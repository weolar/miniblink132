...
TEST(TokenTest, ToString)
{
    ...
    EXPECT_EQ("0123456789ABCDEF5A5A5A5AA5A5A5A5", Token(0x0123456789abcdefull, 0x5a5a5a5aa5a5a5a5ull).ToString());
    EXPECT_EQ("FFFFFFFFFFFFFFFDFFFFFFFFFFFFFFFE", Token(0xfffffffffffffffdull, 0xfffffffffffffffeull).ToString());
}
...
TEST(TokenTest, FromString)
{
    ...
    EXPECT_EQ(Token(0x3141592653589793ull, 0x2384626433832795ull), *Token::FromString(digits.substr(0, 32)));
