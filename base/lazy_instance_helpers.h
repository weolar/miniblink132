...
BASE_EXPORT void CompleteLazyInstance(std::atomic<uintptr_t>& state, uintptr_t new_instance, void (*destructor)(void*), void* destructor_arg);
...
Type* GetOrCreateLazyPointer(std::atomic<uintptr_t>& state, Type* (*creator_func)(void*), void* creator_arg, void (*destructor)(void*), void* destructor_arg)
{
    DCHECK(creator_func);

    // If any bit in the created mask is true, the instance has already been
    // fully constructed.
    constexpr uintptr_t kLazyInstanceCreatedMask = ~internal::kLazyInstanceStateCreating;
