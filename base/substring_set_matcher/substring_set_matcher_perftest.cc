...
TEST(SubstringSetMatcherPerfTest, RandomKeys)
{
    ...
    auto reporter = perf_test::PerfResultReporter("SubstringSetMatcher", "RandomKeys");
    ...
    reporter.AddResult(kMemoryUsage, (base::trace_event::EstimateMemoryUsage(matcher) * 1.0 / (1 << 20)));
}
