...
MatcherStringPattern::MatcherStringPattern(std::string pattern, MatcherStringPattern::ID id)
...
MatcherStringPattern& MatcherStringPattern::operator=(MatcherStringPattern&&) = default;
