...
TEST(NumericsTest, FromNativeEndian)
{
    ...
    {
        constexpr uint8_t bytes[] = { 0x12u, 0x34u, 0x56u, 0x78u, 0x90u, 0x12u, 0x34u, 0x56u };
...

    {
        ...
        EXPECT_EQ(std::bit_cast<uint32_t>(FloatFromNativeEndian(bytes)), 0x78'56'34'12u);
        ...
        static_assert(std::bit_cast<uint32_t>(FloatFromNativeEndian(bytes)) == 0x78'56'34'12u);
    }

    {
        constexpr uint8_t bytes[] = { 0x12u, 0x34u, 0x56u, 0x78u, 0x90u, 0x12u, 0x34u, 0x56u };
        EXPECT_EQ(DoubleFromNativeEndian(bytes), 1.84145159269283616391989849435e107);
        EXPECT_EQ(std::bit_cast<uint64_t>(DoubleFromNativeEndian(bytes)), 0x56'34'12'90'78'56'34'12u);
        static_assert(std::same_as<double, decltype(DoubleFromNativeEndian(bytes))>);
        static_assert(DoubleFromNativeEndian(bytes) == 1.84145159269283616391989849435e107);
        static_assert(std::bit_cast<uint64_t>(DoubleFromNativeEndian(bytes)) == 0x56'34'12'90'78'56'34'12u);
    }
}
...
TEST(NumericsTest, FromLittleEndian)
{
...

    {
        ...
        EXPECT_EQ(std::bit_cast<uint32_t>(FloatFromLittleEndian(bytes)), 0x78'56'34'12u);
        ...
        static_assert(std::bit_cast<uint32_t>(FloatFromLittleEndian(bytes)) == 0x78'56'34'12u);
    }

    {
        constexpr uint8_t bytes[] = { 0x12u, 0x34u, 0x56u, 0x78u, 0x90u, 0x12u, 0x34u, 0x56u };
        EXPECT_EQ(DoubleFromLittleEndian(bytes), 1.84145159269283616391989849435e107);
        EXPECT_EQ(std::bit_cast<uint64_t>(DoubleFromLittleEndian(bytes)), 0x56'34'12'90'78'56'34'12u);
        static_assert(std::same_as<double, decltype(DoubleFromLittleEndian(bytes))>);
        static_assert(DoubleFromLittleEndian(bytes) == 1.84145159269283616391989849435e107);
        static_assert(std::bit_cast<uint64_t>(DoubleFromLittleEndian(bytes)) == 0x56'34'12'90'78'56'34'12u);
    }
}
...
TEST(NumericsTest, FromBigEndian)
{
...

    {
        ...
        EXPECT_EQ(std::bit_cast<uint32_t>(FloatFromBigEndian(bytes)), 0x12'34'56'78u);
        ...
        static_assert(std::bit_cast<uint32_t>(FloatFromBigEndian(bytes)) == 0x12'34'56'78u);
    }
    {
        constexpr uint8_t bytes[] = { 0x12u, 0x34u, 0x56u, 0x78u, 0x90u, 0x12u, 0x34u, 0x56u };
        EXPECT_EQ(DoubleFromBigEndian(bytes), 5.62634909901491201382066931077e-221);
        EXPECT_EQ(std::bit_cast<uint64_t>(DoubleFromBigEndian(bytes)), 0x12'34'56'78'90'12'34'56u);
        static_assert(std::same_as<double, decltype(DoubleFromBigEndian(bytes))>);
        static_assert(DoubleFromBigEndian(bytes) == 5.62634909901491201382066931077e-221);
        static_assert(std::bit_cast<uint64_t>(DoubleFromBigEndian(bytes)) == 0x12'34'56'78'90'12'34'56u);
    }
}
...
TEST(NumericsTest, ToNativeEndian)
{
    ...
    static_assert(std::endian::native == std::endian::little);
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 1u>, decltype(U8ToNativeEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 2u>, decltype(U16ToNativeEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(U32ToNativeEndian(val))>);
        static_assert(U32ToNativeEndian(val) == bytes);
    }
    {
        constexpr std::array<uint8_t, 8u> bytes = { 0x12u, 0x34u, 0x56u, 0x78u, 0x90u, 0x12u, 0x34u, 0x56u };
        constexpr auto val = uint64_t { 0x56'34'12'90'78'56'34'12u };
        EXPECT_EQ(U64ToNativeEndian(val), bytes);
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(U64ToNativeEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 1u>, decltype(I8ToNativeEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 2u>, decltype(I16ToNativeEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(I32ToNativeEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(I64ToNativeEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(FloatToNativeEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(DoubleToNativeEndian(val))>);
...
TEST(NumericsTest, ToLittleEndian)
{
    ...
    static_assert(std::endian::native == std::endian::little);
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 1u>, decltype(U8ToLittleEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 2u>, decltype(U16ToLittleEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(U32ToLittleEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(U64ToLittleEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 1u>, decltype(I8ToLittleEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 2u>, decltype(I16ToLittleEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(I32ToLittleEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(I64ToLittleEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(FloatToLittleEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(DoubleToLittleEndian(val))>);
...
TEST(NumericsTest, ToBigEndian)
{
    ...
    static_assert(std::endian::native == std::endian::little);
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 1u>, decltype(U8ToBigEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 2u>, decltype(U16ToBigEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(U32ToBigEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(U64ToBigEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 1u>, decltype(I8ToBigEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 2u>, decltype(I16ToBigEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(I32ToBigEndian(val))>);
    ...
    }
    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(I64ToBigEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 4u>, decltype(FloatToBigEndian(val))>);
...

    {
        ...
        static_assert(std::same_as<std::array<uint8_t, 8u>, decltype(DoubleToBigEndian(val))>);
