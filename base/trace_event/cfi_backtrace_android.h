...
public:
    ...
    static_assert(sizeof(CFIBacktraceAndroid::CFICache) < 4096, "The cache does not fit in a single page.");
    ...
    bool can_unwind_stack_frames() const
    {
        return can_unwind_stack_frames_;
    }
    ...
    size_t Unwind(uintptr_t pc, uintptr_t sp, uintptr_t lr, const void** out_trace, size_t max_depth);
...
private:
    ...
    // uintptr_t.
    raw_ptr<const uintptr_t, AllowPtrArithmetic> unw_index_function_col_ = nullptr;
