...
TEST(MemoryInfraBackgroundAllowlist, Allowlist)
{
    ...
    EXPECT_TRUE(IsMemoryAllocatorDumpNameInAllowlist("shared_memory/01234ABCDEF"));
    ...
    EXPECT_TRUE(IsMemoryAllocatorDumpNameInAllowlist("blink_gc/workers/worker_0x123/heap"));
    EXPECT_TRUE(IsMemoryAllocatorDumpNameInAllowlist("blink_gc/workers/heap/worker_0x123"));
    EXPECT_FALSE(IsMemoryAllocatorDumpNameInAllowlist("blink_gc/main/heap/0x123"));
}
