...
template <> size_t HashMapBucketCountForTesting<Data>(size_t)
{
    return 10;
}
template <> size_t HashMapBucketCountForTesting<std::pair<const Data, short>>(size_t)
{
    return 10;
}
...
TEST(EstimateMemoryUsageTest, String16)
{
    ...
    EXPECT_EQ(sizeof(char16_t) * (string.capacity() + 1), EstimateMemoryUsage(string));
}
...
TEST(EstimateMemoryUsageTest, IsStandardContainerComplexIteratorTest)
{
    ...
    static_assert(internal::IsIteratorOfStandardContainer<std::list<int>::iterator>, "");
    static_assert(internal::IsIteratorOfStandardContainer<std::list<int>::const_iterator>, "");
    static_assert(internal::IsIteratorOfStandardContainer<std::list<int>::reverse_iterator>, "");
    static_assert(internal::IsIteratorOfStandardContainer<std::list<int>::const_reverse_iterator>, "");
