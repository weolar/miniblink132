...
TEST(TraceArguments, TraceValueAppend)
{
    ...
    TraceArguments args("arg1", std::make_unique<MyConvertable>(kText, &destroy_flag));
...
TEST(TraceArguments, ConstructorWithTwoArguments)
{
...

    {
        ...
        TraceArguments args1("foo_arg1_cstring", kText1, "foo_arg2_convertable", std::unique_ptr<MyConvertable>(ptr));
...
TEST(TraceArguments, Reset)
{
    bool destroy_flag = false;
    {
        TraceArguments args("foo_arg1", "Hello", "foo_arg2", std::make_unique<MyConvertable>("World", &destroy_flag));
...
TEST(TraceArguments, CopyStringsTo_OnlyArgs)
{
    ...
    TraceArguments args("arg1", TraceStringWithCopy("Hello"), "arg2", TraceStringWithCopy("World"));
