...
void BASE_EXPORT SetDumpProviderAllowlistForTesting(base::span<const std::string_view> list);
void BASE_EXPORT SetAllocatorDumpNameAllowlistForTesting(base::span<const std::string_view> list);
