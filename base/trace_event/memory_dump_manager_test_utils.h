...
void RequestGlobalDumpForInProcessTesting(base::trace_event::MemoryDumpType dump_type, base::trace_event::MemoryDumpLevelOfDetail level_of_detail)
{
    MemoryDumpRequestArgs local_args = { 0 /* dump_guid */, dump_type, level_of_detail };
...
void InitializeMemoryDumpManagerForInProcessTesting(bool is_coordinator)
{
    ...
    instance->Initialize(BindRepeating(&RequestGlobalDumpForInProcessTesting), is_coordinator);
}
