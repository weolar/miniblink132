...
std::atomic<AllocationContextTracker::CaptureMode> AllocationContextTracker::capture_mode_ { AllocationContextTracker::CaptureMode::kDisabled };
...
{
    static NoDestructor<ThreadLocalStorage::Slot> tls_alloc_ctx_tracker(&DestructAllocationContextTracker);
...
// static
AllocationContextTracker* AllocationContextTracker::GetInstanceForCurrentThread()
{
    AllocationContextTracker* tracker = static_cast<AllocationContextTracker*>(AllocationContextTrackerTLS().Get());
