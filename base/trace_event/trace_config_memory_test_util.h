...
public:
    static std::string GetTraceConfig_LegacyPeriodicTriggers(int light_period, int heavy_period)
    {
        return StringPrintf("{"
    ...
    static std::string GetTraceConfig_PeriodicTriggers(int light_period, int heavy_period)
    {
        return StringPrintf("{"
                            "\"enable_argument_filter\":false,"
                            "\"enable_package_name_filter\":false,"
