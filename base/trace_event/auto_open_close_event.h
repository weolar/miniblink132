...
template <const char* category> class AutoOpenCloseEvent : public TraceLog::AsyncEnabledStateObserver {
public:
    enum Type { kAsync };
    ...
    void Begin()
    {
        ...
        TRACE_EVENT_ASYNC_BEGIN_WITH_TIMESTAMP0(category, event_name_, static_cast<void*>(this), start_time_);
    }
    void End()
    {
        DCHECK(thread_checker_.CalledOnValidThread());
