...
public:
    ...
    static const TraceCategory* GetCategoryByStatePtr(const uint8_t* category_state);
...
private:
    ...
    static_assert(BuiltinCategories::Size() <= kMaxCategories, "kMaxCategories must be greater than kNumBuiltinCategories");
    ...
    static bool GetOrCreateCategoryLocked(const char* category_name, CategoryInitializerFn, TraceCategory**);
