...
inline constexpr GUID Chrome_GUID = { 0xD2D578D9, 0x2936, 0x45B6, { 0xA0, 0x9F, 0x30, 0xE3, 0x27, 0x15, 0xF4, 0x2D } };
...
public:
    ...
    static void AddCompleteEndEvent(const unsigned char* category_group_enabled, const char* name);
...
BASE_EXPORT uint64_t CategoryGroupToETWKeyword(std::string_view category_group_name);

BASE_EXPORT perfetto::protos::gen::TrackEventConfig ETWKeywordToTrackEventConfig(uint64_t keyword);
