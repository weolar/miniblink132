...
public:
    ...
    void Add(ObjectType object_type, size_t allocated_size_in_bytes, size_t resident_size_in_bytes);
...
private:
    ...
    void AddInternal(ObjectType object_type, size_t count, size_t allocated_size_in_bytes, size_t resident_size_in_bytes);
};
