...
public:
    ...
    TrackEventHandle(TrackEvent*, IncrementalState*, CompletionListener*, bool filter_debug_annotations);
    ...
    TrackEvent* get() const
    {
        return event_;
    }

    IncrementalState* incremental_state() const
    {
...
public:
    ...
    TracePacket* get() const
    {
        return packet_.get();
    }

    PerfettoPacketHandle TakePerfettoHandle()
    {
