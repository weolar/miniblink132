...
public:
    ...
    virtual bool HasConstructionArguments(Sample expected_minimum, Sample expected_maximum, size_t expected_bucket_count) const = 0;
...
protected:
    ...
    void WriteAsciiBucketGraph(double x_count, int line_length, std::string* output) const;
    ...
    void WriteAsciiBucketValue(Count current, double scaled_sum, std::string* output) const;
