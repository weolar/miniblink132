...
BASE_EXPORT void UmaHistogramExactLinear(std::string_view name, int sample, int exclusive_max);
...
template <typename T> void UmaHistogramEnumeration(std::string_view name, T sample)
{
...
template <typename T> void UmaHistogramEnumeration(std::string_view name, T sample, T enum_size)
{
    static_assert(std::is_enum_v<T>, "T is not an enum.");
...
BASE_EXPORT void UmaHistogramPercentageObsoleteDoNotUse(std::string_view name, int percent);
...
BASE_EXPORT void UmaHistogramCustomCounts(std::string_view name, int sample, int min, int exclusive_max, size_t buckets);
...
BASE_EXPORT void UmaHistogramCustomTimes(std::string_view name, TimeDelta sample, TimeDelta min, TimeDelta max, size_t buckets);
...
BASE_EXPORT void UmaHistogramMediumTimes(std::string_view name, TimeDelta sample);
...
BASE_EXPORT void UmaHistogramLongTimes100(std::string_view name, TimeDelta sample);
...
BASE_EXPORT void UmaHistogramCustomMicrosecondsTimes(std::string_view name, TimeDelta sample, TimeDelta min, TimeDelta max, size_t buckets);

// For microseconds timings from 1 microsecond up to 10 seconds (50 buckets).
BASE_EXPORT void UmaHistogramMicrosecondsTimes(std::string_view name, TimeDelta sample);
...
public:
    ...
    explicit ScopedUmaHistogramTimer(std::string_view name, ScopedHistogramTiming timing = ScopedHistogramTiming::kShortTimes);
