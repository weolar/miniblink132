...
TEST(HistogramMacro, UnscopedEnumeration)
{
    ...
    UMA_HISTOGRAM_ENUMERATION("Test.UnscopedEnumeration", SECOND_VALUE, MAX_ENTRIES);
}
...
TEST(HistogramMacro, ScopedEnumeration)
{
    ...
    UMA_HISTOGRAM_ENUMERATION("Test.ScopedEnumeration2", TestEnum2::SECOND_VALUE, TestEnum2::MAX_ENTRIES);
}
...
TEST(HistogramMacro, SplitByProcessPriorityMacro)
{
...

    {
        ...
        UMA_HISTOGRAM_SPLIT_BY_PROCESS_PRIORITY(UMA_HISTOGRAM_COUNTS_1000, mock_now, Microseconds(0), "Test.MyCount", 123);
    ...
    }
    {
        ...
        HistogramTester tester;
        UMA_HISTOGRAM_SPLIT_BY_PROCESS_PRIORITY(UMA_HISTOGRAM_COUNTS_1000, mock_now, kMockIntervalBetweenSamples * 1.5, "Test.MyCount", 123);
        tester.ExpectUniqueSample("Test.MyCount", 123, 0);
        tester.ExpectUniqueSample("Test.MyCount.BestEffort", 123, 1);
    }
    {
        ...
        // time:
        UMA_HISTOGRAM_SPLIT_BY_PROCESS_PRIORITY(UMA_HISTOGRAM_COUNTS_1000, mock_now - kMockIntervalBetweenSamples * 1.5, Microseconds(0), "Test.MyCount", 123);
        tester.ExpectUniqueSample("Test.MyCount", 123, 0);
        tester.ExpectUniqueSample("Test.MyCount.BestEffort", 123, 1);
    }
