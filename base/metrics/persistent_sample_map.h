...
public:
    ...
    static PersistentMemoryAllocator::Reference GetNextPersistentRecord(
        PersistentMemoryAllocator::Iterator& iterator, uint64_t* sample_map_id, HistogramBase::Sample* value);
    ...
    static PersistentMemoryAllocator::Reference CreatePersistentRecord(
        PersistentMemoryAllocator* allocator, uint64_t sample_map_id, HistogramBase::Sample value);
...
protected:
    ...
    HistogramBase::Count* GetOrCreateSampleCountStorage(HistogramBase::Sample value);
...
private:
    ...
    HistogramBase::Count* ImportSamples(std::optional<HistogramBase::Sample> until_value);
    ...
    std::map<HistogramBase::Sample, raw_ptr<HistogramBase::Count, CtnExperimental>> sample_counts_;
