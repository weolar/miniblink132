...
public:
    ...
    static HistogramBase* FactoryGet(std::string_view name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGet(std::string_view name, base::TimeDelta minimum, base::TimeDelta maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryMicrosecondsTimeGet(
        std::string_view name, base::TimeDelta minimum, base::TimeDelta maximum, size_t bucket_count, int32_t flags);
    ...
    static HistogramBase* FactoryGet(const std::string& name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGet(const std::string& name, base::TimeDelta minimum, base::TimeDelta maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryMicrosecondsTimeGet(
        const std::string& name, base::TimeDelta minimum, base::TimeDelta maximum, size_t bucket_count, int32_t flags);

    static HistogramBase* FactoryGet(const char* name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGet(const char* name, base::TimeDelta minimum, base::TimeDelta maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryMicrosecondsTimeGet(const char* name, base::TimeDelta minimum, base::TimeDelta maximum, size_t bucket_count, int32_t flags);

    // Create a histogram using data in persistent storage.
    static std::unique_ptr<HistogramBase> PersistentCreate(const char* name, const BucketRanges* ranges, const DelayedPersistentAllocation& counts,
        const DelayedPersistentAllocation& logged_counts, HistogramSamples::Metadata* meta, HistogramSamples::Metadata* logged_meta);

    static void InitializeBucketRanges(Sample minimum, Sample maximum, BucketRanges* ranges);
    ...
    static bool InspectConstructionArguments(std::string_view name, Sample* minimum, Sample* maximum, size_t* bucket_count);

    // HistogramBase implementation:
    uint64_t name_hash() const override;
    HistogramType GetHistogramType() const override;
    bool HasConstructionArguments(Sample expected_minimum, Sample expected_maximum, size_t expected_bucket_count) const override;
...
protected:
    ...
    Histogram(const char* name, const BucketRanges* ranges, const DelayedPersistentAllocation& counts, const DelayedPersistentAllocation& logged_counts,
...
private:
    ...
    friend BASE_EXPORT HistogramBase* DeserializeHistogramInfo(base::PickleIterator* iter);
    static HistogramBase* DeserializeInfoImpl(base::PickleIterator* iter);

    static HistogramBase* FactoryGetInternal(std::string_view name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGetInternal(std::string_view name, base::TimeDelta minimum, base::TimeDelta maximum, size_t bucket_count, int32_t flags);
...
public:
    ...
    static HistogramBase* FactoryGet(std::string_view name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGet(std::string_view name, TimeDelta minimum, TimeDelta maximum, size_t bucket_count, int32_t flags);
    ...
    static HistogramBase* FactoryGet(const std::string& name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGet(const std::string& name, TimeDelta minimum, TimeDelta maximum, size_t bucket_count, int32_t flags);

    static HistogramBase* FactoryGet(const char* name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGet(const char* name, TimeDelta minimum, TimeDelta maximum, size_t bucket_count, int32_t flags);
...
protected:
    ...
    LinearHistogram(const char* name, const BucketRanges* ranges, const DelayedPersistentAllocation& counts, const DelayedPersistentAllocation& logged_counts,
        HistogramSamples::Metadata* meta, HistogramSamples::Metadata* logged_meta);
...
private:
    ...
    static HistogramBase* FactoryGetInternal(std::string_view name, Sample minimum, Sample maximum, size_t bucket_count, int32_t flags);
    static HistogramBase* FactoryTimeGetInternal(std::string_view name, TimeDelta minimum, TimeDelta maximum, size_t bucket_count, int32_t flags);
...
public:
    ...
    ScaledLinearHistogram(std::string_view name, Sample minimum, Sample maximum, size_t bucket_count, int32_t scale, int32_t flags);

    // Overload of the above function that take a const std::string& or const
    // char* |name| param, to avoid code bloat from the std::string constructor
    // being inlined into call sites.
    ScaledLinearHistogram(const char* name, Sample minimum, Sample maximum, size_t bucket_count, int32_t scale, int32_t flags);
    ScaledLinearHistogram(const std::string& name, Sample minimum, Sample maximum, size_t bucket_count, int32_t scale, int32_t flags);
...
private:
    static HistogramBase* FactoryGetInternal(std::string_view name, int32_t flags);

    BooleanHistogram(const char* name, const BucketRanges* ranges);
    BooleanHistogram(const char* name, const BucketRanges* ranges, const DelayedPersistentAllocation& counts, const DelayedPersistentAllocation& logged_counts,
        HistogramSamples::Metadata* meta, HistogramSamples::Metadata* logged_meta);
...
public:
    ...
    static HistogramBase* FactoryGet(std::string_view name, const std::vector<Sample>& custom_ranges, int32_t flags);

    // Overload of the above function that take a const std::string& or const
    // char* |name| param, to avoid code bloat from the std::string constructor
    // being inlined into call sites.
    static HistogramBase* FactoryGet(const std::string& name, const std::vector<Sample>& custom_ranges, int32_t flags);
    static HistogramBase* FactoryGet(const char* name, const std::vector<Sample>& custom_ranges, int32_t flags);
    ...
    static std::vector<Sample> ArrayToCustomEnumRanges(base::span<const Sample> values);
...
protected:
    ...
    CustomHistogram(const char* name, const BucketRanges* ranges, const DelayedPersistentAllocation& counts, const DelayedPersistentAllocation& logged_counts,
        HistogramSamples::Metadata* meta, HistogramSamples::Metadata* logged_meta);
...
private:
    ...
    static HistogramBase* FactoryGetInternal(std::string_view name, const std::vector<Sample>& custom_ranges, int32_t flags);
...
BASE_EXPORT void SetSharedLastForegroundTimeForMetrics(const std::atomic<TimeTicks>* last_foreground_time_ref);

// Returns the pointer passed to SetSharedLastForegroundTimeForMetrics, or
// nullptr if it was never called.
BASE_EXPORT const std::atomic<TimeTicks>* GetSharedLastForegroundTimeForMetricsForTesting();
