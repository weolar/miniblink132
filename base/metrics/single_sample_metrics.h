...
public:
    ...
    DefaultSingleSampleMetricsFactory& operator=(const DefaultSingleSampleMetricsFactory&) = delete;
    ...
    std::unique_ptr<SingleSampleMetric> CreateCustomCountsMetric(
        const std::string& histogram_name, HistogramBase::Sample min, HistogramBase::Sample max, uint32_t bucket_count) override;
};

class BASE_EXPORT DefaultSingleSampleMetric : public SingleSampleMetric {
public:
    DefaultSingleSampleMetric(const std::string& histogram_name, HistogramBase::Sample min, HistogramBase::Sample max, uint32_t bucket_count, int32_t flags);

    DefaultSingleSampleMetric(const DefaultSingleSampleMetric&) = delete;
    DefaultSingleSampleMetric& operator=(const DefaultSingleSampleMetric&) = delete;
