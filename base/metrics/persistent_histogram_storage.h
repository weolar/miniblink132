...
public:
    ...
    PersistentHistogramStorage(std::string_view allocator_name, StorageDirManagement storage_dir_management);

    PersistentHistogramStorage(const PersistentHistogramStorage&) = delete;
    PersistentHistogramStorage& operator=(const PersistentHistogramStorage&) = delete;
