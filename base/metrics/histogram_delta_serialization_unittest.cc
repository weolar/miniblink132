...
{
    std::unique_ptr<StatisticsRecorder> statistic_recorder(StatisticsRecorder::CreateTemporaryForTesting());
    ...
    HistogramBase* histogram = Histogram::FactoryGet("TestHistogram", 1, 1000, 10, HistogramBase::kIPCSerializationSourceFlag);
    histogram->Add(1);
    histogram->Add(10);
    histogram->Add(100);
    histogram->Add(1000);
