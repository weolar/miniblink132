...
public:
    ...
    // deleting `ranges`.
    virtual const BucketRanges* GetOrRegisterCanonicalRanges(const BucketRanges* ranges);
...
protected:
    ...
    typedef std::unordered_set<raw_ptr<const BucketRanges, CtnExperimental>, BucketRangesHash, BucketRangesEqual> RangesMap;
...
public:
    ...
    // RangesManager:
    const BucketRanges* GetOrRegisterCanonicalRanges(const BucketRanges* ranges) override;
