...
public:
    ...
    HistogramDeltaSerialization& operator=(const HistogramDeltaSerialization&) = delete;
    ...
    void PrepareAndSerializeDeltas(std::vector<std::string>* serialized_deltas, bool include_persistent);
    ...
    static void DeserializeAndAddSamples(const std::vector<std::string>& serialized_deltas);
