...
public:
    ...
    FieldTrialParamAssociator& operator=(const FieldTrialParamAssociator&) = delete;
    ...
    bool GetFieldTrialParamsWithoutFallback(const std::string& trial_name, const std::string& group_name, FieldTrialParams* params);
    ...
    void ClearParamsForTesting(const std::string& trial_name, const std::string& group_name);
