...
#define BASE_REMOVE_PARENS(...)                                                                                                                                \
    BASE_IF(BASE_INTERNAL_IS_PARENTHESIZED(__VA_ARGS__), BASE_INTERNAL_ECHO, BASE_INTERNAL_EMPTY())                                                            \
    __VA_ARGS__

#define BASE_INTERNAL_IS_PARENTHESIZED(...) BASE_IS_EMPTY(BASE_INTERNAL_EAT __VA_ARGS__)
