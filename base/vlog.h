...
private:
    ...
    // commandline.
    static std::vector<VmodulePattern> ParseVmoduleLevels(const std::string& vmodule_switch);
...
BASE_EXPORT bool MatchVlogPattern(std::string_view string, std::string_view vlog_pattern);
