...
public:
    ...
    bool HandleNestedNativeLoopWithApplicationTasks(bool application_tasks_desired) override;
...
private:
    ...
    NOINLINE NOT_TAIL_CALLED void WaitForWork(Delegate::NextWorkInfo next_work_info);
...
public:
    ...
    public:
        ...
        const Location& io_handler_location()
        {
