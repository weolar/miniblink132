...
{
    typedef Singleton<base::GlobalDescriptors, LeakySingletonTraits<base::GlobalDescriptors>> GlobalDescriptorsSingleton;
...
base::ScopedFD GlobalDescriptors::TakeFD(Key key, base::MemoryMappedFile::Region* region)
{
    base::ScopedFD fd;
...
void GlobalDescriptors::Set(Key key, int fd, base::MemoryMappedFile::Region region)
{
