...
public:
    ...
    PooledParallelTaskRunner(const TaskTraits& traits, PooledTaskRunnerDelegate* pooled_task_runner_delegate);
...
private:
    ...
    const raw_ptr<PooledTaskRunnerDelegate, DanglingUntriaged> pooled_task_runner_delegate_;
};
