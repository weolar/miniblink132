...
bool CanUseBackgroundThreadTypeForWorkerThreadImpl()
{
    ...
    if (CommandLine::InitializedForCurrentProcess() && CommandLine::ForCurrentProcess()->HasSwitch(switches::kEnableBackgroundThreadPool)) {
        return true;
    }
    ...
    if (!PlatformThread::CanChangeThreadType(ThreadType::kBackground, ThreadType::kDefault))
        return false;
...
bool CanUseUtilityThreadTypeForWorkerThreadImpl()
{
    ...
    if (!PlatformThread::CanChangeThreadType(ThreadType::kUtility, ThreadType::kDefault))
        return false;
#endif // BUILDFLAG(IS_ANDROID)
...
{
    static const bool can_use_background_thread_type_for_worker_thread = CanUseBackgroundThreadTypeForWorkerThreadImpl();
    return can_use_background_thread_type_for_worker_thread;
}

bool CanUseUtilityThreadTypeForWorkerThread()
{
    static const bool can_use_utility_thread_type_for_worker_thread = CanUseUtilityThreadTypeForWorkerThreadImpl();
