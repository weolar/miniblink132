...
// TaskTracker.
template <typename Target, typename CreateTaskRunner> void TestCanRunPolicyBasic(Target* target, CreateTaskRunner create_task_runner, TaskTracker* task_tracker)
{
    ...
    const auto user_visible_task_runner = create_task_runner(TaskPriority::USER_VISIBLE);
    ...
    const auto best_effort_task_runner = create_task_runner(TaskPriority::BEST_EFFORT);
...
void TestCanRunPolicyChangedBeforeRun(Target* target, CreateTaskRunner create_task_runner, TaskTracker* task_tracker)
{
    constexpr struct {
    ...
    } kTestCases[] = { { "BestEffort/kNone/kAll", TaskPriority::BEST_EFFORT, CanRunPolicy::kNone, CanRunPolicy::kAll },
        { "BestEffort/kForegroundOnly/kAll", TaskPriority::BEST_EFFORT, CanRunPolicy::kForegroundOnly, CanRunPolicy::kAll },
        { "UserVisible/kNone/kForegroundOnly", TaskPriority::USER_VISIBLE, CanRunPolicy::kNone, CanRunPolicy::kForegroundOnly },
        { "UserVisible/kNone/kAll", TaskPriority::USER_VISIBLE, CanRunPolicy::kNone, CanRunPolicy::kAll } };
    ...
    for (auto& test_case : kTestCases) {
        ...
        task_runner->PostTask(FROM_HERE, BindLambdaForTesting([&] { EXPECT_TRUE(second_task_can_run.IsSet()); }));
...
template <typename Target, typename CreateTaskRunner> void TestCanRunPolicyLoad(Target* target, CreateTaskRunner create_task_runner, TaskTracker* task_tracker)
{
    constexpr struct {
        // Descriptor for the test case.
        const char* descriptor;
        ...
        // Policy that disallows running tasks with |priority|.
        CanRunPolicy disallow_policy;
    } kTestCases[] = { { "BestEffort/kAll/kNone", TaskPriority::BEST_EFFORT, CanRunPolicy::kAll, CanRunPolicy::kNone },
        { "BestEffort/kAll/kForegroundOnly", TaskPriority::BEST_EFFORT, CanRunPolicy::kAll, CanRunPolicy::kForegroundOnly },
        { "UserVisible/kForegroundOnly/kNone", TaskPriority::USER_VISIBLE, CanRunPolicy::kForegroundOnly, CanRunPolicy::kNone },
        { "UserVisible/kAll/kNone", TaskPriority::USER_VISIBLE, CanRunPolicy::kAll, CanRunPolicy::kNone } };
