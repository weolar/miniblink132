...
class BASE_EXPORT [[maybe_unused, nodiscard]] ScopedSetTaskPriorityForCurrentThread
{
public:
    ...
    ScopedSetTaskPriorityForCurrentThread(const ScopedSetTaskPriorityForCurrentThread&) = delete;
    ScopedSetTaskPriorityForCurrentThread& operator=(const ScopedSetTaskPriorityForCurrentThread&) = delete;
