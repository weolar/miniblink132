...
public:
    ...
    DeferredSequencedTaskRunner& operator=(const DeferredSequencedTaskRunner&) = delete;
    ...
    void StartWithTaskRunner(scoped_refptr<SequencedTaskRunner> target_task_runner);
...
private:
    ...
    void QueueDeferredTask(const Location& from_here, OnceClosure task, TimeDelta delay, bool is_non_nestable);
