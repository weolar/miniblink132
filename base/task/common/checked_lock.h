...
public:
    ...
    // |acquired_lock|.
    AnnotateAcquiredLockAlias(const CheckedLock& acquired_lock, const CheckedLock& lock_alias) EXCLUSIVE_LOCK_FUNCTION(lock_alias)
    ...
    AnnotateAcquiredLockAlias& operator=(const AnnotateAcquiredLockAlias&) = delete;
