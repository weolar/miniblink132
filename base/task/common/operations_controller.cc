...
OperationsController::~OperationsController()
{
    ...
    DCHECK(ExtractState(value) == State::kRejectingOperations || (ExtractState(value) == State::kShuttingDown && ExtractCount(value) == 0)) << value;
#endif
}
...
bool OperationsController::StartAcceptingOperations()
{
    ...
    auto prev_value = state_and_count_.fetch_or(kAcceptingOperationsBitMask, std::memory_order_release);
