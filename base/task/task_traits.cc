...
const char* TaskShutdownBehaviorToString(TaskShutdownBehavior shutdown_behavior)
{
...
std::ostream& operator<<(std::ostream& os, const TaskShutdownBehavior& shutdown_behavior)
{
