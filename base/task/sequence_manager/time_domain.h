...
public:
    ...
    virtual bool MaybeFastForwardToWakeUp(std::optional<WakeUp> next_wake_up, bool quit_when_idle_requested) = 0;
...
protected:
    ...
    void OnAssignedToSequenceManager(internal::SequenceManagerImpl* sequence_manager);

private:
    friend class internal::SequenceManagerImpl;

    raw_ptr<internal::SequenceManagerImpl, DanglingUntriaged> sequence_manager_ = nullptr;
};
