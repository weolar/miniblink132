...
TEST(WorkDeduplicatorTest, BindToCurrentThreadWithoutPriorOnWorkRequested)
{
    ...
    EXPECT_EQ(ShouldScheduleWork::kNotNeeded, work_deduplicator.BindToCurrentThread());
}
...
TEST(WorkDeduplicatorTest, OnWorkRequestedUnBound)
{
    ...
    EXPECT_EQ(ShouldScheduleWork::kNotNeeded, work_deduplicator.OnWorkRequested());
    EXPECT_EQ(ShouldScheduleWork::kScheduleImmediate, work_deduplicator.BindToCurrentThread());
}
...
TEST(WorkDeduplicatorTest, OnWorkRequestedOnWorkStarted)
{
    ...
    EXPECT_EQ(ShouldScheduleWork::kScheduleImmediate, work_deduplicator.OnWorkRequested());
    EXPECT_EQ(ShouldScheduleWork::kNotNeeded, work_deduplicator.OnWorkRequested());
}
...
TEST(WorkDeduplicatorTest, TaskRequestedWorkButDidCheckForMoreWorkDelayed)
{
    ...
    EXPECT_EQ(ShouldScheduleWork::kNotNeeded, work_deduplicator.DidCheckForMoreWork(NextTask::kIsDelayed));
}

TEST(WorkDeduplicatorTest, TaskRequestedWorkButDidCheckForMoreWorkDelayedAndCrossThreadWorkRequested)
{
    WorkDeduplicator work_deduplicator(AssociatedThreadId::CreateBound());
    work_deduplicator.BindToCurrentThread();
    ...
    EXPECT_EQ(ShouldScheduleWork::kNotNeeded, work_deduplicator.OnWorkRequested());
    EXPECT_EQ(ShouldScheduleWork::kScheduleImmediate, work_deduplicator.DidCheckForMoreWork(NextTask::kIsDelayed));
}
...
TEST(WorkDeduplicatorTest, TaskRequestedWorkAndDidCheckForMoreWorkImmediate)
{
    ...
    EXPECT_EQ(ShouldScheduleWork::kNotNeeded, work_deduplicator.OnWorkRequested());
    work_deduplicator.WillCheckForMoreWork();
    EXPECT_EQ(ShouldScheduleWork::kScheduleImmediate, work_deduplicator.DidCheckForMoreWork(NextTask::kIsImmediate));
}

TEST(WorkDeduplicatorTest, TaskRequestedWorkAndDidCheckForMoreWorkImmediateCrossThreadWorkRequested)
{
    WorkDeduplicator work_deduplicator(AssociatedThreadId::CreateBound());
    work_deduplicator.BindToCurrentThread();
...
TEST(WorkDeduplicatorTest, DidCheckForMoreWorkDelayedAndCrossThreadWorkRequested)
{
    WorkDeduplicator work_deduplicator(AssociatedThreadId::CreateBound());
    work_deduplicator.BindToCurrentThread();
...
TEST(WorkDeduplicatorTest, DidCheckForMoreWorkImmediateCrossThreadWorkRequested)
{
    WorkDeduplicator work_deduplicator(AssociatedThreadId::CreateBound());
    work_deduplicator.BindToCurrentThread();
...
TEST(WorkDeduplicatorTest, OnDelayedWorkRequestedUnbound)
{
    ...
    EXPECT_EQ(ShouldScheduleWork::kNotNeeded, work_deduplicator.OnDelayedWorkRequested());
}
...
TEST(WorkDeduplicatorTest, OnDelayedWorkRequestedBound)
{
    ...
    EXPECT_EQ(ShouldScheduleWork::kScheduleImmediate, work_deduplicator.OnDelayedWorkRequested());
...
TEST(WorkDeduplicatorTest, OnDelayedWorkRequestedDidCheckForMoreWorkWithNoMoreWork)
{
    WorkDeduplicator work_deduplicator(AssociatedThreadId::CreateBound());
    work_deduplicator.BindToCurrentThread();
