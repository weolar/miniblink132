...
public:
    ...
    public:
        ...
        // This is always called on the thread this TaskQueue is associated with.
        virtual std::optional<WakeUp> GetNextAllowedWakeUp(LazyNow* lazy_now, std::optional<WakeUp> next_desired_wake_up, bool has_ready_task) = 0;
    ...
    template <typename T, typename = typename std::enable_if_t<std::is_enum_v<T>>> void SetQueuePriority(T priority)
    {
    ...
    virtual scoped_refptr<SingleThreadTaskRunner> CreateTaskRunner(TaskType task_type) const = 0;
    ...
    public:
        ...
        OnTaskPostedCallbackHandle& operator=(const OnTaskPostedCallbackHandle&) = delete;
    ...
    // thread.
    [[nodiscard]] virtual std::unique_ptr<OnTaskPostedCallbackHandle> AddOnTaskPostedHandler(OnTaskPostedHandler handler) = 0;
