...
public:
    ...
    DelayedTaskHandleDelegate& operator=(const DelayedTaskHandleDelegate&) = delete;
...
private:
    ...
    RAW_PTR_EXCLUSION TaskQueueImpl* const outer_ GUARDED_BY_CONTEXT(sequence_checker_) = nullptr;
    ...
    WeakPtrFactory<DelayedTaskHandleDelegate> weak_ptr_factory_ GUARDED_BY_CONTEXT(sequence_checker_) { this };
};
