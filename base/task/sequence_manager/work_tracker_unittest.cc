...
TEST(SequenceManagerWorkTrackerTest, SetRunTaskSynchronouslyAllowedBlocks)
{
    ...
    other_thread.task_runner()->PostTask(FROM_HERE, BindLambdaForTesting([&] {
        std::optional<SyncWorkAuthorization> auth = tracker.TryAcquireSyncWorkAuthorization();
...
TEST(SequenceManagerWorkTrackerTest, TwoSyncWorkAuthorizations)
{
    ...
    std::optional<SyncWorkAuthorization> first = tracker.TryAcquireSyncWorkAuthorization();
