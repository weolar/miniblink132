...
struct FooWithoutDefaultConstructor {
    explicit FooWithoutDefaultConstructor(int value)
        : value(value)
    {
    }
    int value;
...
void SaveFooWithoutDefaultConstructor(int* output_value, FooWithoutDefaultConstructor input)
{
...
TEST_F(TaskRunnerTest, PostTaskAndReplyWithResult)
{
    ...
    SingleThreadTaskRunner::GetCurrentDefault()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&ReturnFourtyTwo), BindOnce(&StoreValue, &result));
...
TEST_F(TaskRunnerTest, PostTaskAndReplyWithResultRepeatingCallbacks)
{
    ...
    test::SingleThreadTaskEnvironment task_environment;
    SingleThreadTaskRunner::GetCurrentDefault()->PostTaskAndReplyWithResult(FROM_HERE, BindRepeating(&ReturnFourtyTwo), BindRepeating(&StoreValue, &result));
...
TEST_F(TaskRunnerTest, PostTaskAndReplyWithResultImplicitConvert)
{
    ...
    test::SingleThreadTaskEnvironment task_environment;
    SingleThreadTaskRunner::GetCurrentDefault()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&ReturnFourtyTwo), BindOnce(&StoreDoubleValue, &result));
...
{
    test::SingleThreadTaskEnvironment task_environment;
    SingleThreadTaskRunner::GetCurrentDefault()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&CreateFoo), BindOnce(&ExpectFoo));
...
{
    test::SingleThreadTaskEnvironment task_environment;
    SingleThreadTaskRunner::GetCurrentDefault()->PostTaskAndReplyWithResult(FROM_HERE, BindOnce(&CreateScopedFoo), BindOnce(&ExpectScopedFoo));
...
TEST_F(TaskRunnerTest, PostTaskAndReplyWithResultWithoutDefaultConstructor)
{
    ...
    SingleThreadTaskRunner::GetCurrentDefault()->PostTaskAndReplyWithResult(
        FROM_HERE, BindOnce(&CreateFooWithoutDefaultConstructor, kSomeVal), BindOnce(&SaveFooWithoutDefaultConstructor, &actual));
