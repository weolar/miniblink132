...
namespace internal {
template <typename TaskRunnerType, bool com_sta> class BASE_EXPORT LazyThreadPoolTaskRunner;
} // namespace internal
...
using LazyThreadPoolSingleThreadTaskRunner = internal::LazyThreadPoolTaskRunner<SingleThreadTaskRunner, false>;

#if BUILDFLAG(IS_WIN)
// Lazy COM-STA enabled SingleThreadTaskRunner.
using LazyThreadPoolCOMSTATaskRunner = internal::LazyThreadPoolTaskRunner<SingleThreadTaskRunner, true>;
#endif
...
#define LAZY_THREAD_POOL_SEQUENCED_TASK_RUNNER_INITIALIZER(traits)                                                                                             \
    ...
    [[maybe_unused]] constexpr base::TaskTraits BASE_UNIQUIFY(kVerifyTraitsAreConstexpr) = traits
...
#define LAZY_THREAD_POOL_SINGLE_THREAD_TASK_RUNNER_INITIALIZER(traits, thread_mode)                                                                            \
    ...
    [[maybe_unused]] constexpr base::TaskTraits BASE_UNIQUIFY(kVerifyTraitsAreConstexpr) = traits;                                                             \
    [[maybe_unused]] constexpr base::SingleThreadTaskRunnerThreadMode BASE_UNIQUIFY(kVerifyThreadModeIsConstexpr) = thread_mode
...
private:
    constexpr LazyThreadPoolTaskRunner(const TaskTraits& traits, SingleThreadTaskRunnerThreadMode thread_mode = SingleThreadTaskRunnerThreadMode::SHARED)
        : traits_(traits)
...
public:
    ...
    ScopedLazyTaskRunnerListForTesting(const ScopedLazyTaskRunnerListForTesting&) = delete;
    ScopedLazyTaskRunnerListForTesting& operator=(const ScopedLazyTaskRunnerListForTesting&) = delete;
