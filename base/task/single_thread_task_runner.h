...
public:
    ...
    [[nodiscard]] static const scoped_refptr<SingleThreadTaskRunner>& GetCurrentDefault();
    ...
    public:
        ...
        explicit CurrentDefaultHandle(scoped_refptr<SingleThreadTaskRunner> task_runner);
    ...
    private:
        ...
        friend class sequence_manager::internal::CurrentDefaultHandleOverrideForRunOrPostTask;
        FRIEND_TEST_ALL_PREFIXES(SingleThreadTaskRunnerCurrentDefaultHandleTest, NestedRunLoopAllowedUnderHandleOverride);
        FRIEND_TEST_ALL_PREFIXES(SingleThreadTaskRunnerCurrentDefaultHandleTest, NestedOverrideWithMayAlreadyExist);
        FRIEND_TEST_ALL_PREFIXES(SingleThreadTaskRunnerCurrentDefaultHandleTest, OverrideWithNull);
        FRIEND_TEST_ALL_PREFIXES(SingleThreadTaskRunnerCurrentDefaultHandleTest, OverrideWithNonNull);
        ...
        CurrentDefaultHandle(scoped_refptr<SingleThreadTaskRunner> task_runner, MayAlreadyExist);
    ...
    public:
        explicit CurrentHandleOverrideForTesting(scoped_refptr<SingleThreadTaskRunner> overriding_task_runner);
