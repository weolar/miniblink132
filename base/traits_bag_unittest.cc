...
struct TestTraits {
    ...
    constexpr TestTraits(ArgTypes... args)
        ...
        , enum_trait_a(trait_helpers::GetEnum<EnumTraitA, EnumTraitA::A>(args...))
        , enum_trait_b(trait_helpers::GetEnum<EnumTraitB, EnumTraitB::ONE>(args...))
    {
    }
...
TEST(TraitsBagTest, Filtering)
{
    ...
    static_assert(std::is_same_v<ExampleTrait2, decltype(Predicate::Filter(ExampleTrait2 {}))>, "ExampleTrait2 should not be filtered");

    static_assert(std::is_same_v<EmptyTrait, decltype(Predicate::Filter(ExampleTrait {}))>, "ExampleTrait should be filtered");

    static_assert(std::is_same_v<EmptyTrait, decltype(Predicate::Filter(EnumTraitA::A))>, "EnumTraitA should be filtered");

    static_assert(std::is_same_v<EnumTraitB, decltype(Predicate::Filter(EnumTraitB::TWO))>, "EnumTraitB should not be filtered");

    static_assert(std::is_same_v<EmptyTrait, decltype(Predicate::Filter(EmptyTrait {}))>, "EmptyTrait should not be filtered");
}
