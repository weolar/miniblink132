...
TEST(ParameterPack, IndexInPack)
{
    ...
    static_assert(ParameterPack<int, float, bool>::IndexInPack<void*>() == pack_npos, "");
}

TEST(ParameterPack, NthType)
{
    static_assert(std::is_same_v<int, ParameterPack<int, float, bool>::NthType<0>>, "");
    static_assert(std::is_same_v<float, ParameterPack<int, float, bool>::NthType<1>>, "");
    static_assert(std::is_same_v<bool, ParameterPack<int, float, bool>::NthType<2>>, "");
}
