...
public:
    ...
    using CallbackWithChangeInfo = RepeatingCallback<void(const ChangeInfo&, const FilePath& path, bool error)>;
    ...
    public:
        ...
        [[nodiscard]] virtual bool Watch(const FilePath& path, Type type, const Callback& callback) = 0;

        // A more general API which can deal with multiple options.
        [[nodiscard]] virtual bool WatchWithOptions(const FilePath& path, const WatchOptions& options, const Callback& callback);
        ...
        [[nodiscard]] virtual bool WatchWithChangeInfo(const FilePath& path, const WatchOptions& options, const CallbackWithChangeInfo& callback);
    ...
    // A more general API which can deal with multiple options.
    bool WatchWithOptions(const FilePath& path, const WatchOptions& options, const Callback& callback);
    ...
    bool WatchWithChangeInfo(const FilePath& path, const WatchOptions& options, const CallbackWithChangeInfo& callback);
