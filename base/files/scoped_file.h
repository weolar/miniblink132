...
struct BASE_EXPORT ScopedFDCloseTraits : public ScopedGenericOwnershipTracking {
    ...
    static void Acquire(const ScopedGeneric<int, ScopedFDCloseTraits>& owner, int fd);
    static void Release(const ScopedGeneric<int, ScopedFDCloseTraits>& owner, int fd);
};
