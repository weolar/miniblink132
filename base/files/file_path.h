...
public:
    ...
    const StringType& value() const LIFETIME_BOUND
    {
        return path_;
    }
    ...
    [[nodiscard]] FilePath InsertBeforeExtensionASCII(std::string_view suffix) const;
    ...
    static bool CompareEqualIgnoreCase(StringPieceType string1, StringPieceType string2)
    {
        return CompareIgnoreCase(string1, string2) == 0;
    }
    static bool CompareLessIgnoreCase(StringPieceType string1, StringPieceType string2)
    {
        return CompareIgnoreCase(string1, string2) < 0;
    }
    ...
    static int HFSFastUnicodeCompare(StringPieceType string1, StringPieceType string2);
#endif
...
BASE_EXPORT std::ostream& operator<<(std::ostream& out, const FilePath& file_path);
