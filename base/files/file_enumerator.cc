...
FileEnumerator::FileInfo& FileEnumerator::FileInfo::operator=(const FileEnumerator::FileInfo& that) = default;

FileEnumerator::FileInfo& FileEnumerator::FileInfo::operator=(FileEnumerator::FileInfo&& that) = default;
