...
public:
    ...
    ImportantFileWriterCleaner& operator=(const ImportantFileWriterCleaner&) = delete;
...
private:
    ...
    static bool CleanInBackground(Time upper_bound_time, std::vector<FilePath> directories, std::atomic_bool& stop_flag);
