 ...
 * @stable ICU 2.4
 */
#define CBU_IS_UNICODE_CHAR(c) ((uint32_t)(c) < 0xd800 || (0xdfff < (c) && (c) <= 0x10ffff && !CBU_IS_UNICODE_NONCHAR(c)))
...
#define CBU8_LENGTH(c)                                                                                                                                         \
    ((uint32_t)(c) <= 0x7f                                                                                                                                     \
            ...
            : ((uint32_t)(c) <= 0x7ff                                                                                                                          \
                    ? 2                                                                                                                                        \
                    : ((uint32_t)(c) <= 0xd7ff ? 3 : ((uint32_t)(c) <= 0xdfff || (uint32_t)(c) > 0x10ffff ? 0 : ((uint32_t)(c) <= 0xffff ? 3 : 4)))))
            ...
            if ((i) != (length) && /* fetch/validate/assemble all but last trail byte */                                                                       \
                ((c) >= 0xe0 ? ((c) < 0xf0 ? /* U+0800..U+FFFF except surrogates */                                                                            \
                                       ...
                                       ((c) -= 0xf0) <= 4 && CBU8_LEAD4_T1_BITS[(__t = (s)[i]) >> 4] & (1 << (c))                                              \
                                           && ((c) = ((c) << 6) | (__t & 0x3f), ++(i) != (length)) && (__t = (s)[i] - 0x80) <= 0x3f)                           \
 ...
 * @stable ICU 2.4
 */
#define CBU16_GET_SUPPLEMENTARY(lead, trail) (((::base_icu::UChar32)(lead) << 10UL) + (::base_icu::UChar32)(trail)-CBU16_SURROGATE_OFFSET)
