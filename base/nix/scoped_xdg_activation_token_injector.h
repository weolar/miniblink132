...
public:
    ScopedXdgActivationTokenInjector(base::CommandLine& command_line, base::Environment& env);

    ScopedXdgActivationTokenInjector(const ScopedXdgActivationTokenInjector&) = delete;
    ScopedXdgActivationTokenInjector& operator=(const ScopedXdgActivationTokenInjector&) = delete;
