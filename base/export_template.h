...
#define EXPORT_TEMPLATE_DECLARE(foo_export) EXPORT_TEMPLATE_INVOKE(DECLARE, EXPORT_TEMPLATE_STYLE(foo_export), foo_export)
...
#define EXPORT_TEMPLATE_INVOKE(which, style, foo_export) EXPORT_TEMPLATE_INVOKE_2(which, style, foo_export)
#define EXPORT_TEMPLATE_INVOKE_2(which, style, foo_export) EXPORT_TEMPLATE_##which##_##style(foo_export)
...
#define EXPORT_TEMPLATE_STYLE_2(foo_export) EXPORT_TEMPLATE_STYLE_MATCH_foj3FJo5StF0OvIzl7oMxA##foo_export
...
#define EXPORT_TEMPLATE_TEST(want, foo_export) static_assert(EXPORT_TEMPLATE_INVOKE(TEST_##want, EXPORT_TEMPLATE_STYLE(foo_export), foo_export), #foo_export)
