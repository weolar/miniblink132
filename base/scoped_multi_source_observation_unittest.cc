...
using TestScopedMultiSourceObservation = ScopedMultiSourceObservation<TestSource, TestSourceObserver>;
...
using TestScopedMultiSourceObservationWithNonDefaultNames = ScopedMultiSourceObservation<TestSourceWithNonDefaultNames, TestSourceObserver>;
