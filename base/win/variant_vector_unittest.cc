...
TEST(VariantVectorTest, MoveAssignOperator)
{
    ...
    Microsoft::WRL::ComPtr<IDispatch> dispatch1 = Microsoft::WRL::Make<DispatchStub>();
    Microsoft::WRL::ComPtr<IDispatch> dispatch2 = Microsoft::WRL::Make<DispatchStub>();
...
TEST(VariantVectorTest, ResetWithManagedContents)
{
    ...
    Microsoft::WRL::ComPtr<IUnknown> unknown1 = Microsoft::WRL::Make<DispatchStub>();
...
TEST(VariantVectorTest, ReleaseAsScalarVariantMultipleUnknown)
{
    ...
    Microsoft::WRL::ComPtr<IUnknown> unknown1 = Microsoft::WRL::Make<DispatchStub>();
    Microsoft::WRL::ComPtr<IUnknown> unknown2 = Microsoft::WRL::Make<DispatchStub>();
...
TEST(VariantVectorTest, ReleaseAsSafearrayVariantSingleBool)
{
    ...
    std::optional<ScopedSafearray::LockScope<kVariantType>> lock_scope = safearray.CreateLockScope<kVariantType>();
