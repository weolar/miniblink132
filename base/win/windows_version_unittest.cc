...
TEST(WindowsVersion, GetVersionExAndKernelOsVersionMatch)
{
    ...
    // 18363.
    EXPECT_EQ(OSInfo::Kernel32VersionNumber().major, OSInfo::GetInstance()->version_number().major);
    EXPECT_EQ(OSInfo::Kernel32VersionNumber().minor, OSInfo::GetInstance()->version_number().minor);
}
...
TEST(WindowsVersion, CheckDbgHelpVersion)
{
    ...
    auto file_version = FileVersionInfoWin::CreateFileVersionInfoWin(dbghelp_path);
...
TEST(OSInfo, MajorMinorBuildToVersion)
{
    ...
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 32767), Version::WIN11_24H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 26100), Version::WIN11_24H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 22631), Version::WIN11_23H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 22621), Version::WIN11_22H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 22000), Version::WIN11);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 21999), Version::SERVER_2022);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 20348), Version::SERVER_2022);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 20347), Version::WIN10_22H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 19045), Version::WIN10_22H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 19044), Version::WIN10_21H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 19043), Version::WIN10_21H1);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 19042), Version::WIN10_20H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 19041), Version::WIN10_20H1);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 18363), Version::WIN10_19H2);
    EXPECT_EQ(OSInfo::MajorMinorBuildToVersion(10, 0, 18362), Version::WIN10_19H1);
...
TEST(OSInfo, GetWowStatusForProcess)
{
    ...
    if (OSInfo::GetArchitecture() == OSInfo::X86_ARCHITECTURE) {
        ...
        // other host machines.
        EXPECT_TRUE(OSInfo::GetInstance()->IsWowX86OnARM64() || OSInfo::GetInstance()->IsWowX86OnOther());
    }
#else
    ADD_FAILURE() << "This test fails when we're using a process or host machine that is "
