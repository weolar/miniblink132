...
BASE_EXPORT bool GetUserPreferredUILanguageList(std::vector<std::wstring>* languages);
...
BASE_EXPORT bool GetThreadPreferredUILanguageList(std::vector<std::wstring>* languages);
