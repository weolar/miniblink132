...
template <typename T> using VectorComplex = typename ABI::Windows::Foundation::Collections::IVector<T>::T_complex;

template <typename T> using VectorLogical = LogicalType<VectorComplex<T>>;

template <typename T> using VectorAbi = AbiType<VectorComplex<T>>;

template <typename T> using VectorStorage = StorageType<VectorComplex<T>>;
...
public:
    ...
    explicit VectorIterator(Microsoft::WRL::ComPtr<ABI::Windows::Foundation::Collections::IVectorView<LogicalT>> view)
        : view_(std::move(view))
    {
    }
    ...
    IFACEMETHODIMP GetMany(unsigned capacity, AbiT* value, unsigned* actual) override
    {
...
public:
    VectorChangedEventArgs(ABI::Windows::Foundation::Collections::CollectionChange change, unsigned int index)
        : change_(change)
        , index_(index)
    {
    }
...
public:
    ...
    IFACEMETHODIMP GetMany(unsigned start_index, unsigned capacity, AbiT* value, unsigned* actual) override
    {
    ...
    IFACEMETHODIMP Invoke(
        ABI::Windows::Foundation::Collections::IObservableVector<LogicalT>* sender, ABI::Windows::Foundation::Collections::IVectorChangedEventArgs* e) override
    {
...
// improves safety.
template <typename T>
class Vector : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::WinRt | Microsoft::WRL::InhibitRoOriginateError>,
...
public:
    ...
    Vector() = default;
    explicit Vector(const std::vector<StorageT>& vector)
        : vector_(vector)
    {
    }
    ...
    IFACEMETHODIMP GetView(ABI::Windows::Foundation::Collections::IVectorView<LogicalT>** view) override
    {
    ...
    IFACEMETHODIMP IndexOf(AbiT value, unsigned* index, boolean* found) override
    {
        auto iter = base::ranges::find_if(vector_, [&value](const StorageT& elem) { return internal::IsEqual(elem, value); });
    ...
    IFACEMETHODIMP SetAt(unsigned index, AbiT item) override
    {
        ...
        NotifyVectorChanged(ABI::Windows::Foundation::Collections::CollectionChange_ItemChanged, index);
        return S_OK;
    }
    ...
    IFACEMETHODIMP InsertAt(unsigned index, AbiT item) override
    {
        ...
        NotifyVectorChanged(ABI::Windows::Foundation::Collections::CollectionChange_ItemInserted, index);
        return S_OK;
    }
    ...
    IFACEMETHODIMP RemoveAt(unsigned index) override
    {
        ...
        NotifyVectorChanged(ABI::Windows::Foundation::Collections::CollectionChange_ItemRemoved, index);
        return S_OK;
    }
    ...
    IFACEMETHODIMP Append(AbiT item) override
    {
        ...
        NotifyVectorChanged(ABI::Windows::Foundation::Collections::CollectionChange_ItemInserted, vector_.size() - 1);
        return S_OK;
    }
    ...
    IFACEMETHODIMP RemoveAtEnd() override
    {
        ...
        vector_.pop_back();
        NotifyVectorChanged(ABI::Windows::Foundation::Collections::CollectionChange_ItemRemoved, vector_.size());
        return S_OK;
    }
    ...
    IFACEMETHODIMP add_VectorChanged(
        ABI::Windows::Foundation::Collections::VectorChangedEventHandler<LogicalT>* handler, EventRegistrationToken* token) override
    {
    ...
    void NotifyVectorChanged(ABI::Windows::Foundation::Collections::CollectionChange change, unsigned int index)
    {
    ...
    IFACEMETHODIMP First(ABI::Windows::Foundation::Collections::IIterator<LogicalT>** first) override
    {
    ...
    const std::vector<AbiT>& vector_for_testing()
    {
        return vector_;
    }
...
private:
    ...
    base::flat_map<int64_t, ABI::Windows::Foundation::Collections::VectorChangedEventHandler<LogicalT>*> handlers_;
