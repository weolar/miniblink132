...
static_assert(sizeof(CHROME_WIN32_FIND_DATA) == sizeof(WIN32_FIND_DATA), "Definition mismatch.");
static_assert(sizeof(CHROME_FORMATETC) == sizeof(FORMATETC), "Definition mismatch.");
