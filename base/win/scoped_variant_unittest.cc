...
{
    ScopedVariant var;
    Microsoft::WRL::ComPtr<IDispatch> dispatch_stub = Microsoft::WRL::Make<DispatchStub>();
...
{
    ScopedVariant var;
    Microsoft::WRL::ComPtr<IUnknown> unknown_stub = Microsoft::WRL::Make<DispatchStub>();
