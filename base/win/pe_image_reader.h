...
public:
    ...
    using EnumCertificatesCallback = bool (*)(uint16_t revision, uint16_t certificate_type, base::span<const uint8_t> certificate_data, void* context);
    ...
    const IMAGE_DEBUG_DIRECTORY* GetDebugEntry(size_t index, span<const uint8_t>& raw_data);
...
private:
    ...
    template <class OPTIONAL_HEADER_TYPE> class OptionalHeaderImpl;
    ...
    template <typename T> bool GetStructureAt(size_t offset, size_t structure_size, const T** structure)
    {
