...
BASE_EXPORT std::optional<WmiError> RunWmiQuery(
    const std::wstring& server_name, const std::wstring& query, Microsoft::WRL::ComPtr<IEnumWbemClassObject>* enumerator);
...
BASE_EXPORT bool CreateLocalWmiConnection(bool set_blanket, Microsoft::WRL::ComPtr<IWbemServices>* wmi_services);
...
BASE_EXPORT Microsoft::WRL::ComPtr<IWbemServices> CreateWmiConnection(bool set_blanket, const std::wstring& resource);
...
BASE_EXPORT bool CreateWmiClassMethodObject(
    IWbemServices* wmi_services, std::wstring_view class_name, std::wstring_view method_name, Microsoft::WRL::ComPtr<IWbemClassObject>* class_instance);
...
BASE_EXPORT bool WmiLaunchProcess(const std::wstring& command_line, int* process_id);
...
public:
    ...
    const std::wstring& serial_number() const
    {
        return serial_number_;
    }

private:
    void PopulateSerialNumber(const Microsoft::WRL::ComPtr<IEnumWbemClassObject>& enumerator_bios);
