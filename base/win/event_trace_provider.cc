...
ULONG WINAPI EtwTraceProvider::ControlCallback(WMIDPREQUESTCODE request, void* context, ULONG* reserved, void* buffer)
{
...
ULONG EtwTraceProvider::Register()
{
    ...
    return ::RegisterTraceGuids(ControlCallback, this, &provider_name_, 1, &obligatory_guid_registration_, nullptr, nullptr, &registration_handle_);
}
...
ULONG EtwTraceProvider::Log(const EtwEventClass& event_class, EtwEventType type, EtwEventLevel level, const char* message)
{
