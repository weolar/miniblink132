...
public:
    ...
    bool StartWatchingOnce(HANDLE object, Delegate* delegate, const Location& from_here = Location::Current());
    ...
    // Returns whether watching was successfully initiated.
    bool StartWatchingMultipleTimes(HANDLE object, Delegate* delegate, const Location& from_here = Location::Current());
...
private:
    ...
    bool StartWatchingInternal(HANDLE object, Delegate* delegate, bool execute_only_once, const Location& from_here);
