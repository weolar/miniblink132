...
protected:
    void SetUp() override
    {
        ...
        {
            const FilePath target_file(temp_dir_.GetPath().Append(FILE_PATH_LITERAL("Target 1.txt")));
            ...
            static constexpr CLSID toast_activator_clsid = { 0x08d401c2, 0x3f79, 0x41d8, { 0x89, 0xd0, 0x99, 0x25, 0xee, 0x16, 0x28, 0x63 } };
        ...
        {
            const FilePath target_file_2(temp_dir_.GetPath().Append(FILE_PATH_LITERAL("Target 2.txt")));
...
TEST_F(ShortcutTest, CreateAndResolveShortcutProperties)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(file_1, link_properties_, ShortcutOperation::kCreateAlways));

    ShortcutProperties properties_read_1;
    ASSERT_TRUE(ResolveShortcutProperties(file_1, ShortcutProperties::PROPERTIES_ALL, &properties_read_1));
    EXPECT_EQ(static_cast<unsigned>(ShortcutProperties::PROPERTIES_ALL), properties_read_1.options);
    ValidatePathsAreEqual(link_properties_.target, properties_read_1.target);
    ValidatePathsAreEqual(link_properties_.working_dir, properties_read_1.working_dir);
    ...
    EXPECT_EQ(link_properties_.toast_activator_clsid, properties_read_1.toast_activator_clsid);
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(file_2, only_target_properties, ShortcutOperation::kCreateAlways));

    ShortcutProperties properties_read_2;
    ASSERT_TRUE(ResolveShortcutProperties(file_2, ShortcutProperties::PROPERTIES_ALL, &properties_read_2));
    EXPECT_EQ(static_cast<unsigned>(ShortcutProperties::PROPERTIES_ALL), properties_read_2.options);
    ValidatePathsAreEqual(only_target_properties.target, properties_read_2.target);
...
TEST_F(ShortcutTest, CreateAndResolveShortcut)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, only_target_properties, ShortcutOperation::kCreateAlways));
...
{
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, link_properties_, ShortcutOperation::kCreateAlways));
...
TEST_F(ShortcutTest, CreateShortcutWithOnlySomeProperties)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, target_and_args_properties, ShortcutOperation::kCreateAlways));
...
TEST_F(ShortcutTest, UpdateShortcutVerifyPropertiess)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, link_properties_2_, ShortcutOperation::kUpdateExisting));
...
TEST_F(ShortcutTest, UpdateShortcutUpdateOnlyTargetAndResolve)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, update_only_target_properties, ShortcutOperation::kUpdateExisting));
...
TEST_F(ShortcutTest, UpdateShortcutMakeDualMode)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, make_dual_mode_properties, ShortcutOperation::kUpdateExisting));
...
{
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, link_properties_2_, ShortcutOperation::kCreateAlways));

    ShortcutProperties remove_dual_mode_properties;
    remove_dual_mode_properties.set_dual_mode(false);

    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, remove_dual_mode_properties, ShortcutOperation::kUpdateExisting));
...
TEST_F(ShortcutTest, UpdateShortcutClearArguments)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, clear_arguments_properties, ShortcutOperation::kUpdateExisting));
...
{
    ASSERT_FALSE(CreateOrUpdateShortcutLink(link_file_, link_properties_, ShortcutOperation::kUpdateExisting));
...
TEST_F(ShortcutTest, ReplaceShortcutAllProperties)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, link_properties_2_, ShortcutOperation::kReplaceExisting));
...
TEST_F(ShortcutTest, ReplaceShortcutSomeProperties)
{
    ...
    ASSERT_TRUE(CreateOrUpdateShortcutLink(link_file_, new_properties, ShortcutOperation::kReplaceExisting));
...
{
    ASSERT_FALSE(CreateOrUpdateShortcutLink(link_file_, link_properties_, ShortcutOperation::kReplaceExisting));
    ASSERT_FALSE(PathExists(link_file_));
}
