...
struct ScopedPdhQueryTraits {
    static PDH_HQUERY InvalidValue()
    {
        return nullptr;
    }
    static void Free(PDH_HQUERY query)
    {
        ::PdhCloseQuery(query);
    }
};
...
//   }
class BASE_EXPORT ScopedPdhQuery : public ScopedGeneric<PDH_HQUERY, internal::ScopedPdhQueryTraits> {
public:
