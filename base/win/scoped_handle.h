...
enum class HandleOperation { kHandleAlreadyTracked, kCloseHandleNotTracked, kCloseHandleNotOwner, kCloseHandleHook, kDuplicateHandleHook };
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(ScopedHandleDeathTest, HandleVerifierUntrackedHandle);
    Handle handle_;
};
