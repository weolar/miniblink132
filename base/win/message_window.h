...
public:
    ...
    using MessageCallback = base::RepeatingCallback<bool(UINT message, WPARAM wparam, LPARAM lparam,
    ...
    bool CreateNamed(MessageCallback message_callback, const std::wstring& window_name);
