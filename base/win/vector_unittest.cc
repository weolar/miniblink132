...
// using `uuidgen`.
template <> struct __declspec(uuid("21c2c195-91a4-4fce-8346-2a85f4478e26")) IObservableVector<int> : IObservableVector_impl<int> { };

template <> struct __declspec(uuid("86b0071e-5e72-4d3d-82d3-420ebd2b2716")) VectorChangedEventHandler<int> : VectorChangedEventHandler_impl<int> { };

namespace {
using UriPtrAggregate = Internal::AggregateType<Uri*, IUriRuntimeClass*>;
}

template <> struct __declspec(uuid("12311764-f245-4245-9dc9-bab258eddd4e")) IObservableVector<Uri*> : IObservableVector_impl<UriPtrAggregate> { };

template <>
struct __declspec(uuid("050e4b78-71b2-43ff-bf7c-f6ba589aced9")) VectorChangedEventHandler<Uri*> : VectorChangedEventHandler_impl<UriPtrAggregate> { };
...
template <> struct __declspec(uuid("0d82bd8d-fe62-5d67-a7b9-7886dd75bc4e")) IVector<Uri*> : IVector_impl<Internal::AggregateType<Uri*, IUriRuntimeClass*>> { };

template <>
struct __declspec(uuid("4b8385bd-a2cd-5ff1-bf74-7ea580423e50")) IVectorView<Uri*> : IVectorView_impl<Internal::AggregateType<Uri*, IUriRuntimeClass*>> { };

template <>
struct __declspec(uuid("1c157d0f-5efe-5cec-bbd6-0c6ce9af07a5")) IIterator<Uri*> : IIterator_impl<Internal::AggregateType<Uri*, IUriRuntimeClass*>> { };

template <>
struct __declspec(uuid("b0d63b78-78ad-5e31-b6d8-e32a0e16c447")) IIterable<Uri*> : IIterable_impl<Internal::AggregateType<Uri*, IUriRuntimeClass*>> { };
#endif
...
template <typename T>
class FakeVectorChangedEventHandler : public RuntimeClass<RuntimeClassFlags<ClassicCom | InhibitRoOriginateError>, VectorChangedEventHandler<T>> {
public:
    ...
    IFACEMETHODIMP Invoke(IObservableVector<T>* sender, IVectorChangedEventArgs* e)
    {
        sender_ = sender;
