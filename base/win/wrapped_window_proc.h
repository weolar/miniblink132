...
BASE_EXPORT WinProcExceptionFilter SetWinProcExceptionFilter(WinProcExceptionFilter filter);
...
//
template <WNDPROC proc> LRESULT CALLBACK WrappedWindowProc(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam)
{
    LRESULT rv = 0;
    __try {
