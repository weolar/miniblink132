...
TEST(ScopedNativeLibrary, Basic)
{
    ...
    NativeLibrary native_library;
    {
        ...
        EXPECT_EQ(GetFunctionPointerFromNativeLibrary(native_library, kFunctionName), test_function);
    }
    EXPECT_FALSE(GetFunctionPointerFromNativeLibrary(native_library, kFunctionName));
#endif
}
