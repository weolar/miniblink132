...
public:
    ...
    void EnableIfNotSetWithParameter(const Feature& feature, std::string_view name, std::string_view value);
    ...
    bool IsEnabledWithParameter(const Feature& feature, std::string_view parameter_name, std::string_view parameter_value);

private:
    void AddFeatureIfNotSet(const Feature& feature, std::string_view suffix, bool enable);
