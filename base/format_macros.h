...
#if (BUILDFLAG(IS_POSIX) || BUILDFLAG(IS_FUCHSIA)) && (defined(_INTTYPES_H) || defined(_INTTYPES_H_)) && !defined(PRId64)
#error "inttypes.h has already been included before this header file, but "
#error "without __STDC_FORMAT_MACROS defined."
#endif

#if (BUILDFLAG(IS_POSIX) || BUILDFLAG(IS_FUCHSIA)) && !defined(__STDC_FORMAT_MACROS)
