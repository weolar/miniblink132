...
typedef bool (*AInputReceiver_onMotionEvent)(void* context, AInputEvent* motionEvent);

using pAInputTransferToken_fromJava = AInputTransferToken* (*)(JNIEnv*, jobject);
using pAInputTransferToken_toJava = jobject (*)(JNIEnv*, const AInputTransferToken*);
using pAInputTransferToken_release = void (*)(AInputTransferToken* aInputTransferToken);
using pAInputEvent_toJava = jobject (*)(JNIEnv*, const AInputEvent*);
using pAInputReceiverCallbacks_create = AInputReceiverCallbacks* (*)(void* context);
using pAInputReceiverCallbacks_release = void (*)(AInputReceiverCallbacks* callbacks);
using pAInputReceiverCallbacks_setMotionEventCallback = void (*)(AInputReceiverCallbacks*, AInputReceiver_onMotionEvent);
using pAInputReceiver_createUnbatchedInputReceiver
    = AInputReceiver* (*)(ALooper*, const AInputTransferToken*, const ASurfaceControl*, AInputReceiverCallbacks*);
using pAInputReceiver_getInputTransferToken = AInputTransferToken* (*)(AInputReceiver*);
...
public:
    ...
    AndroidInputReceiverCompat& operator=(const AndroidInputReceiverCompat&) = delete;
    ...
    pAInputReceiverCallbacks_setMotionEventCallback AInputReceiverCallbacks_setMotionEventCallbackFn;
    pAInputReceiver_createUnbatchedInputReceiver AInputReceiver_createUnbatchedInputReceiverFn;
