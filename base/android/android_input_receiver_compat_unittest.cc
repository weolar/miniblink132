...
{
    if (base::android::BuildInfo::GetInstance()->sdk_int() < base::android::SdkVersion::SDK_VERSION_V) {
    ...
    const AndroidInputReceiverCompat& instance = AndroidInputReceiverCompat::GetInstance();
