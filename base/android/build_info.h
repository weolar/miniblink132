...
public:
    ...
    const char* host_package_name() const
    {
        return host_package_name_;
    }
    ...
    const char* host_version_code() const
    {
        return host_version_code_;
    }
    ...
    const char* host_package_label() const
    {
        return host_package_label_;
    }
    ...
    const char* custom_themes() const
    {
        return custom_themes_;
    }

    const char* resources_version() const
    {
        return resources_version_;
    }
    ...
    const char* installer_package_name() const
    {
        return installer_package_name_;
    }

    const char* abi_name() const
    {
        return abi_name_;
    }
    ...
    bool is_debug_android() const
    {
        return is_debug_android_;
    }
    ...
    const char* version_incremental() const
    {
        return version_incremental_;
    }

    const char* hardware() const
    {
        return hardware_;
    }

    bool is_at_least_t() const
    {
        return is_at_least_t_;
    }

    bool is_automotive() const
    {
        return is_automotive_;
    }

    bool is_at_least_u() const
    {
        return is_at_least_u_;
    }

    bool targets_at_least_u() const
    {
        return targets_at_least_u_;
    }
    ...
    int32_t vulkan_deqp_level() const
    {
        return vulkan_deqp_level_;
    }

    // Available only on android S+. For S-, this method returns empty string.
    const char* soc_manufacturer() const
    {
        return soc_manufacturer_;
    }

    bool is_debug_app() const
    {
        return is_debug_app_;
    }
