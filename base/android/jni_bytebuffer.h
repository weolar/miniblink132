...
base::span<const uint8_t> BASE_EXPORT JavaByteBufferToSpan(JNIEnv* env, jobject buffer);

base::span<uint8_t> BASE_EXPORT JavaByteBufferToMutableSpan(JNIEnv* env, jobject buffer);

std::optional<base::span<const uint8_t>> BASE_EXPORT MaybeJavaByteBufferToSpan(JNIEnv* env, jobject buffer);

std::optional<base::span<uint8_t>> BASE_EXPORT MaybeJavaByteBufferToMutableSpan(JNIEnv* env, jobject buffer);
