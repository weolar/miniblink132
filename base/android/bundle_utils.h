...
public:
    ...
    static std::string ResolveLibraryPath(const std::string& library_name, const std::string& split_name);
    ...
    static void* DlOpenModuleLibraryPartition(const std::string& library_name, const std::string& partition, const std::string& split_name);
};
