...
public:
    ...
    ScopedHardwareBufferHandle& operator=(const ScopedHardwareBufferHandle&) = delete;
    ...
    [[nodiscard]] static ScopedHardwareBufferHandle DeserializeFromFileDescriptor(ScopedFD fd);
