...
namespace {
std::optional<uint64_t> CalculateProcessMemoryFootprint(base::File& statm_file, base::File& status_file)
{
...
// static
std::optional<uint64_t> PmfUtils::CalculatePrivateMemoryFootprintForTesting(base::File& statm_file, base::File& status_file)
{
...
std::optional<uint64_t> PmfUtils::GetPrivateMemoryFootprintForCurrentProcess()
{
    ...
    base::File status_file(proc_self_dir.Append("status"), base::File::Flags::FLAG_OPEN | base::File::Flags::FLAG_READ);
    base::File statm_file(proc_self_dir.Append("statm"), base::File::Flags::FLAG_OPEN | base::File::Flags::FLAG_READ);
