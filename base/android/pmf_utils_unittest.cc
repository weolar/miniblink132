...
TEST(PmfUtilsTest, CalculatePrivateMemoryFootprint)
{
    ...
    const uint64_t expected_pmf = (40 - 25) * getpagesize() / 1024 + expected_swap_kb;
    ...
    std::optional<uint64_t> pmf = PmfUtils::CalculatePrivateMemoryFootprintForTesting(statm_file, status_file);
