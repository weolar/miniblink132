...
// static
std::optional<UnguessableToken> UnguessableToken::Deserialize(uint64_t high, uint64_t low)
{
...
// static
std::optional<UnguessableToken> UnguessableToken::DeserializeFromString(std::string_view string_representation)
{
