...
template <class Source, class Observer> class ScopedMultiSourceObservation {
public:
    ...
    ScopedMultiSourceObservation& operator=(const ScopedMultiSourceObservation&) = delete;
    ...
    bool IsObservingAnySource() const
    {
    ...
    const std::vector<raw_ptr<Source>>& sources() const
    {
        return sources_;
    }
