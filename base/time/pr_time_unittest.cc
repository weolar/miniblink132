...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("Mon, 15 Oct 2007 19:45:00 GMT", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("Mon Oct 15 12:45 PDT 2007", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_pdt, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("Monday, Oct 15, 2007 12:45 PM", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_local_, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("10/15/07 12:45:00.0 PM", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_local_, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("15-OCT-2007 12:45pm", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_local_, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("16 Oct 2007 4:45-JST (Tuesday)", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_pdt, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-08T11:28:12.441381+02:00", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-08T11:28:12.441381+0200", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_2, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-08T11:28:12.4413819+02", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_2, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-08T09:28:12.44138Z", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-08T11:28:12.441381", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-08T09:28:12.441381Z", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_2, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-08 09:28:12.441381Z", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_2, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("201-07-08T09:28:12.441381Z", PR_FALSE, &parsed_time);
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-007-08T09:28:12.441381Z", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_FAILURE, result);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("2013-07-008T09:28:12.441381Z", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_FAILURE, result);
}
...
TEST_F(PRTimeTest, ParseTimeTestOutOfRange)
{
    ...
    // timezone.
    PRStatus result = PR_ParseTimeString("Sun Jan  2 00:00:00 3001", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("Mon Oct 15 12:44:60 PDT 2007", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_pdt, parsed_time);
}
...
{
    PRTime parsed_time = 0;
    PRStatus result = PR_ParseTimeString("Sun Oct 14 36:45 PDT 2007", PR_FALSE, &parsed_time);
    EXPECT_EQ(PR_SUCCESS, result);
    EXPECT_EQ(comparison_time_pdt, parsed_time);
}
