...
#if (BUILDFLAG(IS_POSIX) && defined(_POSIX_MONOTONIC_CLOCK) && _POSIX_MONOTONIC_CLOCK >= 0) || BUILDFLAG(IS_BSD) || BUILDFLAG(IS_ANDROID)
...
{
#if (defined(_POSIX_THREAD_CPUTIME) && (_POSIX_THREAD_CPUTIME >= 0)) || BUILDFLAG(IS_ANDROID)
