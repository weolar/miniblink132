...
using TimeTicksLowResolutionNowFunction = decltype(&TimeTicks::LowResolutionNow);
...
public:
    ...
    ScopedTimeClockOverrides(TimeNowFunction time_override, TimeTicksNowFunction time_ticks_override, ThreadTicksNowFunction thread_ticks_override,
        LiveTicksNowFunction live_ticks_override = nullptr, TimeTicksLowResolutionNowFunction time_ticks_low_resolution_override = nullptr);
...
extern std::atomic<TimeTicksNowFunction> g_time_ticks_low_resolution_now_function;
