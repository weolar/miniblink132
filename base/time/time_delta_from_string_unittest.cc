...
TEST(TimeDeltaFromStringTest, ParseTimeDeltaTest)
{
    ...
    EXPECT_EQ(TimeDeltaFromString("9223372036854775807us"), Microseconds(9223372036854775807));
    EXPECT_EQ(TimeDeltaFromString("-9223372036854775807us"), Microseconds(-9223372036854775807));
    ...
    EXPECT_EQ(TimeDeltaFromString("3m4s5us"), Minutes(3) + Seconds(4) + Microseconds(5));
    EXPECT_EQ(TimeDeltaFromString("2h3m4s5ms6us7ns"), Hours(2) + Minutes(3) + Seconds(4) + Milliseconds(5) + Microseconds(6) + Nanoseconds(7));

    // Multiple units out of order.
    EXPECT_EQ(TimeDeltaFromString("2us3m4s5h"), Hours(5) + Minutes(3) + Seconds(4) + Microseconds(2));
    ...
    EXPECT_EQ(TimeDeltaFromString("0.4294967295s"), Nanoseconds(429496729) + Nanoseconds(1) / 2);
    EXPECT_EQ(TimeDeltaFromString("0.429496729501234567890123456789s"), Nanoseconds(429496729) + Nanoseconds(1) / 2);
