...
template <typename Functor, typename... Args> inline auto BindOnce(Functor&& functor, Args&&... args)
{
    return internal::BindHelper<OnceCallback>::Bind(std::forward<Functor>(functor), std::forward<Args>(args)...);
}

// Bind as RepeatingCallback.
template <typename Functor, typename... Args> inline auto BindRepeating(Functor&& functor, Args&&... args)
{
    return internal::BindHelper<RepeatingCallback>::Bind(std::forward<Functor>(functor), std::forward<Args>(args)...);
}
...
// pointer as receiver.
template <typename T> inline auto Unretained(T* o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayNotDangle>(o);
}

template <typename T, RawPtrTraits Traits> inline auto Unretained(const raw_ptr<T, Traits>& o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayNotDangle, Traits>(o);
}

template <typename T, RawPtrTraits Traits> inline auto Unretained(raw_ptr<T, Traits>&& o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayNotDangle, Traits>(std::move(o));
}

template <typename T, RawPtrTraits Traits> inline auto Unretained(const raw_ref<T, Traits>& o)
{
    return internal::UnretainedRefWrapper<T, unretained_traits::MayNotDangle, Traits>(o);
}

template <typename T, RawPtrTraits Traits> inline auto Unretained(raw_ref<T, Traits>&& o)
{
    return internal::UnretainedRefWrapper<T, unretained_traits::MayNotDangle, Traits>(std::move(o));
}
...
template <typename T> inline auto UnsafeDangling(T* o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayDangle>(o);
}

template <typename T, RawPtrTraits Traits> auto UnsafeDangling(const raw_ptr<T, Traits>& o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayDangle, Traits>(o);
}

template <typename T, RawPtrTraits Traits> auto UnsafeDangling(raw_ptr<T, Traits>&& o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayDangle, Traits>(std::move(o));
}

template <typename T, RawPtrTraits Traits> auto UnsafeDangling(const raw_ref<T, Traits>& o)
{
    return internal::UnretainedRefWrapper<T, unretained_traits::MayDangle, Traits>(o);
}

template <typename T, RawPtrTraits Traits> auto UnsafeDangling(raw_ref<T, Traits>&& o)
{
    return internal::UnretainedRefWrapper<T, unretained_traits::MayDangle, Traits>(std::move(o));
}
...
template <typename T> inline auto UnsafeDanglingUntriaged(T* o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayDangleUntriaged>(o);
}

template <typename T, RawPtrTraits Traits> auto UnsafeDanglingUntriaged(const raw_ptr<T, Traits>& o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayDangleUntriaged, Traits>(o);
}

template <typename T, RawPtrTraits Traits> auto UnsafeDanglingUntriaged(raw_ptr<T, Traits>&& o)
{
    return internal::UnretainedWrapper<T, unretained_traits::MayDangleUntriaged, Traits>(std::move(o));
}

template <typename T, RawPtrTraits Traits> auto UnsafeDanglingUntriaged(const raw_ref<T, Traits>& o)
{
    return internal::UnretainedRefWrapper<T, unretained_traits::MayDangleUntriaged, Traits>(o);
}

template <typename T, RawPtrTraits Traits> auto UnsafeDanglingUntriaged(raw_ref<T, Traits>&& o)
{
    return internal::UnretainedRefWrapper<T, unretained_traits::MayDangleUntriaged, Traits>(std::move(o));
}
...
template <typename T> inline internal::RetainedRefWrapper<T> RetainedRef(T* o)
{
    return internal::RetainedRefWrapper<T>(o);
}
template <typename T> inline internal::RetainedRefWrapper<T> RetainedRef(scoped_refptr<T> o)
{
...
template <typename T> inline internal::OwnedWrapper<T> Owned(T* o)
{
    return internal::OwnedWrapper<T>(o);
}

template <typename T, typename Deleter> inline internal::OwnedWrapper<T, Deleter> Owned(std::unique_ptr<T, Deleter>&& ptr)
{
...
template <typename T> internal::OwnedRefWrapper<std::decay_t<T>> OwnedRef(T&& t)
{
...
template <typename T> inline internal::PassedWrapper<T> Passed(T* scoper)
{
    return internal::PassedWrapper<T>(std::move(*scoper));
}
...
template <typename T> inline internal::IgnoreResultHelper<T> IgnoreResult(T data)
{
