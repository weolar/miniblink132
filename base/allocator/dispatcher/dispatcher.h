...
public:
    ...
    template <typename... ObserverTypes> void Initialize(const std::tuple<ObserverTypes...>& observers)
    {
    ...
    template <typename ObserverType> void InitializeForTesting(ObserverType* observer)
    {
