...
DispatchData& DispatchData::SetAllocationObserverHooks(AllocationObserverHook* allocation_observer_hook, FreeObserverHook* free_observer_hook)
{
...
DispatchData::AllocationObserverHook* DispatchData::GetAllocationObserverHook() const
{
...
DispatchData& DispatchData::SetAllocatorDispatch(AllocatorDispatch* allocator_dispatch)
{
