...
public:
    ...
    typedef void AllocationObserverHook(const AllocationNotificationData& notification_data);
    ...
    // *out.
    typedef bool AllocationOverrideHook(void** out, AllocFlags flags, size_t size, const char* type_name);
    ...
    static void SetObserverHooks(AllocationObserverHook* alloc_hook, FreeObserverHook* free_hook);
    static void SetOverrideHooks(AllocationOverrideHook* alloc_hook, FreeOverrideHook* free_hook, ReallocOverrideHook realloc_hook);
    ...
    static void AllocationObserverHookIfEnabled(const partition_alloc::AllocationNotificationData& notification_data);
    static bool AllocationOverrideHookIfEnabled(void** out, AllocFlags flags, size_t size, const char* type_name);

    static void FreeObserverHookIfEnabled(const FreeNotificationData& notification_data);
