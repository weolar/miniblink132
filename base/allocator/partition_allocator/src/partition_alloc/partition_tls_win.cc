...
void NTAPI PartitionTlsOnThreadExit(PVOID module, DWORD reason, PVOID reserved)
{
...
const PIMAGE_TLS_CALLBACK partition_tls_thread_exit_callback = partition_alloc::internal::PartitionTlsOnThreadExit;
...
PIMAGE_TLS_CALLBACK partition_tls_thread_exit_callback = partition_alloc::internal::PartitionTlsOnThreadExit;
