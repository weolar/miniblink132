...
[[noreturn]] PA_NOINLINE PA_COMPONENT_EXPORT(PARTITION_ALLOC) void PartitionExcessiveAllocationSize(size_t size);

#if !PA_BUILDFLAG(PA_ARCH_CPU_64_BITS)
[[noreturn]] PA_NOINLINE void PartitionOutOfMemoryWithLotsOfUncommitedPages(size_t size);
[[noreturn]] PA_NOINLINE void PartitionOutOfMemoryWithLargeVirtualSize(size_t virtual_size);
#endif
