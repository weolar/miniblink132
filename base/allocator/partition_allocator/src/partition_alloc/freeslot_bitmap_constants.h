...
constexpr size_t kFreeSlotBitmapBitsPerCell = sizeof(FreeSlotBitmapCellType) * CHAR_BIT;
...
constexpr size_t kFreeSlotBitmapSize = (kSuperPageSize / kSmallestBucket) / CHAR_BIT;

PA_ALWAYS_INLINE PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR size_t ReservedFreeSlotBitmapSize()
{
...
PA_ALWAYS_INLINE PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR size_t CommittedFreeSlotBitmapSize()
{
#if PA_BUILDFLAG(USE_FREESLOT_BITMAP)
...
PA_ALWAYS_INLINE PAGE_ALLOCATOR_CONSTANTS_DECLARE_CONSTEXPR size_t NumPartitionPagesPerFreeSlotBitmap()
{
