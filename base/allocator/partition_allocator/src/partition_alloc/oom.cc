...
[[noreturn]] PA_NOINLINE PA_NOT_TAIL_CALLED void OnNoMemoryInternal(size_t size)
{
    g_oom_size = size;
    ...
    ::RaiseException(win::kOomExceptionCode, EXCEPTION_NONCONTINUABLE, std::size(exception_args), exception_args);
