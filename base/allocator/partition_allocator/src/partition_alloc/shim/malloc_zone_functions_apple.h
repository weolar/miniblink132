...
typedef unsigned (*batch_malloc_type)(struct _malloc_zone_t* zone, size_t size, void** results, unsigned num_requested);
...
typedef boolean_t (*claimed_address_type)(struct _malloc_zone_t* zone, void* ptr);
