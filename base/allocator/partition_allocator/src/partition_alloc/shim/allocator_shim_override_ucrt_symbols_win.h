...
SHIM_ALWAYS_EXPORT void* operator new(size_t size, const std::nothrow_t&) noexcept
{
...
__declspec(restrict) void* _recalloc_base(void* block, size_t count, size_t size)
{
    ...
    const size_t new_block_size = allocator_shim::internal::CheckedMultiply(count, size);
...
// uses are introduced.
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_recalloc(void* address, size_t num, size_t size, size_t alignment)
{
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_offset_realloc(void* address, size_t size, size_t alignment, size_t offset)
{
    PA_CHECK(false) << "This routine has not been implemented";
    __builtin_unreachable();
}
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_offset_recalloc(void* address, size_t num, size_t size, size_t alignment, size_t offset)
{
    PA_CHECK(false) << "This routine has not been implemented";
    __builtin_unreachable();
}
...
{
    wchar_t* dest = static_cast<wchar_t*>(malloc(sizeof(wchar_t) * (wcslen(strSource) + 1)));
    wcscpy(dest, strSource);
    return dest;
}

PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
errno_t _dupenv_s(char** buffer, size_t* number_of_elements, const char* varname)
{
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
errno_t _wdupenv_s(wchar_t** buffer, size_t* number_of_elements, const wchar_t* varname)
{
    if (buffer == nullptr || varname == nullptr) {
        return EINVAL;
    }
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _realloc_dbg(void* ptr, size_t size, int, const char*, int)
{
    return ShimRealloc(ptr, size, nullptr);
}

PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _calloc_dbg(size_t n, size_t size, int, const char*, int)
{
    return ShimCalloc(n, size, nullptr);
}
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_malloc_dbg(size_t size, size_t alignment, const char*, int)
{
    return ShimAlignedMalloc(size, alignment, nullptr);
}

PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_realloc_dbg(void* address, size_t size, size_t alignment, const char*, int)
{
    return ShimAlignedRealloc(address, size, alignment, nullptr);
}
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _recalloc_dbg(void* block, size_t count, size_t size, int, const char*, int)
{
    return _recalloc_base(block, count, size);
}
...
// uses are introduced.
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_recalloc_dbg(void* address, size_t num, size_t size, size_t alignment, const char*, int)
{
    PA_CHECK(false) << "This routine has not been implemented";
    __builtin_unreachable();
}
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_offset_malloc_dbg(size_t const size, size_t const alignment, size_t const offset, const char*, int const)
{
    PA_CHECK(false) << "This routine has not been implemented";
    __builtin_unreachable();
}
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_offset_realloc_dbg(void* address, size_t size, size_t alignment, size_t offset)
{
    PA_CHECK(false) << "This routine has not been implemented";
    __builtin_unreachable();
}
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
__declspec(restrict) void* _aligned_offset_recalloc_dbg(void* address, size_t num, size_t size, size_t alignment, size_t offset, const char*, int)
{
    PA_CHECK(false) << "This routine has not been implemented";
    __builtin_unreachable();
}
...
PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
errno_t _dupenv_s_dbg(char** buffer, size_t* number_of_elements, const char* varname)
{
    return _dupenv_s(buffer, number_of_elements, varname);
}

PA_COMPONENT_EXPORT(ALLOCATOR_SHIM)
errno_t _wdupenv_s_dbg(wchar_t** buffer, size_t* number_of_elements, const wchar_t* varname)
{
