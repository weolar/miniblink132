...
SHIM_CPP_SYMBOLS_EXPORT void* operator new(std::size_t size, std::align_val_t alignment)
{
#if PA_BUILDFLAG(FORWARD_THROUGH_MALLOC)
...
SHIM_CPP_SYMBOLS_EXPORT void* operator new(std::size_t size, std::align_val_t alignment, const std::nothrow_t&) __THROW
{
#if PA_BUILDFLAG(FORWARD_THROUGH_MALLOC)
    return aligned_alloc(static_cast<size_t>(alignment), size);
#else
...
SHIM_CPP_SYMBOLS_EXPORT void operator delete(void* p, std::align_val_t) __THROW
{
#if PA_BUILDFLAG(FORWARD_THROUGH_MALLOC)
    free(p);
#else
...
SHIM_CPP_SYMBOLS_EXPORT void operator delete(void* p, std::size_t size, std::align_val_t) __THROW
{
#if PA_BUILDFLAG(FORWARD_THROUGH_MALLOC)
    free(p);
#else
...
SHIM_CPP_SYMBOLS_EXPORT void operator delete(void* p, std::align_val_t, const std::nothrow_t&) __THROW
{
#if PA_BUILDFLAG(FORWARD_THROUGH_MALLOC)
    free(p);
#else
