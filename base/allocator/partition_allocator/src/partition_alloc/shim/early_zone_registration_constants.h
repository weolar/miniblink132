...
static constexpr char kDelegatingZoneName[] = "DelegatingDefaultZoneForPartitionAlloc";
...
// structs.
#if (__MAC_OS_X_VERSION_MAX_ALLOWED >= 130000) || (__IPHONE_OS_VERSION_MAX_ALLOWED >= 160100)
