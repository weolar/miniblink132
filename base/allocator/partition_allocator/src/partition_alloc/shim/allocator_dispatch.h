...
struct AllocatorDispatch {
    ...
    using BatchMallocFn = unsigned(size_t size, void** results, unsigned num_requested, void* context);
    using BatchFreeFn = void(void** to_be_freed, unsigned num_to_be_freed, void* context);
    ...
    using AlignedMallocUncheckedFn = void*(size_t size, size_t alignment, void* context);
    using AlignedReallocFn = void*(void* address, size_t size, size_t alignment, void* context);
    using AlignedReallocUncheckedFn = void*(void* address, size_t size, size_t alignment, void* context);
    ...
    void OptimizeAllocatorDispatchTable(const AllocatorDispatch* original_table, const AllocatorDispatch* next_table)
    {
