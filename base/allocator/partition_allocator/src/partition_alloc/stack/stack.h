...
private:
    using StackTops = std::unordered_map<base::PlatformThreadId, void*, std::hash<base::PlatformThreadId>, std::equal_to<>,
        internal::InternalAllocator<std::pair<const base::PlatformThreadId, void*>>>;
