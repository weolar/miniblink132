...
public:
    ...
    AllocationNotificationData& SetMteReportingMode(TagViolationReportingMode mode)
    {
...
#if PA_BUILDFLAG(HAS_MEMORY_TAGGING)
    TagViolationReportingMode mte_reporting_mode_ = TagViolationReportingMode::kUndefined;
#endif
};
...
public:
    constexpr explicit FreeNotificationData(void* address)
        : address_(address)
    {
    }
