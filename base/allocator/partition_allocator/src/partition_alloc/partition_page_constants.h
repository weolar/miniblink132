...
#elif defined(PARTITION_ALLOCATOR_CONSTANTS_POSIX_NONCONST_PAGE_SIZE) && PA_BUILDFLAG(IS_LINUX)                                                                \
...
static constexpr size_t kMaxSlotsPerSlotSpan = PartitionPageSize() / kSmallestBucket;
