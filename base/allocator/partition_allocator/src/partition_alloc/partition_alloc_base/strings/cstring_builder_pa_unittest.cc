...
template <typename T> void FillBuffer(CStringBuilder& builder, T value, unsigned count)
{
...
TEST(CStringBuilderTestPA, Integer)
{
    ...
    EXPECT_EQ("18446744073709551615 -9223372036854775808", std::string(builder1.c_str()));
