...
#define PA_EXPORT_TEMPLATE_DECLARE(export) PA_EXPORT_TEMPLATE_INVOKE(DECLARE, PA_EXPORT_TEMPLATE_STYLE(export, ), export) // NOLINT
#define PA_EXPORT_TEMPLATE_DEFINE(export) PA_EXPORT_TEMPLATE_INVOKE(DEFINE, PA_EXPORT_TEMPLATE_STYLE(export, ), export) // NOLINT
...
#define PA_EXPORT_TEMPLATE_INVOKE(which, style, export) PA_EXPORT_TEMPLATE_INVOKE_2(which, style, export)
#define PA_EXPORT_TEMPLATE_INVOKE_2(which, style, export) PA_EXPORT_TEMPLATE_##which##_##style(export, )
...
#define PA_EXPORT_TEMPLATE_STYLE_2(export, _) PA_EXPORT_TEMPLATE_STYLE_3(PA_EXPORT_TEMPLATE_STYLE_MATCH_foj3FJo5StF0OvIzl7oMxA##export)
...
#define PA_EXPORT_TEMPLATE_STYLE_MATCH_foj3FJo5StF0OvIzl7oMxA__attribute__(...) DEFAULT
#define PA_EXPORT_TEMPLATE_STYLE_MATCH_foj3FJo5StF0OvIzl7oMxA__declspec(arg) PA_EXPORT_TEMPLATE_STYLE_MATCH_DECLSPEC_##arg
...
#define PA_EXPORT_TEMPLATE_TEST(want, export)                                                                                                                  \
    static_assert(PA_EXPORT_TEMPLATE_INVOKE(TEST_##want, PA_EXPORT_TEMPLATE_STYLE(export, ), export), #export) // NOLINT
