...
NativeLibrary LoadNativeLibrary(const FilePath& library_path, NativeLibraryLoadError* error);
...
PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE)
void* GetFunctionPointerFromNativeLibrary(NativeLibrary library, const std::string& name);
