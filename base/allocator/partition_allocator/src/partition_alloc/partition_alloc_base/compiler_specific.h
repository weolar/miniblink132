...
#define PA_PRINTF_FORMAT(format_param, dots_param) [[gnu::format(printf, format_param, dots_param)]]
#else
...
#define PA_ANALYZER_SKIP_THIS_PATH() static_cast<void>(::partition_alloc::internal::AnalyzerNoReturn())
#else
...
#define PA_ANALYZER_ASSUME_TRUE(arg) ::partition_alloc::internal::AnalyzerAssumeTrue(!!(arg))
#else
