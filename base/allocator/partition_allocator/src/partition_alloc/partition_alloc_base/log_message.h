...
typedef bool (*LogMessageHandlerFunction)(int severity, const char* file, int line, size_t message_start, const char* str);
...
class PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) Win32ErrorLogMessage : public LogMessage {
public:
...
class PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) ErrnoLogMessage : public LogMessage {
public:
