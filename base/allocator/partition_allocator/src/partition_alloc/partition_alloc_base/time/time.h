...
[[nodiscard]] PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) bool HasConstantRateTSC();

// Returns the frequency of the TSC in ticks per second, or 0 if it hasn't
// been measured yet. Needs to be guarded with a call to HasConstantRateTSC().
[[nodiscard]] PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) double TSCTicksPerSecond();
#endif
...
class PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) Time : public time_internal::TimeBase<Time> {
public:
...
class PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) TimeTicks : public time_internal::TimeBase<TimeTicks> {
public:
...
// thread is running.
class PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) ThreadTicks : public time_internal::TimeBase<ThreadTicks> {
public:
    ...
    {
#if (defined(_POSIX_THREAD_CPUTIME) && (_POSIX_THREAD_CPUTIME >= 0)) || PA_BUILDFLAG(IS_APPLE) || PA_BUILDFLAG(IS_ANDROID) || PA_BUILDFLAG(IS_FUCHSIA)
        return true;
