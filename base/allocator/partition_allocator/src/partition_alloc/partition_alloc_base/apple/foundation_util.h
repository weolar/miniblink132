...
#define PA_CF_CAST_DECL(TypeCF)                                                                                                                                \
    template <> PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) TypeCF##Ref CFCast<TypeCF##Ref>(const CFTypeRef& cf_val);                                            \
                                                                                                                                                               \
    template <> PA_COMPONENT_EXPORT(PARTITION_ALLOC_BASE) TypeCF##Ref CFCastStrict<TypeCF##Ref>(const CFTypeRef& cf_val)
