...
#define PA_COMPONENT_EXPORT(component) PA_COMPONENT_MACRO_CONDITIONAL_(IS_##component##_IMPL, PA_COMPONENT_EXPORT_ANNOTATION, PA_COMPONENT_IMPORT_ANNOTATION)
...
// as expected.
#define PA_INSIDE_COMPONENT_IMPL(component) PA_COMPONENT_MACRO_CONDITIONAL_(IS_##component##_IMPL, 1, 0)
...
#define PA_COMPONENT_MACRO_CONDITIONAL_(condition, consequent, alternate)                                                                                      \
    PA_COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_(PA_COMPONENT_MACRO_CONDITIONAL_COMMA_(condition), consequent, alternate)
...
#define PA_COMPONENT_MACRO_CONDITIONAL_COMMA_(...) PA_COMPONENT_MACRO_CONDITIONAL_COMMA_IMPL_(__VA_ARGS__, )
#define PA_COMPONENT_MACRO_CONDITIONAL_COMMA_IMPL_(x, ...) PA_COMPONENT_MACRO_CONDITIONAL_COMMA_##x##_
...
// macro expansion.
#define PA_COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_(...) PA_MSVC_EXPAND_ARG(PA_COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_IMPL_(__VA_ARGS__))
