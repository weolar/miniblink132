...
// is created.
bool CreateThreadInternal(size_t stack_size, PlatformThreadForTesting::Delegate* delegate, PlatformThreadHandle* out_thread_handle)
{
...
void PlatformThreadForTesting::Join(PlatformThreadHandle thread_handle)
{
    ...
    PA_BASE_CHECK(WAIT_OBJECT_0 == WaitForSingleObject(thread_handle.platform_handle(), INFINITE));
    CloseHandle(thread_handle.platform_handle());
}

// static
bool PlatformThreadForTesting::Create(size_t stack_size, Delegate* delegate, PlatformThreadHandle* thread_handle)
{
