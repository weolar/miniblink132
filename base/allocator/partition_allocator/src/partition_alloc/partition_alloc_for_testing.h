...
template <bool allow_leaks> struct PartitionAllocatorForTesting : public PartitionAllocator {
    PartitionAllocatorForTesting()
        : PartitionAllocator()
    {
    }
...
using PartitionAllocatorForTesting = internal::PartitionAllocatorForTesting<internal::DisallowLeaks>;

using PartitionAllocatorAllowLeaksForTesting = internal::PartitionAllocatorForTesting<internal::AllowLeaks>;
