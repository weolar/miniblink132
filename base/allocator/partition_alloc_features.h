...
extern const BASE_EXPORT base::FeatureParam<UnretainedDanglingPtrMode> kUnretainedDanglingPtrModeParam;
...
extern const BASE_EXPORT base::FeatureParam<DanglingPtrMode> kDanglingPtrModeParam;
...
extern const BASE_EXPORT base::FeatureParam<DanglingPtrType> kDanglingPtrTypeParam;

using PartitionAllocWithAdvancedChecksEnabledProcesses = internal::PAFeatureEnabledProcesses;
...
extern const BASE_EXPORT base::FeatureParam<PartitionAllocWithAdvancedChecksEnabledProcesses> kPartitionAllocWithAdvancedChecksEnabledProcessesParam;
...
extern const BASE_EXPORT base::FeatureParam<int> kPartitionAllocSchedulerLoopQuarantineBranchCapacity;
...
extern const BASE_EXPORT base::FeatureParam<BackupRefPtrEnabledProcesses> kBackupRefPtrEnabledProcessesParam;
extern const BASE_EXPORT base::FeatureParam<BackupRefPtrMode> kBackupRefPtrModeParam;
...
extern const BASE_EXPORT base::FeatureParam<MemoryTaggingEnabledProcesses> kMemoryTaggingEnabledProcessesParam;
...
extern const BASE_EXPORT base::FeatureParam<BucketDistributionMode> kPartitionAllocBucketDistributionParam;
...
extern const BASE_EXPORT base::FeatureParam<TimeDelta> kPartitionAllocMemoryReclaimerInterval;
BASE_EXPORT BASE_DECLARE_FEATURE(kPartitionAllocStraightenLargerSlotSpanFreeLists);
extern const BASE_EXPORT base::FeatureParam<partition_alloc::StraightenLargerSlotSpanFreeListsMode> kPartitionAllocStraightenLargerSlotSpanFreeListsMode;
...
extern const base::FeatureParam<bool> kPartialLowEndModeExcludePartitionAllocSupport;
#endif
...
extern const partition_alloc::internal::base::TimeDelta GetThreadCacheMaxPurgeInterval();
extern const partition_alloc::internal::base::TimeDelta GetThreadCacheDefaultPurgeInterval();

BASE_EXPORT BASE_DECLARE_FEATURE(kEnableConfigurableThreadCacheMinCachedMemoryForPurging);
...
extern const BASE_EXPORT base::FeatureParam<ShadowMetadataEnabledProcesses> kShadowMetadataEnabledProcessesParam;
