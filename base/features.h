...
BASE_EXPORT extern const base::FeatureParam<bool> kUseRustJsonParserInCurrentSequence;
...
BASE_EXPORT BASE_DECLARE_FEATURE(kPostPowerMonitorBroadcastReceiverInitToBackground);
...
BASE_EXPORT void Init(EmitThreadControllerProfilerMetadata emit_thread_controller_profiler_metadata);
