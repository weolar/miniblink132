...
public:
    ...
    BASE_EXPORT friend bool operator==(const dict_iterator& lhs, const dict_iterator& rhs);
    BASE_EXPORT friend bool operator!=(const dict_iterator& lhs, const dict_iterator& rhs);
    ...
    // used instead.
    const DictStorage::iterator& GetUnderlyingIteratorDoNotUse() const LIFETIME_BOUND
    {
        return dict_iter_;
    }
...
public:
    ...
    BASE_EXPORT friend bool operator==(const const_dict_iterator& lhs, const const_dict_iterator& rhs);
    BASE_EXPORT friend bool operator!=(const const_dict_iterator& lhs, const const_dict_iterator& rhs);
