...
TEST(MD5, MD5SumEmptyData)
{
    ...
    const uint8_t expected[] = { 0xd4, 0x1d, 0x8c, 0xd9, 0x8f, 0x00, 0xb2, 0x04, 0xe9, 0x80, 0x09, 0x98, 0xec, 0xf8, 0x42, 0x7e };
...
TEST(MD5, MD5SumOneByteData)
{
    ...
    const uint8_t expected[] = { 0x0c, 0xc1, 0x75, 0xb9, 0xc0, 0xf1, 0xb6, 0xa8, 0x31, 0xc3, 0x99, 0xe2, 0x69, 0x77, 0x26, 0x61 };
    EXPECT_EQ(base::span(expected), digest.a);
}
...
TEST(MD5, MD5SumLongData)
{
    ...
    const uint8_t expected[] = { 0x90, 0xbd, 0x6a, 0xd9, 0x0a, 0xce, 0xf5, 0xad, 0xaa, 0x92, 0x20, 0x3e, 0x21, 0xc7, 0xa1, 0x3e };
    EXPECT_EQ(base::span(expected), digest.a);
}
