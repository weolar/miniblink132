...
#define NOTREACHED_IN_MIGRATION() LOGGING_CHECK_FUNCTION_IMPL(::logging::NotReachedError::NotReached(), false)
#else
#define NOTREACHED_IN_MIGRATION() (true) ? ::logging::NotReachedError::TriggerNotReached() : EAT_CHECK_STREAM_PARAMS()
#endif
...
#define NOTREACHED_INTERNAL_IMPL() (true) ? ::logging::NotReachedFailure() : EAT_CHECK_STREAM_PARAMS()
#endif
...
#define NOTREACHED(...)                                                                                                                                        \
    BASE_IF(BASE_IS_EMPTY(__VA_ARGS__), NOTREACHED_INTERNAL_IMPL(), LOGGING_CHECK_FUNCTION_IMPL(::logging::NotReachedError::NotReached(__VA_ARGS__), false))
...
// suggested usage.
#define DUMP_WILL_BE_NOTREACHED() ::logging::CheckError::DumpWillBeNotReachedNoreturn()
