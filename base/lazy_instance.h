...
template <typename Type> struct LazyInstanceTraitsBase {
...
// Leaky below.
template <typename Type> struct DestructorAtExitLazyInstanceTraits {
...
template <typename Type> struct LeakyLazyInstanceTraits {
...
template <typename Type> struct ErrorMustSelectLazyOrDestructorAtExitForLazyInstance { };

} // namespace internal

template <typename Type, typename Traits = internal::ErrorMustSelectLazyOrDestructorAtExitForLazyInstance<Type>> class LazyInstance {
public:
    ...
    Type* Pointer()
    {
        ...
        return subtle::GetOrCreateLazyPointer(private_instance_, &Traits::New, private_buf_, Traits::kRegisterOnExit ? OnExit : nullptr, this);
    }
