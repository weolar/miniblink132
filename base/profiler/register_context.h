...
// Linux.
template <typename T> uintptr_t& AsUintPtr(T* value)
{
...
inline uintptr_t& RegisterContextInstructionPointer(x86_thread_state64_t* context)
{
...
inline uintptr_t& RegisterContextInstructionPointer(arm_thread_state64_t* context)
{
