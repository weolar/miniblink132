...
using UnwinderCapture = std::tuple<raw_ptr<Unwinder>, std::unique_ptr<UnwinderStateCapture>>;
...
private:
    ...
    base::circular_deque<std::unique_ptr<Unwinder>> unwinders_ GUARDED_BY_CONTEXT(sampling_thread_sequence_checker_);
