...
struct BASE_EXPORT ChromeUnwindInfoAndroid {
    ChromeUnwindInfoAndroid(span<const uint8_t> unwind_instruction_table, span<const uint8_t> function_offset_table,
...
BASE_EXPORT ChromeUnwindInfoAndroid CreateChromeUnwindInfoAndroid(span<const uint8_t> data);
