...
public:
    ...
    ScopedSampleMetadata(std::string_view name, int64_t value, SampleMetadataScope scope);
    ...
    ScopedSampleMetadata(std::string_view name, int64_t key, int64_t value, SampleMetadataScope scope);
...
BASE_EXPORT void ApplyMetadataToPastSamples(TimeTicks period_start, TimeTicks period_end, std::string_view name, int64_t value, SampleMetadataScope scope);
BASE_EXPORT void ApplyMetadataToPastSamples(
    TimeTicks period_start, TimeTicks period_end, std::string_view name, int64_t key, int64_t value, SampleMetadataScope scope);
...
BASE_EXPORT void AddProfileMetadata(std::string_view name, int64_t key, int64_t value, SampleMetadataScope scope);
