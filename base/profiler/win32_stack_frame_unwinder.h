...
public:
    ...
    public:
        ...
        virtual PRUNTIME_FUNCTION LookupFunctionEntry(DWORD64 program_counter, PDWORD64 image_base) = 0;
        virtual void VirtualUnwind(DWORD64 image_base, DWORD64 program_counter, PRUNTIME_FUNCTION runtime_function, CONTEXT* context) = 0;
    ...
    // successful.
    bool TryUnwind(bool at_top_frame, CONTEXT* context, const ModuleCache::Module* module);
