...
public:
    ...
    ThreadGroupProfilerClient& operator=(const ThreadGroupProfilerClient&) = delete;
    ...
    virtual std::unique_ptr<ProfileBuilder> CreateProfileBuilder(OnceClosure builder_completed_callback) = 0;

    // Returns a factory function for creating unwinders.
    virtual base::StackSamplingProfiler::UnwindersFactory GetUnwindersFactory() = 0;
