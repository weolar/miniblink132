...
//         return next_frame >= frame_lower_bound && ClampAdd(next_frame, sizeof(uintptr_t) * 2) <= stack_top && (next_frame & align_mask) == 0;
//     };
...
//         const ModuleCache::Module* module = module_cache()->GetModuleForAddress(retaddr);
