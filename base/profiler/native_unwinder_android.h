...
class NativeUnwinderAndroid : public Unwinder, public ModuleCache::AuxiliaryModuleProvider {
public:
    ...
    static std::unique_ptr<NativeUnwinderAndroidMemoryRegionsMap> CreateMemoryRegionsMap(bool use_updatable_maps = false);
    ...
    NativeUnwinderAndroid(uintptr_t exclude_module_with_base_address, NativeUnwinderAndroidMapDelegate* map_delegate);
...
private:
    ...
    void EmitDexFrame(uintptr_t dex_pc, unwindstack::ArchEnum, std::vector<Frame>* stack);
