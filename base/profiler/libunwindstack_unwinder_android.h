...
public:
    ...
    LibunwindstackUnwinderAndroid& operator=(const LibunwindstackUnwinderAndroid&) = delete;
...
private:
    ...
    std::unique_ptr<NativeUnwinderAndroidMemoryRegionsMapImpl> memory_regions_map_;
