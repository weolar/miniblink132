...
void JNI_TestSupport_InvokeCallbackFunction(JNIEnv* env, jlong context)
{
    ...
    UnwinderJavaTestSupportParams* params = reinterpret_cast<UnwinderJavaTestSupportParams*>(context);
...
FunctionAddressRange callWithJavaFunction(OnceClosure closure)
{
    ...
    base::Java_TestSupport_callWithJavaFunction(env, reinterpret_cast<uintptr_t>(&params));
    return params.range;
}
