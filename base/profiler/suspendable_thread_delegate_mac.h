...
class BASE_EXPORT SuspendableThreadDelegateMac : public SuspendableThreadDelegate {
public:
    ...
    SuspendableThreadDelegateMac& operator=(const SuspendableThreadDelegateMac&) = delete;
