...
class NativeUnwinderAndroidMemoryRegionsMapImpl : public NativeUnwinderAndroidMemoryRegionsMap {
public:
    NativeUnwinderAndroidMemoryRegionsMapImpl(std::unique_ptr<unwindstack::Maps> maps, std::unique_ptr<unwindstack::Memory> memory);
