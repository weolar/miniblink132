...
public:
    ...
    ScopedEnvironmentVariableOverride& operator=(ScopedEnvironmentVariableOverride&&);
    ~ScopedEnvironmentVariableOverride();

    base::Environment* GetEnv()
    {
...
private:
    ScopedEnvironmentVariableOverride(const std::string& variable_name, const std::string& value, bool unset_var);
