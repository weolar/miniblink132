...
#define COMPONENT_EXPORT(component) COMPONENT_MACRO_CONDITIONAL_(IS_##component##_IMPL, COMPONENT_EXPORT_ANNOTATION, COMPONENT_IMPORT_ANNOTATION)
...
#define COMPONENT_MACRO_CONDITIONAL_(condition, consequent, alternate)                                                                                         \
    COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_(COMPONENT_MACRO_CONDITIONAL_COMMA_(condition), consequent, alternate)
...
#define COMPONENT_MACRO_CONDITIONAL_COMMA_(...) COMPONENT_MACRO_CONDITIONAL_COMMA_IMPL_(__VA_ARGS__, )
...
// expansion.
#define COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_(...) COMPONENT_MACRO_SELECT_THIRD_ARGUMENT_IMPL_(__VA_ARGS__)
