...
LazyInstance<NumberFormatWrapper>::DestructorAtExit g_number_format_float = LAZY_INSTANCE_INITIALIZER;
...
{
    return i18n::MessageFormatter::FormatWithNumberedArgs(u"{0,number,percent}", static_cast<double>(number) / 100.0);
}
