...
BASE_I18N_EXPORT TextDirection GetTextDirectionForLocaleInStartUp(const char* locale_name);

// Returns the text direction for |locale_name|.
BASE_I18N_EXPORT TextDirection GetTextDirectionForLocale(const char* locale_name);
...
BASE_I18N_EXPORT TextDirection GetFirstStrongCharacterDirection(const std::u16string& text);
BASE_I18N_EXPORT TextDirection GetLastStrongCharacterDirection(const std::u16string& text);
...
// |text|.
BASE_I18N_EXPORT void EnsureTerminatedDirectionalFormatting(std::u16string* text);
...
BASE_I18N_EXPORT void WrapPathWithLTRFormatting(const FilePath& path, std::u16string* rtl_safe_path);
...
[[nodiscard]] BASE_I18N_EXPORT std::u16string GetDisplayStringInLTRDirectionality(const std::u16string& text);
...
// pair.
[[nodiscard]] BASE_I18N_EXPORT std::u16string StripWrappingBidiControlCharacters(const std::u16string& text);
