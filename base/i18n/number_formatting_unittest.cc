...
TEST(NumberFormattingTest, FormatNumber)
{
    static const struct {
        ...
        { 0, "0", "0" },
        { 1024, "1,024", "1.024" },
        { std::numeric_limits<int64_t>::max(), "9,223,372,036,854,775,807", "9.223.372.036.854.775.807" },
        { std::numeric_limits<int64_t>::min(), "-9,223,372,036,854,775,808", "-9.223.372.036.854.775.808" },
        { -42, "-42", "-42" },
    };
...
TEST(NumberFormattingTest, FormatDoubleWithFixedFractionalDigits)
{
    ...
    for (const auto& i : cases) {
        i18n::SetICUDefaultLocale("en");
        ResetFormattersForTesting();
        EXPECT_EQ(i.expected_english, UTF16ToUTF8(FormatDouble(i.number, i.frac_digits)));
        i18n::SetICUDefaultLocale("de");
        ResetFormattersForTesting();
        EXPECT_EQ(i.expected_german, UTF16ToUTF8(FormatDouble(i.number, i.frac_digits)));
    }
}
...
TEST(NumberFormattingTest, FormatDoubleWithFractionalDigitRange)
{
    ...
    for (const auto& i : cases) {
        i18n::SetICUDefaultLocale("en");
        ResetFormattersForTesting();
        EXPECT_EQ(i.expected_english, UTF16ToUTF8(FormatDouble(i.number, i.min_frac_digits, i.max_frac_digits)));
        i18n::SetICUDefaultLocale("de");
        ResetFormattersForTesting();
        EXPECT_EQ(i.expected_german, UTF16ToUTF8(FormatDouble(i.number, i.min_frac_digits, i.max_frac_digits)));
    }
}
...
TEST(NumberFormattingTest, FormatPercent)
{
    static const struct {
        ...
        { 0, "0%", "0\u00a0%", "\u06f0\u066a", "0\u200e%\u200e", "\u0660\u066a\u061c" },
        { 42, "42%", "42\u00a0%", "\u06f4\u06f2\u066a", "42\u200e%\u200e", "\u0664\u0662\u066a\u061c" },
        { 1024, "1,024%", "1.024\u00a0%", "\u06f1\u066c\u06f0\u06f2\u06f4\u066a", "1,024\u200e%\u200e", "\u0661\u066c\u0660\u0662\u0664\u066a\u061c" },
    };
