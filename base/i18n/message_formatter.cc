...
{
    return UnicodeString::fromUTF8(std::string_view(str.data(), base::checked_cast<int32_t>(str.size())));
}
} // anonymous namespace
...
MessageArg::MessageArg(const Time& t)
    : formattable(new icu::Formattable(static_cast<UDate>(t.InMillisecondsFSinceUnixEpoch())))
{
}
...
std::u16string MessageFormatter::FormatWithNumberedArgs(std::u16string_view msg, const internal::MessageArg& arg0, const internal::MessageArg& arg1,
    const internal::MessageArg& arg2, const internal::MessageArg& arg3, const internal::MessageArg& arg4, const internal::MessageArg& arg5,
...
std::u16string MessageFormatter::FormatWithNamedArgs(std::u16string_view msg, std::string_view name0, const internal::MessageArg& arg0, std::string_view name1,
    const internal::MessageArg& arg1, std::string_view name2, const internal::MessageArg& arg2, std::string_view name3, const internal::MessageArg& arg3,
    std::string_view name4, const internal::MessageArg& arg4, std::string_view name5, const internal::MessageArg& arg5, std::string_view name6,
    const internal::MessageArg& arg6)
{
    icu::UnicodeString names[] = {
        UnicodeStringFromStringView(name0),
        UnicodeStringFromStringView(name1),
        UnicodeStringFromStringView(name2),
        UnicodeStringFromStringView(name3),
        UnicodeStringFromStringView(name4),
        UnicodeStringFromStringView(name5),
