...
public:
    ...
    // |match_length| are non-NULL, they are assigned the start position and total
    // length of the match.
    bool Search(const std::u16string& in_this, size_t* match_index, size_t* match_length, bool forward_search);
...
public:
    ...
    // |match_length| are non-NULL, they are assigned the start position and total
    // length of the match.
    bool Search(const std::u16string& in_this, size_t* match_index, size_t* match_length);
...
public:
    RepeatingStringSearch(const std::u16string& find_this, const std::u16string& in_this, bool case_sensitive);
