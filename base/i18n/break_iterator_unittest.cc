...
TEST(BreakIteratorTest, BreakWordWide16)
{
    ...
    const std::u16string str(u"\x03a0\x03b1\x03b3\x03ba\x03cc\x03c3\x03bc\x03b9"
...
TEST(BreakIteratorTest, BreakWordChineseEnglish)
{
    ...
    const std::u16string str(base::JoinString({ token1, u" ", token2, token3, token4, u" ", token5, token6 }, u""));
