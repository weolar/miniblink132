...
// e.g., "15:07:30.568"
BASE_I18N_EXPORT std::u16string TimeFormatTimeOfDayWithMilliseconds(const Time& time);
...
BASE_I18N_EXPORT std::u16string TimeFormatTimeOfDayWithHourClockType(const Time& time, HourClockType type, AmPmClockType ampm);
...
BASE_I18N_EXPORT std::u16string TimeFormatMonthAndYearForTimeZone(const Time& time, const icu::TimeZone* time_zone);
...
BASE_I18N_EXPORT std::u16string TimeFormatShortDateAndTimeWithTimeZone(const Time& time);
...
// use case.
BASE_I18N_EXPORT std::u16string LocalizedTimeFormatWithPattern(const Time& time, std::string_view pattern);
...
BASE_I18N_EXPORT std::string UnlocalizedTimeFormatWithPattern(const Time& time, std::string_view pattern, const icu::TimeZone* time_zone = nullptr);
...
[[nodiscard]] BASE_I18N_EXPORT bool TimeDurationFormat(TimeDelta time, DurationFormatWidth width, std::u16string* out);
...
[[nodiscard]] BASE_I18N_EXPORT bool TimeDurationFormatWithSeconds(TimeDelta time, DurationFormatWidth width, std::u16string* out);
...
[[nodiscard]] BASE_I18N_EXPORT bool TimeDurationCompactFormatWithSeconds(TimeDelta time, DurationFormatWidth width, std::u16string* out);
...
BASE_I18N_EXPORT std::u16string DateIntervalFormat(const Time& begin_time, const Time& end_time, DateFormat format);
