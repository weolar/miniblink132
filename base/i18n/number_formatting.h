...
BASE_I18N_EXPORT std::u16string FormatDouble(double number, int fractional_digits);
...
BASE_I18N_EXPORT std::u16string FormatDouble(double number, int min_fractional_digits, int max_fractional_digits);
