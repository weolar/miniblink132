...
static const struct FileUtilICUTestCases {
    ...
    { u"bad\x0003\x0091 file\u200E\u200Fname.png", u"bad-- file--name.png", u"bad   file  name.png" },
    { u"bad*file\\?name.jpg", u"bad-file--name.jpg", u"bad file  name.jpg" },
    { u"\t  bad*file\\name/.jpg", u"-  bad-file-name-.jpg", u"bad file name .jpg" },
    { u"this_file_name is okay!.mp3", u"this_file_name is okay!.mp3", u"this_file_name is okay!.mp3" },
    { u"\u4E00\uAC00.mp3", u"\u4E00\uAC00.mp3", u"\u4E00\uAC00.mp3" },
    { u"\u0635\u200C\u0644.mp3", u"\u0635-\u0644.mp3", u"\u0635 \u0644.mp3" },
    { u"\U00010330\U00010331.mp3", u"\U00010330\U00010331.mp3", u"\U00010330\U00010331.mp3" },
    // Unassigned codepoints are ok.
    { u"\u0378\U00040001.mp3", u"\u0378\U00040001.mp3", u"\u0378\U00040001.mp3" },
    // Non-characters are not allowed.
    { u"bad\uFFFFfile\U0010FFFEname.jpg", u"bad-file-name.jpg", u"bad file name.jpg" },
    { u"bad\uFDD0file\uFDEFname.jpg", u"bad-file-name.jpg", u"bad file name.jpg" },
    // CVE-2014-9390
    { u"(\u200C.\u200D.\u200E.\u200F.\u202A.\u202B.\u202C.\u202D.\u202E.\u206A."
      u"\u206B.\u206C.\u206D.\u206F.\uFEFF)",
    ...
    { u"config~1VeryLongCannotBeShortNameOK.txt", u"config~1VeryLongCannotBeShortNameOK.txt", u"config~1VeryLongCannotBeShortNameOK.txt" },
...
static const struct normalize_name_encoding_test_cases {
    ...
    = { { "foo_na\xcc\x88me.foo", "foo_n\xc3\xa4me.foo" }, { "foo_dir_na\xcc\x88me/foo_na\xcc\x88me.foo", "foo_dir_na\xcc\x88me/foo_n\xc3\xa4me.foo" },
...
TEST_F(FileUtilICUTest, NormalizeFileNameEncoding)
{
    for (size_t i = 0; i < std::size(kNormalizeFileNameEncodingTestCases); i++) {
        ...
        EXPECT_EQ(FilePath(kNormalizeFileNameEncodingTestCases[i].normalized_path), path);
    }
}
