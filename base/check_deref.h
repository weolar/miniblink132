...
//
#define CHECK_DEREF(ptr) ::logging::CheckDeref(ptr, #ptr " != nullptr", __FILE__, __LINE__)

template <typename T> [[nodiscard]] T& CheckDeref(T* ptr, const char* message, const char* file, int line)
{
