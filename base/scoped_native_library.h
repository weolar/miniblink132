...
struct BASE_EXPORT NativeLibraryTraits {
    ...
    // for stateful traits.
    static NativeLibrary InvalidValue()
    {
        return nullptr;
    }
...
class BASE_EXPORT ScopedNativeLibrary : public ScopedGeneric<NativeLibrary, NativeLibraryTraits> {
public:
    ...
    // |scoped_library|.
    ScopedNativeLibrary& operator=(ScopedNativeLibrary&& scoped_library) = default;
