...
#define PRINTF_FORMAT(format_param, dots_param) [[gnu::format(printf, format_param, dots_param)]]
#else
...
#if __has_cpp_attribute(clang::preserve_most) && (defined(ARCH_CPU_ARM64) || defined(ARCH_CPU_X86_64)) && !defined(COMPONENT_BUILD)                            \
...
// clang-format on
#define UNSAFE_BUFFERS(...) _Pragma("clang unsafe_buffer_usage begin") __VA_ARGS__ _Pragma("clang unsafe_buffer_usage end")
// clang-format on
#else
