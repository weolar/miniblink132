...
TEST(SpanWriterTest, WriteNativeEndian_Unsigned)
{
    ...
    }
    {
        ...
        EXPECT_EQ(r.remaining(), 0u);
        EXPECT_EQ(kBigArray, base::span<const uint8_t>({ 1, 9, 8, 7, 6, 5, 4, 3, 2 }));
    }
}
...
TEST(SpanWriterTest, WriteNativeEndian_Signed)
{
    ...
    }
    {
        ...
        EXPECT_EQ(r.remaining(), 0u);
        EXPECT_EQ(kBigArray, base::span<const uint8_t>({ 1, 0xf7, 0xf7, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd }));
    }
}
...
TEST(SpanWriterTest, WriteBigEndian_Unsigned)
{
    ...
    }
    {
        ...
        EXPECT_EQ(r.remaining(), 0u);
        EXPECT_EQ(kBigArray, base::span<const uint8_t>({ 1, 2, 3, 4, 5, 6, 7, 8, 9 }));
    }
}
...
TEST(SpanWriterTest, WriteBigEndian_Signed)
{
    ...
    }
    {
        ...
        EXPECT_EQ(r.remaining(), 0u);
        EXPECT_EQ(kBigArray, base::span<const uint8_t>({ 1, 0xfd, 0xfc, 0xfb, 0xfa, 0xf9, 0xf8, 0xf7, 0xf7 }));
    }
}
