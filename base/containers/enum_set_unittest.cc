...
using TestEnumExtremeSet = EnumSet<TestEnumExtreme, TestEnumExtreme::kTestMin, TestEnumExtreme::kTestMax>;
...
{
    static_assert(TestEnumSet::All().Has(TestEnum::kTest2), "Expected All() to be integral constant expression");
    static_assert(TestEnumSet::FromRange(TestEnum::kTest2, TestEnum::kTest4).Has(TestEnum::kTest2), "Expected FromRange() to be integral constant expression");
    static_assert(TestEnumSet { TestEnum::kTest2 }.Has(TestEnum::kTest2), "Expected TestEnumSet() to be integral constant expression");
    static_assert(TestEnumSet::FromEnumBitmask(1 << static_cast<uint64_t>(TestEnum::kTest2)).Has(TestEnum::kTest2),
...
{
    const TestEnumSet enums = { TestEnum::kTest4, TestEnum::kTest2, TestEnum::kTest1 };
    EXPECT_FALSE(enums.empty());
...
{
    EXPECT_EQ(TestEnumSet({ TestEnum::kTest4, TestEnum::kTest2, TestEnum::kTest1, TestEnum::kTest4, TestEnum::kTest2, TestEnum::kTest4 }),
...
{
    EXPECT_EQ(TestEnumSet({ TestEnum::kTest2, TestEnum::kTest3, TestEnum::kTest4 }), TestEnumSet::FromRange(TestEnum::kTest2, TestEnum::kTest4));
    EXPECT_EQ(TestEnumSet::All(), TestEnumSet::FromRange(TestEnum::kTest1, TestEnum::kTest5));
    EXPECT_EQ(TestEnumSet({ TestEnum::kTest2 }), TestEnumSet::FromRange(TestEnum::kTest2, TestEnum::kTest2));

    using RestrictedRangeSet = EnumSet<TestEnum, TestEnum::kTest2, TestEnum::kTestMax>;
    EXPECT_EQ(RestrictedRangeSet({ TestEnum::kTest2, TestEnum::kTest3, TestEnum::kTest4 }), RestrictedRangeSet::FromRange(TestEnum::kTest2, TestEnum::kTest4));
    EXPECT_EQ(RestrictedRangeSet::All(), RestrictedRangeSet::FromRange(TestEnum::kTest2, TestEnum::kTest5));
}
...
TEST_F(EnumSetTest, Put)
{
    ...
    EXPECT_EQ(TestEnumSet({ TestEnum::kTest3, TestEnum::kTest4, TestEnum::kTest5 }), enums);
}
...
TEST_F(EnumSetTest, PutRange)
{
    ...
    EXPECT_EQ(TestEnumSet({ TestEnum::kTest2, TestEnum::kTest3, TestEnum::kTest4 }), enums);
}
...
TEST_F(EnumSetTest, Union)
{
    ...
    EXPECT_EQ(TestEnumSet({ TestEnum::kTest3, TestEnum::kTest4, TestEnum::kTest5 }), enums3);
}
...
TEST_F(EnumSetTest, ToFromEnumBitmask)
{
    ...
    const TestEnumSet enums2 = { TestEnum::kTest3, TestEnum::kTest4 };
    const uint64_t val2 = 1ULL << static_cast<uint64_t>(TestEnum::kTest3) | 1ULL << static_cast<uint64_t>(TestEnum::kTest4);
...
TEST_F(EnumSetTest, FromEnumBitmaskIgnoresExtraBits)
{
    ...
    for (const TestEnumSet& set : kSets) {
        ...
        const uint64_t kJunkVals[] = {
            ...
            val | single_val_bitstring(TestEnum::kTest6OutOfBounds) | single_val_bitstring(TestEnum::kTest7OutOfBounds),
...
TEST_F(EnumSetTest, OneEnumValue)
{
    ...
    using TestEnumOneSet = EnumSet<TestEnumOne, TestEnumOne::kTestMin, TestEnumOne::kTestMax>;
...
TEST_F(EnumSetTest, SparseEnum)
{
    ...
    using TestEnumSparseSet = EnumSet<TestEnumSparse, TestEnumSparse::kTestMin, TestEnumSparse::kTestMax>;
...
TEST_F(EnumSetTest, GetNth64bitWordBitmaskFromEnum)
{
    ...
    using TestEnumEdgeCaseSet = EnumSet<TestEnumEdgeCase, TestEnumEdgeCase::kTestMin, TestEnumEdgeCase::kTestMax>;
    ...
    ASSERT_EQ(bit_mask_0.value(), 1ull << static_cast<uint32_t>(TestEnumEdgeCase::kTest1) | 1ull << static_cast<uint32_t>(TestEnumEdgeCase::kTest63));
    std::optional<uint64_t> bit_mask_1 = sparse.GetNth64bitWordBitmask(1);
    ASSERT_TRUE(bit_mask_1.has_value());
    ASSERT_EQ(bit_mask_1.value(),
        1ull << (static_cast<uint32_t>(TestEnumEdgeCase::kTest64) - 64u) | 1ull << (static_cast<uint32_t>(TestEnumEdgeCase::kTest100) - 64u));
...
TEST_F(EnumSetDeathTest, EnumWithNegatives)
{
    ...
    using TestEnumWithNegSet = EnumSet<TestEnumNeg, TestEnumNeg::kTestMin, TestEnumNeg::kTestMax>;
    ...
    EXPECT_TRUE(TestEnumWithNegSet({ TestEnumNeg::kTestD }).Has(TestEnumNeg::kTestD));
    // Even though kTestA is negative, it is in range, so this should work.
    EXPECT_TRUE(TestEnumWithNegSet({ TestEnumNeg::kTestA }).Has(TestEnumNeg::kTestA));
}
...
TEST_F(EnumSetDeathTest, FromRangeCrashesOnBadInputs)
{
    ...
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTest3, TestEnum::kTest1));

    // FromRange crashes when the start value is out of range.
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTestBelowMin, TestEnum::kTest1));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTestBelowMinNegative, TestEnum::kTest1));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTest6OutOfBounds, TestEnum::kTest1));

    // FromRange crashes when the end value is out of range.
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTest3, TestEnum::kTestBelowMin));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTest3, TestEnum::kTestBelowMinNegative));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTest3, TestEnum::kTest6OutOfBounds));

    // Crashes when start and end are both out of range.
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTest6OutOfBounds, TestEnum::kTest7OutOfBounds));
    EXPECT_CHECK_DEATH(TestEnumSet().FromRange(TestEnum::kTest6OutOfBounds, TestEnum::kTest7OutOfBounds));
}
...
TEST_F(EnumSetDeathTest, PutRangeCrashesOnBadInputs)
{
    ...
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::kTestBelowMinNegative, TestEnum::kTestBelowMin));
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::kTest3, TestEnum::kTest7OutOfBounds));

    // Crashes when both inputs are out of range.
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::kTest6OutOfBounds, TestEnum::kTest7OutOfBounds));

    // Crashes when inputs are out of order.
    EXPECT_CHECK_DEATH(TestEnumSet().PutRange(TestEnum::kTest2, TestEnum::kTest1));
}
...
{
    const TestEnumSet enums = { TestEnum::kTest2, TestEnum::kTest4 };
    EXPECT_THAT(ToVector(enums), testing::ElementsAre(TestEnum::kTest2, TestEnum::kTest4));
}
