...
TEST(UniquePtrMatcherTest, Basic)
{
...

    {
        ...
        EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo>(dangling_foo1)) == iter);
    }

    {
        ...
        EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo>(dangling_foo2)) == iter);
    }
    ...
    EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo>(dangling_foo3)) == v.end());
...
TEST(UniquePtrMatcherTest, Deleter)
{
...

    {
        ...
        ASSERT_TRUE(iter != v.end());
        EXPECT_EQ(foo1, iter->get());
        EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo, TestDeleter>(raw_foo1)) == iter);
        EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo, TestDeleter>(dangling_foo1)) == iter);
    }

    {
        ...
        ASSERT_TRUE(iter != v.end());
        EXPECT_EQ(foo2, iter->get());
        EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo, TestDeleter>(raw_foo2)) == iter);
        EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo, TestDeleter>(dangling_foo2)) == iter);
    }

    {
        ...
        ASSERT_TRUE(iter != v.end());
        EXPECT_EQ(foo2, iter->get());
        EXPECT_TRUE(ranges::find_if(v, MatchesUniquePtr<Foo, TestDeleter>(raw_foo2)) == iter);
        EXPECT_TRUE(ranges::find_if(v, MatchesUniquePtr<Foo, TestDeleter>(dangling_foo2)) == iter);
    }

    EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo, TestDeleter>(foo3)) == v.end());
    EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo, TestDeleter>(raw_foo3)) == v.end());
    EXPECT_TRUE(ranges::find_if(v, UniquePtrMatcher<Foo, TestDeleter>(dangling_foo3)) == v.end());

    EXPECT_TRUE(ranges::find_if(v, MatchesUniquePtr<Foo, TestDeleter>(foo3)) == v.end());
    EXPECT_TRUE(ranges::find_if(v, MatchesUniquePtr<Foo, TestDeleter>(raw_foo3)) == v.end());
    EXPECT_TRUE(ranges::find_if(v, MatchesUniquePtr<Foo, TestDeleter>(dangling_foo3)) == v.end());
