...
{
    observer_list_->Notify(FROM_HERE, &Observer::OnReceivedTaskPort, process_handle);
}

mach_port_t SelfPortProvider::TaskForHandle(base::ProcessHandle process_handle) const
{
