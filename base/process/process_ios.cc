...
bool WaitForExitWithTimeoutImpl(base::ProcessHandle handle, int* exit_code, base::TimeDelta timeout);

void Process::SetTerminationHooks(TerminateCallback terminate_callback, WaitForExitCallback wait_callback)
{
