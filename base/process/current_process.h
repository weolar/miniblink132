...
using CurrentProcessType = perfetto::protos::pbzero::ChromeProcessDescriptor::ProcessType;
...
public:
    ...
    private:
        ...
        friend void ::tracing::SetProcessTrackDescriptor(int64_t process_start_timestamp);
    ...
    {
        return static_cast<CurrentProcessType>(process_type_.load(std::memory_order_relaxed));
    }
