...
class UniqueProcId {
public:
    explicit UniqueProcId(ProcessId value)
        : value_(value)
    {
    }
    ...
    ProcessId GetUnsafeValue() const
    {
        return value_;
    }
...
BASE_EXPORT void InitUniqueIdForProcessInPidNamespace(ProcessId pid_outside_of_namespace);
#endif
