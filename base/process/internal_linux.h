...
int64_t ReadStatsFilendGetFieldAsInt64(const FilePath& stat_file, ProcStatsFields field_num);
...
template <typename Lambda> void ForEachProcessTask(base::ProcessHandle process, Lambda&& lambda)
{
