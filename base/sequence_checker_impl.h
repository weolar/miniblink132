...
class THREAD_ANNOTATION_ATTRIBUTE__(capability("context")) BASE_EXPORT SequenceCheckerImpl {
public:
    ...
    // untouched.
    [[nodiscard]] bool CalledOnValidSequence(std::unique_ptr<debug::StackTrace>* out_bound_at = nullptr) const;
