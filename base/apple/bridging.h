...
#define CF_TO_NS_CAST_IMPL(TypeCF, TypeNS)                                                                                                                     \
    ...
    inline BASE_EXPORT TypeNS* _Nullable CFToNSOwnershipCast(TypeCF##Ref CF_CONSUMED _Nullable cf_val)                                                         \
    {                                                                                                                                                          \
        DCHECK(!cf_val || TypeCF##GetTypeID() == CFGetTypeID(cf_val));                                                                                         \
        return (__bridge_transfer TypeNS*)cf_val;                                                                                                              \
    }                                                                                                                                                          \
    inline BASE_EXPORT CF_RETURNS_RETAINED TypeCF##Ref _Nullable NSToCFOwnershipCast(TypeNS* _Nullable ns_val)                                                 \
    {                                                                                                                                                          \
        TypeCF##Ref cf_val = (__bridge_retained TypeCF##Ref)ns_val;                                                                                            \
        DCHECK(!cf_val || TypeCF##GetTypeID() == CFGetTypeID(cf_val));                                                                                         \
        return cf_val;                                                                                                                                         \
    }                                                                                                                                                          \
    inline BASE_EXPORT TypeNS* _Nullable CFToNSPtrCast(TypeCF##Ref _Nullable cf_val)                                                                           \
    {                                                                                                                                                          \
        DCHECK(!cf_val || TypeCF##GetTypeID() == CFGetTypeID(cf_val));                                                                                         \
        return (__bridge TypeNS*)cf_val;                                                                                                                       \
    }                                                                                                                                                          \
    inline BASE_EXPORT TypeCF##Ref _Nullable NSToCFPtrCast(TypeNS* _Nullable ns_val)                                                                           \
    {                                                                                                                                                          \
...
#define CF_TO_NS_MUTABLE_CAST_IMPL(name)                                                                                                                       \
    ...
    namespace base::apple {                                                                                                                                    \
    inline BASE_EXPORT NSMutable##name* _Nullable CFToNSOwnershipCast(CFMutable##name##Ref CF_CONSUMED _Nullable cf_val)                                       \
    {                                                                                                                                                          \
        DCHECK(!cf_val || CF##name##GetTypeID() == CFGetTypeID(cf_val));                                                                                       \
        return (__bridge_transfer NSMutable##name*)cf_val;                                                                                                     \
    }                                                                                                                                                          \
    inline BASE_EXPORT CF_RETURNS_RETAINED CFMutable##name##Ref _Nullable NSToCFOwnershipCast(NSMutable##name* _Nullable ns_val)                               \
    {                                                                                                                                                          \
        CFMutable##name##Ref cf_val = (__bridge_retained CFMutable##name##Ref)ns_val;                                                                          \
        DCHECK(!cf_val || CF##name##GetTypeID() == CFGetTypeID(cf_val));                                                                                       \
        return cf_val;                                                                                                                                         \
    }                                                                                                                                                          \
    inline BASE_EXPORT NSMutable##name* _Nullable CFToNSPtrCast(CFMutable##name##Ref _Nullable cf_val)                                                         \
    {                                                                                                                                                          \
        DCHECK(!cf_val || CF##name##GetTypeID() == CFGetTypeID(cf_val));                                                                                       \
        return (__bridge NSMutable##name*)cf_val;                                                                                                              \
    }                                                                                                                                                          \
    inline BASE_EXPORT CFMutable##name##Ref _Nullable NSToCFPtrCast(NSMutable##name* _Nullable ns_val)                                                         \
    {                                                                                                                                                          \
...
template <typename CFT> id _Nullable CFToNSOwnershipCast(ScopedCFTypeRef<CFT>)
{
    static_assert(AlwaysFalse<CFT>,
