...
template <typename T> struct ScopedDispatchObjectTraits {
...
template <typename T> using ScopedDispatchObject = ScopedTypeRef<T, internal::ScopedDispatchObjectTraits<T>>;
