...
public:
    ...
    static bool OverrideAndCreateIfNeeded(int key, const FilePath& path, bool is_absolute, bool create);
    ...
    static void RegisterProvider(ProviderFunc provider, int key_start, int key_end);
