...
dict_iterator& dict_iterator::operator=(const dict_iterator& dict_iter) = default;
...
const_dict_iterator& const_dict_iterator::operator=(const const_dict_iterator& dict_iter) = default;
...
bool operator==(const const_dict_iterator& lhs, const const_dict_iterator& rhs)
{
    return lhs.dict_iter_ == rhs.dict_iter_;
}
