...
// registration.
class BASE_EXPORT ProcessLifecycle final : public fidl::Server<fuchsia_process_lifecycle::Lifecycle> {
public:
...
private:
    ...
    std::optional<fidl::ServerBinding<fuchsia_process_lifecycle::Lifecycle>> binding_;
};
