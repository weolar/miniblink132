...
BASE_EXPORT std::optional<std::u16string> ReadUTF8FromVMOAsUTF16(const fuchsia::mem::Buffer& buffer);
...
BASE_EXPORT fuchsia::mem::Buffer MemBufferFromString(std::string_view data, std::string_view name);
...
BASE_EXPORT fuchsia::mem::Buffer MemBufferFromString16(std::u16string_view data, std::string_view name);
...
BASE_EXPORT std::optional<std::string> StringFromMemBuffer(const fuchsia::mem::Buffer& buffer);

// Returns the contents of `data`, or null if the read operation fails.
BASE_EXPORT std::optional<std::string> StringFromMemData(const fuchsia::mem::Data& data);
...
BASE_EXPORT fuchsia::mem::Buffer CloneBuffer(const fuchsia::mem::Buffer& buffer, std::string_view name);
