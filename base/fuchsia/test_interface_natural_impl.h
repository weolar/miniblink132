...
class TestInterfaceNaturalImpl : public fidl::Server<base_testfidl::TestInterface> {
public:
...
fidl::Client<base_testfidl::TestInterface> CreateTestInterfaceClient(
    fidl::UnownedClientEnd<fuchsia_io::Directory> service_directory, const std::string& name = fidl::DiscoverableProtocolName<base_testfidl::TestInterface>);
