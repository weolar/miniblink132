...
// directory.
BASE_EXPORT fidl::UnownedClientEnd<fuchsia_io::Directory> BorrowIncomingServiceDirectoryForProcess();
...
// directly.
BASE_EXPORT std::unique_ptr<sys::ComponentContext> ReplaceComponentContextForProcessForTest(std::unique_ptr<sys::ComponentContext> context);
