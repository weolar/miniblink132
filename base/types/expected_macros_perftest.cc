...
private:
    ...
    {
        --*ops;
        RETURN_IF_ERROR(Loop(ops), [](std::string e) { return e + "The quick brown fox jumped over the lazy dog."; });
        return 0;
    }
};
...
private:
    ...
    {
        --*ops;
        ASSIGN_OR_RETURN(const int result, Loop(ops), [](std::string e) { return e + "The quick brown fox jumped over the lazy dog."; });
        return result;
    }
};
...
template <class T> void BenchmarkLoop(T* driver, ::benchmark::State* state)
{
