...
template <template <typename...> class C, typename T> inline constexpr bool is_instantiation_v = false;

template <template <typename...> class C, typename... Ts> inline constexpr bool is_instantiation_v<C, C<Ts...>> = true;
