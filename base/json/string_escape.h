...
BASE_EXPORT bool EscapeJSONString(std::string_view str, bool put_in_quotes, std::string* dest);
...
BASE_EXPORT bool EscapeJSONString(std::u16string_view str, bool put_in_quotes, std::string* dest);
...
BASE_EXPORT std::string EscapeBytesAsInvalidJSONString(std::string_view str, bool put_in_quotes);
