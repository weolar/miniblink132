...
public:
    JSONParser* NewTestParser(const std::string& input, int options = JSON_PARSE_RFC)
    {
...
TEST_F(JSONParserTest, ErrorMessages)
{
    ...
    // Test each of the error conditions
    {
        ...
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 3, JSONParser::kUnexpectedDataAfterRoot), parser.GetErrorMessage());
...

    {
        ...
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 200, JSONParser::kTooMuchNesting), parser.GetErrorMessage());
...

    {
        ...
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 4, JSONParser::kTrailingComma), parser.GetErrorMessage());
...

    {
        ...
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 2, JSONParser::kUnquotedDictionaryKey), parser.GetErrorMessage());
...

    {
        ...
        std::optional<Value> value = parser.Parse("{\"foo\":\"bar\",}");
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 14, JSONParser::kTrailingComma), parser.GetErrorMessage());
        EXPECT_EQ(JSONParser::JSON_TRAILING_COMMA, parser.error_code());
    }

    {
        ...
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 2, JSONParser::kSyntaxError), parser.GetErrorMessage());
...

    {
        ...
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 7, JSONParser::kInvalidEscape), parser.GetErrorMessage());
...

    {
        ...
        EXPECT_FALSE(value);
        EXPECT_EQ(JSONParser::FormatErrorMessage(1, 4, JSONParser::kUnsupportedEncoding), parser.GetErrorMessage());
