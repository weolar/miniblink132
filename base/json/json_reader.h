...
enum JSONParserOptions {
    ...
    JSON_PARSE_CHROMIUM_EXTENSIONS = JSON_ALLOW_COMMENTS | JSON_ALLOW_NEWLINES_IN_STRINGS | JSON_ALLOW_X_ESCAPES,
};
...
public:
    struct BASE_EXPORT Error {
        ...
        {
            return "line " + base::NumberToString(line) + ", column " + base::NumberToString(column) + ": " + message;
        }
    };
    ...
    static std::optional<Value> Read(std::string_view json, int options = JSON_PARSE_CHROMIUM_EXTENSIONS, size_t max_depth = internal::kAbsoluteMaxDepth);
    ...
    static std::optional<Value::Dict> ReadDict(
        std::string_view json, int options = JSON_PARSE_CHROMIUM_EXTENSIONS, size_t max_depth = internal::kAbsoluteMaxDepth);
    ...
    static Result ReadAndReturnValueWithError(std::string_view json, int options = JSON_PARSE_CHROMIUM_EXTENSIONS);
