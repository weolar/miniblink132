...
public:
    ...
    void set_pretty_print(bool new_value)
    {
...
public:
    ...
    // JSONParserOptions.
    explicit JSONStringValueDeserializer(std::string_view json_string, int options = base::JSON_PARSE_CHROMIUM_EXTENSIONS);

    JSONStringValueDeserializer(const JSONStringValueDeserializer&) = delete;
    JSONStringValueDeserializer& operator=(const JSONStringValueDeserializer&) = delete;
