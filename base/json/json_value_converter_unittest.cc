...
struct SimpleMessage {
    ...
    static void RegisterJSONConverter(base::JSONValueConverter<SimpleMessage>* converter)
    {
        ...
        converter->RegisterCustomField<SimpleEnum>("simple_enum", &SimpleMessage::simple_enum, &ParseSimpleEnum);
        converter->RegisterRepeatedInt("ints", &SimpleMessage::ints);
        converter->RegisterCustomValueField<bool>("bstruct", &SimpleMessage::bstruct, &HasFieldPresent);
        converter->RegisterRepeatedCustomValue<std::string>("string_values", &SimpleMessage::string_values, &GetValueString);
    }
};
...
struct NestedMessage {
    ...
    static void RegisterJSONConverter(base::JSONValueConverter<NestedMessage>* converter)
    {
