...
public:
    ...
    {
        std::string description = "Breadth: " + base::NumberToString(breadth) + ", Depth: " + base::NumberToString(depth);
        ...
        auto reporter = SetUpReporter("breadth_" + base::NumberToString(breadth) + "_depth_" + base::NumberToString(depth));
