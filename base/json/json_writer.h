...
BASE_EXPORT std::optional<std::string> WriteJson(ValueView node, size_t max_depth = internal::kAbsoluteMaxDepth);
...
BASE_EXPORT std::optional<std::string> WriteJsonWithOptions(ValueView node, uint32_t options, size_t max_depth = internal::kAbsoluteMaxDepth);
...
public:
    ...
    static constexpr auto OPTIONS_OMIT_BINARY_VALUES = JsonOptions::OPTIONS_OMIT_BINARY_VALUES;
    static constexpr auto OPTIONS_OMIT_DOUBLE_TYPE_PRESERVATION = JsonOptions::OPTIONS_OMIT_DOUBLE_TYPE_PRESERVATION;
    static constexpr auto OPTIONS_PRETTY_PRINT = JsonOptions::OPTIONS_PRETTY_PRINT;
    ...
    static bool Write(ValueView node, std::string* json, size_t max_depth = internal::kAbsoluteMaxDepth);
    ...
    static bool WriteWithOptions(ValueView node, int options, std::string* json, size_t max_depth = internal::kAbsoluteMaxDepth);
