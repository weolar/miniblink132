...
void MockOneShotTimer::SetTaskRunner(scoped_refptr<SequencedTaskRunner> task_runner)
{
...
void MockRepeatingTimer::SetTaskRunner(scoped_refptr<SequencedTaskRunner> task_runner)
{
...
void MockRetainingOneShotTimer::SetTaskRunner(scoped_refptr<SequencedTaskRunner> task_runner)
{
