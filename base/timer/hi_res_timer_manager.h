...
class BASE_EXPORT HighResolutionTimerManager : public base::PowerSuspendObserver, public base::PowerStateObserver {
public:
    HighResolutionTimerManager();

    HighResolutionTimerManager(const HighResolutionTimerManager&) = delete;
    HighResolutionTimerManager& operator=(const HighResolutionTimerManager&) = delete;
    ...
    bool hi_res_clock_available() const
    {
