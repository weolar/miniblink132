...
public:
    ...
    ScopedMockElapsedTimersForTest(const ScopedMockElapsedTimersForTest&) = delete;
    ScopedMockElapsedTimersForTest& operator=(const ScopedMockElapsedTimersForTest&) = delete;
