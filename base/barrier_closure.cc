...
RepeatingClosure BarrierClosure(size_t num_callbacks_left, OnceClosure done_closure)
{
    ...
    return BindRepeating(&BarrierInfo::Run, std::make_unique<BarrierInfo>(num_callbacks_left, std::move(done_closure)));
}
