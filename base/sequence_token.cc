...
TaskScope::TaskScope(SequenceToken sequence_token, bool is_single_threaded, bool is_running_synchronously)
    ...
    , previous_task_is_running_synchronously_(current_task_is_running_synchronously)
{
...
TaskScope::~TaskScope()
{
    ...
    current_task_is_running_synchronously = previous_task_is_running_synchronously_;
}
