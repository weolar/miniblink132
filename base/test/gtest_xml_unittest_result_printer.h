...
public:
    ...
    void OnAssert(const char* file, int line, const std::string& summary, const std::string& message);
...
private:
    ...
    void WriteTestPartResult(const char* file, int line, testing::TestPartResult::Type type, const std::string& summary, const std::string& message);
