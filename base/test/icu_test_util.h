...
public:
    ...
    ScopedRestoreICUDefaultLocale& operator=(const ScopedRestoreICUDefaultLocale&) = delete;
    ~ScopedRestoreICUDefaultLocale();
...
public:
    ...
    ScopedRestoreDefaultTimezone& operator=(const ScopedRestoreDefaultTimezone&) = delete;
