...
public:
    ...
    static Query EventPid()
    {
        return Query(EVENT_PID);
    }

    static Query EventTid()
    {
        return Query(EVENT_TID);
    }

    // Return the timestamp of the event in microseconds since epoch.
    static Query EventTime()
    {
        return Query(EVENT_TIME);
    }

    // Return the absolute time between event and other event in microseconds.
    // Only works if Query::EventHasOther() == true.
    static Query EventDuration()
    {
        return Query(EVENT_DURATION);
    }
    ...
    static Query EventPhase()
    {
        return Query(EVENT_PHASE);
    }

    static Query EventCategory()
    {
        return Query(EVENT_CATEGORY);
    }

    static Query EventName()
    {
        return Query(EVENT_NAME);
    }

    static Query EventId()
    {
    ...
    static Query EventHasOther()
    {
        return Query(EVENT_HAS_OTHER);
    }

    // Access the associated other_event's members:

    static Query OtherPid()
    {
        return Query(OTHER_PID);
    }

    static Query OtherTid()
    {
        return Query(OTHER_TID);
    }

    static Query OtherTime()
    {
        return Query(OTHER_TIME);
    }

    static Query OtherPhase()
    {
        return Query(OTHER_PHASE);
    }

    static Query OtherCategory()
    {
        return Query(OTHER_CATEGORY);
    }

    static Query OtherName()
    {
        return Query(OTHER_NAME);
    }

    static Query OtherId()
    {
    ...
    static Query PrevPid()
    {
        return Query(PREV_PID);
    }

    static Query PrevTid()
    {
        return Query(PREV_TID);
    }

    static Query PrevTime()
    {
        return Query(PREV_TIME);
    }

    static Query PrevPhase()
    {
        return Query(PREV_PHASE);
    }

    static Query PrevCategory()
    {
        return Query(PREV_CATEGORY);
    }

    static Query PrevName()
    {
        return Query(PREV_NAME);
    }

    static Query PrevId()
    {
        return Query(PREV_ID);
    }
    ...
    enum QueryType { QUERY_BOOLEAN_OPERATOR, QUERY_ARITHMETIC_OPERATOR, QUERY_EVENT_MEMBER, QUERY_NUMBER, QUERY_STRING };
    ...
    static const TraceEvent* SelectTargetEvent(const TraceEvent* ev, TraceEventMember member);
...
public:
    ...
    [[nodiscard]] static std::unique_ptr<TraceAnalyzer> Create(const std::string& json_events);
    ...
    // again.
    void AssociateEvents(const Query& first, const Query& second, const Query& match);
