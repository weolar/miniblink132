...
template <typename F> class MockCallback;

template <typename Signature> using MockOnceCallback = MockCallback<OnceCallback<Signature>>;
template <typename Signature> using MockRepeatingCallback = MockCallback<RepeatingCallback<Signature>>;

using MockOnceClosure = MockCallback<OnceClosure>;
using MockRepeatingClosure = MockCallback<RepeatingClosure>;

template <typename R> class MockCallback<RepeatingCallback<R()>> {
public:
...
template <typename R> class MockCallback<OnceCallback<R()>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1> class MockCallback<RepeatingCallback<R(A1)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1> class MockCallback<OnceCallback<R(A1)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2> class MockCallback<RepeatingCallback<R(A1, A2)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2> class MockCallback<OnceCallback<R(A1, A2)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2, typename A3> class MockCallback<RepeatingCallback<R(A1, A2, A3)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2, typename A3> class MockCallback<OnceCallback<R(A1, A2, A3)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2, typename A3, typename A4> class MockCallback<RepeatingCallback<R(A1, A2, A3, A4)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2, typename A3, typename A4> class MockCallback<OnceCallback<R(A1, A2, A3, A4)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2, typename A3, typename A4, typename A5> class MockCallback<RepeatingCallback<R(A1, A2, A3, A4, A5)>> {
public:
    MockCallback() = default;
...
template <typename R, typename A1, typename A2, typename A3, typename A4, typename A5> class MockCallback<OnceCallback<R(A1, A2, A3, A4, A5)>> {
public:
    MockCallback() = default;
...
class MockCallback<RepeatingCallback<R(A1, A2, A3, A4, A5, A6, A7, A8, A9, A10)>> {
public:
    MockCallback() = default;
