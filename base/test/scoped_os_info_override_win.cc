...
// static
ScopedOSInfoOverride::UniqueOsInfo ScopedOSInfoOverride::CreateInfoOfType(Type type)
{
    ...
    case Type::kWin11HomeN:
        ...
        os_type = type == Type::kWin11Home ? PRODUCT_HOME_BASIC : type == Type::kWin11HomeN ? PRODUCT_HOME_BASIC_N : PRODUCT_PROFESSIONAL;
        break;
    ...
    case Type::kWin10Home:
        ...
        os_type = type == Type::kWin10Home ? PRODUCT_HOME_BASIC : PRODUCT_PROFESSIONAL;
        break;
    ...
    return UniqueOsInfo(new base::win::OSInfo(version_info, system_info, os_type), &ScopedOSInfoOverride::deleter);
}
