...
public:
    ...
    ScopedBlockTestsWritingToSpecialDirs(std::vector<int> dirs_to_block, FileWriteBlockedForTestingFunctionPtr failure_callback);

    ScopedBlockTestsWritingToSpecialDirs(const ScopedBlockTestsWritingToSpecialDirs&) = delete;
    ScopedBlockTestsWritingToSpecialDirs& operator=(const ScopedBlockTestsWritingToSpecialDirs&) = delete;
