...
TEST(GmockExpectedSupportTest, PrintTest)
{
    ...
    EXPECT_EQ(testing::PrintToString(unexpected<std::string>("test")), "Unexpected(test)");

    EXPECT_EQ(testing::PrintToString(expected<void, std::string>(ok())), "Expected()");
    EXPECT_EQ(testing::PrintToString(expected<std::string, std::string>(ok("test"))), "Expected(test)");
    EXPECT_EQ(testing::PrintToString(expected<std::string, std::string>(unexpected("test"))), "Unexpected(test)");
}
