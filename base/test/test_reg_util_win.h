...
private:
    ...
    public:
        ...
        ScopedRegistryKeyOverride& operator=(const ScopedRegistryKeyOverride&) = delete;
    ...
    RegistryOverrideManager(const base::Time& timestamp, const std::wstring& test_key_root);
