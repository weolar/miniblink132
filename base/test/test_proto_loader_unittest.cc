...
void LoadTestProto(const std::string& proto_text, google::protobuf::MessageLite& proto)
{
    base::TestProtoLoader loader(GetTestDataRoot().Append(FILE_PATH_LITERAL("base/test/test_proto.descriptor")), "base.test.TestMessage");
