...
const char switches::kIsolatedScriptTestLauncherRetryLimit[] = "isolated-script-test-launcher-retry-limit";
...
// fails.
const char switches::kEnforceExactPositiveFilter[] = "enforce-exact-positive-filter";
...
const char switches::kTestLauncherOutputBytesLimit[] = "test-launcher-output-bytes-limit";
...
const char switches::kTestLauncherPrintTempLeaks[] = "test-launcher-print-temp-leaks";
...
// are a bit spammy.
const char switches::kTestLauncherPrintTimestamps[] = "test-launcher-print-timestamps";
...
const char switches::kTestLauncherTestPartResultsLimit[] = "test-launcher-test-part-results-limit";
...
const char switches::kWithDeathTestStackTraces[] = "with-death-test-stack-traces";
...
const char switches::kEnableRunIOSUnittestsWithXCTest[] = "enable-run-ios-unittests-with-xctest";
// Write a compiled test json file to a location where writable.
const char switches::kWriteCompiledTestsJsonToWritablePath[] = "write-compiled-tests-json-to-writable-path";
#endif
