...
public:
    ...
    ScopedMockTimeMessageLoopTaskRunner(const ScopedMockTimeMessageLoopTaskRunner&) = delete;
    ScopedMockTimeMessageLoopTaskRunner& operator=(const ScopedMockTimeMessageLoopTaskRunner&) = delete;
    ...
    TestMockTimeTaskRunner* operator->()
    {
        return task_runner_.get();
    }
