...
UserActionTester::UserActionTester()
    ...
    , action_callback_(base::BindRepeating(&UserActionTester::OnUserAction, base::Unretained(this)))
{
...
std::vector<TimeTicks> UserActionTester::GetActionTimes(std::string_view user_action) const
{
...
void UserActionTester::OnUserAction(const std::string& user_action, TimeTicks action_time)
{
