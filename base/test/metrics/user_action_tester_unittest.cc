...
TEST(UserActionTesterTest, GetActionTimesWhenActionsHaveBeenRecorded)
{
    ...
    EXPECT_THAT(user_action_tester.GetActionTimes(kUserAction1), UnorderedElementsAre(t1));
    EXPECT_THAT(user_action_tester.GetActionTimes(kUserAction2), UnorderedElementsAre(t2));
    EXPECT_THAT(user_action_tester.GetActionTimes(kUserAction3), UnorderedElementsAre(t3));
}
...
TEST(UserActionTesterTest, VerifyUserActionTesterListensForUserActions)
{
    ...
    EXPECT_EQ(1, user_action_tester.GetActionCount(kUserAction1));
    EXPECT_THAT(user_action_tester.GetActionTimes(kUserAction1), UnorderedElementsAre(time));
}
...
// called.
TEST(UserActionTesterTest, VerifyUserActionTesterListensForComputedUserActionAt)
{
    UserActionTester user_action_tester;
...
TEST(UserActionTesterTest, VerifyUserActionTesterListensForComputedUserActionSince)
{
    ...
    EXPECT_EQ(1, user_action_tester.GetActionCount(kUserAction1));
    EXPECT_THAT(user_action_tester.GetActionTimes(kUserAction1), UnorderedElementsAre(expected_time));
}
