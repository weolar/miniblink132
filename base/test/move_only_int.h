...
class MoveOnlyInt {
public:
    explicit MoveOnlyInt(int data = 1)
        : data_(data)
    {
    }
    ...
    friend bool operator==(const MoveOnlyInt& lhs, const MoveOnlyInt& rhs) = default;
    friend auto operator<=>(const MoveOnlyInt& lhs, const MoveOnlyInt& rhs) = default;
