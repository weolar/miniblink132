...
Process SpawnMultiProcessTestChild(const std::string& procname, const CommandLine& command_line, const LaunchOptions& options);
...
protected:
    ...
    Process SpawnChildWithOptions(const std::string& procname, const LaunchOptions& options);
