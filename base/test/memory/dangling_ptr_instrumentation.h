...
public:
    ...
    DanglingPtrInstrumentation& operator=(const DanglingPtrInstrumentation&) = delete;
    DanglingPtrInstrumentation& operator=(DanglingPtrInstrumentation&&);

    size_t dangling_ptr_detected()
    {
        return dangling_ptr_detected_;
    }
    size_t dangling_ptr_released()
    {
        return dangling_ptr_released_;
    }
