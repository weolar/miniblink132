...
class StackTracer {
public:
    StackTracer(size_t trace_count)
...
void MultiObjTest(size_t trace_count)
{
    ...
    perf_test::PerfResultReporter reporter = SetUpReporter(base::StringPrintf("trace_count_%zu", trace_count));
...
INSTANTIATE_TEST_SUITE_P(, StackTracePerfTest, ::testing::Range(size_t(4), size_t(16), size_t(4)));
