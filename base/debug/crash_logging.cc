...
CrashKeyString* AllocateCrashKeyString(const char name[], CrashKeySize value_length)
{
    ...
    DCHECK_EQ(std::string_view::npos, name_piece.find(':')) << "; name_piece = " << name_piece;
...
ScopedCrashKeyString::ScopedCrashKeyString(CrashKeyString* crash_key, std::string_view value)
