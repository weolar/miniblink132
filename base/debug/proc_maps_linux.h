...
BASE_EXPORT bool ParseProcMaps(const std::string& input, std::vector<MappedMemoryRegion>* regions);
...
BASE_EXPORT std::optional<SmapsRollup> ParseSmapsRollupForTesting(const std::string& smaps_rollup);
