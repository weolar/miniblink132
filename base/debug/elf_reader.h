...
size_t BASE_EXPORT ReadElfBuildId(const void* elf_mapped_base, bool uppercase, ElfBuildIdBuffer build_id);
...
std::optional<std::string_view> BASE_EXPORT ReadElfLibraryName(const void* elf_mapped_base);
