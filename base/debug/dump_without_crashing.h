...
enum class DumpWithoutCrashingStatus { kThrottled, kUploaded, kMaxValue = kUploaded };
...
NOT_TAIL_CALLED BASE_EXPORT bool DumpWithoutCrashing(
    const base::Location& location = base::Location::Current(), base::TimeDelta time_between_dumps = base::Days(1));
...
NOT_TAIL_CALLED BASE_EXPORT bool DumpWithoutCrashingWithUniqueId(
    size_t unique_identifier, const base::Location& location = base::Location::Current(), base::TimeDelta time_between_dumps = base::Days(1));
