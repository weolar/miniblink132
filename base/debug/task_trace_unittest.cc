...
public:
    ...
    void Run()
    {
        task_runner->PostTask(FROM_HERE, base::BindOnce(&ThreeTasksTest::TaskA, base::Unretained(this)));
    ...
    void TaskA()
    {
        ...
        task_runner->PostTask(FROM_HERE, base::BindOnce(&ThreeTasksTest::TaskB, base::Unretained(this)));
    }
    ...
    void TaskB()
    {
        ...
        task_runner->PostTask(FROM_HERE, base::BindOnce(&ThreeTasksTest::TaskC, base::Unretained(this)));
    }
...
private:
    ...
    const raw_ref<base::SingleThreadTaskRunner> task_runner { *task_environment.GetMainThreadTaskRunner() };
