...
public:
    ...
    // the above enums.
    WaitableEvent(ResetPolicy reset_policy = ResetPolicy::MANUAL, InitialState initial_state = InitialState::NOT_SIGNALED);
    ...
    void declare_only_used_while_idle()
    {
    ...
    NOT_TAIL_CALLED static size_t WaitMany(WaitableEvent** waitables, size_t count);
...
private:
    ...
    // unsorted, array.
    static size_t EnqueueMany(WaiterAndIndex* waitables, size_t count, Waiter* waiter);
