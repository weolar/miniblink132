...
//   ~Foo();
// };
template <class T> class RefCountedDeleteOnSequence : public subtle::RefCountedThreadSafeBase {
public:
    ...
    RefCountedDeleteOnSequence& operator=(const RefCountedDeleteOnSequence&) = delete;
