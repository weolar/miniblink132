...
//     foo->method();
//
template <typename T> class TRIVIAL_ABI WeakPtr {
public:
    WeakPtr() = default;
...
private:
    ...
    internal::WeakReference CloneWeakReference() const
    {
        return ref_;
    }
...
template <class T> class WeakPtrFactory : public internal::WeakPtrFactoryBase {
public:
    ...
    {
        return internal::MakeSafeRefFromWeakPtrInternals(weak_reference_owner_.GetRef(), reinterpret_cast<T*>(ptr_));
    }
