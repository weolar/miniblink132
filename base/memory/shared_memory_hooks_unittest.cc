...
protected:
    ...
    {
        SetCreateHooks(nullptr, nullptr, nullptr);
    }

    void SetCreateHooks(ReadOnlySharedMemoryRegion::CreateFunction* read_only_hook, UnsafeSharedMemoryRegion::CreateFunction* unsafe_hook,
        WritableSharedMemoryRegion::CreateFunction* writable_hook)
    {
        SharedMemoryHooks::SetCreateHooks(read_only_hook, unsafe_hook, writable_hook);
    }
};
...
TEST_F(SharedMemoryHooksTest, Basic)
{
    ...
    SetCreateHooks(&ReadOnlyShmemCreateHook, &UnsafeShmemCreateHook, &WritableShmemCreateHook);
