...
constexpr inline auto kDiscardableMemoryBackingParamOptions = std::to_array<base::FeatureParam<DiscardableMemoryTrialGroup>::Option>({
...
constexpr inline base::FeatureParam<DiscardableMemoryTrialGroup> kDiscardableMemoryBackingParam(
    &kDiscardableMemoryBackingTrial, "DiscardableMemoryBacking", DiscardableMemoryTrialGroup::kEmulatedSharedMemory, kDiscardableMemoryBackingParamOptions);
...
BASE_EXPORT DiscardableMemoryTrialGroup GetDiscardableMemoryBackingFieldTrialGroup();
