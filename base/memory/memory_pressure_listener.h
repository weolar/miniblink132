...
public:
    ...
    MemoryPressureListener(const base::Location& creation_location, const MemoryPressureCallback& memory_pressure_callback);
    MemoryPressureListener(const base::Location& creation_location, const MemoryPressureCallback& memory_pressure_callback,
    ...
    static void SimulatePressureNotification(MemoryPressureLevel memory_pressure_level);
