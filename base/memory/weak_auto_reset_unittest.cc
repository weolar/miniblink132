...
template <class T> class HasWeakFactory {
public:
    ...
    {
        return WeakAutoReset(factory_.GetWeakPtr(), &HasWeakFactory::value_, std::move(value));
    }
    ...
    WeakPtr<HasWeakFactory> GetWeakPtr()
    {
...
TEST(WeakAutoResetTest, TestMoveAssignmentMovesOldValue)
{
...

    {
        ...
        WeakAutoReset<HasWeakFactory<HasWeakFactoryPointer>, HasWeakFactoryPointer> reset;
