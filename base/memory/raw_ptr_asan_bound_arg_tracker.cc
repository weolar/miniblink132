...
constinit thread_local RawPtrAsanBoundArgTracker::ProtectedArgsVector* protected_args = nullptr;
...
uintptr_t RawPtrAsanBoundArgTracker::GetProtectedArgPtr(uintptr_t ptr)
{
    ...
    for (auto protected_arg_ptr : *protected_args) {
        ...
        __asan_locate_address(reinterpret_cast<void*>(protected_arg_ptr), nullptr, 0, reinterpret_cast<void**>(&allocation_base), &allocation_size);
