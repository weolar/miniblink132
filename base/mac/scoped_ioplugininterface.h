...
template <typename T> struct ScopedIOPluginInterfaceTraits {
...
template <typename T> using ScopedIOPluginInterface = apple::ScopedTypeRef<T**, internal::ScopedIOPluginInterfaceTraits<T**>>;
