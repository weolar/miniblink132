...
struct ScopedIONotificationPortRefTraits {
    static IONotificationPortRef InvalidValue()
    {
        return nullptr;
    }
...
using ScopedIONotificationPortRef = ScopedGeneric<IONotificationPortRef, internal::ScopedIONotificationPortRefTraits>;
