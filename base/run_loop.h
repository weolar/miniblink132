...
public:
    ...
    private:
        ...
        using RunLoopStack = stack<raw_ptr<RunLoop, VectorExperimental>, std::vector<raw_ptr<RunLoop, VectorExperimental>>>;
...
private:
    FRIEND_TEST_ALL_PREFIXES(SingleThreadTaskExecutorTypedTest, RunLoopQuitOrderAfter);
...
public:
    ...
    ScopedDisallowRunningRunLoop& operator=(const ScopedDisallowRunningRunLoop&) = delete;
    ~ScopedDisallowRunningRunLoop();
