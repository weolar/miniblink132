...
public:
    ...
    const StringVector& argv() const LIFETIME_BOUND
    {
        return argv_;
    }
    ...
    const SwitchMap& GetSwitches() const LIFETIME_BOUND
    {
        return switches_;
    }
    ...
    void AppendSwitchASCII(std::string_view switch_string, std::string_view value);
    ...
    void CopySwitchesFrom(const CommandLine& source, span<const char* const> switches);
    ...
    bool HasSingleArgumentSwitch() const
    {
        return has_single_argument_switch_;
    }
#endif
    ...
    static void SetDuplicateSwitchHandler(std::unique_ptr<DuplicateSwitchHandler>);
...
private:
    ...
    public:
        ...
        InstanceBoundSequenceChecker& operator=(const InstanceBoundSequenceChecker& other)
        {
            return *this;
        }
        ...
        InstanceBoundSequenceChecker& operator=(InstanceBoundSequenceChecker&&) = default;
    ...
    StringType GetArgumentsStringInternal(bool allow_unsafe_insert_sequences) const;
...
public:
    ...
    virtual void ResolveDuplicate(std::string_view key, CommandLine::StringViewType new_value, CommandLine::StringType& out_value) = 0;
