...
StartupProfilePathInfo GetStartupProfilePath(const base::FilePath& cur_dir, const base::CommandLine& command_line, bool ignore_profile_picker);
...
template <class WorkerInterface, class WorkerImpl, class Worker, class WorkerStatus, WorkerStatus StatusNotOk, WorkerStatus StatusOk, WorkerStatus StatusWork>
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& out, const BooleanWithOptionalStack& bws);
...
private:
    FRIEND_TEST_ALL_PREFIXES(ThreadRestrictionsTest, NestedAllowRestoresPreviousStack);
    ...
    friend class content::ScopedAllowBlockingForViewAura; // http://crbug.com/332579
    ...
    friend class net::ScopedAllowBlockingForSettingGetter; // http://crbug.com/69057
    ...
    friend class remote_cocoa::DroppedScreenShotCopierMac; // https://crbug.com/1148078
    friend class remote_cocoa::SelectFileDialogBridge;
    friend class remoting::ScopedBypassIOThreadRestrictions; // http://crbug.com/1144161
    ...
    friend auto ::GetStartupProfilePath(const base::FilePath& cur_dir, const base::CommandLine& command_line, bool ignore_profile_picker)
        -> StartupProfilePathInfo;
    friend bool ::HasWaylandDisplay(base::Environment* env); // http://crbug.com/1246928
    ...
    friend bool base::internal::ReadProcFile(const FilePath& file, std::string* buffer);
    ...
    friend base::File content::CreateFileForDrop(base::FilePath* file_path); // http://crbug.com/110709
...
public:
    ...
    ScopedAllowBlockingForTesting& operator=(const ScopedAllowBlockingForTesting&) = delete;
...
public:
    ...
    ScopedDisallowBaseSyncPrimitives(const ScopedDisallowBaseSyncPrimitives&) = delete;
    ScopedDisallowBaseSyncPrimitives& operator=(const ScopedDisallowBaseSyncPrimitives&) = delete;
...
private:
    ...
    template <class WorkerInterface, class WorkerImpl, class Worker, class WorkerStatus, WorkerStatus StatusNotOk, WorkerStatus StatusOk,
    ...
    friend class android_webview::OverlayProcessorWebView; // http://crbug.com/341151462
    ...
    friend class viz::DisplayCompositorMemoryAndTaskController; // http://crbug.com/341151462
...
class BASE_EXPORT [[maybe_unused, nodiscard]] ScopedAllowBaseSyncPrimitivesOutsideBlockingScope
{
public:
    ScopedAllowBaseSyncPrimitivesOutsideBlockingScope(const ScopedAllowBaseSyncPrimitivesOutsideBlockingScope&) = delete;
    ScopedAllowBaseSyncPrimitivesOutsideBlockingScope& operator=(const ScopedAllowBaseSyncPrimitivesOutsideBlockingScope&) = delete;
...
private:
    ...
    friend class discardable_memory::ClientDiscardableSharedMemoryManager; // http://crbug.com/1396355
    ...
    friend class proxy_resolver::ScopedAllowThreadJoinForProxyResolverV8Tracing; // http://crbug.com/69710
    friend class remoting::AutoThread; // https://crbug.com/944316
    friend class remoting::protocol::ScopedAllowSyncPrimitivesForWebRtcDataStreamAdapter; // http://b/233844893
    friend class remoting::protocol::ScopedAllowSyncPrimitivesForWebRtcTransport; // http://crbug.com/1198501
    friend class remoting::protocol::ScopedAllowSyncPrimitivesForWebRtcVideoStream; // http://b/304681143
    friend class remoting::protocol::ScopedAllowThreadJoinForWebRtcTransport; // http://crbug.com/660081
    // Not used in production yet, https://crbug.com/844078.
    friend class service_manager::ServiceProcessLauncher;
    friend class ui::WindowResizeHelperMac; // http://crbug.com/902829

    ScopedAllowBaseSyncPrimitivesOutsideBlockingScope(const Location& from_here = Location::Current());
...
public:
    ...
    ScopedAllowBaseSyncPrimitivesForTesting(const ScopedAllowBaseSyncPrimitivesForTesting&) = delete;
    ScopedAllowBaseSyncPrimitivesForTesting& operator=(const ScopedAllowBaseSyncPrimitivesForTesting&) = delete;
...
public:
    ...
    ScopedAllowUnresponsiveTasksForTesting(const ScopedAllowUnresponsiveTasksForTesting&) = delete;
    ScopedAllowUnresponsiveTasksForTesting& operator=(const ScopedAllowUnresponsiveTasksForTesting&) = delete;
