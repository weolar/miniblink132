...
public:
    ...
    CrossProcessPlatformThreadDelegate(const CrossProcessPlatformThreadDelegate&) = delete;
    CrossProcessPlatformThreadDelegate& operator=(const CrossProcessPlatformThreadDelegate&) = delete;
    ...
    virtual bool HandleThreadTypeChange(ProcessId process_id, PlatformThreadId thread_id, ThreadType thread_type) = 0;
};
