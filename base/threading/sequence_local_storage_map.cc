...
constinit thread_local SequenceLocalStorageMap* current_sequence_local_storage = nullptr;
...
SequenceLocalStorageMap& SequenceLocalStorageMap::GetForCurrentThread()
{
    ...
    DCHECK(IsSetForCurrentThread()) << "SequenceLocalStorageSlot cannot be used because no "
...
SequenceLocalStorageMap::Value* SequenceLocalStorageMap::Set(int slot_id, SequenceLocalStorageMap::ValueDestructorPair value_destructor_pair)
{
    auto it = sls_map_.find(slot_id);
...
SequenceLocalStorageMap::ValueDestructorPair::ValueDestructorPair(ExternalValue value, DestructorFunc* destructor)
    : value_ { .external_value = std::move(value) }
    , destructor_(destructor)
{
}

SequenceLocalStorageMap::ValueDestructorPair::ValueDestructorPair(InlineValue value, DestructorFunc* destructor)
    : value_ { .inline_value = std::move(value) }
    , destructor_(destructor)
{
}
...
SequenceLocalStorageMap::ValueDestructorPair::ValueDestructorPair(ValueDestructorPair&& value_destructor_pair)
...
SequenceLocalStorageMap::ValueDestructorPair& SequenceLocalStorageMap::ValueDestructorPair::operator=(ValueDestructorPair&& value_destructor_pair)
{
...
ScopedSetSequenceLocalStorageMapForCurrentThread::ScopedSetSequenceLocalStorageMapForCurrentThread(SequenceLocalStorageMap* sequence_local_storage)
    : resetter_(&current_sequence_local_storage, sequence_local_storage, nullptr)
{
}

ScopedSetSequenceLocalStorageMapForCurrentThread::~ScopedSetSequenceLocalStorageMapForCurrentThread() = default;
