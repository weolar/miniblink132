...
public:
    ...
    DelegateSimpleThread(Delegate* delegate, const std::string& name_prefix, const Options& options);
...
class BASE_EXPORT DelegateSimpleThreadPool : public DelegateSimpleThread::Delegate {
public:
