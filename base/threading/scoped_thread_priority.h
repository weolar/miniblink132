...
#define SCOPED_MAY_LOAD_LIBRARY_AT_BACKGROUND_PRIORITY()                                                                                                       \
    ...
    base::internal::ScopedMayLoadLibraryAtBackgroundPriority BASE_UNIQUIFY(scoped_may_load_library_at_background_priority)(                                    \
...
#define SCOPED_MAY_LOAD_LIBRARY_AT_BACKGROUND_PRIORITY_REPEATEDLY()                                                                                            \
    base::internal::ScopedMayLoadLibraryAtBackgroundPriority BASE_UNIQUIFY(scoped_may_load_library_at_background_priority)(FROM_HERE, nullptr);
...
public:
    ...
    explicit ScopedMayLoadLibraryAtBackgroundPriority(const Location& from_here, std::atomic_bool* already_loaded);

    ScopedMayLoadLibraryAtBackgroundPriority(const ScopedMayLoadLibraryAtBackgroundPriority&) = delete;
    ScopedMayLoadLibraryAtBackgroundPriority& operator=(const ScopedMayLoadLibraryAtBackgroundPriority&) = delete;
