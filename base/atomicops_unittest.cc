...
template <class AtomicType> static void TestAtomicIncrement()
{
...
template <class AtomicType> static void TestCompareAndSwap()
{
    AtomicType value = 0;
...
template <class AtomicType> static void TestAtomicExchange()
{
    AtomicType value = 0;
...
template <class AtomicType> static void TestAtomicIncrementBounds()
{
...
template <class AtomicType> static AtomicType TestFillValue()
{
    AtomicType val = 0;
...
// atomicity
template <class AtomicType> static void TestStore()
{
...
// This is a simple sanity check that values are correct. Not testing
// atomicity
template <class AtomicType> static void TestLoad()
{
    const AtomicType kVal1 = TestFillValue<AtomicType>();
    const AtomicType kVal2 = static_cast<AtomicType>(-1);
