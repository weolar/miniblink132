...
[[nodiscard]] BASE_EXPORT std::string SysWideToNativeMB(const std::wstring& wide);
[[nodiscard]] BASE_EXPORT std::wstring SysNativeMBToWide(std::string_view native_mb);
...
// MultiByteToWideChar().
[[nodiscard]] BASE_EXPORT std::wstring SysMultiByteToWide(std::string_view mb, uint32_t code_page);
[[nodiscard]] BASE_EXPORT std::string SysWideToMultiByte(const std::wstring& wide, uint32_t code_page);
...
[[nodiscard]] BASE_EXPORT apple::ScopedCFTypeRef<CFStringRef> SysUTF8ToCFStringRef(std::string_view utf8);
[[nodiscard]] BASE_EXPORT apple::ScopedCFTypeRef<CFStringRef> SysUTF16ToCFStringRef(std::u16string_view utf16);
...
[[nodiscard]] BASE_EXPORT NSString* SysUTF16ToNSString(std::u16string_view utf16);
