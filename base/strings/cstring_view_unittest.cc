...
TEST(CStringViewTest, Ordering)
{
    ...
    static_assert(stuff <=> cstring_view("stuff") == std::weak_ordering::equivalent);
...
{
    static_assert(cstring_view().max_size() == std::numeric_limits<size_t>::max());
    static_assert(u16cstring_view().max_size() == std::numeric_limits<size_t>::max() / 2u);
    static_assert(u32cstring_view().max_size() == std::numeric_limits<size_t>::max() / 4u);
#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view().max_size() == std::numeric_limits<size_t>::max() / 2u);
#endif
}
...
TEST(CStringViewTest, Find)
{
    ...
    static_assert(u16cstring_view(u"hello hello").find(u"lol") == cstring_view::npos);
    static_assert(u32cstring_view(U"hello hello").find(U"lo") == 3u);
    static_assert(u32cstring_view(U"hello hello").find(U"lol") == cstring_view::npos);
#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello hello").find(L"lo") == 3u);
    static_assert(wcstring_view(L"hello hello").find(L"lol") == cstring_view::npos);
#endif
}
...
TEST(CStringViewTest, Rfind)
{
    ...
    static_assert(u16cstring_view(u"hello hello").rfind(u"lol") == cstring_view::npos);
    static_assert(u32cstring_view(U"hello hello").rfind(U"lo") == 9u);
    static_assert(u32cstring_view(U"hello hello").rfind(U"lol") == cstring_view::npos);
#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello hello").rfind(L"lo") == 9u);
    static_assert(wcstring_view(L"hello hello").rfind(L"lol") == cstring_view::npos);
#endif
}
...
{
    // OOB `pos` will return npos. The NUL is never searched.
    static_assert(cstring_view("hello").find_first_of('h', 1000u) == cstring_view::npos);
    static_assert(cstring_view("hello").find_first_of('\0', 5u) == cstring_view::npos);
    ...
    static_assert(u16cstring_view(u"hello").find_first_of(u'z') == cstring_view::npos);
    ...
    static_assert(u32cstring_view(U"hello").find_first_of(U'z') == cstring_view::npos);
    ...
    static_assert(wcstring_view(L"hello").find_first_of(L'z') == cstring_view::npos);
    ...
    static_assert(cstring_view("hello hello").find_first_of("zz") == cstring_view::npos);
    static_assert(u16cstring_view(u"hello hello").find_first_of(u"ol") == 2u);
    static_assert(u16cstring_view(u"hello hello").find_first_of(u"zz") == cstring_view::npos);
    static_assert(u32cstring_view(U"hello hello").find_first_of(U"ol") == 2u);
    static_assert(u32cstring_view(U"hello hello").find_first_of(U"zz") == cstring_view::npos);
#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello hello").find_first_of(L"ol") == 2u);
    static_assert(wcstring_view(L"hello hello").find_first_of(L"zz") == cstring_view::npos);
#endif
}
...
TEST(CStringViewTest, FindLastOf)
{
    ...
    static_assert(cstring_view("hello").find_last_of('\0', 5u) == cstring_view::npos);
    ...
    static_assert(u16cstring_view(u"hello").find_last_of(u'z') == cstring_view::npos);
    ...
    static_assert(u32cstring_view(U"hello").find_last_of(U'z') == cstring_view::npos);
    ...
    static_assert(wcstring_view(L"hello").find_last_of(L'z') == cstring_view::npos);
    ...
    static_assert(cstring_view("hello hello").find_last_of("zz") == cstring_view::npos);
    static_assert(u16cstring_view(u"hello hello").find_last_of(u"lo") == 10u);
    static_assert(u16cstring_view(u"hello hello").find_last_of(u"zz") == cstring_view::npos);
    static_assert(u32cstring_view(U"hello hello").find_last_of(U"lo") == 10u);
    static_assert(u32cstring_view(U"hello hello").find_last_of(U"zz") == cstring_view::npos);
#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello hello").find_last_of(L"lo") == 10u);
    static_assert(wcstring_view(L"hello hello").find_last_of(L"zz") == cstring_view::npos);
#endif
}
...
{
    // OOB `pos` will return npos. The NUL is never searched.
    static_assert(cstring_view("hello").find_first_not_of('a', 1000u) == cstring_view::npos);
    static_assert(cstring_view("hello").find_first_not_of('a', 5u) == cstring_view::npos);

    // Searching for a Char.
    static_assert(cstring_view("hello").find_first_not_of('h') == 1u);
    static_assert(cstring_view("hello").find_first_not_of('e') == 0u);
    static_assert(cstring_view("hello").find_first_not_of("eloh") == cstring_view::npos);
    ...
    static_assert(u16cstring_view(u"hello").find_first_not_of(u"eloh") == cstring_view::npos);
    ...
    static_assert(u32cstring_view(U"hello").find_first_not_of(U"eloh") == cstring_view::npos);

#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello").find_first_not_of(L'h') == 1u);
    static_assert(wcstring_view(L"hello").find_first_not_of(L'e') == 0u);
    static_assert(wcstring_view(L"hello").find_first_not_of(L"eloh") == cstring_view::npos);
#endif

    // Searching for a string.
    static_assert(cstring_view("hello hello").find_first_not_of("eh") == 2u);
    static_assert(cstring_view("hello hello").find_first_not_of("hello ") == cstring_view::npos);
    static_assert(u16cstring_view(u"hello hello").find_first_not_of(u"eh") == 2u);
    static_assert(u16cstring_view(u"hello hello").find_first_not_of(u"hello ") == cstring_view::npos);
    static_assert(u32cstring_view(U"hello hello").find_first_not_of(U"eh") == 2u);
    static_assert(u32cstring_view(U"hello hello").find_first_not_of(U"hello ") == cstring_view::npos);
#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello hello").find_first_not_of(L"eh") == 2u);
    static_assert(wcstring_view(L"hello hello").find_first_not_of(L"hello ") == cstring_view::npos);
#endif
}
...
TEST(CStringViewTest, FindLastNotOf)
{
    ...
    static_assert(cstring_view("hello").find_last_not_of("eloh") == cstring_view::npos);
    ...
    static_assert(u16cstring_view(u"hello").find_last_not_of(u"eloh") == cstring_view::npos);
    ...
    static_assert(u32cstring_view(U"hello").find_last_not_of(U"eloh") == cstring_view::npos);

#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello").find_last_not_of(L'l') == 4u);
    static_assert(wcstring_view(L"hello").find_last_not_of(L'o') == 3u);
    static_assert(wcstring_view(L"hello").find_last_not_of(L"eloh") == cstring_view::npos);
#endif

    // Searching for a string.
    static_assert(cstring_view("hello hello").find_last_not_of("lo") == 7u);
    static_assert(cstring_view("hello hello").find_last_not_of("hello ") == cstring_view::npos);
    static_assert(u16cstring_view(u"hello hello").find_last_not_of(u"lo") == 7u);
    static_assert(u16cstring_view(u"hello hello").find_last_not_of(u"hello ") == cstring_view::npos);
    static_assert(u32cstring_view(U"hello hello").find_last_not_of(U"lo") == 7u);
    static_assert(u32cstring_view(U"hello hello").find_last_not_of(U"hello ") == cstring_view::npos);
#if BUILDFLAG(IS_WIN)
    static_assert(wcstring_view(L"hello hello").find_last_not_of(L"lo") == 7u);
    static_assert(wcstring_view(L"hello hello").find_last_not_of(L"hello ") == cstring_view::npos);
#endif
}
...
TEST(CStringViewTest, Hash)
{
    ...
    [[maybe_unused]] auto s16 = std::hash<u16cstring_view>()(u16cstring_view(u"hello"));
    static_assert(std::same_as<size_t, decltype(s)>);

    [[maybe_unused]] auto s32 = std::hash<u32cstring_view>()(u32cstring_view(U"hello"));
    static_assert(std::same_as<size_t, decltype(s)>);

#if BUILDFLAG(IS_WIN)
    [[maybe_unused]] auto sw = std::hash<wcstring_view>()(wcstring_view(L"hello"));
    static_assert(std::same_as<size_t, decltype(s)>);
#endif
}
...
{
    EXPECT_EQ(base::StrCat({ cstring_view("hello"), std::string_view("world") }), "helloworld");
}
