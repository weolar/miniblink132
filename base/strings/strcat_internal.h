...
template <typename CharT> void Resize(std::basic_string<CharT>& str, size_t total_size)
{
...
template <typename CharT, typename StringT> void StrAppendT(std::basic_string<CharT>& dest, span<const StringT> pieces)
{
...
template <typename StringT> auto StrCatT(span<const StringT> pieces)
{
