...
TEST(LevenshteinDistanceTest, WithMaxDistance)
{
    ...
    EXPECT_EQ(LevenshteinDistance(std::u16string(100, 'a'), std::u16string(200, 'a'), 50), 51u);
    EXPECT_EQ(LevenshteinDistance(std::u16string(200, 'a'), std::u16string(100, 'a'), 50), 51u);
}
