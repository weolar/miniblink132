...
template <class str, class const_iterator> class StringTokenizerT {
public:
    ...
    StringTokenizerT(const str& string, const owning_str& delims, WhitespacePolicy whitespace_policy = WhitespacePolicy::kIncludeInTokens)
    {
    ...
    StringTokenizerT(const_iterator string_begin, const_iterator string_end, const owning_str& delims,
    ...
    void set_quote_chars(const owning_str& quotes)
    {
        quotes_ = quotes;
    }
    ...
    const_iterator token_end() const
    {
        return token_end_;
    }
    str token() const
...
private:
    void Init(const_iterator string_begin, const_iterator string_end, const owning_str& delims, WhitespacePolicy whitespace_policy)
    {
    ...
    bool QuickGetNext()
    {
        ...
        while (token_end_ != end_ && delims_.find(*token_end_) == str::npos && !ShouldSkip(*token_end_)) {
            ++token_end_;
        }
        return true;
    }
...
typedef StringTokenizerT<std::string_view, std::string_view::const_iterator> StringViewTokenizer;
