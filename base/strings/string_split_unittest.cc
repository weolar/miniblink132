...
using SplitStringIntoKeyValuePairsUsingSubstrTest = SplitStringIntoKeyValuePairsTest;

TEST_F(SplitStringIntoKeyValuePairsUsingSubstrTest, EmptyString)
{
    EXPECT_TRUE(SplitStringIntoKeyValuePairsUsingSubstr(std::string(),
        ':', // Key-value delimiter
...
{
    EXPECT_FALSE(SplitStringIntoKeyValuePairsUsingSubstr("key1,,key2:value2",
        ':', // Key-value delimiter
        ",,", // Key-value pair delimiter
        &kv_pairs));
...
TEST_F(SplitStringIntoKeyValuePairsUsingSubstrTest, MissingKeyValuePairDelimiter)
{
    EXPECT_TRUE(SplitStringIntoKeyValuePairsUsingSubstr("key1:value1,,key3:value3",
        ':', // Key-value delimiter
        ",,,", // Key-value pair delimiter
        &kv_pairs));
...
{
    EXPECT_TRUE(SplitStringIntoKeyValuePairsUsingSubstr("key1 : value1",
        ':', // Key-value delimiter
        ",", // Key-value pair delimiter
        &kv_pairs));
    ASSERT_EQ(1U, kv_pairs.size());
...
{
    std::string a("a ?!@#$%^&*()_+:/{}\\\t\nb");
    EXPECT_TRUE(SplitStringIntoKeyValuePairsUsingSubstr(a + "X" + a + "XY" + a + "YX" + a,
...
{
    std::vector<std::string> results = SplitStringUsingSubstr(std::string(), "DELIMITER", TRIM_WHITESPACE, SPLIT_WANT_ALL);
...
{
    std::vector<std::string> results = SplitStringUsingSubstr("TEST", std::string(), TRIM_WHITESPACE, SPLIT_WANT_ALL);
    ASSERT_EQ(1u, results.size());
...
{
    std::vector<std::string> results = SplitStringUsingSubstr("alongwordwithnodelimiter", "DELIMITER", TRIM_WHITESPACE, SPLIT_WANT_ALL);
    ASSERT_EQ(1u, results.size());
...
TEST(SplitStringUsingSubstrTest, LeadingDelimitersSkipped)
{
    std::vector<std::string> results
        = SplitStringUsingSubstr("DELIMITERDELIMITERDELIMITERoneDELIMITERtwoDELIMITERthree", "DELIMITER", TRIM_WHITESPACE, SPLIT_WANT_ALL);
...
{
    std::vector<std::string> results
        = SplitStringUsingSubstr("unoDELIMITERDELIMITERDELIMITERdosDELIMITERtresDELIMITERDELIMITERcuatro", "DELIMITER", TRIM_WHITESPACE, SPLIT_WANT_ALL);
...
{
    std::vector<std::string> results
        = SplitStringUsingSubstr("unDELIMITERdeuxDELIMITERtroisDELIMITERquatreDELIMITERDELIMITERDELIMITER", "DELIMITER", TRIM_WHITESPACE, SPLIT_WANT_ALL);
    ASSERT_EQ(7u, results.size());
...
{
    std::vector<std::string_view> results = SplitStringPieceUsingSubstr("alongwordwithnodelimiter", "DELIMITER", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
    ASSERT_EQ(1u, results.size());
    EXPECT_THAT(results, ElementsAre("alongwordwithnodelimiter"));
}
...
TEST(SplitStringPieceUsingSubstrTest, LeadingDelimitersSkipped)
{
    std::vector<std::string_view> results
        = SplitStringPieceUsingSubstr("DELIMITERDELIMITERDELIMITERoneDELIMITERtwoDELIMITERthree", "DELIMITER", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
    ASSERT_EQ(6u, results.size());
    EXPECT_THAT(results, ElementsAre("", "", "", "one", "two", "three"));
}
...
TEST(SplitStringPieceUsingSubstrTest, ConsecutiveDelimitersSkipped)
{
    std::vector<std::string_view> results = SplitStringPieceUsingSubstr(
        "unoDELIMITERDELIMITERDELIMITERdosDELIMITERtresDELIMITERDELIMITERcuatro", "DELIMITER", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
    ASSERT_EQ(7u, results.size());
    EXPECT_THAT(results, ElementsAre("uno", "", "", "dos", "tres", "", "cuatro"));
}
...
{
    std::vector<std::string_view> results = SplitStringPieceUsingSubstr(
        "unDELIMITERdeuxDELIMITERtroisDELIMITERquatreDELIMITERDELIMITERDELIMITER", "DELIMITER", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
    ASSERT_EQ(7u, results.size());
    EXPECT_THAT(results, ElementsAre("un", "deux", "trois", "quatre", "", "", ""));
}
...
{
    std::vector<std::string_view> results
        = SplitStringPieceUsingSubstr("un DELIMITERdeux\tDELIMITERtrois\nDELIMITERquatre", "DELIMITER", base::KEEP_WHITESPACE, base::SPLIT_WANT_ALL);
...
{
    std::vector<std::string_view> results
        = SplitStringPieceUsingSubstr("un DELIMITERdeux\tDELIMITERtrois\nDELIMITERquatre", "DELIMITER", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
    ASSERT_EQ(4u, results.size());
    EXPECT_THAT(results, ElementsAre("un", "deux", "trois", "quatre"));
}
...
{
    std::vector<std::string_view> results
        = SplitStringPieceUsingSubstr("unDELIMITERdeuxDELIMITERtroisDELIMITERDELIMITER", "DELIMITER", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
...
{
    std::vector<std::string_view> results
        = SplitStringPieceUsingSubstr("unDELIMITERdeuxDELIMITERtroisDELIMITERDELIMITER", "DELIMITER", base::TRIM_WHITESPACE, base::SPLIT_WANT_NONEMPTY);
...
TEST(StringSplitTest, SplitStringAlongWhitespace)
{
    ...
    for (const TestData& i : data) {
        std::vector<std::string> results = base::SplitString(i.input, kWhitespaceASCII, base::KEEP_WHITESPACE, base::SPLIT_WANT_NONEMPTY);
...
TEST(StringSplitTest, NullSeparatorWantNonEmpty)
{
    ...
    for (const auto& i : data) {
        std::vector<std::string_view> results
            = base::SplitStringPiece(i.test_case, base::MakeStringViewWithNulChars("\0"), base::KEEP_WHITESPACE, base::SPLIT_WANT_NONEMPTY);
...
TEST(StringSplitTest, NullSeparatorWantAll)
{
    ...
    for (const TestData& i : data) {
        std::vector<std::string_view> results
            = base::SplitStringPiece(i.test_case, base::MakeStringViewWithNulChars("\0"), base::KEEP_WHITESPACE, base::SPLIT_WANT_ALL);
        EXPECT_EQ(results, i.expected);
    }
}
