...
BASE_EXPORT std::string EscapeQueryParamValue(std::string_view text, bool use_plus);
...
// as %XX (hex).
BASE_EXPORT std::string EscapeUrlEncodedData(std::string_view path, bool use_plus);
...
BASE_EXPORT std::string UnescapeURLComponent(std::string_view escaped_text, UnescapeRule::Type rules);
...
BASE_EXPORT std::u16string UnescapeAndDecodeUTF8URLComponentWithAdjustments(
    std::string_view text, UnescapeRule::Type rules, OffsetAdjuster::Adjustments* adjustments);
...
BASE_EXPORT std::string UnescapeBinaryURLComponent(std::string_view escaped_text, UnescapeRule::Type rules = UnescapeRule::NORMAL);
...
BASE_EXPORT bool UnescapeBinaryURLComponentSafe(std::string_view escaped_text, bool fail_on_path_separators, std::string* unescaped_text);
...
// characters.
BASE_EXPORT bool ContainsEncodedBytes(std::string_view escaped_text, const std::set<unsigned char>& bytes);
