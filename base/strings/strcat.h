...
[[nodiscard]] BASE_EXPORT std::string StrCat(span<const std::string_view> pieces);
[[nodiscard]] BASE_EXPORT std::u16string StrCat(span<const std::u16string_view> pieces);
[[nodiscard]] BASE_EXPORT std::string StrCat(span<const std::string> pieces);
[[nodiscard]] BASE_EXPORT std::u16string StrCat(span<const std::u16string> pieces);
...
inline std::u16string StrCat(std::initializer_list<std::u16string_view> pieces)
{
    return StrCat(make_span(pieces));
}
...
BASE_EXPORT void StrAppend(std::u16string* dest, span<const std::u16string_view> pieces);
BASE_EXPORT void StrAppend(std::string* dest, span<const std::string> pieces);
BASE_EXPORT void StrAppend(std::u16string* dest, span<const std::u16string> pieces);
...
inline void StrAppend(std::u16string* dest, std::initializer_list<std::u16string_view> pieces)
{
    StrAppend(dest, make_span(pieces));
}
