...
class BASE_EXPORT IOPMPowerSourceSamplingEventSource : public SamplingEventSource {
public:
...
private:
    static void OnNotification(void* context, io_service_t service, natural_t message_type, void* message_argument);
