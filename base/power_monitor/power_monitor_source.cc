...
PowerThermalObserver::DeviceThermalState PowerMonitorSource::GetCurrentThermalState() const
{
...
void PowerMonitorSource::SetCurrentThermalState(PowerThermalObserver::DeviceThermalState state)
{
}
...
void PowerMonitorSource::ProcessPowerEvent(PowerEvent event_id)
{
    ...
    case POWER_STATE_EVENT:
        power_monitor->NotifyPowerStateChange(power_monitor->Source()->GetBatteryPowerStatus());
        break;
    case RESUME_EVENT:
...
// static
void PowerMonitorSource::ProcessThermalEvent(PowerThermalObserver::DeviceThermalState new_thermal_state)
{
...
// static
const char* PowerMonitorSource::DeviceThermalStateToString(PowerThermalObserver::DeviceThermalState state)
{
    switch (state) {
