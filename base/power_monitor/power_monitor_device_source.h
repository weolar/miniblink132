...
public:
    ...
    static void SetPowerSource(PowerStateObserver::BatteryPowerStatus battery_power_status);
    static void HandleSystemSuspending();
    static void HandleSystemResumed();
    static void ThermalEventReceived(PowerThermalObserver::DeviceThermalState state);
    ...
    void SetCurrentThermalState(PowerThermalObserver::DeviceThermalState state) override;
#endif
...
private:
    ...
    static void SystemPowerEventCallback(void* refcon, io_service_t service, natural_t message_type, void* message_argument);
#endif // BUILDFLAG(IS_MAC)
    ...
    void OnBatteryStateReceived(const std::optional<BatteryLevelProvider::BatteryState>& battery_state);
    ...
    PowerStateObserver::BatteryPowerStatus battery_power_status_ = PowerStateObserver::BatteryPowerStatus::kUnknown;
#endif
    ...
    std::unique_ptr<base::SequenceBound<SpeedLimitObserverWin>> speed_limit_observer_;
#endif
