...
public:
    ...
    virtual PowerThermalObserver::DeviceThermalState GetCurrentThermalState() const;
    ...
    virtual void SetCurrentThermalState(PowerThermalObserver::DeviceThermalState state);

    // Platform-specific method to determine the battery power status.
    virtual PowerStateObserver::BatteryPowerStatus GetBatteryPowerStatus() const = 0;
    ...
    static const char* DeviceThermalStateToString(PowerThermalObserver::DeviceThermalState state);
...
protected:
    ...
    friend void ProcessThermalEventHelper(PowerThermalObserver::DeviceThermalState);
    ...
    static void ProcessThermalEvent(PowerThermalObserver::DeviceThermalState new_thermal_state);
