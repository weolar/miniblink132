...
TEST_F(AtExitTest, Param)
{
    ...
    base::AtExitManager::RegisterCallback(&ExpectParamIsCounter, &g_test_counter_1);
    base::AtExitManager::ProcessCallbacksNow();
}
...
{
    ZeroTestCounters();
    base::AtExitManager::RegisterTask(base::BindOnce(&ExpectParamIsCounter, &g_test_counter_1));
    base::AtExitManager::ProcessCallbacksNow();
}
