...
constexpr perfetto::protos::pbzero::BuiltinClock kTraceClockId = perfetto::protos::pbzero::BUILTIN_CLOCK_MONOTONIC;
#else
...
constexpr perfetto::protos::pbzero::BuiltinClock kTraceClockId = perfetto::protos::pbzero::BUILTIN_CLOCK_BOOTTIME;
#endif
