...
public:
    ...
    static scoped_refptr<SolidColorScrollbarLayer> CreateOrReuse(scoped_refptr<Scrollbar>, SolidColorScrollbarLayer* existing_layer);
    ...
    {
        return color_.Read(*this);
    }

    ScrollbarLayerType GetScrollbarLayerType() const override;

private:
    SolidColorScrollbarLayer(ScrollbarOrientation orientation, int thumb_thickness, int track_start, bool is_left_side_vertical_scrollbar);
