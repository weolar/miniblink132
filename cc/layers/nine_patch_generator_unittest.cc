...
TEST(NinePatchGeneratorTest, SetLayoutReturnsChanged)
{
    ...
    EXPECT_TRUE(quad_generator.SetLayout(gfx::Size(10, 10), gfx::Size(10, 10), gfx::Rect(1, 1, 8, 8), gfx::Rect(1, 1, 2, 2), gfx::Rect(), true, false));

    EXPECT_FALSE(quad_generator.SetLayout(gfx::Size(10, 10), gfx::Size(10, 10), gfx::Rect(1, 1, 8, 8), gfx::Rect(1, 1, 2, 2), gfx::Rect(), true, false));

    EXPECT_TRUE(quad_generator.SetLayout(gfx::Size(10, 10), gfx::Size(10, 10), gfx::Rect(1, 1, 8, 8), gfx::Rect(1, 1, 2, 2), gfx::Rect(), false, false));

    EXPECT_FALSE(quad_generator.SetLayout(gfx::Size(10, 10), gfx::Size(10, 10), gfx::Rect(1, 1, 8, 8), gfx::Rect(1, 1, 2, 2), gfx::Rect(), false, false));

    EXPECT_TRUE(quad_generator.SetLayout(gfx::Size(12, 10), gfx::Size(10, 10), gfx::Rect(1, 1, 8, 8), gfx::Rect(1, 1, 2, 2), gfx::Rect(), false, false));
}

TEST(NinePatchGeneratorTest, MatchHorizontallyAndVertically)
{
    NinePatchGenerator generator;
    generator.SetLayout(gfx::Size(10, 20), gfx::Size(10, 20), gfx::Rect(1, 2, 3, 4), gfx::Rect(1, 2, 7, 16), gfx::Rect(), true, false);
...
{
    NinePatchGenerator generator;
    generator.SetLayout(gfx::Size(10, 20), gfx::Size(10, 30), gfx::Rect(1, 2, 3, 4), gfx::Rect(1, 2, 7, 16), gfx::Rect(), true, false);
...
{
    NinePatchGenerator generator;
    generator.SetLayout(gfx::Size(10, 20), gfx::Size(15, 20), gfx::Rect(1, 2, 3, 4), gfx::Rect(1, 2, 7, 16), gfx::Rect(), true, false);
...
TEST(NinePatchGeneratorTest, GenerateNonSymmetricAperture)
{
    ...
    quad_generator.SetLayout(gfx::Size(10, 10), gfx::Size(10, 10), gfx::Rect(3, 5, 2, 2), gfx::Rect(2, 4, 4, 8), gfx::Rect(), true, false);

    std::vector<NinePatchGenerator::Patch> patches = quad_generator.GeneratePatches();
...
TEST(NinePatchGeneratorTest, LargerLayerGenerate)
{
    ...
    quad_generator.SetLayout(gfx::Size(10, 10), gfx::Size(20, 15), gfx::Rect(1, 1, 8, 8), gfx::Rect(1, 1, 2, 2), gfx::Rect(), true, false);
