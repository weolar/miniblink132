...
TouchActionRegion::TouchActionRegion(const TouchActionRegion& touch_action_region) = default;
TouchActionRegion::TouchActionRegion(TouchActionRegion&& touch_action_region) = default;
...
const Region& TouchActionRegion::GetRegionForTouchAction(TouchAction touch_action) const
{
...
TouchAction TouchActionRegion::GetAllowedTouchAction(const gfx::Point& point) const
{
...
TouchActionRegion& TouchActionRegion::operator=(const TouchActionRegion& other)
{
    map_ = other.map_;
    return *this;
}

TouchActionRegion& TouchActionRegion::operator=(TouchActionRegion&& other) = default;
