...
// has.
class CC_EXPORT VideoFrameProviderClientImpl : public VideoFrameProvider::Client,
...
public:
    ...
    static scoped_refptr<VideoFrameProviderClientImpl> Create(VideoFrameProvider* provider, VideoFrameControllerClient* client);
    ...
    scoped_refptr<media::VideoFrame> AcquireLockAndCurrentFrame() EXCLUSIVE_LOCK_FUNCTION(provider_lock_);
...
private:
    ...
    VideoFrameProviderClientImpl(VideoFrameProvider* provider, VideoFrameControllerClient* client);
