...
public:
    ...
    void SetSurfaceId(const viz::SurfaceId& surface_id, const DeadlinePolicy& deadline_policy);
...
private:
    ...
    ProtectedSequenceWritable<UpdateSubmissionStateCB> update_submission_state_callback_;
