...
public:
    static std::unique_ptr<MirrorLayerImpl> Create(LayerTreeImpl* tree_impl, int id)
    {
    ...
    void SetMirroredLayerId(int id)
    {
        mirrored_layer_id_ = id;
    }
    int mirrored_layer_id() const
    {
...
private:
    ...
    {
        return viz::CompositorRenderPassId { static_cast<uint64_t>(mirrored_layer_id()) };
    }
