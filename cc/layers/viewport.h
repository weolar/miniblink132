...
public:
    ...
    ScrollResult ScrollBy(const gfx::Vector2dF& physical_delta, const gfx::Point& viewport_point, bool is_direct_manipulation, bool affect_browser_controls,
    ...
    ScrollResult ScrollAnimated(const gfx::Vector2dF& delta, base::TimeDelta delayed_by);
...
private:
    ...
    static bool ShouldAnimateViewport(const gfx::Vector2dF& viewport_delta, const gfx::Vector2dF& pending_delta);
    bool ShouldBrowserControlsConsumeScroll(const gfx::Vector2dF& scroll_delta) const;
