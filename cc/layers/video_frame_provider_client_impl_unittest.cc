...
class VideoFrameProviderClientImplTest : public testing::Test, public VideoFrameControllerClient {
public:
    VideoFrameProviderClientImplTest()
        : client_impl_(VideoFrameProviderClientImpl::Create(&provider_, this))
        , video_layer_impl_(nullptr)
        , test_frame_(media::VideoFrame::CreateFrame(media::PIXEL_FORMAT_I420, gfx::Size(10, 10), gfx::Rect(10, 10), gfx::Size(10, 10), base::TimeDelta()))
    {
        DebugSetImplThreadAndMainThreadBlocked(impl_.task_runner_provider());
    }
    VideoFrameProviderClientImplTest(const VideoFrameProviderClientImplTest&) = delete;
    ...
    VideoFrameProviderClientImplTest& operator=(const VideoFrameProviderClientImplTest&) = delete;
    ...
    void CreateActiveVideoLayer()
    {
        ...
        video_layer_impl_ = impl_.AddLayerInActiveTree<VideoLayerImpl>(&provider_, media::VIDEO_ROTATION_0);
