...
public:
    static scoped_refptr<VideoLayer> Create(VideoFrameProvider* provider, media::VideoTransformation transform);
...
private:
    VideoLayer(VideoFrameProvider* provider, media::VideoTransformation transform);
    ~VideoLayer() override;
