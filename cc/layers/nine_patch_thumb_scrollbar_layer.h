...
public:
    ...
    static scoped_refptr<NinePatchThumbScrollbarLayer> CreateOrReuse(scoped_refptr<Scrollbar> scrollbar, NinePatchThumbScrollbarLayer* existing_layer);
    static scoped_refptr<NinePatchThumbScrollbarLayer> Create(scoped_refptr<Scrollbar> scrollbar);

    NinePatchThumbScrollbarLayer(const NinePatchThumbScrollbarLayer&) = delete;
    NinePatchThumbScrollbarLayer& operator=(const NinePatchThumbScrollbarLayer&) = delete;
...
private:
    template <typename T> bool UpdateProperty(const T value, T* prop)
    {
        if (*prop == value)
            return false;
        *prop = value;
