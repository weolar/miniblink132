...
protected:
    ...
    perf_test::PerfResultReporter SetUpReporter(const std::string& metric_basename, const std::string& story_name)
    {
...
TEST_F(LayerPerfTest, PushPropertiesTo)
{
    ...
    do {
        ...
        test_layer->PushPropertiesTo(impl_layer.get(), *layer_tree_host_->GetPendingCommitState(), layer_tree_host_->GetThreadUnsafeCommitState());
    ...
    perf_test::PerfResultReporter reporter = SetUpReporter("push_properties_to", "props_changed");
...
TEST_F(LayerPerfTest, ImplPushPropertiesTo)
{
    ...
    do {
        ...
        background_color = background_color == SkColors::kRed ? SkColors::kGreen : SkColors::kRed;
        bounds = bounds == gfx::Size(1000, 1000) ? gfx::Size(500, 500) : gfx::Size(1000, 1000);
    ...
    perf_test::PerfResultReporter reporter = SetUpReporter("impl_push_properties_to", "props_changed");
    reporter.AddResult("", timer_.LapsPerSecond());
