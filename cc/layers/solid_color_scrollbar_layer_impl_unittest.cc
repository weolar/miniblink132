...
TEST(SolidColorScrollbarLayerImplTest, Occlusion)
{
    ...
    SolidColorScrollbarLayerImpl* scrollbar_layer_impl
        = impl.AddLayerInActiveTree<SolidColorScrollbarLayerImpl>(orientation, thumb_thickness, track_start, is_left_side_vertical_scrollbar);
    ...
    EXPECT_EQ(gfx::Rect(0, 500 / 4, 10, layer_size.height() / 2).ToString(), thumb_rect.ToString());
