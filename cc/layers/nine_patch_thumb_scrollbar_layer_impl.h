...
class CC_EXPORT NinePatchThumbScrollbarLayerImpl : public ScrollbarLayerImplBase {
public:
    ...
    NinePatchThumbScrollbarLayerImpl(const NinePatchThumbScrollbarLayerImpl&) = delete;
    NinePatchThumbScrollbarLayerImpl& operator=(const NinePatchThumbScrollbarLayerImpl&) = delete;
...
protected:
    NinePatchThumbScrollbarLayerImpl(LayerTreeImpl* tree_impl, int id, ScrollbarOrientation orientation, bool is_left_side_vertical_scrollbar);
...
private:
    void AppendThumbQuads(viz::CompositorRenderPass* render_pass, AppendQuadsData* append_quads_data, viz::SharedQuadState* shared_quad_state);

    void AppendTrackAndButtonsQuads(viz::CompositorRenderPass* render_pass, AppendQuadsData* append_quads_data, viz::SharedQuadState* shared_quad_state);
