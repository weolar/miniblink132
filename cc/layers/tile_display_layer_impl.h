...
public:
    ...
    public:
        ...
        virtual void DidAppendQuadsWithResources(const std::vector<viz::TransferableResource>& resource) = 0;
    };

    struct NoContents { };

    struct CC_EXPORT TileResource {
        TileResource(const viz::TransferableResource& resource, bool is_premultiplied, bool is_checkered);
    ...
    public:
        ...
        const TileContents& contents() const
        {
            return contents_;
        }
    ...
    public:
        ...
        CoverageIterator Cover(const gfx::Rect& coverage_rect, float coverage_scale) const;
    ...
    class CC_EXPORT DisplayTilingCoverageIterator : public TilingCoverageIterator<Tiling> {
    public:
