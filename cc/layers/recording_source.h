...
public:
    ...
    bool Update(const gfx::Size& layer_size, float recording_scale_factor, ContentLayerClient& content_layer_client, Region& invalidation);
    gfx::Size size() const
    {
        return size_;
    }
    ...
    const gfx::Rect& recorded_bounds() const
    {
...
private:
    void UpdateInvalidationForRecordedBounds(const gfx::Rect& old_recorded_bounds, const gfx::Rect& new_recorded_bounds, Region& invalidation);
