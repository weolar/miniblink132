...
public:
    static std::unique_ptr<TextureLayerImpl> Create(LayerTreeImpl* tree_impl, int id)
    {
    ...
    std::unique_ptr<LayerImpl> CreateLayerImpl(LayerTreeImpl* layer_tree_impl) const override;
    ...
    // layer.
    void RegisterSharedBitmapId(viz::SharedBitmapId id, scoped_refptr<CrossThreadSharedBitmap> bitmap);
    ...
    // visibility change.
    static bool MayEvictResourceInBackground(viz::TransferableResource::ResourceSource source);
...
private:
    ...
    base::flat_map<viz::SharedBitmapId, scoped_refptr<CrossThreadSharedBitmap>> to_register_bitmaps_;
    ...
    // occurs).
    base::flat_map<viz::SharedBitmapId, scoped_refptr<CrossThreadSharedBitmap>> registered_bitmaps_;
