...
public:
    ...
    void CaptureContent(const gfx::Rect& rect, std::vector<NodeInfo>* content) const override;
...
private:
    ...
    ProtectedSequenceForbidden<devtools_instrumentation::ScopedLayerObjectTracker> instrumentation_object_tracker_;
