...
public:
    static scoped_refptr<ViewTransitionContentLayer> Create(const viz::ViewTransitionElementResourceId& resource_id, bool is_live_content_layer);

    ViewTransitionContentLayer(const ViewTransitionContentLayer&) = delete;
    ViewTransitionContentLayer& operator=(const ViewTransitionContentLayer&) = delete;
    ...
    void SetMaxExtentsRectInOriginatingLayerSpace(const gfx::RectF& max_extents_rect_in_originating_layer_space);

protected:
    explicit ViewTransitionContentLayer(const viz::ViewTransitionElementResourceId& resource_id, bool is_live_content_layer);
