...
private:
    ...
    struct CC_BASE_EXPORT PositionInCharAllocator {
        ...
        PositionInCharAllocator(CharAllocator* container, size_t vector_ind, char* item_iter);
    ...
    public:
        ...
        Iterator(CharAllocator* container, size_t vector_ind, char* item_iter, size_t index);
        ~Iterator();
    ...
    public:
        ...
        ConstIterator(CharAllocator* container, size_t vector_ind, char* item_iter, size_t index);
    ...
    public:
        ...
        ReverseIterator(CharAllocator* container, size_t vector_ind, char* item_iter, size_t index);
        ~ReverseIterator();
    ...
    public:
        ...
        ConstReverseIterator(CharAllocator* container, size_t vector_ind, char* item_iter, size_t index);
    ...
    void InsertBeforeAndInvalidateAllPointers(Iterator* position, size_t number_of_elements);
