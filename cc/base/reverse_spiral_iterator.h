...
public:
    ...
    ReverseSpiralIterator(const IndexRect& around_index_rect, const IndexRect& consider_index_rect, const IndexRect& ignore_index_rect);
...
private:
    ...
    {
        return (direction_ == Direction::kUp || direction_ == Direction::kDown) ? vertical_step_count_ : horizontal_step_count_;
    }
