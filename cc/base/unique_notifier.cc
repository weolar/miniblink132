...
UniqueNotifier::UniqueNotifier(base::SequencedTaskRunner* task_runner, base::RepeatingClosure closure)
...
void UniqueNotifier::Schedule()
{
    ...
    task_runner_->PostTask(FROM_HERE, base::BindOnce(&UniqueNotifier::Notify, weak_ptr_factory_.GetWeakPtr()));
