...
public:
    ...
    size_t GetRegionComplexity() const
    {
        return rect_.IsEmpty() ? 0 : 1;
    }
    ...
    void Intersect(const gfx::Rect& in_rect)
    {
        return rect_.Intersect(in_rect);
    }
...
inline bool operator==(const SimpleEnclosedRegion& a, const SimpleEnclosedRegion& b)
{
    return a.Equals(b);
}
...
inline SimpleEnclosedRegion SubtractSimpleEnclosedRegions(const SimpleEnclosedRegion& a, const SimpleEnclosedRegion& b)
{
...
inline SimpleEnclosedRegion IntersectSimpleEnclosedRegions(const SimpleEnclosedRegion& a, const SimpleEnclosedRegion& b)
{
    SimpleEnclosedRegion result = a;
    result.Intersect(b);
    return result;
...
inline SimpleEnclosedRegion UnionSimpleEnclosedRegions(const SimpleEnclosedRegion& a, const SimpleEnclosedRegion& b)
{
    SimpleEnclosedRegion result = a;
    result.Union(b);
    return result;
