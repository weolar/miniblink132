...
struct CC_BASE_EXPORT CategoryName {
    ...
    static constexpr const char kTimeline[] = TRACE_DISABLED_BY_DEFAULT("devtools.timeline");
    static constexpr const char kTimelineFrame[] = TRACE_DISABLED_BY_DEFAULT("devtools.timeline.frame");
};
...
public:
    ...
    {
        TRACE_EVENT_BEGIN1(internal::CategoryName::kTimeline, event_name_, internal::kLayerId, layer_id);
    }
...
public:
    ...
    void SuppressMetrics()
    {
        suppress_metrics_ = true;
    }
...
public:
    ...
    ScopedImageDecodeTask(const void* image_ptr, DecodeType decode_type, TaskType task_type, ImageType image_type);
...
public:
    ScopedLayerTreeTask(const char* event_name, int layer_id, int layer_tree_host_id)
        : event_name_(event_name)
    {
        TRACE_EVENT_BEGIN2(internal::CategoryName::kTimeline, event_name_, internal::kLayerId, layer_id, internal::kLayerTreeId, layer_tree_host_id);
    }
...
public:
    ...
    {
        TRACE_EVENT_BEGIN2(
            internal::CategoryName::kTimeline, internal::kCommit, internal::kLayerTreeId, layer_tree_host_id, internal::kFrameSequenceNumber, sequence_number);
    }
...
struct CC_BASE_EXPORT ScopedLayerObjectTracker : public base::trace_event::TraceScopedTrackableObject<int, internal::CategoryName::kTimeline> {
    explicit ScopedLayerObjectTracker(int layer_id)
        : base::trace_event::TraceScopedTrackableObject<int, internal::CategoryName::kTimeline>(internal::kLayerId, layer_id)
    {
    }
...
inline void CC_BASE_EXPORT DidActivateLayerTree(int layer_tree_host_id, int frame_id)
{
    TRACE_EVENT_INSTANT2(internal::CategoryName::kTimelineFrame, internal::kActivateLayerTree, TRACE_EVENT_SCOPE_THREAD, internal::kLayerTreeId,
        layer_tree_host_id, internal::kFrameId, frame_id);
}

inline void CC_BASE_EXPORT DidBeginFrame(int layer_tree_host_id, base::TimeTicks begin_frame_timestamp, uint64_t sequence_number)
{
    TRACE_EVENT_INSTANT(internal::CategoryName::kTimelineFrame, perfetto::StaticString(internal::kBeginFrame), begin_frame_timestamp, internal::kLayerTreeId,
        layer_tree_host_id, internal::kFrameSequenceNumber, sequence_number);
}

inline void CC_BASE_EXPORT DidDrawFrame(int layer_tree_host_id, uint64_t sequence_number)
{
    TRACE_EVENT_INSTANT2(internal::CategoryName::kTimelineFrame, internal::kDrawFrame, TRACE_EVENT_SCOPE_THREAD, internal::kLayerTreeId, layer_tree_host_id,
...
inline void CC_BASE_EXPORT DidRequestMainThreadFrame(int layer_tree_host_id)
{
    TRACE_EVENT_INSTANT1(
        internal::CategoryName::kTimelineFrame, internal::kRequestMainThreadFrame, TRACE_EVENT_SCOPE_THREAD, internal::kLayerTreeId, layer_tree_host_id);
}

inline void CC_BASE_EXPORT DidDropSmoothnessFrame(
    int layer_tree_host_id, base::TimeTicks dropped_frame_timestamp, uint64_t sequence_number, bool has_partial_update)
{
    TRACE_EVENT_INSTANT(internal::CategoryName::kTimelineFrame, perfetto::StaticString(internal::kDroppedFrame), dropped_frame_timestamp,
        internal::kLayerTreeId, layer_tree_host_id, internal::kFrameSequenceNumber, sequence_number, internal::kHasPartialUpdate, has_partial_update);
}

inline std::unique_ptr<base::trace_event::ConvertableToTraceFormat> BeginMainThreadFrameData(int frame_id)
{
...
inline void CC_BASE_EXPORT WillBeginMainThreadFrame(int layer_tree_host_id, int frame_id)
{
    TRACE_EVENT_INSTANT2(internal::CategoryName::kTimelineFrame, internal::kBeginMainThreadFrame, TRACE_EVENT_SCOPE_THREAD, internal::kLayerTreeId,
        layer_tree_host_id, internal::kData, BeginMainThreadFrameData(frame_id));
}

inline std::unique_ptr<base::trace_event::ConvertableToTraceFormat> NeedsBeginFrameData(bool needs_begin_frame)
{
    std::unique_ptr<base::trace_event::TracedValue> value(new base::trace_event::TracedValue());
...
inline void CC_BASE_EXPORT NeedsBeginFrameChanged(int layer_tree_host_id, bool new_value)
{
    TRACE_EVENT_INSTANT2(internal::CategoryName::kTimelineFrame, internal::kNeedsBeginFrameChanged, TRACE_EVENT_SCOPE_THREAD, internal::kLayerTreeId,
        layer_tree_host_id, internal::kData, NeedsBeginFrameData(new_value));
}
