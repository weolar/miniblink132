...
template <typename Container> typename Container::value_type PopFront(Container* container)
{
...
template <typename Container> typename Container::value_type PopBack(Container* container)
{
