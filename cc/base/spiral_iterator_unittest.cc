    ...
    const std::vector<std::pair<int, int>>& expected)
{
    ...
    EXPECT_EQ(expected, actual_forward) << "Error from line " << source_line_number;
    ...
    EXPECT_EQ(reversed_expected, actual_reverse) << "Error from line " << source_line_number;
}
...
INSTANTIATE_TEST_SUITE_P(
    All, SpiralIteratorTest, ::testing::Values(gfx::Vector2d(0, 0), gfx::Vector2d(50, 100), gfx::Vector2d(17, 31), gfx::Vector2d(10000, 15000)));
...
TEST_P(SpiralIteratorTest, NoIgnoreFullConsider)
{
  ...
  */
    ...
    //  2 │  7│  8│  9│
    //    └───┴───┴───┘
    expected = { { 0, 0 }, { 1, 0 }, { 0, 1 }, { 1, 1 }, { 2, 1 }, { 2, 0 }, { 0, 2 }, { 1, 2 }, { 2, 2 } };
...
TEST_P(SpiralIteratorTest, HasIgnore)
{
    ...
    //  4 │  9│  I│  I│  I│ 10│
    //    └───┴───┴───┴───┴───┘
    expected = { { 0, 0 }, { 0, 1 }, { 0, 2 }, { 0, 3 }, { 4, 3 }, { 4, 2 }, { 4, 1 }, { 4, 0 }, { 0, 4 }, { 4, 4 } };
    TestSpiralIterate(__LINE__, tiling_data, consider, ignore, center, expected);
    ...
    //  4 │  6│  7│  8│  9│ 10│
    //    └───┴───┴───┴───┴───┘
    expected = { { 0, 3 }, { 1, 3 }, { 2, 3 }, { 3, 3 }, { 4, 3 }, { 0, 4 }, { 1, 4 }, { 2, 4 }, { 3, 4 }, { 4, 4 } };
    TestSpiralIterate(__LINE__, tiling_data, consider, ignore, center, expected);
}
...
TEST_P(SpiralIteratorTest, RectangleCenter)
{
    ...
    //  4 │ 23│  8│  9│ 10│ 11│
    //    └───┴───┴───┴───┴───┘
    expected = { { 3, 3 }, { 3, 2 }, { 3, 1 }, { 2, 1 }, { 1, 1 }, { 1, 2 }, { 1, 3 }, { 1, 4 }, { 2, 4 }, { 3, 4 }, { 4, 4 }, { 4, 3 }, { 4, 2 }, { 4, 1 },
    ...
    //  4 │ 10│ 11│ 12│ 13│ 14│
    //    └───┴───┴───┴───┴───┘
    expected = { { 4, 3 }, { 4, 2 }, { 4, 1 }, { 3, 1 }, { 2, 1 }, { 1, 1 }, { 0, 1 }, { 0, 2 }, { 0, 3 }, { 0, 4 }, { 1, 4 }, { 2, 4 }, { 3, 4 }, { 4, 4 },
        { 4, 0 }, { 3, 0 }, { 2, 0 }, { 1, 0 }, { 0, 0 } };
    TestSpiralIterate(__LINE__, tiling_data, consider, ignore, center, expected);
    ...
    // * 4 │  1│  6│ 11│ 16│ 21│
    //     └───┴───┴───┴───┴───┘
    expected = { { 0, 4 }, { 0, 3 }, { 0, 2 }, { 0, 1 }, { 0, 0 }, { 1, 4 }, { 1, 3 }, { 1, 2 }, { 1, 1 }, { 1, 0 }, { 2, 4 }, { 2, 3 }, { 2, 2 }, { 2, 1 },
        { 2, 0 }, { 3, 4 }, { 3, 3 }, { 3, 2 }, { 3, 1 }, { 3, 0 }, { 4, 4 }, { 4, 3 }, { 4, 2 }, { 4, 1 }, { 4, 0 } };
    TestSpiralIterate(__LINE__, tiling_data, consider, ignore, center, expected);
}
...
TEST_P(SpiralIteratorTest, EdgeCases)
{
    ...
    // * 2 │  1│  4│  7│
    //     └───┴───┴───┘
    expected = { { 0, 2 }, { 0, 1 }, { 0, 0 }, { 1, 2 }, { 1, 1 }, { 1, 0 }, { 2, 2 }, { 2, 1 }, { 2, 0 } };
    TestSpiralIterate(__LINE__, tiling_data, consider, ignore, center, expected);
