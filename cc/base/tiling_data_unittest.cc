...
int NumTiles(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels)
{
...
int XIndex(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int x_coord)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.TileXIndexFromSrcCoord(x_coord);
}

int YIndex(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int y_coord)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.TileYIndexFromSrcCoord(y_coord);
}

int MinBorderXIndex(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int x_coord)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.FirstBorderTileXIndexFromSrcCoord(x_coord);
}

int MinBorderYIndex(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int y_coord)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.FirstBorderTileYIndexFromSrcCoord(y_coord);
}

int MaxBorderXIndex(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int x_coord)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.LastBorderTileXIndexFromSrcCoord(x_coord);
}

int MaxBorderYIndex(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int y_coord)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.LastBorderTileYIndexFromSrcCoord(y_coord);
}

int PosX(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int x_index)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.TilePositionX(x_index);
}

int PosY(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int y_index)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.TilePositionY(y_index);
}

int SizeX(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int x_index)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
    return tiling.TileSizeX(x_index);
}

int SizeY(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels, int y_index)
{
    TilingData tiling(max_texture_size, tiling_rect, border_texels);
...
public:
    static gfx::Vector2d offset()
    {
        return GetParam();
    }
    static int OffsetX(int x)
    {
        return x + offset().x();
    }
    static int OffsetY(int y)
    {
        return y + offset().y();
    }
    static gfx::Rect OffsetRect(int w, int h)
    {
        return OffsetRect(0, 0, w, h);
    }
...
INSTANTIATE_TEST_SUITE_P(
    All, TilingDataTest, ::testing::Values(gfx::Vector2d(0, 0), gfx::Vector2d(50, 100), gfx::Vector2d(17, 31), gfx::Vector2d(10000, 15000)));
...
{
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(2)));
    EXPECT_EQ(1, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(3)));
    EXPECT_EQ(1, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(4)));
    EXPECT_EQ(1, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(5)));
    EXPECT_EQ(2, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(6)));
    EXPECT_EQ(2, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(7)));
    EXPECT_EQ(2, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(8)));
    EXPECT_EQ(3, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(9)));
    EXPECT_EQ(3, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(10)));
    EXPECT_EQ(3, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(11)));

    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(2)));
    EXPECT_EQ(1, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(3)));
    EXPECT_EQ(2, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(4)));
    EXPECT_EQ(3, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(5)));
    EXPECT_EQ(4, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(6)));
    EXPECT_EQ(5, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(7)));
    EXPECT_EQ(6, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(8)));
    EXPECT_EQ(7, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(9)));
    EXPECT_EQ(7, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(10)));
    EXPECT_EQ(7, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(11)));

    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(1, 1), OffsetRect(1, 1), 0, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetX(2)));

    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(2)));
    EXPECT_EQ(1, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(3)));

    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(1, 1), OffsetRect(1, 1), 1, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetX(2)));

    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(0)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(1)));
    EXPECT_EQ(0, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(2)));
    EXPECT_EQ(1, MinBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(3)));
}

TEST_P(TilingDataTest, LastBorderTileXIndexFromSrcCoord)
{
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(1)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(2)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(3)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(4)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(5)));
    EXPECT_EQ(2, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(6)));
    EXPECT_EQ(2, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(7)));
    EXPECT_EQ(2, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(8)));
    EXPECT_EQ(3, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(9)));
    EXPECT_EQ(3, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(10)));
    EXPECT_EQ(3, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetX(11)));

    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(0)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(1)));
    EXPECT_EQ(2, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(2)));
    EXPECT_EQ(3, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(3)));
    EXPECT_EQ(4, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(4)));
    EXPECT_EQ(5, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(5)));
    EXPECT_EQ(6, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(6)));
    EXPECT_EQ(7, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(7)));
    EXPECT_EQ(7, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(8)));
    EXPECT_EQ(7, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(9)));
    EXPECT_EQ(7, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(10)));
    EXPECT_EQ(7, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetX(11)));

    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(1, 1), OffsetRect(1, 1), 0, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetX(1)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetX(1)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetX(2)));

    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(1)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(2)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 0, OffsetX(3)));

    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(1, 1), OffsetRect(1, 1), 1, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetX(1)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetX(0)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetX(1)));
    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetX(2)));

    EXPECT_EQ(0, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(0)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(1)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(2)));
    EXPECT_EQ(1, MaxBorderXIndex(gfx::Size(3, 3), OffsetRect(4, 3), 1, OffsetX(3)));
}
...
{
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(2)));
    EXPECT_EQ(1, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(3)));
    EXPECT_EQ(1, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(4)));
    EXPECT_EQ(1, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(5)));
    EXPECT_EQ(2, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(6)));
    EXPECT_EQ(2, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(7)));
    EXPECT_EQ(2, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(8)));
    EXPECT_EQ(3, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(9)));
    EXPECT_EQ(3, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(10)));
    EXPECT_EQ(3, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(11)));

    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(2)));
    EXPECT_EQ(1, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(3)));
    EXPECT_EQ(2, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(4)));
    EXPECT_EQ(3, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(5)));
    EXPECT_EQ(4, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(6)));
    EXPECT_EQ(5, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(7)));
    EXPECT_EQ(6, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(8)));
    EXPECT_EQ(7, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(9)));
    EXPECT_EQ(7, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(10)));
    EXPECT_EQ(7, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(11)));

    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(1, 1), OffsetRect(1, 1), 0, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetY(2)));

    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(2)));
    EXPECT_EQ(1, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(3)));

    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(1, 1), OffsetRect(1, 1), 1, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetY(2)));

    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(0)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(1)));
    EXPECT_EQ(0, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(2)));
    EXPECT_EQ(1, MinBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(3)));
}

TEST_P(TilingDataTest, LastBorderTileYIndexFromSrcCoord)
{
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(1)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(2)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(3)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(4)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(5)));
    EXPECT_EQ(2, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(6)));
    EXPECT_EQ(2, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(7)));
    EXPECT_EQ(2, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(8)));
    EXPECT_EQ(3, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(9)));
    EXPECT_EQ(3, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(10)));
    EXPECT_EQ(3, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 0, OffsetY(11)));

    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(0)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(1)));
    EXPECT_EQ(2, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(2)));
    EXPECT_EQ(3, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(3)));
    EXPECT_EQ(4, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(4)));
    EXPECT_EQ(5, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(5)));
    EXPECT_EQ(6, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(6)));
    EXPECT_EQ(7, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(7)));
    EXPECT_EQ(7, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(8)));
    EXPECT_EQ(7, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(9)));
    EXPECT_EQ(7, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(10)));
    EXPECT_EQ(7, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(10, 10), 1, OffsetY(11)));

    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(1, 1), OffsetRect(1, 1), 0, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 0, OffsetY(1)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetY(1)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 0, OffsetY(2)));

    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(1)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(2)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 0, OffsetY(3)));

    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(1, 1), OffsetRect(1, 1), 1, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(2, 2), OffsetRect(2, 2), 1, OffsetY(1)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetY(0)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetY(1)));
    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 3), 1, OffsetY(2)));

    EXPECT_EQ(0, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(0)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(1)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(2)));
    EXPECT_EQ(1, MaxBorderYIndex(gfx::Size(3, 3), OffsetRect(3, 4), 1, OffsetY(3)));
}
...
TEST_P(TilingDataTest, ExpandRectToTileBounds)
{
    ...
    gfx::Rect rect_result(gfx::UnionRects(data.TileBounds(2, 2), data.TileBounds(3, 4)));
    ...
    gfx::Rect border_rect_src(gfx::UnionRects(data.TileBounds(1, 2), data.TileBounds(3, 4)));
    gfx::Rect border_rect_result(gfx::UnionRects(data.TileBounds(0, 1), data.TileBounds(4, 5)));
    EXPECT_EQ(border_rect_result, data.ExpandRectToTileBounds(border_rect_src));

    // Equal to tiling rect.
    EXPECT_EQ(data.tiling_rect(), data.ExpandRectToTileBounds(data.tiling_rect()));

    // Containing, but larger than tiling rect.
    EXPECT_EQ(data.tiling_rect(), data.ExpandRectToTileBounds(OffsetRect(100, 100)));
    ...
    inner_rect_src.Inset(gfx::Insets::VH(data.border_texels(), data2.border_texels()));
...
void TestIterate(const TilingData& data, gfx::Rect rect, int expect_left, int expect_top, int expect_right, int expect_bottom, bool include_borders)
{
    ...
    SCOPED_TRACE(base::StringPrintf("TilingData: max_texture_size=%s, tiling_rect=%s, border_texels=%d; "
                                    "rect: %s; expected(left,top,right,bottom): %d,%d,%d,%d; "
                                    "include_borders: %d",
        data.max_texture_size().ToString().c_str(), data.tiling_rect().ToString().c_str(), data.border_texels(), rect.ToString().c_str(), expect_left,
        expect_top, expect_right, expect_bottom, include_borders));
    ...
    for (int x = 0; x < data.num_tiles_x(); ++x) {
        for (int y = 0; y < data.num_tiles_y(); ++y) {
            ...
            SCOPED_TRACE(base::StringPrintf("x:%d y:%d bounds:%s", x, y, bounds.ToString().c_str()));
    ...
    // Verify with vanilla iterator.
    {
        ...
        for (TilingData::Iterator iter(&data, rect, include_borders); iter; ++iter) {
            bool found = false;
    ...
    if (!include_borders) {
        std::vector<std::pair<int, int>> expected = original_expected;
        for (TilingData::DifferenceIterator iter(&data, rect, gfx::Rect()); iter; ++iter) {
            bool found = false;
            for (size_t i = 0; i < expected.size(); ++i) {
                if (expected[i] == iter.index()) {
                    expected[i] = expected.back();
...
void TestIterateBorders(const TilingData& data, gfx::Rect rect, int expect_left, int expect_top, int expect_right, int expect_bottom)
{
    bool include_borders = true;
    TestIterate(data, rect, expect_left, expect_top, expect_right, expect_bottom, include_borders);
}

void TestIterateNoBorders(const TilingData& data, gfx::Rect rect, int expect_left, int expect_top, int expect_right, int expect_bottom)
{
    bool include_borders = false;
    TestIterate(data, rect, expect_left, expect_top, expect_right, expect_bottom, include_borders);
}

void TestIterateAll(const TilingData& data, gfx::Rect rect, int expect_left, int expect_top, int expect_right, int expect_bottom)
{
    TestIterateBorders(data, rect, expect_left, expect_top, expect_right, expect_bottom);
...
void TestDiff(const TilingData& data, gfx::Rect consider, gfx::Rect ignore, size_t num_tiles)
{
    ...
    for (TilingData::DifferenceIterator iter(&data, consider, ignore); iter; ++iter) {
        bool found = false;
        for (size_t i = 0; i < expected.size(); ++i) {
            if (expected[i] == iter.index()) {
                expected[i] = expected.back();
