...
public:
    ...
    ProtectedSequenceSynchronizer& operator=(const ProtectedSequenceSynchronizer&) = delete;
...
template <typename T> class ProtectedSequenceForbidden {
public:
    ...
    ProtectedSequenceForbidden& operator=(const ProtectedSequenceForbidden&) = delete;
...
template <typename T> class ProtectedSequenceReadable {
public:
    template <typename... Args>
    ...
    ProtectedSequenceReadable& operator=(const ProtectedSequenceReadable&) = delete;
...
template <typename T> class ProtectedSequenceWritable {
public:
    template <typename... Args>
    ...
    ProtectedSequenceWritable& operator=(const ProtectedSequenceWritable&) = delete;
...
template <typename T> class ProtectedSequenceForbidden<std::unique_ptr<T>> {
public:
    template <typename... Args>
    explicit ProtectedSequenceForbidden(Args&&... args)
        : value_(std::forward<Args>(args)...)
...
template <typename T> class ProtectedSequenceReadable<std::unique_ptr<T>> {
public:
    template <typename... Args>
    explicit ProtectedSequenceReadable(Args&&... args)
        : value_(std::forward<Args>(args)...)
...
template <typename T> class ProtectedSequenceWritable<std::unique_ptr<T>> {
public:
    template <typename... Args>
    explicit ProtectedSequenceWritable(Args&&... args)
        : value_(std::forward<Args>(args)...)
