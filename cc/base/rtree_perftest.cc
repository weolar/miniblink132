...
template <typename Container> size_t Accumulate(const Container& container)
{
    size_t result = 0;
...
public:
    ...
    void RunSearchTest(const std::string& test_name, int rect_count)
    {
        ...
        std::vector<gfx::Rect> queries = { gfx::Rect(0, 0, 1, 1), gfx::Rect(100, 100, 2, 2), gfx::Rect(-10, -10, 1, 1), gfx::Rect(0, 0, 1000, 1000),
