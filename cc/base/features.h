...
CC_BASE_EXPORT extern const base::FeatureParam<int> kDeferImplInvalidationFrames;
...
CC_BASE_EXPORT extern const base::FeatureParam<double> kWaitForLateScrollEventsDeadlineRatio;
...
CC_BASE_EXPORT extern const base::FeatureParam<std::string> kScrollEventDispatchMode;
CC_BASE_EXPORT extern const char kScrollEventDispatchModeDispatchScrollEventsImmediately[];
CC_BASE_EXPORT extern const char kScrollEventDispatchModeUseScrollPredictorForEmptyQueue[];
CC_BASE_EXPORT extern const char kScrollEventDispatchModeUseScrollPredictorForDeadline[];
...
CC_BASE_EXPORT extern const base::FeatureParam<int> kNumDidNotProduceFrameBeforeThrottle;
