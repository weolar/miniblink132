...
public:
    TilingData();
    TilingData(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, int border_texels);
    TilingData(const gfx::Size& max_texture_size, const gfx::Rect& tiling_rect, bool has_border_texels) = delete;
    ...
    gfx::Size max_texture_size() const
    {
        return max_texture_size_;
    }
    void SetMaxTextureSize(const gfx::Size& max_texture_size);

    int border_texels() const
    {
        return border_texels_;
    }

    bool has_empty_bounds() const
    {
        return !num_tiles_x_ || !num_tiles_y_;
    }
    ...
    public:
        Iterator();
        Iterator(const TilingData* tiling_data, const gfx::Rect& consider_rect, bool include_borders);
        Iterator& operator++();
    ...
    protected:
        ...
        BaseDifferenceIterator(const TilingData* tiling_data, const gfx::Rect& consider_rect, const gfx::Rect& ignore_rect);
    ...
    public:
        DifferenceIterator();
        DifferenceIterator(const TilingData* tiling_data, const gfx::Rect& consider_rect, const gfx::Rect& ignore_rect);
    ...
    class CC_BASE_EXPORT SpiralDifferenceIterator : public BaseDifferenceIterator {
    public:
        SpiralDifferenceIterator();
        SpiralDifferenceIterator(const TilingData* tiling_data, const gfx::Rect& consider_rect, const gfx::Rect& ignore_rect, const gfx::Rect& center_rect);
    ...
    class CC_BASE_EXPORT ReverseSpiralDifferenceIterator : public BaseDifferenceIterator {
    public:
