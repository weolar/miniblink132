...
public:
    struct CC_EXPORT LatencyData {
        LatencyData(EventMetrics::EventType event_type, base::TimeDelta total_latency);
        ~LatencyData();
        ...
        absl::variant<absl::monostate, ScrollEventMetrics::ScrollType, PinchEventMetrics::PinchType> input_type;
    };
