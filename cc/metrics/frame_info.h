...
struct CC_EXPORT FrameInfo {
    ...
    enum class SmoothThread { kSmoothNone, kSmoothCompositor, kSmoothMain, kSmoothBoth };
    ...
    FrameFinalState GetFinalStateForThread(SmoothEffectDrivingThread thread) const;
    base::TimeTicks GetTerminationTimeForThread(SmoothEffectDrivingThread thread) const;
