...
public:
    ...
    VideoPlaybackRoughnessReporter(const VideoPlaybackRoughnessReporter&) = delete;
    VideoPlaybackRoughnessReporter& operator=(const VideoPlaybackRoughnessReporter&) = delete;
    ...
    void FramePresented(TokenType token, base::TimeTicks timestamp, bool reliable_timestamp);
    ...
    static_assert(kPercentileToSubmit > 0 && kPercentileToSubmit < 100, "invalid percentile value");
