...
class EventsMetricsManager::ScopedMonitorImpl : public EventsMetricsManager::ScopedMonitor {
public:
...
std::unique_ptr<EventsMetricsManager::ScopedMonitor> EventsMetricsManager::GetScopedMonitor(ScopedMonitor::DoneCallback done_callback)
{
    auto monitor = std::make_unique<ScopedMonitorImpl>(this, std::move(done_callback));
...
void EventsMetricsManager::OnScopedMonitorEnded(std::unique_ptr<EventMetrics> metrics)
{
