...
public:
    ...
    public:
        ...
        using DoneCallback = base::OnceCallback<std::unique_ptr<EventMetrics>(bool handled)>;
    ...
    std::unique_ptr<ScopedMonitor> GetScopedMonitor(ScopedMonitor::DoneCallback done_callback);
...
private:
    ...
    std::vector<raw_ptr<ScopedMonitorImpl, VectorExperimental>> active_scoped_monitors_;
