...
public:
    ...
    CompositorTimingHistory(UMACategory uma_category, RenderingStatsInstrumentation* rendering_stats_instrumentation);
    ...
    virtual base::TimeDelta BeginMainFrameQueueDurationNotCriticalEstimate() const;
    virtual base::TimeDelta BeginMainFrameStartToReadyToCommitDurationEstimate() const;
...
protected:
    ...
    RollingTimeDeltaHistory begin_main_frame_start_to_ready_to_commit_duration_history_;
    ...
    raw_ptr<RenderingStatsInstrumentation, DanglingUntriaged> rendering_stats_instrumentation_;
};
