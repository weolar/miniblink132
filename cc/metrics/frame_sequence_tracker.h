...
public:
    ...
    static const char* GetFrameSequenceTrackerTypeName(FrameSequenceTrackerType type);
    ...
    // BeginFrameArgs.
    void ReportFrameEnd(const viz::BeginFrameArgs& args, const viz::BeginFrameArgs& main_args);
    ...
    int custom_sequence_id() const
    {
        return custom_sequence_id_;
    }
...
private:
    ...
    FrameSequenceTracker(int custom_sequence_id, FrameSequenceMetrics::CustomReporter custom_reporter);
