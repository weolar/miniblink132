...
public:
    using ViewTransitionElementMap = std::map<viz::ViewTransitionElementResourceId, viz::CompositorRenderPassId>;
    ...
    using ViewTransitionCaptureCallback = base::OnceCallback<void(const ViewTransitionContentRectMap&)>;
    ...
    static std::unique_ptr<ViewTransitionRequest> CreateCapture(const blink::ViewTransitionToken& transition_token, bool maybe_cross_frame_sink,
    ...
    static std::unique_ptr<ViewTransitionRequest> CreateAnimateRenderer(const blink::ViewTransitionToken& transition_token, bool maybe_cross_frame_sink);

    // Creates a Type::kRelease type of request.
    static std::unique_ptr<ViewTransitionRequest> CreateRelease(const blink::ViewTransitionToken& transition_token, bool maybe_cross_frame_sink);
...
private:
    ViewTransitionRequest(Type type, const blink::ViewTransitionToken& transition_token, bool maybe_cross_frame_sink,
        std::vector<viz::ViewTransitionElementResourceId> capture_ids, ViewTransitionCaptureCallback commit_callback);
