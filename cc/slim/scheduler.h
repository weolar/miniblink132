...
public:
    ...
    // DoBeginFrame again.
    virtual void SendDidNotProduceFrame(const viz::BeginFrameArgs& begin_frame_args) = 0;
};
...
public:
    ...
    virtual void OnBeginFrameFromViz(const viz::BeginFrameArgs& begin_frame_args) = 0;
