...
public:
    ...
    const std::optional<::viz::HitTestRegionList>& GetLastHitTestRegionList() const;
    bool bind_to_client_called() const
    {
        return bind_to_client_called_;
    }
...
private:
    ...
    TestFrameSinkImpl(scoped_refptr<base::SingleThreadTaskRunner> task_runner,
