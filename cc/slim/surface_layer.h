...
public:
    ...
    void SetSurfaceId(const viz::SurfaceId& surface_id, const cc::DeadlinePolicy& deadline_policy);
    ...
    void RegisterOffsetTag(const viz::OffsetTag& tag, const viz::OffsetTagConstraints& constraints);
...
private:
    ...
    void AppendQuads(viz::CompositorRenderPass& render_pass, FrameData& data, const gfx::Transform& transform_to_root,
        const gfx::Transform& transform_to_target, const gfx::Rect* clip_in_target, const gfx::Rect& visible_rect, float opacity) override;
