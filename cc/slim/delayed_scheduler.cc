...
void DelayedScheduler::OnBeginFrameFromViz(const viz::BeginFrameArgs& begin_frame_args)
{
...
void DelayedScheduler::SendDidNotProduceFrameAndResetArgs(viz::BeginFrameArgs& args)
{
    // Make a copy and clear immediately to avoid re-entrancy issues.
    viz::BeginFrameArgs copy = args;
    args = viz::BeginFrameArgs();
