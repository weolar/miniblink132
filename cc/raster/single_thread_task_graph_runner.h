...
class CC_EXPORT SingleThreadTaskGraphRunner : public TaskGraphRunner, public base::DelegateSimpleThread::Delegate {
public:
    ...
    void Start(const std::string& thread_name, const base::SimpleThread::Options& thread_options);
    void Shutdown();
