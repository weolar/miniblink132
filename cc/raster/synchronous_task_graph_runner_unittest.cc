...
public:
    ...
    {
        synchronous_task_graph_runner_.RunUntilIdle();
    }
...
INSTANTIATE_TYPED_TEST_SUITE_P(SynchronousTaskGraphRunner, TaskGraphRunnerTest, SynchronousTaskGraphRunnerTestDelegate);
INSTANTIATE_TYPED_TEST_SUITE_P(SynchronousTaskGraphRunner, SingleThreadTaskGraphRunnerTest, SynchronousTaskGraphRunnerTestDelegate);
