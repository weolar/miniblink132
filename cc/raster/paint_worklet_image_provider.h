...
public:
    ...
    PaintWorkletImageProvider& operator=(const PaintWorkletImageProvider&) = delete;
    PaintWorkletImageProvider& operator=(PaintWorkletImageProvider&& other);

    ImageProvider::ScopedResult GetPaintRecordResult(scoped_refptr<PaintWorkletInput> input);
