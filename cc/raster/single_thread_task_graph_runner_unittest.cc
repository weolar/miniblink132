...
public:
    ...
    {
        single_thread_task_graph_runner_.Start("SingleThreadTaskGraphRunnerTestDelegate", base::SimpleThread::Options());
    }
...
INSTANTIATE_TYPED_TEST_SUITE_P(SingleThreadTaskGraphRunner, TaskGraphRunnerTest, SingleThreadTaskGraphRunnerTestDelegate);
INSTANTIATE_TYPED_TEST_SUITE_P(SingleThreadTaskGraphRunner, SingleThreadTaskGraphRunnerTest, SingleThreadTaskGraphRunnerTestDelegate);
