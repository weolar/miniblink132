...
public:
    ...
    void PlaybackToCanvas(SkCanvas* canvas, const gfx::Size& content_size, const gfx::Rect& canvas_bitmap_rect, const gfx::Rect& canvas_playback_rect,
        const gfx::AxisTransform2d& raster_transform, const PlaybackSettings& settings) const;
    ...
    // details.
    bool PerformSolidColorAnalysis(gfx::Rect content_rect, SkColor4f* color, int max_ops_to_analyze = 1) const;
    ...
    gfx::Rect recorded_bounds() const
    {
        ...
        return directly_composited_image_info_ ? gfx::Rect(size_) : recorded_bounds_;
    }
    ...
    {
        return &max_op_size_hint_;
    }

    const std::optional<DirectlyCompositedImageInfo>& directly_composited_image_info() const
    {
...
protected:
    ...
    void ClearForOpaqueRaster(SkCanvas* raster_canvas, const gfx::AxisTransform2d& raster_transform, const gfx::Size& content_size,
    ...
    //
    // Virtual for testing.
    virtual void PlaybackDisplayListToCanvas(SkCanvas* canvas, const PlaybackSettings& settings) const;
    ...
    size_t max_op_size_hint_ = gpu::raster::RasterInterface::kDefaultMaxOpSizeHint;
