...
public:
    ...
    const TileTask::Vector& dependencies() const
    {
    ...
    {
        return supports_background_thread_priority_ == SupportsBackgroundThreadPriority::kYes;
    }
...
protected:
    ...
    TileTask(SupportsConcurrentExecution supports_concurrent_execution, SupportsBackgroundThreadPriority supports_background_thread_priority,
