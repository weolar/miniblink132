...
void FakeLayerTreeHostImplClient::SetNeedsImplSideInvalidation(bool needs_first_draw_on_activation)
{
...
size_t FakeLayerTreeHostImplClient::CommitDurationSampleCountForTesting() const
{
    return 0;
}
