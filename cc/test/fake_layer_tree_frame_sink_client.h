...
public:
    ...
    void SetExternalTilePriorityConstraints(const gfx::Rect& viewport_rect_for_tile_priority, const gfx::Transform& transform_for_tile_priority) override
    {
    }
    ...
    const ManagedMemoryPolicy& memory_policy() const
    {
    ...
    void set_hit_test_region_list(const std::optional<viz::HitTestRegionList>& hit_test_region_list)
    {
