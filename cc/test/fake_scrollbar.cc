...
gfx::Rect FakeScrollbar::ShrinkMainThreadedMinimalModeThumbRect(gfx::Rect& rect) const
{
    return rect;
}
...
void FakeScrollbar::PaintTrackAndButtons(PaintCanvas& canvas, const gfx::Rect& rect)
{
    Paint(canvas, rect);
}
...
{
    return uses_nine_patch_track_and_buttons_resource_ ? gfx::Size(5, 5) : gfx::Size();
}

gfx::Rect FakeScrollbar::NinePatchTrackAndButtonsAperture() const
{
    return uses_nine_patch_track_and_buttons_resource_ ? gfx::Rect(0, 0, 5, 5) : gfx::Rect();
}
