...
public:
    FakeImplTaskRunnerProvider()
        : TaskRunnerProvider(base::SingleThreadTaskRunner::GetCurrentDefault(), nullptr)
        , set_impl_thread_(this)
    {
    }

    explicit FakeImplTaskRunnerProvider(scoped_refptr<base::SingleThreadTaskRunner> impl_task_runner)
        : TaskRunnerProvider(base::SingleThreadTaskRunner::GetCurrentDefault(), impl_task_runner)
        , set_impl_thread_(this)
    {
    }
