...
public:
    ...
    explicit FakePictureLayerTilingClient(viz::ClientResourceProvider* resource_provider, viz::RasterContextProvider* context_provider);
    ...
    void set_text_rect(const gfx::Rect& rect)
    {
        text_rect_ = rect;
    }
