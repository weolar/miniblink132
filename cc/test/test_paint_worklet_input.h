...
public:
    ...
    explicit TestPaintWorkletInput(const PaintWorkletInput::PropertyKey& key, const gfx::SizeF& size);

    gfx::SizeF GetSize() const override;
    int WorkletId() const override;
    const std::vector<PaintWorkletInput::PropertyKey>& GetPropertyKeys() const override;
