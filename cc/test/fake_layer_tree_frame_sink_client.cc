...
void FakeLayerTreeFrameSinkClient::SetBeginFrameSource(viz::BeginFrameSource* source)
{
    begin_frame_source_ = source;
}

std::optional<viz::HitTestRegionList> FakeLayerTreeFrameSinkClient::BuildHitTestData()
{
...
void FakeLayerTreeFrameSinkClient::SetMemoryPolicy(const ManagedMemoryPolicy& policy)
{
