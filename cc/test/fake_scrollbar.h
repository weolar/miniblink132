...
public:
    ...
    void PaintTrackAndButtons(PaintCanvas& canvas, const gfx::Rect& rect) override;
    ...
    gfx::Rect ShrinkMainThreadedMinimalModeThumbRect(gfx::Rect& rect) const override;
    bool IsOpaque() const override;

    void set_should_paint(bool b)
    {
        should_paint_ = b;
    }
    void set_has_thumb(bool b)
    {
        has_thumb_ = b;
    }
    void set_has_tickmarks(bool b)
    {
        has_tickmarks_ = b;
    }
    void set_orientation(ScrollbarOrientation o)
    {
        orientation_ = o;
    }
    ...
    void set_is_solid_color(bool b)
    {
        is_solid_color_ = b;
    }
    void set_is_overlay(bool b)
    {
        is_overlay_ = b;
    }
    ...
    void set_uses_solid_color_thumb(bool b)
    {
        uses_solid_color_thumb_ = b;
    }
    void set_uses_nine_patch_track_and_buttons_resource(bool b)
    {
        uses_nine_patch_track_and_buttons_resource_ = b;
    }
    void set_track_rect(const gfx::Rect& track_rect)
    {
        track_rect_ = track_rect;
    }
    void set_thumb_size(const gfx::Size& thumb_size)
    {
        thumb_size_ = thumb_size;
    }
    SkColor paint_fill_color() const
    {
        return SK_ColorBLACK | fill_color_;
    }

    void set_thumb_opacity(float opacity)
    {
        thumb_opacity_ = opacity;
    }
    ...
    void set_is_opaque(bool b)
    {
        is_opaque_ = b;
    }
    void set_thumb_color(SkColor4f color)
    {
        thumb_color_ = color;
    }
