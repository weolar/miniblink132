...
bool FakeProxy::StartDeferringCommits(base::TimeDelta timeout, PaintHoldingReason reason)
{
    return false;
}
...
void FakeProxy::SetPaintWorkletLayerPainter(std::unique_ptr<PaintWorkletLayerPainter> painter)
{
}
