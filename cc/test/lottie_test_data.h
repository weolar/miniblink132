...
constexpr base::FilePath::CharType kLottieDataWith2TextFileName[] = FILE_PATH_LITERAL("animation_with_2_text_nodes.json");
...
constexpr gfx::RectF kLottieDataWith2TextNode1Box = gfx::RectF(10, 20, 100, 200);
constexpr gfx::RectF kLottieDataWith2TextNode2Box = gfx::RectF(20, 40, 200, 400);
