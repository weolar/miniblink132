...
public:
    ...
    MOCK_METHOD5(onDrawArc, void(const SkRect&, SkScalar, SkScalar, bool, const SkPaint&));
    ...
    MOCK_METHOD2(onDrawGlyphRunList, void(const sktext::GlyphRunList&, const SkPaint&));
