...
scoped_refptr<DisplayItemList> SolidColorContentLayerClient::PaintContentsToDisplayList()
{
    ...
    display_list->push<DrawRectOp>(clip.makeInset(border_size_, border_size_), flags);
