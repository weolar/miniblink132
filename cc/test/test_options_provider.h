...
class TestOptionsProvider : public ImageProvider, public TransferCacheTestHelper {
    STACK_ALLOCATED();
...
public:
    ...
    ClientPaintCache* client_paint_cache()
    {
        return &client_paint_cache_;
    }
    ServicePaintCache* service_paint_cache()
    {
        return &service_paint_cache_;
    }

    SkStrikeServer* strike_server()
    {
        return &strike_server_;
    }
    SkStrikeClient* strike_client()
    {
        return &strike_client_;
    }
