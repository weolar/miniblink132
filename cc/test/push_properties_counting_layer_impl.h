...
public:
    static std::unique_ptr<PushPropertiesCountingLayerImpl> Create(LayerTreeImpl* tree_impl, int id);
    PushPropertiesCountingLayerImpl(const PushPropertiesCountingLayerImpl&) = delete;
    ~PushPropertiesCountingLayerImpl() override;

    PushPropertiesCountingLayerImpl& operator=(const PushPropertiesCountingLayerImpl&) = delete;
