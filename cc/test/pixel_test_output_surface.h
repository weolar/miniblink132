...
public:
    explicit PixelTestOutputSurface(std::unique_ptr<viz::SoftwareOutputDevice> software_device);
    ...
    void ReadbackForTesting(base::OnceCallback<void(std::unique_ptr<viz::CopyOutputResult>)> callback) override;
