...
std::unique_ptr<FakeScopedUIResource> FakeScopedUIResource::Create(UIResourceManager* ui_resource_manager)
{
    return base::WrapUnique(new FakeScopedUIResource(ui_resource_manager));
}

FakeScopedUIResource::FakeScopedUIResource(UIResourceManager* ui_resource_manager)
...
UIResourceBitmap FakeScopedUIResource::GetBitmap(UIResourceId uid, bool resource_lost)
{
