...
template <typename BaseLayer> class FakeScrollbarLayer : public BaseLayer {
public:
    ...
    size_t push_properties_count() const
    {
        return push_properties_count_;
    }
    ...
    {
        return fake_scrollbar_.get();
    }

protected:
    FakeScrollbarLayer(ElementId scrolling_element_id, scoped_refptr<FakeScrollbar> fake_scrollbar)
...
class FakePaintedScrollbarLayer : public FakeScrollbarLayer<PaintedScrollbarLayer> {
public:
    explicit FakePaintedScrollbarLayer(ElementId scrolling_element_id, scoped_refptr<FakeScrollbar> fake_scrollbar = CreateScrollbar())
...
class FakeNinePatchThumbScrollbarLayer : public FakeScrollbarLayer<NinePatchThumbScrollbarLayer> {
public:
    explicit FakeNinePatchThumbScrollbarLayer(ElementId scrolling_element_id, scoped_refptr<FakeScrollbar> fake_scrollbar = CreateScrollbar())
        : FakeScrollbarLayer(scrolling_element_id, std::move(fake_scrollbar))
    {
    }
