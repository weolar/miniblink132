...
public:
    ...
    virtual bool Compare(const SkBitmap& actual_bmp, const SkBitmap& expected_bmp) const = 0;
};
...
public:
    ...
    bool Compare(const SkBitmap& actual_bmp, const SkBitmap& expected_bmp) const override;
...
public:
    AlphaDiscardingExactPixelComparator()
    {
        discard_alpha_ = true;
    }
};
...
public:
    ...
    FuzzyPixelComparator& SetErrorPixelsPercentageLimit(float large_error_pixels_percentage_limit, float small_error_pixels_percentage_limit = 0)
    {
    ...
    FuzzyPixelComparator& SetAbsErrorLimit(int max_abs_error_limit, int small_abs_error_limit = 0)
    {
...
class AlphaDiscardingFuzzyPixelOffByOneComparator : public FuzzyPixelOffByOneComparator {
public:
    AlphaDiscardingFuzzyPixelOffByOneComparator()
    {
        DiscardAlpha();
    }
};
