...
// static
bool ImageDecodeCacheUtils::ShouldEvictCaches(base::MemoryPressureListener::MemoryPressureLevel memory_pressure_level)
{
...
// static
size_t ImageDecodeCacheUtils::GetWorkingSetBytesForImageDecode(bool for_renderer)
{
    ...
    if (for_renderer) {
        ...
        } else if (base::SysInfo::AmountOfPhysicalMemoryMB() >= kImageDecodeMemoryThresholdMB) {
