...
public:
    ...
    CheckerImageTracker(ImageController* image_controller, CheckerImageTrackerClient* client, bool enable_checker_imaging, size_t min_image_bytes_to_checker);
    ...
    PaintImage::DecodingMode get_decoding_mode_hint_for_testing(PaintImage::Id id)
    {
...
private:
    ...
    public:
        ScopedDecodeHolder(ImageController* controller, ImageController::ImageDecodeRequestId request_id)
        ...
        ~ScopedDecodeHolder()
        {
            controller_->UnlockImageDecode(request_id_);
        }
    ...
    void DidFinishImageDecode(PaintImage::Id image_id, ImageController::ImageDecodeRequestId request_id, ImageController::ImageDecodeResult result);
    ...
    void UpdateDecodeState(const DrawImage& draw_image, PaintImage::Id paint_image_id, DecodeState* decode_state);
    ...
    std::unordered_map<PaintImage::Id, std::unique_ptr<ScopedDecodeHolder>> image_id_to_decode_;
