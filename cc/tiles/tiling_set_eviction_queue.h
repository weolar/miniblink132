...
public:
    explicit TilingSetEvictionQueue(PictureLayerTilingSet* tiling_set, bool is_drawing_layer);
...
private:
    ...
    protected:
        ...
        template <typename TilingIteratorType> bool AdvanceToNextTile(TilingIteratorType* iterator);
    ...
    public:
        ...
        PendingVisibleTilingIterator(std::vector<PictureLayerTiling*>* tilings, WhichTree tree, bool return_required_for_activation_tiles);
    ...
    public:
        ...
        VisibleTilingIterator(std::vector<PictureLayerTiling*>* tilings, WhichTree tree, bool return_occluded_tiles, bool return_required_for_activation_tiles);
    ...
    public:
        ...
        SkewportTilingIterator(std::vector<PictureLayerTiling*>* tilings, WhichTree tree);
    ...
    public:
        ...
        SoonBorderTilingIterator(std::vector<PictureLayerTiling*>* tilings, WhichTree tree);
    ...
    public:
        ...
        EventuallyTilingIterator(std::vector<PictureLayerTiling*>* tilings, WhichTree tree);
