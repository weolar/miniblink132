...
struct CC_EXPORT TilePriority {
    ...
    constexpr TilePriority(TileResolution resolution, PriorityBin bin, float distance_to_visible)
...
public:
    ...
    {
        return memory_limit_policy == other.memory_limit_policy && soft_memory_limit_in_bytes == other.soft_memory_limit_in_bytes
