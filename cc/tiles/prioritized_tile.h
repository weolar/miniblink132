...
public:
    ...
    PrioritizedTile();
    PrioritizedTile(Tile* tile, const PictureLayerTiling* source_tiling, const TilePriority& priority, bool is_occluded, bool is_process_for_images_only,
    ...
    const PictureLayerTiling* source_tiling() const
    {
        return source_tiling_;
    }
