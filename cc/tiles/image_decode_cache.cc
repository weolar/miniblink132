...
ImageDecodeCache::TaskResult::TaskResult(bool need_unref, bool is_at_raster_decode, bool can_do_hardware_accelerated_decode)
...
ImageDecodeCache::TaskResult::TaskResult(scoped_refptr<TileTask> task, bool can_do_hardware_accelerated_decode)
    : task(std::move(task))
    , need_unref(true)
