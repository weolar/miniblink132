...
public:
    TilesWithResourceIterator(const std::vector<raw_ptr<PictureLayerImpl, VectorExperimental>>* picture_layers,
    ...
    TilesWithResourceIterator& operator=(const TilesWithResourceIterator&) = delete;
...
private:
    ...
    const raw_ptr<const std::vector<raw_ptr<PictureLayerImpl, VectorExperimental>>> picture_layers_;

    // The secondary set of layers to iterate through, may be null.
    const raw_ptr<const std::vector<raw_ptr<PictureLayerImpl, VectorExperimental>>> secondary_picture_layers_;
    ...
    raw_ptr<const std::vector<raw_ptr<PictureLayerImpl, VectorExperimental>>> active_layers_;
