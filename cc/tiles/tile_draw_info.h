...
public:
    ...
    bool is_resource_ready_to_draw() const
    {
        return is_resource_ready_to_draw_;
    }
    ...
    void SetSolidColorForTesting(SkColor4f color)
    {
...
private:
    ...
    void SetResource(ResourcePool::InUsePoolResource resource, bool resource_is_checker_imaged, bool is_premultiplied);
