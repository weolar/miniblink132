...
public:
    ...
    RasterTilePriorityQueueAll& operator=(const RasterTilePriorityQueueAll&) = delete;
...
private:
    ...
    const std::vector<std::unique_ptr<TilingSetRasterQueueAll>>& GetNextQueues() const;
