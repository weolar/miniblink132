...
{
    return CreateDiscardablePaintImage(gfx::Size(width, height), DefaultSkColorSpace());
}

PaintImage CreatePaintImage(int width, int height, const TargetColorParams& target_color_params)
{
    return CreateDiscardablePaintImage(gfx::Size(width, height), target_color_params.color_space.ToSkColorSpace());
}
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyNoneQuality)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kNone,
        CreateMatrix(SkSize::Make(0.5f, 1.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());

    auto key = SoftwareImageDecodeCache::CacheKey::FromDrawImage(draw_image, kN32_SkColorType);
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyLowQualityIncreasedToMediumIfDownscale)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kLow,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityDropsToLowIfMipLevel0)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kMedium,
        CreateMatrix(SkSize::Make(0.75f, 0.75f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, LowUnscalableFormatStaysLow)
{
    ...
    auto key = SoftwareImageDecodeCache::CacheKey::FromDrawImage(draw_image, kARGB_4444_SkColorType);
    EXPECT_EQ(draw_image.frame_key(), key.frame_key());
    EXPECT_FALSE(key.is_nearest_neighbor());
    EXPECT_EQ(100, key.target_size().width());
    EXPECT_EQ(100, key.target_size().height());
...
TEST_F(SoftwareImageDecodeCacheTest, HighUnscalableFormatBecomesLow)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kHigh,
        CreateMatrix(SkSize::Make(1.5f, 1.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQuality)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.4f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityDropToLowIfEnlarging)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kMedium;
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityDropToLowIfIdentity)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.f, 1.f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityDropToLowIfNearlyIdentity)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kMedium;
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.001f, 1.001f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityDropToLowIfNearlyIdentity2)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kMedium;
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.999f, 0.999f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityDropToLowIfNotDecomposable)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityAt0_49Scale)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.49f, 0.49f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityAt0_1Scale)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.1f, 0.1f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyMediumQualityAt0_01Scale)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.01f, 0.01f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyFullDowscalesDropsHighQualityToMedium)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.2f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyUpscaleIsLowQuality)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(2.5f, 1.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyHighQualityDropToMediumIfTooLarge)
{
    ...
    // become low.
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.45f, 0.45f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyHighQualityDropToLowIfNotDecomposable)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = false;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyHighQualityDropToLowIfNearlyIdentity)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyHighQualityDropToLowIfNearlyIdentity2)
{
    PaintImage paint_image = CreatePaintImage(100, 100);
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
...
TEST_F(SoftwareImageDecodeCacheTest, ImageKeyDownscaleMipLevelWithRounding)
{
    ...
    bool is_decomposable = true;
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kMedium,
        CreateMatrix(SkSize::Make(0.2f, 0.2f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, OriginalDecodesAreEqual)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.5), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ...
    DrawImage another_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.5f, 1.5), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());

    auto another_key = SoftwareImageDecodeCache::CacheKey::FromDrawImage(another_draw_image, kN32_SkColorType);
...
TEST_F(SoftwareImageDecodeCacheTest, ImageRectDoesNotContainSrcRect)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeXYWH(25, 35, paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.f, 1.f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, ImageRectDoesNotContainSrcRectWithScale)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeXYWH(20, 30, paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageSameImage)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult result = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(result.need_unref);
    EXPECT_TRUE(result.task);

    DrawImage another_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult another_result = cache_.GetTaskForImageAndRef(cache_client_id_, another_draw_image, ImageDecodeCache::TracingInfo());
...
TEST_F(SoftwareImageDecodeCacheTest, GetRasterTaskBeforeStandAloneTaskSameImage)
{
    ...
    PaintImage paint_image = CreatePaintImage(100, 100);
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kHigh,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), true), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());

    ImageDecodeCache::TaskResult raster_result = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(raster_result.need_unref);
    EXPECT_TRUE(raster_result.task);
    TileTask* raster_decode_task = raster_result.task.get();

    ImageDecodeCache::TaskResult stand_alone_result = cache_.GetOutOfRasterDecodeTaskForImageAndRef(cache_client_id_, draw_image);
...
TEST_F(SoftwareImageDecodeCacheTest, GetStandAloneTaskBeforeRasterTaskSameImage)
{
    if (!base::FeatureList::IsEnabled(features::kPreventDuplicateImageDecodes)) {
        return;
    }
...
TEST_F(SoftwareImageDecodeCacheTest, StandAloneTaskStartedBeforeRasterTaskSameImage)
{
    if (!base::FeatureList::IsEnabled(features::kPreventDuplicateImageDecodes)) {
        return;
    }
...
TEST_F(SoftwareImageDecodeCacheTest, ExternalDependentRasterTaskCanceled)
{
    ...
    raster_result = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(raster_result.need_unref);
    EXPECT_TRUE(raster_result.task);
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageProcessUnrefCancel)
{
    ...
    result = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(result.need_unref);
    EXPECT_TRUE(result.task);
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageSameImageDifferentQuality)
{
    ...
    DrawImage high_quality_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kHigh,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult high_quality_result = cache_.GetTaskForImageAndRef(cache_client_id_, high_quality_draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(high_quality_result.need_unref);
    EXPECT_TRUE(high_quality_result.task);

    DrawImage none_quality_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), PaintFlags::FilterQuality::kNone,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult none_quality_result = cache_.GetTaskForImageAndRef(cache_client_id_, none_quality_draw_image, ImageDecodeCache::TracingInfo());
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageSameImageDifferentSize)
{
    ...
    DrawImage half_size_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult half_size_result = cache_.GetTaskForImageAndRef(cache_client_id_, half_size_draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(half_size_result.need_unref);
    EXPECT_TRUE(half_size_result.task);

    DrawImage quarter_size_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.25f, 0.25f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult quarter_size_result = cache_.GetTaskForImageAndRef(cache_client_id_, quarter_size_draw_image, ImageDecodeCache::TracingInfo());
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageDifferentImage)
{
    ...
    DrawImage first_draw_image(first_paint_image, false, SkIRect::MakeWH(first_paint_image.width(), first_paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult first_result = cache_.GetTaskForImageAndRef(cache_client_id_, first_draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(first_result.need_unref);
    EXPECT_TRUE(first_result.task);

    PaintImage second_paint_image = CreatePaintImage(100, 100);
    DrawImage second_draw_image(second_paint_image, false, SkIRect::MakeWH(second_paint_image.width(), second_paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.25f, 0.25f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ImageDecodeCache::TaskResult second_result = cache_.GetTaskForImageAndRef(cache_client_id_, second_draw_image, ImageDecodeCache::TracingInfo());
...
#define MAYBE_GetTaskForImageDifferentColorSpace DISABLED_GetTaskForImageDifferentColorSpace
#else
#define MAYBE_GetTaskForImageDifferentColorSpace GetTaskForImageDifferentColorSpace
#endif
TEST_F(SoftwareImageDecodeCacheTest, MAYBE_GetTaskForImageDifferentColorSpace)
{
    ...
    TargetColorParams target_color_params_a(gfx::ColorSpace(gfx::ColorSpace::PrimaryID::XYZ_D50, gfx::ColorSpace::TransferID::SRGB));

    TargetColorParams target_color_params_b(gfx::ColorSpace(gfx::ColorSpace::PrimaryID::SMPTE170M, gfx::ColorSpace::TransferID::SRGB));
    ...
    DrawImage first_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.0f, 1.0f), is_decomposable), PaintImage::kDefaultFrameIndex, target_color_params_b);
    ImageDecodeCache::TaskResult first_result = cache_.GetTaskForImageAndRef(cache_client_id_, first_draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(first_result.need_unref);
    EXPECT_TRUE(first_result.task);

    DrawImage second_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.0f, 1.0f), is_decomposable), PaintImage::kDefaultFrameIndex, target_color_params_c);
    ImageDecodeCache::TaskResult second_result = cache_.GetTaskForImageAndRef(cache_client_id_, second_draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(second_result.need_unref);
    EXPECT_TRUE(second_result.task);
    EXPECT_TRUE(first_result.task.get() != second_result.task.get());

    DrawImage third_draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.0f, 1.0f), is_decomposable), PaintImage::kDefaultFrameIndex, target_color_params_b);
    ImageDecodeCache::TaskResult third_result = cache_.GetTaskForImageAndRef(cache_client_id_, third_draw_image, ImageDecodeCache::TracingInfo());
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageAlreadyDecoded)
{
    ...
    ImageDecodeCache::TaskResult another_result = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(another_result.need_unref);
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageAlreadyPrerolled)
{
    ...
    ImageDecodeCache::TaskResult third_result = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(third_result.need_unref);
...
TEST_F(SoftwareImageDecodeCacheTest, GetTaskForImageCanceledWhileReffedGetsNewTask)
{
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
...
TEST_F(SoftwareImageDecodeCacheTest, GetDecodedImageForDraw)
{
    ...
    DecodedDrawImage decoded_draw_image = cache_.GetDecodedImageForDraw(draw_image);
    ...
    EXPECT_EQ(PaintFlags::FilterQuality::kLow, decoded_draw_image.filter_quality());
...
TEST_F(SoftwareImageDecodeCacheTest, GetDecodedImageForDrawWithNonContainedSrcRect)
{
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
...
TEST_F(SoftwareImageDecodeCacheTest, GetDecodedImageForDrawAtRasterDecodeMultipleTimes)
{
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
    ...
    DecodedDrawImage another_decoded_draw_image = cache_.GetDecodedImageForDraw(draw_image);
...
TEST_F(SoftwareImageDecodeCacheTest, ZeroSizedImagesAreSkipped)
{
    ...
    PaintImage paint_image = CreatePaintImage(100, 100);
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.f, 0.f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, NonOverlappingSrcRectImagesAreSkipped)
{
    ...
    PaintImage paint_image = CreatePaintImage(100, 100);
    DrawImage draw_image(paint_image, false, SkIRect::MakeXYWH(150, 150, paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.f, 1.f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, LowQualityScaledSubrectIsHandled)
{
    ...
    PaintImage paint_image = CreatePaintImage(100, 100);
    DrawImage draw_image(paint_image, false, SkIRect::MakeXYWH(10, 10, 80, 80), quality, CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable),
...
TEST_F(SoftwareImageDecodeCacheTest, NoneQualityScaledSubrectIsHandled)
{
    ...
    // SkImage object.
    EXPECT_FALSE(decoded_draw_image.image()->isLazyGenerated());
    EXPECT_EQ(PaintFlags::FilterQuality::kNone, decoded_draw_image.filter_quality());
...
TEST_F(SoftwareImageDecodeCacheTest, MediumQualityAt0_001ScaleIsHandled)
{
    ...
    PaintImage paint_image = CreatePaintImage(500, 200);
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.001f, 0.001f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, MediumQualityImagesAreTheSameAt0_5And0_49Scale)
{
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kMedium;

    PaintImage paint_image = CreatePaintImage(500, 200);
    DrawImage draw_image_50(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5f, 0.5f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    DrawImage draw_image_49(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.49f, 0.49f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());

    ImageDecodeCache::TaskResult result_50 = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image_50, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(result_50.task);
    EXPECT_TRUE(result_50.need_unref);
    ImageDecodeCache::TaskResult result_49 = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image_49, ImageDecodeCache::TracingInfo());
    EXPECT_TRUE(result_49.task);
    EXPECT_TRUE(result_49.need_unref);

    TestTileTaskRunner::ProcessTask(result_49.task.get());

    DecodedDrawImage decoded_draw_image_50 = cache_.GetDecodedImageForDraw(draw_image_50);
    EXPECT_TRUE(decoded_draw_image_50.image());
    DecodedDrawImage decoded_draw_image_49 = cache_.GetDecodedImageForDraw(draw_image_49);
    ...
    EXPECT_EQ(PaintFlags::FilterQuality::kLow, decoded_draw_image_50.filter_quality());
    EXPECT_EQ(PaintFlags::FilterQuality::kLow, decoded_draw_image_49.filter_quality());
...
TEST_F(SoftwareImageDecodeCacheTest, ClearCache)
{
    ...
    for (int i = 0; i < 10; ++i) {
        PaintImage paint_image = CreatePaintImage(100, 100);
        DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
            CreateMatrix(SkSize::Make(1.0f, 1.0f), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
        ImageDecodeCache::TaskResult result = cache_.GetTaskForImageAndRef(cache_client_id_, draw_image, ImageDecodeCache::TracingInfo());
        EXPECT_TRUE(result.need_unref);
        EXPECT_TRUE(result.task);
        TestTileTaskRunner::ProcessTask(result.task.get());
...
TEST_F(SoftwareImageDecodeCacheTest, CacheDecodesExpectedFrames)
{
    ...
    sk_sp<FakePaintImageGenerator> generator = sk_make_sp<FakePaintImageGenerator>(SkImageInfo::MakeN32Premul(10, 10, SkColorSpace::MakeSRGB()), frames);
    ...
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
    DrawImage draw_image(image, false, SkIRect::MakeWH(image.width(), image.height()), quality, CreateMatrix(SkSize::Make(1.0f, 1.0f), is_decomposable), 1u,
    ...
    // Scaled.
    DrawImage scaled_draw_image(draw_image, 0.5f, 2u, draw_image.target_color_params());
    ...
    DrawImage subset_draw_image(
        image, false, SkIRect::MakeWH(5, 5), quality, CreateMatrix(SkSize::Make(1.0f, 1.0f), is_decomposable), 3u, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, SizeSubrectingIsHandled)
{
    ...
    auto paint_image = CreateDiscardablePaintImage(gfx::Size(min_dimension, min_dimension), DefaultSkColorSpace(), false);
    DrawImage draw_image(paint_image, false, SkIRect::MakeXYWH(0, 0, 10, 10), quality, CreateMatrix(SkSize::Make(1.f, 1.f), is_decomposable),
        PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, EmptyTargetSizeDecode)
{
    ...
    auto paint_image = CreateDiscardablePaintImage(gfx::Size(100, 100), DefaultSkColorSpace());
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(100, 100), quality, CreateMatrix(SkSize::Make(1.f, 1.f), is_decomposable),
        PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    DecodedDrawImage decoded_draw_image = cache_.GetDecodedImageForDraw(draw_image);
    EXPECT_TRUE(decoded_draw_image.image());
    cache_.DrawWithImageFinished(draw_image, decoded_draw_image);
    ...
    DrawImage empty_draw_image(paint_image, false, SkIRect::MakeEmpty(), quality, CreateMatrix(SkSize::Make(1.f, 1.f), is_decomposable),
        PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    DecodedDrawImage empty_decoded_draw_image = cache_.GetDecodedImageForDraw(empty_draw_image);
...
TEST_F(SoftwareImageDecodeCacheTest, BitmapImageColorConverted)
{
    bool is_decomposable = true;
    PaintFlags::FilterQuality quality = PaintFlags::FilterQuality::kHigh;
    const TargetColorParams target_color_params(gfx::ColorSpace::CreateDisplayP3D65());

    PaintImage paint_image = CreateBitmapImage(gfx::Size(100, 100));
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(1.f, 1.f), is_decomposable), PaintImage::kDefaultFrameIndex, target_color_params);
    ...
    EXPECT_TRUE(SkColorSpace::Equals(decoded_draw_image.image()->colorSpace(), target_color_params.color_space.ToSkColorSpace().get()));
...
TEST_F(SoftwareImageDecodeCacheTest, DISABLED_ContentIdCaching)
{
    ...
    for (int i = 0; i < 10; ++i) {
        ...
        PaintImage paint_image = CreateDiscardablePaintImage(gfx::Size(100, 100), nullptr, true, stable_id);

        // Cache two entries of different scales.
        for (int j = 0; j < 2; ++j) {
            float scale = j == 0 ? 1.f : 0.5f;
            DrawImage draw_image(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
                CreateMatrix(SkSize::Make(scale, scale), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
            DecodedDrawImage decoded_draw_image = cache_.GetDecodedImageForDraw(draw_image);
            EXPECT_TRUE(decoded_draw_image.image());
            cache_.DrawWithImageFinished(draw_image, decoded_draw_image);
        }
...
TEST_F(SoftwareImageDecodeCacheTest, DecodeToScale)
{
    ...
    sk_sp<FakePaintImageGenerator> generator = sk_make_sp<FakePaintImageGenerator>(
        SkImageInfo::MakeN32Premul(full_size.width(), full_size.height(), DefaultSkColorSpace()), frames, true, supported_sizes);
    ...
    // the direct decode.
    DrawImage draw_image1(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.5, 0.5), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
    ...
    // re-decoding.
    DrawImage draw_image2(paint_image, false, SkIRect::MakeWH(paint_image.width(), paint_image.height()), quality,
        CreateMatrix(SkSize::Make(0.25, 0.25), is_decomposable), PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, DecodeToScaleSubrect)
{
    ...
    DrawImage draw_image(paint_image, false, SkIRect::MakeWH(50, 50), quality, CreateMatrix(SkSize::Make(0.5, 0.5), is_decomposable),
        PaintImage::kDefaultFrameIndex, DefaultTargetColorParams());
...
TEST_F(SoftwareImageDecodeCacheTest, HdrDecodeToHdr)
{
    ...
    auto info = SkImageInfo::Make(size.width(), size.height(), kRGBA_F16_SkColorType, kPremul_SkAlphaType, target_color_params.color_space.ToSkColorSpace());
    SkBitmap bitmap;
    ...
    DrawImage draw_image(image, false, SkIRect::MakeWH(image.width(), image.height()), PaintFlags::FilterQuality::kMedium,
        CreateMatrix(SkSize::Make(0.5, 0.5), true), PaintImage::kDefaultFrameIndex, target_color_params);
...
TEST_F(SoftwareImageDecodeCacheTest, HdrDecodeToSdr)
{
    ...
    DrawImage draw_image(image, false, SkIRect::MakeWH(image.width(), image.height()), PaintFlags::FilterQuality::kMedium,
        CreateMatrix(SkSize::Make(0.5, 0.5), true), PaintImage::kDefaultFrameIndex, TargetColorParams(raster_color_space));
...
TEST_F(SoftwareImageDecodeCacheTest, ReduceCacheOnUnrefWithTasks)
{
    ...
    EXPECT_EQ(cache_.GetNumCacheEntriesForTesting(), cache_.GetMaxNumCacheEntriesForTesting());
}
