...
public:
    ...
    static int GetLevelForSize(const gfx::Size& src_size, const gfx::Size& target_size);
    ...
    static SkSize GetScaleAdjustmentForLevel(const gfx::Size& src_size, int mip_level);
    ...
    static SkSize GetScaleAdjustmentForSize(const gfx::Size& src_size, const gfx::Size& target_size);
};
