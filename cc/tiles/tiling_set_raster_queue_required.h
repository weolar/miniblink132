...
public:
    static std::unique_ptr<TilingSetRasterQueueRequired> Create(PictureLayerTilingSet* tiling_set, RasterTilePriorityQueue::Type type);
...
private:
    ...
    public:
        TilingIterator();
        explicit TilingIterator(PictureLayerTiling* tiling, TilingData* tiling_data, const gfx::Rect& rect);
        ~TilingIterator();
    ...
    TilingSetRasterQueueRequired();
    TilingSetRasterQueueRequired(PictureLayerTiling* tiling, RasterTilePriorityQueue::Type type);
