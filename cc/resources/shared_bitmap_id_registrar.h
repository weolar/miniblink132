...
public:
    ...
    virtual SharedBitmapIdRegistration RegisterSharedBitmapId(const viz::SharedBitmapId& id, scoped_refptr<CrossThreadSharedBitmap> bitmap) = 0;
};
...
public:
    ...
    SharedBitmapIdRegistration& operator=(const SharedBitmapIdRegistration&) = delete;
...
private:
    ...
    // as they wish to
    friend TextureLayer;
    SharedBitmapIdRegistration(base::WeakPtr<TextureLayer> layer_ptr, const viz::SharedBitmapId& id);
