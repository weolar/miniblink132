...
std::unique_ptr<ScopedUIResource> ScopedUIResource::Create(UIResourceManager* ui_resource_manager, const UIResourceBitmap& bitmap)
{
    return base::WrapUnique(new ScopedUIResource(ui_resource_manager, bitmap));
}

ScopedUIResource::ScopedUIResource(UIResourceManager* ui_resource_manager, const UIResourceBitmap& bitmap)
    : bitmap_(bitmap)
...
UIResourceBitmap ScopedUIResource::GetBitmap(UIResourceId uid, bool resource_lost)
{
    return bitmap_;
}
