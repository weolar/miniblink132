...
private:
    ...
    std::unordered_map<UIResourceId, UIResourceClientData> ui_resource_client_map_;
    ...
    // are dropped.
    std::unordered_map<SkPixelRef*, std::unique_ptr<ScopedUIResource>> owned_shared_resources_;
};
