...
struct PendingPageScaleAnimation {
    PendingPageScaleAnimation(const gfx::Point& target_offset, bool use_anchor, float scale, const base::TimeDelta& duration)
...
public:
    ...
    void ZoomTo(const gfx::PointF& target_scroll_offset, float target_page_scale_factor, double duration);
    ...
    void ZoomWithAnchor(const gfx::PointF& anchor, float target_page_scale_factor, double duration);
    ...
    gfx::PointF target_scroll_offset() const
    {
        return target_scroll_offset_;
    }
    float target_page_scale_factor() const
    {
