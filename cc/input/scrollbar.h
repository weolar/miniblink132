...
static constexpr base::TimeDelta kInitialAutoscrollTimerDelay = base::Milliseconds(250);
...
public:
    ...
    virtual void PaintTrackAndButtons(PaintCanvas& canvas, const gfx::Rect& rect) = 0;
    ...
    virtual gfx::Rect ShrinkMainThreadedMinimalModeThumbRect(gfx::Rect& rect) const = 0;
