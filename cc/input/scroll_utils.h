...
public:
    ...
    static gfx::Vector2dF ResolveScrollPercentageToPixels(const gfx::Vector2dF& scroll_delta, const gfx::SizeF& scroller_size, const gfx::SizeF& viewport_size);
    ...
    static gfx::Vector2dF ResolvePixelScrollToPercentageForTesting(
        const gfx::Vector2dF& pixel_scroll_delta, const gfx::SizeF& scroller_size, const gfx::SizeF& viewport_size);
};
