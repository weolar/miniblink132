...
class MockScrollbarAnimationControllerClient : public ScrollbarAnimationControllerClient {
public:
    MockScrollbarAnimationControllerClient(LayerTreeHostImpl* host_impl, bool is_fluent)
    ...
    void PostDelayedScrollbarAnimationTask(base::OnceClosure start_fade, base::TimeDelta delay) override
    {
...
class ScrollbarAnimationControllerOverlayTest : public LayerTreeImplTestBase, public testing::Test, public testing::WithParamInterface<bool> {
public:
...
protected:
    ...
    void SetUp() override
    {
        ...
        h_scrollbar_layer_
            = AddLayerInActiveTree<SolidColorScrollbarLayerImpl>(ScrollbarOrientation::kHorizontal, kThumbThickness, kTrackStart, kIsLeftSideVerticalScrollbar);
        v_scrollbar_layer_
            = AddLayerInActiveTree<SolidColorScrollbarLayerImpl>(ScrollbarOrientation::kVertical, kThumbThickness, kTrackStart, kIsLeftSideVerticalScrollbar);
        ...
        scrollbar_controller_ = ScrollbarAnimationController::CreateScrollbarAnimationControllerAuraOverlay(
            scroll_layer_->element_id(), &client_, kFadeDelay, kFadeDuration, kThinningDuration, 0.0f, kIdleThicknessScale);
        v_scrollbar_layer_->SetCurrentPos(0);
        h_scrollbar_layer_->SetCurrentPos(0);
        mouse_move_distance_to_trigger_fade_in_
            = scrollbar_controller_->GetScrollbarAnimationController(ScrollbarOrientation::kVertical).MouseMoveDistanceToTriggerFadeIn();
        mouse_move_distance_to_trigger_expand_
            = scrollbar_controller_->GetScrollbarAnimationController(ScrollbarOrientation::kVertical).MouseMoveDistanceToTriggerExpand();
    }
...
class ScrollbarAnimationControllerAuraOverlayTest : public ScrollbarAnimationControllerOverlayTest {
public:
...
class ScrollbarAnimationControllerFluentOverlayTest : public ScrollbarAnimationControllerOverlayTest {
public:
...
TEST_P(ScrollbarAnimationControllerOverlayTest, Idle)
{
    ...
    EXPECT_FLOAT_EQ(kIdleThicknessScale, v_scrollbar_layer_->thumb_thickness_scale_factor());
    EXPECT_FLOAT_EQ(kIdleThicknessScale, v_scrollbar_layer_->thumb_thickness_scale_factor());
}
...
TEST_P(ScrollbarAnimationControllerOverlayTest, BasicAppearByWillUpdateScrollThenFadeOut)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MoveNearTrackThenNearThumb)
{
    base::TimeTicks time;
    time += base::Seconds(1);
    ...
    ExpectScrollbarsOpacity(1);
    EXPECT_FLOAT_EQ(kIdleThicknessScale, v_scrollbar_layer_->thumb_thickness_scale_factor());
    EXPECT_FLOAT_EQ(kIdleThicknessScale, h_scrollbar_layer_->thumb_thickness_scale_factor());
...
// to fade out.
TEST_P(ScrollbarAnimationControllerOverlayTest, DontFadeWhileCapturedBeforeThick)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_P(ScrollbarAnimationControllerOverlayTest, DontFadeWhileCapturedThenAway)
{
    ...
    // cancelled.
    scrollbar_controller_->DidMouseMove(NearVerticalScrollbarBegin(-mouse_move_distance_to_trigger_expand_ - 1, 0));
...
TEST_P(ScrollbarAnimationControllerOverlayTest, FadeAfterReleasedFar)
{
    ...
    scrollbar_controller_->DidMouseMove(NearVerticalScrollbarBegin(-mouse_move_distance_to_trigger_fade_in_ - 1, 0));
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MouseNearEach)
{
    ...
    // Now move away from bar.
    scrollbar_controller_->DidMouseMove(NearHorizontalScrollbarBegin(0, -mouse_move_distance_to_trigger_expand_ - 1));
    scrollbar_controller_->Animate(time);
    time += kThinningDuration;
    scrollbar_controller_->Animate(time);
    ExpectScrollbarsOpacity(1);
...
TEST_P(ScrollbarAnimationControllerOverlayTest, MouseNearOtherBeforeAnimationFinished)
{
    base::TimeTicks time;
    time += base::Seconds(1);
    ...
    scrollbar_controller_->Animate(time);
    ExpectScrollbarsOpacity(1);
    EXPECT_FLOAT_EQ(kIdleThicknessScale + (1.0f - kIdleThicknessScale) / 2, v_scrollbar_layer_->thumb_thickness_scale_factor());
    EXPECT_FLOAT_EQ(kIdleThicknessScale, h_scrollbar_layer_->thumb_thickness_scale_factor());
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, BasicMouseHoverFadeIn)
{
    ...
    scrollbar_controller_->DidMouseMove(NearVerticalScrollbarBegin(-mouse_move_distance_to_trigger_fade_in_, 0));
...
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MouseHoverScrollbarAndMoveInside)
{
    base::TimeTicks time;
    time += base::Seconds(1);
    ...
    // post a new fade in.
    scrollbar_controller_->DidMouseMove(NearVerticalScrollbarBegin(-mouse_move_distance_to_trigger_fade_in_ + 2, 0));
...
// move far away.
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MouseHoverThenOutShouldCancelFadeIn)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
// Scrollbars should cancel delay fade in when mouse hover hidden scrollbar then
// move out of window.
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MouseHoverThenLeaveShouldCancelShowThenEnterShouldFadeIn)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
// hover fade in.
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MouseHoverThenMouseDownShouldCancelFadeInThenReleaseNearShouldFadeIn)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
// hover fade in.
TEST_F(ScrollbarAnimationControllerAuraOverlayTest, MouseReleaseFarShouldNotFadeIn)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_F(ScrollbarAnimationControllerFluentOverlayTest, DidMouseMoveWithVisibleScrollbarQueuesAnimations)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
// moused over.
TEST_F(ScrollbarAnimationControllerFluentOverlayTest, DidMouseMoveWithHiddenScrollbarRemainsHidden)
{
    ExpectScrollbarsOpacity(0.f);
...
TEST_F(ScrollbarAnimationControllerFluentOverlayTest, ScrollAndMouseOverGoesToFullMode)
{
    ExpectScrollbarsOpacity(0.f);
...
TEST_F(ScrollbarAnimationControllerFluentOverlayTest, HidesWhenReleasedOutsideArea)
{
    ExpectScrollbarsOpacity(0.f);
...
class ScrollbarAnimationControllerAndroidTest : public LayerTreeImplTestBase, public testing::Test, public ScrollbarAnimationControllerClient {
public:
...
protected:
    void SetUp() override
    {
        ...
        scroll_layer_ = AddLayerInActiveTree<LayerImpl>();
        scrollbar_layer_ = AddLayerInActiveTree<SolidColorScrollbarLayerImpl>(orientation(), kThumbThickness, kTrackStart, kIsLeftSideVerticalScrollbar);
        SetElementIdsForTesting();
        ...
        scrollbar_controller_ = ScrollbarAnimationController::CreateScrollbarAnimationControllerAndroid(
            scroll_layer_->element_id(), this, base::Seconds(2), base::Seconds(3), 0.0f);
    }
...
class VerticalScrollbarAnimationControllerAndroidTest : public ScrollbarAnimationControllerAndroidTest {
protected:
...
{
    scrollbar_layer_->SetOverlayScrollbarLayerOpacityAnimated(0.f, /*fade_out_animation=*/false);
    scrollbar_controller_->Animate(base::TimeTicks());
    EXPECT_FLOAT_EQ(0.0f, scrollbar_layer_->Opacity());
}

TEST_F(ScrollbarAnimationControllerAndroidTest, HiddenAfterNonScrollingGesture)
{
    scrollbar_layer_->SetOverlayScrollbarLayerOpacityAnimated(0.f, /*fade_out_animation=*/false);
...
TEST_F(ScrollbarAnimationControllerAndroidTest, WillUpdateScrollNotAppearScrollbar)
{
    base::TimeTicks time;
    time += base::Seconds(1);
...
TEST_F(VerticalScrollbarAnimationControllerAndroidTest, HideOnUserNonScrollableVert)
{
    EXPECT_EQ(ScrollbarOrientation::kVertical, scrollbar_layer_->orientation());
...
TEST_F(VerticalScrollbarAnimationControllerAndroidTest, ShowOnUserNonScrollableHorz)
{
    EXPECT_EQ(ScrollbarOrientation::kVertical, scrollbar_layer_->orientation());
...
TEST_F(ScrollbarAnimationControllerAndroidTest, AnimationPreservedByNonScrollingGesture)
{
    base::TimeTicks time;
    time += base::Seconds(1);
    scrollbar_controller_->DidScrollUpdate();
    ...
    did_request_animate_ = false;
    EXPECT_FLOAT_EQ(2.0f / 3.0f, scrollbar_layer_->Opacity());
    EXPECT_EQ(scrollbar_layer_->GetDamageReasons(), DamageReasonSet { DamageReason::kScrollbarFadeOutAnimation });
...
TEST_F(ScrollbarAnimationControllerAndroidTest, AnimationOverriddenByScrollingGesture)
{
    base::TimeTicks time;
    time += base::Seconds(1);
    scrollbar_controller_->DidScrollUpdate();
