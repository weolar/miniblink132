...
struct CC_EXPORT MainThreadScrollingReason {
    ...
    static constexpr uint32_t kRepaintReasons
        = kHasBackgroundAttachmentFixedObjects | kNotOpaqueForTextAndLCDText | kPreferNonCompositedScrolling | kBackgroundNeedsRepaintOnScroll;
    static constexpr uint32_t kHitTestReasons = kScrollbarScrolling | kMainThreadScrollHitTestRegion | kFailedHitTest;
    ...
    static void AddToTracedValue(uint32_t reasons, base::trace_event::TracedValue&);
};
