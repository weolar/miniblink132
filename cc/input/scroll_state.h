...
public:
    ...
    // Positive when scrolling right.
    double delta_x_hint() const
    {
        return data_.delta_x_hint;
    }
    // Positive when scrolling down.
    double delta_y_hint() const
    {
        return data_.delta_y_hint;
    }
    ...
    {
        return data_.position_x;
    }
    int position_y() const
    {
        return data_.position_y;
    }

    bool is_beginning() const
    {
        return data_.is_beginning;
    }
    void set_is_beginning(bool is_beginning)
    {
        data_.is_beginning = is_beginning;
    }
    bool is_in_inertial_phase() const
    {
        return data_.is_in_inertial_phase;
    }
    ...
    {
        return data_.is_ending;
    }
    void set_is_ending(bool is_ending)
    {
        data_.is_ending = is_ending;
    }

    // True if the user interacts directly with the screen, e.g., via touch.
    bool is_direct_manipulation() const
    {
        return data_.is_direct_manipulation;
    }
    ...
    bool caused_scroll_x() const
    {
        return data_.caused_scroll_x;
    }
    bool caused_scroll_y() const
    {
        return data_.caused_scroll_y;
    }

    void set_is_scroll_chain_cut(bool cut)
    {
        data_.is_scroll_chain_cut = cut;
    }

    bool is_scroll_chain_cut() const
    {
        return data_.is_scroll_chain_cut;
    }
