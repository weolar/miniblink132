...
public:
    explicit RasterizeAndRecordBenchmark(base::Value::Dict settings, MicroBenchmark::DoneCallback callback);
    ...
    std::unique_ptr<MicroBenchmarkImpl> CreateBenchmarkImpl(scoped_refptr<base::SingleThreadTaskRunner> origin_task_runner) override;
