...
// display compositor.
class CC_MOJO_EMBEDDER_EXPORT AsyncLayerTreeFrameSink : public LayerTreeFrameSink,
...
public:
    struct CC_MOJO_EMBEDDER_EXPORT UnboundMessagePipes {
        ...
        mojo::PendingRemote<viz::mojom::CompositorFrameSink> compositor_frame_sink_remote;
    ...
    AsyncLayerTreeFrameSink(scoped_refptr<viz::RasterContextProvider> context_provider,
    ...
    {
        return auto_needs_begin_frame_;
    }
    ...
    std::unique_ptr<LayerContext> CreateLayerContext(LayerTreeHostImpl& host_impl) override;
...
private:
    ...
    void OnBeginFrame(const viz::BeginFrameArgs& begin_frame_args, const viz::FrameTimingDetailsMap& timing_details, bool frame_ack,
    ...
    void OnMojoConnectionError(uint32_t custom_reason, const std::string& description);
    ...
    mojo::AssociatedRemote<viz::mojom::CompositorFrameSink> compositor_frame_sink_associated_;
    ...
    //using DirectClientReceiver = mojo::DirectReceiver<viz::mojom::CompositorFrameSinkClient>;
    absl::variant<absl::monostate, ClientReceiver /*, DirectClientReceiver*/> client_receiver_;
