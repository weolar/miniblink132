...
TEST(FilterAnimationCurveTest, OneFilterKeyframe)
{
    ...
    curve->AddKeyframe(FilterKeyframe::Create(base::TimeDelta(), operations, nullptr));
...
TEST(FilterAnimationCurveTest, TwoFilterKeyframe)
{
    ...
    curve->AddKeyframe(FilterKeyframe::Create(base::TimeDelta(), operations1, nullptr));
    curve->AddKeyframe(FilterKeyframe::Create(base::Seconds(1.f), operations2, nullptr));
    ExpectBrightness(2.f, SAMPLE(curve, base::Seconds(-1.f)));
    ExpectBrightness(2.f, SAMPLE(curve, base::Seconds(0.f)));
...
TEST(FilterAnimationCurveTest, ThreeFilterKeyframe)
{
    ...
    curve->AddKeyframe(FilterKeyframe::Create(base::TimeDelta(), operations1, nullptr));
    curve->AddKeyframe(FilterKeyframe::Create(base::Seconds(1.f), operations2, nullptr));
    curve->AddKeyframe(FilterKeyframe::Create(base::Seconds(2.f), operations3, nullptr));
    ExpectBrightness(2.f, SAMPLE(curve, base::Seconds(-1.f)));
    ExpectBrightness(2.f, SAMPLE(curve, base::Seconds(0.f)));
    ExpectBrightness(3.f, SAMPLE(curve, base::Seconds(0.5f)));
    ExpectBrightness(4.f, SAMPLE(curve, base::Seconds(1.f)));
...
TEST(FilterAnimationCurveTest, RepeatedFilterKeyTimes)
{
    ...
    curve->AddKeyframe(FilterKeyframe::Create(base::TimeDelta(), operations1, nullptr));
    curve->AddKeyframe(FilterKeyframe::Create(base::Seconds(1.f), operations2, nullptr));
    curve->AddKeyframe(FilterKeyframe::Create(base::Seconds(1.f), operations3, nullptr));
    curve->AddKeyframe(FilterKeyframe::Create(base::Seconds(2.f), operations4, nullptr));
