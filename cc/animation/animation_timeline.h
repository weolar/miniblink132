...
class CC_ANIMATION_EXPORT AnimationTimeline : public base::RefCounted<AnimationTimeline>, public ProtectedSequenceSynchronizer {
public:
    static scoped_refptr<AnimationTimeline> Create(int id, bool impl_only = false);
    ...
    bool TickTimeLinkedAnimations(const std::vector<scoped_refptr<Animation>>& ticking_animations, base::TimeTicks monotonic_time, bool tick_finished);
...
private:
    ...
    void RemoveDetachedAnimationsFromImplThread(AnimationTimeline* timeline) const;
