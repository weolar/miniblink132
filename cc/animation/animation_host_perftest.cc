...
protected:
    ...
    void SetUp() override
    {
        ...
        layer_tree_host_ = FakeLayerTreeHost::Create(&fake_client_, &task_graph_runner_, animation_host_.get(), settings);
    ...
    {
        all_animations_timeline_ = AnimationTimeline::Create(AnimationIdProvider::NextTimelineId());
        ...
        for (int i = 0; i < num_animations; ++i) {
            ...
            scoped_refptr<Animation> animation = Animation::Create(last_animation_id_);
        ...
        scoped_refptr<AnimationTimeline> timeline_impl = host_impl()->GetTimelineById(all_animations_timeline_->id());
