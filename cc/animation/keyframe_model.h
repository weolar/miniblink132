...
public:
    static const KeyframeModel* ToCcKeyframeModel(const gfx::KeyframeModel* keyframe_model);
    ...
    public:
        ...
        // property name.
        TargetPropertyId(int target_property_type, const std::string& custom_property_name);
        // For TargetProperty::NATIVE_PROPERTY.
        TargetPropertyId(int target_property_type, PaintWorkletInput::NativePropertyType native_property_type);
    ...
    void set_element_id(ElementId element_id)
    {
    ...
    bool is_controlling_instance() const
    {
        return is_controlling_instance_;
    }
    ...
    void SetIsImplOnly();
    bool is_impl_only() const
    {
        return is_impl_only_;
    }
    ...
    bool affects_active_elements() const
    {
        return affects_active_elements_;
    }
    ...
    bool affects_pending_elements() const
    {
        return affects_pending_elements_;
    }
...
private:
    KeyframeModel(std::unique_ptr<gfx::AnimationCurve> curve, int keyframe_model_id, int group_id, TargetPropertyId target_property_id);
