...
AnimationEvent::AnimationEvent(AnimationEvent::Type type, UniqueKeyframeModelId uid, int group_id, int target_property, base::TimeTicks monotonic_time)
    : type(type)
    , uid(uid)
    , group_id(group_id)
...
AnimationEvent::AnimationEvent(int timeline_id, int animation_id, std::optional<base::TimeDelta> local_time)
...
AnimationEvents::AnimationEvents()
    : needs_time_updated_events_(false)
{
}
