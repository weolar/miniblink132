...
class CC_ANIMATION_EXPORT Animation : public base::RefCounted<Animation>, public ProtectedSequenceSynchronizer {
public:
    ...
    void NotifyKeyframeModelFinishedForTesting(int timeline_id, int keyframe_model_id, TargetProperty::Type target_property, int group_id);
    ...
    virtual void UpdateState(bool start_ready_keyframe_models, AnimationEvents* events);
    ...
    void set_is_replacement()
    {
        is_replacement_ = true;
    }
...
private:
    ...
    ProtectedSequenceReadable<raw_ptr<AnimationTimeline>> animation_timeline_ { nullptr };
