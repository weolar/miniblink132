...
public:
    ...
    PaintImageBuilder&& set_image(sk_sp<SkImage> sk_image, PaintImage::ContentId content_id)
    {
    ...
    PaintImageBuilder&& set_texture_backing(sk_sp<TextureBacking> texture_backing, PaintImage::ContentId content_id)
    {
        paint_image_.texture_backing_ = std::move(texture_backing);
        paint_image_.content_id_ = content_id;
        return std::move(*this);
    }
    PaintImageBuilder&& set_paint_record(PaintRecord paint_record, const gfx::Rect& rect, PaintImage::ContentId content_id)
    {
    ...
    PaintImageBuilder&& set_paint_image_generator(sk_sp<PaintImageGenerator> generator)
    {
    ...
    PaintImageBuilder&& set_gainmap_paint_image_generator(sk_sp<PaintImageGenerator> generator, const SkGainmapInfo& gainmap_info)
    {
    ...
    PaintImageBuilder&& set_hdr_metadata(std::optional<gfx::HDRMetadata> hdr_metadata)
    {
    ...
    PaintImageBuilder&& set_reset_animation_sequence_id(PaintImage::AnimationSequenceId id)
    {
    ...
    PaintImageBuilder&& set_deferred_paint_record(scoped_refptr<DeferredPaintRecord> input)
    {
...
private:
    ...
    PaintImageBuilder&& set_texture_image(sk_sp<SkImage> sk_image, PaintImage::ContentId content_id)
    {
        paint_image_.sk_image_ = std::move(sk_image);
        paint_image_.content_id_ = content_id;
        return std::move(*this);
    }
    PaintImageBuilder&& set_gainmap_texture_image(sk_sp<SkImage> gainmap_sk_image, const SkGainmapInfo& gainmap_info)
    {
