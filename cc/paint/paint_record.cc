...
{
    static base::NoDestructor<sk_sp<PaintOpBuffer>> empty_buffer(sk_make_sp<PaintOpBuffer>());
...
// static
SkRect PaintRecord::GetFixedScaleBounds(const SkMatrix& ctm, const SkRect& bounds, int max_texture_size)
{
    SkSize scale;
...
sk_sp<SkPicture> PaintRecord::ToSkPicture(const SkRect& bounds, ImageProvider* image_provider, const PlaybackCallbacks& callbacks) const
{
