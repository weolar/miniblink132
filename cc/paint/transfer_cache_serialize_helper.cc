...
bool TransferCacheSerializeHelper::LockEntry(TransferCacheEntryType type, uint32_t id)
{
...
uint32_t TransferCacheSerializeHelper::CreateEntry(const ClientTransferCacheEntry& entry, uint8_t* memory)
{
...
void TransferCacheSerializeHelper::AssertLocked(TransferCacheEntryType type, uint32_t id)
{
