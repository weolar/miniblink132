...
ClientSkottieTransferCacheEntry::ClientSkottieTransferCacheEntry(scoped_refptr<SkottieWrapper> skottie)
...
bool ClientSkottieTransferCacheEntry::Serialize(base::span<uint8_t> data) const
{
...
bool ServiceSkottieTransferCacheEntry::Deserialize(GrDirectContext* context, skgpu::graphite::Recorder* graphite_recorder, base::span<const uint8_t> data)
{
