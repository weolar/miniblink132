...
namespace cc {
DecodeStashingImageProvider::DecodeStashingImageProvider(ImageProvider* source_provider)
...
ImageProvider::ScopedResult DecodeStashingImageProvider::GetRasterContent(const DrawImage& draw_image)
{
