...
public:
    ...
    static sk_sp<ColorFilter> MakeBlend(const SkColor4f& color, SkBlendMode blend_mode);
    ...
    static sk_sp<ColorFilter> MakeTableARGB(const uint8_t a_table[256], const uint8_t r_table[256], const uint8_t g_table[256], const uint8_t b_table[256]);
    static sk_sp<ColorFilter> MakeTable(sk_sp<SkColorTable> table);
    static sk_sp<ColorFilter> MakeHighContrast(const SkHighContrastConfig& config);
