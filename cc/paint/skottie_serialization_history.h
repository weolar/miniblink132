...
public:
    ...
    SkottieSerializationHistory& operator=(const SkottieSerializationHistory&) = delete;
    ...
    void FilterNewSkottieFrameState(const SkottieWrapper& skottie, SkottieFrameDataMap& images, SkottieTextPropertyValueMap& text_map);
...
private:
    ...
    public:
        ...
        SkottieWrapperHistory(const SkottieFrameDataMap& initial_images, const SkottieTextPropertyValueMap& initial_text_map);
        ...
        void FilterNewState(SkottieFrameDataMap& images, SkottieTextPropertyValueMap& text_map);
        ...
        int current_sequence_id() const
        {
            return current_sequence_id_;
        }
    ...
    private:
        ...
        base::flat_map<SkottieResourceIdHash, SkottieFrameDataId> last_frame_data_per_asset_;
        SkottieTextPropertyValueMap accumulated_text_map_;
    };

    base::Lock mutex_;
    base::flat_map</*SkottieWrapper id*/ uint32_t, SkottieWrapperHistory> history_per_animation_ GUARDED_BY(mutex_);
