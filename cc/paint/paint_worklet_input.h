...
public:
    ...
    virtual bool ValueChangeShouldCauseRepaint(const PropertyValue& val1, const PropertyValue& val2) const;
...
using PaintWorkletRecordMap = base::flat_map<scoped_refptr<const PaintWorkletInput>, std::pair<PaintImage::Id, std::optional<PaintRecord>>>;
