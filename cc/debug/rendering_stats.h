...
struct CC_DEBUG_EXPORT RenderingStats {
    ...
    public:
        ...
        void AddToTracedValue(const char* name, base::trace_event::TracedValue* list_value) const;
    ...
    std::unique_ptr<base::trace_event::ConvertableToTraceFormat> AsTraceableData() const;
};
