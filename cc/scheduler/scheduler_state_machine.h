...
public:
    ...
    static const char* BeginImplFrameDeadlineModeToString(BeginImplFrameDeadlineMode mode);
    ...
    {
        return (needs_begin_main_frame_ && !last_commit_had_no_updates_) || CommitPending() || has_pending_tree_;
    }
    ...
    bool needs_update_display_tree() const
    {
    ...
    int pending_submit_frames() const
    {
    ...
    void set_is_scrolling(bool is_scrolling)
    {
...
protected:
    ...
    LayerTreeFrameSinkState layer_tree_frame_sink_state_ = LayerTreeFrameSinkState::NONE;
    ...
    // an animation.
    ForcedRedrawOnTimeoutState forced_redraw_state_ = ForcedRedrawOnTimeoutState::IDLE;
    ...
    ScrollHandlerState scroll_handler_state_ = ScrollHandlerState::SCROLL_DOES_NOT_AFFECT_SCROLL_HANDLER;
