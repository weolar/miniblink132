...
public:
    ...
    void AsProtozeroInto(perfetto::EventContext& ctx, base::TimeTicks now, perfetto::protos::pbzero::BeginImplFrameArgsV2* dict) const;
    ...
    bool DangerousMethodHasFinished() const
    {
        return HasFinished();
    }
...
private:
    ...
    {
        return !current_finished_at_.is_null();
    }
