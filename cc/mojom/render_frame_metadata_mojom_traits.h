...
template <> struct COMPONENT_EXPORT(CC_SHARED_MOJOM_TRAITS) StructTraits<cc::mojom::DelegatedInkBrowserMetadataDataView, cc::DelegatedInkBrowserMetadata> {
    static bool delegated_ink_is_hovering(const cc::DelegatedInkBrowserMetadata& metadata)
    {
        return metadata.delegated_ink_is_hovering;
    }

    static bool Read(cc::mojom::DelegatedInkBrowserMetadataDataView data, cc::DelegatedInkBrowserMetadata* out);
};

template <> struct COMPONENT_EXPORT(CC_SHARED_MOJOM_TRAITS) StructTraits<cc::mojom::RenderFrameMetadataDataView, cc::RenderFrameMetadata> {
    static SkColor4f root_background_color(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.root_background_color;
    }

    static const std::optional<gfx::PointF>& root_scroll_offset(const cc::RenderFrameMetadata& metadata)
    {
    ...
    static const viz::Selection<gfx::SelectionBound>& selection(const cc::RenderFrameMetadata& metadata)
    {
    ...
    static const std::optional<cc::DelegatedInkBrowserMetadata>& delegated_ink_metadata(const cc::RenderFrameMetadata& metadata)
    {
    ...
    static const gfx::Size& viewport_size_in_pixels(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.viewport_size_in_pixels;
    }

    static const std::optional<viz::LocalSurfaceId>& local_surface_id(const cc::RenderFrameMetadata& metadata)
    {
    ...
    static float external_page_scale_factor(const cc::RenderFrameMetadata& metadata)
    {
    ...
    static float top_controls_shown_ratio(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.top_controls_shown_ratio;
    }

    static viz::VerticalScrollDirection new_vertical_scroll_direction(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.new_vertical_scroll_direction;
    }

    static int64_t primary_main_frame_item_sequence_number(const cc::RenderFrameMetadata& metadata)
    {
    ...
    static float bottom_controls_shown_ratio(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.bottom_controls_shown_ratio;
    }

    static float top_controls_min_height_offset(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.top_controls_min_height_offset;
    }

    static float bottom_controls_min_height_offset(const cc::RenderFrameMetadata& metadata)
    {
    ...
    static const gfx::SizeF& scrollable_viewport_size(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.scrollable_viewport_size;
    }

    static const gfx::SizeF& root_layer_size(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.root_layer_size;
    }

    static bool has_transparent_background(const cc::RenderFrameMetadata& metadata)
    {
        return metadata.has_transparent_background;
    }
#endif

    static bool Read(cc::mojom::RenderFrameMetadataDataView data, cc::RenderFrameMetadata* out);
};
