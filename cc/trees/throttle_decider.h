...
public:
    ...
    const base::flat_set<viz::FrameSinkId>& ids() const
    {
        return ids_;
    }

private:
    base::flat_map<viz::CompositorRenderPassId, raw_ptr<const viz::CompositorRenderPass, CtnExperimental>> id_to_pass_map_;
