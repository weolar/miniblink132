...
PropertyAnimationState::PropertyAnimationState(const PropertyAnimationState& rhs) = default;

PropertyAnimationState::~PropertyAnimationState() = default;

bool PropertyAnimationState::operator==(const PropertyAnimationState& other) const
{
...
PropertyAnimationState& PropertyAnimationState::operator|=(const PropertyAnimationState& other)
{
...
PropertyAnimationState operator^(const PropertyAnimationState& lhs, const PropertyAnimationState& rhs)
{
