...
{
    *os << (mode == CompositorMode::THREADED ? "MultiThreaded" : "SingleThreaded");
}
...
{
    return ::testing::Combine(::testing::ValuesIn(types), ::testing::Values(CompositorMode::SINGLE_THREADED, CompositorMode::THREADED));
}

class LayerTreeHostCopyRequestTest : public LayerTreeTest, public ::testing::WithParamInterface<::testing::tuple<viz::RendererType, CompositorMode>> {
public:
...
class LayerTreeHostCopyRequestTestMultipleRequests : public LayerTreeHostCopyRequestTest {
protected:
    ...
    void WaitForCallback()
    {
        base::SingleThreadTaskRunner::GetCurrentDefault()->PostTask(
            FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestMultipleRequests::NextStep, base::Unretained(this)));
    }
    ...
    void NextStep()
    {
        ...
        case 1:
            child->RequestCopyOfOutput(
                std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                    base::BindOnce(&LayerTreeHostCopyRequestTestMultipleRequests::CopyOutputCallback, base::Unretained(this), 0)));
        ...
        case 3:
            ...
            child->RequestCopyOfOutput(
                std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                    base::BindOnce(&LayerTreeHostCopyRequestTestMultipleRequests::CopyOutputCallback, base::Unretained(this), 1)));
            root->RequestCopyOfOutput(
                std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                    base::BindOnce(&LayerTreeHostCopyRequestTestMultipleRequests::CopyOutputCallback, base::Unretained(this), 2)));
            grand_child->RequestCopyOfOutput(
                std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                    base::BindOnce(&LayerTreeHostCopyRequestTestMultipleRequests::CopyOutputCallback, base::Unretained(this), 3)));
            EXPECT_EQ(1u, callbacks_.size());
            break;
        case 4:
            // This commit is triggered by the copy request having been completed.
    ...
    void CopyOutputCallback(size_t id, std::unique_ptr<viz::CopyOutputResult> result)
    {
...
INSTANTIATE_TEST_SUITE_P(All, LayerTreeHostCopyRequestTestMultipleRequests, CombineWithCompositorModes(viz::GetRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestMultipleRequests);
...
class LayerTreeHostCopyRequestTestMultipleRequestsOutOfOrder : public LayerTreeHostCopyRequestTestMultipleRequests {
    std::unique_ptr<viz::DisplayCompositorMemoryAndTaskController> CreateDisplayControllerOnThread() override
    {
    ...
    std::unique_ptr<viz::SkiaOutputSurface> CreateSkiaOutputSurfaceOnThread(viz::DisplayCompositorMemoryAndTaskController*) override
    {
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestMultipleRequestsOutOfOrder, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestMultipleRequestsOutOfOrder);
...
// longer needed.
class LayerTreeHostCopyRequestCompletionCausesCommit : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
    ...
    void DidCommit() override
    {
        ...
        switch (frame) {
        case 1:
            layer_->RequestCopyOfOutput(std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA,
                viz::CopyOutputRequest::ResultDestination::kSystemMemory, base::BindOnce(&LayerTreeHostCopyRequestCompletionCausesCommit::CopyOutputCallback)));
            break;
        case 2:
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestCompletionCausesCommit, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestCompletionCausesCommit);
...
class LayerTreeHostCopyRequestTestLayerDestroyed : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = FakePictureLayer::Create(&client_);
    ...
    void DidCommit() override
    {
        ...
        case 1:
            main_destroyed_->RequestCopyOfOutput(
                std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                    base::BindOnce(&LayerTreeHostCopyRequestTestLayerDestroyed::CopyOutputCallback, base::Unretained(this), &main_destroyed_event_)));
            impl_destroyed_->RequestCopyOfOutput(
                std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                    base::BindOnce(&LayerTreeHostCopyRequestTestLayerDestroyed::CopyOutputCallback, base::Unretained(this), &impl_destroyed_event_)));
        ...
        case 3:
            ...
            EXPECT_TRUE(main_destroyed_event_.TimedWait(TestTimeouts::action_timeout()));
            EXPECT_FALSE(impl_destroyed_event_.IsSignaled());
        ...
        case 5:
            ...
            // to draw.
            EXPECT_TRUE(impl_destroyed_event_.TimedWait(TestTimeouts::action_timeout()));
            EndTest();
            break;
        }
    }

    void CopyOutputCallback(base::WaitableEvent* event, std::unique_ptr<viz::CopyOutputResult> result)
    {
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestLayerDestroyed, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestLayerDestroyed);
...
class LayerTreeHostCopyRequestTestInHiddenSubtree : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = FakePictureLayer::Create(&client_);
    ...
    void AddCopyRequest(Layer* layer)
    {
        layer->RequestCopyOfOutput(
            std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                base::BindOnce(&LayerTreeHostCopyRequestTestInHiddenSubtree::CopyOutputCallback, base::Unretained(this))));
    }
    ...
    void CopyOutputCallback(std::unique_ptr<viz::CopyOutputResult> result)
    {
        ++callback_count_;
        EXPECT_TRUE(layer_tree_host()->GetTaskRunnerProvider()->IsMainThread());
        EXPECT_EQ(copy_layer_->bounds().ToString(), result->size().ToString()) << callback_count_;
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestInHiddenSubtree, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestInHiddenSubtree);
...
class LayerTreeHostTestHiddenSurfaceNotAllocatedForSubtreeCopyRequest : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = FakePictureLayer::Create(&client_);
    ...
    void BeginTest() override
    {
        ...
        copy_layer_->RequestCopyOfOutput(
            std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                base::BindOnce(&LayerTreeHostTestHiddenSurfaceNotAllocatedForSubtreeCopyRequest::CopyOutputCallback, base::Unretained(this))));
    }
    ...
    void DisplayWillDrawAndSwapOnThread(bool will_draw_and_swap, const viz::AggregatedRenderPassList& render_passes) override
    {
    ...
    {
        viz::DirectRenderer* renderer = frame_sink_->display()->renderer_for_testing();

        // |parent| owns a surface, but it was hidden and not part of the copy
        // request so it should not allocate any resource.
        EXPECT_FALSE(renderer->HasAllocatedResourcesForTesting(parent_render_pass_id));
        ...
        if (did_swap_) {
            EXPECT_FALSE(renderer->HasAllocatedResourcesForTesting(copy_layer_render_pass_id));
        } else {
            // |copy_layer| should have been rendered to a texture since it was needed
            // for a copy request.
            EXPECT_TRUE(renderer->HasAllocatedResourcesForTesting(copy_layer_render_pass_id));
        }
...
INSTANTIATE_TEST_SUITE_P(All, LayerTreeHostTestHiddenSurfaceNotAllocatedForSubtreeCopyRequest, CombineWithCompositorModes(viz::GetGpuRendererTypes()),
    PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostTestHiddenSurfaceNotAllocatedForSubtreeCopyRequest);
...
class LayerTreeHostCopyRequestTestClippedOut : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = FakePictureLayer::Create(&client_);
    ...
    void BeginTest() override
    {
        ...
        copy_layer_->RequestCopyOfOutput(
            std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                base::BindOnce(&LayerTreeHostCopyRequestTestClippedOut::CopyOutputCallback, base::Unretained(this))));
    }
...
INSTANTIATE_TEST_SUITE_P(All, LayerTreeHostCopyRequestTestClippedOut, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestClippedOut);
...
class LayerTreeHostCopyRequestTestScaledLayer : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = Layer::Create();
    ...
    void BeginTest() override
    {
        ...
        std::unique_ptr<viz::CopyOutputRequest> request
            = std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                base::BindOnce(&LayerTreeHostCopyRequestTestScaledLayer::CopyOutputCallback, base::Unretained(this)));
...
INSTANTIATE_TEST_SUITE_P(All, LayerTreeHostCopyRequestTestScaledLayer, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestScaledLayer);
...
class LayerTreeHostTestAsyncTwoReadbacksWithoutDraw : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = FakePictureLayer::Create(&client_);
    ...
    void AddCopyRequest(Layer* layer)
    {
        layer->RequestCopyOfOutput(
            std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                base::BindOnce(&LayerTreeHostTestAsyncTwoReadbacksWithoutDraw::CopyOutputCallback, base::Unretained(this))));
    }
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostTestAsyncTwoReadbacksWithoutDraw, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostTestAsyncTwoReadbacksWithoutDraw);
...
class LayerTreeHostCopyRequestTestDeleteSharedImage : public LayerTreeHostCopyRequestTest {
protected:
    std::unique_ptr<viz::DisplayCompositorMemoryAndTaskController> CreateDisplayControllerOnThread() override
    {
        // In this implementation, none of the output surface has a real gpu thread,
    ...
    void ReceiveCopyRequestOutputAndCommit(std::unique_ptr<viz::CopyOutputResult> result)
    {
        EXPECT_TRUE(layer_tree_host()->GetTaskRunnerProvider()->IsMainThread());
        EXPECT_EQ(gfx::Size(10, 10).ToString(), result->size().ToString());
        EXPECT_EQ(result->format(), viz::CopyOutputResult::Format::RGBA);
        EXPECT_EQ(result->destination(), viz::CopyOutputResult::Destination::kNativeTextures);
    ...
    {
        copy_layer_->RequestCopyOfOutput(
            std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputResult::Destination::kNativeTextures,
                base::BindOnce(&LayerTreeHostCopyRequestTestDeleteSharedImage::ReceiveCopyRequestOutputAndCommit, base::Unretained(this))));
    }
    ...
    void DestroyCopyResultAndCheckNumSharedImages()
    {
        ...
        ImplThreadTaskRunner()->PostTask(
            FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestDeleteSharedImage::CheckNumSharedImagesAfterReadbackDestroyed, base::Unretained(this)));
    }
    ...
    void CheckNumSharedImagesAfterReadbackDestroyed()
    {
        ...
        // 1 less by now.
        EXPECT_EQ(num_shared_images_after_readback_ - 1, display_context_provider_->SharedImageInterface()->shared_image_count());
    ...
    void DisplayDidDrawAndSwapOnThread() override
    {
        ...
        case 0:
            ...
            MainThreadTaskRunner()->PostTask(
                FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestDeleteSharedImage::InsertCopyRequest, base::Unretained(this)));
            break;
        case 1:
        ...
        case 2:
            ...
            // textures.
            MainThreadTaskRunner()->PostTask(
                FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestDeleteSharedImage::DestroyCopyResultAndCheckNumSharedImages, base::Unretained(this)));
            break;
        }
    }
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestDeleteSharedImage, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestDeleteSharedImage);
...
class LayerTreeHostCopyRequestTestCountSharedImages : public LayerTreeHostCopyRequestTest {
protected:
    std::unique_ptr<viz::DisplayCompositorMemoryAndTaskController> CreateDisplayControllerOnThread() override
    {
        // In this implementation, none of the output surface has a real gpu thread,
        ...
        scoped_refptr<viz::RasterContextProvider> compositor_context_provider, scoped_refptr<viz::RasterContextProvider> worker_context_provider) override
    {
        ...
        auto frame_sink = LayerTreeHostCopyRequestTest::CreateLayerTreeFrameSink(
            settings, refresh_rate, std::move(compositor_context_provider), std::move(worker_context_provider));
        return frame_sink;
    }
    ...
    void DisplayDidDrawAndSwapOnThread() override
    {
        ...
        case 1:
            ...
            // readback.
            MainThreadTaskRunner()->PostTask(FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestCountSharedImages::DoEndTest, base::Unretained(this)));
            break;
        }
    }
...
class LayerTreeHostCopyRequestTestCreatesSharedImage : public LayerTreeHostCopyRequestTestCountSharedImages {
protected:
    void RequestCopy(Layer* layer) override
    {
        ...
        copy_layer_->RequestCopyOfOutput(
            std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputResult::Destination::kNativeTextures,
                base::BindOnce(&LayerTreeHostCopyRequestTestCreatesSharedImage::CopyOutputCallback, base::Unretained(this))));
    }
    ...
    void AfterTest() override
    {
        ...
        EXPECT_EQ(num_shared_images_without_readback_ + 1, num_shared_images_with_readback_);
    }
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestCreatesSharedImage, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestCreatesSharedImage);
...
class LayerTreeHostCopyRequestTestDestroyBeforeCopy : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = FakePictureLayer::Create(&client_);
    ...
    void DidActivateTreeOnThread(LayerTreeHostImpl* impl) override
    {
        MainThreadTaskRunner()->PostTask(FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestDestroyBeforeCopy::DidActivate, base::Unretained(this)));
    }
    ...
    void DidActivate()
    {
        ...
        case 1: {
            ...
            std::unique_ptr<viz::CopyOutputRequest> request
                = std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputResult::Destination::kNativeTextures,
                    base::BindOnce(&LayerTreeHostCopyRequestTestDestroyBeforeCopy::CopyOutputCallback, base::Unretained(this)));
            copy_layer_->RequestCopyOfOutput(std::move(request));
        ...
        case 3:
            ...
            layer_tree_host()->SetViewportRectAndScale(gfx::Rect(layer_tree_host()->root_layer()->bounds()), 1.f, GetCurrentLocalSurfaceId());
            break;
        case 4:
            EXPECT_EQ(1, callback_count_);
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestDestroyBeforeCopy, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestDestroyBeforeCopy);
...
class LayerTreeHostCopyRequestTestShutdownBeforeCopy : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
        root_ = FakePictureLayer::Create(&client_);
    ...
    void DidActivateTreeOnThread(LayerTreeHostImpl* impl) override
    {
        MainThreadTaskRunner()->PostTask(FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestShutdownBeforeCopy::DidActivate, base::Unretained(this)));
    }
    ...
    void DidActivate()
    {
        ...
        case 1: {
            ...
            std::unique_ptr<viz::CopyOutputRequest> request
                = std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputResult::Destination::kNativeTextures,
                    base::BindOnce(&LayerTreeHostCopyRequestTestShutdownBeforeCopy::CopyOutputCallback, base::Unretained(this)));
            copy_layer_->RequestCopyOfOutput(std::move(request));
        ...
        case 2:
            ...
            // the main thread.
            MainThreadTaskRunner()->PostTask(FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestShutdownBeforeCopy::EndTest, base::Unretained(this)));
            break;
        }
    }
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestShutdownBeforeCopy, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestShutdownBeforeCopy);
...
class LayerTreeHostCopyRequestTestMultipleDrawsHiddenCopyRequest : public LayerTreeHostCopyRequestTest {
protected:
    void SetupTree() override
    {
    ...
    void DidCommit() override
    {
        ...
        if (layer_tree_host()->SourceFrameNumber() == 1) {
            child_->RequestCopyOfOutput(
                std::make_unique<viz::CopyOutputRequest>(viz::CopyOutputRequest::ResultFormat::RGBA, viz::CopyOutputRequest::ResultDestination::kSystemMemory,
                    base::BindOnce(&LayerTreeHostCopyRequestTestMultipleDrawsHiddenCopyRequest::CopyOutputCallback, base::Unretained(this))));
        }
    }
    ...
    DrawResult PrepareToDrawOnThread(LayerTreeHostImpl* host_impl, LayerTreeHostImpl::FrameData* frame_data, DrawResult draw_result) override
    {
        ...
        for (EffectTreeLayerListIterator it(host_impl->active_tree()); it.state() != EffectTreeLayerListIterator::State::kEnd; ++it) {
        ...
        case 3:
            ...
            // to the main thread.
            MainThreadTaskRunner()->PostTask(
                FROM_HERE, base::BindOnce(&LayerTreeHostCopyRequestTestMultipleDrawsHiddenCopyRequest::TryEndTest, base::Unretained(this), WhatHappened::DRAW));
            break;
        }
        return draw_result;
    }
...
INSTANTIATE_TEST_SUITE_P(
    All, LayerTreeHostCopyRequestTestMultipleDrawsHiddenCopyRequest, CombineWithCompositorModes(viz::GetGpuRendererTypes()), PrintTupleToStringParamName());

// viz::GetGpuRendererTypes() is empty on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostCopyRequestTestMultipleDrawsHiddenCopyRequest);
