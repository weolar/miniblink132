...
struct CC_EXPORT CompositorCommitData {
    ...
    struct CC_EXPORT ScrollUpdateInfo {
        ScrollUpdateInfo();
        ScrollUpdateInfo(ElementId id, gfx::Vector2dF delta, std::optional<TargetSnapAreaElementIds> snap_target_ids);
        ...
        {
            return element_id == other.element_id && scroll_delta == other.scroll_delta && snap_target_element_ids == other.snap_target_element_ids;
        }
    };
    ...
    BrowserControlsState browser_controls_constraint = BrowserControlsState::kBoth;
