...
protected:
    ...
    LayerTreeHostProxyTestSetNeedsCommit(const LayerTreeHostProxyTestSetNeedsCommit&) = delete;
    ~LayerTreeHostProxyTestSetNeedsCommit() override = default;

    LayerTreeHostProxyTestSetNeedsCommit& operator=(const LayerTreeHostProxyTestSetNeedsCommit&) = delete;
    ...
    void BeginTest() override
    {
        ...
        EXPECT_EQ(ProxyMain::COMMIT_PIPELINE_STAGE, GetProxyMain()->max_requested_pipeline_stage());
    }

    void DidBeginMainFrame() override
    {
        EXPECT_EQ(ProxyMain::NO_PIPELINE_STAGE, GetProxyMain()->max_requested_pipeline_stage());
        EXPECT_EQ(ProxyMain::NO_PIPELINE_STAGE, GetProxyMain()->current_pipeline_stage());
    }
...
protected:
    ...
    LayerTreeHostProxyTestSetNeedsAnimate(const LayerTreeHostProxyTestSetNeedsAnimate&) = delete;
    ~LayerTreeHostProxyTestSetNeedsAnimate() override = default;

    LayerTreeHostProxyTestSetNeedsAnimate& operator=(const LayerTreeHostProxyTestSetNeedsAnimate&) = delete;
    ...
    void BeginTest() override
    {
        ...
        EXPECT_EQ(ProxyMain::ANIMATE_PIPELINE_STAGE, GetProxyMain()->max_requested_pipeline_stage());
    }
...
class LayerTreeHostProxyTestSetNeedsUpdateLayers : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestSetNeedsUpdateLayers() = default;
    LayerTreeHostProxyTestSetNeedsUpdateLayers(const LayerTreeHostProxyTestSetNeedsUpdateLayers&) = delete;
    ~LayerTreeHostProxyTestSetNeedsUpdateLayers() override = default;

    LayerTreeHostProxyTestSetNeedsUpdateLayers& operator=(const LayerTreeHostProxyTestSetNeedsUpdateLayers&) = delete;
    ...
    void BeginTest() override
    {
        ...
        EXPECT_EQ(ProxyMain::UPDATE_LAYERS_PIPELINE_STAGE, GetProxyMain()->max_requested_pipeline_stage());
    }
...
class LayerTreeHostProxyTestSetNeedsUpdateLayersWhileAnimating : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestSetNeedsUpdateLayersWhileAnimating() = default;
    LayerTreeHostProxyTestSetNeedsUpdateLayersWhileAnimating(const LayerTreeHostProxyTestSetNeedsUpdateLayersWhileAnimating&) = delete;
    ~LayerTreeHostProxyTestSetNeedsUpdateLayersWhileAnimating() override = default;

    LayerTreeHostProxyTestSetNeedsUpdateLayersWhileAnimating& operator=(const LayerTreeHostProxyTestSetNeedsUpdateLayersWhileAnimating&) = delete;
    ...
    void WillBeginMainFrame() override
    {
        ...
        EXPECT_EQ(ProxyMain::NO_PIPELINE_STAGE, GetProxyMain()->max_requested_pipeline_stage());
        EXPECT_EQ(ProxyMain::ANIMATE_PIPELINE_STAGE, GetProxyMain()->current_pipeline_stage());
        EXPECT_EQ(ProxyMain::ANIMATE_PIPELINE_STAGE, GetProxyMain()->final_pipeline_stage());

        proxy()->SetNeedsUpdateLayers();

        EXPECT_EQ(ProxyMain::NO_PIPELINE_STAGE, GetProxyMain()->max_requested_pipeline_stage());
        EXPECT_EQ(ProxyMain::UPDATE_LAYERS_PIPELINE_STAGE, GetProxyMain()->final_pipeline_stage());
    }
...
class LayerTreeHostProxyTestSetNeedsCommitWhileAnimating : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestSetNeedsCommitWhileAnimating() = default;
    LayerTreeHostProxyTestSetNeedsCommitWhileAnimating(const LayerTreeHostProxyTestSetNeedsCommitWhileAnimating&) = delete;
    ~LayerTreeHostProxyTestSetNeedsCommitWhileAnimating() override = default;

    LayerTreeHostProxyTestSetNeedsCommitWhileAnimating& operator=(const LayerTreeHostProxyTestSetNeedsCommitWhileAnimating&) = delete;
    ...
    void WillBeginMainFrame() override
    {
        ...
        EXPECT_EQ(ProxyMain::NO_PIPELINE_STAGE, GetProxyMain()->max_requested_pipeline_stage());
        EXPECT_EQ(ProxyMain::COMMIT_PIPELINE_STAGE, GetProxyMain()->final_pipeline_stage());
    }
...
class LayerTreeHostProxyTestCommitWaitsForActivation : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestCommitWaitsForActivation() = default;
    LayerTreeHostProxyTestCommitWaitsForActivation(const LayerTreeHostProxyTestCommitWaitsForActivation&) = delete;

    LayerTreeHostProxyTestCommitWaitsForActivation& operator=(const LayerTreeHostProxyTestCommitWaitsForActivation&) = delete;
    ...
    void BeginCommitOnThread(LayerTreeHostImpl* impl) override
    {
        ...
        case 1: {
            ...
            auto unblock = base::BindOnce(&LayerTreeHostProxyTestCommitWaitsForActivation::UnblockActivation, base::Unretained(this), impl);
...
class LayerTreeHostProxyTestCommitWaitsForActivationMFBA : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestCommitWaitsForActivationMFBA() = default;
    LayerTreeHostProxyTestCommitWaitsForActivationMFBA(const LayerTreeHostProxyTestCommitWaitsForActivationMFBA&) = delete;

    LayerTreeHostProxyTestCommitWaitsForActivationMFBA& operator=(const LayerTreeHostProxyTestCommitWaitsForActivationMFBA&) = delete;
    ...
    {
        LayerTreeImpl* sync_tree = impl->pending_tree() ? impl->pending_tree() : impl->active_tree();
        ...
        case 0: {
            ...
            auto unblock = base::BindOnce(&LayerTreeHostImpl::BlockNotifyReadyToActivateForTesting, base::Unretained(impl), false, true);
    ...
    void DidActivateTreeOnThread(LayerTreeHostImpl* impl) override
    {
        if (impl->active_tree()->source_frame_number() == 0) {
            ...
            auto unblock = base::BindOnce(&LayerTreeHostProxyTestCommitWaitsForActivationMFBA::UnblockActivation, base::Unretained(this), impl);
            ImplThreadTaskRunner()->PostDelayedTask(FROM_HERE, std::move(unblock), base::Milliseconds(16 * 4));
        }
    }
...
class LayerTreeHostProxyTestImplFrameCausesAnimatePending : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestImplFrameCausesAnimatePending() = default;
    LayerTreeHostProxyTestImplFrameCausesAnimatePending(const LayerTreeHostProxyTestImplFrameCausesAnimatePending&) = delete;
    LayerTreeHostProxyTestImplFrameCausesAnimatePending& operator=(const LayerTreeHostProxyTestImplFrameCausesAnimatePending&) = delete;
...
// from the impl-side.
class LayerTreeHostProxyTestNeedsCommitFromImpl : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestNeedsCommitFromImpl() = default;
    LayerTreeHostProxyTestNeedsCommitFromImpl(const LayerTreeHostProxyTestNeedsCommitFromImpl&) = delete;
    LayerTreeHostProxyTestNeedsCommitFromImpl& operator=(const LayerTreeHostProxyTestNeedsCommitFromImpl&) = delete;
    ...
    void CommitCompleteOnThread(LayerTreeHostImpl* host_impl) override
    {
        ...
        case 0: {
            ...
            MainThreadTaskRunner()->PostTask(
                FROM_HERE, base::BindOnce(&LayerTreeHostProxyTestNeedsCommitFromImpl::CheckCommitRequested, base::Unretained(this)));
            break;
        }
        case 1: {
            MainThreadTaskRunner()->PostTask(
                FROM_HERE, base::BindOnce(&LayerTreeHostProxyTestNeedsCommitFromImpl::CheckRequestClearedAndEnd, base::Unretained(this)));
            break;
        }
        default: {
            NOTREACHED();
    ...
    void CheckCommitRequested()
    {
        EXPECT_TRUE(proxy()->CommitRequested());
    }
...
class LayerTreeHostProxyTestDelayedCommitDueToVisibility : public LayerTreeHostProxyTest {
protected:
    LayerTreeHostProxyTestDelayedCommitDueToVisibility() = default;
    LayerTreeHostProxyTestDelayedCommitDueToVisibility(const LayerTreeHostProxyTestDelayedCommitDueToVisibility&) = delete;
    ~LayerTreeHostProxyTestDelayedCommitDueToVisibility() override = default;

    LayerTreeHostProxyTestDelayedCommitDueToVisibility& operator=(const LayerTreeHostProxyTestDelayedCommitDueToVisibility&) = delete;
    ...
    void BeginMainFrameAbortedOnThread(LayerTreeHostImpl*, CommitEarlyOutReason reason, bool /* did_sync_scroll_and_viewport */) override
    {
...
SINGLE_AND_MULTI_THREAD_TEST_F(LayerTreeHostProxyTestDelayedCommitDueToVisibility);
