...
public:
    ...
    {
        reporter_ = std::make_unique<perf_test::PerfResultReporter>("calc_draw_props_time", story_name);
...
public:
    ...
    void DrawLayersOnThread(LayerTreeHostImpl* host_impl) override
    {
        ...
        do {
            ...
            draw_property_utils::CalculateDrawProperties(host_impl->active_tree(), &render_surface_list);
            timer_.NextLap();
