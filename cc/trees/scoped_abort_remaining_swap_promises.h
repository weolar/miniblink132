...
public:
    explicit ScopedAbortRemainingSwapPromises(SwapPromiseManager* swap_promise_manager)
        : swap_promise_manager_(swap_promise_manager)
    {
    }
    ScopedAbortRemainingSwapPromises(const ScopedAbortRemainingSwapPromises&) = delete;
    ...
    ScopedAbortRemainingSwapPromises& operator=(const ScopedAbortRemainingSwapPromises&) = delete;
