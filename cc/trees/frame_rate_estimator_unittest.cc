...
public:
    ...
    void SetUp() override
    {
        scoped_feature_list_.InitWithFeatures(
            /* enabled_features*/ { features::kThrottleFrameRateOnManyDidNotProduceFrame },
            /* disabled_features*/ {});
...
{
    EXPECT_EQ(estimator_->GetPreferredInterval(), viz::BeginFrameArgs::MinInterval());
    estimator_->SetVideoConferenceMode(true);
    EXPECT_NE(estimator_->GetPreferredInterval(), viz::BeginFrameArgs::MinInterval());
...
TEST_F(FrameRateEstimatorTest, RafAtHalfFps)
{
    ...
    const base::TimeDelta kIntervals[] = { base::Microseconds(33425), base::Microseconds(33298), base::Microseconds(33396), base::Microseconds(33339),
        base::Microseconds(33431), base::Microseconds(33320), base::Microseconds(33364), base::Microseconds(33360) };
    const base::TimeDelta kIntervalForHalfFps = viz::BeginFrameArgs::DefaultInterval() * 2;
    base::TimeTicks time;
...
TEST_F(FrameRateEstimatorTest, ThrottleWhenManyDidNotProduceFrame)
{
    ...
    size_t consecutive_num = static_cast<size_t>(features::kNumDidNotProduceFrameBeforeThrottle.Get()) + 1;
