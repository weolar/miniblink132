...
std::vector<cc::PresentationTimeCallbackBuffer::Callback> GenerateCallbacks(int num_callbacks)
{
...
std::vector<cc::PresentationTimeCallbackBuffer::SuccessfulCallback> GenerateSuccessfulCallbacks(int num_callbacks)
{
...
std::vector<cc::PresentationTimeCallbackBuffer::SuccessfulCallbackWithDetails> GenerateSuccessfulCallbackWithDetails(int num_callbacks)
{
    std::vector<cc::PresentationTimeCallbackBuffer::SuccessfulCallbackWithDetails> result;
...
TEST(PresentationTimeCallbackBufferTest, TestNoCallbacks)
{
    ...
    auto result = buffer.PopPendingCallbacks(kFrameToken1, /*presentation_failed=*/false);
...
TEST(PresentationTimeCallbackBufferTest, TestMainThreadCallbackOnSuccess)
{
    ...
    {
        auto result = buffer.PopPendingCallbacks(kFrameToken2, /*presentation_failed=*/false);
...
TEST(PresentationTimeCallbackBufferTest, TestMainThreadCallbackOnFailure)
{
    ...
    {
        auto result = buffer.PopPendingCallbacks(kFrameToken2, /*presentation_failed=*/true);
        EXPECT_EQ(result.main_callbacks.size(), 1ull);
        EXPECT_TRUE(result.main_successful_callbacks.empty());
        EXPECT_TRUE(result.compositor_successful_callbacks.empty());
    }
...
TEST(PresentationTimeCallbackBufferTest, TestMainThreadSuccessfulCallback)
{
    ...
    buffer.RegisterMainThreadSuccessfulCallbacks(kFrameToken2, GenerateSuccessfulCallbackWithDetails(1));
...
TEST(PresentationTimeCallbackBufferTest, TestCompositorThreadSuccessfulCallback)
{
    PresentationTimeCallbackBuffer buffer;

    buffer.RegisterCompositorThreadSuccessfulCallbacks(kFrameToken2, GenerateSuccessfulCallbacks(1));
...
TEST(PresentationTimeCallbackBufferTest, TestCallbackBatching)
{
    ...
    {
        auto result = buffer.PopPendingCallbacks(kFrameToken3, /*presentation_failed=*/false);
