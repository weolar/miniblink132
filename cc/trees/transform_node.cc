...
void TransformNode::AsValueInto(base::trace_event::TracedValue* value) const
{
    ...
    value->SetBoolean("flattens_inherited_transform", flattens_inherited_transform);
...
TransformCachedNodeData::TransformCachedNodeData(const TransformCachedNodeData& other) = default;
TransformCachedNodeData::~TransformCachedNodeData() = default;
bool TransformCachedNodeData::operator==(const TransformCachedNodeData& other) const = default;
