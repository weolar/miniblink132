...
public:
    ...
    RenderFrameMetadataObserver& operator=(const RenderFrameMetadataObserver&) = delete;
    ...
    virtual void OnRenderFrameSubmission(
        const RenderFrameMetadata& render_frame_metadata, viz::CompositorFrameMetadata* compositor_frame_metadata, bool force_send)
        = 0;
