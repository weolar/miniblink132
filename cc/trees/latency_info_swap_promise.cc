...
SwapPromise::DidNotSwapAction LatencyInfoSwapPromise::DidNotSwap(DidNotSwapReason reason, base::TimeTicks ts)
{
    latency_.Terminate();
...
//         ui::LatencyInfo::FillTraceEvent(ctx, trace_id, perfetto::protos::pbzero::ChromeLatencyInfo2::Step::STEP_HANDLE_INPUT_EVENT_MAIN_COMMIT);
//     });
}
