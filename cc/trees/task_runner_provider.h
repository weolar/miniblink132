...
public:
    ...
    {
        return base::WrapUnique(new TaskRunnerProvider(main_task_runner, impl_task_runner));
    }

    static std::unique_ptr<TaskRunnerProvider> CreateForDisplayTree(scoped_refptr<base::SingleThreadTaskRunner> task_runner)
    {
...
protected:
    TaskRunnerProvider(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner, scoped_refptr<base::SingleThreadTaskRunner> impl_task_runner);
...
public:
    explicit DebugScopedSetMainThreadBlocked(TaskRunnerProvider* task_runner_provider)
        : task_runner_provider_(task_runner_provider)
    {
        DCHECK(!task_runner_provider_->IsMainThreadBlocked());
        task_runner_provider_->SetMainThreadBlocked(true);
    }
    DebugScopedSetMainThreadBlocked(const DebugScopedSetMainThreadBlocked&) = delete;
    ...
    DebugScopedSetMainThreadBlocked& operator=(const DebugScopedSetMainThreadBlocked&) = delete;
