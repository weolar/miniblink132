...
public:
    ...
    // switches to false.
    virtual void OnDeferCommitsChanged(bool defer_status, PaintHoldingReason reason, std::optional<PaintHoldingCommitTrigger> trigger) = 0;
    ...
    virtual void UpdateCompositorScrollState(const CompositorCommitData& commit_data) = 0;
    ...
    // impl thread.
    virtual void DidCommit(int source_frame_number, base::TimeTicks commit_start_time, base::TimeTicks commit_finish_time) = 0;
    ...
    virtual void DidPresentCompositorFrame(uint32_t frame_token, const viz::FrameTimingDetails& frame_timing_details) = 0;
    ...
    virtual void RecordEndOfFrameMetrics(base::TimeTicks frame_begin_time, ActiveFrameSequenceTrackers trackers) = 0;
    ...
    virtual void RunPaintBenchmark(int repeat_count, PaintBenchmarkResult& result)
    {
    }
