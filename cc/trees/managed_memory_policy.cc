...
ManagedMemoryPolicy::ManagedMemoryPolicy(const gpu::MemoryAllocation& allocation)
...
ManagedMemoryPolicy::ManagedMemoryPolicy(
    size_t bytes_limit_when_visible, MemoryAllocation::PriorityCutoff priority_cutoff_when_visible, size_t num_resources_limit)
    : bytes_limit_when_visible(bytes_limit_when_visible)
...
// static
TileMemoryLimitPolicy ManagedMemoryPolicy::PriorityCutoffToTileMemoryLimitPolicy(gpu::MemoryAllocation::PriorityCutoff priority_cutoff)
{
