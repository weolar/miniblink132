...
struct CC_EXPORT ManagedMemoryPolicy {
    ...
    ManagedMemoryPolicy(size_t bytes_limit_when_visible, gpu::MemoryAllocation::PriorityCutoff priority_cutoff_when_visible, size_t num_resources_limit);
    ...
    static TileMemoryLimitPolicy PriorityCutoffToTileMemoryLimitPolicy(gpu::MemoryAllocation::PriorityCutoff priority_cutoff);
};
