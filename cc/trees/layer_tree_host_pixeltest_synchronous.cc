...
class LayerTreeHostSynchronousPixelTest : public LayerTreePixelTest, public ::testing::WithParamInterface<viz::RendererType> {
protected:
    ...
    void DoContentLayerTest()
    {
        ...
        RunSingleThreadedPixelTest(root, base::FilePath(FILE_PATH_LITERAL("green.png")));
    }
};

INSTANTIATE_TEST_SUITE_P(All, LayerTreeHostSynchronousPixelTest, ::testing::ValuesIn(viz::GetGpuRendererTypes()), ::testing::PrintToStringParamName());

// viz::GetGpuRendererTypes() can return an empty list on some platforms.
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(LayerTreeHostSynchronousPixelTest);
