...
protected:
    ...
    virtual void VerifyLayerImpls(LayerImpl* root, LayerImpl* child, LayerImpl* grand_child) = 0;
...
class LayerTreeHostCaptureTestNoExtraRenderPassWhenNotCapturing : public LayerTreeHostCaptureTest {
public:
    ...
    void VerifyLayerImpls(LayerImpl* root, LayerImpl* child, LayerImpl* grand_child) override
    {
...
SINGLE_AND_MULTI_THREAD_TEST_F(LayerTreeHostCaptureTestNoExtraRenderPassWhenNotCapturing);
...
class LayerTreeHostCaptureTestLayerWithCaptureIdElevatesToSurface : public LayerTreeHostCaptureTest {
public:
    void BeginTest() override
    {
        child_->SetSubtreeCaptureId(kCaptureId);
    }
...
SINGLE_AND_MULTI_THREAD_TEST_F(LayerTreeHostCaptureTestLayerWithCaptureIdElevatesToSurface);
