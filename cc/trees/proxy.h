...
public:
    ...
    virtual void SetLayerTreeFrameSink(LayerTreeFrameSink* layer_tree_frame_sink) = 0;
    ...
    virtual bool StartDeferringCommits(base::TimeDelta timeout, PaintHoldingReason reason) = 0;
    ...
    virtual void SetPaintWorkletLayerPainter(std::unique_ptr<PaintWorkletLayerPainter> painter) = 0;
    ...
    virtual void SetUkmSmoothnessDestination(base::WritableSharedMemoryMapping ukm_smoothness_data) = 0;

    virtual void SetRenderFrameObserver(std::unique_ptr<RenderFrameMetadataObserver> observer) = 0;

    virtual void CompositeImmediatelyForTest(base::TimeTicks frame_begin_time, bool raster, base::OnceClosure callback) = 0;
