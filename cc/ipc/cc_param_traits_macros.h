...
IPC_ENUM_TRAITS_MAX_VALUE(cc::OverscrollBehavior::Type, cc::OverscrollBehavior::Type::kMax)
...
IPC_ENUM_TRAITS_MAX_VALUE(cc::BrowserControlsState, cc::BrowserControlsState::kMaxValue)
