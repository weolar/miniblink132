...
template <typename T> struct Converter<gin::Handle<T>> {
    static v8::Local<v8::Value> ToV8(v8::Isolate* isolate, const gin::Handle<T>& val)
    {
        return val.ToV8();
    }
    static bool FromV8(v8::Isolate* isolate, v8::Local<v8::Value> val, gin::Handle<T>* out)
    {
        T* object = NULL;
...
template <typename T> gin::Handle<T> CreateHandle(v8::Isolate* isolate, T* object)
{
