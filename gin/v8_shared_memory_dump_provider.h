...
// process.
class GIN_EXPORT V8SharedMemoryDumpProvider : public base::trace_event::MemoryDumpProvider {
public:
    V8SharedMemoryDumpProvider();
    V8SharedMemoryDumpProvider(const V8SharedMemoryDumpProvider&) = delete;
    V8SharedMemoryDumpProvider& operator=(const V8SharedMemoryDumpProvider&) = delete;
