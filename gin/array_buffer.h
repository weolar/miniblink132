...
private:
    ...
    template <partition_alloc::AllocFlags flags> void* AllocateInternal(size_t length);
...
template <> struct GIN_EXPORT Converter<ArrayBuffer> {
    static bool FromV8(v8::Isolate* isolate, v8::Local<v8::Value> val, ArrayBuffer* out);
};
...
template <> struct GIN_EXPORT Converter<ArrayBufferView> {
    static bool FromV8(v8::Isolate* isolate, v8::Local<v8::Value> val, ArrayBufferView* out);
};
