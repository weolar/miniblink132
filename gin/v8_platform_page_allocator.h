...
public:
    ...
    void* AllocatePages(void* address, size_t length, size_t alignment, v8::PageAllocator::Permission permissions) override;
    ...
    ::partition_alloc::PageAccessibilityConfiguration::Permissions GetPageConfigPermissionsForTesting(v8::PageAllocator::Permission permission);
};
} // namespace gin
