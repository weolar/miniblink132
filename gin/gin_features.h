...
// documentation.
inline constexpr base::FeatureState kFeatureDefaultStateControlledByV8 = base::FEATURE_DISABLED_BY_DEFAULT;
...
GIN_EXPORT extern const base::FeatureParam<int> kV8ConcurrentSparkplugMaxThreads;
...
GIN_EXPORT BASE_DECLARE_FEATURE(kV8SingleThreadedGCInBackgroundNoIncrementalMarking);
GIN_EXPORT BASE_DECLARE_FEATURE(kV8EfficiencyModeTiering);
GIN_EXPORT extern const base::FeatureParam<int> kV8EfficiencyModeTieringDelayTurbofan;
