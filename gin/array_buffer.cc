...
{
    constexpr partition_alloc::AllocFlags flags = partition_alloc::AllocFlags::kZeroFill | partition_alloc::AllocFlags::kReturnNull;
    return AllocateInternal<flags>(length);
}

void* ArrayBufferAllocator::AllocateUninitialized(size_t length)
{
    constexpr partition_alloc::AllocFlags flags = partition_alloc::AllocFlags::kReturnNull;
    return AllocateInternal<flags>(length);
}

template <partition_alloc::AllocFlags flags> void* ArrayBufferAllocator::AllocateInternal(size_t length)
{
...
#endif
    return partition_->AllocInline<new_flags>(length, "gin::ArrayBufferAllocator");
}
...
void ArrayBufferAllocator::InitializePartition()
{
    ...
    static base::NoDestructor<partition_alloc::PartitionAllocator> partition_allocator(opts);
...
bool Converter<ArrayBuffer>::FromV8(v8::Isolate* isolate, v8::Local<v8::Value> val, ArrayBuffer* out)
{
...
ArrayBufferView::ArrayBufferView(v8::Isolate* isolate, v8::Local<v8::ArrayBufferView> view)
...
bool Converter<ArrayBufferView>::FromV8(v8::Isolate* isolate, v8::Local<v8::Value> val, ArrayBufferView* out)
{
...
public:
    std::optional<base::span<uint8_t>> Map(base::subtle::PlatformSharedMemoryHandle handle, bool write_allowed, uint64_t offset, size_t size) override
    {
...
#error "Unknown platform"
        ...
        v8::PagePermissions permissions = write_allowed ? v8::PagePermissions::kReadWrite : v8::PagePermissions::kRead;
        uintptr_t mapping = v8::V8::GetSandboxAddressSpace()->AllocateSharedPages(0, mapping_size, permissions, v8_handle, offset);
        if (!mapping)
            return std::nullopt;
    ...
    void Unmap(base::span<uint8_t> mapping) override
    {
        ...
        size_t mapping_size = base::bits::AlignUp(mapping.size(), allocation_granularity);
