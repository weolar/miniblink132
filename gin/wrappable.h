...
GIN_EXPORT void* FromV8Impl(v8::Isolate* isolate, v8::Local<v8::Value> val, WrapperInfo* info);
...
protected:
    ...
    v8::MaybeLocal<v8::Object> GetWrapperImpl(v8::Isolate* isolate, WrapperInfo* wrapper_info);
