...
public:
    ...
    virtual v8::Local<v8::ObjectTemplate> GetGlobalTemplate(ShellRunner* runner, v8::Isolate* isolate);
...
public:
    ...
    // Runner overrides:
    v8::MaybeLocal<v8::Value> Run(const std::string& source, const std::string& resource_name) override;
