...
typedef enum { MB_PROXY_NONE, MB_PROXY_HTTP, MB_PROXY_SOCKS4, MB_PROXY_SOCKS4A, MB_PROXY_SOCKS5, MB_PROXY_SOCKS5HOSTNAME } mbProxyType;

typedef struct _mbProxy {
    mbProxyType type;
    char hostname[100];
    unsigned short port;
    char username[50];
...
typedef BOOL (*mbCookieVisitor)(void* params, const char* name, const char* value, const char* domain,
...
typedef enum _mbNavigationType {
...
typedef enum _mbCursorInfoType {
...
typedef enum _mbJsType {
    ...
    kMbJsTypeNull = 7,
    kMbJsTypeV8Value = 8,
    kMbJsTypeFrame = 9, // 单独把dom的frame列出来，方便获取mbWebFrameHandle
} mbJsType;

typedef enum _mbImageFormat {
    kMbImageFormatPng = 0,
    kMbImageFormatJpg = 1,
    kMbImageFormatBmp = 2,
} mbImageFormat;
...
typedef void(MB_CALL_TYPE* mbAcceleratedPaintCallback)(
    mbWebView webView, void* param, int type, const mbRect* dirytRects, const size_t dirytRectsSize, void* sharedHandle);
...
typedef mbWebView(MB_CALL_TYPE* mbCreateViewCallback)(
...
typedef void(MB_CALL_TYPE* mbDidCreateScriptContextCallback)(
    mbWebView webView, void* param, mbWebFrameHandle frameId, void* context, int extensionGroup, int worldId);
...
typedef void(MB_CALL_TYPE* mbNodeOnCreateProcessCallback)(
    mbWebView webView, void* param, const WCHAR* applicationPath, const WCHAR* arguments, STARTUPINFOW* startup);

typedef enum { MB_LOADING_SUCCEEDED, MB_LOADING_FAILED, MB_LOADING_CANCELED } mbLoadingResult;

typedef void(MB_CALL_TYPE* mbLoadingFinishCallback)(
...
typedef void(MB_CALL_TYPE* mbConsoleCallback)(
    mbWebView webView, void* param, mbConsoleLevel level, const utf8* message, const utf8* sourceName, unsigned sourceLine, const utf8* stackTrace);
...
typedef void(MB_CALL_TYPE* mbOnUrlRequestWillRedirectCallback)(
...
typedef struct _mbDownloadBind {
    ...
    mbNetBeginSaveCallback beginSaveCallback;
} mbDownloadBind;
...
typedef enum _mbDialogProperties {
    ...
    kMbDialogPropertiesPromptToCreate
...
typedef mbDownloadOpt(MB_CALL_TYPE* mbDownloadInBlinkThreadCallback)(mbWebView webView, void* param, size_t expectedContentLength, const char* url,
...
//mbwindow-----------------------------------------------------------------------------------
typedef enum _mbWindowType { MB_WINDOW_TYPE_POPUP, MB_WINDOW_TYPE_TRANSPARENT, MB_WINDOW_TYPE_CONTROL } mbWindowType;
...
#define MB_DECLARE_ITERATOR0(returnVal, name, description) MB_EXTERN_C MB_DLLEXPORT returnVal MB_CALL_TYPE name();

#define MB_DECLARE_ITERATOR1(returnVal, name, p1, description) MB_EXTERN_C MB_DLLEXPORT returnVal MB_CALL_TYPE name(p1);

#define MB_DECLARE_ITERATOR2(returnVal, name, p1, p2, description) MB_EXTERN_C MB_DLLEXPORT returnVal MB_CALL_TYPE name(p1, p2);

#define MB_DECLARE_ITERATOR3(returnVal, name, p1, p2, p3, description) MB_EXTERN_C MB_DLLEXPORT returnVal MB_CALL_TYPE name(p1, p2, p3);

#define MB_DECLARE_ITERATOR4(returnVal, name, p1, p2, p3, p4, description) MB_EXTERN_C MB_DLLEXPORT returnVal MB_CALL_TYPE name(p1, p2, p3, p4);

#define MB_DECLARE_ITERATOR5(returnVal, name, p1, p2, p3, p4, p5, description) MB_EXTERN_C MB_DLLEXPORT returnVal MB_CALL_TYPE name(p1, p2, p3, p4, p5);

#define MB_DECLARE_ITERATOR6(returnVal, name, p1, p2, p3, p4, p5, p6, description) MB_EXTERN_C MB_DLLEXPORT returnVal MB_CALL_TYPE name(p1, p2, p3, p4, p5, p6);
...
#define MB_GET_PTR_ITERATOR0(returnVal, name, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR1(returnVal, name, p1, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR2(returnVal, name, p1, p2, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR3(returnVal, name, p1, p2, p3, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR4(returnVal, name, p1, p2, p3, p4, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR5(returnVal, name, p1, p2, p3, p4, p5, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR6(returnVal, name, p1, p2, p3, p4, p5, p6, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR7(returnVal, name, p1, p2, p3, p4, p5, p6, p7, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR8(returnVal, name, p1, p2, p3, p4, p5, p6, p7, p8, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR9(returnVal, name, p1, p2, p3, p4, p5, p6, p7, p8, p9, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR10(returnVal, name, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, description) MB_GET_PTR_ITERATOR(name);

#define MB_GET_PTR_ITERATOR11(returnVal, name, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, description) MB_GET_PTR_ITERATOR(name);

// 以下是mb的导出函数。格式按照【返回类型】【函数名】【参数】来排列
#define MB_FOR_EACH_DEFINE_FUNCTION(                                                                                                                           \
    ...
    ITERATOR7(mbWebView, mbCreateWebViewBindGtkWindow, void* rootWindow, void* drawingArea, const char* type, DWORD style, DWORD styleEx, int width,           \
    ...
    ITERATOR7(mbWebView, mbCreateWebWindowEx, mbWindowType type, HWND parent, int x, int y, int width, int height, const mbViewSettings* settings, "")         \
    ...
    ITERATOR1(BOOL, mbIsAudioMuted, mbWebView webview, "")                                                                                                     \
                                                                                                                                                               \
    ITERATOR2(mbStringPtr, mbCreateString, const utf8* str, size_t length, "不拷贝字符串，只引用")                                                             \
    ITERATOR2(mbStringPtr, mbCreateStringWithCopy, const utf8* str, size_t length, "拷贝字符串")                                                               \
    ...
    ITERATOR3(void, mbSetDebugConfig, mbWebView webView, const char* debugString, const char* param, "")                                                       \
                                                                                                                                                               \
    ITERATOR3(void, mbNetSetData, mbNetJob jobPtr, void* buf, int len,                                                                                         \
    ...
    ITERATOR3(void, mbSetCookie, mbWebView webView, const utf8* url, const utf8* cookie,                                                                       \
    ...
    ITERATOR2(void, mbSetResourceGc, mbWebView webView, int intervalSec, "")                                                                                   \
                                                                                                                                                               \
    ITERATOR1(BOOL, mbIsLoading, mbWebView webView, "")                                                                                                        \
    ITERATOR2(BOOL, mbCanGoBackOrForward, mbWebView webView, BOOL isGoBack, "")                                                                                \
    ...
    ITERATOR2(BOOL, mbGetWindowRect, mbWebView webview, mbRect* rc, "")                                                                                        \
                                                                                                                                                               \
    ...
    ITERATOR1(void, mbKillFocus, mbWebView webView, "")                                                                                                        \
                                                                                                                                                               \
    ITERATOR2(void, mbShowWindow, mbWebView webview, int show, "")                                                                                             \
                                                                                                                                                               \
    ...
    ITERATOR2(mbWebFrameHandle, mbJsToWebFrameHandle, mbJsExecState es, mbJsValue v, "")                                                                       \
    ITERATOR2(mbWebFrameHandle, mbGetParentWebFrameHandle, mbWebView webView, mbWebFrameHandle frame, "")                                                      \
    ITERATOR2(mbJsType, mbGetJsValueType, mbJsExecState es, mbJsValue v, "")                                                                                   \
    ITERATOR2(void, mbJsValueAddRef, mbJsExecState es, mbJsValue v, "")                                                                                        \
    ITERATOR2(void, mbJsValueDeref, mbJsExecState es, mbJsValue v, "")                                                                                         \
    ITERATOR3(void, mbOnJsQuery, mbWebView webView, mbJsQueryCallback callback, void* param, "")                                                               \
    ITERATOR3(void, mbOnJsQueryEx, mbWebView webView, mbJsQueryExCallback callback, void* param, "")                                                           \
    ITERATOR4(void, mbResponseQuery, mbWebView webView, int64_t queryId, int customMsg, const utf8* response, "")                                              \
    ITERATOR7(void, mbRunJs, mbWebView webView, mbWebFrameHandle frameId, const utf8* script, BOOL isInClosure, mbRunJsCallback callback, void* param,         \
        void* unuse, "")                                                                                                                                       \
    ...
    ITERATOR2(mbMemBuf*, mbGetWindowScreenshotSync, mbWebView webView, mbImageFormat format, "")                                                               \
    ITERATOR1(mbStringPtr, mbGetSourceSync, mbWebView webView, "")                                                                                             \
    ...
    ITERATOR1(const utf8*, mbUtilBase64Encode, const utf8* str, "对字符串进行base64")                                                                          \
    ITERATOR2(mbMemBuf*, mbUtilBase64EncodeBuffer, const void* str, int len, "对二进制数据进行basee64")                                                        \
    ...
    ITERATOR5(void, mbUtilPrintToPdf, mbWebView webView, mbWebFrameHandle frameId, const mbPrintSettings* settings, mbPrintPdfDataCallback callback,           \
        void* param, "")                                                                                                                                       \
    ITERATOR5(void, mbUtilPrintToBitmap, mbWebView webView, mbWebFrameHandle frameId, const mbScreenshotSettings* settings, mbPrintBitmapCallback callback,    \
        void* param, "")                                                                                                                                       \
    ...
    ITERATOR10(mbDownloadOpt, mbDownloadByPath, mbWebView webView, const mbDownloadOptions* downloadOptions, const WCHAR* path, size_t expectedContentLength,  \
        const char* url, const char* mime, const char* disposition, mbNetJob job, mbNetJobDataBind* dataBind, mbDownloadBind* callbackBind, "")                \
    ITERATOR10(mbDownloadOpt, mbDownloadByUtf8Path, mbWebView webView, const mbDownloadOptions* downloadOptions, const char* path,                             \
...
MB_FOR_EACH_DEFINE_FUNCTION(MB_DECLARE_ITERATOR0, MB_DECLARE_ITERATOR1, MB_DECLARE_ITERATOR2, MB_DECLARE_ITERATOR3, MB_DECLARE_ITERATOR4, MB_DECLARE_ITERATOR5,
    MB_DECLARE_ITERATOR6, MB_DECLARE_ITERATOR7, MB_DECLARE_ITERATOR8, MB_DECLARE_ITERATOR9, MB_DECLARE_ITERATOR10, MB_DECLARE_ITERATOR11)

#else // ENABLE_MB

#if 1 // MB_IN_EXE_H == 1 || !defined(__clang__)
// 如果在linux exp文件或者win exe里
MB_FOR_EACH_DEFINE_FUNCTION(MB_DEFINE_ITERATOR0, MB_DEFINE_ITERATOR1, MB_DEFINE_ITERATOR2, MB_DEFINE_ITERATOR3, MB_DEFINE_ITERATOR4, MB_DEFINE_ITERATOR5,
    MB_DEFINE_ITERATOR6, MB_DEFINE_ITERATOR7, MB_DEFINE_ITERATOR8, MB_DEFINE_ITERATOR9, MB_DEFINE_ITERATOR10, MB_DEFINE_ITERATOR11)
#else
// 如果在linux 非exp文件
MB_FOR_EACH_DEFINE_FUNCTION(MB_DECLARE_H_ITERATOR0, MB_DECLARE_H_ITERATOR1, MB_DECLARE_H_ITERATOR2, MB_DECLARE_H_ITERATOR3, MB_DECLARE_H_ITERATOR4,
    MB_DECLARE_H_ITERATOR5, MB_DECLARE_H_ITERATOR6, MB_DECLARE_H_ITERATOR7, MB_DECLARE_H_ITERATOR8, MB_DECLARE_H_ITERATOR9, MB_DECLARE_H_ITERATOR10,
    MB_DECLARE_H_ITERATOR11)
#endif // MB_IN_EXE_H
...
#if defined(WIN32)
#ifdef _WIN64
MB_SELECTANY const WCHAR* kMbMainDllPath = L"mb108_x64.dll";
#else
MB_SELECTANY const WCHAR* kMbMainDllPath = L"mb108_x32.dll";
#endif
...
inline void mbFillFuncPtr()
{
    ...
    if (!mbCreateWebView) {
        MB_FOR_EACH_DEFINE_FUNCTION(MB_GET_PTR_ITERATOR0, MB_GET_PTR_ITERATOR1, MB_GET_PTR_ITERATOR2, MB_GET_PTR_ITERATOR3, MB_GET_PTR_ITERATOR4,
            MB_GET_PTR_ITERATOR5, MB_GET_PTR_ITERATOR6, MB_GET_PTR_ITERATOR7, MB_GET_PTR_ITERATOR8, MB_GET_PTR_ITERATOR9, MB_GET_PTR_ITERATOR10,
            MB_GET_PTR_ITERATOR11);
    }
}
