...
#ifndef mbvip_common_CallbackClosure_h
...
//     }
    ...
    void setNavigationCallback(mbNavigationCallback callback, void* param)
    {
    ...
    void setNavigationSyncCallback(mbNavigationCallback callback, void* param)
    {
    ...
    void setDocumentReadyInBlinkCallback(mbDocumentReadyCallback callback, void* param)
    {
    ...
    void setDocumentReadyCallback(mbDocumentReadyCallback callback, void* param)
    {
    ...
    void setLoadUrlBeginCallback(mbLoadUrlBeginCallback callback, void* param)
    {
    ...
    void setLoadUrlEndCallback(mbLoadUrlEndCallback callback, void* param)
    {
    ...
    void setTitleChangedCallback(mbTitleChangedCallback callback, void* param)
    {
    ...
    void setMouseOverUrlChangedCallback(mbMouseOverUrlChangedCallback callback, void* param)
    {
    ...
    void setURLChangedCallback(mbURLChangedCallback callback, void* param)
    {
    ...
    void setLoadingFinishCallback(mbLoadingFinishCallback callback, void* param)
    {
        m_LoadingFinishCallback = callback;
        m_LoadingFinishParam = param;
    };
    ...
    void setPaintBitUpdatedCallback(mbPaintBitUpdatedCallback callback, void* param)
    {
    ...
    void setCreateViewCallback(mbCreateViewCallback callback, void* param)
    {
    ...
    void setDownloadCallback(mbDownloadCallback callback, void* param)
    {
    ...
    void setDownloadInBlinkThreadCallback(mbDownloadInBlinkThreadCallback callback, void* param)
    {
    ...
    void setAlertBoxCallback(mbAlertBoxCallback callback, void* param)
    {
    ...
    void setConfirmBoxCallback(mbConfirmBoxCallback callback, void* param)
    {
    ...
    void setPromptBoxCallback(mbPromptBoxCallback callback, void* param)
    {
    ...
    void setConsoleCallback(mbConsoleCallback callback, void* param)
    {
    ...
    void setNetGetFaviconCallback(mbNetGetFaviconCallback callback, void* param)
    {
    ...
    void setCloseCallback(mbCloseCallback callback, void* param)
    {
    ...
    void setWillReleaseScriptContextCallback(mbWillReleaseScriptContextCallback callback, void* param)
    {
    ...
    void setImageBufferToDataURLCallback(mbImageBufferToDataURLCallback callback, void* param)
    {
    ...
    void setNetResponseCallback(mbNetResponseCallback callback, void* param)
    {
    ...
    std::function<void(mbJsExecState es, const mbJsValue* val, int count)>* m_jsQueryClosure2 { nullptr };
    void setJsQuery2Closure(std::function<void(mbJsExecState es, const mbJsValue* val, int count)>* closure)
    {
