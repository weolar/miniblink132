...
// static
proxy_resolver_win::mojom::WinHttpStatus EnumTraits<proxy_resolver_win::mojom::WinHttpStatus, net::WinHttpStatus>::ToMojom(net::WinHttpStatus input)
{
    switch (input) {
    ...
    case net::WinHttpStatus::kWinHttpSetTimeoutsFailed:
        return proxy_resolver_win::mojom::WinHttpStatus::kWinHttpSetTimeoutsFailed;
    case net::WinHttpStatus::kWinHttpSetStatusCallbackFailed:
        return proxy_resolver_win::mojom::WinHttpStatus::kWinHttpSetStatusCallbackFailed;
    case net::WinHttpStatus::kWinHttpGetIEProxyConfigForCurrentUserFailed:
        return proxy_resolver_win::mojom::WinHttpStatus::kWinHttpGetIEProxyConfigForCurrentUserFailed;
    case net::WinHttpStatus::kWinHttpCreateProxyResolverFailed:
        return proxy_resolver_win::mojom::WinHttpStatus::kWinHttpCreateProxyResolverFailed;
    case net::WinHttpStatus::kWinHttpGetProxyForURLExFailed:
        return proxy_resolver_win::mojom::WinHttpStatus::kWinHttpGetProxyForURLExFailed;
    ...
    case net::WinHttpStatus::kWinHttpGetProxyResultFailed:
        return proxy_resolver_win::mojom::WinHttpStatus::kWinHttpGetProxyResultFailed;
...
// static
bool EnumTraits<proxy_resolver_win::mojom::WinHttpStatus, net::WinHttpStatus>::FromMojom(
    proxy_resolver_win::mojom::WinHttpStatus input, net::WinHttpStatus* output)
{
    switch (input) {
    ...
    case proxy_resolver_win::mojom::WinHttpStatus::kWinHttpSetTimeoutsFailed:
        *output = net::WinHttpStatus::kWinHttpSetTimeoutsFailed;
        return true;
    case proxy_resolver_win::mojom::WinHttpStatus::kWinHttpSetStatusCallbackFailed:
        *output = net::WinHttpStatus::kWinHttpSetStatusCallbackFailed;
        return true;
    case proxy_resolver_win::mojom::WinHttpStatus::kWinHttpGetIEProxyConfigForCurrentUserFailed:
        *output = net::WinHttpStatus::kWinHttpGetIEProxyConfigForCurrentUserFailed;
        return true;
    case proxy_resolver_win::mojom::WinHttpStatus::kWinHttpCreateProxyResolverFailed:
        *output = net::WinHttpStatus::kWinHttpCreateProxyResolverFailed;
        return true;
    case proxy_resolver_win::mojom::WinHttpStatus::kWinHttpGetProxyForURLExFailed:
