...
template <> struct EnumTraits<proxy_resolver_win::mojom::WinHttpStatus, net::WinHttpStatus> {
    static proxy_resolver_win::mojom::WinHttpStatus ToMojom(net::WinHttpStatus input);

    static bool FromMojom(proxy_resolver_win::mojom::WinHttpStatus input, net::WinHttpStatus* output);
};
