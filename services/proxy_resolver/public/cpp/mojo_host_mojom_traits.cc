...
// static
proxy_resolver::mojom::HostResolveOperation EnumTraits<proxy_resolver::mojom::HostResolveOperation, net::ProxyResolveDnsOperation>::ToMojom(
...
// static
bool EnumTraits<proxy_resolver::mojom::HostResolveOperation, net::ProxyResolveDnsOperation>::FromMojom(
    proxy_resolver::mojom::HostResolveOperation input, net::ProxyResolveDnsOperation* output)
{
    switch (input) {
