...
proxy_resolver::mojom::ProxyScheme EnumTraits<proxy_resolver::mojom::ProxyScheme, net::ProxyServer::Scheme>::ToMojom(net::ProxyServer::Scheme scheme)
{
...
bool EnumTraits<proxy_resolver::mojom::ProxyScheme, net::ProxyServer::Scheme>::FromMojom(
    proxy_resolver::mojom::ProxyScheme scheme, net::ProxyServer::Scheme* out)
{
    using net::ProxyServer;
    switch (scheme) {
...
base::StringPiece StructTraits<proxy_resolver::mojom::ProxyServerDataView, net::ProxyServer>::host(const net::ProxyServer& s)
{
    if (s.scheme() == net::ProxyServer::SCHEME_DIRECT || s.scheme() == net::ProxyServer::SCHEME_INVALID) {
        return base::StringPiece();
    }
    return s.host_port_pair().host();
}

uint16_t StructTraits<proxy_resolver::mojom::ProxyServerDataView, net::ProxyServer>::port(const net::ProxyServer& s)
{
    if (s.scheme() == net::ProxyServer::SCHEME_DIRECT || s.scheme() == net::ProxyServer::SCHEME_INVALID) {
        return 0;
    }
...
bool StructTraits<proxy_resolver::mojom::ProxyServerDataView, net::ProxyServer>::Read(proxy_resolver::mojom::ProxyServerDataView data, net::ProxyServer* out)
{
    ...
    if ((scheme == net::ProxyServer::SCHEME_DIRECT || scheme == net::ProxyServer::SCHEME_INVALID) && (!host.empty() || data.port())) {
        return false;
    }

    *out = net::ProxyServer(scheme, net::HostPortPair(std::string(host), data.port()));
    return true;
}

bool StructTraits<proxy_resolver::mojom::ProxyInfoDataView, net::ProxyInfo>::Read(proxy_resolver::mojom::ProxyInfoDataView data, net::ProxyInfo* out)
{
