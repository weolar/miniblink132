...
public:
    ...
    MojoProxyResolverV8TracingBindingsTest(const MojoProxyResolverV8TracingBindingsTest&) = delete;
    MojoProxyResolverV8TracingBindingsTest& operator=(const MojoProxyResolverV8TracingBindingsTest&) = delete;
...
protected:
    MojoProxyResolverV8TracingBindings<MojoProxyResolverV8TracingBindingsTest> bindings_ { this };
