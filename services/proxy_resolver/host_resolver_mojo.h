...
public:
    ...
    public:
        ...
        virtual void ResolveDns(const std::string& hostname, net::ProxyResolveDnsOperation operation,
...
private:
    ...
    base::WeakPtrFactory<ProxyHostResolverCache> host_cache_weak_factory_ { &host_cache_ };
