...
std::unique_ptr<ProxyResolverV8Tracing> CreateResolver(std::unique_ptr<ProxyResolverV8Tracing::Bindings> bindings, const char* filename)
{
    std::unique_ptr<ProxyResolverV8Tracing> resolver;
    std::unique_ptr<ProxyResolverV8TracingFactory> factory(ProxyResolverV8TracingFactory::Create());
    net::TestCompletionCallback callback;
    std::unique_ptr<net::ProxyResolverFactory::Request> request;
    factory->CreateProxyResolverV8Tracing(LoadScriptData(filename), std::move(bindings), &resolver, callback.callback(), &request);
...
TEST_F(ProxyResolverV8TracingTest, Simple)
{
    ...
    resolver->GetProxyForURL(GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info, callback.callback(), &req, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, JavascriptError)
{
    ...
    resolver->GetProxyForURL(
        GURL("http://throw-an-error/"), net::NetworkAnonymizationKey(), &proxy_info, callback.callback(), &req, mock_bindings.CreateBindings());
    ...
    EXPECT_EQ("Uncaught TypeError: Cannot read properties of null (reading 'split')", mock_bindings.GetErrors()[0].second);
}
...
TEST_F(ProxyResolverV8TracingTest, TooManyEmptyAlerts)
{
    ...
    std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "too_many_empty_alerts.js");
...
TEST_F(ProxyResolverV8TracingTest, Dns)
{
    ...
    host_resolver.SetResult(
        net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS, net::NetworkAnonymizationKey(), { net::IPAddress(122, 133, 144, 155) });
    host_resolver.SetResult(
        net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS_EX, net::NetworkAnonymizationKey(), { net::IPAddress(133, 122, 100, 200) });
    host_resolver.SetError("", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey());
    host_resolver.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 44) });
    net::IPAddress v6_local;
    ASSERT_TRUE(v6_local.AssignFromIPLiteral("::1"));
    host_resolver.SetResult(
        "host1", net::ProxyResolveDnsOperation::DNS_RESOLVE_EX, net::NetworkAnonymizationKey(), { v6_local, net::IPAddress(192, 168, 1, 1) });
    host_resolver.SetError("host2", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey());
    host_resolver.SetResult("host3", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 33) });
    host_resolver.SetError("host6", net::ProxyResolveDnsOperation::DNS_RESOLVE_EX, net::NetworkAnonymizationKey());
...
TEST_F(ProxyResolverV8TracingTest, FallBackToSynchronous1)
{
    ...
    host_resolver.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 11) });
    host_resolver.SetResult("crazy4", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(133, 199, 111, 4) });
    ...
    EXPECT_EQ("166.155.144.11-133.199.111.4.test:100", ProxyServerToProxyUri(proxy_info.proxy_server()));
...
TEST_F(ProxyResolverV8TracingTest, FallBackToSynchronous2)
{
    ...
    host_resolver.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 11) });
    host_resolver.SetResult("host2", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 22) });
    host_resolver.SetResult("host3", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 33) });
    host_resolver.SetResult("host4", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 44) });
    ...
    EXPECT_EQ("166.155.144.44.test:100", ProxyServerToProxyUri(proxy_info.proxy_server()));
...
TEST_F(ProxyResolverV8TracingTest, InfiniteDNSSequence)
{
    ...
    for (int i = 0; i < 21; ++i) {
        host_resolver.SetResult("host" + base::NumberToString(i), net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(),
    ...
    EXPECT_EQ("166.155.144.11-166.155.144.11-166.155.144.11-166.155.144.11-"
...
void DnsDuringInitHelper(bool synchronous_host_resolver)
{
    ...
    host_resolver.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(91, 13, 12, 1) });
    host_resolver.SetResult("host2", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(91, 13, 12, 2) });
    ...
    host_resolver.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(145, 88, 13, 3) });
    host_resolver.SetResult("host2", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(137, 89, 8, 45) });
    ...
    EXPECT_EQ("91.13.12.1-91.13.12.2-145.88.13.3-137.89.8.45.test:99", ProxyServerToProxyUri(proxy_info.proxy_server()));
...
TEST_F(ProxyResolverV8TracingTest, CancelAll)
{
    ...
    for (size_t i = 0; i < kNumRequests; ++i) {
        resolver->GetProxyForURL(
            GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info[i], base::BindOnce(&CrashCallback), &request[i], mock_bindings.CreateBindings());
    }
...
TEST_F(ProxyResolverV8TracingTest, CancelSome)
{
    ...
    resolver->GetProxyForURL(
        GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info1, base::BindOnce(&CrashCallback), &request1, mock_bindings.CreateBindings());
    resolver->GetProxyForURL(GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info2, callback.callback(), &request2, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, CancelWhilePendingCompletionTask)
{
    ...
    resolver->GetProxyForURL(GURL("http://throw-an-error/"), net::NetworkAnonymizationKey(), &proxy_info1, base::BindOnce(&CrashCallback), &request1,
    ...
    mock_bindings.RunOnError(base::BindOnce(&std::unique_ptr<net::ProxyResolver::Request>::reset, base::Unretained(&request1), nullptr));

    // Start another request, to make sure it is able to complete.
    resolver->GetProxyForURL(GURL("http://i-have-no-idea-what-im-doing/"), net::NetworkAnonymizationKey(), &proxy_info2, callback.callback(), &request2,
        mock_bindings.CreateBindings());

    EXPECT_THAT(callback.WaitForResult(), IsOk());

    EXPECT_EQ("i-approve-this-message:42", ProxyServerToProxyUri(proxy_info2.proxy_server()));
}
...
TEST_F(ProxyResolverV8TracingTest, CancelWhileOutstandingNonBlockingDns)
{
    ...
    resolver->GetProxyForURL(
        GURL("http://foo/req1"), net::NetworkAnonymizationKey(), &proxy_info1, base::BindOnce(&CrashCallback), &request1, mock_bindings.CreateBindings());
    ...
    resolver->GetProxyForURL(
        GURL("http://foo/req2"), net::NetworkAnonymizationKey(), &proxy_info2, base::BindOnce(&CrashCallback), &request2, mock_bindings.CreateBindings());
...
void CancelRequestAndPause(std::unique_ptr<net::ProxyResolver::Request>* request, base::RunLoop* run_loop)
{
    request->reset();
...
TEST_F(ProxyResolverV8TracingTest, CancelWhileBlockedInNonBlockingDns)
{
    ...
    host_resolver.set_hang_callback(base::BindRepeating(&CancelRequestAndPause, &request, &run_loop));

    resolver->GetProxyForURL(
        GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info, base::BindOnce(&CrashCallback), &request, mock_bindings.CreateBindings());
...
TEST_F(ProxyResolverV8TracingTest, CancelCreateResolverWhileOutstandingBlockingDns)
{
    base::RunLoop run_loop;
    ...
    factory->CreateProxyResolverV8Tracing(
        LoadScriptData("dns_during_init.js"), mock_bindings.CreateBindings(), &resolver, base::BindOnce(&CrashCallback), &request);
...
TEST_F(ProxyResolverV8TracingTest, ErrorLoadingScript)
{
    ...
    std::unique_ptr<net::ProxyResolverFactory::Request> request;
    net::TestCompletionCallback callback;
    factory->CreateProxyResolverV8Tracing(LoadScriptData("error_on_load.js"), mock_bindings.CreateBindings(), &resolver, callback.callback(), &request);
...
TEST_F(ProxyResolverV8TracingTest, Terminate)
{
    ...
    host_resolver.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(182, 111, 0, 222) });
    host_resolver.SetResult("host2", net::ProxyResolveDnsOperation::DNS_RESOLVE_EX, net::NetworkAnonymizationKey(), { net::IPAddress(111, 33, 44, 55) });
    ...
    std::unique_ptr<net::ProxyResolver::Request> req;
    resolver->GetProxyForURL(GURL("http://foopy/req1"), net::NetworkAnonymizationKey(), &proxy_info, callback.callback(), &req, mock_bindings.CreateBindings());
    EXPECT_THAT(callback.WaitForResult(), IsOk());
...
TEST_F(ProxyResolverV8TracingTest, MultipleResolvers)
{
    ...
    host_resolver0.SetResult(
        net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS_EX, net::NetworkAnonymizationKey(), { net::IPAddress(133, 122, 100, 200) });
    host_resolver0.SetError("", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey());
    host_resolver0.SetResult("host1", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 44) });
    net::IPAddress v6_local;
    ASSERT_TRUE(v6_local.AssignFromIPLiteral("::1"));
    host_resolver0.SetResult(
        "host1", net::ProxyResolveDnsOperation::DNS_RESOLVE_EX, net::NetworkAnonymizationKey(), { v6_local, net::IPAddress(192, 168, 1, 1) });
    host_resolver0.SetError("host2", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey());
    host_resolver0.SetResult("host3", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 33) });
    host_resolver0.SetError("host6", net::ProxyResolveDnsOperation::DNS_RESOLVE_EX, net::NetworkAnonymizationKey());
    ...
    host_resolver3.SetResult("foo", net::ProxyResolveDnsOperation::DNS_RESOLVE, net::NetworkAnonymizationKey(), { net::IPAddress(166, 155, 144, 33) });
    ...
    for (size_t i = 0; i < kNumResults; ++i) {
        ...
        resolver[resolver_i]->GetProxyForURL(GURL("http://foo/"), net::NetworkAnonymizationKey(), &proxy_info[i], callback[i].callback(), &request[i],
            resolver_i == 3 ? mock_bindings3.CreateBindings() : mock_bindings0.CreateBindings());
    }
    ...
    for (size_t i = 0; i < kNumResults; ++i) {
        ...
        if (resolver_i == 0 || resolver_i == 1) {
            ...
            EXPECT_EQ("166.155.144.33.test:", proxy_uri.substr(0, proxy_uri.find(':') + 1));
        } else {
            NOTREACHED();
        }
    }
...
{
    const net::SchemefulSite kSite1 = net::SchemefulSite(GURL("https://foo.test/"));
    const net::NetworkAnonymizationKey kNetworkAnonymizationKey1(kSite1, kSite1);
    const net::IPAddress kIPAddress1(1, 2, 3, 4);

    const net::SchemefulSite kSite2 = net::SchemefulSite(GURL("https://bar.test/"));
    ...
    host_resolver.SetResult(kHost, net::ProxyResolveDnsOperation::DNS_RESOLVE, kNetworkAnonymizationKey1, { kIPAddress1 });
    host_resolver.SetResult(kHost, net::ProxyResolveDnsOperation::DNS_RESOLVE, kNetworkAnonymizationKey2, { kIPAddress2 });
    ...
    std::unique_ptr<net::ProxyResolver::Request> req;
    net::ProxyInfo proxy_info1;
    resolver->GetProxyForURL(GURL("https://host.test/"), kNetworkAnonymizationKey1, &proxy_info1, callback.callback(), &req, mock_bindings.CreateBindings());
    EXPECT_THAT(callback.WaitForResult(), IsOk());
    EXPECT_EQ(2u, host_resolver.num_resolve());
    EXPECT_EQ(kIPAddress1.ToString() + ".test", proxy_info1.proxy_server().host_port_pair().host());

    net::ProxyInfo proxy_info2;
    resolver->GetProxyForURL(GURL("https://host.test/"), kNetworkAnonymizationKey2, &proxy_info2, callback.callback(), &req, mock_bindings.CreateBindings());
    EXPECT_THAT(callback.WaitForResult(), IsOk());
    EXPECT_EQ(4u, host_resolver.num_resolve());
...
{
    const net::SchemefulSite kSite = net::SchemefulSite(GURL("https://foo.test/"));
    const net::NetworkAnonymizationKey kNetworkAnonymizationKey(kSite, kSite);

    MockProxyHostResolver host_resolver;
    MockBindings mock_bindings(&host_resolver);

    host_resolver.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS, net::NetworkAnonymizationKey(), { net::IPAddress(1, 2, 3, 4) });
    host_resolver.SetResult(
        net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS_EX, net::NetworkAnonymizationKey(), { net::IPAddress(5, 6, 7, 8) });

    host_resolver.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS, kNetworkAnonymizationKey, { net::IPAddress(9, 9, 9, 9) });
    host_resolver.SetResult(net::GetHostName(), net::ProxyResolveDnsOperation::MY_IP_ADDRESS_EX, kNetworkAnonymizationKey, { net::IPAddress(10, 10, 10, 10) });

    std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "my_ip_address.js");

    net::TestCompletionCallback callback;
    std::unique_ptr<net::ProxyResolver::Request> req;
    net::ProxyInfo proxy_info;
    resolver->GetProxyForURL(GURL("https://host.test/"), kNetworkAnonymizationKey, &proxy_info, callback.callback(), &req, mock_bindings.CreateBindings());
    EXPECT_THAT(callback.WaitForResult(), IsOk());
    EXPECT_EQ(2u, host_resolver.num_resolve());
