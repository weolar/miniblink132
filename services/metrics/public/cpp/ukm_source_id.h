...
public:
    ...
    constexpr SourceIdObj()
        : value_(kInvalidSourceId)
    {
    }
...
private:
    constexpr explicit SourceIdObj(int64_t value)
        : value_(value)
    {
    }
    int64_t value_;
...
// Utility for converting other unique ids to source ids.
METRICS_EXPORT SourceId ConvertToSourceId(int64_t other_id, SourceIdType id_type);
