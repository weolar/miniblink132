...
UkmEntryBuilder::UkmEntryBuilder(ukm::SourceId source_id, std::string_view event_name)
    : ukm::internal::UkmEntryBuilderBase(source_id, base::HashMetricName(event_name))
{
}
