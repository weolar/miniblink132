...
UkmEntryBuilderBase::UkmEntryBuilderBase(ukm::SourceId source_id, uint64_t event_hash)
...
UkmEntryBuilderBase::UkmEntryBuilderBase(ukm::SourceIdObj source_id, uint64_t event_hash)
//     : entry_(mojom::UkmEntry::New())
{
...
void UkmEntryBuilderBase::SetMetricInternal(uint64_t metric_hash, int64_t value)
{
