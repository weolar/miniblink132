...
MojoUkmRecorder::MojoUkmRecorder(mojo::PendingRemote<mojom::UkmRecorderInterface> interface)
...
void MojoUkmRecorder::UpdateAppURL(SourceId source_id, const GURL& url, const AppType app_type)
{
    NOTREACHED();
}

void MojoUkmRecorder::RecordNavigation(SourceId source_id, const UkmSource::NavigationData& navigation_data)
{
    NOTREACHED();
}
