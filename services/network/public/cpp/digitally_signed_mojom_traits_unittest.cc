...
{
    for (auto sig_alg : { net::ct::DigitallySigned::SIG_ALGO_ANONYMOUS, net::ct::DigitallySigned::SIG_ALGO_RSA, net::ct::DigitallySigned::SIG_ALGO_DSA,
             net::ct::DigitallySigned::SIG_ALGO_ECDSA }) {
        for (auto hash_alg : { net::ct::DigitallySigned::HASH_ALGO_NONE, net::ct::DigitallySigned::HASH_ALGO_MD5, net::ct::DigitallySigned::HASH_ALGO_SHA1,
                 net::ct::DigitallySigned::HASH_ALGO_SHA224, net::ct::DigitallySigned::HASH_ALGO_SHA256, net::ct::DigitallySigned::HASH_ALGO_SHA384,
            ...
            EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::DigitallySigned>(original, copied)) << "with hash " << hash_alg << " and sig " << sig_alg;
...
TEST(DigitallySignedTraitsTest, EmptySignatureRejected)
{
    ...
    net::ct::DigitallySigned copied;
    EXPECT_FALSE(mojo::test::SerializeAndDeserialize<mojom::DigitallySigned>(original, copied));
}

TEST(DigitallySignedTraitsTest, OutOfBoundsEnumsRejected)
{
    net::ct::DigitallySigned original;
    original.hash_algorithm = static_cast<net::ct::DigitallySigned::HashAlgorithm>(-1);
    original.signature_algorithm = net::ct::DigitallySigned::SIG_ALGO_ECDSA;
    original.signature_data.assign(32, '\x01');

    net::ct::DigitallySigned copied;
    EXPECT_NOTREACHED_DEATH(mojo::test::SerializeAndDeserialize<mojom::DigitallySigned>(original, copied));
}
