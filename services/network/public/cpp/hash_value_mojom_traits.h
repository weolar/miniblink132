...
template <> struct StructTraits<network::mojom::SHA256HashValueDataView, net::SHA256HashValue> {
    static base::span<const uint8_t, 32> data(const net::SHA256HashValue& value)
    {
        return value.data;
    }

    static bool Read(network::mojom::SHA256HashValueDataView in, net::SHA256HashValue* out);
};
