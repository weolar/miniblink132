...
BASE_FEATURE(kExpectCTReporting, "ExpectCTReporting", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kCORBProtectionSniffing, "CORBProtectionSniffing", base::FEATURE_ENABLED_BY_DEFAULT);
...
#define kDnsOverHttpsUpgradeValue base::FEATURE_ENABLED_BY_DEFAULT
#else
#define kDnsOverHttpsUpgradeValue base::FEATURE_DISABLED_BY_DEFAULT
#endif
// Enable usage of hardcoded DoH upgrade mapping for use in automatic mode.
BASE_FEATURE(kDnsOverHttpsUpgrade, "DnsOverHttpsUpgrade", kDnsOverHttpsUpgradeValue);
...
BASE_FEATURE(kOpaqueResponseBlockingV01, "OpaqueResponseBlockingV01", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kOpaqueResponseBlockingV02, "OpaqueResponseBlockingV02", base::FEATURE_DISABLED_BY_DEFAULT);
...
const base::FeatureParam<TrustTokenOriginTrialSpec> kTrustTokenOperationsRequiringOriginTrial { &kTrustTokens, "TrustTokenOperationsRequiringOriginTrial",
...
const base::FeatureParam<bool> kPlatformProvidedTrustTokenIssuance { &kTrustTokens, "PlatformProvidedTrustTokenIssuance", false };

BASE_FEATURE(kWebSocketReassembleShortMessages, "WebSocketReassembleShortMessages", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kSCTAuditingRetryReports, "SCTAuditingRetryReports", base::FEATURE_ENABLED_BY_DEFAULT);

BASE_FEATURE(kSCTAuditingPersistReports, "SCTAuditingPersistReports", base::FEATURE_DISABLED_BY_DEFAULT);
...
//static constexpr uint32_t network::features::kMaxNumConsumedBytesInTask = 1024 * 1024;
...
BASE_FEATURE(kURLLoaderSyncClient, "URLLoaderSyncClient", base::FEATURE_ENABLED_BY_DEFAULT);

// Don't wait for database write before responding to
// RestrictedCookieManager::SetCookieFromString.
BASE_FEATURE(kFasterSetCookie, "FasterSetCookie", base::FEATURE_ENABLED_BY_DEFAULT);

// Allow batching SimpleURLLoaders when the underlying network state is
// inactive.
BASE_FEATURE(kBatchSimpleURLLoader, "BatchSimpleURLLoader", base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kNetworkServiceMemoryCache, "NetworkServiceMemoryCache", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kCacheTransparency, "CacheTransparency", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kDisableResourceScheduler, "DisableResourceScheduler", base::FEATURE_DISABLED_BY_DEFAULT);

// Reduce PNA preflight response waiting time to 200ms.
// See: https://wicg.github.io/private-network-access/#cors-preflight
BASE_FEATURE(kPrivateNetworkAccessPreflightShortTimeout, "PrivateNetworkAccessPreflightReduceTimeout", base::FEATURE_ENABLED_BY_DEFAULT);

// Handle the Link header DNS prefetches and preconnects in the network
// service instead of through the renderer process.
BASE_FEATURE(kPreconnectInNetworkService, "PreconnectInNetworkService", base::FEATURE_DISABLED_BY_DEFAULT);

// Preconnect to a new origin right when a redirect starts.
BASE_FEATURE(kPreconnectOnRedirect, "PreconnectOnRedirect", base::FEATURE_DISABLED_BY_DEFAULT);
