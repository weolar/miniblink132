...
bool StructTraits<network::mojom::SiteForCookiesDataView, net::SiteForCookies>::Read(network::mojom::SiteForCookiesDataView data, net::SiteForCookies* out)
{
    ...
    bool result = net::SiteForCookies::FromWire(site, data.schemefully_same(), out);
    if (!result) {
...
network::mojom::CookieExemptionReason EnumTraits<network::mojom::CookieExemptionReason, net::CookieInclusionStatus::ExemptionReason>::ToMojom(
    net::CookieInclusionStatus::ExemptionReason input)
{
    ...
    case net::CookieInclusionStatus::ExemptionReason::kTopLevel3PCDDeprecationTrial:
        return network::mojom::CookieExemptionReason::kTopLevel3PCDDeprecationTrial;
...
bool EnumTraits<network::mojom::CookieExemptionReason, net::CookieInclusionStatus::ExemptionReason>::FromMojom(
    network::mojom::CookieExemptionReason input, net::CookieInclusionStatus::ExemptionReason* output)
{
    switch (input) {
    ...
    case network::mojom::CookieExemptionReason::k3PCDDeprecationTrial:
        *output = net::CookieInclusionStatus::ExemptionReason::k3PCDDeprecationTrial;
        return true;
    case network::mojom::CookieExemptionReason::kTopLevel3PCDDeprecationTrial:
        *output = net::CookieInclusionStatus::ExemptionReason::kTopLevel3PCDDeprecationTrial;
        return true;
    ...
    case network::mojom::CookieExemptionReason::kTopLevelStorageAccess:
        *output = net::CookieInclusionStatus::ExemptionReason::kTopLevelStorageAccess;
        return true;
...
bool StructTraits<network::mojom::CookieInclusionStatusDataView, net::CookieInclusionStatus>::Read(
    network::mojom::CookieInclusionStatusDataView status, net::CookieInclusionStatus* out)
{
    ...
    return net::CookieInclusionStatus::ValidateExclusionAndWarningFromWire(status.exclusion_reasons(), status.warning_reasons());
}
