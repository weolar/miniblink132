...
// static
bool StructTraits<network::mojom::AddressMapDataView, net::AddressMapOwnerLinux::AddressMap>::Read(
    network::mojom::AddressMapDataView obj, net::AddressMapOwnerLinux::AddressMap* address_map)
{
    return obj.ReadAddressMap(address_map);
}

// static
bool StructTraits<network::mojom::OnlineLinksDataView, std::unordered_set<int>>::Read(
    network::mojom::OnlineLinksDataView obj, std::unordered_set<int>* online_links)
{
...
// static
bool StructTraits<network::mojom::IfAddrMsgDataView, struct ifaddrmsg>::Read(network::mojom::IfAddrMsgDataView obj, struct ifaddrmsg* msg)
{
