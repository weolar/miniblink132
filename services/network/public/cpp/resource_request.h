...
struct /*COMPONENT_EXPORT(NETWORK_CPP_BASE)*/ ResourceRequest {
    ...
    struct /*COMPONENT_EXPORT(NETWORK_CPP_BASE)*/ TrustedParams {
        ...
        mojo::PendingRemote<mojom::URLLoaderNetworkServiceObserver> url_loader_network_observer;
        mojo::PendingRemote<mojom::DevToolsObserver> devtools_observer;
        mojom::ClientSecurityStatePtr client_security_state;
        mojo::PendingRemote<mojom::AcceptCHFrameObserver> accept_ch_frame_observer;
        mojo::PendingRemote<mojom::SharedDictionaryAccessObserver> shared_dictionary_observer;
    };
    ...
    struct /*COMPONENT_EXPORT(NETWORK_CPP_BASE)*/ WebBundleTokenParams {
        ...
        WebBundleTokenParams(const GURL& bundle_url, const base::UnguessableToken& token, mojo::PendingRemote<mojom::WebBundleHandle> handle);
        WebBundleTokenParams(const GURL& bundle_url, const base::UnguessableToken& token, int32_t render_process_id);
    ...
    mojom::CorsPreflightPolicy cors_preflight_policy = mojom::CorsPreflightPolicy::kConsiderPreflight;
    ...
    mojom::IPAddressSpace required_ip_address_space = mojom::IPAddressSpace::kUnknown;
    ...
    mojom::RequestDestination original_destination = mojom::RequestDestination::kEmpty;
    ...
    std::optional<std::vector<net::SourceStream::SourceType>> devtools_accepted_stream_types;
    ...
    network::mojom::AttributionSupport attribution_reporting_support = network::mojom::AttributionSupport::kUnset;
    mojom::AttributionReportingEligibility attribution_reporting_eligibility = mojom::AttributionReportingEligibility::kUnset;
...
public:
    explicit ScopedResourceRequestCrashKeys(const network::ResourceRequest& request);
    ~ScopedResourceRequestCrashKeys();

    ScopedResourceRequestCrashKeys(const ScopedResourceRequestCrashKeys&) = delete;
    ScopedResourceRequestCrashKeys& operator=(const ScopedResourceRequestCrashKeys&) = delete;
