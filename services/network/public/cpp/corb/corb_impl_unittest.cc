...
using CorbResponseAnalyzer = network::corb::CrossOriginReadBlocking::CorbResponseAnalyzer;
using CrossOriginProtectionDecision = CorbResponseAnalyzer::CrossOriginProtectionDecision;
...
::std::ostream& operator<<(::std::ostream& os, const TestScenario& scenario)
{
    ...
    case CrossOriginProtectionDecision::kAllowedAfterSniffing:
        protection_decision = "CrossOriginProtectionDecision::kAllowedAfterSniffing";
        break;
    case CrossOriginProtectionDecision::kBlockedAfterSniffing:
        protection_decision = "CrossOriginProtectionDecision::kBlockedAfterSniffing";
        break;
    }
    ...
    return os << "\n  description           = " << scenario.description << "\n  source_line           = " << scenario.source_line
              ...
              << "\n  packets               = " << packets << "\n  resource_is_sensitive = " << (scenario.resource_is_sensitive ? "true" : "false")
...
// protected
const char kHTMLWithTooLongComment[] = "<!--.............................................................72 chars"
                                       "................................................................144 chars"
                                       "................................................................216 chars"
                                       "................................................................288 chars"
                                       "................................................................360 chars"
...
const TestScenario kScenarios[] = {
    ...
    {
        "Allowed: Same-origin XHR to HTML", __LINE__,
        ...
        CrossOriginProtectionDecision::kBlockedAfterSniffing, // protection_decision
        Verdict::kAllow, // verdict
        kVerdictPacketForHeadersBasedVerdict, // verdict_packet
    },
    {
        "Allowed: Same-origin JSON with parser breaker and HTML mime type", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/html", // response_content_type
    ...
    {
        "Allowed: Same-origin JSON with parser breaker and JSON mime type", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
    ...
    {
        "Allowed: Cross-site script without parser breaker", __LINE__,
        ...
        { "var x=3;" }, // packets
        false, // resource_is_sensitive
        CrossOriginProtectionDecision::kAllowedAfterSniffing, // protection_decision
        Verdict::kAllow, // verdict
        0, // verdict_packet
    },
    {
    ...
    },
    {
        ...
        "Blocked: Cross-site XHR to HTML over FTP", __LINE__,
    ...
    },
    {
        ...
        "Blocked: Cross-site XHR to HTML from file://", __LINE__,
    ...
    },
    {
        ...
        "Blocked: Cross-site fetch HTML from Flash without CORS", __LINE__,
    ...
    {
        "Allowed: JSON object + CORS with parser-breaker labeled as JavaScript", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    {
        "Blocked: JSON object labeled as JavaScript with a no-sniff header", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff", // response_headers
    ...
    {
        "Allowed: Empty response with PNG mime type", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
    ...
    {
        "Allowed: Empty response with PNG mime type and nosniff header", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff", // response_headers
    ...
    {
        "Allowed: JSON-like JavaScript labeled as text", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
    ...
    {
        "Allowed: JSONP labeled as JSON", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/json", // response_content_type
    ...
    {
        "Allowed (for now): JSON array literal labeled as text/plain", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
    ...
    {
        "Allowed: JSON array literal on which a function is called.", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
        MimeType::kPlain, // canonical_mime_type
        MimeTypeBucket::kProtected, // mime_type_bucket
        { "[1, 2, {}, true, false, \"yay\"]", ".map(x => console.log(x))", ".map(x => console.log(x));" }, // packets
        false, // resource_is_sensitive
        CrossOriginProtectionDecision::kAllowedAfterSniffing, // protection_decision
        Verdict::kAllow, // verdict
        0, // verdict_packet
    ...
    {
        "Allowed: Cross-site XHR to partial match for <HTML> tag", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/html", // response_content_type
    ...
    {
        "Allowed: HTML tag appears only after net::kMaxBytesToSniff", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/html", // response_content_type
    ...
    {
        "Allowed: Empty response with html mime type", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/html", // response_content_type
    ...
    {
        "Allowed: Same-origin XHR to a filesystem URI", __LINE__,
    ...
    {
        "Allowed: Same-origin XHR to a blob URI", __LINE__,
    ...
    {
        "Blocked: nosniff + Content-Type: text/html; charset=utf-8", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff", // response_headers
    ...
    {
        "Blocked: Cross-origin, same-site XHR to nosniff HTML without CORS", __LINE__,
    ...
    {
        "Blocked: Cross-site JSON with parser breaker/html/nosniff", __LINE__,
...

    {
        ...
        "Blocked(-ish?): Nosniff header + empty response", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff", // response_headers
    ...
    {
        "Allowed: CORB N/A for CORS requests: Cross-site XHR with wrong CORS", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Access-Control-Allow-Origin: http://example.com", // response_headers
    ...
    {
        "Allowed: CORB N/A for CORS requests: JSON parser-breaker + wrong CORS", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
    ...
    {
        "Blocked: slow-arriving JSON labeled as text/plain", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
    ...
    {
        "Blocked: slow-arriving xml labeled as text/plain", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
    ...
    {
        "Blocked: slow-arriving html labeled as text/plain", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
    ...
    {
        "Blocked: slow-arriving html with commented-out xml tag", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
    ...
    {
        "Blocked: Cross-site XHR to HTML labeled as text without CORS", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/plain", // response_content_type
    ...
    {
        "Blocked: Cross-site <script> inclusion of HTML w/ DTD without CORS", __LINE__,
        "http://www.b.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/html", // response_content_type
        MimeType::kHtml, // canonical_mime_type
        MimeTypeBucket::kProtected, // mime_type_bucket
        { "<!doc", "type html><html itemscope=\"\" ", "itemtype=\"http://schema.org/SearchResultsPage\" ", "lang=\"en\"><head>" }, // packets
        false, // resource_is_sensitive
        CrossOriginProtectionDecision::kBlockedAfterSniffing, // protection_decision
        Verdict::kBlock, // verdict
        1, // verdict_packet
    ...
    {
        "Blocked: Cross-site fetch HTML from NaCl without CORS response", __LINE__,
        "http://www.b.com/plugin.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/html", // response_content_type
    ...
    {
        "Blocked: Cross-site JSON with parser breaker and JSON mime type", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://c.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/json", // response_content_type
    ...
    {
        "Blocked: Cross-site JSON with parser breaker/nosniff/other mime type", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://c.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff", // response_headers
    ...
    {
        "Blocked: Cross-site JSON with parser breaker and other mime type", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://c.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "application/javascript", // response_content_type
    ...
    },
    {
        ...
        "Blocked: Cross-site CSS with parser breaker and text/css mime type", __LINE__,
    ...
    },
    {
        ...
        "Blocked: Cross-site HTML/CSS polyglot with text/css mime type", __LINE__,
        "http://a.com/resource.css", // target_url
        "http://c.com/", // initiator_origin
        "HTTP/1.1 200 OK", // response_headers
        "text/css", // response_content_type
    ...
    {
        "Blocked: Cross-site XHR to a filesystem URI", __LINE__,
    ...
    {
        "Blocked: Cross-site XHR to a blob URI", __LINE__,
    ...
    // values.
    {
        "Blocked-by-ORB: Javascript 206", __LINE__,
    ...
    },
    {
        ...
        "Allowed: text/html 206 media with CORS", __LINE__,
    ...
    {
        "Blocked-by-ORB: text/plain 206 media", __LINE__,
    ...
    {
        "Blocked: text/html 206 media", __LINE__,
        "http://www.b.com/movie.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 206 OK\n"
        "Content-Range: bytes 200-1000/67589", // response_headers
    ...
    {
        "Blocked-by-ORB: application/octet-stream 206 (middle)", __LINE__,
        "http://www.b.com/movie.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 206 OK\n"
        "Content-Range: bytes 200-1000/67589", // response_headers
    ...
    {
        "Allowed: application/octet-stream 206 media - beginning of video", __LINE__,
    ...
    {
        "Allowed: video/mp4 206 media - beginning of resource", __LINE__,
        "http://www.b.com/movie.mp4", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 206 OK\n"
        "Content-Range: bytes 0-800/67589", // response_headers
    ...
    {
        "Allowed: video/mp4 206 media - middle of resource", __LINE__,
        "http://www.b.com/movie.mp4", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 206 OK\n"
        "Content-Range: bytes 200-1000/67589", // response_headers
    ...
    {
        "Allowed: same-origin 204 response with no data", __LINE__,
        "http://a.com/resource.html", // target_url
    ...
    {
        "Allowed after sniffing: cross-site 204 response with no data", __LINE__,
        "http://a.com/resource.html", // target_url
    ...
    {
        "Not Sensitive: script without CORS or Cache heuristic", __LINE__,
    ...
    {
        "Not Sensitive: vary user-agent is present and should be ignored", __LINE__,
        "http://www.a.com/resource.js", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
    ...
    {
        "Not Sensitive: cache-control no-store should be ignored", __LINE__,
        "http://www.a.com/resource.js", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Vary: Origin\n"
    ...
    {
        "Sensitive, Allowed: script with CORS heuristic and range header", __LINE__,
        "http://www.a.com/resource.js", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 206 OK\n"
        "Vary: Origin\n"
    ...
    {
        "Sensitive, Blocked: html with CORS heuristic and no sniff", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Vary: Origin\n"
    ...
    {
        "Sensitive, Blocked after sniffing: html with CORS heuristic", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Vary: Origin\n"
    ...
    {
        "Sensitive, Allowed after sniffing: javascript with CORS heuristic", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Vary: Origin\n"
    ...
    {
        "Sensitive, Allowed: script with cache heuristic and range header", __LINE__,
        "http://www.a.com/resource.js", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 206 OK\n"
        "Vary: Origin\n"
    ...
    {
        "Sensitive, Blocked: html with cache heuristic and no sniff", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    {
        "Sensitive, Blocked after sniffing: html with cache heuristic", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Vary: Origin\n"
    ...
    {
        "Sensitive, Allowed after sniffing: javascript with cache heuristic", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Vary: Origin\n"
    ...
    // sensitive.
    {
        "Sensitive cache heuristic, both CORB and the protection stats block", __LINE__,
        "http://www.a.com/resource.html", // target_url
    ...
    {
        "Sensitive, CORB and CORB protection stats need sniffing", __LINE__,
        "http://www.a.com/resource.html", // target_url
    ...
    {
        "Sensitive response with an accept-ranges header.", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Accept-Ranges: bytes\n"
    ...
    {
        "Sensitive response with an accept-ranges header but value |none|.", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Accept-Ranges: none\n"
    ...
    {
        "Non-sensitive response with an accept-ranges header.", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
    ...
    {
        "CORS-heuristic response with an accept-ranges header.", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    {
        "Cache-heuristic response with an accept-ranges header.", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    {
        "Cache + CORS heuristics, accept-ranges header says |none|.", __LINE__,
        "http://www.a.com/resource.html", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    {
        "Sensitive + accept-ranges header but protection decision = kAllow.", __LINE__,
        "http://www.a.com/resource.js", // target_url
        "http://www.a.com/", // initiator_origin
        "HTTP/1.1 206 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    {
        "Sensitive, allowed after sniffing: same-origin 204 with no data", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://a.com/", // initiator_origin
    ...
    // nosniff header.
    {
        "Cache heuristic with no nosniff header", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "Cache-Control: private\n"
    ...
    // other criteria.
    {
        "Cache heuristic with nosniff header but not a protected type", __LINE__,
    ...
    {
        "Cache heuristic with nosniff header and protection decision == kBlock", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    // header.
    {
        "Nosniff header and satisfies the CORS heuristic", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
    ...
    {
        "Nosniff header and satisfies the Cache heuristic", __LINE__,
        "http://a.com/resource.html", // target_url
        "http://a.com/", // initiator_origin
        "HTTP/1.1 200 OK\n"
        "X-Content-Type-Options: nosniff\n"
...
class ResponseAnalyzerTest : public testing::Test, public testing::WithParamInterface<TestScenario> {
public:
    ...
    mojom::URLResponseHeadPtr CreateResponse(
        const std::string& response_content_type, const std::string& raw_response_headers, const std::string& initiator_origin)
    {
        auto response = mojom::URLResponseHead::New();
        std::string formatted_response_headers = net::HttpUtil::AssembleRawHeaders(raw_response_headers);
        scoped_refptr<net::HttpResponseHeaders> response_headers = base::MakeRefCounted<net::HttpResponseHeaders>(formatted_response_headers);

        std::string charset;
        bool had_charset = false;
        response_headers->SetHeader("Content-Type", response_content_type);
        net::HttpUtil::ParseContentType(response_content_type, &response->mime_type, &charset, &had_charset, nullptr);
        EXPECT_FALSE(response->mime_type.empty()) << "Invalid MIME type defined in kScenarios.";
    ...
    // block or allow.
    void RunAnalyzerOnScenario(const TestScenario& scenario, const mojom::URLResponseHead& response, std::unique_ptr<ResponseAnalyzer> analyzer,
        bool verify_when_decision_is_made = true)
    {
        // Initialize |request| from the parameters.
        std::unique_ptr<net::URLRequest> request
            = context_->CreateRequest(GURL(scenario.target_url), net::DEFAULT_PRIORITY, &delegate_, TRAFFIC_ANNOTATION_FOR_TESTS);
        request->set_initiator(url::Origin::Create(GURL(scenario.initiator_origin)));

        // Check if this is a CORS request.
        std::string cors_header_value;
        response.headers->GetNormalizedHeader("access-control-allow-origin", &cors_header_value);
        auto request_mode = cors_header_value == "" ? mojom::RequestMode::kNoCors : mojom::RequestMode::kCors;
        ...
        ResponseAnalyzer::Decision decision = analyzer->Init(request->url(), request->initiator(), request_mode, response);
        ...
        if (scenario.verdict_packet != kVerdictPacketForInconclusiveSniffing && scenario.verdict_packet != kVerdictPacketForHeadersBasedVerdict) {
        ...
        if (verify_when_decision_is_made) {
            bool expected_to_sniff = scenario.verdict_packet != kVerdictPacketForHeadersBasedVerdict;
        ...
        if (decision == ResponseAnalyzer::Decision::kSniffMore) {
            ...
            for (size_t packet_index = 0; packet_index < packets_vector.size(); packet_index++) {
                SCOPED_TRACE(testing::Message() << "While delivering packet #" << packet_index);
...
TEST_P(ResponseAnalyzerTest, ResponseBlocking)
{
    ...
    auto response = CreateResponse(scenario.response_content_type, scenario.response_headers, scenario.initiator_origin);

    // Run the analyzer and confirm it allows/blocks correctly.
    RunAnalyzerOnScenario(scenario, *response, std::make_unique<CorbResponseAnalyzer>());
    ...
    if (should_be_blocked && expected_to_sniff) {
        end_action = static_cast<int>(CrossOriginReadBlocking::Action::kBlockedAfterSniffing);
    } else if (should_be_blocked && !expected_to_sniff) {
        end_action = static_cast<int>(CrossOriginReadBlocking::Action::kBlockedWithoutSniffing);
    } else if (!should_be_blocked && expected_to_sniff) {
        end_action = static_cast<int>(CrossOriginReadBlocking::Action::kAllowedAfterSniffing);
    } else if (!should_be_blocked && !expected_to_sniff) {
        end_action = static_cast<int>(CrossOriginReadBlocking::Action::kAllowedWithoutSniffing);
    } else {
        NOTREACHED();
    }
    ...
    const auto kResponseStarted = static_cast<base::HistogramBase::Sample>(CrossOriginReadBlocking::Action::kResponseStarted);
    EXPECT_THAT(histograms.GetAllSamples(histogram_base + ".Action"), testing::ElementsAre(base::Bucket(kResponseStarted, 1), base::Bucket(end_action, 1)))
    ...
    // incremented.
    EXPECT_THAT(histograms.GetTotalCountsForPrefix("SiteIsolation.XSD.Browser"), testing::ContainerEq(expected_counts));
}
...
TEST_P(ResponseAnalyzerTest, CORBProtectionLogging)
{
    ...
    auto response = CreateResponse(scenario.response_content_type, scenario.response_headers, scenario.initiator_origin);
    const bool seems_sensitive_from_cors_heuristic = CrossOriginReadBlocking::CorbResponseAnalyzer::SeemsSensitiveFromCORSHeuristic(*response);
    const bool seems_sensitive_from_cache_heuristic = CrossOriginReadBlocking::CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*response);
    const bool supports_range_requests = CorbResponseAnalyzer::SupportsRangeRequests(*response);
    ...
    if (scenario.resource_is_sensitive) {
        ...
        // requests.
        EXPECT_THAT(
            histograms.GetAllSamples("SiteIsolation.CORBProtection.SensitiveWithRangeSupport"), testing::ElementsAre(base::Bucket(supports_range_requests, 1)));
        expected_counts["SiteIsolation.CORBProtection.SensitiveWithRangeSupport"] = 1;
        ...
        bool expect_range_support_histograms = scenario.mime_type_bucket == MimeTypeBucket::kProtected
            && (scenario.protection_decision == CrossOriginProtectionDecision::kBlock
                || scenario.protection_decision == CrossOriginProtectionDecision::kBlockedAfterSniffing);
        ...
        if (seems_sensitive_from_cors_heuristic) {
            ...
            EXPECT_THAT(
                histograms.GetAllSamples(cors_base + mime_type_bucket), testing::ElementsAre(base::Bucket(static_cast<int>(scenario.protection_decision), 1)))
                << "CORB should have reported the right protection decision.";
            if (expect_range_support_histograms) {
                EXPECT_THAT(
                    histograms.GetAllSamples(cors_protected + blocked_with_range_support), testing::ElementsAre(base::Bucket(supports_range_requests, 1)));
                expected_counts[cors_protected + blocked_with_range_support] = 1;
            }
            if (scenario.mime_type_bucket == MimeTypeBucket::kProtected && scenario.protection_decision == CrossOriginProtectionDecision::kBlock) {
                EXPECT_THAT(histograms.GetAllSamples(cors_protected + blocked_nosniff), testing::ElementsAre(base::Bucket(expect_nosniff, 1)));
        ...
        if (seems_sensitive_from_cache_heuristic) {
            ...
            EXPECT_THAT(
                histograms.GetAllSamples(cache_base + mime_type_bucket), testing::ElementsAre(base::Bucket(static_cast<int>(scenario.protection_decision), 1)))
                << "CORB should have reported the right protection decision.";
            if (expect_range_support_histograms) {
                EXPECT_THAT(
                    histograms.GetAllSamples(cache_protected + blocked_with_range_support), testing::ElementsAre(base::Bucket(supports_range_requests, 1)));
                expected_counts[cache_protected + blocked_with_range_support] = 1;
            }
            if (scenario.mime_type_bucket == MimeTypeBucket::kProtected && scenario.protection_decision == CrossOriginProtectionDecision::kBlock) {
                EXPECT_THAT(histograms.GetAllSamples(cache_protected + blocked_nosniff), testing::ElementsAre(base::Bucket(expect_nosniff, 1)));
                expected_counts[cache_protected + blocked_nosniff] = 1;
            }
        }

        EXPECT_THAT(histograms.GetTotalCountsForPrefix("SiteIsolation.CORBProtection"), testing::ContainerEq(expected_counts));
        EXPECT_THAT(histograms.GetAllSamples("SiteIsolation.CORBProtection.SensitiveResource"), testing::ElementsAre(base::Bucket(true, 1)));
    } else {
        ...
        EXPECT_THAT(histograms.GetTotalCountsForPrefix("SiteIsolation.CORBProtection"), testing::ContainerEq(expected_counts));
        EXPECT_THAT(histograms.GetAllSamples("SiteIsolation.CORBProtection.SensitiveResource"), testing::ElementsAre(base::Bucket(false, 1)));
    }
}
...
TEST_P(ResponseAnalyzerTest, OpaqueResponseBlocking)
{
    ...
    if (description == "Blocked-by-ORB: text/plain 206 media" || description == "Blocked-by-ORB: Javascript 206"
    ...
    auto analyzer = std::make_unique<OpaqueResponseBlockingAnalyzer>(per_factory_state);

    RunAnalyzerOnScenario(scenario, *response, std::move(analyzer), kVerifyWhenDecisionIsMade);
}

INSTANTIATE_TEST_SUITE_P(All, ResponseAnalyzerTest, ::testing::ValuesIn(kScenarios));
...
TEST(CrossOriginReadBlockingTest, SniffForHTML)
{
    ...
    EXPECT_EQ(SniffingResult::kYes, CORB::SniffForHTML(" <!-- this is comment -->\n<html><body>"));
    ...
    EXPECT_EQ(SniffingResult::kNo, CORB::SniffForHTML("        var name=window.location;\nadfadf"));

    // HTML comment followed by valid Javascript.
    EXPECT_EQ(SniffingResult::kNo, CORB::SniffForHTML(" <!-- this is comment\n document.write(1);\n// -->\nwindow.open()"));

    // HTML/Javascript polyglot should return kNo.
    EXPECT_EQ(SniffingResult::kNo,
        CORB::SniffForHTML("<!--/*--><html><body><script type='text/javascript'><!--//*/\n"
                           "var blah = 123;\n"
                           "//--></script></body></html>"));
    ...
    EXPECT_EQ(SniffingResult::kNo, CORB::SniffForHTML(commented_out_html_tag_data));
    ...
    while (!almost_html.empty()) {
        ...
        EXPECT_EQ(SniffingResult::kMaybe, CORB::SniffForHTML(almost_html)) << almost_html;
    }
    ...
    EXPECT_EQ(SniffingResult::kMaybe, CORB::SniffForHTML("<!-- blah --> <html> no newline yet"));
}
...
TEST(CrossOriginReadBlockingTest, SniffForXML)
{
    ...
    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForXML(xml_data));
    EXPECT_EQ(SniffingResult::kNo, CrossOriginReadBlocking::SniffForXML(non_xml_data));

    // Empty string should be indeterminate.
    EXPECT_EQ(SniffingResult::kMaybe, CrossOriginReadBlocking::SniffForXML(empty_data));
}
...
TEST(CrossOriginReadBlockingTest, SniffForJSON)
{
    ...
    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForJSON(json_data));
    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForJSON(json_corrupt_after_first_key));

    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForJSON(json_data2));
    ...
    while (!almost_json.empty()) {
        ...
        EXPECT_EQ(SniffingResult::kMaybe, CrossOriginReadBlocking::SniffForJSON(almost_json)) << almost_json;
    }

    EXPECT_EQ(SniffingResult::kNo, CrossOriginReadBlocking::SniffForJSON(non_json_data0));
    EXPECT_EQ(SniffingResult::kNo, CrossOriginReadBlocking::SniffForJSON(non_json_data1));

    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForJSON(R"({"" : 1})")) << "Empty strings are accepted";
    EXPECT_EQ(SniffingResult::kNo, CrossOriginReadBlocking::SniffForJSON(R"({'' : 1})")) << "Single quotes are not accepted";
    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForJSON("{\"\\\"\" : 1}")) << "Escaped quotes are recognized";
    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForJSON(R"({"\\\u000a" : 1})")) << "Escaped control characters are recognized";
    EXPECT_EQ(SniffingResult::kMaybe, CrossOriginReadBlocking::SniffForJSON(R"({"\\\u00)")) << "Incomplete escape results in maybe";
    EXPECT_EQ(SniffingResult::kMaybe, CrossOriginReadBlocking::SniffForJSON("{\"\\")) << "Incomplete escape results in maybe";
    EXPECT_EQ(SniffingResult::kMaybe, CrossOriginReadBlocking::SniffForJSON("{\"\\\"")) << "Incomplete escape results in maybe";
    EXPECT_EQ(SniffingResult::kYes, CrossOriginReadBlocking::SniffForJSON("{\"\n\" : true}")) << "Unescaped control characters are accepted (a bit more like "
                                                                                              << "Javascript than strict reading of the JSON spec)";
    EXPECT_EQ(SniffingResult::kNo, CrossOriginReadBlocking::SniffForJSON("{}")) << "Empty dictionary is not recognized (since it's valid JS too)";
    EXPECT_EQ(SniffingResult::kNo, CrossOriginReadBlocking::SniffForJSON("[true, false, 1, 2]"))
        << "Lists dictionary are not recognized (since they're valid JS too)";
    EXPECT_EQ(SniffingResult::kNo, CrossOriginReadBlocking::SniffForJSON(R"({":"})")) << "A colon character inside a string does not trigger a match";
}
...
TEST(CrossOriginReadBlockingTest, GetCanonicalMimeType)
{
    ...
    for (const auto& test : tests) {
        ...
        EXPECT_EQ(expected, actual) << "when testing with the following input: " << input;
    }
}

mojom::URLResponseHeadPtr CreateResponse(std::string raw_headers)
{
    scoped_refptr<net::HttpResponseHeaders> headers = base::MakeRefCounted<net::HttpResponseHeaders>(net::HttpUtil::AssembleRawHeaders(raw_headers));
...
TEST(CrossOriginReadBlockingTest, SeemsSensitiveFromCORSHeuristic)
{
    ...
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCORSHeuristic(*no_cors_response));

    // Response with CORS value = "*", so not sensitive.
    auto cors_any_response = CreateResponse("HTTP/1.1 200 OK\n"
                                            "Access-Control-Allow-Origin: *");
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCORSHeuristic(*cors_any_response));

    // Response with CORS value = "null", so not sensitive.
    auto cors_null_response = CreateResponse("HTTP/1.1 200 OK\n"
                                             "Access-Control-Allow-Origin: null");
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCORSHeuristic(*cors_null_response));

    // Response with CORS header restricting access to a particular origin.
    auto cors_response = CreateResponse("HTTP/1.1 200 OK\n"
                                        "Access-Control-Allow-Origin: http://www.a.com/");
    EXPECT_TRUE(CorbResponseAnalyzer::SeemsSensitiveFromCORSHeuristic(*cors_response));
}
...
TEST(CrossOriginReadBlockingTest, SeemsSensitiveFromCacheHeuristic)
{
    ...
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*no_cache_response));

    // Response with cache-control but no vary header.
    auto cache_only_response = CreateResponse("HTTP/1.1 200 OK\n"
                                              "Cache-Control: private");
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*cache_only_response));

    // Response with vary: origin but no cache-control header.
    auto vary_only_response = CreateResponse("HTTP/1.1 200 OK\n"
                                             "Vary: origin");
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*vary_only_response));

    // Response with vary: user-agent and cache-control: no-cache (should still
    // not seem sensitive).
    auto wrong_values_response = CreateResponse("HTTP/1.1 200 OK\n"
                                                "Vary: user-agent\n"
                                                "Cache-Control: no-cache");
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*wrong_values_response));

    // Response with vary: origin and cache-control: private.
    auto vary_and_cache_response = CreateResponse("HTTP/1.1 200 OK\n"
                                                  "Vary: origin\n"
                                                  "Cache-Control: private");
    EXPECT_TRUE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*vary_and_cache_response));

    // Response with vary: origin, user-agent and cache-control: private, no-store
    // (we should still find the relevant values).
    auto extra_values_response = CreateResponse("HTTP/1.1 200 OK\n"
                                                "Vary: origin, user-agent\n"
                                                "Cache-Control: no-cache, private");
    EXPECT_TRUE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*extra_values_response));
}
...
TEST(CrossOriginReadBlockingTest, SeemsSensitiveWithBothHeuristics)
{
    ...
    auto cors_response = CreateResponse("HTTP/1.1 200 OK\n"
                                        "Access-Control-Allow-Origin: http://www.a.com/");
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*cors_response));

    // Response with cache heuristic should not appear sensitive to CORS
    // heuristic.
    auto cache_response = CreateResponse("HTTP/1.1 200 OK\n"
                                         "Vary: origin\n"
                                         "Cache-Control: private");
    EXPECT_FALSE(CorbResponseAnalyzer::SeemsSensitiveFromCORSHeuristic(*cache_response));
    ...
    auto both_response = CreateResponse("HTTP/1.1 200 OK\n"
                                        "Vary: origin\n"
                                        "Cache-Control: private\n"
                                        "Access-Control-Allow-Origin: http://www.a.com/");
    EXPECT_TRUE(CorbResponseAnalyzer::SeemsSensitiveFromCORSHeuristic(*both_response));
    EXPECT_TRUE(CorbResponseAnalyzer::SeemsSensitiveFromCacheHeuristic(*both_response));
}
...
TEST(CrossOriginReadBlockingTest, SupportsRangeRequests)
{
    ...
    auto bytes_accept_ranges = CreateResponse("HTTP/1.1 200 OK\n"
                                              "Accept-Ranges: bytes");
    EXPECT_TRUE(CorbResponseAnalyzer::SupportsRangeRequests(*bytes_accept_ranges));

    // Response with an Accept-Ranges header value of |none|. Should return false.
    auto none_accept_ranges = CreateResponse("HTTP/1.1 200 OK\n"
                                             "Accept-Ranges: none");
    EXPECT_FALSE(CorbResponseAnalyzer::SupportsRangeRequests(*none_accept_ranges));
}
