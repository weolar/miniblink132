...
inline constexpr WebSandboxFlags operator&(WebSandboxFlags a, WebSandboxFlags b)
{
...
WebSandboxFlagsParsingResult ParseWebSandboxPolicy(std::string_view input, mojom::WebSandboxFlags ignored_flags);
