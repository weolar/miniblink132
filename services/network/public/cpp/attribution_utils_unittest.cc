...
TEST(AttributionSupportTest, HasAttributionOsSupport)
{
    ...
    for (const auto& test_case : kTestCases) {
        EXPECT_EQ(HasAttributionOsSupport(test_case.attribution_support), test_case.expected);
    }
}
...
TEST(AttributionSupportTest, HasAttributionWebSupport)
{
    ...
    for (const auto& test_case : kTestCases) {
        EXPECT_EQ(HasAttributionWebSupport(test_case.attribution_support), test_case.expected);
    }
}
...
TEST(AttributionSupportTest, HasAttributionSupport)
{
    ...
    for (const auto& test_case : kTestCases) {
        EXPECT_EQ(HasAttributionSupport(test_case.attribution_support), test_case.expected);
    }
}
