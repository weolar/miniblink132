...
namespace mojo {
template <> struct COMPONENT_EXPORT(NETWORK_CPP_BASE) EnumTraits<network::mojom::EcnMarking, rtc::EcnMarking> {
    static network::mojom::EcnMarking ToMojom(rtc::EcnMarking input);
    static bool FromMojom(network::mojom::EcnMarking input, rtc::EcnMarking* output);
};
} // namespace mojo
...
IPC_ENUM_TRAITS_MAX_VALUE(network::P2PSocketOption, network::P2P_SOCKET_OPT_MAX - 1)
IPC_ENUM_TRAITS_MAX_VALUE(net::NetworkChangeNotifier::ConnectionType, net::NetworkChangeNotifier::CONNECTION_LAST)
IPC_ENUM_TRAITS_MIN_MAX_VALUE(rtc::DiffServCodePoint, rtc::DSCP_NO_CHANGE, rtc::DSCP_CS7)
