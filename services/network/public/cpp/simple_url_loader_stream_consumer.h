...
public:
    ...
    SimpleURLLoaderStreamConsumer& operator=(const SimpleURLLoaderStreamConsumer&) = delete;
    ...
    virtual void OnDataReceived(std::string_view string_piece, base::OnceClosure resume) = 0;
