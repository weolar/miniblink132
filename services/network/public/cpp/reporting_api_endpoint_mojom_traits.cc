...
// static
bool StructTraits<network::mojom::ReportingApiEndpointDataView, net::ReportingEndpoint>::Read(
    network::mojom::ReportingApiEndpointDataView data, net::ReportingEndpoint* out)
{
    ...
    if (!data.ReadNetworkAnonymizationKey(&out->group_key.network_anonymization_key)) {
        return false;
    }
