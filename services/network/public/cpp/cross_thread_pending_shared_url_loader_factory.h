...
class COMPONENT_EXPORT(NETWORK_CPP) CrossThreadPendingSharedURLLoaderFactory : public PendingSharedURLLoaderFactory {
public:
    explicit CrossThreadPendingSharedURLLoaderFactory(scoped_refptr<SharedURLLoaderFactory> base_factory);
