...
class MockSelfDeletingURLLoaderFactory : public network::SelfDeletingURLLoaderFactory {
public:
    MockSelfDeletingURLLoaderFactory(mojo::PendingReceiver<network::mojom::URLLoaderFactory> pending_receiver, base::OnceClosure callback)
    ...
    ~MockSelfDeletingURLLoaderFactory() override
    {
...
TEST_F(SelfDeletingURLLoaderFactoryTest, InitializeAndReset)
{
    ...
    new MockSelfDeletingURLLoaderFactory(pending_remote.InitWithNewPipeAndPassReceiver(), run_loop.QuitClosure());
