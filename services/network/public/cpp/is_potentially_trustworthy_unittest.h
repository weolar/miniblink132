...
template <typename TTrustworthinessTraits> class AbstractTrustworthinessTest : public url::AbstractOriginTest<TTrustworthinessTraits> {
protected:
...
TYPED_TEST_P(AbstractTrustworthinessTest, OriginFromString)
{
    ...
    EXPECT_FALSE(this->IsOriginPotentiallyTrustworthy("javascript:alert('blah')"));
...
TYPED_TEST_P(AbstractTrustworthinessTest, CustomSchemes)
{
    ...
    EXPECT_FALSE(this->IsOriginPotentiallyTrustworthy("unknown-scheme://example.com"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("unknown-scheme://example.com"));
    ...
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("sec-std-with-host://blah/x.js"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("sec-noaccess://blah/x.js"));
    EXPECT_TRUE(this->IsOriginPotentiallyTrustworthy("sec-std-with-host://blah/x.js"));
    ...
    EXPECT_FALSE(this->IsOriginPotentiallyTrustworthy("sec-noaccess://blah/x.js"));
    ...
    EXPECT_FALSE(this->IsOriginPotentiallyTrustworthy("std-with-host://blah/x.js"));
}
...
TYPED_TEST_P(AbstractTrustworthinessTest, UrlFromString)
{
    ...
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("https://example.com/fun.html"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("http://example.com/fun.html"));
    ...
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("http://localhost.com/fun.html"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("https://localhost.com/fun.html"));

    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("http://127.example.com/fun.html"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("https://127.example.com/fun.html"));

    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("http://[::2]/fun.html"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("http://[::1].example.com/fun.html"));
    ...
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("http://localhost.localdomain"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("http://localhost6"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("ftp://localhost6.localdomain6"));

    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("filesystem:http://www.example.com/temporary/"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("filesystem:ftp://www.example.com/temporary/"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("filesystem:https://www.example.com/temporary/"));

    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("blob:http://www.example.com/guid-goes-here"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("blob:ftp://www.example.com/guid-goes-here"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("blob:https://www.example.com/guid-goes-here"));

    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("filesystem:data:text/html,Hello"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("filesystem:about:blank"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("blob:blob:https://example.com/578223a1-8c13-17b3-84d5-eca045ae384a"));
    EXPECT_FALSE(this->IsUrlPotentiallyTrustworthy("filesystem:blob:https://example.com/"
    ...
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("http://localhost./fun.html"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("http://pumpkin.localhost/fun.html"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("http://crumpet.pumpkin.localhost/fun.html"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("http://pumpkin.localhost:8080/fun.html"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("http://crumpet.pumpkin.localhost:3000/fun.html"));
    ...
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("filesystem:ftp://127.0.0.1/temporary/"));
    EXPECT_TRUE(this->IsUrlPotentiallyTrustworthy("blob:ftp://127.0.0.1/guid-goes-here"));
...
TYPED_TEST_P(AbstractTrustworthinessTest, TestcasesInheritedFromBlink)
{
    ...
    TestCase inputs[] = {
        ...
        { true, true, "blob:http://localhost:1000/578223a1-8c13-17b3-84d5-eca045ae384a" },
        { true, false, "blob:https://foopy:99/578223a1-8c13-17b3-84d5-eca045ae384a" },
        ...
        { false, false, "blob:blob:https://example.com/578223a1-8c13-17b3-84d5-eca045ae384a" },
    ...
    for (size_t i = 0; i < std::size(inputs); ++i) {
        ...
        EXPECT_EQ(inputs[i].is_potentially_trustworthy, this->IsOriginPotentiallyTrustworthy(origin));
        ...
        if (!(test_gurl.SchemeIsBlob() || test_gurl.SchemeIsFileSystem())) {
            ...
            EXPECT_EQ(net::IsLocalhost(GURL(inputs[i].url)), this->IsOriginOfLocalhost(origin));
        }
    }
}
...
TYPED_TEST_P(AbstractTrustworthinessTest, IsTrustworthyWithPattern)
{
    ...
    for (const auto& test : kTestCases) {
        ...
        command_line->AppendSwitchASCII(network::switches::kUnsafelyTreatInsecureOriginAsSecure, test.pattern);
        network::SecureOriginAllowlist::GetInstance().ResetForTesting();
        EXPECT_EQ(this->IsUrlPotentiallyTrustworthy(test.url), test.expected_secure);
    }
}

REGISTER_TYPED_TEST_SUITE_P(
    AbstractTrustworthinessTest, OpaqueOrigins, OriginFromString, CustomSchemes, UrlFromString, TestcasesInheritedFromBlink, IsTrustworthyWithPattern);
