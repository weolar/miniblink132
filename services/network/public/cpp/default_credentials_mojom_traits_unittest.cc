...
TEST(DefaultCredentialsTraitsTest, Roundtrips_DefaultCredentials)
{
    for (net::HttpAuthPreferences::DefaultCredentials default_credentials :
        { net::HttpAuthPreferences::ALLOW_DEFAULT_CREDENTIALS, net::HttpAuthPreferences::DISALLOW_DEFAULT_CREDENTIALS }) {
        net::HttpAuthPreferences::DefaultCredentials roundtrip;
        ASSERT_TRUE(SerializeAndDeserializeEnum<mojom::DefaultCredentials>(default_credentials, &roundtrip));
