...
// static
bool StructTraits<network::mojom::SharedDictionaryIsolationKeyDataView, net::SharedDictionaryIsolationKey>::Read(
    network::mojom::SharedDictionaryIsolationKeyDataView data, net::SharedDictionaryIsolationKey* out)
{
