...
bool EnumTraits<network::mojom::StorageAccessApiStatus, net::StorageAccessApiStatus>::FromMojom(
    network::mojom::StorageAccessApiStatus status, net::StorageAccessApiStatus* out)
{
    switch (status) {
...
network::mojom::StorageAccessApiStatus EnumTraits<network::mojom::StorageAccessApiStatus, net::StorageAccessApiStatus>::ToMojom(
