...
class COMPONENT_EXPORT(NETWORK_CPP) NotImplementedURLLoaderFactory final : public SelfDeletingURLLoaderFactory {
public:
    ...
    // method).
    static mojo::PendingRemote<network::mojom::URLLoaderFactory> Create(base::Location creator_location = base::Location::Current());

    NotImplementedURLLoaderFactory(const NotImplementedURLLoaderFactory&) = delete;
    NotImplementedURLLoaderFactory& operator=(const NotImplementedURLLoaderFactory&) = delete;
...
private:
    ...
    NotImplementedURLLoaderFactory(base::Location creator_location, mojo::PendingReceiver<network::mojom::URLLoaderFactory> factory_receiver);
