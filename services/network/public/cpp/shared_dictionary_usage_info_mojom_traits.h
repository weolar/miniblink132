...
template <> struct StructTraits<network::mojom::SharedDictionaryUsageInfoDataView, net::SharedDictionaryUsageInfo> {
    static const net::SharedDictionaryIsolationKey& isolation_key(const net::SharedDictionaryUsageInfo& obj)
    {
    ...
    static bool Read(network::mojom::SharedDictionaryUsageInfoDataView data, net::SharedDictionaryUsageInfo* out);
};
