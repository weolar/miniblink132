...
struct COMPONENT_EXPORT(NETWORK_CPP_CROSS_ORIGIN) CrossOriginEmbedderPolicy final {
    ...
    mojom::CrossOriginEmbedderPolicyValue value = mojom::CrossOriginEmbedderPolicyValue::kNone;
    std::optional<std::string> reporting_endpoint;
    mojom::CrossOriginEmbedderPolicyValue report_only_value = mojom::CrossOriginEmbedderPolicyValue::kNone;
