...
struct COMPONENT_EXPORT(NETWORK_CPP_BASE) CorsErrorStatus {
    ...
    CorsErrorStatus(mojom::CorsError cors_error, const std::string& failed_parameter);

    // Constructor for Private Network Access errors.
    CorsErrorStatus(mojom::CorsError cors_error, mojom::IPAddressSpace target_address_space, mojom::IPAddressSpace resource_address_space);
    ...
    mojom::IPAddressSpace resource_address_space = mojom::IPAddressSpace::kUnknown;
