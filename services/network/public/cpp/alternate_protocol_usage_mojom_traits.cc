...
network::mojom::AlternateProtocolUsage EnumTraits<network::mojom::AlternateProtocolUsage, net::AlternateProtocolUsage>::ToMojom(
    net::AlternateProtocolUsage input)
{
    ...
    case net::ALTERNATE_PROTOCOL_USAGE_DNS_ALPN_H3_JOB_WON_WITHOUT_RACE:
        return network::mojom::AlternateProtocolUsage::kDnsAlpnH3JobWonWithoutRace;
...
bool EnumTraits<network::mojom::AlternateProtocolUsage, net::AlternateProtocolUsage>::FromMojom(
    network::mojom::AlternateProtocolUsage input, net::AlternateProtocolUsage* output)
{
    switch (input) {
