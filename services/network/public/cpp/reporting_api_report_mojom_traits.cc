...
// static
network::mojom::ReportingApiReportStatus EnumTraits<network::mojom::ReportingApiReportStatus, net::ReportingReport::Status>::ToMojom(
...
// static
bool EnumTraits<network::mojom::ReportingApiReportStatus, net::ReportingReport::Status>::FromMojom(
    network::mojom::ReportingApiReportStatus input, net::ReportingReport::Status* output)
{
    switch (input) {
...
// static
bool StructTraits<network::mojom::ReportingApiReportDataView, net::ReportingReport>::Read(
    network::mojom::ReportingApiReportDataView data, net::ReportingReport* out)
{
