...
struct /*COMPONENT_EXPORT(NETWORK_CPP_BASE)*/ URLLoaderCompletionStatus {
    ...
    // |completion_time|.
    explicit URLLoaderCompletionStatus(const mojom::BlockedByResponseReason& reason);
    ...
    // `URLResponseHead`.
    mojom::PrivateNetworkAccessPreflightResult private_network_access_preflight_result = mojom::PrivateNetworkAccessPreflightResult::kNone;
    ...
    // attempted.
    mojom::TrustTokenOperationStatus trust_token_operation_status = mojom::TrustTokenOperationStatus::kOk;
