...
const char kIgnoreCertificateErrorsSPKIList[] = "ignore-certificate-errors-spki-list";
...
const char kUnsafelyTreatInsecureOriginAsSecure[] = "unsafely-treat-insecure-origin-as-secure";
...
// runs.
const char kAdditionalTrustTokenKeyCommitments[] = "additional-private-state-token-key-commitments";
...
// testing.
const char kDisableSharedDictionaryStorageCleanupForTesting[] = "disable-shared-dictionary-storage-cleanup-for-testing";
