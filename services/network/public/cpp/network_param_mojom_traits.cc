...
// static
bool StructTraits<network::mojom::AuthChallengeInfoDataView, net::AuthChallengeInfo>::Read(
    network::mojom::AuthChallengeInfoDataView data, net::AuthChallengeInfo* out)
{
    out->is_proxy = data.is_proxy();
    if (!data.ReadChallenger(&out->challenger) || !data.ReadScheme(&out->scheme) || !data.ReadRealm(&out->realm) || !data.ReadChallenge(&out->challenge)
        || !data.ReadPath(&out->path)) {
        return false;
    }
    return true;
}
...
// static
bool StructTraits<network::mojom::HttpVersionDataView, net::HttpVersion>::Read(network::mojom::HttpVersionDataView data, net::HttpVersion* out)
{
...
// static
bool StructTraits<network::mojom::ResolveErrorInfoDataView, net::ResolveErrorInfo>::Read(
    network::mojom::ResolveErrorInfoDataView data, net::ResolveErrorInfo* out)
{
...
// static
bool StructTraits<network::mojom::HostPortPairDataView, net::HostPortPair>::Read(network::mojom::HostPortPairDataView data, net::HostPortPair* out)
{
    std::string host;
...
network::mojom::ProxyScheme EnumTraits<network::mojom::ProxyScheme, net::ProxyServer::Scheme>::ToMojom(net::ProxyServer::Scheme scheme)
{
...
bool EnumTraits<network::mojom::ProxyScheme, net::ProxyServer::Scheme>::FromMojom(network::mojom::ProxyScheme scheme, net::ProxyServer::Scheme* out)
{
    using net::ProxyServer;
    switch (scheme) {
...
std::optional<net::HostPortPair> StructTraits<network::mojom::ProxyServerDataView, net::ProxyServer>::host_and_port(const net::ProxyServer& s)
{
...
bool StructTraits<network::mojom::ProxyServerDataView, net::ProxyServer>::Read(network::mojom::ProxyServerDataView data, net::ProxyServer* out)
{
...
bool StructTraits<network::mojom::ProxyChainDataView, net::ProxyChain>::Read(network::mojom::ProxyChainDataView data, net::ProxyChain* out)
{
    ...
    if (proxy_servers.has_value()) {
        ...
        if (chain_id != net::ProxyChain::kNotIpProtectionChainId) {
            *out = net::ProxyChain::ForIpProtection(std::move(*proxy_servers), chain_id);
        } else {
...
// static
bool StructTraits<network::mojom::SSLCertRequestInfoDataView, scoped_refptr<net::SSLCertRequestInfo>>::Read(
    network::mojom::SSLCertRequestInfoDataView data, scoped_refptr<net::SSLCertRequestInfo>* out)
{
...
// static
bool StructTraits<network::mojom::NetLogSourceDataView, net::NetLogSource>::Read(network::mojom::NetLogSourceDataView data, net::NetLogSource* out)
{
    if (data.source_type() >= static_cast<uint32_t>(net::NetLogSourceType::COUNT)) {
        return false;
    }
    ...
    *out = net::NetLogSource(static_cast<net::NetLogSourceType>(data.source_type()), data.source_id(), start_time);
    return true;
}
