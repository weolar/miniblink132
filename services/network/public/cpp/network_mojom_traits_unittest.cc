...
class NetworkStructTraitsTest : public testing::Test, public mojom::TraitsTestService {
public:
...
private:
    // TraitsTestService:
    void EchoHttpRequestHeaders(const net::HttpRequestHeaders& header, EchoHttpRequestHeadersCallback callback) override
    {
