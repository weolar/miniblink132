...
struct COMPONENT_EXPORT(NETWORK_CPP_BASE) CrossOriginOpenerPolicy final {
    ...
    mojom::CrossOriginOpenerPolicyValue value = mojom::CrossOriginOpenerPolicyValue::kUnsafeNone;
    std::optional<std::string> reporting_endpoint;
    mojom::CrossOriginOpenerPolicyValue report_only_value = mojom::CrossOriginOpenerPolicyValue::kUnsafeNone;
    std::optional<std::string> report_only_reporting_endpoint;
    mojom::CrossOriginOpenerPolicyValue soap_by_default_value = mojom::CrossOriginOpenerPolicyValue::kUnsafeNone;
