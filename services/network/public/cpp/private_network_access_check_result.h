...
std::string_view COMPONENT_EXPORT(NETWORK_CPP) PrivateNetworkAccessCheckResultToStringPiece(PrivateNetworkAccessCheckResult result);
...
std::ostream& operator<<(std::ostream& out, PrivateNetworkAccessCheckResult result);
...
std::optional<mojom::CorsError> COMPONENT_EXPORT(NETWORK_CPP) PrivateNetworkAccessCheckResultToCorsError(PrivateNetworkAccessCheckResult result);
