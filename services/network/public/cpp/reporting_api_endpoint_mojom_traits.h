...
template <> struct StructTraits<network::mojom::ReportingApiEndpointDataView, net::ReportingEndpoint> {
    ...
    static const std::optional<url::Origin>& origin(const net::ReportingEndpoint& endpoint)
    {
    ...
    static const net::NetworkAnonymizationKey& network_anonymization_key(const net::ReportingEndpoint& endpoint)
    {
        return endpoint.group_key.network_anonymization_key;
    }

    static const std::optional<base::UnguessableToken>& reporting_source(const net::ReportingEndpoint& endpoint)
    {
        return endpoint.group_key.reporting_source;
    }

    static bool Read(network::mojom::ReportingApiEndpointDataView data, net::ReportingEndpoint* out);
};
