...
TEST(FirstPartySetsTraitsTest, Roundtrips_SiteIndex)
{
    ...
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::SiteIndex>(original, round_tripped));
...
TEST(FirstPartySetsTraitsTest, Roundtrips_SiteType)
{
    for (net::SiteType site_type : {
        ...
        ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojom::SiteType>(site_type, roundtrip));
...
TEST(FirstPartySetsTraitsTest, Roundtrips_FirstPartySetEntry)
{
    ...
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::FirstPartySetEntry>(original, round_tripped));
...
TEST(FirstPartySetsTraitsTest, Roundtrips_FirstPartySetMetadata)
{
    ...
    net::FirstPartySetEntry frame_entry(frame_owner, net::SiteType::kAssociated, 1);
    net::FirstPartySetEntry top_frame_entry(top_frame_owner, net::SiteType::kAssociated, 2);
    ...
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<network::mojom::FirstPartySetMetadata>(original, round_tripped));
...
TEST(FirstPartySetsTraitsTest, RoundTrips_GlobalFirstPartySets)
{
    ...
    net::GlobalFirstPartySets original(base::Version("1.2.3"),
        /*entries=*/
        {
            { a, net::FirstPartySetEntry(a, net::SiteType::kPrimary, std::nullopt) },
            { b, net::FirstPartySetEntry(a, net::SiteType::kAssociated, 0) },
            { c, net::FirstPartySetEntry(a, net::SiteType::kService, std::nullopt) },
        },
        /*aliases=*/ { { c_cctld, c } });

    original.ApplyManuallySpecifiedSet(net::LocalSetDeclaration(
        /*set_entries=*/ { { a, net::FirstPartySetEntry(a, net::SiteType::kPrimary, std::nullopt) },
            { b, net::FirstPartySetEntry(a, net::SiteType::kAssociated, 0) } },
        /*aliases=*/ { { b_cctld, b } }));
...
TEST(FirstPartySetsTraitsTest, GlobalFirstPartySets_InvalidVersion)
{
    ...
    net::GlobalFirstPartySets original(base::Version(),
        /*entries=*/
        {
            { a, net::FirstPartySetEntry(a, net::SiteType::kPrimary, std::nullopt) },
            { b, net::FirstPartySetEntry(a, net::SiteType::kAssociated, 0) },
    ...
    EXPECT_THAT(
        round_tripped.FindEntries({ a, b, b_cctld, c, c_cctld }, net::FirstPartySetsContextConfig()), UnorderedElementsAre(Key(a), Key(b), Key(b_cctld)));
}
...
TEST(FirstPartySetsTraitsTest, RoundTrips_FirstPartySetsContextConfig)
{
    ...
    const net::FirstPartySetsContextConfig original({
        { a, net::FirstPartySetEntryOverride(net::FirstPartySetEntry(a, net::SiteType::kPrimary, std::nullopt)) },
        { b, net::FirstPartySetEntryOverride(net::FirstPartySetEntry(a, net::SiteType::kAssociated, 0)) },
        { c, net::FirstPartySetEntryOverride() },
    });

    net::FirstPartySetsContextConfig round_tripped;

    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<network::mojom::FirstPartySetsContextConfig>(original, round_tripped));
...
TEST(FirstPartySetsTraitsTest, RoundTrips_FirstPartySetsCacheFilter)
{
    ...
    const net::FirstPartySetsCacheFilter original({ { a, kClearAtRunId } }, kBrowserRunId);

    net::FirstPartySetsCacheFilter round_tripped;

    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<network::mojom::FirstPartySetsCacheFilter>(original, round_tripped));
