...
class COMPONENT_EXPORT(NETWORK_CPP) ScopedRequestInitiatorOriginLockCrashKey : public url::debug::ScopedOriginCrashKey {
public:
    explicit ScopedRequestInitiatorOriginLockCrashKey(const std::optional<url::Origin>& request_initiator_origin_lock);
    ~ScopedRequestInitiatorOriginLockCrashKey();

    ScopedRequestInitiatorOriginLockCrashKey(const ScopedRequestInitiatorOriginLockCrashKey&) = delete;
    ScopedRequestInitiatorOriginLockCrashKey& operator=(const ScopedRequestInitiatorOriginLockCrashKey&) = delete;
};
