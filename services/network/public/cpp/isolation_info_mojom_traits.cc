...
bool EnumTraits<network::mojom::IsolationInfoRequestType, net::IsolationInfo::RequestType>::FromMojom(
    network::mojom::IsolationInfoRequestType request_type, net::IsolationInfo::RequestType* out)
{
    switch (request_type) {
...
network::mojom::IsolationInfoRequestType EnumTraits<network::mojom::IsolationInfoRequestType, net::IsolationInfo::RequestType>::ToMojom(
...
bool StructTraits<network::mojom::IsolationInfoDataView, net::IsolationInfo>::Read(network::mojom::IsolationInfoDataView data, net::IsolationInfo* out)
{
    ...
    if (!data.ReadNonce(&nonce) || !data.ReadSiteForCookies(&site_for_cookies) || !data.ReadRequestType(&request_type)) {
        return false;
    }

    std::optional<net::IsolationInfo> isolation_info
        = net::IsolationInfo::CreateIfConsistent(request_type, top_frame_origin, frame_origin, site_for_cookies, nonce);
    if (!isolation_info) {
