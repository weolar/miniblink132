...
class COMPONENT_EXPORT(NETWORK_CPP) DataPipeToSourceStream final : public net::SourceStream {
public:
    ...
    int Read(net::IOBuffer* buf, int buf_size, net::CompletionOnceCallback callback) override;
