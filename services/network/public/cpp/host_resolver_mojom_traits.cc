...
OptionalSecureDnsMode ToOptionalSecureDnsMode(std::optional<net::SecureDnsMode> optional)
{
    if (!optional)
...
std::optional<net::SecureDnsMode> FromOptionalSecureDnsMode(OptionalSecureDnsMode mode)
{
    switch (mode) {
...
// static
bool StructTraits<network::mojom::DnsOverHttpsServerConfigDataView, net::DnsOverHttpsServerConfig>::Read(
    network::mojom::DnsOverHttpsServerConfigDataView data, net::DnsOverHttpsServerConfig* out_server)
{
    ...
    if (!data.ReadEndpoints(&endpoints))
        return false;
    auto server = net::DnsOverHttpsServerConfig::FromString(std::move(server_template), std::move(endpoints));
    if (!server.has_value())
        return false;
...
// static
bool StructTraits<network::mojom::DnsOverHttpsConfigDataView, net::DnsOverHttpsConfig>::Read(
    network::mojom::DnsOverHttpsConfigDataView data, net::DnsOverHttpsConfig* out_config)
{
...
// static
Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::append_to_multi_label_name(const net::DnsConfigOverrides& overrides)
{
    return ToTristate(overrides.append_to_multi_label_name);
}

// static
Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::rotate(const net::DnsConfigOverrides& overrides)
{
    return ToTristate(overrides.rotate);
}

// static
Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::use_local_ipv6(const net::DnsConfigOverrides& overrides)
{
    return ToTristate(overrides.use_local_ipv6);
}

// static
OptionalSecureDnsMode StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::secure_dns_mode(const net::DnsConfigOverrides& overrides)
{
    return ToOptionalSecureDnsMode(overrides.secure_dns_mode);
}

// static
Tristate StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::allow_dns_over_https_upgrade(const net::DnsConfigOverrides& overrides)
{
    return ToTristate(overrides.allow_dns_over_https_upgrade);
}

// static
bool StructTraits<DnsConfigOverridesDataView, net::DnsConfigOverrides>::Read(DnsConfigOverridesDataView data, net::DnsConfigOverrides* out)
{
    ...
    out->append_to_multi_label_name = FromTristate(data.append_to_multi_label_name());
    ...
    out->allow_dns_over_https_upgrade = FromTristate(data.allow_dns_over_https_upgrade());
...
// static
DnsQueryType EnumTraits<DnsQueryType, net::DnsQueryType>::ToMojom(net::DnsQueryType input)
{
    switch (input) {
...
// static
bool EnumTraits<DnsQueryType, net::DnsQueryType>::FromMojom(DnsQueryType input, net::DnsQueryType* output)
{
    switch (input) {
...
// static
HostResolverSource EnumTraits<HostResolverSource, net::HostResolverSource>::ToMojom(net::HostResolverSource input)
{
    switch (input) {
...
// static
bool EnumTraits<HostResolverSource, net::HostResolverSource>::FromMojom(HostResolverSource input, net::HostResolverSource* output)
{
    switch (input) {
...
// static
MdnsListenerUpdateType EnumTraits<MdnsListenerUpdateType, net::MdnsListenerUpdateType>::ToMojom(net::MdnsListenerUpdateType input)
{
    switch (input) {
...
// static
bool EnumTraits<MdnsListenerUpdateType, net::MdnsListenerUpdateType>::FromMojom(MdnsListenerUpdateType input, net::MdnsListenerUpdateType* output)
{
    switch (input) {
...
// static
network::mojom::SecureDnsMode EnumTraits<network::mojom::SecureDnsMode, net::SecureDnsMode>::ToMojom(net::SecureDnsMode secure_dns_mode)
{
...
// static
bool EnumTraits<network::mojom::SecureDnsMode, net::SecureDnsMode>::FromMojom(network::mojom::SecureDnsMode in, net::SecureDnsMode* out)
{
    switch (in) {
...
// static
network::mojom::SecureDnsPolicy EnumTraits<network::mojom::SecureDnsPolicy, net::SecureDnsPolicy>::ToMojom(net::SecureDnsPolicy secure_dns_policy)
{
...
// static
bool EnumTraits<network::mojom::SecureDnsPolicy, net::SecureDnsPolicy>::FromMojom(network::mojom::SecureDnsPolicy in, net::SecureDnsPolicy* out)
{
    switch (in) {
