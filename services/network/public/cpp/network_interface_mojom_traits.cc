...
bool StructTraits<network::mojom::NetworkInterfaceDataView, net::NetworkInterface>::Read(
    network::mojom::NetworkInterfaceDataView data, net::NetworkInterface* out)
{
    ...
    if (!view.is_null()) {
        ...
        std::copy_n(view.data(), out->mac_address->size(), out->mac_address->begin());
    } else {
...
network::mojom::ConnectionType EnumTraits<network::mojom::ConnectionType, net::NetworkChangeNotifier::ConnectionType>::ToMojom(
...
bool EnumTraits<network::mojom::ConnectionType, net::NetworkChangeNotifier::ConnectionType>::FromMojom(
    network::mojom::ConnectionType input, net::NetworkChangeNotifier::ConnectionType* output)
{
    switch (input) {
    ...
    case network::mojom::ConnectionType::CONNECTION_BLUETOOTH:
        *output = net::NetworkChangeNotifier::ConnectionType::CONNECTION_BLUETOOTH;
        return true;
    }
    return false;
}
