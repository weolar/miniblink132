...
struct COMPONENT_EXPORT(NETWORK_CPP_DOCUMENT_ISOLATION) DocumentIsolationPolicy final {
    ...
    mojom::DocumentIsolationPolicyValue value = mojom::DocumentIsolationPolicyValue::kNone;
    std::optional<std::string> reporting_endpoint;
    mojom::DocumentIsolationPolicyValue report_only_value = mojom::DocumentIsolationPolicyValue::kNone;
