...
template <> struct EnumTraits<network::mojom::AddressFamily, net::AddressFamily> {
    static network::mojom::AddressFamily ToMojom(net::AddressFamily address_family);
    static bool FromMojom(network::mojom::AddressFamily address_family, net::AddressFamily* out);
};
