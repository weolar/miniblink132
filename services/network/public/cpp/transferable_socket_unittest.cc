...
TEST_F(TransferableSocketTest, MojoTraits)
{
...
#endif
    std::unique_ptr<net::TCPSocket> socket = net::TCPSocket::Create(nullptr, nullptr, net::NetLogSource());
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojom::TransferableSocket>(transferable, roundtripped));
