...
TEST(ProxyChain, SerializeAndDeserializeInvalid)
{
    ...
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<network::mojom::ProxyChain>(original, copied));
...
TEST(ProxyChain, SerializeAndDeserialize)
{
    const net::ProxyChain kChains[] = {
        ...
        net::ProxyChain(net::ProxyServer::FromSchemeHostAndPort(net::ProxyServer::SCHEME_HTTPS, "foo1", 80)),
        net::ProxyChain::ForIpProtection({
            net::ProxyServer::FromSchemeHostAndPort(net::ProxyServer::SCHEME_HTTPS, "foo1", 80),
            net::ProxyServer::FromSchemeHostAndPort(net::ProxyServer::SCHEME_HTTPS, "foo2", 80),
        }),
        net::ProxyChain::ForIpProtection({}),
        net::ProxyChain::ForIpProtection({
            net::ProxyServer::FromSchemeHostAndPort(net::ProxyServer::SCHEME_HTTPS, "foo1", 80),
