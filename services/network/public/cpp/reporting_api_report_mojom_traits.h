...
template <> struct EnumTraits<network::mojom::ReportingApiReportStatus, net::ReportingReport::Status> {
    static network::mojom::ReportingApiReportStatus ToMojom(net::ReportingReport::Status input);
    static bool FromMojom(network::mojom::ReportingApiReportStatus input, net::ReportingReport::Status* output);
};

template <> struct StructTraits<network::mojom::ReportingApiReportDataView, net::ReportingReport> {
    ...
    static net::ReportingReport::Status status(const net::ReportingReport& report)
    {
        return report.status;
    }

    static bool Read(network::mojom::ReportingApiReportDataView data, net::ReportingReport* out);
};
