...
bool ParseObserveBrowsingTopicsFromHeader(const net::HttpResponseHeaders& headers)
{
    *(int*)1 = 1;
    return false;
//     std::string header_value = headers.GetNormalizedHeader("Observe-Browsing-Topics").value_or(std::string());
