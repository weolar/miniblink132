...
// static
bool StructTraits<network::mojom::HostResolverEndpointResultDataView, net::HostResolverEndpointResult>::Read(
    network::mojom::HostResolverEndpointResultDataView data, net::HostResolverEndpointResult* out)
{
