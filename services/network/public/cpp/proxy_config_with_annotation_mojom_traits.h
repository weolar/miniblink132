...
template <> struct COMPONENT_EXPORT(NETWORK_CPP_PROXY_CONFIG) StructTraits<network::mojom::ProxyConfigWithAnnotationDataView, net::ProxyConfigWithAnnotation> {
public:
    static const net::ProxyConfig& value(const net::ProxyConfigWithAnnotation& r)
    {
        return r.value();
    }
    static const net::MutableNetworkTrafficAnnotationTag traffic_annotation(const net::ProxyConfigWithAnnotation& r)
    {
        return net::MutableNetworkTrafficAnnotationTag(r.traffic_annotation());
    }

    static bool Read(network::mojom::ProxyConfigWithAnnotationDataView data, net::ProxyConfigWithAnnotation* out_proxy_config);
};
