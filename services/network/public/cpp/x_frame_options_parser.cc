...
mojom::XFrameOptionsValue ParseXFrameOptions(const net::HttpResponseHeaders& headers)
{
    ...
    size_t iter = 0;
    while (std::optional<std::string_view> value = headers.EnumerateHeader(&iter, "x-frame-options")) {
