...
namespace network {
namespace {
const char kNoVarySearchSpecProposalUrl[] = "https://wicg.github.io/nav-speculation/no-vary-search.html";

const char kRFC8941DictionaryDefinitionUrl[] = "https://www.rfc-editor.org/rfc/rfc8941.html#name-dictionaries";
} // namespace

mojom::NoVarySearchWithParseErrorPtr ParseNoVarySearch(const net::HttpResponseHeaders& headers)
{
    ...
    ASSIGN_OR_RETURN(const auto no_vary_search_data, net::HttpNoVarySearchData::ParseFromHeaders(headers), ([](Input error) {
        ...
        return mojom::NoVarySearchWithParseError::NewParseError(map_error(error));
    }));
    ...
    if (no_vary_search_data.vary_by_default()) {
        no_vary_search->search_variance = mojom::SearchParamsVariance::NewNoVaryParams(
            std::vector<std::string>(no_vary_search_data.no_vary_params().begin(), no_vary_search_data.no_vary_params().end()));
        return mojom::NoVarySearchWithParseError::NewNoVarySearch(std::move(no_vary_search));
    }
    no_vary_search->search_variance = mojom::SearchParamsVariance::NewVaryParams(
        std::vector<std::string>(no_vary_search_data.vary_params().begin(), no_vary_search_data.vary_params().end()));
    return mojom::NoVarySearchWithParseError::NewNoVarySearch(std::move(no_vary_search));
}

std::optional<std::string> GetNoVarySearchConsoleMessage(const mojom::NoVarySearchParseError& error, const GURL& preloaded_url)
{
    switch (error) {
    case network::mojom::NoVarySearchParseError::kOk:
        return std::nullopt;
    case network::mojom::NoVarySearchParseError::kDefaultValue:
        return base::StringPrintf("No-Vary-Search header value received for prefetched url %s"
    ...
    case network::mojom::NoVarySearchParseError::kNotDictionary:
        return base::StringPrintf("No-Vary-Search header value received for prefetched url %s"
                                  ...
                                  " information: %s.",
            preloaded_url.spec().c_str(), kRFC8941DictionaryDefinitionUrl, kNoVarySearchSpecProposalUrl);
...
std::optional<std::string> GetNoVarySearchHintConsoleMessage(const mojom::NoVarySearchParseError& error)
{
    switch (error) {
    case network::mojom::NoVarySearchParseError::kOk:
        return std::nullopt;
    case network::mojom::NoVarySearchParseError::kDefaultValue:
        return base::StringPrintf("No-Vary-Search hint value is equivalent to the default behavior."
    ...
    case network::mojom::NoVarySearchParseError::kNotDictionary:
        return base::StringPrintf("No-Vary-Search hint value is not a dictionary as defined in"
                                  " RFC8941: %s. See No-Vary-Search specification for more"
                                  " information: %s.",
            kRFC8941DictionaryDefinitionUrl, kNoVarySearchSpecProposalUrl);
    case network::mojom::NoVarySearchParseError::kUnknownDictionaryKey:
        return base::StringPrintf("No-Vary-Search hint value contains unknown dictionary keys."
                                  " Valid dictionary keys are: \"params\", \"except\", \"key-order\"."
                                  " See No-Vary-Search specification for more information: %s.",
            kNoVarySearchSpecProposalUrl);
    case network::mojom::NoVarySearchParseError::kNonBooleanKeyOrder:
        return base::StringPrintf("No-Vary-Search hint value contains a \"key-order\" dictionary"
                                  " value that is not a boolean."
                                  " See No-Vary-Search specification for more information: %s.",
            kNoVarySearchSpecProposalUrl);
    case network::mojom::NoVarySearchParseError::kParamsNotStringList:
        return base::StringPrintf("No-Vary-Search hint value contains a \"params\" dictionary value"
                                  " that is not a list of strings or a boolean."
                                  " See No-Vary-Search specification for more information: %s.",
            kNoVarySearchSpecProposalUrl);
    case network::mojom::NoVarySearchParseError::kExceptNotStringList:
        return base::StringPrintf("No-Vary-Search hint value contains an \"except\" dictionary value"
                                  " that is not a list of strings."
                                  " See No-Vary-Search specification for more information: %s.",
            kNoVarySearchSpecProposalUrl);
    case network::mojom::NoVarySearchParseError::kExceptWithoutTrueParams:
        return base::StringPrintf("No-Vary-Search hint value contains an \"except\" dictionary key"
