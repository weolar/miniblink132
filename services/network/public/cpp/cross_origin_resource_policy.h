...
public:
    ...
    // process.
    [[nodiscard]] static std::optional<mojom::BlockedByResponseReason> IsBlocked(const GURL& request_url, const GURL& original_url,
    ...
    [[nodiscard]] static std::optional<mojom::BlockedByResponseReason> IsBlockedByHeaderValue(const GURL& request_url, const GURL& original_url,
    ...
    // etc.
    static std::optional<mojom::BlockedByResponseReason> IsNavigationBlocked(const GURL& request_url, const GURL& original_url,
    ...
    static ParsedHeader ParseHeaderForTesting(const net::HttpResponseHeaders* headers);
    ...
    // GURL::DomainIs.
    static bool ShouldAllowSameSiteForTesting(const url::Origin& initiator, const url::Origin& target_origin);
};
