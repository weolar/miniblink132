...
TEST(URLLoaderCompletionStatusMojomTraitsTest, MojoRoundTrip)
{
    ...
    original.cors_error_status = CorsErrorStatus(mojom::CorsError::kInsecurePrivateNetwork);
    original.trust_token_operation_status = mojom::TrustTokenOperationStatus::kInvalidArgument;
    original.blocked_by_response_reason = mojom::BlockedByResponseReason::kCorpNotSameOrigin;
    ...
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::URLLoaderCompletionStatus>(original, copy));
