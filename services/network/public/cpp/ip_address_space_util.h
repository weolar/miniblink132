...
std::string_view COMPONENT_EXPORT(NETWORK_CPP) IPAddressSpaceToStringPiece(mojom::IPAddressSpace space);
...
mojom::IPAddressSpace COMPONENT_EXPORT(NETWORK_CPP) IPAddressToIPAddressSpace(const net::IPAddress& address);
...
mojom::IPAddressSpace COMPONENT_EXPORT(NETWORK_CPP) TransportInfoToIPAddressSpace(const net::TransportInfo& info);
...
//  - local
//
bool COMPONENT_EXPORT(NETWORK_CPP) IsLessPublicAddressSpace(mojom::IPAddressSpace lhs, mojom::IPAddressSpace rhs);
...
public:
    ...
    const std::optional<mojom::IPAddressSpace> client_address_space_inherited_from_service_worker;
...
mojom::IPAddressSpace COMPONENT_EXPORT(NETWORK_CPP) CalculateClientAddressSpace(const GURL& url, std::optional<CalculateClientAddressSpaceParams> params);
...
mojom::IPAddressSpace COMPONENT_EXPORT(NETWORK_CPP) CalculateResourceAddressSpace(const GURL& url, const net::IPEndPoint& endpoint);
