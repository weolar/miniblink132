...
TEST(RequestDestinationTest, ToStringUseTheEmptyString)
{
    ...
    for (const auto& testcase : kTestCases) {
        ...
        EXPECT_EQ(testcase.expected_string, RequestDestinationToString(testcase.request_destination, EmptyRequestDestinationOption::kUseTheEmptyString));
    }
}
...
TEST(RequestDestinationTest, ToStringUseFiveCharEmptyString)
{
    ...
    for (const auto& testcase : kTestCases) {
        SCOPED_TRACE(testcase.request_destination);
        EXPECT_EQ(testcase.expected_string, RequestDestinationToString(testcase.request_destination, EmptyRequestDestinationOption::kUseFiveCharEmptyString));
    }
}
...
TEST(RequestDestinationTest, FromStringUseTheEmptyString)
{
    ...
    for (const auto& testcase : kTestCases) {
        ...
        EXPECT_EQ(testcase.expected_destination, RequestDestinationFromString(testcase.input, EmptyRequestDestinationOption::kUseTheEmptyString));
    }
}
...
TEST(RequestDestinationTest, FromStringUseFiveCharEmptyString)
{
    ...
    for (const auto& testcase : kTestCases) {
        SCOPED_TRACE(testcase.input);
        EXPECT_EQ(testcase.expected_destination, RequestDestinationFromString(testcase.input, EmptyRequestDestinationOption::kUseFiveCharEmptyString));
    }
}
