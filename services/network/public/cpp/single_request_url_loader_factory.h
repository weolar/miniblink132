...
class /*COMPONENT_EXPORT(NETWORK_CPP)*/ SingleRequestURLLoaderFactory : public network::SharedURLLoaderFactory {
public:
    using RequestHandler = base::OnceCallback<void(const network::ResourceRequest& resource_request, mojo::PendingReceiver<network::mojom::URLLoader>,
    ...
    SingleRequestURLLoaderFactory& operator=(const SingleRequestURLLoaderFactory&) = delete;
...
private:
    ...
    mojo::ReceiverSet<network::mojom::URLLoaderFactory, scoped_refptr<SingleRequestURLLoaderFactory>> receivers_;
};
