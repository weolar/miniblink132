...
class COMPONENT_EXPORT(NETWORK_CPP) NetworkQualityTracker : public network::mojom::NetworkQualityEstimatorManagerClient {
public:
    class COMPONENT_EXPORT(NETWORK_CPP) EffectiveConnectionTypeObserver {
    public:
        EffectiveConnectionTypeObserver(const EffectiveConnectionTypeObserver&) = delete;
        EffectiveConnectionTypeObserver& operator=(const EffectiveConnectionTypeObserver&) = delete;
        ...
        virtual void OnEffectiveConnectionTypeChanged(net::EffectiveConnectionType type) = 0;
    ...
    public:
        ...
        virtual void OnRTTOrThroughputEstimatesComputed(base::TimeDelta http_rtt, base::TimeDelta transport_rtt, int32_t downstream_throughput_kbps) = 0;

        RTTAndThroughputEstimatesObserver(const RTTAndThroughputEstimatesObserver&) = delete;
        RTTAndThroughputEstimatesObserver& operator=(const RTTAndThroughputEstimatesObserver&) = delete;
    ...
    // service.
    explicit NetworkQualityTracker(base::RepeatingCallback<network::mojom::NetworkService*()> callback);
    ...
    void ReportEffectiveConnectionTypeForTesting(net::EffectiveConnectionType effective_connection_type);
    ...
    void ReportRTTsAndThroughputForTesting(base::TimeDelta http_rtt, int32_t downstream_throughput_kbps);
...
protected:
    ...
    void OnNetworkQualityChanged(net::EffectiveConnectionType effective_connection_type, base::TimeDelta http_rtt, base::TimeDelta transport_rtt,
...
private:
    ...
    // use.
    const base::RepeatingCallback<network::mojom::NetworkService*()> get_network_service_callback_;
    ...
    base::ObserverList<RTTAndThroughputEstimatesObserver>::Unchecked rtt_and_throughput_observer_list_;

    mojo::Receiver<network::mojom::NetworkQualityEstimatorManagerClient> receiver_ { this };
