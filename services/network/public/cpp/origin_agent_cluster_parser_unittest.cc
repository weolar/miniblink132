...
TEST(OriginAgentClusterHeaderTest, Parse)
{
    ...
    EXPECT_EQ(ParseOriginAgentCluster("?1;param"), OriginAgentClusterValue::kTrue);
    EXPECT_EQ(ParseOriginAgentCluster("?1;param=value"), OriginAgentClusterValue::kTrue);
    EXPECT_EQ(ParseOriginAgentCluster("?1;param=value;param2=value2"), OriginAgentClusterValue::kTrue);
    EXPECT_EQ(ParseOriginAgentCluster("?0;param=value"), OriginAgentClusterValue::kFalse);
