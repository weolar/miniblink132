...
TEST(NetworkInterfaceChangeListenerMojomTraitsTest, IfAddrMsg)
{
    ...
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<network::mojom::IfAddrMsg>(original_msg, copied_msg));
...
TEST(NetworkInterfaceChangeListenerMojomTraitsTest, OnlineLinks)
{
    ...
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<network::mojom::OnlineLinks>(original_online_links, copied_online_links));
...
TEST(NetworkInterfaceChangeListenerMojomTraitsTest, AddressMap)
{
    ...
    net::AddressMapOwnerLinux::AddressMap original_address_map = { { ip_address1, msg1 }, { ip_address2, msg2 } };

    net::AddressMapOwnerLinux::AddressMap copied_address_map;
    EXPECT_TRUE(mojo::test::SerializeAndDeserialize<network::mojom::AddressMap>(original_address_map, copied_address_map));
