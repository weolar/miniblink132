...
class COMPONENT_EXPORT(NETWORK_CPP) WeakWrapperSharedURLLoaderFactory : public network::SharedURLLoaderFactory {
public:
    ...
    explicit WeakWrapperSharedURLLoaderFactory(mojom::URLLoaderFactory* factory_ptr);
    ...
    explicit WeakWrapperSharedURLLoaderFactory(base::OnceCallback<mojom::URLLoaderFactory*()> make_factory_ptr);
    ...
    void CreateLoaderAndStart(mojo::PendingReceiver<mojom::URLLoader> loader, int32_t request_id, uint32_t options, const network::ResourceRequest& request,
