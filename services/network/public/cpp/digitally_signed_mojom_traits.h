...
template <> struct EnumTraits<network::mojom::HashAlgorithm, net::ct::DigitallySigned::HashAlgorithm> {
    static network::mojom::HashAlgorithm ToMojom(net::ct::DigitallySigned::HashAlgorithm input)
    {
        switch (input) {
    ...
    static bool FromMojom(network::mojom::HashAlgorithm input, net::ct::DigitallySigned::HashAlgorithm* output)
    {
        switch (input) {
...
template <> struct EnumTraits<network::mojom::SignatureAlgorithm, net::ct::DigitallySigned::SignatureAlgorithm> {
    static network::mojom::SignatureAlgorithm ToMojom(net::ct::DigitallySigned::SignatureAlgorithm input)
    {
        switch (input) {
    ...
    static bool FromMojom(network::mojom::SignatureAlgorithm input, net::ct::DigitallySigned::SignatureAlgorithm* output)
    {
        switch (input) {
...
template <> struct StructTraits<network::mojom::DigitallySignedDataView, net::ct::DigitallySigned> {
    static net::ct::DigitallySigned::HashAlgorithm hash_algorithm(const net::ct::DigitallySigned& obj)
    {
        return obj.hash_algorithm;
    }
    static net::ct::DigitallySigned::SignatureAlgorithm signature_algorithm(const net::ct::DigitallySigned& obj)
    {
        return obj.signature_algorithm;
    }
    static base::span<const uint8_t> signature(const net::ct::DigitallySigned& obj)
    {
        return base::as_bytes(base::make_span(obj.signature_data));
    }

    static bool Read(network::mojom::DigitallySignedDataView obj, net::ct::DigitallySigned* out);
};
