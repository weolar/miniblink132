...
SelfDeletingURLLoaderFactory::SelfDeletingURLLoaderFactory(mojo::PendingReceiver<mojom::URLLoaderFactory> factory_receiver)
{
    receivers_.set_disconnect_handler(base::BindRepeating(&SelfDeletingURLLoaderFactory::OnDisconnect, base::Unretained(this)));
...
void SelfDeletingURLLoaderFactory::Clone(mojo::PendingReceiver<mojom::URLLoaderFactory> loader)
{
...
void SelfDeletingURLLoaderFactory::ReportBadMessage(const std::string& message)
{
