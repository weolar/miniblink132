...
constexpr char kBatchSimpleURLLoaderEnabledTrafficAnnotationHashesParam[] = "batching_enabled_traffic_annotation_hashes";
...
public:
    ...
    static bool IsBatchingEnabled(const net::NetworkTrafficAnnotationTag& traffic_annotation);
