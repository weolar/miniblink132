...
bool StructTraits<network::mojom::CookieSettingOverridesDataView, net::CookieSettingOverrides>::Read(
    network::mojom::CookieSettingOverridesDataView data, net::CookieSettingOverrides* out)
{
