...
template <> struct StructTraits<network::mojom::MutablePartialNetworkTrafficAnnotationTagDataView, net::MutablePartialNetworkTrafficAnnotationTag> {
    static int32_t unique_id_hash_code(const net::MutablePartialNetworkTrafficAnnotationTag& traffic_annotation)
    {
        return traffic_annotation.unique_id_hash_code;
    }
    static int32_t completing_id_hash_code(const net::MutablePartialNetworkTrafficAnnotationTag& traffic_annotation)
    {
    ...
    static bool Read(network::mojom::MutablePartialNetworkTrafficAnnotationTagDataView data, net::MutablePartialNetworkTrafficAnnotationTag* out)
    {
