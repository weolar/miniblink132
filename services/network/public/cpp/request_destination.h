...
const char* RequestDestinationToString(
    network::mojom::RequestDestination dest, EmptyRequestDestinationOption option = EmptyRequestDestinationOption::kUseTheEmptyString);
...
std::optional<network::mojom::RequestDestination> RequestDestinationFromString(
    std::string_view dest_str, EmptyRequestDestinationOption option = EmptyRequestDestinationOption::kUseTheEmptyString);
