...
// static
bool StructTraits<network::mojom::ParsedRequestCookieDataView, net::cookie_util::ParsedRequestCookie>::Read(
    network::mojom::ParsedRequestCookieDataView data, net::cookie_util::ParsedRequestCookie* out)
{
