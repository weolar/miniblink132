...
namespace mojo {
network::mojom::EcnMarking EnumTraits<network::mojom::EcnMarking, rtc::EcnMarking>::ToMojom(rtc::EcnMarking input)
{
    switch (input) {
...
bool EnumTraits<network::mojom::EcnMarking, rtc::EcnMarking>::FromMojom(network::mojom::EcnMarking input, rtc::EcnMarking* output)
{
    switch (input) {
