...
template <> struct COMPONENT_EXPORT(NETWORK_CPP_BASE) StructTraits<network::mojom::WebTransportErrorDataView, net::WebTransportError> {
    ...
    static bool Read(network::mojom::WebTransportErrorDataView in, net::WebTransportError* out);
};
