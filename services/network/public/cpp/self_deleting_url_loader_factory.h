...
class COMPONENT_EXPORT(NETWORK_CPP) SelfDeletingURLLoaderFactory : public mojom::URLLoaderFactory {
public:
    SelfDeletingURLLoaderFactory(const SelfDeletingURLLoaderFactory&) = delete;
    SelfDeletingURLLoaderFactory& operator=(const SelfDeletingURLLoaderFactory&) = delete;
...
protected:
    ...
    explicit SelfDeletingURLLoaderFactory(mojo::PendingReceiver<mojom::URLLoaderFactory> factory_receiver);
