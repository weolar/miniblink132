...
template <> struct COMPONENT_EXPORT(NETWORK_CPP_BASE) StructTraits<network::mojom::LoadTimingInfoConnectTimingDataView, net::LoadTimingInfo::ConnectTiming> {
    static base::TimeTicks domain_lookup_start(const net::LoadTimingInfo::ConnectTiming& obj)
    {
        return obj.domain_lookup_start;
    }

    static base::TimeTicks domain_lookup_end(const net::LoadTimingInfo::ConnectTiming& obj)
    {
        return obj.domain_lookup_end;
    }

    static base::TimeTicks connect_start(const net::LoadTimingInfo::ConnectTiming& obj)
    {
        return obj.connect_start;
    }

    static base::TimeTicks connect_end(const net::LoadTimingInfo::ConnectTiming& obj)
    {
        return obj.connect_end;
    }

    static base::TimeTicks ssl_start(const net::LoadTimingInfo::ConnectTiming& obj)
    {
        return obj.ssl_start;
    }

    static base::TimeTicks ssl_end(const net::LoadTimingInfo::ConnectTiming& obj)
    {
        return obj.ssl_end;
    }

    static bool Read(network::mojom::LoadTimingInfoConnectTimingDataView obj, net::LoadTimingInfo::ConnectTiming* output);
};

template <> struct COMPONENT_EXPORT(NETWORK_CPP_BASE) StructTraits<network::mojom::LoadTimingInfoDataView, net::LoadTimingInfo> {
    ...
    static net::LoadTimingInfo::ConnectTiming connect_timing(const net::LoadTimingInfo& obj)
    {
    ...
    static base::TimeTicks receive_non_informational_headers_start(const net::LoadTimingInfo& obj)
    {
        return obj.receive_non_informational_headers_start;
    }

    static base::TimeTicks first_early_hints_time(const net::LoadTimingInfo& obj)
    {
    ...
    static base::TimeTicks service_worker_start_time(const net::LoadTimingInfo& obj)
    {
        return obj.service_worker_start_time;
    }

    static base::TimeTicks service_worker_ready_time(const net::LoadTimingInfo& obj)
    {
        return obj.service_worker_ready_time;
    }

    static base::TimeTicks service_worker_fetch_start(const net::LoadTimingInfo& obj)
    {
        return obj.service_worker_fetch_start;
    }

    static base::TimeTicks service_worker_router_evaluation_start(const net::LoadTimingInfo& obj)
    {
        return obj.service_worker_router_evaluation_start;
    }

    static base::TimeTicks service_worker_cache_lookup_start(const net::LoadTimingInfo& obj)
    {
        return obj.service_worker_cache_lookup_start;
    }

    static base::TimeTicks service_worker_respond_with_settled(const net::LoadTimingInfo& obj)
    {
        return obj.service_worker_respond_with_settled;
    }

    static bool Read(network::mojom::LoadTimingInfoDataView obj, net::LoadTimingInfo* output);
};
