...
// verify certificates.
class MojoCertVerifier : public net::CertVerifier, public mojom::CertVerifierServiceClient {
public:
    using ReconnectURLLoaderFactory = base::RepeatingCallback<void(mojo::PendingReceiver<network::mojom::URLLoaderFactory>)>;
    ...
    MojoCertVerifier(mojo::PendingRemote<mojom::CertVerifierService> mojo_cert_verifier,
    ...
    int Verify(const net::CertVerifier::RequestParams& params, net::CertVerifyResult* verify_result, net::CompletionOnceCallback callback,
        std::unique_ptr<net::CertVerifier::Request>* out_req, const net::NetLogWithSource& net_log) override;
