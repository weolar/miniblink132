...
// static
bool StructTraits<network::mojom::ConnectionEndpointMetadataDataView, net::ConnectionEndpointMetadata>::Read(
    network::mojom::ConnectionEndpointMetadataDataView data, net::ConnectionEndpointMetadata* out)
{
