...
inline void RecordOnTransferSizeUpdatedUMA(OnTransferSizeUpdatedFrom class_name)
{
    UMA_HISTOGRAM_ENUMERATION("Net.OnTransferSizeUpdated.Experimental.OverridenBy", class_name);
}
