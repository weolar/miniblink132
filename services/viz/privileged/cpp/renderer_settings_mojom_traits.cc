...
// static
bool StructTraits<viz::mojom::OcclusionCullerSettingsDataView, viz::RendererSettings::OcclusionCullerSettings>::Read(
    viz::mojom::OcclusionCullerSettingsDataView data, viz::RendererSettings::OcclusionCullerSettings* out)
{
...
// static
bool StructTraits<viz::mojom::DebugRendererSettingsDataView, viz::DebugRendererSettings>::Read(
    viz::mojom::DebugRendererSettingsDataView data, viz::DebugRendererSettings* out)
{
    out->tint_composited_content = data.tint_composited_content();
    out->tint_composited_content_modulate = data.tint_composited_content_modulate();
...
// static
bool StructTraits<viz::mojom::RendererSettingsDataView, viz::RendererSettings>::Read(viz::mojom::RendererSettingsDataView data, viz::RendererSettings* out)
{
    ...
    out->slow_down_compositing_scale_factor = data.slow_down_compositing_scale_factor();
