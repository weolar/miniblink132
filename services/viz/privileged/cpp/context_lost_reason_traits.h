...
template <> struct EnumTraits<viz::mojom::ContextLostReason, gpu::error::ContextLostReason> {
    static viz::mojom::ContextLostReason ToMojom(gpu::error::ContextLostReason reason)
    {
        switch (reason) {
    ...
    static bool FromMojom(viz::mojom::ContextLostReason reason, gpu::error::ContextLostReason* out)
    {
        switch (reason) {
