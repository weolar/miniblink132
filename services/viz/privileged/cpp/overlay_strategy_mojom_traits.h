...
template <> struct EnumTraits<viz::mojom::OverlayStrategy, viz::OverlayStrategy> {
    ...
    static bool FromMojom(viz::mojom::OverlayStrategy reason, viz::OverlayStrategy* out)
    {
        switch (reason) {
