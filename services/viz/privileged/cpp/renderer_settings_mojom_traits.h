...
namespace mojo {
template <> struct StructTraits<viz::mojom::DebugRendererSettingsDataView, viz::DebugRendererSettings> {
    static bool tint_composited_content(const viz::DebugRendererSettings& input)
    {
        return input.tint_composited_content;
    }

    static bool tint_composited_content_modulate(const viz::DebugRendererSettings& input)
    {
    ...
    static bool show_dc_layer_debug_borders(const viz::DebugRendererSettings& input)
    {
    ...
    static bool Read(viz::mojom::DebugRendererSettingsDataView data, viz::DebugRendererSettings* out);
};

template <> struct StructTraits<viz::mojom::OcclusionCullerSettingsDataView, viz::RendererSettings::OcclusionCullerSettings> {
    static int quad_split_limit(const viz::RendererSettings::OcclusionCullerSettings& input)
    {
        return input.quad_split_limit;
    }

    static int maximum_occluder_complexity(const viz::RendererSettings::OcclusionCullerSettings& input)
    {
        return input.maximum_occluder_complexity;
    }

    static int minimum_fragments_reduced(const viz::RendererSettings::OcclusionCullerSettings& input)
    {
        return input.minimum_fragments_reduced;
    }

    static bool Read(viz::mojom::OcclusionCullerSettingsDataView data, viz::RendererSettings::OcclusionCullerSettings* out);
};

template <> struct StructTraits<viz::mojom::RendererSettingsDataView, viz::RendererSettings> {
    ...
    static bool should_clear_root_render_pass(const viz::RendererSettings& input)
    {
        return input.should_clear_root_render_pass;
    }

    static bool release_overlay_resources_after_gpu_query(const viz::RendererSettings& input)
    {
    ...
    static int slow_down_compositing_scale_factor(const viz::RendererSettings& input)
    {
    ...
    static viz::RendererSettings::OcclusionCullerSettings occlusion_culler_settings(const viz::RendererSettings& input)
    {
...
#if BUILDFLAG(IS_OZONE)
    static std::vector<viz::OverlayStrategy> overlay_strategies(const viz::RendererSettings& input)
    {
    ...
    static bool Read(viz::mojom::RendererSettingsDataView data, viz::RendererSettings* out);
};
