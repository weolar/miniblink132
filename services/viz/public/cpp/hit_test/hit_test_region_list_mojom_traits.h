...
template <> struct StructTraits<viz::mojom::HitTestRegionDataView, viz::HitTestRegion> {
    static const viz::FrameSinkId& frame_sink_id(const viz::HitTestRegion& region)
    {
    ...
    static bool Read(viz::mojom::HitTestRegionDataView data, viz::HitTestRegion* out);
};

template <> struct StructTraits<viz::mojom::HitTestRegionListDataView, viz::HitTestRegionList> {
    ...
    static const std::vector<viz::HitTestRegion>& regions(const viz::HitTestRegionList& list)
    {
        return list.regions;
    }

    static bool Read(viz::mojom::HitTestRegionListDataView data, viz::HitTestRegionList* out);
};
