...
template <> struct StructTraits<viz::mojom::AggregatedHitTestRegionDataView, viz::AggregatedHitTestRegion> {
    static const viz::FrameSinkId& frame_sink_id(const viz::AggregatedHitTestRegion& region)
    {
    ...
    static uint32_t async_hit_test_reasons(const viz::AggregatedHitTestRegion& region)
    {
    ...
    static const gfx::Transform& transform(const viz::AggregatedHitTestRegion& region)
    {
        return region.transform;
    }

    static bool Read(viz::mojom::AggregatedHitTestRegionDataView data, viz::AggregatedHitTestRegion* out);
};
