...
template <> struct StructTraits<viz::mojom::OffsetTagDataView, viz::OffsetTag> {
...
template <> struct StructTraits<viz::mojom::OffsetTagValueDataView, viz::OffsetTagValue> {
    ...
    static bool Read(viz::mojom::OffsetTagValueDataView data, viz::OffsetTagValue* out);
};

template <> struct StructTraits<viz::mojom::OffsetTagDefinitionDataView, viz::OffsetTagDefinition> {
    ...
    static const viz::SurfaceRange& provider(const viz::OffsetTagDefinition& input)
    {
        return input.provider;
    }

    static const gfx::Vector2dF& min_offset(const viz::OffsetTagDefinition& input)
    {
        return input.constraints.min_offset;
    }

    static const gfx::Vector2dF& max_offset(const viz::OffsetTagDefinition& input)
    {
        return input.constraints.max_offset;
    }

    static bool Read(viz::mojom::OffsetTagDefinitionDataView data, viz::OffsetTagDefinition* out);
};
