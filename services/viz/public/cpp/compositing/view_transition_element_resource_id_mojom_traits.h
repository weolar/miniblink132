...
template <> struct StructTraits<viz::mojom::ViewTransitionElementResourceIdDataView, viz::ViewTransitionElementResourceId> {
    static uint32_t local_id(const viz::ViewTransitionElementResourceId& resource_id)
    {
        return resource_id.local_id();
    }

    static std::optional<blink::ViewTransitionToken> transition_token(const viz::ViewTransitionElementResourceId& resource_id)
    {
    ...
    static bool Read(viz::mojom::ViewTransitionElementResourceIdDataView data, viz::ViewTransitionElementResourceId* out)
    {
        ...
        if (transition_token) {
            *out = viz::ViewTransitionElementResourceId(*transition_token, data.local_id());
        } else {
