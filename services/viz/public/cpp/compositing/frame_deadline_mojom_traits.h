...
template <> struct StructTraits<viz::mojom::FrameDeadlineDataView, viz::FrameDeadline> {
    ...
    static bool use_default_lower_bound_deadline(const viz::FrameDeadline& input)
    {
        return input.use_default_lower_bound_deadline();
    }

    static bool Read(viz::mojom::FrameDeadlineDataView data, viz::FrameDeadline* out);
};
