...
// static
viz::mojom::ResourceFormat EnumTraits<viz::mojom::ResourceFormat, viz::ResourceFormat>::ToMojom(viz::ResourceFormat format)
{
    switch (format) {
...
// static
bool EnumTraits<viz::mojom::ResourceFormat, viz::ResourceFormat>::FromMojom(viz::mojom::ResourceFormat format, viz::ResourceFormat* out)
{
    switch (format) {
