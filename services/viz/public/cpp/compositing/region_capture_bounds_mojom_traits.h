...
template <> struct StructTraits<viz::mojom::CropIdBoundsPairDataView, CropIdBoundsPair> {
    static base::Token crop_id(const CropIdBoundsPair& pair)
    {
        return pair.crop_id;
    }

    static gfx::Rect bounds(const CropIdBoundsPair& pair)
    {
        return pair.bounds;
    }

    static bool Read(viz::mojom::CropIdBoundsPairDataView data, CropIdBoundsPair* out)
    {
        base::Token crop_id;
        gfx::Rect bounds;
...
template <> struct StructTraits<viz::mojom::RegionCaptureBoundsDataView, viz::RegionCaptureBounds> {
    static std::vector<CropIdBoundsPair> bounds(const viz::RegionCaptureBounds& capture_bounds)
    {
    ...
    static bool Read(viz::mojom::RegionCaptureBoundsDataView data, viz::RegionCaptureBounds* out)
    {
