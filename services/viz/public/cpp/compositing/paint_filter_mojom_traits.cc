...
// static
std::optional<std::vector<uint8_t>> StructTraits<viz::mojom::PaintFilterDataView, sk_sp<cc::PaintFilter>>::data(const sk_sp<cc::PaintFilter>& filter)
{
    ...
    cc::PaintOpWriter writer(memory.data(), memory.size(), options, true /* enable_security_constraints */);
...
// static
bool StructTraits<viz::mojom::PaintFilterDataView, sk_sp<cc::PaintFilter>>::Read(viz::mojom::PaintFilterDataView data, sk_sp<cc::PaintFilter>* out)
{
