...
template <> struct EnumTraits<viz::mojom::ThreadType, viz::Thread::Type> {
...
template <> struct StructTraits<viz::mojom::ThreadDataView, viz::Thread> {
    static uint32_t id(const viz::Thread& thread)
    {
        return thread.id;
    }
