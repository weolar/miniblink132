...
void Release(mojo::PendingRemote<viz::mojom::TextureReleaser> pending_remote, const gpu::SyncToken& sync_token, bool is_lost)
{
...
// static
viz::mojom::CopyOutputResultFormat EnumTraits<viz::mojom::CopyOutputResultFormat, viz::CopyOutputResult::Format>::ToMojom(viz::CopyOutputResult::Format format)
{
    switch (format) {
...
// static
bool EnumTraits<viz::mojom::CopyOutputResultFormat, viz::CopyOutputResult::Format>::FromMojom(
    viz::mojom::CopyOutputResultFormat input, viz::CopyOutputResult::Format* out)
{
    switch (input) {
...
// static
viz::mojom::CopyOutputResultDestination EnumTraits<viz::mojom::CopyOutputResultDestination, viz::CopyOutputResult::Destination>::ToMojom(
...
// static
bool EnumTraits<viz::mojom::CopyOutputResultDestination, viz::CopyOutputResult::Destination>::FromMojom(
    viz::mojom::CopyOutputResultDestination input, viz::CopyOutputResult::Destination* out)
{
    switch (input) {
...
// static
viz::CopyOutputResult::Format StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::format(
...
// static
viz::CopyOutputResult::Destination StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::destination(
    const std::unique_ptr<viz::CopyOutputResult>& result)
{
...
// static
const gfx::Rect& StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::rect(
    const std::unique_ptr<viz::CopyOutputResult>& result)
{
    return result->rect();
}
...
// static
std::optional<viz::CopyOutputResult::ScopedSkBitmap> StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::bitmap(
    const std::unique_ptr<viz::CopyOutputResult>& result)
{
    if (result->destination() != viz::CopyOutputResult::Destination::kSystemMemory)
        return std::nullopt;
...
// static
mojo::OptionalAsPointer<const gpu::Mailbox> StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::mailbox(
    const std::unique_ptr<viz::CopyOutputResult>& result)
{
    if (result->destination() != viz::CopyOutputResult::Destination::kNativeTextures || result->IsEmpty()) {
        return nullptr;
    }
...
// static
mojo::OptionalAsPointer<const gfx::ColorSpace> StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::color_space(
    const std::unique_ptr<viz::CopyOutputResult>& result)
{
    if (result->destination() != viz::CopyOutputResult::Destination::kNativeTextures || result->IsEmpty()) {
        return nullptr;
...
// static
mojo::PendingRemote<viz::mojom::TextureReleaser> StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::releaser(
    const std::unique_ptr<viz::CopyOutputResult>& result)
{
    if (result->destination() != viz::CopyOutputResult::Destination::kNativeTextures)
    ...
    MakeSelfOwnedReceiver(std::make_unique<TextureReleaserImpl>(release_callbacks.empty() ? viz::ReleaseCallback {} : std::move(release_callbacks[0])),
        releaser.InitWithNewPipeAndPassReceiver());
    return releaser;
}

// static
bool StructTraits<viz::mojom::CopyOutputResultDataView, std::unique_ptr<viz::CopyOutputResult>>::Read(
    viz::mojom::CopyOutputResultDataView data, std::unique_ptr<viz::CopyOutputResult>* out_p)
{
    ...
    if (!data.ReadFormat(&format) || !data.ReadDestination(&destination) || !data.ReadRect(&rect)) {
        return false;
    }

    if (rect.IsEmpty()) {
        // An empty rect implies an empty result.
        *out_p = std::make_unique<viz::CopyOutputResult>(format, destination, gfx::Rect(), false);
        return true;
    }
    ...
    case viz::CopyOutputResult::Format::RGBA:
        ...
        case viz::CopyOutputResult::Destination::kSystemMemory: {
            ...
            *out_p = std::make_unique<viz::CopyOutputSkBitmapResult>(rect, std::move(*bitmap_opt));
            return true;
        }
        ...
        case viz::CopyOutputResult::Destination::kNativeTextures: {
            ...
            auto releaser = data.TakeReleaser<mojo::PendingRemote<viz::mojom::TextureReleaser>>();
            if (!releaser)
            ...
            release_callbacks.emplace_back(base::BindOnce(&Release, std::move(releaser)));

            *out_p = std::make_unique<viz::CopyOutputTextureResult>(
                viz::CopyOutputResult::Format::RGBA, rect, viz::CopyOutputResult::TextureResult(*mailbox, *color_space), std::move(release_callbacks));
            return true;
        }
        }
