...
viz::DrawQuad* AllocateAndConstruct(viz::mojom::DrawQuadStateDataView::Tag material, viz::QuadList* list);

template <> struct EnumTraits<viz::mojom::ProtectedVideoState, gfx::ProtectedVideoType> {
    static viz::mojom::ProtectedVideoState ToMojom(gfx::ProtectedVideoType input)
    {
        switch (input) {
    ...
    static bool FromMojom(viz::mojom::ProtectedVideoState input, gfx::ProtectedVideoType* out)
    {
        switch (input) {
...
template <> struct EnumTraits<viz::mojom::OverlayPriority, viz::OverlayPriority> {
    ...
    static bool FromMojom(viz::mojom::OverlayPriority input, viz::OverlayPriority* out)
    {
        switch (input) {
...
template <> struct StructTraits<viz::mojom::RoundedDisplayMasksInfoDataView, viz::TextureDrawQuad::RoundedDisplayMasksInfo> {
    static bool is_horizontally_positioned(const viz::TextureDrawQuad::RoundedDisplayMasksInfo& input)
    {
        return input.is_horizontally_positioned;
    }

    static base::span<const uint8_t> radii(const viz::TextureDrawQuad::RoundedDisplayMasksInfo& input)
    {
        return input.radii;
    }

    static bool Read(viz::mojom::RoundedDisplayMasksInfoDataView data, viz::TextureDrawQuad::RoundedDisplayMasksInfo* out);
};

template <> struct UnionTraits<viz::mojom::DrawQuadStateDataView, viz::DrawQuad> {
    static viz::mojom::DrawQuadStateDataView::Tag GetTag(const viz::DrawQuad& quad)
    {
    ...
    static const viz::DrawQuad& debug_border_quad_state(const viz::DrawQuad& quad)
    {
        return quad;
    }

    static const viz::DrawQuad& render_pass_quad_state(const viz::DrawQuad& quad)
    {
        return quad;
    }

    static const viz::DrawQuad& solid_color_quad_state(const viz::DrawQuad& quad)
    {
        return quad;
    }
    ...
    static const viz::DrawQuad& stream_video_quad_state(const viz::DrawQuad& quad)
    {
        return quad;
    }
    ...
    static const viz::DrawQuad& shared_element_quad_state(const viz::DrawQuad& quad)
    {
        return quad;
    }
...
template <> struct StructTraits<viz::mojom::SharedElementQuadStateDataView, viz::DrawQuad> {
    static const viz::ViewTransitionElementResourceId& element_resource_id(const viz::DrawQuad& input)
    {
        const viz::SharedElementDrawQuad* quad = viz::SharedElementDrawQuad::MaterialCast(&input);
        return quad->element_resource_id;
    }

    static bool Read(viz::mojom::SharedElementQuadStateDataView data, viz::DrawQuad* out);
};

template <> struct StructTraits<viz::mojom::VideoHoleQuadStateDataView, viz::DrawQuad> {
    static const base::UnguessableToken& overlay_plane_id(const viz::DrawQuad& input)
    {
        const viz::VideoHoleDrawQuad* quad = viz::VideoHoleDrawQuad::MaterialCast(&input);
        return quad->overlay_plane_id;
    }

    static bool Read(viz::mojom::VideoHoleQuadStateDataView data, viz::DrawQuad* out);
};

template <> struct StructTraits<viz::mojom::DebugBorderQuadStateDataView, viz::DrawQuad> {
    static SkColor4f color(const viz::DrawQuad& input)
    {
        const viz::DebugBorderDrawQuad* quad = viz::DebugBorderDrawQuad::MaterialCast(&input);
        return quad->color;
    }
    ...
    static bool Read(viz::mojom::DebugBorderQuadStateDataView data, viz::DrawQuad* out);
};

template <> struct StructTraits<viz::mojom::CompositorRenderPassQuadStateDataView, viz::DrawQuad> {
    static viz::CompositorRenderPassId render_pass_id(const viz::DrawQuad& input)
    {
        const viz::CompositorRenderPassDrawQuad* quad = viz::CompositorRenderPassDrawQuad::MaterialCast(&input);
    ...
    static bool Read(viz::mojom::CompositorRenderPassQuadStateDataView data, viz::DrawQuad* out);
};

template <> struct StructTraits<viz::mojom::SolidColorQuadStateDataView, viz::DrawQuad> {
    static SkColor4f color(const viz::DrawQuad& input)
    {
        const viz::SolidColorDrawQuad* quad = viz::SolidColorDrawQuad::MaterialCast(&input);
        return quad->color;
    }
    ...
    static bool Read(viz::mojom::SolidColorQuadStateDataView data, viz::DrawQuad* out);
};

template <> struct StructTraits<viz::mojom::SurfaceQuadStateDataView, viz::DrawQuad> {
    static const viz::SurfaceRange& surface_range(const viz::DrawQuad& input)
    {
        const viz::SurfaceDrawQuad* quad = viz::SurfaceDrawQuad::MaterialCast(&input);
    ...
    static bool Read(viz::mojom::SurfaceQuadStateDataView data, viz::DrawQuad* out);
};

template <> struct StructTraits<viz::mojom::TextureQuadStateDataView, viz::DrawQuad> {
    static viz::ResourceId resource_id(const viz::DrawQuad& input)
    {
        const viz::TextureDrawQuad* quad = viz::TextureDrawQuad::MaterialCast(&input);
    ...
    static viz::TextureDrawQuad::RoundedDisplayMasksInfo rounded_display_masks_info(const viz::DrawQuad& input)
    {
        const viz::TextureDrawQuad* quad = viz::TextureDrawQuad::MaterialCast(&input);
    ...
    static gfx::ProtectedVideoType protected_video_type(const viz::DrawQuad& input)
    {
        const viz::TextureDrawQuad* quad = viz::TextureDrawQuad::MaterialCast(&input);
        return quad->protected_video_type;
    }

    static viz::OverlayPriority overlay_priority_hint(const viz::DrawQuad& input)
    {
        const viz::TextureDrawQuad* quad = viz::TextureDrawQuad::MaterialCast(&input);
        return quad->overlay_priority_hint;
    }

    static const std::optional<gfx::Rect>& damage_rect(const viz::DrawQuad& input)
    {
        const viz::TextureDrawQuad* quad = viz::TextureDrawQuad::MaterialCast(&input);
        return quad->damage_rect;
    }

    static bool Read(viz::mojom::TextureQuadStateDataView data, viz::DrawQuad* out);
};

template <> struct StructTraits<viz::mojom::TileQuadStateDataView, viz::DrawQuad> {
    static const gfx::RectF& tex_coord_rect(const viz::DrawQuad& input)
    {
...
template <> struct StructTraits<viz::mojom::DrawQuadDataView, DrawQuadWithSharedQuadState> {
    static const gfx::Rect& rect(const DrawQuadWithSharedQuadState& input)
    {
        return input.quad->rect;
    }

    static const gfx::Rect& visible_rect(const DrawQuadWithSharedQuadState& input)
    {
    ...
    static const viz::DrawQuad& draw_quad_state(const DrawQuadWithSharedQuadState& input)
    {
        return *input.quad;
    }
};
...
template <> struct StructTraits<viz::mojom::DrawQuadDataView, viz::DrawQuad> {
    static bool Read(viz::mojom::DrawQuadDataView data, viz::DrawQuad* out);
};

template <> struct ArrayTraits<viz::QuadList> {
    ...
    static size_t GetSize(const viz::QuadList& input)
    {
        return input.size();
    }
};
