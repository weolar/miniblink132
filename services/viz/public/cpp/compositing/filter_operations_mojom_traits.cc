...
// static
const std::vector<cc::FilterOperation>& StructTraits<viz::mojom::FilterOperationsDataView, cc::FilterOperations>::operations(
...
// static
bool StructTraits<viz::mojom::FilterOperationsDataView, cc::FilterOperations>::Read(viz::mojom::FilterOperationsDataView data, cc::FilterOperations* out)
{
