...
// static
viz::mojom::PlaneConfig EnumTraits<viz::mojom::PlaneConfig, viz::SharedImageFormat::PlaneConfig>::ToMojom(viz::SharedImageFormat::PlaneConfig plane_config)
{
    switch (plane_config) {
...
// static
bool EnumTraits<viz::mojom::PlaneConfig, viz::SharedImageFormat::PlaneConfig>::FromMojom(
    viz::mojom::PlaneConfig input, viz::SharedImageFormat::PlaneConfig* out)
{
    switch (input) {
...
// static
viz::mojom::Subsampling EnumTraits<viz::mojom::Subsampling, viz::SharedImageFormat::Subsampling>::ToMojom(viz::SharedImageFormat::Subsampling subsampling)
{
    switch (subsampling) {
...
// static
bool EnumTraits<viz::mojom::Subsampling, viz::SharedImageFormat::Subsampling>::FromMojom(
    viz::mojom::Subsampling input, viz::SharedImageFormat::Subsampling* out)
{
    switch (input) {
...
// static
viz::mojom::ChannelFormat EnumTraits<viz::mojom::ChannelFormat, viz::SharedImageFormat::ChannelFormat>::ToMojom(
...
// static
bool EnumTraits<viz::mojom::ChannelFormat, viz::SharedImageFormat::ChannelFormat>::FromMojom(
    viz::mojom::ChannelFormat input, viz::SharedImageFormat::ChannelFormat* out)
{
    switch (input) {
...
// static
bool StructTraits<viz::mojom::MultiplanarFormatDataView, viz::SharedImageFormat::SharedImageFormatUnion::MultiplanarFormat>::Read(
    viz::mojom::MultiplanarFormatDataView data, viz::SharedImageFormat::SharedImageFormatUnion::MultiplanarFormat* out)
{
...
bool UnionTraits<viz::mojom::SharedImageFormatDataView, viz::SharedImageFormat>::Read(viz::mojom::SharedImageFormatDataView data, viz::SharedImageFormat* out)
{
    switch (data.tag()) {
