...
template <> struct EnumTraits<viz::mojom::BeginFrameArgsType, viz::BeginFrameArgs::BeginFrameArgsType> {
    static viz::mojom::BeginFrameArgsType ToMojom(viz::BeginFrameArgs::BeginFrameArgsType type);

    static bool FromMojom(viz::mojom::BeginFrameArgsType input, viz::BeginFrameArgs::BeginFrameArgsType* out);
};

template <> struct StructTraits<viz::mojom::BeginFrameArgsDataView, viz::BeginFrameArgs> {
    ...
    static viz::BeginFrameArgs::BeginFrameArgsType type(const viz::BeginFrameArgs& args)
    {
        return args.type;
    }
    ...
    static bool Read(viz::mojom::BeginFrameArgsDataView data, viz::BeginFrameArgs* out);
};

template <> struct StructTraits<viz::mojom::BeginFrameAckDataView, viz::BeginFrameAck> {
    ...
    static std::optional<base::TimeDelta> preferred_frame_interval(const viz::BeginFrameAck& ack)
    {
        DCHECK(!ack.preferred_frame_interval || ack.preferred_frame_interval.value() >= base::TimeDelta());
