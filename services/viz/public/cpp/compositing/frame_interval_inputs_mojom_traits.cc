...
viz::mojom::ContentFrameIntervalType EnumTraits<viz::mojom::ContentFrameIntervalType, viz::ContentFrameIntervalType>::ToMojom(
...
bool EnumTraits<viz::mojom::ContentFrameIntervalType, viz::ContentFrameIntervalType>::FromMojom(
    viz::mojom::ContentFrameIntervalType input, viz::ContentFrameIntervalType* out)
{
    switch (input) {
...
bool StructTraits<viz::mojom::ContentFrameIntervalInfoDataView, viz::ContentFrameIntervalInfo>::Read(
    viz::mojom::ContentFrameIntervalInfoDataView info, viz::ContentFrameIntervalInfo* out)
{
...
bool StructTraits<viz::mojom::FrameIntervalInputsDataView, viz::FrameIntervalInputs>::Read(
    viz::mojom::FrameIntervalInputsDataView inputs, viz::FrameIntervalInputs* out)
{
    ...
    out->has_only_content_frame_interval_updates = inputs.has_only_content_frame_interval_updates();
    return true;
}
