...
template <> struct StructTraits<viz::mojom::CompositorRenderPassIdDataView, viz::CompositorRenderPassId> {
    static uint64_t value(const viz::CompositorRenderPassId& id);

    static bool Read(viz::mojom::CompositorRenderPassIdDataView data, viz::CompositorRenderPassId* out);
};
