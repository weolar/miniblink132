...
template <> struct StructTraits<viz::mojom::SubtreeCaptureIdDataView, viz::SubtreeCaptureId> {
    static base::Token subtree_id(const viz::SubtreeCaptureId& subtree_capture_id)
    {
        return subtree_capture_id.subtree_id();
    }

    static bool Read(viz::mojom::SubtreeCaptureIdDataView data, viz::SubtreeCaptureId* out)
    {
