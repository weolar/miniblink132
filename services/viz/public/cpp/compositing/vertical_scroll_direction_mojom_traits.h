...
template <> struct EnumTraits<viz::mojom::VerticalScrollDirection, viz::VerticalScrollDirection> {
    static viz::mojom::VerticalScrollDirection ToMojom(viz::VerticalScrollDirection in)
    {
        switch (in) {
    ...
    static bool FromMojom(viz::mojom::VerticalScrollDirection in, viz::VerticalScrollDirection* out)
    {
        switch (in) {
