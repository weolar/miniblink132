...
// static
uint32_t StructTraits<viz::mojom::ResourceIdDataView, viz::ResourceId>::value(const viz::ResourceId& id)
{
...
// static
bool StructTraits<viz::mojom::ResourceIdDataView, viz::ResourceId>::Read(viz::mojom::ResourceIdDataView data, viz::ResourceId* out)
{
