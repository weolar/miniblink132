...
template <> struct StructTraits<viz::mojom::FilterOperationsDataView, cc::FilterOperations> {
    static const std::vector<cc::FilterOperation>& operations(const cc::FilterOperations& operations);

    static bool Read(viz::mojom::FilterOperationsDataView data, cc::FilterOperations* out);
};
