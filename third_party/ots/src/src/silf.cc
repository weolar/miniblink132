...
bool OpenTypeSILF::Parse(const uint8_t* data, size_t length, bool prevent_decompression)
{
    ...
    if (this->version >> 16 != 1 && this->version >> 16 != 2 && this->version >> 16 != 3 && this->version >> 16 != 4 && this->version >> 16 != 5) {
    ...
    if (this->version >> 16 >= 5) {
        ...
        case 1: { // lz4
            ...
            if (decompressed_size > OTS_MAX_DECOMPRESSED_TABLE_SIZE) {
                return DropGraphite(
                    "Decompressed size exceeds %gMB: %gMB", OTS_MAX_DECOMPRESSED_TABLE_SIZE / (1024.0 * 1024.0), decompressed_size / (1024.0 * 1024.0));
            }
            std::unique_ptr<uint8_t> decompressed(new uint8_t[decompressed_size]());
            int ret = LZ4_decompress_safe_partial(reinterpret_cast<const char*>(data + table.offset()), reinterpret_cast<char*>(decompressed.get()),
...
{
    if (!out->WriteU32(this->version) || (this->version >> 16 >= 3 && !out->WriteU32(this->compHead)) || !out->WriteU16(this->numSub)
        || (this->version >> 16 >= 2 && !out->WriteU16(this->reserved)) || !SerializeParts(this->offset, out) || !SerializeParts(this->tables, out)) {
...
bool OpenTypeSILF::SILSub::ParsePart(Buffer& table)
{
    ...
    if (!table.ReadU8(&this->iBidi) || !(iBidi == 0xFF || this->iBidi <= this->iPos)) {
    ...
    if (this->lbGID > this->maxGlyphID) {
        parent->Warning("SILSub: lbGID %u outside range 0..%u, replaced with 0", this->lbGID, this->maxGlyphID);
        this->lbGID = 0;
    }

    if (parent->version >> 16 >= 3 && table.offset() != init_offset + this->passOffset) {
    ...
    if (parent->version >> 16 >= 3 && table.offset() != init_offset + this->pseudosOffset) {
    ...
    if (!table.ReadU16(&this->searchPseudo) || !table.ReadU16(&this->pseudoSelector) || !table.ReadU16(&this->pseudoShift)) {
    ...
    if (this->numPseudo == 0) {
        ...
        if (this->searchPseudo != 6 * (unsigned)std::pow(2, floorLog2) || this->pseudoSelector != floorLog2
...
{
    if ((parent->version >> 16 >= 3 && (!out->WriteU32(this->ruleVersion) || !out->WriteU16(this->passOffset) || !out->WriteU16(this->pseudosOffset)))
        || !out->WriteU16(this->maxGlyphID) || !out->WriteS16(this->extraAscent) || !out->WriteS16(this->extraDescent) || !out->WriteU8(this->numPasses)
        || !out->WriteU8(this->iSubst) || !out->WriteU8(this->iPos) || !out->WriteU8(this->iJust) || !out->WriteU8(this->iBidi) || !out->WriteU8(this->flags)
        || !out->WriteU8(this->maxPreContext) || !out->WriteU8(this->maxPostContext) || !out->WriteU8(this->attrPseudo) || !out->WriteU8(this->attrBreakWeight)
        || !out->WriteU8(this->attrDirectionality)
        || (parent->version >> 16 >= 2
            && (!out->WriteU8(this->attrMirroring) || !out->WriteU8(this->attrSkipPasses) || !out->WriteU8(this->numJLevels)
                || !SerializeParts(this->jLevels, out)))
        || !out->WriteU16(this->numLigComp) || !out->WriteU8(this->numUserDefn) || !out->WriteU8(this->maxCompPerLig) || !out->WriteU8(this->direction)
        || !out->WriteU8(this->attrCollisions) || !out->WriteU8(this->reserved4) || !out->WriteU8(this->reserved5)
        || (parent->version >> 16 >= 2
            && (!out->WriteU8(this->reserved6) || !out->WriteU8(this->numCritFeatures) || !SerializeParts(this->critFeatures, out)
                || !out->WriteU8(this->reserved7)))
        || !out->WriteU8(this->numScriptTag) || !SerializeParts(this->scriptTag, out) || !out->WriteU16(this->lbGID) || !SerializeParts(this->oPasses, out)
        || !out->WriteU16(this->numPseudo) || !out->WriteU16(this->searchPseudo) || !out->WriteU16(this->pseudoSelector) || !out->WriteU16(this->pseudoShift)
        || !SerializeParts(this->pMaps, out) || !this->classes.SerializePart(out) || !SerializeParts(this->passes, out)) {
        return parent->Error("SILSub: Failed to write");
    }
    return true;
}

bool OpenTypeSILF::SILSub::JustificationLevel::ParsePart(Buffer& table)
{
...
bool OpenTypeSILF::SILSub::JustificationLevel::SerializePart(OTSStream* out) const
{
    if (!out->WriteU8(this->attrStretch) || !out->WriteU8(this->attrShrink) || !out->WriteU8(this->attrStep) || !out->WriteU8(this->attrWeight)
        || !out->WriteU8(this->runto) || !out->WriteU8(this->reserved) || !out->WriteU8(this->reserved2) || !out->WriteU8(this->reserved3)) {
        return parent->Error("JustificationLevel: Failed to write");
    }
    return true;
}

bool OpenTypeSILF::SILSub::PseudoMap::ParsePart(Buffer& table)
{
...
bool OpenTypeSILF::SILSub::PseudoMap::SerializePart(OTSStream* out) const
{
    if ((parent->version >> 16 >= 2 && !out->WriteU32(this->unicode)) || (parent->version >> 16 == 1 && !out->WriteU16(static_cast<uint16_t>(this->unicode)))
...
bool OpenTypeSILF::SILSub::ClassMap::ParsePart(Buffer& table)
{
    size_t init_offset = table.offset();
    ...
    unsigned long glyphs_len = (this->oClass[this->numLinear] - (table.offset() - init_offset)) / 2;
...
bool OpenTypeSILF::SILSub::ClassMap::SerializePart(OTSStream* out) const
{
...
bool OpenTypeSILF::SILSub::ClassMap::LookupClass::ParsePart(Buffer& table)
{
    if (!table.ReadU16(&this->numIDs)) {
        return parent->Error("LookupClass: Failed to read numIDs");
    }
    if (!table.ReadU16(&this->searchRange) || !table.ReadU16(&this->entrySelector) || !table.ReadU16(&this->rangeShift)) {
    ...
    if (this->numIDs == 0) {
        ...
        if (this->searchRange != (unsigned)std::pow(2, floorLog2) || this->entrySelector != floorLog2 || this->rangeShift != this->numIDs - this->searchRange) {
...
bool OpenTypeSILF::SILSub::ClassMap::LookupClass::SerializePart(OTSStream* out) const
{
    if (!out->WriteU16(this->numIDs) || !out->WriteU16(this->searchRange) || !out->WriteU16(this->entrySelector) || !out->WriteU16(this->rangeShift)
        || !SerializeParts(this->lookups, out)) {
...
bool OpenTypeSILF::SILSub::ClassMap::LookupClass::LookupPair::ParsePart(Buffer& table)
{
...
bool OpenTypeSILF::SILSub::ClassMap::LookupClass::LookupPair::SerializePart(OTSStream* out) const
{
    if (!out->WriteU16(this->glyphId) || !out->WriteU16(this->index)) {
        return parent->Error("LookupPair: Failed to write");
    }
    return true;
}

bool OpenTypeSILF::SILSub::SILPass::ParsePart(Buffer& table, const size_t SILSub_init_offset, const size_t next_pass_offset)
{
    size_t init_offset = table.offset();
    if (!table.ReadU8(&this->flags)) {
    ...
    if (parent->version >> 16 >= 2) {
        ...
        if (!table.ReadU32(&this->pcCode) || (parent->version >= 3 && this->pcCode < this->fsmOffset)) {
            return parent->Error("SILPass: Failed to read pcCode");
        }
    }
    if (!table.ReadU32(&this->rcCode) || (parent->version >> 16 >= 2 && this->rcCode < this->pcCode)) {
    ...
    if (!table.ReadU32(&this->oDebug) || (this->oDebug && this->oDebug < this->aCode)) {
        return parent->Error("SILPass: Failed to read valid oDebug");
    }
    if (parent->version >> 16 >= 3 && table.offset() != init_offset + this->fsmOffset) {
        return parent->Error("SILPass: fsmOffset check failed");
    }
    if (!table.ReadU16(&this->numRows) || (this->oDebug && this->numRows < this->numRules)) {
    ...
    if (this->numRange == 0) {
        ...
        if (this->searchRange != 6 * (unsigned)std::pow(2, floorLog2) || this->entrySelector != floorLog2
    ...
    if (!table.ReadU8(&this->maxRulePreContext) || this->maxRulePreContext < this->minRulePreContext) {
        return parent->Error("SILPass: Failed to read valid maxRulePreContext");
    }

    unsigned startStates_len = this->maxRulePreContext - this->minRulePreContext + 1;
    ...
    for (unsigned long i = 0; i <= this->numRules; ++i) {
        ...
        if (!table.ReadU16(&this->oConstraints[i]) || this->oConstraints[i] > ruleConstraints_len) {
            return parent->Error("SILPass: Failed to read valid oConstraints[%lu]", i);
        }
    }
    ...
    unsigned long actions_len = this->oDebug ? this->oDebug - this->aCode : next_pass_offset - this->aCode;
    ...
    for (unsigned long i = 0; i <= this->numRules; ++i) {
        ...
        if (!table.ReadU16(&this->oActions[i]) || (this->oActions[i] > actions_len)) {
    ...
    for (unsigned i = 0; i < this->numTransitional; ++i) {
        ...
        for (unsigned j = 0; j < this->numColumns; ++j) {
            ...
            if (!table.ReadU16(&stateTrans[i][j])) {
                return parent->Error("SILPass: Failed to read stateTrans[%u][%u]", i, j);
            }
        }
    }
    ...
    if (this->oDebug) {
        OpenTypeNAME* name = static_cast<OpenTypeNAME*>(parent->GetFont()->GetTypedTable(OTS_TAG_NAME));
        if (!name) {
        ...
        for (unsigned i = 0; i < this->numRules; ++i) {
            ...
            if (!table.ReadU16(&this->dActions[i]) || !name->IsValidNameId(this->dActions[i])) {
        ...
        for (unsigned i = 0; i < dStates_len; ++i) {
            ...
            if (!table.ReadU16(&this->dStates[i]) || !name->IsValidNameId(this->dStates[i])) {
        ...
        for (unsigned i = 0; i < this->numRules; ++i) {
            ...
            if (!table.ReadU16(&this->dCols[i]) || !name->IsValidNameId(this->dCols[i])) {
...
bool OpenTypeSILF::SILSub::SILPass::SerializePart(OTSStream* out) const
{
    if (!out->WriteU8(this->flags) || !out->WriteU8(this->maxRuleLoop) || !out->WriteU8(this->maxRuleContext) || !out->WriteU8(this->maxBackup)
        || !out->WriteU16(this->numRules) || (parent->version >> 16 >= 2 && (!out->WriteU16(this->fsmOffset) || !out->WriteU32(this->pcCode)))
        || !out->WriteU32(this->rcCode) || !out->WriteU32(this->aCode) || !out->WriteU32(this->oDebug) || !out->WriteU16(this->numRows)
        || !out->WriteU16(this->numTransitional) || !out->WriteU16(this->numSuccess) || !out->WriteU16(this->numColumns) || !out->WriteU16(this->numRange)
        || !out->WriteU16(this->searchRange) || !out->WriteU16(this->entrySelector) || !out->WriteU16(this->rangeShift) || !SerializeParts(this->ranges, out)
        || !SerializeParts(this->oRuleMap, out) || !SerializeParts(this->ruleMap, out) || !out->WriteU8(this->minRulePreContext)
        || !out->WriteU8(this->maxRulePreContext) || !SerializeParts(this->startStates, out) || !SerializeParts(this->ruleSortKeys, out)
        || !SerializeParts(this->rulePreContext, out)
        || (parent->version >> 16 >= 2 && (!out->WriteU8(this->collisionThreshold) || !out->WriteU16(this->pConstraint)))
        || !SerializeParts(this->oConstraints, out) || !SerializeParts(this->oActions, out) || !SerializeParts(this->stateTrans, out)
        || (parent->version >> 16 >= 2 && (!out->WriteU8(this->reserved2) || !SerializeParts(this->passConstraints, out)))
        || !SerializeParts(this->ruleConstraints, out) || !SerializeParts(this->actions, out) || !SerializeParts(this->dActions, out)
        || !SerializeParts(this->dStates, out) || !SerializeParts(this->dCols, out)) {
        return parent->Error("SILPass: Failed to write");
    }
    return true;
}

bool OpenTypeSILF::SILSub::SILPass::PassRange::ParsePart(Buffer& table)
{
...
bool OpenTypeSILF::SILSub::SILPass::PassRange::SerializePart(OTSStream* out) const
{
    if (!out->WriteU16(this->firstId) || !out->WriteU16(this->lastId) || !out->WriteU16(this->colId)) {
