...
template <typename C, size_t stack_size> void BM_FixedArray(benchmark::State& state)
{
...
BENCHMARK_TEMPLATE(BM_FixedArray, char, absl::kFixedArrayUseDefault)->Range(0, 1 << 16);
...
BENCHMARK_TEMPLATE(BM_FixedArray, SimpleClass, absl::kFixedArrayUseDefault)->Range(0, 1 << 16);
...
BENCHMARK_TEMPLATE(BM_FixedArray, std::string, absl::kFixedArrayUseDefault)->Range(0, 1 << 16);
