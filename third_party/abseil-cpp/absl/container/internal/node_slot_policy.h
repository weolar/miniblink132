...
template <class Reference, class Policy> struct node_slot_policy {
    ...
    template <class Alloc> static std::true_type transfer(Alloc*, slot_type* new_slot, slot_type* old_slot)
    {
        *new_slot = *old_slot;
        return {};
    }
