...
#pragma GCC diagnostic pop
    ...
    {
        return a.bytes_used_ == b.bytes_used_ && a.instance_count_ == b.instance_count_;
    }
...
template <typename T> struct CopyAssignPropagatingCountingAlloc : public CountingAllocator<T> {
    ...
    template <typename U>
    explicit CopyAssignPropagatingCountingAlloc(const CopyAssignPropagatingCountingAlloc<U>& other)
...
template <typename T> struct MoveAssignPropagatingCountingAlloc : public CountingAllocator<T> {
    ...
    template <typename U>
    explicit MoveAssignPropagatingCountingAlloc(const MoveAssignPropagatingCountingAlloc<U>& other)
        : Base(other.bytes_used_, other.instance_count_)
    {
    }
...
template <typename T> struct SwapPropagatingCountingAlloc : public CountingAllocator<T> {
    ...
    template <typename U>
    explicit SwapPropagatingCountingAlloc(const SwapPropagatingCountingAlloc<U>& other)
        : Base(other.bytes_used_, other.instance_count_)
    {
    }
...
template <typename T> struct MinimumAlignmentAlloc : std::allocator<T> {
    MinimumAlignmentAlloc() = default;

    template <typename U> explicit MinimumAlignmentAlloc(const MinimumAlignmentAlloc<U>& /*other*/)
    {
    }
...
template <template <class Alloc> class Container> void TestCopyAssignAllocPropagation()
{
...
template <template <class Alloc> class Container> void TestMoveAssignAllocPropagation()
{
    int64_t bytes1 = 0, instances1 = 0, bytes2 = 0, instances2 = 0;
...
template <template <class Alloc> class Container> void TestSwapAllocPropagation()
{
    int64_t bytes1 = 0, instances1 = 0, bytes2 = 0, instances2 = 0;
...
template <template <class Alloc> class Container> void TestAllocPropagation()
{
