...
template <class T> struct IsTransparent<T, absl::void_t<typename T::is_transparent>> : std::true_type { };
...
struct CommonAccess {
    ...
    template <typename T, typename... Args> static T Construct(Args&&... args)
    {
