...
{
    base_internal::ThreadIdentity* identity = static_cast<base_internal::ThreadIdentity*>(v);
...
static void ResetThreadIdentityBetweenReuse(base_internal::ThreadIdentity* identity)
{
    ...
    pts->state.store(base_internal::PerThreadSynch::State::kAvailable, std::memory_order_relaxed);
