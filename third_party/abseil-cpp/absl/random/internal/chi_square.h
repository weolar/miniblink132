...
template <typename Iterator> double ChiSquareWithExpected(Iterator begin, Iterator end, double expected)
{
...
template <typename Iterator, typename Expected> double ChiSquare(Iterator it, Iterator end, Expected eit, Expected eend)
{
    double chi_square = 0;
