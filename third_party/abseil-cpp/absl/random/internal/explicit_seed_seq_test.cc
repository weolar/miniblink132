...
template <typename Sseq> bool ConformsToInterface()
{
...
#pragma GCC diagnostic pop
    ...
    // Move constructor.
    {
        ...
        absl::random_internal::ExplicitSeedSeq moved_seq(std::move(seq_from_entropy));
        std::vector<uint32_t> seeds_2(1000, 1);
...
TEST(ExplicitSeedSeq, StdURBGGoldenTests)
{
    ...
    // platforms (these should have deterministic output).
    {
        ...
        EXPECT_THAT(values, testing::ElementsAre(579252, 43785881, 464353103, 1501811174));
    }

    {
        ...
        EXPECT_THAT(values, testing::ElementsAre(138416803, 151130212, 33817739, 138416803));
    }

    {
        ...
        EXPECT_THAT(values, testing::ElementsAre(19738651785169348, 1464811352364190456, 18054685302720800, 19738651785169348));
    }
}
