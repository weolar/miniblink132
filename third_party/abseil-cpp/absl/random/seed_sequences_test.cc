...
{
    using ExampleNonsecureURBG = absl::random_internal::NonsecureURBGBase<std::minstd_rand0>;
...
template <typename URBG> void TestReproducibleVariateSequencesForNonsecureURBG()
{
