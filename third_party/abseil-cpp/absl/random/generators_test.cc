...
template <typename URBG> void TestUniform(URBG* gen)
{
...
template <typename URBG> void TestExponential(URBG* gen)
{
...
template <typename URBG> void TestPoisson(URBG* gen)
{
...
template <typename URBG> void TestBernoulli(URBG* gen)
{
    absl::Bernoulli(*gen, 0.5);
    absl::Bernoulli(*gen, 0.5);
}

template <typename URBG> void TestZipf(URBG* gen)
{
...
template <typename URBG> void TestGaussian(URBG* gen)
{
...
template <typename URBG> void TestLogNormal(URBG* gen)
{
...
template <typename URBG> void CompatibilityTest()
{
    URBG gen;
