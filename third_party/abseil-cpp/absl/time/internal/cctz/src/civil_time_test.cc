...
template <typename T> std::string Format(const T& t)
{
    std::stringstream ss;
    ss << t;
    return ss.str();
...
TEST(CivilTime, ConstructionWithHugeYear)
{
    ...
    static_assert(h.year() == -9223372036854775807 - 1, "ConstructionWithHugeYear");
...
TEST(CivilTime, DifferenceWithHugeYear)
{
    ...
    }
    {
        ...
        static_assert((d2 - 1) - d1 == -9223372036854775807 - 1, "DifferenceWithHugeYear");
    }
    {
        ...
        static_assert(d1 - (d2 + 1) == -9223372036854775807 - 1, "DifferenceWithHugeYear");
    }
    {
...
{
    {
        ...
        static_assert(s1 - s2 == -9223372036854775807 - 1, "DifferenceNoIntermediateOverflow");
    }
    {
        ...
        static_assert(s1 - s2 == 9223372036854775807, "DifferenceNoIntermediateOverflow");
    }
}
...
TEST(CivilTime, FieldsConstructionLimits)
{
    ...
    EXPECT_EQ("2038-01-19T03:14:07", Format(civil_second(1970, 1, 1, 0, 0, kIntMax)));
    EXPECT_EQ("6121-02-11T05:21:07", Format(civil_second(1970, 1, 1, 0, kIntMax, kIntMax)));
    EXPECT_EQ("251104-11-20T12:21:07", Format(civil_second(1970, 1, 1, kIntMax, kIntMax, kIntMax)));
    EXPECT_EQ("6130715-05-30T12:21:07", Format(civil_second(1970, 1, kIntMax, kIntMax, kIntMax, kIntMax)));
    EXPECT_EQ("185087685-11-26T12:21:07", Format(civil_second(1970, kIntMax, kIntMax, kIntMax, kIntMax, kIntMax)));

    const int kIntMin = std::numeric_limits<int>::min();
    EXPECT_EQ("1901-12-13T20:45:52", Format(civil_second(1970, 1, 1, 0, 0, kIntMin)));
    EXPECT_EQ("-2182-11-20T18:37:52", Format(civil_second(1970, 1, 1, 0, kIntMin, kIntMin)));
    EXPECT_EQ("-247165-02-11T10:37:52", Format(civil_second(1970, 1, 1, kIntMin, kIntMin, kIntMin)));
    EXPECT_EQ("-6126776-08-01T10:37:52", Format(civil_second(1970, 1, kIntMin, kIntMin, kIntMin, kIntMin)));
    EXPECT_EQ("-185083747-10-31T10:37:52", Format(civil_second(1970, kIntMin, kIntMin, kIntMin, kIntMin, kIntMin)));
}
...
template <typename T1, typename T2> struct HasDifference {
...
#define TEST_RELATIONAL(OLDER, YOUNGER)                                                                                                                        \
    ...
    TEST_RELATIONAL(civil_second(2014, 1, 1, 0, 0, 0), civil_second(2015, 1, 1, 0, 0, 0));
    TEST_RELATIONAL(civil_second(2014, 1, 1, 0, 0, 0), civil_second(2014, 2, 1, 0, 0, 0));
    TEST_RELATIONAL(civil_second(2014, 1, 1, 0, 0, 0), civil_second(2014, 1, 2, 0, 0, 0));
    TEST_RELATIONAL(civil_second(2014, 1, 1, 0, 0, 0), civil_second(2014, 1, 1, 1, 0, 0));
    TEST_RELATIONAL(civil_second(2014, 1, 1, 1, 0, 0), civil_second(2014, 1, 1, 1, 1, 0));
    TEST_RELATIONAL(civil_second(2014, 1, 1, 1, 1, 0), civil_second(2014, 1, 1, 1, 1, 1));
