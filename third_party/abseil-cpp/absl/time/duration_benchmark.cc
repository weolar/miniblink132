...
void BM_Duration_FDivDuration_Nanoseconds(benchmark::State& state)
{
    ...
    int i = 0;
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(d += absl::FDivDuration(absl::Milliseconds(i), absl::Nanoseconds(1)));
        ++i;
    }
}
...
void BM_Duration_IDivDuration_Nanoseconds(benchmark::State& state)
{
    ...
    int i = 0;
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(a += absl::IDivDuration(absl::Nanoseconds(i), absl::Nanoseconds(1), &ignore));
        ++i;
    }
}
...
void BM_Duration_IDivDuration_Microseconds(benchmark::State& state)
{
    ...
    int i = 0;
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(a += absl::IDivDuration(absl::Microseconds(i), absl::Microseconds(1), &ignore));
        ++i;
    }
}
...
void BM_Duration_IDivDuration_Milliseconds(benchmark::State& state)
{
    ...
    int i = 0;
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(a += absl::IDivDuration(absl::Milliseconds(i), absl::Milliseconds(1), &ignore));
        ++i;
    }
}
...
void BM_Duration_IDivDuration_Seconds(benchmark::State& state)
{
    ...
    int i = 0;
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(a += absl::IDivDuration(absl::Seconds(i), absl::Seconds(1), &ignore));
        ++i;
    }
}
...
void BM_Duration_IDivDuration_Minutes(benchmark::State& state)
{
    ...
    int i = 0;
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(a += absl::IDivDuration(absl::Minutes(i), absl::Minutes(1), &ignore));
        ++i;
    }
}
...
void BM_Duration_IDivDuration_Hours(benchmark::State& state)
{
    ...
    int i = 0;
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(a += absl::IDivDuration(absl::Hours(i), absl::Hours(1), &ignore));
        ++i;
    }
}
...
{
    while (state.KeepRunning()) {
        benchmark::DoNotOptimize(absl::GetFlag(FLAGS_absl_duration_flag_for_benchmark));
    }
}
