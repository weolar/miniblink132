...
//   }
//
template <typename Tag, int default_period = 0> class PeriodicSampler final : public PeriodicSamplerBase {
public:
...
template <typename Tag, int default_period> std::atomic<int> PeriodicSampler<Tag, default_period>::period_(default_period);
