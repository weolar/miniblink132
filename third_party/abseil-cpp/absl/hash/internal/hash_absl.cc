...
//         state = Mix(state, hash_internal::CityHash32(reinterpret_cast<const char*>(first), PiecewiseChunkSize()));
//         len -= PiecewiseChunkSize();
//         first += PiecewiseChunkSize();
//     }
//     // Handle the remainder.
//     return CombineContiguousImpl(state, first, len, std::integral_constant<int, 4> {});
}
...
//     }
//     // Handle the remainder.
//     return CombineContiguousImpl(state, first, len, std::integral_constant<int, 8> {});
}
