...
#define ABSL_LOG_INTERNAL_STATEFUL_CONDITION(condition)                                                                                                        \
    for (bool absl_log_internal_stateful_condition_do_log(condition); absl_log_internal_stateful_condition_do_log;                                             \
...
#define ABSL_LOG_INTERNAL_STATEFUL_CONDITION_IMPL(kind, ...)                                                                                                   \
    for (static ::absl::log_internal::Log##kind##State absl_log_internal_stateful_condition_state;                                                             \
         absl_log_internal_stateful_condition_do_log && absl_log_internal_stateful_condition_state.ShouldLog(__VA_ARGS__);                                     \
         absl_log_internal_stateful_condition_do_log = false)                                                                                                  \
        for (const uint32_t COUNTER ABSL_ATTRIBUTE_UNUSED = absl_log_internal_stateful_condition_state.counter(); absl_log_internal_stateful_condition_do_log; \
             absl_log_internal_stateful_condition_do_log = false)
...
#define ABSL_LOG_INTERNAL_CONDITION_INFO(type, condition)                                                                                                      \
    ABSL_LOG_INTERNAL_##type##_CONDITION((condition) && ::absl::LogSeverity::kInfo >= static_cast<::absl::LogSeverity>(ABSL_MIN_LOG_LEVEL))
#define ABSL_LOG_INTERNAL_CONDITION_WARNING(type, condition)                                                                                                   \
    ABSL_LOG_INTERNAL_##type##_CONDITION((condition) && ::absl::LogSeverity::kWarning >= static_cast<::absl::LogSeverity>(ABSL_MIN_LOG_LEVEL))
#define ABSL_LOG_INTERNAL_CONDITION_ERROR(type, condition)                                                                                                     \
    ABSL_LOG_INTERNAL_##type##_CONDITION((condition) && ::absl::LogSeverity::kError >= static_cast<::absl::LogSeverity>(ABSL_MIN_LOG_LEVEL))
...
#define ABSL_LOG_INTERNAL_CONDITION_FATAL(type, condition)                                                                                                     \
    ABSL_LOG_INTERNAL_##type##_CONDITION(((condition)                                                                                                          \
            ? (::absl::LogSeverity::kFatal >= static_cast<::absl::LogSeverity>(ABSL_MIN_LOG_LEVEL) ? true : (::absl::log_internal::AbortQuietly(), false))     \
            : false))
// NOTE: Use ternary operators instead of short-circuiting to mitigate
// https://bugs.llvm.org/show_bug.cgi?id=51928.
#define ABSL_LOG_INTERNAL_CONDITION_QFATAL(type, condition)                                                                                                    \
    ABSL_LOG_INTERNAL_##type##_CONDITION(((condition)                                                                                                          \
            ? (::absl::LogSeverity::kFatal >= static_cast<::absl::LogSeverity>(ABSL_MIN_LOG_LEVEL) ? true : (::absl::log_internal::ExitQuietly(), false))      \
            : false))
#define ABSL_LOG_INTERNAL_CONDITION_DFATAL(type, condition)                                                                                                    \
    ABSL_LOG_INTERNAL_##type##_CONDITION((ABSL_ASSUME(absl::kLogDebugFatal == absl::LogSeverity::kError || absl::kLogDebugFatal == absl::LogSeverity::kFatal), \
        (condition)                                                                                                                                            \
            && (::absl::kLogDebugFatal >= static_cast<::absl::LogSeverity>(ABSL_MIN_LOG_LEVEL)                                                                 \
                || (::absl::kLogDebugFatal == ::absl::LogSeverity::kFatal && (::absl::log_internal::AbortQuietly(), false)))))

#define ABSL_LOG_INTERNAL_CONDITION_LEVEL(severity)                                                                                                            \
    for (int absl_log_internal_severity_loop = 1; absl_log_internal_severity_loop; absl_log_internal_severity_loop = 0)                                        \
        for (const absl::LogSeverity absl_log_internal_severity = ::absl::NormalizeLogSeverity(severity); absl_log_internal_severity_loop;                     \
...
#define ABSL_LOG_INTERNAL_CONDITION_LEVEL_IMPL(type, condition)                                                                                                \
    ABSL_LOG_INTERNAL_##type##_CONDITION(((condition)                                                                                                          \
        && (absl_log_internal_severity >= static_cast<::absl::LogSeverity>(ABSL_MIN_LOG_LEVEL)                                                                 \
            || (absl_log_internal_severity == ::absl::LogSeverity::kFatal && (::absl::log_internal::AbortQuietly(), false)))))
#else // ndef ABSL_MIN_LOG_LEVEL
#define ABSL_LOG_INTERNAL_CONDITION_INFO(type, condition) ABSL_LOG_INTERNAL_##type##_CONDITION(condition)
#define ABSL_LOG_INTERNAL_CONDITION_WARNING(type, condition) ABSL_LOG_INTERNAL_##type##_CONDITION(condition)
#define ABSL_LOG_INTERNAL_CONDITION_ERROR(type, condition) ABSL_LOG_INTERNAL_##type##_CONDITION(condition)
#define ABSL_LOG_INTERNAL_CONDITION_FATAL(type, condition) ABSL_LOG_INTERNAL_##type##_CONDITION(condition)
#define ABSL_LOG_INTERNAL_CONDITION_QFATAL(type, condition) ABSL_LOG_INTERNAL_##type##_CONDITION(condition)
#define ABSL_LOG_INTERNAL_CONDITION_DFATAL(type, condition) ABSL_LOG_INTERNAL_##type##_CONDITION(condition)
#define ABSL_LOG_INTERNAL_CONDITION_LEVEL(severity)                                                                                                            \
    for (int absl_log_internal_severity_loop = 1; absl_log_internal_severity_loop; absl_log_internal_severity_loop = 0)                                        \
        for (const absl::LogSeverity absl_log_internal_severity = ::absl::NormalizeLogSeverity(severity); absl_log_internal_severity_loop;                     \
             absl_log_internal_severity_loop = 0)                                                                                                              \
    ABSL_LOG_INTERNAL_CONDITION_LEVEL_IMPL
#define ABSL_LOG_INTERNAL_CONDITION_LEVEL_IMPL(type, condition) ABSL_LOG_INTERNAL_##type##_CONDITION(condition)
