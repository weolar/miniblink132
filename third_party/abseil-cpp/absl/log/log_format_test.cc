...
TEST(LogFormatTest, NoMessage)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(ComparisonStream())), TextPrefix(AsString(EndsWith(absl::StrCat(" log_format_test.cc:", log_line, "] ")))),
            TextMessage(IsEmpty()), ENCODED_MESSAGE(HasValues(IsEmpty())))));

    test_sink.StartCapturingLogs();
    do_log();
}

template <typename T> class CharLogFormatTest : public testing::Test { };
...
TYPED_TEST(CharLogFormatTest, Printable)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("x")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "x")pb")))))));
...
TYPED_TEST(CharLogFormatTest, Unprintable)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("\xee")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "\xee")pb")))))));

    test_sink.StartCapturingLogs();
    LOG(INFO) << value;
}

template <typename T> class UnsignedIntLogFormatTest : public testing::Test { };
...
TYPED_TEST(UnsignedIntLogFormatTest, Positive)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("224")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "224")pb")))))));
...
TYPED_TEST(UnsignedIntLogFormatTest, BitfieldPositive)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("42")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "42")pb")))))));

    test_sink.StartCapturingLogs();
    LOG(INFO) << value.bits;
}

template <typename T> class SignedIntLogFormatTest : public testing::Test { };
using SignedIntTypes = Types<signed short, signed int, signed long, signed long long>; // NOLINT
...
TYPED_TEST(SignedIntLogFormatTest, Negative)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("-112")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "-112")pb")))))));
...
TYPED_TEST(SignedIntLogFormatTest, BitfieldPositive)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("21")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "21")pb")))))));
...
TYPED_TEST(SignedIntLogFormatTest, BitfieldNegative)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("-21")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "-21")pb")))))));
...
template <typename T> class UnsignedEnumLogFormatTest : public testing::Test { };
using UnsignedEnumTypes = std::conditional<std::is_signed<std::underlying_type<MyUnsignedEnum>::type>::value, Types<MyUnsignedIntEnum>,
    Types<MyUnsignedEnum, MyUnsignedIntEnum>>::type;
...
template <typename T> class SignedEnumLogFormatTest : public testing::Test { };
using SignedEnumTypes = std::conditional<std::is_signed<std::underlying_type<MyUnsignedEnum>::type>::value,
    Types<MyUnsignedEnum, MySignedEnum, MySignedIntEnum>, Types<MySignedEnum, MySignedIntEnum>>::type;
...
TEST(FloatLogFormatTest, Positive)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("6.02e+23")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "6.02e+23")pb")))))));
...
template <typename T> class FloatingPointLogFormatTest : public testing::Test { };
...
TYPED_TEST(FloatingPointLogFormatTest, Zero)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("0")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "0")pb")))))));
...
TYPED_TEST(FloatingPointLogFormatTest, Integer)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("1")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "1")pb")))))));
...
TYPED_TEST(FloatingPointLogFormatTest, Infinity)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(AnyOf(Eq("inf"), Eq("Inf"))),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "inf")pb")))))));
...
TYPED_TEST(FloatingPointLogFormatTest, NaN)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(AnyOf(Eq("nan"), Eq("NaN"))),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "nan")pb")))))));
    test_sink.StartCapturingLogs();
    LOG(INFO) << value;
}
...
TYPED_TEST(FloatingPointLogFormatTest, NegativeNaN)
{
    ...
    const TypeParam value = std::copysign(std::numeric_limits<TypeParam>::quiet_NaN(), -1.0);
    auto comparison_stream = ComparisonStream();
    comparison_stream << value;
...
#ifdef __riscv
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(AnyOf(Eq("-nan"), Eq("nan"), Eq("NaN"), Eq("-nan(ind)"))),
            ENCODED_MESSAGE(
                HasValues(ElementsAre(AnyOf(EqualsProto(R"pb(str: "-nan")pb"), EqualsProto(R"pb(str: "nan")pb"), EqualsProto(R"pb(str: "-nan(ind)")pb"))))))));
#else
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(AnyOf(Eq("-nan"), Eq("nan"), Eq("NaN"), Eq("-nan(ind)"))),
            ENCODED_MESSAGE(
                HasValues(ElementsAre(AnyOf(EqualsProto(R"pb(str: "-nan")pb"), EqualsProto(R"pb(str: "nan")pb"), EqualsProto(R"pb(str: "-nan(ind)")pb"))))))));
#endif
    test_sink.StartCapturingLogs();
...
template <typename T> class VoidPtrLogFormatTest : public testing::Test { };
...
TYPED_TEST(VoidPtrLogFormatTest, Null)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(MatchesOstream(comparison_stream)), TextMessage(AnyOf(Eq("(nil)"), Eq("0"), Eq("0x0"), Eq("00000000"), Eq("0000000000000000"))))));
...
TYPED_TEST(VoidPtrLogFormatTest, NonNull)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(AnyOf(Eq("0xdeadbeef"), Eq("DEADBEEF"), Eq("00000000DEADBEEF"))),
            ENCODED_MESSAGE(HasValues(ElementsAre(AnyOf(EqualsProto(R"pb(str: "0xdeadbeef")pb"), EqualsProto(R"pb(str: "00000000DEADBEEF")pb"))))))));

    test_sink.StartCapturingLogs();
    LOG(INFO) << value;
}

template <typename T> class VolatilePtrLogFormatTest : public testing::Test { };
using VolatilePtrTypes = Types<volatile void*, const volatile void*, volatile char*, const volatile char*, volatile signed char*, const volatile signed char*,
    volatile unsigned char*, const volatile unsigned char*>;
...
TYPED_TEST(VolatilePtrLogFormatTest, Null)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("false")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "false")pb")))))));
...
TYPED_TEST(VolatilePtrLogFormatTest, NonNull)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("true")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "true")pb")))))));

    test_sink.StartCapturingLogs();
    LOG(INFO) << value;
}

template <typename T> class CharPtrLogFormatTest : public testing::Test { };
using CharPtrTypes = Types<char, const char, signed char, const signed char, unsigned char, const unsigned char>;
...
TYPED_TEST(CharPtrLogFormatTest, Null)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            ...
            TextMessage(Eq("(null)")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "(null)")pb")))))));
...
TYPED_TEST(CharPtrLogFormatTest, NonNull)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("value")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "value")pb")))))));
...
TEST(LogFormatTest, StringLiteral)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("value")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(literal: "value")pb")))))));
...
TEST(LogFormatTest, Custom)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("CustomClass{}")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "CustomClass{}")pb")))))));
    test_sink.StartCapturingLogs();
    LOG(INFO) << value;
}
...
TEST(LogFormatTest, CustomNonCopyable)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("CustomClassNonCopyable{}")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "CustomClassNonCopyable{}")pb")))))));
...
struct Point {
    template <typename Sink> friend void AbslStringify(Sink& sink, const Point& p)
    {
...
TEST(LogFormatTest, AbslStringifyExample)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(Eq("(10, 20)")), TextMessage(Eq(absl::StrCat(p))), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "(10, 20)")pb")))))));
...
struct PointWithAbslStringifiyAndOstream {
    template <typename Sink> friend void AbslStringify(Sink& sink, const PointWithAbslStringifiyAndOstream& p)
    {
        absl::Format(&sink, "(%d, %d)", p.x, p.y);
    }
...
ABSL_ATTRIBUTE_UNUSED std::ostream& operator<<(std::ostream& os, const PointWithAbslStringifiyAndOstream&)
{
...
struct PointStreamsNothing {
    template <typename Sink> friend void AbslStringify(Sink&, const PointStreamsNothing&)
    {
    }
...
TEST(LogFormatTest, AbslStringifyStreamsNothing)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(Eq("77")), TextMessage(Eq(absl::StrCat(p, 77))), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "77")pb")))))));
...
struct PointMultipleAppend {
    template <typename Sink> friend void AbslStringify(Sink& sink, const PointMultipleAppend& p)
    {
        sink.Append("(");
...
TEST(LogFormatTest, AbslStringifyMultipleAppend)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(Eq("(10, 20)")), TextMessage(Eq(absl::StrCat(p))),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "(")pb"), EqualsProto(R"pb(str: "10, 20)")pb")))))));
...
TEST(ManipulatorLogFormatTest, BoolAlphaTrue)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("1 true 1")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "1")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "true")pb"),
                EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "1")pb")))))));
...
TEST(ManipulatorLogFormatTest, BoolAlphaFalse)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("0 false 0")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "0")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "false")pb"),
                EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "0")pb")))))));
...
TEST(ManipulatorLogFormatTest, ShowPoint)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 77.0000 77")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "77")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "77.0000")pb"),
                EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "77")pb")))))));
...
TEST(ManipulatorLogFormatTest, ShowPos)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 +77 77")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "77")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "+77")pb"),
                EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "77")pb")))))));
...
TEST(ManipulatorLogFormatTest, UppercaseFloat)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("7.7e+07 7.7E+07 7.7e+07")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "7.7e+07")pb"), EqualsProto(R"pb(literal: " ")pb"),
                EqualsProto(R"pb(str: "7.7E+07")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "7.7e+07")pb")))))));
...
TEST(ManipulatorLogFormatTest, Hex)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("0x77")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "0x77")pb")))))));
    test_sink.StartCapturingLogs();
...
TEST(ManipulatorLogFormatTest, Oct)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("077")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "077")pb")))))));
...
TEST(ManipulatorLogFormatTest, Dec)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(
            TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "77")pb")))))));
...
TEST(ManipulatorLogFormatTest, ShowbaseHex)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 0x77 77")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "77")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "0x77")pb"),
                EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "77")pb")))))));
...
TEST(ManipulatorLogFormatTest, ShowbaseOct)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77 077 77")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "77")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "077")pb"),
                EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "77")pb")))))));
...
TEST(ManipulatorLogFormatTest, UppercaseHex)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("0xbeef 0XBEEF 0xbeef")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "0xbeef")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "0XBEEF")pb"),
                EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "0xbeef")pb")))))));
...
TEST(ManipulatorLogFormatTest, FixedFloat)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("77000000.000000")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "77000000.000000")pb")))))));
...
TEST(ManipulatorLogFormatTest, ScientificFloat)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("7.700000e+07")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "7.700000e+07")pb")))))));
...
TEST(ManipulatorLogFormatTest, FixedAndScientificFloat)
{
    ...
    const double value = 7.7e7;
    auto comparison_stream = ComparisonStream();
    comparison_stream << std::setiosflags(std::ios_base::scientific | std::ios_base::fixed) << value;

    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(AnyOf(Eq("0x1.25bb50p+26"), Eq("0x1.25bb5p+26"), Eq("0x1.25bb500000000p+26"))),
            ENCODED_MESSAGE(HasValues(ElementsAre(AnyOf(EqualsProto(R"pb(str: "0x1.25bb5p+26")pb"), EqualsProto(R"pb(str: "0x1.25bb500000000p+26")pb"))))))));

    test_sink.StartCapturingLogs();

    // This combination should mean the same thing as `std::hexfloat`.
    LOG(INFO) << std::setiosflags(std::ios_base::scientific | std::ios_base::fixed) << value;
}
#endif
...
TEST(ManipulatorLogFormatTest, DefaultFloatFloat)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("7.7e+07")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "7.7e+07")pb")))))));
...
TEST(ManipulatorLogFormatTest, Ends)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq(absl::string_view("\0", 1))),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "\0")pb")))))));
...
TEST(ManipulatorLogFormatTest, Endl)
{
    ...
    EXPECT_CALL(
        test_sink, Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("\n")), ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str:
          "\n")pb")))))));
...
TEST(ManipulatorLogFormatTest, SetIosFlags)
{
    ...
    const int value = 0x77;
    auto comparison_stream = ComparisonStream();
    comparison_stream << std::resetiosflags(std::ios_base::basefield) << std::setiosflags(std::ios_base::hex) << value << " " //
                      << std::resetiosflags(std::ios_base::basefield) << std::setiosflags(std::ios_base::dec) << value;

    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("0x77 119")),
            ...
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "0x77")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "119")pb")))))));

    test_sink.StartCapturingLogs();
    LOG(INFO) << std::resetiosflags(std::ios_base::basefield) << std::setiosflags(std::ios_base::hex) << value << " " //
              << std::resetiosflags(std::ios_base::basefield) << std::setiosflags(std::ios_base::dec) << value;
}
...
TEST(ManipulatorLogFormatTest, SetPrecision)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("6.022e+23")),
            // `std::setprecision` isn't a manipulator.  We're unable to
            // distinguish its return type from arbitrary user-defined
            // types and thus don't suppress the empty str value.
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "6.022e+23")pb")))))));
...
TEST(ManipulatorLogFormatTest, SetPrecisionOverflow)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("602214085700000015187968")),
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "602214085700000015187968")pb")))))));
...
TEST(ManipulatorLogFormatTest, SetW)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("      77")),
            ...
            // distinguish its return type from arbitrary user-defined
            // types and thus don't suppress the empty str value.
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "      77")pb")))))));
...
TEST(ManipulatorLogFormatTest, SetFill)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("00000077")),
            ...
            ENCODED_MESSAGE(HasValues(ElementsAre(EqualsProto(R"pb(str: "00000077")pb")))))));
...
TEST(ManipulatorLogFormatTest, FromCustom)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(MatchesOstream(comparison_stream)), TextMessage(Eq("FromCustomClass{} 0x77")),
            ENCODED_MESSAGE(HasValues(
                ElementsAre(EqualsProto(R"pb(str: "FromCustomClass{}")pb"), EqualsProto(R"pb(literal: " ")pb"), EqualsProto(R"pb(str: "0x77")pb")))))));
...
std::ostream& operator<<(std::ostream& os, const StreamsNothing&)
{
    return os;
}
...
struct PointPercentV {
    template <typename Sink> friend void AbslStringify(Sink& sink, const PointPercentV& p)
    {
...
TEST(StructuredLoggingOverflowTest, TruncatesStrings)
{
    ...
    EXPECT_CALL(test_sink,
        Send(AllOf(TextMessage(
                       AllOf(SizeIs(AllOf(Ge(absl::log_internal::kLogMessageBufferSize - 256), Le(absl::log_internal::kLogMessageBufferSize))), Each(Eq('x')))),
            ENCODED_MESSAGE(HasOneStrThat(
                AllOf(SizeIs(AllOf(Ge(absl::log_internal::kLogMessageBufferSize - 256), Le(absl::log_internal::kLogMessageBufferSize))), Each(Eq('x'))))))));
...
TEST(StructuredLoggingOverflowTest, TruncatesInsertionOperators)
{
    ...
    test_sink.StartCapturingLogs();
    LOG(INFO) << StringLike { std::string(2 * absl::log_internal::kLogMessageBufferSize, 'x') };
}
...
size_t MaxLogFieldLengthNoPrefix()
{
    ...
    public:
        void Send(const absl::LogEntry& entry) override
        {
            ...
            CHECK_EQ(entry.text_message().find_first_not_of('x'), absl::string_view::npos);
    ...
    LOG(INFO).NoPrefix().ToSinkOnly(&extractor_sink) << std::string(2 * absl::log_internal::kLogMessageBufferSize, 'x');
...
TEST(StructuredLoggingOverflowTest, TruncatesStringsCleanly)
{
    ...
    // sizes.  To put any data in the field we need a fifth byte.
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(
            test_sink, Send(AllOf(ENCODED_MESSAGE(HasOneStrThat(AllOf(SizeIs(longest_fit), Each(Eq('x'))))), RawEncodedMessage(AsString(EndsWith("x"))))));
        test_sink.StartCapturingLogs();
    ...
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(
            test_sink, Send(AllOf(ENCODED_MESSAGE(HasOneStrThat(AllOf(SizeIs(longest_fit - 1), Each(Eq('x'))))), RawEncodedMessage(AsString(EndsWith("x"))))));
        test_sink.StartCapturingLogs();
    ...
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(
            test_sink, Send(AllOf(ENCODED_MESSAGE(HasOneStrThat(AllOf(SizeIs(longest_fit - 2), Each(Eq('x'))))), RawEncodedMessage(AsString(EndsWith("x"))))));
        test_sink.StartCapturingLogs();
    ...
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(
            test_sink, Send(AllOf(ENCODED_MESSAGE(HasOneStrThat(AllOf(SizeIs(longest_fit - 3), Each(Eq('x'))))), RawEncodedMessage(AsString(EndsWith("x"))))));
        test_sink.StartCapturingLogs();
    ...
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(test_sink,
            Send(AllOf(ENCODED_MESSAGE(HasOneStrAndOneLiteralThat(AllOf(SizeIs(longest_fit - 4), Each(Eq('x'))), IsEmpty())),
    ...
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(test_sink,
            Send(AllOf(ENCODED_MESSAGE(HasOneStrAndOneLiteralThat(AllOf(SizeIs(longest_fit - 5), Each(Eq('x'))), Eq("y"))),
...
TEST(StructuredLoggingOverflowTest, TruncatesInsertionOperatorsCleanly)
{
    ...
    }
    {
        ...
        test_sink.StartCapturingLogs();
        // x fits, one byte from y's header fits but shouldn't be visible.
        LOG(INFO).NoPrefix() << std::string(longest_fit - 1, 'x') << StringLike { "y" };
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(
        ...
        test_sink.StartCapturingLogs();
        // x fits, two bytes from y's header fit but shouldn't be visible.
        LOG(INFO).NoPrefix() << std::string(longest_fit - 2, 'x') << StringLike { "y" };
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(
        ...
        test_sink.StartCapturingLogs();
        // x fits, three bytes from y's header fit but shouldn't be visible.
        LOG(INFO).NoPrefix() << std::string(longest_fit - 3, 'x') << StringLike { "y" };
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(
            test_sink, Send(AllOf(ENCODED_MESSAGE(HasOneStrThat(AllOf(SizeIs(longest_fit - 4), Each(Eq('x'))))), RawEncodedMessage(AsString(EndsWith("x"))))));
        test_sink.StartCapturingLogs();
        ...
        LOG(INFO).NoPrefix() << std::string(longest_fit - 4, 'x') << StringLike { "y" };
    }
    {
        absl::ScopedMockLog test_sink(absl::MockLogDefault::kDisallowUnexpected);
        EXPECT_CALL(test_sink,
            Send(AllOf(ENCODED_MESSAGE(HasTwoStrsThat(AllOf(SizeIs(longest_fit - 5), Each(Eq('x'))), Eq("y"))), RawEncodedMessage(AsString(EndsWith("y"))))));
        test_sink.StartCapturingLogs();
        // x fits, y fits exactly.
        LOG(INFO).NoPrefix() << std::string(longest_fit - 5, 'x') << StringLike { "y" };
    }
}
