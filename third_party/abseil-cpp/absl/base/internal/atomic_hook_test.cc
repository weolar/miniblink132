...
{
    ABSL_INTERNAL_ATOMIC_HOOK_ATTRIBUTES static absl::base_internal::AtomicHook<void (*)(int)> hook;
    value = 0;
...
TEST(AtomicHookTest, WithDefaultFunction)
{
    ...
    ABSL_INTERNAL_ATOMIC_HOOK_ATTRIBUTES static absl::base_internal::AtomicHook<void (*)(int)> hook(TestHook);
    value = 0;
...
static struct OverrideInstaller {
    OverrideInstaller()
    {
        absl::atomic_hook_internal::func.Store(OverrideFunc);
    }
} override_installer;
