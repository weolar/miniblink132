...
#if defined(__i386__) || defined(__x86_64__) || defined(__aarch64__) || defined(__powerpc__) || defined(__ppc__) || defined(_M_IX86)                           \
...
#if defined(__native_client__) || (defined(__APPLE__)) || (defined(__ANDROID__) && defined(__aarch64__))
