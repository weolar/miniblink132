...
#define ABSL_RAW_LOG(severity, ...)                                                                                                                            \
    do {                                                                                                                                                       \
        constexpr const char* absl_raw_log_internal_basename = ::absl::raw_log_internal::Basename(__FILE__, sizeof(__FILE__) - 1);                             \
...
#define ABSL_INTERNAL_LOG(severity, message)                                                                                                                   \
    do {                                                                                                                                                       \
        ...
        ::absl::raw_log_internal::internal_log_function(ABSL_RAW_LOG_INTERNAL_##severity, absl_raw_log_internal_filename, __LINE__, message);                  \
        ABSL_RAW_LOG_INTERNAL_MAYBE_UNREACHABLE_##severity;                                                                                                    \
    } while (0)
...
#define ABSL_RAW_LOG_INTERNAL_LEVEL(severity) ::absl::NormalizeLogSeverity(severity)
...
ABSL_INTERNAL_ATOMIC_HOOK_ATTRIBUTES ABSL_DLL extern base_internal::AtomicHook<InternalLogFunction> internal_log_function;
