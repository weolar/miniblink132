...
#define ABSL_THREAD_IDENTITY_MODE ABSL_THREAD_IDENTITY_MODE_USE_CPP11
#elif ABSL_PER_THREAD_TLS && defined(__GOOGLE_GRTE_VERSION__) && (__GOOGLE_GRTE_VERSION__ >= 20140228L)
...
ABSL_CONST_INIT extern ABSL_PER_THREAD_TLS_KEYWORD ThreadIdentity* thread_identity_ptr;
...
#if !defined(__APPLE__) && !defined(ABSL_BUILD_DLL) && !defined(ABSL_CONSUME_DLL)
