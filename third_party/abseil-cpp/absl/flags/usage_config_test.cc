...
TEST_F(FlagsUsageConfigTest, TestContainsHelpshortFlags)
{
    ...
    EXPECT_TRUE(config.contains_helpshort_flags("aaaa/usage_config_test-main.cc"));
    ...
    EXPECT_FALSE(flags::GetUsageConfig().contains_helpshort_flags("aaa/progmane.cpp"));
}
...
TEST_F(FlagsUsageConfigTest, TestContainsHelpFlags)
{
    ...
    EXPECT_TRUE(config.contains_help_flags("bdir/a/zzz/usage_config_test-main.cc"));
    EXPECT_TRUE(config.contains_help_flags("//aqse/zzz/usage_config_test_main.cc"));
...
TEST_F(FlagsUsageConfigTest, TestContainsHelppackageFlags)
{
    ...
    EXPECT_TRUE(config.contains_helppackage_flags("bbdir/aaa/usage_config_test-main.cc"));
    EXPECT_TRUE(config.contains_helppackage_flags("//aqswde/aaa/usage_config_test_main.cc"));
    ...
    EXPECT_TRUE(flags::GetUsageConfig().contains_helppackage_flags("aaa/main-body.c"));
    EXPECT_FALSE(flags::GetUsageConfig().contains_helppackage_flags("aadir/main-body.c"));
}
