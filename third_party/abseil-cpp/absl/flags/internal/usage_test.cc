...
ABSL_FLAG(std::string, usage_reporting_test_flag_06, {},
...
TEST_F(UsageReportingDeathTest, TestSetProgramUsageMessage)
{
    ...
    EXPECT_THAT(absl::ProgramUsageMessage(), ::testing::HasSubstr("This program contains tests written using Google Test"));
#endif

    EXPECT_DEATH_IF_SUPPORTED(absl::SetProgramUsageMessage("custom usage message"), ::testing::HasSubstr("SetProgramUsageMessage() called twice"));
}
...
path.
    ...
    flags::FlagsHelp(test_buf_01, "usage_test.cc", flags::HelpFormat::kHumanReadable, kTestUsageMessage);
    EXPECT_EQ(test_buf_01.str(), usage_test_flags_out);

    std::stringstream test_buf_02;
    flags::FlagsHelp(test_buf_02, "flags/internal/usage_test.cc", flags::HelpFormat::kHumanReadable, kTestUsageMessage);
    EXPECT_EQ(test_buf_02.str(), usage_test_flags_out);

    std::stringstream test_buf_03;
    flags::FlagsHelp(test_buf_03, "usage_test", flags::HelpFormat::kHumanReadable, kTestUsageMessage);
    EXPECT_EQ(test_buf_03.str(), usage_test_flags_out);

    std::stringstream test_buf_04;
    flags::FlagsHelp(test_buf_04, "flags/invalid_file_name.cc", flags::HelpFormat::kHumanReadable, kTestUsageMessage);
...
path.
    ...
    flags::FlagsHelp(test_buf_05, "", flags::HelpFormat::kHumanReadable, kTestUsageMessage);
    std::string test_out = test_buf_05.str();
    absl::string_view test_out_str(test_out);
    EXPECT_TRUE(absl::StartsWith(test_out_str, "usage_test: Custom usage message"));
    EXPECT_TRUE(absl::StrContains(test_out_str, "Flags from absl/flags/internal/usage_test.cc:"));
    EXPECT_TRUE(absl::StrContains(test_out_str, "-usage_reporting_test_flag_01 "));
}
...
{
    std::stringstream test_buf;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf, kTestUsageMessage), flags::HelpMode::kNone);
}
...
TEST_F(UsageReportingTest, TestUsageFlag_helpshort)
{
    ...
    std::stringstream test_buf;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf, kTestUsageMessage), flags::HelpMode::kShort);
    EXPECT_EQ(test_buf.str(),
        R"(usage_test: Custom usage message
...
TEST_F(UsageReportingTest, TestUsageFlag_help_simple)
{
    ...
    std::stringstream test_buf;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf, kTestUsageMessage), flags::HelpMode::kImportant);
    EXPECT_EQ(test_buf.str(),
        R"(usage_test: Custom usage message
...
TEST_F(UsageReportingTest, TestUsageFlag_help_one_flag)
{
    ...
    std::stringstream test_buf;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf, kTestUsageMessage), flags::HelpMode::kMatch);
    EXPECT_EQ(test_buf.str(),
        R"(usage_test: Custom usage message
...
TEST_F(UsageReportingTest, TestUsageFlag_helppackage)
{
    ...
    std::stringstream test_buf;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf, kTestUsageMessage), flags::HelpMode::kPackage);
    EXPECT_EQ(test_buf.str(),
        R"(usage_test: Custom usage message
...
TEST_F(UsageReportingTest, TestUsageFlag_version)
{
    ...
    std::stringstream test_buf;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf, kTestUsageMessage), flags::HelpMode::kVersion);
#ifndef NDEBUG
...
TEST_F(UsageReportingTest, TestUsageFlag_only_check_args)
{
    ...
    std::stringstream test_buf;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf, kTestUsageMessage), flags::HelpMode::kOnlyCheckArgs);
    EXPECT_EQ(test_buf.str(), "");
}
...
TEST_F(UsageReportingTest, TestUsageFlag_helpon)
{
    ...
    std::stringstream test_buf_01;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf_01, kTestUsageMessage), flags::HelpMode::kMatch);
...
path.
    ...
    std::stringstream test_buf_02;
    EXPECT_EQ(flags::HandleUsageFlags(test_buf_02, kTestUsageMessage), flags::HelpMode::kMatch);
