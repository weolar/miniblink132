...
struct ListMoveOnlyCopyOnly {
    ListMoveOnlyCopyOnly(std::initializer_list<int> ilist, MoveOnly /*move_only*/, CopyOnly /*copy_only*/)
        : values(ilist)
    {
    }
...
TEST(AnyTest, Noexcept)
{
    ...
    static_assert(noexcept(std::declval<absl::any&>().swap(std::declval<absl::any&>())), "");

    using std::swap;
    static_assert(noexcept(swap(std::declval<absl::any&>(), std::declval<absl::any&>())), "");
}
...
TEST(AnyTest, InPlaceConstruction)
{
    ...
    absl::any o(absl::in_place_type_t<IntMoveOnlyCopyOnly>(), 5, MoveOnly(), copy_only);
...
{
    const CopyOnly copy_only {};
    absl::any o(absl::in_place_type<IntMoveOnlyCopyOnly>, 5, MoveOnly(), copy_only);
...
{
    const CopyOnly copy_only {};
    absl::any o(absl::in_place_type_t<const volatile IntMoveOnlyCopyOnly>(), 5, MoveOnly(), copy_only);
    IntMoveOnlyCopyOnly& v = absl::any_cast<IntMoveOnlyCopyOnly&>(o);
    EXPECT_EQ(5, v.value);
}
...
{
    const CopyOnly copy_only {};
    absl::any o(absl::in_place_type<const volatile IntMoveOnlyCopyOnly>, 5, MoveOnly(), copy_only);
    auto& v = absl::any_cast<IntMoveOnlyCopyOnly&>(o);
    EXPECT_EQ(5, v.value);
}
...
{
    const CopyOnly copy_only {};
    absl::any o(absl::in_place_type_t<ListMoveOnlyCopyOnly>(), { 1, 2, 3, 4 }, MoveOnly(), copy_only);
...
{
    const CopyOnly copy_only {};
    absl::any o(absl::in_place_type<ListMoveOnlyCopyOnly>, { 1, 2, 3, 4 }, MoveOnly(), copy_only);
...
{
    const CopyOnly copy_only {};
    absl::any o(absl::in_place_type_t<const volatile ListMoveOnlyCopyOnly>(), { 1, 2, 3, 4 }, MoveOnly(), copy_only);
    ListMoveOnlyCopyOnly& v = absl::any_cast<ListMoveOnlyCopyOnly&>(o);
    std::vector<int> expected_values = { 1, 2, 3, 4 };
    EXPECT_EQ(expected_values, v.values);
}
...
{
    const CopyOnly copy_only {};
    absl::any o(absl::in_place_type<const volatile ListMoveOnlyCopyOnly>, { 1, 2, 3, 4 }, MoveOnly(), copy_only);
    auto& v = absl::any_cast<ListMoveOnlyCopyOnly&>(o);
    std::vector<int> expected_values = { 1, 2, 3, 4 };
    EXPECT_EQ(expected_values, v.values);
}
...
template <typename Enabler, typename T, typename... Args> struct CanEmplaceAnyImpl : std::false_type { };

template <typename T, typename... Args>
struct CanEmplaceAnyImpl<absl::void_t<decltype(std::declval<absl::any&>().emplace<T>(std::declval<Args>()...))>, T, Args...> : std::true_type { };

template <typename T, typename... Args> using CanEmplaceAny = CanEmplaceAnyImpl<void, T, Args...>;

TEST(AnyTest, Emplace)
{
    const CopyOnly copy_only {};
    absl::any o;
    EXPECT_TRUE((std::is_same<decltype(o.emplace<IntMoveOnlyCopyOnly>(5, MoveOnly(), copy_only)), IntMoveOnlyCopyOnly&>::value));
    IntMoveOnlyCopyOnly& emplace_result = o.emplace<IntMoveOnlyCopyOnly>(5, MoveOnly(), copy_only);
...
TEST(AnyTest, EmplaceWithCV)
{
    const CopyOnly copy_only {};
    absl::any o;
    EXPECT_TRUE((std::is_same<decltype(o.emplace<const volatile IntMoveOnlyCopyOnly>(5, MoveOnly(), copy_only)), IntMoveOnlyCopyOnly&>::value));
    IntMoveOnlyCopyOnly& emplace_result = o.emplace<const volatile IntMoveOnlyCopyOnly>(5, MoveOnly(), copy_only);
    EXPECT_EQ(5, emplace_result.value);
    IntMoveOnlyCopyOnly& v = absl::any_cast<IntMoveOnlyCopyOnly&>(o);
    EXPECT_EQ(5, v.value);
    EXPECT_EQ(&emplace_result, &v);
...
{
    absl::any o;
    EXPECT_TRUE((std::is_same<decltype(o.emplace<FunctionType>(FunctionToEmplace)), FunctionType*&>::value));
...
TEST(AnyTest, EmplaceIlist)
{
    const CopyOnly copy_only {};
    absl::any o;
    EXPECT_TRUE((std::is_same<decltype(o.emplace<ListMoveOnlyCopyOnly>({ 1, 2, 3, 4 }, MoveOnly(), copy_only)), ListMoveOnlyCopyOnly&>::value));
    ListMoveOnlyCopyOnly& emplace_result = o.emplace<ListMoveOnlyCopyOnly>({ 1, 2, 3, 4 }, MoveOnly(), copy_only);
    ListMoveOnlyCopyOnly& v = absl::any_cast<ListMoveOnlyCopyOnly&>(o);
    ...
    static_assert(!CanEmplaceAny<MoveOnlyWithListConstructor, std::initializer_list<int>, int>::value, "");
}
...
TEST(AnyTest, EmplaceIlistWithCV)
{
    const CopyOnly copy_only {};
    absl::any o;
    EXPECT_TRUE((std::is_same<decltype(o.emplace<const volatile ListMoveOnlyCopyOnly>({ 1, 2, 3, 4 }, MoveOnly(), copy_only)), ListMoveOnlyCopyOnly&>::value));
    ListMoveOnlyCopyOnly& emplace_result = o.emplace<const volatile ListMoveOnlyCopyOnly>({ 1, 2, 3, 4 }, MoveOnly(), copy_only);
    ListMoveOnlyCopyOnly& v = absl::any_cast<ListMoveOnlyCopyOnly&>(o);
    EXPECT_EQ(&v, &emplace_result);
    std::vector<int> expected_values = { 1, 2, 3, 4 };
    EXPECT_EQ(expected_values, v.values);
...
struct WeirdConstructor42 {
    explicit WeirdConstructor42(int value)
        : value(value)
    {
    }

    // Copy-constructor
    WeirdConstructor42(const WeirdConstructor42& other)
        : value(other.value)
    {
    }
...
{
    {
        ...
        static_assert(std::is_same<decltype(absl::any_cast<Value>(o)), Value>::value, "");
    }

    {
        ...
        static_assert(std::is_same<decltype(absl::any_cast<const Value>(o)), const Value>::value, "");
    }
}
...
TEST(AnyTest, AnyCastReference)
{
...

    {
        ...
        static_assert(std::is_same<decltype(absl::any_cast<Value&&>(std::move(o))), Value&&>::value, "");
    }

    {
        ...
        static_assert(std::is_same<decltype(absl::any_cast<const Value&&>(std::move(o))), const Value&&>::value, "");
    }
}
...
{
    const CopyOnly copy_only {};
    auto o = absl::make_any<ListMoveOnlyCopyOnly>({ 1, 2, 3 }, MoveOnly(), copy_only);
    static_assert(std::is_same<decltype(o), absl::any>::value, "");
    ListMoveOnlyCopyOnly& v = absl::any_cast<ListMoveOnlyCopyOnly&>(o);
...
#define ABSL_ANY_TEST_EXPECT_BAD_ANY_CAST(...) ABSL_BASE_INTERNAL_EXPECT_FAIL((__VA_ARGS__), absl::bad_any_cast, "")

#else

// If using the absl `any` implementation, we can rely on a specific message.
#define ABSL_ANY_TEST_EXPECT_BAD_ANY_CAST(...) ABSL_BASE_INTERNAL_EXPECT_FAIL((__VA_ARGS__), absl::bad_any_cast, "Bad any cast")
...
#define ABSL_ANY_TEST_EXPECT_BAD_COPY(...) ABSL_BASE_INTERNAL_EXPECT_FAIL((__VA_ARGS__), BadCopy, "Bad copy")
