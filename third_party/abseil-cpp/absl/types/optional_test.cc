...
// in this file.
template <class T, class...> using GccIceHelper1 = T;
template <typename T> struct GccIceHelper2 { };
template <typename T> class GccIce {
    template <typename U, typename SecondTemplateArgHasToExistForSomeReason = void, typename DependentType = void,
...
std::string TypeQuals(std::string&)
{
    return "&";
}
std::string TypeQuals(std::string&&)
...
std::string TypeQuals(const std::string&)
{
    return "c&";
}
std::string TypeQuals(const std::string&&)
...
struct Listenable {
    ...
    explicit Listenable(int /*unused*/)
    {
        ++listener->construct1;
    }
    Listenable(int /*unused*/, int /*unused*/)
    {
        ++listener->construct2;
    }
    Listenable(std::initializer_list<int> /*unused*/)
    {
        ++listener->listinit;
    }
    Listenable(const Listenable& /*unused*/)
    {
        ++listener->copy;
    }
    ...
    Listenable(volatile Listenable&& /*unused*/)
    {
        ++listener->volatile_move;
    }
    Listenable(Listenable&& /*unused*/)
    {
        ++listener->move;
    }
...
struct ConstexprType {
    enum CtorTypes { kCtorDefault, kCtorInt, kCtorInitializerList, kCtorConstChar };
    constexpr ConstexprType()
        : x(kCtorDefault)
    {
    }
    constexpr explicit ConstexprType(int i)
        : x(kCtorInt)
    {
    }
...
struct MoveableThrow {
    ...
    MoveableThrow& operator=(MoveableThrow&&)
    {
        return *this;
    }
};
...
struct MoveableNoThrow {
    ...
    MoveableNoThrow& operator=(MoveableNoThrow&&) noexcept
    {
        return *this;
    }
};
...
struct NoDefault {
    ...
    NoDefault& operator=(const NoDefault&)
    {
        return *this;
    }
};
...
TEST(optionalTest, DefaultConstructor)
{
    ...
    EXPECT_TRUE(std::is_nothrow_default_constructible<absl::optional<int>>::value);
}
...
TEST(optionalTest, nulloptConstructor)
{
    ...
    static_assert(!cempty.has_value(), "");
    EXPECT_TRUE((std::is_nothrow_constructible<absl::optional<int>, absl::nullopt_t>::value));
}
...
TEST(optionalTest, CopyConstructor)
{
    ...
    EXPECT_FALSE(std::is_copy_constructible<absl::optional<MoveableThrow>>::value);
    EXPECT_FALSE(std::is_copy_constructible<absl::optional<MoveableNoThrow>>::value);
    EXPECT_FALSE(std::is_copy_constructible<absl::optional<NonMovable>>::value);

    EXPECT_FALSE(absl::is_trivially_copy_constructible<absl::optional<Copyable>>::value);
    EXPECT_TRUE(absl::is_trivially_copy_constructible<absl::optional<int>>::value);
    EXPECT_TRUE(absl::is_trivially_copy_constructible<absl::optional<const int>>::value);
    ...
    EXPECT_TRUE(absl::is_trivially_copy_constructible<absl::optional<volatile int>>::value);
    ...
    }
    {
        struct TrivialCopyable {
            constexpr TrivialCopyable()
                : x(0)
            {
            }
            constexpr explicit TrivialCopyable(int i)
                : x(i)
            {
            }
            int x;
        ...
        EXPECT_TRUE(absl::is_trivially_copy_constructible<absl::optional<TrivialCopyable>>::value);
        EXPECT_TRUE(absl::is_trivially_copy_constructible<absl::optional<const TrivialCopyable>>::value);
#endif
#if !defined(ABSL_VOLATILE_RETURN_TYPES_DEPRECATED)
        EXPECT_FALSE(std::is_copy_constructible<absl::optional<volatile TrivialCopyable>>::value);
...
TEST(optionalTest, MoveConstructor)
{
    ...
    EXPECT_TRUE(std::is_move_constructible<absl::optional<MoveableNoThrow>>::value);
    ...
    EXPECT_EQ(absl::default_allocator_is_nothrow::value, std::is_nothrow_move_constructible<absl::optional<MoveableThrow>>::value);
    EXPECT_TRUE(std::is_nothrow_move_constructible<absl::optional<MoveableNoThrow>>::value);
}
...
TEST(optionalTest, Destructor)
{
    ...
    EXPECT_FALSE(std::is_trivially_destructible<absl::optional<NonTrivial>>::value);
}
...
TEST(optionalTest, InPlaceConstructor)
{
    ...
    EXPECT_FALSE((std::is_constructible<absl::optional<ConvertsFromInPlaceT>, absl::in_place_t>::value));
    EXPECT_FALSE((std::is_constructible<absl::optional<ConvertsFromInPlaceT>, const absl::in_place_t&>::value));
    EXPECT_TRUE((std::is_constructible<absl::optional<ConvertsFromInPlaceT>, absl::in_place_t, absl::in_place_t>::value));

    EXPECT_FALSE((std::is_constructible<absl::optional<NoDefault>, absl::in_place_t>::value));
    EXPECT_FALSE((std::is_constructible<absl::optional<NoDefault>, absl::in_place_t&&>::value));
}
...
TEST(optionalTest, ValueConstructor)
{
    ...
    EXPECT_TRUE((std::is_convertible<const char*, absl::optional<ConstexprType>>::value));
    // direct initialization
    constexpr absl::optional<ConstexprType> opt2 { 2 };
    static_assert(opt2, "");
    static_assert(ConstexprType::kCtorInt == (*opt2).x, "");
    EXPECT_FALSE((std::is_convertible<int, absl::optional<ConstexprType>>::value));
    ...
    // `-std=c++17`.
#if defined(__GNUC__) && !defined(__clang__) && __GNUC__ == 7 && __cplusplus == 201703L
...
struct Convert {
    ...
    explicit Convert(const Explicit&)
        : implicit(false)
        , move(false)
    {
    }
    explicit Convert(Explicit&&)
        : implicit(false)
        , move(true)
    {
    }
...
struct ConvertFromOptional {
    ...
    ConvertFromOptional(const absl::optional<Implicit>&) // NOLINT(runtime/explicit)
        : implicit(true)
        , move(false)
        , from_optional(true)
    {
...
TEST(optionalTest, ConvertingConstructor)
{
    ...
    }
    {
        ...
        EXPECT_FALSE(opt_copy->move);
        EXPECT_FALSE((std::is_convertible<const absl::optional<Explicit>&, absl::optional<Convert>>::value));
        absl::optional<Convert> opt_move { absl::optional<Explicit>(absl::in_place) };
        EXPECT_TRUE(opt_move);
        EXPECT_FALSE(opt_move->implicit);
        EXPECT_TRUE(opt_move->move);
        EXPECT_FALSE((std::is_convertible<absl::optional<Explicit>&&, absl::optional<Convert>>::value));
    }
    {
        ...
        static_assert(std::is_convertible<absl::optional<Implicit>, absl::optional<ConvertFromOptional>>::value, "");
    ...
    }
    {
        ...
        EXPECT_FALSE(opt0->move);
        EXPECT_TRUE(opt0->from_optional);
        EXPECT_FALSE((std::is_convertible<const absl::optional<Explicit>&, absl::optional<ConvertFromOptional>>::value));
        absl::optional<ConvertFromOptional> opt1 { absl::optional<Explicit>() };
        EXPECT_TRUE(opt1);
        EXPECT_FALSE(opt1->implicit);
        EXPECT_TRUE(opt1->move);
        EXPECT_TRUE(opt1->from_optional);
        EXPECT_FALSE((std::is_convertible<absl::optional<Explicit>&&, absl::optional<ConvertFromOptional>>::value));
    }
}
...
TEST(optionalTest, AssignFromNullopt)
{
    ...
    EXPECT_TRUE((std::is_nothrow_assignable<absl::optional<int>, absl::nullopt_t>::value));
    EXPECT_TRUE((std::is_nothrow_assignable<absl::optional<Listenable>, absl::nullopt_t>::value));
}
...
TEST(optionalTest, CopyAssignment)
{
    ...
    EXPECT_FALSE(absl::is_copy_assignable<absl::optional<MoveableNoThrow>>::value);
...
#if !defined(ABSL_VOLATILE_RETURN_TYPES_DEPRECATED)
    {
        ...
        EXPECT_EQ(1, listener.construct0);
        absl::optional<volatile Listenable> empty_to_empty, empty_to_set, set_to_empty(absl::in_place), set_to_set(absl::in_place);
...
{
    {
        ...
        absl::optional<Listenable> empty1, empty2, set1(absl::in_place), set2(absl::in_place);
        EXPECT_EQ(2, listener.construct0);
        absl::optional<Listenable> empty_to_empty, empty_to_set, set_to_empty(absl::in_place), set_to_set(absl::in_place);
...
#if !defined(ABSL_VOLATILE_RETURN_TYPES_DEPRECATED)
    {
        ...
        absl::optional<volatile Listenable> empty1, empty2, set1(absl::in_place), set2(absl::in_place);
        EXPECT_EQ(2, listener.construct0);
        absl::optional<volatile Listenable> empty_to_empty, empty_to_set, set_to_empty(absl::in_place), set_to_set(absl::in_place);
        EXPECT_EQ(4, listener.construct0);
    ...
    EXPECT_FALSE(std::is_nothrow_move_assignable<absl::optional<MoveableThrow>>::value);
    EXPECT_TRUE(std::is_nothrow_move_assignable<absl::optional<MoveableNoThrow>>::value);
}
...
struct CopyConvertFromOptional {
    ...
    CopyConvertFromOptional& operator=(const absl::optional<NoConvertToOptional>&);
};
...
TEST(optionalTest, ValueAssignment)
{
    ...
    EXPECT_TRUE((std::is_assignable<absl::optional<CopyConvert>&, const NoConvertToOptional&>::value));
    // U = const absl::optional<NoConvertToOptional>&
    EXPECT_TRUE((std::is_assignable<absl::optional<CopyConvertFromOptional>&, const NoConvertToOptional&>::value));
    // U = const NoConvertToOptional& triggers SFINAE because
    // std::is_constructible_v<MoveConvert, const NoConvertToOptional&> is false
    EXPECT_FALSE((std::is_assignable<absl::optional<MoveConvert>&, const NoConvertToOptional&>::value));
    ...
    EXPECT_FALSE((std::is_assignable<absl::optional<MoveConvertFromOptional>&, const NoConvertToOptional&>::value));
    // U = NoConvertToOptional
    EXPECT_TRUE((std::is_assignable<absl::optional<MoveConvertFromOptional>&, NoConvertToOptional&&>::value));
    // U = const absl::optional<NoConvertToOptional>&
    ...
    EXPECT_TRUE((std::is_assignable<absl::optional<MoveConvertFromOptional>&, absl::optional<NoConvertToOptional>&&>::value));
}
...
TEST(optionalTest, ConvertingAssignment)
{
    ...
    EXPECT_TRUE((std::is_assignable<absl::optional<CopyConvert>, const absl::optional<NoConvertToOptional>&>::value));
    // operator=(const absl::optional<U>&) with U = NoConvertToOptional
    ...
    EXPECT_FALSE((std::is_assignable<absl::optional<MoveConvertFromOptional>&, const absl::optional<NoConvertToOptional>&>::value));
}
...
template <int v> struct DeletedOpAddr {
    int value = v;
...
TEST(optionalTest, make_optional)
{
    ...
    }
    {
        ...
        constexpr absl::optional<TrivialCopyable> c_opt1 = absl::make_optional<TrivialCopyable>();
        static_assert((*c_opt1).x == 0, "");
        constexpr absl::optional<TrivialCopyable> c_opt2 = absl::make_optional<TrivialCopyable>(42);
        static_assert((*c_opt2).x == 42, "");
    }
}

template <typename T, typename U> void optionalTest_Comparisons_EXPECT_LESS(T x, U y)
{
    EXPECT_FALSE(x == y);
    EXPECT_TRUE(x != y);
    EXPECT_TRUE(x < y);
...
template <typename T, typename U> void optionalTest_Comparisons_EXPECT_SAME(T x, U y)
{
    EXPECT_TRUE(x == y);
    EXPECT_FALSE(x != y);
    EXPECT_FALSE(x < y);
...
template <typename T, typename U> void optionalTest_Comparisons_EXPECT_GREATER(T x, U y)
{
    EXPECT_FALSE(x == y);
    EXPECT_TRUE(x != y);
    EXPECT_FALSE(x < y);
...
template <typename T, typename U, typename V> void TestComparisons()
{
...
TEST(optionalTest, ValueType)
{
    ...
    EXPECT_TRUE((std::is_same<absl::optional<std::string>::value_type, std::string>::value));
    EXPECT_FALSE((std::is_same<absl::optional<int>::value_type, absl::nullopt_t>::value));
}

template <typename T> struct is_hash_enabled_for {
    template <typename U, typename = decltype(std::hash<U>()(std::declval<U>()))> static std::true_type test(int);
...
TEST(optionalTest, Hash)
{
    ...
    static_assert(absl::type_traits_internal::IsHashable<absl::optional<int>>::value, "");
    static_assert(absl::type_traits_internal::IsHashable<absl::optional<Hashable>>::value, "");
    ...
    static_assert(!absl::type_traits_internal::IsHashable<absl::optional<NonHashable>>::value, "");
#endif
...
struct MoveMeNoThrow {
    ...
    [[noreturn]] MoveMeNoThrow(const MoveMeNoThrow& other)
        : x(other.x)
    {
        LOG(FATAL) << "Should not be called.";
    }
    MoveMeNoThrow(MoveMeNoThrow&& other) noexcept
        : x(other.x)
    {
    }
    int x;
...
struct MoveMeThrow {
    ...
    MoveMeThrow(const MoveMeThrow& other)
        : x(other.x)
    {
    }
    MoveMeThrow(MoveMeThrow&& other)
        : x(other.x)
    {
    }
    int x;
...
{
    static_assert(std::is_nothrow_move_constructible<absl::optional<MoveMeNoThrow>>::value, "");
    static_assert(absl::default_allocator_is_nothrow::value == std::is_nothrow_move_constructible<absl::optional<MoveMeThrow>>::value, "");
...
struct AnyLike {
    ...
    template <typename ValueType, typename T = typename std::decay<ValueType>::type,
        typename std::enable_if<!absl::disjunction<std::is_same<AnyLike, T>, absl::negation<std::is_copy_constructible<T>>>::value, int>::type = 0>
    AnyLike(ValueType&&)
    {
    } // NOLINT(runtime/explicit)
    ...
    template <typename ValueType, typename T = typename std::decay<ValueType>::type>
    typename std::enable_if<absl::conjunction<absl::negation<std::is_same<AnyLike, T>>, std::is_copy_constructible<T>>::value, AnyLike&>::type operator=(
        ValueType&& /* rhs */)
    {
        return *this;
    }
...
TEST(optionalTest, ConstructionConstraints)
{
    ...
    EXPECT_TRUE((std::is_constructible<AnyLike, const absl::optional<AnyLike>&>::value));

    EXPECT_TRUE((std::is_constructible<absl::optional<AnyLike>, AnyLike>::value));
    EXPECT_TRUE((std::is_constructible<absl::optional<AnyLike>, const AnyLike&>::value));

    EXPECT_TRUE((std::is_convertible<absl::optional<AnyLike>, AnyLike>::value));

    EXPECT_TRUE((std::is_convertible<const absl::optional<AnyLike>&, AnyLike>::value));

    EXPECT_TRUE((std::is_convertible<AnyLike, absl::optional<AnyLike>>::value));
    EXPECT_TRUE((std::is_convertible<const AnyLike&, absl::optional<AnyLike>>::value));
...
TEST(optionalTest, AssignmentConstraints)
{
    ...
    EXPECT_TRUE((std::is_assignable<AnyLike&, const absl::optional<AnyLike>&>::value));
    EXPECT_TRUE((std::is_assignable<absl::optional<AnyLike>&, AnyLike>::value));
    EXPECT_TRUE((std::is_assignable<absl::optional<AnyLike>&, const AnyLike&>::value));
...
TEST(optionalTest, InPlaceTSFINAEBug)
{
    ...
    EXPECT_TRUE((std::is_constructible<absl::optional<Inner>, absl::in_place_t>::value));
