...
absl::Nullable<const char*> memmatch(absl::Nullable<const char*> phaystack, size_t haylen, absl::Nullable<const char*> pneedle, size_t neelen)
{
    if (0 == neelen) {
    ...
    while ((match = static_cast<const char*>(memchr(phaystack, pneedle[0], static_cast<size_t>(hayend - phaystack))))) {
