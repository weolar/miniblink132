...
TEST(MatchTest, FindLongestCommonPrefix)
{
    ...
    EXPECT_EQ(absl::FindLongestCommonPrefix(absl::string_view("1234 abcdef").substr(5, 5), absl::string_view("5678 abcdef").substr(5, 3)), "abc");
}
...
TEST(MatchTest, FindLongestCommonSuffix)
{
    ...
    EXPECT_EQ(absl::FindLongestCommonSuffix(absl::string_view("1234 abcdef").substr(5, 5), absl::string_view("5678 abcdef").substr(7, 3)), "cde");
}
