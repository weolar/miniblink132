...
template <typename... Args> constexpr Case ValidFormat(const char* format)
{
...
TEST(StrFormatChecker, ValidFormat)
{
    ...
    constexpr Case trues[] = {
        ...
        ValidFormat<string_view, const char*, double, void*>("string_view=%s const char*=%s double=%f void*=%p)"),
        ValidFormat<int>("%v"), //
        ...
        ValidFormat<void*, string_view, const char*, double>("string_view=%2$s const char*=%3$s double=%4$f void*=%1$p "
                                                             "repeat=%3$s)"),
...
#define CHARS_X_400 CHARS_X_40 CHARS_X_40 CHARS_X_40 CHARS_X_40 CHARS_X_40 CHARS_X_40 CHARS_X_40 CHARS_X_40 CHARS_X_40 CHARS_X_40
#define CHARS_X_4000 CHARS_X_400 CHARS_X_400 CHARS_X_400 CHARS_X_400 CHARS_X_400 CHARS_X_400 CHARS_X_400 CHARS_X_400 CHARS_X_400 CHARS_X_400
    constexpr char long_format[] = CHARS_X_4000 "%d" CHARS_X_4000 "%s" CHARS_X_4000;
