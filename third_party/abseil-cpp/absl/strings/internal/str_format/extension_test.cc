...
{
#define X_VAL(id) EXPECT_EQ(absl::FormatConversionChar::id, absl::str_format_internal::FormatConversionCharInternal::id);
    ABSL_INTERNAL_CONVERSION_CHARS_EXPAND_(X_VAL, );
#undef X_VAL

#define X_VAL(id) EXPECT_EQ(absl::FormatConversionCharSet::id, absl::str_format_internal::FormatConversionCharSetInternal::id);
    ABSL_INTERNAL_CONVERSION_CHARS_EXPAND_(X_VAL, );
#undef X_VAL
}
...
TEST(FormatExtensionTest, SetConversionChar)
{
    ...
    EXPECT_EQ(spec.conversion_char(), absl::str_format_internal::FormatConversionCharInternal::kNone);
    spec.set_conversion_char(absl::str_format_internal::FormatConversionCharInternal::d);
    EXPECT_EQ(spec.conversion_char(), absl::str_format_internal::FormatConversionCharInternal::d);
}
