...
#define ABSL_INTERNAL_CONVERSION_CHARS_EXPAND_(X_VAL, X_SEP)                                                                                                   \
    /* text */                                                                                                                                                 \
    X_VAL(c)                                                                                                                                                   \
    X_SEP X_VAL(s) X_SEP /* ints */                                                                                                                            \
    X_VAL(d)                                                                                                                                                   \
    X_SEP X_VAL(i)                                                                                                                                             \
    X_SEP X_VAL(o)                                                                                                                                             \
    X_SEP                                                                                                                                                      \
    X_VAL(u) X_SEP X_VAL(x)                                                                                                                                    \
    X_SEP X_VAL(X) X_SEP /* floats */                                                                                                                          \
    X_VAL(f)                                                                                                                                                   \
    X_SEP X_VAL(F)                                                                                                                                             \
    X_SEP X_VAL(e)                                                                                                                                             \
    X_SEP X_VAL(E)                                                                                                                                             \
    X_SEP                                                                                                                                                      \
    X_VAL(g) X_SEP X_VAL(G)                                                                                                                                    \
    X_SEP X_VAL(a)                                                                                                                                             \
    X_SEP X_VAL(A) X_SEP /* misc */                                                                                                                            \
    X_VAL(n)                                                                                                                                                   \
    X_SEP X_VAL(p)                                                                                                                                             \
    X_SEP X_VAL(v)
// clang-format on
...
private:
  ...
  enum class Enum : uint8_t {
    ...
    // clang-format on
public:
#define ABSL_INTERNAL_X_VAL(id) static constexpr FormatConversionChar id = static_cast<FormatConversionChar>(Enum::id);
...
{
    if (c == FormatConversionCharInternal::X || c == FormatConversionCharInternal::F || c == FormatConversionCharInternal::E
        || c == FormatConversionCharInternal::G || c == FormatConversionCharInternal::A) {
        return true;
    } else {
        return false;
    }
...
{
    if (c == FormatConversionCharInternal::a || c == FormatConversionCharInternal::e || c == FormatConversionCharInternal::f
        || c == FormatConversionCharInternal::g || c == FormatConversionCharInternal::A || c == FormatConversionCharInternal::E
        || c == FormatConversionCharInternal::F || c == FormatConversionCharInternal::G) {
        return true;
    } else {
        return false;
    }
...
template <typename... CharSet> constexpr FormatConversionCharSet FormatConversionCharSetUnion(FormatConversionCharSet a, CharSet... rest)
{
    return static_cast<FormatConversionCharSet>(static_cast<uint64_t>(a) | static_cast<uint64_t>(FormatConversionCharSetUnion(rest...)));
}
...
{
    return
#define ABSL_INTERNAL_CHAR_SET_CASE(c) conv == #c[0] ? FormatConversionCharToConvInt(FormatConversionCharInternal::c):
...
{
    return static_cast<FormatConversionCharSet>(FormatConversionCharToConvInt(conv));
}

struct FormatConversionCharSetInternal {
#define ABSL_INTERNAL_CHAR_SET_CASE(c) static constexpr FormatConversionCharSet c = FormatConversionCharToConvValue(#c[0]);
    ABSL_INTERNAL_CONVERSION_CHARS_EXPAND_(ABSL_INTERNAL_CHAR_SET_CASE, )
#undef ABSL_INTERNAL_CHAR_SET_CASE
