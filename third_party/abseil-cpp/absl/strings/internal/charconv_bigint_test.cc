...
TEST(BigUnsigned, ShiftLeft)
{
    ...
    }
    {
        ...
        // 2**(32*84)-1
        const BigUnsigned<84> all_bits_one("1474444211396924248063325089479706787923460402125687709454567433186613"
        ...
        // zero.
        for (int out_of_bounds_shift : { 84 * 32, 84 * 32 + 1, std::numeric_limits<int>::max() }) {
            BigUnsigned<84> big_shifted = all_bits_one;
...
{
    const BigUnsigned<84> factorial_100("933262154439441526816992388562667004907159682643816214685929638952175999"
...
{
    {
        ...
        // together.
        const BigUnsigned<84> factorial_200("7886578673647905035523632139321850622951359776871732632947425332443594"
