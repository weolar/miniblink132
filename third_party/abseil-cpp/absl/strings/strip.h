...
//   EXPECT_EQ(input, "bc");
inline bool ConsumePrefix(absl::Nonnull<absl::string_view*> str, absl::string_view expected)
{
...
//   EXPECT_EQ(input, "abc");
inline bool ConsumeSuffix(absl::Nonnull<absl::string_view*> str, absl::string_view expected)
{
