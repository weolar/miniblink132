...
{
    return ft_smooth_render_generic(render, slot, mode, origin, FT_RENDER_MODE_LCD);
}
...
{
    return ft_smooth_render_generic(render, slot, mode, origin, FT_RENDER_MODE_LCD_V);
}
