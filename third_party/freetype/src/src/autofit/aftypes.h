...
#define AF_SCALER_EQUAL_SCALES(a, b)                                                                                                                           \
    ((a)->x_scale == (b)->x_scale && (a)->y_scale == (b)->y_scale && (a)->x_delta == (b)->x_delta && (a)->y_delta == (b)->y_delta)
...
#define AF_DECLARE_WRITING_SYSTEM_CLASS(writing_system_class) FT_CALLBACK_TABLE const AF_WritingSystemClassRec writing_system_class;
