...
#define AF_HINTS_DO_HORIZONTAL(h) (!_af_debug_disable_horz_hints && !AF_HINTS_TEST_SCALER(h, AF_SCALER_FLAG_NO_HORIZONTAL))
...
#define AF_SEGMENT_DIST(seg1, seg2) (((seg1)->pos > (seg2)->pos) ? (seg1)->pos - (seg2)->pos : (seg2)->pos - (seg1)->pos)
