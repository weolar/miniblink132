...
static const FT_Service_CIDRec cid_service_cid_info = {
    ...
    (FT_CID_GetCIDFromGlyphIndexFunc)cid_get_cid_from_glyph_index /* get_cid_from_glyph_index */
};
...
static const FT_ServiceDescRec cid_services[] = { { FT_SERVICE_ID_FONT_FORMAT, FT_FONT_FORMAT_CID },
    { FT_SERVICE_ID_POSTSCRIPT_FONT_NAME, &cid_service_ps_name }, { FT_SERVICE_ID_POSTSCRIPT_INFO, &cid_service_ps_info },
    { FT_SERVICE_ID_CID, &cid_service_cid_info }, { FT_SERVICE_ID_PROPERTIES, &cid_service_properties }, { NULL, NULL } };
...
const FT_Driver_ClassRec t1cid_driver_class = {
    {
        FT_MODULE_FONT_DRIVER | FT_MODULE_DRIVER_SCALABLE | FT_MODULE_DRIVER_HAS_HINTER, sizeof(PS_DriverRec),
    ...
    sizeof(CID_FaceRec), sizeof(CID_SizeRec), sizeof(CID_GlyphSlotRec),
