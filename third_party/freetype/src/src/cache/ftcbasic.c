...
static const FTC_GCacheClassRec ftc_basic_image_cache_class = { {
                                                                    ...
                                                                    sizeof(FTC_GCacheRec), ftc_gcache_init, /* FTC_Cache_InitFunc    cache_init         */
...
static const FTC_SFamilyClassRec ftc_basic_sbit_family_class
    = { {
            sizeof(FTC_BasicFamilyRec), ftc_basic_family_compare, /* FTC_MruNode_CompareFunc  node_compare */
            ftc_basic_family_init, /* FTC_MruNode_InitFunc     node_init    */
            NULL, /* FTC_MruNode_ResetFunc    node_reset   */
            NULL /* FTC_MruNode_DoneFunc     node_done    */
        },

          ftc_basic_family_get_count, ftc_basic_family_load_bitmap };
