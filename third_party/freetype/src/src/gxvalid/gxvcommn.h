...
typedef void (*GXV_StateTable_Subtable_Setup_Func)(FT_UShort table_size, FT_UShort classTable, FT_UShort stateArray, FT_UShort entryTable,
...
typedef void (*GXV_StateTable_Entry_Validate_Func)(
    FT_Byte state, FT_UShort flags, GXV_StateTable_GlyphOffsetCPtr glyphOffset_p, FT_Bytes statetable_table, FT_Bytes statetable_limit, GXV_Validator gxvalid);
...
typedef void (*GXV_XStateTable_Subtable_Setup_Func)(FT_ULong table_size, FT_ULong classTable, FT_ULong stateArray, FT_ULong entryTable,
    FT_ULong* classTable_length_p, FT_ULong* stateArray_length_p, FT_ULong* entryTable_length_p, GXV_Validator gxvalid);

typedef void (*GXV_XStateTable_Entry_Validate_Func)(FT_UShort state, FT_UShort flags, GXV_StateTable_GlyphOffsetCPtr glyphOffset_p, FT_Bytes xstatetable_table,
    FT_Bytes xstatetable_limit, GXV_Validator gxvalid);
...
#define GXV_SUBTABLE_LIMIT_CHECK(_count)                                                                                                                       \
    FT_BEGIN_STMNT                                                                                                                                             \
    if ((p + (_count)-gxvalid->subtable_start) > gxvalid->subtable_length)                                                                                     \
        FT_INVALID_TOO_SHORT;                                                                                                                                  \
    FT_END_STMNT
