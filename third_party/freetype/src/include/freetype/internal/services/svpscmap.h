...
typedef FT_Error (*PS_Unicodes_InitFunc)(FT_Memory memory, PS_Unicodes unicodes, FT_UInt num_glyphs, PS_GetGlyphNameFunc get_glyph_name,
    PS_FreeGlyphNameFunc free_glyph_name, FT_Pointer glyph_data);
...
#define FT_DEFINE_SERVICE_PSCMAPSREC(class_, unicode_value_, unicodes_init_, unicodes_char_index_, unicodes_char_next_, macintosh_name_, adobe_std_strings_,   \
    adobe_std_encoding_, adobe_expert_encoding_)                                                                                                               \
    static const FT_Service_PsCMapsRec class_ = { unicode_value_, unicodes_init_, unicodes_char_index_, unicodes_char_next_, macintosh_name_,                  \
