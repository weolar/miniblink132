...
typedef FT_Error (*ft_raccess_guess_func)(FT_Library library, FT_Stream stream, char* base_file_name, char** result_file_name, FT_Long* result_offset);
...
#define CONST_FT_RFORK_RULE_ARRAY_ENTRY(func_suffix, type_suffix) { raccess_guess_##func_suffix, FT_RFork_Rule_##type_suffix },
