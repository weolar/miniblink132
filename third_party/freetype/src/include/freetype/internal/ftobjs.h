...
#define FT_DEFINE_CMAP_CLASS(                                                                                                                                  \
    class_, size_, init_, done_, char_index_, char_next_, char_var_index_, char_var_default_, variant_list_, charvariant_list_, variantchar_list_)             \
    FT_CALLBACK_TABLE_DEF                                                                                                                                      \
    const FT_CMap_ClassRec class_                                                                                                                              \
        = { size_, init_, done_, char_index_, char_next_, char_var_index_, char_var_default_, variant_list_, charvariant_list_, variantchar_list_ };
...
typedef void (*FT_Bitmap_LcdFilterFunc)(FT_Bitmap* bitmap, FT_Render_Mode render_mode, FT_Byte* weights);
...
#define FT_REQUEST_WIDTH(req) ((req)->horiResolution ? ((req)->width * (FT_Pos)(req)->horiResolution + 36) / 72 : (req)->width)

#define FT_REQUEST_HEIGHT(req) ((req)->vertResolution ? ((req)->height * (FT_Pos)(req)->vertResolution + 36) / 72 : (req)->height)
...
#define FT_DEFINE_RENDERER(class_, flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_, glyph_format_, render_glyph_,          \
    transform_glyph_, get_glyph_cbox_, set_mode_, raster_class_)                                                                                               \
    FT_CALLBACK_TABLE_DEF                                                                                                                                      \
    const FT_Renderer_Class class_                                                                                                                             \
        = { FT_DEFINE_ROOT_MODULE(flags_, size_, name_, version_, requires_, interface_, init_, done_, get_interface_) glyph_format_,                          \
                                                                                                                                                               \
              render_glyph_, transform_glyph_, get_glyph_cbox_, set_mode_,                                                                                     \
                                                                                                                                                               \
              raster_class_ };
