...
#define AVIF_VERSION ((AVIF_VERSION_MAJOR * 1000000) + (AVIF_VERSION_MINOR * 10000) + (AVIF_VERSION_PATCH * 100) + AVIF_VERSION_DEVEL)
...
typedef enum avifRange { AVIF_RANGE_LIMITED = 0, AVIF_RANGE_FULL = 1 } avifRange;
...
AVIF_API avifBool avifCropRectConvertCleanApertureBox(
...
AVIF_API avifBool avifCleanApertureBoxConvertCropRect(
...
typedef enum avifCodecFlag { AVIF_CODEC_FLAG_CAN_DECODE = (1 << 0), AVIF_CODEC_FLAG_CAN_ENCODE = (1 << 1) } avifCodecFlag;
...
AVIF_API avifResult avifEncoderAddImageGrid(
