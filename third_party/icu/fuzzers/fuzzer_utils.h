...
{
    return icu::UnicodeString::fromUTF8(icu::StringPiece(reinterpret_cast<const char*>(data), size));
}
...
std::vector<char16_t> RandomChar16Array(size_t random_value, const uint8_t* data, size_t size)
{
