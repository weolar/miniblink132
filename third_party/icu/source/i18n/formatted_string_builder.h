...
static_assert(
    ...
    std::is_standard_layout<FormattedStringBuilder::Field>::value && std::is_trivial<FormattedStringBuilder::Field>::value,
...
constexpr FormattedStringBuilder::Field::Field(uint8_t category, uint8_t field)
    : bits((U_ASSERT(category <= 0xf), U_ASSERT(field <= 0xf), static_cast<uint8_t>((category << 4) | field)))
{
}
