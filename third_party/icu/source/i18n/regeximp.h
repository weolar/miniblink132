...
#define URX_OPCODE_NAMES                                                                                                                                       \
    "               ", "BACKTRACK", "END", "ONECHAR", "STRING", "STRING_LEN", "STATE_SAVE", "NOP", "START_CAPTURE", "END_CAPTURE", "URX_STATIC_SETREF",        \
        "SETREF", "DOTANY", "JMP", "FAIL", "JMP_SAV", "BACKSLASH_B", "BACKSLASH_G", "JMP_SAV_X", "BACKSLASH_X", "BACKSLASH_Z", "DOTANY_ALL", "BACKSLASH_D",    \
        "CARET", "DOLLAR", "CTR_INIT", "CTR_INIT_NG", "DOTANY_UNIX", "CTR_LOOP", "CTR_LOOP_NG", "URX_CARET_M_UNIX", "RELOC_OPRND", "STO_SP", "LD_SP",          \
        "BACKREF", "STO_INP_LOC", "JMPX", "LA_START", "LA_END", "ONECHAR_I", "STRING_I", "BACKREF_I", "DOLLAR_M", "CARET_M", "LB_START", "LB_CONT", "LB_END",  \
        "LBN_CONT", "LBN_END", "STAT_SETREF_N", "LOOP_SR_I", "LOOP_C", "LOOP_DOT_I", "BACKSLASH_BU", "DOLLAR_D", "DOLLAR_MD", "URX_BACKSLASH_H",               \
        "URX_BACKSLASH_R", "URX_BACKSLASH_V"
...
#define START_OF_MATCH_STR(v)                                                                                                                                  \
    ((v) == START_NO_INFO         ? "START_NO_INFO"                                                                                                            \
