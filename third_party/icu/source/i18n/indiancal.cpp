...
IndianCalendar::IndianCalendar(const IndianCalendar& other)
    : Calendar(other)
{
}
...
{
    int32_t gdow;
    Grego::dayToFields(jd - kEpochStartAsJulianDay, gregorianDate[0], gregorianDate[1], gregorianDate[2], gdow);
