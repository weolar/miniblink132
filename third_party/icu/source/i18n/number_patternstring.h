...
U_NAMESPACE_BEGIN namespace number
{
    ...
    public:
         ...
         */
        static void parseToPatternInfo(const UnicodeString& patternString, ParsedPatternInfo& patternInfo, UErrorCode& status);
         ...
         */
        static DecimalFormatProperties parseToProperties(const UnicodeString& pattern, IgnoreRounding ignoreRounding, UErrorCode& status);
    ...
    public:
         ...
         */
        static UnicodeString propertiesToPatternString(const DecimalFormatProperties& properties, UErrorCode& status);
         ...
         */
        static UnicodeString convertLocalized(const UnicodeString& input, const DecimalFormatSymbols& symbols, bool toLocalized, UErrorCode& status);
         ...
         */
        static void patternInfoToStringBuilder(const AffixPatternProvider& patternInfo, bool isPrefix, PatternSignType patternSignType, bool approximately,
    ...
    private:
        ...
        static int escapePaddingString(UnicodeString input, UnicodeString& output, int startIndex, UErrorCode& status);
    };
