...
void EthiopicCalendar::setAmeteAlemEra(UBool onOff)
{
    eraType = onOff ? AMETE_ALEM_ERA : AMETE_MIHRET_ERA;
}

UBool EthiopicCalendar::isAmeteAlemEra() const
{
...
int32_t EthiopicCalendar::handleGetExtendedYear()
{
    ...
    if (newerField(UCAL_EXTENDED_YEAR, UCAL_YEAR) == UCAL_EXTENDED_YEAR) {
        ...
        eyear = internalGet(UCAL_YEAR, 1 + AMETE_MIHRET_DELTA) - AMETE_MIHRET_DELTA; // Default to year 1 of Amelete Mihret
    } else {
...
void EthiopicCalendar::handleComputeFields(int32_t julianDay, UErrorCode& /*status*/)
{
...
int32_t EthiopicCalendar::handleGetLimit(UCalendarDateFields field, ELimitType limitType) const
{
...
UDate EthiopicCalendar::defaultCenturyStart() const
{
...
int32_t EthiopicCalendar::defaultCenturyStartYear() const
{
