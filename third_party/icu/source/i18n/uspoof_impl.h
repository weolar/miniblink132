 ...
 */
class SpoofImpl : public UObject, public IcuCApiHelper<USpoofChecker, SpoofImpl, USPOOF_MAGIC> {
public:
 ...
 */
class CheckResult : public UObject, public IcuCApiHelper<USpoofCheckResult, CheckResult, USPOOF_CHECK_MAGIC> {
public:
    CheckResult();
    virtual ~CheckResult();
