...
public:
    UTF16CollationIterator(const CollationData* d, UBool numeric, const UChar* s, const UChar* p, const UChar* lim)
...
public:
    FCDUTF16CollationIterator(const CollationData* data, UBool numeric, const UChar* s, const UChar* p, const UChar* lim)
