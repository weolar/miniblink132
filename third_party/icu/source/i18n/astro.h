...
public:
    ...
    UDate timeOfAngle(AngleFunc& func, double desired, double periodDays, double epsilon, UBool next);
    ...
    double riseOrSet(CoordFunc& func, UBool rise, double diameter, double refraction, double epsilon);
