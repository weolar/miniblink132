...
TimeZoneRule::TimeZoneRule(const TimeZoneRule& source)
    : UObject(source)
    , fName(source.fName)
    , fRawOffset(source.fRawOffset)
    , fDSTSavings(source.fDSTSavings)
{
}
...
TimeZoneRule& TimeZoneRule::operator=(const TimeZoneRule& right)
{
    if (this != &right) {
        fName = right.fName;
...
{
    return ((this == &that) || (typeid(*this) == typeid(that) && fName == that.fName && fRawOffset == that.fRawOffset && fDSTSavings == that.fDSTSavings));
}
...
UBool TimeZoneRule::isEquivalentTo(const TimeZoneRule& other) const
{
...
InitialTimeZoneRule::InitialTimeZoneRule(const UnicodeString& name, int32_t rawOffset, int32_t dstSavings)
...
UBool InitialTimeZoneRule::isEquivalentTo(const TimeZoneRule& other) const
{
    if (this == &other) {
        return TRUE;
    }
...
UBool InitialTimeZoneRule::getFirstStart(int32_t /*prevRawOffset*/, int32_t /*prevDSTSavings*/, UDate& /*result*/) const
{
    return FALSE;
}

UBool InitialTimeZoneRule::getFinalStart(int32_t /*prevRawOffset*/, int32_t /*prevDSTSavings*/, UDate& /*result*/) const
{
    return FALSE;
}

UBool InitialTimeZoneRule::getNextStart(UDate /*base*/, int32_t /*prevRawOffset*/, int32_t /*prevDSTSavings*/, UBool /*inclusive*/, UDate& /*result*/) const
{
    return FALSE;
}

UBool InitialTimeZoneRule::getPreviousStart(UDate /*base*/, int32_t /*prevRawOffset*/, int32_t /*prevDSTSavings*/, UBool /*inclusive*/, UDate& /*result*/) const
{
    return FALSE;
}
...
AnnualTimeZoneRule::AnnualTimeZoneRule(
    const UnicodeString& name, int32_t rawOffset, int32_t dstSavings, const DateTimeRule& dateTimeRule, int32_t startYear, int32_t endYear)
    : TimeZoneRule(name, rawOffset, dstSavings)
...
AnnualTimeZoneRule::AnnualTimeZoneRule(
    const UnicodeString& name, int32_t rawOffset, int32_t dstSavings, DateTimeRule* dateTimeRule, int32_t startYear, int32_t endYear)
    : TimeZoneRule(name, rawOffset, dstSavings)
...
AnnualTimeZoneRule::AnnualTimeZoneRule(const AnnualTimeZoneRule& source)
    : TimeZoneRule(source)
    , fDateTimeRule(new DateTimeRule(*(source.fDateTimeRule)))
    , fStartYear(source.fStartYear)
    , fEndYear(source.fEndYear)
{
}
...
AnnualTimeZoneRule* AnnualTimeZoneRule::clone(void) const
{
...
bool AnnualTimeZoneRule::operator==(const TimeZoneRule& that) const
{
    ...
    return (*fDateTimeRule == *(atzr->fDateTimeRule) && fStartYear == atzr->fStartYear && fEndYear == atzr->fEndYear);
}
...
UBool AnnualTimeZoneRule::getStartInYear(int32_t year, int32_t prevRawOffset, int32_t prevDSTSavings, UDate& result) const
{
    ...
    if (type == DateTimeRule::DOM) {
        ...
        if (type == DateTimeRule::DOW) {
            ...
            if (weeks > 0) {
                ...
                after = FALSE;
                ruleDay = Grego::fieldsToDay(year, fDateTimeRule->getRuleMonth(), Grego::monthLength(year, fDateTimeRule->getRuleMonth()));
                ruleDay += 7 * (weeks + 1);
            }
        } else {
...
UBool AnnualTimeZoneRule::isEquivalentTo(const TimeZoneRule& other) const
{
    if (this == &other) {
        return TRUE;
    }
    ...
    return (*fDateTimeRule == *(that->fDateTimeRule) && fStartYear == that->fStartYear && fEndYear == that->fEndYear);
}

UBool AnnualTimeZoneRule::getFirstStart(int32_t prevRawOffset, int32_t prevDSTSavings, UDate& result) const
{
    return getStartInYear(fStartYear, prevRawOffset, prevDSTSavings, result);
}

UBool AnnualTimeZoneRule::getFinalStart(int32_t prevRawOffset, int32_t prevDSTSavings, UDate& result) const
{
...
UBool AnnualTimeZoneRule::getNextStart(UDate base, int32_t prevRawOffset, int32_t prevDSTSavings, UBool inclusive, UDate& result) const
{
...
UBool AnnualTimeZoneRule::getPreviousStart(UDate base, int32_t prevRawOffset, int32_t prevDSTSavings, UBool inclusive, UDate& result) const
{
    int32_t year, month, dom, dow, doy, mid;
    Grego::timeToFields(base, year, month, dom, dow, doy, mid);
    if (year > fEndYear) {
...
TimeArrayTimeZoneRule::TimeArrayTimeZoneRule(
    const UnicodeString& name, int32_t rawOffset, int32_t dstSavings, const UDate* startTimes, int32_t numStartTimes, DateTimeRule::TimeRuleType timeRuleType)
    : TimeZoneRule(name, rawOffset, dstSavings)
...
TimeArrayTimeZoneRule* TimeArrayTimeZoneRule::clone(void) const
{
...
bool TimeArrayTimeZoneRule::operator==(const TimeZoneRule& that) const
{
    ...
    if (fTimeRuleType != tatzr->fTimeRuleType || fNumStartTimes != tatzr->fNumStartTimes) {
        return false;
    }
    // Compare start times
    bool res = true;
...
UBool TimeArrayTimeZoneRule::getStartTimeAt(int32_t index, UDate& result) const
{
...
UBool TimeArrayTimeZoneRule::isEquivalentTo(const TimeZoneRule& other) const
{
    if (this == &other) {
        return TRUE;
    }
    ...
    if (fTimeRuleType != that->fTimeRuleType || fNumStartTimes != that->fNumStartTimes) {
        return FALSE;
    }
    // Compare start times
    UBool res = TRUE;
...
UBool TimeArrayTimeZoneRule::getFirstStart(int32_t prevRawOffset, int32_t prevDSTSavings, UDate& result) const
{
...
UBool TimeArrayTimeZoneRule::getFinalStart(int32_t prevRawOffset, int32_t prevDSTSavings, UDate& result) const
{
    if (fNumStartTimes <= 0 || fStartTimes == NULL) {
        return FALSE;
    }
...
UBool TimeArrayTimeZoneRule::getNextStart(UDate base, int32_t prevRawOffset, int32_t prevDSTSavings, UBool inclusive, UDate& result) const
{
...
UBool TimeArrayTimeZoneRule::getPreviousStart(UDate base, int32_t prevRawOffset, int32_t prevDSTSavings, UBool inclusive, UDate& result) const
{
    int32_t i = fNumStartTimes - 1;
    for (; i >= 0; i--) {
        UDate time = getUTC(fStartTimes[i], prevRawOffset, prevDSTSavings);
...
UBool TimeArrayTimeZoneRule::initStartTimes(const UDate source[], int32_t size, UErrorCode& status)
{
    // Free old array
    if (fStartTimes != NULL && fStartTimes != fLocalStartTimes) {
        uprv_free(fStartTimes);
