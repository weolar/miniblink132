...
public:
    UTF8CollationIterator(const CollationData* d, UBool numeric, const uint8_t* s, int32_t p, int32_t len)
...
public:
    FCDUTF8CollationIterator(const CollationData* data, UBool numeric, const uint8_t* s, int32_t p, int32_t len)
