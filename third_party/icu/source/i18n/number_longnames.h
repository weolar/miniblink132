...
U_NAMESPACE_BEGIN namespace number
{
    ...
    public:
        static UnicodeString getUnitDisplayName(const Locale& loc, const MeasureUnit& unit, UNumberUnitWidth width, UErrorCode& status);
        ...
        static LongNameHandler* forCurrencyLongNames(
         ...
         */
        static void forMeasureUnit(const Locale& loc, const MeasureUnit& unitRef, const UNumberUnitWidth& width, const char* unitDisplayCase,
    ...
    private:
        ...
        static void forArbitraryUnit(const Locale& loc, const MeasureUnit& unit, const UNumberUnitWidth& width, const char* unitDisplayCase,
        ...
        static void processPatternTimes(
        ...
        void multiSimpleFormatsToModifiers(const UnicodeString* leadFormats, UnicodeString trailFormat, Field field, UErrorCode& status);
    };
    ...
    public:
         ...
         * @param fillIn Required.
         */
        static void forMeasureUnit(const Locale& loc, const MeasureUnit& mixedUnit, const UNumberUnitWidth& width, const char* unitDisplayCase,
    ...
    private:
        ...
        // unit.
        const Modifier* getMixedUnitModifier(DecimalQuantity& quantity, MicroProps& micros, UErrorCode& status) const;
    };
    ...
    public:
        ...
        static LongNameMultiplexer* forMeasureUnits(const Locale& loc, const MaybeStackVector<MeasureUnit>& units, const UNumberUnitWidth& width,
    ...
    private:
        ...
        LongNameMultiplexer(const MicroPropsGenerator* parent)
            : fParent(parent)
        {
        }
    };
