...
static Flag decCheckOperands(decNumber*, const decNumber*, const decNumber*, decContext*);
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberAbs(decNumber* res, const decNumber* rhs, decContext* set)
{
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberAnd(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set)
{
    ...
    if (lhs->exponent != 0 || decNumberIsSpecial(lhs) || decNumberIsNegative(lhs) || rhs->exponent != 0 || decNumberIsSpecial(rhs)
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberExp(decNumber* res, const decNumber* rhs, decContext* set)
{
    uInt status = 0; /* accumulator  */
#if DECSUBSET
...
/* C must have space for set->digits digits.                          */
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberFMA(decNumber* res, const decNumber* lhs, const decNumber* rhs, const decNumber* fhs, decContext* set)
{
    uInt status = 0; /* accumulator  */
    ...
    do { /* protect allocated storage  */
        ...
        if ((!decNumberIsSpecial(lhs) && decCheckMath(lhs, set, &status)) || (!decNumberIsSpecial(rhs) && decCheckMath(rhs, set, &status))
...
/* returned with Invalid_operation if a restriction is violated.      */
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberInvert(decNumber* res, const decNumber* rhs, decContext* set)
{
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberLn(decNumber* res, const decNumber* rhs, decContext* set)
{
    uInt status = 0; /* accumulator  */
#if DECSUBSET
    decNumber* allocrhs = NULL; /* non-NULL if rounded rhs allocated  */
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberLogB(decNumber* res, const decNumber* rhs, decContext* set)
{
    uInt status = 0; /* accumulator  */
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberMinus(decNumber* res, const decNumber* rhs, decContext* set)
{
    decNumber dzero;
    uInt status = 0; /* accumulator  */
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberNextMinus(decNumber* res, const decNumber* rhs, decContext* set)
{
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberNextPlus(decNumber* res, const decNumber* rhs, decContext* set)
{
    decNumber dtiny; /* constant  */
    decContext workset = *set; /* work  */
    uInt status = 0; /* accumulator  */
...
U_CAPI decNumber* U_EXPORT2 uprv_decNumberNextToward(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set)
{
    ...
    if (decNumberIsNaN(lhs) || decNumberIsNaN(rhs)) {
        ...
        if (result == BADINT)
            ...
            if (result == 0)
                uprv_decNumberCopySign(res, lhs, rhs); /* easy  */
                ...
                if (uprv_decNumberIsNormal(res, set))
                    status = 0;
            } /* unequal  */
        } /* compare OK  */
    } /* numeric  */
...
/* returned with Invalid_operation if a restriction is violated.      */
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberOr(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set)
{
    const Unit *ua, *ub; /* -> operands  */
    const Unit *msua, *msub; /* -> operand msus  */
    Unit *uc, *msuc; /* -> result and its msu  */
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberPlus(decNumber* res, const decNumber* rhs, decContext* set)
{
    decNumber dzero;
    uInt status = 0; /* accumulator  */
#if DECCHECK
...
/* error in rare cases.                                               */
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberPower(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set)
{
#if DECSUBSET
...
U_CAPI decNumber* U_EXPORT2 uprv_decNumberNormalize(decNumber* res, const decNumber* rhs, decContext* set)
{
    return uprv_decNumberReduce(res, rhs, set);
} /* decNumberNormalize  */

U_CAPI decNumber* U_EXPORT2 uprv_decNumberReduce(decNumber* res, const decNumber* rhs, decContext* set)
{
#if DECSUBSET
    decNumber* allocrhs = NULL; /* non-NULL if rounded rhs allocated  */
#endif
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberScaleB(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set)
{
...
#pragma GCC diagnostic ignored "-Warray-bounds"
#endif
U_CAPI decNumber* U_EXPORT2 uprv_decNumberSquareRoot(decNumber* res, const decNumber* rhs, decContext* set)
{
        ...
        if (SPECIALARG) {
            if (decNumberIsInfinite(rhs)) { /* an infinity  */
                if (decNumberIsNegative(rhs))
                    ...
                    uprv_decNumberCopy(res, rhs); /* +Infinity  */
            } else
...
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberToIntegralExact(decNumber* res, const decNumber* rhs, decContext* set)
{
    decNumber dn;
    ...
    if (SPECIALARG) {
        if (decNumberIsInfinite(rhs))
            uprv_decNumberCopy(res, rhs); /* an Infinity  */
        else
            decNaNs(res, rhs, NULL, set, &status); /* a NaN  */
    } else { /* finite  */
        /* have a finite number; no error possible (res must be big enough)  */
        if (rhs->exponent >= 0)
            return uprv_decNumberCopy(res, rhs);
...
U_CAPI decNumber* U_EXPORT2 uprv_decNumberToIntegralValue(decNumber* res, const decNumber* rhs, decContext* set)
{
...
/* returned with Invalid_operation if a restriction is violated.      */
/* ------------------------------------------------------------------ */
U_CAPI decNumber* U_EXPORT2 uprv_decNumberXor(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set)
{
    const Unit *ua, *ub; /* -> operands  */
    const Unit *msua, *msub; /* -> operand msus  */
    Unit *uc, *msuc; /* -> result and its msu  */
...
#if DECDPUN <= 4
                        if ((lsu - QUOT10(lsu, drop + 1) * powers[drop + 1]) != 0)
        ...
        if (SPECIALARG) { /* handle infinities and NaNs  */
            if (decNumberIsInfinite(rhs)) { /* an infinity  */
                if (decNumberIsNegative(rhs)) /* -Infinity -> +0  */
                    ...
                    uprv_decNumberCopy(res, rhs); /* +Infinity -> self  */
            } else
                decNaNs(res, rhs, NULL, set, status); /* a NaN  */
            break;
        }
...
/* ------------------------------------------------------------------ */
static const uShort LNnn[90] = { 9016, 8652, 8316, 8008, 7724, 7456, 7208, 6972, 6748, 6540, 6340, 6148, 5968, 5792, 5628, 5464, 5312, 5164, 5020, 4884, 4748,
    4620, 4496, 4376, 4256, 4144, 4032, 39233, 38181, 37157, 36157, 35181, 34229, 33297, 32389, 31501, 30629, 29777, 28945, 28129, 27329, 26545, 25777, 25021,
    24281, 23553, 22837, 22137, 21445, 20769, 20101, 19445, 18801, 18165, 17541, 16925, 16321, 15721, 15133, 14553, 13985, 13421, 12865, 12317, 11777, 11241,
    10717, 10197, 9685, 9177, 8677, 8185, 7697, 7213, 6737, 6269, 5801, 5341, 4889, 4437, 39930, 35534, 31186, 26886, 22630, 18418, 14254, 10130, 6046, 20055 };
...
/* result for this unit is negative or >DECDPUNMAX  */
    ...
    if (carry == 0)
        return static_cast<int32_t>(c - clsu); /* no carry, so no more to do  */
...
/* is returned.                                                       */
/* ------------------------------------------------------------------ */
static decNumber* decRoundOperand(const decNumber* dn, decContext* set, uInt* status)
{
    ...
    res = (decNumber*)malloc(sizeof(decNumber) + (D2U(set->digits) - 1) * sizeof(Unit));
    if (res == NULL) {
        *status |= DEC_Insufficient_storage;
        return NULL;
    }
...
/* All fields are updated as required.                                */
/* ------------------------------------------------------------------ */
static void decFinish(decNumber* dn, decContext* set, Int* residue, uInt* status)
{
    if (!set->extended) {
...
static uInt decCheckMath(const decNumber* rhs, decContext* set, uInt* status)
{
    ...
    if (set->digits > DEC_MAX_MATH || set->emax > DEC_MAX_MATH || -set->emin > DEC_MAX_MATH)
        *status |= DEC_Invalid_context;
    else if ((rhs->digits > DEC_MAX_MATH || rhs->exponent + rhs->digits > DEC_MAX_MATH + 1 || rhs->exponent + rhs->digits < 2 * (1 - DEC_MAX_MATH))
        && !ISZERO(rhs))
        *status |= DEC_Invalid_operation;
    return (*status != save);
} /* decCheckMath  */
...
static decNumber* decNaNs(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set, uInt* status)
{
    ...
    if (lhs->digits <= set->digits)
        uprv_decNumberCopy(res, lhs); /* easy  */
    else { /* too long  */
        const Unit* ul;
        Unit *ur, *uresp1;
...
/* ------------------------------------------------------------------ */
static Flag decCheckOperands(decNumber* res, const decNumber* lhs, const decNumber* rhs, decContext* set)
{
    Flag bad = 0;
    if (set == NULL) { /* oops; hopeless  */
        ...
        bad = 1;
        return 1;
    } else if (set != DECUNCONT && (set->digits < 1 || set->round >= DEC_ROUND_MAX)) {
        bad = 1;
#if DECTRACE || DECVERB
...
static void decCheckInexact(const decNumber* dn, decContext* set)
{
    ...
    if ((set->status & (DEC_Inexact | DEC_Subnormal)) == DEC_Inexact && (set->digits != dn->digits) && !(dn->bits & DECSPECIAL)) {
#if DECTRACE || DECVERB
