 ...
 * @stable ICU 3.0
 */
U_CAPI const UChar* U_EXPORT2 uregex_pattern(const URegularExpression* regexp, int32_t* patLength, UErrorCode* status);
 ...
 * @stable ICU 4.6
 */
U_CAPI UText* U_EXPORT2 uregex_patternUText(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_flags(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 3.0
 */
U_CAPI void U_EXPORT2 uregex_setText(URegularExpression* regexp, const UChar* text, int32_t textLength, UErrorCode* status);
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_setUText(URegularExpression* regexp, UText* text, UErrorCode* status);
 ...
 * @stable ICU 3.0
 */
U_CAPI const UChar* U_EXPORT2 uregex_getText(URegularExpression* regexp, int32_t* textLength, UErrorCode* status);
 ...
 * @stable ICU 4.6
 */
U_CAPI UText* U_EXPORT2 uregex_getUText(URegularExpression* regexp, UText* dest, UErrorCode* status);
 ...
 * @stable ICU 4.8
 */
U_CAPI void U_EXPORT2 uregex_refreshUText(URegularExpression* regexp, UText* text, UErrorCode* status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI UBool U_EXPORT2 uregex_matches(URegularExpression* regexp, int32_t startIndex, UErrorCode* status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI UBool U_EXPORT2 uregex_matches64(URegularExpression* regexp, int64_t startIndex, UErrorCode* status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI UBool U_EXPORT2 uregex_lookingAt(URegularExpression* regexp, int32_t startIndex, UErrorCode* status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI UBool U_EXPORT2 uregex_lookingAt64(URegularExpression* regexp, int64_t startIndex, UErrorCode* status);
 ...
 *   @stable ICU 3.0
 */
U_CAPI UBool U_EXPORT2 uregex_find(URegularExpression* regexp, int32_t startIndex, UErrorCode* status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI UBool U_EXPORT2 uregex_find64(URegularExpression* regexp, int64_t startIndex, UErrorCode* status);
 ...
 *  @stable ICU 3.0
 */
U_CAPI UBool U_EXPORT2 uregex_findNext(URegularExpression* regexp, UErrorCode* status);
 ...
 *   @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_groupCount(URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 55
 */
U_CAPI int32_t U_EXPORT2 uregex_groupNumberFromName(URegularExpression* regexp, const UChar* groupName, int32_t nameLength, UErrorCode* status);
 ...
 * @stable ICU 55
 */
U_CAPI int32_t U_EXPORT2 uregex_groupNumberFromCName(URegularExpression* regexp, const char* groupName, int32_t nameLength, UErrorCode* status);
 ...
 *   @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_group(URegularExpression* regexp, int32_t groupNum, UChar* dest, int32_t destCapacity, UErrorCode* status);
...
/** Returns a shallow immutable clone of the entire input string with the current index set
  ...
  *   @stable ICU 4.6
  */
U_CAPI UText* U_EXPORT2 uregex_groupUText(URegularExpression* regexp, int32_t groupNum, UText* dest, int64_t* groupLength, UErrorCode* status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_start(URegularExpression* regexp, int32_t groupNum, UErrorCode* status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_start64(URegularExpression* regexp, int32_t groupNum, UErrorCode* status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_end(URegularExpression* regexp, int32_t groupNum, UErrorCode* status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_end64(URegularExpression* regexp, int32_t groupNum, UErrorCode* status);
 ...
 *    @stable ICU 3.0
 */
U_CAPI void U_EXPORT2 uregex_reset(URegularExpression* regexp, int32_t index, UErrorCode* status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_reset64(URegularExpression* regexp, int64_t index, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setRegion(URegularExpression* regexp, int32_t regionStart, int32_t regionLimit, UErrorCode* status);
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_setRegion64(URegularExpression* regexp, int64_t regionStart, int64_t regionLimit, UErrorCode* status);
 ...
 * @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_setRegionAndStart(URegularExpression* regexp, int64_t regionStart, int64_t regionLimit, int64_t startIndex, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_regionStart(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_regionStart64(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_regionEnd(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.6
 */
U_CAPI int64_t U_EXPORT2 uregex_regionEnd64(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI UBool U_EXPORT2 uregex_hasTransparentBounds(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.0
 **/
U_CAPI void U_EXPORT2 uregex_useTransparentBounds(URegularExpression* regexp, UBool b, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI UBool U_EXPORT2 uregex_hasAnchoringBounds(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_useAnchoringBounds(URegularExpression* regexp, UBool b, UErrorCode* status);
 ...
 *  @stable ICU 4.0
 */
U_CAPI UBool U_EXPORT2 uregex_hitEnd(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI UBool U_EXPORT2 uregex_requireEnd(const URegularExpression* regexp, UErrorCode* status);
...
U_CAPI int32_t U_EXPORT2 uregex_replaceAll(
    URegularExpression* regexp, const UChar* replacementText, int32_t replacementLength, UChar* destBuf, int32_t destCapacity, UErrorCode* status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI UText* U_EXPORT2 uregex_replaceAllUText(URegularExpression* regexp, UText* replacement, UText* dest, UErrorCode* status);
 ...
 *    @stable ICU 4.6
 */
U_CAPI UText* U_EXPORT2 uregex_replaceFirstUText(URegularExpression* regexp, UText* replacement, UText* dest, UErrorCode* status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI void U_EXPORT2 uregex_appendReplacementUText(URegularExpression* regexp, UText* replacementText, UText* dest, UErrorCode* status);
 ...
 *   @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_appendTail(URegularExpression* regexp, UChar** destBuf, int32_t* destCapacity, UErrorCode* status);
 ...
 *   @stable ICU 4.6
 */
U_CAPI UText* U_EXPORT2 uregex_appendTailUText(URegularExpression* regexp, UText* dest, UErrorCode* status);
 ...
 * @stable ICU 3.0
 */
U_CAPI int32_t U_EXPORT2 uregex_split(URegularExpression* regexp, UChar* destBuf, int32_t destCapacity, int32_t* requiredCapacity, UChar* destFields[],
 ...
 * @stable ICU 4.6
 */
U_CAPI int32_t U_EXPORT2 uregex_splitUText(URegularExpression* regexp, UText* destFields[], int32_t destFieldsCapacity, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setTimeLimit(URegularExpression* regexp, int32_t limit, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_getTimeLimit(const URegularExpression* regexp, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setStackLimit(URegularExpression* regexp, int32_t limit, UErrorCode* status);
 ...
 * @stable ICU 4.0
 */
U_CAPI int32_t U_EXPORT2 uregex_getStackLimit(const URegularExpression* regexp, UErrorCode* status);
 ...
 */
U_CDECL_BEGIN
typedef UBool U_CALLCONV URegexMatchCallback(const void* context, int32_t steps);
U_CDECL_END
 ...
 * @stable ICU 4.0
 */
U_CAPI void U_EXPORT2 uregex_setMatchCallback(URegularExpression* regexp, URegexMatchCallback* callback, const void* context, UErrorCode* status);
 ...
 */
U_CDECL_BEGIN
typedef UBool U_CALLCONV URegexFindProgressCallback(const void* context, int64_t matchIndex);
U_CDECL_END
...
U_CAPI void U_EXPORT2 uregex_getFindProgressCallback(
    const URegularExpression* regexp, URegexFindProgressCallback** callback, const void** context, UErrorCode* status);
