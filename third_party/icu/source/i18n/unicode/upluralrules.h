...
U_CAPI int32_t U_EXPORT2 uplrules_selectFormatted(
    const UPluralRules* uplrules, const struct UFormattedNumber* number, UChar* keyword, int32_t capacity, UErrorCode* status);
...
U_CAPI int32_t U_EXPORT2 uplrules_selectForRange(
    const UPluralRules* uplrules, const struct UFormattedNumberRange* urange, UChar* keyword, int32_t capacity, UErrorCode* status);
