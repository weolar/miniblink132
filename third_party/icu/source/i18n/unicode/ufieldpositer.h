 ...
 * @stable ICU 55
 */
U_CAPI UFieldPositionIterator* U_EXPORT2 ufieldpositer_open(UErrorCode* status);
 ...
 * @stable ICU 55
 */
U_CAPI int32_t U_EXPORT2 ufieldpositer_next(UFieldPositionIterator* fpositer, int32_t* beginIndex, int32_t* endIndex);
