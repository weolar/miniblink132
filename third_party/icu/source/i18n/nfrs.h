...
public:
    ...
    UBool isFractionRuleSet() const
    {
        return fIsFractionRuleSet;
    }

    void getName(UnicodeString& result) const
    {
        result.setTo(name);
    }
    UBool isNamed(const UnicodeString& _name) const
    {
    ...
    const RuleBasedNumberFormat* getOwner() const
    {
        return owner;
    }
