...
static void showCurrencyFormatting(UBool useICU26API);
 ...
 */
static void setNumberFormatCurrency_2_4(NumberFormat& nf, const char* currency, UErrorCode& errorCode)
{
    // argument checking
    ...
    static const struct {
        ...
        UChar symbol[16];
    } currencyMap[] = { { "USD", 2, 0.0, { 0x24, 0 } }, { "GBP", 2, 0.0, { 0xa3, 0 } }, { "EUR", 2, 0.0, { 0x20ac, 0 } }, { "JPY", 0, 0.0, { 0xa5, 0 } } };
 ...
 * @param errorCode ICU error code, must pass U_SUCCESS() on input.
 */
static void setNumberFormatCurrency_2_6(NumberFormat& nf, const char* currency, UErrorCode& errorCode)
{
    if (U_FAILURE(errorCode)) {
        return;
    }
...
static const char* const sampleLocaleIDs[] = {
...
static const char* const sampleCurrencies[] = { "USD", "GBP", "EUR", "JPY" };
