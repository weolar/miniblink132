...
static UDate getWhen(const char* millis, const char* seconds, const char* format, const char* locale, UDateFormatStyle style, const char* parse,
    const UChar* tz, UErrorCode* status);
