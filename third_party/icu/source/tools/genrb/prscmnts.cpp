...
const char* patternStrings[UPC_LIMIT] = { "^translate\\s*(.*)", "^note\\s*(.*)" };
...
U_CFUNC int32_t getText(const UChar* source, int32_t srcLen, UChar** dest, int32_t destCapacity, UnicodeString patternString, UErrorCode* status)
{
