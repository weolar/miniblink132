...
#define UFMT_SIMPLE_PERCENT                                                                                                                                    \
    {                                                                                                                                                          \
        ufmt_simple_percent, u_printf_simple_percent_handler                                                                                                   \
    }
/* s */
#define UFMT_STRING                                                                                                                                            \
    {                                                                                                                                                          \
        ufmt_string, u_printf_string_handler                                                                                                                   \
    }
/* c */
#define UFMT_CHAR                                                                                                                                              \
    {                                                                                                                                                          \
        ufmt_char, u_printf_char_handler                                                                                                                       \
    }
/* d, i */
#define UFMT_INT                                                                                                                                               \
    {                                                                                                                                                          \
        ufmt_int, u_printf_integer_handler                                                                                                                     \
    }
/* u */
#define UFMT_UINT                                                                                                                                              \
    {                                                                                                                                                          \
        ufmt_int, u_printf_uinteger_handler                                                                                                                    \
    }
/* o */
#define UFMT_OCTAL                                                                                                                                             \
    {                                                                                                                                                          \
        ufmt_int, u_printf_octal_handler                                                                                                                       \
    }
/* x, X */
#define UFMT_HEX                                                                                                                                               \
    {                                                                                                                                                          \
        ufmt_int, u_printf_hex_handler                                                                                                                         \
    }
/* f */
#define UFMT_DOUBLE                                                                                                                                            \
    {                                                                                                                                                          \
        ufmt_double, u_printf_double_handler                                                                                                                   \
    }
/* e, E */
#define UFMT_SCIENTIFIC                                                                                                                                        \
    {                                                                                                                                                          \
        ufmt_double, u_printf_scientific_handler                                                                                                               \
    }
/* g, G */
#define UFMT_SCIDBL                                                                                                                                            \
    {                                                                                                                                                          \
        ufmt_double, u_printf_scidbl_handler                                                                                                                   \
    }
/* n */
#define UFMT_COUNT                                                                                                                                             \
    {                                                                                                                                                          \
        ufmt_count, u_printf_count_handler                                                                                                                     \
    }
...
#define UFMT_POINTER                                                                                                                                           \
    {                                                                                                                                                          \
        ufmt_pointer, u_printf_pointer_handler                                                                                                                 \
    }
/* V */
#define UFMT_SPELLOUT                                                                                                                                          \
    {                                                                                                                                                          \
        ufmt_double, u_printf_spellout_handler                                                                                                                 \
    }
/* P */
#define UFMT_PERCENT                                                                                                                                           \
    {                                                                                                                                                          \
        ufmt_double, u_printf_percent_handler                                                                                                                  \
    }
/* C  K is old format */
#define UFMT_UCHAR                                                                                                                                             \
    {                                                                                                                                                          \
        ufmt_uchar, u_printf_uchar_handler                                                                                                                     \
    }
/* S  U is old format */
#define UFMT_USTRING                                                                                                                                           \
    {                                                                                                                                                          \
        ufmt_ustring, u_printf_ustring_handler                                                                                                                 \
    }
 ...
 */
typedef int32_t U_EXPORT2 u_printf_handler(const u_printf_stream_handler* handler,
...
/* handle a '%' */
static int32_t u_printf_simple_percent_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)formatBundle;
    (void)info;
    (void)args;
...
/* handle 's' */
static int32_t u_printf_string_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)formatBundle;
    UChar* s;
...
static int32_t u_printf_double_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
...
/* HSYS */
static int32_t u_printf_integer_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
...
static int32_t u_printf_hex_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)formatBundle;
    int64_t num = args[0].int64Value;
...
static int32_t u_printf_octal_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)formatBundle;
    int64_t num = args[0].int64Value;
    ...
    /* format the number, preserving the minimum # of digits */
    ufmt_64tou(result, &len, num, 8, FALSE, /* doesn't matter for octal */
...
static int32_t u_printf_uinteger_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    int64_t num = args[0].int64Value;
    UNumberFormat* format;
...
static int32_t u_printf_pointer_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)formatBundle;
    UChar result[UPRINTF_BUFFER_SIZE];
...
static int32_t u_printf_scientific_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    double num = (double)(args[0].doubleValue);
    UNumberFormat* format;
...
static int32_t u_printf_percent_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    double num = (double)(args[0].doubleValue);
    UNumberFormat* format;
...
static int32_t u_printf_ustring_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)formatBundle;
    int32_t len, written;
...
static int32_t u_printf_uchar_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)formatBundle;
    int32_t written = 0;
...
static int32_t u_printf_scidbl_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
...
static int32_t u_printf_count_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    (void)handler;
    (void)context;
...
static int32_t u_printf_spellout_handler(
    const u_printf_stream_handler* handler, void* context, ULocaleBundle* formatBundle, const u_printf_spec_info* info, const ufmt_args* args)
{
    double num = (double)(args[0].doubleValue);
    UNumberFormat* format;
...
#define ISFLAG(s) (s) == FLAG_MINUS || (s) == FLAG_PLUS || (s) == FLAG_SPACE || (s) == FLAG_POUND || (s) == FLAG_ZERO || (s) == FLAG_PAREN
...
#define ISDIGIT(s)                                                                                                                                             \
    (s) == DIGIT_ZERO || (s) == DIGIT_ONE || (s) == DIGIT_TWO || (s) == DIGIT_THREE || (s) == DIGIT_FOUR || (s) == DIGIT_FIVE || (s) == DIGIT_SIX              \
        || (s) == DIGIT_SEVEN || (s) == DIGIT_EIGHT || (s) == DIGIT_NINE
...
U_CFUNC int32_t u_printf_parse(const u_printf_stream_handler* streamHandler, const UChar* fmt, void* context, u_localized_print_string* locStringContext,
    ULocaleBundle* formatBundle, int32_t* written, va_list ap)
{
    uint16_t handlerNum;
    ufmt_args args;
