 ...
 * @internal
 */
#if (defined(__GNUC__) && (__GNUC__ > 4 || (__GNUC__ == 4 && __GNUC_MINOR__ >= 3))) || UPRV_HAS_ATTRIBUTE(alloc_size)
...
/* Use the predefined value. */
#elif U_HAVE_CHAR16_T || (defined(__xlC__) && defined(__IBM_UTF_LITERAL) && U_SIZEOF_WCHAR_T != 2) || (defined(__HP_aCC) && __HP_aCC >= 035000)                \
