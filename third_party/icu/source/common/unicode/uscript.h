 ...
 * @stable ICU 2.4
 */
U_CAPI UScriptCode U_EXPORT2 uscript_getScript(UChar32 codepoint, UErrorCode* err);
 ...
 * @stable ICU 49
 */
U_CAPI UBool U_EXPORT2 uscript_hasScript(UChar32 c, UScriptCode sc);
 ...
 * @stable ICU 51
 */
U_COMMON_API icu::UnicodeString U_EXPORT2 uscript_getSampleUnicodeString(UScriptCode script);
 ...
 * @stable ICU 51
 */
U_CAPI UScriptUsage U_EXPORT2 uscript_getUsage(UScriptCode script);
 ...
 * @stable ICU 51
 */
U_CAPI UBool U_EXPORT2 uscript_isRightToLeft(UScriptCode script);
 ...
 * @stable ICU 51
 */
U_CAPI UBool U_EXPORT2 uscript_breaksBetweenLetters(UScriptCode script);
 ...
 * @stable ICU 51
 */
U_CAPI UBool U_EXPORT2 uscript_isCased(UScriptCode script);
