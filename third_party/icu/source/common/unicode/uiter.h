 ...
 * @stable ICU 2.1
 */
U_CAPI void U_EXPORT2 uiter_setCharacterIterator(UCharIterator* iter, icu::CharacterIterator* charIter);
 ...
 * @stable ICU 2.1
 */
U_CAPI void U_EXPORT2 uiter_setReplaceable(UCharIterator* iter, const icu::Replaceable* rep);
