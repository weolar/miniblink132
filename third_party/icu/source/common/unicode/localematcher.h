...
public:
    ...
    public:
         ...
         * @stable ICU 65
         */
        inline int32_t getDesiredIndex() const
        {
            return desiredIndex;
        }
         ...
         * @stable ICU 65
         */
        inline int32_t getSupportedIndex() const
        {
    ...
    private:
        Result(const Locale* desired, const Locale* supported, int32_t desIndex, int32_t suppIndex, UBool owned)
