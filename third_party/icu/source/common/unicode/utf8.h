 ...
 * @internal
 */
U_CAPI int32_t U_EXPORT2 utf8_appendCharSafeBody(uint8_t* s, int32_t i, int32_t length, UChar32 c, UBool* pIsError);
    ...
    {                                                                                                                                                          \
        ...
        if (U8_IS_LEAD(__b) && (i) != (length)) {                                                                                                              \
            ...
            if ((0xe0 <= __b && __b < 0xf0)) {                                                                                                                 \
                ...
                if (U8_IS_VALID_LEAD4_AND_T1(__b, __t1) && ++(i) != (length) && U8_IS_TRAIL((s)[i]) && ++(i) != (length) && U8_IS_TRAIL((s)[i])) {             \
                    ++(i);                                                                                                                                     \
                }                                                                                                                                              \
            }                                                                                                                                                  \
        }                                                                                                                                                      \
