...
#endif
#include "patch_code/local_name_xp.h"
 ...
 */
#define ILCID_POSIX_SUBTABLE(id) static const ILcidPosixElement locmap_##id[] =
...
ILCID_POSIX_SUBTABLE(ar) { { 0x01, "ar" }, { 0x3801, "ar_AE" }, { 0x3c01, "ar_BH" }, { 0x1401, "ar_DZ" }, { 0x0c01, "ar_EG" }, { 0x0801, "ar_IQ" },
    { 0x2c01, "ar_JO" }, { 0x3401, "ar_KW" }, { 0x3001, "ar_LB" }, { 0x1001, "ar_LY" }, { 0x1801, "ar_MA" }, { 0x1801, "ar_MO" }, { 0x2001, "ar_OM" },
    { 0x4001, "ar_QA" }, { 0x0401, "ar_SA" }, { 0x2801, "ar_SY" }, { 0x1c01, "ar_TN" }, { 0x2401, "ar_YE" } };
...
ILCID_POSIX_SUBTABLE(az) {
    { 0x2c, "az" }, { 0x082c, "az_Cyrl_AZ" }, /* Cyrillic based */
...
ILCID_POSIX_SUBTABLE(bin) { { 0x66, "bin" }, { 0x0466, "bin_NG" } };

ILCID_POSIX_SUBTABLE(bn) { { 0x45, "bn" }, { 0x0845, "bn_BD" }, { 0x0445, "bn_IN" } };

ILCID_POSIX_SUBTABLE(bo) { { 0x51, "bo" }, { 0x0851, "bo_BT" }, { 0x0451, "bo_CN" }, { 0x0c51, "dz_BT" } };

ILCID_POSIX_ELEMENT_ARRAY(0x047e, br, br_FR)

ILCID_POSIX_SUBTABLE(ca) { { 0x03, "ca" }, { 0x0403, "ca_ES" }, { 0x0803, "ca_ES_VALENCIA" } };

ILCID_POSIX_ELEMENT_ARRAY(0x0483, co, co_FR)

ILCID_POSIX_SUBTABLE(chr) { { 0x05c, "chr" }, { 0x7c5c, "chr_Cher" }, { 0x045c, "chr_Cher_US" }, { 0x045c, "chr_US" } };

// ICU has chosen different names for these.
ILCID_POSIX_SUBTABLE(ckb) { { 0x92, "ckb" }, { 0x7c92, "ckb_Arab" }, { 0x0492, "ckb_Arab_IQ" } };
...
ILCID_POSIX_SUBTABLE(de) {
    { 0x07, "de" }, { 0x0c07, "de_AT" }, { 0x0807, "de_CH" }, { 0x0407, "de_DE" }, { 0x1407, "de_LI" }, { 0x1007, "de_LU" },
...
ILCID_POSIX_SUBTABLE(en) {
    { 0x09, "en" }, { 0x0c09, "en_AU" }, { 0x2809, "en_BZ" }, { 0x1009, "en_CA" }, { 0x0809, "en_GB" }, { 0x3c09, "en_HK" }, { 0x3809, "en_ID" },
    { 0x1809, "en_IE" }, { 0x4009, "en_IN" }, { 0x2009, "en_JM" }, { 0x4409, "en_MY" }, { 0x1409, "en_NZ" }, { 0x3409, "en_PH" }, { 0x4809, "en_SG" },
    { 0x2C09, "en_TT" }, { 0x0409, "en_US" }, { 0x007f, "en_US_POSIX" }, /* duplicate for round-tripping */
    { 0x2409, "en_029" }, { 0x1c09, "en_ZA" }, { 0x3009, "en_ZW" },
...
ILCID_POSIX_SUBTABLE(es) {
    { 0x0a, "es" }, { 0x2c0a, "es_AR" }, { 0x400a, "es_BO" }, { 0x340a, "es_CL" }, { 0x240a, "es_CO" }, { 0x140a, "es_CR" }, { 0x5c0a, "es_CU" },
    { 0x1c0a, "es_DO" }, { 0x300a, "es_EC" }, { 0x0c0a, "es_ES" }, /*Modern sort.*/
    { 0x100a, "es_GT" }, { 0x480a, "es_HN" }, { 0x080a, "es_MX" }, { 0x4c0a, "es_NI" }, { 0x180a, "es_PA" }, { 0x280a, "es_PE" }, { 0x500a, "es_PR" },
    { 0x3c0a, "es_PY" }, { 0x440a, "es_SV" }, { 0x540a, "es_US" }, { 0x380a, "es_UY" }, { 0x200a, "es_VE" }, { 0x580a, "es_419" },
    { 0x040a, "es_ES@collation=traditional" }, { 0x040a, "es@collation=traditional" } // Windows will treat this as es-ES@collation=traditional
};
...
ILCID_POSIX_SUBTABLE(fa) {
    { 0x29, "fa" }, { 0x0429, "fa_IR" }, /* Persian/Farsi (Iran) */
...
ILCID_POSIX_SUBTABLE(ff) { { 0x67, "ff" }, { 0x7c67, "ff_Latn" }, { 0x0867, "ff_Latn_SN" }, { 0x0467, "ff_NG" } };
...
ILCID_POSIX_SUBTABLE(fr) { { 0x0c, "fr" }, { 0x080c, "fr_BE" }, { 0x0c0c, "fr_CA" }, { 0x240c, "fr_CD" }, { 0x240c, "fr_CG" }, { 0x100c, "fr_CH" },
    { 0x300c, "fr_CI" }, { 0x2c0c, "fr_CM" }, { 0x040c, "fr_FR" }, { 0x3c0c, "fr_HT" }, { 0x140c, "fr_LU" }, { 0x380c, "fr_MA" }, { 0x180c, "fr_MC" },
    { 0x340c, "fr_ML" }, { 0x200c, "fr_RE" }, { 0x280c, "fr_SN" }, { 0xe40c, "fr_015" }, { 0x1c0c, "fr_029" } };
...
ILCID_POSIX_SUBTABLE(ga) { /* Gaelic (Ireland) */
    { 0x3c, "ga" }, { 0x083c, "ga_IE" }, { 0x043c, "gd_GB" }
};

ILCID_POSIX_SUBTABLE(gd) { /* Gaelic (Scotland) */
    { 0x91, "gd" }, { 0x0491, "gd_GB" }
};
...
ILCID_POSIX_SUBTABLE(hr) {
    { 0x1a, "hr" }, { 0x141a, "bs_Latn_BA" }, /* Bosnian, Bosnia and Herzegovina */
    ...
    { 0x2c1a, "sr_Latn_ME" }, { 0x241a, "sr_Latn_RS" }, { 0x181a, "sr_Latn_BA" }, /* Serbo-Croatian in Bosnia */
    ...
    { 0x301a, "sr_Cyrl_ME" }, { 0x281a, "sr_Cyrl_RS" }, { 0x6c1a, "sr_Cyrl" }, /* It's 0x1a or 0x0c1a, pick one to make the test program happy. */
...
ILCID_POSIX_SUBTABLE(ibb) { { 0x69, "ibb" }, { 0x0469, "ibb_NG" } };
...
ILCID_POSIX_SUBTABLE(it) { { 0x10, "it" }, { 0x0810, "it_CH" }, { 0x0410, "it_IT" } };

ILCID_POSIX_SUBTABLE(iu) { { 0x5d, "iu" }, { 0x045d, "iu_Cans_CA" }, { 0x785d, "iu_Cans" }, { 0x085d, "iu_Latn_CA" }, { 0x7c5d, "iu_Latn" } };
...
ILCID_POSIX_SUBTABLE(ko) { { 0x12, "ko" }, { 0x0812, "ko_KP" }, { 0x0412, "ko_KR" } };
...
ILCID_POSIX_SUBTABLE(ks) { /* We could add PK and CN too */
    { 0x60, "ks" }, { 0x0460, "ks_Arab_IN" }, { 0x0860, "ks_Deva_IN" }
};

ILCID_POSIX_ELEMENT_ARRAY(0x0440, ky, ky_KG) /* Kyrgyz is spoken in Kyrgyzstan */

ILCID_POSIX_SUBTABLE(la) {
    { 0x76, "la" }, { 0x0476, "la_001" }, { 0x0476, "la_IT" } /*Left in for compatibility*/
};
...
ILCID_POSIX_SUBTABLE(mn) { { 0x50, "mn" }, { 0x0450, "mn_MN" }, { 0x7c50, "mn_Mong" }, { 0x0850, "mn_Mong_CN" }, { 0x0850, "mn_CN" }, { 0x7850, "mn_Cyrl" },
    { 0x0c50, "mn_Mong_MN" } };
...
ILCID_POSIX_SUBTABLE(ms) {
    { 0x3e, "ms" }, { 0x083e, "ms_BN" }, /* Brunei Darussalam*/
...
ILCID_POSIX_SUBTABLE(ne) {
    { 0x61, "ne" }, { 0x0861, "ne_IN" }, /* India*/
    { 0x0461, "ne_NP" } /* Nepal*/
};

ILCID_POSIX_SUBTABLE(nl) { { 0x13, "nl" }, { 0x0813, "nl_BE" }, { 0x0413, "nl_NL" } };
...
ILCID_POSIX_SUBTABLE(om) { /* TODO: Verify the country */
    { 0x72, "om" }, { 0x0472, "om_ET" }, { 0x0472, "gaz_ET" }
};
...
ILCID_POSIX_SUBTABLE(pa) { { 0x46, "pa" }, { 0x0446, "pa_IN" }, { 0x0846, "pa_Arab_PK" }, { 0x0846, "pa_PK" } };

ILCID_POSIX_SUBTABLE(pap) {
    { 0x79, "pap" }, { 0x0479, "pap_029" }, { 0x0479, "pap_AN" } /*Left in for compatibility*/
};

ILCID_POSIX_ELEMENT_ARRAY(0x0415, pl, pl_PL)
ILCID_POSIX_ELEMENT_ARRAY(0x0463, ps, ps_AF)

ILCID_POSIX_SUBTABLE(pt) { { 0x16, "pt" }, { 0x0416, "pt_BR" }, { 0x0816, "pt_PT" } };

ILCID_POSIX_SUBTABLE(
    qu) { { 0x6b, "qu" }, { 0x046b, "qu_BO" }, { 0x086b, "qu_EC" }, { 0x0C6b, "qu_PE" }, { 0x046b, "quz_BO" }, { 0x086b, "quz_EC" }, { 0x0C6b, "quz_PE" } };

ILCID_POSIX_SUBTABLE(quc) { { 0x93, "quc" }, { 0x0493, "quc_CO" },
    /*
...
ILCID_POSIX_SUBTABLE(qut) { { 0x86, "qut" }, { 0x0486, "qut_GT" },
    /*
...
ILCID_POSIX_SUBTABLE(ro) { { 0x18, "ro" }, { 0x0418, "ro_RO" }, { 0x0818, "ro_MD" } };
...
ILCID_POSIX_SUBTABLE(root) { { 0x00, "root" } };

ILCID_POSIX_SUBTABLE(ru) { { 0x19, "ru" }, { 0x0419, "ru_RU" }, { 0x0819, "ru_MD" } };
...
ILCID_POSIX_SUBTABLE(
    sd) { { 0x59, "sd" }, { 0x0459, "sd_Deva_IN" }, { 0x0459, "sd_IN" }, { 0x0859, "sd_Arab_PK" }, { 0x0859, "sd_PK" }, { 0x7c59, "sd_Arab" } };
...
ILCID_POSIX_SUBTABLE(so) { { 0x77, "so" }, { 0x0477, "so_SO" } };

ILCID_POSIX_ELEMENT_ARRAY(0x041c, sq, sq_AL)
ILCID_POSIX_ELEMENT_ARRAY(0x0430, st, st_ZA)

ILCID_POSIX_SUBTABLE(sv) { { 0x1d, "sv" }, { 0x081d, "sv_FI" }, { 0x041d, "sv_SE" } };

ILCID_POSIX_ELEMENT_ARRAY(0x0441, sw, sw_KE)
ILCID_POSIX_ELEMENT_ARRAY(0x045A, syr, syr_SY)

ILCID_POSIX_SUBTABLE(ta) { { 0x49, "ta" }, { 0x0449, "ta_IN" }, { 0x0849, "ta_LK" } };

ILCID_POSIX_ELEMENT_ARRAY(0x044a, te, te_IN)

/* Cyrillic based by default */
ILCID_POSIX_SUBTABLE(tg) { { 0x28, "tg" }, { 0x7c28, "tg_Cyrl" }, { 0x0428, "tg_Cyrl_TJ" } };

ILCID_POSIX_ELEMENT_ARRAY(0x041e, th, th_TH)

ILCID_POSIX_SUBTABLE(ti) { { 0x73, "ti" }, { 0x0873, "ti_ER" }, { 0x0473, "ti_ET" } };

ILCID_POSIX_ELEMENT_ARRAY(0x0442, tk, tk_TM)

ILCID_POSIX_SUBTABLE(tn) { { 0x32, "tn" }, { 0x0832, "tn_BW" }, { 0x0432, "tn_ZA" } };
...
ILCID_POSIX_SUBTABLE(
    tzm) { { 0x5f, "tzm" }, { 0x7c5f, "tzm_Latn" }, { 0x085f, "tzm_Latn_DZ" }, { 0x105f, "tzm_Tfng_MA" }, { 0x045f, "tzm_Arab_MA" }, { 0x045f, "tmz" } };

ILCID_POSIX_SUBTABLE(ug) { { 0x80, "ug" }, { 0x0480, "ug_CN" }, { 0x0480, "ug_Arab_CN" } };

ILCID_POSIX_ELEMENT_ARRAY(0x0422, uk, uk_UA)

ILCID_POSIX_SUBTABLE(ur) { { 0x20, "ur" }, { 0x0820, "ur_IN" }, { 0x0420, "ur_PK" } };

ILCID_POSIX_SUBTABLE(uz) {
    { 0x43, "uz" }, { 0x0843, "uz_Cyrl_UZ" }, /* Cyrillic based */
...
ILCID_POSIX_SUBTABLE(ve) { /* TODO: Verify the country */
    { 0x33, "ve" }, { 0x0433, "ve_ZA" }, { 0x0433, "ven_ZA" }
};
...
ILCID_POSIX_SUBTABLE(yi) { { 0x003d, "yi" }, { 0x043d, "yi_001" } };
...
ILCID_POSIX_SUBTABLE(zh) {
    { 0x0004, "zh_Hans" }, { 0x7804, "zh" }, { 0x0804, "zh_CN" }, { 0x0804, "zh_Hans_CN" }, { 0x0c04, "zh_Hant_HK" }, { 0x0c04, "zh_HK" },
    { 0x1404, "zh_Hant_MO" }, { 0x1404, "zh_MO" }, { 0x1004, "zh_Hans_SG" }, { 0x1004, "zh_SG" }, { 0x0404, "zh_Hant_TW" }, { 0x7c04, "zh_Hant" },
    { 0x0404, "zh_TW" }, { 0x30404, "zh_Hant_TW" }, /* Bopomofo order */
    { 0x30404, "zh_TW" }, /* Bopomofo order */
    { 0x20004, "zh@collation=stroke" }, { 0x20404, "zh_Hant@collation=stroke" }, { 0x20404, "zh_Hant_TW@collation=stroke" },
    { 0x20404, "zh_TW@collation=stroke" }, { 0x20804, "zh_Hans@collation=stroke" }, { 0x20804, "zh_Hans_CN@collation=stroke" },
...
U_CAPI int32_t uprv_convertToPosix(uint32_t hostid, char* posixID, int32_t posixIDCapacity, UErrorCode* status)
{
    ...
    if ((hostid & 0x3FF) != 0x92) {
        ...
        tmpLen = LCIDToLocaleNameXp(hostid, (PWSTR)windowsLocaleName, UPRV_LENGTHOF(windowsLocaleName), LOCALE_ALLOW_NEUTRAL_NAMES);
        if (tmpLen > 1) {
            int32_t i = 0;
...
U_CAPI uint32_t uprv_convertToLCIDPlatform(const char* localeID, UErrorCode* status)
{
    ...
    if (U_SUCCESS(*status)) {
        ...
        if (i < (UPRV_LENGTHOF(bcp47Tag) - 1)) {
            ...
            bcp47Tag[i] = L'\0';
            LCID lcid = LocaleNameToLCIDXp(bcp47Tag, LOCALE_ALLOW_NEUTRAL_NAMES);
            if (lcid > 0) {
