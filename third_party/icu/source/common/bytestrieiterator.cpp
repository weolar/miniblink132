...
BytesTrie::Iterator& BytesTrie::Iterator::reset()
{
    pos_ = initialPos_;
...
UBool BytesTrie::Iterator::truncateAndStop()
{
    pos_ = NULL;
...
const uint8_t* BytesTrie::Iterator::branchNext(const uint8_t* pos, int32_t length, UErrorCode& errorCode)
{
