...
#if IEEE_754
static UBool u_signBit(double d)
{
    uint8_t hiByte;
#if U_IS_BIG_ENDIAN
    hiByte = *(uint8_t*)&d;
...
U_CAPI UDate U_EXPORT2 uprv_getUTCtime()
{
#if defined(U_DEBUG_FAKETIME)
...
U_CAPI UDate U_EXPORT2 uprv_getRawUTCtime()
{
#if U_PLATFORM_USES_ONLY_WIN32_API
...
U_CAPI UBool U_EXPORT2 uprv_isNaN(double number)
{
#if IEEE_754
    ...
    return ((highBits & 0x7F080000L) == 0x7F080000L) && (lowBits == 0x00000000L);
...
U_CAPI UBool U_EXPORT2 uprv_isInfinite(double number)
{
#if IEEE_754
    BitPatternConversion convertedNumber;
    convertedNumber.d64 = number;
...
U_CAPI UBool U_EXPORT2 uprv_isPositiveInfinity(double number)
{
...
U_CAPI UBool U_EXPORT2 uprv_isNegativeInfinity(double number)
{
#if IEEE_754 || U_PLATFORM == U_PF_OS390
    return (UBool)(number < 0 && uprv_isInfinite(number));
...
U_CAPI double U_EXPORT2 uprv_getNaN()
{
#if IEEE_754 || U_PLATFORM == U_PF_OS390
    return gNan.d64;
#else
...
U_CAPI double U_EXPORT2 uprv_getInfinity()
{
#if IEEE_754 || U_PLATFORM == U_PF_OS390
    return gInf.d64;
#else
...
/* Time zone utilities */
U_CAPI void U_EXPORT2 uprv_tzset()
{
#if defined(U_TZSET)
    U_TZSET();
#else
...
U_CAPI int32_t U_EXPORT2 uprv_timezone()
{
#ifdef U_TIMEZONE
    return U_TIMEZONE;
#else
...
extern U_IMPORT char* U_TZNAME[];
    ...
    && ((U_PLATFORM_IS_DARWIN_BASED && (U_PLATFORM != U_PF_IPHONE || defined(U_TIMEZONE))) || U_PLATFORM_IS_LINUX_BASED || U_PLATFORM == U_PF_BSD              \
        || U_PLATFORM == U_PF_SOLARIS)
...
static UBool isValidOlsonID(const char* id)
{
    ...
    return (UBool)(id[idx] == 0 || uprv_strcmp(id, "PST8PDT") == 0 || uprv_strcmp(id, "MST7MDT") == 0 || uprv_strcmp(id, "CST6CDT") == 0
...
static const struct OffsetZoneMapping OFFSET_ZONE_MAPPINGS[]
    = { { -45900, 2, "CHAST", "CHADT", "Pacific/Chatham" }, { -43200, 1, "PETT", "PETST", "Asia/Kamchatka" }, { -43200, 2, "NZST", "NZDT", "Pacific/Auckland" },
          { -43200, 1, "ANAT", "ANAST", "Asia/Anadyr" }, { -39600, 1, "MAGT", "MAGST", "Asia/Magadan" }, { -37800, 2, "LHST", "LHST", "Australia/Lord_Howe" },
          { -36000, 2, "EST", "EST", "Australia/Sydney" }, { -36000, 1, "SAKT", "SAKST", "Asia/Sakhalin" }, { -36000, 1, "VLAT", "VLAST", "Asia/Vladivostok" },
          { -34200, 2, "CST", "CST", "Australia/South" }, { -32400, 1, "YAKT", "YAKST", "Asia/Yakutsk" }, { -32400, 1, "CHOT", "CHOST", "Asia/Choibalsan" },
          { -31500, 2, "CWST", "CWST", "Australia/Eucla" }, { -28800, 1, "IRKT", "IRKST", "Asia/Irkutsk" }, { -28800, 1, "ULAT", "ULAST", "Asia/Ulaanbaatar" },
          { -28800, 2, "WST", "WST", "Australia/West" }, { -25200, 1, "HOVT", "HOVST", "Asia/Hovd" }, { -25200, 1, "KRAT", "KRAST", "Asia/Krasnoyarsk" },
          { -21600, 1, "NOVT", "NOVST", "Asia/Novosibirsk" }, { -21600, 1, "OMST", "OMSST", "Asia/Omsk" }, { -18000, 1, "YEKT", "YEKST", "Asia/Yekaterinburg" },
          { -14400, 1, "SAMT", "SAMST", "Europe/Samara" }, { -14400, 1, "AMT", "AMST", "Asia/Yerevan" }, { -14400, 1, "AZT", "AZST", "Asia/Baku" },
          { -10800, 1, "AST", "ADT", "Asia/Baghdad" }, { -10800, 1, "MSK", "MSD", "Europe/Moscow" }, { -10800, 1, "VOLT", "VOLST", "Europe/Volgograd" },
          { -7200, 0, "EET", "CEST", "Africa/Tripoli" }, { -7200, 1, "EET", "EEST", "Europe/Athens" }, /* Conflicts with Africa/Cairo */
          { -7200, 1, "IST", "IDT", "Asia/Jerusalem" }, { -3600, 0, "CET", "WEST", "Africa/Algiers" }, { -3600, 2, "WAT", "WAST", "Africa/Windhoek" },
          { 0, 1, "GMT", "IST", "Europe/Dublin" }, { 0, 1, "GMT", "BST", "Europe/London" }, { 0, 0, "WET", "WEST", "Africa/Casablanca" },
          { 0, 0, "WET", "WET", "Africa/El_Aaiun" }, { 3600, 1, "AZOT", "AZOST", "Atlantic/Azores" }, { 3600, 1, "EGT", "EGST", "America/Scoresbysund" },
          { 10800, 1, "PMST", "PMDT", "America/Miquelon" }, { 10800, 2, "UYT", "UYST", "America/Montevideo" }, { 10800, 1, "WGT", "WGST", "America/Godthab" },
          { 10800, 2, "BRT", "BRST", "Brazil/East" }, { 12600, 1, "NST", "NDT", "America/St_Johns" }, { 14400, 1, "AST", "ADT", "Canada/Atlantic" },
          { 14400, 2, "AMT", "AMST", "America/Cuiaba" }, { 14400, 2, "CLT", "CLST", "Chile/Continental" }, { 14400, 2, "FKT", "FKST", "Atlantic/Stanley" },
          { 14400, 2, "PYT", "PYST", "America/Asuncion" }, { 18000, 1, "CST", "CDT", "America/Havana" },
          { 18000, 1, "EST", "EDT", "US/Eastern" }, /* Conflicts with America/Grand_Turk */
          { 21600, 2, "EAST", "EASST", "Chile/EasterIsland" }, { 21600, 0, "CST", "MDT", "Canada/Saskatchewan" },
          { 21600, 0, "CST", "CDT", "America/Guatemala" }, { 21600, 1, "CST", "CDT", "US/Central" }, /* Conflicts with Mexico/General */
          { 25200, 1, "MST", "MDT", "US/Mountain" }, /* Conflicts with Mexico/BajaSur */
          { 28800, 0, "PST", "PST", "Pacific/Pitcairn" }, { 28800, 1, "PST", "PDT", "US/Pacific" }, /* Conflicts with Mexico/BajaNorte */
          { 32400, 1, "AKST", "AKDT", "US/Alaska" }, { 36000, 1, "HAST", "HADT", "US/Aleutian" } };
...
static char* searchForTZFile(const char* path, DefaultTZInfo* tzInfo)
{
    ...
    while ((dirEntry = readdir(dirp)) != NULL) {
        ...
        if (uprv_strcmp(dirName, SKIP1) != 0 && uprv_strcmp(dirName, SKIP2) != 0 && uprv_strcmp(TZFILE_SKIP, dirName) != 0
            && uprv_strcmp(TZFILE_SKIP2, dirName) != 0) {
...
typedef int(system_property_read_callback)(
    const prop_info* info, void (*callback)(void* cookie, const char* name, const char* value, uint32_t serial), void* cookie);
typedef int(system_property_get)(const char*, char*);

static char gAndroidTimeZone[PROP_VALUE_MAX] = { '\0' };

static void u_property_read(void* cookie, const char* name, const char* value, uint32_t serial)
{
    uprv_strcpy((char*)cookie, value);
}
#endif

U_CAPI void U_EXPORT2 uprv_tzname_clear_cache(void)
{
#if U_PLATFORM == U_PF_ANDROID
    ...
    if (libc) {
        ...
        system_property_read_callback* property_read_callback = (system_property_read_callback*)dlsym(libc, "__system_property_read_callback");
        if (property_read_callback) {
            const prop_info* info = __system_property_find("persist.sys.timezone");
            if (info) {
                property_read_callback(info, &u_property_read, gAndroidTimeZone);
            }
        } else {
            system_property_get* property_get = (system_property_get*)dlsym(libc, "__system_property_get");
            if (property_get) {
...
static BOOL U_CALLCONV getIcuDataDirectoryUnderWindowsDirectory(char* directoryBuffer, UINT bufferLength)
{
    ...
    if ((length > 0) && (length < (UPRV_LENGTHOF(windowsPath) - 1))) {
        ...
        u_strToUTF8(windowsPathUtf8, static_cast<int32_t>(UPRV_LENGTHOF(windowsPathUtf8)), &windowsPathUtf8Len, reinterpret_cast<const UChar*>(windowsPath), -1,
            &status);

        if (U_SUCCESS(status) && (status != U_STRING_NOT_TERMINATED_WARNING) && (windowsPathUtf8Len < (UPRV_LENGTHOF(windowsPathUtf8) - 1))) {
...
U_CAPI const char* U_EXPORT2 uprv_getDefaultLocaleID()
{
#if U_POSIX_LOCALE
    /*
...
#define POSIX_LOCALE_CAPACITY 64
    ...
    int length = GetLocaleInfoW(LOCALE_USER_DEFAULT, LOCALE_SNAME, windowsLocale, LOCALE_NAME_MAX_LENGTH);
#else
     ...
     */
    if ((uprv_strcmp("C", correctedLocale) == 0) || (uprv_strcmp("POSIX", correctedLocale) == 0) || (uprv_strncmp("QLGPGCMA", correctedLocale, 8) == 0)) {
        ...
        if (correctedLocale[LocaleLen - 2] == '_' && correctedLocale[LocaleLen - 1] == 'E') {
         ...
         */
        else if (correctedLocale[LocaleLen - 2] == '_' && correctedLocale[LocaleLen - 1] == 'L') {
...
static const char* remapPlatformDependentCodepage(const char* locale, const char* name)
{
    ...
    if (locale != NULL && uprv_strcmp(name, "euc") == 0) {
        ...
        */
        name = "eucjis";
    } else if (locale != NULL && uprv_strcmp(locale, "en_US_POSIX") != 0 && (uprv_strcmp(name, "ANSI_X3.4-1968") == 0 || uprv_strcmp(name, "US-ASCII") == 0)) {
        /*
         * For non C/POSIX locale, default the code page to UTF-8 instead of US-ASCII.
         */
        name = "UTF-8";
...
static const char* getCodepageFromPOSIXID(const char* localeName, char* buffer, int32_t buffCapacity)
{
    char localeBuf[100];
...
static const char* int_getDefaultCodepage()
{
#if U_PLATFORM == U_PF_OS400
    ...
    EPT_CALL(QUSRJOBI)(&jobinfo, sizeof(jobinfo), "JOBI0400", "*                         ", "                ", &error);
    ...
    GetLocaleInfoEx(
        LOCALE_NAME_SYSTEM_DEFAULT, LOCALE_IDEFAULTANSICODEPAGE | LOCALE_RETURN_NUMBER, (LPWSTR)&codepageNumber, sizeof(codepageNumber) / sizeof(WCHAR));
#else
