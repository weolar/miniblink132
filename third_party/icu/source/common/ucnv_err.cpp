...
#define IS_DEFAULT_IGNORABLE_CODE_POINT(c)                                                                                                                     \
    ((c == 0x00AD) || (c == 0x034F) || (c == 0x061C) || (c == 0x115F) || (c == 0x1160) || (0x17B4 <= c && c <= 0x17B5) || (0x180B <= c && c <= 0x180F)         \
        || (0x200B <= c && c <= 0x200F) || (0x202A <= c && c <= 0x202E) || (0x2060 <= c && c <= 0x206F) || (c == 0x3164) || (0xFE00 <= c && c <= 0xFE0F)       \
        || (c == 0xFEFF) || (c == 0xFFA0) || (0xFFF0 <= c && c <= 0xFFF8) || (0x1BCA0 <= c && c <= 0x1BCA3) || (0x1D173 <= c && c <= 0x1D17A)                  \
        || (0xE0000 <= c && c <= 0xE0FFF))

/*Function Pointer STOPS at the ILLEGAL_SEQUENCE */
U_CAPI void U_EXPORT2 UCNV_FROM_U_CALLBACK_STOP(const void* context, UConverterFromUnicodeArgs* fromUArgs, const UChar* codeUnits, int32_t length,
...
U_CAPI void U_EXPORT2 UCNV_TO_U_CALLBACK_STOP(
    const void* context, UConverterToUnicodeArgs* toUArgs, const char* codePoints, int32_t length, UConverterCallbackReason reason, UErrorCode* err)
{
    /* the caller must have set the error code accordingly */
    (void)context;
    (void)toUArgs;
...
U_CAPI void U_EXPORT2 UCNV_FROM_U_CALLBACK_SKIP(const void* context, UConverterFromUnicodeArgs* fromUArgs, const UChar* codeUnits, int32_t length,
    UChar32 codePoint, UConverterCallbackReason reason, UErrorCode* err)
{
    (void)fromUArgs;
    (void)codeUnits;
...
U_CAPI void U_EXPORT2 UCNV_FROM_U_CALLBACK_SUBSTITUTE(const void* context, UConverterFromUnicodeArgs* fromArgs, const UChar* codeUnits, int32_t length,
    UChar32 codePoint, UConverterCallbackReason reason, UErrorCode* err)
{
    (void)codeUnits;
    (void)length;
 ...
 */
U_CAPI void U_EXPORT2 UCNV_FROM_U_CALLBACK_ESCAPE(const void* context, UConverterFromUnicodeArgs* fromArgs, const UChar* codeUnits, int32_t length,
    UChar32 codePoint, UConverterCallbackReason reason, UErrorCode* err)
{
    ...
    ucnv_setFromUCallBack(fromArgs->converter, (UConverterFromUCallback)UCNV_FROM_U_CALLBACK_SUBSTITUTE, NULL, &original, &originalContext, &err2);
    ...
    *err = U_ZERO_ERROR;
    ...
    ucnv_setFromUCallBack(fromArgs->converter, original, originalContext, &ignoredCallback, &ignoredContext, &err2);
    if (U_FAILURE(err2)) {
        *err = err2;
        return;
    }
...
U_CAPI void U_EXPORT2 UCNV_TO_U_CALLBACK_SKIP(
    const void* context, UConverterToUnicodeArgs* toArgs, const char* codeUnits, int32_t length, UConverterCallbackReason reason, UErrorCode* err)
{
    (void)toArgs;
    (void)codeUnits;
    (void)length;
