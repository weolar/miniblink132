...
U_CAPI Resource U_EXPORT2 res_getTableItemByIndex(const ResourceData* pResData, Resource table, int32_t indexS, const char** key);

U_CAPI Resource U_EXPORT2 res_getTableItemByKey(const ResourceData* pResData, Resource table, int32_t* indexS, const char** key);
...
inline const int32_t* res_getIntVector(const ResourceTracer& traceInfo, const ResourceData* pResData, Resource res, int32_t* pLength)
{
...
public:
    ...
    UResourceDataEntry* getValidLocaleDataEntry() const
    {
        return validLocaleDataEntry;
    }
    ...
    virtual int32_t getStringArray(UnicodeString* dest, int32_t capacity, UErrorCode& errorCode) const override;
    virtual int32_t getStringArrayOrStringAsArray(UnicodeString* dest, int32_t capacity, UErrorCode& errorCode) const override;
