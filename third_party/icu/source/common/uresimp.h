...
struct UResourceBundle {
    ...
    inline const ResourceData& getResData() const
    {
        return fData->fData;
    }
};
...
public:
    ...
    const UResourceBundle& ref() const
    {
        return bundle;
    }
...
U_CAPI void U_EXPORT2 ures_getValueWithFallback(
    const UResourceBundle* bundle, const char* path, UResourceBundle* tempFillIn, icu::ResourceDataValue& value, UErrorCode& errorCode);
