...
UBool BMPSet::contains(UChar32 c) const
{
    if ((uint32_t)c <= 0xff) {
        ...
        if (b >= 0xe0) {
            if (b < 0xf0) {
                if (/* handle U+0000..U+FFFF inline */
                    (t1 = (uint8_t)(s[0] - 0x80)) <= 0x3f && (t2 = (uint8_t)(s[1] - 0x80)) <= 0x3f) {
                    b &= 0xf;
                ...
                if (((0x10000 <= c && c <= 0x10ffff) ? containsSlow(c, list4kStarts[0x10], list4kStarts[0x11]) : containsFFFD) != spanCondition) {
                    return s - 1;
                }
                s += 3;
                continue;
