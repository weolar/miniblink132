...
#define UCNV_EXT_ARRAY(indexes, index, itemType) ((const itemType*)((const char*)(indexes) + (indexes)[index]))

#define UCNV_GET_MAX_BYTES_PER_UCHAR(indexes) ((indexes)[UCNV_EXT_COUNT_BYTES] & 0xff)
