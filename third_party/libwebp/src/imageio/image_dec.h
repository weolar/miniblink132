...
typedef enum { WEBP_PNG_FORMAT = 0, WEBP_JPEG_FORMAT, WEBP_TIFF_FORMAT, WEBP_WEBP_FORMAT, WEBP_PNM_FORMAT, WEBP_UNSUPPORTED_FORMAT } WebPInputFileFormat;
...
WebPImageReader WebPGuessImageReader(const uint8_t* const data, size_t data_size);
