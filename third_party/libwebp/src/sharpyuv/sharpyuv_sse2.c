...
static uint64_t SharpYuvUpdateY_SSE2(const uint16_t* ref, const uint16_t* src, uint16_t* dst, int len, int bit_depth)
{
...
static void SharpYuvUpdateRGB_SSE2(const int16_t* ref, const int16_t* src, int16_t* dst, int len)
{
    int i = 0;
    for (i = 0; i + 8 <= len; i += 8) {
        const __m128i A = _mm_loadu_si128((const __m128i*)(ref + i));
...
static void SharpYuvFilterRow16_SSE2(const int16_t* A, const int16_t* B, int len, const uint16_t* best_y, uint16_t* out, int bit_depth)
{
    const int max_y = (1 << bit_depth) - 1;
    int i;
...
static void SharpYuvFilterRow32_SSE2(const int16_t* A, const int16_t* B, int len, const uint16_t* best_y, uint16_t* out, int bit_depth)
{
    const int max_y = (1 << bit_depth) - 1;
    int i;
...
static void SharpYuvFilterRow_SSE2(const int16_t* A, const int16_t* B, int len, const uint16_t* best_y, uint16_t* out, int bit_depth)
{
    if (bit_depth <= 10) {
