...
static uint64_t SharpYuvUpdateY_NEON(const uint16_t* ref, const uint16_t* src, uint16_t* dst, int len, int bit_depth)
{
    ...
    for (i = 0; i + 8 <= len; i += 8) {
        ...
        const uint16x8_t H = vreinterpretq_u16_s16(vmaxq_s16(vminq_s16(F, max), zero));
...
static void SharpYuvUpdateRGB_NEON(const int16_t* ref, const int16_t* src, int16_t* dst, int len)
{
    int i;
    for (i = 0; i + 8 <= len; i += 8) {
...
static void SharpYuvFilterRow16_NEON(const int16_t* A, const int16_t* B, int len, const uint16_t* best_y, uint16_t* out, int bit_depth)
{
    const int max_y = (1 << bit_depth) - 1;
    int i;
    const int16x8_t max = vdupq_n_s16(max_y);
...
static void SharpYuvFilterRow32_NEON(const int16_t* A, const int16_t* B, int len, const uint16_t* best_y, uint16_t* out, int bit_depth)
{
    const int max_y = (1 << bit_depth) - 1;
    int i;
...
static void SharpYuvFilterRow_NEON(const int16_t* A, const int16_t* B, int len, const uint16_t* best_y, uint16_t* out, int bit_depth)
{
    if (bit_depth <= 10) {
