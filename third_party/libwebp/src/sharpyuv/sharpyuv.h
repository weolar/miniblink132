...
#define SHARPYUV_MAKE_VERSION(MAJOR, MINOR, PATCH) (((MAJOR) << 24) | ((MINOR) << 16) | (PATCH))
#define SHARPYUV_VERSION SHARPYUV_MAKE_VERSION(SHARPYUV_VERSION_MAJOR, SHARPYUV_VERSION_MINOR, SHARPYUV_VERSION_PATCH)
