...
static int InitParams(uint8_t* const data, int width, int height, int stride, int radius, SmoothParams* const p)
{
...
int WebPDequantizeLevels(uint8_t* const data, int width, int height, int stride, int strength)
{
