...
#define LPF_MASK_HEV(p3_in, p2_in, p1_in, p0_in, q0_in, q1_in, q2_in, q3_in, limit_in, b_limit_in, thresh_in, hev_out, mask_out)                               \
    do {                                                                                                                                                       \
...
static void VFilter16(uint8_t* src, int stride, int b_limit_in, int limit_in, int thresh_in)
{
...
static void HFilter16(uint8_t* src, int stride, int b_limit_in, int limit_in, int thresh_in)
{
    uint8_t* ptmp = src - 4;
    v16u8 p3, p2, p1, p0, q3, q2, q1, q0;
    v16u8 mask, hev;
...
static void VFilterHorEdge16i(uint8_t* src, int stride, int b_limit, int limit, int thresh)
{
    v16u8 mask, hev;
    v16u8 p3, p2, p1, p0, q3, q2, q1, q0;
...
static void VFilter16i(uint8_t* src_y, int stride, int b_limit, int limit, int thresh)
{
...
static void HFilterVertEdge16i(uint8_t* src, int stride, int b_limit, int limit, int thresh)
{
    v16u8 mask, hev;
    v16u8 p3, p2, p1, p0, q3, q2, q1, q0;
...
static void HFilter16i(uint8_t* src_y, int stride, int b_limit, int limit, int thresh)
{
...
static void VFilter8(uint8_t* src_u, uint8_t* src_v, int stride, int b_limit_in, int limit_in, int thresh_in)
{
...
static void HFilter8(uint8_t* src_u, uint8_t* src_v, int stride, int b_limit_in, int limit_in, int thresh_in)
{
...
static void VFilter8i(uint8_t* src_u, uint8_t* src_v, int stride, int b_limit_in, int limit_in, int thresh_in)
{
...
static void HFilter8i(uint8_t* src_u, uint8_t* src_v, int stride, int b_limit_in, int limit_in, int thresh_in)
{
    v16u8 p3, p2, p1, p0, q3, q2, q1, q0, mask, hev;
    v16u8 row0, row1, row2, row3, row4, row5, row6, row7, row8;
    v16u8 row9, row10, row11, row12, row13, row14, row15;
