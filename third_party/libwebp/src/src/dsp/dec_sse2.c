...
static WEBP_INLINE void GetNotHEV_SSE2(
    const __m128i* const p1, const __m128i* const p0, const __m128i* const q0, const __m128i* const q1, int hev_thresh, __m128i* const not_hev)
{
    const __m128i zero = _mm_setzero_si128();
...
static WEBP_INLINE void GetBaseDelta_SSE2(
    const __m128i* const p1, const __m128i* const p0, const __m128i* const q0, const __m128i* const q1, __m128i* const delta)
{
...
static WEBP_INLINE void DoSimpleFilter_SSE2(__m128i* const p0, __m128i* const q0, const __m128i* const fl)
{
...
static WEBP_INLINE void Update2Pixels_SSE2(__m128i* const pi, __m128i* const qi, const __m128i* const a0_lo, const __m128i* const a0_hi)
{
...
static WEBP_INLINE void NeedsFilter_SSE2(
    const __m128i* const p1, const __m128i* const p0, const __m128i* const q0, const __m128i* const q1, int thresh, __m128i* const mask)
{
...
static WEBP_INLINE void DoFilter2_SSE2(__m128i* const p1, __m128i* const p0, __m128i* const q0, __m128i* const q1, int thresh)
{
    __m128i a, mask;
    const __m128i sign_bit = _mm_set1_epi8((char)0x80);
...
static WEBP_INLINE void DoFilter4_SSE2(__m128i* const p1, __m128i* const p0, __m128i* const q0, __m128i* const q1, const __m128i* const mask, int hev_thresh)
{
    const __m128i zero = _mm_setzero_si128();
    const __m128i sign_bit = _mm_set1_epi8((char)0x80);
...
static WEBP_INLINE void DoFilter6_SSE2(
    __m128i* const p2, __m128i* const p1, __m128i* const p0, __m128i* const q0, __m128i* const q1, __m128i* const q2, const __m128i* const mask, int hev_thresh)
{
    const __m128i zero = _mm_setzero_si128();
    const __m128i sign_bit = _mm_set1_epi8((char)0x80);
    __m128i a, not_hev;
...
static WEBP_INLINE void Load8x4_SSE2(const uint8_t* const b, int stride, __m128i* const p, __m128i* const q)
{
    // A0 = 63 62 61 60 23 22 21 20 43 42 41 40 03 02 01 00
    // A1 = 73 72 71 70 33 32 31 30 53 52 51 50 13 12 11 10
    const __m128i A0
        = _mm_set_epi32(WebPMemToUint32(&b[6 * stride]), WebPMemToUint32(&b[2 * stride]), WebPMemToUint32(&b[4 * stride]), WebPMemToUint32(&b[0 * stride]));
    const __m128i A1
        = _mm_set_epi32(WebPMemToUint32(&b[7 * stride]), WebPMemToUint32(&b[3 * stride]), WebPMemToUint32(&b[5 * stride]), WebPMemToUint32(&b[1 * stride]));
...
static WEBP_INLINE void Load16x4_SSE2(
    const uint8_t* const r0, const uint8_t* const r8, int stride, __m128i* const p1, __m128i* const p0, __m128i* const q0, __m128i* const q1)
{
...
static WEBP_INLINE void Store4x4_SSE2(__m128i* const x, uint8_t* dst, int stride)
{
    int i;
...
static WEBP_INLINE void Store16x4_SSE2(
    const __m128i* const p1, const __m128i* const p0, const __m128i* const q0, const __m128i* const q1, uint8_t* r0, uint8_t* r8, int stride)
{
...
static WEBP_INLINE void ComplexMask_SSE2(
    const __m128i* const p1, const __m128i* const p0, const __m128i* const q0, const __m128i* const q1, int thresh, int ithresh, __m128i* const mask)
{
...
// on macroblock edges
static void VFilter16_SSE2(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    __m128i t1;
    __m128i mask;
...
static void HFilter16_SSE2(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    __m128i mask;
...
static void VFilter16i_SSE2(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    int k;
...
static void HFilter16i_SSE2(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    int k;
    __m128i p3, p2, p1, p0; // loop invariants
...
static void VFilter8_SSE2(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    __m128i mask;
...
static void HFilter8_SSE2(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    __m128i mask;
    __m128i p3, p2, p1, p0, q0, q1, q2, q3;
...
static void VFilter8i_SSE2(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    __m128i mask;
...
static void HFilter8i_SSE2(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    __m128i mask;
    __m128i t1, t2, p1, p0, q0, q1;
...
{ // DC with top samples unavailable
    int DC = 8;
    int j;
    for (j = 0; j < 16; ++j) {
        DC += dst[-1 + j * BPS];
...
{ // DC with left samples unavailable
    const __m128i zero = _mm_setzero_si128();
    const __m128i top = _mm_loadu_si128((const __m128i*)(dst - BPS));
    const __m128i sad8x2 = _mm_sad_epu8(top, zero);
    // sum the two sads: sad8x2[0:1] + sad8x2[8:9]
