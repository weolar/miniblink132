...
static void TransformColor_MSA(const VP8LMultipliers* const m, uint32_t* data, int num_pixels)
{
    v16u8 src0, dst0;
...
static void SubtractGreenFromBlueAndRed_MSA(uint32_t* argb_data, int num_pixels)
{
    int i;
