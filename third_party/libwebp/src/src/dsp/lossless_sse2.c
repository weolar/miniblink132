...
static WEBP_INLINE uint32_t ClampedAddSubtractFull_SSE2(uint32_t c0, uint32_t c1, uint32_t c2)
{
...
static WEBP_INLINE uint32_t ClampedAddSubtractHalf_SSE2(uint32_t c0, uint32_t c1, uint32_t c2)
{
    const __m128i zero = _mm_setzero_si128();
    const __m128i C0 = _mm_unpacklo_epi8(_mm_cvtsi32_si128(c0), zero);
    const __m128i C1 = _mm_unpacklo_epi8(_mm_cvtsi32_si128(c1), zero);
...
static WEBP_INLINE void Average2_uint32_SSE2(const uint32_t a0, const uint32_t a1, __m128i* const avg)
{
    // (a + b) >> 1 = ((a + b + 1) >> 1) - ((a ^ b) & 1)
    const __m128i ones = _mm_set1_epi8(1);
...
static WEBP_INLINE uint32_t Average3_SSE2(uint32_t a0, uint32_t a1, uint32_t a2)
{
    const __m128i zero = _mm_setzero_si128();
...
static WEBP_INLINE uint32_t Average4_SSE2(uint32_t a0, uint32_t a1, uint32_t a2, uint32_t a3)
{
...
#define GENERATE_PREDICTOR_1(X, IN)                                                                                                                            \
    static void PredictorAdd##X##_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out)                                               \
    {                                                                                                                                                          \
        int i;                                                                                                                                                 \
        for (i = 0; i + 4 <= num_pixels; i += 4) {                                                                                                             \
            const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]);                                                                                       \
...
static void PredictorAdd10_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out)
{
    int i;
...
static void ConvertBGRAToRGB_SSE2(const uint32_t* src, int num_pixels, uint8_t* dst)
{
...
static void ConvertBGRAToRGBA_SSE2(const uint32_t* src, int num_pixels, uint8_t* dst)
{
...
static void ConvertBGRAToRGBA4444_SSE2(const uint32_t* src, int num_pixels, uint8_t* dst)
{
...
static void ConvertBGRAToRGB565_SSE2(const uint32_t* src, int num_pixels, uint8_t* dst)
{
...
static void ConvertBGRAToBGR_SSE2(const uint32_t* src, int num_pixels, uint8_t* dst)
{
