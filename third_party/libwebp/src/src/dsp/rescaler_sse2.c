...
static void RescalerImportRowExpand_SSE2(WebPRescaler* const wrk, const uint8_t* src)
{
...
static void RescalerImportRowShrink_SSE2(WebPRescaler* const wrk, const uint8_t* src)
{
...
static WEBP_INLINE void LoadDispatchAndMult_SSE2(
    const rescaler_t* const src, const __m128i* const mult, __m128i* const out0, __m128i* const out1, __m128i* const out2, __m128i* const out3)
{
...
static WEBP_INLINE void ProcessRow_SSE2(
    const __m128i* const A0, const __m128i* const A1, const __m128i* const A2, const __m128i* const A3, const __m128i* const mult, uint8_t* const dst)
{
    const __m128i rounder = _mm_set_epi32(0, ROUNDER, 0, ROUNDER);
