...
static void Upsample32Pixels_SSE41(const uint8_t r1[], const uint8_t r2[], uint8_t* const out)
{
...
#define CONVERT2RGB_32(FUNC, XSTEP, top_y, bottom_y, top_dst, bottom_dst, cur_x)                                                                               \
    do {                                                                                                                                                       \
        ...
        if ((bottom_y) != NULL) {                                                                                                                              \
            FUNC##32_SSE41((bottom_y) + (cur_x), r_u + 64, r_v + 64, (bottom_dst) + (cur_x) * (XSTEP));                                                        \
        }                                                                                                                                                      \
    } while (0)
...
#define SSE4_UPSAMPLE_FUNC(FUNC_NAME, FUNC, XSTEP)                                                                                                             \
    ...
    {                                                                                                                                                          \
        ...
        if (len > 1) {                                                                                                                                         \
            ...
            if (bottom_y != NULL)                                                                                                                              \
                memcpy(tmp_bottom, bottom_y + pos, len - pos);                                                                                                 \
            CONVERT2RGB_32(FUNC, XSTEP, tmp_top, tmp_bottom, tmp_top_dst, tmp_bottom_dst, 0);                                                                  \
...
#define YUV444_FUNC(FUNC_NAME, CALL, CALL_C, XSTEP)                                                                                                            \
    extern void CALL_C(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len);                                                           \
