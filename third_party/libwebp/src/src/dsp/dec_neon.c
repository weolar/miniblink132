...
static WEBP_INLINE uint8x8x4_t Load4x8_NEON(const uint8_t* const src, int stride)
{
...
static WEBP_INLINE void Load4x16_NEON(
    const uint8_t* const src, int stride, uint8x16_t* const p1, uint8x16_t* const p0, uint8x16_t* const q0, uint8x16_t* const q1)
{
...
static WEBP_INLINE void Load4x16_NEON(const uint8_t* src, int stride, uint8x16_t* const p1, uint8x16_t* const p0, uint8x16_t* const q0, uint8x16_t* const q1)
{
...
static WEBP_INLINE void Load8x16_NEON(const uint8_t* const src, int stride, uint8x16_t* const p3, uint8x16_t* const p2, uint8x16_t* const p1,
    uint8x16_t* const p0, uint8x16_t* const q0, uint8x16_t* const q1, uint8x16_t* const q2, uint8x16_t* const q3)
{
    Load4x16_NEON(src - 2, stride, p3, p2, p1, p0);
    Load4x16_NEON(src + 2, stride, q0, q1, q2, q3);
}

static WEBP_INLINE void Load16x4_NEON(
    const uint8_t* const src, int stride, uint8x16_t* const p1, uint8x16_t* const p0, uint8x16_t* const q0, uint8x16_t* const q1)
{
...
static WEBP_INLINE void Load16x8_NEON(const uint8_t* const src, int stride, uint8x16_t* const p3, uint8x16_t* const p2, uint8x16_t* const p1,
    uint8x16_t* const p0, uint8x16_t* const q0, uint8x16_t* const q1, uint8x16_t* const q2, uint8x16_t* const q3)
{
...
static WEBP_INLINE void Load8x8x2_NEON(const uint8_t* const u, const uint8_t* const v, int stride, uint8x16_t* const p3, uint8x16_t* const p2,
    uint8x16_t* const p1, uint8x16_t* const p0, uint8x16_t* const q0, uint8x16_t* const q1, uint8x16_t* const q2, uint8x16_t* const q3)
{
...
static WEBP_INLINE void Load8x8x2T_NEON(const uint8_t* const u, const uint8_t* const v, int stride, uint8x16_t* const p3, uint8x16_t* const p2,
    uint8x16_t* const p1, uint8x16_t* const p0, uint8x16_t* const q0, uint8x16_t* const q1, uint8x16_t* const q2, uint8x16_t* const q3)
{
    // We pack the 8x8 u-samples in the lower half of the uint8x16_t destination
    // and the v-samples on the higher half.
...
static WEBP_INLINE void Store2x8_NEON(const uint8x8x2_t v, uint8_t* const dst, int stride)
{
...
static WEBP_INLINE void Store2x16_NEON(const uint8x16_t p0, const uint8x16_t q0, uint8_t* const dst, int stride)
{
    uint8x8x2_t lo, hi;
...
#if !defined(WORK_AROUND_GCC)
static WEBP_INLINE void Store4x8_NEON(const uint8x8x4_t v, uint8_t* const dst, int stride)
{
...
static WEBP_INLINE void Store4x16_NEON(const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, uint8_t* const dst, int stride)
{
    uint8x8x4_t lo, hi;
...
static WEBP_INLINE void Store16x2_NEON(const uint8x16_t p0, const uint8x16_t q0, uint8_t* const dst, int stride)
{
    vst1q_u8(dst - stride, p0);
    vst1q_u8(dst, q0);
}

static WEBP_INLINE void Store16x4_NEON(const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, uint8_t* const dst, int stride)
{
    Store16x2_NEON(p1, p0, dst - stride, stride);
    Store16x2_NEON(q0, q1, dst + stride, stride);
}

static WEBP_INLINE void Store8x2x2_NEON(const uint8x16_t p0, const uint8x16_t q0, uint8_t* const u, uint8_t* const v, int stride)
{
...
static WEBP_INLINE void Store8x4x2_NEON(
    const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, uint8_t* const u, uint8_t* const v, int stride)
{
...
static WEBP_INLINE void Store6x8x2_NEON(const uint8x16_t p2, const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1,
    const uint8x16_t q2, uint8_t* u, uint8_t* v, int stride)
{
...
static WEBP_INLINE void Store4x8x2_NEON(
    const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, uint8_t* const u, uint8_t* const v, int stride)
{
    uint8x8x4_t u0, v0;
...
static WEBP_INLINE void SaturateAndStore4x4_NEON(uint8_t* const dst, const int16x8_t dst01, const int16x8_t dst23)
{
...
static WEBP_INLINE void Add4x4_NEON(const int16x8_t row01, const int16x8_t row23, uint8_t* const dst)
{
...
static uint8x16_t NeedsFilter_NEON(const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, int thresh)
{
...
static int8x16_t GetBaseDelta_NEON(const int8x16_t p1, const int8x16_t p0, const int8x16_t q0, const int8x16_t q1)
{
...
static void ApplyFilter2NoFlip_NEON(const int8x16_t p0s, const int8x16_t q0s, const int8x16_t delta, int8x16_t* const op0, int8x16_t* const oq0)
{
...
static void ApplyFilter2_NEON(const int8x16_t p0s, const int8x16_t q0s, const int8x16_t delta, uint8x16_t* const op0, uint8x16_t* const oq0)
{
    const int8x16_t kCst3 = vdupq_n_s8(0x03);
    const int8x16_t kCst4 = vdupq_n_s8(0x04);
    const int8x16_t delta_p3 = vqaddq_s8(delta, kCst3);
...
static void DoFilter2_NEON(
    const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, const uint8x16_t mask, uint8x16_t* const op0, uint8x16_t* const oq0)
{
...
static void SimpleVFilter16_NEON(uint8_t* p, int stride, int thresh)
{
    __asm__ volatile("sub        %[p], %[p], %[stride], lsl #1  \n" // p -= 2 * stride
...
static void SimpleHFilter16_NEON(uint8_t* p, int stride, int thresh)
{
    __asm__ volatile("sub        r4, %[p], #2                   \n" // base1 = p - 2
                     "lsl        r6, %[stride], #1              \n" // r6 = 2 * stride
                     "add        r5, r4, %[stride]              \n" // base2 = base1 + stride

                     LOAD8x4(d2, d3, d4, d5, [r4], [r5], r6)
                         LOAD8x4(d24, d25, d26, d27, [r4], [r5], r6) "vswp       d3, d24                        \n" // p1:q1 p0:q3
                                                                     "vswp       d5, d26                        \n" // q0:q2 q1:q4
                     ...
                     DO_FILTER2(q1, q2, q12, q13, % [thresh])
                         ...
                         "vswp        d5, d24                       \n" STORE8x2(d4, d5, [%[p]], % [stride]) STORE8x2(d24, d25, [%[p]], % [stride])
...
static uint8x16_t NeedsHev_NEON(const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, int hev_thresh)
{
...
static uint8x16_t NeedsFilter2_NEON(const uint8x16_t p3, const uint8x16_t p2, const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0,
    const uint8x16_t q1, const uint8x16_t q2, const uint8x16_t q3, int ithresh, int thresh)
{
...
static void ApplyFilter4_NEON(const int8x16_t p1, const int8x16_t p0, const int8x16_t q0, const int8x16_t q1, const int8x16_t delta0, uint8x16_t* const op1,
    uint8x16_t* const op0, uint8x16_t* const oq0, uint8x16_t* const oq1)
{
    const int8x16_t kCst3 = vdupq_n_s8(0x03);
    const int8x16_t kCst4 = vdupq_n_s8(0x04);
...
static void DoFilter4_NEON(const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, const uint8x16_t mask, const uint8x16_t hev_mask,
    uint8x16_t* const op1, uint8x16_t* const op0, uint8x16_t* const oq0, uint8x16_t* const oq1)
{
...
static void ApplyFilter6_NEON(const int8x16_t p2, const int8x16_t p1, const int8x16_t p0, const int8x16_t q0, const int8x16_t q1, const int8x16_t q2,
    const int8x16_t delta, uint8x16_t* const op2, uint8x16_t* const op1, uint8x16_t* const op0, uint8x16_t* const oq0, uint8x16_t* const oq1,
...
static void DoFilter6_NEON(const uint8x16_t p2, const uint8x16_t p1, const uint8x16_t p0, const uint8x16_t q0, const uint8x16_t q1, const uint8x16_t q2,
    const uint8x16_t mask, const uint8x16_t hev_mask, uint8x16_t* const op2, uint8x16_t* const op1, uint8x16_t* const op0, uint8x16_t* const oq0,
    uint8x16_t* const oq1, uint8x16_t* const oq2)
{
    ...
    // do_filter6 part (complex loopfilter on pixels without hev)
    {
        ...
        const uint8x16_t complex_lf_mask = veorq_u8(simple_lf_mask, mask);
        const int8x16_t complex_lf_delta = vandq_s8(delta0, vreinterpretq_s8_u8(complex_lf_mask));
        ApplyFilter6_NEON(p2s, p1s, p0s, q0s, q1s, q2s, complex_lf_delta, op2, op1, op0, oq0, oq1, oq2);
    }
}

// on macroblock edges

static void VFilter16_NEON(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint8x16_t p3, p2, p1, p0, q0, q1, q2, q3;
    Load16x8_NEON(p, stride, &p3, &p2, &p1, &p0, &q0, &q1, &q2, &q3);
    {
        const uint8x16_t mask = NeedsFilter2_NEON(p3, p2, p1, p0, q0, q1, q2, q3, ithresh, thresh);
        const uint8x16_t hev_mask = NeedsHev_NEON(p1, p0, q0, q1, hev_thresh);
        uint8x16_t op2, op1, op0, oq0, oq1, oq2;
        DoFilter6_NEON(p2, p1, p0, q0, q1, q2, mask, hev_mask, &op2, &op1, &op0, &oq0, &oq1, &oq2);
...
static void HFilter16_NEON(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint8x16_t p3, p2, p1, p0, q0, q1, q2, q3;
...
static void VFilter16i_NEON(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint32_t k;
...
#if !defined(WORK_AROUND_GCC)
static void HFilter16i_NEON(uint8_t* p, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint32_t k;
    uint8x16_t p3, p2, p1, p0;
...
static void VFilter8_NEON(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint8x16_t p3, p2, p1, p0, q0, q1, q2, q3;
...
static void VFilter8i_NEON(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint8x16_t p3, p2, p1, p0, q0, q1, q2, q3;
    u += 4 * stride;
    v += 4 * stride;
...
#if !defined(WORK_AROUND_GCC)
static void HFilter8_NEON(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint8x16_t p3, p2, p1, p0, q0, q1, q2, q3;
...
static void HFilter8i_NEON(uint8_t* u, uint8_t* v, int stride, int thresh, int ithresh, int hev_thresh)
{
    uint8x16_t p3, p2, p1, p0, q0, q1, q2, q3;
    u += 4;
    v += 4;
...
#if defined(WEBP_USE_INTRINSICS)
static WEBP_INLINE void Transpose8x2_NEON(const int16x8_t in0, const int16x8_t in1, int16x8x2_t* const out)
{
...
static void TransformAC3_NEON(const int16_t* in, uint8_t* dst)
{
    ...
    const uint64_t cd = (uint64_t)(d1 & 0xffff) << 0 | (uint64_t)(c1 & 0xffff) << 16 | (uint64_t)(-c1 & 0xffff) << 32 | (uint64_t)(-d1 & 0xffff) << 48;
...
{ // Down-right
    ...
    const uint64x1_t LKJI____ = vcreate_u64((uint64_t)L | (K << 8) | (J << 16) | (I << 24));
