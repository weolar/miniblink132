...
#define CALC_MULT_FIX1_16(in0, in1, in2, in3, fyscale, shift, dst0, dst1, dst2, dst3)                                                                          \
    do {                                                                                                                                                       \
        v4u32 tmp0, tmp1, tmp2, tmp3;                                                                                                                          \
        v2u64 out0, out1, out2, out3;                                                                                                                          \
        ILVRL_W2_UW(zero, in0, tmp0, tmp1);                                                                                                                    \
...
static WEBP_INLINE void ExportRowExpand_0(const uint32_t* frow, uint8_t* dst, int length, WebPRescaler* const wrk)
{
...
static WEBP_INLINE void ExportRowExpand_1(const uint32_t* frow, uint32_t* irow, uint8_t* dst, int length, WebPRescaler* const wrk)
{
