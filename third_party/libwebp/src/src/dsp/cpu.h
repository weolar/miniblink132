...
#if defined(_MSC_VER) && ((_MSC_VER >= 1700 && defined(_M_ARM)) || (_MSC_VER >= 1926 && defined(_M_ARM64)))
#define WEBP_USE_NEON
#define WEBP_USE_INTRINSICS
#endif

#undef WEBP_USE_NEON // weolar
...
#define WEBP_DSP_INIT(func)                                                                                                                                    \
    do {                                                                                                                                                       \
        ...
        if (pthread_mutex_lock(&func##_lock))                                                                                                                  \
            break;                                                                                                                                             \
        if (func##_last_cpuinfo_used != VP8GetCPUInfo)                                                                                                         \
            func();                                                                                                                                            \
