...
static void SubtractGreenFromBlueAndRed_NEON(uint32_t* argb_data, int num_pixels)
{
...
static void TransformColor_NEON(const VP8LMultipliers* const m, uint32_t* argb_data, int num_pixels)
{
