...
#define TRANSFORM_COLOR_INVERSE_8(src0, src1, dst0, dst1, c0, c1, mask0, mask1)                                                                                \
    do {                                                                                                                                                       \
...
static void ConvertBGRAToRGBA_MSA(const uint32_t* src, int num_pixels, uint8_t* dst)
{
    int i;
...
static void ConvertBGRAToBGR_MSA(const uint32_t* src, int num_pixels, uint8_t* dst)
{
    const uint8_t* ptemp_src = (const uint8_t*)src;
    uint8_t* ptemp_dst = (uint8_t*)dst;
...
static void ConvertBGRAToRGB_MSA(const uint32_t* src, int num_pixels, uint8_t* dst)
{
    const uint8_t* ptemp_src = (const uint8_t*)src;
    uint8_t* ptemp_dst = (uint8_t*)dst;
...
static void AddGreenToBlueAndRed_MSA(const uint32_t* const src, int num_pixels, uint32_t* dst)
{
    int i;
...
static void TransformColorInverse_MSA(const VP8LMultipliers* const m, const uint32_t* src, int num_pixels, uint32_t* dst)
{
    v16u8 src0, dst0;
    const v16i8 g2br = (v16i8)__msa_fill_w(m->green_to_blue_ | (m->green_to_red_ << 16));
