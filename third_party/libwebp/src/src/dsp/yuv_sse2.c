...
static void ConvertYUV444ToRGB_SSE2(
    const __m128i* const Y0, const __m128i* const U0, const __m128i* const V0, __m128i* const R, __m128i* const G, __m128i* const B)
{
...
static void YUV444ToRGB_SSE2(const uint8_t* const y, const uint8_t* const u, const uint8_t* const v, __m128i* const R, __m128i* const G, __m128i* const B)
{
...
static void YUV420ToRGB_SSE2(const uint8_t* const y, const uint8_t* const u, const uint8_t* const v, __m128i* const R, __m128i* const G, __m128i* const B)
{
...
static WEBP_INLINE void PackAndStore4_SSE2(const __m128i* const R, const __m128i* const G, const __m128i* const B, const __m128i* const A, uint8_t* const dst)
{
...
static WEBP_INLINE void PackAndStore4444_SSE2(
    const __m128i* const R, const __m128i* const G, const __m128i* const B, const __m128i* const A, uint8_t* const dst)
{
...
static WEBP_INLINE void PackAndStore565_SSE2(const __m128i* const R, const __m128i* const G, const __m128i* const B, uint8_t* const dst)
{
...
static WEBP_INLINE void PlanarTo24b_SSE2(
    __m128i* const in0, __m128i* const in1, __m128i* const in2, __m128i* const in3, __m128i* const in4, __m128i* const in5, uint8_t* const rgb)
{
...
void VP8YuvToRgba32_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst)
{
...
void VP8YuvToBgra32_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst)
{
    const __m128i kAlpha = _mm_set1_epi16(255);
    int n;
    for (n = 0; n < 32; n += 8, dst += 32) {
...
void VP8YuvToArgb32_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst)
{
    const __m128i kAlpha = _mm_set1_epi16(255);
    int n;
    for (n = 0; n < 32; n += 8, dst += 32) {
...
void VP8YuvToRgba444432_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst)
{
    const __m128i kAlpha = _mm_set1_epi16(255);
    int n;
...
void VP8YuvToRgb56532_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst)
{
    int n;
    for (n = 0; n < 32; n += 8, dst += 16) {
        __m128i R, G, B;
...
void VP8YuvToRgb32_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst)
{
...
void VP8YuvToBgr32_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst)
{
    __m128i R0, R1, R2, R3, G0, G1, G2, G3, B0, B1, B2, B3;
...
static void YuvToRgbaRow_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len)
{
    const __m128i kAlpha = _mm_set1_epi16(255);
    int n;
...
static void YuvToBgraRow_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len)
{
    const __m128i kAlpha = _mm_set1_epi16(255);
    int n;
    for (n = 0; n + 8 <= len; n += 8, dst += 32) {
...
static void YuvToArgbRow_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len)
{
    const __m128i kAlpha = _mm_set1_epi16(255);
    int n;
    for (n = 0; n + 8 <= len; n += 8, dst += 32) {
...
static void YuvToRgbRow_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len)
{
    int n;
...
static void YuvToBgrRow_SSE2(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len)
{
    int n;
    for (n = 0; n + 32 <= len; n += 32, dst += 32 * 3) {
        __m128i R0, R1, R2, R3, G0, G1, G2, G3, B0, B1, B2, B3;
...
static WEBP_INLINE void RGB24PackedToPlanarHelper_SSE2(const __m128i* const in /*in[6]*/, __m128i* const out /*out[6]*/)
{
...
static WEBP_INLINE void RGB24PackedToPlanar_SSE2(const uint8_t* const rgb, __m128i* const out /*out[6]*/)
{
    __m128i tmp[6];
...
static WEBP_INLINE void RGB32PackedToPlanar_SSE2(const uint32_t* const argb, __m128i* const rgb /*in[6]*/)
{
    const __m128i zero = _mm_setzero_si128();
...
static WEBP_INLINE void ConvertRGBToY_SSE2(const __m128i* const R, const __m128i* const G, const __m128i* const B, __m128i* const Y)
{
...
static WEBP_INLINE void ConvertRGBToUV_SSE2(const __m128i* const R, const __m128i* const G, const __m128i* const B, __m128i* const U, __m128i* const V)
{
...
static void HorizontalAddPack_SSE2(const __m128i* const A, const __m128i* const B, __m128i* const out)
{
...
static void ConvertARGBToUV_SSE2(const uint32_t* argb, uint8_t* u, uint8_t* v, int src_width, int do_store)
{
...
static WEBP_INLINE void RGBA32PackedToPlanar_16b_SSE2(const uint16_t* const rgbx, __m128i* const r, __m128i* const g, __m128i* const b)
{
...
static void ConvertRGBA32ToUV_SSE2(const uint16_t* rgb, uint8_t* u, uint8_t* v, int width)
{
    const int max_width = width & ~15;
