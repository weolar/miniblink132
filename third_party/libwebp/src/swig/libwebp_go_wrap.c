...
swiggo_size_assert(char, 1) swiggo_size_assert(short, 2) swiggo_size_assert(int, 4) typedef long long swiggo_long_long;
swiggo_size_assert(swiggo_long_long, 8) swiggo_size_assert(float, 4) swiggo_size_assert(double, 8)
...
void _wrap_WebPGetDecoderVersion(void* swig_v)
{
    int result;
...
void _wrap_wrapped_WebPGetInfo(void* swig_v)
{
