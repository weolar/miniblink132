...
void
·WebPGetDecoderVersion(struct { uint8 x[SWIG_PARM_SIZE]; } p)
...
void
·Wrapped_WebPGetInfo(struct { uint8 x[(2 * SWIG_PARM_SIZE) + (3 * SWIG_PARM_SIZE) + (3 * SWIG_PARM_SIZE) + SWIG_PARM_SIZE]; } p)
