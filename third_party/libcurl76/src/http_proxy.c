        ...
        if (TUNNEL_INIT == s->tunnel_state) {
           ...
           then. Just free() it. */
            ...
            if (!result) {
                ...
                const char* http = (conn->http_proxy.proxytype == CURLPROXY_HTTP_1_0) ? "1.0" : "1.1";
                ...
                result = Curl_add_bufferf(req_buffer,
                    ...
                    "%s" /* User-Agent */
                    "%s", /* Proxy-Connection */
                    hostheader, http, host ? host : "", conn->allocptr.proxyuserpwd ? conn->allocptr.proxyuserpwd : "", useragent, proxyconn);
                ...
                if (!result) {
                    ...
                    /* BLOCKING */
                    result = Curl_add_buffer_send(req_buffer, conn, &data->info.request_size, 0, sockindex);
                }
                req_buffer = NULL;
                if (result)
        ...
        { /* READING RESPONSE PHASE */
           ...
           as end-of-headers as well.*/
               ...
               whole response-body */
                        ...
                        if (s->cl) {
                            infof(data, "Ignore %" CURL_FORMAT_CURL_OFF_T " bytes of response-body\n", s->cl);
               ...
               "Successful" described as: 2xx (Successful). RFC 7231 4.3.6 */
                        ...
                        (void)curlx_strtoofft(s->line_start + strlen("Content-Length:"), NULL, 10, &s->cl);
                    }
