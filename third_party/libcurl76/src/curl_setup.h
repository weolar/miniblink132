...
#if !defined(_MSC_VER) // def HAVE_CONFIG_H // For linux, weolar
...
#if defined(USE_OPENSSL) || defined(USE_WINDOWS_SSPI) || defined(USE_GNUTLS) || defined(USE_NSS) || defined(USE_DARWINSSL) || defined(USE_OS400CRYPTO)         \
