...
#if (defined(__BORLANDC__) && (__BORLANDC__ >= 0x520)) || (defined(__WATCOMC__) && defined(__386__)) || (defined(__POCC__) && defined(_MSC_VER))               \
    || (defined(_WIN32_WCE)) || (defined(__MINGW32__)) || (defined(_MSC_VER) && (_MSC_VER >= 900) && (_INTEGRAL_MAX_BITS >= 64))
...
static int dprintf_formatf(void* data, /* untouched by format(), just sent to the stream() function in
    ...
    int(__cdecl* stream)(int, FILE*), const char* format, /* %-formatted string */
