...
CURLcode Curl_SOCKS5_gssapi_negotiate(int sockindex, struct connectdata* conn)
{
   ...
   */
    ...
    for (;;) {
        ...
        if (sspi_send_token.cbBuffer != 0) {
            ...
            code = Curl_write_plain(conn, sock, (char*)sspi_send_token.pvBuffer, sspi_send_token.cbBuffer, &written);
     ...
     */
        ...
        result = Curl_blockread_all(conn, sock, (char*)sspi_recv_token.pvBuffer, sspi_recv_token.cbBuffer, &actualread);
   ...
   */
    ...
    result = Curl_blockread_all(conn, sock, (char*)sspi_w_token[0].pvBuffer, sspi_w_token[0].cbBuffer, &actualread);
