        ...
        if (
         ...
         treat both error codes the same here */
            ...
            *code = CURLE_AGAIN;
            ...
            failf(conn->data, "Send failure: %s", Curl_strerror(conn, err));
    ...
    ssize_t* n) /* amount bytes read */
{
    ...
    bool pipelining = Curl_pipeline_wanted(data->multi, CURLPIPE_HTTP1) && (conn->bundle->multiuse == BUNDLE_PIPELINING);
