...
template <class StringType> static void StringAppendVT(StringType* dst, const typename StringType::value_type* format, va_list ap)
{
...
LogItemStruct* makeLogItemStruct(NPAPI_Action action, DWORD dw1, DWORD dw2, DWORD dw3, DWORD dw4, DWORD dw5, DWORD dw6, DWORD dw7, BOOL bShort)
{
    int iWrap = 64;
...
void formatLogItem(LogItemStruct* plis, std::string* output, BOOL bDOSStyle)
{
    ...
    case action_npn_post_url_notify: {
        ...
        *output = StringPrintf("NPN_PostURLNotify(%#08lx, %s, %s, %li, %s, %s, %#08lx)", dw1, sz2, sz3, (uint32)dw4, sz5, sz6, dw7);
        break;
    }
    case action_npn_post_url: {
        FormatPCHARArgument(sz2, sizeof(sz2), &plis->arg2);
        ...
        *output = StringPrintf("NPN_PostURL(%#08lx, %s, %s, %li, %s, %s)", dw1, sz2, sz3, (uint32)dw4, sz5, sz6);
        break;
    }
    case action_npn_new_stream: {
        FormatPCHARArgument(sz2, sizeof(sz2), &plis->arg2);
        ...
        if (plis->arg4.pData != NULL)
            *output = StringPrintf("NPN_NewStream(%#08lx, %s, %s, %#08lx(%#08lx))", dw1, sz2, sz3, dw4, *(DWORD*)plis->arg4.pData);
        else
    ...
    case action_npn_get_value: {
        ...
        case NPNVisOfflineBool:
            if (dw3 != 0L)
                *output = StringPrintf("NPN_GetValue(%#08lx, %s, %#08lx(%s))", dw1, FormatNPNVariable((NPNVariable)dw2), dw3,
        ...
        if (((NPPVariable)dw2 == NPPVpluginNameString) || ((NPPVariable)dw2 == NPPVpluginDescriptionString)) {
            ...
            *output = StringPrintf("NPN_SetValue(%#08lx, %s, %s)", dw1, FormatNPPVariable((NPPVariable)dw2), sz3);
            ...
            if (plis->arg3.pData != NULL) {
                ...
                *output = StringPrintf("NPN_SetValue(%#08lx, %s, %#08lx(%li,%li))", dw1, FormatNPPVariable((NPPVariable)dw2), dw3, iWidth, iHeight);
            } else
                *output = StringPrintf("NPN_SetValue(%#08lx, %s, %#08lx(?,?))", dw1, FormatNPPVariable((NPPVariable)dw2), dw3);
        } else
    ...
    case action_npp_new: {
        ...
        *output = StringPrintf("NPP_New(\"%s\", %#08lx, %s, %i, %#08lx, %#08lx, %#08lx)", (char*)dw1, dw2, szMode, (int)dw4, dw5, dw6, dw7);
        break;
    }
    case action_npp_destroy:
    ...
    case action_npp_set_window: {
        ...
        if (plis->arg2.pData != NULL) {
            ...
            sprintf(szWindow, "NPWindow: %#08lx, (%li,%li), (%li,%li), (%i,%i,%i,%i), %s", ((NPWindow*)plis->arg2.pData)->window,
                ((NPWindow*)plis->arg2.pData)->x, ((NPWindow*)plis->arg2.pData)->y, ((NPWindow*)plis->arg2.pData)->width, ((NPWindow*)plis->arg2.pData)->height,
                ((NPWindow*)plis->arg2.pData)->clipRect.top, ((NPWindow*)plis->arg2.pData)->clipRect.left, ((NPWindow*)plis->arg2.pData)->clipRect.bottom,
    ...
    case action_npp_new_stream: {
        ...
        FormatPCHARArgument(sz2, sizeof(sz2), &plis->arg2);
        *output = StringPrintf(
            "NPP_NewStream(%#08lx, %s, %#08lx (%s), %s, %s)", dw1, sz2, dw3, ((NPStream*)dw3)->url, ((NPBool)dw4 == TRUE) ? "TRUE" : "FALSE", sz5);
        break;
    }
    case action_npp_destroy_stream:
