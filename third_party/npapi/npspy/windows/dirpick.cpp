...
static void onDrawItem(LPDRAWITEMSTRUCT lpdis, BOOL bDrive)
{
    ...
    if (lpdis->itemAction & (ODA_DRAWENTIRE | ODA_SELECT)) {
        ...
        ExtTextOut(lpdis->hDC, lpdis->rcItem.left + ITEM_LEFTMARGIN + ITEM_BITMAPWIDTH + ITEM_GAP + indent, lpdis->rcItem.top, ETO_OPAQUE | ETO_CLIPPED,
            &lpdis->rcItem, szItem, lstrlen(szItem), NULL);

        BOOL res = DrawIcon(lpdis->hDC, lpdis->rcItem.left + ITEM_LEFTMARGIN + indent, lpdis->rcItem.top, hIcon);
