...
extern struct PRProcess* _PR_CreateOS2Process(const char* path, char* const* argv, char* const* envp, const struct PRProcessAttr* attr);
...
extern PRStatus _PR_WaitOS2Process(struct PRProcess* process, PRInt32* exitCode);
