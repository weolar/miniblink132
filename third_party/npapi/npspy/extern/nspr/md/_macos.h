...
extern struct PRProcess* _MD_CreateProcess(const char* path, char* const* argv, char* const* envp, const PRProcessAttr* attr);
...
typedef enum IOOperation { READ_ASYNC, WRITE_ASYNC } IOOperation;
