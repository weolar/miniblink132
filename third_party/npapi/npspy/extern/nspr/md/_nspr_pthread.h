...
#define _MD_CURRENT_THREAD() ((struct PRThread*)pthread_getspecific(current_thread_key))
#define _MD_CURRENT_CPU() ((struct _PRCPU*)pthread_getspecific(current_cpu_key))
#define _MD_LAST_THREAD() ((struct PRThread*)pthread_getspecific(last_thread_key))

#define _MD_SET_CURRENT_THREAD(newval) pthread_setspecific(current_thread_key, (void*)newval)

#define _MD_SET_CURRENT_CPU(newval) pthread_setspecific(current_cpu_key, (void*)newval)

#define _MD_SET_LAST_THREAD(newval) pthread_setspecific(last_thread_key, (void*)newval)
...
NSPR_API(PRStatus)
_MD_CreateThread(struct PRThread* thread, void (*start)(void*), PRThreadPriority priority, PRThreadScope scope, PRThreadState state, PRUint32 stackSize);
...
NSPR_API(void) _MD_SetPriority(struct _MDThread* thread, PRThreadPriority newPri);
