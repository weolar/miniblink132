...
#define _PT_PTHREAD_MUTEX_INIT(m, a) (memset(&(m), 0, sizeof(m)), pthread_mutex_init(&(m), NULL))
#define _PT_PTHREAD_MUTEX_IS_LOCKED(m) (EBUSY == pthread_mutex_trylock(&(m)))
#define _PT_PTHREAD_CONDATTR_INIT(x) 0
#define _PT_PTHREAD_CONDATTR_DESTROY(x) /* */
#define _PT_PTHREAD_COND_INIT(m, a) (memset(&(m), 0, sizeof(m)), pthread_cond_init(&(m), NULL))
#else
...
#define _PT_PTHREAD_INVALIDATE_THR_HANDLE(t) memset(&(t), 0, sizeof(pthread_t))
#define _PT_PTHREAD_THR_HANDLE_IS_INVALID(t) (!memcmp(&(t), &pt_zero_tid, sizeof(pthread_t)))
#define _PT_PTHREAD_COPY_THR_HANDLE(st, dt) (dt) = (st)
#elif defined(IRIX) || defined(OSF1) || defined(AIX) || defined(SOLARIS) || defined(HPUX) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD)             \
    || defined(OPENBSD) || defined(BSDI) || defined(VMS) || defined(NTO) || defined(DARWIN) || defined(UNIXWARE)
...
#define _PT_PTHREAD_ATTR_GETSTACKSIZE(a, s) (*(s) = pthread_attr_getstacksize(*(a)), 0)
#define _PT_PTHREAD_GETSPECIFIC(k, r) pthread_getspecific((k), (pthread_addr_t*)&(r))
 ...
 */
#if (defined(AIX) && !defined(AIX4_3_PLUS)) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD) || defined(BSDI) || defined(VMS)      \
    || defined(UNIXWARE) || defined(DARWIN)
...
#elif defined(NETBSD) || defined(BSDI) || defined(DARWIN) || defined(UNIXWARE) /* XXX */
#define PT_PRIO_MIN 0
...
#define _PT_PTHREAD_YIELD()                                                                                                                                    \
    ...
    PR_END_MACRO
#elif defined(HPUX) || defined(LINUX) || defined(SOLARIS) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD) || defined(BSDI) || defined(NTO)          \
