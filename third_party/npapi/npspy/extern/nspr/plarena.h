...
#define PL_ARENA_ALIGN(pool, n) (((PRUword)(n) + PL_ARENA_CONST_ALIGN_MASK) & ~PL_ARENA_CONST_ALIGN_MASK)

#define PL_INIT_ARENA_POOL(pool, name, size) PL_InitArenaPool(pool, name, size, PL_ARENA_CONST_ALIGN_MASK + 1)
#else
...
#define PL_CLEAR_UNUSED(a) (PR_ASSERT((a)->avail <= (a)->limit), memset((void*)(a)->avail, PL_FREE_PATTERN, (a)->limit - (a)->avail))
#define PL_CLEAR_ARENA(a) memset((void*)(a), PL_FREE_PATTERN, (a)->limit - (PRUword)(a))
#else
...
PR_EXTERN(void) PL_ArenaCountInplaceGrowth(PLArenaPool* pool, PRUint32 size, PRUint32 incr);

PR_EXTERN(void) PL_ArenaCountGrowth(PLArenaPool* pool, PRUint32 size, PRUint32 incr);
