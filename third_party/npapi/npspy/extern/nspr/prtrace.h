...
#define PR_INIT_TRACE_HANDLE(handle, value) (handle) = (PRCounterHandle)(value)
#else
...
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_CREATE_TRACE(handle, qName, rName, description) (handle) = PR_CreateTrace((qName), (rName), (description))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_DESTROY_TRACE(handle) PR_DestroyTrace((handle))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_TRACE(handle, ud0, ud1, ud2, ud3, ud4, ud5, ud6, ud7) PR_Trace((handle), (ud0), (ud1), (ud2), (ud3), (ud4), (ud5), (ud6), (ud7))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_SET_TRACE_OPTION(command, value) PR_SetTraceOption((command), (value))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_GET_TRACE_OPTION(command, value) PR_GetTraceOption((command), (value))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_GET_TRACE_HANDLE_FROM_NAME(handle, qName, rName) (handle) = PR_GetTraceHandleFromName((qName), (rName))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_GET_TRACE_NAME_FROM_HANDLE(handle, qName, rName, description) PR_GetTraceNameFromHandle((handle), (qName), (rName), (description))
#else
#define PR_GET_TRACE_NAME_FROM_HANDLE(handle, qName, rName, description)
#endif

NSPR_API(void)
PR_GetTraceNameFromHandle(PRTraceHandle handle, /* handle as search argument */
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_FIND_NEXT_TRACE_QNAME(next, handle) (next) = PR_FindNextTraceQname((handle))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_FIND_NEXT_TRACE_RNAME(next, rhandle, qhandle) (next) = PR_FindNextTraceRname((rhandle), (qhandle))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_RECORD_TRACE_ENTRIES() PR_RecordTraceEntries()
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_TRACE)
#define PR_GET_TRACE_ENTRIES(buffer, count, found) PR_GetTraceEntries((buffer), (count), (found))
#else
