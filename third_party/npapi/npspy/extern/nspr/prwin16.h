...
NSPR_API(PRStatus)
PR_MD_RegisterW16StdioCallbacks(PRStdinRead inReadf, /* i: function pointer for stdin read       */
...
#define PR_STDIO_INIT()                                                                                                                                        \
    PR_MD_RegisterW16StdioCallbacks(_PL_W16StdioRead, _PL_W16StdioWrite, _PL_W16StdioWrite);                                                                   \
    PR_INIT_CALLBACKS();
