...
#define PR_INIT_COUNTER_HANDLE(handle, value) (handle) = (PRCounterHandle)(value)
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_CREATE_COUNTER(handle, qName, rName, description) (handle) = PR_CreateCounter((qName), (rName), (description))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_GET_COUNTER_HANDLE_FROM_NAME(handle, qName, rName) (handle) = PR_GetCounterHandleFromName((qName), (rName))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_GET_COUNTER_NAME_FROM_HANDLE(handle, qName, rName, description) PR_GetCounterNameFromHandle((handle), (qName), (rName), (description))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_ADD_TO_COUNTER(handle, value) PR_AddToCounter((handle), (value))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_SUBTRACT_FROM_COUNTER(handle, value) PR_SubtractFromCounter((handle), (value))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_GET_COUNTER(counter, handle) (counter) = PR_GetCounter((handle))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_FIND_NEXT_COUNTER_QNAME(next, handle) (next) = PR_FindNextCounterQname((handle))
#else
...
*/
#if defined(DEBUG) || defined(FORCE_NSPR_COUNTERS)
#define PR_FIND_NEXT_COUNTER_RNAME(next, rhandle, qhandle) (next) = PR_FindNextCounterRname((rhandle), (qhandle))
#else
