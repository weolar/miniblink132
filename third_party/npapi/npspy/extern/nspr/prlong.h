...
PRInt64 __pascal __loadds __export LL_MaxInt(void);
PRInt64 __pascal __loadds __export LL_MinInt(void);
PRInt64 __pascal __loadds __export LL_Zero(void);
PRUint64 __pascal __loadds __export LL_MaxUint(void);
#else
...
***********************************************************************/
#define LL_UDIVMOD(qp, rp, a, b) (*(qp) = ((PRUint64)(a) / (b)), *(rp) = ((PRUint64)(a) % (b)))
...
#define LL_NEG(r, a) ((r).lo = -(PRInt32)(a).lo, (r).hi = -(PRInt32)(a).hi - ((r).lo != 0))
#define LL_ADD(r, a, b)                                                                                                                                        \
    {                                                                                                                                                          \
        PRInt64 _a, _b;                                                                                                                                        \
        _a = a;                                                                                                                                                \
