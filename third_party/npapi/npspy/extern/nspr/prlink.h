...
typedef enum PRLibSpecType { PR_LibSpec_Pathname, PR_LibSpec_MacNamedFragment, PR_LibSpec_MacIndexedFragment } PRLibSpecType;
...
NSPR_API(PRLibrary*)
PR_LoadLibraryWithFlags(PRLibSpec libSpec, /* the shared library */
...
** This increments the reference count of the library.
*/
NSPR_API(void*) PR_FindSymbolAndLibrary(const char* name, PRLibrary** lib);
...
** This increments the reference count of the library.
*/
NSPR_API(PRFuncPtr) PR_FindFunctionSymbolAndLibrary(const char* name, PRLibrary** lib);
...
** This increments the reference count of the library.
*/
NSPR_API(PRLibrary*) PR_LoadStaticLibrary(const char* name, const PRStaticLinkTable* table);
