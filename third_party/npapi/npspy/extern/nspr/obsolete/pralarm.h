...
typedef PRBool(PR_CALLBACK* PRPeriodicAlarmFn)(PRAlarmID* id, void* clientData, PRUint32 late);
...
***********************************************************************/
NSPR_API(PRAlarmID*) PR_SetAlarm(PRAlarm* alarm, PRIntervalTime period, PRUint32 rate, PRPeriodicAlarmFn function, void* clientData);
...
***********************************************************************/
NSPR_API(PRStatus) PR_ResetAlarm(PRAlarmID* id, PRIntervalTime period, PRUint32 rate);
