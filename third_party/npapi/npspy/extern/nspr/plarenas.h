...
**/
PR_EXTERN(void) PL_InitArenaPool(PLArenaPool* pool, const char* name, PRUint32 size, PRUint32 align);
...
PR_EXTERN(void*) PL_ArenaGrow(PLArenaPool* pool, void* p, PRUint32 size, PRUint32 incr);
