...
typedef enum JRIVerifyMode { JRIVerifyNone, JRIVerifyRemote, JRIVerifyAll } JRIVerifyMode;
...
extern JRI_PUBLIC_API(JRIRuntimeInstance*) JRI_NewRuntime(JRIRuntimeInitargs* initargs);
...
typedef void (*JRI_GetClassFieldInfo_t)(
    JRIReflectionEnv* env, struct java_lang_Class* clazz, jsize fieldIndex, char** fieldName, char** fieldSig, JRIAccessFlags* fieldAccess, jref* fieldClass);
...
typedef void (*JRI_GetClassMethodInfo_t)(JRIReflectionEnv* env, struct java_lang_Class* clazz, jsize methodIndex, char** methodName, char** methodSig,
    JRIAccessFlags* methodAccess, jref* methodClass, void** methodNativeProc);
...
typedef void (*JRI_GetVarInfo_t)(
    JRIDebuggerEnv* env, jsize frameIndex, jsize varIndex, char** name, char** signature, jbool* isArgument, jsize* startScope, jsize* endScope);
