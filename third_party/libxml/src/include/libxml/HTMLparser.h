...
XMLPUBFUN htmlParserCtxtPtr XMLCALL htmlNewSAXParserCtxt(const htmlSAXHandler* sax, void* userData);
...
XML_DEPRECATED
XMLPUBFUN htmlDocPtr XMLCALL htmlSAXParseDoc(const xmlChar* cur, const char* encoding, htmlSAXHandlerPtr sax, void* userData);
XMLPUBFUN htmlDocPtr XMLCALL htmlParseDoc(const xmlChar* cur, const char* encoding);
...
XMLPUBFUN htmlParserCtxtPtr XMLCALL htmlCreatePushParserCtxt(
    htmlSAXHandlerPtr sax, void* user_data, const char* chunk, int size, const char* filename, xmlCharEncoding enc);
...
XMLPUBFUN htmlDocPtr XMLCALL htmlReadIO(
...
XMLPUBFUN htmlDocPtr XMLCALL htmlCtxtReadIO(
