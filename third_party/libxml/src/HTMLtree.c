 ...
 */
static size_t htmlBufNodeDumpFormat(xmlBufPtr buf, xmlDocPtr doc, xmlNodePtr cur, int format)
{
    size_t use;
    int ret;
 ...
 */
static void htmlDtdDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr doc, const char* encoding ATTRIBUTE_UNUSED)
{
 ...
 */
static void htmlAttrDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr doc, xmlAttrPtr cur)
{
    xmlChar* value;
 ...
 * Dump an HTML node, recursive behaviour,children are printed too.
 */
void htmlNodeDumpFormatOutput(xmlOutputBufferPtr buf, xmlDocPtr doc, xmlNodePtr cur, const char* encoding ATTRIBUTE_UNUSED, int format)
{
    ...
    while (1) {
        ...
        case XML_ELEMENT_NODE:
            ...
            if ((info != NULL) && (info->empty)) {
                ...
                if ((info != NULL) && (info->saveEndTag != 0) && (xmlStrcmp(BAD_CAST info->name, BAD_CAST "html"))
                ...
                xmlOutputBufferWriteString(buf, ">");
                if ((format) && (info != NULL) && (!info->isinline) && (cur->children->type != HTML_TEXT_NODE) && (cur->children->type != HTML_ENTITY_REF_NODE)
                    && (cur->children != cur->last) && (cur->name != NULL) && (cur->name[0] != 'p')) /* p, pre, param */
                    xmlOutputBufferWriteString(buf, "\n");
                parent = cur;
                cur = cur->children;
                continue;
            ...
            if ((format) && (cur->next != NULL) && (info != NULL) && (!info->isinline)) {
                if ((cur->next->type != HTML_TEXT_NODE) && (cur->next->type != HTML_ENTITY_REF_NODE) && (parent != NULL) && (parent->name != NULL)
        ...
        case HTML_TEXT_NODE:
            ...
            if (((cur->name == (const xmlChar*)xmlStringText) || (cur->name != (const xmlChar*)xmlStringTextNoenc))
                && ((parent == NULL) || ((xmlStrcasecmp(parent->name, BAD_CAST "script")) && (xmlStrcasecmp(parent->name, BAD_CAST "style"))))) {
                xmlChar* buffer;
        ...
        while (1) {
            ...
            if ((cur->type == XML_HTML_DOCUMENT_NODE) || (cur->type == XML_DOCUMENT_NODE)) {
                ...
                if ((format) && (info != NULL) && (!info->isinline) && (cur->last->type != HTML_TEXT_NODE) && (cur->last->type != HTML_ENTITY_REF_NODE)
                    && (cur->children != cur->last) && (cur->name != NULL) && (cur->name[0] != 'p')) /* p, pre, param */
                    xmlOutputBufferWriteString(buf, "\n");
 ...
 */
void htmlNodeDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr doc, xmlNodePtr cur, const char* encoding ATTRIBUTE_UNUSED)
{
 ...
 */
void htmlDocContentDumpFormatOutput(xmlOutputBufferPtr buf, xmlDocPtr cur, const char* encoding ATTRIBUTE_UNUSED, int format)
{
    int type = 0;
    if (cur) {
        type = cur->type;
 ...
 */
void htmlDocContentDumpOutput(xmlOutputBufferPtr buf, xmlDocPtr cur, const char* encoding ATTRIBUTE_UNUSED)
{
