...
void TestPayloads(size_t input_size, zlib_internal::WrapperType type)
{
    ...
    std::vector<unsigned char> compressed(zlib_internal::GzipExpectedCompressedSize(input.size()));
    ...
    int result = zlib_internal::CompressHelper(type, compressed.data(), &compressed_size, input.data(), input.size(), Z_DEFAULT_COMPRESSION, nullptr, nullptr);
    ASSERT_EQ(result, Z_OK);

    unsigned long decompressed_size = static_cast<unsigned long>(decompressed.size());
    result = zlib_internal::UncompressHelper(type, decompressed.data(), &decompressed_size, compressed.data(), compressed_size);
    ASSERT_EQ(result, Z_OK);
...
TEST(ZlibTest, DeflateStored)
{
    ...
    std::vector<unsigned char> decompressed(input.size());
    unsigned long compressed_size = static_cast<unsigned long>(compressed.size());
    int result = zlib_internal::CompressHelper(type, compressed.data(), &compressed_size, input.data(), input.size(), no_compression, nullptr, nullptr);
    ASSERT_EQ(result, Z_OK);
...
// Fuzzer generated.
static const uint8_t checkMatchCrashData[] = { ,
    ...
    0xff, 0xff, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x00, 0xff, 0x00, 0x00, 0x24, 0x2a, 0x6e, 0x5c, 0x24, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x87, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xeb, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x40, 0x00, 0x40, 0x00, 0x00, 0x00, 0x58, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x05, 0x00, 0x00, 0x00, 0x5d, 0x10, 0x6e, 0x6e, 0xa5, 0x2f, 0x00, 0x00, 0x95, 0x87, 0x00,
    0x6e };
...
TEST(ZlibTest, CheckMatchCrash)
{
    ...
    ASSERT_EQ(ret, Z_STREAM_END);
    inflateEnd(&stream);
    ASSERT_EQ(memcmp(checkMatchCrashData, decompressed, sizeof(checkMatchCrashData)), 0);
}
...
static const char zFixedCorruptionData[] = "AAABAACAADAAEAAFAAGAAHAAIAAJAAKAALAAMAANAAOAAPAAQAARAASAATAAUAAVAAWAAXAAYA"
...
TEST(ZlibTest, DeflateZFixedCorruption)
{
    ...
    int ret = deflateInit2(&stream, level, Z_DEFLATED, windowBits, memLevel, strategy);
    ASSERT_EQ(ret, Z_OK);
    std::vector<uint8_t> compressed(deflateBound(&stream, strlen(zFixedCorruptionData)));
    stream.next_out = compressed.data();
    stream.avail_out = compressed.size();
    ...
    EXPECT_EQ(memcmp(zFixedCorruptionData, decompressed.data(), decompressed.size()), 0);
}
