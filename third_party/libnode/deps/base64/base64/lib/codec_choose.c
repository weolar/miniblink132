...
static bool codec_choose_forced(struct codec* codec, int flags)
{
...
static bool codec_choose_arm(struct codec* codec)
{
...
static bool codec_choose_x86(struct codec* codec)
{
