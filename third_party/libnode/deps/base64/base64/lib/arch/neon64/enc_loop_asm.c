...
static inline void enc_loop_neon64(const uint8_t** s, size_t* slen, uint8_t** o, size_t* olen)
{
    ...
    *olen += rounds * 64; // 64 bytes produced per round.
    ...
    __asm__ volatile(
        ...
        "    " ROUND_A_FIRST() "    " ROUND_B() "    " ROUND_A() "    " ROUND_B() "    " ROUND_A() "    " ROUND_B() "    " ROUND_A() "    " ROUND_B_LAST() "   "
                                                                                                                                                           " b."
                                                                                                                                                           "ne "
                                                                                                                                                           "88b"
                                                                                                                                                           " \n"
                                                                                                                                                           ...
                                                                                                                                                           " " ROUND_A_FIRST() "    " ROUND_B() "    " ROUND_A() "    " ROUND_B_LAST() "    sub %[rounds], %[rounds], #4 \n\t"
                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                       "3:  " ROUND() "2:  " ROUND() "1:  " ROUND() "0:  \n\t"

        // Outputs (modified).
        : [loops] "+r"(loops), [src] "+r"(*s), [dst] "+r"(*o), [t0] "=&w"(tmp0), [t1] "=&w"(tmp1), [t2] "=&w"(tmp2), [t3] "=&w"(tmp3)

        // Inputs (not modified).
        : [rounds] "r"(rounds), [tbl] "r"(base64_table_enc_6bit), [n63] "w"(vdupq_n_u8(63))

        // Clobbers.
        : "v2", "v3", "v4", "v5", "v8", "v9", "v10", "v11", "v12", "v13", "v14", "v15", "cc", "memory");
}
