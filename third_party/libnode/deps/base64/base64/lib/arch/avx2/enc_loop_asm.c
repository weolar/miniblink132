...
// constant offset.
#define LOAD(R0, ROUND, OFFSET) "vlddqu (" #ROUND " * 24 + " #OFFSET ")(%[src]), %[" R0 "] \n\t"
...
#define STOR(R0, ROUND) "vmovdqu %[" R0 "], (" #ROUND " * 32)(%[dst]) \n\t"
...
#define ROUND_3_A(ROUND) ROUND_3(ROUND, "a", "b", "c", "d", "e", "f")

// Define a type B round. Inputs and outputs are swapped with regard to type A.
#define ROUND_3_B(ROUND) ROUND_3(ROUND, "d", "e", "f", "a", "b", "c")
...
static inline void enc_loop_avx2(const uint8_t** s, size_t* slen, uint8_t** o, size_t* olen)
{
    ...
    *olen += rounds * 32; // 32 bytes produced per round
    ...
    // Lookup tables.
    const __m256i lut0 = _mm256_set_epi8(10, 11, 9, 10, 7, 8, 6, 7, 4, 5, 3, 4, 1, 2, 0, 1, 14, 15, 13, 14, 11, 12, 10, 11, 8, 9, 7, 8, 5, 6, 4, 5);

    const __m256i lut1
        = _mm256_setr_epi8(65, 71, -4, -4, -4, -4, -4, -4, -4, -4, -4, -4, -19, -16, 0, 0, 65, 71, -4, -4, -4, -4, -4, -4, -4, -4, -4, -4, -19, -16, 0, 0);
    ...
    __asm__ volatile(
        ...
        "                            \n\t"
        ".balign 64                  \n\t"
        "36: " ROUND_3_INIT() "    " ROUND_3_A(0) "    " ROUND_3_B(3) "    " ROUND_3_A(6) "    " ROUND_3_B(9) "    " ROUND_3_A(12) "    " ROUND_3_B(
            15) "    " ROUND_3_A(18) "    " ROUND_3_B(21) "    " ROUND_3_A(24) "    " ROUND_3_B(27) "    " ROUND_3_A_LAST(30) "    add $(24 * 36), %[src] \n\t"
                                                                                                                              "    add $(32 * 36), %[dst] \n\t"
                                                                                                                              "    dec %[loops]           \n\t"
                                                                                                                              "    jnz 36b                \n\t"
                                                                                                                              ...
                                                                                                                              "    jl  9f             \n\t"
                                                                                                                              "    " ROUND_3_INIT() "   "
                                                                                                                                                    " " ROUND_3_A(0) "    " ROUND_3_B(3) "    " ROUND_3_A(6) "    " ROUND_3_B(9) "    " ROUND_3_A_LAST(
                                                                                                                                                        12) "  "
                                                                                                                                                            "  "
                                                                                                                                                            "su"
                                                                                                                                                            "b "
                                                                                                                                                            ...
                                                                                                                                                            "  "
                                                                                                                                                            " "
                                                                                                                                                            " " ROUND_3_INIT() "    " ROUND_3_A(0) "    " ROUND_3_B_LAST(
                                                                                                                                                                3) "    sub $9,        %[rounds] \n\t"
                                                                                                                                                                   "    add $(24 * 9), %[src]    \n\t"
                                                                                                                                                                   "    add $(32 * 9), %[dst]    \n\t"
                                                                                                                                                                   ...
                                                                                                                                                                   "    " ROUND_3_INIT() "    " ROUND_3_A_LAST(
                                                                                                                                                                       0) "    sub $6,        %[rounds] \n\t"
                                                                                                                                                                          ...
                                                                                                                                                                          "5: " ROUND() "4: " ROUND() "3: " ROUND() "2: " ROUND() "1: " ROUND() "0: \n\t"

        // Outputs (modified).
        : [rounds] "+r"(rounds), [loops] "+r"(loops), [src] "+r"(*s), [dst] "+r"(*o), [a] "=&x"(a), [b] "=&x"(b), [c] "=&x"(c), [d] "=&x"(d), [e] "=&x"(e),
        [f] "+x"(f)

        // Inputs (not modified).
        : [lut0] "x"(lut0), [lut1] "x"(lut1), [msk0] "x"(_mm256_set1_epi32(0x0FC0FC00)), [msk1] "x"(_mm256_set1_epi32(0x04000040)),
        [msk2] "x"(_mm256_set1_epi32(0x003F03F0)), [msk3] "x"(_mm256_set1_epi32(0x01000010)), [n51] "x"(_mm256_set1_epi8(51)), [n25] "x"(_mm256_set1_epi8(25))
