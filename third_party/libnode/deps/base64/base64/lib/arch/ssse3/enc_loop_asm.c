...
#define LOAD(R0, ROUND) "lddqu (" #ROUND " * 12)(%[src]), %[" R0 "] \n\t"
...
#define STOR(R0, ROUND) "movdqu %[" R0 "], (" #ROUND " * 16)(%[dst]) \n\t"
...
static inline void enc_loop_ssse3(const uint8_t** s, size_t* slen, uint8_t** o, size_t* olen)
{
