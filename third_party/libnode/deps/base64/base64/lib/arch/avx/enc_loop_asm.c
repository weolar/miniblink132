...
#define LOAD(R0, ROUND) "vlddqu (" #ROUND " * 12)(%[src]), %[" R0 "] \n\t"
...
#define STOR(R0, ROUND) "vmovdqu %[" R0 "], (" #ROUND " * 16)(%[dst]) \n\t"
...
static inline void enc_loop_avx(const uint8_t** s, size_t* slen, uint8_t** o, size_t* olen)
{
    ...
    *olen += rounds * 16; // 16 bytes produced per round
    ...
    // Lookup tables.
    const __m128i lut0 = _mm_set_epi8(10, 11, 9, 10, 7, 8, 6, 7, 4, 5, 3, 4, 1, 2, 0, 1);

    const __m128i lut1 = _mm_setr_epi8(65, 71, -4, -4, -4, -4, -4, -4, -4, -4, -4, -4, -19, -16, 0, 0);
    ...
    __asm__ volatile(
        ...
        "36: " ROUND_3_INIT() "    " ROUND_3_A(0) "    " ROUND_3_B(3) "    " ROUND_3_A(6) "    " ROUND_3_B(9) "    " ROUND_3_A(12) "    " ROUND_3_B(
            15) "    " ROUND_3_A(18) "    " ROUND_3_B(21) "    " ROUND_3_A(24) "    " ROUND_3_B(27) "    " ROUND_3_A_LAST(30) "    add $(12 * 36), %[src] \n\t"
                                                                                                                              "    add $(16 * 36), %[dst] \n\t"
                                                                                                                              "    dec %[loops]           \n\t"
                                                                                                                              "    jnz 36b                \n\t"
        ...
        // Inputs (not modified).
        : [lut0] "x"(lut0), [lut1] "x"(lut1), [msk0] "x"(_mm_set1_epi32(0x0FC0FC00)), [msk1] "x"(_mm_set1_epi32(0x04000040)),
        [msk2] "x"(_mm_set1_epi32(0x003F03F0)), [msk3] "x"(_mm_set1_epi32(0x01000010)), [n51] "x"(_mm_set1_epi8(51)), [n25] "x"(_mm_set1_epi8(25))
