static inline void enc_loop_generic_32_inner(const uint8_t** s, uint8_t** o)
{
    uint32_t src;
...
static inline void enc_loop_generic_32(const uint8_t** s, size_t* slen, uint8_t** o, size_t* olen)
{
    if (*slen < 4) {
        return;
    }
