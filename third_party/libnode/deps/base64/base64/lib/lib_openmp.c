...
static inline void base64_encode_openmp(const char* src, size_t srclen, char* out, size_t* outlen, int flags)
{
    size_t s;
    size_t t;
...
static inline int base64_decode_openmp(const char* src, size_t srclen, char* out, size_t* outlen, int flags)
{
