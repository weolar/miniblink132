...
#define STRUCT(name)                                                                                                                                           \
    void uvwasi_serdes_write_##name(void* ptr, size_t offset, const uvwasi_##name* value);                                                                     \
    void uvwasi_serdes_read_##name(const void* ptr, size_t offset, uvwasi_##name* value);

/* iovs currently only need to be read from WASM memory. */
#define IOVS_STRUCT(name) uvwasi_errno_t uvwasi_serdes_read_##name(const void* ptr, size_t end, size_t offset, uvwasi_##name* value);
