...
#define WRITE_STRUCT(name) void uvwasi_serdes_write_##name(void* ptr, size_t offset, const uvwasi_##name* value)

#define READ_STRUCT(name) void uvwasi_serdes_read_##name(const void* ptr, size_t offset, uvwasi_##name* value)
...
#define WRITE_ALIAS(new_name, old_name)                                                                                                                        \
    void uvwasi_serdes_write_##new_name(void* ptr, size_t offset, uvwasi_##new_name value)                                                                     \
    {                                                                                                                                                          \
        uvwasi_serdes_write_##old_name(ptr, offset, value);                                                                                                    \
    }

#define READ_ALIAS(new_name, old_name)                                                                                                                         \
    uvwasi_##new_name uvwasi_serdes_read_##new_name(const void* ptr, size_t offset)                                                                            \
    {                                                                                                                                                          \
...
uvwasi_errno_t uvwasi_serdes_read_ciovec_t(const void* ptr, size_t end, size_t offset, uvwasi_ciovec_t* value)
{
    uint32_t buf_ptr;
...
uvwasi_errno_t uvwasi_serdes_read_iovec_t(const void* ptr, size_t end, size_t offset, uvwasi_iovec_t* value)
{
    uint32_t buf_ptr;
...
uvwasi_errno_t uvwasi_serdes_readv_ciovec_t(const void* ptr, size_t end, size_t offset, uvwasi_ciovec_t* iovs, uvwasi_size_t iovs_len)
{
    uvwasi_errno_t err;
    uvwasi_size_t i;
...
uvwasi_errno_t uvwasi_serdes_readv_iovec_t(const void* ptr, size_t end, size_t offset, uvwasi_iovec_t* iovs, uvwasi_size_t iovs_len)
{
    uvwasi_errno_t err;
    uvwasi_size_t i;
...
int uvwasi_serdes_check_array_bounds(size_t offset, size_t end, size_t size, size_t count)
{
