...
template <typename T> struct ProtocolTypeTraits<T, typename std::enable_if<std::is_base_of<node::inspector::protocol::Value, T>::value>::type> {
...
template <> struct ProtocolTypeTraits<std::unique_ptr<node::inspector::protocol::Value>> {
...
template <> struct ProtocolTypeTraits<std::unique_ptr<node::inspector::protocol::DictionaryValue>> {
...
template <> struct ProtocolTypeTraits<std::unique_ptr<node::inspector::protocol::Object>> {
...
template <> struct ProtocolTypeTraits<node::inspector::protocol::Object> {
