...
#define PER_ISOLATE_SYMBOL_PROPERTIES(V)                                                                                                                       \
    ...
    V(vm_dynamic_import_main_context_default, "vm_dynamic_import_main_context_default")                                                                        \
...
#define PER_ISOLATE_STRING_PROPERTIES(V)                                                                                                                       \
    ...
    V(required_module_facade_url_string, "node:internal/require_module_default_facade")                                                                        \
    ...
    V(transfer_unsupported_type_str, "Cannot transfer object of unsupported type.")                                                                            \
    V(ttl_string, "ttl")                                                                                                                                       \
    V(type_string, "type")                                                                                                                                     \
    V(uid_string, "uid")                                                                                                                                       \
