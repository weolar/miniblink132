...
class PerIsolatePlatformData : public IsolatePlatformDelegate, public v8::TaskRunner, public std::enable_shared_from_this<PerIsolatePlatformData> {
public:
    ...
    const uv_loop_t* event_loop() const
    {
        return loop_;
    }
...
private:
    ...
    typedef std::unique_ptr<DelayedTask, void (*)(DelayedTask*)> DelayedTaskPointer;
...
public:
    NodePlatform(int thread_pool_size, v8::TracingController* tracing_controller, v8::PageAllocator* page_allocator = nullptr);
    ...
    void PostDelayedTaskOnWorkerThreadImpl(
        v8::TaskPriority priority, std::unique_ptr<v8::Task> task, double delay_in_seconds, const v8::SourceLocation& location) override;
    ...
    void RegisterIsolate(v8::Isolate* isolate, IsolatePlatformDelegate* delegate) override;

    void UnregisterIsolate(v8::Isolate* isolate) override;
    void AddIsolateFinishedCallback(v8::Isolate* isolate, void (*callback)(void*), void* data) override;
...
private:
    ...
    using DelegatePair = std::pair<IsolatePlatformDelegate*, std::shared_ptr<PerIsolatePlatformData>>;
