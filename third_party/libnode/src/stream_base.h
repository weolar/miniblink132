...
public:
    ...
    enum InternalFields { kSlot = BaseObject::kSlot, kStreamReqField = BaseObject::kInternalFieldCount, kInternalFieldCount };

    inline explicit StreamReq(StreamBase* stream, v8::Local<v8::Object> req_wrap_obj);
...
public:
    inline ShutdownWrap(StreamBase* stream, v8::Local<v8::Object> req_wrap_obj);

    static inline ShutdownWrap* FromObject(v8::Local<v8::Object> req_wrap_obj);
    template <typename T, bool kIsWeak> static inline ShutdownWrap* FromObject(const BaseObjectPtrImpl<T, kIsWeak>& base_obj);
...
public:
    ...
    inline WriteWrap(StreamBase* stream, v8::Local<v8::Object> req_wrap_obj);

    static inline WriteWrap* FromObject(v8::Local<v8::Object> req_wrap_obj);
    template <typename T, bool kIsWeak> static inline WriteWrap* FromObject(const BaseObjectPtrImpl<T, kIsWeak>& base_obj);
...
public:
    ...
    explicit CustomBufferJSListener(uv_buf_t buffer)
        : buffer_(buffer)
    {
    }
...
public:
    ...
    virtual inline bool HasDoTryWrite() const
    {
        return false;
    }
    ...
    virtual int DoWrite(WriteWrap* w, uv_buf_t* bufs, size_t count, uv_stream_t* send_handle) = 0;

    // Returns true if the stream supports the `OnStreamWantsWrite()` interface.
    virtual bool HasWantsWrite() const
    {
        return false;
    }
...
protected:
    ...
    inline void EmitRead(ssize_t nread, const uv_buf_t& buf = uv_buf_init(nullptr, 0));
...
public:
    ...
    enum InternalFields { kSlot = BaseObject::kSlot, kStreamBaseField = BaseObject::kInternalFieldCount, kOnReadFunctionField, kInternalFieldCount };

    static void AddMethods(IsolateData* isolate_data, v8::Local<v8::FunctionTemplate> target);
    static void AddMethods(Environment* env, v8::Local<v8::FunctionTemplate> target);
    ...
    v8::MaybeLocal<v8::Value> CallJSOnreadMethod(
        ssize_t nread, v8::Local<v8::ArrayBuffer> ab, size_t offset = 0, StreamBaseJSChecks checks = DONT_SKIP_NREAD_CHECKS);
    ...
    // be invoked.
    StreamWriteResult Write(uv_buf_t* bufs, size_t count, uv_stream_t* send_handle = nullptr, v8::Local<v8::Object> req_wrap_obj = v8::Local<v8::Object>(),
...
protected:
    ...
    template <enum encoding enc> int WriteString(const v8::FunctionCallbackInfo<v8::Value>& args);
    ...
    template <int (StreamBase::*Method)(const v8::FunctionCallbackInfo<v8::Value>& args)> static void JSMethod(const v8::FunctionCallbackInfo<v8::Value>& args);
...
template <typename OtherBase> class SimpleShutdownWrap : public ShutdownWrap, public OtherBase {
public:
...
template <typename OtherBase> class SimpleWriteWrap : public WriteWrap, public OtherBase {
public:
