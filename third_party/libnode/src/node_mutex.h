...
template <typename T, typename MutexT = Mutex> class ExclusiveAccess {
public:
...
template <typename Traits> ConditionVariableBase<Traits>::ConditionVariableBase()
{
...
template <typename Traits> void ConditionVariableBase<Traits>::Broadcast(const ScopedLock&)
{
    Traits::cond_broadcast(&cond_);
}

template <typename Traits> void ConditionVariableBase<Traits>::Signal(const ScopedLock&)
{
    Traits::cond_signal(&cond_);
}

template <typename Traits> void ConditionVariableBase<Traits>::Wait(const ScopedLock& scoped_lock)
{
    Traits::cond_wait(&cond_, &scoped_lock.mutex_.mutex_);
}

template <typename Traits> MutexBase<Traits>::MutexBase()
{
...
template <typename Traits> void MutexBase<Traits>::Lock()
{
    Traits::mutex_lock(&mutex_);
}

template <typename Traits> void MutexBase<Traits>::Unlock()
{
    Traits::mutex_unlock(&mutex_);
}

template <typename Traits> void MutexBase<Traits>::RdLock()
{
    Traits::mutex_rdlock(&mutex_);
}

template <typename Traits> void MutexBase<Traits>::RdUnlock()
{
...
template <typename Traits> MutexBase<Traits>::ScopedLock::~ScopedLock()
{
...
template <typename Traits> MutexBase<Traits>::ScopedReadLock::~ScopedReadLock()
{
...
template <typename Traits> MutexBase<Traits>::ScopedUnlock::~ScopedUnlock()
{
    Traits::mutex_lock(&mutex_.mutex_);
}
