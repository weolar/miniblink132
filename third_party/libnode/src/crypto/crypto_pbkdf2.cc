...
MaybeLocal<Value> PBKDF2Traits::EncodeOutput(Environment* env, const PBKDF2Config& params, ByteSource* out)
{
...
Maybe<void> PBKDF2Traits::AdditionalConfig(CryptoJobMode mode, const FunctionCallbackInfo<Value>& args, unsigned int offset, PBKDF2Config* params)
{
...
bool PBKDF2Traits::DeriveBits(Environment* env, const PBKDF2Config& params, ByteSource* out)
{
    ...
    auto dp = ncrypto::pbkdf2(params.digest,
        ...
        params.iterations, params.length);
