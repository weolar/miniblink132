...
public:
    ...
    static constexpr int QUIC_TRANSPORT_PARAMS_VERSION = NGTCP2_TRANSPORT_PARAMS_VERSION;
    ...
    struct Config {
        ...
        Config(Side side, const CID& ocid = CID::kInvalid, const CID& retry_scid = CID::kInvalid);
    };
    ...
    TransportParams(const ngtcp2_vec& buf, int version = QUIC_TRANSPORT_PARAMS_V1);
