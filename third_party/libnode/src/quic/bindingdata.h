...
class BindingData final : public BaseObject, public mem::NgLibMemoryManager<BindingData, ngtcp2_mem> {
public:
    ...
    static void FlushPacketFreelist(const v8::FunctionCallbackInfo<v8::Value>& args);
...
#define V(name)                                                                                                                                                \
    void set_##name##_constructor_template(v8::Local<v8::FunctionTemplate> tmpl);                                                                              \
...
template <typename T> struct CallbackScope final : public CallbackScopeBase {
    BaseObjectPtr<T> ref;
