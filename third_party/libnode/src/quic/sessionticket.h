...
public:
    static v8::Maybe<SessionTicket> FromV8Value(Environment* env, v8::Local<v8::Value> value);
    ...
    static SSL_TICKET_RETURN DecryptedCallback(
...
public:
    ...
    public:
        ...
        virtual Status ExtractSessionTicketAppData(const AppData& app_data, Flag flag = Flag::STATUS_NONE) = 0;
    };
