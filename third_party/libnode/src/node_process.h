...
v8::MaybeLocal<v8::Value> ProcessEmit(Environment* env, std::string_view event, v8::Local<v8::Value> message);

v8::Maybe<bool> ProcessEmitWarningGeneric(Environment* env, std::string_view warning, std::string_view type = "", std::string_view code = "");

template <typename... Args> inline v8::Maybe<bool> ProcessEmitWarning(Environment* env, const char* fmt, Args&&... args);

v8::Maybe<void> ProcessEmitWarningSync(Environment* env, std::string_view message);
v8::Maybe<bool> ProcessEmitExperimentalWarning(Environment* env, const std::string& warning);
v8::Maybe<bool> ProcessEmitDeprecationWarning(Environment* env, const std::string& warning, std::string_view deprecation_code);
...
public:
    ...
    static void AddMethods(v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> target);
    static void RegisterExternalReferences(ExternalReferenceRegistry* registry);

    SERIALIZABLE_OBJECT_METHODS()
    SET_BINDING_ID(process_binding_data)

    BindingData(Realm* realm, v8::Local<v8::Object> object, InternalFieldInfo* info = nullptr);
    ...
    static void FastNumber(v8::Local<v8::Value> unused, v8::Local<v8::Value> receiver)
    {
    ...
    static void FastBigInt(v8::Local<v8::Value> unused, v8::Local<v8::Value> receiver)
    {
