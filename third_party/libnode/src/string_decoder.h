...
public:
    ...
    // was finished.
    v8::MaybeLocal<v8::String> DecodeData(v8::Isolate* isolate, const char* data, size_t* nread);
    ...
    enum Fields { kIncompleteCharactersStart = 0, kIncompleteCharactersEnd = 4, kMissingBytes = 4, kBufferedBytes = 5, kEncodingField = 6, kNumFields = 7 };
