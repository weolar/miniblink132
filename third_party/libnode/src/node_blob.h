...
public:
    ...
    {
        return this->data_queue_->size().value();
    }
    ...
    public:
        ...
        static v8::Local<v8::FunctionTemplate> GetConstructorTemplate(Environment* env);
        static BaseObjectPtr<Reader> Create(Environment* env, BaseObjectPtr<Blob> blob);
        static void Pull(const v8::FunctionCallbackInfo<v8::Value>& args);

        explicit Reader(Environment* env, v8::Local<v8::Object> obj, BaseObjectPtr<Blob> strong_ptr);
    ...
    Blob(Environment* env, v8::Local<v8::Object> obj, std::shared_ptr<DataQueue> data_queue);

    DataQueue& getDataQueue() const
    {
        return *data_queue_;
    }
...
public:
    ...
    struct StoredDataObject : public MemoryRetainer {
        ...
        StoredDataObject(const BaseObjectPtr<Blob>& blob_, size_t length_, const std::string& type_);
    ...
    void store_data_object(const std::string& uuid, const StoredDataObject& object);
