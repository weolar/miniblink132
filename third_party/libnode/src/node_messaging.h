...
public:
    ...
    virtual BaseObjectPtr<BaseObject> Deserialize(Environment* env, v8::Local<v8::Context> context, std::unique_ptr<TransferData> self) = 0;
    ...
    virtual v8::Maybe<bool> FinalizeTransferWrite(v8::Local<v8::Context> context, v8::ValueSerializer* serializer);
};
...
public:
    ...
    v8::MaybeLocal<v8::Value> Deserialize(Environment* env, v8::Local<v8::Context> context, v8::Local<v8::Value>* port_list = nullptr);
    ...
    v8::Maybe<bool> Serialize(Environment* env, v8::Local<v8::Context> context, v8::Local<v8::Value> input, const TransferList& transfer_list,
...
public:
    ...
    v8::Maybe<bool> Dispatch(MessagePortData* source, std::shared_ptr<Message> message, std::string* error = nullptr);
...
private:
    ...
    using Map = std::unordered_map<std::string, std::weak_ptr<SiblingGroup>>;
...
public:
    ...
    v8::Maybe<bool> Dispatch(std::shared_ptr<Message> message, std::string* error = nullptr);
    ...
    void MemoryInfo(MemoryTracker* tracker) const override;
    BaseObjectPtr<BaseObject> Deserialize(Environment* env, v8::Local<v8::Context> context, std::unique_ptr<TransferData> self) override;
...
private:
    ...
    MessagePort(Environment* env, v8::Local<v8::Context> context, v8::Local<v8::Object> wrap);
...
public:
    ...
    static MessagePort* New(
        Environment* env, v8::Local<v8::Context> context, std::unique_ptr<MessagePortData> data = {}, std::shared_ptr<SiblingGroup> sibling_group = {});
    ...
    v8::Maybe<bool> PostMessage(Environment* env, v8::Local<v8::Context> context, v8::Local<v8::Value> message, const TransferList& transfer);
    ...
    void Close(v8::Local<v8::Value> close_callback = v8::Local<v8::Value>()) override;
...
private:
    ...
    void TriggerAsync();
    v8::MaybeLocal<v8::Value> ReceiveMessage(v8::Local<v8::Context> context, MessageProcessingMode mode, v8::Local<v8::Value>* port_list = nullptr);
...
private:
    ...
    public:
        ...
        BaseObjectPtr<BaseObject> Deserialize(Environment* env, v8::Local<v8::Context> context, std::unique_ptr<TransferData> self) override;
        v8::Maybe<bool> FinalizeTransferWrite(v8::Local<v8::Context> context, v8::ValueSerializer* serializer) override;
...
v8::Local<v8::FunctionTemplate> GetMessagePortConstructorTemplate(IsolateData* isolate_data);
