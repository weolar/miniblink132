...
static_assert(static_cast<int>(NM_F_LINKED) == static_cast<int>(node::ModuleFlags::kLinked), "NM_F_LINKED != node::ModuleFlags::kLinked");
...
#define NODE_BINDING_CONTEXT_AWARE_CPP(modname, regfunc, priv, flags)                                                                                          \
    static node::node_module _module                                                                                                                           \
        = { NODE_MODULE_VERSION, flags, nullptr, __FILE__, nullptr, (node::addon_context_register_func)(regfunc), NODE_STRINGIFY(modname), priv, nullptr };    \
    void _register_##modname()                                                                                                                                 \
    {                                                                                                                                                          \
        node_module_register(&_module);                                                                                                                        \
    }

void napi_module_register_by_symbol(v8::Local<v8::Object> exports, v8::Local<v8::Value> module, v8::Local<v8::Context> context, napi_addon_register_func init,
...
#define NODE_BINDING_CONTEXT_AWARE_INTERNAL(modname, regfunc) NODE_BINDING_CONTEXT_AWARE_CPP(modname, regfunc, nullptr, NM_F_INTERNAL)
...
#define NODE_BINDING_PER_ISOLATE_INIT(modname, per_isolate_func)                                                                                               \
    void _register_isolate_##modname(node::IsolateData* isolate_data, v8::Local<v8::ObjectTemplate> target)                                                    \
    {                                                                                                                                                          \
