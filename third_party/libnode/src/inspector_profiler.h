...
public:
    ...
    uint64_t DispatchMessage(const char* method, const char* params = nullptr, bool is_profile_request = false);
    ...
    virtual std::optional<std::string_view> GetProfile(simdjson::ondemand::object* result);
    ...
    void RemoveProfileId(uint64_t id)
    {
        profile_ids_.erase(id);
    }
...
public:
    ...
    std::optional<std::string_view> GetProfile(simdjson::ondemand::object* result) override;
