...
public:
    URLPattern(Environment* env, v8::Local<v8::Object> object, ada::url_pattern<URLPatternRegexProvider>&& url_pattern);
    ...
    // - Component Getters
#define URL_PATTERN_COMPONENT_GETTERS(name, _) static void name(const v8::FunctionCallbackInfo<v8::Value>& info);
...
#undef URL_PATTERN_COMPONENT_GETTERS
    ...
    public:
        static std::optional<ada::url_pattern_init> FromJsObject(Environment* env, v8::Local<v8::Object> obj);
        static v8::MaybeLocal<v8::Value> ToJsObject(Environment* env, const ada::url_pattern_init& init);
    };

    class URLPatternOptions {
    public:
        static std::optional<ada::url_pattern_options> FromJsObject(Environment* env, v8::Local<v8::Object> obj);
    };

    class URLPatternResult {
    public:
        static v8::MaybeLocal<v8::Value> ToJSValue(Environment* env, const ada::url_pattern_result& result);
    };

    class URLPatternComponentResult {
    public:
        static v8::MaybeLocal<v8::Object> ToJSObject(Environment* env, const ada::url_pattern_component_result& result);
    };
...
#undef URL_PATTERN_COMPONENT_GETTERS
    ...
    // Public API
    v8::MaybeLocal<v8::Value> Exec(Environment* env, const ada::url_pattern_input& input,
        std::optional<std::string_view>& baseURL); // NOLINT (runtime/references)
    bool Test(Environment* env, const ada::url_pattern_input& input,
        std::optional<std::string_view>& baseURL); // NOLINT (runtime/references)
