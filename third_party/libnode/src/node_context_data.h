...
enum ContextEmbedderIndex {
    ...
    kAllowCodeGenerationFromStrings = NODE_CONTEXT_ALLOW_CODE_GENERATION_FROM_STRINGS_INDEX,
...
public:
    static inline void TagNodeContext(v8::Local<v8::Context> context)
    {
        ...
        // context.
        context->SetAlignedPointerInEmbedderData(ContextEmbedderIndex::kContextTag, ContextEmbedderTag::kNodeContextTagPtr);
    }
    ...
    static inline bool IsNodeContext(v8::Local<v8::Context> context)
    {
        ...
        if (context->GetAlignedPointerFromEmbedderData(ContextEmbedderIndex::kContextTag) != ContextEmbedderTag::kNodeContextTagPtr)
            [[unlikely]]
            {
                return false;
            }
