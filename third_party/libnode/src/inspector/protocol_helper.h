...
inline std::unique_ptr<v8_inspector::StringBuffer> ToInspectorString(v8::Isolate* isolate, v8::Local<v8::Value> value)
{
    TwoByteValue buffer(isolate, value);
    return v8_inspector::StringBuffer::create(v8_inspector::StringView(*buffer, buffer.length()));
}

// Convert a V8 string to node::inspector::protocol::String, encoded in UTF8.
inline protocol::String ToProtocolString(v8::Isolate* isolate, v8::Local<v8::Value> value)
{
