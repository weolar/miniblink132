...
public:
    explicit NetworkInspector(Environment* env, v8_inspector::V8Inspector* v8_inspector);
    ~NetworkInspector();
    ...
    void emitNotification(v8::Local<v8::Context> context, const std::string& domain, const std::string& method, v8::Local<v8::Object> params);
