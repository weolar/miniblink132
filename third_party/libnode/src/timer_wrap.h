...
public:
    ...
    template <typename... Args> explicit inline TimerWrap(Environment* env, Args&&... args);
...
public:
    template <typename... Args> explicit inline TimerWrapHandle(Environment* env, Args&&... args);
