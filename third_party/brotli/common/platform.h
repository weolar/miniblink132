...
#elif defined(BROTLI_TARGET_X64) || defined(BROTLI_TARGET_ARMV8_64) || defined(BROTLI_TARGET_POWERPC64) || defined(BROTLI_TARGET_RISCV64)
#define BROTLI_64_BITS 1
#else
#define BROTLI_64_BITS 0
#endif
...
#elif defined(BROTLI_TARGET_X86) || defined(BROTLI_TARGET_X64) || defined(BROTLI_TARGET_ARMV7) || defined(BROTLI_TARGET_ARMV8_ANY)                             \
...
#define BROTLI_BSWAP16_(V) ((uint16_t)((((V)&0xFFU) << 8) | (((V) >> 8) & 0xFFU)))
static BROTLI_INLINE uint16_t BROTLI_UNALIGNED_LOAD16LE(const void* p)
{
    uint16_t value = BrotliUnalignedRead16(p);
    return BROTLI_BSWAP16_(value);
}
#define BROTLI_BSWAP32_(V) ((((V)&0xFFU) << 24) | (((V)&0xFF00U) << 8) | (((V) >> 8) & 0xFF00U) | (((V) >> 24) & 0xFFU))
...
#define BROTLI_BSWAP64_(V)                                                                                                                                     \
    ((((V)&0xFFU) << 56) | (((V)&0xFF00U) << 40) | (((V)&0xFF0000U) << 24) | (((V)&0xFF000000U) << 8) | (((V) >> 8) & 0xFF000000U) | (((V) >> 24) & 0xFF0000U) \
