...
{
    BrotliWriteBits(40, BROTLI_MAKE_UINT64_T(0x0000FFu, 0x55555554u), storage_ix, storage);
}
...
{
    BrotliWriteBits(56, BROTLI_MAKE_UINT64_T(0x926244U, 0x16307003U), storage_ix, storage);
