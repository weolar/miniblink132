...
#define BROTLI_SUNPRO_VERSION                                                                                                                                  \
    BROTLI_MAKE_VERSION(                                                                                                                                       \
        (((__SUNPRO_C >> 16) & 0xf) * 10) + ((__SUNPRO_C >> 12) & 0xf), (((__SUNPRO_C >> 8) & 0xf) * 10) + ((__SUNPRO_C >> 4) & 0xf), (__SUNPRO_C & 0xf) * 10)
...
#define BROTLI_ARM_VERSION                                                                                                                                     \
    BROTLI_MAKE_VERSION((__ARMCOMPILER_VERSION / 1000000), (__ARMCOMPILER_VERSION % 1000000) / 10000, (__ARMCOMPILER_VERSION % 10000) / 100)
...
#if defined(ADDRESS_SANITIZER) || BROTLI_HAS_FEATURE(address_sanitizer) || defined(THREAD_SANITIZER) || BROTLI_HAS_FEATURE(thread_sanitizer)                   \
