 ...
 */
#define IS_XSLT_ELEM_FAST(n) (((n) != NULL) && ((n)->ns != NULL) && ((n)->ns->href == xsltConstNamespaceNameXSLT))
 ...
 */
#define IS_XSLT_ATTR_FAST(a) (((a) != NULL) && ((a)->ns != NULL) && ((a)->ns->href == xsltConstNamespaceNameXSLT))
 ...
 */
#define XSLT_HAS_INTERNAL_NSMAP(s) (((s) != NULL) && ((s)->principal) && ((s)->principal->principalData) && ((s)->principal->principalData->nsMap))
 ...
 */
#define IS_XSLT_ELEM_FAST(n) (((n) != NULL) && ((n)->ns != NULL) && (xmlStrEqual((n)->ns->href, XSLT_NAMESPACE)))
 ...
 */
XSLTPUBFUN xsltPointerListPtr XSLTCALL xsltPointerListCreate(int initialSize);
XSLTPUBFUN void XSLTCALL xsltPointerListFree(xsltPointerListPtr list);
XSLTPUBFUN void XSLTCALL xsltPointerListClear(xsltPointerListPtr list);
XSLTPUBFUN int XSLTCALL xsltPointerListAddSize(xsltPointerListPtr list, void* item, int initialSize);
...
typedef enum { XSLT_ERROR_SEVERITY_ERROR = 0, XSLT_ERROR_SEVERITY_WARNING } xsltErrorSeverityType;
...
#ifdef XSLT_REFACTORED
XSLTPUBFUN void XSLTCALL xsltParseSequenceConstructor(xsltCompilerCtxtPtr cctxt, xmlNodePtr start);
XSLTPUBFUN int XSLTCALL xsltParseAnyXSLTElem(xsltCompilerCtxtPtr cctxt, xmlNodePtr elem);
#ifdef XSLT_REFACTORED_XSLT_NSCOMP
XSLTPUBFUN int XSLTCALL xsltRestoreDocumentNamespaces(xsltNsMapPtr ns, xmlDocPtr doc);
#endif
#endif /* XSLT_REFACTORED */
