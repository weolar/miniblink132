...
static void exsltObjectTypeFunction(xmlXPathParserContextPtr ctxt, int nargs)
{
    ...
    case XPATH_USERS:
        ...
        break;
    default:
        xsltGenericError(xsltGenericErrorContext, "object-type() invalid arg\n");
...
void exsltCommonRegister(void)
{
    ...
    xsltRegisterExtModuleElement((const xmlChar*)"document", EXSLT_COMMON_NAMESPACE, xsltDocumentComp, xsltDocumentElem);
}
