...
struct test_input_t {
    ...
    { "perf/fonts/NotoNastaliqUrdu-Regular.ttf", "perf/texts/fa-thelittleprince.txt", false },

    { "perf/fonts/Amiri-Regular.ttf", "perf/texts/fa-thelittleprince.txt", false },

    { "perf/fonts/Roboto-Regular.ttf", "perf/texts/en-thelittleprince.txt", false },

    { "perf/fonts/Roboto-Regular.ttf", "perf/texts/en-words.txt", false },

    { SUBSET_FONT_BASE_PATH "SourceSerifVariable-Roman.ttf", "perf/texts/en-thelittleprince.txt", true },
};
...
static void BM_Shape(benchmark::State& state, bool is_var, backend_t backend, const test_input_t& input)
{
    hb_font_t* font;
    {
...
static void test_backend(backend_t backend, const char* backend_name, bool variable, const test_input_t& test_input)
{
    ...
    benchmark::RegisterBenchmark(name, BM_Shape, variable, backend, test_input)->Unit(benchmark::kMillisecond);
}
