 ...
 **/
static inline bool hb_ot_tags_from_complex_language(const char* lang_str, const char* limit, unsigned int* count /* IN/OUT */, hb_tag_t* tags /* OUT */)
{
    if (limit - lang_str >= 7) {
        const char* p = strchr(lang_str, '-');
        if (!p || p >= limit || limit - p < 5)
            goto out;
...
out:
    ...
    case 'c':
        ...
        if (0 == strncmp(&lang_str[1], "do-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Min Dong Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "do-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "do-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Min Dong Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "jy-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Jinyu Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "jy-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
            /* Jinyu Chinese; Macao */
            unsigned int i;
            hb_tag_t possible_tags[] = {
                HB_TAG('Z', 'H', 'T', 'M'), /* Chinese, Traditional, Macao SAR */
        ...
        if (0 == strncmp(&lang_str[1], "jy-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Jinyu Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "mn-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Mandarin Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "mn-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "mn-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Mandarin Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "np-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Northern Ping Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "np-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "np-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Northern Ping Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "px-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Pu-Xian Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "px-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "px-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Pu-Xian Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "sp-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Southern Ping Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "sp-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "sp-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Southern Ping Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "zh-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Huizhou Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "zh-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "zh-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Huizhou Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "zo-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Min Zhong Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "zo-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "zo-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
    ...
    case 'g':
        ...
        if (0 == strncmp(&lang_str[1], "an-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Gan Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "an-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
            /* Gan Chinese; Macao */
            unsigned int i;
            hb_tag_t possible_tags[] = {
                HB_TAG('Z', 'H', 'T', 'M'), /* Chinese, Traditional, Macao SAR */
        ...
        if (0 == strncmp(&lang_str[1], "an-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
    ...
    case 'h':
        ...
        if (0 == strncmp(&lang_str[1], "ak-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Hakka Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "ak-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
            /* Hakka Chinese; Macao */
            unsigned int i;
            hb_tag_t possible_tags[] = {
                HB_TAG('Z', 'H', 'T', 'M'), /* Chinese, Traditional, Macao SAR */
        ...
        if (0 == strncmp(&lang_str[1], "ak-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
            /* Hakka Chinese; Taiwan, Province of China */
            tags[0] = HB_TAG('Z', 'H', 'T', ' '); /* Chinese, Traditional */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "sn-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Xiang Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "sn-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
            /* Xiang Chinese; Macao */
            unsigned int i;
            hb_tag_t possible_tags[] = {
                HB_TAG('Z', 'H', 'T', 'M'), /* Chinese, Traditional, Macao SAR */
        ...
        if (0 == strncmp(&lang_str[1], "sn-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
    ...
    case 'm':
        ...
        if (0 == strncmp(&lang_str[1], "nw-", 3) && subtag_matches(lang_str, limit, "-th", 3)) {
            /* Mon; Thailand */
    ...
    case 'n':
        ...
        break;
    case 'r':
        if (0 == strncmp(&lang_str[1], "o-", 2) && subtag_matches(lang_str, limit, "-md", 3)) {
            /* Romanian; Moldova */
            unsigned int i;
            hb_tag_t possible_tags[] = {
    ...
    case 'w':
        ...
        if (0 == strncmp(&lang_str[1], "uu-", 3) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Wu Chinese; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "uu-", 3) && subtag_matches(lang_str, limit, "-mo", 3)) {
            /* Wu Chinese; Macao */
            unsigned int i;
            hb_tag_t possible_tags[] = {
                HB_TAG('Z', 'H', 'T', 'M'), /* Chinese, Traditional, Macao SAR */
        ...
        if (0 == strncmp(&lang_str[1], "uu-", 3) && subtag_matches(lang_str, limit, "-tw", 3)) {
    ...
    case 'z':
        ...
        if (0 == strncmp(&lang_str[1], "h-", 2) && subtag_matches(lang_str, limit, "-hk", 3)) {
            /* Chinese [macrolanguage]; Hong Kong */
            tags[0] = HB_TAG('Z', 'H', 'H', ' '); /* Chinese, Traditional, Hong Kong SAR */
            *count = 1;
            return true;
        }
        if (0 == strncmp(&lang_str[1], "h-", 2) && subtag_matches(lang_str, limit, "-mo", 3)) {
        ...
        if (0 == strncmp(&lang_str[1], "h-", 2) && subtag_matches(lang_str, limit, "-tw", 3)) {
 ...
 **/
static inline hb_language_t hb_ot_ambiguous_tag_to_language(hb_tag_t tag)
{
    switch (tag) {
