...
static void propagate_attachment_offsets(
    hb_glyph_position_t* pos, unsigned int len, unsigned int i, hb_direction_t direction, unsigned nesting_level = HB_MAX_NESTING_LEVEL);
...
static void propagate_attachment_offsets(hb_glyph_position_t* pos, unsigned int len, unsigned int i, hb_direction_t direction, unsigned nesting_level)
{
...
void GPOS::position_finish_offsets(hb_font_t* font, hb_buffer_t* buffer)
{
    _hb_buffer_assert_gsubgpos_vars(buffer);
...
struct GPOS_accelerator_t : Layout::GPOS::accelerator_t {
    GPOS_accelerator_t(hb_face_t* face)
        : Layout::GPOS::accelerator_t(face)
    {
    }
};
