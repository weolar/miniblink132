...
public:
    ...
    WebScopedVirtualTimePauser(scheduler::ThreadSchedulerBase*, VirtualTaskDuration, const WebString& debug_name);
    ...
    WebScopedVirtualTimePauser& operator=(const WebScopedVirtualTimePauser&) = delete;
...
private:
    ...
    raw_ptr<scheduler::ThreadSchedulerBase, DanglingUntriaged> scheduler_; // NOT OWNED
