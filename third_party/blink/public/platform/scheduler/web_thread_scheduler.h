...
class BLINK_PLATFORM_EXPORT WebThreadScheduler : public IPC::UrgentMessageObserver {
public:
    ...
    // base::MessageLoop.
    static std::unique_ptr<WebThreadScheduler> CreateMainThreadScheduler(std::unique_ptr<base::MessagePump> message_pump = nullptr);
    ...
    virtual scoped_refptr<base::SingleThreadTaskRunner> DeprecatedDefaultTaskRunner();
    ...
    // main thread.
    virtual std::unique_ptr<WebAgentGroupScheduler> CreateWebAgentGroupScheduler() = 0;
