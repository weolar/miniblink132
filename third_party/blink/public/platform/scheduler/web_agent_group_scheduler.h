...
class BLINK_PLATFORM_EXPORT WebAgentGroupScheduler : public IPC::UrgentMessageObserver {
public:
    // Create a dummy AgentGroupScheduler only for testing
    static std::unique_ptr<blink::scheduler::WebAgentGroupScheduler> CreateForTesting();
