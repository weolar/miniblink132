...
public:
    ...
    MOCK_METHOD0(DefaultTaskRunner, scoped_refptr<base::SingleThreadTaskRunner>());
    MOCK_METHOD0(DeprecatedDefaultTaskRunner, scoped_refptr<base::SingleThreadTaskRunner>());
    ...
    MOCK_METHOD0(CreateWebAgentGroupScheduler, std::unique_ptr<WebAgentGroupScheduler>());
