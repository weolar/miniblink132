...
// methods.
std::unique_ptr<WebMockThreadScheduler> CreateMockWebMainThreadSchedulerForTests();
...
scoped_refptr<base::SingleThreadTaskRunner> GetSingleThreadTaskRunnerForTesting();
