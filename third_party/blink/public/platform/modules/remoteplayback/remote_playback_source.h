...
inline constexpr char kRemotePlaybackPresentationUrlScheme[] = "remote-playback";
...
inline constexpr char kRemotePlaybackPresentationUrlPath[] = "remote-playback:media-element";

// The format for RemotePlayback Urls on desktop.
inline constexpr char kRemotePlaybackDesktopUrlFormat[] = "remote-playback:media-session?video_codec=%s&audio_codec=%s&tab_id=%d";
