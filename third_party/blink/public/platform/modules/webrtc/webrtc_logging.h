...
BLINK_PLATFORM_EXPORT void InitWebRtcLoggingDelegate(WebRtcLogMessageDelegate* delegate);
...
PRINTF_FORMAT(3, 4)
void BLINK_PLATFORM_EXPORT WebRtcLog(const char* prefix, void* thiz, const char* format, ...);
} // namespace blink
