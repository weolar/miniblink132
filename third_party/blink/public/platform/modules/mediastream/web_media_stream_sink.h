...
public:
    ...
    virtual void OnContentHintChanged(WebMediaStreamTrack::ContentHintType content_hint)
    {
    }
    ...
    // to a video track.
    virtual void OnVideoConstraintsChanged(std::optional<double> min_fps, std::optional<double> max_fps)
    {
    }
