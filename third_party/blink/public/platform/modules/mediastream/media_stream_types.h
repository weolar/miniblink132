...
using VideoTrackSettingsCallback = base::RepeatingCallback<void(gfx::Size frame_size, double frame_rate)>;

using VideoTrackFormatCallback = base::RepeatingCallback<void(const media::VideoCaptureFormat&)>;
