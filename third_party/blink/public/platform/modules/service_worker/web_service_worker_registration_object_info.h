...
struct WebServiceWorkerRegistrationObjectInfo {
    WebServiceWorkerRegistrationObjectInfo(int64_t registration_id, WebURL scope, mojom::ServiceWorkerUpdateViaCache update_via_cache,
        CrossVariantMojoAssociatedRemote<mojom::ServiceWorkerRegistrationObjectHostInterfaceBase> host_remote,
        CrossVariantMojoAssociatedReceiver<mojom::ServiceWorkerRegistrationObjectInterfaceBase> receiver, WebServiceWorkerObjectInfo installing,
        WebServiceWorkerObjectInfo waiting, WebServiceWorkerObjectInfo active)
    ...
    WebServiceWorkerRegistrationObjectInfo(WebServiceWorkerRegistrationObjectInfo&& other) = default;

    WebServiceWorkerRegistrationObjectInfo(const WebServiceWorkerRegistrationObjectInfo&) = delete;
    WebServiceWorkerRegistrationObjectInfo& operator=(const WebServiceWorkerRegistrationObjectInfo&) = delete;
    ...
    CrossVariantMojoAssociatedRemote<mojom::ServiceWorkerRegistrationObjectHostInterfaceBase> host_remote;
    CrossVariantMojoAssociatedReceiver<mojom::ServiceWorkerRegistrationObjectInterfaceBase> receiver;
