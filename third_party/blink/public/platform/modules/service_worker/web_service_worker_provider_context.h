...
public:
    ...
    virtual void BindServiceWorkerWorkerClientRemote(CrossVariantMojoRemote<mojom::ServiceWorkerWorkerClientInterfaceBase> pending_client) = 0;

    // Binds a new ServiceWorkerWorkerClientRegistry endpoint.
    virtual void BindServiceWorkerWorkerClientRegistryReceiver(CrossVariantMojoReceiver<mojom::ServiceWorkerWorkerClientRegistryInterfaceBase> receiver) = 0;
    ...
    // destroyed soon).
    virtual CrossVariantMojoRemote<mojom::ServiceWorkerContainerHostInterfaceBase> CloneRemoteContainerHost() = 0;

    virtual mojom::ControllerServiceWorkerMode GetControllerServiceWorkerMode() const = 0;
    virtual mojom::ServiceWorkerFetchHandlerType GetFetchHandlerType() const = 0;
    virtual mojom::ServiceWorkerFetchHandlerBypassOption GetFetchHandlerBypassOption() const = 0;
