...
struct WebServiceWorkerObjectInfo {
    WebServiceWorkerObjectInfo(int64_t version_id, mojom::ServiceWorkerState state, WebURL url,
        CrossVariantMojoAssociatedRemote<mojom::ServiceWorkerObjectHostInterfaceBase> host_remote,
        CrossVariantMojoAssociatedReceiver<mojom::ServiceWorkerObjectInterfaceBase> receiver)
    ...
    WebServiceWorkerObjectInfo& operator=(const WebServiceWorkerObjectInfo&) = delete;
