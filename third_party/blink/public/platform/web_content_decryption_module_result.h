...
public:
    ...
    void CompleteWithContentDecryptionModule(std::unique_ptr<WebContentDecryptionModule>);
    ...
    void CompleteWithError(WebContentDecryptionModuleException, uint32_t system_code, const WebString& message);
...
private:
    ...
    WebPrivatePtrForGC<ContentDecryptionModuleResult, WebPrivatePtrDestruction::kCrossThread> impl_;
};
