...
class BLINK_PLATFORM_EXPORT WeakWrapperResourceLoadInfoNotifier : public blink::mojom::ResourceLoadInfoNotifier {
public:
    explicit WeakWrapperResourceLoadInfoNotifier(blink::mojom::ResourceLoadInfoNotifier* resource_load_info_notifier);
    ...
    void NotifyResourceResponseReceived(int64_t request_id, const url::SchemeHostPort& final_response_url, network::mojom::URLResponseHeadPtr response_head,
    ...
    void Clone(mojo::PendingReceiver<blink::mojom::ResourceLoadInfoNotifier> pending_resource_load_info_notifier) override;
