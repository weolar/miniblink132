...
struct WebPolicyContainerPolicies {
    network::mojom::CrossOriginEmbedderPolicyValue cross_origin_embedder_policy = network::mojom::CrossOriginEmbedderPolicyValue::kNone;
    ...
    network::mojom::WebSandboxFlags sandbox_flags = network::mojom::WebSandboxFlags::kNone;
...
struct WebPolicyContainer {
    ...
    WebPolicyContainer(WebPolicyContainerPolicies policies, CrossVariantMojoAssociatedRemote<mojom::PolicyContainerHostInterfaceBase> remote)
    ...
    CrossVariantMojoAssociatedRemote<mojom::PolicyContainerHostInterfaceBase> remote;
};

struct WebPolicyContainerBindParams {
    CrossVariantMojoAssociatedReceiver<mojom::PolicyContainerHostInterfaceBase> receiver;
};
