...
public:
    ...
    virtual std::unique_ptr<WebSocketHandshakeThrottleProvider> Clone(scoped_refptr<base::SingleThreadTaskRunner> task_runner) = 0;
    ...
    virtual std::unique_ptr<blink::WebSocketHandshakeThrottle> CreateThrottle(
        base::optional_ref<const LocalFrameToken> local_frame_token, scoped_refptr<base::SingleThreadTaskRunner> task_runner)
        = 0;
};
