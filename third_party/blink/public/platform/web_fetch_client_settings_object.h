...
struct WebFetchClientSettingsObject {
    ...
    mojom::InsecureRequestsPolicy insecure_requests_policy = blink::mojom::InsecureRequestsPolicy::kDoNotUpgrade;

    WebFetchClientSettingsObject(
        network::mojom::ReferrerPolicy referrer_policy, WebURL outgoing_referrer, mojom::InsecureRequestsPolicy insecure_requests_policy)
        ...
        outgoing_referrer(outgoing_referrer.IsEmpty() ? WebURL() : outgoing_referrer)
        , insecure_requests_policy(insecure_requests_policy)
    {
    }

#if INSIDE_BLINK
    explicit WebFetchClientSettingsObject(const FetchClientSettingsObject& settings_object)
        ...
        outgoing_referrer(settings_object.GetOutgoingReferrer().empty() ? KURL() : KURL(settings_object.GetOutgoingReferrer()))
        , insecure_requests_policy((settings_object.GetInsecureRequestsPolicy() & blink::mojom::InsecureRequestPolicy::kUpgradeInsecureRequests)
