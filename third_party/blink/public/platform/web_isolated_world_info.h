...
BLINK_EXPORT void SetIsolatedWorldInfo(int32_t world_id, const WebIsolatedWorldInfo& info);
...
BLINK_EXPORT WebString GetIsolatedWorldHumanReadableName(v8::Local<v8::Context>);
