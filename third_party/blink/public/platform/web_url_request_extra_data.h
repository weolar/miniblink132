...
class BLINK_PLATFORM_EXPORT WebURLRequestExtraData : public base::RefCounted<WebURLRequestExtraData> {
public:
    ...
    bool is_for_no_state_prefetch() const
    {
        return is_for_no_state_prefetch_;
    }
    ...
    // agent.
    const WebString& custom_user_agent() const
    {
