...
public:
    ...
    static WebFrameWidget* CreateTestWebFrameWidget(base::PassKey<WebLocalFrame>,
        ...
        bool is_for_child_local_root, bool is_for_nested_main_frame, bool is_for_scalable_page, content::TestRunner* test_runner);
    ...
    virtual void UpdateAllLifecyclePhasesAndComposite(base::OnceClosure completion_callback) = 0;
};
