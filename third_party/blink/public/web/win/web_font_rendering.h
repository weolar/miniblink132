...
public:
    ...
    static void SetMenuFontMetrics(const WebString& family_name, int32_t font_height);
    static void SetSmallCaptionFontMetrics(const WebString& family_name, int32_t font_height);
    static void SetStatusFontMetrics(const WebString& family_name, int32_t font_height);
