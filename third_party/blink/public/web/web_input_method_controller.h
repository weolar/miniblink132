...
public:
    ...
    virtual bool FinishComposingText(ConfirmCompositionBehavior selection_behavior) = 0;
    ...
    virtual int ComputeWebTextInputNextPreviousFlags()
    {
        return 0;
    }
    ...
    // "marked range."
    virtual WebRange CompositionRange() const
    {
        return WebRange();
    }
    ...
    virtual void GetLayoutBounds(gfx::Rect* control_bounds, gfx::Rect* selection_bounds) = 0;
    ...
    virtual ui::mojom::VirtualKeyboardVisibilityRequest GetLastVirtualKeyboardVisibilityRequest() const = 0;
    // Sets the VirtualKeyboard visibility request(show/hide/none).
    virtual void SetVirtualKeyboardVisibilityRequest(ui::mojom::VirtualKeyboardVisibilityRequest vk_visibility_request) = 0;
};
