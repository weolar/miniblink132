...
public:
    ...
    static void EnableMojoJSAndUseBroker(v8::Local<v8::Context> context, CrossVariantMojoRemote<mojom::BrowserInterfaceBrokerInterfaceBase> broker_remote);
    ...
    static void EnableMojoJSWithoutSecurityChecksForTesting(v8::Local<v8::Context>);
