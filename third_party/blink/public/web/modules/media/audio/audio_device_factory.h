...
public:
    ...
    static media::AudioLatency::Type GetSourceLatencyType(WebAudioDeviceSourceType source);
    ...
    virtual scoped_refptr<media::AudioRendererSink> NewAudioRendererSink(
        WebAudioDeviceSourceType source_type, const LocalFrameToken& frame_token, const media::AudioSinkParameters& params);
    ...
    virtual scoped_refptr<media::SwitchableAudioRendererSink> NewMixableSink(blink::WebAudioDeviceSourceType source_type,
    ...
    virtual media::OutputDeviceInfo GetOutputDeviceInfo(const LocalFrameToken& frame_token, const std::string& device_id);
    ...
    // consuming the audio.
    virtual scoped_refptr<media::AudioCapturerSource> NewAudioCapturerSource(WebLocalFrame* web_frame, const media::AudioSourceParameters& params);
