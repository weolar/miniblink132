...
public:
    ...
    static std::unique_ptr<media::AudioInputIPC> CreateAudioInputIPC(const blink::LocalFrameToken& frame_token,
        scoped_refptr<base::SequencedTaskRunner> main_task_runner, const media::AudioSourceParameters& source_params);
