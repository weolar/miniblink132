...
public:
    ...
    WebPerformanceMetricsForNestedContexts(const WebPerformanceMetricsForNestedContexts& p)
    {
        Assign(p);
    }

    WebPerformanceMetricsForNestedContexts& operator=(const WebPerformanceMetricsForNestedContexts& p)
    {
        Assign(p);
        return *this;
    }
