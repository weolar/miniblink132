...
public:
    ...
    static WebRemoteFrame* Create(mojom::TreeScopeType, const RemoteFrameToken& frame_token);

    static WebRemoteFrame* CreateMainFrame(WebView*, const RemoteFrameToken& frame_token, bool is_loading, const base::UnguessableToken& devtools_frame_token,
        WebFrame* opener, CrossVariantMojoAssociatedRemote<mojom::RemoteFrameHostInterfaceBase> remote_frame_host,
        CrossVariantMojoAssociatedReceiver<mojom::RemoteFrameInterfaceBase> receiver, mojom::FrameReplicationStatePtr replicated_state);
    ...
    // beginning.
    virtual WebLocalFrame* CreateLocalChild(mojom::TreeScopeType, const WebString& name, const FramePolicy&, WebLocalFrameClient*, InterfaceRegistry*,
        ...
        CrossVariantMojoRemote<mojom::BrowserInterfaceBrokerInterfaceBase>, std::unique_ptr<WebPolicyContainer> policy_container)
        = 0;
    ...
    virtual void SetReplicatedOrigin(const WebSecurityOrigin&, bool is_potentially_trustworthy_opaque_origin) = 0;
    ...
    virtual const FrameVisualProperties& GetPendingVisualPropertiesForTesting() const = 0;
...
protected:
    explicit WebRemoteFrame(mojom::TreeScopeType scope, const RemoteFrameToken& frame_token)
