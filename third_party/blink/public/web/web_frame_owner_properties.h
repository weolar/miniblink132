...
#if INSIDE_BLINK
    WebFrameOwnerProperties(const WebString& name, mojom::ScrollbarMode scrollbar_mode, int margin_width, int margin_height, bool allow_fullscreen,
        bool allow_payment_request, bool is_display_none, mojom::ColorScheme color_scheme, mojom::PreferredColorScheme preferred_color_scheme)
        : name(name)
