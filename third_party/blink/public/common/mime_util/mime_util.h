...
bool BLINK_COMMON_EXPORT IsSupportedNonImageMimeType(std::string_view mime_type);
bool BLINK_COMMON_EXPORT IsUnsupportedTextMimeType(std::string_view mime_type);
bool BLINK_COMMON_EXPORT IsSupportedJavascriptMimeType(std::string_view mime_type);
