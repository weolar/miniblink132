...
class COMPONENT_EXPORT(PRIVACY_BUDGET_TEST_SUPPORT) ScopedSwitchSampleCollector {
public:
    ...
    explicit ScopedSwitchSampleCollector(IdentifiabilitySampleCollector* replacement);
