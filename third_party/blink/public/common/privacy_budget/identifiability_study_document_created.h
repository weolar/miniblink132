...
public:
    ...
    IdentifiabilityStudyDocumentCreated& SetNavigationSourceId(ukm::SourceId navigation_source_id);

    IdentifiabilityStudyDocumentCreated& SetIsMainFrame(bool is_main_frame);

    IdentifiabilityStudyDocumentCreated& SetIsCrossOriginFrame(bool is_cross_origin_frame);

    IdentifiabilityStudyDocumentCreated& SetIsCrossSiteFrame(bool is_cross_site_frame);
