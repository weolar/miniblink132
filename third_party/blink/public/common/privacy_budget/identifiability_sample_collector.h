...
public:
    ...
    virtual void Record(ukm::UkmRecorder* recorder, ukm::SourceId source, std::vector<IdentifiableSample> metrics) = 0;
    ...
    virtual void FlushSource(ukm::UkmRecorder* recorder, ukm::SourceId source) = 0;
};
