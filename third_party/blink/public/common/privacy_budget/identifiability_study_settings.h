...
public:
    ...
    explicit IdentifiabilityStudySettings(std::unique_ptr<IdentifiabilityStudySettingsProvider> provider);
    ...
    static void SetGlobalProvider(std::unique_ptr<IdentifiabilityStudySettingsProvider> provider);
    ...
    bool ShouldSampleAnyType(std::initializer_list<IdentifiableSurface::Type> types) const;
    ...
    IdentifiabilityStudySettings& operator=(const IdentifiabilityStudySettings&) = delete;
