...
public:
    ...
    IdentifiabilityStudyWorkerClientAdded& SetClientSourceId(ukm::SourceId client_source_id);

    IdentifiabilityStudyWorkerClientAdded& SetWorkerType(blink::IdentifiableSurface::WorkerType worker_type);
