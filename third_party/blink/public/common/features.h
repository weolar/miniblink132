...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kAdAuctionSignalsMaxSizeBytes);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kAdInterestGroupAPIRestrictedPolicyByDefault);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kAllowDevToolsMainThreadDebuggerForMultipleMainFrames);

// Enables rate obfuscation mitigation in compute pressure, to prevent
// cross-channel attacks.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kComputePressureRateObfuscationMitigation);

// Feature for allowing page into back/forward cache when datapipe has been
// drained as bytes consumer for fetch requests.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kAllowDatapipeDrainedAsBytesConsumerInBFCache);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kDisplayWarningDeprecateURNIframesUseFencedFrames);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kAutofillFixFieldsAssociatedWithNestedFormsByParser);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kAutoSpeculationRulesHoldback);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kAvoidForcedLayoutOnInitialEmptyDocumentInSubframe);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kBackForwardCacheDWCOnJavaScriptExecution);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kBackgroundFontResponseProcessor);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kBackgroundScriptResponseProcessor);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kBackgroundCodeCacheDecoderStart);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kBackgroundTracingPerformanceMark_AllowList);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kBlinkSchedulerDiscreteInputMatchesResponsivenessMetrics);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kThreadedScrollPreventRenderingStarvation);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBoostImagePriorityImageCount);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBoostImagePriorityImageSize);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBoostImagePriorityTightMediumLimit);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kBoostRenderBlockingStyleLoadingTaskPriority);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kBoostNonRenderBlockingStyleLoadingTaskPriority);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kBrowsingTopics);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kBrowsingTopicsBypassIPIsPubliclyRoutableCheck);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kBrowsingTopicsTimePeriodPerEpoch);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsNumberOfEpochsToExpose);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsNumberOfTopTopicsPerEpoch);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsUseRandomTopicProbabilityPercent);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kBrowsingTopicsMaxEpochIntroductionDelay);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kBrowsingTopicsEpochRetentionDuration);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kBrowsingTopicsMaxEpochPhaseOutTimeOffset);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsNumberOfEpochsOfObservationDataToUseForFiltering);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsMaxNumberOfApiUsageContextDomainsToKeepPerTopic);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsMaxNumberOfApiUsageContextEntriesToLoadPerEpoch);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsMaxNumberOfApiUsageContextDomainsToStorePerPageLoad);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kBrowsingTopicsTaxonomyVersion);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kBrowsingTopicsDisabledTopicsList);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kBrowsingTopicsPrioritizedTopicsList);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kBrowsingTopicsFirstTimeoutRetryDelay);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kCacheStorageCodeCacheHintHeaderName);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kCacheCodeOnIdleDelayServiceWorkerOnlyParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kCanvas2DHibernationReleaseTransferMemory);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kMaxDiskDataAllocatorCapacityMB);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(TaskDeferralPolicy, kTaskDeferralPolicyParam);
// Constants to expose the policy in about:flags.
BLINK_COMMON_EXPORT extern const char kDeferRendererTasksAfterInputPolicyParamName[];
BLINK_COMMON_EXPORT extern const char kDeferRendererTasksAfterInputMinimalTypesPolicyName[];
BLINK_COMMON_EXPORT extern const char kDeferRendererTasksAfterInputNonUserBlockingDeferrableTypesPolicyName[];
BLINK_COMMON_EXPORT extern const char kDeferRendererTasksAfterInputNonUserBlockingTypesPolicyName[];
BLINK_COMMON_EXPORT extern const char kDeferRendererTasksAfterInputAllDeferrableTypesPolicyName[];
BLINK_COMMON_EXPORT extern const char kDeferRendererTasksAfterInputAllTypesPolicyName[];
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(DelayAsyncScriptDelayType, kDelayAsyncScriptExecutionDelayParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(DelayAsyncScriptTarget, kDelayAsyncScriptTargetParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kDelayAsyncScriptExecutionDelayLimitParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kDelayAsyncScriptExecutionFeatureLimitParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kDelayAsyncScriptExecutionMainFrameOnlyParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kDelayAsyncScriptExecutionWhenLcpFoundInHtml);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kDelayAsyncScriptExecutionDelayByDefaultParam);
enum class AsyncScriptExperimentalSchedulingTarget {
    kAds,
    kNonAds,
    kBoth,
};
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(AsyncScriptExperimentalSchedulingTarget, kDelayAsyncScriptExecutionTargetParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kDelayAsyncScriptExecutionOptOutLowFetchPriorityHintParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kDelayAsyncScriptExecutionOptOutAutoFetchPriorityHintParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kDelayAsyncScriptExecutionOptOutHighFetchPriorityHintParam);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kDelayLayerTreeViewDeletionOnLocalSwap);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kDelayLayerTreeViewDeletionOnLocalSwapTaskDelayParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kDisableArrayBufferSizeLimitsForTesting);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kDisableThirdPartyStoragePartitioningDeprecationTrial2);
...
// quietly discarded.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kDiscardInputEventsToRecentlyMovedFrames);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kDeprecateUnloadAllowlist);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kCullRectPixelDistanceToExpand);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kCullRectExpansionDPRCoef);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kSmallScrollersUseMinCullRect);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFencedFrames);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFencedFramesCrossOriginEventReporting);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFencedFramesAutomaticBeaconCredentials);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kExemptUrlFromNetworkRevocationForTesting);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFileSystemUrlNavigationForChromeAppsOnly);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kFilteringScrollPredictionFilterParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kFledgeBiddingAndAuctionKeyURL);
// JSON config specifying supported coordinator origins and their public key
// URLs.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kFledgeBiddingAndAuctionKeyConfig);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kFledgeDebugReportLockout);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kFledgeDebugReportRestrictedCooldown);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kFledgeDebugReportShortCooldown);
// Gives a 1/(kFledgeDebugReportSamplingRandomMax+1) chance of allowing sending
// forDebuggingOnly reports.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kFledgeDebugReportSamplingRandomMax);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kFledgeDebugReportSamplingRestrictedCooldownRandomMax);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kFledgeEnableFilteringDebugReportStartingFrom);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kFledgeCustomMaxAuctionAdComponentsValue);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFledgeNumberBidderWorkletGroupByOriginContextsToKeep);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kFledgeNumberBidderWorkletGroupByOriginContextsToKeepValue);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kFledgeRealTimeReportingEpsilon);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kFledgeRealTimeReportingNumBuckets);
// The priorityWeight of FLEDGE real time reporting's platform contributions.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kFledgeRealTimeReportingPlatformContributionPriority);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kFledgeRealTimeReportingWindow);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kFledgeRealTimeReportingMaxReports);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFledgeEnforcePermissionPolicyContributeOnEvent);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(ForceDarkInversionMethod, kForceDarkInversionMethodParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(ForceDarkImageBehavior, kForceDarkImageBehaviorParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kForceDarkForegroundLightnessThresholdParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kForceDarkBackgroundLightnessThresholdParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(ForceDarkImageClassifier, kForceDarkImageClassifierParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFrequencyCappingForLargeStickyAdDetection);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kFrequencyCappingForOverlayPopupDetection);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kGMSCoreEmoji);

#if !BUILDFLAG(IS_ANDROID) && !BUILDFLAG(IS_CHROMEOS) && !BUILDFLAG(IS_FUCHSIA)
// Defers device selection until after permission is granted.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kGetUserMediaDeferredDeviceSettingsSelection);
#endif
...
BLINK_COMMON_EXPORT extern const base::FeatureParam<int> kIndexedDBCompressValuesWithSnappyCompressionThreshold;
...
BLINK_COMMON_EXPORT extern const char kIntensiveWakeUpThrottling_GracePeriodSeconds_Name[];
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kInterestGroupStorageMaxOwners);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kInterestGroupStorageMaxStoragePerOwner);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kInterestGroupStorageMaxGroupsPerOwner);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kInterestGroupStorageMaxNegativeGroupsPerOwner);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kInterestGroupStorageMaxOpsBeforeMaintenance);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(IsolateSandboxedIframesGrouping, kIsolateSandboxedIframesGroupingParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kAttributionReportingInBrowserMigration);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLCPCriticalPathAdjustImageLoadPriority);

// The maximum element locator length for LCPP.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kLCPCriticalPathPredictorMaxElementLocatorLength);

// If true, LCP critical path predictor mechanism overrides the first N image
// prioritization when there is LCP hint.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLCPCriticalPathAdjustImageLoadPriorityOverrideFirstNBoost);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppRecordedLcpElementTypes, kLCPCriticalPathPredictorRecordedLcpElementTypes);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppResourceLoadPriority, kLCPCriticalPathPredictorImageLoadPriority);

// Enable ResourceLoadPriority changes for all HTMLImageElement loaded images.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLCPCriticalPathPredictorImageLoadPriorityEnabledForHTMLImageElement);

// Size of LRU caches for the host data for LCP critical path predictor (LCPP).
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLCPCriticalPathPredictorMaxHostsToTrack);

// The virtual sliding window size for LCP critical path predictor (LCPP)
// histogram.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLCPCriticalPathPredictorHistogramSlidingWindowSize);

// The max histogram bucket count that can be stored in the LCP critical path
// predictor (LCPP) database.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLCPCriticalPathPredictorMaxHistogramBuckets);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppResourceLoadPriority, kLCPScriptObserverScriptLoadPriority);

// The ResourceLoadPriority for images that are expected to LCP elements.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppResourceLoadPriority, kLCPScriptObserverImageLoadPriority);

// The maximum URL count for LCPP.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kLCPScriptObserverMaxUrlCountPerOrigin);

// The maximum URL length allowed for LCPP.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kLCPScriptObserverMaxUrlLength);

// Enable ResourceLoadPriority changes for all HTMLImageElement loaded images.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLCPScriptObserverAdjustImageLoadPriority);
...
// threshold.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kLCPPAutoPreconnectFrequencyThreshold);

// The maximum number of origins to be preconnected
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kkLCPPAutoPreconnectMaxPreconnectOriginsCount);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppDeferUnusedPreloadExcludedResourceType, kLcppDeferUnusedPreloadExcludedResourceType);

// Unused preload requests are deferred if frequencies are above this threshold.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kLCPPDeferUnusedPreloadFrequencyThreshold);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppDeferUnusedPreloadPreloadedReason, kLcppDeferUnusedPreloadPreloadedReason);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppDeferUnusedPreloadTiming, kLcppDeferUnusedPreloadTiming);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kLCPPFontURLPredictorMaxUrlLength);

// The maximum URL count allowed for LCPP font URL predictor.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kLCPPFontURLPredictorMaxUrlCountPerOrigin);

// Fonts are preloaded if frequencies are above this threshold.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kLCPPFontURLPredictorFrequencyThreshold);

// The maximum number of Fonts to be sent for preload.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLCPPFontURLPredictorMaxPreloadCount);

// Enables prefetch using the LCPP font URL predictor.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLCPPFontURLPredictorEnablePrefetch);

// Enables prefetch/preload if upper limit bandwidth for the network is
// larger than this value.
// The value <=0 is used for disabling the feature.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kLCPPFontURLPredictorThresholdInMbps);
...
BLINK_COMMON_EXPORT extern const base::FeatureParam<std::string> kLCPPFontURLPredictorExcludedHosts;

// Enables cross site font prefetch/preload.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLCPPCrossSiteFontPredictionAllowed);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLcppInitiatorOriginHistogramSlidingWindowSize);

// The max histogram bucket count that can be stored in the LCP critical path
// predictor (LCPP) database for kLCPPInitiatorOrigin option.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLcppInitiatorOriginMaxHistogramBuckets);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kLCPPLazyLoadImagePreload);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLCPPLazyLoadImagePreloadDryRun);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppPreloadLazyLoadImageType, kLCPCriticalPathPredictorPreloadLazyLoadImageType);
...
// Note: Declared without BASE_DECLARE_FEATURE_PARAM because the production code
// gets this value only once.
BLINK_COMMON_EXPORT extern const base::FeatureParam<std::string> kPreloadSystemFontsTargets;

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kPreloadSystemFontsRequiredMemoryGB);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kLCPPMultipleKeyMaxPathLength);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LcppMultipleKeyTypes, kLcppMultipleKeyType);

// The virtual sliding window size for LCP critical path predictor (LCPP)
// histogram for LcppMultipleKeyTypes::kLcppKeyStat option.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLcppMultipleKeyHistogramSlidingWindowSize);

// The max histogram bucket count that can be stored in the LCP critical path
// predictor (LCPP) database for LcppMultipleKeyTypes::kLcppKeyStat option.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLcppMultipleKeyMaxHistogramBuckets);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kHttpDiskCachePrewarmingMaxUrlLength);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kHttpDiskCachePrewarmingHistorySize);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kHttpDiskCachePrewarmingReprewarmPeriod);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kHttpDiskCachePrewarmingTriggerOnNavigation);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kHttpDiskCachePrewarmingTriggerOnPointerDownOrHover);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kHttpDiskCachePrewarmingUseReadAndDiscardBodyOption);

// If true, avoid prewarming HttpDiskCache during the browser startup.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kHttpDiskCachePrewarmingSkipDuringBrowserStartup);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(LinkPreviewTriggerType, kLinkPreviewTriggerType);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kLoadingTasksUnfreezable);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kLoadingPhaseBufferTimeAfterFirstMeaningfulPaint);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kLogUnexpectedIPCPostedToBackForwardCachedDocuments);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kTimeoutForLowPriorityAsyncScriptExecution);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kLowPriorityAsyncScriptExecutionFeatureLimitParam);
// kLowPriorityAsyncScriptExecution will be applied only for cross site scripts.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionCrossSiteOnlyParam);
// kLowPriorityAsyncScriptExecution will be applied only for main frame's
// scripts.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionMainFrameOnlyParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionExcludeLcpInfluencersParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionDisableWhenLcpNotInHtmlParam);
enum class AsyncScriptPrioritisationType {
    kHigh,
    kLow,
    kBestEffort,
};
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(AsyncScriptPrioritisationType, kLowPriorityAsyncScriptExecutionLowerTaskPriorityParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(AsyncScriptExperimentalSchedulingTarget, kLowPriorityAsyncScriptExecutionTargetParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionExcludeNonParserInsertedParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionExcludeDocumentWriteParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionOptOutLowFetchPriorityHintParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionOptOutAutoFetchPriorityHintParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityAsyncScriptExecutionOptOutHighFetchPriorityHintParam);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityScriptLoadingCrossSiteOnlyParam);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kLowPriorityScriptLoadingFeatureLimitParam);
// Note: declared without BASE_DECLARE_FEATURE_PARAM because the production code
// gets this value only once to construct static local instance.
BLINK_COMMON_EXPORT extern const base::FeatureParam<std::string> kLowPriorityScriptLoadingDenyListParam;
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kLowPriorityScriptLoadingMainFrameOnlyParam);
...
// references.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kMemoryCacheStrongReferenceTotalSizeThresholdParam);
// The threshold for the decoded size of a resource that can keep a strong
// reference.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kMemoryCacheStrongReferenceResourceSizeThresholdParam);
// Whether the ResourceFetcher should store strong references too.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kResourceFetcherStoresStrongReferences);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kPredictorTrafficClientEnabledPercent);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kNavigationPredictorNewViewportFeatures);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kPartialLowEndModeExcludeCanvasFontCache);
#endif
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kDedicatedWorkerStartDelayInMs);
...
// are blocked.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPostMessageFirstPartyToThirdPartyDifferentBucketSameOriginBlocked);
// Whether first-party to third-party different-bucket same-origin post messages
// are blocked when storage partitioning is enabled.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPostMessageFirstPartyToThirdPartyDifferentBucketSameOriginBlockedIfStorageIsPartitioned);
// Whether third-party to first-party different-bucket same-origin post messages
// are blocked.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPostMessageThirdPartyToFirstPartyDifferentBucketSameOriginBlocked);
// Whether third-party to first-party different-bucket same-origin post messages
// are blocked when storage partitioning is enabled.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPostMessageThirdPartyToFirstPartyDifferentBucketSameOriginBlockedIfStorageIsPartitioned);
// Whether third-party to third-party different-bucket same-origin post messages
// are blocked.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPostMessageThirdPartyToThirdPartyDifferentBucketSameOriginBlocked);
// Whether third-party to third-party different-bucket same-origin post messages
// are blocked when storage partitioning is enabled.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPostMessageThirdPartyToThirdPartyDifferentBucketSameOriginBlockedIfStorageIsPartitioned);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kPreloadingModelTimerStartDelay);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kPreloadingModelTimerInterval);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kPreloadingModelOneExecutionPerHover);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kPreloadingModelMaxHoverTime);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kPreloadingModelEnactCandidates);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kPreloadingModelPrefetchModerateThreshold);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kPreloadingModelPrerenderModerateThreshold);
...
BLINK_COMMON_EXPORT extern const char kPrerender2MaxNumOfRunningSpeculationRules[];
...
BLINK_COMMON_EXPORT extern const char kPrerender2MemoryAcceptablePercentOfSystemMemoryParamName[];
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPrerender2EarlyDocumentLifecycleUpdate);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(Prerender2WarmUpCompositorTriggerPoint, kPrerender2WarmUpCompositorTriggerPoint);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPreviewsResourceLoadingHintsSpecificResourceTypes);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kPrivateAggregationApiEnabledInSharedStorage);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kPrivateAggregationApiEnabledInProtectedAudience);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kPrivateAggregationApiProtectedAudienceExtensionsEnabled);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kPrivateAggregationApiDebugModeEnabledAtAll);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kPrivateAggregationApiProtectedAudienceAdditionalExtensions);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kProcessHtmlDataImmediatelyChildFrame);
// If set, the first chunk of data available for html processing is processed
// immediately.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kProcessHtmlDataImmediatelyFirstChunk);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kProcessHtmlDataImmediatelyMainFrame);
// If set, subsequent chunks of data available for html processing are processed
// immediately.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kProcessHtmlDataImmediatelySubsequentChunks);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kProduceCompileHintsNoiseLevel);
// The proportion of the clients producing data.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(double, kProduceCompileHintsDataProductionLevel);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kQuoteEmptySecChUaStringHeadersConsistently);

// A parameter for kReduceUserAgentMinorVersion;
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kUserAgentFrozenBuildVersion);

// Parameters for kReduceUserAgentPlatformOsCpu;
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kAllExceptLegacyWindowsPlatform);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kReducedReferrerGranularity);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kRegisterJSSourceLocationBlockingBFCache);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kMaxBlockingTimeMsForRenderBlockingFonts);
// Max milliseconds that font are allowed to delay of FCP.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kMaxFCPDelayMsForRenderBlockingFonts);
...
BLINK_COMMON_EXPORT extern const base::FeatureParam<std::string> kSelectiveInOrderScriptAllowList;

// Performs additional SubresourceFilter checks when CNAME aliases are found
// for the host of a requested URL.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kSendCnameAliasesToSubresourceFilterFromRenderer);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kSharedStorageURLSelectionOperationInputURLSizeLimit);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kMaxSharedStorageIteratorBatchSize);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kSharedStorageBudgetInterval);
...
// finds.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kSharedStorageStalePurgeInitialInterval);
...
// finds.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kSharedStorageStalePurgeRecurringInterval);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kSharedStorageStalenessThreshold);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(size_t, kSharedStorageMaxAllowedFencedFrameDepthForSelectURL);
...
// default.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kSharedStorageExposeDebugMessageForSettingsStatus);
...
// backing thread.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kSharedStorageWorkletSharedBackingThreadImplementation);
...
// TODO(crbug.com/40185706): Merge this flag with `kSharedStorageAPI` once
// shipped.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kSharedStorageCreateWorkletUseContextOriginByDefault);

// For the Shared Storage API, allow custom data origins in `createWorklet`.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kSharedStorageCreateWorkletCustomDataOrigin);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kSimplifyLoadingTransparentPlaceholderImage);
...
BLINK_COMMON_EXPORT
extern const char kSkipTouchEventFilterFilteringProcessParamValueBrowserAndRenderer[];
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kSpeculativeServiceWorkerWarmUpMaxCount);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kSpeculativeServiceWorkerWarmUpDuration);
...
BLINK_COMMON_EXPORT extern const base::FeatureParam<bool> kSpeculativeServiceWorkerWarmUpOnPointerover;
BLINK_COMMON_EXPORT extern const base::FeatureParam<bool> kSpeculativeServiceWorkerWarmUpOnPointerdown;
BLINK_COMMON_EXPORT extern const base::FeatureParam<bool> kSpeculativeServiceWorkerWarmUpOnIdleTimeout;
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(std::string, kBoostRenderProcessForLoadingTargetUrls);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kBoostRenderProcessForLoadingPrioritizePrerendering);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kBoostRenderProcessForLoadingPrioritizePrerenderingOnly);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kInstallingServiceWorkerOutstandingThrottledLimit);

BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kThrottleUnimportantFrameTimers);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kUnimportantFrameTimersThrottledWakeUpIntervalMills);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(int, kLargeFrameSizePercentThreshold);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kTreatHTTPExpiresHeaderValueZeroAsExpiredInBlink);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kUseImageInsteadOfStorageForStagingBuffer);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kUseThreadPoolForMediaStreamVideoTaskRunner);
...
// occluded tabs.
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(base::TimeDelta, kVSyncDecodingHiddenOccludedTickDuration);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kWebAudioBypassOutputBufferingInteractive);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kWebAudioBypassOutputBufferingBalanced);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kWebAudioBypassOutputBufferingPlayback);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE_PARAM(bool, kWebAudioBypassOutputBufferingExact);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kWebRtcThreadsUseResourceEfficientType);
...
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kReleaseResourceStrongReferencesOnMemoryPressure);
BLINK_COMMON_EXPORT BASE_DECLARE_FEATURE(kReleaseResourceDecodedDataOnMemoryPressure);
...
BLINK_COMMON_EXPORT bool IsLinkPreviewTriggerTypeEnabled(LinkPreviewTriggerType type);
