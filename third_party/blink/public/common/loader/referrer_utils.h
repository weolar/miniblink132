...
class ReferrerUtils {
public:
    static BLINK_COMMON_EXPORT network::mojom::ReferrerPolicy NetToMojoReferrerPolicy(net::ReferrerPolicy net_policy);
    ...
    static BLINK_COMMON_EXPORT network::mojom::ReferrerPolicy MojoReferrerPolicyResolveDefault(network::mojom::ReferrerPolicy);
};
