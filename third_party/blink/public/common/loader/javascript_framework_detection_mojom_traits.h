...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::JavaScriptFrameworkDetectionResultDataView, blink::JavaScriptFrameworkDetectionResult> {
    static const std::map<blink::JavaScriptFramework, int16_t>& detected_versions(const blink::JavaScriptFrameworkDetectionResult& r)
    {
        return r.detected_versions;
    }

    static bool Read(blink::mojom::JavaScriptFrameworkDetectionResultDataView r, blink::JavaScriptFrameworkDetectionResult* out)
    {
