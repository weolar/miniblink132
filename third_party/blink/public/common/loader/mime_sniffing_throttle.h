...
public:
    ...
    // current sequence.
    explicit MimeSniffingThrottle(scoped_refptr<base::SequencedTaskRunner> task_runner);
    ...
    void ResumeWithNewResponseHead(network::mojom::URLResponseHeadPtr new_response_head, mojo::ScopedDataPipeConsumerHandle body);
