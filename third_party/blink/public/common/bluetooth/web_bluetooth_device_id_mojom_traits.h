...
template <> struct StructTraits<blink::mojom::WebBluetoothDeviceIdDataView, blink::WebBluetoothDeviceId> {
    static const blink::WebBluetoothDeviceIdKey device_id(const blink::WebBluetoothDeviceId& device_id)
    {
        return device_id.DeviceId();
    }

    static bool Read(blink::mojom::WebBluetoothDeviceIdDataView input, blink::WebBluetoothDeviceId* output)
    {
