...
using DedicatedWorkerToken = base::TokenType<class DedicatedWorkerTokenTypeMarker>;
...
using WorkerToken = MultiToken<DedicatedWorkerToken, ServiceWorkerToken, SharedWorkerToken>;

////////////////////////////////////////////////////////////////////////////////
// WORKLET TOKENS

// Identifies an animation worklet.
using AnimationWorkletToken = base::TokenType<class AnimationWorkletTokenTypeMarker>;
...
using SharedStorageWorkletToken = base::TokenType<class SharedStorageWorkletTokenTypeMarker>;

// Can represent any type of WorkletToken.
using WorkletToken = MultiToken<AnimationWorkletToken, AudioWorkletToken, LayoutWorkletToken, PaintWorkletToken, SharedStorageWorkletToken>;
...
using AttributionSrcToken = base::TokenType<class AttributionSrcTokenTypeMarker>;
...
using ExecutionContextToken = MultiToken<LocalFrameToken, DedicatedWorkerToken, ServiceWorkerToken, SharedWorkerToken, AnimationWorkletToken, AudioWorkletToken,
    LayoutWorkletToken, PaintWorkletToken, SharedStorageWorkletToken, ShadowRealmToken>;

// Identifies the destination of a screenshot for a same-document navigation.
using SameDocNavigationScreenshotDestinationToken = base::TokenType<class SameDocNavigationScreenshotDestinationTokenTypeMarker>;

// Identifies a v8::Context / blink::ScriptState.
using V8ContextToken = base::TokenType<class V8ContextTokenTypeMarker>;

using ViewTransitionToken = base::TokenType<class ViewTransitionTokenTypeMarker>;
...
//     there later on.
using WebGPUExecutionContextToken = MultiToken<DocumentToken, DedicatedWorkerToken, SharedWorkerToken, ServiceWorkerToken>;
