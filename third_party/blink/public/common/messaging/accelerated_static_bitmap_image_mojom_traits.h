...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::SharedImageUsageSet::DataView, gpu::SharedImageUsageSet> {
    static uint32_t usage(const gpu::SharedImageUsageSet& input)
    {
        return uint32_t(input);
    }

    static bool Read(blink::mojom::SharedImageUsageSet::DataView data, gpu::SharedImageUsageSet* out);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::AcceleratedStaticBitmapImage::DataView, blink::AcceleratedImageInfo> {
    static const gpu::MailboxHolder& mailbox_holder(const blink::AcceleratedImageInfo& input)
    {
        return input.mailbox_holder;
    }

    static gpu::SharedImageUsageSet usage(const blink::AcceleratedImageInfo& input)
    {
        return input.usage;
    }
    ...
    static bool supports_display_compositing(const blink::AcceleratedImageInfo& input)
    {
    ...
    static mojo::PendingRemote<blink::mojom::ImageReleaseCallback> release_callback(blink::AcceleratedImageInfo& input);

    static bool Read(blink::mojom::AcceleratedStaticBitmapImage::DataView data, blink::AcceleratedImageInfo* out);
};
} // namespace mojo
