...
public:
    ...
    static std::vector<MessagePortDescriptor> ReleaseHandles(const std::vector<MessagePortChannel>& ports);
    static std::vector<MessagePortChannel> CreateFromHandles(std::vector<MessagePortDescriptor> handles);
