...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::MessagePortDescriptorDataView, blink::MessagePortDescriptor> {
    // For converting a blink::mojom::MessagePortDescriptor to a
    // blink::MessagePortDescriptor.
    static bool Read(blink::mojom::MessagePortDescriptorDataView data, blink::MessagePortDescriptor* output);

    // For converting a blink::MessagePortDescriptor to a
    // blink::mojom::MessagePortDescriptor.
    static mojo::ScopedMessagePipeHandle pipe_handle(blink::MessagePortDescriptor& input);
