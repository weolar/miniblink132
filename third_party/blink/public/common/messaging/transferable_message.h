...
struct BLINK_COMMON_EXPORT TransferableMessage : public CloneableMessage {
    ...
    std::vector<mojom::SerializedArrayBufferContentsPtr> array_buffer_contents_array;
    // The contents of any ImageBitmaps being transferred as part of this message.
    std::vector<mojom::SerializedStaticBitmapImagePtr> image_bitmap_contents_array;
    ...
    mojom::DelegatedCapability delegated_capability = mojom::DelegatedCapability::kNone;
