...
struct BLINK_COMMON_EXPORT DirectFromSellerSignalsSubresource {
    ...
    DirectFromSellerSignalsSubresource& operator=(const DirectFromSellerSignalsSubresource&);
    DirectFromSellerSignalsSubresource& operator=(DirectFromSellerSignalsSubresource&&);

    friend BLINK_COMMON_EXPORT bool operator==(const DirectFromSellerSignalsSubresource&, const DirectFromSellerSignalsSubresource&);
...
struct BLINK_COMMON_EXPORT DirectFromSellerSignals {
    ...
    GURL prefix;
    base::flat_map<url::Origin, DirectFromSellerSignalsSubresource> per_buyer_signals;
    ...
    friend BLINK_COMMON_EXPORT bool operator==(const DirectFromSellerSignals&, const DirectFromSellerSignals&);
};
...
struct BLINK_COMMON_EXPORT AuctionConfig {
    ...
    // typemapped.
    template <typename Value> class BLINK_COMMON_EXPORT MaybePromise {
    public:
        ...
        friend BLINK_COMMON_EXPORT bool operator==(const MaybePromise<Value>&, const MaybePromise<Value>&) = default;
        ...
        Value& mutable_value_for_testing()
        {
            return value_;
        }
    ...
    using MaybePromisePerBuyerSignals = MaybePromise<std::optional<base::flat_map<url::Origin, std::string>>>;

    // Typemapped to
    // blink::mojom::AuctionAdConfigMaybePromiseDirectFromSellerSignals
    using MaybePromiseDirectFromSellerSignals = MaybePromise<std::optional<DirectFromSellerSignals>>;
    ...
    struct BLINK_COMMON_EXPORT AdKeywordReplacement {
        ...
        bool IsValid()
        {
            return ((match.starts_with("${") && match.ends_with("}")) || (match.starts_with("%%") && match.ends_with("%%")));
        }

        bool operator==(const AdKeywordReplacement& other) const
        {
            return std::tie(match, replacement) == std::tie(other.match, other.replacement);
        }
    };

    // Typemapped to
    // blink::mojom::AuctionAdConfigMaybePromiseDeprecatedRenderURLReplacements
    using MaybePromiseDeprecatedRenderURLReplacements = MaybePromise<std::vector<AdKeywordReplacement>>;
    ...
    struct BuyerTimeouts {
        ...
        friend BLINK_COMMON_EXPORT bool operator==(const BuyerTimeouts&, const BuyerTimeouts&);
    };
    ...
    struct BuyerCurrencies {
        ...
        friend BLINK_COMMON_EXPORT bool operator==(const BuyerCurrencies&, const BuyerCurrencies&);
    };
    ...
    struct BLINK_COMMON_EXPORT ServerResponseConfig {
        ...
        friend BLINK_COMMON_EXPORT bool operator==(const ServerResponseConfig&, const ServerResponseConfig&);
    ...
    struct BLINK_COMMON_EXPORT NonSharedParams {
        ...
        // the report.
        using BuyerReportType = blink::mojom::AuctionAdConfigNonSharedParams_BuyerReportType;

        // The type of real time reports.
        using RealTimeReportingType = blink::mojom::AuctionAdConfigNonSharedParams_RealTimeReportingType;
        ...
        struct BLINK_COMMON_EXPORT AuctionReportBuyersConfig {
            ...
            friend BLINK_COMMON_EXPORT bool operator==(const AuctionReportBuyersConfig&, const AuctionReportBuyersConfig&);
        };
        ...
        struct BLINK_COMMON_EXPORT AuctionReportBuyerDebugModeConfig {
            ...
            friend BLINK_COMMON_EXPORT bool operator==(const AuctionReportBuyerDebugModeConfig&, const AuctionReportBuyerDebugModeConfig&);
        };
        ...
        friend BLINK_COMMON_EXPORT bool operator==(const NonSharedParams&, const NonSharedParams&);
        ...
        std::uint16_t all_buyers_group_limit = std::numeric_limits<std::uint16_t>::max();
        ...
        std::optional<base::flat_map<BuyerReportType, AuctionReportBuyersConfig>> auction_report_buyers;

        // Specifies the debug mode config for per-buyer extended Private
        // Aggregation reporting to the seller.
        std::optional<blink::AuctionConfig::NonSharedParams::AuctionReportBuyerDebugModeConfig> auction_report_buyer_debug_mode_config;
        ...
        std::optional<base::flat_map<url::Origin, RealTimeReportingType>> per_buyer_real_time_reporting_types;
        ...
        MaybePromiseDeprecatedRenderURLReplacements deprecated_render_url_replacements;
    ...
    friend BLINK_COMMON_EXPORT bool operator==(const AuctionConfig&, const AuctionConfig&);
    ...
    // auction.
    bool IsDirectFromSellerSignalsValid(const std::optional<blink::DirectFromSellerSignals>& direct_from_seller_signals) const;
