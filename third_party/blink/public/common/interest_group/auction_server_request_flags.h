...
enum class AuctionServerRequestFlagsEnum : uint32_t { kOmitAds, kIncludeFullAds, kOmitUserBiddingSignals, kMaxValue = kOmitUserBiddingSignals };

using AuctionServerRequestFlags
    = base::EnumSet<AuctionServerRequestFlagsEnum, AuctionServerRequestFlagsEnum::kOmitAds, AuctionServerRequestFlagsEnum::kMaxValue>;
