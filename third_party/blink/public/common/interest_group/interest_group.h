...
struct BLINK_COMMON_EXPORT InterestGroup {
    ...
    using TrustedBiddingSignalsSlotSizeMode = blink::mojom::InterestGroup_TrustedBiddingSignalsSlotSizeMode;
    ...
    public:
        ...
        explicit Ad(base::PassKey<content::InterestGroupStorage>, std::string&& render_url);
        explicit Ad(base::PassKey<content::InterestGroupStorage>, const std::string& render_url);
        Ad(GURL render_gurl, std::optional<std::string> metadata, std::optional<std::string> size_group = std::nullopt,
            std::optional<std::string> buyer_reporting_id = std::nullopt, std::optional<std::string> buyer_and_seller_reporting_id = std::nullopt,
            std::optional<std::vector<std::string>> selectable_buyer_and_seller_reporting_ids = std::nullopt,
            std::optional<std::string> ad_render_id = std::nullopt, std::optional<std::vector<url::Origin>> allowed_reporting_origins = std::nullopt);
        ~Ad();
        ...
        const std::string& render_url() const
        {
            return render_url_;
        }
    ...
    private:
        ...
        friend struct mojo::StructTraits<blink::mojom::InterestGroupAdDataView, blink::InterestGroup::Ad>;
    };
    ...
    template <class StringType> static TrustedBiddingSignalsSlotSizeMode ParseTrustedBiddingSignalsSlotSizeMode(const StringType& mode)
    {
        if (mode == "slot-size") {
    ...
    // string.
    static std::string_view TrustedBiddingSignalsSlotSizeModeToString(TrustedBiddingSignalsSlotSizeMode slot_size_mode);
    ...
    TrustedBiddingSignalsSlotSizeMode trusted_bidding_signals_slot_size_mode = TrustedBiddingSignalsSlotSizeMode::kNone;
...
std::string BLINK_COMMON_EXPORT DEPRECATED_KAnonKeyForAdBid(const InterestGroup& group, const std::string& ad_url_from_gurl_spec);
std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdBid(const url::Origin& owner, const GURL& bidding_url, const std::string& ad_url_from_gurl_spec);
std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdBid(const InterestGroup& group, const std::string& ad_url_from_gurl_spec);
std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdBid(const InterestGroup& group, const blink::AdDescriptor& ad_descriptor);
...
std::string BLINK_COMMON_EXPORT DEPRECATED_KAnonKeyForAdComponentBid(const std::string& ad_url_from_gurl_spec);
std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdComponentBid(const std::string& ad_url_from_gurl_spec);
std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdComponentBid(const blink::AdDescriptor& ad_descriptor);
std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdComponentBid(const GURL& ad_url);
...
std::string BLINK_COMMON_EXPORT DEPRECATED_KAnonKeyForAdNameReporting(
    const InterestGroup& group, const InterestGroup::Ad& ad, base::optional_ref<const std::string> selected_buyer_and_seller_reporting_id);

std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdNameReporting(
    const InterestGroup& group, const InterestGroup::Ad& ad, base::optional_ref<const std::string> selected_buyer_and_seller_reporting_id);

std::string BLINK_COMMON_EXPORT HashedKAnonKeyForAdNameReportingWithoutInterestGroup(const url::Origin& interest_group_owner,
    const std::string& interest_group_name, const GURL& interest_group_bidding_url, const std::string& ad_render_url,
    base::optional_ref<const std::string> buyer_reporting_id, base::optional_ref<const std::string> buyer_and_seller_reporting_id,
    base::optional_ref<const std::string> selected_buyer_and_seller_reporting_id);
