...
inline constexpr InsecureRequestPolicy operator&(InsecureRequestPolicy a, InsecureRequestPolicy b)
{
    return static_cast<InsecureRequestPolicy>(static_cast<int>(a) & static_cast<int>(b));
}

inline constexpr InsecureRequestPolicy operator|(InsecureRequestPolicy a, InsecureRequestPolicy b)
{
    InsecureRequestPolicy result = static_cast<InsecureRequestPolicy>(static_cast<int>(a) | static_cast<int>(b));
    DCHECK_LE(result, InsecureRequestPolicy::kMaxInsecureRequestPolicy);
    return result;
}

inline InsecureRequestPolicy& operator|=(InsecureRequestPolicy& a, InsecureRequestPolicy b)
{
    return a = a | b;
}
