...
inline constexpr LargestContentfulPaintType operator&(LargestContentfulPaintType a, LargestContentfulPaintType b)
{
    return static_cast<LargestContentfulPaintType>(static_cast<uint32_t>(a) & static_cast<uint32_t>(b));
}
...
inline LargestContentfulPaintType& operator&=(LargestContentfulPaintType& a, LargestContentfulPaintType b)
{
    return a = a & b;
}
...
inline constexpr uint64_t LargestContentfulPaintTypeToUKMFlags(LargestContentfulPaintType type)
{
