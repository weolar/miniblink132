...
struct BLINK_COMMON_EXPORT WebPreferences {
    ...
    blink::mojom::PointerType primary_pointer_type = blink::mojom::PointerType::kPointerNone;
    int available_hover_types = 0;
    blink::mojom::HoverType primary_hover_type = blink::mojom::HoverType::kHoverNone;
    blink::mojom::OutputDeviceUpdateAbilityType output_device_update_ability_type = blink::mojom::OutputDeviceUpdateAbilityType::kFastType;
    ...
    bool auto_zoom_focused_editable_to_legible_scale = BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_IOS);
    ...
    bool shrinks_viewport_contents_to_fit = BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_IOS);
...
#endif
    bool always_show_context_menu_on_touch = !(BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_IOS));
    bool smooth_scroll_for_find_enabled = BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_IOS);
    bool main_frame_resizes_are_orientation_changes = BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_IOS);
    ...
    blink::mojom::V8CacheOptions v8_cache_options = blink::mojom::V8CacheOptions::kDefault;
    ...
    blink::mojom::ImageAnimationPolicy animation_policy = blink::mojom::ImageAnimationPolicy::kImageAnimationPolicyAllowed;
    ...
    bool double_tap_to_zoom_enabled = BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_APPLE);
...
// once all Content embedders on Fuchsia support WebAuthn.
    ...
    blink::mojom::AutoplayPolicy autoplay_policy = blink::mojom::AutoplayPolicy::kDocumentUserActivationRequired;
    ...
    // root scrollbars.
    blink::mojom::PreferredColorScheme preferred_root_scrollbar_color_scheme = blink::mojom::PreferredColorScheme::kLight;
    ...
    blink::mojom::PreferredColorScheme preferred_color_scheme = blink::mojom::PreferredColorScheme::kLight;

    // The preferred contrast for the web content. The contrast is used to
    // evaluate the prefers-contrast media query.
    blink::mojom::PreferredContrast preferred_contrast = blink::mojom::PreferredContrast::kNoPreference;

    // Network quality threshold below which resources from iframes are assigned
    // either kVeryLow or kVeryLow Blink priority.
    EffectiveConnectionType low_priority_iframes_threshold = EffectiveConnectionType::kEffectiveConnectionUnknownType;
    ...
    EffectiveConnectionType network_quality_estimator_web_holdback = EffectiveConnectionType::kEffectiveConnectionUnknownType;
