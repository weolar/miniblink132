...
private:
    ...
    std::bitset<static_cast<size_t>(mojom::WebFeature::kMaxValue) + 1> web_features_;
    std::bitset<static_cast<size_t>(mojom::WebDXFeature::kMaxValue) + 1> webdx_features_;
    std::bitset<static_cast<size_t>(mojom::CSSSampleId::kMaxValue) + 1> css_properties_;
    std::bitset<static_cast<size_t>(mojom::CSSSampleId::kMaxValue) + 1> animated_css_properties_;
    std::bitset<static_cast<size_t>(mojom::PermissionsPolicyFeature::kMaxValue) + 1> violated_permissions_policy_features_;
    std::bitset<static_cast<size_t>(blink::mojom::PermissionsPolicyFeature::kMaxValue) + 1> iframe_permissions_policy_features_;
    std::bitset<static_cast<size_t>(blink::mojom::PermissionsPolicyFeature::kMaxValue) + 1> header_permissions_policy_features_;
};
