...
public:
    ...
    explicit FontTableMatcher(const base::ReadOnlySharedMemoryMapping& memory_mapping);
    ...
    static base::ReadOnlySharedMemoryMapping MemoryMappingFromFontUniqueNameTable(const FontUniqueNameTable& font_unique_name_table);
