...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::VisualPropertiesDataView, blink::VisualProperties> {
    static const display::ScreenInfos& screen_infos(const blink::VisualProperties& r)
    {
    ...
    static const gfx::Size& min_size_for_auto_resize(const blink::VisualProperties& r)
    {
        return r.min_size_for_auto_resize;
    }

    static const gfx::Size& max_size_for_auto_resize(const blink::VisualProperties& r)
    {
    ...
    static const gfx::Size& visible_viewport_size(const blink::VisualProperties& r)
    {
        return r.visible_viewport_size;
    }

    static const gfx::Rect& compositor_viewport_pixel_rect(const blink::VisualProperties& r)
    {
        return r.compositor_viewport_pixel_rect;
    }

    static const cc::BrowserControlsParams& browser_controls_params(const blink::VisualProperties& r)
    {
    ...
    static const std::optional<viz::LocalSurfaceId>& local_surface_id(const blink::VisualProperties& r)
    {
    ...
    static blink::mojom::DisplayMode display_mode(const blink::VisualProperties& r)
    {
        return r.display_mode;
    }

    static const ui::mojom::WindowShowState& window_show_state(const blink::VisualProperties& r)
    {
    ...
    static int virtual_keyboard_resize_height_physical_px(const blink::VisualProperties& r)
    {
    ...
    static float cursor_accessibility_scale_factor(const blink::VisualProperties& r)
    {
        DCHECK_GE(r.cursor_accessibility_scale_factor, 1.f);
        return r.cursor_accessibility_scale_factor;
    }

    static const std::vector<gfx::Rect>& root_widget_viewport_segments(const blink::VisualProperties& r)
    {
    ...
    static const gfx::Rect& window_controls_overlay_rect(const blink::VisualProperties& r)
    {
        return r.window_controls_overlay_rect;
    }

    static bool Read(blink::mojom::VisualPropertiesDataView r, blink::VisualProperties* out);
};
