...
struct DeviceEmulationParams {
    ...
    display::mojom::ScreenOrientation screen_orientation_type = display::mojom::ScreenOrientation::kUndefined;
    ...
    mojom::DevicePostureType device_posture = mojom::DevicePostureType::kContinuous;

    DeviceEmulationParams() = default;
};

inline bool operator==(const DeviceEmulationParams& a, const DeviceEmulationParams& b)
{
    return a.screen_type == b.screen_type && a.screen_size == b.screen_size && a.view_position == b.view_position
        && a.device_scale_factor == b.device_scale_factor && a.view_size == b.view_size && a.scale == b.scale
        && a.screen_orientation_type == b.screen_orientation_type && a.screen_orientation_angle == b.screen_orientation_angle
        && a.viewport_offset == b.viewport_offset && a.viewport_scale == b.viewport_scale && a.viewport_segments == b.viewport_segments
