...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::DeviceEmulationParamsDataView, blink::DeviceEmulationParams> {
    static blink::mojom::EmulatedScreenType screen_type(const blink::DeviceEmulationParams& r)
    {
    ...
    static const std::optional<gfx::Point>& view_position(const blink::DeviceEmulationParams& r)
    {
    ...
    static float scale(const blink::DeviceEmulationParams& r)
    {
        return r.scale;
    }

    static const gfx::PointF& viewport_offset(const blink::DeviceEmulationParams& r)
    {
    ...
    static display::mojom::ScreenOrientation screen_orientation_type(const blink::DeviceEmulationParams& r)
    {
        return r.screen_orientation_type;
    }

    static uint32_t screen_orientation_angle(const blink::DeviceEmulationParams& r)
    {
        return r.screen_orientation_angle;
    }

    static const std::vector<gfx::Rect>& viewport_segments(const blink::DeviceEmulationParams& r)
    {
        return r.viewport_segments;
    }

    static blink::mojom::DevicePostureType device_posture(const blink::DeviceEmulationParams& r)
    {
        return r.device_posture;
    }

    static bool Read(blink::mojom::DeviceEmulationParamsDataView r, blink::DeviceEmulationParams* out);
};
