...
struct SubresourceLoadMetrics {
    ...
    std::optional<ServiceWorkerSubresourceLoadMetrics> service_worker_subresource_load_metrics;

    bool operator==(const SubresourceLoadMetrics& other) const
    {
        return number_of_subresources_loaded == other.number_of_subresources_loaded
            && number_of_subresource_loads_handled_by_service_worker == other.number_of_subresource_loads_handled_by_service_worker
            && service_worker_subresource_load_metrics == other.service_worker_subresource_load_metrics;
    }
};
