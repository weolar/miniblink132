...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::MediaDeviceInfoDataView, blink::WebMediaDeviceInfo> {
    ...
    static const media::VideoCaptureControlSupport& control_support(const blink::WebMediaDeviceInfo& info)
    {
        return info.video_control_support;
    }

    static const blink::mojom::FacingMode& facing_mode(const blink::WebMediaDeviceInfo& info)
    {
        return info.video_facing;
    }

    static const std::optional<media::CameraAvailability>& availability(const blink::WebMediaDeviceInfo& info)
    {
        return info.availability;
    }

    static bool Read(blink::mojom::MediaDeviceInfoDataView input, blink::WebMediaDeviceInfo* out);
};
