...
BLINK_COMMON_EXPORT extern const char kMediaStreamSourceScreen[]; /* video only */
BLINK_COMMON_EXPORT extern const char kMediaStreamSourceDesktop[];
BLINK_COMMON_EXPORT extern const char kMediaStreamSourceSystem[]; /* audio only */
...
struct BLINK_COMMON_EXPORT StreamControls {
    ...
    mojom::PreferredDisplaySurface preferred_display_surface = mojom::PreferredDisplaySurface::NO_PREFERENCE;
