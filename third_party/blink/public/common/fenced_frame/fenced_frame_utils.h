...
inline constexpr char kFencedFrameCreationOrNavigationOutcomeHistogram[] = "Blink.FencedFrame.CreationOrNavigationOutcome";

inline constexpr char kIsOpaqueFencedFrameSizeCoercedHistogram[] = "Blink.FencedFrame.IsOpaqueFrameSizeCoerced";

inline constexpr char kIsFencedFrameResizedAfterSizeFrozen[] = "Blink.FencedFrame.IsFrameResizedAfterSizeFrozen";

inline constexpr char kFencedFrameMandatoryUnsandboxedFlagsSandboxed[] = "Blink.FencedFrame.MandatoryUnsandboxedFlagsSandboxed";

inline constexpr char kFencedFrameFailedSandboxLoadInTopLevelFrame[] = "Blink.FencedFrame.FailedSandboxLoadInTopLevelFrame";

inline constexpr char kFencedFrameTopNavigationHistogram[] = "Navigation.FencedFrameTopNavigation";

inline constexpr char kAutomaticBeaconOutcomeHistogram[] = "Navigation.AutomaticBeaconOutcome";

inline constexpr char kAutomaticBeaconEventTypeHistogram[] = "Navigation.FencedFrameAutomaticBeaconEventType";

inline constexpr char kFencedFrameBeaconReportingHttpResultUMA[] = "Blink.FencedFrame.BeaconReportingHttpResult";

inline constexpr char kFencedFrameBeaconReportingCountUMA[] = "Navigation.FencedFrameBeaconReportingCountSameOrigin";

inline constexpr char kFencedFrameBeaconReportingCountCrossOriginUMA[] = "Navigation.FencedFrameBeaconReportingCountCrossOrigin";
...
//
// PLEASE DO NOT REORDER, REMOVE, OR CHANGE THE MEANING OF THESE VALUES.
enum class FencedFrameNavigationState { kBegin = 0, kCommit = 1, kMaxValue = kCommit };
...
BLINK_COMMON_EXPORT void RecordFencedFrameCreationOutcome(const FencedFrameCreationOutcome outcome);
...
BLINK_COMMON_EXPORT void RecordFencedFrameUnsandboxedFlags(network::mojom::WebSandboxFlags flags);
BLINK_COMMON_EXPORT void RecordFencedFrameFailedSandboxLoadInTopLevelFrame(bool is_main_frame);
...
BLINK_COMMON_EXPORT bool CanNotifyEventTypeAcrossFence(const std::string& event_type);

// Automatic beacon type definitions
inline constexpr char kDeprecatedFencedFrameTopNavigationBeaconType[] = "reserved.top_navigation";
inline constexpr char kFencedFrameTopNavigationStartBeaconType[] = "reserved.top_navigation_start";
inline constexpr char kFencedFrameTopNavigationCommitBeaconType[] = "reserved.top_navigation_commit";

inline constexpr const char* kFencedFrameAutomaticBeaconTypes[]
    = { kDeprecatedFencedFrameTopNavigationBeaconType, kFencedFrameTopNavigationStartBeaconType, kFencedFrameTopNavigationCommitBeaconType };
