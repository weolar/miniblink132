...
class BLINK_COMMON_EXPORT WebPointerEvent : public WebInputEvent, public WebPointerProperties {
public:
    WebPointerEvent()
        : WebPointerProperties(0)
    {
    }
    WebPointerEvent(WebInputEvent::Type type_param, WebPointerProperties web_pointer_properties_param, float width_param, float height_param)
    ...
    static WebPointerEvent CreatePointerCausesUaActionEvent(WebPointerProperties::PointerType, base::TimeTicks time_stamp);
    ...
    {
        return dispatch_type == DispatchType::kBlocking;
    }
    bool HasWidth() const
    {
