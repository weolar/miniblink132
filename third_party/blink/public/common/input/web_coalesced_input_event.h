...
public:
    ...
    WebCoalescedInputEvent(std::unique_ptr<WebInputEvent>, const ui::LatencyInfo&);
    WebCoalescedInputEvent(
        std::unique_ptr<WebInputEvent>, std::vector<std::unique_ptr<WebInputEvent>>, std::vector<std::unique_ptr<WebInputEvent>>, const ui::LatencyInfo&);
    ...
    const std::vector<std::unique_ptr<WebInputEvent>>& GetCoalescedEventsPointers() const;
    ...
    const std::vector<std::unique_ptr<WebInputEvent>>& GetPredictedEventsPointers() const;
