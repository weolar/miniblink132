...
public:
    ...
    WebPointerProperties::PointerType primary_pointer_type = WebPointerProperties::PointerType::kUnknown;
...
public:
    WebGestureEvent(Type type, int modifiers, base::TimeTicks time_stamp, mojom::GestureDevice device = mojom::GestureDevice::kUninitialized)
    ...
    const gfx::PointF& PositionInWidget() const
    {
        return position_in_widget_;
    }
    const gfx::PointF& PositionInScreen() const
    {
        return position_in_screen_;
    }
    ...
    mojom::GestureDevice SourceDevice() const
    {
        return source_device_;
    }
    void SetSourceDevice(mojom::GestureDevice device)
    {
        source_device_ = device;
    }
    ...
    bool IsTouchpadZoomEvent() const
    {
        ...
        // pinch gesture.
        return source_device_ == mojom::GestureDevice::kTouchpad && (WebInputEvent::IsPinchGestureEventType(type_) || type_ == Type::kGestureDoubleTap);
    }
    ...
    static std::pair<std::unique_ptr<WebGestureEvent>, std::unique_ptr<WebGestureEvent>> CoalesceScrollAndPinch(
    ...
    static bool IsCompatibleScrollorPinch(const WebGestureEvent& new_event, const WebGestureEvent& event_in_queue);
    ...
    static std::unique_ptr<blink::WebGestureEvent> GenerateInjectedScrollbarGestureScroll(
