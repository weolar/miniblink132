...
public:
    ...
    BrowsingContextGroupInfo(const base::UnguessableToken& browsing_context_group_token, const base::UnguessableToken& coop_related_group_token);
...
bool BLINK_COMMON_EXPORT operator==(const BrowsingContextGroupInfo& lhs, const BrowsingContextGroupInfo& rhs);
bool BLINK_COMMON_EXPORT operator!=(const BrowsingContextGroupInfo& lhs, const BrowsingContextGroupInfo& rhs);
