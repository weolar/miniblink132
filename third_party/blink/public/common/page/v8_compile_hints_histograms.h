...
inline constexpr const char* kStatusHistogram = "WebCore.Scripts.V8CompileHintsStatus";

inline constexpr const char* kLocalCompileHintsGeneratedHistogram = "WebCore.Scripts.V8LocalCompileHintsGenerated";

inline constexpr const char* kLocalCompileHintsObsoletedByCodeCacheHistogram = "WebCore.Scripts.V8LocalCompileHintsObsoletedByCodeCache";
...
enum class LocalCompileHintsGenerated { kNonFinal = 0, kFinal = 1, kMaxValue = kFinal };
