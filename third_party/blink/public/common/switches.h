...
BLINK_COMMON_EXPORT extern const char kForcePermissionPolicyUnloadDefaultEnabled[];
...
BLINK_COMMON_EXPORT extern const char kEnableGpuMemoryBufferCompositorResources[];
...
BLINK_COMMON_EXPORT extern const char kIntensiveWakeUpThrottlingPolicy_ForceDisable[];
BLINK_COMMON_EXPORT extern const char kIntensiveWakeUpThrottlingPolicy_ForceEnable[];
