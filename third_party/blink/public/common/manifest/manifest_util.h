...
BLINK_COMMON_EXPORT bool IsDefaultManifest(const mojom::Manifest& manifest, const GURL& document_url);
BLINK_COMMON_EXPORT bool IsDefaultManifest(const mojom::ManifestPtr& manifest, const GURL& document_url);
...
BLINK_COMMON_EXPORT std::optional<blink::mojom::Manifest_TextDirection> TextDirectionFromString(const std::string& dir);
...
BLINK_COMMON_EXPORT std::string DisplayModeToString(blink::mojom::DisplayMode display);
...
// match.
BLINK_COMMON_EXPORT blink::mojom::DisplayMode DisplayModeFromString(const std::string& display);
...
BLINK_COMMON_EXPORT std::string WebScreenOrientationLockTypeToString(device::mojom::ScreenOrientationLockType);
...
BLINK_COMMON_EXPORT device::mojom::ScreenOrientationLockType WebScreenOrientationLockTypeFromString(const std::string& orientation);

BLINK_COMMON_EXPORT mojom::CaptureLinks CaptureLinksFromString(const std::string& capture_links);

BLINK_COMMON_EXPORT std::optional<mojom::ManifestLaunchHandler::ClientMode> ClientModeFromString(const std::string& client_mode);
