...
BLINK_COMMON_EXPORT extern const char kWebRTCIPHandlingDefaultPublicAndPrivateInterfaces[];

// WebRTC should only use the default route used by http. This doesn't expose
// any local addresses.
BLINK_COMMON_EXPORT extern const char kWebRTCIPHandlingDefaultPublicInterfaceOnly[];
