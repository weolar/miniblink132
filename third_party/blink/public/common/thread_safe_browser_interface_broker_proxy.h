...
class BLINK_COMMON_EXPORT ThreadSafeBrowserInterfaceBrokerProxy : public base::RefCountedThreadSafe<ThreadSafeBrowserInterfaceBrokerProxy> {
public:
    ThreadSafeBrowserInterfaceBrokerProxy();
    ThreadSafeBrowserInterfaceBrokerProxy(const ThreadSafeBrowserInterfaceBrokerProxy&) = delete;
    ThreadSafeBrowserInterfaceBrokerProxy& operator=(const ThreadSafeBrowserInterfaceBrokerProxy&) = delete;
...
protected:
    friend class base::RefCountedThreadSafe<ThreadSafeBrowserInterfaceBrokerProxy>;
...
private:
    ...
    std::map<std::string, Binder> binder_map_for_testing_ GUARDED_BY(binder_map_lock_);
};
