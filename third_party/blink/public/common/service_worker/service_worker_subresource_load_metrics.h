...
struct ServiceWorkerSubresourceLoadMetrics {
    ...
    {
        return image_handled == other.image_handled && image_fallback == other.image_fallback && css_handled == other.css_handled
            && css_fallback == other.css_fallback && script_handled == other.script_handled && script_fallback == other.script_fallback
            && font_handled == other.font_handled && font_fallback == other.font_fallback && raw_handled == other.raw_handled
            && raw_fallback == other.raw_fallback && svg_handled == other.svg_handled && svg_fallback == other.svg_fallback && xsl_handled == other.xsl_handled
            && xsl_fallback == other.xsl_fallback && link_prefetch_handled == other.link_prefetch_handled
            && link_prefetch_fallback == other.link_prefetch_fallback && text_track_handled == other.text_track_handled
            && text_track_fallback == other.text_track_fallback && audio_handled == other.audio_handled && audio_fallback == other.audio_fallback
            && video_handled == other.video_handled && video_fallback == other.video_fallback && manifest_handled == other.manifest_handled
            && manifest_fallback == other.manifest_fallback && speculation_rules_handled == other.speculation_rules_handled
            && speculation_rules_fallback == other.speculation_rules_fallback && mock_handled == other.mock_handled && mock_fallback == other.mock_fallback
            && dictionary_handled == other.dictionary_handled && dictionary_fallback == other.dictionary_fallback
            && matched_network_router_source_count == other.matched_network_router_source_count
            && matched_fetch_event_router_source_count == other.matched_fetch_event_router_source_count
            && matched_cache_router_source_count == other.matched_cache_router_source_count
            && matched_race_network_and_fetch_router_source_count == other.matched_race_network_and_fetch_router_source_count
            && total_router_evaluation_time_for_subresources == other.total_router_evaluation_time_for_subresources
            && total_cache_lookup_time_for_subresources == other.total_cache_lookup_time_for_subresources;
    }
};
