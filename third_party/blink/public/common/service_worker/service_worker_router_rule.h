...
struct BLINK_COMMON_EXPORT ServiceWorkerRouterRunningStatusCondition {
    ...
    bool operator==(const ServiceWorkerRouterRunningStatusCondition& other) const
    {
...
struct BLINK_COMMON_EXPORT ServiceWorkerRouterNotCondition {
    ...
    ServiceWorkerRouterNotCondition& operator=(const ServiceWorkerRouterNotCondition&);
...
public:
    using MemberRef = std::tuple<std::optional<SafeUrlPattern>&, std::optional<ServiceWorkerRouterRequestCondition>&,
        std::optional<ServiceWorkerRouterRunningStatusCondition>&, std::optional<ServiceWorkerRouterOrCondition>&,
        std::optional<ServiceWorkerRouterNotCondition>&>;
    using MemberConstRef = std::tuple<const std::optional<SafeUrlPattern>&, const std::optional<ServiceWorkerRouterRequestCondition>&,
        const std::optional<ServiceWorkerRouterRunningStatusCondition>&, const std::optional<ServiceWorkerRouterOrCondition>&,
    ...
    ServiceWorkerRouterCondition& operator=(const ServiceWorkerRouterCondition&) = default;
    ServiceWorkerRouterCondition(ServiceWorkerRouterCondition&&) = default;
    ServiceWorkerRouterCondition& operator=(ServiceWorkerRouterCondition&&) = default;

    ServiceWorkerRouterCondition(const std::optional<SafeUrlPattern>& url_pattern, const std::optional<ServiceWorkerRouterRequestCondition>& request,
        const std::optional<ServiceWorkerRouterRunningStatusCondition>& running_status, const std::optional<ServiceWorkerRouterOrCondition>& or_condition,
    ...
    MemberRef get()
    {
        return { url_pattern_, request_, running_status_, or_condition_, not_condition_ };
    }
    ...
    {
        return or_condition_.has_value() != (url_pattern_ || request_ || running_status_ || not_condition_);
    }
    bool IsNotConditionExclusive() const
    {
        return not_condition_.has_value() != (url_pattern_ || request_ || running_status_ || or_condition_);
    }
    ...
    static ServiceWorkerRouterCondition WithUrlPattern(const SafeUrlPattern& url_pattern)
    {
        return { url_pattern, std::nullopt, std::nullopt, std::nullopt, std::nullopt };
    }
    static ServiceWorkerRouterCondition WithRequest(const ServiceWorkerRouterRequestCondition& request)
    {
        return { std::nullopt, request, std::nullopt, std::nullopt, std::nullopt };
    }
    static ServiceWorkerRouterCondition WithRunningStatus(const ServiceWorkerRouterRunningStatusCondition& running_status)
    {
        return { std::nullopt, std::nullopt, running_status, std::nullopt, std::nullopt };
    }
    static ServiceWorkerRouterCondition WithOrCondition(const ServiceWorkerRouterOrCondition& or_condition)
    {
        return { std::nullopt, std::nullopt, std::nullopt, or_condition, std::nullopt };
    }
    static ServiceWorkerRouterCondition WithNotCondition(const ServiceWorkerRouterNotCondition& not_condition)
    {
        return { std::nullopt, std::nullopt, std::nullopt, std::nullopt, not_condition };
    }
