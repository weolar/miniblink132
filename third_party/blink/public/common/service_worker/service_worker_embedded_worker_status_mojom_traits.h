...
template <> struct BLINK_COMMON_EXPORT EnumTraits<blink::mojom::ServiceWorkerEmbeddedWorkerStatus, blink::EmbeddedWorkerStatus> {
    static blink::mojom::ServiceWorkerEmbeddedWorkerStatus ToMojom(blink::EmbeddedWorkerStatus input)
    {
        switch (input) {
    ...
    static bool FromMojom(blink::mojom::ServiceWorkerEmbeddedWorkerStatus input, blink::EmbeddedWorkerStatus* output)
    {
        switch (input) {
