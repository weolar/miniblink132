...
using PermissionsPolicyFeatureToNameMap = base::flat_map<mojom::PermissionsPolicyFeature, std::string_view>;

using PermissionsPolicyNameToFeatureMap = base::flat_map<std::string_view, mojom::PermissionsPolicyFeature>;
