...
using PermissionsPolicyFeatureList = std::map<mojom::PermissionsPolicyFeature, PermissionsPolicyFeatureDefault>;

// `origin` is used, in combination with flags, to decide whether the "unload"
// feature will be enabled or disabled by default.
BLINK_COMMON_EXPORT const PermissionsPolicyFeatureList& GetPermissionsPolicyFeatureList(const url::Origin& origin);
...
using PermissionsPolicyFeatureState = std::map<mojom::PermissionsPolicyFeature, bool>;
