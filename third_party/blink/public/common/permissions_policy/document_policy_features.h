...
using DocumentPolicyFeatureInfoMap = base::flat_map<mojom::DocumentPolicyFeature, DocumentPolicyFeatureInfo>;

using DocumentPolicyFeatureState = base::flat_map<mojom::DocumentPolicyFeature, PolicyValue>;

using DocumentPolicyNameFeatureMap = base::flat_map<std::string, mojom::DocumentPolicyFeature>;

BLINK_COMMON_EXPORT const DocumentPolicyFeatureInfoMap& GetDocumentPolicyFeatureInfoMap();

BLINK_COMMON_EXPORT const DocumentPolicyNameFeatureMap& GetDocumentPolicyNameFeatureMap();
