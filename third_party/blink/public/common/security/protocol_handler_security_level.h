...
inline ProtocolHandlerSecurityLevel ProtocolHandlerSecurityLevelFrom(int security_level)
{
    return security_level < 0 || security_level > static_cast<int>(ProtocolHandlerSecurityLevel::kExtensionFeatures)
