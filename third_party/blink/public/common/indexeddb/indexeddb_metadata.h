...
struct BLINK_COMMON_EXPORT IndexedDBIndexMetadata {
    ...
    IndexedDBIndexMetadata(const std::u16string& name, int64_t id, const blink::IndexedDBKeyPath& key_path, bool unique, bool multi_entry);
...
struct BLINK_COMMON_EXPORT IndexedDBObjectStoreMetadata {
    ...
    IndexedDBObjectStoreMetadata(const std::u16string& name, int64_t id, const blink::IndexedDBKeyPath& key_path, bool auto_increment, int64_t max_index_id);
    ...
    ~IndexedDBObjectStoreMetadata();
    IndexedDBObjectStoreMetadata& operator=(const IndexedDBObjectStoreMetadata& other);
...
struct BLINK_COMMON_EXPORT IndexedDBDatabaseMetadata {
    ...
    IndexedDBDatabaseMetadata(const std::u16string& name, int64_t id, int64_t version, int64_t max_object_store_id);
