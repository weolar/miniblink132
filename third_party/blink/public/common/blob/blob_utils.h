...
public:
    ...
    static uint32_t BLINK_COMMON_EXPORT GetDataPipeCapacity(uint64_t target_blob_size);
    ...
    static constexpr uint64_t BLINK_COMMON_EXPORT kUnknownSize = std::numeric_limits<uint64_t>::max();
};
