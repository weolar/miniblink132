...
private:
    ...
    friend struct mojo::StructTraits<blink::mojom::ViewTransitionElementDataView, ViewTransitionElement>;
    ...
    base::flat_map<blink::mojom::ViewTransitionPropertyId, std::string> captured_css_properties;
...
public:
    bool IsValid() const
    {
        return next_element_resource_id != viz::ViewTransitionElementResourceId::kInvalidLocalId;
    }
    bool HasSubframeSnapshot() const
    {
        return subframe_snapshot_id.IsValid();
    }
...
private:
    ...
    friend struct mojo::StructTraits<blink::mojom::ViewTransitionStateDataView, ViewTransitionState>;
    ...
    uint32_t next_element_resource_id = viz::ViewTransitionElementResourceId::kInvalidLocalId;
