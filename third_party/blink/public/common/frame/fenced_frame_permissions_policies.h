...
// turned off.
static inline constexpr blink::mojom::PermissionsPolicyFeature kFencedFrameAllowedFeatures[]
    = { blink::mojom::PermissionsPolicyFeature::kFencedUnpartitionedStorageRead, blink::mojom::PermissionsPolicyFeature::kPrivateAggregation,
          blink::mojom::PermissionsPolicyFeature::kSharedStorage, blink::mojom::PermissionsPolicyFeature::kSharedStorageSelectUrl };
...
static inline constexpr blink::mojom::PermissionsPolicyFeature kFencedFrameFledgeDefaultRequiredFeatures[]
    = { blink::mojom::PermissionsPolicyFeature::kAttributionReporting, blink::mojom::PermissionsPolicyFeature::kPrivateAggregation,
          blink::mojom::PermissionsPolicyFeature::kSharedStorage, blink::mojom::PermissionsPolicyFeature::kSharedStorageSelectUrl };

static inline constexpr blink::mojom::PermissionsPolicyFeature kFencedFrameSharedStorageDefaultRequiredFeatures[]
    = { blink::mojom::PermissionsPolicyFeature::kAttributionReporting, blink::mojom::PermissionsPolicyFeature::kSharedStorage,
