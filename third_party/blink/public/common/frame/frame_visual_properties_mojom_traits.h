...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::FrameVisualPropertiesDataView, blink::FrameVisualProperties> {
    static const display::ScreenInfos& screen_infos(const blink::FrameVisualProperties& r)
    {
    ...
    static uint32_t capture_sequence_number(const blink::FrameVisualProperties& r)
    {
    ...
    static double compositing_scale_factor(const blink::FrameVisualProperties& r)
    {
        DCHECK_GT(r.compositing_scale_factor, 0);
        return r.compositing_scale_factor;
    }

    static float cursor_accessibility_scale_factor(const blink::FrameVisualProperties& r)
    {
        DCHECK_GE(r.cursor_accessibility_scale_factor, 1.f);
        return r.cursor_accessibility_scale_factor;
    }

    static const gfx::Size& visible_viewport_size(const blink::FrameVisualProperties& r)
    {
        return r.visible_viewport_size;
    }

    static const gfx::Size& min_size_for_auto_resize(const blink::FrameVisualProperties& r)
    {
        return r.min_size_for_auto_resize;
    }

    static const gfx::Size& max_size_for_auto_resize(const blink::FrameVisualProperties& r)
    {
        return r.max_size_for_auto_resize;
    }

    static const std::vector<gfx::Rect>& root_widget_viewport_segments(const blink::FrameVisualProperties& r)
    {
        return r.root_widget_viewport_segments;
    }

    static const gfx::Rect& compositor_viewport(const blink::FrameVisualProperties& r)
    {
        return r.compositor_viewport;
    }

    static const gfx::Rect& rect_in_local_root(const blink::FrameVisualProperties& r)
    {
        return r.rect_in_local_root;
    }

    static const gfx::Size& local_frame_size(const blink::FrameVisualProperties& r)
    {
        return r.local_frame_size;
    }

    static const viz::LocalSurfaceId& local_surface_id(const blink::FrameVisualProperties& r)
    {
        return r.local_surface_id;
    }

    static bool Read(blink::mojom::FrameVisualPropertiesDataView r, blink::FrameVisualProperties* out);
};
