...
private:
    ...
    mojom::FilterListResult latest_filter_list_result_ = mojom::FilterListResult::kNotChecked;
    ...
    mojom::FilterListResult most_restrictive_filter_list_result_ = mojom::FilterListResult::kNotChecked;

    // Whether ad script was on the v8 stack at the time this frame was created.
    mojom::FrameCreationStackEvidence created_by_ad_script_ = mojom::FrameCreationStackEvidence::kNotCreatedByAdScript;
};
