...
template <> class BLINK_COMMON_EXPORT StructTraits<blink::mojom::FrameAdEvidenceDataView, blink::FrameAdEvidence> {
public:
    ...
    static blink::mojom::FilterListResult latest_filter_list_result(const blink::FrameAdEvidence& e)
    {
        return e.latest_filter_list_result();
    }
    static blink::mojom::FilterListResult most_restrictive_filter_list_result(const blink::FrameAdEvidence& e)
    {
        return e.most_restrictive_filter_list_result();
    }
    static blink::mojom::FrameCreationStackEvidence created_by_ad_script(const blink::FrameAdEvidence& e)
    {
        return e.created_by_ad_script();
    }

    static bool Read(blink::mojom::FrameAdEvidenceDataView data, blink::FrameAdEvidence* out);
};
