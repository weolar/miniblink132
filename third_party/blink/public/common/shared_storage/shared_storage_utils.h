...
static constexpr char kSharedStorageModuleScriptNotLoadedErrorMessage[] = "The module script hasn't been loaded.";

static constexpr char kSharedStorageOperationNotFoundErrorMessage[] = "Cannot find operation name.";

static constexpr char kSharedStorageEmptyOperationDefinitionInstanceErrorMessage[] = "Empty operation definition instance.";

static constexpr char kSharedStorageCannotDeserializeDataErrorMessage[] = "Cannot deserialize data.";

static constexpr char kSharedStorageEmptyScriptResultErrorMessage[] = "empty script result.";

static constexpr char kSharedStorageReturnValueToIntErrorMessage[] = "Promise did not resolve to an uint32 number.";

static constexpr char kSharedStorageReturnValueOutOfRangeErrorMessage[] = "Promise resolved to a number outside the length of the input urls.";
...
BLINK_COMMON_EXPORT void LogSharedStorageWorkletError(SharedStorageWorkletErrorType error_type);

// Logs histogram of the `selectURL()` budget status.
BLINK_COMMON_EXPORT void LogSharedStorageSelectURLBudgetStatus(SharedStorageSelectUrlBudgetStatus budget_status);
...
BLINK_COMMON_EXPORT bool IsValidPrivateAggregationContextId(std::string_view context_id);
...
BLINK_COMMON_EXPORT bool IsValidPrivateAggregationFilteringIdMaxBytes(size_t filtering_id_max_bytes);
