...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::ImpressionDataView, blink::Impression> {
    static const blink::AttributionSrcToken& attribution_src_token(const blink::Impression& r)
    {
