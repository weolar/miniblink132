...
BLINK_COMMON_EXPORT mojom::CommonNavigationParamsPtr CreateCommonNavigationParams();
BLINK_COMMON_EXPORT mojom::CommitNavigationParamsPtr CreateCommitNavigationParams();
...
//   reasonable defaults.
BLINK_COMMON_EXPORT mojom::RendererContentSettingsPtr CreateDefaultRendererContentSettings();
