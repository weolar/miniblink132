...
TEST_F(ScriptWrappableV8GCIntegrationTest, V8ReportsLiveObjectsDuringFullGc)
{
    ...
    GCObjectLivenessObserver<DeathAwareScriptWrappable> observer;
    {
        ...
        holder.Reset(GetIsolate(), ToV8Traits<DeathAwareScriptWrappable>::ToV8(scope.GetScriptState(), object));
    }
...
TEST_F(ScriptWrappableV8GCIntegrationTest, OilpanDoesntCollectObjectsReachableFromV8)
{
    V8TestingScope scope;
    SetIsolate(scope.GetIsolate());
...
TEST_F(ScriptWrappableV8GCIntegrationTest, OilpanCollectObjectsNotReachableFromV8)
{
    V8TestingScope scope;
    SetIsolate(scope.GetIsolate());
    ...
    GCObjectLivenessObserver<DeathAwareScriptWrappable> observer;
    {
        ...
        // Creates new V8 wrapper and associates it with global scope
        ToV8Traits<DeathAwareScriptWrappable>::ToV8(scope.GetScriptState(), object).IsEmpty();
    }
