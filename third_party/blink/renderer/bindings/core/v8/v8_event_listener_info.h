...
public:
    V8EventListenerInfo(AtomicString event_type, bool use_capture, bool passive, bool once, v8::Local<v8::Object> handler,
        v8::Local<v8::Function> effective_function, uint64_t backend_node_id)
