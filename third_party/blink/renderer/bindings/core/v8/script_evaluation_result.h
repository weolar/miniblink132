...
public:
    ...
    static ScriptEvaluationResult FromClassicException(v8::Local<v8::Value> exception);
    ...
    static ScriptEvaluationResult FromModuleException(v8::Local<v8::Value> exception);
...
private:
    ScriptEvaluationResult(mojom::blink::ScriptType, ResultType, v8::Local<v8::Value>);
