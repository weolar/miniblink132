...
public:
    ...
    void LogSetter(ScriptState* script_state, const String& api_name, const v8::Local<v8::Value>& new_value) override
    {
        logged_activities_.push_back(api_name + " | " + ToCoreStringWithUndefinedOrNullCheck(script_state->GetIsolate(), new_value));
    }

    void LogMethod(ScriptState* script_state, const String& api_name, base::span<const v8::Local<v8::Value>> args) override
    {
        String activity_string = api_name;
        for (const auto& arg : args) {
            activity_string = activity_string + " | " + ToCoreStringWithUndefinedOrNullCheck(script_state->GetIsolate(), arg);
        }
        logged_activities_.push_back(activity_string);
    }

    void LogEvent(ExecutionContext* execution_context, const String& event_name, base::span<const String> args) override
    {
...
protected:
    ActivityLoggerTest()
    {
        ...
        V8DOMActivityLogger::SetActivityLogger(kIsolatedWorldId, String(), base::WrapUnique(activity_logger_));
    ...
    void ExecuteScriptInIsolatedWorld(const String& script) const
    {
        ...
        ClassicScript::CreateUnspecifiedScript(script)->RunScriptInIsolatedWorldAndReturnValue(local_frame_->DomWindow(), kIsolatedWorldId);
        PumpPendingRequestsForFrameToLoad(web_view_helper_.LocalMainFrame());
    }
...
TEST_F(ActivityLoggerTest, EventHandler)
{
    ...
    const char* expected_activities = "blinkAddEventListener | A | click\n"
                                      "blinkAddElement | a | \n"
...
TEST_F(ActivityLoggerTest, ScriptElement)
{
    const char* code = "document.body.innerHTML = '<script "
                       ...
                       "document.close();";
    const char* expected_activities = "blinkAddElement | script | data:text/javascript;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, IFrameElement)
{
    const char* code = "document.body.innerHTML = '<iframe "
                       ...
                       "document.close();";
    const char* expected_activities = "blinkAddElement | iframe | data:text/html;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, AnchorElement)
{
    const char* code = "document.body.innerHTML = '<a "
                       ...
                       "document.close();";
    const char* expected_activities = "blinkAddElement | a | data:text/css;charset=utf-8,\n"
                                      "blinkAddElement | a | \n"
                                      "blinkAddElement | a | \n"
...
TEST_F(ActivityLoggerTest, LinkElement)
{
    const char* code = "document.body.innerHTML = '<link rel=\\\'stylesheet\\\' "
                       ...
                       "document.close();";
    const char* expected_activities = "blinkAddElement | link | stylesheet | data:text/css;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, InputElement)
{
    const char* code = "document.body.innerHTML = '<input type=\\\'submit\\\' "
                       ...
                       "document.close();";
    const char* expected_activities = "blinkAddElement | input | submit | data:text/html;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, ButtonElement)
{
    const char* code = "document.body.innerHTML = '<button type=\\\'submit\\\' "
                       ...
                       "document.close();";
    const char* expected_activities = "blinkAddElement | button | submit | post | "
...
TEST_F(ActivityLoggerTest, FormElement)
{
    const char* code = "document.body.innerHTML = '<form method=\\\'post\\\' "
                       ...
                       "document.close();";
    const char* expected_activities = "blinkAddElement | form | post | data:text/html;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, ScriptSrcAttribute)
{
    ...
    const char* expected_activities = "blinkAddElement | script | data:text/javascript;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, IFrameSrcAttribute)
{
    ...
    const char* expected_activities = "blinkAddElement | iframe | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, AnchorHrefAttribute)
{
    ...
    const char* expected_activities = "blinkAddElement | a | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, LinkHrefAttribute)
{
    ...
    const char* expected_activities = "blinkAddElement | link | stylesheet | data:text/css;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, InputFormActionAttribute)
{
    ...
    const char* expected_activities = "blinkAddElement | input | button | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, FormActionAttribute)
{
    ...
    const char* expected_activities = "blinkAddElement | form |  | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, LocalDOMWindowAttribute)
{
    ...
    const char* expected_activities = "blinkSetAttribute | LocalDOMWindow | url | about:blank | "
                                      "data:text/html;charset=utf-8,A\n"
                                      "blinkRequestResource | Main resource | data:text/html;charset=utf-8,A\n"
