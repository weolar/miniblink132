...
public:
    ...
    //   property.
    static ScriptIterator FromIterable(v8::Isolate* isolate, v8::Local<v8::Object> iterable, ExceptionState& exception_state, ScriptIterator::Kind kind);
    ...
    bool IsNull() const
    {
        return iterator_.IsEmpty();
    }

    // Returns true if the iterator is still not done.
    bool Next(ExecutionContext* execution_context, ExceptionState& exception_state);
    ...
    ScriptValue CloseSync(ScriptState* script_state, ExceptionState& exception_state, v8::Local<v8::Value> reason);
    ScriptPromise<IDLAny> CloseAsync(
        ScriptState* script_state, const ExceptionContext& exception_context, v8::Local<v8::Value> reason = v8::Local<v8::Value>());
...
private:
    ...
    ScriptIterator(v8::Isolate*, v8::Local<v8::Object> iterator, v8::Local<v8::Value> next_method, Kind kind);
