...
template <> struct HashTraits<blink::Member<blink::BoxedV8Module>> : MemberHashTraits<blink::BoxedV8Module> {
    static unsigned GetHash(const blink::Member<blink::BoxedV8Module>& key)
    {
        return key->identity_hash_;
    }

    static bool Equal(const blink::Member<blink::BoxedV8Module>& a, const blink::Member<blink::BoxedV8Module>& b)
    {
