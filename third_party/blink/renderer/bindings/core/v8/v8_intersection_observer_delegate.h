...
class V8IntersectionObserverDelegate final : public IntersectionObserverDelegate, public ExecutionContextClient {

public:
    CORE_EXPORT V8IntersectionObserverDelegate(V8IntersectionObserverCallback*, ScriptState*);
    ...
    void Deliver(const HeapVector<Member<IntersectionObserverEntry>>&, IntersectionObserver&) override;
