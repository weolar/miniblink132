...
public:
    ...
    static v8::Local<v8::Value> CreateOrEmpty(v8::Isolate*, DOMExceptionCode, const String& sanitized_message, const String& unsanitized_message = String());

    // Same as CreateOrEmpty, but performs CHECK for exception to not be empty.
    static v8::Local<v8::Value> CreateOrDie(v8::Isolate*, DOMExceptionCode, const String& sanitized_message, const String& unsanitized_message = String());

    // Combined CreateOrEmpty() + V8ThrowException::ThrowException().
    static void Throw(v8::Isolate*, DOMExceptionCode, const String& sanitized_message, const String& unsanitized_message = String());
