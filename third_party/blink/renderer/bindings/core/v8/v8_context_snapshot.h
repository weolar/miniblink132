...
public:
    static v8::Local<v8::Context> CreateContextFromSnapshot(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::ExtensionConfiguration* extension_config,
        v8::Local<v8::Object> global_proxy, Document* document);
    ...
    using CreateContextFromSnapshotFuncType
        = v8::Local<v8::Context> (*)(v8::Isolate*, const DOMWrapperWorld&, v8::ExtensionConfiguration*, v8::Local<v8::Object>, Document*);
    static void SetCreateContextFromSnapshotFunc(CreateContextFromSnapshotFuncType func);
    using InstallContextIndependentPropsFuncType = void (*)(ScriptState*);
    static void SetInstallContextIndependentPropsFunc(InstallContextIndependentPropsFuncType func);
    using EnsureInterfaceTemplatesFuncType = void (*)(v8::Isolate*);
    static void SetEnsureInterfaceTemplatesFunc(EnsureInterfaceTemplatesFuncType func);
