...
V8ContextSnapshot::CreateContextFromSnapshotFuncType g_create_context_from_snapshot_func;
V8ContextSnapshot::InstallContextIndependentPropsFuncType g_install_context_independent_props_func;
V8ContextSnapshot::EnsureInterfaceTemplatesFuncType g_ensure_interface_templates_func;
...
{
    return g_create_context_from_snapshot_func(isolate, world, extension_config, global_proxy, document);
}

void V8ContextSnapshot::InstallContextIndependentProps(ScriptState* script_state)
{
...
void V8ContextSnapshot::SetCreateContextFromSnapshotFunc(CreateContextFromSnapshotFuncType func)
{
...
void V8ContextSnapshot::SetInstallContextIndependentPropsFunc(InstallContextIndependentPropsFuncType func)
{
...
void V8ContextSnapshot::SetEnsureInterfaceTemplatesFunc(EnsureInterfaceTemplatesFuncType func)
{
...
void V8ContextSnapshot::SetGetReferenceTableFunc(GetReferenceTableFuncType func)
{
