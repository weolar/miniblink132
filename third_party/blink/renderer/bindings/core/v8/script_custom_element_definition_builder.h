...
class CORE_EXPORT ScriptCustomElementDefinitionBuilder : public CustomElementDefinitionBuilder {
    STACK_ALLOCATED();

public:
    ScriptCustomElementDefinitionBuilder(ScriptState*, CustomElementRegistry*, V8CustomElementConstructor* constructor, ExceptionState&);

    ScriptCustomElementDefinitionBuilder(const ScriptCustomElementDefinitionBuilder&) = delete;
    ScriptCustomElementDefinitionBuilder& operator=(const ScriptCustomElementDefinitionBuilder&) = delete;
