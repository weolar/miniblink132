...
struct V8CustomElementConstructorHashTraits : WTF::MemberHashTraits<V8CustomElementConstructor> {
    static unsigned GetHash(const Member<V8CustomElementConstructor>& constructor)
    {
        return constructor->CallbackObject()->GetIdentityHash();
    }
    static bool Equal(const Member<V8CustomElementConstructor>& a, const Member<V8CustomElementConstructor>& b)
    {
...
struct V8CustomElementConstructorHashTranslator {
    ...
    static bool Equal(const Member<V8CustomElementConstructor>& a, const v8::Local<v8::Object>& b)
    {
