...
public:
    ...
    static bool ParseCSSPropertyList(v8::Local<v8::Context>, const ExecutionContext*, v8::Local<v8::Object> constructor, const AtomicString list_name,
        Vector<CSSPropertyID>* native_properties, Vector<AtomicString>* custom_properties, ExceptionState&);
};
