...
public:
    ...
    static void TrapDefineProperty(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        v8::Isolate* isolate = info.GetIsolate();
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "defineProperty");
        ...
        V8ObjectToPropertyDescriptor(isolate, v8_desc_obj, desc_bag, exception_state);
        ...
        if (v8_property->IsString()) {
            ...
            if (v8_property->ToArrayIndex(current_context).ToLocal(&v8_index)) {
                if ((desc_bag.has_get || desc_bag.has_set) || (desc_bag.has_configurable && !desc_bag.configurable)
                    || (desc_bag.has_enumerable && !desc_bag.enumerable) || (desc_bag.has_writable && !desc_bag.writable)) {
                    V8SetReturnValue(info, false);
                    return;
                }
                uint32_t index = v8_index->Value();
                DoSetTheIndexedValue(isolate, current_context, backing_list, index, desc_bag.value, exception_state);
                if (exception_state.HadException())
                    return;
            ...
            if (v8_property.As<v8::String>()->StringEquals(V8AtomicString(isolate, "length"))) {
                if ((desc_bag.has_get || desc_bag.has_set) || (desc_bag.has_configurable && desc_bag.configurable)
                    || (desc_bag.has_enumerable && desc_bag.enumerable) || (desc_bag.has_writable && !desc_bag.writable)) {
                    V8SetReturnValue(info, false);
                    return;
                }
                DoSetTheLength(isolate, current_context, backing_list, desc_bag.value, exception_state);
                if (exception_state.HadException())
                    return;
                V8SetReturnValue(info, true);
                return;
        ...
        if (desc_bag.has_get || desc_bag.has_set) {
            ...
            if (!v8_target->DefineProperty(current_context, v8_property, desc).To(&is_defined)) {
                return;
            }
        } else {
    ...
    static void TrapDeleteProperty(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        v8::Isolate* isolate = info.GetIsolate();
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "deleteProperty");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (v8_property->IsString()) {
            ...
            if (v8_property->ToArrayIndex(current_context).ToLocal(&v8_index)) {
                ...
                ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "deleteProperty");
                if (!RunDeleteAlgorithm(script_state, backing_list, index, exception_state)) {
                    return;
                }
    ...
    static void TrapGet(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "get");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (v8_property->IsString()) {
            ...
            if (v8_property->ToArrayIndex(current_context).ToLocal(&v8_index)) {
                ...
                ScriptState* script_state = ScriptState::From(isolate, current_context);
                v8::Local<v8::Value> v8_element = ToV8Traits<ElementIdlType>::ToV8(script_state, backing_list[index]);
    ...
    static void TrapGetOwnPropertyDescriptor(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        v8::Isolate* isolate = info.GetIsolate();
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(
                isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "getOwnPropertyDescriptor");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (v8_property->IsString()) {
            ...
            if (v8_property.As<v8::String>()->StringEquals(V8AtomicString(isolate, "length"))) {
                v8::PropertyDescriptor prop_desc(v8::Integer::NewFromUnsigned(isolate, backing_list.size()), true);
        ...
        v8::Local<v8::Value> v8_value;
        if (!v8_target->GetOwnPropertyDescriptor(current_context, v8_property).ToLocal(&v8_value)) {
            return;
        }
        V8SetReturnValue(info, v8_value);
    }
    ...
    static void TrapHas(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "has");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
    ...
    static void TrapOwnKeys(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!info[0]->IsArray()) {
            ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "ownKeys");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        v8::Local<v8::Value> own_keys_as_value = ToV8Traits<IDLSequence<IDLString>>::ToV8(ScriptState::From(isolate, current_context), keys_vector);
        ...
        if (!v8_target->GetOwnPropertyNames(current_context, v8::ALL_PROPERTIES).ToLocal(&own_props)) {
            return;
        }
        ...
        for (uint32_t index = 0; index < own_props_length; ++index) {
            ...
            if (!own_keys->CreateDataProperty(current_context, own_keys_index++, prop_name).To(&is_created)) {
                return;
            }
            DCHECK(is_created);
        }
    ...
    static void TrapPreventExtensions(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        V8SetReturnValue(info, false);
    }
    ...
    static void TrapSet(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
        if (!(info[0]->IsArray() && info[1]->IsName())) {
            ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "set");
            exception_state.ThrowTypeError("Invalid argument.");
            return;
        }
        v8::Local<v8::Array> v8_target = info[0].As<v8::Array>();
        ...
        if (v8_property->IsString()) {
            v8::Local<v8::Uint32> v8_index;
            if (v8_property->ToArrayIndex(current_context).ToLocal(&v8_index)) {
                ExceptionState exception_state(isolate, v8::ExceptionContext::kOperation, BackingListWrappable::ObservableArrayNameInIDL(), "indexed value");
                uint32_t index = v8_index->Value();
                bool result = DoSetTheIndexedValue(isolate, current_context, backing_list, index, v8_value, exception_state);
                V8SetReturnValue(info, result);
                return;
            }

            if (v8_property.As<v8::String>()->StringEquals(V8AtomicString(isolate, "length"))) {
                ExceptionState exception_state(isolate, v8::ExceptionContext::kAttributeSet, BackingListWrappable::ObservableArrayNameInIDL(), "length");
                bool result = DoSetTheLength(isolate, current_context, backing_list, v8_value, exception_state);
                V8SetReturnValue(info, result);
                return;
            }
        }
    ...
    //   argument T:
    static void PerformAttributeSet(
        ScriptState* script_state, BackingListWrappable& backing_list, v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
    {
        v8::Isolate* isolate = script_state->GetIsolate();
        // step 4.5.10.1. Let newValues be the result of converting V to an IDL
        //   value of type sequence<T>.
        auto&& blink_value = NativeValueTraits<IDLSequence<ElementIdlType>>::NativeValue(isolate, v8_value, exception_state);
        if (exception_state.HadException())
            return;
        // step 4.5.10.3. Set the length of oa.[[ProxyHandler]] to 0.
        if (!DoSetTheLength(isolate, script_state->GetContext(), backing_list, 0, exception_state)) {
            return;
        }
        // step 4.5.10.4. Let i be 0.
        // step 4.5.10.5. While i < newValues’s size:
        for (typename BackingListWrappable::size_type i = 0; i < blink_value.size(); ++i) {
            // step 4.5.10.5.1. Perform the algorithm steps given by
            //   oa.[[ProxyHandler]].[[SetAlgorithm]], given newValues[i] and i.
            if (!RunSetAlgorithm(script_state, backing_list, i, blink_value[i], exception_state)) {
                return;
            }
...
private:
    static BackingListWrappable& ToWrappableOrDie(v8::Isolate* isolate, v8::Local<v8::Array> target)
    {
        return *ObservableArrayExoticObject::ProxyTargetToObservableArray<BackingListWrappable>(isolate, target);
    }

    // https://webidl.spec.whatwg.org/#observable-array-exotic-object-set-the-length
    static bool DoSetTheLength(v8::Isolate* isolate, v8::Local<v8::Context> current_context, BackingListWrappable& backing_list, v8::Local<v8::Value> v8_length,
        ExceptionState& exception_state)
    {
        ...
        return DoSetTheLength(isolate, current_context, backing_list, length, exception_state);
    }

    // https://webidl.spec.whatwg.org/#observable-array-exotic-object-set-the-length
    static bool DoSetTheLength(
        v8::Isolate* isolate, v8::Local<v8::Context> current_context, BackingListWrappable& backing_list, uint32_t length, ExceptionState& exception_state)
    {
        ...
        while (length <= index_to_delete) {
            if (!RunDeleteAlgorithm(script_state, backing_list, index_to_delete, exception_state)) {
                return false;
            }
    ...
    static bool DoSetTheIndexedValue(v8::Isolate* isolate, v8::Local<v8::Context> current_context, BackingListWrappable& backing_list, uint32_t index,
        v8::Local<v8::Value> v8_value, ExceptionState& exception_state)
    {
        if (backing_list.size() < index)
            return false;
        ...
        typename BackingListWrappable::value_type blink_value = NativeValueTraits<ElementIdlType>::NativeValue(isolate, v8_value, exception_state);
        if (exception_state.HadException())
            return false;
        ...
        if (!RunSetAlgorithm(script_state, backing_list, index, blink_value, exception_state)) {
            return false;
        }
    ...
    static bool RunSetAlgorithm(ScriptState* script_state, BackingListWrappable& backing_list, typename BackingListWrappable::size_type index,
        typename BackingListWrappable::value_type& value, ExceptionState& exception_state)
    {
        if (!backing_list.set_algorithm_callback_)
            return true;

        backing_list.set_algorithm_callback_(backing_list.GetPlatformObject(), script_state, backing_list, index, value, exception_state);
        return !exception_state.HadException();
    }

    // https://webidl.spec.whatwg.org/#observable-array-attribute-delete-an-indexed-value
    static bool RunDeleteAlgorithm(
        ScriptState* script_state, BackingListWrappable& backing_list, typename BackingListWrappable::size_type index, ExceptionState& exception_state)
    {
        if (!backing_list.delete_algorithm_callback_)
            return true;

        backing_list.delete_algorithm_callback_(backing_list.GetPlatformObject(), script_state, backing_list, index, exception_state);
        return !exception_state.HadException();
    }
};
