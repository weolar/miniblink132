...
public:
    ...
    ScriptCustomElementDefinitionData(const ScriptCustomElementDefinitionData&) = delete;
    ScriptCustomElementDefinitionData& operator=(const ScriptCustomElementDefinitionData&) = delete;
    ...
    V8CustomElementAttributeChangedCallback* attribute_changed_callback_ = nullptr;
    ...
    V8CustomElementFormStateRestoreCallback* form_state_restore_callback_ = nullptr;
