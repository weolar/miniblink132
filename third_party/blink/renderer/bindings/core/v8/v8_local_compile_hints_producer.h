...
class CORE_EXPORT V8LocalCompileHintsProducer : public GarbageCollected<V8LocalCompileHintsProducer> {
public:
    ...
    V8LocalCompileHintsProducer& operator=(const V8LocalCompileHintsProducer&) = delete;

    ~V8LocalCompileHintsProducer() = default;
    void RecordScript(ExecutionContext* execution_context, const v8::Local<v8::Script> script, ClassicScript* classic_script);
    void GenerateData(bool final_data);

    void Trace(Visitor* visitor) const;

    static v8::ScriptCompiler::CachedData* CreateCompileHintsCachedDataForScript(std::vector<int>& compile_hints, uint64_t prefix);
