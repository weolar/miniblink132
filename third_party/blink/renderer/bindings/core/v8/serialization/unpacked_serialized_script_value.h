...
class CORE_EXPORT UnpackedSerializedScriptValue final : public GarbageCollected<UnpackedSerializedScriptValue> {
public:
    ...
    const SerializedScriptValue* Value() const
    {
        return value_.get();
    }
    ...
    v8::Local<v8::Value> Deserialize(v8::Isolate*, const DeserializeOptions& = DeserializeOptions());
