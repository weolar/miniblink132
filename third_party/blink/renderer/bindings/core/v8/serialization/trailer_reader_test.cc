...
{
    return !arg.has_value() && arg.error() == TrailerReader::Error::kInvalidHeader;
}
...
{
    return !arg.has_value() && arg.error() == TrailerReader::Error::kInvalidTrailer;
}
...
{
    constexpr uint8_t kData[] = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    TrailerReader reader(kData);
    EXPECT_THAT(reader.SkipToTrailer(), SawInvalidHeader());
}
...
{
    constexpr uint8_t kData[] = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x0f, '0' };
    TrailerReader reader(kData);
    EXPECT_THAT(reader.SkipToTrailer(), FoundNoTrailer());
}
...
{
    constexpr uint8_t kData[] = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xff, 0x0f, '0' };
    TrailerReader reader(kData);
    EXPECT_THAT(reader.SkipToTrailer(), SawInvalidHeader());
}
...
{
    constexpr uint8_t kData[] = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x10, 0xff, 0x0f, '0' };
    TrailerReader reader(kData);
    EXPECT_THAT(reader.SkipToTrailer(), SawInvalidHeader());
}
...
TEST(TrailerReaderTest, SkipToTrailer_SizeTooLarge)
{
    constexpr uint8_t kData[]
        = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x14, 0xff, 0x0f, '0', 't', 'e', 's', 't' };
    TrailerReader reader(kData);
    EXPECT_THAT(reader.SkipToTrailer(), SawInvalidHeader());
}
...
{
    constexpr uint8_t kData[]
        = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x04, 0xff, 0x0f, '0', 't', 'e', 's', 't' };
    TrailerReader reader(kData);
...
{
    constexpr uint8_t kData[] = { 0xa0, 0x00, 0x00, 0x00, 0x02, kImageBitmapTag, kCryptoKeyTag };
    TrailerReader reader(kData);
    EXPECT_THAT(reader.Read(), Succeeded());
    EXPECT_THAT(reader.required_exposed_interfaces(), UnorderedElementsAre(kImageBitmapTag, kCryptoKeyTag));
}

TEST(TrailerReaderTest, Read_AfterSkipToTrailer)
{
    constexpr uint8_t kData[] = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x07, 0xff, 0x0f, '0', 0xa0, 0x00, 0x00,
        0x00, 0x02, kImageBitmapTag, kCryptoKeyTag };
    TrailerReader reader(kData);
...
{
    constexpr uint8_t kData[] = { 0xff, 0x15, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x05, 0xff, 0x0f, '0', 0xa0, 0x00, 0x00,
        0x00, 0x02, kImageBitmapTag, kCryptoKeyTag };
    TrailerReader reader(kData);
    ASSERT_THAT(reader.SkipToTrailer(), FoundTrailer());
    EXPECT_EQ(reader.GetPositionForTesting(), 18u);
