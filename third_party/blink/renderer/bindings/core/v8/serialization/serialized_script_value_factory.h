...
public:
    ...
    SerializedScriptValueFactory& operator=(const SerializedScriptValueFactory&) = delete;
...
protected:
    ...
    virtual bool ExtractTransferable(v8::Isolate*, v8::Local<v8::Value>, wtf_size_t object_index, Transferables&, ExceptionState&);

    virtual scoped_refptr<SerializedScriptValue> Create(v8::Isolate*, v8::Local<v8::Value>, const SerializedScriptValue::SerializeOptions&, ExceptionState&);

    virtual v8::Local<v8::Value> Deserialize(scoped_refptr<SerializedScriptValue>, v8::Isolate*, const SerializedScriptValue::DeserializeOptions&);

    virtual v8::Local<v8::Value> Deserialize(UnpackedSerializedScriptValue*, v8::Isolate*, const SerializedScriptValue::DeserializeOptions&);

    virtual bool ExecutionContextExposesInterface(ExecutionContext*, SerializationTag);
