...
class NotReachedResolveFunction : public ThenCallable<GarbageCollectedScriptWrappable, NotReachedResolveFunction> {
public:
...
class NotReachedRejectFunction : public ThenCallable<IDLAny, NotReachedRejectFunction> {
public:
...
class ScriptWrappableReaction : public ThenCallable<GarbageCollectedScriptWrappable, ScriptWrappableReaction> {
public:
    ...
    GarbageCollectedScriptWrappable* Result() const
    {
        return result_;
    }
    ...
    void Trace(Visitor* visitor) const override
    {
        ...
        ThenCallable<GarbageCollectedScriptWrappable, ScriptWrappableReaction>::Trace(visitor);
    }
...
template <typename IDLType, typename ValueType> class StubResolveFunction : public ThenCallable<IDLType, StubResolveFunction<IDLType, ValueType>> {
public:
...
public:
    typedef ScriptPromiseProperty<GarbageCollectedScriptWrappable, GarbageCollectedScriptWrappable> Property;
...
public:
    using Property = ScriptPromiseProperty<GarbageCollectedScriptWrappable, GarbageCollectedScriptWrappable>;
...
public:
    ...
    {
        {
            ...
            MainScriptState()->GetContext()->GetMicrotaskQueue()->PerformCheckpoint(GetIsolate());
        }
        {
            ScriptState::Scope scope(OtherScriptState());
            OtherScriptState()->GetContext()->GetMicrotaskQueue()->PerformCheckpoint(GetIsolate());
        }
    }
    ...
    template <typename IDLType = GarbageCollectedScriptWrappable, typename ValueType>
    StubResolveFunction<IDLType, ValueType>* StubResolve(ValueType& value, size_t& call_count)
    {
        return MakeGarbageCollected<StubResolveFunction<IDLType, ValueType>>(value, call_count);
    }
    ...
    ScriptValue Wrap(DOMWrapperWorld& world, GarbageCollectedScriptWrappable* value)
    {
        v8::Isolate* isolate = GetIsolate();
        v8::HandleScope handle_scope(isolate);
        ScriptState* script_state = ScriptState::From(isolate, ToV8Context(DomWindow(), world));
        ScriptState::Scope scope(script_state);
        return ScriptValue(isolate, ToV8Traits<GarbageCollectedScriptWrappable>::ToV8(script_state, value));
    }
...
public:
    ...
    GarbageCollectedHolder* Holder()
    {
        return holder_;
    }
    Property* GetProperty()
    {
        return holder_->GetProperty();
    }
    ScriptPromise<GarbageCollectedScriptWrappable> Promise(DOMWrapperWorld& world)
    {
...
public:
    template <typename T> void Test(const T::ImplType& value, const char* expected, const char* file, int line)
    {
        ...
        typename T::ImplType actual_value;
        {
            ...
            property->Promise(DOMWrapperWorld::MainWorld(GetIsolate()))
                .React(CurrentScriptState(), StubResolve<T>(actual_value, n_resolve_calls), NotReachedReject());
        }
...
TEST_F(ScriptPromisePropertyGarbageCollectedTest, Promise_IsStableObjectInMainWorld)
{
    ...
    {
        ScriptState::Scope scope(MainScriptState());
        EXPECT_EQ(v.V8Promise()->GetCreationContextChecked(), ToV8Context(DomWindow(), MainWorld()));
    }
...
TEST_F(ScriptPromisePropertyGarbageCollectedTest, Promise_IsStableObjectInVariousWorlds)
{
    ...
    {
        ScriptState::Scope scope(OtherScriptState());
        EXPECT_EQ(u.V8Promise()->GetCreationContextChecked(), ToV8Context(DomWindow(), OtherWorld()));
    }
    {
        ScriptState::Scope scope(MainScriptState());
        EXPECT_EQ(v.V8Promise()->GetCreationContextChecked(), ToV8Context(DomWindow(), MainWorld()));
...
TEST_F(ScriptPromisePropertyGarbageCollectedTest, Promise_IsStableObjectAfterSettling)
{
    ...
    GarbageCollectedScriptWrappable* value = MakeGarbageCollected<GarbageCollectedScriptWrappable>("value");
...
TEST_F(ScriptPromisePropertyGarbageCollectedTest, Promise_DoesNotImpedeGarbageCollection)
{
    Persistent<GCObservation> observation;
    {
        ...
        observation = MakeGarbageCollected<GCObservation>(GetIsolate(), Promise(DOMWrapperWorld::MainWorld(GetIsolate())).V8Promise());
    }
...
{
    auto promise = GetProperty()->Promise(DOMWrapperWorld::MainWorld(GetIsolate()));
    ...
    {
        ScriptState::Scope scope(OtherScriptState());
        other_promise.React(CurrentScriptState(), other_reaction, NotReachedReject());
    }
...
{
    GarbageCollectedScriptWrappable* reason = MakeGarbageCollected<GarbageCollectedScriptWrappable>("reason");
    ...
    {
        ScriptState::Scope scope(MainScriptState());
        GetProperty()->Promise(DOMWrapperWorld::MainWorld(GetIsolate())).React(CurrentScriptState(), NotReachedResolve(), StubReject(actual, n_reject_calls));
    }

    {
        ScriptState::Scope scope(OtherScriptState());
        GetProperty()->Promise(OtherWorld()).React(CurrentScriptState(), NotReachedResolve(), StubReject(other_actual, n_other_reject_calls));
    }
...
{
    v8::Isolate* isolate = GetIsolate();
    GetProperty()->Resolve(MakeGarbageCollected<GarbageCollectedScriptWrappable>("value"));
    EXPECT_EQ(Property::kResolved, GetProperty()->GetState());

    DestroyContext();

    EXPECT_TRUE(GetProperty()->Promise(DOMWrapperWorld::MainWorld(isolate)).IsEmpty());
}
...
TEST_F(ScriptPromisePropertyGarbageCollectedTest, Resolve_DeadContext)
{
    {
        ScriptState::Scope scope(MainScriptState());
        GetProperty()->Promise(DOMWrapperWorld::MainWorld(GetIsolate())).React(CurrentScriptState(), NotReachedResolve(), NotReachedReject());
    }
...
TEST_F(ScriptPromisePropertyGarbageCollectedTest, Reset)
{
    ...
    GarbageCollectedScriptWrappable* old_value = MakeGarbageCollected<GarbageCollectedScriptWrappable>("old");
    GarbageCollectedScriptWrappable* new_value = MakeGarbageCollected<GarbageCollectedScriptWrappable>("new");
...

    {
        ...
        new_promise.React(CurrentScriptState(), NotReachedResolve(), StubReject(new_actual, n_new_reject_calls));
...
TEST_F(ScriptPromisePropertyGarbageCollectedTest, SyncResolve)
{
    ...
    auto* resolution = MakeGarbageCollected<GarbageCollectedScriptWrappable>("hi");
    v8::HandleScope handle_scope(GetIsolate());
    v8::Local<v8::Object> main_v8_resolution;
    v8::Local<v8::Object> other_v8_resolution;
    {
        ScriptState::Scope scope(MainScriptState());
        v8::MicrotasksScope microtasks_scope(GetIsolate(), ToMicrotaskQueue(MainScriptState()), v8::MicrotasksScope::kDoNotRunMicrotasks);
        main_v8_resolution = ToV8Traits<GarbageCollectedScriptWrappable>::ToV8(MainScriptState(), resolution).As<v8::Object>();
        v8::PropertyDescriptor descriptor(
            MakeGarbageCollected<ScriptPromisePropertyResetter>(GetProperty())->ToV8Function(MainScriptState()), v8::Undefined(GetIsolate()));
        ASSERT_EQ(v8::Just(true),
            main_v8_resolution->DefineProperty(MainScriptState()->GetContext(), v8::String::NewFromUtf8Literal(GetIsolate(), "then"), descriptor));
    }
    {
        ScriptState::Scope scope(OtherScriptState());
        v8::MicrotasksScope microtasks_scope(GetIsolate(), ToMicrotaskQueue(OtherScriptState()), v8::MicrotasksScope::kDoNotRunMicrotasks);
        other_v8_resolution = ToV8Traits<GarbageCollectedScriptWrappable>::ToV8(OtherScriptState(), resolution).As<v8::Object>();
        v8::PropertyDescriptor descriptor(
            MakeGarbageCollected<ScriptPromisePropertyResetter>(GetProperty())->ToV8Function(OtherScriptState()), v8::Undefined(GetIsolate()));
        ASSERT_EQ(v8::Just(true),
            other_v8_resolution->DefineProperty(OtherScriptState()->GetContext(), v8::String::NewFromUtf8Literal(GetIsolate(), "then"), descriptor));
    }
