...
private:
    ...
    template <typename Traits> friend class DecoderTemplate;
    ...
    template <typename Traits> friend class EncoderBase;
    friend class EventSource;
    friend class FetchEvent;
    friend class FileReader;
    friend class FileWriter;
    friend class FontFace;
    template <typename NativeFrameType> friend class FrameQueueUnderlyingSource;
