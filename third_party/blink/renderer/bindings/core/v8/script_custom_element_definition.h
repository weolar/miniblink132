...
class CORE_EXPORT ScriptCustomElementDefinition final : public CustomElementDefinition {
public:
    ScriptCustomElementDefinition(const ScriptCustomElementDefinitionData& data, const CustomElementDescriptor&);

    ScriptCustomElementDefinition(const ScriptCustomElementDefinition&) = delete;
    ScriptCustomElementDefinition& operator=(const ScriptCustomElementDefinition&) = delete;
    ...
    HTMLElement* CreateAutonomousCustomElementSync(Document&, const QualifiedName&) override;
