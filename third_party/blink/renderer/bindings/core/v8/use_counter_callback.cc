...
void UseCounterCallback(v8::Isolate* isolate, v8::Isolate::UseCounterFeature feature)
{
    ...
    case v8::Isolate::kSharedArrayBufferConstructed: {
        ExecutionContext* current_execution_context = CurrentExecutionContext(isolate);
        ...
        bool is_cross_origin_isolated = current_execution_context->CrossOriginIsolatedCapability();
        String protocol = current_execution_context->GetSecurityOrigin()->Protocol();
        bool scheme_allows_sab = SchemeRegistry::ShouldTreatURLSchemeAsAllowingSharedArrayBuffers(protocol);
        bool is_extension_scheme = CommonSchemeRegistry::IsExtensionScheme(protocol.Ascii());

        if (!is_cross_origin_isolated && is_extension_scheme) {
            DCHECK(scheme_allows_sab);
            blink_feature = WebFeature::kV8SharedArrayBufferConstructedInExtensionWithoutIsolation;
            deprecated = true;
            ...
            // per context.
            if (!current_execution_context->has_filed_shared_array_buffer_creation_issue()) {
                current_execution_context->FileSharedArrayBufferCreationIssue();
            }
            blink_feature = WebFeature::kV8SharedArrayBufferConstructedWithoutIsolation;
            deprecated = true;
        }
        break;
    }
    ...
    case v8::Isolate::kInvalidatedArrayIteratorLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedArrayIteratorLookupChainProtector;
        break;
    case v8::Isolate::kInvalidatedArraySpeciesLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedArraySpeciesLookupChainProtector;
        break;
    case v8::Isolate::kInvalidatedIsConcatSpreadableLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedIsConcatSpreadableLookupChainProtector;
        break;
    ...
    case v8::Isolate::kInvalidatedPromiseResolveLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedPromiseResolveLookupChainProtector;
        break;
    case v8::Isolate::kInvalidatedPromiseSpeciesLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedPromiseSpeciesLookupChainProtector;
        break;
    ...
    case v8::Isolate::kInvalidatedRegExpSpeciesLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedRegExpSpeciesLookupChainProtector;
        break;
    ...
    case v8::Isolate::kInvalidatedStringIteratorLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedStringIteratorLookupChainProtector;
        break;
    case v8::Isolate::kInvalidatedStringLengthOverflowLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedStringLengthOverflowLookupChainProtector;
        break;
    case v8::Isolate::kInvalidatedTypedArraySpeciesLookupChainProtector:
        blink_feature = WebFeature::kV8InvalidatedTypedArraySpeciesLookupChainProtector;
        break;
    case v8::Isolate::kInvalidatedNumberStringNotRegexpLikeProtector:
        blink_feature = WebFeature::kV8InvalidatedNumberStringNotRegexpLikeProtector;
        break;
    ...
    if (deprecated) {
        Deprecation::CountDeprecation(CurrentExecutionContext(isolate), blink_feature);
    } else {
