...
public:
    static JSEventHandlerForContentAttribute* Create(
        ExecutionContext*, const QualifiedName&, const AtomicString& value, JSEventHandler::HandlerType = JSEventHandler::HandlerType::kEventHandler);
    JSEventHandlerForContentAttribute(ExecutionContext*, const QualifiedName&, const AtomicString& value, JSEventHandler::HandlerType);

    // blink::EventListener overrides:
    bool IsEventHandlerForContentAttribute() const override
    {
        return true;
    }
    ...
    const String& ScriptBody() const override
    {
        return script_body_;
    }
