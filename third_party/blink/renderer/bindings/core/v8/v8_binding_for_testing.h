...
public:
    ...
    void RunV8MinorGC()
    {
        isolate_->RequestGarbageCollectionForTesting(v8::Isolate::GarbageCollectionType::kMinorGarbageCollection);
    }

    void RunV8FullGC(cppgc::EmbedderStackState stack_state = cppgc::EmbedderStackState::kNoHeapPointers)
    {
