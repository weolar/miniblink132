...
// `FrozenArrayBase`.
template <typename IDLType> class FrozenArray final : public bindings::FrozenArrayBase {
public:
    ...
    FrozenArray() = default;
    explicit FrozenArray(VectorType array)
...
protected:
    ...
    v8::Local<v8::Value> MakeV8ArrayToBeFrozen(ScriptState* script_state) const override
    {
