...
MODULES_EXPORT v8::Local<v8::Value> DeserializeIDBValue(ScriptState*, const IDBValue*);

v8::Local<v8::Value> DeserializeIDBValueArray(ScriptState*, const Vector<std::unique_ptr<IDBValue>>&);
...
template <> struct NativeValueTraits<SQLValue> {
...
// recursively check.
MODULES_EXPORT std::unique_ptr<IDBKey> CreateIDBKeyFromValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
