...
class CONTROLLER_EXPORT JavaScriptCallStackGenerator : public mojom::blink::CallStackGenerator {
public:
    static void Bind(mojo::PendingReceiver<mojom::blink::CallStackGenerator> receiver);
...
private:
    ...
    WTF::HashMap<JavaScriptCallStackCollector*, std::unique_ptr<JavaScriptCallStackCollector>> collectors_;
};
