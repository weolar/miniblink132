...
class CONTROLLER_EXPORT V8DetailedMemoryReporterImpl : public mojom::blink::V8DetailedMemoryReporter {
public:
    static void Bind(mojo::PendingReceiver<mojom::blink::V8DetailedMemoryReporter> receiver);
