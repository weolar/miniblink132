...
class MockUserLevelMemoryPressureSignalGenerator : public UserLevelMemoryPressureSignalGenerator {
public:
    explicit MockUserLevelMemoryPressureSignalGenerator(scoped_refptr<base::TestMockTimeTaskRunner> mock_time_task_runner, base::TimeDelta inert_interval,
        base::TimeDelta minimum_interval, MainThreadScheduler* main_thread_scheduler)
        : UserLevelMemoryPressureSignalGenerator(
            mock_time_task_runner, inert_interval, minimum_interval, mock_time_task_runner->GetMockTickClock(), main_thread_scheduler)
    {
        ON_CALL(*this, Generate(_)).WillByDefault(testing::Invoke(this, &MockUserLevelMemoryPressureSignalGenerator::RealGenerate));
    }
...
public:
    ...
    void SetUp() override
    {
        ...
        memory_pressure_listener_
            = std::make_unique<base::MemoryPressureListener>(FROM_HERE, WTF::BindRepeating([](base::MemoryPressureListener::MemoryPressureLevel) {}),
                WTF::BindRepeating(&UserLevelMemoryPressureSignalGeneratorTest::OnSyncMemoryPressure, base::Unretained(this)));
    ...
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> CreateUserLevelMemoryPressureSignalGenerator(base::TimeDelta inert_interval)
    {
        return std::make_unique<MockUserLevelMemoryPressureSignalGenerator>(test_task_runner_, inert_interval, kMinimumInterval, &dummy_scheduler_);
    }
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, GenerateImmediatelyIfInertIntervalIsNegative)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(base::TimeDelta::Min()));
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, GenerateImmediatelyNotLoading)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, GenerateImmediatelyInertIntervalAfterFinishLoading)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, GenerateInertIntervalAfterFinishLoadingIfRequestedWhileLoading)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, GenerateInertIntervalAfterFinishLoadingIfRequestedWhileInert)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, GenerateIfLoadingIsRestarted)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, NoPressureSignalsIfRequestIsExpired)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, TwoRequestsAndOneIsExpired)
{
    ...
    base::TimeDelta time_to_expire = (first_requested_time + kMinimumInterval) - NowTicks();
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, TwoRequestsCauseSignalsAtTheSameTime)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
  ...
  //             |                             /   v
    ...
    test_task_runner_->PostDelayedTask(FROM_HERE,
        WTF::BindOnce(&UserLevelMemoryPressureSignalGenerator::RequestMemoryPressureSignal, WTF::UnretainedWrapper(generator.get())), kInertInterval);
...
TEST_F(UserLevelMemoryPressureSignalGeneratorTest, DoesNotGenerateSignalDuringInertInterval)
{
    std::unique_ptr<MockUserLevelMemoryPressureSignalGenerator> generator(CreateUserLevelMemoryPressureSignalGenerator(kInertInterval));
