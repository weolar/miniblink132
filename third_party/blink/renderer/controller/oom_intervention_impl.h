...
class CONTROLLER_EXPORT OomInterventionImpl : public mojom::blink::OomIntervention, public MemoryUsageMonitor::Observer {
public:
    static void BindReceiver(scoped_refptr<base::SingleThreadTaskRunner> task_runner, mojo::PendingReceiver<mojom::blink::OomIntervention> receiver);

    explicit OomInterventionImpl(base::PassKey<OomInterventionImpl> pass_key, scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    ~OomInterventionImpl() override;

    // mojom::blink::OomIntervention:
    void StartDetection(mojo::PendingRemote<mojom::blink::OomInterventionHost> host, mojom::blink::DetectionArgsPtr detection_args, bool renderer_pause_enabled,
...
protected:
    explicit OomInterventionImpl(scoped_refptr<base::SingleThreadTaskRunner> task_runner);
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(OomInterventionImplTest, ContinueWatchingWithoutDetection);
