...
public:
    using FinishedCallback = base::OnceCallback<void(JavaScriptCallStackCollector*)>;
    using CollectJavaScriptCallStackCallback = mojom::blink::CallStackGenerator::CollectJavaScriptCallStackCallback;

    explicit JavaScriptCallStackCollector(CollectJavaScriptCallStackCallback&& result_callback, FinishedCallback finished_callback)
    ...
    void HandleCallStackCollected(const String& call_stack, const std::optional<LocalFrameToken> frame_token);
