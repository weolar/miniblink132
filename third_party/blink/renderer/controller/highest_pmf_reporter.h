...
class CONTROLLER_EXPORT HighestPmfReporter : public MemoryUsageMonitor::Observer {
...
private:
    explicit HighestPmfReporter(scoped_refptr<base::SingleThreadTaskRunner> task_runner);

    // The constructor for testing.
    HighestPmfReporter(scoped_refptr<base::SingleThreadTaskRunner> task_runner_for_testing, const base::TickClock* clock);
