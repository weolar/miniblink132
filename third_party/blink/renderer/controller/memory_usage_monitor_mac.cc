...
constexpr mach_msg_type_number_t ChromeTaskVMInfoCount = TASK_VM_INFO_REV2_COUNT;
...
constexpr mach_msg_type_number_t MAX_MIG_SIZE_FOR_1014 = 52 / (sizeof(natural_t) / sizeof(integer_t));
static_assert(ChromeTaskVMInfoCount <= MAX_MIG_SIZE_FOR_1014, "task_vm_info must be small enough for 10.14 MIG interfaces");
...
bool MemoryUsageMonitorMac::CalculateProcessMemoryFootprint(uint64_t* private_footprint)
{
