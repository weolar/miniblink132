...
public:
    ...
    ScriptPromise<IDLSequence<CrosNetworkInterface>> getNetworkInterfaces(ScriptState* script_state);
...
private:
    ...
    void OnGetCpuInfoResponse(ScriptPromiseResolver<CrosCpuInfo>* resolver, mojom::blink::GetCpuInfoResultPtr result);

    void OnGetNetworkInterfacesResponse(ScriptPromiseResolver<IDLSequence<CrosNetworkInterface>>* resolver, mojom::blink::GetNetworkInterfacesResultPtr result);
