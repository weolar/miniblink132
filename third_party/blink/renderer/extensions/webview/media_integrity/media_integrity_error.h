...
public:
    ...
    static MediaIntegrityError* Create(String message, const MediaIntegrityErrorOptions* options);

    // Constructor for C++ code, which attaches stack trace.
    static v8::Local<v8::Value> CreateForName(v8::Isolate* isolate, V8MediaIntegrityErrorName::Enum name);

    // Constructor for C++ code, which attaches stack trace.
    static v8::Local<v8::Value> CreateFromMojomEnum(v8::Isolate* isolate, mojom::blink::WebViewMediaIntegrityErrorCode error_code);
