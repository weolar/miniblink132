...
class EXTENSIONS_WEBVIEW_EXPORT WebViewAndroid : public ScriptWrappable, public Supplement<ExecutionContext>, public ExecutionContextClient {
...
public:
    ...
    ScriptPromise<MediaIntegrityTokenProvider> getExperimentalMediaIntegrityTokenProvider(
...
private:
    ...
    void OnGetIntegrityProviderResponse(ScriptState* script_state, mojo::PendingRemote<mojom::blink::WebViewMediaIntegrityProvider> provider_pending_remote,
        uint64_t cloud_project_number, ScriptPromiseResolver<MediaIntegrityTokenProvider>* resolver,
        std::optional<mojom::blink::WebViewMediaIntegrityErrorCode> error);

    HeapHashSet<Member<ScriptPromiseResolver<MediaIntegrityTokenProvider>>> provider_resolvers_;
    HeapMojoRemote<mojom::blink::WebViewMediaIntegrityService> media_integrity_service_remote_;
};
