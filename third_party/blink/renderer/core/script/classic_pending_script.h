...
class CORE_EXPORT ClassicPendingScript final : public PendingScript, public ResourceClient, public ScriptCacheConsumerClient {
public:
    ...
    static ClassicPendingScript* Fetch(const KURL&, Document&, const ScriptFetchOptions&, CrossOriginAttributeValue, const WTF::TextEncoding&,
        ScriptElementBase*, FetchParameters::DeferOption, scheduler::TaskAttributionInfo* parent_task);

    // For an inline script.
    static ClassicPendingScript* CreateInline(ScriptElementBase*, const TextPosition&, const KURL& source_url, const KURL& base_url, const String& source_text,
        ScriptSourceLocationType, const ScriptFetchOptions&, scheduler::TaskAttributionInfo*);

    ClassicPendingScript(ScriptElementBase*, const TextPosition&, const KURL& source_url_for_inline_script, const KURL& base_url_for_inline_script,
        const String& source_text_for_inline_script, ScriptSourceLocationType, const ScriptFetchOptions&, bool is_external,
