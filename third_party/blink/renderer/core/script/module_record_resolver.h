...
// descendant.
class CORE_EXPORT ModuleRecordResolver : public GarbageCollected<ModuleRecordResolver> {
public:
    ...
    virtual const ModuleScript* GetModuleScriptFromModuleRecord(v8::Local<v8::Module>) const = 0;
    ...
    virtual v8::Local<v8::Module> Resolve(const ModuleRequest& module_request, v8::Local<v8::Module> referrer, ExceptionState&) = 0;
};
