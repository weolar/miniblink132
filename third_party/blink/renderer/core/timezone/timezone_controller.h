...
class CORE_EXPORT TimeZoneController final : public device::mojom::blink::TimeZoneMonitorClient {
public:
    ...
    static std::unique_ptr<TimeZoneOverride> SetTimeZoneOverride(const String& timezone_id);
