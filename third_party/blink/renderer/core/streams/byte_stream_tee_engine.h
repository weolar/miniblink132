...
public:
    ...
    ReadableStream* Branch1() const
    {
        return branch_[0].Get();
    }
    ReadableStream* Branch2() const
    {
        return branch_[1].Get();
    }
...
private:
    ...
    void ForwardReaderError(ScriptState*, ReadableStreamGenericReader* this_reader);

    void PullWithDefaultReader(ScriptState*, ExceptionState&);

    void PullWithBYOBReader(ScriptState*, NotShared<DOMArrayBufferView> view, bool for_branch_2, ExceptionState&);
