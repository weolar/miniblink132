...
public:
    ...
    virtual v8::Local<v8::Value> CallWithLocal(ScriptState*, v8::Local<v8::Value>) = 0;
...
CORE_EXPORT v8::Local<v8::Promise> StreamThenPromise(ScriptState*, v8::Local<v8::Promise>, ScriptFunction* on_fulfilled, ScriptFunction* on_rejected = nullptr);
