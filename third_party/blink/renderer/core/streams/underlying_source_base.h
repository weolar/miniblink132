...
class CORE_EXPORT UnderlyingSourceBase : public GarbageCollected<UnderlyingSourceBase>, public ExecutionContextLifecycleObserver {
public:
    void Trace(Visitor*) const override;
    ~UnderlyingSourceBase() override = default;

    ScriptPromise<IDLUndefined> StartWrapper(ScriptState*, ReadableStreamDefaultController*, ExceptionState&);
    ...
    ScriptPromise<IDLUndefined> CancelWrapper(ScriptState*, ScriptValue reason, ExceptionState&);
    virtual ScriptPromise<IDLUndefined> Cancel(ScriptState*, ScriptValue reason, ExceptionState&);
...
public:
    UnderlyingStartAlgorithm(UnderlyingSourceBase* source, ReadableStreamDefaultController* controller)
        : source_(source)
        , controller_(controller)
    {
    }

    v8::MaybeLocal<v8::Promise> Run(ScriptState* script_state, ExceptionState&) final;
...
public:
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) final;
    void Trace(Visitor* visitor) const final;
