...
CORE_EXPORT StreamAlgorithm* CreateAlgorithmFromUnderlyingMethod(ScriptState*, v8::Local<v8::Object> underlying_object, const char* method_name,
    const char* method_name_for_error, v8::MaybeLocal<v8::Value> extra_arg, ExceptionState&);
...
CORE_EXPORT v8::MaybeLocal<v8::Value> ResolveMethod(
    ScriptState*, v8::Local<v8::Object> object, const char* method_name, const char* name_for_error, ExceptionState&);
...
CORE_EXPORT StreamAlgorithm* CreateAlgorithmFromResolvedMethod(
    ScriptState*, v8::Local<v8::Object> underlying_object, v8::Local<v8::Value> method, v8::MaybeLocal<v8::Value> extra_arg);
...
CORE_EXPORT StreamStartAlgorithm* CreateStartAlgorithm(
    ScriptState*, v8::Local<v8::Object> underlying_object, const char* method_name_for_error, v8::Local<v8::Value> controller);

// Create a StreamStartAlgorithm from the "start" method on |underlying_object|
// for readable byte streams.
CORE_EXPORT StreamStartAlgorithm* CreateByteStreamStartAlgorithm(
    ScriptState*, v8::Local<v8::Object> underlying_object, v8::Local<v8::Value> method, v8::Local<v8::Value> controller);
...
CORE_EXPORT ScriptValue CreateTrivialQueuingStrategy(v8::Isolate*, size_t high_water_mark);
...
CORE_EXPORT v8::MaybeLocal<v8::Value> CallOrNoop1(
    ScriptState*, v8::Local<v8::Object> object, const char* method_name, const char* name_for_error, v8::Local<v8::Value> arg0, ExceptionState&);
...
CORE_EXPORT v8::MaybeLocal<v8::Value> Call1(
    ScriptState*, v8::Local<v8::Function> method, v8::Local<v8::Object> object, v8::Local<v8::Value> arg0, ExceptionState&);
...
CORE_EXPORT v8::Local<v8::Promise> PromiseCall(ScriptState*, v8::Local<v8::Function> method, v8::Local<v8::Object> recv, int argc, v8::Local<v8::Value> argv[]);

// Unlike in the standard, the caller needs to handle the conversion of the
// value to a Number.
// https://streams.spec.whatwg.org/#validate-and-normalize-high-water-mark
CORE_EXPORT double ValidateAndNormalizeHighWaterMark(double high_water_mark, ExceptionState&);

// https://streams.spec.whatwg.org/#make-size-algorithm-from-size-function
CORE_EXPORT StrategySizeAlgorithm* MakeSizeAlgorithmFromSizeFunction(ScriptState*, v8::Local<v8::Value> size, ExceptionState&);
...
CORE_EXPORT v8::Local<v8::Promise> PromiseReject(ScriptState*, v8::Local<v8::Value>);
...
CORE_EXPORT v8::Local<v8::Promise> PromiseResolve(ScriptState*, v8::Local<v8::Value>);
...
public:
    ...
    double GetHighWaterMark(ScriptState*, int default_value, ExceptionState&) const;
