...
// cloned.
using AllowPerChunkTransferring = base::StrongAlias<class AllowPerChunkTransferringTag, bool>;
...
CORE_EXPORT WritableStream* CreateCrossRealmTransformWritable(
    ScriptState*, MessagePort* port, AllowPerChunkTransferring, std::unique_ptr<WritableStreamTransferringOptimizer> optimizer, ExceptionState&);
...
CORE_EXPORT ReadableStream* CreateCrossRealmTransformReadable(
    ScriptState*, MessagePort* port, std::unique_ptr<ReadableStreamTransferringOptimizer> optimizer, ExceptionState&);
...
// longer than `source1`.
CORE_EXPORT ReadableStream* CreateConcatenatedReadableStream(ScriptState*, UnderlyingSourceBase* source1, UnderlyingSourceBase* source2);
