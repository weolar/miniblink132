...
// postMessage.
v8::Local<v8::Object> CreateKeyValueObject(v8::Isolate* isolate, const char* key1, v8::Local<v8::Value> value1, const char* key2, v8::Local<v8::Value> value2)
{
    v8::Local<v8::Name> names[] = { V8AtomicString(isolate, key1), V8AtomicString(isolate, key2) };
    v8::Local<v8::Value> values[] = { value1, value2 };
    static_assert(std::size(names) == std::size(values), "names and values arrays must be the same size");
    return v8::Object::New(isolate, v8::Null(isolate), names, values, std::size(names));
}

// Unpacks an object created by CreateKeyValueObject(). |value1| and |value2|
// are out parameters. Returns false on failure.
bool UnpackKeyValueObject(
    ScriptState* script_state, v8::Local<v8::Object> object, const char* key1, v8::Local<v8::Value>* value1, const char* key2, v8::Local<v8::Value>* value2)
{
...
void PackAndPostMessage(ScriptState* script_state, MessagePort* port, MessageType type, v8::Local<v8::Value> value,
    AllowPerChunkTransferring allow_per_chunk_transferring, ExceptionState& exception_state)
{
    DVLOG(3) << "PackAndPostMessage sending message type " << static_cast<int>(type);
    ...
    v8::Local<v8::Object> packed = CreateKeyValueObject(isolate, "t", v8::Number::New(isolate, static_cast<int>(type)), "v", value);
    ...
    //    and options.
    port->postMessage(script_state, ScriptValue(isolate, packed), options, exception_state);
}

// Sends a kError message to the remote side, disregarding failure.
void CrossRealmTransformSendError(ScriptState* script_state, MessagePort* port, v8::Local<v8::Value> error)
{
    ...
    PackAndPostMessage(script_state, port, MessageType::kError, error, AllowPerChunkTransferring(false), PassThroughException(script_state->GetIsolate()));
...
bool PackAndPostMessageHandlingError(ScriptState* script_state, MessagePort* port, MessageType type, v8::Local<v8::Value> value,
    AllowPerChunkTransferring allow_per_chunk_transferring, v8::Local<v8::Value>* error)
{
    v8::TryCatch try_catch(script_state->GetIsolate());
    ...
    PackAndPostMessage(script_state, port, type, value, allow_per_chunk_transferring, PassThroughException(script_state->GetIsolate()));
...
bool PackAndPostMessageHandlingError(ScriptState* script_state, MessagePort* port, MessageType type, v8::Local<v8::Value> value, v8::Local<v8::Value>* error)
{
    return PackAndPostMessageHandlingError(script_state, port, type, value, AllowPerChunkTransferring(false), error);
}
...
class CrossRealmTransformStream : public GarbageCollected<CrossRealmTransformStream> {
public:
...
public:
    ...
    void Invoke(ExecutionContext*, Event* event) override
    {
        ...
        if (!UnpackKeyValueObject(script_state, data.As<v8::Object>(), "t", &type, "v", &value)) {
...
public:
    ...
    void Invoke(ExecutionContext*, Event*) override
    {
        ...
        v8::Local<v8::Value> error
            = V8ThrowDOMException::CreateOrEmpty(script_state->GetIsolate(), DOMExceptionCode::kDataCloneError, "chunk could not be cloned");
...
public:
    CrossRealmTransformWritable(ScriptState* script_state, MessagePort* port, AllowPerChunkTransferring allow_per_chunk_transferring)
        : script_state_(script_state)
        , message_port_(port)
        , backpressure_promise_(MakeGarbageCollected<ScriptPromiseResolver<IDLUndefined>>(script_state))
    ...
    MessagePort* GetMessagePort() const override
    {
        return message_port_.Get();
    }
...
class CrossRealmTransformWritable::WriteAlgorithm final : public StreamAlgorithm {
public:
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        ...
        return writable_->backpressure_promise_->Promise().Then(script_state, MakeGarbageCollected<DoWriteOnResolve>(script_state, chunk, this)).V8Promise();
    }
...
private:
    ...
    class DoWriteOnResolve final : public ThenCallable<IDLUndefined, DoWriteOnResolve, IDLPromise<IDLUndefined>> {
    public:
        DoWriteOnResolve(ScriptState* script_state, v8::Local<v8::Value> chunk, WriteAlgorithm* target)
        ...
        {
            return target_->DoWrite(script_state, chunk_.Get(script_state->GetIsolate()));
        }
        ...
        void Trace(Visitor* visitor) const override
        {
            ...
            visitor->Trace(target_);
            ThenCallable<IDLUndefined, DoWriteOnResolve, IDLPromise<IDLUndefined>>::Trace(visitor);
        }
    ...
    ScriptPromise<IDLUndefined> DoWrite(ScriptState* script_state, v8::Local<v8::Value> chunk)
    {
        // https://streams.spec.whatwg.org/#abstract-opdef-setupcrossrealmtransformwritable
        // 8. Let writeAlgorithm be the following steps, taking a chunk argument:
        //   2. Return the result of reacting to backpressurePromise with the
        ...
        writable_->backpressure_promise_ = MakeGarbageCollected<ScriptPromiseResolver<IDLUndefined>>(script_state);
        ...
        bool success = PackAndPostMessageHandlingError(
            script_state, writable_->message_port_, MessageType::kChunk, chunk, writable_->allow_per_chunk_transferring_, &error);
...
class CrossRealmTransformWritable::CloseAlgorithm final : public StreamAlgorithm {
public:
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        ...
        bool success
            = PackAndPostMessageHandlingError(script_state, writable_->message_port_, MessageType::kClose, v8::Undefined(script_state->GetIsolate()), &error);
...
class CrossRealmTransformWritable::AbortAlgorithm final : public StreamAlgorithm {
public:
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        ...
        //      reason).
        bool success = PackAndPostMessageHandlingError(script_state, writable_->message_port_, MessageType::kError, reason, &error);
...
WritableStream* CrossRealmTransformWritable::CreateWritableStream(ExceptionState& exception_state)
{
    ...
    message_port_->setOnmessage(MakeGarbageCollected<CrossRealmTransformMessageListener>(this));

    //  5. Add a handler for port’s messageerror event with the following steps:
    message_port_->setOnmessageerror(MakeGarbageCollected<CrossRealmTransformErrorListener>(this));
    ...
    //     sizeAlgorithm).
    auto* stream = WritableStream::Create(script_state_, CreateTrivialStartAlgorithm(), MakeGarbageCollected<WriteAlgorithm>(this),
        MakeGarbageCollected<CloseAlgorithm>(this), MakeGarbageCollected<AbortAlgorithm>(this), 1, CreateDefaultSizeAlgorithm(), exception_state);
...
void CrossRealmTransformWritable::HandleMessage(MessageType type, v8::Local<v8::Value> value)
{
    // https://streams.spec.whatwg.org/#abstract-opdef-setupcrossrealmtransformwritable
    // 4. Add a handler for port’s message event with the following steps:
    ...
    case MessageType::kError:
        ...
        //    value).
        WritableStreamDefaultController::ErrorIfNeeded(script_state_, controller_, value);
    ...
    default:
        DLOG(WARNING) << "Invalid message from peer ignored (invalid type): " << static_cast<int>(type);
        return;
    }
}
...
void CrossRealmTransformWritable::HandleError(v8::Local<v8::Value> error)
{
    ...
    WritableStreamDefaultController::ErrorIfNeeded(script_state_, controller_, error);
}
...
class CrossRealmTransformReadable::PullAlgorithm final : public StreamAlgorithm {
public:
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        ...
        bool success = PackAndPostMessageHandlingError(script_state, readable_->message_port_, MessageType::kPull, v8::Undefined(isolate), &error);
...
class CrossRealmTransformReadable::CancelAlgorithm final : public StreamAlgorithm {
public:
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        ...
        //   1. Let result be PackAndPostMessageHandlingError(port, "error",
        //      reason).
        bool success = PackAndPostMessageHandlingError(script_state, readable_->message_port_, MessageType::kError, reason, &error);
...
public:
    class PullSource2 final : public ThenCallable<IDLUndefined, PullSource2, IDLPromise<IDLUndefined>> {
    public:
        ...
        ScriptPromise<IDLUndefined> React(ScriptState* script_state)
        {
            return source_->source2_->Pull(script_state, PassThroughException(script_state->GetIsolate()));
        }

        void Trace(Visitor* visitor) const override
        {
            visitor->Trace(source_);
            ThenCallable<IDLUndefined, PullSource2, IDLPromise<IDLUndefined>>::Trace(visitor);
        }
    ...
    public:
        explicit ConcatenatingUnderlyingSourceReadRequest(ConcatenatingUnderlyingSource* source, ScriptPromiseResolver<IDLUndefined>* resolver)
            : source_(source)
            , resolver_(resolver)
        {
        }

        void ChunkSteps(ScriptState* script_state, v8::Local<v8::Value> chunk, ExceptionState&) const override
        {
        ...
        void CloseSteps(ScriptState* script_state) const override
        {
            ...
            ReadableStreamDefaultController* controller = source_->Controller()->GetOriginalController();
            auto* isolate = script_state->GetIsolate();
            if (controller) {
                ExceptionState exception_state(script_state->GetIsolate());
                resolver_->Resolve(
                    source_->source2_->StartWrapper(script_state, controller, exception_state).Then(script_state, MakeGarbageCollected<PullSource2>(source_)));
            } else {
                // TODO(crbug.com/1418910): Investigate how to handle cases when the
                // controller is cleared.
                resolver_->Reject(v8::Exception::TypeError(V8String(isolate,
        ...
        {
            ReadableStream* dummy_stream = ReadableStream::CreateWithCountQueueingStrategy(script_state, source_->source2_,
                /*high_water_mark=*/0);

            v8::Isolate* isolate = script_state->GetIsolate();
            // We don't care about the result of the cancellation, including
            // exceptions.
            dummy_stream->cancel(script_state, ScriptValue(isolate, v8::Undefined(isolate)), IGNORE_EXCEPTION);
            resolver_->Reject(e);
        }
    ...
    ConcatenatingUnderlyingSource(ScriptState* script_state, ReadableStream* stream1, UnderlyingSourceBase* source2)
    ...
    {
        v8::TryCatch try_catch(script_state->GetIsolate());
        reader_for_stream1_ = ReadableStream::AcquireDefaultReader(script_state, stream1_, PassThroughException(script_state->GetIsolate()));
        if (try_catch.HasCaught()) {
            return ScriptPromise<IDLUndefined>::Reject(script_state, try_catch.Exception());
        }
        DCHECK(reader_for_stream1_);
        return ToResolvedUndefinedPromise(script_state);
    }

    ScriptPromise<IDLUndefined> Pull(ScriptState* script_state, ExceptionState& exception_state) override
    {
        if (has_finished_reading_stream1_) {
            return source2_->Pull(script_state, exception_state);
        }
        auto* promise = MakeGarbageCollected<ScriptPromiseResolver<IDLUndefined>>(script_state);
        auto* read_request = MakeGarbageCollected<ConcatenatingUnderlyingSourceReadRequest>(this, promise);
        ReadableStreamDefaultReader::Read(script_state, reader_for_stream1_, read_request, exception_state);
        return promise->Promise();
    }

    ScriptPromise<IDLUndefined> Cancel(ScriptState* script_state, ScriptValue reason, ExceptionState& exception_state) override
    {
        if (has_finished_reading_stream1_) {
            return source2_->Cancel(script_state, reason, exception_state);
        }
        v8::TryCatch try_catch(script_state->GetIsolate());
        ScriptPromise<IDLUndefined> cancel_promise1 = reader_for_stream1_->cancel(script_state, reason, PassThroughException(script_state->GetIsolate()));
        if (try_catch.HasCaught()) {
            cancel_promise1 = ScriptPromise<IDLUndefined>::Reject(script_state, try_catch.Exception());
        }

        ReadableStream* dummy_stream = ReadableStream::CreateWithCountQueueingStrategy(script_state, source2_,
            /*high_water_mark=*/0);
        ScriptPromise<IDLUndefined> cancel_promise2 = dummy_stream->cancel(script_state, reason, PassThroughException(script_state->GetIsolate()));
        if (try_catch.HasCaught()) {
            cancel_promise2 = ScriptPromise<IDLUndefined>::Reject(script_state, try_catch.Exception());
        }

        return PromiseAll<IDLUndefined>::Create(script_state, { cancel_promise1, cancel_promise2 });
    }
...
ReadableStream* CrossRealmTransformReadable::CreateReadableStream(ExceptionState& exception_state)
{
    ...
    auto* stream = ReadableStream::Create(script_state_, CreateTrivialStartAlgorithm(), MakeGarbageCollected<PullAlgorithm>(this),
...
void CrossRealmTransformReadable::HandleMessage(MessageType type, v8::Local<v8::Value> value)
{
    // https://streams.spec.whatwg.org/#abstract-opdef-setupcrossrealmtransformreadable
    // 3. Add a handler for port’s message event with the following steps:
    ...
    case MessageType::kChunk:
        ...
        if (ReadableStreamDefaultController::CanCloseOrEnqueue(controller_)) {
            ...
            // 1.0.
            ReadableStreamDefaultController::Enqueue(script_state_, controller_, value, ASSERT_NO_EXCEPTION);
        }
        return;
...
CORE_EXPORT WritableStream* CreateCrossRealmTransformWritable(ScriptState* script_state, MessagePort* port,
    AllowPerChunkTransferring allow_per_chunk_transferring, std::unique_ptr<WritableStreamTransferringOptimizer> optimizer, ExceptionState& exception_state)
{
    WritableStream* stream
        = MakeGarbageCollected<CrossRealmTransformWritable>(script_state, port, allow_per_chunk_transferring)->CreateWritableStream(exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
    if (!optimizer) {
    ...
    UnderlyingSinkBase* sink = optimizer->PerformInProcessOptimization(script_state);
    if (!sink) {
        return stream;
    }
...
{
    ReadableStream* stream = MakeGarbageCollected<CrossRealmTransformReadable>(script_state, port)->CreateReadableStream(exception_state);
    if (!optimizer) {
        return stream;
    }
    UnderlyingSourceBase* source2 = optimizer->PerformInProcessOptimization(script_state);
    if (!source2) {
        return stream;
    }

    return ReadableStream::CreateWithCountQueueingStrategy(script_state, MakeGarbageCollected<ConcatenatingUnderlyingSource>(script_state, stream, source2),
        /*high_water_mark=*/0);
}

ReadableStream* CreateConcatenatedReadableStream(ScriptState* script_state, UnderlyingSourceBase* source1, UnderlyingSourceBase* source2)
{
    auto* const stream1 = ReadableStream::CreateWithCountQueueingStrategy(script_state, source1,
        /*high_water_mark=*/0);
    return ReadableStream::CreateWithCountQueueingStrategy(script_state, MakeGarbageCollected<ConcatenatingUnderlyingSource>(script_state, stream1, source2),
        /*high_water_mark=*/0);
}
