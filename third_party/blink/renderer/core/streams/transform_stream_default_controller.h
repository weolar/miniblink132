...
private:
    ...
    static void SetUp(
        ScriptState*, TransformStream*, TransformStreamDefaultController*, StreamAlgorithm* transform_algorithm, StreamAlgorithm* flush_algorithm);

    // https://streams.spec.whatwg.org/#set-up-transform-stream-default-controller-from-transformer
    static v8::Local<v8::Value> SetUpFromTransformer(ScriptState*, TransformStream*, v8::Local<v8::Object> transformer, ExceptionState&);
    ...
    static void Enqueue(ScriptState*, TransformStreamDefaultController*, v8::Local<v8::Value> chunk, ExceptionState&);

    // https://streams.spec.whatwg.org/#transform-stream-default-controller-error
    static void Error(ScriptState*, TransformStreamDefaultController*, v8::Local<v8::Value> e);

    // https://streams.spec.whatwg.org/#transform-stream-default-controller-perform-transform
    static v8::Local<v8::Promise> PerformTransform(ScriptState*, TransformStreamDefaultController*, v8::Local<v8::Value> chunk);

    // https://streams.spec.whatwg.org/#transform-stream-default-controller-terminate
    static void Terminate(ScriptState*, TransformStreamDefaultController*);

    static ReadableStreamDefaultController* GetDefaultController(TransformStream*);
