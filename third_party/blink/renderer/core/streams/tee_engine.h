...
public:
    ...
    void Start(ScriptState*, ReadableStream*, bool clone_for_branch2, ExceptionState&);
...
private:
    ...
    v8::MaybeLocal<v8::Value> StructuredClone(ScriptState*, v8::Local<v8::Value> chunk, ExceptionState&);
