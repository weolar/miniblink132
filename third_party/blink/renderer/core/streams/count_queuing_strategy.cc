...
CountQueuingStrategy* CountQueuingStrategy::Create(ScriptState* script_state, const QueuingStrategyInit* init)
{
    return MakeGarbageCollected<CountQueuingStrategy>(script_state, init);
}

CountQueuingStrategy::CountQueuingStrategy(ScriptState* script_state, const QueuingStrategyInit* init)
...
ScriptValue CountQueuingStrategy::size(ScriptState* script_state) const
{
    ...
    return GetCachedSizeFunction(script_state, kCountQueuingStrategySizeFunction, &CountQueuingStrategySizeFunction::CreateFunction);
}
