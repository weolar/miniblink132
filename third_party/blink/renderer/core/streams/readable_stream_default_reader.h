...
class CORE_EXPORT ReadableStreamDefaultReader : public ReadableStreamGenericReader,
                                                public ActiveScriptWrappable<ReadableStreamDefaultReader>,
                                                public ExecutionContextClient {
    DEFINE_WRAPPERTYPEINFO();

public:
    static ReadableStreamDefaultReader* Create(ScriptState*, ReadableStream* stream, ExceptionState&);

    // https://streams.spec.whatwg.org/#default-reader-constructor
    ReadableStreamDefaultReader(ScriptState*, ReadableStream* stream, ExceptionState&);
    ...
    static void SetUpDefaultReader(ScriptState*, ReadableStreamDefaultReader* reader, ReadableStream* stream, ExceptionState&);
    ...
    static void Read(ScriptState*, ReadableStreamDefaultReader* reader, ReadRequest*, ExceptionState&);

    // https://streams.spec.whatwg.org/#abstract-opdef-readablestreamdefaultreadererrorreadrequests
    static void ErrorReadRequests(ScriptState*, ReadableStreamDefaultReader* reader, v8::Local<v8::Value> e);
...
template <> struct DowncastTraits<ReadableStreamDefaultReader> {
