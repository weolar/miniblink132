...
class CORE_EXPORT ReadableByteStreamController : public ReadableStreamController {
...
public:
    ...
    static ReadableStreamBYOBRequest* GetBYOBRequest(ReadableByteStreamController*);
    ...
    void enqueue(ScriptState*, NotShared<DOMArrayBufferView> chunk, ExceptionState&);

    // https://streams.spec.whatwg.org/#rbs-controller-error
    void error(ScriptState*);
    void error(ScriptState*, const ScriptValue& e);

    bool IsByteStreamController() const override
    {
        return true;
    }
    bool IsDefaultController() const override
    {
        return false;
    }
...
private:
    ...
    struct QueueEntry final : public GarbageCollected<QueueEntry> {
        explicit QueueEntry(DOMArrayBuffer* buffer, size_t byte_offset, size_t byte_length);
    ...
    struct PullIntoDescriptor final : public GarbageCollected<PullIntoDescriptor> {
        ...
        using ViewConstructorType = DOMArrayBufferView* (*)(DOMArrayBuffer*, size_t, size_t);

        explicit PullIntoDescriptor(DOMArrayBuffer* buffer, size_t buffer_byte_length, size_t byte_offset, size_t byte_length, size_t bytes_filled,
            size_t element_size, ViewConstructorType view_constructor, ReaderType reader_type);
    ...
    static void Error(ScriptState*, ReadableByteStreamController*, v8::Local<v8::Value> e);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-enqueue
    static void Enqueue(ScriptState*, ReadableByteStreamController*, NotShared<DOMArrayBufferView> chunk, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-enqueue-chunk-to-queue
    static void EnqueueChunkToQueue(ReadableByteStreamController*, DOMArrayBuffer*, size_t byte_offset, size_t byte_length);

    // https://streams.spec.whatwg.org/#abstract-opdef-readablebytestreamcontrollerenqueueclonedchunktoqueue
    static void EnqueueClonedChunkToQueue(ReadableByteStreamController*, DOMArrayBuffer*, size_t byte_offset, size_t byte_length);

    // https://streams.spec.whatwg.org/#abstract-opdef-readablebytestreamcontrollerenqueuedetachedpullintotoqueue
    static void EnqueueDetachedPullIntoToQueue(ReadableByteStreamController*, PullIntoDescriptor*);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-process-pull-into-descriptors-using-queue
    static void ProcessPullIntoDescriptorsUsingQueue(ScriptState*, ReadableByteStreamController*);

    // https://streams.spec.whatwg.org/#abstract-opdef-readablebytestreamcontrollerprocessreadrequestsusingqueue
    static void ProcessReadRequestsUsingQueue(ScriptState*, ReadableByteStreamController*, ExceptionState&);
    ...
    static PullIntoDescriptor* ShiftPendingPullInto(ReadableByteStreamController*);
    ...
    static void CommitPullIntoDescriptor(ScriptState*, ReadableStream*, PullIntoDescriptor*, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-convert-pull-into-descriptor
    static DOMArrayBufferView* ConvertPullIntoDescriptor(ScriptState*, PullIntoDescriptor*, ExceptionState&);
    ...
    static void SetUp(ScriptState*, ReadableStream*, ReadableByteStreamController*, StreamStartAlgorithm* start_algorithm, StreamAlgorithm* pull_algorithm,
        StreamAlgorithm* cancel_algorithm, double high_water_mark, size_t auto_allocate_chunk_size, ExceptionState&);

    // https://streams.spec.whatwg.org/#set-up-readable-byte-stream-controller-from-underlying-source
    static void SetUpFromUnderlyingSource(ScriptState*, ReadableStream*, v8::Local<v8::Object> underlying_source, UnderlyingSource* underlying_source_dict,
        double high_water_mark, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-fill-head-pull-into-descriptor
    static void FillHeadPullIntoDescriptor(ReadableByteStreamController*, size_t size, PullIntoDescriptor*);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-fill-pull-into-descriptor-from-queue
    static bool FillPullIntoDescriptorFromQueue(ReadableByteStreamController*, PullIntoDescriptor*, ExceptionState&);

    // https://streams.spec.whatwg.org/#abstract-opdef-readablebytestreamcontrollerfillreadrequestfromqueue
    static void FillReadRequestFromQueue(ScriptState*, ReadableByteStreamController*, ReadRequest* read_request, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-pull-into
    static void PullInto(ScriptState*, ReadableByteStreamController*, NotShared<DOMArrayBufferView> view, ReadIntoRequest*, ExceptionState&);
    ...
    static void Respond(ScriptState*, ReadableByteStreamController*, size_t bytes_written, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-respond-in-closed-state
    static void RespondInClosedState(ScriptState*, ReadableByteStreamController*, PullIntoDescriptor* first_descriptor, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-respond-in-readable-state
    static void RespondInReadableState(ScriptState*, ReadableByteStreamController*, size_t bytes_written, PullIntoDescriptor*, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-respond-internal
    static void RespondInternal(ScriptState*, ReadableByteStreamController*, size_t bytes_written, ExceptionState&);

    // https://streams.spec.whatwg.org/#readable-byte-stream-controller-respond-with-new-view
    static void RespondWithNewView(ScriptState*, ReadableByteStreamController*, NotShared<DOMArrayBufferView> view, ExceptionState&);
    ...
    static DOMArrayBuffer* TransferArrayBuffer(ScriptState*, DOMArrayBuffer* buffer, ExceptionState&);

    // https://streams.spec.whatwg.org/#rbs-controller-private-cancel
    v8::Local<v8::Promise> CancelSteps(ScriptState*, v8::Local<v8::Value> reason) override;
...
template <> struct DowncastTraits<ReadableByteStreamController> {
