...
public:
    ...
    ScriptPromise<IDLUndefined> Start(ReadableStream* readable, WritableStream* destination, ExceptionState&);
...
private:
    ...
    // passed to them.
    using PromiseReaction = v8::Local<v8::Value> (PipeToEngine::*)(v8::Local<v8::Value>);
    ...
    void ReadRequestChunkStepsBody(ScriptState* script_state, v8::Global<v8::Value> chunk);
    ...
    void ShutdownWithAction(Action action, v8::MaybeLocal<v8::Value> original_error);
    ...
    v8::Local<v8::Promise> WritableStreamDefaultWriterCloseWithErrorPropagationAction();
    ...
    v8::Local<v8::Promise> ThenPromise(v8::Local<v8::Promise> promise, PromiseReaction on_fulfilled, PromiseReaction on_rejected = nullptr);
