...
public:
    ...
    void Enqueue(ScriptValue value)
    {
        Controller()->Enqueue(value.V8Value());
    }
    void Close()
    {
        Controller()->Close();
    }
    void Error(ScriptValue value)
    {
        Controller()->Error(value.V8Value());
    }
    double DesiredSize()
    {
    ...
    bool IsCancelledWithNull() const
    {
        return is_cancelled_with_null_;
    }
