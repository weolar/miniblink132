...
public:
    ...
    WritableStreamTransferringOptimizer(const WritableStreamTransferringOptimizer&) = delete;
    WritableStreamTransferringOptimizer& operator=(const WritableStreamTransferringOptimizer&) = delete;
    ...
    virtual UnderlyingSinkBase* PerformInProcessOptimization(ScriptState* script_state)
    {
        return nullptr;
    }
};
