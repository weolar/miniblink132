...
public:
    ReadableStreamBYOBRequest(ReadableByteStreamController*, NotShared<DOMUint8Array> view);
    ...
    void respondWithNewView(ScriptState*, NotShared<DOMArrayBufferView> view, ExceptionState&);
