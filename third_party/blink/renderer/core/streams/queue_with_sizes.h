...
class CORE_EXPORT QueueWithSizes final : public GarbageCollected<QueueWithSizes> {
public:
    QueueWithSizes();
    ...
    void EnqueueValueWithSize(v8::Isolate*, v8::Local<v8::Value> value, double size, ExceptionState&);
