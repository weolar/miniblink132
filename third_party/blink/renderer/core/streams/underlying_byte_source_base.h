...
class CORE_EXPORT UnderlyingByteSourceBase : public GarbageCollected<UnderlyingByteSourceBase> {
public:
    ...
    virtual ScriptPromise<IDLUndefined> Pull(ReadableByteStreamController* controller, ExceptionState&) = 0;
