...
public:
    ...
    ReadableStreamTransferringOptimizer(const ReadableStreamTransferringOptimizer&) = delete;
    ReadableStreamTransferringOptimizer& operator=(const ReadableStreamTransferringOptimizer&) = delete;
    ...
    virtual UnderlyingSourceBase* PerformInProcessOptimization(ScriptState* script_state)
    {
        return nullptr;
    }
};
