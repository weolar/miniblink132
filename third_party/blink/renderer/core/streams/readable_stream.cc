...
public:
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        DCHECK_EQ(argc, 0);
        DCHECK(controller_);
        ...
        if (script_state->ContextIsValid()) {
            v8::TryCatch try_catch(script_state->GetIsolate());
            {
                ...
                promise = underlying_byte_source_->Pull(controller_, PassThroughException(script_state->GetIsolate()));
            }
            if (try_catch.HasCaught()) {
                return PromiseReject(script_state, try_catch.Exception());
            }
        } else {
            return PromiseReject(script_state, V8ThrowException::CreateTypeError(script_state->GetIsolate(), "invalid realm"));
        }
...
class ReadableStream::IterationSource final : public ReadableStream::IterationSourceBase {
public:
    IterationSource(ScriptState* script_state, Kind kind, ReadableStreamDefaultReader* reader, bool prevent_cancel)
...
public:
    ...
    void ChunkSteps(ScriptState* script_state, v8::Local<v8::Value> chunk, ExceptionState& exception_state) const override
    {
        // 1. Resolve promise with chunk.
        iteration_source_->TakePendingPromiseResolver()->Resolve(iteration_source_->MakeIterationResult(ScriptValue(script_state->GetIsolate(), chunk)));
    }

    void CloseSteps(ScriptState* script_state) const override
    {
        // 1. Perform ! ReadableStreamDefaultReaderRelease(reader).
        ReadableStreamDefaultReader::Release(script_state, iteration_source_->reader_);
        // 2. Resolve promise with end of iteration.
        iteration_source_->TakePendingPromiseResolver()->Resolve(iteration_source_->MakeEndOfIteration());
    }

    void ErrorSteps(ScriptState* script_state, v8::Local<v8::Value> e) const override
    {
        // 1. Perform ! ReadableStreamDefaultReaderRelease(reader).
        ReadableStreamDefaultReader::Release(script_state, iteration_source_->reader_);
...
void ReadableStream::IterationSource::GetNextIterationResult()
{
    ...
    ExceptionState exception_state(script_state->GetIsolate(), v8::ExceptionContext::kUnknown, "", "");
    ReadableStreamDefaultReader::Read(script_state, reader_, read_request, exception_state);
}
...
void ReadableStream::IterationSource::AsyncIteratorReturn(ScriptValue arg)
{
    ...
    if (!prevent_cancel_) {
        ...
        auto result = ReadableStreamGenericReader::GenericCancel(script_state, reader_, arg.V8Value());
    ...
    TakePendingPromiseResolver()->Resolve(v8::Undefined(script_state->GetIsolate()));
}

ReadableStream* ReadableStream::Create(ScriptState* script_state, ExceptionState& exception_state)
{
    return Create(script_state, ScriptValue(script_state->GetIsolate(), v8::Undefined(script_state->GetIsolate())),
        ScriptValue(script_state->GetIsolate(), v8::Undefined(script_state->GetIsolate())), exception_state);
}

ReadableStream* ReadableStream::Create(ScriptState* script_state, ScriptValue underlying_source, ExceptionState& exception_state)
{
    return Create(script_state, underlying_source, ScriptValue(script_state->GetIsolate(), v8::Undefined(script_state->GetIsolate())), exception_state);
}

ReadableStream* ReadableStream::Create(ScriptState* script_state, ScriptValue underlying_source, ScriptValue strategy, ExceptionState& exception_state)
{
    auto* stream = MakeGarbageCollected<ReadableStream>();
    stream->InitInternal(script_state, underlying_source, strategy, false, exception_state);
...
ReadableStream* ReadableStream::CreateWithCountQueueingStrategy(ScriptState* script_state, UnderlyingSourceBase* underlying_source, size_t high_water_mark)
{
    return CreateWithCountQueueingStrategy(script_state, underlying_source, high_water_mark, AllowPerChunkTransferring(false),
        /*optimizer=*/nullptr);
}

ReadableStream* ReadableStream::CreateWithCountQueueingStrategy(ScriptState* script_state, UnderlyingSourceBase* underlying_source, size_t high_water_mark,
    AllowPerChunkTransferring allow_per_chunk_transferring, std::unique_ptr<ReadableStreamTransferringOptimizer> optimizer)
{
    ...
    stream->InitWithCountQueueingStrategy(
        script_state, underlying_source, high_water_mark, allow_per_chunk_transferring, std::move(optimizer), IGNORE_EXCEPTION);
    return stream;
}

void ReadableStream::InitWithCountQueueingStrategy(ScriptState* script_state, UnderlyingSourceBase* underlying_source, size_t high_water_mark,
    AllowPerChunkTransferring allow_per_chunk_transferring, std::unique_ptr<ReadableStreamTransferringOptimizer> optimizer, ExceptionState& exception_state)
{
    Initialize(this);
    auto* controller = MakeGarbageCollected<ReadableStreamDefaultController>(script_state);

    ReadableStreamDefaultController::SetUp(script_state, this, controller, MakeGarbageCollected<UnderlyingStartAlgorithm>(underlying_source, controller),
        MakeGarbageCollected<UnderlyingPullAlgorithm>(underlying_source), MakeGarbageCollected<UnderlyingCancelAlgorithm>(underlying_source), high_water_mark,
...
ReadableStream* ReadableStream::Create(ScriptState* script_state, StreamStartAlgorithm* start_algorithm, StreamAlgorithm* pull_algorithm,
    StreamAlgorithm* cancel_algorithm, double high_water_mark, StrategySizeAlgorithm* size_algorithm, ExceptionState& exception_state)
{
    ...
    ReadableStreamDefaultController::SetUp(
        script_state, stream, controller, start_algorithm, pull_algorithm, cancel_algorithm, high_water_mark, size_algorithm, exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
...
ReadableStream* ReadableStream::CreateByteStream(ScriptState* script_state, StreamStartAlgorithm* start_algorithm, StreamAlgorithm* pull_algorithm,
    StreamAlgorithm* cancel_algorithm, ExceptionState& exception_state)
{
    ...
    ReadableByteStreamController::SetUp(script_state, stream, controller, start_algorithm, pull_algorithm, cancel_algorithm, 0, 0, exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
...
// static
ReadableStream* ReadableStream::CreateByteStream(ScriptState* script_state, UnderlyingByteSourceBase* underlying_byte_source)
{
    // https://streams.spec.whatwg.org/#abstract-opdef-createreadablebytestream
    // 1. Let stream be a new ReadableStream.
    auto* stream = MakeGarbageCollected<ReadableStream>();
...
void ReadableStream::InitByteStream(
    ScriptState* script_state, ReadableStream* stream, UnderlyingByteSourceBase* underlying_byte_source, ExceptionState& exception_state)
{
    auto* pull_algorithm = MakeGarbageCollected<PullAlgorithm>(underlying_byte_source);
    auto* cancel_algorithm = MakeGarbageCollected<CancelAlgorithm>(underlying_byte_source);
    ...
    InitByteStream(script_state, stream, controller, CreateTrivialStartAlgorithm(), pull_algorithm, cancel_algorithm, exception_state);
    DCHECK(!exception_state.HadException());

    pull_algorithm->SetController(controller);
}

void ReadableStream::InitByteStream(ScriptState* script_state, ReadableStream* stream, ReadableByteStreamController* controller,
    StreamStartAlgorithm* start_algorithm, StreamAlgorithm* pull_algorithm, StreamAlgorithm* cancel_algorithm, ExceptionState& exception_state)
{
    // Step 2 and 4 of
    // https://streams.spec.whatwg.org/#abstract-opdef-createreadablebytestream
    // 2. Perform ! InitializeReadableStream(stream).
...
ScriptPromise<IDLUndefined> ReadableStream::cancel(ScriptState* script_state, ExceptionState& exception_state)
{
    return cancel(script_state, ScriptValue(script_state->GetIsolate(), v8::Undefined(script_state->GetIsolate())), exception_state);
}

ScriptPromise<IDLUndefined> ReadableStream::cancel(ScriptState* script_state, ScriptValue reason, ExceptionState& exception_state)
{
...
V8ReadableStreamReader* ReadableStream::getReader(ScriptState* script_state, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#rs-get-reader
    // 1. If options["mode"] does not exist, return ?
    // AcquireReadableStreamDefaultReader(this).
    ReadableStreamDefaultReader* reader = AcquireDefaultReader(script_state, this, exception_state);
    if (!reader)
        return nullptr;
    return MakeGarbageCollected<V8ReadableStreamReader>(reader);
}

V8ReadableStreamReader* ReadableStream::getReader(ScriptState* script_state, const ReadableStreamGetReaderOptions* options, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#rs-get-reader
    if (options->hasMode()) {
        DCHECK_EQ(options->mode(), "byob");

        UseCounter::Count(ExecutionContext::From(script_state), WebFeature::kReadableStreamBYOBReader);

        ReadableStreamBYOBReader* reader = AcquireBYOBReader(script_state, this, exception_state);
        if (!reader)
            return nullptr;
        return MakeGarbageCollected<V8ReadableStreamReader>(reader);
    }
...
ReadableStreamDefaultReader* ReadableStream::GetDefaultReaderForTesting(ScriptState* script_state, ExceptionState& exception_state)
{
...
ReadableStreamBYOBReader* ReadableStream::GetBYOBReaderForTesting(ScriptState* script_state, ExceptionState& exception_state)
{
...
ReadableStream* ReadableStream::pipeThrough(ScriptState* script_state, ReadableWritablePair* transform, ExceptionState& exception_state)
{
    return pipeThrough(script_state, transform, StreamPipeOptions::Create(), exception_state);
}

// https://streams.spec.whatwg.org/#rs-pipe-through
ReadableStream* ReadableStream::pipeThrough(
    ScriptState* script_state, ReadableWritablePair* transform, const StreamPipeOptions* options, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#rs-pipe-through
    ...
    auto promise = PipeTo(script_state, this, writable_stream, pipe_options, exception_state);
...
ScriptPromise<IDLUndefined> ReadableStream::pipeTo(ScriptState* script_state, WritableStream* destination, ExceptionState& exception_state)
{
    return pipeTo(script_state, destination, StreamPipeOptions::Create(), exception_state);
}

ScriptPromise<IDLUndefined> ReadableStream::pipeTo(
    ScriptState* script_state, WritableStream* destination, const StreamPipeOptions* options, ExceptionState& exception_state)
{
...
HeapVector<Member<ReadableStream>> ReadableStream::tee(ScriptState* script_state, ExceptionState& exception_state)
{
    return CallTeeAndReturnBranchArray(script_state, this, false, exception_state);
}
...
void ReadableStream::InitInternal(
    ScriptState* script_state, ScriptValue raw_underlying_source, ScriptValue raw_strategy, bool created_by_ua, ExceptionState& exception_state)
{
    if (!created_by_ua) {
        // TODO(ricea): Move this to IDL once blink::ReadableStreamOperations is
        // no longer using the public constructor.
        UseCounter::Count(ExecutionContext::From(script_state), WebFeature::kReadableStreamConstructor);
    }
    ...
    ScriptValueToObject(script_state, raw_underlying_source, &underlying_source, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    StrategyUnpacker strategy_unpacker(script_state, raw_strategy, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    if (!underlying_source->Get(context, V8AtomicString(isolate, "type")).ToLocal(&type)) {
        return;
    }
    ...
    if (!type->IsUndefined()) {
        ...
        if (type_string->StringEquals(V8AtomicString(isolate, "bytes"))) {
            UseCounter::Count(ExecutionContext::From(script_state), WebFeature::kReadableStreamWithByteSource);

            UnderlyingSource* underlying_source_dict
                = NativeValueTraits<UnderlyingSource>::NativeValue(script_state->GetIsolate(), raw_underlying_source.V8Value(), exception_state);
            if (!strategy_unpacker.IsSizeUndefined()) {
                exception_state.ThrowRangeError("Cannot create byte stream with size() defined on the strategy");
                return;
            }
            double high_water_mark = strategy_unpacker.GetHighWaterMark(script_state, 0, exception_state);
            if (exception_state.HadException()) {
                return;
            }
            ReadableByteStreamController::SetUpFromUnderlyingSource(
                script_state, this, underlying_source, underlying_source_dict, high_water_mark, exception_state);
            return;
        }
    ...
    auto* size_algorithm = strategy_unpacker.MakeSizeAlgorithm(script_state, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    //      highWaterMark).
    double high_water_mark = strategy_unpacker.GetHighWaterMark(script_state, 1, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    ReadableStreamDefaultController::SetUpFromUnderlyingSource(script_state, this, underlying_source, high_water_mark, size_algorithm, exception_state);
}

//
// Readable stream abstract operations
//
ReadableStreamDefaultReader* ReadableStream::AcquireDefaultReader(ScriptState* script_state, ReadableStream* stream, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#acquire-readable-stream-reader
    // 1. Let reader by a new ReadableStreamDefaultReader.
    // 2. Perform ? SetUpReadableStreamReader(reader, stream).
    auto* reader = MakeGarbageCollected<ReadableStreamDefaultReader>(script_state, stream, exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
...
ReadableStreamBYOBReader* ReadableStream::AcquireBYOBReader(ScriptState* script_state, ReadableStream* stream, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#acquire-readable-stream-byob-reader
    // 1. Let reader be a new ReadableStreamBYOBReader.
    // 2. Perform ? SetUpBYOBReader(reader, stream).
    auto* reader = MakeGarbageCollected<ReadableStreamBYOBReader>(script_state, stream, exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
...
void ReadableStream::Tee(ScriptState* script_state, ReadableStream** branch1, ReadableStream** branch2, bool clone_for_branch2, ExceptionState& exception_state)
{
...
void ReadableStream::ByteStreamTee(ScriptState* script_state, ReadableStream** branch1, ReadableStream** branch2, ExceptionState& exception_state)
{
...
void ReadableStream::LockAndDisturb(ScriptState* script_state)
{
    ...
    ReadableStreamGenericReader* reader = AcquireDefaultReader(script_state, this, exception_state);
    DCHECK(reader);

    is_disturbed_ = true;
}

void ReadableStream::CloseStream(ScriptState* script_state, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#readablestream-close
    // 1. If stream.[[controller]] implements ReadableByteStreamController,
    if (auto* readable_byte_stream_controller = DynamicTo<ReadableByteStreamController>(readable_stream_controller_.Get())) {
        ...
        readable_byte_stream_controller->Close(script_state, readable_byte_stream_controller);
        ...
        if (readable_byte_stream_controller->pending_pull_intos_.size() > 0) {
            readable_byte_stream_controller->Respond(script_state, readable_byte_stream_controller, 0, exception_state);
        }
        if (exception_state.HadException()) {
            return;
        }
    ...
    // ReadableStreamDefaultControllerClose(stream.[[controller]]).
        ...
        auto* readable_stream_default_controller = To<ReadableStreamDefaultController>(readable_stream_controller_.Get());
        ReadableStreamDefaultController::Close(script_state, readable_stream_default_controller);
    }
}

void ReadableStream::Serialize(ScriptState* script_state, MessagePort* port, ExceptionState& exception_state)
{
    ...
    auto* writable = CreateCrossRealmTransformWritable(script_state, port, allow_per_chunk_transferring_, /*optimizer=*/nullptr, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    //    false).
    auto promise = PipeTo(script_state, this, writable, MakeGarbageCollected<PipeOptions>(), exception_state);
...
ReadableStream* ReadableStream::Deserialize(
    ScriptState* script_state, MessagePort* port, std::unique_ptr<ReadableStreamTransferringOptimizer> optimizer, ExceptionState& exception_state)
{
    // We need to execute JavaScript to call "Then" on v8::Promises. We will not
    // run author code.
    v8::Isolate::AllowJavascriptExecutionScope allow_js(script_state->GetIsolate());
    ...
    auto* readable = CreateCrossRealmTransformReadable(script_state, port, std::move(optimizer), exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
    return readable;
...
ScriptPromise<IDLUndefined> ReadableStream::PipeTo(
    ScriptState* script_state, ReadableStream* readable, WritableStream* destination, PipeOptions* pipe_options, ExceptionState& exception_state)
{
...
v8::Local<v8::Value> ReadableStream::GetStoredError(v8::Isolate* isolate) const
{
    return stored_error_.Get(isolate);
}

std::unique_ptr<ReadableStreamTransferringOptimizer> ReadableStream::TakeTransferringOptimizer()
{
...
void ReadableStream::AddReadRequest(ScriptState* script_state, ReadableStream* stream, ReadRequest* read_request)
{
...
ScriptPromise<IDLUndefined> ReadableStream::Cancel(ScriptState* script_state, ReadableStream* stream, v8::Local<v8::Value> reason)
{
    ...
    //    [[storedError]].
    if (state == kErrored) {
        return ScriptPromise<IDLUndefined>::Reject(script_state, stream->GetStoredError(script_state->GetIsolate()));
    }
    ...
    v8::Local<v8::Promise> source_cancel_promise = stream->readable_stream_controller_->CancelSteps(script_state, reason);

    enum FunctionType { kResolve, kReject };
    class ResolveUndefinedFunction final : public PromiseHandler {
    public:
        ResolveUndefinedFunction(ScriptPromiseResolver<IDLUndefined>* resolver, FunctionType type)
            : resolver_(resolver)
            , type_(type)
        {
        }

        void CallWithLocal(ScriptState* script_state, v8::Local<v8::Value> value) override
        {
            if (type_ == kResolve) {
                resolver_->Resolve();
            } else {
    ...
    StreamThenPromise(script_state, source_cancel_promise, MakeGarbageCollected<ResolveUndefinedFunction>(resolver, kResolve),
...
void ReadableStream::Error(ScriptState* script_state, ReadableStream* stream, v8::Local<v8::Value> e)
{
    ...
    if (reader->IsDefaultReader()) {
        ...
        ReadableStreamDefaultReader* default_reader = To<ReadableStreamDefaultReader>(reader);
        ReadableStreamDefaultReader::ErrorReadRequests(script_state, default_reader, e);
    } else {
        // 9. Otherwise,
        ...
        ReadableStreamBYOBReader* byob_reader = To<ReadableStreamBYOBReader>(reader);
        ReadableStreamBYOBReader::ErrorReadIntoRequests(script_state, byob_reader, e);
    }
}

void ReadableStream::FulfillReadIntoRequest(
    ScriptState* script_state, ReadableStream* stream, DOMArrayBufferView* chunk, bool done, ExceptionState& exception_state)
{
...
void ReadableStream::FulfillReadRequest(
    ScriptState* script_state, ReadableStream* stream, v8::Local<v8::Value> chunk, bool done, ExceptionState& exception_state)
{
...
HeapVector<Member<ReadableStream>> ReadableStream::CallTeeAndReturnBranchArray(
    ScriptState* script_state, ReadableStream* readable, bool clone_for_branch2, ExceptionState& exception_state)
{
    ...
    if (readable->readable_stream_controller_->IsByteStreamController()) {
        ...
        readable->Tee(script_state, &branch1, &branch2, clone_for_branch2, exception_state);
    }
...
ReadableStream::IterationSourceBase* ReadableStream::CreateIterationSource(
    ScriptState* script_state, ReadableStream::IterationSourceBase::Kind kind, ReadableStreamIteratorOptions* options, ExceptionState& exception_state)
{
    ...
    return MakeGarbageCollected<IterationSource>(script_state, kind, reader, prevent_cancel);
}
