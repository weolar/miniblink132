...
class CORE_EXPORT ReadableStreamDefaultControllerWithScriptScope : public GarbageCollected<ReadableStreamDefaultControllerWithScriptScope> {
public:
    ReadableStreamDefaultControllerWithScriptScope(ScriptState* script_state, ReadableStreamDefaultController* controller);
    ...
    template <typename ChunkType>
        requires std::derived_from<ChunkType, bindings::DictionaryBase> || std::derived_from<ChunkType, ScriptWrappable>
    ...
    template <typename ErrorType>
        requires std::derived_from<ErrorType, bindings::DictionaryBase> || std::derived_from<ErrorType, ScriptWrappable>
