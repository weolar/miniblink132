...
class WritableStream::PendingAbortRequest final : public GarbageCollected<PendingAbortRequest> {
public:
    PendingAbortRequest(v8::Isolate* isolate, ScriptPromiseResolver<IDLUndefined>* resolver, v8::Local<v8::Value> reason, bool was_already_erroring)
        : resolver_(resolver)
    ...
    ScriptPromiseResolver<IDLUndefined>* GetResolver()
    {
...
WritableStream* WritableStream::Create(ScriptState* script_state, ExceptionState& exception_state)
{
...
WritableStream* WritableStream::Create(ScriptState* script_state, ScriptValue underlying_sink, ExceptionState& exception_state)
{
    return Create(script_state, underlying_sink, ScriptValue(script_state->GetIsolate(), v8::Undefined(script_state->GetIsolate())), exception_state);
}

WritableStream* WritableStream::Create(ScriptState* script_state, ScriptValue raw_underlying_sink, ScriptValue raw_strategy, ExceptionState& exception_state)
{
    auto* stream = MakeGarbageCollected<WritableStream>();
    stream->InitInternal(script_state, raw_underlying_sink, raw_strategy, exception_state);
...
ScriptPromise<IDLUndefined> WritableStream::abort(ScriptState* script_state, ExceptionState& exception_state)
{
    return abort(script_state, ScriptValue(script_state->GetIsolate(), v8::Undefined(script_state->GetIsolate())), exception_state);
}

ScriptPromise<IDLUndefined> WritableStream::abort(ScriptState* script_state, ScriptValue reason, ExceptionState& exception_state)
{
...
ScriptPromise<IDLUndefined> WritableStream::close(ScriptState* script_state, ExceptionState& exception_state)
{
...
WritableStreamDefaultWriter* WritableStream::getWriter(ScriptState* script_state, ExceptionState& exception_state)
{
...
WritableStream* WritableStream::Create(ScriptState* script_state, StreamStartAlgorithm* start_algorithm, StreamAlgorithm* write_algorithm,
    StreamAlgorithm* close_algorithm, StreamAlgorithm* abort_algorithm, double high_water_mark, StrategySizeAlgorithm* size_algorithm,
    ExceptionState& exception_state)
{
    ...
    WritableStreamDefaultController::SetUp(
        script_state, stream, controller, start_algorithm, write_algorithm, close_algorithm, abort_algorithm, high_water_mark, size_algorithm, exception_state);
...
// static
WritableStream* WritableStream::CreateWithCountQueueingStrategy(ScriptState* script_state, UnderlyingSinkBase* underlying_sink, size_t high_water_mark)
{
    return CreateWithCountQueueingStrategy(script_state, underlying_sink, high_water_mark,
        /*optimizer=*/nullptr);
}

WritableStream* WritableStream::CreateWithCountQueueingStrategy(
    ScriptState* script_state, UnderlyingSinkBase* underlying_sink, size_t high_water_mark, std::unique_ptr<WritableStreamTransferringOptimizer> optimizer)
{
    v8::Isolate* isolate = script_state->GetIsolate();
    v8::MicrotasksScope microtasks_scope(isolate, ToMicrotaskQueue(script_state), v8::MicrotasksScope::kDoNotRunMicrotasks);
    auto* stream = MakeGarbageCollected<WritableStream>();
    stream->InitWithCountQueueingStrategy(script_state, underlying_sink, high_water_mark, std::move(optimizer), PassThroughException(isolate));
...
void WritableStream::InitWithCountQueueingStrategy(ScriptState* script_state, UnderlyingSinkBase* underlying_sink, size_t high_water_mark,
    std::unique_ptr<WritableStreamTransferringOptimizer> optimizer, ExceptionState& exception_state)
{
    ScriptValue strategy_value = CreateTrivialQueuingStrategy(script_state->GetIsolate(), high_water_mark);
    ...
    // UnderlyingSinkBase.
    InitInternal(script_state, underlying_sink_value, strategy_value, exception_state);

    transferring_optimizer_ = std::move(optimizer);
}

void WritableStream::Serialize(ScriptState* script_state, MessagePort* port, ExceptionState& exception_state)
{
    ...
    auto* readable = CreateCrossRealmTransformReadable(script_state, port, /*optimizer=*/nullptr, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    //    false).
    auto promise = ReadableStream::PipeTo(script_state, readable, this, MakeGarbageCollected<PipeOptions>(), exception_state);
...
WritableStream* WritableStream::Deserialize(
    ScriptState* script_state, MessagePort* port, std::unique_ptr<WritableStreamTransferringOptimizer> optimizer, ExceptionState& exception_state)
{
    ...
    auto* writable = CreateCrossRealmTransformWritable(script_state, port, AllowPerChunkTransferring(false), std::move(optimizer), exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
    return writable;
...
WritableStreamDefaultWriter* WritableStream::AcquireDefaultWriter(ScriptState* script_state, WritableStream* stream, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#acquire-writable-stream-default-writer
    //  1. Return ? Construct(WritableStreamDefaultWriter, « stream »).
    auto* writer = MakeGarbageCollected<WritableStreamDefaultWriter>(script_state, stream, exception_state);
    if (exception_state.HadException()) {
        return nullptr;
    }
    return writer;
...
ScriptPromise<IDLUndefined> WritableStream::Abort(ScriptState* script_state, WritableStream* stream, v8::Local<v8::Value> reason)
{
    ...
    //     wasAlreadyErroring.
    stream->pending_abort_request_ = MakeGarbageCollected<PendingAbortRequest>(isolate, resolver, reason, was_already_erroring);
...
void WritableStream::AddWriteRequest(WritableStream* stream, ScriptPromiseResolver<IDLUndefined>* resolver)
{
...
ScriptPromise<IDLUndefined> WritableStream::Close(ScriptState* script_state, WritableStream* stream)
{
    ...
    //     TypeError exception.
    if (state == kClosed || state == kErrored) {
        return ScriptPromise<IDLUndefined>::Reject(script_state, CreateCannotActionOnStateStreamException(script_state->GetIsolate(), "close", state));
    }
...
void WritableStream::DealWithRejection(ScriptState* script_state, WritableStream* stream, v8::Local<v8::Value> error)
{
...
void WritableStream::StartErroring(ScriptState* script_state, WritableStream* stream, v8::Local<v8::Value> reason)
{
    ...
    WritableStreamDefaultController* controller = stream->writable_stream_controller_;
    ...
    if (writer) {
        WritableStreamDefaultWriter::EnsureReadyPromiseRejected(script_state, writer, reason);
    }
...
void WritableStream::FinishErroring(ScriptState* script_state, WritableStream* stream)
{
    ...
    //     abortRequest.[[reason]]).
    auto promise = stream->writable_stream_controller_->AbortSteps(script_state, abort_request->Reason(isolate));

    class ResolvePromiseFunction final : public PromiseHandler {
    public:
        ResolvePromiseFunction(WritableStream* stream, ScriptPromiseResolver<IDLUndefined>* resolver)
            : stream_(stream)
            , resolver_(resolver)
        {
        }
    ...
    public:
        RejectPromiseFunction(WritableStream* stream, ScriptPromiseResolver<IDLUndefined>* resolver)
            : stream_(stream)
            , resolver_(resolver)
        {
        }

        void CallWithLocal(ScriptState* script_state, v8::Local<v8::Value> reason) override
        {
    ...
    StreamThenPromise(script_state, promise, MakeGarbageCollected<ResolvePromiseFunction>(stream, abort_request->GetResolver()),
        MakeGarbageCollected<RejectPromiseFunction>(stream, abort_request->GetResolver()));
}

void WritableStream::FinishInFlightWrite(ScriptState* script_state, WritableStream* stream)
{
...
void WritableStream::FinishInFlightWriteWithError(ScriptState* script_state, WritableStream* stream, v8::Local<v8::Value> error)
{
...
void WritableStream::FinishInFlightClose(ScriptState* script_state, WritableStream* stream)
{
...
void WritableStream::FinishInFlightCloseWithError(ScriptState* script_state, WritableStream* stream, v8::Local<v8::Value> error)
{
...
void WritableStream::MarkFirstWriteRequestInFlight(WritableStream* stream)
{
    ...
    ScriptPromiseResolver<IDLUndefined>* write_request = stream->write_requests_.front();
...
void WritableStream::UpdateBackpressure(ScriptState* script_state, WritableStream* stream, bool backpressure)
{
...
v8::Local<v8::Value> WritableStream::GetStoredError(v8::Isolate* isolate) const
{
    return stored_error_.Get(isolate);
}

void WritableStream::SetCloseRequest(ScriptPromiseResolver<IDLUndefined>* close_request)
{
    close_request_ = close_request;
}

void WritableStream::SetController(WritableStreamDefaultController* controller)
{
...
std::unique_ptr<WritableStreamTransferringOptimizer> WritableStream::TakeTransferringOptimizer()
{
    return std::move(transferring_optimizer_);
}

// static
v8::Local<v8::String> WritableStream::CreateCannotActionOnStateStreamMessage(v8::Isolate* isolate, const char* action, const char* state_name)
{
    return V8String(isolate, String::Format("Cannot %s a %s writable stream", action, state_name));
}

// static
v8::Local<v8::Value> WritableStream::CreateCannotActionOnStateStreamException(v8::Isolate* isolate, const char* action, State state)
{
    ...
    return v8::Exception::TypeError(CreateCannotActionOnStateStreamMessage(isolate, action, state_name));
}
...
void WritableStream::InitInternal(ScriptState* script_state, ScriptValue raw_underlying_sink, ScriptValue raw_strategy, ExceptionState& exception_state)
{
    ...
    ScriptValueToObject(script_state, raw_underlying_sink, &underlying_sink, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    if (!underlying_sink->Get(context, V8AtomicString(isolate, "type")).ToLocal(&type)) {
        return;
    }
    ...
    WritableStreamDefaultController::SetUpFromUnderlyingSink(script_state, this, underlying_sink, high_water_mark, size_algorithm, exception_state);
}
...
void WritableStream::RejectCloseAndClosedPromiseIfNeeded(ScriptState* script_state, WritableStream* stream)
{
    ...
    if (writer) {
        ...
        writer->ClosedResolver()->Reject(ScriptValue(isolate, stream->stored_error_.Get(isolate)));
...
void WritableStream::RejectPromises(ScriptState* script_state, PromiseQueue* queue, v8::Local<v8::Value> e)
{
