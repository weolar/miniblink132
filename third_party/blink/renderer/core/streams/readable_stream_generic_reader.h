...
public:
    ...
    static ScriptPromise<IDLUndefined> GenericCancel(ScriptState*, ReadableStreamGenericReader*, v8::Local<v8::Value> reason);

    // https://streams.spec.whatwg.org/#readable-stream-reader-generic-initialize
    static void GenericInitialize(ScriptState*, ReadableStreamGenericReader*, ReadableStream*);
