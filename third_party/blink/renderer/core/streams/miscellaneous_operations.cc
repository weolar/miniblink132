...
v8::Local<v8::Promise> PromiseRejectInternal(ScriptState* script_state, v8::Local<v8::Value> value, int recursion_depth)
{
    ...
    if (resolver->Reject(context, value).IsNothing()) {
        ...
        return PromiseRejectInternal(script_state, trycatch.Exception(), recursion_depth + 1);
    }
...
public:
    ...
    std::optional<double> Run(ScriptState* script_state, v8::Local<v8::Value> chunk) override
    {
        ...
        v8::MaybeLocal<v8::Value> result_maybe = function_.Get(isolate)->Call(context, v8::Undefined(isolate), 1, argv);
...
public:
    JavaScriptStreamAlgorithmWithoutExtraArg(v8::Isolate* isolate, v8::Local<v8::Function> method, v8::Local<v8::Object> recv)
        : recv_(isolate, recv)
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        ...
        return PromiseCall(script_state, method_.Get(isolate), recv_.Get(isolate), argc, argv);
    }
...
public:
    JavaScriptStreamAlgorithmWithExtraArg(v8::Isolate* isolate, v8::Local<v8::Function> method, v8::Local<v8::Value> extra_arg, v8::Local<v8::Object> recv)
        : recv_(isolate, recv)
        , method_(isolate, method)
    ...
    v8::Local<v8::Promise> Run(ScriptState* script_state, int argc, v8::Local<v8::Value> argv[]) override
    {
        ...
        return PromiseCall(script_state, method_.Get(isolate), recv_.Get(isolate), full_argc, full_argv.data());
    }
...
public:
    JavaScriptByteStreamStartAlgorithm(v8::Isolate* isolate, v8::Local<v8::Function> method, v8::Local<v8::Object> recv, v8::Local<v8::Value> controller)
        : recv_(isolate, recv)
        , method_(isolate, method)
    ...
    v8::MaybeLocal<v8::Promise> Run(ScriptState* script_state, ExceptionState& exception_state) override
    {
        auto* isolate = script_state->GetIsolate();

        auto value_maybe = Call1(script_state, method_.Get(isolate), recv_.Get(isolate), controller_.Get(isolate), exception_state);
...
public:
    JavaScriptStreamStartAlgorithm(v8::Isolate* isolate, v8::Local<v8::Object> recv, const char* method_name_for_error, v8::Local<v8::Value> controller)
        : recv_(isolate, recv)
    ...
    v8::MaybeLocal<v8::Promise> Run(ScriptState* script_state, ExceptionState& exception_state) override
    {
        ...
        auto value_maybe = CallOrNoop1(script_state, recv_.Get(isolate), "start", method_name_for_error_, controller_.Get(isolate), exception_state);
        if (exception_state.HadException()) {
            return v8::MaybeLocal<v8::Promise>();
        }
        v8::Local<v8::Value> value;
...
public:
    v8::MaybeLocal<v8::Promise> Run(ScriptState* script_state, ExceptionState&) override
    {
        return PromiseResolveWithUndefined(script_state);
    }
};
...
CORE_EXPORT StreamAlgorithm* CreateAlgorithmFromUnderlyingMethod(ScriptState* script_state, v8::Local<v8::Object> underlying_object, const char* method_name,
    const char* method_name_for_error, v8::MaybeLocal<v8::Value> extra_arg, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#create-algorithm-from-underlying-method
    ...
    v8::MaybeLocal<v8::Value> method_maybe = ResolveMethod(script_state, underlying_object, method_name, method_name_for_error, exception_state);
    ...
    return CreateAlgorithmFromResolvedMethod(script_state, underlying_object, method, extra_arg);
}

CORE_EXPORT v8::MaybeLocal<v8::Value> ResolveMethod(
    ScriptState* script_state, v8::Local<v8::Object> object, const char* method_name, const char* name_for_error, ExceptionState& exception_state)
{
    auto* isolate = script_state->GetIsolate();
    ...
    // https://streams.spec.whatwg.org/#create-algorithm-from-underlying-method
    // 5. Let method be ? GetV(underlyingObject, methodName).
    auto method_maybe = object->Get(script_state->GetContext(), V8AtomicString(isolate, method_name));
    v8::Local<v8::Value> method;
    if (!method_maybe.ToLocal(&method)) {
    ...
    if (!method->IsFunction() && !method->IsUndefined()) {
        exception_state.ThrowTypeError(String(name_for_error) + " must be a function or undefined");
        return v8::MaybeLocal<v8::Value>();
    }
...
CORE_EXPORT StreamAlgorithm* CreateAlgorithmFromResolvedMethod(
    ScriptState* script_state, v8::Local<v8::Object> underlying_object, v8::Local<v8::Value> method, v8::MaybeLocal<v8::Value> extra_arg)
{
    ...
    if (!extra_arg.ToLocal(&extra_arg_local)) {
        return MakeGarbageCollected<JavaScriptStreamAlgorithmWithoutExtraArg>(isolate, method.As<v8::Function>(), underlying_object);
    }

    return MakeGarbageCollected<JavaScriptStreamAlgorithmWithExtraArg>(isolate, method.As<v8::Function>(), extra_arg_local, underlying_object);
}

CORE_EXPORT StreamStartAlgorithm* CreateStartAlgorithm(
    ScriptState* script_state, v8::Local<v8::Object> underlying_object, const char* method_name_for_error, v8::Local<v8::Value> controller)
{
    return MakeGarbageCollected<JavaScriptStreamStartAlgorithm>(script_state->GetIsolate(), underlying_object, method_name_for_error, controller);
}

CORE_EXPORT StreamStartAlgorithm* CreateByteStreamStartAlgorithm(
    ScriptState* script_state, v8::Local<v8::Object> underlying_object, v8::Local<v8::Value> method, v8::Local<v8::Value> controller)
{
    return MakeGarbageCollected<JavaScriptByteStreamStartAlgorithm>(script_state->GetIsolate(), method.As<v8::Function>(), underlying_object, controller);
}
...
CORE_EXPORT ScriptValue CreateTrivialQueuingStrategy(v8::Isolate* isolate, size_t high_water_mark)
{
    v8::Local<v8::Name> high_water_mark_string = V8AtomicString(isolate, "highWaterMark");
    v8::Local<v8::Value> high_water_mark_value = v8::Number::New(isolate, high_water_mark);

    auto strategy = v8::Object::New(isolate, v8::Null(isolate), &high_water_mark_string, &high_water_mark_value, 1);

    return ScriptValue(isolate, strategy);
}

CORE_EXPORT v8::MaybeLocal<v8::Value> CallOrNoop1(ScriptState* script_state, v8::Local<v8::Object> object, const char* method_name, const char* name_for_error,
    v8::Local<v8::Value> arg0, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#invoke-or-noop
    // 4. Let method be ? GetV(O, P).
    v8::MaybeLocal<v8::Value> method_maybe = ResolveMethod(script_state, object, method_name, name_for_error, exception_state);
    v8::Local<v8::Value> method;
    if (!method_maybe.ToLocal(&method)) {
        DCHECK(exception_state.HadException());
        return v8::MaybeLocal<v8::Value>();
    ...
    return method.As<v8::Function>()->Call(script_state->GetContext(), object, 1, &arg0);
}

CORE_EXPORT v8::MaybeLocal<v8::Value> Call1(
    ScriptState* script_state, v8::Local<v8::Function> method, v8::Local<v8::Object> object, v8::Local<v8::Value> arg0, ExceptionState& exception_state)
{
    TryRethrowScope rethrow_scope(script_state->GetIsolate(), exception_state);
    return method->Call(script_state->GetContext(), object, 1, &arg0);
}

CORE_EXPORT v8::Local<v8::Promise> PromiseCall(
    ScriptState* script_state, v8::Local<v8::Function> method, v8::Local<v8::Object> recv, int argc, v8::Local<v8::Value> argv[])
{
    DCHECK_GE(argc, 0);
    v8::Isolate* isolate = script_state->GetIsolate();
    v8::TryCatch trycatch(isolate);
    ...
    v8::MaybeLocal<v8::Value> result_maybe = method->Call(script_state->GetContext(), recv, argc, argv);
...
CORE_EXPORT double ValidateAndNormalizeHighWaterMark(double high_water_mark, ExceptionState& exception_state)
{
    // https://streams.spec.whatwg.org/#validate-and-normalize-high-water-mark
    // 2. If highWaterMark is NaN or highWaterMark < 0, throw a RangeError
    //    exception.
    if (isnan(high_water_mark) || high_water_mark < 0) {
        exception_state.ThrowRangeError("A queuing strategy's highWaterMark property must be a nonnegative, "
                                        "non-NaN number");
        return 0;
    }
...
CORE_EXPORT StrategySizeAlgorithm* MakeSizeAlgorithmFromSizeFunction(ScriptState* script_state, v8::Local<v8::Value> size, ExceptionState& exception_state)
{
    ...
    if (!size->IsFunction()) {
        exception_state.ThrowTypeError("A queuing strategy's size property must be a function");
        return nullptr;
    }
    ...
    return MakeGarbageCollected<JavaScriptSizeAlgorithm>(script_state->GetIsolate(), size.As<v8::Function>());
}
...
CORE_EXPORT v8::Local<v8::Promise> PromiseResolve(ScriptState* script_state, v8::Local<v8::Value> value)
{
    if (value->IsPromise()) {
...
CORE_EXPORT v8::Local<v8::Promise> PromiseResolveWithUndefined(ScriptState* script_state)
{
    return PromiseResolve(script_state, v8::Undefined(script_state->GetIsolate()));
}

CORE_EXPORT v8::Local<v8::Promise> PromiseReject(ScriptState* script_state, v8::Local<v8::Value> value)
{
    return PromiseRejectInternal(script_state, value, 0);
}

void ScriptValueToObject(ScriptState* script_state, ScriptValue value, v8::Local<v8::Object>* object, ExceptionState& exception_state)
{
    auto* isolate = script_state->GetIsolate();
...
StrategyUnpacker::StrategyUnpacker(ScriptState* script_state, ScriptValue strategy, ExceptionState& exception_state)
{
    auto* isolate = script_state->GetIsolate();
    auto context = script_state->GetContext();
    v8::Local<v8::Object> strategy_object;
    ScriptValueToObject(script_state, strategy, &strategy_object, exception_state);
    if (exception_state.HadException()) {
        return;
    }
    ...
    TryRethrowScope rethrow_scope(isolate, exception_state);
    if (!strategy_object->Get(context, V8AtomicString(isolate, "size")).ToLocal(&size_)) {
        return;
    }

    // 3. Let highWaterMark be ? GetV(strategy, "highWaterMark").
    if (!strategy_object->Get(context, V8AtomicString(isolate, "highWaterMark")).ToLocal(&high_water_mark_)) {
        return;
    }
}

StrategySizeAlgorithm* StrategyUnpacker::MakeSizeAlgorithm(ScriptState* script_state, ExceptionState& exception_state) const
{
    DCHECK(!size_.IsEmpty());
    // 6. Let sizeAlgorithm be ? MakeSizeAlgorithmFromSizeFunction(size).
    return MakeSizeAlgorithmFromSizeFunction(script_state, size_, exception_state);
}

double StrategyUnpacker::GetHighWaterMark(ScriptState* script_state, int default_value, ExceptionState& exception_state) const
{
    ...
    if (!high_water_mark_->ToNumber(script_state->GetContext()).ToLocal(&high_water_mark_as_number)) {
        return 0.0;
    }

    // 8. Set highWaterMark to ? ValidateAndNormalizeHighWaterMark(highWaterMark)
    return ValidateAndNormalizeHighWaterMark(high_water_mark_as_number->Value(), exception_state);
}
