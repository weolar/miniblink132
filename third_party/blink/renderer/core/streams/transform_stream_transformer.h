...
class CORE_EXPORT TransformStreamTransformer : public GarbageCollected<TransformStreamTransformer> {
public:
    TransformStreamTransformer() = default;
    TransformStreamTransformer(const TransformStreamTransformer&) = delete;
    TransformStreamTransformer& operator=(const TransformStreamTransformer&) = delete;
    virtual ~TransformStreamTransformer() = default;

    virtual ScriptPromise<IDLUndefined> Transform(v8::Local<v8::Value> chunk, TransformStreamDefaultController*, ExceptionState&) = 0;
    virtual ScriptPromise<IDLUndefined> Flush(TransformStreamDefaultController*, ExceptionState&) = 0;
