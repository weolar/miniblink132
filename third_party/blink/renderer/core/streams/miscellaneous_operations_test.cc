...
TEST(MiscellaneousOperationsTest, CreateAlgorithmNoMethod)
{
    ...
    auto* algo
        = CreateAlgorithmFromUnderlyingMethod(scope.GetScriptState(), underlying_object, "pull", "underlyingSource.pull", EmptyExtraArg(), ASSERT_NO_EXCEPTION);
    ASSERT_TRUE(algo);
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmUndefinedMethod)
{
    ...
    V8TestingScope scope;
    auto underlying_object = v8::Object::New(scope.GetIsolate());
    underlying_object->Set(scope.GetContext(), V8String(scope.GetIsolate(), "pull"), v8::Undefined(scope.GetIsolate())).Check();
    auto* algo
        = CreateAlgorithmFromUnderlyingMethod(scope.GetScriptState(), underlying_object, "pull", "underlyingSource.pull", EmptyExtraArg(), ASSERT_NO_EXCEPTION);
    ASSERT_TRUE(algo);
    auto promise = algo->Run(scope.GetScriptState(), 0, nullptr);
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmNullMethod)
{
    ...
    V8TestingScope scope;
    auto underlying_object = v8::Object::New(scope.GetIsolate());
    underlying_object->Set(scope.GetContext(), V8String(scope.GetIsolate(), "pull"), v8::Null(scope.GetIsolate())).Check();
    ExceptionState exception_state(scope.GetIsolate(), v8::ExceptionContext::kOperation, "", "");
    auto* algo
        = CreateAlgorithmFromUnderlyingMethod(scope.GetScriptState(), underlying_object, "pull", "underlyingSource.pull", EmptyExtraArg(), exception_state);
    EXPECT_FALSE(algo);
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmThrowingGetter)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    ScriptValue underlying_value = EvalWithPrintingError(&scope, "({ get pull() { throw new TypeError(); } })");
...
v8::Local<v8::Value> CreateFromFunctionAndGetResult(V8TestingScope* scope, const char* function_definition,
    v8::MaybeLocal<v8::Value> extra_arg = v8::MaybeLocal<v8::Value>(), int argc = 0, v8::Local<v8::Value> argv[] = nullptr)
{
    String js = String("({start: ") + function_definition + "})" + '\0';
    ScriptValue underlying_value = EvalWithPrintingError(scope, js.Utf8().c_str());
    auto underlying_object = underlying_value.V8Value().As<v8::Object>();
    auto* algo
        = CreateAlgorithmFromUnderlyingMethod(scope->GetScriptState(), underlying_object, "start", "underlyingSource.start", extra_arg, ASSERT_NO_EXCEPTION);
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmReturnsPromise)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    auto result = CreateFromFunctionAndGetResult(&scope, "() => Promise.resolve(2)");
    ASSERT_TRUE(result->IsNumber());
    EXPECT_EQ(result.As<v8::Number>()->Value(), 2);
}

bool CreateFromFunctionAndGetSuccess(V8TestingScope* scope, const char* function_definition, v8::MaybeLocal<v8::Value> extra_arg = v8::MaybeLocal<v8::Value>(),
    int argc = 0, v8::Local<v8::Value> argv[] = nullptr)
{
    auto result = CreateFromFunctionAndGetResult(scope, function_definition, extra_arg, argc, argv);
    if (!result->IsBoolean()) {
        return false;
    }
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmNoArgs)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    EXPECT_TRUE(CreateFromFunctionAndGetSuccess(&scope, "(...args) => args.length === 0"));
}
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmExtraArg)
{
    ...
    EXPECT_TRUE(CreateFromFunctionAndGetSuccess(&scope, "(...args) => args.length === 1 && args[0] === 7", extra_arg));
}
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmPassOneArg)
{
    ...
    EXPECT_TRUE(CreateFromFunctionAndGetSuccess(&scope, "(...args) => args.length === 1 && args[0] === 10", EmptyExtraArg(), 1, argv));
}
...
TEST(MiscellaneousOperationsTest, CreateAlgorithmPassBoth)
{
    ...
    v8::Local<v8::Value> argv[] = { v8::Number::New(scope.GetIsolate(), 10) };
    EXPECT_TRUE(CreateFromFunctionAndGetSuccess(&scope, "(...args) => args.length === 2 && args[0] === 10 && args[1] === 5", extra_arg, 1, argv));
}
...
TEST(MiscellaneousOperationsTest, CreateStartAlgorithmNoMethod)
{
    ...
    auto* algo = CreateStartAlgorithm(scope.GetScriptState(), underlying_object, "underlyingSink.start", controller);
    ASSERT_TRUE(algo);
...
TEST(MiscellaneousOperationsTest, CreateStartAlgorithmNullMethod)
{
    ...
    V8TestingScope scope;
    auto underlying_object = v8::Object::New(scope.GetIsolate());
    underlying_object->Set(scope.GetContext(), V8String(scope.GetIsolate(), "start"), v8::Null(scope.GetIsolate())).Check();
    v8::Local<v8::Value> controller = v8::Undefined(scope.GetIsolate());
    auto* algo = CreateStartAlgorithm(scope.GetScriptState(), underlying_object, "underlyingSink.start", controller);
    ASSERT_TRUE(algo);
    ExceptionState exception_state(scope.GetIsolate(), v8::ExceptionContext::kOperation, "", "");
...
TEST(MiscellaneousOperationsTest, CreateStartAlgorithmReturningController)
{
  ...
  start(controller) {
    ...
    v8::Local<v8::Value> controller = v8::Promise::Resolver::New(scope.GetContext()).ToLocalChecked()->GetPromise();
    auto* algo = CreateStartAlgorithm(scope.GetScriptState(), underlying_object, "underlyingSink.start", controller);
    ASSERT_TRUE(algo);
    auto maybe_result = algo->Run(scope.GetScriptState(), ASSERT_NO_EXCEPTION);
...
TEST(MiscellaneousOperationsTest, CallOrNoop1NoMethod)
{
    ...
    auto maybe_result = CallOrNoop1(scope.GetScriptState(), underlying_object, "transform", "transformer.transform", arg0, ASSERT_NO_EXCEPTION);
    ASSERT_FALSE(maybe_result.IsEmpty());
...
TEST(MiscellaneousOperationsTest, CallOrNoop1NullMethod)
{
    ...
    auto underlying_object = v8::Object::New(scope.GetIsolate());
    v8::Local<v8::Value> arg0 = v8::Number::New(scope.GetIsolate(), 0);
    underlying_object->Set(scope.GetContext(), V8String(scope.GetIsolate(), "transform"), v8::Null(scope.GetIsolate())).Check();
    ExceptionState exception_state(scope.GetIsolate(), v8::ExceptionContext::kOperation, "", "");
    auto maybe_result = CallOrNoop1(scope.GetScriptState(), underlying_object, "transform", "transformer.transform", arg0, exception_state);
...
TEST(MiscellaneousOperationsTest, CallOrNoop1ThrowingMethod)
{
  ...
  transform(...args) {
    ...
    auto maybe_result
        = CallOrNoop1(scope.GetScriptState(), underlying_object, "transform", "transformer.transform", arg0, PassThroughException(scope.GetIsolate()));
    ASSERT_TRUE(try_catch.HasCaught());
    EXPECT_TRUE(maybe_result.IsEmpty());
    EXPECT_TRUE(try_catch.Exception()->IsBoolean());
}

v8::Local<v8::Promise> PromiseCallFromText(
    V8TestingScope* scope, const char* function_definition, const char* object_definition, int argc, v8::Local<v8::Value> argv[])
{
    ScriptValue function_value = EvalWithPrintingError(scope, function_definition);
    ...
    return PromiseCall(scope->GetScriptState(), function_value.V8Value().As<v8::Function>(), object_value.V8Value().As<v8::Object>(), argc, argv);
}
...
TEST(MiscellaneousOperationsTest, PromiseCalledWithObject)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    v8::Local<v8::Promise> promise = PromiseCallFromText(&scope, "(function() { return this.value === 15; })", "({ value: 15 })", 0, nullptr);
    ASSERT_EQ(promise->State(), v8::Promise::kFulfilled);
...
TEST(MiscellaneousOperationsTest, PromiseCallThrowing)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    v8::Local<v8::Promise> promise = PromiseCallFromText(&scope, "(function() { throw new TypeError(); })", "({})", 0, nullptr);
...
TEST(MiscellaneousOperationsTest, PromiseCallRejecting)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    v8::Local<v8::Promise> promise = PromiseCallFromText(&scope, "(function() { return Promise.reject(16) })", "({})", 0, nullptr);
    ASSERT_EQ(promise->State(), v8::Promise::kRejected);
...
TEST(MiscellaneousOperationsTest, ValidateInfiniteHighWaterMark)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    EXPECT_FALSE(isfinite(ValidateAndNormalizeHighWaterMark(std::numeric_limits<double>::infinity(), ASSERT_NO_EXCEPTION)));
}
...
TEST(MiscellaneousOperationsTest, NaNHighWaterMarkInvalid)
{
    ...
    V8TestingScope scope;
    ExceptionState exception_state(scope.GetIsolate(), v8::ExceptionContext::kOperation, "", "");
    ValidateAndNormalizeHighWaterMark(std::numeric_limits<double>::quiet_NaN(), exception_state);
    EXPECT_TRUE(exception_state.HadException());
}
...
TEST(MiscellaneousOperationsTest, UndefinedSizeFunction)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    auto* algo = MakeSizeAlgorithmFromSizeFunction(scope.GetScriptState(), v8::Undefined(scope.GetIsolate()), ASSERT_NO_EXCEPTION);
    ASSERT_TRUE(algo);
    auto optional = algo->Run(scope.GetScriptState(), v8::Number::New(scope.GetIsolate(), 97));
...
TEST(MiscellaneousOperationsTest, NullSizeFunction)
{
    ...
    V8TestingScope scope;
    ExceptionState exception_state(scope.GetIsolate(), v8::ExceptionContext::kOperation, "", "");
    EXPECT_EQ(MakeSizeAlgorithmFromSizeFunction(scope.GetScriptState(), v8::Null(scope.GetIsolate()),
...
StrategySizeAlgorithm* IdentitySizeAlgorithm(V8TestingScope* scope)
{
    ...
    EXPECT_TRUE(function_value.IsFunction());
    return MakeSizeAlgorithmFromSizeFunction(scope->GetScriptState(), function_value.V8Value(), ASSERT_NO_EXCEPTION);
}
...
TEST(MiscellaneousOperationsTest, SizeAlgorithmWorks)
{
    ...
    ASSERT_TRUE(algo);
    auto optional = algo->Run(scope.GetScriptState(), v8::Number::New(scope.GetIsolate(), 41));
    ASSERT_TRUE(optional.has_value());
...
TEST(MiscellaneousOperationsTest, SizeAlgorithmConvertsToNumber)
{
    ...
    auto* algo = IdentitySizeAlgorithm(&scope);
    ASSERT_TRUE(algo);
    auto optional = algo->Run(scope.GetScriptState(), V8String(scope.GetIsolate(), "79"));
    ASSERT_TRUE(optional.has_value());
...
TEST(MiscellaneousOperationsTest, ThrowingSizeAlgorithm)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    ScriptValue function_value = EvalWithPrintingError(&scope, "() => { throw new TypeError(); }");
    EXPECT_TRUE(function_value.IsFunction());
    auto* algo = MakeSizeAlgorithmFromSizeFunction(scope.GetScriptState(), function_value.V8Value(), ASSERT_NO_EXCEPTION);
    ASSERT_TRUE(algo);
    v8::TryCatch try_catch(scope.GetIsolate());
    auto optional = algo->Run(scope.GetScriptState(), V8String(scope.GetIsolate(), "79"));
...
TEST(MiscellaneousOperationsTest, UnconvertibleSize)
{
    ...
    auto* algo = IdentitySizeAlgorithm(&scope);
    ASSERT_TRUE(algo);
    ScriptValue unconvertible_value = EvalWithPrintingError(&scope, "({ toString() { throw new Error(); }})");
    EXPECT_TRUE(unconvertible_value.IsObject());
    v8::TryCatch try_catch(scope.GetIsolate());
    auto optional = algo->Run(scope.GetScriptState(), unconvertible_value.V8Value());
...
TEST(MiscellaneousOperationsTest, PromiseResolve)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    auto promise = PromiseResolve(scope.GetScriptState(), v8::Number::New(scope.GetIsolate(), 19));
    ASSERT_EQ(promise->State(), v8::Promise::kFulfilled);
    ASSERT_TRUE(promise->Result()->IsNumber());
...
TEST(MiscellaneousOperationsTest, PromiseResolveWithPromise)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    auto original_promise = v8::Promise::Resolver::New(scope.GetContext()).ToLocalChecked()->GetPromise();
    auto resolved_promise = PromiseResolve(scope.GetScriptState(), original_promise);
...
TEST(MiscellaneousOperationsTest, PromiseReject)
{
    test::TaskEnvironment task_environment;
    V8TestingScope scope;
    auto promise = PromiseReject(scope.GetScriptState(), v8::Number::New(scope.GetIsolate(), 43));
    ASSERT_EQ(promise->State(), v8::Promise::kRejected);
    ASSERT_TRUE(promise->Result()->IsNumber());
