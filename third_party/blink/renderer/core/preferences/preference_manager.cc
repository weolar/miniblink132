...
{
    color_scheme_ = MakeGarbageCollected<PreferenceObject>(executionContext, preference_names::kColorScheme);
    contrast_ = MakeGarbageCollected<PreferenceObject>(executionContext, preference_names::kContrast);
    reduced_motion_ = MakeGarbageCollected<PreferenceObject>(executionContext, preference_names::kReducedMotion);
    reduced_transparency_ = MakeGarbageCollected<PreferenceObject>(executionContext, preference_names::kReducedTransparency);
    reduced_data_ = MakeGarbageCollected<PreferenceObject>(executionContext, preference_names::kReducedData);
}
