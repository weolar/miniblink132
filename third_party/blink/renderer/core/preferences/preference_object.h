...
class CORE_EXPORT PreferenceObject final : public EventTarget, public ExecutionContextLifecycleObserver {
...
public:
    ...
    ScriptPromise<IDLUndefined> requestOverride(ScriptState*, std::optional<AtomicString>);
