...
public:
    XSLStyleSheet(Node* parent_node, const String& original_url, const KURL& final_url, bool embedded);
    ...
    XSLStyleSheet(Document* owner_document, Node* style_sheet_root_node, const String& original_url, const KURL& final_url, bool embedded);
    XSLStyleSheet(XSLStyleSheet* parent_style_sheet, const String& original_url, const KURL& final_url);
    ...
    xmlDocPtr LocateStylesheetSubResource(xmlDocPtr parent_doc, const xmlChar* uri);
...
template <> struct DowncastTraits<XSLStyleSheet> {
