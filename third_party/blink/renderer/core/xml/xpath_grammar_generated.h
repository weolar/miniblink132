...
public:
    ...
    public:
        ...
        /// Empty construction.
        semantic_type() YY_NOEXCEPT : yybuffer_()
        {
        }

        /// Construct and fill.
        template <typename T> semantic_type(YY_RVREF(T) t)
        {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kMulOp(blink::xpath::NumericOp::Opcode v)
    {
        return symbol_type(token::kMulOp, std::move(v));
    }
#else
    static symbol_type make_kMulOp(const blink::xpath::NumericOp::Opcode& v)
    {
        return symbol_type(token::kMulOp, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kEqOp(blink::xpath::EqTestOp::Opcode v)
    {
        return symbol_type(token::kEqOp, std::move(v));
    }
#else
    static symbol_type make_kEqOp(const blink::xpath::EqTestOp::Opcode& v)
    {
        return symbol_type(token::kEqOp, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kRelOp(blink::xpath::EqTestOp::Opcode v)
    {
        return symbol_type(token::kRelOp, std::move(v));
    }
#else
    static symbol_type make_kRelOp(const blink::xpath::EqTestOp::Opcode& v)
    {
        return symbol_type(token::kRelOp, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kPlus()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kMinus()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kAxisName(blink::xpath::Step::Axis v)
    {
        return symbol_type(token::kAxisName, std::move(v));
    }
#else
    static symbol_type make_kAxisName(const blink::xpath::Step::Axis& v)
    {
        return symbol_type(token::kAxisName, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kNodeType(String v)
    {
        return symbol_type(token::kNodeType, std::move(v));
    }
#else
    static symbol_type make_kNodeType(const String& v)
    {
        return symbol_type(token::kNodeType, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kPI(String v)
    {
        return symbol_type(token::kPI, std::move(v));
    }
#else
    static symbol_type make_kPI(const String& v)
    {
        return symbol_type(token::kPI, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kFunctionName(String v)
    {
        return symbol_type(token::kFunctionName, std::move(v));
    }
#else
    static symbol_type make_kFunctionName(const String& v)
    {
        return symbol_type(token::kFunctionName, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kLiteral(String v)
    {
        return symbol_type(token::kLiteral, std::move(v));
    }
#else
    static symbol_type make_kLiteral(const String& v)
    {
        return symbol_type(token::kLiteral, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kVariableReference(String v)
    {
        return symbol_type(token::kVariableReference, std::move(v));
    }
#else
    static symbol_type make_kVariableReference(const String& v)
    {
        return symbol_type(token::kVariableReference, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kNumber(String v)
    {
        return symbol_type(token::kNumber, std::move(v));
    }
#else
    static symbol_type make_kNumber(const String& v)
    {
        return symbol_type(token::kNumber, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kDotDot()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kSlashSlash()
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kNameTest(String v)
    {
        return symbol_type(token::kNameTest, std::move(v));
    }
#else
    static symbol_type make_kNameTest(const String& v)
    {
        return symbol_type(token::kNameTest, v);
    }
#endif
#if 201103L <= YY_CPLUSPLUS
    static symbol_type make_kXPathError()
    {
