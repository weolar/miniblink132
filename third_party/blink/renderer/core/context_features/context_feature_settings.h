...
class CORE_EXPORT ContextFeatureSettings final : public GarbageCollected<ContextFeatureSettings>, public Supplement<ExecutionContext> {
public:
    ...
    void EnableMojoJS(bool enable)
    {
        enable_mojo_js_ = enable;
    }
