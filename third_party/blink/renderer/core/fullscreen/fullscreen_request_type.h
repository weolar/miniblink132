...
inline FullscreenRequestType operator|(FullscreenRequestType lhs, FullscreenRequestType rhs)
{
    return static_cast<FullscreenRequestType>(static_cast<int>(lhs) | static_cast<int>(rhs));
}
