...
public:
    static ScriptPromise<IDLUndefined> requestFullscreen(ScriptState*, Element&, const FullscreenOptions*, ExceptionState& exception_state);
    ...
    DEFINE_STATIC_ATTRIBUTE_EVENT_LISTENER(webkitfullscreenchange, kWebkitfullscreenchange)
    DEFINE_STATIC_ATTRIBUTE_EVENT_LISTENER(webkitfullscreenerror, kWebkitfullscreenerror)
};
