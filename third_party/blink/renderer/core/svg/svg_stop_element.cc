...
SVGStopElement::SVGStopElement(Document& document)
    ...
    , offset_(MakeGarbageCollected<SVGAnimatedNumber>(this, svg_names::kOffsetAttr, MakeGarbageCollected<SVGNumberAcceptPercentage>()))
{
...
void SVGStopElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
SVGAnimatedPropertyBase* SVGStopElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
