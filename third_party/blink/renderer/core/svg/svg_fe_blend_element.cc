...
template <> const SVGEnumerationMap& GetEnumerationMap<SVGFEBlendElement::Mode>()
{
...
SVGFEBlendElement::SVGFEBlendElement(Document& document)
    ...
    , mode_(MakeGarbageCollected<SVGAnimatedEnumeration<Mode>>(this, svg_names::kModeAttr, SVGFEBlendElement::kModeNormal))
{
}
...
bool SVGFEBlendElement::SetFilterEffectAttribute(FilterEffect* effect, const QualifiedName& attr_name)
{
...
void SVGFEBlendElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
FilterEffect* SVGFEBlendElement::Build(SVGFilterBuilder* filter_builder, Filter* filter)
{
    ...
    auto* effect = MakeGarbageCollected<FEBlend>(filter, ToBlendMode(mode_->CurrentEnumValue()));
...
SVGAnimatedPropertyBase* SVGFEBlendElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
