...
enum SVGStitchOptions { kSvgStitchtypeUnknown = 0, kSvgStitchtypeStitch = 1, kSvgStitchtypeNostitch = 2 };
...
public:
    ...
    SVGAnimatedEnumeration<TurbulenceType>* type()
    {
        return type_.Get();
    }
...
private:
    bool SetFilterEffectAttribute(FilterEffect*, const QualifiedName& attr_name) override;
