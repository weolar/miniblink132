...
TEST(SVGPathParserTest, ErrorReporting)
{
    ...
    // Invalid arc-flag.
    EXPECT_ERROR("M0,0 A10,10 0 #,0 20,20", 14u, SVGParseStatus::kExpectedArcFlag);
    EXPECT_ERROR("M0,0 A10,10 0 0,# 20,20", 16u, SVGParseStatus::kExpectedArcFlag);
    EXPECT_ERROR("M0,0 A10,10 0 0,2 20,20", 16u, SVGParseStatus::kExpectedArcFlag);
}
