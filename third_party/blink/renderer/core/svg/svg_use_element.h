...
class SVGUseElement final : public SVGGraphicsElement, public SVGURIReference, public SVGResourceDocumentObserver {
...
private:
    ...
    bool HasCycleUseReferencing(const ContainerNode& target_instance, const SVGElement& new_target) const;
    ...
    void CollectExtraStyleForPresentationAttribute(MutableCSSPropertyValueSet* style) override;
    ...
    FRIEND_TEST_ALL_PREFIXES(SVGUseElementTest, NullInstanceRootWhenNotConnectedToDocument);
    FRIEND_TEST_ALL_PREFIXES(SVGUseElementTest, NullInstanceRootWhenConnectedToInactiveDocument);
    FRIEND_TEST_ALL_PREFIXES(SVGUseElementTest, NullInstanceRootWhenShadowTreePendingRebuild);
};
