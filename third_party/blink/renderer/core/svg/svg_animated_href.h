...
public:
    ...
    void setBaseVal(const V8UnionStringOrTrustedScriptURL* value, ExceptionState& exception_state) override;
    ...
    SVGAnimatedPropertyBase* PropertyFromAttribute(const QualifiedName& attribute_name);
