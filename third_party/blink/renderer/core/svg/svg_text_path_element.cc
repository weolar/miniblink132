...
template <> const SVGEnumerationMap& GetEnumerationMap<SVGTextPathMethodType>()
{
...
template <> const SVGEnumerationMap& GetEnumerationMap<SVGTextPathSpacingType>()
{
    static constexpr auto enum_items = std::to_array<const char* const>({
        "auto",
        "exact",
...
SVGTextPathElement::SVGTextPathElement(Document& document)
    ...
    , start_offset_(MakeGarbageCollected<SVGAnimatedLength>(this, svg_names::kStartOffsetAttr, SVGLengthMode::kWidth, SVGLength::Initial::kUnitlessZero))
    , method_(MakeGarbageCollected<SVGAnimatedEnumeration<SVGTextPathMethodType>>(this, svg_names::kMethodAttr, kSVGTextPathMethodAlign))
    , spacing_(MakeGarbageCollected<SVGAnimatedEnumeration<SVGTextPathSpacingType>>(this, svg_names::kSpacingAttr, kSVGTextPathSpacingExact))
{
}
...
void SVGTextPathElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
    ...
    if (attr_name == svg_names::kStartOffsetAttr || attr_name == svg_names::kMethodAttr || attr_name == svg_names::kSpacingAttr) {
...
{
    if (parentNode() && (IsA<SVGAElement>(*parentNode()) || IsA<SVGTextElement>(*parentNode())))
...
Node::InsertionNotificationRequest SVGTextPathElement::InsertedInto(ContainerNode& root_parent)
{
...
{
    return start_offset_->CurrentValue()->IsRelative() || SVGTextContentElement::SelfHasRelativeLengths();
}

SVGAnimatedPropertyBase* SVGTextPathElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
...
{
    SVGAnimatedPropertyBase* attrs[] { start_offset_.Get(), method_.Get(), spacing_.Get() };
