...
SVGMPathElement::SVGMPathElement(Document& document)
    : SVGElement(svg_names::kMPathTag, document)
...
SVGAnimatedPropertyBase* SVGMPathElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
...
Node::InsertionNotificationRequest SVGMPathElement::InsertedInto(ContainerNode& root_parent)
{
...
void SVGMPathElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
