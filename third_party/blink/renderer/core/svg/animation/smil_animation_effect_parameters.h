...
inline float ComputeAnimatedNumber(const SMILAnimationEffectParameters& parameters, float percentage, unsigned repeat_count, float from_number, float to_number,
