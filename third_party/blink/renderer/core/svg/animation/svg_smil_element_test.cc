...
Vector<std::pair<SMILTime, SMILTimeOrigin>> ExtractListContents(const SMILInstanceTimeList& list)
{
...
TEST(SMILInstanceTimeListTest, Sort)
{
    ...
    Vector<std::pair<SMILTime, SMILTimeOrigin>> expected_times({ { SMILTime::FromSecondsD(1), SMILTimeOrigin::kAttribute },
        { SMILTime::FromSecondsD(2), SMILTimeOrigin::kAttribute }, { SMILTime::FromSecondsD(3), SMILTimeOrigin::kAttribute },
        { SMILTime::FromSecondsD(4), SMILTimeOrigin::kAttribute }, { SMILTime::FromSecondsD(5), SMILTimeOrigin::kAttribute } });
...
TEST(SMILInstanceTimeListTest, InsertSortedAndUnique)
{
    ...
    // Unique time/item.
    list.InsertSortedAndUnique(SMILTime::FromSecondsD(4), SMILTimeOrigin::kScript);
    ASSERT_EQ(list.size(), 4u);
    Vector<std::pair<SMILTime, SMILTimeOrigin>> expected_times1(
        { { SMILTime::FromSecondsD(1), SMILTimeOrigin::kAttribute }, { SMILTime::FromSecondsD(2), SMILTimeOrigin::kScript },
            { SMILTime::FromSecondsD(3), SMILTimeOrigin::kAttribute }, { SMILTime::FromSecondsD(4), SMILTimeOrigin::kScript } });
    ASSERT_EQ(ExtractListContents(list), expected_times1);

    // Non-unique item.
    list.InsertSortedAndUnique(SMILTime::FromSecondsD(2), SMILTimeOrigin::kScript);
    ASSERT_EQ(list.size(), 4u);
    ASSERT_EQ(ExtractListContents(list), expected_times1);

    // Same time but different origin.
    list.InsertSortedAndUnique(SMILTime::FromSecondsD(2), SMILTimeOrigin::kAttribute);
    ASSERT_EQ(list.size(), 5u);
    Vector<std::pair<SMILTime, SMILTimeOrigin>> expected_times2({ { SMILTime::FromSecondsD(1), SMILTimeOrigin::kAttribute },
        { SMILTime::FromSecondsD(2), SMILTimeOrigin::kAttribute }, { SMILTime::FromSecondsD(2), SMILTimeOrigin::kScript },
        { SMILTime::FromSecondsD(3), SMILTimeOrigin::kAttribute }, { SMILTime::FromSecondsD(4), SMILTimeOrigin::kScript } });
...
TEST(SMILInstanceTimeListTest, RemoveWithOrigin)
{
    ...
    ASSERT_EQ(list.size(), 3u);
    Vector<std::pair<SMILTime, SMILTimeOrigin>> expected_times({ { SMILTime::FromSecondsD(2), SMILTimeOrigin::kAttribute },
        { SMILTime::FromSecondsD(3), SMILTimeOrigin::kAttribute }, { SMILTime::FromSecondsD(5), SMILTimeOrigin::kAttribute } });
    ASSERT_EQ(ExtractListContents(list), expected_times);
}
...
TEST(SMILInstanceTimeListTest, NextAfter)
{
    ...
    EXPECT_EQ(list.NextAfter(SMILTime::FromSecondsD(2) - SMILTime::Epsilon()), SMILTime::FromSecondsD(2));
    // Equal to an entry in the list.
    EXPECT_EQ(list.NextAfter(SMILTime::FromSecondsD(2)), SMILTime::FromSecondsD(3));
    // Just after an entry in the list.
    EXPECT_EQ(list.NextAfter(SMILTime::FromSecondsD(2) + SMILTime::Epsilon()), SMILTime::FromSecondsD(3));
...
TEST(SVGSMILElementTest, RepeatNEventListenerUseCounted)
{
    ...
    ASSERT_TRUE(set);
    set->addEventListener(AtomicString("repeatn"), MakeGarbageCollected<EmptyEventListener>());
