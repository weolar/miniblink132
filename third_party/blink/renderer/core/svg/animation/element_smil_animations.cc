...
void ElementSMILAnimations::AddAnimation(const QualifiedName& attribute, SVGAnimationElement* animation)
{
...
void ElementSMILAnimations::RemoveAnimation(const QualifiedName& attribute, SVGAnimationElement* animation)
{
