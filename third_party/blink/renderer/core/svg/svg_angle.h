...
enum SVGMarkerOrientType { kSVGMarkerOrientUnknown = 0, kSVGMarkerOrientAuto, kSVGMarkerOrientAngle, kSVGMarkerOrientAutoStartReverse };
...
public:
    ...
    void NewValueSpecifiedUnits(SVGAngleType unit_type, float value_in_specified_units);
    void ConvertToSpecifiedUnits(SVGAngleType unit_type);

    SVGEnumeration* OrientType()
    {
...
template <> struct DowncastTraits<SVGAngle> {
