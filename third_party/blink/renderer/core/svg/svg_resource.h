...
protected:
    ...
    HeapHashMap<Member<ImageResourceObserver>, Member<ImageResourceObserverWrapper>> observer_wrappers_;
};
...
public:
    ...
    void NotifyFilterPrimitiveChanged(SVGFilterPrimitiveStandardAttributes& primitive, const QualifiedName& attribute);
...
class ExternalSVGResourceDocumentContent final : public SVGResource, public SVGResourceDocumentObserver {
public:
...
// as the "data source".
class ExternalSVGResourceImageContent final : public SVGResource, public ImageResourceObserver {
    USING_PRE_FINALIZER(ExternalSVGResourceImageContent, Prefinalize);

public:
    ExternalSVGResourceImageContent(ImageResourceContent* image_content, const AtomicString& fragment);
