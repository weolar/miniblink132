...
class CORE_EXPORT SVGResourceDocumentContent final : public GarbageCollected<SVGResourceDocumentContent> {
public:
    static SVGResourceDocumentContent* Fetch(FetchParameters&, Document&);

    SVGResourceDocumentContent(AgentGroupScheduler&, scoped_refptr<base::SingleThreadTaskRunner>);
    ...
    UpdateResult UpdateDocument(scoped_refptr<SharedBuffer> data, const KURL& request_url);
    void ClearDocument();
    void Dispose();
