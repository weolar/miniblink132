...
public:
    ...
    const SVGLength* Cx() const
    {
        return cx_.Get();
    }
    const SVGLength* Cy() const
    {
        return cy_.Get();
    }
    ...
    const SVGLength* Fx() const
    {
        return fx_.Get();
    }
    const SVGLength* Fy() const
    {
        return fy_.Get();
    }
    const SVGLength* Fr() const
    {
        return fr_.Get();
    }

    void SetCx(const SVGLength* value)
    {
        cx_ = value;
    }
    void SetCy(const SVGLength* value)
    {
        cy_ = value;
    }
    void SetR(const SVGLength* value)
    {
        r_ = value;
    }
    void SetFx(const SVGLength* value)
    {
        fx_ = value;
    }
    void SetFy(const SVGLength* value)
    {
        fy_ = value;
    }
    void SetFr(const SVGLength* value)
    {
        fr_ = value;
    }
