...
SVGTransformableElement::SVGTransformableElement(const QualifiedName& tag_name, Document& document, ConstructionType construction_type)
    : SVGElement(tag_name, document, construction_type)
    , transform_(MakeGarbageCollected<SVGAnimatedTransformList>(this, svg_names::kTransformAttr, CSSPropertyID::kTransform))
{
}
...
void SVGTransformableElement::CollectExtraStyleForPresentationAttribute(MutableCSSPropertyValueSet* style)
{
...
AffineTransform SVGTransformableElement::LocalCoordinateSpaceTransform(CTMScope) const
{
...
void SVGTransformableElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
SVGAnimatedPropertyBase* SVGTransformableElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
