...
enum SVGZoomAndPanType { kSVGZoomAndPanUnknown = 0, kSVGZoomAndPanDisable, kSVGZoomAndPanMagnify };

class SVGZoomAndPan {
public:
    // Forward declare enumerations in the W3C naming scheme, for IDL generation.
    enum { kSvgZoomandpanUnknown = kSVGZoomAndPanUnknown, kSvgZoomandpanDisable = kSVGZoomAndPanDisable, kSvgZoomandpanMagnify = kSVGZoomAndPanMagnify };
