...
public:
    ...
    unsigned suspendRedraw(unsigned)
    {
        return 1;
    }
    ...
    StaticNodeTypeList<Element>* getIntersectionList(SVGRectTearOff*, SVGElement* reference_element) const;
    StaticNodeList* getEnclosureList(SVGRectTearOff*, SVGElement* reference_element) const;
    ...
    const SVGViewSpec* ParseViewSpec(const String& fragment_identifier, Element* anchor_node) const;
