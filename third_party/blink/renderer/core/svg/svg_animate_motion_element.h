...
private:
    ...
    bool CalculateToAtEndOfDurationValue(const String& to_at_end_of_duration_string) override;
    void CalculateFromAndToValues(const String& from_string, const String& to_string) override;
    void CalculateFromAndByValues(const String& from_string, const String& by_string) override;
    void CalculateAnimationValue(SMILAnimationValue&, float percentage, unsigned repeat_count) const override;
    void ApplyResultsToTarget(const SMILAnimationValue&) override;
    float CalculateDistance(const String& from_string, const String& to_string) override;
