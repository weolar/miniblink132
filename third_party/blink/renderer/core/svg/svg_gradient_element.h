...
enum SVGSpreadMethodType { kSVGSpreadMethodUnknown = 0, kSVGSpreadMethodPad, kSVGSpreadMethodReflect, kSVGSpreadMethodRepeat };
...
{
    return element.HasTagName(svg_names::kRadialGradientTag) || element.HasTagName(svg_names::kLinearGradientTag);
}

template <> struct DowncastTraits<SVGGradientElement> {
