...
void SVGFEMergeNodeElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
SVGAnimatedPropertyBase* SVGFEMergeNodeElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
