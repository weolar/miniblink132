...
public:
    ...
    {
        return gfx::RectF(x_, y_, width_, height_);
    }
...
private:
    ...
    template <typename CharType> SVGParsingError Parse(const CharType*& ptr, const CharType* end);
...
template <> struct DowncastTraits<SVGRect> {
