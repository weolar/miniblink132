...
SVGClipPathElement::SVGClipPathElement(Document& document)
    ...
    , clip_path_units_(MakeGarbageCollected<SVGAnimatedEnumeration<SVGUnitTypes::SVGUnitType>>(
          this, svg_names::kClipPathUnitsAttr, SVGUnitTypes::kSvgUnitTypeUserspaceonuse))
{
}
...
void SVGClipPathElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
SVGAnimatedPropertyBase* SVGClipPathElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
