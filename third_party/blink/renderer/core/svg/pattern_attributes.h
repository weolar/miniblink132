...
public:
    ...
    bool HasWidth() const
    {
        return width_ != nullptr;
    }
    bool HasHeight() const
    {
        return height_ != nullptr;
    }
    bool HasViewBox() const
    {
        return view_box_set_;
    }
    ...
    {
        return pattern_units_set_;
    }
    bool HasPatternContentUnits() const
    {
        return pattern_content_units_set_;
    }
    bool HasPatternTransform() const
    {
        return pattern_transform_set_;
    }
...
private:
    ...
    SVGUnitTypes::SVGUnitType pattern_units_ = SVGUnitTypes::kSvgUnitTypeObjectboundingbox;
    SVGUnitTypes::SVGUnitType pattern_content_units_ = SVGUnitTypes::kSvgUnitTypeUserspaceonuse;
