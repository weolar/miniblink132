...
void SVGFETileElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
FilterEffect* SVGFETileElement::Build(SVGFilterBuilder* filter_builder, Filter* filter)
{
...
SVGAnimatedPropertyBase* SVGFETileElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
