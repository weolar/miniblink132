...
enum SVGLengthAdjustType { kSVGLengthAdjustUnknown, kSVGLengthAdjustSpacing, kSVGLengthAdjustSpacingAndGlyphs };
...
private:
    bool IsTextContent() const final
    {
        return true;
    }
...
template <> struct DowncastTraits<SVGTextContentElement> {
