...
SVGPolyElement::SVGPolyElement(const QualifiedName& tag_name, Document& document)
    ...
    , points_(MakeGarbageCollected<SVGAnimatedPointList>(this, svg_names::kPointsAttr, MakeGarbageCollected<SVGPointList>()))
{
}
...
void SVGPolyElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
SVGAnimatedPropertyBase* SVGPolyElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
