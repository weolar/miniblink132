...
public:
    SVGAnimatedPointList* Points() const
    {
        return points_.Get();
    }
...
template <> struct DowncastTraits<SVGPolyElement> {
    ...
    {
        return svg_element.HasTagName(svg_names::kPolygonTag) || svg_element.HasTagName(svg_names::kPolylineTag);
    }
};
