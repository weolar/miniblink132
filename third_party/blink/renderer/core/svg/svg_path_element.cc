...
SVGPathElement::SVGPathElement(Document& document)
    ...
    , path_(MakeGarbageCollected<SVGAnimatedPath>(this, svg_names::kDAttr, CSSPropertyID::kD))
{
}
...
SVGPointTearOff* SVGPathElement::getPointAtLength(float length, ExceptionState& exception_state)
{
    GetDocument().UpdateStyleAndLayoutForNode(this, DocumentUpdateReason::kJavaScript);
...
void SVGPathElement::SvgAttributeChanged(const SvgAttributeChangedParams& params)
{
...
Node::InsertionNotificationRequest SVGPathElement::InsertedInto(ContainerNode& root_parent)
{
...
SVGAnimatedPropertyBase* SVGPathElement::PropertyFromAttribute(const QualifiedName& attribute_name) const
{
...
void SVGPathElement::CollectExtraStyleForPresentationAttribute(MutableCSSPropertyValueSet* style)
{
