...
SVGParsingError CORE_EXPORT BuildByteStreamFromString(const StringView&, SVGPathByteStreamBuilder&);

// SVGPathByteStream -> String
enum PathSerializationFormat { kNoTransformation, kTransformToAbsolute };
String BuildStringFromByteStream(const SVGPathByteStream&, PathSerializationFormat);
