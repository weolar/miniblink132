...
public:
    ...
    enum class Initial { kUnitlessZero, kPercentMinus10, kPercent0, kPercent50, kPercent100, kPercent120, kNumber3, kNumValues };
    ...
    const CSSPrimitiveValue& AsCSSPrimitiveValue() const
    {
        return *value_;
    }
    ...
    void NewValueSpecifiedUnits(CSSPrimitiveValue::UnitType, float value_in_specified_units);
    ...
    bool IsFontRelative() const
    {
        ...
        return value_->IsNumericLiteralValue() && To<CSSNumericLiteralValue>(*value_).IsFontRelativeLength();
    }
    bool IsCalculated() const
    {
        return value_->IsCalculated();
    }
    bool IsPercentage() const
    {
        return value_->IsPercentage();
    }
...
template <> struct DowncastTraits<SVGLength> {
