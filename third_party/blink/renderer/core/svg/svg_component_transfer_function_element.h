...
public:
    ...
    SVGAnimatedEnumeration<ComponentTransferType>* type()
    {
        return type_.Get();
    }
...
template <> struct DowncastTraits<SVGComponentTransferFunctionElement> {
    static bool AllowFrom(const SVGElement& svg_element)
    {
        return svg_element.HasTagName(svg_names::kFEFuncATag) || svg_element.HasTagName(svg_names::kFEFuncBTag)
            || svg_element.HasTagName(svg_names::kFEFuncGTag) || svg_element.HasTagName(svg_names::kFEFuncRTag);
    }
};
