...
enum SVGMarkerUnitsType { kSVGMarkerUnitsUnknown = 0, kSVGMarkerUnitsUserSpaceOnUse, kSVGMarkerUnitsStrokeWidth };
...
public:
    ...
    enum { kSvgMarkerOrientUnknown = kSVGMarkerOrientUnknown, kSvgMarkerOrientAuto = kSVGMarkerOrientAuto, kSvgMarkerOrientAngle = kSVGMarkerOrientAngle };
