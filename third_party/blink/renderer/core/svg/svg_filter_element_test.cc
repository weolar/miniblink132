...
TEST_F(SVGFilterElementSimTest, FilterInvalidatedIfPrimitivesChangeDuringParsing)
{
    ...
    const Element* target_element = GetDocument().getElementById(AtomicString("target"));
