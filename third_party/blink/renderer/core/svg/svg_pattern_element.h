...
class SVGPatternElement final : public SVGElement, public SVGURIReference, public SVGTests, public SVGFitToViewBox {
...
public:
    ...
    const SVGAnimatedEnumeration<SVGUnitTypes::SVGUnitType>* patternUnits() const
    {
        return pattern_units_.Get();
    }
    const SVGAnimatedEnumeration<SVGUnitTypes::SVGUnitType>* patternContentUnits() const
    {
        return pattern_content_units_.Get();
    }
...
private:
    ...
    Member<SVGAnimatedEnumeration<SVGUnitTypes::SVGUnitType>> pattern_content_units_;
