...
private:
    ...
    AffineTransform SourceToDestinationTransform(const LayoutObject& layout_object, const gfx::RectF& dest_rect) const;
    ...
    sk_sp<PaintFilter> CreateImageFilterForLayoutObject(const LayoutObject&, const gfx::RectF& dst_rect, const gfx::RectF& crop_rect);
