...
public:
    ...
    // SvgAttributeChanged.
    FilterEffect* EffectForElement(SVGFilterPrimitiveStandardAttributes& primitive)
    {
...
private:
    ...
    HeapHashMap<WeakMember<SVGFilterPrimitiveStandardAttributes>, Member<FilterEffect>> effect_element_;
};
...
public:
    SVGFilterBuilder(FilterEffect* source_graphic, SVGFilterGraphNodeMap* = nullptr, const cc::PaintFlags* fill_flags = nullptr,
