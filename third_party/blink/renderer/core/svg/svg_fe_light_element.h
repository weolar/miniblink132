...
public:
    ...
    std::optional<bool> SetLightSourceAttribute(FELighting*, const QualifiedName&) const;

    SVGAnimatedNumber* azimuth()
    {
        return azimuth_.Get();
    }
    const SVGAnimatedNumber* azimuth() const
    {
        return azimuth_.Get();
    }
    ...
    const SVGAnimatedNumber* elevation() const
    {
        return elevation_.Get();
    }
    SVGAnimatedNumber* x()
    ...
    const SVGAnimatedNumber* x() const
    {
        return x_.Get();
    }
    SVGAnimatedNumber* y()
    ...
    const SVGAnimatedNumber* y() const
    {
        return y_.Get();
    }
    SVGAnimatedNumber* z()
    ...
    const SVGAnimatedNumber* z() const
    {
        return z_.Get();
    }
    ...
    const SVGAnimatedNumber* pointsAtX() const
    {
        return points_at_x_.Get();
    }
    ...
    const SVGAnimatedNumber* pointsAtY() const
    {
        return points_at_y_.Get();
    }
    ...
    const SVGAnimatedNumber* pointsAtZ() const
    {
        return points_at_z_.Get();
    }
...
template <> struct DowncastTraits<SVGFELightElement> {
    ...
    {
        return svg_element.HasTagName(svg_names::kFEDistantLightTag) || svg_element.HasTagName(svg_names::kFEPointLightTag)
