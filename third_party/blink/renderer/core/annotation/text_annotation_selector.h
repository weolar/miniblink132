...
// suffix.
class CORE_EXPORT TextAnnotationSelector : public AnnotationSelector, public TextFragmentFinder::Client {
public:
    ...
    bool IsTextSelector() const override
    {
        return true;
    }
...
template <> struct DowncastTraits<TextAnnotationSelector> {
