...
public:
    ...
    static DOMMatrix* Create(ExecutionContext* execution_context, const V8UnionStringOrUnrestrictedDoubleSequence* init, ExceptionState& exception_state);
    ...
    static DOMMatrix* fromFloat32Array(NotShared<DOMFloat32Array>, ExceptionState&);
    static DOMMatrix* fromFloat64Array(NotShared<DOMFloat64Array>, ExceptionState&);
    ...
    template <typename T> explicit DOMMatrix(base::span<T> sequence);
    ...
    {
        matrix_.set_rc(0, 0, value);
    }
    void setM12(double value)
    {
        matrix_.set_rc(1, 0, value);
    }
    ...
    {
        matrix_.set_rc(0, 1, value);
    }
    void setM22(double value)
    {
        matrix_.set_rc(1, 1, value);
    }
    ...
    {
        matrix_.set_rc(0, 3, value);
    }
    void setM42(double value)
    {
        matrix_.set_rc(1, 3, value);
    }
    ...
    DOMMatrix* scaleSelf(double sx, double sy, double sz = 1, double ox = 0, double oy = 0, double oz = 0);
    DOMMatrix* scale3dSelf(double scale = 1, double ox = 0, double oy = 0, double oz = 0);
    ...
    DOMMatrix* setMatrixValue(const ExecutionContext*, const String&, ExceptionState&);
