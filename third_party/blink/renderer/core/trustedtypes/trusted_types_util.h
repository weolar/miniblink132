...
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckFor(SpecificTrustedType type, const V8TrustedType* trusted, const ExecutionContext* execution_context,
    const char* interface_name, const char* property_name, ExceptionState& exception_state);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScript(const V8UnionStringOrTrustedScript* value, const ExecutionContext* execution_context,
    const char* interface_name, const char* property_name, ExceptionState& exception_state);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScript(const V8UnionStringLegacyNullToEmptyStringOrTrustedScript* value,
    const ExecutionContext* execution_context, const char* interface_name, const char* property_name, ExceptionState& exception_state);
...
// policy.
[[nodiscard]] String TrustedTypesCheckFor(
    SpecificTrustedType, String, const ExecutionContext*, const char* interface_name, const char* property_name, ExceptionState&);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForHTML(
    const String&, const ExecutionContext*, const char* interface_name, const char* property_name, ExceptionState&);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScript(
    const String&, const ExecutionContext*, const char* interface_name, const char* property_name, ExceptionState&);
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForScriptURL(
    const String&, const ExecutionContext*, const char* interface_name, const char* property_name, ExceptionState&);
...
// cases.
String TrustedTypesCheckForJavascriptURLinNavigation(const String&, ExecutionContext*);
CORE_EXPORT String GetStringForScriptExecution(const String&, ScriptElementBase::Type, ExecutionContext*);
...
[[nodiscard]] CORE_EXPORT String TrustedTypesCheckForExecCommand(const String&, const ExecutionContext*, ExceptionState&);
