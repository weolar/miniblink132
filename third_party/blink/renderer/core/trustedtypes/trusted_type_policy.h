...
public:
    ...
    TrustedHTML* createHTML(v8::Isolate*, const String&, const HeapVector<ScriptValue>&, ExceptionState&);
    TrustedScript* createScript(v8::Isolate*, const String&, const HeapVector<ScriptValue>&, ExceptionState&);
    TrustedScriptURL* createScriptURL(v8::Isolate*, const String&, const HeapVector<ScriptValue>&, ExceptionState&);
