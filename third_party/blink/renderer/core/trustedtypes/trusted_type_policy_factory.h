...
class CORE_EXPORT TrustedTypePolicyFactory final : public EventTarget, public ExecutionContextClient {
...
public:
    ...
    TrustedTypePolicy* createPolicy(const String&, const TrustedTypePolicyOptions*, ExceptionState&);
    ...
    String getPropertyType(const String& tagName, const String& propertyName, const String& elementNS) const;
    String getAttributeType(const String& tagName, const String& attributeName, const String& tagNS, const String& attributeNS) const;
