...
TrustedScript::TrustedScript(String script)
...
TrustedScript* TrustedScript::fromLiteral(ScriptState* script_state, const ScriptValue& templateLiteral, ExceptionState& exception_state)
{
