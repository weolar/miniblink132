...
class CORE_EXPORT Mojo final : public ScriptWrappable, public Supplementable<Mojo> {
...
public:
    ...
    static const MojoResult kResultDeadlineExceeded = MOJO_RESULT_DEADLINE_EXCEEDED;
    ...
    static const MojoResult kResultPermissionDenied = MOJO_RESULT_PERMISSION_DENIED;
    static const MojoResult kResultResourceExhausted = MOJO_RESULT_RESOURCE_EXHAUSTED;
    static const MojoResult kResultFailedPrecondition = MOJO_RESULT_FAILED_PRECONDITION;
    ...
    static MojoCreateDataPipeResult* createDataPipe(const MojoCreateDataPipeOptions*);
    static MojoCreateSharedBufferResult* createSharedBuffer(unsigned num_bytes);

    static void bindInterface(ScriptState*, const String& interface_name, MojoHandle*, const V8MojoScope& scope, ExceptionState& exception_state);
