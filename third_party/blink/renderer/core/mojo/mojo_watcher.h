...
class MojoWatcher final : public ScriptWrappable, public ActiveScriptWrappable<MojoWatcher>, public ExecutionContextLifecycleObserver {
    DEFINE_WRAPPERTYPEINFO();

public:
    static MojoWatcher* Create(mojo::Handle, const MojoHandleSignals*, V8MojoWatchCallback*, ExecutionContext*);
