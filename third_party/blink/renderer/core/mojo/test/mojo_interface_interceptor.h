...
class MojoInterfaceInterceptor final : public EventTarget, public ActiveScriptWrappable<MojoInterfaceInterceptor>, public ExecutionContextLifecycleObserver {
    DEFINE_WRAPPERTYPEINFO();

public:
    using Scope = V8MojoInterfaceInterceptorScope;
    static MojoInterfaceInterceptor* Create(ExecutionContext*, const String& interface_name, const Scope& scope, ExceptionState&);

    MojoInterfaceInterceptor(ExecutionContext*, const String& interface_name, Scope::Enum scope);
