...
public:
    ...
    ShadowTreeStyleSheetCollection(const ShadowTreeStyleSheetCollection&) = delete;
    ShadowTreeStyleSheetCollection& operator=(const ShadowTreeStyleSheetCollection&) = delete;

    void UpdateActiveStyleSheets(StyleEngine&);
    bool IsShadowTreeStyleSheetCollection() const final
    {
        return true;
    }
...
template <> struct DowncastTraits<ShadowTreeStyleSheetCollection> {
