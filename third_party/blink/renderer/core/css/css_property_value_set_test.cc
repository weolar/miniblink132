...
TEST_F(CSSPropertyValueSetTest, MergeAndOverrideOnConflictCustomProperty)
{
    ...
    CSSParser::ParseSheet(context, style_sheet, sheet_text, CSSDeferPropertyParsing::kNo);
...
TEST_F(CSSPropertyValueSetTest, ConflictingLonghandAndShorthand)
{
    ...
    EXPECT_EQ("offset-position: normal; offset-distance: 0px; "
...
{
    MutableCSSPropertyValueSet* properties = MakeGarbageCollected<MutableCSSPropertyValueSet>(kHTMLStandardMode);
    ...
    EXPECT_EQ(MutableCSSPropertyValueSet::kUnchanged,
        properties->ParseAndSetProperty(CSSPropertyID::kColor, "red",
            ...
            /*context_style_sheet=*/nullptr));
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties->ParseAndSetProperty(CSSPropertyID::kBackgroundColor, "white",
            /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr));
...
TEST_F(CSSPropertyValueSetTest, SetCustomPropertyReturnValue)
{
    MutableCSSPropertyValueSet* properties = MakeGarbageCollected<MutableCSSPropertyValueSet>(kHTMLStandardMode);
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties->ParseAndSetCustomProperty(AtomicString("--my-property"), "red", /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr,
    ...
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties->ParseAndSetCustomProperty(AtomicString("--your-property"), "white",
            /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr,
            /*is_animation_tainted=*/false));
    EXPECT_EQ(MutableCSSPropertyValueSet::kModifiedExisting,
        properties->ParseAndSetCustomProperty(AtomicString("--my-property"), "green",
            /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr,
            /*is_animation_tainted=*/false));
    EXPECT_EQ(MutableCSSPropertyValueSet::kChangedPropertySet,
        properties->ParseAndSetCustomProperty(AtomicString("--my-property"), "", /*important=*/false, SecureContextMode::kInsecureContext,
            /*context_style_sheet=*/nullptr,
            /*is_animation_tainted=*/false));
}
