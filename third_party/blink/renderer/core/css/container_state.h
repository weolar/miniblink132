...
{
    if (overflowing == static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kNone)) {
        return overflowing;
    }
    ContainerOverflowingFlags flipped = static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kNone);
    if (overflowing & static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart)) {
        flipped |= static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kEnd);
    }
    if (overflowing & static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kEnd)) {
        flipped |= static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart);
    }
    return flipped;
}
