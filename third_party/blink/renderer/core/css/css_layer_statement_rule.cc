...
CSSLayerStatementRule::CSSLayerStatementRule(StyleRuleLayerStatement* layer_statement_rule, CSSStyleSheet* parent)
    : CSSRule(parent)
    , layer_statement_rule_(layer_statement_rule)
{
}
