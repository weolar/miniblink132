...
public:
    ...
    inline bool FastRejectSelector(const base::span<const unsigned> identifier_hashes) const;
    static void CollectIdentifierHashes(const CSSSelector&, const StyleScope*, Vector<unsigned>& bloom_hash_backing);
...
inline bool SelectorFilter::FastRejectSelector(const base::span<const unsigned> identifier_hashes) const
{
