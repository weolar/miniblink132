...
public:
    void SetOverride(const AtomicString& feature, const String& value_string, const Document*);

    std::optional<ColorSpaceGamut> GetColorGamut() const
    {
        return color_gamut_;
    }
    std::optional<mojom::blink::PreferredColorScheme> GetPreferredColorScheme() const
    {
    ...
    std::optional<ForcedColors> GetForcedColors() const
    {
        return forced_colors_;
    }

    static std::optional<mojom::blink::PreferredColorScheme> ConvertPreferredColorScheme(const MediaQueryExpValue&);
    static std::optional<mojom::blink::PreferredContrast> ConvertPreferredContrast(const MediaQueryExpValue&);
    static std::optional<bool> ConvertPrefersReducedMotion(const MediaQueryExpValue& value);
    static std::optional<bool> ConvertPrefersReducedData(const MediaQueryExpValue& value);
    static std::optional<bool> ConvertPrefersReducedTransparency(const MediaQueryExpValue& value);

    static MediaQueryExpValue ParseMediaQueryValue(const AtomicString&, const String&, const Document*);
