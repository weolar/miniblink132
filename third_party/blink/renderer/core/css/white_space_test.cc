...
class WhiteSpaceValuesTest : public testing::Test, public testing::WithParamInterface<EWhiteSpace> { };
...
INSTANTIATE_TEST_SUITE_P(WhiteSpaceTest, WhiteSpaceValuesTest, testing::ValuesIn(whitespace_values));
