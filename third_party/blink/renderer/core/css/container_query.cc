...
ContainerQuery::ContainerQuery(ContainerSelector selector, const MediaQueryExpNode* query)
...
ContainerQuery* ContainerQuery::CopyWithParent(const ContainerQuery* parent) const
{
