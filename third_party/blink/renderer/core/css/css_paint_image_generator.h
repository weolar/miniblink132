...
class CORE_EXPORT CSSPaintImageGenerator : public GarbageCollected<CSSPaintImageGenerator> {
public:
    ...
    static CSSPaintImageGenerator* Create(const String& name, const Document&, Observer*);
    virtual ~CSSPaintImageGenerator();

    typedef CSSPaintImageGenerator* (*CSSPaintImageGeneratorCreateFunction)(const String&, const Document&, Observer*);
    ...
    virtual scoped_refptr<Image> Paint(const ImageResourceObserver&, const gfx::SizeF& container_size, const CSSStyleValueVector*) = 0;
