...
class CORE_EXPORT MediaQueryList final : public EventTarget, public ActiveScriptWrappable<MediaQueryList>, public ExecutionContextLifecycleObserver {
...
public:
    ...
    bool MediaFeaturesChanged(HeapVector<Member<MediaQueryListListener>>* listeners_to_notify);
