...
public:
    ...
    bool IsAngle() const
    {
        return CSSPrimitiveValue::IsAngle(GetType());
    }
    ...
    {
        return GetType() == UnitType::kQuirkyEms;
    }
    ...
    bool IsLength() const
    {
        return CSSPrimitiveValue::IsLength(GetType());
    }
    bool IsPx() const
    {
        return GetType() == UnitType::kPixels;
    }
    bool IsNumber() const
    {
    ...
    {
        return GetType() == UnitType::kInteger;
    }
    bool IsPercentage() const
    {
        return GetType() == UnitType::kPercentage;
    }
    bool IsTime() const
    {
        return CSSPrimitiveValue::IsTime(GetType());
    }
    ...
    bool IsFlex() const
    {
        return CSSPrimitiveValue::IsFlex(GetType());
    }
...
template <> struct DowncastTraits<CSSNumericLiteralValue> {
