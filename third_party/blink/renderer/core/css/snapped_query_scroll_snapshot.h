...
class SnappedQueryScrollSnapshot : public GarbageCollected<SnappedQueryScrollSnapshot>, public ScrollSnapshotClient {
public:
    explicit SnappedQueryScrollSnapshot(PaintLayerScrollableArea& scroller);

    Element* GetSnappedTargetX() const
    {
        return snapped_target_x_;
    }
    Element* GetSnappedTargetY() const
    {
        return snapped_target_y_;
    }
