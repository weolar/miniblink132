...
public:
    ...
    virtual CSSRuleList* cssRules() const
    {
        return nullptr;
    }
    virtual MediaQuerySetOwner* GetMediaQuerySetOwner()
    {
        return nullptr;
    }
...
protected:
    ...
    {
        return has_cached_selector_text_;
    }
...
private:
    ...
    friend StyleRuleBase* ParseRuleForInsert(const ExecutionContext* execution_context, const String& rule_string, unsigned index, size_t num_child_rules,
