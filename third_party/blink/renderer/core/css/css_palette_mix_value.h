...
public:
    CSSPaletteMixValue(const CSSValue* palette1, const CSSValue* palette2, const CSSPrimitiveValue* p1, const CSSPrimitiveValue* p2,
    ...
    const CSSValue& Palette1() const
    {
        return *palette1_;
    }
    const CSSValue& Palette2() const
    {
        return *palette2_;
    }
...
template <> struct DowncastTraits<cssvalue::CSSPaletteMixValue> {
