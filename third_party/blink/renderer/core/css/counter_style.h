...
public:
    ...
    const StyleRuleCounterStyle& GetStyleRule() const
    {
        return *style_rule_;
    }

    AtomicString GetName() const;
    CounterStyleSystem GetSystem() const
    {
        return system_;
    }
    ...
    bool IsPredefinedSymbolMarker() const
    {
        return is_predefined_symbol_marker_;
    }
    void SetIsPredefinedSymbolMarker()
    {
        is_predefined_symbol_marker_ = true;
    }
    ...
    void SetHasInexistentReferences()
    {
        has_inexistent_references_ = true;
    }
    ...
    AtomicString GetExtendsName() const
    {
        return extends_name_;
    }
    const CounterStyle& GetExtendedStyle() const
    {
    ...
    AtomicString GetFallbackName() const
    {
        return fallback_name_;
    }
    const CounterStyle& GetFallbackStyle() const
    {
        return *fallback_style_;
    }
    bool HasUnresolvedFallback() const
    {
        return !fallback_style_;
    }
    void ResolveFallback(CounterStyle& fallback)
    {
        fallback_style_ = &fallback;
    }

    CounterStyleSpeakAs GetSpeakAs() const
    {
        return speak_as_;
    }
    AtomicString GetSpeakAsName() const
    {
        return speak_as_name_;
    }
