...
static void TestMediaQuery(const char* input, const char* output, MediaQuerySet& query_set, String unknown_substitute = String())
{
...
TEST(MediaQuerySetTest, Basic)
{
    ...
    MediaQuerySetTestCase test_cases[] = {
        ...
        { "(resolution: 0.83333333333333333333dppx)", "(resolution: 0.833333dppx)" },
        ...
        { "[](()), (max-width: 900px)", "not all, (max-width: 900px)" },
        { "all an[isdfs bla())()]icalc(i)(()), (max-width: 400px)", "not all, (max-width: 400px)" },
        { "all an[isdfs bla())(]icalc(i)(()), (max-width: 500px)", "not all" },
        { "all an[isdfs bla())(]icalc(i)(())), (max-width: 600px)", "not all" },
        { "all an[isdfs bla())(]icalc(i)(()))], (max-width: 800px)", "not all, (max-width: 800px)" },
        ...
        { "(foo(), (max-width: 900px)", "not all" },
        { "[](()), (max-width: 900px)", "not all, (max-width: 900px)" },
        { "all an[isdfs bla())(i())]icalc(i)(()), (max-width: 400px)", "not all, (max-width: 400px)" },
        { "all an[isdfs bla())(]icalc(i)(()), (max-width: 500px)", "not all" },
        { "all an[isdfs bla())(]icalc(i)(())), (max-width: 600px)", "not all" },
        { "all an[isdfs bla())(]icalc(i)(()))], (max-width: 800px)", "not all, (max-width: 800px)" },
        ...
        { "(device-aspect-ratio: calc(16.1)/calc(9.0))", "(device-aspect-ratio: calc(16.1) / calc(9))" },
        { "(device-aspect-ratio: calc(16.1)/9.0)", "(device-aspect-ratio: calc(16.1) / 9)" },
    };
    ...
    for (const MediaQuerySetTestCase& test : test_cases) {
        ...
        TestMediaQuery(test.input, test.output, *MediaQuerySet::Create(test.input, nullptr), "not all");
    }
}
...
TEST(MediaQuerySetTest, CSSMediaQueries4)
{
    ...
    for (const MediaQuerySetTestCase& test : test_cases) {
        SCOPED_TRACE(String(test.input));
        TestMediaQuery(test.input, test.output, *MediaQuerySet::Create(test.input, nullptr), "<unknown>");
    }
}
...
TEST(MediaQuerySetTest, GeneralEnclosed)
{
    ...
    for (const char* input : unknown_cases) {
        ...
        // "<unknown>".
        TestMediaQuery(input, "<unknown>", *MediaQuerySet::Create(input, nullptr), "<unknown>");
    }
