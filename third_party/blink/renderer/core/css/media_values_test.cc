...
TEST_F(MediaValuesTest, Basic)
{
    MediaValuesTestCase test_cases[] = {
        ...
        { 43.0, CSSPrimitiveValue::UnitType::kViewportWidth, 16, 848, 976, true, 364.64 },
        { 100.0, CSSPrimitiveValue::UnitType::kViewportWidth, 16, 821, 976, true, 821 },
        { 43.0, CSSPrimitiveValue::UnitType::kViewportHeight, 16, 848, 976, true, 419.68 },
        { 43.0, CSSPrimitiveValue::UnitType::kViewportMin, 16, 848, 976, true, 364.64 },
        { 43.0, CSSPrimitiveValue::UnitType::kViewportMax, 16, 848, 976, true, 419.68 },
        { 1.3, CSSPrimitiveValue::UnitType::kCentimeters, 16, 300, 300, true, 49.133858 },
        { 1.3, CSSPrimitiveValue::UnitType::kMillimeters, 16, 300, 300, true, 4.913386 },
        { 1.3, CSSPrimitiveValue::UnitType::kQuarterMillimeters, 16, 300, 300, true, 1.2283465 },
    ...
    for (MediaValuesTestCase test_case : test_cases) {
        ...
        data.line_height = 20;
        MediaValuesCached* media_values = MakeGarbageCollected<MediaValuesCached>(data);

        double output = 0;
        bool success = media_values->ComputeLength(test_case.value, test_case.type, output);
