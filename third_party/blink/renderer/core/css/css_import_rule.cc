...
String CSSImportRule::cssText() const
{
    ...
    if (String supports = import_rule_->GetSupportsString(); supports != g_null_atom) {
...
CSSStyleSheet* CSSImportRule::styleSheet() const
{
    ...
    if (!style_sheet_cssom_wrapper_) {
        style_sheet_cssom_wrapper_ = MakeGarbageCollected<CSSStyleSheet>(import_rule_->GetStyleSheet(), const_cast<CSSImportRule*>(this));
    }
