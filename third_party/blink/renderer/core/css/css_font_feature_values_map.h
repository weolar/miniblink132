...
class CSSFontFeatureValuesMap : public ScriptWrappable, public FeatureValuesMaplike {
    DEFINE_WRAPPERTYPEINFO();

public:
    CSSFontFeatureValuesMap(CSSFontFeatureValuesRule* parent_rule, StyleRuleFontFeatureValues* style_rule_font_feature_values, FontFeatureAliases* aliases)
    ...
    CSSFontFeatureValuesMap* set(const String& key, V8UnionUnsignedLongOrUnsignedLongSequence* value);
...
private:
    ...
    PairSyncIterable<CSSFontFeatureValuesMap>::IterationSource* CreateIterationSource(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, Vector<uint32_t>& value, ExceptionState&) override;
