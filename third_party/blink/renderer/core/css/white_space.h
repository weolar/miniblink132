...
//
inline constexpr unsigned kTextWrapModeBits = std::bit_width(static_cast<unsigned>(TextWrapMode::kMaxEnumValue));
...
{
    return whitespace == EWhiteSpace::kNormal || whitespace == EWhiteSpace::kNowrap || whitespace == EWhiteSpace::kPre || whitespace == EWhiteSpace::kPreLine
