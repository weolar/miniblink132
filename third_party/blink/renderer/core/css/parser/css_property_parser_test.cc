...
static bool IsValidPropertyValueForStyleRule(CSSPropertyID property_id, const String& value)
{
    CSSParserTokenStream stream(value);
    HeapVector<CSSPropertyValue, 64> parsed_properties;
    return CSSPropertyParser::ParseValue(property_id, /*allow_important_annotation=*/false, stream, StrictCSSParserContext(SecureContextMode::kSecureContext),
...
TEST(CSSPropertyParserTest, CSSPaint_Functions)
{
    const CSSValue* value = CSSParser::ParseSingleValue(
        CSSPropertyID::kBackgroundImage, "paint(foo, func1(1px, 3px), red)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    ASSERT_TRUE(value);
...
TEST(CSSPropertyParserTest, CSSPaint_NoArguments)
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundImage, "paint(foo)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    ASSERT_TRUE(value);
    ASSERT_TRUE(value->IsValueList());
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundImage, "paint(bar, 10px, red)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    ASSERT_TRUE(value);
    ASSERT_TRUE(value->IsValueList());
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundImage, "paint(foo bar)", StrictCSSParserContext(SecureContextMode::kSecureContext));
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateColumns, "repeat(999, 20px)", StrictCSSParserContext(SecureContextMode::kSecureContext));
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateRows, "repeat(999, 20px)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 999);
}
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateColumns, "repeat(1000000, 10%)", StrictCSSParserContext(SecureContextMode::kSecureContext));
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateRows, "repeat(1000000, 10%)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 1000000);
}
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(
        CSSPropertyID::kGridTemplateColumns, "repeat(1000000, [first] min-content [last])", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 1000000);
}
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(
        CSSPropertyID::kGridTemplateRows, "repeat(1000000, [first] min-content [last])", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 1000000);
}
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateColumns, "repeat(1000001, auto)", StrictCSSParserContext(SecureContextMode::kSecureContext));
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateRows, "repeat(1000001, auto)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 1000001);
}
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(
        CSSPropertyID::kGridTemplateColumns, "repeat(400000, 2em minmax(10px, max-content) 0.5fr)", StrictCSSParserContext(SecureContextMode::kSecureContext));
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(
        CSSPropertyID::kGridTemplateRows, "repeat(400000, 2em minmax(10px, max-content) 0.5fr)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 1200000);
}

TEST(CSSPropertyParserTest, GridTrackLimit11)
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateColumns,
        "repeat(600000, [first] 3vh 10% 2fr [nav] 10px auto 1fr 6em [last])", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 4200000);
}

TEST(CSSPropertyParserTest, GridTrackLimit12)
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateRows, "repeat(600000, [first] 3vh 10% 2fr [nav] 10px auto 1fr 6em [last])",
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(
        CSSPropertyID::kGridTemplateColumns, "repeat(100000000000000000000, 10% 1fr)", StrictCSSParserContext(SecureContextMode::kSecureContext));
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(
        CSSPropertyID::kGridTemplateRows, "repeat(100000000000000000000, 10% 1fr)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 10000000);
}
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateColumns,
        "repeat(100000000000000000000, 10% 5em 1fr auto auto 15px min-content)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 9999997);
}

TEST(CSSPropertyParserTest, GridTrackLimit16)
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridTemplateRows,
        "repeat(100000000000000000000, 10% 5em 1fr auto auto 15px min-content)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    EXPECT_EQ(ComputeNumberOfTracks(To<CSSValueList>(value)), 9999997);
}
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridColumnStart, "999", StrictCSSParserContext(SecureContextMode::kSecureContext));
    DCHECK(value);
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridColumnEnd, "1000000", StrictCSSParserContext(SecureContextMode::kSecureContext));
    DCHECK(value);
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridRowStart, "1000001", StrictCSSParserContext(SecureContextMode::kSecureContext));
    DCHECK(value);
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kGridRowEnd, "5000000000", StrictCSSParserContext(SecureContextMode::kSecureContext));
    DCHECK(value);
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundColor, "rgba(0, 0, 0, 1)", StrictCSSParserContext(SecureContextMode::kSecureContext));
    ASSERT_TRUE(value);
...
{
    const CSSValue* value
        = CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundColor, "rgba(123 45", StrictCSSParserContext(SecureContextMode::kSecureContext));
    ASSERT_FALSE(value);
}
...
TEST(CSSPropertyParserTest, ClipPathEllipse)
{
    ...
    auto* context = MakeGarbageCollected<CSSParserContext>(kHTMLStandardMode, SecureContextMode::kSecureContext, doc);

    CSSParser::ParseSingleValue(CSSPropertyID::kClipPath, "ellipse(1px 2px at invalid)", context);

    EXPECT_FALSE(doc->IsUseCounted(WebFeature::kBasicShapeEllipseTwoRadius));
    CSSParser::ParseSingleValue(CSSPropertyID::kClipPath, "ellipse(1px 2px)", context);
...
{
    test::TaskEnvironment task_environment;
    auto dummy_page_holder = std::make_unique<DummyPageHolder>(gfx::Size(800, 600));
    Document& document = dummy_page_holder->GetDocument();
    Page::InsertOrdinaryPageForTesting(&dummy_page_holder->GetPage());
    WebFeature feature = WebFeature::kCSSGradient;
    EXPECT_FALSE(document.IsUseCounted(feature));
    document.documentElement()->setInnerHTML("<style>* { background-image: linear-gradient(red, blue); }</style>");
...
TEST(CSSPropertyParserTest, PaintUseCount)
{
    ...
    dummy_page_holder->GetFrame().Loader().CommitNavigation(
        WebNavigationParams::CreateWithEmptyHTMLForTesting(KURL("https://example.com")), nullptr /* extra_data */);
    Document& document = dummy_page_holder->GetDocument();
    Page::InsertOrdinaryPageForTesting(&dummy_page_holder->GetPage());
    WebFeature feature = WebFeature::kCSSPaintFunction;
    EXPECT_FALSE(document.IsUseCounted(feature));
    document.documentElement()->setInnerHTML("<style>span { background-image: paint(geometry); }</style>");
    EXPECT_TRUE(document.IsUseCounted(feature));
}
...
TEST(CSSPropertyParserTest, CrossFadeUseCount)
{
    ...
    EXPECT_FALSE(document.IsUseCounted(feature));
    document.documentElement()->setInnerHTML("<style>div { background-image: -webkit-cross-fade(url('from.png'), "
...
TEST(CSSPropertyParserTest, TwoValueOverflowOverlayCount)
{
    ...
    document.documentElement()->setInnerHTML("<div style=\"height: 10px; width: 10px; overflow: overlay overlay;\">"
...
TEST(CSSPropertyParserTest, OneValueOverflowOverlayCount)
{
    ...
    EXPECT_FALSE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
    document.documentElement()->setInnerHTML("<div style=\"height: 10px; width: 10px; overflow: overlay;\">"
                                             "<div style=\"height: 50px; width: 50px;\"></div></div>");
    EXPECT_TRUE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
}
...
TEST(CSSPropertyParserTest, OverflowXOverlayCount)
{
    ...
    EXPECT_FALSE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
    document.documentElement()->setInnerHTML("<div style=\"height: 10px; width: 10px; overflow-x: overlay;\">"
                                             "<div style=\"height: 50px; width: 50px;\"></div></div>");
    EXPECT_TRUE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
}
...
TEST(CSSPropertyParserTest, OverflowYOverlayCount)
{
    ...
    EXPECT_FALSE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
    document.documentElement()->setInnerHTML("<div style=\"height: 10px; width: 10px; overflow-y: overlay;\">"
                                             "<div style=\"height: 50px; width: 50px;\"></div></div>");
    EXPECT_TRUE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
}
...
TEST(CSSPropertyParserTest, OverflowFirstValueOverlayCount)
{
    ...
    EXPECT_FALSE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
    document.documentElement()->setInnerHTML("<div style=\"height: 10px; width: 10px; overflow: overlay scroll;\">"
                                             "<div style=\"height: 50px; width: 50px;\"></div></div>");
    EXPECT_TRUE(document.IsUseCounted(feature));
    EXPECT_TRUE(document.IsUseCounted(feature2));
}
...
TEST(CSSPropertyParserTest, OverflowSecondValueOverlayCount)
{
    ...
    EXPECT_FALSE(document.IsUseCounted(feature));
    EXPECT_FALSE(document.IsUseCounted(feature2));
    document.documentElement()->setInnerHTML("<div style=\"height: 10px; width: 10px; overflow: scroll overlay;\">"
                                             "<div style=\"height: 50px; width: 50px;\"></div></div>");
    EXPECT_TRUE(document.IsUseCounted(feature));
    EXPECT_TRUE(document.IsUseCounted(feature2));
}
...
{
    test::TaskEnvironment task_environment;
    EXPECT_FALSE(IsValidPropertyValueForStyleRule(CSSPropertyID::kSrc, "url(blah)"));
    EXPECT_FALSE(IsValidPropertyValueForStyleRule(CSSPropertyID::kSrc, "inherit"));
    EXPECT_FALSE(IsValidPropertyValueForStyleRule(CSSPropertyID::kSrc, "var(--dummy)"));
}
...
public:
    ...
    {
        const CSSValue* value = CSSParser::ParseSingleValue(property, String(value_string), MakeGarbageCollected<CSSParserContext>(GetDocument()));
        DCHECK(value);
    }
...
TEST_F(CSSPropertyUseCounterTest, CSSPropertyBackgroundImageWebkitImageSet)
{
    ...
    EXPECT_FALSE(IsCounted(feature));
    ParseProperty(CSSPropertyID::kBackgroundImage, "-webkit-image-set(url(foo) 2x)");
    EXPECT_TRUE(IsCounted(feature));
}
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundImage, testValue, StrictCSSParserContext(SecureContextMode::kSecureContext));
...
{
    TestImageSetParsing("image-set(url(foo) calc(1 * max(INFinity * 3x, 0dpcm)))", "image-set(url(\"foo\") calc(infinity * 1dppx))");
}
...
{
    TestImageSetParsing("image-set(url(foo) calc(1dppx * max(0, min(10, NaN))))", "image-set(url(\"foo\") calc(NaN * 1dppx))");
}

TEST(CSSPropertyParserTest, ImageSetCalcClamp)
{
    TestImageSetParsing("image-set(url(foo) calc(1dppx * clamp(-Infinity, 0, infinity)))", "image-set(url(\"foo\") calc(0dppx))");
}

TEST(CSSPropertyParserTest, ImageSetCalcClampLeft)
{
    TestImageSetParsing("image-set(url(foo) calc(1dppx * clamp(0, -Infinity, infinity)))", "image-set(url(\"foo\") calc(0dppx))");
}

TEST(CSSPropertyParserTest, ImageSetCalcClampRight)
{
    TestImageSetParsing("image-set(url(foo) calc(1dppx * clamp(-Infinity, infinity, 0)))", "image-set(url(\"foo\") calc(0dppx))");
}

TEST(CSSPropertyParserTest, ImageSetCalcClampNan)
{
    TestImageSetParsing("image-set(url(foo) calc(1 * clamp(-INFINITY*0dppx, 0dppx, "
                        "infiniTY*0dppx)))",
...
{
    TestImageSetParsing("image-set(repeating-linear-gradient(red, blue 25%) 1x)", "image-set(repeating-linear-gradient(red, blue 25%) 1x)");
}
...
{
    TestImageSetParsing("image-set(repeating-radial-gradient(red, blue 25%) 1x)", "image-set(repeating-radial-gradient(red, blue 25%) 1x)");
}
...
{
    TestImageSetParsing("image-set(repeating-conic-gradient(red, blue 25%) 1x)", "image-set(repeating-conic-gradient(red, blue 25%) 1x)");
}
...
TEST(CSSPropertyParserTest, LightDarkAuthor)
{
    ...
    ASSERT_FALSE(CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundImage, "light-dark(url(light.png), url(dark.png))", context));
}

TEST(CSSPropertyParserTest, UALightDarkBackgroundImage)
{
    auto* ua_context = MakeGarbageCollected<CSSParserContext>(kUASheetMode, SecureContextMode::kInsecureContext);
    ...
    for (const auto& test : tests) {
        EXPECT_EQ(!!CSSParser::ParseSingleValue(CSSPropertyID::kBackgroundImage, test.value, ua_context), test.valid) << test.value;
    }
}
...
TEST(CSSPropertyParserTest, UAAppearanceAutoBaseSelectSerialization)
{
    ...
    const CSSPropertyValueSet* set = css_test_helpers::ParseDeclarationBlock("color:-internal-appearance-auto-base-select(red, blue)", kUASheetMode);
...
bool ParseCSSValue(CSSPropertyID property_id, const String& value, const CSSParserContext* context)
{
    CSSParserTokenStream stream(value);
    HeapVector<CSSPropertyValue, 64> parsed_properties;
    return CSSPropertyParser::ParseValue(property_id, /*allow_important_annotation=*/false, stream, context, parsed_properties, StyleRule::RuleType::kStyle);
}
...
TEST(CSSPropertyParserTest, ParseRevert)
{
    ...
    const CSSValue* value = CSSPropertyParser::ParseSingleValue(CSSPropertyID::kMarginLeft, stream, context);
    ASSERT_TRUE(value);
...
{
    const CSSValue* value = CSSParser::ParseSingleValue(propID, testValue, StrictCSSParserContext(SecureContextMode::kSecureContext));
    ASSERT_NE(value, nullptr);
...
void TestRepeatStylesParsing(const String& testValue, const String& expectedCssText)
{
    ...
    TestRepeatStyleParsing(testValue, expectedCssText, CSSPropertyID::kMaskRepeat);
}
...
void TestRepeatStyleViaShorthandParsing(const String& testValue, const String& expectedCssText, const CSSPropertyID& propID)
{
    auto* style = MakeGarbageCollected<MutableCSSPropertyValueSet>(kHTMLStandardMode);
...
void TestRepeatStyleViaShorthandsParsing(const String& testValue, const String& expectedCssText)
{
    ...
    TestRepeatStyleViaShorthandParsing(testValue, expectedCssText, CSSPropertyID::kMask);
}
...
void TestMaskPositionParsing(const String& testValue, const String& expectedCssText)
{
    auto* style = MakeGarbageCollected<MutableCSSPropertyValueSet>(kHTMLStandardMode);
    CSSParser::ParseValue(style, CSSPropertyID::kMaskPosition, testValue, false /* important */);
    ASSERT_NE(style, nullptr);
    EXPECT_TRUE(style->AsText().Contains(expectedCssText));
}
...
void TestMaskModeParsing(const String& testValue, const String& expectedCssText)
{
    const CSSValue* value = CSSParser::ParseSingleValue(CSSPropertyID::kMaskMode, testValue, StrictCSSParserContext(SecureContextMode::kSecureContext));
    ASSERT_NE(value, nullptr);
...
{
    TestMaskModeParsing("alpha, luminance, match-source", "alpha, luminance, match-source");
}

void TestMaskParsing(const String& specified_css_text, const CSSPropertyID property_id, const String& expected_prop_value)
{
    auto* style = MakeGarbageCollected<MutableCSSPropertyValueSet>(kHTMLStandardMode);
    ASSERT_NE(style, nullptr);

    auto result = style->ParseAndSetProperty(
        CSSPropertyID::kMask, specified_css_text, false /* important */, SecureContextMode::kSecureContext, nullptr /* context_style_sheet */);
...
{
    TestMaskParsing("top right, bottom left", CSSPropertyID::kMaskPosition, "right top, left bottom");
}

TEST(CSSPropertyParserTest, MaskPositionLayered2)
{
    TestMaskParsing("top right, none, bottom left", CSSPropertyID::kMaskPosition, "right top, 0% 0%, left bottom");
}
