...
FontVariantAlternatesParser::ParseResult FontVariantAlternatesParser::ConsumeAlternates(CSSParserTokenStream& stream, const CSSParserContext& context)
{
...
bool FontVariantAlternatesParser::ConsumeAlternate(CSSParserTokenStream& stream, const CSSParserContext& context)
{
    ...
    CSSFunctionValue* function_value = MakeGarbageCollected<CSSFunctionValue>(peek);
    CSSValueList* aliases;
    {
        CSSParserTokenStream::RestoringBlockGuard guard(stream);
        stream.ConsumeWhitespace();
        aliases = ConsumeCommaSeparatedList<CSSCustomIdentValue*(CSSParserTokenStream&, const CSSParserContext&)>(ConsumeCustomIdent, stream, context);
    ...
    stream.ConsumeWhitespace();
    *value_to_set = MakeGarbageCollected<cssvalue::CSSAlternateValue>(*function_value, *aliases);
    return true;
}
