...
private:
    ...
    const MediaQueryExpNode* ConsumeFeatureQuery(CSSParserTokenStream&, const FeatureSet&);
    const MediaQueryExpNode* ConsumeFeatureQueryInParens(CSSParserTokenStream&, const FeatureSet&);
    const MediaQueryExpNode* ConsumeFeatureCondition(CSSParserTokenStream&, const FeatureSet&);
