...
public:
    ...
    const Vector<String>& StringPool() const
    {
        return string_pool_;
    }
...
private:
    template <bool SkipComments> ALWAYS_INLINE CSSParserToken NextToken();
    ...
    CSSParserToken BlockStart(CSSParserTokenType block_type, CSSParserTokenType, StringView, CSSValueID id);
