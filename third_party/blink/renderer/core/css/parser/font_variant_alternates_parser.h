...
public:
    ...
    ParseResult ConsumeAlternates(CSSParserTokenStream& stream, const CSSParserContext& context);

    CSSValue* FinalizeValue();

private:
    bool ConsumeAlternate(CSSParserTokenStream& stream, const CSSParserContext& context);
