...
CSSLazyPropertyParserImpl::CSSLazyPropertyParserImpl(wtf_size_t offset, CSSLazyParsingState* state)
...
{
    return CSSParserImpl::ParseDeclarationListForLazyStyle(lazy_state_->SheetText(), offset_, lazy_state_->Context());
}
