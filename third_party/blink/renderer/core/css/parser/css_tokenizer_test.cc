...
void TestTokens(const String& string, const CSSParserToken& token1, const CSSParserToken& token2 = CSSParserToken(kEOFToken),
    const CSSParserToken& token3 = CSSParserToken(kEOFToken), bool unicode_ranges_allowed = false)
{
    CSSParserTokenStream stream(string);
    CSSParserTokenStream::EnableUnicodeRanges enable(stream, unicode_ranges_allowed);
...
void TestUnicodeRangeTokens(const String& string, const CSSParserToken& token1, const CSSParserToken& token2 = CSSParserToken(kEOFToken),
...
TEST(CSSTokenizerTest, Escapes)
{
    ...
    TEST_TOKENS(String(base::span_from_cstring("null\\\0")), Ident("null" + replacement));
    TEST_TOKENS(String(base::span_from_cstring("null\\\0\0")), Ident("null" + replacement + replacement));
...
TEST(CSSTokenizerTest, IdentToken)
{
    ...
    TEST_TOKENS(String(base::span_from_cstring("\0")), Ident(FromUChar32(0xFFFD)));
    TEST_TOKENS(String(base::span_from_cstring("ab\0c")), Ident("ab" + FromUChar32(0xFFFD) + "c"));
    TEST_TOKENS(String(base::span_from_cstring("ab\0c")), Ident("ab" + FromUChar32(0xFFFD) + "c"));
}
...
TEST(CSSTokenizerTest, StringToken)
{
    ...
    TEST_TOKENS(String(base::span_from_cstring("'\0'")), GetString(FromUChar32(0xFFFD)));
    TEST_TOKENS(String(base::span_from_cstring("'hel\0lo'")), GetString("hel" + FromUChar32(0xFFFD) + "lo"));
    TEST_TOKENS(String(base::span_from_cstring("'h\\65l\0lo'")), GetString("hel" + FromUChar32(0xFFFD) + "lo"));
}
...
TEST(CSSTokenizerTest, UnicodeRangeToken)
{
    ...
    TestUnicodeRangeTokens("u+222+111", UnicodeRng(0x222, 0x222), Number(kIntegerValueType, 111, kPlusSign));
    TestUnicodeRangeTokens("u+12345678", UnicodeRng(0x123456, 0x123456), Number(kIntegerValueType, 78, kNoSign));
    TestUnicodeRangeTokens("u+123-12345678", UnicodeRng(0x123, 0x123456), Number(kIntegerValueType, 78, kNoSign));
    TestUnicodeRangeTokens("u+cake", UnicodeRng(0xca, 0xca), Ident("ke"));
    TestUnicodeRangeTokens("u+1234-gggg", UnicodeRng(0x1234, 0x1234), Ident("-gggg"));
    TestUnicodeRangeTokens("U+ab12???", UnicodeRng(0xab1200, 0xab12ff), Delim('?'));
    TestUnicodeRangeTokens("u+a1?-123", UnicodeRng(0xa10, 0xa1f), Number(kIntegerValueType, -123, kMinusSign));
    TestUnicodeRangeTokens("u+1??4", UnicodeRng(0x100, 0x1ff), Number(kIntegerValueType, 4, kNoSign));
