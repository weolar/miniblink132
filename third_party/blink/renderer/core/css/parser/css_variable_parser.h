...
public:
    static const CSSValue* ParseDeclarationIncludingCSSWide(CSSParserTokenStream&, bool is_animation_tainted, const CSSParserContext&);
    static CSSUnparsedDeclarationValue* ParseDeclarationValue(StringView, bool is_animation_tainted, const CSSParserContext&);
    ...
    static CSSVariableData* ConsumeUnparsedDeclaration(CSSParserTokenStream& stream, bool allow_important_annotation, bool is_animation_tainted,
    ...
    static CSSUnparsedDeclarationValue* ParseUniversalSyntaxValue(StringView, const CSSParserContext&, bool is_animation_tainted);
