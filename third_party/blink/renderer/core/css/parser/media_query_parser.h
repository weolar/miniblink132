...
public:
    ...
    static MediaQuerySet* ParseMediaQuerySet(CSSParserTokenStream&, ExecutionContext*);
    static MediaQuerySet* ParseMediaCondition(CSSParserTokenStream&, ExecutionContext*);
    static MediaQuerySet* ParseMediaQuerySetInMode(CSSParserTokenStream&, CSSParserMode, ExecutionContext*);
    ...
    public:
        ...
        virtual bool IsAllowedWithoutValue(const AtomicString& feature, const ExecutionContext*) const = 0;
...
private:
    ...
    MediaQueryParser(ParserType, CSSParserMode, ExecutionContext*, SyntaxLevel = SyntaxLevel::kAuto);
    ...
    const MediaQueryExpNode* ConsumeFeature(CSSParserTokenStream&, const FeatureSet&);
    ...
    // https://drafts.csswg.org/mediaqueries-4/#typedef-media-condition
    const MediaQueryExpNode* ConsumeCondition(CSSParserTokenStream&, ConditionMode = ConditionMode::kNormal);
