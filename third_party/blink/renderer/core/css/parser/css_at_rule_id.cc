...
{
    if (RuntimeEnabledFeatures::ViewTransitionOnNavigationEnabled() && EqualIgnoringASCIICase(name, "view-transition")) {
    ...
    if (RuntimeEnabledFeatures::CSSFunctionsEnabled() && EqualIgnoringASCIICase(name, "function")) {
