...
public:
    ...
    static bool ParseValue(
        CSSPropertyID, bool allow_important_annotation, CSSParserTokenStream&, const CSSParserContext*, HeapVector<CSSPropertyValue, 64>&, StyleRule::RuleType);

    // Parses a non-shorthand CSS property
    static const CSSValue* ParseSingleValue(CSSPropertyID, CSSParserTokenStream&, const CSSParserContext*);
    ...
    static const CSSValue* ConsumeCSSWideKeyword(CSSParserTokenStream& stream, bool allow_important_annotation, bool& important);

private:
    CSSPropertyParser(CSSParserTokenStream&, const CSSParserContext*, HeapVector<CSSPropertyValue, 64>*);

    // TODO(timloh): Rename once the CSSParserValue-based parseValue is removed
    bool ParseValueStart(CSSPropertyID unresolved_property, bool allow_important_annotation, StyleRule::RuleType rule_type);
...
CSSPropertyID CORE_EXPORT UnresolvedCSSPropertyID(const ExecutionContext*, StringView, CSSParserMode mode = kHTMLStandardMode);
