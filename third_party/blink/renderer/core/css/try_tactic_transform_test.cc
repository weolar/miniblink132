...
{
    return a.inline_start == b.inline_start && a.inline_end == b.inline_end && a.block_start == b.block_start && a.block_end == b.block_end;
}
...
{
    EXPECT_EQ(TryTacticTransform(Tactics(TryTactic::kNone)), TryTacticTransform(Tactics(TryTactic::kNone)));
    EXPECT_EQ(TryTacticTransform(Tactics(TryTactic::kFlipBlock)), TryTacticTransform(Tactics(TryTactic::kFlipBlock)));
    EXPECT_NE(TryTacticTransform(Tactics(TryTactic::kFlipInline)), TryTacticTransform(Tactics(TryTactic::kFlipBlock)));
    EXPECT_NE(TryTacticTransform(Tactics(TryTactic::kFlipBlock)), TryTacticTransform(Tactics(TryTactic::kFlipInline)));
}
...
{
    TryTacticTransform expected = TryTacticTransform(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipInline));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipInline, TryTactic::kFlipBlock)));
}

// (4)
TEST_F(TryTacticTransformTest, StartEquality)
{
    TryTacticTransform expected = TryTacticTransform(Tactics(TryTactic::kFlipStart));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipStart, TryTactic::kFlipInline)));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipInline, TryTactic::kFlipStart, TryTactic::kFlipBlock)));
}

// (5)
TEST_F(TryTacticTransformTest, BlockStartEquality)
{
    TryTacticTransform expected = TryTacticTransform(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipStart));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipStart, TryTactic::kFlipInline)));
}

// (6)
TEST_F(TryTacticTransformTest, InlineStartEquality)
{
    TryTacticTransform expected = TryTacticTransform(Tactics(TryTactic::kFlipInline, TryTactic::kFlipStart));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipStart, TryTactic::kFlipBlock)));
}

// (7)
TEST_F(TryTacticTransformTest, BlockInlineStartEquality)
{
    TryTacticTransform expected = TryTacticTransform(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipInline, TryTactic::kFlipStart));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipStart, TryTactic::kFlipBlock, TryTactic::kFlipInline)));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipStart, TryTactic::kFlipBlock, TryTactic::kFlipInline)));
    EXPECT_EQ(expected, TryTacticTransform(Tactics(TryTactic::kFlipStart, TryTactic::kFlipInline, TryTactic::kFlipBlock)));
}
...
TEST_F(TryTacticTransformTest, Transform_Block_Inline)
{
    EXPECT_EQ((LogicalSides {
        ...
        TransformLogicalSides(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipInline)));
}
...
TEST_F(TryTacticTransformTest, Transform_Block_Start)
{
    EXPECT_EQ((LogicalSides {
        ...
        TransformLogicalSides(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipStart)));
}
...
TEST_F(TryTacticTransformTest, Transform_Inline_Start)
{
    EXPECT_EQ((LogicalSides {
        ...
        TransformLogicalSides(Tactics(TryTactic::kFlipInline, TryTactic::kFlipStart)));
}
...
TEST_F(TryTacticTransformTest, Transform_Block_Inline_Start)
{
    EXPECT_EQ((LogicalSides {
        ...
        TransformLogicalSides(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipInline, TryTactic::kFlipStart)));
}
...
TEST_F(TryTacticTransformTest, Inverse_None)
{
    ...
    EXPECT_EQ(InitialLogicalSides(), transform.Inverse().Transform(transform.Transform(InitialLogicalSides())));
}
...
{
    TryTacticTransform transform(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipInline));
    EXPECT_EQ(InitialLogicalSides(), transform.Inverse().Transform(transform.Transform(InitialLogicalSides())));
}
...
{
    TryTacticTransform transform(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipStart));
    EXPECT_EQ(InitialLogicalSides(), transform.Inverse().Transform(transform.Transform(InitialLogicalSides())));
}
...
{
    TryTacticTransform transform(Tactics(TryTactic::kFlipInline, TryTactic::kFlipStart));
    EXPECT_EQ(InitialLogicalSides(), transform.Inverse().Transform(transform.Transform(InitialLogicalSides())));
}
...
{
    TryTacticTransform transform(Tactics(TryTactic::kFlipBlock, TryTactic::kFlipInline, TryTactic::kFlipStart));
    EXPECT_EQ(InitialLogicalSides(), transform.Inverse().Transform(transform.Transform(InitialLogicalSides())));
}
