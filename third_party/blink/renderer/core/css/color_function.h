...
public:
    ...
    static constexpr double kPercentNotApplicable = std::numeric_limits<double>::quiet_NaN();

    static constexpr auto kMetadataMap = base::MakeFixedFlatMap<MetadataEntry, Metadata>({
        // rgb(); percentage mapping: r,g,b=255
        { MetadataEntry::kLegacyRgb, { { CSSValueID::kR, CSSValueID::kG, CSSValueID::kB }, { 255, 255, 255 } } },

        // color(... <predefined-rgb-params> ...); percentage mapping: r,g,b=1
        { MetadataEntry::kColorRgb, { { CSSValueID::kR, CSSValueID::kG, CSSValueID::kB }, { 1, 1, 1 } } },

        // color(... <xyz-params> ...); percentage mapping: x,y,z=1
        { MetadataEntry::kColorXyz, { { CSSValueID::kX, CSSValueID::kY, CSSValueID::kZ }, { 1, 1, 1 } } },

        // lab(); percentage mapping: l=100 a,b=125
        { MetadataEntry::kLab, { { CSSValueID::kL, CSSValueID::kA, CSSValueID::kB }, { 100, 125, 125 } } },

        // oklab(); percentage mapping: l=1 a,b=0.4
        { MetadataEntry::kOkLab, { { CSSValueID::kL, CSSValueID::kA, CSSValueID::kB }, { 1, 0.4, 0.4 } } },

        // lch(); percentage mapping: l=100 c=150 h=n/a
        { MetadataEntry::kLch, { { CSSValueID::kL, CSSValueID::kC, CSSValueID::kH }, { 100, 150, kPercentNotApplicable } } },

        // oklch(); percentage mapping: l=1 c=0.4 h=n/a
        { MetadataEntry::kOkLch, { { CSSValueID::kL, CSSValueID::kC, CSSValueID::kH }, { 1, 0.4, kPercentNotApplicable } } },

        // hsl(); percentage mapping: h=n/a s,l=100
        { MetadataEntry::kHsl, { { CSSValueID::kH, CSSValueID::kS, CSSValueID::kL }, { kPercentNotApplicable, 100, 100 } } },

        // hwb(); percentage mapping: h=n/a w,b=100
        { MetadataEntry::kHwb, { { CSSValueID::kH, CSSValueID::kW, CSSValueID::kB }, { kPercentNotApplicable, 100, 100 } } },
    });

    static constexpr auto kColorSpaceMap = base::MakeFixedFlatMap<Color::ColorSpace, MetadataEntry>({
