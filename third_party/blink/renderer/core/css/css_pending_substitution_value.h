...
public:
    CSSPendingSubstitutionValue(CSSPropertyID shorthand_property_id, CSSUnparsedDeclarationValue* shorthand_value)
...
template <> struct DowncastTraits<cssvalue::CSSPendingSubstitutionValue> {
