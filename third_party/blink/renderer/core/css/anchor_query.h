...
public:
    AnchorQuery(
        CSSAnchorQueryType query_type, const AnchorSpecifierValue* anchor_specifier, float percentage, absl::variant<CSSAnchorValue, CSSAnchorSizeValue> value)
