...
public:
    CSSAlternateValue(const CSSFunctionValue& function, const CSSValueList& alias_list);

    const CSSFunctionValue& Function() const
    {
        return *function_;
    }
    const CSSValueList& Aliases() const
    {
        return *aliases_;
    }
...
template <> struct DowncastTraits<cssvalue::CSSAlternateValue> {
