...
public:
    StyleRuleImport(const String& href, LayerName&& layer, bool supported, String supports, const MediaQuerySet*, OriginClean origin_clean);
    ~StyleRuleImport();
    ...
    StyleSheetContents* GetStyleSheet() const
    {
    ...
    const LayerName& GetLayerName() const
    {
        return layer_;
    }
    ...
    String GetSupportsString() const
    {
        return supports_string_;
    }
...
private:
    ...
    class ImportedStyleSheetClient final : public GarbageCollected<ImportedStyleSheetClient>, public ResourceClient {
    public:
        ...
        {
            return "ImportedStyleSheetClient";
        }
...
template <> struct DowncastTraits<StyleRuleImport> {
