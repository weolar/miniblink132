...
public:
    CSSNestedDeclarationsRule(StyleRuleNestedDeclarations*, CSSStyleSheet* parent);
...
private:
    ...
    {
        return kNestedDeclarationsRule;
    }
...
template <> struct DowncastTraits<CSSNestedDeclarationsRule> {
