...
public:
    ...
    unsigned insertRule(const ExecutionContext* execution_context, const String& rule, unsigned index, ExceptionState&);
...
template <> struct DowncastTraits<CSSStyleRule> {
