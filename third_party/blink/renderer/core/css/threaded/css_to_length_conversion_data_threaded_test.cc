...
TSAN_TEST(CSSToLengthConversionDataThreadedTest, ConversionEm)
{
    RunOnThreads([]() {
        ...
        CSSPrimitiveValue& value = *CSSNumericLiteralValue::Create(3.14, CSSPrimitiveValue::UnitType::kEms);
...
TSAN_TEST(CSSToLengthConversionDataThreadedTest, ConversionPixel)
{
    RunOnThreads([]() {
        ...
        CSSPrimitiveValue& value = *CSSNumericLiteralValue::Create(44, CSSPrimitiveValue::UnitType::kPixels);
...
TSAN_TEST(CSSToLengthConversionDataThreadedTest, ConversionViewport)
{
    RunOnThreads([]() {
        ...
        CSSPrimitiveValue& value = *CSSNumericLiteralValue::Create(1, CSSPrimitiveValue::UnitType::kViewportWidth);
...
TSAN_TEST(CSSToLengthConversionDataThreadedTest, ConversionRem)
{
    RunOnThreads([]() {
        ...
        CSSPrimitiveValue& value = *CSSNumericLiteralValue::Create(1, CSSPrimitiveValue::UnitType::kRems);
