...
TSAN_TEST(TextRendererThreadedTest, MeasureText)
{
    RunOnThreads([]() {
        ...
        gfx::RectF text_bounds = font.SelectionRectForText(text_run, gfx::PointF(), font.GetFontDescription().ComputedSize(), 0, -1);
...
TSAN_TEST(TextRendererThreadedTest, DrawText)
{
    ...
    RunOnThreads([]() {
        ...
        font.DrawBidiText(&mpc, text_run_paint_info, location, Font::kUseFallbackIfFontNotReady, flags, Font::DrawType::kGlyphsAndClusters);
    });
}
