...
TSAN_TEST(FontObjectThreadedTest, GetDefaultFontData)
{
    ...
    RunOnThreads([]() {
        for (FontDescription::GenericFamilyType family_type :
            { FontDescription::kStandardFamily, FontDescription::kWebkitBodyFamily, FontDescription::kSerifFamily, FontDescription::kSansSerifFamily,
                FontDescription::kMonospaceFamily, FontDescription::kCursiveFamily, FontDescription::kFantasyFamily }) {
...
{
    RunOnThreads([]() { Font font = CreateTestFont(AtomicString("Ahem"), test::CoreTestDataPath("Ahem.ttf"), 16); });
}
...
TSAN_TEST(FontObjectThreadedTest, TextIntercepts)
{
    ...
    RunOnThreads([]() {
        Font font = CreateTestFont(AtomicString("Ahem"), test::CoreTestDataPath("Ahem.ttf"), 16);
