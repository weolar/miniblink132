...
class ContainerQueryData final : public GarbageCollected<ContainerQueryData>, public ElementRareDataField {
public:
    ...
    bool SkippedStyleRecalc() const
    {
        return child_change_.has_value();
    }
