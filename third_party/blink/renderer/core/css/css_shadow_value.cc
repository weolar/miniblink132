...
CSSShadowValue::CSSShadowValue(
    CSSPrimitiveValue* x, CSSPrimitiveValue* y, CSSPrimitiveValue* blur, CSSPrimitiveValue* spread, CSSIdentifierValue* style, const CSSValue* color)
...
{
    return base::ValuesEquivalent(color, other.color) && base::ValuesEquivalent(x, other.x) && base::ValuesEquivalent(y, other.y)
        && base::ValuesEquivalent(blur, other.blur) && base::ValuesEquivalent(spread, other.spread) && base::ValuesEquivalent(style, other.style);
}
