...
public:
    ...
    static std::optional<CSSPropertyName> From(const ExecutionContext* execution_context, const String& value)
    {
...
private:
    ...
    explicit CSSPropertyName(int value)
        : value_(value)
    {
...
template <> struct HashTraits<blink::CSSPropertyName> : SimpleClassHashTraits<blink::CSSPropertyName> {
    ...
    {
        new (NotNullTag::kNotNull, &slot) CSSPropertyName(CSSPropertyName::kDeletedValue);
    }
