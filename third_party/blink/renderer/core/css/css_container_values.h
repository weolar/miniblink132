...
public:
    explicit CSSContainerValues(Document& document, Element& container, std::optional<double> width, std::optional<double> height,
    ...
    // supported.
    std::optional<double> Width() const override
    {
        return width_;
    }
    std::optional<double> Height() const override
    {
        return height_;
    }
...
protected:
    ...
    Element* ContainerElement() const override
    {
        return element_.Get();
    }
    ...
    ContainerSnappedFlags SnappedFlags() const override
    {
        return snapped_;
    }
