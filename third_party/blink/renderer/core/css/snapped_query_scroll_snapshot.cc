...
SnappedQueryScrollSnapshot::SnappedQueryScrollSnapshot(PaintLayerScrollableArea& scroller)
...
bool SnappedQueryScrollSnapshot::UpdateSnappedTargets()
{
    ...
    Element* snapped_target_x = scroller_->GetSnappedQueryTargetAlongAxis(cc::SnapAxis::kX);
    Element* snapped_target_y = scroller_->GetSnappedQueryTargetAlongAxis(cc::SnapAxis::kY);
