...
private:
    template <size_t size> class Group {
    public:
...
public:
    ...
    template <size_t size> class LogicalMapping : public Group<size> {
    ...
    // [1]: https://drafts.csswg.org/css-logical/#logical-property-group
    // [2]: https://drafts.csswg.org/css-logical/#mapping-logic
    template <size_t size> class PhysicalMapping : public Group<size> {
        using Group<size>::Group;
    };
