...
{
    return (border_image_length_box.Left() == border_image_length && border_image_length_box.Right() == border_image_length
        && border_image_length_box.Top() == border_image_length && border_image_length_box.Bottom() == border_image_length);
}
inline bool LengthMatchesAllSides(const LengthBox& length_box, const Length& length)
{
    return (length_box.Left() == length && length_box.Right() == length && length_box.Top() == length && length_box.Bottom() == length);
}
