...
template <size_t size> using LogicalMapping = CSSDirectionAwareResolver::LogicalMapping<size>;
template <size_t size> using PhysicalMapping = CSSDirectionAwareResolver::PhysicalMapping<size>;
...
constexpr uint8_t kStartStartMap[kWritingModeSize] = { kTopLeftCorner, kTopRightCorner, kTopLeftCorner, kTopRightCorner, kBottomLeftCorner };
constexpr uint8_t kStartEndMap[kWritingModeSize] = { kTopRightCorner, kBottomRightCorner, kBottomLeftCorner, kBottomRightCorner, kTopLeftCorner };
constexpr uint8_t kEndStartMap[kWritingModeSize] = { kBottomLeftCorner, kTopLeftCorner, kTopRightCorner, kTopLeftCorner, kBottomRightCorner };
constexpr uint8_t kEndEndMap[kWritingModeSize] = { kBottomRightCorner, kBottomLeftCorner, kBottomRightCorner, kBottomLeftCorner, kTopRightCorner };
...
template <size_t size>
CSSDirectionAwareResolver::Group<size>::Group(const CSSProperty* (&properties)[size])
    : properties_(properties)
{
}

template <size_t size> const CSSProperty& CSSDirectionAwareResolver::Group<size>::GetProperty(size_t index) const
{
    DCHECK_LT(index, size);
    return *properties_[index];
}

template <size_t size> bool CSSDirectionAwareResolver::Group<size>::Contains(CSSPropertyID id) const
{
...
LogicalMapping<4> CSSDirectionAwareResolver::LogicalBorderMapping()
{
    static const CSSProperty* kProperties[]
        = { &GetCSSPropertyBorderBlockStart(), &GetCSSPropertyBorderBlockEnd(), &GetCSSPropertyBorderInlineStart(), &GetCSSPropertyBorderInlineEnd() };
...
{
    static const CSSProperty* kProperties[]
        = { &GetCSSPropertyBorderTop(), &GetCSSPropertyBorderRight(), &GetCSSPropertyBorderBottom(), &GetCSSPropertyBorderLeft() };
    return PhysicalMapping<4>(kProperties);
}

LogicalMapping<4> CSSDirectionAwareResolver::LogicalBorderColorMapping()
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyBorderBlockStartColor(), &GetCSSPropertyBorderBlockEndColor(),
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyBorderBlockStartStyle(), &GetCSSPropertyBorderBlockEndStyle(),
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyBorderBlockStartWidth(), &GetCSSPropertyBorderBlockEndWidth(),
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyContainIntrinsicWidth(), &GetCSSPropertyContainIntrinsicHeight() };
    return PhysicalMapping<2>(kProperties);
}

LogicalMapping<4> CSSDirectionAwareResolver::LogicalBorderRadiusMapping()
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyBorderStartStartRadius(), &GetCSSPropertyBorderStartEndRadius(),
...
{
    static const CSSProperty* kProperties[]
        = { &GetCSSPropertyInsetBlockStart(), &GetCSSPropertyInsetBlockEnd(), &GetCSSPropertyInsetInlineStart(), &GetCSSPropertyInsetInlineEnd() };
    return LogicalMapping<4>(kProperties);
}
...
{
    static const CSSProperty* kProperties[]
        = { &GetCSSPropertyMarginBlockStart(), &GetCSSPropertyMarginBlockEnd(), &GetCSSPropertyMarginInlineStart(), &GetCSSPropertyMarginInlineEnd() };
    return LogicalMapping<4>(kProperties);
}
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyOverscrollBehaviorBlock(), &GetCSSPropertyOverscrollBehaviorInline() };
    return LogicalMapping<2>(kProperties);
}
...
{
    static const CSSProperty* kProperties[]
        = { &GetCSSPropertyPaddingBlockStart(), &GetCSSPropertyPaddingBlockEnd(), &GetCSSPropertyPaddingInlineStart(), &GetCSSPropertyPaddingInlineEnd() };
    return LogicalMapping<4>(kProperties);
}
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyScrollMarginBlockStart(), &GetCSSPropertyScrollMarginBlockEnd(),
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyScrollPaddingBlockStart(), &GetCSSPropertyScrollPaddingBlockEnd(),
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyInternalVisitedBorderBlockStartColor(), &GetCSSPropertyInternalVisitedBorderBlockEndColor(),
...
{
    static const CSSProperty* kProperties[] = { &GetCSSPropertyInternalVisitedBorderTopColor(), &GetCSSPropertyInternalVisitedBorderRightColor(),
        &GetCSSPropertyInternalVisitedBorderBottomColor(), &GetCSSPropertyInternalVisitedBorderLeftColor() };
    return PhysicalMapping<4>(kProperties);
}

const CSSProperty& CSSDirectionAwareResolver::ResolveInlineStart(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
    return group.GetProperty(static_cast<size_t>(writing_direction.InlineStart()));
}

const CSSProperty& CSSDirectionAwareResolver::ResolveInlineEnd(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
    return group.GetProperty(static_cast<size_t>(writing_direction.InlineEnd()));
}

const CSSProperty& CSSDirectionAwareResolver::ResolveBlockStart(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
    return group.GetProperty(static_cast<size_t>(writing_direction.BlockStart()));
}

const CSSProperty& CSSDirectionAwareResolver::ResolveBlockEnd(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
    return group.GetProperty(static_cast<size_t>(writing_direction.BlockEnd()));
}

const CSSProperty& CSSDirectionAwareResolver::ResolveInline(WritingDirectionMode writing_direction, const PhysicalMapping<2>& group)
{
...
const CSSProperty& CSSDirectionAwareResolver::ResolveBlock(WritingDirectionMode writing_direction, const PhysicalMapping<2>& group)
{
    if (writing_direction.IsHorizontal()) {
        return group.GetProperty(kPhysicalAxisY);
    }
...
const CSSProperty& CSSDirectionAwareResolver::ResolveStartStart(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
...
const CSSProperty& CSSDirectionAwareResolver::ResolveStartEnd(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
    WritingMode writing_mode = writing_direction.GetWritingMode();
    if (writing_direction.IsLtr()) {
        return group.GetProperty(kStartEndMap[static_cast<int>(writing_mode)]);
...
const CSSProperty& CSSDirectionAwareResolver::ResolveEndStart(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
    WritingMode writing_mode = writing_direction.GetWritingMode();
    if (writing_direction.IsLtr()) {
...
const CSSProperty& CSSDirectionAwareResolver::ResolveEndEnd(WritingDirectionMode writing_direction, const PhysicalMapping<4>& group)
{
    WritingMode writing_mode = writing_direction.GetWritingMode();
    if (writing_direction.IsLtr()) {
        return group.GetProperty(kEndEndMap[static_cast<int>(writing_mode)]);
