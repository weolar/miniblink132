...
template <size_t kBits> std::bitset<kBits> ToStdBitsetUsingHas(const CSSBitsetBase<kBits>& bitset)
{
...
template <size_t kBits> std::bitset<kBits> ToStdBitsetUsingIterator(const CSSBitsetBase<kBits>& bitset)
{
    std::bitset<kBits> ret;
...
template <size_t kBits> void AssertBitset(const size_t* begin, const size_t* end)
{
...
template <size_t kBits> void AssertBitset(std::initializer_list<size_t> bits)
{
