...
public:
    ...
    virtual bool ParseShorthand(
        bool important, CSSParserTokenStream&, const CSSParserContext&, const CSSParserLocalContext&, HeapVector<CSSPropertyValue, 64>& properties) const
    {
        NOTREACHED();
    }
...
template <> struct DowncastTraits<Shorthand> {
