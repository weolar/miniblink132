...
// std::basic_ostream<char, std::char_traits<char>>& operator<<(std::basic_ostream<char, std::char_traits<char>>& a, EAlignmentBaseline b)
// {
//     *(int*)1 = 1;
//     return a << (int)b;
// }

#define MAKE_EMPTY_OPERATOR1(name) \
std::ostream& operator<<(std::ostream& a, name b) \
{ \
    *(int*)1 = 1; \
    return a << (int)(b); \
}

#define MAKE_EVERY_EMPTY_OPERATOR1(func) \
    func(::blink::mojom::BackgroundFetchError) \
    func(::blink::mojom::ClipboardBuffer) \
    func(::blink::mojom::FormControlType) \
    func(::blink::mojom::PermissionName) \
    func(::blink::mojom::ScreenAvailability) \
    func(::blink::mojom::WebDXFeature) \
    func(EAlignmentBaseline) \
    func(EBaselineSource) \
    func(EBorderStyle) \
    func(EBoxAlignment) \
    func(EBoxDirection) \
    func(EBoxOrient) \
    ...
    func(EBreakBetween) \
    func(EBreakInside) \
    func(EBufferedRendering) \
    func(ECaptionSide) \
    func(ECaretAnimation) \
    func(EClear) \
    func(EColorInterpolation) \
    func(EColorRendering) \
    func(EColumnFill) \
    func(EContentVisibility) \
    func(ECursor) \
    func(EDisplay) \
    func(EDominantBaseline) \
    func(EEmptyCells) \
    func(EFieldSizing) \
    func(EFlexDirection) \
    func(EFlexWrap) \
    func(EFloat) \
    func(EForcedColorAdjust) \
    func(EImageRendering) \
    func(EInteractivity) \
    func(EInterpolateSize) \
    func(EIsolation) \
    func(EListStylePosition) \
    func(EMaskType) \
    func(EMathShift) \
    func(EMathStyle) \
    func(EObjectFit) \
    func(EOrder) \
    func(EOriginTrialTestProperty) \
    func(EOverflow) \
    func(EOverflowAnchor) \
    func(EOverflowWrap) \
    func(EOverlay) \
    func(EOverscrollBehavior) \
    func(EPointerEvents) \
    func(EPosition) \
    func(EPositionTryOrder) \
    func(EPrintColorAdjust) \
    func(EReadingFlow) \
    func(EResize) \
    func(ERubyAlign) \
    func(EScrollbarWidth) \
    func(EScrollMarkerGroup) \
    func(EScrollSnapStop) \
    func(EShapeRendering) \
    func(ESpeak) \
    func(ETextAlign) \
    func(ETextAlignLast) \
    func(ETextAnchor) \
    ...
    func(ETextBoxTrim) \
    func(ETextCombine) \
    func(ETextOrientation) \
    func(ETextSecurity) \
    func(ETextTransform) \
    func(ETransformBox) \
    func(ETransformStyle3D) \
    func(EUserDrag) \
    func(EUserModify) \
    func(EUserSelect) \
    func(EVectorEffect) \
...
MAKE_EVERY_EMPTY_OPERATOR1(MAKE_EMPTY_OPERATOR1)
...
CSSCustomIdentValue* ConsumeCustomIdentExcludingNone(CSSParserTokenStream& stream, const CSSParserContext& context)
{
...
const CSSValue* AlignContent::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeContentDistributionOverflowPosition(stream, css_parsing_utils::IsContentPositionKeyword);
}

const CSSValue* AlignContent::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForContentPositionAndDistributionWithOverflowAlignment(style.AlignContent());
}

const CSSValue* AlignItems::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* AlignItems::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForItemPositionWithOverflowAlignment(style.AlignItems());
}

const CSSValue* AlignSelf::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSelfPositionOverflowPosition(stream, css_parsing_utils::IsSelfPositionKeyword);
}
...
const CSSValue* AlignSelf::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForItemPositionWithOverflowAlignment(style.AlignSelf());
}
...
const CSSValue* PositionAnchor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (CSSValue* value = css_parsing_utils::ConsumeIdent<CSSValueID::kAuto>(stream)) {
        return value;
    }
...
void PositionAnchor::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.SetPositionAnchor(StyleBuilderConverter::ConvertPositionAnchor(state, value));
}
...
const CSSValue* PositionVisibility::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAlways) {
        return css_parsing_utils::ConsumeIdent(stream);
    }

    CSSIdentifierValue* anchors_visible = css_parsing_utils::ConsumeIdent<CSSValueID::kAnchorsVisible>(stream);
    CSSIdentifierValue* no_overflow = css_parsing_utils::ConsumeIdent<CSSValueID::kNoOverflow>(stream);
    if (!anchors_visible) {
        anchors_visible = css_parsing_utils::ConsumeIdent<CSSValueID::kAnchorsVisible>(stream);
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    if (EnumHasFlags(position_visibility, blink::PositionVisibility::kAnchorsVisible)) {
        list->Append(*CSSIdentifierValue::Create(CSSValueID::kAnchorsVisible));
    }
    if (EnumHasFlags(position_visibility, blink::PositionVisibility::kNoOverflow)) {
...
const CSSValue* AnchorName::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (CSSValue* value = css_parsing_utils::ConsumeIdent<CSSValueID::kNone>(stream)) {
        return value;
    }
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeDashedIdent, stream, context);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    for (const Member<const ScopedCSSName>& name : style.AnchorName()->GetNames()) {
        list->Append(*MakeGarbageCollected<CSSCustomIdentValue>(*name));
    }
    return list;
}

const CSSValue* AnchorScope::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (CSSValue* value = css_parsing_utils::ConsumeIdent<CSSValueID::kNone>(stream)) {
        return value;
    }
    if (CSSValue* value = css_parsing_utils::ConsumeScopedKeywordValue<CSSValueID::kAll>(stream)) {
        return value;
    }
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeDashedIdent, stream, context);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateCommaSeparated();
    for (const Member<const ScopedCSSName>& name : anchor_scope.Names()->GetNames()) {
        list->Append(*MakeGarbageCollected<CSSCustomIdentValue>(*name));
    }
    return list;
}

const CSSValue* AnimationComposition::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList<CSSIdentifierValue*(CSSParserTokenStream&)>(
...
const CSSValue* AnimationDelay::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(
        static_cast<CSSPrimitiveValue* (*)(CSSParserTokenStream&, const CSSParserContext&, CSSPrimitiveValue::ValueRange)>(css_parsing_utils::ConsumeTime),
...
{
    DEFINE_STATIC_LOCAL(const Persistent<CSSValue>, value, (ComputedStyleUtils::ValueForAnimationDelay(CSSTimingData::InitialDelayStart())));
    return value;
}

const CSSValue* AnimationDirection::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList<CSSIdentifierValue*(CSSParserTokenStream&)>(
        css_parsing_utils::ConsumeIdent<CSSValueID::kNormal, CSSValueID::kAlternate, CSSValueID::kReverse, CSSValueID::kAlternateReverse>, stream);
}
...
const CSSValue* AnimationDuration::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* AnimationDuration::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForAnimationDurationList(style.Animations(), value_phase);
}

const CSSValue* AnimationDuration::InitialValue() const
{
    return ComputedStyleUtils::ValueForAnimationDuration(CSSAnimationData::InitialDuration(), /* resolve_auto_to_zero */ false);
}

const CSSValue* AnimationFillMode::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList<CSSIdentifierValue*(CSSParserTokenStream&)>(
        css_parsing_utils::ConsumeIdent<CSSValueID::kNone, CSSValueID::kForwards, CSSValueID::kBackwards, CSSValueID::kBoth>, stream);
}
...
const CSSValue* AnimationIterationCount::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeAnimationIterationCount, stream, context);
}

const CSSValue* AnimationIterationCount::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForAnimationIterationCountList(style.Animations());
}

const CSSValue* AnimationIterationCount::InitialValue() const
{
    DEFINE_STATIC_LOCAL(
        const Persistent<CSSValue>, value, (CSSNumericLiteralValue::Create(CSSAnimationData::InitialIterationCount(), CSSPrimitiveValue::UnitType::kNumber)));
    return value;
}

const CSSValue* AnimationName::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    // Allow quoted name if this is an alias property.
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeAnimationName, stream, context, local_context.UseAliasParsing());
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (animation_data) {
        for (wtf_size_t i = 0; i < animation_data->NameList().size(); ++i) {
            list->Append(*MakeGarbageCollected<CSSCustomIdentValue>(animation_data->NameList()[i]));
        }
    } else {
...
const CSSValue* AnimationPlayState::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList<CSSIdentifierValue*(CSSParserTokenStream&)>(
...
const CSSValue* AnimationRangeStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* AnimationRangeStart::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForAnimationRangeStartList(style.Animations(), style);
}
...
const CSSValue* AnimationRangeEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    DCHECK(RuntimeEnabledFeatures::ScrollTimelineEnabled());
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeAnimationRange, stream, context,
...
const CSSValue* AnimationRangeEnd::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForAnimationRangeEndList(style.Animations(), style);
}
...
const CSSValue* AnimationTimeline::ParseSingleValue(
    CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
...
const CSSValue* AnimationTimingFunction::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeAnimationTimingFunction, stream, context);
}

const CSSValue* AnimationTimingFunction::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForAnimationTimingFunctionList(style.Animations());
}
...
const CSSValue* AspectRatio::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* AspectRatio::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    auto* ratio_value
        = MakeGarbageCollected<cssvalue::CSSRatioValue>(*CSSNumericLiteralValue::Create(ratio.GetRatio().width(), CSSPrimitiveValue::UnitType::kNumber),
            *CSSNumericLiteralValue::Create(ratio.GetRatio().height(), CSSPrimitiveValue::UnitType::kNumber));
...
const CSSValue* BackdropFilter::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
{
    state.StyleBuilder().SetBackdropFilter(StyleBuilderConverter::ConvertFilterOperations(state, value, PropertyID()));
}

const CSSValue* BackfaceVisibility::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create((style.BackfaceVisibility() == EBackfaceVisibility::kHidden) ? CSSValueID::kHidden : CSSValueID::kVisible);
}

const CSSValue* BackgroundAttachment::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
...
const CSSValue* BackgroundBlendMode::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
...
const CSSValue* BackgroundClip::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext& local_context) const
{
    if (RuntimeEnabledFeatures::CSSBackgroundClipUnprefixEnabled()) {
        ...
        return css_parsing_utils::ParseBackgroundBox(stream, local_context, css_parsing_utils::AllowTextValue::kAllow);
    }
}
...
void BackgroundClip::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
...
const CSSValue* BackgroundColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColorMaybeQuirky(stream, context);
}

const blink::Color BackgroundColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    const StyleColor& background_color = style.BackgroundColor();
    if (!style.InForcedColorsMode() && !background_color.HasColorKeyword() && !background_color.IsUnresolvedColorFunction()) {
        // Fast path.
        if (is_current_color) {
        ...
        if (style.ShouldForceColor(background_color)) {
            return GetCSSPropertyInternalForcedBackgroundColor().ColorIncludingFallback(false, style, is_current_color);
        }
        return background_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
    }
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    const StyleColor& background_color = style.BackgroundColor();
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(background_color)) {
        return GetCSSPropertyInternalForcedBackgroundColor().CSSValueFromComputedStyle(style, nullptr, allow_visited_style, value_phase);
    }
    return ComputedStyleUtils::CurrentColorOrValidColor(style, background_color, value_phase);
}

const CSSValue* BackgroundImage::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::BackgroundImageOrMaskImage(style, allow_visited_style, fill_layer, value_phase);
}

const CSSValue* BackgroundOrigin::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext& local_context) const
{
...
const CSSValue* BackgroundPositionX::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumePositionLonghand<CSSValueID::kLeft, CSSValueID::kRight>, stream, context);
}
...
{
    const FillLayer* curr_layer = &style.BackgroundLayers();
    return ComputedStyleUtils::BackgroundPositionXOrWebkitMaskPositionX(style, curr_layer);
}

const CSSValue* BackgroundPositionY::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumePositionLonghand<CSSValueID::kTop, CSSValueID::kBottom>, stream, context);
}
...
{
    const FillLayer* curr_layer = &style.BackgroundLayers();
    return ComputedStyleUtils::BackgroundPositionYOrWebkitMaskPositionY(style, curr_layer);
}

const CSSValue* BackgroundSize::ParseSingleValue(
    CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    return css_parsing_utils::ParseBackgroundSize(stream, context, local_context, WebFeature::kNegativeBackgroundSize);
}
...
const CSSValue* BaselineShift::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    case EBaselineShiftType::kLength:
        return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.BaselineShift(), style);
    }
    NOTREACHED();
}
...
void BaselineShift::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    if (auto* identifier_value = DynamicTo<CSSIdentifierValue>(value)) {
        ...
        builder.SetBaselineShift(StyleBuilderConverter::ConvertLength(state, To<CSSPrimitiveValue>(value)));
    }
}

const CSSValue* BlockSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context);
}

bool BlockSize::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && (layout_object->IsBox() || layout_object->IsSVG());
}

const CSSValue* BorderBlockEndColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const CSSValue* BorderBlockEndWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderWidth(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* BorderBlockStartColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const CSSValue* BorderBlockStartWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderWidth(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const blink::Color BorderBottomColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    const StyleColor& border_bottom_color = style.BorderBottomColor();
    if (style.ShouldForceColor(border_bottom_color)) {
        return GetCSSPropertyInternalForcedBorderColor().ColorIncludingFallback(false, style, is_current_color);
    }
    return ComputedStyleUtils::BorderSideColor(style, border_bottom_color, style.BorderBottomStyle(), visited_link, is_current_color);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(border_bottom_color)) {
        return GetCSSPropertyInternalForcedBorderColor().CSSValueFromComputedStyle(style, nullptr, allow_visited_style, value_phase);
    }
    return allow_visited_style ? cssvalue::CSSColor::Create(style.VisitedDependentColor(*this))
                               : ComputedStyleUtils::CurrentColorOrValidColor(style, border_bottom_color, value_phase);
}

const CSSValue* BorderBottomLeftRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* BorderBottomLeftRadius::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForBorderRadiusCorner(style.BorderBottomLeftRadius(), style);
}

const CSSValue* BorderBottomRightRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseBorderRadiusCorner(stream, context);
}
...
const CSSValue* BorderBottomRightRadius::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForBorderRadiusCorner(style.BorderBottomRightRadius(), style);
}
...
const CSSValue* BorderEndEndRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseBorderRadiusCorner(stream, context);
}

const CSSValue* BorderEndStartRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseBorderRadiusCorner(stream, context);
}

const CSSValue* BorderImageOutset::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* BorderImageOutset::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForNinePieceImageQuad(style.BorderImage().Outset(), style);
}

const CSSValue* BorderImageOutset::InitialValue() const
{
    DEFINE_STATIC_LOCAL(const Persistent<CSSQuadValue>, value,
        (MakeGarbageCollected<CSSQuadValue>(CSSNumericLiteralValue::Create(0, CSSPrimitiveValue::UnitType::kInteger), CSSQuadValue::kSerializeAsQuad)));
    return value;
}

const CSSValue* BorderImageRepeat::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
...
const CSSValue* BorderImageSlice::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
{
    DEFINE_STATIC_LOCAL(const Persistent<cssvalue::CSSBorderImageSliceValue>, value,
        (MakeGarbageCollected<cssvalue::CSSBorderImageSliceValue>(
            MakeGarbageCollected<CSSQuadValue>(CSSNumericLiteralValue::Create(100, CSSPrimitiveValue::UnitType::kPercentage), CSSQuadValue::kSerializeAsQuad),
            /* fill */ false)));
    return value;
}

const CSSValue* BorderImageSource::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (style.BorderImageSource()) {
        return style.BorderImageSource()->ComputedCSSValue(style, allow_visited_style, value_phase);
    }
    return CSSIdentifierValue::Create(CSSValueID::kNone);
}
...
void BorderImageSource::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.StyleBuilder().SetBorderImageSource(state.GetStyleImage(CSSPropertyID::kBorderImageSource, value));
}

const CSSValue* BorderImageWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* BorderImageWidth::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForNinePieceImageQuad(style.BorderImage().BorderSlices(), style);
}

const CSSValue* BorderImageWidth::InitialValue() const
{
    DEFINE_STATIC_LOCAL(const Persistent<CSSQuadValue>, value,
        (MakeGarbageCollected<CSSQuadValue>(CSSNumericLiteralValue::Create(1, CSSPrimitiveValue::UnitType::kInteger), CSSQuadValue::kSerializeAsQuad)));
    return value;
}

const CSSValue* BorderInlineEndColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const CSSValue* BorderInlineEndWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderWidth(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* BorderInlineStartColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const CSSValue* BorderInlineStartWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderWidth(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const blink::Color BorderLeftColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return ComputedStyleUtils::BorderSideColor(style, border_left_color, style.BorderLeftStyle(), visited_link, is_current_color);
}
...
{
    const StyleColor& border_left_color = style.BorderLeftColor();
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(border_left_color)) {
        return GetCSSPropertyInternalForcedBorderColor().CSSValueFromComputedStyle(style, nullptr, allow_visited_style, value_phase);
    }
    return allow_visited_style ? cssvalue::CSSColor::Create(style.VisitedDependentColor(*this))
                               : ComputedStyleUtils::CurrentColorOrValidColor(style, border_left_color, value_phase);
}
...
const blink::Color BorderRightColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return ComputedStyleUtils::BorderSideColor(style, border_right_color, style.BorderRightStyle(), false, is_current_color);
}
...
{
    const StyleColor& border_right_color = style.BorderRightColor();
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(border_right_color)) {
        return GetCSSPropertyInternalForcedBorderColor().CSSValueFromComputedStyle(style, nullptr, allow_visited_style, value_phase);
    }
    return allow_visited_style ? cssvalue::CSSColor::Create(style.VisitedDependentColor(*this))
                               : ComputedStyleUtils::CurrentColorOrValidColor(style, border_right_color, value_phase);
}
...
const CSSValue* BorderStartStartRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseBorderRadiusCorner(stream, context);
}

const CSSValue* BorderStartEndRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseBorderRadiusCorner(stream, context);
}
...
const blink::Color BorderTopColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return ComputedStyleUtils::BorderSideColor(style, border_top_color, style.BorderTopStyle(), visited_link, is_current_color);
}
...
{
    const StyleColor& border_top_color = style.BorderTopColor();
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(border_top_color)) {
        return GetCSSPropertyInternalForcedBorderColor().CSSValueFromComputedStyle(style, nullptr, allow_visited_style, value_phase);
    }
    return allow_visited_style ? cssvalue::CSSColor::Create(style.VisitedDependentColor(*this))
                               : ComputedStyleUtils::ComputedStyleUtils::CurrentColorOrValidColor(style, border_top_color, value_phase);
}

const CSSValue* BorderTopLeftRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseBorderRadiusCorner(stream, context);
}
...
const CSSValue* BorderTopLeftRadius::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForBorderRadiusCorner(style.BorderTopLeftRadius(), style);
}

const CSSValue* BorderTopRightRadius::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseBorderRadiusCorner(stream, context);
}
...
const CSSValue* BorderTopRightRadius::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForBorderRadiusCorner(style.BorderTopRightRadius(), style);
}
...
const CSSValue* Bottom::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessUnlessShorthand(local_context), anchor_types);
}

bool Bottom::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
...
const CSSValue* BoxShadow::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* BoxShadow::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForShadowList(style.BoxShadow(), style, true, value_phase);
}
...
const CSSValue* CaretColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const blink::Color CaretColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    const StyleColor result = auto_color.IsAutoColor() ? StyleColor::CurrentColor() : auto_color.ToStyleColor();
    if (style.ShouldForceColor(result)) {
        return style.GetInternalForcedCurrentColor(is_current_color);
    }
    return result.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    // the background to ensure good visibility and contrast.
    const StyleColor result = auto_color.IsAutoColor() ? StyleColor::CurrentColor() : auto_color.ToStyleColor();
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(result)) {
        return cssvalue::CSSColor::Create(style.GetInternalForcedCurrentColor());
    }

    return ComputedStyleUtils::ValueForStyleAutoColor(style, style.CaretColor(), value_phase);
}
...
CSSValue* ConsumeClipComponent(CSSParserTokenStream& stream, const CSSParserContext& context)
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    return css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kAllow);
}

} // namespace

const CSSValue* Clip::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    guard.Release();
    return MakeGarbageCollected<CSSQuadValue>(top, right, bottom, left, CSSQuadValue::kSerializeAsRect);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValue* top = ComputedStyleUtils::ZoomAdjustedPixelValueOrAuto(style.Clip().Top(), style);
    CSSValue* right = ComputedStyleUtils::ZoomAdjustedPixelValueOrAuto(style.Clip().Right(), style);
    CSSValue* bottom = ComputedStyleUtils::ZoomAdjustedPixelValueOrAuto(style.Clip().Bottom(), style);
    CSSValue* left = ComputedStyleUtils::ZoomAdjustedPixelValueOrAuto(style.Clip().Left(), style);
    return MakeGarbageCollected<CSSQuadValue>(top, right, bottom, left, CSSQuadValue::kSerializeAsRect);
}

const CSSValue* ClipPath::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }

    if (cssvalue::CSSURIValue* url = css_parsing_utils::ConsumeUrl(stream, context)) {
        return url;
    }
    ...
    if (basic_shape || geometry_box) {
        ...
        if (geometry_box) {
            if (list->length() == 0 || To<CSSIdentifierValue>(geometry_box)->GetValueID() != CSSValueID::kBorderBox) {
...
const CSSValue* Color::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColorMaybeQuirky(stream, context);
}

const blink::Color Color::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    if (style.ShouldForceColor(style.Color())) {
        return GetCSSPropertyInternalForcedColor().ColorIncludingFallback(false, style, is_current_color);
    }
...
const CSSValue* Color::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(style.Color())) {
        return GetCSSPropertyInternalForcedColor().CSSValueFromComputedStyle(style, nullptr, allow_visited_style, value_phase);
    }
    return cssvalue::CSSColor::Create(allow_visited_style ? style.VisitedDependentColor(*this) : style.GetCurrentColor());
}
...
void Color::ApplyInherit(StyleResolverState& state) const
{
    ...
    if (builder.ShouldPreserveParentColor()) {
        builder.SetColor(StyleColor(state.ParentStyle()->VisitedDependentColor(GetCSSPropertyColor())));
    } else {
...
void Color::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    if (value.IsInitialColorValue()) {
        ...
        if (color.IsUnresolvedColorFunction()) {
            ...
            color = StyleColor(color.Resolve(state.ParentStyle()->Color().GetColor(), mojom::blink::ColorScheme::kLight));
        } else if (color.IsCurrentColor()) {
            // As per the spec, 'color: currentColor' is treated as 'color: inherit'
            ApplyInherit(state);
            builder.SetColorIsCurrentColor(true);
            if (state.UsesHighlightPseudoInheritance() && state.OriginatingElementStyle()) {
...
const CSSValue* ColorScheme::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    do {
        ...
        CSSValue* value = css_parsing_utils::ConsumeIdent<CSSValueID::kDark, CSSValueID::kLight, CSSValueID::kOnly>(stream);
...
void ApplyColorSchemeValue(StyleResolverState& state, const CSSValueList* scheme_list)
{
    ColorSchemeFlags flags = static_cast<ColorSchemeFlags>(ColorSchemeFlag::kNormal);
    Vector<AtomicString> color_schemes;

    Document& document = state.GetDocument();
    if (scheme_list) {
        flags = StyleBuilderConverter::ExtractColorSchemes(document, *scheme_list, &color_schemes);
    } else {
        flags = document.GetStyleEngine().GetPageColorSchemes();
    }

    state.StyleBuilder().SetColorScheme(std::move(color_schemes));
    state.StyleBuilder().SetUsedColorScheme(flags, document.GetStyleEngine().GetPreferredColorScheme(), document.GetStyleEngine().GetForceDarkModeEnabled());
...
void ColorScheme::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    const CSSValueList* scheme_list = DynamicTo<CSSValueList>(value);
    DCHECK(scheme_list || (value.IsIdentifierValue() && DynamicTo<CSSIdentifierValue>(value)->GetValueID() == CSSValueID::kNormal));
    ApplyColorSchemeValue(state, scheme_list);
}

const CSSValue* ColumnCount::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return CSSNumericLiteralValue::Create(style.ColumnCount(), CSSPrimitiveValue::UnitType::kNumber);
}
...
const CSSValue* ColumnGap::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ColumnRuleColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGapDecorationColorList(stream, context);
}

const blink::Color ColumnRuleColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    const StyleColor& column_rule_color = style.ColumnRuleColor().GetLegacyValue();
    if (style.ShouldForceColor(column_rule_color)) {
        return style.GetInternalForcedCurrentColor(is_current_color);
    }
    return column_rule_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ValueForGapDecorationColorDataList(style.ColumnRuleColor(), style, value_phase);
}
...
const CSSValue* ColumnRuleWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ColumnSpan::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ColumnSpan::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create(static_cast<unsigned>(style.GetColumnSpan()) ? CSSValueID::kAll : CSSValueID::kNone);
}

const CSSValue* ColumnWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* Contain::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
...
const CSSValue* ContainIntrinsicWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ContainIntrinsicWidth::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForIntrinsicLength(style, style.ContainIntrinsicWidth());
}

const CSSValue* ContainIntrinsicHeight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeIntrinsicSizeLonghand(stream, context);
}
...
const CSSValue* ContainIntrinsicHeight::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForIntrinsicLength(style, style.ContainIntrinsicHeight());
}

const CSSValue* ContainIntrinsicInlineSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeIntrinsicSizeLonghand(stream, context);
}

const CSSValue* ContainIntrinsicBlockSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeIntrinsicSizeLonghand(stream, context);
}

const CSSValue* ContainerName::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    for (const Member<const ScopedCSSName>& name : style.ContainerName()->GetNames()) {
        list->Append(*ComputedStyleUtils::ValueForCustomIdentOrNone(name.Get()));
    }
    return list;
}

const CSSValue* ContainerType::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ContainerType::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    DCHECK_NE(style.ContainerType() & kContainerTypeSize, kContainerTypeBlockSize);

    if (style.ContainerType() == kContainerTypeNormal) {
        return CSSIdentifierValue::Create(CSSValueID::kNormal);
    }
    CSSValueList* values = CSSValueList::CreateSpaceSeparated();
    if ((style.ContainerType() & kContainerTypeBlockSize) == kContainerTypeBlockSize) {
...
CSSValue* ConsumeAttr(CSSParserTokenStream& stream, const CSSParserContext& context)
{
    ...
    CSSFunctionValue* attr_value = MakeGarbageCollected<CSSFunctionValue>(CSSValueID::kAttr);
    attr_value->Append(*MakeGarbageCollected<CSSCustomIdentValue>(attr_name));
    return attr_value;
}

CSSValue* ConsumeCounterContent(CSSParserTokenStream& stream, const CSSParserContext& context, bool counters)
{
...

    {
        ...
        if (!counters) {
            ...
            if (!css_parsing_utils::ConsumeCommaIncludingWhitespace(stream) || stream.Peek().GetType() != kStringToken) {
                return nullptr;
            }
            separator = MakeGarbageCollected<CSSStringValue>(stream.ConsumeIncludingWhitespace().Value().ToString());
        }
        ...
        if (css_parsing_utils::ConsumeCommaIncludingWhitespace(stream)) {
            ...
            if (stream.Peek().Id() == CSSValueID::kNone) {
                list_style = MakeGarbageCollected<CSSCustomIdentValue>(AtomicString("none"));
                stream.ConsumeIncludingWhitespace();
            } else {
                list_style = css_parsing_utils::ConsumeCounterStyleName(stream, context);
            }
        } else {
    ...
    stream.ConsumeWhitespace();
    return MakeGarbageCollected<cssvalue::CSSCounterValue>(identifier, list_style, separator);
}

const CSSValue* ParseContentValue(CSSParserTokenStream& stream, const CSSParserContext& context)
{
    ...
    do {
        ...
        if (!parsed_value) {
            parsed_value
                = css_parsing_utils::ConsumeIdent<CSSValueID::kOpenQuote, CSSValueID::kCloseQuote, CSSValueID::kNoOpenQuote, CSSValueID::kNoCloseQuote>(stream);
        }
        if (!parsed_value) {
            parsed_value = css_parsing_utils::ConsumeString(stream);
        }
        if (!parsed_value) {
            if (stream.Peek().FunctionId() == CSSValueID::kAttr && !RuntimeEnabledFeatures::CSSAdvancedAttrFunctionEnabled()) {
...
const CSSValue* Content::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* Content::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForContentData(style, allow_visited_style, value_phase);
}
...
String GetStringFromAttributeOrStringValue(const CSSValue& value, StyleResolverState& state, ComputedStyleBuilder& builder)
{
    ...
    if (const auto* function_value = DynamicTo<CSSFunctionValue>(value)) {
        ...
        QualifiedName attr(To<CSSCustomIdentValue>(function_value->Item(0)).Value());
        const AtomicString& attr_value = state.GetUltimateOriginatingElementOrSelf().getAttribute(attr);
...
void Content::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    DCHECK(value.IsScopedValue());
    ComputedStyleBuilder& builder = state.StyleBuilder();
    if (auto* identifier_value = DynamicTo<CSSIdentifierValue>(value)) {
        DCHECK(identifier_value->GetValueID() == CSSValueID::kNormal || identifier_value->GetValueID() == CSSValueID::kNone);
    ...
    for (auto& item : To<CSSValueList>(outer_list.Item(0))) {
        ...
        if (item->IsImageGeneratorValue() || item->IsImageSetValue() || item->IsImageValue()) {
            next_content = MakeGarbageCollected<ImageContentData>(state.GetStyleImage(CSSPropertyID::kContent, *item));
        } else if (const auto* counter_value = DynamicTo<cssvalue::CSSCounterValue>(item.Get())) {
            next_content = MakeGarbageCollected<CounterContentData>(
                AtomicString(counter_value->Identifier()), counter_value->ListStyle(), AtomicString(counter_value->Separator()), counter_value->GetTreeScope());
        } else if (auto* item_identifier_value = DynamicTo<CSSIdentifierValue>(item.Get())) {
            ...
            String string = GetStringFromAttributeOrStringValue(*item, state, builder);
    ...
    if (outer_list.length() > 1) {
        ...
        for (auto& item : To<CSSValueList>(outer_list.Item(1))) {
            auto* alt_content = MakeGarbageCollected<AltTextContentData>(GetStringFromAttributeOrStringValue(*item, state, builder));
...
const CSSValue* CounterIncrement::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* CounterIncrement::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForCounterDirectives(style, CountersAttachmentContext::Type::kIncrementType);
}

const int kCounterResetDefaultValue = 0;

const CSSValue* CounterReset::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* CounterReset::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForCounterDirectives(style, CountersAttachmentContext::Type::kResetType);
}

const int kCounterSetDefaultValue = 0;

const CSSValue* CounterSet::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* CounterSet::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForCounterDirectives(style, CountersAttachmentContext::Type::kSetType);
}

const CSSValue* Cursor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    bool in_quirks_mode = IsQuirksModeBehavior(context.Mode());
    CSSValueList* list = nullptr;
    while (CSSValue* image = css_parsing_utils::ConsumeImage(stream, context, css_parsing_utils::ConsumeGeneratedImagePolicy::kForbid)) {
        double num;
        ...
        list->Append(*MakeGarbageCollected<cssvalue::CSSCursorImageValue>(*image, hot_spot_specified, hot_spot));
        if (!css_parsing_utils::ConsumeCommaIncludingWhitespace(stream)) {
            return nullptr;
        }
    }
    ...
    if (id == CSSValueID::kHand) {
        ...
        cursor_type = MakeGarbageCollected<CSSIdentifierValue>(CSSValueID::kPointer,
            /*was_quirky=*/true); // Cannot use the identifier value pool due to
            // was_quirky.
        stream.ConsumeIncludingWhitespace();
    } else if ((id >= CSSValueID::kAuto && id <= CSSValueID::kWebkitZoomOut) || id == CSSValueID::kCopy || id == CSSValueID::kNone) {
        ...
        for (const CursorData& cursor : *cursors) {
            if (StyleImage* image = cursor.GetImage()) {
                list->Append(*MakeGarbageCollected<cssvalue::CSSCursorImageValue>(
                    *image->ComputedCSSValue(style, allow_visited_style, value_phase), cursor.HotSpotSpecified(), cursor.HotSpot()));
            }
        }
    }
...
void Cursor::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    builder.ClearCursorList();
    if (auto* value_list = DynamicTo<CSSValueList>(value)) {
        ...
        for (const auto& item : *value_list) {
            if (const auto* cursor = DynamicTo<cssvalue::CSSCursorImageValue>(*item)) {
                const CSSValue& image = cursor->ImageValue();
                builder.AddCursor(state.GetStyleImage(CSSPropertyID::kCursor, image), cursor->HotSpotSpecified(), cursor->HotSpot());
            } else {
...
const CSSValue* Cx::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSVGGeometryPropertyLength(stream, context, CSSPrimitiveValue::ValueRange::kAll);
}
...
const CSSValue* Cy::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSVGGeometryPropertyLength(stream, context, CSSPrimitiveValue::ValueRange::kAll);
}
...
const CSSValue* D::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumePathOrNone(stream);
}

const CSSValue* D::CSSValueFromComputedStyleInternal(const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
...
void Direction::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.StyleBuilder().SetDirection(To<CSSIdentifierValue>(value).ConvertTo<TextDirection>());
}
...
static bool IsDisplayInside(CSSValueID id)
{
    ...
    return (id >= CSSValueID::kFlowRoot && id <= CSSValueID::kMasonry) || id == CSSValueID::kMath || id == CSSValueID::kRuby;
}
...
const CSSValue* ParseDisplayMultipleKeywords(CSSParserTokenStream& stream, const CSSIdentifierValue* first_value)
{
    CSSValueList* values = CSSValueList::CreateSpaceSeparated();
...
const CSSValue* Display::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
    if (id != CSSValueID::kInvalid) {
        ...
        } else if (id == CSSValueID::kListItem || IsDisplayBox(id) || IsDisplayInternal(id) || IsDisplayLegacy(id) || IsDisplayInside(id)
            || IsDisplayOutside(id)) {
            return value;
        } else {
            return nullptr;
    ...
    stream.ConsumeWhitespace();
    return MakeGarbageCollected<cssvalue::CSSLayoutFunctionValue>(name, /* is_inline */ function == CSSValueID::kInlineLayout);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (style.IsDisplayLayoutCustomBox()) {
        return MakeGarbageCollected<cssvalue::CSSLayoutFunctionValue>(
            MakeGarbageCollected<CSSCustomIdentValue>(style.DisplayLayoutCustomName()), style.IsDisplayInlineType());
    }
...
const CSSValue* DynamicRangeLimit::ParseSingleValue(
    CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    if (const CSSValue* const keyword_value = css_parsing_utils::ConsumeIdent<CSSValueID::kStandard, CSSValueID::kHigh, CSSValueID::kConstrainedHigh>(stream)) {
    ...
    bool all_percentages_zero = true;
    {
        ...
        while (true) {
            ...
            const CSSValue* limit = DynamicRangeLimit::ParseSingleValue(stream, context, local_context);
            if (limit == nullptr) {
                return nullptr;
            }
            ...
            const CSSPrimitiveValue* percentage = css_parsing_utils::ConsumePercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
            if (!percentage) {
                return nullptr;
            }
    ...
    return MakeGarbageCollected<cssvalue::CSSDynamicRangeLimitMixValue>(std::move(limits), std::move(percentages));
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (limit.standard_mix != 0.f) {
        ...
        percentages.push_back(CSSNumericLiteralValue::Create(100 * limit.standard_mix, CSSPrimitiveValue::UnitType::kPercentage));
    }
    if (limit.constrained_high_mix != 0.f) {
        limits.push_back(CSSIdentifierValue::Create(CSSValueID::kConstrainedHigh));
        percentages.push_back(CSSNumericLiteralValue::Create(100 * limit.constrained_high_mix, CSSPrimitiveValue::UnitType::kPercentage));
    }
    if (high_mix != 0.f) {
        limits.push_back(CSSIdentifierValue::Create(CSSValueID::kHigh));
        percentages.push_back(CSSNumericLiteralValue::Create(100 * high_mix, CSSPrimitiveValue::UnitType::kPercentage));
    }
    return MakeGarbageCollected<cssvalue::CSSDynamicRangeLimitMixValue>(std::move(limits), std::move(percentages));
}
...
const CSSValue* Fill::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const blink::Color Fill::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return fill_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}

void Fill::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.StyleBuilder().SetFillPaint(StyleBuilderConverter::ConvertSVGPaint(state, value, false, PropertyID()));
}

const CSSValue* FillOpacity::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FillOpacity::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.FillOpacity(), CSSPrimitiveValue::UnitType::kNumber);
}
...
const CSSValue* Filter::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeFilterFunctionList(stream, context);
}
...
void Filter::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.StyleBuilder().SetFilter(StyleBuilderConverter::ConvertFilterOperations(state, value, PropertyID()));
}

const CSSValue* FlexBasis::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    // TODO(https://crbug.com/353538495): This should really use
    // css_parsing_utils::ValidWidthOrHeightKeyword.
    if (css_parsing_utils::IdentMatches<CSSValueID::kAuto, CSSValueID::kContent, CSSValueID::kMinContent, CSSValueID::kMaxContent, CSSValueID::kFitContent>(
            stream.Peek().Id())) {
        return css_parsing_utils::ConsumeIdent(stream);
    }

    if (RuntimeEnabledFeatures::LayoutStretchEnabled() && CSSValueID::kStretch == stream.Peek().Id()) {
        return css_parsing_utils::ConsumeIdent(stream);
    }

    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kForbid,
        kCSSAnchorQueryTypesNone, css_parsing_utils::AllowCalcSize::kAllowWithAutoAndContent);
}

const CSSValue* FlexBasis::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.FlexBasis(), style);
}
...
const CSSValue* FlexGrow::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FlexGrow::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.FlexGrow(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* FlexShrink::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeNumber(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}
...
const CSSValue* FlexShrink::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.FlexShrink(), CSSPrimitiveValue::UnitType::kNumber);
}
...
const CSSValue* FloodColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color FloodColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
...
const CSSValue* FloodColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.FloodColor(), value_phase);
}

const CSSValue* FloodOpacity::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeAlphaValue(stream, context);
}
...
const CSSValue* FloodOpacity::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.FloodOpacity(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* FontFamily::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
...
void FontFamily::ApplyInherit(StyleResolverState& state) const
{
    ...
    CSSFontSelector* selector = static_cast<CSSFontSelector*>(state.ParentStyle()->GetFont().GetFontSelector());
    const TreeScope* tree_scope = selector ? selector->GetTreeScope() : nullptr;
    state.GetFontBuilder().SetFamilyTreeScope(tree_scope);
}

const CSSValue* FontFeatureSettings::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FontPalette::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeFontPalette(stream, context);
}

const CSSValue* FontSizeAdjust::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FontSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FontStretch::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FontStyle::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FontVariantCaps::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeIdent<CSSValueID::kNormal, CSSValueID::kSmallCaps, CSSValueID::kAllSmallCaps, CSSValueID::kPetiteCaps,
        CSSValueID::kAllPetiteCaps, CSSValueID::kUnicase, CSSValueID::kTitlingCaps>(stream);
}
...
const CSSValue* FontVariantEastAsian::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNormal) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* FontVariantLigatures::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FontVariantNumeric::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNormal) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* FontVariantAlternates::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNormal) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    do {
        if (alternates_parser.ConsumeAlternates(stream, context) != FontVariantAlternatesParser::ParseResult::kConsumedValue) {
            break;
        }
        found_any = true;
    } while (!stream.AtEnd());
...
cssvalue::CSSFontVariationValue* ConsumeFontVariationTag(CSSParserTokenStream& stream, const CSSParserContext& context)
{
    ...
    return MakeGarbageCollected<cssvalue::CSSFontVariationValue>(tag, ClampTo<float>(tag_value));
}

} // namespace

const CSSValue* FontVariationSettings::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNormal) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    do {
        cssvalue::CSSFontVariationValue* font_variation_value = ConsumeFontVariationTag(stream, context);
...
const CSSValue* FontWeight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* FontSynthesisWeight::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create(style.GetFontDescription().GetFontSynthesisWeight());
}

const CSSValue* FontSynthesisStyle::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create(style.GetFontDescription().GetFontSynthesisStyle());
}

const CSSValue* FontSynthesisSmallCaps::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create(style.GetFontDescription().GetFontSynthesisSmallCaps());
}
...
void InternalVisitedColor::ApplyInherit(StyleResolverState& state) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    if (builder.ShouldPreserveParentColor()) {
        builder.SetInternalVisitedColor(StyleColor(state.ParentStyle()->VisitedDependentColor(GetCSSPropertyColor())));
    } else {
        builder.SetInternalVisitedColor(state.ParentStyle()->Color());
    }
    builder.SetInternalVisitedColorIsCurrentColor(state.ParentStyle()->InternalVisitedColorIsCurrentColor());
}

void InternalVisitedColor::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    ...
    if (identifier_value && identifier_value->GetValueID() == CSSValueID::kCurrentcolor) {
        ...
        if (state.UsesHighlightPseudoInheritance() && state.OriginatingElementStyle()) {
            builder.SetInternalVisitedColor(state.OriginatingElementStyle()->InternalVisitedColor());
        }
        return;
    }
    if (value.IsInitialColorValue()) {
        ...
        StyleColor color = StyleBuilderConverter::ConvertStyleColor(state, value, true);
        if (color.IsUnresolvedColorFunction()) {
            color = StyleColor(color.Resolve(state.ParentStyle()->Color().GetColor(), mojom::blink::ColorScheme::kLight));
        }
...
const blink::Color InternalVisitedColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    if (style.ShouldForceColor(style.InternalVisitedColor())) {
        return GetCSSPropertyInternalForcedVisitedColor().ColorIncludingFallback(true, style, is_current_color);
    }
...
const CSSValue* GridAutoColumns::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* GridAutoColumns::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForGridAutoTrackList(kForColumns, layout_object, style);
}
...
const CSSValue* GridAutoFlow::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSIdentifierValue* row_or_column_value = css_parsing_utils::ConsumeIdent<CSSValueID::kRow, CSSValueID::kColumn>(stream);
    CSSIdentifierValue* dense_algorithm = css_parsing_utils::ConsumeIdent<CSSValueID::kDense>(stream);
...
const CSSValue* GridAutoRows::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridTrackList(stream, context, css_parsing_utils::TrackListType::kGridAuto);
}
...
const CSSValue* GridAutoRows::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForGridAutoTrackList(kForRows, layout_object, style);
}
...
const CSSValue* GridColumnEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* GridColumnStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridLine(stream, context);
}
...
const CSSValue* GridRowEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridLine(stream, context);
}
...
const CSSValue* GridRowStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridLine(stream, context);
}
...
const CSSValue* GridTemplateAreas::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    while (stream.Peek().GetType() == kStringToken) {
        if (!css_parsing_utils::ParseGridTemplateAreasRow(stream.ConsumeIncludingWhitespace().Value().ToString(), grid_area_map, row_count, column_count)) {
            return nullptr;
        }
        ++row_count;
    }
    ...
    DCHECK(column_count);
    return MakeGarbageCollected<cssvalue::CSSGridTemplateAreasValue>(grid_area_map, row_count, column_count);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (const auto& grid_template_areas = style.GridTemplateAreas()) {
        return MakeGarbageCollected<cssvalue::CSSGridTemplateAreasValue>(
            grid_template_areas->named_areas, grid_template_areas->row_count, grid_template_areas->column_count);
    }
    return CSSIdentifierValue::Create(CSSValueID::kNone);
}
...
const CSSValue* GridTemplateColumns::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridTemplatesRowsOrColumns(stream, context);
}

bool GridTemplateColumns::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
...
const CSSValue* GridTemplateColumns::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForGridTrackList(kForColumns, layout_object, style);
}
...
const CSSValue* GridTemplateRows::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridTemplatesRowsOrColumns(stream, context);
}

bool GridTemplateRows::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsLayoutGrid();
}
...
const CSSValue* GridTemplateRows::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForGridTrackList(kForRows, layout_object, style);
}
...
const CSSValue* Height::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context, css_parsing_utils::UnitlessQuirk::kAllow);
}

bool Height::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && (layout_object->IsBox() || layout_object->IsSVG());
}
...
const CSSValue* Height::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (value_phase == CSSValuePhase::kResolvedValue && ComputedStyleUtils::WidthOrHeightShouldReturnUsedValue(layout_object)) {
        return ZoomAdjustedPixelValue(ComputedStyleUtils::UsedBoxSize(*layout_object).height(), style);
    }
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.Height(), style);
}
...
const CSSValue* PopoverShowDelay::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.PopoverShowDelay(), CSSPrimitiveValue::UnitType::kSeconds);
}
...
const CSSValue* PopoverHideDelay::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.PopoverHideDelay(), CSSPrimitiveValue::UnitType::kSeconds);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (value.MinBeforeChars() || value.MinAfterChars()) {
        ...
        if (value.MinAfterChars()) {
            list->Append(*CSSNumericLiteralValue::Create(value.MinAfterChars(), CSSPrimitiveValue::UnitType::kInteger));
        }
    }
    return list;
}

const CSSValue* HyphenateLimitChars::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ImageOrientation::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ImageOrientation::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    const CSSValueID value = style.ImageOrientation() == kRespectImageOrientation ? CSSValueID::kFromImage : CSSValueID::kNone;
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    list->Append(*CSSNumericLiteralValue::Create(initial_letter.Size(), CSSPrimitiveValue::UnitType::kNumber));
    if (initial_letter.IsIntegerSink()) {
        list->Append(*CSSNumericLiteralValue::Create(initial_letter.Sink(), CSSPrimitiveValue::UnitType::kInteger));
...
const CSSValue* InitialLetter::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeInitialLetter(stream, context);
}

const CSSValue* InlineSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context);
}

bool InlineSize::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && (layout_object->IsBox() || layout_object->IsSVG());
}

const CSSValue* PositionArea::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* InsetArea::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    if (const auto* document = context.GetDocument()) {
        document->AddConsoleMessage(
            MakeGarbageCollected<ConsoleMessage>(mojom::blink::ConsoleMessageSource::kDeprecation, mojom::blink::ConsoleMessageLevel::kWarning,
                String("The 'inset-area' property has been deprecated, "
                       "and will be removed from this browser very soon. Please use the "
                       "'position-area' property instead.")));
        Deprecation::CountDeprecation(document->GetExecutionContext(), WebFeature::kCSSInsetAreaProperty);
    }
    return css_parsing_utils::ConsumePositionArea(stream);
}
...
void ComputeAnchorEdgeOffsetsForPositionArea(StyleResolverState& state, blink::PositionArea position_area)
{
    if (AnchorEvaluator* evaluator = state.CssToLengthConversionData().GetAnchorEvaluator()) {
        state.SetPositionAreaOffsets(evaluator->ComputePositionAreaOffsetsForLayout(state.StyleBuilder().PositionAnchor(), position_area));
    }
...
void PositionArea::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    blink::PositionArea position_area = StyleBuilderConverter::ConvertPositionArea(state, value);
...
const CSSValue* InsetBlockEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, anchor_types);
}

bool InsetBlockEnd::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* InsetBlockStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, anchor_types);
...
bool InsetBlockStart::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* InsetInlineEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, anchor_types);
...
bool InsetInlineEnd::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* InsetInlineStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, anchor_types);
...
bool InsetInlineStart::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const blink::Color InternalVisitedBackgroundColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);

    const StyleColor& visited_background_color = style.InternalVisitedBackgroundColor();
    if (style.ShouldForceColor(visited_background_color)) {
        return GetCSSPropertyInternalForcedBackgroundColor().ColorIncludingFallback(true, style, is_current_color);
    }
    blink::Color color = visited_background_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
    ...
    if (color == blink::Color::kTransparent) {
        ...
        return style.BackgroundColor().Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
    }
...
const blink::Color InternalVisitedBorderLeftColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_border_left_color = style.InternalVisitedBorderLeftColor();
    if (style.ShouldForceColor(visited_border_left_color)) {
        return GetCSSPropertyInternalForcedBorderColor().ColorIncludingFallback(true, style, is_current_color);
    }
    return visited_border_left_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedBorderTopColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_border_top_color = style.InternalVisitedBorderTopColor();
    if (style.ShouldForceColor(visited_border_top_color)) {
        return GetCSSPropertyInternalForcedBorderColor().ColorIncludingFallback(true, style, is_current_color);
    }
    return visited_border_top_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedCaretColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    ...
    return result.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const CSSValue* InternalVisitedCaretColor::ParseSingleValue(
    CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    return GetCSSPropertyCaretColor().ParseSingleValue(stream, context, local_context);
}

const blink::Color InternalVisitedBorderRightColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_border_right_color = style.InternalVisitedBorderRightColor();
    if (style.ShouldForceColor(visited_border_right_color)) {
        return GetCSSPropertyInternalForcedBorderColor().ColorIncludingFallback(true, style, is_current_color);
    }
    return visited_border_right_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedBorderBottomColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_border_bottom_color = style.InternalVisitedBorderBottomColor();
    if (style.ShouldForceColor(visited_border_bottom_color)) {
        return GetCSSPropertyInternalForcedBorderColor().ColorIncludingFallback(true, style, is_current_color);
    }
    return visited_border_bottom_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedFill::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    ...
    if (!paint.HasColor()) {
        return GetCSSPropertyFill().ColorIncludingFallback(false, style, is_current_color);
    }
    const StyleColor& visited_fill_color = paint.GetColor();
    if (style.ShouldForceColor(visited_fill_color)) {
        return style.GetInternalForcedVisitedCurrentColor(is_current_color);
    }
    return visited_fill_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const blink::Color InternalVisitedColumnRuleColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_column_rule_color = style.InternalVisitedColumnRuleColor().GetLegacyValue();
    if (style.ShouldForceColor(visited_column_rule_color)) {
        return style.GetInternalForcedVisitedCurrentColor(is_current_color);
    }
    return visited_column_rule_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedOutlineColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_outline_color = style.InternalVisitedOutlineColor();
    if (style.ShouldForceColor(visited_outline_color)) {
        return GetCSSPropertyInternalForcedOutlineColor().ColorIncludingFallback(true, style, is_current_color);
    }
    return visited_outline_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const CSSValue* InternalVisitedOutlineColor::ParseSingleValue(
    CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    return GetCSSPropertyOutlineColor().ParseSingleValue(stream, context, local_context);
}
...
const blink::Color InternalVisitedStroke::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    ...
    // paint, https://bugs.webkit.org/show_bug.cgi?id=70006
    if (!paint.HasColor()) {
        return GetCSSPropertyStroke().ColorIncludingFallback(false, style, is_current_color);
    }
    const StyleColor& visited_stroke_color = paint.GetColor();
    if (style.ShouldForceColor(visited_stroke_color)) {
        return style.GetInternalForcedVisitedCurrentColor(is_current_color);
    }
    return visited_stroke_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const blink::Color InternalVisitedTextDecorationColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_decoration_color = style.DecorationColorIncludingFallback(visited_link);
    if (style.ShouldForceColor(visited_decoration_color)) {
        return style.GetInternalForcedVisitedCurrentColor(is_current_color);
    }
    return visited_decoration_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedTextEmphasisColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_text_emphasis_color = style.InternalVisitedTextEmphasisColor();
    if (style.ShouldForceColor(visited_text_emphasis_color)) {
        return style.GetInternalForcedVisitedCurrentColor(is_current_color);
    }
    return visited_text_emphasis_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedTextFillColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_text_fill_color = style.InternalVisitedTextFillColor();
    if (style.ShouldForceColor(visited_text_fill_color)) {
        return style.GetInternalForcedVisitedCurrentColor(is_current_color);
    }
    return visited_text_fill_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalVisitedTextStrokeColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    const StyleColor& visited_text_stroke_color = style.InternalVisitedTextStrokeColor();
    if (style.ShouldForceColor(visited_text_stroke_color)) {
        return style.GetInternalForcedVisitedCurrentColor(is_current_color);
    }
    return visited_text_stroke_color.Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
const blink::Color InternalForcedBackgroundColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    ...
    if (visited_link) {
        ...
        alpha = style.InternalVisitedBackgroundColor()
                    .Resolve(style.GetInternalVisitedCurrentColor(), style.UsedColorScheme(), &alpha_is_current_color)
                    .AlphaAsInteger();
    } else {
        forced_current_color = style.GetInternalForcedCurrentColor(
            /* No is_current_color because we might not be forced_current_color */);
        alpha = style.BackgroundColor().Resolve(style.GetCurrentColor(), style.UsedColorScheme(), &alpha_is_current_color).AlphaAsInteger();
    }

    bool result_is_current_color;
    blink::Color result
        = style.InternalForcedBackgroundColor().ResolveWithAlpha(forced_current_color, style.UsedColorScheme(), alpha, &result_is_current_color);
...
const CSSValue* InternalForcedBackgroundColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    bool visited_link = allow_visited_style && style.InsideLink() == EInsideLink::kInsideVisitedLink;
    return cssvalue::CSSColor::Create(ColorIncludingFallback(visited_link, style));
}
...
const blink::Color InternalForcedBorderColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    // Don’t pass is_current_color here because we might not be current_color
    blink::Color current_color = visited_link ? style.GetInternalForcedVisitedCurrentColor() : style.GetInternalForcedCurrentColor();

    return style.InternalForcedBorderColor().Resolve(current_color, style.UsedColorScheme(), is_current_color);
}
...
{
    state.StyleBuilder().SetInternalForcedColor(ComputedStyleInitialValues::InitialInternalForcedColor());
}

void InternalForcedColor::ApplyInherit(StyleResolverState& state) const
{
    state.StyleBuilder().SetInternalForcedColor(state.ParentStyle()->InternalForcedColor());
}

void InternalForcedColor::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    auto* identifier_value = DynamicTo<CSSIdentifierValue>(value);
    if (identifier_value && identifier_value->GetValueID() == CSSValueID::kCurrentcolor) {
        ApplyInherit(state);
    ...
    if (value.IsInitialColorValue()) {
        DCHECK_EQ(state.GetElement(), state.GetDocument().documentElement());
        builder.SetInternalForcedColor(ComputedStyleInitialValues::InitialInternalForcedColor());
        return;
    }
    builder.SetInternalForcedColor(StyleBuilderConverter::ConvertStyleColor(state, value));
}

const blink::Color InternalForcedColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    return style.GetInternalForcedCurrentColor(is_current_color);
}
...
const CSSValue* InternalForcedColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return cssvalue::CSSColor::Create(allow_visited_style ? style.VisitedDependentColor(*this) : style.GetInternalForcedCurrentColor());
}
...
const blink::Color InternalForcedOutlineColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    // No is_current_color here because we might not be current_color
    blink::Color current_color = visited_link ? style.GetInternalForcedVisitedCurrentColor() : style.GetInternalForcedCurrentColor();

    return style.InternalForcedOutlineColor().Resolve(current_color, style.UsedColorScheme(), is_current_color);
}
...
{
    state.StyleBuilder().SetInternalForcedVisitedColor(ComputedStyleInitialValues::InitialInternalForcedVisitedColor());
}
...
void InternalForcedVisitedColor::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    auto* identifier_value = DynamicTo<CSSIdentifierValue>(value);
    if (identifier_value && identifier_value->GetValueID() == CSSValueID::kCurrentcolor) {
        ApplyInherit(state);
    ...
    if (value.IsInitialColorValue()) {
        DCHECK_EQ(state.GetElement(), state.GetDocument().documentElement());
        builder.SetInternalForcedVisitedColor(ComputedStyleInitialValues::InitialInternalForcedVisitedColor());
        return;
    }
    builder.SetInternalForcedVisitedColor(StyleBuilderConverter::ConvertStyleColor(state, value, true));
}

const blink::Color InternalForcedVisitedColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(visited_link);
    return style.GetInternalForcedVisitedCurrentColor(is_current_color);
}
...
const CSSValue* JustifyContent::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    // justify-content property does not allow the <baseline-position> values.
    if (css_parsing_utils::IdentMatches<CSSValueID::kFirst, CSSValueID::kLast, CSSValueID::kBaseline>(stream.Peek().Id())) {
        return nullptr;
    }
    return css_parsing_utils::ConsumeContentDistributionOverflowPosition(stream, css_parsing_utils::IsContentPositionOrLeftOrRightKeyword);
}

const CSSValue* JustifyContent::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForContentPositionAndDistributionWithOverflowAlignment(style.JustifyContent());
}

const CSSValue* JustifyItems::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    CSSIdentifierValue* legacy = css_parsing_utils::ConsumeIdent<CSSValueID::kLegacy>(stream);
    CSSIdentifierValue* position_keyword = css_parsing_utils::ConsumeIdent<CSSValueID::kCenter, CSSValueID::kLeft, CSSValueID::kRight>(stream);
    if (!legacy) {
    ...
    if (legacy) {
        if (position_keyword) {
            ...
            return MakeGarbageCollected<CSSValuePair>(legacy, position_keyword, CSSValuePair::kDropIdenticalValues);
        }
        return legacy;
    }

    return css_parsing_utils::ConsumeSelfPositionOverflowPosition(stream, css_parsing_utils::IsSelfPositionOrLeftOrRightKeyword);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForItemPositionWithOverflowAlignment(
        style.JustifyItems().GetPosition() == ItemPosition::kAuto ? ComputedStyleInitialValues::InitialDefaultAlignment() : style.JustifyItems());
}

const CSSValue* JustifySelf::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSelfPositionOverflowPosition(stream, css_parsing_utils::IsSelfPositionOrLeftOrRightKeyword);
}
...
const CSSValue* JustifySelf::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForItemPositionWithOverflowAlignment(style.JustifySelf());
}

const CSSValue* Left::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessUnlessShorthand(local_context), anchor_types);
...
bool Left::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}
...
const CSSValue* LetterSpacing::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* LightingColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color LightingColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
...
const CSSValue* LightingColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.LightingColor(), value_phase);
}
...
const CSSValue* LineClamp::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return CSSNumericLiteralValue::Create(style.StandardLineClamp(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* LineHeight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ListStyleImage::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeImageOrNone(stream, context);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (style.ListStyleImage()) {
        return style.ListStyleImage()->ComputedCSSValue(style, allow_visited_style, value_phase);
    }
    return CSSIdentifierValue::Create(CSSValueID::kNone);
}

void ListStyleImage::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.StyleBuilder().SetListStyleImage(state.GetStyleImage(CSSPropertyID::kListStyleImage, value));
}
...
const CSSValue* ListStyleType::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (auto* none = css_parsing_utils::ConsumeIdent<CSSValueID::kNone>(stream)) {
        return none;
    }

    if (auto* counter_style_name = css_parsing_utils::ConsumeCounterStyleName(stream, context)) {
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (list_style_type.IsString()) {
        return MakeGarbageCollected<CSSStringValue>(list_style_type.GetStringValue());
    }
    return &MakeGarbageCollected<CSSCustomIdentValue>(list_style_type.GetCounterStyleName())->PopulateWithTreeScope(list_style_type.GetTreeScope());
}

void ListStyleType::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    DCHECK(value.IsScopedValue());
    ComputedStyleBuilder& builder = state.StyleBuilder();
    if (const auto* identifier_value = DynamicTo<CSSIdentifierValue>(value)) {
    ...
    if (const auto* string_value = DynamicTo<CSSStringValue>(value)) {
        builder.SetListStyleType(ListStyleTypeData::CreateString(AtomicString(string_value->Value())));
        return;
    }
    ...
    if (custom_ident_value.Value() != keywords::kDecimal && custom_ident_value.Value() != keywords::kDisc && custom_ident_value.Value() != keywords::kSquare
        && custom_ident_value.Value() != keywords::kCircle && custom_ident_value.Value() != keywords::kDisclosureOpen
        && custom_ident_value.Value() != keywords::kDisclosureClosed) {
        state.SetHasTreeScopedReference();
    }
    builder.SetListStyleType(ListStyleTypeData::CreateCounterStyle(custom_ident_value.Value(), custom_ident_value.GetTreeScope()));
}

bool MarginBlockEnd::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* MarginBlockEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, anchor_types);
}

bool MarginBlockStart::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* MarginBlockStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
...
const CSSValue* MarginBottom::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessQuirk::kAllow, anchor_types);
}

bool MarginBottom::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.MarginBottom(), style);
}

bool MarginInlineEnd::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* MarginInlineEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
...
bool MarginInlineStart::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* MarginInlineStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
...
const CSSValue* MarginLeft::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
...
bool MarginLeft::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox() && (!style || !style->MarginLeft().IsFixed());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.MarginLeft(), style);
}

const CSSValue* MarginRight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
...
bool MarginRight::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox() && (!style || !style->MarginRight().IsFixed());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.MarginRight(), style);
}

const CSSValue* MarginTop::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSAnchorQueryTypes anchor_types = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled()
        ? static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchorSize)
        : kCSSAnchorQueryTypesNone;
...
bool MarginTop::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox() && (!style || !style->MarginTop().IsFixed());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.MarginTop(), style);
}

const CSSValue* MarkerEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
{
    state.StyleBuilder().SetMarkerEndResource(StyleBuilderConverter::ConvertElementReference(state, value, PropertyID()));
}

const CSSValue* MarkerMid::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
{
    state.StyleBuilder().SetMarkerMidResource(StyleBuilderConverter::ConvertElementReference(state, value, PropertyID()));
}

const CSSValue* MarkerStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
{
    state.StyleBuilder().SetMarkerStartResource(StyleBuilderConverter::ConvertElementReference(state, value, PropertyID()));
}
...
const CSSValue* MasonrySlack::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* MasonryTemplateTracks::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridTemplatesRowsOrColumns(stream, context);
}

bool MasonryTemplateTracks::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
...
const CSSValue* MasonryTrackEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridLine(stream, context);
}
...
const CSSValue* MasonryTrackStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGridLine(stream, context);
}
...
const CSSValue* MathDepth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* MathDepth::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.MathDepth(), CSSPrimitiveValue::UnitType::kNumber);
}

void MathDepth::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    if (const auto* list = DynamicTo<CSSValueList>(value)) {
        DCHECK_EQ(list->length(), 1U);
        const auto& relative_value = To<CSSPrimitiveValue>(list->Item(0));
        builder.SetMathDepth(base::ClampAdd(state.ParentStyle()->MathDepth(), relative_value.ComputeInteger(state.CssToLengthConversionData())));
        ...
        builder.SetMathDepth(base::ClampAdd(state.ParentStyle()->MathDepth(), depth));
    } else if (DynamicTo<CSSPrimitiveValue>(value)) {
        builder.SetMathDepth(ClampTo<int16_t>(To<CSSPrimitiveValue>(value).ComputeInteger(state.CssToLengthConversionData())));
    }
}

const CSSValue* MaxBlockSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeMaxWidthOrHeight(stream, context);
}

const CSSValue* MaxHeight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* MaxInlineSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeMaxWidthOrHeight(stream, context);
}

const CSSValue* MaxWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeMaxWidthOrHeight(stream, context, css_parsing_utils::UnitlessQuirk::kAllow);
}
...
const CSSValue* MinBlockSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* MinHeight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context, css_parsing_utils::UnitlessQuirk::kAllow);
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.MinHeight(), style);
}

const CSSValue* MinInlineSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* MinWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context, css_parsing_utils::UnitlessQuirk::kAllow);
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.MinWidth(), style);
}
...
const CSSValue* ObjectPosition::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumePosition(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, std::optional<WebFeature>());
}

const CSSValue* ObjectPosition::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return MakeGarbageCollected<CSSValuePair>(ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.ObjectPosition().X(), style),
        ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.ObjectPosition().Y(), style), CSSValuePair::kKeepIdenticalValues);
}

const CSSValue* ObjectViewBox::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    if (!css_value || css_value->IsBasicShapeInsetValue() || css_value->IsBasicShapeRectValue() || css_value->IsBasicShapeXYWHValue()) {
        return css_value;
    }
...
const CSSValue* OffsetAnchor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
    if (id == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    return css_parsing_utils::ConsumePosition(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, std::optional<WebFeature>());
}
...
const CSSValue* OffsetDistance::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll);
}
...
const CSSValue* OffsetDistance::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.OffsetDistance(), style);
}

const CSSValue* OffsetPath::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (operation) {
        if (const auto* shape_operation = DynamicTo<ShapeOffsetPathOperation>(operation)) {
            CSSValueList* list = CSSValueList::CreateSpaceSeparated();
            CSSValue* shape = ValueForBasicShape(style, &shape_operation->GetBasicShape());
            list->Append(*shape);
        ...
        if (const auto* coord_box_operation = DynamicTo<CoordBoxOffsetPathOperation>(operation)) {
            CSSValueList* list = CSSValueList::CreateSpaceSeparated();
            CoordBox coord_box = coord_box_operation->GetCoordBox();
            list->Append(*CSSIdentifierValue::Create(coord_box));
            return list;
        }
        const auto& reference_operation = To<ReferenceOffsetPathOperation>(*operation);
        CSSValueList* list = CSSValueList::CreateSpaceSeparated();
...
const CSSValue* OffsetPosition::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
    if (id == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    ...
    CSSValue* value = css_parsing_utils::ConsumePosition(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, std::optional<WebFeature>());
...
const CSSValue* OffsetRotate::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    list->Append(*CSSNumericLiteralValue::Create(style.OffsetRotate().angle, CSSPrimitiveValue::UnitType::kDegrees));
    return list;
}

const CSSValue* Opacity::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeAlphaValue(stream, context);
}
...
const CSSValue* Opacity::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.Opacity(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* Order::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* Order::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.Order(), CSSPrimitiveValue::UnitType::kNumber);
}
...
const CSSValue* Orphans::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumePositiveInteger(stream, context);
}
...
const CSSValue* Orphans::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.Orphans(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* OutlineColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* AccentColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ValueForStyleAutoColor(style, style.AccentColor(), value_phase);
}

const blink::Color OutlineColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    const StyleColor& outline_color = style.OutlineColor();
    if (style.ShouldForceColor(outline_color)) {
        return GetCSSPropertyInternalForcedOutlineColor().ColorIncludingFallback(false, style, is_current_color);
    }
    return outline_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}
...
{
    const StyleColor& outline_color = style.OutlineColor();
    if (value_phase == CSSValuePhase::kResolvedValue && style.ShouldForceColor(outline_color)) {
        return GetCSSPropertyInternalForcedOutlineColor().CSSValueFromComputedStyle(style, nullptr, allow_visited_style, value_phase);
    }
    return allow_visited_style ? cssvalue::CSSColor::Create(style.VisitedDependentColor(*this))
                               : ComputedStyleUtils::CurrentColorOrValidColor(style, outline_color, value_phase);
}

const CSSValue* OutlineOffset::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    builder.SetOutlineStyleIsAuto(ComputedStyleInitialValues::InitialOutlineStyleIsAuto());
...
void OutlineStyle::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    const auto& identifier_value = To<CSSIdentifierValue>(value);
    builder.SetOutlineStyleIsAuto(static_cast<bool>(identifier_value.ConvertTo<OutlineIsAuto>()));
    builder.SetOutlineStyle(identifier_value.ConvertTo<EBorderStyle>());
}

const CSSValue* OutlineWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLineWidth(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (!style.OverflowClipMargin()) {
        css_value_list->Append(*CSSPrimitiveValue::CreateFromLength(Length::Fixed(0), 1.f));
        return css_value_list;
    }

    if (style.OverflowClipMargin()->GetReferenceBox() == StyleOverflowClipMargin::ReferenceBox::kPaddingBox
    ...
    if (style.OverflowClipMargin()->GetMargin() != LayoutUnit()) {
        css_value_list->Append(*ZoomAdjustedPixelValue(style.OverflowClipMargin()->GetMargin(), style));
    }
...
const CSSValue* OverflowClipMargin::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
void OverflowX::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    auto converted_value = To<CSSIdentifierValue>(value).ConvertTo<blink::EOverflow>();
...
void OverflowY::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    auto converted_value = To<CSSIdentifierValue>(value).ConvertTo<blink::EOverflow>();
...
bool PaddingBlockEnd::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* PaddingBlockEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kForbid);
}

bool PaddingBlockStart::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* PaddingBlockStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* PaddingBottom::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kAllow,
        kCSSAnchorQueryTypesNone, css_parsing_utils::AllowCalcSize::kForbid);
}

bool PaddingBottom::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox() && (!style || !style->PaddingBottom().IsFixed());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (padding_bottom.IsFixed() || !layout_object || !layout_object->IsBox()) {
        return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(padding_bottom, style);
    }
    return ZoomAdjustedPixelValue(To<LayoutBox>(layout_object)->ComputedCSSPaddingBottom(), style);
}

bool PaddingInlineEnd::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* PaddingInlineEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kForbid);
}

bool PaddingInlineStart::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}

const CSSValue* PaddingInlineStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* PaddingLeft::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kAllow,
        kCSSAnchorQueryTypesNone, css_parsing_utils::AllowCalcSize::kForbid);
}

bool PaddingLeft::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox() && (!style || !style->PaddingLeft().IsFixed());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (padding_left.IsFixed() || !layout_object || !layout_object->IsBox()) {
        return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(padding_left, style);
    }
    return ZoomAdjustedPixelValue(To<LayoutBox>(layout_object)->ComputedCSSPaddingLeft(), style);
}

const CSSValue* PaddingRight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kAllow,
        kCSSAnchorQueryTypesNone, css_parsing_utils::AllowCalcSize::kForbid);
}

bool PaddingRight::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox() && (!style || !style->PaddingRight().IsFixed());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (padding_right.IsFixed() || !layout_object || !layout_object->IsBox()) {
        return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(padding_right, style);
    }
    return ZoomAdjustedPixelValue(To<LayoutBox>(layout_object)->ComputedCSSPaddingRight(), style);
}

const CSSValue* PaddingTop::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kAllow,
        kCSSAnchorQueryTypesNone, css_parsing_utils::AllowCalcSize::kForbid);
}

bool PaddingTop::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox() && (!style || !style->PaddingTop().IsFixed());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (padding_top.IsFixed() || !layout_object || !layout_object->IsBox()) {
        return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(padding_top, style);
    }
    return ZoomAdjustedPixelValue(To<LayoutBox>(layout_object)->ComputedCSSPaddingTop(), style);
}

const CSSValue* Page::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* ViewTransitionName::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return RuntimeEnabledFeatures::CSSViewTransitionAutoNameEnabled() ? css_parsing_utils::ConsumeIdent(stream) : nullptr;
    }
    return css_parsing_utils::ConsumeCustomIdent(stream, context);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return MakeGarbageCollected<CSSCustomIdentValue>(style.ViewTransitionName()->CustomName());
}

const CSSValue* ViewTransitionClass::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    return css_parsing_utils::ConsumeSpaceSeparatedList(ConsumeCustomIdentExcludingNone, stream, context);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    for (const auto& class_name : view_transition_class->GetNames()) {
        auto* value = MakeGarbageCollected<CSSCustomIdentValue>(class_name->GetName());
...
const CSSValue* ViewTransitionGroup::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    auto id = stream.Peek().Id();
    if (id == CSSValueID::kNormal || id == CSSValueID::kNearest || id == CSSValueID::kContain) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    return css_parsing_utils::ConsumeCustomIdent(stream, context);
}

const CSSValue* ViewTransitionCaptureMode::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    auto id = stream.Peek().Id();
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return MakeGarbageCollected<CSSCustomIdentValue>(style.ViewTransitionGroup().CustomName());
}
...
const CSSValue* PaintOrder::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNormal) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    case CSSValueID::kStroke:
        paint_order_list->Append(first_paint_order_type == CSSValueID::kFill ? *fill : *stroke);
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    const unsigned canonical_length = PaintOrderArray::CanonicalLength(paint_order);
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
...
const CSSValue* Perspective::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& localContext) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    CSSPrimitiveValue* parsed_value = css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
...
const CSSValue* PerspectiveOrigin::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumePosition(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, std::optional<WebFeature>());
}

bool PerspectiveOrigin::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (layout_object) {
        ...
        return MakeGarbageCollected<CSSValuePair>(ZoomAdjustedPixelValue(MinimumValueForLength(style.PerspectiveOrigin().X(), box.Width()), style),
            ZoomAdjustedPixelValue(MinimumValueForLength(style.PerspectiveOrigin().Y(), box.Height()), style), CSSValuePair::kKeepIdenticalValues);
    } else {
        return MakeGarbageCollected<CSSValuePair>(ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.PerspectiveOrigin().X(), style),
            ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.PerspectiveOrigin().Y(), style), CSSValuePair::kKeepIdenticalValues);
    }
}
...
const CSSValue* PositionTryFallbacks::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* PositionTryFallbacks::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (const blink::PositionTryFallbacks* fallbacks = style.GetPositionTryFallbacks()) {
        return ComputedStyleUtils::ValueForPositionTryFallbacks(*fallbacks);
    }
    return CSSIdentifierValue::Create(CSSValueID::kNone);
}

void PositionTryFallbacks::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ...
    for (const auto& fallback : To<CSSValueList>(value)) {
        ...
        if (const auto* function = DynamicTo<CSSFunctionValue>(fallback.Get())) {
            ...
            blink::PositionArea position_area = StyleBuilderConverter::ConvertPositionArea(state, function->First());
            fallbacks.push_back(PositionTryFallback(position_area));
            continue;
        }
        // <'position-area'>
        if (IsA<CSSValuePair>(fallback.Get()) || IsA<CSSIdentifierValue>(fallback.Get())) {
            blink::PositionArea position_area = StyleBuilderConverter::ConvertPositionArea(state, *fallback.Get());
            fallbacks.push_back(PositionTryFallback(position_area));
            continue;
        }
        ...
        for (const auto& name_or_tactic : To<CSSValueList>(*fallback)) {
            ...
            tactic_list[tactic_index++] = To<CSSIdentifierValue>(*name_or_tactic).ConvertTo<TryTactic>();
        }
        fallbacks.push_back(PositionTryFallback(scoped_name, tactic_list));
    }
    DCHECK(!fallbacks.empty());
    state.StyleBuilder().SetPositionTryFallbacks(MakeGarbageCollected<blink::PositionTryFallbacks>(fallbacks));
}
...
const CSSValue* Quotes::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (style.Quotes()->size()) {
        ...
        for (int i = 0; i < style.Quotes()->size(); i++) {
            list->Append(*MakeGarbageCollected<CSSStringValue>(style.Quotes()->GetOpenQuote(i)));
            list->Append(*MakeGarbageCollected<CSSStringValue>(style.Quotes()->GetCloseQuote(i)));
        }
        return list;
    }
    return CSSIdentifierValue::Create(CSSValueID::kNone);
...
const CSSValue* R::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSVGGeometryPropertyLength(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}

const CSSValue* R::CSSValueFromComputedStyleInternal(const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.R(), style);
}

const CSSValue* ReadingFlow::CSSValueFromComputedStyleInternal(const ComputedStyle& style, const LayoutObject*, bool, CSSValuePhase) const
{
...
void Resize::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    const CSSIdentifierValue& identifier_value = To<CSSIdentifierValue>(value);

    EResize r = EResize::kNone;
    if (identifier_value.GetValueID() == CSSValueID::kAuto || identifier_value.GetValueID() == CSSValueID::kInternalTextareaAuto) {
        if (Settings* settings = state.GetDocument().GetSettings()) {
            r = settings->GetTextAreasAreResizable() ? EResize::kBoth : EResize::kNone;
        }
...
const CSSValue* Right::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessUnlessShorthand(local_context), anchor_types);
...
bool Right::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}
...
const CSSValue* Rotate::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
    if (id == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    ...
    CSSValue* rotation = css_parsing_utils::ConsumeAngle(stream, context, std::optional<WebFeature>());
    ...
    if (!rotation) {
        rotation = css_parsing_utils::ConsumeAngle(stream, context, std::optional<WebFeature>());
        if (!rotation) {
            return nullptr;
        }
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (style.Rotate()->X() != 0 || style.Rotate()->Y() != 0 || style.Rotate()->Z() != 1) {
        const cssvalue::CSSAxisValue* axis = MakeGarbageCollected<cssvalue::CSSAxisValue>(
            MakeGarbageCollected<CSSNumericLiteralValue>(style.Rotate()->X(), CSSPrimitiveValue::UnitType::kNumber),
            MakeGarbageCollected<CSSNumericLiteralValue>(style.Rotate()->Y(), CSSPrimitiveValue::UnitType::kNumber),
            MakeGarbageCollected<CSSNumericLiteralValue>(style.Rotate()->Z(), CSSPrimitiveValue::UnitType::kNumber));
        list->Append(*axis);
    }
    list->Append(*CSSNumericLiteralValue::Create(style.Rotate()->Angle(), CSSPrimitiveValue::UnitType::kDegrees));
    return list;
}

const CSSValue* RowGap::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeGapLength(stream, context);
}
...
const CSSValue* Rx::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* Ry::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* Scale::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
    if (id == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    ...
    CSSPrimitiveValue* x_scale = css_parsing_utils::ConsumeNumberOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll);
    if (!x_scale) {
        return nullptr;
    }
    ...
    CSSPrimitiveValue* y_scale = css_parsing_utils::ConsumeNumberOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll);
    if (y_scale) {
        CSSPrimitiveValue* z_scale = css_parsing_utils::ConsumeNumberOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll);
        if (z_scale && (!z_scale->IsNumericLiteralValue() || To<CSSNumericLiteralValue>(z_scale)->DoubleValue() != 1.0)) {
            list->Append(*y_scale);
            list->Append(*z_scale);
        } else if (!x_scale->IsNumericLiteralValue() || !y_scale->IsNumericLiteralValue()
            || To<CSSNumericLiteralValue>(x_scale)->DoubleValue() != To<CSSNumericLiteralValue>(y_scale)->DoubleValue()) {
            list->Append(*y_scale);
        }
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    list->Append(*CSSNumericLiteralValue::Create(scale->X(), CSSPrimitiveValue::UnitType::kNumber));

    if (scale->Z() == 1) {
        if (scale->X() != scale->Y()) {
            list->Append(*CSSNumericLiteralValue::Create(scale->Y(), CSSPrimitiveValue::UnitType::kNumber));
        }
    } else {
        list->Append(*CSSNumericLiteralValue::Create(scale->Y(), CSSPrimitiveValue::UnitType::kNumber));
        list->Append(*CSSNumericLiteralValue::Create(scale->Z(), CSSNumericLiteralValue::UnitType::kNumber));
    }
    return list;
}
...
// auto | <color>{2}
const CSSValue* ScrollbarColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    list->Append(*ComputedStyleUtils::CurrentColorOrValidColor(style, scrollbar_color->GetThumbColor(), value_phase));
    list->Append(*ComputedStyleUtils::CurrentColorOrValidColor(style, scrollbar_color->GetTrackColor(), value_phase));
    return list;
}

// https://www.w3.org/TR/css-overflow-4
// auto | stable && both-edges?
const CSSValue* ScrollbarGutter::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (auto* value = css_parsing_utils::ConsumeIdent<CSSValueID::kAuto>(stream)) {
        return value;
    }
    ...
    while (!stream.AtEnd()) {
        if (!stable) {
            if ((stable = css_parsing_utils::ConsumeIdent<CSSValueID::kStable>(stream))) {
                continue;
            }
        }
        CSSValueID id = stream.Peek().Id();
...
const CSSValue* ScrollMarginBlockEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* ScrollMarginBlockStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* ScrollMarginBottom::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const CSSValue* ScrollMarginInlineEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* ScrollMarginInlineStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* ScrollMarginLeft::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const CSSValue* ScrollMarginRight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const CSSValue* ScrollMarginTop::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const CSSValue* ScrollPaddingBlockEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}

const CSSValue* ScrollPaddingBlockStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}

const CSSValue* ScrollPaddingBottom::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}
...
const CSSValue* ScrollPaddingBottom::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.ScrollPaddingBottom(), style);
}

const CSSValue* ScrollPaddingInlineEnd::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}

const CSSValue* ScrollPaddingInlineStart::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}

const CSSValue* ScrollPaddingLeft::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}
...
const CSSValue* ScrollPaddingLeft::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.ScrollPaddingLeft(), style);
}

const CSSValue* ScrollPaddingRight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}
...
const CSSValue* ScrollPaddingRight::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.ScrollPaddingRight(), style);
}

const CSSValue* ScrollPaddingTop::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollPadding(stream, context);
}
...
const CSSValue* ScrollPaddingTop::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.ScrollPaddingTop(), style);
}

const CSSValue* ScrollSnapAlign::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValue* block_value = css_parsing_utils::ConsumeIdent<CSSValueID::kNone, CSSValueID::kStart, CSSValueID::kEnd, CSSValueID::kCenter>(stream);
    if (!block_value) {
        return nullptr;
    }

    CSSValue* inline_value = css_parsing_utils::ConsumeIdent<CSSValueID::kNone, CSSValueID::kStart, CSSValueID::kEnd, CSSValueID::kCenter>(stream);
    if (!inline_value) {
        return block_value;
    }
    auto* pair = MakeGarbageCollected<CSSValuePair>(block_value, inline_value, CSSValuePair::kDropIdenticalValues);
    return pair;
}
...
const CSSValue* ScrollSnapAlign::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForScrollSnapAlign(style.GetScrollSnapAlign(), style);
}
...
const CSSValue* ScrollSnapType::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID axis_id = stream.Peek().Id();
    if (axis_id != CSSValueID::kNone && axis_id != CSSValueID::kX && axis_id != CSSValueID::kY && axis_id != CSSValueID::kBlock
    ...
    if (strictness_id != CSSValueID::kProximity && strictness_id != CSSValueID::kMandatory) {
        return axis_value;
    }
    ...
    auto* pair = MakeGarbageCollected<CSSValuePair>(axis_value, strictness_value, CSSValuePair::kDropIdenticalValues);
    return pair;
}
...
const CSSValue* ScrollSnapType::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForScrollSnapType(style.GetScrollSnapType(), style);
}

const CSSValue* ScrollStartBlock::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollStart(stream, context);
}

const CSSValue* ScrollStartInline::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollStart(stream, context);
}

const CSSValue* ScrollStartX::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollStart(stream, context);
}
...
const CSSValue* ScrollStartY::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeScrollStart(stream, context);
}
...
const CSSValue* ScrollTimelineAxis::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ScrollTimelineName::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    using css_parsing_utils::ConsumeCommaSeparatedList;
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateCommaSeparated();
    for (const Member<const ScopedCSSName>& name : style.ScrollTimelineName()->GetNames()) {
        list->Append(*ComputedStyleUtils::ValueForCustomIdentOrNone(name.Get()));
    }
    return list;
}
...
const CSSValue* ShapeImageThreshold::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeAlphaValue(stream, context);
}
...
const CSSValue* ShapeImageThreshold::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.ShapeImageThreshold(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* ShapeMargin::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* ShapeOutside::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (CSSValue* image_value = css_parsing_utils::ConsumeImageOrNone(stream, context)) {
        return image_value;
    }
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    CSSValue* box_value = css_parsing_utils::ConsumeShapeBox(stream);
    CSSValue* shape_value = css_parsing_utils::ConsumeBasicShape(stream, context, css_parsing_utils::AllowPathValue::kForbid,
        css_parsing_utils::AllowBasicShapeRectValue::kForbid, css_parsing_utils::AllowBasicShapeXYWHValue::kForbid);
    if (shape_value) {
    ...
    if (box_value) {
        if (!shape_value || To<CSSIdentifierValue>(box_value)->GetValueID() != CSSValueID::kMarginBox) {
...
const CSSValue* ShapeOutside::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForShape(style, allow_visited_style, style.ShapeOutside(), value_phase);
}
...
{
    return css_parsing_utils::ConsumeIdent<CSSValueID::kA3, CSSValueID::kA4, CSSValueID::kA5, CSSValueID::kB4, CSSValueID::kB5, CSSValueID::kJisB5,
        CSSValueID::kJisB4, CSSValueID::kLedger, CSSValueID::kLegal, CSSValueID::kLetter>(stream);
}
...
const CSSValue* Size::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    if (CSSValue* width = css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative)) {
        CSSValue* height = css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        result->Append(*width);
        if (height) {
    ...
    CSSValue* orientation = css_parsing_utils::ConsumeIdent<CSSValueID::kPortrait, CSSValueID::kLandscape>(stream);
    if (!page_size) {
...
void Size::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    ...
    if (list.length() == 2) {
        ...
        if (first_primitive_value && first_primitive_value->IsLength()) {
            CSSToLengthConversionData unzoomed_conversion_data = state.CssToLengthConversionData().Unzoomed();
            // <length>{2}
            size = gfx::SizeF(first_primitive_value->ComputeLength<float>(unzoomed_conversion_data),
                To<CSSPrimitiveValue>(second).ComputeLength<float>(unzoomed_conversion_data));
        } else {
            // <page-size> <orientation>
            size = GetPageSizeFromName(To<CSSIdentifierValue>(first));

            DCHECK(
                To<CSSIdentifierValue>(second).GetValueID() == CSSValueID::kLandscape || To<CSSIdentifierValue>(second).GetValueID() == CSSValueID::kPortrait);
        ...
        if (first_primitive_value && first_primitive_value->IsLength()) {
            // <length>
            page_size_type = PageSizeType::kFixed;
            float width = first_primitive_value->ComputeLength<float>(state.CssToLengthConversionData().Unzoomed());
...
const CSSValue* StopColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color StopColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
...
const CSSValue* StopColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.StopColor(), value_phase);
}

const CSSValue* StopOpacity::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeAlphaValue(stream, context);
}
...
const CSSValue* StopOpacity::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.StopOpacity(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* Stroke::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSVGPaint(stream, context);
}
...
const blink::Color Stroke::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return stroke_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}

void Stroke::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.StyleBuilder().SetStrokePaint(StyleBuilderConverter::ConvertSVGPaint(state, value, false, PropertyID()));
}

const CSSValue* StrokeDasharray::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    for (;;) {
        CSSPrimitiveValue* dash = css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
        if (!dash) {
            if (need_next_value) {
                return nullptr;
            } else {
        ...
        dashes->Append(*dash);
        need_next_value = css_parsing_utils::ConsumeCommaIncludingWhitespace(stream);
    }
    return dashes;
}
...
const CSSValue* StrokeDasharray::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::StrokeDashArrayToCSSValueList(*style.StrokeDashArray(), style);
}

const CSSValue* StrokeDashoffset::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSParserContext::ParserModeOverridingScope scope(context, kSVGAttributeMode);
    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
}

const CSSValue* StrokeDashoffset::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.StrokeDashOffset(), style);
}
...
const CSSValue* StrokeMiterlimit::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeNumber(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}
...
const CSSValue* StrokeMiterlimit::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.StrokeMiterLimit(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* StrokeOpacity::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeAlphaValue(stream, context);
}
...
const CSSValue* StrokeOpacity::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.StrokeOpacity(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* StrokeWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSParserContext::ParserModeOverridingScope scope(context, kSVGAttributeMode);
    return css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const CSSValue* ContentVisibility::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeIdent<CSSValueID::kVisible, CSSValueID::kAuto, CSSValueID::kHidden>(stream);
}

const CSSValue* TabSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSPrimitiveValue* parsed_value = css_parsing_utils::ConsumeNumber(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
    if (parsed_value) {
        return parsed_value;
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(
        style.GetTabSize().GetPixelSize(1.0), style.GetTabSize().IsSpaces() ? CSSPrimitiveValue::UnitType::kNumber : CSSPrimitiveValue::UnitType::kPixels);
}
...
void TextAlign::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    ...
    if (ident_value && ident_value->GetValueID() != CSSValueID::kWebkitMatchParent) {
        ...
        if (ident_value->GetValueID() == CSSValueID::kInternalCenter && state.ParentStyle()->GetTextAlign() != ComputedStyleInitialValues::InitialTextAlign()) {
        ...
        builder.SetTextAlign(state.ParentStyle()->IsLeftToRightDirection() ? ETextAlign::kLeft : ETextAlign::kRight);
    } else if (state.ParentStyle()->GetTextAlign() == ETextAlign::kEnd) {
        builder.SetTextAlign(state.ParentStyle()->IsLeftToRightDirection() ? ETextAlign::kRight : ETextAlign::kLeft);
    } else {
        builder.SetTextAlign(state.ParentStyle()->GetTextAlign());
    }
}
...
const CSSValue* TextBoxEdge::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* TextDecorationColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color TextDecorationColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    const StyleColor& decoration_color = style.DecorationColorIncludingFallback(visited_link);
    if (style.ShouldForceColor(decoration_color)) {
        return style.GetInternalForcedCurrentColor(is_current_color);
    }
    return decoration_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const CSSValue* TextDecorationColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.TextDecorationColor(), value_phase);
}

const CSSValue* TextDecorationLine::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
...
const CSSValue* TextDecorationLine::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::RenderTextDecorationFlagsToCSSValue(style.GetTextDecorationLine());
}

const CSSValue* TextDecorationSkipInk::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForTextDecorationSkipInk(style.TextDecorationSkipInk());
}

const CSSValue* TextDecorationStyle::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForTextDecorationStyle(style.TextDecorationStyle());
}

const CSSValue* TextDecorationThickness::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.GetTextDecorationThickness().Thickness(), style);
}

const CSSValue* TextIndent::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    // [ <length> | <percentage> ]
    CSSValue* length_percentage
        = css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kAllow);
...
{
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    list->Append(*ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.TextIndent(), style));
    return list;
}

void TextIndent::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
...
{
    state.SetTextOrientation(ComputedStyleInitialValues::InitialTextOrientation());
}
...
void TextOrientation::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    state.SetTextOrientation(To<CSSIdentifierValue>(value).ConvertTo<ETextOrientation>());
}
...
const CSSValue* TextShadow::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* TextShadow::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForShadowList(style.TextShadow(), style, false, value_phase);
}

const CSSValue* TextSizeAdjust::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return CSSNumericLiteralValue::Create(style.GetTextSizeAdjust().Multiplier() * 100, CSSPrimitiveValue::UnitType::kPercentage);
}

const CSSValue* TextSpacingTrim::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create(style.GetFontDescription().GetTextSpacingTrim());
}
...
const CSSValue* TextUnderlinePosition::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }

    CSSIdentifierValue* from_font_or_under_value = css_parsing_utils::ConsumeIdent<CSSValueID::kFromFont, CSSValueID::kUnder>(stream);
    CSSIdentifierValue* left_or_right_value = css_parsing_utils::ConsumeIdent<CSSValueID::kLeft, CSSValueID::kRight>(stream);
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    if (EnumHasFlags(text_underline_position, blink::TextUnderlinePosition::kFromFont)) {
        list->Append(*CSSIdentifierValue::Create(CSSValueID::kFromFont));
    } else {
        DCHECK(EnumHasFlags(text_underline_position, blink::TextUnderlinePosition::kUnder));
        list->Append(*CSSIdentifierValue::Create(CSSValueID::kUnder));
    }
    if (EnumHasFlags(text_underline_position, blink::TextUnderlinePosition::kLeft)) {
        list->Append(*CSSIdentifierValue::Create(CSSValueID::kLeft));
    }
    if (EnumHasFlags(text_underline_position, blink::TextUnderlinePosition::kRight)) {
...
const CSSValue* TextUnderlineOffset::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* TextUnderlineOffset::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.TextUnderlineOffset(), style);
}

const CSSValue* Top::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    CSSAnchorQueryTypes anchor_types
        = RuntimeEnabledFeatures::CSSAnchorSizeInsetsMarginsEnabled() ? kCSSAnchorQueryTypesAll : static_cast<CSSAnchorQueryTypes>(CSSAnchorQueryType::kAnchor);
    return css_parsing_utils::ConsumeMarginOrOffset(stream, context, css_parsing_utils::UnitlessUnlessShorthand(local_context), anchor_types);
...
bool Top::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}
...
static bool ConsumePan(CSSParserTokenStream& stream, CSSValue*& pan_x, CSSValue*& pan_y, CSSValue*& pinch_zoom)
{
    CSSValueID id = stream.Peek().Id();
...
const CSSValue* TouchAction::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    CSSValueID id = stream.Peek().Id();
...
const CSSValue* Transform::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    return css_parsing_utils::ConsumeTransformList(stream, context, local_context);
}

bool Transform::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && (layout_object->IsBox() || layout_object->IsSVGChild());
}
...
const CSSValue* TransformOrigin::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValue* result_x = nullptr;
    CSSValue* result_y = nullptr;
    if (css_parsing_utils::ConsumeOneOrTwoValuedPosition(stream, context, css_parsing_utils::UnitlessQuirk::kForbid, result_x, result_y)) {
        CSSValueList* list = CSSValueList::CreateSpaceSeparated();
        list->Append(*result_x);
        list->Append(*result_y);
        CSSValue* result_z = css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll);
        if (result_z) {
...
bool TransformOrigin::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && (layout_object->IsBox() || layout_object->IsSVGChild());
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    if (layout_object) {
        gfx::RectF reference_box = ComputedStyleUtils::ReferenceBoxForTransform(*layout_object);
        gfx::PointF resolved_origin(FloatValueForLength(style.GetTransformOrigin().X(), reference_box.width()),
            FloatValueForLength(style.GetTransformOrigin().Y(), reference_box.height()));
        list->Append(*ZoomAdjustedPixelValue(resolved_origin.x(), style));
        list->Append(*ZoomAdjustedPixelValue(resolved_origin.y(), style));
    } else {
        list->Append(*ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.GetTransformOrigin().X(), style));
        list->Append(*ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.GetTransformOrigin().Y(), style));
    }
    if (style.GetTransformOrigin().Z() != 0) {
        list->Append(*ZoomAdjustedPixelValue(style.GetTransformOrigin().Z(), style));
    }
    return list;
}
...
const CSSValue* TransformStyle::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create((style.TransformStyle3D() == ETransformStyle3D::kPreserve3d) ? CSSValueID::kPreserve3d : CSSValueID::kFlat);
}

const CSSValue* TransitionDelay::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(
        static_cast<CSSPrimitiveValue* (*)(CSSParserTokenStream&, const CSSParserContext&, CSSPrimitiveValue::ValueRange)>(css_parsing_utils::ConsumeTime),
        stream, context, CSSPrimitiveValue::ValueRange::kAll);
...
const CSSValue* TransitionDuration::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(
        static_cast<CSSPrimitiveValue* (*)(CSSParserTokenStream&, const CSSParserContext&, CSSPrimitiveValue::ValueRange)>(css_parsing_utils::ConsumeTime),
...
const CSSValue* TransitionDuration::InitialValue() const
{
    DEFINE_STATIC_LOCAL(const Persistent<CSSValue>, value,
        (CSSNumericLiteralValue::Create(CSSTransitionData::InitialDuration().value(), CSSPrimitiveValue::UnitType::kSeconds)));
    return value;
}

const CSSValue* TransitionProperty::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueList* list = css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeTransitionProperty, stream, context);
...
namespace {
CSSIdentifierValue* ConsumeIdentNoTemplate(CSSParserTokenStream& stream, const CSSParserContext&)
{
    return css_parsing_utils::ConsumeIdent(stream);
}
} // namespace

const CSSValue* TransitionBehavior::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueList* list = css_parsing_utils::ConsumeCommaSeparatedList(ConsumeIdentNoTemplate, stream, context);
...
const CSSValue* TransitionTimingFunction::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeAnimationTimingFunction, stream, context);
}
...
const CSSValue* TransitionTimingFunction::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForAnimationTimingFunctionList(style.Transitions());
}
...
const CSSValue* Translate::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
    if (id == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    ...
    CSSValue* translate_x = css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll);
    if (!translate_x) {
        return nullptr;
    }
    CSSValueList* list = CSSValueList::CreateSpaceSeparated();
    list->Append(*translate_x);
    CSSPrimitiveValue* translate_y = css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll);
    if (translate_y) {
        CSSPrimitiveValue* translate_z = css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll);

        if (translate_z && translate_z->IsZero() == CSSPrimitiveValue::BoolStatus::kTrue) {
            translate_z = nullptr;
        }
        if (translate_y->IsZero() == CSSPrimitiveValue::BoolStatus::kTrue && !translate_y->HasPercentage() && !translate_z) {
            return list;
        }
...
bool Translate::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && layout_object->IsBox();
}
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    if (!y.IsZero() || y.HasPercent() || z != 0) {
        list->Append(*ComputedStyleUtils::ZoomAdjustedPixelValueForLength(y, style));
    }
...
const CSSValue* VerticalAlign::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValue* parsed_value = css_parsing_utils::ConsumeIdentRange(stream, CSSValueID::kBaseline, CSSValueID::kWebkitBaselineMiddle);
    if (!parsed_value) {
        parsed_value
            = css_parsing_utils::ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kAllow);
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    case EVerticalAlign::kLength:
        return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.GetVerticalAlignLength(), style);
    }
    NOTREACHED();
}
...
void VerticalAlign::ApplyInherit(StyleResolverState& state) const
{
    ...
    if (vertical_align == EVerticalAlign::kLength) {
        builder.SetVerticalAlignLength(state.ParentStyle()->GetVerticalAlignLength());
    }
}

void VerticalAlign::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
    if (auto* identifier_value = DynamicTo<CSSIdentifierValue>(value)) {
...
const CSSValue* ViewTimelineAxis::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    using css_parsing_utils::ConsumeCommaSeparatedList;
    using css_parsing_utils::ConsumeSingleTimelineAxis;
    return ConsumeCommaSeparatedList(ConsumeSingleTimelineAxis, stream);
...
const CSSValue* ViewTimelineInset::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    using css_parsing_utils::ConsumeCommaSeparatedList;
...
const CSSValue* ViewTimelineName::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    using css_parsing_utils::ConsumeCommaSeparatedList;
    using css_parsing_utils::ConsumeSingleTimelineName;
    return ConsumeCommaSeparatedList(ConsumeSingleTimelineName, stream, context);
    ...
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateCommaSeparated();
    for (const Member<const ScopedCSSName>& name : style.ViewTimelineName()->GetNames()) {
        list->Append(*ComputedStyleUtils::ValueForCustomIdentOrNone(name.Get()));
    }
    return list;
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return CSSIdentifierValue::Create(style.DraggableRegionMode() == EDraggableRegionMode::kDrag ? CSSValueID::kDrag : CSSValueID::kNoDrag);
}
...
void AppRegion::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    const auto& identifier_value = To<CSSIdentifierValue>(value);
    state.StyleBuilder().SetDraggableRegionMode(
        identifier_value.GetValueID() == CSSValueID::kDrag ? EDraggableRegionMode::kDrag : EDraggableRegionMode::kNoDrag);
    state.GetDocument().SetHasDraggableRegions(true);
}

const CSSValue* Appearance::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    CSSValueID id = stream.Peek().Id();
...
const CSSValue* WebkitBorderHorizontalSpacing::ParseSingleValue(
    CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}

const CSSValue* WebkitBorderHorizontalSpacing::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ZoomAdjustedPixelValue(style.HorizontalBorderSpacing(), style);
}

const CSSValue* WebkitBorderImage::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* WebkitBorderImage::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForNinePieceImage(style.BorderImage(), style, allow_visited_style, value_phase);
}

void WebkitBorderImage::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    NinePieceImage image;
    CSSToStyleMap::MapNinePieceImage(state, CSSPropertyID::kWebkitBorderImage, value, image);
    state.StyleBuilder().SetBorderImage(image);
}

const CSSValue* WebkitBorderVerticalSpacing::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kNonNegative);
}
...
const CSSValue* WebkitBoxDecorationBreak::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject* layout_object, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return GetCSSPropertyBoxDecorationBreak().CSSValueFromComputedStyleInternal(style, layout_object, allow_visited_style, value_phase);
}
...
const CSSValue* WebkitBoxFlex::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* WebkitBoxFlex::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.BoxFlex(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* WebkitBoxOrdinalGroup::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumePositiveInteger(stream, context);
}
...
const CSSValue* WebkitBoxOrdinalGroup::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.BoxOrdinalGroup(), CSSPrimitiveValue::UnitType::kNumber);
}
...
CSSValue* ConsumeReflect(CSSParserTokenStream& stream, const CSSParserContext& context)
{
    CSSIdentifierValue* direction = css_parsing_utils::ConsumeIdent<CSSValueID::kAbove, CSSValueID::kBelow, CSSValueID::kLeft, CSSValueID::kRight>(stream);
    if (!direction) {
        return nullptr;
    }

    CSSPrimitiveValue* offset = ConsumeLengthOrPercent(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kForbid);
    if (!offset) {
    ...
    CSSValue* mask_or_null = css_parsing_utils::ConsumeWebkitBorderImage(stream, context);
    return MakeGarbageCollected<cssvalue::CSSReflectValue>(direction, offset, mask_or_null);
}

} // namespace

const CSSValue* WebkitBoxReflect::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* WebkitBoxReflect::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForReflection(style.BoxReflect(), style, allow_visited_style, value_phase);
}

const CSSValue* InternalFontSizeDelta::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll, css_parsing_utils::UnitlessQuirk::kAllow);
}
...
const CSSValue* HyphenateCharacter::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
const CSSValue* WebkitLineClamp::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    } else {
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return CSSNumericLiteralValue::Create(style.WebkitLineClamp(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* WebkitLocale::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
...
void WebkitLocale::ApplyValue(StyleResolverState& state, const CSSValue& value, ValueMode) const
{
    if (auto* identifier_value = DynamicTo<CSSIdentifierValue>(value)) {
        DCHECK_EQ(identifier_value->GetValueID(), CSSValueID::kAuto);
        state.GetFontBuilder().SetLocale(nullptr);
    } else {
        state.GetFontBuilder().SetLocale(LayoutLocale::Get(AtomicString(To<CSSStringValue>(value).Value())));
    }
}

const CSSValue* WebkitMaskBoxImageOutset::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderImageOutset(stream, context);
}
...
const CSSValue* WebkitMaskBoxImageOutset::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForNinePieceImageQuad(style.MaskBoxImage().Outset(), style);
}

const CSSValue* WebkitMaskBoxImageRepeat::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderImageRepeat(stream);
}
...
const CSSValue* WebkitMaskBoxImageSlice::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderImageSlice(stream, context, css_parsing_utils::DefaultFill::kNoFill);
}
...
const CSSValue* WebkitMaskBoxImageSource::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeImageOrNone(stream, context);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    if (style.MaskBoxImageSource()) {
        return style.MaskBoxImageSource()->ComputedCSSValue(style, allow_visited_style, value_phase);
    }
    return CSSIdentifierValue::Create(CSSValueID::kNone);
}
...
const CSSValue* WebkitMaskBoxImageWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeBorderImageWidth(stream, context);
}
...
const CSSValue* WebkitMaskBoxImageWidth::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForNinePieceImageQuad(style.MaskBoxImage().BorderSlices(), style);
}

const CSSValue* MaskClip::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext& local_context) const
{
    if (local_context.UseAliasParsing()) {
        return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumePrefixedBackgroundBox, stream, css_parsing_utils::AllowTextValue::kAllow);
    }
...
const CSSValue* MaskComposite::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext& local_context) const
{
    if (local_context.UseAliasParsing()) {
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    const FillLayer* curr_layer = &style.MaskLayers();
    for (; curr_layer; curr_layer = curr_layer->Next()) {
        list->Append(*CSSIdentifierValue::Create(curr_layer->CompositingOperator()));
    }
    return list;
}
...
const CSSValue* MaskImage::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumeImageOrNone, stream, context);
}
...
const CSSValue* MaskMode::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
...
const CSSValue* MaskOrigin::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext& local_context) const
{
    if (local_context.UseAliasParsing()) {
        return css_parsing_utils::ConsumeCommaSeparatedList(
            css_parsing_utils::ConsumePrefixedBackgroundBox, stream, css_parsing_utils::AllowTextValue::kForbid);
    }
...
const CSSValue* WebkitMaskPositionX::ParseSingleValue(CSSParserTokenStream& Stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumePositionLonghand<CSSValueID::kLeft, CSSValueID::kRight>, Stream, context);
}
...
const CSSValue* WebkitMaskPositionY::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeCommaSeparatedList(css_parsing_utils::ConsumePositionLonghand<CSSValueID::kTop, CSSValueID::kBottom>, stream, context);
}
...
const CSSValue* MaskRepeat::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    return css_parsing_utils::ParseRepeatStyle(stream);
}
...
{
    return MakeGarbageCollected<CSSRepeatStyleValue>(CSSIdentifierValue::Create(CSSValueID::kRepeat));
}

const CSSValue* MaskSize::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext& local_context) const
{
    return css_parsing_utils::ParseMaskSize(stream, context, local_context, WebFeature::kNegativeMaskSize);
}
...
const CSSValue* WebkitPerspectiveOriginX::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* WebkitPerspectiveOriginY::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
{
    state.StyleBuilder().SetPerspectiveOriginY(state.ParentStyle()->PerspectiveOrigin().Y());
}
...
const CSSValue* WebkitRtlOrdering::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSIdentifierValue::Create(style.RtlOrdering() == EOrder::kVisual ? CSSValueID::kVisual : CSSValueID::kLogical);
}
...
const CSSValue* RubyPosition::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
...
const CSSValue* WebkitTapHighlightColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color WebkitTapHighlightColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    const StyleColor& highlight_color = style.TapHighlightColor();
    if (style.ShouldForceColor(highlight_color)) {
        return visited_link ? style.GetInternalForcedVisitedCurrentColor(is_current_color) : style.GetInternalForcedCurrentColor(is_current_color);
    }
...
const CSSValue* WebkitTapHighlightColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.TapHighlightColor(), value_phase);
}
...
const CSSValue* WebkitTextDecorationsInEffect::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeTextDecorationLine(stream);
}

const CSSValue* WebkitTextDecorationsInEffect::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::RenderTextDecorationFlagsToCSSValue(style.TextDecorationsInEffect());
}

const CSSValue* TextEmphasisColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color TextEmphasisColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return text_emphasis_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const CSSValue* TextEmphasisColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.TextEmphasisColor(), value_phase);
}

// [ over | under ] && [ right | left ]?
// If [ right | left ] is omitted, it defaults to right.
const CSSValue* TextEmphasisPosition::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSIdentifierValue* values[2]
        = { css_parsing_utils::ConsumeIdent<CSSValueID::kOver, CSSValueID::kUnder, CSSValueID::kRight, CSSValueID::kLeft>(stream), nullptr };
    if (!values[0]) {
        return nullptr;
    }
    values[1] = css_parsing_utils::ConsumeIdent<CSSValueID::kOver, CSSValueID::kUnder, CSSValueID::kRight, CSSValueID::kLeft>(stream);
...
const CSSValue* TextEmphasisStyle::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    CSSValueID id = stream.Peek().Id();
    if (id == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    ...
    if (CSSValue* text_emphasis_style = css_parsing_utils::ConsumeString(stream)) {
        return text_emphasis_style;
    }

    CSSIdentifierValue* fill = css_parsing_utils::ConsumeIdent<CSSValueID::kFilled, CSSValueID::kOpen>(stream);
    CSSIdentifierValue* shape
        = css_parsing_utils::ConsumeIdent<CSSValueID::kDot, CSSValueID::kCircle, CSSValueID::kDoubleCircle, CSSValueID::kTriangle, CSSValueID::kSesame>(stream);
    if (!fill) {
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    case TextEmphasisMark::kCustom:
        return MakeGarbageCollected<CSSStringValue>(style.TextEmphasisCustomMark());
...
void TextEmphasisStyle::ApplyInherit(StyleResolverState& state) const
{
    ...
    builder.SetTextEmphasisCustomMark(state.ParentStyle()->TextEmphasisCustomMark());
}

void TextEmphasisStyle::ApplyValue(StyleResolverState& state, const CSSValue& in_value, ValueMode) const
{
    ComputedStyleBuilder& builder = state.StyleBuilder();
...
const CSSValue* WebkitTextFillColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color WebkitTextFillColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return text_fill_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const CSSValue* WebkitTextFillColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.TextFillColor(), value_phase);
}
...
const CSSValue* WebkitTextStrokeColor::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeColor(stream, context);
}

const blink::Color WebkitTextStrokeColor::ColorIncludingFallback(bool visited_link, const ComputedStyle& style, bool* is_current_color) const
{
    DCHECK(!visited_link);
    ...
    return text_stroke_color.Resolve(style.GetCurrentColor(), style.UsedColorScheme(), is_current_color);
}

const CSSValue* WebkitTextStrokeColor::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::CurrentColorOrValidColor(style, style.TextStrokeColor(), value_phase);
}

const CSSValue* WebkitTextStrokeWidth::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLineWidth(stream, context, css_parsing_utils::UnitlessQuirk::kForbid);
}
...
const CSSValue* TimelineScope::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kNone) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    return ConsumeCommaSeparatedList<CSSCustomIdentValue*(CSSParserTokenStream&, const CSSParserContext&)>(ConsumeCustomIdent, stream, context);
}
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    CSSValueList* list = CSSValueList::CreateCommaSeparated();
    for (const Member<const ScopedCSSName>& name : style.TimelineScope()->GetNames()) {
        list->Append(*MakeGarbageCollected<CSSCustomIdentValue>(name->GetName()));
    }
    return list;
}

const CSSValue* WebkitTransformOriginX::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumePositionLonghand<CSSValueID::kLeft, CSSValueID::kRight>(stream, context);
}
...
{
    state.StyleBuilder().SetTransformOriginX(state.ParentStyle()->GetTransformOrigin().X());
}
...
const CSSValue* WebkitTransformOriginY::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumePositionLonghand<CSSValueID::kTop, CSSValueID::kBottom>(stream, context);
}
...
const CSSValue* WebkitTransformOriginZ::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeLength(stream, context, CSSPrimitiveValue::ValueRange::kAll);
}
...
{
    state.StyleBuilder().SetTransformOriginZ(state.ParentStyle()->GetTransformOrigin().Z());
}
...
const CSSValue* Widows::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumePositiveInteger(stream, context);
}
...
const CSSValue* Widows::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.Widows(), CSSPrimitiveValue::UnitType::kNumber);
}

const CSSValue* Width::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeWidthOrHeight(stream, context, css_parsing_utils::UnitlessQuirk::kAllow);
}

bool Width::IsLayoutDependent(const ComputedStyle* style, LayoutObject* layout_object) const
{
    return layout_object && (layout_object->IsBox() || layout_object->IsSVG());
}
...
{
    if (value_phase == CSSValuePhase::kResolvedValue && ComputedStyleUtils::WidthOrHeightShouldReturnUsedValue(layout_object)) {
        return ZoomAdjustedPixelValue(ComputedStyleUtils::UsedBoxSize(*layout_object).width(), style);
    }
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.Width(), style);
}

const CSSValue* WillChange::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    while (true) {
        ...
        CSSPropertyID unresolved_property = UnresolvedCSSPropertyID(context.GetExecutionContext(), stream.Peek().Value());
        if (unresolved_property != CSSPropertyID::kInvalid && unresolved_property != CSSPropertyID::kVariable) {
#if DCHECK_IS_ON()
            DCHECK(CSSProperty::Get(ResolveCSSPropertyID(unresolved_property)).IsWebExposed(context.GetExecutionContext()));
#endif
            ...
            values->Append(*MakeGarbageCollected<CSSCustomIdentValue>(unresolved_property));
            stream.ConsumeIncludingWhitespace();
        } else {
...
const CSSValue* WillChange::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ValueForWillChange(style.WillChangeProperties(), style.WillChangeContents(), style.WillChangeScrollPosition());
}
...
void WillChange::ApplyInitial(StyleResolverState& state) const
{
    ...
    builder.SetSubtreeWillChangeContents(state.ParentStyle()->SubtreeWillChangeContents());
}
...
{
    blink::EWordBreak word_break = To<CSSIdentifierValue>(value).ConvertTo<blink::EWordBreak>();
...
const CSSValue* WordSpacing::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ParseSpacing(stream, context);
}
...
const CSSValue* X::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSVGGeometryPropertyLength(stream, context, CSSPrimitiveValue::ValueRange::kAll);
}

const CSSValue* X::CSSValueFromComputedStyleInternal(const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.X(), style);
}

const CSSValue* Y::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeSVGGeometryPropertyLength(stream, context, CSSPrimitiveValue::ValueRange::kAll);
}

const CSSValue* Y::CSSValueFromComputedStyleInternal(const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return ComputedStyleUtils::ZoomAdjustedPixelValueForLength(style.Y(), style);
}

const CSSValue* ZIndex::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    if (stream.Peek().Id() == CSSValueID::kAuto) {
        return css_parsing_utils::ConsumeIdent(stream);
    }
    ...
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    ...
    return CSSNumericLiteralValue::Create(style.ZIndex(), CSSPrimitiveValue::UnitType::kInteger);
}

const CSSValue* Zoom::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext& context, const CSSParserLocalContext&) const
{
    const CSSParserToken token = stream.Peek();
    ...
    if (zoom) {
        if (!(token.Id() == CSSValueID::kNormal
                || (token.GetType() == kNumberToken && To<CSSPrimitiveValue>(zoom)->IsOne() == CSSPrimitiveValue::BoolStatus::kTrue)
                || (token.GetType() == kPercentageToken && To<CSSPrimitiveValue>(zoom)->IsHundred() == CSSPrimitiveValue::BoolStatus::kTrue))) {
...
const CSSValue* Zoom::CSSValueFromComputedStyleInternal(
    const ComputedStyle& style, const LayoutObject*, bool allow_visited_style, CSSValuePhase value_phase) const
{
    return CSSNumericLiteralValue::Create(style.Zoom(), CSSPrimitiveValue::UnitType::kNumber);
}
...
const CSSValue* InternalAlignContentBlock::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeIdent<CSSValueID::kCenter, CSSValueID::kNormal>(stream);
}

const CSSValue* InternalEmptyLineHeight::ParseSingleValue(CSSParserTokenStream& stream, const CSSParserContext&, const CSSParserLocalContext&) const
{
    return css_parsing_utils::ConsumeIdent<CSSValueID::kFabricated, CSSValueID::kNone>(stream);
}
