...
StyleRuleCSSStyleDeclaration::StyleRuleCSSStyleDeclaration(MutableCSSPropertyValueSet& property_set_arg, CSSRule* parent_rule)
    : PropertySetCSSStyleDeclaration(const_cast<Document*>(CSSStyleSheet::SingleOwnerDocument(parent_rule->parentStyleSheet()))
            ? const_cast<Document*>(CSSStyleSheet::SingleOwnerDocument(parent_rule->parentStyleSheet()))->GetExecutionContext()
            : nullptr,
        property_set_arg)
...
void StyleRuleCSSStyleDeclaration::Reattach(MutableCSSPropertyValueSet& property_set)
{
