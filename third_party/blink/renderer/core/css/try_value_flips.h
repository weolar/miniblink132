...
public:
    ...
    static const CSSValue* FlipValue(CSSPropertyID from_property, const CSSValue*, const TryTacticTransform&, const WritingDirectionMode&);
...
private:
    ...
    mutable HeapVector<Member<const CSSPropertyValueSet>, kCachedFlipSetsSize> cached_flip_sets_;
};
