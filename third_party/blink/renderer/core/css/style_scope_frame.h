...
struct CORE_EXPORT StyleScopeActivations : public GarbageCollected<StyleScopeActivations> {
public:
    void Trace(blink::Visitor*) const;
...
public:
    explicit StyleScopeFrame(Element& element)
        : element_(element)
    {
    }
...
private:
    ...
    HeapHashMap<Member<const StyleScope>, Member<const StyleScopeActivations>> data_;
