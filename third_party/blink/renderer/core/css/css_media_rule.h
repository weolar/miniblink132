...
class CORE_EXPORT CSSMediaRule final : public CSSConditionRule, public MediaQuerySetOwner {
...
private:
    ...
    MediaQuerySetOwner* GetMediaQuerySetOwner() override
    {
        return this;
    }
...
template <> struct DowncastTraits<CSSMediaRule> {
