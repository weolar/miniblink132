...
class ScrollStateQuerySnapshot : public GarbageCollected<ScrollStateQuerySnapshot>, public ScrollSnapshotClient {
public:
    explicit ScrollStateQuerySnapshot(Element& container);

    ContainerStuckPhysical StuckHorizontal() const
    {
        return stuck_horizontal_;
    }
    ContainerStuckPhysical StuckVertical() const
    {
