...
public:
    ...
    {
        return class_type_ >= kValueListClass;
    }
    ...
    bool IsColorMixValue() const
    {
        return class_type_ == kColorMixClass;
    }
    bool IsCounterValue() const
    {
        return class_type_ == kCounterClass;
    }
    bool IsCursorImageValue() const
    {
        return class_type_ == kCursorImageClass;
    }
    ...
    bool IsPaintValue() const
    {
        return class_type_ == kPaintClass;
    }
    bool IsFontFeatureValue() const
    {
        return class_type_ == kFontFeatureClass;
    }
    bool IsFontFamilyValue() const
    {
        return class_type_ == kFontFamilyClass;
    }
    bool IsFontFaceSrcValue() const
    {
        return class_type_ == kFontFaceSrcClass;
    }
    ...
    {
        return class_type_ == kFunctionClass;
    }
    bool IsCustomIdentValue() const
    {
        return class_type_ == kCustomIdentClass;
    }
    bool IsImageGeneratorValue() const
    {
        return class_type_ >= kCrossfadeClass && class_type_ <= kConstantGradientClass;
    }
    bool IsGradientValue() const
    {
        return class_type_ >= kLinearGradientClass && class_type_ <= kConstantGradientClass;
    }
    bool IsImageSetOptionValue() const
    {
        return class_type_ == kImageSetOptionClass;
    }
    bool IsImageSetTypeValue() const
    {
        return class_type_ == kImageSetTypeClass;
    }
    bool IsImageSetValue() const
    {
        return class_type_ == kImageSetClass;
    }
    ...
    {
        return class_type_ == kRevertClass;
    }
    bool IsRevertLayerValue() const
    {
        return class_type_ == kRevertLayerClass;
    }
    ...
    bool IsPaletteMixValue() const
    {
        return class_type_ == kPaletteMixClass;
    }
    bool IsPathValue() const
    {
        return class_type_ == kPathClass;
    }
    bool IsQuadValue() const
    {
        return class_type_ == kQuadClass;
    }
    bool IsRayValue() const
    {
        return class_type_ == kRayClass;
    }
    ...
    {
        return class_type_ == kReflectClass;
    }
    ...
    {
        return class_type_ == kStringClass;
    }
    ...
    {
        return class_type_ == kUnicodeRangeClass;
    }
    ...
    bool IsFlipRevertValue() const
    {
        return class_type_ == kFlipRevertClass;
    }
    bool IsAlternateValue() const
    {
        return class_type_ == kAlternateClass;
    }
    bool IsAxisValue() const
    {
        return class_type_ == kAxisClass;
    }
    ...
    bool IsScrollValue() const
    {
        return class_type_ == kScrollClass;
    }
    bool IsViewValue() const
    {
        return class_type_ == kViewClass;
    }
    bool IsRatioValue() const
    {
        return class_type_ == kRatioClass;
    }

    bool IsRepeatStyleValue() const
    {
        return class_type_ == kRepeatStyleClass;
    }
    ...
    bool IsRepeatValue() const
    {
        return class_type_ == kRepeatClass;
    }
...
protected:
    ...
    {
        return static_cast<ClassType>(class_type_);
    }
...
inline bool CompareCSSValueVector(
    const HeapVector<Member<CSSValueType>, inlineCapacity>& first_vector, const HeapVector<Member<CSSValueType>, inlineCapacity>& second_vector)
{
...
template <typename T> struct SpaceTrait<T, std::enable_if_t<std::is_base_of<blink::CSSValue, T>::value>> {
