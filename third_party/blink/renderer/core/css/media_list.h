...
public:
    ...
    {
        return Queries()->QueryVector().size();
    }
    String item(unsigned index) const;
    void deleteMedium(ExecutionContext*, const String& old_medium, ExceptionState&);
    ...
    String MediaTextInternal() const
    {
        return Queries()->MediaText();
    }
