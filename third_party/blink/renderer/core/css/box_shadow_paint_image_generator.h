...
class CORE_EXPORT BoxShadowPaintImageGenerator : public NativePaintImageGenerator {
public:
    static BoxShadowPaintImageGenerator* Create(LocalFrame& local_root);

    ~BoxShadowPaintImageGenerator() override = default;

    using BoxShadowPaintImageGeneratorCreateFunction = BoxShadowPaintImageGenerator*(LocalFrame&);
