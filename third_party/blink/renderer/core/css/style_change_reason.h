...
public:
    ...
    static StyleChangeReasonForTracing CreateWithExtraData(StyleChangeReasonString reason_string, const AtomicString& extra_data)
    {
    ...
    {
        return String(reason_);
    }
    const AtomicString& GetExtraData() const
    {
        return extra_data_;
    }
