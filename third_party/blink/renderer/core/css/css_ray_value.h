...
public:
    CSSRayValue(
        const CSSPrimitiveValue& angle, const CSSIdentifierValue& size, const CSSIdentifierValue* contain, const CSSValue* center_x, const CSSValue* center_y);

    const CSSPrimitiveValue& Angle() const
    {
        return *angle_;
    }
    const CSSIdentifierValue& Size() const
    {
        return *size_;
    }
    const CSSIdentifierValue* Contain() const
    {
        return contain_.Get();
    }
    const CSSValue* CenterX() const
    {
        return center_x_.Get();
    }
    const CSSValue* CenterY() const
    {
...
template <> struct DowncastTraits<cssvalue::CSSRayValue> {
