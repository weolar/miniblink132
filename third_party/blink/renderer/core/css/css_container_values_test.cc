...
public:
    ...
    void SetContainerWritingDirection(WritingMode writing_mode, TextDirection direction)
    {
    ...
    CSSContainerValues* CreateStickyValues(ContainerStuckPhysical horizontal, ContainerStuckPhysical vertical)
    {
        return MakeGarbageCollected<CSSContainerValues>(GetDocument(), ContainerElement(), std::nullopt, std::nullopt, horizontal, vertical,
            static_cast<ContainerSnappedFlags>(ContainerSnapped::kNone), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kNone),
    ...
    {
        return MakeGarbageCollected<CSSContainerValues>(GetDocument(), ContainerElement(), std::nullopt, std::nullopt, ContainerStuckPhysical::kNo,
            ContainerStuckPhysical::kNo, snapped, static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kNone),
            static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kNone));
    }

    CSSContainerValues* CreateOverflowingValues(ContainerOverflowingFlags horizontal, ContainerOverflowingFlags vertical)
    {
        return MakeGarbageCollected<CSSContainerValues>(GetDocument(), ContainerElement(), std::nullopt, std::nullopt, ContainerStuckPhysical::kNo,
            ContainerStuckPhysical::kNo, static_cast<ContainerSnappedFlags>(ContainerSnapped::kNone), horizontal, vertical);
    }
...
TEST_F(CSSContainerValuesTest, StickyHorizontalTbLtr)
{
    ...
    MediaValues* values = CreateStickyValues(ContainerStuckPhysical::kRight, ContainerStuckPhysical::kTop);
...
{
    SetContainerWritingDirection(WritingMode::kHorizontalTb, TextDirection::kLtr);
    MediaValues* values = CreateSnappedValues(static_cast<ContainerSnappedFlags>(ContainerSnapped::kNone));
...
{
    SetContainerWritingDirection(WritingMode::kHorizontalTb, TextDirection::kLtr);
    MediaValues* values = CreateSnappedValues(static_cast<ContainerSnappedFlags>(ContainerSnapped::kX));
...
{
    SetContainerWritingDirection(WritingMode::kHorizontalTb, TextDirection::kLtr);
    MediaValues* values = CreateSnappedValues(static_cast<ContainerSnappedFlags>(ContainerSnapped::kY));
...
TEST_F(CSSContainerValuesTest, SnappedBoth)
{
    SetContainerWritingDirection(WritingMode::kHorizontalTb, TextDirection::kLtr);
    MediaValues* values
        = CreateSnappedValues(static_cast<ContainerSnappedFlags>(ContainerSnapped::kX) | static_cast<ContainerSnappedFlags>(ContainerSnapped::kY));
    EXPECT_TRUE(values->SnappedBlock());
    EXPECT_TRUE(values->SnappedInline());
    EXPECT_TRUE(values->Snapped());
}
...
TEST_F(CSSContainerValuesTest, OverflowingHorizontalTbLtr)
{
    ...
    MediaValues* values = CreateOverflowingValues(
        static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kEnd), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart));
    EXPECT_EQ(values->OverflowingInline(), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kEnd));
    EXPECT_EQ(values->OverflowingBlock(), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart));
}
...
TEST_F(CSSContainerValuesTest, OverflowingHorizontalTbRtl)
{
    ...
    MediaValues* values = CreateOverflowingValues(
        static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kEnd), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart));
    EXPECT_EQ(values->OverflowingInline(), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart));
    EXPECT_EQ(values->OverflowingBlock(), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart));
}
...
TEST_F(CSSContainerValuesTest, OverflowingVerticalLrLtr)
{
    ...
    MediaValues* values = CreateOverflowingValues(
        static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kEnd), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart));
    EXPECT_EQ(values->OverflowingInline(), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kStart));
    EXPECT_EQ(values->OverflowingBlock(), static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kEnd));
}
