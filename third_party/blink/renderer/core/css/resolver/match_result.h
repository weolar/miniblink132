...
public:
    ...
    struct Data {
        ...
        uint8_t valid_property_filter : 4 = static_cast<std::underlying_type_t<ValidPropertyFilter>>(ValidPropertyFilter::kNoFilter);
...
public:
    ...
    void AddMatchedProperties(const CSSPropertyValueSet* properties, const MatchedProperties::Data& types);
    bool HasMatchedProperties() const
    {
        return matched_properties_.size();
    }
    ...
    void SetIsCacheable(bool cacheable)
    {
        is_cacheable_ = cacheable;
    }
    ...
    void AddFlags(MatchFlags flags)
    {
        flags_ |= flags;
    }
    ...
    unsigned PseudoElementStyles() const
    {
...
{
    return a.properties == b.properties && a.data_.link_match_type == b.data_.link_match_type;
}
