...
TEST(CSSVariableDataTest, Serialize)
{
    const String test_cases[] = {
        ...
        "'value'",
        "a.1",
        "5257114e-22df-4378-a8e7-61897860f71e",
        "11111111",
    };
...
{
    const String replacement_character_string(base::span_from_ref(kReplacementCharacter));
    ...
    for (auto test_case : test_cases) {
        EXPECT_EQ(CreateVariableData(test_case.first)->Serialize(), test_case.second);
    }
}
