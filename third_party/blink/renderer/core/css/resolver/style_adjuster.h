...
public:
    ...
    static void AdjustStyleForSvgElement(const SVGElement& element, ComputedStyleBuilder& builder, const ComputedStyle& layout_parent_style);
...
private:
    ...
    static void AdjustEffectiveTouchAction(ComputedStyleBuilder&, const ComputedStyle& parent_style, Element* element, bool is_svg_root);
