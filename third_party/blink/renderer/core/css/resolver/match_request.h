...
public:
    explicit MatchRequest(const ContainerNode* scope = nullptr, Element* vtt_originating_element = nullptr)
        : scope_(scope)
    ...
    explicit MatchRequest(RuleSet* rule_set, const ContainerNode* scope = nullptr, const CSSStyleSheet* css_sheet = nullptr, unsigned style_sheet_index = 0,
    ...
    Element* VTTOriginatingElement() const
    {
    ...
    bool IsEmpty() const
    {
        return num_rule_sets_ == 0;
    }
    bool IsFull() const
    {
        return num_rule_sets_ == kRulesetsRoom;
    }
    ...
    public:
        ...
        {
            return { match_request_.rule_sets_[index_], index_ + match_request_.style_sheet_first_index_ };
        }
    ...
    public:
        ...
        RuleSetIterator begin() const
        {
            return { &match_request_, 0 };
        }
