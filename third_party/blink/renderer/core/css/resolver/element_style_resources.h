...
public:
    ...
    explicit PreCachedContainerSizes(const CSSToLengthConversionData* conversion_data)
...
public:
    ...
    SVGResource* GetSVGResourceFromValue(CSSPropertyID, const cssvalue::CSSURIValue&);
