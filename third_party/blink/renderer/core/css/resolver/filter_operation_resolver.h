...
public:
    ...
    static FilterOperations CreateFilterOperations(StyleResolverState&, const CSSValue&, CSSPropertyID);
    static FilterOperations CreateOffscreenFilterOperations(const CSSValue&, const Font&);
    static double ResolveNumericArgumentForFunction(const CSSFunctionValue& filter, const CSSLengthResolver& length_resolver);
};
