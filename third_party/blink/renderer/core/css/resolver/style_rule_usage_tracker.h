...
public:
    using RuleListByStyleSheet = HeapHashMap<Member<const CSSStyleSheet>, Member<HeapVector<Member<const StyleRule>>>>;
...
private:
    ...
    HeapHashMap<Member<const CSSStyleSheet>, Member<HeapHashSet<Member<const StyleRule>>>> used_rules_;
