...
void CSSToStyleMap::MapFillCompositingOperator(StyleResolverState&, FillLayer* layer, const CSSValue& value)
{
    if (value.IsInitialValue()) {
        layer->SetCompositingOperator(FillLayer::InitialFillCompositingOperator(layer->GetType()));
        return;
    }
    ...
    layer->SetCompositingOperator(identifier_value->ConvertTo<CompositingOperator>());
}
...
void CSSToStyleMap::MapFillImage(StyleResolverState& state, FillLayer* layer, const CSSValue& value)
{
    ...
    CSSPropertyID property = layer->GetType() == EFillLayerType::kBackground ? CSSPropertyID::kBackgroundImage : CSSPropertyID::kMaskImage;
    layer->SetImage(state.GetStyleImage(property, state.ResolveLightDarkPair(value)));
}

void CSSToStyleMap::MapFillRepeat(StyleResolverState&, FillLayer* layer, const CSSValue& value)
{
    if (value.IsInitialValue()) {
    ...
    if (const auto* repeat = DynamicTo<CSSRepeatStyleValue>(value)) {
        layer->SetRepeat({ repeat->x()->ConvertTo<EFillRepeat>(), repeat->y()->ConvertTo<EFillRepeat>() });
    }
}

void CSSToStyleMap::MapFillMaskMode(StyleResolverState&, FillLayer* layer, const CSSValue& value)
{
    if (value.IsInitialValue()) {
...
void CSSToStyleMap::MapFillSize(StyleResolverState& state, FillLayer* layer, const CSSValue& value)
{
    ...
    if (identifier_value && identifier_value->GetValueID() == CSSValueID::kContain) {
        layer->SetSizeType(EFillSizeType::kContain);
    } else if (identifier_value && identifier_value->GetValueID() == CSSValueID::kCover) {
    ...
    if (identifier_value && (identifier_value->GetValueID() == CSSValueID::kContain || identifier_value->GetValueID() == CSSValueID::kCover)) {
    ...
    if (const auto* pair = DynamicTo<CSSValuePair>(value)) {
        first_length = StyleBuilderConverter::ConvertLengthOrAuto(state, pair->First());
        second_length = StyleBuilderConverter::ConvertLengthOrAuto(state, pair->Second());
    } else {
...
void CSSToStyleMap::MapFillPositionX(StyleResolverState& state, FillLayer* layer, const CSSValue& value)
{
    if (value.IsInitialValue()) {
    ...
    if (pair) {
        length = To<CSSPrimitiveValue>(pair->Second()).ConvertToLength(state.CssToLengthConversionData());
    } else {
        length = StyleBuilderConverter::ConvertPositionLength<CSSValueID::kLeft, CSSValueID::kRight>(state, value);
    }

    layer->SetPositionX(length);
    if (pair) {
        layer->SetBackgroundXOrigin(To<CSSIdentifierValue>(pair->First()).ConvertTo<BackgroundEdgeOrigin>());
    }
}

void CSSToStyleMap::MapFillPositionY(StyleResolverState& state, FillLayer* layer, const CSSValue& value)
{
    if (value.IsInitialValue()) {
    ...
    if (pair) {
        ...
        length = StyleBuilderConverter::ConvertPositionLength<CSSValueID::kTop, CSSValueID::kBottom>(state, value);
    }

    layer->SetPositionY(length);
    if (pair) {
        layer->SetBackgroundYOrigin(To<CSSIdentifierValue>(pair->First()).ConvertTo<BackgroundEdgeOrigin>());
    }
}

namespace {

Timing::Delay MapAnimationTimingDelay(const CSSLengthResolver& length_resolver, const CSSValue& value)
{
    if (const auto* primitive = DynamicTo<CSSPrimitiveValue>(value)) {
        return Timing::Delay(AnimationTimeDelta(primitive->ComputeSeconds(length_resolver)));
    }
...
Timing::Delay CSSToStyleMap::MapAnimationDelayStart(StyleResolverState& state, const CSSValue& value)
{
...
Timing::Delay CSSToStyleMap::MapAnimationDelayEnd(StyleResolverState& state, const CSSValue& value)
{
    return MapAnimationTimingDelay(state.CssToLengthConversionData(), value);
}

Timing::PlaybackDirection CSSToStyleMap::MapAnimationDirection(StyleResolverState& state, const CSSValue& value)
{
...
std::optional<double> CSSToStyleMap::MapAnimationDuration(StyleResolverState& state, const CSSValue& value)
{
    if (auto* identifier = DynamicTo<CSSIdentifierValue>(value); identifier && identifier->GetValueID() == CSSValueID::kAuto) {
        return std::nullopt;
    }
    return To<CSSPrimitiveValue>(value).ComputeSeconds();
}

Timing::FillMode CSSToStyleMap::MapAnimationFillMode(StyleResolverState& state, const CSSValue& value)
{
    switch (To<CSSIdentifierValue>(value).GetValueID()) {
...
double CSSToStyleMap::MapAnimationIterationCount(StyleResolverState& state, const CSSValue& value)
{
    auto* identifier_value = DynamicTo<CSSIdentifierValue>(value);
    if (identifier_value && identifier_value->GetValueID() == CSSValueID::kInfinite) {
        return std::numeric_limits<double>::infinity();
    }
    return To<CSSPrimitiveValue>(value).GetFloatValue();
}

AtomicString CSSToStyleMap::MapAnimationName(StyleResolverState& state, const CSSValue& value)
{
...
CSSTransitionData::TransitionBehavior CSSToStyleMap::MapAnimationBehavior(StyleResolverState& state, const CSSValue& value)
{
...
StyleTimeline CSSToStyleMap::MapAnimationTimeline(StyleResolverState& state, const CSSValue& value)
{
    DCHECK(value.IsScopedValue());
    if (auto* ident = DynamicTo<CSSIdentifierValue>(value)) {
        DCHECK(ident->GetValueID() == CSSValueID::kAuto || ident->GetValueID() == CSSValueID::kNone);
        return StyleTimeline(ident->GetValueID());
    }
    if (auto* custom_ident = DynamicTo<CSSCustomIdentValue>(value)) {
        return StyleTimeline(MakeGarbageCollected<ScopedCSSName>(custom_ident->Value(), custom_ident->GetTreeScope()));
    }
    if (value.IsViewValue()) {
        ...
        TimelineAxis axis = axis_value ? axis_value->ConvertTo<TimelineAxis>() : StyleTimeline::ViewData::DefaultAxis();
        const auto* inset_value = view_value.Inset();
        TimelineInset inset = inset_value ? StyleBuilderConverter::ConvertSingleTimelineInset(state, *inset_value) : TimelineInset();
    ...
    const auto* scroller_value = DynamicTo<CSSIdentifierValue>(scroll_value.Scroller());

    TimelineAxis axis = axis_value ? axis_value->ConvertTo<TimelineAxis>() : StyleTimeline::ScrollData::DefaultAxis();
    TimelineScroller scroller = scroller_value ? scroller_value->ConvertTo<TimelineScroller>() : StyleTimeline::ScrollData::DefaultScroller();

    return StyleTimeline(StyleTimeline::ScrollData(axis, scroller));
}

EAnimPlayState CSSToStyleMap::MapAnimationPlayState(StyleResolverState& state, const CSSValue& value)
{
...
std::optional<TimelineOffset> MapAnimationRange(StyleResolverState& state, const CSSValue& value, double default_percent)
{
    if (auto* ident = DynamicTo<CSSIdentifierValue>(value); ident && ident->GetValueID() == CSSValueID::kNormal) {
        return std::nullopt;
    }
    ...
    if (list.Item(0).IsIdentifierValue()) {
        range_name = To<CSSIdentifierValue>(list.Item(0)).ConvertTo<TimelineOffset::NamedRange>();
        if (list.length() == 2u) {
...
std::optional<TimelineOffset> CSSToStyleMap::MapAnimationRangeStart(StyleResolverState& state, const CSSValue& value)
{
    return MapAnimationRange(state, value, 0);
}

std::optional<TimelineOffset> CSSToStyleMap::MapAnimationRangeEnd(StyleResolverState& state, const CSSValue& value)
{
    return MapAnimationRange(state, value, 100);
}

EffectModel::CompositeOperation CSSToStyleMap::MapAnimationComposition(StyleResolverState& state, const CSSValue& value)
{
    switch (To<CSSIdentifierValue>(value).GetValueID()) {
...
CSSTransitionData::TransitionProperty CSSToStyleMap::MapAnimationProperty(StyleResolverState& state, const CSSValue& value)
{
    if (const auto* custom_ident_value = DynamicTo<CSSCustomIdentValue>(value)) {
        if (custom_ident_value->IsKnownPropertyID()) {
            return CSSTransitionData::TransitionProperty(custom_ident_value->ValueAsPropertyID());
        }
...
scoped_refptr<TimingFunction> CSSToStyleMap::MapAnimationTimingFunction(const CSSValue& value)
{
    ...
    if (const auto* linear_timing_function = DynamicTo<cssvalue::CSSLinearTimingFunctionValue>(value)) {
        return LinearTimingFunction::Create(linear_timing_function->Points());
    }

    if (const auto* cubic_timing_function = DynamicTo<cssvalue::CSSCubicBezierTimingFunctionValue>(value)) {
        return CubicBezierTimingFunction::Create(
            cubic_timing_function->X1(), cubic_timing_function->Y1(), cubic_timing_function->X2(), cubic_timing_function->Y2());
    }

    const auto& steps_timing_function = To<cssvalue::CSSStepsTimingFunctionValue>(value);
    return StepsTimingFunction::Create(steps_timing_function.NumberOfSteps(), steps_timing_function.GetStepPosition());
}

scoped_refptr<TimingFunction> CSSToStyleMap::MapAnimationTimingFunction(StyleResolverState& state, const CSSValue& value)
{
...
void CSSToStyleMap::MapNinePieceImage(StyleResolverState& state, CSSPropertyID property, const CSSValue& value, NinePieceImage& image)
{
    ...
    if (property == CSSPropertyID::kWebkitBorderImage) {
        ...
        if (image.BorderSlices().Right().IsLength() && image.BorderSlices().Right().length().IsFixed()) {
            builder.SetBorderRightWidth(image.BorderSlices().Right().length().Pixels());
        }
        if (image.BorderSlices().Bottom().IsLength() && image.BorderSlices().Bottom().length().IsFixed()) {
            builder.SetBorderBottomWidth(image.BorderSlices().Bottom().length().Pixels());
        }
...
static Length ConvertBorderImageSliceSide(const CSSLengthResolver& length_resolver, const CSSPrimitiveValue& value)
{
...
void CSSToStyleMap::MapNinePieceImageSlice(StyleResolverState& state, const CSSValue& value, NinePieceImage& image)
{
    ...
    // Retrieve the border image value.
    const auto& border_image_slice = To<cssvalue::CSSBorderImageSliceValue>(value);

    // Set up a length box to represent our image slices.
    LengthBox box;
    const CSSQuadValue& slices = border_image_slice.Slices();
    box.top_ = ConvertBorderImageSliceSide(state.CssToLengthConversionData(), To<CSSPrimitiveValue>(*slices.Top()));
    box.bottom_ = ConvertBorderImageSliceSide(state.CssToLengthConversionData(), To<CSSPrimitiveValue>(*slices.Bottom()));
    box.left_ = ConvertBorderImageSliceSide(state.CssToLengthConversionData(), To<CSSPrimitiveValue>(*slices.Left()));
    box.right_ = ConvertBorderImageSliceSide(state.CssToLengthConversionData(), To<CSSPrimitiveValue>(*slices.Right()));
...
static BorderImageLength ToBorderImageLength(const StyleResolverState& state, const CSSValue& value)
{
...
BorderImageLengthBox CSSToStyleMap::MapNinePieceImageQuad(StyleResolverState& state, const CSSValue& value)
{
    ...
    return BorderImageLengthBox(ToBorderImageLength(state, *slices->Top()), ToBorderImageLength(state, *slices->Right()),
        ToBorderImageLength(state, *slices->Bottom()), ToBorderImageLength(state, *slices->Left()));
}
...
void CSSToStyleMap::MapNinePieceImageRepeat(StyleResolverState&, const CSSValue& value, NinePieceImage& image)
{
    ...
    if (pair != nullptr) {
        ...
        first_identifier = second_identifier = To<CSSIdentifierValue>(value).GetValueID();
    }
