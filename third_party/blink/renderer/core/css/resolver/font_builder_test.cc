...
{
    const ComputedStyle& parent_style = GetDocument().GetStyleResolver().InitialStyle();
...
TEST_P(FontBuilderAdditiveTest, OnlySetValueIsModified)
{
    ...
    builder = GetDocument().GetStyleResolver().CreateComputedStyleBuilderInheritingFrom(*parent_style);
...
{
    b.SetFamilyDescription(FontDescription::FamilyDescription(FontDescription::kCursiveFamily));
}
...
{
    d.SetVariantLigatures(FontDescription::VariantLigatures(FontDescription::kEnabledLigaturesState));
}
static void FontVariantLigaturesValue(FontBuilder& b)
{
    b.SetVariantLigatures(FontDescription::VariantLigatures(FontDescription::kDisabledLigaturesState));
}
...
INSTANTIATE_TEST_SUITE_P(AllFields, FontBuilderAdditiveTest,
    testing::Values(FunctionPair(FontWeightBase, FontWeightValue), FunctionPair(FontStretchBase, FontStretchValue),
        FunctionPair(FontFamilyBase, FontFamilyValue), FunctionPair(FontFeatureSettingsBase, FontFeatureSettingsValue),
        FunctionPair(FontStyleBase, FontStyleValue), FunctionPair(FontVariantCapsBase, FontVariantCapsValue),
        FunctionPair(FontVariantLigaturesBase, FontVariantLigaturesValue), FunctionPair(FontVariantNumericBase, FontVariantNumericValue),
        FunctionPair(FontSynthesisWeightBase, FontSynthesisWeightValue), FunctionPair(FontSynthesisStyleBase, FontSynthesisStyleValue),
        FunctionPair(FontSynthesisSmallCapsBase, FontSynthesisSmallCapsValue), FunctionPair(FontTextRenderingBase, FontTextRenderingValue),
        FunctionPair(FontKerningBase, FontKerningValue), FunctionPair(FontFontSmoothingBase, FontFontSmoothingValue), FunctionPair(FontSizeBase, FontSizeValue),
        FunctionPair(FontScriptBase, FontScriptValue), FunctionPair(FontOpticalSizingBase, FontOpticalSizingValue)));
