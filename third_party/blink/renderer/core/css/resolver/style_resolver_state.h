...
public:
    StyleResolverState(Document&, Element&, const StyleRecalcContext* = nullptr, const StyleRequest& = StyleRequest());
    ...
    Element* GetStyledElement() const
    {
    ...
    {
        return element_context_.GetElement();
    }
    ...
    void CreateNewStyle(const ComputedStyle& source_for_noninherited, const ComputedStyle& inherit_parent,
        ComputedStyleBuilderBase::IsAtShadowBoundary is_at_shadow_boundary = ComputedStyleBuilderBase::kNotAtShadowBoundary)
    {
        // FIXME: Improve RAII of StyleResolverState to remove this function.
        style_builder_.emplace(source_for_noninherited, inherit_parent, is_at_shadow_boundary);
        UpdateLengthConversionData();
    }
    ComputedStyleBuilder& StyleBuilder()
    {
        return *style_builder_;
    }
    const ComputedStyleBuilder& StyleBuilder() const
    {
        return *style_builder_;
    }
    ...
    void SetConversionFontSizes(const CSSToLengthConversionData::FontSizes& font_sizes)
    {
    ...
    void SetOldStyle(const ComputedStyle* old_style)
    {
    ...
    const FontBuilder& GetFontBuilder() const
    {
        return font_builder_;
    }
    ...
    bool IsForHighlight() const
    {
        return is_for_highlight_;
    }
    ...
    {
        return is_outside_flat_tree_;
    }

    bool CanTriggerAnimations() const
    {
        return can_trigger_animations_;
    }

    bool HadNoMatchedProperties() const
    {
        return had_no_matched_properties_;
    }
    void SetHadNoMatchedProperties()
    {
        had_no_matched_properties_ = true;
    }
    ...
    void SetAffectsCompositorSnapshots()
    {
        affects_compositor_snapshots_ = true;
    }
    ...
    void SetRejectedLegacyOverlapping()
    {
        rejected_legacy_overlapping_ = true;
    }
    ...
    void SetHasTreeScopedReference()
    {
        has_tree_scoped_reference_ = true;
    }
    bool HasTreeScopedReference() const
    {
        return has_tree_scoped_reference_;
    }
