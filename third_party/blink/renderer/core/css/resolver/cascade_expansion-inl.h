...
void ExpandCascade(const MatchedProperties& matched_properties, const Document& document, wtf_size_t matched_properties_index,
    CustomPropertyCallback&& custom_property_callback, RegularPropertyCallback&& regular_property_callback)
{
    ...
    if (size > kMaxDeclarationIndex + 1 || matched_properties_index > kMaxMatchedPropertiesIndex) {
        return;
    }
    ...
    for (wtf_size_t property_idx = 0; property_idx < size; ++property_idx) {
        ...
        CascadePriority priority(matched_properties.data_.origin, metadata.important_, matched_properties.data_.tree_order,
            matched_properties.data_.is_inline_style, matched_properties.data_.is_try_style, matched_properties.data_.is_try_tactics_style,
            matched_properties.data_.layer_order, EncodeMatchResultPosition(matched_properties_index, property_idx));
