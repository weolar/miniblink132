...
public:
    ...
    static FontFeatureSettings* InitialFeatureSettings()
    {
        return nullptr;
    }
    static FontVariationSettings* InitialVariationSettings()
    {
        return nullptr;
    }
    static FontPalette* InitialFontPalette()
    {
        return nullptr;
    }
    ...
    static FontSizeAdjust InitialSizeAdjust()
    {
        return FontSizeAdjust();
    }
    static TextRenderingMode InitialTextRendering()
    {
    ...
    static LayoutLocale* InitialLocale()
    {
        return nullptr;
    }
    ...
    static OpticalSizing InitialFontOpticalSizing()
    {
    ...
    static FontVariantEmoji InitialVariantEmoji()
    {
...
private:
    ...
    void Set(PropertySetFlag flag)
    {
        flags_ |= (1 << unsigned(flag));
    }
