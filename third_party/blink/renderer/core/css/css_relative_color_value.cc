...
CSSRelativeColorValue::CSSRelativeColorValue(const CSSValue& origin_color, Color::ColorSpace color_interpolation_space, const CSSValue& channel0,
    const CSSValue& channel1, const CSSValue& channel2, const CSSValue* alpha)
...
String CSSRelativeColorValue::CustomCSSText() const
{
    ...
    const bool serialize_as_color_function = Color::IsPredefinedColorSpace(color_interpolation_space_);
...
{
    return base::ValuesEquivalent(origin_color_, other.origin_color_) && (color_interpolation_space_ == other.color_interpolation_space_)
        && base::ValuesEquivalent(channel0_, other.channel0_) && base::ValuesEquivalent(channel1_, other.channel1_)
        && base::ValuesEquivalent(channel2_, other.channel2_) && base::ValuesEquivalent(alpha_, other.alpha_);
}
