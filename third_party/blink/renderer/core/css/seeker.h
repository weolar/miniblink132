...
#endif
        iter_
            = std::find_if(iter_, intervals_.end(), [rule_position](const RuleSet::Interval<T>& interval) { return interval.start_position > rule_position; });
