...
public:
    ...
    {
//         DEFINE_STATIC_LOCAL(const unsigned char*, is_tracing_enabled,
//             (TRACE_EVENT_API_GET_CATEGORY_GROUP_ENABLED(TRACE_DISABLED_BY_DEFAULT("devtools.timeline.invalidationTracking"))));
// 
