...
protected:
    ...
    void MergeInvalidationSet(RuleInvalidationData::InvalidationSetMap&, const AtomicString& key, scoped_refptr<InvalidationSet>);
    void MergeInvalidationSet(RuleInvalidationData::PseudoTypeInvalidationSetMap&, CSSSelector::PseudoType key, scoped_refptr<InvalidationSet>);
};
