...
public:
    ...
    bool operator!=(const InvalidationFlags& o) const
    {
        return !(*this == o);
    }
    ...
    bool InvalidateCustomPseudo() const
    {
        return invalidate_custom_pseudo_;
    }
    ...
    {
        return whole_subtree_invalid_;
    }
    void SetWholeSubtreeInvalid(bool value)
    {
        whole_subtree_invalid_ = value;
    }

    bool TreeBoundaryCrossing() const
    {
        return tree_boundary_crossing_;
    }
    void SetTreeBoundaryCrossing(bool value)
    {
        tree_boundary_crossing_ = value;
    }

    bool InsertionPointCrossing() const
    {
        return insertion_point_crossing_;
    }
    ...
    {
        return invalidates_slotted_;
    }
    void SetInvalidatesSlotted(bool value)
    {
        invalidates_slotted_ = value;
    }

    bool InvalidatesParts() const
    {
        return invalidates_parts_;
    }
    void SetInvalidatesParts(bool value)
    {
        invalidates_parts_ = value;
    }
