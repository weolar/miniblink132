...
RuleInvalidationDataTracer::RuleInvalidationDataTracer(const RuleInvalidationData& rule_invalidation_data)
    : RuleInvalidationDataVisitor(rule_invalidation_data)
{
}

void RuleInvalidationDataTracer::TraceInvalidationSetsForSelector(const CSSSelector& selector)
{
