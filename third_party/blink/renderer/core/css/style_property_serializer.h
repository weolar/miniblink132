...
private:
    ...
    bool AppendFontLonghandValueIfNotNormal(const CSSProperty&, WTF::StringBuilder& result) const;
    ...
    String GetPropertyText(const CSSPropertyName&, const String& value, bool is_important, bool is_not_first_decl) const;
    ...
    void AppendBackgroundPropertyAsText(WTF::StringBuilder& result, unsigned& num_decls) const;
    ...
    public:
        ...
        PropertyValueForSerializer(const CSSPropertyName& name, const CSSValue* value, bool is_important)
            : value_(value)
            , name_(name)
