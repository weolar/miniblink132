...
CSSRayValue::CSSRayValue(
    const CSSPrimitiveValue& angle, const CSSIdentifierValue& size, const CSSIdentifierValue* contain, const CSSValue* center_x_, const CSSValue* center_y_)
    : CSSValue(kRayClass)
    , angle_(&angle)
    , size_(&size)
    , contain_(contain)
...
{
    return base::ValuesEquivalent(angle_, other.angle_) && base::ValuesEquivalent(size_, other.size_) && base::ValuesEquivalent(contain_, other.contain_)
        && base::ValuesEquivalent(center_x_, other.center_x_) && base::ValuesEquivalent(center_y_, other.center_y_);
}
