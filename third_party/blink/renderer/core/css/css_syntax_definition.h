...
public:
    ...
    const CSSValue* Parse(StringView, const CSSParserContext&, bool is_animation_tainted) const;
...
template <wtf_size_t inlineCapacity, typename Allocator> struct CrossThreadCopier<Vector<blink::CSSSyntaxDefinition, inlineCapacity, Allocator>> {
