...
CSSPathValue::CSSPathValue(scoped_refptr<StylePath> style_path, PathSerializationFormat serialization_format)
    : CSSValue(kPathClass)
...
CSSPathValue::CSSPathValue(SVGPathByteStream path_byte_stream, WindRule wind_rule, PathSerializationFormat serialization_format)
    : CSSPathValue(StylePath::Create(std::move(path_byte_stream), wind_rule), serialization_format)
{
}
