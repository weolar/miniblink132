...
public:
    CSSRelativeColorValue(const CSSValue& origin_color, Color::ColorSpace color_interpolation_space, const CSSValue& channel0, const CSSValue& channel1,
...
template <> struct DowncastTraits<cssvalue::CSSRelativeColorValue> {
