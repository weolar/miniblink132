...
public:
    explicit CSSImageSetOptionValue(const CSSValue* image, const CSSPrimitiveValue* resolution = nullptr, const CSSImageSetTypeValue* type = nullptr);
...
template <> struct DowncastTraits<CSSImageSetOptionValue> {
