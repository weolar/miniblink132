...
TEST_F(FontUpdateInvalidationTest, PartialLayoutInvalidationAfterFontLoadingSVG)
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/Ahem.woff2", "font/woff2");
    ...
    auto* target = To<SVGTextElement>(GetDocument().getElementById(AtomicString("target")));
    auto* reference = To<SVGTextElement>(GetDocument().getElementById(AtomicString("reference")));
...
TEST_F(FontUpdateInvalidationTest, PartialLayoutInvalidationAfterFontFaceDeletion)
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/Ahem.woff2", "font/woff2");
...
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest slow_font_resource("https://example.com/nonexist.woff2", "font/woff2");
    SimSubresourceRequest fast_font_resource("https://example.com/Ahem.woff2", "font/woff2");
...
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/font2.woff2", "font/woff2");
