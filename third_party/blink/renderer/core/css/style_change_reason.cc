...
void Init()
{
    ...
    new (WTF::NotNullTag::kNotNull, (void*)&g_active_view_transition) AtomicString(":active_view_transition");
    new (WTF::NotNullTag::kNotNull, (void*)&g_active_view_transition_type) AtomicString(":active_view_transition_type");
    ...
    new (WTF::NotNullTag::kNotNull, (void*)&g_focus_visible) AtomicString(":focus-visible");
    new (WTF::NotNullTag::kNotNull, (void*)&g_focus_within) AtomicString(":focus-within");
    new (WTF::NotNullTag::kNotNull, (void*)&g_hover) AtomicString(":hover");
    new (WTF::NotNullTag::kNotNull, (void*)&g_past) AtomicString(":past");
    new (WTF::NotNullTag::kNotNull, (void*)&g_unresolved) AtomicString(":unresolved");
}
