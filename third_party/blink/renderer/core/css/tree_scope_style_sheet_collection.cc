...
TreeScopeStyleSheetCollection::TreeScopeStyleSheetCollection(TreeScope& tree_scope)
...
void TreeScopeStyleSheetCollection::ApplyActiveStyleSheetChanges(StyleSheetCollection& new_collection)
{
    GetDocument().GetStyleEngine().ApplyRuleSetChanges(GetTreeScope(), ActiveStyleSheets(), new_collection.ActiveStyleSheets(), new_collection.RuleSetDiffs());
