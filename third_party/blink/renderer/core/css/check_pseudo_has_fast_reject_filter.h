...
public:
    ...
    static void CollectPseudoHasArgumentHashes(Vector<unsigned>& pseudo_has_argument_hashes, const CSSSelector* simple_selector);
    ...
    bool BloomFilterAllocated() const
    {
        return filter_.get();
    }
