...
mojom::blink::PreferredColorScheme CSSValueIDToPreferredColorScheme(CSSValueID id)
{
    switch (id) {
...
int MediaValues::CalculateDeviceWidth(LocalFrame* frame)
{
    ...
    const display::ScreenInfo& screen_info = frame->GetPage()->GetChromeClient().GetScreenInfo(*frame);
...
bool MediaValues::CalculateDeviceSupportsHDR(LocalFrame* frame)
{
    ...
    return frame->GetPage()->GetChromeClient().GetScreenInfo(*frame).display_color_spaces.SupportsHDR();
}
...
float MediaValues::CalculateEmSize(LocalFrame* frame)
{
    ...
    return CSSToLengthConversionData::FontSizes(style.GetFontSizeStyle(), &style).Em(/* zoom */ 1.0f);
}
...
float MediaValues::CalculateExSize(LocalFrame* frame)
{
    ...
    CHECK(frame->ContentLayoutObject());
    const ComputedStyle& style = frame->ContentLayoutObject()->StyleRef();
    return CSSToLengthConversionData::FontSizes(style.GetFontSizeStyle(), &style).Ex(/* zoom */ 1.0f);
}
...
float MediaValues::CalculateChSize(LocalFrame* frame)
{
    ...
    CHECK(frame->ContentLayoutObject());
    const ComputedStyle& style = frame->ContentLayoutObject()->StyleRef();
    return CSSToLengthConversionData::FontSizes(style.GetFontSizeStyle(), &style).Ch(/* zoom */ 1.0f);
}
...
float MediaValues::CalculateIcSize(LocalFrame* frame)
{
    ...
    CHECK(frame->ContentLayoutObject());
    const ComputedStyle& style = frame->ContentLayoutObject()->StyleRef();
    return CSSToLengthConversionData::FontSizes(style.GetFontSizeStyle(), &style).Ic(/* zoom */ 1.0f);
}
...
float MediaValues::CalculateCapSize(LocalFrame* frame)
{
    ...
    CHECK(frame->ContentLayoutObject());
    const ComputedStyle& style = frame->ContentLayoutObject()->StyleRef();
    return CSSToLengthConversionData::FontSizes(style.GetFontSizeStyle(), &style).Cap(/* zoom */ 1.0f);
}
...
mojom::blink::DisplayMode MediaValues::CalculateDisplayMode(LocalFrame* frame)
{
    ...
    blink::mojom::DisplayMode mode = frame->GetPage()->GetSettings().GetDisplayModeOverride();
...
ui::mojom::blink::WindowShowState MediaValues::CalculateWindowShowState(LocalFrame* frame)
{
    DCHECK(frame);

    ui::mojom::blink::WindowShowState show_state = frame->GetPage()->GetSettings().GetWindowShowState();
...
mojom::blink::PointerType MediaValues::CalculatePrimaryPointerType(LocalFrame* frame)
{
    DCHECK(frame);
    DCHECK(frame->GetSettings());
...
mojom::blink::HoverType MediaValues::CalculatePrimaryHoverType(LocalFrame* frame)
{
    DCHECK(frame);
    DCHECK(frame->GetSettings());
...
mojom::blink::OutputDeviceUpdateAbilityType MediaValues::CalculateOutputDeviceUpdateAbilityType(LocalFrame* frame)
{
    DCHECK(frame);
    DCHECK(frame->GetSettings());
...
ColorSpaceGamut MediaValues::CalculateColorGamut(LocalFrame* frame)
{
    DCHECK(frame);
    DCHECK(frame->GetPage());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    std::optional<ColorSpaceGamut> override_value = overrides ? overrides->GetColorGamut() : std::nullopt;
    return override_value.value_or(color_space_utilities::GetColorSpaceGamut(frame->GetPage()->GetChromeClient().GetScreenInfo(*frame)));
}

mojom::blink::PreferredColorScheme MediaValues::CalculatePreferredColorScheme(LocalFrame* frame)
{
    DCHECK(frame);
    DCHECK(frame->GetSettings());
    DCHECK(frame->GetDocument());
    DCHECK(frame->GetPage());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    std::optional<mojom::blink::PreferredColorScheme> override_value = overrides ? overrides->GetPreferredColorScheme() : std::nullopt;
    if (override_value.has_value()) {
        return override_value.value();
    }

    const PreferenceOverrides* preference_overrides = frame->GetPage()->GetPreferenceOverrides();
    std::optional<mojom::blink::PreferredColorScheme> preference_override_value
        = preference_overrides ? preference_overrides->GetPreferredColorScheme() : std::nullopt;
    return preference_override_value.value_or(frame->GetDocument()->GetStyleEngine().GetPreferredColorScheme());
}

mojom::blink::PreferredContrast MediaValues::CalculatePreferredContrast(LocalFrame* frame)
{
    DCHECK(frame);
    DCHECK(frame->GetSettings());
    DCHECK(frame->GetPage());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    std::optional<mojom::blink::PreferredContrast> override_value = overrides ? overrides->GetPreferredContrast() : std::nullopt;
    if (override_value.has_value()) {
        return override_value.value();
    }
    ...
    std::optional<mojom::blink::PreferredContrast> preference_override_value
        = preference_overrides ? preference_overrides->GetPreferredContrast() : std::nullopt;
    return preference_override_value.value_or(frame->GetSettings()->GetPreferredContrast());
}
...
bool MediaValues::CalculatePrefersReducedMotion(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetSettings());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    std::optional<bool> override_value = overrides ? overrides->GetPrefersReducedMotion() : std::nullopt;
    if (override_value.has_value()) {
        return override_value.value();
    }

    const PreferenceOverrides* preference_overrides = frame->GetPage()->GetPreferenceOverrides();
    std::optional<bool> preference_override_value = preference_overrides ? preference_overrides->GetPrefersReducedMotion() : std::nullopt;
    return preference_override_value.value_or(frame->GetSettings()->GetPrefersReducedMotion());
}
...
bool MediaValues::CalculatePrefersReducedData(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetSettings());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    std::optional<bool> override_value = overrides ? overrides->GetPrefersReducedData() : std::nullopt;
    if (override_value.has_value()) {
        return override_value.value();
    }

    const PreferenceOverrides* preference_overrides = frame->GetPage()->GetPreferenceOverrides();
    std::optional<bool> preference_override_value = preference_overrides ? preference_overrides->GetPrefersReducedData() : std::nullopt;
    return preference_override_value.value_or(GetNetworkStateNotifier().SaveDataEnabled());
}
...
bool MediaValues::CalculatePrefersReducedTransparency(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetSettings());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    std::optional<bool> override_value = overrides ? overrides->GetPrefersReducedTransparency() : std::nullopt;
    if (override_value.has_value()) {
        return override_value.value();
    }

    const PreferenceOverrides* preference_overrides = frame->GetPage()->GetPreferenceOverrides();
    std::optional<bool> preference_override_value = preference_overrides ? preference_overrides->GetPrefersReducedTransparency() : std::nullopt;
    return preference_override_value.value_or(frame->GetSettings()->GetPrefersReducedTransparency());
}
...
ForcedColors MediaValues::CalculateForcedColors(LocalFrame* frame)
{
    ...
    DCHECK(frame->GetSettings());
    const MediaFeatureOverrides* overrides = frame->GetPage()->GetMediaFeatureOverrides();
    std::optional<ForcedColors> override_value = overrides ? overrides->GetForcedColors() : std::nullopt;
    return override_value.value_or(frame->GetDocument()->GetStyleEngine().GetForcedColors());
}
...
int MediaValues::CalculateHorizontalViewportSegments(LocalFrame* frame)
{
    ...
    WebVector<gfx::Rect> viewport_segments = frame->GetWidgetForLocalRoot()->ViewportSegments();
...
mojom::blink::DevicePostureType MediaValues::CalculateDevicePosture(LocalFrame* frame)
{
...
Scripting MediaValues::CalculateScripting(LocalFrame* frame)
{
    DCHECK(frame);
    DCHECK(frame->GetDocument());
    if (!frame->GetDocument()->GetExecutionContext()->CanExecuteScripts(kNotAboutToExecuteScript)) {
