...
struct CORE_EXPORT CSSPropertyValueMetadata {
    ...
    CSSPropertyValueMetadata(const CSSPropertyName&, bool is_set_from_shorthand, int index_in_shorthands_vector, bool important, bool implicit);
...
public:
    CSSPropertyValue(const CSSPropertyName& name, const CSSValue& value, bool important = false, bool is_set_from_shorthand = false,
        int index_in_shorthands_vector = 0, bool implicit = false)
    ...
    {
        return metadata_.is_set_from_shorthand_;
    }
    CSSPropertyID ShorthandID() const
    {
        return metadata_.ShorthandID();
    }
    bool IsImportant() const
    {
        return metadata_.important_;
    }
    void SetImportant()
    {
        metadata_.important_ = true;
    }
    CSSPropertyName Name() const
    {
    ...
    const CSSPropertyValueMetadata& Metadata() const
    {
        return metadata_;
    }
...
namespace WTF {
template <> struct VectorTraits<blink::CSSPropertyValue> : VectorTraitsBase<blink::CSSPropertyValue> {
