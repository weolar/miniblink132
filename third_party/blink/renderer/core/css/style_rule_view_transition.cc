...
StyleRuleViewTransition::StyleRuleViewTransition(CSSPropertyValueSet& properties)
    : StyleRuleBase(kViewTransition)
    , navigation_(properties.GetPropertyCSSValue(CSSPropertyID::kNavigation))
    , types_(ExtractTypesFromCSSValue(properties.GetPropertyCSSValue(CSSPropertyID::kTypes)))
{
}

StyleRuleViewTransition::StyleRuleViewTransition(const StyleRuleViewTransition&) = default;
...
void StyleRuleViewTransition::TraceAfterDispatch(blink::Visitor* visitor) const
{
