...
template <class T> T CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <class T> inline CSSValueID PlatformEnumToCSSValueID(T v)
{
    // By default, we use the generated mappings. For special cases, we overload.
    return detail::platformEnumToCSSValueIDGenerated(v);
}

template <> inline UnicodeBidi CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline EBoxOrient CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline ETextCombine CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline ETextAlign CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline CSSValueID PlatformEnumToCSSValueID(EffectModel::CompositeOperation v)
{
    switch (v) {
...
template <> inline EffectModel::CompositeOperation CssValueIDToPlatformEnum(CSSValueID v)
{
    switch (v) {
...
template <> inline ETextOrientation CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline EResize CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline WritingMode CssValueIDToPlatformEnum(CSSValueID v)
{
    switch (v) {
    case CSSValueID::kLr:
...
template <> inline ECursor CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline EDisplay CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline EUserSelect CssValueIDToPlatformEnum(CSSValueID v)
{
    if (v == CSSValueID::kAuto) {
...
template <> inline CSSValueID PlatformEnumToCSSValueID(EDisplay v)
{
    if (v == EDisplay::kNone) {
...
template <> inline PageOrientation CssValueIDToPlatformEnum(CSSValueID v)
{
...
template <> inline ScrollbarGutter CssValueIDToPlatformEnum(CSSValueID v)
{
    if (v == CSSValueID::kAuto) {
...
template <> inline EWhiteSpace CssValueIDToPlatformEnum(CSSValueID v)
{
    switch (v) {
...
template <> inline CSSValueID PlatformEnumToCSSValueID(EWhiteSpace v)
{
    switch (v) {
...
template <> inline WhiteSpaceCollapse CssValueIDToPlatformEnum(CSSValueID v)
{
    switch (v) {
...
template <> inline CSSValueID PlatformEnumToCSSValueID(WhiteSpaceCollapse v)
{
    switch (v) {
...
template <> inline TextBoxEdge::Type CssValueIDToPlatformEnum(CSSValueID id)
{
    switch (id) {
...
template <> inline CSSValueID PlatformEnumToCSSValueID(TextBoxEdge::Type type)
{
...
template <> inline TextSpacingTrim CssValueIDToPlatformEnum(CSSValueID v)
{
    switch (v) {
    case CSSValueID::kNormal:
...
template <> inline CSSValueID PlatformEnumToCSSValueID(TextSpacingTrim v)
{
    switch (v) {
...
template <> inline TryTactic CssValueIDToPlatformEnum(CSSValueID v)
{
    switch (v) {
...
template <> inline CSSValueID PlatformEnumToCSSValueID(TryTactic v)
{
    switch (v) {
