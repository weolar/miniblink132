...
{
    return rule_invalidation_data_ == other.rule_invalidation_data_ && media_query_result_flags_ == other.media_query_result_flags_;
}

SelectorPreMatch RuleFeatureSet::CollectFeaturesFromSelector(const CSSSelector& selector, const StyleScope* style_scope)
{
...
void RuleFeatureSet::RevisitSelectorForInspector(const CSSSelector& selector) const
{
