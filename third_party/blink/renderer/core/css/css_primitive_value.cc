...
float CSSPrimitiveValue::ClampToCSSLengthRange(double value)
{
    ...
    // here.
    return ClampTo<float>(CSSValueClampingUtils::ClampLength(value), kMinValueForCssLength, kMaxValueForCssLength);
}
...
CSSPrimitiveValue::ValueRange CSSPrimitiveValue::ValueRangeForLengthValueRange(Length::ValueRange range)
{
    switch (range) {
...
bool CSSPrimitiveValue::IsCalculatedPercentageWithLength() const
{
    ...
    CalculationResultCategory category = To<CSSMathFunctionValue>(this)->Category();
    return category == kCalcLengthFunction || category == kCalcIntrinsicSize;
}

bool CSSPrimitiveValue::IsResolution() const
{
    return (IsNumericLiteralValue() && To<CSSNumericLiteralValue>(this)->IsResolution())
        || (IsMathFunctionValue() && To<CSSMathFunctionValue>(this)->IsResolution());
}
...
bool CSSPrimitiveValue::HasContainerRelativeUnits() const
{
    ...
    const CSSPrimitiveValue::LengthTypeFlags container_units((1ull << CSSPrimitiveValue::kUnitTypeContainerWidth)
        | (1ull << CSSPrimitiveValue::kUnitTypeContainerHeight) | (1ull << CSSPrimitiveValue::kUnitTypeContainerInlineSize)
        | (1ull << CSSPrimitiveValue::kUnitTypeContainerBlockSize) | (1ull << CSSPrimitiveValue::kUnitTypeContainerMin)
        | (1ull << CSSPrimitiveValue::kUnitTypeContainerMax));
    return (units & container_units).any();
}

// static
CSSPrimitiveValue* CSSPrimitiveValue::CreateFromLength(const Length& length, float zoom)
{
...
{
    double result = IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputeSeconds() : To<CSSNumericLiteralValue>(this)->ComputeSeconds();
    return CSSValueClampingUtils::ClampTime(result);
}

double CSSPrimitiveValue::ComputeDegrees() const
{
    double result = IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputeDegrees() : To<CSSNumericLiteralValue>(this)->ComputeDegrees();
...
{
    double result = IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputeDegrees(length_resolver) : To<CSSNumericLiteralValue>(this)->ComputeDegrees();
    return CSSValueClampingUtils::ClampAngle(result);
}

double CSSPrimitiveValue::ComputeSeconds(const CSSLengthResolver& length_resolver) const
{
    double result = IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputeSeconds(length_resolver) : To<CSSNumericLiteralValue>(this)->ComputeSeconds();
    return CSSValueClampingUtils::ClampTime(result);
}

double CSSPrimitiveValue::ComputeDotsPerPixel(const CSSLengthResolver& length_resolver) const
{
    DCHECK(IsResolution());
    double result
        = IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputeDotsPerPixel(length_resolver) : To<CSSNumericLiteralValue>(this)->ComputeDotsPerPixel();
    return CSSValueClampingUtils::ClampDouble(result);
}

template <> int CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return RoundForImpreciseConversion<int>(ComputeLengthDouble(length_resolver));
}

template <> unsigned CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return RoundForImpreciseConversion<unsigned>(ComputeLengthDouble(length_resolver));
}

template <> Length CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return Length::Fixed(ClampToCSSLengthRange(ComputeLengthDouble(length_resolver)));
}

template <> int16_t CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return RoundForImpreciseConversion<int16_t>(ComputeLengthDouble(length_resolver));
}

template <> uint16_t CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return RoundForImpreciseConversion<uint16_t>(ComputeLengthDouble(length_resolver));
}

template <> uint8_t CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return RoundForImpreciseConversion<uint8_t>(ComputeLengthDouble(length_resolver));
}

template <> float CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return ClampTo<float>(CSSValueClampingUtils::ClampLength(ComputeLengthDouble(length_resolver)));
}

template <> double CSSPrimitiveValue::ComputeLength(const CSSLengthResolver& length_resolver) const
{
    return CSSValueClampingUtils::ClampLength(ComputeLengthDouble(length_resolver));
}

int CSSPrimitiveValue::ComputeInteger(const CSSLengthResolver& length_resolver) const
{
    DCHECK(IsNumber());
    return IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputeInteger(length_resolver) : To<CSSNumericLiteralValue>(this)->ComputeInteger();
}

double CSSPrimitiveValue::ComputeNumber(const CSSLengthResolver& length_resolver) const
{
    DCHECK(IsNumber());
    return IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputeNumber(length_resolver) : To<CSSNumericLiteralValue>(this)->ComputeNumber();
}

double CSSPrimitiveValue::ComputePercentage(const CSSLengthResolver& length_resolver) const
{
    DCHECK(IsPercentage());
    return IsCalculated() ? To<CSSMathFunctionValue>(this)->ComputePercentage(length_resolver) : To<CSSNumericLiteralValue>(this)->ComputePercentage();
}
...
bool CSSPrimitiveValue::AccumulateLengthArray(CSSLengthArray& length_array, double multiplier) const
{
    DCHECK_EQ(length_array.values.size(), CSSLengthArray::kSize);
    if (IsCalculated()) {
        return To<CSSMathFunctionValue>(this)->AccumulateLengthArray(length_array, multiplier);
    }
    return To<CSSNumericLiteralValue>(this)->AccumulateLengthArray(length_array, multiplier);
}

void CSSPrimitiveValue::AccumulateLengthUnitTypes(LengthTypeFlags& types) const
{
    if (IsCalculated()) {
...
bool CSSPrimitiveValue::HasStaticViewportUnits(const LengthTypeFlags& length_type_flags)
{
    return length_type_flags.test(CSSPrimitiveValue::kUnitTypeViewportWidth) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeViewportHeight)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeViewportInlineSize) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeViewportBlockSize)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeViewportMin) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeViewportMax)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeSmallViewportWidth) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeSmallViewportHeight)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeSmallViewportInlineSize)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeSmallViewportBlockSize) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeSmallViewportMin)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeSmallViewportMax) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeLargeViewportWidth)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeLargeViewportHeight)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeLargeViewportInlineSize)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeLargeViewportBlockSize) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeLargeViewportMin)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeLargeViewportMax);
}

bool CSSPrimitiveValue::HasDynamicViewportUnits(const LengthTypeFlags& length_type_flags)
{
    return length_type_flags.test(CSSPrimitiveValue::kUnitTypeDynamicViewportWidth) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeDynamicViewportHeight)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeDynamicViewportInlineSize)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeDynamicViewportBlockSize)
        || length_type_flags.test(CSSPrimitiveValue::kUnitTypeDynamicViewportMin) || length_type_flags.test(CSSPrimitiveValue::kUnitTypeDynamicViewportMax);
}
...
Length CSSPrimitiveValue::ConvertToLength(const CSSLengthResolver& length_resolver) const
{
    ...
    if (IsPercentage()) {
        if (IsNumericLiteralValue() || !To<CSSMathFunctionValue>(this)->AllowsNegativePercentageReference()) {
            return Length::Percent(CSSValueClampingUtils::ClampLength(GetDoubleValueWithoutClamping()));
        }
    }
    DCHECK(IsCalculated());
...
{
    return IsCalculated() ? To<CSSMathFunctionValue>(this)->DoubleValue() : To<CSSNumericLiteralValue>(this)->DoubleValue();
}
...
// static
CSSPrimitiveValue::UnitType CSSPrimitiveValue::CanonicalUnit(CSSPrimitiveValue::UnitType unit_type)
{
    return CanonicalUnitTypeForCategory(UnitTypeToUnitCategory(unit_type));
}

bool CSSPrimitiveValue::UnitTypeToLengthUnitType(UnitType unit_type, LengthUnitType& length_type)
{
    switch (unit_type) {
...
const CSSMathExpressionNode* CreateExpressionNodeFromDouble(double value, CSSPrimitiveValue::UnitType unit_type)
{
    return CSSMathExpressionNumericLiteral::Create(value, unit_type);
}

CSSPrimitiveValue* CreateValueFromOperation(const CSSMathExpressionNode* left, const CSSMathExpressionNode* right, CSSMathOperator op)
{
    const CSSMathExpressionNode* operation = CSSMathExpressionOperation::CreateArithmeticOperationSimplified(left, right, op);
    if (!operation) {
        return nullptr;
    }
    if (auto* numeric = DynamicTo<CSSMathExpressionNumericLiteral>(operation)) {
        return MakeGarbageCollected<CSSNumericLiteralValue>(numeric->DoubleValue(), numeric->ResolvedUnitType());
    }
    return MakeGarbageCollected<CSSMathFunctionValue>(operation, CSSPrimitiveValue::ValueRange::kAll);
}
...
const CSSMathExpressionNode* CSSPrimitiveValue::ToMathExpressionNode() const
{
    if (IsMathFunctionValue()) {
        ...
        return CreateExpressionNodeFromDouble(numeric->DoubleValue(), numeric->GetType());
    }
}

CSSPrimitiveValue* CSSPrimitiveValue::Add(double value, UnitType unit_type) const
{
    return CreateValueFromOperation(ToMathExpressionNode(), CreateExpressionNodeFromDouble(value, unit_type), CSSMathOperator::kAdd);
}

CSSPrimitiveValue* CSSPrimitiveValue::AddTo(double value, UnitType unit_type) const
{
    return CreateValueFromOperation(CreateExpressionNodeFromDouble(value, unit_type), ToMathExpressionNode(), CSSMathOperator::kAdd);
}

CSSPrimitiveValue* CSSPrimitiveValue::Add(const CSSPrimitiveValue& other) const
{
    return CreateValueFromOperation(ToMathExpressionNode(), other.ToMathExpressionNode(), CSSMathOperator::kAdd);
}

CSSPrimitiveValue* CSSPrimitiveValue::AddTo(const CSSPrimitiveValue& other) const
{
    return CreateValueFromOperation(other.ToMathExpressionNode(), ToMathExpressionNode(), CSSMathOperator::kAdd);
}

CSSPrimitiveValue* CSSPrimitiveValue::Subtract(double value, UnitType unit_type) const
{
    return CreateValueFromOperation(ToMathExpressionNode(), CreateExpressionNodeFromDouble(value, unit_type), CSSMathOperator::kSubtract);
}

CSSPrimitiveValue* CSSPrimitiveValue::SubtractFrom(double value, UnitType unit_type) const
{
    return CreateValueFromOperation(CreateExpressionNodeFromDouble(value, unit_type), ToMathExpressionNode(), CSSMathOperator::kSubtract);
}

CSSPrimitiveValue* CSSPrimitiveValue::Subtract(const CSSPrimitiveValue& other) const
{
    return CreateValueFromOperation(ToMathExpressionNode(), other.ToMathExpressionNode(), CSSMathOperator::kSubtract);
}

CSSPrimitiveValue* CSSPrimitiveValue::SubtractFrom(const CSSPrimitiveValue& other) const
{
    return CreateValueFromOperation(other.ToMathExpressionNode(), ToMathExpressionNode(), CSSMathOperator::kSubtract);
}

CSSPrimitiveValue* CSSPrimitiveValue::Multiply(double value, UnitType unit_type) const
{
    return CreateValueFromOperation(ToMathExpressionNode(), CreateExpressionNodeFromDouble(value, unit_type), CSSMathOperator::kMultiply);
}

CSSPrimitiveValue* CSSPrimitiveValue::MultiplyBy(double value, UnitType unit_type) const
{
    return CreateValueFromOperation(CreateExpressionNodeFromDouble(value, unit_type), ToMathExpressionNode(), CSSMathOperator::kMultiply);
}

CSSPrimitiveValue* CSSPrimitiveValue::Multiply(const CSSPrimitiveValue& other) const
{
    return CreateValueFromOperation(ToMathExpressionNode(), other.ToMathExpressionNode(), CSSMathOperator::kMultiply);
}

CSSPrimitiveValue* CSSPrimitiveValue::MultiplyBy(const CSSPrimitiveValue& other) const
{
    return CreateValueFromOperation(other.ToMathExpressionNode(), ToMathExpressionNode(), CSSMathOperator::kMultiply);
}

CSSPrimitiveValue* CSSPrimitiveValue::Divide(double value, UnitType unit_type) const
{
    return CreateValueFromOperation(ToMathExpressionNode(), CreateExpressionNodeFromDouble(value, unit_type), CSSMathOperator::kDivide);
}

CSSPrimitiveValue* CSSPrimitiveValue::ConvertLiteralsFromPercentageToNumber() const
{
    if (const auto* numeric = DynamicTo<CSSNumericLiteralValue>(this)) {
        return MakeGarbageCollected<CSSNumericLiteralValue>(numeric->DoubleValue() / 100, UnitType::kNumber);
    }
    CHECK(IsMathFunctionValue());
    const CSSMathExpressionNode* math_node = To<CSSMathFunctionValue>(this)->ExpressionNode();
    return MakeGarbageCollected<CSSMathFunctionValue>(math_node->ConvertLiteralsFromPercentageToNumber(), CSSPrimitiveValue::ValueRange::kAll);
}
