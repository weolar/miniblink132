...
class CORE_EXPORT NativePaintImageGenerator : public GarbageCollected<NativePaintImageGenerator> {
public:
    ...
    {
        return RuntimeEnabledFeatures::CompositeClipPathAnimationEnabled() || RuntimeEnabledFeatures::CompositeBGColorAnimationEnabled();
    }
};
