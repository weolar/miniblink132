...
public:
    ...
    explicit RuleSetDiff(RuleSet* old_ruleset)
        : old_ruleset_(old_ruleset)
    {
    }
    ...
    void NewRuleSetCleared()
    {
        new_ruleset_ = nullptr;
    }
    bool HasNewRuleSet() const
    {
        return new_ruleset_ != nullptr;
    }
