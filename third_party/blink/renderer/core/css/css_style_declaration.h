...
class CORE_EXPORT CSSStyleDeclaration : public ScriptWrappable, public ExecutionContextClient {
...
public:
    ...
    virtual bool IsAbstractPropertySet() const
    {
        return false;
    }
    ...
    String cssFloat()
    {
        return GetPropertyValueInternal(CSSPropertyID::kFloat);
    }
    void setCSSFloat(const ExecutionContext* execution_context, const String& value, ExceptionState& exception_state);
    virtual String cssText() const = 0;
    virtual void setCSSText(const ExecutionContext*, const String&, ExceptionState&) = 0;
    ...
    virtual void setProperty(const ExecutionContext*, const String& property_name, const String& value, const String& priority, ExceptionState&) = 0;
    virtual String removeProperty(const String& property_name, ExceptionState&) = 0;
    ...
    virtual const CSSValue* GetPropertyCSSValueInternal(const AtomicString& custom_property_name) = 0;
    ...
    virtual String GetPropertyValueWithHint(const String& property_name, unsigned index) = 0;
    virtual String GetPropertyPriorityWithHint(const String& property_name, unsigned index) = 0;
    virtual void SetPropertyInternal(CSSPropertyID, const String& property_value, StringView value, bool important, SecureContextMode, ExceptionState&) = 0;
    ...
    NamedPropertySetterResult AnonymousNamedSetter(ScriptState*, const AtomicString& name, v8::Local<v8::Value> value);
...
private:
    ...
    virtual bool FastPathSetProperty(CSSPropertyID unresolved_property, double value)
    {
        return false;
    }
};
