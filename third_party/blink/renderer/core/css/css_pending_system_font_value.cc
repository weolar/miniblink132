...
CSSPendingSystemFontValue::CSSPendingSystemFontValue(CSSValueID system_font_id)
    : CSSValue(kPendingSystemFontValueClass)
    , system_font_id_(system_font_id)
{
    DCHECK(CSSParserFastPaths::IsValidSystemFont(system_font_id));
}

// static
CSSPendingSystemFontValue* CSSPendingSystemFontValue::Create(CSSValueID system_font_id)
{
...
void CSSPendingSystemFontValue::TraceAfterDispatch(blink::Visitor* visitor) const
{
