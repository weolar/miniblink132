...
{
    swap(style_sheets_for_style_sheet_list_, other.style_sheets_for_style_sheet_list_);
...
void StyleSheetCollection::AppendActiveStyleSheet(const ActiveStyleSheet& active_sheet)
{
