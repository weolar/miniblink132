...
public:
    ...
    {
        return MakeGarbageCollected<CSSMathInvert>(value, CSSNumericValueType::NegateExponents(value->Type()));
    }
    ...
    const CSSNumericValue& Value() const
    {
        return *value_;
    }
    ...
    {
        return CSSStyleValue::kInvertType;
    }
