...
public:
    ...
    static CSSRGB* Create(
        const V8CSSNumberish* r, const V8CSSNumberish* g, const V8CSSNumberish* b, const V8CSSNumberish* alpha, ExceptionState& exception_state);

    // Internal constructor used by blink.
    explicit CSSRGB(const Color&);
    CSSRGB(CSSNumericValue*, CSSNumericValue*, CSSNumericValue*, CSSNumericValue*);
