...
bool CrossThreadUnitValue::operator==(const CrossThreadStyleValue& other) const
{
...
std::unique_ptr<CrossThreadStyleValue> CrossThreadUnitValue::IsolatedCopy() const
{
