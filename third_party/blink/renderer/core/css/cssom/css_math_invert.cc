...
void CSSMathInvert::BuildCSSText(Nested nested, ParenLess paren_less, StringBuilder& result) const
{
...
CSSMathExpressionNode* CSSMathInvert::ToCalcExpressionNode() const
{
    ...
    return CSSMathExpressionOperation::CreateArithmeticOperation(
        CSSMathExpressionNumericLiteral::Create(1, CSSPrimitiveValue::UnitType::kNumber), right_side, CSSMathOperator::kDivide);
}
