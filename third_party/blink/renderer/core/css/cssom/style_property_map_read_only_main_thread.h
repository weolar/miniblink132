...
class CORE_EXPORT StylePropertyMapReadOnlyMainThread : public StylePropertyMapReadOnly {
public:
    using StylePropertyMapEntry = std::pair<String, CSSStyleValueVector>;

    StylePropertyMapReadOnlyMainThread(const StylePropertyMapReadOnlyMainThread&) = delete;
    StylePropertyMapReadOnlyMainThread& operator=(const StylePropertyMapReadOnlyMainThread&) = delete;
...
protected:
    ...
    using IterationFunction = base::FunctionRef<void(const CSSPropertyName&, const CSSValue&)>;
