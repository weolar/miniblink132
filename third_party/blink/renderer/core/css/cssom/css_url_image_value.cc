...
std::optional<gfx::Size> CSSURLImageValue::IntrinsicSize() const
{
    ...
    return resource_content ? resource_content->IntrinsicSize(kRespectImageOrientation) : gfx::Size(0, 0);
}
...
scoped_refptr<Image> CSSURLImageValue::GetSourceImageForCanvas(FlushReason, SourceImageStatus*, const gfx::SizeF&, const AlphaDisposition alpha_disposition)
{
