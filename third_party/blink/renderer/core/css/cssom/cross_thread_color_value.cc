...
bool CrossThreadColorValue::operator==(const CrossThreadStyleValue& other) const
{
...
std::unique_ptr<CrossThreadStyleValue> CrossThreadColorValue::IsolatedCopy() const
{
