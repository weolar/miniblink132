...
class CORE_EXPORT InlineStylePropertyMap final : public StylePropertyMap, public ElementRareDataField {
public:
...
protected:
    ...
    bool SetShorthandProperty(CSSPropertyID, const String&, SecureContextMode) override;
