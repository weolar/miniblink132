...
protected:
    PaintWorkletInput(const gfx::SizeF& container_size, int worklet_id, cc::PaintWorkletInput::PropertyKeys property_keys)
...
template <> struct DowncastTraits<PaintWorkletInput> {
