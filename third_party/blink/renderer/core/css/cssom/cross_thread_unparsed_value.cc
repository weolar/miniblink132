...
bool CrossThreadUnparsedValue::operator==(const CrossThreadStyleValue& other) const
{
...
std::unique_ptr<CrossThreadStyleValue> CrossThreadUnparsedValue::IsolatedCopy() const
{
