...
TEST_F(CaretPositionTest, offsetNodeAndOffsetInClosedShadowTree)
{
    ...
    ShadowRoot& shadow_root = host->AttachShadowRootForTesting(ShadowRootMode::kClosed);
...
TEST_F(CaretPositionTest, offsetNodeAndOffsetInInput)
{
    ...
    auto* caret_position = MakeGarbageCollected<CaretPosition>(text_inside_input, 6);
