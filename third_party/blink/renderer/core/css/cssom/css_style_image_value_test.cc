...
{
    FakeCSSStyleImageValue* style_image_value = MakeGarbageCollected<FakeCSSStyleImageValue>(true, gfx::Size(100, 100));
    bool is_null = false;
...
{
    FakeCSSStyleImageValue* style_image_value = MakeGarbageCollected<FakeCSSStyleImageValue>(false, gfx::Size(480, 120));
    bool is_null = false;
