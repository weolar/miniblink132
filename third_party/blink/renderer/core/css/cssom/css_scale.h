...
public:
    ...
    static CSSScale* Create(const V8CSSNumberish* x, const V8CSSNumberish* y, ExceptionState& exception_state);
    static CSSScale* Create(const V8CSSNumberish* x, const V8CSSNumberish* y, const V8CSSNumberish* z, ExceptionState& exception_state);

    // Blink-internal ways of creating CSSScales.
    static CSSScale* Create(CSSNumericValue* x, CSSNumericValue* y)
    {
        return MakeGarbageCollected<CSSScale>(x, y, CSSUnitValue::Create(1), true /* is2D */);
    }
    static CSSScale* Create(CSSNumericValue* x, CSSNumericValue* y, CSSNumericValue* z)
    {
        return MakeGarbageCollected<CSSScale>(x, y, z, false /* is2D */);
    }
    static CSSScale* FromCSSValue(const CSSFunctionValue&);

    CSSScale(CSSNumericValue* x, CSSNumericValue* y, CSSNumericValue* z, bool is2D);
