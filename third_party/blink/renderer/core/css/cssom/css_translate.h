...
public:
    ...
    static CSSTranslate* Create(CSSNumericValue* x, CSSNumericValue* y, CSSNumericValue* z, ExceptionState&);
    static CSSTranslate* Create(CSSNumericValue* x, CSSNumericValue* y, ExceptionState&);

    // Blink-internal ways of creating CSSTranslates.
    static CSSTranslate* Create(CSSNumericValue* x, CSSNumericValue* y);
    static CSSTranslate* Create(CSSNumericValue* x, CSSNumericValue* y, CSSNumericValue* z);
    static CSSTranslate* FromCSSValue(const CSSFunctionValue&);

    CSSTranslate(CSSNumericValue* x, CSSNumericValue* y, CSSNumericValue* z, bool is2D);
