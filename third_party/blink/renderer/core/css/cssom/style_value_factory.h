...
public:
    static CSSStyleValueVector FromString(CSSPropertyID, const AtomicString& custom_property_name, const String&, const CSSParserContext*);
    static CSSStyleValue* CssValueToStyleValue(const CSSPropertyName&, const CSSValue&);
    static CSSStyleValueVector CssValueToStyleValueVector(const CSSPropertyName&, const CSSValue&);
    // Returns an empty vector on error conditions.
    static CSSStyleValueVector CoerceStyleValuesOrStrings(const CSSProperty& property, const AtomicString& custom_property_name,
