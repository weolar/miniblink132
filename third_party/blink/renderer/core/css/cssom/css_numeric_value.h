...
public:
    ...
    static CSSNumericValue* parse(const ExecutionContext*, const String& css_text, ExceptionState&);
    ...
    CSSNumericValue* add(const HeapVector<Member<V8CSSNumberish>>& numberishes, ExceptionState& exception_state);
    CSSNumericValue* sub(const HeapVector<Member<V8CSSNumberish>>& numberishes, ExceptionState& exception_state);
    CSSNumericValue* mul(const HeapVector<Member<V8CSSNumberish>>& numberishes, ExceptionState& exception_state);
    CSSNumericValue* div(const HeapVector<Member<V8CSSNumberish>>& numberishes, ExceptionState& exception_state);
    CSSNumericValue* min(const HeapVector<Member<V8CSSNumberish>>& numberishes, ExceptionState& exception_state);
    CSSNumericValue* max(const HeapVector<Member<V8CSSNumberish>>& numberishes, ExceptionState& exception_state);
    ...
    const CSSNumericValueType& Type() const
    {
        return type_;
    }
...
protected:
    ...
    CSSNumericValue(const CSSNumericValueType& type)
        : type_(type)
    {
    }
