...
bool SuccessfulPositionFallback::operator==(const SuccessfulPositionFallback& other) const
{
    return base::ValuesEquivalent(position_try_fallbacks_, other.position_try_fallbacks_) && try_set_ == other.try_set_ && try_tactics_ == other.try_tactics_
        && index_ == other.index_;
}
