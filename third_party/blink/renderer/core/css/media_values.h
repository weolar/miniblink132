...
class CORE_EXPORT MediaValues : public GarbageCollected<MediaValues>, public CSSLengthResolver {
public:
    MediaValues()
        : CSSLengthResolver(1.0f /* zoom */)
    {
    }
    ...
    template <typename T> bool ComputeLength(double value, CSSPrimitiveValue::UnitType type, T& result) const
    {
        double temp_result;
    ...
    virtual std::optional<double> Width() const
    {
        return ViewportWidth();
    }
    virtual std::optional<double> Height() const
    {
    ...
    virtual mojom::blink::OutputDeviceUpdateAbilityType OutputDeviceUpdateAbilityType() const = 0;
    ...
    virtual mojom::blink::PreferredColorScheme GetPreferredColorScheme() const = 0;
    ...
    bool Stuck() const
    {
        return StuckHorizontal() != ContainerStuckPhysical::kNo || StuckVertical() != ContainerStuckPhysical::kNo;
    }
    ...
    bool SnappedX() const
    {
        return SnappedFlags() & static_cast<ContainerSnappedFlags>(ContainerSnapped::kX);
    }
    bool SnappedY() const
    {
        return SnappedFlags() & static_cast<ContainerSnappedFlags>(ContainerSnapped::kY);
    }
    ...
    bool Snapped() const
    {
        return SnappedFlags() != static_cast<ContainerSnappedFlags>(ContainerSnapped::kNone);
    }
    ...
    {
        return OverflowingHorizontal() != static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kNone)
            || OverflowingVertical() != static_cast<ContainerOverflowingFlags>(ContainerOverflowing::kNone);
    }
    ...
    virtual Element* ContainerElement() const
    {
        return nullptr;
    }
...
protected:
    ...
    static ui::mojom::blink::WindowShowState CalculateWindowShowState(LocalFrame*);
    ...
    static mojom::blink::OutputDeviceUpdateAbilityType CalculateOutputDeviceUpdateAbilityType(LocalFrame*);
    static int CalculateAvailableHoverTypes(LocalFrame*);
    static ColorSpaceGamut CalculateColorGamut(LocalFrame*);
    static mojom::blink::PreferredColorScheme CalculatePreferredColorScheme(LocalFrame*);
    static mojom::blink::PreferredContrast CalculatePreferredContrast(LocalFrame*);
