...
CSSFontFeatureValuesRule::CSSFontFeatureValuesRule(StyleRuleFontFeatureValues* font_feature_values_rule, CSSStyleSheet* parent)
    : CSSRule(parent)
    , font_feature_values_rule_(font_feature_values_rule)
{
}
...
{
    return MakeGarbageCollected<CSSFontFeatureValuesMap>(this, font_feature_values_rule_, font_feature_values_rule_->GetAnnotation());
}
CSSFontFeatureValuesMap* CSSFontFeatureValuesRule::ornaments()
{
    return MakeGarbageCollected<CSSFontFeatureValuesMap>(this, font_feature_values_rule_, font_feature_values_rule_->GetOrnaments());
}
CSSFontFeatureValuesMap* CSSFontFeatureValuesRule::stylistic()
{
    return MakeGarbageCollected<CSSFontFeatureValuesMap>(this, font_feature_values_rule_, font_feature_values_rule_->GetStylistic());
}
CSSFontFeatureValuesMap* CSSFontFeatureValuesRule::swash()
{
    return MakeGarbageCollected<CSSFontFeatureValuesMap>(this, font_feature_values_rule_, font_feature_values_rule_->GetSwash());
}
CSSFontFeatureValuesMap* CSSFontFeatureValuesRule::characterVariant()
{
    return MakeGarbageCollected<CSSFontFeatureValuesMap>(this, font_feature_values_rule_, font_feature_values_rule_->GetCharacterVariant());
}
CSSFontFeatureValuesMap* CSSFontFeatureValuesRule::styleset()
{
    return MakeGarbageCollected<CSSFontFeatureValuesMap>(this, font_feature_values_rule_, font_feature_values_rule_->GetStyleset());
}
...
String CSSFontFeatureValuesRule::cssText() const
{
    ...
    result.Append(" { ");
    auto append_category = [&result](String rule_name, FontFeatureAliases* aliases) {
        DCHECK(aliases);
        if (aliases->size()) {
            result.Append("@");
    ...
    append_category("character-variant", font_feature_values_rule_->GetCharacterVariant());
