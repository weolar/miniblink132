...
CSSImageSetOptionValue::CSSImageSetOptionValue(const CSSValue* image, const CSSPrimitiveValue* resolution, const CSSImageSetTypeValue* type)
...
{
    return base::ValuesEquivalent(image_, other.image_) && base::ValuesEquivalent(resolution_, other.resolution_) && base::ValuesEquivalent(type_, other.type_);
}
