...
template <> struct DowncastTraits<StyleRulePositionTry> {
...
public:
    ...
    {
        return kPositionTryRule;
    }

    String name() const
    {
        return position_try_rule_->Name();
    }
    String cssText() const final;
    void Reattach(StyleRuleBase*) final;

    StyleRulePositionTry* PositionTry() const
    {
        return position_try_rule_.Get();
    }
...
template <> struct DowncastTraits<CSSPositionTryRule> {
