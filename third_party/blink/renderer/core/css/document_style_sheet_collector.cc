...
DocumentStyleSheetCollector::DocumentStyleSheetCollector(StyleSheetCollection* collection, HeapVector<Member<StyleSheet>>* sheets_for_list)
    : collection_(collection)
    , style_sheets_for_style_sheet_list_(sheets_for_list)
{
}

void DocumentStyleSheetCollector::AppendActiveStyleSheet(const ActiveStyleSheet& sheet)
{
    DCHECK(collection_);
...
ImportedDocumentStyleSheetCollector::ImportedDocumentStyleSheetCollector(DocumentStyleSheetCollector& collector, HeapVector<Member<StyleSheet>>& sheet_for_list)
