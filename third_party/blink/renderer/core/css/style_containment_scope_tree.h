...
class CORE_EXPORT StyleContainmentScopeTree final : public GarbageCollected<StyleContainmentScopeTree> {
public:
    ...
    StyleContainmentScopeTree& operator=(const StyleContainmentScopeTree&) = delete;
...
#if DCHECK_IS_ON()
    String ToString(StyleContainmentScope* style_scope = nullptr, wtf_size_t depth = 0u) const;
#endif // DCHECK_IS_ON()
