...
TEST_F(ComputedStyleCSSValueMappingTest, GetVariablesOnOldStyle)
{
    ...
    auto before = ComputedStyleCSSValueMapping::GetVariables(target->ComputedStyleRef(), GetDocument().GetPropertyRegistry(), CSSValuePhase::kComputedValue);
    ...
    auto after = ComputedStyleCSSValueMapping::GetVariables(target->ComputedStyleRef(), GetDocument().GetPropertyRegistry(), CSSValuePhase::kComputedValue);
