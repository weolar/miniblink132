...
class CORE_EXPORT OutOfFlowData final : public GarbageCollected<OutOfFlowData>, public ElementRareDataField {
public:
    ...
    {
        return SetPendingSuccessfulPositionFallback(nullptr, nullptr, kNoTryTactics, std::nullopt);
    }
    ...
    {
        return last_successful_position_fallback_.position_try_fallbacks_ != nullptr;
    }
