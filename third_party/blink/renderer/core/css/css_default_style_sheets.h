...
class CSSDefaultStyleSheets final : public GarbageCollected<CSSDefaultStyleSheets> {
public:
    ...
    RuleSet* DefaultHtmlStyle()
    {
        return default_html_style_.Get();
    }
    RuleSet* DefaultMathMLStyle()
    {
        return default_mathml_style_.Get();
    }
    RuleSet* DefaultSVGStyle()
    {
        return default_svg_style_.Get();
    }
    RuleSet* DefaultHtmlQuirksStyle()
    {
        return default_html_quirks_style_.Get();
    }
    RuleSet* DefaultPrintStyle()
    {
        return default_print_style_.Get();
    }
    ...
    RuleSet* DefaultFullscreenStyle()
    {
        return default_fullscreen_style_.Get();
    }

    StyleSheetContents* DefaultStyleSheet()
    {
        return default_style_sheet_.Get();
    }
    StyleSheetContents* QuirksStyleSheet()
    {
        return quirks_style_sheet_.Get();
    }
    ...
    StyleSheetContents* SvgStyleSheet()
    {
        return svg_style_sheet_.Get();
    }
    StyleSheetContents* MathmlStyleSheet()
    {
        return mathml_style_sheet_.Get();
    }
    ...
    StyleSheetContents* MarkerStyleSheet()
    {
        return marker_style_sheet_.Get();
    }
    ...
    CORE_EXPORT void SetMediaControlsStyleSheetLoader(std::unique_ptr<UAStyleSheetLoader>);
...
private:
    ...
    void AddRulesToDefaultStyleSheets(StyleSheetContents* rules, NamespaceType type);
