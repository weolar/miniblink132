...
public:
    explicit CSSFlipRevertValue(CSSPropertyID property_id, TryTacticTransform transform)
    ...
    TryTacticTransform Transform() const
    {
        return transform_;
    }
...
template <> struct DowncastTraits<cssvalue::CSSFlipRevertValue> {
