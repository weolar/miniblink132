...
public:
    ...
    public:
        ...
        mojom::blink::PointerType primary_pointer_type = mojom::blink::PointerType::kPointerNone;
        // Bitmask of |ui::PointerType|
        int available_pointer_types = ui::POINTER_TYPE_NONE;
        mojom::blink::HoverType primary_hover_type = mojom::blink::HoverType::kHoverNone;
        mojom::blink::OutputDeviceUpdateAbilityType output_device_update_ability_type = mojom::blink::OutputDeviceUpdateAbilityType::kFastType;
        ...
        String media_type;
        mojom::blink::DisplayMode display_mode = mojom::blink::DisplayMode::kBrowser;
        ui::mojom::blink::WindowShowState window_show_state = ui::mojom::blink::WindowShowState::kDefault;
        bool resizable = true;
        ColorSpaceGamut color_gamut = ColorSpaceGamut::kUnknown;
        mojom::blink::PreferredColorScheme preferred_color_scheme = mojom::blink::PreferredColorScheme::kLight;
        mojom::blink::PreferredContrast preferred_contrast = mojom::blink::PreferredContrast::kNoPreference;
        ...
        mojom::blink::DevicePostureType device_posture = mojom::blink::DevicePostureType::kContinuous;
    ...
    mojom::blink::OutputDeviceUpdateAbilityType OutputDeviceUpdateAbilityType() const override;
