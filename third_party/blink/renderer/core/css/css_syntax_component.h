...
public:
    ...
    CSSSyntaxRepeat GetRepeat() const
    {
        return repeat_;
    }
    bool IsRepeatable() const
    {
        return repeat_ != CSSSyntaxRepeat::kNone;
    }
    bool IsInteger() const
    {
        return type_ == CSSSyntaxType::kInteger;
    }
    ...
    {
        String result = (type_ == CSSSyntaxType::kIdent) ? string_ : blink::ToString(type_);
