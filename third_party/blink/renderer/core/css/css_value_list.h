...
public:
    ...
    using const_reverse_iterator = HeapVector<Member<const CSSValue>, 4>::const_reverse_iterator;
    ...
    const CSSValue& Item(wtf_size_t index) const
    {
