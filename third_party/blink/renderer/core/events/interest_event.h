...
public:
    static InterestEvent* Create(const AtomicString& type, const InterestEventInit* initializer)
    {
        return MakeGarbageCollected<InterestEvent>(type, initializer);
    }

    static InterestEvent* Create(const AtomicString& type, const String& action, Element* invoker)
    {
    ...
    InterestEvent(const AtomicString& type, const String& action, Element* invoker);
    ...
    void SetInvoker(Element* invoker)
    {
        invoker_ = invoker;
    }
