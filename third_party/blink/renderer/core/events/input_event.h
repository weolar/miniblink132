...
public:
    ...
    static InputEvent* CreateBeforeInput(InputType, const String& data, EventIsComposing, const StaticRangeVector*);
    static InputEvent* CreateBeforeInput(InputType, DataTransfer*, EventIsComposing, const StaticRangeVector*);
    static InputEvent* CreateInput(InputType, const String& data, EventIsComposing, const StaticRangeVector*);
    ...
    // variant.
    InputEvent(const AtomicString& type, const UIEventInit& init, InputType input_type, const String& data, DataTransfer* data_transfer,
