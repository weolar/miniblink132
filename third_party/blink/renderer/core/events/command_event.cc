...
CommandEvent::CommandEvent(const AtomicString& type, const CommandEventInit* initializer)
...
CommandEvent::CommandEvent(const AtomicString& type, const String& command, Element* source)
