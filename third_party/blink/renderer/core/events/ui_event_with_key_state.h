...
public:
    bool ctrlKey() const
    {
        return modifiers_ & WebInputEvent::kControlKey;
    }
    bool shiftKey() const
    {
        return modifiers_ & WebInputEvent::kShiftKey;
    }
    bool altKey() const
    {
        return modifiers_ & WebInputEvent::kAltKey;
    }
    bool metaKey() const
    {
        return modifiers_ & WebInputEvent::kMetaKey;
    }
    ...
    static void DidCreateEventInIsolatedWorld(bool ctrl_key, bool shift_key, bool alt_key, bool meta_key);

    static void SetFromWebInputEventModifiers(EventModifierInit*, WebInputEvent::Modifiers);
...
protected:
    ...
    UIEventWithKeyState(const AtomicString& type, Bubbles, Cancelable, AbstractView*, int detail, WebInputEvent::Modifiers, base::TimeTicks platform_time_stamp,
        InputDeviceCapabilities* source_capabilities = nullptr);
    UIEventWithKeyState(const AtomicString& type, const EventModifierInit* initializer, base::TimeTicks platform_time_stamp);
    ...
    void InitModifiers(bool ctrl_key, bool alt_key, bool shift_key, bool meta_key);
