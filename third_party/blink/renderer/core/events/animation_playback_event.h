...
public:
    ...
    AnimationPlaybackEvent(const AtomicString& type, V8CSSNumberish* current_time, V8CSSNumberish* timeline_time);
    ...
    V8CSSNumberish* timelineTime() const
    {
        return timeline_time_.Get();
    }
