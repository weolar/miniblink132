...
InterestEvent::InterestEvent(const AtomicString& type, const InterestEventInit* initializer)
...
InterestEvent::InterestEvent(const AtomicString& type, const String& action, Element* invoker)
