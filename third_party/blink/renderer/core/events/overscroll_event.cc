...
OverscrollEvent::OverscrollEvent(const AtomicString& type, bool bubbles, double delta_x, double delta_y)
...
OverscrollEvent::OverscrollEvent(const AtomicString& type, bool bubbles, const OverscrollEventInit* initializer)
    : Event(type, (bubbles ? Bubbles::kYes : Bubbles::kNo), Cancelable::kNo)
