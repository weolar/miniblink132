...
public:
    static PromiseRejectionEvent* Create(ScriptState* script_state, const AtomicString& type, const PromiseRejectionEventInit* initializer)
    {
        return MakeGarbageCollected<PromiseRejectionEvent>(script_state, type, initializer);
    }
