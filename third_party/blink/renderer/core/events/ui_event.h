...
public:
    ...
    {
        return MakeGarbageCollected<UIEvent>();
    }
    ...
    UIEvent();
    UIEvent(const AtomicString& type, Bubbles, Cancelable, ComposedMode, base::TimeTicks platform_time_stamp, AbstractView*, int detail,
        InputDeviceCapabilities* source_capabilities);
    UIEvent(const AtomicString&, const UIEventInit*, base::TimeTicks platform_time_stamp);
    ...
    void initUIEvent(const AtomicString& type, bool bubbles, bool cancelable, AbstractView*, int detail);
    void InitUIEventInternal(const AtomicString& type, bool bubbles, bool cancelable, EventTarget* related_target, AbstractView*, int detail,
        InputDeviceCapabilities* source_capabilities);
...
template <> struct DowncastTraits<UIEvent> {
