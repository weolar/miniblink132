...
class CORE_EXPORT FetchHeaderList final : public GarbageCollected<FetchHeaderList> {
public:
    ...
    const std::multimap<String, String, ByteCaseInsensitiveCompare>& List() const
    {
        return header_list_;
    }
...
private:
    ...
    std::multimap<String, String, ByteCaseInsensitiveCompare> header_list_ ALLOW_DISCOURAGED_TYPE("No multimap equivalent in blink");
};
