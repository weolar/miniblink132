...
public:
    ...
    public:
        ...
        MOCK_METHOD1(DrainAsBlobDataHandle, scoped_refptr<BlobDataHandle>(BlobSizePolicy));
        ...
        {
            return "MockBytesConsumer";
        }
    };

    class MockFetchDataLoaderClient : public GarbageCollected<MockFetchDataLoaderClient>, public FetchDataLoader::Client {
    public:
        ...
        MOCK_METHOD1(DidFetchDataLoadedBlobHandleMock, void(scoped_refptr<BlobDataHandle>));
