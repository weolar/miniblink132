...
//   called anymore.
class CORE_EXPORT MultipartParser final : public GarbageCollected<MultipartParser> {
public:
    ...
    public:
        ...
        virtual void PartHeaderFieldsInMultipartReceived(const HTTPHeaderMap& header_fields) = 0;
...
private:
    ...
    public:
        ...
        size_t NumMatchedBytes() const
        {
            return num_matched_bytes_;
        }
    ...
    bool ParseHeaderFields(base::span<const char>& bytes, HTTPHeaderMap* header_fields);
