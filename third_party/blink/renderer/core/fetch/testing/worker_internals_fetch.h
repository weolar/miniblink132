...
public:
    ...
    static ScriptPromise<IDLLong> getInitialResourcePriority(ScriptState*, WorkerInternals&, const String& url, WorkerGlobalScope*);

private:
    static void ResolveResourcePriority(ScriptPromiseResolver<IDLLong>*, int resource_load_priority);
};
