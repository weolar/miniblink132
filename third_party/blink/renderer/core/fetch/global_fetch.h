...
public:
    ...
    public:
        ...
        virtual ScriptPromise<Response> Fetch(ScriptState*, const V8RequestInfo*, const RequestInit*, ExceptionState&) = 0;

        virtual FetchLaterResult* FetchLater(ScriptState*, const V8RequestInfo*, const DeferredRequestInit*, ExceptionState&);
    ...
    static ScriptPromise<Response> fetch(
