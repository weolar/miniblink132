...
class CORE_EXPORT FetchManager final : public GarbageCollected<FetchManager>, public ExecutionContextLifecycleObserver {
public:
    explicit FetchManager(ExecutionContext*);

    ScriptPromise<Response> Fetch(ScriptState*, FetchRequestData*, AbortSignal*, ExceptionState&);
...
class CORE_EXPORT FetchLaterManager final : public GarbageCollected<FetchLaterManager>,
                                            public ExecutionContextLifecycleObserver,
                                            public mojom::blink::PermissionObserver {
public:
    explicit FetchLaterManager(ExecutionContext*);

    FetchLaterResult* FetchLater(ScriptState*, FetchRequestData*, AbortSignal*, std::optional<DOMHighResTimeStamp>, ExceptionState&);
    ...
    void RecreateTimerForTesting(scoped_refptr<base::SingleThreadTaskRunner>, const base::TickClock*);
    static ResourceLoadPriority ComputeLoadPriorityForTesting(const FetchParameters& params);
...
private:
    ...
    std::unique_ptr<network::ResourceRequest> PrepareNetworkRequest(ResourceRequest request, const ResourceLoaderOptions& options) const;
    ...
    mojom::blink::PermissionStatus background_sync_permission_ = mojom::blink::PermissionStatus::DENIED;
    HeapMojoReceiver<mojom::blink::PermissionObserver, FetchLaterManager> permission_observer_receiver_;
};
