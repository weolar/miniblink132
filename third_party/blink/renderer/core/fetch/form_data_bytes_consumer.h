...
public:
    ...
    CORE_EXPORT FormDataBytesConsumer(ExecutionContext*, scoped_refptr<EncodedFormData>);
    CORE_EXPORT FormDataBytesConsumer(ExecutionContext*, scoped_refptr<EncodedFormData>, BytesConsumer* consumer_for_testing);
...
private:
    static BytesConsumer* GetImpl(ExecutionContext*, scoped_refptr<EncodedFormData>, BytesConsumer* consumer_for_testing);
