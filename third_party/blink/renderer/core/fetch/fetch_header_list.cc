...
void FetchHeaderList::Set(const String& name, const String& value)
{
    ...
    const FetchHeaderList::Header newHeader = std::make_pair(existingHeader != header_list_.end() ? existingHeader->first : name, value);
...
String FetchHeaderList::GetAsRawString(int status_code, String status_message) const
{
