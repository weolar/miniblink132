...
TEST(FetchRequestDataTest, For_ServiceWorkerFetchEvent_Headers)
{
    FetchRequestData* request_data = FetchRequestData::Create(
        /*script_state=*/nullptr, PrepareFetchAPIRequest(), FetchRequestData::ForServiceWorkerFetchEvent::kTrue);
...
{
    FetchRequestData* request_data = FetchRequestData::Create(
        /*script_state=*/nullptr, PrepareFetchAPIRequest(), FetchRequestData::ForServiceWorkerFetchEvent::kFalse);
...
TEST(FetchRequestDataTest, CheckTrustTokenParamsAreCopiedWithCreate)
{
    ...
    issuers.push_back(::blink::SecurityOrigin::CreateFromString("https://aaa.example"));
    issuers.push_back(::blink::SecurityOrigin::CreateFromString("https://bbb.example"));
    WTF::Vector<WTF::String> additional_signed_headers = { "aaa", "bbb" };
    auto trust_token_params = network::mojom::blink::TrustTokenParams::New(network::mojom::TrustTokenOperationType::kRedemption,
        network::mojom::TrustTokenRefreshPolicy::kUseCached,
        /* custom_key_commitment=*/"custom_key_commitment",
        /* custom_issuer=*/
        ::blink::SecurityOrigin::CreateFromString("https://ccc.example"), network::mojom::TrustTokenSignRequestData::kInclude,
    ...
    FetchRequestData* request_data = FetchRequestData::Create(
        /*script_state=*/nullptr, std::move(request), FetchRequestData::ForServiceWorkerFetchEvent::kTrue);
...
TEST(FetchRequestDataTest, CheckServiceworkerRaceNetworkRequestToken)
{
    ...
    EXPECT_TRUE(cloned_request_data->ServiceWorkerRaceNetworkRequestToken().is_empty());
}
