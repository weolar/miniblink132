...
class CORE_EXPORT BytesUploader : public GarbageCollected<BytesUploader>,
...
public:
    ...
    BytesUploader(ExecutionContext* execution_context, BytesConsumer* consumer,
...
private:
    ...
    HeapMojoReceiver<network::mojom::blink::ChunkedDataPipeGetter, BytesUploader> receiver_;
