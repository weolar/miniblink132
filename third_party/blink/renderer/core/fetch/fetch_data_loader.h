...
public:
    ...
    public:
        ...
        virtual void DidFetchDataStartedDataPipe(mojo::ScopedDataPipeConsumerHandle handle)
        {
            NOTREACHED();
        }
        ...
        virtual void DidFetchDataLoadedDataPipe()
        {
            NOTREACHED();
        }
        ...
        virtual void DidFetchDataLoadedCustomFormat()
        {
            NOTREACHED();
        }
    ...
    static FetchDataLoader* CreateLoaderAsBlobHandle(const String& mime_type, scoped_refptr<base::SingleThreadTaskRunner>);
    static FetchDataLoader* CreateLoaderAsArrayBuffer();
    static FetchDataLoader* CreateLoaderAsFailure();
    static FetchDataLoader* CreateLoaderAsFormData(const String& multipart_boundary);
    ...
    static FetchDataLoader* CreateLoaderAsString(const TextResourceDecoderOptions&);
    // The mojo::DataPipe consumer handle is provided via the
    // Client::DidFetchStartedDataPipe() callback.
    static FetchDataLoader* CreateLoaderAsDataPipe(scoped_refptr<base::SingleThreadTaskRunner>);
