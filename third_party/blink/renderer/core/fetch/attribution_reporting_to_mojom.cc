...
AttributionReportingEligibility ConvertAttributionReportingRequestOptionsToMojom(
    const AttributionReportingRequestOptions& options, const ExecutionContext& execution_context, ExceptionState& exception_state)
{
    bool enabled = execution_context.IsFeatureEnabled(mojom::blink::PermissionsPolicyFeature::kAttributionReporting);
