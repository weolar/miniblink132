...
CORE_EXPORT network::mojom::RequestMode V8RequestModeToMojom(const V8RequestMode& mode);
CORE_EXPORT network::mojom::RequestDestination V8RequestDestinationToMojom(const V8RequestDestination& destination);
