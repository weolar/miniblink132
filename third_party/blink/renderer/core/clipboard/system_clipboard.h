...
class CORE_EXPORT SystemClipboard final : public GarbageCollected<SystemClipboard> {
public:
    ...
    void ReadPlainText(mojom::blink::ClipboardBuffer buffer, mojom::blink::ClipboardHost::ReadTextCallback callback);
    ...
    void WriteHTML(const String& markup, const KURL& document_url, SmartReplaceOption = kCannotSmartReplace);
    ...
    void ReadAvailableCustomAndStandardFormats(mojom::blink::ClipboardHost::ReadAvailableCustomAndStandardFormatsCallback callback);
    void ReadUnsanitizedCustomFormat(const String& type, mojom::blink::ClipboardHost::ReadUnsanitizedCustomFormatCallback callback);

    void WriteUnsanitizedCustomFormat(const String& type, mojo_base::BigBuffer data);
...
private:
    ...
    public:
        ...
        void SetHtml(mojom::blink::ClipboardBuffer buffer, const String& html, const KURL& url, unsigned fragment_start, unsigned fragment_end);
        ...
        void SetPng(mojom::blink::ClipboardBuffer buffer, const mojo_base::BigBuffer& png);

        bool HasFiles(mojom::blink::ClipboardBuffer buffer) const;
        mojom::blink::ClipboardFilesPtr Files(mojom::blink::ClipboardBuffer buffer) const;
        // Because of the special handling needed to clone ClipboardFilesPtr,
        // SetFiles() needs to change the function argument `files`.
        void SetFiles(mojom::blink::ClipboardBuffer buffer, mojom::blink::ClipboardFilesPtr& files);

        bool HasCustomData(mojom::blink::ClipboardBuffer buffer, const String& type) const;
        String CustomData(mojom::blink::ClipboardBuffer buffer, const String& type) const;
        void SetCustomData(mojom::blink::ClipboardBuffer buffer, const String& type, const String& data);

        static mojom::blink::ClipboardFilesPtr CloneFiles(mojom::blink::ClipboardFilesPtr& files);
    ...
    mojom::blink::ClipboardBuffer buffer_ = mojom::blink::ClipboardBuffer::kStandard;
