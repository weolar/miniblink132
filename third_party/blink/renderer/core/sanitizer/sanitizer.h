...
public:
    ...
    static Sanitizer* Create(ExecutionContext*, const SanitizerConfig*, ExceptionState&);
    Sanitizer() = default;
    ~Sanitizer() override = default;

    // API methods:
    void allowElement(const V8UnionSanitizerElementNamespaceWithAttributesOrString*);
    void removeElement(const V8UnionSanitizerElementNamespaceOrString*);
    void replaceWithChildrenElement(const V8UnionSanitizerElementNamespaceOrString*);
    ...
    const HashSet<QualifiedName>& allow_elements()
    {
        return allow_elements_;
    }
    const HashSet<QualifiedName>& remove_elements()
    {
        return remove_elements_;
    }
    const HashSet<QualifiedName>& replace_elements()
    {
        return replace_elements_;
    }
    const HashSet<QualifiedName>& allow_attrs()
    {
        return allow_attrs_;
    }
    const HashSet<QualifiedName>& remove_attrs()
    {
        return remove_attrs_;
    }
    const HashMap<QualifiedName, HashSet<QualifiedName>>& allow_attrs_per_element()
    {
        return allow_attrs_per_element_;
    }
    const HashMap<QualifiedName, HashSet<QualifiedName>>& remove_attrs_per_element()
    {
...
private:
    ...
    QualifiedName getFrom(const V8UnionSanitizerElementNamespaceWithAttributesOrString*) const;
    QualifiedName getFrom(const V8UnionSanitizerElementNamespaceOrString*) const;
    QualifiedName getFrom(const V8UnionSanitizerAttributeNamespaceOrString*) const;
