...
class CORE_EXPORT CssSelectorFragmentAnchor final : public SelectorFragmentAnchor {
public:
    static CssSelectorFragmentAnchor* TryCreate(const KURL& url, LocalFrame& frame, bool should_scroll);

    CssSelectorFragmentAnchor(Element& anchor_node, LocalFrame& frame, bool should_scroll);
    CssSelectorFragmentAnchor(const CssSelectorFragmentAnchor&) = delete;
    CssSelectorFragmentAnchor& operator=(const CssSelectorFragmentAnchor&) = delete;
    ...
    bool IsSelectorFragmentAnchor() override
    {
        return true;
    }
