...
class CORE_EXPORT TextFragmentHandler final : public GarbageCollected<TextFragmentHandler>, public blink::mojom::blink::TextFragmentReceiver {
public:
    ...
    static void DidCreateTextFragment(AnnotationAgentImpl& agent, Document& owning_document);
    ...
    void BindTextFragmentReceiver(mojo::PendingReceiver<mojom::blink::TextFragmentReceiver> producer);
...
private:
    FRIEND_TEST_ALL_PREFIXES(TextFragmentHandlerTest, IfGeneratorResetShouldRecordCorrectError);
    ...
    // result.
    void DidFinishSelectorGeneration(const TextFragmentSelector& selector, shared_highlighting::LinkGenerationError error);
    ...
    void InvokeReplyCallback(const TextFragmentSelector& selector, shared_highlighting::LinkGenerationError error);
    ...
    std::optional<shared_highlighting::LinkGenerationReadyStatus> selector_ready_status_;
    ...
    HeapMojoReceiver<blink::mojom::blink::TextFragmentReceiver, TextFragmentHandler> selector_producer_ { this, nullptr };
