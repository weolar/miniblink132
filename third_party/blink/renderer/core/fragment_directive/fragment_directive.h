...
public:
    ...
    template <typename DirectiveType> HeapVector<Member<DirectiveType>> GetDirectives()
    {
    ...
    ScriptPromise<SelectorDirective> createSelectorDirective(ScriptState*, const V8UnionRangeOrSelection*);
