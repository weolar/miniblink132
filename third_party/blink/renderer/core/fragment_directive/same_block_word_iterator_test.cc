...
TEST_F(SameBlockWordIteratorTest, GetNextWord)
{
    ...
    ForwardSameBlockWordIterator* iterator = MakeGarbageCollected<ForwardSameBlockWordIterator>(PositionInFlatTree(*node, 0));
...
TEST_F(SameBlockWordIteratorTest, GetNextWord_ExtraSpace)
{
    ...
    Node* node = GetDocument().getElementById(AtomicString("first"))->firstChild();
    ForwardSameBlockWordIterator* iterator = MakeGarbageCollected<ForwardSameBlockWordIterator>(PositionInFlatTree(*node, 6));
    iterator->AdvanceNextWord();
...
TEST_F(SameBlockWordIteratorTest, GetNextWord_WithComment)
{
    ...
    BackwardSameBlockWordIterator* iterator = MakeGarbageCollected<BackwardSameBlockWordIterator>(PositionInFlatTree(*node, 9));
    iterator->AdvanceNextWord();
    EXPECT_EQ("paragraph", iterator->TextFromStart());
...
TEST_F(SameBlockWordIteratorTest, GetNextWord_NestedTextNode)
{
    ...
    Node* node = GetDocument().getElementById(AtomicString("first"))->firstChild();
    ForwardSameBlockWordIterator* iterator = MakeGarbageCollected<ForwardSameBlockWordIterator>(PositionInFlatTree(*node, 5));
    iterator->AdvanceNextWord();
...
TEST_F(SameBlockWordIteratorTest, GetPreviousWord)
{
    ...
    BackwardSameBlockWordIterator* iterator = MakeGarbageCollected<BackwardSameBlockWordIterator>(PositionInFlatTree(*node, 16));
    iterator->AdvanceNextWord();
    EXPECT_EQ("paragraph", iterator->TextFromStart());
...
TEST_F(SameBlockWordIteratorTest, GetPreviousWord_ExtraSpace)
{
    ...
    Node* node = GetDocument().getElementById(AtomicString("first"))->firstChild();
    BackwardSameBlockWordIterator* iterator = MakeGarbageCollected<BackwardSameBlockWordIterator>(PositionInFlatTree(*node, 25));
    iterator->AdvanceNextWord();
    EXPECT_EQ("paragraph", iterator->TextFromStart());
...
TEST_F(SameBlockWordIteratorTest, GetPreviousWord_NestedTextNode)
{
    ...
    BackwardSameBlockWordIterator* iterator = MakeGarbageCollected<BackwardSameBlockWordIterator>(PositionInFlatTree(*node, 11));
    iterator->AdvanceNextWord();
    EXPECT_EQ("paragraph", iterator->TextFromStart());
...
TEST_F(SameBlockWordIteratorTest, GetPreviousWord_NestedInvisibleBlock)
{
    ...
    Node* node = GetDocument().getElementById(AtomicString("div"))->nextSibling();
    BackwardSameBlockWordIterator* iterator = MakeGarbageCollected<BackwardSameBlockWordIterator>(PositionInFlatTree(*node, 0));
    iterator->AdvanceNextWord();
    EXPECT_EQ("First", iterator->TextFromStart());
...
TEST_F(SameBlockWordIteratorTest, GetNextWord_HalfWord)
{
    ...
    Node* node = GetDocument().getElementById(AtomicString("first"))->firstChild();
    ForwardSameBlockWordIterator* iterator = MakeGarbageCollected<ForwardSameBlockWordIterator>(PositionInFlatTree(*node, 2));
    iterator->AdvanceNextWord();
