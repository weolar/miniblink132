...
class CORE_EXPORT TextFragmentSelectorGenerator final : public GarbageCollected<TextFragmentSelectorGenerator>, public TextFragmentFinder::Client {
    using GenerateCallback = base::OnceCallback<void(const TextFragmentSelector&, shared_highlighting::LinkGenerationError)>;
...
public:
    ...
    TextFragmentSelectorGenerator& operator=(const TextFragmentSelectorGenerator&) = delete;
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetPreviousTextEndPosition_PrevNode);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetPreviousTextEndPosition_PrevTextNode);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetPreviousTextEndPosition_ParentNode);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetPreviousTextEndPosition_SpacesBeforeSelection);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetPreviousTextEndPosition_InvisibleBeforeSelection);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetPreviousTextEndPosition_NoPrevious);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetNextTextStartPosition_NextNode);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetNextTextStartPosition_NextNode_WithComment);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetNextTextStartPosition_NextTextNode);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetNextTextStartPosition_ParentNode);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetNextTextStartPosition_SpacesAfterSelection);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetNextTextStartPosition_InvisibleAfterSelection);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, RangeSelector_RangeMultipleNonBlockNodes);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetNextTextStartPosition_NoNextNode);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, ExactTextSelector_Long);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, GetPreviousTextEndPosition_ShouldSkipNodesWithNoLayoutObject);
    FRIEND_TEST_ALL_PREFIXES(TextFragmentSelectorGeneratorTest, RemoveLayoutObjectAsync);
    ...
    PositionInFlatTree GetNextTextStartPosition(const PositionInFlatTree& position);

    // Returns last position for the text preceding given position.
    PositionInFlatTree GetPreviousTextEndPosition(const PositionInFlatTree& position);
