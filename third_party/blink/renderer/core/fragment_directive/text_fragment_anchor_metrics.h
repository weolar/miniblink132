...
class CORE_EXPORT TextFragmentAnchorMetrics final : public GarbageCollected<TextFragmentAnchorMetrics> {
public:
    ...
    static TextFragmentAnchorParameters GetParametersForSelector(const TextFragmentSelector& selector);
