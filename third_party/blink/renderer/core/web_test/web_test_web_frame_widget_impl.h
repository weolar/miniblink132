...
class WebTestWebFrameWidgetImpl : public WebFrameWidgetImpl, public FrameWidgetTestHelper {
public:
    WebTestWebFrameWidgetImpl(base::PassKey<WebLocalFrame>, CrossVariantMojoAssociatedRemote<mojom::blink::FrameWidgetHostInterfaceBase> frame_widget_host,
    ...
    void UpdateAllLifecyclePhasesAndComposite(base::OnceClosure completion_callback) override;
...
private:
    ...
    void StartDragging(LocalFrame* source_frame, const WebDragData& drag_data, DragOperationsMask operations_allowed, const SkBitmap& drag_image,
        const gfx::Vector2d& cursor_offset, const gfx::Rect& drag_obj_rect) override;
    ...
    static void DoComposite(cc::LayerTreeHost* layer_tree_host, bool do_raster, base::OnceClosure callback);
