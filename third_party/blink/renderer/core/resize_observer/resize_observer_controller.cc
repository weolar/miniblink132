...
const char ResizeObserverController::kSupplementName[] = "ResizeObserverController";

ResizeObserverController* ResizeObserverController::From(LocalDOMWindow& window)
{
...
ResizeObserverController* ResizeObserverController::FromIfExists(LocalDOMWindow& window)
{
