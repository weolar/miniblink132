...
class CORE_EXPORT ResizeObserver final : public ScriptWrappable, public ActiveScriptWrappable<ResizeObserver>, public ExecutionContextClient {
...
public:
    ...
    public:
        ...
        virtual void OnResize(const HeapVector<Member<ResizeObserverEntry>>& entries) = 0;
        ...
        virtual bool SkipNonAtomicInlineObservations() const
        {
            return false;
        }
    };
    ...
    {
        return skipped_observations_;
    }
    void DeliverObservations();
    void ClearObservations();

    ResizeObserverBoxOptions V8EnumToBoxOptions(V8ResizeObserverBoxOptions::Enum box_options);
