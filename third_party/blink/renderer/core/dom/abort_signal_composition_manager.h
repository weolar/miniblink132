...
class CORE_EXPORT AbortSignalCompositionManager : public GarbageCollected<AbortSignalCompositionManager> {
public:
    ...
    AbortSignalCompositionManager& operator=(const AbortSignalCompositionManager&) = delete;
    ...
    // Used for casting.
    virtual bool IsSourceSignalManager() const
    {
        return false;
    }
    virtual bool IsDependentSignalManager() const
    {
        return false;
    }
...
// signals.
class CORE_EXPORT SourceSignalCompositionManager : public AbortSignalCompositionManager {
public:
    SourceSignalCompositionManager(AbortSignal&, AbortSignalCompositionType);
    ~SourceSignalCompositionManager() override;
    SourceSignalCompositionManager(const SourceSignalCompositionManager&) = delete;
    SourceSignalCompositionManager& operator=(const SourceSignalCompositionManager&) = delete;

    void Trace(Visitor*) const override;
    void Settle() override;

    bool IsSourceSignalManager() const override
    {
        return true;
    }
...
// source signals.
class CORE_EXPORT DependentSignalCompositionManager : public AbortSignalCompositionManager {
public:
    DependentSignalCompositionManager(AbortSignal&, AbortSignalCompositionType, const HeapVector<Member<AbortSignal>>& source_signals);
    ~DependentSignalCompositionManager() override;
    DependentSignalCompositionManager(const DependentSignalCompositionManager&) = delete;
    DependentSignalCompositionManager& operator=(const DependentSignalCompositionManager&) = delete;

    void Trace(Visitor*) const override;
    void Settle() override;

    bool IsDependentSignalManager() const override
    {
        return true;
    }
...
template <> struct DowncastTraits<DependentSignalCompositionManager> {
...
template <> struct DowncastTraits<SourceSignalCompositionManager> {
    static bool AllowFrom(const AbortSignalCompositionManager& manager)
    {
