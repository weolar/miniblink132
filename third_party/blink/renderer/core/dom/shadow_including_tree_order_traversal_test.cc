...
void RemoveWhiteSpaceOnlyTextNodes(ContainerNode& container)
{
    ...
    for (Node& descendant : NodeTraversal::DescendantsOf(container)) {
        if (auto* text = DynamicTo<Text>(&descendant); text && text->ContainsOnlyWhitespaceOrEmpty()) {
...
TEST_F(ShadowIncludingTreeOrderTraversalTest, Next)
{
    ...
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*GetDocument().body(), &GetDocument()), c0);
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*c0, &GetDocument()), c00);
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*c00, &GetDocument()), shadow_root_0);
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*shadow_root_0, &GetDocument()), c01);
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*c01, &GetDocument()), shadow_root_1);
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*shadow_root_1, &GetDocument()), s0);
    ...
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*c02, &GetDocument()), shadow_root_2);
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*shadow_root_2, &GetDocument()), t0);
    ...
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*t01, &GetDocument()), c020);
    EXPECT_EQ(ShadowIncludingTreeOrderTraversal::Next(*c020, &GetDocument()), c021);
...
TEST_F(ShadowIncludingTreeOrderTraversalTest, DescendantsOf)
{
    ...
    EXPECT_THAT(GatherElementIdsFromTraversalRange(ShadowIncludingTreeOrderTraversal::DescendantsOf(*GetDocument().body())),
        ElementsAre("a0", "a00", "a01", "a1", "shadow", "b0", "b00", "a10", "a2"));
    EXPECT_THAT(GatherElementIdsFromTraversalRange(ShadowIncludingTreeOrderTraversal::InclusiveDescendantsOf(*GetDocument().body())),
        ElementsAre("body", "a0", "a00", "a01", "a1", "shadow", "b0", "b00", "a10", "a2"));
}
...
TEST_F(ShadowIncludingTreeOrderTraversalTest, ChildrenOf)
{
    ...
    EXPECT_THAT(GatherElementIdsFromTraversalRange(ShadowIncludingTreeOrderTraversal::ChildrenOf(*GetDocument().body())), ElementsAre("a0", "a1", "a2"));
    EXPECT_THAT(GatherElementIdsFromTraversalRange(ShadowIncludingTreeOrderTraversal::ChildrenOf(*GetElementById("a1"))), ElementsAre("shadow", "a10"));
    EXPECT_THAT(GatherElementIdsFromTraversalRange(ShadowIncludingTreeOrderTraversal::ChildrenOf(*GetElementById("a2"))), ElementsAre("shadow", "a20"));
}
