...
public:
    ...
    FlatTreeTraversalForbiddenScope(const FlatTreeTraversalForbiddenScope&) = delete;
    FlatTreeTraversalForbiddenScope& operator=(const FlatTreeTraversalForbiddenScope&) = delete;
