...
class CORE_EXPORT EventListener : public GarbageCollected<EventListener>, public NameClient {
public:
    ...
    virtual bool IsEventHandlerForContentAttribute() const
    {
        return false;
    }
    ...
    virtual const String& ScriptBody() const
    {
    ...
    virtual bool IsJSBasedEventListener() const
    {
        return false;
    }
    virtual bool IsNativeEventListener() const
    {
        return false;
    }
