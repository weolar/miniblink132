...
class RegisteredEventListener final : public GarbageCollected<RegisteredEventListener> {
public:
    ...
    RegisteredEventListener& operator=(const RegisteredEventListener& that) = delete;
    ...
    bool PassiveSpecified() const
    {
        return passive_specified_;
    }
