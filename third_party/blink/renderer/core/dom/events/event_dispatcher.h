...
public:
    ...
    static void DispatchSimulatedClick(Node&, const Event* underlying_event, SimulatedClickCreationScope);
...
private:
    ...
    EventDispatchContinuation DispatchEventPreProcess(Node* activation_target, EventDispatchHandlingState*&);
    EventDispatchContinuation DispatchEventAtCapturing();
    void DispatchEventAtBubbling();
    void DispatchEventPostProcess(Node* activation_target, EventDispatchHandlingState*);
