...
public:
    LiveNodeList(ContainerNode& owner_node, CollectionType collection_type, NodeListInvalidationType invalidation_type,
    ...
    virtual bool CanTraverseBackward() const
    {
        return true;
    }
    virtual Element* TraverseToFirst() const;
    virtual Element* TraverseToLast() const;
    virtual Element* TraverseForwardToOffset(unsigned offset, Element& current_node, unsigned& current_offset) const;
    virtual Element* TraverseBackwardToOffset(unsigned offset, Element& current_node, unsigned& current_offset) const;
...
template <> struct DowncastTraits<LiveNodeList> {
