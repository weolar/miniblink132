...
using DocumentClassFlags = base::EnumSet<DocumentClass, DocumentClass::kMinValue, DocumentClass::kMaxValue>;
...
using CachedAttrAssociatedElementsMap = HeapHashMap<QualifiedName, Member<FrozenArray<Element>>>;
...
public:
    ...
    explicit Document(const DocumentInit& init, DocumentClassFlags flags = DocumentClassFlags());
    ~Document() override;
    ...
    static const Position PositionAdjustedToTreeScope(const TreeScope&, const Position&);
    ...
    {
        return is_initial_empty_document_;
    }
    ...
    {
        return *viewport_data_;
    }

    void SetDoctype(DocumentType*);
    DocumentType* doctype() const
    {
        return doc_type_.Get();
    }
    ...
    CaretPosition* caretPositionFromPoint(float x, float y, const CaretPositionFromPointOptions* options);
    ...
    {
        return xml_standalone_ == kStandalone;
    }
    ...
    {
        return is_srcdoc_document_;
    }
    bool IsMobileDocument() const
    {
        return is_mobile_document_;
    }
    ...
    virtual bool IsJSONDocument() const
    {
        return false;
    }
    ...
    {
        return is_for_external_handler_;
    }
    ...
    KURL CompleteURL(const String&, const CompleteURLPreloadStatus preload_status = kIsNotPreload) const;
    // Creates URL based on passed relative url and passed base URL override.
    KURL CompleteURLWithOverride(const String&, const KURL& base_url_override, const CompleteURLPreloadStatus preload_status = kIsNotPreload) const;
    ...
    {
        return compatibility_mode_ == kQuirksMode;
    }
    ...
    {
        return compatibility_mode_ == kNoQuirksMode;
    }
    ...
    {
        return is_freezing_in_progress_;
    }
    ...
    bool Parsing() const
    {
        return parsing_state_ == kParsing;
    }
    ...
    void MoveElementExplicitlySetAttrElementsMapToNewDocument(const Element*, Document& new_document);
    ...
    void MoveElementCachedAttrAssociatedElementsMapToNewDocument(Element*, Document& new_document);
    ...
    bool CanAcceptChild(const Node* new_child, const VectorOf<Node>* new_children, const Node* next, const Node* old_child, ExceptionState&) const;
    ...
    enum ListenerType {
        ...
        // 0 bits remaining
        kDOMMutationEventListener = kDOMSubtreeModifiedListener | kDOMNodeInsertedListener | kDOMNodeRemovedListener | kDOMNodeRemovedFromDocumentListener
            | kDOMNodeInsertedIntoDocumentListener | kDOMCharacterDataModifiedListener,
    };
    ...
    bool HasAnyNodeWithEventListeners() const
    {
        return event_listener_counts_;
    }
    ...
    {
        return mutation_observer_types_;
    }
    ...
    void WillChangeFrameOwnerProperties(int margin_width, int margin_height, mojom::blink::ScrollbarMode, bool is_display_none,
    ...
    ScriptPromise<IDLBoolean> hasPrivateToken(ScriptState* script_state, const String& issuer, ExceptionState&);
    ...
    // is unavailable).
    ScriptPromise<IDLBoolean> hasRedemptionRecord(ScriptState* script_state, const String& issuer, ExceptionState&);
    ...
    {
        return is_running_exec_command_;
    }
    ...
    {
        return dom_tree_version_;
    }

    uint64_t StyleVersion() const
    {
        return style_version_;
    }
    ...
    {
        return is_dns_prefetch_enabled_;
    }
    ...
    {
        return encoding_data_.SawDecodingError();
    }

    // Draggable regions are set using the "app-region" CSS property.
    void SetDraggableRegionsDirty(bool f)
    {
        draggable_regions_dirty_ = f;
    }
    bool DraggableRegionsDirty() const
    {
        return draggable_regions_dirty_;
    }
    bool HasDraggableRegions() const
    {
        return has_draggable_regions_;
    }
    void SetHasDraggableRegions(bool f)
    {
        has_draggable_regions_ = f;
    }
    ...
    {
        contains_plugins_ = true;
    }
    bool ContainsPlugins() const
    {
        return contains_plugins_;
    }
    ...
    void EnqueueScrollSnapChangeEvent(Node* target, Member<Node>& block_target, Member<Node>& inline_target);
    void EnqueueScrollSnapChangingEvent(Node* target, Member<Node>& block_target, Member<Node>& inline_target);
    ...
    {
        return write_recursion_depth_ > 0;
    }
    ...
    {
        return element_data_cache_.Get();
    }
    ...
    const PopoverStack& PopoverHintStack() const
    {
        return popover_hint_stack_;
    }
    PopoverStack& PopoverHintStack()
    {
        return popover_hint_stack_;
    }
    bool PopoverHintShowing() const
    {
        return !popover_hint_stack_.empty();
    }
    PopoverStack& PopoverAutoStack()
    {
        return popover_auto_stack_;
    }
    const PopoverStack& PopoverAutoStack() const
    {
        return popover_auto_stack_;
    }
    bool PopoverAutoShowing() const
    {
        return !popover_auto_stack_.empty();
    }
    ...
    bool DOMPartsInUse() const
    {
        return document_part_root_ != nullptr;
    }
    ...
    {
        return template_document_host_ != nullptr;
    }
    Document& EnsureTemplateDocument();
    Document* TemplateDocumentHost()
    {
        return template_document_host_.Get();
    }
    ...
    void DidChangeFormRelatedElementDynamically(HTMLElement*, WebFormRelatedChangeType);
    ...
    {
        return viewport_unit_flags_ & static_cast<unsigned>(ViewportUnitFlag::kStatic);
    }
    bool HasDynamicViewportUnits() const
    {
        return viewport_unit_flags_ & static_cast<unsigned>(ViewportUnitFlag::kDynamic);
    }
    ...
    bool InPseudoHasChecking() const
    {
        return in_pseudo_has_checking_;
    }
    ...
    {
        may_contain_shadow_roots_ = true;
    }

    bool MayContainShadowRoots() const
    {
        return may_contain_shadow_roots_;
    }
    ...
    void MaybeRecordSvgImageProcessingTime(int data_change_count, base::TimeDelta data_change_elapsed_time) const;
    ...
    {
        return is_vertical_scroll_enforced_;
    }
    ...
    unsigned GetNumberOfCanvases() const
    {
        return num_canvases_;
    }
    ...
    const ui::ColorProvider* GetColorProviderForPainting(mojom::blink::ColorScheme color_scheme) const;
    ...
    {
        return is_for_markup_sanitization_;
    }
    ...
    HeapObserverList<SynchronousMutationObserver>& SynchronousMutationObserverSet()
    {
        return synchronous_mutation_observer_set_;
    }

    void NotifyUpdateCharacterData(CharacterData* character_data, const TextDiffRange&);
    ...
    // implicit equivalent)?
    bool HasDirAttribute() const
    {
        return has_dir_attribute_;
    }
    void SetHasDirAttribute()
    {
        has_dir_attribute_ = true;
    }
    ...
    // it.
    bool HasAtLeastOneDataList() const
    {
        return data_list_count_;
    }

    void IncrementDisabledFieldsetCount()
    {
    ...
    static Document* parseHTMLUnsafe(ExecutionContext* context, const String& html, ExceptionState& exception_state);
    ...
    // should be merged.
    static Document* parseHTMLUnsafe(ExecutionContext* context, const String& html, SetHTMLOptions* options, ExceptionState& exception_state);
    static Document* parseHTML(ExecutionContext* context, const String& html, SetHTMLOptions* options, ExceptionState& exception_state);
...
protected:
    ...
    {
        compatibility_mode_locked_ = true;
    }
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(DictionaryLoadFromHeaderTest, LoadDictionaryFromHeader);
    FRIEND_TEST_ALL_PREFIXES(RangeTest, ContainerNodeRemovalWithSequentialFocusNavigationStartingPoint);
    ...
    void LeavePseudoHasChecking()
    {
        in_pseudo_has_checking_ = false;
    }
    ...
    static Document* parseHTMLInternal(ExecutionContext* context, const String& html, SetHTMLOptions* options, bool safe, ExceptionState& exception_state);
    ...
    class PendingJavascriptUrl final : public GarbageCollected<PendingJavascriptUrl> {
    public:
    ...
    HeapHashSet<Member<FocusedElementChangeObserver>> focused_element_change_observers_;
    ...
    using ElementComputedStyleMap = HeapHashMap<WeakMember<Element>, Member<StylePropertyMapReadOnly>>;
    ...
    HeapHashSet<WeakMember<const LiveNodeListBase>> lists_invalidated_at_document_;
    ...
    // O(n) instead of O(1).
    class TopLayerPendingRemoval : public GarbageCollected<TopLayerPendingRemoval> {
    public:
    ...
    // necessary.
    Member<BeforeUnloadEventListener> mime_handler_view_before_unload_event_listener_;
    ...
    HeapHashMap<WeakMember<const Element>, Member<ExplicitlySetAttrElementsMap>> element_explicitly_set_attr_elements_map_;
    HeapHashMap<WeakMember<Element>, Member<CachedAttrAssociatedElementsMap>> element_cached_attr_associated_elements_map_;

    HeapObserverList<SynchronousMutationObserver> synchronous_mutation_observer_set_;
    ...
    DeclarativeShadowRootAllowState declarative_shadow_root_allow_state_ = DeclarativeShadowRootAllowState::kNotSet;
    ...
    std::optional<net::SchemefulSite> cached_top_frame_site_for_visited_links_ = std::nullopt;

#if BUILDFLAG(IS_ANDROID)
    HeapMojoRemote<payments::facilitated::mojom::blink::PaymentLinkHandler> payment_link_handler_ { nullptr };
...
template <> struct DowncastTraits<Document> {
