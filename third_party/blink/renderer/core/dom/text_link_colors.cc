...
{
    return has_custom_text_color_ ? text_color_ : color_scheme == mojom::blink::ColorScheme::kLight ? Color::kBlack : Color::kWhite;
}
...
const Color& TextLinkColors::LinkColor(mojom::blink::ColorScheme color_scheme) const
{
    return has_custom_link_color_ ? link_color_ : color_scheme == mojom::blink::ColorScheme::kLight ? kDefaultLinkColorLight : kDefaultLinkColorDark;
}
...
const Color& TextLinkColors::VisitedLinkColor(mojom::blink::ColorScheme color_scheme) const
{
    return has_custom_visited_link_color_                   ? visited_link_color_
        : color_scheme == mojom::blink::ColorScheme::kLight ? kDefaultVisitedLinkColorLight
...
const Color& TextLinkColors::ActiveLinkColor(mojom::blink::ColorScheme color_scheme) const
{
    return has_custom_active_link_color_                    ? active_link_color_
        : color_scheme == mojom::blink::ColorScheme::kLight ? kDefaultActiveLinkColorLight
