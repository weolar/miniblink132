...
class CORE_EXPORT FrameCallback : public GarbageCollected<FrameCallback>, public NameClient {
public:
    ...
    bool GetUseLegacyTimeBase() const
    {
        return use_legacy_time_base_;
    }
    void SetId(int id)
    {
        id_ = id;
...
public:
    ...
    void ExecuteFrameCallbacks(double high_res_now_ms, double high_res_now_ms_legacy);
