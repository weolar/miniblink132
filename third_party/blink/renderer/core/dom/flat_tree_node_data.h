...
public:
    ...
    {
        return !assigned_slot_ && !previous_in_assigned_nodes_ && !next_in_assigned_nodes_;
    }
#endif
...
private:
    ...
    void SetNextInAssignedNodes(Node* next)
    {
        next_in_assigned_nodes_ = next;
    }
    ...
    {
        return assigned_slot_.Get();
    }
    Node* PreviousInAssignedNodes()
    {
        return previous_in_assigned_nodes_.Get();
    }
    Node* NextInAssignedNodes()
    {
        return next_in_assigned_nodes_.Get();
    }
