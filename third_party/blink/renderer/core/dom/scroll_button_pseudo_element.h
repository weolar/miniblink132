...
public:
    ...
    bool IsScrollButtonPseudoElement() const final
    {
        return true;
    }
    ...
    Node* InnerNodeForHitTesting() final
    {
        return this;
    }
    void SetScrollMarkerGroup(ScrollMarkerGroupPseudoElement* scroll_marker_group)
    {
...
template <> struct DowncastTraits<ScrollButtonPseudoElement> {
