...
public:
    explicit DocumentData(ExecutionContext* context)
        ...
        , trust_token_query_answerer_(context)
    {
    }
...
private:
    ...
    HeapMojoRemote<network::mojom::blink::TrustTokenQueryAnswerer> trust_token_query_answerer_;
    ...
    HeapHashSet<Member<ScriptPromiseResolverBase>> pending_trust_token_query_resolvers_;
