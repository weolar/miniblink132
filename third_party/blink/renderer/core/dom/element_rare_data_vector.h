...
private:
    ...
    template <typename T> class DataFieldWrapper final : public GarbageCollected<DataFieldWrapper<T>>, public ElementRareDataField {
    public:
        T& Get()
        {
            return data_;
    ...
    template <typename T, typename... Args> T& EnsureField(FieldId field_id, Args&&... args)
    {
    ...
    template <typename T> T& EnsureWrappedField(FieldId field_id)
    {
        return EnsureField<DataFieldWrapper<T>>(field_id).Get();
    }

    template <typename T, typename U> void SetWrappedField(FieldId field_id, U data)
    {
        EnsureWrappedField<T>(field_id) = std::move(data);
    }

    template <typename T> T* GetWrappedField(FieldId field_id) const
    {
        auto* wrapper = static_cast<DataFieldWrapper<T>*>(GetField(field_id));
        return wrapper ? &wrapper->Get() : nullptr;
    }

    template <typename T> void SetOptionalField(FieldId field_id, std::optional<T> data)
    {
        if (data) {
    ...
    template <typename T> std::optional<T> GetOptionalField(FieldId field_id) const
    {
...
public:
    ...
    void SetPseudoElement(PseudoId, PseudoElement*, const AtomicString& document_transition_tag = g_null_atom);
    PseudoElement* GetPseudoElement(PseudoId, const AtomicString& document_transition_tag = g_null_atom) const;
    ...
    {
        element_flags_ = (element_flags_ & ~static_cast<uint16_t>(mask)) | (-static_cast<uint16_t>(value) & static_cast<uint16_t>(mask));
    }
    ...
    {
        fields_.did_attach_internals = true;
    }
    bool DidAttachInternals() const
    {
        return fields_.did_attach_internals;
    }
    bool HasUndoStack() const
    {
        return fields_.has_undo_stack;
    }
    void SetHasUndoStack(bool value)
    {
        fields_.has_undo_stack = value;
    }
    ...
    {
        return fields_.has_invalidation_flags.ancestors_or_ancestor_siblings_affected_by_has;
    }
    void SetAncestorsOrAncestorSiblingsAffectedByHas()
    {
        fields_.has_invalidation_flags.ancestors_or_ancestor_siblings_affected_by_has = true;
    }
    ...
    {
        return fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_hover_in_has;
    }
    void SetAncestorsOrSiblingsAffectedByHoverInHas()
    {
        fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_hover_in_has = true;
    }
    bool AncestorsOrSiblingsAffectedByActiveInHas() const
    {
        return fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_active_in_has;
    }
    void SetAncestorsOrSiblingsAffectedByActiveInHas()
    {
        fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_active_in_has = true;
    }
    bool AncestorsOrSiblingsAffectedByFocusInHas() const
    {
        return fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_focus_in_has;
    }
    void SetAncestorsOrSiblingsAffectedByFocusInHas()
    {
        fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_focus_in_has = true;
    }
    bool AncestorsOrSiblingsAffectedByFocusVisibleInHas() const
    {
        return fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_focus_visible_in_has;
    }
    void SetAncestorsOrSiblingsAffectedByFocusVisibleInHas()
    {
        fields_.has_invalidation_flags.ancestors_or_siblings_affected_by_focus_visible_in_has = true;
    }
    bool AffectedByLogicalCombinationsInHas() const
    {
        return fields_.has_invalidation_flags.affected_by_logical_combinations_in_has;
    }
    void SetAffectedByLogicalCombinationsInHas()
    {
        fields_.has_invalidation_flags.affected_by_logical_combinations_in_has = true;
    }
