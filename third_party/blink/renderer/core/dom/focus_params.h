...
public:
    ...
    FocusParams(SelectionBehaviorOnFocus selection, mojom::blink::FocusType focus_type, InputDeviceCapabilities* capabilities,
        const FocusOptions* focus_options = FocusOptions::Create(), FocusTrigger focus_trigger = FocusTrigger::kScript)
    ...
    SelectionBehaviorOnFocus selection_behavior = SelectionBehaviorOnFocus::kRestore;
