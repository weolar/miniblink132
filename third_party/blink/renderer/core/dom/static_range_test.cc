...
TEST_F(StaticRangeTest, SplitTextNodeRangeWithinText)
{
    ...
    auto* static_range04 = MakeGarbageCollected<StaticRange>(GetDocument(), old_text, 0u, old_text, 4u);
    auto* static_range02 = MakeGarbageCollected<StaticRange>(GetDocument(), old_text, 0u, old_text, 2u);
    auto* static_range22 = MakeGarbageCollected<StaticRange>(GetDocument(), old_text, 2u, old_text, 2u);
    auto* static_range24 = MakeGarbageCollected<StaticRange>(GetDocument(), old_text, 2u, old_text, 4u);
...
TEST_F(StaticRangeTest, SplitTextNodeRangeOutsideText)
{
    ...
    auto* static_range_outer_outside = MakeGarbageCollected<StaticRange>(GetDocument(), outer, 0u, outer, 5u);
    auto* static_range_outer_inside = MakeGarbageCollected<StaticRange>(GetDocument(), outer, 1u, outer, 4u);
    auto* static_range_outer_surrounding_text = MakeGarbageCollected<StaticRange>(GetDocument(), outer, 2u, outer, 3u);
    auto* static_range_inner_left = MakeGarbageCollected<StaticRange>(GetDocument(), inner_left, 0u, inner_left, 1u);
    auto* static_range_inner_right = MakeGarbageCollected<StaticRange>(GetDocument(), inner_right, 0u, inner_right, 1u);
    auto* static_range_from_text_to_middle_of_element = MakeGarbageCollected<StaticRange>(GetDocument(), old_text, 6u, outer, 3u);

    Range* range_outer_outside = static_range_outer_outside->toRange(ASSERT_NO_EXCEPTION);
    Range* range_outer_inside = static_range_outer_inside->toRange(ASSERT_NO_EXCEPTION);
    Range* range_outer_surrounding_text = static_range_outer_surrounding_text->toRange(ASSERT_NO_EXCEPTION);
    ...
    Range* range_from_text_to_middle_of_element = static_range_from_text_to_middle_of_element->toRange(ASSERT_NO_EXCEPTION);
