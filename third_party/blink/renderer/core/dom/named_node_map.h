...
public:
    ...
    Attr* getNamedItemNS(const AtomicString& namespace_uri, const AtomicString& local_name) const;
    Attr* removeNamedItemNS(const AtomicString& namespace_uri, const AtomicString& local_name, ExceptionState&);
