...
PartRootUnion* DocumentPartRoot::clone(ExceptionState&)
{
    NodeCloningData data { CloneOption::kIncludeDescendants,
        RuntimeEnabledFeatures::DOMPartsAPIMinimalEnabled() ? CloneOption::kPreserveDOMPartsMinimalAPI : CloneOption::kPreserveDOMParts };
    ...
    DocumentPartRoot* new_part_root = clone->IsDocumentNode() ? &To<Document>(clone)->getPartRoot() : &To<DocumentFragment>(clone)->getPartRoot();
