...
void DocumentTiming::MarkDomLoading()
{
    ...
    TRACE_EVENT_MARK_WITH_TIMESTAMP1("blink.user_timing,rail", "domLoading", dom_loading_, "frame", GetFrameIdForTracing(GetFrame()));
...
void DocumentTiming::MarkDomInteractive()
{
    ...
    TRACE_EVENT_MARK_WITH_TIMESTAMP1("blink.user_timing,rail", "domInteractive", dom_interactive_, "frame", GetFrameIdForTracing(GetFrame()));
    NotifyDocumentTimingChanged();
}
...
void DocumentTiming::MarkDomContentLoadedEventStart()
{
    ...
    TRACE_EVENT_MARK_WITH_TIMESTAMP1(
        "blink.user_timing,rail", "domContentLoadedEventStart", dom_content_loaded_event_start_, "frame", GetFrameIdForTracing(GetFrame()));
    NotifyDocumentTimingChanged();
}
...
void DocumentTiming::MarkDomContentLoadedEventEnd()
{
    ...
    TRACE_EVENT_MARK_WITH_TIMESTAMP1(
        "blink.user_timing,rail", "domContentLoadedEventEnd", dom_content_loaded_event_end_, "frame", GetFrameIdForTracing(GetFrame()));
    InteractiveDetector* interactive_detector(InteractiveDetector::From(*document_));
...
void DocumentTiming::MarkDomComplete()
{
    ...
    TRACE_EVENT_MARK_WITH_TIMESTAMP1("blink.user_timing,rail", "domComplete", dom_complete_, "frame", GetFrameIdForTracing(GetFrame()));
    NotifyDocumentTimingChanged();
}
