...
public:
    TagCollectionNS(ContainerNode& root_node, CollectionType, const AtomicString& namespace_uri, const AtomicString& local_name);
...
template <> struct DowncastTraits<TagCollection> {
...
template <> struct DowncastTraits<TagCollectionNS> {
    static bool AllowFrom(const LiveNodeListBase& collection)
    {
