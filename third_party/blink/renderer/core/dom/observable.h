...
class CORE_EXPORT Observable final : public ScriptWrappable, public ExecutionContextClient {
...
public:
    ...
    // API methods:
    void subscribe(ScriptState*, V8UnionObserverOrObserverCallback*, SubscribeOptions*);

    static Observable* from(ScriptState* script_state, ScriptValue value, ExceptionState& exception_state);
    ...
    Observable* switchMap(ScriptState*, V8Mapper*, ExceptionState& exception_state);
    Observable* inspect(ScriptState*, V8UnionObservableInspectorOrObserverCallback*);
    ...
    ScriptPromise<IDLUndefined> forEach(ScriptState*, V8Visitor*, SubscribeOptions*);
    ...
    ScriptPromise<IDLBoolean> every(ScriptState*, V8Predicate*, SubscribeOptions*);
    ScriptPromise<IDLAny> find(ScriptState*, V8Predicate*, SubscribeOptions*);
    ScriptPromise<IDLAny> reduce(ScriptState*, V8Reducer*);
    ScriptPromise<IDLAny> reduce(ScriptState*, V8Reducer*, v8::Local<v8::Value>, SubscribeOptions*);
    ...
    void SubscribeWithNativeObserver(ScriptState*, ObservableInternalObserver*, SubscribeOptions*);
...
private:
    ...
    void SubscribeInternal(ScriptState*, V8UnionObserverOrObserverCallback*, ObservableInternalObserver*, SubscribeOptions*);
