...
class CORE_EXPORT AbortSignalRegistry : public GarbageCollected<AbortSignalRegistry>,
...
private:
    ...
    HeapHashMap<WeakMember<EventListener>, Member<const AbortSignal::AlgorithmHandle>> event_listener_signals_;
