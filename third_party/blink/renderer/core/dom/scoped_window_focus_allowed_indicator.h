...
public:
    explicit ScopedWindowFocusAllowedIndicator(ExecutionContext* execution_context)
        : execution_context_(execution_context)
    {
        execution_context->AllowWindowInteraction();
    }
    ScopedWindowFocusAllowedIndicator(const ScopedWindowFocusAllowedIndicator&) = delete;
    ScopedWindowFocusAllowedIndicator& operator=(const ScopedWindowFocusAllowedIndicator&) = delete;
