...
public:
    ...
    SlotAssignmentRecalcForbiddenScope(const SlotAssignmentRecalcForbiddenScope&) = delete;
    SlotAssignmentRecalcForbiddenScope& operator=(const SlotAssignmentRecalcForbiddenScope&) = delete;
