...
class CORE_EXPORT DocumentParser : public GarbageCollected<DocumentParser>, public NameClient {
public:
    ...
    virtual bool NeedsDecoder() const
    {
        return false;
    }
    ...
    virtual void AppendDecodedData(const String& data, const DocumentEncodingData& encoding_data)
    {
    }
    using BackgroundScanCallback = WTF::CrossThreadRepeatingFunction<void(const String&)>;
    ...
    {
        return state_ == kParsingState;
    }
    bool IsStopping() const
    {
        return state_ == kStoppingState;
    }
    ALWAYS_INLINE bool IsStopped() const
    {
        return state_ >= kStoppedState;
    }
    bool IsDetached() const
    {
        return state_ == kDetachedState;
    }
    ...
    void SetIsPreloading(bool is_preloading)
    {
        is_preloading_ = is_preloading;
    }
    bool IsPreloading() const
    {
        return is_preloading_;
    }
