...
class CORE_EXPORT ProcessingInstruction final : public CharacterData, private ResourceClient {
...
template <> struct DowncastTraits<ProcessingInstruction> {
...
{
    return node.getNodeType() == Node::kProcessingInstructionNode && To<ProcessingInstruction>(node).IsXSL();
}
