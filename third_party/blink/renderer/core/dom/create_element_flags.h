...
public:
    ...
    Document* ParserDocument() const
    {
        return parser_document_;
    }
    bool IsAsyncCustomElements() const
    {
        return async_custom_elements_;
    }
    bool IsCustomElements() const
    {
        return custom_elements_;
    }
    bool WasAlreadyStarted() const
    {
    ...
    static CreateElementFlags ByCreateElement()
    {
    ...
    {
        return CreateElementFlags().SetCreatedByParser(true, document).SetAsyncCustomElements();
    }
