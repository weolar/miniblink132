...
class CORE_EXPORT ShadowRealmGlobalScope final : public EventTarget, public ExecutionContext {
    DEFINE_WRAPPERTYPEINFO();

public:
    explicit ShadowRealmGlobalScope(ExecutionContext* initiator_execution_context);
...
template <> struct DowncastTraits<ShadowRealmGlobalScope> {
