...
ShadowRealmGlobalScope::ShadowRealmGlobalScope(ExecutionContext* initiator_execution_context)
    : ExecutionContext(initiator_execution_context->GetIsolate(), initiator_execution_context->GetAgent())
    , initiator_execution_context_(initiator_execution_context)
{
}

ExecutionContext* ShadowRealmGlobalScope::GetRootInitiatorExecutionContext() const
{
    return initiator_execution_context_->IsShadowRealmGlobalScope()
        ? To<ShadowRealmGlobalScope>(initiator_execution_context_.Get())->GetRootInitiatorExecutionContext()
...
const BrowserInterfaceBrokerProxy& ShadowRealmGlobalScope::GetBrowserInterfaceBroker() const
{
    return GetEmptyBrowserInterfaceBroker();
}

scoped_refptr<base::SingleThreadTaskRunner> ShadowRealmGlobalScope::GetTaskRunner(TaskType task_type)
{
...
void ShadowRealmGlobalScope::CountDeprecation(mojom::blink::WebFeature feature)
{
}

void ShadowRealmGlobalScope::CountWebDXFeature(mojom::blink::WebDXFeature feature)
{
}
...
void ShadowRealmGlobalScope::SetWasmEvalErrorMessage(const String& error_message)
{
    NOTREACHED();
}
...
void ShadowRealmGlobalScope::AddConsoleMessageImpl(ConsoleMessage* message, bool discard_duplicates)
{
    NOTREACHED();
}
