...
public:
    ...
    void AsyncTaskScheduled(const StringView& task_name, void* task, bool recurring) override;
    void AsyncTaskCanceled(void* task) override;
    void AllAsyncTasksCanceled() override;
    void AsyncTaskStarted(void* task) override;
    void AsyncTaskFinished(void* task) override;
    unsigned PromiseRejected(
        v8::Local<v8::Context>, const WTF::String& error_message, v8::Local<v8::Value> exception, std::unique_ptr<SourceLocation>) override;
    void PromiseRejectionRevoked(v8::Local<v8::Context>, unsigned promise_rejection_id) override;

    v8_inspector::V8StackTraceId StoreCurrentStackTrace(const StringView& description) override;
    void ExternalAsyncTaskStarted(const v8_inspector::V8StackTraceId& parent) override;
    void ExternalAsyncTaskFinished(const v8_inspector::V8StackTraceId& parent) override;
...
private:
    ...
    std::unique_ptr<v8_inspector::DeepSerializationResult> deepSerialize(
        v8::Local<v8::Value> v8_value, int max_depth, v8::Local<v8::Object> additional_parameters) override;
    ...
    void consoleTimeEnd(v8::Isolate* isolate, v8::Local<v8::String> label) override;
    void consoleTimeStamp(v8::Isolate* isolate, v8::Local<v8::String> label) override;
    ...
    static void GetAccessibleNameCallback(const v8::FunctionCallbackInfo<v8::Value>&);
    static void GetAccessibleRoleCallback(const v8::FunctionCallbackInfo<v8::Value>&);
...
template <> struct CrossThreadCopier<v8_inspector::V8StackTraceId> {
    typedef v8_inspector::V8StackTraceId Type;
    static Type Copy(const Type& id)
    {
        return id;
    }
};
