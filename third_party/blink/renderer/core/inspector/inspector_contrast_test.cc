...
TEST_F(InspectorContrastTest, GetContrast)
{
    ...
    GetDocument().View()->UpdateAllLifecyclePhasesForTest();
    InspectorContrast contrast(&GetDocument());
    ContrastInfo contrast_info_1 = contrast.GetContrast(GetDocument().getElementById(AtomicString("target1")));
    ...
    ContrastInfo contrast_info_2 = contrast.GetContrast(GetDocument().getElementById(AtomicString("target3")));
...
TEST_F(InspectorContrastTest, GetContrastEmptyNodes)
{
    ...
    ContrastInfo contrast_info_2 = contrast.GetContrast(GetDocument().getElementById(AtomicString("target2")));
    EXPECT_EQ(false, contrast_info_2.able_to_compute_contrast);
    ContrastInfo contrast_info_3 = contrast.GetContrast(GetDocument().getElementById(AtomicString("target3")));
