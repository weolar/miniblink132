...
class CORE_EXPORT InspectorTraceEvents : public GarbageCollected<InspectorTraceEvents> {
public:
    ...
    void WillSendRequest(ExecutionContext*, DocumentLoader*, const KURL& fetch_context_url, const ResourceRequest&, const ResourceResponse& redirect_response,
        const ResourceLoaderOptions&, ResourceType, RenderBlockingBehavior, base::TimeTicks timestamp);
    void WillSendNavigationRequest(uint64_t identifier, DocumentLoader*, const KURL&, const AtomicString& http_method, EncodedFormData*);
    void DidReceiveResourceResponse(uint64_t identifier, DocumentLoader*, const ResourceResponse&, const Resource*);
    void DidReceiveData(uint64_t identifier, DocumentLoader*, base::SpanOrSize<const char> encoded_data);
    void DidFinishLoading(
        uint64_t identifier, DocumentLoader*, base::TimeTicks monotonic_finish_time, int64_t encoded_data_length, int64_t decoded_body_length);
    void DidFailLoading(
        CoreProbeSink* sink, uint64_t identifier, DocumentLoader*, const ResourceError&, const base::UnguessableToken& devtools_frame_or_worker_token);
...
#define DEVTOOLS_TIMELINE_TRACE_EVENT_INSTANT_WITH_CATEGORIES(categories, event_name, function_name, ...)                                                      \
    TRACE_EVENT_INSTANT1(                                                                                                                                      \
        categories, event_name, TRACE_EVENT_SCOPE_THREAD, "data", [&](perfetto::TracedValue ctx) { function_name(std::move(ctx), __VA_ARGS__); })

#define DEVTOOLS_TIMELINE_TRACE_EVENT_WITH_CATEGORIES(categories, event_name, function_name, ...)                                                              \
    TRACE_EVENT1(categories, event_name, "data", [&](perfetto::TracedValue ctx) { function_name(std::move(ctx), __VA_ARGS__); })

#define DEVTOOLS_TIMELINE_TRACE_EVENT_INSTANT(...) DEVTOOLS_TIMELINE_TRACE_EVENT_INSTANT_WITH_CATEGORIES("devtools.timeline", __VA_ARGS__)

#define DEVTOOLS_TIMELINE_TRACE_EVENT(...) DEVTOOLS_TIMELINE_TRACE_EVENT_WITH_CATEGORIES("devtools.timeline", __VA_ARGS__)

namespace inspector_layout_event {
void BeginData(perfetto::TracedValue context, LocalFrameView*);
void EndData(perfetto::TracedValue context, const HeapVector<LayoutObjectWithDepth>&);
} // namespace inspector_layout_event
...
void AttributeChange(perfetto::TracedValue context, Element&, const InvalidationSet&, const QualifiedName&);
void ClassChange(perfetto::TracedValue context, Element&, const InvalidationSet&, const AtomicString&);
void IdChange(perfetto::TracedValue context, Element&, const InvalidationSet&, const AtomicString&);
void PseudoChange(perfetto::TracedValue context, Element&, const InvalidationSet&, CSSSelector::PseudoType);
} // namespace inspector_schedule_style_invalidation_tracking_event
...
#define TRACE_SCHEDULE_STYLE_INVALIDATION(element, invalidationSet, changeType, ...)                                                                           \
    DEVTOOLS_TIMELINE_TRACE_EVENT_INSTANT_WITH_CATEGORIES(TRACE_DISABLED_BY_DEFAULT("devtools.timeline.invalidationTracking"),                                 \
        "ScheduleStyleInvalidationTracking", inspector_schedule_style_invalidation_tracking_event::changeType, (element), (invalidationSet), ##__VA_ARGS__);

namespace inspector_style_recalc_invalidation_tracking_event {
void Data(perfetto::TracedValue context, Node*, StyleChangeType, const StyleChangeReasonForTracing&);
}
...
void SelectorPart(perfetto::TracedValue context, Element&, const char* reason, const InvalidationSet&, const AtomicString&);
void InvalidationList(perfetto::TracedValue context, ContainerNode&, const Vector<scoped_refptr<InvalidationSet>>&);
} // namespace inspector_style_invalidator_invalidate_event

#define TRACE_STYLE_INVALIDATOR_INVALIDATION(element, reason)                                                                                                  \
    DEVTOOLS_TIMELINE_TRACE_EVENT_INSTANT_WITH_CATEGORIES(TRACE_DISABLED_BY_DEFAULT("devtools.timeline.invalidationTracking"),                                 \
        "StyleInvalidatorInvalidationTracking", inspector_style_invalidator_invalidate_event::Data, (element),                                                 \
...
#define TRACE_STYLE_INVALIDATOR_INVALIDATION_SELECTORPART(element, reason, invalidationSet, singleSelectorPart)                                                \
    DEVTOOLS_TIMELINE_TRACE_EVENT_INSTANT_WITH_CATEGORIES(TRACE_DISABLED_BY_DEFAULT("devtools.timeline.invalidationTracking"),                                 \
        "StyleInvalidatorInvalidationTracking", inspector_style_invalidator_invalidate_event::SelectorPart, (element),                                         \
        (inspector_style_invalidator_invalidate_event::reason), (invalidationSet), (singleSelectorPart))

#define TRACE_STYLE_INVALIDATOR_INVALIDATION_SET(element, reason, invalidationSet)                                                                             \
    TRACE_STYLE_INVALIDATOR_INVALIDATION_SELECTORPART(element, reason, invalidationSet, g_empty_atom)
...
CORE_EXPORT
void Data(perfetto::TracedValue context, const LayoutObject*, LayoutInvalidationReasonForTracing);
}

namespace inspector_change_resource_priority_event {
void Data(perfetto::TracedValue context, DocumentLoader*, uint64_t identifier, const ResourceLoadPriority&);
}

namespace inspector_send_request_event {
void Data(perfetto::TracedValue context, ExecutionContext* execution_context, DocumentLoader*, uint64_t identifier, LocalFrame*, const ResourceRequest&,
    ResourceType resource_type, RenderBlockingBehavior, const ResourceLoaderOptions&);
}

namespace inspector_change_render_blocking_behavior_event {
void Data(perfetto::TracedValue context, DocumentLoader*, uint64_t identifier, const ResourceRequestHead&, RenderBlockingBehavior);
}

namespace inspector_send_navigation_request_event {
void Data(perfetto::TracedValue context, DocumentLoader*, uint64_t identifier, LocalFrame*, const KURL&, const AtomicString& http_method);
}

namespace inspector_receive_response_event {
void Data(perfetto::TracedValue context, DocumentLoader*, uint64_t identifier, LocalFrame*, const ResourceResponse&);
}

namespace inspector_receive_data_event {
void Data(perfetto::TracedValue context, DocumentLoader*, uint64_t identifier, LocalFrame*, uint64_t encoded_data_length);
}

namespace inspector_resource_finish_event {
void Data(perfetto::TracedValue context, DocumentLoader*, uint64_t identifier, base::TimeTicks finish_time, bool did_fail, int64_t encoded_data_length,
...
CORE_EXPORT void Data(perfetto::TracedValue context, ExecutionContext*, int timer_id, base::TimeDelta timeout, bool single_shot);
}
...
void Data(perfetto::TracedValue context, ExecutionContext*, int id, double timeout);
}
...
void Data(perfetto::TracedValue context, ExecutionContext*, int id, double allotted_milliseconds, bool timed_out);
}
...
void Data(perfetto::TracedValue context, LocalFrame*, const LayoutObject*, const gfx::QuadF& quad, int layer_id);
}

namespace inspector_paint_image_event {
void Data(perfetto::TracedValue context, const LayoutImage&, const gfx::RectF& src_rect, const gfx::RectF& dest_rect);
void Data(perfetto::TracedValue context, const LayoutObject&, const StyleImage&);
void Data(perfetto::TracedValue context, Node*, const StyleImage&, const gfx::RectF& src_rect, const gfx::RectF& dest_rect);
void Data(perfetto::TracedValue context, const LayoutObject*, const ImageResourceContent&);
} // namespace inspector_paint_image_event
...
void Data(perfetto::TracedValue context, v8::Isolate*, LocalFrame*, const String& url, const WTF::TextPosition&);
}

namespace inspector_target_rundown_event {

void Data(perfetto::TracedValue context, ExecutionContext* execution_context, v8::Isolate* isolate, ScriptState* script_state, int scriptId);
}

namespace inspector_parse_script_event {
void Data(perfetto::TracedValue context, uint64_t identifier, const String& url);
}
...
void Data(perfetto::TracedValue context, const String& url, const WTF::TextPosition&, std::optional<V8ConsumeCacheResult>, bool eager, bool streamed,
    ScriptStreamer::NotStreamingReason);
} // namespace inspector_compile_script_event

namespace inspector_produce_script_cache_event {
void Data(perfetto::TracedValue context, const String& url, const WTF::TextPosition&, int cache_size);
}

namespace inspector_function_call_event {
void Data(perfetto::TracedValue context, ExecutionContext*, const v8::Local<v8::Function>&);
}
...
void Data(perfetto::TracedValue context, ExecutionContext*, const String& message);
}

namespace inspector_tracing_session_id_for_worker_event {
void Data(perfetto::TracedValue context, const base::UnguessableToken& worker_devtools_token, const base::UnguessableToken& parent_devtools_token,
    const KURL& url, PlatformThreadId worker_thread_id);
}
...
void Data(perfetto::TracedValue context, blink::CompositorAnimations::FailureReasons failure_reasons, const blink::PropertyHandleSet& unsupported_properties);
}

namespace inspector_hit_test_event {
void EndData(perfetto::TracedValue context, const HitTestRequest&, const HitTestLocation&, const HitTestResult&);
}
...
void Data(perfetto::TracedValue context, ExecutionContext* execution_context, uint64_t trace_id);
}

namespace inspector_handle_post_message_event {
void Data(perfetto::TracedValue context, ExecutionContext* execution_context, const MessageEvent& event);
}

namespace inspector_scheduler_schedule_event {
void Data(perfetto::TracedValue trace_context, ExecutionContext* execution_context, uint64_t task_id, WebSchedulingPriority priority,
...
void Data(perfetto::TracedValue trace_context, ExecutionContext* execution_context, uint64_t task_id);
}

CORE_EXPORT String ToHexString(const void* p);
CORE_EXPORT void SetCallStack(v8::Isolate* isolate, perfetto::TracedDictionary&);
