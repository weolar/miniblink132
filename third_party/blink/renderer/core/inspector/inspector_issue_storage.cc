...
void InspectorIssueStorage::AddInspectorIssue(CoreProbeSink* sink, std::unique_ptr<protocol::Audits::InspectorIssue> issue)
{
...
void InspectorIssueStorage::AddInspectorIssue(CoreProbeSink* sink, AuditsIssue issue)
{
    AddInspectorIssue(sink, issue.TakeIssue());
}

void InspectorIssueStorage::AddInspectorIssue(ExecutionContext* context, AuditsIssue issue)
{
...
protocol::Audits::InspectorIssue* InspectorIssueStorage::at(wtf_size_t index) const
{
