...
class CORE_EXPORT InspectorPerformanceAgent final : public InspectorBaseAgent<protocol::Performance::Metainfo>,
...
public:
    ...
    InspectorPerformanceAgent& operator=(const InspectorPerformanceAgent&) = delete;
    ...
    protocol::Response getMetrics(std::unique_ptr<protocol::Array<protocol::Performance::Metric>>* out_result) override;
