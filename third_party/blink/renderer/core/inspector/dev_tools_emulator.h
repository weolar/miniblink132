...
class CORE_EXPORT DevToolsEmulator final : public GarbageCollected<DevToolsEmulator> {
public:
    ...
    void SetOutputDeviceUpdateAbilityType(mojom::blink::OutputDeviceUpdateAbilityType);
    ...
    gfx::Transform ForceViewportForTesting(const gfx::PointF& position, float scale)
    {
        return ForceViewport(position, scale);
    }
    gfx::Transform ResetViewportForTesting()
    {
...
private:
    ...
    mojom::blink::OutputDeviceUpdateAbilityType embedder_output_device_update_ability_type_;
