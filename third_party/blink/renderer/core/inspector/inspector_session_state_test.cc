...
TEST(InspectorSessionStateTest, MapFields)
{
    ...
    { // Renderer session.
        ...
        EXPECT_THAT(maps_agent.strings_.Keys(), UnorderedElementsAre("key1", "key2"));
        EXPECT_EQ("Hello, world.", maps_agent.strings_.Get("key1"));
        EXPECT_EQ(WTF::String::FromUTF8("I ❤ Unicode."), maps_agent.strings_.Get("key2"));
    ...
    { // Restore renderer session and verify.
        ...
        EXPECT_THAT(maps_agent.strings_.Keys(), UnorderedElementsAre("key2", "key3"));
