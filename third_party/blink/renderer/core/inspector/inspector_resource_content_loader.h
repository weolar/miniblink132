...
class CORE_EXPORT InspectorResourceContentLoader final : public GarbageCollected<InspectorResourceContentLoader> {
public:
    explicit InspectorResourceContentLoader(LocalFrame*);
    InspectorResourceContentLoader(const InspectorResourceContentLoader&) = delete;
    InspectorResourceContentLoader& operator=(const InspectorResourceContentLoader&) = delete;
