...
class CORE_EXPORT InspectorIOAgent final : public InspectorBaseAgent<protocol::IO::Metainfo> {
public:
...
private:
    ...
    protocol::Response resolveBlob(const String& object_id, String* uuid) override;
