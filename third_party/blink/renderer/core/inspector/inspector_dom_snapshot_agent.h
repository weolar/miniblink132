...
class CORE_EXPORT InspectorDOMSnapshotAgent final : public InspectorBaseAgent<protocol::DOMSnapshot::Metainfo> {
public:
    ...
    InspectorDOMSnapshotAgent& operator=(const InspectorDOMSnapshotAgent&) = delete;
    ...
    protocol::Response getSnapshot(std::unique_ptr<protocol::Array<String>> style_filter, protocol::Maybe<bool> include_event_listeners,
        ...
        std::unique_ptr<protocol::Array<protocol::DOMSnapshot::ComputedStyle>>* computed_styles) override;
    protocol::Response captureSnapshot(std::unique_ptr<protocol::Array<String>> computed_styles, protocol::Maybe<bool> include_paint_order,
        protocol::Maybe<bool> include_dom_rects, protocol::Maybe<bool> include_blended_background_colors, protocol::Maybe<bool> include_text_color_opacities,
        std::unique_ptr<protocol::Array<protocol::DOMSnapshot::DocumentSnapshot>>* documents, std::unique_ptr<protocol::Array<String>>* strings) override;
    ...
    static PhysicalRect TextFragmentRectInDocument(const LayoutObject* layout_object, const LayoutText::TextBoxInfo& text_box);
...
private:
    ...
    void SetRare(protocol::DOMSnapshot::RareIntegerData* data, int index, int value);
    void SetRare(protocol::DOMSnapshot::RareStringData* data, int index, const String& value);
    ...
    void VisitPseudoElements(Element* parent, int parent_index, InspectorContrast& contrast);
    std::unique_ptr<protocol::Array<int>> BuildArrayForElementAttributes(Node*);
    int BuildLayoutTreeNode(LayoutObject*, Node*, int node_index, InspectorContrast& contrast);
    ...
    std::unique_ptr<protocol::Array<protocol::DOMSnapshot::LayoutTreeNode>> layout_tree_nodes_;
    std::unique_ptr<protocol::Array<protocol::DOMSnapshot::ComputedStyle>> computed_styles_;
