...
struct CORE_EXPORT InspectorCSSMatchedRules : public GarbageCollected<InspectorCSSMatchedRules> {
public:
...
struct CORE_EXPORT InspectorCSSMatchedPseudoElements : public GarbageCollected<InspectorCSSMatchedPseudoElements> {
public:
    Member<Element> element;
...
public:
    InspectorStyleResolver(Element*, PseudoId, const AtomicString& view_transition_name);
    ...
    HeapVector<Member<InspectorCSSMatchedPseudoElements>> ParentPseudoElementRules();

private:
    void AddPseudoElementRules(PseudoId pseudo_id, const AtomicString& view_transition_name);
    ...
    HeapVector<Member<InspectorCSSMatchedPseudoElements>> parent_pseudo_element_rules_;
};
