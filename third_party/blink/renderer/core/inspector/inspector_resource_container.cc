...
InspectorResourceContainer::InspectorResourceContainer(InspectedFrames* inspected_frames)
...
void InspectorResourceContainer::StoreStyleElementContent(DOMNodeId backend_node_id, const String& content)
{
    style_element_contents_.Set(backend_node_id, content);
}

bool InspectorResourceContainer::LoadStyleElementContent(DOMNodeId backend_node_id, String* content)
{
...
void InspectorResourceContainer::EraseStyleElementContent(DOMNodeId backend_node_id)
{
