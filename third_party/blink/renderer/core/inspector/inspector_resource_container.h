...
class CORE_EXPORT InspectorResourceContainer final : public GarbageCollected<InspectorResourceContainer> {
public:
    explicit InspectorResourceContainer(InspectedFrames*);
    InspectorResourceContainer(const InspectorResourceContainer&) = delete;
    InspectorResourceContainer& operator=(const InspectorResourceContainer&) = delete;
    ...
    void StoreStyleElementContent(DOMNodeId backend_node_id, const String& content);
