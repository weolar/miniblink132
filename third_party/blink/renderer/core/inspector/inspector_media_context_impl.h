...
class CORE_EXPORT MediaInspectorContextImpl final : public GarbageCollected<MediaInspectorContextImpl>,
...
public:
    ...
    void NotifyPlayerErrors(WebString playerId, const InspectorPlayerErrors&) override;
    void NotifyPlayerEvents(WebString playerId, const InspectorPlayerEvents&) override;
    void NotifyPlayerMessages(WebString playerId, const InspectorPlayerMessages&) override;
    void SetPlayerProperties(WebString playerId, const InspectorPlayerProperties&) override;
    ...
    int GetTotalEventCountForTesting()
    {
