...
class CORE_EXPORT InspectorPerformanceTimelineAgent final : public InspectorBaseAgent<protocol::PerformanceTimeline::Metainfo> {
public:
    explicit InspectorPerformanceTimelineAgent(InspectedFrames*);
    InspectorPerformanceTimelineAgent(const InspectorPerformanceTimelineAgent&) = delete;
    InspectorPerformanceTimelineAgent& operator=(const InspectorPerformanceTimelineAgent&) = delete;
...
private:
    ...
    protocol::Response enable(std::unique_ptr<protocol::Array<String>> event_types) override;
    ...
    using EventsVector = protocol::Array<protocol::PerformanceTimeline::TimelineEvent>;
