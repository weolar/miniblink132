...
using InspectorIndexMap = HashMap<unsigned, unsigned, WTF::IntWithZeroKeyHashTraits<unsigned>>;
...
public:
    ...
    static void FindLCSMapping(const Vector<String>& list_a, const Vector<String>& list_b, InspectorIndexMap* a_to_b, InspectorIndexMap* b_to_a);
};
