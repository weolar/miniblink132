...
class CORE_EXPORT InspectorMediaAgent final : public InspectorBaseAgent<protocol::Media::Metainfo> {
public:
    ...
    void PlayerErrorsRaised(const WebString&, const Vector<InspectorPlayerError>&);
    void PlayerEventsAdded(const WebString&, const Vector<InspectorPlayerEvent>&);
    void PlayerMessagesLogged(const WebString&, const Vector<InspectorPlayerMessage>&);
    void PlayerPropertiesChanged(const WebString&, const Vector<InspectorPlayerProperty>&);
