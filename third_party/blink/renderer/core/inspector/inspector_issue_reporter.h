...
class CORE_EXPORT InspectorIssueReporter final : public GarbageCollected<InspectorIssueReporter> {
public:
    ...
    // Core Probes.
    void DidFailLoading(CoreProbeSink* sink, uint64_t identifier, DocumentLoader* loader, const ResourceError& error, const base::UnguessableToken& token);
