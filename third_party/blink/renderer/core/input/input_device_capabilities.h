...
public:
    ...
    static InputDeviceCapabilities* Create(const InputDeviceCapabilitiesInit* initializer)
    {
...
class InputDeviceCapabilitiesConstants final : public GarbageCollected<InputDeviceCapabilitiesConstants> {
public:
