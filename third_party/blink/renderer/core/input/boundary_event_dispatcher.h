...
public:
    BoundaryEventDispatcher(AtomicString over_event, AtomicString out_event, AtomicString enter_event, AtomicString leave_event)
    ...
    void SendBoundaryEvents(EventTarget* exited_target, bool original_exited_target_removed, EventTarget* entered_target);

protected:
    virtual void Dispatch(EventTarget*, EventTarget* related_target, const AtomicString&, bool check_for_listener) = 0;
