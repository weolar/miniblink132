...
class CORE_EXPORT KeyboardEventManager final : public GarbageCollected<KeyboardEventManager> {
public:
...
// TODO(crbug.com/618397): Add a settings to control this behavior.
    ...
    bool is_handling_key_event() const
    {
        return is_handling_key_event_;
    }
