...
public:
    ...
    // component string.
    static Component* Compile(v8::Isolate* isolate, StringView pattern, Type type, Component* protocol_component, const URLPatternOptions& external_options,
    ...
    // `regexp`.
    Component(Type type, liburlpattern::Pattern pattern, ScriptRegexp* regexp, Vector<String> name_list, base::PassKey<Component> key);
    ...
    bool Match(StringView input, Vector<std::pair<String, String>>* group_list) const;
    ...
    {
        return pattern_.HasRegexGroups();
    }
