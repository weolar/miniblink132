...
class CORE_EXPORT WindowControlsOverlayChangedDelegate : public GarbageCollectedMixin {
public:
    ...
    // coordinate space.
    virtual void WindowControlsOverlayChanged(const gfx::Rect& titlebar_area_rect) = 0;
