...
String Navigator::platform() const
{
    ...
    const String& platform_override = DomWindow()->GetFrame()->GetSettings()->GetNavigatorPlatformOverride();
    return platform_override.empty() ? NavigatorBase::platform() : platform_override;
}
...
String Navigator::GetAcceptLanguages()
{
    ...
    return DomWindow()->GetFrame()->GetPage()->GetChromeClient().AcceptLanguages();
}
