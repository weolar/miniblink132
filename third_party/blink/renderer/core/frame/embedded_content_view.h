...
public:
    EmbeddedContentView(const gfx::Rect& frame_rect)
    ...
    virtual bool IsLocalFrameView() const
    {
        return false;
    }
    ...
    virtual void Paint(GraphicsContext&, PaintFlags, const CullRect& cull_rect, const gfx::Vector2d& paint_offset) const = 0;
    ...
    gfx::Rect FrameRect() const
    {
        return gfx::Rect(Location(), Size());
    }
