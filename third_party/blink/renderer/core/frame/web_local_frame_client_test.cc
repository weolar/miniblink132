...
class CallTrackingTestWebLocalFrameClient : public frame_test_helpers::TestWebFrameClient {
public:
        ...
        const ParsedPermissionsPolicy& permissions_policy_header, const DocumentPolicyFeatureState& document_policy_header) override
    {
        ...
        TestWebFrameClient::DidCommitNavigation(commit_type, should_reset_browser_interface_broker, permissions_policy_header, document_policy_header);
    }
...
TEST(WebLocalFrameClientTest, Basic)
{
    ...
    EXPECT_THAT(client.TakeCalls(), testing::ElementsAre("DidCreateDocumentLoader", "DidCreateDocumentElement", "RunScriptsAtDocumentElementAvailable"));

    frame_test_helpers::LoadHTMLString(web_view_helper.LocalMainFrame(), "<p>Hello world!</p>", ToKURL("https://example.com/"));
    EXPECT_THAT(client.TakeCalls(),
        testing::ElementsAre(
            ...
            "RunScriptsAtDocumentIdle", "DidCreateDocumentLoader", "DidCommitNavigation", "DidCreateDocumentElement", "RunScriptsAtDocumentElementAvailable",
            "DidDispatchDOMContentLoadedEvent", "RunScriptsAtDocumentReady", "RunScriptsAtDocumentIdle", "DidHandleOnloadEvents", "DidFinishLoad"));
}
