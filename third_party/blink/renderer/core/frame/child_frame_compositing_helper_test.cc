...
viz::SurfaceId MakeSurfaceId(const viz::FrameSinkId& frame_sink_id, uint32_t parent_sequence_number, uint32_t child_sequence_number = 1u)
{
    return viz::SurfaceId(frame_sink_id, viz::LocalSurfaceId(parent_sequence_number, child_sequence_number, base::UnguessableToken::CreateForTesting(0, 1u)));
}
...
public:
    ChildFrameCompositingHelperTest()
        : compositing_helper_(&compositor_)
    {
    }
    ChildFrameCompositingHelperTest(const ChildFrameCompositingHelperTest&) = delete;
    ChildFrameCompositingHelperTest& operator=(const ChildFrameCompositingHelperTest&) = delete;
...
TEST_F(ChildFrameCompositingHelperTest, ChildFrameGoneClearsFallback)
{
    ...
    compositing_helper()->SetSurfaceId(
        surface_id, ChildFrameCompositingHelper::CaptureSequenceNumberChanged::kNo, ChildFrameCompositingHelper::AllowPaintHolding::kNo);
...
TEST_F(ChildFrameCompositingHelperTest, PaintHoldingTimeout)
{
    ...
    const viz::SurfaceId new_surface_id = MakeSurfaceId(viz::FrameSinkId(1, 1), 2);
    compositing_helper()->SetSurfaceId(
        new_surface_id, ChildFrameCompositingHelper::CaptureSequenceNumberChanged::kNo, ChildFrameCompositingHelper::AllowPaintHolding::kYes);
