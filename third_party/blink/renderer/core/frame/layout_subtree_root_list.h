...
public:
    ...
    void CountObjectsNeedingLayout(unsigned& needs_layout_objects, unsigned& total_objects);

    static void CountObjectsNeedingLayoutInRoot(const LayoutObject* root, unsigned& needs_layout_objects, unsigned& total_objects);
};
