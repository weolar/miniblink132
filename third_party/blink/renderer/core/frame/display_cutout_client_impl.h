...
class CORE_EXPORT DisplayCutoutClientImpl final : public GarbageCollected<DisplayCutoutClientImpl>, public mojom::blink::DisplayCutoutClient {
public:
    static void BindMojoReceiver(LocalFrame*, mojo::PendingAssociatedReceiver<mojom::blink::DisplayCutoutClient>);

    DisplayCutoutClientImpl(LocalFrame*, mojo::PendingAssociatedReceiver<mojom::blink::DisplayCutoutClient>);
...
private:
    ...
    HeapMojoAssociatedReceiver<mojom::blink::DisplayCutoutClient, DisplayCutoutClientImpl> receiver_;
};
