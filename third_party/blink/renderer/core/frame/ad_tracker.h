...
public:
    ...
    static bool IsAdScriptExecutingInDocument(Document* document, StackType stack_type = StackType::kBottomAndTop);
    ...
    bool IsAdScriptInStack(StackType stack_type, std::optional<AdScriptIdentifier>* out_ad_script = nullptr);
...
private:
    ...
    void WillExecuteScript(ExecutionContext*, const v8::Local<v8::Context>& v8_context, const String& script_name, int script_id);
