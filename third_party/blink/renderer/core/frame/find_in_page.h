...
class CORE_EXPORT FindInPage final : public GarbageCollected<FindInPage>, public mojom::blink::FindInPage {
public:
    ...
    bool FindInternal(int identifier, const String& search_text, const mojom::blink::FindOptions&, bool wrap_within_frame, bool* active_now = nullptr);
    ...
    // CSS space.
    void SetTickmarks(const WebElement& target, const WebVector<gfx::Rect>& tickmarks_in_layout_space);
    ...
    void ReportFindInPageSelection(int request_id, int active_match_ordinal, const gfx::Rect& selection_rect, bool final_update);

    // mojom::blink::FindInPage overrides
    void Find(int request_id, const String& search_text, mojom::blink::FindOptionsPtr) final;
...
#if BUILDFLAG(IS_ANDROID)
    void GetNearestFindResult(const gfx::PointF&, GetNearestFindResultCallback) final;
    ...
    void BindToReceiver(mojo::PendingAssociatedReceiver<mojom::blink::FindInPage> receiver);
...
private:
    ...
    HeapMojoAssociatedReceiver<mojom::blink::FindInPage, FindInPage> receiver_ { this, nullptr };
};
