...
public:
    ...
    {
        url_test_helpers::RegisterMockedURLLoadFromBase(WebString::FromUTF8(base_url_), test::CoreTestDataPath(), WebString::FromUTF8(file_path));
    }
...
TEST_F(FrameContentAsTextTest, RenderedDocumentsOnly)
{
    ...
    WebView* web_view = web_view_helper.InitializeAndLoad(base_url_ + "display_none_frame.html");
