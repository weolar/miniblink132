...
class CORE_EXPORT DeviceSingleWindowEventController : public GarbageCollected<DeviceSingleWindowEventController>,
...
protected:
    ...
    bool CheckPolicyFeatures(const Vector<mojom::blink::PermissionsPolicyFeature>& features) const;
