...
class TestCSPDelegate final : public GarbageCollected<TestCSPDelegate>, public ContentSecurityPolicyDelegate {
public:
    Vector<String>& console_messages()
    {
...
private:
    ...
    const scoped_refptr<SecurityOrigin> security_origin_ = SecurityOrigin::Create(url_);
