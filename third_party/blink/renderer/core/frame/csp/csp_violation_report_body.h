...
public:
    explicit CSPViolationReportBody(const SecurityPolicyViolationEventInit& violation_data)
        : LocationReportBody(violation_data.sourceFile(), violation_data.lineNumber(), violation_data.columnNumber())
