...
class ExecutionContextCSPDelegate final : public GarbageCollected<ExecutionContextCSPDelegate>, public ContentSecurityPolicyDelegate {
public:
...
private:
    ...
    void DispatchViolationEventInternal(const SecurityPolicyViolationEventInit*, Element*);
