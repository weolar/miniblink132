...
public:
    ScreenMetricsEmulator(WebFrameWidgetImpl* frame_widget, const display::ScreenInfos& screen_infos, const gfx::Size& widget_size,
    ...
    float scale() const
    {
        return emulation_params_.scale;
    }
...
private:
    ...
    {
        return emulation_params_.screen_type == mojom::blink::EmulatedScreenType::kDesktop;
    }
    ...
    std::vector<gfx::Rect> original_root_viewport_segments_ ALLOW_DISCOURAGED_TYPE("WebFrameWidgetImpl::SetViewportSegments() uses STL");
};
