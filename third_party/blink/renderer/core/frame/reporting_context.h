...
class CORE_EXPORT ReportingContext : public GarbageCollected<ReportingContext>, public mojom::blink::ReportingObserver, public Supplement<ExecutionContext> {
public:
    ...
    virtual void QueueReport(Report*, const Vector<String>& endpoints = { "default" });
...
private:
    ...
    const HeapMojoRemote<mojom::blink::ReportingServiceProxy>& GetReportingService() const;
    ...
    // const methods.
    mutable HeapMojoRemote<mojom::blink::ReportingServiceProxy> reporting_service_;
