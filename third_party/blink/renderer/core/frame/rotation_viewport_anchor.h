...
public:
    RotationViewportAnchor(LocalFrameView& root_frame_view, VisualViewport&, const gfx::PointF& anchor_in_inner_view_coords, PageScaleConstraintsSet&);
...
private:
    ...
    void ComputeOrigins(const gfx::SizeF& inner_size, gfx::Point& main_frame_origin, gfx::PointF& visual_viewport_origin) const;
