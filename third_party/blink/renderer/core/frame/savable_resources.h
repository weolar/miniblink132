...
public:
    ...
    public:
        Result(Vector<KURL>* resources_list, Vector<mojom::blink::SavableSubframePtr>* subframes)
            : resources_list_(resources_list)
    ...
    static bool GetSavableResourceLinksForFrame(LocalFrame* frame, SavableResources::Result* result);
