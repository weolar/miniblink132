...
class CORE_EXPORT LocalFrameUkmAggregator : public RefCounted<LocalFrameUkmAggregator> {
public:
...
private:
    ...
    // Primary metric name
    static const char* primary_metric_name()
    {
        return "MainFrame";
    }
    ...
    {
        static const MetricInitializationData data[] = { { "Blink.CompositingCommit.UpdateTime", true }, { "Blink.CompositingInputs.UpdateTime", true },
            { "Blink.ImplCompositorCommit.UpdateTime", true }, { "Blink.IntersectionObservation.UpdateTime", true },
            { "Blink.IntersectionObservationInternalCount.UpdateTime", true }, { "Blink.IntersectionObservationJavascriptCount.UpdateTime", true },
            { "Blink.Paint.UpdateTime", true }, { "Blink.PrePaint.UpdateTime", true }, { "Blink.Style.UpdateTime", true }, { "Blink.Layout.UpdateTime", true },
            { "Blink.HandleInputEvents.UpdateTime", true }, { "Blink.Animate.UpdateTime", true }, { "Blink.UpdateLayers.UpdateTime", false },
            { "Blink.WaitForCommit.UpdateTime", true }, { "Blink.DisplayLockIntersectionObserver.UpdateTime", true },
            { "Blink.JavascriptIntersectionObserver.UpdateTime", true }, { "Blink.LazyLoadIntersectionObserver.UpdateTime", true },
            { "Blink.MediaIntersectionObserver.UpdateTime", true }, { "Blink.PermissionElementIntersectionObserver.UpdateTime", true },
            { "Blink.AnchorElementMetricsIntersectionObserver.UpdateTime", true }, { "Blink.UpdateViewportIntersection.UpdateTime", true },
            { "Blink.VisualUpdateDelay.UpdateTime", true }, { "Blink.ForcedStyleAndLayout.UpdateTime", true },
            { "Blink.ContentDocumentUpdate.UpdateTime", true }, { "Blink.HitTestDocumentUpdate.UpdateTime", true },
            { "Blink.JavascriptDocumentUpdate.UpdateTime", true }, { "Blink.ServiceDocumentUpdate.UpdateTime", true },
            { "Blink.UserDrivenDocumentUpdate.UpdateTime", true }, { "Blink.ParseStyleSheet.UpdateTime", true }, { "Blink.Accessibility.UpdateTime", true },
...
public:
    ...
    public:
        ...
        ScopedUkmHierarchicalTimer& operator=(const ScopedUkmHierarchicalTimer&) = delete;
        ~ScopedUkmHierarchicalTimer();

    private:
        friend class LocalFrameUkmAggregator;

        ScopedUkmHierarchicalTimer(scoped_refptr<LocalFrameUkmAggregator>, size_t metric_index, const base::TickClock* clock);
    ...
    public:
        ScopedForcedLayoutTimer(LocalFrameUkmAggregator& aggregator, DocumentUpdateReason update_reason, bool avoid_unnecessary_forced_layout_measurements,
            bool should_report_uma_this_frame, bool is_pre_fcp, bool record_ukm_for_current_frame);
    ...
    ScopedForcedLayoutTimer GetScopedForcedLayoutTimer(DocumentUpdateReason update_reason);
    ...
    void RecordTimerSample(size_t metric_index, base::TimeTicks start, base::TimeTicks end);
    ...
    //   commit is complete.
    void RecordImplCompositorSample(base::TimeTicks requested, base::TimeTicks started, base::TimeTicks completed);
    ...
    bool InMainFrameUpdate()
    {
        return in_main_frame_update_;
    }
    ...
    void TransmitFinalSample(int64_t source_id, ukm::UkmRecorder* recorder, bool is_for_main_frame);
...
private:
    ...
    void UpdateEventTimeAndUpdateSampleIfNeeded(cc::ActiveFrameSequenceTrackers trackers, bool& record_ukm_for_next_frame);
    ...
    void EndForcedLayout(DocumentUpdateReason reason, base::TimeDelta duration, bool avoid_unnecessary_forced_layout_measurements,
    ...
    enum SampleControlForTest { kNoPreference, kMustChooseNextFrame, kMustNotChooseNextFrame };
