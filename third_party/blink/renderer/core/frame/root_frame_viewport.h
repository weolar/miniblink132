...
class CORE_EXPORT RootFrameViewport final : public GarbageCollected<RootFrameViewport>, public ScrollableArea {
public:
    RootFrameViewport(ScrollableArea& visual_viewport, ScrollableArea& layout_viewport);
    ...
    PhysicalRect RootContentsToLayoutViewportContents(LocalFrameView& root_frame_view, const PhysicalRect&) const;
    ...
    bool IsRootFrameViewport() const override
    {
        return true;
    }
    bool SetScrollOffset(const ScrollOffset&, mojom::blink::ScrollType, mojom::blink::ScrollBehavior, ScrollCallback on_finish) override;
    ...
    ScrollResult UserScroll(ui::ScrollGranularity, const ScrollOffset&, ScrollableArea::ScrollCallback on_finish) override;
    CompositorElementId GetScrollElementId() const override;
    CompositorElementId GetScrollbarElementId(ScrollbarOrientation orientation) override;
    ...
    void SetSnappedQueryTargetIds(std::optional<cc::TargetSnapAreaElementIds> new_target_ids) override;
...
private:
    ...
    bool DistributeScrollBetweenViewports(
        const ScrollOffset&, mojom::blink::ScrollType, mojom::blink::ScrollBehavior, ViewportToScrollFirst, ScrollCallback on_finish = ScrollCallback());
...
template <> struct DowncastTraits<RootFrameViewport> {
