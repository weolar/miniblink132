...
public:
    explicit ChildFrameCompositingHelper(ChildFrameCompositor* child_frame_compositor);
    ChildFrameCompositingHelper(const ChildFrameCompositingHelper&) = delete;
    ChildFrameCompositingHelper& operator=(const ChildFrameCompositingHelper&) = delete;
    ...
    void SetSurfaceId(const viz::SurfaceId& surface_id, CaptureSequenceNumberChanged capture_sequence_number_changed, AllowPaintHolding allow_paint_holding);
...
private:
    ...
    void MaybeSetUpPaintHolding(const viz::SurfaceId& fallback_id, AllowPaintHolding allow_paint_holding);
