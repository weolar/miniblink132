...
public:
    ...
    LayoutBlockFlow* CreateAnonymousPageLayoutObject(Document&, const ComputedStyle&);
    ...
    void SetCurrentPageIndex(wtf_size_t n)
    {
        current_page_index_ = n;
    }
    wtf_size_t CurrentPageIndex() const
    {
    ...
    PropertyTreeState ContentAreaPropertyTreeStateForCurrentPage(const LayoutView&) const;
