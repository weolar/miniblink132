...
public:
    ...
    Length ViewportDefaultMinWidth() const
    {
...
private:
    ...
    HeapMojoAssociatedRemote<mojom::blink::DisplayCutoutHost> display_cutout_host_;
};

inline bool ViewportData::ShouldOverrideLegacyDescription(ViewportDescription::Type origin) const
{
