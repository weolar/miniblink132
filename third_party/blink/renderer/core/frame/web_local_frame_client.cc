...
AssociatedInterfaceProvider* WebLocalFrameClient::GetRemoteNavigationAssociatedInterfaces()
{
...
std::unique_ptr<WebLinkPreviewTriggerer> WebLocalFrameClient::CreateLinkPreviewTriggerer()
{
    return nullptr;
}

void WebLocalFrameClient::SetLinkPreviewTriggererForTesting(std::unique_ptr<WebLinkPreviewTriggerer> trigger)
{
}
