...
public:
    static const DeprecationInfo Create(WebFeature feature, const StringView& type, const StringView& message)
    {
...
private:
    DeprecationInfo(WebFeature feature, const StringView& type, const StringView& message)
        : feature_(feature)
        , type_(type)
        , message_(message)
    {
