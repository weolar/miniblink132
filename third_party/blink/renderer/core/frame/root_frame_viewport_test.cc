...
class ScrollableAreaStub : public GarbageCollected<ScrollableAreaStub>, public ScrollableArea {
public:
    ScrollableAreaStub(const gfx::Size& viewport_size, const gfx::Size& contents_size)
        ...
        , timer_task_runner_(blink::scheduler::GetSingleThreadTaskRunnerForTesting())
    {
    }
    ...
    ScrollOffset MinimumScrollOffset() const override
    {
        return ScrollOffset();
    }
    ...
    gfx::Rect VisibleContentRect(IncludeScrollbarsInRect = kExcludeScrollbars) const override
    {
        return gfx::Rect(gfx::ToFlooredPoint(gfx::PointAtOffsetFromOrigin(scroll_offset_)), viewport_size_);
    }
...
protected:
    ...
    void UpdateScrollOffset(const ScrollOffset& offset, mojom::blink::ScrollType) override
    {
    ...
    {
        return orientation == kHorizontalScrollbar ? user_input_scrollable_x_ : user_input_scrollable_y_;
    }
    ...
    ScrollOffset ClampedScrollOffset(const ScrollOffset& offset)
    {
        ...
        float width = std::min(std::max(offset.x(), min_offset.x()), max_offset.x());
        float height = std::min(std::max(offset.y(), min_offset.y()), max_offset.y());
...
public:
    RootLayoutViewportStub(const gfx::Size& viewport_size, const gfx::Size& contents_size)
    ...
    PhysicalOffset LocalToScrollOriginOffset() const override
    {
        return {};
    }
...
public:
    VisualViewportStub(const gfx::Size& viewport_size, const gfx::Size& contents_size)
        : ScrollableAreaStub(viewport_size, contents_size)
        , scale_(1)
    {
    }
    ...
    ScrollOffset MaximumScrollOffset() const override
    {
        gfx::Size diff = ContentsSize() - gfx::ScaleToFlooredSize(ViewportSize(), 1 / scale_);
        return ScrollOffset(diff.width(), diff.height());
    }
...
private:
    ...
    {
        return gfx::Rect(gfx::ToFlooredPoint(ScrollPosition()), gfx::ToCeiledSize(gfx::ScaleSize(gfx::SizeF(viewport_size_), 1 / scale_)));
    }
...
TEST_F(RootFrameViewportTest, UserInputScrollable)
{
    ...
    auto* layout_viewport = MakeGarbageCollected<RootLayoutViewportStub>(viewport_size, gfx::Size(200, 300));
    auto* visual_viewport = MakeGarbageCollected<VisualViewportStub>(viewport_size, viewport_size);
    ...
    root_frame_viewport->UserScroll(ui::ScrollGranularity::kScrollByPrecisePixel, ScrollOffset(300, 0), ScrollableArea::ScrollCallback());
    ...
    root_frame_viewport->UserScroll(ui::ScrollGranularity::kScrollByPrecisePixel, ScrollOffset(0, 300), ScrollableArea::ScrollCallback());
...
TEST_F(RootFrameViewportTest, TestScrollAnimatorUpdatedBeforeScroll)
{
    ...
    visual_viewport->SetScrollOffset(ScrollOffset(50, 75), mojom::blink::ScrollType::kProgrammatic);
    ...
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(0, 0), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());
    ...
    root_frame_viewport->UserScroll(ui::ScrollGranularity::kScrollByPrecisePixel, ScrollOffset(-50, 0), ScrollableArea::ScrollCallback());
    EXPECT_EQ(ScrollOffset(0, 75), root_frame_viewport->GetScrollOffset());
    EXPECT_EQ(ScrollOffset(0, 75), visual_viewport->GetScrollOffset());
    ...
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(0, 0), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());
    layout_viewport->SetScrollOffset(ScrollOffset(100, 150), mojom::blink::ScrollType::kProgrammatic);
    EXPECT_EQ(ScrollOffset(100, 150), root_frame_viewport->GetScrollOffset());

    root_frame_viewport->UserScroll(ui::ScrollGranularity::kScrollByPrecisePixel, ScrollOffset(-100, 0), ScrollableArea::ScrollCallback());
...
TEST_F(RootFrameViewportTest, ScrollIntoView)
{
    ...
    root_frame_viewport->ScrollIntoView(layout_viewport->DocumentToFrame(PhysicalRect(100, 250, 50, 50)), PhysicalBoxStrut(),
        scroll_into_view_util::CreateScrollIntoViewParams(ScrollAlignment::ToEdgeIfNeeded(), ScrollAlignment::ToEdgeIfNeeded(),
            mojom::blink::ScrollType::kProgrammatic, true, mojom::blink::ScrollBehavior::kInstant));
    EXPECT_EQ(ScrollOffset(50, 150), layout_viewport->GetScrollOffset());
    EXPECT_EQ(ScrollOffset(0, 50), visual_viewport->GetScrollOffset());

    root_frame_viewport->ScrollIntoView(layout_viewport->DocumentToFrame(PhysicalRect(25, 75, 50, 50)), PhysicalBoxStrut(),
        scroll_into_view_util::CreateScrollIntoViewParams(ScrollAlignment::ToEdgeIfNeeded(), ScrollAlignment::ToEdgeIfNeeded(),
            mojom::blink::ScrollType::kProgrammatic, true, mojom::blink::ScrollBehavior::kInstant));
    ...
    root_frame_viewport->ScrollIntoView(layout_viewport->DocumentToFrame(PhysicalRect(50, 75, 50, 75)), PhysicalBoxStrut(),
        scroll_into_view_util::CreateScrollIntoViewParams(ScrollAlignment::ToEdgeIfNeeded(), ScrollAlignment::ToEdgeIfNeeded(),
            mojom::blink::ScrollType::kProgrammatic, true, mojom::blink::ScrollBehavior::kInstant));
    EXPECT_EQ(ScrollOffset(0, 0), layout_viewport->GetScrollOffset());
    EXPECT_EQ(ScrollOffset(50, 75), visual_viewport->GetScrollOffset());

    root_frame_viewport->ScrollIntoView(layout_viewport->DocumentToFrame(PhysicalRect(190, 290, 10, 10)), PhysicalBoxStrut(),
        scroll_into_view_util::CreateScrollIntoViewParams(ScrollAlignment::ToEdgeIfNeeded(), ScrollAlignment::ToEdgeIfNeeded(),
            mojom::blink::ScrollType::kProgrammatic, true, mojom::blink::ScrollBehavior::kInstant));
    ...
    visual_viewport->SetScrollOffset(ScrollOffset(0, 10), mojom::blink::ScrollType::kProgrammatic);
    layout_viewport->SetScrollOffset(ScrollOffset(50, 50), mojom::blink::ScrollType::kProgrammatic);
    root_frame_viewport->SetScrollOffset(root_frame_viewport->GetScrollOffset(), mojom::blink::ScrollType::kProgrammatic,
        mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());

    root_frame_viewport->ScrollIntoView(layout_viewport->DocumentToFrame(PhysicalRect(root_frame_viewport->VisibleContentRect(kExcludeScrollbars))),
        PhysicalBoxStrut(),
        scroll_into_view_util::CreateScrollIntoViewParams(ScrollAlignment::ToEdgeIfNeeded(), ScrollAlignment::ToEdgeIfNeeded(),
            mojom::blink::ScrollType::kProgrammatic, true, mojom::blink::ScrollBehavior::kInstant));
    ...
    root_frame_viewport->ScrollIntoView(layout_viewport->DocumentToFrame(PhysicalRect(root_frame_viewport->VisibleContentRect(kExcludeScrollbars))),
        PhysicalBoxStrut(),
        scroll_into_view_util::CreateScrollIntoViewParams(ScrollAlignment::CenterAlways(), ScrollAlignment::CenterAlways(),
            mojom::blink::ScrollType::kProgrammatic, true, mojom::blink::ScrollBehavior::kInstant));
    EXPECT_EQ(ScrollOffset(50, 50), layout_viewport->GetScrollOffset());
    EXPECT_EQ(ScrollOffset(0, 10), visual_viewport->GetScrollOffset());
    ...
    root_frame_viewport->ScrollIntoView(layout_viewport->DocumentToFrame(PhysicalRect(root_frame_viewport->VisibleContentRect(kExcludeScrollbars))),
        ...
        scroll_into_view_util::CreateScrollIntoViewParams(
            ScrollAlignment::TopAlways(), ScrollAlignment::TopAlways(), mojom::blink::ScrollType::kProgrammatic, true, mojom::blink::ScrollBehavior::kInstant));
    EXPECT_EQ(ScrollOffset(50, 50), layout_viewport->GetScrollOffset());
    EXPECT_EQ(ScrollOffset(0, 10), visual_viewport->GetScrollOffset());
}
...
TEST_F(RootFrameViewportTest, SetScrollOffset)
{
    ...
    auto* layout_viewport = MakeGarbageCollected<RootLayoutViewportStub>(viewport_size, gfx::Size(1000, 2000));
    auto* visual_viewport = MakeGarbageCollected<VisualViewportStub>(viewport_size, viewport_size);
    ...
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(100, 100), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());
    ...
    // the remainder.
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(300, 400), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());
    ...
    // out of bounds.
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(780, 1780), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());
    EXPECT_EQ(ScrollOffset(250, 250), visual_viewport->GetScrollOffset());
...
TEST_F(RootFrameViewportTest, VisibleContentRect)
{
    ...
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(100, 75), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());

    EXPECT_EQ(gfx::Point(100, 75), root_frame_viewport->VisibleContentRect().origin());
    EXPECT_EQ(gfx::Size(500, 401), root_frame_viewport->VisibleContentRect().size());

    visual_viewport->SetScale(2);

    EXPECT_EQ(gfx::Point(100, 75), root_frame_viewport->VisibleContentRect().origin());
    EXPECT_EQ(gfx::Size(250, 201), root_frame_viewport->VisibleContentRect().size());
}
...
TEST_F(RootFrameViewportTest, ViewportScrollOrder)
{
    ...
    root_frame_viewport->SetScrollOffset(ScrollOffset(40, 40), mojom::blink::ScrollType::kUser, mojom::blink::ScrollBehavior::kInstant,
        ScrollableArea::ScrollCallback(WTF::BindOnce(
            [](ScrollableArea* visual_viewport, ScrollableArea* layout_viewport, ScrollableArea::ScrollCompletionMode) {
                EXPECT_EQ(ScrollOffset(40, 40), visual_viewport->GetScrollOffset());
                EXPECT_EQ(ScrollOffset(0, 0), layout_viewport->GetScrollOffset());
            },
            WrapWeakPersistent(visual_viewport), WrapWeakPersistent(layout_viewport))));
    EXPECT_EQ(ScrollOffset(40, 40), visual_viewport->GetScrollOffset());
    EXPECT_EQ(ScrollOffset(0, 0), layout_viewport->GetScrollOffset());

    root_frame_viewport->SetScrollOffset(ScrollOffset(60, 60), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kInstant,
        ScrollableArea::ScrollCallback(WTF::BindOnce(
            [](ScrollableArea* visual_viewport, ScrollableArea* layout_viewport, ScrollableArea::ScrollCompletionMode) {
...
TEST_F(RootFrameViewportTest, SetAlternateLayoutViewport)
{
    ...
    auto* alternate_scroller = MakeGarbageCollected<RootLayoutViewportStub>(viewport_size, gfx::Size(600, 500));
    ...
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(100, 100), mojom::blink::ScrollType::kUser, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());
    EXPECT_EQ(ScrollOffset(50, 50), visual_viewport->GetScrollOffset());
    EXPECT_EQ(ScrollOffset(50, 50), layout_viewport->GetScrollOffset());
    ...
    root_frame_viewport->SetScrollOffset(
        ScrollOffset(200, 200), mojom::blink::ScrollType::kUser, mojom::blink::ScrollBehavior::kInstant, ScrollableArea::ScrollCallback());
    EXPECT_EQ(ScrollOffset(50, 50), visual_viewport->GetScrollOffset());
...
TEST_F(RootFrameViewportTest, DistributeScrollOrder)
{
    ...
    root_frame_viewport->DistributeScrollBetweenViewports(ScrollOffset(60, 60), mojom::blink::ScrollType::kProgrammatic, mojom::blink::ScrollBehavior::kSmooth,
...
TEST_F(RootFrameViewportRenderTest, ApplyPendingHistoryRestoreScrollOffsetTwice)
{
    HistoryItem::ViewState view_state;
    view_state.page_scale_factor_ = 1.5;
    RootFrameViewport* root_frame_viewport = static_cast<RootFrameViewport*>(GetDocument().View()->GetScrollableArea());
    root_frame_viewport->SetPendingHistoryRestoreScrollOffset(view_state, false, mojom::blink::ScrollBehavior::kAuto);
