...
public:
    ...
    static PerformanceEventTiming* CreateFirstInputTiming(PerformanceEventTiming* entry);

    PerformanceEventTiming(const AtomicString& event_type, const AtomicString& entry_type, EventTimingReportingInfo repoerting_info, bool cancelable,
        Node* target, DOMWindow* source);
    ...
    void SetPerfettoData(Frame* frame, perfetto::protos::pbzero::EventTiming* traced_value, base::TimeTicks time_origin);
