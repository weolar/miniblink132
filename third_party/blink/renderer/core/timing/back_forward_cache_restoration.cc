...
BackForwardCacheRestoration::BackForwardCacheRestoration(
    DOMHighResTimeStamp start_time, DOMHighResTimeStamp pageshow_event_start, DOMHighResTimeStamp pageshow_event_end, DOMWindow* source)
...
void BackForwardCacheRestoration::BuildJSONValue(V8ObjectBuilder& builder) const
{
