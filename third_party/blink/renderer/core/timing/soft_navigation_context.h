...
class CORE_EXPORT SoftNavigationContext : public GarbageCollected<SoftNavigationContext> {
public:
    ...
    void MarkMainModification()
    {
        has_main_modification_ = true;
    }
    bool HasMainModification() const
    {
        return has_main_modification_;
    }
