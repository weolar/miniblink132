...
public:
    static LayoutShiftAttribution* Create(Node*, DOMRectReadOnly* previous, DOMRectReadOnly* current);
    LayoutShiftAttribution(Node*, DOMRectReadOnly* previous, DOMRectReadOnly* current);
