...
public:
    ...
    static SiteHashSet ParsePerformanceMarkSiteHashes(const std::string& allow_list)
    {
...
TEST_F(BackgroundTracingHelperTest, MD5Hash32)
{
    ...
    static constexpr char kQuickFox[] = "the quick fox jumps over the lazy brown dog";
    static constexpr uint32_t kQuickFoxHash = 0x01275c33;
    static_assert(kQuickFoxHash == base::MD5Hash32Constexpr(kQuickFox), "unexpected hash");
