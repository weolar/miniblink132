...
public:
    using WebMemoryAttribution = performance_manager::mojom::blink::WebMemoryAttribution;
    using WebMemoryMeasurement = performance_manager::mojom::blink::WebMemoryMeasurement;
    ...
    static void StartMeasurement(v8::Isolate*, WebMemoryMeasurement::Mode, MeasureMemoryController*, WebMemoryAttribution::Scope, WTF::String attribution_url);
...
private:
    LocalWebMemoryMeasurer(MeasureMemoryController*, WebMemoryAttribution::Scope, WTF::String attribution_url);
