...
constexpr int kTechnologyCount = std::bit_width(static_cast<uint64_t>(ThirdPartyScriptDetector::Technology::kLast));
...
ThirdPartyScriptDetector::Technology GetTechnologyFromGroupIndex(int index)
{
    ...
    DEFINE_STATIC_LOCAL(const Vector<Technology>, technologies_in_regex_capturing_group_order, ([] {
        Vector<Technology> vector { Technology::kElementor, Technology::kGoogleAnalytics, Technology::kGoogleFontApi, Technology::kGoogleTagManager,
            Technology::kGoogleMaps, Technology::kMetaPixel, Technology::kYouTube, Technology::kAdobeAnalytics, Technology::kTiktokPixel, Technology::kHotjar,
            Technology::kGoogleAdSense, Technology::kGooglePublisherTag, Technology::kGoogleAdsLibraries, Technology::kFundingChoices,
            Technology::kSliderRevolution, Technology::kWordPress };
        return vector;
    }()));
...
// static
const char ThirdPartyScriptDetector::kSupplementName[] = "ThirdPartyScriptDetector";

// static
ThirdPartyScriptDetector& ThirdPartyScriptDetector::From(LocalDOMWindow& window)
{
    ThirdPartyScriptDetector* supplement = Supplement<LocalDOMWindow>::From<ThirdPartyScriptDetector>(window);
    if (!supplement) {
...
//, precompiled_detection_regex__(kThirdPartyTechnologiesSourceLocationRegexString)
{
}
...
ThirdPartyScriptDetector::Technology ThirdPartyScriptDetector::Detect(const WTF::String url)
{
    *(int*)1 = 1;
