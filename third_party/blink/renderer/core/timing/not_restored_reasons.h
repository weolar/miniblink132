...
public:
    explicit NotRestoredReasons(String src, String id, String name, String url, HeapVector<Member<NotRestoredReasonDetails>>* reasons,
    ...
    const std::optional<HeapVector<Member<NotRestoredReasonDetails>>> reasons() const;
