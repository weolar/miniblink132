...
base::TimeDelta TimeClamper::ClampTimeResolution(base::TimeDelta time, bool cross_origin_isolated_capability) const
{
    ...
    int resolution = cross_origin_isolated_capability ? kFineResolutionMicroseconds : kCoarseResolutionMicroseconds;
...
inline double TimeClamper::ThresholdFor(int64_t clamped_time, int resolution) const
{
