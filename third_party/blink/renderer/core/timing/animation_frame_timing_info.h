...
public:
    enum class InvokerType { kClassicScript, kModuleScript, kUserCallback, kEventHandler, kPromiseResolve, kPromiseReject };
    ...
    ScriptTimingInfo(ExecutionContext* context, InvokerType invoker_type, base::TimeTicks start_time, base::TimeTicks execution_start_time,
        base::TimeTicks end_time, base::TimeDelta style_duration, base::TimeDelta layout_duration);

    void Trace(Visitor* visitor) const;
    InvokerType GetInvokerType() const
    {
        return invoker_type_;
    }
    base::TimeTicks StartTime() const
    {
        return start_time_;
    }
    base::TimeTicks ExecutionStartTime() const
    {
        return execution_start_time_;
    }
    base::TimeTicks EndTime() const
    {
        return end_time_;
    }
    base::TimeDelta PauseDuration() const
    {
    ...
    base::TimeDelta StyleDuration() const
    {
        return style_duration_;
    }
    base::TimeDelta LayoutDuration() const
    {
        return layout_duration_;
    }
    ...
    const AtomicString& ClassLikeName() const
    {
        return class_like_name_;
    }
    void SetClassLikeName(const AtomicString& name)
    {
        class_like_name_ = name;
    }
    const AtomicString& PropertyLikeName() const
    {
        return property_like_name_;
    }
...
class AnimationFrameTimingInfo : public GarbageCollected<AnimationFrameTimingInfo> {
public:
    explicit AnimationFrameTimingInfo(base::TimeTicks start_time)
        : frame_start_time(start_time)
    {
    }
    void SetRenderStartTime(base::TimeTicks time)
    {
    ...
    void SetRenderEndTime(base::TimeTicks time)
    {
        render_end_time = time;
    }
    void SetFirstUIEventTime(base::TimeTicks time)
    {
        first_ui_event_time = time;
    }

    base::TimeTicks FrameStartTime() const
    {
        return frame_start_time;
    }
    base::TimeTicks RenderStartTime() const
    {
    ...
    base::TimeTicks RenderEndTime() const
    {
        return render_end_time;
    }
    base::TimeTicks FirstUIEventTime() const
    {
        return first_ui_event_time;
    }
