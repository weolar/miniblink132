...
private:
    ...
    PairSyncIterable<EventCounts>::IterationSource* CreateIterationSource(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, uint64_t& value, ExceptionState&) override;
