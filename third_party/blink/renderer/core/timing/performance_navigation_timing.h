...
class CORE_EXPORT PerformanceNavigationTiming final : public PerformanceResourceTiming, public ExecutionContextClient {
    DEFINE_WRAPPERTYPEINFO();
    friend class PerformanceNavigationTimingTest;

public:
    PerformanceNavigationTiming(LocalDOMWindow&, mojom::blink::ResourceTimingInfoPtr, base::TimeTicks time_origin);
...
private:
    ...
    static V8NavigationTimingType::Enum GetNavigationTimingType(WebNavigationType);
    ...
    NotRestoredReasons* BuildNotRestoredReasons(const mojom::blink::BackForwardCacheNotRestoredReasonsPtr& reasons) const;
};
} // namespace blink
