...
class RenderBlockingMetricsReporter final : public GarbageCollected<RenderBlockingMetricsReporter>, public Supplement<Document> {
public:
    ...
    RenderBlockingMetricsReporter& operator=(const RenderBlockingMetricsReporter&) = delete;
