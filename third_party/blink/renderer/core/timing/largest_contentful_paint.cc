...
LargestContentfulPaint::LargestContentfulPaint(double start_time, DOMHighResTimeStamp render_time, uint64_t size, DOMHighResTimeStamp load_time,
    ...
    : PerformanceEntry(g_empty_atom, start_time, start_time, source, is_triggered_by_soft_navigation)
    , size_(size)
