...
public:
    static PerformanceElementTiming* Create(const AtomicString& name, const String& url, const gfx::RectF& intersection_rect, DOMHighResTimeStamp render_time,
        DOMHighResTimeStamp load_time, const AtomicString& identifier, int naturalWidth, int naturalHeight, const AtomicString& id, Element*,
        DOMWindow* source);
    PerformanceElementTiming(const AtomicString& name, DOMHighResTimeStamp start_time, const String& url, const gfx::RectF& intersection_rect,
        DOMHighResTimeStamp render_time, DOMHighResTimeStamp load_time, const AtomicString& identifier, int naturalWidth, int naturalHeight,
        const AtomicString& id, Element*, DOMWindow* source);
