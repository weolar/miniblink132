...
public:
    ...
    // and returns false.
    static bool CanProfile(LocalDOMWindow*, ExceptionState* = nullptr, ReportOptions = ReportOptions::kDoNotReport);
    ...
    Profiler* CreateProfiler(ScriptState* script_state, const ProfilerInitOptions&, base::TimeTicks time_origin, ExceptionState&);
...
private:
    ...
    void StopProfiler(ScriptState*, Profiler*, ScriptPromiseResolver<ProfilerTrace>*);
...
public:
    explicit DiscardedSamplesDelegate(ProfilerGroup* profiler_group, String profiler_id)
