...
TEST_F(PerformanceEntryTest, GetNavigationId)
{
    ...
    String navigation_id1 = PerformanceEntry::GetNavigationId(scope.GetScriptState());

    scope.GetFrame().DomWindow()->GenerateNewNavigationId();
    String navigation_id2 = PerformanceEntry::GetNavigationId(scope.GetScriptState());
