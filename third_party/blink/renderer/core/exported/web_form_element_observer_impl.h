...
class CORE_EXPORT WebFormElementObserverImpl final : public GarbageCollected<WebFormElementObserverImpl>, public WebFormElementObserver {
public:
    WebFormElementObserverImpl(base::PassKey<WebFormElementObserver>, HTMLElement&, base::OnceClosure);
    WebFormElementObserverImpl(const WebFormElementObserverImpl&) = delete;
    WebFormElementObserverImpl& operator=(const WebFormElementObserverImpl&) = delete;
