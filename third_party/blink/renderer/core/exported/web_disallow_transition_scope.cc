...
WebDisallowTransitionScope::WebDisallowTransitionScope(WebDocument* web_document)
...
DocumentLifecycle& WebDisallowTransitionScope::Lifecycle(WebDocument* web_document) const
{
