...
TEST(LineRelativeRectTest, EnclosingRect)
{
    ...
    EXPECT_EQ(lor2.size.inline_size, LayoutUnit(10.015625)) << "inline size clamped to 20 and 1/64";
    EXPECT_EQ(lor2.size.block_size, LayoutUnit(100.015625)) << "block size clamped to 30 and 1/64";
}
...
{
    test::TaskEnvironment task_environment;
    LineRelativeRect r_origin = { { LayoutUnit(), LayoutUnit() }, { LayoutUnit(20), LayoutUnit(30) } };

    WritingMode writing_mode = WritingMode::kHorizontalTb;
    std::optional<AffineTransform> rotation = r_origin.ComputeRelativeToPhysicalTransform(writing_mode);
...
{
    test::TaskEnvironment task_environment;
    LineRelativeRect r_origin = { { LayoutUnit(1000), LayoutUnit(10000) }, { LayoutUnit(10), LayoutUnit(100) } };
    ...
    writing_mode = WritingMode::kVerticalRl;
    rotation = r_origin.ComputeRelativeToPhysicalTransform(writing_mode);
    EXPECT_EQ(rotation, AffineTransform(0, 1, -1, 0, 11100, 9000)) << "kVerticalRl";

    writing_mode = WritingMode::kSidewaysLr;
    rotation = r_origin.ComputeRelativeToPhysicalTransform(writing_mode);
    EXPECT_EQ(rotation, AffineTransform(0, -1, 1, 0, -9000, 11010)) << "kSidewaysLr";
}
...
TEST(LineRelativeRectTest, Create_kHorizontalTB)
{
    ...
    const LineRelativeRect rotated_box = LineRelativeRect::CreateFromLineBox(r, is_horizontal);
    std::optional<AffineTransform> rotation = rotated_box.ComputeRelativeToPhysicalTransform(writing_mode);
    ...
    EXPECT_EQ(rotated.size.inline_size, 5) << "first half inline_size, no rotation";
    EXPECT_EQ(rotated.size.block_size, 100) << "first half block_size, no rotation";
    ...
    EXPECT_EQ(rotated2.size.inline_size, 5) << "second half inline_size, no rotation";
    EXPECT_EQ(rotated2.size.block_size, 100) << "second half block_size, no rotation";
}
...
TEST(LineRelativeRectTest, EnclosingLineRelativeRect)
{
    ...
    LineRelativeRect rect_1 = { { LayoutUnit(10), LayoutUnit(0) }, { LayoutUnit(20), LayoutUnit(30) } };
    ...
    LineRelativeRect rect_2 = { { LayoutUnit(10.25), LayoutUnit(0.25) }, { LayoutUnit(20.5), LayoutUnit(30.5) } };
    ...
    LineRelativeRect rect_3 = { { LayoutUnit(10.75), LayoutUnit(0.75) }, { LayoutUnit(20.25), LayoutUnit(30.25) } };
    ...
    LineRelativeRect rect_4 = { { LayoutUnit(10.75), LayoutUnit(0.75) }, { LayoutUnit(20.5), LayoutUnit(30.5) } };
...
TEST(LineRelativeRectTest, Unite)
{
    ...
    // Nothing should change
    LineRelativeRect rect_1 = { { LayoutUnit(10), LayoutUnit(0) }, { LayoutUnit(20), LayoutUnit(40) } };
    LineRelativeRect rect_2 = { { LayoutUnit(0), LayoutUnit(10) }, { LayoutUnit(40), LayoutUnit(20) } };
