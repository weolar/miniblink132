...
CORE_EXPORT void ShowTransformPropertyTree(const blink::LocalFrameView& rootFrame);
...
CORE_EXPORT String TransformPropertyTreeAsString(const blink::LocalFrameView& rootFrame);
CORE_EXPORT String ClipPropertyTreeAsString(const blink::LocalFrameView& rootFrame);
CORE_EXPORT String EffectPropertyTreeAsString(const blink::LocalFrameView& rootFrame);
CORE_EXPORT String ScrollPropertyTreeAsString(const blink::LocalFrameView& rootFrame);
