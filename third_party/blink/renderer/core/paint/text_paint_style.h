...
public:
    ...
    {
        visitor->Trace(shadow);
    }

    bool operator==(const TextPaintStyle& other) const
    {
        return current_color == other.current_color && fill_color == other.fill_color && stroke_color == other.stroke_color
            && emphasis_mark_color == other.emphasis_mark_color && stroke_width == other.stroke_width && color_scheme == other.color_scheme
            && shadow == other.shadow && selection_decoration_lines == other.selection_decoration_lines
            && selection_decoration_color == other.selection_decoration_color && paint_order == other.paint_order;
    }
    bool operator!=(const TextPaintStyle& other) const
    {
        return !(*this == other);
