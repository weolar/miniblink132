...
AccompaniedFragmentIterator::AccompaniedFragmentIterator(const LayoutObject& object)
...
const PhysicalBoxFragment* AccompaniedFragmentIterator::GetPhysicalBoxFragment() const
{
    if (ng_layout_box_) {
