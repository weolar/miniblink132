...
public:
    void ComputeFragmentOffsetOnLine(TextDirection, LayoutUnit* offset_on_line, LayoutUnit* total_width) const;

protected:
    InlineBoxFragmentPainterBase(const PhysicalFragment& inline_box_fragment, const InlineCursor* inline_box_cursor, const FragmentItem& inline_box_item,
        const LayoutObject& layout_object, const ComputedStyle& style, const ComputedStyle& line_style, InlinePaintContext* inline_context)
    ...
    InlineBoxFragmentPainterBase(const InlineCursor& inline_box_cursor, const FragmentItem& inline_box_item, const PhysicalBoxFragment& inline_box_fragment,
        const LayoutObject& layout_object, const ComputedStyle& style, const ComputedStyle& line_style, InlinePaintContext* inline_context)
        : InlineBoxFragmentPainterBase(inline_box_fragment, &inline_box_cursor, inline_box_item, layout_object, style, line_style, inline_context)
    {
    }
    ...
    PhysicalRect PaintRectForImageStrip(const PhysicalRect&, TextDirection direction) const;
    ...
    SlicePaintingType GetBorderPaintType(const PhysicalRect& adjusted_frame_rect, gfx::Rect& adjusted_clip_rect, bool object_has_multiple_boxes) const;
    SlicePaintingType GetSlicePaintType(
        const NinePieceImage&, const PhysicalRect& adjusted_frame_rect, gfx::Rect& adjusted_clip_rect, bool object_has_multiple_boxes) const;

    void PaintNormalBoxShadow(const PaintInfo&, const ComputedStyle&, const PhysicalRect& paint_rect);
    void PaintInsetBoxShadow(const PaintInfo&, const ComputedStyle&, const PhysicalRect& paint_rect);

    void PaintBackgroundBorderShadow(const PaintInfo&, const PhysicalOffset& paint_offset);

    void PaintBoxDecorationBackground(BoxPainterBase&, const PaintInfo&, const PhysicalOffset& paint_offset, const PhysicalRect& adjusted_frame_rect,
        const BoxBackgroundPaintContext&, bool object_has_multiple_boxes, PhysicalBoxSides sides_to_include);

    void PaintFillLayers(BoxPainterBase&, const PaintInfo&, const Color&, const FillLayer&, const PhysicalRect&, const BoxBackgroundPaintContext&,
        bool object_has_multiple_boxes);
    void PaintFillLayer(BoxPainterBase&, const PaintInfo&, const Color&, const FillLayer&, const PhysicalRect&, const BoxBackgroundPaintContext&,
        bool object_has_multiple_boxes);
...
public:
    // Constructor for |FragmentItem|.
    InlineBoxFragmentPainter(const InlineCursor& inline_box_cursor, const FragmentItem& inline_box_item, const PhysicalBoxFragment& inline_box_fragment,
        InlinePaintContext* inline_context)
        : InlineBoxFragmentPainterBase(inline_box_cursor, inline_box_item, inline_box_fragment, *inline_box_fragment.GetLayoutObject(),
            inline_box_fragment.Style(), inline_box_fragment.Style(), inline_context)
    {
        CheckValid();
    }
    InlineBoxFragmentPainter(const InlineCursor& inline_box_cursor, const FragmentItem& inline_box_item, InlinePaintContext* inline_context)
        : InlineBoxFragmentPainter(inline_box_cursor, inline_box_item, *inline_box_item.BoxFragment(), inline_context)
    {
    ...
    static void PaintAllFragments(const LayoutInline& layout_inline, const FragmentData& fragment_data, wtf_size_t fragment_data_idx, const PaintInfo&);
...
public:
    LineBoxFragmentPainter(const PhysicalFragment& line_box_fragment, const FragmentItem& line_box_item, const PhysicalBoxFragment& block_fragment)
        : LineBoxFragmentPainter(line_box_fragment, line_box_item, block_fragment, *block_fragment.GetLayoutObject())
    {
    }
...
private:
    LineBoxFragmentPainter(const PhysicalFragment& line_box_fragment, const FragmentItem& line_box_item, const PhysicalBoxFragment& block_fragment,
        ...
        : InlineBoxFragmentPainterBase(line_box_fragment,
            /* inline_box_cursor */ nullptr, line_box_item, layout_block_flow,
            ...
            layout_block_flow.StyleRef(), layout_block_flow.FirstLineStyleRef(),
