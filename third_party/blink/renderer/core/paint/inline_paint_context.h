...
public:
    ...
    const DecoratingBoxList& DecoratingBoxes() const
    {
        return decorating_boxes_;
    }
    ...
    template <class... Args> void PushDecoratingBox(Args&&... args)
    {
    ...
    void ClearDecoratingBoxes(DecoratingBoxList* saved_decorating_boxes = nullptr);

    void SetLineBox(const InlineCursor& line_cursor);
    void ClearLineBox();

    const PhysicalOffset& PaintOffset() const
    {
    ...
    public:
        ScopedInlineItem(const FragmentItem& inline_item, InlinePaintContext* inline_context);
        ~ScopedInlineItem();
    ...
    public:
        ScopedInlineBoxAncestors(const InlineCursor& inline_box, InlinePaintContext* inline_context);
    ...
    public:
        ScopedLineBox(const InlineCursor& line_cursor, InlinePaintContext* inline_context);
        ~ScopedLineBox();
    ...
    public:
        ScopedPaintOffset(const PhysicalOffset& paint_offset, InlinePaintContext* inline_context)
...
private:
    wtf_size_t SyncDecoratingBox(const FragmentItem& item, DecoratingBoxList* saved_decorating_boxes = nullptr);
...
inline InlinePaintContext::ScopedInlineBoxAncestors::~ScopedInlineBoxAncestors()
{
    if (inline_context_)
