...
public:
    ...
    ObjectPaintProperties& EnsurePaintProperties()
    {
        ...
        if (!rare_data_->paint_properties) {
            rare_data_->paint_properties = MakeGarbageCollected<ObjectPaintProperties>();
        }
    ...
    void EnsureId()
    {
        EnsureRareData().EnsureId();
    }
    bool HasUniqueId() const
    {
        return rare_data_ && rare_data_->unique_id;
    }
    ...
    {
        return rare_data_ && rare_data_->local_border_box_properties.IsInitialized();
    }
    ...
    {
        return PropertyTreeStateOrAlias(ContentsTransform(), ContentsClip(), ContentsEffect());
    }
...
protected:
    ...
    public:
        ...
        TraceablePropertyTreeStateOrAlias local_border_box_properties { TraceablePropertyTreeStateOrAlias::kUninitialized };
        CullRect cull_rect_;
