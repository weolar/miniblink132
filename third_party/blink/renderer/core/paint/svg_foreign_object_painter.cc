...
SVGForeignObjectPainter::SVGForeignObjectPainter(const LayoutSVGForeignObject& layout_svg_foreign_object)
...
void SVGForeignObjectPainter::PaintLayer(const PaintInfo& paint_info)
{
    ...
    PaintLayerPainter(*layout_svg_foreign_object_.Layer()).Paint(paint_info.context, paint_info.GetPaintFlags());
}
