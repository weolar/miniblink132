...
{
    return phase == PaintPhase::kBlockBackground || phase == PaintPhase::kSelfBlockBackgroundOnly;
}
...
{
    return phase == PaintPhase::kBlockBackground || phase == PaintPhase::kDescendantBlockBackgroundsOnly;
}

inline bool ShouldPaintDescendantOutlines(PaintPhase phase)
{
    return phase == PaintPhase::kOutline || phase == PaintPhase::kDescendantOutlinesOnly;
}
