...
public:
    ...
    void PaintBoxDecorationBackground(const PaintInfo&, const PhysicalRect&, const BoxDecorationData&);

    void PaintCollapsedBorders(const PaintInfo&, const PhysicalOffset&, const gfx::Rect& visual_rect);
...
public:
    explicit TableSectionPainter(const PhysicalBoxFragment& table_section_fragment)
    ...
    void PaintColumnsBackground(
        const PaintInfo&, const PhysicalOffset& section_paint_offset, const PhysicalRect& columns_paint_rect, const TableFragmentData::ColumnGeometries&);
...
public:
    ...
    void PaintColumnsBackground(
        const PaintInfo&, const PhysicalOffset& row_paint_offset, const PhysicalRect& columns_paint_rect, const TableFragmentData::ColumnGeometries&);
