...
class CORE_EXPORT PaintTimingVisualizer : public trace_event::EnabledStateObserver {
    DISALLOW_NEW();
...
public:
    ...
    void DumpImageDebuggingRect(const LayoutObject&, const gfx::RectF&, bool is_loaded, const KURL& url);
