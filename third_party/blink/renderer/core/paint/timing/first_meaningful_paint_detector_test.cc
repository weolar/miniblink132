...
protected:
    ...
    void ClearFirstPaintPresentationPromise()
    {
        ...
        GetPaintTiming().ReportPresentationTime(PaintEvent::kFirstPaint, presentation_details);
    }
    ...
    void ClearFirstContentfulPaintPresentationPromise()
    {
        ...
        viz::FrameTimingDetails presentation_details;
        presentation_details.presentation_feedback.timestamp = Now();
        GetPaintTiming().ReportPresentationTime(PaintEvent::kFirstContentfulPaint, presentation_details);
    }
    ...
    void ClearProvisionalFirstMeaningfulPaintPresentationPromise(base::TimeTicks timestamp)
    {
        viz::FrameTimingDetails presentation_details;
        presentation_details.presentation_feedback.timestamp = timestamp;
        Detector().ReportPresentationTime(PaintEvent::kProvisionalFirstMeaningfulPaint, presentation_details);
    }
...
TEST_F(FirstMeaningfulPaintDetectorTest, TwoLayoutsSignificantFirst)
{
    ...
    EXPECT_EQ(OutstandingDetectorPresentationPromiseCount(), 0U);
    SimulateNetworkStable();
    EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint(), GetPaintTiming().FirstPaintRendered());
...
{
    MarkFirstContentfulPaintAndClearPresentationPromise();
    EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaintCandidate(), base::TimeTicks());
    SimulateLayoutAndPaint(1);
    EXPECT_EQ(OutstandingDetectorPresentationPromiseCount(), 1U);
    ClearProvisionalFirstMeaningfulPaintPresentationPromise();
    base::TimeTicks after_paint = AdvanceClockAndGetTime();
...
TEST_F(FirstMeaningfulPaintDetectorTest, OnlyOneFirstMeaningfulPaintCandidateBeforeNetworkStable)
{
    MarkFirstContentfulPaintAndClearPresentationPromise();
    EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaintCandidate(), base::TimeTicks());
...
TEST_F(FirstMeaningfulPaintDetectorTest, NetworkStableBeforeFirstContentfulPaint)
{
...
TEST_F(FirstMeaningfulPaintDetectorTest, FirstMeaningfulPaintShouldNotBeBeforeFirstContentfulPaint)
{
    MarkFirstPaintAndClearPresentationPromise();
    SimulateLayoutAndPaint(10);
    EXPECT_EQ(OutstandingDetectorPresentationPromiseCount(), 1U);
    ...
    MarkFirstContentfulPaintAndClearPresentationPromise();
    SimulateNetworkStable();
    EXPECT_GE(GetPaintTiming().FirstMeaningfulPaint(), GetPaintTiming().FirstContentfulPaintIgnoringSoftNavigations());
}

TEST_F(FirstMeaningfulPaintDetectorTest, FirstMeaningfulPaintAfterUserInteraction)
{
    MarkFirstContentfulPaintAndClearPresentationPromise();
    SimulateUserInput();
    SimulateLayoutAndPaint(10);
...
TEST_F(FirstMeaningfulPaintDetectorTest, WaitForSingleOutstandingPresentationPromiseAfterNetworkStable)
{
    MarkFirstContentfulPaintAndClearPresentationPromise();
    SimulateLayoutAndPaint(10);
    EXPECT_EQ(OutstandingDetectorPresentationPromiseCount(), 1U);
...
TEST_F(FirstMeaningfulPaintDetectorTest, WaitForMultipleOutstandingPresentationPromisesAfterNetworkStable)
{
    MarkFirstContentfulPaintAndClearPresentationPromise();
    SimulateLayoutAndPaint(1);
    EXPECT_EQ(OutstandingDetectorPresentationPromiseCount(), 1U);
...
TEST_F(FirstMeaningfulPaintDetectorTest, WaitForFirstContentfulPaintPresentationpAfterNetworkStable)
{
    MarkFirstPaintAndClearPresentationPromise();
    SimulateLayoutAndPaint(10);
    EXPECT_EQ(OutstandingDetectorPresentationPromiseCount(), 1U);
    ...
    ClearFirstContentfulPaintPresentationPromise();
    EXPECT_GT(GetPaintTiming().FirstMeaningfulPaint(), base::TimeTicks());
    EXPECT_EQ(GetPaintTiming().FirstMeaningfulPaint(), GetPaintTiming().FirstContentfulPaintIgnoringSoftNavigations());
}

TEST_F(FirstMeaningfulPaintDetectorTest, ProvisionalTimestampChangesAfterNetworkQuietWithOutstandingPresentationPromise)
{
    MarkFirstContentfulPaintAndClearPresentationPromise();
    SimulateLayoutAndPaint(1);
    EXPECT_EQ(OutstandingDetectorPresentationPromiseCount(), 1U);
