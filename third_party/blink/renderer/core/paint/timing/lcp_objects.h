...
struct LargestContentfulPaintDetails {
    ...
    blink::LargestContentfulPaintType largest_contentful_paint_type = blink::LargestContentfulPaintType::kNone;
    ...
    std::optional<WebURLRequest::Priority> largest_contentful_paint_image_request_priority = std::nullopt;
};
...
public:
    LCPRectInfo(const gfx::Rect& frame_rect_info, const gfx::Rect& root_rect_info)
        : frame_rect_info_(frame_rect_info)
        , root_rect_info_(root_rect_info)
    {
    }
