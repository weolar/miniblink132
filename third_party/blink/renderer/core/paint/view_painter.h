...
private:
    void PaintRootElementGroup(const PaintInfo&, const gfx::Rect& pixel_snapped_background_rect, const PropertyTreeStateOrAlias& background_paint_state,
        const DisplayItemClient& background_client, bool painted_separate_backdrop, bool painted_separate_effect);

    void PaintRootGroup(const PaintInfo& paint_info, const gfx::Rect& pixel_snapped_background_rect, const Document&,
        const DisplayItemClient& background_client, const PropertyTreeStateOrAlias& state);
