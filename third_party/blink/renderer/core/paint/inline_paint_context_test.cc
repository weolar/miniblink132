...
public:
    ...
    Vector<float> GetFontSizes(const InlinePaintContext::DecoratingBoxList& boxes)
    {
...
TEST_F(InlinePaintContextTest, VerticalAlign)
{
    ...
    EXPECT_EQ(span1_item.InkOverflowRect().Bottom() + span1_item.OffsetInContainerFragment().top,
...
TEST_F(InlinePaintContextTest, NestedBlocks)
{
    ...
    EXPECT_THAT(GetFontSizes(context.DecoratingBoxes()), testing::ElementsAre(20.f, 20.f));
    ...
    EXPECT_THAT(GetFontSizes(context.DecoratingBoxes()), testing::ElementsAre(20.f, 20.f, 10.f));

    const LayoutObject* span5 = GetLayoutObjectByElementId("span5");
    cursor.MoveTo(*span5);
    EXPECT_TRUE(cursor.Current());
    context.PushDecoratingBox(*cursor.Current());
    EXPECT_THAT(GetFontSizes(context.DecoratingBoxes()), testing::ElementsAre(20.f, 20.f, 10.f, 5.f));
    ...
    EXPECT_THAT(GetFontSizes(context2.DecoratingBoxes()), testing::ElementsAre(20.f, 20.f, 10.f));
}
