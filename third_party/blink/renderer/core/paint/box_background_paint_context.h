...
public:
    ...
    BoxBackgroundPaintContext(const LayoutView&, const PhysicalBoxFragment*, const PhysicalOffset& element_positioning_area_offset);
    ...
    BoxBackgroundPaintContext(const LayoutTableCell& cell, PhysicalOffset cell_offset, const LayoutBox& table_part, PhysicalSize table_part_size);
    ...
    PhysicalRect ComputePositioningArea(const PaintInfo& paint_info, const FillLayer& fill_layer, const PhysicalRect& paint_rect) const;
    ...
    PhysicalBoxStrut InnerBorderOutsets(const PhysicalRect& dest_rect, const PhysicalRect& positioning_area) const;
    SnappedAndUnsnappedOutsets ObscuredBorderOutsets(const PhysicalRect& dest_rect, const PhysicalRect& positioning_area) const;
...
private:
    BoxBackgroundPaintContext(const LayoutBoxModelObject* box, const LayoutBoxModelObject* positioning_box);
