...
public:
    ...
    {
        return TextPaintStyle { color, color, color, color, 2, ::blink::mojom::blink::ColorScheme::kLight, nullptr, TextDecorationLine::kNone, color,
            kPaintOrderNormal };
    }
};
...
TEST_F(HighlightOverlayTest, ComputeLayers)
{
    ...
    EXPECT_EQ(HighlightOverlay::ComputeLayers(GetDocument(), text, style, text_style, paint_info, nullptr, *none, *none, *none, *none, *none),
        HeapVector<HighlightLayer> { HighlightLayer { HighlightLayerType::kOriginating } })
        << "should return kOriginating when nothing is highlighted";

    EXPECT_EQ(HighlightOverlay::ComputeLayers(GetDocument(), text, style, text_style, paint_info, &selection, *none, *none, *none, *none, *none),
    ...
    search->push_back(MakeGarbageCollected<TextMatchMarker>(1, 2, TextMatchMarker::MatchStatus::kActive));
    search->push_back(MakeGarbageCollected<TextMatchMarker>(2, 3, TextMatchMarker::MatchStatus::kInactive));

    EXPECT_EQ(HighlightOverlay::ComputeLayers(GetDocument(), text, style, text_style, paint_info, nullptr, *none, *grammar, *spelling, *target, *search),
        (HeapVector<HighlightLayer> {
            HighlightLayer { HighlightLayerType::kOriginating },
    ...
    HighlightRegistry* registry = HighlightRegistry::From(*text->GetDocument().domWindow());
    ...
    HeapVector<Member<AbstractRange>>* range_vector = MakeGarbageCollected<HeapVector<Member<AbstractRange>>>();
    ...
    DocumentMarkerVector custom = marker_controller.MarkersFor(*text, DocumentMarker::MarkerTypes::CustomHighlight());
    EXPECT_EQ(HighlightOverlay::ComputeLayers(GetDocument(), text, style, text_style, paint_info, nullptr, custom, *none, *none, *none, *none),
        (HeapVector<HighlightLayer> {
            HighlightLayer { HighlightLayerType::kOriginating },
...
TEST_F(HighlightOverlayTest, ComputeEdges)
{
    ...
    layers = HighlightOverlay::ComputeLayers(GetDocument(), text, text_style, paint_style, paint_info, nullptr, *none, *none, *none, *none, *none);
    EXPECT_EQ(HighlightOverlay::ComputeEdges(text, false, originating, layers, nullptr, *none, *none, *none, *none, *none), (Vector<HighlightEdge> {}))
        << "should return no edges when nothing is highlighted";

    layers = HighlightOverlay::ComputeLayers(GetDocument(), text, text_style, paint_style, paint_info, &selection, *none, *none, *none, *none, *none);
    EXPECT_EQ(HighlightOverlay::ComputeEdges(nullptr, false, originating, layers, &selection, *none, *none, *none, *none, *none),
    ...
    layers = HighlightOverlay::ComputeLayers(GetDocument(), br, br_style, paint_style, paint_info, &selection, *none, *none, *none, *none, *none);
    EXPECT_EQ(HighlightOverlay::ComputeEdges(br, false, originating, layers, &selection, *none, *none, *none, *none, *none),
        (Vector<HighlightEdge> {
            HighlightEdge { { 1, 3 }, HighlightLayerType::kSelection, 1, HighlightEdgeType::kStart },
            HighlightEdge { { 1, 3 }, HighlightLayerType::kSelection, 1, HighlightEdgeType::kEnd },
        }))
    ...
    search->push_back(MakeGarbageCollected<TextMatchMarker>(4, 5, TextMatchMarker::MatchStatus::kActive));
    spelling->push_back(MakeGarbageCollected<SpellingMarker>(4, 5, ""));
    spelling->push_back(MakeGarbageCollected<SpellingMarker>(5, 6, ""));

    layers
        = HighlightOverlay::ComputeLayers(GetDocument(), text, text_style, paint_style, paint_info, &selection, *none, *grammar, *spelling, *target, *search);
    EXPECT_EQ(HighlightOverlay::ComputeEdges(text, false, originating, layers, &selection, *none, *grammar, *spelling, *target, *search),
        (Vector<HighlightEdge> {
            HighlightEdge { { 1, 2 }, HighlightLayerType::kGrammar, 1, HighlightEdgeType::kStart },
            HighlightEdge { { 1, 3 }, HighlightLayerType::kSelection, 6, HighlightEdgeType::kStart },
            HighlightEdge { { 1, 2 }, HighlightLayerType::kGrammar, 1, HighlightEdgeType::kEnd },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kGrammar, 1, HighlightEdgeType::kStart },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kSpelling, 2, HighlightEdgeType::kStart },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kTargetText, 3, HighlightEdgeType::kStart },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kSearchTextActiveMatch, 5, HighlightEdgeType::kStart },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kGrammar, 1, HighlightEdgeType::kEnd },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kSpelling, 2, HighlightEdgeType::kEnd },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kTargetText, 3, HighlightEdgeType::kEnd },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kSearchTextActiveMatch, 5, HighlightEdgeType::kEnd },
            HighlightEdge { { 1, 3 }, HighlightLayerType::kSelection, 6, HighlightEdgeType::kEnd },
            HighlightEdge { { 3, 4 }, HighlightLayerType::kSpelling, 2, HighlightEdgeType::kStart },
            HighlightEdge { { 3, 4 }, HighlightLayerType::kSpelling, 2, HighlightEdgeType::kEnd },
        }))
        << "should return edges in correct order";

    TextOffsetRange originating2 { 4, 5 };

    EXPECT_EQ(HighlightOverlay::ComputeEdges(text, false, originating2, layers, &selection, *none, *grammar, *spelling, *target, *search),
        (Vector<HighlightEdge> {
            HighlightEdge { { 1, 3 }, HighlightLayerType::kSelection, 6, HighlightEdgeType::kStart },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kGrammar, 1, HighlightEdgeType::kStart },
            HighlightEdge { { 2, 3 }, HighlightLayerType::kSpelling, 2, HighlightEdgeType::kStart },
...
TEST_F(HighlightOverlayTest, ComputeParts)
{
    ...
    HeapVector<Member<AbstractRange>>* foo_range_vector = MakeGarbageCollected<HeapVector<Member<AbstractRange>>>();
    foo_range_vector->push_back(foo_range);
    HeapVector<Member<AbstractRange>>* bar_range_vector = MakeGarbageCollected<HeapVector<Member<AbstractRange>>>();
    ...
    HeapVector<HighlightLayer> layers
        = HighlightOverlay::ComputeLayers(GetDocument(), text, text_style, paint_style, paint_info, &selection, custom, *grammar, *spelling, *target, *none);
    ...
    HighlightStyleUtils::HighlightTextPaintStyle originating_text_style { CreatePaintStyle(originating_color), originating_color, Color::kTransparent,
    ...
    HighlightStyleUtils::HighlightTextPaintStyle foo_text_style { CreatePaintStyle(foo_color), foo_color, foo_background, foo_current_colors };
    layers[1].text_style = foo_text_style;

    Color bar_color(0, 0, 2);
    Color bar_background(1, 0, 2);
    HighlightStyleUtils::HighlightColorPropertySet bar_current_colors { HighlightStyleUtils::HighlightColorProperty::kCurrentColor,
        HighlightStyleUtils::HighlightColorProperty::kFillColor, HighlightStyleUtils::HighlightColorProperty::kStrokeColor,
        HighlightStyleUtils::HighlightColorProperty::kEmphasisColor, HighlightStyleUtils::HighlightColorProperty::kSelectionDecorationColor,
        HighlightStyleUtils::HighlightColorProperty::kTextDecorationColor, HighlightStyleUtils::HighlightColorProperty::kBackgroundColor };
    HighlightStyleUtils::HighlightTextPaintStyle bar_text_style { CreatePaintStyle(bar_color), bar_color, bar_background, bar_current_colors };
    ...
    HighlightStyleUtils::HighlightTextPaintStyle spelling_text_style { CreatePaintStyle(spelling_color), spelling_color, spelling_background,
        spelling_current_colors };
    layers[3].text_style = spelling_text_style;

    Color target_color(0, 0, 4);
    Color target_background(1, 0, 4);
    HighlightStyleUtils::HighlightColorPropertySet target_current_colors { HighlightStyleUtils::HighlightColorProperty::kCurrentColor,
        HighlightStyleUtils::HighlightColorProperty::kFillColor, HighlightStyleUtils::HighlightColorProperty::kStrokeColor,
        HighlightStyleUtils::HighlightColorProperty::kEmphasisColor, HighlightStyleUtils::HighlightColorProperty::kSelectionDecorationColor,
        HighlightStyleUtils::HighlightColorProperty::kTextDecorationColor, HighlightStyleUtils::HighlightColorProperty::kBackgroundColor };
    HighlightStyleUtils::HighlightTextPaintStyle target_text_style { CreatePaintStyle(target_color), target_color, target_background, target_current_colors };
    ...
    HighlightStyleUtils::HighlightTextPaintStyle selection_text_style { CreatePaintStyle(selection_color), selection_color, selection_background,
    ...
    Vector<HighlightEdge> edges = HighlightOverlay::ComputeEdges(text, false, originating_dom_offsets, layers, nullptr, *none, *none, *none, *none, *none);
    ...
    Vector<HighlightEdge> edges2
        = HighlightOverlay::ComputeEdges(text, false, originating_dom_offsets, layers, &selection, custom, *grammar, *spelling, *target, *none);
    ...
    EXPECT_EQ(HighlightOverlay::ComputeParts(originating, layers, edges2),
        (HeapVector<HighlightPart> {
            HighlightPart { HighlightLayerType::kCustom, 1, { 0, 6 }, foo_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 0, 25 }, originating_color }, { HighlightLayerType::kCustom, 1, { 0, 14 }, foo_color } },
                { { HighlightLayerType::kCustom, 1, foo_background } }, { { HighlightLayerType::kCustom, 1, foo_color } } },
            HighlightPart { HighlightLayerType::kSpelling, 3, { 6, 9 }, spelling_text_style.style, 0,
                ...
                { { HighlightLayerType::kCustom, 1, foo_background }, { HighlightLayerType::kSpelling, 3, spelling_background } },
                { { HighlightLayerType::kCustom, 1, foo_color }, { HighlightLayerType::kSpelling, 3, spelling_color } } },
            ...
            HighlightPart { HighlightLayerType::kSpelling, 3, { 10, 13 }, spelling_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 0, 25 }, originating_color }, { HighlightLayerType::kCustom, 1, { 0, 14 }, foo_color },
                    { HighlightLayerType::kCustom, 2, { 10, 19 }, foo_color }, { HighlightLayerType::kSpelling, 3, { 10, 14 }, spelling_color } },
                { { HighlightLayerType::kCustom, 1, foo_background }, { HighlightLayerType::kCustom, 2, foo_color },
                    { HighlightLayerType::kSpelling, 3, spelling_background } },
                { { HighlightLayerType::kCustom, 1, foo_color }, { HighlightLayerType::kCustom, 2, foo_color },
            ...
            HighlightPart { HighlightLayerType::kSelection, 5, { 13, 14 }, selection_text_style.style, 0,
                ...
                { { HighlightLayerType::kCustom, 1, foo_background }, { HighlightLayerType::kCustom, 2, foo_color },
                    { HighlightLayerType::kSpelling, 3, spelling_background }, { HighlightLayerType::kSelection, 5, selection_background } },
                { { HighlightLayerType::kCustom, 1, foo_color }, { HighlightLayerType::kCustom, 2, foo_color },
                    { HighlightLayerType::kSpelling, 3, spelling_color }, { HighlightLayerType::kSelection, 5, selection_color } } },
            HighlightPart { HighlightLayerType::kSelection, 5, { 14, 15 }, selection_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 0, 25 }, originating_color }, { HighlightLayerType::kCustom, 2, { 10, 19 }, originating_color },
                    { HighlightLayerType::kSelection, 5, { 13, 19 }, selection_color } },
                { { HighlightLayerType::kCustom, 2, originating_color }, { HighlightLayerType::kSelection, 5, selection_background } },
                { { HighlightLayerType::kCustom, 2, originating_color }, { HighlightLayerType::kSelection, 5, selection_color } } },
            HighlightPart { HighlightLayerType::kSelection, 5, { 15, 19 }, selection_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 0, 25 }, originating_color }, { HighlightLayerType::kCustom, 2, { 10, 19 }, originating_color },
                    { HighlightLayerType::kTargetText, 4, { 15, 23 }, originating_color }, { HighlightLayerType::kSelection, 5, { 13, 19 }, selection_color } },
                { { HighlightLayerType::kCustom, 2, originating_color }, { HighlightLayerType::kTargetText, 4, originating_color },
            ...
            HighlightPart { HighlightLayerType::kTargetText, 4, { 19, 20 }, originating_text_style.style, 0,
                ...
                { { HighlightLayerType::kTargetText, 4, originating_color } }, { { HighlightLayerType::kTargetText, 4, originating_color } } },
            HighlightPart { HighlightLayerType::kTargetText, 4, { 20, 23 }, spelling_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 0, 25 }, originating_color }, { HighlightLayerType::kSpelling, 3, { 20, 23 }, spelling_color },
                    { HighlightLayerType::kTargetText, 4, { 15, 23 }, spelling_color } },
                { { HighlightLayerType::kSpelling, 3, spelling_background }, { HighlightLayerType::kTargetText, 4, spelling_color } },
                { { HighlightLayerType::kSpelling, 3, spelling_color }, { HighlightLayerType::kTargetText, 4, spelling_color } } },
    ...
    EXPECT_EQ(HighlightOverlay::ComputeParts(originating, layers, edges3),
        (HeapVector<HighlightPart> {
            HighlightPart { HighlightLayerType::kOriginating, 0, { 0, 6 }, originating_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 0, 25 }, originating_color } } },
            HighlightPart { HighlightLayerType::kSpelling, 3, { 6, 9 }, spelling_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 0, 25 }, originating_color }, { HighlightLayerType::kCustom, 1, { 6, 14 }, foo_color },
                    { HighlightLayerType::kSpelling, 3, { 6, 9 }, spelling_color } },
                { { HighlightLayerType::kCustom, 1, foo_background }, { HighlightLayerType::kSpelling, 3, spelling_background } },
                { { HighlightLayerType::kCustom, 1, foo_color }, { HighlightLayerType::kSpelling, 3, spelling_color } } },
            HighlightPart { HighlightLayerType::kCustom, 1, { 9, 10 }, foo_text_style.style, 0,
    ...
    Vector<HighlightEdge> edges4
        = HighlightOverlay::ComputeEdges(text, false, originating2_dom_offsets, layers, &selection, custom, *grammar, *spelling, *target, *none);
    ...
    EXPECT_EQ(HighlightOverlay::ComputeParts(originating2, layers, edges4),
        (HeapVector<HighlightPart> {
            HighlightPart { HighlightLayerType::kSpelling, 3, { 8, 9 }, spelling_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 8, 18 }, originating_color }, { HighlightLayerType::kCustom, 1, { 8, 14 }, foo_color },
            ...
            HighlightPart { HighlightLayerType::kSpelling, 3, { 10, 13 }, spelling_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 8, 18 }, originating_color }, { HighlightLayerType::kCustom, 1, { 8, 14 }, foo_color },
                    { HighlightLayerType::kCustom, 2, { 10, 18 }, foo_color }, { HighlightLayerType::kSpelling, 3, { 10, 14 }, spelling_color } },
                { { HighlightLayerType::kCustom, 1, foo_background }, { HighlightLayerType::kCustom, 2, foo_color },
                    { HighlightLayerType::kSpelling, 3, spelling_background } },
                { { HighlightLayerType::kCustom, 1, foo_color }, { HighlightLayerType::kCustom, 2, foo_color },
                    { HighlightLayerType::kSpelling, 3, spelling_color } } },
            HighlightPart { HighlightLayerType::kSelection, 5, { 13, 14 }, selection_text_style.style, 0,
                ...
                { { HighlightLayerType::kCustom, 1, foo_color }, { HighlightLayerType::kCustom, 2, foo_color },
                    { HighlightLayerType::kSpelling, 3, spelling_color }, { HighlightLayerType::kSelection, 5, selection_color } } },
            HighlightPart { HighlightLayerType::kSelection, 5, { 14, 15 }, selection_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 8, 18 }, originating_color }, { HighlightLayerType::kCustom, 2, { 10, 18 }, originating_color },
                    { HighlightLayerType::kSelection, 5, { 13, 18 }, selection_color } },
                { { HighlightLayerType::kCustom, 2, originating_color }, { HighlightLayerType::kSelection, 5, selection_background } },
                { { HighlightLayerType::kCustom, 2, originating_color }, { HighlightLayerType::kSelection, 5, selection_color } } },
            HighlightPart { HighlightLayerType::kSelection, 5, { 15, 18 }, selection_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 8, 18 }, originating_color }, { HighlightLayerType::kCustom, 2, { 10, 18 }, originating_color },
                    { HighlightLayerType::kTargetText, 4, { 15, 18 }, originating_color }, { HighlightLayerType::kSelection, 5, { 13, 18 }, selection_color } },
                { { HighlightLayerType::kCustom, 2, originating_color }, { HighlightLayerType::kTargetText, 4, originating_color },
                    { HighlightLayerType::kSelection, 5, selection_background } },
                { { HighlightLayerType::kCustom, 2, originating_color }, { HighlightLayerType::kTargetText, 4, originating_color },
                    { HighlightLayerType::kSelection, 5, selection_color } } },
    ...
    Vector<HighlightEdge> edges5
        = HighlightOverlay::ComputeEdges(text, false, originating2_dom_offsets, layers, nullptr, *none, *none, *spelling, *none, *none);

    EXPECT_EQ(HighlightOverlay::ComputeParts(originating2, layers, edges5),
        (HeapVector<HighlightPart> {
            HighlightPart { HighlightLayerType::kSpelling, 3, { 8, 9 }, spelling_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 8, 18 }, originating_color }, { HighlightLayerType::kSpelling, 3, { 8, 9 }, spelling_color } },
                { { HighlightLayerType::kSpelling, 3, spelling_background } }, { { HighlightLayerType::kSpelling, 3, spelling_color } } },
            ...
            HighlightPart { HighlightLayerType::kSpelling, 3, { 10, 14 }, spelling_text_style.style, 0,
                { { HighlightLayerType::kOriginating, 0, { 8, 18 }, originating_color }, { HighlightLayerType::kSpelling, 3, { 10, 14 }, spelling_color } },
                { { HighlightLayerType::kSpelling, 3, spelling_background } }, { { HighlightLayerType::kSpelling, 3, spelling_color } } },
    ...
    Vector<HighlightEdge> edges6
        = HighlightOverlay::ComputeEdges(text, false, originating3_dom_offsets, layers, &selection, custom, *grammar, *spelling, *target, *none);
    ...
    Vector<HighlightEdge> edges7
        = HighlightOverlay::ComputeEdges(text, false, originating4_dom_offsets, layers, &selection, custom, *grammar, *spelling, *target, *none);
