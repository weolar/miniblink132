...
public:
    explicit TextDecorationPainter(TextPainter& text_painter, const InlinePaintContext* inline_context, const PaintInfo& paint_info, const ComputedStyle& style,
        const TextPaintStyle& text_style, const LineRelativeRect& decoration_rect, HighlightPainter::SelectionPaintState* selection);
    ...
    void UpdateDecorationInfo(std::optional<TextDecorationInfo>&, const FragmentItem&, const ComputedStyle&, std::optional<LineRelativeRect> = {},
    ...
    void PaintExceptLineThrough(TextDecorationInfo&, const TextPaintStyle&, const TextFragmentPaintInfo&, TextDecorationLine lines_to_paint);
    void PaintOnlyLineThrough(TextDecorationInfo&, const TextPaintStyle&);

    const InlinePaintContext* InlineContext() const
    {
...
private:
    ...
    void PaintUnderOrOverLineDecorations(TextDecorationInfo&, const TextFragmentPaintInfo&, const TextPaintStyle&, TextDecorationLine lines_to_paint);
