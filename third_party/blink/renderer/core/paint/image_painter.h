...
public:
    ImagePainter(const LayoutImage& layout_image)
        : layout_image_(layout_image)
    {
    }
    ...
    // offset.
    void PaintIntoRect(GraphicsContext&, const PhysicalRect& dest_rect, const PhysicalRect& content_rect);
