...
public:
    PaintLayerPainter(PaintLayer& paint_layer)
...
private:
    ...
    PaintResult PaintChildren(PaintLayerIteration children_to_visit, GraphicsContext&, PaintFlags);
    void PaintFragmentWithPhase(PaintPhase, const FragmentData&, wtf_size_t fragment_data_idx, const PhysicalBoxFragment*, GraphicsContext&, PaintFlags);
