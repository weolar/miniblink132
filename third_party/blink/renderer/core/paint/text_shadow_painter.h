...
public:
    ScopedTextShadowPainter(GraphicsContext& context, const TextPaintStyle& text_style)
    {
...
template <typename PaintProc> void PaintWithTextShadow(PaintProc paint_proc, GraphicsContext& context, const TextPaintStyle& text_style)
{
    if (text_style.shadow) {
