...
public:
    explicit CullRectUpdater(PaintLayer& starting_layer, bool disable_expansion = false);
    ...
    static void PaintPropertiesChanged(const LayoutObject&, const PaintPropertiesChangeInfo&);
...
private:
    ...
    CullRect ComputeFragmentCullRect(Context&, PaintLayer&, const FragmentData& fragment, const FragmentData& parent_fragment);
    CullRect ComputeFragmentContentsCullRect(Context&, PaintLayer&, const FragmentData& fragment, const CullRect& cull_rect);
