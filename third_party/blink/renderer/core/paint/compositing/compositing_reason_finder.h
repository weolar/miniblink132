...
public:
    static CompositingReasons DirectReasonsForPaintProperties(const LayoutObject&, const LayoutObject* container_for_fixed_position = nullptr);

    static bool ShouldForcePreferCompositingToLCDText(const LayoutObject&, CompositingReasons reasons_except_scrolling);
    ...
    static CompositingReasons PotentialCompositingReasonsFor3DTransform(const ComputedStyle&);
