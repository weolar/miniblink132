...
class CORE_EXPORT WorkerAnimationFrameProvider : public GarbageCollected<WorkerAnimationFrameProvider>, public BeginFrameProviderClient {
public:
    WorkerAnimationFrameProvider(ExecutionContext* context, const BeginFrameProviderParams& begin_frame_provider_params);
    WorkerAnimationFrameProvider(const WorkerAnimationFrameProvider&) = delete;
    WorkerAnimationFrameProvider& operator=(const WorkerAnimationFrameProvider&) = delete;
