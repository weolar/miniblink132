...
class ComputedStyle;
using CustomHighlightsStyleMap = HeapHashMap<AtomicString, Member<const ComputedStyle>>;
...
public:
    ...
    const ComputedStyle* Style(PseudoId, const AtomicString& pseudo_argument = g_null_atom) const;
