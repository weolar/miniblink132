...
public:
    ...
    StyleContentAlignmentData(ContentPosition position, ContentDistributionType distribution, OverflowAlignment overflow = OverflowAlignment::kDefault)
    ...
    {
        return position_ == o.position_ && distribution_ == o.distribution_ && overflow_ == o.overflow_;
    }
