...
struct FillSize {
    DISALLOW_NEW();
    FillSize()
        : type(EFillSizeType::kSizeLength)
    {
    }
...
struct FillRepeat {
    ...
    bool operator==(const FillRepeat& r) const
    {
        return x == r.x && y == r.y;
    }
    bool operator!=(const FillRepeat& r) const
...
public:
    ...
    const Length& PositionX() const
    {
        return position_x_;
    }
    const Length& PositionY() const
    {
        return position_y_;
    }
    ...
    EFillBox Clip() const
    {
        return static_cast<EFillBox>(clip_);
    }
    EFillBox Origin() const
    {
        return static_cast<EFillBox>(origin_);
    }
    const FillRepeat& Repeat() const
    {
        return repeat_;
    }
    ...
    {
        return static_cast<BlendMode>(blend_mode_);
    }
    const LengthSize& SizeLength() const
    {
        return size_length_;
    }
    ...
    bool IsPositionXSet() const
    {
        return pos_x_set_;
    }
    bool IsPositionYSet() const
    {
        return pos_y_set_;
    }
    bool IsBackgroundXOriginSet() const
    {
        return background_x_origin_set_;
    }
    bool IsBackgroundYOriginSet() const
    {
        return background_y_origin_set_;
    }
    bool IsAttachmentSet() const
    {
        return attachment_set_;
    }
    ...
    bool IsRepeatSet() const
    {
        return repeat_set_;
    }
    bool IsMaskModeSet() const
    {
        return mask_mode_set_;
    }
    bool IsCompositingOperatorSet() const
    {
        return compositing_operator_set_;
    }

    bool IsBlendModeSet() const
    {
        return blend_mode_set_;
    }
    ...
    {
        size_type_ = static_cast<unsigned>(b);
    }
    void SetSizeLength(const LengthSize& length)
    {
        size_length_ = length;
    }
    ...
    void ClearMaskMode()
    {
        mask_mode_set_ = false;
    }
    void ClearCompositingOperator()
    {
        compositing_operator_set_ = false;
    }
    void ClearBlendMode()
    {
    ...
    EFillLayerType GetType() const
    {
        return static_cast<EFillLayerType>(type_);
    }
    ...
    {
        return type == EFillLayerType::kBackground ? EFillBox::kPadding : EFillBox::kBorder;
    }
    ...
    static enum CompositingOperator InitialFillCompositingOperator(EFillLayerType)
    {
    ...
    static StyleImage* InitialFillImage(EFillLayerType)
    {
        return nullptr;
    }
...
public:
    explicit FillLayerWrapper(EFillLayerType type)
        : layer(type)
    {
    }
