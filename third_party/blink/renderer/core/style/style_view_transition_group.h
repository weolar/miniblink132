...
public:
    ...
    {
        return type_ == GroupType::kNearest;
    }
    bool IsCustom() const
    {
        return type_ == GroupType::kCustom;
    }
    bool IsNormal() const
    {
        return type_ == GroupType::kNormal;
    }
    bool IsContain() const
    {
        return type_ == GroupType::kContain;
    }
...
private:
    ...
    explicit StyleViewTransitionGroup(GroupType type)
        : type_(type)
    {
    }
    GroupType type_;
