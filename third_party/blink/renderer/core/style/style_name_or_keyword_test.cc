...
{
    StyleName name_custom_ident(AtomicString("foo"), StyleName::Type::kCustomIdent);
...
TEST(StyleNameOrKeywordTest, Keyword)
{
    ...
    EXPECT_EQ(CSSValueID::kAuto, StyleNameOrKeyword(CSSValueID::kAuto).GetKeyword());
    EXPECT_EQ(CSSValueID::kNone, StyleNameOrKeyword(CSSValueID::kNone).GetKeyword());
}
...
TEST(StyleNameOrKeywordTest, Equality)
{
    ...
    EXPECT_EQ(StyleNameOrKeyword(CSSValueID::kAuto), StyleNameOrKeyword(CSSValueID::kAuto));
    EXPECT_EQ(StyleNameOrKeyword(name_string), StyleNameOrKeyword(name_string));
    EXPECT_EQ(StyleNameOrKeyword(name_custom_ident), StyleNameOrKeyword(name_custom_ident));
    EXPECT_NE(StyleNameOrKeyword(name_custom_ident), StyleNameOrKeyword(name_string));
    EXPECT_NE(StyleNameOrKeyword(CSSValueID::kAuto), StyleNameOrKeyword(CSSValueID::kNone));
}
