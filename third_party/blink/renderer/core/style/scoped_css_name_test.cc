...
{
    ScopedCSSName* foo = MakeGarbageCollected<ScopedCSSName>(AtomicString("foo"), nullptr);
...
{
    ScopedCSSName* foo = MakeGarbageCollected<ScopedCSSName>(AtomicString("foo"), nullptr);
    ScopedCSSName* bar = MakeGarbageCollected<ScopedCSSName>(AtomicString("bar"), nullptr);
...
{
    ScopedCSSName* foo1 = MakeGarbageCollected<ScopedCSSName>(AtomicString("foo"), nullptr);
    ScopedCSSName* foo2 = MakeGarbageCollected<ScopedCSSName>(AtomicString("foo"), nullptr);
    ScopedCSSName* foo3 = MakeGarbageCollected<ScopedCSSName>(AtomicString("foo"), nullptr);
