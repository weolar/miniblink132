...
private:
    ...
    static constexpr unsigned EncodeFields(EPaintOrderType first, EPaintOrderType second, EPaintOrderType third)
    {
    ...
    static constexpr EPaintOrder ReorderMarkerPaintType(EPaintOrder paint_order)
    {
        ...
        if (paint_order == kPaintOrderFillMarkersStroke || paint_order == kPaintOrderMarkersFillStroke) {
            return kPaintOrderFillStrokeMarkers;
        }
        if (paint_order == kPaintOrderStrokeMarkersFill || paint_order == kPaintOrderMarkersStrokeFill) {
