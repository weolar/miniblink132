...
class CORE_EXPORT StyleInheritedVariables : public GarbageCollected<StyleInheritedVariables> {
public:
...
private:
    ...
    friend CORE_EXPORT std::ostream& operator<<(std::ostream& stream, const StyleInheritedVariables& variables);
};

// For debugging/logging.
CORE_EXPORT std::ostream& operator<<(std::ostream& stream, const StyleInheritedVariables& variables);
