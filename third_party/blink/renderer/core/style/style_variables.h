...
private:
    ...
    friend CORE_EXPORT std::ostream& operator<<(std::ostream& stream, const StyleVariables& variables);
};

CORE_EXPORT std::ostream& operator<<(std::ostream& stream, const StyleVariables& variables);
