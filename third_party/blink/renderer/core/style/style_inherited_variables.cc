...
bool StyleInheritedVariables::HasEquivalentRoots(const StyleInheritedVariables& other) const
{
...
StyleVariables::OptionalData StyleInheritedVariables::GetData(const AtomicString& name) const
{
...
StyleVariables::OptionalValue StyleInheritedVariables::GetValue(const AtomicString& name) const
{
...
std::ostream& operator<<(std::ostream& stream, const StyleInheritedVariables& variables)
{
    if (variables.root_) {
