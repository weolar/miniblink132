...
public:
    ...
    // current layout.
    unsigned MinWordChars() const
    {
        return min_word_chars_;
    }
    unsigned MinBeforeChars() const
    {
        return min_before_chars_;
    }
    unsigned MinAfterChars() const
    {
        return min_after_chars_;
    }
...
inline bool StyleHyphenateLimitChars::operator==(const StyleHyphenateLimitChars& other) const
{
    return min_word_chars_ == other.min_word_chars_ && min_before_chars_ == other.min_before_chars_ && min_after_chars_ == other.min_after_chars_;
}
