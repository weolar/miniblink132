...
public:
    ...
    // center ] ]
    StyleSelfAlignmentData(ItemPosition position, OverflowAlignment overflow, ItemPositionType position_type = ItemPositionType::kNonLegacy)
    ...
    {
        return position_ == o.position_ && position_type_ == o.position_type_ && overflow_ == o.overflow_;
    }
