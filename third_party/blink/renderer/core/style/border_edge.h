...
public:
    BorderEdge(int edge_width, const Color& edge_color, EBorderStyle edge_style, bool edge_is_present = true);
    BorderEdge();
    ...
    enum DoubleBorderStripe { kDoubleBorderStripeOuter, kDoubleBorderStripeInner };
