...
public:
    ...
    PositionArea(PositionAreaRegion span1_start, PositionAreaRegion span1_end, PositionAreaRegion span2_start, PositionAreaRegion span2_end)
    ...
    PositionAreaRegion FirstStart() const
    {
        return span1_start_;
    }
    PositionAreaRegion FirstEnd() const
    {
        return span1_end_;
    }
    PositionAreaRegion SecondStart() const
    {
        return span2_start_;
    }
    PositionAreaRegion SecondEnd() const
    {
        return span2_end_;
    }
    ...
    {
        return span1_start_ == other.span1_start_ && span1_end_ == other.span1_end_ && span2_start_ == other.span2_start_ && span2_end_ == other.span2_end_;
    }
    bool operator!=(const PositionArea& other) const
    {
        return !(*this == other);
    ...
    bool IsNone() const
    {
        return span1_start_ == PositionAreaRegion::kNone;
    }
    ...
    PositionArea ToPhysical(const WritingDirectionMode& container_writing_direction, const WritingDirectionMode& self_writing_direction) const;
    ...
    std::pair<StyleSelfAlignmentData, StyleSelfAlignmentData> AlignJustifySelfFromPhysical(
