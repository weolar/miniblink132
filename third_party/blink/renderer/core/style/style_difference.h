...
public:
    ...
    StyleDifference()
        : paint_invalidation_type_(static_cast<unsigned>(PaintInvalidationType::kNone))
    ...
    {
        paint_invalidation_type_ = std::max(paint_invalidation_type_, other.paint_invalidation_type_);
        ...
        scroll_anchor_disabling_property_changed_ |= other.scroll_anchor_disabling_property_changed_;
        compositing_reasons_changed_ |= other.compositing_reasons_changed_;
        compositable_paint_effect_changed_ |= other.compositable_paint_effect_changed_;
    ...
    {
        return (paint_invalidation_type_ != static_cast<unsigned>(PaintInvalidationType::kNone)) || layout_type_ || needs_reshape_
            || property_specific_differences_ || recompute_visual_overflow_ || scroll_anchor_disabling_property_changed_ || compositing_reasons_changed_
            || compositable_paint_effect_changed_ || border_radius_changed_ || transform_data_changed_;
    }
    ...
    {
        return paint_invalidation_type_ == static_cast<unsigned>(PaintInvalidationType::kSimple);
    }
    bool NeedsNormalPaintInvalidation() const
    {
        return paint_invalidation_type_ == static_cast<unsigned>(PaintInvalidationType::kNormal);
    }
    void SetNeedsSimplePaintInvalidation()
    {
        DCHECK(!NeedsNormalPaintInvalidation());
        paint_invalidation_type_ = static_cast<unsigned>(PaintInvalidationType::kSimple);
    }
    void SetNeedsNormalPaintInvalidation()
    {
        paint_invalidation_type_ = static_cast<unsigned>(PaintInvalidationType::kNormal);
    }

    bool NeedsLayout() const
    {
        return layout_type_ != kNoLayout;
    }
    ...
    bool NeedsFullLayout() const
    {
        return layout_type_ == kFullLayout;
    }
    void SetNeedsFullLayout()
    {
        layout_type_ = kFullLayout;
    }

    bool NeedsReshape() const
    {
        return needs_reshape_;
    }
    void SetNeedsReshape()
    {
        needs_reshape_ = true;
    }
    ...
    void SetNeedsRecomputeVisualOverflow()
    {
        recompute_visual_overflow_ = true;
    }
    ...
    {
        return property_specific_differences_ & kTransformPropertyChanged || property_specific_differences_ & kOtherTransformPropertyChanged;
    }
    ...
    void SetZIndexChanged()
    {
        property_specific_differences_ |= kZIndexChanged;
    }
    ...
    {
        property_specific_differences_ |= kFilterChanged;
    }
    ...
    void SetMaskChanged()
    {
        property_specific_differences_ |= kMaskChanged;
    }
    ...
    void SetCompositingReasonsChanged()
    {
        compositing_reasons_changed_ = true;
    }
    ...
    bool BorderRadiusChanged() const
    {
        return border_radius_changed_;
    }
    void SetBorderRadiusChanged()
    {
        border_radius_changed_ = true;
    }
    bool TransformDataChanged() const
    {
        return transform_data_changed_;
    }
    void SetTransformDataChanged()
    {
        transform_data_changed_ = true;
    }

private:
    static constexpr int kPropertyDifferenceCount = 11;

    friend CORE_EXPORT std::ostream& operator<<(std::ostream&, const StyleDifference&);
