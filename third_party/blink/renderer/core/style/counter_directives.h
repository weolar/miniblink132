...
public:
    ...
    {
        return IsReset() || IsIncrement() || IsSet();
    }
    ...
    int CombinedValue() const
    {
        ...
        return base::CheckAdd(reset_value_.value_or(0), increment_value_.value_or(0)).ValueOrDefault(reset_value_.value_or(0));
    }
