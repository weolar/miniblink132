...
public:
    ...
    ListStyleTypeData(Type type, AtomicString name_or_string_value, const TreeScope* tree_scope)
        : type_(type)
    ...
    static ListStyleTypeData* CreateCounterStyle(const AtomicString&, const TreeScope*);

    bool operator==(const ListStyleTypeData& other) const
    {
        return type_ == other.type_ && name_or_string_value_ == other.name_or_string_value_ && tree_scope_ == other.tree_scope_;
    }
    bool operator!=(const ListStyleTypeData& other) const
    {
    ...
    {
        return type_ == Type::kCounterStyle;
    }
    bool IsString() const
    {
