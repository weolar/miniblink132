...
class CORE_EXPORT ComputedGridTemplateAreas : public GarbageCollected<ComputedGridTemplateAreas> {
public:
    ComputedGridTemplateAreas() = default;
    ComputedGridTemplateAreas(const NamedGridAreaMap&, wtf_size_t row_count, wtf_size_t column_count);
    ...
    bool operator==(const ComputedGridTemplateAreas& other) const
    {
        ...
        return named_areas == other.named_areas && row_count == other.row_count && column_count == other.column_count;
    }
    ...
    static NamedGridLinesMap CreateImplicitNamedGridLinesFromGridArea(const NamedGridAreaMap& named_areas, GridTrackSizingDirection direction);
