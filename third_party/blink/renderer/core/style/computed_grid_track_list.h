...
struct CORE_EXPORT ComputedGridTrackList {
    ...
    {
        return track_list == other.track_list && named_grid_lines == other.named_grid_lines
            && auto_repeat_named_grid_lines == other.auto_repeat_named_grid_lines && ordered_named_grid_lines == other.ordered_named_grid_lines
            && auto_repeat_ordered_named_grid_lines == other.auto_repeat_ordered_named_grid_lines
            && auto_repeat_insertion_point == other.auto_repeat_insertion_point && auto_repeat_type == other.auto_repeat_type && axis_type == other.axis_type;
    }
