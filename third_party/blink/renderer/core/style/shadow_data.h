...
public:
    ShadowData(gfx::Vector2dF offset, float blur, float spread, ShadowStyle style, StyleColor color, float opacity = 1.0f)
        : offset_(offset)
        , blur_(blur, blur)
        , spread_(spread)
        , color_(color)
    ...
    ShadowData(gfx::Vector2dF offset, gfx::PointF blur, float spread, ShadowStyle style, StyleColor color, float opacity = 1.0f)
        : offset_(offset)
        , blur_(blur)
        , spread_(spread)
        , color_(color)
