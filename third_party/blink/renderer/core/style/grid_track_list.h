...
struct NGGridTrackRepeater {
    ...
    NGGridTrackRepeater(wtf_size_t repeat_index, wtf_size_t repeat_size, wtf_size_t repeat_count, wtf_size_t line_name_indices_count, RepeatType repeat_type);
...
public:
    ...
    bool AddRepeater(const Vector<GridTrackSize, 1>& repeater_track_sizes,
        NGGridTrackRepeater::RepeatType repeat_type = NGGridTrackRepeater::RepeatType::kNoRepeat, wtf_size_t repeat_count = 1u,
        wtf_size_t repeat_number_of_lines = 1u, wtf_size_t line_name_indices_count = 0u);
