...
public:
    ...
    {
        return direction_ == o.direction_ && offset_ == o.offset_ && mask_ == o.mask_;
    }
    bool operator!=(const StyleReflection& o) const
    {
        return !(*this == o);
    ...
    const Length& Offset() const
    {
        return offset_;
    }
    const NinePieceImage& Mask() const
    {
        return mask_;
    }
    ...
    void SetOffset(const Length& length)
    {
        offset_ = length;
    }
