...
class CORE_EXPORT StyleCachedData final : public GarbageCollected<StyleCachedData> {
public:
...
private:
    ...
    // end of the Vector).
    scoped_refptr<base::RefCountedData<Vector<AppliedTextDecoration, 1>>> applied_text_decorations_;
};
