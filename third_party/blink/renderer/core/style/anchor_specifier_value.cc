...
{
    DEFINE_STATIC_LOCAL(
        Persistent<AnchorSpecifierValue>, instance, { MakeGarbageCollected<AnchorSpecifierValue>(base::PassKey<AnchorSpecifierValue>(), Type::kDefault) });
    return instance;
}

AnchorSpecifierValue::AnchorSpecifierValue(base::PassKey<AnchorSpecifierValue>, Type type)
    : type_(type)
{
