...
public:
    static StyleBaseData* Create(const ComputedStyle* style, std::unique_ptr<CSSBitset> important_set)
    {
    ...
    const CSSBitset* GetBaseImportantSet() const
    {
        return important_set_.get();
    }
