...
protected:
    void SetUp() override
    {
        dummy_page_holder_ = std::make_unique<DummyPageHolder>(gfx::Size(0, 0), nullptr);
    ...
    ComputedStyleBuilder CreateComputedStyleBuilderFrom(const ComputedStyle& style)
    {
...
TEST_F(ComputedStyleTest, ShapeOutsideCircleEqual)
{
    ...
    auto* shape1 = MakeGarbageCollected<ShapeValue>(std::move(circle1), CSSBoxType::kContent);
    auto* shape2 = MakeGarbageCollected<ShapeValue>(std::move(circle2), CSSBoxType::kContent);
    ComputedStyleBuilder builder1 = CreateComputedStyleBuilder();
    ComputedStyleBuilder builder2 = CreateComputedStyleBuilder();
    builder1.SetShapeOutside(shape1);
    builder2.SetShapeOutside(shape2);
...
TEST_F(ComputedStyleTest, ClipPathEqual)
{
    ...
    ShapeClipPathOperation* path1 = MakeGarbageCollected<ShapeClipPathOperation>(shape, GeometryBox::kBorderBox);
    ShapeClipPathOperation* path2 = MakeGarbageCollected<ShapeClipPathOperation>(shape, GeometryBox::kBorderBox);
    ComputedStyleBuilder builder1 = CreateComputedStyleBuilder();
    ComputedStyleBuilder builder2 = CreateComputedStyleBuilder();
...
{
    for (uint8_t pseudo_id_int = kFirstPublicPseudoId; pseudo_id_int <= kLastTrackedPublicPseudoId; pseudo_id_int++) {
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesRespectsTransformAnimation)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsTransform)
{
    ...
    operations.Operations().push_back(MakeGarbageCollected<ScaleTransformOperation>(1, 1, TransformOperation::kScale));
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesRespectsScaleAnimation)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesRespectsRotateAnimation)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesRespectsTranslateAnimation)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsOpacity)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsFilter)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsBackdropFilter)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsBackfaceVisibility)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsWillChange)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
    builder.SetBackfaceVisibility(EBackfaceVisibility::kHidden);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsUsedStylePreserve3D)
{
    ComputedStyleBuilder builder = CreateComputedStyleBuilder();
    builder.SetTransformStyle3D(ETransformStyle3D::kPreserve3d);
    const ComputedStyle* style = builder.TakeStyle();
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsOverflow)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
    builder.SetOverflowX(EOverflow::kHidden);
...
TEST_F(ComputedStyleTest, UpdatePropertySpecificDifferencesCompositingReasonsContainsPaint)
{
    const ComputedStyle* style = InitialComputedStyle();
    ComputedStyleBuilder builder(*style);
    // This induces a flat used transform style.
...
{
    auto* gradient = MakeGarbageCollected<cssvalue::CSSLinearGradientValue>(nullptr, nullptr, nullptr, nullptr, nullptr, cssvalue::kRepeating);

    auto* image_value = MakeGarbageCollected<StyleGeneratedImage>(*gradient, StyleGeneratedImage::ContainerSizes());
    auto* other_image_value = MakeGarbageCollected<StyleGeneratedImage>(*gradient, StyleGeneratedImage::ContainerSizes());
...
#define TEST_ANIMATION_FLAG(flag, inherited)                                                                                                                   \
    do {                                                                                                                                                       \
        ...
        EXPECT_EQ(ComputedStyle::Difference::inherited, ComputedStyle::ComputeDifference(style, other));                                                       \
...
#define TEST_ANIMATION_FLAG_NO_DIFF(flag)                                                                                                                      \
    do {                                                                                                                                                       \
        ...
        const auto* other = InitialComputedStyle();                                                                                                            \
        EXPECT_FALSE(other->flag());                                                                                                                           \
        EXPECT_EQ(ComputedStyle::Difference::kEqual, ComputedStyle::ComputeDifference(style, other));                                                          \
        auto diff = style->VisualInvalidationDiff(document, *other);                                                                                           \
...
{
    css_test_helpers::RegisterProperty(GetDocument(), "--x", "<length>", "0px", false);
...
{
    css_test_helpers::RegisterProperty(GetDocument(), "--x", "<length>", "0px", true);
    ...
    EXPECT_EQ(ComputedStyle::Difference::kIndependentInherited, ComputedStyle::ComputeDifference(old_style, new_style));
...
TEST_F(ComputedStyleTest, CustomPropertiesInheritance_StyleRecalc)
{
    ...
    EXPECT_EQ(ComputedStyle::Difference::kInherited, ComputedStyle::ComputeDifference(old_style, new_style));
...
{
    Document& document = GetDocument();
    const ComputedStyle* initial = document.GetStyleResolver().InitialStyleForElement();
    ...
    StyleResolverState state(document, *document.documentElement(), nullptr /* StyleRecalcContext */, StyleRequest(initial));
    ...
    To<Longhand>(ref.GetProperty()).ApplyValue(state, *dark_value, CSSProperty::ValueMode::kNormal);
    EXPECT_EQ(mojom::blink::ColorScheme::kDark, state.StyleBuilder().UsedColorScheme());

    To<Longhand>(ref.GetProperty()).ApplyValue(state, *light_value, CSSProperty::ValueMode::kNormal);
    EXPECT_EQ(mojom::blink::ColorScheme::kLight, state.StyleBuilder().UsedColorScheme());
}
...
TEST_F(ComputedStyleTest, ApplyLightDarkColor)
{
    ...
    auto* color_declaration = ParseDeclarationBlock("color:light-dark(black, white)", CSSParserMode::kUASheetMode);
    ...
    cascade1.MutableMatchResult().AddMatchedProperties(color_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade1.MutableMatchResult().AddMatchedProperties(dark_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade1.Apply();
    ...
    cascade2.MutableMatchResult().AddMatchedProperties(color_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade2.MutableMatchResult().AddMatchedProperties(light_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade2.Apply();
...
TEST_F(ComputedStyleTest, ApplyLightDarkBackgroundImage)
{
    ...
    auto* bgimage_declaration = ParseDeclarationBlock("background-image:light-dark(none, url(dummy.png))", kUASheetMode);
    auto* dark_declaration = ParseDeclarationBlock("color-scheme:dark");
    auto* light_declaration = ParseDeclarationBlock("color-scheme:light");

    StyleCascade cascade1(state);
    cascade1.MutableMatchResult().BeginAddingAuthorRulesForTreeScope(document);
    cascade1.MutableMatchResult().AddMatchedProperties(bgimage_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade1.MutableMatchResult().AddMatchedProperties(dark_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade1.Apply();
    ...
    StyleCascade cascade2(state);
    cascade2.MutableMatchResult().BeginAddingAuthorRulesForTreeScope(document);
    cascade2.MutableMatchResult().AddMatchedProperties(bgimage_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade2.MutableMatchResult().AddMatchedProperties(light_declaration, { .origin = CascadeOrigin::kAuthor });
    cascade2.Apply();
...
TEST_F(ComputedStyleTest, StrokeWidthZoomAndCalc)
{
    ...
    auto* calc_value
        = CSSMathFunctionValue::Create(CSSMathExpressionNumericLiteral::Create(CSSNumericLiteralValue::Create(10, CSSPrimitiveValue::UnitType::kNumber)));

    GetCSSPropertyStrokeWidth().ApplyValue(state, *calc_value, CSSProperty::ValueMode::kNormal);
    const ComputedStyle* style = state.TakeStyle();
    auto* computed_value = GetCSSPropertyStrokeWidth().CSSValueFromComputedStyleInternal(
        *style, nullptr /* layout_object */, false /* allow_visited_style */, CSSValuePhase::kComputedValue);
...
TEST_F(ComputedStyleTest, InitialVariableNames)
{
    ...
    registry->RegisterProperty(AtomicString("--x"), *CreateLengthRegistration("--x", 1));
    registry->RegisterProperty(AtomicString("--y"), *CreateLengthRegistration("--y", 2));

    ComputedStyleBuilder builder = CreateComputedStyleBuilder();
    builder.SetInitialData(MakeGarbageCollected<StyleInitialData>(GetDocument(), *registry));
    const ComputedStyle* style = builder.TakeStyle();
...
TEST_F(ComputedStyleTest, InheritedVariableNames)
{
    ...
    ComputedStyleBuilder builder = CreateComputedStyleBuilder();
    builder.SetVariableData(AtomicString("--a"), CreateVariableData("foo"), inherited);
    builder.SetVariableData(AtomicString("--b"), CreateVariableData("bar"), inherited);
    const ComputedStyle* style = builder.TakeStyle();
...
TEST_F(ComputedStyleTest, InheritedAndNonInheritedVariableNames)
{
    ...
    builder.SetVariableData(AtomicString("--a"), CreateVariableData("foo"), inherited);
    builder.SetVariableData(AtomicString("--b"), CreateVariableData("bar"), inherited);
    builder.SetVariableData(AtomicString("--d"), CreateVariableData("foz"), !inherited);
    builder.SetVariableData(AtomicString("--c"), CreateVariableData("baz"), !inherited);
    const ComputedStyle* style = builder.TakeStyle();
...
TEST_F(ComputedStyleTest, InitialAndInheritedAndNonInheritedVariableNames)
{
    ...
    PropertyRegistry* registry = MakeGarbageCollected<PropertyRegistry>();
    registry->RegisterProperty(AtomicString("--b"), *CreateLengthRegistration("--b", 1));
    registry->RegisterProperty(AtomicString("--e"), *CreateLengthRegistration("--e", 2));
...
TEST_F(ComputedStyleTest, GetVariableNamesWithInitialData_Invalidation)
{
    ...
    // Not set StyleInitialData to something else.
    {
        ...
        PropertyRegistry* registry = MakeGarbageCollected<PropertyRegistry>();
        registry->RegisterProperty(AtomicString("--y"), *CreateLengthRegistration("--y", 2));
        registry->RegisterProperty(AtomicString("--z"), *CreateLengthRegistration("--z", 3));
        builder.SetInitialData(MakeGarbageCollected<StyleInitialData>(GetDocument(), *registry));
        style = builder.TakeStyle();
    }
    EXPECT_EQ(style->GetVariableNames().size(), 2u);
...
TEST_F(ComputedStyleTest, BorderWidthZoom)
{
    ...
    const struct {
        ...
        { document.getElementById(AtomicString("medium"))->GetComputedStyle(), 3.0 },
        { document.getElementById(AtomicString("thick"))->GetComputedStyle(), 5.0 },
    };

    for (const auto& test : tests) {
        for (const Longhand* property : { static_cast<const Longhand*>(&GetCSSPropertyBorderTopWidth()),
                 static_cast<const Longhand*>(&GetCSSPropertyOutlineWidth()), static_cast<const Longhand*>(&GetCSSPropertyColumnRuleWidth()) }) {
            const Longhand& longhand = To<Longhand>(*property);
            auto* computed_value = longhand.CSSValueFromComputedStyleInternal(
                *test.style, nullptr /* layout_object */, false /* allow_visited_style */, CSSValuePhase::kComputedValue);
...
TEST_F(ComputedStyleTest, BorderWidthConversion)
{
    ...
    for (const auto& test : tests) {
        for (const Longhand* longhand : { static_cast<const Longhand*>(&GetCSSPropertyBorderTopWidth()),
                 static_cast<const Longhand*>(&GetCSSPropertyOutlineWidth()), static_cast<const Longhand*>(&GetCSSPropertyColumnRuleWidth()) }) {
            auto* computed_value = longhand->CSSValueFromComputedStyleInternal(
                *test.style, nullptr /* layout_object */, false /* allow_visited_style */, CSSValuePhase::kComputedValue);
...
TEST_F(ComputedStyleTest, TextDecorationEqualDoesNotRequireRecomputeInkOverflow)
{
    using css_test_helpers::ParseDeclarationBlock;
    ...
    const ComputedStyle* style = document.getElementById(AtomicString("style"))->GetComputedStyle();
    const ComputedStyle* clone = document.getElementById(AtomicString("clone"))->GetComputedStyle();
    const ComputedStyle* other = document.getElementById(AtomicString("other"))->GetComputedStyle();
...
TEST_F(ComputedStyleTest, TextDecorationNotEqualRequiresRecomputeInkOverflow)
{
    ...
    const ComputedStyle* style = document.getElementById(AtomicString("style"))->GetComputedStyle();
    const ComputedStyle* wavy = document.getElementById(AtomicString("wavy"))->GetComputedStyle();
    const ComputedStyle* overline = document.getElementById(AtomicString("overline"))->GetComputedStyle();
    const ComputedStyle* thickness = document.getElementById(AtomicString("thickness"))->GetComputedStyle();
    const ComputedStyle* offset = document.getElementById(AtomicString("offset"))->GetComputedStyle();
    const ComputedStyle* position = document.getElementById(AtomicString("position"))->GetComputedStyle();

    // Change decoration style
    StyleDifference diff_decoration_style = style->VisualInvalidationDiff(GetDocument(), *wavy);
    EXPECT_TRUE(diff_decoration_style.NeedsRecomputeVisualOverflow());

    // Change decoration line
    StyleDifference diff_decoration_line = style->VisualInvalidationDiff(GetDocument(), *overline);
    EXPECT_TRUE(diff_decoration_line.NeedsRecomputeVisualOverflow());

    // Change decoration thickness
    StyleDifference diff_decoration_thickness = style->VisualInvalidationDiff(GetDocument(), *thickness);
    EXPECT_TRUE(diff_decoration_thickness.NeedsRecomputeVisualOverflow());

    // Change underline offset
    StyleDifference diff_underline_offset = style->VisualInvalidationDiff(GetDocument(), *offset);
    EXPECT_TRUE(diff_underline_offset.NeedsRecomputeVisualOverflow());

    // Change underline position
    StyleDifference diff_underline_position = style->VisualInvalidationDiff(GetDocument(), *position);
...
TEST_F(ComputedStyleTest, ClonedStyleAnimationsAreIndependent)
{
    ...
    cloned_style_animations.DelayStartList().push_back(CSSAnimationData::InitialDelayStart());
...
TEST_F(ComputedStyleTest, ClonedStyleTransitionsAreIndependent)
{
    ...
    cloned_style_transitions.PropertyList().push_back(CSSTransitionData::InitialProperty());
    const ComputedStyle* cloned_style = builder.TakeStyle();
...
#define TEST_STYLE_VALUE_NO_DIFF(field_name)                                                                                                                   \
    {                                                                                                                                                          \
        ComputedStyleBuilder builder1 = CreateComputedStyleBuilder();                                                                                          \
        ComputedStyleBuilder builder2 = CreateComputedStyleBuilder();                                                                                          \
        builder1.Set##field_name(ComputedStyleInitialValues::Initial##field_name());                                                                           \
        builder2.Set##field_name(ComputedStyleInitialValues::Initial##field_name());                                                                           \
        const ComputedStyle* style1 = builder1.TakeStyle();                                                                                                    \
        const ComputedStyle* style2 = builder2.TakeStyle();                                                                                                    \
...
TEST_F(ComputedStyleTest, ShouldApplyAnyContainment)
{
    ...
    std::vector display_types = { CSSValueID::kInline, CSSValueID::kBlock, CSSValueID::kListItem, CSSValueID::kInlineBlock, CSSValueID::kTable,
        CSSValueID::kInlineTable, CSSValueID::kTableRowGroup, CSSValueID::kTableHeaderGroup, CSSValueID::kTableFooterGroup, CSSValueID::kTableRow,
        CSSValueID::kTableColumnGroup, CSSValueID::kTableColumn, CSSValueID::kTableCell, CSSValueID::kTableCaption, CSSValueID::kWebkitBox,
        CSSValueID::kWebkitInlineBox, CSSValueID::kFlex, CSSValueID::kInlineFlex, CSSValueID::kGrid, CSSValueID::kInlineGrid, CSSValueID::kContents,
        CSSValueID::kFlowRoot, CSSValueID::kNone, CSSValueID::kMath };
    for (auto contain : { CSSValueID::kNone, CSSValueID::kLayout, CSSValueID::kPaint, CSSValueID::kSize, CSSValueID::kStyle }) {
        html->SetInlineStyleProperty(CSSPropertyID::kContain, GetCSSValueNameAs<String>(contain));
        body->SetInlineStyleProperty(CSSPropertyID::kContain, GetCSSValueNameAs<String>(contain));
        for (auto html_display : display_types) {
            ...
            for (auto body_display : display_types) {
                ...
                EXPECT_EQ(html->GetLayoutObject()->ShouldApplyAnyContainment(), html->GetLayoutObject()->StyleRef().ShouldApplyAnyContainment(*html))
                    << "html contain:" << GetCSSValueName(contain) << " display:" << GetCSSValueName(html_display);
                if (!body->GetLayoutObject()) {
                    if (const auto* body_style = body->GetComputedStyle()) {
                        EXPECT_EQ(body_style->Display(), EDisplay::kContents);
                        EXPECT_EQ(body_style->ShouldApplyAnyContainment(*body), contain == CSSValueID::kStyle);
                    }
                    continue;
                }
                EXPECT_EQ(body->GetLayoutObject()->ShouldApplyAnyContainment(), body->GetLayoutObject()->StyleRef().ShouldApplyAnyContainment(*body))
                    << "body contain:" << GetCSSValueName(contain) << " display:" << GetCSSValueName(body_display);
            }
        }
    }
}
...
TEST_F(ComputedStyleTest, DebugDiffFields)
{
    ...
    EXPECT_EQ("\"Length(Fixed, 100)\"", style1->DebugDiffFields(*style2)[0].actual);
    EXPECT_EQ("\"Length(Fixed, 200)\"", style1->DebugDiffFields(*style2)[0].correct);

    EXPECT_EQ("width_", ComputedStyleBase::DebugFieldToString(DebugField::width_));
}
...
TEST_F(ComputedStyleTest, DerivedDebugDiff)
{
    ...
    EXPECT_EQ(DebugField::forces_stacking_context_, style1->DebugDiffFields(*style2)[0].field);
    EXPECT_EQ("1", style1->DebugDiffFields(*style2)[0].actual);
    EXPECT_EQ("0", style1->DebugDiffFields(*style2)[0].correct);

    EXPECT_EQ(DebugField::is_stacking_context_without_containment_, style1->DebugDiffFields(*style2)[1].field);
...
TEST_F(ComputedStyleTest, ScrollTimelineNameNoDiff)
{
    ...
    builder1.SetScrollTimelineName(MakeGarbageCollected<ScopedCSSNameList>(HeapVector<Member<const ScopedCSSName>>(1u,
        MakeGarbageCollected<ScopedCSSName>(AtomicString("test"),
            /* tree_scope */ nullptr))));
    builder2.SetScrollTimelineName(MakeGarbageCollected<ScopedCSSNameList>(HeapVector<Member<const ScopedCSSName>>(1u,
        MakeGarbageCollected<ScopedCSSName>(AtomicString("test"),
            /* tree_scope */ nullptr))));
    ...
    EXPECT_EQ(ComputedStyle::Difference::kEqual, ComputedStyle::ComputeDifference(style1, style2));
}
...
TEST_F(ComputedStyleTest, ViewTimelineNameNoDiff)
{
    ...
    builder1.SetViewTimelineName(MakeGarbageCollected<ScopedCSSNameList>(HeapVector<Member<const ScopedCSSName>>(1u,
        MakeGarbageCollected<ScopedCSSName>(AtomicString("test"),
            /* tree_scope */ nullptr))));
    builder2.SetViewTimelineName(MakeGarbageCollected<ScopedCSSNameList>(HeapVector<Member<const ScopedCSSName>>(1u,
        MakeGarbageCollected<ScopedCSSName>(AtomicString("test"),
            /* tree_scope */ nullptr))));
...
TEST_F(ComputedStyleTest, ViewTimelineInsetNoDiff)
{
    ...
    builder1.SetViewTimelineInset(Vector<TimelineInset>(1u, TimelineInset(Length::Fixed(1.0f), Length::Fixed(1.0f))));
    builder2.SetViewTimelineInset(Vector<TimelineInset>(1u, TimelineInset(Length::Fixed(1.0f), Length::Fixed(1.0f))));
...
TEST_F(ComputedStyleTest, ContainerNameNoDiff)
{
    ...
    builder1.SetContainerName(MakeGarbageCollected<ScopedCSSNameList>(HeapVector<Member<const ScopedCSSName>>(1u,
        MakeGarbageCollected<ScopedCSSName>(AtomicString("test"),
            /* tree_scope */ nullptr))));
    builder1.SetContainerType(kContainerTypeSize);
    builder2.SetContainerName(MakeGarbageCollected<ScopedCSSNameList>(HeapVector<Member<const ScopedCSSName>>(1u,
        MakeGarbageCollected<ScopedCSSName>(AtomicString("test"),
            /* tree_scope */ nullptr))));
...
TEST_F(ComputedStyleTest, BackgroundRepeat)
{
    ...
    auto* repeat_style_value = MakeGarbageCollected<CSSRepeatStyleValue>(CSSIdentifierValue::Create(CSSValueID::kRepeatX));

    GetCSSPropertyBackgroundRepeat().ApplyValue(state, *repeat_style_value, CSSProperty::ValueMode::kNormal);
    const ComputedStyle* style = state.TakeStyle();
    auto* computed_value = GetCSSPropertyBackgroundRepeat().CSSValueFromComputedStyleInternal(
        *style, nullptr /* layout_object */, false /* allow_visited_style */, CSSValuePhase::kComputedValue);
    ASSERT_TRUE(computed_value);
...
TEST_F(ComputedStyleTest, MaskRepeat)
{
    ...
    auto* repeat_style_value = MakeGarbageCollected<CSSRepeatStyleValue>(CSSIdentifierValue::Create(CSSValueID::kRepeatY));

    GetCSSPropertyMaskRepeat().ApplyValue(state, *repeat_style_value, CSSProperty::ValueMode::kNormal);
    const ComputedStyle* style = state.TakeStyle();
    auto* computed_value = GetCSSPropertyMaskRepeat().CSSValueFromComputedStyleInternal(
        *style, nullptr /* layout_object */, false /* allow_visited_style */, CSSValuePhase::kComputedValue);
    ASSERT_TRUE(computed_value);
...
TEST_F(ComputedStyleTest, MaskMode)
{
    ...
    GetCSSPropertyMaskMode().ApplyValue(state, *mode_style_value, CSSProperty::ValueMode::kNormal);
    const ComputedStyle* style = state.TakeStyle();
    auto* computed_value = GetCSSPropertyMaskMode().CSSValueFromComputedStyleInternal(
        *style, nullptr /* layout_object */, false /* allow_visited_style */, CSSValuePhase::kComputedValue);
    ASSERT_TRUE(computed_value);
...
TEST_F(ComputedStyleTest, DynamicRangeLimitMixStandardToConstrainedHigh)
{
    ...
    auto* dynamic_range_limit_mix_value = GetCSSPropertyDynamicRangeLimit().CSSValueFromComputedStyleInternal(
        *builder.TakeStyle(), nullptr /* layout_object */, false /* allow_visited_style */, CSSValuePhase::kComputedValue);
    ASSERT_NE(dynamic_range_limit_mix_value, nullptr);

    EXPECT_EQ(dynamic_range_limit_mix_value->CssText(), "dynamic-range-limit-mix(standard 30%, constrained-high 70%)");
    ...
    GetCSSPropertyDynamicRangeLimit().ApplyValue(state, *dynamic_range_limit_mix_value, CSSProperty::ValueMode::kNormal);

    const DynamicRangeLimit converted_limit = state.TakeStyle()->GetDynamicRangeLimit();
    EXPECT_FLOAT_EQ(converted_limit.standard_mix, limit.standard_mix);
    EXPECT_FLOAT_EQ(converted_limit.constrained_high_mix, limit.constrained_high_mix);
}
...
TEST_F(ComputedStyleTest, DynamicRangeLimitMixStandardToHigh)
{
    ...
    EXPECT_EQ(dynamic_range_limit_mix_value->CssText(), "dynamic-range-limit-mix(standard 40%, high 60%)");
...
TEST_F(ComputedStyleTest, DynamicRangeLimitMixConstrainedHighToHigh)
{
    ...
    EXPECT_EQ(dynamic_range_limit_mix_value->CssText(), "dynamic-range-limit-mix(constrained-high 55%, high 45%)");
...
TEST_F(ComputedStyleTest, DynamicRangeLimitMixAllThree)
{
    ...
    EXPECT_EQ(dynamic_range_limit_mix_value->CssText(), "dynamic-range-limit-mix(standard 20%, constrained-high 60%, high 20%)");
...
TEST_F(ComputedStyleTest, UseCountInsideListMarkerPositionQuirk)
{
    ...
    document.View()->UpdateAllLifecyclePhasesForTest();
    EXPECT_FALSE(document.IsUseCounted(WebFeature::kInsideListMarkerPositionQuirk));

    document.body()->setInnerHTML("<li></li>");
    document.View()->UpdateAllLifecyclePhasesForTest();
    EXPECT_TRUE(document.IsUseCounted(WebFeature::kInsideListMarkerPositionQuirk));
}
...
TEST_F(ComputedStyleTest, ColorSchemeFlagsIsNormal)
{
    ...
    document.View()->UpdateAllLifecyclePhasesForTest();
    EXPECT_TRUE(GetDocument().getElementById(AtomicString("normal"))->ComputedStyleRef().ColorSchemeFlagsIsNormal());
    EXPECT_FALSE(GetDocument().getElementById(AtomicString("light"))->ComputedStyleRef().ColorSchemeFlagsIsNormal());
    EXPECT_FALSE(GetDocument().getElementById(AtomicString("dark"))->ComputedStyleRef().ColorSchemeFlagsIsNormal());
}
...
TEST_F(ComputedStyleTest, ColorSchemeFlagsIsNormal_WithMeta)
{
    ...
    document.View()->UpdateAllLifecyclePhasesForTest();
    EXPECT_FALSE(GetDocument().getElementById(AtomicString("normal"))->ComputedStyleRef().ColorSchemeFlagsIsNormal());
    EXPECT_FALSE(GetDocument().getElementById(AtomicString("light"))->ComputedStyleRef().ColorSchemeFlagsIsNormal());
    EXPECT_FALSE(GetDocument().getElementById(AtomicString("dark"))->ComputedStyleRef().ColorSchemeFlagsIsNormal());
}
