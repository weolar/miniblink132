...
{
    return tactic_list_ == other.tactic_list_ && base::ValuesEquivalent(position_try_name_, other.position_try_name_) && position_area_ == other.position_area_;
}
...
bool PositionTryFallbacks::HasPositionTryName(const HashSet<AtomicString>& names) const
{
