...
enum class SVGPaintType { kColor, kNone, kContextFill, kContextStroke, kUriNone, kUriColor, kUri };
...
public:
    ...
    bool IsNone() const
    {
        return type == SVGPaintType::kNone;
    }
    bool IsColor() const
    {
        return type == SVGPaintType::kColor;
    }
    // Used by CSSPropertyEquality::PropertiesEqual.
    bool EqualTypeOrColor(const SVGPaint& other) const
    {
        return type == other.type && (type != SVGPaintType::kColor || color == other.color);
    }
    bool HasColor() const
    {
        return IsColor() || type == SVGPaintType::kUriColor;
    }
    bool HasUrl() const
    {
        return type >= SVGPaintType::kUriNone;
    }
    bool HasCurrentColor() const
    {
        return HasColor() && color.IsCurrentColor();
    }
    StyleSVGResource* Resource() const
    {
        return resource.Get();
    }

    const StyleColor& GetColor() const
    {
        return color;
    }
