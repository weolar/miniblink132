...
public:
    AppliedTextDecoration(TextDecorationLine, ETextDecorationStyle, Color, TextDecorationThickness, Length);
    ...
    TextDecorationThickness Thickness() const
    {
        return thickness_;
    }
    Length UnderlineOffset() const
    {
        return underline_offset_;
    }
