...
enum ENinePieceImageRule { kStretchImageRule, kRoundImageRule, kSpaceImageRule, kRepeatImageRule };

class CORE_EXPORT NinePieceImageData : public RefCountedCopyable<NinePieceImageData> {
public:
    ...
    bool operator!=(const NinePieceImageData& o) const
    {
        return !(*this == o);
    }
...
public:
    NinePieceImage();
    NinePieceImage(StyleImage*, LengthBox image_slices, bool fill, const BorderImageLengthBox& border_slices, const BorderImageLengthBox& outset,
        ENinePieceImageRule horizontal_rule, ENinePieceImageRule vertical_rule);
    ...
    const BorderImageLengthBox& Outset() const
    {
        return data_->outset;
    }
    ...
    static LayoutUnit ComputeOutset(const BorderImageLength& outset_side, int border_side)
    {
