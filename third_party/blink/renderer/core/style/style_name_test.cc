...
{
    EXPECT_EQ(StyleName(AtomicString("foo"), StyleName::Type::kString), StyleName(AtomicString("foo"), StyleName::Type::kString));
    EXPECT_NE(StyleName(AtomicString("foo"), StyleName::Type::kString), StyleName(AtomicString("bar"), StyleName::Type::kString));
    EXPECT_NE(StyleName(AtomicString("foo"), StyleName::Type::kString), StyleName(AtomicString("foo"), StyleName::Type::kCustomIdent));
}
