...
TEST(GapDataTest, GapDataEquivalence)
{
    ...
    ValueRepeater<StyleColor>* repeater = MakeGarbageCollected<ValueRepeater<StyleColor>>(std::move(colors), /*repeat_count=*/std::nullopt);
    ...
    ValueRepeater<StyleColor>* repeater2 = MakeGarbageCollected<ValueRepeater<StyleColor>>(std::move(colors2), /*repeat_count=*/std::nullopt);
