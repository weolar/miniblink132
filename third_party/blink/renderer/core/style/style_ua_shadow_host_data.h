...
public:
    StyleUAShadowHostData(const Length& width, const Length& height, const StyleAspectRatio& aspect_ratio, const String& alt_text,
        const AtomicString& alt_attribute, const AtomicString& src_attribute, const bool has_appearance)
        : width_(width)
        , height_(height)
    ...
    const String& AltText() const
    {
        return alt_text_;
    }
    const AtomicString& AltAttribute() const
    {
        return alt_attribute_;
    }
    const AtomicString& SrcAttribute() const
    {
        return src_attribute_;
    }

    bool operator==(const StyleUAShadowHostData& o) const
    {
        return width_ == o.width_ && height_ == o.height_ && aspect_ratio_ == o.aspect_ratio_ && alt_text_ == o.alt_text_ && alt_attribute_ == o.alt_attribute_
            && src_attribute_ == o.src_attribute_ && has_appearance_ == o.has_appearance_;
    }
