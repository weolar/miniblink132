...
public:
    ...
    void AddMathLSpaceIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
    void AddMathRSpaceIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
    void AddMathMinSizeIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
    void AddMathMaxSizeIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
    bool IsVertical();
...
private:
    ...
    void SetOperatorPropertyDirtyFlagIfNeeded(const AttributeModificationParams&, const OperatorPropertyFlag&, bool& needs_layout);
