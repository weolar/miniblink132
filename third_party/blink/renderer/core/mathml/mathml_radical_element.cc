...
MathMLRadicalElement::MathMLRadicalElement(const QualifiedName& tagName, Document& document)
...
LayoutObject* MathMLRadicalElement::CreateLayoutObject(const ComputedStyle& style)
{
