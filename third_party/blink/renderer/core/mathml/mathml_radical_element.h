...
template <> struct DowncastTraits<MathMLRadicalElement> {
    ...
    {
        return mathml_element.HasTagName(mathml_names::kMsqrtTag) || mathml_element.HasTagName(mathml_names::kMrootTag);
    }
};
