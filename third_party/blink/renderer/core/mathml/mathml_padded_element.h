...
public:
    ...
    void AddMathBaselineIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
    void AddMathPaddedDepthIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
    void AddMathPaddedLSpaceIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
    void AddMathPaddedVOffsetIfNeeded(ComputedStyleBuilder&, const CSSToLengthConversionData&);
...
private:
    ...
    bool IsGroupingElement() const final
    {
        return false;
    }
};
