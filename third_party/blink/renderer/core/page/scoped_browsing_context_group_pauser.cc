...
uint64_t& PausedCountPerBrowsingContextGroup(const base::UnguessableToken& token)
{
...
{
    return PausedCountPerBrowsingContextGroup(page.BrowsingContextGroupToken()) > 0;
}
