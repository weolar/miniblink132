...
TEST(PageTest, CreateOrdinaryBrowsingContextGroup)
{
    ...
    Page* page = Page::CreateOrdinary(*client, /*opener=*/nullptr, *scheduler, bcg_info,
        /*color_provider_colors=*/nullptr,
        /*partitioned_popin_params=*/nullptr);

    EXPECT_EQ(page->BrowsingContextGroupToken(), bcg_info.browsing_context_group_token);
...
TEST(PageTest, BrowsingContextGroupUpdate)
{
    ...
    Page* page = Page::CreateOrdinary(*client, /*opener=*/nullptr, *scheduler, initial_bcg_info,
        /*color_provider_colors=*/nullptr,
        /*partitioned_popin_params=*/nullptr);

    EXPECT_EQ(page->BrowsingContextGroupToken(), initial_bcg_info.browsing_context_group_token);
    EXPECT_EQ(page->CoopRelatedGroupToken(), initial_bcg_info.coop_related_group_token);

    auto updated_bcg_info = BrowsingContextGroupInfo::CreateUnique();
    page->UpdateBrowsingContextGroup(updated_bcg_info);

    EXPECT_EQ(page->BrowsingContextGroupToken(), updated_bcg_info.browsing_context_group_token);
    EXPECT_EQ(page->CoopRelatedGroupToken(), updated_bcg_info.coop_related_group_token);
}
...
TEST(PageTest, BrowsingContextGroupUpdateWithPauser)
{
    ...
    scoped_feature_list.InitAndEnableFeature(features::kPausePagesPerBrowsingContextGroup);
    ...
    Page* page1 = Page::CreateOrdinary(*client, /*opener=*/nullptr, *scheduler, group_a,
        /*color_provider_colors=*/nullptr,
        /*partitioned_popin_params=*/nullptr);

    auto pauser_for_group_a = std::make_unique<ScopedBrowsingContextGroupPauser>(*page1);
    ...
    Page* page2 = Page::CreateOrdinary(*client, /*opener=*/nullptr, *scheduler, group_b,
        /*color_provider_colors=*/nullptr,
        /*partitioned_popin_params=*/nullptr);
...
TEST(PageTest, CreateOrdinaryColorProviders)
{
    ...
    Page* page = Page::CreateOrdinary(*client, /*opener=*/nullptr, *scheduler, bcg_info, &color_provider_colors,
        /*partitioned_popin_params=*/nullptr);

    const ui::ColorProvider* light_color_provider = page->GetColorProviderForPainting(
        /*color_scheme=*/mojom::blink::ColorScheme::kLight,
        /*in_forced_colors=*/false);
    const ui::ColorProvider* dark_color_provider = page->GetColorProviderForPainting(
        /*color_scheme=*/mojom::blink::ColorScheme::kDark,
        /*in_forced_colors=*/false);
    const ui::ColorProvider* forced_colors_color_provider = page->GetColorProviderForPainting(
        /*color_scheme=*/mojom::blink::ColorScheme::kLight,
