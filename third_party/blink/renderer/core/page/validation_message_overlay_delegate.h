...
class CORE_EXPORT ValidationMessageOverlayDelegate : public FrameOverlay::Delegate {
public:
    ...
    void PaintFrameOverlay(const FrameOverlay&, GraphicsContext&, const gfx::Size& view_size) const override;
