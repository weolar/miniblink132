...
public:
    ...
    static int PageNumberForElement(Element*, const gfx::SizeF& page_size_in_pixels);
...
protected:
    ...
    void OutputLinkedDestinations(GraphicsContext&, const PropertyTreeStateOrAlias&, const gfx::Rect& page_rect);
