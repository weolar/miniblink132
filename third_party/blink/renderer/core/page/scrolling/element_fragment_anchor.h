...
public:
    ...
    static ElementFragmentAnchor* TryCreate(const KURL& url, LocalFrame& frame, bool should_scroll);
...
private:
    FRIEND_TEST_ALL_PREFIXES(ElementFragmentAnchorTest, AnchorRemovedBeforeBeginFrameCrash);
