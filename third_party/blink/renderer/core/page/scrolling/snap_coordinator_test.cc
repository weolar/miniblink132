...
class SnapCoordinatorTest : public testing::Test, public ScopedMockOverlayScrollbars {
protected:
    void SetUp() override
    {
        page_holder_ = std::make_unique<DummyPageHolder>(
            gfx::Size(), nullptr, nullptr, WTF::BindOnce([](Settings& settings) { settings.SetAcceleratedCompositingEnabled(true); }));
...
{
    Element& snap_element = *GetDocument().getElementById(AtomicString("snap-element"));
    snap_element.setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start;"));
    UpdateAllLifecyclePhasesForTest();
...
{
    Element& snap_element = *GetDocument().getElementById(AtomicString("nested-snap-element"));
    snap_element.setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start;"));
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(SnapCoordinatorTest, ModifySnapElement)
{
    ...
    snap_element.setAttribute(kStyleAttr, AtomicString("scroll-snap-align: end;"));
...
TEST_F(SnapCoordinatorTest, NestedSnapElementCaptured)
{
    ...
    Element* intermediate = GetDocument().getElementById(AtomicString("intermediate"));
...
{
    Element& snap_element = *GetDocument().getElementById(AtomicString("snap-element-fixed-position"));
    snap_element.setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start;"));
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(SnapCoordinatorTest, UpdateStyleForSnapElement)
{
    ...
    Element& container = *GetDocument().getElementById(AtomicString("snap-container"));
...
TEST_F(SnapCoordinatorTest, ViewportScrollSnapStyleComesFromDocumentElement)
{
    ...
    const cc::SnapContainerData* viewport_data = GetSnapContainerData(*GetDocument().GetLayoutView());
    EXPECT_TRUE(viewport_data);
    EXPECT_EQ(viewport_data->scroll_snap_type(), cc::ScrollSnapType(false, cc::SnapAxis::kBoth, cc::SnapStrictness::kMandatory));

    const cc::SnapContainerData* body_data = GetSnapContainerData(*body->GetLayoutBox());
...
TEST_F(SnapCoordinatorTest, LayoutViewCapturesWhenDocumentElementViewportDefining)
{
    SetHTML(R"HTML(
    <style>
    :root {
...
TEST_F(SnapCoordinatorTest, BodyCapturesWhenBodyOverflowAndDocumentElementViewportDefining)
{
    SetHTML(R"HTML(
    <style>
    :root {
...
TEST_F(SnapCoordinatorTest, SnapDataCalculation)
{
    ...
    ScrollableArea* scrollable_area = scroller_element->GetLayoutBox()->GetScrollableArea();
    Element* area_element = GetDocument().getElementById(AtomicString("area"));
    area_element->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start;"));
    UpdateAllLifecyclePhasesForTest();

    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    cc::SnapContainerData actual_container = *data;
    gfx::PointF max_position = scrollable_area->ScrollOffsetToPosition(scrollable_area->MaximumScrollOffset());
    ...
    cc::SnapContainerData expected_container(
        cc::ScrollSnapType(false, cc::SnapAxis::kBoth, cc::SnapStrictness::kMandatory), gfx::RectF(10, 10, width - 20, height - 20), max_position);
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(192, 192, 116, 116), false, false, cc::ElementId(10));
...
TEST_F(SnapCoordinatorTest, ScrolledSnapDataCalculationOnViewport)
{
    ...
    area_element->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start;"));
    UpdateAllLifecyclePhasesForTest();
    const cc::SnapContainerData* data = GetSnapContainerData(*GetDocument().GetLayoutView());
    EXPECT_TRUE(data);
    cc::SnapContainerData actual_container = *data;
    ...
    cc::SnapContainerData expected_container(
        cc::ScrollSnapType(false, cc::SnapAxis::kBoth, cc::SnapStrictness::kMandatory), gfx::RectF(0, 0, width, height), max_position);

    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(200, 200, 100, 100), false, false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, SnapDataCalculationWithBoxModel)
{
    ...
    area_element->setAttribute(kStyleAttr,
        AtomicString("scroll-snap-align: start; margin: 2px; border: "
                     "9px solid; padding: 5px;"));
    Element* scroller_element = GetDocument().getElementById(AtomicString("scroller"));
    scroller_element->setAttribute(kStyleAttr, AtomicString("margin: 3px; border: 10px solid; padding: 4px;"));
    UpdateAllLifecyclePhasesForTest();
    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    cc::SnapContainerData actual_container = *data;
    ...
    cc::SnapContainerData expected_container(
        cc::ScrollSnapType(false, cc::SnapAxis::kBoth, cc::SnapStrictness::kMandatory), gfx::RectF(20, 20, width - 20, height - 20), max_position);
    ...
    //               2 * (area.padding + area.border + area.scroll-margin)
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(208, 208, 144, 144), false, false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, NegativeMarginSnapDataCalculation)
{
    SetUpSingleSnapArea();
    Element* area_element = GetDocument().getElementById(AtomicString("area"));
    area_element->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start; scroll-margin: -8px;"));
    UpdateAllLifecyclePhasesForTest();
    Element* scroller_element = GetDocument().getElementById(AtomicString("scroller"));
    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    ...
    cc::SnapContainerData expected_container(
        cc::ScrollSnapType(false, cc::SnapAxis::kBoth, cc::SnapStrictness::kMandatory), gfx::RectF(10, 10, width - 20, height - 20), max_position);
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kStart), gfx::RectF(208, 208, 84, 84), false, false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, AsymmetricalSnapDataCalculation)
{
    ...
    cc::SnapContainerData expected_container(
        cc::ScrollSnapType(false, cc::SnapAxis::kBoth, cc::SnapStrictness::kMandatory), gfx::RectF(16, 10, width - 28, height - 24), max_position);
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kCenter), gfx::RectF(192, 198, 112, 108), false, false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, ScaledSnapDataCalculation)
{
    SetUpSingleSnapArea();
    Element* area_element = GetDocument().getElementById(AtomicString("area"));
    area_element->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: end; transform: scale(4, 4);"));
    UpdateAllLifecyclePhasesForTest();
    Element* scroller_element = GetDocument().getElementById(AtomicString("scroller"));
    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    ...
    // (50, 50).
    cc::SnapAreaData expected_area(cc::ScrollSnapAlign(cc::SnapAlignment::kEnd), gfx::RectF(42, 42, 416, 416), false, false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, VerticalRlSnapDataCalculation)
{
    SetUpSingleSnapArea();
    Element* area_element = GetDocument().getElementById(AtomicString("area"));
    area_element->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start; left: -200px;"));
    Element* scroller_element = GetDocument().getElementById(AtomicString("scroller"));
    scroller_element->setAttribute(kStyleAttr, AtomicString("writing-mode: vertical-rl;"));
    UpdateAllLifecyclePhasesForTest();
    const cc::SnapContainerData* data = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data);
    cc::SnapContainerData actual_container = *data;
    ...
    cc::SnapAreaData expected_area(
        cc::ScrollSnapAlign(cc::SnapAlignment::kStart, cc::SnapAlignment::kEnd), gfx::RectF(192, 192, 116, 116), false, false, cc::ElementId(10));
    expected_container.AddSnapAreaData(expected_area);
...
TEST_F(SnapCoordinatorTest, ChangeOverflowToVisible)
{
    ...
    GetDocument().getElementById(AtomicString("area"))->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start;"));
    UpdateAllLifecyclePhasesForTest();
    ...
    scroller_element->setAttribute(kStyleAttr, AtomicString("overflow : visible"));
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(SnapCoordinatorTest, CurrentSnappedAreaRemoved)
{
    ...
    const cc::SnapContainerData* data_ptr = GetSnapContainerData(*scroller_element->GetLayoutBox());
    EXPECT_TRUE(data_ptr);
    cc::SnapContainerData data = *data_ptr;
    cc::TargetSnapAreaElementIds expected_snap_targets(data.at(0).element_id, data.at(0).element_id);
    EXPECT_TRUE(expected_snap_targets.x);
    EXPECT_EQ(expected_snap_targets, data.GetTargetSnapAreaElementIds());

    area_element->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: none;"));
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(SnapCoordinatorTest, AddingSnapAreaDoesNotRemoveCurrentSnapTarget)
{
    ...
    area2_element->setAttribute(kStyleAttr, AtomicString("scroll-snap-align: start;"));
    UpdateAllLifecyclePhasesForTest();
...
TEST_F(SnapCoordinatorTest, NegativeOverflowWithExpandedViewport)
{
    ...
    EXPECT_EQ(frame_view->LayoutViewport()->MaximumScrollOffsetInt(), gfx::Vector2d(-400, 0));
    EXPECT_EQ(GetSnapContainerData(*GetDocument().GetLayoutView())->max_position(), gfx::PointF(1000, 200));
}
