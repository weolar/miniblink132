...
class CORE_EXPORT RootScrollerController : public GarbageCollected<RootScrollerController> {
public:
...
private:
    ...
    // post tree order.
    template <typename Function> void ForAllNonThrottledLocalControllers(const Function&);
