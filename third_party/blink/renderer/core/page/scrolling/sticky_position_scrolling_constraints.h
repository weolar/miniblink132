...
// |ComputeStickyOffset|.
struct CORE_EXPORT StickyPositionScrollingConstraints final : public GarbageCollected<StickyPositionScrollingConstraints> {
public:
    ...
    Member<const LayoutBoxModelObject> nearest_sticky_layer_shifting_sticky_box = nullptr;
    Member<const LayoutBoxModelObject> nearest_sticky_layer_shifting_containing_block = nullptr;
