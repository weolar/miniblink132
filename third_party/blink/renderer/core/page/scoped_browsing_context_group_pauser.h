...
public:
    ...
    ScopedBrowsingContextGroupPauser(const ScopedBrowsingContextGroupPauser&) = delete;
    ScopedBrowsingContextGroupPauser& operator=(const ScopedBrowsingContextGroupPauser&) = delete;
