...
struct CORE_EXPORT ViewportDescription {
    ...
    ui::mojom::blink::VirtualKeyboardMode virtual_keyboard_mode = ui::mojom::blink::VirtualKeyboardMode::kUnset;
    ...
    PageScaleConstraints Resolve(const gfx::SizeF& initial_viewport_size, const Length& legacy_fallback_width) const;
    ...
    void SetViewportFit(mojom::ViewportFit value)
    {
        viewport_fit_ = value;
    }
    ...
    bool operator==(const ViewportDescription& other) const
    {
        ...
        return min_width == other.min_width && max_width == other.max_width && min_height == other.min_height && max_height == other.max_height
            && zoom == other.zoom && min_zoom == other.min_zoom && max_zoom == other.max_zoom && user_zoom == other.user_zoom
            && orientation == other.orientation && deprecated_target_density_dpi == other.deprecated_target_density_dpi
            && zoom_is_explicit == other.zoom_is_explicit && min_zoom_is_explicit == other.min_zoom_is_explicit
            && max_zoom_is_explicit == other.max_zoom_is_explicit && user_zoom_is_explicit == other.user_zoom_is_explicit
            && virtual_keyboard_mode == other.virtual_keyboard_mode && viewport_fit_ == other.viewport_fit_;
    }
    ...
    bool IsMetaViewportType() const
    {
        return type == kViewportMeta;
    }
    bool IsSpecifiedByAuthor() const
    {
        return type != kUserAgentStyleSheet;
    }
...
private:
    ...
    static float ResolveViewportLength(const Length&, const gfx::SizeF& initial_viewport_size, Direction);
