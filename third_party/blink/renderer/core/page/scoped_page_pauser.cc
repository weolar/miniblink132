...
ScopedPagePauser::ScopedPagePauser(Page* primary_page)
{
    ...
    pause_handle_ = ThreadScheduler::Current()->ToMainThreadScheduler() ? ThreadScheduler::Current()->ToMainThreadScheduler()->PauseScheduler() : nullptr;
}

ScopedPagePauser::ScopedPagePauser()
    : ScopedPagePauser(nullptr)
{
}
