...
public:
    EventWithHitTestResults(const EventType& event, const HitTestLocation& location, const HitTestResult& hit_test_result)
        : event_(event)
    ...
    PhysicalOffset LocalPoint() const
    {
        return hit_test_result_.LocalPoint();
    }
    Scrollbar* GetScrollbar() const
    {
        return hit_test_result_.GetScrollbar();
    }
    bool IsOverLink() const
    {
        return hit_test_result_.IsOverLink();
    }
    ...
    {
        return hit_test_result_.InnerNode();
    }
    Element* InnerElement() const
    {
        return hit_test_result_.InnerElement();
    }
