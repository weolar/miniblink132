...
ColorPagePopupController::ColorPagePopupController(Page& page, PagePopup& popup, ColorChooserPopupUIController* client)
...
{
    if (popup_client_) {
        static_cast<ColorChooserPopupUIController*>(popup_client_)->OpenEyeDropper();
    }
}
