...
class CORE_EXPORT Page final : public GarbageCollected<Page>, public Supplementable<Page>, public SettingsDelegate, public PageScheduler::Delegate {
    friend class Settings;

public:
    // Any pages not owned by a web view should be created using this method.
    static Page* CreateNonOrdinary(
        ChromeClient& chrome_client, AgentGroupScheduler& agent_group_scheduler, const ColorProviderColorMaps* color_provider_colors);

    // An "ordinary" page is a fully-featured page owned by a web view.
    static Page* CreateOrdinary(ChromeClient& chrome_client, Page* opener, AgentGroupScheduler& agent_group_scheduler,
    ...
    Page(base::PassKey<Page>, ChromeClient& chrome_client, AgentGroupScheduler& agent_group_scheduler,
        const BrowsingContextGroupInfo& browsing_context_group_info, const ColorProviderColorMaps* color_provider_colors,
    ...
    bool UpdateColorProviders(const ColorProviderColorMaps& color_provider_colors);
    void UpdateColorProvidersForTest();
    const ui::ColorProvider* GetColorProviderForPainting(mojom::blink::ColorScheme color_scheme, bool in_forced_colors) const;
    ...
    void SetColorProviderColorMaps(const ColorProviderColorMaps& color_provider_colors)
    {
    ...
    void SetPreviousMainFrameForLocalSwap(LocalFrame* previous_main_frame_for_local_swap)
    {
    ...
    void UpdateLifecycle(LocalFrame& root, WebLifecycleUpdate requested_update, DocumentUpdateReason reason);
    ...
    DragCaret& GetDragCaret() const
    {
        return *drag_caret_;
    }
    DragController& GetDragController() const
    {
    ...
    bool ShowPausedHudOverlay() const
    {
        return show_paused_hud_overlay_;
    }
    ...
    void SetVisibilityState(mojom::blink::PageVisibilityState visibility_state, bool is_initial_state);
    mojom::blink::PageVisibilityState GetVisibilityState() const;
    bool IsPageVisible() const;

    bool IsCursorVisible() const;
    void SetIsCursorVisible(bool is_visible)
    {
    ...
    // is true.
    void UpdateSafeAreaInsetWithBrowserControls(const BrowserControls& browser_controls, bool force_update = false);
    ...
    void SetUserAgentPageScaleConstraints(const PageScaleConstraints& new_constraints);

#if DCHECK_IS_ON()
    void SetIsPainting(bool painting)
    {
        is_painting_ = painting;
    }
    ...
    void SetShouldWarmUpCompositorOnPrerender(bool should_warm_up_compositor_on_prerender)
    {
        should_warm_up_compositor_on_prerender_ = should_warm_up_compositor_on_prerender;
    }
    ...
    void SetTextAutosizerPageInfo(const mojom::blink::TextAutosizerPageInfo& page_info)
    {
    ...
    void SetMediaFeatureOverride(const AtomicString& media_feature, const String& value);
    ...
    void SetPreferenceOverride(const AtomicString& media_feature, const String& value);
    ...
    VisionDeficiency GetVisionDeficiency() const
    {
        return vision_deficiency_;
    }
    ...
    HeapLinkedHashSet<WeakMember<PageVisibilityObserver>>& PageVisibilityObserverSet()
    {
        return page_visibility_observer_set_;
    }

    void SetPageLifecycleState(mojom::blink::PageLifecycleStatePtr lifecycle_state)
    {
    ...
    void SetDeprecatedFencedFrameMode(blink::FencedFrame::DeprecatedFencedFrameMode mode)
    {
    ...
    v8_compile_hints::V8CrowdsourcedCompileHintsProducer& GetV8CrowdsourcedCompileHintsProducer()
    {
        return *v8_compile_hints_producer_;
    }

    v8_compile_hints::V8CrowdsourcedCompileHintsConsumer& GetV8CrowdsourcedCompileHintsConsumer()
    {
    ...
    void SetAttributionSupport(network::mojom::AttributionSupport attribution_support);
    ...
    // https://explainers-by-googlers.github.io/partitioned-popins/
    const PartitionedPopinOpenerProperties& GetPartitionedPopinOpenerProperties() const;
...
private:
    ...
    HeapLinkedHashSet<WeakMember<PageVisibilityObserver>> page_visibility_observer_set_;
    ...
    const Member<TopDocumentRootScrollerController> global_root_scroller_controller_;
    ...
    blink::FencedFrame::DeprecatedFencedFrameMode fenced_frame_mode_ = blink::FencedFrame::DeprecatedFencedFrameMode::kDefault;
    ...
    Member<v8_compile_hints::V8CrowdsourcedCompileHintsProducer> v8_compile_hints_producer_;

    Member<v8_compile_hints::V8CrowdsourcedCompileHintsConsumer> v8_compile_hints_consumer_;
    ...
    network::mojom::AttributionSupport attribution_support_ = network::mojom::AttributionSupport::kUnset;
    ...
    // See https://explainers-by-googlers.github.io/partitioned-popins/
    std::optional<PartitionedPopinOpenerProperties> partitioned_popin_opener_properties_;
};
