...
void HTMLFrameSetElement::CollectStyleForPresentationAttribute(const QualifiedName& name, const AtomicString& value, MutableCSSPropertyValueSet* style)
{
    if (name == html_names::kBordercolorAttr)
...
void HTMLFrameSetElement::ParseAttribute(const AttributeModificationParams& params)
{
    ...
    if (name == html_names::kRowsAttr) {
        if (!value.IsNull()) {
            ...
            SetNeedsStyleRecalc(kSubtreeStyleChange, StyleChangeReasonForTracing::FromAttribute(name));
        ...
        if (!value.IsNull()) {
            if (EqualIgnoringASCIICase(value, "no") || EqualIgnoringASCIICase(value, "0")) {
                frameborder_ = false;
            } else if (EqualIgnoringASCIICase(value, "yes") || EqualIgnoringASCIICase(value, "1")) {
                frameborder_ = true;
            }
        } else {
            frameborder_.reset();
        ...
        for (auto& frame_set : Traversal<HTMLFrameSetElement>::DescendantsOf(*this)) {
        ...
        if (auto* box = GetLayoutBox()) {
            box->SetNeedsLayoutAndFullPaintInvalidation(layout_invalidation_reason::kAttributeChanged);
        }
    } else if (name == html_names::kBordercolorAttr) {
        if (GetLayoutBox()) {
            for (const auto& frame_set : Traversal<HTMLFrameSetElement>::DescendantsOf(*this)) {
        ...
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kAfterprint, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnbeforeprintAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kBeforeprint, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnloadAttr) {
        GetDocument().SetWindowAttributeEventListener(event_type_names::kLoad, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnbeforeunloadAttr) {
        GetDocument().SetWindowAttributeEventListener(event_type_names::kBeforeunload,
            JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value, JSEventHandler::HandlerType::kOnBeforeUnloadEventHandler));
    } else if (name == html_names::kOnunloadAttr) {
        GetDocument().SetWindowAttributeEventListener(event_type_names::kUnload, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnpagehideAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kPagehide, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnpageshowAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kPageshow, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnblurAttr) {
        GetDocument().SetWindowAttributeEventListener(event_type_names::kBlur, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
        ...
        GetDocument().SetWindowAttributeEventListener(event_type_names::kFocus, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnfocusinAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kFocusin, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnfocusoutAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kFocusout, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (RuntimeEnabledFeatures::OrientationEventEnabled() && name == html_names::kOnorientationchangeAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kOrientationchange, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnhashchangeAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kHashchange, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnmessageAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kMessage, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnresizeAttr) {
        GetDocument().SetWindowAttributeEventListener(event_type_names::kResize, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnscrollAttr) {
        GetDocument().SetWindowAttributeEventListener(event_type_names::kScroll, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnstorageAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kStorage, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnonlineAttr) {
        GetDocument().SetWindowAttributeEventListener(event_type_names::kOnline, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnofflineAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kOffline, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnpopstateAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kPopstate, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (name == html_names::kOnlanguagechangeAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kLanguagechange, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else if (RuntimeEnabledFeatures::TimeZoneChangeEventEnabled() && name == html_names::kOntimezonechangeAttr) {
        GetDocument().SetWindowAttributeEventListener(
            event_type_names::kTimezonechange, JSEventHandlerForContentAttribute::Create(GetExecutionContext(), name, value));
    } else {
...
int HTMLFrameSetElement::Border(const ComputedStyle& style) const
{
    ...
    if (border_.has_value()) {
        return *border_ == 0 ? 0 : std::max(ClampTo<int>(*border_ * style.EffectiveZoom()), 1);
    }
    if (const auto* frame_set = DynamicTo<HTMLFrameSetElement>(parentNode()))
...
FrameEdgeInfo HTMLFrameSetElement::EdgeInfo() const
{
    ...
    result.SetPreventResize(kRightFrameEdge, resize_cols_.prevent_resize_[cols_count]);
    ...
    result.SetPreventResize(kBottomFrameEdge, resize_rows_.prevent_resize_[rows_count]);
    result.SetAllowBorder(kBottomFrameEdge, allow_border_rows_[rows_count]);
    return result;
}

void HTMLFrameSetElement::FillFromEdgeInfo(const FrameEdgeInfo& edge_info, wtf_size_t r, wtf_size_t c)
{
...
bool HTMLFrameSetElement::LayoutObjectIsNeeded(const DisplayStyle& style) const
{
...
void HTMLFrameSetElement::DefaultEventHandler(Event& evt)
{
    ...
    if (mouse_event && !NoResize() && GetLayoutObject() && GetLayoutObject()->IsFrameSet()) {
...
Node::InsertionNotificationRequest HTMLFrameSetElement::InsertedInto(ContainerNode& insertion_point)
{
...
void HTMLFrameSetElement::WillRecalcStyle(const StyleRecalcChange)
{
    if (NeedsStyleRecalc() && GetLayoutObject()) {
        if (GetForceReattachLayoutTree()) {
            ...
            GetLayoutObject()->SetNeedsLayoutAndFullPaintInvalidation(layout_invalidation_reason::kStyleChange);
        }
...
bool HTMLFrameSetElement::UserResize(const MouseEvent& event)
{
    ...
    if (!is_resizing_) {
        ...
        if (event.type() == event_type_names::kMousedown && event.IsLeftButton()) {
            gfx::PointF local_pos = box.AbsoluteToLocalPoint(event.AbsoluteLocation());
        ...
        if (event.type() == event_type_names::kMousemove || (event.type() == event_type_names::kMouseup && event.IsLeftButton())) {
            gfx::PointF local_pos = box.AbsoluteToLocalPoint(event.AbsoluteLocation());
...
void HTMLFrameSetElement::StartResizing(const Vector<LayoutUnit>& sizes, int position, ResizeAxis& resize_axis)
{
...
void HTMLFrameSetElement::ContinueResizing(const Vector<LayoutUnit>& sizes, int position, ResizeAxis& resize_axis)
{
    ...
    int delta = (position - current_split_position) - resize_axis.split_resize_offset_;
    if (!delta)
        return;
    const LayoutUnit original_size_prev = sizes[split_index - 1] - resize_axis.deltas_[split_index - 1];
    const LayoutUnit original_size_next = sizes[split_index] - resize_axis.deltas_[split_index];
    if ((original_size_prev != 0 && sizes[split_index - 1] + delta <= 0) || (original_size_next != 0 && sizes[split_index] - delta <= 0)) {
        resize_axis.deltas_.Fill(0);
    } else {
        resize_axis.deltas_[split_index - 1] += delta;
        resize_axis.deltas_[split_index] -= delta;
    }
    GetLayoutObject()->SetNeedsLayoutAndFullPaintInvalidation(layout_invalidation_reason::kSizeChanged);
}

int HTMLFrameSetElement::SplitPosition(const Vector<LayoutUnit>& sizes, int split) const
{
    if (GetLayoutObject()->NeedsLayout())
        return 0;
...
{
    const_cast<HTMLFrameSetElement*>(this)->CollectEdgeInfoIfDirty();
    return resize_rows_.CanResizeSplitAt(HitTestSplit(RowSizes(*GetLayoutBox()), p.y()));
}

bool HTMLFrameSetElement::CanResizeColumn(const gfx::Point& p) const
{
    const_cast<HTMLFrameSetElement*>(this)->CollectEdgeInfoIfDirty();
    return resize_cols_.CanResizeSplitAt(HitTestSplit(ColumnSizes(*GetLayoutBox()), p.x()));
}

int HTMLFrameSetElement::HitTestSplit(const Vector<LayoutUnit>& sizes, int position) const
{
    if (GetLayoutObject()->NeedsLayout())
    ...
    for (wtf_size_t i = 1; i < size; ++i) {
        if (position >= split_position && position < split_position + border_thickness)
