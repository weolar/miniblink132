...
public:
    ...
    {
        return disabled_state_ == kDisabled;
    }
    ...
    bool IsUnset() const
    {
        return disabled_state_ == kUnset;
    }

    bool IsExplicitlyEnabled() const
    {
        return explicitly_enabled_;
    }
...
private:
    ...
    LoadReturnValue LoadStylesheetIfNeeded(const LinkLoadParameters&, const WTF::TextEncoding&);
