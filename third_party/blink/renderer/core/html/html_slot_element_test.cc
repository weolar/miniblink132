...
protected:
    HTMLSlotElementTest()
        : lcs_table_(kTableSize)
        , backtrack_table_(kTableSize)
    {
    }
    ...
    Vector<HTMLSlotElement::LCSArray<Backtrack, kTableSize>, kTableSize> backtrack_table_;
    test::TaskEnvironment task_environment_;
};

Vector<char> HTMLSlotElementTest::LongestCommonSubsequence(const Seq& seq1, const Seq& seq2)
{
    HTMLSlotElement::FillLongestCommonSubsequenceDynamicProgrammingTable(seq1, seq2, lcs_table_, backtrack_table_);
    Seq lcs;
...
TEST_F(HTMLSlotElementTest, LongestCommonSubsequence)
{
    ...
    }
    {
        Seq seq1 { 'a', 'b' };
        Seq seq2 { 'b', 'a' };
        EXPECT_TRUE(LongestCommonSubsequence(seq1, seq2) == Seq { 'a' } || LongestCommonSubsequence(seq1, seq2) == Seq { 'b' });
    }
    {
        Seq seq1 { 'a', 'b', 'c', 'd' };
        Seq seq2 {};
    ...
    }
    {
        ...
        Seq lcs1 { 'a', 'c' };
        Seq lcs2 { 'b', 'c' };
        EXPECT_TRUE(LongestCommonSubsequence(seq1, seq2) == lcs1 || LongestCommonSubsequence(seq1, seq2) == lcs2);
    }
    {
        Seq seq1 { 'a', 'b', 'c', 'd' };
        Seq seq2 { '1', 'b', '2', 'd', '1' };
...
TEST_F(HTMLSlotElementInDocumentTest, RecalcAssignedNodeStyleForReattach)
{
    ...
    shadow_span->setAttribute(html_names::kStyleAttr, AtomicString("display:block"));
