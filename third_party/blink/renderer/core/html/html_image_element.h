...
class CORE_EXPORT HTMLImageElement : public HTMLElement,
...
public:
    ...
    static HTMLImageElement* CreateForJSConstructor(Document&, unsigned width, unsigned height);
    ...
    gfx::SizeF DefaultDestinationSize(const gfx::SizeF&, const RespectImageOrientationEnum) const override;

    // public so that HTMLPictureElement can call this as well.
    void SelectSourceURL(ImageLoader::UpdateFromElementBehavior);

    void SetIsFallbackImage()
    {
        is_fallback_image_ = true;
    }
    ...
    FormAssociated* ToFormAssociatedOrNull() override
    {
        return this;
    }
    void AssociateWith(HTMLFormElement*) override;

    bool ElementCreatedByParser() const
    {
        return element_created_by_parser_;
    }
    ...
    void SetIsLCPElement()
    {
        is_lcp_element_ = true;
    }
    bool IsLCPElement() const
    {
        return is_lcp_element_;
    }
    void SetPredictedLcpElement()
    {
        is_predicted_lcp_element_ = true;
    }
    bool IsPredictedLcpElement() const
    {
        return is_predicted_lcp_element_;
    }
    ...
    static bool SupportedImageType(const String& type, const HashSet<String>* disabled_image_types);
    ...
    const HashSet<String>& creator_scripts() const
    {
        return creator_scripts_;
    }
...
private:
    ...
    void CollectExtraStyleForPresentationAttribute(MutableCSSPropertyValueSet*) override;
    ...
    HTMLImageLoader& GetImageLoader() const override
    {
