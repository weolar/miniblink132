...
TEST_F(ProgressShadowElementTest, LayoutObjectIsNeeded)
{
    ...
    auto* progress = To<HTMLProgressElement>(GetDocument().getElementById(AtomicString("prog")));
    ...
    const ComputedStyle* style = shadow_element->StyleForLayoutObject(StyleRecalcContext());
