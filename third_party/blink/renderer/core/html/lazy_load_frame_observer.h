...
class LazyLoadFrameObserver final : public GarbageCollected<LazyLoadFrameObserver> {
public:
...
private:
    ...
    void LoadIfHiddenOrNearViewport(const HeapVector<Member<IntersectionObserverEntry>>&);
