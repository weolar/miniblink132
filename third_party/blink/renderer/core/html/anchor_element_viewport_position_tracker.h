...
class CORE_EXPORT AnchorElementViewportPositionTracker : public GarbageCollected<AnchorElementViewportPositionTracker>,
...
public:
    ...
    public:
        ...
        struct AnchorPositionUpdate : public GarbageCollected<AnchorPositionUpdate> {
        ...
        virtual void AnchorPositionsUpdated(HeapVector<Member<AnchorPositionUpdate>>& position_updates)
        {
        }
    };
    ...
    AnchorElementViewportPositionTracker(const AnchorElementViewportPositionTracker&) = delete;
    AnchorElementViewportPositionTracker& operator=(const AnchorElementViewportPositionTracker&) = delete;
    ...
    // returns nullptr.
    HTMLAnchorElementBase* MaybeObserveAnchor(HTMLAnchorElementBase& anchor, const mojom::blink::AnchorElementMetrics& metrics);
...
private:
    void UpdateVisibleAnchors(const HeapVector<Member<IntersectionObserverEntry>>& entries);
    void PositionUpdateTimerFired(TimerBase*);
    void DidFinishLifecycleUpdate(const LocalFrameView& local_frame_view) override;
    ...
    std::set<AnchorObservation> observed_anchors_ ALLOW_DISCOURAGED_TYPE("WTF::HashSet lacks key sorting.");
    std::set<AnchorObservation> not_observed_anchors_ ALLOW_DISCOURAGED_TYPE("WTF::HashSet lacks key sorting.");
    ...
    HeapTaskRunnerTimer<AnchorElementViewportPositionTracker> position_update_timer_;
