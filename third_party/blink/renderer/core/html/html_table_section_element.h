...
{
    return element.HasTagName(html_names::kTbodyTag) || element.HasTagName(html_names::kTfootTag) || element.HasTagName(html_names::kTheadTag);
}

template <> struct DowncastTraits<HTMLTableSectionElement> {
