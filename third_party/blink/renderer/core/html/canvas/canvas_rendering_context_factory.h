...
public:
    ...
    CanvasRenderingContextFactory& operator=(const CanvasRenderingContextFactory&) = delete;
    virtual ~CanvasRenderingContextFactory() = default;

    virtual CanvasRenderingContext* Create(CanvasRenderingContextHost*, const CanvasContextCreationAttributesCore&) = 0;

    virtual CanvasRenderingContext::CanvasRenderingAPI GetRenderingAPI() const = 0;
