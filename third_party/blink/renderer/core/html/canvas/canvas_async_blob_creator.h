...
class CORE_EXPORT CanvasAsyncBlobCreator : public GarbageCollected<CanvasAsyncBlobCreator> {
public:
    ...
    CanvasAsyncBlobCreator(scoped_refptr<StaticBitmapImage>, const ImageEncodeOptions* options, ToBlobFunctionType function_type, base::TimeTicks start_time,
        ExecutionContext*, const IdentifiableToken& input_digest, ScriptPromiseResolver<Blob>*);
    CanvasAsyncBlobCreator(scoped_refptr<StaticBitmapImage>, const ImageEncodeOptions*, ToBlobFunctionType, V8BlobCallback*, base::TimeTicks start_time,
        ExecutionContext*, const IdentifiableToken& input_digest, ScriptPromiseResolver<Blob>* = nullptr);
...
protected:
    static ImageEncodeOptions* GetImageEncodeOptionsForMimeType(ImageEncodingMimeType);
    ...
    virtual void PostDelayedTaskToCurrentThread(const base::Location&, base::OnceClosure, double delay_ms);
...
private:
    ...
    static bool EncodeImage(std::unique_ptr<ImageDataBuffer>, ImageEncodingMimeType, const double& quality, Vector<unsigned char>* encoded_image);
    ...
    // WEBP
    static void EncodeImageOnEncoderThread(CrossThreadHandle<CanvasAsyncBlobCreator>, scoped_refptr<base::SingleThreadTaskRunner>, sk_sp<SkImage>,
        std::unique_ptr<ImageDataBuffer>, ImageEncodingMimeType, double quality);
