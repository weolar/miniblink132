...
public:
    ...
    cc::PaintOpBuffer::Iterator begin() const
    {
        return begin_;
    }
    cc::PaintOpBuffer::Iterator end() const
    {
        return end_;
    }
...
template <typename... Args> testing::Matcher<cc::PaintRecord> RecordedOpsAre(Args... args)
{
    return testing::ResultOf([](const cc::PaintRecord& record) { return RecordedOpsView(record); }, testing::ElementsAre(args...));
}
