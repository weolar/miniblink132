...
class CORE_EXPORT CanvasResourceTracker final : public V8PerIsolateData::UserData {
public:
    using ResourceMap = HeapHashMap<WeakMember<CanvasRenderingContextHost>, WeakMember<ExecutionContext>>;
