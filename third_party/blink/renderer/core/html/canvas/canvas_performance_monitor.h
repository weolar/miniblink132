...
class CORE_EXPORT CanvasPerformanceMonitor : public base::sequence_manager::TaskTimeObserver {
public:
    ...
    void DidProcessTask(base::TimeTicks start_time, base::TimeTicks end_time) final;
