...
public:
    TextCluster(const String& text, double x, double y, unsigned begin, unsigned end, TextAlign align, TextBaseline baseline, TextMetrics& text_metrics);
    static TextCluster* Create(
        const String& text, double x, double y, unsigned begin, unsigned end, TextAlign align, TextBaseline baseline, TextMetrics& text_metrics);
    ...
    {
        return TextAlignName(align_);
    }
    const String baseline() const
    {
        return TextBaselineName(baseline_);
    }
    ...
    const Member<TextMetrics> textMetrics() const
    {
