...
public:
    HTMLTagCollection(ContainerNode& root_node, const AtomicString& qualified_name);
    HTMLTagCollection(ContainerNode& root_node, CollectionType type, const AtomicString& qualified_name);
...
template <> struct DowncastTraits<HTMLTagCollection> {
...
inline bool HTMLTagCollection::ElementMatches(const Element& test_element) const
{
