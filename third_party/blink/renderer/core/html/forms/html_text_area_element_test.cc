...
TEST_F(HTMLTextAreaElementTest, SanitizeUserInputValue)
{
    ...
    EXPECT_EQ("abc", HTMLTextAreaElement::SanitizeUserInputValue(String("abc") + lead_surrogate, 4));
...
#define RTO "\xE2\x80\xAE"
    textarea.SetValue(String::FromUTF8(RTO "Hebrew" LTO " English " RTO "Arabic" LTO));
