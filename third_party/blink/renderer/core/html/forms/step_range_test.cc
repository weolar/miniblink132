...
TEST(StepRangeTest, ClampValueWithOutStepMatchedValue)
{
    ...
    StepRange step_range(Decimal(200), Decimal(0), Decimal(100), true,
        /*supports_reversed_range=*/false, Decimal(1000), StepRange::StepDescription());
...
TEST(StepRangeTest, StepSnappedMaximum)
{
    ...
    StepRange step_range(
        Decimal::FromDouble(1110), Decimal(0), Decimal(100), true, /*supports_reversed_range=*/false, Decimal(20), StepRange::StepDescription());
    ...
    StepRange step_range2(Decimal::FromDouble(8.62402e+207), Decimal(0), Decimal(100), true, /*supports_reversed_range=*/false,
        Decimal::FromDouble(1.84467e+19), StepRange::StepDescription());
    EXPECT_FALSE(step_range2.StepSnappedMaximum().IsFinite());

    StepRange step_range3(
        Decimal::FromDouble(100), Decimal(0), Decimal(400), true, /*supports_reversed_range=*/false, Decimal(-7), StepRange::StepDescription());
