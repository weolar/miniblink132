...
class CORE_EXPORT HTMLFormControlElement : public HTMLElement, public ListedElement, public FormAssociated {
public:
    ...
    {
        return FormControlTypeAsString();
    }
    ...
    virtual bool IsSubmittableElement()
    {
        return true;
    }
    ...
    // button.
    virtual bool CanBeSuccessfulSubmitButton() const
    {
        return false;
    }
    ...
    WebAutofillState GetAutofillState() const
    {
        return autofill_state_;
    }
    ...
    bool BlocksFormSubmission() const
    {
        return blocks_form_submission_;
    }
    void SetBlocksFormSubmission(bool value)
    {
        blocks_form_submission_ = value;
    }
...
private:
    bool IsFormControlElement() const final
    {
        return true;
    }
    bool AlwaysCreateUserAgentShadowRoot() const override
    {
        return true;
    }
    ...
    void HandlePopoverTriggering(HTMLElement* popover, PopoverTriggerAction action);
...
template <> struct DowncastTraits<HTMLFormControlElement> {
