...
public:
    ...
    void FindCustomValidationMessageTextDirection(const String& message, TextDirection& message_dir, String& sub_message, TextDirection& sub_message_dir);
...
protected:
    ...
    void UpdateWillValidateCache(WillValidateReason = WillValidateReason::kDefault);
    ...
    mutable AncestorDisabledState ancestor_disabled_state_ = AncestorDisabledState::kUnknown;
    ...
    bool IsSelfDisabledIgnoringAncestors() const
    {
        return is_element_disabled_;
    }
...
private:
    ...
    enum class DataListAncestorState { kUnknown, kInsideDataList, kNotInsideDataList };
    mutable enum DataListAncestorState data_list_ancestor_state_ = DataListAncestorState::kUnknown;
};
