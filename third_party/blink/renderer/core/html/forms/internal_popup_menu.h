...
class CORE_EXPORT InternalPopupMenu final : public PopupMenu, public PagePopupClient {
public:
...
private:
    ...
    void AppendOwnerElementPseudoStyles(const String&, SegmentedBuffer&, const ComputedStyle&);
    ...
    void SetMenuListOptionsBoundsInAXTree(WTF::Vector<gfx::Rect>&, gfx::Point) override;
