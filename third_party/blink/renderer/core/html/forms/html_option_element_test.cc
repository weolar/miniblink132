...
template <typename T> T* CreateElement(Document& document, const String& id)
{
...
protected:
    ...
    VectorOf<HTMLOptionElement> OptionCollectionToVector(HTMLSelectElement* select)
    {
        VectorOf<HTMLOptionElement> options;
...
TEST_F(HTMLOptionElementTest, DescendantOptionsInNestedSelects)
{
    ...
    auto* parent_select = CreateElement<HTMLSelectElement>(GetDocument(), "parent_select");
    GetDocument().body()->AppendChild(parent_select);
    auto* parents_datalist = CreateElement<HTMLDataListElement>(GetDocument(), "parents_datalist");
    parent_select->AppendChild(parents_datalist);
    auto* child_select = CreateElement<HTMLSelectElement>(GetDocument(), "child_select");
    parents_datalist->AppendChild(child_select);
    auto* child_option = CreateElement<HTMLOptionElement>(GetDocument(), "child_option");
    child_select->AppendChild(child_option);
    auto* datalist = CreateElement<HTMLDataListElement>(GetDocument(), "datalist");
    child_select->AppendChild(datalist);
    auto* datalist_child_option = CreateElement<HTMLOptionElement>(GetDocument(), "datalist_child_option");
    datalist->AppendChild(datalist_child_option);
    auto* datalist_child_option_2 = CreateElement<HTMLOptionElement>(GetDocument(), "datalist_child_option_2");
    ...
    auto* child_div_option = CreateElement<HTMLOptionElement>(GetDocument(), "child_div_option");
    ...
    VectorOf<HTMLOptionElement> expected1({ child_option, datalist_child_option, datalist_child_option_2, child_div_option });
    ...
    EXPECT_EQ(OptionListToVector(parent_select), empty);
    EXPECT_EQ(OptionCollectionToVector(parent_select), empty);
    VectorOf<HTMLOptionElement> expected3({ datalist_child_option, datalist_child_option_2, child_div_option });
    ...
    EXPECT_EQ(OptionListToVector(parent_select), empty);
    EXPECT_EQ(OptionCollectionToVector(parent_select), empty);
    VectorOf<HTMLOptionElement> expected4({ datalist_child_option, child_div_option });
    ...
    EXPECT_EQ(OptionListToVector(parent_select), empty);
    EXPECT_EQ(OptionCollectionToVector(parent_select), empty);
    VectorOf<HTMLOptionElement> expected6({ child_div_option, datalist_child_option });
