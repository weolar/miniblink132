...
private:
    ...
    void SetValueCommon(const String&, TextFieldEventBehavior, TextControlSetValueSelection, WebAutofillState autofill_state);
    ...
    void UpdateSelectionOnFocus(SelectionBehaviorOnFocus, const FocusOptions*) override;
