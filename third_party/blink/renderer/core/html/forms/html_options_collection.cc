...
HTMLOptionsCollection::HTMLOptionsCollection(ContainerNode& select, CollectionType type)
...
void HTMLOptionsCollection::setLength(unsigned length, ExceptionState& exception_state)
{
    To<HTMLSelectElement>(ownerNode()).setLength(length, exception_state);
}

IndexedPropertySetterResult HTMLOptionsCollection::AnonymousIndexedSetter(unsigned index, HTMLOptionElement* value, ExceptionState& exception_state)
{
