...
public:
    ...
    virtual void DidSelectOption(HTMLOptionElement* element, HTMLSelectElement::SelectOptionFlags flags, bool should_update_popup) = 0;
    ...
    virtual HTMLSelectElement::SelectAutofillPreviewElement* GetAutofillPreviewElement() const = 0;
    ...
    CORE_EXPORT HTMLOptionElement* PreviousSelectableOption(HTMLOptionElement*) const;
...
protected:
    ...
    HTMLOptionElement* NextValidOption(int list_index, SkipDirection direction, int skip) const;
