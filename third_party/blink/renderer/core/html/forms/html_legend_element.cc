...
LayoutObject* HTMLLegendElement::CreateLayoutObject(const ComputedStyle& style)
{
    ...
    bool should_count;
    const AtomicString& align_value = FastGetAttribute(html_names::kAlignAttr).LowerASCII();
    ...
    case ETextAlign::kCenter:
        ...
        break;
    default:
        should_count = (align_value == "left" || align_value == "right" || align_value == "center" || align_value == "middle");
        break;
    }
    if (should_count)
