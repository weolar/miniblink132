...
protected:
    ...
    HTMLOptionElement* NextSelectableOption(const HTMLSelectElement& select, HTMLOptionElement* option)
    {
        return GetSelectType(select).NextSelectableOption(option);
    }
    HTMLOptionElement* PreviousSelectableOption(const HTMLSelectElement& select, HTMLOptionElement* option)
    {
...
void HTMLSelectElementTest::SetUp()
{
    ...
    original_delegates_flag_ = LayoutTheme::GetTheme().DelegatesMenuListRendering();
}

void HTMLSelectElementTest::TearDown()
{
    LayoutTheme::GetTheme().SetDelegatesMenuListRenderingForTesting(original_delegates_flag_);
...
{
    SetHtmlInnerHTML("<!DOCTYPE HTML><select id='sel'>"
...
TEST_F(HTMLSelectElementTest, SaveRestoreSelectSingleFormControlState)
{
    ...
    EXPECT_FALSE(opt0->Selected());
    EXPECT_TRUE(opt2->Selected());
    EXPECT_EQ("!666", To<HTMLSelectElement>(element)->InnerElement().textContent());
}

TEST_F(HTMLSelectElementTest, SaveRestoreSelectMultipleFormControlState)
{
    SetHtmlInnerHTML("<!DOCTYPE HTML><select id='sel' multiple>"
                     "<option value='111' id='0'>111</option>"
                     "<option value='222'>222</option>"
                     "<option value='111' selected id='2'>!666</option>"
    ...
    HTMLFormControlElementWithState* select = To<HTMLSelectElement>(GetElementById("sel"));
    FormControlState select_state = select->SaveFormControlState();
...
{
    SetHtmlInnerHTML("<select style='position:fixed; top:12.3px; height:24px; "
...
TEST_F(HTMLSelectElementTest, FirstSelectableOption)
{
    ...
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o1", FirstSelectableOption(*select)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1 disabled></option><option "
                         "id=o2></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o2", FirstSelectableOption(*select)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1 style='display:none'></option><option "
                         "id=o2></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o2", FirstSelectableOption(*select)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><optgroup><option id=o1></option><option "
...
TEST_F(HTMLSelectElementTest, LastSelectableOption)
{
    ...
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o2", LastSelectableOption(*select)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2 "
                         "disabled></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o1", LastSelectableOption(*select)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2 "
...
TEST_F(HTMLSelectElementTest, NextSelectableOption)
{
    ...
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o1", NextSelectableOption(*select, nullptr)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1 disabled></option><option "
                         "id=o2></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o2", NextSelectableOption(*select, nullptr)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1 style='display:none'></option><option "
                         "id=o2></option></select>");
    ...
    }
    {
        ...
        EXPECT_EQ("o2", NextSelectableOption(*select, option)->FastGetAttribute(html_names::kIdAttr));

        EXPECT_EQ(nullptr, NextSelectableOption(*select, To<HTMLOptionElement>(GetElementById("o2"))));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><optgroup><option "
                         "id=o2></option></optgroup></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        auto* option = To<HTMLOptionElement>(GetElementById("o1"));
        EXPECT_EQ("o2", NextSelectableOption(*select, option)->FastGetAttribute(html_names::kIdAttr));
...
TEST_F(HTMLSelectElementTest, PreviousSelectableOption)
{
    ...
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o2", PreviousSelectableOption(*select, nullptr)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2 "
                         "disabled></option></select>");
        auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
        EXPECT_EQ("o1", PreviousSelectableOption(*select, nullptr)->FastGetAttribute(html_names::kIdAttr));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><option id=o2 "
                         "style='display:none'></option></select>");
    ...
    }
    {
        ...
        EXPECT_EQ("o1", PreviousSelectableOption(*select, option)->FastGetAttribute(html_names::kIdAttr));

        EXPECT_EQ(nullptr, PreviousSelectableOption(*select, To<HTMLOptionElement>(GetElementById("o1"))));
    }
    {
        SetHtmlInnerHTML("<select><option id=o1></option><optgroup><option "
                         "id=o2></option></optgroup></select>");
...
{
    SetHtmlInnerHTML("<select size=4>"
...
{
    SetHtmlInnerHTML("<select size=4><option value="
    ...
    EXPECT_EQ(String(), select->DefaultToolTip()) << "defaultToolTip for SELECT without FORM and without required "
    ...
    EXPECT_EQ("<<ValidationValueMissingForSelect>>", select->DefaultToolTip()) << "defaultToolTip for SELECT without FORM and with required attribute "
    ...
    EXPECT_EQ("<<ValidationValueMissingForSelect>>", select->DefaultToolTip()) << "defaultToolTip for SELECT with FORM and required attribute should "
                                                                                  "return a valueMissing message.";
    EXPECT_EQ(select->DefaultToolTip(), option->DefaultToolTip());
    EXPECT_EQ(select->DefaultToolTip(), optgroup->DefaultToolTip());

    form->SetBooleanAttribute(html_names::kNovalidateAttr, true);
    EXPECT_EQ(String(), select->DefaultToolTip()) << "defaultToolTip for SELECT with FORM[novalidate] and required "
                                                     "attribute should return null string.";
    EXPECT_EQ(select->DefaultToolTip(), option->DefaultToolTip());
    EXPECT_EQ(select->DefaultToolTip(), optgroup->DefaultToolTip());
...
{
    SetHtmlInnerHTML("<select><optgroup><option>sub1</option><option>sub2</option></"
                     "optgroup></select>");
    auto* select = To<HTMLSelectElement>(GetDocument().body()->firstChild());
    select->setInnerHTML("");
...
TEST_F(HTMLSelectElementTest, SelectMultipleOptionsByPopup)
{
    ...
    {
        SetHtmlInnerHTML("<select multiple onchange='this.remove();'>"
                         "<option>o0</option><option>o1</option></select>");
        EXPECT_TRUE(FirstSelectIsConnectedAfterSelectMultiple(Vector<int> {})) << "Onchange handler should not be executed.";
    }
    {
        SetHtmlInnerHTML("<select multiple onchange='this.remove();'>"
                         "<option>o0</option><option selected>o1</option></select>");
        EXPECT_TRUE(FirstSelectIsConnectedAfterSelectMultiple(Vector<int> { 1 })) << "Onchange handler should not be executed.";
    }
    ...
    // 0 old selected options -> 1+ selected options
    {
        SetHtmlInnerHTML("<select multiple onchange='this.remove();'>"
                         "<option>o0</option><option>o1</option></select>");
        EXPECT_FALSE(FirstSelectIsConnectedAfterSelectMultiple(Vector<int> { 0 })) << "Onchange handler should be executed.";
    }
    ...
    // 1+ old selected options -> more selected options
    {
        SetHtmlInnerHTML("<select multiple onchange='this.remove();'>"
                         "<option>o0</option><option selected>o1</option></select>");
        EXPECT_FALSE(FirstSelectIsConnectedAfterSelectMultiple(Vector<int> { 0, 1 })) << "Onchange handler should be executed.";
    }
    ...
    // 1+ old selected options -> 0 selected options
    {
        SetHtmlInnerHTML("<select multiple onchange='this.remove();'>"
                         "<option>o0</option><option selected>o1</option></select>");
        EXPECT_FALSE(FirstSelectIsConnectedAfterSelectMultiple(Vector<int> {})) << "Onchange handler should be executed.";
    }
    ...
    // Multiple old selected options -> less selected options
    {
        ...
        EXPECT_FALSE(FirstSelectIsConnectedAfterSelectMultiple(Vector<int> { 1 })) << "Onchange handler should be executed.";
    }

    // Check if the label is correctly updated.
    {
        SetHtmlInnerHTML("<select multiple>"
                         "<option selected>o0</option><option selected>o1</option></select>");
...
TEST_F(HTMLSelectElementTest, IntrinsicInlineSizeOverflow)
{
    ...
    SetHtmlInnerHTML("<select style='word-spacing:1073741824em;'>"
...
TEST_F(HTMLSelectElementTest, AddingNotOwnedOption)
{
    ...
    select->appendChild(doc.CreateRawElement(html_names::kDivTag))->appendChild(optgroup);
...
TEST_F(HTMLSelectElementTest, ChangeRenderingCrash2)
{
    ...
    GetElementById("sel")->setAttribute(html_names::kMultipleAttr, AtomicString("true"));
}
