...
class CORE_EXPORT HTMLScriptElement final : public HTMLElement, public ScriptElementBase {
...
public:
    ...
    void setInnerTextForBinding(const V8UnionStringLegacyNullToEmptyStringOrTrustedScript* string_or_trusted_script, ExceptionState& exception_state) override;
    ...
    ScriptLoader* Loader() const final
    {
        return loader_.Get();
    }

    bool IsScriptElement() const override
    {
        return true;
    }
...
private:
    ...
    bool AllowInlineScriptForCSP(const AtomicString& nonce, const WTF::OrdinalNumber&, const String& script_content) override;
