...
public:
    ...
    bool PointInArea(const PhysicalOffset&, const LayoutObject* container_object) const;
...
private:
    ...
    bool IsFocusableStyle(UpdateBehavior update_behavior = UpdateBehavior::kStyleAndLayout) const override;
