...
{
    DocumentFencedFrames* supplement = Supplement<Document>::From<DocumentFencedFrames>(document);
    if (!supplement) {
...
void DocumentFencedFrames::RegisterFencedFrame(HTMLFencedFrameElement* fenced_frame)
{
...
void DocumentFencedFrames::DeregisterFencedFrame(HTMLFencedFrameElement* fenced_frame)
{
