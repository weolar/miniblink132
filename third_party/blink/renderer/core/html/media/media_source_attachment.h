...
class CORE_EXPORT MediaSourceAttachment : public URLRegistrable, public WTF::ThreadSafeRefCounted<MediaSourceAttachment> {
public:
    ...
    static scoped_refptr<MediaSourceAttachment> LookupMediaSource(const String& url);
    ...
    virtual MediaSourceTracer* StartAttachingToMediaElement(HTMLMediaElement*, bool* success) = 0;
    virtual void CompleteAttachingToMediaElement(MediaSourceTracer* tracer, std::unique_ptr<WebMediaSource>) = 0;
