...
public:
    ...
    void OnRemotePlaybackStateChanged(mojom::blink::PresentationConnectionState) final;
    ...
    // Test helper methods.
    float visibility_threshold_for_tests() const
    {
        return visibility_threshold_;
    }
    bool active_for_tests() const
    {
        return active_;
    }
...
private:
    ...
    const HTMLVideoElement& VideoElement() const
    {
        return *video_element_;
    }
    ...
    bool playing_ = false;
    bool active_ = false;
    mojom::blink::PresentationConnectionState remote_playback_state_ = mojom::blink::PresentationConnectionState::CLOSED;
