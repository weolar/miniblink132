...
public:
    ...
    MediaStubLocalFrameClient(std::unique_ptr<WebMediaPlayer>, bool allow_empty_player);
    MediaStubLocalFrameClient(const MediaStubLocalFrameClient&) = delete;
    MediaStubLocalFrameClient& operator=(const MediaStubLocalFrameClient&) = delete;
