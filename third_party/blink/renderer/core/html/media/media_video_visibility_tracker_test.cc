...
public:
    ...
    RequestVisibilityCallback& operator=(const RequestVisibilityCallback&) = delete;
    ...
    MediaVideoVisibilityTracker::RequestVisibilityCallback VisibilityCallback()
    {
        ...
        // RunLoop::Run() returns.
        return base::BindOnce(&RequestVisibilityCallback::RequestVisibility, base::Unretained(this));
    }
...
protected:
    ...
    {
        HTMLVideoElement* video_element = To<HTMLVideoElement>(GetDocument().QuerySelector(AtomicString("video")));
    ...
    {
        DCHECK(!tracker_);
        tracker_ = MakeGarbageCollected<MediaVideoVisibilityTracker>(*VideoElement(), visibility_threshold, ReportVisibilityCb().Get());
        return tracker_;
    }

    MediaVideoVisibilityTracker* CreateAndAttachVideoVisibilityTracker(const int visibility_threshold)
    {
    ...
    const MediaVideoVisibilityTracker::ClientIdsSet GetClientIdsSet(DisplayItemClientId start_after_display_item_client_id) const
    {
        DCHECK(tracker_);
        return tracker_->GetClientIdsSet(start_after_display_item_client_id);
    }

    const MediaVideoVisibilityTracker::TrackerAttachedToDocument TrackerAttached() const
    {
        DCHECK(tracker_);
        return tracker_->tracker_attached_to_document_;
    }

    void SetRequestVisibilityCbForTesting(RequestVisibilityCallback& request_visibility_callback)
    {
        DCHECK(tracker_);
        tracker_->request_visibility_callback_ = request_visibility_callback.VisibilityCallback();
    }
...
TEST_F(MediaVideoVisibilityTrackerTest, NoOcclusionDoesNotMeetVisibilityThreshold)
{
...
TEST_F(MediaVideoVisibilityTrackerTest, NoViewPortIntersection)
{
    ...
    GetDocument().View()->LayoutViewport()->SetScrollOffset(ScrollOffset(0, 500), mojom::blink::ScrollType::kProgrammatic);
    ...
    VectorOf<SkIRect> expected_occludning_rect { SkIRect::MakeXYWH(8, -158, 150, 150) };
    EXPECT_EQ(expected_occludning_rect, OccludingRects());
}

TEST_F(MediaVideoVisibilityTrackerTest, SingleElementNotOccludingAboveThreshold)
{
...
TEST_F(MediaVideoVisibilityTrackerTest, SingleElementOccludingAboveThreshold)
{
    ...
    VectorOf<SkIRect> expected_occludning_rects { SkIRect::MakeXYWH(0, 0, 490, 490) };
    EXPECT_EQ(expected_occludning_rects, OccludingRects());
}

TEST_F(MediaVideoVisibilityTrackerTest, MultipleElementsOccludingEqualToThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(500, 500));
    LoadMainResource(R"HTML(
    <style>
    ...
    VectorOf<SkIRect> expected_occludning_rects { SkIRect::MakeXYWH(250, 0, 250, 250), SkIRect::MakeXYWH(0, 0, 250, 250) };
    EXPECT_THAT(expected_occludning_rects, UnorderedElementsAreArray(OccludingRects()));
    EXPECT_EQ(visibility_threshold, ComputeArea(IntersectionRect()) - OccludedArea());
}

TEST_F(MediaVideoVisibilityTrackerTest, MultipleElementsOccludingGreaterThanThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(500, 500));
    LoadMainResource(R"HTML(
    <style>
    ...
    VectorOf<SkIRect> expected_occludning_rects { SkIRect::MakeXYWH(250, 0, 250, 490), SkIRect::MakeXYWH(0, 0, 250, 500) };
    EXPECT_THAT(expected_occludning_rects, UnorderedElementsAreArray(OccludingRects()));
}
...
TEST_F(MediaVideoVisibilityTrackerTest, ElementWithZeroOpacityIsIgnored)
{
    ...
    EXPECT_EQ(VectorOf<SkIRect> { SkIRect::MakeXYWH(0, 0, 500, 500) }, OccludingRects());
...
TEST_F(MediaVideoVisibilityTrackerTest, MultipleIntersectingElementsOccludingGreaterThanThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(500, 500));
    LoadMainResource(R"HTML(
    <style>
    ...
    VectorOf<SkIRect> expected_occludning_rects { SkIRect::MakeXYWH(0, 0, 500, 50), SkIRect::MakeXYWH(0, 0, 500, 500) };
    EXPECT_THAT(expected_occludning_rects, UnorderedElementsAreArray(OccludingRects()));
    EXPECT_EQ(1, OccludedArea() / ComputeArea(IntersectionRect()));
}

TEST_F(MediaVideoVisibilityTrackerTest, MultipleIntersectingElementsOccludingBelowThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(500, 500));
    LoadMainResource(R"HTML(
  <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, HitTestingStopsWhenOcclusionAboveThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(500, 500));
    LoadMainResource(R"HTML(
    <style>
    ...
    VectorOf<SkIRect> expected_occludning_rects { SkIRect::MakeXYWH(0, 0, 500, 125), SkIRect::MakeXYWH(0, 125, 500, 360) };
    EXPECT_THAT(expected_occludning_rects, UnorderedElementsAreArray(OccludingRects()));
}

TEST_F(MediaVideoVisibilityTrackerTest, ViewportIntersectionFromVisibleToNotVisibleWithNoOcclusion)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(500, 500));
    LoadMainResource(R"HTML(
    <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, ViewportIntersectionFromNotVisibleToVisibleWithNoOcclusion)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(500, 500));
    LoadMainResource(R"HTML(
    <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, SingleElementPartiallyIntersectingNotOccludingAboveThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
    ...
    VectorOf<SkIRect> expected_occludning_rect { SkIRect::MakeXYWH(150, 0, 50, 100) };
    EXPECT_EQ(expected_occludning_rect, OccludingRects());
}

TEST_F(MediaVideoVisibilityTrackerTest, NonUserAgentShadowDomElementOccludingAboveThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
  <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, ElementAddedAfterPlayOccludingAboveThreshold)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
    ...
    // threshold.
    Element* div = GetDocument().QuerySelector(AtomicString("div"));
    div->setAttribute(html_names::kStyleAttr, AtomicString("width:100%; height: 100%;"));
    EXPECT_CALL(ReportVisibilityCb(), Run(false));
...
TEST_F(MediaVideoVisibilityTrackerTest, ClientIdsSetContents)
{
  ...
  <div id="invisible_div"></div>
    ...
    auto* invisible_div = GetDocument().getElementById(AtomicString("invisible_div"));
...
TEST_F(MediaVideoVisibilityTrackerTest, ClientIdsSetBeginIndexGreaterThanEndIndex)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
  <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, ComputeVisibilityOnDemandReportsFalseWhenTrackerNotAttached)
{
    auto* video = GetDocument().CreateRawElement(html_names::kVideoTag);
    GetDocument().body()->AppendChild(video);
...
TEST_F(MediaVideoVisibilityTrackerTest, ComputeVisibilityOnDemandReportsTrueWhenVideoMeetsVisibility)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, ComputeVisibilityOnDemandReportsFalseWhenVideoDoesNotMeetVisibility)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, ComputeVisibilityOnDemandHitTestTimerIgnored)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, ComputeVisibilityOnDemandNewCallbacksTakePriority)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
    ...
    tracker->RequestVisibility(new_request_visibility_callback.VisibilityCallback());
...
TEST_F(MediaVideoVisibilityTrackerTest, ComputeVisibilityOnDemandUsesCachedVisibilityValue)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
...
TEST_F(MediaVideoVisibilityTrackerTest, ComputeVisibilityOnDemandReportsFalseIfTrackerDetached)
{
    WebView().MainFrameViewWidget()->Resize(gfx::Size(800, 800));
    LoadMainResource(R"HTML(
    <style>
