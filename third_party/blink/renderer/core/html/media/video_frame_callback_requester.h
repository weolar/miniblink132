...
class CORE_EXPORT VideoFrameCallbackRequester : public GarbageCollected<VideoFrameCallbackRequester>, public Supplement<HTMLVideoElement> {
public:
    ...
    VideoFrameCallbackRequester& operator=(const VideoFrameCallbackRequester&) = delete;
