...
class CORE_EXPORT AutoplayPolicy final : public GarbageCollected<AutoplayPolicy> {
public:
...
private:
    ...
    void OnIntersectionChangedForAutoplay(const HeapVector<Member<IntersectionObserverEntry>>& entries);
