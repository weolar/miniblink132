...
TEST(HTMLDocumentParserFastpathTest, SanityCheck)
{
    ...
    EXPECT_TRUE(TryParsingHTMLFragment("<div>test</div>", *document, *fragment, *div, ParserContentPolicy::kAllowScriptingContent, {}));
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTagType.CompositeMaskV2", 0);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedContextTag.CompositeMaskV2", 0);
}
...
TEST(HTMLDocumentParserFastpathTest, SetInnerHTMLUsesFastPathSuccess)
{
    ...
    histogram_tester.ExpectUniqueSample("Blink.HTMLFastPathParser.ParseResult", HtmlFastPathResult::kSucceeded, 1);
}
...
TEST(HTMLDocumentParserFastpathTest, SetInnerHTMLUsesFastPathFailure)
{
    ...
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.ParseResult", 1);
    histogram_tester.ExpectBucketCount("Blink.HTMLFastPathParser.ParseResult", HtmlFastPathResult::kSucceeded, 0);
}
...
TEST(HTMLDocumentParserFastpathTest, MaximumHTMLParserDOMTreeDepth)
{
    ...
    const unsigned depth = HTMLConstructionSite::kMaximumHTMLParserDOMTreeDepth + 2;
...
TEST(HTMLDocumentParserFastpathTest, LogUnsupportedTags)
{
    ...
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTag.CompositeMaskV2", 1);
    histogram_tester.ExpectBucketCount("Blink.HTMLFastPathParser.UnsupportedTag.CompositeMaskV2", 2, 1);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTag.Mask0V2", 0);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTag.Mask1V2", 1);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTag.Mask2V2", 0);
}
...
TEST(HTMLDocumentParserFastpathTest, LogUnsupportedContextTag)
{
    ...
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedContextTag.CompositeMaskV2", 1);
    // Textarea is in the third chunk of values, so 3 should be set.
    histogram_tester.ExpectBucketCount("Blink.HTMLFastPathParser.UnsupportedContextTag.CompositeMaskV2", 4, 1);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedContextTag.Mask0V2", 0);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedContextTag.Mask1V2", 0);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedContextTag.Mask2V2", 1);
}
...
TEST(HTMLDocumentParserFastpathTest, LogSvg)
{
    ...
    histogram_tester.ExpectBucketCount("Blink.HTMLFastPathParser.UnsupportedTag.CompositeMaskV2", 4, 1);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTag.Mask0V2", 0);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTag.Mask1V2", 0);
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.UnsupportedTag.Mask2V2", 1);
}
...
TEST(HTMLDocumentParserFastpathTest, NullMappedToReplacementChar)
{
    ...
    div->setInnerHTML(String(base::span_from_cstring("<div id='x' name='x\0y'></div>")));
...
TEST(HTMLDocumentParserFastpathTest, DomParserUsesFastPath)
{
    ...
    base::HistogramTester histogram_tester;
    parser->parseFromString("<strong>0</strong> items left", V8SupportedType(V8SupportedType::Enum::kTextHtml));
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.ParseResult", 1);
}
...
TEST(HTMLDocumentParserFastpathTest, BodyWithLeadingAndTrailingWhitespace2)
{
    ...
    histogram_tester.ExpectTotalCount("Blink.HTMLFastPathParser.ParseResult", 1);
    EXPECT_EQ("<body>x \n  <div></div>y \n   </body>", CreateMarkup(document->body()));
    auto* first_child = document->body()->firstChild();
    ASSERT_TRUE(first_child);
}
