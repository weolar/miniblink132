...
class HTMLParserReentryPermit final : public GarbageCollected<HTMLParserReentryPermit> {
public:
    ...
    unsigned ScriptNestingLevel() const
    {
        return script_nesting_level_;
    }
    bool ParserPauseFlag() const
    {
        return parser_pause_flag_;
    }
    void Pause()
    {
    ...
    public:
        ...
        ScriptNestingLevelIncrementer(const ScriptNestingLevelIncrementer&) = delete;
        ScriptNestingLevelIncrementer& operator=(const ScriptNestingLevelIncrementer&) = delete;
