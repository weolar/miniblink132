...
public:
    ...
    {
        return source_ == kAutoDetectedEncoding || source_ == kEncodingFromContentSniffing;
    }
...
private:
    static const WTF::TextEncoding& DefaultEncoding(TextResourceDecoderOptions::ContentType, const WTF::TextEncoding& default_encoding);
