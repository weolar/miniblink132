...
class HTMLDocumentParserState : public GarbageCollected<HTMLDocumentParserState> {
...
public:
    ...
    DeferredParserState GetState() const
    {
        return state_;
    }

    int GetDefaultBudget() const
    {
        return budget_;
    }
    ...
    {
        return state_ >= DeferredParserState::kScheduled;
    }
    ...
    void DispatchedLinkHeaderPreloads()
    {
        needs_link_header_dispatch_ = false;
    }

    bool SeenFirstByte() const
    {
        return have_seen_first_byte_;
    }
    void MarkSeenFirstByte()
    {
        have_seen_first_byte_ = true;
    }

    bool EndWasDelayed() const
    {
        return end_was_delayed_;
    }
    void SetEndWasDelayed(bool new_value)
    {
        end_was_delayed_ = new_value;
    }
    ...
    bool WaitingForStylesheets() const
    {
        return is_waiting_for_stylesheets_;
    }
    ...
    {
        return should_attempt_to_end_on_eof_;
    }
    ...
    bool ShouldEndIfDelayed() const
    {
        return end_if_delayed_forbidden_ == 0;
    }
    ...
    ParserSynchronizationPolicy GetMode() const
    {
        return mode_;
    }
    ...
    int TimesYielded() const
    {
        return times_yielded_;
    }
    ...
    {
        return pump_session_nesting_level_;
    }
    bool InNestedPumpSession() const
    {
        return pump_session_nesting_level_ > 1;
    }
    ...
    {
        return exited_header_;
    }

private:
    void EnterEndIfDelayedForbidden()
    {
