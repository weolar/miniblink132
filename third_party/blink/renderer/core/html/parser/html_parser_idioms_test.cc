...
class SplitOnWhitespaceTest : public testing::Test, public ::testing::WithParamInterface<SplitOnWhitespaceTestCase> {
public:
...
INSTANTIATE_TEST_SUITE_P(All, SplitOnWhitespaceTest, ::testing::ValuesIn(SplitOnWhitespaceTest::test_cases));
