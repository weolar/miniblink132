...
public:
    static CloseWatcher* Create(ScriptState*, CloseWatcherOptions*, ExceptionState&);
    ...
    class WatcherStack final : public GarbageCollected<WatcherStack>, public mojom::blink::CloseListener {
    public:
...
private:
    static CloseWatcher* CreateInternal(LocalDOMWindow&, WatcherStack&, CloseWatcherOptions*);
