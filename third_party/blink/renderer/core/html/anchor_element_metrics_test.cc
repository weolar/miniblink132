...
protected:
    ...
    mojom::blink::AnchorElementMetricsPtr CreateAnchorMetrics(const String& source, const String& target)
    {
        SimRequest main_resource(source, "text/html");
        LoadURL(source);
        main_resource.Complete("<a id='anchor' href=''>example</a>");

        auto* anchor_element = To<HTMLAnchorElement>(GetDocument().getElementById(AtomicString("anchor")));
...
{
    auto metrics = CreateAnchorMetrics("http://example.com/p1", "http://example.com/p2");
    EXPECT_EQ(metrics->viewport_size.width(), AnchorElementMetricsTest::kViewportWidth);
    EXPECT_EQ(metrics->viewport_size.height(), AnchorElementMetricsTest::kViewportHeight);
}

// Test for is_url_incremented_by_one.
TEST_F(AnchorElementMetricsTest, IsUrlIncrementedByOne)
{
    EXPECT_TRUE(CreateAnchorMetrics("http://example.com/p1", "http://example.com/p2")->is_url_incremented_by_one);
    EXPECT_TRUE(CreateAnchorMetrics("http://example.com/?p=9", "http://example.com/?p=10")->is_url_incremented_by_one);
    EXPECT_TRUE(CreateAnchorMetrics("http://example.com/?p=12", "http://example.com/?p=13")->is_url_incremented_by_one);
    EXPECT_TRUE(CreateAnchorMetrics("http://example.com/p9/cat1", "http://example.com/p10/cat1")->is_url_incremented_by_one);
    EXPECT_FALSE(CreateAnchorMetrics("http://example.com/1", "https://example.com/2")->is_url_incremented_by_one);
    EXPECT_FALSE(CreateAnchorMetrics("http://example.com/1", "http://google.com/2")->is_url_incremented_by_one);
    EXPECT_FALSE(CreateAnchorMetrics("http://example.com/p1", "http://example.com/p1")->is_url_incremented_by_one);
    EXPECT_FALSE(CreateAnchorMetrics("http://example.com/p2", "http://example.com/p1")->is_url_incremented_by_one);
    EXPECT_FALSE(CreateAnchorMetrics("http://example.com/p9/cat1", "http://example.com/p10/cat2")->is_url_incremented_by_one);
}
...
TEST_F(AnchorElementMetricsTest, AnchorWithoutTextSibling)
{
    SimRequest main_resource("https://example.com/", "text/html");
    LoadURL("https://example.com/");
    main_resource.Complete(R"HTML(<body><a id='anchor' href="https://example.com/page2">foo</a></body>)HTML");
...
TEST_F(AnchorElementMetricsTest, AnchorWithPreviousTextSibling)
{
    SimRequest main_resource("https://example.com/", "text/html");
    LoadURL("https://example.com/");
    main_resource.Complete(R"HTML(<body>bar<a id='anchor' href="https://example.com/page2">foo</a></body>)HTML");
...
TEST_F(AnchorElementMetricsTest, AnchorWithNextTextSibling)
{
    SimRequest main_resource("https://example.com/", "text/html");
    LoadURL("https://example.com/");
    main_resource.Complete(R"HTML(<body><a id='anchor' href="https://example.com/page2">foo</a>bar</body>)HTML");
...
TEST_F(AnchorElementMetricsTest, AnchorFontSize)
{
    SimRequest main_resource("https://example.com/", "text/html");
    LoadURL("https://example.com/");
    main_resource.Complete(R"HTML(<body><a id='anchor' style="font-size: 23px" href="https://example.com/page2">foo</a>bar</body>)HTML");
...
TEST_F(AnchorElementMetricsTest, AnchorFontWeight)
{
    SimRequest main_resource("https://example.com/", "text/html");
    LoadURL("https://example.com/");
    main_resource.Complete(R"HTML(<body><a id='anchor' style='font-weight: 438' href="https://example.com/page2">foo</a>bar</body>)HTML");
...
TEST_F(AnchorElementMetricsTest, AnchorFeatureExtract)
{
    ...
    GetDocument().View()->LayoutViewport()->SetScrollOffset(ScrollOffset(0, kViewportHeight * 1.5), mojom::blink::ScrollType::kProgrammatic);
...
TEST_F(AnchorElementMetricsTest, AnchorFeatureInIframe)
{
    ...
    SimSubresourceRequest image_resource("https://example.com/cat.png", "image/png");
    ...
    Element* anchor = subframe->GetDocument()->getElementById(AtomicString("anchor"));
    auto* anchor_element = To<HTMLAnchorElement>(anchor);
    ...
    GetDocument().View()->LayoutViewport()->SetScrollOffset(ScrollOffset(0, kViewportHeight * 1.8), mojom::blink::ScrollType::kProgrammatic);
    GetDocument().View()->UpdateAllLifecyclePhasesForTest();
    auto metrics2 = CreateAnchorElementMetrics(*anchor_element);
    ...
    subframe->View()->LayoutViewport()->SetScrollOffset(ScrollOffset(0, kViewportHeight * 0.2), mojom::blink::ScrollType::kProgrammatic);
    GetDocument().View()->UpdateAllLifecyclePhasesForTest();
