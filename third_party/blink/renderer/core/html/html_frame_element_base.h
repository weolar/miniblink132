...
public:
    ...
    int MarginWidth() const final
    {
        return margin_width_;
    }
    int MarginHeight() const final
    {
...
protected:
    ...
    scoped_refptr<const SecurityOrigin> GetOriginForPermissionsPolicy() const override;
...
template <> struct DowncastTraits<HTMLFrameElementBase> {
    ...
    {
        return html_element.HasTagName(html_names::kFrameTag) || html_element.HasTagName(html_names::kIFrameTag);
    }
};
