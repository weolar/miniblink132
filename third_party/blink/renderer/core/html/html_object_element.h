...
class CORE_EXPORT HTMLObjectElement final : public HTMLPlugInElement, public ListedElement, public FormAssociated {
...
public:
    ...
    bool IsObjectElement() const override
    {
        return true;
    }
...
template <> struct DowncastTraits<HTMLObjectElement> {
