...
Vector<unsigned char> JpegImage()
{
    ...
    static const unsigned char kData[] = { 0xff, 0xd8, 0xff, 0xe0, 0x00, 0x10, 0x4a, 0x46, 0x49, 0x46, 0x00, 0x01, 0x01, 0x01, 0x00, 0x48, 0x00, 0x48, 0x00,
        0x00, 0xff, 0xdb, 0x00, 0x43, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
        ...
        ,
...
Vector<unsigned char> AnimatedWebpImage()
{
    ...
    static const unsigned char kData[] = { ,
...
protected:
    ...
    void CreateDocumentWithoutLoadingImage(int view_width, int view_height, bool is_animated);
    void CreateDocument(int view_width, int view_height, bool is_animated = false);

    ImageDocument& GetDocument() const;

    int ImageWidth() const
    {
        return GetDocument().ImageElement()->width();
    }
    int ImageHeight() const
    {
        return GetDocument().ImageElement()->height();
    }
...
void ImageDocumentTest::CreateDocumentWithoutLoadingImage(int view_width, int view_height, bool is_animated)
{
    chrome_client_ = MakeGarbageCollected<WindowToViewportScalingChromeClient>();
    dummy_page_holder_ = nullptr;
    dummy_page_holder_ = std::make_unique<DummyPageHolder>(gfx::Size(view_width, view_height), chrome_client_);
    ...
    if (force_zero_layout_height_.has_value()) {
        dummy_page_holder_->GetPage().GetSettings().SetForceZeroLayoutHeight(force_zero_layout_height_.value());
    }

    auto params = std::make_unique<WebNavigationParams>();
    params->url = is_animated ? KURL("http://www.example.com/image.webp") : KURL("http://www.example.com/image.jpg");

    const Vector<unsigned char>& data = is_animated ? AnimatedWebpImage() : JpegImage();
    WebNavigationParams::FillStaticResponse(params.get(), is_animated ? "image/webp" : "image/jpeg", "UTF-8", base::as_chars(base::span(data)));
    dummy_page_holder_->GetFrame().Loader().CommitNavigation(std::move(params), nullptr);
}

void ImageDocumentTest::CreateDocument(int view_width, int view_height, bool is_animated /*=false*/)
{
...
{
    CreateDocument(50, 50);
    auto& style = GetDocument().ImageElement()->getAttribute(html_names::kStyleAttr);
...
TEST_F(ImageDocumentTest, MAYBE(ImageCenteredAtDeviceScaleFactor))
{
    ...
    ScrollOffset offset = GetDocument().GetFrame()->View()->LayoutViewport()->GetScrollOffset();
    ...
    offset = GetDocument().GetFrame()->View()->LayoutViewport()->GetScrollOffset();
...
public:
    ...
    {
        Document* document = To<LocalFrame>(WebView().GetPage()->MainFrame())->DomWindow()->document();
        ImageDocument* image_document = static_cast<ImageDocument*>(document);
        return *image_document;
    }
};
