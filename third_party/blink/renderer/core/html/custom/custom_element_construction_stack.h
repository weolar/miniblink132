...
struct CustomElementConstructionStackEntry {
    ...
    CustomElementConstructionStackEntry(Element& element, CustomElementDefinition& definition)
        : element(element)
...
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::CustomElementConstructionStackEntry)

namespace blink {

using CustomElementConstructionStack = HeapVector<CustomElementConstructionStackEntry, 1>;
...
CORE_EXPORT CustomElementConstructionStack* GetCustomElementConstructionStack(const LocalDOMWindow* window, v8::Local<v8::Object> constructor);
...
public:
    ...
    CustomElementConstructionStackScope(const CustomElementConstructionStackScope&) = delete;
    CustomElementConstructionStackScope& operator=(const CustomElementConstructionStackScope&) = delete;
