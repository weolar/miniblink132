...
class CORE_EXPORT CustomElementReactionQueue final : public GarbageCollected<CustomElementReactionQueue> {
public:
    CustomElementReactionQueue();
    CustomElementReactionQueue(const CustomElementReactionQueue&) = delete;
    CustomElementReactionQueue& operator=(const CustomElementReactionQueue&) = delete;
    ~CustomElementReactionQueue();
