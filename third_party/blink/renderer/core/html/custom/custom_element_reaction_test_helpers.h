...
public:
    ...
    void Run(Element& element) override
    {
        std::move(callback_).Run(element);
    }
...
public:
    Log(char what, Vector<char>& where)
        : what_(what)
        , where_(where)
    {
    }
...
public:
    ...
    void Run(Element& element) override
    {
        queue_->InvokeReactions(element);
    }
...
public:
    explicit TestReaction(HeapVector<Member<Command>>&& commands)
        : CustomElementReaction(
            *MakeGarbageCollected<TestCustomElementDefinition>(CustomElementDescriptor(AtomicString("mock-element"), AtomicString("mock-element"))))
...
public:
    ...
    ResetCustomElementReactionStackForTest(const ResetCustomElementReactionStackForTest&) = delete;
    ResetCustomElementReactionStackForTest& operator=(const ResetCustomElementReactionStackForTest&) = delete;
