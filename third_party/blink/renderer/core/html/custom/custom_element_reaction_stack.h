...
class CORE_EXPORT CustomElementReactionStack final : public GarbageCollected<CustomElementReactionStack>, public NameClient, public Supplement<Agent> {
public:
    explicit CustomElementReactionStack(Agent& agent);
    CustomElementReactionStack(const CustomElementReactionStack&) = delete;
    CustomElementReactionStack& operator=(const CustomElementReactionStack&) = delete;
...
private:
    ...
    using ElementReactionQueueMap = HeapHashMap<Member<Element>, Member<CustomElementReactionQueue>>;
    ElementReactionQueueMap map_;

    static CustomElementReactionStack* Swap(Agent& agent, CustomElementReactionStack* new_stack);
