...
class CORE_EXPORT ElementInternals : public ScriptWrappable, public ListedElement, public ElementRareDataField {
...
public:
    ...
    void setFormValue(const V8ControlValue* value, ExceptionState& exception_state);
    void setFormValue(const V8ControlValue* value, const V8ControlValue* state, ExceptionState& exception_state);
    ...
    void setValidity(ValidityStateFlags* flags, const String& message, ExceptionState& exception_state);
    void setValidity(ValidityStateFlags* flags, const String& message, HTMLElement* anchor, ExceptionState& exception_state);
    ...
    void SetElementArrayAttribute(const QualifiedName& attribute, const HeapVector<Member<Element>>* given_elements);
    const FrozenArray<Element>* GetElementArrayAttribute(const QualifiedName& attribute) const;
...
private:
    ...
    HeapHashMap<QualifiedName, Member<FrozenArray<Element>>> explicitly_set_attr_elements_map_;
};

template <> struct DowncastTraits<ElementInternals> {
