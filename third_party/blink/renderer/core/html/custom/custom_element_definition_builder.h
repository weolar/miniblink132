...
public:
    CustomElementDefinitionBuilder(const CustomElementDefinitionBuilder&) = delete;
    CustomElementDefinitionBuilder& operator=(const CustomElementDefinitionBuilder&) = delete;
