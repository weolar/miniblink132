...
class CORE_EXPORT HTMLIFrameElement : public HTMLFrameElementBase, public Supplementable<HTMLIFrameElement> {
...
private:
    ...
    network::mojom::blink::TrustTokenParamsPtr ConstructTrustTokenParams() const override;

    // FrameOwner overrides:
    bool AllowFullscreen() const override
    {
        return allow_fullscreen_;
    }
    bool AllowPaymentRequest() const override
    {
        return allow_payment_request_;
    }
