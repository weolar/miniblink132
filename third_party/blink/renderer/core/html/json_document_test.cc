...
{
    LoadResource("{\"menu\":{\"id\":\"file\",\"value\":\"File\",\"popup\":{\"menuitem\":[{"
                 "\"value\":\"New\",\"click\":\"CreateNewDoc\"}]},\"itemCount\":3,"
                 "\"isShown\":true}}");
    EXPECT_EQ(GetDocument().documentElement()->QuerySelector(html_names::kBodyTag.LocalName())->firstChild()->textContent(),
...
{
    LoadResource("{\"interests\": [\"音楽\", \"खेल\", \"чтение\"],"
