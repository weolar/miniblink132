...
public:
    explicit HTMLStyleElement(Document&, const CreateElementFlags = CreateElementFlags());
...
private:
    ...
    void DispatchPendingEvent(std::unique_ptr<IncrementLoadEventDelayCount>, bool is_load_event);
    ...
    bool IsSameObject(const Node& node) const override
    {
        return this == &node;
    }
