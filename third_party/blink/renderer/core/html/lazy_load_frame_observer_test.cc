...
class LazyLoadFramesParamsTest : public SimTest,
                                 public ::testing::WithParamInterface<std::tuple<LazyFrameVisibleLoadTimeFeatureStatus, WebEffectiveConnectionType>> {
public:
    ...
    void SetUp() override
    {
        WebEffectiveConnectionType ect = std::get<WebEffectiveConnectionType>(GetParam());
        GetNetworkStateNotifier().SetNetworkConnectionInfoOverride(
            true /*on_line*/, kWebConnectionTypeWifi, ect, 1000 /*http_rtt_msec*/, 100 /*max_bandwidth_mbps*/);
    ...
    {
        static constexpr int kDistanceThresholdByEffectiveConnectionType[] = { 200, 300, 400, 500, 600, 700 };
        return kDistanceThresholdByEffectiveConnectionType[static_cast<int>(std::get<WebEffectiveConnectionType>(GetParam()))];
    }
    ...
    std::unique_ptr<SimRequest> LoadPageWithCrossOriginFrameFarFromViewport()
    {
        ...
        if (!child_frame_resource) {
            child_frame_resource = std::make_unique<SimRequest>("https://crossorigin.com/subframe.html", "text/html");
        }
...
{
    SimRequest main_resource("https://example.com/", "text/html");
    SimRequest child_frame_resource("https://example.com/subframe.html", "text/html");
...
{
    SimRequest main_resource("https://example.com/", "text/html");
    SimRequest child_frame_resource("https://crossorigin.com/subframe.html", "text/html");
...
TEST_P(LazyLoadFramesParamsTest, BelowTheFoldButNearViewportFrame)
{
    ...
    GetDocument().View()->LayoutViewport()->SetScrollOffset(ScrollOffset(0, 150), mojom::blink::ScrollType::kProgrammatic);
...
{
    std::unique_ptr<SimRequest> child_frame_resource = LoadPageWithCrossOriginFrameFarFromViewport();
    ...
    GetDocument().View()->LayoutViewport()->SetScrollOffset(ScrollOffset(0, GetLoadingDistanceThreshold() + 150), mojom::blink::ScrollType::kProgrammatic);
...
TEST_P(LazyLoadFramesParamsTest, CrossOriginFrameFarFromViewportBecomesVisibleBeforeFinishedLoading)
{
    std::unique_ptr<SimRequest> child_frame_resource = LoadPageWithCrossOriginFrameFarFromViewport();
...
TEST_P(LazyLoadFramesParamsTest, NestedFrameInCrossOriginFrameFarFromViewport)
{
    ...
    child_frame_resource->Complete(String::Format("<div style='height: %dpx;'></div>"
...
TEST_P(LazyLoadFramesParamsTest, AboutBlankChildFrameNavigation)
{
    ...
    EXPECT_TRUE(ConsoleMessages().Contains("main body onload"));
    EXPECT_EQ(1, static_cast<int>(base::ranges::count(ConsoleMessages(), "child frame element onload")));
    ...
    EXPECT_EQ(2, static_cast<int>(base::ranges::count(ConsoleMessages(), "child frame element onload")));
}
...
TEST_P(LazyLoadFramesParamsTest, CrossOriginFrameFarFromViewportWithLoadingAttributeEager)
{
    SimRequest main_resource("https://example.com/", "text/html");
    SimRequest child_frame_resource("https://crossorigin.com/subframe.html", "text/html");
    ...
    EXPECT_TRUE(ConsoleMessages().Contains("main body onload"));
    EXPECT_TRUE(ConsoleMessages().Contains("child frame element onload"));
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kLazyLoadFrameLoadingAttributeLazy));
    EXPECT_TRUE(GetDocument().IsUseCounted(WebFeature::kLazyLoadFrameLoadingAttributeEager));
}

TEST_P(LazyLoadFramesParamsTest, LoadSameOriginFrameFarFromViewportWithLoadingAttributeLazy)
{
    SimRequest main_resource("https://example.com/", "text/html");
    ...
    EXPECT_TRUE(ConsoleMessages().Contains("main body onload"));
    EXPECT_FALSE(ConsoleMessages().Contains("child frame element onload"));
    EXPECT_TRUE(GetDocument().IsUseCounted(WebFeature::kLazyLoadFrameLoadingAttributeLazy));
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kLazyLoadFrameLoadingAttributeEager));

    if (!child_frame_resource) {
        child_frame_resource.emplace("https://example.com/subframe.html", "text/html");
    }
...
TEST_P(LazyLoadFramesParamsTest, LoadCrossOriginFrameFarFromViewportThenSetLoadingAttributeEager)
{
    SimRequest main_resource("https://example.com/", "text/html");
    std::optional<SimRequest> child_frame_resource;
    ...
    if (!child_frame_resource) {
        child_frame_resource.emplace("https://crossorigin.com/subframe.html", "text/html");
    }

    Element* child_frame_element = GetDocument().getElementById(AtomicString("child_frame"));
    ASSERT_TRUE(child_frame_element);
    child_frame_element->setAttribute(html_names::kLoadingAttr, AtomicString("eager"));
...
TEST_P(LazyLoadFramesParamsTest, NestedFrameWithLazyLoadAttributeOnInFrameWithNoLoadingAttribute)
{
    std::unique_ptr<SimRequest> child_frame_resource = LoadPageWithCrossOriginFrameFarFromViewport();
...
TEST_P(LazyLoadFramesParamsTest, NestedFrameWithLazyLoadAttributeOnInFrameWithLoadingAttributeEager)
{
    SimRequest main_resource("https://example.com/", "text/html");
    SimRequest child_frame_resource("https://crossorigin.com/subframe.html", "text/html");
...
TEST_P(LazyLoadFramesParamsTest, NestedFrameWithLazyLoadAttributeOffInFrameWithLoadingAttributeEager)
{
    SimRequest main_resource("https://example.com/", "text/html");
    SimRequest child_frame_resource("https://crossorigin.com/subframe.html", "text/html");
...
INSTANTIATE_TEST_SUITE_P(LazyFrameLoading, LazyLoadFramesParamsTest,
    ::testing::Combine(::testing::Values(LazyFrameVisibleLoadTimeFeatureStatus::kDisabled, LazyFrameVisibleLoadTimeFeatureStatus::kEnabled),
        ::testing::Values(WebEffectiveConnectionType::kTypeUnknown, WebEffectiveConnectionType::kTypeOffline, WebEffectiveConnectionType::kTypeSlow2G,
            WebEffectiveConnectionType::kType2G, WebEffectiveConnectionType::kType3G, WebEffectiveConnectionType::kType4G)));
...
public:
    ...
    void SetUp() override
    {
        ...
        GetNetworkStateNotifier().SetNetworkConnectionInfoOverride(
            true /*on_line*/, kWebConnectionTypeWifi, WebEffectiveConnectionType::kType4G, 1000 /*http_rtt_msec*/, 100 /*max_bandwidth_mbps*/);
    ...
    void TestCrossOriginFrameIsImmediatelyLoaded(const char* iframe_attributes)
    {
        ...
        main_resource.Complete(String::Format(
          ...
          <iframe src='https://crossorigin.com/subframe.html'
            ...
            kViewportHeight + kLoadingDistanceThresholdPx + 100, iframe_attributes));
    ...
    void TestLazyLoadUsedInPageReload(const char* iframe_attributes, bool is_deferral_expected_on_reload)
    {
        ...
        main_resource.Complete(String::Format(
            ...
            LazyLoadFramesTest::kViewportHeight + LazyLoadFramesTest::kLoadingDistanceThresholdPx + 100, iframe_attributes));
        ...
        if (is_deferral_expected_on_reload) {
            ...
            GetDocument().View()->LayoutViewport()->SetScrollOffset(
                ScrollOffset(0, LazyLoadFramesTest::kViewportHeight + LazyLoadFramesTest::kLoadingDistanceThresholdPx),
