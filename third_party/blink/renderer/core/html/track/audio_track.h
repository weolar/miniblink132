...
public:
    AudioTrack(const String& id, const AtomicString& kind, const AtomicString& label, const AtomicString& language, bool enabled, bool exclusive);
    ~AudioTrack() override;
...
template <> struct DowncastTraits<AudioTrack> {
