...
private:
    ...
    LayoutUnit ComputeInitialPositionAdjustment(LayoutUnit max_dimension, const gfx::Rect& controls_rect);
    ...
    bool ShouldSwitchDirection(LayoutUnit cue_block_position, LayoutUnit cue_block_size, LayoutUnit full_dimension) const;
