...
HTMLTagCollection::HTMLTagCollection(ContainerNode& root_node, const AtomicString& qualified_name)
...
HTMLTagCollection::HTMLTagCollection(ContainerNode& root_node, CollectionType type, const AtomicString& qualified_name)
