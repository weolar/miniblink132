...
class IntersectionObserverDelegate : public GarbageCollected<IntersectionObserverDelegate>, public NameClient {
public:
    ~IntersectionObserverDelegate() override = default;

    virtual IntersectionObserver::DeliveryBehavior GetDeliveryBehavior() const = 0;
    ...
    virtual void Deliver(const HeapVector<Member<IntersectionObserverEntry>>&, IntersectionObserver&) = 0;
