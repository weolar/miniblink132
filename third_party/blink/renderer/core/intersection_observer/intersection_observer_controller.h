...
public:
    ...
    std::optional<IntersectionGeometry::RootGeometry>& GetRootGeometry(const IntersectionObserver& observer, unsigned flags);
...
class CORE_EXPORT IntersectionObserverController : public GarbageCollected<IntersectionObserverController>, public ExecutionContextClient, public NameClient {
public:
    ...
    // observer.
    bool ComputeIntersections(unsigned flags, LocalFrameView&, gfx::Vector2dF accumulated_scroll_delta_since_last_update, ComputeIntersectionsContext&);
...
private:
    ...
    HeapHashMap<Member<IntersectionObserver>, HeapHashSet<Member<IntersectionObservation>>> tracked_implicit_root_observations_;
