...
public:
    IntersectionObserverEntry(const IntersectionGeometry& geometry, DOMHighResTimeStamp timestamp, Element* target);
    ...
    {
        return geometry_.IsIntersecting();
    }
    ...
    const IntersectionGeometry& GetGeometry() const
    {
        return geometry_;
    }
