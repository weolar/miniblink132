...
class CORE_EXPORT ElementIntersectionObserverData final : public GarbageCollected<ElementIntersectionObserverData>,
                                                          public NameClient,
...
public:
    ...
    bool IsEmpty() const
    {
        return observations_.empty() && observers_.empty();
    }
...
private:
    ...
    HeapHashMap<Member<IntersectionObserver>, Member<IntersectionObservation>> observations_;
