...
class CORE_EXPORT IntersectionObservation final : public GarbageCollected<IntersectionObservation> {
public:
    ...
    IntersectionObserver* Observer() const
    {
    ...
    int64_t ComputeIntersection(unsigned flags, gfx::Vector2dF accumulated_scroll_delta_since_last_update, ComputeIntersectionsContext&);
...
private:
    ...
    void ProcessIntersectionGeometry(const IntersectionGeometry& geometry, ComputeIntersectionsContext&);
