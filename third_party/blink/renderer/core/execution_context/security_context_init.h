...
public:
    ...
    void ApplyPermissionsPolicy(LocalFrame& frame, const ResourceResponse& response, const FramePolicy& frame_policy,
    ...
    void ApplyDocumentPolicy(DocumentPolicy::ParsedDocumentPolicy& document_policy, const String& report_only_document_policy_header);
