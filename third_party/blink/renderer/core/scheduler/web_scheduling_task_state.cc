...
WebSchedulingTaskState::WebSchedulingTaskState(scheduler::TaskAttributionInfo* task_state, AbortSignal* abort_source, DOMTaskSignal* priority_source)
...
scheduler::TaskAttributionInfo* WebSchedulingTaskState::GetTaskAttributionInfo()
{
