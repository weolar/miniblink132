...
class CORE_EXPORT WebSchedulingTaskState final : public GarbageCollected<WebSchedulingTaskState>, public WrappableTaskState {
public:
    WebSchedulingTaskState(scheduler::TaskAttributionInfo*, AbortSignal* abort_source, DOMTaskSignal* priority_source);
