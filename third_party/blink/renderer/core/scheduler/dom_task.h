...
public:
    DOMTask(ScriptPromiseResolver<IDLAny>*, V8SchedulerPostTaskCallback*, AbortSignal* abort_source, DOMTaskSignal* priority_source,
        DOMScheduler::DOMTaskQueue*, base::TimeDelta delay, uint64_t task_id_for_tracing);
