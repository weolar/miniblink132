...
class CORE_EXPORT IdleTask : public GarbageCollected<IdleTask>, public NameClient {
public:
...
class CORE_EXPORT ScriptedIdleTaskController : public GarbageCollected<ScriptedIdleTaskController>,
...
private:
    ...
    void SchedulerIdleTask(CallbackId id, DelayedTaskCanceler canceler, base::TimeTicks deadline);
    void SchedulerTimeoutTask(CallbackId id);

    void RunIdleTask(CallbackId id, base::TimeTicks deadline, IdleDeadline::CallbackType callback_type);
