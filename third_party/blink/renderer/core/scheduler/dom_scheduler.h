 ...
 */
class CORE_EXPORT DOMScheduler : public ScriptWrappable, public ExecutionContextLifecycleObserver, public Supplement<ExecutionContext> {
...
public:
    ...
    ScriptPromise<IDLAny> postTask(ScriptState*, V8SchedulerPostTaskCallback*, SchedulerPostTaskOptions*, ExceptionState&);
    ...
    DOMTaskSignal* GetFixedPriorityTaskSignal(ScriptState*, WebSchedulingPriority);
...
private:
    ...
    static constexpr size_t kWebSchedulingPriorityCount = static_cast<size_t>(WebSchedulingPriority::kLastPriority) + 1;

    static constexpr WebSchedulingPriority kDefaultPriority = WebSchedulingPriority::kUserVisiblePriority;
    ...
    public:
        DOMTaskQueue(std::unique_ptr<WebSchedulingTaskQueue> task_queue, WebSchedulingPriority priority);
        ~DOMTaskQueue();
        ...
        WebSchedulingPriority GetPriority() const
        {
            return priority_;
        }
    ...
    using FixedPriorityTaskQueueVector = HeapVector<Member<DOMTaskQueue>, kWebSchedulingPriorityCount>;
    using SignalToTaskQueueMap = HeapHashMap<WeakMember<DOMTaskSignal>, WeakMember<DOMTaskQueue>>;
    ...
    void CreateFixedPriorityTaskQueues(ExecutionContext*, WebSchedulingQueueType, FixedPriorityTaskQueueVector&);
    ...
    DOMTaskQueue* CreateDynamicPriorityTaskQueue(DOMTaskSignal*, WebSchedulingQueueType);
    ...
    // fixed priority.
    HeapVector<Member<DOMTaskSignal>, kWebSchedulingPriorityCount> fixed_priority_task_signals_;
