...
public:
    static TaskPriorityChangeEvent* Create(const AtomicString& type, const TaskPriorityChangeEventInit*);

    TaskPriorityChangeEvent(const AtomicString& type, const TaskPriorityChangeEventInit*);
