...
TaskAttributionInfoImpl::TaskAttributionInfoImpl(scheduler::TaskAttributionId id, SoftNavigationContext* soft_navigation_context)
    : id_(id)
...
scheduler::TaskAttributionInfo* TaskAttributionInfoImpl::GetTaskAttributionInfo()
{
    return this;
}
