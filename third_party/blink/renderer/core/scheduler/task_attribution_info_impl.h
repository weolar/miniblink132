...
class CORE_EXPORT TaskAttributionInfoImpl final : public GarbageCollected<TaskAttributionInfoImpl>,
...
template <> struct DowncastTraits<TaskAttributionInfoImpl> {
    static bool AllowFrom(const scheduler::TaskAttributionInfo&)
    {
        return true;
    }
};
