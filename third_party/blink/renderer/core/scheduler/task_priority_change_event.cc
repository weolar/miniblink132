...
// static
TaskPriorityChangeEvent* TaskPriorityChangeEvent::Create(const AtomicString& type, const TaskPriorityChangeEventInit* initializer)
{
    return MakeGarbageCollected<TaskPriorityChangeEvent>(type, initializer);
}

TaskPriorityChangeEvent::TaskPriorityChangeEvent(const AtomicString& type, const TaskPriorityChangeEventInit* initializer)
