...
public:
    MockAnimationTimeline(Document* document)
...
TEST_F(DocumentAnimationsTest, NeedsAnimationTimingUpdate)
{
    ...
    MockAnimationTimeline* timeline1 = MakeGarbageCollected<MockAnimationTimeline>(document);
    MockAnimationTimeline* timeline2 = MakeGarbageCollected<MockAnimationTimeline>(document);
...
TEST_F(DocumentAnimationsTest, UpdateAnimationsUpdatesAllTimelines)
{
    ...
    document->GetFrame()->LocalFrameRoot().View()->UpdateAllLifecyclePhases(DocumentUpdateReason::kTest);
