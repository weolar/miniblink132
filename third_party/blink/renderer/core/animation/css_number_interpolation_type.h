...
public:
    CSSNumberInterpolationType(PropertyHandle property, const PropertyRegistration* registration = nullptr, bool round_to_integer = false)
...
private:
    ...
    {
        return round_to_integer_ ? CSSPrimitiveValue::UnitType::kInteger : CSSPrimitiveValue::UnitType::kNumber;
    }
