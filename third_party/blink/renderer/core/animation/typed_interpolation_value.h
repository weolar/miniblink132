...
class TypedInterpolationValue : public GarbageCollected<TypedInterpolationValue> {
public:
    TypedInterpolationValue(
        const InterpolationType& type, InterpolableValue* interpolable_value, scoped_refptr<const NonInterpolableValue> non_interpolable_value = nullptr)
        : type_(type)
    ...
    TypedInterpolationValue* Clone() const
    {
        ...
        return MakeGarbageCollected<TypedInterpolationValue>(type_, copy.interpolable_value, std::move(copy.non_interpolable_value));
    }
