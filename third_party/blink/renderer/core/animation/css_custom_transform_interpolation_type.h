...
class CSSCustomTransformInterpolationType : public CSSTransformInterpolationType {
public:
    CSSCustomTransformInterpolationType(PropertyHandle property, const PropertyRegistration* registration)
