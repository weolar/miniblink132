...
TEST(CSSColorInterpolationTypeTest, RGBBounds)
{
    ...
    InterpolableValue* from = CSSColorInterpolationType::CreateInterpolableColor(from_color);
    InterpolableValue* to = CSSColorInterpolationType::CreateInterpolableColor(to_color);
    InterpolableValue* result = CSSColorInterpolationType::CreateInterpolableColor(to_color);
...
TEST(CSSColorInterpolationTypeTest, RGBToOklab)
{
    ...
    InterpolableColor* from = CSSColorInterpolationType::CreateInterpolableColor(from_color);
    InterpolableColor* to = CSSColorInterpolationType::CreateInterpolableColor(to_color);
...
{
    test::TaskEnvironment task_environment;
    Color from_color = Color::FromColorSpace(Color::ColorSpace::kOklab, 1, 1, 1, 1);
    Color to_color = Color::FromColorSpace(Color::ColorSpace::kOklab, 0, 0, 0, 0.5);
    InterpolableValue* from = CSSColorInterpolationType::CreateInterpolableColor(from_color);
    InterpolableValue* to = CSSColorInterpolationType::CreateInterpolableColor(to_color);
    InterpolableValue* result = CSSColorInterpolationType::CreateInterpolableColor(to_color);
