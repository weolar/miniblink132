...
public:
    ...
    static Timing Convert(const V8UnionKeyframeEffectOptionsOrUnrestrictedDouble* options, Document* document, ExceptionState& exception_state);
    ...
    static Timing Convert(const V8UnionKeyframeAnimationOptionsOrUnrestrictedDouble* options, Document* document, ExceptionState& exception_state);
    ...
    template <class TimingInput> static bool Update(Timing&, const TimingInput*, Document*, ExceptionState&);
};
