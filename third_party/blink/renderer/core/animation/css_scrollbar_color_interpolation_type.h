...
class CORE_EXPORT CSSScrollbarColorInterpolationType : public CSSInterpolationType {
public:
...
private:
    InterpolableScrollbarColor* CreateScrollbarColorValue(const StyleScrollbarColor*) const;
