...
public:
    ...
    virtual bool IsInvalidatableInterpolation() const
    {
        return false;
    }
    virtual bool IsTransitionInterpolation() const
    {
        return false;
    }
...
using ActiveInterpolationsMap = HeapHashMap<PropertyHandle, Member<ActiveInterpolations>>;
