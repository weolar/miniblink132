...
public:
    ...
    static bool GetInitialLengthList(const CSSProperty&, const ComputedStyle& initial_style, Vector<Length>& result);
    static bool GetLengthList(const CSSProperty&, const ComputedStyle&, Vector<Length>& result);
    static void SetLengthList(const CSSProperty&, ComputedStyleBuilder&, Vector<Length>&& length_list);
};
