...
public:
    InterpolableColor()
    {
        ...
        static_assert(std::is_trivially_destructible_v<InterpolableColor>, "Require trivial destruction for faster sweeping");
    }
    ...
    static InterpolableColor* Create(CSSValueID keyword, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider);

    Color GetColor() const;
    bool IsColor() const final
    {
        return true;
    }
    ...
    static void SetupColorInterpolationSpaces(InterpolableColor& to, InterpolableColor& from);
    ...
    Color Resolve(const Color& current_color, const Color& active_link_color, const Color& link_color, const Color& text_color,
    ...
    double Param0() const
    {
        return param0_.Value();
    }
    double Param1() const
    {
        return param1_.Value();
    }
    double Param2() const
    {
        return param2_.Value();
    }
    double Alpha() const
    {
        return alpha_.Value();
    }
    Color::ColorSpace ColorSpace() const
    {
        return color_space_;
    }
    ...
    InterpolableColor* Clone() const
    {
        return RawClone();
    }

    InterpolableColor* CloneAndZero() const
    {
    ...
    InterpolableColor(InlinedInterpolableDouble param0, InlinedInterpolableDouble param1, InlinedInterpolableDouble param2, InlinedInterpolableDouble alpha,
        InlinedInterpolableDouble current_color, InlinedInterpolableDouble webkit_active_link, InlinedInterpolableDouble webkit_link,
        InlinedInterpolableDouble quirk_inherit, Color::ColorSpace color_space);
...
template <> struct DowncastTraits<InterpolableColor> {
