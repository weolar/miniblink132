...
public:
    static SizeList GetInitialSizeList(const CSSProperty&, const ComputedStyle& initial_style);
    static SizeList GetSizeList(const CSSProperty&, const ComputedStyle&);
    static void SetSizeList(const CSSProperty&, ComputedStyleBuilder&, const SizeList&);
};
