...
TEST(InterpolableDynamicRangeLimitTest, SimpleEndpointsInterpolation)
{
    ...
    InterpolableDynamicRangeLimit* interpolable_limit_from = InterpolableDynamicRangeLimit::Create(limit1);
    InterpolableDynamicRangeLimit* interpolable_limit_to = InterpolableDynamicRangeLimit::Create(limit2);

    InterpolableValue* interpolable_value = interpolable_limit_from->CloneAndZero();
    interpolable_limit_from->Interpolate(*interpolable_limit_to, 0.3, *interpolable_value);
    const auto& result_limit = To<InterpolableDynamicRangeLimit>(*interpolable_value);
...
TEST(InterpolableDynamicRangeLimitTest, NestedEndpointsInterpolation)
{
    ...
    InterpolableValue* interpolable_value = interpolable_limit_from->CloneAndZero();
    interpolable_limit_from->Interpolate(*interpolable_limit_to, 0.5, *interpolable_value);
    const auto& result_limit = To<InterpolableDynamicRangeLimit>(*interpolable_value);
    DynamicRangeLimit limit = result_limit.GetDynamicRangeLimit();
...
TEST(InterpolableDynamicRangeLimitTest, TestScaleAndAdd)
{
    ...
    DynamicRangeLimit limit2(cc::PaintFlags::DynamicRangeLimit::kHigh);
    InterpolableDynamicRangeLimit* interpolable_limit1 = InterpolableDynamicRangeLimit::Create(limit1);
    InterpolableDynamicRangeLimit* interpolable_limit2 = InterpolableDynamicRangeLimit::Create(limit2);
