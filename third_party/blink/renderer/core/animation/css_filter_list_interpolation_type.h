...
private:
    ...
    InterpolationValue PerformAdditiveComposition(InterpolableList* interpolable_list, const InterpolableList& underlying_list) const;
    InterpolationValue PerformAccumulativeComposition(InterpolableList* interpolable_list, const InterpolableList& underlying_list) const;
};
