...
TEST(SVGNumberInterpolationTypeTest, NonNegativeSVGNumber)
{
    ...
    SVGNumber* svg_number = static_cast<SVGNumber*>(interpolation_type.AppliedSVGValueForTesting(InterpolableNumber(5), nullptr));
    EXPECT_EQ(svg_number->Value(), 5);

    svg_number = static_cast<SVGNumber*>(interpolation_type.AppliedSVGValueForTesting(InterpolableNumber(-5), nullptr));
...
TEST(SVGNumberInterpolationTypeTest, InterpolableNumberOutOfRange)
{
    ...
    SVGNumber* svg_number = static_cast<SVGNumber*>(interpolation_type.AppliedSVGValueForTesting(InterpolableNumber(too_large), nullptr));
