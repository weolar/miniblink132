...
public:
        ...
        : CSSInterpolationType(property)
    {
        ...
        DCHECK(property_id_ == CSSPropertyID::kGridTemplateColumns || property_id_ == CSSPropertyID::kGridTemplateRows);
    }
    ...
    static InterpolableValue* CreateInterpolableGridTrackList(const NGGridTrackList& track_list, const CSSProperty& property, float zoom);
