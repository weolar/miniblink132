...
TEST(CSSScrollbarColorInterpolationTypeTest, GetRGBA1)
{
    ...
    EXPECT_EQ(color, CSSColorInterpolationType::GetColor(*CSSColorInterpolationType::CreateInterpolableColor(color)));
}
...
TEST(CSSScrollbarColorInterpolationTypeTest, GetRGBA4)
{
    ...
    EXPECT_EQ(Color::FromRGBA(0, 0, 0, 0), CSSColorInterpolationType::GetColor(*CSSColorInterpolationType::CreateInterpolableColor(color)));
}
...
TEST(CSSScrollbarColorInterpolationTypeTest, RGBBounds)
{
    ...
    std::unique_ptr<InterpolableValue> from = CSSColorInterpolationType::CreateInterpolableColor(from_color);
    std::unique_ptr<InterpolableValue> to = CSSColorInterpolationType::CreateInterpolableColor(to_color);
    std::unique_ptr<InterpolableValue> result = CSSColorInterpolationType::CreateInterpolableColor(to_color);
...
TEST(CSSScrollbarColorInterpolationTypeTest, RGBToOklab)
{
    ...
    Color to_color = Color::FromColorSpace(Color::ColorSpace::kOklab, 0, 0, 0, 0.5);
    std::unique_ptr<InterpolableColor> from = CSSColorInterpolationType::CreateInterpolableColor(from_color);
    std::unique_ptr<InterpolableColor> to = CSSColorInterpolationType::CreateInterpolableColor(to_color);

    from_color = CSSColorInterpolationType::GetColor(*from);
    ASSERT_EQ(Color::ColorSpace::kSRGBLegacy, from_color.GetColorInterpolationSpace());
...
{
    Color from_color = Color::FromColorSpace(Color::ColorSpace::kOklab, 100, 1, 1, 1);
    Color to_color = Color::FromColorSpace(Color::ColorSpace::kOklab, 0, 0, 0, 0.5);
    std::unique_ptr<InterpolableValue> from = CSSColorInterpolationType::CreateInterpolableColor(from_color);
    std::unique_ptr<InterpolableValue> to = CSSColorInterpolationType::CreateInterpolableColor(to_color);
    std::unique_ptr<InterpolableValue> result = CSSColorInterpolationType::CreateInterpolableColor(to_color);
    ...
    ASSERT_EQ(Color::ColorSpace::kOklab, result_color.GetColorInterpolationSpace());
