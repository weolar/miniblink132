...
class CSSCustomTransformFunctionInterpolationType : public CSSTransformInterpolationType {
public:
    CSSCustomTransformFunctionInterpolationType(PropertyHandle property, const PropertyRegistration* registration)
