...
public:
    ...
    explicit InterpolableAspectRatio(InterpolableValue* value)
        : value_(value)
    {
    }
    ...
    bool IsAspectRatio() const final
    {
        return true;
    }
...
private:
    ...
    {
        return MakeGarbageCollected<InterpolableAspectRatio>(value_->CloneAndZero());
    }
...
template <> struct DowncastTraits<InterpolableAspectRatio> {
