...
KeyframeEffect* CreateSimpleKeyframeEffectForTest(Element*, CSSPropertyID, String value_start, String value_end);
KeyframeEffectModelBase* CreateSimpleKeyframeEffectModelForTest(CSSPropertyID, String value_start, String value_end);
