...
public:
    ...
    static InterpolableFontPalette* Create(scoped_refptr<const FontPalette> font_palette);
    ...
    bool IsFontPalette() const final
    {
        return true;
    }
...
template <> struct DowncastTraits<InterpolableFontPalette> {
