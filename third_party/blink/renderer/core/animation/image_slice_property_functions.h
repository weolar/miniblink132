...
public:
    static ImageSlice GetInitialImageSlice(const CSSProperty& property, const ComputedStyle& initial_style)
    {
        return GetImageSlice(property, initial_style);
    }

    static ImageSlice GetImageSlice(const CSSProperty& property, const ComputedStyle& style)
    {
    ...
    static void SetImageSlice(const CSSProperty& property, ComputedStyleBuilder& builder, const ImageSlice& slice)
    {
        switch (property.PropertyID()) {
        case CSSPropertyID::kBorderImageSlice:
