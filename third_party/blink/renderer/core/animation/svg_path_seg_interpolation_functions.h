...
public:
    static InterpolableValue* ConsumePathSeg(const PathSegmentData&, PathCoordinates& current_coordinates);
    static PathSegmentData ConsumeInterpolablePathSeg(const InterpolableValue&, SVGPathSegType, PathCoordinates& current_coordinates);
};
