...
OptionalStyleColor ColorPropertyFunctions::GetInitialColor(const CSSProperty& property, const ComputedStyle& initial_style)
{
    return GetUnvisitedColor(property, initial_style);
}

template <typename ComputedStyleOrBuilder>
OptionalStyleColor ColorPropertyFunctions::GetUnvisitedColor(const CSSProperty& property, const ComputedStyleOrBuilder& style)
{
...
template OptionalStyleColor ColorPropertyFunctions::GetUnvisitedColor<ComputedStyle>(const CSSProperty&, const ComputedStyle&);
template OptionalStyleColor ColorPropertyFunctions::GetUnvisitedColor<ComputedStyleBuilder>(const CSSProperty&, const ComputedStyleBuilder&);

template <typename ComputedStyleOrBuilder>
OptionalStyleColor ColorPropertyFunctions::GetVisitedColor(const CSSProperty& property, const ComputedStyleOrBuilder& style)
{
    switch (property.PropertyID()) {
    case CSSPropertyID::kAccentColor:
    ...
    case CSSPropertyID::kCaretColor:
        ...
        return OptionalStyleColor(style.InternalVisitedCaretColor().ToStyleColor());
    case CSSPropertyID::kColor:
        return OptionalStyleColor(style.InternalVisitedColor());
    case CSSPropertyID::kOutlineColor:
        return OptionalStyleColor(style.InternalVisitedOutlineColor());
    case CSSPropertyID::kColumnRuleColor:
        return OptionalStyleColor(style.InternalVisitedColumnRuleColor().GetLegacyValue());
    case CSSPropertyID::kTextEmphasisColor:
...
template OptionalStyleColor ColorPropertyFunctions::GetVisitedColor<ComputedStyle>(const CSSProperty&, const ComputedStyle&);
template OptionalStyleColor ColorPropertyFunctions::GetVisitedColor<ComputedStyleBuilder>(const CSSProperty&, const ComputedStyleBuilder&);

void ColorPropertyFunctions::SetUnvisitedColor(const CSSProperty& property, ComputedStyleBuilder& builder, const Color& color)
{
...
void ColorPropertyFunctions::SetVisitedColor(const CSSProperty& property, ComputedStyleBuilder& builder, const Color& color)
{
    StyleColor style_color(color);
    switch (property.PropertyID()) {
    case CSSPropertyID::kAccentColor:
    ...
    case CSSPropertyID::kBorderTopColor:
        ...
        return;
    case CSSPropertyID::kCaretColor:
        builder.SetInternalVisitedCaretColor(StyleAutoColor(std::move(style_color)));
        return;
    case CSSPropertyID::kColor:
    ...
    case CSSPropertyID::kTextEmphasisColor:
        ...
        return;
    case CSSPropertyID::kColumnRuleColor:
        builder.SetInternalVisitedColumnRuleColor(GapDataList<StyleColor>(style_color));
        return;
    case CSSPropertyID::kWebkitTextStrokeColor:
