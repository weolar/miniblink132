...
public:
    ...
    explicit InterpolableStyleColor(const BaseInterpolableColor* interpolable_color)
    ...
    static InterpolableStyleColor* Create(const BaseInterpolableColor* interpolable_color)
    {
    ...
    static void Interpolate(const InterpolableValue& from, const InterpolableValue& to, double progress, InterpolableValue& result);
    ...
    {
        InterpolableStyleColor* clone = MakeGarbageCollected<InterpolableStyleColor>(style_color_);
    ...
    const StyleColor& style_color() const
    {
        return style_color_;
    }
...
template <> struct DowncastTraits<InterpolableStyleColor> {
