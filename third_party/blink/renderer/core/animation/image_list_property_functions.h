...
public:
    ...
    static void GetImageList(const CSSProperty& property, const ComputedStyle& style, StyleImageList* result)
    {
    ...
    static void SetImageList(const CSSProperty& property, ComputedStyleBuilder& builder, const StyleImageList* image_list)
    {
