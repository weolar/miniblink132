...
namespace blink {
EffectModel::CompositeOperation EffectModel::EnumToCompositeOperation(V8CompositeOperation::Enum composite)
{
    switch (composite) {
...
std::optional<EffectModel::CompositeOperation> EffectModel::EnumToCompositeOperation(V8CompositeOperationOrAuto::Enum composite)
{
    switch (composite) {
...
V8CompositeOperation::Enum EffectModel::CompositeOperationToEnum(CompositeOperation composite)
{
    switch (composite) {
