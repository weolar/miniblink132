...
public:
    CSSTimeInterpolationType(PropertyHandle property, const PropertyRegistration* registration = nullptr)
    ...
    static std::optional<double> GetSeconds(const CSSPropertyID& property, const ComputedStyle& style);
