...
public:
    static CSSPropertyID KeyframeAttributeToCSSProperty(const WTF::String&, const Document&);
    static CSSPropertyID KeyframeAttributeToPresentationAttribute(const WTF::String&, const Element*);
    static const QualifiedName* KeyframeAttributeToSVGAttribute(const WTF::String&, Element*);
    static scoped_refptr<TimingFunction> ParseTimingFunction(const WTF::String&, Document*, ExceptionState&);
