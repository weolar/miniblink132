...
public:
    static InterpolationValue ConvertFillSizeSide(const FillSize&, const CSSProperty& property, float zoom, bool convert_width);
    static InterpolationValue MaybeConvertCSSSizeSide(const CSSValue&, bool convert_width);
    ...
    static FillSize CreateFillSize(const InterpolableValue& interpolable_value_a, const NonInterpolableValue* non_interpolable_value_a,
        const InterpolableValue& interpolable_value_b, const NonInterpolableValue* non_interpolable_value_b, const CSSToLengthConversionData&);
};
