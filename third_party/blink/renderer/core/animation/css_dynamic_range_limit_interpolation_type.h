...
class CORE_EXPORT CSSDynamicRangeLimitInterpolationType : public CSSInterpolationType {
public:
    explicit CSSDynamicRangeLimitInterpolationType(PropertyHandle property)
        : CSSInterpolationType(property)
    {
        DCHECK(property.GetCSSProperty().PropertyID() == CSSPropertyID::kDynamicRangeLimit);
    }
