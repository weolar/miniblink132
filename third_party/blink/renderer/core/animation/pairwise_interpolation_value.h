...
struct PairwiseInterpolationValue {
    ...
    PairwiseInterpolationValue(InterpolableValue* start_interpolable_value, InterpolableValue* end_interpolable_value,
        scoped_refptr<const NonInterpolableValue> non_interpolable_value = nullptr)
    ...
    operator bool() const
    {
        return start_interpolable_value.Get();
    }
