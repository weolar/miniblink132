...
TEST(AnimationTimeDeltaTest, Construction)
{
    ...
    EXPECT_EQ(ANIMATION_TIME_DELTA_FROM_SECONDS(5.5), ANIMATION_TIME_DELTA_FROM_MILLISECONDS(5500));
    EXPECT_EQ(ANIMATION_TIME_DELTA_FROM_SECONDS(-2), ANIMATION_TIME_DELTA_FROM_MILLISECONDS(-2000));
}
...
TEST(AnimationTimeDeltaTest, Max)
{
    ...
    EXPECT_EQ(max_delta.InMillisecondsF(), std::numeric_limits<double>::infinity());
}
...
{
    test::TaskEnvironment task_environment;
    EXPECT_EQ(ANIMATION_TIME_DELTA_FROM_SECONDS(4.5) + ANIMATION_TIME_DELTA_FROM_MILLISECONDS(500), ANIMATION_TIME_DELTA_FROM_SECONDS(5));
    EXPECT_EQ(ANIMATION_TIME_DELTA_FROM_SECONDS(100) + ANIMATION_TIME_DELTA_FROM_MILLISECONDS(-850), ANIMATION_TIME_DELTA_FROM_SECONDS(99.15));

    EXPECT_EQ(ANIMATION_TIME_DELTA_FROM_SECONDS(5) * 20, ANIMATION_TIME_DELTA_FROM_SECONDS(100));
    EXPECT_EQ(ANIMATION_TIME_DELTA_FROM_SECONDS(10) * 1.5, ANIMATION_TIME_DELTA_FROM_SECONDS(15));
    EXPECT_EQ(ANIMATION_TIME_DELTA_FROM_SECONDS(2.5) * -2, ANIMATION_TIME_DELTA_FROM_SECONDS(-5));

    EXPECT_EQ(20 * ANIMATION_TIME_DELTA_FROM_SECONDS(5), ANIMATION_TIME_DELTA_FROM_SECONDS(100));
}

TEST(AnimationTimeDeltaTest, Comparison)
{
    test::TaskEnvironment task_environment;
    EXPECT_TRUE(ANIMATION_TIME_DELTA_FROM_SECONDS(10) == ANIMATION_TIME_DELTA_FROM_SECONDS(10));
    EXPECT_TRUE(ANIMATION_TIME_DELTA_FROM_SECONDS(10) != ANIMATION_TIME_DELTA_FROM_SECONDS(50));
    EXPECT_TRUE(ANIMATION_TIME_DELTA_FROM_SECONDS(50) > ANIMATION_TIME_DELTA_FROM_SECONDS(49.999));
    EXPECT_TRUE(ANIMATION_TIME_DELTA_FROM_SECONDS(50) >= ANIMATION_TIME_DELTA_FROM_SECONDS(49.999));
    EXPECT_TRUE(ANIMATION_TIME_DELTA_FROM_SECONDS(50) >= ANIMATION_TIME_DELTA_FROM_SECONDS(50));
    EXPECT_TRUE(ANIMATION_TIME_DELTA_FROM_SECONDS(50) <= ANIMATION_TIME_DELTA_FROM_SECONDS(50));
    EXPECT_TRUE(ANIMATION_TIME_DELTA_FROM_SECONDS(50) <= ANIMATION_TIME_DELTA_FROM_SECONDS(100));
}
