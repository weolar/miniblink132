...
public:
    ...
    static bool GetPixelsForKeyword(const CSSProperty&, CSSValueID, double& result_pixels);
    static bool GetInitialLength(const CSSProperty&, const ComputedStyle& initial_style, Length& result);
    static bool GetLength(const CSSProperty&, const ComputedStyle&, Length& result);
    static bool SetLength(const CSSProperty&, ComputedStyleBuilder&, const Length&);
};
