...
std::optional<double> NumberPropertyFunctions::GetInitialNumber(const CSSProperty& property, const ComputedStyle& initial_style)
{
    return GetNumber(property, initial_style);
}

std::optional<double> NumberPropertyFunctions::GetNumber(const CSSProperty& property, const ComputedStyle& style)
{
...
double NumberPropertyFunctions::ClampNumber(const CSSProperty& property, double value)
{
    switch (property.PropertyID()) {
    case CSSPropertyID::kStrokeMiterlimit:
...
bool NumberPropertyFunctions::SetNumber(const CSSProperty& property, ComputedStyleBuilder& builder, double value)
{
