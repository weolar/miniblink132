...
public:
    virtual void Composite(const BaseInterpolableColor& other, double underlying_fraction) = 0;
    ...
    virtual Color Resolve(const Color& current_color, const Color& active_link_color, const Color& link_color, const Color& text_color,
        mojom::blink::ColorScheme color_scheme) const
        = 0;
};

template <> struct DowncastTraits<BaseInterpolableColor> {
