...
public:
    static std::optional<double> GetInitialNumber(const CSSProperty&, const ComputedStyle& initial_style);
    static std::optional<double> GetNumber(const CSSProperty&, const ComputedStyle&);
