...
public:
    explicit SVGInterpolationEnvironment(const InterpolationTypesMap& map, SVGElement& svg_element, const SVGPropertyBase& svg_base_value)
...
template <> struct DowncastTraits<SVGInterpolationEnvironment> {
