...
public:
    CSSCustomListInterpolationType(PropertyHandle property, const PropertyRegistration* registration,
        std::unique_ptr<CSSInterpolationType> inner_interpolation_type, CSSSyntaxType syntax_type, CSSSyntaxRepeat syntax_repeat)
