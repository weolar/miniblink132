...
public:
    ...
    struct TransitionProperty {
        ...
        TransitionProperty(CSSPropertyID id)
            : property_type(kTransitionKnownProperty)
            , unresolved_property(id)
        {
        ...
        {
            return property_type == other.property_type && unresolved_property == other.unresolved_property && property_string == other.property_string;
        }
    ...
    TransitionPropertyVector& PropertyList()
    {
        return property_list_;
    }
    ...
    TransitionBehaviorVector& BehaviorList()
    {
        return behavior_list_;
    }
