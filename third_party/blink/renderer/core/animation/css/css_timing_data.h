...
public:
    ...
    const DelayVector& DelayStartList() const
    {
        return delay_start_list_;
    }
    const DelayVector& DelayEndList() const
    {
        return delay_end_list_;
    }
    const DurationVector& DurationList() const
    {
    ...
    DelayVector& DelayStartList()
    {
        return delay_start_list_;
    }
    DelayVector& DelayEndList()
    {
        return delay_end_list_;
    }
    DurationVector& DurationList()
    {
        return duration_list_;
    }
    TimingFunctionVector& TimingFunctionList()
    {
        return timing_function_list_;
    }
    ...
    static Timing::Delay InitialDelayStart()
    {
        return Timing::Delay();
    }
    static Timing::Delay InitialDelayEnd()
    {
        return Timing::Delay();
    }
    ...
    template <class T, wtf_size_t C> static const T& GetRepeated(const Vector<T, C>& v, size_t index)
    {
