...
public:
    ...
    const Vector<AtomicString>& NameList() const
    {
        return name_list_;
    }
    const Vector<StyleTimeline>& TimelineList() const
    {
    ...
    Vector<AtomicString>& NameList()
    {
        return name_list_;
    }
    Vector<StyleTimeline>& TimelineList()
    {
        return timeline_list_;
    }
    ...
    Vector<Timing::PlaybackDirection>& DirectionList()
    {
        return direction_list_;
    }
    Vector<Timing::FillMode>& FillModeList()
    {
        return fill_mode_list_;
    }
    Vector<EAnimPlayState>& PlayStateList()
    {
        return play_state_list_;
    }
    ...
    {
        return timeline_list_.size() == 1u && timeline_list_.front() == InitialTimeline();
    }
    bool HasSingleInitialRangeStart() const
    {
        return range_start_list_.size() == 1u && range_start_list_.front() == InitialRangeStart();
    }
    bool HasSingleInitialRangeEnd() const
    {
        return range_end_list_.size() == 1u && range_end_list_.front() == InitialRangeEnd();
    }
    ...
    static Timing::FillMode InitialFillMode()
    {
