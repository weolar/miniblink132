...
class CORE_EXPORT CompositorKeyframeDouble final : public CompositorKeyframeValue {
public:
    CompositorKeyframeDouble(double number)
        : number_(number)
    {
    }
...
template <> struct DowncastTraits<CompositorKeyframeDouble> {
