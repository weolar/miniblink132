...
class CORE_EXPORT CompositorKeyframeTransform final : public CompositorKeyframeValue {
public:
    explicit CompositorKeyframeTransform(const TransformOperations& transform, double zoom)
...
template <> struct DowncastTraits<CompositorKeyframeTransform> {
