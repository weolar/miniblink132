...
template <typename TimelineType> using CSSTimelineMap = HeapHashMap<Member<const ScopedCSSName>, Member<TimelineType>>;
...
using TimelineAttachmentMap = HeapHashMap<Member<ScrollSnapshotTimeline>, Member<DeferredTimeline>>;
