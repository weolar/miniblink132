...
class CORE_EXPORT CompositorKeyframeColor final : public CompositorKeyframeValue {
public:
    CompositorKeyframeColor(SkColor color)
        : color_(color)
    {
    }
    ~CompositorKeyframeColor() override = default;

    SkColor ToColor() const
    {
        return color_;
    }
...
template <> struct DowncastTraits<CompositorKeyframeColor> {
