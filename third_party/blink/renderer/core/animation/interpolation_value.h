...
struct CORE_EXPORT InterpolationValue {
    ...
    explicit InterpolationValue(InterpolableValue* interpolable_value, scoped_refptr<const NonInterpolableValue> non_interpolable_value = nullptr)
