...
// static
String URLFileAPI::createObjectURL(ScriptState* script_state, Blob* blob, ExceptionState& exception_state)
{
    DCHECK(blob);
...
// static
void URLFileAPI::revokeObjectURL(ScriptState* script_state, const String& url_string)
{
    ExecutionContext* execution_context = ExecutionContext::From(script_state);
    DCHECK(execution_context);
...
// static
void URLFileAPI::revokeObjectURL(ExecutionContext* execution_context, const String& url_string)
{
    DCHECK(execution_context);
