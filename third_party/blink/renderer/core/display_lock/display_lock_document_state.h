...
// locking feature.
class CORE_EXPORT DisplayLockDocumentState final : public GarbageCollected<DisplayLockDocumentState> {
public:
    ...
    public:
        ...
        ScopedForceActivatableDisplayLocks& operator=(ScopedForceActivatableDisplayLocks&&);
    ...
    void BeginNodeForcedScope(const Node* node, bool self_was_forced, DisplayLockUtilities::ScopedForcedUpdate::Impl* chain);
    void BeginRangeForcedScope(const Range* range, DisplayLockUtilities::ScopedForcedUpdate::Impl* chain);
    ...
    public:
        ForcedNodeInfo(const Node* node, bool self_forced, DisplayLockUtilities::ScopedForcedUpdate::Impl* chain)
            : chain_(chain)
            , node_(node)
            , self_forced_(self_forced)
        {
        }
    ...
    public:
        ForcedRangeInfo(const Range* range, DisplayLockUtilities::ScopedForcedUpdate::Impl* chain)
            : chain_(chain)
            , range_(range)
        {
        }
...
private:
    ...
    void ProcessDisplayLockActivationObservation(const HeapVector<Member<IntersectionObserverEntry>>&);
...
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::DisplayLockDocumentState::ForcedNodeInfo)
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::DisplayLockDocumentState::ForcedRangeInfo)
