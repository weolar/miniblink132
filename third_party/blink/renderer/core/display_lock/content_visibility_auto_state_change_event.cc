...
ContentVisibilityAutoStateChangeEvent::ContentVisibilityAutoStateChangeEvent(
    const AtomicString& type, const ContentVisibilityAutoStateChangeEventInit* initializer)
    : Event(type, initializer)
    , skipped_(initializer->skipped())
{
}

ContentVisibilityAutoStateChangeEvent::ContentVisibilityAutoStateChangeEvent(const AtomicString& type, bool skipped)
...
const AtomicString& ContentVisibilityAutoStateChangeEvent::InterfaceName() const
{
