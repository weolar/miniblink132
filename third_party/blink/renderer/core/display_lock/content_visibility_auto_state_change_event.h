...
public:
    ...
    static ContentVisibilityAutoStateChangeEvent* Create(const AtomicString& type, bool skipped)
    {
        return MakeGarbageCollected<ContentVisibilityAutoStateChangeEvent>(type, skipped);
    }
    static ContentVisibilityAutoStateChangeEvent* Create(const AtomicString& type, const ContentVisibilityAutoStateChangeEventInit* initializer)
    {
        return MakeGarbageCollected<ContentVisibilityAutoStateChangeEvent>(type, initializer);
    }

    ContentVisibilityAutoStateChangeEvent();
    ContentVisibilityAutoStateChangeEvent(const AtomicString& type, bool skipped);
    ContentVisibilityAutoStateChangeEvent(const AtomicString&, const ContentVisibilityAutoStateChangeEventInit*);
