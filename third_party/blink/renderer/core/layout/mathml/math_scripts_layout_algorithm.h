...
class CORE_EXPORT MathScriptsLayoutAlgorithm : public LayoutAlgorithm<BlockNode, BoxFragmentBuilder, BlockBreakToken> {
public:
...
private:
    void GatherChildren(BlockNode* base, HeapVector<SubSupPair>*, BlockNode* prescripts, unsigned* first_prescript_index, BoxFragmentBuilder* = nullptr) const;
    ...
    VerticalMetrics GetVerticalMetrics(const ChildAndMetrics& base_metrics, const ChildrenAndMetrics& sub_metrics, const ChildrenAndMetrics& sup_metrics) const;
};

} // namespace blink

WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::MathScriptsLayoutAlgorithm::ChildAndMetrics)
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::MathScriptsLayoutAlgorithm::SubSupPair)
