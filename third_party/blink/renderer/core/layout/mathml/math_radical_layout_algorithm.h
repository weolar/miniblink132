...
class CORE_EXPORT MathRadicalLayoutAlgorithm : public LayoutAlgorithm<BlockNode, BoxFragmentBuilder, BlockBreakToken> {
public:
...
private:
    ...
    void GatherChildren(BlockNode* base, BlockNode* index, BoxFragmentBuilder* = nullptr) const;
};
