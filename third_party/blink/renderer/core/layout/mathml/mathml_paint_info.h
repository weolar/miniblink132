...
public:
    MathMLPaintInfo(UChar operator_character, const ShapeResultView* operator_shape_result_view, LayoutUnit operator_inline_size, LayoutUnit operator_ascent,
        LayoutUnit operator_descent, const BoxStrut& radical_base_margins = BoxStrut(),
        const std::optional<LayoutUnit>& radical_operator_inline_offset = std::nullopt)
