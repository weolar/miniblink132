...
class LayoutBoxModelObjectTest : public RenderingTest, public PaintTestConfigurations {
protected:
    ...
    bool HasStickyLayer(const PaintLayerScrollableArea* scrollable_area, const LayoutBoxModelObject* sticky)
    {
        for (const auto& fragment : scrollable_area->GetLayoutBox()->PhysicalFragments()) {
...
TEST_P(LayoutBoxModelObjectTest, LocalCaretRectForEmptyElementVertical)
{
...

    {
        ...
        EXPECT_EQ(PhysicalRect(rl->Size().width - kPaddingRight - kFontHeight, kPaddingTop, kFontHeight, kCaretWidth), rl->LocalCaretRect(0));
    }
    {
        auto* lr = GetLayoutBoxByElementId("target-lr");
        EXPECT_EQ(PhysicalRect(kPaddingLeft, kPaddingTop, kFontHeight, kCaretWidth), lr->LocalCaretRect(0));
    }
    {
        auto* inline_rl = To<LayoutInline>(GetLayoutObjectByElementId("target-inline-rl"));
        EXPECT_EQ(PhysicalRect(LayoutUnit(), kPaddingTop - kCaretWidth, kFontHeight, kCaretWidth), inline_rl->LocalCaretRect(0));
    }
    {
        auto* inline_lr = To<LayoutInline>(GetLayoutObjectByElementId("target-inline-lr"));
        EXPECT_EQ(PhysicalRect(kFontHeight, kPaddingTop - kCaretWidth, kFontHeight, kCaretWidth), inline_lr->LocalCaretRect(0));
    }
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionConstraints)
{
    ...
    scrollable_area->ScrollToAbsolutePosition(gfx::PointF(scrollable_area->ScrollOffsetInt().x(), 50));
    ASSERT_EQ(50.0, scrollable_area->ScrollPosition().y());
    auto* sticky = GetLayoutBoxModelObjectByElementId("sticky");
    ASSERT_EQ(scroller->Layer(), sticky->Layer()->ContainingScrollContainerLayer());
    ...
    // unscrolled scroller.
    ASSERT_EQ(gfx::Rect(15, 115, 170, 370), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    ASSERT_EQ(gfx::Rect(15, 115, 100, 100), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));

    // The sticky constraining rect also doesn't include the border offset.
    ASSERT_EQ(gfx::Rect(0, 0, 400, 100), ToEnclosingRect(constraints->constraining_rect));
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionVerticalRLConstraints)
{
    ...
    // The coordinates of the constraint rects should all be with respect to the
    // unscrolled scroller.
    ASSERT_EQ(gfx::Rect(215, 115, 170, 370), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    ASSERT_EQ(gfx::Rect(285, 115, 100, 100), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionInlineConstraints)
{
    ...
    // The coordinates of the constraint rects should all be with respect to the
    // unscrolled scroller.
    EXPECT_EQ(gfx::Rect(0, 100, 200, 400), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    EXPECT_EQ(gfx::Rect(0, 100, 10, 10), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));
    EXPECT_EQ(gfx::Rect(0, 0, 100, 100), ToEnclosingRect(constraints->constraining_rect));
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionVerticalRLInlineConstraints)
{
    ...
    auto* scroller = GetLayoutBoxModelObjectByElementId("scroller");
    PaintLayerScrollableArea* scrollable_area = scroller->GetScrollableArea();
    scrollable_area->ScrollToAbsolutePosition(gfx::PointF(scrollable_area->ScrollPosition().x(), 50));
    EXPECT_EQ(50.f, scrollable_area->ScrollPosition().y());
    auto* sticky = GetLayoutBoxModelObjectByElementId("sticky");
    ...
    // The coordinates of the constraint rects should all be with respect to the
    // unscrolled scroller.
    EXPECT_EQ(gfx::Rect(2000, 100, 200, 400), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    EXPECT_EQ(gfx::Rect(2190, 100, 10, 10), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));
    EXPECT_EQ(gfx::Rect(0, 0, 100, 100), ToEnclosingRect(constraints->constraining_rect));
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionPercentageStyles)
{
    ...
    if (RuntimeEnabledFeatures::LayoutIgnoreMarginsForStickyEnabled()) {
        ASSERT_EQ(gfx::Rect(25, 125, 200, 350), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    } else {
        ASSERT_EQ(gfx::Rect(25, 145, 200, 330), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    }
    ASSERT_EQ(gfx::Rect(25, 145, 100, 100), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionContainerIsScroller)
{
    ...
    ASSERT_TRUE(constraints);
    EXPECT_TRUE(HasStickyLayer(scrollable_area, sticky));
    ASSERT_EQ(gfx::Rect(0, 0, 400, 1100), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    ASSERT_EQ(gfx::Rect(0, 0, 100, 100), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionAnonymousContainer)
{
    ...
    ASSERT_EQ(gfx::Rect(15, 115, 170, 370), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    ASSERT_EQ(gfx::Rect(15, 165, 100, 100), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionTableContainers)
{
    ...
    EXPECT_EQ(gfx::Rect(0, 0, 50, 100), ToEnclosingRect(constraints->scroll_container_relative_containing_block_rect));
    EXPECT_EQ(gfx::Rect(0, 50, 50, 50), ToEnclosingRect(constraints->scroll_container_relative_sticky_box_rect));
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionConstraintInvalidation)
{
    ...
    EXPECT_EQ(25.f, constraints->scroll_container_relative_sticky_box_rect.X().ToFloat());
    ...
    EXPECT_EQ(50.f, sticky->StickyConstraints()->scroll_container_relative_sticky_box_rect.X().ToFloat());
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionStatusChange)
{
    ...
    auto* scrollable_area = GetLayoutBoxModelObjectByElementId("scroller")->GetScrollableArea();
    ...
    sticky->setAttribute(html_names::kStyleAttr, AtomicString("position: relative"));
    GetDocument().View()->UpdateLifecycleToLayoutClean(DocumentUpdateReason::kTest);
    ASSERT_EQ(sticky_layer, sticky_box->Layer());
    EXPECT_FALSE(HasStickyLayer(scrollable_area, sticky_box));
    EXPECT_FALSE(sticky_box->StickyConstraints());
    ...
    sticky->setAttribute(html_names::kStyleAttr, AtomicString("position: static"));
    GetDocument().View()->UpdateLifecycleToLayoutClean(DocumentUpdateReason::kTest);
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionFindsCorrectStickyBoxShiftingAncestor)
{
    SetBodyInnerHTML(R"HTML(
    ...
    LayoutBoxModelObject* sticky_outer_inline = GetLayoutBoxModelObjectByElementId("stickyOuterInline");
    LayoutBoxModelObject* unanchored_sticky = GetLayoutBoxModelObjectByElementId("unanchoredSticky");
    LayoutBoxModelObject* sticky_inner_inline = GetLayoutBoxModelObjectByElementId("stickyInnerInline");

    PaintLayerScrollableArea* scrollable_area = sticky_outer_div->ContainingScrollContainerLayer()->GetScrollableArea();
    ASSERT_TRUE(scrollable_area);

    ASSERT_TRUE(HasStickyLayer(scrollable_area, sticky_outer_div->GetLayoutBox()));
    auto* outer_div_constraints = sticky_outer_div->GetLayoutObject().StickyConstraints();
    ...
    // containing block.
    EXPECT_FALSE(outer_inline_constraints->nearest_sticky_layer_shifting_sticky_box);
    ...
    // sticky element.
    EXPECT_EQ(sticky_outer_inline, inner_inline_constraints->nearest_sticky_layer_shifting_sticky_box);
}
...
// layer (exclusive).
TEST_P(LayoutBoxModelObjectTest, StickyPositionFindsCorrectContainingBlockShiftingAncestor)
{
    ...
    // shifting ancestor.
    EXPECT_FALSE(parent_constraints->nearest_sticky_layer_shifting_containing_block);
    ...
    EXPECT_EQ(sticky_parent, child_constraints->nearest_sticky_layer_shifting_containing_block);
    EXPECT_EQ(sticky_parent, nested_child_constraints->nearest_sticky_layer_shifting_containing_block);
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionFindsCorrectContainingBlockShiftingAncestorRoot)
{
    SetBodyInnerHTML(R"HTML(
    ...
    PaintLayerScrollableArea* scrollable_area = sticky_parent->Layer()->ContainingScrollContainerLayer()->GetScrollableArea();
    ASSERT_TRUE(scrollable_area);
    ...
    // shifting ancestor.
    EXPECT_EQ(sticky_parent, grandchild_constraints->nearest_sticky_layer_shifting_containing_block);
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionFindsCorrectContainingBlockShiftingAncestorTable)
{
    SetBodyInnerHTML(R"HTML(
    ...
    // shifting ancestor.
    EXPECT_EQ(sticky_outer, th_constraints->nearest_sticky_layer_shifting_containing_block);
}
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionNested)
{
    ...
    auto* scroller = GetLayoutBoxModelObjectByElementId("scroller");
    PaintLayerScrollableArea* scrollable_area = scroller->GetScrollableArea();
    scrollable_area->ScrollToAbsolutePosition(gfx::PointF(scrollable_area->ScrollPosition().x(), 100));
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionNestedStickyTable)
{
    ...
    auto* scroller = GetLayoutBoxModelObjectByElementId("scroller");
    PaintLayerScrollableArea* scrollable_area = scroller->GetScrollableArea();
    scrollable_area->ScrollToAbsolutePosition(gfx::PointF(scrollable_area->ScrollPosition().x(), 150));
    ...
    scrollable_area->ScrollToAbsolutePosition(gfx::PointF(scrollable_area->ScrollPosition().x(), 275));
    ...
    scrollable_area->ScrollToAbsolutePosition(gfx::PointF(scrollable_area->ScrollPosition().x(), 350));
...
TEST_P(LayoutBoxModelObjectTest, StickyPositionNestedFixedPos)
{
    ...
    auto* inner_sticky_bottom = GetLayoutBoxModelObjectByElementId("innerStickyBottom");
    ...
    ASSERT_EQ(scroller->Layer(), outer_sticky->Layer()->ContainingScrollContainerLayer(&is_fixed_to_view));
    ...
    ASSERT_EQ(GetLayoutView().Layer(), inner_sticky_top->Layer()->ContainingScrollContainerLayer(&is_fixed_to_view));
    ASSERT_TRUE(is_fixed_to_view);
    ASSERT_FALSE(HasStickyLayer(scroller_scrollable_area, inner_sticky_top));
    ASSERT_TRUE(HasStickyLayer(view_scrollable_area, inner_sticky_top));
    ASSERT_EQ(GetLayoutView().Layer(), inner_sticky_bottom->Layer()->ContainingScrollContainerLayer(&is_fixed_to_view));
    ASSERT_TRUE(is_fixed_to_view);
    ASSERT_FALSE(HasStickyLayer(scroller_scrollable_area, inner_sticky_top));
    ASSERT_TRUE(HasStickyLayer(view_scrollable_area, inner_sticky_top));
    ...
    EXPECT_FALSE(inner_constraints_top->nearest_sticky_layer_shifting_containing_block);
    auto* inner_constraints_bottom = inner_sticky_bottom->StickyConstraints();
    ASSERT_TRUE(inner_constraints_bottom);
    EXPECT_FALSE(inner_constraints_bottom->nearest_sticky_layer_shifting_sticky_box);
    EXPECT_FALSE(inner_constraints_bottom->nearest_sticky_layer_shifting_containing_block);

    // Scroll the scroller down.
    scroller_scrollable_area->ScrollToAbsolutePosition(gfx::PointF(scroller_scrollable_area->ScrollPosition().x(), 100));
    ...
    EXPECT_EQ(PhysicalOffset(0, -75), inner_sticky_bottom->StickyPositionOffset());

    // Scroll the page down. No StickyPositionOffset() should change because
    // none of the sticky elements scroll with the view.
    view_scrollable_area->ScrollToAbsolutePosition(gfx::PointF(view_scrollable_area->ScrollPosition().x(), 100));
...
TEST_P(LayoutBoxModelObjectTest, InvalidatePaintLayerOnStackedChange)
{
    ...
    auto* original_compositing_container = target->Layer()->CompositingContainer();
    ...
    target_element->setAttribute(html_names::kClassAttr, AtomicString("non-stacked"));
    GetDocument().View()->UpdateLifecycleToLayoutClean(DocumentUpdateReason::kTest);
    ...
    EXPECT_EQ(original_compositing_container, target->Layer()->CompositingContainer());
}

TEST_P(LayoutBoxModelObjectTest, BackfaceVisibilityChange)
{
    AtomicString base_style("width: 100px; height: 100px; background: blue; position: absolute");
    SetBodyInnerHTML("<div id='target' style='" + base_style + "'></div>");

    auto* target = GetElementById("target");
    auto* target_layer = To<LayoutBoxModelObject>(target->GetLayoutObject())->Layer();
    ASSERT_NE(nullptr, target_layer);
    EXPECT_FALSE(target_layer->SelfNeedsRepaint());

    target->setAttribute(html_names::kStyleAttr, AtomicString(base_style + "; backface-visibility: hidden"));
...
TEST_P(LayoutBoxModelObjectTest, ChangingFilterWithWillChange)
{
    ...
    auto* target = GetElementById("target");
    target->setAttribute(html_names::kStyleAttr, AtomicString("filter: grayscale(1)"));
...
TEST_P(LayoutBoxModelObjectTest, ChangingBackdropFilterWithWillChange)
{
    ...
    auto* target = GetElementById("target");
    target->setAttribute(html_names::kStyleAttr, AtomicString("backdrop-filter: grayscale(1)"));
    GetDocument().UpdateStyleAndLayoutTree();
    EXPECT_FALSE(target->GetLayoutObject()->ShouldCheckForPaintInvalidation());
    UpdateAllLifecyclePhasesForTest();
    EXPECT_FALSE(target->GetLayoutObject()->ShouldCheckForPaintInvalidation());
...
TEST_P(LayoutBoxModelObjectTest, StickyParentContainStrictChangeOverflowProperty)
{
    SetBodyInnerHTML(R"HTML(
    ...
    ASSERT_TRUE(constraints);
    EXPECT_EQ(&GetLayoutView(), &constraints->containing_scroll_container_layer->GetLayoutObject());

    GetDocument().body()->setAttribute(html_names::kStyleAttr, AtomicString("overflow: hidden"));
    UpdateAllLifecyclePhasesForTest();
    constraints = sticky->StickyConstraints();
    ASSERT_TRUE(constraints);
    EXPECT_EQ(GetDocument().body()->GetLayoutObject(), &constraints->containing_scroll_container_layer->GetLayoutObject());
...
TEST_P(LayoutBoxModelObjectTest, ChangeStickyStatusUnderContain)
{
    ...
    target->setAttribute(html_names::kStyleAttr, AtomicString("top: 1px; position: sticky"));
    UpdateAllLifecyclePhasesForTest();
    EXPECT_TRUE(target->GetLayoutBox()->StickyConstraints());
    GetLayoutView().GetScrollableArea()->ScrollToAbsolutePosition(gfx::PointF(0, 50));
    ...
    // This should not crash.
    GetLayoutView().GetScrollableArea()->ScrollToAbsolutePosition(gfx::PointF(0, 100));
    UpdateAllLifecyclePhasesForTest();
}
...
TEST_P(LayoutBoxModelObjectTest, RemoveStickyStatusInNestedStickyElementsWithContain)
{
    SetBodyInnerHTML(R"HTML(
    <style>
    ...
    ASSERT_TRUE(child_constraints);
    EXPECT_EQ(container, child_constraints->nearest_sticky_layer_shifting_containing_block.Get());

    GetLayoutView().GetScrollableArea()->ScrollToAbsolutePosition(gfx::PointF(0, 50));

    container_element->setAttribute(html_names::kStyleAttr, AtomicString("position: relative"));
    GetDocument().View()->UpdateLifecycleToLayoutClean(DocumentUpdateReason::kTest);
    ...
    ASSERT_TRUE(child_constraints);
    EXPECT_EQ(body, child_constraints->nearest_sticky_layer_shifting_containing_block.Get());

    // This should not crash.
    GetLayoutView().GetScrollableArea()->ScrollToAbsolutePosition(gfx::PointF(0, 0));
    UpdateAllLifecyclePhasesForTest();
}
