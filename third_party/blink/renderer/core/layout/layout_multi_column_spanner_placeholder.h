...
public:
    ...
    static LayoutMultiColumnSpannerPlaceholder* CreateAnonymous(const ComputedStyle& parent_style, LayoutBox&);
...
template <> struct DowncastTraits<LayoutMultiColumnSpannerPlaceholder> {
