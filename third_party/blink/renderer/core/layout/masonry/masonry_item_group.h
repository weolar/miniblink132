...
using MasonryItemGroups = HeapHashMap<MasonryItemGroupProperties, HeapVector<BlockNode, 16>>;

} // namespace blink

namespace WTF {

template <> struct HashTraits<blink::MasonryItemGroupProperties> : SimpleClassHashTraits<blink::MasonryItemGroupProperties> { };
