...
ControlPart AutoAppearanceFor(const Element& element)
{
    ...
    if (element.IsInUserAgentShadowRoot()) {
        const AtomicString& id_value = element.FastGetAttribute(html_names::kIdAttr);
        if (id_value == shadow_element_names::kIdSliderThumb)
            return kSliderThumbHorizontalPart;
        if (id_value == shadow_element_names::kIdSearchClearButton || id_value == shadow_element_names::kIdClearButton)
        ...
        if (element.ShadowPseudoId() == shadow_element_names::kPseudoMeterInnerElement)
            return kMeterPart;
    }
...
{
    return RuntimeEnabledFeatures::CSSSystemAccentColorEnabled() || RuntimeEnabledFeatures::CSSAccentColorKeywordEnabled();
}
...
//         DEFINE_STATIC_REF(LayoutTheme, layout_theme_mobile, (LayoutThemeMobile::Create()));
...
LayoutTheme::LayoutTheme()
    : has_custom_focus_ring_color_(false)
{
}

ControlPart LayoutTheme::AdjustAppearanceWithAuthorStyle(ControlPart part, const ComputedStyleBuilder& builder)
{
...
ControlPart LayoutTheme::AdjustAppearanceWithElementType(const ComputedStyleBuilder& builder, const Element* element)
{
    ...
    case kBaseSelectPart:
        ...
        return IsA<HTMLSelectElement>(element) || HTMLSelectElement::IsPopoverForAppearanceBase(element) ? part : auto_appearance;
    ...
    case kButtonPart:
        return (auto_appearance == kPushButtonPart || auto_appearance == kSquareButtonPart) ? part : auto_appearance;
    ...
    case kSliderThumbVerticalPart:
        return auto_appearance == kSliderThumbHorizontalPart ? part : auto_appearance;

    case kTextFieldPart:
        if (const auto* input_element = DynamicTo<HTMLInputElement>(*element);
            input_element && input_element->FormControlType() == FormControlType::kInputSearch) {
            return part;
        }
        return auto_appearance;
    }
...
void LayoutTheme::AdjustStyle(const Element* element, ComputedStyleBuilder& builder)
{
    ...
    // which is block)
    if (builder.Display() == EDisplay::kInline || builder.Display() == EDisplay::kInlineTable || builder.Display() == EDisplay::kTableRowGroup
        || builder.Display() == EDisplay::kTableHeaderGroup || builder.Display() == EDisplay::kTableFooterGroup || builder.Display() == EDisplay::kTableRow
        || builder.Display() == EDisplay::kTableColumnGroup || builder.Display() == EDisplay::kTableColumn || builder.Display() == EDisplay::kTableCell
        || builder.Display() == EDisplay::kTableCaption)
        builder.SetDisplay(EDisplay::kInlineBlock);
    else if (builder.Display() == EDisplay::kListItem || builder.Display() == EDisplay::kTable)
        builder.SetDisplay(EDisplay::kBlock);

    ControlPart part = AdjustAppearanceWithAuthorStyle(AdjustAppearanceWithElementType(builder, element), builder);
...
Color LayoutTheme::ActiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
...
Color LayoutTheme::InactiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformInactiveSelectionBackgroundColor(color_scheme).BlendWithWhite();
}

Color LayoutTheme::ActiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformActiveSelectionForegroundColor(color_scheme);
}

Color LayoutTheme::InactiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformInactiveSelectionForegroundColor(color_scheme);
}

Color LayoutTheme::ActiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformActiveListBoxSelectionBackgroundColor(color_scheme);
}

Color LayoutTheme::InactiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformInactiveListBoxSelectionBackgroundColor(color_scheme);
}

Color LayoutTheme::ActiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformActiveListBoxSelectionForegroundColor(color_scheme);
}

Color LayoutTheme::InactiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
...
Color LayoutTheme::PlatformActiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
    // Use a blue color by default if the platform theme doesn't define anything.
    return Color(0, 0, 255);
}

Color LayoutTheme::PlatformActiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
    // Use a white color by default if the platform theme doesn't define anything.
    return Color::kWhite;
}

Color LayoutTheme::PlatformInactiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
...
Color LayoutTheme::PlatformInactiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
    // Use a black color by default.
    return Color::kBlack;
}

Color LayoutTheme::PlatformActiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformActiveSelectionBackgroundColor(color_scheme);
}

Color LayoutTheme::PlatformActiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformActiveSelectionForegroundColor(color_scheme);
}

Color LayoutTheme::PlatformInactiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformInactiveSelectionBackgroundColor(color_scheme);
}

Color LayoutTheme::PlatformInactiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const
{
    return PlatformInactiveSelectionForegroundColor(color_scheme);
}

bool LayoutTheme::IsControlStyled(ControlPart part, const ComputedStyleBuilder& builder) const
{
    switch (part) {
    case kPushButtonPart:
    case kSquareButtonPart:
    ...
    case kMeterPart:
        return RuntimeEnabledFeatures::MeterDevolveAppearanceEnabled() && (builder.HasAuthorBackground() || builder.HasAuthorBorder());

    case kMenulistPart:
    case kSearchFieldPart:
    case kTextAreaPart:
    case kTextFieldPart:
        return builder.HasAuthorBackground() || builder.HasAuthorBorder() || builder.BoxShadow();
...
bool LayoutTheme::ShouldDrawDefaultFocusRing(const Node* node, const ComputedStyle& style) const
{
    if (!node)
        return true;
...
void LayoutTheme::AdjustSliderContainerStyle(const Element& element, ComputedStyleBuilder& builder) const
{
    ...
    if (!IsHorizontalWritingMode(builder.GetWritingMode())) {
    ...
    } else if (RuntimeEnabledFeatures::NonStandardAppearanceValueSliderVerticalEnabled() && builder.EffectiveAppearance() == kSliderVerticalPart) {
        builder.SetTouchAction(TouchAction::kPanX);
        ...
        if (To<HTMLInputElement>(element.OwnerShadowHost())->DataList()) {
            builder.SetAlignSelf(StyleSelfAlignmentData(ItemPosition::kCenter, OverflowAlignment::kUnsafe));
        }
    }
...
void LayoutTheme::AdjustSearchFieldCancelButtonStyle(ComputedStyleBuilder&) const
{
}
...
base::TimeDelta LayoutTheme::CaretBlinkInterval() const
{
    ...
    return WebTestSupport::IsRunningWebTest() ? base::TimeDelta() : caret_blink_interval_;
}

Color LayoutTheme::SystemColor(
    CSSValueID css_value_id, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const
{
    if (color_provider && !WebTestSupport::IsRunningWebTest()) {
        return SystemColorFromColorProvider(css_value_id, color_scheme, color_provider, is_in_web_app_scope);
    }
    return DefaultSystemColor(css_value_id, color_scheme, color_provider, is_in_web_app_scope);
}
    ...
    CSSValueID css_value_id, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const
{
    ...
    case CSSValueID::kAccentcolor:
        return RuntimeEnabledFeatures::CSSAccentColorKeywordEnabled() ? GetAccentColorOrDefault(color_scheme, is_in_web_app_scope) : Color();
    case CSSValueID::kAccentcolortext:
        return RuntimeEnabledFeatures::CSSAccentColorKeywordEnabled() ? GetAccentColorText(color_scheme, is_in_web_app_scope) : Color();
    ...
    case CSSValueID::kWindowframe:
        return color_scheme == mojom::blink::ColorScheme::kDark ? Color::FromRGBA32(0xFF6B6B6B) : Color::FromRGBA32(0xFF767676);
    ...
    case CSSValueID::kThreedface:
        return color_scheme == mojom::blink::ColorScheme::kDark ? Color::FromRGBA32(0xFF6B6B6B) : Color::FromRGBA32(0xFFEFEFEF);
    case CSSValueID::kButtontext:
        return color_scheme == mojom::blink::ColorScheme::kDark ? Color::FromRGBA32(0xFFFFFFFF) : Color::FromRGBA32(0xFF000000);
    ...
    case CSSValueID::kWindow:
        return color_scheme == mojom::blink::ColorScheme::kDark ? Color::FromRGBA32(0xFF121212) : Color::FromRGBA32(0xFFFFFFFF);
    ...
    case CSSValueID::kField:
        return color_scheme == mojom::blink::ColorScheme::kDark ? Color::FromRGBA32(0xFF3B3B3B) : Color::FromRGBA32(0xFFFFFFFF);
    ...
    case CSSValueID::kLinktext:
        return color_scheme == mojom::blink::ColorScheme::kDark ? Color::FromRGBA32(0xFF9E9EFF) : Color::FromRGBA32(0xFF0000EE);
    ...
    case CSSValueID::kVisitedtext:
        return color_scheme == mojom::blink::ColorScheme::kDark ? Color::FromRGBA32(0xFFD0ADF0) : Color::FromRGBA32(0xFF551A8B);
    ...
    case CSSValueID::kInternalSearchColor:
        return PlatformTextSearchHighlightColor(/* active_match */ false,
            /* in_forced_colors */ false, color_scheme, color_provider, is_in_web_app_scope);
    ...
    DUMP_WILL_BE_NOTREACHED() << GetCSSValueName(css_value_id) << " is not a recognized system color";
    return Color();
}
    ...
    CSSValueID css_value_id, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const
{
    ...
    case CSSValueID::kLinktext:
    case CSSValueID::kVisitedtext:
        system_theme_color = color_provider->GetColor(ui::kColorCssSystemHotlight);
        break;
    case CSSValueID::kButtonface:
    case CSSValueID::kButtonhighlight:
    case CSSValueID::kButtonshadow:
    ...
    case CSSValueID::kWindowframe:
        ...
        break;
    case CSSValueID::kGraytext:
        system_theme_color = color_provider->GetColor(ui::kColorCssSystemGrayText);
        break;
    case CSSValueID::kHighlight:
        return SystemHighlightFromColorProvider(color_scheme, color_provider);
    case CSSValueID::kHighlighttext:
        system_theme_color = color_provider->GetColor(ui::kColorCssSystemHighlightText);
        break;
    case CSSValueID::kCanvas:
    case CSSValueID::kField:
    // Deprecated colors, see DefaultSystemColor().
    ...
    case CSSValueID::kMenutext:
    case CSSValueID::kWindowtext:
        system_theme_color = color_provider->GetColor(ui::kColorCssSystemWindowText);
        break;
    default:
        return DefaultSystemColor(css_value_id, color_scheme, color_provider, is_in_web_app_scope);
    }
...
Color LayoutTheme::SystemHighlightFromColorProvider(mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider) const
{
    SkColor system_highlight_color = color_provider->GetColor(ui::kColorCssSystemHighlight);
    return Color::FromSkColor(system_highlight_color).BlendWithWhite();
}

Color LayoutTheme::PlatformTextSearchHighlightColor(
    bool active_match, bool in_forced_colors, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const
{
    if (active_match) {
        if (in_forced_colors) {
            return GetTheme().SystemColor(CSSValueID::kHighlight, color_scheme, color_provider, is_in_web_app_scope);
        }
    ...
    bool active_match, bool in_forced_colors, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const
{
    if (in_forced_colors && active_match) {
        return GetTheme().SystemColor(CSSValueID::kHighlighttext, color_scheme, color_provider, is_in_web_app_scope);
    }
    return Color::kBlack;
}
...
{
    const bool changed = !has_custom_focus_ring_color_ || custom_focus_ring_color_ != c;
...
Color LayoutTheme::FocusRingColor(mojom::blink::ColorScheme color_scheme) const
{
    return has_custom_focus_ring_color_ ? custom_focus_ring_color_ : GetTheme().PlatformFocusRingColor();
}
...
bool LayoutTheme::SupportsCalendarPicker(InputType::Type type) const
{
    ...
    return type == InputType::Type::kTime || type == InputType::Type::kDate || type == InputType::Type::kDateTimeLocal || type == InputType::Type::kMonth
        || type == InputType::Type::kWeek;
}
...
bool LayoutTheme::IsAccentColorCustomized(mojom::blink::ColorScheme color_scheme) const
{
    if (!SystemAccentColorAllowed()) {
        return false;
    }

    return WebThemeEngineHelper::GetNativeThemeEngine()->GetAccentColor().has_value();
}

Color LayoutTheme::GetSystemAccentColor(mojom::blink::ColorScheme color_scheme) const
{
    if (!SystemAccentColorAllowed()) {
        return Color();
    }
    ...
    const auto& accent_color = WebThemeEngineHelper::GetNativeThemeEngine()->GetAccentColor();
...
Color LayoutTheme::GetAccentColorOrDefault(mojom::blink::ColorScheme color_scheme, bool is_in_web_app_scope) const
{
    ...
    // risk.
    if (RuntimeEnabledFeatures::CSSAccentColorKeywordEnabled() && is_in_web_app_scope) {
        accent_color = GetSystemAccentColor(color_scheme);
    }
    return accent_color == Color() ? kDefaultAccentColor : accent_color;
}

Color LayoutTheme::GetAccentColorText(mojom::blink::ColorScheme color_scheme, bool is_in_web_app_scope) const
{
    Color accent_color = GetAccentColorOrDefault(color_scheme, is_in_web_app_scope);
    ...
    return color_utils::GetRelativeLuminance4f(accent_color.toSkColor4f()) <= 128 ? Color::kWhite : Color::kBlack;
}
