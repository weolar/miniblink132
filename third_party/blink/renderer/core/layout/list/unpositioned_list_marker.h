...
public:
    ...
    {
        return marker_layout_object_ != nullptr;
    }
    ...
    std::optional<LayoutUnit> ContentAlignmentBaseline(const ConstraintSpace&, FontBaseline, const PhysicalFragment& content) const;
    // Add a fragment for an outside list marker.
    void AddToBox(const ConstraintSpace&, FontBaseline, const PhysicalFragment& content, const BoxStrut&, const LayoutResult& marker_layout_result,
        LayoutUnit content_baseline, LayoutUnit* block_offset, BoxFragmentBuilder*) const;
    ...
    // marker.
    void AddToBoxWithoutLineBoxes(
        const ConstraintSpace&, FontBaseline, const LayoutResult& marker_layout_result, BoxFragmentBuilder*, LayoutUnit* intrinsic_block_size) const;
    ...
    const LayoutResult* Layout(const ConstraintSpace& parent_space, const ComputedStyle& parent_style, FontBaseline) const;
...
private:
    LayoutUnit ComputeIntrudedFloatOffset(const ConstraintSpace&, const BoxFragmentBuilder*, const BoxStrut&, LayoutUnit) const;
