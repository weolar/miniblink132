...
public:
    ...
    static std::pair<LayoutUnit, LayoutUnit> InlineMarginsForInside(
        Document&, const ComputedStyleBuilder& marker_style_builder, const ComputedStyle& list_item_style);
    static std::pair<LayoutUnit, LayoutUnit> InlineMarginsForOutside(
        Document&, const ComputedStyle& marker_style, const ComputedStyle& list_item_style, LayoutUnit marker_inline_size);

    static PhysicalRect RelativeSymbolMarkerRect(const ComputedStyle&, const AtomicString& list_style, LayoutUnit);
    static LayoutUnit WidthOfSymbol(const ComputedStyle&, const AtomicString& list_style);
...
private:
    enum MarkerTextFormat { kWithPrefixSuffix, kWithoutPrefixSuffix, kAlternativeText };
    enum MarkerTextType {
    ...
    MarkerTextType MarkerText(const LayoutObject&, StringBuilder*, MarkerTextFormat) const;
