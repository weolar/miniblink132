...
public:
    enum BreakTokenType { kBlockBreakToken = LayoutInputNode::kBlock, kInlineBreakToken = LayoutInputNode::kInline };
    BreakTokenType Type() const
    {
        return static_cast<BreakTokenType>(type_);
    }

    bool IsBlockType() const
    {
        return Type() == kBlockBreakToken;
    }
    bool IsInlineType() const
    {
        return Type() == kInlineBreakToken;
    }
    ...
    {
        return LayoutInputNode::Create(box_.Get(), static_cast<LayoutInputNode::LayoutInputNodeType>(type_));
    }
