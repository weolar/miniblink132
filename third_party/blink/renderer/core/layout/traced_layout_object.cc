...
void DumpToTracedValue(const LayoutObject& object, bool trace_geometry, TracedValue* traced_value)
{
    traced_value->SetString("address", String::Format("%" PRIxPTR, reinterpret_cast<uintptr_t>(&object)));
...
std::unique_ptr<TracedValue> TracedLayoutObject::Create(const LayoutView& view, bool trace_geometry)
{
