...
TEST_F(FragmentationTest, MultipleFragmentsNestedMulticol)
{
    ...
    EXPECT_EQ(outer_multicol->GetPhysicalFragment(0)->Size(), PhysicalSize(620, 100));

    EXPECT_EQ(inner_multicol->GetPhysicalFragment(0)->Size(), PhysicalSize(200, 100));
    EXPECT_EQ(inner_multicol->GetPhysicalFragment(1)->Size(), PhysicalSize(200, 100));
    EXPECT_EQ(inner_multicol->GetPhysicalFragment(2)->Size(), PhysicalSize(200, 100));
    EXPECT_EQ(inner_multicol->GetPhysicalFragment(3)->Size(), PhysicalSize(200, 100));
...
TEST_F(FragmentationTest, InkOverflowInline)
{
    ...
    const auto* container = To<LayoutBlockFlow>(GetLayoutObjectByElementId("container"));
