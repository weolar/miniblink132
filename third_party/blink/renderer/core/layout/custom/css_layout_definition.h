...
class CSSLayoutDefinition final : public GarbageCollected<CSSLayoutDefinition>, public NameClient {
public:
    CSSLayoutDefinition(ScriptState*, V8NoArgumentConstructor* constructor, V8IntrinsicSizesCallback* intrinsic_sizes, V8LayoutCallback* layout,
    ...
    public:
        ...
        bool Layout(const ConstraintSpace&, const Document&, const BlockNode&, const LogicalSize& border_box_size, const BoxStrut& border_scrollbar_padding,
            CustomLayoutScope*, FragmentResultOptions*&, scoped_refptr<SerializedScriptValue>* fragment_result_data);
        ...
        bool IntrinsicSizes(const ConstraintSpace&, const Document&, const BlockNode&, const LogicalSize& border_box_size,
            const BoxStrut& border_scrollbar_padding, const LayoutUnit child_available_block_size, CustomLayoutScope*, IntrinsicSizesResultOptions**,
