...
public:
    ...
    ScriptPromise<CustomIntrinsicSizes> intrinsicSizes(ScriptState*, ExceptionState&);
    ScriptPromise<CustomLayoutFragment> layoutNextFragment(ScriptState*, const CustomLayoutConstraintsOptions*, ExceptionState&);
    ...
    void ClearLayoutNode()
    {
        node_ = nullptr;
    }

    void SetCustomLayoutToken(CustomLayoutToken* token)
    {
        token_ = token;
    }
