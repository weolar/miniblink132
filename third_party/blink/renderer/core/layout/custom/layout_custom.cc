...
void LayoutCustom::AddChild(LayoutObject* new_child, LayoutObject* before_child)
{
...
void LayoutCustom::StyleDidChange(StyleDifference diff, const ComputedStyle* old_style)
{
    if (state_ == kUnloaded) {
        ...
        LayoutWorklet::DocumentDefinitionMap* document_definition_map = worklet->GetDocumentDefinitionMap();
