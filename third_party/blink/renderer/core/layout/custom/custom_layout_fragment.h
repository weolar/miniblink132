...
public:
    CustomLayoutFragment(
        CustomLayoutChild*, CustomLayoutToken*, const LayoutResult*, const LogicalSize& size, const std::optional<LayoutUnit> baseline, v8::Isolate*);
    ...
    void setInlineOffset(double inline_offset)
    {
        inline_offset_ = inline_offset;
    }
    void setBlockOffset(double block_offset)
    {
        block_offset_ = block_offset;
    }

    std::optional<double> baseline() const
    {
        return baseline_;
    }
