...
// global scopes.
class CORE_EXPORT LayoutWorklet : public Worklet, public Supplement<LocalDOMWindow> {
public:
    ...
    typedef HeapHashMap<String, Member<DocumentLayoutDefinition>> DocumentDefinitionMap;
