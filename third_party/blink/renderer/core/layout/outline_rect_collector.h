...
public:
    ...
    virtual std::unique_ptr<OutlineRectCollector> ForDescendantCollector() const = 0;
    virtual void Combine(OutlineRectCollector*, const LayoutObject& descendant, const LayoutBoxModelObject* ancestor, const PhysicalOffset& post_offset) = 0;
    virtual void Combine(OutlineRectCollector*, const PhysicalOffset& additional_offset) = 0;
...
public:
    ...
    void Combine(
        OutlineRectCollector* collector, const LayoutObject& descendant, const LayoutBoxModelObject* ancestor, const PhysicalOffset& post_offset) final;
    void Combine(OutlineRectCollector*, const PhysicalOffset& additional_offset) final;
...
public:
    ...
    void AddRect(const PhysicalRect& r) override
    {
        rects_.push_back(r);
    }
    Vector<PhysicalRect> TakeRects()
    {
