...
template <typename SubtreeType, typename GridTreePtr> class GridSubtree {
public:
    explicit operator bool() const
    {
        return static_cast<bool>(grid_tree_);
    }
...
protected:
    ...
    GridSubtree(GridTreePtr grid_tree, wtf_size_t parent_end_index, wtf_size_t subtree_root)
    {
