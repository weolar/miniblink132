...
void LayoutFrameSet::AddChild(LayoutObject* new_child, LayoutObject* before_child)
{
...
CursorDirective LayoutFrameSet::GetCursor(const PhysicalOffset& point, ui::Cursor& cursor) const
{
    NOT_DESTROYED();
