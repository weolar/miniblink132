...
class LayoutViewHitTestTest : public testing::WithParamInterface<HitTestConfig>, public RenderingTest {
public:
...
protected:
    ...
    {
        return GetParam().editing_behavior == mojom::EditingBehavior::kEditingAndroidBehavior
            || GetParam().editing_behavior == mojom::EditingBehavior::kEditingWindowsBehavior
            || GetParam().editing_behavior == mojom::EditingBehavior::kEditingChromeOSBehavior;
    }

    void SetUp() override
    {
        RenderingTest::SetUp();
        GetFrame().GetSettings()->SetEditingBehaviorType(GetParam().editing_behavior);
    }
...
INSTANTIATE_TEST_SUITE_P(All, LayoutViewHitTestTest,
    ::testing::Values(HitTestConfig { mojom::EditingBehavior::kEditingMacBehavior }, HitTestConfig { mojom::EditingBehavior::kEditingWindowsBehavior },
        HitTestConfig { mojom::EditingBehavior::kEditingUnixBehavior }, HitTestConfig { mojom::EditingBehavior::kEditingAndroidBehavior },
...
TEST_P(LayoutViewHitTestTest, BlockInInlineBelowBottom)
{
    ...
    SetBodyInnerHTML("<div id=target>"
                     "<div id=line1>ab</div>"
    ...
    const auto& cd_1 = PositionWithAffinity(Position(cd, 1), TextAffinity::kDownstream);
    const auto& cd_2 = PositionWithAffinity(Position(cd, 2), TextAffinity::kUpstream);
...
TEST_P(LayoutViewHitTestTest, BlockInInlineWithListItem)
{
    ...
    if (IsAndroidOrWindowsOrChromeOSEditingBehavior()) {
        ...
        EXPECT_EQ(PositionWithAffinity(Position(abc, 3), TextAffinity::kUpstream), HitTest(100, 5));
        EXPECT_EQ(PositionWithAffinity(Position(abc, 3), TextAffinity::kUpstream), HitTest(100, 10));
    } else {
        EXPECT_EQ(PositionWithAffinity(Position::BeforeNode(inner)), HitTest(10, 5));
        EXPECT_EQ(PositionWithAffinity(Position::BeforeNode(inner)), HitTest(10, 10));
        EXPECT_EQ(PositionWithAffinity(Position::BeforeNode(inner)), HitTest(100, 5));
        EXPECT_EQ(PositionWithAffinity(Position::BeforeNode(inner)), HitTest(100, 10));
    }
    EXPECT_EQ(PositionWithAffinity(Position(abc, 3), TextAffinity::kUpstream), HitTest(100, 15));
    EXPECT_EQ(PositionWithAffinity(Position(abc, 3), TextAffinity::kUpstream), HitTest(100, 20));
    EXPECT_EQ(PositionWithAffinity(Position(abc, 3), TextAffinity::kUpstream), HitTest(100, 25));
}

TEST_P(LayoutViewHitTestTest, EmptySpan)
{
    LoadAhem();
    InsertStyleElement("body { margin: 0px; font: 10px/10px Ahem; }"
                       "#target { width: 50px; }"
                       "b { border: solid 5px green; }");
    SetBodyInnerHTML("<div id=target>AB<b></b></div>");
    auto& target = *GetElementById("target");
    auto& ab = *To<Text>(target.firstChild());
    const auto after_ab = PositionWithAffinity(Position(ab, 2), TextAffinity::kUpstream);

    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(0, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(5, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(10, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(15, 5));
...
TEST_P(LayoutViewHitTestTest, FlexBlockChildren)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), TextAffinity::kDownstream), HitTest(30, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), TextAffinity::kDownstream), HitTest(35, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(40, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(45, 5));
}
...
TEST_P(LayoutViewHitTestTest, FloatLeftLeft)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), TextAffinity::kDownstream), HitTest(40, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), TextAffinity::kDownstream), HitTest(45, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(50, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(55, 5));
}
...
TEST_P(LayoutViewHitTestTest, FloatLeftMiddle)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(50, 5));
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(55, 5));
}
...
TEST_P(LayoutViewHitTestTest, FloatRightLeft)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), TextAffinity::kDownstream), HitTest(15, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(20, 5)) << "at right of 'xy'";
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(25, 5)) << "right of 'xy'";
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(30, 5)) << "inside float";
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(35, 5)) << "inside float";
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(40, 5)) << "inside float";
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(45, 5)) << "inside float";

    // |HitTestResult| holds <body>.
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(50, 5)) << "at right side of float";
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(55, 5)) << "right of float";
}
...
TEST_P(LayoutViewHitTestTest, FloatRightMiddle)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(20, 5));
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(25, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(30, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(35, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(40, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(45, 5));
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(50, 5));
    EXPECT_EQ(PositionWithAffinity(Position(y, 1), TextAffinity::kUpstream), HitTest(55, 5));
}
...
TEST_P(LayoutViewHitTestTest, FloatRightRight)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 0)), HitTest(5, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 1), TextAffinity::kDownstream), HitTest(15, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(20, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(25, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(30, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(35, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(40, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(45, 5));
...
TEST_P(LayoutViewHitTestTest, PositionAbsolute)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(20, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(25, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(30, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(35, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(40, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 0)), HitTest(45, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(50, 5));
    EXPECT_EQ(PositionWithAffinity(Position(ab, 1), TextAffinity::kDownstream), HitTest(55, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(60, 5));
    EXPECT_EQ(PositionWithAffinity(Position(xy, 2), TextAffinity::kUpstream), HitTest(65, 5));
}
...
TEST_P(LayoutViewHitTestTest, HitTestHorizontal)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text1, 0), TextAffinity::kDownstream), result.GetPosition());
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text2, 3), TextAffinity::kUpstream), result.GetPosition());
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text1, 5), TextAffinity::kUpstream), result.GetPosition());
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text2, 0), TextAffinity::kDownstream), result.GetPosition());
    ...
    EXPECT_EQ(IsAndroidOrWindowsOrChromeOSEditingBehavior() ? PositionWithAffinity(Position(text1, 0), TextAffinity::kDownstream)
...
TEST_P(LayoutViewHitTestTest, HitTestVerticalRL)
{
    ...
    EXPECT_EQ(GetDocument().documentElement(), result.InnerNode());
    EXPECT_EQ(PhysicalOffset(51, 181), result.LocalPoint());
    EXPECT_EQ(IsAndroidOrWindowsOrChromeOSEditingBehavior() ? PositionWithAffinity(Position(text2, 3), TextAffinity::kUpstream)
                                                            : PositionWithAffinity(Position(text2, 3), TextAffinity::kDownstream),
        result.GetPosition());
...
TEST_P(LayoutViewHitTestTest, HitTestVerticalRLRoot)
{
    ...
    EXPECT_EQ(IsAndroidOrWindowsOrChromeOSEditingBehavior() ? PositionWithAffinity(Position(text, 0), TextAffinity::kDownstream)
    ...
    EXPECT_EQ(PhysicalOffset(199, 1), result.LocalPoint());
    EXPECT_EQ(PositionWithAffinity(Position(text, 0), TextAffinity::kDownstream), result.GetPosition());
    ...
    EXPECT_EQ(div, result.InnerNode());
    EXPECT_EQ(PhysicalOffset(199, 51), result.LocalPoint());
    EXPECT_EQ(PositionWithAffinity(Position(text, 5), TextAffinity::kUpstream), result.GetPosition());
    ...
    EXPECT_EQ(IsAndroidOrWindowsOrChromeOSEditingBehavior() ? PositionWithAffinity(Position(text, 5), TextAffinity::kUpstream)
                                                            : PositionWithAffinity(Position(text, 5), TextAffinity::kDownstream),
        result.GetPosition());
}
...
TEST_P(LayoutViewHitTestTest, PseudoElementAfterBlock)
{
    ...
    const auto expected = PositionWithAffinity(IsAndroidOrWindowsOrChromeOSEditingBehavior() ? Position(text_ab, 2) : Position(text_ab, 0),
        IsAndroidOrWindowsOrChromeOSEditingBehavior() ? TextAffinity::kUpstream : TextAffinity::kDownstream);
...
TEST_P(LayoutViewHitTestTest, PseudoElementAfterInline)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text_ab, 1), TextAffinity::kDownstream), HitTest(15, 5));
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 0)), HitTest(25, 5));
    // Because of hit testing at "d", position should be |kDownstream|.
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 1), TextAffinity::kDownstream), HitTest(35, 5));
    // Because of hit testing at right of <span cd>, result position should be
    // |kUpstream|.
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 2), TextAffinity::kUpstream), HitTest(45, 5));
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 2), TextAffinity::kUpstream), HitTest(55, 5));
    EXPECT_EQ(PositionWithAffinity(Position(text_cd, 2), TextAffinity::kUpstream), HitTest(65, 5));
}
...
TEST_P(LayoutViewHitTestTest, ScrolledBlockChildren)
{
    ...
    SetBodyInnerHTML("<div id=sample>"
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text_4, 1), TextAffinity::kUpstream), HitTest(15, 5));
    EXPECT_EQ(PositionWithAffinity(Position(text_5, 1), TextAffinity::kUpstream), HitTest(15, 15));
    EXPECT_EQ(PositionWithAffinity(Position(text_5, 1), TextAffinity::kUpstream), HitTest(15, 25));
    EXPECT_EQ(PositionWithAffinity(Position(text_x, 1), TextAffinity::kUpstream), HitTest(15, 35));
    EXPECT_EQ(PositionWithAffinity(Position(text_6, 1), TextAffinity::kUpstream), HitTest(15, 45));
    EXPECT_EQ(PositionWithAffinity(Position(text_6, 1), TextAffinity::kUpstream), HitTest(15, 55));
}
...
TEST_P(LayoutViewHitTestTest, TextAndInputsWithRtlDirection)
{
    ...
    for (int y : { 0, 25, 49 }) {
        for (int x : { 0, 25 }) {
            EXPECT_EQ(PositionWithAffinity(Position::AfterNode(*input_1), TextAffinity::kUpstream), HitTest(x, y));
        }
        for (int x : { 26, 50, 75 }) {
            EXPECT_EQ(PositionWithAffinity(Position(text_ab, 1), downstream_if_ng), HitTest(x, y));
        }
        for (int x : { 76, 99 }) {
            EXPECT_EQ(PositionWithAffinity(Position(text_ab, 2), TextAffinity::kUpstream), HitTest(x, y));
        }
        for (int x : { 100, 125, 150, 175, 199 }) {
            EXPECT_EQ(PositionWithAffinity(Position(shadow_div_1, 0)), HitTest(x, y));
        }
        EXPECT_EQ(PositionWithAffinity(Position::AfterNode(*input_1)), HitTest(200, y));
    }
    for (int y : { 50, 75, 99 }) {
        ...
        for (int x : { 126, 150, 175 }) {
            EXPECT_EQ(PositionWithAffinity(Position(text_cd, 1), downstream_if_ng), HitTest(x, y));
        }
        for (int x : { 176, 200 }) {
            EXPECT_EQ(PositionWithAffinity(Position::BeforeNode(*input_2)), HitTest(x, y));
        }
    }
    if (IsAndroidOrWindowsOrChromeOSEditingBehavior()) {
        for (int x : { 0, 25, 50, 75, 99 }) {
            EXPECT_EQ(PositionWithAffinity(Position::AfterNode(*input_2)), HitTest(x, 100));
        }
        for (int x : { 100, 125 }) {
            EXPECT_EQ(PositionWithAffinity(Position(text_cd, 0)), HitTest(x, 100));
        }
        for (int x : { 126, 150, 175 }) {
            EXPECT_EQ(PositionWithAffinity(Position(text_cd, 1), downstream_if_ng), HitTest(x, 100));
        }
        for (int x : { 176, 200 }) {
            EXPECT_EQ(PositionWithAffinity(Position::BeforeNode(*input_2)), HitTest(x, 100));
        }
    } else {
...
{
    LoadAhem();
    InsertStyleElement("body { margin: 0px; font: 100px/110px Ahem; }"
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text_01234, 5), TextAffinity::kUpstream), HitTest(100, 150));
...
TEST_P(LayoutViewHitTestTest, TextCombineTwoTextNodes)
{
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text_012, 3), TextAffinity::kUpstream), HitTest(60, 150));
    ...
    EXPECT_EQ(PositionWithAffinity(Position(text_34, 2), TextAffinity::kUpstream), HitTest(100, 150));
