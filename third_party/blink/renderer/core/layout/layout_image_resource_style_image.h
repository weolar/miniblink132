...
public:
    ...
    {
        return style_image_->ErrorOccurred();
    }
    ...
    gfx::SizeF ConcreteObjectSize(float multiplier, const gfx::SizeF& default_object_size) const override;
    ...
    WrappedImagePtr ImagePtr() const override
    {
        return style_image_->Data();
    }
