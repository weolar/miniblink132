...
TEST_F(LayoutThemeTest, SystemColorWithColorScheme)
{
    ...
    EXPECT_EQ(Color(0xef, 0xef, 0xef), style->VisitedDependentColor(GetCSSPropertyColor()));
    ...
    EXPECT_EQ(Color(0x6b, 0x6b, 0x6b), style->VisitedDependentColor(GetCSSPropertyColor()));
}

TEST_F(LayoutThemeTest, SetSelectionColors)
{
    LayoutTheme::GetTheme().SetSelectionColors(Color::kBlack, Color::kBlack, Color::kBlack, Color::kBlack);
    EXPECT_EQ(Color::kBlack, LayoutTheme::GetTheme().ActiveSelectionForegroundColor(mojom::blink::ColorScheme::kLight));
    {
        ...
        LayoutTheme::GetTheme().SetSelectionColors(Color::kWhite, Color::kWhite, Color::kWhite, Color::kWhite);
        EXPECT_EQ(Color::kWhite, LayoutTheme::GetTheme().ActiveSelectionForegroundColor(mojom::blink::ColorScheme::kLight));
    }
    EXPECT_EQ(Color::kWhite, LayoutTheme::GetTheme().ActiveSelectionForegroundColor(mojom::blink::ColorScheme::kLight));
}
...
TEST_F(LayoutThemeTest, SetSelectionColorsNoInvalidation)
{
    ...
    EXPECT_EQ(GetDocument().documentElement()->GetStyleChangeType(), StyleChangeType::kNoStyleChange);
    EXPECT_EQ(Color::kWhite, LayoutTheme::GetTheme().ActiveSelectionForegroundColor(mojom::blink::ColorScheme::kLight));
