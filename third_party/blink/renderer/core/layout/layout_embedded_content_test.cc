...
TEST_F(LayoutEmbeddedContentTest, FreozenSizeReplacedContentRect)
{
    ...
    element->setAttribute(html_names::kSrcAttr, AtomicString("http://example.com/"));
    element->SetInlineStyleProperty(CSSPropertyID::kObjectFit, CSSValueID::kContain);
    ...
    EXPECT_EQ(layout_object->ReplacedContentRect(), PhysicalRect(32, 2, 240, 150));
}
