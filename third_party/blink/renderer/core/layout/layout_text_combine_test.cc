...
protected:
    std::string AsInkOverflowString(const LayoutBlockFlow& root)
    {
        ...
        for (InlineCursor cursor(root); cursor; cursor.MoveToNext()) {
            ...
            ostream << "                 Rect " << cursor.CurrentItem()->RectInContainerFragment() << std::endl;
            ostream << "          InkOverflow " << cursor.CurrentItem()->InkOverflowRect() << std::endl;
            ostream << "      SelfInkOverflow " << cursor.CurrentItem()->SelfInkOverflowRect() << std::endl;
            ostream << "  ContentsInkOverflow " << ContentsInkOverflow(*cursor.CurrentItem()) << std::endl;
        }
        return ostream.str();
    }
...
{
    InsertStyleElement("#root { text-combine-upright: all; writing-mode: vertical-rl; }");
...
LayoutBlockFlow DIV id="root"
  ...
  |  +--LayoutBR BR id="target"
    ...
    target.style()->setProperty(GetDocument().GetExecutionContext(), "color", "red", "", ASSERT_NO_EXCEPTION);
    RunDocumentLifecycle();
...
TEST_F(LayoutTextCombineTest, HtmlElement)
{
    ...
    GetDocument().documentElement()->appendChild(Text::Create(GetDocument(), "X"));
...
{
    LoadAhem();
    InsertStyleElement("body { font: 100px/110px Ahem; }"
                       "c { text-combine-upright: all; }"
                       "div { writing-mode: vertical-rl; }");
    SetBodyInnerHTML("<div id=root>a<c id=combine>0123456789</c>b</div>");
    const auto& root = *To<LayoutBlockFlow>(GetElementById("root")->GetLayoutObject());
...
{Text 2-3 LTR Standard}
  ...
  ContentsInkOverflow "0,0 0x0"
    ...
    const auto& text_combine = *To<LayoutTextCombine>(GetElementById("combine")->GetLayoutObject()->SlowFirstChild());
    EXPECT_EQ(R"DUMP(
...
{
    InsertStyleElement("br { text-combine-upright: all; writing-mode: vertical-rl; }");
    SetBodyInnerHTML("<div id=root>x</div>");
    auto& root = *GetElementById("root");
    root.insertBefore(MakeGarbageCollected<HTMLBRElement>(GetDocument()), root.lastChild());
    RunDocumentLifecycle();
...
TEST_F(LayoutTextCombineTest, ScrollableOverflow)
{
    ...
    SetBodyInnerHTML("<div id=t1><tcy>abcefgh</tcy>X</div>"
                     "<div id=t2>aX</div>");
    ...
    EXPECT_EQ(PhysicalRect(PhysicalOffset(), PhysicalSize(150, 200)), sample_fragment1.ScrollableOverflow());
    ...
    EXPECT_EQ(PhysicalRect(PhysicalOffset(), PhysicalSize(150, 200)), sample_fragment2.ScrollableOverflow());
}

// http://crbug.com/1223015
TEST_F(LayoutTextCombineTest, ListItemStyleToImage)
{
    InsertStyleElement("li { text-combine-upright: all; }"
...
LayoutBlockFlow OL id="root"
  ...
  |  |  |  +--LayoutTextFragment (anonymous) ("1. ")
    ...
    root.style()->setProperty(GetDocument().GetExecutionContext(), "list-style-image",
        "url(data:image/"
...
TEST_F(LayoutTextCombineTest, Outline)
{
    ...
    sample1.AddOutlineRects(collector, nullptr, PhysicalOffset(), OutlineType::kDontIncludeBlockInkOverflow);
    Vector<PhysicalRect> standard_outlines1 = collector.TakeRects();
    EXPECT_THAT(standard_outlines1, ElementsAre(PhysicalRect(PhysicalOffset(0, 0), PhysicalSize(150, 200))));

    sample1.AddOutlineRects(collector, nullptr, PhysicalOffset(), OutlineType::kIncludeBlockInkOverflow);
    Vector<PhysicalRect> focus_outlines1 = collector.TakeRects();
    EXPECT_THAT(focus_outlines1,
        ElementsAre(PhysicalRect(PhysicalOffset(0, 0), PhysicalSize(150, 200)),
            // tcy
            PhysicalRect(PhysicalOffset(25, 0), PhysicalSize(100, 100)), PhysicalRect(PhysicalOffset(20, 0), PhysicalSize(110, 100)),
            // "X"
            PhysicalRect(PhysicalOffset(25, 100), PhysicalSize(100, 100)), PhysicalRect(PhysicalOffset(25, 100), PhysicalSize(100, 100))));

    // Sample 1 without text-combine-upright:all
    const auto& sample2 = *GetLayoutObjectByElementId("t2");
    sample2.AddOutlineRects(collector, nullptr, PhysicalOffset(), OutlineType::kDontIncludeBlockInkOverflow);
    Vector<PhysicalRect> standard_outlines2 = collector.TakeRects();
    EXPECT_THAT(standard_outlines2, ElementsAre(PhysicalRect(PhysicalOffset(0, 0), PhysicalSize(150, 100))));

    sample1.AddOutlineRects(collector, nullptr, PhysicalOffset(), OutlineType::kIncludeBlockInkOverflow);
    Vector<PhysicalRect> focus_outlines2 = collector.TakeRects();
    EXPECT_THAT(focus_outlines2,
        ElementsAre(PhysicalRect(PhysicalOffset(0, 0), PhysicalSize(150, 200)),
            // "a"
            PhysicalRect(PhysicalOffset(25, 0), PhysicalSize(100, 100)), PhysicalRect(PhysicalOffset(20, 0), PhysicalSize(110, 100)),
            // "X"
...
{
    InsertStyleElement("body { writing-mode: horizontal-tb; }"
                       "html {"
                       "text-combine-upright: all;"
                       "writing-mode: vertical-lr;"
                       "}");
    ...
    // Make |Text| node child in <html> element to call
    // |HTMLHtmlElement::PropagateWritingModeAndDirectionFromBody()|
    GetDocument().documentElement()->insertBefore(Text::Create(GetDocument(), "X"), GetDocument().body());
...
{
    InsertStyleElement("body { writing-mode: vertical-rl; }"
                       "html {"
                       "text-combine-upright: all;"
...
{
    InsertStyleElement("details { text-combine-upright: all; writing-mode: vertical-rl;  }");
...
LayoutBlockFlow DETAILS id="root"
  ...
  |  |  +--LayoutText #text "cd"
    ...
    root.style()->setProperty(GetDocument().GetExecutionContext(), "color", "red", "important", ASSERT_NO_EXCEPTION);
    RunDocumentLifecycle();
...
{
    InsertStyleElement("div { text-combine-upright: all; }"
                       "div { writing-mode: vertical-rl; }");
...
LayoutBlockFlow DIV id="root"
  ...
  +--LayoutText #text "de"
    ...
    To<Text>(GetElementById("combine")->firstChild())->splitText(0, ASSERT_NO_EXCEPTION);
    RunDocumentLifecycle();
    EXPECT_EQ(R"DUMP(
LayoutBlockFlow DIV id="root"
  +--LayoutText #text "ab"
...
LayoutBlockFlow DIV id="root"
  ...
  +--LayoutText #text "de"
    ...
    GetElementById("combine")->setAttribute(html_names::kStyleAttr, AtomicString("text-combine-upright: all"));
    RunDocumentLifecycle();
    EXPECT_EQ(R"DUMP(
LayoutBlockFlow DIV id="root"
  +--LayoutText #text "ab"
...
LayoutBlockFlow DIV id="root"
  ...
  +--LayoutText #text "de"
    ...
    GetElementById("combine")->setAttribute(html_names::kStyleAttr, AtomicString("text-combine-upright: none"));
    RunDocumentLifecycle();
    EXPECT_EQ(R"DUMP(
LayoutBlockFlow DIV id="root"
  +--LayoutText #text "ab"
...
LayoutBlockFlow DIV id="root"
  ...
  +--LayoutText #text "de"
    ...
    root.setAttribute(html_names::kStyleAttr, AtomicString("writing-mode: horizontal-tb"));
    RunDocumentLifecycle();
    EXPECT_EQ(R"DUMP(
...
{
    InsertStyleElement("wbr { text-combine-upright: all; }"
                       "div { writing-mode: vertical-rl; }");
...
LayoutBlockFlow DIV id="root"
  ...
  +--LayoutText #text "de"
    ...
    root.setAttribute(html_names::kStyleAttr, AtomicString("writing-mode: vertical-rl"));
    RunDocumentLifecycle();
    EXPECT_EQ(R"DUMP(
...
{
    InsertStyleElement("#sample {  text-combine-upright: all; writing-mode: vertical-rl; }");
    SetBodyInnerHTML("<br id=sample>");
    const auto& root_layout_object = *To<LayoutBlockFlow>(GetDocument().body()->GetLayoutObject());
...
{
    InsertStyleElement("c { text-combine-upright: all; -webkit-rtl-ordering: visual; }"
                       "div { writing-mode: vertical-rl; }");
    SetBodyInnerHTML("<div id=root>ab<c id=combine>XY</c>de</div>");
    const auto& root_layout_object = *To<LayoutBlockFlow>(GetElementById("root")->GetLayoutObject());
...
{
    InsertStyleElement("q { text-combine-upright: all; }"
                       "div { writing-mode: vertical-rl; }");
...
{
    InsertStyleElement("c { text-combine-upright: all; white-space: pre; }"
                       "div { writing-mode: vertical-rl; }");
    SetBodyInnerHTML("<div id=root>ab<c id=combine>X\tY</c>de</div>");
    const auto& root_layout_object = *To<LayoutBlockFlow>(GetElementById("root")->GetLayoutObject());
...
TEST_F(LayoutTextCombineTest, WithTextIndent)
{
    ...
    EXPECT_EQ(PhysicalRect(0, 0, 60, 20), cursor.Current().RectInContainerFragment());
}
...
{
    InsertStyleElement("div { writing-mode: horizontal-tb; }"
                       "tcy { text-combine-upright: all; }");
