...
public:
    ...
    {
        return *To<LayoutBlockFlow>(GetDocument().body()->GetLayoutObject())->GetPhysicalFragment(0);
    }
...
TEST_F(PhysicalBoxFragmentTest, OverflowClipMarginVisualBox)
{
    ...
    EXPECT_EQ(layout_box->GetPhysicalFragment(0)->InkOverflowRect(), PhysicalRect(zero_offset, PhysicalSize(LayoutUnit(75), LayoutUnit(35))));
    EXPECT_EQ(layout_box->GetPhysicalFragment(1)->InkOverflowRect(), PhysicalRect(zero_offset, PhysicalSize(LayoutUnit(75), LayoutUnit(40))));

    GetElementById("test")->SetInlineStyleProperty(CSSPropertyID::kOverflowClipMargin, "padding-box 15px");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(layout_box->GetPhysicalFragment(0)->InkOverflowRect(), PhysicalRect(zero_offset, PhysicalSize(LayoutUnit(80), LayoutUnit(35))));
    EXPECT_EQ(layout_box->GetPhysicalFragment(1)->InkOverflowRect(), PhysicalRect(zero_offset, PhysicalSize(LayoutUnit(80), LayoutUnit(45))));

    GetElementById("test")->SetInlineStyleProperty(CSSPropertyID::kOverflowClipMargin, "border-box 15px");
    UpdateAllLifecyclePhasesForTest();
    EXPECT_EQ(layout_box->GetPhysicalFragment(0)->InkOverflowRect(), PhysicalRect(zero_offset, PhysicalSize(LayoutUnit(85), LayoutUnit(35))));
    EXPECT_EQ(layout_box->GetPhysicalFragment(1)->InkOverflowRect(), PhysicalRect(zero_offset, PhysicalSize(LayoutUnit(85), LayoutUnit(50))));
}
...
TEST_F(PhysicalBoxFragmentTest, CloneWithPostLayoutFragments)
{
    ...
    const auto* clone = PhysicalBoxFragment::CloneWithPostLayoutFragments(fragment);
