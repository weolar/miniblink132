...
public:
    ...
    bool IsAccentColorCustomized(mojom::blink::ColorScheme color_scheme) const override;
    Color GetSystemAccentColor(mojom::blink::ColorScheme color_scheme) const override;
    Color SystemHighlightFromColorProvider(mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider) const override;
