...
public:
    ...
    {
        const LayoutBlockFlow* container = To<LayoutBlockFlow>(element.GetLayoutObject());
...
struct AnchorTestData {
    static Vector<AnchorTestData> ToList(const PhysicalAnchorQuery& anchor_query)
    {
        ...
        std::sort(items.begin(), items.end(), [](const AnchorTestData& a, const AnchorTestData& b) { return CodeUnitCompare(a.name, b.name) < 0; });
        return items;
    }
...
TEST_F(AnchorEvaluatorImplTest, AnchorNameAdd)
{
    ...
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--div1a"), PhysicalRect(0, 0, 50, 20) }));
}
...
TEST_F(AnchorEvaluatorImplTest, AnchorNameChange)
{
    ...
    const PhysicalAnchorQuery* anchor_query = AnchorQuery(*container);
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--div1"), PhysicalRect(0, 0, 50, 20) }));
...
TEST_F(AnchorEvaluatorImplTest, BlockFlow)
{
    ...
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::UnorderedElementsAre(AnchorTestData { AtomicString("--div1"), PhysicalRect(0, 0, 400, 20) },
            AnchorTestData { AtomicString("--div2"), PhysicalRect(0, 20, 800, 0) }, AnchorTestData { AtomicString("--div3"), PhysicalRect(0, 50, 800, 0) }));
    ...
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::UnorderedElementsAre(AnchorTestData { AtomicString("--div1"), PhysicalRect(0, 0, 400, 40) },
            AnchorTestData { AtomicString("--div2"), PhysicalRect(0, 40, 800, 0) }, AnchorTestData { AtomicString("--div3"), PhysicalRect(0, 70, 800, 0) }));
}
...
TEST_F(AnchorEvaluatorImplTest, Inline)
{
    ...
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::UnorderedElementsAre(AnchorTestData { AtomicString("--culled"), PhysicalRect(20, 0, 20, 10) },
            AnchorTestData { AtomicString("--img"), PhysicalRect(110, 0, 10, 8) },
            AnchorTestData { AtomicString("--inline-block"), PhysicalRect(130, 0, 10, 10) },
            AnchorTestData { AtomicString("--non-culled"), PhysicalRect(50, 0, 20, 10) }));
    ...
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query),
        testing::UnorderedElementsAre(AnchorTestData { AtomicString("--add"), PhysicalRect(80, 0, 20, 10) },
            AnchorTestData { AtomicString("--culled"), PhysicalRect(20, 0, 20, 10) }, AnchorTestData { AtomicString("--img"), PhysicalRect(110, 0, 10, 8) },
            AnchorTestData { AtomicString("--inline-block"), PhysicalRect(130, 0, 10, 10) },
            AnchorTestData { AtomicString("--non-culled"), PhysicalRect(50, 0, 20, 10) }));
}
...
TEST_F(AnchorEvaluatorImplTest, OutOfFlow)
{
    ...
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--abs1"), PhysicalRect(100, 50, 400, 20) }));
...
TEST_F(AnchorEvaluatorImplTest, Relative)
{
    ...
    const PhysicalAnchorQuery* anchor_query = AnchorQueryByElementId("container");
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--relpos"), PhysicalRect(20, 10, 800, 0) }));
}
...
TEST_F(AnchorEvaluatorImplTest, Transform)
{
    ...
    const PhysicalAnchorQuery* anchor_query = AnchorQueryByElementId("container");
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--transform"), PhysicalRect(0, 0, 800, 0) }));
}
...
TEST_F(AnchorEvaluatorImplTest, Scroll)
{
    ...
    const PhysicalAnchorQuery* anchor_query = AnchorQuery(*container);
    ASSERT_NE(anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--inner"), PhysicalRect(0, 0, 400, 500) }));
}
...
TEST_F(AnchorEvaluatorImplTest, FragmentedContainingBlock)
{
    ...
    EXPECT_THAT(AnchorTestData::ToList(*cb_anchor_query1), testing::ElementsAre(AnchorTestData { AtomicString("--a1"), PhysicalRect(0, 50, 100, 50) }));
    ...
    EXPECT_THAT(AnchorTestData::ToList(*cb_anchor_query2), testing::ElementsAre(AnchorTestData { AtomicString("--a1"), PhysicalRect(0, 0, 100, 50) }));

    const PhysicalAnchorQuery* columns_anchor_query = AnchorQueryByElementId("columns");
    ASSERT_NE(columns_anchor_query, nullptr);
    EXPECT_THAT(AnchorTestData::ToList(*columns_anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--a1"), PhysicalRect(110, 0, 210, 100) }));

    const PhysicalAnchorQuery* container_anchor_query = AnchorQueryByElementId("container");
    ASSERT_NE(container_anchor_query, nullptr);
    EXPECT_THAT(
        AnchorTestData::ToList(*container_anchor_query), testing::ElementsAre(AnchorTestData { AtomicString("--a1"), PhysicalRect(110, 10, 210, 100) }));
}
