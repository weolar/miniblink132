...
class CORE_EXPORT LayoutImageResource : public GarbageCollected<LayoutImageResource> {
public:
    LayoutImageResource();
    ...
    virtual gfx::SizeF ConcreteObjectSize(float multiplier, const gfx::SizeF& default_object_size) const;
