...
// layout and/or paint.
class AnchorPositionScrollData : public GarbageCollected<AnchorPositionScrollData>, public ScrollSnapshotClient, public ElementRareDataField {
public:
    explicit AnchorPositionScrollData(Element* anchored_element);
    virtual ~AnchorPositionScrollData();

    Element* AnchoredElement() const
    {
        return anchored_element_.Get();
    }
    ...
    bool IsAnchorPositionScrollData() const override
    {
        return true;
    }

    AnchorPositionVisibilityObserver& EnsureAnchorPositionVisibilityObserver();
    AnchorPositionVisibilityObserver* GetAnchorPositionVisibilityObserver() const
    {
...
private:
    ...
    AdjustmentData ComputeAdjustmentContainersData(const LayoutObject& anchor) const;
...
template <> struct DowncastTraits<AnchorPositionScrollData> {
