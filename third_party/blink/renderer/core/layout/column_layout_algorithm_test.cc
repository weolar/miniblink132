...
{
    LoadAhem();
    InsertStyleElement("body { font: 10px/20px Ahem; }"
                       "#multicol1, #multicol2 { columns: 3; }");
    SetBodyInnerHTML("<div contenteditable id=single></div>"
...
TEST_F(ColumnLayoutAlgorithmTest, EmptyEditableWithFloat)
{
    ...
    InsertStyleElement("body { font: 10px/20px Ahem; }"
                       ...
                       "#multicol1, #multicol2 { columns: 3; }");
    SetBodyInnerHTML("<div contenteditable id=single><float></float></div>"
...
TEST_F(ColumnLayoutAlgorithmTest, EmptyMulticol)
{
    ...
    ConstraintSpace space
        = ConstructBlockLayoutTestConstraintSpace({ WritingMode::kHorizontalTb, TextDirection::kLtr }, LogicalSize(LayoutUnit(1000), kIndefiniteSize));
    const PhysicalBoxFragment* parent_fragment = BaseLayoutAlgorithmTest::RunBlockLayoutAlgorithm(container, space);
...
TEST_F(ColumnLayoutAlgorithmTest, LinesInMulticolChildInsufficientSpaceForFirst)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #parent {
...
TEST_F(ColumnLayoutAlgorithmTest, ColumnBalancingFixedHeightOverflowingContent)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      #parent {
...
TEST_F(ColumnLayoutAlgorithmTest, ColumnBalancing100By3)
{
    ...
    const PhysicalBoxFragment* parent_fragment = RunBlockLayoutAlgorithm(GetElementById("container"));
...
TEST_F(ColumnLayoutAlgorithmTest, NoClassCBreakPointBeforeBlockMarginCollapsing)
{
...
TEST_F(ColumnLayoutAlgorithmTest, IgnoreBreakInsideAvoidBecauseBreakBetweenAvoid)
{
