...
struct SerializedAnchor {
    ...
    SerializedAnchor(const ScrollAnchorData& data, const ScrollableArea& scroller);
...
private:
    ...
    struct ExamineResult {
        explicit ExamineResult(WalkStatus s)
            : status(s)
            , corner(Corner::kTopLeft)
        {
