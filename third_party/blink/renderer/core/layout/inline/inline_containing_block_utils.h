...
public:
    ...
    using InlineContainingBlockMap = HashMap<Persistent<const LayoutObject>, std::optional<InlineContainingBlockGeometry>>;
    ...
    static void ComputeInlineContainerGeometry(InlineContainingBlockMap* inline_containing_block_map, BoxFragmentBuilder* container_builder);
