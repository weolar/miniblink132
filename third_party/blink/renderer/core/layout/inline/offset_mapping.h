...
public:
    OffsetMappingUnit(OffsetMappingUnitType, const LayoutObject&, unsigned dom_start, unsigned dom_end, unsigned text_content_start, unsigned text_content_end);
...
public:
    ...
    using RangeMap = HeapHashMap<Member<const Node>, std::pair<unsigned, unsigned>>;
    ...
    public:
        ...
        LayoutObjectConverter(const OffsetMapping* offset_mapping, const LayoutObject& layout_object)
    ...
    base::span<const OffsetMappingUnit> GetMappingUnitsForNode(const Node& node) const;
    ...
    base::span<const OffsetMappingUnit> GetMappingUnitsForLayoutObject(const LayoutObject& layout_object) const;
    ...
    base::span<const OffsetMappingUnit> GetMappingUnitsForTextContentOffsetRange(unsigned start, unsigned end) const;
...
template <> struct VectorTraits<blink::OffsetMappingUnit> : VectorTraitsBase<blink::OffsetMappingUnit> {
