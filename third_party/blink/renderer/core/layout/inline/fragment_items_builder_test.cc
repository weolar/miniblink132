...
TEST_F(FragmentItemsBuilderTest, MultipleLogicalLineItems)
{
    ...
    const PhysicalLineBoxFragment* line_fragment1 = cursor.Current()->LineBoxFragment();
    cursor.MoveToNextLine();
    const PhysicalLineBoxFragment* line_fragment2 = cursor.Current()->LineBoxFragment();
    ...
    InlineNode inline_node(container);
    {
        ...
        // 3. |AddLine|.
        FragmentItemsBuilder items_builder(inline_node, { WritingMode::kHorizontalTb, TextDirection::kLtr }, false);
        auto* line_container1 = items_builder.AcquireLogicalLineContainer();
        items_builder.AssociateLogicalLineContainer(line_container1, *line_fragment1);
        items_builder.AddLine(*line_fragment1, LogicalOffset());
        auto* line_container2 = items_builder.AcquireLogicalLineContainer();
        items_builder.AssociateLogicalLineContainer(line_container2, *line_fragment2);
