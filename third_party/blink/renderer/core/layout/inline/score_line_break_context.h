...
public:
    LineInfoList& GetLineInfoList()
    {
        return line_info_list_;
    }

    LineBreakPoints& GetLineBreakPoints()
    {
        return line_break_points_;
    }
    wtf_size_t LineBreakPointsIndex()
    {
        return line_break_points_index_;
    }
...
//
template <wtf_size_t max_lines> class CORE_EXPORT ScoreLineBreakContextOf : public ScoreLineBreakContext {
public:
    ScoreLineBreakContextOf()
        : ScoreLineBreakContext(line_info_list_instance_)
    {
    }
...
inline const LineBreakPoint* ScoreLineBreakContext::CurrentLineBreakPoint() const
{
