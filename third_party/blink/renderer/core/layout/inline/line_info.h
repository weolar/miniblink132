...
public:
    ...
    void SetLineStyle(const InlineNode&, const InlineItemsData&, bool use_first_line_style);
    void OverrideLineStyle(const ComputedStyle& style)
    {
        line_style_ = style;
    }
    ...
    {
        return is_first_formatted_line_;
    }
    void SetIsFirstFormattedLine(bool value)
    {
        is_first_formatted_line_ = value;
    }
    ...
    {
        return is_last_line_;
    }
    void SetIsLastLine(bool is_last_line)
    {
        is_last_line_ = is_last_line;
    }
    ...
    {
        return has_line_even_if_empty_;
    }
    void SetHasLineEvenIfEmpty()
    {
        has_line_even_if_empty_ = true;
    }
    ...
    InlineItemResults* MutableResults()
    {
        return &results_;
    }
    const InlineItemResults& Results() const
    {
        return results_;
    }

    const InlineBreakToken* GetBreakToken() const
    {
        return break_token_;
    }
    ...
    // break.
    bool IsEndParagraph() const
    {
        return !GetBreakToken() || HasForcedBreak();
    }
    ...
    void SetTextIndent(LayoutUnit indent)
    {
        text_indent_ = indent;
    }
    LayoutUnit TextIndent() const
    {
        return text_indent_;
    }
    ...
    {
        return width_.ClampNegativeToZero();
    }
    ...
    bool HasTrailingSpaces() const
    {
        return has_trailing_spaces_;
    }
    void SetHasTrailingSpaces()
    {
        has_trailing_spaces_ = true;
    }
    ...
    {
        return has_overflow_;
    }
    void SetHasOverflow(bool value = true)
    {
        has_overflow_ = value;
    }
    ...
    const InlineItemTextIndex& Start() const
    {
        return start_;
    }
    unsigned StartOffset() const
    {
        return start_.text_offset;
    }
    void SetStart(const InlineItemTextIndex& index)
    {
        start_ = index;
    }
    ...
    unsigned EndItemIndex() const
    {
        return end_item_index_;
    }
    void SetEndItemIndex(unsigned index)
    {
        end_item_index_ = index;
    }
    ...
    // justify alignment.
    bool NeedsAccurateEndPosition() const
    {
        return needs_accurate_end_position_;
    }
    ...
    // computation.
    bool MayHaveRubyOverhang() const
    {
        return may_have_ruby_overhang_;
    }
    void SetMayHaveRubyOverhang()
    {
    ...
    // letter box.
    LayoutUnit ComputeTotalBlockSize(LayoutUnit line_height, LayoutUnit annotation_overflow_block_end) const;
...
private:
    ...
    LayoutUnit ComputeTrailingSpaceWidth(unsigned* end_offset_out = nullptr) const;
