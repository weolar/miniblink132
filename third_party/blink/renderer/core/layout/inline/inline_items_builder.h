...
template <typename MappingBuilder> class InlineItemsBuilderTemplate {
    STACK_ALLOCATED();

public:
    // Create a builder that appends items to |items|.
    InlineItemsBuilderTemplate(LayoutBlockFlow* block_flow, HeapVector<InlineItem>* items, const String& previous_text_content = String(),
    ...
    bool HasBidiControls() const
    {
        return has_bidi_controls_;
    }

    bool IsBlockLevel() const
    {
        return is_block_level_;
    }
    ...
    bool HasUnicodeBidiPlainText() const
    {
        return has_unicode_bidi_plain_text_;
    }
    ...
    bool AppendTextReusing(const InlineNodeData& previous_data, LayoutText* layout_text);
    ...
    // not exist.
    InlineItem& AppendOpaque(InlineItem::InlineItemType, UChar, LayoutObject* = nullptr);
    ...
    void EnterBidiContext(LayoutObject*, const ComputedStyle*, UChar ltr_enter, UChar rtl_enter, UChar exit);
    ...
    MappingBuilder& GetOffsetMappingBuilder()
    {
        return mapping_builder_;
    }
...
private:
    ...
    void AppendCollapseWhitespace(const TransformedString&, const ComputedStyle*, LayoutText*);
    void AppendPreserveWhitespace(const TransformedString&, const ComputedStyle*, LayoutText*);
    void AppendPreserveNewline(const TransformedString&, const ComputedStyle*, LayoutText*);

    void AppendForcedBreakCollapseWhitespace(LayoutObject*);
    void AppendForcedBreak(LayoutObject*);
    bool AppendTextChunks(const TransformedString& transformed, LayoutText& layout_text);
    void AppendTransformedString(const TransformedString& transformed, const LayoutText& layout_text);
    ...
    InlineItem& AppendTextItem(InlineItem::InlineItemType type, const TransformedString&, LayoutText* layout_object);
    ...
    bool ShouldInsertBreakOpportunityAfterLeadingPreservedSpaces(StringView, const ComputedStyle&, unsigned index = 0) const;
    void InsertBreakOpportunityAfterLeadingPreservedSpaces(const TransformedString&, const ComputedStyle&, LayoutText*, unsigned* start);

    friend class InlineItemsBuilderTest;
};

template <> CORE_EXPORT bool InlineItemsBuilderTemplate<OffsetMappingBuilder>::AppendTextReusing(const InlineNodeData&, LayoutText*);

template <> CORE_EXPORT bool InlineItemsBuilderTemplate<OffsetMappingBuilder>::ShouldUpdateLayoutObject() const;

template <> CORE_EXPORT void InlineItemsBuilderTemplate<OffsetMappingBuilder>::ClearInlineFragment(LayoutObject*);

template <> CORE_EXPORT void InlineItemsBuilderTemplate<OffsetMappingBuilder>::ClearNeedsLayout(LayoutObject*);

template <> CORE_EXPORT void InlineItemsBuilderTemplate<OffsetMappingBuilder>::UpdateShouldCreateBoxFragment(LayoutInline*);

extern template class CORE_EXTERN_TEMPLATE_EXPORT InlineItemsBuilderTemplate<EmptyOffsetMappingBuilder>;
extern template class CORE_EXTERN_TEMPLATE_EXPORT InlineItemsBuilderTemplate<OffsetMappingBuilder>;

using InlineItemsBuilder = InlineItemsBuilderTemplate<EmptyOffsetMappingBuilder>;
using InlineItemsBuilderForOffsetMapping = InlineItemsBuilderTemplate<OffsetMappingBuilder>;

} // namespace blink

WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::InlineItemsBuilder::BidiContext)
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::InlineItemsBuilderForOffsetMapping::BidiContext)
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::InlineItemsBuilder::BoxInfo)
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::InlineItemsBuilderForOffsetMapping::BoxInfo)
