...
public:
    ...
    LogicalLineItems& BaseLine() const
    {
        return *base_line_;
    }
    ...
    public:
        ...
        void Trace(Visitor* visitor) const
        {
            visitor->Trace(line_items);
        }
        LogicalLineItems* operator->() const
        {
            return line_items.Get();
        }
    };
...
WTF_ALLOW_CLEAR_UNUSED_SLOTS_WITH_MEM_FUNCTIONS(blink::LogicalLineContainer::AnnotationLine)
