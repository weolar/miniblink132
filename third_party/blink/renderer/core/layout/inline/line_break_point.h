...
public:
    ...
    LineBreakPoint(const InlineItemTextIndex& offset, const InlineItemTextIndex& end, bool is_hyphenated = false)
        : offset(offset)
        , end(end)
        , is_hyphenated(is_hyphenated)
    {
    }
    explicit LineBreakPoint(const InlineItemTextIndex& offset, bool is_hyphenated = false)
    ...
    {
        return offset == other.offset && end == other.end && is_hyphenated == other.is_hyphenated;
    }
