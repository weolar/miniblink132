...
{
    const InlineCaretPosition caret_position = ComputeInlineCaretPosition(position);
...
bool InSameNGLineBox(const PositionWithAffinity& position1, const PositionWithAffinity& position2)
{
