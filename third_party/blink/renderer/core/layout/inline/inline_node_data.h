...
template <typename OffsetMappingBuilder> class InlineItemsBuilderTemplate;
...
public:
    ...
    bool HasNonOrc16BitCharacters() const
    {
        return has_non_orc_16bit_;
    }
    bool IsBidiEnabled() const
    {
        return is_bidi_enabled_;
    }
    ...
    {
        return has_initial_letter_box_;
    }
    bool HasRuby() const
    {
        return has_ruby_;
    ...
    {
        return !is_first_line || !first_line_items_ ? (const InlineItemsData&)*this : *first_line_items_;
    }
...
private:
    ...
    template <typename OffsetMappingBuilder> friend class InlineItemsBuilderTemplate;
