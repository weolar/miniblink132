...
public:
    ...
    // created.
    LayoutUnit TruncateLine(LayoutUnit line_width, LogicalLineItems* line_box, InlineLayoutStateStack* box_states);

    LayoutUnit TruncateLineInTheMiddle(LayoutUnit line_width, LogicalLineItems* line_box, InlineLayoutStateStack* box_states);
...
private:
    ...
    LayoutUnit PlaceEllipsisNextTo(LogicalLineItems* line_box, LogicalLineItem* ellipsized_child);
    ...
    //                         copied.
    wtf_size_t AddTruncatedChild(wtf_size_t source_index, bool leave_one_character, LayoutUnit position, TextDirection edge, LogicalLineItems* line_box,
        InlineLayoutStateStack* box_states);
    bool EllipsizeChild(
        LayoutUnit line_width, LayoutUnit ellipsis_width, bool is_first_child, LogicalLineItem*, std::optional<LogicalLineItem>* truncated_child);
    bool TruncateChild(LayoutUnit space_for_this_child, bool is_first_child, const LogicalLineItem& child, std::optional<LogicalLineItem>* truncated_child);
    ...
    LogicalLineItem TruncateText(const LogicalLineItem& item, const ShapeResult& shape_result, unsigned offset_to_fit, TextDirection direction);
