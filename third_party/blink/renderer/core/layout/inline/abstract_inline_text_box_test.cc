...
TEST_F(AbstractInlineTextBoxTest, GetTextWithLineBreakAtMiddleCollapsedWhiteSpace)
{
...
TEST_F(AbstractInlineTextBoxTest, GetTextWithLineBreakAtSpanCollapsedWhiteSpace)
{
    ...
    EXPECT_EQ(nullptr, inline_text_box2) << "We don't have inline box when <span> "
...
TEST_F(AbstractInlineTextBoxTest, HeapCompactionNoCrash)
{
    ...
    const Element& div = *GetElementById("div");
    auto* inline_text_box = To<LayoutText>(div.firstChild()->GetLayoutObject())->FirstAbstractInlineTextBox();
