...
public:
    ...
    virtual bool IsControlStyled(ControlPart part, const ComputedStyleBuilder&) const;
    ...
    Color ActiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    Color InactiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    Color ActiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;
    Color InactiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;
    virtual void SetSelectionColors(
    ...
    Color ActiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    Color ActiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;
    Color InactiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    Color InactiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;
    ...
    Color PlatformTextSearchHighlightColor(bool active_match, bool in_forced_colors, mojom::blink::ColorScheme color_scheme,
        const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const;
    Color PlatformTextSearchColor(bool active_match, bool in_forced_colors, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider,
    ...
    virtual Color SystemColor(CSSValueID, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const;
    ...
    virtual int PopupInternalPaddingTop(const ComputedStyle&) const
    {
        return 0;
    }
    ...
    virtual bool PopsMenuByReturnKey() const
    {
        return true;
    }
    ...
    virtual bool IsAccentColorCustomized(mojom::blink::ColorScheme color_scheme) const;

    // GetSystemAccentColor returns transparent unless there is a special value
    // from the OS color scheme.
    virtual Color GetSystemAccentColor(mojom::blink::ColorScheme color_scheme) const;
    ...
    Color GetAccentColorOrDefault(mojom::blink::ColorScheme color_scheme, bool is_in_web_app_scope) const;
    ...
    Color GetAccentColorText(mojom::blink::ColorScheme color_scheme, bool is_in_web_app_scope) const;

    virtual Color SystemHighlightFromColorProvider(mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider) const;

protected:
    // The platform selection color.
    virtual Color PlatformActiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    virtual Color PlatformInactiveSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    virtual Color PlatformActiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;
    virtual Color PlatformInactiveSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;

    virtual Color PlatformActiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    virtual Color PlatformInactiveListBoxSelectionBackgroundColor(mojom::blink::ColorScheme color_scheme) const;
    virtual Color PlatformActiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;
    virtual Color PlatformInactiveListBoxSelectionForegroundColor(mojom::blink::ColorScheme color_scheme) const;
    ...
    virtual void AdjustSliderContainerStyle(const Element&, ComputedStyleBuilder&) const;
    ...
    Color DefaultSystemColor(CSSValueID, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const;
    Color SystemColorFromColorProvider(
        CSSValueID, mojom::blink::ColorScheme color_scheme, const ui::ColorProvider* color_provider, bool is_in_web_app_scope) const;
...
private:
    ...
    ControlPart AdjustAppearanceWithAuthorStyle(ControlPart part, const ComputedStyleBuilder& style);

    ControlPart AdjustAppearanceWithElementType(const ComputedStyleBuilder&, const Element*);
    ...
    static constexpr Color kDefaultTapHighlightColor = Color::FromRGBA32(0x66000000);

    static constexpr Color kDefaultCompositionBackgroundColor = Color::FromRGBA32(0xFFFFDD55);
};
