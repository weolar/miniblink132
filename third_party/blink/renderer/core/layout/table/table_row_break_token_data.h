...
struct TableRowBreakTokenData final : BlockBreakTokenData {
    TableRowBreakTokenData(const BlockBreakTokenData* break_token_data, LayoutUnit previous_consumed_row_block_size)
...
template <> struct DowncastTraits<TableRowBreakTokenData> {
