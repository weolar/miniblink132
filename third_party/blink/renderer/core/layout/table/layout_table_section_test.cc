...
TEST_F(LayoutTableSectionTest, BackgroundIsKnownToBeOpaqueWithLayerAndCollapsedBorder)
{
    ...
    EXPECT_TRUE(section);
    EXPECT_FALSE(section->BackgroundIsKnownToBeOpaqueInRect(PhysicalRect(0, 0, 1, 1)));
}
...
TEST_F(LayoutTableSectionTest, VisualOverflowWithCollapsedBorders)
{
    ...
    EXPECT_EQ(section->PhysicalBorderBoxRect(), section->SelfVisualOverflowRect());
    ...
    expected_visual_overflow.ExpandEdges(LayoutUnit(3), LayoutUnit(8), LayoutUnit(8), LayoutUnit(8));
