...
struct TableBreakTokenData final : BlockBreakTokenData {
    TableBreakTokenData(const BlockBreakTokenData* break_token_data, const TableTypes::Rows& rows,
        const TableTypes::CellBlockConstraints& cell_block_constraints, const TableTypes::Sections& sections, LayoutUnit total_table_min_block_size,
        LayoutUnit consumed_table_box_block_size, bool has_entered_table_box, bool is_past_table_box)
...
template <> struct DowncastTraits<TableBreakTokenData> {
