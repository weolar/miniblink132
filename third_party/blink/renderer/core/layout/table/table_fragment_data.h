...
public:
    ...
    public:
        ColumnGeometry(wtf_size_t start_column, wtf_size_t span, LayoutUnit inline_offset, LayoutUnit inline_size, LayoutInputNode node)
...
#if DCHECK_IS_ON()
        void CheckSameForSimplifiedLayout(const CollapsedBordersGeometry& other) const
        {
...
WTF_ALLOW_MOVE_INIT_AND_COMPARE_WITH_MEM_FUNCTIONS(blink::TableFragmentData::ColumnGeometry)
