...
struct CORE_EXPORT BfcRect {
    ...
    LayoutUnit LineStartOffset() const
    {
        return start_offset.line_offset;
    }
    LayoutUnit LineEndOffset() const
    {
        return end_offset.line_offset;
    }
    LayoutUnit BlockStartOffset() const
    {
        return start_offset.block_offset;
    }
    LayoutUnit BlockEndOffset() const
    {
        return end_offset.block_offset;
    }
    ...
    LayoutUnit InlineSize() const
    {
        if (end_offset.line_offset == LayoutUnit::Max()) {
            return start_offset.line_offset == LayoutUnit::Max() ? LayoutUnit() : LayoutUnit::Max();
        }
