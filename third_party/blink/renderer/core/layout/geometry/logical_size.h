...
struct CORE_EXPORT LogicalSize {
    ...
    {
        return LogicalSize(inline_size.ClampNegativeToZero(), block_size.ClampNegativeToZero());
    }

    LogicalSize ClampIndefiniteToZero() const
    {
        return LogicalSize(inline_size.ClampIndefiniteToZero(), block_size.ClampIndefiniteToZero());
    }
};
...
inline LogicalOffset operator+(const LogicalOffset& offset, const LogicalSize& size)
{
    return { offset.inline_offset + size.inline_size, offset.block_offset + size.block_size };
}

inline LogicalOffset& operator+=(LogicalOffset& offset, const LogicalSize& size)
{
    offset = offset + size;
    return offset;
}
...
public:
    ...
    constexpr operator LogicalOffset() const
    {
