...
struct CORE_EXPORT FlexOffset {
    ...
    constexpr FlexOffset(LayoutUnit main_axis_offset, LayoutUnit cross_axis_offset)
    ...
    {
        return main_axis_offset == other.main_axis_offset && cross_axis_offset == other.cross_axis_offset;
    }
    constexpr bool operator!=(const FlexOffset& other) const
    {
