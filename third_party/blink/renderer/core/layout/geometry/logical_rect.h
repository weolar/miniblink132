...
struct CORE_EXPORT LogicalRect {
    ...
    constexpr LogicalRect(LayoutUnit inline_offset, LayoutUnit block_offset, LayoutUnit inline_size, LayoutUnit block_size)
    ...
    constexpr LogicalRect(int inline_offset, int block_offset, int inline_size, int block_size);
    ...
    void ExpandEdges(LayoutUnit block_start, LayoutUnit inline_end, LayoutUnit block_end, LayoutUnit inline_start)
    {
    ...
    void ContractEdges(LayoutUnit block_start, LayoutUnit inline_end, LayoutUnit block_end, LayoutUnit inline_start)
    {
    ...
    {
        const LogicalOffset offset(LayoutUnit::FromFloatFloor(rect.x()), LayoutUnit::FromFloatFloor(rect.y()));
        const LogicalSize size(LayoutUnit::FromFloatCeil(rect.right()) - offset.inline_offset, LayoutUnit::FromFloatCeil(rect.bottom()) - offset.block_offset);
