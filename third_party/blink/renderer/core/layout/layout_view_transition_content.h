...
public:
    ...
    void OnIntrinsicSizeUpdated(const gfx::RectF& captured_rect, const gfx::RectF& border_box_rect, bool propagate_max_extent_rect);
...
template <> struct DowncastTraits<LayoutViewTransitionContent> {
