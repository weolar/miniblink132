...
public:
    ...
    {
        return IsBlock() && box_->IsLayoutBlockFlow();
    }
    bool IsBlockInInline() const
    {
        return box_->IsBlockInInline();
    }
    bool IsCustom() const
    {
        return IsBlock() && box_->IsLayoutCustom();
    }
    ...
    {
        return IsBlock() && box_->IsFloating();
    }
    ...
    bool IsView() const
    {
        return IsBlock() && box_->IsLayoutView();
    }
    ...
    {
        return IsBlock() && box_->IsFlexibleBox();
    }
    bool IsGrid() const
    {
        return IsBlock() && box_->IsLayoutGrid();
    }
    bool IsMasonry() const
    {
        return IsBlock() && box_->IsLayoutMasonry();
    }
    ...
    {
        return IsBlock() && box_->IsLayoutListItem();
    }
    ...
    {
        return IsBlock() && box_->IsFieldset();
    }
    bool IsInitialLetterBox() const
    {
        return box_->IsInitialLetterBox();
    }
    bool IsMedia() const
    {
        return box_->IsMedia();
    ...
    bool IsTable() const
    {
        return IsBlock() && box_->IsTable();
    }
    bool IsTextCombine() const
    {
        return box_->IsLayoutTextCombine();
    }

    bool IsTableCaption() const
    {
        return IsBlock() && box_->IsTableCaption();
    }
    bool IsTableSection() const
    {
        return IsBlock() && box_->IsTableSection();
    }
    bool IsTableRow() const
    {
        return IsBlock() && box_->IsTableRow();
    }
    ...
    {
        return box_->IsTextArea();
    }
    bool IsTextControl() const
    {
        return box_->IsTextControl();
    }
    bool IsTextControlPlaceholder() const;
    bool IsTextField() const
    {
        return box_->IsTextField();
    }

    bool IsMathRoot() const
    {
        return box_->IsMathMLRoot();
    }
    bool IsMathML() const
    {
        return box_->IsMathML();
    }
    ...
    bool UseParentPercentageResolutionBlockSizeForChildren() const
    {
        ...
        if (IsBlock() && layout_block) {
            return LayoutBoxUtils::SkipContainingBlockForPercentHeightCalculation(layout_block);
        }
    ...
    void IntrinsicSize(std::optional<LayoutUnit>* computed_inline_size, std::optional<LayoutUnit>* computed_block_size) const;
    ...
    Node* EnclosingDOMNode() const
    {
        return box_->EnclosingNode();
    }
...
protected:
    ...
    void GetOverrideIntrinsicSize(std::optional<LayoutUnit>* computed_inline_size, std::optional<LayoutUnit>* computed_block_size) const;
