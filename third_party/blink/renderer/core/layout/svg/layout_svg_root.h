...
public:
    ...
    void UnscaledIntrinsicSizingInfo(const SVGRect* override_viewbox, IntrinsicSizingInfo&) const;
...
private:
    ...
    void PaintReplaced(const PaintInfo&, const PhysicalOffset& paint_offset) const override;

    void WillBeDestroyed() override;
    void StyleDidChange(StyleDifference, const ComputedStyle* old_style) override;
    bool IsChildAllowed(LayoutObject*, const ComputedStyle&) const override;
    void AddChild(LayoutObject* child, LayoutObject* before_child = nullptr) override;
    ...
    bool HitTestChildren(HitTestResult&, const HitTestLocation& location_in_container, const PhysicalOffset& accumulated_offset, HitTestPhase) override;
...
template <> struct DowncastTraits<LayoutSVGRoot> {
