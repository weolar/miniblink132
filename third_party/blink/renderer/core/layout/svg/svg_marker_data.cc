...
void SVGMarkerDataBuilder::UpdateFromPathElement(void* info, const PathElement& element)
{
...
Vector<PathSegmentData> MarkerPathSegmentProcessor::DecomposeArc(const PathSegmentData& segment)
{
    ...
    public:
        ...
        Vector<PathSegmentData> ReturnSegments()
        {
...
void MarkerPathSegmentProcessor::EmitSegment(const PathSegmentData& original_segment)
{
...
SVGMarkerDataBuilder::AngleType SVGMarkerDataBuilder::DetermineAngleType(bool ends_subpath) const
{
...
void SVGMarkerDataBuilder::ComputeQuadTangents(SegmentData& data, const gfx::PointF& start, const gfx::PointF& control, const gfx::PointF& end)
{
...
SVGMarkerDataBuilder::SegmentData SVGMarkerDataBuilder::ExtractPathElementFeatures(const PathElement& element) const
{
    SegmentData data;
