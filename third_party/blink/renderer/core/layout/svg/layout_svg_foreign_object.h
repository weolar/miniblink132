...
public:
    ...
    bool NodeAtPointFromSVG(HitTestResult& result, const HitTestLocation& hit_test_location, const PhysicalOffset& accumulated_offset, HitTestPhase phase);
...
private:
    ...
    bool IsChildAllowed(LayoutObject* child, const ComputedStyle& style) const override;
...
template <> struct DowncastTraits<LayoutSVGForeignObject> {
