...
public:
    ...
    bool ApplyShader(
        const SVGResourceClient&, const gfx::RectF& reference_box, const AffineTransform* additional_transform, const AutoDarkMode&, cc::PaintFlags&) override;
...
private:
    ...
    std::unique_ptr<PatternData> BuildPatternData(const gfx::RectF& object_bounding_box);
    ...
    using PatternMap = HeapHashMap<Member<const SVGResourceClient>, std::unique_ptr<PatternData>>;
