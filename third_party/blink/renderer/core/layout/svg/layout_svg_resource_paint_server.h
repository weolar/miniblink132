...
public:
    ...
    virtual bool ApplyShader(const SVGResourceClient&, const gfx::RectF& reference_box, const AffineTransform* additional_transform,
        const AutoDarkMode& auto_dark_mode, cc::PaintFlags&)
        = 0;
...
template <> struct DowncastTraits<LayoutSVGResourcePaintServer> {
