...
protected:
    ...
    bool UpdateAfterSVGLayout(const SVGLayoutInfo&, SVGTransformChange transform_change, bool bbox_changed);
    ...
    virtual SVGTransformChange UpdateLocalTransform(const gfx::RectF& reference_box);
...
template <> struct DowncastTraits<LayoutSVGContainer> {
