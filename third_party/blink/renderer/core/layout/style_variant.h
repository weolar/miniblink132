...
enum class StyleVariant : uint8_t { kStandard = 0, kFirstLine = 1, kStandardEllipsis = 2, kFirstLineEllipsis = 3 };

inline bool UsesFirstLineStyle(StyleVariant variant)
{
    return static_cast<uint8_t>(variant) & static_cast<uint8_t>(StyleVariant::kFirstLine);
}

inline bool IsEllipsis(StyleVariant variant)
{
    return static_cast<uint8_t>(variant) & static_cast<uint8_t>(StyleVariant::kStandardEllipsis);
}
...
inline StyleVariant ToParentStyleVariant(StyleVariant variant)
{
    ...
    return static_cast<StyleVariant>(static_cast<uint8_t>(variant) & ~static_cast<uint8_t>(StyleVariant::kStandardEllipsis));
}
