...
TEST(ConstraintSpaceBuilderTest, AvailableSizeFromHorizontalICB)
{
    ...
    ConstraintSpaceBuilder horizontal_builder(WritingMode::kHorizontalTb, { WritingMode::kHorizontalTb, TextDirection::kLtr },
        /* is_new_fc */ true);
    ...
    ConstraintSpaceBuilder vertical_builder(horizontal_builder.ToConstraintSpace(), { WritingMode::kVerticalLr, TextDirection::kLtr },
        /* is_new_fc */ true);
...
TEST(ConstraintSpaceBuilderTest, AvailableSizeFromVerticalICB)
{
    ...
    ConstraintSpaceBuilder horizontal_builder(WritingMode::kVerticalLr, { WritingMode::kVerticalLr, TextDirection::kLtr },
        /* is_new_fc */ true);
    LogicalSize fixed_size { LayoutUnit(100), LayoutUnit(200) };
    LogicalSize indefinite_size { kIndefiniteSize, kIndefiniteSize };
    ...
    ConstraintSpaceBuilder vertical_builder(horizontal_builder.ToConstraintSpace(), { WritingMode::kHorizontalTb, TextDirection::kLtr },
        /* is_new_fc */ true);
