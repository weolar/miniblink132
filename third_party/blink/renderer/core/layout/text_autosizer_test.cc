...
public:
    ...
    gfx::Rect LocalRootToScreenDIPs(const gfx::Rect& rect, const LocalFrameView*) const override
    {
...
class TextAutosizerTest : public RenderingTest, public testing::WithParamInterface<bool>, private ScopedTextSizeAdjustImprovementsForTest {
public:
    TextAutosizerTest()
    ...
    {
        DEFINE_STATIC_LOCAL(Persistent<TextAutosizerClient>, client, (MakeGarbageCollected<TextAutosizerClient>()));
        return *client;
    }
    void set_device_scale_factor(float device_scale_factor)
    {
...
private:
    void SetUp() override
    {
        ...
        GetDocument().GetSettings()->SetTextAutosizingWindowSizeOverride(gfx::Size(320, 480));
    }
};
...
TEST_P(TextAutosizerTest, SimpleParagraph)
{
    ...
    EXPECT_FLOAT_EQ(16.f, autosized->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    // (specified font-size = 16px) * (viewport width = 800px) /
    // (window width = 320px) = 40px.
    EXPECT_FLOAT_EQ(40.f, autosized->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, TextSizeAdjustDisablesAutosizing)
{
    ...
    LayoutObject* text_size_adjust_auto = GetLayoutObjectByElementId("textSizeAdjustAuto");
    ...
    LayoutObject* text_size_adjust_none = GetLayoutObjectByElementId("textSizeAdjustNone");
    ...
    LayoutObject* text_size_adjust100 = GetLayoutObjectByElementId("textSizeAdjust100");
...
TEST_P(TextAutosizerTest, ParagraphWithChangingTextSizeAdjustment)
{
    ...
    EXPECT_FLOAT_EQ(16.f, autosized_div->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    EXPECT_FLOAT_EQ(40.f, autosized_div->GetLayoutObject()->StyleRef().ComputedFontSize());

    autosized_div->setAttribute(html_names::kClassAttr, AtomicString("none"));
    UpdateAllLifecyclePhasesForTest();
    EXPECT_FLOAT_EQ(16.f, autosized_div->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    EXPECT_FLOAT_EQ(16.f, autosized_div->GetLayoutObject()->StyleRef().ComputedFontSize());

    autosized_div->setAttribute(html_names::kClassAttr, AtomicString("small"));
    UpdateAllLifecyclePhasesForTest();
    EXPECT_FLOAT_EQ(16.f, autosized_div->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    EXPECT_FLOAT_EQ(8.f, autosized_div->GetLayoutObject()->StyleRef().ComputedFontSize());

    autosized_div->setAttribute(html_names::kClassAttr, AtomicString("large"));
    UpdateAllLifecyclePhasesForTest();
    EXPECT_FLOAT_EQ(16.f, autosized_div->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    EXPECT_FLOAT_EQ(24.f, autosized_div->GetLayoutObject()->StyleRef().ComputedFontSize());
...
TEST_P(TextAutosizerTest, ZeroTextSizeAdjustment)
{
    ...
    LayoutObject* text_size_adjust_zero = GetElementById("textSizeAdjustZero")->GetLayoutObject();
...
TEST_P(TextAutosizerTest, NegativeTextSizeAdjustment)
{
    SetBodyInnerHTML("<style>"
                     ...
                     "  culpa qui officia deserunt mollit anim id est laborum."
                     "</div>");
    LayoutObject* text_size_adjust_negative = GetLayoutObjectByElementId("textSizeAdjustNegative");
    EXPECT_FLOAT_EQ(16.f, text_size_adjust_negative->StyleRef().SpecifiedFontSize());
    EXPECT_FLOAT_EQ(40.f, text_size_adjust_negative->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, TextSizeAdjustmentPixelUnits)
{
    SetBodyInnerHTML("<style>"
                     ...
                     "  culpa qui officia deserunt mollit anim id est laborum."
                     "</div>");
    LayoutObject* text_size_adjust_pixels = GetLayoutObjectByElementId("textSizeAdjustPixels");
    EXPECT_FLOAT_EQ(16.f, text_size_adjust_pixels->StyleRef().SpecifiedFontSize());
...
TEST_P(TextAutosizerTest, NestedTextSizeAdjust)
{
    ...
    LayoutObject* text_size_adjust_a = GetLayoutObjectByElementId("textSizeAdjustA");
    ...
    LayoutObject* text_size_adjust_b = GetLayoutObjectByElementId("textSizeAdjustB");
...
TEST_P(TextAutosizerTest, PrefixedTextSizeAdjustIsAlias)
{
    ...
    EXPECT_FLOAT_EQ(.5f, text_size_adjust->StyleRef().GetTextSizeAdjust().Multiplier());
}
...
TEST_P(TextAutosizerTest, AccessibilityFontScaleFactor)
{
    ...
    EXPECT_FLOAT_EQ(60.f, autosized->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, AccessibilityFontScaleFactorWithTextSizeAdjustNone)
{
    ...
    EXPECT_FLOAT_EQ(24.f, autosized->GetLayoutObject()->StyleRef().ComputedFontSize());
    ...
    EXPECT_FLOAT_EQ(16.f, not_autosized->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    // specified font-size = 16px.
    EXPECT_FLOAT_EQ(16.f, not_autosized->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, ChangingAccessibilityFontScaleFactor)
{
    ...
    EXPECT_FLOAT_EQ(80.f, autosized->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, TextSizeAdjustDoesNotDisableAccessibility)
{
    ...
    EXPECT_FLOAT_EQ(16.f, text_size_adjust_none->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    // 1.5 * (specified font-size = 16px) = 24px.
    EXPECT_FLOAT_EQ(24.f, text_size_adjust_none->GetLayoutObject()->StyleRef().ComputedFontSize());

    Element* text_size_adjust_double = GetElementById("textSizeAdjustDouble");
    EXPECT_FLOAT_EQ(16.f, text_size_adjust_double->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    // 1.5 * (specified font-size = 16px) * (text size adjustment = 2) = 48px.
    EXPECT_FLOAT_EQ(48.f, text_size_adjust_double->GetLayoutObject()->StyleRef().ComputedFontSize());
    ...
    EXPECT_FLOAT_EQ(32.f, text_size_adjust_none->GetLayoutObject()->StyleRef().ComputedFontSize());

    EXPECT_FLOAT_EQ(16.f, text_size_adjust_double->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    // 2.0 * (specified font-size = 16px) * (text size adjustment = 2) = 64px.
    EXPECT_FLOAT_EQ(64.f, text_size_adjust_double->GetLayoutObject()->StyleRef().ComputedFontSize());
}

// https://crbug.com/646237
TEST_P(TextAutosizerTest, DISABLED_TextSizeAdjustWithoutNeedingAutosizing)
{
    GetDocument().GetSettings()->SetTextAutosizingWindowSizeOverride(gfx::Size(800, 600));
    SetBodyInnerHTML(R"HTML(
    <style>
      html { font-size: 16px; }
      body { width: 800px; margin: 0; overflow-y: hidden; }
    ...
    EXPECT_FLOAT_EQ(1.5f, text_size_adjust->StyleRef().GetTextSizeAdjust().Multiplier());
}
...
TEST_P(TextAutosizerTest, ChangingSuperClusterFirstText)
{
    ...
    long_text_element->setInnerHTML("    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed "
                                    "do eiusmod tempor"
...
TEST_P(TextAutosizerTest, AddingSuperCluster)
{
    ...
    container->setInnerHTML("<div class='supercluster' id='longText'>"
...
TEST_P(TextAutosizerTest, AutosizeInnerContentOfRuby)
{
    ...
    EXPECT_FLOAT_EQ(16.f, ruby_inline->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    // (specified font-size = 16px) * (viewport width = 800px) /
    // (window width = 320px) = 40px.
    EXPECT_FLOAT_EQ(40.f, ruby_inline->GetLayoutObject()->StyleRef().ComputedFontSize());

    Element* ruby_block = GetElementById("rubyBlock");
    EXPECT_FLOAT_EQ(16.f, ruby_block->GetLayoutObject()->StyleRef().SpecifiedFontSize());
    // (specified font-size = 16px) * (viewport width = 800px) /
    // (window width = 320px) = 40px.
    EXPECT_FLOAT_EQ(40.f, ruby_block->GetLayoutObject()->StyleRef().ComputedFontSize());
}

TEST_P(TextAutosizerTest, ResizeAndGlyphOverflowChanged)
{
    GetDocument().GetSettings()->SetTextAutosizingWindowSizeOverride(gfx::Size(360, 640));
    Element* html = GetDocument().body()->parentElement();
    html->setInnerHTML("<head>"
                       "  <meta name='viewport' content='width=800'>"
                       "  <style>"
    ...
    GetDocument().GetSettings()->SetTextAutosizingWindowSizeOverride(gfx::Size(640, 360));
    UpdateAllLifecyclePhasesForTest();
...
TEST_P(TextAutosizerTest, narrowContentInsideNestedWideBlock)
{
    ...
    // font-size = 16px;
    EXPECT_FLOAT_EQ(16.f, content->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, LayoutViewWidthProvider)
{
    ...
    // (specified font-size = 16px) * (viewport width = 800px) /
    // (window width = 320px) = 40px.
    EXPECT_FLOAT_EQ(40.f, content->GetLayoutObject()->StyleRef().ComputedFontSize());
...
TEST_P(TextAutosizerTest, MultiColumns)
{
    ...
    EXPECT_FLOAT_EQ(16.f, target->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, MultiColumns2)
{
    ...
    // (window width = 320px) < 16px.
    EXPECT_FLOAT_EQ(16.f, target1->GetLayoutObject()->StyleRef().ComputedFontSize());
    EXPECT_FLOAT_EQ(16.f, target2->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, ScaledbyDSF)
{
    ...
    EXPECT_FLOAT_EQ(40.0f * device_scale, target->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, ClusterHasNotEnoughTextToAutosizeForZoomDSF)
{
    ...
    EXPECT_FLOAT_EQ(8.0f, target->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, ClusterHasEnoughTextToAutosizeForZoomDSF)
{
    ...
    EXPECT_FLOAT_EQ(20.0f * device_scale, target->GetLayoutObject()->StyleRef().ComputedFontSize());
}
...
TEST_P(TextAutosizerTest, UsedDeviceScaleAdjustmentUseCounterWithViewport)
{
    ...
    EXPECT_FALSE(GetDocument().IsUseCounted(WebFeature::kUsedDeviceScaleAdjustment));
    EXPECT_FALSE(ChildDocument().IsUseCounted(WebFeature::kUsedDeviceScaleAdjustment));
}
...
TEST_P(TextAutosizerTest, UsedDeviceScaleAdjustmentUseCounterWithoutViewport)
{
    ...
    ASSERT_FALSE(GetDocument().IsUseCounted(WebFeature::kUsedDeviceScaleAdjustment));
    GetDocument().GetSettings()->SetViewportMetaEnabled(true);
    GetDocument().GetSettings()->SetDeviceScaleAdjustment(1.5f);
    ...
    EXPECT_TRUE(GetDocument().IsUseCounted(WebFeature::kUsedDeviceScaleAdjustment));
    EXPECT_TRUE(ChildDocument().IsUseCounted(WebFeature::kUsedDeviceScaleAdjustment));
}

class TextAutosizerSimTest : public SimTest, public testing::WithParamInterface<bool>, private ScopedTextSizeAdjustImprovementsForTest {
public:
...
TEST_P(TextAutosizerSimTest, CrossSiteUseCounter)
{
    ...
    main_resource.Complete("<iframe width=700 src='https://crosssite.com/'></iframe>");
    ...
    EXPECT_TRUE(child_doc->IsUseCounted(WebFeature::kTextAutosizedCrossSiteIframe));
}
...
TEST_P(TextAutosizerSimTest, ViewportChangesUpdateAutosizing)
{
    ...
    EXPECT_FALSE(GetDocument().GetViewportData().GetViewportDescription().IsSpecifiedByAuthor());
    ...
    meta->setAttribute(html_names::kContentAttr, AtomicString("width=device-width"));
