...
public:
    static bool SkipContainingBlockForPercentHeightCalculation(const LayoutBlock* cb);
    ...
    static LayoutPoint ComputeLocation(const PhysicalBoxFragment& child_fragment, PhysicalOffset offset, const PhysicalBoxFragment& container_fragment,
