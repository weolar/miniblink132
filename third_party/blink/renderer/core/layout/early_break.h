...
public:
    ...
    explicit EarlyBreak(BlockNode block, BreakAppeal break_appeal, const EarlyBreak* break_inside_child = nullptr)
    ...
    BreakType Type() const
    {
        return static_cast<BreakType>(const_type_);
    }
    bool IsBreakBefore() const
    {
        return !break_inside_child_;
    }
    ...
    const EarlyBreak* BreakInside() const
    {
        return break_inside_child_.Get();
    }
