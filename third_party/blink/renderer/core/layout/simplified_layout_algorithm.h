...
class CORE_EXPORT SimplifiedLayoutAlgorithm : public LayoutAlgorithm<BlockNode, BoxFragmentBuilder, BlockBreakToken> {
public:
    SimplifiedLayoutAlgorithm(const LayoutAlgorithmParams&, const LayoutResult&, bool keep_old_size = false);
...
private:
    void AddChildFragment(const PhysicalFragmentLink& old_fragment, const PhysicalFragment& new_fragment, const MarginStrut* margin_strut = nullptr,
