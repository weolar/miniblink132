...
enum FragmentationType { kFragmentNone, kFragmentPage, kFragmentColumn, kFragmentRegion };
...
public:
    ...
    enum PercentageStorage { kSameAsAvailable, kZero, kIndefinite, kRareDataPercentage };
    ...
    const ConstraintSpace& CloneForBlockInInlineIfNeeded(std::optional<ConstraintSpace>& space) const;
    ...
    {
        return bitfields_.is_hidden_for_paint;
    }
    ...
    {
        switch (static_cast<PercentageStorage>(bitfields_.percentage_inline_storage)) {
        default:
            NOTREACHED();
    ...
    {
        switch (static_cast<PercentageStorage>(bitfields_.percentage_block_storage)) {
        default:
            NOTREACHED();
        case kSameAsAvailable:
    ...
    {
        switch (static_cast<PercentageStorage>(bitfields_.replaced_percentage_block_storage)) {
        case kSameAsAvailable:
            return available_size_.block_size;
        case kZero:
            return LayoutUnit();
    ...
    {
        return { ReplacedPercentageResolutionInlineSize(), ReplacedPercentageResolutionBlockSize() };
    }
    ...
    {
        if (GetDecorationPercentageResolutionType() == DecorationPercentageResolutionType::kContainingBlockSize) {
    ...
    {
        return HasRareData() ? rare_data_->TargetStretchInlineSize() : kIndefiniteSize;
    }
    ...
    {
        return HasRareData() ? rare_data_->TableCellAlignmentBaseline() : std::nullopt;
    }

    bool IsTableCellWithCollapsedBorders() const
    {
        return HasRareData() ? rare_data_->IsTableCellWithCollapsedBorders() : false;
    }
    ...
    {
        return HasRareData() ? rare_data_->fragmentainer_block_size : kIndefiniteSize;
    }
    ...
    {
        return BlockFragmentationType() == kFragmentColumn && FragmentainerBlockSize() == kIndefiniteSize;
    }
    ...
    {
        return HasRareData() && rare_data_->data_union_type == static_cast<unsigned>(RareData::DataUnionType::kTableCellData);
    }
    ...
    {
        return bitfields_.is_anonymous;
    }
    ...
    {
        return bitfields_.use_first_line_style;
    }
    ...
    {
        return static_cast<BaselineAlgorithmType>(bitfields_.baseline_algorithm_type);
    }
    ...
    bool IsFixedInlineSize() const
    {
        return bitfields_.is_fixed_inline_size;
    }

    bool IsFixedBlockSize() const
    {
        return bitfields_.is_fixed_block_size;
    }
    ...
    bool IsTableCellChild() const
    {
        return bitfields_.is_table_cell_child;
    }
    ...
    bool IsPaintedAtomically() const
    {
        return bitfields_.is_painted_atomically;
    }
    ...
    {
        return HasRareData() ? static_cast<FragmentationType>(rare_data_->block_direction_fragmentation_type) : kFragmentNone;
    }
    ...
    {
        return HasRareData() && rare_data_->is_monolithic_overflow_propagation_disabled;
    }
    ...
    {
        return HasRareData() && rare_data_->min_block_size_should_encompass_intrinsic_size;
    }
    ...
    {
        return HasRareData() ? rare_data_->BlockStartAnnotationSpace() : LayoutUnit();
    }
    ...
    {
        return HasRareData() ? rare_data_->OptimisticBfcBlockOffset() : std::nullopt;
    }
    ...
    LayoutUnit ExpectedBfcBlockOffset() const
    {
        ...
        return ForcedBfcBlockOffset().value_or(OptimisticBfcBlockOffset().value_or(GetBfcOffset().block_offset));
    }
    ...
    {
        return !GetExclusionSpace().IsEmpty();
    }
    ...
    {
        return HasRareData() ? rare_data_->LineClampEndMarginStrut() : MarginStrut();
    }
    ...
    {
        return HasRareData() ? TextBoxEdge(rare_data_->effective_text_box_edge) : TextBoxEdge();
    }
    ...
    {
        return HasRareData() && rare_data_->should_text_box_trim_fragmentainer_start;
    }
    ...
    {
        return HasRareData() && rare_data_->should_text_box_trim_inside_when_line_clamp;
    }
    ...
    DecorationPercentageResolutionType GetDecorationPercentageResolutionType() const
    {
        if (!HasRareData()) {
            return DecorationPercentageResolutionType::kContainingBlockInlineSize;
        }
        return static_cast<DecorationPercentageResolutionType>(rare_data_->decoration_percentage_resolution_type);
    }
    ...
    bool AreBlockSizeConstraintsEqual(const ConstraintSpace& other) const
    {
        ...
        return TableCellAlignmentBaseline() == other.TableCellAlignmentBaseline()
            && MinBlockSizeShouldEncompassIntrinsicSize() == other.MinBlockSizeShouldEncompassIntrinsicSize();
    }
    ...
    bool AreSizesEqual(const ConstraintSpace& other) const
    {
        ...
        if (bitfields_.percentage_inline_storage != other.bitfields_.percentage_inline_storage)
            return false;

        if (bitfields_.percentage_block_storage != other.bitfields_.percentage_block_storage)
            return false;

        if (bitfields_.replaced_percentage_block_storage != other.bitfields_.replaced_percentage_block_storage)
            return false;
        ...
        if (bitfields_.percentage_inline_storage == kRareDataPercentage && other.bitfields_.percentage_inline_storage == kRareDataPercentage
            && rare_data_->percentage_resolution_size.inline_size != other.rare_data_->percentage_resolution_size.inline_size)
            return false;

        if (bitfields_.percentage_block_storage == kRareDataPercentage && other.bitfields_.percentage_block_storage == kRareDataPercentage
            && rare_data_->percentage_resolution_size.block_size != other.rare_data_->percentage_resolution_size.block_size)
            return false;

        if (bitfields_.replaced_percentage_block_storage == kRareDataPercentage && other.bitfields_.replaced_percentage_block_storage == kRareDataPercentage
            && rare_data_->replaced_percentage_resolution_block_size != other.rare_data_->replaced_percentage_resolution_block_size)
            return false;

        return true;
    }

    void ReplaceTableRowData(const TableConstraintSpaceData& table_data, const wtf_size_t row_index)
    {
        DCHECK(HasRareData());
...
private:
    ...
    public:
        ...
        RareData(const RareData& other)
            ...
            , replaced_percentage_resolution_block_size(other.replaced_percentage_resolution_block_size)
            ...
            , is_restricted_block_size_table_cell(other.is_restricted_block_size_table_cell)
            , hide_table_cell_if_empty(other.hide_table_cell_if_empty)
            , block_direction_fragmentation_type(other.block_direction_fragmentation_type)
            , is_block_fragmentation_forced_off(other.is_block_fragmentation_forced_off)
            , is_monolithic_overflow_propagation_disabled(other.is_monolithic_overflow_propagation_disabled)
            ...
            , min_block_size_should_encompass_intrinsic_size(other.min_block_size_should_encompass_intrinsic_size)
            , uses_orthogonal_fallback_inline_size(other.uses_orthogonal_fallback_inline_size)
            ...
            , should_text_box_trim_node_start(other.should_text_box_trim_node_start)
            , should_text_box_trim_node_end(other.should_text_box_trim_node_end)
            , should_text_box_trim_fragmentainer_start(other.should_text_box_trim_fragmentainer_start)
            , should_text_box_trim_fragmentainer_end(other.should_text_box_trim_fragmentainer_end)
            , should_force_text_box_trim_end(other.should_force_text_box_trim_end)
            , should_text_box_trim_inside_when_line_clamp(other.should_text_box_trim_inside_when_line_clamp)
            , decoration_percentage_resolution_type(other.decoration_percentage_resolution_type)
        {
            ...
            case DataUnionType::kTableSectionData:
                new (&table_section_data_) TableSectionData(other.table_section_data_);
                break;
        ...
        {
            if (data_union_type != other.data_union_type || is_pushed_by_floats != other.is_pushed_by_floats
                || is_restricted_block_size_table_cell != other.is_restricted_block_size_table_cell
                || hide_table_cell_if_empty != other.hide_table_cell_if_empty || block_direction_fragmentation_type != other.block_direction_fragmentation_type
                || is_block_fragmentation_forced_off != other.is_block_fragmentation_forced_off
                || is_monolithic_overflow_propagation_disabled != other.is_monolithic_overflow_propagation_disabled
                || requires_content_before_breaking != other.requires_content_before_breaking || is_inside_balanced_columns != other.is_inside_balanced_columns
                || should_ignore_forced_breaks != other.should_ignore_forced_breaks || is_in_column_bfc != other.is_in_column_bfc
                || is_past_break != other.is_past_break || min_break_appeal != other.min_break_appeal
                || propagate_child_break_values != other.propagate_child_break_values || should_repeat != other.should_repeat
                || is_inside_repeatable_content != other.is_inside_repeatable_content
                || should_text_box_trim_node_start != other.should_text_box_trim_node_start
                || should_text_box_trim_node_end != other.should_text_box_trim_node_end
                || should_text_box_trim_fragmentainer_start != other.should_text_box_trim_fragmentainer_start
        ...
        {
            if (page_name || fragmentainer_block_size != kIndefiniteSize || fragmentainer_offset || is_pushed_by_floats || is_restricted_block_size_table_cell
                || hide_table_cell_if_empty || block_direction_fragmentation_type != kFragmentNone || is_block_fragmentation_forced_off
                || is_monolithic_overflow_propagation_disabled || requires_content_before_breaking || is_inside_balanced_columns || should_ignore_forced_breaks
                || is_in_column_bfc || is_past_break || min_break_appeal != kBreakAppealLastResort || propagate_child_break_values || is_at_fragmentainer_start
                || should_repeat || is_inside_repeatable_content || should_text_box_trim_node_start || should_text_box_trim_node_end
                || should_text_box_trim_fragmentainer_start || should_text_box_trim_fragmentainer_end || should_force_text_box_trim_end
                || should_text_box_trim_inside_when_line_clamp || decoration_percentage_resolution_type) {
                return false;
            }
        ...
        MarginStrut GetMarginStrut() const
        {
            return GetDataUnionType() == DataUnionType::kBlockData ? block_data_.margin_strut : MarginStrut();
        }
        ...
        std::optional<LayoutUnit> OptimisticBfcBlockOffset() const
        {
            return GetDataUnionType() == DataUnionType::kBlockData ? block_data_.optimistic_bfc_block_offset : std::nullopt;
        }

        void SetOptimisticBfcBlockOffset(LayoutUnit optimistic_bfc_block_offset)
        {
            EnsureBlockData()->optimistic_bfc_block_offset = optimistic_bfc_block_offset;
        }

        std::optional<LayoutUnit> ForcedBfcBlockOffset() const
        {
            return GetDataUnionType() == DataUnionType::kBlockData ? block_data_.forced_bfc_block_offset : std::nullopt;
        }
        ...
        LineClampData GetLineClampData() const
        {
            return GetDataUnionType() == DataUnionType::kBlockData ? block_data_.line_clamp_data : LineClampData();
        }
        ...
        LayoutUnit LineClampEndPadding() const
        {
            return GetDataUnionType() == DataUnionType::kBlockData ? block_data_.line_clamp_end_padding : LayoutUnit();
        }
        ...
        MarginStrut LineClampEndMarginStrut() const
        {
            return GetDataUnionType() == DataUnionType::kBlockData ? block_data_.line_clamp_end_margin_strut : MarginStrut();
        }
        ...
        BoxStrut TableCellBorders() const
        {
            return GetDataUnionType() == DataUnionType::kTableCellData ? table_cell_data_.table_cell_borders : BoxStrut();
        }
        ...
        wtf_size_t TableCellColumnIndex() const
        {
            return GetDataUnionType() == DataUnionType::kTableCellData ? table_cell_data_.table_cell_column_index : 0;
        }
        ...
        std::optional<LayoutUnit> TableCellAlignmentBaseline() const
        {
            return GetDataUnionType() == DataUnionType::kTableCellData ? table_cell_data_.table_cell_alignment_baseline : std::nullopt;
        }

        void SetTableCellAlignmentBaseline(LayoutUnit table_cell_alignment_baseline)
        {
            EnsureTableCellData()->table_cell_alignment_baseline = table_cell_alignment_baseline;
        }

        bool IsTableCellWithCollapsedBorders() const
        {
            return GetDataUnionType() == DataUnionType::kTableCellData && table_cell_data_.has_collapsed_borders;
        }
        ...
        void SetTableRowData(scoped_refptr<const TableConstraintSpaceData> table_data, wtf_size_t row_index)
        {
            EnsureTableRowData()->table_data = std::move(table_data);
            EnsureTableRowData()->row_index = row_index;
        }

        void SetTableSectionData(scoped_refptr<const TableConstraintSpaceData> table_data, wtf_size_t section_index)
        {
            EnsureTableSectionData()->table_data = std::move(table_data);
            EnsureTableSectionData()->section_index = section_index;
        }

        void ReplaceTableRowData(const TableConstraintSpaceData& table_data, wtf_size_t row_index)
        {
            DCHECK_EQ(GetDataUnionType(), DataUnionType::kTableRowData);
            DCHECK(table_data.IsTableSpecificDataEqual(*(table_row_data_.table_data)));
            DCHECK(table_data.MaySkipRowLayout(*table_row_data_.table_data, row_index, table_row_data_.row_index));
        ...
        wtf_size_t TableRowIndex() const
        {
            return GetDataUnionType() == DataUnionType::kTableRowData ? table_row_data_.row_index : kNotFound;
        }

        wtf_size_t TableSectionIndex() const
        {
            return GetDataUnionType() == DataUnionType::kTableSectionData ? table_section_data_.section_index : kNotFound;
        }

        SerializedScriptValue* CustomLayoutData() const
        {
            return GetDataUnionType() == DataUnionType::kCustomData ? custom_data_.data.get() : nullptr;
        }

        void SetCustomLayoutData(scoped_refptr<SerializedScriptValue> custom_layout_data)
        {
        ...
        LayoutUnit TargetStretchInlineSize() const
        {
            return GetDataUnionType() == DataUnionType::kStretchData ? stretch_data_.target_stretch_inline_size : kIndefiniteSize;
        }

        void SetTargetStretchInlineSize(LayoutUnit target_stretch_inline_size)
        {
            EnsureStretchData()->target_stretch_inline_size = target_stretch_inline_size;
        }

        std::optional<MathTargetStretchBlockSizes> TargetStretchBlockSizes() const
        {
            return GetDataUnionType() == DataUnionType::kStretchData ? stretch_data_.target_stretch_block_sizes : std::nullopt;
        }

        void SetTargetStretchBlockSizes(MathTargetStretchBlockSizes target_stretch_block_sizes)
        {
            EnsureStretchData()->target_stretch_block_sizes = target_stretch_block_sizes;
        }

        const GridLayoutSubtree* GetGridLayoutSubtree() const
        {
            return GetDataUnionType() == DataUnionType::kSubgridData ? &subgrid_data_.layout_subtree : nullptr;
        }
        ...
        unsigned block_direction_fragmentation_type : 2 = static_cast<unsigned>(kFragmentNone);
        ...
        unsigned min_break_appeal : kBreakAppealBitsNeeded = static_cast<unsigned>(kBreakAppealLastResort);
        ...
        unsigned effective_text_box_edge : TextBoxEdge::kBits = static_cast<unsigned>(TextBoxEdge());
        unsigned should_force_text_box_trim_end : 1 = false;
        unsigned should_text_box_trim_inside_when_line_clamp : 1 = false;
        unsigned decoration_percentage_resolution_type : 1 = static_cast<unsigned>(DecorationPercentageResolutionType::kContainingBlockInlineSize);
    ...
    private:
        ...
        struct TableCellData {
            bool MaySkipLayout(const TableCellData& other) const
            {
                ...
                return table_cell_borders == other.table_cell_borders && table_cell_column_index == other.table_cell_column_index
                    && has_collapsed_borders == other.has_collapsed_borders;
            }

            bool IsInitialForMaySkipLayout() const
            {
                return table_cell_borders == BoxStrut() && table_cell_column_index == kNotFound && !has_collapsed_borders;
            }
        ...
        struct TableRowData {
            ...
            {
                return table_data->IsTableSpecificDataEqual(*other.table_data) && table_data->MaySkipRowLayout(*other.table_data, row_index, other.row_index);
            }
            bool IsInitialForMaySkipLayout() const
            {
        ...
        struct TableSectionData {
            bool MaySkipLayout(const TableSectionData& other) const
            {
                return table_data->IsTableSpecificDataEqual(*other.table_data)
                    && table_data->MaySkipSectionLayout(*other.table_data, section_index, other.section_index);
            }
            bool IsInitialForMaySkipLayout() const
            {
        ...
        struct StretchData {
            bool MaySkipLayout(const StretchData& other) const
            {
                return target_stretch_inline_size == other.target_stretch_inline_size
                    && target_stretch_block_sizes.has_value() == other.target_stretch_block_sizes.has_value()
                    && (!target_stretch_block_sizes
                        || (target_stretch_block_sizes->ascent == other.target_stretch_block_sizes->ascent
                            && target_stretch_block_sizes->descent == other.target_stretch_block_sizes->descent));
            }

            bool IsInitialForMaySkipLayout() const
            {
                return target_stretch_inline_size == kIndefiniteSize && !target_stretch_block_sizes;
            }
        ...
        {
            DCHECK(GetDataUnionType() == DataUnionType::kNone || GetDataUnionType() == DataUnionType::kBlockData);
        ...
        {
            DCHECK(GetDataUnionType() == DataUnionType::kNone || GetDataUnionType() == DataUnionType::kTableCellData);
        ...
        {
            DCHECK(GetDataUnionType() == DataUnionType::kNone || GetDataUnionType() == DataUnionType::kTableRowData);
            if (GetDataUnionType() != DataUnionType::kTableRowData) {
        ...
        {
            DCHECK(GetDataUnionType() == DataUnionType::kNone || GetDataUnionType() == DataUnionType::kTableSectionData);
            if (GetDataUnionType() != DataUnionType::kTableSectionData) {
                data_union_type = static_cast<unsigned>(DataUnionType::kTableSectionData);
        ...
        {
            DCHECK(GetDataUnionType() == DataUnionType::kNone || GetDataUnionType() == DataUnionType::kCustomData);
        ...
        {
            DCHECK(GetDataUnionType() == DataUnionType::kNone || GetDataUnionType() == DataUnionType::kStretchData);
        ...
        {
            DCHECK(GetDataUnionType() == DataUnionType::kNone || GetDataUnionType() == DataUnionType::kSubgridData);
    ...
    public:
        ...
        explicit Bitfields(WritingDirectionMode writing_direction)
            : writing_mode(static_cast<unsigned>(writing_direction.GetWritingMode()))
        ...
        {
            return adjoining_object_types == other.adjoining_object_types && writing_mode == other.writing_mode && direction == other.direction
                && is_anonymous == other.is_anonymous && is_new_formatting_context == other.is_new_formatting_context
                && is_orthogonal_writing_mode_root == other.is_orthogonal_writing_mode_root && is_painted_atomically == other.is_painted_atomically
                && is_hidden_for_paint == other.is_hidden_for_paint && use_first_line_style == other.use_first_line_style
                && ancestor_has_clearance_past_adjoining_floats == other.ancestor_has_clearance_past_adjoining_floats
                && baseline_algorithm_type == other.baseline_algorithm_type;
        }

        bool AreInlineSizeConstraintsEqual(const Bitfields& other) const
        {
            return inline_auto_behavior == other.inline_auto_behavior && is_fixed_inline_size == other.is_fixed_inline_size;
        }
        bool AreBlockSizeConstraintsEqual(const Bitfields& other) const
        {
            return block_auto_behavior == other.block_auto_behavior && is_fixed_block_size == other.is_fixed_block_size
                && is_initial_block_size_indefinite == other.is_initial_block_size_indefinite && is_table_cell_child == other.is_table_cell_child
                && is_restricted_block_size_table_cell_child == other.is_restricted_block_size_table_cell_child;
        }

        unsigned has_rare_data : 1 = false;
        unsigned adjoining_object_types : 3 = static_cast<unsigned>(AdjoiningObjectTypeValue::kAdjoiningNone);
        ...
        unsigned baseline_algorithm_type : 1 = static_cast<unsigned>(BaselineAlgorithmType::kDefault);

        unsigned cache_slot : 1 = static_cast<unsigned>(LayoutResultCacheSlot::kLayout);

        // Size constraints.
        unsigned inline_auto_behavior : 2 = static_cast<unsigned>(AutoSizeBehavior::kFitContent);
        unsigned block_auto_behavior : 2 = static_cast<unsigned>(AutoSizeBehavior::kFitContent);
        ...
        unsigned percentage_inline_storage : 2 = static_cast<unsigned>(PercentageStorage::kSameAsAvailable);
        unsigned percentage_block_storage : 2 = static_cast<unsigned>(PercentageStorage::kSameAsAvailable);
        unsigned replaced_percentage_block_storage : 2 = static_cast<unsigned>(PercentageStorage::kSameAsAvailable);
    };
    ...
    {
        return bitfields_.has_rare_data;
    }
...
inline std::ostream& operator<<(std::ostream& stream, const ConstraintSpace& value)
{
