...
class DepthOrderedLayoutObjectListData : public GarbageCollected<DepthOrderedLayoutObjectListData> {
public:
    ...
    HeapHashSet<Member<LayoutObject>>& objects()
    {
        return objects_;
    }
...
const HeapHashSet<Member<LayoutObject>>& DepthOrderedLayoutObjectList::Unordered() const
{
    return data_->objects();
}

const HeapVector<LayoutObjectWithDepth>& DepthOrderedLayoutObjectList::Ordered()
{
