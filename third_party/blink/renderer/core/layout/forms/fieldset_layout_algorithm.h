...
class CORE_EXPORT FieldsetLayoutAlgorithm : public LayoutAlgorithm<BlockNode, BoxFragmentBuilder, BlockBreakToken> {
public:
...
private:
    ...
    BreakStatus LayoutFieldsetContent(
    ...
    const ConstraintSpace CreateConstraintSpaceForLegend(BlockNode legend, LogicalSize available_size, LogicalSize percentage_size);
    const ConstraintSpace CreateConstraintSpaceForFieldsetContent(BlockNode fieldset_content, LogicalSize padding_box_size, LayoutUnit block_offset);
