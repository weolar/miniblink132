...
protected:
    ...
    {
        return To<LayoutText>(control->InnerEditorElement()->GetLayoutObject()->SlowFirstChild());
    }
...
TEST_F(LayoutTextControlTest, ChangingPseudoSelectionStyleShouldInvalidateSelectionSingle)
{
    ...
    text_control->setAttribute(html_names::kClassAttr, AtomicString("pseudoSelection"));
    CheckSelectionInvalidationChanges(*selected_text);
}

TEST_F(LayoutTextControlTest, ChangingPseudoSelectionStyleShouldInvalidateSelectionMulti)
{
    SetBodyInnerHTML(R"HTML(
    <style>
...
TEST_F(LayoutTextControlTest, AddingPseudoSelectionStyleShouldInvalidateSelectionSingle)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
...
TEST_F(LayoutTextControlTest, AddingPseudoSelectionStyleShouldInvalidateSelectionMulti)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
...
TEST_F(LayoutTextControlTest, RemovingPseudoSelectionStyleShouldInvalidateSelectionSingle)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
...
TEST_F(LayoutTextControlTest, RemovingPseudoSelectionStyleShouldInvalidateSelectionMulti)
{
    SetBodyInnerHTML(R"HTML(
    <style>
      .pseudoSelection::selection { background-color: green; }
...
TEST_F(LayoutTextControlTest, HitTestSearchInput)
{
    ...
    EXPECT_TRUE(input->GetLayoutObject()->HitTestAllPhases(result, location, PhysicalOffset()));
