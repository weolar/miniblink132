...
protected:
    ...
    void UpdateAnonymousChildStyle(const LayoutObject* child, ComputedStyleBuilder& child_style_builder) const override;
...
template <> struct DowncastTraits<LayoutFieldset> {
