...
class CORE_EXPORT TapFriendlinessChecker : public GarbageCollected<TapFriendlinessChecker> {
    using PassKey = base::PassKey<TapFriendlinessChecker>;

public:
    explicit TapFriendlinessChecker(LocalFrameView& view, base::PassKey<TapFriendlinessChecker>)
        : view_(&view)
    {
    }
