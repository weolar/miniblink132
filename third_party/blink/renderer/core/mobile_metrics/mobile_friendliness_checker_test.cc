...
class MobileFriendlinessCheckerTest : public testing::Test {
    ...
    template <typename LoaderCallback> ukm::mojom::UkmEntry EvalMobileFriendlinessUKM(const LoaderCallback& load, float device_scale)
    {
        auto helper = std::make_unique<frame_test_helpers::WebViewHelper>();
        helper->Initialize(nullptr, nullptr, ConfigureAndroidSettings);
        helper->GetWebView()->MainFrameWidget()->SetDeviceScaleFactorForTesting(device_scale);
        helper->Resize(gfx::Size(kDeviceWidth, kDeviceHeight));
        helper->GetWebView()->GetPage()->SetDefaultPageScaleLimits(kMinimumZoom, kMaximumZoom);
        // Model Chrome text auto-sizing more accurately.
        helper->GetWebView()->GetPage()->GetSettings().SetTextAutosizingEnabled(true);
        helper->GetWebView()->GetPage()->GetSettings().SetShrinksViewportContentToFit(true);
        helper->GetWebView()->GetPage()->GetSettings().SetViewportStyle(mojom::blink::ViewportStyle::kMobile);
        helper->LoadAhem();
        ...
        helper->GetWebView()->MainFrameImpl()->GetFrameView()->UpdateAllLifecyclePhasesForTest();
        helper->GetWebView()->MainFrameImpl()->GetFrameView()->GetMobileFriendlinessChecker()->ComputeNowForTesting();

        auto entries = result.GetEntriesByName("MobileFriendliness");
        EXPECT_EQ(entries.size(), 1u);
        EXPECT_EQ(entries[0]->event_hash, ukm::builders::MobileFriendliness::kEntryNameHash);
        return *entries[0];
    }
...
public:
    ...
    ukm::mojom::UkmEntry CalculateMetricsForHTMLString(const std::string& html, float device_scale = 1.0)
    {
        return EvalMobileFriendlinessUKM(
            [&](frame_test_helpers::WebViewHelper& helper) {
                frame_test_helpers::LoadHTMLString(helper.GetWebView()->MainFrameImpl(), html, url_test_helpers::ToKURL("about:blank"));
            },
            device_scale);
    }

    ukm::mojom::UkmEntry CalculateMetricsForFile(const std::string& path, float device_scale = 1.0)
    {
        return EvalMobileFriendlinessUKM(
            [&](frame_test_helpers::WebViewHelper& helper) {
                ...
                frame_test_helpers::LoadFrame(helper.GetWebView()->MainFrameImpl(), kBaseUrl + path);
            },
            device_scale);
    }

    static void ExpectUkm(const ukm::mojom::UkmEntry& ukm, uint64_t name_hash, int expected)
    {
    ...
    static void ExpectUkmLT(const ukm::mojom::UkmEntry& ukm, uint64_t name_hash, int expected)
    {
        auto it = ukm.metrics.find(name_hash);
        EXPECT_NE(it, ukm.metrics.end());
    ...
    static void ExpectUkmGT(const ukm::mojom::UkmEntry& ukm, uint64_t name_hash, int expected)
    {
        auto it = ukm.metrics.find(name_hash);
        EXPECT_NE(it, ukm.metrics.end());
...
TEST_F(MobileFriendlinessCheckerTest, NoViewportSetting)
{
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, false);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
}

TEST_F(MobileFriendlinessCheckerTest, DeviceWidth)
{
    ukm::mojom::UkmEntry ukm = CalculateMetricsForFile("viewport/viewport-1.html");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
}

TEST_F(MobileFriendlinessCheckerTest, HardcodedViewport)
{
    ukm::mojom::UkmEntry ukm = CalculateMetricsForFile("viewport/viewport-30.html");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, false);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportHardcodedWidthNameHash,
...
TEST_F(MobileFriendlinessCheckerTest, DeviceWidthWithInitialScale05)
{
    ...
    ukm::mojom::UkmEntry ukm = CalculateMetricsForFile("viewport/viewport-34.html");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportInitialScaleX10NameHash,
        6); // Bucketed 5 -> 6.
}
...
TEST_F(MobileFriendlinessCheckerTest, AllowUserScalableWithSmallMaxZoom)
{
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, false);
}
...
TEST_F(MobileFriendlinessCheckerTest, AllowUserScalableWithLargeMaxZoomAndLargeInitialScale)
{
    ukm::mojom::UkmEntry ukm = CalculateMetricsForHTMLString(R"HTML(
    <head>
...
{
    ukm::mojom::UkmEntry ukm = CalculateMetricsForFile("viewport-initial-scale-and-user-scalable-no.html");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, false);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportInitialScaleX10NameHash, 18);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
}

TEST_F(MobileFriendlinessCheckerTest, NoText)
{
    ukm::mojom::UkmEntry ukm = CalculateMetricsForHTMLString(R"HTML(<body></body>)HTML");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, false);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
...
<html>
    ...
    ExpectUkmLT(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 80);
}
...
<html>
  ...
  <body>
    ...
    ExpectUkmLT(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 90);
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 60);
}
...
<html>
  ...
  <body style="font-size: 16px; width: 960px">
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, false);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportHardcodedWidthNameHash, 480);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportInitialScaleX10NameHash, 6);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
}
...
<html>
  <body style="margin:0px">
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 0);
}
...
TEST_F(MobileFriendlinessCheckerTest, NormalTextAndWideImageWithDeviceWidthViewport)
{
    ukm::mojom::UkmEntry ukm = CalculateMetricsForHTMLString(R"HTML(
<html>
  <head>
  ...
  <body>
    ...
    // Automatic zoom-out makes text small and image fits in display.
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 10);
}
...
<html>
  ...
  <body style="margin:240px;font-size: 12pt">
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 0);
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 50);
}
...
TEST_F(MobileFriendlinessCheckerTest, NormalTextAndWideImageWithInitialScaleAndDeviceScale)
{
    ukm::mojom::UkmEntry ukm = CalculateMetricsForHTMLString(R"HTML(
<html>
  <head>
  ...
  <body style="margin: 0px">
    ...
    <p style="font-size: 6pt">Illegible font text.</p>
        ...
        /*device_scale=*/2.0);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 100);
}
...
<html>
  ...
  <body>
    ...
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 20);
}
...
<html>
  ...
  <body style="font-size: 12px">
    ...
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 14);
}
...
<html>
  ...
  <body style="margin: 0px">
    ...
    ExpectUkm(ukm_full, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 100);
...
<html>
  ...
  <body style="margin: 0px">
    ...
    ExpectUkm(ukm_half, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 50);
}
...
<html>
  ...
  <body style="font-size: 12px">
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 1);
}
...
<html>
  ...
  <body>
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 20);
}
...
<html>
  ...
  <body style="margin:0px;">
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 100);
}
...
<html>
  ...
  <body style="width:4036px">
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 46);
}
...
<html>
  ...
  <body style="font: 76px Ahem; width: 480">
    ...
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportInitialScaleX10NameHash,
        26); // Bucketed 30 -> 26.
    ExpectUkmGT(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 55);
}
...
<html>
  ...
  <div class="scrollmenu">
    ...
    // Fits within the viewport by scrollbar.
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 50);
}
...
<html>
  ...
  <div class="scrollmenu">
    ...
    // Fits within the viewport by scrollbar.
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 75);
}
...
<html>
  ...
  <body style="font: 20px/1; line-height: 1">
    ...
    // Fits within the viewport by scrollbar.
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kTextContentOutsideViewportPercentageNameHash, 25);
}

TEST_F(MobileFriendlinessCheckerTest, IFrame)
{
    url_test_helpers::RegisterMockedURLLoadFromBase(WebString::FromUTF8(kBaseUrl), blink::test::CoreTestDataPath(), WebString::FromUTF8("visible_iframe.html"));
    const ukm::mojom::UkmEntry ukm = CalculateMetricsForFile("single_iframe.html");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, false);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
}
...
TEST_F(MobileFriendlinessCheckerTest, IFrameVieportDeviceWidth)
{
    url_test_helpers::RegisterMockedURLLoadFromBase(
        WebString::FromUTF8(kBaseUrl), blink::test::CoreTestDataPath(), WebString::FromUTF8("viewport/viewport-1.html"));
    const ukm::mojom::UkmEntry ukm = CalculateMetricsForFile("page_contains_viewport_iframe.html");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 0);
}
...
{
    url_test_helpers::RegisterMockedURLLoadFromBase(
        WebString::FromUTF8(kBaseUrl), blink::test::CoreTestDataPath(), WebString::FromUTF8("small_text_iframe.html"));
    const ukm::mojom::UkmEntry ukm = CalculateMetricsForFile("page_contains_small_text_iframe.html");
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kViewportDeviceWidthNameHash, false);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kAllowUserZoomNameHash, true);
    ExpectUkm(ukm, ukm::builders::MobileFriendliness::kSmallTextRatioNameHash, 100);
}
