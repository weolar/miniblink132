...
public:
    virtual gfx::Size BitmapSourceSize() const
    {
        return gfx::Size();
    }
    virtual ScriptPromise<ImageBitmap> CreateImageBitmap(ScriptState*, std::optional<gfx::Rect>, const ImageBitmapOptions*, ExceptionState&);
    ...
    static ScriptPromise<ImageBitmap> FulfillImageBitmap(ScriptState*, ImageBitmap*, const ImageBitmapOptions* options, ExceptionState&);
