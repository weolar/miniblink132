...
public:
    ...
    void SetPreferredRootScrollbarColorScheme(mojom::PreferredColorScheme preferred_root_scrollbar_color_scheme);
    void SetPreferredColorScheme(mojom::PreferredColorScheme preferred_color_scheme);
...
private:
    Settings& settings_;
    mojom::PreferredColorScheme default_preferred_root_scrollbar_color_scheme_ = mojom::PreferredColorScheme::kLight;
    mojom::PreferredColorScheme default_preferred_color_scheme_ = mojom::PreferredColorScheme::kLight;
    mojom::PreferredContrast default_preferred_contrast_ = mojom::PreferredContrast::kNoPreference;
