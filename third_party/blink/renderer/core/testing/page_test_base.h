...
public:
    ...
    public:
        explicit MockClipboardHostProvider(const blink::BrowserInterfaceBrokerProxy& interface_broker);
        ...
        MockClipboardHost* clipboard_host()
        {
            return &host_;
        }
    ...
    void SetUp(gfx::Size);
    void SetupPageWithClients(
        ChromeClient* = nullptr, LocalFrameClient* = nullptr, FrameSettingOverrideFunction = nullptr, gfx::Size size = gfx::Size(800, 600));
    ...
    void NavigateTo(const KURL& url, const WTF::HashMap<String, String>& headers = {});

    Document& GetDocument() const;
    Page& GetPage() const;
    LocalFrame& GetFrame() const;
    FrameSelection& Selection() const;
    DummyPageHolder& GetDummyPageHolder() const
    {
    ...
    static void LoadFontFromFile(LocalFrame& fame, String font_path, const AtomicString& family_name);
