...
public:
    ...
    static bool staticUnconditionalAttribute()
    {
        return true;
    }
    bool unconditionalMethod()
    {
        return true;
    }
    ...
    static bool staticUnconditionalMethod()
    {
        return true;
    }
    static const uint16_t kUnconditionalConstant = 99;

    bool secureUnconditionalAttribute()
    {
        return true;
    }
    static bool secureStaticUnconditionalAttribute()
    {
        return true;
    }
    bool secureUnconditionalMethod()
    {
        return true;
    }
    static bool secureStaticUnconditionalMethod()
    {
        return true;
    }
    ...
    static bool secureStaticAttribute()
    {
        return true;
    }
    bool secureMethod()
    ...
    static bool secureStaticMethod()
    {
        return true;
    }

    bool deprecationAttribute()
    {
        return true;
    }

    bool impliedAttribute()
    {
        return true;
    }

    bool invalidOSAttribute()
    {
        return true;
    }

    bool navigationMethod()
    {
        return true;
    }

    bool thirdPartyAttribute()
    {
        return true;
    }
};
