...
protected:
    explicit SimTest(std::optional<base::test::TaskEnvironment::TimeSource> time_source = std::nullopt);
    ~SimTest() override;
    ...
    virtual frame_test_helpers::TestWebFrameWidget* CreateWebFrameWidget(base::PassKey<WebLocalFrame> pass_key,
    ...
    virtual std::unique_ptr<frame_test_helpers::TestWebFrameClient> CreateWebFrameClientForMainFrame();
