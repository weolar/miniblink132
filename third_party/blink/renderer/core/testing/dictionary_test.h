...
public:
    ...
    void setDerived(v8::Isolate* isolate, const InternalDictionaryDerived* input_dictionary);
    InternalDictionaryDerived* getDerived(v8::Isolate* isolate);

    void setDerivedDerived(v8::Isolate* isolate, const InternalDictionaryDerivedDerived* input_dictionary);
...
private:
    ...
    void RestoreInternalDictionaryDerived(InternalDictionaryDerived* output_dictionary);
    void RestoreInternalDictionaryDerivedDerived(InternalDictionaryDerivedDerived* output_dictionary);
