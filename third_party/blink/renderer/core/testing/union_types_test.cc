...
V8UnionDoubleOrStringOrStringSequence* UnionTypesTest::doubleOrStringOrStringSequenceAttribute() const
{
    switch (attribute_type_) {
    case kSpecificTypeDouble:
        return MakeGarbageCollected<V8UnionDoubleOrStringOrStringSequence>(attribute_double_);
    case kSpecificTypeString:
        return MakeGarbageCollected<V8UnionDoubleOrStringOrStringSequence>(attribute_string_);
    case kSpecificTypeStringSequence:
        return MakeGarbageCollected<V8UnionDoubleOrStringOrStringSequence>(attribute_string_sequence_);
    }
    NOTREACHED();
}

void UnionTypesTest::setDoubleOrStringOrStringSequenceAttribute(const V8UnionDoubleOrStringOrStringSequence* value)
{
    DCHECK(value);
...
String UnionTypesTest::doubleOrStringArg(V8UnionDoubleOrString* arg)
{
    ...
    case V8UnionDoubleOrString::ContentType::kDouble:
        return "double is passed: " + String::NumberToStringECMAScript(arg->GetAsDouble());
...
String UnionTypesTest::doubleOrInternalEnumArg(V8UnionDoubleOrInternalEnum* arg)
{
    DCHECK(arg);
...
String UnionTypesTest::doubleOrStringSequenceArg(const HeapVector<Member<V8UnionDoubleOrString>>& sequence)
{
    ...
    for (auto& double_or_string : sequence) {
        ...
        case V8UnionDoubleOrString::ContentType::kDouble:
            ...
            builder.Append(String::NumberToStringECMAScript(double_or_string->GetAsDouble()));
            break;
        case V8UnionDoubleOrString::ContentType::kString:
...
String UnionTypesTest::nodeListOrElementArg(const V8UnionElementOrNodeList* arg)
{
    DCHECK(arg);
    return nodeListOrElementOrNullArg(arg);
}

String UnionTypesTest::nodeListOrElementOrNullArg(const V8UnionElementOrNodeList* arg)
{
    if (!arg)
...
String UnionTypesTest::doubleOrStringOrStringSequenceArg(const V8UnionDoubleOrStringOrStringSequence* arg)
{
    if (!arg)
        return "null";
