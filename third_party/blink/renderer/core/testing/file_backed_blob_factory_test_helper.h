...
public:
    ...
    FileBackedBlobFactoryTestHelper(const FileBackedBlobFactoryTestHelper&) = delete;
    FileBackedBlobFactoryTestHelper& operator=(const FileBackedBlobFactoryTestHelper&) = delete;
