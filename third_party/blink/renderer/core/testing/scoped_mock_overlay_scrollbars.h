...
public:
    explicit ScopedMockOverlayScrollbars(bool use_mock_overlay_scrollbars = true)
        ...
        , original_mock_scrollbars_enabled_(ScrollbarThemeSettings::MockScrollbarsEnabled())
        , original_overlay_scrollbars_enabled_(ScrollbarThemeSettings::OverlayScrollbarsEnabled())
    {
        ScrollbarThemeSettings::SetOverlayScrollbarsEnabled(use_mock_overlay_scrollbars);
        ScrollbarThemeSettings::SetMockScrollbarsEnabled(use_mock_overlay_scrollbars);
    }
    ...
    ~ScopedMockOverlayScrollbars()
    {
        ...
        DCHECK_EQ(use_mock_overlay_scrollbars_, ScrollbarThemeSettings::OverlayScrollbarsEnabled());
        DCHECK_EQ(use_mock_overlay_scrollbars_, ScrollbarThemeSettings::MockScrollbarsEnabled());
        ScrollbarThemeSettings::SetMockScrollbarsEnabled(original_mock_scrollbars_enabled_);
        ScrollbarThemeSettings::SetOverlayScrollbarsEnabled(original_overlay_scrollbars_enabled_);
    }
    ...
    bool IsSuccessful() const
    {
        ...
        if (use_mock_overlay_scrollbars_)
            return true;
#if BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_IOS) || BUILDFLAG(IS_FUCHSIA)
