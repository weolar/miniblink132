...
public:
    ...
    void setNullableStringLongRecord(const std::optional<Vector<std::pair<String, int32_t>>>& arg);
    std::optional<Vector<std::pair<String, int32_t>>> getNullableStringLongRecord();

    Vector<std::pair<String, String>> GetByteStringByteStringRecord();
    void setByteStringByteStringRecord(const Vector<std::pair<String, String>>& arg);

    void setStringElementRecord(const HeapVector<std::pair<String, Member<Element>>>& arg);
    HeapVector<std::pair<String, Member<Element>>> getStringElementRecord();

    using NestedRecordType = Vector<std::pair<String, Vector<std::pair<String, bool>>>>;
    ...
    Vector<std::pair<String, Vector<String>>> returnStringByteStringSequenceRecord();

    bool unionReceivedARecord(const V8UnionBooleanOrByteStringByteStringRecord* arg);
...
private:
    ...
    std::optional<Vector<std::pair<String, int32_t>>> nullable_string_long_record_;
