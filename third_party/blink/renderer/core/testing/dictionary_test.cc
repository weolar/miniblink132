...
void DictionaryTest::set(v8::Isolate* isolate, const InternalDictionary* input_dictionary)
{
    ...
    SAVE_DICT_MEMBER(stringSequenceMemberWithDefault, StringSequenceMemberWithDefault);
    ...
    SAVE_DICT_MEMBER(objectOrNullMemberWithDefault, ObjectOrNullMemberWithDefault);
    ...
    SAVE_DICT_MEMBER(internalEnumOrInternalEnumSequenceMember, InternalEnumOrInternalEnumSequenceMember);
...
void DictionaryTest::setDerived(v8::Isolate* isolate, const InternalDictionaryDerived* input_dictionary)
{
    set(isolate, input_dictionary);

    SAVE_DICT_MEMBER(derivedStringMember, DerivedStringMember);
    SAVE_DICT_MEMBER(derivedStringMemberWithDefault, DerivedStringMemberWithDefault);
...
{
    InternalDictionaryDerived* dictionary = InternalDictionaryDerived::Create(isolate);
    RestoreInternalDictionaryDerived(dictionary);
    return dictionary;
}

void DictionaryTest::setDerivedDerived(v8::Isolate* isolate, const InternalDictionaryDerivedDerived* input_dictionary)
{
...
InternalDictionaryDerivedDerived* DictionaryTest::getDerivedDerived(v8::Isolate* isolate)
{
    InternalDictionaryDerivedDerived* dictionary = InternalDictionaryDerivedDerived::Create(isolate);
...
void DictionaryTest::RestoreInternalDictionary(InternalDictionary* output_dictionary)
{
    ...
    RESTORE_DICT_MEMBER(stringSequenceMemberWithDefault, StringSequenceMemberWithDefault);
    ...
    RESTORE_DICT_MEMBER(objectOrNullMemberWithDefault, ObjectOrNullMemberWithDefault);
    RESTORE_DICT_MEMBER(doubleOrStringMember, DoubleOrStringMember);
    RESTORE_DICT_MEMBER(doubleOrStringSequenceMember, DoubleOrStringSequenceMember);
    RESTORE_DICT_MEMBER(eventTargetOrNullMember, EventTargetOrNullMember);
    RESTORE_DICT_MEMBER(internalEnumOrInternalEnumSequenceMember, InternalEnumOrInternalEnumSequenceMember);
    RESTORE_DICT_MEMBER(anyMember, AnyMember);
    RESTORE_DICT_MEMBER(callbackFunctionMember, CallbackFunctionMember);
}

void DictionaryTest::RestoreInternalDictionaryDerived(InternalDictionaryDerived* output_dictionary)
{
    RestoreInternalDictionary(output_dictionary);

    RESTORE_DICT_MEMBER(derivedStringMember, DerivedStringMember);
    RESTORE_DICT_MEMBER(derivedStringMemberWithDefault, DerivedStringMemberWithDefault);
    RESTORE_DICT_MEMBER(requiredBooleanMember, RequiredBooleanMember);
}

void DictionaryTest::RestoreInternalDictionaryDerivedDerived(InternalDictionaryDerivedDerived* output_dictionary)
{
