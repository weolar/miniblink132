...
public:
    ...
    mojo::PendingAssociatedRemote<mojom::blink::RemoteMainFrameHost> BindNewAssociatedRemote();

    // blink::mojom::RemoteMainFrameHost overrides:
    void FocusPage() override;
    void TakeFocus(bool reverse) override;
    void UpdateTargetURL(const KURL&, mojom::blink::RemoteMainFrameHost::UpdateTargetURLCallback) override;
