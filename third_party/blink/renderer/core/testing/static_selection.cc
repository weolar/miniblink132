...
// static
StaticSelection* StaticSelection::FromSelectionInDOMTree(const SelectionInDOMTree& selection)
{
    return MakeGarbageCollected<StaticSelection>(selection);
}

// static
StaticSelection* StaticSelection::FromSelectionInFlatTree(const SelectionInFlatTree& seleciton)
{
