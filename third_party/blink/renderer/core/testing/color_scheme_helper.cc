...
{
    default_preferred_root_scrollbar_color_scheme_ = settings_.GetPreferredRootScrollbarColorScheme();
...
ColorSchemeHelper::~ColorSchemeHelper()
{
    ...
    settings_.SetPreferredRootScrollbarColorScheme(default_preferred_root_scrollbar_color_scheme_);
...
void ColorSchemeHelper::SetPreferredRootScrollbarColorScheme(blink::mojom::PreferredColorScheme preferred_root_scrollbar_color_scheme)
{
    settings_.SetPreferredRootScrollbarColorScheme(preferred_root_scrollbar_color_scheme);
}

void ColorSchemeHelper::SetPreferredColorScheme(mojom::blink::PreferredColorScheme preferred_color_scheme)
{
    settings_.SetPreferredColorScheme(preferred_color_scheme);
}

void ColorSchemeHelper::SetPreferredContrast(mojom::blink::PreferredContrast preferred_contrast)
{
    settings_.SetPreferredContrast(preferred_contrast);
}

void ColorSchemeHelper::SetInForcedColors(Document& document, bool in_forced_colors)
{
...
void ColorSchemeHelper::SetEmulatedForcedColors(Document& document, bool is_dark_theme)
{
