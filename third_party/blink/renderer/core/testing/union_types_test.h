...
public:
    ...
    V8UnionDoubleOrStringOrStringSequence* doubleOrStringOrStringSequenceAttribute() const;
    void setDoubleOrStringOrStringSequenceAttribute(const V8UnionDoubleOrStringOrStringSequence* value);

    String doubleOrStringArg(V8UnionDoubleOrString* arg);
    String doubleOrInternalEnumArg(V8UnionDoubleOrInternalEnum* arg);
    String doubleOrStringSequenceArg(const HeapVector<Member<V8UnionDoubleOrString>>& sequence);
    ...
    String doubleOrStringOrStringSequenceArg(const V8UnionDoubleOrStringOrStringSequence* arg);
