...
public:
    ...
    WorkerBackingThreadStartupData(HeapLimitMode heap_limit_mode, AtomicsWaitMode atomics_wait_mode)
    ...
    {
        return WorkerBackingThreadStartupData(HeapLimitMode::kDefault, AtomicsWaitMode::kDisallow);
    }
...
struct CrossThreadCopier<std::optional<blink::WorkerBackingThreadStartupData>>
    : public CrossThreadCopierPassThrough<std::optional<blink::WorkerBackingThreadStartupData>> { };

// This allows to pass WorkerBackingThreadStartupData across threads by
// PostTask().
template <> struct CrossThreadCopier<blink::WorkerBackingThreadStartupData> : public CrossThreadCopierPassThrough<blink::WorkerBackingThreadStartupData> { };
