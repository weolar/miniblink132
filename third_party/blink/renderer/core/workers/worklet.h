...
class CORE_EXPORT Worklet : public ScriptWrappable, public ExecutionContextLifecycleObserver {
...
public:
    ...
    ScriptPromise<IDLUndefined> addModule(ScriptState*, const String& module_url, const WorkletOptions*, ExceptionState&);
...
protected:
    ...
    wtf_size_t GetNumberOfGlobalScopes() const
    {
...
private:
    virtual void FetchAndInvokeScript(const KURL& module_url_record, V8RequestCredentials::Enum credentials, WorkletPendingTasks*);
