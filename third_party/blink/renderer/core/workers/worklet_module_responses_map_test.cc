...
public:
    ...
    class ClientImpl final : public GarbageCollected<ClientImpl>, public ModuleScriptFetcher::Client {
    public:
        enum class Result { kInitial, kOK, kFailed };

        void NotifyFetchFinishedError(const HeapVector<Member<ConsoleMessage>>&) override
        {
            ASSERT_EQ(Result::kInitial, result_);
            result_ = Result::kFailed;
        }

        void NotifyFetchFinishedSuccess(const ModuleScriptCreationParams& params) override
        {
            ASSERT_EQ(Result::kInitial, result_);
            result_ = Result::kOK;
    ...
    void Fetch(const KURL& url, ClientImpl* client)
    {
        ...
        WorkletModuleScriptFetcher* module_fetcher
            = MakeGarbageCollected<WorkletModuleScriptFetcher>(global_scope_, ModuleScriptLoader::CreatePassKeyForTests());
        module_fetcher->Fetch(fetch_params, ModuleType::kJavaScript, fetcher_.Get(), ModuleGraphLevel::kTopLevelModuleFetch, client);
    }
...
TEST_F(WorkletModuleResponsesMapTest, Basic)
{
    ...
    url_test_helpers::RegisterMockedURLLoad(kUrl, test::CoreTestDataPath("module.js"), "text/javascript", platform_->GetURLLoaderMockFactory());
...
{
    const KURL kUrl("https://example.com/module.js");
    url_test_helpers::RegisterMockedErrorURLLoad(kUrl, platform_->GetURLLoaderMockFactory());
    HeapVector<Member<ClientImpl>> clients;
...
TEST_F(WorkletModuleResponsesMapTest, Isolation)
{
    ...
    url_test_helpers::RegisterMockedErrorURLLoad(kUrl1, platform_->GetURLLoaderMockFactory());
    url_test_helpers::RegisterMockedURLLoad(kUrl2, test::CoreTestDataPath("module.js"), "text/javascript", platform_->GetURLLoaderMockFactory());
    HeapVector<Member<ClientImpl>> clients;
...
TEST_F(WorkletModuleResponsesMapTest, Dispose)
{
    const KURL kUrl1("https://example.com/module?1.js");
    const KURL kUrl2("https://example.com/module?2.js");
    url_test_helpers::RegisterMockedURLLoad(kUrl1, test::CoreTestDataPath("module.js"), "text/javascript", platform_->GetURLLoaderMockFactory());
    url_test_helpers::RegisterMockedURLLoad(kUrl2, test::CoreTestDataPath("module.js"), "text/javascript", platform_->GetURLLoaderMockFactory());
    HeapVector<Member<ClientImpl>> clients;
