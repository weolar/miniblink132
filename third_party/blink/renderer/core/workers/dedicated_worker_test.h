...
public:
    ...
    explicit DedicatedWorkerTest(base::test::TaskEnvironment::TimeSource time_source)
    ...
    DedicatedWorker* WorkerObject()
    {
        return worker_object_;
    }
...
protected:
    Event* CreateAndDispatchEvent(base::OnceCallback<void(BlinkTransferableMessage)> post_event_callback);
