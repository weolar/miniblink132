...
public:
    ...
    virtual void FetchAndInvokeScript(const KURL& module_url_record, network::mojom::CredentialsMode,
        ...
        scoped_refptr<base::SingleThreadTaskRunner> outside_settings_task_runner, WorkletPendingTasks*)
        = 0;
