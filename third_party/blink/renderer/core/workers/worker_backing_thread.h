...
public:
    ...
    static void MemoryPressureNotificationToWorkerThreadIsolates(v8::MemoryPressureLevel);
    static void SetWorkerThreadIsolatesPriority(v8::Isolate::Priority priority);
    static void SetBatterySaverModeForWorkerThreadIsolates(bool battery_saver_mode_enabled);
