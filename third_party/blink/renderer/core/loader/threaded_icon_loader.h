...
class CORE_EXPORT ThreadedIconLoader final : public GarbageCollected<ThreadedIconLoader>, public ThreadableLoaderClient {
public:
    ...
    using IconCallback = base::OnceCallback<void(SkBitmap icon, double resize_scale)>;
    ...
    // those dimensions.
    void Start(ExecutionContext* execution_context, const ResourceRequestHead& resource_request, const std::optional<gfx::Size>& resize_dimensions,
