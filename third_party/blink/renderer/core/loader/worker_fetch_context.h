...
public:
    WorkerFetchContext(const DetachableResourceFetcherProperties&, WorkerOrWorkletGlobalScope&, scoped_refptr<WebWorkerFetchContext>, SubresourceFilter*,
        ContentSecurityPolicy&, WorkerResourceTimingNotifier&);
    ...
    bool AllowRunningInsecureContent(bool enabled_per_settings, const KURL& url) const;
...
private:
    ...
    const CrossThreadPersistent<WorkerResourceTimingNotifier> resource_timing_notifier_;
