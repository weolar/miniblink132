...
class WebBundleLoader : public GarbageCollected<WebBundleLoader>, public ThreadableLoaderClient, public network::mojom::blink::WebBundleHandle {
public:
    WebBundleLoader(SubresourceWebBundle& subresource_web_bundle, Document& document, const KURL& url, network::mojom::CredentialsMode credentials_mode);

    void Trace(Visitor* visitor) const override;

    bool HasLoaded() const
    {
        return load_state_ == LoadState::kSuccess;
    }
    bool HasFailed() const
    {
        return load_state_ == LoadState::kFailed;
    }
    ...
    void Clone(mojo::PendingReceiver<network::mojom::blink::WebBundleHandle> receiver) override;
    void OnWebBundleError(network::mojom::blink::WebBundleErrorType type, const String& message) override;
...
private:
    ...
    HeapMojoReceiverSet<network::mojom::blink::WebBundleHandle, WebBundleLoader> receivers_;
};
