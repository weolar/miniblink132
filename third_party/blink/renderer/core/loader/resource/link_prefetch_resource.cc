...
Resource* LinkPrefetchResource::Fetch(FetchParameters& params, ResourceFetcher* fetcher)
{
    return fetcher->RequestResource(params, Factory(), nullptr);
}

LinkPrefetchResource::LinkPrefetchResource(const ResourceRequest& request, const ResourceLoaderOptions& options)
...
Resource* LinkPrefetchResource::Factory::Create(const ResourceRequest& request, const ResourceLoaderOptions& options) const
{
