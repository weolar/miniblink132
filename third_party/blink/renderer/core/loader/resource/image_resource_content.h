...
class CORE_EXPORT ImageResourceContent final : public GarbageCollected<ImageResourceContent>, public ImageObserver, public MediaTiming {
public:
    // Used for loading.
    ...
    gfx::Size IntrinsicSize(RespectImageOrientationEnum should_respect_image_orientation) const;
    ...
    // content.
    RespectImageOrientationEnum ForceOrientationIfNecessary(RespectImageOrientationEnum default_orientation) const;
    ...
    void EmulateLoadStartedForInspector(ResourceFetcher*, const AtomicString& initiator_name);
    ...
    [[nodiscard]] UpdateImageResult UpdateImage(scoped_refptr<SharedBuffer>, ResourceStatus, UpdateImageOption, bool all_data_received, bool is_multipart);
