...
class CORE_EXPORT MultipartImageResourceParser final : public GarbageCollected<MultipartImageResourceParser> {
public:
    ...
    MultipartImageResourceParser& operator=(const MultipartImageResourceParser&) = delete;
    ...
    static wtf_size_t SkippableLengthForTest(const Vector<char>& data, wtf_size_t size)
    {
        return SkippableLength(data, size);
    }
    static wtf_size_t FindBoundaryForTest(const Vector<char>& data, Vector<char>* boundary)
    {
...
private:
    ...
    static wtf_size_t FindBoundary(const Vector<char>& data, Vector<char>* boundary);
