...
public:
    ...
    SpeculationRulesResource(const ResourceRequest&, const ResourceLoaderOptions&);
...
private:
    ...
    public:
        ...
        Resource* Create(
            const ResourceRequest& request, const ResourceLoaderOptions& options, const TextResourceDecoderOptions& decoder_options) const override;
    };
};

template <> struct DowncastTraits<SpeculationRulesResource> {
