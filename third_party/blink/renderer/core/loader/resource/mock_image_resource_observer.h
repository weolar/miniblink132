...
class MockImageResourceObserver final : public GarbageCollected<MockImageResourceObserver>, public ImageResourceObserver {
public:
    ...
    int ImageChangedCount() const
    {
        return image_changed_count_;
    }
    ...
    CanDeferInvalidation Defer() const
    {
        return defer_;
    }
...
private:
    ...
    {
        return "MockImageResourceObserver";
    }
