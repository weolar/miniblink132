...
public:
    static SVGDocumentResource* Fetch(FetchParameters&, ResourceFetcher*, AgentGroupScheduler&);

    SVGDocumentResource(const ResourceRequest&, const ResourceLoaderOptions&, const TextResourceDecoderOptions&, SVGResourceDocumentContent*);
    ...
    SVGResourceDocumentContent* GetContent() const
    {
        return content_.Get();
    }
...
template <> struct DowncastTraits<SVGDocumentResource> {
