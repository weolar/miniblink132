...
class CORE_EXPORT WorkerResourceTimingNotifierImpl final : public WorkerResourceTimingNotifier {
public:
    static WorkerResourceTimingNotifierImpl* CreateForInsideResourceFetcher(ExecutionContext&);
    static WorkerResourceTimingNotifierImpl* CreateForOutsideResourceFetcher(ExecutionContext&);

    // Do not call this. Use static creation function instead. This is public
    // only for MakeGarbageCollected.
    explicit WorkerResourceTimingNotifierImpl(scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    WorkerResourceTimingNotifierImpl(const WorkerResourceTimingNotifierImpl&) = delete;
    WorkerResourceTimingNotifierImpl& operator=(const WorkerResourceTimingNotifierImpl&) = delete;
...
private:
    void AddCrossThreadResourceTiming(mojom::blink::ResourceTimingInfoPtr, const String& initiator_type);
...
class CORE_EXPORT NullWorkerResourceTimingNotifier final : public WorkerResourceTimingNotifier {
public:
    NullWorkerResourceTimingNotifier() = default;
    NullWorkerResourceTimingNotifier(const NullWorkerResourceTimingNotifier&) = delete;
    NullWorkerResourceTimingNotifier& operator=(const NullWorkerResourceTimingNotifier&) = delete;
