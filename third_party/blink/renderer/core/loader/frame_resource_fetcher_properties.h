...
// for Frame.
class CORE_EXPORT FrameResourceFetcherProperties final : public ResourceFetcherProperties {
public:
    FrameResourceFetcherProperties(DocumentLoader& document_loader, Document& document);
