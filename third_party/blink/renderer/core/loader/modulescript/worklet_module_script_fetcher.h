...
class CORE_EXPORT WorkletModuleScriptFetcher final : public GarbageCollected<WorkletModuleScriptFetcher>, public ModuleScriptFetcher {
public:
    WorkletModuleScriptFetcher(WorkletGlobalScope*, base::PassKey<ModuleScriptLoader>);
...
private:
    ...
    {
        return "WorkletModuleScriptFetcher";
    }
