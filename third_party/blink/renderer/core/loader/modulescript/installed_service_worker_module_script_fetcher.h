...
class CORE_EXPORT InstalledServiceWorkerModuleScriptFetcher final : public GarbageCollected<InstalledServiceWorkerModuleScriptFetcher>,
                                                                    public ModuleScriptFetcher {
public:
    InstalledServiceWorkerModuleScriptFetcher(WorkerGlobalScope*, base::PassKey<ModuleScriptLoader>);
