...
class CORE_EXPORT WorkerModuleScriptFetcher final : public GarbageCollected<WorkerModuleScriptFetcher>,
                                                    public ModuleScriptFetcher,
                                                    public WorkerMainScriptLoaderClient {
public:
    WorkerModuleScriptFetcher(WorkerGlobalScope*, base::PassKey<ModuleScriptLoader>);

    // Implements ModuleScriptFetcher.
    void Fetch(FetchParameters&, ModuleType, ResourceFetcher*, ModuleGraphLevel, ModuleScriptFetcher::Client*) override;
    ...
    void OnStartLoadingBodyWorkerMainScript(const ResourceResponse& resource_response) override;
...
private:
    ...
    {
        return "WorkerModuleScriptFetcher";
    }

    void NotifyClient(const KURL& request_url, ModuleType module_type, const ParkableString& source_text, const ResourceResponse& response,
