...
class CORE_EXPORT DocumentModuleScriptFetcher final : public GarbageCollected<DocumentModuleScriptFetcher>,
                                                      public ModuleScriptFetcher,
                                                      public ExecutionContextClient {
public:
    explicit DocumentModuleScriptFetcher(ExecutionContext* execution_context, base::PassKey<ModuleScriptLoader>);

    // Implements ModuleScriptFetcher.
    void Fetch(FetchParameters&, ModuleType, ResourceFetcher*, ModuleGraphLevel, Client*) override;

    // Implements ResourceClient
    void NotifyFinished(Resource*) override;
    String DebugName() const override
    {
        return "DocumentModuleScriptFetcher";
    }
