...
TEST_F(RenderBlockingResourceManagerTest, FastFontFinishBeforeBody)
{
    ...
    SimSubresourceRequest font_resource("https://example.com/font.woff", "font/woff2");
...
TEST_F(RenderBlockingResourceManagerTest, OptionalFontForcedLayoutNoLayoutShift)
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/Ahem.woff2", "font/woff2");
...
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest style_resource("https://example.com/sheet.css", "text/css");
...
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/font.woff2", "font/woff2");
    SimSubresourceRequest script_resource("https://example.com/script.js", "application/javascript");
...
public:
    void SetUp() override
    {
        ...
        scoped_feature_list_.InitAndEnableFeatureWithParameters(features::kRenderBlockingFonts, parameters);
        SimTest::SetUp();
    }
...
TEST_F(RenderBlockingFontTest, SlowFontPreloadWithoutOtherBlockingResources)
{
    ...
    test::RunDelayedTasks(base::Milliseconds(features::kMaxFCPDelayMsForRenderBlockingFonts.Get()));
...
TEST_F(RenderBlockingFontTest, SlowFontPreloadAndSlowBodyWithoutOtherBlockingResources)
{
    SimRequest main_resource("https://example.com", "text/html");
    SimSubresourceRequest font_resource("https://example.com/font.woff2", "font/woff2");
    ...
    test::RunDelayedTasks(base::Milliseconds(features::kMaxBlockingTimeMsForRenderBlockingFonts.Get()));
...
TEST_F(RenderBlockingFontTest, FontPreloadExceedingMaxFCPDelay)
{
    ...
    EXPECT_FALSE(GetRenderBlockingResourceManager().HasNonFontRenderBlockingResources());
    EXPECT_TRUE(Compositor().DeferMainFrameUpdate());
