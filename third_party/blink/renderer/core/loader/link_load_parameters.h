...
struct CORE_EXPORT LinkLoadParameters {
    ...
    LinkLoadParameters(const LinkRelAttribute&, const CrossOriginAttributeValue&, const String& type, const String& as, const String& media,
        const String& nonce, const String& integrity, const String& fetch_priority_hint, network::mojom::ReferrerPolicy, const KURL& href,
        const String& image_srcset, const String& image_sizes, const String& blocking, Reason reason = Reason::kDefault);
