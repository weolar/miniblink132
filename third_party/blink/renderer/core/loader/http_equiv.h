...
public:
    static void Process(Document&, const AtomicString& equiv, const AtomicString& content, bool in_document_head_element, bool is_sync_parser, Element*);

private:
    static void ProcessHttpEquivDefaultStyle(Document&, const AtomicString& content);
    static void ProcessHttpEquivOriginTrial(LocalDOMWindow*, const AtomicString& content);
    static void ProcessHttpEquivRefresh(LocalDOMWindow*, const AtomicString& content, Element*);
    static void ProcessHttpEquivSetCookie(Document&, const AtomicString& content, Element*);
    static void ProcessHttpEquivContentSecurityPolicy(LocalDOMWindow*, const AtomicString& equiv, const AtomicString& content);
};
