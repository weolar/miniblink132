...
{
    DEFINE_STATIC_LOCAL(Persistent<LongTaskDetector>, long_task_detector, (MakeGarbageCollected<LongTaskDetector>()));
    DCHECK(IsMainThread());
...
void LongTaskDetector::DidProcessTask(base::TimeTicks start_time, base::TimeTicks end_time)
{
