...
public:
    WorkerResourceFetcherProperties(
        WorkerOrWorkletGlobalScope&, const FetchClientSettingsObject& fetch_client_settings_object, scoped_refptr<WebWorkerFetchContext> web_context);
    ...
    {
        DCHECK_NE(GetControllerServiceWorkerMode(), mojom::ControllerServiceWorkerMode::kNoController);
