...
public:
    ...
    virtual void OnLongTaskDetected(base::TimeTicks start_time, base::TimeTicks end_time) = 0;
};
...
// TaskTimeObserver.
class CORE_EXPORT LongTaskDetector final : public GarbageCollected<LongTaskDetector>, public base::sequence_manager::TaskTimeObserver {
public:
