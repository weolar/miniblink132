...
enum class NavigateEventType { kFragment, kHistoryApi, kCrossDocument, kPrerenderNoVarySearchActivation };

struct CORE_EXPORT NavigateEventDispatchParams : public GarbageCollected<NavigateEventDispatchParams> {
public:
