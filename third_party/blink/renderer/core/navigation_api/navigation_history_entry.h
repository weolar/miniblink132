...
class CORE_EXPORT NavigationHistoryEntry final : public EventTarget, public ExecutionContextClient {
    DEFINE_WRAPPERTYPEINFO();

public:
    NavigationHistoryEntry(
        LocalDOMWindow*, const String& key, const String& id, const KURL& url, int64_t document_sequence_number, scoped_refptr<SerializedScriptValue>);
    ...
    SerializedScriptValue* GetSerializedState()
    {
        return state_.get();
    }
