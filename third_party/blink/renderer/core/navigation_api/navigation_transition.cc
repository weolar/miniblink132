...
namespace blink {
NavigationTransition::NavigationTransition(ExecutionContext* context, V8NavigationType::Enum navigation_type, NavigationHistoryEntry* from)
...
ScriptPromise<IDLUndefined> NavigationTransition::finished(ScriptState* script_state)
{
