...
public:
    ...
    bool BeginNavigationCalled() const
    {
        return begin_navigation_called_;
    }
...
{
    url_test_helpers::RegisterMockedURLLoad(url_test_helpers::ToKURL("https://example.com/navigation-api/onnavigate-preventDefault.html"),
        test::CoreTestDataPath("navigation-api/onnavigate-preventDefault.html"));

    BeginNavigationClient client;
    frame_test_helpers::WebViewHelper web_view_helper;
    web_view_helper.InitializeAndLoad("https://example.com/navigation-api/onnavigate-preventDefault.html", &client);
    ...
    web_view_helper.LocalMainFrame()->GetFrame()->Loader().StartNavigation(request);
...
TEST_F(NavigationApiTest, BrowserInitiatedSameDocumentBackForward)
{
    ...
    frame_test_helpers::WebViewHelper web_view_helper;
    web_view_helper.InitializeAndLoad("https://example.com/navigation-api/onnavigate-preventDefault.html");
    ...
    auto result1 = document_loader->CommitSameDocumentNavigation(url, WebFrameLoadType::kBackForward, MakeHistoryItemFor(url, key),
        ClientRedirectPolicy::kNotClientRedirect, false /* has_transient_user_activation */, nullptr /* initiator_origin */,
        false /* is_synchronously_committed */, /*source_element=*/nullptr, mojom::blink::TriggeringEventInfo::kNotFromEvent, true /* is_browser_initiated */,
        /*has_ua_visual_transition,=*/false, std::nullopt);
    ...
    auto result2 = document_loader->CommitSameDocumentNavigation(url, WebFrameLoadType::kBackForward, MakeHistoryItemFor(url, key),
        ClientRedirectPolicy::kNotClientRedirect, false /* has_transient_user_activation */, nullptr /* initiator_origin */,
        false /* is_synchronously_committed */, /*source_element=*/nullptr, mojom::blink::TriggeringEventInfo::kNotFromEvent, true /* is_browser_initiated */,
        /*has_ua_visual_transition,=*/false, std::nullopt);
    ...
    auto result3 = document_loader->CommitSameDocumentNavigation(url, WebFrameLoadType::kBackForward, MakeHistoryItemFor(url, key),
        ClientRedirectPolicy::kNotClientRedirect, false /* has_transient_user_activation */, nullptr /* initiator_origin */,
        false /* is_synchronously_committed */, /*source_element=*/nullptr, mojom::blink::TriggeringEventInfo::kNotFromEvent, true /* is_browser_initiated */,
        /*has_ua_visual_transition,=*/false, std::nullopt);
...
{
    url_test_helpers::RegisterMockedURLLoad(url_test_helpers::ToKURL("https://example.com/navigation-api/onnavigate-window-stop.html"),
        test::CoreTestDataPath("navigation-api/onnavigate-window-stop.html"));

    frame_test_helpers::WebViewHelper web_view_helper;
    web_view_helper.InitializeAndLoad("https://example.com/navigation-api/onnavigate-window-stop.html");
...
TEST_F(NavigationApiTest, DispatchNavigateEventAfterPurgeMemory)
{
    ...
    frame->DomWindow()->navigation()->DispatchNavigateEvent(
        MakeGarbageCollected<NavigateEventDispatchParams>(dest_url, NavigateEventType::kFragment, WebFrameLoadType::kStandard));
}
...
TEST_F(NavigationApiTest, UpdateForNavigationAfterPurgeMemory)
{
    ...
    // Should not crash.
    frame->DomWindow()->navigation()->UpdateForNavigation(*item, WebFrameLoadType::kStandard);
}
