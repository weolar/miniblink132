...
PageRevealEvent::PageRevealEvent(const AtomicString& type, const PageRevealEventInit* initializer)
...
void PageRevealEvent::SetViewTransition(DOMViewTransition* dom_view_transition)
{
