...
class CORE_EXPORT ViewTransitionSupplement : public GarbageCollected<ViewTransitionSupplement>, public Supplement<Document>, public ViewTransition::Delegate {
public:
    ...
    // script API.
    // With callback:
    static DOMViewTransition* startViewTransition(ScriptState*, Document&, V8ViewTransitionCallback* callback, ExceptionState&);
    // With options
    static DOMViewTransition* startViewTransition(ScriptState*, Document&, ViewTransitionOptions* options, ExceptionState&);
    // Without callback or options:
    static DOMViewTransition* startViewTransition(ScriptState*, Document&, ExceptionState&);
    ...
    static void SnapshotDocumentForNavigation(
        Document&, const blink::ViewTransitionToken& transition_token, mojom::blink::PageSwapEventParamsPtr, ViewTransition::ViewTransitionStateCallback);
    ...
    static void CreateFromSnapshotForNavigation(Document&, ViewTransitionState transition_state);
    ...
    void OnViewTransitionsStyleUpdated(bool cross_document_enabled, const Vector<String>& types);
    ...
    viz::ViewTransitionElementResourceId GenerateResourceId(const blink::ViewTransitionToken& transition_token);
...
private:
    static DOMViewTransition* StartViewTransitionInternal(
        ScriptState*, Document&, V8ViewTransitionCallback* callback, const std::optional<Vector<String>>& types, ExceptionState&);
    ...
    void StartTransition(Document& document, const blink::ViewTransitionToken& transition_token, mojom::blink::PageSwapEventParamsPtr,
    ...
    mojom::blink::ViewTransitionSameOriginOptIn cross_document_opt_in_ = mojom::blink::ViewTransitionSameOriginOptIn::kDisabled;

    uint32_t resource_local_id_sequence_ = viz::ViewTransitionElementResourceId::kInvalidLocalId;
