...
class CORE_EXPORT ViewTransitionTypeSet : public ScriptWrappable, public ValueSyncIterable<ViewTransitionTypeSet> {
    DEFINE_WRAPPERTYPEINFO();

public:
    explicit ViewTransitionTypeSet(ViewTransition*, const Vector<String>& initial);
    ...
    {
        return types_.Contains(value);
    }
    String At(wtf_size_t index) const
    {
...
protected:
    ...
    IterationSource* CreateIterationSource(ScriptState* script_state, ExceptionState& exception_state) override;
