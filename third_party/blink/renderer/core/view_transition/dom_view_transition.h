...
class CORE_EXPORT DOMViewTransition : public ScriptWrappable, public ExecutionContextLifecycleObserver {
...
public:
    ...
    explicit DOMViewTransition(ExecutionContext&, ViewTransition&, V8ViewTransitionCallback*);
    ...
    ViewTransition* GetViewTransitionForTest()
    {
        return view_transition_.Get();
    }

    void Trace(Visitor* visitor) const override;

private:
    void AtMicrotask(ViewTransition::PromiseResponse response, PromiseProperty* resolver);
    void HandlePromise(ViewTransition::PromiseResponse response, PromiseProperty* property);
