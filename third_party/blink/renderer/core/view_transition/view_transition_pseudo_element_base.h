...
public:
    ViewTransitionPseudoElementBase(Element* parent, PseudoId, const AtomicString& view_transition_name, const ViewTransitionStyleTracker* style_tracker);
...
template <> struct DowncastTraits<ViewTransitionPseudoElementBase> {
