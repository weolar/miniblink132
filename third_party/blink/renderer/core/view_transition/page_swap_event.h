...
public:
    PageSwapEvent(Document&, mojom::blink::PageSwapEventParamsPtr, DOMViewTransition*);
    PageSwapEvent(const AtomicString&, const PageSwapEventInit*);

    static PageSwapEvent* Create(const AtomicString& type, const PageSwapEventInit* initializer)
    {
...
template <> struct DowncastTraits<PageSwapEvent> {
