...
SpeechSynthesisBase::SpeechSynthesisBaseCreateFunction SpeechSynthesisBase::create_function_ = nullptr;
...
void SpeechSynthesisBase::SetOnSpeakingCompletedCallback(OnSpeakingCompletedCallback callback)
{
