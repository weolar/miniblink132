...
public:
    ...
    V8HighlightType type() const
    {
        return type_;
    }
    void setType(const V8HighlightType& type)
    {
        type_ = type;
    }
...
private:
    HighlightSetIterable::IterationSource* CreateIterationSource(ScriptState*, ExceptionState&) override;
    ...
    HeapHashMap<Member<HighlightRegistry>, unsigned> containing_highlight_registries_;
