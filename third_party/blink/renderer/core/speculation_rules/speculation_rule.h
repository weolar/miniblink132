...
class CORE_EXPORT SpeculationRule final : public GarbageCollected<SpeculationRule> {
public:
    using RequiresAnonymousClientIPWhenCrossOrigin = base::StrongAlias<class RequiresAnonymousClientIPWhenCrossOriginTag, bool>;

    SpeculationRule(Vector<KURL>, DocumentRulePredicate*, RequiresAnonymousClientIPWhenCrossOrigin,
        std::optional<mojom::blink::SpeculationTargetHint> target_hint, std::optional<network::mojom::ReferrerPolicy>, mojom::blink::SpeculationEagerness,
        network::mojom::blink::NoVarySearchPtr, mojom::blink::SpeculationInjectionType);
    ~SpeculationRule();
    ...
    DocumentRulePredicate* predicate() const
    {
    ...
    std::optional<mojom::blink::SpeculationTargetHint> target_browsing_context_name_hint() const
    {
    ...
    mojom::blink::SpeculationEagerness eagerness() const
    {
        return eagerness_;
    }
    const network::mojom::blink::NoVarySearchPtr& no_vary_search_expected() const
    {
...
private:
    ...
    const std::optional<mojom::blink::SpeculationTargetHint> target_browsing_context_name_hint_;
    ...
    mojom::blink::SpeculationInjectionType injection_type_ = mojom::blink::SpeculationInjectionType::kNone;
};
