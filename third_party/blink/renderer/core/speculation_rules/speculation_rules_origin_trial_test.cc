...
[[maybe_unused]] constexpr char kSpeculationRulesPrefetchToken[] = "A3S8LtUYS39YgB/jc0a04rQIVhfaBWRbQ7ewo8GkBDbwSu5v0RAkybhXtsI/uVkwex"
...
[[maybe_unused]] ::testing::AssertionResult DocumentAcceptsRuleSet(const char* trial_token, const char* json)
{
    ...
    security_context.SetSecurityOrigin(SecurityOrigin::CreateFromString("https://speculationrules.test"));
    ...
    HTMLMetaElement* meta = MakeGarbageCollected<HTMLMetaElement>(document, CreateElementFlags());
    ...
    return speculation_host.candidates().empty() ? ::testing::AssertionFailure() << "no rule set was found"
...
void CommitTestNavigation(LocalFrame& frame, const KURL& url, const Vector<std::pair<String, String>>& response_headers)
{
    auto navigation_params = std::make_unique<WebNavigationParams>();
    navigation_params->url = url;
    WebNavigationParams::FillStaticResponse(navigation_params.get(), "text/html", "UTF-8", base::span_from_cstring("<!DOCTYPE html>"));
...
[[maybe_unused]] constexpr char kSpeculationRulesPrefetchFutureToken[] = "A65w3qdO3g37pxmQiews6uP1bjIR5qb4UX0Rwx7SH3VYbF3rX3hi4EUqqQ7ozG/kfE"
...
TEST(SpeculationRulesPrefetchFutureOriginTrialTest, FirstPartyTrialToken)
{
    ...
    CommitTestNavigation(frame, KURL("https://speculationrules.test/"),
        { { "Origin-Trial", kSpeculationRulesPrefetchFutureToken },
            { "Speculation-Rules", "\"//thirdparty-speculationrules.test/single_url_prefetch.json\"" } });

    // This should have enabled the origin trial and all its dependent features.
    EXPECT_TRUE(RuntimeEnabledFeatures::SpeculationRulesPrefetchFutureEnabled(frame.DomWindow()));
}
