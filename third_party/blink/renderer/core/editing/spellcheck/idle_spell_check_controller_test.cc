...
{
    SetBodyContent("<div contenteditable style=\"width:800px\">"
                   "foo"
                   "<menu style=\"all: initial\">1127</menu>"
                   "<object><optgroup></optgroup></object>"
                   "</div>");
    auto* html_object_element = To<HTMLObjectElement>(GetDocument().QuerySelector(AtomicString("object")));
    html_object_element->RenderFallbackContent(HTMLObjectElement::ErrorEventPolicy::kDispatch);
