...
class CORE_EXPORT IdleSpellCheckController final : public GarbageCollected<IdleSpellCheckController>, public ExecutionContextLifecycleObserver {
public:
...
#undef V
    ...
    int IdleCallbackHandle() const
    {
        return idle_callback_handle_;
    }
...
private:
    ...
    {
        return state_ == State::kInHotModeInvocation || state_ == State::kInColdModeInvocation;
    }
