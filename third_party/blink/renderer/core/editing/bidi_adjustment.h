...
public:
    ...
    static InlineCaretPosition AdjustForInlineCaretPositionResolution(const InlineCaretPosition&);
    ...
    static SelectionInFlatTree AdjustForRangeSelection(const PositionInFlatTreeWithAffinity&, const PositionInFlatTreeWithAffinity&);
};
