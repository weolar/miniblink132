...
TextSegmentationMachineState ForwardCodePointStateMachine::FeedFollowingCodeUnit(UChar code_unit)
{
    switch (state_) {
...
TextSegmentationMachineState ForwardCodePointStateMachine::FeedPrecedingCodeUnit(UChar code_unit)
{
    NOTREACHED();
}
