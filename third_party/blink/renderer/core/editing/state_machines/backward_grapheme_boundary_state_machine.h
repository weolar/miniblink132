...
public:
    ...
    BackwardGraphemeBoundaryStateMachine(const BackwardGraphemeBoundaryStateMachine&) = delete;
    BackwardGraphemeBoundaryStateMachine& operator=(const BackwardGraphemeBoundaryStateMachine&) = delete;
