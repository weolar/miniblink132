...
public:
    ...
    ForwardGraphemeBoundaryStateMachine(const ForwardGraphemeBoundaryStateMachine&) = delete;
    ForwardGraphemeBoundaryStateMachine& operator=(const ForwardGraphemeBoundaryStateMachine&) = delete;
