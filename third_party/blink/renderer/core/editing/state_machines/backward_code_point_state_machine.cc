...
TextSegmentationMachineState BackwardCodePointStateMachine::FeedPrecedingCodeUnit(UChar code_unit)
{
    switch (state_) {
...
TextSegmentationMachineState BackwardCodePointStateMachine::FeedFollowingCodeUnit(UChar code_unit)
{
    NOTREACHED();
}
