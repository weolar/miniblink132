...
TEST(StateMachineUtilTest, IsGraphmeBreak_Extend_or_ZWJ)
{
    ...
    EXPECT_FALSE(IsGraphemeBreak(WTF::unicode::kZeroWidthJoinerCharacter, WTF::unicode::kZeroWidthJoinerCharacter));
    EXPECT_FALSE(IsGraphemeBreak(kExtend, WTF::unicode::kZeroWidthJoinerCharacter));
    EXPECT_FALSE(IsGraphemeBreak(WTF::unicode::kZeroWidthJoinerCharacter, kExtend));
}
...
TEST(StateMachineUtilTest, IsGraphmeBreak_ZWJSequecne)
{
    ...
    EXPECT_FALSE(IsGraphemeBreak(WTF::unicode::kZeroWidthJoinerCharacter, kGlueAfterZwj));
    EXPECT_FALSE(IsGraphemeBreak(WTF::unicode::kZeroWidthJoinerCharacter, kEBaseGAZ));
