...
public:
    ...
    SelectionState ComputePaintingSelectionStateForCursor(const InlineCursorPosition&) const;
...
private:
    LayoutSelectionStatus ComputeSelectionStatus(const InlineCursor&, const TextOffsetRange&) const;
    SelectionState ComputeSelectionStateFromOffsets(SelectionState state, unsigned start_offset, unsigned end_offset) const;
