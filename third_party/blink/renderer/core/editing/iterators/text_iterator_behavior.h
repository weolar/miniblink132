...
public:
    ...
    {
        return values_.bits.emits_image_alt_text;
    }
    bool EmitsSpaceForNbsp() const
    {
        return values_.bits.emits_space_for_nbsp;
    }
    ...
    {
        return values_.bits.emits_original_text;
    }
    ...
    {
        return values_.bits.enters_text_controls;
    }
    ...
    bool ForWindowFind() const
    {
        return values_.bits.for_window_find;
    }
    ...
    bool IgnoresDisplayLock() const
    {
        return values_.bits.ignores_display_lock;
    }
