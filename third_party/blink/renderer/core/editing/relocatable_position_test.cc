...
TEST_F(RelocatablePositionTest, position)
{
    ...
    RelocatablePosition* relocatable_position = MakeGarbageCollected<RelocatablePosition>(position);
    ...
    EXPECT_EQ(CreateVisiblePosition(expected_position).DeepEquivalent(), CreateVisiblePosition(tracked_position).DeepEquivalent());
}
...
TEST_F(RelocatablePositionTest, positionAnchorTypes)
{
    ...
    RelocatablePosition* relocatable_before = MakeGarbageCollected<RelocatablePosition>(before);
    RelocatablePosition* relocatable_offset0 = MakeGarbageCollected<RelocatablePosition>(offset0);
    RelocatablePosition* relocatable_offset1 = MakeGarbageCollected<RelocatablePosition>(offset1);
    RelocatablePosition* relocatable_after_children = MakeGarbageCollected<RelocatablePosition>(after_children);
    RelocatablePosition* relocatable_after = MakeGarbageCollected<RelocatablePosition>(after);
    ...
    RelocatablePosition* relocatable_offset2 = MakeGarbageCollected<RelocatablePosition>(offset2);
    ...
    RelocatablePosition* relocatable_offset3 = MakeGarbageCollected<RelocatablePosition>(offset3);
