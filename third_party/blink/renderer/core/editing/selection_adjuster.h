...
public:
    static SelectionInDOMTree AdjustSelectionRespectingGranularity(const SelectionInDOMTree&, TextGranularity, const WordInclusion);
    static SelectionInFlatTree AdjustSelectionRespectingGranularity(const SelectionInFlatTree&, TextGranularity, const WordInclusion);
    static SelectionInDOMTree AdjustSelectionToAvoidCrossingShadowBoundaries(const SelectionInDOMTree&);
    static SelectionInFlatTree AdjustSelectionToAvoidCrossingShadowBoundaries(const SelectionInFlatTree&);
    static SelectionInDOMTree AdjustSelectionToAvoidCrossingEditingBoundaries(const SelectionInDOMTree&);
    static SelectionInFlatTree AdjustSelectionToAvoidCrossingEditingBoundaries(const SelectionInFlatTree&);
