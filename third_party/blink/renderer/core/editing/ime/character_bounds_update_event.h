...
public:
    CharacterBoundsUpdateEvent(const AtomicString& type, const CharacterBoundsUpdateEventInit* initializer);
    CharacterBoundsUpdateEvent(const AtomicString& type, uint32_t range_start, uint32_t range_end);
    static CharacterBoundsUpdateEvent* Create(const AtomicString& type, const CharacterBoundsUpdateEventInit* initializer);
