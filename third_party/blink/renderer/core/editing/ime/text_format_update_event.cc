...
TextFormatUpdateEvent::TextFormatUpdateEvent(const AtomicString& type, const TextFormatUpdateEventInit* initializer)
...
TextFormatUpdateEvent::TextFormatUpdateEvent(const AtomicString& type, HeapVector<Member<TextFormat>>& text_formats)
    : Event(type, Bubbles::kNo, Cancelable::kYes, ComposedMode::kComposed, base::TimeTicks::Now())
    , text_formats_(text_formats)
{
}

TextFormatUpdateEvent* TextFormatUpdateEvent::Create(const AtomicString& type, const TextFormatUpdateEventInit* initializer)
{
