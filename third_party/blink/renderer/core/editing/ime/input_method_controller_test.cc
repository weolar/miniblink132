...
protected:
    ...
    // as friend class.
    Range* GetCompositionRange()
    {
        return Controller().composition_range_.Get();
    }
...
Element* InputMethodControllerTest::InsertHTMLElement(const char* element_code, const char* element_id)
{
...
void InputMethodControllerTest::CreateHTMLWithCompositionInputEventListeners()
{
    ...
    script->setInnerHTML("document.getElementById('sample').addEventListener('beforeinput', "
                         "event => {"
...
void InputMethodControllerTest::CreateHTMLWithCompositionEndEventListener(const SelectionType type)
{
    GetDocument().GetSettings()->SetScriptEnabled(true);
    Element* editable = InsertHTMLElement("<div id='sample' contentEditable></div>", "sample");
    Element* script = GetDocument().CreateRawElement(html_names::kScriptTag);
...
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kAutocorrect, 0, 5, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
    ...
    EXPECT_EQ(DocumentMarker::MarkerType::kSuggestion, GetDocument().Markers().Markers()[0]->GetType());
    EXPECT_EQ(SuggestionMarker::SuggestionType::kAutocorrect, To<SuggestionMarker>(GetDocument().Markers().Markers()[0].Get())->GetSuggestionType());
}
...
TEST_F(InputMethodControllerTest, AddGrammarCheckSpans)
{
    ...
    GetDocument().Markers().AddSpellingMarker(EphemeralRange(Position(text, 0), Position(text, 5)));

    Vector<ImeTextSpan> grammar_ime_text_spans;
    grammar_ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kGrammarSuggestion, 3, 6, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
    grammar_ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kGrammarSuggestion, 8, 10, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
    ...
    EXPECT_EQ(0u, GetDocument().Markers().Markers()[0]->StartOffset());
    EXPECT_EQ(5u, GetDocument().Markers().Markers()[0]->EndOffset());
    EXPECT_EQ(DocumentMarker::MarkerType::kSpelling, GetDocument().Markers().Markers()[0]->GetType());
    EXPECT_EQ(8u, GetDocument().Markers().Markers()[1]->StartOffset());
    EXPECT_EQ(10u, GetDocument().Markers().Markers()[1]->EndOffset());
    EXPECT_EQ(DocumentMarker::MarkerType::kSuggestion, GetDocument().Markers().Markers()[1]->GetType());
}

TEST_F(InputMethodControllerTest, GetImeTextSpans)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
    ImeTextSpan span1 = ImeTextSpan(ImeTextSpan::Type::kAutocorrect, 0, 5, Color(255, 0, 0), ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kSolid,
        Color::kTransparent, Color::kTransparent);
    ImeTextSpan span2 = ImeTextSpan(ImeTextSpan::Type::kComposition, 1, 3, Color(255, 0, 0), ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kSolid,
        Color::kTransparent, Color::kTransparent);
    ImeTextSpan span3 = ImeTextSpan(ImeTextSpan::Type::kMisspellingSuggestion, 1, 3, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent);
    ImeTextSpan span4 = ImeTextSpan(ImeTextSpan::Type::kGrammarSuggestion, 6, 8, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent, Color::kTransparent, false, false, { String("fake_suggestion") });

    Controller().AddImeTextSpansToExistingText({ span1, span2, span3, span4 }, 0, 10);
    Controller().SetEditableSelectionOffsets(PlainTextRange(1, 1));

    const WebVector<ui::ImeTextSpan>& ime_text_spans = Controller().TextInputInfo().ime_text_spans;
...
TEST_F(InputMethodControllerTest, SetCompositionAfterEmoji)
{
    ...
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>&#x1f3c6</div>", "sample");

    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 2, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));

    GetDocument().UpdateStyleAndLayout(DocumentUpdateReason::kTest);
    Controller().SetEditableSelectionOffsets(PlainTextRange(2, 2));
    EXPECT_EQ(2, GetFrame().Selection().GetSelectionInDOMTree().Anchor().ComputeOffsetInContainerNode());
    EXPECT_EQ(2, GetFrame().Selection().GetSelectionInDOMTree().Focus().ComputeOffsetInContainerNode());
...
TEST_F(InputMethodControllerTest, SetCompositionWithGraphemeCluster)
{
    ...
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 6, 6, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
    GetDocument().UpdateStyleAndLayout(DocumentUpdateReason::kTest);

    // UTF16 = 0x0939 0x0947 0x0932 0x0932. Note that 0x0932 0x0932 is a grapheme
    // cluster.
    Controller().SetComposition(String::FromUTF8("\xE0\xA4\xB9\xE0\xA5\x87\xE0\xA4\xB2\xE0\xA4\xB2"), ime_text_spans, 4, 4);
    ...
    Controller().SetComposition(String::FromUTF8("\xE0\xA4\xB9\xE0\xA5\x87\xE0\xA4\xB2\xE0\xA5\x8D\xE0"
                                                 "\xA4\xB2\xE0\xA5\x8B"),
        ime_text_spans, 6, 6);
...
TEST_F(InputMethodControllerTest, SetCompositionWithGraphemeClusterAndMultipleNodes)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable></div>", "sample");

    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 12, 12, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
    GetDocument().UpdateStyleAndLayout(DocumentUpdateReason::kTest);
    ...
    Controller().CommitText(String::FromUTF8("\xE0\xA4\xB9\xE0\xA5\x87\xE0\xA4\xB2\xE0\xA5\x8D\xE0"
                                             "\xA4\xB2\xE0\xA5\x8B"),
        ime_text_spans, 1);
    Controller().CommitText("\nab ", ime_text_spans, 1);
    Controller().SetComposition(String("c"), ime_text_spans, 1, 1);
    EXPECT_EQ("\xE0\xA4\xB9\xE0\xA5\x87\xE0\xA4\xB2\xE0\xA5\x8D\xE0\xA4\xB2\xE0\xA5"
              "\x8B\nab c",
        div->innerText().Utf8());
...
{
    Element* div = InsertHTMLElement("<div id='sample' "
                                     "contenteditable>abc1<b>2</b>34567<b>8</b>9d<b>e</b>f</div>",
        "sample");

    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 3, 12, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
...
TEST_F(InputMethodControllerTest, SetCompositionWithEmojiKeepingStyle)
{
    ...
    Element* div = InsertHTMLElement("<div id='sample' contenteditable><b>&#x1f3e0</b></div>", "sample");
    ...
    Controller().SetComposition(String::FromUTF8("\xF0\x9F\x8F\xAB"), ime_text_spans, 2, 2);
    EXPECT_EQ("<b>\xF0\x9F\x8F\xAB</b>", div->innerHTML().Utf8());

    Controller().SetComposition(String::FromUTF8("\xF0\x9F\x8F\xA0"), ime_text_spans, 2, 2);
    EXPECT_EQ("<b>\xF0\x9F\x8F\xA0</b>", div->innerHTML().Utf8());
}

TEST_F(InputMethodControllerTest, SetCompositionWithTeluguSignVisargaKeepingStyle)
{
    ...
    Element* div = InsertHTMLElement("<div id='sample' contenteditable><b>&#xc03</b></div>", "sample");
    ...
    // 1 grapheme cluster.
    Controller().SetComposition(String::FromUTF8("\xE0\xB0\x83\xE0\xB0\x83"), ime_text_spans, 2, 2);
    EXPECT_EQ("<b>\xE0\xB0\x83\xE0\xB0\x83</b>", div->innerHTML().Utf8());

    Controller().SetComposition(String::FromUTF8("\xE0\xB0\x83"), ime_text_spans, 1, 1);
...
{
    GetFrame().Selection().SetSelection(SetSelectionTextToBody("<div contenteditable>|abc^</div>"), SetSelectionOptions());
...
TEST_F(InputMethodControllerTest, InsertTextWithNewLine)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable></div>", "sample");
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 11, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
...
TEST_F(InputMethodControllerTest, SelectionOnConfirmExistingText)
{
    ...
    Controller().FinishComposingText(InputMethodController::kKeepSelection);
    EXPECT_EQ(0, GetFrame().Selection().GetSelectionInDOMTree().Anchor().ComputeOffsetInContainerNode());
    EXPECT_EQ(0, GetFrame().Selection().GetSelectionInDOMTree().Focus().ComputeOffsetInContainerNode());
}
...
TEST_F(InputMethodControllerTest, DeleteBySettingEmptyComposition)
{
    ...
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 3, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
...
TEST_F(InputMethodControllerTest, SetCompositionFromExistingTextWithCollapsedWhiteSpace)
{
    ...
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>\nhello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, SetCompositionFromExistingTextWithInvalidOffsets)
{
    ...
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 7, 8, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
...
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample' type='password' size='24'>", "sample"));
...
TEST_F(InputMethodControllerTest, DeleteSurroundingTextWithMultiCodeTextOnTheLeft)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
...
TEST_F(InputMethodControllerTest, DeleteSurroundingTextWithMultiCodeTextOnTheRight)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
...
TEST_F(InputMethodControllerTest, DeleteSurroundingTextWithMultiCodeTextOnBothSides)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
...
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>aaa"
...
TEST_F(InputMethodControllerTest, DeleteSurroundingTextInCodePointsWithMultiCodeTextOnTheLeft)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
    ...
    // [1,2,2].
    input->SetValue(String::FromUTF8("a\xE2\x98\x85 \xF0\x9F\x8F\x86 \xE0\xB8\x81\xE0\xB9\x89"));
    GetDocument().UpdateStyleAndLayout(DocumentUpdateReason::kTest);
    ...
    EXPECT_EQ("a\xE2\x98\x85 \xF0\x9F\x8F\x86 \xE0\xB8\x81", input->Value().Utf8());
}

TEST_F(InputMethodControllerTest, DeleteSurroundingTextInCodePointsWithMultiCodeTextOnTheRight)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
...
TEST_F(InputMethodControllerTest, DeleteSurroundingTextInCodePointsWithMultiCodeTextOnBothSides)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
...
TEST_F(InputMethodControllerTest, DeleteSurroundingTextInCodePointsWithInvalidSurrogatePair)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
...
TEST_F(InputMethodControllerTest, ReplaceTextAndDoNotChangeSelection)
{
    ...
    Controller().ReplaceTextAndMoveCaret("Hi", PlainTextRange(0, 5), InputMethodController::MoveCaretBehavior::kDoNotMove);
    ...
    Controller().SetEditableSelectionOffsets(PlainTextRange(0, 5));
    // Replace "He" with "Hi".
    Controller().ReplaceTextAndMoveCaret("Hi", PlainTextRange(0, 2), InputMethodController::MoveCaretBehavior::kDoNotMove);
...
TEST_F(InputMethodControllerTest, ReplaceTextAndMoveCursorAfterTheReplacementText)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample'>", "sample"));
    ...
    // the selection range.
    Controller().ReplaceTextAndMoveCaret("night", PlainTextRange(5, 12), InputMethodController::MoveCaretBehavior::kMoveCaretAfterText);
...
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>hello</div>", "sample");
    ...
    ime_text_spans0.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 0, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
    Vector<ImeTextSpan> ime_text_spans2;
    ime_text_spans2.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 2, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
...
TEST_F(InputMethodControllerTest, CompositionInputEventIsComposing)
{
    ...
    Controller().SetComposition("foo", ime_text_spans, 0, 3);
    EXPECT_EQ("beforeinput.isComposing:true;input.isComposing:true;", GetDocument().title());
...
TEST_F(InputMethodControllerTest, CompositionInputEventForReplace)
{
    ...
    EXPECT_EQ("beforeinput.data:hell;beforeinput.targetRanges:0-0;input.data:hell;", GetDocument().title());

    // Replace the existing composition.
    GetDocument().setTitle(g_empty_string);
    Controller().SetComposition("hello", ime_text_spans, 0, 0);
    EXPECT_EQ("beforeinput.data:hello;beforeinput.targetRanges:0-4;input.data:hello;", GetDocument().title());
}
...
TEST_F(InputMethodControllerTest, CompositionInputEventForConfirm)
{
    ...
    GetDocument().setTitle(g_empty_string);
    Controller().SetComposition("hello", ime_text_spans, 5, 5);
    EXPECT_EQ("beforeinput.data:hello;beforeinput.targetRanges:0-0;input.data:hello;", GetDocument().title());
...
TEST_F(InputMethodControllerTest, CompositionInputEventForDelete)
{
    ...
    EXPECT_EQ("beforeinput.data:;beforeinput.targetRanges:0-5;input.data:null;"
              "compositionend.data:;",
        GetDocument().title());
}
...
TEST_F(InputMethodControllerTest, CompositionInputEventForInsert)
{
    ...
    EXPECT_EQ("beforeinput.data:n;beforeinput.targetRanges:5-5;input.data:n;", GetDocument().title());

    // Insert new text with previous composition.
    GetDocument().setTitle(g_empty_string);
    GetDocument().UpdateStyleAndLayout(DocumentUpdateReason::kTest);
    Controller().CommitText("hello", ime_text_spans, 1);
    EXPECT_EQ("beforeinput.data:hello;beforeinput.targetRanges:5-6;input.data:hello;"
...
TEST_F(InputMethodControllerTest, CompositionInputEventForInsertEmptyText)
{
    ...
    GetDocument().setTitle(g_empty_string);
    Controller().SetComposition("n", ime_text_spans, 1, 1);
    EXPECT_EQ("beforeinput.data:n;beforeinput.targetRanges:0-0;input.data:n;", GetDocument().title());

    // Insert empty text with previous composition.
    GetDocument().setTitle(g_empty_string);
    GetDocument().UpdateStyleAndLayout(DocumentUpdateReason::kTest);
    Controller().CommitText("", ime_text_spans, 1);
    EXPECT_EQ("beforeinput.data:;beforeinput.targetRanges:0-1;input.data:null;"
              "compositionend.data:;",
        GetDocument().title());
}
...
{
    Element* input_a = InsertHTMLElement("<input id='a' /><br><input type='tel' id='b' />", "a");
...
TEST_F(InputMethodControllerTest, SetCompositionPlainTextWithIme_Text_Span)
{
    ...
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 1, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
...
TEST_F(InputMethodControllerTest, SetCompositionPlainTextWithIme_Text_Span_Interim_Char_Selection)
{
    InsertHTMLElement("<div id='sample' contenteditable></div>", "sample");

    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 1, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent, Color::kTransparent, false, true /*interim_char_selection*/));

    Controller().SetComposition("a", ime_text_spans, 0, 1);

    ASSERT_EQ(1u, GetDocument().Markers().Markers().size());

    auto* styleable_marker = DynamicTo<StyleableMarker>(GetDocument().Markers().Markers()[0].Get());
    EXPECT_EQ(ImeTextSpanUnderlineStyle::kSolid, styleable_marker->UnderlineStyle());
}

TEST_F(InputMethodControllerTest, CommitPlainTextWithIme_Text_SpanInsert)
{
    InsertHTMLElement("<div id='sample' contenteditable>Initial text.</div>", "sample");

    Vector<ImeTextSpan> ime_text_spans;

    Controller().SetEditableSelectionOffsets(PlainTextRange(8, 8));

    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 1, 11, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
...
TEST_F(InputMethodControllerTest, ImeTextSpanAppearsCorrectlyAfterNewline)
{
    ...
    const Position& first_line_position = PlainTextRange(2).CreateRange(*div).StartPosition();
    const Position& second_line_position = PlainTextRange(8).CreateRange(*div).StartPosition();
    ASSERT_EQ(0u, GetDocument().Markers().MarkersFor(To<Text>(*first_line_position.ComputeContainerNode())).size());
    ASSERT_EQ(1u, GetDocument().Markers().MarkersFor(To<Text>(*second_line_position.ComputeContainerNode())).size());
...
TEST_F(InputMethodControllerTest, SelectionWhenFocusChangeFinishesComposition)
{
    ...
    EXPECT_EQ(3, GetFrame().Selection().GetSelectionInDOMTree().Anchor().ComputeOffsetInContainerNode());
    ...
    EXPECT_TRUE(Controller().HasComposition());
    EXPECT_EQ(7, GetFrame().Selection().GetSelectionInDOMTree().Anchor().ComputeOffsetInContainerNode());
...
{
    auto* textarea = To<HTMLTextAreaElement>(InsertHTMLElement("<textarea id='txt'>", "txt"));
...
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text blah</div>", "sample");
...
static String GetMarkedText(DocumentMarkerController& document_marker_controller, Node* node, int marker_index)
{
    DocumentMarker* marker = document_marker_controller.Markers()[marker_index];
    return node->textContent().Substring(marker->StartOffset(), marker->EndOffset() - marker->StartOffset());
}

TEST_F(InputMethodControllerTest, Marker_WhitespaceFixupAroundContentIndependentMarkerNotContainingSpace)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text blah</div>", "sample");
    ...
    GetDocument().Markers().AddActiveSuggestionMarker(
        marker_range, Color::kBlack, ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kSolid, Color::kBlack, Color::kBlack);
    // Delete "Initial"
    Vector<ImeTextSpan> empty_ime_text_spans;
    Controller().SetCompositionFromExistingText(empty_ime_text_spans, 0, 7);
    Controller().CommitText(String(""), empty_ime_text_spans, 0);
    ...
    EXPECT_EQ(1u, GetDocument().Markers().MarkersFor(To<Text>(*div->firstChild())).size());
    EXPECT_EQ("text", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0));
}

TEST_F(InputMethodControllerTest, Marker_WhitespaceFixupAroundContentIndependentMarkerBeginningWithSpace)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text blah</div>", "sample");
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_EQ("\xC2\xA0text", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0).Utf8());
}

TEST_F(InputMethodControllerTest, Marker_WhitespaceFixupAroundContentIndependentMarkerEndingWithSpace)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text blah</div>", "sample");
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_EQ("text\xC2\xA0", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0).Utf8());
}

TEST_F(InputMethodControllerTest, Marker_WhitespaceFixupAroundContentIndependentMarkerBeginningAndEndingWithSpaces)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text blah</div>", "sample");
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_EQ("\xC2\xA0text\xC2\xA0", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0).Utf8());
}

TEST_F(InputMethodControllerTest, ContentDependentMarker_ReplaceStartOfMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text</div>", "sample");

    // Add marker under "Initial text"
    EphemeralRange marker_range = PlainTextRange(0, 12).CreateRange(*div);
    GetDocument().Markers().AddTextMatchMarker(marker_range, TextMatchMarker::MatchStatus::kInactive);
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_ReplaceStartOfMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text</div>", "sample");
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_EQ("Original text", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0).Utf8());
}

TEST_F(InputMethodControllerTest, ContentDependentMarker_ReplaceTextContainsStartOfMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>This is some initial text</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_ReplaceTextContainsStartOfMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>This is some initial text</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_ReplaceEndOfMarker)
{
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_EQ("Initial string", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0).Utf8());
}

TEST_F(InputMethodControllerTest, ContentDependentMarker_ReplaceTextContainsEndOfMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>This is some initial text</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_ReplaceTextContainsEndOfMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>This is some initial text</div>", "sample");
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_EQ("some ", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0));
}
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_ReplaceEntireMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text</div>", "sample");
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_EQ("string", GetMarkedText(GetDocument().Markers(), div->firstChild(), 0).Utf8());
}

TEST_F(InputMethodControllerTest, ContentDependentMarker_ReplaceTextWithMarkerAtBeginning)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_ReplaceTextWithMarkerAtBeginning)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_ReplaceTextWithMarkerAtEnd)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_ReplaceTextWithMarkerAtEnd)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>Initial text</div>", "sample");
...
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>1111122222333334444455555</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_DeleteExactlyOnMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>1111122222333334444455555</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_DeleteExactlyOnMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>1111122222333334444455555</div>", "sample");

    EphemeralRange marker_range = PlainTextRange(5, 10).CreateRange(*div);
    GetDocument().Markers().AddActiveSuggestionMarker(
        marker_range, Color::kBlack, ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kBlack);
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_DeleteMiddleOfMarker)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>1111122222333334444455555</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentDependentMarker_InsertInMarkerInterior)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>1111122222333334444455555</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_InsertInMarkerInterior)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>1111122222333334444455555</div>", "sample");
...
TEST_F(InputMethodControllerTest, ContentIndependentMarker_InsertBetweenMarkers)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>1111122222333334444455555</div>", "sample");
...
TEST_F(InputMethodControllerTest, CommitNotMisspellingSuggestionMarkerWithSpellCheckingDisabled)
{
    InsertHTMLElement("<div id='sample' contenteditable spellcheck='false'>text</div>", "sample");

    Vector<ImeTextSpan> ime_text_spans;
    // Try to commit a non-misspelling suggestion marker.
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kSuggestion, 0, 5, Color::kTransparent, ImeTextSpanThickness::kNone,
        ImeTextSpanUnderlineStyle::kNone, Color::kTransparent, Color::kTransparent));
    Controller().CommitText("hello", ime_text_spans, 1);
...
TEST_F(InputMethodControllerTest, CommitMisspellingSuggestionMarkerWithSpellCheckingDisabled)
{
    InsertHTMLElement("<div id='sample' contenteditable spellcheck='false'>text</div>", "sample");

    Vector<ImeTextSpan> ime_text_spans;
    // Try to commit a non-misspelling suggestion marker.
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kMisspellingSuggestion, 0, 5, Color::kTransparent, ImeTextSpanThickness::kNone,
        ImeTextSpanUnderlineStyle::kNone, Color::kTransparent, Color::kTransparent));
    Controller().CommitText("hello", ime_text_spans, 1);
...
{
    InsertHTMLElement("<div id='sample' contenteditable spellcheck='true'>text</div>", "sample");

    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kMisspellingSuggestion, 0, 5, Color::kTransparent, ImeTextSpanThickness::kNone,
        ImeTextSpanUnderlineStyle::kNone, Color::kTransparent, Color::kTransparent, Color ::kTransparent,
    ...
    ASSERT_EQ(1u, GetDocument().Markers().Markers().size());
    ASSERT_TRUE(Controller().FinishComposingText(InputMethodController::kKeepSelection));
    ...
    EXPECT_EQ(1u, GetDocument().Markers().Markers().size());
    EXPECT_EQ(DocumentMarker::MarkerType::kComposition, GetDocument().Markers().Markers()[0]->GetType());
}

TEST_F(InputMethodControllerTest, ClearImeTextSpansByType)
{
    InsertHTMLElement("<div id='sample' contenteditable spellcheck='true'>hello</div>", "sample");
    ImeTextSpan::Type type = ImeTextSpan::Type::kAutocorrect;
    unsigned start = 0;
    unsigned end = 1;
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(type, start, end, Color::kTransparent, ImeTextSpanThickness::kNone, ImeTextSpanUnderlineStyle::kNone,
...
TEST_F(InputMethodControllerTest, TextInputTypeAtBeforeEditable)
{
    ...
    GetFrame().Selection().SetSelection(SelectionInDOMTree::Builder().Collapse(Position(GetDocument().documentElement(), 0)).Build(), SetSelectionOptions());
...
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='a' maxlength='4'/>", "a"));
...
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable><b>t</b>est</div>", "sample");
    Vector<ImeTextSpan> ime_text_spans;
    ime_text_spans.push_back(ImeTextSpan(ImeTextSpan::Type::kComposition, 0, 4, Color(255, 0, 0), ImeTextSpanThickness::kThin,
        ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kTransparent));
    ...
    const DocumentMarkerVector& text1_markers = GetDocument().Markers().MarkersFor(*text1, DocumentMarker::MarkerTypes::Composition());
    EXPECT_EQ(1u, text1_markers.size());
    EXPECT_EQ(0u, text1_markers[0]->StartOffset());
    EXPECT_EQ(1u, text1_markers[0]->EndOffset());

    const DocumentMarkerVector& text2_markers = GetDocument().Markers().MarkersFor(*text2, DocumentMarker::MarkerTypes::Composition());
...
{
    Element* div = InsertHTMLElement("<div id='div' contenteditable='true'><img />test</div>", "div");
    // Select the contents of the div element.
    GetFrame().Selection().SetSelection(SelectionInDOMTree::Builder().SetBaseAndExtent(EphemeralRange::RangeOfContents(*div)).Build(), SetSelectionOptions());
...
{
    Element* div = InsertHTMLElement("<div id='div' contenteditable='true'>test<img /></div>", "div");
    // Select the contents of the div element.
    GetFrame().Selection().SetSelection(SelectionInDOMTree::Builder().SetBaseAndExtent(EphemeralRange::RangeOfContents(*div)).Build(), SetSelectionOptions());
...
TEST_F(InputMethodControllerTest, SetCompositionDeletesMarkupBeforeAndAfterText)
{
    Element* div = InsertHTMLElement("<div id='div' contenteditable='true'><img />test<img /></div>", "div");
    // Select the contents of the div element.
    GetFrame().Selection().SetSelection(SelectionInDOMTree::Builder().SetBaseAndExtent(EphemeralRange::RangeOfContents(*div)).Build(), SetSelectionOptions());
...
TEST_F(InputMethodControllerTest, SetCompositionWithPartialGraphemeWithCompositionUnderlineDoesntCrash)
{
    InsertHTMLElement("<div id='sample' contenteditable></div>", "sample");
    ...
    Controller().SetComposition(String::FromUTF8("\xE0\xA5\x8D"), ime_text_spans, 1, 1);
}

TEST_F(InputMethodControllerTest, SetCompositionWithPartialGraphemeWithoutCompositionUnderlineDoesntCrash)
{
    InsertHTMLElement("<div id='sample' contenteditable></div>", "sample");

    Controller().CommitText(" ", Vector<ImeTextSpan>(), 0);
    // Add character U+094D: 'DEVANAGARI SIGN VIRAMA'
    Controller().SetComposition(String::FromUTF8("\xE0\xA5\x8D"), Vector<ImeTextSpan>(), 1, 1);
}
...
TEST_F(InputMethodControllerTest, SetCompositionContainingNewline)
{
    ...
    EXPECT_EQ("Hello\n\n", PlainText(EphemeralRange(Position(div, PositionAnchorType::kBeforeAnchor), Position(div, PositionAnchorType::kAfterAnchor))));
}
...
TEST_F(InputMethodControllerTest, SetCompositionTamilVirama)
{
    ...
    Controller().CommitText(String::FromUTF8("\xE0\xAE\x9A\xE0\xAF\x8D"), Vector<ImeTextSpan>(), 0);

    // Open composition with TAMIL LETTER CA (U+0B9A) followed by
    // TAMIL SIGN VIRAMA (U+U0BCD)
    Controller().SetComposition(String::FromUTF8("\xE0\xAE\x9A\xE0\xAF\x8D"), Vector<ImeTextSpan>(), 2, 2);
    // Remove the TAMIL SIGN VIRAMA from the end of the composition
    Controller().SetComposition(String::FromUTF8("\xE0\xAE\x9A"), Vector<ImeTextSpan>(), 1, 1);
...
TEST_F(InputMethodControllerTest, CommitTextWithOpenCompositionAndInputEventHandlerChangingText)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello</div>", "sample");

    GetDocument().GetSettings()->SetScriptEnabled(true);
    Element* script = GetDocument().CreateRawElement(html_names::kScriptTag);
    script->setInnerHTML("document.getElementById('sample').addEventListener('input', "
                         "  event => {"
    ...
    EXPECT_EQ(11, GetFrame().Selection().GetSelectionInDOMTree().Anchor().ComputeOffsetInContainerNode());
}

TEST_F(InputMethodControllerTest, CommitTextWithoutCompositionAndInputEventHandlerChangingSelection)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
    ...
    GetFrame().Selection().SetSelection(
        SelectionInDOMTree::Builder().SetBaseAndExtent(EphemeralRange(Position(div->firstChild(), 0), Position(div->firstChild(), 5))).Build(),
        SetSelectionOptions());
...
TEST_F(InputMethodControllerTest, SetCompositionToEmptyStringWithOpenCompositionAndInputEventHandlerChangingText)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, SetCompositionWithOpenCompositionAndInputEventHandlerChangingText)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, SetCompositionWithOpenCompositionAndInputEventHandlerChangingSelection)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
    ...
    EXPECT_EQ(5, GetFrame().Selection().GetSelectionInDOMTree().Anchor().ComputeOffsetInContainerNode());
}

TEST_F(InputMethodControllerTest, SetCompositionToEmptyStringAndInputEventHandlerChangingSelection)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, SetCompositionDeleteSelectionAndInputEventHandlerChangingSelection)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
    ...
    // Select "world".
    GetFrame().Selection().SetSelection(
        SelectionInDOMTree::Builder().SetBaseAndExtent(EphemeralRange(Position(div->firstChild(), 6), Position(div->firstChild(), 11))).Build(),
        SetSelectionOptions());
...
TEST_F(InputMethodControllerTest, DeleteSelectionAndBeforeInputEventHandlerChangingStyle)
{
    Element* div = InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, CommitTextWithOpenCompositionAndCompositionEndEventHandlerChangingText)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello</div>", "sample");

    GetDocument().GetSettings()->SetScriptEnabled(true);
    Element* script = GetDocument().CreateRawElement(html_names::kScriptTag);
    script->setInnerHTML("document.getElementById('sample').addEventListener('compositionend', "
                         "  event => {"
                         "    const node = event.currentTarget;"
                         "    node.textContent = 'HELLO WORLD';"
                         "    const selection = getSelection();"
...
TEST_F(InputMethodControllerTest, SetCompositionToEmptyStringWithOpenCompositionAndCompositionEndEventHandlerChangingText)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, SetCompositionToEmptyStringAndCompositionEndEventHandlerChangingSelection)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, FinishComposingTextDoNotKeepSelectionAndCompositionEndEventHandler)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, FinishComposingTextKeepSelectionAndCompositionEndEventHandler)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");
...
TEST_F(InputMethodControllerTest, SetCompositionFromExistingTextAndCompositionStartEventHandlerChangingStyle)
{
    InsertHTMLElement("<div id='sample' contenteditable>hello world</div>", "sample");

    GetDocument().GetSettings()->SetScriptEnabled(true);
    Element* script = GetDocument().CreateRawElement(html_names::kScriptTag);
    script->setInnerHTML("document.getElementById('sample').addEventListener('compositionstart', "
                         "  event => {"
                         "    event.currentTarget.style.transform = 'rotate(7deg)';"
                         "});");
    GetDocument().body()->AppendChild(script);
...
TEST_F(InputMethodControllerTest, FinishComposingTextTooLongKeepSelectionAndInputEventHandler)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample' maxlength='2'>", "sample"));
...
TEST_F(InputMethodControllerTest, FinishComposingTextTooLongDoNotKeepSelectionAndInputEventHandler)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample' maxlength='2'>", "sample"));
...
TEST_F(InputMethodControllerTest, FinishComposingTextTooLongKeepSelectionAndCompositionEndEventHandler)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample' maxlength='2'>", "sample"));
...
TEST_F(InputMethodControllerTest, FinishComposingTextTooLongDoNotKeepSelectionAndCompositionEndEventHandler)
{
    auto* input = To<HTMLInputElement>(InsertHTMLElement("<input id='sample' maxlength='2'>", "sample"));
...
TEST_F(InputMethodControllerTest, AutocapitalizeTextInputFlags)
{
    ...
    Vector<std::pair<String, int>> element_and_expected_flags_pairs = {
        ...
        { "<input type='text' autocapitalize='none'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='text' autocapitalize='characters'>", kWebTextInputFlagAutocapitalizeCharacters },
        { "<input type='text' autocapitalize='sentences'>", kWebTextInputFlagAutocapitalizeSentences },
        { "<input type='text' autocapitalize='words'>", kWebTextInputFlagAutocapitalizeWords },

        { "<input type='search'>", kWebTextInputFlagAutocapitalizeSentences },
        { "<input type='search' autocapitalize='none'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='search' autocapitalize='characters'>", kWebTextInputFlagAutocapitalizeCharacters },
        { "<input type='search' autocapitalize='sentences'>", kWebTextInputFlagAutocapitalizeSentences },
        { "<input type='search' autocapitalize='words'>", kWebTextInputFlagAutocapitalizeWords },

        { "<input type='email'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='email' autocapitalize='none'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='email' autocapitalize='characters'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='email' autocapitalize='sentences'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='email' autocapitalize='words'>", kWebTextInputFlagAutocapitalizeNone },

        { "<input type='url'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='url' autocapitalize='none'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='url' autocapitalize='characters'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='url' autocapitalize='sentences'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='url' autocapitalize='words'>", kWebTextInputFlagAutocapitalizeNone },

        { "<input type='password'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='password' autocapitalize='none'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='password' autocapitalize='characters'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='password' autocapitalize='sentences'>", kWebTextInputFlagAutocapitalizeNone },
        { "<input type='password' autocapitalize='words'>", kWebTextInputFlagAutocapitalizeNone },

        { "<textarea></textarea>", kWebTextInputFlagAutocapitalizeSentences },
        { "<textarea autocapitalize='none'></textarea>", kWebTextInputFlagAutocapitalizeNone },
        { "<textarea autocapitalize='characters'></textarea>", kWebTextInputFlagAutocapitalizeCharacters },
        { "<textarea autocapitalize='sentences'></textarea>", kWebTextInputFlagAutocapitalizeSentences },
        { "<textarea autocapitalize='words'></textarea>", kWebTextInputFlagAutocapitalizeWords },

        { "<div contenteditable></div>", kWebTextInputFlagAutocapitalizeSentences },
        { "<div contenteditable autocapitalize='none'></div>", kWebTextInputFlagAutocapitalizeNone },
        { "<div contenteditable autocapitalize='characters'></div>", kWebTextInputFlagAutocapitalizeCharacters },
        { "<div contenteditable autocapitalize='sentences'></div>", kWebTextInputFlagAutocapitalizeSentences },
        { "<div contenteditable autocapitalize='words'></div>", kWebTextInputFlagAutocapitalizeWords },
    };

    const int autocapitalize_mask = kWebTextInputFlagAutocapitalizeNone | kWebTextInputFlagAutocapitalizeCharacters | kWebTextInputFlagAutocapitalizeWords
        | kWebTextInputFlagAutocapitalizeSentences;

    for (const std::pair<String, int>& element_and_expected_flags_pair : element_and_expected_flags_pairs) {
        ...
        EXPECT_EQ(expected_flags, Controller().TextInputInfo().flags & autocapitalize_mask);
    }
}
...
TEST_F(InputMethodControllerTest, VerticalTextInputFlags)
{
    Vector<std::pair<String, int>> element_html_and_expected_flags = {
        ...
        { "<div contenteditable='true' style='writing-mode:vertical-rl;'></div>", kWebTextInputFlagVertical },
        { "<div contenteditable='true' style='writing-mode:vertical-lr;'></div>", kWebTextInputFlagVertical },
    };

    for (const std::pair<String, int>& html_and_flags : element_html_and_expected_flags) {
        ...
        EXPECT_EQ(expected_flags, Controller().TextInputInfo().flags & kWebTextInputFlagVertical);
    }
}
...
TEST_F(InputMethodControllerTest, ExecCommandDuringComposition)
{
    ...
    // Open a composition.
    Controller().SetComposition(String::FromUTF8("hello"), Vector<ImeTextSpan>(), 5, 5);
    // Turn on bold formatting.
    GetDocument().execCommand("bold", false, "", ASSERT_NO_EXCEPTION);

    // Extend the composition with some more text.
    Controller().SetComposition(String::FromUTF8("helloworld"), Vector<ImeTextSpan>(), 10, 10);
...
{
    GetFrame().Selection().SetSelection(SetSelectionTextToBody("<div id='sample' contenteditable='true'>"
    ...
    Controller().SetComposition(String::FromUTF8("c"), Vector<ImeTextSpan>(), 1, 1);

    // Add some more text to the composition.
    Controller().SetComposition(String::FromUTF8("cd"), Vector<ImeTextSpan>(), 2, 2);

    EXPECT_EQ("<div contenteditable=\"true\" id=\"sample\">"
              "<span contenteditable=\"false\">a</span>^cd|b</div>",
        GetSelectionTextFromBody(SelectionInDOMTree::Builder().SetBaseAndExtent(Controller().CompositionEphemeralRange()).Build()));
}

TEST_F(InputMethodControllerTest, SetCompositionInTableCell)
{
    GetFrame().Selection().SetSelection(SetSelectionTextToBody("<table id='sample' contenteditable><tr><td>a</td><td "
                                                               "id='td2'>|</td></tr></table>"),
        SetSelectionOptions());
...
TEST_F(InputMethodControllerTest, SetCompositionInMyanmar)
{
    ...
    Controller().SetComposition(String::FromUTF8("\xE2\x80\x8C\xE1\x80\xB1"), Vector<ImeTextSpan>(), 0, 0);
    ...
    Controller().CommitText(String::FromUTF8("\xE2\x80\x8C\xE1\x80\xB1"), Vector<ImeTextSpan>(), 1);
    EXPECT_EQ(String::FromUTF8("\xE2\x80\x8C\xE1\x80\xB1"), div->innerHTML());

    // Add character U+200C: 'kZeroWidthNonJoinerCharacter' and Myanmar vowel
    Controller().SetComposition(String::FromUTF8("\xE2\x80\x8C\xE1\x80\xB1"), Vector<ImeTextSpan>(), 2, 2);
    Controller().CommitText(String::FromUTF8("\xE2\x80\x8C\xE1\x80\xB1"), Vector<ImeTextSpan>(), 1);
    EXPECT_EQ(String::FromUTF8("\xE2\x80\x8C\xE1\x80\xB1\xE2\x80\x8C\xE1\x80\xB1"), div->innerHTML());
}

TEST_F(InputMethodControllerTest, VirtualKeyboardPolicyOfFocusedElement)
{
    EXPECT_EQ(ui::mojom::VirtualKeyboardPolicy::AUTO, Controller().VirtualKeyboardPolicyOfFocusedElement());
    InsertHTMLElement("<input id='a' virtualkeyboardpolicy='manual'>", "a")->Focus();
    EXPECT_EQ(ui::mojom::VirtualKeyboardPolicy::MANUAL, Controller().VirtualKeyboardPolicyOfFocusedElement());
}

TEST_F(InputMethodControllerTest, SetCompositionInTibetan)
{
    GetFrame().Selection().SetSelection(SetSelectionTextToBody("<div id='sample' contenteditable>|</div>"), SetSelectionOptions());
    Element* const div = GetDocument().getElementById(AtomicString("sample"));
    div->Focus();

    Vector<ImeTextSpan> ime_text_spans;
    Controller().SetComposition(String(Vector<UChar> { 0xF56 }), ime_text_spans, 1, 1);
    EXPECT_EQ("<div contenteditable id=\"sample\">\u0F56|</div>", GetSelectionTextFromBody());

    Controller().CommitText(String(Vector<UChar> { 0xF56 }), ime_text_spans, 0);
    EXPECT_EQ("<div contenteditable id=\"sample\">\u0F56|</div>", GetSelectionTextFromBody());

    Controller().SetComposition(String(Vector<UChar> { 0xFB7 }), ime_text_spans, 1, 1);
    EXPECT_EQ("<div contenteditable id=\"sample\">\u0F56\u0FB7|</div>", GetSelectionTextFromBody());
    ...
    Controller().SetComposition(String(Vector<UChar> { 0xF74 }), ime_text_spans, 1, 1);
    EXPECT_EQ("<div contenteditable id=\"sample\">\u0F56\u0FB7\u0F74|</div>", GetSelectionTextFromBody());
}

TEST_F(InputMethodControllerTest, SetCompositionInDevanagari)
{
    GetFrame().Selection().SetSelection(SetSelectionTextToBody("<div id='sample' contenteditable>\u0958|</div>"), SetSelectionOptions());
    Element* const div = GetDocument().getElementById(AtomicString("sample"));
    div->Focus();

    Vector<ImeTextSpan> ime_text_spans;
    Controller().SetComposition(String(Vector<UChar> { 0x94D }), ime_text_spans, 1, 1);
    EXPECT_EQ("<div contenteditable id=\"sample\">\u0958\u094D|</div>", GetSelectionTextFromBody());

    Controller().CommitText(String(Vector<UChar> { 0x94D, 0x930 }), ime_text_spans, 0);
    EXPECT_EQ("<div contenteditable id=\"sample\">\u0958\u094D\u0930|</div>", GetSelectionTextFromBody());
}
...
TEST_F(InputMethodControllerTest, SetCompositionTamil)
{
    ...
    Controller().SetComposition(String(Vector<UChar> { 0xBB5 }), ime_text_spans, 0, 0);
    // Add character U+0BC7: 'TAMIL VOWEL SIGN EE'
    Controller().CommitText(String(Vector<UChar> { 0xBB5, 0xBC7 }), ime_text_spans, 1);
    EXPECT_EQ("<div contenteditable id=\"sample\">\u00A0\u0BB5\u0BC7|</div>", GetSelectionTextFromBody());
}

TEST_F(InputMethodControllerTest, EditContextCanvasHasEditableType)
{
    GetDocument().GetSettings()->SetScriptEnabled(true);
    Element* noneditable_canvas = InsertHTMLElement("<canvas id='noneditable-canvas'></canvas>", "noneditable-canvas");
    Element* editable_canvas = InsertHTMLElement("<canvas id='editable-canvas'></canvas>", "editable-canvas");
    Element* script = GetDocument().CreateRawElement(html_names::kScriptTag);
    script->setInnerHTML("document.getElementById('editable-canvas').editContext = new "
                         "EditContext()");
    GetDocument().body()->AppendChild(script);
    UpdateAllLifecyclePhasesForTest();
