...
CharacterBoundsUpdateEvent::CharacterBoundsUpdateEvent(const AtomicString& type, const CharacterBoundsUpdateEventInit* initializer)
...
CharacterBoundsUpdateEvent::CharacterBoundsUpdateEvent(const AtomicString& type, uint32_t range_start, uint32_t range_end)
    : Event(type, Bubbles::kNo, Cancelable::kNo, ComposedMode::kComposed, base::TimeTicks::Now())
    , range_start_(range_start)
    , range_end_(range_end)
{
}

CharacterBoundsUpdateEvent* CharacterBoundsUpdateEvent::Create(const AtomicString& type, const CharacterBoundsUpdateEventInit* initializer)
{
