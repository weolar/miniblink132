...
public:
    TextUpdateEvent(const AtomicString& type, const TextUpdateEventInit* initializer);
    TextUpdateEvent(const AtomicString& type, const String& update_text, uint32_t update_range_start, uint32_t update_range_end, uint32_t selection_start,
        uint32_t selection_end);
    static TextUpdateEvent* Create(const AtomicString& type, const TextUpdateEventInit* initializer);
