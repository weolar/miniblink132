...
public:
    ...
    static mojom::blink::HandwritingGestureResult ApplyGesture(LocalFrame*, mojom::blink::StylusWritingGestureDataPtr);

protected:
    StylusWritingGesture(const gfx::Rect& start_rect, const String& text_alternative);
