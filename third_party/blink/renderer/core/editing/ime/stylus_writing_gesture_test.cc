...
class StylusWritingGestureTest : public SimTest, public testing::WithParamInterface<bool> {
public:
...
protected:
    ...
    std::unique_ptr<frame_test_helpers::TestWebFrameClient> CreateWebFrameClientForMainFrame() override
    {
    ...
    mojom::blink::HandwritingGestureResult last_gesture_result = mojom::blink::HandwritingGestureResult::kUnknown;
...
{
    HTMLInputElement* input_element = DynamicTo<HTMLInputElement>(
        SetUpElement(String("<input type='text' id='target' ") + String(is_RTL ? "style='unicode-bidi: bidi-override; direction: rtl;'" : "") + String("/>")));
    input_element->Focus();
    return input_element;
}

HTMLTextAreaElement* StylusWritingGestureTest::SetUpMultilineInput(bool is_RTL)
{
    HTMLTextAreaElement* text_area = DynamicTo<HTMLTextAreaElement>(SetUpElement(
        String("<textarea type='text' id='target' rows='4' ") + String(is_RTL ? "style='unicode-bidi: bidi-override; direction: rtl;'" : "") + String("/>")));
    text_area->Focus();
    return text_area;
}

gfx::Rect StylusWritingGestureTest::GetRect(int x, int y, int width, int height, int input_width, bool is_RTL) const
{
    // Start of text in RTL input is input_width - 1
    return is_RTL ? gfx::Rect(input_width - x - width - 1, y, width, height) : gfx::Rect(x, y, width, height);
}
...
TEST_P(StylusWritingGestureTest, TestGestureDelete)
{
    ...
    mojom::blink::StylusWritingGestureDataPtr gesture_data(mojom::blink::StylusWritingGestureData::New());
    ...
    WidgetImpl()->HandleStylusWritingGestureAction(std::move(gesture_data), WTF::BindOnce(&StylusWritingGestureTest::ResultCallback, base::Unretained(this)));
    ...
    EXPECT_EQ(mojom::blink::HandwritingGestureResult::kSuccess, last_gesture_result);

    // Try to do delete gesture outside the current input range.
    // This should insert the text alternative at current cursor.
    mojom::blink::StylusWritingGestureDataPtr gesture_data2(mojom::blink::StylusWritingGestureData::New());
    ...
    WidgetImpl()->HandleStylusWritingGestureAction(std::move(gesture_data2), WTF::BindOnce(&StylusWritingGestureTest::ResultCallback, base::Unretained(this)));
    ...
    EXPECT_EQ(mojom::blink::HandwritingGestureResult::kFallback, last_gesture_result);
}
...
TEST_P(StylusWritingGestureTest, TestGestureDeleteWithWordGranularity)
{
    ...
    std::vector<TestCase> test_cases { // Crossing out the first word and half of the second should delete both
    ...
    for (auto test_case : test_cases) {
        ...
        mojom::blink::StylusWritingGestureDataPtr gesture_data(mojom::blink::StylusWritingGestureData::New());
        gesture_data->action = mojom::blink::StylusWritingGestureAction::DELETE_TEXT;
        gesture_data->granularity = mojom::blink::StylusWritingGestureGranularity::WORD;
        ...
        WidgetImpl()->HandleStylusWritingGestureAction(
            std::move(gesture_data), WTF::BindOnce(&StylusWritingGestureTest::ResultCallback, base::Unretained(this)));
...
TEST_P(StylusWritingGestureTest, TestGestureDeleteNotFirstLine)
{
    ...
    mojom::blink::StylusWritingGestureDataPtr gesture_data(mojom::blink::StylusWritingGestureData::New());
    gesture_data->action = mojom::blink::StylusWritingGestureAction::DELETE_TEXT;
    gesture_data->granularity = mojom::blink::StylusWritingGestureGranularity::CHARACTER;
...
TEST_P(StylusWritingGestureTest, TestGestureDeleteMultilinePartiallyOutsideBounds)
{
    const bool is_RTL = GetParam();
    auto* input = SetUpMultilineInput(is_RTL);
    input->SetValue("ABCD\nEFGH");
...
TEST_P(StylusWritingGestureTest, TestGestureRemoveSpaces)
{
    ...
    mojom::blink::StylusWritingGestureDataPtr gesture_data(mojom::blink::StylusWritingGestureData::New());
    gesture_data->action = mojom::blink::StylusWritingGestureAction::REMOVE_SPACES;
    ...
    // This should insert the text alternative at current cursor.
    mojom::blink::StylusWritingGestureDataPtr gesture_data2(mojom::blink::StylusWritingGestureData::New());
    gesture_data2->action = mojom::blink::StylusWritingGestureAction::REMOVE_SPACES;
...
TEST_P(StylusWritingGestureTest, TestGestureAddSpaceOrText)
{
    ...
    mojom::blink::StylusWritingGestureDataPtr gesture_data(mojom::blink::StylusWritingGestureData::New());
    gesture_data->action = mojom::blink::StylusWritingGestureAction::ADD_SPACE_OR_TEXT;
    ...
    // This should insert the text alternative at current cursor.
    mojom::blink::StylusWritingGestureDataPtr gesture_data2(mojom::blink::StylusWritingGestureData::New());
    gesture_data2->action = mojom::blink::StylusWritingGestureAction::ADD_SPACE_OR_TEXT;
...
TEST_P(StylusWritingGestureTest, TestGestureSplitOrMerge_RemovesAllSpaces)
{
    ...
    mojom::blink::StylusWritingGestureDataPtr gesture_data(mojom::blink::StylusWritingGestureData::New());
    gesture_data->action = mojom::blink::StylusWritingGestureAction::SPLIT_OR_MERGE;
    gesture_data->start_rect = GetRect(42, 6, 0, 0, width, is_RTL);
    gesture_data->text_alternative = text_alternative;
    ...
    // Expected value after gesture = "ABCDEFGH". And cursor to be after ABCD.
    mojom::blink::StylusWritingGestureDataPtr gesture_data1(mojom::blink::StylusWritingGestureData::New());
    gesture_data1->action = mojom::blink::StylusWritingGestureAction::SPLIT_OR_MERGE;
    gesture_data1->start_rect = GetRect(78, 6, 0, 0, width, is_RTL);
    gesture_data1->text_alternative = text_alternative;

    WidgetImpl()->HandleStylusWritingGestureAction(std::move(gesture_data1), WTF::BindOnce(&StylusWritingGestureTest::ResultCallback, base::Unretained(this)));
    range = Controller()->GetSelectionOffsets();
    EXPECT_EQ("ABCDEFGH", input->Value());
    EXPECT_EQ(4, range.StartOffset());
    EXPECT_EQ(4, range.EndOffset());
...
TEST_P(StylusWritingGestureTest, TestGestureSplitOrMerge_NonEmptyInput)
{
    ...
    // This should insert the text alternative at current cursor.
    mojom::blink::StylusWritingGestureDataPtr gesture_data2(mojom::blink::StylusWritingGestureData::New());
    gesture_data2->action = mojom::blink::StylusWritingGestureAction::SPLIT_OR_MERGE;
    gesture_data2->start_rect = GetRect(120, 6, 0, 0, width, is_RTL);
    gesture_data2->text_alternative = text_alternative;
    ...
    mojom::blink::StylusWritingGestureDataPtr gesture_data3(mojom::blink::StylusWritingGestureData::New());
    gesture_data3->action = mojom::blink::StylusWritingGestureAction::SPLIT_OR_MERGE;
    gesture_data3->start_rect = GetRect(4, 6, 0, 0, width, is_RTL);
    gesture_data3->text_alternative = text_alternative;

    WidgetImpl()->HandleStylusWritingGestureAction(std::move(gesture_data3), WTF::BindOnce(&StylusWritingGestureTest::ResultCallback, base::Unretained(this)));
    range = Controller()->GetSelectionOffsets();
...
INSTANTIATE_TEST_SUITE_P(BiDirectional, StylusWritingGestureTest, testing::Bool(), &BoolToDirection);
