...
TextUpdateEvent::TextUpdateEvent(const AtomicString& type, const TextUpdateEventInit* initializer)
...
TextUpdateEvent::TextUpdateEvent(
    const AtomicString& type, const String& text, uint32_t update_range_start, uint32_t update_range_end, uint32_t selection_start, uint32_t selection_end)
...
TextUpdateEvent* TextUpdateEvent::Create(const AtomicString& type, const TextUpdateEventInit* initializer)
{
