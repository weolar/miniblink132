...
public:
    TextFormatUpdateEvent(const AtomicString& type, const TextFormatUpdateEventInit* initializer);
    TextFormatUpdateEvent(const AtomicString& type, HeapVector<Member<TextFormat>>& textFormats);
    static TextFormatUpdateEvent* Create(const AtomicString& type, const TextFormatUpdateEventInit* initializer);
