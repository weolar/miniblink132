...
public:
    ...
    static PositionInFlatTree FindBoundaryForward(const PositionInFlatTree& position, Finder* finder);

    static PositionInFlatTree FindBoundaryBackward(const PositionInFlatTree& position, Finder* finder);
};
