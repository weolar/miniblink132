...
class CORE_EXPORT DocumentMarkerGroup : public GarbageCollected<DocumentMarkerGroup> {
public:
    ...
    void Erase(const DocumentMarker* marker)
    {
        marker_text_map_.erase(marker);
    }
...
private:
    HeapHashMap<WeakMember<const DocumentMarker>, WeakMember<const Text>> marker_text_map_;
};
