...
{
    DocumentMarker* marker = MakeGarbageCollected<SuggestionMarker>(0, 1, SuggestionMarkerProperties());
...
TEST_F(SuggestionMarkerTest, ConstructorAndGetters)
{
    ...
    SuggestionMarker* marker = MakeGarbageCollected<SuggestionMarker>(0, 1,
    ...
    SuggestionMarker* marker2 = MakeGarbageCollected<SuggestionMarker>(0, 1,
        SuggestionMarkerProperties::Builder()
...
{
    Vector<String> suggestions = { "this", "that" };
    SuggestionMarker* marker = MakeGarbageCollected<SuggestionMarker>(0, 1, SuggestionMarkerProperties::Builder().SetSuggestions(suggestions).Build());
