...
public:
    OverlappingDocumentMarkerListEditorTest()
        : marker_list_(MakeGarbageCollected<HeapVector<Member<DocumentMarker>>>())
    {
    }
...
protected:
    ...
    {
        return MakeGarbageCollected<SuggestionMarker>(start_offset, end_offset, SuggestionMarkerProperties());
    }
...
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(40, 60));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 30));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(70, 100));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 20));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 40));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(45, 70));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(35, 65));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(90, 100));
...
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(30, 40));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 30));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 40));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 20));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 40));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(20, 40));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(20, 30));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 30));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 20));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(11, 21));

    DocumentMarkerList* dst_list = MakeGarbageCollected<SuggestionMarkerListImpl>();
...
TEST_F(OverlappingDocumentMarkerListEditorTest, RemoveMarkersNestedOverlap)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 30));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(15, 20));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(20, 30));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(30, 40));

    EXPECT_TRUE(OverlappingDocumentMarkerListEditor::RemoveMarkers(marker_list_, 20, 10));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, RemoveMarkersTouchingEndpoints)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(30, 40));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(40, 50));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 20));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(20, 30));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, RemoveMarkersOneCharacterIntoInterior)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(30, 40));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(40, 50));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 20));
    ...
    EXPECT_TRUE(OverlappingDocumentMarkerListEditor::RemoveMarkers(marker_list_, 19, 12));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_ReplaceStartOfMarker)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_ReplaceContainsStartOfMarker)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 15));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_ReplaceEndOfMarker)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_ReplaceContainsEndOfMarker)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_ReplaceEntireMarker)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_ReplaceTextWithMarkerAtBeginning)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_ReplaceTextWithMarkerAtEnd)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 15));
...
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 5));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 15));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(15, 20));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(20, 25));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_DeletionWithinNested)
{
    // A marker that overlaps the range with markers that do not overlap
    // nested within it.
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 35));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(7, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(15, 25));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(30, 32));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_DeleteExactlyOnMarker)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_InsertInMarkerInterior)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 5));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 15));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, ShiftMarkers_InsertBetweenMarkers)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 5));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(10, 15));
...
TEST_F(OverlappingDocumentMarkerListEditorTest, MarkersIntersectingRange_RangeContainingNoMarkers)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));

    OverlappingDocumentMarkerListEditor::MarkerList markers_intersecting_range
        = OverlappingDocumentMarkerListEditor::MarkersIntersectingRange(*marker_list_, 10, 15);
    EXPECT_EQ(0u, markers_intersecting_range.size());
}

TEST_F(OverlappingDocumentMarkerListEditorTest, MarkersIntersectingRange_TouchingStart)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 9));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(1, 9));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(1, 10));

    OverlappingDocumentMarkerListEditor::MarkerList markers_intersecting_range
        = OverlappingDocumentMarkerListEditor::MarkersIntersectingRange(*marker_list_, 0, 1);
...
TEST_F(OverlappingDocumentMarkerListEditorTest, MarkersIntersectingRange_TouchingEnd)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 9));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(1, 9));
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(0, 10));
    ...
    OverlappingDocumentMarkerListEditor::MarkerList markers_intersecting_range
        = OverlappingDocumentMarkerListEditor::MarkersIntersectingRange(*marker_list_, 9, 10);
...
TEST_F(OverlappingDocumentMarkerListEditorTest, MarkersIntersectingRange_CollapsedRange)
{
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 10));

    OverlappingDocumentMarkerListEditor::MarkerList markers_intersecting_range
        = OverlappingDocumentMarkerListEditor::MarkersIntersectingRange(*marker_list_, 7, 7);
...
TEST_F(OverlappingDocumentMarkerListEditorTest, MarkersIntersectingRange_NestedMarkers)
{
    // A marker that overlaps the range with markers that do not overlap
    // nested within it.
    OverlappingDocumentMarkerListEditor::AddMarker(marker_list_, CreateMarker(5, 35));
    ...
    OverlappingDocumentMarkerListEditor::MarkerList markers_intersecting_range
        = OverlappingDocumentMarkerListEditor::MarkersIntersectingRange(*marker_list_, 15, 25);
    EXPECT_EQ(2u, markers_intersecting_range.size());
