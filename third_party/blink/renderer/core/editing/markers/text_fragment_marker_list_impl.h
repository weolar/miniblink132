...
class CORE_EXPORT TextFragmentMarkerListImpl final : public HighlightPseudoMarkerListImpl {
public:
    TextFragmentMarkerListImpl() = default;
    TextFragmentMarkerListImpl(const TextFragmentMarkerListImpl&) = delete;
    TextFragmentMarkerListImpl& operator=(const TextFragmentMarkerListImpl&) = delete;
...
template <> struct DowncastTraits<TextFragmentMarkerListImpl> {
