...
{
    DocumentMarker* marker = MakeGarbageCollected<SpellingMarker>(0, 1, kTestDescription);
...
{
    SpellingMarker* marker = MakeGarbageCollected<SpellingMarker>(0, 1, kTestDescription);
