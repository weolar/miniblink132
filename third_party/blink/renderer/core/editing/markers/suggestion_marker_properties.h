...
public:
    ...
    SuggestionMarker::SuggestionType Type() const
    {
        return type_;
    }
    ...
    ImeTextSpanUnderlineStyle UnderlineStyle() const
    {
...
private:
    SuggestionMarker::SuggestionType type_ = SuggestionMarker::SuggestionType::kNotMisspelling;
    SuggestionMarker::RemoveOnFinishComposing remove_on_finish_composing_ = SuggestionMarker::RemoveOnFinishComposing::kDoNotRemove;
    ...
    ImeTextSpanUnderlineStyle underline_style_ = ImeTextSpanUnderlineStyle::kSolid;
