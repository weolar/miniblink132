...
protected:
    ...
    SuggestionMarker* CreateMarker(unsigned start_offset, unsigned end_offset, const SuggestionMarkerProperties& properties)
    {
        return MakeGarbageCollected<SuggestionMarker>(start_offset, end_offset, properties);
    }
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForSuggestionReplacement_ReturnsFalseWhenNoShift)
{
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForSuggestionReplacement_MarkersUpdateProperly)
{
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_DeleteFromMiddle)
{
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_InsertIntoMiddle)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_PrependLetter)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_PrependSurrogatePairLetter)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_PrependDigit)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_PrependSurrogatePairDigit)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_PrependNonAlphanumeric)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_PrependSurrogatePairNonAlphanumeric)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_AppendLetter)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_AppendSurrogatePairLetter)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_AppendDigit)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_AppendSurrogatePairDigit)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_AppendNonAlphanumeric)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, ShiftMarkersForNonSuggestionEditingOperation_AppendSurrogatePairNonAlphanumeric)
{
    marker_list_->Add(CreateMarker(0, 5));
...
TEST_F(SuggestionMarkerListImplTest, RemoveMarkerByType_NotFound)
{
    SuggestionMarker* const marker = CreateMarker(0, 10);
    marker_list_->Add(marker);
    EXPECT_TRUE(marker->GetSuggestionType() != SuggestionMarker::SuggestionType::kAutocorrect);
    EXPECT_FALSE(marker_list_->RemoveMarkerByType(SuggestionMarker::SuggestionType::kAutocorrect));
}
...
TEST_F(SuggestionMarkerListImplTest, RemoveMarkerByType_Found)
{
    ...
    SuggestionMarker* const marker2
        = CreateMarker(10, 20, SuggestionMarkerProperties::Builder().SetType(SuggestionMarker::SuggestionType::kAutocorrect).Build());

    marker_list_->Add(marker1);
    marker_list_->Add(marker2);

    EXPECT_TRUE(marker1->GetSuggestionType() != SuggestionMarker::SuggestionType::kAutocorrect);
