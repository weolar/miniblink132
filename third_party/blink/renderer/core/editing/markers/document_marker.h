...
public:
    ...
    public:
        ...
        MarkerType operator*() const
        {
            ...
            // 6: 6 & -6 = 2
            // 4: 4 & -4 = 4
            return static_cast<MarkerType>(remaining_types_ & (~remaining_types_ + 1));
        }
    ...
    public:
        explicit MarkerTypes(unsigned mask = 0)
            : mask_(mask)
        {
        }
        ...
        {
            return MarkerTypes(kTextFragment | kSpelling | kGrammar | kCustomHighlight);
        }
        ...
        static MarkerTypes Composition()
        {
            return MarkerTypes(kComposition);
        }
        static MarkerTypes Grammar()
        {
            return MarkerTypes(kGrammar);
        }
        static MarkerTypes Misspelling()
        {
            return MarkerTypes(kSpelling | kGrammar);
        }
        static MarkerTypes Spelling()
        {
            return MarkerTypes(kSpelling);
        }
        static MarkerTypes TextMatch()
        {
            return MarkerTypes(kTextMatch);
        }
        static MarkerTypes Suggestion()
        {
            return MarkerTypes(kSuggestion);
        }
        static MarkerTypes TextFragment()
        {
            return MarkerTypes(kTextFragment);
        }
        ...
        MarkerTypesIterator begin() const
        {
            return MarkerTypesIterator(mask_);
        }
        MarkerTypesIterator end() const
        {
            return MarkerTypesIterator(0);
        }
    ...
    std::optional<MarkerOffsets> ComputeOffsetsAfterShift(unsigned offset, unsigned old_length, unsigned new_length) const;
