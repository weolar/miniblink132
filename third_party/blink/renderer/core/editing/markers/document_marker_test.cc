...
TEST_F(DocumentMarkerTest, GetShiftedMarkerPosition_DeleteAfter)
{
    ...
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(13, 19, 0);
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(0, 10, 0);
    EXPECT_EQ(std::nullopt, result);
}
...
{
    DocumentMarker* marker = CreateMarker(5, 10);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(5, 5, 0);
    EXPECT_EQ(std::nullopt, result);
}
...
{
    DocumentMarker* marker = CreateMarker(5, 10);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(6, 3, 0);
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(10, 0, 5);
    EXPECT_EQ(0u, result.value().start_offset);
    EXPECT_EQ(5u, result.value().end_offset);
}
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(5, 0, 5);
    EXPECT_EQ(0u, result.value().start_offset);
    EXPECT_EQ(5u, result.value().end_offset);
}
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(2, 0, 5);
    EXPECT_EQ(0u, result.value().start_offset);
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(0, 0, 5);
    EXPECT_EQ(5u, result.value().start_offset);
    EXPECT_EQ(10u, result.value().end_offset);
}
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(13, 19, 1);
    EXPECT_EQ(0u, result.value().start_offset);
    EXPECT_EQ(5u, result.value().end_offset);
}
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(0, 2, 1);
    EXPECT_EQ(0u, result.value().start_offset);
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(3, 2, 1);
    EXPECT_EQ(0u, result.value().start_offset);
    EXPECT_EQ(4u, result.value().end_offset);
}
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(0, 5, 1);
    EXPECT_EQ(0u, result.value().start_offset);
...
{
    DocumentMarker* marker = CreateMarker(0, 5);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(0, 6, 1);
    EXPECT_EQ(std::nullopt, result);
}
...
{
    DocumentMarker* marker = CreateMarker(5, 10);
    std::optional<MarkerOffsets> result = marker->ComputeOffsetsAfterShift(4, 6, 1);
    EXPECT_EQ(std::nullopt, result);
}
