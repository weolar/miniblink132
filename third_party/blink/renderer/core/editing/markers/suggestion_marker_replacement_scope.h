...
public:
    ...
    SuggestionMarkerReplacementScope(const SuggestionMarkerReplacementScope&) = delete;
    SuggestionMarkerReplacementScope& operator=(const SuggestionMarkerReplacementScope&) = delete;
    ~SuggestionMarkerReplacementScope();
