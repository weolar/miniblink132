...
class CORE_EXPORT ActiveSuggestionMarkerListImpl final : public DocumentMarkerList {
public:
    ActiveSuggestionMarkerListImpl() = default;
    ActiveSuggestionMarkerListImpl(const ActiveSuggestionMarkerListImpl&) = delete;
