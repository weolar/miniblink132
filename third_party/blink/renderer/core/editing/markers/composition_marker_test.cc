...
TEST_F(CompositionMarkerTest, MarkerType)
{
    DocumentMarker* marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kTransparent, ImeTextSpanThickness::kNone, ImeTextSpanUnderlineStyle::kNone, Color::kTransparent, Color::kTransparent);
...
TEST_F(CompositionMarkerTest, ConstructorAndGetters)
{
    CompositionMarker* marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kGray);
    ...
    CompositionMarker* thick_marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThick, ImeTextSpanUnderlineStyle::kSolid, Color::kTransparent, Color::kGray);
...
{
    CompositionMarker* marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kDot, Color::kGray, Color::kGray);
    EXPECT_EQ(Color::kDarkGray, marker->UnderlineColor());
    EXPECT_TRUE(marker->HasThicknessThin());
    ...
    CompositionMarker* thick_marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThick, ImeTextSpanUnderlineStyle::kDot, Color::kGray, Color::kGray);
    EXPECT_TRUE(thick_marker->HasThicknessThick());
    EXPECT_EQ(ImeTextSpanUnderlineStyle::kDot, marker->UnderlineStyle());
    EXPECT_EQ(Color::kGray, marker->TextColor());
}
...
{
    CompositionMarker* marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kDash, Color::kTransparent, Color::kGray);
    EXPECT_EQ(Color::kDarkGray, marker->UnderlineColor());
    EXPECT_TRUE(marker->HasThicknessThin());
    ...
    CompositionMarker* thick_marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThick, ImeTextSpanUnderlineStyle::kDash, Color::kTransparent, Color::kGray);
    EXPECT_TRUE(thick_marker->HasThicknessThick());
    EXPECT_EQ(ImeTextSpanUnderlineStyle::kDash, marker->UnderlineStyle());
    EXPECT_EQ(Color::kTransparent, marker->TextColor());
}
...
{
    CompositionMarker* marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThin, ImeTextSpanUnderlineStyle::kSquiggle, Color::kTransparent, Color::kGray);
    EXPECT_EQ(Color::kDarkGray, marker->UnderlineColor());
    EXPECT_TRUE(marker->HasThicknessThin());
    ...
    CompositionMarker* thick_marker = MakeGarbageCollected<CompositionMarker>(
        0, 1, Color::kDarkGray, ImeTextSpanThickness::kThick, ImeTextSpanUnderlineStyle::kSquiggle, Color::kTransparent, Color::kGray);
    EXPECT_TRUE(thick_marker->HasThicknessThick());
    EXPECT_EQ(ImeTextSpanUnderlineStyle::kSquiggle, marker->UnderlineStyle());
    EXPECT_EQ(Color::kTransparent, marker->TextColor());
}
