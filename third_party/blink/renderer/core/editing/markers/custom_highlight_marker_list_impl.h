...
class CORE_EXPORT CustomHighlightMarkerListImpl final : public HighlightPseudoMarkerListImpl {
public:
    CustomHighlightMarkerListImpl() = default;
    CustomHighlightMarkerListImpl(const CustomHighlightMarkerListImpl&) = delete;
    CustomHighlightMarkerListImpl& operator=(const CustomHighlightMarkerListImpl&) = delete;
...
template <> struct DowncastTraits<CustomHighlightMarkerListImpl> {
