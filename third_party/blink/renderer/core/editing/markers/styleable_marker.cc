...
StyleableMarker::StyleableMarker(unsigned start_offset, unsigned end_offset, Color underline_color, ImeTextSpanThickness thickness,
...
{
    return thickness_ != ImeTextSpanThickness::kNone && underline_color_ == Color::kTransparent;
}
...
bool IsStyleableMarker(const DocumentMarker& marker)
{
    ...
    return type == DocumentMarker::kComposition || type == DocumentMarker::kActiveSuggestion || type == DocumentMarker::kSuggestion;
}
