...
template <typename Strategy> class SelectionTemplate final {
    DISALLOW_NEW();
...
public:
    ...
    public:
        ...
        Builder& SetBaseAndExtent(const PositionTemplate<Strategy>& base, const PositionTemplate<Strategy>& extent);
        ...
        Builder& SetBaseAndExtentDeprecated(const PositionTemplate<Strategy>& base, const PositionTemplate<Strategy>& extent);
    ...
    public:
        ...
        InvalidSelectionResetter& operator=(const InvalidSelectionResetter&) = delete;
...
extern template class CORE_EXTERN_TEMPLATE_EXPORT SelectionTemplate<EditingStrategy>;
extern template class CORE_EXTERN_TEMPLATE_EXPORT SelectionTemplate<EditingInFlatTreeStrategy>;
...
CORE_EXPORT SelectionInDOMTree ConvertToSelectionInDOMTree(const SelectionInFlatTree&);
CORE_EXPORT SelectionInFlatTree ConvertToSelectionInFlatTree(const SelectionInDOMTree&);
