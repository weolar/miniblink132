...
class CORE_EXPORT InsertIncrementalTextCommand final : public InsertTextCommand {
public:
    InsertIncrementalTextCommand(Document&, const String& text, RebalanceType = kRebalanceLeadingAndTrailingWhitespaces);
