...
TEST_F(StyleCommandsTest, ComputeAndSetTypingStyleWithNullPosition)
{
    ...
    InsertStyleElement("b {"
                       ...
                       "overflow-x: scroll;"
                       "}");
    Selection().SetSelection(SetSelectionTextToBody("|<b></b>&#32;"), SetSelectionOptions());

    EXPECT_TRUE(StyleCommands::ExecuteToggleBold(GetFrame(), nullptr, EditorCommandSource::kDOM, ""));
