...
public:
    ...
    IgnorableEditingAbortState& operator=(const IgnorableEditingAbortState&) = delete;
    ~IgnorableEditingAbortState();
...
// unexpectedly.
#define ASSERT_NO_EDITING_ABORT (NoEditingAbortChecker(__FILE__, __LINE__).GetEditingState())
#else
