...
SelectionForUndoStep SelectionForUndoStep::From(const SelectionInDOMTree& selection)
{
...
SelectionForUndoStep::SelectionForUndoStep(const SelectionForUndoStep& other) = default;

SelectionForUndoStep::SelectionForUndoStep() = default;

SelectionForUndoStep& SelectionForUndoStep::operator=(const SelectionForUndoStep& other) = default;
...
bool SelectionForUndoStep::operator==(const SelectionForUndoStep& other) const
{
    ...
    return anchor_ == other.anchor_ && focus_ == other.focus_ && affinity_ == other.affinity_ && is_anchor_first_ == other.is_anchor_first_;
}
...
SelectionInDOMTree SelectionForUndoStep::AsSelection() const
{
    ...
    return SelectionInDOMTree::Builder().SetBaseAndExtent(anchor_, focus_).SetAffinity(affinity_).Build();
}
...
SelectionForUndoStep::Builder& SelectionForUndoStep::Builder::SetAnchorAndFocusAsBackwardSelection(const Position& anchor, const Position& focus)
{
...
SelectionForUndoStep::Builder& SelectionForUndoStep::Builder::SetAnchorAndFocusAsForwardSelection(const Position& anchor, const Position& focus)
{
    DCHECK(anchor.IsNotNull());
    DCHECK(focus.IsNotNull());
    DCHECK_NE(anchor, focus);
...
// ---
VisibleSelection CreateVisibleSelection(const SelectionForUndoStep& selection_in_undo_step)
{
