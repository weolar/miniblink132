...
{
    const char* body_content = "<div contenteditable><blockquote>a<br>b<br></blockquote></div>";
    ...
    //      BR (editable)
    SimpleEditCommand* command = MakeGarbageCollected<SplitElementCommand>(To<Element>(blockquote), at_child);
