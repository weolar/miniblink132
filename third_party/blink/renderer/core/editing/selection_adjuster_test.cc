...
{
    const SelectionInDOMTree& selection = SetSelectionTextToBody("<span><template data-mode=\"open\">a|bc</template></span>^");
    const SelectionInDOMTree& result = SelectionAdjuster::AdjustSelectionToAvoidCrossingShadowBoundaries(selection);
...
TEST_F(SelectionAdjusterTest, AdjustShadowToCollpasedInFlatTree)
{
    ...
    const SelectionInFlatTree& selection = SelectionInFlatTree::Builder()
                                               .Collapse(PositionInFlatTree::AfterNode(input))
                                               .Extend(PositionInFlatTree(*input.InnerEditorElement()->firstChild(), 1))
                                               .Build();
    const SelectionInFlatTree& result = SelectionAdjuster::AdjustSelectionToAvoidCrossingShadowBoundaries(selection);
    EXPECT_EQ("<input value=\"abc\"><div>abc</div></input>|", GetSelectionTextInFlatTreeFromBody(result));
}
...
TEST_F(SelectionAdjusterTest, DeleteNonEditableRange)
{
    ...
    const SelectionInDOMTree& result = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection);
...
TEST_F(SelectionAdjusterTest, ShadowRootAsRootBoundaryElement)
{
    ...
    const SelectionInDOMTree& selection
        = SelectionInDOMTree::Builder().Collapse(Position::FirstPositionInNode(*foo)).Extend(Position::LastPositionInNode(*bar)).Build();
    const SelectionInDOMTree& result = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection);
    ...
    const SelectionInFlatTree& selection_in_flat_tree
        = SelectionInFlatTree::Builder().Collapse(PositionInFlatTree::FirstPositionInNode(*foo)).Extend(PositionInFlatTree::LastPositionInNode(*bar)).Build();
    const SelectionInFlatTree& result_in_flat_tree = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection_in_flat_tree);

    EXPECT_EQ(PositionInFlatTree::FirstPositionInNode(*foo), result_in_flat_tree.Anchor());
    EXPECT_EQ(PositionInFlatTree::LastPositionInNode(*bar), result_in_flat_tree.Focus());
}

TEST_F(SelectionAdjusterTest, ShadowRootAsRootBoundaryElementEditable)
{
    const char* body_content = "<div id='host'></div>";
    const char* shadow_content = "foo"
    ...
    const SelectionInDOMTree& selection2
        = SelectionInDOMTree::Builder().Collapse(Position::LastPositionInNode(*bar)).Extend(Position::FirstPositionInNode(*foo)).Build();
    const SelectionInDOMTree& result2 = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection2);
    ...
    const SelectionInFlatTree& selection_in_flat_tree2
        = SelectionInFlatTree::Builder().Collapse(PositionInFlatTree::LastPositionInNode(*bar)).Extend(PositionInFlatTree::FirstPositionInNode(*foo)).Build();
    const SelectionInFlatTree& result_in_flat_tree2 = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection_in_flat_tree2);

    EXPECT_EQ(PositionInFlatTree::LastPositionInNode(*bar), result_in_flat_tree2.Anchor());
    EXPECT_EQ(PositionInFlatTree::FirstPositionInNode(*bar), result_in_flat_tree2.Focus());
}
...
TEST_F(SelectionAdjusterTest, ShadowDistributedNodesWithoutEditingBoundary)
{
    ...
    const SelectionInFlatTree& selection
        = SelectionInFlatTree::Builder().Collapse(PositionInFlatTree::FirstPositionInNode(*s1)).Extend(PositionInFlatTree::LastPositionInNode(*foo)).Build();
    const SelectionInFlatTree& result = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection);
    EXPECT_EQ(R"HTML(
      <div id="host">
      <div>
        <div id="s1">^111</div>
    ...
    const SelectionInFlatTree& selection2
        = SelectionInFlatTree::Builder().Collapse(PositionInFlatTree::LastPositionInNode(*foo)).Extend(PositionInFlatTree::FirstPositionInNode(*s1)).Build();
    const SelectionInFlatTree& result2 = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection2);
    EXPECT_EQ(R"HTML(
      <div id="host">
      <div>
        <div id="s1">|111</div>
...
TEST_F(SelectionAdjusterTest, ShadowDistributedNodesWithEditingBoundary)
{
    ...
    const SelectionInFlatTree& selection3
        = SelectionInFlatTree::Builder().Collapse(PositionInFlatTree::FirstPositionInNode(*s1)).Extend(PositionInFlatTree::LastPositionInNode(*s2)).Build();
    const SelectionInFlatTree& result3 = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection3);
    EXPECT_EQ(R"HTML(
      <div contenteditable id="host">
      <div>
        <div id="s1">^111</div>
    ...
    const SelectionInFlatTree& selection4
        = SelectionInFlatTree::Builder().Collapse(PositionInFlatTree::FirstPositionInNode(*foo)).Extend(PositionInFlatTree::LastPositionInNode(*bar)).Build();
    const SelectionInFlatTree& result4 = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection4);
    EXPECT_EQ(R"HTML(
      <div contenteditable id="host">
      <div>
        <div id="s1">111</div>
...
TEST_F(SelectionAdjusterTest, EditingBoundaryOutsideOfShadowTree)
{
    ...
    ShadowRoot* shadow_root = SetShadowContent("<div id=extent>extent</div>", "host");
...
TEST_F(SelectionAdjusterTest, ShadowHostAndShadowTreeAreEditable)
{
    ...
    ShadowRoot* shadow_root = SetShadowContent("<div contenteditable id=bar>bar</div>", "host");
...
TEST_F(SelectionAdjusterTest, AdjustSelectionTypeWithShadow)
{
    ...
    const SelectionInDOMTree& selection = SelectionInDOMTree::Builder().Collapse(base).Extend(extent).Build();

    // Should not crash
    const SelectionInDOMTree& adjusted = SelectionAdjuster::AdjustSelectionType(selection);
...
TEST_F(SelectionAdjusterTest, AdjustShadowWithRootAndHost)
{
    ...
    Element* host = GetDocument().getElementById(AtomicString("host"));
    const SelectionInDOMTree& selection = SelectionInDOMTree::Builder().Collapse(Position(shadow_root, 0)).Extend(Position(host, 0)).Build();
...
TEST_F(SelectionAdjusterTest, AdjustSelectionWithNextNonEditableNode)
{
    ...
    const SelectionInDOMTree& selection = SelectionInDOMTree::Builder().Collapse(Position(one, 0)).Extend(Position(two, 0)).Build();
    const SelectionInDOMTree& editing_selection = SelectionAdjuster::AdjustSelectionToAvoidCrossingEditingBoundaries(selection);
    EXPECT_EQ(editing_selection.Anchor(), selection.Anchor());
    EXPECT_EQ(editing_selection.Focus(), Position::BeforeNode(*two));

    const SelectionInDOMTree& adjusted_selection = SelectionAdjuster::AdjustSelectionType(editing_selection);
    EXPECT_EQ(adjusted_selection.Anchor(), Position::FirstPositionInNode(*one->firstChild()));
