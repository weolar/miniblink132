...
class CORE_EXPORT TextSuggestionBackendImpl final : public GarbageCollected<TextSuggestionBackendImpl>,
                                                    public mojom::blink::TextSuggestionBackend,
                                                    public Supplement<LocalFrame> {
public:
    static const char kSupplementName[];
    static TextSuggestionBackendImpl* From(LocalFrame&);
    static void Bind(LocalFrame*, mojo::PendingReceiver<mojom::blink::TextSuggestionBackend>);

    explicit TextSuggestionBackendImpl(
        base::PassKey<TextSuggestionBackendImpl>, LocalFrame&, mojo::PendingReceiver<mojom::blink::TextSuggestionBackend> receiver);

    // Not copyable or movable
    TextSuggestionBackendImpl(const TextSuggestionBackendImpl&) = delete;
    TextSuggestionBackendImpl& operator=(const TextSuggestionBackendImpl&) = delete;
...
private:
    HeapMojoReceiver<mojom::blink::TextSuggestionBackend, TextSuggestionBackendImpl, HeapMojoWrapperMode::kForceWithoutContextObserver> receiver_;
};
