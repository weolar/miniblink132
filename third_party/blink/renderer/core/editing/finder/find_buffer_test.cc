...
protected:
    ...
    {
        return GetDocument().documentElement()->lastChild() ? PositionInFlatTree::AfterNode(*GetDocument().documentElement()->lastChild())
                                                            : PositionInFlatTree::LastPositionInNode(*GetDocument().documentElement());
    }

    EphemeralRangeInFlatTree WholeDocumentRange()
    {
        return EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*GetDocument().documentElement()), LastPositionInDocument());
    }
    ...
    EphemeralRangeInFlatTree CreateRange(const Node& start_node, int start_offset, const Node& end_node, int end_offset)
    {
        return EphemeralRangeInFlatTree(PositionInFlatTree(start_node, start_offset), PositionInFlatTree(end_node, end_offset));
    }

    std::string SerializeRange(const EphemeralRangeInFlatTree& range)
    {
        return GetSelectionTextInFlatTreeFromBody(SelectionInFlatTree::Builder().SetAsForwardSelection(range).Build());
    }

    static unsigned CaseInsensitiveMatchCount(FindBuffer& buffer, const String& query)
    {
        return buffer.FindMatches(query, kCaseInsensitive).CountForTesting();
    }

    static constexpr FindOptions kCaseInsensitive = FindOptions().SetCaseInsensitive(true);
};

// A test with an HTML data containing no <ruby> should use FindBufferParamTest,
// and should create a FindBuffer with GetParam().
class FindBufferParamTest : public FindBufferTest, public testing::WithParamInterface<RubySupport> { };

INSTANTIATE_TEST_SUITE_P(, FindBufferParamTest, ::testing::Values(RubySupport::kDisabled, RubySupport::kEnabledForcefully));

TEST_P(FindBufferParamTest, FindInline)
{
    SetBodyContent("<div id='container'>a<span id='span'>b</span><b id='b'>c</b><div "
    ...
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 0), PositionFromParentId("inline-div", 1)),
        buffer.RangeFromBufferIndex(match.start, match.start + match.length));
}

TEST_P(FindBufferParamTest, RangeFromBufferIndex)
{
    SetBodyContent("<div id='container'>a <span id='span'> b</span><b id='b'>cc</b><div "
                   "id='none' style='display:none'>d</div><div id='inline-div' "
                   "style='display: inline;'>e</div></div>");
    FindBuffer buffer(WholeDocumentRange(), GetParam());
    // Range for "a"
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 0), PositionFromParentId("container", 1)), buffer.RangeFromBufferIndex(0, 1));
    EXPECT_EQ("<div id=\"container\">^a| <span id=\"span\"> b</span><b "
    ...
    // Range for "a "
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 0), PositionFromParentId("container", 2)), buffer.RangeFromBufferIndex(0, 2));
    EXPECT_EQ("<div id=\"container\">^a |<span id=\"span\"> b</span><b "
              "id=\"b\">cc</b><div id=\"none\" style=\"display:none\">d</div><div "
              "id=\"inline-div\" style=\"display: inline;\">e</div></div>",
        SerializeRange(buffer.RangeFromBufferIndex(0, 2)));
    // Range for "a b"
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 0), PositionFromParentId("span", 2)), buffer.RangeFromBufferIndex(0, 3));
    EXPECT_EQ("<div id=\"container\">^a <span id=\"span\"> b|</span><b "
              "id=\"b\">cc</b><div id=\"none\" style=\"display:none\">d</div><div "
              "id=\"inline-div\" style=\"display: inline;\">e</div></div>",
        SerializeRange(buffer.RangeFromBufferIndex(0, 3)));
    // Range for "a bc"
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 0), PositionFromParentId("b", 1)), buffer.RangeFromBufferIndex(0, 4));
    EXPECT_EQ("<div id=\"container\">^a <span id=\"span\"> b</span><b "
              "id=\"b\">c|c</b><div id=\"none\" style=\"display:none\">d</div><div "
              "id=\"inline-div\" style=\"display: inline;\">e</div></div>",
        SerializeRange(buffer.RangeFromBufferIndex(0, 4)));
    // Range for "a bcc"
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 0), PositionFromParentId("b", 2)), buffer.RangeFromBufferIndex(0, 5));
    EXPECT_EQ("<div id=\"container\">^a <span id=\"span\"> b</span><b "
              "id=\"b\">cc|</b><div id=\"none\" style=\"display:none\">d</div><div "
              "id=\"inline-div\" style=\"display: inline;\">e</div></div>",
        SerializeRange(buffer.RangeFromBufferIndex(0, 5)));
    // Range for "a bcce"
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 0), PositionFromParentId("inline-div", 1)), buffer.RangeFromBufferIndex(0, 6));
    EXPECT_EQ("<div id=\"container\">^a <span id=\"span\"> b</span><b "
              "id=\"b\">cc</b><div id=\"none\" style=\"display:none\">d</div><div "
              "id=\"inline-div\" style=\"display: inline;\">e|</div></div>",
        SerializeRange(buffer.RangeFromBufferIndex(0, 6)));
    // Range for " b"
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 1), PositionFromParentId("span", 2)), buffer.RangeFromBufferIndex(1, 3));
    EXPECT_EQ("<div id=\"container\">a^ <span id=\"span\"> b|</span><b "
              "id=\"b\">cc</b><div id=\"none\" style=\"display:none\">d</div><div "
              "id=\"inline-div\" style=\"display: inline;\">e</div></div>",
        SerializeRange(buffer.RangeFromBufferIndex(1, 3)));
    // Range for " bc"
    EXPECT_EQ(EphemeralRangeInFlatTree(PositionFromParentId("container", 1), PositionFromParentId("b", 1)), buffer.RangeFromBufferIndex(1, 4));
    EXPECT_EQ("<div id=\"container\">a^ <span id=\"span\"> b</span><b "
              "id=\"b\">c|c</b><div id=\"none\" style=\"display:none\">d</div><div "
              "id=\"inline-div\" style=\"display: inline;\">e</div></div>",
...
{
    PositionInFlatTree start_position = ToPositionInFlatTree(SetCaretTextToBody("f|oofoo"));
    Node* node = start_position.ComputeContainerNode();
    // |end_position| = foofoo| (end of text).
    PositionInFlatTree end_position = PositionInFlatTree::LastPositionInNode(*node);
    {
        FindBuffer buffer(EphemeralRangeInFlatTree(start_position, end_position), GetParam());
...
{
    SetBodyContent("<div id='div'>foo<span id='span'>foof<b id='b'>oo</b></span></div>");
    ...
    {
        FindBuffer buffer(
            EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*div->firstChild()), PositionInFlatTree::LastPositionInNode(*span->firstChild())),
            GetParam());
    ...
    // So buffer = "oofoofo"
    {
        FindBuffer buffer(CreateRange(*div->firstChild(), 1, *b->firstChild(), 1), GetParam());
        EXPECT_EQ(1u, CaseInsensitiveMatchCount(buffer, "foo"));
        EXPECT_EQ(2u, CaseInsensitiveMatchCount(buffer, "oof"));
        EXPECT_EQ(2u, CaseInsensitiveMatchCount(buffer, "fo"));
        EXPECT_EQ(2u, CaseInsensitiveMatchCount(buffer, "oo"));
    ...
    // So buffer = "oof"
    {
        FindBuffer buffer(CreateRange(*span->firstChild(), 1, *span->firstChild(), 4), GetParam());
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "foo"));
    ...
    // <div>foo<span>foof^<b>oo|</b></span></div>
    // So buffer = "oo"
    FindBuffer buffer(CreateRange(*span->firstChild(), 4, *b->firstChild(), 2), GetParam());
    EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "foo"));
...
{
    SetBodyContent("<div id='div'>foo<span id='span' style='display:none'>foof</span><b "
    ...
    {
        FindBuffer buffer(
            EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*div->firstChild()), PositionInFlatTree(*span->firstChild(), 3)), GetParam());
        EXPECT_EQ(1u, CaseInsensitiveMatchCount(buffer, "foo"));
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "oof"));
    ...
    // So buffer = "oo"
    {
        FindBuffer buffer(CreateRange(*span->firstChild(), 1, *b->firstChild(), 2), GetParam());
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "foo"));
        EXPECT_EQ(1u, CaseInsensitiveMatchCount(buffer, "oo"));
        EXPECT_EQ(2u, CaseInsensitiveMatchCount(buffer, "o"));
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "f"));
    ...
    // So buffer = "oo"
    {
        FindBuffer buffer(CreateRange(*span->firstChild(), 1, *script->firstChild(), 2), GetParam());
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "foo"));
        EXPECT_EQ(1u, CaseInsensitiveMatchCount(buffer, "oo"));
        EXPECT_EQ(2u, CaseInsensitiveMatchCount(buffer, "o"));
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "f"));
    ...
    // So buffer = "o"
    {
        FindBuffer buffer(CreateRange(*script->firstChild(), 1, *a->firstChild(), 1), GetParam());
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "foo"));
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "oo"));
        EXPECT_EQ(1u, CaseInsensitiveMatchCount(buffer, "o"));
        EXPECT_EQ(0u, CaseInsensitiveMatchCount(buffer, "f"));
...
TEST_F(FindBufferTest, FindMatchInRange)
{
    ...
    Element* a = GetElementById("a");
    Element* b = GetElementById("b");
    EphemeralRangeInFlatTree foo1
        = EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*div->firstChild()), PositionInFlatTree::LastPositionInNode(*div->firstChild()));
    EphemeralRangeInFlatTree foo2
        = EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*a->firstChild()), PositionInFlatTree(*a->firstChild(), 3));
    EphemeralRangeInFlatTree foo3 = EphemeralRangeInFlatTree(PositionInFlatTree(*a->firstChild(), 3), PositionInFlatTree::LastPositionInNode(*b->firstChild()));

    // <div>^foo<a>foof</a><b>oo|</b></div>, forwards
    EphemeralRangeInFlatTree match = FindBuffer::FindMatchInRange(WholeDocumentRange(), "foo", kCaseInsensitive);
    EXPECT_EQ(foo1, match);
    // <div>f^oo<a>foof</a><b>oo|</b></div>, forwards
    match
        = FindBuffer::FindMatchInRange(EphemeralRangeInFlatTree(PositionInFlatTree(*div->firstChild(), 1), LastPositionInDocument()), "foo", kCaseInsensitive);
    ...
    match = FindBuffer::FindMatchInRange(
        EphemeralRangeInFlatTree(PositionInFlatTree(*a->firstChild(), 1), PositionInFlatTree::LastPositionInNode(*a->firstChild())), "foo", kCaseInsensitive);
    EXPECT_TRUE(match.IsNull());
    // <div>foo<a>f^oof</a><b>oo|</b></div>, forwards
    match = FindBuffer::FindMatchInRange(EphemeralRangeInFlatTree(PositionInFlatTree(*a->firstChild(), 1), LastPositionInDocument()), "foo", kCaseInsensitive);
    EXPECT_EQ(foo3, match);

    constexpr FindOptions kCaseInsensitiveBackwards = FindOptions().SetCaseInsensitive(true).SetBackwards(true);

    // <div>^foo<a>foof</a><b>oo|</b></div>, backwards
    match = FindBuffer::FindMatchInRange(WholeDocumentRange(), "foo", kCaseInsensitiveBackwards);
    EXPECT_EQ(foo3, match);
    // <div>^foo<a>foof</a><b>o|o</b></div>, backwards
    match = FindBuffer::FindMatchInRange(
        EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*div->firstChild()), PositionInFlatTree(*b->firstChild(), 1)), "foo",
        kCaseInsensitiveBackwards);
    EXPECT_EQ(foo2, match);
    // <div>foo<a>^foof</a><b>o|o</b></div>, backwards
    match = FindBuffer::FindMatchInRange(
        EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*a->firstChild()), PositionInFlatTree(*b->firstChild(), 1)), "foo",
        kCaseInsensitiveBackwards);
    EXPECT_EQ(foo2, match);
    // <div>foo<a>foo^f</a><b>o|o</b></div>, backwards
    match = FindBuffer::FindMatchInRange(
        EphemeralRangeInFlatTree(PositionInFlatTree(*a->firstChild(), 3), PositionInFlatTree(*b->firstChild(), 1)), "foo", kCaseInsensitiveBackwards);
    EXPECT_TRUE(match.IsNull());
    // <div>^foo<a>fo|of</a><b>oo</b></div>, backwards
    match = FindBuffer::FindMatchInRange(
        EphemeralRangeInFlatTree(PositionInFlatTree::FirstPositionInNode(*div->firstChild()), PositionInFlatTree(*a->firstChild(), 2)), "foo",
        kCaseInsensitiveBackwards);
    EXPECT_EQ(foo1, match);
}
...
TEST_F(FindBufferTest, FindMatchInRangeIgnoreNonSearchable)
{
    ...
    EphemeralRangeInFlatTree match = FindBuffer::FindMatchInRange(WholeDocumentRange(), "me", kCaseInsensitive);
    EXPECT_TRUE(match.IsNull());
}

class FindBufferBlockTest : public FindBufferTest, public testing::WithParamInterface<std::tuple<std::string, RubySupport>> { };

std::string GenerateSuffix(const testing::TestParamInfo<FindBufferBlockTest::ParamType>& info)
{
    ...
    return display + "_" + (ruby_support == RubySupport::kDisabled ? "RubyDisabled" : "RubyEnabled");
}

INSTANTIATE_TEST_SUITE_P(Blocks, FindBufferBlockTest,
    testing::Combine(
        testing::Values("block", "table", "flow-root", "grid", "flex", "list-item"), testing::Values(RubySupport::kDisabled, RubySupport::kEnabledForcefully)),
    GenerateSuffix);

TEST_P(FindBufferBlockTest, FindBlock)
{
    auto [display, ruby_support] = GetParam();
    SetBodyContent("text<div id='block' style='display: " + display + ";'>block</div><span id='span'>span</span>");
    PositionInFlatTree position_after_block;
    {
        FindBuffer text_buffer(WholeDocumentRange(), ruby_support);
        EXPECT_EQ(GetElementById("block"), *text_buffer.PositionAfterBlock().ComputeContainerNode());
    ...
    {
        FindBuffer block_buffer(EphemeralRangeInFlatTree(position_after_block, LastPositionInDocument()), ruby_support);
        EXPECT_EQ(GetElementById("span"), *block_buffer.PositionAfterBlock().ComputeContainerNode());
    ...
    {
        FindBuffer span_buffer(EphemeralRangeInFlatTree(position_after_block, LastPositionInDocument()), ruby_support);
...
class FindBufferSeparatorTest : public FindBufferTest, public testing::WithParamInterface<std::string> { };

INSTANTIATE_TEST_SUITE_P(Separators, FindBufferSeparatorTest, testing::Values("br", "hr", "meter", "object", "progress", "select", "video"));
...
TEST_P(FindBufferParamTest, WholeWordTest)
{
    ...
    FindBuffer buffer(WholeDocumentRange(), GetParam());
    EXPECT_EQ(2u, CaseInsensitiveMatchCount(buffer, "foo"));
    constexpr FindOptions kCaseInsensitiveWholeWord = FindOptions().SetCaseInsensitive(true).SetWholeWord(true);
    EXPECT_EQ(1u, buffer.FindMatches("foo", kCaseInsensitiveWholeWord).CountForTesting());
    EXPECT_EQ(2u, CaseInsensitiveMatchCount(buffer, "bar"));
    EXPECT_EQ(1u, buffer.FindMatches("bar", kCaseInsensitiveWholeWord).CountForTesting());
    EXPECT_EQ(1u, buffer.FindMatches(u"六", kCaseInsensitiveWholeWord).CountForTesting());
    EXPECT_EQ(1u, buffer.FindMatches(u"本木", kCaseInsensitiveWholeWord).CountForTesting());
}
...
TEST_P(FindBufferParamTest, FindPlainTextInvalidTarget1)
{
    ...
    static const UChar kInvalid1[] = { 0x1461u, 0x2130u, 0x129bu, 0xd711u, 0xd6feu, 0xccadu, 0x7064u, 0xd6a0u, 0x4e3bu, 0x03abu, 0x17dcu, 0xb8b7u, 0xbf55u,
        0xfca0u, 0x07fau, 0x0427u, 0xda0au, 0 };
...
TEST_P(FindBufferParamTest, FindPlainTextInvalidTarget2)
{
    ...
    static const UChar kInvalid2[] = { 0x1461u, 0x2130u, 0x129bu, 0xdc01u, 0xd6feu, 0xccadu, 0 };
...
TEST_P(FindBufferParamTest, FindPlainTextInvalidTarget3)
{
    ...
    static const UChar kInvalid3[] = { 0xd800u, 0xdc00u, 0x0061u, 0xdc03u, 0xd901u, 0xccadu, 0 };
    FindBuffer buffer(WholeDocumentRange(), GetParam());
...
TEST_P(FindBufferParamTest, DisplayBlock)
{
    ...
    FindBuffer buffer(WholeDocumentRange(), GetParam());
    const auto results = buffer.FindMatches("find", FindOptions());
    ASSERT_EQ(0u, results.CountForTesting()) << "We should not match across block.";
}
...
TEST_P(FindBufferParamTest, InputTest)
{
    ...
    EXPECT_EQ(buffer.PositionAfterBlock(), PositionInFlatTree::FirstPositionInNode(*GetElementById("i1")));
}
...
{
    SetBodyContent("some text with <script></script> and \uFFFC (object replacement "
                   "character)");
    FindBuffer buffer(WholeDocumentRange(), GetParam());
...
TEST_P(FindBufferParamTest, FindMaxCodepointWithReplacedElementAndMaxCodepointUTF32)
{
    SetBodyContent("some text with <img/> <script></script> and \U0010FFFF (max codepoint)");
    FindBuffer buffer(WholeDocumentRange(), GetParam());
...
TEST_P(FindBufferParamTest, FindNonCharacterWithReplacedElementAndNonCharacterUTF16)
{
    SetBodyContent("some text with <img/> <scrip></script> and \uFFFF (non character)");
    FindBuffer buffer(WholeDocumentRange(), GetParam());
    const auto results = buffer.FindMatches(u"\uFFFF", FindOptions());
    ASSERT_EQ(1u, results.CountForTesting());
}
...
TEST_P(FindBufferParamTest, DoNotSearchInSuggestedValues)
{
    ...
    TextControlElement& text_control_element = To<TextControlElement>(*input_element);
...
{
    SetBodyContent("<table id='table'><tbody><tr id='row'><td id='c1'>c1 "
...
{
    SetBodyContent("<div id=outer>a<div id=inner>b</div><i id='styled'>i</i>c</div>");
    ...
    ASSERT_TRUE(FindBuffer::IsInSameUninterruptedBlock(*text_node_i, *text_node_c));
    ASSERT_TRUE(FindBuffer::IsInSameUninterruptedBlock(*styled, *text_node_c));
    ASSERT_FALSE(FindBuffer::IsInSameUninterruptedBlock(*text_node_a, *text_node_c));
    ASSERT_FALSE(FindBuffer::IsInSameUninterruptedBlock(*text_node_a, *text_node_b));
}
...
TEST_F(FindBufferTest, IsInSameUninterruptedBlock_input)
{
    ...
    ASSERT_FALSE(FindBuffer::IsInSameUninterruptedBlock(*text_node_a, *editable_div));
}

TEST_F(FindBufferTest, IsInSameUninterruptedBlock_table)
{
    SetBodyContent("<table id='table'>"
                   "<tbody>"
                   "<tr id='row'>"
                   "  <td id='c1'>c1</td>"
                   "  <td id='c2'>c2</td>"
    ...
    ASSERT_FALSE(FindBuffer::IsInSameUninterruptedBlock(*text_node_1, *text_node_3));
}

TEST_F(FindBufferTest, IsInSameUninterruptedBlock_comment)
{
    SetBodyContent("<div id='text'><span id='span1'>abc</span><!--comment--><span "
...
TEST_F(FindBufferTest, GetFirstBlockLevelAncestorInclusive)
{
    ...
    ASSERT_EQ(outer_div, FindBuffer::GetFirstBlockLevelAncestorInclusive(*text_node_a));
    ASSERT_EQ(outer_div, FindBuffer::GetFirstBlockLevelAncestorInclusive(*text_node_c));
    ASSERT_EQ(inner_div, FindBuffer::GetFirstBlockLevelAncestorInclusive(*text_node_b));
}
...
{
    SetBodyContent("<p id=container>before <ruby id=r>base<rt>anno</ruby> after</p>");
    FindBuffer buffer(CreateRange(*GetElementById("r")->firstChild(), 2, *GetElementById("r")->nextSibling(), 4), RubySupport::kEnabledIfNecessary);
...
{
    SetBodyContent("<p id=p>before <ruby id=r>base<rt id=rt>anno</rt>base2</ruby> "
                   "after</p>");
    FindBuffer buffer(CreateRange(*GetElementById("p"), 0, *GetElementById("rt")->firstChild(), 2), GetParam());
    EXPECT_EQ(PositionInFlatTree::FirstPositionInNode(*GetElementById("rt")->nextSibling()), buffer.PositionAfterBlock());
}

TEST_P(FindBufferParamTest, RubyBuffersEndAtDisplayNoneTextInRuby)
{
    SetBodyContent("<p id=p>before <ruby id=r>base <span style='display:none' "
                   "id=none>text</span> base<rt>anno</ruby> after</p>");
    FindBuffer buffer(CreateRange(*GetElementById("p"), 0, *GetElementById("none")->firstChild(), 2), GetParam());
    EXPECT_EQ(PositionInFlatTree::FirstPositionInNode(*GetElementById("none")->nextSibling()), buffer.PositionAfterBlock());
}
...
{
    SetBodyContent("<p>before <span style='display:ruby-text'>anno</span> after</p>");
    FindBuffer buffer(WholeDocumentRange(), RubySupport::kEnabledIfNecessary);
    auto buffer_list = buffer.BuffersForTesting();
    ASSERT_EQ(2u, buffer_list.size());
    EXPECT_EQ("before ____ after", ReplaceZero(buffer_list[0]));
...
{
    SetBodyContent("<p>before <ruby>base <b><span "
...
{
    SetBodyContent("<p>before <ruby>base <b style='display:contents'><span "
                   "style='display:ruby-text'>anno</span></b></ruby> after</p>");
    FindBuffer buffer(WholeDocumentRange(), RubySupport::kEnabledIfNecessary);
    auto buffer_list = buffer.BuffersForTesting();
    ASSERT_EQ(2u, buffer_list.size());
...
{
    SetBodyContent("<p>before <ruby id=r style='display:block ruby'>base<rt>anno</ruby> "
                   "after</p>");
    FindBuffer buffer(CreateRange(*GetElementById("r")->firstChild(), 2, *GetElementById("r")->nextSibling(), 4), RubySupport::kEnabledIfNecessary);
    auto buffer_list = buffer.BuffersForTesting();
    ASSERT_EQ(2u, buffer_list.size());
...
{
    SetBodyContent("<p>残暑お<ruby>見<rt>み</ruby><ruby>舞<rt>ま</ruby>い"
                   "申し上げます。</p>");
    {
        FindBuffer buffer(WholeDocumentRange(), RubySupport::kEnabledIfNecessary);
...
{
    SetBodyContent("<p>の<ruby><ruby>超電磁砲<rt>レールガン</ruby><rt>railgun</ruby></p>");
    {
        FindBuffer buffer(WholeDocumentRange(), RubySupport::kEnabledIfNecessary);
...
{
    SetBodyContent("<p>の<ruby>超電磁砲<rt>レール<ruby>ガン<rt>gun</ruby></ruby></p>");
    {
        FindBuffer buffer(WholeDocumentRange(), RubySupport::kEnabledIfNecessary);
...
TEST_P(FindBufferParamTest, PositionAfterBlock)
{
    ...
    EXPECT_EQ(0u, results.CountForTesting());
    EXPECT_EQ(PositionInFlatTree::FirstPositionInNode(*GetDocument().body()->lastChild()), buffer.PositionAfterBlock());
}
