...
class CORE_EXPORT FindTaskController final : public GarbageCollected<FindTaskController> {
public:
    ...
    void StartRequest(int identifier, const String& search_text, const mojom::blink::FindOptions& options);
    ...
    // was searched.
    bool ShouldFindMatches(int identifier, const String& search_text, const mojom::blink::FindOptions& options);
    ...
    void DidFinishTask(int identifier, const String& search_text, const mojom::blink::FindOptions& options, bool finished_whole_request,
...
private:
    void RequestFindTask(int identifier, const String& search_text, const mojom::blink::FindOptions& options);
