...
public:
    ...
    public:
        ...
        Iterator() = default;
        Iterator(const FindBuffer* find_buffer, TextSearcherICU* text_searcher, const Vector<std::unique_ptr<TextSearcherICU>>& extra_searchers);
    ...
    FindResults();
    FindResults(const FindBuffer* find_buffer, TextSearcherICU* text_searcher, const Vector<UChar>& buffer, const Vector<Vector<UChar>>* extra_buffers,
