...
class CORE_EXPORT ContentCaptureTask : public GarbageCollected<ContentCaptureTask> {
public:
    ...
    public:
        ...
        base::TimeDelta task_initial_delay() const
        {
    ...
    // TestHelper class.
    TaskState GetTaskStateForTesting() const
    {
        return task_state_;
    }
    ...
    void SetCapturedContentForTesting(const Vector<cc::NodeInfo>& captured_content)
    {
    ...
    const TaskDelay& GetTaskDelayForTesting() const
    {
        return *task_delay_;
    }
