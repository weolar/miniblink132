...
class CORE_EXPORT ContentCaptureManager : public GarbageCollected<ContentCaptureManager> {
public:
    ...
    void NotifyInputEvent(WebInputEvent::Type type, const LocalFrame& local_frame);
...
protected:
    ...
    TaskSession& GetTaskSessionForTesting() const
    {
        return *task_session_;
    }
