...
class MockScrollableArea : public GarbageCollected<MockScrollableArea>, public ScrollableArea {
public:
    ...
    static MockScrollableArea* Create(const ScrollOffset& maximum_scroll_offset, const ScrollOffset& minimum_scroll_offset)
    {
        MockScrollableArea* mock = Create();
        mock->SetMaximumScrollOffset(maximum_scroll_offset);
    ...
    gfx::Point ConvertFromRootFrame(const gfx::Point& point_in_root_frame) const override
    {
        return point_in_root_frame;
    }
    gfx::Point ConvertFromContainingEmbeddedContentViewToScrollbar(const Scrollbar& scrollbar, const gfx::Point& parent_point) const override
    {
        return parent_point;
    }
    ...
    void SetIsPopup()
    {
        chrome_client_->SetIsPopup(true);
    }
    ...
    float ScaleFromDIP() const override
    {
        return scale_from_dip_;
    }
