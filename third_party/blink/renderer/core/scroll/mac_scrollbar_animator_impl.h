...
class CORE_EXPORT MacScrollbarImplV2 : public ui::OverlayScrollbarAnimatorMac::Client, public MacScrollbar {
public:
    MacScrollbarImplV2(Scrollbar& scrollbar, scoped_refptr<base::SingleThreadTaskRunner> task_runner);
...
public:
    ...
    bool SetScrollbarsVisibleForTesting(bool) final
    {
        return true;
    }
    ...
    void StartScrollbarPaintTimer() final
    {
        NOTREACHED();
    }
    void StopScrollbarPaintTimer() final
    {
        NOTREACHED();
    }
    void Dispose() final;
