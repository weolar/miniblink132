...
ScrollAnimatorCompositorCoordinator::~ScrollAnimatorCompositorCoordinator() = default;
...
bool ScrollAnimatorCompositorCoordinator::AddAnimation(std::unique_ptr<cc::KeyframeModel> keyframe_model)
{
    RemoveAnimation();
...
void ScrollAnimatorCompositorCoordinator::CompositorAnimationFinished(int group_id)
{
...
bool ScrollAnimatorCompositorCoordinator::ReattachCompositorAnimationIfNeeded(cc::AnimationTimeline* timeline)
{
...
void ScrollAnimatorCompositorCoordinator::NotifyAnimationStarted(base::TimeDelta monotonic_time, int group)
{
}

void ScrollAnimatorCompositorCoordinator::NotifyAnimationFinished(base::TimeDelta monotonic_time, int group)
{
    NotifyCompositorAnimationFinished(group);
}

void ScrollAnimatorCompositorCoordinator::NotifyAnimationAborted(base::TimeDelta monotonic_time, int group)
{
...
CompositorAnimation* ScrollAnimatorCompositorCoordinator::GetCompositorAnimation() const
{
    return compositor_animation_.get();
}

gfx::PointF ScrollAnimatorCompositorCoordinator::CompositorOffsetFromBlinkOffset(ScrollOffset offset)
{
    return GetScrollableArea()->ScrollOffsetToPosition(offset);
}

ScrollOffset ScrollAnimatorCompositorCoordinator::BlinkOffsetFromCompositorOffset(gfx::PointF position)
{
...
CompositorElementId ScrollAnimatorCompositorCoordinator::GetScrollElementId() const
{
...
void ScrollAnimatorCompositorCoordinator::UpdateImplOnlyCompositorAnimations()
{
    ...
    if (host && element_id) {
        if (!impl_only_animation_adjustment_.IsZero()) {
            host->scroll_offset_animations().AddAdjustmentUpdate(element_id, gfx::Vector2dF(impl_only_animation_adjustment_));
        }
...
void ScrollAnimatorCompositorCoordinator::ScrollOffsetChanged(const ScrollOffset& offset, mojom::blink::ScrollType scroll_type)
{
...
void ScrollAnimatorCompositorCoordinator::AdjustImplOnlyScrollOffsetAnimation(const gfx::Vector2d& adjustment)
{
    if (!GetScrollableArea()->ScrollAnimatorEnabled())
        return;
