...
TEST(MessagePortTest, DispatchMessageEvent)
{
    ...
    mojo::Message mojo_message = mojom::blink::TransferableMessage::WrapAsMessage(MakeNullMessage());
...
TEST(MessagePortTest, DispatchMessageErrorEvent_LockedAgentCluster)
{
    ...
    mojo::Message mojo_message = mojom::blink::TransferableMessage::WrapAsMessage(std::move(message));
    ASSERT_TRUE(static_cast<mojo::MessageReceiver*>(port)->Accept(&mojo_message));
    run_loop.Run();
