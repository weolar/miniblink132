...
public:
    ScopedBlinkAXEventIntent(const BlinkAXEventIntent& intent, Document* document);
    ScopedBlinkAXEventIntent(const Vector<BlinkAXEventIntent>& intents, Document* document);
    ~ScopedBlinkAXEventIntent();
    ScopedBlinkAXEventIntent(const ScopedBlinkAXEventIntent& intent) = delete;
    ScopedBlinkAXEventIntent& operator=(const ScopedBlinkAXEventIntent& intent) = delete;

    const Vector<BlinkAXEventIntent>& intents() const
    {
        return intents_;
    }
