...
public:
    ...
    static BlinkAXEventIntent FromClearedSelection(const SetSelectionBy set_selection_by);
    static BlinkAXEventIntent FromModifiedSelection(const SelectionModifyAlteration alter, const SelectionModifyDirection direction,
    ...
    static BlinkAXEventIntent FromNewSelection(const TextGranularity granularity, bool is_base_first, const SetSelectionBy set_selection_by);
    ...
    BlinkAXEventIntent(ax::mojom::blink::Command command, ax::mojom::blink::InputEventType input_event_type);

    // Constructs a selection event intent; which is attached to a selection
    // changed event.
    BlinkAXEventIntent(ax::mojom::blink::Command command, ax::mojom::blink::TextBoundary text_boundary, ax::mojom::blink::MoveDirection move_direction);
    ...
    CORE_EXPORT friend bool operator==(const BlinkAXEventIntent& a, const BlinkAXEventIntent& b);
    CORE_EXPORT friend bool operator!=(const BlinkAXEventIntent& a, const BlinkAXEventIntent& b);

//     const ui::AXEventIntent& intent() const
//     {
//         return intent_;
//     }
//     ui::AXEventIntent& intent()
//     {
//         return intent_;
//     }
...
struct CORE_EXPORT BlinkAXEventIntentHashTraits : WTF::SimpleClassHashTraits<BlinkAXEventIntent> {
