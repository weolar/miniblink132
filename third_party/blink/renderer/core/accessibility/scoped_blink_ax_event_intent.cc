...
ScopedBlinkAXEventIntent::ScopedBlinkAXEventIntent(const BlinkAXEventIntent& intent, Document* document)
    : document_(document)
{
//     DCHECK(document_);
...
//         AXObjectCache::BlinkAXEventIntentsSet& active_intents = cache->ActiveEventIntents();
//         active_intents.insert(intent);
//     }
}

ScopedBlinkAXEventIntent::ScopedBlinkAXEventIntent(const Vector<BlinkAXEventIntent>& intents, Document* document)
    : intents_(intents)
    , document_(document)
{
//     DCHECK(document_);
