...
const WrapperTypeInfo& DOMSharedArrayBuffer::wrapper_type_info_ = DOMSharedArrayBuffer::wrapper_type_info_body_;
...
v8::Local<v8::Value> DOMSharedArrayBuffer::Wrap(ScriptState* script_state)
{
    ...
    v8::Local<v8::SharedArrayBuffer> wrapper;
    {
        ...
        wrapper = v8::SharedArrayBuffer::New(script_state->GetIsolate(), Content()->BackingStore());
    }
