...
public:
    ...
    static DOMDataView* Create(DOMArrayBufferBase*, size_t byte_offset, size_t byte_length);

    DOMDataView(DOMArrayBufferBase* dom_array_buffer, size_t byte_offset, size_t byte_length)
    ...
    DOMArrayBufferView::ViewType GetType() const final
    {
        return kTypeDataView;
    }
