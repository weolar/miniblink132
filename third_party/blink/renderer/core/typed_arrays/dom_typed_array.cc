...
template <typename T, typename V8TypedArray, bool clamped> v8::Local<v8::Value> DOMTypedArray<T, V8TypedArray, clamped>::Wrap(ScriptState* script_state)
{
    ...
    v8::Local<v8::Value> v8_buffer = ToV8Traits<DOMArrayBufferBase>::ToV8(script_state, buffer);
    ...
    v8::Local<v8::Object> wrapper;
    {
        ...
        if (IsShared()) {
            wrapper = V8TypedArray::New(v8_buffer.As<v8::SharedArrayBuffer>(), byteOffset(), length());
        } else {
            wrapper = V8TypedArray::New(v8_buffer.As<v8::ArrayBuffer>(), byteOffset(), length());
        }
    }
...
#define DOMTYPEDARRAY_DEFINE_WRAPPERTYPEINFO(val_t, Type, clamped)                                                                                             \
    template <>                                                                                                                                                \
    const WrapperTypeInfo DOMTypedArray<val_t, v8::Type##Array, clamped>::wrapper_type_info_body_ {                                                            \
        gin::kEmbedderBlink,                                                                                                                                   \
        nullptr,                                                                                                                                               \
        nullptr,                                                                                                                                               \
        #Type "Array",                                                                                                                                         \
    ...
    template <>                                                                                                                                                \
    const WrapperTypeInfo& DOMTypedArray<val_t, v8::Type##Array, clamped>::wrapper_type_info_                                                                  \
...
#define DOMTYPEDARRAY_EXPLICITLY_INSTANTIATE(val_t, Type, clamped) template class CORE_TEMPLATE_EXPORT DOMTypedArray<val_t, v8::Type##Array, clamped>;
