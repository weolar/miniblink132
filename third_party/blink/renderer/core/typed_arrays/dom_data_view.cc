...
const WrapperTypeInfo& DOMDataView::wrapper_type_info_ = DOMDataView::wrapper_type_info_body_;

#if defined(COMPONENT_BUILD) && defined(WIN32) && defined(__clang__)
#pragma clang diagnostic pop
#endif

DOMDataView* DOMDataView::Create(DOMArrayBufferBase* buffer, size_t byte_offset, size_t byte_length)
{
...
v8::Local<v8::Value> DOMDataView::Wrap(ScriptState* script_state)
{
    ...
    v8::Local<v8::Value> v8_buffer = ToV8Traits<DOMArrayBuffer>::ToV8(script_state, buffer());
    DCHECK(v8_buffer->IsArrayBuffer());

    v8::Local<v8::Object> wrapper;
    {
        v8::Context::Scope context_scope(script_state->GetContext());
        wrapper = v8::DataView::New(v8_buffer.As<v8::ArrayBuffer>(), byteOffset(), byteLength());
    }
