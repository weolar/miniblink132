...
public:
    ...
    const ArrayBufferContents* Content() const
    {
        return &contents_;
    }
    ...
    base::span<uint8_t> ByteSpan()
    {
        return contents_.ByteSpan();
    }
    base::span<const uint8_t> ByteSpan() const
    {
        return contents_.ByteSpan();
    }
