...
public:
    ...
    static DOMArrayBuffer* Create(base::span<const uint8_t> source)
    {
        ArrayBufferContents contents(
            source.size(), 1, ArrayBufferContents::kNotShared, ArrayBufferContents::kDontInitialize, ArrayBufferContents::AllocationFailureBehavior::kCrash);
        CHECK(contents.IsValid());
    ...
    static DOMArrayBuffer* Create(const void* source, size_t byte_length)
    {
        ...
        return Create(UNSAFE_BUFFERS(base::span(static_cast<const uint8_t*>(source), byte_length)));
    }

    static DOMArrayBuffer* Create(scoped_refptr<SharedBuffer>);
    static DOMArrayBuffer* Create(const Vector<base::span<const char>>&);

    static DOMArrayBuffer* CreateOrNull(size_t num_elements, size_t element_byte_size);
    ...
    static DOMArrayBuffer* CreateUninitializedOrNull(size_t num_elements, size_t element_byte_size);
    ...
    bool Transfer(v8::Isolate*, v8::Local<v8::Value> detach_key, ArrayBufferContents& result, ExceptionState& exception_state);

    bool Transfer(v8::Isolate*, ArrayBufferContents& result, ExceptionState& exception_state);
    ...
    v8::Local<v8::Object> AssociateWithWrapper(v8::Isolate* isolate, const WrapperTypeInfo* wrapper_type_info, v8::Local<v8::Object> wrapper) override;
...
private:
    v8::Maybe<bool> TransferDetachable(v8::Isolate*, v8::Local<v8::Value> detach_key, ArrayBufferContents& result);
