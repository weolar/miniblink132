...
DOMArrayPiece::DOMArrayPiece(const V8UnionArrayBufferOrArrayBufferView* array_buffer_or_view)
{
    ...
    case V8UnionArrayBufferOrArrayBufferView::ContentType::kArrayBufferView:
        InitWithArrayBufferView(array_buffer_or_view->GetAsArrayBufferView().Get());
        return;
    }
