...
public:
    enum EncodeReason { kEncodeReasonToDataURL = 0, kEncodeReasonToBlobCallback = 1, kEncodeReasonConvertToBlobPromise = 2, kNumberOfEncodeReasons };
    ...
    static ImageEncodingMimeType ToEncodingMimeType(const String&, const EncodeReason);
};
