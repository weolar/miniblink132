...
TEST_F(SchemeRegistryTest, NoCSPBypass)
{
    ...
    EXPECT_FALSE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme, SchemeRegistry::kPolicyAreaImage));
}
...
TEST_F(SchemeRegistryTest, FullCSPBypass)
{
    ...
    EXPECT_TRUE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme, SchemeRegistry::kPolicyAreaImage));
    EXPECT_FALSE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme2));
    EXPECT_FALSE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme2, SchemeRegistry::kPolicyAreaImage));
}
...
TEST_F(SchemeRegistryTest, PartialCSPBypass)
{
    ...
    WTF::SetIsBeforeThreadCreatedForTest(); // Required for next operation:
#endif
    SchemeRegistry::RegisterURLSchemeAsBypassingContentSecurityPolicy(kTestScheme, SchemeRegistry::kPolicyAreaImage);
    EXPECT_FALSE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme));
    EXPECT_TRUE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme, SchemeRegistry::kPolicyAreaImage));
    EXPECT_FALSE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme, SchemeRegistry::kPolicyAreaStyle));
    EXPECT_FALSE(SchemeRegistry::SchemeShouldBypassContentSecurityPolicy(kTestScheme2, SchemeRegistry::kPolicyAreaImage));
}
...
TEST_F(SchemeRegistryTest, CodeCacheWithHashing)
{
    ...
    EXPECT_FALSE(SchemeRegistry::SchemeSupportsCodeCacheWithHashing(kChromeUIScheme));
    ...
    EXPECT_TRUE(SchemeRegistry::SchemeSupportsCodeCacheWithHashing(kTestScheme));
    EXPECT_TRUE(SchemeRegistry::SchemeSupportsCodeCacheWithHashing(kChromeUIScheme));
