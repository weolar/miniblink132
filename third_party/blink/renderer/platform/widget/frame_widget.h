...
public:
    ...
    // or navigate.
    virtual void SetOverscrollBehavior(const cc::OverscrollBehavior& overscroll_behavior) = 0;
    ...
    virtual void RequestDecode(const cc::PaintImage&, base::OnceCallback<void(bool)>) = 0;
    ...
    virtual void NotifyPresentationTimeInBlink(base::OnceCallback<void(const viz::FrameTimingDetails&)> presentation_callback) = 0;
    ...
    virtual void SetEventListenerProperties(cc::EventListenerClass, cc::EventListenerProperties) = 0;
    virtual cc::EventListenerProperties EventListenerProperties(cc::EventListenerClass) const = 0;
    ...
    virtual void SetDelegatedInkMetadata(std::unique_ptr<gfx::DelegatedInkMetadata> metadata) = 0;
    ...
    virtual void GetCompositionCharacterBoundsInWindow(Vector<gfx::Rect>* bounds_in_dips) = 0;
    ...
    // of given spans.
    virtual Vector<ui::mojom::blink::ImeTextSpanInfoPtr> GetImeTextSpansInfo(const WebVector<ui::ImeTextSpan>& ime_text_spans) = 0;
    virtual WebTextInputInfo TextInputInfo() = 0;
    virtual ui::mojom::blink::VirtualKeyboardVisibilityRequest GetLastVirtualKeyboardVisibilityRequest() = 0;
    virtual bool ShouldSuppressKeyboardForFocusedElement() = 0;

    // Return the edit context bounds in window coordinates.
    virtual void GetEditContextBoundsInWindow(std::optional<gfx::Rect>* control_bounds, std::optional<gfx::Rect>* selection_bounds) = 0;
    ...
    virtual bool GetSelectionBoundsInWindow(gfx::Rect* focus, gfx::Rect* anchor, gfx::Rect* bounding_box, base::i18n::TextDirection* focus_dir,
    ...
    // moves the cursor.
    virtual void CommitText(const String& text, const Vector<ui::ImeTextSpan>& ime_text_spans, const gfx::Range& replacement_range, int relative_cursor_pos)
        = 0;
    ...
    virtual cc::ElementId GetScrollableContainerIdAt(const gfx::PointF& point) = 0;

    virtual bool ShouldHandleImeEvents()
    {
        return false;
    }

    virtual void SetEditCommandsForNextKeyEvent(Vector<mojom::blink::EditCommandPtr> edit_commands) = 0;
    ...
    virtual void SetMayThrottleIfUndrawnFrames(bool may_throttle_if_undrawn_frames) = 0;
    ...
    virtual void OnTaskCompletedForFrame(base::TimeTicks start_time, base::TimeTicks end_time, LocalFrame*) = 0;
};
