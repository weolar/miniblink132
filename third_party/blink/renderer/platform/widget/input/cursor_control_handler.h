...
public:
    ...
    std::optional<InputHandlerProxy::EventDisposition> ObserveInputEvent(const WebInputEvent& event);

private:
    std::optional<InputHandlerProxy::EventDisposition> HandleGestureScrollBegin(const WebGestureEvent& event);
    std::optional<InputHandlerProxy::EventDisposition> HandleGestureScrollUpdate(const WebGestureEvent& event);
    std::optional<InputHandlerProxy::EventDisposition> HandleGestureScrollEnd(const WebGestureEvent& event);
