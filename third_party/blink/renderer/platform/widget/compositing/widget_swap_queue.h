...
public:
    using VisualStateRequestCallback = mojom::blink::WidgetCompositor::VisualStateRequestCallback;
    ...
    void Queue(int source_frame_number, VisualStateRequestCallback callback, bool* is_first);
...
private:
    base::Lock lock_;
    std::map<int, Vector<VisualStateRequestCallback>> queue_ ALLOW_DISCOURAGED_TYPE("TODO(crbug.com/1404327)");
