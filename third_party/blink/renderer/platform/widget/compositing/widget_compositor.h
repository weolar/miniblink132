...
class PLATFORM_EXPORT WidgetCompositor : public ThreadSafeRefCounted<WidgetCompositor>, public mojom::blink::WidgetCompositor {
public:
    static scoped_refptr<WidgetCompositor> Create(base::WeakPtr<WidgetBase> widget_base, scoped_refptr<base::SingleThreadTaskRunner> main_task_runner,
    ...
    WidgetCompositor(base::PassKey<WidgetCompositorPassKeyProvider>, base::WeakPtr<WidgetBase> widget_base,
...
protected:
    ...
    void BindOnThread(mojo::PendingReceiver<mojom::blink::WidgetCompositor> receiver);

private:
    void ResetOnThread();
    void CreateQueueSwapPromise(base::OnceCallback<void(int)> drain_callback, base::OnceClosure swap_callback, VisualStateRequestCallback callback);
