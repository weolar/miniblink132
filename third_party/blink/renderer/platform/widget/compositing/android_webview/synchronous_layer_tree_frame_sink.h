...
public:
    ...
    virtual void SubmitCompositorFrame(uint32_t layer_tree_frame_sink_id, const viz::LocalSurfaceId& local_surface_id,
...
public:
    SynchronousLayerTreeFrameSink(scoped_refptr<viz::RasterContextProvider> context_provider,
        ...
        gpu::GpuMemoryBufferManager* gpu_memory_buffer_manager, uint32_t layer_tree_frame_sink_id, std::unique_ptr<viz::BeginFrameSource> begin_frame_source,
        SynchronousCompositorRegistry* registry, mojo::PendingRemote<viz::mojom::blink::CompositorFrameSink> compositor_frame_sink_remote,
    ...
    SynchronousLayerTreeFrameSink& operator=(const SynchronousLayerTreeFrameSink&) = delete;
    ...
    void DidNotProduceFrame(const viz::BeginFrameAck& ack, cc::FrameSkippedReason reason) override;
    ...
    void DidReceiveCompositorFrameAck(Vector<viz::ReturnedResource> resources) override;
    void OnBeginFrame(const viz::BeginFrameArgs& args, const HashMap<uint32_t, viz::FrameTimingDetails>& timing_details, bool frame_ack,
    ...
    void DidPresentCompositorFrame(const viz::FrameTimingDetailsMap& timing_details);
    void BeginFrame(const viz::BeginFrameArgs& args);
    void SetBeginFrameSourcePaused(bool paused);
    void SetMemoryPolicy(size_t bytes_limit);
    void ReclaimResources(uint32_t layer_tree_frame_sink_id, Vector<viz::ReturnedResource> resources);
    void OnCompositorFrameTransitionDirectiveProcessed(uint32_t layer_tree_frame_sink_id, uint32_t sequence_id);
    void DemandDrawHw(const gfx::Size& viewport_size, const gfx::Rect& viewport_rect_for_tile_priority, const gfx::Transform& transform_for_tile_priority,
...
private:
    ...
    void InvokeComposite(const gfx::Transform& transform, const gfx::Rect& viewport);
    ...
    mojo::PendingRemote<viz::mojom::blink::CompositorFrameSink> unbound_compositor_frame_sink_;
    mojo::PendingReceiver<viz::mojom::blink::CompositorFrameSinkClient> unbound_client_;
    mojo::Remote<viz::mojom::blink::CompositorFrameSink> compositor_frame_sink_;
    mojo::Receiver<viz::mojom::blink::CompositorFrameSinkClient> client_receiver_ { this };
    ...
    class StubDisplayClient : public viz::DisplayClient {
        ...
        base::TimeDelta GetPreferredFrameIntervalForFrameSinkId(const viz::FrameSinkId& id, viz::mojom::CompositorFrameSinkType* type) override;
    };
    ...
    std::unique_ptr<viz::mojom::CompositorFrameSinkClient> software_frame_sink_client_;
