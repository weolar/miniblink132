...
public:
    ...
    QueueReportTimeSwapPromise& operator=(const QueueReportTimeSwapPromise&) = delete;

    void WillSwap(viz::CompositorFrameMetadata* metadata) override;
    void DidSwap() override;
    cc::SwapPromise::DidNotSwapAction DidNotSwap(DidNotSwapReason reason, base::TimeTicks now) override;
