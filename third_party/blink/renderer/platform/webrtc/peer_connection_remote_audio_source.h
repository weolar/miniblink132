...
class PLATFORM_EXPORT PeerConnectionRemoteAudioTrack final : public MediaStreamAudioTrack {
public:
    explicit PeerConnectionRemoteAudioTrack(scoped_refptr<webrtc::AudioTrackInterface> track_interface);
    PeerConnectionRemoteAudioTrack(const PeerConnectionRemoteAudioTrack&) = delete;
    PeerConnectionRemoteAudioTrack& operator=(const PeerConnectionRemoteAudioTrack&) = delete;
...
class PLATFORM_EXPORT PeerConnectionRemoteAudioSource final : public MediaStreamAudioSource, protected webrtc::AudioTrackSinkInterface {
public:
    PeerConnectionRemoteAudioSource(scoped_refptr<webrtc::AudioTrackInterface> track_interface, scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    PeerConnectionRemoteAudioSource(const PeerConnectionRemoteAudioSource&) = delete;
    PeerConnectionRemoteAudioSource& operator=(const PeerConnectionRemoteAudioSource&) = delete;
    ~PeerConnectionRemoteAudioSource() final;

protected:
    // MediaStreamAudioSource implementation.
    std::unique_ptr<MediaStreamAudioTrack> CreateMediaStreamAudioTrack(const std::string& id) final;
