...
media::VideoCodecProfile WebRtcVideoFormatToMediaVideoCodecProfile(const webrtc::SdpVideoFormat& format)
{
    ...
    case webrtc::kVideoCodecVP9: {
        const std::optional<webrtc::VP9Profile> vp9_profile = webrtc::ParseSdpForVP9Profile(format.parameters);
    ...
    case webrtc::kVideoCodecH264: {
        const std::optional<webrtc::H264ProfileLevelId> h264_profile_level_id = webrtc::ParseSdpForH264ProfileLevelId(format.parameters);
...
#if BUILDFLAG(RTC_USE_H265)
    case webrtc::kVideoCodecH265: {
        const std::optional<webrtc::H265ProfileTierLevel> h265_ptl = webrtc::ParseSdpForH265ProfileTierLevel(format.parameters);
        if (!h265_ptl) {
            return media::VIDEO_CODEC_PROFILE_UNKNOWN;
        }
...
{
    webrtc::ColorSpace::PrimaryID primaries = webrtc::ColorSpace::PrimaryID::kUnspecified;
    ...
    webrtc::ColorSpace::TransferID transfer = webrtc::ColorSpace::TransferID::kUnspecified;
    ...
    webrtc::ColorSpace::MatrixID matrix = webrtc::ColorSpace::MatrixID::kUnspecified;
