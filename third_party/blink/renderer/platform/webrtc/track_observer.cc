...
class TrackObserver::TrackObserverImpl : public WTF::ThreadSafeRefCounted<TrackObserver::TrackObserverImpl>, public webrtc::ObserverInterface {
public:
    TrackObserverImpl(const scoped_refptr<base::SingleThreadTaskRunner>& main_thread, const scoped_refptr<webrtc::MediaStreamTrackInterface>& track)
...
private:
    ...
    void OnChanged() override
    {
        ...
        PostCrossThreadTask(*main_thread_.get(), FROM_HERE, CrossThreadBindOnce(&TrackObserverImpl::OnChangedOnMainThread, WrapRefCounted(this), state));
    }
...
TrackObserver::TrackObserver(const scoped_refptr<base::SingleThreadTaskRunner>& main_thread, const scoped_refptr<webrtc::MediaStreamTrackInterface>& track)
...
const scoped_refptr<webrtc::MediaStreamTrackInterface>& TrackObserver::track() const
{
