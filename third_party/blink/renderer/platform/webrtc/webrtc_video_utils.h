...
media::VideoRotation PLATFORM_EXPORT WebRtcToMediaVideoRotation(webrtc::VideoRotation rotation);

media::VideoCodec PLATFORM_EXPORT WebRtcToMediaVideoCodec(webrtc::VideoCodecType codec);

// Map webrtc::SdpVideoFormat to the same or closest media::VideoCodecProfile.
media::VideoCodecProfile PLATFORM_EXPORT WebRtcVideoFormatToMediaVideoCodecProfile(const webrtc::SdpVideoFormat& format);

gfx::ColorSpace PLATFORM_EXPORT WebRtcToGfxColorSpace(const webrtc::ColorSpace& color_space);

webrtc::ColorSpace PLATFORM_EXPORT GfxToWebRtcColorSpace(const gfx::ColorSpace& color_space);
