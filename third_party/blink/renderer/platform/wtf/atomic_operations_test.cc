...
template <size_t buffer_size, size_t alignment, typename CopyMethod> void TestCopyImpl(CopyMethod copy)
{
...
template <size_t buffer_size, size_t alignment> void TestAtomicReadMemcpy()
{
    TestCopyImpl<buffer_size, alignment>(AtomicReadMemcpy<buffer_size, alignment>);
}
...
template <size_t buffer_size, size_t alignment> void TestAtomicWriteMemcpy()
{
    TestCopyImpl<buffer_size, alignment>(AtomicWriteMemcpy<buffer_size, alignment>);
}
...
template <size_t buffer_size, size_t alignment> void TestAtomicMemzero()
{
    // Allocating extra memory before and after the buffer to make sure the
