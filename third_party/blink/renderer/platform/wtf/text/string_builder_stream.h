...
template <std::integral T> StringBuilder& operator<<(StringBuilder& builder, T number)
{
    builder.AppendNumber(number);
    return builder;
}

template <std::floating_point T> StringBuilder& operator<<(StringBuilder& builder, T number)
{
    builder.AppendNumber(number);
    return builder;
}

template <typename T> StringBuilder& operator<<(StringBuilder& builder, const Vector<T>& vector)
{
    builder << "[";
    String delimiter = "";
