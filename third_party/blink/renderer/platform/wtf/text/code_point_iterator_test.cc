...
struct TestData {
    ...
    {
        return str8 ? String(str8) : String(str16);
    }
...
class CodePointIteratorParamTest : public testing::Test, public testing::WithParamInterface<TestData> { };
INSTANTIATE_TEST_SUITE_P(CodePointIteratorTest, CodePointIteratorParamTest, testing::ValuesIn(g_test_data));
