...
public:
    ...
    explicit CaseMap(const AtomicString& locale)
        : CaseMap(Locale(locale))
    {
    }

    String ToLower(const String& source, TextOffsetMap* offset_map = nullptr) const;
    String ToUpper(const String& source, TextOffsetMap* offset_map = nullptr) const;
...
private:
    scoped_refptr<StringImpl> ToLower(StringImpl* source, TextOffsetMap* offset_map = nullptr) const;
    scoped_refptr<StringImpl> ToUpper(StringImpl* source, TextOffsetMap* offset_map = nullptr) const;
    ...
    static scoped_refptr<StringImpl> ToLowerInvariant(StringImpl* source, TextOffsetMap* offset_map);
    static scoped_refptr<StringImpl> ToUpperInvariant(StringImpl* source, TextOffsetMap* offset_map);
