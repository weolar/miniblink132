...
template <> struct HashTraits<StringImpl*> : GenericHashTraits<StringImpl*> {
    static unsigned GetHash(const StringImpl* key)
    {
        return key->GetHash();
    }
...
template <> struct HashTraits<scoped_refptr<StringImpl>> : GenericHashTraits<scoped_refptr<StringImpl>> {
...
template <> struct HashTraits<String> : SimpleClassHashTraits<String> {
    ...
    static bool Equal(const char* a, const String& b)
    {
        return a == b;
    }
    ...
    static bool Equal(const String& a, const UChar* b)
    {
        return a == b;
    }
    static bool Equal(const UChar* a, const String& b)
    {
        return a == b;
    }
