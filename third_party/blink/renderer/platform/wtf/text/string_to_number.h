...
// string -> int.
WTF_EXPORT int CharactersToInt(base::span<const LChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT int CharactersToInt(base::span<const UChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT int CharactersToInt(const StringView&, NumberParsingOptions, bool* ok);

// string -> unsigned.
WTF_EXPORT unsigned HexCharactersToUInt(base::span<const LChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT unsigned HexCharactersToUInt(base::span<const UChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT uint64_t HexCharactersToUInt64(base::span<const UChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT uint64_t HexCharactersToUInt64(base::span<const LChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT unsigned CharactersToUInt(base::span<const LChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT unsigned CharactersToUInt(base::span<const UChar>, NumberParsingOptions, bool* ok);

// NumberParsingResult versions of CharactersToUInt. They can detect
// overflow. |NumberParsingResult*| should not be nullptr;
WTF_EXPORT unsigned CharactersToUInt(base::span<const LChar>, NumberParsingOptions, NumberParsingResult*);
WTF_EXPORT unsigned CharactersToUInt(base::span<const UChar>, NumberParsingOptions, NumberParsingResult*);

// string -> int64_t.
WTF_EXPORT int64_t CharactersToInt64(base::span<const LChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT int64_t CharactersToInt64(base::span<const UChar>, NumberParsingOptions, bool* ok);

// string -> uint64_t.
WTF_EXPORT uint64_t CharactersToUInt64(base::span<const LChar>, NumberParsingOptions, bool* ok);
WTF_EXPORT uint64_t CharactersToUInt64(base::span<const UChar>, NumberParsingOptions, bool* ok);
...
// whiespace/garbage.
WTF_EXPORT double CharactersToDouble(base::span<const LChar>, size_t& parsed_length);
WTF_EXPORT double CharactersToDouble(base::span<const UChar>, size_t& parsed_length);
...
// smaller than |length| if the input string contains trailing
// whiespace/garbage.
WTF_EXPORT float CharactersToFloat(base::span<const LChar>, size_t& parsed_length);
WTF_EXPORT float CharactersToFloat(base::span<const UChar>, size_t& parsed_length);
