...
TEST(StringViewTest, ConstructionStringImpl8)
{
    ...
    EXPECT_EQ(impl8_bit->Characters8() + 2, StringView(impl8_bit.get(), 2).Characters8());
    ...
    EXPECT_EQ(impl8_bit->Characters8() + 2, StringView(impl8_bit.get(), 2, 1).Characters8());
...
TEST(StringViewTest, ConstructionStringImpl16)
{
    ...
    EXPECT_EQ(impl16_bit->Characters16(), StringView(impl16_bit.get()).Characters16());
    ...
    EXPECT_EQ(impl16_bit->Characters16() + 2, StringView(impl16_bit.get(), 2).Characters16());
    ...
    EXPECT_EQ(impl16_bit->Characters16() + 2, StringView(impl16_bit.get(), 2, 1).Characters16());
...
TEST(StringViewTest, ConstructionStringImplRef8)
{
    ...
    EXPECT_EQ(impl8_bit->Characters8() + 2, StringView(*impl8_bit, 2).Characters8());
    ...
    EXPECT_EQ(impl8_bit->Characters8() + 2, StringView(*impl8_bit, 2, 1).Characters8());
...
TEST(StringViewTest, ConstructionStringImplRef16)
{
    ...
    EXPECT_EQ(impl16_bit->Characters16() + 2, StringView(*impl16_bit, 2).Characters16());
    ...
    EXPECT_EQ(impl16_bit->Characters16() + 2, StringView(*impl16_bit, 2, 1).Characters16());
...
TEST(StringViewTest, ConstructionString8)
{
    ...
    EXPECT_EQ(string8_bit.Characters8() + 2, StringView(string8_bit, 2).Characters8());
    ...
    EXPECT_EQ(string8_bit.Characters8() + 2, StringView(string8_bit, 2, 1).Characters8());
...
TEST(StringViewTest, ConstructionString16)
{
    ...
    EXPECT_EQ(string16_bit.Characters16() + 2, StringView(string16_bit, 2).Characters16());
    ...
    EXPECT_EQ(string16_bit.Characters16() + 2, StringView(string16_bit, 2, 1).Characters16());
...
TEST(StringViewTest, ConstructionAtomicString8)
{
    ...
    EXPECT_EQ(atom8_bit.Characters8() + 2, StringView(atom8_bit, 2, 1).Characters8());
...
TEST(StringViewTest, ConstructionAtomicString16)
{
    ...
    EXPECT_EQ(atom16_bit.Characters16() + 2, StringView(atom16_bit, 2).Characters16());
    ...
    EXPECT_EQ(atom16_bit.Characters16() + 2, StringView(atom16_bit, 2, 1).Characters16());
...
TEST(StringViewTest, ConstructionStringView8)
{
    ...
    EXPECT_EQ(view8_bit.Characters8() + 2, StringView(view8_bit, 2, 1).Characters8());
...
TEST(StringViewTest, ConstructionStringView16)
{
    ...
    EXPECT_EQ(view16_bit.Characters16() + 2, StringView(view16_bit, 2).Characters16());
    ...
    EXPECT_EQ(view16_bit.Characters16() + 2, StringView(view16_bit, 2, 1).Characters16());
...
TEST(StringViewTest, SubstringContainsOnlyWhitespaceOrEmpty)
{
    ...
    EXPECT_TRUE(StringView("\x20\x09\x0A\x0D").SubstringContainsOnlyWhitespaceOrEmpty(0, 4));
    ...
    EXPECT_FALSE(StringView(" \u090A\n").SubstringContainsOnlyWhitespaceOrEmpty(0, StringView(" \u090A\n").length()));
    EXPECT_FALSE(StringView("\n\x08\x1B").SubstringContainsOnlyWhitespaceOrEmpty(0, 3));
}
...
TEST(StringViewTest, ConstructionLiteral16)
{
    ...
    EXPECT_EQ(StringView(reinterpret_cast<const UChar*>(u"12")), StringView(kChars16, 2u));
...
TEST(StringViewTest, EqualIgnoringASCIICase)
{
    ...
    static const UChar kLinkCaps16[5] = { 0x004c, 0x0049, 0x004e, 0x004b, 0 }; // LINK
    ...
    EXPECT_FALSE(EqualIgnoringASCIICase(StringView(non_ascii8), kNonASCIIInvalid16));
