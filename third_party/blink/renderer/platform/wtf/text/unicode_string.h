...
inline int FoldCase(UChar* result, int result_length, const UChar* src, int src_length, bool* error)
{
    UErrorCode status = U_ZERO_ERROR;
    int real_length = u_strFoldCase(result, result_length, src, src_length, U_FOLD_CASE_DEFAULT, &status);
