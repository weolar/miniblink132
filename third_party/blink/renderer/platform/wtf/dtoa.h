...
WTF_EXPORT const char* NumberToFixedPrecisionString(double, unsigned significant_figures, NumberToStringBuffer);
WTF_EXPORT const char* NumberToFixedWidthString(double, unsigned decimal_places, NumberToStringBuffer);

WTF_EXPORT double ParseDouble(const LChar* string, size_t length, size_t& parsed_length);
WTF_EXPORT double ParseDouble(const UChar* string, size_t length, size_t& parsed_length);
