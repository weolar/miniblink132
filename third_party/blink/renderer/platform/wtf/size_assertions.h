...
template <size_t ActualSize, size_t ExpectedSize> struct SizesEqual {
...
#define ASSERT_SIZE(type, same_size_type) static_assert(::WTF::internal::SizesEqual<sizeof(type), sizeof(same_size_type)>::value, #type " should stay small")
