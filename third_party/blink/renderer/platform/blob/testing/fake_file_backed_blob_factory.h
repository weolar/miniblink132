...
public:
    ...
    void RegisterBlob(
        mojo::PendingReceiver<mojom::blink::Blob> blob, const String& uuid, const String& content_type, mojom::blink::DataElementFilePtr file) override;

    void RegisterBlobSync(mojo::PendingReceiver<mojom::blink::Blob> blob, const String& uuid, const String& content_type, mojom::blink::DataElementFilePtr file,
