...
void BudgetPool::AddThrottler(base::TimeTicks now, TaskQueueThrottler* throttler)
{
...
void BudgetPool::RemoveThrottler(base::TimeTicks now, TaskQueueThrottler* throttler)
{
    throttler->RemoveBudgetPool(this);
    associated_throttlers_.erase(throttler);
