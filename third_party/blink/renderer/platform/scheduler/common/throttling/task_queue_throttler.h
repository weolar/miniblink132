...
class PLATFORM_EXPORT TaskQueueThrottler final : public base::sequence_manager::TaskQueue::Throttler {
public:
    TaskQueueThrottler(base::sequence_manager::TaskQueue* task_queue, const base::TickClock* tick_clock);
    ...
    void OnTaskRunTimeReported(base::TimeTicks start_time, base::TimeTicks end_time);
...
private:
    ...
    std::optional<base::sequence_manager::WakeUp> GetNextAllowedWakeUpImpl(
        base::LazyNow* lazy_now, std::optional<base::sequence_manager::WakeUp> next_wake_up, bool has_ready_task);

    // TaskQueue::Throttler implementation:
    std::optional<base::sequence_manager::WakeUp> GetNextAllowedWakeUp(
        base::LazyNow* lazy_now, std::optional<base::sequence_manager::WakeUp> next_wake_up, bool has_ready_task) override;
