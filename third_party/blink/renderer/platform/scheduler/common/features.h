...
BASE_FEATURE(kDedicatedWorkerThrottling, "BlinkSchedulerWorkerThrottling", base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kBestEffortPriorityForFindInPage, "BlinkSchedulerBestEffortPriorityForFindInPage", base::FEATURE_DISABLED_BY_DEFAULT);

// Enable setting high priority database task type from field trial parameters.
BASE_FEATURE(kHighPriorityDatabaseTaskType, "HighPriorityDatabaseTaskType", base::FEATURE_DISABLED_BY_DEFAULT);
...
PLATFORM_EXPORT void ClearIntensiveWakeUpThrottlingPolicyOverrideCacheForTesting();
...
// is enabled.
PLATFORM_EXPORT base::TimeDelta GetIntensiveWakeUpThrottlingGracePeriod(bool loading);
...
BASE_FEATURE(kMbiOverrideTaskRunnerHandle, "MbiOverrideTaskRunnerHandle", base::FEATURE_DISABLED_BY_DEFAULT);
...
// received.
PLATFORM_EXPORT base::TimeDelta GetLoadingPhaseBufferTimeAfterFirstMeaningfulPaint();
