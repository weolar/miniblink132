...
// }
// 
// ProtoPriority TaskPriorityToProto(base::sequence_manager::TaskQueue::QueuePriority priority)
// {
//     DCHECK_LT(static_cast<size_t>(priority), static_cast<size_t>(TaskPriority::kPriorityCount));
//     return ToProtoPriority(static_cast<TaskPriority>(priority));
// }

} // namespace

base::sequence_manager::SequenceManager::PrioritySettings CreatePrioritySettings()
{
    using base::sequence_manager::TaskQueue;
    base::sequence_manager::SequenceManager::PrioritySettings settings(TaskPriority::kPriorityCount, TaskPriority::kDefaultPriority);
