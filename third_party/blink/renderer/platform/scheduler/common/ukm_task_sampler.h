...
public:
    ...
    explicit UkmTaskSampler(double thread_time_sampling_rate, double ukm_task_sampling_rate = kDefaultUkmTaskSamplingRate);
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(UkmTaskSamplerTest, GetConditionalSamplingProbability);
    FRIEND_TEST_ALL_PREFIXES(UkmTaskSamplerTest, GetConditionalSamplingProbabilityWithEdgeCases);
