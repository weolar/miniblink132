...
PLATFORM_EXPORT void PostTask(const base::Location&, const base::TaskTraits&, CrossThreadOnceClosure);

PLATFORM_EXPORT scoped_refptr<base::SequencedTaskRunner> CreateSequencedTaskRunner(const base::TaskTraits& traits);
