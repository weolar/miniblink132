...
struct PLATFORM_EXPORT SchedulingPolicy {
    ...
    constexpr SchedulingPolicy(ArgTypes... args)
        : disable_aggressive_throttling(base::trait_helpers::HasTrait<DisableAggressiveThrottling, ArgTypes...>())
        , disable_back_forward_cache(base::trait_helpers::HasTrait<DisableBackForwardCache, ArgTypes...>())
        , disable_align_wake_ups(base::trait_helpers::HasTrait<DisableAlignWakeUps, ArgTypes...>())
    {
    }
