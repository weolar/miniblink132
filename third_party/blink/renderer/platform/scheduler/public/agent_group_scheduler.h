...
class BLINK_PLATFORM_EXPORT AgentGroupScheduler : public GarbageCollected<AgentGroupScheduler>, public IPC::UrgentMessageObserver {
public:
    ...
    virtual std::unique_ptr<PageScheduler> CreatePageScheduler(PageScheduler::Delegate*) = 0;
