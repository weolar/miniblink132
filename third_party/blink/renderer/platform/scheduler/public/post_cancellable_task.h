...
private:
    ...
    friend PLATFORM_EXPORT TaskHandle PostCancellableTask(base::SequencedTaskRunner&, const base::Location&, base::OnceClosure);
    friend PLATFORM_EXPORT TaskHandle PostDelayedCancellableTask(base::SequencedTaskRunner&, const base::Location&, base::OnceClosure, base::TimeDelta delay);
    friend PLATFORM_EXPORT TaskHandle PostNonNestableCancellableTask(base::SequencedTaskRunner&, const base::Location&, base::OnceClosure);
    friend PLATFORM_EXPORT TaskHandle PostNonNestableDelayedCancellableTask(
        base::SequencedTaskRunner&, const base::Location&, base::OnceClosure, base::TimeDelta delay);
...
// cancellation.
[[nodiscard]] PLATFORM_EXPORT TaskHandle PostCancellableTask(base::SequencedTaskRunner&, const base::Location&, base::OnceClosure);
[[nodiscard]] PLATFORM_EXPORT TaskHandle PostDelayedCancellableTask(
    base::SequencedTaskRunner&, const base::Location&, base::OnceClosure, base::TimeDelta delay);
[[nodiscard]] PLATFORM_EXPORT TaskHandle PostNonNestableCancellableTask(base::SequencedTaskRunner&, const base::Location&, base::OnceClosure);
[[nodiscard]] PLATFORM_EXPORT TaskHandle PostNonNestableDelayedCancellableTask(
    base::SequencedTaskRunner&, const base::Location&, base::OnceClosure, base::TimeDelta delay);
