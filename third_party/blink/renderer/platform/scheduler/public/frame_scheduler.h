...
public:
    ...
    public:
        ...
        virtual void OnTaskCompleted(base::TimeTicks start_time, base::TimeTicks end_time) = 0;
    ...
    virtual void SetAgentClusterId(const base::UnguessableToken& agent_cluster_id) = 0;
    ...
    virtual void DidCommitProvisionalLoad(
        bool is_web_history_inert_commit, NavigationType navigation_type, DidCommitProvisionalLoadParams params = { base::TimeDelta() })
        = 0;
    ...
    FrameScheduler* ToFrameScheduler() override
    {
        return this;
    }
    ...
    // exists.
    virtual std::unique_ptr<blink::mojom::blink::PauseSubresourceLoadingHandle> GetPauseSubresourceLoadingHandle() = 0;

    // Returns the list of active features which currently tracked by the
    // scheduler for back-forward cache metrics.
    virtual WTF::HashSet<SchedulingPolicy::Feature> GetActiveFeaturesTrackedForBackForwardCacheMetrics() = 0;
