...
public:
    ...
    [[nodiscard]] virtual std::unique_ptr<RendererPauseHandle> PauseScheduler() = 0;
    ...
    virtual void ForEachMainThreadIsolate(base::RepeatingCallback<void(v8::Isolate* isolate)> callback) = 0;
    ...
    virtual Vector<WebInputEventAttribution> GetPendingUserInputInfo(bool include_continuous) const
    {
        return {};
    }
    ...
    virtual void ExecuteAfterCurrentTaskForTesting(base::OnceClosure on_completion_task, ExecuteAfterCurrentTaskRestricted) = 0;
