...
PLATFORM_EXPORT std::unique_ptr<FrameScheduler> CreateDummyFrameScheduler(v8::Isolate* isolate);
PLATFORM_EXPORT std::unique_ptr<PageScheduler> CreateDummyPageScheduler(v8::Isolate* isolate = nullptr);
PLATFORM_EXPORT AgentGroupScheduler* CreateDummyAgentGroupScheduler(v8::Isolate* isolate = nullptr);
PLATFORM_EXPORT std::unique_ptr<WebThreadScheduler> CreateDummyWebMainThreadScheduler();
