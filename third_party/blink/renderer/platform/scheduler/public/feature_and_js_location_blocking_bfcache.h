...
public:
    ...
    FeatureAndJSLocationBlockingBFCache(SchedulingPolicy::Feature feature, const SourceLocation* source_location);
    FeatureAndJSLocationBlockingBFCache(const FeatureAndJSLocationBlockingBFCache&) = default;
    FeatureAndJSLocationBlockingBFCache& operator=(const FeatureAndJSLocationBlockingBFCache&) = default;
    ~FeatureAndJSLocationBlockingBFCache();
    bool operator==(const FeatureAndJSLocationBlockingBFCache& other) const;
    SchedulingPolicy::Feature Feature() const
    {
        return feature_;
    }
