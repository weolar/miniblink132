...
class PLATFORM_EXPORT NonMainThreadWebSchedulingTaskQueueImpl : public WebSchedulingTaskQueue {
public:
    explicit NonMainThreadWebSchedulingTaskQueueImpl(scoped_refptr<NonMainThreadTaskQueue>);
