...
class PLATFORM_EXPORT CompositorThreadSchedulerImpl : public CompositorThreadScheduler,
                                                      public NonMainThreadSchedulerBase,
                                                      public SingleThreadIdleTaskRunner::Delegate {
public:
    explicit CompositorThreadSchedulerImpl(base::sequence_manager::SequenceManager* sequence_manager);
    CompositorThreadSchedulerImpl(const CompositorThreadSchedulerImpl&) = delete;
    CompositorThreadSchedulerImpl& operator=(const CompositorThreadSchedulerImpl&) = delete;
