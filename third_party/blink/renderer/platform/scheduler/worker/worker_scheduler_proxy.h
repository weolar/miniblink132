...
public:
    ...
    void OnWorkerSchedulerCreated(base::WeakPtr<WorkerScheduler> worker_scheduler);
...
private:
    ...
    std::unique_ptr<FrameOrWorkerScheduler::LifecycleObserverHandle> throttling_observer_handle_;
