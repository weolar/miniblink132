...
scoped_refptr<base::SingleThreadTaskRunner> MainThreadImpl::GetTaskRunner(MainThreadTaskRunnerRestricted) const
{
    return task_runner_;
}

void MainThreadImpl::AddTaskTimeObserver(base::sequence_manager::TaskTimeObserver* task_time_observer)
{
    scheduler_->AddTaskTimeObserver(task_time_observer);
}

void MainThreadImpl::RemoveTaskTimeObserver(base::sequence_manager::TaskTimeObserver* task_time_observer)
{
