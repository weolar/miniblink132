...
private:
    ...
    std::unique_ptr<base::sequence_manager::TaskQueue::QueueEnabledVoter> input_task_queue_enabled_voter_;

    const raw_ptr<MainThreadSchedulerImpl, DanglingUntriaged> main_thread_scheduler_;
