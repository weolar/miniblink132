...
class PLATFORM_EXPORT MainThreadWebSchedulingTaskQueueImpl : public WebSchedulingTaskQueue {
public:
    MainThreadWebSchedulingTaskQueueImpl(base::WeakPtr<MainThreadTaskQueue> immediate_task_queue, base::WeakPtr<MainThreadTaskQueue> delayed_task_queue);
...
private:
    ...
    public:
        ...
        bool PostDelayedTask(const base::Location& location, base::OnceClosure task, base::TimeDelta delay) override;
