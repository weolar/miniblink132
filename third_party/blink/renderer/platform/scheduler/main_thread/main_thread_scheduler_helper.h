...
public:
    ...
    MainThreadSchedulerHelper(base::sequence_manager::SequenceManager* sequence_manager, MainThreadSchedulerImpl* main_thread_scheduler);
    MainThreadSchedulerHelper(const MainThreadSchedulerHelper&) = delete;
    MainThreadSchedulerHelper& operator=(const MainThreadSchedulerHelper&) = delete;
