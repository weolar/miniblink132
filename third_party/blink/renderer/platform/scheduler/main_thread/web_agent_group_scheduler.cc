...
WebAgentGroupScheduler::WebAgentGroupScheduler(AgentGroupScheduler* agent_group_scheduler)
...
scoped_refptr<base::SingleThreadTaskRunner> WebAgentGroupScheduler::DefaultTaskRunner()
{
    return private_->DefaultTaskRunner();
}

scoped_refptr<base::SingleThreadTaskRunner> WebAgentGroupScheduler::CompositorTaskRunner()
{
