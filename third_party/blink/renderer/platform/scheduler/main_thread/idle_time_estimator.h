...
public:
    IdleTimeEstimator(const base::TickClock* time_source, int sample_count, double estimation_percentile);
    ...
    base::TimeDelta GetExpectedIdleDuration(base::TimeDelta compositor_frame_interval) const;
    ...
    void AddCompositorTaskQueue(scoped_refptr<MainThreadTaskQueue> compositor_task_queue);
