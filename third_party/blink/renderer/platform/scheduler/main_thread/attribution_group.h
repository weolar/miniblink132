...
struct AttributionGroup {
    ...
    {
        return attribution == other.attribution && is_deleted_value == other.is_deleted_value;
    }
...
template <> struct HashTraits<blink::scheduler::AttributionGroup> : SimpleClassHashTraits<blink::scheduler::AttributionGroup> {
