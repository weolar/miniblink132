...
{
    EXPECT_EQ(base::TimeDelta(), user_model_->TimeLeftInContinuousUserGesture(clock_->NowTicks()));
}

TEST_F(UserModelTest, TimeLeftInContinuousUserGesture_ImmediatelyAfterInput)
{
    user_model_->DidStartProcessingInputEvent(blink::WebInputEvent::Type::kTouchStart, clock_->NowTicks());
    user_model_->DidFinishProcessingInputEvent(clock_->NowTicks());
    EXPECT_EQ(UserModel::kGestureEstimationLimit, user_model_->TimeLeftInContinuousUserGesture(clock_->NowTicks()));
}
...
TEST_F(UserModelTest, TimeLeftInContinuousUserGesture_ShortlyAfterInput)
{
    ...
    EXPECT_EQ(UserModel::kGestureEstimationLimit - delta, user_model_->TimeLeftInContinuousUserGesture(clock_->NowTicks()));
}
...
TEST_F(UserModelTest, GestureExpectedSoon_NoRecentInput)
{
    ...
    EXPECT_FALSE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
...
{
    user_model_->DidStartProcessingInputEvent(blink::WebInputEvent::Type::kGestureScrollBegin, clock_->NowTicks());
    user_model_->DidFinishProcessingInputEvent(clock_->NowTicks());
    ...
    base::TimeDelta prediction_valid_duration;
    EXPECT_FALSE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(UserModel::kMedianGestureDuration - delta, prediction_valid_duration);
}
...
TEST_F(UserModelTest, GestureExpectedSoon_LongAfter_GestureScrollBegin)
{
    ...
    base::TimeDelta prediction_valid_duration;
    EXPECT_TRUE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(UserModel::kExpectSubsequentGestureDeadline, prediction_valid_duration);
}

TEST_F(UserModelTest, GestureExpectedSoon_ImmediatelyAfter_GestureScrollEnd)
{
    user_model_->DidStartProcessingInputEvent(blink::WebInputEvent::Type::kGestureScrollEnd, clock_->NowTicks());
    user_model_->DidFinishProcessingInputEvent(clock_->NowTicks());
...
TEST_F(UserModelTest, GestureExpectedSoon_ShortlyAfter_GestureScrollEnd)
{
    ...
    base::TimeDelta prediction_valid_duration;
    EXPECT_TRUE(user_model_->IsGestureExpectedSoon(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(UserModel::kExpectSubsequentGestureDeadline - delta, prediction_valid_duration);
}
...
{
    user_model_->DidStartProcessingInputEvent(blink::WebInputEvent::Type::kGesturePinchEnd, clock_->NowTicks());
    user_model_->DidFinishProcessingInputEvent(clock_->NowTicks());
...
{
    user_model_->DidStartProcessingInputEvent(blink::WebInputEvent::Type::kGestureTap, clock_->NowTicks());
    user_model_->DidFinishProcessingInputEvent(clock_->NowTicks());
...
{
    base::TimeDelta prediction_valid_duration;
    EXPECT_FALSE(user_model_->IsGestureExpectedToContinue(clock_->NowTicks(), &prediction_valid_duration));
    EXPECT_EQ(base::TimeDelta(), prediction_valid_duration);
}
...
TEST_F(UserModelTest, IsGestureExpectedToContinue_GestureJustStarted)
{
    user_model_->DidStartProcessingInputEvent(blink::WebInputEvent::Type::kGestureScrollBegin, clock_->NowTicks());
    base::TimeDelta prediction_valid_duration;
    EXPECT_TRUE(user_model_->IsGestureExpectedToContinue(clock_->NowTicks(), &prediction_valid_duration));
...
TEST_F(UserModelTest, DiscreteInput)
{
    ...
    EXPECT_EQ(user_model_->TimeLeftUntilDiscreteInputResponseDeadline(clock_->NowTicks()), UserModel::kDiscreteInputResponseDeadline);
    user_model_->DidProcessDiscreteInputResponse();
    EXPECT_EQ(user_model_->TimeLeftUntilDiscreteInputResponseDeadline(clock_->NowTicks()), base::TimeDelta());
    ...
    EXPECT_EQ(user_model_->TimeLeftUntilDiscreteInputResponseDeadline(clock_->NowTicks()), UserModel::kDiscreteInputResponseDeadline - delta);
...
{
    EXPECT_EQ(user_model_->TimeLeftInContinuousUserGesture(clock_->NowTicks()), base::TimeDelta());
    EXPECT_EQ(user_model_->TimeLeftUntilDiscreteInputResponseDeadline(clock_->NowTicks()), base::TimeDelta());

    user_model_->DidStartProcessingInputEvent(blink::WebInputEvent::Type::kGestureScrollBegin, clock_->NowTicks());
    EXPECT_EQ(user_model_->TimeLeftInContinuousUserGesture(clock_->NowTicks()), UserModel::kGestureEstimationLimit);
    EXPECT_EQ(user_model_->TimeLeftUntilDiscreteInputResponseDeadline(clock_->NowTicks()), base::TimeDelta());
