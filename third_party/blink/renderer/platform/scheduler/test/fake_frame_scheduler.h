...
public:
    ...
    FakeFrameScheduler(PageScheduler* page_scheduler, bool is_page_visible, bool is_frame_visible, FrameScheduler::FrameType frame_type,
        bool is_cross_origin_to_nearest_main_frame, bool is_exempt_from_throttling, FrameScheduler::Delegate* delegate)
    ...
    {
        DCHECK(frame_type_ != FrameType::kMainFrame || !is_cross_origin_to_nearest_main_frame);
    }
    ...
    public:
        ...
        {
            return std::make_unique<FakeFrameScheduler>(page_scheduler_, is_page_visible_, is_frame_visible_, frame_type_,
                is_cross_origin_to_nearest_main_frame_, is_exempt_from_throttling_, delegate_);
        }
        ...
        Builder& SetIsCrossOriginToNearestMainFrame(bool is_cross_origin_to_nearest_main_frame)
        {
            is_cross_origin_to_nearest_main_frame_ = is_cross_origin_to_nearest_main_frame;
            return *this;
        }
    ...
    private:
        ...
        FrameScheduler::FrameType frame_type_ = FrameScheduler::FrameType::kMainFrame;
    ...
    {
        return is_frame_visible_;
    }
    bool IsPageVisible() const override
    {
        return is_page_visible_;
    }
    ...
    void DidCommitProvisionalLoad(
        bool is_web_history_inert_commit, FrameScheduler::NavigationType navigation_type, DidCommitProvisionalLoadParams params) override
    {
    }
