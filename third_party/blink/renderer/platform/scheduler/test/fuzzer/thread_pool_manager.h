...
public:
    ...
    void CreateThread(const google::protobuf::RepeatedPtrField<SequenceManagerTestDescription::Action>& initial_thread_actions, base::TimeTicks initial_time);
    ...
    void AdvanceClockSynchronouslyToTime(ThreadManager* thread_manager, base::TimeTicks time);
    ...
    void AdvanceClockSynchronouslyByPendingTaskDelay(ThreadManager* thread_manager);
...
private:
    void StartThread(const google::protobuf::RepeatedPtrField<SequenceManagerTestDescription::Action>& initial_thread_actions, ThreadManager* thread_manager);
