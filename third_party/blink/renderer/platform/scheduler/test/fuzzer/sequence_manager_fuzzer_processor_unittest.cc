...
class SequenceManagerFuzzerProcessorForTest : public SequenceManagerFuzzerProcessor {
public:
    ...
    static void ParseAndRun(std::string test_description, Vector<Vector<TaskForTest>>* executed_tasks, Vector<Vector<ActionForTest>>* executed_actions)
    {
        SequenceManagerTestDescription proto_description;
        google::protobuf::TextFormat::ParseFromString(test_description, &proto_description);
    ...
    static void ParseAndRunSingleThread(std::string test_description, Vector<TaskForTest>* executed_tasks, Vector<ActionForTest>* executed_actions)
    {
        SequenceManagerTestDescription proto_description;

        google::protobuf::TextFormat::ParseFromString(base::StrCat({ "main_thread_actions { create_thread {", test_description, "}}" }), &proto_description);
...
TEST(SequenceManagerFuzzerProcessorTest, CreateTaskQueue)
{
    ...
    expected_actions.emplace_back(1, ActionForTest::ActionType::kCreateTaskQueue, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kCreateTaskQueue, 0);
...
TEST(SequenceManagerFuzzerProcessorTest, CreateQueueVoter)
{
    ...
    Vector<ActionForTest> expected_actions;
    expected_actions.emplace_back(1, ActionForTest::ActionType::kCreateQueueVoter, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kCreateQueueVoter, 0);
    EXPECT_THAT(executed_actions, ContainerEq(expected_actions));
}
...
TEST(SequenceManagerFuzzerProcessorTest, PostDelayedTaskWDuration)
{
    ...
    Vector<ActionForTest> expected_actions;
    expected_actions.emplace_back(1, ActionForTest::ActionType::kPostDelayedTask, 0);
    EXPECT_THAT(executed_actions, ContainerEq(expected_actions));
}
...
TEST(SequenceManagerFuzzerProcessorTest, SetQueuePriority)
{
    ...
    Vector<ActionForTest> expected_actions;
    expected_actions.emplace_back(1, ActionForTest::ActionType::kSetQueuePriority, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kSetQueuePriority, 0);
...
TEST(SequenceManagerFuzzerProcessorTest, SetQueueEnabled)
{
    ...
    expected_actions.emplace_back(1, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kSetQueueEnabled, 0);
    expected_actions.emplace_back(4, ActionForTest::ActionType::kPostDelayedTask, 0);
...
TEST(SequenceManagerFuzzerProcessorTest, MultipleVoters)
{
    ...
    Vector<ActionForTest> expected_actions;
    expected_actions.emplace_back(1, ActionForTest::ActionType::kCreateQueueVoter, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kCreateQueueVoter, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kSetQueueEnabled, 0);
    expected_actions.emplace_back(4, ActionForTest::ActionType::kSetQueueEnabled, 0);
    expected_actions.emplace_back(5, ActionForTest::ActionType::kPostDelayedTask, 0);
...
TEST(SequenceManagerFuzzerProcessorTest, ShutdownTaskQueue)
{
    ...
    expected_actions.emplace_back(1, ActionForTest::ActionType::kCreateTaskQueue, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(4, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(5, ActionForTest::ActionType::kShutdownTaskQueue, 0);
    expected_actions.emplace_back(6, ActionForTest::ActionType::kPostDelayedTask, 0);
...
TEST(SequenceManagerFuzzerProcessorTest, ShutdownTaskQueueWhenOneQueueAvailable)
{
    Vector<TaskForTest> executed_tasks;
    Vector<ActionForTest> executed_actions;
    SequenceManagerFuzzerProcessorForTest::ParseAndRunSingleThread(
    ...
    Vector<ActionForTest> expected_actions;
    expected_actions.emplace_back(1, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kShutdownTaskQueue, 0);
...
TEST(SequenceManagerFuzzerProcessorTest, ShutdownPostingTaskQueue)
{
    ...
    expected_actions.emplace_back(1, ActionForTest::ActionType::kCreateTaskQueue, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kShutdownTaskQueue, 0);
...
TEST(SequenceManagerFuzzerProcessorTest, TaskDurationBlocksOtherPendingTasksPostedFromOutsideOfTask)
{
    Vector<TaskForTest> executed_tasks;
    Vector<ActionForTest> executed_actions;
...
TEST(SequenceManagerFuzzerProcessorTest, TaskDurationBlocksOtherNonNestableTaskWhenPostedFromWithinTask)
{
    Vector<TaskForTest> executed_tasks;
...
TEST(SequenceManagerFuzzerProcessorTest, PostNonEmptyTask)
{
    ...
    Vector<ActionForTest> expected_actions;
    expected_actions.emplace_back(1, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(2, ActionForTest::ActionType::kCreateTaskQueue, 5);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kPostDelayedTask, 5);
    expected_actions.emplace_back(4, ActionForTest::ActionType::kPostDelayedTask, 5);
    expected_actions.emplace_back(5, ActionForTest::ActionType::kCreateTaskQueue, 5);
    expected_actions.emplace_back(6, ActionForTest::ActionType::kPostDelayedTask, 5);
    EXPECT_THAT(executed_actions, ContainerEq(expected_actions));
}
...
TEST(SequenceManagerFuzzerProcessorTest, OrderOfSimpleUnnestedExecutedActions)
{
    ...
    expected_actions.emplace_back(5, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(6, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions.emplace_back(3, ActionForTest::ActionType::kCreateTaskQueue, 10);
    EXPECT_THAT(executed_actions, ContainerEq(expected_actions));
}
...
TEST(SequenceManagerFuzzerProcessorTest, MultipleThreadsButNotInteracting)
{
    ...
    Vector<std::string> threads { thread_actions, thread_actions, thread_actions, thread_actions, thread_actions };

    Vector<Vector<ActionForTest>> executed_actions;
    Vector<Vector<TaskForTest>> executed_tasks;

    SequenceManagerFuzzerProcessorForTest::ParseAndRun(base::StrCat(threads), &executed_tasks, &executed_actions);
    ...
    for (int i = 1; i <= 5; i++) {
        ...
        expected_actions[0].emplace_back(1, ActionForTest::ActionType::kCreateThread, 0);

        // Actions of the Ith thread.
        expected_actions[i].emplace_back(1, ActionForTest::ActionType::kCreateTaskQueue, 0);
        expected_actions[i].emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);
        expected_actions[i].emplace_back(4, ActionForTest::ActionType::kPostDelayedTask, 0);
        expected_actions[i].emplace_back(5, ActionForTest::ActionType::kPostDelayedTask, 0);
        expected_actions[i].emplace_back(6, ActionForTest::ActionType::kPostDelayedTask, 0);
        expected_actions[i].emplace_back(3, ActionForTest::ActionType::kCreateTaskQueue, 10);
    }
...
TEST(SequenceManagerFuzzerProcessorTest, CreateThreadRecursively)
{
    ...
    for (int i = 0; i <= 2; i++) {
        // Actions of the Ith thread.
        expected_actions[i].emplace_back(i + 1, ActionForTest::ActionType::kCreateThread, 0);
    }
...
TEST(SequenceManagerFuzzerProcessorTest, DISABLED_PostTaskToCreateThread)
{
    ...
    expected_actions[0].emplace_back(1, ActionForTest::ActionType::kCreateThread, 0);
    expected_actions[0].emplace_back(5, ActionForTest::ActionType::kCreateThread, 0);

    expected_actions[1].emplace_back(2, ActionForTest::ActionType::kPostDelayedTask, 0);

    // Posted messages execute after instant actions.
    expected_actions[1].emplace_back(4, ActionForTest::ActionType::kCreateThread, 0);
    expected_actions[1].emplace_back(3, ActionForTest::ActionType::kCreateThread, 0);

    expected_actions[2].emplace_back(6, ActionForTest::ActionType::kPostDelayedTask, 0);
    expected_actions[2].emplace_back(7, ActionForTest::ActionType::kCreateThread, 20);
...
TEST(SequenceManagerFuzzerProcessorTest, CrossThreadPostingOnlyOneThreadAvaible)
{
    Vector<Vector<TaskForTest>> executed_tasks;
...
TEST(SequenceManagerFuzzerProcessorTest, AdvanceThreadClockByTaskDurationSynchronously)
{
    Vector<Vector<TaskForTest>> executed_tasks;
...
TEST(SequenceManagerFuzzerProcessorTest, CrossThreadPostFromChildThreads)
{
    ...
    auto* main_thread = description.add_main_thread_actions()->mutable_create_thread();
    for (int i = 0; i < 100; ++i) {
        auto* child_thread = main_thread->add_initial_thread_actions()->mutable_create_thread();

        child_thread->add_initial_thread_actions()->mutable_cross_thread_post()->set_thread_id(i + 1234);
    }
