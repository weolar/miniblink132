...
std::unique_ptr<WebAgentGroupScheduler> WebFakeThreadScheduler::CreateWebAgentGroupScheduler()
{
    return std::make_unique<WebAgentGroupScheduler>(MakeGarbageCollected<FakeAgentGroupScheduler>(*this));
}
...
void WebFakeThreadScheduler::SetRendererProcessType(WebRendererProcessType type)
{
}
