...
public:
    ...
    public:
        ...
        {
            return std::make_unique<FakePageScheduler>(is_audio_playing_, is_throttling_exempt_);
        }
    ...
    std::unique_ptr<FrameScheduler> CreateFrameScheduler(
        FrameScheduler::Delegate* delegate, bool is_in_embedded_frame_tree, FrameScheduler::FrameType frame_type) override
    {
        return nullptr;
    }
