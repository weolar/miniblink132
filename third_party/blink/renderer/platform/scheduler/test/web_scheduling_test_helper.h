...
public:
    ...
    WebSchedulingTaskQueue* GetWebSchedulingTaskQueue(WebSchedulingQueueType, WebSchedulingPriority);
    ...
    void PostTestTasks(Vector<String>* run_order, const Vector<TestTaskSpecEntry>& test_spec);
