...
public:
    ...
    explicit PushPullFIFO(unsigned number_of_channels, uint32_t fifo_length, unsigned render_quantum_frames = 128);
    ...
    PullResult PullAndUpdateEarmark(AudioBus* output_bus, uint32_t frames_requested);
