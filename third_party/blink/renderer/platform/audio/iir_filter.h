...
public:
    ...
    IIRFilter(const AudioDoubleArray* feedforward_coef, const AudioDoubleArray* feedback_coef);
    ~IIRFilter();
    ...
    double TailTime(double sample_rate, bool is_filter_stable, unsigned render_quantum_frames);
