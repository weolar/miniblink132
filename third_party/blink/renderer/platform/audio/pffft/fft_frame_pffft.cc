...
void FFTFrame::Initialize(float sample_rate)
{
    ...
    unsigned hrtf_fft_size = static_cast<unsigned>(HRTFPanner::FftSizeForSampleRate(sample_rate));
...
void FFTFrame::DoFFT(const float* data)
{
    ...
    pffft_transform_ordered(setup, data, complex_data_.Data(), pffft_work_.Data(), PFFFT_FORWARD);
...
void FFTFrame::DoInverseFFT(float* data)
{
    ...
    pffft_transform_ordered(setup, fft_data, data, pffft_work_.Data(), PFFFT_BACKWARD);
