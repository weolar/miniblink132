...
void VerifyAccumulator(const AudioFrameStatsAccumulator& accumulator, uint64_t observed_frames, base::TimeDelta observed_frames_duration,
    uint64_t glitch_frames, base::TimeDelta latency, base::TimeDelta min_latency, base::TimeDelta average_latency, base::TimeDelta max_latency,
...
TEST(AudioFrameStatsAccumulatorTest, AbsorbEmtpy)
{
    ...
    VerifyAccumulator(accumulator1,
        ...
        /*max_latency=*/base::TimeDelta(), media::AudioGlitchInfo());
...
TEST(AudioFrameStatsAccumulatorTest, Update)
{
    ...
    media::AudioGlitchInfo glitch_info[] = { {}, { .duration = base::Milliseconds(2), .count = 1 }, { .duration = base::Milliseconds(3), .count = 2 } };
    base::TimeDelta latency[] = { base::Milliseconds(30), base::Milliseconds(20), base::Milliseconds(70) };

    accumulator.Update(frames[0], sample_rate, latency[0], glitch_info[0]);
    total_frames += frames[0];
    total_glitch_info += glitch_info[0];

    VerifyAccumulator(accumulator,
        /*observed_frames=*/total_frames,
        /*observed_frames_duration=*/
        media::AudioTimestampHelper::FramesToTime(total_frames, sample_rate),
        /*glitch_frames=*/
        media::AudioTimestampHelper::TimeToFrames(total_glitch_info.duration, sample_rate),
        /*latency=*/latency[0],
    ...
    VerifyAccumulator(accumulator,
        ...
        /*average_latency=*/(latency[0] * frames[0] + latency[1] * frames[1]) / total_frames,
        /*max_latency=*/latency[0], total_glitch_info);
    ...
    VerifyAccumulator(accumulator,
        ...
        /*min_latency=*/latency[1],
        /*average_latency=*/
        (latency[0] * frames[0] + latency[1] * frames[1] + latency[2] * frames[2]) / total_frames,
...
TEST(AudioFrameStatsAccumulatorTest, Absorb)
{
    ...
    int frames[] = { 480, 520, 400 };
    media::AudioGlitchInfo glitch_info[] = { { .duration = base::Milliseconds(1), .count = 2 }, { .duration = base::Milliseconds(2), .count = 1 },
        { .duration = base::Milliseconds(1), .count = 1 } };
    base::TimeDelta latency[] = { base::Milliseconds(10), base::Milliseconds(20), base::Milliseconds(30) };
    ...
    VerifyAccumulator(absorbing_accumulator,
        /*observed_frames=*/total_frames,
        /*observed_frames_duration=*/
        media::AudioTimestampHelper::FramesToTime(total_frames, sample_rate),
        /*glitch_frames=*/
    ...
    VerifyAccumulator(accumulator,
        ...
        /*latency=*/latency[2],
        /*min_latency=*/latency[1],
        /*average_latency=*/(latency[1] * frames[1] + latency[2] * frames[2]) / (frames[1] + frames[2]),
        /*max_latency=*/latency[2], total_glitch_info);
...
TEST(AudioFrameStatsAccumulatorTest, UpdateDifferentSampleRates)
{
    ...
    int frames[] = { 480, 1024 };
    media::AudioGlitchInfo glitch_info[] = { { .duration = base::Milliseconds(5), .count = 2 }, { .duration = base::Milliseconds(1), .count = 1 } };
    ...
    VerifyAccumulator(accumulator,
        ...
        /*glitch_frames=*/
        media::AudioTimestampHelper::TimeToFrames(glitch_info[0].duration, sample_rate[0]),
        /*latency=*/latency[0],
        /*min_latency=*/latency[0],
        /*average_latency=*/latency[0],
        /*max_latency=*/latency[0], total_glitch_info);
    ...
    VerifyAccumulator(accumulator,
        /*observed_frames=*/total_frames,
        /*observed_frames_duration=*/
        media::AudioTimestampHelper::FramesToTime(frames[0], sample_rate[0]) + media::AudioTimestampHelper::FramesToTime(frames[1], sample_rate[1]),
        /*glitch_frames=*/
        media::AudioTimestampHelper::TimeToFrames(glitch_info[0].duration, sample_rate[0])
            + media::AudioTimestampHelper::TimeToFrames(glitch_info[1].duration, sample_rate[1]),
        /*latency=*/latency[1],
        /*min_latency=*/latency[0],
        /*average_latency=*/(latency[0] * frames[0] + latency[1] * frames[1]) / total_frames,
