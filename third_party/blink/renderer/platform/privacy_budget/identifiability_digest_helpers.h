...
PLATFORM_EXPORT IdentifiableToken IdentifiabilityBenignStringToken(const String&);

// For sensitive strings, this function narrows the hash width to 16 bits.
PLATFORM_EXPORT IdentifiableToken IdentifiabilitySensitiveStringToken(const String&);
...
PLATFORM_EXPORT IdentifiableToken IdentifiabilityBenignCaseFoldingStringToken(const String&);

// For sensitive strings, this function narrows the hash width to 16 bits. Token
// construction is additionally case-insensitive (using Unicode CaseFolding).
PLATFORM_EXPORT IdentifiableToken IdentifiabilitySensitiveCaseFoldingStringToken(const String&);

// For vectors of benign strings only (i.e. those where the string is not
// sensitive).
PLATFORM_EXPORT IdentifiableToken IdentifiabilityBenignStringVectorToken(const Vector<String>&);
