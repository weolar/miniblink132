...
{
    PhysicalToLogical<int> converter({ WritingMode::kHorizontalTb, TextDirection::kLtr }, kTop, kRight, kBottom, kLeft);
...
{
    PhysicalToLogical<int> converter({ WritingMode::kHorizontalTb, TextDirection::kRtl }, kTop, kRight, kBottom, kLeft);
...
{
    PhysicalToLogical<int> converter({ WritingMode::kVerticalLr, TextDirection::kLtr }, kTop, kRight, kBottom, kLeft);
...
{
    PhysicalToLogical<int> converter({ WritingMode::kVerticalLr, TextDirection::kRtl }, kTop, kRight, kBottom, kLeft);
...
{
    PhysicalToLogical<int> converter({ WritingMode::kVerticalRl, TextDirection::kLtr }, kTop, kRight, kBottom, kLeft);
    EXPECT_EQ(kTop, converter.InlineStart());
    EXPECT_EQ(kBottom, converter.InlineEnd());
...
{
    PhysicalToLogical<int> converter({ WritingMode::kVerticalRl, TextDirection::kRtl }, kTop, kRight, kBottom, kLeft);
    EXPECT_EQ(kBottom, converter.InlineStart());
    EXPECT_EQ(kTop, converter.InlineEnd());
    EXPECT_EQ(kRight, converter.BlockStart());
    EXPECT_EQ(kLeft, converter.BlockEnd());
...
{
    LogicalToPhysical<int> converter({ WritingMode::kHorizontalTb, TextDirection::kLtr }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
...
{
    LogicalToPhysical<int> converter({ WritingMode::kHorizontalTb, TextDirection::kRtl }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
...
{
    LogicalToPhysical<int> converter({ WritingMode::kVerticalLr, TextDirection::kLtr }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
...
{
    LogicalToPhysical<int> converter({ WritingMode::kVerticalLr, TextDirection::kRtl }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
    EXPECT_EQ(kBlockStart, converter.Left());
    EXPECT_EQ(kBlockEnd, converter.Right());
...
{
    LogicalToPhysical<int> converter({ WritingMode::kVerticalRl, TextDirection::kLtr }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
...
{
    LogicalToPhysical<int> converter({ WritingMode::kVerticalRl, TextDirection::kRtl }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
    EXPECT_EQ(kBlockEnd, converter.Left());
    EXPECT_EQ(kBlockStart, converter.Right());
    EXPECT_EQ(kInlineEnd, converter.Top());
    EXPECT_EQ(kInlineStart, converter.Bottom());
...
{
    LogicalToPhysical<int> converter({ WritingMode::kSidewaysLr, TextDirection::kLtr }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
    EXPECT_EQ(kBlockStart, converter.Left());
    EXPECT_EQ(kBlockEnd, converter.Right());
    EXPECT_EQ(kInlineEnd, converter.Top());
    EXPECT_EQ(kInlineStart, converter.Bottom());
...
{
    LogicalToPhysical<int> converter({ WritingMode::kSidewaysLr, TextDirection::kRtl }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
    EXPECT_EQ(kBlockStart, converter.Left());
    EXPECT_EQ(kBlockEnd, converter.Right());
    EXPECT_EQ(kInlineStart, converter.Top());
    EXPECT_EQ(kInlineEnd, converter.Bottom());
...
{
    LogicalToPhysical<int> converter({ WritingMode::kSidewaysRl, TextDirection::kLtr }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
    EXPECT_EQ(kBlockEnd, converter.Left());
    EXPECT_EQ(kBlockStart, converter.Right());
    EXPECT_EQ(kInlineStart, converter.Top());
    EXPECT_EQ(kInlineEnd, converter.Bottom());
...
{
    LogicalToPhysical<int> converter({ WritingMode::kSidewaysRl, TextDirection::kRtl }, kInlineStart, kInlineEnd, kBlockStart, kBlockEnd);
    EXPECT_EQ(kBlockEnd, converter.Left());
    EXPECT_EQ(kBlockStart, converter.Right());
    EXPECT_EQ(kInlineEnd, converter.Top());
    EXPECT_EQ(kInlineStart, converter.Bottom());
...
TEST(WritingModeUtilsTest, PhysicalToLogicalGetter)
{
    ...
    PhysicalToLogicalGetter<int, PhysicalValues> getter({ WritingMode::kVerticalRl, TextDirection::kRtl }, physical_values, &PhysicalValues::Top,
        &PhysicalValues::Right, &PhysicalValues::Bottom, &PhysicalValues::Left);
...
{
    PhysicalValues physical_values;
    LogicalToPhysicalSetter<int, PhysicalValues> setter({ WritingMode::kVerticalRl, TextDirection::kRtl }, physical_values, &PhysicalValues::SetTop,
        &PhysicalValues::SetRight, &PhysicalValues::SetBottom, &PhysicalValues::SetLeft);
...
public:
    ...
    void SetInlineStart(int inline_start)
    {
        inline_start_ = inline_start;
    }
    void SetInlineEnd(int inline_end)
    {
        inline_end_ = inline_end;
    }
    void SetBlockStart(int block_start)
    {
        block_start_ = block_start;
    }
    void SetBlockEnd(int block_end)
    {
...
TEST(WritingModeUtilsTest, LogicalToPhysicalGetter)
{
    ...
    LogicalToPhysicalGetter<int, LogicalValues> getter({ WritingMode::kVerticalRl, TextDirection::kRtl }, logical_values, &LogicalValues::InlineStart,
        &LogicalValues::InlineEnd, &LogicalValues::BlockStart, &LogicalValues::BlockEnd);
