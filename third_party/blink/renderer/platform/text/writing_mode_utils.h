...
template <typename Value> class PhysicalToLogical {
    STACK_ALLOCATED();
...
public:
    ...
    {
        return writing_direction_.IsHorizontal() ? top_ : ValueFor(writing_direction_.LineOver());
    }
...
template <typename Value> class LogicalToPhysical {
    STACK_ALLOCATED();

public:
    LogicalToPhysical(WritingDirectionMode writing_direction, Value inline_start, Value inline_end, Value block_start, Value block_end)
        : writing_direction_(writing_direction)
...
template <typename Value> class LogicalToLogical {
    STACK_ALLOCATED();

public:
    LogicalToLogical(WritingDirectionMode from_writing_direction, WritingDirectionMode to_writing_direction, Value inline_start, Value inline_end,
        Value block_start, Value block_end)
        : LogicalToLogical(to_writing_direction, LogicalToPhysical<Value>(from_writing_direction, inline_start, inline_end, block_start, block_end))
    {
    }

    Value InlineStart() const
    {
        return logical_.InlineStart();
    }
    Value BlockStart() const
    {
        return logical_.BlockStart();
    }
    Value InlineEnd() const
    {
        return logical_.InlineEnd();
    }
    Value BlockEnd() const
    {
        return logical_.BlockEnd();
    }
...
template <typename Value, typename Object> class LogicalToPhysicalGetter {
    STACK_ALLOCATED();

public:
    using Getter = Value (Object::*)() const;
    LogicalToPhysicalGetter(WritingDirectionMode writing_direction, const Object& object, Getter inline_start_getter, Getter inline_end_getter,
        Getter block_start_getter, Getter block_end_getter)
        : object_(object)
    ...
    Value Left() const
    {
        return (object_.*converter_.Left())();
    }
    Value Right() const
    {
        return (object_.*converter_.Right())();
    }
    Value Top() const
    {
        return (object_.*converter_.Top())();
    }
    Value Bottom() const
    {
        return (object_.*converter_.Bottom())();
    }
...
template <typename Value, typename Object> class PhysicalToLogicalGetter {
    STACK_ALLOCATED();

public:
    using Getter = Value (Object::*)() const;
    PhysicalToLogicalGetter(
        WritingDirectionMode writing_direction, const Object& object, Getter top_getter, Getter right_getter, Getter bottom_getter, Getter left_getter)
        : object_(object)
        , converter_(writing_direction, top_getter, right_getter, bottom_getter, left_getter)
    {
    }

    Value InlineStart() const
    {
        return (object_.*converter_.InlineStart())();
    }
    Value InlineEnd() const
    {
        return (object_.*converter_.InlineEnd())();
    }
    Value BlockStart() const
    {
        return (object_.*converter_.BlockStart())();
    }
    Value BlockEnd() const
    {
        return (object_.*converter_.BlockEnd())();
    }
...
template <typename Value, typename Object> class LogicalToPhysicalSetter {
    STACK_ALLOCATED();

public:
    using Setter = void (Object::*)(Value);
    LogicalToPhysicalSetter(
        WritingDirectionMode writing_direction, Object& object, Setter top_setter, Setter right_setter, Setter bottom_setter, Setter left_setter)
        : object_(object)
        , converter_(writing_direction, top_setter, right_setter, bottom_setter, left_setter)
    {
    }

    void SetInlineStart(Value v)
    {
        (object_.*converter_.InlineStart())(v);
    }
    void SetInlineEnd(Value v)
    {
        (object_.*converter_.InlineEnd())(v);
    }
    void SetBlockStart(Value v)
    {
        (object_.*converter_.BlockStart())(v);
    }
    void SetBlockEnd(Value v)
    {
        (object_.*converter_.BlockEnd())(v);
    }
