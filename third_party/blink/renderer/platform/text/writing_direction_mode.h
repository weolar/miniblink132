...
public:
    ...
    bool IsLtr() const
    {
        return blink::IsLtr(direction_);
    }
    bool IsRtl() const
    {
        return blink::IsRtl(direction_);
    }
    ...
    {
        return IsHorizontalWritingMode(writing_mode_);
    }
    ...
    //
    bool IsHorizontalLtr() const
    {
        return IsHorizontal() && IsLtr();
    }
...
PLATFORM_EXPORT std::ostream& operator<<(std::ostream&, const WritingDirectionMode&);
