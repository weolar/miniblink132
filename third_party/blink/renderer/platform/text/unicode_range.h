...
const unsigned char kCRangeSetStart = 30; // range set definition starts from here
...
const unsigned char kCRangeTableBase = 128; // values over 127 are reserved for internal use only
