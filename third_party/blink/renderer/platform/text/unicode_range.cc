...
static const unsigned char kGUnicodeSubrangeTable[kCNumSubTables][kCSubTableSize] = {
    {
        // table for X---
    ...
    },
    {
        ...
        kCRangeTableBase + 7, // u05xx, includes Cyrillic supplement, Hebrew, and Armenian
        kCRangeArabic, // u06xx
    ...
    },
    {
        ...
        //                CJK compatibility forms,
        //                small form variants
        kCRangeTableBase + 8, // uffxx, halfwidth and fullwidth forms, includes Specials
    },
    {
