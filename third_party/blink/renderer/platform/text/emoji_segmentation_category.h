...
{
    return emoji != EmojiSegmentationCategory::kMaxCategory && emoji != EmojiSegmentationCategory::KEYCAP_BASE
        && emoji != EmojiSegmentationCategory::EMOJI_TEXT_PRESENTATION && emoji != EmojiSegmentationCategory::VS15;
}
