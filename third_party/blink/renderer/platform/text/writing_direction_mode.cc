...
constexpr PhysicalDirectionMap kInlineStartMap
    = { PhysicalDirection::kLeft, PhysicalDirection::kUp, PhysicalDirection::kUp, PhysicalDirection::kUp, PhysicalDirection::kDown };
constexpr PhysicalDirectionMap kInlineEndMap
    = { PhysicalDirection::kRight, PhysicalDirection::kDown, PhysicalDirection::kDown, PhysicalDirection::kDown, PhysicalDirection::kUp };
constexpr PhysicalDirectionMap kBlockStartMap
    = { PhysicalDirection::kUp, PhysicalDirection::kRight, PhysicalDirection::kLeft, PhysicalDirection::kRight, PhysicalDirection::kLeft };
constexpr PhysicalDirectionMap kBlockEndMap
    = { PhysicalDirection::kDown, PhysicalDirection::kLeft, PhysicalDirection::kRight, PhysicalDirection::kLeft, PhysicalDirection::kRight };
constexpr PhysicalDirectionMap kLineOverMap
    = { PhysicalDirection::kUp, PhysicalDirection::kRight, PhysicalDirection::kRight, PhysicalDirection::kRight, PhysicalDirection::kLeft };
constexpr PhysicalDirectionMap kLineUnderMap
    = { PhysicalDirection::kDown, PhysicalDirection::kLeft, PhysicalDirection::kLeft, PhysicalDirection::kLeft, PhysicalDirection::kRight };
