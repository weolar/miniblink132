...
static const char kStandardizedVariationSequences[] = R"([[{\U00000030\U0000FE00}][{\U00002205\U0000FE00}][{\U00002229\U0000FE00}])"
...
bool Character::IsStandardizedVariationSequence(UChar32 ch, UChar32 vs)
{
    ...
    DEFINE_THREAD_SAFE_STATIC_LOCAL(icu::UnicodeSet, standardizedVariationSequencesSet, ());
    ApplyPatternAndFreezeIfEmpty(&standardizedVariationSequencesSet, kStandardizedVariationSequences);
    icu::UnicodeString variation_sequence = (icu::UnicodeString)ch + (icu::UnicodeString)vs;
...
bool Character::IsIdeographicVariationSequence(UChar32 ch, UChar32 vs)
{
    ...
    WTF::unicode::CharDecompositionType decomp_type = WTF::unicode::DecompositionType(ch);
    return u_hasBinaryProperty(ch, UCHAR_IDEOGRAPHIC) && decomp_type != WTF::unicode::kDecompositionCanonical
