...
public:
    TextRun(const LChar* c, unsigned len, TextDirection direction = TextDirection::kLtr, bool directional_override = false)
        : len_(len)
        , is_8bit_(true)
    ...
    TextRun(const UChar* c, unsigned len, TextDirection direction = TextDirection::kLtr, bool directional_override = false)
        : len_(len)
        , is_8bit_(false)
        , direction_(static_cast<unsigned>(direction))
        , directional_override_(directional_override)
    ...
    TextRun(const StringView& string, TextDirection direction = TextDirection::kLtr, bool directional_override = false)
        : len_(string.length())
        , direction_(static_cast<unsigned>(direction))
        , directional_override_(directional_override)
        , normalize_space_(false)
    ...
    bool NormalizeSpace() const
    {
        return normalize_space_;
    }
    ...
    bool Rtl() const
    {
        return Direction() == TextDirection::kRtl;
    }
    bool Ltr() const
    {
