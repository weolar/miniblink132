...
enum class MathMLOperatorDictionaryCategory : uint8_t { kNone, kForceDefault, kA, kB, kC, kDorEorK, kForG, kH, kI, kJ, kL, kM, kUndefined = 15 };

enum MathMLOperatorDictionaryForm { kInfix, kPrefix, kPostfix, kMaxValue = kPostfix };
...
PLATFORM_EXPORT MathMLOperatorDictionaryCategory FindCategory(const String& content, MathMLOperatorDictionaryForm);
