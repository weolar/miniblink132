...
static ui::NativeTheme::ExtraParams GetNativeThemeExtraParams(
    WebThemeEngine::Part part, WebThemeEngine::State state, const WebThemeEngine::ExtraParams* extra_params)
{
    if (!extra_params) {
    ...
    case WebThemeEngine::kPartScrollbarVerticalTrack: {
        ...
        const auto& scrollbar_track = absl::get<WebThemeEngine::ScrollbarTrackExtraParams>(*extra_params);
    ...
    case WebThemeEngine::kPartCheckbox: {
        ...
        const auto& button = absl::get<WebThemeEngine::ButtonExtraParams>(*extra_params);
    ...
    case WebThemeEngine::kPartTextField: {
        ...
        const auto& text_field = absl::get<WebThemeEngine::TextFieldExtraParams>(*extra_params);
    ...
    case WebThemeEngine::kPartMenuList: {
        ...
        const auto& menu_list = absl::get<WebThemeEngine::MenuListExtraParams>(*extra_params);
        ...
        ui::NativeTheme::ArrowDirection dir = ui::NativeTheme::ArrowDirection(menu_list.arrow_direction);
    ...
    case WebThemeEngine::kPartSliderTrack: {
        ...
        const auto& slider_track = absl::get<WebThemeEngine::SliderExtraParams>(*extra_params);
    ...
    case WebThemeEngine::kPartSliderThumb: {
        ...
        const auto& slider_thumb = absl::get<WebThemeEngine::SliderExtraParams>(*extra_params);
    ...
    case WebThemeEngine::kPartInnerSpinButton: {
        ...
        const auto& inner_spin = absl::get<WebThemeEngine::InnerSpinButtonExtraParams>(*extra_params);
        native_inner_spin.spin_up = inner_spin.spin_up;
        native_inner_spin.read_only = inner_spin.read_only;
        //  Need to explicit cast so we can assign enum to enum.
        ui::NativeTheme::SpinArrowsDirection dir = ui::NativeTheme::SpinArrowsDirection(inner_spin.spin_arrows_direction);
    ...
    case WebThemeEngine::kPartProgressBar: {
        ...
        const auto& progress_bar = absl::get<WebThemeEngine::ProgressBarExtraParams>(*extra_params);
    ...
    case WebThemeEngine::kPartScrollbarVerticalThumb: {
        ...
        const auto& scrollbar_thumb = absl::get<WebThemeEngine::ScrollbarThumbExtraParams>(*extra_params);
        native_scrollbar_thumb.thumb_color = scrollbar_thumb.thumb_color;
        native_scrollbar_thumb.is_thumb_minimal_mode = scrollbar_thumb.is_thumb_minimal_mode;
    ...
    case WebThemeEngine::kPartScrollbarUpArrow: {
        ...
        const auto& scrollbar_button = absl::get<WebThemeEngine::ScrollbarButtonExtraParams>(*extra_params);
        native_scrollbar_arrow.zoom = scrollbar_button.zoom;
        native_scrollbar_arrow.needs_rounded_corner = scrollbar_button.needs_rounded_corner;
...
gfx::Size WebThemeEngineDefault::GetSize(WebThemeEngine::Part part)
{
    ...
    if (!ScrollbarThemeSettings::FluentScrollbarsEnabled()) {
        ...
        case ui::NativeTheme::kScrollbarVerticalTrack: {
            return gfx::Size(g_vertical_scroll_bar_width, g_vertical_scroll_bar_width);
        }
...
#endif
    return ui::NativeTheme::GetInstanceForWeb()->GetPartSize(native_theme_part, ui::NativeTheme::kNormal, extra);
}

void WebThemeEngineDefault::Paint(cc::PaintCanvas* canvas, WebThemeEngine::Part part, WebThemeEngine::State state, const gfx::Rect& rect,
    const WebThemeEngine::ExtraParams* extra_params, mojom::ColorScheme color_scheme, bool in_forced_colors, const ui::ColorProvider* color_provider,
    const std::optional<SkColor>& accent_color)
{
    ui::NativeTheme::ExtraParams native_theme_extra_params = GetNativeThemeExtraParams(part, state, extra_params);
    ui::NativeTheme::GetInstanceForWeb()->Paint(canvas, color_provider, NativeThemePart(part), NativeThemeState(state), rect, native_theme_extra_params,
        NativeColorScheme(color_scheme), in_forced_colors, accent_color);
}

gfx::Insets WebThemeEngineDefault::GetScrollbarSolidColorThumbInsets(Part part) const
{
    return ui::NativeTheme::GetInstanceForWeb()->GetScrollbarSolidColorThumbInsets(NativeThemePart(part));
}

SkColor4f WebThemeEngineDefault::GetScrollbarThumbColor(
    WebThemeEngine::State state, const WebThemeEngine::ExtraParams* extra_params, const ui::ColorProvider* color_provider) const
{
    const ui::NativeTheme::ScrollbarThumbExtraParams native_theme_extra_params
        = absl::get<ui::NativeTheme::ScrollbarThumbExtraParams>(GetNativeThemeExtraParams(
            /*part=*/WebThemeEngine::kPartScrollbarVerticalThumb, state, extra_params));

    return ui::NativeTheme::GetInstanceForWeb()->GetScrollbarThumbColor(*color_provider, NativeThemeState(state), native_theme_extra_params);
}
...
{
    return ui::NativeTheme::GetInstanceForWeb()->SupportsNinePatch(NativeThemePart(part));
}

gfx::Size WebThemeEngineDefault::NinePatchCanvasSize(Part part) const
{
    return ui::NativeTheme::GetInstanceForWeb()->GetNinePatchCanvasSize(NativeThemePart(part));
}

gfx::Rect WebThemeEngineDefault::NinePatchAperture(Part part) const
{
    return ui::NativeTheme::GetInstanceForWeb()->GetNinePatchAperture(NativeThemePart(part));
}
...
void WebThemeEngineDefault::cacheScrollBarMetrics(
    int32_t vertical_scroll_bar_width, int32_t horizontal_scroll_bar_height, int32_t vertical_arrow_bitmap_height, int32_t horizontal_arrow_bitmap_width)
{
