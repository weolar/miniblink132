...
ui::NativeTheme::ColorScheme NativeColorScheme(mojom::ColorScheme color_scheme)
{
    switch (color_scheme) {
...
ui::NativeTheme::SystemThemeColor NativeSystemThemeColor(WebThemeEngine::SystemThemeColor theme_color)
{
    switch (theme_color) {
...
WebThemeEngine::SystemThemeColor WebThemeSystemThemeColor(ui::NativeTheme::SystemThemeColor theme_color)
{
    switch (theme_color) {
