...
public:
    ...
    void Paint(cc::PaintCanvas* canvas, WebThemeEngine::Part part, WebThemeEngine::State state, const gfx::Rect& rect,
    ...
    SkColor4f GetScrollbarThumbColor(WebThemeEngine::State, const WebThemeEngine::ExtraParams*, const ui::ColorProvider*) const override;
    ...
    static void cacheScrollBarMetrics(
