...
public:
    ...
    void SetDigest(const String& digest)
    {
        digest_ = digest;
    }
    IntegrityAlgorithm Algorithm() const
    {
        return algorithm_;
    }
...
enum class ResourceIntegrityDisposition : uint8_t { kNotChecked = 0, kNetworkError, kFailedIntegrityMetadata, kPassed };
