...
class PLATFORM_EXPORT ResponseBodyLoaderDrainableInterface : public GarbageCollected<ResponseBodyLoaderDrainableInterface> {
public:
    ...
    virtual mojo::ScopedDataPipeConsumerHandle DrainAsDataPipe(ResponseBodyLoaderClient** client) = 0;
...
class PLATFORM_EXPORT ResponseBodyLoader final : public ResponseBodyLoaderDrainableInterface, private ResponseBodyLoaderClient, private BytesConsumer::Client {
public:
    ResponseBodyLoader(
        BytesConsumer&, ResponseBodyLoaderClient&, scoped_refptr<base::SingleThreadTaskRunner>, BackForwardCacheLoaderHelper* back_forward_cache_loader_helper);

    // ResponseBodyLoaderDrainableInterface implementation.
    mojo::ScopedDataPipeConsumerHandle DrainAsDataPipe(ResponseBodyLoaderClient**) override;
