...
public:
    ...
    virtual bool IsFontResourceClient() const
    {
        return false;
    }

    virtual bool IsRawResourceClient() const
    {
        return false;
    }
    ...
    bool FinishedFromMemoryCache() const
    {
        return finished_from_memory_cache_;
    }
    void SetHasFinishedFromMemoryCache()
    {
        finished_from_memory_cache_ = true;
    }
...
private:
    ...
    void SetResource(Resource* new_resource, base::SingleThreadTaskRunner* task_runner);
