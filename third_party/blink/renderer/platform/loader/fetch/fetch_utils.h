...
public:
    ...
    static net::NetworkTrafficAnnotationTag GetTrafficAnnotationTag(const network::ResourceRequest& request);
    ...
    static void LogFetchKeepAliveRequestMetric(const mojom::blink::RequestContextType&, const FetchKeepAliveRequestState&, bool is_context_detached = false);
    static void LogFetchKeepAliveRequestSentToServiceMetric(const network::ResourceRequest& resource_request);
};
