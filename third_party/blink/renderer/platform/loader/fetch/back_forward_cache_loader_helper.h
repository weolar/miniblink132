...
class PLATFORM_EXPORT BackForwardCacheLoaderHelper : public GarbageCollected<BackForwardCacheLoaderHelper> {
public:
    ...
    virtual void EvictFromBackForwardCache(mojom::blink::RendererEvictionReason reason) = 0;
