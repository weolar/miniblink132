...
// stylesheets, etc.
class PLATFORM_EXPORT MemoryCache final : public GarbageCollected<MemoryCache>, public MemoryCacheDumpClient, public MemoryPressureListener {
public:
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(MemoryCacheStrongReferenceTest, ClearStrongReferences);
};
