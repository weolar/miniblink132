...
class PLATFORM_EXPORT FetchClientSettingsObject : public GarbageCollected<FetchClientSettingsObject> {
public:
    ...
    virtual AllowedByNosniff::MimeTypeCheck MimeTypeCheckForClassicWorkerScript() const = 0;

    // https://w3c.github.io/webappsec-upgrade-insecure-requests/#insecure-requests-policy
    virtual mojom::blink::InsecureRequestPolicy GetInsecureRequestsPolicy() const = 0;
    ...
    virtual const InsecureNavigationsSet& GetUpgradeInsecureNavigationsSet() const = 0;
