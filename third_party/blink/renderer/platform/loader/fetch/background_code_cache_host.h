...
// enabled.
class BLINK_PLATFORM_EXPORT BackgroundCodeCacheHost : public ThreadSafeRefCounted<BackgroundCodeCacheHost> {
public:
    explicit BackgroundCodeCacheHost(mojo::PendingRemote<mojom::blink::CodeCacheHost> pending_remote);
    ...
    CodeCacheHost& GetCodeCacheHost(scoped_refptr<base::SequencedTaskRunner> background_task_runner);
