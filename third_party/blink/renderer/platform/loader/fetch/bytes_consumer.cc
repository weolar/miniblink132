...
std::ostream& operator<<(std::ostream& out, const BytesConsumer::PublicState& state)
{
    switch (state) {
...
std::ostream& operator<<(std::ostream& out, const BytesConsumer::Result& result)
{
    switch (result) {
