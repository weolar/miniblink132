...
void DetachableResourceFetcherProperties::Detach()
{
    ...
    fetch_client_settings_object_ = MakeGarbageCollected<FetchClientSettingsObjectSnapshot>(properties_->GetFetchClientSettingsObject());
    ...
    is_subframe_deprioritization_enabled_ = properties_->IsSubframeDeprioritizationEnabled();
