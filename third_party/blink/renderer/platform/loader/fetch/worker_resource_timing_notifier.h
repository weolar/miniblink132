...
class WorkerResourceTimingNotifier : public GarbageCollected<WorkerResourceTimingNotifier> {
public:
    ...
    // running thread.
    virtual void AddResourceTiming(mojom::blink::ResourceTimingInfoPtr, const AtomicString& initiator_type) = 0;
