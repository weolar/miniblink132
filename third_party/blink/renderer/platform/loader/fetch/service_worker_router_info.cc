...
String ServiceWorkerRouterInfo::GetRouterSourceTypeString(const network::mojom::ServiceWorkerRouterSourceType source)
{
    switch (source) {
...
network::mojom::blink::ServiceWorkerRouterInfoPtr ServiceWorkerRouterInfo::ToMojo() const
{
    network::mojom::blink::ServiceWorkerRouterInfoPtr info = network::mojom::blink::ServiceWorkerRouterInfo::New();
