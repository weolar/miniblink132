...
ResourceLoadPriority BLINK_PLATFORM_EXPORT AdjustPriorityWithPriorityHintAndRenderBlocking(
...
public:
    ...
    // set.
    virtual ResourceLoadPriority ComputeLoadPriority(const FetchParameters& params) = 0;
...
BLINK_PLATFORM_EXPORT std::optional<ResourceRequestBlockedReason> PrepareResourceRequestForCacheAccess(ResourceType type,
...
BLINK_PLATFORM_EXPORT std::optional<ResourceRequestBlockedReason> PrepareResourceRequest(ResourceType resource_type,
    const FetchClientSettingsObject& fetch_client_settings_object, FetchParameters& params, FetchContext& context,
    WebScopedVirtualTimePauser& virtual_time_pauser, ResourceRequestContext& resource_request_context, const KURL& bundle_url_for_uuid_resources);
BLINK_PLATFORM_EXPORT void UpgradeResourceRequestForLoaderNew(ResourceType resource_type, FetchParameters& params, FetchContext& context,
