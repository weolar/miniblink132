...
public:
    class PLATFORM_EXPORT CompletionNotifier final : public GarbageCollected<CompletionNotifier> {
    public:
    ...
    DataPipeBytesConsumer(scoped_refptr<base::SingleThreadTaskRunner> task_runner, mojo::ScopedDataPipeConsumerHandle, CompletionNotifier** notifier);
