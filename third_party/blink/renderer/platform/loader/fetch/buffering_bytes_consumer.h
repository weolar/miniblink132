...
// client.
class PLATFORM_EXPORT BufferingBytesConsumer final : public BytesConsumer, private BytesConsumer::Client {
public:
    ...
    // not have a client.
    static BufferingBytesConsumer* CreateWithDelay(BytesConsumer* bytes_consumer, scoped_refptr<base::SingleThreadTaskRunner> timer_task_runner);
    ...
    BufferingBytesConsumer(base::PassKey<BufferingBytesConsumer> key, BytesConsumer* bytes_consumer,
