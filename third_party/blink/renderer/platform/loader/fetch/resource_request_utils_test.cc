...
TEST(ShouldLoadIncrementalTest, PriorityNotIncremental)
{
    constexpr ResourceType kResNotIncremental[]
        = { ResourceType::kCSSStyleSheet, ResourceType::kScript, ResourceType::kFont, ResourceType::kXSLStyleSheet, ResourceType::kManifest };
...
{
    constexpr ResourceType kResIncremental[] = { ResourceType::kImage, ResourceType::kRaw, ResourceType::kSVGDocument, ResourceType::kLinkPrefetch,
        ResourceType::kTextTrack, ResourceType::kAudio, ResourceType::kVideo, ResourceType::kSpeculationRules };
