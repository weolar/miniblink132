...
template <> struct PLATFORM_EXPORT StructTraits<blink::mojom::FetchAPIRequestBodyDataView, blink::ResourceRequestBody> {
    ...
    static WTF::Vector<network::DataElement> elements(blink::ResourceRequestBody& mutable_body);
    ...
    static bool Read(blink::mojom::FetchAPIRequestBodyDataView in, blink::ResourceRequestBody* out);
};
