...
class PLATFORM_EXPORT SubresourceWebBundleList : public GarbageCollected<SubresourceWebBundleList> {
public:
    ...
    SubresourceWebBundle* FindSubresourceWebBundleWhichWillBeReleased(const KURL& bundle_url, network::mojom::CredentialsMode credentials_mode) const;
