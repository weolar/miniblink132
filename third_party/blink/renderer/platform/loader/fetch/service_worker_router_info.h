...
class PLATFORM_EXPORT ServiceWorkerRouterInfo : public RefCounted<ServiceWorkerRouterInfo> {
public:
    static scoped_refptr<ServiceWorkerRouterInfo> Create();

    static String GetRouterSourceTypeString(const network::mojom::ServiceWorkerRouterSourceType source);
    ...
    void SetMatchedSourceType(const std::optional<network::mojom::ServiceWorkerRouterSourceType>& type)
    {
        matched_source_type_ = type;
    }

    const std::optional<network::mojom::ServiceWorkerRouterSourceType>& MatchedSourceType() const
    {
        return matched_source_type_;
    }

    void SetActualSourceType(const std::optional<network::mojom::ServiceWorkerRouterSourceType>& type)
    {
        actual_source_type_ = type;
    }

    const std::optional<network::mojom::ServiceWorkerRouterSourceType>& ActualSourceType() const
    {
        return actual_source_type_;
    }

    std::uint64_t RouteRuleNum() const
    {
        return route_rule_num_;
    }
    ...
    const std::optional<network::mojom::ServiceWorkerStatus>& EvaluationWorkerStatus() const
    {
        return evaluation_worker_status_;
    }

    void SetEvaluationWorkerStatus(const std::optional<network::mojom::ServiceWorkerStatus>& evaluation_worker_status)
    {
    ...
    const base::TimeDelta& CacheLookupTime() const
    {
        return cache_lookup_time_;
    }
...
private:
    ...
    std::optional<network::mojom::ServiceWorkerRouterSourceType> matched_source_type_;
    std::optional<network::mojom::ServiceWorkerRouterSourceType> actual_source_type_;
