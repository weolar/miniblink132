...
public:
    CrossThreadFetchClientSettingsObjectData(KURL global_object_url, KURL base_url, scoped_refptr<const SecurityOrigin> security_origin,
        network::mojom::ReferrerPolicy referrer_policy, String outgoing_referrer, HttpsState https_state,
        AllowedByNosniff::MimeTypeCheck mime_type_check_for_classic_worker_script, mojom::blink::InsecureRequestPolicy insecure_requests_policy,
        FetchClientSettingsObject::InsecureNavigationsSet insecure_navigations_set)
    ...
    CrossThreadFetchClientSettingsObjectData(const CrossThreadFetchClientSettingsObjectData&) = delete;
    CrossThreadFetchClientSettingsObjectData& operator=(const CrossThreadFetchClientSettingsObjectData&) = delete;
    ...
    const AllowedByNosniff::MimeTypeCheck mime_type_check_for_classic_worker_script;
    const mojom::blink::InsecureRequestPolicy insecure_requests_policy;
    const FetchClientSettingsObject::InsecureNavigationsSet insecure_navigations_set;
};
...
class PLATFORM_EXPORT FetchClientSettingsObjectSnapshot final : public FetchClientSettingsObject {
public:
    explicit FetchClientSettingsObjectSnapshot(const FetchClientSettingsObject&);
    explicit FetchClientSettingsObjectSnapshot(std::unique_ptr<CrossThreadFetchClientSettingsObjectData>);
    FetchClientSettingsObjectSnapshot(const KURL& global_object_url, const KURL& base_url, const scoped_refptr<const SecurityOrigin> security_origin,
        network::mojom::ReferrerPolicy referrer_policy, const String& outgoing_referrer, HttpsState https_state, AllowedByNosniff::MimeTypeCheck,
        mojom::blink::InsecureRequestPolicy, InsecureNavigationsSet);

    ~FetchClientSettingsObjectSnapshot() override = default;

    const KURL& GlobalObjectUrl() const override
    {
        return global_object_url_;
    }
    ...
    {
        return std::make_unique<CrossThreadFetchClientSettingsObjectData>(global_object_url_, base_url_, security_origin_->IsolatedCopy(), referrer_policy_,
            outgoing_referrer_, https_state_, mime_type_check_for_classic_worker_script_, insecure_requests_policy_, insecure_navigations_set_);
    }
...
private:
    ...
    const AllowedByNosniff::MimeTypeCheck mime_type_check_for_classic_worker_script_;
