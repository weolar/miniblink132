...
class BLINK_PLATFORM_EXPORT ResourceRequestClient : public WTF::RefCounted<ResourceRequestClient> {
public:
    ...
    // the resource load.
    virtual void OnCompletedRequest(const network::URLLoaderCompletionStatus& status) = 0;
