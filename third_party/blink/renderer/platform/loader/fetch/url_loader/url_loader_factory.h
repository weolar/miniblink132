...
public:
    URLLoaderFactory(scoped_refptr<network::SharedURLLoaderFactory> loader_factory, const Vector<String>& cors_exempt_header_list,
    ...
    virtual std::unique_ptr<URLLoader> CreateURLLoader(const network::ResourceRequest& request,
