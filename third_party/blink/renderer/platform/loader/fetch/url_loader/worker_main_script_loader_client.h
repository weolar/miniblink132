...
class PLATFORM_EXPORT WorkerMainScriptLoaderClient : public GarbageCollectedMixin {
public:
    ...
    virtual void OnStartLoadingBodyWorkerMainScript(const ResourceResponse& resource_response)
    {
    }
