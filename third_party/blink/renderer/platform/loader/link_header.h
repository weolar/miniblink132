...
public:
    ...
    const String& ImageSrcset() const
    {
        return image_srcset_;
    }
    const String& ImageSizes() const
    {
        return image_sizes_;
    }
    const String& HeaderIntegrity() const
    {
    ...
    const String& VariantKey() const
    {
        return variant_key_;
    }
    const String& Blocking() const
    {
        return blocking_;
    }
    ...
    const String& FetchPriority() const
    {
        return fetch_priority_;
    }
    const std::optional<String>& Anchor() const
    {
        return anchor_;
    }
    bool Valid() const
...
private:
    ...
    template <typename Iterator> LinkHeader(Iterator begin, Iterator end);
...
public:
    ...
    Vector<LinkHeader>::const_iterator end() const
    {
        return header_set_.end();
    }
    LinkHeader& operator[](wtf_size_t i)
    {
        return header_set_[i];
    }
    wtf_size_t size()
    {
        return header_set_.size();
    }
