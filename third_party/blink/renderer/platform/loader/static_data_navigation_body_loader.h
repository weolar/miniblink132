...
class PLATFORM_EXPORT StaticDataNavigationBodyLoader : public WebNavigationBodyLoader {
public:
    static std::unique_ptr<StaticDataNavigationBodyLoader> CreateWithData(scoped_refptr<SharedBuffer> data);
