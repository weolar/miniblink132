...
class FakeResourceLoadInfoNotifier final : public blink::mojom::ResourceLoadInfoNotifier {
public:
    ...
    FakeResourceLoadInfoNotifier& operator=(const FakeResourceLoadInfoNotifier&) = delete;
    ...
    void NotifyResourceResponseReceived(int64_t request_id, const url::SchemeHostPort& final_url, network::mojom::URLResponseHeadPtr head,
