...
// BackgroundURLLoader.
class FakeBackgroundResourceFetchAssets : public WebBackgroundResourceFetchAssets {
public:
    ...
    FakeBackgroundResourceFetchAssets(scoped_refptr<base::SequencedTaskRunner> background_task_runner, LoadStartCallback load_start_callback);

    FakeBackgroundResourceFetchAssets(const FakeBackgroundResourceFetchAssets&) = delete;
    FakeBackgroundResourceFetchAssets& operator=(const FakeBackgroundResourceFetchAssets&) = delete;
    ...
    URLLoaderThrottleProvider* GetThrottleProvider() override
    {
        return nullptr;
    }
