...
class FakeURLLoaderFactoryForBackgroundThread : public network::SharedURLLoaderFactory {
public:
    ...
    // request is started.
    explicit FakeURLLoaderFactoryForBackgroundThread(LoadStartCallback load_start_callback);
    FakeURLLoaderFactoryForBackgroundThread(const FakeURLLoaderFactoryForBackgroundThread&) = delete;
    FakeURLLoaderFactoryForBackgroundThread& operator=(const FakeURLLoaderFactoryForBackgroundThread&) = delete;
...
private:
    ...
    mojo::ReceiverSet<network::mojom::URLLoaderFactory, scoped_refptr<FakeURLLoaderFactoryForBackgroundThread>> receivers_;
