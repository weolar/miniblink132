...
ReplayingBytesConsumer::ReplayingBytesConsumer(scoped_refptr<base::SingleThreadTaskRunner> task_runner)
...
BytesConsumer::Result ReplayingBytesConsumer::BeginRead(base::span<const char>& buffer)
{
    ...
    case Command::kWait:
        ...
        task_runner_->PostTask(FROM_HERE, WTF::BindOnce(&ReplayingBytesConsumer::NotifyAsReadable, WrapPersistent(this), notification_token_));
        return Result::kShouldWait;
    }
    NOTREACHED();
}
