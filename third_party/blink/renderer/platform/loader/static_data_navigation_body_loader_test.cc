...
class StaticDataNavigationBodyLoaderTest : public ::testing::Test, public WebNavigationBodyLoader::Client {
protected:
    void SetUp() override
    {
    ...
    void BodyLoadingFinished(base::TimeTicks completion_time, int64_t total_encoded_data_length, int64_t total_encoded_body_length,
        int64_t total_decoded_body_length, const std::optional<blink::WebURLError>& error) override
    {
...
TEST_F(StaticDataNavigationBodyLoaderTest, SetDefersLoadingAndWriteFromDataReceived)
{
    loader_->StartLoadingBody(this);
    expecting_data_received_ = true;
...
TEST_F(StaticDataNavigationBodyLoaderTest, SetDefersLoadingWithBfcacheAndWriteFromDataReceived)
{
    loader_->StartLoadingBody(this);
    expecting_data_received_ = true;
...
TEST_F(StaticDataNavigationBodyLoaderTest, SetDefersLoadingWithBfcacheFromDataReceived)
{
    loader_->StartLoadingBody(this);
    expecting_data_received_ = true;
    freeze_mode_ = LoaderFreezeMode::kBufferIncoming;
...
TEST_F(StaticDataNavigationBodyLoaderTest, SetDefersLoadingFromFinishedDataReceived)
{
    Write("hello");
    loader_->Finish();
    expecting_data_received_ = true;
...
TEST_F(StaticDataNavigationBodyLoaderTest, SetDefersLoadingWithBfcacheFromFinishedDataReceived)
{
    Write("hello");
    loader_->Finish();
    expecting_data_received_ = true;
...
TEST_F(StaticDataNavigationBodyLoaderTest, SetDefersLoadingWithBfcacheFromFinished)
{
    loader_->StartLoadingBody(this);
    expecting_finished_ = true;
    freeze_mode_ = LoaderFreezeMode::kBufferIncoming;
