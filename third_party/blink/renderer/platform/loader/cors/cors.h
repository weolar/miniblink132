...
PLATFORM_EXPORT bool IsNoCorsSafelistedHeader(const String& name, const String& value);
...
PLATFORM_EXPORT bool IsForbiddenRequestHeader(const String& name, const String& value);
...
PLATFORM_EXPORT HTTPHeaderSet ExtractCorsExposedHeaderNamesList(network::mojom::CredentialsMode, const ResourceResponse&);
