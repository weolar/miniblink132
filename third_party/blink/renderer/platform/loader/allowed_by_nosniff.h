...
public:
    ...
    static bool MimeTypeAsScript(UseCounter&, ConsoleLogger*, const ResourceResponse&, MimeTypeCheck mime_type_check_mode);

    static bool MimeTypeAsXMLExternalEntity(ConsoleLogger*, const ResourceResponse&);
};
