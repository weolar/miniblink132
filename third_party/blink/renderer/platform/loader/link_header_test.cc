...
struct SingleTestCase {
    ...
    { "</images/cat.jpg>; rel=prefetch;media=\"(max-width: 5000px)\"", true, "/images/cat.jpg", "prefetch", "", "(max-width: 5000px)", "" },
    { "</images/cat.jpg>; rel=prefetch;media=(max-width:5000px)", true, "/images/cat.jpg", "prefetch", "", "(max-width:5000px)", "" },
    { "<simple.css>; rel=preload; fetchpriority=auto", true, "simple.css", "preload", "", "", "auto" },
    { "<simple.css>; rel=preload; fetchpriority=low", true, "simple.css", "preload", "", "", "low" },
    { "<simple.css>; rel=preload; fetchpriority=high", true, "simple.css", "preload", "", "", "high" },
};
...
INSTANTIATE_TEST_SUITE_P(LinkHeaderTest, SingleLinkHeaderTest, testing::ValuesIn(g_single_test_cases));
...
INSTANTIATE_TEST_SUITE_P(LinkHeaderTest, DoubleLinkHeaderTest, testing::ValuesIn(g_double_test_cases));
...
INSTANTIATE_TEST_SUITE_P(LinkHeaderTest, CrossOriginLinkHeaderTest, testing::ValuesIn(g_cross_origin_test_cases));
