...
// static
std::unique_ptr<StaticDataNavigationBodyLoader> StaticDataNavigationBodyLoader::CreateWithData(scoped_refptr<SharedBuffer> data)
{
...
void StaticDataNavigationBodyLoader::StartLoadingBody(WebNavigationBodyLoader::Client* client)
{
...
void StaticDataNavigationBodyLoader::Continue()
{
    ...
    base::WeakPtr<StaticDataNavigationBodyLoader> weak_self = weak_factory_.GetWeakPtr();
    ...
    if (sent_all_data_) {
        ...
        client_ = nullptr;
        client->BodyLoadingFinished(base::TimeTicks::Now(), total_encoded_data_length_, total_encoded_data_length_, total_encoded_data_length_, std::nullopt);
