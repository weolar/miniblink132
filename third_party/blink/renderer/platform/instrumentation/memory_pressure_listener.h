...
public:
    ...
    virtual void OnMemoryPressure(base::MemoryPressureListener::MemoryPressureLevel)
    {
    }
...
class PLATFORM_EXPORT MemoryPressureListenerRegistry final : public GarbageCollected<MemoryPressureListenerRegistry> {
public:
    ...
    static bool IsLowEndDeviceOrPartialLowEndModeEnabledIncludingCanvasFontCache();
