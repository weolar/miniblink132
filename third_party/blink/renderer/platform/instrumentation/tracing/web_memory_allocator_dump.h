...
public:
    explicit WebMemoryAllocatorDump(base::trace_event::MemoryAllocatorDump* memory_allocator_dump);
...
private:
    raw_ptr<base::trace_event::MemoryAllocatorDump> memory_allocator_dump_; // Not owned.
