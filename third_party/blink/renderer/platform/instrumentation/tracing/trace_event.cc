...
{
    base::trace_event::TraceLog::GetInstance()->AddAsyncEnabledStateObserver(observer);
}

void RemoveAsyncEnabledStateObserver(AsyncEnabledStateObserver* observer)
{
    base::trace_event::TraceLog::GetInstance()->RemoveAsyncEnabledStateObserver(observer);
}
...
{
    base::trace_event::TraceLog::GetInstance()->RemoveEnabledStateObserver(observer);
}
