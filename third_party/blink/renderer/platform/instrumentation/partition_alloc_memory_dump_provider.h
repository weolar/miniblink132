...
class PLATFORM_EXPORT PartitionAllocMemoryDumpProvider final : public base::trace_event::MemoryDumpProvider {
...
public:
    ...
    PartitionAllocMemoryDumpProvider(const PartitionAllocMemoryDumpProvider&) = delete;
    PartitionAllocMemoryDumpProvider& operator=(const PartitionAllocMemoryDumpProvider&) = delete;
