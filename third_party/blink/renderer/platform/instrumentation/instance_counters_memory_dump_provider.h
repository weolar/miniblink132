...
class PLATFORM_EXPORT InstanceCountersMemoryDumpProvider final : public base::trace_event::MemoryDumpProvider {
    USING_FAST_MALLOC(InstanceCountersMemoryDumpProvider);

public:
    static InstanceCountersMemoryDumpProvider* Instance();
    InstanceCountersMemoryDumpProvider(const InstanceCountersMemoryDumpProvider&) = delete;
    InstanceCountersMemoryDumpProvider& operator=(const InstanceCountersMemoryDumpProvider&) = delete;
