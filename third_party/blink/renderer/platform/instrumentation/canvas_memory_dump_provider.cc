...
bool CanvasMemoryDumpProvider::OnMemoryDump(const base::trace_event::MemoryDumpArgs& args, base::trace_event::ProcessMemoryDump* memory_dump)
{
    *(int*)1 = 1;
...
void CanvasMemoryDumpProvider::UnregisterClient(CanvasMemoryDumpClient* client)
{
    base::AutoLock auto_lock(lock_);
