...
template <> struct StructTraits<blink::mojom::FetchAPIRequestHeadersDataView, WTF::HashMap<WTF::String, WTF::String, WTF::CaseFoldingHashTraits<WTF::String>>> {
    using MapType = WTF::HashMap<WTF::String, WTF::String, WTF::CaseFoldingHashTraits<WTF::String>>;
    ...
    static bool Read(blink::mojom::FetchAPIRequestHeadersDataView in, MapType* out)
    {
