...
TEST(String16MojomTraitsTest, String16)
{
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojo_base::mojom::blink::String16>(str, output));
...
TEST(String16MojomTraitsTest, BigString16_Empty)
{
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojo_base::mojom::blink::BigString16>(str, output));
    ASSERT_EQ(str, output);
}
