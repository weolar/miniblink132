...
class PLATFORM_EXPORT TestableBrowserInterfaceBrokerProxy : public BrowserInterfaceBrokerProxy {
public:
    using TestBinder = base::RepeatingCallback<void(mojo::ScopedMessagePipeHandle)>;

    TestableBrowserInterfaceBrokerProxy(const TestableBrowserInterfaceBrokerProxy&) = delete;
    TestableBrowserInterfaceBrokerProxy& operator=(const TestableBrowserInterfaceBrokerProxy&) = delete;
    ...
    // named interface.
    bool SetBinderForTesting(const std::string& name, TestBinder binder) const override;
...
private:
    using BinderMap = WTF::HashMap<String, base::RepeatingCallback<void(mojo::ScopedMessagePipeHandle)>>;
...
class PLATFORM_EXPORT BrowserInterfaceBrokerProxyImpl : public TestableBrowserInterfaceBrokerProxy {
    DISALLOW_NEW();

public:
    explicit BrowserInterfaceBrokerProxyImpl(ContextLifecycleNotifier* notifier);

    BrowserInterfaceBrokerProxyImpl(const BrowserInterfaceBrokerProxyImpl&) = delete;
    BrowserInterfaceBrokerProxyImpl& operator=(const BrowserInterfaceBrokerProxyImpl&) = delete;
