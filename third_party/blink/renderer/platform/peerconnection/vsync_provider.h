...
public:
    ...
    virtual void Initialize(base::RepeatingCallback<void(bool /*visible*/)> callback) = 0;
...
public:
    VSyncProviderImpl(scoped_refptr<base::SequencedTaskRunner> task_runner, uint32_t frame_sink_client_id);
