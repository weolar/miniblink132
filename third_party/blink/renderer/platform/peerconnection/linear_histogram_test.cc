...
protected:
    LinearHistogramTest()
        : histogram_(kMinValue, kMaxValue, kNumBuckets)
    {
    }
...
TEST_F(LinearHistogramTest, ReturnsCorrectPercentiles)
{
    const std::vector<float> kTestValues
        = { -1.0f, 0.0f, 1.0f, 2.9f, 3.1f, 4.1f, 5.0f, 8.0f, 9.0f, 9.9f, 10.0f, 11.0f, 12.0f, 13.0f, 14.0f, 15.0f, 16.0f, 17.0f, 18.0f, 19.0f };
    // Pairs of {fraction, percentile value} computed by hand
    // for `kTestValues`.
    const std::vector<std::pair<float, float>> kTestPercentiles = { { 0.01f, 0.0f }, { 0.05f, 0.0f }, { 0.1f, 0.0f }, { 0.11f, 1.0f }, { 0.15f, 1.0f },
        { 0.20f, 3.0f }, { 0.25f, 4.0f }, { 0.30f, 5.0f }, { 0.35f, 5.0f }, { 0.40f, 8.0f }, { 0.41f, 9.0f }, { 0.45f, 9.0f }, { 0.50f, 10.0f },
        { 0.55f, 10.0f }, { 0.56f, 19.0f }, { 0.80f, 19.0f }, { 0.95f, 19.0f }, { 0.99f, 19.0f }, { 1.0f, 19.0f } };
    for (float value : kTestValues) {
        histogram_.Add(value);
    }
    for (const auto& test_percentile : kTestPercentiles) {
        EXPECT_EQ(test_percentile.second, histogram_.GetPercentile(test_percentile.first));
    }
}
