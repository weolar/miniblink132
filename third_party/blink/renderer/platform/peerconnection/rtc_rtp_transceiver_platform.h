...
public:
    ...
    virtual std::optional<webrtc::RtpTransceiverDirection> CurrentDirection() const = 0;
    virtual std::optional<webrtc::RtpTransceiverDirection> FiredDirection() const = 0;
    virtual webrtc::RTCError Stop() = 0;
    virtual webrtc::RTCError SetCodecPreferences(Vector<webrtc::RtpCodecCapability>) = 0;
    virtual webrtc::RTCError SetHeaderExtensionsToNegotiate(Vector<webrtc::RtpHeaderExtensionCapability> header_extensions) = 0;
    virtual Vector<webrtc::RtpHeaderExtensionCapability> GetNegotiatedHeaderExtensions() const = 0;
    virtual Vector<webrtc::RtpHeaderExtensionCapability> GetHeaderExtensionsToNegotiate() const = 0;
};
