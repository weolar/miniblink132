...
{
    webrtc::RtpSource rtp_source(kTimestamp, kSourceId, kSourceType, kRtpTimestamp, webrtc::RtpSource::Extensions());
...
TEST(RtcRtpSource, BaseTimeTicksAndRtcMicrosAreTheSame)
{
    ...
    base::TimeTicks webrtc_timestamp = ConvertToBaseTimeTicks(webrtc::Timestamp::Micros(rtc::TimeMicros()));
...
{
    constexpr webrtc::AbsoluteCaptureTime kAbsCaptureTime { .absolute_capture_timestamp = kQ32x32Time1000ms };
    webrtc::RtpSource rtp_source(kTimestamp, kSourceId, kSourceType, kRtpTimestamp,
...
{
    constexpr webrtc::AbsoluteCaptureTime kAbsCaptureTime { .absolute_capture_timestamp = kQ32x32Time1250ms, .estimated_capture_clock_offset = 0 };
    webrtc::RtpSource rtp_source(kTimestamp, kSourceId, kSourceType, kRtpTimestamp,
        /*extensions=*/ { .absolute_capture_time = kAbsCaptureTime });
    RTCRtpSource rtc_rtp_source(rtp_source);
...
{
    constexpr webrtc::AbsoluteCaptureTime kAbsCaptureTime { .absolute_capture_timestamp = kQ32x32Time1250ms,
