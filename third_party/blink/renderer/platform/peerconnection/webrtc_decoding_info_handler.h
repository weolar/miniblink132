...
public:
    ...
    WebrtcDecodingInfoHandler& operator=(const WebrtcDecodingInfoHandler&) = delete;
    ~WebrtcDecodingInfoHandler();
    ...
    using OnMediaCapabilitiesDecodingInfoCallback = base::OnceCallback<void(bool, bool)>;
    void DecodingInfo(const std::optional<webrtc::SdpAudioFormat> sdp_audio_format, const std::optional<webrtc::SdpVideoFormat> sdp_video_format,
        const bool video_spatial_scalability, OnMediaCapabilitiesDecodingInfoCallback callback) const;
