...
public:
    ...
    virtual void OnEncoderCreated(int encoder_id, const webrtc::VideoCodec& config) = 0;
    ...
    virtual void OnRatesUpdated(int encoder_id, const Vector<bool>& active_spatial_layers) = 0;
