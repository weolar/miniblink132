...
class PLATFORM_EXPORT StatsCollectingDecoder : private StatsCollector, public webrtc::VideoDecoder, private webrtc::DecodedImageCallback {
public:
    ...
    explicit StatsCollectingDecoder(const webrtc::SdpVideoFormat& format, std::unique_ptr<webrtc::VideoDecoder> decoder, StoreProcessingStatsCB stats_callback);
