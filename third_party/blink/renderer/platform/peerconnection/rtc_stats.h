...
public:
    explicit RTCStatsReportPlatform(const scoped_refptr<const webrtc::RTCStatsReport>& stats_report);
    ...
    const webrtc::RTCStatsReport& stats_report() const
    {
        return *stats_report_;
    }
...
using RTCStatsReportCallback = base::OnceCallback<void(std::unique_ptr<RTCStatsReportPlatform>)>;
...
class PLATFORM_EXPORT RTCStatsCollectorCallbackImpl : public webrtc::RTCStatsCollectorCallback {
public:
    void OnStatsDelivered(const rtc::scoped_refptr<const webrtc::RTCStatsReport>& report) override;

protected:
    RTCStatsCollectorCallbackImpl(scoped_refptr<base::SingleThreadTaskRunner> main_thread, RTCStatsReportCallback callback);
