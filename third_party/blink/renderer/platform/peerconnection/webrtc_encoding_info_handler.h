...
public:
    ...
    WebrtcEncodingInfoHandler& operator=(const WebrtcEncodingInfoHandler&) = delete;
    ~WebrtcEncodingInfoHandler();
    ...
    using OnMediaCapabilitiesEncodingInfoCallback = base::OnceCallback<void(bool, bool)>;
    void EncodingInfo(const std::optional<webrtc::SdpAudioFormat> sdp_audio_format, const std::optional<webrtc::SdpVideoFormat> sdp_video_format,
        const std::optional<String> video_scalability_mode, OnMediaCapabilitiesEncodingInfoCallback callback) const;
