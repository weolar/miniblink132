...
class ResolutionMonitorTestWithInvalidFrame : public ::testing::TestWithParam<media::VideoCodec> {
protected:
...
TEST_P(ResolutionMonitorTestWithInvalidFrame, ReturnNullOpt)
{
    ...
    auto invalid_buffer = media::DecoderBuffer::CopyFrom(base::as_byte_span(kInvalidData));
...
INSTANTIATE_TEST_SUITE_P(, ResolutionMonitorTestWithInvalidFrame, ::testing::ValuesIn(kCodecs));
...
class ResolutionMonitorTestWithValidFrame : public ::testing::TestWithParam<FrameData> { };
...
const FrameData kH264Frames[] = {
    ...
    { "bear-320x192-baseline-frame-0.h264", media::VideoCodec::kH264, gfx::Size(320, 192) },
...
const FrameData kAV1Frames[] = {
    ...
    { "av1-monochrome-I-frame-320x240-8bpp", media::VideoCodec::kAV1, gfx::Size(320, 240) },
};

INSTANTIATE_TEST_SUITE_P(H264, ResolutionMonitorTestWithValidFrame, ::testing::ValuesIn(kH264Frames));
INSTANTIATE_TEST_SUITE_P(VP8, ResolutionMonitorTestWithValidFrame, ::testing::ValuesIn(kVP8Frames));
INSTANTIATE_TEST_SUITE_P(VP9, ResolutionMonitorTestWithValidFrame, ::testing::ValuesIn(kVP9Frames));
INSTANTIATE_TEST_SUITE_P(AV1, ResolutionMonitorTestWithValidFrame, ::testing::ValuesIn(kAV1Frames));
...
class ResolutionMonitorTestWithValidVideo : public ::testing::TestWithParam<VideoData> { };
...
INSTANTIATE_TEST_SUITE_P(VP8, ResolutionMonitorTestWithValidVideo, ::testing::ValuesIn(kVP8Videos));
INSTANTIATE_TEST_SUITE_P(VP9, ResolutionMonitorTestWithValidVideo, ::testing::ValuesIn(kVP9Videos));
INSTANTIATE_TEST_SUITE_P(AV1, ResolutionMonitorTestWithValidVideo, ::testing::ValuesIn(kAV1Videos));
