...
public:
    ...
    virtual rtc::scoped_refptr<webrtc::DtlsTransportInterface> DtlsTransport() = 0;
    ...
    virtual void SetParameters(Vector<webrtc::RtpEncodingParameters>, std::optional<webrtc::DegradationPreference>, RTCVoidRequest*) = 0;
    virtual void GetStats(RTCStatsReportCallback) = 0;
    virtual void SetStreams(const Vector<String>& stream_ids) = 0;
    virtual RTCEncodedAudioStreamTransformer* GetEncodedAudioStreamTransformer() const
    {
        return nullptr;
    }
    virtual RTCEncodedVideoStreamTransformer* GetEncodedVideoStreamTransformer() const
    {
        return nullptr;
    }
};
