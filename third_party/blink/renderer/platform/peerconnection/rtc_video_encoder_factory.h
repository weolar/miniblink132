...
class PLATFORM_EXPORT RTCVideoEncoderFactory : public webrtc::VideoEncoderFactory {
public:
    ...
    void clear_disabled_profiles_for_testing()
    {
...
private:
    ...
    std::vector<media::VideoCodecProfile> disabled_profiles_ ALLOW_DISCOURAGED_TYPE("Matches webrtc API");
};
