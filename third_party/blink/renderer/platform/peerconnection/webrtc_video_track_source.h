...
public:
    ...
    WebRtcVideoTrackSource(bool is_screencast, std::optional<bool> needs_denoising, media::VideoCaptureFeedbackCB feedback_callback,
    ...
    void SetCustomFrameAdaptationParamsForTesting(const FrameAdaptationParams& params);
...
private:
    ...
    public:
        ...
        void ProcessMappedFrame(int64_t id, scoped_refptr<media::VideoFrame> mapped_frame);
        void Reset();
    ...
    void ComputeMetadataAndDeliverFrame(scoped_refptr<media::VideoFrame> frame, int64_t time_posted_us);
    ...
    // frame) version of it.
    void DeliverFrame(scoped_refptr<media::VideoFrame> frame, std::optional<gfx::Rect> update_rect, int64_t timestamp_us,
    ...
    std::optional<FrameAdaptationParams> custom_frame_adaptation_params_for_testing_;
