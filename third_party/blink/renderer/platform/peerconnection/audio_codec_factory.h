...
PLATFORM_EXPORT rtc::scoped_refptr<webrtc::AudioEncoderFactory> CreateWebrtcAudioEncoderFactory();

PLATFORM_EXPORT rtc::scoped_refptr<webrtc::AudioDecoderFactory> CreateWebrtcAudioDecoderFactory();
