...
using DetectLanguageCallback = base::OnceCallback<void(base::expected<WTF::Vector<LanguagePrediction>, DetectLanguageError>)>;
...
PLATFORM_EXPORT void DetectLanguage(const WTF::String& text, DetectLanguageCallback on_complete);
