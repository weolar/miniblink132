...
template <typename T> class DisallowNewWrapper final : public GarbageCollected<DisallowNewWrapper<T>> {
public:
    explicit DisallowNewWrapper(const T& value)
        : value_(value)
    {
    ...
    explicit DisallowNewWrapper(T&& value)
...
template <typename T> DisallowNewWrapper<T>* WrapDisallowNew(const T& value)
{
    return MakeGarbageCollected<DisallowNewWrapper<T>>(value);
}

template <typename T> DisallowNewWrapper<T>* WrapDisallowNew(T&& value)
{
