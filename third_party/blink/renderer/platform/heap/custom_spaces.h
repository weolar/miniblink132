...
class PLATFORM_EXPORT CompactableHeapVectorBackingSpace : public cppgc::CustomSpace<CompactableHeapVectorBackingSpace> {
public:
    static constexpr cppgc::CustomSpaceIndex kSpaceIndex = 0;
    static constexpr bool kSupportsCompaction = true;
};

class PLATFORM_EXPORT CompactableHeapHashTableBackingSpace : public cppgc::CustomSpace<CompactableHeapHashTableBackingSpace> {
public:
...
class PLATFORM_EXPORT LayoutObjectSpace : public cppgc::CustomSpace<LayoutObjectSpace> {
public:
