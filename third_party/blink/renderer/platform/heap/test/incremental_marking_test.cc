...
public:
    NonGarbageCollectedContainer(LinkedObject* obj, int y)
        : obj_(obj)
        , y_(y)
    {
    }
...
public:
    NonGarbageCollectedContainerRoot(LinkedObject* obj1, LinkedObject* obj2, int y)
        : next_(obj1, y)
        , obj_(obj2)
    {
    }
...
TEST_F(IncrementalMarkingTest, HeapVectorPushBackMember)
{
    ...
    HeapVector<Member<LinkedObject>>* vec = MakeGarbageCollected<HeapVector<Member<LinkedObject>>>();
...
{
    WeakPersistent<LinkedObject> obj = MakeGarbageCollected<LinkedObject>();
    HeapVector<NonGarbageCollectedContainer>* vec = MakeGarbageCollected<HeapVector<NonGarbageCollectedContainer>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
...
TEST_F(IncrementalMarkingTest, HeapVectorPushBackStdPair)
{
    ...
    HeapVector<std::pair<Member<LinkedObject>, Member<LinkedObject>>>* vec
        = MakeGarbageCollected<HeapVector<std::pair<Member<LinkedObject>, Member<LinkedObject>>>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    vec->push_back(std::make_pair(Member<LinkedObject>(obj1), Member<LinkedObject>(obj2)));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
    EXPECT_TRUE(obj2);
}
...
TEST_F(IncrementalMarkingTest, HeapVectorMoveNonGCedContainer)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    *MakeGarbageCollected<HeapVector<NonGarbageCollectedContainer>>() = std::move(*vec);
    driver.FinishGC();
    EXPECT_TRUE(obj);
}
...
TEST_F(IncrementalMarkingTest, HeapVectorEagerTracingStopsAtMember)
{
    ...
    obj1->set_next(obj3);
    HeapVector<NonGarbageCollectedContainerRoot>* vec = MakeGarbageCollected<HeapVector<NonGarbageCollectedContainerRoot>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
...
{
    WeakPersistent<LinkedObject> obj = MakeGarbageCollected<LinkedObject>();
    HeapDeque<Member<LinkedObject>>* deq = MakeGarbageCollected<HeapDeque<Member<LinkedObject>>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    deq->push_back(obj);
    driver.FinishGC();
...
TEST_F(IncrementalMarkingTest, HeapDequeSwapMember)
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    HeapDeque<Member<LinkedObject>>* deq1 = MakeGarbageCollected<HeapDeque<Member<LinkedObject>>>();
    deq1->push_back(obj1);
    HeapDeque<Member<LinkedObject>>* deq2 = MakeGarbageCollected<HeapDeque<Member<LinkedObject>>>();
    deq2->push_back(obj2);
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    std::swap(*deq1, *deq2);
...
template <typename Container> void Insert()
{
    WeakPersistent<LinkedObject> obj = MakeGarbageCollected<LinkedObject>();
...
template <typename Container> void Copy()
{
    WeakPersistent<LinkedObject> obj = MakeGarbageCollected<LinkedObject>();
...
template <typename Container> void Move()
{
    WeakPersistent<LinkedObject> obj = MakeGarbageCollected<LinkedObject>();
    Container* container1 = MakeGarbageCollected<Container>();
...
template <typename Container> void Swap()
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    Container* container1 = MakeGarbageCollected<Container>();
...
TEST_F(IncrementalMarkingTest, HeapHashCountedSetSwap)
{
    // HeapHashCountedSet is not move constructible so we cannot use std::swap.
    {
        WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
        WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
        HeapHashCountedSet<Member<LinkedObject>>* container1 = MakeGarbageCollected<HeapHashCountedSet<Member<LinkedObject>>>();
        container1->insert(obj1.Get());
        HeapHashCountedSet<Member<LinkedObject>>* container2 = MakeGarbageCollected<HeapHashCountedSet<Member<LinkedObject>>>();
        container2->insert(obj2.Get());
        IncrementalMarkingTestDriver driver(ThreadState::Current());
        driver.StartGC();
    ...
    }
    {
        WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
        WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
        HeapHashCountedSet<WeakMember<LinkedObject>>* container1 = MakeGarbageCollected<HeapHashCountedSet<WeakMember<LinkedObject>>>();
        container1->insert(obj1.Get());
        HeapHashCountedSet<WeakMember<LinkedObject>>* container2 = MakeGarbageCollected<HeapHashCountedSet<WeakMember<LinkedObject>>>();
        container2->insert(obj2.Get());
        IncrementalMarkingTestDriver driver(ThreadState::Current());
        driver.StartGC();
        container1->swap(*container2);
...
TEST_F(IncrementalMarkingTest, HeapHashMapInsertMember)
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>* map = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
...
TEST_F(IncrementalMarkingTest, HeapHashMapInsertWeakMember)
{
    ...
    HeapHashMap<WeakMember<LinkedObject>, WeakMember<LinkedObject>>* map
        = MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, WeakMember<LinkedObject>>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    map->insert(obj1.Get(), obj2.Get());
    driver.FinishGC();
...
TEST_F(IncrementalMarkingTest, HeapHashMapInsertMemberWeakMember)
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>* map = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    map->insert(obj1.Get(), obj2.Get());
    driver.FinishGC();
...
TEST_F(IncrementalMarkingTest, HeapHashMapInsertWeakMemberMember)
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>* map = MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>>();
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    map->insert(obj1.Get(), obj2.Get());
    driver.FinishGC();
...
TEST_F(IncrementalMarkingTest, HeapHashMapCopyMemberMember)
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>* map1 = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>>();
    map1->insert(obj1.Get(), obj2.Get());
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    EXPECT_TRUE(map1->Contains(obj1));
    HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>* map2 = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>>(*map1);
    EXPECT_TRUE(map1->Contains(obj1));
...
TEST_F(IncrementalMarkingTest, HeapHashMapCopyWeakMemberWeakMember)
{
    ...
    HeapHashMap<WeakMember<LinkedObject>, WeakMember<LinkedObject>>* map2
        = MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, WeakMember<LinkedObject>>>(*map1);
    EXPECT_TRUE(map1->Contains(obj1));
    EXPECT_TRUE(map2->Contains(obj1));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
...
TEST_F(IncrementalMarkingTest, HeapHashMapCopyMemberWeakMember)
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>* map1 = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>>();
    map1->insert(obj1.Get(), obj2.Get());
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    EXPECT_TRUE(map1->Contains(obj1));
    ...
    HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>* map2
        = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>>(*map1);
    EXPECT_TRUE(map1->Contains(obj1));
    EXPECT_TRUE(map2->Contains(obj1));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
...
TEST_F(IncrementalMarkingTest, HeapHashMapCopyWeakMemberMember)
{
    WeakPersistent<LinkedObject> obj1 = MakeGarbageCollected<LinkedObject>();
    WeakPersistent<LinkedObject> obj2 = MakeGarbageCollected<LinkedObject>();
    HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>* map1 = MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>>();
    map1->insert(obj1.Get(), obj2.Get());
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    EXPECT_TRUE(map1->Contains(obj1));
    ...
    HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>* map2
        = MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>>(*map1);
    EXPECT_TRUE(map1->Contains(obj1));
    EXPECT_TRUE(map2->Contains(obj1));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
...
TEST_F(IncrementalMarkingTest, HeapHashMapMoveMember)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>>(std::move(*map));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
    EXPECT_TRUE(obj2);
}
...
TEST_F(IncrementalMarkingTest, HeapHashMapMoveWeakMember)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, WeakMember<LinkedObject>>>(std::move(*map));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
    EXPECT_TRUE(obj2);
}
...
TEST_F(IncrementalMarkingTest, HeapHashMapMoveMemberWeakMember)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>>(std::move(*map));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
    EXPECT_TRUE(obj2);
}
...
TEST_F(IncrementalMarkingTest, HeapHashMapMoveWeakMemberMember)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>>(std::move(*map));
    driver.FinishGC();
    EXPECT_TRUE(obj1);
    EXPECT_TRUE(obj2);
}
...
TEST_F(IncrementalMarkingTest, HeapHashMapSwapMemberMember)
{
    ...
    HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>* map1 = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>>();
    map1->insert(obj1.Get(), obj2.Get());
    HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>* map2 = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, Member<LinkedObject>>>();
...
TEST_F(IncrementalMarkingTest, HeapHashMapSwapMemberWeakMember)
{
    ...
    HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>* map1 = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>>();
    map1->insert(obj1.Get(), obj2.Get());
    HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>* map2 = MakeGarbageCollected<HeapHashMap<Member<LinkedObject>, WeakMember<LinkedObject>>>();
    map2->insert(obj3.Get(), obj4.Get());
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    std::swap(*map1, *map2);
...
TEST_F(IncrementalMarkingTest, HeapHashMapSwapWeakMemberMember)
{
    ...
    HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>* map1 = MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>>();
    map1->insert(obj1.Get(), obj2.Get());
    HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>* map2 = MakeGarbageCollected<HeapHashMap<WeakMember<LinkedObject>, Member<LinkedObject>>>();
    map2->insert(obj3.Get(), obj4.Get());
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    std::swap(*map1, *map2);
...
public:
    ...
    void set_object(LinkedObject* object)
    {
        object_ = object;
    }
...
TEST_F(IncrementalMarkingTest, WeakMember)
{
    ...
    Persistent<ObjectWithWeakMember> persistent(MakeGarbageCollected<ObjectWithWeakMember>());
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    driver.TriggerMarkingSteps();
...
TEST_F(IncrementalMarkingTest, MemberSwap)
{
    ...
    // interleaving.
    driver.TriggerMarkingSteps();
    LinkedObject* object2 = MakeGarbageCollected<LinkedObject>(MakeGarbageCollected<LinkedObject>());
...
template <typename T> class ObjectHolder : public GarbageCollected<ObjectHolder<T>> {
public:
...
TEST_F(IncrementalMarkingTest, StepDuringObjectConstruction)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    MakeGarbageCollected<O>(WTF::BindOnce(
...
TEST_F(IncrementalMarkingTest, StepDuringMixinObjectConstruction)
{
    ...
    IncrementalMarkingTestDriver driver(ThreadState::Current());
    driver.StartGC();
    MakeGarbageCollected<Parent>(WTF::BindOnce(
                                     [](IncrementalMarkingTestDriver* driver, Holder* holder, Mixin* thiz) {
...
TEST_F(IncrementalMarkingTest, InPayloadWriteBarrierRegistersInvalidSlotForCompaction)
{
    // Regression test: https://crbug.com/918064
...
class LinkedHashSetWrapper final : public GarbageCollected<LinkedHashSetWrapper> {
public:
...
TEST_F(IncrementalMarkingTest, LinkedHashSetMovingCallback)
{
    ...
    Persistent<LinkedHashSetWrapper> wrapper = MakeGarbageCollected<LinkedHashSetWrapper>();
...
#define MAYBE_ConservativeGCOfWeakContainer DISABLED_ConservativeGCOfWeakContainer
#else
...
TEST_F(IncrementalMarkingTest, WriteBarrierOfWeakContainersStrongifiesBackingStore)
{
