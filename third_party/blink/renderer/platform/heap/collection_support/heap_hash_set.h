...
class HeapHashSet final : public GarbageCollected<HeapHashSet<ValueArg, TraitsArg>>, public HashSet<ValueArg, TraitsArg, HeapAllocator> {
    DISALLOW_NEW();
...
private:
    struct TypeConstraints {
        ...
        {
            static_assert(WTF::IsMemberOrWeakMemberType<ValueArg>::value, "HeapHashSet supports only Member and WeakMember.");
            static_assert(std::is_trivially_destructible_v<HeapHashSet>, "HeapHashSet must be trivially destructible.");
