...
class HeapLinkedHashSet final : public GarbageCollected<HeapLinkedHashSet<ValueArg, TraitsArg>>, public LinkedHashSet<ValueArg, TraitsArg, HeapAllocator> {
public:
...
private:
    struct TypeConstraints {
        ...
        {
            static_assert(WTF::IsMemberOrWeakMemberType<ValueArg>::value, "HeapLinkedHashSet supports only Member and WeakMember.");
            static_assert(std::is_trivially_destructible_v<HeapLinkedHashSet>, "HeapLinkedHashSet must be trivially destructible.");
