...
// };
// ```
template <typename T> using CrossThreadHandle = internal::BasicCrossThreadHandle<T, internal::StrongCrossThreadHandleWeaknessPolicy>;

// Utility function creating a `CrossThreadHandle` tracking the current source
// location position in debugging configurations.
template <typename T> CrossThreadHandle<T> MakeCrossThreadHandle(T* value, const CrossThreadHandleLocation& loc = CROSS_THREAD_HANDLE_LOCATION_FROM_HERE)
{
...
template <typename T> using CrossThreadWeakHandle = internal::BasicCrossThreadHandle<T, internal::WeakCrossThreadHandleWeaknessPolicy>;
...
template <typename T>
CrossThreadWeakHandle<T> MakeCrossThreadWeakHandle(T* value, const CrossThreadHandleLocation& loc = CROSS_THREAD_HANDLE_LOCATION_FROM_HERE)
{
...
template <typename T> using UnwrappingCrossThreadHandle = internal::BasicUnwrappingCrossThreadHandle<T, internal::StrongCrossThreadHandleWeaknessPolicy>;

// Utility function creating an `UnwrappingCrossThreadHandle`.
template <typename T>
UnwrappingCrossThreadHandle<T> MakeUnwrappingCrossThreadHandle(T* value, const CrossThreadHandleLocation& loc = CROSS_THREAD_HANDLE_LOCATION_FROM_HERE)
{
    return UnwrappingCrossThreadHandle<T>(value, loc);
}

// Utility function creating an `UnwrappingCrossThreadHandle`.
template <typename T> UnwrappingCrossThreadHandle<T> MakeUnwrappingCrossThreadHandle(const CrossThreadHandle<T>& handle)
{
    return UnwrappingCrossThreadHandle<T>(handle);
}

// Utility function creating an `UnwrappingCrossThreadHandle`.
template <typename T> UnwrappingCrossThreadHandle<T> MakeUnwrappingCrossThreadHandle(CrossThreadHandle<T>&& handle)
{
...
// instance methods of a type.
template <typename T> using UnwrappingCrossThreadWeakHandle = internal::BasicUnwrappingCrossThreadHandle<T, internal::WeakCrossThreadHandleWeaknessPolicy>;

// Utility function creating an `UnwrappingCrossThreadHandle`.
template <typename T>
UnwrappingCrossThreadWeakHandle<T> MakeUnwrappingCrossThreadWeakHandle(T* value, const CrossThreadHandleLocation& loc = CROSS_THREAD_HANDLE_LOCATION_FROM_HERE)
{
    return UnwrappingCrossThreadWeakHandle<T>(value, loc);
}

// Utility function creating an `UnwrappingCrossThreadHandle`.
template <typename T> UnwrappingCrossThreadWeakHandle<T> MakeUnwrappingCrossThreadWeakHandle(const CrossThreadWeakHandle<T>& handle)
{
...
template <typename T> UnwrappingCrossThreadWeakHandle<T> MakeUnwrappingCrossThreadWeakHandle(CrossThreadWeakHandle<T>&& handle)
{
