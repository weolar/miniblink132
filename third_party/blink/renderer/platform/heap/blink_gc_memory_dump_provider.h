...
public:
    ...
    BlinkGCMemoryDumpProvider(ThreadState*, scoped_refptr<base::SingleThreadTaskRunner>, HeapType);

    // MemoryDumpProvider implementation.
    bool OnMemoryDump(const base::trace_event::MemoryDumpArgs&, base::trace_event::ProcessMemoryDump*) final;
