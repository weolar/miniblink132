...
#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || (BUILDFLAG(IS_LINUX) && !BUILDFLAG(IS_CASTOS))
...
{
    return std::make_unique<BMPImageDecoder>(ImageDecoder::kAlphaNotPremultiplied, ColorBehavior::kTransformToSRGB, ImageDecoder::kNoDecodedImageByteLimit);
}
...
{
    static constexpr char kBmpFile[] = "/images/resources/1xint32_min.bmp"; // 0xINT32_MIN
    scoped_refptr<SharedBuffer> data = ReadFileToSharedBuffer(kBmpFile);
    std::unique_ptr<ImageDecoder> decoder = CreateBMPDecoder();
...
{
    static constexpr char kBmpFile[] = "/images/resources/invalid-bitmap-offset.bmp";
    scoped_refptr<SharedBuffer> data = ReadFileToSharedBuffer(kBmpFile);
    ASSERT_TRUE(data.get());
...
TEST_P(BMPImageDecoderTest, VerifyBMPSuiteImage)
{
    ...
    std::string bmp_path = base::StringPrintf("/images/bmp-suite/%s/%s.bmp", entry_dir.c_str(), entry_bmp.c_str());
    ...
    // counts as a pass.
    raw_ptr<ui::test::SkiaGoldPixelDiff> skia_gold = ui::test::SkiaGoldPixelDiff::GetSession();
    ...
    std::string golden_name = ui::test::SkiaGoldPixelDiff::GetGoldenImageName(
        "BMPImageDecoderTest", "VerifyBMPSuite", base::StringPrintf("%s_%s.rev0", entry_dir.c_str(), entry_bmp.c_str()));
    EXPECT_TRUE(skia_gold->CompareScreenshot(golden_name, *result_image, &positive_if_exact_image_only)) << bmp_path;
#endif
}

INSTANTIATE_TEST_SUITE_P(BMPSuite, BMPImageDecoderTest,
    testing::Values(BMPSuiteEntry { "good", "pal1" }, BMPSuiteEntry { "good", "pal1wb" }, BMPSuiteEntry { "good", "pal1bg" }, BMPSuiteEntry { "good", "pal4" },
        BMPSuiteEntry { "good", "pal4gs" }, BMPSuiteEntry { "good", "pal4rle" }, BMPSuiteEntry { "good", "pal8" }, BMPSuiteEntry { "good", "pal8-0" },
        BMPSuiteEntry { "good", "pal8gs" }, BMPSuiteEntry { "good", "pal8rle" }, BMPSuiteEntry { "good", "pal8w126" }, BMPSuiteEntry { "good", "pal8w125" },
        BMPSuiteEntry { "good", "pal8w124" }, BMPSuiteEntry { "good", "pal8topdown" }, BMPSuiteEntry { "good", "pal8nonsquare" },
        BMPSuiteEntry { "good", "pal8os2" }, BMPSuiteEntry { "good", "pal8v4" }, BMPSuiteEntry { "good", "pal8v5" }, BMPSuiteEntry { "good", "rgb16" },
        BMPSuiteEntry { "good", "rgb16bfdef" }, BMPSuiteEntry { "good", "rgb16-565" }, BMPSuiteEntry { "good", "rgb16-565pal" },
        BMPSuiteEntry { "good", "rgb24" }, BMPSuiteEntry { "good", "rgb24pal" }, BMPSuiteEntry { "good", "rgb32" }, BMPSuiteEntry { "good", "rgb32bfdef" },
        BMPSuiteEntry { "good", "rgb32bf" },

        BMPSuiteEntry { "questionable", "pal1p1" }, BMPSuiteEntry { "questionable", "pal2" }, BMPSuiteEntry { "questionable", "pal2color" },
        BMPSuiteEntry { "questionable", "pal4rletrns" }, BMPSuiteEntry { "questionable", "pal4rlecut" }, BMPSuiteEntry { "questionable", "pal8rletrns" },
        BMPSuiteEntry { "questionable", "pal8rlecut" }, BMPSuiteEntry { "questionable", "pal8offs" }, BMPSuiteEntry { "questionable", "pal8oversizepal" },
        BMPSuiteEntry { "questionable", "pal8os2-sz" }, BMPSuiteEntry { "questionable", "pal8os2-hs" }, BMPSuiteEntry { "questionable", "pal8os2sp" },
        BMPSuiteEntry { "questionable", "pal8os2v2" }, BMPSuiteEntry { "questionable", "pal8os2v2-16" }, BMPSuiteEntry { "questionable", "pal8os2v2-sz" },
        BMPSuiteEntry { "questionable", "pal8os2v2-40sz" }, BMPSuiteEntry { "questionable", "rgb24rle24" },
        BMPSuiteEntry { "questionable", "pal1huffmsb" }, // Unsupported encoding.
        BMPSuiteEntry { "questionable", "rgb16faketrns" }, BMPSuiteEntry { "questionable", "rgb16-231" }, BMPSuiteEntry { "questionable", "rgb16-3103" },
        BMPSuiteEntry { "questionable", "rgba16-4444" }, BMPSuiteEntry { "questionable", "rgba16-5551" }, BMPSuiteEntry { "questionable", "rgba16-1924" },
        ...
        BMPSuiteEntry { "questionable", "rgb24jpeg" }, BMPSuiteEntry { "questionable", "rgb24png" }, BMPSuiteEntry { "questionable", "rgb32h52" },
        BMPSuiteEntry { "questionable", "rgb32-xbgr" }, BMPSuiteEntry { "questionable", "rgb32fakealpha" }, BMPSuiteEntry { "questionable", "rgb32-111110" },
        BMPSuiteEntry { "questionable", "rgb32-7187" }, BMPSuiteEntry { "questionable", "rgba32-1" }, BMPSuiteEntry { "questionable", "rgba32-1010102" },
        BMPSuiteEntry { "questionable", "rgba32-81284" }, BMPSuiteEntry { "questionable", "rgba32-61754" }, BMPSuiteEntry { "questionable", "rgba32abf" },
        ...
        BMPSuiteEntry { "bad", "badbitcount" }, BMPSuiteEntry { "bad", "badbitssize" }, BMPSuiteEntry { "bad", "baddens1" },
        BMPSuiteEntry { "bad", "baddens2" }, BMPSuiteEntry { "bad", "badfilesize" }, BMPSuiteEntry { "bad", "badheadersize" },
        BMPSuiteEntry { "bad", "badpalettesize" }, BMPSuiteEntry { "bad", "badplanes" }, BMPSuiteEntry { "bad", "badrle" }, BMPSuiteEntry { "bad", "badrle4" },
        BMPSuiteEntry { "bad", "badrle4bis" }, BMPSuiteEntry { "bad", "badrle4ter" }, BMPSuiteEntry { "bad", "badrlebis" },
        BMPSuiteEntry { "bad", "badrleter" }, BMPSuiteEntry { "bad", "badwidth" }, BMPSuiteEntry { "bad", "pal8badindex" },
        BMPSuiteEntry { "bad", "reallybig" }, BMPSuiteEntry { "bad", "rgb16-880" }, BMPSuiteEntry { "bad", "rletopdown" },
        BMPSuiteEntry { "bad", "shortfile" }));

class BMPImageDecoderCorpusTest : public ImageDecoderBaseTest {
public:
    BMPImageDecoderCorpusTest()
        : ImageDecoderBaseTest("bmp")
    {
    }
...
protected:
    ...
    {
        return std::make_unique<BMPImageDecoder>(ImageDecoder::kAlphaPremultiplied, ColorBehavior::kTransformToSRGB, ImageDecoder::kNoDecodedImageByteLimit);
    }
