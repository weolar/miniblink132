...
public:
    ...
    static scoped_refptr<SegmentReader> CreateFromSharedBuffer(scoped_refptr<const SharedBuffer>);
    ...
    static scoped_refptr<SegmentReader> CreateFromROBuffer(scoped_refptr<ROBuffer>);
    ...
    static sk_sp<SkData> RWBufferCopyAsSkData(RWBuffer::ROIter iter, size_t available);
    static base::span<const uint8_t> RWBufferGetSomeData(RWBuffer::ROIter& iter, size_t& position_of_block, size_t position);
