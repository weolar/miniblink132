...
class PLATFORM_EXPORT SkiaPngRustImageDecoder final : public SkiaImageDecoderBase {
public:
    SkiaPngRustImageDecoder(AlphaOption, ColorBehavior, wtf_size_t max_decoded_bytes, wtf_size_t offset);
...
protected:
    ...
    std::unique_ptr<SkCodec> OnCreateSkCodec(std::unique_ptr<SkStream>, SkCodec::Result* result) override;
};
