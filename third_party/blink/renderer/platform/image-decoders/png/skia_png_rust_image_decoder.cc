...
SkiaPngRustImageDecoder::SkiaPngRustImageDecoder(AlphaOption alpha_option, ColorBehavior color_behavior, wtf_size_t max_decoded_bytes, wtf_size_t offset)
    : SkiaImageDecoderBase(alpha_option, color_behavior, max_decoded_bytes, offset)
{
}
...
std::unique_ptr<SkCodec> SkiaPngRustImageDecoder::OnCreateSkCodec(std::unique_ptr<SkStream> stream, SkCodec::Result* result)
{
