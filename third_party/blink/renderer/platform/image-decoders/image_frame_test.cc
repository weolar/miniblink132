...
public:
    void SetUp() override
    {
        ...
        skcms_Transform(
            &src_8888, pixel_format_n32, skcms_AlphaFormat_Unpremul, nullptr, &src_f16, skcms_PixelFormat_RGBA_hhhh, skcms_AlphaFormat_Unpremul, nullptr, 1);
        skcms_Transform(
            &dst_8888, pixel_format_n32, skcms_AlphaFormat_Unpremul, nullptr, &dst_f16, skcms_PixelFormat_RGBA_hhhh, skcms_AlphaFormat_Unpremul, nullptr, 1);
    }
...
protected:
    ...
    {
        skcms_Transform(&src, pixel_format_n32, skcms_AlphaFormat_Unpremul, nullptr, dst, skcms_PixelFormat_RGBA_ffff, skcms_AlphaFormat_Unpremul, nullptr, 1);
    }

    void ConvertF16ToF32(float* dst, ImageFrame::PixelDataF16 src)
    {
        skcms_Transform(
            &src, skcms_PixelFormat_RGBA_hhhh, skcms_AlphaFormat_Unpremul, nullptr, dst, skcms_PixelFormat_RGBA_ffff, skcms_AlphaFormat_Unpremul, nullptr, 1);
    }
};
...
TEST_F(ImageFrameTest, BlendRGBARawF16Buffer)
{
    ...
    ImageFrame::BlendRGBARaw(&blended_8888, src_8888_r, src_8888_g, src_8888_b, src_8888_a);
    ...
    for (int i = 0; i < 4; i++) {
        ASSERT_TRUE(fabs(f32_from_blended_8888[i] - f32_from_blended_f16[i]) < color_compoenent_tolerance);
    }
}
...
{
    ImageFrame::PixelData blended_8888(dst_8888);
    ImageFrame::BlendRGBAPremultiplied(&blended_8888, src_8888_r, src_8888_g, src_8888_b, src_8888_a);
