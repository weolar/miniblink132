...
public:
    CrabbyAVIFImageDecoder(AlphaOption, HighBitDepthDecodingOption, ColorBehavior, cc::AuxImage, wtf_size_t max_decoded_bytes, AnimationOption);
...
private:
    ...
    static crabbyavif::avifResult ReadFromSegmentReader(crabbyavif::avifIO* io, uint32_t read_flags, uint64_t offset, size_t size, crabbyavif::avifROData* out);
    ...
    // data.
    bool RenderImage(const crabbyavif::avifImage* image, int from_row, int* to_row, ImageFrame* buffer);
    ...
    crabbyavif::avifPixelFormat avif_yuv_format_ = crabbyavif::AVIF_PIXEL_FORMAT_NONE;
    ...
    std::unique_ptr<crabbyavif::avifImage, decltype(&crabbyavif::crabby_avifImageDestroy)> cropped_image_ { nullptr, crabbyavif::crabby_avifImageDestroy };
    ...
    // aperture) property.
    raw_ptr<const crabbyavif::avifImage, DanglingUntriaged> decoded_image_ = nullptr;
    ...
    std::unique_ptr<crabbyavif::avifDecoder, decltype(&crabbyavif::crabby_avifDecoderDestroy)> decoder_ { nullptr, crabbyavif::crabby_avifDecoderDestroy };
