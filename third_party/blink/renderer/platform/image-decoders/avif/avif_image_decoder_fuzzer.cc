...
std::unique_ptr<ImageDecoder> CreateAVIFDecoder()
{
    ...
    // fuzzer input.
    return std::make_unique<AVIFImageDecoder>(ImageDecoder::kAlphaPremultiplied, ImageDecoder::kDefaultBitDepth, ColorBehavior::kTransformToSRGB,
        cc::AuxImage::kDefault, ImageDecoder::kNoDecodedImageByteLimit, ImageDecoder::AnimationOption::kPreferAnimation);
}
