    ...
    gfx::Point3F* rgb_pixel = nullptr)
{
    ...
    auto transform = gfx::ColorTransform::NewColorTransform(
        reinterpret_cast<CrabbyAVIFImageDecoder*>(decoder.get())->GetColorSpaceForTesting(), gfx::ColorSpace(), options);
...
INSTANTIATE_TEST_SUITE_P(AnimatedAVIF, CrabbyAVIFValidImagesTest, ::testing::ValuesIn(kAnimatedTestParams));

INSTANTIATE_TEST_SUITE_P(StaticAVIF, CrabbyAVIFValidImagesTest, ::testing::ValuesIn(kStaticTestParams));
...
using CrabbyStaticAVIFColorTests = ::testing::TestWithParam<StaticColorCheckParam>;

INSTANTIATE_TEST_SUITE_P(Parameterized, CrabbyStaticAVIFColorTests, ::testing::ValuesIn(kTestParams));
