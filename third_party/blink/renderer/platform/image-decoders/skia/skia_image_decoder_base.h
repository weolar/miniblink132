...
public:
    ...
    SkiaImageDecoderBase(AlphaOption, ColorBehavior, wtf_size_t max_decoded_bytes, wtf_size_t reading_offset = kNoReadingOffset);
...
protected:
    ...
    virtual std::unique_ptr<SkCodec> OnCreateSkCodec(std::unique_ptr<SkStream>, SkCodec::Result* result) = 0;
