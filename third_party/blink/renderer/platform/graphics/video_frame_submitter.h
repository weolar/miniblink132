...
class PLATFORM_EXPORT VideoFrameSubmitter : public WebVideoFrameSubmitter,
                                            public viz::ContextLostObserver,
                                            public viz::SharedBitmapReporter,
                                            public gpu::GpuChannelLostObserver,
                                            public viz::mojom::blink::CompositorFrameSinkClient {
public:
    VideoFrameSubmitter(WebContextProviderCallback, cc::VideoPlaybackRoughnessReporter::ReportingCallback, std::unique_ptr<VideoFrameResourceProvider>);
    ...
    void OnBeginFrame(const viz::BeginFrameArgs&, const WTF::HashMap<uint32_t, viz::FrameTimingDetails>&, bool frame_ack,
    ...
    void DidAllocateSharedBitmap(base::ReadOnlySharedMemoryRegion, const viz::SharedBitmapId&) override;
...
private:
    ...
    // should be requested.
    bool MaybeAcceptContextProvider(scoped_refptr<viz::RasterContextProvider> context_provider);
    ...
    raw_ptr<viz::mojom::blink::CompositorFrameSink> compositor_frame_sink_ = nullptr;
