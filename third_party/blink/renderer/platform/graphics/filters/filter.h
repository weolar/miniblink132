...
public:
    ...
    Filter(const gfx::RectF& reference_box, const gfx::RectF& filter_region, float scale, UnitScaling);
    ...
    const gfx::RectF& FilterRegion() const
    {
        return filter_region_;
    }
    ...
    SourceGraphic* GetSourceGraphic() const
    {
        return source_graphic_.Get();
    }
