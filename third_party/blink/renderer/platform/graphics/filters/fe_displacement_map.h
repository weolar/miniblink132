...
enum ChannelSelectorType { CHANNEL_UNKNOWN = 0, CHANNEL_R = 1, CHANNEL_G = 2, CHANNEL_B = 3, CHANNEL_A = 4 };

class PLATFORM_EXPORT FEDisplacementMap final : public FilterEffect {
public:
    FEDisplacementMap(Filter*, ChannelSelectorType x_channel_selector, ChannelSelectorType y_channel_selector, float);
