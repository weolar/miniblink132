...
public:
    enum EdgeModeType { EDGEMODE_UNKNOWN = 0, EDGEMODE_DUPLICATE = 1, EDGEMODE_WRAP = 2, EDGEMODE_NONE = 3 };

    FEConvolveMatrix(Filter*, const gfx::Size&, float, float, const gfx::Vector2d&, FEConvolveMatrix::EdgeModeType, bool, const Vector<float>&);
