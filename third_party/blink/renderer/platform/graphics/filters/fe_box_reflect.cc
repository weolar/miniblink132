...
StringBuilder& FEBoxReflect::ExternalRepresentation(StringBuilder& ts, wtf_size_t indent) const
{
...
{
    return paint_filter_builder::BuildBoxReflectFilter(reflection_, paint_filter_builder::Build(InputEffect(0), OperatingInterpolationSpace()));
}
