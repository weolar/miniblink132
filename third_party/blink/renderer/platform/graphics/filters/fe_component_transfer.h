...
struct ComponentTransferFunction {
    ...
    bool operator==(const ComponentTransferFunction& o) const
    {
        ...
        case FECOMPONENTTRANSFER_TYPE_GAMMA:
            return (amplitude == o.amplitude && exponent == o.exponent && offset == o.offset);
...
public:
    FEComponentTransfer(Filter*, const ComponentTransferFunction& red_func, const ComponentTransferFunction& green_func,
        const ComponentTransferFunction& blue_func, const ComponentTransferFunction& alpha_func);

    StringBuilder& ExternalRepresentation(StringBuilder&, wtf_size_t indent) const override;
...
private:
    ...
    void GetValues(ComponentTransferLutType r_values, ComponentTransferLutType g_values, ComponentTransferLutType b_values, ComponentTransferLutType a_values);
