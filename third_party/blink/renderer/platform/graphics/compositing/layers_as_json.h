...
public:
    ...
    void AddLayer(const cc::Layer& layer, const TransformPaintPropertyNode& transform, const ContentLayerClientImpl* content_layer_client);
...
PLATFORM_EXPORT std::unique_ptr<JSONObject> CCLayerAsJSON(const cc::Layer& layer, LayerTreeFlags flags);
