...
class PLATFORM_EXPORT ContentLayerClientImpl : public GarbageCollected<ContentLayerClientImpl>,
...
public:
    ...
    {
        visitor->Trace(raster_invalidator_);
    }
    ...
    // For LayersAsJSON.
    void AppendAdditionalInfoAsJSON(LayerTreeFlags, const cc::Layer&, JSONObject&) const;

    cc::Layer& Layer() const
    {
        return *cc_picture_layer_.get();
    }
    ...
    RasterInvalidator& GetRasterInvalidator()
    {
