...
public:
    static std::unique_ptr<PlatformPaintWorkletLayerPainter> CreateCompositorThreadPainter(base::WeakPtr<PaintWorkletPaintDispatcher>* paintee);

    PaintWorkletPaintDispatcher();
    PaintWorkletPaintDispatcher(const PaintWorkletPaintDispatcher&) = delete;
    PaintWorkletPaintDispatcher& operator=(const PaintWorkletPaintDispatcher&) = delete;
    ...
    void DispatchWorklets(cc::PaintWorkletJobMap, PlatformPaintWorkletLayerPainter::DoneCallback);
    ...
    void RegisterPaintWorkletPainter(PaintWorkletPainter*, scoped_refptr<base::SingleThreadTaskRunner>);
    ...
    using PaintWorkletPainterToTaskRunnerMap
        = HashMap<PaintWorkletId, std::pair<CrossThreadPersistent<PaintWorkletPainter>, scoped_refptr<base::SingleThreadTaskRunner>>>;
