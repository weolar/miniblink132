...
{
    const gfx::ColorSpace& color_space = screen_info.display_color_spaces.GetScreenInfoColorSpace();
...
ColorSpaceGamut GetColorSpaceGamut(const skcms_ICCProfile* color_profile)
{
    ...
    bool color_conversion_successful = skcms_Transform(in.data(), skcms_PixelFormat_RGB_888, skcms_AlphaFormat_Unpremul, color_profile, out.data(),
        skcms_PixelFormat_RGB_fff, skcms_AlphaFormat_Unpremul, &sc_rgb, 3);
