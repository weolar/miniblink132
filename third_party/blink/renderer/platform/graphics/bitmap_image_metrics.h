...
public:
    ...
    static void CountDecodedImageType(const WTF::String& type, UseCounter* use_counter);
    ...
    // size are reported.
    static void CountDecodedImageDensity(const WTF::String& type, int image_min_side, uint64_t density_centi_bpp, size_t image_size_bytes);
};
