...
public:
    ...
    virtual scoped_refptr<base::SingleThreadTaskRunner> GetCompositorTaskRunner() = 0;
    virtual ~BeginFrameProviderClient() = default;
};

class PLATFORM_EXPORT BeginFrameProvider : public GarbageCollected<BeginFrameProvider>,
                                           public viz::mojom::blink::CompositorFrameSinkClient,
                                           public mojom::blink::EmbeddedFrameSinkClient {
public:
    BeginFrameProvider(const BeginFrameProviderParams& begin_frame_provider_params, BeginFrameProviderClient* client, ContextLifecycleNotifier* context);
    ...
    void BindSurfaceEmbedder(mojo::PendingReceiver<mojom::blink::SurfaceEmbedder> receiver) override
    {
        NOTIMPLEMENTED();
    }
...
private:
    ...
    HeapMojoReceiver<viz::mojom::blink::CompositorFrameSinkClient, BeginFrameProvider> cfs_receiver_;

    HeapMojoReceiver<mojom::blink::EmbeddedFrameSinkClient, BeginFrameProvider> efs_receiver_;
