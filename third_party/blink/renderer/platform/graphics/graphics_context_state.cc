...
static inline cc::PaintFlags::FilterQuality FilterQualityForPaint(InterpolationQuality quality)
{
    ...
    return quality != kInterpolationNone ? cc::PaintFlags::FilterQuality::kLow : cc::PaintFlags::FilterQuality::kNone;
}
