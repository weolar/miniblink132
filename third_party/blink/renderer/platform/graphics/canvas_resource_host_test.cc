...
TEST(CanvasResourceHostTest, ReleaseLostTransferableResource)
{
    ...
    ScopedTestingPlatformSupport<AcceleratedCompositingTestPlatform> accelerated_compositing_scope;
    ...
    EXPECT_TRUE(host->PrepareTransferableResource(nullptr, &resource, &release_callback));
