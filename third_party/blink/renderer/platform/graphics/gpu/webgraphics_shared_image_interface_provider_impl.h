...
class WebGraphicsSharedImageInterfaceProviderImpl : public WebGraphicsSharedImageInterfaceProvider, public gpu::GpuChannelLostObserver {
public:
    explicit WebGraphicsSharedImageInterfaceProviderImpl(scoped_refptr<gpu::ClientSharedImageInterface> shared_image_interface);

    WebGraphicsSharedImageInterfaceProviderImpl(const WebGraphicsSharedImageInterfaceProviderImpl&) = delete;
    WebGraphicsSharedImageInterfaceProviderImpl& operator=(const WebGraphicsSharedImageInterfaceProviderImpl&) = delete;
    ...
    base::WeakPtr<blink::WebGraphicsSharedImageInterfaceProvider> GetWeakPtr() override;
...
private:
    ...
    base::WeakPtrFactory<WebGraphicsSharedImageInterfaceProviderImpl> weak_ptr_factory_ { this };
};
