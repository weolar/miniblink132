...
class PLATFORM_EXPORT XRWebGLDrawingBuffer : public RefCounted<XRWebGLDrawingBuffer> {
public:
    static scoped_refptr<XRWebGLDrawingBuffer> Create(DrawingBuffer*, GLuint framebuffer, const gfx::Size&, bool want_alpha_channel, bool want_depth_buffer,
        bool want_stencil_buffer, bool want_antialiasing);
    ...
    void UseSharedBuffer(const scoped_refptr<gpu::ClientSharedImage>& buffer_shared_image, const gpu::SyncToken& buffer_sync_token);
...
private:
    struct PLATFORM_EXPORT ColorBuffer : public ThreadSafeRefCounted<ColorBuffer> {
        ColorBuffer(base::WeakPtr<XRWebGLDrawingBuffer>, const gfx::Size&, scoped_refptr<gpu::ClientSharedImage> shared_image, GLuint texture_id);
    ...
    XRWebGLDrawingBuffer(
        DrawingBuffer*, GLuint framebuffer, bool discard_framebuffer_supported, bool want_alpha_channel, bool want_depth_buffer, bool want_stencil_buffer);
    ...
    static void NotifyMailboxReleased(scoped_refptr<ColorBuffer>, const gpu::SyncToken&, bool lost_resource);
