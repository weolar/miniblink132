...
void WebGPURecyclableResourceCacheTest::SetUp()
{
    ...
    recyclable_resource_cache_
        = std::make_unique<WebGPURecyclableResourceCache>(SharedGpuContext::ContextProviderWrapper(), scheduler::GetSingleThreadTaskRunnerForTesting());
}
...
{
    SkImageInfo kInfo = SkImageInfo::Make(10, 10, kRGBA_8888_SkColorType, kPremul_SkAlphaType);
    Vector<CanvasResourceProvider*> returned_resource_providers;

    std::unique_ptr<RecyclableCanvasResource> provider_holder_0 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfo);
    returned_resource_providers.push_back(provider_holder_0->resource_provider());

    std::unique_ptr<RecyclableCanvasResource> provider_holder_1 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfo);
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_2 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfo);
...
TEST_F(WebGPURecyclableResourceCacheTest, DifferentSize)
{
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_0 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[0]);
    returned_resource_providers.push_back(provider_holder_0->resource_provider());

    std::unique_ptr<RecyclableCanvasResource> provider_holder_1 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[1]);
    returned_resource_providers.push_back(provider_holder_1->resource_provider());
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_2 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[0]);
    returned_resource_providers.push_back(provider_holder_2->resource_provider());

    std::unique_ptr<RecyclableCanvasResource> provider_holder_3 = recyclable_resource_cache_->GetOrCreateCanvasResource(kInfos[1]);
...
TEST_F(WebGPURecyclableResourceCacheTest, CacheMissHit)
{
    ...
    const auto info_0 = SkImageInfo::Make(10, 10, kRGBA_8888_SkColorType, kPremul_SkAlphaType);
    std::unique_ptr<RecyclableCanvasResource> provider_holder_0 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_0);
    returned_resource_providers.push_back(provider_holder_0->resource_provider());
    ...
    const auto info_1 = SkImageInfo::Make(20, 20, kRGBA_8888_SkColorType, kPremul_SkAlphaType);
    std::unique_ptr<RecyclableCanvasResource> provider_holder_1 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_1);
    returned_resource_providers.push_back(provider_holder_1->resource_provider());
    ...
    const SkImageInfo info_2 = SkImageInfo::Make(10, 10, kRGBA_8888_SkColorType, kPremul_SkAlphaType, SkColorSpace::MakeSRGBLinear());
    std::unique_ptr<RecyclableCanvasResource> provider_holder_2 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_2);
    returned_resource_providers.push_back(provider_holder_2->resource_provider());
    ...
    const SkImageInfo info_3 = SkImageInfo::Make(10, 10, kRGBA_F16_SkColorType, kPremul_SkAlphaType);
    std::unique_ptr<RecyclableCanvasResource> provider_holder_3 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_3);
    returned_resource_providers.push_back(provider_holder_3->resource_provider());
    ...
    const auto info_4 = SkImageInfo::Make(10, 10, kRGBA_8888_SkColorType, kOpaque_SkAlphaType);
    std::unique_ptr<RecyclableCanvasResource> provider_holder_4 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_4);
    ...
    std::unique_ptr<RecyclableCanvasResource> provider_holder_5 = recyclable_resource_cache_->GetOrCreateCanvasResource(info_0);
...
TEST_F(WebGPURecyclableResourceCacheTest, StaleResourcesCleanUp)
{
    ...
    int wait_count = recyclable_resource_cache_->GetWaitCountBeforeDeletionForTesting();
    ...
    for (int i = 0; i < wait_count; i++) {
        wtf_size_t size = recyclable_resource_cache_->CleanUpResourcesAndReturnSizeForTesting();
        EXPECT_EQ(2u, size);
    }

    // After the intended delay, all stale resources should be released now.
    wtf_size_t size_after = recyclable_resource_cache_->CleanUpResourcesAndReturnSizeForTesting();
