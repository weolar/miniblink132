...
class PLATFORM_EXPORT WebGPUTextureAlphaClearer final : public WTF::RefCounted<WebGPUTextureAlphaClearer> {
public:
    WebGPUTextureAlphaClearer(scoped_refptr<DawnControlClientHolder> dawn_control_client, const wgpu::Device& device, wgpu::TextureFormat format);

    bool IsCompatible(const wgpu::Device& device, wgpu::TextureFormat format) const;
