...
class PLATFORM_EXPORT CompositorMutatorClient : public cc::LayerTreeMutator, public MutatorClient {
public:
    explicit CompositorMutatorClient(std::unique_ptr<AnimationWorkletMutatorDispatcherImpl>);
    ...
    bool Mutate(std::unique_ptr<cc::MutatorInputState>, MutateQueuingStrategy, DoneCallback) override;
