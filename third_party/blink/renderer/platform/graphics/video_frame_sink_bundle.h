...
// VideoFrameSubmitter.
class PLATFORM_EXPORT VideoFrameSinkBundle : public viz::mojom::blink::FrameSinkBundleClient {
public:
    ...
    static void SetFrameSinkProviderForTesting(mojom::blink::EmbeddedFrameSinkProvider* provider);
    ...
    const viz::FrameSinkBundleId& bundle_id() const
    {
        return id_;
    }
    ...
    base::WeakPtr<VideoFrameSinkBundle> AddClient(const viz::FrameSinkId& frame_sink_id, viz::mojom::blink::CompositorFrameSinkClient* client,
    ...
    void InitializeCompositorFrameSinkType(uint32_t sink_id, viz::mojom::blink::CompositorFrameSinkType);
    void SetNeedsBeginFrame(uint32_t sink_id, bool needs_begin_frame);
    void SetWantsBeginFrameAcks(uint32_t sink_id);
    void SubmitCompositorFrame(uint32_t sink_id, const viz::LocalSurfaceId& local_surface_id, viz::CompositorFrame frame,
    ...
    void DidAllocateSharedBitmap(uint32_t sink_id, base::ReadOnlySharedMemoryRegion region, const viz::SharedBitmapId& id);
    ...
    void FlushNotifications(WTF::Vector<viz::mojom::blink::BundledReturnedResourcesPtr> acks, WTF::Vector<viz::mojom::blink::BeginFrameInfoPtr> begin_frames,
        WTF::Vector<viz::mojom::blink::BundledReturnedResourcesPtr> reclaimed_resources) override;
...
private:
    ...
    WTF::HashMap<uint32_t, viz::mojom::blink::CompositorFrameSinkClient*> clients_;
