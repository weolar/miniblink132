...
public:
    explicit FakeWebGraphicsContext3DProvider(gpu::gles2::GLES2Interface* gl, cc::ImageDecodeCache* cache = nullptr, GrDirectContext* gr_context = nullptr,
        ...
        , raster_context_provider_(raster_context_provider)
    {
        ...
        if (!raster_context_provider_) {
            ...
            raster_interface_ = std::make_unique<gpu::raster::RasterImplementationGLES>(gl_, nullptr, capabilities_);
    ...
    explicit FakeWebGraphicsContext3DProvider(
        gpu::raster::RasterInterface* raster, cc::ImageDecodeCache* cache = nullptr, viz::TestContextProvider* raster_context_provider = nullptr)
    ...
    void SetCapabilities(const gpu::Capabilities& c)
    {
        capabilities_ = c;
    }
    ...
    gpu::raster::RasterInterface* RasterInterface() override
    {
        ...
        return raster_context_provider_ ? raster_context_provider_->RasterInterface() : raster_interface_.get();
    }
    bool IsContextLost() override
    {
        return RasterInterface() && RasterInterface()->GetGraphicsResetStatusKHR() != GL_NO_ERROR;
    }
    ...
    {
        return raster_context_provider_ ? raster_context_provider_->SharedImageInterface() : test_shared_image_interface_.get();
    }
...
private:
    ...
    raw_ptr<gpu::raster::RasterInterface, DanglingUntriaged> external_raster_interface_ = nullptr;
    ...
    raw_ptr<viz::TestContextProvider, DanglingUntriaged> raster_context_provider_ = nullptr;
};
