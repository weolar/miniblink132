...
class TestWebGraphicsSharedImageInterfaceProvider : public WebGraphicsSharedImageInterfaceProvider {
public:
    static std::unique_ptr<TestWebGraphicsSharedImageInterfaceProvider> Create()
    {
        return std::make_unique<TestWebGraphicsSharedImageInterfaceProvider>(base::MakeRefCounted<gpu::TestSharedImageInterface>());
    }

    explicit TestWebGraphicsSharedImageInterfaceProvider(scoped_refptr<gpu::TestSharedImageInterface> shared_image_interface)
...
private:
    ...
    base::WeakPtrFactory<TestWebGraphicsSharedImageInterfaceProvider> weak_ptr_factory_ { this };
};
