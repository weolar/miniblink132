...
public:
    MailboxRef(const gpu::SyncToken& sync_token, base::PlatformThreadRef context_thread_ref, scoped_refptr<base::SingleThreadTaskRunner> context_task_runner,
    ...
    bool verified_flush()
    {
        return sync_token_.verified_flush();
    }
