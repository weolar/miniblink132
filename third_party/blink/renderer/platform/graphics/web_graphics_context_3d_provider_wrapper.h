...
public:
    ...
    WebGraphicsContext3DProviderWrapper(std::unique_ptr<WebGraphicsContext3DProvider> provider)
...
private:
    ...
    base::ObserverList<DestructionObserver>::UncheckedAndRawPtrExcluded observers_;
    base::WeakPtrFactory<WebGraphicsContext3DProviderWrapper> weak_ptr_factory_ { this };
};
