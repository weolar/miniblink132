...
public:
    ...
    explicit WebGraphicsContext3DVideoFramePool(base::WeakPtr<WebGraphicsContext3DProviderWrapper> weak_context_provider);
    WebGraphicsContext3DVideoFramePool(base::WeakPtr<WebGraphicsContext3DProviderWrapper> weak_context_provider, gpu::GpuMemoryBufferManager* gmb_manager);
    ...
    bool CopyRGBATextureToVideoFrame(const gfx::Size& src_size, scoped_refptr<gpu::ClientSharedImage> src_shared_image,
    ...
    // RGB texture.
    bool ConvertVideoFrame(scoped_refptr<media::VideoFrame> src_video_frame, const gfx::ColorSpace& dst_color_space, FrameReadyCallback callback);
...
private:
    ...
    WTF::Deque<std::unique_ptr<base::CancelableOnceClosure>> pending_gpu_completion_callbacks_;
};
