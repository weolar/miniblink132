...
public:
    DisplayItemRasterInvalidator(
        RasterInvalidator& invalidator, const DisplayItemRange& old_display_items, const DisplayItemRange& new_display_items, const ChunkToLayerMapper& mapper)
...
private:
    ...
    ALWAYS_INLINE void AddRasterInvalidation(DisplayItemClientId, const gfx::Rect&, PaintInvalidationReason, RasterInvalidator::ClientIsOldOrNew);
    ALWAYS_INLINE DisplayItemIterator MatchNewDisplayItemInOldChunk(const DisplayItem& new_item, DisplayItemIterator& next_old_item_to_match);
    ALWAYS_INLINE void GenerateRasterInvalidation(
        DisplayItemClientId, const gfx::Rect& old_visual_rect, const gfx::Rect& new_visual_rect, PaintInvalidationReason);
    ALWAYS_INLINE void GenerateIncrementalRasterInvalidation(DisplayItemClientId, const gfx::Rect& old_visual_rect, const gfx::Rect& new_visual_rect);
    ALWAYS_INLINE void GenerateFullRasterInvalidation(
        DisplayItemClientId, const gfx::Rect& old_visual_rect, const gfx::Rect& new_visual_rect, PaintInvalidationReason reason);
    ...
    HashMap<DisplayItemClientId, Vector<DisplayItemIterator>> old_display_items_index_;
};
