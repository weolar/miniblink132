...
// queries.
class PLATFORM_EXPORT GeometryMapperTransformCache : public GarbageCollected<GeometryMapperTransformCache> {
public:
    GeometryMapperTransformCache() = default;
    GeometryMapperTransformCache(const GeometryMapperTransformCache&) = delete;
    GeometryMapperTransformCache& operator=(const GeometryMapperTransformCache&) = delete;
    ...
    bool is_backface_hidden() const
    {
        return is_backface_hidden_;
    }
    ...
    const TransformPaintPropertyNode* nearest_directly_composited_ancestor() const
    {
...
private:
    ...
    Member<const TransformPaintPropertyNode> nearest_directly_composited_ancestor_;
