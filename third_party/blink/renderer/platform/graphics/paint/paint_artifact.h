...
class PLATFORM_EXPORT PaintArtifact final : public GarbageCollected<PaintArtifact> {
public:
    ...
    PaintRecord GetPaintRecord(const PropertyTreeState& replay_state, const gfx::Rect* cull_rect = nullptr) const;
    ...
    void AppendChunksAsJSON(
        wtf_size_t start_chunk_index, wtf_size_t end_chunk_index, JSONArray&, DisplayItemList::JsonOption = DisplayItemList::kDefault) const;
