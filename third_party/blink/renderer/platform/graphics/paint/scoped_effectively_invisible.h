...
public:
    explicit ScopedEffectivelyInvisible(PaintController& paint_controller)
        ...
        , previous_effectively_invisible_(paint_controller.CurrentEffectivelyInvisible())
    {
        paint_controller.SetCurrentEffectivelyInvisible(true);
    }
    ScopedEffectivelyInvisible(const ScopedEffectivelyInvisible&) = delete;
    ScopedEffectivelyInvisible& operator=(const ScopedEffectivelyInvisible&) = delete;
    ~ScopedEffectivelyInvisible()
    {
        paint_controller_.SetCurrentEffectivelyInvisible(previous_effectively_invisible_);
    }
