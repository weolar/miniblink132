...
public:
    DISABLE_CFI_PERF
    DrawingDisplayItem(DisplayItemClientId client_id, Type type, const gfx::Rect& visual_rect, PaintRecord record, RasterEffectOutset raster_effect_outset,
...
private:
    ...
    static gfx::Rect TightenVisualRect(const gfx::Rect& visual_rect, const PaintRecord& record);
...
DISABLE_CFI_PERF
inline DrawingDisplayItem::DrawingDisplayItem(DisplayItemClientId client_id, Type type, const gfx::Rect& visual_rect, PaintRecord record,
    RasterEffectOutset raster_effect_outset, PaintInvalidationReason paint_invalidation_reason)
    : DisplayItem(
        client_id, type,
        [&] {
        ...
        raster_effect_outset, paint_invalidation_reason,
...
template <> struct DowncastTraits<DrawingDisplayItem> {
