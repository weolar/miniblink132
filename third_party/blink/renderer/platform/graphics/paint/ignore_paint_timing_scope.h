...
public:
    IgnorePaintTimingScope()
        ...
        , reset_is_document_element_invisible_(&is_document_element_invisible_, is_document_element_invisible_)
    {
    }
    ...
    static void IncrementIgnoreDepth()
    {
        ++ignore_depth_;
    }
    static int IgnoreDepth()
    {
        return ignore_depth_;
    }
    ...
    {
        return (!is_document_element_invisible_ && ignore_depth_) || ignore_depth_ > 1;
    }
