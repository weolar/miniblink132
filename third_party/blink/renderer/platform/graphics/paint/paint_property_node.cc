...
int PaintPropertyNode::NodeDepthOrFoundAncestor(const PaintPropertyNode& maybe_ancestor) const
{
    int depth = 0;
...
const PaintPropertyNode& PaintPropertyNode::LowestCommonAncestorInternal(const PaintPropertyNode& other) const
{
    // Measure both depths.
...
void PropertyTreePrinter::BuildTreeString(StringBuilder& string_builder, const PaintPropertyNode& node, unsigned indent)
{
