...
struct PLATFORM_EXPORT PaintChunk {
    ...
    PaintChunk(wtf_size_t begin, wtf_size_t end, const DisplayItemClient& client, const Id& id, const PropertyTreeStateOrAlias& properties,
    ...
    PaintChunk(wtf_size_t begin, PaintChunk&& other)
        ...
        , text_known_to_be_on_opaque_background(other.text_known_to_be_on_opaque_background)
    ...
    String ToString(const PaintArtifact& paint_artifact, bool concise = false) const;
    ...
    cc::HitTestOpaqueness hit_test_opaqueness = cc::HitTestOpaqueness::kTransparent;
