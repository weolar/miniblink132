...
// ancestor spaces.
class PLATFORM_EXPORT GeometryMapperClipCache : public GarbageCollected<GeometryMapperClipCache> {
public:
    ...
    public:
        ...
        ClipAndTransform(const ClipPaintPropertyNode* ancestor_clip_arg, const TransformPaintPropertyNode* ancestor_transform_arg,
    ...
    public:
        ...
        {
            visitor->Trace(clip_and_transform);
        }
    };
...
WTF_ALLOW_MOVE_AND_INIT_WITH_MEM_FUNCTIONS(blink::GeometryMapperClipCache::ClipCacheEntry)
