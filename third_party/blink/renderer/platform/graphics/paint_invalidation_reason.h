...
inline constexpr bool IsFullPaintInvalidationReason(PaintInvalidationReason reason)
{
    return reason > PaintInvalidationReason::kNonFullMax;
}

inline constexpr bool IsNonLayoutFullPaintInvalidationReason(PaintInvalidationReason reason)
{
    return reason > PaintInvalidationReason::kNonFullMax && reason <= PaintInvalidationReason::kNonLayoutMax;
}

inline constexpr bool IsLayoutFullPaintInvalidationReason(PaintInvalidationReason reason)
{
    return reason > PaintInvalidationReason::kNonLayoutMax && reason <= PaintInvalidationReason::kLayoutMax;
}

inline constexpr bool IsLayoutPaintInvalidationReason(PaintInvalidationReason reason)
{
    return reason == PaintInvalidationReason::kIncremental || IsLayoutFullPaintInvalidationReason(reason);
}
