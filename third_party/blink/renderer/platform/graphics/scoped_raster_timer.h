...
public:
    ...
    ScopedRasterTimer(gpu::raster::RasterInterface* raster_interface, Host& host, bool always_measure_for_testing);
    ~ScopedRasterTimer();

    // Histogram names.
    static constexpr const char* const kRasterDurationUnacceleratedHistogram = "Blink.Canvas.RasterDuration.Unaccelerated";
    static constexpr const char* const kRasterDurationAcceleratedCpuHistogram = "Blink.Canvas.RasterDuration.Accelerated.CPU";
    static constexpr const char* const kRasterDurationAcceleratedGpuHistogram = "Blink.Canvas.RasterDuration.Accelerated.GPU";
    static constexpr const char* const kRasterDurationAcceleratedTotalHistogram = "Blink.Canvas.RasterDuration.Accelerated.Total";
...
private:
    ...
    public:
        ...
        // interface.
        explicit AsyncGpuRasterTimer(gpu::raster::RasterInterface& raster_interface);

        // Stop tracking issue command
        void FinishedIssuingCommands(gpu::raster::RasterInterface& raster_interface, base::TimeDelta cpu_raster_duration);
