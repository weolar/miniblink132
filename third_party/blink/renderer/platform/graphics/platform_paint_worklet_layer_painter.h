...
class PLATFORM_EXPORT PlatformPaintWorkletLayerPainter : public cc::PaintWorkletLayerPainter {
public:
    explicit PlatformPaintWorkletLayerPainter(std::unique_ptr<PaintWorkletPaintDispatcher>);
