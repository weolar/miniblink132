...
class PLATFORM_EXPORT RasterDarkModeFilterImpl : public cc::RasterDarkModeFilter {
public:
    ...
    sk_sp<cc::ColorFilter> ApplyToImage(const SkPixmap& pixmap, const SkIRect& src) const override;
