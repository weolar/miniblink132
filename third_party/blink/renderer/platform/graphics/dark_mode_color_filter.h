...
public:
    static std::unique_ptr<DarkModeColorFilter> FromSettings(const DarkModeSettings& settings);
    ...
    virtual SkColor4f AdjustColorForHigherConstrast(const SkColor4f& adjusted_color, const SkColor4f& background, float reference_contrast_ratio)
    {
