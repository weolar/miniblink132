...
public:
    ...
    static std::unique_ptr<DarkModeColorClassifier> MakeForegroundColorClassifier(const DarkModeSettings& settings);
    static std::unique_ptr<DarkModeColorClassifier> MakeBackgroundColorClassifier(const DarkModeSettings& settings);
