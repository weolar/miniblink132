...
class PLATFORM_EXPORT TransferredMediaStreamComponent final : public GarbageCollected<TransferredMediaStreamComponent>, public MediaStreamComponent {
public:
    ...
    TransferredMediaStreamComponent(const TransferredMediaStreamComponent&) = delete;
    TransferredMediaStreamComponent& operator=(const TransferredMediaStreamComponent&) = delete;
    ...
    void SetCreationFrameGetter(base::RepeatingCallback<WebLocalFrame*()>) override;
