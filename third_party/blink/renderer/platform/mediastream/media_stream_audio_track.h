...
public:
    ...
    std::unique_ptr<MediaStreamTrackPlatform> CreateFromComponent(const MediaStreamComponent*, const String& id) override;
    ...
    void TransferAudioFrameStatsTo(MediaStreamTrackPlatform::AudioFrameStats& destination) override;
...
private:
    ...
    void UpdateFrameStats(const media::AudioBus& audio_bus, base::TimeTicks reference_time, const media::AudioGlitchInfo& glitch_info);
...
private:
    ...
    AudioFrameStats mainthread_frame_stats_ GUARDED_BY(mainthread_frame_stats_lock_);
