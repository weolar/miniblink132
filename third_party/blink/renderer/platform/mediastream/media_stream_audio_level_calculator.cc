...
MediaStreamAudioLevelCalculator::Level::Level(base::PassKey<MediaStreamAudioLevelCalculator>)
{
}
...
MediaStreamAudioLevelCalculator::MediaStreamAudioLevelCalculator()
    : level_(base::MakeRefCounted<Level>(base::PassKey<MediaStreamAudioLevelCalculator>()))
{
}
...
void MediaStreamAudioLevelCalculator::Calculate(const media::AudioBus& audio_bus, bool assume_nonzero_energy)
{
