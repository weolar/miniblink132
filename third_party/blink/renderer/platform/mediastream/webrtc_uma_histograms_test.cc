...
class PerSessionWebRTCAPIMetricsTest : public testing::Test, public testing::WithParamInterface<RTCAPIName> {
public:
...
INSTANTIATE_TEST_SUITE_P(PerSessionWebRTCAPIMetricsTest, PerSessionWebRTCAPIMetricsTest,
    ::testing::ValuesIn({ RTCAPIName::kGetUserMedia, RTCAPIName::kGetDisplayMedia, RTCAPIName::kEnumerateDevices, RTCAPIName::kRTCPeerConnection }));
