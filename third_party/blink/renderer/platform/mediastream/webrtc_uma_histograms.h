...
PLATFORM_EXPORT void LogUserMediaRequestResult(mojom::MediaStreamRequestResult result);
...
public:
    ...
    PerSessionWebRTCAPIMetrics& operator=(const PerSessionWebRTCAPIMetrics&) = delete;
