...
void WebEncryptedMediaRequest::RequestSucceeded(std::unique_ptr<WebContentDecryptionModuleAccess> access)
{
    private_->RequestSucceeded(std::move(access));
}

void WebEncryptedMediaRequest::RequestNotSupported(const WebString& error_message)
{
