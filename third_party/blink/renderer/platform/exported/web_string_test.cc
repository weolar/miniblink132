...
TEST(WebStringTest, UTF8ConversionRoundTrip)
{
    ...
    for (WebUChar uchar = 0xD800; uchar <= 0xDFFF; ++uchar) {
        ...
        std::string utf8_string(utf16_string.Utf8(WebString::UTF8ConversionMode::kStrict));
        ...
        utf8_string = utf16_string.Utf8(WebString::UTF8ConversionMode::kStrictReplacingErrorsWithFFFD);
        EXPECT_FALSE(utf8_string.empty());
