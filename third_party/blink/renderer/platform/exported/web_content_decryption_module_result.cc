...
void WebContentDecryptionModuleResult::CompleteWithContentDecryptionModule(std::unique_ptr<WebContentDecryptionModule> cdm)
{
...
void WebContentDecryptionModuleResult::CompleteWithKeyStatus(WebEncryptedMediaKeyInformation::KeyStatus key_status)
{
    impl_->CompleteWithKeyStatus(key_status);
    Reset();
}

void WebContentDecryptionModuleResult::CompleteWithError(WebContentDecryptionModuleException exception, uint32_t system_code, const WebString& error_message)
{
