...
TEST(ScreenInfoTest, Equality)
{
    ...
    screen_info1.orientation_type = display::mojom::ScreenOrientation::kLandscapePrimary;
    ...
    screen_info2.orientation_type = display::mojom::ScreenOrientation::kLandscapePrimary;
