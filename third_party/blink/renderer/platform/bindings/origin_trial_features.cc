...
InstallPropertiesPerFeatureFuncType SetInstallPropertiesPerFeatureFunc(InstallPropertiesPerFeatureFuncType func)
{
    DCHECK(func);

    InstallPropertiesPerFeatureFuncType old_func = g_install_properties_per_feature_func;
