...
public:
    class PLATFORM_EXPORT IterationSourceBase : public GarbageCollected<IterationSourceBase> {
    public:
        ...
        explicit IterationSourceBase(Kind kind)
            : kind_(kind)
        {
        }
        ...
        virtual v8::Local<v8::Promise> Next(ScriptState* script_state, ExceptionState& exception_state) = 0;

        virtual v8::Local<v8::Promise> Return(ScriptState* script_state, v8::Local<v8::Value> value, ExceptionState& exception_state) = 0;
    ...
    v8::Local<v8::Promise> next(ScriptState* script_state, ExceptionState& exception_state);

    v8::Local<v8::Promise> returnForBinding(ScriptState* script_state, ExceptionState& exception_state);
    v8::Local<v8::Promise> returnForBinding(ScriptState* script_state, v8::Local<v8::Value> value, ExceptionState& exception_state);
