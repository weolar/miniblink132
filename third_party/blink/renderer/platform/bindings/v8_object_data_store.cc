...
V8ObjectDataStore::value_type V8ObjectDataStore::Get(v8::Isolate* isolate, key_type key)
{
...
void V8ObjectDataStore::Set(v8::Isolate* isolate, key_type key, value_type value)
{
    v8_object_map_.insert(key, TraceWrapperV8Reference<v8::Object>(isolate, value));
}
