...
public:
    ...
    V8ExternalMemoryAccounterBase& operator=(const V8ExternalMemoryAccounterBase&) = delete;
    V8ExternalMemoryAccounterBase& operator=(V8ExternalMemoryAccounterBase&& other)
    {
#if DCHECK_IS_ON()
        if (this == &other) {
            return *this;
