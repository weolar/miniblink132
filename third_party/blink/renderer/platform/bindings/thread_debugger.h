...
public:
    ...
    virtual void AsyncTaskScheduled(const StringView& task_name, void* task, bool recurring) = 0;
    virtual void AsyncTaskCanceled(void* task) = 0;
    virtual void AllAsyncTasksCanceled() = 0;
    virtual void AsyncTaskStarted(void* task) = 0;
    virtual void AsyncTaskFinished(void* task) = 0;
    virtual unsigned PromiseRejected(v8::Local<v8::Context>, const WTF::String& error_message, v8::Local<v8::Value> exception, std::unique_ptr<SourceLocation>)
        = 0;
    virtual void PromiseRejectionRevoked(v8::Local<v8::Context>, unsigned promise_rejection_id) = 0;

    virtual v8_inspector::V8StackTraceId StoreCurrentStackTrace(const StringView& description) = 0;
