...
class PLATFORM_EXPORT ActiveScriptWrappableManager final : public GarbageCollected<ActiveScriptWrappableManager>, public NameClient {
public:
...
private:
    ...
    HeapVector<std::pair<UntracedMember<const ActiveScriptWrappableBase>, Member<const ActiveScriptWrappableBase>>> active_script_wrappables_;
