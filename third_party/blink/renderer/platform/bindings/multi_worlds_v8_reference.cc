...
MultiWorldsV8Reference::MultiWorldsV8Reference(v8::Isolate* isolate, v8::Local<v8::Value> value)
    : value_(isolate, value)
{
    if (value->IsObject()) {
        script_state_ = ScriptState::ForRelevantRealm(isolate, value.As<v8::Object>());
    } else {
        script_state_ = nullptr;
    }
}

v8::Local<v8::Value> MultiWorldsV8Reference::GetValue(ScriptState* script_state)
{
...
v8::Local<v8::Object> MultiWorldsV8Reference::GetObject(ScriptState* script_state)
{
