...
const WrapperTypeInfo& FrozenArrayBase::wrapper_type_info_ = frozen_array_wrapper_type_info_;
...
v8::Local<v8::Value> FrozenArrayBase::Wrap(ScriptState* script_state)
{
    ...
    wrapper.As<v8::Object>()->SetIntegrityLevel(script_state->GetContext(), v8::IntegrityLevel::kFrozen);

    return AssociateWithWrapper(script_state->GetIsolate(), GetWrapperTypeInfo(), wrapper.As<v8::Object>());
}

v8::Local<v8::Object> FrozenArrayBase::AssociateWithWrapper(v8::Isolate* isolate, const WrapperTypeInfo* wrapper_type_info, v8::Local<v8::Object> wrapper)
{
