...
v8::Local<v8::Value> ScriptWrappable::ToV8(ScriptState* script_state)
{
    ...
    if (DOMDataStore::GetWrapper(script_state, this).ToLocal(&wrapper)) [[likely]] {
        return wrapper;
    }
    return Wrap(script_state);
}

v8::Local<v8::Value> ScriptWrappable::ToV8(v8::Isolate* isolate, v8::Local<v8::Object> creation_context_object)
{
    v8::Local<v8::Object> wrapper;
    ...
    ScriptState* script_state = ScriptState::ForRelevantRealm(isolate, creation_context_object);
    return Wrap(script_state);
}
...
v8::Local<v8::Value> ScriptWrappable::Wrap(ScriptState* script_state)
{
    ...
    v8::Local<v8::Object> wrapper = V8DOMWrapper::CreateWrapper(script_state, wrapper_type_info);
    return AssociateWithWrapper(script_state->GetIsolate(), wrapper_type_info, wrapper);
}

v8::Local<v8::Object> ScriptWrappable::AssociateWithWrapper(v8::Isolate* isolate, const WrapperTypeInfo* wrapper_type_info, v8::Local<v8::Object> wrapper)
{
    return V8DOMWrapper::AssociateObjectWithWrapper(isolate, this, wrapper_type_info, wrapper);
}
