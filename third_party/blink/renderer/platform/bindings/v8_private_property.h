...
public:
    ...
    public:
        ...
        [[nodiscard]] v8::MaybeLocal<v8::Value> GetOrUndefined(v8::Local<v8::Object> object) const
        {
        ...
        v8::Local<v8::Private> GetPrivate() const
        {
            return private_symbol_;
        }
    ...
    private:
        ...
        Symbol(v8::Isolate* isolate, v8::Local<v8::Private> private_symbol)
            : private_symbol_(private_symbol)
            , isolate_(isolate)
        {
        }
    ...
    static Symbol GetCachedAccessor(v8::Isolate* isolate, CachedAccessor symbol_id);
...
private:
    static v8::Local<v8::Private> CreateV8Private(v8::Isolate*, const char* symbol);
