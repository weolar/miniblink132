...
private:
    using ShouldAllowAccessToV8ContextFunction = bool (*)(v8::Local<v8::Context> accessing_context, v8::MaybeLocal<v8::Context> target_context);
    static void SetShouldAllowAccessToV8Context(ShouldAllowAccessToV8ContextFunction);
