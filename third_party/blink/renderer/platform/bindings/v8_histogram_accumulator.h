...
public:
    ...
    void* RegisterHistogram(base::HistogramBase* histogram, const std::string& name);
...
private:
    ...
    struct HistogramAndSum {
        ...
        HistogramAndSum(base::HistogramBase* histogram, std::atomic<int>* sum_microseconds)
            : original_histogram(histogram)
            , sum_microseconds(sum_microseconds)
        {
        }
    ...
    void* RegisterHistogramImpl(base::HistogramBase* histogram, const std::string& name);
