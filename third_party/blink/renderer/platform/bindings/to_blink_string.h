...
template <typename StringType> PLATFORM_EXPORT StringType ToBlinkString(v8::Isolate* isolate, v8::Local<v8::String>, ExternalMode);
...
PLATFORM_EXPORT StringView ToBlinkStringView(
    v8::Isolate* isolate, v8::Local<v8::String> v8_string, StringView::StackBackingStore& backing_store, ExternalMode external);
