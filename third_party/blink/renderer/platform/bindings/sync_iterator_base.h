...
public:
    ...
    public:
        ...
        virtual v8::Local<v8::Object> Next(ScriptState* script_state, Kind kind, ExceptionState& exception_state) = 0;
    ...
    v8::Local<v8::Object> next(ScriptState* script_state, ExceptionState& exception_state);
...
// or setlike.
template <typename T> class SyncIterator;
