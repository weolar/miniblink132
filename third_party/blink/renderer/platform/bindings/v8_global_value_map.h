 ...
 * collected.
 */
template <typename KeyType, typename ValueType, v8::PersistentContainerCallbackType type> class V8GlobalValueMapTraits {
...
public:
    ...
    static void Swap(Impl& impl, Impl& other)
    {
        impl.swap(other);
    }
    ...
    static KeyType Key(Iterator& iter)
    {
        return iter->key;
    }
    static v8::PersistentContainerValue Set(Impl* impl, KeyType key, v8::PersistentContainerValue value)
    {
...
class V8GlobalValueMap : public v8::GlobalValueMap<KeyType, ValueType, V8GlobalValueMapTraits<KeyType, ValueType, v8::kNotWeak>> {
    DISALLOW_NEW();
