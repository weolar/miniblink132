...
public:
    ...
    public:
        AllowUserAgentScript()
            : saved_counter_(&GetMutableCounter(), 0)
        {
...
public:
    ...
    BlinkLifecycleScopeWillBeScriptForbidden(const BlinkLifecycleScopeWillBeScriptForbidden&) = delete;
    BlinkLifecycleScopeWillBeScriptForbidden& operator=(const BlinkLifecycleScopeWillBeScriptForbidden&) = delete;
    ~BlinkLifecycleScopeWillBeScriptForbidden()
    {
