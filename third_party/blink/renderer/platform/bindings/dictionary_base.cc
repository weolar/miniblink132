...
v8::Local<v8::Value> DictionaryBase::ToV8(ScriptState* script_state) const
{
    ...
    v8::MaybeLocal<v8::DictionaryTemplate> maybe_template = per_isolate_data->FindV8DictionaryTemplate(key);
    ...
    if (!maybe_template.IsEmpty()) {
        ...
        just_template = v8::DictionaryTemplate::New(script_state->GetIsolate(), v8::MemorySpan<const std::string_view>(properties.data(), properties.size()));
