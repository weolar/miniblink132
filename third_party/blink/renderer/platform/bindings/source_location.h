...
public:
    ...
    static std::unique_ptr<SourceLocation> CreateFromNonEmptyV8StackTraceInternal(std::unique_ptr<v8_inspector::V8StackTrace>);
...
// trace.
PLATFORM_EXPORT std::unique_ptr<SourceLocation> CaptureSourceLocation(const String& url, unsigned line_number, unsigned column_number);
...
PLATFORM_EXPORT std::unique_ptr<SourceLocation> CaptureSourceLocation(v8::Isolate* isolate, v8::Local<v8::Function>);
