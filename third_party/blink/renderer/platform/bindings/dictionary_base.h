...
class PLATFORM_EXPORT InputDictionaryBase : public GarbageCollected<InputDictionaryBase> {
public:
...
protected:
    ...
    virtual void FillTemplateProperties(WTF::Vector<std::string_view>& properties) const = 0;
    virtual v8::Local<v8::Object> FillValues(ScriptState* script_state, v8::Local<v8::DictionaryTemplate> dict_template) const = 0;
};
