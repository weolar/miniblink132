...
public:
    ...
    static ScriptState* Create(v8::Local<v8::Context>, DOMWrapperWorld*, ExecutionContext*);
    ...
    static ScriptState* ForCurrentRealm(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        return ForCurrentRealm(info.GetIsolate());
    }

    static ScriptState* ForCurrentRealm(const v8::PropertyCallbackInfo<v8::Value>& info)
    {
        return ForCurrentRealm(info.GetIsolate());
    }

    static ScriptState* ForRelevantRealm(v8::Isolate* isolate, v8::Local<v8::Object> object)
    {
        DCHECK(!object.IsEmpty());
        ScriptState* script_state
            = static_cast<ScriptState*>(object->GetAlignedPointerFromEmbedderDataInCreationContext(isolate, kV8ContextPerContextDataIndex));
    ...
    const V8ContextToken& GetToken() const
    {
        return token_;
    }
...
private:
    static void OnV8ContextCollectedCallback(const v8::WeakCallbackInfo<ScriptState>&);
    ...
    using CreateCallback = ScriptState* (*)(v8::Local<v8::Context>, DOMWrapperWorld*, ExecutionContext*);
    static CreateCallback s_create_callback_;
    static void SetCreateCallback(CreateCallback);
    friend class ScriptStateImpl;

    static constexpr int kV8ContextPerContextDataIndex = static_cast<int>(gin::kPerContextDataStartIndex) + static_cast<int>(gin::kEmbedderBlink);
...
public:
    ...
    v8::Isolate* GetIsolate() const
    {
        return script_state_->GetIsolate();
    }
    v8::Local<v8::Context> GetContext() const
    {
