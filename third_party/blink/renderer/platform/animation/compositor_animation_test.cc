...
public:
    CompositorAnimationDelegateForTesting()
    {
        ResetFlags();
    }
...
public:
    CompositorAnimationTestClient()
        : animation_(CompositorAnimation::Create())
    {
    }
...
TEST_F(CompositorAnimationTest, NullDelegate)
{
    ...
    auto timeline = cc::AnimationTimeline::Create(cc::AnimationIdProvider::NextTimelineId());
    std::unique_ptr<CompositorAnimationTestClient> client(new CompositorAnimationTestClient);
    ...
    auto keyframe_model = cc::KeyframeModel::Create(
        std::move(curve), cc::AnimationIdProvider::NextKeyframeModelId(), 1, cc::KeyframeModel::TargetPropertyId(cc::TargetProperty::TRANSFORM));
    ...
    cc_animation->NotifyKeyframeModelFinishedForTesting(timeline_id, keyframe_model_id, cc::TargetProperty::TRANSFORM, 1);
...
TEST_F(CompositorAnimationTest, NotifyFromCCAfterCompositorAnimationDeletion)
{
    ...
    auto curve = gfx::KeyframedFloatAnimationCurve::Create();
    auto keyframe_model = cc::KeyframeModel::Create(
        std::move(curve), cc::AnimationIdProvider::NextKeyframeModelId(), 1, cc::KeyframeModel::TargetPropertyId(cc::TargetProperty::OPACITY));
    int keyframe_model_id = keyframe_model->id();
    animation->AddKeyframeModel(std::move(keyframe_model));
    ...
    cc_animation->NotifyKeyframeModelFinishedForTesting(timeline_id, keyframe_model_id, cc::TargetProperty::OPACITY, 1);
    EXPECT_TRUE(delegate->finished_);
...
TEST_F(CompositorAnimationTest, CompositorAnimationDeletionDetachesFromCCTimeline)
{
    auto timeline = cc::AnimationTimeline::Create(cc::AnimationIdProvider::NextTimelineId());
    std::unique_ptr<CompositorAnimationTestClient> client(new CompositorAnimationTestClient);
