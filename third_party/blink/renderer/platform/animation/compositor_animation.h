...
public:
    ...
    static std::unique_ptr<CompositorAnimation> Create(std::optional<int> replaced_cc_animation_id = std::nullopt);
    static std::unique_ptr<CompositorAnimation> CreateWorkletAnimation(cc::WorkletAnimationId, const String& name, double playback_rate,
        std::unique_ptr<cc::AnimationOptions>, std::unique_ptr<cc::AnimationEffectTimings> effect_timings);
...
private:
    ...
    void NotifyAnimationTakeover(
        base::TimeTicks monotonic_time, int target_property, base::TimeTicks animation_start_time, std::unique_ptr<gfx::AnimationCurve>) override;
