...
public:
    ...
    virtual void NotifyAnimationStarted(base::TimeDelta monotonic_time, int group) = 0;
    virtual void NotifyAnimationFinished(base::TimeDelta monotonic_time, int group) = 0;
    virtual void NotifyAnimationAborted(base::TimeDelta monotonic_time, int group) = 0;
    ...
    virtual void NotifyAnimationTakeover(double monotonic_time, double animation_start_time, std::unique_ptr<gfx::AnimationCurve> curve)
    {
    }
    virtual void NotifyLocalTimeUpdated(std::optional<base::TimeDelta> local_time)
    {
    }
};
