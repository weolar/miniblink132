...
public:
    ...
    using ScopedTestFeatureDependentForTestType = ScopedTestFeatureDependentForTest;
    ...
    static ScopedTestFeatureForTestType CreateScopedTestFeatureForTest(bool enabled)
    {
        return ScopedTestFeatureForTest(enabled);
    }

    static ScopedTestFeatureImpliedForTestType CreateScopedTestFeatureImpliedForTest(bool enabled)
    {
        return ScopedTestFeatureImpliedForTest(enabled);
    }

    static ScopedTestFeatureDependentForTestType CreateScopedTestFeatureDependentForTest(bool enabled)
    {
...
public:
    ...
    using ScopedTestFeatureImpliedForTestType = ScopedTestFeatureProtectedImpliedForTest;
    using ScopedTestFeatureDependentForTestType = ScopedTestFeatureProtectedDependentForTest;
    ...
    static void SetOriginTrialsSampleAPIImpliedEnabled(bool enabled)
    {
        RuntimeEnabledFeatures::SetProtectedOriginTrialsSampleAPIImpliedEnabled(enabled);
    }

    static void SetOriginTrialsSampleAPIDependentEnabled(bool enabled)
    {
        RuntimeEnabledFeatures::SetProtectedOriginTrialsSampleAPIDependentEnabled(enabled);
    }
};

template <typename TRuntimeEnabledFeaturesTraits> class AbstractRuntimeEnabledFeaturesTest : public testing::Test {
protected:
    using ScopedTestFeatureForTestType = typename TRuntimeEnabledFeaturesTraits::ScopedTestFeatureForTestType;
    using ScopedTestFeatureImpliedForTestType = typename TRuntimeEnabledFeaturesTraits::ScopedTestFeatureImpliedForTestType;
    using ScopedTestFeatureDependentForTestType = typename TRuntimeEnabledFeaturesTraits::ScopedTestFeatureDependentForTestType;
    ...
    {
        return TRuntimeEnabledFeaturesTraits::CreateScopedTestFeatureForTest(enabled);
    }

    ScopedTestFeatureImpliedForTestType CreateScopedTestFeatureImpliedForTest(bool enabled)
    {
        return TRuntimeEnabledFeaturesTraits::CreateScopedTestFeatureImpliedForTest(enabled);
    }

    ScopedTestFeatureDependentForTestType CreateScopedTestFeatureDependentForTest(bool enabled)
    {
        return TRuntimeEnabledFeaturesTraits::CreateScopedTestFeatureDependentForTest(enabled);
    }
    ...
    {
        return TRuntimeEnabledFeaturesTraits::OriginTrialsSampleAPIEnabledByRuntimeFlag();
    }

    bool OriginTrialsSampleAPIImpliedEnabledByRuntimeFlag()
    {
        return TRuntimeEnabledFeaturesTraits::OriginTrialsSampleAPIImpliedEnabledByRuntimeFlag();
    }

    bool OriginTrialsSampleAPIDependentEnabledByRuntimeFlag()
    {
        return TRuntimeEnabledFeaturesTraits::OriginTrialsSampleAPIDependentEnabledByRuntimeFlag();
    }
    ...
    {
        TRuntimeEnabledFeaturesTraits::SetOriginTrialsSampleAPIImpliedEnabled(enabled);
    }

    void SetOriginTrialsSampleAPIDependentEnabled(bool enabled)
    {
        TRuntimeEnabledFeaturesTraits::SetOriginTrialsSampleAPIDependentEnabled(enabled);
    }
...
REGISTER_TYPED_TEST_SUITE_P(
    AbstractRuntimeEnabledFeaturesTest, Relationship, ScopedForTest, BackupRestore, OriginTrialsByRuntimeEnabled, CopiedFromBaseFaetureIf);

INSTANTIATE_TYPED_TEST_SUITE_P(Base, AbstractRuntimeEnabledFeaturesTest, RuntimeEnabledFeaturesTestTraits);

INSTANTIATE_TYPED_TEST_SUITE_P(Protected, AbstractRuntimeEnabledFeaturesTest, RuntimeProtectedEnabledFeaturesTestTraits);
