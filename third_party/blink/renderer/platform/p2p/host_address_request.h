...
class P2PAsyncAddressResolver : public ThreadSafeRefCounted<P2PAsyncAddressResolver> {
public:
    ...
    void Start(const rtc::SocketAddress& addr, std::optional<int> address_family, DoneCallback done_callback);
