...
class PLATFORM_EXPORT P2PSocketDispatcher : public GarbageCollected<P2PSocketDispatcher>,
...
public:
    ...
    P2PSocketDispatcher(MojoBindingContext& context, base::PassKey<P2PSocketDispatcher>);
    ...
    mojo::SharedRemote<network::mojom::blink::P2PSocketManager> GetP2PSocketManager();

    void Trace(Visitor*) const override;

private:
    // network::mojom::blink::P2PNetworkNotificationClient interface.
    void NetworkListChanged(const Vector<net::NetworkInterface>& networks, const net::IPAddress& default_ipv4_local_address,
    ...
    scoped_refptr<base::ObserverListThreadSafe<blink::NetworkListObserver>> network_list_observers_;

    mojo::PendingReceiver<network::mojom::blink::P2PSocketManager> p2p_socket_manager_receiver_;
    mojo::SharedRemote<network::mojom::blink::P2PSocketManager> p2p_socket_manager_ GUARDED_BY(p2p_socket_manager_lock_);
    ...
    HeapMojoReceiver<network::mojom::blink::P2PNetworkNotificationClient, P2PSocketDispatcher> network_notification_client_receiver_;
};
