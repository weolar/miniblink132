...
class PLATFORM_EXPORT P2PSocketClientImpl : public blink::P2PSocketClient, public network::mojom::blink::P2PSocketClient {
public:
    ...
    uint64_t Send(const net::IPEndPoint& address, base::span<const uint8_t> data, const rtc::PacketOptions& options) override;
    ...
    mojo::PendingReceiver<network::mojom::blink::P2PSocket> CreatePendingReceiver()
    {
        return socket_.BindNewPipeAndPassReceiver();
    }
    mojo::PendingRemote<network::mojom::blink::P2PSocketClient> CreatePendingRemote()
    {
...
private:
    ...
    // condition.
    void SendWithPacketId(const net::IPEndPoint& address, base::span<const uint8_t> data, const rtc::PacketOptions& options, uint64_t packet_id);
    ...
    void SendBatchComplete(const WTF::Vector<::network::P2PSendPacketMetrics>& in_send_metrics_batch) override;
