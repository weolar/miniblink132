...
class PLATFORM_EXPORT MdnsResponderAdapter : public webrtc::MdnsResponderInterface {
public:
...
private:
    mojo::SharedRemote<network::mojom::blink::MdnsResponder> shared_remote_client_;
};
