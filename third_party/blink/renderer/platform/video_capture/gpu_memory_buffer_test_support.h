...
class TestingPlatformSupportForGpuMemoryBuffer : public IOTaskRunnerTestingPlatformSupport {
public:
    ...
    void SetSharedImageCapabilities(const gpu::SharedImageCapabilities& capabilities);
