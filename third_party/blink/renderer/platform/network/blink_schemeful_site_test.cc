...
{
    scoped_refptr<SecurityOrigin> origin1_site1 = SecurityOrigin::CreateFromString("https://example.com");
    scoped_refptr<SecurityOrigin> origin2_site1 = SecurityOrigin::CreateFromString("https://sub.example.com");
    scoped_refptr<SecurityOrigin> origin1_site2 = SecurityOrigin::CreateFromString("https://other.com");
    ...
    scoped_refptr<SecurityOrigin> opaque_origin1 = SecurityOrigin::CreateUniqueOpaque();
    scoped_refptr<SecurityOrigin> opaque_origin2 = SecurityOrigin::CreateUniqueOpaque();
...
{
    scoped_refptr<SecurityOrigin> security_origin_1 = SecurityOrigin::CreateFromString("https://www.example.com");
    url::Origin origin_1 = url::Origin::Create(GURL("https://www.example.com"));

    BlinkSchemefulSite security_origin_site_1 = BlinkSchemefulSite(security_origin_1);
    BlinkSchemefulSite origin_site_1 = BlinkSchemefulSite(origin_1);

    EXPECT_EQ(security_origin_site_1, origin_site_1);

    scoped_refptr<SecurityOrigin> security_origin_2 = SecurityOrigin::CreateFromString("https://www.other.com");
    url::Origin origin_2 = url::Origin::Create(GURL("https://www.other.com"));

    BlinkSchemefulSite security_origin_site_2 = BlinkSchemefulSite(security_origin_2);
...
TEST(BlinkSchemefulSiteTest, TypecastOperator)
{
    ...
    net::SchemefulSite net_site_from_blink_site = static_cast<net::SchemefulSite>(blink_site);
...
TEST(BlinkSchemefulSiteTest, HashBlinkSchemefulSite)
{
    ...
    BlinkSchemefulSite blink_site_1(SecurityOrigin::CreateFromString("https://example.com"));
    BlinkSchemefulSite blink_site_2(SecurityOrigin::CreateFromString("https://other.com"));
...
{
    BlinkSchemefulSite site(SecurityOrigin::CreateFromString("https://example.com"));
