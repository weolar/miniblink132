...
// static
bool StructTraits<network::mojom::SchemefulSiteDataView, blink::BlinkSchemefulSite>::Read(
    network::mojom::SchemefulSiteDataView data, blink::BlinkSchemefulSite* out)
{
