...
ParsedContentDisposition::ParsedContentDisposition(const String& content_disposition, Mode mode)
{
    ...
    parameters_ = ParsedContentHeaderFieldParameters::Parse(std::move(tokenizer), mode);
}
