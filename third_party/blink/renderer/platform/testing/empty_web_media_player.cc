...
WebMediaPlayer::LoadTiming EmptyWebMediaPlayer::Load(LoadType, const WebMediaPlayerSource&, CorsMode, bool is_cache_disabled)
{
...
scoped_refptr<media::VideoFrame> EmptyWebMediaPlayer::GetCurrentFrameThenUpdate()
{
    return nullptr;
}

std::optional<media::VideoFrame::ID> EmptyWebMediaPlayer::CurrentFrameId() const
{
    return std::nullopt;
}
