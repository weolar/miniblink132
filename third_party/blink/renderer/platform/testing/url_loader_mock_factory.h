...
public:
    ...
    virtual void RegisterURL(const WebURL&, const WebURLResponse&, const WebString& file_path) = 0;
    ...
    virtual void RegisterURLProtocol(const WebString& protocol, const WebURLResponse&, const WebString& file_path) = 0;
