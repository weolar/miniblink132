...
class FakeMojoBindingContext : public GarbageCollected<FakeMojoBindingContext>, public MojoBindingContext {
    USING_PRE_FINALIZER(FakeMojoBindingContext, Dispose);

public:
    explicit FakeMojoBindingContext(scoped_refptr<base::SingleThreadTaskRunner> task_runner);
