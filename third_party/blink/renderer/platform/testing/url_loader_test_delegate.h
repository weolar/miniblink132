...
public:
    ...
    virtual void DidReceiveResponse(URLLoaderClient* original_client, const WebURLResponse&);
    virtual void DidReceiveData(URLLoaderClient* original_client, base::span<const char> data);
    virtual void DidFail(URLLoaderClient* original_client, const WebURLError&, int64_t total_encoded_data_length, int64_t total_encoded_body_length,
        int64_t total_decoded_body_length);
    virtual void DidFinishLoading(URLLoaderClient* original_client, base::TimeTicks finish_time, int64_t total_encoded_data_length,
