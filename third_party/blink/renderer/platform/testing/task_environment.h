...
public:
    ...
    explicit TaskEnvironment(Traits... traits)
        : TaskEnvironment(CreateTaskEnvironmentWithPriorities(blink::scheduler::CreatePrioritySettings(), SubclassCreatesDefaultTaskRunner {}, traits...))
    {
    }
    ...
    v8::Isolate* isolate()
    {
        return main_thread_isolate_->isolate();
    }
    void ResetIsolate()
    {
...
private:
    ...
    explicit TaskEnvironment(base::test::TaskEnvironment&& scoped_task_environment);
