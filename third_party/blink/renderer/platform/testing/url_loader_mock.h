...
public:
    ...
    WebURL ServeRedirect(const WebString& method, const WebURLResponse& redirect_response);
    ...
    void LoadSynchronously(std::unique_ptr<network::ResourceRequest> request, scoped_refptr<const SecurityOrigin> top_frame_origin, bool download_to_blob,
        bool no_mime_sniffing, base::TimeDelta timeout_interval, URLLoaderClient* client, WebURLResponse&, std::optional<WebURLError>&,
