...
class PaintTestConfigurations : public testing::WithParamInterface<unsigned>,
...
public:
    PaintTestConfigurations()
        : ScopedPaintUnderInvalidationCheckingForTest(GetParam() & kUnderInvalidationChecking)
        , ScopedHitTestOpaquenessForTest(GetParam() & kHitTestOpaqueness)
        , ScopedFastNonCompositedScrollHitTestForTest(GetParam() & kHitTestOpaqueness)
...
#define PAINT_TEST_SUITE_P_VALUES 0, kFluentScrollbar, kHitTestOpaqueness, kRasterInducingScroll | kHitTestOpaqueness

#define INSTANTIATE_PAINT_TEST_SUITE_P(test_class) INSTANTIATE_TEST_SUITE_P(All, test_class, ::testing::Values(PAINT_TEST_SUITE_P_VALUES))
