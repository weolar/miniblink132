...
class ScopedFakeUkmRecorder : public ukm::mojom::UkmRecorderInterface, public ukm::mojom::UkmRecorderFactory {
public:
    ...
    void CreateUkmRecorder(
        mojo::PendingReceiver<ukm::mojom::UkmRecorderInterface> receiver, mojo::PendingRemote<ukm::mojom::UkmRecorderClientInterface> client_remote) override;
...
private:
    ...
    std::unique_ptr<mojo::Receiver<ukm::mojom::UkmRecorderInterface>> interface_receiver_;
