...
public:
    ...
    TestingPlatformSupportWithMockScheduler(const TestingPlatformSupportWithMockScheduler&) = delete;
    TestingPlatformSupportWithMockScheduler& operator=(const TestingPlatformSupportWithMockScheduler&) = delete;
...
protected:
    ...
    raw_ptr<base::sequence_manager::SequenceManager> sequence_manager_; // Owned by scheduler_.
};
