...
public:
    ...
    enum PairedBracketType { kBracketTypeNone, kBracketTypeOpen, kBracketTypeClose, kBracketTypeCount };

    static constexpr int kMaxUnicodeScriptExtensions = ScriptRunIterator::kMaxUnicodeScriptExtensions;
