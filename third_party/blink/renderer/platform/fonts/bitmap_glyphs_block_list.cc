...
bool BitmapGlyphsBlockList::ShouldAvoidEmbeddedBitmapsForTypeface(const SkTypeface& typeface)
{
    SkString font_family_name;
    typeface.getFamilyName(&font_family_name);
    return font_family_name.equals(kBitmapGlyphsBlockList[0]) || font_family_name.equals(kBitmapGlyphsBlockList[1]);
}
