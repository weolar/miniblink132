...
// font formatting.
class PLATFORM_EXPORT FontGlobalContext : public GarbageCollected<FontGlobalContext> {
public:
    ...
    static inline FontCache& GetFontCache()
    {
        return Get().font_cache_;
    }
    ...
    IdentifiableToken GetOrComputePostScriptNameDigest(const FontPlatformData& source);
...
private:
    ...
    base::HashingLRUCache<SkTypefaceID, IdentifiableToken> postscript_name_digest_cache_;
};
