...
public:
    ...
    static scoped_refptr<FontPalette> Mix(scoped_refptr<const FontPalette> start, scoped_refptr<const FontPalette> end, double start_percentage,
        double end_percentage, double normalized_percentage, double alpha_multiplier, Color::ColorSpace color_interpolation_space,
        std::optional<Color::HueInterpolationMethod> hue_interpolation_method)
    {
        return base::AdoptRef(new FontPalette(start, end, NonNormalizedPercentages(start_percentage, end_percentage), normalized_percentage, alpha_multiplier,
   ...
   * for this FontPalette object. */
    ...
    static NonNormalizedPercentages ComputeEndpointPercentagesFromNormalized(double normalized_percentage)
    {
    ...
    std::optional<Color::HueInterpolationMethod> GetHueInterpolationMethod() const
    {
        DCHECK(IsInterpolablePalette());
...
private:
    ...
    FontPalette(scoped_refptr<const FontPalette> start, scoped_refptr<const FontPalette> end, NonNormalizedPercentages percentages,
        double normalized_percentage, double alpha_multiplier, Color::ColorSpace color_interpoaltion_space,
        std::optional<Color::HueInterpolationMethod> hue_interpolation_method)
