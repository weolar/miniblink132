...
public:
   ...
   * SkTypeface objects.
   */
    static std::optional<uint16_t> FirstThemedPalette(sk_sp<SkTypeface> typeface, PaletteUse palette_use);
   ...
   */
    static Vector<Color> RetrieveColorRecords(sk_sp<SkTypeface> typeface, unsigned int palette_index);
};
