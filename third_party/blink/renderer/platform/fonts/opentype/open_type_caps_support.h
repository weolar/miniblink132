...
public:
    OpenTypeCapsSupport();
    OpenTypeCapsSupport(
        const HarfBuzzFace*, FontDescription::FontVariantCaps requested_caps, FontDescription::FontSynthesisSmallCaps font_synthesis_small_caps, hb_script_t);

    bool NeedsRunCaseSplitting();
    bool NeedsSyntheticFont(SmallCapsIterator::SmallCapsBehavior run_case);
    FontDescription::FontVariantCaps FontFeatureToUse(SmallCapsIterator::SmallCapsBehavior run_case);
...
private:
    ...
    FontDescription::FontVariantCaps requested_caps_ = FontDescription::kCapsNormal;
    FontDescription::FontSynthesisSmallCaps font_synthesis_small_caps_ = FontDescription::kAutoFontSynthesisSmallCaps;
    ...
    enum class CapsSynthesis { kNone, kLowerToSmallCaps, kUpperToSmallCaps, kBothToSmallCaps };
