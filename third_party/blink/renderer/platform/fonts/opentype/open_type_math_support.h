...
public:
    ...
    static Vector<OpenTypeMathStretchData::GlyphVariantRecord> GetGlyphVariantRecords(
        const HarfBuzzFace*, Glyph base_glyph, OpenTypeMathStretchData::StretchAxis);
    ...
    static Vector<OpenTypeMathStretchData::GlyphPartRecord> GetGlyphPartRecords(
        const HarfBuzzFace*, Glyph base_glyph, OpenTypeMathStretchData::StretchAxis, float* italic_correction = nullptr);
};
