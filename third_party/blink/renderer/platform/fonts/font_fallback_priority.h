...
{
    return fallback_priority == FontFallbackPriority::kEmojiText || fallback_priority == FontFallbackPriority::kEmojiEmoji
        || fallback_priority == FontFallbackPriority::kEmojiTextWithVS || fallback_priority == FontFallbackPriority::kEmojiEmojiWithVS;
}
