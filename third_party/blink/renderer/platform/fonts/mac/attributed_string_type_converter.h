...
template <> struct PLATFORM_EXPORT TypeConverter<ui::mojom::blink::AttributedStringPtr, CFAttributedStringRef> {
    static ui::mojom::blink::AttributedStringPtr Convert(CFAttributedStringRef cf_attributed_string);
};
