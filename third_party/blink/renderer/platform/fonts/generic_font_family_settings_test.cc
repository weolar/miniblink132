...
TEST(GenericFontFamilySettingsTest, TestAllNames)
{
    ...
    settings.UpdateSansSerif(AtomicString("CustomArabicSansSerif"), USCRIPT_ARABIC);
...
TEST(GenericFontFamilySettingsTest, TestSettingNotChanged)
{
    ...
    EXPECT_FALSE(settings.UpdateStandard(AtomicString("CustomArabicStandard"), USCRIPT_ARABIC));
    EXPECT_FALSE(settings.UpdateFixed(AtomicString("CustomArabicFixed"), USCRIPT_ARABIC));
    EXPECT_FALSE(settings.UpdateSerif(AtomicString("CustomArabicSerif"), USCRIPT_ARABIC));
    EXPECT_FALSE(settings.UpdateCursive(AtomicString("CustomArabicCursive"), USCRIPT_ARABIC));
    EXPECT_FALSE(settings.UpdateFantasy(AtomicString("CustomArabicFantasy"), USCRIPT_ARABIC));
    EXPECT_FALSE(settings.UpdateMath(AtomicString("CustomArabicMath"), USCRIPT_ARABIC));
}
