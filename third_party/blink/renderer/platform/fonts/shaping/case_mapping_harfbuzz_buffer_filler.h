...
public:
    CaseMappingHarfBuzzBufferFiller(
        CaseMapIntend, const AtomicString& locale, hb_buffer_t* harfbuzz_buffer, const String& text, unsigned start_index, unsigned num_characters);

private:
    void FillSlowCase(CaseMapIntend, const AtomicString& locale, const UChar* buffer, unsigned buffer_length, unsigned start_index, unsigned num_characters);
