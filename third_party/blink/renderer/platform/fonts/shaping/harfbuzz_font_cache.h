...
public:
    ...
    // implementation.
    HarfBuzzFontData* GetOrCreate(uint64_t unique_id, const FontPlatformData* platform_data);

private:
    HeapHashMap<uint64_t, WeakMember<HarfBuzzFontData>, IntWithZeroKeyHashTraits<uint64_t>> font_map_;
};
