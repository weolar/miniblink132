...
public:
    StretchyOperatorShaper(UChar32 stretchy_character, OpenTypeMathStretchData::StretchAxis stretch_axis)
    ...
    const ShapeResult* Shape(const Font*, float target_size, Metrics* metrics = nullptr) const;
