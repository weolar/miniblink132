...
{
    return mode == kForceVariationSelector15 || mode == kForceVariationSelector16 || mode == kUseUnicodeDefaultPresentation;
}

VariationSelectorMode GetVariationSelectorModeFromFontVariantEmoji(FontVariantEmoji font_variant_emoji)
{
