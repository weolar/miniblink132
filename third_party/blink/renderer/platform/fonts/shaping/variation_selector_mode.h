...
PLATFORM_EXPORT bool UseFontVariantEmojiVariationSelector(VariationSelectorMode mode);

PLATFORM_EXPORT VariationSelectorMode GetVariationSelectorModeFromFontVariantEmoji(FontVariantEmoji font_variant_emoji);
