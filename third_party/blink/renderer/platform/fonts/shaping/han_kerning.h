...
public:
    ...
    HanKerning(const String& text, wtf_size_t start, wtf_size_t end, const SimpleFontData& font_data, const FontDescription& font_description, Options options,
    ...
    struct PLATFORM_EXPORT FontData {
        FontData() = default;
        FontData(const SimpleFontData& font, const LayoutLocale& locale, bool is_horizontal);
...
private:
    ...
    void Compute(const String& text, wtf_size_t start, wtf_size_t end, const SimpleFontData& font_data, const FontDescription& font_description,
