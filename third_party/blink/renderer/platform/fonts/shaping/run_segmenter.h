...
public:
    ...
    struct PLATFORM_EXPORT RunSegmenterRange {
        ...
        OrientationIterator::RenderOrientation render_orientation = OrientationIterator::kOrientationKeep;
...
private:
    ...
    void ConsumeIteratorPastLastSplit(Iterator& iterator, unsigned* iterator_position, SegmentationCategory* segmentation_category);
