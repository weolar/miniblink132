...
struct FallbackExpectedRun {
    ...
    FallbackExpectedRun(unsigned the_limit, FontFallbackPriority the_font_fallback_priority)
        : limit(the_limit)
...
protected:
    void SetUp() override
    {
        ScopedFontVariantEmojiForTest scoped_feature(true);
    }
    ...
    void CheckRuns(const Vector<FallbackTestRun>& runs)
    {
        ...
        for (auto& run : runs) {
            ...
            expect.push_back(FallbackExpectedRun(text.length(), run.font_fallback_priority));
        }
        SymbolsIterator symbols_iterator(text.Span16());
        VerifyRuns(&symbols_iterator, expect);
    }

    void VerifyRuns(SymbolsIterator* symbols_iterator, const Vector<FallbackExpectedRun>& expect)
    {
        unsigned limit;
        FontFallbackPriority font_fallback_priority;
        size_t run_count = 0;
        while (symbols_iterator->Consume(&limit, &font_fallback_priority)) {
            ...
            ASSERT_EQ(expect[run_count].font_fallback_priority, font_fallback_priority);
            ++run_count;
        }
...
class SymbolsIteratorWithFontVariantEmojiParamTest : public SymbolsIteratorTest, public testing::WithParamInterface<bool> {
    void SetUp() override
    {
...
INSTANTIATE_TEST_SUITE_P(SymbolsIteratorTest, SymbolsIteratorWithFontVariantEmojiParamTest, testing::ValuesIn(FontVariantEmojiFlagValues));
...
{
    CheckRuns({ { "a", FontFallbackPriority::kText }, { "⌚", FontFallbackPriority::kEmojiEmoji }, { "☎", FontFallbackPriority::kText } });
}
...
TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, NumbersAndHashNormalAndEmoji)
{
...
{
    CheckRuns({ { "#", FontFallbackPriority::kText }, { "#\uFE0F\u20E3", FontFallbackPriority::kEmojiEmojiWithVS }, { "#", FontFallbackPriority::kText } });
}

TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, VS15onDigits)
{
    CheckRuns({ { "#", FontFallbackPriority::kText }, { "#\uFE0E\u20E3", FontFallbackPriority::kEmojiTextWithVS }, { "#", FontFallbackPriority::kText } });
}

TEST_F(SymbolsIteratorTest, EmojiVS15AndVS16)
{
    CheckRuns({ { "\U0001F642", FontFallbackPriority::kEmojiEmoji }, { "\U0001F642\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS },
        { "\U0001F642\U0000FE0F", FontFallbackPriority::kEmojiEmojiWithVS } });
}

TEST_F(SymbolsIteratorTest, EmojiVSSplitStartsWithText)
{
    CheckRuns({ { "abc", FontFallbackPriority::kText }, { "\U00002614", FontFallbackPriority::kEmojiEmoji }, { "\U00002603", FontFallbackPriority::kText },
        { "\U00002614\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS } });
}

TEST_F(SymbolsIteratorTest, EmojiVSSplitStartsWithEmoji)
{
    CheckRuns({ { "\U00002614\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS }, { "abc", FontFallbackPriority::kText },
        { "\U00002614\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS }, { "\U00002614", FontFallbackPriority::kEmojiEmoji },
        { "\U00002614\U0000FE0F", FontFallbackPriority::kEmojiEmojiWithVS } });
}

TEST_F(SymbolsIteratorTest, EmojiVSSplitWithExcessiveVS)
{
    CheckRuns({ { "\U00002603", FontFallbackPriority::kText }, { "\U00002603\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS },
        { "\U00002614\U0000FE0F", FontFallbackPriority::kEmojiEmojiWithVS }, { "\U00002614", FontFallbackPriority::kEmojiEmoji } });
}

TEST_F(SymbolsIteratorTest, EmojiAndTextVSSplit)
{
    CheckRuns({ { "\U00002603", FontFallbackPriority::kText }, { "\U00002603\U0000FE0F", FontFallbackPriority::kEmojiEmojiWithVS },
        { "\U00002614\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS }, { "\U00002614", FontFallbackPriority::kEmojiEmoji } });
}

TEST_F(SymbolsIteratorTest, EmojiTextVSSplit)
{
    CheckRuns({ { "\U00002614\U0000FE0F", FontFallbackPriority::kEmojiEmojiWithVS }, { "a\U00002603bc", FontFallbackPriority::kText },
        { "\U00002603\U0000FE0E\U00002614\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS } });
}
...
TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, CombiningEnclosingCircleBackslash)
{
    CheckRuns(
        { { "A⃠B⃠C⃠", FontFallbackPriority::kText }, { "🚷🚯🚱🔞📵🚭🚫🎙⃠📸⃠🔫⃠", FontFallbackPriority::kEmojiEmoji }, { "a⃠b⃠c⃠", FontFallbackPriority::kText } });
}
...
TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, FlagsVsNonFlags)
{
    CheckRuns({ { "🇺🇸", FontFallbackPriority::kEmojiEmoji }, // "US"
        { "🇸abc", FontFallbackPriority::kText }, { "🇺🇸", FontFallbackPriority::kEmojiEmoji }, { "a🇿", FontFallbackPriority::kText } });
}

TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, EmojiVS15)
{
    // A VS15 after the anchor must trigger text display.
    CheckRuns({ { "⚓\U0000FE0E", FontFallbackPriority::kEmojiTextWithVS }, { "⛵", FontFallbackPriority::kEmojiEmoji } });
}

TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, EmojiZWSSequences)
{
    CheckRuns({ { "👩‍👩‍👧‍👦👩‍❤️‍💋‍👨", FontFallbackPriority::kEmojiEmoji }, { "abcd", FontFallbackPriority::kText },
        { "\U0001F469\U0000200D\U0001F469", FontFallbackPriority::kEmojiEmoji }, { "\U0000200Defgh", FontFallbackPriority::kText } });
}
...
TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, FacepalmCartwheelShrugModifierFemale)
{
    CheckRuns({ { "🤦‍♀🤸‍♀🤷‍♀🤷🏾‍♀", FontFallbackPriority::kEmojiEmoji } });
}

TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, AesculapiusMaleFemalEmoji)
{
...
TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, DingbatsMiscSymbolsModifier)
{
    CheckRuns({ { "⛹🏻✍🏻✊🏼", FontFallbackPriority::kEmojiEmoji } });
}
...
{
    CheckRuns({ { "\U0000200D\U0000FE0E\U0000FE0E\U0000FE0E\U0000200D\U0000200D", FontFallbackPriority::kText },
        { "\U0001F469\U0000200D\U00002764\U0000FE0F\U0000200D\U0001F48B"
          "\U0000200D\U0001F468",
            FontFallbackPriority::kEmojiEmoji },
        { "\U0000200D\U0000FE0E\U0000FE0E\U0000FE0E\U0000200D\U0000200D", FontFallbackPriority::kText } });
}
...
{
    CheckRuns({ { "👨‍⚖️👩‍⚖️👨🏼‍⚖️👩🏼‍⚖️", FontFallbackPriority::kEmojiEmoji } });
}
...
TEST_P(SymbolsIteratorWithFontVariantEmojiParamTest, Emoji5AdditionsExceptFlags)
{
    CheckRuns({ { "\U0001F9D4\U0001F3FB\U0001F9D4\U0001F3FC\U0001F9D4\U0001F3FD"
...
{
    CheckRuns({ { "\U0001F970\U0001F975\U0001F976\U0001F973\U0001F974\U0001F97A"
