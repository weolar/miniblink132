...
TEST_F(FallbackListCompositeKeyTest, FontFamilies)
{
    ...
    font_description_a.SetFamily(FontFamily(font_family_names::kSerif, FontFamily::Type::kGenericFamily));
    FallbackListCompositeKey key_a = FallbackListCompositeKey(font_description_a);

    FontDescription font_description_b;
    font_description_b.SetFamily(FontFamily(font_family_names::kSerif, FontFamily::Type::kGenericFamily));
    ...
    font_description_a.SetFamily(FontFamily(font_family_names::kSerif, FontFamily::Type::kGenericFamily, next_family_a));
    ...
    font_description_b.SetFamily(FontFamily(font_family_names::kSerif, FontFamily::Type::kGenericFamily, next_family_b));
    ...
    font_description_a.SetFamily(FontFamily(font_family_names::kSerif, FontFamily::Type::kGenericFamily, next_family_a));
    key_a = FallbackListCompositeKey(font_description_a);
    next_family_a = SharedFontFamily::Create(AtomicString("CustomFont1b"), FontFamily::Type::kFamilyName);
    font_description_b.SetFamily(FontFamily(font_family_names::kSerif, FontFamily::Type::kGenericFamily, next_family_b));
    key_b = FallbackListCompositeKey(font_description_b);
    EXPECT_NE(key_a, key_b);
}
...
TEST_F(FallbackListCompositeKeyTest, GenericVsFamily)
{
    ...
    FontDescription font_description_b;
    font_description_b.SetFamily(FontFamily(font_family_names::kSerif, FontFamily::Type::kFamilyName));
    FallbackListCompositeKey key_b = FallbackListCompositeKey(font_description_b);
