...
public:
    static sk_sp<SkTypeface> FromFontConfigInterfaceIdAndTtcIndex(int config_id, int ttc_index);
    static sk_sp<SkTypeface> FromFilenameAndTtcIndex(const std::string& filename, int ttc_index);
};
