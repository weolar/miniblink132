...
{
    return output << String::Format("%d:%d (%s)", run.limit, run.code, uscript_getName(run.code));
}
...
protected:
    ...
    void CheckMockRuns(const Vector<ScriptTestRun>& runs)
    {
        ...
        ScriptRunIterator script_run_iterator(text.Span16(), MockScriptData::Instance());
        VerifyRuns(&script_run_iterator, expect);
    }

    void VerifyRuns(ScriptRunIterator* script_run_iterator, const Vector<ScriptExpectedRun>& expect)
    {
...
class JapaneseMixedScriptTest : public ScriptRunIteratorTest, public testing::WithParamInterface<JapaneseMixedScript> { };

INSTANTIATE_TEST_SUITE_P(ScriptRunIteratorTest, JapaneseMixedScriptTest, testing::ValuesIn(japanese_mixed_scripts));
...
{
    CHECK_SCRIPT_RUNS({ { "(萬", USCRIPT_HAN }, { "a]", USCRIPT_LATIN }, { ")", USCRIPT_HAN } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "Unicode (", USCRIPT_LATIN }, { "萬國碼", USCRIPT_HAN }, { ")", USCRIPT_LATIN } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "国「国", USCRIPT_HAN }, { "ア（", USCRIPT_HIRAGANA }, { "A", USCRIPT_LATIN },
        // The consecutive punctuation should not be split.
        { "）」", USCRIPT_HIRAGANA } });
}
...
TEST_F(ScriptRunIteratorTest, CJKConsecutiveParens4)
{
    CHECK_SCRIPT_RUNS({ { "A", USCRIPT_LATIN },
        ...
        { "「", USCRIPT_BOPOMOFO }, { "A", USCRIPT_LATIN }, { "あ（", USCRIPT_HIRAGANA },
        // The consecutive punctuation should not be split.
        { "国）」", USCRIPT_HAN } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "「あ", USCRIPT_HIRAGANA }, { "国", USCRIPT_HAN }, { "A", USCRIPT_LATIN }, { "」", USCRIPT_HIRAGANA } });
}

TEST_F(ScriptRunIteratorTest, CJKConsecutiveParens6)
{
    CHECK_SCRIPT_RUNS({ { "A", USCRIPT_LATIN }, { "「", USCRIPT_BOPOMOFO }, // See CJKConsecutiveParens4
        { "A", USCRIPT_LATIN }, { "あ（", USCRIPT_HIRAGANA }, { "国）", USCRIPT_HAN }, { "A", USCRIPT_LATIN }, { "」", USCRIPT_BOPOMOFO } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "「あ", USCRIPT_HIRAGANA }, { "国", USCRIPT_HAN }, { "A1", USCRIPT_LATIN }, { "」", USCRIPT_HIRAGANA } });
}

TEST_F(ScriptRunIteratorTest, CJKConsecutiveParens10)
{
    CHECK_SCRIPT_RUNS({ { "A", USCRIPT_LATIN }, { "「", USCRIPT_BOPOMOFO }, // See CJKConsecutiveParens4
        { "A", USCRIPT_LATIN }, { "あ（", USCRIPT_HIRAGANA }, { "国）", USCRIPT_HAN }, { "A1", USCRIPT_LATIN }, { "」", USCRIPT_BOPOMOFO } });
}

TEST_F(ScriptRunIteratorTest, CJKConsecutiveParensLatin1)
{
    CHECK_SCRIPT_RUNS({ { "「", USCRIPT_BOPOMOFO }, // See CJKConsecutiveParens4
        { "A", USCRIPT_LATIN }, { "「", USCRIPT_BOPOMOFO }, { "A", USCRIPT_LATIN }, { "」」", USCRIPT_BOPOMOFO } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "Unicode (", USCRIPT_LATIN }, { "萬國碼] ", USCRIPT_HAN }, { ") Unicode\"", USCRIPT_LATIN } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "((([萬國碼 ", USCRIPT_HAN }, { "Unicode (((((((((((((((((((((((((((((((", USCRIPT_LATIN }, { "萬國碼!", USCRIPT_HAN },
        { ")))))))))))))))))))))))))))))))", USCRIPT_LATIN }, { "]", USCRIPT_HAN }, { "But )))", USCRIPT_LATIN } });
}
...
{
    CHECK_MOCK_SCRIPT_RUNS(
        { { "<gl><(lg>", USCRIPT_GREEK }, { "h<[hl>", USCRIPT_HAN }, { "l", USCRIPT_LATIN }, { "<]hl>", USCRIPT_HAN }, { "<)lg>", USCRIPT_GREEK } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "萬國碼 ", USCRIPT_HAN }, { "\xE2\x97\x8C\xE0\xA5\x91", USCRIPT_BENGALI } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "Latin ", USCRIPT_LATIN }, { "\xD9\x80\xD9\x8B", USCRIPT_ARABIC } });
}
...
{
    CHECK_SCRIPT_RUNS({ { "萬國碼", USCRIPT_HAN }, { " \xE0\xA5\x91", USCRIPT_BENGALI } });
}
...
public:
    ...
    {
        std::tie(max_extensions_, max_extensions_codepoint_) = MaximumScriptExtensions();
    }
...
TEST_F(ScriptRunIteratorICUDataTest, ValidateICUMaxScriptExtensions)
{
    ...
    ASSERT_LE(max_extensions, ScriptData::kMaxScriptCount) << "char " << std::hex << cp << std::dec;
}
...
TEST_F(ScriptRunIteratorICUDataTest, ICUDataGetScriptsReturnsAllExtensions)
{
    ...
    ASSERT_GE(static_cast<int>(extensions.size()), max_extensions) << "char " << std::hex << cp << std::dec;
}
