...
BackForwardCacheBufferLimitTracker::BackForwardCacheBufferLimitTracker()
    : max_buffered_bytes_per_process_(GetLoadingTasksUnfreezableParamAsInt("max_buffered_bytes_per_process", kDefaultMaxBufferedBodyBytesPerProcess))
{
}
...
void BackForwardCacheBufferLimitTracker::DidBufferBytes(size_t num_bytes)
{
    ...
    TRACE_EVENT2("loading", "BackForwardCacheBufferLimitTracker::DidBufferBytes", "total_bytes_buffered", static_cast<int>(total_bytes_buffered_),
        "added_bytes", static_cast<int>(num_bytes));
}

void BackForwardCacheBufferLimitTracker::DidRemoveFrameOrWorkerFromBackForwardCache(size_t total_bytes)
{
    base::AutoLock lock(lock_);
    ...
    TRACE_EVENT2("loading",
        ...
        "total_bytes_buffered", static_cast<int>(total_bytes_buffered_), "substracted_bytes", static_cast<int>(total_bytes));
}
