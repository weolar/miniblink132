...
TEST(BlinkStorageKeyMojomTraitsTest, SerializeAndDeserialize_BlinkStorageKey)
{
    ...
    Vector<BlinkStorageKey> keys = {
        ...
        BlinkStorageKey::Create(origin1, site1, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::Create(origin2, site1, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::Create(origin3, site2, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::Create(origin4, site2, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::CreateWithNonce(origin1, nonce),
        BlinkStorageKey::CreateWithNonce(origin2, nonce),
        BlinkStorageKey::Create(origin2, site2, mojom::blink::AncestorChainBit::kCrossSite),
    ...
    for (BlinkStorageKey& key : keys) {
        ...
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::StorageKey>(key, copied));
        EXPECT_EQ(key, copied);
        EXPECT_TRUE(key.GetSecurityOrigin()->IsSameOriginWith(copied.GetSecurityOrigin().get()));
...
TEST(BlinkStorageKeyMojomTraitsTest, SerializeFromStorageKey_DeserializeToBlinkStorageKey)
{
    scoped_refptr<const SecurityOrigin> origin1 = SecurityOrigin::CreateUniqueOpaque();
    scoped_refptr<const SecurityOrigin> origin2 = SecurityOrigin::CreateFromString("http://example.site");
    scoped_refptr<const SecurityOrigin> origin3 = SecurityOrigin::CreateFromString("https://example.site");
    ...
    Vector<StorageKey> storage_keys = {
        ...
        StorageKey::Create(url_origin3, net_site2, mojom::blink::AncestorChainBit::kCrossSite),
        StorageKey::Create(url_origin4, net_site2, mojom::blink::AncestorChainBit::kCrossSite),
        StorageKey::CreateWithNonce(url_origin1, nonce),
        StorageKey::CreateWithNonce(url_origin2, nonce),
        StorageKey::Create(url_origin2, net_site2, mojom::blink::AncestorChainBit::kCrossSite),
        StorageKey::Create(url_origin1, net_site1, mojom::blink::AncestorChainBit::kCrossSite),
        StorageKey::Create(url_origin2, net_site1, mojom::blink::AncestorChainBit::kCrossSite),
    };
    Vector<BlinkStorageKey> blink_storage_keys = {
        ...
        BlinkStorageKey::CreateFirstParty(origin3),
        BlinkStorageKey::CreateFirstParty(origin4),
        BlinkStorageKey::Create(origin3, blink_site2, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::Create(origin4, blink_site2, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::CreateWithNonce(origin1, nonce),
        BlinkStorageKey::CreateWithNonce(origin2, nonce),
        BlinkStorageKey::Create(origin2, blink_site2, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::Create(origin1, blink_site1, mojom::blink::AncestorChainBit::kCrossSite),
        BlinkStorageKey::Create(origin2, blink_site1, mojom::blink::AncestorChainBit::kCrossSite),
    };
    ...
    for (size_t i = 0; i < storage_keys.size(); ++i) {
        ...
        EXPECT_EQ(blink_storage_keys[i].GetTopLevelSite(), deserialized.GetTopLevelSite());
    }
}

// Tests serializing from BlinkStorageKey and deserializing to StorageKey.
TEST(BlinkStorageKeyMojomTraitsTest, SerializeFromBlinkStorageKey_DeserializeToStorageKey)
{
    ...
    scoped_refptr<const SecurityOrigin> origin1 = SecurityOrigin::CreateFromUrlOrigin(url_origin1);
    scoped_refptr<const SecurityOrigin> origin2 = SecurityOrigin::CreateFromUrlOrigin(url_origin2);
    scoped_refptr<const SecurityOrigin> origin3 = SecurityOrigin::CreateFromUrlOrigin(url_origin3);
    scoped_refptr<const SecurityOrigin> origin4 = SecurityOrigin::CreateFromUrlOrigin(url_origin4);
    ...
    for (const bool toggle : { false, true }) {
        ...
        for (size_t i = 0; i < storage_keys.size(); ++i) {
            ...
            // `ancestor_chain_bit_`.
            EXPECT_EQ(storage_keys[i].CopyWithForceEnabledThirdPartyStoragePartitioning(), deserialized.CopyWithForceEnabledThirdPartyStoragePartitioning());
        }
    }
}
