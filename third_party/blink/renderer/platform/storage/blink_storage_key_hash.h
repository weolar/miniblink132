...
struct BlinkStorageKeyHashTraits : GenericHashTraits<std::unique_ptr<const BlinkStorageKey>> {
...
#error "Unknown bits"
    ...
    static unsigned GetHash(const std::unique_ptr<const BlinkStorageKey>& storage_key)
    {
    ...
    static bool Equal(const std::unique_ptr<const BlinkStorageKey>& a, const BlinkStorageKey* b)
    {
        return Equal(a.get(), b);
    }

    static bool Equal(const BlinkStorageKey* a, const std::unique_ptr<const BlinkStorageKey>& b)
    {
        return Equal(a, b.get());
    }

    static bool Equal(const std::unique_ptr<const BlinkStorageKey>& a, const std::unique_ptr<const BlinkStorageKey>& b)
    {
