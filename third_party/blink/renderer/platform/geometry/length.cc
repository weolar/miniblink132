...
void Length::Initialize()
{
    ...
    new (WTF::NotNullTag::kNotNull, (void*)&g_fit_content_length) Length(kFitContent);
    new (WTF::NotNullTag::kNotNull, (void*)&g_max_content_length) Length(kMaxContent);
    new (WTF::NotNullTag::kNotNull, (void*)&g_min_content_length) Length(kMinContent);
    new (WTF::NotNullTag::kNotNull, (void*)&g_min_intrinsic_length) Length(kMinIntrinsic);
}
...
String Length::ToString() const
{
    ...
    static const auto kTypeNames = std::to_array<const char* const>({ "Auto", "Percent", "Fixed", "MinContent", "MaxContent", "MinIntrinsic", "Stretch",
        "FitContent", "Calculated", "Flex", "ExtendToZoom", "DeviceWidth", "DeviceHeight", "None", "Content" });
