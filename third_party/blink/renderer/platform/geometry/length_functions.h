...
PLATFORM_EXPORT float FloatValueForLength(const Length&, float maximum_value, const EvaluationInput& = {});
PLATFORM_EXPORT LayoutUnit MinimumValueForLengthInternal(const Length&, LayoutUnit maximum_value, const EvaluationInput&);
...
PLATFORM_EXPORT gfx::SizeF SizeForLengthSize(const LengthSize&, const gfx::SizeF& box_size);
PLATFORM_EXPORT gfx::PointF PointForLengthPoint(const LengthPoint&, const gfx::SizeF& box_size);
