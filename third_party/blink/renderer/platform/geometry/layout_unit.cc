...
template <unsigned fractional_bits, typename Storage> String FromLayoutUnit(FixedPoint<fractional_bits, Storage> value)
{
...
template <unsigned fractional_bits, typename Storage> String FixedPoint<fractional_bits, Storage>::ToString() const
{
...
template <unsigned fractional_bits, typename Storage> std::ostream& operator<<(std::ostream& stream, const FixedPoint<fractional_bits, Storage>& value)
{
...
#define INSTANTIATE(fractional_bits, Storage)                                                                                                                  \
    ...
    template std::ostream& operator<<(std::ostream&, const FixedPoint<fractional_bits, Storage>&)
