...
template <typename T> static std::unique_ptr<JSONArray> RectAsJSONArray(const T& rect)
{
...
template <typename T> std::unique_ptr<JSONArray> PointAsJSONArray(const T& point)
{
...
template <typename T> std::unique_ptr<JSONArray> VectorAsJSONArray(const T& vector)
{
...
template <typename T> std::unique_ptr<JSONArray> SizeAsJSONArray(const T& size)
{
