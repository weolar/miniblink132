...
public:
    ...
    Length(LayoutUnit v, Length::Type t)
        : value_(v.ToFloat())
        , type_(t)
    {
    ...
    static const Length& Stretch()
    {
        return g_stretch_length;
    }
    static const Length& FitContent()
    {
        return g_fit_content_length;
    }
    static const Length& MaxContent()
    {
        return g_max_content_length;
    }
    static const Length& MinContent()
    {
        return g_min_content_length;
    }
    static const Length& MinIntrinsic()
    {
        return g_min_intrinsic_length;
    }

    static Length Content()
    {
        return Length(kContent);
    }
    static Length Fixed()
    {
    ...
    static Length ExtendToZoom()
    {
        return Length(kExtendToZoom);
    }
    static Length DeviceWidth()
    {
        return Length(kDeviceWidth);
    }
    static Length DeviceHeight()
    {
        return Length(kDeviceHeight);
    }

    template <typename NUMBER_TYPE> static Length Fixed(NUMBER_TYPE number)
    {
        return Length(number, kFixed);
    }
    template <typename NUMBER_TYPE> static Length Percent(NUMBER_TYPE number)
    {
        return Length(number, kPercent);
    }
    static Length Flex(float value)
    {
        return Length(value, kFlex);
    }
    ...
    Length::Type GetType() const
    {
        return static_cast<Length::Type>(type_);
    }
    bool Quirk() const
    {
        return quirk_;
    ...
    bool HasMinIntrinsic() const
    {
        return IsMinIntrinsic();
    }
    ...
    bool IsFlex() const
    {
        return GetType() == kFlex;
    }
    bool IsExtendToZoom() const
    {
        return GetType() == kExtendToZoom;
    }
    bool IsDeviceWidth() const
    {
        return GetType() == kDeviceWidth;
    }
    bool IsDeviceHeight() const
    {
        return GetType() == kDeviceHeight;
    }
