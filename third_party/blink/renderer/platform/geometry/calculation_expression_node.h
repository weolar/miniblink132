...
class PLATFORM_EXPORT CalculationExpressionNode : public RefCounted<CalculationExpressionNode> {
public:
    ...
    virtual scoped_refptr<const CalculationExpressionNode> Zoom(double factor) const = 0;
...
class PLATFORM_EXPORT CalculationExpressionNumberNode final : public CalculationExpressionNode {
public:
    CalculationExpressionNumberNode(float value)
        : value_(value)
    {
#if DCHECK_IS_ON()
    ...
    scoped_refptr<const CalculationExpressionNode> Zoom(double factor) const final;
...
template <> struct DowncastTraits<CalculationExpressionNumberNode> {
...
class PLATFORM_EXPORT CalculationExpressionIdentifierNode final : public CalculationExpressionNode {
public:
    ...
    bool Equals(const CalculationExpressionNode& other) const final
    {
        auto* other_identifier = DynamicTo<CalculationExpressionIdentifierNode>(other);
...
template <> struct DowncastTraits<CalculationExpressionIdentifierNode> {
    static bool AllowFrom(const CalculationExpressionNode& node)
    {
...
class PLATFORM_EXPORT CalculationExpressionSizingKeywordNode final : public CalculationExpressionNode {
public:
    ...
    bool Equals(const CalculationExpressionNode& other) const final
    {
        auto* other_sizing_keyword = DynamicTo<CalculationExpressionSizingKeywordNode>(other);
...
template <> struct DowncastTraits<CalculationExpressionSizingKeywordNode> {
    static bool AllowFrom(const CalculationExpressionNode& node)
    {
...
class PLATFORM_EXPORT CalculationExpressionColorChannelKeywordNode final : public CalculationExpressionNode {
public:
    explicit CalculationExpressionColorChannelKeywordNode(ColorChannelKeyword channel);
    ...
    bool Equals(const CalculationExpressionNode& other) const final
    {
        auto* other_color_channel_keyword = DynamicTo<CalculationExpressionColorChannelKeywordNode>(other);
...
template <> struct DowncastTraits<CalculationExpressionColorChannelKeywordNode> {
    static bool AllowFrom(const CalculationExpressionNode& node)
    {
...
class PLATFORM_EXPORT CalculationExpressionPixelsAndPercentNode final : public CalculationExpressionNode {
public:
...
template <> struct DowncastTraits<CalculationExpressionPixelsAndPercentNode> {
    static bool AllowFrom(const CalculationExpressionNode& node)
    {
...
class PLATFORM_EXPORT CalculationExpressionOperationNode final : public CalculationExpressionNode {
public:
    using Children = Vector<scoped_refptr<const CalculationExpressionNode>>;

    static scoped_refptr<const CalculationExpressionNode> CreateSimplified(Children&& children, CalculationOperator op);
...
template <> struct DowncastTraits<CalculationExpressionOperationNode> {
    static bool AllowFrom(const CalculationExpressionNode& node)
    {
