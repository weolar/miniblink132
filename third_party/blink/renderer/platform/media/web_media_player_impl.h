...
// Encrypted Media.
class PLATFORM_EXPORT WebMediaPlayerImpl : public WebMediaPlayer,
...
public:
    ...
    WebMediaPlayerImpl(WebLocalFrame* frame, MediaPlayerClient* client, WebMediaPlayerEncryptedMediaClient* encrypted_client, WebMediaPlayerDelegate* delegate,
        std::unique_ptr<media::RendererFactorySelector> renderer_factory_selector, UrlIndex* url_index, std::unique_ptr<VideoFrameCompositor> compositor,
        std::unique_ptr<media::MediaLog> media_log, media::MediaPlayerLoggingID player_id, WebMediaPlayerBuilder::DeferLoadCB defer_load_cb,
        scoped_refptr<media::SwitchableAudioRendererSink> audio_renderer_sink, scoped_refptr<base::SequencedTaskRunner> media_task_runner,
        scoped_refptr<base::TaskRunner> worker_task_runner, scoped_refptr<base::SingleThreadTaskRunner> compositor_task_runner,
        scoped_refptr<base::SingleThreadTaskRunner> video_frame_compositor_task_runner, WebContentDecryptionModule* initial_cdm,
        media::RequestRoutingTokenCallback request_routing_token_cb, base::WeakPtr<media::MediaObserver> media_observer, bool enable_instant_source_buffer_gc,
        bool embedded_media_experience_enabled, mojo::PendingRemote<media::mojom::MediaMetricsProvider> metrics_provider,
        ...
        bool is_background_suspend_enabled, bool is_background_video_play_enabled, bool is_background_video_track_optimization_supported,
    ...
    WebMediaPlayer::LoadTiming Load(LoadType load_type, const WebMediaPlayerSource& source, CorsMode cors_mode, bool is_cache_disabled) override;
    ...
    void SetWasPlayedWithUserActivationAndHighMediaEngagement(bool was_played_with_user_activation_and_high_media_engagement) override;
    ...
    void Paint(cc::PaintCanvas* canvas, const gfx::Rect& rect, cc::PaintFlags& flags) override;
    ...
    void EnabledAudioTracksChanged(const WebVector<WebMediaPlayer::TrackId>& enabled_track_ids) override;
    void SelectedVideoTrackChanged(std::optional<WebMediaPlayer::TrackId> selected_track_id) override;
    ...
    void SetShouldPauseWhenFrameIsHidden(bool should_pause_when_frame_is_hidden) override;
    ...
    void SetContentDecryptionModule(WebContentDecryptionModule* cdm, WebContentDecryptionModuleResult result) override;

    void EnteredFullscreen() override;
    void ExitedFullscreen() override;
    void BecameDominantVisibleContent(bool is_dominant) override;
    void SetIsEffectivelyFullscreen(WebFullscreenVideoStatus fullscreen_video_status) override;
    ...
    void SwitchToRemoteRenderer(const std::string& remote_device_friendly_name) override;
    void SwitchToLocalRenderer(media::MediaObserverClient::ReasonToSwitchToLocal reason) override;
    ...
    std::unique_ptr<WebMediaPlayer::VideoFramePresentationMetadata> GetVideoFramePresentationMetadata() override;
    ...
    constexpr static base::TimeDelta kMaxKeyframeDistanceToDisableBackgroundVideo = base::Milliseconds(5500);
...
private:
    ...
    template <uint32_t Flags, typename... T> void WriteSplitHistogram(void (*UmaFunction)(const std::string&, T...), SplitHistogramName key, const T&... value);
    ...
    void OnEncryptedMediaInitData(media::EmeInitDataType init_data_type, const std::vector<uint8_t>& init_data) override;
    ...
    void GetUrlData(const GURL& gurl, bool ignore_cache, base::OnceCallback<void(scoped_refptr<UrlData>)> cb);
    base::SequenceBound<media::HlsDataSourceProvider> GetHlsDataSourceProvider() override;
    ...
    void DoLoad(LoadType load_type, const KURL& url, CorsMode cors_mode, bool is_cache_disabled);
    ...
    // necessary).
    void OnOverlayInfoRequested(bool decoder_requires_restart_for_overlay, media::ProvideOverlayInfoCB provide_overlay_info_cb);
    ...
    std::unique_ptr<media::Renderer> CreateRenderer(std::optional<media::RendererType> renderer_type);
    ...
    PlayState UpdatePlayState_ComputePlayState(bool is_flinging, bool can_auto_suspend, bool is_suspended, bool is_backgrounded, bool is_in_picture_in_picture);
    ...
    void OnMainThreadMemoryDump(int32_t id, const base::trace_event::MemoryDumpArgs& args, base::trace_event::ProcessMemoryDump* pmd);
    static void OnMediaThreadMemoryDump(
        int32_t id, media::Demuxer* demuxer, const base::trace_event::MemoryDumpArgs& args, base::trace_event::ProcessMemoryDump* pmd);
    ...
    void OnBufferingStateChangeInternal(media::BufferingState state, media::BufferingStateChangeReason reason, bool for_suspended_start = false);
    ...
    void RecordEncryptionScheme(const std::string& stream_name, media::EncryptionScheme encryption_scheme);
    ...
    std::unique_ptr<media::learning::LearningTaskController> GetLearningTaskController(const char* task_name);
    ...
    media::PipelineStatus OnDemuxerCreated(media::Demuxer* demuxer, media::Pipeline::StartType start_type, bool is_streaming, bool is_static);
    ...
    WebMediaPlayer::NetworkState network_state_ = WebMediaPlayer::kNetworkStateEmpty;
    WebMediaPlayer::ReadyState ready_state_ = WebMediaPlayer::kReadyStateHaveNothing;
    WebMediaPlayer::ReadyState highest_ready_state_ = WebMediaPlayer::kReadyStateHaveNothing;
    ...
    std::unique_ptr<VideoFrameCompositor> compositor_; // Deleted on |vfc_task_runner_|.
    ...
    base::CancelableOnceCallback<void(const base::UnguessableToken&)> token_available_cb_;
    ...
    media::AudioDecoderType audio_decoder_type_ = media::AudioDecoderType::kUnknown;
    media::VideoDecoderType video_decoder_type_ = media::VideoDecoderType::kUnknown;
