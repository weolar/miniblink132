...
public:
    using CreateBatteryMonitorCB = base::RepeatingCallback<mojo::PendingRemote<device::mojom::blink::BatteryMonitor>()>;
...
private:
    ...
    static std::optional<int> BucketFor(bool is_playing, bool has_video, media::VideoCodec codec, media::VideoCodecProfile profile, gfx::Size natural_size,
    ...
    media::VideoCodecProfile profile_ = media::VideoCodecProfile::VIDEO_CODEC_PROFILE_UNKNOWN;
