...
public:
    ...
    MultiBufferReader(MultiBuffer* multibuffer, int64_t start, int64_t end, bool is_client_audio_element,
    ...
    // Getters
    int64_t preload_high() const
    {
        return preload_high_;
    }
    int64_t preload_low() const
    {
        return preload_low_;
    }
...
private:
    ...
    {
        return static_cast<MultiBufferBlockId>(byte_pos >> multibuffer_->block_size_shift());
    }
