...
PLATFORM_EXPORT uint32_t GetReasonsForUncacheability(const WebURLResponse& response);
...
PLATFORM_EXPORT base::TimeDelta GetCacheValidUntil(const WebURLResponse& response);
