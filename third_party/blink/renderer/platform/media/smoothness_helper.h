...
public:
    ...
    const media::learning::FeatureVector& features() const
    {
        return features_;
    }
    ...
    static std::unique_ptr<SmoothnessHelper> Create(std::unique_ptr<media::learning::LearningTaskController> bad_controller,
        std::unique_ptr<media::learning::LearningTaskController> nnr_controller, const media::learning::FeatureVector& features, Client* player);
