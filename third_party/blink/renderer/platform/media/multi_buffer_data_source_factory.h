...
class PLATFORM_EXPORT MultiBufferDataSourceFactory : public media::HlsDataSourceProviderImpl::DataSourceFactory {
public:
    using UrlDataCb = base::RepeatingCallback<void(const GURL& url, bool ignore_cache, base::OnceCallback<void(scoped_refptr<UrlData>)>)>;
...
private:
    void OnUrlData(DataSourceCb cb, base::RepeatingCallback<void(bool)> download_cb, scoped_refptr<UrlData> data);
