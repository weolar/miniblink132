...
public:
    ...
    WebURLResponse GeneratePartial206(int64_t first_byte_offset, int64_t last_byte_offset);

    // Generates a custom HTTP 206 response starting from |first_byte_offset|
    // until |last_byte_offset|. You can tweak what gets included in the
    // headers via |flags|.
    WebURLResponse GeneratePartial206(int64_t first_byte_offset, int64_t last_byte_offset, Flags flags);
