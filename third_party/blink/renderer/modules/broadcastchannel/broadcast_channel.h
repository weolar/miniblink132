...
class MODULES_EXPORT BroadcastChannel final : public EventTarget,
...
public:
    ...
    BroadcastChannel(base::PassKey<BroadcastChannelTester>, ExecutionContext*, const String& name,
        mojo::PendingAssociatedReceiver<mojom::blink::BroadcastChannelClient> receiver,
...
private:
    BroadcastChannel(ExecutionContext*, const String& name, mojo::PendingAssociatedReceiver<mojom::blink::BroadcastChannelClient> receiver,
        mojo::PendingAssociatedRemote<mojom::blink::BroadcastChannelClient> remote);
    ...
    HeapMojoAssociatedReceiver<mojom::blink::BroadcastChannelClient, BroadcastChannel> receiver_;
    ...
    HeapMojoAssociatedRemote<mojom::blink::BroadcastChannelProvider> associated_remote_;
};
