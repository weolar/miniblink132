...
public:
    ...
    static WTF::String getService(const V8BluetoothServiceUUID* name, ExceptionState& exception_state);
    static WTF::String getCharacteristic(const V8BluetoothCharacteristicUUID* name, ExceptionState& exception_state);
    static WTF::String getDescriptor(const V8BluetoothDescriptorUUID* name, ExceptionState& exception_state);
...
BLINK_EXPORT WTF::String GetBluetoothUUIDFromV8Value(const V8UnionStringOrUnsignedLong* value);
