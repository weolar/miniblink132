...
class BluetoothManufacturerDataMap final : public ScriptWrappable, public Maplike<BluetoothManufacturerDataMap> {
...
public:
    ...
    using MapType = HashMap<mojom::blink::WebBluetoothCompanyPtr, WTF::Vector<unsigned char>>;
...
private:
    PairSyncIterable<BluetoothManufacturerDataMap>::IterationSource* CreateIterationSource(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const uint16_t& key, NotShared<DOMDataView>& value, ExceptionState&) override;
