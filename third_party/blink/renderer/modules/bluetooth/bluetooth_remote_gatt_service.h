...
public:
    BluetoothRemoteGATTService(mojom::blink::WebBluetoothRemoteGATTServicePtr, bool is_primary, const String& device_instance_id, BluetoothDevice*);
    ...
    ScriptPromise<IDLSequence<BluetoothRemoteGATTCharacteristic>> getCharacteristics(
        ScriptState* script_state, const V8BluetoothCharacteristicUUID* characteristic, ExceptionState& exception_state);
    ScriptPromise<IDLSequence<BluetoothRemoteGATTCharacteristic>> getCharacteristics(ScriptState*, ExceptionState&);

private:
    void GetCharacteristicsCallback(const String& service_instance_id, const String& requested_characteristic_uuid, mojom::blink::WebBluetoothGATTQueryQuantity,
        ScriptPromiseResolverBase*, mojom::blink::WebBluetoothResult,
        std::optional<Vector<mojom::blink::WebBluetoothRemoteGATTCharacteristicPtr>> characteristics);

    ScriptPromise<IDLSequence<BluetoothRemoteGATTCharacteristic>> GetCharacteristicsImpl(
        ScriptState*, ExceptionState&, const String& characteristic_uuid = String());
