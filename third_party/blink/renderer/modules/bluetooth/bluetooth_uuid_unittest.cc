...
TEST(BluetoothUUIDTest, GetBluetoothUUIDFromV8Value_CanonicalUUID)
{
    ...
    V8UnionStringOrUnsignedLong* v8_uuid = MakeGarbageCollected<V8UnionStringOrUnsignedLong>(expected_uuid);
...
TEST(BluetoothUUIDTest, GetBluetoothUUIDFromV8Value_16bitUUID)
{
    ...
    V8UnionStringOrUnsignedLong* v8_uuid = MakeGarbageCollected<V8UnionStringOrUnsignedLong>(0x1101);
    String uuid = GetBluetoothUUIDFromV8Value(v8_uuid);
    EXPECT_EQ(uuid, expected_uuid);
}
...
{
    test::TaskEnvironment task_environment;
    V8UnionStringOrUnsignedLong* v8_uuid = MakeGarbageCollected<V8UnionStringOrUnsignedLong>("");
    String uuid = GetBluetoothUUIDFromV8Value(v8_uuid);
...
TEST(BluetoothUUIDTest, GetBluetoothUUIDFromV8Value_BluetoothName)
{
    ...
    V8UnionStringOrUnsignedLong* v8_uuid = MakeGarbageCollected<V8UnionStringOrUnsignedLong>("height");
    String uuid = GetBluetoothUUIDFromV8Value(v8_uuid);
    EXPECT_TRUE(uuid.empty());
}
...
{
    test::TaskEnvironment task_environment;
    V8UnionStringOrUnsignedLong* v8_uuid = MakeGarbageCollected<V8UnionStringOrUnsignedLong>("00000000-0000-0000-0000-000000000000-X");
    String uuid = GetBluetoothUUIDFromV8Value(v8_uuid);
    EXPECT_TRUE(uuid.empty());
}
