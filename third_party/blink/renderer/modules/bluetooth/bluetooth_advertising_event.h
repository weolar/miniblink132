...
public:
    BluetoothAdvertisingEvent(const AtomicString& event_type, BluetoothDevice* device, mojom::blink::WebBluetoothAdvertisingEventPtr advertising_event);
    ...
    std::optional<int8_t> txPower() const
    {
        return txPower_;
    }
