...
class Bluetooth final : public EventTarget, public Supplement<Navigator>, public PageVisibilityObserver, public mojom::blink::WebBluetoothAdvertisementClient {
...
public:
    ...
    ScriptPromise<IDLSequence<BluetoothDevice>> getDevices(ScriptState*, ExceptionState&);
    ScriptPromise<BluetoothDevice> requestDevice(ScriptState*, const RequestDeviceOptions*, ExceptionState&);

    ScriptPromise<BluetoothLEScan> requestLEScan(ScriptState*, const BluetoothLEScanOptions*, ExceptionState&);
    ...
    BluetoothAdvertisingEvent* CreateBluetoothAdvertisingEvent(mojom::blink::WebBluetoothAdvertisingEventPtr advertising_event);

private:
    BluetoothDevice* GetBluetoothDeviceRepresentingDevice(mojom::blink::WebBluetoothDevicePtr, ExecutionContext*);

    void GetDevicesCallback(ScriptPromiseResolver<IDLSequence<BluetoothDevice>>*, Vector<mojom::blink::WebBluetoothDevicePtr>);

    void RequestDeviceCallback(ScriptPromiseResolver<BluetoothDevice>*, mojom::blink::WebBluetoothResult, mojom::blink::WebBluetoothDevicePtr);

    void RequestScanningCallback(
        ScriptPromiseResolver<BluetoothLEScan>*, mojo::ReceiverId, mojom::blink::WebBluetoothRequestLEScanOptionsPtr, mojom::blink::WebBluetoothResult);
    ...
    HeapMojoAssociatedReceiverSet<mojom::blink::WebBluetoothAdvertisementClient, Bluetooth> client_receivers_;
