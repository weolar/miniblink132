...
class BluetoothServiceDataMap final : public ScriptWrappable, public Maplike<BluetoothServiceDataMap> {
...
private:
    PairSyncIterable<BluetoothServiceDataMap>::IterationSource* CreateIterationSource(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, NotShared<DOMDataView>& value, ExceptionState&) override;
