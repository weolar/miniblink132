...
class BluetoothRemoteGATTServer : public ScriptWrappable, public mojom::blink::WebBluetoothServerClient {
...
public:
    ...
    ScriptPromise<BluetoothRemoteGATTServer> connect(ScriptState*, ExceptionState&);
    ...
    ScriptPromise<IDLSequence<BluetoothRemoteGATTService>> getPrimaryServices(
        ScriptState* script_state, const V8BluetoothServiceUUID* service, ExceptionState& exception_state);
    ScriptPromise<IDLSequence<BluetoothRemoteGATTService>> getPrimaryServices(ScriptState*, ExceptionState&);

private:
    void GetPrimaryServicesImpl(ScriptPromiseResolverBase*, mojom::blink::WebBluetoothGATTQueryQuantity, String service_uuid = String());

    void ConnectCallback(ScriptPromiseResolver<BluetoothRemoteGATTServer>*, mojom::blink::WebBluetoothResult);
    void GetPrimaryServicesCallback(const String& requested_service_uuid, mojom::blink::WebBluetoothGATTQueryQuantity, ScriptPromiseResolverBase*,
        mojom::blink::WebBluetoothResult, std::optional<Vector<mojom::blink::WebBluetoothRemoteGATTServicePtr>> services);
    ...
    HeapMojoAssociatedReceiverSet<mojom::blink::WebBluetoothServerClient, BluetoothRemoteGATTServer> client_receivers_;
