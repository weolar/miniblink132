...
class BluetoothRemoteGATTCharacteristic final : public EventTarget,
...
public:
    explicit BluetoothRemoteGATTCharacteristic(
        ExecutionContext*, mojom::blink::WebBluetoothRemoteGATTCharacteristicPtr, BluetoothRemoteGATTService*, BluetoothDevice*);
    ...
    ScriptPromise<IDLSequence<BluetoothRemoteGATTDescriptor>> getDescriptors(ScriptState*, ExceptionState&);
    ScriptPromise<IDLSequence<BluetoothRemoteGATTDescriptor>> getDescriptors(
        ScriptState* script_state, const V8BluetoothDescriptorUUID* descriptor_uuid, ExceptionState& exception_state);
    ScriptPromise<NotShared<DOMDataView>> readValue(ScriptState*, ExceptionState&);
    ScriptPromise<IDLUndefined> writeValue(ScriptState*, base::span<const uint8_t> value, ExceptionState&);
    ScriptPromise<IDLUndefined> writeValueWithResponse(ScriptState*, base::span<const uint8_t> value, ExceptionState&);
    ScriptPromise<IDLUndefined> writeValueWithoutResponse(ScriptState*, base::span<const uint8_t> value, ExceptionState&);
    ScriptPromise<BluetoothRemoteGATTCharacteristic> startNotifications(ScriptState*, ExceptionState&);
    ScriptPromise<BluetoothRemoteGATTCharacteristic> stopNotifications(ScriptState*, ExceptionState&);

    DEFINE_ATTRIBUTE_EVENT_LISTENER(characteristicvaluechanged, kCharacteristicvaluechanged)
...
private:
    ...
    struct DeferredValueChange : public GarbageCollected<DeferredValueChange> {
        DeferredValueChange(Member<Event> event, Member<DOMDataView> dom_data_view, ScriptPromiseResolver<NotShared<DOMDataView>>* resolver)
            : event(event)
            , dom_data_view(dom_data_view)
            , resolver(resolver)
        {
        }
    ...
    {
        return device_->GetBluetooth();
    }

    void ReadValueCallback(ScriptPromiseResolver<NotShared<DOMDataView>>*, mojom::blink::WebBluetoothResult, base::span<const uint8_t> value);
    void WriteValueCallback(ScriptPromiseResolver<IDLUndefined>*, DOMDataView* new_value, mojom::blink::WebBluetoothResult);
    ...
    void NotificationsCallback(ScriptPromiseResolver<BluetoothRemoteGATTCharacteristic>*, bool started, mojom::blink::WebBluetoothResult);

    ScriptPromise<IDLUndefined> WriteCharacteristicValue(ScriptState*, base::span<const uint8_t> value, mojom::blink::WebBluetoothWriteType, ExceptionState&);

    ScriptPromise<IDLSequence<BluetoothRemoteGATTDescriptor>> GetDescriptorsImpl(ScriptState*, ExceptionState&, const String& descriptor_uuid = String());

    void GetDescriptorsCallback(const String& requested_descriptor_uuid, const String& characteristic_instance_id, mojom::blink::WebBluetoothGATTQueryQuantity,
        ScriptPromiseResolverBase*, mojom::blink::WebBluetoothResult, std::optional<Vector<mojom::blink::WebBluetoothRemoteGATTDescriptorPtr>> descriptors);
    ...
    HeapMojoAssociatedReceiverSet<mojom::blink::WebBluetoothCharacteristicClient, BluetoothRemoteGATTCharacteristic> receivers_;
