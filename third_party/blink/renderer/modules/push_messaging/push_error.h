...
public:
    ...
    static DOMException* Take(ScriptPromiseResolverBase* resolver, mojom::PushErrorType error)
    {
        return CreateException(error);
    }

    static DOMException* CreateException(mojom::PushErrorType error, const String& message = String());
};
