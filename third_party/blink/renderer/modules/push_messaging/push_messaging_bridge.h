...
class PushMessagingBridge final : public GarbageCollected<PushMessagingBridge>, public Supplement<ServiceWorkerRegistration> {
public:
    ...
    ScriptPromise<V8PermissionState> GetPermissionState(ScriptState* script_state, const PushSubscriptionOptionsInit* options);
...
private:
    ...
    void DidGetPermissionState(ScriptPromiseResolver<V8PermissionState>* resolver, mojom::blink::PermissionStatus status);
