...
class PushSubscriptionCallbacks final : public WebCallbacks<PushSubscription*, DOMException*> {
...
public:
    ...
    PushSubscriptionCallbacks& operator=(const PushSubscriptionCallbacks&) = delete;
