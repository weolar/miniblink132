...
public:
    ...
    // Web-exposed methods:
    ScriptPromise<PushSubscription> subscribe(ScriptState* script_state, const PushSubscriptionOptionsInit* options_init, ExceptionState& exception_state);
    ScriptPromise<IDLNullable<PushSubscription>> getSubscription(ScriptState* script_state);
    ScriptPromise<V8PermissionState> permissionState(ScriptState* script_state, const PushSubscriptionOptionsInit* options, ExceptionState& exception_state);
