...
class ServiceWorkerRegistrationPush final : public GarbageCollected<ServiceWorkerRegistrationPush>, public Supplement<ServiceWorkerRegistration> {
public:
    static const char kSupplementName[];

    explicit ServiceWorkerRegistrationPush(ServiceWorkerRegistration* registration);
    ...
    static ServiceWorkerRegistrationPush& From(ServiceWorkerRegistration& registration);
