...
public:
    ...
    static MODULES_EXPORT PushSubscriptionOptions* FromOptionsInit(const PushSubscriptionOptionsInit* options_init, ExceptionState& exception_state);

    explicit PushSubscriptionOptions(bool user_visible_only, const WTF::Vector<uint8_t>& application_server_key);
