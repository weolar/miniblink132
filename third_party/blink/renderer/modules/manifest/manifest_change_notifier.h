...
class MODULES_EXPORT ManifestChangeNotifier : public GarbageCollected<ManifestChangeNotifier> {
public:
...
private:
    ...
    HeapMojoAssociatedRemote<mojom::blink::ManifestUrlChangeObserver> manifest_change_observer_;
