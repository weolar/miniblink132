...
TEST(ImageResourceConverter, EmptySizesTest)
{
    ...
    blink::ManifestImageResource* resource = blink::ManifestImageResource::Create();
...
TEST(ImageResourceConverter, BlinkToMojoTypeTest)
{
    ...
    blink::Manifest::ImageResource mojo_icon = blink::ConvertManifestImageResource(icon);
    ...
    EXPECT_EQ(mojo_icon.purpose[0], blink::mojom::ManifestImageResource_Purpose::MONOCHROME);
}
