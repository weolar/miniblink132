...
class ManifestFetcher final : public GarbageCollected<ManifestFetcher>, public ThreadableLoaderClient {
    ...
    using Callback = base::OnceCallback<void(const ResourceResponse&, const String&)>;
...
public:
    ...
    void Start(LocalDOMWindow& window, bool use_credentials, ResourceFetcher* resource_fetcher, ManifestFetcher::Callback callback);
    void Cancel();
