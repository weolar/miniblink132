...
class Lock final : public ScriptWrappable, public ExecutionContextLifecycleObserver {
    DEFINE_WRAPPERTYPEINFO();

public:
    Lock(ScriptState*, const String& name, mojom::blink::LockMode, mojo::PendingAssociatedRemote<mojom::blink::LockHandle>,
        mojo::PendingRemote<mojom::blink::ObservedFeature>, LockManager*);
    ~Lock() override;
