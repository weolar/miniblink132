...
class LockManager final : public ScriptWrappable, public Supplement<NavigatorBase>, public ExecutionContextLifecycleObserver {
...
public:
    ...
    ScriptPromise<IDLAny> request(ScriptState*, const String& name, V8LockGrantedCallback*, ExceptionState&);
    ScriptPromise<IDLAny> request(ScriptState*, const String& name, const LockOptions*, V8LockGrantedCallback*, ExceptionState&);
    ...
    void SetManager(mojo::PendingRemote<mojom::blink::LockManager> manager, ExecutionContext* execution_context);
...
private:
    ...
    void CheckStorageAccessAllowed(ExecutionContext* context, ScriptPromiseResolverBase* resolver, base::OnceCallback<void()> callback);
    void DidCheckStorageAccessAllowed(ScriptPromiseResolverBase* resolver, base::OnceCallback<void()> callback, bool allow_access);
