...
class MODULES_EXPORT PressureClientImpl final : public GarbageCollected<PressureClientImpl>,
...
public:
    ...
    void BindPressureClient(mojo::PendingReceiver<device::mojom::blink::PressureClient>);
...
private:
    ...
    HeapMojoReceiver<device::mojom::blink::PressureClient, PressureClientImpl> receiver_;
