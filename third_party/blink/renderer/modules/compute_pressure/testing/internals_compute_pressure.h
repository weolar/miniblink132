...
public:
    static ScriptPromise<IDLUndefined> createVirtualPressureSource(
        ScriptState* script_state, Internals&, V8PressureSource source, CreateVirtualPressureSourceOptions*);

    static ScriptPromise<IDLUndefined> removeVirtualPressureSource(ScriptState* script_state, Internals&, V8PressureSource source);

    static ScriptPromise<IDLUndefined> updateVirtualPressureSource(ScriptState* script_state, Internals&, V8PressureSource posture, V8PressureState state);
};
