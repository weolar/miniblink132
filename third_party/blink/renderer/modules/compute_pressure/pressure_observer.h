...
public:
    ...
    ScriptPromise<IDLUndefined> observe(ScriptState*, V8PressureSource, PressureObserverOptions*, ExceptionState&);
    ...
    void OnUpdate(ExecutionContext*, V8PressureSource::Enum, V8PressureState::Enum, DOMHighResTimeStamp);
...
private:
    ...
    void QueuePressureRecord(ExecutionContext*, V8PressureSource::Enum, PressureRecord*);

    // Resolve/reject pending resolvers.
    void ResolvePendingResolvers(V8PressureSource::Enum);
    void RejectPendingResolvers(V8PressureSource::Enum, DOMExceptionCode, const String&);
    ...
    std::array<HeapHashSet<Member<ScriptPromiseResolver<IDLUndefined>>>, V8PressureSource::kEnumSize> pending_resolvers_;
    ...
    std::array<Member<PressureRecord>, V8PressureSource::kEnumSize> last_record_map_;
    ...
    std::array<Member<PressureRecord>, V8PressureSource::kEnumSize> after_penalty_records_;
    ...
    std::array<TaskHandle, V8PressureSource::kEnumSize> pending_delayed_report_to_callback_;
};
