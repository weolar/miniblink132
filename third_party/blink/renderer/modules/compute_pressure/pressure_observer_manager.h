...
class MODULES_EXPORT PressureObserverManager final : public GarbageCollected<PressureObserverManager>,
...
private:
    ...
    void DidAddClient(V8PressureSource::Enum, device::mojom::blink::PressureManagerAddClientResultPtr);

    // Connection to the browser side implementation.
    HeapMojoRemote<mojom::blink::WebPressureManager> pressure_manager_;

    HeapHashMap<V8PressureSource::Enum, Member<PressureClientImpl>> source_to_client_;
};
