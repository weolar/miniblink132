...
public:
    static NDEFReadingEvent* Create(const ScriptState*, const AtomicString&, const NDEFReadingEventInit*, ExceptionState&);

    NDEFReadingEvent(const AtomicString&, const NDEFReadingEventInit*, NDEFMessage*);
