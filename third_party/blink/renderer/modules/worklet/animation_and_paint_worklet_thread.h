...
// collection process.
class MODULES_EXPORT AnimationAndPaintWorkletThread final : public WorkerThread {
public:
    static std::unique_ptr<AnimationAndPaintWorkletThread> CreateForAnimationWorklet(WorkerReportingProxy&);
    static std::unique_ptr<AnimationAndPaintWorkletThread> CreateForPaintWorklet(WorkerReportingProxy&);
    ...
    static WorkletThreadHolder<AnimationAndPaintWorkletThread>* GetWorkletThreadHolderForTesting();
...
private:
    ...
    WorkerOrWorkletGlobalScope* CreateWorkerGlobalScope(std::unique_ptr<GlobalScopeCreationParams>) final;
