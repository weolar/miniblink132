...
class AppBannerController final : public GarbageCollected<AppBannerController>, public Supplement<LocalDOMWindow>, public mojom::blink::AppBannerController {
public:
    static const char kSupplementName[];
    static AppBannerController* From(LocalDOMWindow&);
    static void BindReceiver(LocalFrame*, mojo::PendingReceiver<mojom::blink::AppBannerController>);

    explicit AppBannerController(base::PassKey<AppBannerController>, LocalDOMWindow&);
    ...
    void BannerPromptRequest(mojo::PendingRemote<mojom::blink::AppBannerService>, mojo::PendingReceiver<mojom::blink::AppBannerEvent>,
        const Vector<String>& platforms, BannerPromptRequestCallback) override;

private:
    void Bind(mojo::PendingReceiver<mojom::blink::AppBannerController> receiver);

    HeapMojoReceiver<mojom::blink::AppBannerController, AppBannerController> receiver_;
};
