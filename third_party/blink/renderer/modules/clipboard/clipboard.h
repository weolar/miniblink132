...
public:
    ...
    ScriptPromise<IDLSequence<ClipboardItem>> read(ScriptState*, ClipboardUnsanitizedFormats* formats, ExceptionState&);
    ScriptPromise<IDLSequence<ClipboardItem>> read(ScriptState* script_state, ExceptionState& exception_state)
    {
        return read(script_state, nullptr, exception_state);
    }
    ScriptPromise<IDLString> readText(ScriptState*, ExceptionState&);

    ScriptPromise<IDLUndefined> write(ScriptState*, const HeapVector<Member<ClipboardItem>>&, ExceptionState&);
    ScriptPromise<IDLUndefined> writeText(ScriptState*, const String&, ExceptionState&);
