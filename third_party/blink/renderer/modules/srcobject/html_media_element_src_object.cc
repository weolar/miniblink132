...
// static
V8MediaProvider* HTMLMediaElementSrcObject::srcObject(HTMLMediaElement& element)
{
//     HTMLMediaElement::SrcObjectVariant src_object_variant = element.GetSrcObjectVariant();
// 
...
//         return MakeGarbageCollected<V8MediaProvider>(static_cast<MediaSourceHandleImpl*>(handle));
//     }
// 
...
// static
void HTMLMediaElementSrcObject::setSrcObject(HTMLMediaElement& element, V8MediaProvider* media_provider)
{
//     if (!media_provider) {
