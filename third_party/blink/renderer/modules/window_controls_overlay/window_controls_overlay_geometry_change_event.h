...
public:
    static WindowControlsOverlayGeometryChangeEvent* Create(const AtomicString& type, const WindowControlsOverlayGeometryChangeEventInit*);

    WindowControlsOverlayGeometryChangeEvent(const AtomicString& type, const WindowControlsOverlayGeometryChangeEventInit*);
    WindowControlsOverlayGeometryChangeEvent(const AtomicString& type, DOMRect* rect, bool visible);
