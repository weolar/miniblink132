...
WindowControlsOverlayGeometryChangeEvent* WindowControlsOverlayGeometryChangeEvent::Create(
    const AtomicString& type, const WindowControlsOverlayGeometryChangeEventInit* initializer)
{
    return MakeGarbageCollected<WindowControlsOverlayGeometryChangeEvent>(type, initializer);
}
...
WindowControlsOverlayGeometryChangeEvent::WindowControlsOverlayGeometryChangeEvent(const AtomicString& type, DOMRect* rect, bool visible)
