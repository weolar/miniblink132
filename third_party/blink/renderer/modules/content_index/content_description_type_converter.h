...
template <> struct MODULES_EXPORT TypeConverter<blink::mojom::blink::ContentDescriptionPtr, const blink::ContentDescription*> {
    static blink::mojom::blink::ContentDescriptionPtr Convert(const blink::ContentDescription* description);
};

template <> struct MODULES_EXPORT TypeConverter<blink::ContentDescription*, blink::mojom::blink::ContentDescriptionPtr> {
    static blink::ContentDescription* Convert(const blink::mojom::blink::ContentDescriptionPtr& description);
};
