...
AutoCanvasDrawListener::AutoCanvasDrawListener(std::unique_ptr<CanvasCaptureHandler> handler)
    : handler_(std::move(handler))
    , frame_capture_requested_(true)
{
}

CanvasDrawListener::NewFrameCallback AutoCanvasDrawListener::GetNewFrameCallback()
{
