...
public:
    static MediaStream* captureStream(ScriptState*, HTMLCanvasElement&, ExceptionState&);
    static MediaStream* captureStream(ScriptState*, HTMLCanvasElement&, double frame_rate, ExceptionState&);

private:
    static MediaStream* captureStream(ScriptState*, HTMLCanvasElement&, bool given_frame_rate, double frame_rate, ExceptionState&);
};
