...
OnRequestCanvasDrawListener::OnRequestCanvasDrawListener(std::unique_ptr<CanvasCaptureHandler> handler)
...
CanvasDrawListener::NewFrameCallback OnRequestCanvasDrawListener::GetNewFrameCallback()
{
