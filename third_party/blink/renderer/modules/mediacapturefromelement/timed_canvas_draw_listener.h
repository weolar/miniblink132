...
public:
    TimedCanvasDrawListener(std::unique_ptr<CanvasCaptureHandler>, double frame_rate, ExecutionContext*);
    ~TimedCanvasDrawListener() override;

    static TimedCanvasDrawListener* Create(std::unique_ptr<CanvasCaptureHandler>, double frame_rate, ExecutionContext*);
