...
class MODULES_EXPORT WebPrintingManager : public ScriptWrappable, public Supplement<NavigatorBase> {
...
public:
    ...
    ScriptPromise<IDLSequence<WebPrinter>> getPrinters(ScriptState*, ExceptionState&);
...
private:
    ...
    void OnPrintersRetrieved(ScriptPromiseResolver<IDLSequence<WebPrinter>>*, mojom::blink::GetPrintersResultPtr result);
