...
class MODULES_EXPORT WebPrintJob : public EventTarget,
...
public:
    WebPrintJob(ExecutionContext* execution_context, mojom::blink::WebPrintJobInfoPtr print_job_info);
    ~WebPrintJob() override;

    // Web-exposed interfaces:
    WebPrintJobAttributes* attributes() const
    {
        return attributes_;
    }
    void cancel();
...
private:
    ...
    HeapMojoReceiver<mojom::blink::WebPrintJobStateObserver, WebPrintJob> observer_;
