...
class SmartCardContext final : public ScriptWrappable, public ExecutionContextClient {
    DEFINE_WRAPPERTYPEINFO();

public:
    SmartCardContext(mojo::PendingRemote<device::mojom::blink::SmartCardContext>, ExecutionContext*);

    // SmartCardContext idl
    ScriptPromise<IDLSequence<IDLString>> listReaders(ScriptState* script_state, ExceptionState& exception_state);

    ScriptPromise<IDLSequence<SmartCardReaderStateOut>> getStatusChange(ScriptState* script_state,
    ...
    ScriptPromise<SmartCardConnectResult> connect(ScriptState* script_state, const String& reader_name, V8SmartCardAccessMode access_mode,
        SmartCardConnectOptions* options, ExceptionState& exception_state);
...
private:
    ...
    void OnListReadersDone(ScriptPromiseResolver<IDLSequence<IDLString>>* resolver, device::mojom::blink::SmartCardListReadersResultPtr);
    void OnGetStatusChangeDone(ScriptPromiseResolver<IDLSequence<SmartCardReaderStateOut>>* resolver, AbortSignal* signal,
    ...
    void OnConnectDone(ScriptPromiseResolver<SmartCardConnectResult>* resolver, device::mojom::blink::SmartCardConnectResultPtr result);
