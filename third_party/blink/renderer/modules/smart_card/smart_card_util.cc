...
device::mojom::blink::SmartCardShareMode ToMojoSmartCardShareMode(V8SmartCardAccessMode access_mode)
{
...
device::mojom::blink::SmartCardProtocolsPtr ToMojoSmartCardProtocols(const Vector<V8SmartCardProtocol>& preferred_protocols)
{
...
void RejectWithAbortionReason(ScriptPromiseResolverBase* resolver, AbortSignal* signal)
{
