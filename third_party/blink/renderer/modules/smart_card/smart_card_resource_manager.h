...
class MODULES_EXPORT SmartCardResourceManager final : public ScriptWrappable, public Supplement<NavigatorBase>, public ExecutionContextLifecycleObserver {
...
public:
    ...
    ScriptPromise<SmartCardContext> establishContext(ScriptState* script_state, ExceptionState& exception_state);

private:
    void EnsureServiceConnection();
    void CloseServiceConnection();

    void OnCreateContextDone(ScriptPromiseResolver<SmartCardContext>*, device::mojom::blink::SmartCardCreateContextResultPtr);

    HeapMojoRemote<mojom::blink::SmartCardService> service_;
    HeapHashSet<Member<ScriptPromiseResolver<SmartCardContext>>> create_context_promises_;
};
