...
public:
    ...
    {
        return object_ && target_;
    }

    WebGLProgram* GetProgram() const
    {
        return program_.Get();
    }
    ...
    bool GetBoundIndexedTransformFeedbackBuffer(GLuint index, WebGLBuffer** outBuffer) const;
    ...
    const HeapVector<Member<WebGLBuffer>>& bound_indexed_transform_feedback_buffers() const
    {
