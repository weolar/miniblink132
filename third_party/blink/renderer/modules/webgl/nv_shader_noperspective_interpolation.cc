...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_NV_shader_noperspective_interpolation");
}
...
bool NVShaderNoperspectiveInterpolation::Supported(WebGLRenderingContextBase* context)
{
    return context->ExtensionsUtil()->SupportsExtension("GL_NV_shader_noperspective_interpolation");
}
