...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_OES_compressed_ETC1_RGB8_texture");
...
bool WebGLCompressedTextureETC1::Supported(WebGLRenderingContextBase* context)
{
    ...
    return extensions_util->SupportsExtension("GL_OES_compressed_ETC1_RGB8_texture");
}
