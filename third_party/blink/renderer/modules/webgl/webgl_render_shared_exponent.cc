...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_QCOM_render_shared_exponent");
}
...
{
    return context->ExtensionsUtil()->SupportsExtension("GL_QCOM_render_shared_exponent");
}
