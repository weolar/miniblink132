...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_OES_shader_multisample_interpolation");
}
...
bool OESShaderMultisampleInterpolation::Supported(WebGLRenderingContextBase* context)
{
    return context->ExtensionsUtil()->SupportsExtension("GL_OES_shader_multisample_interpolation");
}
