...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_EXT_texture_compression_bptc");
    ...
    context->AddCompressedTextureFormat(GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT);
}
