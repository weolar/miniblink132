...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_EXT_polygon_offset_clamp");
}
...
{
    return context->ExtensionsUtil()->SupportsExtension("GL_EXT_polygon_offset_clamp");
}
...
void EXTPolygonOffsetClamp::polygonOffsetClampEXT(GLfloat factor, GLfloat units, GLfloat clamp)
{
