...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_EXT_texture_compression_s3tc_srgb");
...
bool WebGLCompressedTextureS3TCsRGB::Supported(WebGLRenderingContextBase* context)
{
    ...
    return extensions_util->SupportsExtension("GL_EXT_texture_compression_s3tc_srgb");
}
