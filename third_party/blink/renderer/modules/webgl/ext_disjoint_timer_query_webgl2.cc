...
bool EXTDisjointTimerQueryWebGL2::Supported(WebGLRenderingContextBase* context)
{
...
void EXTDisjointTimerQueryWebGL2::queryCounterEXT(WebGLQuery* query, GLenum target)
{
...
{
    context->ExtensionsUtil()->EnsureExtensionEnabled("GL_EXT_disjoint_timer_query_webgl2");
}
