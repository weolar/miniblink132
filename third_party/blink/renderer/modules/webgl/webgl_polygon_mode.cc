...
void WebGLPolygonMode::EmitDeferredPortabilityWarning(WebGLRenderingContextBase* context)
{
    if (!emitted_warning_) {
        context->EmitGLWarning("this extension has very low support on mobile devices; do not rely on "
