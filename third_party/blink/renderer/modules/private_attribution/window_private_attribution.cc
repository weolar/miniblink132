...
// static
const char WindowPrivateAttribution::kSupplementName[] = "WindowPrivateAttribution";

// static
WindowPrivateAttribution& WindowPrivateAttribution::From(LocalDOMWindow& window)
{
    WindowPrivateAttribution* supplement = Supplement<LocalDOMWindow>::From<WindowPrivateAttribution>(window);
    if (!supplement) {
...
// static
PrivateAttribution* WindowPrivateAttribution::privateAttribution(LocalDOMWindow& window)
{
