...
public:
    ...
    static ScriptPromise<PrivateAttributionEncryptedMatchKey> getEncryptedMatchKey(
        ScriptState*, WTF::String report_collector, PrivateAttributionOptions* options, ExceptionState& exception_state);

    static ScriptPromise<IDLSequence<PrivateAttributionNetwork>> getHelperNetworks(ScriptState*, ExceptionState& exception_state);
