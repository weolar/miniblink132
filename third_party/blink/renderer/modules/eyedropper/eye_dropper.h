...
public:
    ...
    // preview.
    ScriptPromise<ColorSelectionResult> open(ScriptState*, const ColorSelectionOptions*, ExceptionState&);
...
private:
    ...
    void EyeDropperResponseHandler(std::unique_ptr<ScopedAbortState>, ScriptPromiseResolver<ColorSelectionResult>*, bool, uint32_t);
