...
public:
    LanguageTranslator(const String source_lang, const String target_lang, mojo::PendingRemote<mojom::blink::Translator> pending_remote,
    ...
    ScriptPromise<IDLString> translate(ScriptState* script_state, const String& input, ExceptionState& exception_state);
    void destroy();

private:
    void OnTranslateFinished(ScriptPromiseResolver<IDLString>* resolver, const WTF::String& output);
