...
public:
    static V8RenderingContext* getContext(
        HTMLCanvasElement& canvas, const WTF::String& context_id, const CanvasContextCreationAttributesModule* attributes, ExceptionState& exception_state);
    static OffscreenCanvas* transferControlToOffscreen(ScriptState*, HTMLCanvasElement&, ExceptionState&);

private:
    static OffscreenCanvas* TransferControlToOffscreenInternal(ScriptState*, HTMLCanvasElement&, ExceptionState&);
};
