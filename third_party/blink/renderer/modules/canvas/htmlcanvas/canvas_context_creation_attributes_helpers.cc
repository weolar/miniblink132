...
bool ToCanvasContextCreationAttributes(
    const CanvasContextCreationAttributesModule* attrs, CanvasContextCreationAttributesCore& result, ExceptionState& exception_state)
{
    result.alpha = attrs->alpha();
    result.antialias = attrs->antialias();
    if (!ValidateAndConvertColorSpace(attrs->colorSpace(), result.color_space, exception_state)) {
        return false;
    }
    ...
    case V8CanvasPowerPreference::Enum::kDefault:
        result.power_preference = CanvasContextCreationAttributesCore::PowerPreference::kDefault;
        break;
    case V8CanvasPowerPreference::Enum::kLowPower:
        result.power_preference = CanvasContextCreationAttributesCore::PowerPreference::kLowPower;
        break;
    case V8CanvasPowerPreference::Enum::kHighPerformance:
        result.power_preference = CanvasContextCreationAttributesCore::PowerPreference::kHighPerformance;
        break;
    }
    result.stencil = attrs->stencil();
    switch (attrs->willReadFrequently().AsEnum()) {
    case V8CanvasWillReadFrequently::Enum::kTrue:
        result.will_read_frequently = CanvasContextCreationAttributesCore::WillReadFrequently::kTrue;
        break;
    case V8CanvasWillReadFrequently::Enum::kFalse:
        result.will_read_frequently = CanvasContextCreationAttributesCore::WillReadFrequently::kFalse;
        break;
    default:
        result.will_read_frequently = CanvasContextCreationAttributesCore::WillReadFrequently::kUndefined;
    }
