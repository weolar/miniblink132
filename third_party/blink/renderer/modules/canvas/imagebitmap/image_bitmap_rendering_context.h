...
class MODULES_EXPORT ImageBitmapRenderingContext final : public ImageBitmapRenderingContextBase {
...
public:
    ...
    ImageBitmapRenderingContext(CanvasRenderingContextHost*, const CanvasContextCreationAttributesCore&);
