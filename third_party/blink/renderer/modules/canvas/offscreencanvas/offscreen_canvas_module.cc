...
V8OffscreenRenderingContext* OffscreenCanvasModule::getContext(ScriptState* script_state, OffscreenCanvas& offscreen_canvas,
    const V8OffscreenRenderingContextType& context_type, const CanvasContextCreationAttributesModule* attributes, ExceptionState& exception_state)
{
    ...
    case V8OffscreenRenderingContextType::Enum::kBitmaprenderer:
        rendering_api = CanvasRenderingContext::CanvasRenderingAPI::kBitmaprenderer;
        break;
    ...
    CanvasRenderingContext* context
        = offscreen_canvas.GetCanvasRenderingContext(ExecutionContext::From(script_state), rendering_api, canvas_context_creation_attributes);
    if (!context)
        return nullptr;
