...
public:
    static V8OffscreenRenderingContext* getContext(ScriptState* script_state, OffscreenCanvas& offscreen_canvas,
        const V8OffscreenRenderingContextType& context_id, const CanvasContextCreationAttributesModule* attributes, ExceptionState& exception_state);
};
