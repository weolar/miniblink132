...
public:
    static CanvasFilter* Create(ScriptState* script_state, const V8CanvasFilterInput* init, ExceptionState& exception_state);
    ...
    static FilterOperations CreateFilterOperations(const V8CanvasFilterInput& filter_input, const Font& font, Element* style_resolution_host,
