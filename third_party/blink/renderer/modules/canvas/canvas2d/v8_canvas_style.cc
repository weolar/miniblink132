...
bool ExtractV8CanvasStyle(v8::Isolate* isolate, v8::Local<v8::Value> value, V8CanvasStyle& style, ExceptionState& exception_state)
{
    // Check for string first as it's the most common.
    if (value->IsString()) {
        style.string = NativeValueTraits<IDLString>::NativeValue(isolate, value, exception_state);
...
v8::Local<v8::Value> CanvasStyleToV8(ScriptState* script_state, const CanvasStyle& style)
{
