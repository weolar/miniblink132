...
struct CachedColor final : public GarbageCollected<CachedColor> {
    CachedColor(v8::Isolate* isolate, const v8::Local<v8::String>& color_string, const Color& color, ColorParseResult parse_result)
...
struct CachedColorTraits final : public WTF::BaseMemberHashTraits<CachedColor, Member<CachedColor>> {
...
struct ColorCacheHashTranslator final {
    ...
    static bool Equal(const CachedColor* cached_color, const v8::Local<v8::String>& string)
    {
