...
public:
    ...
    OffscreenCanvasRenderingContext2D(OffscreenCanvas*, const CanvasContextCreationAttributesCore& attrs);
    ...
    bool HasPendingActivity() const final
    {
        ...
        return static_cast<OffscreenCanvas*>(Host())->HasPlaceholderCanvas() && !dirty_rect_for_commit_.isEmpty();
    }
    ...
    ImageBitmap* TransferToImageBitmap(ScriptState* script_state, ExceptionState& exception_state) final;
