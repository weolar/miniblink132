...
TEST(StorageNamespaceTest, BasicStorageAreas)
{
    ...
    StorageNamespace* localStorage = MakeGarbageCollected<StorageNamespace>(&controller);
    StorageNamespace* sessionStorage
        = MakeGarbageCollected<StorageNamespace>(*local_dom_window_root->GetFrame()->GetPage(), &controller, kSessionStorageNamespace);
