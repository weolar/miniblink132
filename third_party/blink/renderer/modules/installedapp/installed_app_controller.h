...
using AppInstalledCallbacks = CallbackPromiseAdapter<IDLSequence<RelatedApplication>, void>;

class MODULES_EXPORT InstalledAppController final : public GarbageCollected<InstalledAppController>, public Supplement<LocalDOMWindow> {
public:
...
private:
    ...
    void OnFilterInstalledApps(std::unique_ptr<AppInstalledCallbacks>, Vector<mojom::blink::RelatedApplicationPtr>);
