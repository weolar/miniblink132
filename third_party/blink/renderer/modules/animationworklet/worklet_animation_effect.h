...
public:
    WorkletAnimationEffect(std::optional<base::TimeDelta> local_time, const Timing& timing, const Timing::NormalizedTiming& normalized_timing);
