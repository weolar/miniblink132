...
WorkletAnimationEffect::WorkletAnimationEffect(
    std::optional<base::TimeDelta> local_time, const Timing& specified_timing, const Timing::NormalizedTiming& normalized_timing)
...
ComputedEffectTiming* WorkletAnimationEffect::getComputedTiming() const
{
    ...
    if (needs_update) {
        ...
        calculated_ = specified_timing_.CalculateTimings(
            local_time, /*is_idle*/ false, normalized_timing_, Timing::AnimationDirection::kForwards, false, playback_rate);
    }
