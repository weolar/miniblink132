...
public:
    Animator(v8::Isolate*, AnimatorDefinition*, v8::Local<v8::Value> instance, const String& name, WorkletAnimationOptions options,
    ...
    bool Animate(v8::Isolate* isolate, double current_time, AnimationWorkletDispatcherOutput::AnimationState* output);
    v8::Local<v8::Value> State(v8::Isolate*, ExceptionState&);

    template <typename T> void GetLocalTimes(T& local_times) const
    {
        local_times.clear();
