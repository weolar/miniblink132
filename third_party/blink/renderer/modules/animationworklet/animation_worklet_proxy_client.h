...
// thread.
class MODULES_EXPORT AnimationWorkletProxyClient : public GarbageCollected<AnimationWorkletProxyClient>,
...
public:
    ...
    // |mutatee_runner|.
    explicit AnimationWorkletProxyClient(int worklet_id, base::WeakPtr<AnimationWorkletMutatorDispatcherImpl> compositor_mutatee,
        scoped_refptr<base::SingleThreadTaskRunner> compositor_mutatee_runner, base::WeakPtr<AnimationWorkletMutatorDispatcherImpl> main_thread_mutatee,
    ...
    AnimationWorkletProxyClient& operator=(const AnimationWorkletProxyClient&) = delete;
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(AnimationWorkletProxyClientTest, AnimationWorkletProxyClientConstruction);
    FRIEND_TEST_ALL_PREFIXES(AnimationWorkletProxyClientTest, RegisteredAnimatorNameShouldSyncOnce);
    ...
    struct MutatorItem {
        ...
        MutatorItem(base::WeakPtr<AnimationWorkletMutatorDispatcherImpl> mutator_dispatcher, scoped_refptr<base::SingleThreadTaskRunner> mutator_runner)
...
void MODULES_EXPORT ProvideAnimationWorkletProxyClientTo(WorkerClients*, AnimationWorkletProxyClient*);
