...
// static
AnimationWorklet* CSSAnimationWorklet::animationWorklet(ScriptState* script_state)
{
...
{
    CSSAnimationWorklet* supplement = Supplement<LocalDOMWindow>::From<CSSAnimationWorklet>(window);
    if (!supplement) {
