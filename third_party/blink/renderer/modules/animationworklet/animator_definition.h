...
class MODULES_EXPORT AnimatorDefinition final : public GarbageCollected<AnimatorDefinition>, public NameClient {
public:
    explicit AnimatorDefinition(V8AnimatorConstructor* constructor, V8AnimateCallback* animate, V8StateCallback* state);
    ...
    V8AnimateCallback* AnimateFunction() const
    {
        return animate_.Get();
    }
    V8StateCallback* StateFunction() const
    {
        return state_.Get();
    }
