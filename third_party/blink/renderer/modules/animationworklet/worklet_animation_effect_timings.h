...
class MODULES_EXPORT WorkletAnimationEffectTimings final : public cc::AnimationEffectTimings {
public:
    explicit WorkletAnimationEffectTimings(
        scoped_refptr<base::RefCountedData<Vector<Timing>>>, scoped_refptr<base::RefCountedData<Vector<Timing::NormalizedTiming>>>);
    ...
    const scoped_refptr<base::RefCountedData<Vector<Timing::NormalizedTiming>>>& GetNormalizedTimings()
    {
...
private:
    ...
    scoped_refptr<base::RefCountedData<Vector<Timing::NormalizedTiming>>> normalized_timings_;
};
