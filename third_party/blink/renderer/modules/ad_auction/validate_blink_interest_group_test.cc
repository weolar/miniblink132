...
{
    return mojom::blink::InterestGroupAd::New(url, /*size_group=*/String(),
...
public:
    ...
    void ExpectInterestGroupIsValid(const mojom::blink::InterestGroupPtr& blink_interest_group)
    {
        String error_field_name;
        String error_field_value;
        String error;
        EXPECT_TRUE(ValidateBlinkInterestGroup(*blink_interest_group, error_field_name, error_field_value, error));
        EXPECT_TRUE(error_field_name.IsNull());
        EXPECT_TRUE(error_field_value.IsNull());
        EXPECT_TRUE(error.IsNull());

        blink::InterestGroup interest_group;
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<mojom::blink::InterestGroup>(blink_interest_group, interest_group));
        EXPECT_EQ(EstimateBlinkInterestGroupSize(*blink_interest_group), interest_group.EstimateSize());
    }

    // Check that `blink_interest_group` is not valid, if added from
    // `blink_origin`, and returns the provided error values.
    void ExpectInterestGroupIsNotValid(const mojom::blink::InterestGroupPtr& blink_interest_group, String expected_error_field_name,
        String expected_error_field_value, String expected_error, bool check_deserialization = true)
    {
        String error_field_name;
        String error_field_value;
        String error;
        EXPECT_FALSE(ValidateBlinkInterestGroup(*blink_interest_group, error_field_name, error_field_value, error));
        ...
        if (check_deserialization) {
            ...
            EXPECT_FALSE(mojo::test::SerializeAndDeserialize<mojom::blink::InterestGroup>(blink_interest_group, interest_group));
        }
    }
    ...
    {
        mojom::blink::InterestGroupPtr blink_interest_group = mojom::blink::InterestGroup::New();
        blink_interest_group->owner = kOrigin;
        blink_interest_group->name = kName;
        blink_interest_group->all_sellers_capabilities = mojom::blink::SellerCapabilities::New();
        blink_interest_group->auction_server_request_flags = mojom::blink::AuctionServerRequestFlags::New();
    ...
    {
        mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();

        // Url that's allowed in every field. Populate all portions of the URL that
        // are allowed in most places.
        const KURL kAllowedUrl = KURL(String::FromUTF8("https://origin.test/foo?bar"));
        ...
        // above ones.
        blink_interest_group->trusted_bidding_signals_url = KURL(String::FromUTF8("https://origin.test/foo"));

        blink_interest_group->trusted_bidding_signals_keys.emplace();
        blink_interest_group->trusted_bidding_signals_keys->push_back(String::FromUTF8("1"));
        blink_interest_group->trusted_bidding_signals_keys->push_back(String::FromUTF8("2"));
        blink_interest_group->max_trusted_bidding_signals_url_length = 8000;
        blink_interest_group->trusted_bidding_signals_coordinator = kCoordinatorOrigin;
        blink_interest_group->user_bidding_signals = String::FromUTF8("\"This field isn't actually validated\"");
        ...
        mojo_ad1->render_url = KURL(String::FromUTF8("https://origin.test/foo?bar#baz"));
        mojo_ad1->metadata = String::FromUTF8("\"This field isn't actually validated\"");
        ...
        mojo_ad2->render_url = KURL(String::FromUTF8("https://origin.test/foo?bar#baz2"));
        ...
        mojo_ad_component1->render_url = KURL(String::FromUTF8("https://origin.test/components?bar#baz"));
        mojo_ad_component1->metadata = String::FromUTF8("\"This field isn't actually validated\"");
        mojo_ad_component1->ad_render_id = String::FromUTF8("\"NotTooLong\"");
        blink_interest_group->ad_components->push_back(std::move(mojo_ad_component1));
        auto mojo_ad_component2 = mojom::blink::InterestGroupAd::New();
        mojo_ad_component2->render_url = KURL(String::FromUTF8("https://origin.test/foo?component#baz2"));
        blink_interest_group->ad_components->push_back(std::move(mojo_ad_component2));

        blink_interest_group->auction_server_request_flags = mojom::blink::AuctionServerRequestFlags::New();
        blink_interest_group->auction_server_request_flags->omit_ads = true;
        blink_interest_group->auction_server_request_flags->omit_user_bidding_signals = true;
...
protected:
    ...
    const scoped_refptr<const SecurityOrigin> kOrigin = SecurityOrigin::CreateFromString(String::FromUTF8(kOriginString));

    const String kName = String::FromUTF8(kNameString);
    const scoped_refptr<const SecurityOrigin> kCoordinatorOrigin = SecurityOrigin::CreateFromString(String::FromUTF8(kCoordinatorOriginString));
...
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateFullyPopulatedInterestGroup();
    ExpectInterestGroupIsValid(blink_interest_group);
}
...
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->owner = SecurityOrigin::CreateFromString(String::FromUTF8("http://origin.test/"));
    ...
    blink_interest_group->owner = SecurityOrigin::CreateFromString(String::FromUTF8("data:,foo"));
...
TEST_F(ValidateBlinkInterestGroupTest, NonHttpsOriginRejectedSellerCapabilities)
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->seller_capabilities.emplace();
    blink_interest_group->seller_capabilities->insert(
        SecurityOrigin::CreateFromString(String::FromUTF8("https://origin.test/")), mojom::blink::SellerCapabilities::New());
    blink_interest_group->seller_capabilities->insert(
        SecurityOrigin::CreateFromString(String::FromUTF8("http://origin.test/")), mojom::blink::SellerCapabilities::New());
    ExpectInterestGroupIsNotValid(blink_interest_group,
    ...
    blink_interest_group->seller_capabilities->insert(SecurityOrigin::CreateFromString(String::FromUTF8("data:,foo")), mojom::blink::SellerCapabilities::New());
    blink_interest_group->seller_capabilities->insert(
        SecurityOrigin::CreateFromString(String::FromUTF8("https://origin.test/")), mojom::blink::SellerCapabilities::New());
    // Data URLs have opaque origins, which are mapped to the string "null".
    ExpectInterestGroupIsNotValid(blink_interest_group,
    ...
    blink_interest_group->seller_capabilities->insert(
        SecurityOrigin::CreateFromString(String::FromUTF8("https://origin.test")), mojom::blink::SellerCapabilities::New());
    blink_interest_group->seller_capabilities->insert(
        SecurityOrigin::CreateFromString(String::FromUTF8("https://invalid^&")), mojom::blink::SellerCapabilities::New());
    // Data URLs have opaque origins, which are mapped to the string "null".
    ExpectInterestGroupIsNotValid(blink_interest_group,
        /*expected_error_field_name=*/String::FromUTF8("sellerCapabilities"),
        /*expected_error_field_value=*/String::FromUTF8("null"),
...
TEST_F(ValidateBlinkInterestGroupTest, RejectedUrls)
{
    ...
    const char kBadBiddingUrlError[] = "biddingLogicURL must have the same origin as the InterestGroup owner "
                                       "and have no fragment identifier or embedded credentials.";
    const char kBadBiddingWasmHelperUrlError[] = "biddingWasmHelperURL must have the same origin as the InterestGroup "
                                                 "owner and have no fragment identifier or embedded credentials.";
    const char kBadUpdateUrlError[] = "updateURL must have the same origin as the InterestGroup owner "
                                      "and have no fragment identifier or embedded credentials.";
    ...
    // also HTTPS.
    const KURL kFileSystemUrl = KURL(String::FromUTF8("filesystem:https://origin.test/foo"));
    EXPECT_TRUE(kOrigin->IsSameOriginWith(SecurityOrigin::Create(kFileSystemUrl).get()));
...
TEST_F(ValidateBlinkInterestGroupTest, TrustedBiddingSignalsUrl)
{
    ...
    const struct {
        KURL url;
        bool ok = false;
    } kTests[] = { // HTTP URLs is rejected: it's wrong scheme.
        ...
        // Invalid URLs.
        { KURL(String::FromUTF8("")) }, { KURL(String::FromUTF8("invalid url")) }, { KURL(String::FromUTF8("https://!@#$%^&*()/")) },
        { KURL(String::FromUTF8("https://[1::::::2]/")) }, { KURL(String::FromUTF8("https://origin%00.test")) },
    ...
    for (const auto& test : kTests) {
        ...
        if (test.ok) {
            ...
            ExpectInterestGroupIsNotValid(blink_interest_group,
                ...
                /*expected_error=*/
                String::FromUTF8("trustedBiddingSignalsURL must have https schema and have no "
...
{
    const char kBadAdUrlError[] = "renderURLs must be HTTPS and have no embedded credentials.";
    ...
    for (const auto& test_case : kTestCases) {
        ...
        blink_interest_group = CreateMinimalInterestGroup();
        blink_interest_group->ads.emplace();
        blink_interest_group->ads->emplace_back(MakeAdWithUrl(KURL(String::FromUTF8("https://origin.test/"))));
        blink_interest_group->ads->emplace_back(MakeAdWithUrl(test_case_url));
        if (test_case.expect_allowed) {
            ExpectInterestGroupIsValid(blink_interest_group);
        } else {
...
TEST_F(ValidateBlinkInterestGroupTest, AdComponentRenderUrlValidation)
{
    ...
    for (const auto& test_case : kTestCases) {
        ...
        mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
        blink_interest_group->ad_components.emplace();
        blink_interest_group->ad_components->emplace_back(MakeAdWithUrl(test_case_url));
        if (test_case.expect_allowed) {
            ExpectInterestGroupIsValid(blink_interest_group);
        } else {
            ExpectInterestGroupIsNotValid(blink_interest_group,
        ...
        blink_interest_group = CreateMinimalInterestGroup();
        blink_interest_group->ad_components.emplace();
        blink_interest_group->ad_components->emplace_back(MakeAdWithUrl(KURL(String::FromUTF8("https://origin.test/"))));
        blink_interest_group->ad_components->emplace_back(MakeAdWithUrl(test_case_url));
        if (test_case.expect_allowed) {
            ExpectInterestGroupIsValid(blink_interest_group);
        } else {
...
TEST_F(ValidateBlinkInterestGroupTest, MalformedUrl)
{
    ...
    constexpr char kBadAdUrlError[] = "renderURLs must be HTTPS and have no embedded credentials.";
    mojom::blink::InterestGroupPtr blink_interest_group = mojom::blink::InterestGroup::New();
    blink_interest_group->owner = kOrigin;
    blink_interest_group->name = kName;
    blink_interest_group->ads.emplace();
    ...
    interest_group.ads->emplace_back(blink::InterestGroup::Ad(GURL(kMalformedUrl), /*metadata=*/""));
...
TEST_F(ValidateBlinkInterestGroupTest, TooLarge)
{
    ...
    const size_t kTooLongNameLength = mojom::blink::kMaxInterestGroupSize - EstimateBlinkInterestGroupSize(*blink_interest_group);
...
TEST_F(ValidateBlinkInterestGroupTest, TooLargePriorityVector)
{
    ...
    size_t initial_estimate = EstimateBlinkInterestGroupSize(*blink_interest_group);
    ...
    size_t current_estimate = EstimateBlinkInterestGroupSize(*blink_interest_group);
    ...
    const size_t kTooLongNameLength = mojom::blink::kMaxInterestGroupSize - current_estimate;
...
TEST_F(ValidateBlinkInterestGroupTest, TooLargeSellerCapabilities)
{
    ...
    for (int i = 0; i < 510; ++i) {
        ...
        String origin_string = String::FromUTF8(base::StringPrintf("https://%.83i.test", i));
        blink_interest_group->seller_capabilities->insert(SecurityOrigin::CreateFromString(origin_string), mojom::blink::SellerCapabilities::New());
    }
    size_t current_estimate = EstimateBlinkInterestGroupSize(*blink_interest_group);
    EXPECT_EQ(51000 + initial_estimate, current_estimate);
...
TEST_F(ValidateBlinkInterestGroupTest, TooLargeAdSizes)
{
    ...
    for (int i = 0; i < 510; ++i) {
        ...
        blink_interest_group->ad_sizes->insert(
            name_string, mojom::blink::AdSize::New(150, blink::AdSize::LengthUnit::kPixels, 100, blink::AdSize::LengthUnit::kPixels));
    }
    size_t current_estimate = EstimateBlinkInterestGroupSize(*blink_interest_group);
    EXPECT_EQ(51000 + initial_estimate, current_estimate);
...
TEST_F(ValidateBlinkInterestGroupTest, TooLargeSizeGroups)
{
    ...
    blink_interest_group->ad_sizes.emplace();
    blink_interest_group->ad_sizes->insert(
        "size1", blink::mojom::blink::AdSize::New(100, blink::AdSize::LengthUnit::kPixels, 100, blink::AdSize::LengthUnit::kPixels));
    ...
    for (int i = 0; i < 510; ++i) {
        ...
        blink_interest_group->size_groups->insert(name_string, WTF::Vector<WTF::String> { "size1" });
    }
    size_t current_estimate = EstimateBlinkInterestGroupSize(*blink_interest_group);
    EXPECT_EQ(51000 + initial_estimate, current_estimate);
...
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->name = WTF::String("paddingTo1048576" + std::string(12, 'P'));
    blink_interest_group->ad_components.emplace();
...
{
    constexpr char kSizeError[] = "Ad sizes must have a valid (non-zero/non-infinite) width and height.";
    constexpr char kNameError[] = "Ad sizes cannot map from an empty event name.";
    constexpr char kUnitError[] = "Ad size dimensions must be a valid number either in pixels (px) "
                                  "or screen width (sw).";
    struct {
        const char* ad_name;
        const double width;
        ...
        { "ad_name", 0, blink::AdSize::LengthUnit::kPixels, 0, blink::AdSize::LengthUnit::kPixels, kSizeError, "0.000000 x 0.000000" },
        { "ad_name", 300, blink::AdSize::LengthUnit::kPixels, 0, blink::AdSize::LengthUnit::kPixels, kSizeError, "300.000000 x 0.000000" },
        { "ad_name", 0, blink::AdSize::LengthUnit::kScreenWidth, 300, blink::AdSize::LengthUnit::kScreenWidth, kSizeError, "0.000000 x 300.000000" },
        { "ad_name", -300, blink::AdSize::LengthUnit::kScreenWidth, 300, blink::AdSize::LengthUnit::kPixels, kSizeError, "-300.000000 x 300.000000" },
        { "", 300, blink::AdSize::LengthUnit::kScreenWidth, 300, blink::AdSize::LengthUnit::kPixels, kNameError, "" },
        { "ad_name", std::numeric_limits<double>::infinity(), blink::AdSize::LengthUnit::kPixels, std::numeric_limits<double>::infinity(),
            blink::AdSize::LengthUnit::kPixels, kSizeError, "inf x inf" },
        { "ad_name", 300, blink::AdSize::LengthUnit::kInvalid, 300, blink::AdSize::LengthUnit::kPixels, kUnitError, "" },
    };
    for (const auto& test_case : test_cases) {
        mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
        blink_interest_group->ad_sizes.emplace();
        blink_interest_group->ad_sizes->insert(
            test_case.ad_name, blink::mojom::blink::AdSize::New(test_case.width, test_case.width_units, test_case.height, test_case.height_units));
        ExpectInterestGroupIsNotValid(blink_interest_group,
            /*expected_error_field_name=*/String::FromUTF8("adSizes"), test_case.expected_error_field_value, test_case.expected_error);
    }
}
...
TEST_F(ValidateBlinkInterestGroupTest, InvalidSizeGroups)
{
    struct {
        ...
        { "group_name", "", true, "", "Size groups cannot map to an empty ad size name." },
        { "", "size_name", true, "", "Size groups cannot map from an empty group name." },
        { "group_name", "nonexistant", true, "nonexistant", "Size does not exist in adSizes map." },
        { "group_name", "size_name", false, "", "An adSizes map must exist for sizeGroups to work." },
    };
    for (const auto& test_case : test_cases) {
        mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
        if (test_case.has_ad_sizes) {
            blink_interest_group->ad_sizes.emplace();
            blink_interest_group->ad_sizes->insert(
                "size_name", blink::mojom::blink::AdSize::New(300, blink::AdSize::LengthUnit::kPixels, 150, blink::AdSize::LengthUnit::kPixels));
        }
        blink_interest_group->size_groups.emplace();
        blink_interest_group->size_groups->insert(test_case.size_group, WTF::Vector<WTF::String>(1, test_case.size_name));
        ExpectInterestGroupIsNotValid(blink_interest_group,
            /*expected_error_field_name=*/String::FromUTF8("sizeGroups"), test_case.expected_error_field_value, test_case.expected_error);
    }
}

TEST_F(ValidateBlinkInterestGroupTest, AdSizeGroupEmptyNameOrNotInSizeGroups)
{
    constexpr char kSizeGroupError[] = "The assigned size group does not exist in sizeGroups map.";
    ...
    for (const auto& test_case : test_cases) {
        mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
        blink_interest_group->ads.emplace();
        blink_interest_group->ads->emplace_back(mojom::blink::InterestGroupAd::New(KURL("https://origin.test/foo?bar"),
        ...
        blink_interest_group->ad_sizes->insert(
            "size_name", blink::mojom::blink::AdSize::New(300, blink::AdSize::LengthUnit::kPixels, 150, blink::AdSize::LengthUnit::kPixels));
        blink_interest_group->size_groups.emplace();
        blink_interest_group->size_groups->insert(test_case.size_group, WTF::Vector<WTF::String>(1, "size_name"));
        ExpectInterestGroupIsNotValid(blink_interest_group,
            /*expected_error_field_name=*/String::FromUTF8("ads[0].sizeGroup"), test_case.expected_error_field_value, test_case.expected_error);
    }
}

TEST_F(ValidateBlinkInterestGroupTest, AdComponentSizeGroupEmptyNameOrNotInSizeGroups)
{
    constexpr char kSizeGroupError[] = "The assigned size group does not exist in sizeGroups map.";
    constexpr char kNameError[] = "Size group name cannot be empty.";
    struct {
    ...
    for (const auto& test_case : test_cases) {
        mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
        blink_interest_group->ad_components.emplace();
        blink_interest_group->ad_components->emplace_back(mojom::blink::InterestGroupAd::New(KURL("https://origin.test/foo?bar"),
        ...
        ExpectInterestGroupIsNotValid(blink_interest_group,
            /*expected_error_field_name=*/
            String::FromUTF8("adComponents[0].sizeGroup"), test_case.expected_error_field_value, test_case.expected_error);
    }
}
...
TEST_F(ValidateBlinkInterestGroupTest, AdComponentRenderIdTooLong)
{
    ...
    mojo_ad_component->render_url = KURL(String::FromUTF8("https://origin.test/foo?bar"));
    mojo_ad_component->ad_render_id = String::FromUTF8("ThisIsTooLong");
    blink_interest_group->ad_components->emplace_back(std::move(mojo_ad_component));
    ExpectInterestGroupIsNotValid(blink_interest_group,
        /*expected_error_field_name=*/
...
TEST_F(ValidateBlinkInterestGroupTest, AdTooManyAllowedReportingOrigins)
{
    ...
    for (size_t i = 0; i < mojom::blink::kMaxAllowedReportingOrigins + 1; ++i) {
        ad->allowed_reporting_origins->emplace_back(SecurityOrigin::CreateFromString(String::Format("https://origin%zu.test/", i)));
    }
    blink_interest_group->ads->emplace_back(std::move(ad));
    ExpectInterestGroupIsNotValid(blink_interest_group,
        /*expected_error_field_name=*/
...
TEST_F(ValidateBlinkInterestGroupTest, AdNonHttpsAllowedReportingOrigins)
{
    ...
    ad->render_url = KURL(String::FromUTF8("https://origin.test/foo?bar"));
    ad->allowed_reporting_origins.emplace();
    ad->allowed_reporting_origins->emplace_back(SecurityOrigin::CreateFromString("https://origin1.test/"));
    ad->allowed_reporting_origins->emplace_back(SecurityOrigin::CreateFromString("http://origin2.test/"));
    blink_interest_group->ads->emplace_back(std::move(ad));
    ExpectInterestGroupIsNotValid(blink_interest_group,
        /*expected_error_field_name=*/
        String::FromUTF8("ads[0].allowedReportingOrigins"),
...
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->additional_bid_key = { 0x7d, 0x4d, 0x0e, 0x7f, 0x61, 0x53, 0xa6, 0x9b, 0x62, 0x42, 0xb5, 0x22, 0xab, 0xbe, 0xe6, 0x85, 0xfd, 0xa4,
...
TEST_F(ValidateBlinkInterestGroupTest, AdditionalBidKeyAndAdsNotAllowedTogether)
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->ads.emplace();
    blink_interest_group->ads->emplace_back(MakeAdWithUrl(KURL(String::FromUTF8("https://origin.test/"))));
...
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->aggregation_coordinator_origin = SecurityOrigin::CreateFromString("http://coordinator.test");
...
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->aggregation_coordinator_origin = SecurityOrigin::CreateFromString("http://invalid^&");
...
TEST_F(ValidateBlinkInterestGroupTest, AdditionalBidKeyAndUpdateURLNotAllowedTogether)
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->update_url = KURL(String::FromUTF8("https://origin.test/update"));
    blink_interest_group->additional_bid_key = { 0x7d, 0x4d, 0x0e, 0x7f, 0x61, 0x53, 0xa6, 0x9b, 0x62, 0x42, 0xb5, 0x22, 0xab, 0xbe, 0xe6, 0x85, 0xfd, 0xa4,
        0x42, 0x0f, 0x88, 0x34, 0xb1, 0x08, 0xc3, 0xbd, 0xae, 0x36, 0x9e, 0xf5, 0x49, 0xfa };
...
TEST_F(ValidateBlinkInterestGroupTest, MaxTrustedBiddingSignalsURLLengthMustNotBeNegative)
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->max_trusted_bidding_signals_url_length = -1;

    ExpectInterestGroupIsNotValid(blink_interest_group, /*expected_error_field_name=*/
...
TEST_F(ValidateBlinkInterestGroupTest, InvalidTrustedBiddingSignalsCoordinator)
{
    mojom::blink::InterestGroupPtr blink_interest_group = CreateMinimalInterestGroup();
    blink_interest_group->trusted_bidding_signals_coordinator = SecurityOrigin::CreateFromString(String::FromUTF8("http://origin.test/"));
    ExpectInterestGroupIsNotValid(blink_interest_group,
        /*expected_error_field_name=*/
        String::FromUTF8("trustedBiddingSignalsCoordinator"),
        /*expected_error_field_value=*/String::FromUTF8("http://origin.test"),
        /*expected_error=*/
        String::FromUTF8("trustedBiddingSignalsCoordinator origin must be HTTPS."));

    blink_interest_group->trusted_bidding_signals_coordinator = SecurityOrigin::CreateFromString(String::FromUTF8("data:,foo"));
    // Data URLs have opaque origins, which are mapped to the string "null".
    ExpectInterestGroupIsNotValid(blink_interest_group,
        /*expected_error_field_name=*/
        String::FromUTF8("trustedBiddingSignalsCoordinator"),
