...
// process.
MODULES_EXPORT bool ValidateBlinkInterestGroup(const mojom::blink::InterestGroup& group, String& error_field_name, String& error_field_value, String& error);

MODULES_EXPORT size_t EstimateBlinkInterestGroupSize(const mojom::blink::InterestGroup& group);
