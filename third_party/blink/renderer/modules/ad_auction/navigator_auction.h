...
class MODULES_EXPORT NavigatorAuction final : public GarbageCollected<NavigatorAuction>, public Supplement<Navigator> {
public:
    class AuctionHandle;
    ...
    ScriptPromise<IDLUndefined> joinAdInterestGroup(ScriptState*, AuctionAdInterestGroup*, std::optional<double>, ExceptionState&);
    static ScriptPromise<IDLUndefined> joinAdInterestGroup(ScriptState*, Navigator&, AuctionAdInterestGroup*, double, ExceptionState&);
    static ScriptPromise<IDLUndefined> joinAdInterestGroup(ScriptState*, Navigator&, AuctionAdInterestGroup*, ExceptionState&);
    ScriptPromise<IDLUndefined> leaveAdInterestGroup(ScriptState*, const AuctionAdInterestGroupKey*, ExceptionState&);
    static ScriptPromise<IDLUndefined> leaveAdInterestGroup(ScriptState*, Navigator&, const AuctionAdInterestGroupKey*, ExceptionState&);

    // Implicit leaveAdInterestGroup - only supported when called from within
    // a fenced frame showing FLEDGE ads.
    ScriptPromise<IDLUndefined> leaveAdInterestGroupForDocument(ScriptState*, ExceptionState&);
    static ScriptPromise<IDLUndefined> leaveAdInterestGroup(ScriptState*, Navigator&, ExceptionState&);

    ScriptPromise<IDLUndefined> clearOriginJoinedAdInterestGroups(ScriptState*, const String&, Vector<String>, ExceptionState&);
    static ScriptPromise<IDLUndefined> clearOriginJoinedAdInterestGroups(ScriptState*, Navigator&, const String, ExceptionState&);
    static ScriptPromise<IDLUndefined> clearOriginJoinedAdInterestGroups(ScriptState*, Navigator&, const String, const Vector<String>, ExceptionState&);
    ...
    ScriptPromise<IDLNullable<V8UnionFencedFrameConfigOrUSVString>> runAdAuction(
        ScriptState*, AuctionAdConfig*, ExceptionState&, base::TimeTicks start_time = base::TimeTicks::Now());
    static ScriptPromise<IDLNullable<V8UnionFencedFrameConfigOrUSVString>> runAdAuction(ScriptState*, Navigator&, AuctionAdConfig*, ExceptionState&);

    ScriptPromise<IDLString> createAuctionNonce(ScriptState*, ExceptionState&);
    static ScriptPromise<IDLString> createAuctionNonce(ScriptState*, Navigator&, ExceptionState&);
    ...
    static Vector<String> adAuctionComponents(ScriptState* script_state, Navigator& navigator, uint16_t num_ad_components, ExceptionState& exception_state);

    ScriptPromise<IDLUSVString> deprecatedURNToURL(ScriptState* script_state, const String& urn_uuid, bool send_reports, ExceptionState& exception_state);

    static ScriptPromise<IDLUSVString> deprecatedURNToURL(ScriptState* script_state, Navigator& navigator,
    ...
    ScriptPromise<IDLUndefined> deprecatedReplaceInURN(
        ScriptState* script_state, const String& urn_uuid, const Vector<std::pair<String, String>>& replacement, ExceptionState& exception_state);

    static ScriptPromise<IDLUndefined> deprecatedReplaceInURN(ScriptState* script_state, Navigator& navigator,
        const V8UnionFencedFrameConfigOrUSVString* urn_or_config, const Vector<std::pair<String, String>>& replacement, ExceptionState& exception_state);

    ScriptPromise<AdAuctionData> getInterestGroupAdAuctionData(
        ScriptState* script_state, const AdAuctionDataConfig* config, ExceptionState& exception_state, base::TimeTicks start_time = base::TimeTicks::Now());
    ...
    ScriptPromise<Ads> createAdRequest(ScriptState*, const AdRequestConfig*, ExceptionState&);
    static ScriptPromise<Ads> createAdRequest(ScriptState*, Navigator&, const AdRequestConfig*, ExceptionState&);
    ScriptPromise<IDLString> finalizeAd(ScriptState*, const Ads*, const AuctionAdConfig*, ExceptionState&);
    static ScriptPromise<IDLString> finalizeAd(ScriptState*, Navigator&, const Ads*, const AuctionAdConfig*, ExceptionState&);
    ...
    static bool deprecatedRunAdAuctionEnforcesKAnonymity(ScriptState*, Navigator&);

    static ProtectedAudience* protectedAudience(ScriptState*, Navigator& navigator);
...
private:
    ...
    void JoinComplete(bool is_cross_origin, ScriptPromiseResolver<IDLUndefined>* resolver, bool failed_well_known_check);
    ...
    void LeaveComplete(bool is_cross_origin, ScriptPromiseResolver<IDLUndefined>* resolver, bool failed_well_known_check);
    ...
    void ClearComplete(bool is_cross_origin, ScriptPromiseResolver<IDLUndefined>* resolver, bool failed_well_known_check);

    // Completion callback for createAdRequest() Mojo call.
    void AdsRequested(ScriptPromiseResolver<Ads>* resolver, const WTF::String& ads_guid);
    // Completion callback for finalizeAd() Mojo call.
    void FinalizeAdComplete(ScriptPromiseResolver<IDLString>* resolver, const std::optional<KURL>& creative_url);
    // Completion callback for Mojo call made by deprecatedURNToURL().
    void GetURLFromURNComplete(ScriptPromiseResolver<IDLUSVString>*, const std::optional<KURL>&);
    ...
    void GetInterestGroupAdAuctionDataComplete(base::TimeTicks start_time, ScriptPromiseResolver<AdAuctionData>* resolver, mojo_base::BigBuffer request,
        const std::optional<base::Uuid>& request_id, const WTF::String& error_message);
