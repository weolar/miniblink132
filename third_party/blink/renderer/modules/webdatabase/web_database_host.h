...
public:
    ...
    void DatabaseOpened(const SecurityOrigin& origin, const String& database_name, const String& database_display_name);
    void DatabaseModified(const SecurityOrigin& origin, const String& database_name);
    void DatabaseClosed(const SecurityOrigin& origin, const String& database_name);
    void ReportSqliteError(const SecurityOrigin& origin, const String& database_name, int error);
