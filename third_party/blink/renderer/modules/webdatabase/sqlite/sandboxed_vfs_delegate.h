...
public:
    ...
    base::File OpenFile(const base::FilePath& file_path, int sqlite_requested_flags) override;
    int DeleteFile(const base::FilePath& file_path, bool sync_dir) override;
    std::optional<sql::SandboxedVfs::PathAccessInfo> GetPathAccess(const base::FilePath& file_path) override;
};
