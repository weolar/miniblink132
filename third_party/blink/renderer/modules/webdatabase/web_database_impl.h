...
private:
    ...
    void UpdateSize(const scoped_refptr<const SecurityOrigin>&, const String& name, int64_t size) override;
    void CloseImmediately(const scoped_refptr<const SecurityOrigin>&, const String& name) override;
