...
static void HistogramAlgorithmId(ExecutionContext* context, WebCryptoAlgorithmId algorithm_id)
{
...
void HistogramDeriveBitsTruncation(ExecutionContext* context, std::optional<unsigned int> length_bits, WebCryptoWarningType status)
{
    if (length_bits == 0) {
