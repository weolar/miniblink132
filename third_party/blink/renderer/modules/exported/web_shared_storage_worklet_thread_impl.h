...
class MODULES_EXPORT WebSharedStorageWorkletThreadImpl final : public GarbageCollected<WebSharedStorageWorkletThreadImpl>,
                                                               public WebSharedStorageWorkletThread {
public:
    WebSharedStorageWorkletThreadImpl(scoped_refptr<base::SingleThreadTaskRunner> main_thread_runner,
        mojo::PendingReceiver<mojom::blink::SharedStorageWorkletService> receiver,
        mojom::blink::WorkletGlobalScopeCreationParamsPtr global_scope_creation_params);
