...
class MODULES_EXPORT WebRtcAudioRenderer : public media::AudioRendererSink::RenderCallback, public MediaStreamAudioRenderer {
public:
    ...
    WebRtcAudioRenderer(const scoped_refptr<base::SingleThreadTaskRunner>& signaling_thread, MediaStreamDescriptor* media_stream_descriptor,
    ...
    scoped_refptr<MediaStreamAudioRenderer> CreateSharedAudioRendererProxy(MediaStreamDescriptor* media_stream_descriptor);
...
private:
    ...
    public:
        ...
        explicit AudioStreamTracker(scoped_refptr<base::SingleThreadTaskRunner> task_runner, WebRtcAudioRenderer* renderer, int sample_rate);
...
private:
    ...
    typedef std::map<webrtc::AudioSourceInterface*, PlayingStates> SourcePlayingStates ALLOW_DISCOURAGED_TYPE("TODO(crbug.com/1404327");
    ...
    bool AddPlayingState(webrtc::AudioSourceInterface* source, PlayingState* state);
    ...
    bool RemovePlayingState(webrtc::AudioSourceInterface* source, PlayingState* state);
    ...
    void OnPlayStateChanged(MediaStreamDescriptor* media_stream_descriptor, PlayingState* state);
