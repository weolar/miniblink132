...
int32_t WebRtcAudioDeviceNotImpl::ActiveAudioLayer(AudioLayer* audio_layer) const
{
    return 0;
}
...
int32_t WebRtcAudioDeviceNotImpl::PlayoutDeviceName(uint16_t index, char name[webrtc::kAdmMaxDeviceNameSize], char guid[webrtc::kAdmMaxGuidSize])
{
    return 0;
}

int32_t WebRtcAudioDeviceNotImpl::RecordingDeviceName(uint16_t index, char name[webrtc::kAdmMaxDeviceNameSize], char guid[webrtc::kAdmMaxGuidSize])
{
    return 0;
}
...
int32_t WebRtcAudioDeviceNotImpl::MaxMicrophoneVolume(uint32_t* max_volume) const
{
    return 0;
}

int32_t WebRtcAudioDeviceNotImpl::MinMicrophoneVolume(uint32_t* min_volume) const
{
    return 0;
}
...
int32_t WebRtcAudioDeviceNotImpl::StereoPlayoutIsAvailable(bool* available) const
{
    *available = false;
    return 0;
}
...
int32_t WebRtcAudioDeviceNotImpl::StereoRecordingIsAvailable(bool* available) const
{
    *available = false;
    return 0;
}
...
#if BUILDFLAG(IS_IOS)
int WebRtcAudioDeviceNotImpl::GetPlayoutAudioParameters(webrtc::AudioParameters* params) const
{
    return 0;
}

int WebRtcAudioDeviceNotImpl::GetRecordAudioParameters(webrtc::AudioParameters* params) const
{
    return 0;
}
