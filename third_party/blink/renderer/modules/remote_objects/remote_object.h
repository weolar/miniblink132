...
class RemoteObject : public gin::Wrappable<RemoteObject>, public gin::NamedPropertyInterceptor {
public:
...
private:
    static void RemoteObjectInvokeCallback(const v8::FunctionCallbackInfo<v8::Value>& info);
