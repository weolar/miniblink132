...
public:
    IDBRequestQueueItem(IDBRequest*, DOMException*, base::OnceClosure on_result_ready);
    ...
    IDBRequestQueueItem(IDBRequest*, std::unique_ptr<IDBKey>, base::OnceClosure on_result_ready);
    IDBRequestQueueItem(IDBRequest*, std::unique_ptr<IDBValue>, base::OnceClosure on_load_complete);
    IDBRequestQueueItem(
        IDBRequest*, std::unique_ptr<IDBKey>, std::unique_ptr<IDBKey> primary_key, std::unique_ptr<IDBValue>, base::OnceClosure on_result_ready);
    IDBRequestQueueItem(IDBRequest*, mojo::PendingAssociatedRemote<mojom::blink::IDBCursor> pending_cursor, std::unique_ptr<IDBKey>,
        std::unique_ptr<IDBKey> primary_key, std::unique_ptr<IDBValue>, base::OnceClosure on_result_ready);
    // Asynchronous fetching of multiple results.
    IDBRequestQueueItem(IDBRequest*, mojom::blink::IDBGetAllResultType get_all_result_type,
...
private:
    ...
    void OnLoadComplete(Vector<std::unique_ptr<IDBValue>>&& values, DOMException* error);
