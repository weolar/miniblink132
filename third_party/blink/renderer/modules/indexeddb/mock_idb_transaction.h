...
class MockIDBTransaction : public testing::StrictMock<mojom::blink::IDBTransaction> {
public:
    MOCK_METHOD(void, CreateObjectStore, (int64_t object_store_id, const String& name, const IDBKeyPath&, bool auto_increment), (override));
    MOCK_METHOD(void, DeleteObjectStore, (int64_t object_store_id), (override));
    MOCK_METHOD(void, Put,
        (int64_t object_store_id, std::unique_ptr<IDBValue> value, std::unique_ptr<IDBKey> key, mojom::blink::IDBPutMode, Vector<IDBIndexKeys>,
