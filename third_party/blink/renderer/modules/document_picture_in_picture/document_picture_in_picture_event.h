...
public:
    ...
    static DocumentPictureInPictureEvent* Create(const AtomicString&, const DocumentPictureInPictureEventInit*);

    DocumentPictureInPictureEvent(AtomicString const&, DOMWindow*);
    DocumentPictureInPictureEvent(AtomicString const&, const DocumentPictureInPictureEventInit*);
