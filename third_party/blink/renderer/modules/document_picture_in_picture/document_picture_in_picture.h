...
class MODULES_EXPORT DocumentPictureInPicture : public EventTarget, public Supplement<LocalDOMWindow> {
...
public:
    ...
    ScriptPromise<DOMWindow> requestWindow(ScriptState*, DocumentPictureInPictureOptions*, ExceptionState&);
