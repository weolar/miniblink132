...
class DeviceSensorEntry : public GarbageCollected<DeviceSensorEntry>, public device::mojom::blink::SensorClient {
public:
    ...
    enum class State { kNotInitialized, kInitializing, kActive, kShouldSuspend, kSuspended };

    DeviceSensorEntry(DeviceSensorEventPump* pump, ExecutionContext* context, device::mojom::blink::SensorType sensor_type);
...
private:
    ...
    void OnSensorCreated(device::mojom::blink::SensorCreationResult result, device::mojom::blink::SensorInitParamsPtr params);
    ...
    HeapMojoReceiver<device::mojom::blink::SensorClient, DeviceSensorEntry> client_receiver_;
