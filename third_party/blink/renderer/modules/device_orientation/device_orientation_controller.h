...
class MODULES_EXPORT DeviceOrientationController : public DeviceSingleWindowEventController, public Supplement<LocalDOMWindow> {
public:
    ...
    void DidAddEventListener(LocalDOMWindow*, const AtomicString& event_type) override;
    ...
    static void LogToConsolePolicyFeaturesDisabled(LocalFrame&, const AtomicString& event_name);

    ScriptPromise<V8DeviceOrientationPermissionState> RequestPermission(ScriptState*);
