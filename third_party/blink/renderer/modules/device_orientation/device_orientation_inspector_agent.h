...
public:
    ...
    DeviceOrientationInspectorAgent(const DeviceOrientationInspectorAgent&) = delete;
    DeviceOrientationInspectorAgent& operator=(const DeviceOrientationInspectorAgent&) = delete;
