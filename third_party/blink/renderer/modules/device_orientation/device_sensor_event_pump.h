...
public:
    ...
    static constexpr int kDefaultPumpDelayMicroseconds = base::Time::kMicrosecondsPerSecond / kDefaultPumpFrequencyHz;
    ...
    void SetSensorProviderForTesting(mojo::PendingRemote<mojom::blink::WebSensorProvider> sensor_provider);
