...
class PermissionStatusListener final : public GarbageCollected<PermissionStatusListener>,
...
public:
    ...
    static PermissionStatusListener* Create(Permissions&, ExecutionContext*, MojoPermissionStatus, MojoPermissionDescriptor);

    PermissionStatusListener(Permissions&, ExecutionContext*, MojoPermissionStatus, MojoPermissionDescriptor);
    ...
    void SetStatus(MojoPermissionStatus status)
    {
        status_ = status;
    }
...
private:
    ...
    HeapMojoReceiver<mojom::blink::PermissionObserver, PermissionStatusListener> receiver_;
};
