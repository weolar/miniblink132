...
constexpr V8PermissionState::Enum ToPermissionStateEnum(mojom::blink::PermissionStatus status)
{
    ...
    static_assert(V8PermissionState::kEnumSize == 3u,
...
PermissionDescriptorPtr CreateMidiPermissionDescriptor(bool sysex)
{
    ...
    descriptor->extension = mojom::blink::PermissionDescriptorExtension::NewMidi(std::move(midi_extension));
    return descriptor;
}

PermissionDescriptorPtr CreateClipboardPermissionDescriptor(PermissionName name, bool has_user_gesture, bool will_be_sanitized)
{
...
PermissionDescriptorPtr CreateVideoCapturePermissionDescriptor(bool pan_tilt_zoom)
{
    auto descriptor = CreatePermissionDescriptor(PermissionName::VIDEO_CAPTURE);
    auto camera_device_extension = mojom::blink::CameraDevicePermissionDescriptor::New(pan_tilt_zoom);
    descriptor->extension = mojom::blink::PermissionDescriptorExtension::NewCameraDevice(std::move(camera_device_extension));
    return descriptor;
}

PermissionDescriptorPtr CreateTopLevelStorageAccessPermissionDescriptor(const KURL& origin_as_kurl)
{
    auto descriptor = CreatePermissionDescriptor(PermissionName::TOP_LEVEL_STORAGE_ACCESS);
...
PermissionDescriptorPtr CreateFullscreenPermissionDescriptor(bool allow_without_user_gesture)
{
    auto descriptor = CreatePermissionDescriptor(PermissionName::FULLSCREEN);
    auto fullscreen_extension = mojom::blink::FullscreenPermissionDescriptor::New(allow_without_user_gesture);
    descriptor->extension = mojom::blink::PermissionDescriptorExtension::NewFullscreen(std::move(fullscreen_extension));
    return descriptor;
}

PermissionDescriptorPtr ParsePermissionDescriptor(ScriptState* script_state, const ScriptValue& raw_descriptor, ExceptionState& exception_state)
{
    PermissionDescriptor* permission
        = NativeValueTraits<PermissionDescriptor>::NativeValue(script_state->GetIsolate(), raw_descriptor.V8Value(), exception_state);
    ...
    if (name == V8PermissionName::Enum::kCamera) {
        CameraDevicePermissionDescriptor* camera_device_permission
            = NativeValueTraits<CameraDevicePermissionDescriptor>::NativeValue(script_state->GetIsolate(), raw_descriptor.V8Value(), exception_state);
        if (exception_state.HadException()) {
            return nullptr;
        }

        return CreateVideoCapturePermissionDescriptor(camera_device_permission->panTiltZoom());
    }
    ...
    if (name == V8PermissionName::Enum::kPush) {
        PushPermissionDescriptor* push_permission
            = NativeValueTraits<PushPermissionDescriptor>::NativeValue(script_state->GetIsolate(), raw_descriptor.V8Value(), exception_state);
        if (exception_state.HadException()) {
            return nullptr;
        }
        ...
        if (!push_permission->userVisibleOnly()) {
            exception_state.ThrowDOMException(DOMExceptionCode::kNotSupportedError, "Push Permission without userVisibleOnly:true isn't supported yet.");
            return nullptr;
        }
    ...
    if (name == V8PermissionName::Enum::kMidi) {
        MidiPermissionDescriptor* midi_permission
            = NativeValueTraits<MidiPermissionDescriptor>::NativeValue(script_state->GetIsolate(), raw_descriptor.V8Value(), exception_state);
    ...
    if (name == V8PermissionName::Enum ::kAmbientLightSensor || name == V8PermissionName::Enum::kAccelerometer || name == V8PermissionName::Enum::kGyroscope
        ...
        if (name == V8PermissionName::Enum::kAmbientLightSensor) {
            if (!RuntimeEnabledFeatures::SensorExtraClassesEnabled()) {
                exception_state.ThrowTypeError("GenericSensorExtraClasses flag is not enabled.");
                return nullptr;
            }
        }
    ...
    if (name == V8PermissionName::Enum::kClipboardRead || name == V8PermissionName::Enum::kClipboardWrite) {
        ...
        ClipboardPermissionDescriptor* clipboard_permission
            = NativeValueTraits<ClipboardPermissionDescriptor>::NativeValue(script_state->GetIsolate(), raw_descriptor.V8Value(), exception_state);
        return CreateClipboardPermissionDescriptor(permission_name,
    ...
    if (name == V8PermissionName::Enum::kSystemWakeLock) {
        if (!RuntimeEnabledFeatures::SystemWakeLockEnabled(ExecutionContext::From(script_state))) {
    ...
    if (name == V8PermissionName::Enum::kNfc) {
        if (!RuntimeEnabledFeatures::WebNFCEnabled(ExecutionContext::From(script_state))) {
    ...
    if (name == V8PermissionName::Enum::kTopLevelStorageAccess) {
        TopLevelStorageAccessPermissionDescriptor* top_level_storage_access_permission
            = NativeValueTraits<TopLevelStorageAccessPermissionDescriptor>::NativeValue(script_state->GetIsolate(), raw_descriptor.V8Value(), exception_state);
        if (exception_state.HadException()) {
            return nullptr;
        }
    ...
    if (name == V8PermissionName::Enum::kLocalFonts) {
        if (!RuntimeEnabledFeatures::FontAccessEnabled(ExecutionContext::From(script_state))) {
    ...
    if (name == V8PermissionName::Enum::kCapturedSurfaceControl) {
        if (!RuntimeEnabledFeatures::CapturedSurfaceControlEnabled(ExecutionContext::From(script_state))) {
            exception_state.ThrowTypeError("The Captured Surface Control API is not enabled.");
            return nullptr;
        }
        return CreatePermissionDescriptor(PermissionName::CAPTURED_SURFACE_CONTROL);
    }
    if (name == V8PermissionName::Enum::kSpeakerSelection) {
        if (!RuntimeEnabledFeatures::SpeakerSelectionEnabled(ExecutionContext::From(script_state))) {
            exception_state.ThrowTypeError("The Speaker Selection API is not enabled.");
            return nullptr;
        }
...
#else
        exception_state.ThrowTypeError("The Keyboard Lock permission isn't available on Android.");
        return nullptr;
#endif
    }
...
#else
        exception_state.ThrowTypeError("The Pointer Lock permission isn't available on Android.");
        return nullptr;
#endif
    }
    ...
    if (name == V8PermissionName::Enum::kFullscreen) {
        FullscreenPermissionDescriptor* fullscreen_permission
            = NativeValueTraits<FullscreenPermissionDescriptor>::NativeValue(script_state->GetIsolate(), raw_descriptor.V8Value(), exception_state);
        if (exception_state.HadException()) {
            return nullptr;
        }
        if (!fullscreen_permission->allowWithoutGesture()) {
            // There is no permission state for fullscreen with user gesture.
            exception_state.ThrowTypeError("Fullscreen Permission only supports allowWithoutGesture:true.");
            return nullptr;
        }
        return CreateFullscreenPermissionDescriptor(fullscreen_permission->allowWithoutGesture());
    }
    if (name == V8PermissionName::Enum::kWebAppInstallation) {
        if (!RuntimeEnabledFeatures::WebAppInstallationEnabled(ExecutionContext::From(script_state))) {
