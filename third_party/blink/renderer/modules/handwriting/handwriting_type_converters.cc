...
// static
HandwritingPointPtr TypeConverter<HandwritingPointPtr, blink::HandwritingPoint*>::Convert(const blink::HandwritingPoint* input)
{
    if (!input) {
        return nullptr;
    }
...
// static
HandwritingStrokePtr TypeConverter<HandwritingStrokePtr, blink::HandwritingStroke*>::Convert(const blink::HandwritingStroke* input)
{
    if (!input) {
        return nullptr;
    }
    auto output = handwriting::mojom::blink::HandwritingStroke::New();
    output->points = mojo::ConvertTo<Vector<HandwritingPointPtr>>(input->getPoints());
    return output;
}

// static
HandwritingHintsPtr TypeConverter<HandwritingHintsPtr, blink::HandwritingHints*>::Convert(const blink::HandwritingHints* input)
{
    if (!input) {
        return nullptr;
    }
...
// static
blink::HandwritingPoint* TypeConverter<blink::HandwritingPoint*, HandwritingPointPtr>::Convert(const HandwritingPointPtr& input)
{
    if (!input) {
        return nullptr;
    }
...
// static
blink::HandwritingStroke* TypeConverter<blink::HandwritingStroke*, HandwritingStrokePtr>::Convert(const HandwritingStrokePtr& input)
{
    if (!input) {
        return nullptr;
    }
...
// static
blink::HandwritingDrawingSegment* TypeConverter<blink::HandwritingDrawingSegment*, HandwritingDrawingSegmentPtr>::Convert(
    const HandwritingDrawingSegmentPtr& input)
{
    if (!input) {
        return nullptr;
    }
...
// static
blink::HandwritingSegment* TypeConverter<blink::HandwritingSegment*, handwriting::mojom::blink::HandwritingSegmentPtr>::Convert(
    const handwriting::mojom::blink::HandwritingSegmentPtr& input)
{
    ...
    blink::HeapVector<blink::Member<blink::HandwritingDrawingSegment>> drawing_segments;
...
// static
blink::HandwritingPrediction* TypeConverter<blink::HandwritingPrediction*, handwriting::mojom::blink::HandwritingPredictionPtr>::Convert(
...
TypeConverter<handwriting::mojom::blink::HandwritingModelConstraintPtr, blink::HandwritingModelConstraint*>::Convert(
...
Vector<blink::V8HandwritingRecognitionType> ConvertRecognitionType(const Vector<handwriting::mojom::blink::HandwritingRecognitionType>& input)
{
...
Vector<blink::V8HandwritingInputType> ConvertInputType(const Vector<handwriting::mojom::blink::HandwritingInputType>& input)
{
...
TypeConverter<blink::HandwritingRecognizerQueryResult*, handwriting::mojom::blink::QueryHandwritingRecognizerResultPtr>::Convert(
    const handwriting::mojom::blink::QueryHandwritingRecognizerResultPtr& input)
{
    ...
    hints->setRecognitionType(ConvertRecognitionType(input->hints->recognition_type));
