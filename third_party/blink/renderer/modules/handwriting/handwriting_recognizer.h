...
public:
    explicit HandwritingRecognizer(ExecutionContext* context, mojo::PendingRemote<handwriting::mojom::blink::HandwritingRecognizer> pending_remote);
    ...
    void GetPrediction(Vector<handwriting::mojom::blink::HandwritingStrokePtr> strokes, handwriting::mojom::blink::HandwritingHintsPtr hints,
        handwriting::mojom::blink::HandwritingRecognizer::GetPredictionCallback callback);

    // IDL Interface:
    HandwritingDrawing* startDrawing(ScriptState* script_state, const HandwritingHints* hints, ExceptionState& exception_state);
...
private:
    ...
    HeapMojoRemote<handwriting::mojom::blink::HandwritingRecognizer> remote_service_;
};
