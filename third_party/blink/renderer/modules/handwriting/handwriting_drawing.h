...
public:
    explicit HandwritingDrawing(ExecutionContext* context, HandwritingRecognizer* recognizer, const HandwritingHints* hints);
    ...
    void clear();
    ScriptPromise<IDLSequence<HandwritingPrediction>> getPrediction(ScriptState* script_state);
