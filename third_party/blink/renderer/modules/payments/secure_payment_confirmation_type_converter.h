...
template <> struct TypeConverter<payments::mojom::blink::SecurePaymentConfirmationRequestPtr, blink::SecurePaymentConfirmationRequest*> {
    static payments::mojom::blink::SecurePaymentConfirmationRequestPtr Convert(const blink::SecurePaymentConfirmationRequest* input);
};
