...
class DOMWindowDigitalGoods final : public GarbageCollected<DOMWindowDigitalGoods>, public Supplement<LocalDOMWindow> {
public:
    ...
    // IDL Interface:
    static ScriptPromise<DigitalGoodsService> getDigitalGoodsService(ScriptState*, LocalDOMWindow&, const String& payment_method, ExceptionState&);

    ScriptPromise<DigitalGoodsService> GetDigitalGoodsService(ScriptState*, LocalDOMWindow&, const String& payment_method, ExceptionState&);
