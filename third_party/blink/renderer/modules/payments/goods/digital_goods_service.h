...
public:
    explicit DigitalGoodsService(ExecutionContext* context, mojo::PendingRemote<payments::mojom::blink::DigitalGoods> pending_remote);
    ~DigitalGoodsService() override;

    // IDL Interface:
    ScriptPromise<IDLSequence<ItemDetails>> getDetails(ScriptState*, const Vector<String>& item_ids);
    ...
    ScriptPromise<IDLUndefined> consume(ScriptState*, const String& purchase_token);
