...
public:
    ...
    static ::payments::mojom::blink::SecurePaymentConfirmationRequestPtr ParseSecurePaymentConfirmationData(
        const ScriptValue& input, ExecutionContext&, ExceptionState&);
};
