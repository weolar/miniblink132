...
public:
    ...
    payments::mojom::blink::PaymentDetailsPtr& GetDetails()
    {
        return details_;
    }
...
TEST_F(PaymentRequestOptionalTotalTest, AppStoreBillingFlagEnabledTotalIsRequiredWhenMixMethods)
{
    ...
    PaymentRequest::Create(scope.GetExecutionContext(), method_data, details, scope.GetExceptionState());

    EXPECT_TRUE(scope.GetExceptionState().HadException());
    EXPECT_EQ("required member details is undefined.", scope.GetExceptionState().Message());
...
TEST_F(PaymentRequestOptionalTotalTest, AppStoreBillingFlagDisabledTotalIsRequiredWhenMixMethods)
{
...
TEST_F(PaymentRequestOptionalTotalTest, AppStoreBillingFlagEnabledTotalGetPlaceHolder)
{
    ScopedDigitalGoodsForTest digital_goods(true);
    ...
    MakeGarbageCollected<PaymentRequest>(
        scope.GetExecutionContext(), method_data, details, PaymentOptions::Create(), payment_provider_->CreatePendingRemoteAndBind(), ASSERT_NO_EXCEPTION);
...
TEST_F(PaymentRequestOptionalTotalTest, AppStoreBillingFlagDisabledTotalGetRejected)
{
    ScopedDigitalGoodsForTest digital_goods(false);
    ...
    MakeGarbageCollected<PaymentRequest>(scope.GetExecutionContext(), method_data, details, PaymentOptions::Create(),
        payment_provider_->CreatePendingRemoteAndBind(), scope.GetExceptionState());
    platform_->RunUntilIdle();
...
TEST_F(PaymentRequestOptionalTotalTest, AppStoreBillingFlagEnabledTotalGetOverridden)
{
    ScopedDigitalGoodsForTest digital_goods(true);
...
TEST_F(PaymentRequestOptionalTotalTest, AppStoreBillingFlagDisabledTotalNotGetOverridden)
{
    ScopedDigitalGoodsForTest digital_goods(false);
