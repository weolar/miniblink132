...
class UpdatePaymentDetailsResolve : public ThenCallable<PaymentDetailsUpdate, UpdatePaymentDetailsResolve> {
public:
...
class UpdatePaymentDetailsReject : public ThenCallable<IDLAny, UpdatePaymentDetailsReject> {
public:
