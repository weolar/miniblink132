...
public:
    ...
    ScriptPromise<IDLBoolean> enableDelegations(ScriptState*, const Vector<V8PaymentDelegation>& delegations, ExceptionState&);

    const HeapMojoRemote<payments::mojom::blink::PaymentManager>& manager() const
    {
        return manager_;
    }
...
private:
    ...
    void OnEnableDelegationsResponse(payments::mojom::blink::PaymentHandlerStatus status);
