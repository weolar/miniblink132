...
public:
    static PaymentCurrencyAmount* ToPaymentCurrencyAmount(payments::mojom::blink::PaymentCurrencyAmountPtr&);
    static CanMakePaymentEventInit* ToCanMakePaymentEventInit(ScriptState*, payments::mojom::blink::CanMakePaymentEventDataPtr);
    static PaymentRequestEventInit* ToPaymentRequestEventInit(ScriptState*, payments::mojom::blink::PaymentRequestEventDataPtr);
};
