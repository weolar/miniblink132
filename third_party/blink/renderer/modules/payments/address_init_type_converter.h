...
template <> struct TypeConverter<payments::mojom::blink::PaymentAddressPtr, blink::AddressInit*> {
    static payments::mojom::blink::PaymentAddressPtr Convert(const blink::AddressInit* input);
};
