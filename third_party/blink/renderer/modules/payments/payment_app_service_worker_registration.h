...
class PaymentAppServiceWorkerRegistration final : public GarbageCollected<PaymentAppServiceWorkerRegistration>, public Supplement<ServiceWorkerRegistration> {
public:
    static const char kSupplementName[];

    explicit PaymentAppServiceWorkerRegistration(ServiceWorkerRegistration*);

    PaymentAppServiceWorkerRegistration(const PaymentAppServiceWorkerRegistration&) = delete;
    PaymentAppServiceWorkerRegistration& operator=(const PaymentAppServiceWorkerRegistration&) = delete;

    virtual ~PaymentAppServiceWorkerRegistration();

    static PaymentAppServiceWorkerRegistration& From(ServiceWorkerRegistration&);

    static PaymentManager* paymentManager(ScriptState*, ServiceWorkerRegistration&, ExceptionState&);
