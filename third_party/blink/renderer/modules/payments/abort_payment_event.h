...
public:
    static AbortPaymentEvent* Create(const AtomicString& type, const ExtendableEventInit*);
    static AbortPaymentEvent* Create(const AtomicString& type, const ExtendableEventInit*, AbortPaymentRespondWithObserver*, WaitUntilObserver*);

    AbortPaymentEvent(const AtomicString& type, const ExtendableEventInit*, AbortPaymentRespondWithObserver*, WaitUntilObserver*);
