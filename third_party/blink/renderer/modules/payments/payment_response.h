...
class MODULES_EXPORT PaymentResponse final : public EventTarget, public ExecutionContextClient, public ActiveScriptWrappable<PaymentResponse> {
    DEFINE_WRAPPERTYPEINFO();

public:
    PaymentResponse(ScriptState* script_state, payments::mojom::blink::PaymentResponsePtr response, PaymentAddress* shipping_address,
    ...
    void Update(ScriptState* script_state, payments::mojom::blink::PaymentResponsePtr response, PaymentAddress* shipping_address);
    ...
    PaymentAddress* shippingAddress() const
    {
    ...
    ScriptPromise<IDLUndefined> complete(ScriptState*, const V8PaymentComplete& result, ExceptionState&);
    ScriptPromise<IDLUndefined> retry(ScriptState*, const PaymentValidationErrors*, ExceptionState&);
