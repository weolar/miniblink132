...
private:
    bool CompareGamepads(
        const HeapVector<Member<Gamepad>> old_gamepads, const HeapVector<Member<Gamepad>> new_gamepads, bool compare_all_axes, bool compare_all_buttons);
    bool CompareAxes(Gamepad* old_gamepad, Gamepad* new_gamepad, size_t gamepad_index, bool compare_all);
    bool CompareButtons(Gamepad* old_gamepad, Gamepad* new_gamepad, size_t gamepad_index, bool compare_all);
    ...
    std::array<std::bitset<device::Gamepad::kAxesLengthCap>, device::Gamepads::kItemsLengthCap> axis_changed_;
    std::array<std::bitset<device::Gamepad::kButtonsLengthCap>, device::Gamepads::kItemsLengthCap> button_changed_;
    std::array<std::bitset<device::Gamepad::kButtonsLengthCap>, device::Gamepads::kItemsLengthCap> button_down_;
    std::array<std::bitset<device::Gamepad::kButtonsLengthCap>, device::Gamepads::kItemsLengthCap> button_up_;
};
...
public:
    ...
    static void HasGamepadConnectionChanged(bool old_connected, bool new_connected, bool id_changed, bool* gamepad_found, bool* gamepad_lost);
