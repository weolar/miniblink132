...
public:
    ...
    virtual void DidConnectGamepad(uint32_t index, const device::Gamepad& gamepad) = 0;
    ...
    // connected gamepad.
    virtual void DidDisconnectGamepad(uint32_t index, const device::Gamepad& gamepad) = 0;
    ...
    // to the gamepad.
    virtual void ButtonOrAxisDidChange(uint32_t index, const device::Gamepad& gamepad) = 0;
};
