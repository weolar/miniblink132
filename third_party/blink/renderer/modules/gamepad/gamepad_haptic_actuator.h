...
class GamepadHapticActuator final : public ScriptWrappable, public ExecutionContextClient {
    DEFINE_WRAPPERTYPEINFO();

public:
    GamepadHapticActuator(ExecutionContext& context, int pad_index, device::GamepadHapticActuatorType type);
    ...
    ScriptPromise<V8GamepadHapticsResult> playEffect(ScriptState*, const V8GamepadHapticEffectType&, const GamepadEffectParameters*);
...
private:
    void OnPlayEffectCompleted(ScriptPromiseResolver<V8GamepadHapticsResult>*, device::mojom::GamepadHapticsResult);
    void OnResetCompleted(ScriptPromiseResolver<V8GamepadHapticsResult>*, device::mojom::GamepadHapticsResult);
