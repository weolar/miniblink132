...
class GamepadSharedMemoryReader : public GarbageCollected<GamepadSharedMemoryReader>, public device::mojom::blink::GamepadObserver {
public:
    ...
    GamepadSharedMemoryReader& operator=(const GamepadSharedMemoryReader&) = delete;
...
private:
    ...
    raw_ptr<const device::GamepadHardwareBuffer> gamepad_hardware_buffer_ = nullptr;

    bool ever_interacted_with_ = false;

    HeapMojoReceiver<device::mojom::blink::GamepadObserver, GamepadSharedMemoryReader> receiver_;
