...
protected:
    ...
    {
        base::TimeTicks dummy_time_origin = base::TimeTicks() + base::Microseconds(1000);
        base::TimeTicks dummy_time_floor = base::TimeTicks() + base::Microseconds(2000);
        return MakeGarbageCollected<Gamepad>(nullptr, 0, dummy_time_origin, dummy_time_floor);
    }
    ...
    void initTouch(float x, float y, uint8_t surface_id, uint32_t touch_id, bool has_surface_dimensions, uint32_t surface_width, uint32_t surface_height,
...
TEST_F(GamepadComparisonsTest, CompareEmptyLists)
{
    ...
    auto compareResult = GamepadComparisons::Compare(list1, list2, /*compare_all_axes=*/true, /*compare_all_buttons=*/true);
...
TEST_F(GamepadComparisonsTest, CompareNeutralWithAxisTilt)
{
    ...
    // axes.
    auto compareResult2 = GamepadComparisons::Compare(list1, list2, /*compare_all_axes*/ false, /*compare_all_buttons*/ true);
...
TEST_F(GamepadComparisonsTest, CompareNeutralWithButtonDown)
{
    ...
    // individual buttons.
    auto compareResult2 = GamepadComparisons::Compare(list1, list2, /*compare_all_axes*/ true, /*compare_all_buttons*/ false);
    EXPECT_TRUE(compareResult2.IsDifferent());
    EXPECT_FALSE(compareResult2.IsGamepadConnected(0));
    EXPECT_FALSE(compareResult2.IsGamepadDisconnected(0));
    EXPECT_FALSE(compareResult2.IsAxisChanged(0, 0));
...
TEST_F(GamepadComparisonsTest, CompareDifferentTouch)
{
    ...
    auto compareResult = GamepadComparisons::Compare(list1, list2, /*compare_all_axes=*/false, /*compare_all_buttons=*/false);
    EXPECT_TRUE(compareResult.IsDifferent());
}
...
TEST_F(GamepadComparisonsTest, CompareSameTouch1)
{
    ...
    auto compareResult = GamepadComparisons::Compare(list1, list1, /*compare_all_axes=*/false, /*compare_all_buttons=*/false);
    EXPECT_FALSE(compareResult.IsDifferent());
}
