...
class GamepadDispatcher final : public GarbageCollected<GamepadDispatcher>, public PlatformEventDispatcher, public GamepadListener {
public:
    ...
    void PlayVibrationEffectOnce(uint32_t pad_index, device::mojom::blink::GamepadHapticEffectType, device::mojom::blink::GamepadEffectParametersPtr,
        device::mojom::blink::GamepadHapticsManager::PlayVibrationEffectOnceCallback);
    void ResetVibrationActuator(uint32_t pad_index, device::mojom::blink::GamepadHapticsManager::ResetVibrationActuatorCallback);
...
private:
    ...
    void DispatchDidConnectOrDisconnectGamepad(uint32_t index, const device::Gamepad&, bool connected);

    WeakMember<ExecutionContext> execution_context_;
    Member<GamepadSharedMemoryReader> reader_;
    HeapMojoRemote<device::mojom::blink::GamepadHapticsManager> gamepad_haptics_manager_remote_;
};
