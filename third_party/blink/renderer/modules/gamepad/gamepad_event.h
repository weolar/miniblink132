...
public:
    static GamepadEvent* Create(const AtomicString& type, Bubbles bubbles, Cancelable cancelable, Gamepad* gamepad)
    {
        return MakeGarbageCollected<GamepadEvent>(type, bubbles, cancelable, gamepad);
    }
