...
void RejectCacheStorageWithError(ScriptPromiseResolverBase* resolver, mojom::blink::CacheStorageError web_error, const String& message)
{
    ...
    case mojom::CacheStorageError::kSuccess:
        ...
        NOTREACHED();
    case mojom::CacheStorageError::kErrorExists:
        resolver->RejectWithDOMException(DOMExceptionCode::kInvalidAccessError, final_message);
        return;
    case mojom::CacheStorageError::kErrorStorage:
        resolver->RejectWithDOMException(DOMExceptionCode::kUnknownError, final_message);
        return;
    case mojom::CacheStorageError::kErrorNotFound:
        resolver->RejectWithDOMException(DOMExceptionCode::kNotFoundError, final_message);
        return;
    case mojom::CacheStorageError::kErrorQuotaExceeded:
        resolver->RejectWithDOMException(DOMExceptionCode::kQuotaExceededError, final_message);
        return;
    case mojom::CacheStorageError::kErrorCacheNameNotFound:
        resolver->RejectWithDOMException(DOMExceptionCode::kNotFoundError, final_message);
        return;
    case mojom::CacheStorageError::kErrorQueryTooLarge:
        resolver->RejectWithDOMException(DOMExceptionCode::kAbortError, final_message);
        return;
    case mojom::CacheStorageError::kErrorNotImplemented:
        resolver->RejectWithDOMException(DOMExceptionCode::kNotSupportedError, final_message);
        return;
    case mojom::CacheStorageError::kErrorDuplicateOperation:
        resolver->RejectWithDOMException(DOMExceptionCode::kInvalidStateError, final_message);
        return;
    case mojom::CacheStorageError::kErrorCrossOriginResourcePolicy:
