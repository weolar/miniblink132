...
class MODULES_EXPORT CacheStorageBlobClientList : public GarbageCollected<CacheStorageBlobClientList> {
public:
    CacheStorageBlobClientList() = default;

    CacheStorageBlobClientList(const CacheStorageBlobClientList&) = delete;
    CacheStorageBlobClientList& operator=(const CacheStorageBlobClientList&) = delete;

    void AddClient(ExecutionContext* context, mojo::PendingReceiver<mojom::blink::BlobReaderClient> client_pending_receiver,
