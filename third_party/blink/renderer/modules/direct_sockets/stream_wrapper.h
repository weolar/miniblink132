...
public:
    ...
    ControllerType* Controller() const
    {
...
protected:
    ...
    static UnderlyingSourceBase* MakeForwardingUnderlyingSource(ReadableStreamDefaultWrapper* readable_stream_wrapper);

    void SetSource(UnderlyingSourceBase* source)
    {
        source_ = source;
    }
...
protected:
    ...
    static UnderlyingByteSourceBase* MakeForwardingUnderlyingByteSource(ReadableByteStreamWrapper* readable_stream_wrapper);

    void SetSource(UnderlyingByteSourceBase* source)
    {
        source_ = source;
    }
...
public:
    ...
    virtual bool HasPendingWrite() const
    {
        return false;
    }
...
protected:
    ...
    static UnderlyingSinkBase* MakeForwardingUnderlyingSink(WritableStreamWrapper* writable_stream_wrapper);

    void SetSink(UnderlyingSinkBase* sink)
    {
        sink_ = sink;
    }
