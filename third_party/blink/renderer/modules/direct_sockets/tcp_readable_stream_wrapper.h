...
class MODULES_EXPORT TCPReadableStreamWrapper : public GarbageCollected<TCPReadableStreamWrapper>, public ReadableByteStreamWrapper {
    USING_PRE_FINALIZER(TCPReadableStreamWrapper, Dispose);

public:
    TCPReadableStreamWrapper(ScriptState*, CloseOnceCallback, mojo::ScopedDataPipeConsumerHandle);
