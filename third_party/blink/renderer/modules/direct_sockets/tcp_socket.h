...
class MODULES_EXPORT TCPSocket final : public ScriptWrappable,
                                       public Socket,
...
public:
    // IDL definitions
    static TCPSocket* Create(ScriptState*, const String& remote_address, const uint16_t remote_port, const TCPSocketOptions*, ExceptionState&);
...
public:
    ...
    static TCPSocket* CreateFromAcceptedConnection(ScriptState*, mojo::PendingRemote<network::mojom::blink::TCPConnectedSocket>,
        mojo::PendingReceiver<network::mojom::blink::SocketObserver>, const net::IPEndPoint& remote_addr, mojo::ScopedDataPipeConsumerHandle receive_stream,
    ...
    bool Open(const String& remote_address, const uint16_t remote_port, const TCPSocketOptions*, ExceptionState&);

    // On net::OK initializes readable/writable streams and resolves opened
    // promise. Otherwise rejects the opened promise.
    void OnTCPSocketOpened(mojo::PendingRemote<network::mojom::blink::TCPConnectedSocket>, mojo::PendingReceiver<network::mojom::blink::SocketObserver>,
...
private:
    void FinishOpenOrAccept(mojo::PendingRemote<network::mojom::blink::TCPConnectedSocket>, mojo::PendingReceiver<network::mojom::blink::SocketObserver>,
        const net::IPEndPoint& peer_addr, const std::optional<net::IPEndPoint>& local_addr, mojo::ScopedDataPipeConsumerHandle receive_stream,
        mojo::ScopedDataPipeProducerHandle send_stream);
    ...
    HeapMojoReceiver<network::mojom::blink::SocketObserver, TCPSocket> socket_observer_;
