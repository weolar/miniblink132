...
public:
    explicit ForwardingUnderlyingSource(ReadableStreamDefaultWrapper* readable_stream_wrapper)
...
public:
    explicit ForwardingUnderlyingByteSource(ReadableByteStreamWrapper* readable_stream_wrapper)
        : readable_stream_wrapper_(readable_stream_wrapper)
    {
    }

    ScriptPromise<IDLUndefined> Pull(ReadableByteStreamController* controller, ExceptionState&) override
    {
...
public:
    explicit ForwardingUnderlyingSink(WritableStreamWrapper* writable_stream_wrapper)
    ...
    ScriptPromise<IDLUndefined> start(ScriptState* script_state, WritableStreamDefaultController* controller, ExceptionState&) override
    {
        ...
        public:
            ...
            void Run() override
            {
                writable_stream_wrapper_->OnAbortSignal();
            }
        ...
        abort_handle_ = Controller()->signal()->AddAlgorithm(MakeGarbageCollected<AbortAlgorithm>(writable_stream_wrapper_));
        return ToResolvedUndefinedPromise(script_state);
    }

    ScriptPromise<IDLUndefined> write(ScriptState*, ScriptValue chunk, WritableStreamDefaultController* controller, ExceptionState& exception_state) override
    {
...
ReadableStreamDefaultWrapper::ReadableStreamDefaultWrapper(ScriptState* script_state)
...
// static
UnderlyingSourceBase* ReadableStreamDefaultWrapper::MakeForwardingUnderlyingSource(ReadableStreamDefaultWrapper* readable_stream_wrapper)
{
    return MakeGarbageCollected<ForwardingUnderlyingSource>(readable_stream_wrapper);
}
...
// static
UnderlyingByteSourceBase* ReadableByteStreamWrapper::MakeForwardingUnderlyingByteSource(ReadableByteStreamWrapper* readable_stream_wrapper)
{
    return MakeGarbageCollected<ForwardingUnderlyingByteSource>(readable_stream_wrapper);
}
...
// static
UnderlyingSinkBase* WritableStreamWrapper::MakeForwardingUnderlyingSink(WritableStreamWrapper* writable_stream_wrapper)
{
    return MakeGarbageCollected<ForwardingUnderlyingSink>(writable_stream_wrapper);
}
