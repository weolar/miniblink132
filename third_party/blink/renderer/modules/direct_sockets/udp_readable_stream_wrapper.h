...
class MODULES_EXPORT UDPReadableStreamWrapper : public GarbageCollected<UDPReadableStreamWrapper>,
                                                public ReadableStreamDefaultWrapper,
                                                public network::mojom::blink::UDPSocketListener {
public:
    UDPReadableStreamWrapper(ScriptState*, CloseOnceCallback, const Member<UDPSocketMojoRemote> udp_socket,
...
private:
    ...
    HeapMojoReceiver<network::mojom::blink::UDPSocketListener, UDPReadableStreamWrapper> socket_listener_;
};
