...
class MODULES_EXPORT UDPWritableStreamWrapper final : public GarbageCollected<UDPWritableStreamWrapper>, public WritableStreamWrapper {
public:
    UDPWritableStreamWrapper(ScriptState*, CloseOnceCallback, const Member<UDPSocketMojoRemote>, network::mojom::blink::RestrictedUDPSocketMode);
    ...
    ScriptPromise<IDLUndefined> Write(ScriptValue chunk, ExceptionState&) override;
