...
class MODULES_EXPORT TCPWritableStreamWrapper : public GarbageCollected<TCPWritableStreamWrapper>, public WritableStreamWrapper {
    USING_PRE_FINALIZER(TCPWritableStreamWrapper, Dispose);

public:
    TCPWritableStreamWrapper(ScriptState*, CloseOnceCallback, mojo::ScopedDataPipeProducerHandle);
