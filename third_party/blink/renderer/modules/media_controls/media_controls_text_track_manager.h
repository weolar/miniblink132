...
class MODULES_EXPORT MediaControlsTextTrackManager : public GarbageCollected<MediaControlsTextTrackManager> {
public:
    ...
    MediaControlsTextTrackManager& operator=(const MediaControlsTextTrackManager&) = delete;
