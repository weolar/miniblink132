...
private:
    ...
    enum class DeviceOrientationType { kUnknown, kFlat, kDiagonal, kPortrait, kLandscape };
    ...
    // size.
    MODULES_EXPORT device::mojom::blink::ScreenOrientationLockType ComputeOrientationLock() const;
    ...
    MODULES_EXPORT DeviceOrientationType ComputeDeviceOrientation(DeviceOrientationData*) const;
    ...
    MODULES_EXPORT static constexpr base::TimeDelta kLockToAnyDelay = base::Milliseconds(500);
    ...
    device::mojom::blink::ScreenOrientationLockType locked_orientation_ = device::mojom::blink::ScreenOrientationLockType::DEFAULT /* unlocked */;
