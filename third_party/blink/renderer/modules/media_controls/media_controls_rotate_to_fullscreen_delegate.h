...
class MediaControlsRotateToFullscreenDelegate final : public NativeEventListener {
public:
...
private:
    ...
    void OnStateChange();
    void OnIntersectionChange(const HeapVector<Member<IntersectionObserverEntry>>& entries);
