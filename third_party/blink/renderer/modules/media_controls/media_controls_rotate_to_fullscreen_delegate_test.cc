...
class MediaControlsRotateToFullscreenDelegateTest : public PageTestBase,
...
protected:
    using SimpleOrientation = MediaControlsRotateToFullscreenDelegate::SimpleOrientation;

    void SetUp() override
    {
        chrome_client_ = MakeGarbageCollected<MockChromeClient>();
        SetupPageWithClients(chrome_client_, MakeGarbageCollected<StubLocalFrameClient>());
    ...
    {
        return !!static_cast<const MediaControlsImpl*>(&media_controls)->rotate_to_fullscreen_delegate_;
    }
    ...
    {
        return GetMediaControls().rotate_to_fullscreen_delegate_->current_screen_orientation_;
    }

    SimpleOrientation ComputeVideoOrientation() const
    {
        return GetMediaControls().rotate_to_fullscreen_delegate_->ComputeVideoOrientation();
    }

    bool IsObservingVisibility() const
    {
        return GetMediaControls().rotate_to_fullscreen_delegate_->intersection_observer_ != nullptr;
    }
    ...
    void InitScreenAndVideo(display::mojom::blink::ScreenOrientation initial_screen_orientation, gfx::Size video_size, bool with_device_orientation = true);
    ...
    void RotateTo(display::mojom::blink::ScreenOrientation new_screen_orientation);

    MockChromeClient& GetChromeClient() const
    {
    ...
    HTMLVideoElement& GetVideo() const
    {
        return *video_;
    }
    ...
    {
        return *static_cast<MockVideoWebMediaPlayer*>(GetVideo().GetWebMediaPlayer());
    }
...
void MediaControlsRotateToFullscreenDelegateTest::InitScreenAndVideo(
    display::mojom::blink::ScreenOrientation initial_screen_orientation, gfx::Size video_size, bool with_device_orientation /* = true */)
{
    // Set initial screen orientation (called by `Attach` during `AppendChild`).
    GetChromeClient().MockScreenInfo().orientation_type = initial_screen_orientation;
    ...
    if (with_device_orientation) {
        ...
        DeviceOrientationController::From(GetWindow())
            .SetOverride(DeviceOrientationData::Create(0.0 /* alpha */, 90.0 /* beta */, 0.0 /* gamma */, false /* absolute */));
        test::RunPendingTasks();
    }
}
...
void MediaControlsRotateToFullscreenDelegateTest::RotateTo(display::mojom::blink::ScreenOrientation new_screen_orientation)
{
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, OnlyObserveVisibilityWhenPlaying)
{
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterSuccessPortraitToLandscape)
{
    // Portrait screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(640, 480));
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterSuccessLandscapeToPortrait)
{
    // Landscape screen, portrait video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kLandscapePrimary, gfx::Size(480, 640));
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterSuccessSquarePortraitToLandscape)
{
    // Portrait screen, square video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(400, 400));
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
    EXPECT_EQ(SimpleOrientation::kLandscape, ComputeVideoOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailWrongOrientation)
{
    ...
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kLandscapePrimary, gfx::Size(640, 480));
    EXPECT_EQ(SimpleOrientation::kLandscape, ObservedScreenOrientation());
    EXPECT_EQ(SimpleOrientation::kLandscape, ComputeVideoOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailSquareWrongOrientation)
{
    // Landscape screen, square video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kLandscapePrimary, gfx::Size(400, 400));
    EXPECT_EQ(SimpleOrientation::kLandscape, ObservedScreenOrientation());
    EXPECT_EQ(SimpleOrientation::kLandscape, ComputeVideoOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailNoDeviceOrientation)
{
    // Portrait screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(640, 480), false /* with_device_orientation */);
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
    EXPECT_EQ(SimpleOrientation::kLandscape, ComputeVideoOrientation());
    ...
    DeviceOrientationController::From(GetWindow()).SetOverride(DeviceOrientationData::Create());
    test::RunPendingTasks();
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailZeroDeviceOrientation)
{
    // Portrait screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(640, 480), false /* with_device_orientation */);
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
    ...
    DeviceOrientationController::From(GetWindow())
        .SetOverride(DeviceOrientationData::Create(0.0 /* alpha */, 0.0 /* beta */, 0.0 /* gamma */, false /* absolute */));
    test::RunPendingTasks();
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailHidden)
{
    ...
    GetDocument().body()->style()->setProperty(GetDocument().GetExecutionContext(), "margin-top", "-999px", "", ASSERT_NO_EXCEPTION);
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFail180DegreeRotation)
{
    // Landscape screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kLandscapeSecondary, gfx::Size(640, 480));
    EXPECT_EQ(SimpleOrientation::kLandscape, ObservedScreenOrientation());
    EXPECT_EQ(SimpleOrientation::kLandscape, ComputeVideoOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailSmall)
{
    ...
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(300, 199));
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
    EXPECT_EQ(SimpleOrientation::kUnknown, ComputeVideoOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailDocumentFullscreen)
{
    // Portrait screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(640, 480));
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, ExitSuccessLandscapeFullscreenToPortraitInline)
{
    // Landscape screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kLandscapePrimary, gfx::Size(640, 480));
    EXPECT_EQ(SimpleOrientation::kLandscape, ObservedScreenOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, ExitSuccessPortraitFullscreenToLandscapeInline)
{
    // Portrait screen, portrait video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(480, 640));
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
    EXPECT_EQ(SimpleOrientation::kPortrait, ComputeVideoOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, ExitFailDocumentFullscreen)
{
    // Landscape screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kLandscapePrimary, gfx::Size(640, 480));
    EXPECT_EQ(SimpleOrientation::kLandscape, ObservedScreenOrientation());
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterFailControlsListNoFullscreen)
{
    // Portrait screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(640, 480));
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
    ...
    GetVideo().setAttribute(AtomicString("controlslist"), AtomicString("nofullscreen"));
...
TEST_F(MediaControlsRotateToFullscreenDelegateTest, EnterSuccessControlsListNoDownload)
{
    // Portrait screen, landscape video.
    InitScreenAndVideo(display::mojom::blink::ScreenOrientation::kPortraitPrimary, gfx::Size(640, 480));
    EXPECT_EQ(SimpleOrientation::kPortrait, ObservedScreenOrientation());
    ...
    GetVideo().setAttribute(AtomicString("controlslist"), AtomicString("nodownload"));
