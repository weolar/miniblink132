...
class MediaControlsResourceLoader : public CSSDefaultStyleSheets::UAStyleSheetLoader {
public:
    ...
    MediaControlsResourceLoader& operator=(const MediaControlsResourceLoader&) = delete;
