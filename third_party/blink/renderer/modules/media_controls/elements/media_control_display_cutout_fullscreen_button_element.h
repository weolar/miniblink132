...
class MediaControlDisplayCutoutFullscreenButtonElement final : public MediaControlInputElement {
public:
    MODULES_EXPORT explicit MediaControlDisplayCutoutFullscreenButtonElement(MediaControlsImpl&);
