...
class MediaControlPlaybackSpeedListElement final : public MediaControlPopupMenuElement {
public:
...
private:
    ...
    Element* CreatePlaybackSpeedListItem(const int display_name, const double playback_rate);
