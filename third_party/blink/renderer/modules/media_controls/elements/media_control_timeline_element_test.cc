...
public:
    ...
    MediaControlTimelineElement* Timeline() const
    {
        return timeline_;
    }
...
TEST_F(MediaControlTimelineElementTest, PointerDownPausesPlayback)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerdown, GetValidPointerEventInit()));
...
TEST_F(MediaControlTimelineElementTest, PointerDownRightClickNoOp)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerdown, init));
...
TEST_F(MediaControlTimelineElementTest, PointerUpResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerdown, GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerup, GetValidPointerEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, PointerUpRightClickNoOp)
{
    ...
    PointerEventInit* init = GetValidPointerEventInit();
    init->setButton(static_cast<int>(WebPointerProperties::Button::kRight));
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerup, init));
    EXPECT_TRUE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, PointerOutDoesNotResume)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerdown, GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerout, GetValidPointerEventInit()));
    EXPECT_TRUE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, PointerMoveDoesNotResume)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerdown, GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointermove, GetValidPointerEventInit()));
    EXPECT_TRUE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, PointerCancelResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointerdown, GetValidPointerEventInit()));
    Timeline()->DispatchEvent(*PointerEvent::Create(event_type_names::kPointercancel, GetValidPointerEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchStartPausesPlayback)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchstart, GetValidTouchEventInit()));
    EXPECT_TRUE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchEndResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchstart, GetValidTouchEventInit()));
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchend, GetValidTouchEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchCancelResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchstart, GetValidTouchEventInit()));
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchcancel, GetValidTouchEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, ChangeResumesPlayback)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchstart, GetValidTouchEventInit()));
    Timeline()->DispatchEvent(*Event::Create(event_type_names::kChange, GetValidTouchEventInit()));
    EXPECT_FALSE(Video()->paused());
}
...
TEST_F(MediaControlTimelineElementTest, TouchMoveDoesNotResume)
{
    ...
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchstart, GetValidTouchEventInit()));
    Timeline()->DispatchEvent(*TouchEvent::Create(event_type_names::kTouchmove, GetValidTouchEventInit()));
    EXPECT_TRUE(Video()->paused());
}
