...
MediaControlMuteButtonElement::MediaControlMuteButtonElement(MediaControlsImpl& media_controls)
...
void MediaControlMuteButtonElement::UpdateDisplayType()
{
    ...
    setAttribute(html_names::kAriaLabelAttr, WTF::AtomicString(GetLocale().QueryString(muted ? IDS_AX_MEDIA_UNMUTE_BUTTON : IDS_AX_MEDIA_MUTE_BUTTON)));
