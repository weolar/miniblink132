...
class MODULES_EXPORT MediaControlAnimatedArrowContainerElement final : public MediaControlDivElement {
public:
...
private:
    ...
    class MODULES_EXPORT AnimatedArrow final : public HTMLDivElement, public MediaControlAnimationEventListener::Observer {
    public:
