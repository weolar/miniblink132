...
MediaControlElementBase::MediaControlElementBase(MediaControlsImpl& media_controls, HTMLElement* element)
...
void MediaControlElementBase::UpdateShownState()
{
    if (is_wanted_ && does_fit_) {
        ...
        element_->SetInlineStyleProperty(CSSPropertyID::kDisplay, CSSValueID::kNone);
    }
}
