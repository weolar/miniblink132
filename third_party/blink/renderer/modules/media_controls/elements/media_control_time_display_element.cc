...
MediaControlTimeDisplayElement::MediaControlTimeDisplayElement(MediaControlsImpl& media_controls)
...
{
    return MediaControlElementsHelper::GetSizeOrDefault(*this, gfx::Size(EstimateElementWidth(), kDefaultTimeDisplayHeight));
}
...
int MediaControlTimeDisplayElement::EstimateElementWidth() const
{
    ...
    return kDefaultTimeDisplayColonWidth * colons + kDefaultTimeDisplayDigitWidth * (formatted_time.length() - colons);
}
