...
MediaControlVolumeControlContainerElement::MediaControlVolumeControlContainerElement(MediaControlsImpl& media_controls)
    : MediaControlDivElement(media_controls)
{
    SetShadowPseudoId(AtomicString("-webkit-media-controls-volume-control-container"));
    MediaControlElementsHelper::CreateDiv(AtomicString("-webkit-media-controls-volume-control-hover-background"), this);
...
void MediaControlVolumeControlContainerElement::DefaultEventHandler(Event& event)
{
