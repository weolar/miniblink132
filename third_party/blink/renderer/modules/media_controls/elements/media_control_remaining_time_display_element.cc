...
MediaControlRemainingTimeDisplayElement::MediaControlRemainingTimeDisplayElement(MediaControlsImpl& media_controls)
    : MediaControlTimeDisplayElement(media_controls)
{
    SetShadowPseudoId(AtomicString("-webkit-media-controls-time-remaining-display"));
}
