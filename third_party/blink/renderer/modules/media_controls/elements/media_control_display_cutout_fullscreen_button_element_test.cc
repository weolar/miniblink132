...
class MediaControlDisplayCutoutFullscreenButtonElementTest : public PageTestBase, private ScopedDisplayCutoutAPIForTest {
public:
    ...
    void SetUp() override
    {
        ...
        display_cutout_fullscreen_button_ = controls_->display_cutout_fullscreen_button_;
    }
...
protected:
    ...
    Persistent<MediaControlDisplayCutoutFullscreenButtonElement> display_cutout_fullscreen_button_;
    Persistent<MediaControlsImpl> controls_;
};

TEST_F(MediaControlDisplayCutoutFullscreenButtonElementTest, Fullscreen_ButtonAccessibility)
{
    EXPECT_EQ(display_cutout_fullscreen_button_->GetLocale().QueryString(IDS_AX_MEDIA_DISPLAY_CUT_OUT_FULL_SCREEN_BUTTON),
        display_cutout_fullscreen_button_->getAttribute(html_names::kAriaLabelAttr));
}

TEST_F(MediaControlDisplayCutoutFullscreenButtonElementTest, Fullscreen_ButtonVisiblilty)
{
...
TEST_F(MediaControlDisplayCutoutFullscreenButtonElementTest, Fullscreen_ButtonTogglesDisplayCutoutFullscreen)
{
    SimulateEnterFullscreen();
