...
class KeyboardLayout final : public GarbageCollected<KeyboardLayout>, public ExecutionContextClient {
public:
    ...
    ScriptPromise<KeyboardLayoutMap> GetKeyboardLayoutMap(ScriptState*, ExceptionState&);
...
private:
    ...
    void GotKeyboardLayoutMap(ScriptPromiseResolver<KeyboardLayoutMap>*, mojom::blink::GetKeyboardLayoutMapResultPtr);
