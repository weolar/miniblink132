...
ScriptPromise<IDLUndefined> Keyboard::lock(ScriptState* state, const Vector<String>& keycodes, ExceptionState& exception_state)
{
...
ScriptPromise<KeyboardLayoutMap> Keyboard::getLayoutMap(ScriptState* state, ExceptionState& exception_state)
{
