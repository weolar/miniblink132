...
class KeyboardLayoutMapIterationSource final : public PairSyncIterable<KeyboardLayoutMap>::IterationSource {
public:
    ...
    bool FetchNextItem(ScriptState* script_state, String& map_key, String& map_value, ExceptionState&) override
    {
...
PairSyncIterable<KeyboardLayoutMap>::IterationSource* KeyboardLayoutMap::CreateIterationSource(ScriptState*, ExceptionState&)
{
    return MakeGarbageCollected<KeyboardLayoutMapIterationSource>(*this);
}

bool KeyboardLayoutMap::GetMapEntry(ScriptState*, const String& key, String& value, ExceptionState&)
{
