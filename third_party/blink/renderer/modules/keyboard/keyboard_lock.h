...
public:
    ...
    ScriptPromise<IDLUndefined> lock(ScriptState*, const Vector<String>&, ExceptionState&);
...
private:
    ...
    void LockRequestFinished(ScriptPromiseResolver<IDLUndefined>*, mojom::KeyboardLockRequestResult);
