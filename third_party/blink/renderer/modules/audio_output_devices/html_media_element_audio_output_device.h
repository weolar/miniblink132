...
class MODULES_EXPORT HTMLMediaElementAudioOutputDevice final : public GarbageCollected<HTMLMediaElementAudioOutputDevice>, public AudioOutputDeviceController {
public:
    ...
    static ScriptPromise<IDLUndefined> setSinkId(ScriptState*, HTMLMediaElement&, const String& sink_id);
