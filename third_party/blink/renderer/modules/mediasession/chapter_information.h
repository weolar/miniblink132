...
public:
    static ChapterInformation* From(ScriptState* script_state, const ChapterInformationInit* chapter, ExceptionState& exception_state);

    static ChapterInformation* Create(ScriptState* script_state, const String& title, const double& start_time, const HeapVector<Member<MediaImage>>& artwork,
        ExceptionState& exception_state);

    ChapterInformation(ScriptState* script_state, const String& title, const double& start_time, const HeapVector<Member<MediaImage>>& artwork,
        ExceptionState& exception_state);
...
private:
    ...
    void SetArtworkInternal(ScriptState*, const HeapVector<Member<MediaImage>>&, ExceptionState&);
