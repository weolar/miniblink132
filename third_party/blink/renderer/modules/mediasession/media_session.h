...
class MODULES_EXPORT MediaSession final : public ScriptWrappable, public Supplement<Navigator>, public blink::mojom::blink::MediaSessionClient {
...
public:
    ...
    void setActionHandler(const V8MediaSessionAction& action, V8MediaSessionActionHandler*, ExceptionState&);
...
private:
    ...
    void DidReceiveAction(media_session::mojom::blink::MediaSessionAction, mojom::blink::MediaSessionActionDetailsPtr) override;
    ...
    HeapHashMap<V8MediaSessionAction::Enum, Member<V8MediaSessionActionHandler>> action_handlers_;
    HeapMojoRemote<mojom::blink::MediaSessionService> service_;
    HeapMojoReceiver<blink::mojom::blink::MediaSessionClient, MediaSession> client_receiver_;
};
