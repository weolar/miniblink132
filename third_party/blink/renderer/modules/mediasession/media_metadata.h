...
public:
    static MediaMetadata* Create(ScriptState*, const MediaMetadataInit*, ExceptionState&);
    ...
    void setArtwork(ScriptState*, const HeapVector<Member<MediaImage>>&, ExceptionState&);
...
private:
    ...
    void SetChapterInfoFromInit(ScriptState*, const HeapVector<Member<ChapterInformationInit>>&, ExceptionState&);
