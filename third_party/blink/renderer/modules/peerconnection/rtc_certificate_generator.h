...
using RTCCertificateCallback = base::OnceCallback<void(rtc::scoped_refptr<rtc::RTCCertificate>)>;
...
public:
    ...
    // completed.
    void GenerateCertificate(const rtc::KeyParams& key_params, blink::RTCCertificateCallback completion_callback, ExecutionContext& context,
        scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    void GenerateCertificateWithExpiration(const rtc::KeyParams& key_params, uint64_t expires_ms, blink::RTCCertificateCallback completion_callback,
    ...
    rtc::scoped_refptr<rtc::RTCCertificate> FromPEM(String pem_private_key, String pem_certificate);
};
