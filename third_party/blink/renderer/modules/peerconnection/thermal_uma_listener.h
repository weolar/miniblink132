...
public:
    static std::unique_ptr<ThermalUmaListener> Create(scoped_refptr<base::SequencedTaskRunner> task_runner);

    explicit ThermalUmaListener(scoped_refptr<base::SequencedTaskRunner> task_runner);
