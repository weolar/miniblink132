...
public:
    static RTCEncodedAudioFrame* Create(RTCEncodedAudioFrame* original_frame, ExceptionState& exception_state);
    static RTCEncodedAudioFrame* Create(RTCEncodedAudioFrame* original_frame, const RTCEncodedAudioFrameOptions* options_dict, ExceptionState& exception_state);
    explicit RTCEncodedAudioFrame(std::unique_ptr<webrtc::TransformableAudioFrameInterface> webrtc_frame);
    explicit RTCEncodedAudioFrame(std::unique_ptr<webrtc::TransformableAudioFrameInterface> webrtc_frame, base::UnguessableToken owner_id, int64_t counter);
    explicit RTCEncodedAudioFrame(scoped_refptr<RTCEncodedAudioFrameDelegate> delegate);
    ...
    base::expected<void, String> SetMetadata(const RTCEncodedAudioFrameMetadata* metadata);
    void setMetadata(RTCEncodedAudioFrameMetadata* metadata, ExceptionState& exception_state);
    ...
    std::unique_ptr<webrtc::TransformableAudioFrameInterface> PassWebRtcFrame(v8::Isolate* isolate, bool detach_frame_data);
