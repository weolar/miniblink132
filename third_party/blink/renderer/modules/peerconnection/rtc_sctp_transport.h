...
class MODULES_EXPORT RTCSctpTransport final : public EventTarget, public ExecutionContextClient, public SctpTransportProxy::Delegate {
    DEFINE_WRAPPERTYPEINFO();

public:
    RTCSctpTransport(ExecutionContext* context, rtc::scoped_refptr<webrtc::SctpTransportInterface> native_transport);
