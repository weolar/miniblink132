...
public:
    static RTCTrackEvent* Create(const AtomicString& type, const RTCTrackEventInit* eventInitDict);
    RTCTrackEvent(RTCRtpReceiver*, MediaStreamTrack*, const HeapVector<Member<MediaStream>>&, RTCRtpTransceiver*);
    RTCTrackEvent(const AtomicString& type, const RTCTrackEventInit* eventInitDict);
