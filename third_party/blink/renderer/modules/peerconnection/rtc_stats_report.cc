...
template <typename T> v8::Local<v8::Value> HashMapToValue(ScriptState* script_state, HashMap<String, T>&& map)
{
...
RTCCodecStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCCodecStats& webrtc_stat)
{
    RTCCodecStats* v8_codec = MakeGarbageCollected<RTCCodecStats>(script_state->GetIsolate());
...
RTCInboundRtpStreamStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCInboundRtpStreamStats& webrtc_stat, bool expose_hardware_caps)
{
    RTCInboundRtpStreamStats* v8_stat = MakeGarbageCollected<RTCInboundRtpStreamStats>(script_state->GetIsolate());
    // RTCRtpStreamStats
    ...
    if (webrtc_stat.track_identifier.has_value()) {
        v8_stat->setTrackIdentifier(String::FromUTF8(*webrtc_stat.track_identifier));
    }
    ...
    if (webrtc_stat.total_corruption_probability.has_value()) {
        v8_stat->setTotalCorruptionProbability(*webrtc_stat.total_corruption_probability);
    }
    if (webrtc_stat.total_squared_corruption_probability.has_value()) {
        v8_stat->setTotalSquaredCorruptionProbability(*webrtc_stat.total_squared_corruption_probability);
    }
    ...
    if (webrtc_stat.total_squared_inter_frame_delay.has_value()) {
        v8_stat->setTotalSquaredInterFrameDelay(*webrtc_stat.total_squared_inter_frame_delay);
    }
    ...
    if (webrtc_stat.last_packet_received_timestamp.has_value()) {
        v8_stat->setLastPacketReceivedTimestamp(*webrtc_stat.last_packet_received_timestamp);
    }
    ...
    if (webrtc_stat.estimated_playout_timestamp.has_value()) {
        v8_stat->setEstimatedPlayoutTimestamp(*webrtc_stat.estimated_playout_timestamp);
    }
    ...
    if (webrtc_stat.jitter_buffer_target_delay.has_value()) {
        v8_stat->setJitterBufferTargetDelay(*webrtc_stat.jitter_buffer_target_delay);
    }
    if (webrtc_stat.jitter_buffer_emitted_count.has_value()) {
        v8_stat->setJitterBufferEmittedCount(*webrtc_stat.jitter_buffer_emitted_count);
    }
    if (webrtc_stat.jitter_buffer_minimum_delay.has_value()) {
        v8_stat->setJitterBufferMinimumDelay(*webrtc_stat.jitter_buffer_minimum_delay);
    }
    ...
    if (webrtc_stat.inserted_samples_for_deceleration.has_value()) {
        v8_stat->setInsertedSamplesForDeceleration(*webrtc_stat.inserted_samples_for_deceleration);
    }
    if (webrtc_stat.removed_samples_for_acceleration.has_value()) {
        v8_stat->setRemovedSamplesForAcceleration(*webrtc_stat.removed_samples_for_acceleration);
    }
    ...
    if (webrtc_stat.frames_assembled_from_multiple_packets.has_value()) {
        v8_stat->setFramesAssembledFromMultiplePackets(*webrtc_stat.frames_assembled_from_multiple_packets);
    }
    ...
    if (expose_hardware_caps) {
        ...
        if (webrtc_stat.decoder_implementation.has_value()) {
            v8_stat->setDecoderImplementation(String::FromUTF8(*webrtc_stat.decoder_implementation));
        }
    }
    ...
    if (webrtc_stat.goog_timing_frame_info.has_value()) {
        v8_stat->setGoogTimingFrameInfo(String::FromUTF8(*webrtc_stat.goog_timing_frame_info));
    }
    if (webrtc_stat.retransmitted_packets_received.has_value()) {
        v8_stat->setRetransmittedPacketsReceived(*webrtc_stat.retransmitted_packets_received);
    }
    if (webrtc_stat.retransmitted_bytes_received.has_value()) {
        v8_stat->setRetransmittedBytesReceived(*webrtc_stat.retransmitted_bytes_received);
    }
...
RTCRemoteInboundRtpStreamStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCRemoteInboundRtpStreamStats& webrtc_stat)
{
    RTCRemoteInboundRtpStreamStats* v8_stat = MakeGarbageCollected<RTCRemoteInboundRtpStreamStats>(script_state->GetIsolate());
    // RTCRtpStreamStats
    if (webrtc_stat.ssrc.has_value()) {
        v8_stat->setSsrc(*webrtc_stat.ssrc);
    }
    ...
    if (webrtc_stat.round_trip_time_measurements.has_value()) {
        v8_stat->setRoundTripTimeMeasurements(*webrtc_stat.round_trip_time_measurements);
    }
    return v8_stat;
}

RTCOutboundRtpStreamStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCOutboundRtpStreamStats& webrtc_stat, bool expose_hardware_caps)
{
    RTCOutboundRtpStreamStats* v8_stat = MakeGarbageCollected<RTCOutboundRtpStreamStats>(script_state->GetIsolate());
    // RTCRtpStreamStats
    if (webrtc_stat.ssrc.has_value()) {
        v8_stat->setSsrc(*webrtc_stat.ssrc);
    }
    ...
    if (webrtc_stat.retransmitted_packets_sent.has_value()) {
        v8_stat->setRetransmittedPacketsSent(*webrtc_stat.retransmitted_packets_sent);
    }
    ...
    if (webrtc_stat.total_encoded_bytes_target.has_value()) {
        v8_stat->setTotalEncodedBytesTarget(*webrtc_stat.total_encoded_bytes_target);
    }
    if (webrtc_stat.frame_width.has_value()) {
        v8_stat->setFrameWidth(*webrtc_stat.frame_width);
    }
    ...
    if (webrtc_stat.quality_limitation_reason.has_value()) {
        v8_stat->setQualityLimitationReason(String::FromUTF8(*webrtc_stat.quality_limitation_reason));
    }
    ...
    if (webrtc_stat.quality_limitation_resolution_changes.has_value()) {
        v8_stat->setQualityLimitationResolutionChanges(*webrtc_stat.quality_limitation_resolution_changes);
    }
    if (webrtc_stat.nack_count.has_value()) {
        v8_stat->setNackCount(*webrtc_stat.nack_count);
    }
    ...
    if (webrtc_stat.scalability_mode.has_value()) {
        v8_stat->setScalabilityMode(String::FromUTF8(*webrtc_stat.scalability_mode));
    }
    if (expose_hardware_caps) {
        if (webrtc_stat.encoder_implementation.has_value()) {
            v8_stat->setEncoderImplementation(String::FromUTF8(*webrtc_stat.encoder_implementation));
        }
...
RTCRemoteOutboundRtpStreamStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCRemoteOutboundRtpStreamStats& webrtc_stat)
{
    RTCRemoteOutboundRtpStreamStats* v8_stat = MakeGarbageCollected<RTCRemoteOutboundRtpStreamStats>(script_state->GetIsolate());
    // RTCRtpStreamStats
    if (webrtc_stat.ssrc.has_value()) {
        v8_stat->setSsrc(*webrtc_stat.ssrc);
    }
...
RTCAudioSourceStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCAudioSourceStats& webrtc_stat)
{
    RTCAudioSourceStats* v8_stat = MakeGarbageCollected<RTCAudioSourceStats>(script_state->GetIsolate());
    // RTCMediaSourceStats
    if (webrtc_stat.track_identifier.has_value()) {
        v8_stat->setTrackIdentifier(String::FromUTF8(*webrtc_stat.track_identifier));
    }
    ...
    if (webrtc_stat.echo_return_loss_enhancement.has_value()) {
        v8_stat->setEchoReturnLossEnhancement(*webrtc_stat.echo_return_loss_enhancement);
    }
    return v8_stat;
}

// https://w3c.github.io/webrtc-stats/#videosourcestats-dict*
RTCVideoSourceStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCVideoSourceStats& webrtc_stat)
{
    RTCVideoSourceStats* v8_stat = MakeGarbageCollected<RTCVideoSourceStats>(script_state->GetIsolate());
    // RTCMediaSourceStats
    if (webrtc_stat.track_identifier.has_value()) {
        v8_stat->setTrackIdentifier(String::FromUTF8(*webrtc_stat.track_identifier));
    }
...
RTCAudioPlayoutStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCAudioPlayoutStats& webrtc_stat)
{
    RTCAudioPlayoutStats* v8_stat = MakeGarbageCollected<RTCAudioPlayoutStats>(script_state->GetIsolate());

    if (webrtc_stat.kind.has_value()) {
        v8_stat->setKind(String::FromUTF8(*webrtc_stat.kind));
    }
    if (webrtc_stat.synthesized_samples_duration.has_value()) {
        v8_stat->setSynthesizedSamplesDuration(*webrtc_stat.synthesized_samples_duration);
    }
    if (webrtc_stat.synthesized_samples_events.has_value()) {
        v8_stat->setSynthesizedSamplesEvents(base::saturated_cast<uint32_t>(*webrtc_stat.synthesized_samples_events));
    }
    if (webrtc_stat.total_samples_duration.has_value()) {
        v8_stat->setTotalSamplesDuration(*webrtc_stat.total_samples_duration);
    }
...
RTCPeerConnectionStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCPeerConnectionStats& webrtc_stat)
{
    RTCPeerConnectionStats* v8_stat = MakeGarbageCollected<RTCPeerConnectionStats>(script_state->GetIsolate());
...
RTCDataChannelStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCDataChannelStats& webrtc_stat)
{
    RTCDataChannelStats* v8_stat = MakeGarbageCollected<RTCDataChannelStats>(script_state->GetIsolate());
...
RTCTransportStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCTransportStats& webrtc_stat)
{
    RTCTransportStats* v8_stat = MakeGarbageCollected<RTCTransportStats>(script_state->GetIsolate());
    ...
    if (webrtc_stat.ice_local_username_fragment.has_value()) {
        v8_stat->setIceLocalUsernameFragment(String::FromUTF8(*webrtc_stat.ice_local_username_fragment));
    }
    ...
    if (webrtc_stat.selected_candidate_pair_id.has_value()) {
        v8_stat->setSelectedCandidatePairId(String::FromUTF8(*webrtc_stat.selected_candidate_pair_id));
    }
    if (webrtc_stat.local_certificate_id.has_value()) {
        v8_stat->setLocalCertificateId(String::FromUTF8(*webrtc_stat.local_certificate_id));
    }
    if (webrtc_stat.remote_certificate_id.has_value()) {
        v8_stat->setRemoteCertificateId(String::FromUTF8(*webrtc_stat.remote_certificate_id));
    }
    ...
    if (webrtc_stat.selected_candidate_pair_changes.has_value()) {
        v8_stat->setSelectedCandidatePairChanges(*webrtc_stat.selected_candidate_pair_changes);
    }
    ...
    if (webrtc_stat.rtcp_transport_stats_id.has_value()) {
        v8_stat->setRtcpTransportStatsId(String::FromUTF8(*webrtc_stat.rtcp_transport_stats_id));
    }
    return v8_stat;
}

// https://w3c.github.io/webrtc-stats/#icecandidate-dict*
RTCIceCandidateStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCIceCandidateStats& webrtc_stat)
{
    RTCIceCandidateStats* v8_stat = MakeGarbageCollected<RTCIceCandidateStats>(script_state->GetIsolate());
    if (webrtc_stat.transport_id.has_value()) {
        v8_stat->setTransportId(String::FromUTF8(*webrtc_stat.transport_id));
    }
    ...
    if (webrtc_stat.username_fragment.has_value()) {
        v8_stat->setUsernameFragment(String::FromUTF8(*webrtc_stat.username_fragment));
    }
...
RTCIceCandidatePairStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCIceCandidatePairStats& webrtc_stat)
{
    RTCIceCandidatePairStats* v8_stat = MakeGarbageCollected<RTCIceCandidatePairStats>(script_state->GetIsolate());
    if (webrtc_stat.transport_id.has_value()) {
        v8_stat->setTransportId(String::FromUTF8(*webrtc_stat.transport_id));
    }
    if (webrtc_stat.local_candidate_id.has_value()) {
        v8_stat->setLocalCandidateId(String::FromUTF8(*webrtc_stat.local_candidate_id));
    }
    if (webrtc_stat.remote_candidate_id.has_value()) {
        v8_stat->setRemoteCandidateId(String::FromUTF8(*webrtc_stat.remote_candidate_id));
    }
    if (webrtc_stat.state.has_value()) {
        v8_stat->setState(String::FromUTF8(*webrtc_stat.state));
    }
    ...
    if (webrtc_stat.last_packet_sent_timestamp.has_value()) {
        v8_stat->setLastPacketSentTimestamp(*webrtc_stat.last_packet_sent_timestamp);
    }
    if (webrtc_stat.last_packet_received_timestamp.has_value()) {
        v8_stat->setLastPacketReceivedTimestamp(*webrtc_stat.last_packet_received_timestamp);
    }
    ...
    if (webrtc_stat.available_outgoing_bitrate.has_value()) {
        v8_stat->setAvailableOutgoingBitrate(*webrtc_stat.available_outgoing_bitrate);
    }
    if (webrtc_stat.available_incoming_bitrate.has_value()) {
        v8_stat->setAvailableIncomingBitrate(*webrtc_stat.available_incoming_bitrate);
    }
    ...
    if (webrtc_stat.packets_discarded_on_send.has_value()) {
        v8_stat->setPacketsDiscardedOnSend(base::saturated_cast<uint32_t>(*webrtc_stat.packets_discarded_on_send));
    }
...
RTCCertificateStats* ToV8Stat(ScriptState* script_state, const webrtc::RTCCertificateStats& webrtc_stat)
{
    ...
    if (webrtc_stat.fingerprint_algorithm.has_value()) {
        v8_stat->setFingerprintAlgorithm(String::FromUTF8(*webrtc_stat.fingerprint_algorithm));
    }
    if (webrtc_stat.base64_certificate.has_value()) {
        v8_stat->setBase64Certificate(String::FromUTF8(*webrtc_stat.base64_certificate));
    }
    if (webrtc_stat.issuer_certificate_id.has_value()) {
        v8_stat->setIssuerCertificateId(String::FromUTF8(*webrtc_stat.issuer_certificate_id));
    }
    return v8_stat;
}

RTCStats* RTCStatsToIDL(ScriptState* script_state, const webrtc::RTCStats& stat, bool expose_hardware_caps)
{
    ...
    if (strcmp(stat.type(), "codec") == 0) {
        ...
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCInboundRtpStreamStats>(), expose_hardware_caps);
    } else if (strcmp(stat.type(), "outbound-rtp") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCOutboundRtpStreamStats>(), expose_hardware_caps);
    } else if (strcmp(stat.type(), "remote-inbound-rtp") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCRemoteInboundRtpStreamStats>());
    } else if (strcmp(stat.type(), "remote-outbound-rtp") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCRemoteOutboundRtpStreamStats>());
    } else if (strcmp(stat.type(), "media-source") == 0) {
        // Type media-source indicates a parent type. The actual stats are based on
        // the kind.
        const auto& media_source = static_cast<const webrtc::RTCMediaSourceStats&>(stat);
        DCHECK(media_source.kind.has_value());
        std::string kind = media_source.kind.value_or("");
        if (kind == "audio") {
            v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCAudioSourceStats>());
        } else if (kind == "video") {
            v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCVideoSourceStats>());
        } else {
            NOTIMPLEMENTED() << "Unhandled media source stat type: " << kind;
            return nullptr;
        }
    } else if (strcmp(stat.type(), "media-playout") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCAudioPlayoutStats>());
    } else if (strcmp(stat.type(), "peer-connection") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCPeerConnectionStats>());
    } else if (strcmp(stat.type(), "data-channel") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCDataChannelStats>());
    } else if (strcmp(stat.type(), "transport") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCTransportStats>());
    } else if (strcmp(stat.type(), "candidate-pair") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCIceCandidatePairStats>());
    } else if (strcmp(stat.type(), "local-candidate") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCLocalIceCandidateStats>());
    } else if (strcmp(stat.type(), "remote-candidate") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCRemoteIceCandidateStats>());
    } else if (strcmp(stat.type(), "certificate") == 0) {
        v8_stats = ToV8Stat(script_state, stat.cast_to<webrtc::RTCCertificateStats>());
    } else {
    ...
    DocumentLoadTiming& time_converter = window->GetFrame()->Loader().GetDocumentLoader()->GetTiming();
    v8_stats->setTimestamp(time_converter.MonotonicTimeToPseudoWallTime(ConvertToBaseTimeTicks(stat.timestamp())).InMillisecondsF());
    v8_stats->setType(String::FromUTF8(stat.type()));
    return v8_stats;
}

class RTCStatsReportIterationSource final : public PairSyncIterable<RTCStatsReport>::IterationSource {
public:
    explicit RTCStatsReportIterationSource(std::unique_ptr<RTCStatsReportPlatform> report)
        : report_(std::move(report))
    {
    }

    bool FetchNextItem(ScriptState* script_state, String& key, ScriptValue& value, ExceptionState& exception_state) override
    {
        return FetchNextItemIdl(script_state, key, value, exception_state);
    }

    bool FetchNextItemIdl(ScriptState* script_state, String& key, ScriptValue& value, ExceptionState& exception_state)
    {
...
PairSyncIterable<RTCStatsReport>::IterationSource* RTCStatsReport::CreateIterationSource(ScriptState*, ExceptionState&)
{
    return MakeGarbageCollected<RTCStatsReportIterationSource>(report_->CopyHandle());
}

bool RTCStatsReport::GetMapEntryIdl(ScriptState* script_state, const String& key, ScriptValue& value, ExceptionState&)
{
    ...
    RTCStats* v8_stats = RTCStatsToIDL(script_state, *stats, ExposeHardwareCapabilityStats(script_state));
    if (!v8_stats) {
        return false;
    }
...
bool RTCStatsReport::GetMapEntry(ScriptState* script_state, const String& key, ScriptValue& value, ExceptionState& exception_state)
{
