...
class MODULES_EXPORT RtcEncodedAudioSenderSinkOptimizer : public WritableStreamTransferringOptimizer {
public:
    using UnderlyingSinkSetter = WTF::CrossThreadOnceFunction<void(RTCEncodedAudioUnderlyingSink*)>;
    RtcEncodedAudioSenderSinkOptimizer(UnderlyingSinkSetter, scoped_refptr<blink::RTCEncodedAudioStreamTransformer::Broker> transformer);
