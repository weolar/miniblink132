...
class MODULES_EXPORT RTCEncodedUnderlyingSinkWrapper : public UnderlyingSinkBase {
public:
    explicit RTCEncodedUnderlyingSinkWrapper(ScriptState* script_state);

    void CreateAudioUnderlyingSink(scoped_refptr<RTCEncodedAudioStreamTransformer::Broker> encoded_audio_transformer, base::UnguessableToken owner_id);
    void CreateVideoUnderlyingSink(scoped_refptr<RTCEncodedVideoStreamTransformer::Broker> encoded_video_transformer, base::UnguessableToken owner_id);
