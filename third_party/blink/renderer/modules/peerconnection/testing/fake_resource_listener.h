...
public:
    ...
    void OnResourceUsageStateMeasured(rtc::scoped_refptr<webrtc::Resource> resource, webrtc::ResourceUsageState usage_state) override;

private:
    size_t measurement_count_ = 0u;
    webrtc::ResourceUsageState latest_measurement_ = webrtc::ResourceUsageState::kUnderuse;
};
