...
// the updated States.
class MODULES_EXPORT WebRtcSetDescriptionObserver : public WTF::ThreadSafeRefCounted<WebRtcSetDescriptionObserver> {
public:
    ...
    struct MODULES_EXPORT States {
        ...
        std::vector<blink::RtpTransceiverState> transceiver_states ALLOW_DISCOURAGED_TYPE("Avoids conversions when passed from/to webrtc API");
    ...
    WebRtcSetDescriptionObserver& operator=(const WebRtcSetDescriptionObserver&) = delete;
    ...
    // thread.
    virtual void OnSetDescriptionComplete(webrtc::RTCError error, States states) = 0;
...
class MODULES_EXPORT WebRtcSetDescriptionObserverHandlerImpl : public WTF::ThreadSafeRefCounted<WebRtcSetDescriptionObserverHandlerImpl> {
public:
    WebRtcSetDescriptionObserverHandlerImpl(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner,
    ...
    WebRtcSetDescriptionObserverHandlerImpl(const WebRtcSetDescriptionObserverHandlerImpl&) = delete;
    WebRtcSetDescriptionObserverHandlerImpl& operator=(const WebRtcSetDescriptionObserverHandlerImpl&) = delete;
...
private:
    friend class WTF::ThreadSafeRefCounted<WebRtcSetDescriptionObserverHandlerImpl>;
    virtual ~WebRtcSetDescriptionObserverHandlerImpl();

    void OnSetDescriptionCompleteOnMainThread(webrtc::RTCError error, webrtc::PeerConnectionInterface::SignalingState signaling_state,
        blink::TransceiverStateSurfacer transceiver_state_surfacer, std::unique_ptr<webrtc::SessionDescriptionInterface> pending_local_description,
        std::unique_ptr<webrtc::SessionDescriptionInterface> current_local_description,
        std::unique_ptr<webrtc::SessionDescriptionInterface> pending_remote_description,
        std::unique_ptr<webrtc::SessionDescriptionInterface> current_remote_description);
...
class MODULES_EXPORT WebRtcSetLocalDescriptionObserverHandler : public webrtc::SetLocalDescriptionObserverInterface {
public:
    static scoped_refptr<WebRtcSetLocalDescriptionObserverHandler> Create(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner,
        scoped_refptr<base::SingleThreadTaskRunner> signaling_task_runner, rtc::scoped_refptr<webrtc::PeerConnectionInterface> pc,
        scoped_refptr<blink::WebRtcMediaStreamTrackAdapterMap> track_adapter_map, scoped_refptr<WebRtcSetDescriptionObserver> observer);

    WebRtcSetLocalDescriptionObserverHandler(const WebRtcSetLocalDescriptionObserverHandler&) = delete;
    WebRtcSetLocalDescriptionObserverHandler& operator=(const WebRtcSetLocalDescriptionObserverHandler&) = delete;
...
protected:
    WebRtcSetLocalDescriptionObserverHandler(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner,
        scoped_refptr<base::SingleThreadTaskRunner> signaling_task_runner, rtc::scoped_refptr<webrtc::PeerConnectionInterface> pc,
        scoped_refptr<blink::WebRtcMediaStreamTrackAdapterMap> track_adapter_map, scoped_refptr<WebRtcSetDescriptionObserver> observer);
...
// performing the operations of WebRtcSetDescriptionObserverHandlerImpl.
class MODULES_EXPORT WebRtcSetRemoteDescriptionObserverHandler : public webrtc::SetRemoteDescriptionObserverInterface {
public:
    static scoped_refptr<WebRtcSetRemoteDescriptionObserverHandler> Create(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner,
        scoped_refptr<base::SingleThreadTaskRunner> signaling_task_runner, rtc::scoped_refptr<webrtc::PeerConnectionInterface> pc,
        scoped_refptr<blink::WebRtcMediaStreamTrackAdapterMap> track_adapter_map, scoped_refptr<WebRtcSetDescriptionObserver> observer);

    WebRtcSetRemoteDescriptionObserverHandler(const WebRtcSetRemoteDescriptionObserverHandler&) = delete;
    WebRtcSetRemoteDescriptionObserverHandler& operator=(const WebRtcSetRemoteDescriptionObserverHandler&) = delete;
...
protected:
    WebRtcSetRemoteDescriptionObserverHandler(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner,
        scoped_refptr<base::SingleThreadTaskRunner> signaling_task_runner, rtc::scoped_refptr<webrtc::PeerConnectionInterface> pc,
        scoped_refptr<blink::WebRtcMediaStreamTrackAdapterMap> track_adapter_map, scoped_refptr<WebRtcSetDescriptionObserver> observer);
