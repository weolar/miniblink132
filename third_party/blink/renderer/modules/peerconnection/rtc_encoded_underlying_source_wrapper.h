...
class MODULES_EXPORT RTCEncodedUnderlyingSourceWrapper : public UnderlyingSourceBase {
public:
    explicit RTCEncodedUnderlyingSourceWrapper(ScriptState*, WTF::CrossThreadOnceClosure disconnect_callback = WTF::CrossThreadOnceClosure());
    ...
    void CreateAudioUnderlyingSource(WTF::CrossThreadOnceClosure disconnect_callback_source, base::UnguessableToken owner_id);
    void CreateVideoUnderlyingSource(WTF::CrossThreadOnceClosure disconnect_callback_source, base::UnguessableToken owner_id);

    using VideoTransformer = WTF::CrossThreadRepeatingFunction<void(std::unique_ptr<webrtc::TransformableVideoFrameInterface>)>;
    using AudioTransformer = WTF::CrossThreadRepeatingFunction<void(std::unique_ptr<webrtc::TransformableAudioFrameInterface>)>;
