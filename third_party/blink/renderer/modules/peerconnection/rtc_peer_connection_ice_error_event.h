...
public:
    ...
    RTCPeerConnectionIceErrorEvent(const AtomicString& type, const RTCPeerConnectionIceErrorEventInit*);
    ...
    static RTCPeerConnectionIceErrorEvent* Create(const AtomicString& type, const RTCPeerConnectionIceErrorEventInit*);
