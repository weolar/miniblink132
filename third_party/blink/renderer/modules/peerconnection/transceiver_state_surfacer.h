...
public:
    TransceiverStateSurfacer(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner, scoped_refptr<base::SingleThreadTaskRunner> signaling_task_runner);
    ...
    void Initialize(rtc::scoped_refptr<webrtc::PeerConnectionInterface> native_peer_connection,
...
private:
    ...
    std::vector<blink::RtpTransceiverState> transceiver_states_ ALLOW_DISCOURAGED_TYPE("Avoids conversions when passed from/to webrtc API");
};
