...
class MODULES_EXPORT RtcEncodedAudioReceiverSinkOptimizer : public WritableStreamTransferringOptimizer {
public:
    using UnderlyingSinkSetter = WTF::CrossThreadOnceFunction<void(RTCEncodedAudioUnderlyingSink*)>;
    RtcEncodedAudioReceiverSinkOptimizer(UnderlyingSinkSetter, scoped_refptr<blink::RTCEncodedAudioStreamTransformer::Broker> transformer);
