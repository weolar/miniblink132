...
// track.
class MODULES_EXPORT MediaStreamRemoteVideoSource : public MediaStreamVideoSource {
public:
    explicit MediaStreamRemoteVideoSource(scoped_refptr<base::SingleThreadTaskRunner> task_runner, std::unique_ptr<TrackObserver> observer);

    MediaStreamRemoteVideoSource(const MediaStreamRemoteVideoSource&) = delete;
    MediaStreamRemoteVideoSource& operator=(const MediaStreamRemoteVideoSource&) = delete;
...
protected:
    ...
    rtc::VideoSinkInterface<webrtc::RecordableEncodedFrame>* EncodedSinkInterfaceForTesting();
