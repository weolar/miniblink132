...
class MODULES_EXPORT RtcEncodedVideoSenderSourceOptimizer : public ReadableStreamTransferringOptimizer {
public:
    ...
    RtcEncodedVideoSenderSourceOptimizer(UnderlyingSourceSetter, WTF::CrossThreadOnceClosure disconnect_callback);
