...
class RTCStatsReport final : public ScriptWrappable, public Maplike<RTCStatsReport> {
...
public:
    ...
    PairSyncIterable<RTCStatsReport>::IterationSource* CreateIterationSource(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, ScriptValue&, ExceptionState&) override;

private:
    bool GetMapEntryIdl(ScriptState*, const String& key, ScriptValue&, ExceptionState&);
