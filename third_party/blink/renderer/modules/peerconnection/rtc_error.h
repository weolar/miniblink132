...
public:
    ...
    std::optional<int32_t> sdpLineNumber() const
    {
    ...
    std::optional<int32_t> sctpCauseCode() const
    {
        return sctp_cause_code_;
    }
    std::optional<uint32_t> receivedAlert() const
    {
        return received_alert_;
    }
    std::optional<uint32_t> sentAlert() const
    {
        return sent_alert_;
    }
