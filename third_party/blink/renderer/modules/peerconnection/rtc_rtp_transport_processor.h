...
class MODULES_EXPORT RTCRtpTransportProcessor : public ScriptWrappable, public ExecutionContextClient {
...
public:
    ...
    webrtc::NetworkControlUpdate OnFeedback(webrtc::TransportPacketsFeedback feedback);
    void OnSentPacket(webrtc::SentPacket sp);

    void SetFeedbackProviders(Vector<scoped_refptr<FeedbackProvider>> feedback_providers);
