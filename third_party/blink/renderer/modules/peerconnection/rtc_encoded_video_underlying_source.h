...
class MODULES_EXPORT RTCEncodedVideoUnderlyingSource : public UnderlyingSourceBase {
public:
    ...
    explicit RTCEncodedVideoUnderlyingSource(ScriptState*, WTF::CrossThreadOnceClosure disconnect_callback);
    explicit RTCEncodedVideoUnderlyingSource(ScriptState*, WTF::CrossThreadOnceClosure disconnect_callback, bool enable_frame_restrictions,
    ...
    void OnFrameFromSource(std::unique_ptr<webrtc::TransformableVideoFrameInterface>);
    void Close();
