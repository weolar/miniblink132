...
public:
    static RTCErrorEvent* Create(const AtomicString& type, const RTCErrorEventInit* event_init_dict);

    RTCErrorEvent(const AtomicString& type, const RTCErrorEventInit* event_init_dict);
