...
UnderlyingSourceBase* RtcEncodedVideoReceiverSourceOptimizer::PerformInProcessOptimization(ScriptState* script_state)
{
    ...
    auto* new_source = MakeGarbageCollected<RTCEncodedVideoUnderlyingSource>(script_state, std::move(disconnect_callback_));
