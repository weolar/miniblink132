...
public:
    RTCRtpAcks(HeapVector<Member<RTCRtpAck>> acks, uint64_t remote_send_timestamp, double received_time,
    ...
    uint64_t remoteSendTimestamp()
    {
        return remote_send_timestamp_;
    }

    DOMHighResTimeStamp receivedTime()
    {
