...
class MODULES_EXPORT RtcEncodedVideoReceiverSinkOptimizer : public WritableStreamTransferringOptimizer {
public:
    using UnderlyingSinkSetter = WTF::CrossThreadOnceFunction<void(RTCEncodedVideoUnderlyingSink*)>;
    RtcEncodedVideoReceiverSinkOptimizer(UnderlyingSinkSetter, scoped_refptr<blink::RTCEncodedVideoStreamTransformer::Broker> transformer);
