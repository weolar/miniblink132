...
class MODULES_EXPORT RtcEncodedVideoReceiverSourceOptimizer : public ReadableStreamTransferringOptimizer {
public:
    using UnderlyingSourceSetter = WTF::CrossThreadFunction<void(RTCEncodedVideoUnderlyingSource*, scoped_refptr<base::SingleThreadTaskRunner>)>;
    RtcEncodedVideoReceiverSourceOptimizer(UnderlyingSourceSetter, WTF::CrossThreadOnceClosure disconnect_callback);
