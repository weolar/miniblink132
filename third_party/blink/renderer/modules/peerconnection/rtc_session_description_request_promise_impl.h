...
public:
    static RTCSessionDescriptionRequestPromiseImpl* Create(RTCPeerConnection*, ScriptPromiseResolver<RTCSessionDescriptionInit>*);

    RTCSessionDescriptionRequestPromiseImpl(RTCPeerConnection*, ScriptPromiseResolver<RTCSessionDescriptionInit>*);
