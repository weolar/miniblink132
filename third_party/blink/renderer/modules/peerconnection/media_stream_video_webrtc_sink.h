...
public:
    ...
    MediaStreamVideoWebRtcSink& operator=(const MediaStreamVideoWebRtcSink&) = delete;
...
protected:
    ...
    void OnVideoConstraintsChanged(std::optional<double> min_fps, std::optional<double> max_fps) override;

private:
    FRIEND_TEST_ALL_PREFIXES(MediaStreamVideoWebRtcSinkTest, ForwardsConstraintsChangeToWebRtcVideoTrackSourceProxy);
