...
class MODULES_EXPORT RtcEncodedAudioSenderSourceOptimizer : public ReadableStreamTransferringOptimizer {
public:
    ...
    RtcEncodedAudioSenderSourceOptimizer(UnderlyingSourceSetter, WTF::CrossThreadOnceClosure disconnect_callback);
