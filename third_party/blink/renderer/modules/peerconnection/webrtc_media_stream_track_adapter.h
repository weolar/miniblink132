...
class MODULES_EXPORT WebRtcMediaStreamTrackAdapter : public WTF::ThreadSafeRefCounted<WebRtcMediaStreamTrackAdapter, WebRtcMediaStreamTrackAdapterTraits> {
public:
    ...
    static scoped_refptr<WebRtcMediaStreamTrackAdapter> CreateLocalTrackAdapter(
        PeerConnectionDependencyFactory* factory, const scoped_refptr<base::SingleThreadTaskRunner>& main_thread, MediaStreamComponent* component);
    ...
    static scoped_refptr<WebRtcMediaStreamTrackAdapter> CreateRemoteTrackAdapter(blink::PeerConnectionDependencyFactory* factory,
    ...
    WebRtcMediaStreamTrackAdapter& operator=(const WebRtcMediaStreamTrackAdapter&) = delete;
...
protected:
    friend class WTF::ThreadSafeRefCounted<WebRtcMediaStreamTrackAdapter, WebRtcMediaStreamTrackAdapterTraits>;
    friend struct WebRtcMediaStreamTrackAdapterTraits;

    WebRtcMediaStreamTrackAdapter(blink::PeerConnectionDependencyFactory* factory, const scoped_refptr<base::SingleThreadTaskRunner>& main_thread);
...
private:
    ...
    void InitializeRemoteAudioTrack(const scoped_refptr<webrtc::AudioTrackInterface>& webrtc_audio_track, ExecutionContext* execution_context);
    void InitializeRemoteVideoTrack(const scoped_refptr<webrtc::VideoTrackInterface>& webrtc_video_track, ExecutionContext* execution_context);
