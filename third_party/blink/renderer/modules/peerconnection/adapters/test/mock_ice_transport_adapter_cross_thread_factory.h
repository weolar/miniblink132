...
class MockIceTransportAdapterCrossThreadFactory : public IceTransportAdapterCrossThreadFactory {
public:
    MockIceTransportAdapterCrossThreadFactory(std::unique_ptr<MockIceTransportAdapter> mock_adapter, IceTransportAdapter::Delegate** delegate_out)
        : mock_adapter_(std::move(mock_adapter))
