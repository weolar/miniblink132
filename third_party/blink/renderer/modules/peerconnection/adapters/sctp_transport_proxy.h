...
public:
    ...
    static std::unique_ptr<SctpTransportProxy> Create(LocalFrame& frame, scoped_refptr<base::SingleThreadTaskRunner> proxy_thread,
...
private:
    SctpTransportProxy(LocalFrame& frame, scoped_refptr<base::SingleThreadTaskRunner> proxy_thread, scoped_refptr<base::SingleThreadTaskRunner> host_thread,
        rtc::scoped_refptr<webrtc::SctpTransportInterface> sctp_transport, Delegate* delegate);
