...
public:
    ...
    public:
        ...
        virtual void OnSelectedCandidatePairChanged(const std::pair<cricket::Candidate, cricket::Candidate>& selected_candidate_pair)
        {
        }
    };
    ...
    virtual void StartGathering(const cricket::IceParameters& local_parameters, const cricket::ServerAddresses& stun_servers,
    ...
    virtual void Start(const cricket::IceParameters& remote_parameters, cricket::IceRole role, const Vector<cricket::Candidate>& initial_remote_candidates) = 0;

    // Handle a remote ICE restart. This changes the remote parameters and clears
    // all remote candidates.
    virtual void HandleRemoteRestart(const cricket::IceParameters& new_remote_parameters) = 0;
