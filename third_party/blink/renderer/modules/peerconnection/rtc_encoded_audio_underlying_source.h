...
class MODULES_EXPORT RTCEncodedAudioUnderlyingSource : public UnderlyingSourceBase {
public:
    ...
    explicit RTCEncodedAudioUnderlyingSource(ScriptState*, WTF::CrossThreadOnceClosure disconnect_callback);
    explicit RTCEncodedAudioUnderlyingSource(ScriptState*, WTF::CrossThreadOnceClosure disconnect_callback, bool enable_frame_restrictions,
        base::UnguessableToken owner_id, ReadableStreamDefaultControllerWithScriptScope* controller_override = nullptr);
    ...
    void OnFrameFromSource(std::unique_ptr<webrtc::TransformableAudioFrameInterface>);
    void Close();
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(RTCEncodedAudioUnderlyingSourceTest, QueuedFramesAreDroppedWhenOverflow);
