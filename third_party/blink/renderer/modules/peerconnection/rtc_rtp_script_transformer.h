...
public:
    ...
    explicit RTCRtpScriptTransformer(ScriptState* script_state, CustomEventMessage options, scoped_refptr<base::SequencedTaskRunner> transform_task_runner,
...
private:
    ...
    const scoped_refptr<base::SingleThreadTaskRunner> rtp_transformer_task_runner_;
    ...
    const Member<RTCEncodedUnderlyingSourceWrapper> rtc_encoded_underlying_source_;
