...
// static
ScriptPromise<IDLUndefined> InternalsFuzzing::runFuzzer(ScriptState* script_state, Internals&, const String& fuzzer_id, V8BufferSource* fuzzer_data)
{
    ...
    RendererFuzzingSupport::Run(&context->GetBrowserInterfaceBroker(), Platform::Current()->GetBrowserInterfaceBroker(), associated_provider, fuzzer_id.Utf8(),
        std::move(data), WTF::BindOnce(&ResolvePromise, WrapPersistent(resolver)));
