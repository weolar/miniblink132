...
public:
    ...
    static v8::Local<v8::Value> Create(v8::Isolate*, std::optional<uint32_t> stream_error_code, String message, V8WebTransportErrorSource::Enum);
    ...
    // methods.
    WebTransportError(PassKey, std::optional<uint32_t> stream_error_code, String message, V8WebTransportErrorSource::Enum);
    ~WebTransportError() override;

    std::optional<uint32_t> streamErrorCode() const
    {
