...
public:
    ...
    // constructed from C++.
    explicit BidirectionalStream(ScriptState*, WebTransport*, uint32_t stream_id, mojo::ScopedDataPipeProducerHandle, mojo::ScopedDataPipeConsumerHandle);
