...
public:
    ...
    ScriptPromise<IDLRecord<IDLString, V8SubAppsResultCode>> add(
        ScriptState*, const HeapVector<std::pair<String, Member<SubAppsAddParams>>>& sub_apps_to_add, ExceptionState&);
    ScriptPromise<IDLRecord<IDLString, SubAppsListResult>> list(ScriptState*, ExceptionState&);
    ScriptPromise<IDLRecord<IDLString, V8SubAppsResultCode>> remove(ScriptState*, const Vector<String>& manifest_id_paths, ExceptionState&);
