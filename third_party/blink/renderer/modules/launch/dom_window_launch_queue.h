...
class DOMWindowLaunchQueue final : public GarbageCollected<DOMWindowLaunchQueue>, public Supplement<LocalDOMWindow> {
public:
    ...
    static void UpdateLaunchFiles(LocalDOMWindow*, HeapVector<Member<FileSystemHandle>>);
