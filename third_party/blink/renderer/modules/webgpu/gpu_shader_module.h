...
public:
    static GPUShaderModule* Create(GPUDevice* device, const GPUShaderModuleDescriptor* webgpu_desc);
    explicit GPUShaderModule(GPUDevice* device, wgpu::ShaderModule shader_module, const String& label);
    ...
    ScriptPromise<GPUCompilationInfo> getCompilationInfo(ScriptState* script_state);
