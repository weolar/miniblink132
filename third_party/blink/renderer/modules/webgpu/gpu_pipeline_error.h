...
public:
    ...
    static GPUPipelineError* Create(String message, const GPUPipelineErrorInit* options);

    // For creating a GPUPipelineError from C++. Typically this will be
    // immediately passed to ScriptPromiseResolverBase::Reject.
    static v8::Local<v8::Value> Create(v8::Isolate*, const String& message, V8GPUPipelineErrorReason::Enum reason);
    ...
    // methods.
    GPUPipelineError(const String& message, V8GPUPipelineErrorReason::Enum reason);
