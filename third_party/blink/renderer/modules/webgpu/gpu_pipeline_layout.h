...
public:
    static GPUPipelineLayout* Create(GPUDevice* device, const GPUPipelineLayoutDescriptor* webgpu_desc);
    explicit GPUPipelineLayout(GPUDevice* device, wgpu::PipelineLayout pipeline_layout, const String& label);
