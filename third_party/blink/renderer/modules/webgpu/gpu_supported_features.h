...
class GPUSupportedFeatures : public ScriptWrappable, public ValueSyncIterable<GPUSupportedFeatures> {
...
private:
    ...
    class IterationSource final : public ValueSyncIterable<GPUSupportedFeatures>::IterationSource {
    public:
    ...
    GPUSupportedFeatures::IterationSource* CreateIterationSource(ScriptState* script_state, ExceptionState& exception_state) override
    {
        return MakeGarbageCollected<GPUSupportedFeatures::IterationSource>(features_);
    }
};
