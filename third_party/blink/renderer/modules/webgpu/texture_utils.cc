...
TexelBlockInfo GetTexelBlockInfoForCopy(wgpu::TextureFormat format, wgpu::TextureAspect aspect)
{
...
size_t EstimateWriteTextureBytesUpperBound(wgpu::TextureDataLayout layout, wgpu::Extent3D extent, wgpu::TextureFormat format, wgpu::TextureAspect aspect)
{
