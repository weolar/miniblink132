...
public:
    static GPUQuerySet* Create(GPUDevice* device, const GPUQuerySetDescriptor* webgpu_desc);
    explicit GPUQuerySet(GPUDevice* device, wgpu::QuerySet querySet, const String& label);
