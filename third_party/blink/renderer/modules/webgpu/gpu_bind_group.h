...
public:
    static GPUBindGroup* Create(GPUDevice* device, const GPUBindGroupDescriptor* webgpu_desc, ExceptionState& exception_state);
    explicit GPUBindGroup(GPUDevice* device, wgpu::BindGroup bind_group, const String& label);
