...
public:
    ...
    static constexpr uint32_t kTextureBinding = V8GPUTextureUsage::Constant::kTextureBinding;
    static constexpr uint32_t kStorageBinding = V8GPUTextureUsage::Constant::kStorageBinding;
    static constexpr uint32_t kRenderAttachment = V8GPUTextureUsage::Constant::kRenderAttachment;
