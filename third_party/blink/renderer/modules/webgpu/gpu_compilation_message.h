...
public:
    explicit GPUCompilationMessage(String message, wgpu::CompilationMessageType type = wgpu::CompilationMessageType::Error, uint64_t line_num = 0,
        uint64_t line_pos = 0, uint64_t offset = 0, uint64_t length = 0);
