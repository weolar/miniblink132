...
public:
    static GPUSampler* Create(GPUDevice* device, const GPUSamplerDescriptor* webgpu_desc);
    explicit GPUSampler(GPUDevice* device, wgpu::Sampler sampler, const String& label);
