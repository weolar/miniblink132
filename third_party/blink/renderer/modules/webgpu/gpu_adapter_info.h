...
public:
    GPUAdapterInfo(const String& vendor, const String& architecture, const String& device = String(), const String& description = String(),
        const String& driver = String(), const String& backend = String(), const String& type = String(),
        const std::optional<uint32_t> d3d_shader_model = std::nullopt, const std::optional<uint32_t> vk_driver_version = std::nullopt);
