...
bool ConvertToDawn(const V8GPUColor* in, wgpu::Color* out, ExceptionState& exception_state)
{
    ...
    case V8GPUColor::ContentType::kDoubleSequence: {
        ...
        if (sequence.size() != 4) {
            exception_state.ThrowTypeError("A sequence of number used as a GPUColor must have exactly 4 "
                                           "elements.");
            return false;
        }
...
bool ConvertToDawn(const V8GPUExtent3D* in, wgpu::Extent3D* out, GPUDevice* device, ExceptionState& exception_state)
{
    switch (in->GetContentType()) {
    ...
    case V8GPUExtent3D::ContentType::kUnsignedLongEnforceRangeSequence: {
        const Vector<uint32_t>& sequence = in->GetAsUnsignedLongEnforceRangeSequence();
        ...
        case 3:
            *out = { sequence[0], sequence[1], sequence[2] };
            return true;
        default:
            exception_state.ThrowTypeError("A sequence of number used as a GPUExtent3D must have between 1 "
                                           "and 3 elements.");
            return false;
        }
    }
...
bool ConvertToDawn(const V8GPUOrigin3D* in, wgpu::Origin3D* out, ExceptionState& exception_state)
{
    switch (in->GetContentType()) {
    ...
    case V8GPUOrigin3D::ContentType::kUnsignedLongEnforceRangeSequence: {
        ...
        case 3:
            *out = { sequence[0], sequence[1], sequence[2] };
            return true;
        default:
            exception_state.ThrowTypeError("A sequence of number used as a GPUOrigin3D must have at most 3 "
                                           "elements.");
            return false;
        }
    }
...
bool ConvertToDawn(const V8GPUOrigin2D* in, wgpu::Origin2D* out, ExceptionState& exception_state)
{
    switch (in->GetContentType()) {
    ...
    case V8GPUOrigin2D::ContentType::kUnsignedLongEnforceRangeSequence: {
        ...
        case 2:
            *out = { sequence[0], sequence[1] };
            return true;
        default:
            exception_state.ThrowTypeError("A sequence of number used as a GPUOrigin2D must have at most 2 "
                                           "elements.");
            return false;
        }
    }
...
bool ConvertToDawn(const GPUImageCopyTexture* in, wgpu::ImageCopyTexture* out, ExceptionState& exception_state)
{
    DCHECK(in);
    DCHECK(in->texture());
...
const char* ValidateTextureDataLayout(const GPUImageDataLayout* webgpu_layout, wgpu::TextureDataLayout* dawn_layout)
{
...
wgpu::PipelineLayout AsDawnType(V8UnionGPUAutoLayoutModeOrGPUPipelineLayout* webgpu_layout)
{
    ...
    case V8UnionGPUAutoLayoutModeOrGPUPipelineLayout::ContentType::kGPUPipelineLayout:
        return AsDawnType(webgpu_layout->GetAsGPUPipelineLayout());
    case V8UnionGPUAutoLayoutModeOrGPUPipelineLayout::ContentType::kGPUAutoLayoutMode:
        return nullptr;
    }
