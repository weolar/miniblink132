...
template <typename DawnFlags> DawnFlags AsDawnFlags(uint32_t webgpu_enum)
{
...
[[nodiscard]] bool FromDawnEnum(wgpu::WGSLFeatureName dawn_enum, V8WGSLFeatureName* result);
