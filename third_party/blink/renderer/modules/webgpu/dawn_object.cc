...
DawnObjectBase::DawnObjectBase(scoped_refptr<DawnControlClientHolder> dawn_control_client, const String& label)
    : dawn_control_client_(std::move(dawn_control_client))
    , label_(label)
{
}

const scoped_refptr<DawnControlClientHolder>& DawnObjectBase::GetDawnControlClient() const
{
...
DawnObjectImpl::DawnObjectImpl(GPUDevice* device, const String& label)
    : DawnObjectBase(device->GetDawnControlClient(), label)
    , device_(device)
{
}
