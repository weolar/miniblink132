...
class NetworkInformation final : public EventTarget,
...
public:
    ...
    void ConnectionChange(WebConnectionType, double downlink_max_mbps, WebEffectiveConnectionType effective_type,
