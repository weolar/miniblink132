...
class FileSystemObservation final : public GarbageCollected<FileSystemObservation>, public mojom::blink::FileSystemAccessObserver {
public:
    ...
    void OnFileChanges(WTF::Vector<mojom::blink::FileSystemAccessChangePtr> mojo_changes) override;
...
private:
    ...
    HeapMojoReceiver<mojom::blink::FileSystemAccessObserver, FileSystemObservation> receiver_ { this, nullptr };
};
