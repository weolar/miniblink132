...
FileSystemUnderlyingSink::FileSystemUnderlyingSink(ExecutionContext* context, mojo::PendingRemote<mojom::blink::FileSystemAccessFileWriter> writer_remote)
    : writer_remote_(context)
{
    writer_remote_.Bind(std::move(writer_remote), context->GetTaskRunner(TaskType::kStorage));
    DCHECK(writer_remote_.is_bound());
}

ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::start(
    ScriptState* script_state, WritableStreamDefaultController* controller, ExceptionState& exception_state)
{
    return ToResolvedUndefinedPromise(script_state);
}

ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::write(
    ScriptState* script_state, ScriptValue chunk, WritableStreamDefaultController* controller, ExceptionState& exception_state)
{
    auto* input = NativeValueTraits<V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams>::NativeValue(
        script_state->GetIsolate(), chunk.V8Value(), exception_state);
    if (exception_state.HadException())
        return EmptyPromise();

    if (input->IsWriteParams()) {
        return HandleParams(script_state, *input->GetAsWriteParams(), exception_state);
    }

    auto* write_data = input->GetAsV8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString();
    return WriteData(script_state, offset_, write_data, exception_state);
}

ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::close(ScriptState* script_state, ExceptionState& exception_state)
{
    ...
    pending_operation_ = MakeGarbageCollected<ScriptPromiseResolver<IDLUndefined>>(script_state, exception_state.GetContext());
    auto result = pending_operation_->Promise();
    writer_remote_->Close(WTF::BindOnce(&FileSystemUnderlyingSink::CloseComplete, WrapPersistent(this)));

    return result;
}

ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::abort(ScriptState* script_state, ScriptValue reason, ExceptionState& exception_state)
{
...
ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::HandleParams(ScriptState* script_state, const WriteParams& params, ExceptionState& exception_state)
{
    if (params.type() == V8WriteCommandType::Enum::kTruncate) {
        if (!params.hasSizeNonNull()) {
            ThrowDOMExceptionAndInvalidateSink(exception_state, DOMExceptionCode::kSyntaxError, "Invalid params passed. truncate requires a size argument");
            return EmptyPromise();
        }
    ...
    if (params.type() == V8WriteCommandType::Enum::kSeek) {
        if (!params.hasPositionNonNull()) {
            ThrowDOMExceptionAndInvalidateSink(exception_state, DOMExceptionCode::kSyntaxError, "Invalid params passed. seek requires a position argument");
            return EmptyPromise();
        }
    ...
    if (params.type() == V8WriteCommandType::Enum::kWrite) {
        uint64_t position = params.hasPositionNonNull() ? params.positionNonNull() : offset_;
        if (!params.hasData()) {
            ThrowDOMExceptionAndInvalidateSink(exception_state, DOMExceptionCode::kSyntaxError, "Invalid params passed. write requires a data argument");
            return EmptyPromise();
        }
        if (!params.data()) {
            ThrowTypeErrorAndInvalidateSink(exception_state, "Invalid params passed. write requires a non-null data");
            return EmptyPromise();
        }
...
class WriterHelper {
public:
    explicit WriterHelper(base::OnceCallback<void(mojom::blink::FileSystemAccessErrorPtr result, uint64_t bytes_written)> callback)
    ...
    // implementation.
    void WriteComplete(mojom::blink::FileSystemAccessErrorPtr result, uint64_t bytes_written)
    {
...
private:
    void MaybeCallCallbackAndDeleteThis()
    {
        ...
        if (!producer_result_.is_null() && producer_result_->status != mojom::blink::FileSystemAccessStatus::kOk) {
        ...
        if (!write_result_.is_null() && write_result_->status != mojom::blink::FileSystemAccessStatus::kOk) {
    ...
    base::OnceCallback<void(mojom::blink::FileSystemAccessErrorPtr result, uint64_t bytes_written)> callback_;
...
public:
    StreamWriterHelper(std::unique_ptr<mojo::DataPipeProducer> producer,
        base::OnceCallback<void(mojom::blink::FileSystemAccessErrorPtr result, uint64_t bytes_written)> callback)
    ...
    void DataProducerComplete(MojoResult result)
    {
        ...
        if (result == MOJO_RESULT_OK) {
            ProducerComplete(mojom::blink::FileSystemAccessError::New(mojom::blink::FileSystemAccessStatus::kOk, base::File::FILE_OK, ""));
        } else {
            ProducerComplete(mojom::blink::FileSystemAccessError::New(
                mojom::blink::FileSystemAccessStatus::kOperationAborted, base::File::FILE_OK, "Failed to write data to data pipe"));
        }
    }
...
// WriterHelper implementation that is used when data is being produced by a
// Blob.
class BlobWriterHelper final : public mojom::blink::BlobReaderClient, public WriterHelper {
public:
    BlobWriterHelper(mojo::PendingReceiver<mojom::blink::BlobReaderClient> receiver,
        base::OnceCallback<void(mojom::blink::FileSystemAccessErrorPtr result, uint64_t bytes_written)> callback)
        : WriterHelper(std::move(callback))
        , receiver_(this, std::move(receiver))
    {
        receiver_.set_disconnect_handler(WTF::BindOnce(&BlobWriterHelper::OnDisconnect, WTF::Unretained(this)));
    }
    ...
    void OnComplete(int32_t status, uint64_t data_length) override
    {
        ...
        if (status == net::OK) {
            ...
            ProducerComplete(mojom::blink::FileSystemAccessError::New(mojom::blink::FileSystemAccessStatus::kFileError, base::File::FILE_ERROR_NOT_FOUND, ""));
        } else {
            ProducerComplete(mojom::blink::FileSystemAccessError::New(mojom::blink::FileSystemAccessStatus::kFileError, base::File::FILE_ERROR_IO, ""));
        }
    }
...
private:
    void OnDisconnect()
    {
        if (!complete_called_) {
            ...
            ProducerComplete(mojom::blink::FileSystemAccessError::New(
                mojom::blink::FileSystemAccessStatus::kOperationAborted, base::File::FILE_OK, "Blob disconnected while reading"));
        }
    }
...
bool CreateDataPipe(
    uint64_t data_size, ExceptionState& exception_state, mojo::ScopedDataPipeProducerHandle& producer, mojo::ScopedDataPipeConsumerHandle& consumer)
{
...
void FileSystemUnderlyingSink::ThrowDOMExceptionAndInvalidateSink(ExceptionState& exception_state, DOMExceptionCode error, const char* message)
{
    exception_state.ThrowDOMException(error, message);
    writer_remote_.reset();
}

void FileSystemUnderlyingSink::ThrowTypeErrorAndInvalidateSink(ExceptionState& exception_state, const char* message)
{
...
ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::WriteData(
    ScriptState* script_state, uint64_t position, const V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString* data, ExceptionState& exception_state)
{
    DCHECK(data);
    ...
    case V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::ContentType::kArrayBuffer: {
        ...
        data_source = std::make_unique<mojo::StringDataSource>(
            base::as_chars(array_buffer->ByteSpan()), mojo::StringDataSource::AsyncWritingMode::STRING_MAY_BE_INVALIDATED_BEFORE_COMPLETION);
        break;
    }
    case V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::ContentType::kArrayBufferView: {
        ...
        data_source = std::make_unique<mojo::StringDataSource>(
            base::as_chars(array_buffer_view->ByteSpan()), mojo::StringDataSource::AsyncWritingMode::STRING_MAY_BE_INVALIDATED_BEFORE_COMPLETION);
        break;
    }
    ...
    case V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::ContentType::kUSVString:
        data_source = std::make_unique<mojo::StringDataSource>(
            StringUTF8Adaptor(data->GetAsUSVString()).AsStringView(), mojo::StringDataSource::AsyncWritingMode::STRING_MAY_BE_INVALIDATED_BEFORE_COMPLETION);
        break;
    }

    DCHECK(data_source || data->IsBlob());
    uint64_t data_size = data_source ? data_source->GetLength() : data->GetAsBlob()->size();

    mojo::ScopedDataPipeProducerHandle producer_handle;
    mojo::ScopedDataPipeConsumerHandle consumer_handle;
    if (!CreateDataPipe(data_size, exception_state, producer_handle, consumer_handle)) {
        ThrowDOMExceptionAndInvalidateSink(exception_state, DOMExceptionCode::kInvalidStateError, "Failed to create datapipe");
        return EmptyPromise();
    }
    ...
    if (data->IsBlob()) {
        ...
        helper = new BlobWriterHelper(
            reader_client.InitWithNewPipeAndPassReceiver(), WTF::BindOnce(&FileSystemUnderlyingSink::WriteComplete, WrapPersistent(this)));
        data->GetAsBlob()->GetBlobDataHandle()->ReadAll(std::move(producer_handle), std::move(reader_client));
    } else {
        auto producer = std::make_unique<mojo::DataPipeProducer>(std::move(producer_handle));
        auto* producer_ptr = producer.get();
        helper = new StreamWriterHelper(std::move(producer), WTF::BindOnce(&FileSystemUnderlyingSink::WriteComplete, WrapPersistent(this)));
        // Unretained is safe because the producer is owned by `helper`.
        producer_ptr->Write(
            std::move(data_source), WTF::BindOnce(&StreamWriterHelper::DataProducerComplete, WTF::Unretained(static_cast<StreamWriterHelper*>(helper))));
    }

    writer_remote_->Write(position, std::move(consumer_handle), WTF::BindOnce(&WriterHelper::WriteComplete, helper->AsWeakPtr()));

    pending_operation_ = MakeGarbageCollected<ScriptPromiseResolver<IDLUndefined>>(script_state, exception_state.GetContext());
    return pending_operation_->Promise();
}

ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::Truncate(ScriptState* script_state, uint64_t size, ExceptionState& exception_state)
{
    if (!writer_remote_.is_bound() || pending_operation_) {
        ThrowDOMExceptionAndInvalidateSink(exception_state, DOMExceptionCode::kInvalidStateError, "Object reached an invalid state");
        return EmptyPromise();
    ...
    pending_operation_ = MakeGarbageCollected<ScriptPromiseResolver<IDLUndefined>>(script_state, exception_state.GetContext());
    auto result = pending_operation_->Promise();
    writer_remote_->Truncate(size, WTF::BindOnce(&FileSystemUnderlyingSink::TruncateComplete, WrapPersistent(this), size));
    return result;
}

ScriptPromise<IDLUndefined> FileSystemUnderlyingSink::Seek(ScriptState* script_state, uint64_t offset, ExceptionState& exception_state)
{
    if (!writer_remote_.is_bound() || pending_operation_) {
        ThrowDOMExceptionAndInvalidateSink(exception_state, DOMExceptionCode::kInvalidStateError, "Object reached an invalid state");
        return EmptyPromise();
...
void FileSystemUnderlyingSink::WriteComplete(mojom::blink::FileSystemAccessErrorPtr result, uint64_t bytes_written)
{
...
void FileSystemUnderlyingSink::TruncateComplete(uint64_t to_size, mojom::blink::FileSystemAccessErrorPtr result)
{
    DCHECK(pending_operation_);
...
void FileSystemUnderlyingSink::CloseComplete(mojom::blink::FileSystemAccessErrorPtr result)
{
    DCHECK(pending_operation_);
