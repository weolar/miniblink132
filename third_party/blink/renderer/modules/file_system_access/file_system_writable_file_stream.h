...
public:
    static FileSystemWritableFileStream* Create(ScriptState* script_state, mojo::PendingRemote<mojom::blink::FileSystemAccessFileWriter> writer_pending_remote,
        V8FileSystemWritableFileStreamMode lock_mode);

    explicit FileSystemWritableFileStream(V8FileSystemWritableFileStreamMode lock_mode);

    void Trace(Visitor* visitor) const override;

    // IDL defined functions specific to FileSystemWritableFileStream.
    ScriptPromise<IDLUndefined> write(ScriptState*, const V8UnionBlobOrBufferSourceOrUSVStringOrWriteParams* data, ExceptionState&);
