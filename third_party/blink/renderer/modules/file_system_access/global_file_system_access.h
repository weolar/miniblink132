...
public:
    static ScriptPromise<IDLSequence<FileSystemFileHandle>> showOpenFilePicker(ScriptState*, LocalDOMWindow&, const OpenFilePickerOptions*, ExceptionState&);
    static ScriptPromise<FileSystemFileHandle> showSaveFilePicker(ScriptState*, LocalDOMWindow&, const SaveFilePickerOptions*, ExceptionState&);
    static ScriptPromise<FileSystemDirectoryHandle> showDirectoryPicker(ScriptState*, LocalDOMWindow&, const DirectoryPickerOptions*, ExceptionState&);
};
