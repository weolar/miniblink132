...
class FileSystemObservationCollection final : public GarbageCollected<FileSystemObservationCollection>, public Supplement<ExecutionContext> {
public:
    ...
    FileSystemObservationCollection(const FileSystemObservationCollection&) = delete;
    FileSystemObservationCollection& operator=(const FileSystemObservationCollection&) = delete;

    void Trace(Visitor* visitor) const override;
    void AddObservation(FileSystemObserver* observer, mojo::PendingReceiver<mojom::blink::FileSystemAccessObserver> observer_receiver);
    void RemoveObservation(FileSystemObserver* observer, FileSystemObservation* observation);
...
private:
    ...
    // the HeapHashMap.
    HeapHashMap<Member<FileSystemObserver>, Member<HeapHashSet<Member<FileSystemObservation>>>> observation_map_;
};
