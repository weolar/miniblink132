...
public:
    static FileSystemObserver* Create(ScriptState*, V8FileSystemObserverCallback* callback, ExceptionState&);
    ...
    ScriptPromise<IDLUndefined> observe(ScriptState*, FileSystemHandle* handle, FileSystemObserverObserveOptions* options, ExceptionState&);
    void unobserve(FileSystemHandle* handle);
    void disconnect();

    void OnFileChanges(WTF::Vector<mojom::blink::FileSystemAccessChangePtr> mojo_changes);

    void Trace(Visitor* visitor) const override;

private:
    void DidObserve(ScriptPromiseResolver<IDLUndefined>* resolver, mojom::blink::FileSystemAccessErrorPtr result,
    ...
    void OnGotStorageAccessStatus(ScriptPromiseResolver<IDLUndefined>* resolver, FileSystemHandle* handle, FileSystemObserverObserveOptions* options,
