...
void ResolveOrReject(ScriptPromiseResolver<IDLUndefined>* resolver, const mojom::blink::FileSystemAccessError& error)
{
...
void Reject(ScriptPromiseResolverBase* resolver, const mojom::blink::FileSystemAccessError& error)
{
    ...
    case mojom::blink::FileSystemAccessStatus::kPermissionDenied:
        resolver->RejectWithDOMException(DOMExceptionCode::kNotAllowedError, message);
        break;
    case mojom::blink::FileSystemAccessStatus::kNoModificationAllowedError:
        resolver->RejectWithDOMException(DOMExceptionCode::kNoModificationAllowedError, message);
        break;
    case mojom::blink::FileSystemAccessStatus::kInvalidModificationError:
        resolver->RejectWithDOMException(DOMExceptionCode::kInvalidModificationError, message);
        break;
