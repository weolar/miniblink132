...
public:
    explicit FileSystemSyncAccessHandle(ExecutionContext* context, FileSystemAccessFileDelegate* file_delegate,
        mojo::PendingRemote<mojom::blink::FileSystemAccessAccessHandleHost> access_handle_host, V8FileSystemSyncAccessHandleMode lock_mode);

    FileSystemSyncAccessHandle(const FileSystemSyncAccessHandle&) = delete;
    FileSystemSyncAccessHandle& operator=(const FileSystemSyncAccessHandle&) = delete;
    ...
    uint64_t read(const AllowSharedBufferSource* buffer, FileSystemReadWriteOptions* options, ExceptionState&);

    uint64_t write(base::span<const uint8_t> buffer, FileSystemReadWriteOptions* options, ExceptionState&);
...
private:
    ...
    HeapMojoRemote<mojom::blink::FileSystemAccessAccessHandleHost> access_handle_remote_;
