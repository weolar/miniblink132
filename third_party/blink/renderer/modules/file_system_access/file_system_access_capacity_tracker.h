...
class FileSystemAccessCapacityTracker final : public GarbageCollected<FileSystemAccessCapacityTracker> {
public:
    explicit FileSystemAccessCapacityTracker(ExecutionContext* context,
    ...
    FileSystemAccessCapacityTracker(const FileSystemAccessCapacityTracker&) = delete;
    FileSystemAccessCapacityTracker& operator=(const FileSystemAccessCapacityTracker&) = delete;
    ...
    void RequestFileCapacityChange(int64_t required_capacity, base::OnceCallback<void(bool)> callback);
...
private:
    ...
    void DidRequestCapacityChange(int64_t new_size, base::OnceCallback<void(bool)> callback, int64_t granted_capacity);
    ...
    HeapMojoRemote<mojom::blink::FileSystemAccessFileModificationHost> file_modification_host_;
