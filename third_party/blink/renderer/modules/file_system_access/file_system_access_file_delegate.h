...
class FileSystemAccessFileDelegate : public GarbageCollected<FileSystemAccessFileDelegate> {
public:
    virtual ~FileSystemAccessFileDelegate() = default;

    static FileSystemAccessFileDelegate* Create(ExecutionContext* context, mojom::blink::FileSystemAccessRegularFilePtr regular_file);
    ...
    virtual base::FileErrorOr<int> Read(int64_t offset, base::span<uint8_t> data) = 0;
    ...
    virtual base::FileErrorOr<int> Write(int64_t offset, base::span<const uint8_t> data) = 0;
