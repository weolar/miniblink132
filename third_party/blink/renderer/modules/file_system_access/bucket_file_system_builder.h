...
using DirectoryCallback = base::OnceCallback<void(mojom::blink::FileSystemAccessErrorPtr, std::unique_ptr<protocol::FileSystem::Directory>)>;
...
class MODULES_EXPORT BucketFileSystemBuilder final : public GarbageCollected<BucketFileSystemBuilder>,
...
public:
    ...
    static void BuildDirectoryTree(
    ...
    BucketFileSystemBuilder(ExecutionContext* execution_context, const String storage_key, const String name, DirectoryCallback completion_callback);

    // mojom::blink::FileSystemAccessDirectoryEntriesListener
    void DidReadDirectory(
        mojom::blink::FileSystemAccessErrorPtr result, Vector<mojom::blink::FileSystemAccessEntryPtr> entries, bool has_more_entries) override;

    mojo::PendingRemote<mojom::blink::FileSystemAccessDirectoryEntriesListener> GetListener();
...
private:
    ...
    // encountered.
    void DidBuildFile(base::OnceClosure barrier_callback, mojom::blink::FileSystemAccessErrorPtr result, std::unique_ptr<protocol::FileSystem::File> file);
    ...
    HeapMojoReceiver<mojom::blink::FileSystemAccessDirectoryEntriesListener, BucketFileSystemBuilder> receiver_;
