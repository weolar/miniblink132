...
class FileSystemAccessIncognitoFileDelegate final : public FileSystemAccessFileDelegate {
public:
    // Instances should only be constructed via
    // `FileSystemAccessFileDelegate::CreateForIncognito()`
    explicit FileSystemAccessIncognitoFileDelegate(ExecutionContext* context,
    ...
    FileSystemAccessIncognitoFileDelegate(const FileSystemAccessIncognitoFileDelegate&) = delete;
    FileSystemAccessIncognitoFileDelegate& operator=(const FileSystemAccessIncognitoFileDelegate&) = delete;
