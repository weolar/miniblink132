...
inline base::span<uint8_t> AsByteSpan(const AllowSharedBufferSource& buffer_union)
{
    ...
    case AllowSharedBufferSource::ContentType::kArrayBufferAllowShared: {
        ...
        return (buffer && !buffer->IsDetached()) ? buffer->ByteSpanMaybeShared() : base::span<uint8_t>();
    }
