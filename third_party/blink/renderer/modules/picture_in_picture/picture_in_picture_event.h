...
public:
    static PictureInPictureEvent* Create(const AtomicString&, PictureInPictureWindow*);
    static PictureInPictureEvent* Create(const AtomicString&, const PictureInPictureEventInit*);
