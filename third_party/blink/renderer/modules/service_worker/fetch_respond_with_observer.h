...
public:
    FetchRespondWithObserver(ExecutionContext*, int fetch_event_id, base::WeakPtr<CrossOriginResourcePolicyChecker> corp_checker,
        const mojom::blink::FetchAPIRequest&, WaitUntilObserver*);
