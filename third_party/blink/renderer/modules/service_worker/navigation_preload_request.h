...
class NavigationPreloadRequest final : public WebNavigationPreloadRequest, public network::mojom::URLLoaderClient {
public:
    // |owner| must outlive |this|.
    NavigationPreloadRequest(WebServiceWorkerContextClient* owner, int fetch_event_id, const WebURL& url,
...
private:
    ...
    void ReportErrorToOwner(const WebString& message, WebServiceWorkerError::Mode error_mode);
