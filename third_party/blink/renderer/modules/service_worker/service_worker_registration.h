...
class ServiceWorkerRegistration final : public EventTarget,
...
public:
    ...
    static ServiceWorkerRegistration* Take(ScriptPromiseResolverBase*, WebServiceWorkerRegistrationObjectInfo);

    ServiceWorkerRegistration(ExecutionContext*, WebServiceWorkerRegistrationObjectInfo);

    ServiceWorkerRegistration(ExecutionContext*, mojom::blink::ServiceWorkerRegistrationObjectInfoPtr);
    ...
    void EnableNavigationPreload(bool enable, ScriptPromiseResolver<IDLUndefined>* resolver);
    void GetNavigationPreloadState(ScriptPromiseResolver<NavigationPreloadState>* resolver);
    void SetNavigationPreloadHeader(const String& value, ScriptPromiseResolver<IDLUndefined>* resolver);

    ScriptPromise<ServiceWorkerRegistration> update(ScriptState*, ExceptionState&);
...
private:
    ...
    void SetServiceWorkerObjects(mojom::blink::ChangedServiceWorkerObjectsMaskPtr changed_mask, mojom::blink::ServiceWorkerObjectInfoPtr installing,
        mojom::blink::ServiceWorkerObjectInfoPtr waiting, mojom::blink::ServiceWorkerObjectInfoPtr active) override;
    void SetUpdateViaCache(mojom::blink::ServiceWorkerUpdateViaCache update_via_cache) override;
    void UpdateFound() override;

    void UpdateInternal(mojom::blink::FetchClientSettingsObjectPtr mojom_settings_object, ScriptPromiseResolver<ServiceWorkerRegistration>* resolver);
    ...
    HeapMojoAssociatedRemote<mojom::blink::ServiceWorkerRegistrationObjectHost> host_;
    ...
    HeapMojoAssociatedReceiver<mojom::blink::ServiceWorkerRegistrationObject, ServiceWorkerRegistration> receiver_;
...
public:
    ...
    static HeapVector<Member<ServiceWorkerRegistration>> Take(ScriptPromiseResolverBase* resolver, WebType web_service_worker_registrations)
    {
        HeapVector<Member<ServiceWorkerRegistration>> registrations;
        for (auto& registration : web_service_worker_registrations) {
            registrations.push_back(ServiceWorkerRegistration::Take(resolver, std::move(registration)));
        }
