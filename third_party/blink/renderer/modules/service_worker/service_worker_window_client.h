...
public:
    using ResolveWindowClientCallback = base::OnceCallback<void(bool, mojom::blink::ServiceWorkerClientInfoPtr, const String&)>;

    static ResolveWindowClientCallback CreateResolveWindowClientCallback(ScriptPromiseResolver<IDLNullable<ServiceWorkerWindowClient>>*);

    explicit ServiceWorkerWindowClient(const mojom::blink::ServiceWorkerClientInfo&);
    ...
    ScriptPromise<IDLNullable<ServiceWorkerWindowClient>> navigate(ScriptState*, const String& url);
