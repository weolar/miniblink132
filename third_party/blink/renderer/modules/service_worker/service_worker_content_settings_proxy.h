...
public:
    explicit ServiceWorkerContentSettingsProxy(mojo::PendingRemote<mojom::blink::WorkerContentSettingsProxy> host_info);

    ServiceWorkerContentSettingsProxy(const ServiceWorkerContentSettingsProxy&) = delete;
    ServiceWorkerContentSettingsProxy& operator=(const ServiceWorkerContentSettingsProxy&) = delete;
