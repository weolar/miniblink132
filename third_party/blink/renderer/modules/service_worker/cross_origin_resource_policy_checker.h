...
public:
    ...
    CrossOriginResourcePolicyChecker(const CrossOriginResourcePolicyChecker&) = delete;
    CrossOriginResourcePolicyChecker& operator=(const CrossOriginResourcePolicyChecker&) = delete;

    bool IsBlocked(const url::Origin& initiator_origin, network::mojom::RequestMode request_mode, network::mojom::RequestDestination request_destination,
