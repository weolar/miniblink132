...
AXProgressIndicator::AXProgressIndicator(LayoutObject* layout_object, AXObjectCacheImpl& ax_object_cache)
    : AXNodeObject(layout_object, ax_object_cache)
{
    DCHECK(layout_object);
    DCHECK(IsA<HTMLProgressElement>(layout_object->GetNode())) << "The layout object's node isn't an HTMLProgressElement.";
}
