...
public:
    ...
    const std::optional<wtf_size_t> FindFirstFragment(const LayoutObject* layout_object) const;
    ...
    {
        return total_fragment_count_;
    }

    const HeapVector<Line>& GetLines() const
    {
        return lines_;
    }
...
private:
    ...
    void ProcessBoxFragment(const PhysicalBoxFragment* box_fragment, wtf_size_t starting_fragment_index);
