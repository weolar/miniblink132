...
{
    return state_ == kDeferTreeUpdates || state_ == kProcessDeferredUpdates || state_ == kFinalizingTree || state_ == kDisposing;
}
...
{
    return state_ == kDeferTreeUpdates || state_ == kProcessDeferredUpdates || state_ == kFinalizingTree;
}

inline bool AXObjectCacheLifecycle::StateAllowsAXObjectsToGainFinalizationNeededBit() const
{
    return state_ == kDeferTreeUpdates || state_ == kProcessDeferredUpdates;
}

inline bool AXObjectCacheLifecycle::StateAllowsQueueingEventsForSerialization() const
{
    return state_ == kDeferTreeUpdates || state_ == kProcessDeferredUpdates;
}

inline bool AXObjectCacheLifecycle::StateAllowsQueueingAXObjectsForSerialization() const
{
    return state_ == kDeferTreeUpdates || state_ == kProcessDeferredUpdates || state_ == kFinalizingTree;
}
