...
// static
WTF::String InternalsAccessibility::getComputedLabel(Internals&, const Element* element)
{
...
// static
WTF::String InternalsAccessibility::getComputedRole(Internals&, const Element* element)
{
    AXObject* ax_object = GetAXObject(element);
    if (!ax_object || ax_object->IsIgnored()) {
