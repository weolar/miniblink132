...
private:
    std::ostringstream& PrintAXTreeHelper(std::ostringstream&, const AXObject* root, size_t level) const;

    ScopedAccessibilityUseAXPositionForDocumentMarkersForTest use_ax_position { true };
};
