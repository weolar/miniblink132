...
class MODULES_EXPORT BlinkAXTreeSource : public GarbageCollected<BlinkAXTreeSource>, public ui::AXTreeSource<const AXObject*, ui::AXTreeData*, ui::AXNodeData> {
public:
    ...
    explicit BlinkAXTreeSource(AXObjectCacheImpl& ax_object_cache, bool is_snapshot);
    ~BlinkAXTreeSource() override;

    static BlinkAXTreeSource* Create(AXObjectCacheImpl& ax_object_cache, bool is_snapshot = false)
    {
        return MakeGarbageCollected<BlinkAXTreeSource>(ax_object_cache, is_snapshot);
    }
...
private:
    void Selection(const AXObject* obj, bool& is_selection_backward, const AXObject** anchor_object, int& anchor_offset,
        ax::mojom::blink::TextAffinity& anchor_affinity, const AXObject** focus_object, int& focus_offset,
    ...
    bool ShouldTruncateInlineTextBoxes() const
    {
        return is_snapshot_;
    }
