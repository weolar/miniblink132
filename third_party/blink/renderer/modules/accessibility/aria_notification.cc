...
ax::mojom::blink::AriaNotificationInterrupt AsEnum(const V8AriaNotifyInterrupt& interrupt)
{
...
ax::mojom::blink::AriaNotificationPriority AsEnum(const V8AriaNotifyPriority& priority)
{
...
AriaNotification::AriaNotification(const String& announcement, const AriaNotificationOptions* options)
...
void AriaNotifications::Add(const String& announcement, const AriaNotificationOptions* options)
{
