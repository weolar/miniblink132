...
public:
    ...
    AriaNotification(const String& announcement, const AriaNotificationOptions* options);

    const String& Announcement() const
    {
    ...
    AriaNotificationInterrupt Interrupt() const
    {
        return interrupt_;
    }
    AriaNotificationPriority Priority() const
    {
        return priority_;
    }
