...
public:
    ...
    ScriptPromise<IDLUndefined> Transform(v8::Local<v8::Value> chunk, TransformStreamDefaultController*, ExceptionState&) override;
...
private:
    ...
    void Inflate(const uint8_t*, wtf_size_t, IsFinished, TransformStreamDefaultController*, ExceptionState&);

    void EnqueueBuffers(TransformStreamDefaultController*, HeapVector<Member<DOMUint8Array>, 1u> buffers, ExceptionState&);
