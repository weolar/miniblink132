...
public:
    ...
    static WebSocketError* Create(String message, const WebSocketCloseInfo*, ExceptionState&);
    ...
    static v8::Local<v8::Value> Create(v8::Isolate*, String message, std::optional<uint16_t> close_code, String reason);
    ...
    WebSocketError(PassKey, String message, std::optional<uint16_t> close_code, String reason);
    ~WebSocketError() override;

    std::optional<uint16_t> closeCode() const
    {
        return close_code_;
    }
...
private:
    static WebSocketError* ValidateAndCreate(String message, std::optional<uint16_t> close_code, String reason, ExceptionState& exception_state);
