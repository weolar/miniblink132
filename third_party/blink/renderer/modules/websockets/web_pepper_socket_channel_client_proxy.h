...
class WebPepperSocketChannelClientProxy final : public GarbageCollected<WebPepperSocketChannelClientProxy>, public WebSocketChannelClient {
public:
    ...
    {
        std::unique_ptr<Vector<char>> data_to_pass = std::make_unique<Vector<char>>();
    ...
    void DidClose(ClosingHandshakeCompletionStatus status, uint16_t code, const String& reason) override
    {
