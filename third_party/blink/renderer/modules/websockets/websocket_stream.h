...
class MODULES_EXPORT WebSocketStream final : public ScriptWrappable,
...
public:
    // IDL constructors
    static WebSocketStream* Create(ScriptState*, const String& url, WebSocketStreamOptions*, ExceptionState&);
    static WebSocketStream* CreateForTesting(ScriptState*, const String& url, WebSocketStreamOptions*, WebSocketChannel*, ExceptionState&);
    ...
    void DidClose(ClosingHandshakeCompletionStatus, uint16_t /* code */, const String& /* reason */) override;
...
private:
    ...
    static WebSocketStream* CreateInternal(ScriptState*, const String& url, WebSocketStreamOptions*, WebSocketChannel*, ExceptionState&);
    void Connect(ScriptState*, const String& url, WebSocketStreamOptions*, ExceptionState&);
    ...
    void CloseInternal(std::optional<uint16_t> code, const String& reason, ExceptionState& exception_state);
    void OnAbort();

    // Create a WebSocketError with the supplied arguments.
    v8::Local<v8::Value> CreateWebSocketError(String message, std::optional<uint16_t> close_code = std::nullopt, String reason = String());
    static WebSocketCloseInfo* MakeCloseInfo(uint16_t close_code, const String& reason);
