...
public:
    ...
    static constexpr auto kSegmentSize = WebSocketMessageChunkAccumulator::kSegmentSize;
    static constexpr auto kFreeDelay = WebSocketMessageChunkAccumulator::kFreeDelay;
...
TEST_F(WebSocketMessageChunkAccumulatorTest, Empty)
{
    ...
    WebSocketMessageChunkAccumulator* chunks = MakeGarbageCollected<WebSocketMessageChunkAccumulator>(task_runner);
...
{
    WebSocketMessageChunkAccumulator* chunks = MakeGarbageCollected<WebSocketMessageChunkAccumulator>(base::MakeRefCounted<FakeTaskRunner>());
