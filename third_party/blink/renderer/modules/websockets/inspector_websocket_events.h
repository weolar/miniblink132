...
public:
    static void Data(perfetto::TracedValue context, ExecutionContext*, uint64_t identifier, const KURL&, const String& protocol);
};
...
public:
    static void Data(perfetto::TracedValue context, ExecutionContext*, uint64_t identifier);
};
...
public:
    static void Data(perfetto::TracedValue context, ExecutionContext*, uint64_t identifier, uint64_t data_length);
};
