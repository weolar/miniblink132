...
public:
    ...
    MOCK_METHOD2(Send, WebSocketChannel::SendResult(const std::string&, base::OnceClosure));
    MOCK_METHOD4(Send, WebSocketChannel::SendResult(const DOMArrayBuffer&, size_t, size_t, base::OnceClosure));
    ...
    MOCK_METHOD3(FailMock, void(const String&, mojom::ConsoleMessageLevel, SourceLocation*));
    void Fail(const String& reason, mojom::ConsoleMessageLevel level, std::unique_ptr<SourceLocation> location) override
    {
