...
class BLINK_MODULES_EXPORT AudioRendererMixerInput : public media::SwitchableAudioRendererSink, public media::AudioConverter::InputCallback {
public:
    ...
    AudioRendererMixerInput(AudioRendererMixerPool* mixer_pool, const LocalFrameToken& source_frame_token, const FrameToken& main_frame_token,
        std::string_view device_id, media::AudioLatency::Type latency);
    ...
    void Initialize(const media::AudioParameters& params, media::AudioRendererSink::RenderCallback* renderer) override;
...
private:
    ...
    double ProvideInput(media::AudioBus* audio_bus, uint32_t frames_delayed, const media::AudioGlitchInfo& glitch_info) override;

    void OnDeviceInfoReceived(OutputDeviceInfoCB info_cb, media::OutputDeviceInfo device_info);
    ...
    void OnDeviceSwitchReady(media::OutputDeviceStatusCB switch_cb, scoped_refptr<media::AudioRendererSink> sink, media::OutputDeviceInfo device_info);
