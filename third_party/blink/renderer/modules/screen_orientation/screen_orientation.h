...
class MODULES_EXPORT ScreenOrientation final : public EventTarget, public ExecutionContextClient {
...
public:
    ...
    ScriptPromise<IDLUndefined> lock(ScriptState*, const V8OrientationLockType& orientation, ExceptionState&);
    void unlock();

    DEFINE_ATTRIBUTE_EVENT_LISTENER(change, kChange)

    // Helper being used by this class and LockOrientationCallback.
    static V8OrientationType::Enum OrientationTypeToV8Enum(display::mojom::blink::ScreenOrientation);
