...
class MODULES_EXPORT ScreenOrientationController final : public GarbageCollected<ScreenOrientationController>,
...
public:
    ...
    ScreenOrientationController& operator=(const ScreenOrientationController&) = delete;
    ...
    void lock(device::mojom::blink::ScreenOrientationLockType, std::unique_ptr<WebLockOrientationCallback>);
    void unlock();
    ...
    void SetScreenOrientationAssociatedRemoteForTests(HeapMojoAssociatedRemote<device::mojom::blink::ScreenOrientation>);
...
private:
    ...
    static display::mojom::blink::ScreenOrientation ComputeOrientation(const gfx::Rect&, uint16_t);
    ...
    void LockOrientationInternal(device::mojom::blink::ScreenOrientationLockType orientation, std::unique_ptr<WebLockOrientationCallback> callback);
    void UnlockOrientationInternal();

    Member<ScreenOrientation> orientation_;
    bool active_lock_ = false;
    HeapMojoAssociatedRemote<device::mojom::blink::ScreenOrientation> screen_orientation_service_;
