...
class MODULES_EXPORT BrowsingTopicsDocumentSupplement : public GarbageCollected<BrowsingTopicsDocumentSupplement>, public Supplement<Document> {
public:
    static const char kSupplementName[];

    // Supplement functionality.
    static BrowsingTopicsDocumentSupplement* From(Document&);
    static ScriptPromise<IDLSequence<BrowsingTopic>> browsingTopics(ScriptState* script_state, Document& document, ExceptionState& exception_state);
