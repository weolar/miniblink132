...
class AudioListenerHandler final : public ThreadSafeRefCounted<AudioListenerHandler> {
public:
    static scoped_refptr<AudioListenerHandler> Create(AudioParamHandler& position_x_handler, AudioParamHandler& position_y_handler,
    ...
    {
        return gfx::Point3F(position_x_handler_->Value(), position_y_handler_->Value(), position_z_handler_->Value());
    }

    const gfx::Vector3dF GetOrientation() const
    {
        return gfx::Vector3dF(forward_x_handler_->Value(), forward_y_handler_->Value(), forward_z_handler_->Value());
    }

    const gfx::Vector3dF GetUpVector() const
    {
        return gfx::Vector3dF(up_x_handler_->Value(), up_y_handler_->Value(), up_z_handler_->Value());
    }
    ...
    {
        return is_listener_dirty_;
    }

    base::Lock& Lock()
    {
        return listener_lock_;
    }
...
private:
    AudioListenerHandler(AudioParamHandler& position_x_handler, AudioParamHandler& position_y_handler, AudioParamHandler& position_z_handler,
