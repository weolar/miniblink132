...
public:
    static scoped_refptr<DynamicsCompressorHandler> Create(AudioNode&, float sample_rate, AudioParamHandler& threshold, AudioParamHandler& knee,
...
private:
    DynamicsCompressorHandler(AudioNode&, float sample_rate, AudioParamHandler& threshold, AudioParamHandler& knee, AudioParamHandler& ratio,
