...
public:
    ...
    {
        return GetPlaybackState() == FINISHED_STATE;
    }
...
protected:
    ...
    std::tuple<size_t, size_t, double> UpdateSchedulingInfo(size_t quantum_frame_size, AudioBus* output_bus) EXCLUSIVE_LOCKS_REQUIRED(process_lock_);
