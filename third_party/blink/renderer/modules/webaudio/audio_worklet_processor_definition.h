...
class MODULES_EXPORT AudioWorkletProcessorDefinition final : public GarbageCollected<AudioWorkletProcessorDefinition>, public NameClient {
public:
    ...
    void SetAudioParamDescriptors(const HeapVector<Member<AudioParamDescriptor>>&);
