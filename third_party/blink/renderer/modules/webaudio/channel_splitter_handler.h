...
public:
    static scoped_refptr<ChannelSplitterHandler> Create(AudioNode&, float sample_rate, unsigned number_of_outputs);
    ...
    void SetChannelInterpretation(V8ChannelInterpretation::Enum, ExceptionState&) final;
...
private:
    ChannelSplitterHandler(AudioNode&, float sample_rate, unsigned number_of_outputs);
};
