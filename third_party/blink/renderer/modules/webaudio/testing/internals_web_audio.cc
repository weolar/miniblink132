...
{
#if DEBUG_AUDIONODE_REFERENCES
    fprintf(stderr, "InternalsWebAudio::audioWorkletProcessorCount = %u\n", InstanceCounters::CounterValue(InstanceCounters::kAudioWorkletProcessorCounter));
#endif
    return InstanceCounters::CounterValue(InstanceCounters::kAudioWorkletProcessorCounter);
}

void InternalsWebAudio::emulateDeviceFailureOnAudioContext(Internals& internals, AudioContext* context)
{
