...
class AudioParamMapIterationSource final : public PairSyncIterable<AudioParamMap>::IterationSource {
public:
    explicit AudioParamMapIterationSource(const HeapHashMap<String, Member<AudioParam>>& map)
    {
    ...
    bool FetchNextItem(ScriptState* scrip_state, String& key, AudioParam*& audio_param, ExceptionState&) override
    {
...
AudioParamMap::AudioParamMap(const HeapHashMap<String, Member<AudioParam>>& parameter_map)
    : parameter_map_(parameter_map)
{
}

PairSyncIterable<AudioParamMap>::IterationSource* AudioParamMap::CreateIterationSource(ScriptState*, ExceptionState&)
{
    return MakeGarbageCollected<AudioParamMapIterationSource>(parameter_map_);
}

bool AudioParamMap::GetMapEntry(ScriptState*, const String& key, AudioParam*& value, ExceptionState&)
{
