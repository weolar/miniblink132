...
DOMHighResTimeStamp AudioPlayoutStats::fallbackFramesDuration(ScriptState* script_state)
{
...
DOMHighResTimeStamp AudioPlayoutStats::totalFramesDuration(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return (stats_.glitch_frames_duration() + stats_.observed_frames_duration()).InMillisecondsF();
}

DOMHighResTimeStamp AudioPlayoutStats::averageLatency(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return stats_.average_latency().InMillisecondsF();
}

DOMHighResTimeStamp AudioPlayoutStats::minimumLatency(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return stats_.min_latency().InMillisecondsF();
}

DOMHighResTimeStamp AudioPlayoutStats::maximumLatency(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
...
ScriptValue AudioPlayoutStats::toJSON(ScriptState* script_state)
{
    ...
    result.AddNumber("fallbackFramesDuration", fallbackFramesDuration(script_state));
...
void AudioPlayoutStats::MaybeUpdateStats(ScriptState* script_state)
{
    ...
    ToEventLoop(script_state).EnqueueMicrotask(WTF::BindOnce(&AudioPlayoutStats::OnMicrotask, WrapWeakPersistent(this)));
}
