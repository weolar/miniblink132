...
public:
    static scoped_refptr<MediaStreamAudioSourceHandler> Create(AudioNode&, std::unique_ptr<AudioSourceProvider>);
...
private:
    MediaStreamAudioSourceHandler(AudioNode&, std::unique_ptr<AudioSourceProvider>);
