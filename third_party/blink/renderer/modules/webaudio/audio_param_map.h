...
class AudioParamMap final : public ScriptWrappable, public Maplike<AudioParamMap> {
...
public:
    ...
    const MapType& GetHashMap() const
    {
...
private:
    PairSyncIterable<AudioParamMap>::IterationSource* CreateIterationSource(ScriptState*, ExceptionState&) override;
    bool GetMapEntry(ScriptState*, const String& key, AudioParam*& value, ExceptionState&) override;
