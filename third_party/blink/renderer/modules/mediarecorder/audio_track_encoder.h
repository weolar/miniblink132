...
public:
    ...
    explicit AudioTrackEncoder(OnEncodedAudioCB on_encoded_audio_cb, OnEncodedAudioErrorCB on_encoded_audio_error_cb = base::DoNothing());
    ...
    virtual void EncodeAudio(std::unique_ptr<media::AudioBus> audio_bus, base::TimeTicks capture_time) = 0;
