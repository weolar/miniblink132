...
TEST(KeyFrameRequestProcessorTest, DefaultConfigurationIsUnconfigured)
{
    ...
    ASSERT_TRUE(absl::get_if<KeyFrameRequestProcessor::NotConfiguredTag>(&config));
}

TEST_F(KeyFrameRequestProcessorClockTest, DefaultProcessorRequestKeyFrameEvery100Frames)
{
...
TEST_F(KeyFrameRequestProcessorClockTest, CountIntervalSuggestsKeyframesPeriodically)
{
...
TEST_F(KeyFrameRequestProcessorClockTest, DurationIntervalSuggestsKeyframesPeriodically)
{
