...
// WebMediaStreamSink.
template <class MediaStreamSink> class TrackRecorder : public MediaStreamSink {
public:
...
template <class MediaStreamSink> void TrackRecorder<MediaStreamSink>::OnReadyStateChanged(WebMediaStreamSource::ReadyState state)
{
...
MODULES_EXPORT MediaTrackContainerType GetMediaContainerTypeFromString(const WTF::String& type);
