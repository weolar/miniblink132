...
public:
    ...
    public:
        ...
        {
            return base::MakeRefCounted<FakeEncodedVideoFrame>(is_key_frame_, std::move(data_), codec_, std::move(color_space_), resolution_);
        }
    ...
    FakeEncodedVideoFrame(bool is_key_frame, std::string data, media::VideoCodec codec, std::optional<gfx::ColorSpace> color_space, gfx::Size resolution)
        : is_key_frame_(is_key_frame)
        , data_(std::move(data))
        , codec_(codec)
