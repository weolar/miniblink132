...
// implementation file.
class MODULES_EXPORT AudioTrackRecorder : public TrackRecorder<WebMediaStreamAudioSink> {
public:
    enum class CodecId {
    ...
    public:
        ...
        virtual void OnEncodedAudio(const media::AudioParameters& params, scoped_refptr<media::DecoderBuffer> encoded_data,
    ...
    using OnEncodedAudioCB = base::RepeatingCallback<void(const media::AudioParameters& params, scoped_refptr<media::DecoderBuffer> encoded_data,
        std::optional<media::AudioEncoder::CodecDescription> codec_description, base::TimeTicks capture_time)>;
    ...
    AudioTrackRecorder(scoped_refptr<base::SingleThreadTaskRunner> main_thread_task_runner, CodecId codec, MediaStreamComponent* track,
        WeakCell<CallbackInterface>* callback_interface, uint32_t bits_per_second, BitrateMode bitrate_mode,
        scoped_refptr<base::SequencedTaskRunner> encoder_task_runner = base::ThreadPool::CreateSequencedTaskRunner({ base::TaskPriority::USER_VISIBLE }));
    ...
    void OnData(const media::AudioBus& audio_bus, base::TimeTicks capture_time) override;
...
private:
    ...
    // invalid.
    static std::unique_ptr<AudioTrackEncoder> CreateAudioEncoder(CodecId codec, scoped_refptr<base::SequencedTaskRunner> encoder_task_runner,
