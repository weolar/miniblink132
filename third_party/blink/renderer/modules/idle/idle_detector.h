...
class MODULES_EXPORT IdleDetector final : public EventTarget,
...
public:
    ...
    static ScriptPromise<V8PermissionState> requestPermission(ScriptState*, ExceptionState&);
    ScriptPromise<IDLUndefined> start(ScriptState*, const IdleOptions*, ExceptionState&);
    DEFINE_ATTRIBUTE_EVENT_LISTENER(change, kChange)

    void Trace(Visitor*) const override;

    void SetTaskRunnerForTesting(scoped_refptr<base::SingleThreadTaskRunner> task_runner, const base::TickClock* tick_clock);
...
private:
    ...
    void Update(mojom::blink::IdleStatePtr state, bool is_overridden_by_devtools) override;

    void DispatchUserIdleEvent(TimerBase*);
    void Abort();
    void OnMonitorDisconnected();
    void OnAddMonitor(ScriptPromiseResolver<IDLUndefined>*, mojom::blink::IdleManagerError, mojom::blink::IdleStatePtr);
    void Clear();
