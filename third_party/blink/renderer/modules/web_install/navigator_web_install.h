...
class MODULES_EXPORT NavigatorWebInstall final : public GarbageCollected<NavigatorWebInstall>, public Supplement<Navigator> {
public:
    ...
    static ScriptPromise<WebInstallResult> install(ScriptState* script_state, Navigator& navigator, ExceptionState& exception_state);
...
private:
    ...
    ScriptPromise<WebInstallResult> InstallImpl(ScriptState* script_state, ExceptionState& exception_state);
    ...
    KURL ResolveManifestId(const String& manifest_id, ExceptionState& exception_state);
