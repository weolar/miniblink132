...
class MODULES_EXPORT PresentationAvailability final : public EventTarget,
...
public:
    static PresentationAvailability* Take(ExecutionContext*, const WTF::Vector<KURL>&, bool);
