...
void PresentationConnectionList::AddedEventListener(const AtomicString& event_type, RegisteredEventListener& registered_listener)
{
...
bool PresentationConnectionList::RemoveConnection(PresentationConnection* connection)
{
...
{
    DispatchEvent(*PresentationConnectionAvailableEvent::Create(event_type_names::kConnectionavailable, connection));
}
