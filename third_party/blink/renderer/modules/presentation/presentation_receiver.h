...
// client.
class MODULES_EXPORT PresentationReceiver final : public ScriptWrappable, public mojom::blink::PresentationReceiver {
    DEFINE_WRAPPERTYPEINFO();
    using ConnectionListProperty = ScriptPromiseProperty<PresentationConnectionList, DOMException>;
...
public:
    ...
    void OnReceiverConnectionAvailable(mojom::blink::PresentationConnectionResultPtr result) override;
...
private:
    ...
    HeapMojoReceiver<mojom::blink::PresentationReceiver, PresentationReceiver> presentation_receiver_receiver_;
