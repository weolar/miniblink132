...
class MODULES_EXPORT PresentationAvailabilityState final : public GarbageCollected<PresentationAvailabilityState> {
public:
    ...
    PresentationAvailabilityState& operator=(const PresentationAvailabilityState&) = delete;
    ...
    void RequestAvailability(const Vector<KURL>&, ScriptPromiseResolver<PresentationAvailability>* resolver);
...
private:
    ...
    // set of URLs.
    class AvailabilityListener final : public GarbageCollected<AvailabilityListener> {
    public:
        ...
        HeapVector<Member<ScriptPromiseResolver<PresentationAvailability>>> availability_resolvers;
    ...
    mojom::blink::ScreenAvailability GetScreenAvailability(const Vector<KURL>&) const;
    ...
    const raw_ptr<mojom::blink::PresentationService, DanglingUntriaged> presentation_service_;
};
