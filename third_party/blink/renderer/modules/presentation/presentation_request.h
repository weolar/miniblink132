...
class MODULES_EXPORT PresentationRequest final : public EventTarget, public ActiveScriptWrappable<PresentationRequest>, public ExecutionContextClient {
...
public:
    ...
    static PresentationRequest* Create(ExecutionContext*, const HeapVector<Member<V8UnionPresentationSourceOrUSVString>>& sources, ExceptionState&);
    ...
    ScriptPromise<PresentationConnection> reconnect(ScriptState*, const String& id, ExceptionState&);
    ScriptPromise<PresentationAvailability> getAvailability(ScriptState*, ExceptionState&);
