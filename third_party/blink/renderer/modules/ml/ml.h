...
class MODULES_EXPORT ML final : public ScriptWrappable, public ExecutionContextClient {
...
public:
    ...
    // IDL interface:
    ScriptPromise<MLContext> createContext(ScriptState* state, MLContextOptions* option, ExceptionState& exception_state);
...
private:
    ...
    HeapMojoRemote<webnn::mojom::blink::WebNNContextProvider> webnn_context_provider_;
