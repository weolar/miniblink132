...
// static
String MLOperator::OperatorKindToString(webnn::mojom::blink::Operation::Tag kind, OperationSubKind sub_kind)
{
    switch (kind) {
    ...
    case webnn::mojom::blink::Operation::Tag::kElementWiseBinary: {
        switch (absl::get<webnn::mojom::blink::ElementWiseBinary::Kind>(sub_kind)) {
    ...
    case webnn::mojom::blink::Operation::Tag::kElementWiseUnary: {
        switch (absl::get<webnn::mojom::blink::ElementWiseUnary::Kind>(sub_kind)) {
...
MLOperator::MLOperator(MLGraphBuilder* builder, webnn::mojom::blink::Operation::Tag kind, const MLOperatorOptions* options, OperationSubKind sub_kind)
    : builder_(builder)
    , kind_(kind)
    , options_(options)
    , sub_kind_(sub_kind)
...
void MLOperator::Connect(HeapVector<Member<MLOperand>> inputs, HeapVector<Member<const MLOperand>> outputs)
{
    DCHECK(!inputs.empty());
...
MLArgMinMaxOperator::MLArgMinMaxOperator(MLGraphBuilder* builder, OperationSubKind sub_kind, const uint32_t axis, const MLArgMinMaxOptions* options)
    : MLOperator(builder, webnn::mojom::blink::Operation::Tag::kArgMinMax, options, sub_kind)
    , axis_(axis)
{
}
...
MLConcatOperator::MLConcatOperator(MLGraphBuilder* builder, const uint32_t axis, const MLOperatorOptions* options)
    : MLOperator(builder, webnn::mojom::blink::Operation::Tag::kConcat, options)
    , axis_(axis)
{
}
...
MLCumulativeSumOperator::MLCumulativeSumOperator(MLGraphBuilder* builder, const uint32_t axis, const MLCumulativeSumOptions* options)
    : MLOperator(builder, webnn::mojom::blink::Operation::Tag::kCumulativeSum, options)
    , axis_(axis)
{
}
...
MLLstmOperator::MLLstmOperator(MLGraphBuilder* builder, uint32_t steps, uint32_t hidden_size, const MLLstmOptions* options)
...
MLLstmCellOperator::MLLstmCellOperator(MLGraphBuilder* builder, uint32_t hidden_size, const MLLstmCellOptions* options)
    : MLOperator(builder, webnn::mojom::blink::Operation::Tag::kLstmCell, options)
    , hidden_size_(hidden_size)
{
}
...
MLGruOperator::MLGruOperator(MLGraphBuilder* builder, uint32_t steps, uint32_t hidden_size, const MLOperatorOptions* options)
...
MLGruCellOperator::MLGruCellOperator(MLGraphBuilder* builder, uint32_t hidden_size, const MLGruCellOptions* options)
    : MLOperator(builder, webnn::mojom::blink::Operation::Tag::kGruCell, options)
    , hidden_size_(hidden_size)
{
}
...
MLPadOperator::MLPadOperator(
    MLGraphBuilder* builder, const Vector<uint32_t>& beginning_padding, const Vector<uint32_t>& ending_padding, const MLPadOptions* options)
...
MLSliceOperator::MLSliceOperator(
    MLGraphBuilder* builder, const Vector<uint32_t>& starts, const Vector<uint32_t>& sizes, const Vector<uint32_t>& strides, const MLSliceOptions* options)
...
MLSoftmaxOperator::MLSoftmaxOperator(MLGraphBuilder* builder, const uint32_t axis, const MLOperatorOptions* options)
    : MLOperator(builder, webnn::mojom::blink::Operation::Tag::kSoftmax, options)
    , axis_(axis)
{
}
...
MLSplitOperator::MLSplitOperator(MLGraphBuilder* builder, const uint32_t splits, const MLSplitOptions* options)
...
MLSplitOperator::MLSplitOperator(MLGraphBuilder* builder, const Vector<uint32_t>& splits, const MLSplitOptions* options)
    : MLOperator(builder, webnn::mojom::blink::Operation::Tag::kSplit, options)
...
MLTileOperator::MLTileOperator(MLGraphBuilder* builder, const Vector<uint32_t>& repetitions, const MLOperatorOptions* options)
