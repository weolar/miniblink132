...
class MODULES_EXPORT MIDIAccessInitializer : public GarbageCollected<MIDIAccessInitializer>, public MIDIDispatcher::Client {
public:
    struct PortDescriptor {
        ...
        PortDescriptor(const String& id, const String& manufacturer, const String& name, MIDIPortType type, const String& version, midi::mojom::PortState state)
            : id(id)
