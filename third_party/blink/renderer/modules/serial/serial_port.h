...
class SerialPort final : public EventTarget, public ActiveScriptWrappable<SerialPort>, public device::mojom::blink::SerialPortClient {
...
public:
    ...
    ScriptPromise<IDLUndefined> open(ScriptState*, const SerialOptions* options, ExceptionState&);
    bool connected()
    {
        return connected_;
    }
    ...
    ScriptPromise<IDLUndefined> setSignals(ScriptState*, const SerialOutputSignals*, ExceptionState&);
    ...
    {
        return close_resolver_ != nullptr;
    }

    void Flush(device::mojom::blink::SerialPortFlushMode mode, device::mojom::blink::SerialPort::FlushCallback callback);
...
private:
    bool CreateDataPipe(mojo::ScopedDataPipeProducerHandle* producer, mojo::ScopedDataPipeConsumerHandle* consumer);
    void OnConnectionError();
    void OnOpen(mojo::PendingReceiver<device::mojom::blink::SerialPortClient>, mojo::PendingRemote<device::mojom::blink::SerialPort>);
    void OnGetSignals(ScriptPromiseResolver<SerialInputSignals>*, device::mojom::blink::SerialPortControlSignalsPtr);
    ...
    HeapMojoReceiver<device::mojom::blink::SerialPortClient, SerialPort> client_receiver_;
