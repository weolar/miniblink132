...
class SerialPortUnderlyingSource : public UnderlyingByteSourceBase, ExecutionContextLifecycleObserver {
    USING_PRE_FINALIZER(SerialPortUnderlyingSource, Dispose);

public:
    SerialPortUnderlyingSource(ScriptState*, SerialPort*, mojo::ScopedDataPipeConsumerHandle);
