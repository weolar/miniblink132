...
// source->Stop();
class MODULES_EXPORT PushableMediaStreamVideoSource : public MediaStreamVideoSource {
public:
    ...
    public:
        ...
        void PushFrame(scoped_refptr<media::VideoFrame> video_frame, base::TimeTicks estimated_capture_time);
        void StopSource();
        bool IsMuted();
        void SetMuted(bool);
    ...
    explicit PushableMediaStreamVideoSource(scoped_refptr<base::SingleThreadTaskRunner>);
