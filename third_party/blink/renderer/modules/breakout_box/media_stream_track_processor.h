...
public:
    static MediaStreamTrackProcessor* Create(ScriptState*, MediaStreamTrackProcessorInit*, ExceptionState&);
    static MediaStreamTrackProcessor* Create(ScriptState*, MediaStreamTrack*, uint16_t buffer_size, ExceptionState&);
    static MediaStreamTrackProcessor* Create(ScriptState*, MediaStreamTrack*, ExceptionState&);
    MediaStreamTrackProcessor(ScriptState*, MediaStreamTrack*, uint16_t buffer_size);
