...
public:
    static MediaStreamTrackGenerator* Create(ScriptState*, const String& kind, ExceptionState&);
    static MediaStreamTrackGenerator* Create(ScriptState*, MediaStreamTrackGeneratorInit* init, ExceptionState&);
    ...
    MediaStreamTrackGenerator& operator=(const MediaStreamTrackGenerator&) = delete;
...
private:
    ...
    static MediaStreamComponent* MakeMediaStreamComponent(ScriptState* script_state, MediaStreamSource::StreamType type);
