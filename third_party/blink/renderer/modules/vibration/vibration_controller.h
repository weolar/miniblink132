...
class MODULES_EXPORT VibrationController final : public GarbageCollected<VibrationController>,
...
public:
    ...
    static VibrationPattern SanitizeVibrationPattern(const V8UnionUnsignedLongOrUnsignedLongSequence* input);
    ...
    VibrationPattern Pattern() const
    {
        return pattern_;
    }
...
private:
    ...
    HeapMojoRemote<device::mojom::blink::VibrationManager, HeapMojoWrapperMode::kForceWithoutContextObserver> vibration_manager_;
