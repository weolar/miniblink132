...
class AIRewriterFactory final : public ScriptWrappable, public ExecutionContextClient {
...
public:
    ...
    ScriptPromise<AIRewriter> create(ScriptState* script_state, const AIRewriterCreateOptions* options, ExceptionState& exception_state);
