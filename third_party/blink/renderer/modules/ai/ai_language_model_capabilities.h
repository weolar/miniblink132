...
public:
    explicit AILanguageModelCapabilities(V8AICapabilityAvailability capability_availability);
    ...
    std::optional<uint64_t> defaultTopK() const
    {
        return default_top_k_;
    }
    std::optional<uint64_t> maxTopK() const
    {
        return max_top_k_;
    }
    ...
    void SetMaxTopK(uint64_t max_top_k)
    {
