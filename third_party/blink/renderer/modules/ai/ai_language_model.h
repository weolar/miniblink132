...
class AILanguageModel final : public EventTarget, public ExecutionContextClient {
    DEFINE_WRAPPERTYPEINFO();

public:
    AILanguageModel(ExecutionContext* execution_context, mojo::PendingRemote<mojom::blink::AIAssistant> pending_remote,
        scoped_refptr<base::SequencedTaskRunner> task_runner, mojom::blink::AIAssistantInfoPtr info, uint64_t current_tokens);
    ...
    ScriptPromise<IDLString> prompt(
    ...
    {
        return max_tokens_ - current_tokens_;
    }
    ...
    ScriptPromise<AILanguageModel> clone(ScriptState* script_state, const AILanguageModelCloneOptions* options, ExceptionState& exception_state);
    ...
    void SetInfo(std::variant<base::PassKey<AILanguageModelFactory>, base::PassKey<AILanguageModel>> pass_key, const mojom::blink::AIAssistantInfoPtr info);
...
private:
    void OnResponseComplete(mojom::blink::ModelExecutionContextInfoPtr context_info);
