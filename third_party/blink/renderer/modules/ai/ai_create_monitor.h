...
class AICreateMonitor final : public EventTarget, public ExecutionContextClient, public mojom::blink::ModelDownloadProgressObserver {
    DEFINE_WRAPPERTYPEINFO();

public:
    AICreateMonitor(ExecutionContext* context, scoped_refptr<base::SequencedTaskRunner> task_runner);
...
private:
    ...
    HeapMojoReceiver<mojom::blink::ModelDownloadProgressObserver, AICreateMonitor> receiver_;
};
