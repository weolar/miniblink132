...
class AIWriterFactory final : public ScriptWrappable, public ExecutionContextClient {
...
public:
    ...
    ScriptPromise<AIWriter> create(ScriptState* script_state, const AIWriterCreateOptions* options, ExceptionState& exception_state);
