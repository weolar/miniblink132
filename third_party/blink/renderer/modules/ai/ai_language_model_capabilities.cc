...
AILanguageModelCapabilities::AILanguageModelCapabilities(V8AICapabilityAvailability capability_availability)
...
V8AICapabilityAvailability AILanguageModelCapabilities::languageAvailable(WTF::String languageTag) const
{
