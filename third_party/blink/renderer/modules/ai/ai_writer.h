...
public:
    AIWriter(ExecutionContext* execution_context, scoped_refptr<base::SequencedTaskRunner> task_runner,
    ...
    ScriptPromise<IDLString> write(ScriptState* script_state, const String& input, const AIWriterWriteOptions* options, ExceptionState& exception_state);
    ReadableStream* writeStreaming(ScriptState* script_state, const String& input, const AIWriterWriteOptions* options, ExceptionState& exception_state);
