...
AISummarizerCapabilities::AISummarizerCapabilities(V8AICapabilityAvailability capability_availability)
...
V8AICapabilityAvailability AISummarizerCapabilities::languageAvailable(const WTF::String& language_tag)
{
