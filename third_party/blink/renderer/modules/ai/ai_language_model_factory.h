...
class AILanguageModelFactory final : public ScriptWrappable, public ExecutionContextClient {
...
public:
    ...
    ScriptPromise<AILanguageModel> create(ScriptState* script_state, const AILanguageModelCreateOptions* options, ExceptionState& exception_state);
    ScriptPromise<AILanguageModelCapabilities> capabilities(ScriptState* script_state, ExceptionState& exception_state);
...
private:
    ...
    void OnCanCreateSessionComplete(ScriptPromiseResolver<AILanguageModelCapabilities>* resolver, mojom::blink::ModelAvailabilityCheckResult check_result);
