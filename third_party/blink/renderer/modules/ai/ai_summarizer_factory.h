...
class AISummarizerFactory final : public ScriptWrappable, public ExecutionContextClient {
    DEFINE_WRAPPERTYPEINFO();

public:
    AISummarizerFactory(AI* ai, ExecutionContext* context, scoped_refptr<base::SequencedTaskRunner> task_runner);

    void Trace(Visitor* visitor) const override;

    // ai_summarizer_factory.idl implementation.
    ScriptPromise<AISummarizer> create(ScriptState* script_state, AISummarizerCreateOptions* options, ExceptionState& exception_state);
    ScriptPromise<AISummarizerCapabilities> capabilities(ScriptState* script_state, ExceptionState& exception_state);
