...
HandleAttachmentProvider::HandleAttachmentProvider(scoped_refptr<MediaSourceAttachment> attachment)
...
scoped_refptr<MediaSourceAttachment> HandleAttachmentProvider::TakeAttachment()
{
