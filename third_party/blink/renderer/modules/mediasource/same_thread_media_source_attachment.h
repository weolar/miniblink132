...
class SameThreadMediaSourceAttachment final : public MediaSourceAttachmentSupplement {
public:
    ...
    SameThreadMediaSourceAttachment(MediaSource* media_source, AttachmentCreationPassKeyProvider::PassKey);

    SameThreadMediaSourceAttachment(const SameThreadMediaSourceAttachment&) = delete;
    SameThreadMediaSourceAttachment& operator=(const SameThreadMediaSourceAttachment&) = delete;
    ...
    MediaSourceTracer* StartAttachingToMediaElement(HTMLMediaElement*, bool* success) final;
    void CompleteAttachingToMediaElement(MediaSourceTracer* tracer, std::unique_ptr<WebMediaSource>) final;
