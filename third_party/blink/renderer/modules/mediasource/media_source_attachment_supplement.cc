...
void MediaSourceAttachmentSupplement::AddMainThreadAudioTrackToMediaElement(
    String /* id */, String /* kind */, String /* label */, String /* language */, bool /* enabled */)
{
...
void MediaSourceAttachmentSupplement::AddMainThreadVideoTrackToMediaElement(
    String /* id */, String /* kind */, String /* label */, String /* language */, bool /* selected */)
{
    // TODO(https::/crbug.com/878133): Remove this once cross-thread
    // implementation supports creation of worker-thread tracks.
    NOTIMPLEMENTED();
...
bool MediaSourceAttachmentSupplement::RunExclusively(bool /* abort_if_not_fully_attached */, RunExclusivelyCB cb)
{
    std::move(cb).Run(ExclusiveKey());
    return true; // Indicates that we ran |cb|.
}

bool MediaSourceAttachmentSupplement::FullyAttachedOrSameThread(SourceBufferPassKey) const
{
    return true;
}

void MediaSourceAttachmentSupplement::AssertCrossThreadMutexIsAcquiredForDebugging()
{
    DCHECK(false) << "This should only be called on a CrossThreadMediaSourceAttachment";
}
...
// protected
MediaSourceAttachmentSupplement::ExclusiveKey MediaSourceAttachmentSupplement::GetExclusiveKey() const
{
    return ExclusiveKey();
}
