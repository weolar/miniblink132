...
public:
    ...
    MediaSourceAttachmentSupplement(const MediaSourceAttachmentSupplement&) = delete;
    MediaSourceAttachmentSupplement& operator=(const MediaSourceAttachmentSupplement&) = delete;
    ...
    virtual void NotifyDurationChanged(MediaSourceTracer* tracer, double duration) = 0;
    ...
    virtual void AddAudioTrackToMediaElement(MediaSourceTracer* tracer, AudioTrack* track) = 0;
    virtual void AddVideoTrackToMediaElement(MediaSourceTracer* tracer, VideoTrack* track) = 0;
    virtual void RemoveAudioTracksFromMediaElement(MediaSourceTracer* tracer, Vector<String> audio_ids, bool enqueue_change_event) = 0;
    virtual void RemoveVideoTracksFromMediaElement(MediaSourceTracer* tracer, Vector<String> video_ids, bool enqueue_change_event) = 0;
    ...
    virtual void AddMainThreadAudioTrackToMediaElement(String id, String kind, String label, String language, bool enabled);
    virtual void AddMainThreadVideoTrackToMediaElement(String id, String kind, String label, String language, bool selected);
    ...
    virtual bool RunExclusively(bool abort_if_not_fully_attached, RunExclusivelyCB cb);
