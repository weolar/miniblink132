...
// static
const char SourceBufferTrackBaseSupplement::kSupplementName[] = "SourceBufferTrackBaseSupplement";
...
SourceBufferTrackBaseSupplement::SourceBufferTrackBaseSupplement(TrackBase& track)
    : Supplement(track)
{
}

void SourceBufferTrackBaseSupplement::SetSourceBuffer(TrackBase& track, SourceBuffer* source_buffer)
{
