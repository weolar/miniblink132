...
public:
    ...
    static TrackDefault* Create(const V8TrackDefaultType& type, const String& language, const String& label, const Vector<String>& kinds,
        const String& byte_stream_track_id, ExceptionState&);

    TrackDefault(const V8TrackDefaultType& type, const String& language, const String& label, const Vector<String>& kinds, const String& byte_stream_track_id);
    ~TrackDefault() override;

    // Implement the IDL
    V8TrackDefaultType type() const
    {
        return type_;
    }
    String byteStreamTrackID() const
    {
