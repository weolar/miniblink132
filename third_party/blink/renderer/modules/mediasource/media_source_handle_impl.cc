...
MediaSourceHandleImpl::MediaSourceHandleImpl(scoped_refptr<HandleAttachmentProvider> attachment_provider, String internal_blob_url)
    ...
    , internal_blob_url_(internal_blob_url)
{
    ...
    DVLOG(1) << __func__ << " this=" << this << ", attachment_provider_=" << attachment_provider_ << ", internal_blob_url_=" << internal_blob_url_;
}
...
scoped_refptr<HandleAttachmentProvider> MediaSourceHandleImpl::TakeAttachmentProvider()
{
    DVLOG(1) << __func__ << " this=" << this;
...
scoped_refptr<MediaSourceAttachment> MediaSourceHandleImpl::TakeAttachment()
{
    ...
    scoped_refptr<MediaSourceAttachment> result = attachment_provider_->TakeAttachment();
