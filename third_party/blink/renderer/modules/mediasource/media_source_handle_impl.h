...
class MediaSourceHandleImpl final : public ScriptWrappable, public MediaSourceHandle {
    DEFINE_WRAPPERTYPEINFO();

public:
    explicit MediaSourceHandleImpl(scoped_refptr<HandleAttachmentProvider> attachment_provider, String internal_blob_url);
