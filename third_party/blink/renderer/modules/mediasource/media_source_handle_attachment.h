...
class MODULES_EXPORT MediaSourceHandleAttachment : public SerializedScriptValue::Attachment {
public:
    ...
    MediaSourceHandleVector& Attachments()
    {
        return attachments_;
    }

    const MediaSourceHandleVector& Attachments() const
    {
        return attachments_;
    }
