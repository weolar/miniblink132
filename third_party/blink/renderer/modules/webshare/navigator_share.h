...
class MODULES_EXPORT NavigatorShare final : public GarbageCollected<NavigatorShare>, public Supplement<Navigator> {
public:
    static const char kSupplementName[];

    NavigatorShare(Navigator& navigator)
    ...
    ScriptPromise<IDLUndefined> share(ScriptState*, const ShareData*, ExceptionState&);
    static ScriptPromise<IDLUndefined> share(ScriptState*, Navigator&, const ShareData*, ExceptionState&);
