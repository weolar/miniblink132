...
public:
    static USBEndpoint* Create(const USBAlternateInterface*, wtf_size_t endpoint_index);
    static USBEndpoint* Create(const USBAlternateInterface*, uint8_t endpoint_number, const V8USBDirection& direction, ExceptionState&);
