...
public:
    static USBInTransferResult* Create(const V8USBTransferStatus& status, base::span<const uint8_t> data)
    {
        DOMDataView* data_view = DOMDataView::Create(DOMArrayBuffer::Create(data), 0, data.size());
    ...
    static USBInTransferResult* Create(const V8USBTransferStatus& status, NotShared<DOMDataView> data)
    {
