...
public:
    ...
    // USB.idl
    ScriptPromise<IDLSequence<USBDevice>> getDevices(ScriptState*, ExceptionState&);
    ScriptPromise<USBDevice> requestDevice(ScriptState*, const USBDeviceRequestOptions*, ExceptionState&);
    ...
    void ForgetDevice(const String& device_guid, mojom::blink::WebUsbService::ForgetDeviceCallback callback);

    void OnGetDevices(ScriptPromiseResolver<IDLSequence<USBDevice>>*, Vector<device::mojom::blink::UsbDeviceInfoPtr>);
    void OnGetPermission(ScriptPromiseResolver<USBDevice>*, device::mojom::blink::UsbDeviceInfoPtr);
...
private:
    ...
    HeapHashSet<Member<ScriptPromiseResolver<IDLSequence<USBDevice>>>> get_devices_requests_;
    HeapHashSet<Member<ScriptPromiseResolverBase>> get_permission_requests_;
    HeapMojoAssociatedReceiver<device::mojom::blink::UsbDeviceManagerClient, USB> client_receiver_;
