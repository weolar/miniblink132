...
public:
    static USBAlternateInterface* Create(const USBInterface*, wtf_size_t alternate_index);
    static USBAlternateInterface* Create(const USBInterface*, uint8_t alternate_setting, ExceptionState&);
