...
public:
    static USBConfiguration* Create(const USBDevice*, wtf_size_t configuration_index);
    static USBConfiguration* Create(const USBDevice*, uint8_t configuration_value, ExceptionState&);
    ...
    {
        return Info().configuration_value;
    }
    String configurationName() const
    {
        return Info().configuration_name;
    }
