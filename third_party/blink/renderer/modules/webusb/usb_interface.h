...
public:
    static USBInterface* Create(const USBConfiguration*, wtf_size_t interface_index);
    static USBInterface* Create(const USBConfiguration*, uint8_t interface_number, ExceptionState&);

    USBInterface(const USBDevice*, wtf_size_t configuration_index, wtf_size_t interface_index);
