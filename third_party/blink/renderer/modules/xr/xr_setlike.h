...
template <typename InterfaceType, typename ElementType> class XRSetlike : public ValueSyncIterable<InterfaceType> {
public:
    unsigned size() const
    {
    ...
    bool hasForBinding(ScriptState* script_state, ElementType* element, ExceptionState& exception_state) const
    {
        DCHECK(element);
...
private:
    class IterationSource final : public ValueSyncIterable<InterfaceType>::IterationSource {
    public:
        ...
        bool FetchNextItem(ScriptState* script_state, ElementType*& value, ExceptionState& exception_state) override
        {
    ...
    XRSetlike::IterationSource* CreateIterationSource(ScriptState* script_state, ExceptionState& exception_state) override
    {
