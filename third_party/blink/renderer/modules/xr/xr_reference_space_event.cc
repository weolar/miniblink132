...
XRReferenceSpaceEvent::XRReferenceSpaceEvent(const AtomicString& type, XRReferenceSpace* reference_space)
    : Event(type, Bubbles::kNo, Cancelable::kYes)
    , reference_space_(reference_space)
{
}

XRReferenceSpaceEvent::XRReferenceSpaceEvent(const AtomicString& type, const XRReferenceSpaceEventInit* initializer)
