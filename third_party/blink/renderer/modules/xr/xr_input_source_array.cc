...
XRInputSource* XRInputSourceArray::AnonymousIndexedGetter(unsigned index) const
{
...
void XRInputSourceArray::SetWithSourceId(uint32_t source_id, XRInputSource* input_source)
{
