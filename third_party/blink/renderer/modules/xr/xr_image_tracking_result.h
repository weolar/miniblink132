...
public:
    explicit XRImageTrackingResult(XRSession* session, const device::mojom::blink::XRTrackedImageData& image_tracking_result);
    ...
    V8XRImageTrackingState trackingState()
    {
...
private:
    ...
    uint32_t index_;
    V8XRImageTrackingState tracking_state_ = V8XRImageTrackingState(V8XRImageTrackingState::Enum::kEmulated);
