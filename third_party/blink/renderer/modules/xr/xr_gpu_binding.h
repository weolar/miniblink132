...
public:
    ...
    static XRGPUBinding* Create(XRSession* session, GPUDevice* device, ExceptionState& exception_state);

    XRProjectionLayer* createProjectionLayer(const XRGPUProjectionLayerInit* init, ExceptionState& exception_state);

    XRGPUSubImage* getViewSubImage(XRProjectionLayer* layer, XRView* view, ExceptionState& exception_state);
    ...
    gfx::Rect GetViewportForEye(XRProjectionLayer* layer, device::mojom::blink::XREye eye);
