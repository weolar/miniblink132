...
XRInputSourceEvent::XRInputSourceEvent(const AtomicString& type, XRFrame* frame, XRInputSource* input_source)
...
XRInputSourceEvent::XRInputSourceEvent(const AtomicString& type, const XRInputSourceEventInit* initializer)
