...
XRGPUProjectionLayer::XRGPUProjectionLayer(XRGPUBinding* binding, XRGPUSwapChain* color_swap_chain, XRGPUSwapChain* depth_stencil_swap_chain)
...
void XRGPUProjectionLayer::OnFrameEnd()
{
    ...
    session()->xr()->frameProvider()->SubmitWebGPULayer(this, color_swap_chain_->texture_was_queried());
}
