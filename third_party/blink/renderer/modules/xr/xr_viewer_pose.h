...
public:
    explicit XRViewerPose(XRFrame*, const gfx::Transform& ref_space_from_mojo, const gfx::Transform& ref_space_from_viewer, bool emulated_position);
    ~XRViewerPose() override = default;

    const FrozenArray<XRView>& views() const
    {
        return *views_.Get();
    }
