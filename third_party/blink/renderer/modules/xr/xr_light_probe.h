...
public:
    ...
    enum XRReflectionFormat { kReflectionFormatSRGBA8 = 0, kReflectionFormatRGBA16F = 1 };
    ...
    void ProcessLightEstimationData(const device::mojom::blink::XRLightEstimationData* data, double timestamp);

    XRLightEstimate* getLightEstimate()
    {
        return light_estimate_.Get();
    }
    XRCubeMap* getReflectionCubeMap()
    {
