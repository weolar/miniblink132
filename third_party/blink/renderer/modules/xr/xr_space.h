...
public:
    ...
    // Returns nullopt if computing a transform is not possible.
    virtual std::optional<gfx::Transform> NativeFromViewer(const std::optional<gfx::Transform>& mojo_from_viewer) const;
    ...
    virtual device::mojom::blink::XRNativeOriginInformationPtr NativeOrigin() const = 0;
