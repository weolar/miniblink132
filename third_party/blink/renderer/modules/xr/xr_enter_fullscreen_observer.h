...
public:
    ...
    XrEnterFullscreenObserver& operator=(const XrEnterFullscreenObserver&) = delete;
    ...
    void RequestFullscreen(Element* element, bool setup_for_dom_overlay, bool may_have_camera_access, base::OnceCallback<void(bool)> on_completed);
