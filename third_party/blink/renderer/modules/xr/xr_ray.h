...
public:
    ...
    XRRay(DOMPointInit* origin, XRRayDirectionInit* direction, ExceptionState& exception_state);
    ~XRRay() override;
    ...
    static XRRay* Create(DOMPointInit* origin, XRRayDirectionInit* direction, ExceptionState& exception_state);
    static XRRay* Create(XRRigidTransform* transform, ExceptionState& exception_state);

    void Trace(Visitor*) const override;

private:
    void Set(const gfx::Transform& matrix, ExceptionState& exception_state);
    void Set(gfx::Point3F origin, gfx::Vector3dF direction, ExceptionState& exception_state);
