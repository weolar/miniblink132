...
public:
    ...
    static XRSessionEvent* Create(const AtomicString& type, const XRSessionEventInit* initializer)
    {
    ...
    XRSessionEvent(const AtomicString& type, XRSession*, Event::Bubbles, Event::Cancelable, Event::ComposedMode);
