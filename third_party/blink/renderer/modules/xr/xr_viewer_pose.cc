...
XRViewerPose::XRViewerPose(XRFrame* frame, const gfx::Transform& ref_space_from_mojo, const gfx::Transform& ref_space_from_viewer, bool emulated_position)
    : XRPose(ref_space_from_viewer, emulated_position)
{
    ...
    for (XRViewData* view : view_data) {
        views.push_back(MakeGarbageCollected<XRView>(frame, view, ref_space_from_mojo));
    }
