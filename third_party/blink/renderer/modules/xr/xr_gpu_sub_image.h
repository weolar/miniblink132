...
public:
    XRGPUSubImage(const gfx::Rect& viewport, wtf_size_t layer, GPUTexture* color_texture, GPUTexture* depth_stencil_texture)
        : XRSubImage(viewport)
        , layer_(layer)
    ...
    {
        GPUTextureViewDescriptor* view_descriptor = GPUTextureViewDescriptor::Create();
