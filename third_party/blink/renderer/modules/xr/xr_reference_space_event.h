...
public:
    ...
    static XRReferenceSpaceEvent* Create(const AtomicString& type, XRReferenceSpace* reference_space)
    {
        return MakeGarbageCollected<XRReferenceSpaceEvent>(type, reference_space);
    }
    static XRReferenceSpaceEvent* Create(const AtomicString& type, const XRReferenceSpaceEventInit* initializer)
    {
    ...
    XRReferenceSpaceEvent(const AtomicString& type, const XRReferenceSpaceEventInit*);
