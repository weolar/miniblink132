...
public:
    ...
    void Reset();
    void SetLayerSharedImages(XRLayer*, const scoped_refptr<gpu::ClientSharedImage>& color_shared_image, const gpu::SyncToken& color_sync_token,
        const scoped_refptr<gpu::ClientSharedImage>& camera_image_shared_image, const gpu::SyncToken& camera_image_sync_token);
