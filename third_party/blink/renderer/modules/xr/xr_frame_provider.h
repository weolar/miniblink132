...
public:
    ...
    XRSession* immersive_session() const
    {
        return immersive_session_.Get();
    }

    void OnSessionStarted(XRSession* session, device::mojom::blink::XRSessionPtr session_ptr);
...
private:
    ...
    void OnNonImmersiveFrameData(XRSession* session, device::mojom::blink::XRFrameDataPtr data);
    ...
    void ScheduleImmersiveFrame(device::mojom::blink::XRFrameDataRequestOptionsPtr options);
    ...
    // session.
    void ScheduleNonImmersiveFrame(device::mojom::blink::XRFrameDataRequestOptionsPtr options);
    ...
    void ProcessScheduledFrame(device::mojom::blink::XRFrameDataPtr frame_data, double high_res_now_ms, ScheduledFrameType type);
    ...
    double UpdateImmersiveFrameTime(LocalDOMWindow* window, const device::mojom::blink::XRFrameData& data);
    ...
    HeapMojoRemote<device::mojom::blink::XRFrameDataProvider> immersive_data_provider_;
    HeapMojoRemote<device::mojom::blink::XRPresentationProvider> immersive_presentation_provider_;
    ...
    HeapHashMap<Member<XRSession>, Member<DisallowNewWrapper<HeapMojoRemote<device::mojom::blink::XRFrameDataProvider>>>> non_immersive_data_providers_;
    HeapHashMap<Member<XRSession>, device::mojom::blink::XRFrameDataPtr> requesting_sessions_;
