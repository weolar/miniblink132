...
public:
    static ScriptPromise<IDLUndefined> setDevicePostureOverride(ScriptState* script_state, Internals&, V8DevicePostureType posture);

    static ScriptPromise<IDLUndefined> clearDevicePostureOverride(ScriptState* script_state, Internals&);
};
