...
class MODULES_EXPORT DevicePosture : public EventTarget, public ExecutionContextClient, public mojom::blink::DevicePostureClient {
...
private:
    ...
    mojom::blink::DevicePostureType posture_ = mojom::blink::DevicePostureType::kContinuous;
