...
EncodedVideoChunk* EncodedVideoChunk::Create(ScriptState* script_state, const EncodedVideoChunkInit* init, ExceptionState& exception_state)
{
...
{
    return V8EncodedVideoChunkType(buffer_->is_key_frame() ? V8EncodedVideoChunkType::Enum::kKey : V8EncodedVideoChunkType::Enum::kDelta);
}
...
void EncodedVideoChunk::copyTo(const AllowSharedBufferSource* destination, ExceptionState& exception_state)
{
