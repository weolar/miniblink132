...
class MODULES_EXPORT VideoFrameAttachment : public SerializedScriptValue::Attachment {
public:
    ...
    size_t size() const
    {
        return frame_handles_.size();
    }

    Vector<scoped_refptr<VideoFrameHandle>>& Handles()
    {
