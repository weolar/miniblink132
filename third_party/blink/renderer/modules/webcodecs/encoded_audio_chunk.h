...
public:
    ...
    static EncodedAudioChunk* Create(ScriptState* script_state, const EncodedAudioChunkInit* init, ExceptionState& exception_state);
    ...
    void copyTo(const AllowSharedBufferSource* destination, ExceptionState& exception_state);

    scoped_refptr<media::DecoderBuffer> buffer() const
    {
        return buffer_;
    }
