...
class MODULES_EXPORT CodecPressureManagerProvider : public GarbageCollected<CodecPressureManagerProvider>, public Supplement<ExecutionContext> {
public:
    ...
    CodecPressureManagerProvider& operator=(const CodecPressureManagerProvider&) = delete;
