...
template <typename Traits> class MODULES_EXPORT EncoderBase : public EventTarget, public ActiveScriptWrappable<EncoderBase<Traits>>, public ReclaimableCodec {
public:
    ...
    void encode(InputType* input, const EncodeOptionsType* opts, ExceptionState& exception_state);
...
protected:
    ...
    virtual bool CanReconfigure(InternalConfigType& original_config, InternalConfigType& new_config) = 0;
    virtual InternalConfigType* ParseConfig(const ConfigType*, ExceptionState&) = 0;
    virtual bool VerifyCodecSupport(InternalConfigType*, String* js_error_message) = 0;
