...
VideoColorSpace::VideoColorSpace(const gfx::ColorSpace& color_space)
{
    ...
    case gfx::ColorSpace::PrimaryID::SMPTE170M:
        primaries_ = V8VideoColorPrimaries(V8VideoColorPrimaries::Enum::kSmpte170M);
        break;
    case gfx::ColorSpace::PrimaryID::BT2020:
        primaries_ = V8VideoColorPrimaries(V8VideoColorPrimaries::Enum::kBt2020);
        break;
    case gfx::ColorSpace::PrimaryID::P3:
        primaries_ = V8VideoColorPrimaries(V8VideoColorPrimaries::Enum::kSmpte432);
        break;
    default:
    ...
    case gfx::ColorSpace::TransferID::BT709_APPLE:
        transfer_ = V8VideoTransferCharacteristics(V8VideoTransferCharacteristics::Enum::kBt709);
        break;
    case gfx::ColorSpace::TransferID::SMPTE170M:
        transfer_ = V8VideoTransferCharacteristics(V8VideoTransferCharacteristics::Enum::kSmpte170M);
        break;
    case gfx::ColorSpace::TransferID::SRGB:
        transfer_ = V8VideoTransferCharacteristics(V8VideoTransferCharacteristics::Enum::kIec6196621);
        break;
    case gfx::ColorSpace::TransferID::LINEAR:
        transfer_ = V8VideoTransferCharacteristics(V8VideoTransferCharacteristics::Enum::kLinear);
        break;
    case gfx::ColorSpace::TransferID::PQ:
        transfer_ = V8VideoTransferCharacteristics(V8VideoTransferCharacteristics::Enum::kPq);
        break;
    case gfx::ColorSpace::TransferID::HLG:
        transfer_ = V8VideoTransferCharacteristics(V8VideoTransferCharacteristics::Enum::kHlg);
        break;
    default:
        // Other values map to unspecified for now.
        break;
    ...
    case gfx::ColorSpace::MatrixID::RGB:
        matrix_ = V8VideoMatrixCoefficients(V8VideoMatrixCoefficients::Enum::kRgb);
        break;
    case gfx::ColorSpace::MatrixID::BT709:
        matrix_ = V8VideoMatrixCoefficients(V8VideoMatrixCoefficients::Enum::kBt709);
        break;
    case gfx::ColorSpace::MatrixID::BT470BG:
        matrix_ = V8VideoMatrixCoefficients(V8VideoMatrixCoefficients::Enum::kBt470Bg);
        break;
    case gfx::ColorSpace::MatrixID::SMPTE170M:
        matrix_ = V8VideoMatrixCoefficients(V8VideoMatrixCoefficients::Enum::kSmpte170M);
        break;
    case gfx::ColorSpace::MatrixID::BT2020_NCL:
        matrix_ = V8VideoMatrixCoefficients(V8VideoMatrixCoefficients::Enum::kBt2020Ncl);
        break;
    default:
        // Other values map to unspecified for now.
        break;
...
gfx::ColorSpace VideoColorSpace::ToGfxColorSpace() const
{
    ...
    if (full_range_) {
        range = *full_range_ ? gfx::ColorSpace::RangeID::FULL : gfx::ColorSpace::RangeID::LIMITED;
    }
...
{
    media::VideoColorSpace::PrimaryID primaries = media::VideoColorSpace::PrimaryID::UNSPECIFIED;
    if (primaries_) {
        switch (primaries_->AsEnum()) {
        case V8VideoColorPrimaries::Enum::kBt709:
    ...
    media::VideoColorSpace::TransferID transfer = media::VideoColorSpace::TransferID::UNSPECIFIED;
    if (transfer_) {
        switch (transfer_->AsEnum()) {
        case V8VideoTransferCharacteristics::Enum::kBt709:
    ...
    media::VideoColorSpace::MatrixID matrix = media::VideoColorSpace::MatrixID::UNSPECIFIED;
    if (matrix_) {
        switch (matrix_->AsEnum()) {
        case V8VideoMatrixCoefficients::Enum::kRgb:
