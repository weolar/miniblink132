...
public:
    ...
    ImageDecoderCore(String mime_type, scoped_refptr<SegmentReader> data, bool data_complete, ColorBehavior color_behavior, const SkISize& desired_size,
    ...
    std::unique_ptr<ImageDecodeResult> Decode(uint32_t frame_index, bool complete_frames_only, const base::AtomicFlag* abort_flag);
...
private:
    ...
    HashMap<uint32_t, uint32_t, IntWithZeroKeyHashTraits<uint32_t>> incomplete_frames_;
