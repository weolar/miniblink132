...
struct ParsedVideoFrameInit {
    ParsedVideoFrameInit(const VideoFrameInit* init, media::VideoPixelFormat format, const gfx::Size& coded_size, const gfx::Rect& default_visible_rect,
        const gfx::Size& default_display_size, ExceptionState& exception_state);
