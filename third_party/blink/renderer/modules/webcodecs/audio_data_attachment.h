...
class MODULES_EXPORT AudioDataAttachment : public SerializedScriptValue::Attachment {
public:
    ...
    size_t size() const
    {
        return audio_buffers_.size();
    }

    AudioBufferVector& AudioBuffers()
    {
        return audio_buffers_;
    }

    const AudioBufferVector& AudioBuffers() const
    {
        return audio_buffers_;
    }
