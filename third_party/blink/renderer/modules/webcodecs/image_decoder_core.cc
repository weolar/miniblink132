...
media::VideoPixelFormat YUVSubsamplingToMediaPixelFormat(cc::YUVSubsampling sampling, int depth)
{
...
std::pair<gfx::ColorSpace::PrimaryID, gfx::ColorSpace::TransferID> GuessPrimaryAndTransfer(SkYUVColorSpace yuv_cs)
{
    switch (yuv_cs) {
    case kJPEG_Full_SkYUVColorSpace:
        return { gfx::ColorSpace::PrimaryID::BT709, gfx::ColorSpace::TransferID::SRGB };
    case kFCC_Full_SkYUVColorSpace:
    case kFCC_Limited_SkYUVColorSpace:
    case kRec601_Limited_SkYUVColorSpace:
        return { gfx::ColorSpace::PrimaryID::SMPTE170M, gfx::ColorSpace::TransferID::SMPTE170M };
    ...
    case kYCgCo_16bit_Limited_SkYUVColorSpace:
        return { gfx::ColorSpace::PrimaryID::BT709, gfx::ColorSpace::TransferID::BT709 };
    ...
    case kBT2020_10bit_Limited_SkYUVColorSpace:
        return { gfx::ColorSpace::PrimaryID::BT2020, gfx::ColorSpace::TransferID::BT2020_10 };
    ...
    case kBT2020_16bit_Limited_SkYUVColorSpace:
        return { gfx::ColorSpace::PrimaryID::BT2020, gfx::ColorSpace::TransferID::BT2020_12 };
    case kSMPTE240_Full_SkYUVColorSpace:
    case kSMPTE240_Limited_SkYUVColorSpace:
        return { gfx::ColorSpace::PrimaryID::SMPTE240M, gfx::ColorSpace::TransferID::SMPTE240M };
...
gfx::ColorSpace YUVColorSpaceToGfxColorSpace(SkYUVColorSpace yuv_cs, const gfx::ColorSpace& gfx_cs)
{
    ...
    switch (yuv_cs) {
    case kJPEG_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::SMPTE170M, gfx::ColorSpace::RangeID::FULL);
    case kRec601_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::SMPTE170M, gfx::ColorSpace::RangeID::LIMITED);
    case kRec709_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::BT709, gfx::ColorSpace::RangeID::FULL);
    case kRec709_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::BT709, gfx::ColorSpace::RangeID::LIMITED);
    case kBT2020_8bit_Full_SkYUVColorSpace:
    case kBT2020_10bit_Full_SkYUVColorSpace:
    case kBT2020_12bit_Full_SkYUVColorSpace:
    case kBT2020_16bit_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::BT2020_NCL, gfx::ColorSpace::RangeID::FULL);
    case kBT2020_8bit_Limited_SkYUVColorSpace:
    case kBT2020_10bit_Limited_SkYUVColorSpace:
    case kBT2020_12bit_Limited_SkYUVColorSpace:
    case kBT2020_16bit_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::BT2020_NCL, gfx::ColorSpace::RangeID::LIMITED);
    case kFCC_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::FCC, gfx::ColorSpace::RangeID::FULL);
    case kFCC_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::FCC, gfx::ColorSpace::RangeID::LIMITED);
    case kSMPTE240_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::SMPTE240M, gfx::ColorSpace::RangeID::FULL);
    case kSMPTE240_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::SMPTE240M, gfx::ColorSpace::RangeID::LIMITED);
    case kYDZDX_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::YDZDX, gfx::ColorSpace::RangeID::FULL);
    case kYDZDX_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::YDZDX, gfx::ColorSpace::RangeID::LIMITED);
    case kGBR_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::GBR, gfx::ColorSpace::RangeID::FULL);
    case kGBR_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::GBR, gfx::ColorSpace::RangeID::LIMITED);
    case kYCgCo_8bit_Full_SkYUVColorSpace:
    case kYCgCo_10bit_Full_SkYUVColorSpace:
    case kYCgCo_12bit_Full_SkYUVColorSpace:
    case kYCgCo_16bit_Full_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::YCOCG, gfx::ColorSpace::RangeID::FULL);
    case kYCgCo_8bit_Limited_SkYUVColorSpace:
    case kYCgCo_10bit_Limited_SkYUVColorSpace:
    case kYCgCo_12bit_Limited_SkYUVColorSpace:
    case kYCgCo_16bit_Limited_SkYUVColorSpace:
        return gfx::ColorSpace(primary_id, transfer_id, gfx::ColorSpace::MatrixID::YCOCG, gfx::ColorSpace::RangeID::LIMITED);
    case kIdentity_SkYUVColorSpace:
        NOTREACHED();
    };
}
...
ImageDecoderCore::ImageDecoderCore(String mime_type, scoped_refptr<SegmentReader> data, bool data_complete, ColorBehavior color_behavior,
    const SkISize& desired_size, ImageDecoder::AnimationOption animation_option)
    ...
    , segment_reader_(std::move(data))
{
    ...
    base::UmaHistogramEnumeration("Blink.WebCodecs.ImageDecoder.Type", BitmapImageMetrics::StringToDecodedImageType(decoder_->FilenameExtension()));
}
...
ImageDecoderCore::ImageMetadata ImageDecoderCore::DecodeMetadata()
{
    ...
    metadata.image_has_both_still_and_animated_sub_images = decoder_->ImageHasBothStillAndAnimatedSubImages();
...
std::unique_ptr<ImageDecoderCore::ImageDecodeResult> ImageDecoderCore::Decode(
    uint32_t frame_index, bool complete_frames_only, const base::AtomicFlag* abort_flag)
{
    DCHECK(decoder_);
    ...
    if (decoder_->CanDecodeToYUV() && !have_completed_rgb_decode_ && frame_index == 0u) {
    ...
    if (image->GetStatus() == ImageFrame::kFrameEmpty || image->GetStatus() == ImageFrame::kFrameInitialized) {
        result->status = Status::kNoImage;
        return result;
    }
    ...
    auto sk_image = is_complete ? image->FinalizePixelsAndGetImage() : SkImages::RasterFromBitmap(image->Bitmap());
    if (!sk_image) {
    ...
    auto frame = media::CreateFromSkImage(sk_image, gfx::Rect(coded_size), coded_size, GetTimestampForFrame(frame_index));
    if (!frame) {
        result->status = Status::kDecodeError;
        return result;
    }
    ...
    frame->metadata().transformation = ImageOrientationToVideoTransformation(decoder_->Orientation());

    // Only animated images have frame durations.
    if (decoder_->FrameCount() > 1 || decoder_->RepetitionCount() != kAnimationNone) {
        frame->metadata().frame_duration = decoder_->FrameDurationAtIndex(frame_index);
    }

    if (is_decoding_in_order_) {
        // Stop aggressive purging when out of order decoding is detected.
        if (last_decoded_frame_ != frame_index && ((last_decoded_frame_ + 1) % decoder_->FrameCount()) != frame_index) {
...
void ImageDecoderCore::Reinitialize(ImageDecoder::AnimationOption animation_option)
{
    Clear();
    animation_option_ = animation_option;
    decoder_ = ImageDecoder::CreateByMimeType(mime_type_, segment_reader_, data_complete_, ImageDecoder::kAlphaNotPremultiplied,
        ImageDecoder::HighBitDepthDecodingOption::kDefaultBitDepth, color_behavior_, cc::AuxImage::kDefault, Platform::GetMaxDecodedImageBytes(), desired_size_,
        animation_option_);
    DCHECK(decoder_);
}

bool ImageDecoderCore::FrameIsDecodedAtIndexForTesting(uint32_t frame_index) const
{
...
void ImageDecoderCore::MaybeDecodeToYuv()
{
    ...
    const auto format = YUVSubsamplingToMediaPixelFormat(decoder_->GetYUVSubsampling(), decoder_->GetYUVBitDepth());
    ...
    if (!yuv_frame_) {
        ...
        auto layout = media::VideoFrameLayout::CreateWithStrides(format, coded_size,
            { static_cast<int32_t>(decoder_->DecodedYUVWidthBytes(cc::YUVIndex::kY)), static_cast<int32_t>(decoder_->DecodedYUVWidthBytes(cc::YUVIndex::kU)),
                static_cast<int32_t>(decoder_->DecodedYUVWidthBytes(cc::YUVIndex::kV)) });
        if (!layout)
            return;

        yuv_frame_ = media::VideoFrame::CreateFrameWithLayout(*layout, gfx::Rect(coded_size), coded_size, media::kNoTimestamp,
            /*zero_initialize_memory=*/false);
        if (!yuv_frame_)
            return;
    }

    void* planes[cc::kNumYUVPlanes] = { yuv_frame_->writable_data(0), yuv_frame_->writable_data(1), yuv_frame_->writable_data(2) };
    wtf_size_t row_bytes[cc::kNumYUVPlanes]
        = { static_cast<wtf_size_t>(yuv_frame_->stride(0)), static_cast<wtf_size_t>(yuv_frame_->stride(1)), static_cast<wtf_size_t>(yuv_frame_->stride(2)) };

    // TODO(crbug.com/1073995): Add support for high bit depth format.
    const auto color_type = kGray_8_SkColorType;

    auto image_planes = std::make_unique<ImagePlanes>(planes, row_bytes, color_type);
    ...
    yuv_frame_->metadata().transformation = ImageOrientationToVideoTransformation(decoder_->Orientation());
...
base::TimeDelta ImageDecoderCore::GetTimestampForFrame(uint32_t index) const
{
    ...
    for (auto i = old_size; i < timestamp_cache_.size(); ++i) {
        timestamp_cache_[i] = timestamp_cache_[i - 1] + decoder_->FrameDurationAtIndex(i - 1);
    }
