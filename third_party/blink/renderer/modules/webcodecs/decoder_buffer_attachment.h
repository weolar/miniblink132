...
class MODULES_EXPORT DecoderBufferAttachment : public SerializedScriptValue::Attachment {
public:
    ...
    DecoderBufferVector& Buffers()
    {
        return buffers_;
    }

    const DecoderBufferVector& Buffers() const
    {
        return buffers_;
    }
