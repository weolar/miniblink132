...
class MODULES_EXPORT AudioDecoderBroker : public media::AudioDecoder, public CrossThreadAudioDecoderClient {
public:
    explicit AudioDecoderBroker(media::MediaLog* media_log, ExecutionContext& execution_context);
