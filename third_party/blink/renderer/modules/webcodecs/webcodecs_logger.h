...
class MODULES_EXPORT WebCodecsLogger : public GarbageCollected<WebCodecsLogger>, public Supplement<ExecutionContext> {
public:
    ...
    class VideoFrameCloseAuditor : public WTF::ThreadSafeRefCounted<VideoFrameCloseAuditor> {
    public:
        ...
        {
            return were_frames_not_closed_;
        }
