...
class MojoFileSystemAccess final : public GarbageCollected<MojoFileSystemAccess>, public Supplement<Mojo> {
public:
    ...
    static MojoHandle* getFileSystemAccessTransferToken(FileSystemFileHandle* fs_handle);
