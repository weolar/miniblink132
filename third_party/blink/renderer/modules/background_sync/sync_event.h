...
public:
    static SyncEvent* Create(const AtomicString& type, const String& tag, bool last_chance, WaitUntilObserver* observer)
    {
    ...
    SyncEvent(const AtomicString& type, const String& tag, bool last_chance, WaitUntilObserver* observer);
