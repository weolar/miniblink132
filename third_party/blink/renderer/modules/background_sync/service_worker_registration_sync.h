...
class ServiceWorkerRegistrationSync final : public GarbageCollected<ServiceWorkerRegistrationSync>, public Supplement<ServiceWorkerRegistration> {
public:
    static const char kSupplementName[];

    static ServiceWorkerRegistrationSync& From(ServiceWorkerRegistration& registration);

    static PeriodicSyncManager* periodicSync(ServiceWorkerRegistration& registration);
    static SyncManager* sync(ServiceWorkerRegistration& registration);

    explicit ServiceWorkerRegistrationSync(ServiceWorkerRegistration* registration);

    ServiceWorkerRegistrationSync(const ServiceWorkerRegistrationSync&) = delete;
    ServiceWorkerRegistrationSync& operator=(const ServiceWorkerRegistrationSync&) = delete;
