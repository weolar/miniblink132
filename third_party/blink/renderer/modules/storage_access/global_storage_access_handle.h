...
class GlobalStorageAccessHandle final : public GarbageCollected<GlobalStorageAccessHandle>, public Supplement<LocalDOMWindow> {
public:
    static const char kSupplementName[];

    static GlobalStorageAccessHandle& From(LocalDOMWindow& window);

    explicit GlobalStorageAccessHandle(base::PassKey<GlobalStorageAccessHandle>, LocalDOMWindow& window)
...
//         , shared_worker_connector_(window.GetExecutionContext())
    ...
    HeapMojoAssociatedRemote<mojom::blink::BroadcastChannelProvider>& GetBroadcastChannelProvider();
    HeapMojoRemote<mojom::blink::SharedWorkerConnector>& GetSharedWorkerConnector();
...
//     HeapMojoAssociatedRemote<mojom::blink::BroadcastChannelProvider> broadcast_channel_provider_;
