...
// static
CookieDeprecationLabel* CookieDeprecationLabel::cookieDeprecationLabel(Navigator& navigator)
{
    auto* supplement = Supplement<Navigator>::From<CookieDeprecationLabel>(navigator);
    if (!supplement) {
...
ScriptPromise<IDLString> CookieDeprecationLabel::getValue(ScriptState* script_state)
{
    String label;
