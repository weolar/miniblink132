...
WakeLockManager* MakeManager(WakeLockTestingContext& context, V8WakeLockType::Enum type)
{
...
TEST(WakeLockManagerTest, AcquireWakeLock)
{
    ...
    auto* resolver1 = MakeGarbageCollected<ScriptPromiseResolver<WakeLockSentinel>>(context.GetScriptState());
    auto promise1 = resolver1->Promise();
    auto* resolver2 = MakeGarbageCollected<ScriptPromiseResolver<WakeLockSentinel>>(context.GetScriptState());
    ...
    auto* sentinel1 = ScriptPromiseUtils::GetPromiseResolutionAsWakeLockSentinel(context.GetScriptState()->GetIsolate(), promise1);
    auto* sentinel2 = ScriptPromiseUtils::GetPromiseResolutionAsWakeLockSentinel(context.GetScriptState()->GetIsolate(), promise2);
