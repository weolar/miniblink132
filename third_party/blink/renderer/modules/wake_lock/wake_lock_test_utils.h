...
private:
    ...
    void AddClient(mojo::PendingReceiver<device::mojom::blink::WakeLock>) override;
    void ChangeType(device::mojom::blink::WakeLockType, ChangeTypeCallback) override;
...
private:
    ...
    void GetWakeLock(device::mojom::blink::WakeLockType type, device::mojom::blink::WakeLockReason reason, const String& description,
...
public:
    ...
    void SetPermissionResponse(V8WakeLockType::Enum, mojom::blink::PermissionStatus);

    void WaitForPermissionRequest(V8WakeLockType::Enum);

private:
    bool GetWakeLockTypeFromDescriptor(const mojom::blink::PermissionDescriptorPtr& descriptor, V8WakeLockType::Enum* output);

    // mojom::blink::PermissionService implementation
    void HasPermission(mojom::blink::PermissionDescriptorPtr permission, HasPermissionCallback) override;
    void RegisterPageEmbeddedPermissionControl(
        Vector<mojom::blink::PermissionDescriptorPtr> permissions, mojo::PendingRemote<mojom::blink::EmbeddedPermissionControlClient> client) override;
    void RequestPageEmbeddedPermission(mojom::blink::EmbeddedPermissionRequestDescriptorPtr permissions, RequestPageEmbeddedPermissionCallback) override;
    void RequestPermission(mojom::blink::PermissionDescriptorPtr permission, bool user_gesture, RequestPermissionCallback) override;
    void RequestPermissions(Vector<mojom::blink::PermissionDescriptorPtr> permissions, bool user_gesture, RequestPermissionsCallback) override;
    void RevokePermission(mojom::blink::PermissionDescriptorPtr permission, RevokePermissionCallback) override;
    void AddPermissionObserver(mojom::blink::PermissionDescriptorPtr permission, mojom::blink::PermissionStatus last_known_status,
        mojo::PendingRemote<mojom::blink::PermissionObserver>) override;
    void AddPageEmbeddedPermissionObserver(mojom::blink::PermissionDescriptorPtr permission, mojom::blink::PermissionStatus last_known_status,
        mojo::PendingRemote<mojom::blink::PermissionObserver>) override;
    void NotifyEventListener(mojom::blink::PermissionDescriptorPtr permission, const String& event_type, bool is_added) override;

    void OnConnectionError();

    mojo::Receiver<mojom::blink::PermissionService> receiver_ { this };

    std::optional<mojom::blink::PermissionStatus> permission_responses_[V8WakeLockType::kEnumSize];
...
public:
    ...
    static v8::Promise::PromiseState GetPromiseState(const ScriptPromise<WakeLockSentinel>& promise);
    ...
    static DOMException* GetPromiseResolutionAsDOMException(v8::Isolate*, const ScriptPromise<WakeLockSentinel>&);
    ...
    // conversion fails, nullptr is returned.
    static WakeLockSentinel* GetPromiseResolutionAsWakeLockSentinel(v8::Isolate*, const ScriptPromise<WakeLockSentinel>&);
};
