...
public:
    ...
    ScriptPromise<WakeLockSentinel> request(ScriptState*, V8WakeLockType type, ExceptionState& exception_state);
...
private:
    ...
    // lot easier.
    void DoRequest(V8WakeLockType::Enum, ScriptPromiseResolver<WakeLockSentinel>*);

    void DidReceivePermissionResponse(V8WakeLockType::Enum, ScriptPromiseResolver<WakeLockSentinel>*, mojom::blink::PermissionStatus);
    ...
    FRIEND_TEST_ALL_PREFIXES(WakeLockTest, PageVisibilityHiddenBeforeLockAcquisition);
};
