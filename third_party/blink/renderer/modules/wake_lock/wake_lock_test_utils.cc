...
class ClosureOnResolve final : public ThenCallable<WakeLockSentinel, ClosureOnResolve> {
public:
...
V8WakeLockType::Enum ToBlinkWakeLockType(device::mojom::blink::WakeLockType type)
{
    switch (type) {
...
void MockWakeLock::Bind(mojo::PendingReceiver<device::mojom::blink::WakeLock> receiver)
{
    DCHECK(!receiver_.is_bound());
    receiver_.Bind(std::move(receiver));
    receiver_.set_disconnect_handler(WTF::BindOnce(&MockWakeLock::OnConnectionError, WTF::Unretained(this)));
}
...
void MockWakeLock::AddClient(mojo::PendingReceiver<device::mojom::blink::WakeLock>)
{
}
void MockWakeLock::ChangeType(device::mojom::blink::WakeLockType, ChangeTypeCallback)
{
}
...
{
    receivers_.Add(this, mojo::PendingReceiver<mojom::blink::WakeLockService>(std::move(handle)));
}
...
void MockWakeLockService::GetWakeLock(device::mojom::blink::WakeLockType type, device::mojom::blink::WakeLockReason reason, const String& description,
...
{
    DCHECK(!receiver_.is_bound());
    receiver_.Bind(mojo::PendingReceiver<mojom::blink::PermissionService>(std::move(handle)));
    receiver_.set_disconnect_handler(WTF::BindOnce(&MockPermissionService::OnConnectionError, WTF::Unretained(this)));
}

void MockPermissionService::SetPermissionResponse(V8WakeLockType::Enum type, mojom::blink::PermissionStatus status)
{
    DCHECK(status == mojom::blink::PermissionStatus::GRANTED || status == mojom::blink::PermissionStatus::DENIED);
...
bool MockPermissionService::GetWakeLockTypeFromDescriptor(const PermissionDescriptorPtr& descriptor, V8WakeLockType::Enum* output)
{
...
void MockPermissionService::WaitForPermissionRequest(V8WakeLockType::Enum type)
{
    size_t pos = static_cast<size_t>(type);
...
void MockPermissionService::HasPermission(PermissionDescriptorPtr permission, HasPermissionCallback callback)
{
    ...
    std::move(callback).Run(permission_responses_[pos].value_or(mojom::blink::PermissionStatus::DENIED));
}

void MockPermissionService::RegisterPageEmbeddedPermissionControl(
    Vector<mojom::blink::PermissionDescriptorPtr> permissions, mojo::PendingRemote<mojom::blink::EmbeddedPermissionControlClient> client)
{
}

void MockPermissionService::RequestPageEmbeddedPermission(
    mojom::blink::EmbeddedPermissionRequestDescriptorPtr permissions, RequestPageEmbeddedPermissionCallback)
{
    NOTREACHED();
}

void MockPermissionService::RequestPermission(PermissionDescriptorPtr permission, bool user_gesture, RequestPermissionCallback callback)
{
    V8WakeLockType::Enum type;
    if (!GetWakeLockTypeFromDescriptor(permission, &type)) {
        std::move(callback).Run(mojom::blink::PermissionStatus::DENIED);
...
void MockPermissionService::RequestPermissions(
    Vector<PermissionDescriptorPtr> permissions, bool user_gesture, mojom::blink::PermissionService::RequestPermissionsCallback)
{
    NOTREACHED();
}

void MockPermissionService::RevokePermission(PermissionDescriptorPtr permission, RevokePermissionCallback)
{
    NOTREACHED();
}

void MockPermissionService::AddPermissionObserver(
    PermissionDescriptorPtr permission, mojom::blink::PermissionStatus last_known_status, mojo::PendingRemote<mojom::blink::PermissionObserver>)
{
    NOTREACHED();
}
...
void MockPermissionService::NotifyEventListener(PermissionDescriptorPtr permission, const String& event_type, bool is_added)
{
    NOTREACHED();
}
// WakeLockTestingContext

WakeLockTestingContext::WakeLockTestingContext(MockWakeLockService* mock_wake_lock_service)
{
    DomWindow()->GetBrowserInterfaceBroker().SetBinderForTesting(
        mojom::blink::WakeLockService::Name_, WTF::BindRepeating(&MockWakeLockService::BindRequest, WTF::Unretained(mock_wake_lock_service)));
    DomWindow()->GetBrowserInterfaceBroker().SetBinderForTesting(
        mojom::blink::PermissionService::Name_, WTF::BindRepeating(&MockPermissionService::BindRequest, WTF::Unretained(&permission_service_)));
}
...
WakeLockTestingContext::~WakeLockTestingContext()
{
    ...
    DomWindow()->GetBrowserInterfaceBroker().SetBinderForTesting(mojom::blink::WakeLockService::Name_, {});
    DomWindow()->GetBrowserInterfaceBroker().SetBinderForTesting(mojom::blink::PermissionService::Name_, {});
}
...
void WakeLockTestingContext::WaitForPromiseFulfillment(ScriptPromise<WakeLockSentinel> promise)
{
    base::RunLoop run_loop;
...
void WakeLockTestingContext::WaitForPromiseRejection(ScriptPromise<WakeLockSentinel> promise)
{
    base::RunLoop run_loop;
...
// static
v8::Promise::PromiseState ScriptPromiseUtils::GetPromiseState(const ScriptPromise<WakeLockSentinel>& promise)
{
    return promise.V8Promise()->State();
}

// static
DOMException* ScriptPromiseUtils::GetPromiseResolutionAsDOMException(v8::Isolate* isolate, const ScriptPromise<WakeLockSentinel>& promise)
{
    return V8DOMException::ToWrappable(isolate, promise.V8Promise()->Result());
}

// static
WakeLockSentinel* ScriptPromiseUtils::GetPromiseResolutionAsWakeLockSentinel(v8::Isolate* isolate, const ScriptPromise<WakeLockSentinel>& promise)
{
    return V8WakeLockSentinel::ToWrappable(isolate, promise.V8Promise()->Result());
}
