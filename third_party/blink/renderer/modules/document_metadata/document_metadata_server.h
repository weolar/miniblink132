...
class DocumentMetadataServer final : public GarbageCollected<DocumentMetadataServer>, public mojom::blink::DocumentMetadata, public Supplement<Document> {
public:
    static const char kSupplementName[];
    static DocumentMetadataServer* From(Document&);
    static void BindReceiver(LocalFrame*, mojo::PendingReceiver<mojom::blink::DocumentMetadata>);

    explicit DocumentMetadataServer(base::PassKey<DocumentMetadataServer>, LocalFrame&);
...
private:
    ...
    HeapMojoReceiver<mojom::blink::DocumentMetadata, DocumentMetadataServer> receiver_;
};
