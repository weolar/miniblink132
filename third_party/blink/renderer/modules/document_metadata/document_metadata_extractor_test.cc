...
void DocumentMetadataExtractorTest::SetHTMLInnerHTML(const String& html_content)
{
...
PropertyPtr DocumentMetadataExtractorTest::CreateStringProperty(const String& name, const String& value)
{
...
PropertyPtr DocumentMetadataExtractorTest::CreateBooleanProperty(const String& name, const bool& value)
{
    PropertyPtr property = Property::New();
    property->name = name;
...
PropertyPtr DocumentMetadataExtractorTest::CreateLongProperty(const String& name, const int64_t& value)
{
    PropertyPtr property = Property::New();
    property->name = name;
...
PropertyPtr DocumentMetadataExtractorTest::CreateEntityProperty(const String& name, EntityPtr value)
{
    PropertyPtr property = Property::New();
    property->name = name;
...
WebPagePtr DocumentMetadataExtractorTest::CreateWebPage(const String& url, const String& title)
{
...
TEST_F(DocumentMetadataExtractorTest, basic)
{
    ...
    WebPagePtr expected = CreateWebPage("http://www.test.com/", "My neat website about cool stuff");

    EntityPtr restaurant = Entity::New();
    restaurant->type = "Restaurant";
    restaurant->properties.push_back(CreateStringProperty("name", "Special characters for ya >_<;"));
...
TEST_F(DocumentMetadataExtractorTest, nested)
{
    ...
    EntityPtr restaurant = Entity::New();
    restaurant->type = "Restaurant";
    restaurant->properties.push_back(CreateStringProperty("name", "Ye ol greasy diner"));

    EntityPtr address = Entity::New();
    address->type = "Thing";
    address->properties.push_back(CreateStringProperty("streetAddress", "123 Big Oak Road"));
    address->properties.push_back(CreateStringProperty("addressLocality", "San Francisco"));

    restaurant->properties.push_back(CreateEntityProperty("address", std::move(address)));
...
TEST_F(DocumentMetadataExtractorTest, truncateLongString)
{
    ...
    EntityPtr restaurant = Entity::New();
    restaurant->type = "Restaurant";
    restaurant->properties.push_back(CreateStringProperty("name", maxLengthString.ToString()));
...
TEST_F(DocumentMetadataExtractorTest, truncateTooManyFields)
{
    ...
    for (int i = 0; i < 19; ++i) {
        restaurant->properties.push_back(CreateStringProperty(String::Number(i), "a"));
    }
...
TEST_F(DocumentMetadataExtractorTest, enforceMaxNestingDepth)
{
    ...
    restaurant->properties.push_back(CreateEntityProperty("1", std::move(entity1)));
