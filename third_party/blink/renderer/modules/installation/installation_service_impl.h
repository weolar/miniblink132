...
class MODULES_EXPORT InstallationServiceImpl final : public GarbageCollected<InstallationServiceImpl>,
                                                     public mojom::blink::InstallationService,
                                                     public Supplement<LocalDOMWindow> {
public:
    static const char kSupplementName[];
    static InstallationServiceImpl* From(LocalDOMWindow&);
    static void BindReceiver(LocalFrame*, mojo::PendingReceiver<mojom::blink::InstallationService> receiver);

    explicit InstallationServiceImpl(base::PassKey<InstallationServiceImpl>, LocalFrame&);
...
private:
    HeapMojoReceiverSet<mojom::blink::InstallationService, InstallationServiceImpl> receivers_;
};
