...
class ContactsManager final : public ScriptWrappable, public Supplement<Navigator> {
...
public:
    ...
    ScriptPromise<IDLSequence<V8ContactProperty>> getProperties(ScriptState* script_state);
...
private:
    ...
    void OnContactsSelected(ScriptPromiseResolver<IDLSequence<ContactInfo>>* resolver, std::optional<Vector<mojom::blink::ContactInfoPtr>> contacts);
