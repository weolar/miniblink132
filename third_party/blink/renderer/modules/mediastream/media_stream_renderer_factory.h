...
public:
    ...
    MediaStreamRendererFactory& operator=(const MediaStreamRendererFactory&) = delete;

    virtual ~MediaStreamRendererFactory();

    virtual scoped_refptr<MediaStreamVideoRenderer> GetVideoRenderer(const WebMediaStream& web_stream, const MediaStreamVideoRenderer::RepaintCB& repaint_cb,
