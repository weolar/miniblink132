...
public:
    ...
    VideoTrackAdapterSettings(const gfx::Size& target_size, std::optional<double> max_frame_rate);
    ...
    VideoTrackAdapterSettings(std::optional<gfx::Size> target_size, double min_aspect_ratio, double max_aspect_ratio, std::optional<double> max_frame_rate);
    ...
    const std::optional<gfx::Size>& target_size() const
    {
        return target_size_;
    }
