...
// capture tracks.
class MODULES_EXPORT ScreenCaptureMediaStreamTrack final : public MediaStreamTrackImpl {
    DEFINE_WRAPPERTYPEINFO();

public:
    ScreenCaptureMediaStreamTrack(ExecutionContext* context, MediaStreamComponent* component, ScreenDetails* screen_details, ScreenDetailed* screen_detailed);
    ~ScreenCaptureMediaStreamTrack() override = default;

    ScreenDetailed* screenDetailed(ScriptState* script_state, ExceptionState& exception_state);
