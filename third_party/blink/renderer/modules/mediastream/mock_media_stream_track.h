...
public:
    ...
    ScriptPromise<IDLUndefined> applyConstraints(ScriptState* state, const MediaTrackConstraints* constraints) override
    {
        return applyConstraintsScriptState(state, constraints);
    }
    void applyConstraints(ScriptPromiseResolver<IDLUndefined>* resolver, const MediaTrackConstraints* constraints) override
    {
    ...
    void SetSettings(MediaTrackSettings* settings)
    {
        settings_ = settings;
    }
    ...
    void SetComponent(MediaStreamComponent* component)
    {
    ...
    MOCK_METHOD0(stats, V8UnionMediaStreamTrackAudioStatsOrMediaStreamTrackVideoStats*());
    MOCK_METHOD2(applyConstraintsScriptState, ScriptPromise<IDLUndefined>(ScriptState*, const MediaTrackConstraints*));
    MOCK_METHOD2(applyConstraintsResolver, void(ScriptPromiseResolver<IDLUndefined>*, const MediaTrackConstraints*));
    ...
    MOCK_METHOD2(AddedEventListener, void(const AtomicString&, RegisteredEventListener&));
    MOCK_METHOD1(BeingTransferred, void(const base::UnguessableToken&));
    MOCK_CONST_METHOD1(TransferAllowed, bool(String&));

#if !BUILDFLAG(IS_ANDROID)
    MOCK_METHOD5(SendWheel, void(double, double, int, int, base::OnceCallback<void(DOMException*)>));
    MOCK_METHOD1(GetZoomLevel, void(base::OnceCallback<void(std::optional<int>, const String&)>));
    MOCK_METHOD0(CloseFocusWindowOfOpportunity, void());
    MOCK_METHOD2(SetZoomLevel, void(int, base::OnceCallback<void(DOMException*)>));
#endif
...
private:
    ...
    V8MediaStreamTrackState ready_state_ = V8MediaStreamTrackState(V8MediaStreamTrackState::Enum::kLive);
