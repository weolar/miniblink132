...
class MODULES_EXPORT MediaStreamVideoRendererSink : public MediaStreamVideoRenderer, public MediaStreamVideoSink {
public:
    MediaStreamVideoRendererSink(MediaStreamComponent* video_component, const MediaStreamVideoRenderer::RepaintCB& repaint_cb,
    ...
    MediaStreamVideoRendererSink& operator=(const MediaStreamVideoRendererSink&) = delete;
