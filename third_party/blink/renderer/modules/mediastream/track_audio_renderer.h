...
// consumer.
class MODULES_EXPORT TrackAudioRenderer : public MediaStreamAudioRenderer, public WebMediaStreamAudioSink, public media::AudioRendererSink::RenderCallback {
public:
    ...
    TrackAudioRenderer(
        MediaStreamComponent* audio_component, LocalFrame& playout_web_frame, const String& device_id, base::RepeatingClosure on_render_error_callback);
...
private:
    ...
    void OnData(const media::AudioBus& audio_bus, base::TimeTicks reference_time) override;
    ...
    void ReconfigureSink(const media::AudioParameters new_format, int reconfig_number);
    ...
    // |audio_shifter_->push()|.
    void PushDataIntoShifter_Locked(std::unique_ptr<media::AudioBus>, base::TimeTicks);
