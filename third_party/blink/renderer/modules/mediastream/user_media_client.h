...
class MODULES_EXPORT UserMediaClient : public GarbageCollected<UserMediaClient>, public Supplement<LocalDOMWindow>, public ExecutionContextLifecycleObserver {
public:
    ...
    UserMediaClient(LocalFrame* frame, scoped_refptr<base::SingleThreadTaskRunner> task_runner);
    ...
    void SetMediaDevicesDispatcherForTesting(mojo::PendingRemote<blink::mojom::blink::MediaDevicesDispatcherHost> media_devices_dispatcher);
...
protected:
    ...
    UserMediaClient(LocalFrame* frame, UserMediaProcessor* user_media_processor, UserMediaProcessor* display_user_media_processor,
...
private:
    ...
    public:
        ...
        MediaStreamComponent* track_to_stop() const
        {
            return track_to_stop_.Get();
        }

        bool IsUserMedia() const
        {
        ...
        bool IsStopTrack() const
        {
            return !!track_to_stop_;
        }
    ...
    RequestQueue* GetRequestQueue(mojom::blink::MediaStreamType user_media_request);
