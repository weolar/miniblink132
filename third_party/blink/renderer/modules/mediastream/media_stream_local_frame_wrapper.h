...
public:
    MediaStreamInternalFrameWrapper(WebLocalFrame* web_frame)
        : frame_(web_frame ? static_cast<LocalFrame*>(WebLocalFrame::ToCoreFrame(*web_frame)) : nullptr)
    {
    }

    MediaStreamInternalFrameWrapper(const MediaStreamInternalFrameWrapper&) = delete;
    MediaStreamInternalFrameWrapper& operator=(const MediaStreamInternalFrameWrapper&) = delete;
