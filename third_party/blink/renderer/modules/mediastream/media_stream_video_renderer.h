...
class MediaStreamVideoRenderer : public ThreadSafeRefCounted<MediaStreamVideoRenderer> {
public:
    typedef base::RepeatingCallback<void(scoped_refptr<media::VideoFrame>)> RepaintCB;
