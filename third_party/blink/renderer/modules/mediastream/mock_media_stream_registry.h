...
public:
    ...
    MockMediaStreamVideoSource* AddVideoTrack(const String& track_id, const VideoTrackAdapterSettings& adapter_settings,
        const std::optional<bool>& noise_reduction, bool is_screen_cast, double min_frame_rate);
    MockMediaStreamVideoSource* AddVideoTrack(const String& track_id);
    void AddAudioTrack(const String& track_id);

    MediaStreamDescriptor* test_stream() const
    {
