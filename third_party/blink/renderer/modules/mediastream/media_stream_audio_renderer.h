...
class MediaStreamAudioRenderer : public ThreadSafeRefCounted<MediaStreamAudioRenderer> {
public:
    ...
    virtual void SwitchOutputDevice(const std::string& device_id, media::OutputDeviceStatusCB callback) = 0;
