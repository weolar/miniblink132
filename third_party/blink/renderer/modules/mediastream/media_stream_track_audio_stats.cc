...
MediaStreamTrackAudioStats::MediaStreamTrackAudioStats(MediaStreamTrackImpl* track)
    : track_(track)
{
}

uint64_t MediaStreamTrackAudioStats::deliveredFrames(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return stats_.DeliveredFrames();
}

DOMHighResTimeStamp MediaStreamTrackAudioStats::deliveredFramesDuration(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
...
DOMHighResTimeStamp MediaStreamTrackAudioStats::totalFramesDuration(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return stats_.TotalFramesDuration().InMillisecondsF();
}

DOMHighResTimeStamp MediaStreamTrackAudioStats::latency(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return stats_.Latency().InMillisecondsF();
}

DOMHighResTimeStamp MediaStreamTrackAudioStats::averageLatency(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return stats_.AverageLatency().InMillisecondsF();
}

DOMHighResTimeStamp MediaStreamTrackAudioStats::minimumLatency(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
    return stats_.MinimumLatency().InMillisecondsF();
}

DOMHighResTimeStamp MediaStreamTrackAudioStats::maximumLatency(ScriptState* script_state)
{
    MaybeUpdateStats(script_state);
...
ScriptValue MediaStreamTrackAudioStats::toJSON(ScriptState* script_state)
{
    ...
    result.AddNumber("deliveredFramesDuration", deliveredFramesDuration(script_state));
...
void MediaStreamTrackAudioStats::MaybeUpdateStats(ScriptState* script_state)
{
    ...
    ToEventLoop(script_state).EnqueueMicrotask(WTF::BindOnce(&MediaStreamTrackAudioStats::OnMicrotask, WrapWeakPersistent(this)));
}
