...
class MODULES_EXPORT ApplyConstraintsRequest final : public GarbageCollected<ApplyConstraintsRequest> {
public:
    ApplyConstraintsRequest(MediaStreamTrack*, const MediaConstraints&, ScriptPromiseResolver<IDLUndefined>*);
