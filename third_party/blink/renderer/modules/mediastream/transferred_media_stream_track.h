...
public:
    TransferredMediaStreamTrack(ExecutionContext* execution_context, const TransferredValues& data);
...
private:
    ...
    enum SetterFunction { APPLY_CONSTRAINTS, SET_CONTENT_HINT, SET_ENABLED, CLONE };
    ...
    public:
        EventPropagator(MediaStreamTrack* underlying_track, TransferredMediaStreamTrack* transferred_track);
    ...
    struct ConstraintsPair : GarbageCollected<ConstraintsPair> {
        ConstraintsPair(ScriptPromiseResolver<IDLUndefined>* resolver, const MediaTrackConstraints* constraints);
