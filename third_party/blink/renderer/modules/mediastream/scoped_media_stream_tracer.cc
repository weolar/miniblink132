...
{
    TRACE_EVENT_NESTABLE_ASYNC_BEGIN0(kMediaStreamTraceCategory, event_name_.Utf8().c_str(), this);
}
...
void ScopedMediaStreamTracer::End()
{
    ...
    TRACE_EVENT_NESTABLE_ASYNC_END0(kMediaStreamTraceCategory, event_name_.Utf8().c_str(), this);
    finished_ = true;
}
