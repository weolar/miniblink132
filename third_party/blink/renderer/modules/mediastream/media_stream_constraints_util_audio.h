...
public:
    ...
    AudioDeviceCaptureCapability(String device_id, String group_id, const media::AudioParameters& parameters);
    ...
    blink::MediaStreamAudioSource* source() const
    {
        return source_;
    }
...
MODULES_EXPORT blink::AudioCaptureSettings SelectSettingsAudioCapture(const AudioDeviceCaptureCapabilities& capabilities, const MediaConstraints& constraints,
    mojom::blink::MediaStreamType stream_type, bool should_disable_hardware_noise_suppression, bool is_reconfiguration_allowed = false);
...
MODULES_EXPORT blink::AudioCaptureSettings SelectSettingsAudioCapture(blink::MediaStreamAudioSource* source, const MediaConstraints& constraints);
...
MODULES_EXPORT base::expected<Vector<blink::AudioCaptureSettings>, std::string> SelectEligibleSettingsAudioCapture(
    ...
    bool should_disable_hardware_noise_suppression, bool is_reconfiguration_allowed = false);
...
MODULES_EXPORT std::tuple<int, int> GetMinMaxBufferSizesForAudioParameters(const media::AudioParameters& parameters);
MODULES_EXPORT std::tuple<double, double> GetMinMaxLatenciesForAudioParameters(const media::AudioParameters& parameters);
