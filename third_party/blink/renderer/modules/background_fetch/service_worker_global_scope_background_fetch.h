...
public:
    DEFINE_STATIC_ATTRIBUTE_EVENT_LISTENER(backgroundfetchsuccess, kBackgroundfetchsuccess)
    DEFINE_STATIC_ATTRIBUTE_EVENT_LISTENER(backgroundfetchfail, kBackgroundfetchfail)
    DEFINE_STATIC_ATTRIBUTE_EVENT_LISTENER(backgroundfetchabort, kBackgroundfetchabort)
    DEFINE_STATIC_ATTRIBUTE_EVENT_LISTENER(backgroundfetchclick, kBackgroundfetchclick)
};
