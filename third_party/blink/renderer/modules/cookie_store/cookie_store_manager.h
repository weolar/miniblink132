...
class CookieStoreManager final : public ScriptWrappable, public Supplement<ServiceWorkerRegistration> {
...
public:
    ...
    ScriptPromise<IDLUndefined> unsubscribe(
        ScriptState* script_state, const HeapVector<Member<CookieStoreGetOptions>>& subscription, ExceptionState& exception_state);
    ScriptPromise<IDLSequence<CookieStoreGetOptions>> getSubscriptions(ScriptState* script_state, ExceptionState& exception_state);
...
private:
    ...
    void OnSubscribeResult(ScriptPromiseResolver<IDLUndefined>* resolver, bool backend_result);
    void OnGetSubscriptionsResult(ScriptPromiseResolver<IDLSequence<CookieStoreGetOptions>>* resolver,
        Vector<mojom::blink::CookieChangeSubscriptionPtr> backend_result, bool backend_success);
