...
class SensorProxyImpl final : public SensorProxy, public device::mojom::blink::SensorClient {
public:
    SensorProxyImpl(device::mojom::blink::SensorType, SensorProviderProxy*, Page*);
...
private:
    ...
    void AddConfiguration(device::mojom::blink::SensorConfigurationPtr, base::OnceCallback<void(bool)>) override;
    void RemoveConfiguration(device::mojom::blink::SensorConfigurationPtr) override;
    ...
    void HandleSensorError(device::mojom::blink::SensorCreationResult = device::mojom::blink::SensorCreationResult::ERROR_NOT_AVAILABLE);

    // mojo call callbacks.
    void OnSensorCreated(device::mojom::blink::SensorCreationResult, device::mojom::blink::SensorInitParamsPtr);
    ...
    device::mojom::blink::ReportingMode mode_ = device::mojom::blink::ReportingMode::CONTINUOUS;
    HeapMojoRemote<device::mojom::blink::Sensor> sensor_remote_;
    HeapMojoReceiver<device::mojom::blink::SensorClient, SensorProxyImpl> client_receiver_;
    scoped_refptr<base::SingleThreadTaskRunner> task_runner_;

    std::unique_ptr<device::SensorReadingSharedBufferReader> shared_buffer_reader_;
