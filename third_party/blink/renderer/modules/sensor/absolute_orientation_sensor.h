...
public:
    static AbsoluteOrientationSensor* Create(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
    static AbsoluteOrientationSensor* Create(ExecutionContext*, ExceptionState&);

    AbsoluteOrientationSensor(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
