...
public:
    static GravitySensor* Create(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
    static GravitySensor* Create(ExecutionContext*, ExceptionState&);

    GravitySensor(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
