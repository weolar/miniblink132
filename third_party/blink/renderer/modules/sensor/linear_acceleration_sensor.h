...
public:
    static LinearAccelerationSensor* Create(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
    static LinearAccelerationSensor* Create(ExecutionContext*, ExceptionState&);

    LinearAccelerationSensor(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
