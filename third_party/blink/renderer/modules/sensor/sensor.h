...
class Sensor : public EventTarget, public ActiveScriptWrappable<Sensor>, public ExecutionContextLifecycleObserver, public SensorProxy::Observer {
...
protected:
    Sensor(ExecutionContext*, const SensorOptions*, ExceptionState&, device::mojom::blink::SensorType, const Vector<mojom::blink::PermissionsPolicyFeature>&);

    Sensor(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&, device::mojom::blink::SensorType,
    ...
    void OnSensorError(DOMExceptionCode, const String& sanitized_message, const String& unsanitized_message) override;
...
private:
    ...
    void HandleError(DOMExceptionCode, const String& sanitized_message, const String& unsanitized_message = String());
