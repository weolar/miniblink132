...
class SensorProxy : public GarbageCollected<SensorProxy>, public PageVisibilityObserver, public FocusChangedObserver {
public:
    ...
    public:
        ...
        virtual void OnSensorError(DOMExceptionCode, const String& sanitized_message, const String& unsanitized_message)
        {
        }
    };
    ...
    virtual void AddConfiguration(device::mojom::blink::SensorConfigurationPtr, base::OnceCallback<void(bool)>) = 0;
    virtual void RemoveConfiguration(device::mojom::blink::SensorConfigurationPtr) = 0;
    ...
    device::mojom::blink::SensorType type() const
    {
        return type_;
    }
...
protected:
    ...
    SensorProviderProxy* sensor_provider_proxy() const
    {
...
private:
    ...
    static_assert(
        sizeof(device::SensorReadingSharedBuffer) == device::mojom::blink::SensorInitParams::kReadBufferSizeForTests, "Check reading buffer size for tests");
};
