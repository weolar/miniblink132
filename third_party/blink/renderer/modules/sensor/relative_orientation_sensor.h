...
public:
    static RelativeOrientationSensor* Create(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
    static RelativeOrientationSensor* Create(ExecutionContext*, ExceptionState&);

    RelativeOrientationSensor(ExecutionContext*, const SpatialSensorOptions*, ExceptionState&);
