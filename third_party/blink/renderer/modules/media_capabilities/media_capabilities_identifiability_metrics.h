...
void ReportDecodingInfoResult(ExecutionContext*, const MediaDecodingConfiguration*, const MediaCapabilitiesDecodingInfo*);
...
void ReportDecodingInfoResult(ExecutionContext*, std::optional<IdentifiableToken>, const MediaCapabilitiesDecodingInfo*);
...
std::optional<IdentifiableToken> ComputeDecodingInfoInputToken(const MediaDecodingConfiguration*);
