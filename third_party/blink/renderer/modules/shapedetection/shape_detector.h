...
protected:
    std::optional<SkBitmap> GetBitmapFromSource(ScriptState* script_state, const V8ImageBitmapSource* image_source, ExceptionState&);

private:
    std::optional<SkBitmap> GetBitmapFromImageData(ScriptState*, ImageData*, ExceptionState&);
    std::optional<SkBitmap> GetBitmapFromImageElement(ScriptState*, const HTMLImageElement*, ExceptionState&);
};
