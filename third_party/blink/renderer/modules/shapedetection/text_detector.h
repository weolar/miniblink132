...
public:
    ...
    ScriptPromise<IDLSequence<DetectedText>> detect(ScriptState*, const V8ImageBitmapSource*, ExceptionState&);

    void Trace(Visitor*) const override;

private:
    void OnDetectText(ScriptPromiseResolver<IDLSequence<DetectedText>>*, Vector<shape_detection::mojom::blink::TextDetectionResultPtr>);
