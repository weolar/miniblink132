...
public:
    static TextDecoderStream* Create(ScriptState*, const String& label, const TextDecoderOptions*, ExceptionState&);

    TextDecoderStream(ScriptState*, const WTF::TextEncoding&, const TextDecoderOptions*, ExceptionState&);
