...
class WindowScreenDetails final : public GarbageCollected<WindowScreenDetails>, public ExecutionContextLifecycleObserver, public Supplement<LocalDOMWindow> {
public:
    ...
    static ScriptPromise<ScreenDetails> getScreenDetails(ScriptState* script_state, LocalDOMWindow& window, ExceptionState& exception_state);
...
private:
    ...
    ScriptPromise<ScreenDetails> GetScreenDetails(ScriptState* script_state, ExceptionState& exception_state);
    ...
    void OnPermissionInquiryComplete(ScriptPromiseResolver<ScreenDetails>* resolver, bool permission_requested, mojom::blink::PermissionStatus status);
