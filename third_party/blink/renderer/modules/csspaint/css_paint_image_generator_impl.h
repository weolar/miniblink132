...
class MODULES_EXPORT CSSPaintImageGeneratorImpl final : public CSSPaintImageGenerator {
public:
    ...
    scoped_refptr<Image> Paint(const ImageResourceObserver&, const gfx::SizeF& container_size, const CSSStyleValueVector*) final;
    ...
    bool GetValidDocumentDefinitionForTesting(DocumentPaintDefinition*& definition) const
    {
