...
class MODULES_EXPORT ClipPathPaintDefinition final : public GarbageCollected<ClipPathPaintDefinition>, public NativeCssPaintDefinition {
public:
    ...
    static scoped_refptr<Image> Paint(float zoom, const gfx::RectF& reference_box, const gfx::SizeF& clip_area_size, const Node&, int worklet_id);
