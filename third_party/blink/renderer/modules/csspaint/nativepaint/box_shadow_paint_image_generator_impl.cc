...
BoxShadowPaintImageGenerator* BoxShadowPaintImageGeneratorImpl::Create(LocalFrame& local_root)
{
    BoxShadowPaintDefinition* box_shadow_paint_definition = BoxShadowPaintDefinition::Create(local_root);

    DCHECK(box_shadow_paint_definition);
    BoxShadowPaintImageGeneratorImpl* generator = MakeGarbageCollected<BoxShadowPaintImageGeneratorImpl>(box_shadow_paint_definition);

    return generator;
}

BoxShadowPaintImageGeneratorImpl::BoxShadowPaintImageGeneratorImpl(BoxShadowPaintDefinition* box_shadow_paint_definition)
...
Animation* BoxShadowPaintImageGeneratorImpl::GetAnimationIfCompositable(const Element* element)
{
