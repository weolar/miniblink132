...
class MODULES_EXPORT BackgroundColorPaintDefinition final : public GarbageCollected<BackgroundColorPaintDefinition>, public NativeCssPaintDefinition {
...
public:
    ...
    BackgroundColorPaintDefinition(const BackgroundColorPaintDefinition&) = delete;
    BackgroundColorPaintDefinition& operator=(const BackgroundColorPaintDefinition&) = delete;
