...
NativePaintDefinition::NativePaintDefinition(LocalFrame* local_root, PaintWorkletInput::PaintWorkletInputType type)
...
void NativePaintDefinition::RegisterProxyClient(LocalFrame* local_root, PaintWorkletInput::PaintWorkletInputType type)
{
    proxy_client_ = PaintWorkletProxyClient::Create(local_root->DomWindow(), worklet_id_);
