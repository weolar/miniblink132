...
class MODULES_EXPORT ClipPathPaintImageGeneratorImpl final : public ClipPathPaintImageGenerator {
public:
    ...
    scoped_refptr<Image> Paint(float zoom, const gfx::RectF& reference_box, const gfx::SizeF& clip_area_size, const Node&) final;
