...
PaintRenderingContext2D::PaintRenderingContext2D(const gfx::Size& container_size, const PaintRenderingContext2DSettings* context_settings, float zoom,
    scoped_refptr<base::SingleThreadTaskRunner> task_runner, PaintWorkletGlobalScope* global_scope)
    ...
    , global_scope_(global_scope)
{
    ...
    GetPaintCanvas()->clear(context_settings->alpha() ? SkColors::kTransparent : SkColors::kBlack);
}

void PaintRenderingContext2D::InitializeForRecording(cc::PaintCanvas* canvas) const
{
...
PredefinedColorSpace PaintRenderingContext2D::GetDefaultImageDataColorSpace() const
{
...
void PaintRenderingContext2D::resetTransform()
{
    ...
    BaseRenderingContext2D::transform(effective_zoom_, 0, 0, effective_zoom_, 0, 0);
}
