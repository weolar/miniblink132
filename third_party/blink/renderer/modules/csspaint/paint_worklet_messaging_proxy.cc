...
PaintWorkletMessagingProxy::PaintWorkletMessagingProxy(ExecutionContext* execution_context)
...
{
    return AnimationAndPaintWorkletThread::CreateForPaintWorklet(WorkletObjectProxy());
}
