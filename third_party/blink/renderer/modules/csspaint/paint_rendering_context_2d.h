...
class MODULES_EXPORT PaintRenderingContext2D : public ScriptWrappable, public BaseRenderingContext2D, public MemoryManagedPaintRecorder::Client {
    DEFINE_WRAPPERTYPEINFO();

public:
    PaintRenderingContext2D(const gfx::Size& container_size, const PaintRenderingContext2DSettings*, float zoom,
        scoped_refptr<base::SingleThreadTaskRunner> task_runner, PaintWorkletGlobalScope* global_scope = nullptr);
    ...
    {
        return context_settings_->alpha();
    }
