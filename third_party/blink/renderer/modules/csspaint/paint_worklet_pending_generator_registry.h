...
class PaintWorkletPendingGeneratorRegistry : public GarbageCollected<PaintWorkletPendingGeneratorRegistry> {
public:
    PaintWorkletPendingGeneratorRegistry() = default;

    PaintWorkletPendingGeneratorRegistry(const PaintWorkletPendingGeneratorRegistry&) = delete;
    PaintWorkletPendingGeneratorRegistry& operator=(const PaintWorkletPendingGeneratorRegistry&) = delete;
