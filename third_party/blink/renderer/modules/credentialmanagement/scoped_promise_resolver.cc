...
ScopedPromiseResolver::ScopedPromiseResolver(ScriptPromiseResolverBase* resolver)
    : resolver_(resolver)
{
}
...
void ScopedPromiseResolver::OnConnectionError()
{
    ...
    resolver_->Reject(MakeGarbageCollected<DOMException>(DOMExceptionCode::kNotSupportedError, "The user agent does not support public key credentials."));
}
