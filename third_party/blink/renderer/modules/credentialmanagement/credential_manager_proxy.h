...
// method was called.
class MODULES_EXPORT CredentialManagerProxy : public GarbageCollected<CredentialManagerProxy>, public Supplement<LocalDOMWindow> {
public:
...
private:
    template <typename Interface> void BindRemoteForFedCm(HeapMojoRemote<Interface>& remote, base::OnceClosure disconnect_closure);
    ...
    HeapMojoRemote<mojom::blink::DigitalIdentityRequest> digital_identity_request_;
};
