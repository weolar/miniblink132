...
class MODULES_EXPORT NavigatorLogin : public ScriptWrappable, public Supplement<Navigator> {
...
public:
    ...
    ScriptPromise<IDLUndefined> setStatus(ScriptState* script_state, const V8LoginStatus& status);
