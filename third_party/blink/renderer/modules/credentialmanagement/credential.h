...
public:
    ...
    virtual bool IsPasswordCredential() const
    {
        return false;
    }
    virtual bool IsFederatedCredential() const
    {
        return false;
    }
    virtual bool IsDigitalCredential() const
    {
        return false;
    }
    virtual bool IsPublicKeyCredential() const
    {
        return false;
    }
    virtual bool IsOTPCredential() const
    {
        return false;
    }
    virtual bool IsIdentityCredential() const
    {
        return false;
    }
