...
class MODULES_EXPORT AuthenticatorAssertionResponse final : public AuthenticatorResponse {
...
public:
    ...
    // present.
    AuthenticatorAssertionResponse(const Vector<uint8_t> client_data_json, const Vector<uint8_t> authenticator_data, const Vector<uint8_t> signature,
    ...
    DOMArrayBuffer* userHandle() const
    {
        return user_handle_.Get();
    }
