...
DOMException* AuthenticatorStatusToDOMException(
    mojom::blink::AuthenticatorStatus status, const mojom::blink::WebAuthnDOMExceptionDetailsPtr& dom_exception_details);

class MODULES_EXPORT AuthenticationCredentialsContainer final : public CredentialsContainer, public Supplement<Navigator> {
public:
    ...
    ScriptPromise<IDLNullable<Credential>> get(ScriptState*, const CredentialRequestOptions*, ExceptionState&) override;
    ScriptPromise<Credential> store(ScriptState*, Credential*, ExceptionState& exception_state) override;
    ScriptPromise<IDLNullable<Credential>> create(ScriptState*, const CredentialCreationOptions*, ExceptionState&) override;
...
private:
    ...
    void GetForIdentity(
        ScriptState*, ScriptPromiseResolver<IDLNullable<Credential>>*, const CredentialRequestOptions&, const IdentityCredentialRequestOptions&);
