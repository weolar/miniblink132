...
class MODULES_EXPORT IdentityCredentialsContainer final : public CredentialsContainer, public Supplement<Navigator> {
public:
    ...
    ScriptPromise<Credential> store(ScriptState*, Credential*, ExceptionState&) override;
