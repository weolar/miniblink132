...
public:
    ...
    DOMArrayBuffer* clientDataJSON() const
    {
        return client_data_json_.Get();
    }

    void Trace(Visitor*) const override;

    virtual absl::variant<AuthenticatorAssertionResponseJSON*, AuthenticatorAttestationResponseJSON*> toJSON() const;
