...
// static
IdentityCredentialError* IdentityCredentialError::Create(const String& message, const IdentityCredentialErrorInit* options)
{
    return MakeGarbageCollected<IdentityCredentialError>(message, options);
}

IdentityCredentialError::IdentityCredentialError(const String& message, const IdentityCredentialErrorInit* options)
...
IdentityCredentialError::IdentityCredentialError(const String& message, const String& code, const String& url)
    : DOMException(DOMExceptionCode::kIdentityCredentialError, message)
    , code_(code)
    , url_(url)
{
