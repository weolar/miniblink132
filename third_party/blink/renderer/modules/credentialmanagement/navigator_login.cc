...
{
    NavigatorLogin* supplement = Supplement<Navigator>::From<NavigatorLogin>(navigator);
    if (!supplement) {
...
ScriptPromise<IDLUndefined> NavigatorLogin::setStatus(ScriptState* script_state, const V8LoginStatus& v8_status)
{
