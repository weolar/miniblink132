...
public:
    ...
    virtual ScriptPromise<IDLNullable<Credential>> get(ScriptState*, const CredentialRequestOptions*, ExceptionState&) = 0;
    virtual ScriptPromise<Credential> store(ScriptState*, Credential*, ExceptionState&) = 0;
    virtual ScriptPromise<IDLNullable<Credential>> create(ScriptState*, const CredentialCreationOptions*, ExceptionState&) = 0;
