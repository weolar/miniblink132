...
public:
    ...
    static IdentityCredentialError* Create(const String& message, const IdentityCredentialErrorInit* options);

    IdentityCredentialError(const String& message, const IdentityCredentialErrorInit* options);
    IdentityCredentialError(const String& message, const String& code, const String& url);
