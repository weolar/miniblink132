...
public:
    ...
    static ScriptPromise<IDLUndefined> selectFedCmAccount(ScriptState*, Internals&, int account_index, ExceptionState&);
    static ScriptPromise<IDLUndefined> dismissFedCmDialog(ScriptState*, Internals&);
    static ScriptPromise<IDLUndefined> clickFedCmDialogButton(ScriptState*, Internals&, const V8DialogButton& button);
};
