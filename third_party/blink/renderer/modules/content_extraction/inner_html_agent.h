...
class InnerHtmlAgent final : public GarbageCollected<InnerHtmlAgent>, public mojom::blink::InnerHtmlAgent, public Supplement<Document> {
public:
    static const char kSupplementName[];
    static InnerHtmlAgent* From(Document&);
    static void BindReceiver(LocalFrame* frame, mojo::PendingReceiver<mojom::blink::InnerHtmlAgent> receiver);
...
private:
    ...
    HeapMojoReceiverSet<mojom::blink::InnerHtmlAgent, InnerHtmlAgent> receiver_set_;
};
