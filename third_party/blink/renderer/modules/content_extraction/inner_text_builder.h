...
public:
    ...
    static mojom::blink::InnerTextFramePtr Build(LocalFrame& frame, const mojom::blink::InnerTextParams& params);
...
private:
    ...
    InnerTextBuilder(const mojom::blink::InnerTextParams& params, HeapVector<Member<ChildIFrame>>& child_iframes);
    ...
    void AddNextNonFrameSegments(const String& text, unsigned next_child_offset, unsigned& text_offset, mojom::blink::InnerTextFrame& frame);
...
private:
    explicit InnerTextPassagesBuilder(const mojom::blink::InnerTextParams& params);
