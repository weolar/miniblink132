...
InnerHtmlBuilder::InnerHtmlBuilder(Document& d)
    : MarkupAccumulator(kDoNotResolveURLs, IsA<HTMLDocument>(d) ? SerializationType::kHTML : SerializationType::kXML, ShadowRootInclusion())
{
}
...
MarkupAccumulator::EmitElementChoice InnerHtmlBuilder::WillProcessElement(const Element& e)
{
