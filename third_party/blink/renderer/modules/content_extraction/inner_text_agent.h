...
class InnerTextAgent final : public GarbageCollected<InnerTextAgent>, public mojom::blink::InnerTextAgent, public Supplement<Document> {
public:
    static const char kSupplementName[];
    static InnerTextAgent* From(Document&);
    static void BindReceiver(LocalFrame* frame, mojo::PendingReceiver<mojom::blink::InnerTextAgent> receiver);
    ...
    void GetInnerText(mojom::blink::InnerTextParamsPtr params, GetInnerTextCallback callback) override;

private:
    void Bind(mojo::PendingReceiver<mojom::blink::InnerTextAgent> receiver);

    HeapMojoReceiverSet<mojom::blink::InnerTextAgent, InnerTextAgent> receiver_set_;
};
