...
// static
media::EmeInitDataType EncryptedMediaUtils::ConvertToInitDataType(const String& init_data_type)
{
...
// static
String EncryptedMediaUtils::ConvertFromInitDataType(media::EmeInitDataType init_data_type)
{
...
// static
WebEncryptedMediaSessionType EncryptedMediaUtils::ConvertToSessionType(const String& session_type)
{
...
// static
String EncryptedMediaUtils::ConvertFromSessionType(WebEncryptedMediaSessionType session_type)
{
    switch (session_type) {
...
// static
String EncryptedMediaUtils::ConvertKeyStatusToString(const WebEncryptedMediaKeyInformation::KeyStatus status)
{
    switch (status) {
...
// static
V8MediaKeyStatus EncryptedMediaUtils::ConvertKeyStatusToEnum(const WebEncryptedMediaKeyInformation::KeyStatus status)
{
    switch (status) {
    case WebEncryptedMediaKeyInformation::KeyStatus::kUsable:
...
// static
WebMediaKeySystemConfiguration::Requirement EncryptedMediaUtils::ConvertToMediaKeysRequirement(V8MediaKeysRequirement::Enum requirement)
{
    switch (requirement) {
...
// static
V8MediaKeysRequirement::Enum EncryptedMediaUtils::ConvertMediaKeysRequirementToEnum(WebMediaKeySystemConfiguration::Requirement requirement)
{
    switch (requirement) {
...
// static
WebEncryptedMediaClient* EncryptedMediaUtils::GetEncryptedMediaClientFromLocalDOMWindow(LocalDOMWindow* window)
{
    WebLocalFrameImpl* web_frame = WebLocalFrameImpl::FromFrame(window->GetFrame());
    return web_frame->Client()->EncryptedMediaClient();
}

// static
void EncryptedMediaUtils::ReportUsage(
    EmeApiType api_type, ExecutionContext* execution_context, const String& key_system, bool use_hardware_secure_codecs, bool is_persistent_session)
{
