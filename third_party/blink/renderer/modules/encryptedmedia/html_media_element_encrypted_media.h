...
class MODULES_EXPORT HTMLMediaElementEncryptedMedia final : public GarbageCollected<HTMLMediaElementEncryptedMedia>,
...
public:
    ...
    static ScriptPromise<IDLUndefined> setMediaKeys(ScriptState*, HTMLMediaElement&, MediaKeys*, ExceptionState&);
    ...
    void Encrypted(media::EmeInitDataType init_data_type, const unsigned char* init_data, unsigned init_data_length) final;
...
private:
    ...
    // EventTarget
    bool SetAttributeEventListener(const AtomicString& event_type, EventListener*);
