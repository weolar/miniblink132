...
class AvailabilityCallbackWrapper final : public GarbageCollected<AvailabilityCallbackWrapper>, public NameClient {
public:
    ...
    AvailabilityCallbackWrapper& operator=(const AvailabilityCallbackWrapper&) = delete;
