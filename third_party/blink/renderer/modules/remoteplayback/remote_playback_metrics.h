...
public:
    static void RecordRemotePlaybackLocation(RemotePlaybackInitiationLocation location);

    static void RecordRemotePlaybackStartSessionResult(ExecutionContext* execution_context, bool success);
};
