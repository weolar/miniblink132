...
class MODULES_EXPORT VideoFrameRequestCallbackCollection final : public GarbageCollected<VideoFrameRequestCallbackCollection>, public NameClient {
public:
    ...
    class MODULES_EXPORT VideoFrameCallback : public GarbageCollected<VideoFrameCallback>, public NameClient {
    public:
        ...
        void SetIsCancelled(bool is_cancelled)
        {
    ...
    void ExecuteFrameCallbacks(double high_res_now_ms, const VideoFrameCallbackMetadata*);
