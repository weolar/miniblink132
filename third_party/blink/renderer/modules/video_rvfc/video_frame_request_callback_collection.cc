...
VideoFrameRequestCallbackCollection::VideoFrameRequestCallbackCollection(ExecutionContext* context)
    : context_(context)
{
}

VideoFrameRequestCallbackCollection::CallbackId VideoFrameRequestCallbackCollection::RegisterFrameCallback(VideoFrameCallback* callback)
{
...
void VideoFrameRequestCallbackCollection::ExecuteFrameCallbacks(double high_res_now_ms, const VideoFrameCallbackMetadata* metadata)
{
...
VideoFrameRequestCallbackCollection::V8VideoFrameCallback::V8VideoFrameCallback(V8VideoFrameRequestCallback* callback)
    : callback_(callback)
{
}

void VideoFrameRequestCallbackCollection::V8VideoFrameCallback::Trace(blink::Visitor* visitor) const
{
    visitor->Trace(callback_);
    VideoFrameRequestCallbackCollection::VideoFrameCallback::Trace(visitor);
}

void VideoFrameRequestCallbackCollection::V8VideoFrameCallback::Invoke(double highResTime, const VideoFrameCallbackMetadata* metadata)
{
