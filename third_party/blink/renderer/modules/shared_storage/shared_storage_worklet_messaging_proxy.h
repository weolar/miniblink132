...
// thread.
class MODULES_EXPORT SharedStorageWorkletMessagingProxy final : public ThreadedWorkletMessagingProxy {
public:
    SharedStorageWorkletMessagingProxy(scoped_refptr<base::SingleThreadTaskRunner> main_thread_runner,
        mojo::PendingReceiver<mojom::blink::SharedStorageWorkletService> receiver,
        mojom::blink::WorkletGlobalScopeCreationParamsPtr global_scope_creation_params, base::OnceClosure worklet_terminated_callback);
...
private:
    ...
    static void InitializeSharedStorageWorkletServiceOnWorkletThread(scoped_refptr<base::SingleThreadTaskRunner> main_thread_runner,
        CrossThreadHandle<SharedStorageWorkletMessagingProxy>, WorkerThread* worker_thread,
        mojo::PendingReceiver<mojom::blink::SharedStorageWorkletService> receiver);

    static void OnSharedStorageWorkletServiceDisconnectedOnWorkletThread(
        scoped_refptr<base::SingleThreadTaskRunner> main_thread_runner, CrossThreadHandle<SharedStorageWorkletMessagingProxy>);
