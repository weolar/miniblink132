...
SharedStorageOperationDefinition::SharedStorageOperationDefinition(
    ScriptState* script_state, const String& name, V8NoArgumentConstructor* constructor, v8::Local<v8::Function> v8_run)
    : script_state_(script_state)
    , name_(name)
    , constructor_(constructor)
    , run_function_for_select_url_(V8RunFunctionForSharedStorageSelectURLOperation::Create(v8_run))
    , run_function_for_run_(V8RunFunctionForSharedStorageRunOperation::Create(v8_run))
{
}
...
TraceWrapperV8Reference<v8::Value> SharedStorageOperationDefinition::GetInstance()
{
