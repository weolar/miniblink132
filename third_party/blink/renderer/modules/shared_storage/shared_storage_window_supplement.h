...
class MODULES_EXPORT SharedStorageWindowSupplement : public GarbageCollected<SharedStorageWindowSupplement>, public Supplement<LocalDOMWindow> {
public:
...
private:
    HeapMojoAssociatedRemote<mojom::blink::SharedStorageDocumentService> shared_storage_document_service_ { nullptr };
};
