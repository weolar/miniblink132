...
public:
    static SharedStorageWorklet* Create(ScriptState*, bool cross_origin_script_allowed);
    ...
    ScriptPromise<IDLUndefined> addModule(ScriptState*, const String& module_url, const WorkletOptions* options, ExceptionState&);
    ...
    void AddModuleHelper(ScriptState*, ScriptPromiseResolverBase*, const String& module_url, const WorkletOptions* options, ExceptionState&,
        bool resolve_to_worklet, SharedStorageDataOrigin data_origin_type);

private:
    // Set when addModule() was called and passed early renderer checks.
    HeapMojoAssociatedRemote<mojom::blink::SharedStorageWorkletHost> worklet_host_ { nullptr };
