...
static constexpr char kOpaqueContextOriginCheckErrorMessage[] = "the method on sharedStorage is not allowed in an opaque origin context";

static constexpr char kOpaqueDataOriginCheckErrorMessage[] = "the method on sharedStorage is not allowed to have an opaque data origin";
...
bool StringFromV8(v8::Isolate* isolate, v8::Local<v8::Value> val, WTF::String* out);
