...
class MODULES_EXPORT SharedStorageOperationDefinition final : public GarbageCollected<SharedStorageOperationDefinition>, public NameClient {
public:
    SharedStorageOperationDefinition(ScriptState* script_state, const String& name, V8NoArgumentConstructor* constructor, v8::Local<v8::Function> v8_run);
    ...
    V8RunFunctionForSharedStorageSelectURLOperation* GetRunFunctionForSharedStorageSelectURLOperation()
    {
        return run_function_for_select_url_.Get();
    }

    V8RunFunctionForSharedStorageRunOperation* GetRunFunctionForSharedStorageRunOperation()
    {
...
private:
    ...
    Member<V8RunFunctionForSharedStorageSelectURLOperation> run_function_for_select_url_;
