...
class MODULES_EXPORT EventSourceParser final : public GarbageCollected<EventSourceParser> {
public:
    class MODULES_EXPORT Client : public GarbageCollectedMixin {
    public:
        virtual ~Client() = default;
        virtual void OnMessageEvent(const AtomicString& type, const String& data, const AtomicString& last_event_id) = 0;
    ...
    const AtomicString& LastEventId() const
    {
