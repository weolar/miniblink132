...
bool StructTraits<blink::mojom::UserAgentBrandVersionDataView, ::blink::UserAgentBrandVersion>::Read(
    blink::mojom::UserAgentBrandVersionDataView data, ::blink::UserAgentBrandVersion* out)
{
...
bool StructTraits<blink::mojom::UserAgentMetadataDataView, ::blink::UserAgentMetadata>::Read(
    blink::mojom::UserAgentMetadataDataView data, ::blink::UserAgentMetadata* out)
{
    std::string string;
...
bool StructTraits<blink::mojom::UserAgentOverrideDataView, ::blink::UserAgentOverride>::Read(
    blink::mojom::UserAgentOverrideDataView data, ::blink::UserAgentOverride* out)
{
    if (!data.ReadUaStringOverride(&out->ua_string_override) || !data.ReadUaMetadataOverride(&out->ua_metadata_override)) {
        return false;
    }
    return true;
}
