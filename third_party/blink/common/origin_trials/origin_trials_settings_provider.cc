...
void OriginTrialsSettingsProvider::SetSettings(blink::mojom::OriginTrialsSettingsPtr settings)
{
    base::AutoLock auto_lock(settings_lock_);
    settings_ = std::move(settings);
}

blink::mojom::OriginTrialsSettingsPtr OriginTrialsSettingsProvider::GetSettings()
{
