...
const char kSampleToken[] = "AuR/1mg+/w5ROLN54Ok20rApK3opgR7Tq9ZfzhATQmnCa+BtPA1RRw4Nigf336r+"
                            ...
                            "IjogMjAwMDAwMDAwMH0=";
const uint8_t kSampleTokenSignature[] = { 0xe4, 0x7f, 0xd6, 0x68, 0x3e, 0xff, 0x0e, 0x51, 0x38, 0xb3, 0x79, 0xe0, 0xe9, 0x36, 0xd2, 0xb0, 0x29, 0x2b, 0x7a,
    0x29, 0x81, 0x1e, 0xd3, 0xab, 0xd6, 0x5f, 0xce, 0x10, 0x13, 0x42, 0x69, 0xc2, 0x6b, 0xe0, 0x6d, 0x3c, 0x0d, 0x51, 0x47, 0x0e, 0x0d, 0x8a, 0x07, 0xf7, 0xdf,
    0xaa, 0xfe, 0x3b, 0x87, 0xcc, 0xdd, 0x26, 0xbe, 0x30, 0x47, 0x7e, 0xe4, 0x97, 0x08, 0x81, 0x26, 0x5a, 0x7f, 0x0f };

// The expiry time of the sample token (2033-05-18 03:33:20 UTC).
const base::Time kSampleTokenExpiryTime = base::Time::FromMillisecondsSinceUnixEpoch(2000000000000);
...
const char kSampleToken2[] = "Ar3e2ev1rH7T/5NRr/9g/ehLLk7dXBi4mjluPG7pohGifzTJCgBtuGhgJXO/8tD/"
...
const char kExpiredToken[] = "AmHPUIXMaXe9jWW8kJeDFXolVjT93p4XMnK4+jMYd2pjqtFcYB1bUmdD8PunQKM+"
                             ...
                             "eGFtcGxlLmNvbTo0NDMiLCAiZmVhdHVyZSI6ICJGcm9idWxhdGUiLCAiZXhwaXJ5"
                             "IjogMTAwMDAwMDAwMH0=";
const uint8_t kExpiredTokenSignature[] = { 0x61, 0xcf, 0x50, 0x85, 0xcc, 0x69, 0x77, 0xbd, 0x8d, 0x65, 0xbc, 0x90, 0x97, 0x83, 0x15, 0x7a, 0x25, 0x56, 0x34,
    0xfd, 0xde, 0x9e, 0x17, 0x32, 0x72, 0xb8, 0xfa, 0x33, 0x18, 0x77, 0x6a, 0x63, 0xaa, 0xd1, 0x5c, 0x60, 0x1d, 0x5b, 0x52, 0x67, 0x43, 0xf0, 0xfb, 0xa7, 0x40,
    0xa3, 0x3e, 0x46, 0xb3, 0xad, 0x94, 0x0c, 0x1a, 0xd2, 0x03, 0xea, 0xaa, 0x7f, 0x80, 0xf0, 0x64, 0xc3, 0xdc, 0x04 };
...
const char kThirdPartyToken[] = "A51LHxdQmDueLf8V89ayrd5I0A2xatWl3Eu7feXlCYOTMQJgFznqw8CTmawLphLz"
...
//  --expire-timestamp=2000000000
const char kThirdPartyUsageSubsetToken[] = "A3mGpVqzEea9V9Nl6Qr2LS84PxTf2ZnWdtU6cNZvGmX1rRX5khvJSYuYSCP0J8Ca"
...
const char kUsageSubsetToken[] = "Axi0wjIp8gaGr/"
...
//  --expire-timestamp=2000000000
const char kExpiryGracePeriodToken[] = "A2AVLsM2Set66KCwTfxH1ni9v8Jcs685qHKDLGam1LmpvnJE9GhYQwbLid3Xlqs/"
...
//  --is-third-party --expire-timestamp=2000000000
const char kExpiryGracePeriodThirdPartyToken[] = "AwLU1cK4P3vWskpAlt5cSiiLl9QOJBeVIQEu5ZFJWEZRFSk7zckx8K6MCa+WZ3cU"
...
//  --expire-timestamp=2000000000
const char kUnknownFeatureToken[] = "AxjosEuqWyp9mrBFMOHJtO84YyY4QYuJ6TUNBMVzKMUWPE+B7Nwg2kgZKGO+"
...
// generate_token.py valid.example.com Grokalyze
//  --is-third-party --expire-timestamp=2000000000
const char kUnknownFeatureThirdPartyToken[] = "A7BJkSTbLJ8/EM61BwStBGK3+hAnss/"
...
// --is-third-party --expire-timestamp=2000000000
const char kThirdPartyTokenForNonThirdPartyTrial[] = "AzZhTxsmsC9fGlNnLEwMuo88WpNjUCDWRzP9NGyP854gRMcvTvbpO1OzEMwbyFeC"
...
// --expire-timestamp=2000000000
const char kDeprecationInsecureToken[] = "A1k7VFKXf+PKrR4J+QPP/pzXmDGKpYqFvWtGxAP0MZoV37/o/Eu1az8ivCp4Z9le"
...
// --is-third-party --expire-timestamp=2000000000
const char kThirdPartyInsecureToken[] = "AxlhBSHLsMiWo84CUgo6vejsWrVDLB1v6oyNxVMvY9Yb9ccf6/1CmDnEEp/vuGk0"
...
const char kSubdomainToken[] = "A6Q929l21zbxF8lhVu75RktCi6DIz9tcVTDFCeH752NfJ8cIs4dJjp8xLKRtbPgS"
...
const char kThirdPartySubdomainToken[] = "A+rkIJ7LrKWl0fV+V4Wp5eolmX62Q8IAQgXvHV/DxKVsPjROQPuy9tMkrTgRdHto"
...
// --is-subdomain --is-third-party --expire-timestamp=2000000000
const char kThirdPartyInsecureSubdomainToken[] = "A09GOcBObv3Ltpr5tt+sKE16irURhADqX6p+cLIs/pHHmciM8QYJ2YT7JHqGoSsm"
...
public:
    ...
    const std::vector<blink::OriginTrialPublicKey>& GetPublicKeys() const override
    {
        return keys_;
    }
...
public:
    TrialTokenValidatorTest()
        ...
        , valid_token_signature_(std::string(reinterpret_cast<const char*>(kSampleTokenSignature), std::size(kSampleTokenSignature)))
        , expired_token_signature_(std::string(reinterpret_cast<const char*>(kExpiredTokenSignature), std::size(kExpiredTokenSignature)))
        , response_headers_(new net::HttpResponseHeaders(""))
    {
        TrialTokenValidator::SetOriginTrialPolicyGetter(base::BindRepeating([](OriginTrialPolicy* policy) { return policy; }, base::Unretained(&policy_)));
    ...
    std::vector<TrialTokenValidator::OriginInfo> WithInfo(base::span<const url::Origin> origins) const
    {
...
public:
    ...
    virtual TrialTokenResult Validate(std::string_view token, const url::Origin& origin, base::Time timestamp) const
    {
        return validator_->ValidateToken(token, origin, timestamp);
    }

    virtual TrialTokenResult Validate(
        std::string_view token, const url::Origin& origin, base::span<const url::Origin> script_origins, base::Time timestamp) const
    {
...
public:
    explicit ValidateTokenAndTrialWrapper(const blink::TrialTokenValidator& validator)
        : ValidateTokenWrapper(validator)
    {
    }
    ~ValidateTokenAndTrialWrapper() override = default;

    TrialTokenResult Validate(std::string_view token, const url::Origin& origin, base::Time timestamp) const override
    {
        return validator_->ValidateTokenAndTrial(token, origin, timestamp);
    }

    TrialTokenResult Validate(
        std::string_view token, const url::Origin& origin, base::span<const url::Origin> script_origins, base::Time timestamp) const override
    {
        return validator_->ValidateTokenAndTrial(token, origin, script_origins, timestamp);
    }
};

class ValidateTokenAndTrialWithOriginInfoWrapper : public ValidateTokenWrapper {
public:
    explicit ValidateTokenAndTrialWithOriginInfoWrapper(const blink::TrialTokenValidator& validator)
        : ValidateTokenWrapper(validator)
    {
    }
    ...
    TrialTokenResult Validate(std::string_view token, const url::Origin& origin, base::Time timestamp) const override
    {
        return validator_->ValidateTokenAndTrialWithOriginInfo(token, TrialTokenValidator::OriginInfo(origin), {}, timestamp);
    }
        ...
        std::string_view token, const url::Origin& origin, base::span<const url::Origin> script_origins, base::Time timestamp) const override
    {
        ...
        return validator_->ValidateTokenAndTrialWithOriginInfo(token, TrialTokenValidator::OriginInfo(origin), info, timestamp);
    }
};
...
public:
    ...
    virtual std::unique_ptr<const ValidateTokenWrapper> CreateWrapper(const blink::TrialTokenValidator& validator) const
    {
...
public:
    ...
    std::unique_ptr<const ValidateTokenWrapper> CreateWrapper(const blink::TrialTokenValidator& validator) const override
    {
        return std::make_unique<ValidateTokenAndTrialWrapper>(validator);
    }
};

class ValidateTokenAndTrialWithOriginInfoWrapperFactory : public ValidateTokenWrapperFactory {
public:
    ~ValidateTokenAndTrialWithOriginInfoWrapperFactory() override = default;
    std::unique_ptr<const ValidateTokenWrapper> CreateWrapper(const blink::TrialTokenValidator& validator) const override
    {
        return std::make_unique<ValidateTokenAndTrialWithOriginInfoWrapper>(validator);
    }
};
...
class TrialTokenValidatorEquivalenceTest : public TrialTokenValidatorTest, public testing::WithParamInterface<ValidateTokenWrapperFactory> {
public:
    ...
    TrialTokenResult Validate(std::string_view token, const url::Origin& origin, base::Time timestamp) const
    {
        return validator_wrapper_->Validate(token, origin, timestamp);
    }

    TrialTokenResult Validate(std::string_view token, const url::Origin& origin, base::span<const url::Origin> script_origins, base::Time timestamp) const
    {
        return validator_wrapper_->Validate(token, origin, script_origins, timestamp);
    }
...
INSTANTIATE_TEST_SUITE_P(TrialTokenValidatorTest, TrialTokenValidatorEquivalenceTest,
    testing::Values(ValidateTokenWrapperFactory(), ValidateTokenAndTrialWrapperFactory(), ValidateTokenAndTrialWithOriginInfoWrapperFactory()));
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidateValidToken)
{
    ...
    TrialTokenResult result2 = Validate(kSampleToken2, appropriate_origin_, Now());
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidateThirdPartyToken)
{
    ...
    TrialTokenResult result = Validate(kThirdPartyToken, appropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidateThirdPartyTokenFromExternalScript)
{
    url::Origin third_party_origins[] = { appropriate_origin_ };
    TrialTokenResult result = Validate(kThirdPartyToken, inappropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(blink::OriginTrialTokenStatus::kSuccess, result.Status());
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidateThirdPartyTokenFromMultipleExternalScripts)
{
    url::Origin third_party_origins[] = { inappropriate_origin_, appropriate_origin_ };
    TrialTokenResult result = Validate(kThirdPartyToken, inappropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(blink::OriginTrialTokenStatus::kSuccess, result.Status());
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidateThirdPartyTokenFromInappropriateScriptOrigin)
{
    url::Origin third_party_origins[] = { inappropriate_origin_ };
    EXPECT_EQ(blink::OriginTrialTokenStatus::kWrongOrigin, Validate(kThirdPartyToken, appropriate_origin_, third_party_origins, Now()).Status());
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidateThirdPartyTokenFromMultipleInappropriateScriptOrigins)
{
...
{
    EXPECT_EQ(blink::OriginTrialTokenStatus::kWrongOrigin, Validate(kThirdPartyToken, appropriate_origin_, base::span<const url::Origin> {}, Now()).Status());
    std::vector<url::Origin> empty_origin_list;
    EXPECT_EQ(blink::OriginTrialTokenStatus::kWrongOrigin, Validate(kThirdPartyToken, appropriate_origin_, empty_origin_list, Now()).Status());
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidateInappropriateOrigin)
{
    TrialTokenResult inappropriate_result = Validate(kSampleToken, inappropriate_origin_, Now());
    EXPECT_EQ(inappropriate_result.Status(), blink::OriginTrialTokenStatus::kWrongOrigin);
    EXPECT_NE(inappropriate_result.ParsedToken(), nullptr);

    TrialTokenResult insecure_result = Validate(kSampleToken, insecure_origin_, Now());
    EXPECT_EQ(insecure_result.Status(), blink::OriginTrialTokenStatus::kWrongOrigin);
    EXPECT_NE(insecure_result.ParsedToken(), nullptr);
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidateInvalidSignature)
{
    TrialTokenResult result = Validate(kInvalidSignatureToken, appropriate_origin_, Now());
...
{
    TrialTokenResult result = Validate(kUnparsableToken, appropriate_origin_, Now());
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidatorRespectsDisabledFeatures)
{
    ...
    EXPECT_EQ(blink::OriginTrialTokenStatus::kFeatureDisabled, Validate(kSampleToken, appropriate_origin_, Now()).Status());
}
TEST_P(TrialTokenValidatorEquivalenceTest, ValidatorRespectsDisabledFeaturesForUserWithFirstPartyToken)
{
    // Token should be valid if the feature is not disabled for user.
    TrialTokenResult result = Validate(kUsageSubsetToken, appropriate_origin_, Now());
    EXPECT_EQ(blink::OriginTrialTokenStatus::kSuccess, result.Status());
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    // Token should be invalid when the feature is disabled for user.
    DisableFeatureForUser(kAppropriateThirdPartyFeatureName);
    EXPECT_EQ(blink::OriginTrialTokenStatus::kFeatureDisabledForUser, Validate(kUsageSubsetToken, appropriate_origin_, Now()).Status());
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidatorRespectsDisabledFeaturesForUserWithThirdPartyToken)
{
    // Token should be valid if the feature is not disabled for user.
    url::Origin third_party_origins[] = { appropriate_origin_ };
    TrialTokenResult result = Validate(kThirdPartyUsageSubsetToken, inappropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(blink::OriginTrialTokenStatus::kSuccess, result.Status());
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    // Token should be invalid when the feature is disabled for user.
    ...
    EXPECT_EQ(blink::OriginTrialTokenStatus::kFeatureDisabledForUser,
        Validate(kThirdPartyUsageSubsetToken, inappropriate_origin_, third_party_origins, Now()).Status());
}
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidatorRespectsDisabledTokens)
{
    ...
    EXPECT_EQ(blink::OriginTrialTokenStatus::kTokenDisabled, Validate(kSampleToken, appropriate_origin_, Now()).Status());
}
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidateValidExpiryGraceToken)
{
    ...
    auto current_time = kSampleTokenExpiryTime + kExpiryGracePeriod - base::Days(1);
    TrialTokenResult result = Validate(kExpiryGracePeriodToken, appropriate_origin_, current_time);
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidateValidExpiryGraceThirdPartyToken)
{
    url::Origin third_party_origins[] = { appropriate_origin_ };
    // This token is valid one day before the end of the expiry grace period,
    // even though it is past the token's expiry time.
    auto current_time = kSampleTokenExpiryTime + kExpiryGracePeriod - base::Days(1);
    TrialTokenResult result = Validate(kExpiryGracePeriodThirdPartyToken, appropriate_origin_, third_party_origins, current_time);
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    EXPECT_TRUE(result.ParsedToken()->is_third_party());
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidateExpiredExpiryGraceThirdPartyToken)
{
    url::Origin third_party_origins[] = { appropriate_origin_ };
    // This token is expired at the end of the expiry grace period.
    auto current_time = kSampleTokenExpiryTime + kExpiryGracePeriod;
...
{
    TrialTokenResult result = Validate(kSubdomainToken, appropriate_origin_, {}, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    EXPECT_TRUE(result.ParsedToken()->match_subdomains());
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidateSubdomainTokenUnrelatedOrigin)
{
    // A subdomain token should not match against an unrelated origin
    TrialTokenResult result = Validate(kSubdomainToken, unrelated_origin_, {}, Now());
...
TEST_P(TrialTokenValidatorEquivalenceTest, ValidateThirdPartySubdomainToken)
{
    ...
    TrialTokenResult result = Validate(kThirdPartySubdomainToken, unrelated_origin_, script_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    EXPECT_TRUE(result.ParsedToken()->match_subdomains());
}

TEST_P(TrialTokenValidatorEquivalenceTest, ValidateThirdPartySubdomainTokenInsecureOrigin)
{
...
TEST_F(TrialTokenValidatorTest, ValidateRequestInsecure)
{
    ...
    EXPECT_FALSE(validator_.RequestEnablesFeature(GURL(kInsecureOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
}
...
TEST_F(TrialTokenValidatorTest, ValidateRequestForDeprecationInsecure)
{
    ...
    EXPECT_TRUE(validator_.RequestEnablesDeprecatedFeature(GURL(kInsecureOrigin), response_headers_.get(), kAppropriateDeprecationFeatureName, Now()));
}

TEST_F(TrialTokenValidatorTest, ValidateRequestValidToken)
{
    response_headers_->AddHeader("Origin-Trial", kSampleToken);
    EXPECT_TRUE(validator_.RequestEnablesFeature(GURL(kAppropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
}

TEST_F(TrialTokenValidatorTest, ValidateRequestForDeprecationValidToken)
{
    response_headers_->AddHeader("Origin-Trial", kSampleToken);
    EXPECT_TRUE(validator_.RequestEnablesDeprecatedFeature(GURL(kAppropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
}

TEST_F(TrialTokenValidatorTest, ValidateRequestNoTokens)
{
    EXPECT_FALSE(validator_.RequestEnablesFeature(GURL(kAppropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
}

TEST_F(TrialTokenValidatorTest, ValidateRequestForDeprecationNoTokens)
{
    EXPECT_FALSE(validator_.RequestEnablesDeprecatedFeature(GURL(kAppropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
}
...
TEST_F(TrialTokenValidatorTest, ValidateRequestMultipleHeaders)
{
    ...
    EXPECT_TRUE(validator_.RequestEnablesFeature(GURL(kAppropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
    EXPECT_FALSE(validator_.RequestEnablesFeature(GURL(kAppropriateOrigin), response_headers_.get(), kInappropriateFeatureName, Now()));
    EXPECT_FALSE(validator_.RequestEnablesFeature(GURL(kInappropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
}

TEST_F(TrialTokenValidatorTest, ValidateRequestMultipleHeaderValues)
{
    response_headers_->AddHeader("Origin-Trial", std::string(kExpiredToken) + ", " + kSampleToken);
    EXPECT_TRUE(validator_.RequestEnablesFeature(GURL(kAppropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
    EXPECT_FALSE(validator_.RequestEnablesFeature(GURL(kAppropriateOrigin), response_headers_.get(), kInappropriateFeatureName, Now()));
    EXPECT_FALSE(validator_.RequestEnablesFeature(GURL(kInappropriateOrigin), response_headers_.get(), kAppropriateFeatureName, Now()));
}
...
TEST_F(TrialTokenValidatorTest, ValidateUnknownFeatureToken)
{
    ...
    TrialTokenResult result = validator_.ValidateToken(kUnknownFeatureToken, appropriate_origin_, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kInappropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrial(kUnknownFeatureToken, appropriate_origin_, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kUnknownTrial);
    EXPECT_EQ(kInappropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrialWithOriginInfo(kUnknownFeatureToken, WithInfo(appropriate_origin_), {}, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kUnknownTrial);
    EXPECT_EQ(kInappropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}
...
TEST_F(TrialTokenValidatorTest, ValidateUnknownFeatureThirdPartyToken)
{
    ...
    result = validator_.ValidateTokenAndTrial(kUnknownFeatureThirdPartyToken, appropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kUnknownTrial);
    EXPECT_EQ(kInappropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    EXPECT_EQ(true, result.ParsedToken()->is_third_party());
    ...
    result
        = validator_.ValidateTokenAndTrialWithOriginInfo(kUnknownFeatureThirdPartyToken, WithInfo(appropriate_origin_), WithInfo(third_party_origins), Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kUnknownTrial);
    EXPECT_EQ(kInappropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    EXPECT_EQ(true, result.ParsedToken()->is_third_party());
...
TEST_F(TrialTokenValidatorTest, ValidateInsecureToken)
{
    ...
    // trial allows it
    TrialTokenResult result = validator_.ValidateToken(kInsecureOriginToken, insecure_origin_, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kAppropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrial(kInsecureOriginToken, insecure_origin_, Now());
    ...
    result = validator_.ValidateTokenAndTrialWithOriginInfo(kInsecureOriginToken, WithInfo(insecure_origin_), {}, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}

TEST_F(TrialTokenValidatorTest, ValidateThirdPartyTokenForNonThirdPartyFeature)
{
    ...
    url::Origin third_party_origins[] = { appropriate_origin_ };
    TrialTokenResult result = validator_.ValidateToken(kThirdPartyTokenForNonThirdPartyTrial, appropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kAppropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    EXPECT_EQ(true, result.ParsedToken()->is_third_party());

    result = validator_.ValidateTokenAndTrial(kThirdPartyTokenForNonThirdPartyTrial, appropriate_origin_, third_party_origins, Now());
    ...
    result = validator_.ValidateTokenAndTrialWithOriginInfo(
        kThirdPartyTokenForNonThirdPartyTrial, WithInfo(appropriate_origin_), WithInfo(third_party_origins), Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kFeatureDisabled);
    EXPECT_EQ(kAppropriateFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
    EXPECT_EQ(true, result.ParsedToken()->is_third_party());
...
TEST_F(TrialTokenValidatorTest, ValidateInsecureThirdPartyToken)
{
    ...
    TrialTokenResult result = validator_.ValidateToken(kThirdPartyInsecureToken, appropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrial(kThirdPartyInsecureToken, appropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrialWithOriginInfo(kThirdPartyInsecureToken, WithInfo(appropriate_origin_), WithInfo(third_party_origins), Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}
...
TEST_F(TrialTokenValidatorTest, ValidateInsecureThirdPartyTokenInsecureOrigin)
{
    ...
    url::Origin third_party_origins[] = { inappropriate_origin_, appropriate_origin_ };
    TrialTokenResult result = validator_.ValidateToken(kThirdPartyToken, insecure_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrial(kThirdPartyToken, insecure_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrialWithOriginInfo(kThirdPartyToken, WithInfo(insecure_origin_), WithInfo(third_party_origins), Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}

TEST_F(TrialTokenValidatorTest, ValidateInsecureThirdPartyTokenMultipleOrigins)
{
    // An insecure third-party token is valid against insecure origins,
...
TEST_F(TrialTokenValidatorTest, ValidateThirdPartyTokenInsecureOrigin)
{
    ...
    TrialTokenResult result = validator_.ValidateToken(kThirdPartyInsecureSubdomainToken, appropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kSuccess);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrial(kThirdPartyInsecureSubdomainToken, appropriate_origin_, third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());

    result = validator_.ValidateTokenAndTrialWithOriginInfo(
        kThirdPartyInsecureSubdomainToken, WithInfo(appropriate_origin_), WithInfo(third_party_origins), Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}
...
{
    TrialTokenValidator::OriginInfo insecure_origin_info(appropriate_origin_, false);
    TrialTokenResult result = validator_.ValidateTokenAndTrialWithOriginInfo(kSampleToken, insecure_origin_info, {}, Now());
...
TEST_F(TrialTokenValidatorTest, ValidateInsecureOriginThirdPartyOriginInfo)
{
    ...
    TrialTokenValidator::OriginInfo insecure_origin_info(appropriate_origin_, false);
    url::Origin third_party_origins[] = { appropriate_origin_ };
    TrialTokenResult result = validator_.ValidateTokenAndTrialWithOriginInfo(kThirdPartyToken, insecure_origin_info, WithInfo(third_party_origins), Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}

TEST_F(TrialTokenValidatorTest, ValidateInsecureThirdPartyOriginThirdPartyOriginInfo)
{
    // Third-party tokens should not be secure if the third-party origin is
    // insecure
    TrialTokenValidator::OriginInfo insecure_origin_info(appropriate_origin_, false);
    TrialTokenValidator::OriginInfo insecure_third_parties[] = { insecure_origin_info };
    TrialTokenResult result = validator_.ValidateTokenAndTrialWithOriginInfo(kThirdPartyToken, WithInfo(appropriate_origin_), insecure_third_parties, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}

TEST_F(TrialTokenValidatorTest, ValidateMultipleInsecureThirdPartyOriginThirdPartyOriginInfo)
{
    // Third-party tokens should not be secure if the third-party origin is
    // insecure, even if there are other, secure, third-party origins
    TrialTokenValidator::OriginInfo insecure_origin_info(appropriate_origin_, false);

    TrialTokenValidator::OriginInfo third_party_origins[] = { WithInfo(inappropriate_origin_), // Secure, but not appropriate
        insecure_origin_info };
    TrialTokenResult result = validator_.ValidateTokenAndTrialWithOriginInfo(kThirdPartyToken, WithInfo(appropriate_origin_), third_party_origins, Now());
    EXPECT_EQ(result.Status(), blink::OriginTrialTokenStatus::kInsecure);
    EXPECT_EQ(kAppropriateThirdPartyFeatureName, result.ParsedToken()->feature_name());
    EXPECT_EQ(kSampleTokenExpiryTime, result.ParsedToken()->expiry_time());
}
...
TEST_F(TrialTokenValidatorTest, RevalidateTokenInformation)
{
    EXPECT_TRUE(validator_.RevalidateTokenAndTrial(
        kAppropriateFeatureName, kSampleTokenExpiryTime, blink::TrialToken::UsageRestriction::kNone, valid_token_signature_, Now()));
}
...
TEST_F(TrialTokenValidatorTest, RevalidateExpiredToken)
{
    ...
    EXPECT_FALSE(
        validator_.RevalidateTokenAndTrial(kAppropriateFeatureName, expiry, blink::TrialToken::UsageRestriction::kNone, valid_token_signature_, Now()));

    // Check grace period expiration
    EXPECT_TRUE(validator_.RevalidateTokenAndTrial(
        kAppropriateGracePeriodFeatureName, expiry, blink::TrialToken::UsageRestriction::kNone, valid_token_signature_, Now()));
...
TEST_F(TrialTokenValidatorTest, RevalidateDisabledTrialForUser)
{
    ...
    // kSubset
    EXPECT_TRUE(validator_.RevalidateTokenAndTrial(
        kAppropriateThirdPartyFeatureName, kSampleTokenExpiryTime, blink::TrialToken::UsageRestriction::kNone, valid_token_signature_, Now()));

    EXPECT_FALSE(validator_.RevalidateTokenAndTrial(
        kAppropriateThirdPartyFeatureName, kSampleTokenExpiryTime, blink::TrialToken::UsageRestriction::kSubset, valid_token_signature_, Now()));
}
...
TEST_F(TrialTokenValidatorTest, XRWTrialAllowedForAll3POrigins)
{
    ...
    const char kXRW1PToken[] = "Ay6L+HCN2v3sAGUg/"
    ...
    // WebViewXRequestedWithDeprecation --expire-timestamp=2000000000
    // --is-third-party
    const char kXRW3PToken[] = "AwINH5I2lshWrnPvEqz1KRya3QU2Zx5djBDcr7Q5CnnccjUgNtWaAecPL26JnZlvye3WgAz6"
    ...
    // result.
    TrialTokenResult firstPartyResult = validator_.ValidateTokenAndTrial(kXRW1PToken, inappropriate_origin_, scriptOrigins, Now());
    EXPECT_EQ(blink::OriginTrialTokenStatus::kWrongOrigin, firstPartyResult.Status());

    // For this trial only, we have disabled the origin check on third-party
    // tokens. See |trial_token.cc|.
    TrialTokenResult thirdPartyResult = validator_.ValidateTokenAndTrial(kXRW3PToken, inappropriate_origin_, scriptOrigins, Now());
