...
const char kSampleTokenV2[] = "Ap+Q/Qm0ELadZql+dlEGSwnAVsFZKgCEtUZg8idQC3uekkIeSZIY1tftoYdrwhqj"
                              ...
                              "IjogMTQ1ODc2NjI3N30=";
const uint8_t kSampleTokenV2Signature[] = { 0x9f, 0x90, 0xfd, 0x09, 0xb4, 0x10, 0xb6, 0x9d, 0x66, 0xa9, 0x7e, 0x76, 0x51, 0x06, 0x4b, 0x09, 0xc0, 0x56, 0xc1,
    0x59, 0x2a, 0x00, 0x84, 0xb5, 0x46, 0x60, 0xf2, 0x27, 0x50, 0x0b, 0x7b, 0x9e, 0x92, 0x42, 0x1e, 0x49, 0x92, 0x18, 0xd6, 0xd7, 0xed, 0xa1, 0x87, 0x6b, 0xc2,
    0x1a, 0xa3, 0xec, 0x53, 0xb9, 0x2f, 0x6d, 0xac, 0x36, 0xf9, 0x19, 0x66, 0x76, 0x9c, 0x2e, 0xf9, 0x9f, 0x37, 0x0b };

// This is a good trial token, signed with the above test private key.
// Generate this token with the command (in tools/origin_trials):
// generate_token.py valid.example.com 3 Frobulate --expire-timestamp=1458766277
const char kSampleTokenV3[] = "A79AvyC9SLsjuRTUsjIeGmEfw8Ow0pZSoFtHs8qtrAhUKSNbluCYo86D4M3F6bco"
                              "F2BOyjyI7mEWztV+HQvxUAsAAABZeyJvcmlnaW4iOiAiaHR0cHM6Ly92YWxpZC5l"
                              "eGFtcGxlLmNvbTo0NDMiLCAiZmVhdHVyZSI6ICJGcm9idWxhdGUiLCAiZXhwaXJ5"
                              "IjogMTQ1ODc2NjI3N30=";
const uint8_t kSampleTokenV3Signature[] = { 0xbf, 0x40, 0xbf, 0x20, 0xbd, 0x48, 0xbb, 0x23, 0xb9, 0x14, 0xd4, 0xb2, 0x32, 0x1e, 0x1a, 0x61, 0x1f, 0xc3, 0xc3,
    0xb0, 0xd2, 0x96, 0x52, 0xa0, 0x5b, 0x47, 0xb3, 0xca, 0xad, 0xac, 0x08, 0x54, 0x29, 0x23, 0x5b, 0x96, 0xe0, 0x98, 0xa3, 0xce, 0x83, 0xe0, 0xcd, 0xc5, 0xe9,
    0xb7, 0x28, 0x17, 0x60, 0x4e, 0xca, 0x3c, 0x88, 0xee, 0x61, 0x16, 0xce, 0xd5, 0x7e, 0x1d, 0x0b, 0xf1, 0x50, 0x0b };
...
const uint8_t kSampleSubdomainTokenSignature[] = { 0xeb, 0xbe, 0x8f, 0xd9, 0xd7, 0x01, 0x0a, 0x32, 0xe7, 0xeb, 0x74, 0xd0, 0xc8, 0x96, 0x6a, 0x46, 0x70, 0x14,
    0x4c, 0x5c, 0x74, 0xd0, 0xbc, 0x10, 0xd9, 0x11, 0x74, 0xad, 0x60, 0x2f, 0x83, 0x8c, 0x14, 0x74, 0xb4, 0x01, 0xb6, 0x42, 0xb1, 0xcb, 0x25, 0x0d, 0x37, 0x0f,
    0xd5, 0xf8, 0xcd, 0x16, 0x3a, 0x5b, 0x99, 0x01, 0xbe, 0x54, 0x23, 0xe4, 0xd4, 0xda, 0xe5, 0x75, 0x55, 0xd9, 0x9e, 0x0e };
...
const uint8_t kSampleNonSubdomainTokenSignature[] = { 0xb7, 0x83, 0xf7, 0xbf, 0x43, 0xee, 0xd3, 0xb4, 0x96, 0xe4, 0x99, 0x4e, 0xbd, 0x7e, 0xff, 0xe2, 0x7a,
    0x13, 0x44, 0x92, 0x8f, 0xf1, 0x84, 0x53, 0x22, 0xca, 0xe3, 0x5a, 0x35, 0x85, 0x71, 0x73, 0x5f, 0x0d, 0x51, 0xed, 0x9d, 0x61, 0x08, 0x31, 0xec, 0xd2, 0x05,
    0xd6, 0x55, 0x2b, 0xb5, 0x96, 0xf1, 0xf9, 0xd9, 0x68, 0xa7, 0xbf, 0x2d, 0xfd, 0xb4, 0x76, 0xec, 0x53, 0x68, 0x09, 0x25, 0x06 };
...
//   --expire-timestamp=1458766277
const char kSampleThirdPartyToken[] = "A9+2NjaYsaFkwtULzbWjcsSJiXD0LuoOgma9fET8hq1uEqVcNyqjGH4ExpF7mYUk"
                                      ...
                                      "OiAiRnJvYnVsYXRlIiwgImV4cGlyeSI6IDE0NTg3NjYyNzd9";
const uint8_t kSampleThirdPartyTokenSignature[] = { 0xdf, 0xb6, 0x36, 0x36, 0x98, 0xb1, 0xa1, 0x64, 0xc2, 0xd5, 0x0b, 0xcd, 0xb5, 0xa3, 0x72, 0xc4, 0x89, 0x89,
    0x70, 0xf4, 0x2e, 0xea, 0x0e, 0x82, 0x66, 0xbd, 0x7c, 0x44, 0xfc, 0x86, 0xad, 0x6e, 0x12, 0xa5, 0x5c, 0x37, 0x2a, 0xa3, 0x18, 0x7e, 0x04, 0xc6, 0x91, 0x7b,
    0x99, 0x85, 0x24, 0x8a, 0xb7, 0x98, 0xa2, 0xf5, 0xaa, 0x3b, 0x0b, 0x19, 0x13, 0x28, 0x97, 0xe9, 0xea, 0x1d, 0x7f, 0x0e };
...
//   --expire-timestamp=1458766277
const char kSampleNonThirdPartyToken[] = "Ay0uBIEXlhMfvS43Z+m8bgeqnnZq27xV4OG13d+bkyGuCKx6Wa+hSkLkk6OStg+D"
...
const uint8_t kSampleNonThirdPartyTokenSignature[] = { 0x2d, 0x2e, 0x04, 0x81, 0x17, 0x96, 0x13, 0x1f, 0xbd, 0x2e, 0x37, 0x67, 0xe9, 0xbc, 0x6e, 0x07, 0xaa,
    0x9e, 0x76, 0x6a, 0xdb, 0xbc, 0x55, 0xe0, 0xe1, 0xb5, 0xdd, 0xdf, 0x9b, 0x93, 0x21, 0xae, 0x08, 0xac, 0x7a, 0x59, 0xaf, 0xa1, 0x4a, 0x42, 0xe4, 0x93, 0xa3,
    0x92, 0xb6, 0x0f, 0x83, 0x97, 0xca, 0x51, 0x76, 0xa5, 0x06, 0xd7, 0xd0, 0x61, 0x5a, 0x78, 0xb3, 0x9f, 0x94, 0xdb, 0x28, 0x03 };
...
const char kSampleThirdPartyUsageSubsetToken[] = "A27Ee1Bm6HYjEu2Zz1DbGNUaPuM8x0Tnk15Gyx8TRKZg72+JUXgCccMxlLIjVh4l"
                                                 ...
                                                 "NzY2Mjc3fQ==";
const uint8_t kSampleThirdPartyUsageSubsetTokenSignature[] = { 0x6e, 0xc4, 0x7b, 0x50, 0x66, 0xe8, 0x76, 0x23, 0x12, 0xed, 0x99, 0xcf, 0x50, 0xdb, 0x18, 0xd5,
    0x1a, 0x3e, 0xe3, 0x3c, 0xc7, 0x44, 0xe7, 0x93, 0x5e, 0x46, 0xcb, 0x1f, 0x13, 0x44, 0xa6, 0x60, 0xef, 0x6f, 0x89, 0x51, 0x78, 0x02, 0x71, 0xc3, 0x31, 0x94,
    0xb2, 0x23, 0x56, 0x1e, 0x25, 0x7a, 0x73, 0x84, 0x4b, 0x9f, 0x2d, 0x7c, 0x9c, 0x6b, 0x44, 0x2a, 0x2b, 0x04, 0x02, 0xa6, 0x07, 0x07 };
...
const char kSampleThirdPartyUsageEmptyToken[] = "A+gXf6yZgfN8NADWvnEhQ/GKycwCg34USmDlQ9UXTP6jDGJLBV+jI1npSUI0W/YW"
                                                ...
                                                "fQ==";
const uint8_t kSampleThirdPartyUsageEmptyTokenSignature[] = { 0xe8, 0x17, 0x7f, 0xac, 0x99, 0x81, 0xf3, 0x7c, 0x34, 0x00, 0xd6, 0xbe, 0x71, 0x21, 0x43, 0xf1,
    0x8a, 0xc9, 0xcc, 0x02, 0x83, 0x7e, 0x14, 0x4a, 0x60, 0xe5, 0x43, 0xd5, 0x17, 0x4c, 0xfe, 0xa3, 0x0c, 0x62, 0x4b, 0x05, 0x5f, 0xa3, 0x23, 0x59, 0xe9, 0x49,
    0x42, 0x34, 0x5b, 0xf6, 0x16, 0x84, 0xdc, 0x8d, 0x61, 0xbc, 0xc1, 0x68, 0x4d, 0xa2, 0x08, 0x94, 0x86, 0x08, 0x3e, 0x7a, 0xa7, 0x0c };
...
const char kExpectedLongFeatureName[] = "ThisTrialNameIs100CharactersLongIncludingPaddingAAAAAAAAAAAAAAAAAAAAAAAAAA"
...
const char kUsageEmptyTokenJSON[] = "{\"origin\": \"https://valid.example.com:443\", \"usage\": \"\", "
                                    "\"feature\": \"Frobulate\", \"expiry\": 1458766277}";

const char kUsageSubsetTokenJSON[] = "{\"origin\": \"https://valid.example.com:443\", \"usage\": \"subset\", "
                                     "\"feature\": \"Frobulate\", \"expiry\": 1458766277}";

const char kSampleNonThirdPartyTokenJSON[] = "{\"origin\": \"https://valid.example.com:443\", \"isThirdParty\": false, "
                                             "\"feature\": \"Frobulate\", \"expiry\": 1458766277}";

const char kSampleThirdPartyTokenJSON[] = "{\"origin\": \"https://valid.example.com:443\", \"isThirdParty\": true, "
                                          "\"feature\": \"Frobulate\", \"expiry\": 1458766277}";

const char kSampleThirdPartyTokenUsageSubsetJSON[] = "{\"origin\": \"https://valid.example.com:443\", \"isThirdParty\": true, "
                                                     "\"usage\": \"subset\", \"feature\": \"Frobulate\", \"expiry\": "
                                                     "1458766277}";

const char kSampleThirdPartyTokenUsageEmptyJSON[] = "{\"origin\": \"https://valid.example.com:443\", \"isThirdParty\": true, "
...
const char kLargeTokenJSON[] = "{\"origin\": "
                               "\"https://"
                               "www."
...
const char kExpectedLongTokenOrigin[] = "https://"
                                        "www."
                                        "AAAt2VqC9eTDzZ8JJw42R4kfIDABQp37GWLUZ33tOzPJvvcLzkD5TAmW2wYl1mZoxI76VrgN3A"
                                        "RPNHfpJErLpFom3zxlE8mGbShqZMi9sSW1ezCqOPi2Rg5IaFA4ev1bbBkt62UmOXZXkcRfZSba"
                                        "htONHOTHsiATjUPzbO8IFpmJQVKQk8kepGiJAKkLHs65GiKJzfRBTBK1w63vUfsNOj1A4BNhM5"
...
const char kTooLargeTokenJSON[] = "{\"origin\": "
                                  "\"https://"
                                  "www."
...
const char kLargeValidToken[] = "Aq1wGS1wFPBT/"
                                ...
                                "ODc2NjI3N30=";
const uint8_t kLargeValidTokenSignature[] = { 0xad, 0x70, 0x19, 0x2d, 0x70, 0x14, 0xf0, 0x53, 0xfd, 0x2d, 0x2d, 0x45, 0xb5, 0xc8, 0x84, 0xee, 0x9f, 0x9e, 0xd7,
    0x37, 0x1a, 0xe0, 0xda, 0x70, 0x03, 0xc0, 0x71, 0xf4, 0xc1, 0x33, 0x19, 0x1d, 0x5e, 0x98, 0x17, 0x24, 0xc1, 0x11, 0x55, 0xc5, 0x44, 0x54, 0xd7, 0xd9, 0x02,
    0xed, 0x65, 0x68, 0xa1, 0xe1, 0x31, 0x48, 0xd3, 0xa7, 0x4a, 0x4e, 0x20, 0x18, 0xbf, 0x2b, 0x25, 0x97, 0xac, 0x04 };
...
//   ThisTrialNameIs100CharactersLongIncludingPaddingAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
const char kTooLargeValidToken[] = "AswTUJEo9qF5QaVITkRzMQ+muYHK13+"
...
public:
    TrialTokenTest()
        ...
        , expected_subdomain_origin_(url::Origin::Create(GURL(kExpectedSubdomainOrigin)))
        , expected_multiple_subdomain_origin_(url::Origin::Create(GURL(kExpectedMultipleSubdomainOrigin)))
        ...
        , incorrect_domain_origin_(url::Origin::Create(GURL(kIncorrectDomainOrigin)))
        , invalid_tld_origin_(url::Origin::Create(GURL(kInvalidTLDOrigin)))
        , expected_expiry_(base::Time::FromSecondsSinceUnixEpoch(kExpectedExpiry))
        , valid_timestamp_(base::Time::FromSecondsSinceUnixEpoch(kValidTimestamp))
        , invalid_timestamp_(base::Time::FromSecondsSinceUnixEpoch(kInvalidTimestamp))
        , expected_v2_signature_(std::string(reinterpret_cast<const char*>(kSampleTokenV2Signature), std::size(kSampleTokenV2Signature)))
        , expected_v3_signature_(std::string(reinterpret_cast<const char*>(kSampleTokenV3Signature), std::size(kSampleTokenV3Signature)))
        , expected_subdomain_signature_(std::string(reinterpret_cast<const char*>(kSampleSubdomainTokenSignature), std::size(kSampleSubdomainTokenSignature)))
        , expected_nonsubdomain_signature_(
              std::string(reinterpret_cast<const char*>(kSampleNonSubdomainTokenSignature), std::size(kSampleNonSubdomainTokenSignature)))
        , expected_third_party_signature_(
              std::string(reinterpret_cast<const char*>(kSampleThirdPartyTokenSignature), std::size(kSampleThirdPartyTokenSignature)))
        , expected_non_third_party_signature_(
              std::string(reinterpret_cast<const char*>(kSampleNonThirdPartyTokenSignature), std::size(kSampleNonThirdPartyTokenSignature)))
        , expected_third_party_usage_empty_signature_(
              std::string(reinterpret_cast<const char*>(kSampleThirdPartyUsageEmptyTokenSignature), std::size(kSampleThirdPartyUsageEmptyTokenSignature)))
        , expected_third_party_usage_subset_signature_(
              std::string(reinterpret_cast<const char*>(kSampleThirdPartyUsageSubsetTokenSignature), std::size(kSampleThirdPartyUsageSubsetTokenSignature)))
...
protected:
    OriginTrialTokenStatus Extract(
        const std::string& token_text, const OriginTrialPublicKey& public_key, std::string* token_payload, std::string* token_signature, uint8_t* token_version)
    {
        return TrialToken::Extract(token_text, public_key, token_payload, token_signature, token_version);
    }

    OriginTrialTokenStatus ExtractStatusOnly(const std::string& token_text, const OriginTrialPublicKey& public_key)
    {
        std::string token_payload;
        std::string token_signature;
        uint8_t token_version;
        return Extract(token_text, public_key, &token_payload, &token_signature, &token_version);
    }

    std::unique_ptr<TrialToken> Parse(const std::string& token_payload, const uint8_t token_version)
    {
...
TEST_F(TrialTokenTest, ExtractValidSignatureVersion2)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleTokenV2, correct_public_key(), &token_payload, &token_signature, &token_version);
...
TEST_F(TrialTokenTest, ExtractValidSignatureVersion3)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleTokenV3, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
...
TEST_F(TrialTokenTest, ExtractSubdomainValidSignature)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleSubdomainToken, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
    EXPECT_EQ(kVersion2, token_version);
...
TEST_F(TrialTokenTest, ExtractNonSubdomainValidSignature)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleNonSubdomainToken, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
    EXPECT_EQ(kVersion2, token_version);
...
TEST_F(TrialTokenTest, ExtractThirdPartyValidSignature)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleThirdPartyToken, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
    EXPECT_EQ(kVersion3, token_version);
...
TEST_F(TrialTokenTest, ExtractNonThirdPartyValidSignature)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleNonThirdPartyToken, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
    EXPECT_EQ(kVersion3, token_version);
...
TEST_F(TrialTokenTest, ExtractThirdPartyUsageEmptyValidSignature)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleThirdPartyUsageEmptyToken, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
    EXPECT_EQ(kVersion3, token_version);
...
TEST_F(TrialTokenTest, ExtractThirdPartyUsageSubsetValidSignature)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kSampleThirdPartyUsageSubsetToken, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
    EXPECT_EQ(kVersion3, token_version);
...
{
    OriginTrialTokenStatus status = ExtractStatusOnly(kInvalidSignatureToken, correct_public_key());
    EXPECT_EQ(OriginTrialTokenStatus::kInvalidSignature, status);
}

TEST_F(TrialTokenTest, ExtractSignatureWithIncorrectKey)
{
    OriginTrialTokenStatus status = ExtractStatusOnly(kSampleTokenV2, incorrect_public_key());
    EXPECT_EQ(OriginTrialTokenStatus::kInvalidSignature, status);
}
...
{
    OriginTrialTokenStatus status = ExtractStatusOnly(kTruncatedToken, correct_public_key());
    EXPECT_EQ(OriginTrialTokenStatus::kMalformed, status);
}

TEST_F(TrialTokenTest, ExtractUnsupportedVersion)
{
    OriginTrialTokenStatus status = ExtractStatusOnly(kIncorrectVersionToken, correct_public_key());
    EXPECT_EQ(OriginTrialTokenStatus::kWrongVersion, status);
}

TEST_F(TrialTokenTest, ExtractSignatureWithIncorrectLength)
{
    OriginTrialTokenStatus status = ExtractStatusOnly(kIncorrectLengthToken, correct_public_key());
    EXPECT_EQ(OriginTrialTokenStatus::kMalformed, status);
}
...
TEST_F(TrialTokenTest, ExtractLargeToken)
{
    ...
    std::string token_signature;
    uint8_t token_version;
    OriginTrialTokenStatus status = Extract(kLargeValidToken, correct_public_key(), &token_payload, &token_signature, &token_version);
    ASSERT_EQ(OriginTrialTokenStatus::kSuccess, status);
    EXPECT_EQ(kVersion2, token_version);
    std::string expected_signature(std::string(reinterpret_cast<const char*>(kLargeValidTokenSignature), std::size(kLargeValidTokenSignature)));
    EXPECT_EQ(expected_signature, token_signature);
}

TEST_F(TrialTokenTest, ExtractTooLargeToken)
{
    OriginTrialTokenStatus status = ExtractStatusOnly(kTooLargeValidToken, correct_public_key());
    EXPECT_EQ(OriginTrialTokenStatus::kMalformed, status);
}

// Test parsing of fields from JSON token.
class TrialTokenParseInvalidTest : public TrialTokenTest, public testing::WithParamInterface<std::tuple<const char*, uint8_t>> { };

TEST_P(TrialTokenParseInvalidTest, ParseInvalidString)
{
    std::tuple<const char*, uint8_t> param = GetParam();
    std::unique_ptr<TrialToken> empty_token = Parse(std::get<0>(param), std::get<1>(param));
    EXPECT_FALSE(empty_token) << "Invalid trial token should not parse.";
}

INSTANTIATE_TEST_SUITE_P(
    TrialTokenTest, TrialTokenParseInvalidTest, testing::Combine(testing::ValuesIn(kInvalidTokens), testing::Values(kVersion2, kVersion3)));

class TrialTokenParseInvalidVersion3Test : public TrialTokenTest, public testing::WithParamInterface<const char*> { };
...
INSTANTIATE_TEST_SUITE_P(TrialTokenTest, TrialTokenParseInvalidVersion3Test, testing::ValuesIn(kInvalidTokensVersion3));

// Test parsing of fields from JSON token.
class TrialTokenParseTest : public TrialTokenTest, public testing::WithParamInterface<uint8_t> { };
...
{
    std::unique_ptr<TrialToken> token = Parse(kSampleNonSubdomainTokenJSON, GetParam());
    ASSERT_TRUE(token);
    EXPECT_EQ(kExpectedFeatureName, token->feature_name());
    EXPECT_FALSE(token->match_subdomains());
    EXPECT_EQ(expected_origin_, token->origin());
...
{
    std::unique_ptr<TrialToken> token = Parse(kSampleSubdomainTokenJSON, GetParam());
    ASSERT_TRUE(token);
    EXPECT_EQ(kExpectedFeatureName, token->feature_name());
...
TEST_P(TrialTokenParseTest, ParseValidLargeToken)
{
    ...
    EXPECT_TRUE(token->match_subdomains());
    url::Origin expected_long_origin(url::Origin::Create(GURL(kExpectedLongTokenOrigin)));
...
TEST_P(TrialTokenParseTest, ValidateValidToken)
{
    ...
    EXPECT_FALSE(ValidateFeatureName(token.get(), base::ToUpperASCII(kExpectedFeatureName).c_str()));
    EXPECT_FALSE(ValidateFeatureName(token.get(), base::ToLowerASCII(kExpectedFeatureName).c_str()));
...
TEST_P(TrialTokenParseTest, TokenIsValid)
{
    std::unique_ptr<TrialToken> token = Parse(kSampleTokenJSON, GetParam());
    ASSERT_TRUE(token);
    EXPECT_EQ(OriginTrialTokenStatus::kSuccess, token->IsValid(expected_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kWrongOrigin, token->IsValid(invalid_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kWrongOrigin, token->IsValid(insecure_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kWrongOrigin, token->IsValid(incorrect_port_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kExpired, token->IsValid(expected_origin_, invalid_timestamp_));
}
...
TEST_P(TrialTokenParseTest, SubdomainTokenIsValid)
{
    ...
    ASSERT_TRUE(token);
    EXPECT_EQ(OriginTrialTokenStatus::kSuccess, token->IsValid(expected_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kSuccess, token->IsValid(expected_subdomain_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kSuccess, token->IsValid(expected_multiple_subdomain_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kWrongOrigin, token->IsValid(incorrect_domain_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kWrongOrigin, token->IsValid(insecure_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kWrongOrigin, token->IsValid(incorrect_port_origin_, valid_timestamp_));
    EXPECT_EQ(OriginTrialTokenStatus::kExpired, token->IsValid(expected_origin_, invalid_timestamp_));
}

INSTANTIATE_TEST_SUITE_P(TrialTokenTest, TrialTokenParseTest, testing::Values(kVersion2, kVersion3));

TEST_F(TrialTokenTest, ParseValidNonThirdPartyToken)
{
    std::unique_ptr<TrialToken> token = Parse(kSampleNonThirdPartyTokenJSON, kVersion3);
    ASSERT_TRUE(token);
    EXPECT_EQ(kExpectedFeatureName, token->feature_name());
...
{
    std::unique_ptr<TrialToken> token = Parse(kSampleThirdPartyTokenJSON, kVersion3);
    ASSERT_TRUE(token);
    EXPECT_EQ(kExpectedFeatureName, token->feature_name());
...
{
    std::unique_ptr<TrialToken> token = Parse(kSampleThirdPartyTokenJSON, kVersion2);
    ASSERT_TRUE(token);
    EXPECT_EQ(kExpectedFeatureName, token->feature_name());
    EXPECT_FALSE(token->is_third_party());
    EXPECT_EQ(expected_origin_, token->origin());
...
{
    std::unique_ptr<TrialToken> token = Parse(kSampleThirdPartyTokenUsageEmptyJSON, kVersion3);
    ASSERT_TRUE(token);
    EXPECT_EQ(kExpectedFeatureName, token->feature_name());
    EXPECT_TRUE(token->is_third_party());
    EXPECT_EQ(TrialToken::UsageRestriction::kNone, token->usage_restriction());
...
TEST_F(TrialTokenTest, FromValidToken)
{
    ...
    std::unique_ptr<TrialToken> token = TrialToken::From(kSampleTokenV2, correct_public_key(), &status);
    EXPECT_TRUE(token);
...
{
    OriginTrialTokenStatus status;
    std::unique_ptr<TrialToken> token = TrialToken::From(kSampleTokenV2, incorrect_public_key(), &status);
    EXPECT_FALSE(token);
    EXPECT_EQ(OriginTrialTokenStatus::kInvalidSignature, status);
}
...
{
    OriginTrialTokenStatus status;
    std::unique_ptr<TrialToken> token = TrialToken::From(kSampleTokenV3, correct_public_key(), &status);
    EXPECT_TRUE(token);
    EXPECT_EQ(OriginTrialTokenStatus::kSuccess, status);
...
{
    OriginTrialTokenStatus status;
    std::unique_ptr<TrialToken> token = TrialToken::From(kSampleTokenV3, incorrect_public_key(), &status);
    EXPECT_FALSE(token);
    EXPECT_EQ(OriginTrialTokenStatus::kInvalidSignature, status);
}
