...
const std::vector<blink::OriginTrialPublicKey>& ScopedTestOriginTrialPolicy::GetPublicKeys() const
{
    return public_keys_;
}
...
{
    TrialTokenValidator::SetOriginTrialPolicyGetter(base::BindRepeating([](OriginTrialPolicy* self) { return self; }, base::Unretained(this)));
}
