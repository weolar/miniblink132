...
bool FeatureHasExpiryGracePeriod(blink::mojom::OriginTrialFeature feature)
{
    static blink::mojom::OriginTrialFeature const kHasExpiryGracePeriod[] = {
        ...
        blink::mojom::OriginTrialFeature::kOriginTrialsSampleAPIExpiryGracePeriodThirdParty,
        blink::mojom::OriginTrialFeature::kOriginTrialsSampleAPIPersistentExpiryGracePeriod,
