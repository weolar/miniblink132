...
AdSize::AdSize(double width, LengthUnit width_units, double height, LengthUnit height_units)
    : width(width)
...
{
    return std::tie(width, width_units, height, height_units) == std::tie(other.width, other.width_units, other.height, other.height_units);
}
