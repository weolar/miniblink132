...
TEST(AdSizeTest, OperatorCompare)
{
    ...
    AdSize ad_size_in_pixels(100, AdSize::LengthUnit::kPixels, 100, AdSize::LengthUnit::kPixels);
    AdSize ad_size_in_screenwidth(100, AdSize::LengthUnit::kScreenWidth, 100, AdSize::LengthUnit::kScreenWidth);
    AdSize ad_size_in_mix_units(100, AdSize::LengthUnit::kPixels, 100, AdSize::LengthUnit::kScreenWidth);
    ...
    AdSize ad_size_in_pixels_small(5, AdSize::LengthUnit::kPixels, 5, AdSize::LengthUnit::kPixels);
...
TEST(AdDescriptorTest, Constructor)
{
    ...
    AdSize ad_size(100, AdSize::LengthUnit::kPixels, 50, AdSize::LengthUnit::kScreenWidth);
...
TEST(AdDescriptorTest, OperatorCompare)
{
    ...
    EXPECT_FALSE(ad_descriptor_without_size == different_ad_descriptor_without_size);
    EXPECT_TRUE(ad_descriptor_without_size != different_ad_descriptor_without_size);

    AdDescriptor ad_descriptor_in_pixels(kUrl1, AdSize(100, AdSize::LengthUnit::kPixels, 100, AdSize::LengthUnit::kPixels));
    ...
    AdDescriptor ad_descriptor_screenwidth(kUrl1, AdSize(100, AdSize::LengthUnit::kScreenWidth, 100, AdSize::LengthUnit::kScreenWidth));
