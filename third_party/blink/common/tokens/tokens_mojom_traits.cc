...
// static
bool UnionTraits<blink::mojom::FrameTokenDataView, blink::FrameToken>::Read(DataView input, blink::FrameToken* output)
{
    switch (input.tag()) {
...
// static
bool UnionTraits<blink::mojom::WorkerTokenDataView, blink::WorkerToken>::Read(DataView input, blink::WorkerToken* output)
{
    switch (input.tag()) {
...
// static
bool UnionTraits<blink::mojom::WorkletTokenDataView, blink::WorkletToken>::Read(DataView input, blink::WorkletToken* output)
{
    switch (input.tag()) {
...
// static
bool UnionTraits<blink::mojom::ExecutionContextTokenDataView, blink::ExecutionContextToken>::Read(DataView input, blink::ExecutionContextToken* output)
{
    switch (input.tag()) {
    case DataView::Tag::kLocalFrameToken: {
        blink::LocalFrameToken token;
...
// static
bool UnionTraits<blink::mojom::WebGPUExecutionContextTokenDataView, blink::WebGPUExecutionContextToken>::Read(
    DataView input, blink::WebGPUExecutionContextToken* output)
{
    switch (input.tag()) {
