...
blink::mojom::LinkGenerationError EnumTraits<blink::mojom::LinkGenerationError, shared_highlighting::LinkGenerationError>::ToMojom(
...
bool EnumTraits<blink::mojom::LinkGenerationError, shared_highlighting::LinkGenerationError>::FromMojom(
    blink::mojom::LinkGenerationError input, shared_highlighting::LinkGenerationError* output)
{
    switch (input) {
...
blink::mojom::LinkGenerationReadyStatus EnumTraits<blink::mojom::LinkGenerationReadyStatus, shared_highlighting::LinkGenerationReadyStatus>::ToMojom(
...
bool EnumTraits<blink::mojom::LinkGenerationReadyStatus, shared_highlighting::LinkGenerationReadyStatus>::FromMojom(
    blink::mojom::LinkGenerationReadyStatus input, shared_highlighting::LinkGenerationReadyStatus* output)
{
    switch (input) {
    case blink::mojom::LinkGenerationReadyStatus::kRequestedBeforeReady:
        *output = shared_highlighting::LinkGenerationReadyStatus::kRequestedBeforeReady;
        return true;
    case blink::mojom::LinkGenerationReadyStatus::kRequestedAfterReady:
        *output = shared_highlighting::LinkGenerationReadyStatus::kRequestedAfterReady;
        return true;
    }
