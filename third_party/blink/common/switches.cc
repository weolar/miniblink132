...
const char kForcePermissionPolicyUnloadDefaultEnabled[] = "force-permission-policy-unload-default-enabled";
...
// detection.
const char kEnableLeakDetectionHeapSnapshot[] = "enable-leak-detection-heap-snapshot";
...
const char kEnableRasterSideDarkModeForImages[] = "enable-raster-side-dark-mode-for-images";
...
extern const char kIntensiveWakeUpThrottlingPolicy[] = "intensive-wake-up-throttling-policy";
...
extern const char kKeyboardFocusableScrollersEnabled[] = "keyboard-focusable-scrollers-enabled";
extern const char kKeyboardFocusableScrollersOptOut[] = "keyboard-focusable-scrollers-opt-out";
...
extern const char kLegacyTechReportPolicyEnabled[] = "legacy-tech-report-policy-enabled";
...
extern const char kMutationEventsEnabled[] = "deprecated-mutation-events-enabled";
...
// enterprise policy override.
extern const char kCSSCustomStateDeprecatedSyntaxEnabled[] = "css-custom-state-deprecated-syntax-enabled";

// Used to communicate managed policy for SelectParserRelaxation. This feature
// is typically controlled by a RuntimeEnabledFeature, but requires an
// enterprise policy override.
extern const char kDisableSelectParserRelaxation[] = "disable-select-parser-relaxation";
...
const char kDisableStandardizedBrowserZoom[] = "disable-standardized-browser-zoom";

// Comma-separated list of origins that can use SharedArrayBuffer without
// enabling cross-origin isolation.
const char kSharedArrayBufferAllowedOrigins[] = "shared-array-buffer-allowed-origins";
...
// feature is typically controlled by a RuntimeEnabledFeature, but requires an
// enterprise policy override.
const char kWebAudioBypassOutputBufferingOptOut[] = "web-audio-bypass-output-buffering-opt-out";
