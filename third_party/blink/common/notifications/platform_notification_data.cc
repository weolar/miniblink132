...
PlatformNotificationData::PlatformNotificationData(const PlatformNotificationData& other)
{
    *this = other;
}

PlatformNotificationData& PlatformNotificationData::operator=(const PlatformNotificationData& other)
{
    if (&other == this)
        return *this;
