...
blink::mojom::CustomContextMenuItemPtr MenuItemBuild(const blink::MenuItemInfo& item)
{
    ...
    result->type = static_cast<blink::mojom::CustomContextMenuItemType>(item.type);
    ...
    result->force_show_accelerator_for_item = item.force_show_accelerator_for_item;
...
// static
UntrustworthyContextMenuParams ContextMenuParamsBuilder::Build(const blink::ContextMenuData& data)
{
    ...
    params.is_content_editable_for_autofill = data.is_content_editable_for_autofill;
