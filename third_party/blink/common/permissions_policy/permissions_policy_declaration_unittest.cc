...
{
    const url::Origin kTestOrigin = url::Origin::Create(GURL("https://example.test/"));
    ...
    mismatch_decl.allowed_origins.emplace_back(*OriginWithPossibleWildcards::FromOrigin(url::Origin::Create(GURL("https://example2.test/"))));
    ...
    match_decl.allowed_origins.emplace_back(*OriginWithPossibleWildcards::FromOrigin(url::Origin::Create(GURL("https://example.test/"))));
    ...
    self_decl.self_if_matches = url::Origin::Create(GURL("https://example.test/"));
