...
template <> struct BLINK_COMMON_EXPORT UnionTraits<blink::mojom::PolicyValueDataView, blink::PolicyValue> {
public:
    static blink::mojom::PolicyValueDataView::Tag GetTag(const blink::PolicyValue& value)
    {
        switch (value.Type()) {
    ...
    static bool null_value(const blink::PolicyValue& value)
    {
        return false;
    }
    ...
    static bool Read(blink::mojom::PolicyValueDataView in, blink::PolicyValue* out);
};
