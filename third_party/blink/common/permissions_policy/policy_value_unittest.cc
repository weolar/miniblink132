...
TEST_F(PolicyValueTest, TestCanCreateBoolValues)
{
    ...
    PolicyValue min_value(PolicyValue::CreateMinPolicyValue(mojom::PolicyValueType::kBool));
    PolicyValue max_value(PolicyValue::CreateMaxPolicyValue(mojom::PolicyValueType::kBool));
...
TEST_F(PolicyValueTest, TestCanCreateDoubleValues)
{
    ...
    PolicyValue min_value(PolicyValue::CreateMinPolicyValue(mojom::PolicyValueType::kDecDouble));
    PolicyValue max_value(PolicyValue::CreateMaxPolicyValue(mojom::PolicyValueType::kDecDouble));
...
TEST_F(PolicyValueTest, TestCanModifyDoubleValues)
{
    ...
    EXPECT_EQ(initially_zero_value.DoubleValue(), std::numeric_limits<double>::infinity());
