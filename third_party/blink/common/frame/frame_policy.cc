...
FramePolicy::FramePolicy(
    network::mojom::WebSandboxFlags sandbox_flags, const ParsedPermissionsPolicy& container_policy, const DocumentPolicyFeatureState& required_document_policy)
...
{
    return (lhs.sandbox_flags == rhs.sandbox_flags) && (lhs.container_policy == rhs.container_policy)
