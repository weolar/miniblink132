...
mojom::FilterListResult MoreRestrictiveFilterListEvidence(mojom::FilterListResult a, mojom::FilterListResult b)
{
    return std::max(a, b);
}
...
bool FrameAdEvidence::IndicatesAdFrame() const
{
    ...
    return parent_is_ad_ || created_by_ad_script_ == mojom::FrameCreationStackEvidence::kCreatedByAdScript
        || most_restrictive_filter_list_result_ == mojom::FilterListResult::kMatchedBlockingRule;
}

void FrameAdEvidence::UpdateFilterListResult(mojom::FilterListResult value)
{
    latest_filter_list_result_ = value;
    most_restrictive_filter_list_result_ = MoreRestrictiveFilterListEvidence(most_restrictive_filter_list_result_, value);
}
