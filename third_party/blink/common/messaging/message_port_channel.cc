...
public:
    ...
    const MessagePortDescriptor& handle() const
    {
        return handle_;
    }
...
MessagePortChannel::MessagePortChannel(const MessagePortChannel& other) = default;

MessagePortChannel& MessagePortChannel::operator=(const MessagePortChannel& other)
{
    state_ = other.state_;
    return *this;
}
...
// static
std::vector<MessagePortDescriptor> MessagePortChannel::ReleaseHandles(const std::vector<MessagePortChannel>& ports)
{
...
// static
std::vector<MessagePortChannel> MessagePortChannel::CreateFromHandles(std::vector<MessagePortDescriptor> handles)
{
