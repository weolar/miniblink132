...
blink::ServiceWorkerStatusCode TypeConverter<blink::ServiceWorkerStatusCode, blink::mojom::ServiceWorkerEventStatus>::Convert(
...
blink::ServiceWorkerStatusCode TypeConverter<blink::ServiceWorkerStatusCode, blink::mojom::ServiceWorkerStartStatus>::Convert(
