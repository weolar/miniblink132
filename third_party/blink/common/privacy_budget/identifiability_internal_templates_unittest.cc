...
TEST(IdentifiabilityInternalTemplatesTest, DigestOfObjectRepresentation)
{
    ...
    EXPECT_EQ(INT64_C(-1), DigestOfObjectRepresentation(std::numeric_limits<uint64_t>::max()));
...
TEST(IdentifiabilityInternalTemplatesTest, DigestOfObjectRepresentation_Floats)
{
