...
TEST(IdentifiabilityMetricsTest, IdentifiabilityDigestOfBytes_Padding)
{
    ...
    EXPECT_EQ(UINT64_C(0xb74c74c9fcf0505a), IdentifiabilityDigestOfBytes(kTwoBytes));
...
TEST(IdentifiabilityMetricsTest, IdentifiabilityDigestOfBytes_EdgeCases)
{
    ...
    EXPECT_EQ(UINT64_C(0x6209312a69a56947), IdentifiabilityDigestOfBytes(kOneByte));
}
