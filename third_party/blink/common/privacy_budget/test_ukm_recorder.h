...
public:
    ...
    std::vector<const ukm::mojom::UkmEntry*> GetEntriesByHash(uint64_t event_hash) const;
    ...
    void RecordWebDXFeatures(ukm::SourceId source_id, const std::set<int32_t>& features, const size_t max_feature_value) override
    {
    }
    ...
    void RecordNavigation(ukm::SourceId, const ukm::UkmSource::NavigationData&) override
    {
    }
