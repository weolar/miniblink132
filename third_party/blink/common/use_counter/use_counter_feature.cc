...
UseCounterFeature::UseCounterFeature(mojom::UseCounterFeatureType type, EnumValue value)
    : type_(type)
    , value_(value)
{
    DCHECK(IsValid());
...
bool UseCounterFeature::SetTypeAndValue(mojom::UseCounterFeatureType type, EnumValue value)
{
    type_ = type;
    value_ = value;
    return IsValid();
...
bool UseCounterFeature::IsValid() const
{
    ...
    case mojom::UseCounterFeatureType::kWebFeature:
        return value_ <= static_cast<UseCounterFeature::EnumValue>(mojom::WebFeature::kMaxValue);
    case mojom::UseCounterFeatureType::kWebDXFeature:
        return value_ <= static_cast<UseCounterFeature::EnumValue>(mojom::WebDXFeature::kMaxValue);
    case mojom::UseCounterFeatureType::kCssProperty:
    case mojom::UseCounterFeatureType::kAnimatedCssProperty:
        return value_ <= static_cast<UseCounterFeature::EnumValue>(mojom::CSSSampleId::kMaxValue);
    ...
    case mojom::UseCounterFeatureType::kPermissionsPolicyIframeAttribute:
        return value_ <= static_cast<UseCounterFeature::EnumValue>(mojom::PermissionsPolicyFeature::kMaxValue);
    }
}
