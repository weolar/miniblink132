...
template <> struct BLINK_COMMON_EXPORT StructTraits<blink::mojom::UseCounterFeatureDataView, blink::UseCounterFeature> {
public:
    static blink::mojom::UseCounterFeatureType type(const blink::UseCounterFeature& feature)
    {
        return feature.type();
    }
    ...
    static bool Read(blink::mojom::UseCounterFeatureDataView in, blink::UseCounterFeature* out);
};
