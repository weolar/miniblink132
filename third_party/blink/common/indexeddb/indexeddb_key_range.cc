...
IndexedDBKeyRange::IndexedDBKeyRange(const blink::IndexedDBKey& lower, const blink::IndexedDBKey& upper, bool lower_open, bool upper_open)
    : lower_(lower)
    , upper_(upper)
...
IndexedDBKeyRange::~IndexedDBKeyRange() = default;
IndexedDBKeyRange& IndexedDBKeyRange::operator=(const IndexedDBKeyRange& other) = default;
