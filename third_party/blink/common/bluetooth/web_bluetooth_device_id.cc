...
WebBluetoothDeviceId::WebBluetoothDeviceId(const std::string& encoded_device_id)
{
    std::string decoded;
...
WebBluetoothDeviceId::WebBluetoothDeviceId(const WebBluetoothDeviceIdKey& device_id)
...
bool WebBluetoothDeviceId::operator==(const WebBluetoothDeviceId& device_id) const
{
...
std::ostream& operator<<(std::ostream& out, const WebBluetoothDeviceId& device_id)
{
