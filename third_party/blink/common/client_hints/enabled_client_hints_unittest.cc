...
public:
        ...
        : response_headers_(base::MakeRefCounted<net::HttpResponseHeaders>(""))
    {
        scoped_feature_list_.InitWithFeatures(
            /*enabled_features=*/ {},
            /*disabled_features=*/ { blink::features::kClientHintsDeviceMemory_DEPRECATED });
    }
...
TEST_F(EnabledClientHintsTest, GetEnabledHints)
{
    ...
    hints.SetIsEnabled(WebClientHintsType::kRtt_DEPRECATED, true);
    EXPECT_THAT(
        hints.GetEnabledHints(), ElementsAre(WebClientHintsType::kRtt_DEPRECATED, WebClientHintsType::kUAFullVersion, WebClientHintsType::kUAFullVersionList));
}
