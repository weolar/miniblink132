...
static int KRB5KDF(const EVP_CIPHER* cipher, ENGINE* engine, const unsigned char* key, size_t key_len, const unsigned char* constant, size_t constant_len,
...
static int krb5kdf_derive(void* vctx, unsigned char* key, size_t keylen, const OSSL_PARAM params[])
{
    ...
    return KRB5KDF(cipher, engine, ctx->key, ctx->key_len, ctx->constant, ctx->constant_len, key, keylen);
}
...
static const OSSL_PARAM* krb5kdf_settable_ctx_params(ossl_unused void* ctx, ossl_unused void* provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[]
        = { OSSL_PARAM_utf8_string(OSSL_KDF_PARAM_PROPERTIES, NULL, 0), OSSL_PARAM_utf8_string(OSSL_KDF_PARAM_CIPHER, NULL, 0),
              OSSL_PARAM_octet_string(OSSL_KDF_PARAM_KEY, NULL, 0), OSSL_PARAM_octet_string(OSSL_KDF_PARAM_CONSTANT, NULL, 0), OSSL_PARAM_END };
...
const OSSL_DISPATCH ossl_kdf_krb5kdf_functions[] = { { OSSL_FUNC_KDF_NEWCTX, (void (*)(void))krb5kdf_new },
    { OSSL_FUNC_KDF_FREECTX, (void (*)(void))krb5kdf_free }, { OSSL_FUNC_KDF_RESET, (void (*)(void))krb5kdf_reset },
    { OSSL_FUNC_KDF_DERIVE, (void (*)(void))krb5kdf_derive }, { OSSL_FUNC_KDF_SETTABLE_CTX_PARAMS, (void (*)(void))krb5kdf_settable_ctx_params },
    ...
    { OSSL_FUNC_KDF_GET_CTX_PARAMS, (void (*)(void))krb5kdf_get_ctx_params }, { 0, NULL } };
...
static void n_fold(unsigned char* block, unsigned int blocksize, const unsigned char* constant, size_t constant_len)
{
    ...
    for (l = lcm - 1; l >= 0; l--) {
        ...
        tmp = (constant[(rbyte - 1) % constant_len] << (8 - rshift) | constant[rbyte % constant_len] >> rshift) & 0xff;
