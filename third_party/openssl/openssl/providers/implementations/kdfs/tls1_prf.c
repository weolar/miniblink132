...
static int tls1_prf_alg(EVP_MAC_CTX* mdctx, EVP_MAC_CTX* sha1ctx, const unsigned char* sec, size_t slen, const unsigned char* seed, size_t seed_len,
...
static int kdf_tls1_prf_derive(void* vctx, unsigned char* key, size_t keylen, const OSSL_PARAM params[])
{
    TLS1_PRF* ctx = (TLS1_PRF*)vctx;
    ...
    return tls1_prf_alg(ctx->P_hash, ctx->P_sha1, ctx->sec, ctx->seclen, ctx->seed, ctx->seedlen, key, keylen);
}
...
static const OSSL_PARAM* kdf_tls1_prf_settable_ctx_params(ossl_unused void* ctx, ossl_unused void* provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[]
        = { OSSL_PARAM_utf8_string(OSSL_KDF_PARAM_PROPERTIES, NULL, 0), OSSL_PARAM_utf8_string(OSSL_KDF_PARAM_DIGEST, NULL, 0),
              OSSL_PARAM_octet_string(OSSL_KDF_PARAM_SECRET, NULL, 0), OSSL_PARAM_octet_string(OSSL_KDF_PARAM_SEED, NULL, 0), OSSL_PARAM_END };
...
const OSSL_DISPATCH ossl_kdf_tls1_prf_functions[] = { { OSSL_FUNC_KDF_NEWCTX, (void (*)(void))kdf_tls1_prf_new },
    { OSSL_FUNC_KDF_FREECTX, (void (*)(void))kdf_tls1_prf_free }, { OSSL_FUNC_KDF_RESET, (void (*)(void))kdf_tls1_prf_reset },
    { OSSL_FUNC_KDF_DERIVE, (void (*)(void))kdf_tls1_prf_derive }, { OSSL_FUNC_KDF_SETTABLE_CTX_PARAMS, (void (*)(void))kdf_tls1_prf_settable_ctx_params },
    { OSSL_FUNC_KDF_SET_CTX_PARAMS, (void (*)(void))kdf_tls1_prf_set_ctx_params },
    { OSSL_FUNC_KDF_GETTABLE_CTX_PARAMS, (void (*)(void))kdf_tls1_prf_gettable_ctx_params },
    { OSSL_FUNC_KDF_GET_CTX_PARAMS, (void (*)(void))kdf_tls1_prf_get_ctx_params }, { 0, NULL } };
 ...
 *     A(i) = HMAC_<hash>(secret, A(i-1))
 */
static int tls1_prf_P_hash(
    EVP_MAC_CTX* ctx_init, const unsigned char* sec, size_t sec_len, const unsigned char* seed, size_t seed_len, unsigned char* out, size_t olen)
{
    size_t chunk;
    ...
    unsigned char* out, size_t olen)
{
    if (sha1ctx != NULL) {
        ...
        if (!tls1_prf_P_hash(mdctx, sec, L_S1, seed, seed_len, out, olen))
            return 0;
        ...
        if (!tls1_prf_P_hash(sha1ctx, sec + slen - L_S2, L_S2, seed, seed_len, tmp, olen)) {
