...
static int der2obj_decode(
    void* provctx, OSSL_CORE_BIO* cin, int selection, OSSL_CALLBACK* data_cb, void* data_cbarg, OSSL_PASSPHRASE_CALLBACK* pw_cb, void* pw_cbarg)
{
    ...
    return any2obj_decode_final(provctx, OSSL_OBJECT_UNKNOWN, mem, data_cb, data_cbarg);
}
...
#define MAKE_DECODER(fromtype, objtype)                                                                                                                        \
    static const OSSL_DISPATCH fromtype##_to_obj_decoder_functions[] = { { OSSL_FUNC_DECODER_NEWCTX, (void (*)(void))any2obj_newctx },                         \
        { OSSL_FUNC_DECODER_FREECTX, (void (*)(void))any2obj_freectx }, { OSSL_FUNC_DECODER_DECODE, (void (*)(void))fromtype##2obj_decode }, { 0, NULL } }

MAKE_DECODER(der, OSSL_OBJECT_UNKNOWN);
MAKE_DECODER(msblob, OSSL_OBJECT_PKEY);
MAKE_DECODER(pvk, OSSL_OBJECT_PKEY);

const OSSL_ALGORITHM ossl_any_to_obj_algorithm[] = { { "obj", "input=DER", der_to_obj_decoder_functions },
    { "obj", "input=MSBLOB", msblob_to_obj_decoder_functions }, { "obj", "input=PVK", pvk_to_obj_decoder_functions },
    {
        NULL,
    } };
