...
static int siv_init(void* vctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[], int enc)
{
    PROV_AES_SIV_CTX* ctx = (PROV_AES_SIV_CTX*)vctx;
...
static int siv_einit(void* vctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[])
{
    return siv_init(vctx, key, keylen, iv, ivlen, params, 1);
}

static int siv_dinit(void* vctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[])
{
...
static const OSSL_PARAM aes_siv_known_gettable_ctx_params[] = { OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL),
    OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_AEAD_TAGLEN, NULL), OSSL_PARAM_octet_string(OSSL_CIPHER_PARAM_AEAD_TAG, NULL, 0), OSSL_PARAM_END };
...
static const OSSL_PARAM aes_siv_known_settable_ctx_params[] = { OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL),
    OSSL_PARAM_uint(OSSL_CIPHER_PARAM_SPEED, NULL), OSSL_PARAM_octet_string(OSSL_CIPHER_PARAM_AEAD_TAG, NULL, 0), OSSL_PARAM_END };
...
#define IMPLEMENT_cipher(alg, lc, UCMODE, flags, kbits, blkbits, ivbits)                                                                                       \
    ...
    static OSSL_FUNC_cipher_gettable_ctx_params_fn alg##_##lc##_gettable_ctx_params;                                                                           \
    static OSSL_FUNC_cipher_set_ctx_params_fn alg##_##lc##_set_ctx_params;                                                                                     \
    static OSSL_FUNC_cipher_settable_ctx_params_fn alg##_##lc##_settable_ctx_params;                                                                           \
    static int alg##_##kbits##_##lc##_get_params(OSSL_PARAM params[])                                                                                          \
    {                                                                                                                                                          \
        return ossl_cipher_generic_get_params(params, EVP_CIPH_##UCMODE##_MODE, flags, 2 * kbits, blkbits, ivbits);                                            \
    }                                                                                                                                                          \
    static void* alg##kbits##lc##_newctx(void* provctx)                                                                                                        \
    {                                                                                                                                                          \
        return alg##_##lc##_newctx(provctx, 2 * kbits, EVP_CIPH_##UCMODE##_MODE, flags);                                                                       \
    }                                                                                                                                                          \
    const OSSL_DISPATCH ossl_##alg##kbits##lc##_functions[] = { { OSSL_FUNC_CIPHER_NEWCTX, (void (*)(void))alg##kbits##lc##_newctx },                          \
        { OSSL_FUNC_CIPHER_FREECTX, (void (*)(void))alg##_##lc##_freectx }, { OSSL_FUNC_CIPHER_DUPCTX, (void (*)(void))lc##_dupctx },                          \
        { OSSL_FUNC_CIPHER_ENCRYPT_INIT, (void (*)(void))lc##_einit }, { OSSL_FUNC_CIPHER_DECRYPT_INIT, (void (*)(void))lc##_dinit },                          \
        { OSSL_FUNC_CIPHER_UPDATE, (void (*)(void))lc##_stream_update }, { OSSL_FUNC_CIPHER_FINAL, (void (*)(void))lc##_stream_final },                        \
        { OSSL_FUNC_CIPHER_CIPHER, (void (*)(void))lc##_cipher }, { OSSL_FUNC_CIPHER_GET_PARAMS, (void (*)(void))alg##_##kbits##_##lc##_get_params },          \
        ...
        { OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))alg##_##lc##_gettable_ctx_params },                                                            \
        { OSSL_FUNC_CIPHER_SET_CTX_PARAMS, (void (*)(void))alg##_##lc##_set_ctx_params },                                                                      \
        { OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))alg##_##lc##_settable_ctx_params }, { 0, NULL } };
