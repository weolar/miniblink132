...
static int aria_gcm_initkey(PROV_GCM_CTX* ctx, const unsigned char* key, size_t keylen)
{
...
static const PROV_GCM_HW aria_gcm = { aria_gcm_initkey, ossl_gcm_setiv, ossl_gcm_aad_update, ossl_gcm_cipher_update, ossl_gcm_cipher_final, ossl_gcm_one_shot };
