...
#define PROV_CIPHER_HW_camellia_mode(mode)                                                                                                                     \
    static const PROV_CIPHER_HW camellia_##mode = { cipher_hw_camellia_initkey, ossl_cipher_hw_generic_##mode, cipher_hw_camellia_copyctx };                   \
    PROV_CIPHER_HW_declare(mode) const PROV_CIPHER_HW* ossl_prov_cipher_hw_camellia_##mode(size_t keybits)                                                     \
    {                                                                                                                                                          \
        PROV_CIPHER_HW_select(mode) return &camellia_##mode;                                                                                                   \
    }

PROV_CIPHER_HW_camellia_mode(cbc) PROV_CIPHER_HW_camellia_mode(ecb) PROV_CIPHER_HW_camellia_mode(ofb128) PROV_CIPHER_HW_camellia_mode(cfb128)
    PROV_CIPHER_HW_camellia_mode(cfb1) PROV_CIPHER_HW_camellia_mode(cfb8) PROV_CIPHER_HW_camellia_mode(ctr)
