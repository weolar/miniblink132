...
static int des_ede3_unwrap(PROV_CIPHER_CTX* ctx, unsigned char* out, const unsigned char* in, size_t inl)
{
...
static int des_ede3_wrap(PROV_CIPHER_CTX* ctx, unsigned char* out, const unsigned char* in, size_t inl)
{
...
static int tdes_wrap_cipher_internal(PROV_CIPHER_CTX* ctx, unsigned char* out, const unsigned char* in, size_t inl)
{
    /*
...
static int tdes_wrap_cipher(void* vctx, unsigned char* out, size_t* outl, size_t outsize, const unsigned char* in, size_t inl)
{
...
static int tdes_wrap_update(void* vctx, unsigned char* out, size_t* outl, size_t outsize, const unsigned char* in, size_t inl)
{
    *outl = 0;
    if (inl == 0)
        return 1;
...
#define IMPLEMENT_WRAP_CIPHER(flags, kbits, blkbits, ivbits)                                                                                                   \
    ...
    {                                                                                                                                                          \
        return ossl_tdes_newctx(provctx, EVP_CIPH_WRAP_MODE, kbits, blkbits, ivbits, flags, ossl_prov_cipher_hw_tdes_wrap_cbc());                              \
    }                                                                                                                                                          \
    static OSSL_FUNC_cipher_get_params_fn tdes_wrap_get_params;                                                                                                \
    static int tdes_wrap_get_params(OSSL_PARAM params[])                                                                                                       \
    {                                                                                                                                                          \
        return ossl_cipher_generic_get_params(params, EVP_CIPH_WRAP_MODE, flags, kbits, blkbits, ivbits);                                                      \
    }                                                                                                                                                          \
    const OSSL_DISPATCH ossl_tdes_wrap_cbc_functions[] = { { OSSL_FUNC_CIPHER_ENCRYPT_INIT, (void (*)(void))ossl_tdes_einit },                                 \
        { OSSL_FUNC_CIPHER_DECRYPT_INIT, (void (*)(void))ossl_tdes_dinit }, { OSSL_FUNC_CIPHER_CIPHER, (void (*)(void))tdes_wrap_cipher },                     \
        { OSSL_FUNC_CIPHER_NEWCTX, (void (*)(void))tdes_wrap_newctx }, { OSSL_FUNC_CIPHER_FREECTX, (void (*)(void))ossl_tdes_freectx },                        \
        { OSSL_FUNC_CIPHER_UPDATE, (void (*)(void))tdes_wrap_update }, { OSSL_FUNC_CIPHER_FINAL, (void (*)(void))ossl_cipher_generic_stream_final },           \
        ...
        { OSSL_FUNC_CIPHER_GET_CTX_PARAMS, (void (*)(void))ossl_tdes_get_ctx_params },                                                                         \
        { OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))ossl_tdes_gettable_ctx_params },                                                               \
