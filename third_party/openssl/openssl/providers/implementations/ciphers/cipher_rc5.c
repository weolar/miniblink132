...
static int rc5_einit(void* ctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[])
{
...
static int rc5_dinit(void* ctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[])
{
...
OSSL_PARAM_uint(OSSL_CIPHER_PARAM_ROUNDS, NULL),
    CIPHER_DEFAULT_GETTABLE_CTX_PARAMS_END(rc5)
        ...
        CIPHER_DEFAULT_SETTABLE_CTX_PARAMS_START(rc5) OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL),
    OSSL_PARAM_uint(OSSL_CIPHER_PARAM_ROUNDS, NULL),
...
#define IMPLEMENT_cipher(alg, UCALG, lcmode, UCMODE, flags, kbits, blkbits, ivbits, typ)                                                                       \
    ...
    const OSSL_DISPATCH ossl_##alg##kbits##lcmode##_functions[]                                                                                                \
        = { { OSSL_FUNC_CIPHER_NEWCTX, (void (*)(void))alg##_##kbits##_##lcmode##_newctx }, { OSSL_FUNC_CIPHER_FREECTX, (void (*)(void))alg##_freectx },       \
              { OSSL_FUNC_CIPHER_DUPCTX, (void (*)(void))alg##_dupctx }, { OSSL_FUNC_CIPHER_ENCRYPT_INIT, (void (*)(void))rc5_einit },                         \
              { OSSL_FUNC_CIPHER_DECRYPT_INIT, (void (*)(void))rc5_dinit }, { OSSL_FUNC_CIPHER_UPDATE, (void (*)(void))ossl_cipher_generic_##typ##_update },   \
              ...
              { OSSL_FUNC_CIPHER_GET_CTX_PARAMS, (void (*)(void))rc5_get_ctx_params },                                                                         \
              { OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))rc5_gettable_ctx_params },                                                               \
              { OSSL_FUNC_CIPHER_SET_CTX_PARAMS, (void (*)(void))rc5_set_ctx_params },                                                                         \
              { OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))rc5_settable_ctx_params }, { 0, NULL } };
