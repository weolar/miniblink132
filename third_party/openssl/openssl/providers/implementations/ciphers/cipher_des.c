...
static void* des_newctx(void* provctx, size_t kbits, size_t blkbits, size_t ivbits, unsigned int mode, uint64_t flags, const PROV_CIPHER_HW* hw)
{
    PROV_DES_CTX* ctx;
    ...
    if (ctx != NULL)
        ossl_cipher_generic_initkey(ctx, kbits, blkbits, ivbits, mode, flags, hw, provctx);
    return ctx;
}
...
static int des_init(void* vctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[], int enc)
{
...
static int des_einit(void* vctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[])
{
    return des_init(vctx, key, keylen, iv, ivlen, params, 1);
}

static int des_dinit(void* vctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[])
{
...
#define IMPLEMENT_des_cipher(type, lcmode, UCMODE, flags, kbits, blkbits, ivbits, block)                                                                       \
    static OSSL_FUNC_cipher_newctx_fn type##_##lcmode##_newctx;                                                                                                \
    static void* des_##lcmode##_newctx(void* provctx)                                                                                                          \
    {                                                                                                                                                          \
        return des_newctx(provctx, kbits, blkbits, ivbits, EVP_CIPH_##UCMODE##_MODE, flags, ossl_prov_cipher_hw_des_##lcmode());                               \
    }                                                                                                                                                          \
    ...
    const OSSL_DISPATCH ossl_##des_##lcmode##_functions[] = { { OSSL_FUNC_CIPHER_ENCRYPT_INIT, (void (*)(void))des_einit },                                    \
        { OSSL_FUNC_CIPHER_DECRYPT_INIT, (void (*)(void))des_dinit }, { OSSL_FUNC_CIPHER_UPDATE, (void (*)(void))ossl_cipher_generic_##block##_update },       \
        { OSSL_FUNC_CIPHER_FINAL, (void (*)(void))ossl_cipher_generic_##block##_final },                                                                       \
        { OSSL_FUNC_CIPHER_CIPHER, (void (*)(void))ossl_cipher_generic_cipher }, { OSSL_FUNC_CIPHER_NEWCTX, (void (*)(void))des_##lcmode##_newctx },           \
        { OSSL_FUNC_CIPHER_DUPCTX, (void (*)(void))des_dupctx }, { OSSL_FUNC_CIPHER_FREECTX, (void (*)(void))des_freectx },                                    \
        { OSSL_FUNC_CIPHER_GET_PARAMS, (void (*)(void))des_##lcmode##_get_params },                                                                            \
        ...
        { OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))des_gettable_ctx_params },                                                                     \
