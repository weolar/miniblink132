...
#define PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_START(name, CTX, blksize, dgstsize, flags, upd, fin)                                                               \
    ...
    const OSSL_DISPATCH ossl_##name##_functions[]                                                                                                              \
        = { { OSSL_FUNC_DIGEST_NEWCTX, (void (*)(void))name##_newctx }, { OSSL_FUNC_DIGEST_UPDATE, (void (*)(void))upd },                                      \
              { OSSL_FUNC_DIGEST_FINAL, (void (*)(void))name##_internal_final }, { OSSL_FUNC_DIGEST_FREECTX, (void (*)(void))name##_freectx },                 \
              { OSSL_FUNC_DIGEST_DUPCTX, (void (*)(void))name##_dupctx }, PROV_DISPATCH_FUNC_DIGEST_GET_PARAMS(name)
...
#define IMPLEMENT_digest_functions(name, CTX, blksize, dgstsize, flags, init, upd, fin)                                                                        \
    ...
    PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_START(name, CTX, blksize, dgstsize, flags, upd, fin), { OSSL_FUNC_DIGEST_INIT, (void (*)(void))name##_internal_init }, \
...
#define IMPLEMENT_digest_functions_with_settable_ctx(name, CTX, blksize, dgstsize, flags, init, upd, fin, settable_ctx_params, set_ctx_params)                 \
    ...
    {                                                                                                                                                          \
        return ossl_prov_is_running() && init(ctx) && set_ctx_params(ctx, params);                                                                             \
    }                                                                                                                                                          \
    PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_START(name, CTX, blksize, dgstsize, flags, upd, fin), { OSSL_FUNC_DIGEST_INIT, (void (*)(void))name##_internal_init }, \
        { OSSL_FUNC_DIGEST_SETTABLE_CTX_PARAMS, (void (*)(void))settable_ctx_params }, { OSSL_FUNC_DIGEST_SET_CTX_PARAMS, (void (*)(void))set_ctx_params },    \
        PROV_DISPATCH_FUNC_DIGEST_CONSTRUCT_END
