...
#define IMPLEMENT_MS(KEYTYPE, keytype)                                                                                                                         \
    static const struct keytype_desc_st pvk2##keytype##_desc                                                                                                   \
        = { EVP_PKEY_##KEYTYPE, #KEYTYPE, ossl_##keytype##_keymgmt_functions, keytype##_private_key_bio, keytype##_adjust, keytype##_free };                   \
    ...
    const OSSL_DISPATCH ossl_##pvk_to_##keytype##_decoder_functions[]                                                                                          \
        = { { OSSL_FUNC_DECODER_NEWCTX, (void (*)(void))pvk2##keytype##_newctx }, { OSSL_FUNC_DECODER_FREECTX, (void (*)(void))pvk2key_freectx },              \
              { OSSL_FUNC_DECODER_DOES_SELECTION, (void (*)(void))pvk2key_does_selection }, { OSSL_FUNC_DECODER_DECODE, (void (*)(void))pvk2key_decode },      \
              { OSSL_FUNC_DECODER_EXPORT_OBJECT, (void (*)(void))pvk2key_export_object }, { 0, NULL } }
