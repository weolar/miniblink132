...
#define MAKE_BLOB_ENCODER(impl, type, selection_name)                                                                                                          \
    ...
    const OSSL_DISPATCH ossl_##impl##_to_blob_encoder_functions[] = { { OSSL_FUNC_ENCODER_NEWCTX, (void (*)(void))key2blob_newctx },                           \
        { OSSL_FUNC_ENCODER_FREECTX, (void (*)(void))key2blob_freectx }, { OSSL_FUNC_ENCODER_DOES_SELECTION, (void (*)(void))impl##2blob_does_selection },     \
        { OSSL_FUNC_ENCODER_IMPORT_OBJECT, (void (*)(void))impl##2blob_import_object },                                                                        \
        { OSSL_FUNC_ENCODER_FREE_OBJECT, (void (*)(void))impl##2blob_free_object }, { OSSL_FUNC_ENCODER_ENCODE, (void (*)(void))impl##2blob_encode },          \
        { 0, NULL } }
