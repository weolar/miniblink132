...
static void* der2key_decode_p8(const unsigned char** input_der, long input_der_len, struct der2key_ctx_st* ctx, key_from_pkcs8_t* key_from_pkcs8)
{
    ...
    if ((p8inf = d2i_PKCS8_PRIV_KEY_INFO(NULL, input_der, input_der_len)) != NULL && PKCS8_pkey_get0(NULL, NULL, NULL, &alg, p8inf)
...
static int der2key_decode(
    void* vctx, OSSL_CORE_BIO* cin, int selection, OSSL_CALLBACK* data_cb, void* data_cbarg, OSSL_PASSPHRASE_CALLBACK* pw_cb, void* pw_cbarg)
{
    struct der2key_ctx_st* ctx = vctx;
...
next:
    ...
    if (key != NULL) {
        ...
        params[1] = OSSL_PARAM_construct_utf8_string(OSSL_OBJECT_PARAM_DATA_TYPE, (char*)ctx->desc->keytype_name, 0);
...
static void* sm2_d2i_PKCS8(void** key, const unsigned char** der, long der_len, struct der2key_ctx_st* ctx)
{
    return der2key_decode_p8(der, der_len, ctx, (key_from_pkcs8_t*)ossl_ec_key_from_pkcs8);
}
...
static void* rsa_d2i_PKCS8(void** key, const unsigned char** der, long der_len, struct der2key_ctx_st* ctx)
{
    return der2key_decode_p8(der, der_len, ctx, (key_from_pkcs8_t*)ossl_rsa_key_from_pkcs8);
}
...
#define DO_type_specific_keypair(keytype)                                                                                                                      \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_KEYPAIR), keytype##_d2i_private_key, keytype##_d2i_public_key, NULL, NULL, NULL,                 \
        keytype##_check, keytype##_adjust, keytype##_free

#define DO_type_specific_pub(keytype)                                                                                                                          \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PUBLIC_KEY), NULL, keytype##_d2i_public_key, NULL, NULL, NULL, keytype##_check,                  \
        keytype##_adjust, keytype##_free

#define DO_type_specific_priv(keytype)                                                                                                                         \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PRIVATE_KEY), keytype##_d2i_private_key, NULL, NULL, NULL, NULL, keytype##_check,                \
        keytype##_adjust, keytype##_free

#define DO_type_specific_params(keytype)                                                                                                                       \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), NULL, NULL, keytype##_d2i_key_params, NULL, NULL, keytype##_check,              \
        keytype##_adjust, keytype##_free

#define DO_type_specific(keytype)                                                                                                                              \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL), keytype##_d2i_private_key, keytype##_d2i_public_key, keytype##_d2i_key_params, NULL, NULL, \
        keytype##_check, keytype##_adjust, keytype##_free

#define DO_type_specific_no_pub(keytype)                                                                                                                       \
    "type-specific", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PRIVATE_KEY | OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), keytype##_d2i_private_key, NULL,              \
        keytype##_d2i_key_params, NULL, NULL, keytype##_check, keytype##_adjust, keytype##_free

#define DO_PrivateKeyInfo(keytype)                                                                                                                             \
    "PrivateKeyInfo", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PRIVATE_KEY), NULL, NULL, NULL, keytype##_d2i_PKCS8, NULL, keytype##_check, keytype##_adjust,   \
        keytype##_free

#define DO_SubjectPublicKeyInfo(keytype)                                                                                                                       \
    "SubjectPublicKeyInfo", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PUBLIC_KEY), NULL, NULL, NULL, NULL, keytype##_d2i_PUBKEY, keytype##_check,               \
        keytype##_adjust, keytype##_free

#define DO_DH(keytype)                                                                                                                                         \
    "DH", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), NULL, NULL, keytype##_d2i_key_params, NULL, NULL, keytype##_check, keytype##_adjust,       \
        keytype##_free

#define DO_DHX(keytype)                                                                                                                                        \
    "DHX", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), NULL, NULL, keytype##_d2i_key_params, NULL, NULL, keytype##_check, keytype##_adjust,      \
        keytype##_free

#define DO_DSA(keytype)                                                                                                                                        \
    "DSA", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_ALL), keytype##_d2i_private_key, keytype##_d2i_public_key, keytype##_d2i_key_params, NULL, NULL,           \
        keytype##_check, keytype##_adjust, keytype##_free

#define DO_EC(keytype)                                                                                                                                         \
    "EC", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_PRIVATE_KEY | OSSL_KEYMGMT_SELECT_ALL_PARAMETERS), keytype##_d2i_private_key, NULL,                         \
        keytype##_d2i_key_params, NULL, NULL, keytype##_check, keytype##_adjust, keytype##_free

#define DO_RSA(keytype)                                                                                                                                        \
    "RSA", keytype##_evp_type, (OSSL_KEYMGMT_SELECT_KEYPAIR), keytype##_d2i_private_key, keytype##_d2i_public_key, NULL, NULL, NULL, keytype##_check,          \
        keytype##_adjust, keytype##_free
...
#define MAKE_DECODER(keytype_name, keytype, type, kind)                                                                                                        \
    ...
    const OSSL_DISPATCH ossl_##kind##_der_to_##keytype##_decoder_functions[]                                                                                   \
        = { { OSSL_FUNC_DECODER_NEWCTX, (void (*)(void))kind##_der2##keytype##_newctx }, { OSSL_FUNC_DECODER_FREECTX, (void (*)(void))der2key_freectx },       \
              { OSSL_FUNC_DECODER_DOES_SELECTION, (void (*)(void))kind##_der2##keytype##_does_selection },                                                     \
              { OSSL_FUNC_DECODER_DECODE, (void (*)(void))der2key_decode }, { OSSL_FUNC_DECODER_EXPORT_OBJECT, (void (*)(void))der2key_export_object },        \
              { 0, NULL } }
