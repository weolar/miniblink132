...
static int mac_digest_sign_init(void* vpmacctx, const char* mdname, void* vkey, const OSSL_PARAM params[])
{
    ...
    if (!ossl_prov_set_macctx(pmacctx->macctx, NULL, (char*)ciphername, (char*)mdname, (char*)engine, pmacctx->key->properties, NULL, 0))
        return 0;
...
#define MAC_SETTABLE_CTX_PARAMS(funcname, macname)                                                                                                             \
    static const OSSL_PARAM* mac_##funcname##_settable_ctx_params(void* ctx, void* provctx)                                                                    \
    {                                                                                                                                                          \
...
#define MAC_SIGNATURE_FUNCTIONS(funcname)                                                                                                                      \
    const OSSL_DISPATCH ossl_mac_legacy_##funcname##_signature_functions[] = { { OSSL_FUNC_SIGNATURE_NEWCTX, (void (*)(void))mac_##funcname##_newctx },        \
        { OSSL_FUNC_SIGNATURE_DIGEST_SIGN_INIT, (void (*)(void))mac_digest_sign_init },                                                                        \
        { OSSL_FUNC_SIGNATURE_DIGEST_SIGN_UPDATE, (void (*)(void))mac_digest_sign_update },                                                                    \
        { OSSL_FUNC_SIGNATURE_DIGEST_SIGN_FINAL, (void (*)(void))mac_digest_sign_final }, { OSSL_FUNC_SIGNATURE_FREECTX, (void (*)(void))mac_freectx },        \
        { OSSL_FUNC_SIGNATURE_DUPCTX, (void (*)(void))mac_dupctx }, { OSSL_FUNC_SIGNATURE_SET_CTX_PARAMS, (void (*)(void))mac_set_ctx_params },                \
        { OSSL_FUNC_SIGNATURE_SETTABLE_CTX_PARAMS, (void (*)(void))mac_##funcname##_settable_ctx_params }, { 0, NULL } };
