...
#define KDF_SETTABLE_CTX_PARAMS(funcname, kdfname)                                                                                                             \
    static const OSSL_PARAM* kdf_##funcname##_settable_ctx_params(void* vpkdfctx, void* provctx)                                                               \
    {                                                                                                                                                          \
...
#define KDF_KEYEXCH_FUNCTIONS(funcname)                                                                                                                        \
    const OSSL_DISPATCH ossl_kdf_##funcname##_keyexch_functions[]                                                                                              \
        = { { OSSL_FUNC_KEYEXCH_NEWCTX, (void (*)(void))kdf_##funcname##_newctx }, { OSSL_FUNC_KEYEXCH_INIT, (void (*)(void))kdf_init },                       \
              { OSSL_FUNC_KEYEXCH_DERIVE, (void (*)(void))kdf_derive }, { OSSL_FUNC_KEYEXCH_FREECTX, (void (*)(void))kdf_freectx },                            \
              { OSSL_FUNC_KEYEXCH_DUPCTX, (void (*)(void))kdf_dupctx }, { OSSL_FUNC_KEYEXCH_SET_CTX_PARAMS, (void (*)(void))kdf_set_ctx_params },              \
              { OSSL_FUNC_KEYEXCH_SETTABLE_CTX_PARAMS, (void (*)(void))kdf_##funcname##_settable_ctx_params }, { 0, NULL } };
