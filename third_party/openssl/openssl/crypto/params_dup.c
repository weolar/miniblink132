...
static int ossl_param_buf_alloc(OSSL_PARAM_BUF* out, size_t extra_blocks, int is_secure)
{
...
static OSSL_PARAM* ossl_param_dup(const OSSL_PARAM* src, OSSL_PARAM* dst, OSSL_PARAM_BUF buf[OSSL_PARAM_BUF_MAX], int* param_count)
{
    const OSSL_PARAM* in;
