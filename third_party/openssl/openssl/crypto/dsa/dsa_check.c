...
int ossl_dsa_check_priv_key(const DSA* dsa, const BIGNUM* priv_key, int* ret)
{
    *ret = 0;
    ...
    return (dsa->params.q != NULL && ossl_ffc_validate_private_key(dsa->params.q, priv_key, ret));
}
...
int ossl_dsa_check_pairwise(const DSA* dsa)
{
    ...
    if (dsa->params.p == NULL || dsa->params.g == NULL || dsa->priv_key == NULL || dsa->pub_key == NULL)
        return 0;
