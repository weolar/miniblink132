...
#define FFDHE(sz, keylength)                                                                                                                                   \
    {                                                                                                                                                          \
        SN_ffdhe##sz, NID_ffdhe##sz, sz, keylength, &ossl_bignum_ffdhe##sz##_p, &ossl_bignum_ffdhe##sz##_q, &ossl_bignum_const_2,                              \
    }

#define MODP(sz, keylength)                                                                                                                                    \
    {                                                                                                                                                          \
        SN_modp_##sz, NID_modp_##sz, sz, keylength, &ossl_bignum_modp_##sz##_p, &ossl_bignum_modp_##sz##_q, &ossl_bignum_const_2                               \
    }
