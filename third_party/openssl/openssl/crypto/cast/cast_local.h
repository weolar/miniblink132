...
#undef c2l
#define c2l(c, l)                                                                                                                                              \
    (l = ((unsigned long)(*((c)++))), l |= ((unsigned long)(*((c)++))) << 8L, l |= ((unsigned long)(*((c)++))) << 16L, l |= ((unsigned long)(*((c)++))) << 24L)
...
#undef l2c
#define l2c(l, c)                                                                                                                                              \
    (*((c)++) = (unsigned char)(((l)) & 0xff), *((c)++) = (unsigned char)(((l) >> 8L) & 0xff), *((c)++) = (unsigned char)(((l) >> 16L) & 0xff),                \
...
#undef n2l
#define n2l(c, l)                                                                                                                                              \
    (l = ((unsigned long)(*((c)++))) << 24L, l |= ((unsigned long)(*((c)++))) << 16L, l |= ((unsigned long)(*((c)++))) << 8L, l |= ((unsigned long)(*((c)++))))

#undef l2n
#define l2n(l, c)                                                                                                                                              \
    (*((c)++) = (unsigned char)(((l) >> 24L) & 0xff), *((c)++) = (unsigned char)(((l) >> 16L) & 0xff), *((c)++) = (unsigned char)(((l) >> 8L) & 0xff),         \
...
#define E_CAST(n, key, L, R, OP1, OP2, OP3)                                                                                                                    \
    {                                                                                                                                                          \
        ...
        i = key[n * 2 + 1];                                                                                                                                    \
        t = ROTL(t, i);                                                                                                                                        \
        L ^= (((((*(CAST_LONG*)((unsigned char*)CAST_S_table0 + ((t >> C_2) & C_M)) OP2 * (CAST_LONG*)((unsigned char*)CAST_S_table1 + ((t << C_3) & C_M)))    \
                    & 0xffffffffL) OP3                                                                                                                         \
                   * (CAST_LONG*)((unsigned char*)CAST_S_table2 + ((t >> C_0) & C_M)))                                                                         \
                  & 0xffffffffL) OP1                                                                                                                           \
                 * (CAST_LONG*)((unsigned char*)CAST_S_table3 + ((t >> C_1) & C_M)))                                                                           \
            & 0xffffffffL;                                                                                                                                     \
    }
