...
static int zlib_stateful_compress_block(COMP_CTX* ctx, unsigned char* out, unsigned int olen, unsigned char* in, unsigned int ilen);
...
static COMP_METHOD zlib_stateful_method
    = { NID_zlib_compression, LN_zlib_compression, zlib_stateful_init, zlib_stateful_finish, zlib_stateful_compress_block, zlib_stateful_expand_block };
...
#define LIBZ "z"
    ...
    if (zlib_dso != NULL) {
        ...
        if (p_compress == NULL || p_inflateEnd == NULL || p_inflate == NULL || p_inflateInit_ == NULL || p_deflateEnd == NULL || p_deflate == NULL
...
static const BIO_METHOD bio_meth_zlib = { BIO_TYPE_COMP, "zlib", bwrite_conv, bio_zlib_write, bread_conv, bio_zlib_read, NULL, /* bio_zlib_puts, */
    NULL, /* bio_zlib_gets, */
