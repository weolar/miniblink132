...
#define IMPLEMENT_PEM_provided_write_body_vars(type, asn1, pq)                                                                                                 \
    int ret = 0;                                                                                                                                               \
    OSSL_ENCODER_CTX* ctx = OSSL_ENCODER_CTX_new_for_##type(x, PEM_SELECTION_##asn1, "PEM", PEM_STRUCTURE_##asn1, (pq));                                       \
                                                                                                                                                               \
...
#define IMPLEMENT_PEM_provided_write_body_pass()                                                                                                               \
    ...
    if (enc != NULL) {                                                                                                                                         \
        ret = 0;                                                                                                                                               \
        if (OSSL_ENCODER_CTX_set_cipher(ctx, EVP_CIPHER_get0_name(enc), NULL)) {                                                                               \
            ret = 1;                                                                                                                                           \
            if (kstr != NULL && !OSSL_ENCODER_CTX_set_passphrase(ctx, kstr, klen))                                                                             \
                ret = 0;                                                                                                                                       \
            else if (cb != NULL && !OSSL_ENCODER_CTX_set_pem_password_cb(ctx, cb, u))                                                                          \
                ret = 0;                                                                                                                                       \
        }                                                                                                                                                      \
    }                                                                                                                                                          \
    if (!ret) {                                                                                                                                                \
...
#define IMPLEMENT_PEM_provided_write_body_main(type, outtype)                                                                                                  \
    ...
    OSSL_ENCODER_CTX_free(ctx);                                                                                                                                \
    return ret
#define IMPLEMENT_PEM_provided_write_body_fallback(str, asn1, writename)                                                                                       \
    legacy:                                                                                                                                                    \
    return PEM_ASN1_##writename((i2d_of_void*)i2d_##asn1, str, out, x, NULL, NULL, 0, NULL, NULL)
#define IMPLEMENT_PEM_provided_write_body_fallback_cb(str, asn1, writename)                                                                                    \
    legacy:                                                                                                                                                    \
    return PEM_ASN1_##writename##((i2d_of_void*)i2d_##asn1, str, out, x, enc, kstr, klen, cb, u)

#define IMPLEMENT_PEM_provided_write_to(name, TYPE, type, str, asn1, OUTTYPE, outtype, writename)                                                              \
    ...
    {                                                                                                                                                          \
        ...
        IMPLEMENT_PEM_provided_write_body_fallback(str, asn1, writename);                                                                                      \
    }                                                                                                                                                          \
...
#define IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, OUTTYPE, outtype, writename)                                                           \
    PEM_write_cb_fnsig(name, TYPE, OUTTYPE, writename)                                                                                                         \
    {                                                                                                                                                          \
        IMPLEMENT_PEM_provided_write_body_vars(type, asn1, NULL);                                                                                              \
        IMPLEMENT_PEM_provided_write_body_pass();                                                                                                              \
        IMPLEMENT_PEM_provided_write_body_main(type, outtype);                                                                                                 \
        IMPLEMENT_PEM_provided_write_body_fallback_cb(str, asn1, writename);                                                                                   \
    }                                                                                                                                                          \
...
#define IMPLEMENT_PEM_provided_write_fp(name, TYPE, type, str, asn1) IMPLEMENT_PEM_provided_write_to(name, TYPE, type, str, asn1, FILE, fp, write)
#define IMPLEMENT_PEM_provided_write_cb_fp(name, TYPE, type, str, asn1) IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, FILE, fp, write)

#endif

#define IMPLEMENT_PEM_provided_write_bio(name, TYPE, type, str, asn1) IMPLEMENT_PEM_provided_write_to(name, TYPE, type, str, asn1, BIO, bio, write_bio)
#define IMPLEMENT_PEM_provided_write_cb_bio(name, TYPE, type, str, asn1) IMPLEMENT_PEM_provided_write_cb_to(name, TYPE, type, str, asn1, BIO, bio, write_bio)

#define IMPLEMENT_PEM_provided_write(name, TYPE, type, str, asn1)                                                                                              \
    IMPLEMENT_PEM_provided_write_bio(name, TYPE, type, str, asn1) IMPLEMENT_PEM_provided_write_fp(name, TYPE, type, str, asn1)

#define IMPLEMENT_PEM_provided_write_cb(name, TYPE, type, str, asn1)                                                                                           \
    IMPLEMENT_PEM_provided_write_cb_bio(name, TYPE, type, str, asn1) IMPLEMENT_PEM_provided_write_cb_fp(name, TYPE, type, str, asn1)

#define IMPLEMENT_PEM_provided_rw(name, TYPE, type, str, asn1)                                                                                                 \
    IMPLEMENT_PEM_read(name, TYPE, str, asn1) IMPLEMENT_PEM_provided_write(name, TYPE, type, str, asn1)

#define IMPLEMENT_PEM_provided_rw_cb(name, TYPE, type, str, asn1)                                                                                              \
    IMPLEMENT_PEM_read(name, TYPE, str, asn1) IMPLEMENT_PEM_provided_write_cb(name, TYPE, type, str, asn1)
