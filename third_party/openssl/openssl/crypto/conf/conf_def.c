...
static CONF_METHOD default_method
    = { "OpenSSL default", def_create, def_init_default, def_destroy, def_destroy_data, def_load_bio, def_dump, def_is_number, def_to_int, def_load };
...
static CONF_METHOD WIN32_method
    = { "WIN32", def_create, def_init_WIN32, def_destroy, def_destroy_data, def_load_bio, def_dump, def_is_number, def_to_int, def_load };
    ...
    read_retry:
        ...
        again:
            ...
            *end = '\0';
            ...
            p = eat_ws(conf, end);
            if (strncmp(pname, ".pragma", 7) == 0 && (p != pname + 7 || *p == '=')) {
                char* pval;
                ...
                *pval++ = '\0';
                 ...
                 */
                continue;
            } else if (strncmp(pname, ".include", 8) == 0 && (p != pname + 8 || *p == '=')) {
                char* include = NULL;
                BIO* next;
