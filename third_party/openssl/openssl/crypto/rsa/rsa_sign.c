...
#define ENCODE_DIGESTINFO_SHA(name, n, sz)                                                                                                                     \
    static const unsigned char digestinfo_##name##_der[] = { ASN1_SEQUENCE, 0x11 + sz, ASN1_SEQUENCE, 0x0d, ASN1_OID, 0x09, 2 * 40 + 16, 0x86, 0x48, 1, 101,   \
        3, 4, 2, n, ASN1_NULL, 0x00, ASN1_OCTET_STRING, sz };

/* MD2, MD4 and MD5 OIDs are of the form: (1 2 840 113549 2 |n|) */
#define ENCODE_DIGESTINFO_MD(name, n, sz)                                                                                                                      \
    static const unsigned char digestinfo_##name##_der[] = { ASN1_SEQUENCE, 0x10 + sz, ASN1_SEQUENCE, 0x0c, ASN1_OID, 0x08, 1 * 40 + 2, 0x86, 0x48, 0x86,      \
        0xf7, 0x0d, 2, n, ASN1_NULL, 0x00, ASN1_OCTET_STRING, sz };
...
#ifndef OPENSSL_NO_MDC2
/* MDC-2 (2 5 8 3 101) */
static const unsigned char digestinfo_mdc2_der[] = { ASN1_SEQUENCE, 0x0c + MDC2_DIGEST_LENGTH, ASN1_SEQUENCE, 0x08, ASN1_OID, 0x04, 2 * 40 + 5, 8, 3, 101,
    ASN1_NULL, 0x00, ASN1_OCTET_STRING, MDC2_DIGEST_LENGTH };
#endif
#ifndef OPENSSL_NO_RMD160
/* RIPEMD160 (1 3 36 3 2 1) */
static const unsigned char digestinfo_ripemd160_der[] = { ASN1_SEQUENCE, 0x0d + RIPEMD160_DIGEST_LENGTH, ASN1_SEQUENCE, 0x09, ASN1_OID, 0x05, 1 * 40 + 3, 36, 3,
    2, 1, ASN1_NULL, 0x00, ASN1_OCTET_STRING, RIPEMD160_DIGEST_LENGTH };
#endif
#endif /* FIPS_MODULE */

/* SHA-1 (1 3 14 3 2 26) */
static const unsigned char digestinfo_sha1_der[] = { ASN1_SEQUENCE, 0x0d + SHA_DIGEST_LENGTH, ASN1_SEQUENCE, 0x09, ASN1_OID, 0x05, 1 * 40 + 3, 14, 3, 2, 26,
    ASN1_NULL, 0x00, ASN1_OCTET_STRING, SHA_DIGEST_LENGTH };
 ...
 */
int ossl_rsa_verify(
    int type, const unsigned char* m, unsigned int m_len, unsigned char* rm, size_t* prm_len, const unsigned char* sigbuf, size_t siglen, RSA* rsa)
{
    int len, ret = 0;
