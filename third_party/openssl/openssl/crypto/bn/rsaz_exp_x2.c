...
#define ALIGN_OF(ptr, boundary) ((unsigned char*)(ptr) + (boundary - (((size_t)(ptr)) & (boundary - 1))))
...
int ossl_rsaz_mod_exp_avx512_x2(BN_ULONG* res1, const BN_ULONG* base1, const BN_ULONG* exp1, const BN_ULONG* m1, const BN_ULONG* rr1, BN_ULONG k0_1,
    BN_ULONG* res2, const BN_ULONG* base2, const BN_ULONG* exp2, const BN_ULONG* m2, const BN_ULONG* rr2, BN_ULONG k0_2, int factor_size)
{
    int ret = 0;
 ...
 */
#define DAMS(r, a, m, k0) ossl_rsaz_amm52x20_x2_256((r), (a), (a), (m), (k0))
