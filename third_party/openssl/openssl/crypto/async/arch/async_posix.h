...
#if defined(OPENSSL_SYS_UNIX) && defined(OPENSSL_THREADS) && !defined(OPENSSL_NO_ASYNC) && !defined(__ANDROID__) && !defined(__OpenBSD__)

#include <unistd.h>

#if _POSIX_VERSION >= 200112L && (_POSIX_VERSION < 200809L || defined(__GLIBC__))
