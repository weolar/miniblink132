 ...
 * modulo that modulus.
 */
c448_error_t ossl_curve448_scalar_decode(curve448_scalar_t out, const unsigned char ser[C448_SCALAR_BYTES]);
 ...
 * out (out): Deserialized form.
 */
void ossl_curve448_scalar_decode_long(curve448_scalar_t out, const unsigned char* ser, size_t ser_len);
 ...
 */
static ossl_inline void curve448_scalar_copy(curve448_scalar_t out, const curve448_scalar_t a)
{
    *out = *a;
}
 ...
 * scalar (in): The scalar to multiply by.
 */
void ossl_curve448_precomputed_scalarmul(curve448_point_t scaled, const curve448_precomputed_s* base, const curve448_scalar_t scalar);
