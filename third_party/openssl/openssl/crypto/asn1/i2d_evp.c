...
static int i2d_provided(const EVP_PKEY* a, int selection, const struct type_and_structure_st* output_info, unsigned char** pp)
{
...
{
    if (evp_pkey_is_provided(a)) {
        static const struct type_and_structure_st output_info[] = { { "DER", "type-specific" }, { "DER", "PrivateKeyInfo" },
            {
                NULL,
            } };
...
{
    if (evp_pkey_is_provided(a)) {
        static const struct type_and_structure_st output_info[] = { { "DER", "type-specific" }, { "blob", NULL }, /* for EC */
            {
                NULL,
            } };
