...
static ossl_inline void asn1_type_init_oct(ASN1_OCTET_STRING* oct, unsigned char* data, int len)
{
    oct->data = data;
...
static int asn1_type_get_int_oct(ASN1_OCTET_STRING* oct, int32_t anum, long* num, unsigned char* data, int max_len)
{
...
ASN1_SEQUENCE(asn1_int_oct) = { ASN1_EMBED(asn1_int_oct, num, INT32), ASN1_SIMPLE(asn1_int_oct, oct, ASN1_OCTET_STRING) } static_ASN1_SEQUENCE_END(asn1_int_oct)
 ...
 */
ASN1_SEQUENCE(asn1_oct_int) = { ASN1_SIMPLE(asn1_oct_int, oct, ASN1_OCTET_STRING), ASN1_EMBED(asn1_oct_int, num, INT32) } static_ASN1_SEQUENCE_END(asn1_oct_int)
