...
static int do_buf(unsigned char* buf, int buflen, int type, unsigned short flags, char* quotes, char_io* io_ch, void* arg)
{
...
static int do_dump(unsigned long lflags, char_io* io_ch, void* arg, const ASN1_STRING* str)
{
    /*
