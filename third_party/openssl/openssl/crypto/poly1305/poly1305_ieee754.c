...
#endif
#ifndef U32TO8
#define U32TO8(p, v) ((p)[0] = (u8)(v), (p)[1] = (u8)((v) >> 8), (p)[2] = (u8)((v) >> 16), (p)[3] = (u8)((v) >> 24))
#endif
...
void poly1305_blocks(void* ctx, const unsigned char* inp, size_t len, int padbit)
{
    poly1305_internal* st = (poly1305_internal*)ctx;
