...
#define n2l(c, l) (l = ((DES_LONG)(*((c)++))) << 24L, l |= ((DES_LONG)(*((c)++))) << 16L, l |= ((DES_LONG)(*((c)++))) << 8L, l |= ((DES_LONG)(*((c)++))))
...
#define D_ENCRYPT(LL, R, S)                                                                                                                                    \
    {                                                                                                                                                          \
        ...
        t = ROTATE(t, 4);                                                                                                                                      \
        LL ^= DES_SPtrans[0][(u >> 2L) & 0x3f] ^ DES_SPtrans[2][(u >> 10L) & 0x3f] ^ DES_SPtrans[4][(u >> 18L) & 0x3f] ^ DES_SPtrans[6][(u >> 26L) & 0x3f]     \
            ^ DES_SPtrans[1][(t >> 2L) & 0x3f] ^ DES_SPtrans[3][(t >> 10L) & 0x3f] ^ DES_SPtrans[5][(t >> 18L) & 0x3f] ^ DES_SPtrans[7][(t >> 26L) & 0x3f];    \
    }
