...
{
    return ENGINE_load_ssl_client_cert(s->ctx->client_cert_engine, s, SSL_get_client_CA_list(s), px509, ppkey, NULL, NULL, NULL);
}
#endif
...
int ssl_set_tmp_ecdh_groups(uint16_t** pext, size_t* pextlen, void* key)
{
