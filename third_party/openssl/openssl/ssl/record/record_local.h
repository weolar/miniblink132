...
__owur int ssl3_read_n(SSL* s, size_t n, size_t max, int extend, int clearold, size_t* readbytes);
...
__owur int ssl3_cbc_remove_padding_and_mac(
...
__owur int tls1_cbc_remove_padding_and_mac(size_t* reclen, size_t origreclen, unsigned char* recdata, unsigned char** mac, int* alloced, size_t block_size,
