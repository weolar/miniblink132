...
static ossl_inline void ossl_sleep(unsigned long millis)
{
    ...
    do {
        ...
        elapsedms = (((now.tv_sec - start.tv_sec) * 1000000) + now.tv_usec - start.tv_usec) / 1000;
...
/* unistd.h defines _POSIX_VERSION */
    ...
    && ((defined(_POSIX_VERSION) && _POSIX_VERSION >= 200112L) || defined(__sun) || defined(__hpux) || defined(__sgi) || defined(__osf__)))                    \
    || defined(_WIN32)
