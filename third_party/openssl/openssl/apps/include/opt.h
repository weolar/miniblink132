 ...
 */
#define OPT_V_ENUM                                                                                                                                             \
    OPT_V__FIRST = 2000, OPT_V_POLICY, OPT_V_PURPOSE, OPT_V_VERIFY_NAME, OPT_V_VERIFY_DEPTH, OPT_V_ATTIME, OPT_V_VERIFY_HOSTNAME, OPT_V_VERIFY_EMAIL,          \
    OPT_V_VERIFY_IP, OPT_V_IGNORE_CRITICAL, OPT_V_ISSUER_CHECKS, OPT_V_CRL_CHECK, OPT_V_CRL_CHECK_ALL, OPT_V_POLICY_CHECK, OPT_V_EXPLICIT_POLICY,              \
    OPT_V_INHIBIT_ANY, OPT_V_INHIBIT_MAP, OPT_V_X509_STRICT, OPT_V_EXTENDED_CRL, OPT_V_USE_DELTAS, OPT_V_POLICY_PRINT, OPT_V_CHECK_SS_SIG,                     \
    OPT_V_TRUSTED_FIRST, OPT_V_SUITEB_128_ONLY, OPT_V_SUITEB_128, OPT_V_SUITEB_192, OPT_V_PARTIAL_CHAIN, OPT_V_NO_ALT_CHAINS, OPT_V_NO_CHECK_TIME,             \
    OPT_V_VERIFY_AUTH_LEVEL, OPT_V_ALLOW_PROXY_CERTS, OPT_V__LAST

#define OPT_V_OPTIONS                                                                                                                                          \
    OPT_SECTION("Validation"), { "policy", OPT_V_POLICY, 's', "adds policy to the acceptable policy set" },                                                    \
        { "purpose", OPT_V_PURPOSE, 's', "certificate chain purpose" }, { "verify_name", OPT_V_VERIFY_NAME, 's', "verification policy name" },                 \
        { "verify_depth", OPT_V_VERIFY_DEPTH, 'n', "chain depth limit" },                                                                                      \
        { "auth_level", OPT_V_VERIFY_AUTH_LEVEL, 'n', "chain authentication security level" }, { "attime", OPT_V_ATTIME, 'M', "verification epoch time" },     \
        { "verify_hostname", OPT_V_VERIFY_HOSTNAME, 's', "expected peer hostname" }, { "verify_email", OPT_V_VERIFY_EMAIL, 's', "expected peer email" },       \
        ...
        { "issuer_checks", OPT_V_ISSUER_CHECKS, '-', "(deprecated)" }, { "crl_check", OPT_V_CRL_CHECK, '-', "check leaf certificate revocation" },             \
        ...
        { "extended_crl", OPT_V_EXTENDED_CRL, '-', "enable extended CRL features" }, { "use_deltas", OPT_V_USE_DELTAS, '-', "use delta CRLs" },                \
        ...
        { "no_alt_chains", OPT_V_NO_ALT_CHAINS, '-', "(deprecated)" }, { "no_check_time", OPT_V_NO_CHECK_TIME, '-', "ignore certificate validity time" },      \
    {                                                                                                                                                          \
 ...
 */
#define OPT_X_ENUM OPT_X__FIRST = 1000, OPT_X_KEY, OPT_X_CERT, OPT_X_CHAIN, OPT_X_CHAIN_BUILD, OPT_X_CERTFORM, OPT_X_KEYFORM, OPT_X__LAST

#define OPT_X_OPTIONS                                                                                                                                          \
    OPT_SECTION("Extended certificate"), { "xkey", OPT_X_KEY, '<', "key for Extended certificates" },                                                          \
        { "xcert", OPT_X_CERT, '<', "cert for Extended certificates" }, { "xchain", OPT_X_CHAIN, '<', "chain for Extended certificates" },                     \
 ...
 */
#define OPT_S_ENUM                                                                                                                                             \
    OPT_S__FIRST = 3000, OPT_S_NOSSL3, OPT_S_NOTLS1, OPT_S_NOTLS1_1, OPT_S_NOTLS1_2, OPT_S_NOTLS1_3, OPT_S_BUGS, OPT_S_NO_COMP, OPT_S_NOTICKET,                \
    OPT_S_SERVERPREF, OPT_S_LEGACYRENEG, OPT_S_CLIENTRENEG, OPT_S_LEGACYCONN, OPT_S_ONRESUMP, OPT_S_NOLEGACYCONN, OPT_S_ALLOW_NO_DHE_KEX,                      \
    OPT_S_PRIORITIZE_CHACHA, OPT_S_STRICT, OPT_S_SIGALGS, OPT_S_CLIENTSIGALGS, OPT_S_GROUPS, OPT_S_CURVES, OPT_S_NAMEDCURVE, OPT_S_CIPHER, OPT_S_CIPHERSUITES, \
    OPT_S_RECORD_PADDING, OPT_S_DEBUGBROKE, OPT_S_COMP, OPT_S_MINPROTO, OPT_S_MAXPROTO, OPT_S_NO_RENEGOTIATION, OPT_S_NO_MIDDLEBOX, OPT_S_NO_ETM, OPT_S__LAST

#define OPT_S_OPTIONS                                                                                                                                          \
    OPT_SECTION("TLS/SSL"), { "no_ssl3", OPT_S_NOSSL3, '-', "Just disable SSLv3" }, { "no_tls1", OPT_S_NOTLS1, '-', "Just disable TLSv1" },                    \
        { "no_tls1_1", OPT_S_NOTLS1_1, '-', "Just disable TLSv1.1" }, { "no_tls1_2", OPT_S_NOTLS1_2, '-', "Just disable TLSv1.2" },                            \
        { "no_tls1_3", OPT_S_NOTLS1_3, '-', "Just disable TLSv1.3" }, { "bugs", OPT_S_BUGS, '-', "Turn on SSL bug compatibility" },                            \
        { "no_comp", OPT_S_NO_COMP, '-', "Disable SSL/TLS compression (default)" }, { "comp", OPT_S_COMP, '-', "Use SSL/TLS-level compression" },              \
...
#define IS_NO_PROT_FLAG(o) (o == OPT_S_NOSSL3 || o == OPT_S_NOTLS1 || o == OPT_S_NOTLS1_1 || o == OPT_S_NOTLS1_2 || o == OPT_S_NOTLS1_3)
...
#define OPT_R_OPTIONS                                                                                                                                          \
    OPT_SECTION("Random state"), { "rand", OPT_R_RAND, 's', "Load the given file(s) into the random number generator" },                                       \
    {                                                                                                                                                          \
 ...
 * Provider options.
 */
#define OPT_PROV_ENUM OPT_PROV__FIRST = 1600, OPT_PROV_PROVIDER, OPT_PROV_PROVIDER_PATH, OPT_PROV_PROPQUERY, OPT_PROV__LAST
...
#define OPT_PROV_OPTIONS                                                                                                                                       \
    OPT_SECTION("Provider"), { "provider-path", OPT_PROV_PROVIDER_PATH, 's', "Provider load path (must be before 'provider' argument if required)" },          \
