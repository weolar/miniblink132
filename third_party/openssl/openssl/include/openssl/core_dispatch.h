...
OSSL_CORE_MAKE_FUNC(
    size_t, get_nonce, (const OSSL_CORE_HANDLE* handle, unsigned char** pout, size_t min_len, size_t max_len, const void* salt, size_t salt_len))
...
OSSL_CORE_MAKE_FUNC(int, provider_register_child_cb,
    (const OSSL_CORE_HANDLE* handle, int (*create_cb)(const OSSL_CORE_HANDLE* provider, void* cbdata),
...
OSSL_CORE_MAKE_FUNC(
    int, cipher_encrypt_init, (void* cctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[]))
OSSL_CORE_MAKE_FUNC(
    int, cipher_decrypt_init, (void* cctx, const unsigned char* key, size_t keylen, const unsigned char* iv, size_t ivlen, const OSSL_PARAM params[]))
...
OSSL_CORE_MAKE_FUNC(int, rand_generate,
    (void* vctx, unsigned char* out, size_t outlen, unsigned int strength, int prediction_resistance, const unsigned char* addin, size_t addin_len))
OSSL_CORE_MAKE_FUNC(
    int, rand_reseed, (void* vctx, int prediction_resistance, const unsigned char* ent, size_t ent_len, const unsigned char* addin, size_t addin_len))
...
OSSL_CORE_MAKE_FUNC(void, rand_set_callbacks,
    (void* vctx, OSSL_INOUT_CALLBACK* get_entropy, OSSL_CALLBACK* cleanup_entropy, OSSL_INOUT_CALLBACK* get_nonce, OSSL_CALLBACK* cleanup_nonce, void* arg))
OSSL_CORE_MAKE_FUNC(int, rand_verify_zeroization, (void* vctx))
OSSL_CORE_MAKE_FUNC(size_t, rand_get_seed,
    (void* vctx, unsigned char** buffer, int entropy, size_t min_len, size_t max_len, int prediction_resistance, const unsigned char* adin, size_t adin_len))
...
#define OSSL_KEYMGMT_SELECT_ALL_PARAMETERS (OSSL_KEYMGMT_SELECT_DOMAIN_PARAMETERS | OSSL_KEYMGMT_SELECT_OTHER_PARAMETERS)
#define OSSL_KEYMGMT_SELECT_KEYPAIR (OSSL_KEYMGMT_SELECT_PRIVATE_KEY | OSSL_KEYMGMT_SELECT_PUBLIC_KEY)
...
OSSL_CORE_MAKE_FUNC(int, encoder_encode,
    (void* ctx, OSSL_CORE_BIO* out, const void* obj_raw, const OSSL_PARAM obj_abstract[], int selection, OSSL_PASSPHRASE_CALLBACK* cb, void* cbarg))
...
OSSL_CORE_MAKE_FUNC(int, decoder_decode,
    (void* ctx, OSSL_CORE_BIO* in, int selection, OSSL_CALLBACK* data_cb, void* data_cbarg, OSSL_PASSPHRASE_CALLBACK* pw_cb, void* pw_cbarg))
