...
#define OSSL_DEPRECATED_FOR(since, message) __declspec(deprecated("Since OpenSSL " #since ";" message))
#elif _MSC_VER >= 1310
...
#else
#define OPENSSL_API_LEVEL (((OPENSSL_API_COMPAT >> 28) & 0xF) * 10000 + ((OPENSSL_API_COMPAT >> 20) & 0xFF) * 100 + ((OPENSSL_API_COMPAT >> 12) & 0xFF))
#endif
#endif
