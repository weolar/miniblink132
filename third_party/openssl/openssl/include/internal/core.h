...
typedef struct ossl_method_construct_method_st {
    ...
    int (*put)(void* store, void* method, const OSSL_PROVIDER* prov, const char* name, const char* propdef, void* data);
...
void* ossl_method_construct(
    OSSL_LIB_CTX* ctx, int operation_id, OSSL_PROVIDER** provider_rw, int force_cache, OSSL_METHOD_CONSTRUCT_METHOD* mcm, void* mcm_data);
