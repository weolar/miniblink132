...
#define sk_X509_LOOKUP_deep_copy(sk, copyfunc, freefunc)                                                                                                       \
    ((STACK_OF(X509_LOOKUP)*)OPENSSL_sk_deep_copy(                                                                                                             \
        ossl_check_const_X509_LOOKUP_sk_type(sk), ossl_check_X509_LOOKUP_copyfunc_type(copyfunc), ossl_check_X509_LOOKUP_freefunc_type(freefunc)))
#define sk_X509_LOOKUP_set_cmp_func(sk, cmp)                                                                                                                   \
    ((sk_X509_LOOKUP_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_LOOKUP_sk_type(sk), ossl_check_X509_LOOKUP_compfunc_type(cmp)))
...
#define sk_X509_OBJECT_deep_copy(sk, copyfunc, freefunc)                                                                                                       \
    ((STACK_OF(X509_OBJECT)*)OPENSSL_sk_deep_copy(                                                                                                             \
        ossl_check_const_X509_OBJECT_sk_type(sk), ossl_check_X509_OBJECT_copyfunc_type(copyfunc), ossl_check_X509_OBJECT_freefunc_type(freefunc)))
#define sk_X509_OBJECT_set_cmp_func(sk, cmp)                                                                                                                   \
    ((sk_X509_OBJECT_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_OBJECT_sk_type(sk), ossl_check_X509_OBJECT_compfunc_type(cmp)))
...
#define sk_X509_VERIFY_PARAM_delete_ptr(sk, ptr)                                                                                                               \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_delete_ptr(ossl_check_X509_VERIFY_PARAM_sk_type(sk), ossl_check_X509_VERIFY_PARAM_type(ptr)))
...
#define sk_X509_VERIFY_PARAM_pop_free(sk, freefunc)                                                                                                            \
    OPENSSL_sk_pop_free(ossl_check_X509_VERIFY_PARAM_sk_type(sk), ossl_check_X509_VERIFY_PARAM_freefunc_type(freefunc))
...
#define sk_X509_VERIFY_PARAM_set(sk, idx, ptr)                                                                                                                 \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_set(ossl_check_X509_VERIFY_PARAM_sk_type(sk), (idx), ossl_check_X509_VERIFY_PARAM_type(ptr)))
...
#define sk_X509_VERIFY_PARAM_deep_copy(sk, copyfunc, freefunc)                                                                                                 \
    ((STACK_OF(X509_VERIFY_PARAM)*)OPENSSL_sk_deep_copy(ossl_check_const_X509_VERIFY_PARAM_sk_type(sk), ossl_check_X509_VERIFY_PARAM_copyfunc_type(copyfunc),  \
        ossl_check_X509_VERIFY_PARAM_freefunc_type(freefunc)))
#define sk_X509_VERIFY_PARAM_set_cmp_func(sk, cmp)                                                                                                             \
    ((sk_X509_VERIFY_PARAM_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_VERIFY_PARAM_sk_type(sk), ossl_check_X509_VERIFY_PARAM_compfunc_type(cmp)))
...
#define sk_X509_TRUST_deep_copy(sk, copyfunc, freefunc)                                                                                                        \
    ((STACK_OF(X509_TRUST)*)OPENSSL_sk_deep_copy(                                                                                                              \
        ossl_check_const_X509_TRUST_sk_type(sk), ossl_check_X509_TRUST_copyfunc_type(copyfunc), ossl_check_X509_TRUST_freefunc_type(freefunc)))
#define sk_X509_TRUST_set_cmp_func(sk, cmp)                                                                                                                    \
    ((sk_X509_TRUST_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_TRUST_sk_type(sk), ossl_check_X509_TRUST_compfunc_type(cmp)))
...
typedef int (*X509_LOOKUP_get_by_subject_ex_fn)(
    X509_LOOKUP* ctx, X509_LOOKUP_TYPE type, const X509_NAME* name, X509_OBJECT* ret, OSSL_LIB_CTX* libctx, const char* propq);
typedef int (*X509_LOOKUP_get_by_issuer_serial_fn)(
    X509_LOOKUP* ctx, X509_LOOKUP_TYPE type, const X509_NAME* name, const ASN1_INTEGER* serial, X509_OBJECT* ret);
