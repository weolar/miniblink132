...
#define sk_SRP_gN_cache_deep_copy(sk, copyfunc, freefunc)                                                                                                      \
    ((STACK_OF(SRP_gN_cache)*)OPENSSL_sk_deep_copy(                                                                                                            \
        ossl_check_const_SRP_gN_cache_sk_type(sk), ossl_check_SRP_gN_cache_copyfunc_type(copyfunc), ossl_check_SRP_gN_cache_freefunc_type(freefunc)))
#define sk_SRP_gN_cache_set_cmp_func(sk, cmp)                                                                                                                  \
    ((sk_SRP_gN_cache_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_SRP_gN_cache_sk_type(sk), ossl_check_SRP_gN_cache_compfunc_type(cmp)))
...
#define sk_SRP_user_pwd_deep_copy(sk, copyfunc, freefunc)                                                                                                      \
    ((STACK_OF(SRP_user_pwd)*)OPENSSL_sk_deep_copy(                                                                                                            \
        ossl_check_const_SRP_user_pwd_sk_type(sk), ossl_check_SRP_user_pwd_copyfunc_type(copyfunc), ossl_check_SRP_user_pwd_freefunc_type(freefunc)))
#define sk_SRP_user_pwd_set_cmp_func(sk, cmp)                                                                                                                  \
    ((sk_SRP_user_pwd_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_SRP_user_pwd_sk_type(sk), ossl_check_SRP_user_pwd_compfunc_type(cmp)))
...
#define sk_SRP_gN_deep_copy(sk, copyfunc, freefunc)                                                                                                            \
    ((STACK_OF(SRP_gN)*)OPENSSL_sk_deep_copy(                                                                                                                  \
        ossl_check_const_SRP_gN_sk_type(sk), ossl_check_SRP_gN_copyfunc_type(copyfunc), ossl_check_SRP_gN_freefunc_type(freefunc)))
