...
#define sk_PKCS7_SIGNER_INFO_delete_ptr(sk, ptr)                                                                                                               \
    ((PKCS7_SIGNER_INFO*)OPENSSL_sk_delete_ptr(ossl_check_PKCS7_SIGNER_INFO_sk_type(sk), ossl_check_PKCS7_SIGNER_INFO_type(ptr)))
...
#define sk_PKCS7_SIGNER_INFO_pop_free(sk, freefunc)                                                                                                            \
    OPENSSL_sk_pop_free(ossl_check_PKCS7_SIGNER_INFO_sk_type(sk), ossl_check_PKCS7_SIGNER_INFO_freefunc_type(freefunc))
...
#define sk_PKCS7_SIGNER_INFO_set(sk, idx, ptr)                                                                                                                 \
    ((PKCS7_SIGNER_INFO*)OPENSSL_sk_set(ossl_check_PKCS7_SIGNER_INFO_sk_type(sk), (idx), ossl_check_PKCS7_SIGNER_INFO_type(ptr)))
...
#define sk_PKCS7_SIGNER_INFO_deep_copy(sk, copyfunc, freefunc)                                                                                                 \
    ((STACK_OF(PKCS7_SIGNER_INFO)*)OPENSSL_sk_deep_copy(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sk), ossl_check_PKCS7_SIGNER_INFO_copyfunc_type(copyfunc),  \
        ossl_check_PKCS7_SIGNER_INFO_freefunc_type(freefunc)))
#define sk_PKCS7_SIGNER_INFO_set_cmp_func(sk, cmp)                                                                                                             \
    ((sk_PKCS7_SIGNER_INFO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_PKCS7_SIGNER_INFO_sk_type(sk), ossl_check_PKCS7_SIGNER_INFO_compfunc_type(cmp)))
...
#define sk_PKCS7_RECIP_INFO_delete_ptr(sk, ptr)                                                                                                                \
    ((PKCS7_RECIP_INFO*)OPENSSL_sk_delete_ptr(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_type(ptr)))
...
#define sk_PKCS7_RECIP_INFO_pop_free(sk, freefunc)                                                                                                             \
    OPENSSL_sk_pop_free(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_freefunc_type(freefunc))
...
#define sk_PKCS7_RECIP_INFO_set(sk, idx, ptr)                                                                                                                  \
    ((PKCS7_RECIP_INFO*)OPENSSL_sk_set(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), (idx), ossl_check_PKCS7_RECIP_INFO_type(ptr)))
...
#define sk_PKCS7_RECIP_INFO_deep_copy(sk, copyfunc, freefunc)                                                                                                  \
    ((STACK_OF(PKCS7_RECIP_INFO)*)OPENSSL_sk_deep_copy(ossl_check_const_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_copyfunc_type(copyfunc),     \
        ossl_check_PKCS7_RECIP_INFO_freefunc_type(freefunc)))
#define sk_PKCS7_RECIP_INFO_set_cmp_func(sk, cmp)                                                                                                              \
    ((sk_PKCS7_RECIP_INFO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_compfunc_type(cmp)))
...
#define sk_PKCS7_deep_copy(sk, copyfunc, freefunc)                                                                                                             \
    ((STACK_OF(PKCS7)*)OPENSSL_sk_deep_copy(                                                                                                                   \
        ossl_check_const_PKCS7_sk_type(sk), ossl_check_PKCS7_copyfunc_type(copyfunc), ossl_check_PKCS7_freefunc_type(freefunc)))
