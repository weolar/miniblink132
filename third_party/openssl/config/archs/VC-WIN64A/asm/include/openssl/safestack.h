...
#define sk_OPENSSL_STRING_deep_copy(sk, copyfunc, freefunc)                                                                                                    \
    ((STACK_OF(OPENSSL_STRING)*)OPENSSL_sk_deep_copy(                                                                                                          \
        ossl_check_const_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_copyfunc_type(copyfunc), ossl_check_OPENSSL_STRING_freefunc_type(freefunc)))
#define sk_OPENSSL_STRING_set_cmp_func(sk, cmp)                                                                                                                \
    ((sk_OPENSSL_STRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_compfunc_type(cmp)))
...
#define sk_OPENSSL_CSTRING_delete_ptr(sk, ptr)                                                                                                                 \
    ((const char*)OPENSSL_sk_delete_ptr(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_type(ptr)))
...
#define sk_OPENSSL_CSTRING_deep_copy(sk, copyfunc, freefunc)                                                                                                   \
    ((STACK_OF(OPENSSL_CSTRING)*)OPENSSL_sk_deep_copy(                                                                                                         \
        ossl_check_const_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_copyfunc_type(copyfunc), ossl_check_OPENSSL_CSTRING_freefunc_type(freefunc)))
#define sk_OPENSSL_CSTRING_set_cmp_func(sk, cmp)                                                                                                               \
    ((sk_OPENSSL_CSTRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_compfunc_type(cmp)))
...
#define sk_OPENSSL_BLOCK_deep_copy(sk, copyfunc, freefunc)                                                                                                     \
    ((STACK_OF(OPENSSL_BLOCK)*)OPENSSL_sk_deep_copy(                                                                                                           \
        ossl_check_const_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_copyfunc_type(copyfunc), ossl_check_OPENSSL_BLOCK_freefunc_type(freefunc)))
#define sk_OPENSSL_BLOCK_set_cmp_func(sk, cmp)                                                                                                                 \
    ((sk_OPENSSL_BLOCK_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_compfunc_type(cmp)))
