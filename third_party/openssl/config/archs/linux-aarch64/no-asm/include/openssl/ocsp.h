...
#define sk_OCSP_CERTID_deep_copy(sk, copyfunc, freefunc)                                                                                                       \
    ((STACK_OF(OCSP_CERTID)*)OPENSSL_sk_deep_copy(                                                                                                             \
        ossl_check_const_OCSP_CERTID_sk_type(sk), ossl_check_OCSP_CERTID_copyfunc_type(copyfunc), ossl_check_OCSP_CERTID_freefunc_type(freefunc)))
#define sk_OCSP_CERTID_set_cmp_func(sk, cmp)                                                                                                                   \
    ((sk_OCSP_CERTID_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OCSP_CERTID_sk_type(sk), ossl_check_OCSP_CERTID_compfunc_type(cmp)))
...
#define sk_OCSP_ONEREQ_deep_copy(sk, copyfunc, freefunc)                                                                                                       \
    ((STACK_OF(OCSP_ONEREQ)*)OPENSSL_sk_deep_copy(                                                                                                             \
        ossl_check_const_OCSP_ONEREQ_sk_type(sk), ossl_check_OCSP_ONEREQ_copyfunc_type(copyfunc), ossl_check_OCSP_ONEREQ_freefunc_type(freefunc)))
#define sk_OCSP_ONEREQ_set_cmp_func(sk, cmp)                                                                                                                   \
    ((sk_OCSP_ONEREQ_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OCSP_ONEREQ_sk_type(sk), ossl_check_OCSP_ONEREQ_compfunc_type(cmp)))
...
#define sk_OCSP_RESPID_deep_copy(sk, copyfunc, freefunc)                                                                                                       \
    ((STACK_OF(OCSP_RESPID)*)OPENSSL_sk_deep_copy(                                                                                                             \
        ossl_check_const_OCSP_RESPID_sk_type(sk), ossl_check_OCSP_RESPID_copyfunc_type(copyfunc), ossl_check_OCSP_RESPID_freefunc_type(freefunc)))
#define sk_OCSP_RESPID_set_cmp_func(sk, cmp)                                                                                                                   \
    ((sk_OCSP_RESPID_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OCSP_RESPID_sk_type(sk), ossl_check_OCSP_RESPID_compfunc_type(cmp)))
...
#define sk_OCSP_SINGLERESP_delete_ptr(sk, ptr)                                                                                                                 \
    ((OCSP_SINGLERESP*)OPENSSL_sk_delete_ptr(ossl_check_OCSP_SINGLERESP_sk_type(sk), ossl_check_OCSP_SINGLERESP_type(ptr)))
...
#define sk_OCSP_SINGLERESP_pop_free(sk, freefunc)                                                                                                              \
    OPENSSL_sk_pop_free(ossl_check_OCSP_SINGLERESP_sk_type(sk), ossl_check_OCSP_SINGLERESP_freefunc_type(freefunc))
...
#define sk_OCSP_SINGLERESP_set(sk, idx, ptr)                                                                                                                   \
    ((OCSP_SINGLERESP*)OPENSSL_sk_set(ossl_check_OCSP_SINGLERESP_sk_type(sk), (idx), ossl_check_OCSP_SINGLERESP_type(ptr)))
...
#define sk_OCSP_SINGLERESP_deep_copy(sk, copyfunc, freefunc)                                                                                                   \
    ((STACK_OF(OCSP_SINGLERESP)*)OPENSSL_sk_deep_copy(                                                                                                         \
        ossl_check_const_OCSP_SINGLERESP_sk_type(sk), ossl_check_OCSP_SINGLERESP_copyfunc_type(copyfunc), ossl_check_OCSP_SINGLERESP_freefunc_type(freefunc)))
#define sk_OCSP_SINGLERESP_set_cmp_func(sk, cmp)                                                                                                               \
    ((sk_OCSP_SINGLERESP_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_OCSP_SINGLERESP_sk_type(sk), ossl_check_OCSP_SINGLERESP_compfunc_type(cmp)))
...
#define OCSP_REQ_CTX_i2d(r, it, req) OSSL_HTTP_REQ_CTX_set1_req(r, "application/ocsp-request", it, req)
...
#define OCSP_parse_url(url, host, port, path, ssl) OSSL_HTTP_parse_url(url, ssl, NULL, host, port, NULL, path, NULL, NULL)
