...
#define ASN1_SEQUENCE_END_name(stname, tname)                                                                                                                  \
    ;                                                                                                                                                          \
    ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, sizeof(stname),         \
        #tname ASN1_ITEM_end(tname)

#define static_ASN1_SEQUENCE_END_name(stname, tname)                                                                                                           \
    ;                                                                                                                                                          \
    static_ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, sizeof(stname),  \
...
#define ASN1_NDEF_SEQUENCE_END(tname)                                                                                                                          \
    ;                                                                                                                                                          \
    ASN1_ITEM_start(tname) ASN1_ITYPE_NDEF_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), NULL, sizeof(tname),     \
        #tname ASN1_ITEM_end(tname)
...
#define ASN1_SEQUENCE_END_ref(stname, tname)                                                                                                                   \
    ;                                                                                                                                                          \
    ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), &tname##_aux, sizeof(stname), \
        #tname ASN1_ITEM_end(tname)
#define static_ASN1_SEQUENCE_END_ref(stname, tname)                                                                                                            \
    ;                                                                                                                                                          \
    static_ASN1_ITEM_start(tname) ASN1_ITYPE_SEQUENCE, V_ASN1_SEQUENCE, tname##_seq_tt, sizeof(tname##_seq_tt) / sizeof(ASN1_TEMPLATE), &tname##_aux,          \
...
#define ASN1_CHOICE_END_selector(stname, tname, selname)                                                                                                       \
    ;                                                                                                                                                          \
    ASN1_ITEM_start(tname) ASN1_ITYPE_CHOICE, offsetof(stname, selname), tname##_ch_tt, sizeof(tname##_ch_tt) / sizeof(ASN1_TEMPLATE), NULL, sizeof(stname),   \
        #stname ASN1_ITEM_end(tname)
...
typedef int ASN1_ex_d2i_ex(ASN1_VALUE** pval, const unsigned char** in, long len, const ASN1_ITEM* it, int tag, int aclass, char opt, ASN1_TLC* ctx,
...
#define sk_ASN1_VALUE_deep_copy(sk, copyfunc, freefunc)                                                                                                        \
    ((STACK_OF(ASN1_VALUE)*)OPENSSL_sk_deep_copy(                                                                                                              \
        ossl_check_const_ASN1_VALUE_sk_type(sk), ossl_check_ASN1_VALUE_copyfunc_type(copyfunc), ossl_check_ASN1_VALUE_freefunc_type(freefunc)))
#define sk_ASN1_VALUE_set_cmp_func(sk, cmp)                                                                                                                    \
    ((sk_ASN1_VALUE_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASN1_VALUE_sk_type(sk), ossl_check_ASN1_VALUE_compfunc_type(cmp)))
...
#define IMPLEMENT_ASN1_ENCODE_FUNCTIONS_const_fname(stname, itname, fname) IMPLEMENT_ASN1_ENCODE_FUNCTIONS_fname(stname, itname, fname)
