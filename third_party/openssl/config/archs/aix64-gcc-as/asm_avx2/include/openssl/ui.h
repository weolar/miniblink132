...
#define sk_UI_STRING_deep_copy(sk, copyfunc, freefunc)                                                                                                         \
    ((STACK_OF(UI_STRING)*)OPENSSL_sk_deep_copy(                                                                                                               \
        ossl_check_const_UI_STRING_sk_type(sk), ossl_check_UI_STRING_copyfunc_type(copyfunc), ossl_check_UI_STRING_freefunc_type(freefunc)))
#define sk_UI_STRING_set_cmp_func(sk, cmp)                                                                                                                     \
    ((sk_UI_STRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_UI_STRING_sk_type(sk), ossl_check_UI_STRING_compfunc_type(cmp)))
