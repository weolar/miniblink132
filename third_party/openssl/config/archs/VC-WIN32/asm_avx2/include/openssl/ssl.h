...
#define sk_SRTP_PROTECTION_PROFILE_new_reserve(cmp, n)                                                                                                         \
    ((STACK_OF(SRTP_PROTECTION_PROFILE)*)OPENSSL_sk_new_reserve(ossl_check_SRTP_PROTECTION_PROFILE_compfunc_type(cmp), (n)))
...
#define sk_SRTP_PROTECTION_PROFILE_delete_ptr(sk, ptr)                                                                                                         \
    ((SRTP_PROTECTION_PROFILE*)OPENSSL_sk_delete_ptr(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_type(ptr)))
...
#define sk_SRTP_PROTECTION_PROFILE_unshift(sk, ptr)                                                                                                            \
    OPENSSL_sk_unshift(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_type(ptr))
...
#define sk_SRTP_PROTECTION_PROFILE_pop_free(sk, freefunc)                                                                                                      \
    OPENSSL_sk_pop_free(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_freefunc_type(freefunc))
#define sk_SRTP_PROTECTION_PROFILE_insert(sk, ptr, idx)                                                                                                        \
    OPENSSL_sk_insert(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_type(ptr), (idx))
#define sk_SRTP_PROTECTION_PROFILE_set(sk, idx, ptr)                                                                                                           \
    ((SRTP_PROTECTION_PROFILE*)OPENSSL_sk_set(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), (idx), ossl_check_SRTP_PROTECTION_PROFILE_type(ptr)))
...
#define sk_SRTP_PROTECTION_PROFILE_find_ex(sk, ptr)                                                                                                            \
    OPENSSL_sk_find_ex(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_type(ptr))
#define sk_SRTP_PROTECTION_PROFILE_find_all(sk, ptr, pnum)                                                                                                     \
    OPENSSL_sk_find_all(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_type(ptr), pnum)
...
#define sk_SRTP_PROTECTION_PROFILE_deep_copy(sk, copyfunc, freefunc)                                                                                           \
    ((STACK_OF(SRTP_PROTECTION_PROFILE)*)OPENSSL_sk_deep_copy(ossl_check_const_SRTP_PROTECTION_PROFILE_sk_type(sk),                                            \
        ossl_check_SRTP_PROTECTION_PROFILE_copyfunc_type(copyfunc), ossl_check_SRTP_PROTECTION_PROFILE_freefunc_type(freefunc)))
...
__owur int SSL_select_next_proto(
    unsigned char** out, unsigned char* outlen, const unsigned char* in, unsigned int inlen, const unsigned char* client, unsigned int client_len);
...
__owur int SSL_CTX_add_client_custom_ext(
...
__owur int SSL_CTX_add_server_custom_ext(
    SSL_CTX* ctx, unsigned int ext_type, custom_ext_add_cb add_cb, custom_ext_free_cb free_cb, void* add_arg, custom_ext_parse_cb parse_cb, void* parse_arg);

__owur int SSL_CTX_add_custom_ext(SSL_CTX* ctx, unsigned int ext_type, unsigned int context, SSL_custom_ext_add_cb_ex add_cb, SSL_custom_ext_free_cb_ex free_cb,
...
#define sk_SSL_CIPHER_deep_copy(sk, copyfunc, freefunc)                                                                                                        \
    ((STACK_OF(SSL_CIPHER)*)OPENSSL_sk_deep_copy(                                                                                                              \
        ossl_check_const_SSL_CIPHER_sk_type(sk), ossl_check_SSL_CIPHER_copyfunc_type(copyfunc), ossl_check_SSL_CIPHER_freefunc_type(freefunc)))
#define sk_SSL_CIPHER_set_cmp_func(sk, cmp)                                                                                                                    \
    ((sk_SSL_CIPHER_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_SSL_CIPHER_sk_type(sk), ossl_check_SSL_CIPHER_compfunc_type(cmp)))
...
#define sk_SSL_COMP_deep_copy(sk, copyfunc, freefunc)                                                                                                          \
    ((STACK_OF(SSL_COMP)*)OPENSSL_sk_deep_copy(                                                                                                                \
        ossl_check_const_SSL_COMP_sk_type(sk), ossl_check_SSL_COMP_copyfunc_type(copyfunc), ossl_check_SSL_COMP_freefunc_type(freefunc)))
#define sk_SSL_COMP_set_cmp_func(sk, cmp)                                                                                                                      \
    ((sk_SSL_COMP_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_SSL_COMP_sk_type(sk), ossl_check_SSL_COMP_compfunc_type(cmp)))
...
typedef SSL_TICKET_RETURN (*SSL_CTX_decrypt_session_ticket_fn)(
    SSL* s, SSL_SESSION* ss, const unsigned char* keyname, size_t keyname_length, SSL_TICKET_STATUS status, void* arg);
...
struct ssl_quic_method_st {
    int (*set_encryption_secrets)(SSL* ssl, OSSL_ENCRYPTION_LEVEL level, const uint8_t* read_secret, const uint8_t* write_secret, size_t secret_len);
    int (*add_handshake_data)(SSL* ssl, OSSL_ENCRYPTION_LEVEL level, const uint8_t* data, size_t len);
...
__owur int SSL_set_quic_transport_params(SSL* ssl, const uint8_t* params, size_t params_len);
...
__owur int SSL_provide_quic_data(SSL* ssl, OSSL_ENCRYPTION_LEVEL level, const uint8_t* data, size_t len);
