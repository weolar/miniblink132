...
#define sk_X509V3_EXT_METHOD_delete_ptr(sk, ptr)                                                                                                               \
    ((X509V3_EXT_METHOD*)OPENSSL_sk_delete_ptr(ossl_check_X509V3_EXT_METHOD_sk_type(sk), ossl_check_X509V3_EXT_METHOD_type(ptr)))
...
#define sk_X509V3_EXT_METHOD_pop_free(sk, freefunc)                                                                                                            \
    OPENSSL_sk_pop_free(ossl_check_X509V3_EXT_METHOD_sk_type(sk), ossl_check_X509V3_EXT_METHOD_freefunc_type(freefunc))
...
#define sk_X509V3_EXT_METHOD_set(sk, idx, ptr)                                                                                                                 \
    ((X509V3_EXT_METHOD*)OPENSSL_sk_set(ossl_check_X509V3_EXT_METHOD_sk_type(sk), (idx), ossl_check_X509V3_EXT_METHOD_type(ptr)))
...
#define sk_X509V3_EXT_METHOD_deep_copy(sk, copyfunc, freefunc)                                                                                                 \
    ((STACK_OF(X509V3_EXT_METHOD)*)OPENSSL_sk_deep_copy(ossl_check_const_X509V3_EXT_METHOD_sk_type(sk), ossl_check_X509V3_EXT_METHOD_copyfunc_type(copyfunc),  \
        ossl_check_X509V3_EXT_METHOD_freefunc_type(freefunc)))
#define sk_X509V3_EXT_METHOD_set_cmp_func(sk, cmp)                                                                                                             \
    ((sk_X509V3_EXT_METHOD_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509V3_EXT_METHOD_sk_type(sk), ossl_check_X509V3_EXT_METHOD_compfunc_type(cmp)))
...
#define sk_ACCESS_DESCRIPTION_delete_ptr(sk, ptr)                                                                                                              \
    ((ACCESS_DESCRIPTION*)OPENSSL_sk_delete_ptr(ossl_check_ACCESS_DESCRIPTION_sk_type(sk), ossl_check_ACCESS_DESCRIPTION_type(ptr)))
...
#define sk_ACCESS_DESCRIPTION_pop_free(sk, freefunc)                                                                                                           \
    OPENSSL_sk_pop_free(ossl_check_ACCESS_DESCRIPTION_sk_type(sk), ossl_check_ACCESS_DESCRIPTION_freefunc_type(freefunc))
...
#define sk_ACCESS_DESCRIPTION_set(sk, idx, ptr)                                                                                                                \
    ((ACCESS_DESCRIPTION*)OPENSSL_sk_set(ossl_check_ACCESS_DESCRIPTION_sk_type(sk), (idx), ossl_check_ACCESS_DESCRIPTION_type(ptr)))
...
#define sk_ACCESS_DESCRIPTION_find_all(sk, ptr, pnum)                                                                                                          \
    OPENSSL_sk_find_all(ossl_check_ACCESS_DESCRIPTION_sk_type(sk), ossl_check_ACCESS_DESCRIPTION_type(ptr), pnum)
...
#define sk_ACCESS_DESCRIPTION_deep_copy(sk, copyfunc, freefunc)                                                                                                \
    ((STACK_OF(ACCESS_DESCRIPTION)*)OPENSSL_sk_deep_copy(ossl_check_const_ACCESS_DESCRIPTION_sk_type(sk),                                                      \
...
#define sk_ACCESS_DESCRIPTION_set_cmp_func(sk, cmp)                                                                                                            \
    ((sk_ACCESS_DESCRIPTION_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ACCESS_DESCRIPTION_sk_type(sk), ossl_check_ACCESS_DESCRIPTION_compfunc_type(cmp)))
...
#define sk_GENERAL_NAME_deep_copy(sk, copyfunc, freefunc)                                                                                                      \
    ((STACK_OF(GENERAL_NAME)*)OPENSSL_sk_deep_copy(                                                                                                            \
        ossl_check_const_GENERAL_NAME_sk_type(sk), ossl_check_GENERAL_NAME_copyfunc_type(copyfunc), ossl_check_GENERAL_NAME_freefunc_type(freefunc)))
#define sk_GENERAL_NAME_set_cmp_func(sk, cmp)                                                                                                                  \
    ((sk_GENERAL_NAME_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_GENERAL_NAME_sk_type(sk), ossl_check_GENERAL_NAME_compfunc_type(cmp)))
...
#define sk_GENERAL_NAMES_deep_copy(sk, copyfunc, freefunc)                                                                                                     \
    ((STACK_OF(GENERAL_NAMES)*)OPENSSL_sk_deep_copy(                                                                                                           \
        ossl_check_const_GENERAL_NAMES_sk_type(sk), ossl_check_GENERAL_NAMES_copyfunc_type(copyfunc), ossl_check_GENERAL_NAMES_freefunc_type(freefunc)))
#define sk_GENERAL_NAMES_set_cmp_func(sk, cmp)                                                                                                                 \
    ((sk_GENERAL_NAMES_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_GENERAL_NAMES_sk_type(sk), ossl_check_GENERAL_NAMES_compfunc_type(cmp)))
...
#define sk_DIST_POINT_deep_copy(sk, copyfunc, freefunc)                                                                                                        \
    ((STACK_OF(DIST_POINT)*)OPENSSL_sk_deep_copy(                                                                                                              \
        ossl_check_const_DIST_POINT_sk_type(sk), ossl_check_DIST_POINT_copyfunc_type(copyfunc), ossl_check_DIST_POINT_freefunc_type(freefunc)))
#define sk_DIST_POINT_set_cmp_func(sk, cmp)                                                                                                                    \
    ((sk_DIST_POINT_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_DIST_POINT_sk_type(sk), ossl_check_DIST_POINT_compfunc_type(cmp)))
...
#define sk_SXNETID_deep_copy(sk, copyfunc, freefunc)                                                                                                           \
    ((STACK_OF(SXNETID)*)OPENSSL_sk_deep_copy(                                                                                                                 \
        ossl_check_const_SXNETID_sk_type(sk), ossl_check_SXNETID_copyfunc_type(copyfunc), ossl_check_SXNETID_freefunc_type(freefunc)))
...
#define sk_POLICYQUALINFO_delete_ptr(sk, ptr)                                                                                                                  \
    ((POLICYQUALINFO*)OPENSSL_sk_delete_ptr(ossl_check_POLICYQUALINFO_sk_type(sk), ossl_check_POLICYQUALINFO_type(ptr)))
...
#define sk_POLICYQUALINFO_deep_copy(sk, copyfunc, freefunc)                                                                                                    \
    ((STACK_OF(POLICYQUALINFO)*)OPENSSL_sk_deep_copy(                                                                                                          \
        ossl_check_const_POLICYQUALINFO_sk_type(sk), ossl_check_POLICYQUALINFO_copyfunc_type(copyfunc), ossl_check_POLICYQUALINFO_freefunc_type(freefunc)))
#define sk_POLICYQUALINFO_set_cmp_func(sk, cmp)                                                                                                                \
    ((sk_POLICYQUALINFO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_POLICYQUALINFO_sk_type(sk), ossl_check_POLICYQUALINFO_compfunc_type(cmp)))
...
#define sk_POLICYINFO_deep_copy(sk, copyfunc, freefunc)                                                                                                        \
    ((STACK_OF(POLICYINFO)*)OPENSSL_sk_deep_copy(                                                                                                              \
        ossl_check_const_POLICYINFO_sk_type(sk), ossl_check_POLICYINFO_copyfunc_type(copyfunc), ossl_check_POLICYINFO_freefunc_type(freefunc)))
#define sk_POLICYINFO_set_cmp_func(sk, cmp)                                                                                                                    \
    ((sk_POLICYINFO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_POLICYINFO_sk_type(sk), ossl_check_POLICYINFO_compfunc_type(cmp)))
...
#define sk_POLICY_MAPPING_delete_ptr(sk, ptr)                                                                                                                  \
    ((POLICY_MAPPING*)OPENSSL_sk_delete_ptr(ossl_check_POLICY_MAPPING_sk_type(sk), ossl_check_POLICY_MAPPING_type(ptr)))
...
#define sk_POLICY_MAPPING_deep_copy(sk, copyfunc, freefunc)                                                                                                    \
    ((STACK_OF(POLICY_MAPPING)*)OPENSSL_sk_deep_copy(                                                                                                          \
        ossl_check_const_POLICY_MAPPING_sk_type(sk), ossl_check_POLICY_MAPPING_copyfunc_type(copyfunc), ossl_check_POLICY_MAPPING_freefunc_type(freefunc)))
#define sk_POLICY_MAPPING_set_cmp_func(sk, cmp)                                                                                                                \
    ((sk_POLICY_MAPPING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_POLICY_MAPPING_sk_type(sk), ossl_check_POLICY_MAPPING_compfunc_type(cmp)))
...
#define sk_GENERAL_SUBTREE_delete_ptr(sk, ptr)                                                                                                                 \
    ((GENERAL_SUBTREE*)OPENSSL_sk_delete_ptr(ossl_check_GENERAL_SUBTREE_sk_type(sk), ossl_check_GENERAL_SUBTREE_type(ptr)))
...
#define sk_GENERAL_SUBTREE_pop_free(sk, freefunc)                                                                                                              \
    OPENSSL_sk_pop_free(ossl_check_GENERAL_SUBTREE_sk_type(sk), ossl_check_GENERAL_SUBTREE_freefunc_type(freefunc))
...
#define sk_GENERAL_SUBTREE_set(sk, idx, ptr)                                                                                                                   \
    ((GENERAL_SUBTREE*)OPENSSL_sk_set(ossl_check_GENERAL_SUBTREE_sk_type(sk), (idx), ossl_check_GENERAL_SUBTREE_type(ptr)))
...
#define sk_GENERAL_SUBTREE_deep_copy(sk, copyfunc, freefunc)                                                                                                   \
    ((STACK_OF(GENERAL_SUBTREE)*)OPENSSL_sk_deep_copy(                                                                                                         \
        ossl_check_const_GENERAL_SUBTREE_sk_type(sk), ossl_check_GENERAL_SUBTREE_copyfunc_type(copyfunc), ossl_check_GENERAL_SUBTREE_freefunc_type(freefunc)))
#define sk_GENERAL_SUBTREE_set_cmp_func(sk, cmp)                                                                                                               \
    ((sk_GENERAL_SUBTREE_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_GENERAL_SUBTREE_sk_type(sk), ossl_check_GENERAL_SUBTREE_compfunc_type(cmp)))
...
#define EXT_UTF8STRING(nid)                                                                                                                                    \
    {                                                                                                                                                          \
        nid, 0, ASN1_ITEM_ref(ASN1_UTF8STRING), 0, 0, 0, 0, (X509V3_EXT_I2S)i2s_ASN1_UTF8STRING, (X509V3_EXT_S2I)s2i_ASN1_UTF8STRING, 0, 0, 0, 0, NULL         \
    }
...
#define sk_X509_PURPOSE_deep_copy(sk, copyfunc, freefunc)                                                                                                      \
    ((STACK_OF(X509_PURPOSE)*)OPENSSL_sk_deep_copy(                                                                                                            \
        ossl_check_const_X509_PURPOSE_sk_type(sk), ossl_check_X509_PURPOSE_copyfunc_type(copyfunc), ossl_check_X509_PURPOSE_freefunc_type(freefunc)))
#define sk_X509_PURPOSE_set_cmp_func(sk, cmp)                                                                                                                  \
    ((sk_X509_PURPOSE_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_PURPOSE_sk_type(sk), ossl_check_X509_PURPOSE_compfunc_type(cmp)))
...
#define sk_X509_POLICY_NODE_delete_ptr(sk, ptr)                                                                                                                \
    ((X509_POLICY_NODE*)OPENSSL_sk_delete_ptr(ossl_check_X509_POLICY_NODE_sk_type(sk), ossl_check_X509_POLICY_NODE_type(ptr)))
...
#define sk_X509_POLICY_NODE_pop_free(sk, freefunc)                                                                                                             \
    OPENSSL_sk_pop_free(ossl_check_X509_POLICY_NODE_sk_type(sk), ossl_check_X509_POLICY_NODE_freefunc_type(freefunc))
...
#define sk_X509_POLICY_NODE_set(sk, idx, ptr)                                                                                                                  \
    ((X509_POLICY_NODE*)OPENSSL_sk_set(ossl_check_X509_POLICY_NODE_sk_type(sk), (idx), ossl_check_X509_POLICY_NODE_type(ptr)))
...
#define sk_X509_POLICY_NODE_deep_copy(sk, copyfunc, freefunc)                                                                                                  \
    ((STACK_OF(X509_POLICY_NODE)*)OPENSSL_sk_deep_copy(ossl_check_const_X509_POLICY_NODE_sk_type(sk), ossl_check_X509_POLICY_NODE_copyfunc_type(copyfunc),     \
        ossl_check_X509_POLICY_NODE_freefunc_type(freefunc)))
#define sk_X509_POLICY_NODE_set_cmp_func(sk, cmp)                                                                                                              \
    ((sk_X509_POLICY_NODE_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_X509_POLICY_NODE_sk_type(sk), ossl_check_X509_POLICY_NODE_compfunc_type(cmp)))
...
#define sk_ASIdOrRange_deep_copy(sk, copyfunc, freefunc)                                                                                                       \
    ((STACK_OF(ASIdOrRange)*)OPENSSL_sk_deep_copy(                                                                                                             \
        ossl_check_const_ASIdOrRange_sk_type(sk), ossl_check_ASIdOrRange_copyfunc_type(copyfunc), ossl_check_ASIdOrRange_freefunc_type(freefunc)))
#define sk_ASIdOrRange_set_cmp_func(sk, cmp)                                                                                                                   \
    ((sk_ASIdOrRange_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASIdOrRange_sk_type(sk), ossl_check_ASIdOrRange_compfunc_type(cmp)))
...
#define sk_IPAddressOrRange_delete_ptr(sk, ptr)                                                                                                                \
    ((IPAddressOrRange*)OPENSSL_sk_delete_ptr(ossl_check_IPAddressOrRange_sk_type(sk), ossl_check_IPAddressOrRange_type(ptr)))
...
#define sk_IPAddressOrRange_pop_free(sk, freefunc)                                                                                                             \
    OPENSSL_sk_pop_free(ossl_check_IPAddressOrRange_sk_type(sk), ossl_check_IPAddressOrRange_freefunc_type(freefunc))
...
#define sk_IPAddressOrRange_set(sk, idx, ptr)                                                                                                                  \
    ((IPAddressOrRange*)OPENSSL_sk_set(ossl_check_IPAddressOrRange_sk_type(sk), (idx), ossl_check_IPAddressOrRange_type(ptr)))
...
#define sk_IPAddressOrRange_deep_copy(sk, copyfunc, freefunc)                                                                                                  \
    ((STACK_OF(IPAddressOrRange)*)OPENSSL_sk_deep_copy(ossl_check_const_IPAddressOrRange_sk_type(sk), ossl_check_IPAddressOrRange_copyfunc_type(copyfunc),     \
        ossl_check_IPAddressOrRange_freefunc_type(freefunc)))
#define sk_IPAddressOrRange_set_cmp_func(sk, cmp)                                                                                                              \
    ((sk_IPAddressOrRange_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_IPAddressOrRange_sk_type(sk), ossl_check_IPAddressOrRange_compfunc_type(cmp)))
...
#define sk_IPAddressFamily_delete_ptr(sk, ptr)                                                                                                                 \
    ((IPAddressFamily*)OPENSSL_sk_delete_ptr(ossl_check_IPAddressFamily_sk_type(sk), ossl_check_IPAddressFamily_type(ptr)))
...
#define sk_IPAddressFamily_pop_free(sk, freefunc)                                                                                                              \
    OPENSSL_sk_pop_free(ossl_check_IPAddressFamily_sk_type(sk), ossl_check_IPAddressFamily_freefunc_type(freefunc))
...
#define sk_IPAddressFamily_set(sk, idx, ptr)                                                                                                                   \
    ((IPAddressFamily*)OPENSSL_sk_set(ossl_check_IPAddressFamily_sk_type(sk), (idx), ossl_check_IPAddressFamily_type(ptr)))
...
#define sk_IPAddressFamily_deep_copy(sk, copyfunc, freefunc)                                                                                                   \
    ((STACK_OF(IPAddressFamily)*)OPENSSL_sk_deep_copy(                                                                                                         \
        ossl_check_const_IPAddressFamily_sk_type(sk), ossl_check_IPAddressFamily_copyfunc_type(copyfunc), ossl_check_IPAddressFamily_freefunc_type(freefunc)))
#define sk_IPAddressFamily_set_cmp_func(sk, cmp)                                                                                                               \
    ((sk_IPAddressFamily_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_IPAddressFamily_sk_type(sk), ossl_check_IPAddressFamily_compfunc_type(cmp)))
...
#define sk_ASN1_STRING_deep_copy(sk, copyfunc, freefunc)                                                                                                       \
    ((STACK_OF(ASN1_STRING)*)OPENSSL_sk_deep_copy(                                                                                                             \
        ossl_check_const_ASN1_STRING_sk_type(sk), ossl_check_ASN1_STRING_copyfunc_type(copyfunc), ossl_check_ASN1_STRING_freefunc_type(freefunc)))
#define sk_ASN1_STRING_set_cmp_func(sk, cmp)                                                                                                                   \
    ((sk_ASN1_STRING_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ASN1_STRING_sk_type(sk), ossl_check_ASN1_STRING_compfunc_type(cmp)))
...
#define sk_PROFESSION_INFO_delete_ptr(sk, ptr)                                                                                                                 \
    ((PROFESSION_INFO*)OPENSSL_sk_delete_ptr(ossl_check_PROFESSION_INFO_sk_type(sk), ossl_check_PROFESSION_INFO_type(ptr)))
...
#define sk_PROFESSION_INFO_pop_free(sk, freefunc)                                                                                                              \
    OPENSSL_sk_pop_free(ossl_check_PROFESSION_INFO_sk_type(sk), ossl_check_PROFESSION_INFO_freefunc_type(freefunc))
...
#define sk_PROFESSION_INFO_set(sk, idx, ptr)                                                                                                                   \
    ((PROFESSION_INFO*)OPENSSL_sk_set(ossl_check_PROFESSION_INFO_sk_type(sk), (idx), ossl_check_PROFESSION_INFO_type(ptr)))
...
#define sk_PROFESSION_INFO_deep_copy(sk, copyfunc, freefunc)                                                                                                   \
    ((STACK_OF(PROFESSION_INFO)*)OPENSSL_sk_deep_copy(                                                                                                         \
        ossl_check_const_PROFESSION_INFO_sk_type(sk), ossl_check_PROFESSION_INFO_copyfunc_type(copyfunc), ossl_check_PROFESSION_INFO_freefunc_type(freefunc)))
#define sk_PROFESSION_INFO_set_cmp_func(sk, cmp)                                                                                                               \
    ((sk_PROFESSION_INFO_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_PROFESSION_INFO_sk_type(sk), ossl_check_PROFESSION_INFO_compfunc_type(cmp)))
...
#define sk_ADMISSIONS_deep_copy(sk, copyfunc, freefunc)                                                                                                        \
    ((STACK_OF(ADMISSIONS)*)OPENSSL_sk_deep_copy(                                                                                                              \
        ossl_check_const_ADMISSIONS_sk_type(sk), ossl_check_ADMISSIONS_copyfunc_type(copyfunc), ossl_check_ADMISSIONS_freefunc_type(freefunc)))
#define sk_ADMISSIONS_set_cmp_func(sk, cmp)                                                                                                                    \
    ((sk_ADMISSIONS_compfunc)OPENSSL_sk_set_cmp_func(ossl_check_ADMISSIONS_sk_type(sk), ossl_check_ADMISSIONS_compfunc_type(cmp)))
