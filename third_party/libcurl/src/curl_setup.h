...
#if TARGET_OS_MAC && !(defined(TARGET_OS_IPHONE) && TARGET_OS_IPHONE) && defined(ENABLE_IPV6)
...
#include <proto/dos.h>
#include <unistd.h>
#if defined(HAVE_PROTO_BSDSOCKET_H) && (!defined(__amigaos4__) || defined(USE_AMISSL))
...
#ifdef __amigaos4__
int Curl_amiga_select(int nfds, fd_set* readfds, fd_set* writefds, fd_set* errorfds, struct timeval* timeout);
...
#if defined(USE_GNUTLS) || defined(USE_OPENSSL) || defined(USE_MBEDTLS) || defined(USE_WOLFSSL) || defined(USE_SCHANNEL) || defined(USE_SECTRANSP)             \
...
#if defined(USE_OPENSSL) || defined(USE_MBEDTLS) || defined(USE_GNUTLS) || defined(USE_SECTRANSP) || defined(USE_OS400CRYPTO) || defined(USE_WIN32_CRYPTO)     \
