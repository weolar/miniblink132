...
CURLcode Curl_buffer_send(
    struct dynbuf* in, struct Curl_easy* data, struct HTTP* http, curl_off_t* bytes_written, curl_off_t included_body_bytes, int socketindex);
...
void Curl_http_method(struct Curl_easy* data, struct connectdata* conn, const char** method, Curl_HttpReq*);
CURLcode Curl_http_useragent(struct Curl_easy* data);
CURLcode Curl_http_host(struct Curl_easy* data, struct connectdata* conn);
CURLcode Curl_http_target(struct Curl_easy* data, struct connectdata* conn, struct dynbuf* req);
...
CURLcode Curl_http_body(struct Curl_easy* data, struct connectdata* conn, Curl_HttpReq httpreq, const char** teep);
