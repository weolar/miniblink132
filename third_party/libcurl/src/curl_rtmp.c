...
static CURLcode rtmp_setup_connection(struct Curl_easy* data, struct connectdata* conn);
...
static CURLcode rtmp_disconnect(struct Curl_easy* data, struct connectdata* conn, bool dead);
...
static CURLcode rtmp_done(struct Curl_easy* data, CURLcode status, bool premature)
{
    (void)data; /* unused */
    (void)status; /* unused */
...
static CURLcode rtmp_disconnect(struct Curl_easy* data, struct connectdata* conn, bool dead_connection)
{
    RTMP* r = conn->proto.rtmp;
    (void)data;
...
static ssize_t rtmp_recv(struct Curl_easy* data, int sockindex, char* buf, size_t len, CURLcode* err)
{
    struct connectdata* conn = data->conn;
    RTMP* r = conn->proto.rtmp;
    ssize_t nread;
...
static ssize_t rtmp_send(struct Curl_easy* data, int sockindex, const void* buf, size_t len, CURLcode* err)
{
    struct connectdata* conn = data->conn;
    RTMP* r = conn->proto.rtmp;
    ssize_t num;
