 ...
 */
CURLcode Curl_resolver_is_resolved(struct Curl_easy* data, struct Curl_dns_entry** dns);
 ...
 */
CURLcode Curl_resolver_wait_resolv(struct Curl_easy* data, struct Curl_dns_entry** dnsentry);
