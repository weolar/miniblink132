...
#if (defined(__BORLANDC__) && (__BORLANDC__ >= 0x520)) || (defined(__POCC__) && defined(_MSC_VER)) || (defined(_WIN32_WCE)) || (defined(__MINGW32__))          \
...
static int dprintf_formatf(void* data, /* untouched by format(), just sent to the stream() function in
    ...
    int (*stream)(int, FILE*), const char* format, /* %-formatted string */
