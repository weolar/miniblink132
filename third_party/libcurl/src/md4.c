...
#if defined(OPENSSL_VERSION_MAJOR) && (OPENSSL_VERSION_MAJOR >= 3) && !defined(USE_AMISSL)
...
#else
#define SET(n)                                                                                                                                                 \
    (ctx->block[(n)] = (MD4_u32plus)ptr[(n)*4] | ((MD4_u32plus)ptr[(n)*4 + 1] << 8) | ((MD4_u32plus)ptr[(n)*4 + 2] << 16) | ((MD4_u32plus)ptr[(n)*4 + 3] << 24))
