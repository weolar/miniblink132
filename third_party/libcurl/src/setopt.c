...
static CURLcode setstropt_userpwd(char* option, char** userp, char** passwdp)
{
    ...
    if (option) {
        ...
        result = Curl_parse_login_details(option, len, (userp ? &user : NULL), (passwdp ? &passwd : NULL), NULL);
    }
...
CURLcode Curl_vsetopt(struct Curl_easy* data, CURLoption option, va_list param)
{
    ...
    case CURLOPT_SSL_CIPHER_LIST:
        ...
        result = Curl_setstropt(&data->set.str[STRING_SSL_CIPHER_LIST], va_arg(param, char*));
        break;
#ifndef CURL_DISABLE_PROXY
    case CURLOPT_PROXY_SSL_CIPHER_LIST:
        /* set a list of cipher we want to use in the SSL connection for proxy */
        result = Curl_setstropt(&data->set.str[STRING_SSL_CIPHER_LIST_PROXY], va_arg(param, char*));
        break;
#endif
    case CURLOPT_TLS13_CIPHERS:
        if (Curl_ssl_supports(data, SSLSUPP_TLS13_CIPHERSUITES)) {
            /* set preferred list of TLS 1.3 cipher suites */
            result = Curl_setstropt(&data->set.str[STRING_SSL_CIPHER13_LIST], va_arg(param, char*));
        } else
    ...
    case CURLOPT_PROXY_TLS13_CIPHERS:
        if (Curl_ssl_supports(data, SSLSUPP_TLS13_CIPHERSUITES)) {
            ...
            result = Curl_setstropt(&data->set.str[STRING_SSL_CIPHER13_LIST_PROXY], va_arg(param, char*));
        } else
            return CURLE_NOT_BUILT_IN;
        break;
#endif
...
#ifdef USE_SSL
    {
        ...
        if (version < CURL_SSLVERSION_DEFAULT || version == CURL_SSLVERSION_SSLv2 || version == CURL_SSLVERSION_SSLv3 || version >= CURL_SSLVERSION_LAST
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_AWS_SIGV4], va_arg(param, char*));
        /*
        ...
        if (strcasecompare(argptr, "ALL")) {
            ...
            if (!argptr || !data->cookies) {
                ...
                if (checkprefix("Set-Cookie:", argptr))
                    ...
                    Curl_cookie_add(data, data->cookies, TRUE, FALSE, argptr + 11, NULL, NULL, TRUE);

                else
                    /* Netscape format line */
                    Curl_cookie_add(data, data->cookies, FALSE, FALSE, argptr, NULL, NULL, TRUE);
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_PROXY_SERVICE_NAME], va_arg(param, char*));
        break;
#endif
    ...
    case CURLOPT_FTP_ALTERNATIVE_TO_USER:
        result = Curl_setstropt(&data->set.str[STRING_FTP_ALTERNATIVE_TO_USER], va_arg(param, char*));
        break;
     ...
     */
        result = Curl_setblobopt(&data->set.blobs[BLOB_CERT], va_arg(param, struct curl_blob*));
        break;
#ifndef CURL_DISABLE_PROXY
     ...
     */
        result = Curl_setblobopt(&data->set.blobs[BLOB_CERT_PROXY], va_arg(param, struct curl_blob*));
        break;
#endif
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_CERT_TYPE], va_arg(param, char*));
        break;
#ifndef CURL_DISABLE_PROXY
     ...
     */
        result = Curl_setblobopt(&data->set.blobs[BLOB_KEY], va_arg(param, struct curl_blob*));
        break;
#ifndef CURL_DISABLE_PROXY
     ...
     */
        result = Curl_setblobopt(&data->set.blobs[BLOB_KEY_PROXY], va_arg(param, struct curl_blob*));
        break;
#endif
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_KEY_TYPE], va_arg(param, char*));
        break;
#ifndef CURL_DISABLE_PROXY
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_KEY_PASSWD], va_arg(param, char*));
        break;
#ifndef CURL_DISABLE_PROXY
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_HAPROXY_CLIENT_IP], va_arg(param, char*));
     ...
     */
        uarg = va_arg(param, unsigned long);
        data->set.gssapi_delegation = (unsigned char)uarg & (CURLGSSAPI_DELEGATION_POLICY_FLAG | CURLGSSAPI_DELEGATION_FLAG);
        break;
     ...
     */
        ...
        if (Curl_ssl_supports(data, SSLSUPP_PINNEDPUBKEY))
            result = Curl_setstropt(&data->set.str[STRING_SSL_PINNEDPUBLICKEY], va_arg(param, char*));
        else
#endif
            result = CURLE_NOT_BUILT_IN;
        break;
...
#ifdef USE_SSL
        if (Curl_ssl_supports(data, SSLSUPP_PINNEDPUBKEY))
            result = Curl_setstropt(&data->set.str[STRING_SSL_PINNEDPUBLICKEY_PROXY], va_arg(param, char*));
        else
#endif
            result = CURLE_NOT_BUILT_IN;
        break;
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_SSL_CAFILE], va_arg(param, char*));
        break;
     ...
     */
        ...
        if (Curl_ssl_supports(data, SSLSUPP_CAINFO_BLOB))
            result = Curl_setblobopt(&data->set.blobs[BLOB_CAINFO], va_arg(param, struct curl_blob*));
        else
#endif
            return CURLE_NOT_BUILT_IN;
...
#ifdef USE_SSL
        if (Curl_ssl_supports(data, SSLSUPP_CAINFO_BLOB))
            result = Curl_setblobopt(&data->set.blobs[BLOB_CAINFO_PROXY], va_arg(param, struct curl_blob*));
        else
#endif
            return CURLE_NOT_BUILT_IN;
        break;
     ...
     */
        ...
        if (Curl_ssl_supports(data, SSLSUPP_CA_PATH))
            ...
            result = Curl_setstropt(&data->set.str[STRING_SSL_CAPATH], va_arg(param, char*));
        else
#endif
            result = CURLE_NOT_BUILT_IN;
        break;
     ...
     */
        ...
        if (Curl_ssl_supports(data, SSLSUPP_CA_PATH))
            /* This does not work on windows. */
            result = Curl_setstropt(&data->set.str[STRING_SSL_CAPATH_PROXY], va_arg(param, char*));
        else
#endif
            result = CURLE_NOT_BUILT_IN;
        break;
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_SSL_CRLFILE], va_arg(param, char*));
        break;
#ifndef CURL_DISABLE_PROXY
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_SSL_ISSUERCERT], va_arg(param, char*));
        break;
    case CURLOPT_ISSUERCERT_BLOB:
        /*
     * Blob that holds Issuer certificate to check certificates issuer
     */
        result = Curl_setblobopt(&data->set.blobs[BLOB_SSL_ISSUERCERT], va_arg(param, struct curl_blob*));
        break;
#ifndef CURL_DISABLE_PROXY
     ...
     * to check certificates issuer
     */
        result = Curl_setstropt(&data->set.str[STRING_SSL_ISSUERCERT_PROXY], va_arg(param, char*));
        break;
    case CURLOPT_PROXY_ISSUERCERT_BLOB:
        /*
     * Blob that holds Issuer certificate to check certificates issuer
     */
        result = Curl_setblobopt(&data->set.blobs[BLOB_SSL_ISSUERCERT_PROXY], va_arg(param, struct curl_blob*));
        break;
#endif
    ...
    case CURLOPT_PROXY_SSL_OPTIONS:
        ...
        data->set.proxy_ssl.auto_client_cert = !!(arg & CURLSSLOPT_AUTO_CLIENT_CERT);
        break;
#endif
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_SSL_EC_CURVES], va_arg(param, char*));
        break;
#endif
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_SSH_HOST_PUBLIC_KEY_MD5], va_arg(param, char*));
        break;
     ...
     * for validation purposes.
     */
        result = Curl_setstropt(&data->set.str[STRING_SSH_HOST_PUBLIC_KEY_SHA256], va_arg(param, char*));
        break;
    ...
    case CURLOPT_TLSAUTH_USERNAME:
        result = Curl_setstropt(&data->set.str[STRING_TLSAUTH_USERNAME], va_arg(param, char*));
        break;
#ifndef CURL_DISABLE_PROXY
    case CURLOPT_PROXY_TLSAUTH_USERNAME:
        result = Curl_setstropt(&data->set.str[STRING_TLSAUTH_USERNAME_PROXY], va_arg(param, char*));
        break;
#endif
    case CURLOPT_TLSAUTH_PASSWORD:
        result = Curl_setstropt(&data->set.str[STRING_TLSAUTH_PASSWORD], va_arg(param, char*));
        break;
#ifndef CURL_DISABLE_PROXY
    case CURLOPT_PROXY_TLSAUTH_PASSWORD:
        result = Curl_setstropt(&data->set.str[STRING_TLSAUTH_PASSWORD_PROXY], va_arg(param, char*));
        break;
#endif
     ...
     */
        result = Curl_setstropt(&data->set.str[STRING_SIGN_CERT], va_arg(param, char*));
        break;
    case CURLOPT_SSLSIGNKEY:
        /*
     * String that holds file name of the SSL sign key to use
     */
        result = Curl_setstropt(&data->set.str[STRING_SIGN_KEY], va_arg(param, char*));
        break;
    case CURLOPT_SSLENCCERT:
        /*
     * String that holds file name of the SSL enc certificate to use
     */
        result = Curl_setstropt(&data->set.str[STRING_ENC_CERT], va_arg(param, char*));
        break;
    case CURLOPT_SSLENCKEY:
        /*
     * String that holds file name of the SSL enc key to use
     */
        result = Curl_setstropt(&data->set.str[STRING_ENC_KEY], va_arg(param, char*));
        break;
#endif
    default:
