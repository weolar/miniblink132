...
#if (defined(_MSC_VER) && (_MSC_VER >= 1600)) || defined(__MINGW32__) || (defined(__BORLANDC__) && (__BORLANDC__ >= 0x0582)) || defined(__POCC__)
...
#if defined(__MINGW32__) || defined(__POCC__) || (defined(_MSC_VER) && (_MSC_VER >= 1800))
...
#if defined(__MINGW32__) || (defined(_MSC_VER) && (_MSC_VER >= 1310)) || (defined(__BORLANDC__) && (__BORLANDC__ >= 0x561))
