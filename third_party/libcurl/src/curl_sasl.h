...
struct SASLproto {
    ...
    CURLcode (*sendauth)(struct Curl_easy* data, const char* mech, const struct bufref* ir);
    /* Send authentication command */
    CURLcode (*contauth)(struct Curl_easy* data, const char* mech, const struct bufref* contauth);
