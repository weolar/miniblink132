...
#if defined(__GNUC__) && ((__GNUC__ > 12) || ((__GNUC__ == 12) && (__GNUC_MINOR__ >= 1))) && !defined(__INTEL_COMPILER) && !defined(CURL_DISABLE_DEPRECATION)  \
    && !defined(BUILDING_LIBCURL)
#define CURL_DEPRECATED(version, message) __attribute__((deprecated("since " #version ". " message)))
#define CURL_IGNORE_DEPRECATION(statements)                                                                                                                    \
    _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"") statements _Pragma("GCC diagnostic pop")
#else
...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
    ...
    || defined(__ANDROID__) || defined(__OpenBSD__) || defined(__CYGWIN__) || defined(AMIGA) || defined(__NuttX__)                                             \
    || (defined(__FreeBSD_version) && (__FreeBSD_version < 800000)) || (defined(__MidnightBSD_version) && (__MidnightBSD_version < 100000))                    \
...
typedef enum {
   ...
   * This must be one of the CURL_NETRC_* enums below. */
    ...
    /* HTTP PUT */
    CURLOPTDEPRECATED(CURLOPT_PUT, CURLOPTTYPE_LONG, 54, 7.12.1, "Use CURLOPT_UPLOAD"),
   ...
   * prototype defines. */
    CURLOPTDEPRECATED(CURLOPT_PROGRESSFUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 56, 7.32.0, "Use CURLOPT_XFERINFOFUNCTION"),
...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
   ...
   * is set but doesn't match one of these, 'private' will be used.  */
    ...
    CURLOPTDEPRECATED(CURLOPT_RANDOM_FILE, CURLOPTTYPE_STRINGPOINT, 76, 7.84.0, "Serves no purpose anymore"),

    /* Set to the Entropy Gathering Daemon socket pathname */
    CURLOPTDEPRECATED(CURLOPT_EGDSOCKET, CURLOPTTYPE_STRINGPOINT, 77, 7.84.0, "Serves no purpose anymore"),
   ...
   */
    ...
    CURLOPTDEPRECATED(CURLOPT_DNS_USE_GLOBAL_CACHE, CURLOPTTYPE_LONG, 91, 7.11.1, "Use CURLOPT_SHARE"),
  ...
  */
    ...
    CURLOPTDEPRECATED(CURLOPT_IOCTLFUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 130, 7.18.0, "Use CURLOPT_SEEKFUNCTION"),
    CURLOPTDEPRECATED(CURLOPT_IOCTLDATA, CURLOPTTYPE_CBPOINT, 131, 7.18.0, "Use CURLOPT_SEEKDATA"),
  ...
  */
    ...
    CURLOPTDEPRECATED(CURLOPT_CONV_FROM_NETWORK_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 142, 7.82.0, "Serves no purpose anymore"),

    /* Function that will be called to convert to the
     network encoding (instead of using the iconv calls in libcurl) */
    CURLOPTDEPRECATED(CURLOPT_CONV_TO_NETWORK_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 143, 7.82.0, "Serves no purpose anymore"),

    /* Function that will be called to convert from UTF8
     (instead of using the iconv calls in libcurl)
     Note that this is used only for SSL certificate processing */
    CURLOPTDEPRECATED(CURLOPT_CONV_FROM_UTF8_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 144, 7.82.0, "Serves no purpose anymore"),
    ...
    /* Socks Service */
    /* DEPRECATED, do not use! */
    CURLOPTDEPRECATED(CURLOPT_SOCKS5_GSSAPI_SERVICE, CURLOPTTYPE_STRINGPOINT, 179, 7.49.0, "Use CURLOPT_PROXY_SERVICE_NAME"),
    ...
    CURLOPTDEPRECATED(CURLOPT_PROTOCOLS, CURLOPTTYPE_LONG, 181, 7.85.0, "Use CURLOPT_PROTOCOLS_STR"),

    /* set the bitmask for the protocols that libcurl is allowed to follow to,
     as a subset of the CURLOPT_PROTOCOLS ones. That means the protocol needs
     to be set in both bitmasks to be allowed to get redirected to. */
    CURLOPTDEPRECATED(CURLOPT_REDIR_PROTOCOLS, CURLOPTTYPE_LONG, 182, 7.85.0, "Use CURLOPT_REDIR_PROTOCOLS_STR"),
  ...
  */
   ...
   * Only supported by the c-ares DNS backend */
    ...
    CURLOPTDEPRECATED(CURLOPT_SSL_ENABLE_NPN, CURLOPTTYPE_LONG, 225, 7.86.0, "Has no function"),
...
CURL_EXTERN CURLcode curl_mime_data_cb(
    curl_mimepart* part, curl_off_t datasize, curl_read_callback readfunc, curl_seek_callback seekfunc, curl_free_callback freefunc, void* arg);
