...
static FcBool FcFileScanFontConfig(FcFontSet* set, const FcChar8* file, FcConfig* config)
{
    int i;
    FcBool ret = FcTrue;
	 ...
	 */
        if (sysroot) {
            ...
            if (FcPatternObjectGetString(font, FC_FILE_OBJECT, 0, &f) == FcResultMatch && strncmp((const char*)f, (const char*)sysroot, len) == 0) {
...
FcBool FcFileScan(FcFontSet* set, FcStrSet* dirs, FcFileCache* cache FC_UNUSED, FcBlanks* blanks FC_UNUSED, const FcChar8* file, FcBool force FC_UNUSED)
{
    FcConfig* config;
    FcBool ret;
...
FcBool FcDirScanConfig(FcFontSet* set, FcStrSet* dirs, const FcChar8* dir, FcBool force, /* XXX unused */
    FcConfig* config)
{
    DIR* d;
    struct dirent* e;
...
FcBool FcDirScan(FcFontSet* set, FcStrSet* dirs, FcFileCache* cache FC_UNUSED, FcBlanks* blanks FC_UNUSED, const FcChar8* dir, FcBool force FC_UNUSED)
{
    FcConfig* config;
    FcBool ret;
...
FcBool FcDirSave(FcFontSet* set FC_UNUSED, FcStrSet* dirs FC_UNUSED, const FcChar8* dir FC_UNUSED)
{
