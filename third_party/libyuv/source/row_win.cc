...
#if !defined(LIBYUV_DISABLE_X86) && defined(_MSC_VER) && !defined(__clang__) && (defined(_M_IX86) || defined(_M_X64))
...
static const ulvec8 kBiasUV128 = { 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
...
__declspec(naked) void J400ToARGBRow_SSE2(const uint8_t* src_y, uint8_t* dst_argb, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_y
...
// Duplicates gray value 3 times and fills in alpha opaque.
__declspec(naked) void J400ToARGBRow_AVX2(const uint8_t* src_y, uint8_t* dst_argb, int width)
{
    __asm {
    mov         eax, [esp + 4] // src_y
    mov         edx, [esp + 8] // dst_argb
...
__declspec(naked) void RAWToARGBRow_SSSE3(const uint8_t* src_raw, uint8_t* dst_argb, int width)
{
    __asm {
...
__declspec(naked) void RAWToRGB24Row_SSSE3(const uint8_t* src_raw, uint8_t* dst_rgb24, int width)
{
    __asm {
    mov       eax, [esp + 4] // src_raw
...
// 20 instructions.
__declspec(naked) void RGB565ToARGBRow_SSE2(const uint8_t* src_rgb565, uint8_t* dst_argb, int width)
{
    __asm {
...
// v * (256 + 8)
// G shift of 5 is incorporated, so shift is 5 + 8 and 5 + 3
__declspec(naked) void RGB565ToARGBRow_AVX2(const uint8_t* src_rgb565, uint8_t* dst_argb, int width)
{
    __asm {
    mov        eax, 0x01080108 // generate multiplier to repeat 5 bits
    vmovd      xmm5, eax
...
__declspec(naked) void ARGB1555ToARGBRow_AVX2(const uint8_t* src_argb1555, uint8_t* dst_argb, int width)
{
    __asm {
    mov        eax, 0x01080108 // generate multiplier to repeat 5 bits
    vmovd      xmm5, eax
...
__declspec(naked) void ARGB4444ToARGBRow_AVX2(const uint8_t* src_argb4444, uint8_t* dst_argb, int width)
{
    __asm {
...
// 24 instructions
__declspec(naked) void ARGB1555ToARGBRow_SSE2(const uint8_t* src_argb1555, uint8_t* dst_argb, int width)
{
    __asm {
    mov       eax, 0x01080108 // generate multiplier to repeat 5 bits
    movd      xmm5, eax
...
// 18 instructions.
__declspec(naked) void ARGB4444ToARGBRow_SSE2(const uint8_t* src_argb4444, uint8_t* dst_argb, int width)
{
    __asm {
    mov       eax, 0x0f0f0f0f // generate mask 0x0f0f0f0f
    movd      xmm4, eax
...
__declspec(naked) void ARGBToRGB24Row_SSSE3(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
...
__declspec(naked) void ARGBToRAWRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
    mov       eax, [esp + 4] // src_argb
    mov       edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToRGB565Row_SSE2(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
    mov       eax, [esp + 4] // src_argb
    mov       edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToRGB565DitherRow_SSE2(const uint8_t* src_argb, uint8_t* dst_rgb, const uint32_t dither4, int width)
{
    __asm {
...
__declspec(naked) void ARGBToRGB565DitherRow_AVX2(const uint8_t* src_argb, uint8_t* dst_rgb, const uint32_t dither4, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToARGB1555Row_SSE2(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
    mov       eax, [esp + 4] // src_argb
    mov       edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToARGB4444Row_SSE2(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
    mov       eax, [esp + 4] // src_argb
    mov       edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToRGB565Row_AVX2(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToARGB1555Row_AVX2(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToARGB4444Row_AVX2(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_rgb
...
__declspec(naked) void ARGBToYRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ARGBToYJRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ARGBToYRow_AVX2(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
// Convert 32 ARGB pixels (128 bytes) to 32 Y values.
__declspec(naked) void ARGBToYJRow_AVX2(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void BGRAToYRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ABGRToYRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void RGBAToYRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ARGBToUVRow_SSSE3(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void ARGBToUVJRow_SSSE3(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void ARGBToUVRow_AVX2(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void ARGBToUVJRow_AVX2(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void ARGBToUV444Row_SSSE3(const uint8_t* src_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       edi
...
__declspec(naked) void BGRAToUVRow_SSSE3(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void ABGRToUVRow_SSSE3(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void RGBAToUVRow_SSSE3(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void I422AlphaToARGBRow_AVX2(const uint8_t* y_buf, const uint8_t* u_buf, const uint8_t* v_buf, const uint8_t* a_buf, uint8_t* dst_argb,
    const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
...
// 16 pixels
// 16 UV values with 16 Y producing 16 ARGB (64 bytes).
__declspec(naked) void I444AlphaToARGBRow_AVX2(const uint8_t* y_buf, const uint8_t* u_buf, const uint8_t* v_buf, const uint8_t* a_buf, uint8_t* dst_argb,
    const struct YuvConstants* yuvconstants, int width)
{
    __asm {
  push       esi
...
// 16 pixels.
// 8 UV values upsampled to 16 UV, mixed with 16 Y producing 16 ARGB (64 bytes).
__declspec(naked) void NV12ToARGBRow_AVX2(const uint8_t* y_buf, const uint8_t* uv_buf, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
    push       ebx
...
__declspec(naked) void NV21ToARGBRow_AVX2(const uint8_t* y_buf, const uint8_t* vu_buf, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
    push       ebx
...
__declspec(naked) void YUY2ToARGBRow_AVX2(const uint8_t* src_yuy2, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       ebx
...
__declspec(naked) void UYVYToARGBRow_AVX2(const uint8_t* src_uyvy, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       ebx
...
__declspec(naked) void I444AlphaToARGBRow_SSSE3(const uint8_t* y_buf, const uint8_t* u_buf, const uint8_t* v_buf, const uint8_t* a_buf, uint8_t* dst_argb,
    const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
...
__declspec(naked) void I422ToRGB565Row_SSSE3(
    const uint8_t* y_buf, const uint8_t* u_buf, const uint8_t* v_buf, uint8_t* rgb565_buf, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void I422AlphaToARGBRow_SSSE3(const uint8_t* y_buf, const uint8_t* u_buf, const uint8_t* v_buf, const uint8_t* a_buf, uint8_t* dst_argb,
    const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
...
// 8 pixels.
// 4 UV values upsampled to 8 UV, mixed with 8 Y producing 8 ARGB (32 bytes).
__declspec(naked) void NV12ToARGBRow_SSSE3(const uint8_t* y_buf, const uint8_t* uv_buf, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
    push       ebx
...
// 8 pixels.
// 4 UV values upsampled to 8 UV, mixed with 8 Y producing 8 ARGB (32 bytes).
__declspec(naked) void NV21ToARGBRow_SSSE3(const uint8_t* y_buf, const uint8_t* vu_buf, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       esi
    push       ebx
...
__declspec(naked) void YUY2ToARGBRow_SSSE3(const uint8_t* src_yuy2, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       ebx
    mov        eax, [esp + 4 + 4] // yuy2
...
__declspec(naked) void UYVYToARGBRow_SSSE3(const uint8_t* src_uyvy, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    __asm {
    push       ebx
    mov        eax, [esp + 4 + 4] // uyvy
...
__declspec(naked) void I400ToARGBRow_SSE2(const uint8_t* y_buf, uint8_t* rgb_buf, const struct YuvConstants*, int width)
{
    __asm {
...
__declspec(naked) void I400ToARGBRow_AVX2(const uint8_t* y_buf, uint8_t* rgb_buf, const struct YuvConstants*, int width)
{
    __asm {
    mov        eax, 0x4a354a35 // 4a35 = 18997 = round(1.164 * 64 * 256)
    vmovd      xmm2, eax
...
__declspec(naked) void MirrorRow_SSSE3(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov       eax, [esp + 4] // src
    mov       edx, [esp + 8] // dst
...
__declspec(naked) void MirrorSplitUVRow_SSSE3(const uint8_t* src, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push      edi
    mov       eax, [esp + 4 + 4] // src
...
__declspec(naked) void ARGBMirrorRow_SSE2(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov       eax, [esp + 4] // src
    mov       edx, [esp + 8] // dst
...
__declspec(naked) void ARGBMirrorRow_AVX2(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov       eax, [esp + 4] // src
    mov       edx, [esp + 8] // dst
...
__declspec(naked) void SplitUVRow_SSE2(const uint8_t* src_uv, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       edi
...
__declspec(naked) void SplitUVRow_AVX2(const uint8_t* src_uv, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       edi
    mov        eax, [esp + 4 + 4] // src_uv
...
__declspec(naked) void MergeUVRow_SSE2(const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_uv, int width)
{
    __asm {
    push       edi
...
__declspec(naked) void MergeUVRow_AVX2(const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_uv, int width)
{
    __asm {
    push       edi
    mov        eax, [esp + 4 + 4] // src_u
...
__declspec(naked) void CopyRow_SSE2(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov        eax, [esp + 4] // src
    mov        edx, [esp + 8] // dst
...
__declspec(naked) void CopyRow_AVX(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov        eax, [esp + 4] // src
    mov        edx, [esp + 8] // dst
...
// Multiple of 1.
__declspec(naked) void CopyRow_ERMS(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov        eax, esi
    mov        edx, edi
...
// width in pixels
__declspec(naked) void ARGBCopyAlphaRow_SSE2(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov        eax, [esp + 4] // src
    mov        edx, [esp + 8] // dst
...
// width in pixels
__declspec(naked) void ARGBCopyAlphaRow_AVX2(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov        eax, [esp + 4] // src
    mov        edx, [esp + 8] // dst
...
// width in pixels
__declspec(naked) void ARGBExtractAlphaRow_SSE2(const uint8_t* src_argb, uint8_t* dst_a, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_a
...
// width in pixels
__declspec(naked) void ARGBExtractAlphaRow_AVX2(const uint8_t* src_argb, uint8_t* dst_a, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_a
...
// width in pixels
__declspec(naked) void ARGBCopyYToAlphaRow_SSE2(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov        eax, [esp + 4] // src
    mov        edx, [esp + 8] // dst
...
// width in pixels
__declspec(naked) void ARGBCopyYToAlphaRow_AVX2(const uint8_t* src, uint8_t* dst, int width)
{
    __asm {
    mov        eax, [esp + 4] // src
    mov        edx, [esp + 8] // dst
...
__declspec(naked) void ARGBSetRow_X86(uint8_t* dst_argb, uint32_t v32, int width)
{
    __asm {
    mov        edx, edi
    mov        edi, [esp + 4] // dst
...
__declspec(naked) void YUY2ToYRow_AVX2(const uint8_t* src_yuy2, uint8_t* dst_y, int width)
{
    __asm {
...
__declspec(naked) void YUY2ToUVRow_AVX2(const uint8_t* src_yuy2, int stride_yuy2, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void YUY2ToUV422Row_AVX2(const uint8_t* src_yuy2, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       edi
...
__declspec(naked) void UYVYToYRow_AVX2(const uint8_t* src_uyvy, uint8_t* dst_y, int width)
{
    __asm {
...
__declspec(naked) void UYVYToUVRow_AVX2(const uint8_t* src_uyvy, int stride_uyvy, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void UYVYToUV422Row_AVX2(const uint8_t* src_uyvy, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       edi
    mov        eax, [esp + 4 + 4] // src_yuy2
...
__declspec(naked) void YUY2ToYRow_SSE2(const uint8_t* src_yuy2, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_yuy2
    mov        edx, [esp + 8] // dst_y
...
__declspec(naked) void YUY2ToUVRow_SSE2(const uint8_t* src_yuy2, int stride_yuy2, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void YUY2ToUV422Row_SSE2(const uint8_t* src_yuy2, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       edi
    mov        eax, [esp + 4 + 4] // src_yuy2
...
__declspec(naked) void UYVYToYRow_SSE2(const uint8_t* src_uyvy, uint8_t* dst_y, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_uyvy
    mov        edx, [esp + 8] // dst_y
...
__declspec(naked) void UYVYToUVRow_SSE2(const uint8_t* src_uyvy, int stride_uyvy, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void UYVYToUV422Row_SSE2(const uint8_t* src_uyvy, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    __asm {
    push       edi
    mov        eax, [esp + 4 + 4] // src_yuy2
...
__declspec(naked) void BlendPlaneRow_SSSE3(const uint8_t* src0, const uint8_t* src1, const uint8_t* alpha, uint8_t* dst, int width)
{
    __asm {
    push       esi
    push       edi
...
// signed version of math
// =(((A2-128)*C2)+((B2-128)*(255-C2))+32768+127)/256
__declspec(naked) void BlendPlaneRow_AVX2(const uint8_t* src0, const uint8_t* src1, const uint8_t* alpha, uint8_t* dst, int width)
{
    __asm {
    push        esi
    push        edi
...
// Blend 8 pixels at a time.
__declspec(naked) void ARGBBlendRow_SSSE3(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_argb
...
__declspec(naked) void ARGBAttenuateRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_argb
...
__declspec(naked) void ARGBAttenuateRow_AVX2(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_argb
...
__declspec(naked) void ARGBUnattenuateRow_SSE2(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    __asm {
    push       ebx
    push       esi
...
#ifdef USE_GATHER
__declspec(naked) void ARGBUnattenuateRow_AVX2(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_argb
...
__declspec(naked) void ARGBGrayRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_argb */
...
__declspec(naked) void ARGBColorMatrixRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_argb, const int8_t* matrix_argb, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_argb */
...
__declspec(naked) void ARGBQuantizeRow_SSE2(uint8_t* dst_argb, int scale, int interval_size, int interval_offset, int width)
{
    __asm {
    mov        eax, [esp + 4] /* dst_argb */
...
__declspec(naked) void ARGBShadeRow_SSE2(const uint8_t* src_argb, uint8_t* dst_argb, int width, uint32_t value)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_argb
...
__declspec(naked) void ARGBMultiplyRow_SSE2(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_argb
...
__declspec(naked) void ARGBAddRow_SSE2(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_argb
...
__declspec(naked) void ARGBSubtractRow_SSE2(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_argb
...
__declspec(naked) void ARGBMultiplyRow_AVX2(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_argb
...
__declspec(naked) void ARGBAddRow_AVX2(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_argb
...
__declspec(naked) void ARGBSubtractRow_AVX2(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_argb
...
// -2  0  2
// -1  0  1
__declspec(naked) void SobelXRow_SSE2(const uint8_t* src_y0, const uint8_t* src_y1, const uint8_t* src_y2, uint8_t* dst_sobelx, int width)
{
    __asm {
    push       esi
    push       edi
...
//  0  0  0
//  1  2  1
__declspec(naked) void SobelYRow_SSE2(const uint8_t* src_y0, const uint8_t* src_y1, uint8_t* dst_sobely, int width)
{
    __asm {
    push       esi
...
// G = Sobel
// B = Sobel
__declspec(naked) void SobelRow_SSE2(const uint8_t* src_sobelx, const uint8_t* src_sobely, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
...
__declspec(naked) void SobelToPlaneRow_SSE2(const uint8_t* src_sobelx, const uint8_t* src_sobely, uint8_t* dst_y, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_sobelx
...
// G = Sobel
// B = Sobel Y
__declspec(naked) void SobelXYRow_SSE2(const uint8_t* src_sobelx, const uint8_t* src_sobely, uint8_t* dst_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] // src_sobelx
...
__declspec(naked) LIBYUV_API void ARGBAffineRow_SSE2(const uint8_t* src_argb, int src_argb_stride, uint8_t* dst_argb, const float* uv_dudv, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void InterpolateRow_AVX2(uint8_t* dst_ptr, const uint8_t* src_ptr, ptrdiff_t src_stride, int dst_width, int source_y_fraction)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void InterpolateRow_SSSE3(uint8_t* dst_ptr, const uint8_t* src_ptr, ptrdiff_t src_stride, int dst_width, int source_y_fraction)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void ARGBShuffleRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_argb, const uint8_t* shuffler, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_argb
...
__declspec(naked) void ARGBShuffleRow_AVX2(const uint8_t* src_argb, uint8_t* dst_argb, const uint8_t* shuffler, int width)
{
    __asm {
    mov        eax, [esp + 4] // src_argb
    mov        edx, [esp + 8] // dst_argb
...
__declspec(naked) void I422ToYUY2Row_SSE2(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_frame, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void I422ToUYVYRow_SSE2(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_frame, int width)
{
    __asm {
    push       esi
    push       edi
...
__declspec(naked) void ARGBPolynomialRow_SSE2(const uint8_t* src_argb, uint8_t* dst_argb, const float* poly, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] /* src_argb */
...
__declspec(naked) void ARGBPolynomialRow_AVX2(const uint8_t* src_argb, uint8_t* dst_argb, const float* poly, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_argb */
...
__declspec(naked) void HalfFloatRow_SSE2(const uint16_t* src, uint16_t* dst, float scale, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src */
    mov        edx, [esp + 8] /* dst */
...
__declspec(naked) void HalfFloatRow_AVX2(const uint16_t* src, uint16_t* dst, float scale, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src */
    mov        edx, [esp + 8] /* dst */
...
__declspec(naked) void HalfFloatRow_F16C(const uint16_t* src, uint16_t* dst, float scale, int width)
{
    __asm {
    mov        eax, [esp + 4] /* src */
    mov        edx, [esp + 8] /* dst */
...
__declspec(naked) void ARGBColorTableRow_X86(uint8_t* dst_argb, const uint8_t* table_argb, int width)
{
    __asm {
    push       esi
...
__declspec(naked) void RGBColorTableRow_X86(uint8_t* dst_argb, const uint8_t* table_argb, int width)
{
    __asm {
    push       esi
    mov        eax, [esp + 4 + 4] /* dst_argb */
...
__declspec(naked) void ARGBLumaColorTableRow_SSSE3(const uint8_t* src_argb, uint8_t* dst_argb, int width, const uint8_t* luma, uint32_t lumacoeff)
{
    __asm {
    push       esi
    push       edi
