...
#define YUVTORGB_D(in_y, in_uvl, in_uvh, ubvr, ugvg, yg, yb, b_l, b_h, g_l, g_h, r_l, r_h)                                                                     \
    {                                                                                                                                                          \
        ...
        DUP4_ARG2(__lasx_xvsrai_w, yl_ev, 16, yl_od, 16, yh_ev, 16, yh_od, 16, yl_ev, yl_od, yh_ev, yh_od);                                                    \
        ...
        DUP4_ARG2(__lasx_xvsrai_w, temp0, 6, temp1, 6, temp2, 6, temp3, 6, temp0, temp1, temp2, temp3);                                                        \
...
void MirrorRow_LASX(const uint8_t* src, uint8_t* dst, int width)
{
    ...
    int len = width / 64;
    __m256i src0, src1;
    __m256i shuffler = { 0x08090A0B0C0D0E0F, 0x0001020304050607, 0x08090A0B0C0D0E0F, 0x0001020304050607 };
    src += width - 64;
    for (x = 0; x < len; x++) {
        DUP2_ARG2(__lasx_xvld, src, 0, src, 32, src0, src1);
        DUP2_ARG3(__lasx_xvshuf_b, src0, src0, shuffler, src1, src1, shuffler, src0, src1);
...
void MirrorUVRow_LASX(const uint8_t* src_uv, uint8_t* dst_uv, int width)
{
    ...
    int len = width / 16;
    __m256i src, dst;
    __m256i shuffler = { 0x0004000500060007, 0x0000000100020003, 0x0004000500060007, 0x0000000100020003 };
...
void ARGBMirrorRow_LASX(const uint8_t* src, uint8_t* dst, int width)
{
    ...
    __m256i src0, src1;
    __m256i dst0, dst1;
    __m256i shuffler = { 0x0B0A09080F0E0D0C, 0x0302010007060504, 0x0B0A09080F0E0D0C, 0x0302010007060504 };
    src += (width * 4) - 64;
    for (x = 0; x < len; x++) {
        DUP2_ARG2(__lasx_xvld, src, 0, src, 32, src0, src1);
        DUP2_ARG3(__lasx_xvshuf_b, src0, src0, shuffler, src1, src1, shuffler, src0, src1);
...
void I422ToARGBRow_LASX(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    int x;
    int len = width / 32;
    ...
    for (x = 0; x < len; x++) {
        ...
        YUVTORGB_D(y, uv_l, uv_h, vec_ubvr, vec_ugvg, vec_yg, vec_yb, b_l, b_h, g_l, g_h, r_l, r_h);
...
void I422ToRGBARow_LASX(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    int x;
    int len = width / 32;
...
void I422ToRGB24Row_LASX(
    const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int32_t width)
{
    int x;
    int len = width / 32;
    __m256i vec_yb, vec_yg, vec_ub, vec_vr, vec_ug, vec_vg;
    __m256i vec_ubvr, vec_ugvg;
    __m256i const_0x80 = __lasx_xvldi(0x80);
    __m256i shuffler0 = { 0x0504120302100100, 0x0A18090816070614, 0x0504120302100100, 0x0A18090816070614 };
    __m256i shuffler1 = { 0x1E0F0E1C0D0C1A0B, 0x1E0F0E1C0D0C1A0B, 0x1E0F0E1C0D0C1A0B, 0x1E0F0E1C0D0C1A0B };
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG3(__lasx_xvshuf_b, r_l, temp0, shuffler1, r_h, temp1, shuffler1, r_l, temp0, shuffler0, r_h, temp1, shuffler0, temp2, temp3, temp0, temp1);
    ...
    const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb4444, const struct YuvConstants* yuvconstants, int width)
{
    ...
    __m256i vec_ubvr, vec_ugvg;
    __m256i const_0x80 = __lasx_xvldi(0x80);
    __m256i alpha = { 0xF000F000F000F000, 0xF000F000F000F000, 0xF000F000F000F000, 0xF000F000F000F000 };
    __m256i mask = { 0x00F000F000F000F0, 0x00F000F000F000F0, 0x00F000F000F000F0, 0x00F000F000F000F0 };
    ...
    const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb1555, const struct YuvConstants* yuvconstants, int width)
{
    ...
    __m256i vec_ubvr, vec_ugvg;
    __m256i const_0x80 = __lasx_xvldi(0x80);
    __m256i alpha = { 0x8000800080008000, 0x8000800080008000, 0x8000800080008000, 0x8000800080008000 };
...
void YUY2ToUVRow_LASX(const uint8_t* src_yuy2, int src_stride_yuy2, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_yuy2, 0, src_yuy2, 32, src_yuy2_next, 0, src_yuy2_next, 32, src0, src1, src2, src3);
...
void UYVYToUVRow_LASX(const uint8_t* src_uyvy, int src_stride_uyvy, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_uyvy, 0, src_uyvy, 32, src_uyvy_next, 0, src_uyvy_next, 32, src0, src1, src2, src3);
...
void ARGBToYRow_LASX(const uint8_t* src_argb0, uint8_t* dst_y, int width)
{
    ...
    __m256i const_1080 = { 0x1080108010801080, 0x1080108010801080, 0x1080108010801080, 0x1080108010801080 };
    __m256i control = { 0x0000000400000000, 0x0000000500000001, 0x0000000600000002, 0x0000000700000003 };

    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_argb0, 0, src_argb0, 32, src_argb0, 64, src_argb0, 96, src0, src1, src2, src3);
...
void ARGBToUVRow_LASX(const uint8_t* src_argb0, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    int x;
    int len = width / 32;
    ...
    __m256i const_0x70 = { 0x0038003800380038, 0x0038003800380038, 0x0038003800380038, 0x0038003800380038 };
    __m256i const_0x4A = { 0x0025002500250025, 0x0025002500250025, 0x0025002500250025, 0x0025002500250025 };
    __m256i const_0x26 = { 0x0013001300130013, 0x0013001300130013, 0x0013001300130013, 0x0013001300130013 };
    __m256i const_0x5E = { 0x002f002f002f002f, 0x002f002f002f002f, 0x002f002f002f002f, 0x002f002f002f002f };
    __m256i const_0x12 = { 0x0009000900090009, 0x0009000900090009, 0x0009000900090009, 0x0009000900090009 };
    __m256i control = { 0x0000000400000000, 0x0000000500000001, 0x0000000600000002, 0x0000000700000003 };
    __m256i const_0x8080 = { 0x8080808080808080, 0x8080808080808080, 0x8080808080808080, 0x8080808080808080 };

    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_argb0, 0, src_argb0, 32, src_argb0, 64, src_argb0, 96, src0, src1, src2, src3);
        DUP4_ARG2(__lasx_xvld, src_argb1, 0, src_argb1, 32, src_argb1, 64, src_argb1, 96, src4, src5, src6, src7);
...
void ARGBToRGB24Row_LASX(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    ...
    __m256i shuf = { 0x0908060504020100, 0x000000000E0D0C0A, 0x0908060504020100, 0x000000000E0D0C0A };
    __m256i control = { 0x0000000100000000, 0x0000000400000002, 0x0000000600000005, 0x0000000700000003 };
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_argb, 0, src_argb, 32, src_argb, 64, src_argb, 96, src0, src1, src2, src3);
...
void ARGBToRAWRow_LASX(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    ...
    __m256i src0, src1, src2, src3;
    __m256i tmp0, tmp1, tmp2, tmp3;
    __m256i shuf = { 0x090A040506000102, 0x000000000C0D0E08, 0x090A040506000102, 0x000000000C0D0E08 };
    __m256i control = { 0x0000000100000000, 0x0000000400000002, 0x0000000600000005, 0x0000000700000003 };
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_argb, 0, src_argb, 32, src_argb, 64, src_argb, 96, src0, src1, src2, src3);
        tmp0 = __lasx_xvshuf_b(src0, src0, shuf);
...
void ARGBToRGB565Row_LASX(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    ...
    __m256i shift = { 0x0300030003000300, 0x0300030003000300, 0x0300030003000300, 0x0300030003000300 };
...
void ARGBToARGB1555Row_LASX(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    ...
    __m256i shift1 = { 0x0703070307030703, 0x0703070307030703, 0x0703070307030703, 0x0703070307030703 };
    __m256i shift2 = { 0x0200020002000200, 0x0200020002000200, 0x0200020002000200, 0x0200020002000200 };
...
void ARGBToUV444Row_LASX(const uint8_t* src_argb, uint8_t* dst_u, uint8_t* dst_v, int32_t width)
{
    int x;
    int len = width / 32;
    __m256i src0, src1, src2, src3;
...
void ARGBAttenuateRow_LASX(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    ...
    __m256i control = { 0x0005000100040000, 0x0007000300060002, 0x0005000100040000, 0x0007000300060002 };
...
void ARGBShuffleRow_LASX(const uint8_t* src_argb, uint8_t* dst_argb, const uint8_t* shuffler, int width)
{
    ...
    int len = width / 16;
    __m256i src0, src1, dst0, dst1;
    __m256i shuf = { 0x0404040400000000, 0x0C0C0C0C08080808, 0x0404040400000000, 0x0C0C0C0C08080808 };
...
void ARGBGrayRow_LASX(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    ...
    __m256i const_br = { 0x4D1D4D1D4D1D4D1D, 0x4D1D4D1D4D1D4D1D, 0x4D1D4D1D4D1D4D1D, 0x4D1D4D1D4D1D4D1D };
...
void ARGBSepiaRow_LASX(uint8_t* dst_argb, int width)
{
    ...
    __m256i spb_br = { 0x2311231123112311, 0x2311231123112311, 0x2311231123112311, 0x2311231123112311 };
    __m256i spg_br = { 0x2D162D162D162D16, 0x2D162D162D162D16, 0x2D162D162D162D16, 0x2D162D162D162D16 };
    __m256i spr_br = { 0x3218321832183218, 0x3218321832183218, 0x3218321832183218, 0x3218321832183218 };
    __m256i shuff = { 0x1706150413021100, 0x1F0E1D0C1B0A1908, 0x1706150413021100, 0x1F0E1D0C1B0A1908 };
...
void ARGB4444ToARGBRow_LASX(const uint8_t* src_argb4444, uint8_t* dst_argb, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG2(__lasx_xvandi_b, src0, 0x0F, src0, 0xF0, src1, 0x0F, src1, 0xF0, tmp0, tmp1, tmp2, tmp3);
        DUP2_ARG2(__lasx_xvslli_b, tmp0, 4, tmp2, 4, reg0, reg2);
        DUP2_ARG2(__lasx_xvsrli_b, tmp1, 4, tmp3, 4, reg1, reg3);
        DUP4_ARG2(__lasx_xvor_v, tmp0, reg0, tmp1, reg1, tmp2, reg2, tmp3, reg3, tmp0, tmp1, tmp2, tmp3);
        DUP2_ARG2(__lasx_xvilvl_b, tmp1, tmp0, tmp3, tmp2, reg0, reg2);
        DUP2_ARG2(__lasx_xvilvh_b, tmp1, tmp0, tmp3, tmp2, reg1, reg3);
        DUP4_ARG3(__lasx_xvpermi_q, reg1, reg0, 0x20, reg1, reg0, 0x31, reg3, reg2, 0x20, reg3, reg2, 0x31, dst0, dst1, dst2, dst3);
        __lasx_xvst(dst0, dst_argb, 0);
        __lasx_xvst(dst1, dst_argb, 32);
...
void ARGB1555ToARGBRow_LASX(const uint8_t* src_argb1555, uint8_t* dst_argb, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG3(__lasx_xvpermi_q, dst1, dst0, 0x20, dst1, dst0, 0x31, dst3, dst2, 0x20, dst3, dst2, 0x31, reg0, reg1, reg2, reg3);
...
void RGB24ToARGBRow_LASX(const uint8_t* src_rgb24, uint8_t* dst_argb, int width)
{
    ...
    __m256i reg0, reg1, reg2, reg3;
    __m256i alpha = __lasx_xvldi(0xFF);
    __m256i shuf0 = { 0x131211100F0E0D0C, 0x1B1A191817161514, 0x131211100F0E0D0C, 0x1B1A191817161514 };
    __m256i shuf1 = { 0x1F1E1D1C1B1A1918, 0x0706050403020100, 0x1F1E1D1C1B1A1918, 0x0706050403020100 };
    __m256i shuf2 = { 0x0B0A090807060504, 0x131211100F0E0D0C, 0x0B0A090807060504, 0x131211100F0E0D0C };
    __m256i shuf3 = { 0x1005040310020100, 0x100B0A0910080706, 0x1005040310020100, 0x100B0A0910080706 };
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG3(__lasx_xvshuf_b, alpha, src0, shuf3, alpha, tmp0, shuf3, alpha, tmp1, shuf3, alpha, tmp2, shuf3, reg0, reg1, reg2, reg3);
        DUP4_ARG3(__lasx_xvpermi_q, reg1, reg0, 0x20, reg3, reg2, 0x20, reg1, reg0, 0x31, reg3, reg2, 0x31, dst0, dst1, dst2, dst3);
        __lasx_xvst(dst0, dst_argb, 0);
        __lasx_xvst(dst1, dst_argb, 32);
        __lasx_xvst(dst2, dst_argb, 64);
        __lasx_xvst(dst3, dst_argb, 96);
...
void RAWToARGBRow_LASX(const uint8_t* src_raw, uint8_t* dst_argb, int width)
{
    ...
    __m256i shuf1 = { 0x1F1E1D1C1B1A1918, 0x0706050403020100, 0x1F1E1D1C1B1A1918, 0x0706050403020100 };
    __m256i shuf2 = { 0x0B0A090807060504, 0x131211100F0E0D0C, 0x0B0A090807060504, 0x131211100F0E0D0C };
    __m256i shuf3 = { 0x1003040510000102, 0x10090A0B10060708, 0x1003040510000102, 0x10090A0B10060708 };
...
void ARGB1555ToUVRow_LASX(const uint8_t* src_argb1555, int src_stride_argb1555, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    __m256i const_8080 = { 0x8080808080808080, 0x8080808080808080, 0x8080808080808080, 0x8080808080808080 };

    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_argb1555, 0, src_argb1555, 32, next_argb1555, 0, next_argb1555, 32, src0, src1, src2, src3);
...
void RGB565ToUVRow_LASX(const uint8_t* src_rgb565, int src_stride_rgb565, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_rgb565, 0, src_rgb565, 32, next_rgb565, 0, next_rgb565, 32, src0, src1, src2, src3);
        DUP2_ARG2(__lasx_xvpickev_b, src1, src0, src3, src2, tmp0, tmp2);
        DUP2_ARG2(__lasx_xvpickod_b, src1, src0, src3, src2, tmp1, tmp3);
        tmpb = __lasx_xvandi_b(tmp0, 0x1F);
        tmpr = __lasx_xvandi_b(tmp1, 0xF8);
...
void RGB24ToYRow_LASX(const uint8_t* src_rgb24, uint8_t* dst_y, int width)
{
    ...
    __m256i reg0, reg1, reg2, dst0;
    __m256i const_129 = __lasx_xvldi(129);
    __m256i const_br = { 0x4219421942194219, 0x4219421942194219, 0x4219421942194219, 0x4219421942194219 };
    __m256i const_1080 = { 0x1080108010801080, 0x1080108010801080, 0x1080108010801080, 0x1080108010801080 };
    __m256i shuff0 = { 0x0B09080605030200, 0x17151412110F0E0C, 0x0B09080605030200, 0x17151412110F0E0C };
    __m256i shuff1 = { 0x0301001E1D1B1A18, 0x0F0D0C0A09070604, 0x0301001E1D1B1A18, 0x0F0D0C0A09070604 };
    __m256i shuff2 = { 0x000A000700040001, 0x001600130010000D, 0x000A000700040001, 0x001600130010000D };
    __m256i shuff3 = { 0x0002001F001C0019, 0x000E000B00080005, 0x0002001F001C0019, 0x000E000B00080005 };
...
void RGB24ToUVRow_LASX(const uint8_t* src_rgb24, int src_stride_rgb24, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    __m256i const_18 = __lasx_xvldi(0x409);
    __m256i const_8080 = { 0x8080808080808080, 0x8080808080808080, 0x8080808080808080, 0x8080808080808080 };
    __m256i shuff0_b = { 0x15120F0C09060300, 0x00000000001E1B18, 0x15120F0C09060300, 0x00000000001E1B18 };
    __m256i shuff1_b = { 0x0706050403020100, 0x1D1A1714110A0908, 0x0706050403020100, 0x1D1A1714110A0908 };
    __m256i shuff0_g = { 0x1613100D0A070401, 0x00000000001F1C19, 0x1613100D0A070401, 0x00000000001F1C19 };
    __m256i shuff1_g = { 0x0706050403020100, 0x1E1B1815120A0908, 0x0706050403020100, 0x1E1B1815120A0908 };
    __m256i shuff0_r = { 0x1714110E0B080502, 0x0000000000001D1A, 0x1714110E0B080502, 0x0000000000001D1A };
    __m256i shuff1_r = { 0x0706050403020100, 0x1F1C191613100908, 0x0706050403020100, 0x1F1C191613100908 };

    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_rgb24, 0, src_rgb24, 32, src_rgb24, 64, next_rgb24, 0, reg0, reg1, reg2, tmp0);
        DUP2_ARG2(__lasx_xvld, next_rgb24, 32, next_rgb24, 64, tmp1, tmp2);
        DUP4_ARG3(__lasx_xvpermi_q, reg1, reg0, 0x30, reg2, reg0, 0x21, reg2, reg1, 0x30, tmp1, tmp0, 0x30, src0, src1, src2, nex0);
        DUP2_ARG3(__lasx_xvpermi_q, tmp2, tmp0, 0x21, tmp2, tmp1, 0x30, nex1, nex2);
        DUP2_ARG3(__lasx_xvshuf_b, src1, src0, shuff0_b, nex1, nex0, shuff0_b, tmpb, nexb);
        DUP2_ARG3(__lasx_xvshuf_b, src1, src0, shuff0_g, nex1, nex0, shuff0_g, tmpg, nexg);
        DUP2_ARG3(__lasx_xvshuf_b, src1, src0, shuff0_r, nex1, nex0, shuff0_r, tmpr, nexr);
        DUP2_ARG3(__lasx_xvshuf_b, src2, tmpb, shuff1_b, nex2, nexb, shuff1_b, tmpb, nexb);
        DUP2_ARG3(__lasx_xvshuf_b, src2, tmpg, shuff1_g, nex2, nexg, shuff1_g, tmpg, nexg);
        DUP2_ARG3(__lasx_xvshuf_b, src2, tmpr, shuff1_r, nex2, nexr, shuff1_r, tmpr, nexr);
        RGBTOUV(tmpb, tmpg, tmpr, nexb, nexg, nexr, reg0, reg1);
        dst0 = __lasx_xvpickod_b(reg1, reg0);
        __lasx_xvstelm_d(dst0, dst_u, 0, 0);
        __lasx_xvstelm_d(dst0, dst_v, 0, 1);
...
void RAWToYRow_LASX(const uint8_t* src_raw, uint8_t* dst_y, int width)
{
    ...
    __m256i reg0, reg1, reg2, dst0;
    __m256i const_129 = __lasx_xvldi(129);
    __m256i const_br = { 0x1942194219421942, 0x1942194219421942, 0x1942194219421942, 0x1942194219421942 };
    __m256i const_1080 = { 0x1080108010801080, 0x1080108010801080, 0x1080108010801080, 0x1080108010801080 };
    __m256i shuff0 = { 0x0B09080605030200, 0x17151412110F0E0C, 0x0B09080605030200, 0x17151412110F0E0C };
    __m256i shuff1 = { 0x0301001E1D1B1A18, 0x0F0D0C0A09070604, 0x0301001E1D1B1A18, 0x0F0D0C0A09070604 };
    __m256i shuff2 = { 0x000A000700040001, 0x001600130010000D, 0x000A000700040001, 0x001600130010000D };
...
void RAWToUVRow_LASX(const uint8_t* src_raw, int src_stride_raw, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    __m256i const_18 = __lasx_xvldi(0x409);
    __m256i const_8080 = { 0x8080808080808080, 0x8080808080808080, 0x8080808080808080, 0x8080808080808080 };
    __m256i shuff0_r = { 0x15120F0C09060300, 0x00000000001E1B18, 0x15120F0C09060300, 0x00000000001E1B18 };
    __m256i shuff1_r = { 0x0706050403020100, 0x1D1A1714110A0908, 0x0706050403020100, 0x1D1A1714110A0908 };
    __m256i shuff0_g = { 0x1613100D0A070401, 0x00000000001F1C19, 0x1613100D0A070401, 0x00000000001F1C19 };
    __m256i shuff1_g = { 0x0706050403020100, 0x1E1B1815120A0908, 0x0706050403020100, 0x1E1B1815120A0908 };
    __m256i shuff0_b = { 0x1714110E0B080502, 0x0000000000001D1A, 0x1714110E0B080502, 0x0000000000001D1A };
    __m256i shuff1_b = { 0x0706050403020100, 0x1F1C191613100908, 0x0706050403020100, 0x1F1C191613100908 };

    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_raw, 0, src_raw, 32, src_raw, 64, next_raw, 0, reg0, reg1, reg2, tmp0);
...
void NV12ToARGBRow_LASX(const uint8_t* src_y, const uint8_t* src_uv, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        YUVTORGB(vec_y, vec_vu, vec_vrub, vec_vgug, vec_yg, vec_yb, out_r, out_g, out_b);
...
void NV21ToARGBRow_LASX(const uint8_t* src_y, const uint8_t* src_uv, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    int x;
    int len = width / 16;
    __m256i vec_yg, vec_yb, vec_ub, vec_vr, vec_ug, vec_vg;
    ...
    for (x = 0; x < len; x++) {
        ...
        YUVTORGB(vec_y, vec_uv, vec_ubvr, vec_ugvg, vec_yg, vec_yb, out_b, out_g, out_r);
        STOREARGB(alpha, out_r, out_g, out_b, dst_argb);
        src_y += 16;
        src_uv += 16;
    }
...
void ARGBToYJRow_LASX(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    ...
    __m256i const_150 = __lasx_xvldi(0x96);
    __m256i const_br = { 0x4D1D4D1D4D1D4D1D, 0x4D1D4D1D4D1D4D1D, 0x4D1D4D1D4D1D4D1D, 0x4D1D4D1D4D1D4D1D };
    __m256i shuff = { 0x0000000400000000, 0x0000000500000001, 0x0000000600000002, 0x0000000700000003 };
...
void ARGBToUVJRow_LASX(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    __m256i const_8080 = { 0x8080808080808080, 0x8080808080808080, 0x8080808080808080, 0x8080808080808080 };
    __m256i shuff = { 0x1614060412100200, 0x1E1C0E0C1A180A08, 0x1715070513110301, 0x1F1D0F0D1B190B09 };

    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lasx_xvld, src_argb, 0, src_argb, 32, src_argb, 64, src_argb, 96, src0, src1, src2, src3);
        DUP4_ARG2(__lasx_xvld, next_argb, 0, next_argb, 32, next_argb, 64, next_argb, 96, nex0, nex1, nex2, nex3);
        tmp0 = __lasx_xvpickev_b(src1, src0);
        tmp1 = __lasx_xvpickod_b(src1, src0);
        tmp2 = __lasx_xvpickev_b(src3, src2);
        tmp3 = __lasx_xvpickod_b(src3, src2);
