...
#define LSX_ST_4(_dst0, _dst1, _dst2, _dst3, _dst, _stride, _stride2, _stride3, _stride4)                                                                      \
    {                                                                                                                                                          \
...
void TransposeWx16_C(const uint8_t* src, int src_stride, uint8_t* dst, int dst_stride, int width)
{
    ...
    TransposeWx8_C((src + 8 * src_stride), src_stride, (dst + 8), dst_stride, width);
}
...
{
    TransposeUVWx8_C(src, src_stride, dst_a, dst_stride_a, dst_b, dst_stride_b, width);
    TransposeUVWx8_C((src + 8 * src_stride), src_stride, (dst_a + 8), dst_stride_a, (dst_b + 8), dst_stride_b, width);
}
...
void TransposeWx16_LSX(const uint8_t* src, int src_stride, uint8_t* dst, int dst_stride, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        LSX_ST_4(dst0, dst1, dst2, dst3, dst, dst_stride, dst_stride2, dst_stride3, dst_stride4);
