...
void RGB24ToARGBRow_MMI(const uint8_t* src_rgb24, uint8_t* dst_argb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     : [src_ptr] "r"(src_rgb24), [dst_ptr] "r"(dst_argb), [width] "r"(width), [mask] "f"(mask)
                     : "memory");
}
...
void RAWToARGBRow_MMI(const uint8_t* src_raw, uint8_t* dst_argb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "bnez       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [dest] "=&f"(dest)
                     : [src_ptr] "r"(src_raw), [dst_ptr] "r"(dst_argb), [mask0] "f"(mask0), [mask1] "f"(mask1), [mask2] "f"(mask2), [width] "r"(width)
                     : "memory");
}
...
void RAWToRGB24Row_MMI(const uint8_t* src_raw, uint8_t* dst_rgb24, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "bgtz       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [ftmp0] "=&f"(ftmp[0]), [ftmp1] "=&f"(ftmp[1]), [ftmp2] "=&f"(ftmp[2]), [ftmp3] "=&f"(ftmp[3])
                     : [src_raw] "r"(src_raw), [dst_rgb24] "r"(dst_rgb24), [width] "r"(width), [mask0] "f"(mask0), [mask1] "f"(mask1), [zero] "f"(0x00),
                     [one] "f"(0x01), [two] "f"(0x02), [three] "f"(0x03)
                     : "memory");
}

void RGB565ToARGBRow_MMI(const uint8_t* src_rgb565, uint8_t* dst_argb, int width)
{
    uint64_t ftmp[5];
    ...
    __asm__ volatile("1:                                                      \n\t"
                     ...
                     "daddiu    %[width],      %[width],           -0x04      \n\t"
                     "bgtz      %[width],     1b                              \n\t"
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [b] "=&f"(ftmp[2]), [g] "=&f"(ftmp[3]), [r] "=&f"(ftmp[4])
                     : [src_rgb565] "r"(src_rgb565), [dst_argb] "r"(dst_argb), [width] "r"(width), [c0] "f"(c0), [c1] "f"(c1), [c2] "f"(c2), [eight] "f"(0x08),
                     [five] "f"(0x05), [three] "f"(0x03), [two] "f"(0x02), [four] "f"(0x04)
                     : "memory");
}

void ARGB1555ToARGBRow_MMI(const uint8_t* src_argb1555, uint8_t* dst_argb, int width)
{
    uint64_t ftmp[6];
    uint64_t c0 = 0x001f001f001f001f;
    uint64_t c1 = 0x00ff00ff00ff00ff;
    ...
    __asm__ volatile("1:                                                         \n\t"
                     ...
                     "daddiu    %[width],        %[width],            -0x04      \n\t"
                     "bgtz      %[width],        1b                              \n\t"
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [b] "=&f"(ftmp[2]), [g] "=&f"(ftmp[3]), [r] "=&f"(ftmp[4]), [a] "=&f"(ftmp[5])
                     : [src_argb1555] "r"(src_argb1555), [dst_argb] "r"(dst_argb), [width] "r"(width), [c0] "f"(c0), [c1] "f"(c1), [c2] "f"(c2), [c3] "f"(c3),
                     [c4] "f"(c4), [eight] "f"(0x08), [five] "f"(0x05), [three] "f"(0x03), [two] "f"(0x02), [seven] "f"(0x07)
                     : "memory");
}

void ARGB4444ToARGBRow_MMI(const uint8_t* src_argb4444, uint8_t* dst_argb, int width)
{
    uint64_t ftmp[6];
    ...
    __asm__ volatile(
        ...
        "bgtz      %[width],        1b                               \n\t"
        : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [b] "=&f"(ftmp[2]), [g] "=&f"(ftmp[3]), [r] "=&f"(ftmp[4]), [a] "=&f"(ftmp[5])
        : [src_argb4444] "r"(src_argb4444), [dst_argb] "r"(dst_argb), [width] "r"(width), [c0] "f"(c0), [c1] "f"(c1), [eight] "f"(0x08), [four] "f"(0x04)
        : "memory");
}
...
void ARGBToRAWRow_MMI(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddiu     %[width],        %[width],         -0x04          \n\t"
                     "bgtz       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [ftmp0] "=&f"(ftmp[0]), [ftmp1] "=&f"(ftmp[1]), [ftmp2] "=&f"(ftmp[2])
                     : [src_argb] "r"(src_argb), [dst_rgb] "r"(dst_rgb), [width] "r"(width), [mask0] "f"(mask0), [mask1] "f"(mask1), [zero] "f"(0x00),
...
void ARGBToRGB565Row_MMI(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddiu     %[width],        %[width],         -0x04          \n\t"
                     "bgtz       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [b] "=&f"(ftmp[0]), [g] "=&f"(ftmp[1]), [r] "=&f"(ftmp[2])
                     : [src_argb] "r"(src_argb), [dst_rgb] "r"(dst_rgb), [width] "r"(width), [zero] "f"(0x00), [two] "f"(0x02), [three] "f"(0x03),
                     [five] "f"(0x05), [eleven] "f"(0x0b)
                     : "memory");
}
...
void ARGBToRGB565DitherRow_MMI(const uint8_t* src_argb, uint8_t* dst_rgb, const uint32_t dither4, int width)
{
    uint64_t src0, src1;
    uint64_t ftmp[3];
    uint64_t c0 = 0x00ff00ff00ff00ff;

    __asm__ volatile("punpcklbh  %[dither],       %[dither],         %[zero]       \n\t"
                     "1:                                                           \n\t"
                     "gsldrc1    %[src0],         0x00(%[src_argb])                \n\t"
                     "gsldlc1    %[src0],         0x07(%[src_argb])                \n\t"
                     "gsldrc1    %[src1],         0x08(%[src_argb])                \n\t"
                     ...
                     "bgtz       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [b] "=&f"(ftmp[0]), [g] "=&f"(ftmp[1]), [r] "=&f"(ftmp[2])
                     : [src_argb] "r"(src_argb), [dst_rgb] "r"(dst_rgb), [width] "r"(width), [dither] "f"(dither4), [c0] "f"(c0), [zero] "f"(0x00),
                     [two] "f"(0x02), [three] "f"(0x03), [five] "f"(0x05), [eleven] "f"(0x0b)
                     : "memory");
}

void ARGBToARGB1555Row_MMI(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    uint64_t src0, src1;
    uint64_t ftmp[4];
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddiu     %[width],        %[width],         -0x04          \n\t"
                     "bgtz       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [b] "=&f"(ftmp[0]), [g] "=&f"(ftmp[1]), [r] "=&f"(ftmp[2]), [a] "=&f"(ftmp[3])
                     : [src_argb] "r"(src_argb), [dst_rgb] "r"(dst_rgb), [width] "r"(width), [zero] "f"(0x00), [three] "f"(0x03), [five] "f"(0x05),
                     [seven] "f"(0x07), [ten] "f"(0x0a), [fifteen] "f"(0x0f)
                     : "memory");
}

void ARGBToARGB4444Row_MMI(const uint8_t* src_argb, uint8_t* dst_rgb, int width)
{
    uint64_t src0, src1;
    uint64_t ftmp[4];
    ...
    __asm__ volatile(
        ...
        "bgtz       %[width],        1b                               \n\t"
        : [src0] "=&f"(src0), [src1] "=&f"(src1), [b] "=&f"(ftmp[0]), [g] "=&f"(ftmp[1]), [r] "=&f"(ftmp[2]), [a] "=&f"(ftmp[3])
        : [src_argb] "r"(src_argb), [dst_rgb] "r"(dst_rgb), [width] "r"(width), [zero] "f"(0x00), [four] "f"(0x04), [eight] "f"(0x08), [twelve] "f"(0x0c)
        : "memory");
}
...
void ARGBToYRow_MMI(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    ...
    __asm__ volatile(
        ...
        : [src_argb] "r"(src_argb), [dst_y] "r"(dst_y), [width] "r"(width), [mask] "f"(mask), [value] "f"(value), [eight] "f"(0x08), [zero] "f"(0x00)
        : "memory");
}

void ARGBToUVRow_MMI(const uint8_t* src_rgb, int src_stride_rgb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t src_rgb1;
    uint64_t ftmp[13];
    uint64_t tmp[1];
    ...
    __asm__ volatile("dli        %[tmp0],         0x0001000100010001                   \n\t"
                     "dmtc1      %[tmp0],         %[ftmp12]                            \n\t"
                     "1:                                                               \n\t"
                     ...
                     "bgtz       %[width],        1b                                   \n\t"
                     : [src_rgb1] "=&r"(src_rgb1), [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [src_lo] "=&f"(ftmp[2]), [src_hi] "=&f"(ftmp[3]),
                     [dest0_u] "=&f"(ftmp[4]), [dest0_v] "=&f"(ftmp[5]), [dest1_u] "=&f"(ftmp[6]), [dest1_v] "=&f"(ftmp[7]), [dest2_u] "=&f"(ftmp[8]),
                     [dest2_v] "=&f"(ftmp[9]), [dest3_u] "=&f"(ftmp[10]), [dest3_v] "=&f"(ftmp[11]), [ftmp12] "=&f"(ftmp[12]), [tmp0] "=&r"(tmp[0])
                     : [src_rgb] "r"(src_rgb), [src_stride_rgb] "r"(src_stride_rgb), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width),
                     [mask_u] "f"(mask_u), [mask_v] "f"(mask_v), [value] "f"(value), [zero] "f"(0x00), [eight] "f"(0x08), [one] "f"(0x01), [sixteen] "f"(0x10)
                     : "memory");
}
...
void BGRAToUVRow_MMI(const uint8_t* src_rgb, int src_stride_rgb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t src_rgb1;
    uint64_t ftmp[13];
    uint64_t tmp[1];
...
void ABGRToUVRow_MMI(const uint8_t* src_rgb, int src_stride_rgb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t src_rgb1;
    uint64_t ftmp[13];
    uint64_t tmp[1];
...
void RGBAToUVRow_MMI(const uint8_t* src_rgb, int src_stride_rgb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t src_rgb1;
    uint64_t ftmp[13];
    uint64_t tmp[1];
...
void RGB24ToUVRow_MMI(const uint8_t* src_rgb, int src_stride_rgb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t src_rgb1;
    uint64_t ftmp[13];
    uint64_t tmp[1];
...
void RAWToUVRow_MMI(const uint8_t* src_rgb, int src_stride_rgb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t src_rgb1;
    uint64_t ftmp[13];
    uint64_t tmp[1];
...
void ARGBToYJRow_MMI(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    ...
    __asm__ volatile(
        ...
        "daddi      %[width],        %[width],         -0x08          \n\t"
        "bnez       %[width],        1b                               \n\t"
        : [src] "=&f"(src), [dest] "=&f"(dest), [src_hi] "=&f"(src_hi), [src_lo] "=&f"(src_lo), [dest0] "=&f"(dest0), [dest1] "=&f"(dest1),
        [dest2] "=&f"(dest2), [dest3] "=&f"(dest3), [tmp0] "=&f"(tmp0), [tmp1] "=&f"(tmp1)
        : [src_ptr] "r"(src_argb), [dst_ptr] "r"(dst_y), [mask0] "f"(mask0), [mask1] "f"(mask1), [shift] "f"(shift), [value] "f"(value), [width] "r"(width)
        : "memory");
}

void ARGBToUVJRow_MMI(const uint8_t* src_rgb, int src_stride_rgb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t src_rgb1;
    uint64_t ftmp[12];
    const uint64_t value = 0x4040;
    ...
    __asm__ volatile("1:                                                               \n\t"
                     ...
                     : [src_rgb1] "=&r"(src_rgb1), [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [src_lo] "=&f"(ftmp[2]), [src_hi] "=&f"(ftmp[3]),
                     [dest0_u] "=&f"(ftmp[4]), [dest0_v] "=&f"(ftmp[5]), [dest1_u] "=&f"(ftmp[6]), [dest1_v] "=&f"(ftmp[7]), [dest2_u] "=&f"(ftmp[8]),
                     [dest2_v] "=&f"(ftmp[9]), [dest3_u] "=&f"(ftmp[10]), [dest3_v] "=&f"(ftmp[11])
                     : [src_rgb] "r"(src_rgb), [src_stride_rgb] "r"(src_stride_rgb), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width),
                     [mask_u] "f"(mask_u), [mask_v] "f"(mask_v), [value] "f"(value), [zero] "f"(0x00), [eight] "f"(0x08), [sixteen] "f"(0x10)
                     : "memory");
}
...
void RGB565ToYRow_MMI(const uint8_t* src_rgb565, uint8_t* dst_y, int width)
{
    ...
    __asm__ volatile("1:                                                            \n\t"
                     ...
                     "bgtz      %[width],        1b                                 \n\t"
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [src_lo] "=&f"(ftmp[2]), [src_hi] "=&f"(ftmp[3]), [b] "=&f"(ftmp[4]), [g] "=&f"(ftmp[5]),
                     [r] "=&f"(ftmp[6]), [dest0] "=&f"(ftmp[7]), [dest1] "=&f"(ftmp[8]), [dest2] "=&f"(ftmp[9]), [dest3] "=&f"(ftmp[10])
                     : [src_rgb565] "r"(src_rgb565), [dst_y] "r"(dst_y), [value] "f"(value), [width] "r"(width), [c0] "f"(c0), [c1] "f"(c1), [c2] "f"(c2),
                     [mask] "f"(mask), [eight] "f"(0x08), [five] "f"(0x05), [three] "f"(0x03), [two] "f"(0x02), [four] "f"(0x04)
                     : "memory");
}
...
void ARGB1555ToYRow_MMI(const uint8_t* src_argb1555, uint8_t* dst_y, int width)
{
    ...
    __asm__ volatile("1:                                                            \n\t"
                     ...
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [src_lo] "=&f"(ftmp[2]), [src_hi] "=&f"(ftmp[3]), [b] "=&f"(ftmp[4]), [g] "=&f"(ftmp[5]),
                     [r] "=&f"(ftmp[6]), [dest0] "=&f"(ftmp[7]), [dest1] "=&f"(ftmp[8]), [dest2] "=&f"(ftmp[9]), [dest3] "=&f"(ftmp[10])
                     : [src_argb1555] "r"(src_argb1555), [dst_y] "r"(dst_y), [width] "r"(width), [value] "f"(value), [mask] "f"(mask), [c0] "f"(c0),
                     [c1] "f"(c1), [c2] "f"(c2), [c3] "f"(c3), [eight] "f"(0x08), [five] "f"(0x05), [three] "f"(0x03), [two] "f"(0x02), [seven] "f"(0x07)
                     : "memory");
}
...
void ARGB4444ToYRow_MMI(const uint8_t* src_argb4444, uint8_t* dst_y, int width)
{
    ...
    __asm__ volatile("1:                                                            \n\t"
                     ...
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [src_lo] "=&f"(ftmp[2]), [src_hi] "=&f"(ftmp[3]), [b] "=&f"(ftmp[4]), [g] "=&f"(ftmp[5]),
                     [r] "=&f"(ftmp[6]), [dest0] "=&f"(ftmp[7]), [dest1] "=&f"(ftmp[8]), [dest2] "=&f"(ftmp[9]), [dest3] "=&f"(ftmp[10])
                     : [src_argb4444] "r"(src_argb4444), [dst_y] "r"(dst_y), [width] "r"(width), [value] "f"(value), [mask] "f"(mask), [c0] "f"(c0),
                     [c1] "f"(c1), [eight] "f"(0x08), [four] "f"(0x04)
                     : "memory");
}

void RGB565ToUVRow_MMI(const uint8_t* src_rgb565, int src_stride_rgb565, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t ftmp[13];
    ...
    uint64_t c1 = 0x00ff00ff00ff00ff;
    uint64_t c2 = 0x0007000700070007;
    __asm__ volatile("daddu      %[next_rgb565], %[src_rgb565],       %[next_rgb565]   \n\t"
                     "1:                                                               \n\t"
                     "gsldrc1    %[src0],        0x00(%[src_rgb565])                   \n\t"
                     "gsldlc1    %[src0],        0x07(%[src_rgb565])                   \n\t"
                     ...
                     "bgtz      %[width],        1b                                    \n\t"
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [b0] "=&f"(ftmp[2]), [g0] "=&f"(ftmp[3]), [r0] "=&f"(ftmp[4]), [dest0_u] "=&f"(ftmp[5]),
                     [dest1_u] "=&f"(ftmp[6]), [dest2_u] "=&f"(ftmp[7]), [dest3_u] "=&f"(ftmp[8]), [dest0_v] "=&f"(ftmp[9]), [dest1_v] "=&f"(ftmp[10]),
                     [dest2_v] "=&f"(ftmp[11]), [dest3_v] "=&f"(ftmp[12])
                     : [src_rgb565] "r"(src_rgb565), [next_rgb565] "r"(src_stride_rgb565), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width),
                     [value] "f"(value), [c0] "f"(c0), [c1] "f"(c1), [c2] "f"(c2), [mask] "f"(mask), [mask_u] "f"(mask_u), [mask_v] "f"(mask_v),
                     [eight] "f"(0x08), [six] "f"(0x06), [five] "f"(0x05), [three] "f"(0x03), [one] "f"(0x01)
                     : "memory");
}

void ARGB1555ToUVRow_MMI(const uint8_t* src_argb1555, int src_stride_argb1555, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t ftmp[11];
    uint64_t value = 0x2020202020202020;
    uint64_t mask_u = 0x0026004a00700002;
    ...
    uint64_t c2 = 0x0003000300030003;
    uint64_t c3 = 0x007c007c007c007c;
    __asm__ volatile("daddu      %[next_argb1555], %[src_argb1555],      %[next_argb1555] \n\t"
                     "1:                                                                  \n\t"
                     "gsldrc1    %[src0],          0x00(%[src_argb1555])                  \n\t"
                     "gsldlc1    %[src0],          0x07(%[src_argb1555])                  \n\t"
                     ...
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [b0] "=&f"(ftmp[2]), [g0] "=&f"(ftmp[3]), [r0] "=&f"(ftmp[4]), [dest0_u] "=&f"(ftmp[5]),
                     [dest1_u] "=&f"(ftmp[6]), [dest2_u] "=&f"(ftmp[7]), [dest3_u] "=&f"(ftmp[8]), [dest0_v] "=&f"(ftmp[9]), [dest1_v] "=&f"(ftmp[10])
                     : [src_argb1555] "r"(src_argb1555), [next_argb1555] "r"(src_stride_argb1555), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width),
                     [value] "f"(value), [c0] "f"(c0), [c1] "f"(c1), [c2] "f"(c2), [c3] "f"(c3), [mask] "f"(mask), [mask_u] "f"(mask_u), [mask_v] "f"(mask_v),
                     [eight] "f"(0x08), [six] "f"(0x06), [five] "f"(0x05), [three] "f"(0x03), [two] "f"(0x02), [one] "f"(0x01)
                     : "memory");
}

void ARGB4444ToUVRow_MMI(const uint8_t* src_argb4444, int src_stride_argb4444, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t ftmp[13];
    uint64_t value = 0x2020202020202020;
    uint64_t mask_u = 0x0026004a00700002;
    ...
    uint64_t c0 = 0x000f000f000f000f;
    uint64_t c1 = 0x00ff00ff00ff00ff;
    __asm__ volatile("daddu      %[next_argb4444], %[src_argb4444],      %[next_argb4444] \n\t"
                     "1:                                                                  \n\t"
                     "gsldrc1    %[src0],          0x00(%[src_argb4444])                  \n\t"
                     "gsldlc1    %[src0],          0x07(%[src_argb4444])                  \n\t"
                     ...
                     [dest1_u] "=&f"(ftmp[6]), [dest2_u] "=&f"(ftmp[7]), [dest3_u] "=&f"(ftmp[8]), [dest0_v] "=&f"(ftmp[9]), [dest1_v] "=&f"(ftmp[10]),
                     [dest2_v] "=&f"(ftmp[11]), [dest3_v] "=&f"(ftmp[12])
                     : [src_argb4444] "r"(src_argb4444), [next_argb4444] "r"(src_stride_argb4444), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width),
                     [value] "f"(value), [c0] "f"(c0), [c1] "f"(c1), [mask] "f"(mask), [mask_u] "f"(mask_u), [mask_v] "f"(mask_v), [eight] "f"(0x08),
                     [four] "f"(0x04), [two] "f"(0x02)
                     : "memory");
}

void ARGBToUV444Row_MMI(const uint8_t* src_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t ftmp[12];
    const uint64_t value = 0x4040;
    ...
    __asm__ volatile("1:                                                               \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x08              \n\t"
                     "bgtz       %[width],        1b                                   \n\t"
                     : [src0] "=&f"(ftmp[0]), [src1] "=&f"(ftmp[1]), [src_lo] "=&f"(ftmp[2]), [src_hi] "=&f"(ftmp[3]), [dest0_u] "=&f"(ftmp[4]),
                     [dest0_v] "=&f"(ftmp[5]), [dest1_u] "=&f"(ftmp[6]), [dest1_v] "=&f"(ftmp[7]), [dest2_u] "=&f"(ftmp[8]), [dest2_v] "=&f"(ftmp[9]),
                     [dest3_u] "=&f"(ftmp[10]), [dest3_v] "=&f"(ftmp[11])
                     : [src_argb] "r"(src_argb), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width), [mask_u] "f"(mask_u), [mask_v] "f"(mask_v),
                     [value] "f"(value), [zero] "f"(0x00), [sixteen] "f"(0x10), [eight] "f"(0x08)
                     : "memory");
}
...
void ARGBGrayRow_MMI(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "bnez       %[width],        1b                               \n\t"
                     : [dest_hi] "=&f"(dest_hi), [dest_lo] "=&f"(dest_lo), [src_hi] "=&f"(src_hi), [src_lo] "=&f"(src_lo), [tmp0] "=&f"(tmp0),
                     [tmp1] "=&f"(tmp1), [src] "=&f"(src), [dest] "=&f"(dest), [src37] "=&f"(src37)
                     : [src_ptr] "r"(src_argb), [dst_ptr] "r"(dst_argb), [width] "r"(width), [shift] "f"(shift), [mask0] "f"(mask0), [mask1] "f"(mask1),
...
void ARGBSepiaRow_MMI(uint8_t* dst_argb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x02          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [dest_hi] "=&f"(dest_hi), [dest_lo] "=&f"(dest_lo), [dest0] "=&f"(dest0), [dest1] "=&f"(dest1), [dest2] "=&f"(dest2),
                     [dest37] "=&f"(dest37), [tmp0] "=&f"(tmp0), [tmp1] "=&f"(tmp1), [dest] "=&f"(dest)
                     : [dst_ptr] "r"(dst_argb), [width] "r"(width), [mask0] "f"(mask0), [mask1] "f"(mask1), [mask2] "f"(mask2), [mask3] "f"(mask3),
...
void ARGBColorMatrixRow_MMI(const uint8_t* src_argb, uint8_t* dst_argb, const int8_t* matrix_argb, int width)
{
    uint64_t src, src_hi, src_lo, dest, dest_lo, dest_hi, dest0, dest1, dest2, dest3;
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x02          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src_hi] "=&f"(src_hi), [src_lo] "=&f"(src_lo), [dest_hi] "=&f"(dest_hi), [dest_lo] "=&f"(dest_lo), [dest0] "=&f"(dest0),
                     [dest1] "=&f"(dest1), [dest2] "=&f"(dest2), [dest3] "=&f"(dest3), [src] "=&f"(src), [dest] "=&f"(dest), [tmp0] "=&f"(tmp0),
                     [tmp1] "=&f"(tmp1), [matrix_hi] "=&f"(matrix_hi), [matrix_lo] "=&f"(matrix_lo), [matrix] "=&f"(matrix)
                     : [src_ptr] "r"(src_argb), [matrix_ptr] "r"(matrix_argb), [dst_ptr] "r"(dst_argb), [width] "r"(width), [shift0] "f"(shift0),
                     [shift1] "f"(shift1), [mask0] "f"(mask0), [mask1] "f"(mask1)
                     : "memory");
}

void ARGBShadeRow_MMI(const uint8_t* src_argb, uint8_t* dst_argb, int width, uint32_t value)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x02          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src_hi] "=&f"(src_hi), [src_lo] "=&f"(src_lo), [dest_hi] "=&f"(dest_hi), [dest_lo] "=&f"(dest_lo), [src] "=&f"(src), [dest] "=&f"(dest)
                     : [src_ptr] "r"(src_argb), [dst_ptr] "r"(dst_argb), [width] "r"(width), [value] "f"(value), [shift] "f"(shift)
                     : "memory");
}

void ARGBMultiplyRow_MMI(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x02          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src0_hi] "=&f"(src0_hi), [src0_lo] "=&f"(src0_lo), [src1_hi] "=&f"(src1_hi), [src1_lo] "=&f"(src1_lo), [dest_hi] "=&f"(dest_hi),
                     [dest_lo] "=&f"(dest_lo), [src0] "=&f"(src0), [src1] "=&f"(src1), [dest] "=&f"(dest)
                     : [src0_ptr] "r"(src_argb), [src1_ptr] "r"(src_argb1), [dst_ptr] "r"(dst_argb), [width] "r"(width), [mask] "f"(mask)
                     : "memory");
}

void ARGBAddRow_MMI(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    uint64_t src0, src1, dest;
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "bnez       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [dest] "=&f"(dest)
                     : [src0_ptr] "r"(src_argb), [src1_ptr] "r"(src_argb1), [dst_ptr] "r"(dst_argb), [width] "r"(width)
                     : "memory");
}

void ARGBSubtractRow_MMI(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    uint64_t src0, src1, dest;
...
void SobelXRow_MMI(const uint8_t* src_y0, const uint8_t* src_y1, const uint8_t* src_y2, uint8_t* dst_sobelx, int width)
{
    ...
    __asm__ volatile("1:	                                         \n\t"
                     ...
                     "bgtz      %[width],      1b                       \n\t"
                     "nop                                               \n\t"
                     : [sobel] "=&f"(sobel), [y00] "=&f"(y00), [y10] "=&f"(y10), [y20] "=&f"(y20), [y02] "=&f"(y02), [y12] "=&f"(y12), [y22] "=&f"(y22)
                     : [src_y0] "r"(src_y0), [src_y1] "r"(src_y1), [src_y2] "r"(src_y2), [dst_sobelx] "r"(dst_sobelx), [width] "r"(width), [zero] "f"(zero)
                     : "memory");
}

void SobelYRow_MMI(const uint8_t* src_y0, const uint8_t* src_y1, uint8_t* dst_sobely, int width)
{
    ...
    __asm__ volatile("1:	                                        \n\t"
                     ...
                     "bgtz      %[width],      1b                      \n\t"
                     "nop                                              \n\t"
                     : [sobel] "=&f"(sobel), [y00] "=&f"(y00), [y01] "=&f"(y01), [y02] "=&f"(y02), [y10] "=&f"(y10), [y11] "=&f"(y11), [y12] "=&f"(y12)
                     : [src_y0] "r"(src_y0), [src_y1] "r"(src_y1), [dst_sobely] "r"(dst_sobely), [width] "r"(width), [zero] "f"(zero)
                     : "memory");
}

void SobelRow_MMI(const uint8_t* src_sobelx, const uint8_t* src_sobely, uint8_t* dst_argb, int width)
{
    double temp[3];
    ...
    __asm__ volatile("1:	                                          \n\t"
                     ...
                     : [src_sobelx] "r"(src_sobelx), [src_sobely] "r"(src_sobely), [dst_argb] "r"(dst_argb), [width] "r"(width), [c1] "f"(c1)
                     : "memory");
}

void SobelToPlaneRow_MMI(const uint8_t* src_sobelx, const uint8_t* src_sobely, uint8_t* dst_y, int width)
{
    uint64_t tr = 0;
    uint64_t tb = 0;
    __asm__ volatile("1:	                                       \n\t"
                     ...
                     "nop                                             \n\t"
                     : [tr] "=&f"(tr), [tb] "=&f"(tb)
                     : [src_sobelx] "r"(src_sobelx), [src_sobely] "r"(src_sobely), [dst_y] "r"(dst_y), [width] "r"(width)
                     : "memory");
}

void SobelXYRow_MMI(const uint8_t* src_sobelx, const uint8_t* src_sobely, uint8_t* dst_argb, int width)
{
    uint64_t temp[3];
    uint64_t result = 0;
    uint64_t gb = 0;
    ...
    __asm__ volatile("1:	                                          \n\t"
                     ...
                     "bgtz      %[width],      1b                        \n\t"
                     "nop                                                \n\t"
                     : [tr] "=&f"(temp[0]), [tb] "=&f"(temp[1]), [tg] "=&f"(temp[2]), [gb] "=&f"(gb), [cr] "=&f"(cr), [result] "=&f"(result)
                     : [src_sobelx] "r"(src_sobelx), [src_sobely] "r"(src_sobely), [dst_argb] "r"(dst_argb), [width] "r"(width), [c1] "f"(c1)
                     : "memory");
}
...
void J400ToARGBRow_MMI(const uint8_t* src_y, uint8_t* dst_argb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     : [src_ptr] "r"(src_y), [dst_ptr] "r"(dst_argb), [mask0] "f"(mask0), [mask1] "f"(mask1), [width] "r"(width)
                     : "memory");
}

// TODO - respect YuvConstants
void I400ToARGBRow_MMI(const uint8_t* src_y, uint8_t* rgb_buf, const struct YuvConstants*, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x08          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src] "=&f"(src), [dest] "=&f"(dest), [src_hi] "=&f"(src_hi), [src_lo] "=&f"(src_lo), [dest_hi] "=&f"(dest_hi), [dest_lo] "=&f"(dest_lo)
                     : [src_ptr] "r"(src_y), [dst_ptr] "r"(rgb_buf), [mask0] "f"(mask0), [mask1] "f"(mask1), [mask2] "f"(mask2), [mask3] "f"(mask3),
                     [mask4] "f"(mask4), [mask5] "f"(mask5), [shift0] "f"(shift0), [shift1] "f"(shift1), [width] "r"(width)
                     : "memory");
}
...
void MirrorRow_MMI(const uint8_t* src, uint8_t* dst, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x08          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [source] "=&f"(source), [dest] "=&f"(dest), [src0] "=&f"(src0), [src1] "=&f"(src1)
                     : [src_ptr] "r"(src), [dst_ptr] "r"(dst), [mask0] "f"(mask0), [mask1] "f"(mask1), [width] "r"(width)
                     : "memory");
}

void MirrorSplitUVRow_MMI(const uint8_t* src_uv, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    __asm__ volatile(
        ...
        "daddi      %[width],        %[width],         -0x08          \n\t"
        "bnez       %[width],        1b                               \n\t"
        : [dest0] "=&f"(dest0), [dest1] "=&f"(dest1), [src0] "=&f"(src0), [src1] "=&f"(src1)
        : [src_ptr] "r"(src_uv), [dstu_ptr] "r"(dst_u), [dstv_ptr] "r"(dst_v), [width] "r"(width), [mask0] "f"(mask0), [mask1] "f"(mask1), [shift] "f"(shift)
        : "memory");
}
...
void SplitUVRow_MMI(const uint8_t* src_uv, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t c0 = 0x00ff00ff00ff00ff;
    uint64_t temp[4];
    uint64_t shift = 0x08;
    __asm__ volatile("1:	                                    \n\t"
                     ...
                     "bgtz     %[width],  1b                       \n\t"
                     "nop                                          \n\t"
                     : [t0] "=&f"(temp[0]), [t1] "=&f"(temp[1]), [t2] "=&f"(temp[2]), [t3] "=&f"(temp[3])
                     : [src_uv] "r"(src_uv), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width), [c0] "f"(c0), [shift] "f"(shift)
                     : "memory");
}

void MergeUVRow_MMI(const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_uv, int width)
{
    uint64_t temp[3];
    __asm__ volatile("1:	                                 \n\t"
                     ...
                     "nop                                       \n\t"
                     : [t0] "=&f"(temp[0]), [t1] "=&f"(temp[1]), [t2] "=&f"(temp[2])
                     : [dst_uv] "r"(dst_uv), [src_u] "r"(src_u), [src_v] "r"(src_v), [width] "r"(width)
                     : "memory");
}

void SplitRGBRow_MMI(const uint8_t* src_rgb, uint8_t* dst_r, uint8_t* dst_g, uint8_t* dst_b, int width)
{
    uint64_t src[4];
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x04          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src[0]), [src1] "=&f"(src[1]), [src2] "=&f"(src[2]), [src3] "=&f"(src[3]), [dest_hi] "=&f"(dest_hi),
                     [dest_lo] "=&f"(dest_lo), [dest] "=&f"(dest)
                     : [src_ptr] "r"(src_rgb), [dstr_ptr] "r"(dst_r), [dstg_ptr] "r"(dst_g), [dstb_ptr] "r"(dst_b), [width] "r"(width)
                     : "memory");
}

void MergeRGBRow_MMI(const uint8_t* src_r, const uint8_t* src_g, const uint8_t* src_b, uint8_t* dst_rgb, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x08          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [srcr] "=&f"(srcr), [srcg] "=&f"(srcg), [srcb] "=&f"(srcb), [dest] "=&f"(dest), [srcrg_hi] "=&f"(srcrg_hi), [srcrg_lo] "=&f"(srcrg_lo),
                     [srcbz_hi] "=&f"(srcbz_hi), [srcbz_lo] "=&f"(srcbz_lo)
                     : [srcr_ptr] "r"(src_r), [srcg_ptr] "r"(src_g), [srcb_ptr] "r"(src_b), [dst_ptr] "r"(dst_rgb), [width] "r"(width), [temp] "f"(temp)
                     : "memory");
}

// Filter 2 rows of YUY2 UV's (422) into U and V (420).
void YUY2ToUVRow_MMI(const uint8_t* src_yuy2, int src_stride_yuy2, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    __asm__ volatile("1:	                                                     \n\t"
                     ...
                     "bgtz     %[width],      1b                                    \n\t"
                     "nop                                                           \n\t"
                     : [t0] "=&f"(temp[0]), [t1] "=&f"(temp[1]), [t2] "=&f"(temp[2]), [d0] "=&f"(data[0]), [d1] "=&f"(data[1]), [d2] "=&f"(data[2]),
                     [d3] "=&f"(data[3]), [src_stride] "=&r"(src_stride)
                     : [src_yuy2] "r"(src_yuy2), [src_stride_yuy2] "r"(src_stride_yuy2), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width),
                     [c0] "f"(c0), [c1] "f"(c1), [shift] "f"(shift)
                     : "memory");
}

// Copy row of YUY2 UV's (422) into U and V (422).
void YUY2ToUV422Row_MMI(const uint8_t* src_yuy2, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    uint64_t c0 = 0xff00ff00ff00ff00;
    uint64_t c1 = 0x00ff00ff00ff00ff;
    uint64_t temp[2];
    ...
    __asm__ volatile("1:	                                        \n\t"
                     ...
                     "bgtz     %[width],    1b                         \n\t"
                     "nop                                              \n\t"
                     : [t0] "=&f"(temp[0]), [t1] "=&f"(temp[1]), [d0] "=&f"(data[0]), [d1] "=&f"(data[1]), [d2] "=&f"(data[2]), [d3] "=&f"(data[3])
                     : [src_yuy2] "r"(src_yuy2), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width), [c0] "f"(c0), [c1] "f"(c1), [shift] "f"(shift)
                     : "memory");
}
...
void YUY2ToYRow_MMI(const uint8_t* src_yuy2, uint8_t* dst_y, int width)
{
    ...
    __asm__ volatile("1:	                                     \n\t"
                     ...
                     : [src_yuy2] "r"(src_yuy2), [dst_y] "r"(dst_y), [width] "r"(width), [c0] "f"(c0)
                     : "memory");
}

// Filter 2 rows of UYVY UV's (422) into U and V (420).
void UYVYToUVRow_MMI(const uint8_t* src_uyvy, int src_stride_uyvy, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    __asm__ volatile("1:	                                                      \n\t"
                     ...
                     : [t0] "=&f"(temp[0]), [t1] "=&f"(temp[1]), [t2] "=&f"(temp[2]), [d0] "=&f"(data[0]), [d1] "=&f"(data[1]), [d2] "=&f"(data[2]),
                     [d3] "=&f"(data[3]), [src_stride] "=&r"(src_stride)
                     : [src_uyvy] "r"(src_uyvy), [src_stride_uyvy] "r"(src_stride_uyvy), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width),
                     [c0] "f"(c0), [shift] "f"(shift)
                     : "memory");
}

// Copy row of UYVY UV's (422) into U and V (422).
void UYVYToUV422Row_MMI(const uint8_t* src_uyvy, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    // Output a row of UV values.
    uint64_t c0 = 0x00ff00ff00ff00ff;
    uint64_t temp[2];
    ...
    __asm__ volatile("1:	                                        \n\t"
                     ...
                     "nop                                              \n\t"
                     : [t0] "=&f"(temp[0]), [t1] "=&f"(temp[1]), [d0] "=&f"(data[0]), [d1] "=&f"(data[1]), [d2] "=&f"(data[2]), [d3] "=&f"(data[3])
                     : [src_uyvy] "r"(src_uyvy), [dst_u] "r"(dst_u), [dst_v] "r"(dst_v), [width] "r"(width), [c0] "f"(c0), [shift] "f"(shift)
                     : "memory");
}
...
void UYVYToYRow_MMI(const uint8_t* src_uyvy, uint8_t* dst_y, int width)
{
    ...
    __asm__ volatile("1:	                                        \n\t"
                     ...
                     "nop                                              \n\t"
                     : [t0] "=&f"(temp[0]), [t1] "=&f"(temp[1])
                     : [src_uyvy] "r"(src_uyvy), [dst_y] "r"(dst_y), [width] "r"(width), [c0] "f"(c0), [shift] "f"(shift)
                     : "memory");
}
...
void ARGBBlendRow_MMI(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    uint64_t src0, src1, dest, alpha, src0_hi, src0_lo, src1_hi, src1_lo, dest_hi, dest_lo;
    const uint64_t mask0 = 0x0;
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x02          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src0] "=&f"(src0), [src1] "=&f"(src1), [alpha] "=&f"(alpha), [dest] "=&f"(dest), [src0_hi] "=&f"(src0_hi), [src0_lo] "=&f"(src0_lo),
                     [src1_hi] "=&f"(src1_hi), [src1_lo] "=&f"(src1_lo), [dest_hi] "=&f"(dest_hi), [dest_lo] "=&f"(dest_lo)
                     : [src0_ptr] "r"(src_argb), [src1_ptr] "r"(src_argb1), [dst_ptr] "r"(dst_argb), [mask0] "f"(mask0), [mask1] "f"(mask1), [mask2] "f"(mask2),
                     [mask3] "f"(mask3), [mask4] "f"(mask4), [shift] "f"(shift), [width] "r"(width)
                     : "memory");
}

void BlendPlaneRow_MMI(const uint8_t* src0, const uint8_t* src1, const uint8_t* alpha, uint8_t* dst, int width)
{
    uint64_t source0, source1, dest, alph;
    uint64_t src0_hi, src0_lo, src1_hi, src1_lo, alpha_hi, alpha_lo, dest_hi, dest_lo;
    ...
    __asm__ volatile(
        ...
        "daddi      %[width],        %[width],         -0x08          \n\t"
        "bnez       %[width],        1b                               \n\t"
        : [src0] "=&f"(source0), [src1] "=&f"(source1), [alpha] "=&f"(alph), [dest] "=&f"(dest), [src0_hi] "=&f"(src0_hi), [src0_lo] "=&f"(src0_lo),
        [src1_hi] "=&f"(src1_hi), [src1_lo] "=&f"(src1_lo), [alpha_hi] "=&f"(alpha_hi), [alpha_lo] "=&f"(alpha_lo), [dest_hi] "=&f"(dest_hi),
        [dest_lo] "=&f"(dest_lo), [alpha_rlo] "=&f"(alpha_rev_lo), [alpha_rhi] "=&f"(alpha_rev_hi), [alpha_r] "=&f"(alpha_rev)
        : [src0_ptr] "r"(src0), [src1_ptr] "r"(src1), [alpha_ptr] "r"(alpha), [dst_ptr] "r"(dst), [mask0] "f"(mask0), [mask1] "f"(mask1), [mask2] "f"(mask2),
...
// This code mimics the SSSE3 version for better testability.
void ARGBAttenuateRow_MMI(const uint8_t* src_argb, uint8_t* dst_argb, int width)
{
    ...
    __asm__ volatile(
        ...
        : [src] "=&f"(src), [dest] "=&f"(dest), [src_hi] "=&f"(src_hi), [src_lo] "=&f"(src_lo), [dest_hi] "=&f"(dest_hi), [dest_lo] "=&f"(dest_lo),
        [alpha] "=&f"(alpha)
        : [src_ptr] "r"(src_argb), [dst_ptr] "r"(dst_argb), [mask0] "f"(mask0), [mask1] "f"(mask1), [mask2] "f"(mask2), [shift] "f"(shift), [width] "r"(width)
        : "memory");
}

void ComputeCumulativeSumRow_MMI(const uint8_t* row, int32_t* cumsum, const int32_t* previous_cumsum, int width)
{
    int64_t row_sum[2] = { 0, 0 };
    uint64_t src, dest0, dest1, presrc0, presrc1, dest;
    const uint64_t mask = 0x0;

    __asm__ volatile("xor        %[row_sum0],     %[row_sum0],       %[row_sum0]   \n\t"
                     ...
                     "bnez       %[width],        1b                               \n\t"
                     : [src] "=&f"(src), [dest] "=&f"(dest), [dest0] "=&f"(dest0), [dest1] "=&f"(dest1), [row_sum0] "+&f"(row_sum[0]),
                     [row_sum1] "+&f"(row_sum[1]), [presrc0] "=&f"(presrc0), [presrc1] "=&f"(presrc1)
                     : [row_ptr] "r"(row), [pre_ptr] "r"(previous_cumsum), [dst_ptr] "r"(cumsum), [width] "r"(width), [mask] "f"(mask)
                     : "memory");
}

// C version 2x2 -> 2x1.
void InterpolateRow_MMI(uint8_t* dst_ptr, const uint8_t* src_ptr, ptrdiff_t src_stride, int width, int source_y_fraction)
{
    ...
    if (source_y_fraction == 128) {
        ...
        __asm__ volatile("1:	                                            \n\t"
                         ...
                         : [src_ptr] "r"(src_ptr), [dst_ptr] "r"(dst_ptr), [width] "r"(width), [stride] "r"((int64_t)src_stride)
                         : "memory");
        return;
    }
    ...
    uint64_t shift = 0x8;
    __asm__ volatile("pshufh    %[fy1],      %[fy1],          %[zero]  \n\t"
                     "psubh     %[fy0],      %[fy0],          %[fy1]   \n\t"
                     "1:	                                        \n\t"
                     ...
                     "bgtz      %[width],    1b                        \n\t"
                     "nop                                              \n\t"
                     : [t0] "=&f"(temp), [d0] "=&f"(data[0]), [d1] "=&f"(data[1]), [d2] "=&f"(data[2]), [d3] "=&f"(data[3])
                     : [src_ptr] "r"(src_ptr), [src_ptr1] "r"(src_ptr1), [dst_ptr] "r"(dst_ptr), [width] "r"(width), [fy1] "f"(source_y_fraction),
                     [fy0] "f"(fy0), [c0] "f"(c0), [shift] "f"(shift), [zero] "f"(zero)
                     : "memory");
}

// Use first 4 shuffler values to reorder ARGB channels.
void ARGBShuffleRow_MMI(const uint8_t* src_argb, uint8_t* dst_argb, const uint8_t* shuffler, int width)
{
    uint64_t source, dest0, dest1, dest;
    const uint64_t mask0 = 0x0;
    const uint64_t mask1 = (shuffler[0] & 0x03) | ((shuffler[1] & 0x03) << 2) | ((shuffler[2] & 0x03) << 4) | ((shuffler[3] & 0x03) << 6);
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x02          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src] "=&f"(source), [dest] "=&f"(dest), [dest0] "=&f"(dest0), [dest1] "=&f"(dest1)
                     : [src_ptr] "r"(src_argb), [dst_ptr] "r"(dst_argb), [mask0] "f"(mask0), [mask1] "f"(mask1), [width] "r"(width)
                     : "memory");
}

void I422ToYUY2Row_MMI(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_frame, int width)
{
    uint64_t temp[3];
    uint64_t vu = 0x0;
    __asm__ volatile("1:	                                        \n\t"
                     ...
                     "bgtz      %[width],     1b                       \n\t"
                     "nop                                              \n\t"
                     : [ty] "=&f"(temp[1]), [tu] "=&f"(temp[1]), [tv] "=&f"(temp[1]), [vu] "=&f"(vu)
                     : [src_y] "r"(src_y), [src_u] "r"(src_u), [src_v] "r"(src_v), [dst_frame] "r"(dst_frame), [width] "r"(width)
                     : "memory");
}

void I422ToUYVYRow_MMI(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_frame, int width)
{
    uint64_t temp[3];
    uint64_t vu = 0x0;
    __asm__ volatile("1:	                                        \n\t"
...
void ARGBExtractAlphaRow_MMI(const uint8_t* src_argb, uint8_t* dst_a, int width)
{
    ...
    __asm__ volatile("1:                                                           \n\t"
                     ...
                     "daddi      %[width],        %[width],         -0x08          \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [src] "=&f"(src), [dest] "=&f"(dest), [dest0] "=&f"(dest0), [dest1] "=&f"(dest1), [dest_lo] "=&f"(dest_lo), [dest_hi] "=&f"(dest_hi)
                     : [src_ptr] "r"(src_argb), [dst_ptr] "r"(dst_a), [mask] "f"(mask), [shift] "f"(shift), [width] "r"(width)
                     : "memory");
}
...
void I444ToARGBRow_MMI(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec[2], g_vec[2], r_vec[2];
    uint64_t mask = 0xff00ff00ff00ff00ULL;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t" // yg
                     ...
                     "daddi      %[width],        %[width],          -0x04         \n\t"
                     "bnez       %[width],        1b                               \n\t"
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec0] "=&f"(b_vec[0]), [b_vec1] "=&f"(b_vec[1]), [g_vec0] "=&f"(g_vec[0]),
                     [g_vec1] "=&f"(g_vec[1]), [r_vec0] "=&f"(r_vec[0]), [r_vec1] "=&f"(r_vec[1]), [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg),
                     [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants),
                     [width] "r"(width), [zero] "f"(0x00), [alpha] "f"(-1), [six] "f"(0x6), [five] "f"(0x55), [mask] "f"(mask)
                     : "memory");
}

// Also used for 420
void I422ToARGBRow_MMI(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec[2], g_vec[2], r_vec[2];
    uint64_t mask = 0xff00ff00ff00ff00ULL;
...
void I210ToARGBRow_MMI(
    const uint16_t* src_y, const uint16_t* src_u, const uint16_t* src_v, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec[2], g_vec[2], r_vec[2];
    uint64_t mask = 0xff00ff00ff00ff00ULL;
    ...
    __asm__ volatile(
        ...
        : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec0] "=&f"(b_vec[0]), [b_vec1] "=&f"(b_vec[1]), [g_vec0] "=&f"(g_vec[0]), [g_vec1] "=&f"(g_vec[1]),
        [r_vec0] "=&f"(r_vec[0]), [r_vec1] "=&f"(r_vec[1]), [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg),
        [br] "=&f"(br), [yg] "=&f"(yg)
        : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
        [zero] "f"(0x00), [alpha] "f"(-1), [six] "f"(0x6), [five] "f"(0x55), [mask] "f"(mask), [two] "f"(0x02), [mask1] "f"(0x00ff00ff00ff00ff)
        : "memory");
}

void I422AlphaToARGBRow_MMI(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, const uint8_t* src_a, uint8_t* rgb_buf,
    const struct YuvConstants* yuvconstants, int width)
{
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [a] "=&f"(a), [b_vec0] "=&f"(b_vec[0]), [b_vec1] "=&f"(b_vec[1]), [g_vec0] "=&f"(g_vec[0]),
                     [g_vec1] "=&f"(g_vec[1]), [r_vec0] "=&f"(r_vec[0]), [r_vec1] "=&f"(r_vec[1]), [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg),
                     [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants),
                     [width] "r"(width), [a_ptr] "r"(src_a), [zero] "f"(0x00), [six] "f"(0x6), [five] "f"(0x55), [mask] "f"(mask)
                     : "memory");
}

void I422ToRGB24Row_MMI(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec[2], g_vec[2], r_vec[2];
    uint64_t mask = 0xff00ff00ff00ff00ULL;
    ...
    __asm__ volatile(
        ...
        [br] "=&f"(br), [yg] "=&f"(yg)
        : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
        [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask] "f"(mask), [lmove1] "f"(0x18), [rmove1] "f"(0x8), [one] "f"(0x1)
        : "memory");
}
    ...
    const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb4444, const struct YuvConstants* yuvconstants, int width)
{
    ...
    __asm__ volatile(
        ...
        [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
        : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [dst_argb4444] "r"(dst_argb4444), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
        [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask] "f"(0xff00ff00ff00ff00), [four] "f"(0x4), [mask1] "f"(0xf0f0f0f0f0f0f0f0), [alpha] "f"(-1)
        : "memory");
}
    ...
    const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb1555, const struct YuvConstants* yuvconstants, int width)
{
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec] "=&f"(b_vec), [g_vec] "=&f"(g_vec), [r_vec] "=&f"(r_vec), [temp] "=&f"(temp),
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [dst_argb1555] "r"(dst_argb1555), [yuvcons_ptr] "r"(yuvconstants),
                     [width] "r"(width), [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [three] "f"(0x3),
                     [mask2] "f"(0x1f0000001f), [eight] "f"(0x8), [mask3] "f"(0x800000008000), [lmove5] "f"(0x5)
                     : "memory");
}
    ...
    const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_rgb565, const struct YuvConstants* yuvconstants, int width)
{
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec] "=&f"(b_vec), [g_vec] "=&f"(g_vec), [r_vec] "=&f"(r_vec), [temp] "=&f"(temp),
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [dst_rgb565] "r"(dst_rgb565), [yuvcons_ptr] "r"(yuvconstants),
                     [width] "r"(width), [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [three] "f"(0x3),
                     [mask2] "f"(0x1f0000001f), [eight] "f"(0x8), [seven] "f"(0x7), [lmove5] "f"(0x5)
                     : "memory");
}

void NV12ToARGBRow_MMI(const uint8_t* src_y, const uint8_t* src_uv, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec] "=&f"(b_vec), [g_vec] "=&f"(g_vec), [r_vec] "=&f"(r_vec), [temp] "=&f"(temp),
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [uv_ptr] "r"(src_uv), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
                     [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [ushu] "f"(0xA0), [vshu] "f"(0xf5), [alpha] "f"(-1)
                     : "memory");
}

void NV21ToARGBRow_MMI(const uint8_t* src_y, const uint8_t* src_vu, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec] "=&f"(b_vec), [g_vec] "=&f"(g_vec), [r_vec] "=&f"(r_vec), [temp] "=&f"(temp),
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [vu_ptr] "r"(src_vu), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
                     [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [ushu] "f"(0xA0), [vshu] "f"(0xf5), [alpha] "f"(-1)
                     : "memory");
}

void NV12ToRGB24Row_MMI(const uint8_t* src_y, const uint8_t* src_uv, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y_ptr] "r"(src_y), [uv_ptr] "r"(src_uv), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
                     [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [ushu] "f"(0xA0), [vshu] "f"(0xf5), [alpha] "f"(-1),
                     [lmove1] "f"(0x18), [one] "f"(0x1), [rmove1] "f"(0x8)
                     : "memory");
}

void NV21ToRGB24Row_MMI(const uint8_t* src_y, const uint8_t* src_vu, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [vu_ptr] "r"(src_vu), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
                     [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [ushu] "f"(0xA0), [vshu] "f"(0xf5),
                     [lmove1] "f"(0x18), [rmove1] "f"(0x8), [one] "f"(0x1)
                     : "memory");
}

void NV12ToRGB565Row_MMI(const uint8_t* src_y, const uint8_t* src_uv, uint8_t* dst_rgb565, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec] "=&f"(b_vec), [g_vec] "=&f"(g_vec), [r_vec] "=&f"(r_vec), [temp] "=&f"(temp),
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [uv_ptr] "r"(src_uv), [dst_rgb565] "r"(dst_rgb565), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width),
                     [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [ushu] "f"(0xA0), [vshu] "f"(0xf5), [three] "f"(0x3),
                     [mask2] "f"(0x1f0000001f), [eight] "f"(0x8), [seven] "f"(0x7)
                     : "memory");
}

void YUY2ToARGBRow_MMI(const uint8_t* src_yuy2, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec] "=&f"(b_vec), [g_vec] "=&f"(g_vec), [r_vec] "=&f"(r_vec), [temp] "=&f"(temp),
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [yuy2_ptr] "r"(src_yuy2), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width), [zero] "f"(0x00),
                     [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [ushu] "f"(0xA0), [vshu] "f"(0xf5), [alpha] "f"(-1), [eight] "f"(0x8)
                     : "memory");
}

void UYVYToARGBRow_MMI(const uint8_t* src_uyvy, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     : [y] "=&f"(y), [u] "=&f"(u), [v] "=&f"(v), [b_vec] "=&f"(b_vec), [g_vec] "=&f"(g_vec), [r_vec] "=&f"(r_vec), [temp] "=&f"(temp),
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [uyvy_ptr] "r"(src_uyvy), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants), [width] "r"(width), [zero] "f"(0x00),
                     [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [ushu] "f"(0xA0), [vshu] "f"(0xf5), [alpha] "f"(-1), [eight] "f"(0x8)
                     : "memory");
}

void I422ToRGBARow_MMI(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* rgb_buf, const struct YuvConstants* yuvconstants, int width)
{
    uint64_t y, u, v;
    uint64_t b_vec, g_vec, r_vec, temp;
    uint64_t ub, ug, vg, vr, bb, bg, br, yg;
    ...
    __asm__ volatile("ldc1       %[yg],           0xc0(%[yuvcons_ptr])             \n\t"
                     ...
                     [ub] "=&f"(ub), [ug] "=&f"(ug), [vg] "=&f"(vg), [vr] "=&f"(vr), [bb] "=&f"(bb), [bg] "=&f"(bg), [br] "=&f"(br), [yg] "=&f"(yg)
                     : [y_ptr] "r"(src_y), [u_ptr] "r"(src_u), [v_ptr] "r"(src_v), [rgbbuf_ptr] "r"(rgb_buf), [yuvcons_ptr] "r"(yuvconstants),
                     [width] "r"(width), [zero] "f"(0x00), [five] "f"(0x55), [six] "f"(0x6), [mask1] "f"(0xff00ff00ff00ff00), [alpha] "f"(-1)
                     : "memory");
}
