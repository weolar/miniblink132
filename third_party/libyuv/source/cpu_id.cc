...
#endif
#if !defined(__pnacl__) && !defined(__CLR_VER) && !defined(__native_client__) && (defined(_M_IX86) || defined(_M_X64)) && defined(_MSC_FULL_VER)               \
...
#if defined(_MSC_FULL_VER) && (_MSC_FULL_VER >= 160040219) && !defined(__clang__)
...
#if (defined(_M_IX86) || defined(_M_X64) || defined(__i386__) || defined(__x86_64__)) && !defined(__pnacl__) && !defined(__CLR_VER)
LIBYUV_API
...
static SAFEBUFFERS int GetCpuFlags(void)
{
    ...
    cpu_info = kCpuHasX86 | ((cpu_info1[3] & 0x04000000) ? kCpuHasSSE2 : 0) | ((cpu_info1[2] & 0x00000200) ? kCpuHasSSSE3 : 0)
        | ((cpu_info1[2] & 0x00080000) ? kCpuHasSSE41 : 0) | ((cpu_info1[2] & 0x00100000) ? kCpuHasSSE42 : 0) | ((cpu_info7[1] & 0x00000200) ? kCpuHasERMS : 0);

    // AVX requires OS saves YMM registers.
    if (((cpu_info1[2] & 0x1c000000) == 0x1c000000) && // AVX and OSXSave
        ((GetXCR0() & 6) == 6)) { // Test OS saves YMM registers
        cpu_info |= kCpuHasAVX | ((cpu_info7[1] & 0x00000020) ? kCpuHasAVX2 : 0) | ((cpu_info1[2] & 0x00001000) ? kCpuHasFMA3 : 0)
