...
#define I444TORGB(in_yy, in_u, in_v, ub, vr, ugvg, yg, yb, out_b, out_g, out_r)                                                                                \
    {                                                                                                                                                          \
...
void ARGB4444ToARGBRow_LSX(const uint8_t* src_argb4444, uint8_t* dst_argb, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG2(__lsx_vor_v, tmp0, reg0, tmp1, reg1, tmp2, reg2, tmp3, reg3, tmp0, tmp1, tmp2, tmp3);
...
void RGB24ToARGBRow_LSX(const uint8_t* src_rgb24, uint8_t* dst_argb, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG3(__lsx_vshuf_b, alpha, src0, shuf3, alpha, tmp0, shuf3, alpha, tmp1, shuf3, alpha, tmp2, shuf3, dst0, dst1, dst2, dst3);
        __lsx_vst(dst0, dst_argb, 0);
        __lsx_vst(dst1, dst_argb, 16);
        __lsx_vst(dst2, dst_argb, 32);
        __lsx_vst(dst3, dst_argb, 48);
...
void ARGB1555ToUVRow_LSX(const uint8_t* src_argb1555, int src_stride_argb1555, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_argb1555, 0, src_argb1555, 16, next_argb1555, 0, next_argb1555, 16, src0, src1, src2, src3);
...
void RGB565ToUVRow_LSX(const uint8_t* src_rgb565, int src_stride_rgb565, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_rgb565, 0, src_rgb565, 16, next_rgb565, 0, next_rgb565, 16, src0, src1, src2, src3);
        DUP2_ARG2(__lsx_vpickev_b, src1, src0, src3, src2, tmp0, tmp2);
        DUP2_ARG2(__lsx_vpickod_b, src1, src0, src3, src2, tmp1, tmp3);
        tmpb = __lsx_vandi_b(tmp0, 0x1F);
        tmpr = __lsx_vandi_b(tmp1, 0xF8);
...
void NV12ToARGBRow_LSX(const uint8_t* src_y, const uint8_t* src_uv, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        YUVTORGB(vec_y, vec_vu, vec_vrub, vec_vgug, vec_yg, vec_yb, out_b, out_g, out_r);
...
void NV21ToARGBRow_LSX(const uint8_t* src_y, const uint8_t* src_vu, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        YUVTORGB(vec_y, vec_uv, vec_ubvr, vec_ugvg, vec_yg, vec_yb, out_r, out_g, out_b);
        STOREARGB(alpha, out_r, out_g, out_b, dst_argb);
        src_y += 8;
        src_vu += 8;
    }
...
void SobelRow_LSX(const uint8_t* src_sobelx, const uint8_t* src_sobely, uint8_t* dst_argb, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG3(__lsx_vshuf_b, alpha, tmp0, shuff0, alpha, tmp0, shuff1, alpha, tmp0, shuff2, alpha, tmp0, shuff3, out0, out1, out2, out3);
...
void ARGBToYJRow_LSX(const uint8_t* src_argb, uint8_t* dst_y, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_argb, 0, src_argb, 16, src_argb, 32, src_argb, 48, src0, src1, src2, src3);
        tmp0 = __lsx_vpickev_b(src1, src0);
        tmp1 = __lsx_vpickod_b(src1, src0);
...
void BGRAToYRow_LSX(const uint8_t* src_bgra, uint8_t* dst_y, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_bgra, 0, src_bgra, 16, src_bgra, 32, src_bgra, 48, src0, src1, src2, src3);
...
void BGRAToUVRow_LSX(const uint8_t* src_bgra, int src_stride_bgra, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_bgra, 0, src_bgra, 16, src_bgra, 32, src_bgra, 48, src0, src1, src2, src3);
        DUP4_ARG2(__lsx_vld, next_bgra, 0, next_bgra, 16, next_bgra, 32, next_bgra, 48, nex0, nex1, nex2, nex3);
        tmp0 = __lsx_vpickod_b(src1, src0);
        tmp1 = __lsx_vpickev_b(src1, src0);
        tmp2 = __lsx_vpickod_b(src3, src2);
        tmp3 = __lsx_vpickev_b(src3, src2);
...
void ABGRToYRow_LSX(const uint8_t* src_abgr, uint8_t* dst_y, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_abgr, 0, src_abgr, 16, src_abgr, 32, src_abgr, 48, src0, src1, src2, src3);
        tmp0 = __lsx_vpickev_b(src1, src0);
        tmp1 = __lsx_vpickod_b(src1, src0);
        tmp2 = __lsx_vpickev_b(src3, src2);
        tmp3 = __lsx_vpickod_b(src3, src2);
...
void ABGRToUVRow_LSX(const uint8_t* src_abgr, int src_stride_abgr, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_abgr, 0, src_abgr, 16, src_abgr, 32, src_abgr, 48, src0, src1, src2, src3);
        DUP4_ARG2(__lsx_vld, next_abgr, 0, next_abgr, 16, next_abgr, 32, next_abgr, 48, nex0, nex1, nex2, nex3);
        tmp0 = __lsx_vpickev_b(src1, src0);
        tmp1 = __lsx_vpickod_b(src1, src0);
        tmp2 = __lsx_vpickev_b(src3, src2);
        tmp3 = __lsx_vpickod_b(src3, src2);
...
void RGBAToYRow_LSX(const uint8_t* src_rgba, uint8_t* dst_y, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_rgba, 0, src_rgba, 16, src_rgba, 32, src_rgba, 48, src0, src1, src2, src3);
        tmp0 = __lsx_vpickod_b(src1, src0);
        tmp1 = __lsx_vpickev_b(src1, src0);
        tmp2 = __lsx_vpickod_b(src3, src2);
        tmp3 = __lsx_vpickev_b(src3, src2);
...
void RGBAToUVRow_LSX(const uint8_t* src_rgba, int src_stride_rgba, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_rgba, 0, src_rgba, 16, src_rgba, 32, src_rgba, 48, src0, src1, src2, src3);
        DUP4_ARG2(__lsx_vld, next_rgba, 0, next_rgba, 16, next_rgba, 32, next_rgba, 48, nex0, nex1, nex2, nex3);
        tmp0 = __lsx_vpickod_b(src1, src0);
        tmp1 = __lsx_vpickev_b(src1, src0);
        tmp2 = __lsx_vpickod_b(src3, src2);
        tmp3 = __lsx_vpickev_b(src3, src2);
...
void ARGBToUVJRow_LSX(const uint8_t* src_argb, int src_stride_argb, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_argb, 0, src_argb, 16, src_argb, 32, src_argb, 48, src0, src1, src2, src3);
        DUP4_ARG2(__lsx_vld, next_argb, 0, next_argb, 16, next_argb, 32, next_argb, 48, nex0, nex1, nex2, nex3);
        tmp0 = __lsx_vpickev_b(src1, src0);
        tmp1 = __lsx_vpickod_b(src1, src0);
        tmp2 = __lsx_vpickev_b(src3, src2);
        tmp3 = __lsx_vpickod_b(src3, src2);
...
void I444ToARGBRow_LSX(const uint8_t* src_y, const uint8_t* src_u, const uint8_t* src_v, uint8_t* dst_argb, const struct YuvConstants* yuvconstants, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        I444TORGB(vec_yl, vec_ul, vec_vl, vec_ub, vec_vr, vec_ugvg, vec_yg, vec_yb, out_b, out_g, out_r);
        STOREARGB(alpha, out_r, out_g, out_b, dst_argb);
        vec_yh = __lsx_vilvh_b(vec_y, vec_y);
        vec_uh = __lsx_vilvh_b(zero, vec_u);
        vec_vh = __lsx_vilvh_b(zero, vec_v);
        I444TORGB(vec_yh, vec_uh, vec_vh, vec_ub, vec_vr, vec_ugvg, vec_yg, vec_yb, out_b, out_g, out_r);
        STOREARGB(alpha, out_r, out_g, out_b, dst_argb);
        src_y += 16;
        src_u += 16;
        src_v += 16;
...
void InterpolateRow_LSX(uint8_t* dst_ptr, const uint8_t* src_ptr, ptrdiff_t src_stride, int width, int32_t source_y_fraction)
{
    int x;
...
void ARGBBlendRow_LSX(const uint8_t* src_argb, const uint8_t* src_argb1, uint8_t* dst_argb, int width)
{
    int x;
    int len = width / 8;
    __m128i src0, src1, src2, src3;
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_argb, 0, src_argb, 16, src_argb1, 0, src_argb1, 16, src0, src1, src2, src3);
        ...
        DUP4_ARG2(__lsx_vsub_h, const_256, a0, const_256, a1, const_256, a2, const_256, a3, a0, a1, a2, a3);
        DUP4_ARG2(__lsx_vmul_h, a0, reg0, a1, reg1, a2, reg2, a3, reg3, reg0, reg1, reg2, reg3);
...
void ARGBQuantizeRow_LSX(uint8_t* dst_argb, int scale, int interval_size, int interval_offset, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, dst_argb, 0, dst_argb, 16, dst_argb, 32, dst_argb, 48, src0, src1, src2, src3);
        ...
        DUP4_ARG2(__lsx_vmul_w, tmp0, vec_scale, tmp1, vec_scale, tmp2, vec_scale, tmp3, vec_scale, tmp0, tmp1, tmp2, tmp3);
        DUP4_ARG2(__lsx_vmul_w, tmp4, vec_scale, tmp5, vec_scale, tmp6, vec_scale, tmp7, vec_scale, tmp4, tmp5, tmp6, tmp7);
        DUP4_ARG3(__lsx_vsrani_h_w, tmp1, tmp0, 16, tmp3, tmp2, 16, tmp5, tmp4, 16, tmp7, tmp6, 16, reg0, reg1, reg2, reg3);
        ...
        DUP4_ARG2(__lsx_vmul_b, dst0, vec_size, dst1, vec_size, dst2, vec_size, dst3, vec_size, dst0, dst1, dst2, dst3);
        DUP4_ARG2(__lsx_vadd_b, dst0, vec_offset, dst1, vec_offset, dst2, vec_offset, dst3, vec_offset, dst0, dst1, dst2, dst3);
        DUP4_ARG3(__lsx_vbitsel_v, dst0, src0, control, dst1, src1, control, dst2, src2, control, dst3, src3, control, dst0, dst1, dst2, dst3);
        __lsx_vst(dst0, dst_argb, 0);
        __lsx_vst(dst1, dst_argb, 16);
        __lsx_vst(dst2, dst_argb, 32);
        __lsx_vst(dst3, dst_argb, 48);
...
void ARGBColorMatrixRow_LSX(const uint8_t* src_argb, uint8_t* dst_argb, const int8_t* matrix_argb, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG2(__lsx_vdp2_h_bu_b, src0, matrix_b, src0, matrix_g, src0, matrix_r, src0, matrix_a, tmp_b, tmp_g, tmp_r, tmp_a);
        DUP4_ARG2(__lsx_vdp2_h_bu_b, src1, matrix_b, src1, matrix_g, src1, matrix_r, src1, matrix_a, reg_b, reg_g, reg_r, reg_a);
        DUP4_ARG2(__lsx_vhaddw_w_h, tmp_b, tmp_b, tmp_g, tmp_g, tmp_r, tmp_r, tmp_a, tmp_a, tmp_b, tmp_g, tmp_r, tmp_a);
        DUP4_ARG2(__lsx_vhaddw_w_h, reg_b, reg_b, reg_g, reg_g, reg_r, reg_r, reg_a, reg_a, reg_b, reg_g, reg_r, reg_a);
        DUP4_ARG2(__lsx_vsrai_w, tmp_b, 6, tmp_g, 6, tmp_r, 6, tmp_a, 6, tmp_b, tmp_g, tmp_r, tmp_a);
        DUP4_ARG2(__lsx_vsrai_w, reg_b, 6, reg_g, 6, reg_r, 6, reg_a, 6, reg_b, reg_g, reg_r, reg_a);
        ...
        DUP4_ARG2(__lsx_vpickev_h, reg_b, tmp_b, reg_g, tmp_g, reg_r, tmp_r, reg_a, tmp_a, tmp_b, tmp_g, tmp_r, tmp_a);
...
void SplitUVRow_LSX(const uint8_t* src_uv, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        DUP4_ARG2(__lsx_vld, src_uv, 0, src_uv, 16, src_uv, 32, src_uv, 48, src0, src1, src2, src3);
...
void MirrorSplitUVRow_LSX(const uint8_t* src_uv, uint8_t* dst_u, uint8_t* dst_v, int width)
{
    ...
    for (x = 0; x < len; x++) {
        src_uv -= 64;
        DUP4_ARG2(__lsx_vld, src_uv, 0, src_uv, 16, src_uv, 32, src_uv, 48, src2, src3, src0, src1);
        DUP4_ARG3(__lsx_vshuf_b, src1, src0, shuff1, src3, src2, shuff1, src1, src0, shuff0, src3, src2, shuff0, dst0, dst1, dst2, dst3);
...
void HalfFloatRow_LSX(const uint16_t* src, uint16_t* dst, float scale, int width)
{
    ...
    for (x = 0; x < len; x++) {
        ...
        DUP4_ARG2(__lsx_vilvl_h, zero, src0, zero, src1, zero, src2, zero, src3, tmp0, tmp2, tmp4, tmp6);
        DUP4_ARG2(__lsx_vilvh_h, zero, src0, zero, src1, zero, src2, zero, src3, tmp1, tmp3, tmp5, tmp7);
        ...
        DUP4_ARG2(__lsx_vfmul_s, reg0, vec_mult, reg1, vec_mult, reg2, vec_mult, reg3, vec_mult, reg0, reg1, reg2, reg3);
        DUP4_ARG2(__lsx_vfmul_s, reg4, vec_mult, reg5, vec_mult, reg6, vec_mult, reg7, vec_mult, reg4, reg5, reg6, reg7);
        DUP4_ARG2(__lsx_vsrli_w, (v4u32)reg0, 13, (v4u32)reg1, 13, (v4u32)reg2, 13, (v4u32)reg3, 13, tmp0, tmp1, tmp2, tmp3);
        DUP4_ARG2(__lsx_vsrli_w, (v4u32)reg4, 13, (v4u32)reg5, 13, (v4u32)reg6, 13, (v4u32)reg7, 13, tmp4, tmp5, tmp6, tmp7);
        DUP4_ARG2(__lsx_vpickev_h, tmp1, tmp0, tmp3, tmp2, tmp5, tmp4, tmp7, tmp6, dst0, dst1, dst2, dst3);
        __lsx_vst(dst0, dst, 0);
