...
#if !defined(LIBYUV_DISABLE_X86) && (defined(__x86_64__) || defined(__i386__) || defined(_M_IX86))
...
#if !defined(LIBYUV_DISABLE_X86) && defined(_M_IX86) && defined(_MSC_VER) && !defined(__clang__) && (defined(VISUALC_HAS_AVX2) || defined(CLANG_HAS_AVX2))
...
// The following are available for GCC and clangcl:
#if !defined(LIBYUV_DISABLE_X86) && defined(CLANG_HAS_AVX2) && (defined(__x86_64__) || defined(__i386__))
