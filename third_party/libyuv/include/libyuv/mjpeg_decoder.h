...
enum JpegSubsamplingType { kJpegYuv420, kJpegYuv422, kJpegYuv444, kJpegYuv400, kJpegUnknown };
...
public:
    typedef void (*CallbackFunction)(void* opaque, const uint8_t* const* data, const int* strides, int rows);
    ...
    static JpegSubsamplingType JpegSubsamplingTypeHelper(int* subsample_x, int* subsample_y, int number_of_components);
