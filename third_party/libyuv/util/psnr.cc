...
static uint32_t SumSquareError_NEON(const uint8_t* src_a, const uint8_t* src_b, int count)
{
...
__declspec(naked) static uint32_t SumSquareError_SSE2(const uint8_t* /*src_a*/, const uint8_t* /*src_b*/, int /*count*/)
{
    __asm {
    mov        eax, [esp + 4] // src_a
    mov        edx, [esp + 8] // src_b
...
#define HAS_SUMSQUAREERROR_SSE2
static uint32_t SumSquareError_SSE2(const uint8_t* src_a, const uint8_t* src_b, int count)
{
    uint32_t sse;
    asm volatile( // NOLINT
        "pxor      %%xmm0,%%xmm0                   \n"
...
static uint32_t SumSquareError_C(const uint8_t* src_a, const uint8_t* src_b, int count)
{
    uint32_t sse = 0u;
