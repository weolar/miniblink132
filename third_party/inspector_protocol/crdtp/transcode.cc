...
namespace crdtp {
namespace {
int Transcode(const std::string& cmd, const std::string& input_file_name, const std::string& output_file_name)
{
...
int main(int argc, char** argv)
{
    ...
    std::cerr << "usage: " << argv[0] << " --json-to-cbor <input-file> <output-file>\n"
