...
template <> struct CRDTP_EXPORT ProtocolTypeTraits<std::string> {
...
template <> struct CRDTP_EXPORT ProtocolTypeTraits<base::Value> {
...
template <> struct CRDTP_EXPORT ProtocolTypeTraits<traits::DictionaryValue> {
    static bool Deserialize(DeserializerState* state, traits::DictionaryValue* value);
    static void Serialize(const traits::DictionaryValue& value, std::vector<uint8_t>* bytes);
};

template <> struct CRDTP_EXPORT ProtocolTypeTraits<traits::ListValue> {
    static bool Deserialize(DeserializerState* state, traits::ListValue* value);
    static void Serialize(const traits::ListValue& value, std::vector<uint8_t>* bytes);
};

template <typename T> struct UniquePtrTraitsHelper {
...
template <> struct CRDTP_EXPORT ProtocolTypeTraits<std::unique_ptr<traits::DictionaryValue>> : public UniquePtrTraitsHelper<traits::DictionaryValue> { };

// TODO(caseq): get rid of this, make sure Value is stored directly.
template <> struct CRDTP_EXPORT ProtocolTypeTraits<std::unique_ptr<base::Value>> : public UniquePtrTraitsHelper<base::Value> { };
...
template <> struct CRDTP_EXPORT ProtocolTypeTraits<Binary> {
...
template <> struct detail::MaybeTypedef<Binary> {
