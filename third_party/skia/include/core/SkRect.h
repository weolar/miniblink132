...
struct SK_API SkIRect {
    ...
    */
    ...
    {
        return MakeLTRB(std::min(fLeft, fRight), std::min(fTop, fBottom), std::max(fLeft, fRight), std::max(fTop, fBottom));
    }
};
...
struct SK_API SkRect {
    ...
    */
    ...
    {
        return { static_cast<float>(irect.fLeft), static_cast<float>(irect.fTop), static_cast<float>(irect.fRight), static_cast<float>(irect.fBottom) };
    }
    ...
    */
    ...
    {
        return this->makeOffset(v.x(), v.y());
    }
...
public:
    ...
    */
    ...
    {
        SkASSERT(dst);
        dst->setLTRB(sk_float_round2int(fLeft), sk_float_round2int(fTop), sk_float_round2int(fRight), sk_float_round2int(fBottom));
    }
    ...
    */
    ...
    {
        SkASSERT(dst);
        dst->setLTRB(sk_float_floor2int(fLeft), sk_float_floor2int(fTop), sk_float_ceil2int(fRight), sk_float_ceil2int(fBottom));
    }
    ...
    */
    ...
    {
        dst->setLTRB(std::floor(fLeft), std::floor(fTop), std::ceil(fRight), std::ceil(fBottom));
    }
    ...
    */
    ...
    {
        SkASSERT(dst);
        dst->setLTRB(sk_float_ceil2int(fLeft), sk_float_ceil2int(fTop), sk_float_floor2int(fRight), sk_float_floor2int(fBottom));
    }
