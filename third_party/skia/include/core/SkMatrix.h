...
public:
    ...
    */
    ...
    [[nodiscard]] static SkMatrix Translate(SkVector t)
    {
        return Translate(t.x(), t.y());
    }
    [[nodiscard]] static SkMatrix Translate(SkIVector t)
    {
        return Translate(t.x(), t.y());
    }
    ...
    */
    [[nodiscard]] static SkMatrix RectToRect(const SkRect& src, const SkRect& dst, ScaleToFit mode = kFill_ScaleToFit)
    {
    ...
    */
    [[nodiscard]] static SkMatrix MakeAll(
        SkScalar scaleX, SkScalar skewX, SkScalar transX, SkScalar skewY, SkScalar scaleY, SkScalar transY, SkScalar pers0, SkScalar pers1, SkScalar pers2)
    {
        SkMatrix m;
    ...
    */
    SkMatrix& setAll(
        SkScalar scaleX, SkScalar skewX, SkScalar transX, SkScalar skewY, SkScalar scaleY, SkScalar transY, SkScalar persp0, SkScalar persp1, SkScalar persp2)
    {
...
private:
    ...
    */
    ...
    constexpr SkMatrix(SkScalar sx, SkScalar kx, SkScalar tx, SkScalar ky, SkScalar sy, SkScalar ty, SkScalar p0, SkScalar p1, SkScalar p2, int typeMask)
    ...
    void setTypeMask(int mask)
    {
        ...
        SkASSERT(kUnknown_Mask == mask || (mask & kAllMasks) == mask
            || ((kUnknown_Mask | kOnlyPerspectiveValid_Mask) & mask) == (kUnknown_Mask | kOnlyPerspectiveValid_Mask));
        fTypeMask = mask;
    }
