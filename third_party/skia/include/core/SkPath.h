...
public:
     ...
     */
    static SkPath Make(
        const SkPoint[], int pointCount, const uint8_t[], int verbCount, const SkScalar[], int conicWeightCount, SkPathFillType, bool isVolatile = false);
    ...
    static SkPath Polygon(
        const std::initializer_list<SkPoint>& list, bool isClosed, SkPathFillType fillType = SkPathFillType::kWinding, bool isVolatile = false)
    {
...
private:
    SkPath(sk_sp<SkPathRef>, SkPathFillType, bool isVolatile, SkPathConvexity, SkPathFirstDirection firstDirection);
    ...
    */
    ...
    static SkPath MakeInternal(const SkPathVerbAnalysis& analsis, const SkPoint points[], const uint8_t verbs[], int verbCount, const SkScalar conics[],
