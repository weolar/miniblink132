...
public:
    ...
    {
        this->insert(offset, str.c_str(), str.size());
    }
    void insert(size_t offset, std::string_view str)
    {
        this->insert(offset, str.data(), str.size());
    }
    ...
    {
        this->insert((size_t)-1, str.c_str(), str.size());
    }
    void append(std::string_view str)
    {
        this->insert((size_t)-1, str.data(), str.size());
    }
    ...
    {
        this->insert(0, str.c_str(), str.size());
    }
    void prepend(std::string_view str)
    {
        this->insert(0, str.data(), str.size());
    }
