...
public:
    ...
    std::unique_ptr<GpuDrawHandler> snapGpuDrawHandler(
        GrBackendApi backendApi, const SkMatrix& matrix, const SkIRect& clipBounds, const SkImageInfo& bufferInfo)
    {
...
protected:
    ...
    virtual std::unique_ptr<GpuDrawHandler> onSnapGpuDrawHandler(GrBackendApi, const SkMatrix&, const SkIRect& /*clipBounds*/, const SkImageInfo&)
    {
        return nullptr;
    }
