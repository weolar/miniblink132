...
struct SkArc {
    ...
    bool isWedge() const
    {
        return fType == Type::kWedge;
    }

    friend bool operator==(const SkArc& a, const SkArc& b)
    {
        return a.fOval == b.fOval && a.fStartAngle == b.fStartAngle && a.fSweepAngle == b.fSweepAngle && a.fType == b.fType;
    }
    ...
    {
        return SkArc(oval, startAngleDegrees, sweepAngleDegrees, useCenter ? Type::kWedge : Type::kArc);
    }
