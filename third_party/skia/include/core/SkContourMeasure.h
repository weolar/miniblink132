...
public:
    ...
    /** Pins distance to 0 <= distance <= getLength(), and then computes
     ...
     matrix is unchanged.
     */
    [[nodiscard]] bool getMatrix(SkScalar distance, SkMatrix* matrix, MatrixFlags flags = kGetPosAndTan_MatrixFlag) const;
     ...
     */
    [[nodiscard]] bool getSegment(SkScalar startD, SkScalar stopD, SkPath* dst, bool startWithMoveTo) const;
...
public:
    ...
    public:
        ...
        {
            SkASSERT(fSegments.data() != other.fSegments.data() || fSegments.size() == other.fSegments.size());
