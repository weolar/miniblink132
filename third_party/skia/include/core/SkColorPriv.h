...
#if (SK_A32_SHIFT == SK_RGBA_A32_SHIFT && SK_R32_SHIFT == SK_RGBA_R32_SHIFT && SK_G32_SHIFT == SK_RGBA_G32_SHIFT && SK_B32_SHIFT == SK_RGBA_B32_SHIFT)
#define SK_PMCOLOR_IS_RGBA
#elif (SK_A32_SHIFT == SK_BGRA_A32_SHIFT && SK_R32_SHIFT == SK_BGRA_R32_SHIFT && SK_G32_SHIFT == SK_BGRA_G32_SHIFT && SK_B32_SHIFT == SK_BGRA_B32_SHIFT)
...
static inline SkPMColor SkPMSrcOver(SkPMColor src, SkPMColor dst)
{
    ...
    return std::min(rb & 0x000001FF, 0x000000FFU) | std::min(ag & 0x0001FF00, 0x0000FF00U) | std::min(rb & 0x01FF0000, 0x00FF0000U) | (ag & 0xFF000000);
}
