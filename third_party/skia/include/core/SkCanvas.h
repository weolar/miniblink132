...
namespace skiatest {
template <typename Key> class TestCanvas; // IWYU pragma: keep
}
...
public:
    ...
    */
    struct SaveLayerRec {
        ...
        */
        SaveLayerRec(const SkRect* bounds, const SkPaint* paint, SaveLayerFlags saveLayerFlags = 0)
            : SaveLayerRec(bounds, paint, nullptr, nullptr, 1.f, SkTileMode::kClamp, saveLayerFlags, /*filters=*/ {})
        {
        }
        ...
        */
        SaveLayerRec(const SkRect* bounds, const SkPaint* paint, const SkImageFilter* backdrop, SaveLayerFlags saveLayerFlags)
            : SaveLayerRec(bounds, paint, backdrop, nullptr, 1.f, SkTileMode::kClamp, saveLayerFlags, /*filters=*/ {})
        {
        }
        ...
        */
        SaveLayerRec(const SkRect* bounds, const SkPaint* paint, const SkImageFilter* backdrop, const SkColorSpace* colorSpace, SaveLayerFlags saveLayerFlags)
            : SaveLayerRec(bounds, paint, backdrop, colorSpace, 1.f, SkTileMode::kClamp, saveLayerFlags, /*filters=*/ {})
        {
        }
        ...
        /** Sets fBounds, fBackdrop, fBackdropTileMode, fColorSpace, and fSaveLayerFlags.
            ...
            @return                 SaveLayerRec fully specified
        */
        SaveLayerRec(const SkRect* bounds, const SkPaint* paint, const SkImageFilter* backdrop, SkTileMode backdropTileMode, const SkColorSpace* colorSpace,
            SaveLayerFlags saveLayerFlags)
            : SaveLayerRec(bounds, paint, backdrop, colorSpace, 1.f, backdropTileMode, saveLayerFlags, /*filters=*/ {})
        {
        }
    ...
    private:
        ...
        SaveLayerRec(const SkRect* bounds, const SkPaint* paint, const SkImageFilter* backdrop, const SkColorSpace* colorSpace, SkScalar backdropScale,
            SkTileMode backdropTileMode, SaveLayerFlags saveLayerFlags, FilterSpan filters)
            : fBounds(bounds)
            , fPaint(paint)
            , fFilters(filters)
            , fBackdrop(backdrop)
    ...
    */
    ...
    void drawImageRect(const sk_sp<SkImage>& image, const SkRect& src, const SkRect& dst, const SkSamplingOptions& sampling, const SkPaint* paint,
    ...
    */
     ...
     */
    void experimental_DrawEdgeAAImageSet(const ImageSetEntry imageSet[], int cnt, const SkPoint dstClips[], const SkMatrix preViewMatrices[],
        const SkSamplingOptions&, const SkPaint* paint = nullptr, SrcRectConstraint constraint = kStrict_SrcRectConstraint);
    ...
    */
    ...
    /** Draws count glyphs, at positions relative to origin styled with font and paint with
       ...
       @param paint           blend, color, and so on, used to draw
    */
    void drawGlyphs(int count, const SkGlyphID glyphs[], const SkPoint positions[], const uint32_t clusters[], int textByteCount, const char utf8text[],
    ...
    */
    void drawAtlas(const SkImage* atlas, const SkRSXform xform[], const SkRect tex[], const SkColor colors[], int count, SkBlendMode mode,
...
protected:
    ...
    virtual void onDrawAtlas2(const SkImage*, const SkRSXform[], const SkRect src[], const SkColor[], int count, SkBlendMode, const SkSamplingOptions&,
        const SkRect* cull, const SkPaint*);
    virtual void onDrawEdgeAAImageSet2(const ImageSetEntry imageSet[], int count, const SkPoint dstClips[], const SkMatrix preViewMatrices[],
...
private:
    ...
    std::optional<AutoLayerForImageFilter> aboutToDraw(const SkPaint& paint, const SkRect* rawBounds, SkEnumBitMask<PredrawFlags> flags);
    std::optional<AutoLayerForImageFilter> aboutToDraw(const SkPaint& paint, const SkRect* rawBounds = nullptr);
    ...
    struct Layer {
        ...
        Layer(sk_sp<SkDevice> device, FilterSpan imageFilters, const SkPaint& paint, bool isCoverage, bool includesPadding);
    };
    ...
    public:
        ...
        void newLayer(sk_sp<SkDevice> layerDevice, FilterSpan filters, const SkPaint& restorePaint, bool layerIsCoverage, bool includesPadding);
    ...
    template <typename Key> friend class skiatest::TestCanvas;
...
private:
    SkCanvas(const SkBitmap&, std::unique_ptr<SkRasterHandleAllocator>, SkRasterHandleAllocator::Handle, const SkSurfaceProps* props);
     ...
     */
    sk_sp<sktext::gpu::Slug> convertBlobToSlug(const SkTextBlob& blob, SkPoint origin, const SkPaint& paint);
    ...
    bool internalQuickReject(const SkRect& bounds, const SkPaint& paint, const SkMatrix* matrix = nullptr);
     ...
     */
    void internalDrawDeviceWithFilter(SkDevice* src, SkDevice* dst, FilterSpan filters, const SkPaint& paint, DeviceCompatibleWithFilter compat,
        const SkColorInfo& filterColorInfo, SkScalar scaleFactor = 1.f, SkTileMode srcTileMode = SkTileMode::kDecal, bool srcIsCoverageLayer = false);
     ...
     */
    bool wouldOverwriteEntireSurface(const SkRect*, const SkPaint*, SkEnumBitMask<PredrawFlags>) const;
    ...
    std::optional<AutoLayerForImageFilter> attemptBlurredRRectDraw(const SkRRect&, const SkPaint&, SkEnumBitMask<PredrawFlags>);
