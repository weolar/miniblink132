...
public:
    ...
    struct CropRect : public std::optional<SkRect> {
        ...
        CropRect(const SkIRect& crop)
            : std::optional<SkRect>(SkRect::Make(crop))
        {
        }
        CropRect(const SkRect& crop)
            : std::optional<SkRect>(crop)
        {
        }
     ...
     */
    static sk_sp<SkImageFilter> Arithmetic(SkScalar k1, SkScalar k2, SkScalar k3, SkScalar k4, bool enforcePMColor, sk_sp<SkImageFilter> background,
    ...
    static sk_sp<SkImageFilter> Blend(
        SkBlendMode mode, sk_sp<SkImageFilter> background, sk_sp<SkImageFilter> foreground = nullptr, const CropRect& cropRect = {});
     ...
     */
    static sk_sp<SkImageFilter> Blend(
        sk_sp<SkBlender> blender, sk_sp<SkImageFilter> background, sk_sp<SkImageFilter> foreground = nullptr, const CropRect& cropRect = {});
    ...
    */
     ...
     */
    static sk_sp<SkImageFilter> DisplacementMap(SkColorChannel xChannelSelector, SkColorChannel yChannelSelector, SkScalar scale,
     ...
     *  @param cropRect   Optional rectangle that crops the input and output.
     */
    static sk_sp<SkImageFilter> DropShadow(SkScalar dx, SkScalar dy, SkScalar sigmaX, SkScalar sigmaY, SkColor4f color, sk_sp<SkColorSpace> colorSpace,
        sk_sp<SkImageFilter> input, const CropRect& cropRect = {});
    static sk_sp<SkImageFilter> DropShadow(
        SkScalar dx, SkScalar dy, SkScalar sigmaX, SkScalar sigmaY, SkColor color, sk_sp<SkImageFilter> input, const CropRect& cropRect = {})
    {
        return DropShadow(dx, dy, sigmaX, sigmaY, SkColor4f::FromColor(color), /*colorSpace=*/nullptr, std::move(input), cropRect);
    }
     ...
     *  @param cropRect   Optional rectangle that crops the input and output.
     */
    static sk_sp<SkImageFilter> DropShadowOnly(SkScalar dx, SkScalar dy, SkScalar sigmaX, SkScalar sigmaY, SkColor4f color, sk_sp<SkColorSpace>,
        sk_sp<SkImageFilter> input, const CropRect& cropRect = {});
    static sk_sp<SkImageFilter> DropShadowOnly(
        SkScalar dx, SkScalar dy, SkScalar sigmaX, SkScalar sigmaY, SkColor color, sk_sp<SkImageFilter> input, const CropRect& cropRect = {})
    {
        return DropShadowOnly(dx, dy, sigmaX, sigmaY, SkColor4f::FromColor(color), /*colorSpace=*/nullptr, std::move(input), cropRect);
    }
     ...
     *  @param cropRect   Optional rectangle that crops the input and output.
     */
    static sk_sp<SkImageFilter> Magnifier(const SkRect& lensBounds, SkScalar zoomAmount, SkScalar inset, const SkSamplingOptions& sampling,
        sk_sp<SkImageFilter> input, const CropRect& cropRect = {});
     ...
     */
    static sk_sp<SkImageFilter> MatrixConvolution(const SkISize& kernelSize, const SkScalar kernel[], SkScalar gain, SkScalar bias,
        const SkIPoint& kernelOffset, SkTileMode tileMode, bool convolveAlpha, sk_sp<SkImageFilter> input, const CropRect& cropRect = {});
     ...
     */
    static sk_sp<SkImageFilter> RuntimeShader(const SkRuntimeEffectBuilder& builder, std::string_view childShaderName, sk_sp<SkImageFilter> input)
    {
    ...
    */
    static sk_sp<SkImageFilter> RuntimeShader(
        const SkRuntimeEffectBuilder& builder, SkScalar sampleRadius, std::string_view childShaderName, sk_sp<SkImageFilter> input);
     ...
     */
    static sk_sp<SkImageFilter> RuntimeShader(
        const SkRuntimeEffectBuilder& builder, std::string_view childShaderNames[], const sk_sp<SkImageFilter> inputs[], int inputCount)
    {
     ...
     *  This requires a GPU backend or SkSL to be compiled in.
     */
    static sk_sp<SkImageFilter> RuntimeShader(const SkRuntimeEffectBuilder& builder, SkScalar maxSampleRadius, std::string_view childShaderNames[],
     ...
     *  @param cropRect        Optional rectangle that crops the input and output.
     */
    static sk_sp<SkImageFilter> SpotLitDiffuse(const SkPoint3& location, const SkPoint3& target, SkScalar falloffExponent, SkScalar cutoffAngle,
     ...
     *  @param cropRect     Optional rectangle that crops the input and output.
     */
    static sk_sp<SkImageFilter> DistantLitSpecular(const SkPoint3& direction, SkColor lightColor, SkScalar surfaceScale, SkScalar ks, SkScalar shininess,
        sk_sp<SkImageFilter> input, const CropRect& cropRect = {});
    /**
     ...
     *  @param cropRect     Optional rectangle that crops the input and output.
     */
    static sk_sp<SkImageFilter> PointLitSpecular(const SkPoint3& location, SkColor lightColor, SkScalar surfaceScale, SkScalar ks, SkScalar shininess,
        sk_sp<SkImageFilter> input, const CropRect& cropRect = {});
    /**
     ...
     *  @param cropRect        Optional rectangle that crops the input and output.
     */
    static sk_sp<SkImageFilter> SpotLitSpecular(const SkPoint3& location, const SkPoint3& target, SkScalar falloffExponent, SkScalar cutoffAngle,
