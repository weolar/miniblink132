...
public:
     ...
     */
    virtual void compileError([[maybe_unused]] const char* shader, [[maybe_unused]] const char* errors)
    {
    }
    virtual void compileError(const char* shader, const char* errors, [[maybe_unused]] bool shaderWasCached)
    {
