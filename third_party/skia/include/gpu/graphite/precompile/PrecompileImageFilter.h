...
private:
    ...
    virtual void onCreatePipelines(const KeyContext&, PipelineDataGatherer*, const RenderPassDesc&, const PaintOptions::ProcessCombination&) const = 0;

    void createPipelines(const KeyContext&, PipelineDataGatherer*, const RenderPassDesc&, const PaintOptions::ProcessCombination&);
...
SK_API sk_sp<PrecompileImageFilter> Blend(sk_sp<PrecompileBlender> blender, sk_sp<PrecompileImageFilter> background, sk_sp<PrecompileImageFilter> foreground);
