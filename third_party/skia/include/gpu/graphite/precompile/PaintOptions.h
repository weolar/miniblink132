...
private:
    ...
    void createKey(const KeyContext&, PaintParamsKeyBuilder*, PipelineDataGatherer*, int desiredCombination, bool addPrimitiveBlender, Coverage coverage) const;

    typedef std::function<void(UniquePaintParamsID id, DrawTypeFlags, bool withPrimitiveBlender, Coverage, const RenderPassDesc&)> ProcessCombination;

    void buildCombinations(
        const KeyContext&, PipelineDataGatherer*, DrawTypeFlags, bool addPrimitiveBlender, Coverage, const RenderPassDesc&, const ProcessCombination&) const;
