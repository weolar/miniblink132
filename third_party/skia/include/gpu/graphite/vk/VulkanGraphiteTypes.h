...
struct VulkanTextureInfo {
    ...
    VulkanTextureInfo(uint32_t sampleCount, Mipmapped mipmapped, VkImageCreateFlags flags, VkFormat format, VkImageTiling imageTiling,
        VkImageUsageFlags imageUsageFlags, VkSharingMode sharingMode, VkImageAspectFlags aspectMask, VulkanYcbcrConversionInfo ycbcrConversionInfo)
...
SK_API BackendTexture MakeVulkan(SkISize dimensions, const VulkanTextureInfo&, VkImageLayout, uint32_t queueFamilyIndex, VkImage, VulkanAlloc);
} // namespace BackendTextures
