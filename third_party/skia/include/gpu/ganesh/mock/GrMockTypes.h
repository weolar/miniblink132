...
struct GrMockTextureInfo {
    ...
    {
        return fColorType == that.fColorType && fCompressionType == that.fCompressionType && fID == that.fID && fProtected == that.fProtected;
    }
...
struct GrMockRenderTargetInfo {
    ...
    {
        return fColorType == that.fColorType && fID == that.fID && fProtected == that.fProtected;
    }
