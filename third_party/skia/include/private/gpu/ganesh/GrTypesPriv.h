...
constexpr static int kGrInternalTextureFlagsMask = static_cast<int>(GrInternalSurfaceFlags::kReadOnly);
...
constexpr static int kGrInternalTextureRenderTargetFlagsMask = kGrInternalTextureFlagsMask | kGrInternalRenderTargetFlagsMask;
...
static constexpr GrColorType SkColorTypeToGrColorType(SkColorType ct)
{
    ...
    case kRGB_F16F16F16x_SkColorType:
        return GrColorType::kRGB_F16F16F16x;
    case kRGBA_1010102_SkColorType:
        return GrColorType::kRGBA_1010102;
    case kRGB_101010x_SkColorType:
        return GrColorType::kRGB_101010x;
    case kBGRA_1010102_SkColorType:
        return GrColorType::kBGRA_1010102;
...
static constexpr bool GrColorTypeIsWiderThan(GrColorType colorType, int n)
{
    ...
    return (desc.r() && desc.r() > n) || (desc.g() && desc.g() > n) || (desc.b() && desc.b() > n) || (desc.a() && desc.a() > n)
