...
template <typename... Args> static void fuzz_nice_float(Fuzz* fuzz, float* f, Args... rest)
{
...
void FuzzCreateValidInputsForRuntimeEffect(SkRuntimeEffect* effect, sk_sp<SkData>& uniformBytes, TArray<SkRuntimeEffect::ChildPtr>& children)
{
    ...
    for (const SkRuntimeEffect::Uniform& u : effect->uniforms()) {
        ...
        if (u.type == SkRuntimeEffect::Uniform::Type::kInt || u.type == SkRuntimeEffect::Uniform::Type::kInt2 || u.type == SkRuntimeEffect::Uniform::Type::kInt3
