...
template <int logPixelScale> static int16_t saturating_lerp(float t, int16_t a, int16_t b)
{
...
template <int logPixelScale> static int16_t ssse3_lerp(float t, int16_t a, int16_t b)
{
    const int16_t half = 1 << (logPixelScale - 1);
    Q15 qt(floor(t * 32768.f + 0.5f));
    Q15 qa(a << logPixelScale);
...
template <int logPixelScale> static int16_t balanced_lerp(float t, int16_t a, int16_t b)
{
...
template <typename Lerp> static Stats check_lerp(Lerp lerp)
{
    Stats stats;
