...
EMSCRIPTEN_BINDINGS(Extension)
{
    ...
    function("_withObject", optional_override([](CompoundObj o) -> void { printf("Object %d %s %f\n", o.alpha, o.beta.c_str(), o.gamma); }));
    ...
    class_<Extension>("Extension")
        ...
        .function("getProp", &Extension::getProp) TS_PRIVATE_EXPORT("setProp(p: string): void")
