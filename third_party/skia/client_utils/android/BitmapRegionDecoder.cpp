...
bool BitmapRegionDecoder::decodeRegion(SkBitmap* bitmap, BRDAllocator* allocator, const SkIRect& desiredSubset, int sampleSize, SkColorType dstColorType,
    bool requireUnpremul, sk_sp<SkColorSpace> dstColorSpace)
{
    ...
    SkImageInfo decodeInfo = SkImageInfo::Make(scaledSize, dstColorType, dstAlphaType, std::move(dstColorSpace));
