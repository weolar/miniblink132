...
public:
    ...
    bool decodeRegion(SkBitmap* bitmap, BRDAllocator* allocator, const SkIRect& desiredSubset, int sampleSize, SkColorType colorType, bool requireUnpremul,
    ...
    bool getGainmapBitmapRegionDecoder(SkGainmapInfo* outInfo, std::unique_ptr<BitmapRegionDecoder>* outDecoder)
    {
        ...
        *outDecoder = std::unique_ptr<BitmapRegionDecoder>(new BitmapRegionDecoder(std::move(codec)));
        return true;
    }
