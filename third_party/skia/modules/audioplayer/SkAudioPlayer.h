...
public:
    ...
    {
        return this->state() == State::kPlaying;
    }
    bool isPaused() const
    {
        return this->state() == State::kPaused;
    }
    bool isStopped() const
    {
        return this->state() == State::kStopped;
    }
