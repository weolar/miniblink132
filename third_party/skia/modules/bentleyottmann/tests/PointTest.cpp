...
DEF_TEST(BO_PointBasic, reporter)
{
...

    {
        ...
        REPORTER_ASSERT(reporter, !Point::DifferenceTooBig(Point::Smallest() + Point { 1, 1 }, Point { 0, 0 }));
        REPORTER_ASSERT(reporter, !Point::DifferenceTooBig(Point { 0, 0 }, Point::Smallest() + Point { 1, 1 }));
    }
}
