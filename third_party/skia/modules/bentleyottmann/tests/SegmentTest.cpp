...
{
    Segment interesting[]
        = { { Point::Smallest(), Point::Smallest() + Point { 10, 5 } }, { Point::Largest(), Point::Largest() - Point { 10, 5 } }, { { -10, -5 }, { 10, 5 } } };
    ...
    for (auto& s0 : interesting) {
        ...
        Segment outside[] = { { { r, t }, { big, b } }, { { r, b }, { big, big } }, { { l, b }, { r, big } }, { { l, b }, { small, big } },
            { { l, t }, { small, b } }, { { l, t }, { small, small } }, { { l, t }, { r, small } }, { { r, t }, { small, small } } };
