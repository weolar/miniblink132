...
DEF_TEST(BO_EventQueueOrdering, reporter)
{
    { // Check that event types are ordered correctly.
        ...
        Segment s0 = { { 50, 50 }, { 150, 150 } }, s1 = { { 150, 50 }, { 50, 150 } };
...
struct TestEventHandler : public SweepLineInterface {
    TestEventHandler(skiatest::Reporter* r, Point eventPoint, SkSpan<const Segment> deletions, SkSpan<const Segment> insertions,
        SkSpan<const Crossing> crossings, HasDeletions hasDeletions = kHasDeletions)
        : fR(r)
