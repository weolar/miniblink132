...
{
    enum_<para::Affinity>("Affinity").value("Upstream", para::Affinity::kUpstream).value("Downstream", para::Affinity::kDownstream);
    ...
    enum_<para::RectWidthStyle>("RectWidthStyle").value("Tight", para::RectWidthStyle::kTight).value("Max", para::RectWidthStyle::kMax);
    ...
    enum_<para::TextBaseline>("TextBaseline").value("Alphabetic", para::TextBaseline::kAlphabetic).value("Ideographic", para::TextBaseline::kIdeographic);

    enum_<para::TextDirection>("TextDirection").value("LTR", para::TextDirection::kLtr).value("RTL", para::TextDirection::kRtl);
