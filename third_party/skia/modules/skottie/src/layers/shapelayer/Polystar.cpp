...
public:
    ...
    PolystarGeometryAdapter(const skjson::ObjectValue& jstar, const AnimationBuilder* abuilder, Type t)
        : fType(t)
    {
...
private:
    void onSync() override
    {
        ...
        const auto pt_on_circle = [](const SkV2& c, SkScalar r, SkScalar a) { return SkPoint::Make(c.x + r * std::cos(a), c.y + r * std::sin(a)); };
    ...
    ScalarValue fPointCount = 0, fRotation = 0, fInnerRadius = 0, fOuterRadius = 0, fInnerRoundness = 0, fOuterRoundness = 0;
};

} // namespace

sk_sp<sksg::GeometryNode> ShapeBuilder::AttachPolystarGeometry(const skjson::ObjectValue& jstar, const AnimationBuilder* abuilder)
{
