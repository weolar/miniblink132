...
static sk_sp<SkBlender> hardMix()
{
    static SkRuntimeEffect* hardMixEffect = [] {
        const char hardMix[] = "half4 main(half4 src, half4 dst) {"
...
static sk_sp<SkBlender> get_blender(const skjson::ObjectValue& jobject, const AnimationBuilder* abuilder)
{
...
sk_sp<sksg::RenderNode> AnimationBuilder::attachBlendMode(const skjson::ObjectValue& jobject, sk_sp<sksg::RenderNode> child) const
{
