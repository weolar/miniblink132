...
AnimationBuilder::ScopedAssetRef::ScopedAssetRef(const AnimationBuilder* abuilder, const skjson::ObjectValue& jlayer)
{
...
CompositionBuilder::CompositionBuilder(const AnimationBuilder& abuilder, const SkSize& size, const skjson::ObjectValue& jcomp)
    : fSize(size)
{
