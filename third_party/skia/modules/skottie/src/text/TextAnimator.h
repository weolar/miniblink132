...
public:
    ...
    struct AnimatedProps {
        VectorValue position, scale = { 100, 100, 100 };
        ...
        ScalarValue opacity = 100, fill_opacity = 100, stroke_opacity = 100, tracking = 0, stroke_width = 0;
    };
    ...
    {
        return fRequiresAnchorPoint;
    }
    bool requiresLineAdjustments() const
    {
        return fRequiresLineAdjustments;
    }

private:
    TextAnimator(std::vector<sk_sp<RangeSelector>>&&, const skjson::ObjectValue&, const AnimationBuilder*, AnimatablePropertyContainer*);
    ...
    bool fHasFillColor : 1, fHasStrokeColor : 1, fHasFillOpacity : 1, fHasStrokeOpacity : 1, fHasOpacity : 1, fHasBlur : 1,
