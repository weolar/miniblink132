...
public:
    static sk_sp<TextAdapter> Make(
        const skjson::ObjectValue&, const AnimationBuilder*, sk_sp<SkFontMgr>, sk_sp<CustomFont::GlyphCompMapper>, sk_sp<Logger>, sk_sp<::SkShapers::Factory>);
...
private:
    ...
    TextAdapter(sk_sp<SkFontMgr>, sk_sp<CustomFont::GlyphCompMapper>, sk_sp<Logger>, sk_sp<SkShapers::Factory>, AnchorPointGrouping);
    ...
    void pushPropsToFragment(
        const TextAnimator::ResolvedProps&, const FragmentRec&, const SkV2& frag_offset, const SkV2& grouping_alignment, const TextAnimator::DomainSpan*) const;
    ...
    struct TextValueTracker {
        ...
        const TextValue* operator->() const
        {
