...
public:
    static sk_sp<InvertEffectAdapter> Make(const skjson::ArrayValue& jprops, sk_sp<sksg::RenderNode> layer, const AnimationBuilder* abuilder)
    {
...
private:
    InvertEffectAdapter(const skjson::ArrayValue& jprops, sk_sp<sksg::RenderNode> layer, const AnimationBuilder* abuilder)
    ...
    void onSync() override
    {
        ...
        SkColorMatrix m(stcm.scale[0], 0, 0, 0, stcm.trans[0], 0, stcm.scale[1], 0, 0, stcm.trans[1], 0, 0, stcm.scale[2], 0, stcm.trans[2], 0, 0, 0,
            stcm.scale[3], stcm.trans[3]
        ...
        if (stcm.cs == CS::kYIQ) {
            ...
            static constexpr SkColorMatrix YIQ2RGB(1, 0.9560f, 0.6190f, 0, 0, 1, -0.2720f, -0.6470f, 0, 0, 1, -1.1060f, 1.7030f, 0, 0, 0, 0, 0, 1, 0);
...
sk_sp<sksg::RenderNode> EffectBuilder::attachInvertEffect(const skjson::ArrayValue& jprops, sk_sp<sksg::RenderNode> layer) const
{
