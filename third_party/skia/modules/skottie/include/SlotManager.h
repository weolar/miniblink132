...
private:
    ...
    void trackColorValue(const SlotID&, ColorValue*, sk_sp<skottie::internal::AnimatablePropertyContainer>);
    sk_sp<skresources::ImageAsset> trackImageValue(const SlotID&, sk_sp<skresources::ImageAsset>);
    void trackScalarValue(const SlotID&, ScalarValue*, sk_sp<skottie::internal::AnimatablePropertyContainer>);
    void trackVec2Value(const SlotID&, Vec2Value*, sk_sp<skottie::internal::AnimatablePropertyContainer>);
    ...
    template <typename T> using SlotMap = THashMap<SlotID, TArray<T>>;
