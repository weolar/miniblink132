...
template <class T> class SK_API ExpressionEvaluator : public SkRefCnt {
public:
...
private:
    ...
    Animation(sk_sp<sksg::RenderNode>, std::vector<sk_sp<internal::Animator>>&&, SkString ver, const SkSize& size, double inPoint, double outPoint,
        double duration, double fps, uint32_t flags);
