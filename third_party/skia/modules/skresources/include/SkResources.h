...
public:
     ...
     * ImageAsset proxy.
     */
    virtual sk_sp<ImageAsset> loadImageAsset(const char[] /* resource_path */, const char[] /* resource_name */, const char[] /* resource_id   */) const
    {
        return nullptr;
    }
     ...
     */
    virtual sk_sp<ExternalTrackAsset> loadAudioAsset(const char[] /* resource_path */, const char[] /* resource_name */, const char[] /* resource_id   */)
    {
        return nullptr;
    }
...
public:
    ...
    {
        return rp ? sk_sp<CachingResourceProvider>(new CachingResourceProvider(std::move(rp))) : nullptr;
    }
...
public:
    ...
    static sk_sp<DataURIResourceProviderProxy> Make(
        sk_sp<ResourceProvider> rp, ImageDecodeStrategy = ImageDecodeStrategy::kLazyDecode, sk_sp<const SkFontMgr> fontMgr = nullptr);

private:
    DataURIResourceProviderProxy(sk_sp<ResourceProvider>, ImageDecodeStrategy, sk_sp<const SkFontMgr> fontMgr);
