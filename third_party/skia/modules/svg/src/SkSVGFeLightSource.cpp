...
{
    return INHERITED::parseAndSetAttribute(n, v) || this->setAzimuth(SkSVGAttributeParser::parse<SkSVGNumberType>("azimuth", n, v))
...
{
    return INHERITED::parseAndSetAttribute(n, v) || this->setX(SkSVGAttributeParser::parse<SkSVGNumberType>("x", n, v))
        || this->setY(SkSVGAttributeParser::parse<SkSVGNumberType>("y", n, v)) || this->setZ(SkSVGAttributeParser::parse<SkSVGNumberType>("z", n, v));
}
...
bool SkSVGFeSpotLight::parseAndSetAttribute(const char* n, const char* v)
{
    return INHERITED::parseAndSetAttribute(n, v) || this->setX(SkSVGAttributeParser::parse<SkSVGNumberType>("x", n, v))
        ...
        || this->setLimitingConeAngle(SkSVGAttributeParser::parse<SkSVGNumberType>("limitingConeAngle", n, v));
}
