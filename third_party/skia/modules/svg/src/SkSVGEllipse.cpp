...
{
    return INHERITED::parseAndSetAttribute(n, v) || this->setCx(SkSVGAttributeParser::parse<SkSVGLength>("cx", n, v))
        || this->setCy(SkSVGAttributeParser::parse<SkSVGLength>("cy", n, v)) || this->setRx(SkSVGAttributeParser::parse<SkSVGLength>("rx", n, v))
...
SkRect SkSVGEllipse::resolve(const SkSVGLengthContext& lctx) const
{
    ...
    return (rx > 0 && ry > 0) ? SkRect::MakeXYWH(cx - rx, cy - ry, rx * 2, ry * 2) : SkRect::MakeEmpty();
}
