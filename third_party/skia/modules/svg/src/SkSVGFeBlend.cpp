...
sk_sp<SkImageFilter> SkSVGFeBlend::onMakeImageFilter(const SkSVGRenderContext& ctx, const SkSVGFilterContext& fctx) const
{
...
template <> bool SkSVGAttributeParser::parse<SkSVGFeBlend::Mode>(SkSVGFeBlend::Mode* mode)
{
