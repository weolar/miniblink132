...
public:
    ...
    SkSVGProperty()
        : fState(SkSVGPropertyState::kUnspecified)
    {
    }

    explicit SkSVGProperty(SkSVGPropertyState state)
        : fState(state)
    {
    }

    explicit SkSVGProperty(const T& value)
        : fState(SkSVGPropertyState::kValue)
    {
        fValue = value;
    }

    explicit SkSVGProperty(T&& value)
        : fState(SkSVGPropertyState::kValue)
    {
    ...
    bool isValue() const
    {
        return fState == SkSVGPropertyState::kValue;
    }
...
public:
    ...
    SkSVGColor()
        : SkSVGColor(SK_ColorBLACK)
    {
    }
    explicit SkSVGColor(const SkSVGColorType& c)
        : fType(Type::kColor)
        , fColor(c)
        , fVars(nullptr)
    {
...
public:
    ...
    explicit SkSVGPaint(Type t)
        : fType(t)
        , fColor(SK_ColorBLACK)
    {
    }
    explicit SkSVGPaint(SkSVGColor c)
        : fType(Type::kColor)
        , fColor(std::move(c))
    {
    }
    SkSVGPaint(const SkSVGIRI& iri, SkSVGColor fallback_color)
        : fType(Type::kIRI)
        , fColor(std::move(fallback_color))
        , fIRI(iri)
    {
    }
...
public:
    ...
    explicit SkSVGFuncIRI(Type t)
        : fType(t)
    {
    }
    explicit SkSVGFuncIRI(SkSVGIRI&& iri)
        : fType(Type::kIRI)
        , fIRI(std::move(iri))
    {
    }
...
public:
    ...
    constexpr explicit SkSVGLineJoin(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    constexpr explicit SkSVGSpreadMethod(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    constexpr explicit SkSVGFillRule(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    constexpr explicit SkSVGVisibility(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    explicit SkSVGDashArray(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    explicit SkSVGStopColor(Type t)
        : fType(t)
        , fColor(SK_ColorBLACK)
    {
    }
    explicit SkSVGStopColor(const SkSVGColorType& c)
        : fType(Type::kColor)
        , fColor(c)
    {
    }
...
public:
    ...
    SkSVGObjectBoundingBoxUnits()
        : fType(Type::kUserSpaceOnUse)
    {
    }
    explicit SkSVGObjectBoundingBoxUnits(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    explicit SkSVGFontStyle(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    explicit SkSVGFontWeight(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    explicit SkSVGTextAnchor(Type t)
        : fType(t)
    {
    }
...
public:
    ...
    SkSVGFeInputType()
        : fType(Type::kUnspecified)
    {
    }
    explicit SkSVGFeInputType(Type t)
        : fType(t)
    {
    }
...
struct SK_API SkSVGFeTurbulenceType {
    ...
    explicit SkSVGFeTurbulenceType(Type type)
        : fType(type)
    {
    }
};
