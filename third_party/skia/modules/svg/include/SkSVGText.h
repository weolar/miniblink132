...
protected:
    explicit SkSVGTextFragment(SkSVGTag t)
        : INHERITED(t)
    {
    }
...
protected:
    explicit SkSVGTextContainer(SkSVGTag t)
        : INHERITED(t)
    {
    }
...
public:
    ...
    {
        return sk_sp<SkSVGTSpan>(new SkSVGTSpan());
    }

private:
    SkSVGTSpan()
        : INHERITED(SkSVGTag::kTSpan)
    {
    }
...
private:
    SkSVGTextLiteral()
        : INHERITED(SkSVGTag::kTextLiteral)
    {
    }
...
public:
    ...
    {
        return sk_sp<SkSVGTextPath>(new SkSVGTextPath());
    }
