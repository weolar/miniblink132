...
private:                                                                                                                                                       \
    bool set##attr_name(SkSVGAttributeParser::ParseResult<SkSVGProperty<attr_type, attr_inherited>>&& pr)                                                      \
    {                                                                                                                                                          \
        if (pr.isValid()) {                                                                                                                                    \
...
private:                                                                                                                                                       \
    SkTLazy<attr_type> f##attr_name;                                                                                                                           \
                                                                                                                                                               \
public:                                                                                                                                                        \
    const SkTLazy<attr_type>& get##attr_name() const                                                                                                           \
    {                                                                                                                                                          \
        return f##attr_name;                                                                                                                                   \
    }                                                                                                                                                          \
    _SVG_ATTR_SETTERS(                                                                                                                                         \
        attr_name, attr_type, attr_default, [this](const attr_type& a) { this->f##attr_name.set(a); },                                                         \
