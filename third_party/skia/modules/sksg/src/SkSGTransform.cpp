...
sk_sp<Transform> Transform::MakeConcat(sk_sp<Transform> a, sk_sp<Transform> b)
{
    ...
    return TransformPriv::Is44(a) || TransformPriv::Is44(b) ? sk_sp<Transform>(new Concat<SkM44>(std::move(a), std::move(b)))
...
sk_sp<Transform> Transform::MakeInverse(sk_sp<Transform> t)
{
    ...
    return TransformPriv::Is44(t) ? sk_sp<Transform>(new Inverse<SkM44>(std::move(t))) : sk_sp<Transform>(new Inverse<SkMatrix>(std::move(t)));
}
