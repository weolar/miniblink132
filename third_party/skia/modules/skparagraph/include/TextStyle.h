...
struct Decoration {
    ...
    {
        return this->fType == other.fType && this->fMode == other.fMode && this->fColor == other.fColor && this->fStyle == other.fStyle
...
public:
    ...
    {
        setForegroundPaint(std::move(paint));
    }
    ...
    {
        setBackgroundPaint(std::move(paint));
    }
    ...
    {
        return fFontFeatures.size();
    }
    std::vector<FontFeature> getFontFeatures() const
    {
        return fFontFeatures;
    }
    ...
    {
        return fHeightOverride ? fHeight : 0;
    }
...
private:
    ...
    Decoration fDecoration = { TextDecoration::kNoDecoration,
