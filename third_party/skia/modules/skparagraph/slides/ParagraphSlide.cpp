    ...
    void drawTest(SkCanvas* canvas, SkScalar w, SkScalar h, SkColor fg, SkColor bg)
    {
        ...
        for (auto i = 1; i < 5; ++i) {
            ...
            for (auto para : gParagraph) {
                ...
                SkFontStyle fontStyle(std::get<1>(para) ? SkFontStyle::Weight::kBold_Weight : SkFontStyle::Weight::kNormal_Weight,
                    SkFontStyle::Width::kNormal_Width, std::get<2>(para) ? SkFontStyle::Slant::kItalic_Slant : SkFontStyle::Slant::kUpright_Slant);
                ...
                name = " " + std::get<0>(para) + " " + (std::get<1>(para) ? ", bold" : "") + (std::get<2>(para) ? ", italic" : "") + " "
                    + std::to_string(std::get<3>(para) * i) + (std::get<4>(para) != bg ? ", background" : "") + (std::get<5>(para) != fg ? ", foreground" : "")
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        std::vector<const char*> cupertino = { "google_logogoogle_gsuper_g_logo 1 "
                                               ...
                                               "google_logogoogle_gsuper_g_logo "
                                               "google_logogoogle_gsuper_g_logo" };
        std::vector<const char*> text = { "My neighbor came over to say,\n"
                                          "Although not in a neighborly way,\n\n"
                                          "That he'd knock me around,\n\n\n"
                                          "If I didn't stop the sound,\n\n\n\n"
                                          "Of the classical music I play." };

        std::vector<const char*> long_word = { "A_very_very_very_very_very_very_very_very_very_very_very_very_very_very_very_very_"
        ...
        std::vector<const char*> very_long = { "A very very very very very very very very very very very very very very very very "
                                               "very very very very very very very very very very very very very very very very "
                                               "very very very very very very very very very very very very very very very very "
                                               "very very very very very very very long text" };

        std::vector<const char*> very_word = { "A very_very_very_very_very_very_very_very_very_very "
...
private:
    ...
    void drawText(SkCanvas* canvas, SkScalar w, SkScalar h, std::vector<const char*>& text, SkColor fg = SK_ColorDKGRAY, SkColor bg = SK_ColorWHITE,
        const char* ff = "sans-serif", SkScalar fs = 24, size_t lineLimit = 30, const std::u16string& ellipsis = u"\u2026")
    {
        SkAutoCanvasRestore acr(canvas, true);
        ...
        style.setFontStyle(SkFontStyle(SkFontStyle::kMedium_Weight, SkFontStyle::kNormal_Width, SkFontStyle::kUpright_Slant));
...
private:
    void drawLine(SkCanvas* canvas, SkScalar w, SkScalar h, const std::string& text, TextAlign align, size_t lineLimit = std::numeric_limits<size_t>::max(),
        bool RTL = false, SkColor background = SK_ColorGRAY, const std::u16string& ellipsis = u"\u2026")
    {
        SkAutoCanvasRestore acr(canvas, true);
...
private:
    void bidi(SkCanvas* canvas, SkScalar w, SkScalar h, const std::u16string& text, const std::u16string& expected,
        size_t lineLimit = std::numeric_limits<size_t>::max(), const char* ff = "Roboto", SkScalar fs = 30, const std::u16string& ellipsis = u"\u2026")
    {
        SkAutoCanvasRestore acr(canvas, true);
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        text_style.setFontFamilies({ SkString("Roboto"), SkString("Noto Color Emoji"), SkString("Noto Serif CJK JP") });
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        for (auto& query : hit1) {
            auto hitRects = paragraph->getRectsForRange(query.fX, query.fY, RectHeightStyle::kTight, RectWidthStyle::kTight);
        ...
        for (auto& query : miss) {
            auto missRects = paragraph->getRectsForRange(query.fX, query.fY, RectHeightStyle::kTight, RectWidthStyle::kTight);
            if (missRects.empty()) {
            } else {
                if (this->isVerbose()) {
                    SkDebugf("-[%u:%u): Bad\n", query.fX, query.fY);
...
class Zalgo {
private:
    std::u16string COMBINING_DOWN = u"\u0316\u0317\u0318\u0319\u031c\u031d\u031e\u031f\u0320\u0324\u0325\u0326\u0329\u032a\u032b\u032c\u032d\u032e\u032f\u0330"
                                    u"\u0331\u0332\u0333\u0339\u033a\u033b\u033c\u0345\u0347\u0348\u0349\u034d\u034e\u0353\u0354\u0355\u0356\u0359\u035a\u0323";
    std::u16string COMBINING_UP
        = u"\u030d\u030e\u0304\u0305\u033f\u0311\u0306\u0310\u0352\u0357\u0351\u0307\u0308\u030a\u0342\u0343\u0344\u034a\u034b\u034c\u0303\u0302\u030c\u0350"
          u"\u0300\u0301\u030b\u030f\u0312\u0313\u0314\u033d\u0309\u0363\u0364\u0365\u0366\u0367\u0368\u0369\u036a\u036b\u036c\u036d\u036e\u035b\u0346\u031a";
    std::u16string COMBINING_MIDDLE
        = u"\u0315\u031b\u0340\u0341\u0358\u0321\u0322\u0327\u0328\u0334\u0335\u0336\u034f\u035c\u035d\u035e\u035f\u0360\u0362\u0338\u0337\u0361\u0489";
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        std::u16string text = u"\u0068\u0301\u0350\u0312\u0357\u030C\u0369\u0305\u036C\u0304\u0310\u033F\u0366\u0350\u0343\u0364\u0369\u0311\u0309\u030E\u0365"
                              u"\u031B\u0340\u0337\u0335\u035E\u0334\u0328\u0360\u0360\u0315\u035F\u0340\u0340\u0362\u0360\u0322\u031B\u031B\u0337\u0340\u031E"
                              u"\u031F\u032A\u0331\u0345\u032F\u0332\u032E\u0333\u0353\u0320\u0345\u031C\u031F\u033C\u0325\u0355\u032C\u0325\u033Aa\u0307\u0312"
                              u"\u034B\u0308\u0312\u0346\u0313\u0346\u0304\u0307\u0344\u0305\u0342\u0368\u0346\u036A\u035B\u030F\u0365\u0307\u0340\u0328\u0322"
                              u"\u0361\u0489\u034F\u0328\u0334\u035F\u0335\u0362\u0489\u0360\u0358\u035E\u0360\u035D\u0341\u0337\u0337\u032E\u0326\u032D\u0359"
                              u"\u0318\u033C\u032F\u0333\u035A\u034D\u0319\u031C\u0353\u033C\u0345\u0359\u0331\u033B\u0331\u033C";
        ParagraphStyle paragraph_style;
        ParagraphBuilderImpl builder(paragraph_style, fontCollection, get_unicode());
        TextStyle text_style;
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        ParagraphBuilderImpl builder(paragraphStyle, fontCollection, get_unicode());
        builder.addText(
            u"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam ut dolor ornare, fermentum nibh in, consectetur libero. Ut id semper est. Sed "
            u"malesuada, est id bibendum egestas, urna risus tristique nibh, euismod interdum risus turpis nec purus. Maecenas dolor nisl, consectetur in "
            u"vestibulum et, tincidunt id leo. Duis maximus, odio eget tristique commodo, lacus tellus dapibus leo, consequat pellentesque arcu nisi sit amet "
            u"diam. Quisque euismod venenatis egestas. Mauris posuere volutpat iaculis. Suspendisse finibus tempor urna, dignissim venenatis sapien finibus "
            u"eget. Donec interdum lacus ac venenatis fringilla. Curabitur eget lacinia augue. Vestibulum eu vulputate odio. Quisque nec imperdiet");
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        auto draw = [&](SkScalar width, SkScalar height, TextDirection td, TextAlign ta, const char* t) {
            ...
            for (auto& line : impl->lines()) {
                ...
                line.iterateThroughVisualRuns(true, [&](const Run* run, SkScalar runOffset, TextRange textRange, SkScalar* width) {
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        if (this->isVerbose()) {
            ...
            SkDebugf("%d(%s) %d(%s) %d(%s)\n", f1Pos.position, f1Pos.affinity == Affinity::kUpstream ? "up" : "down", f2Pos.position,
                f2Pos.affinity == Affinity::kUpstream ? "up" : "down", iPos.position, iPos.affinity == Affinity::kUpstream ? "up" : "down");
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        const std::u16string text
            = //u"\U0001f600\U0001f1e6\U0001f1f9\U0001f601\U0001f9f1\U0001f61a\U0001f431\U0001f642\U0001f38e\U0001f60d\U0001f3b9\U0001f917\U0001f6bb\U0001f609\U0001f353\U0001f618\U0001f1eb\U0001f1f0\U0001f468\u200D\U0001f469\u200D\U0001f466\u200D\U0001f466\U0001f468\u200D\U0001f469\u200D\U0001f467\u200D\U0001f466\U0001f468\u200D\U0001f469\u200D\U0001f467\U0001f46a";
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        canvas->drawRect(SkRect::MakeXYWH(0, 0, this->size().width() / 2, paragraph->getHeight()), paint);
        paragraph->paint(canvas, 0, 0);
    }
};
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        while (wordPos < 72) {
            ...
            wordPos = res2.end;
            auto res3 = paragraph->getRectsForRange(res2.start, res2.end, RectHeightStyle::kTight, RectWidthStyle::kTight);
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        auto text = u"hzbzzj sjsjjs sjkkahgafa\u09A4\u09A1\u09A4\u09A0\u09A4\u09A0 jsjzjgvsh sjsjsksbsbsjs sjjajajahhav jssjbxx jsisudg "
                    u"\u09AF\u09A0\u09AF\u09A0\u09A4\u09A0\u09A4\u09A0\u09A5 "
                    u"\u062A\u0624\u062A\u064A\u0646\u0646\u064A\u0621\u0646\u0627\u0644\u0631\u0631\u064A\u0644\u0627 \u062A\u062A\u0644\u0649 "
                    u"\u062A\u0627\u0631\u064A\u062E \u062A\u0633\u0628\u0628 \u0624\u062A\u064A\u062A\u0624\u062A\u0624\u062A\u0624\u062A\u0624 dhishsbs "
                    u"\u7238\u7238\u4E0D\u5BF9\u52B2\u5927\u5BB6\u90FD\u597D\u8BB0\u5F97\u8BB0\u5F97hshs\u099B\u09A1\u099B\u09A1\u099A jdjdj jdjdjd "
                    u"dbbdbdbdbddbnd\u09A2\u099B\u09A1\u09A2\u09A3\u099B\u09B0\u099A\u0998\u09A0\u09A0\u09B8\u09AB\u0997\u09A3\u09A4\u099C\u09B0\u09A5\u099B"
                    u"\u099B\u09A5\u09A6\u099D\u09A6\u09B2\u09A5\u09A4\u09A3\u09A2\u0997\u0996\u09A0\u0998\u0999\u09A3\u099A\u09A5\u09A4\u09A3\u062A\u0628"
                    u"\u0646\u064A\u0646 \u09A5\u09A3\u09A3 \u09A4\u0998\u0998\u0998\u099B\u09A4 \u09A4\u09A3 "
                    u"\u09A3\u0998\u09A2\u09A3\u0999\u0648\u064A\u0648\u0621\u062A\u064A\u0632\u0633\u0646\u0632\u0624\u0624\u0645\u0645\u0624\u0648\u0624"
                    u"\u0648\u0648\u064A\u0646\u0624\u0646\u0624\u0646\u0624\u0624 \u09A4\u09A4\u09A2\u09A2\u09A4\u09A4 \u0999\u0998\u0997\u09C1\u099B\u09A5 "
                    u"\u09A4\u0997\u0998\u09A3\u099A\u099C\u09A6\u09A5\u0632\u0624\u0648\u0624\u0648\u0624 "
                    u"\u09A4\u09A4\u09A3\u0998\u09A2\u09A4\u099B\u09A6\u09A5\u09A4\u0999\u0998\u09A3 "
                    u"\u0648\u0624\u0648\u0624\u0648\u0624\u0632\u0624\u0646\u0633\u0643\u0633\u0643\u0628\u0646\u09A4\u09AD\u0996\u0996\u099F\u09C0\u09C1"
                    u"\u099B\u09A6\u09C0\u09C1\u09C2\u09C7\u0648\u0624\u0646\u0621\u0646\u0624\u0646 "
                    u"\u09C7\u09C2\u09C0\u09C2\u099A\u09A3\u09A2\u09A4\u09A5\u09A5\u0632\u064A\u09C7\u09C2\u09C0\u09C2\u099A\u09A3\u09A2\u09AE\u09A4\u09A5"
                    u"\u09A5 \U0001f34d\U0001f955\U0001f4a7\U0001f4a7\U0001f4a6\U0001f32a";
        auto fontCollection = sk_make_sp<FontCollection>();
        fontCollection->setDefaultFontManager(ToolUtils::TestFontMgr());
        fontCollection->enableFontFallback();
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        std::set<std::pair<std::string, std::string>> font_paths = { { "Roboto", "Roboto-Regular.ttf" }, { "Roboto", "Roboto-Bold.ttf" },
            { "Noto", "NotoSansCJK-Regular.ttc" }, { "Noto", "NotoSansCJK-Bold.ttc" }, { "Emoji", "NotoColorEmoji.ttf" } };
        ...
        for (auto& pair : font_paths) {
            ...
            font_provider->registerTypeface(ToolUtils::TestFontMgr()->makeFromData(std::move(data)), family_name);
        }
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        for (auto x = 0.0f; x < paragraph->getMaxIntrinsicWidth(); x += 5.0f) {
            ...
            SkDebugf("@x=%f [0:%d%s=%d) ", x, pos.position, pos.affinity == Affinity::kDownstream ? "D" : "U", p);
            for (auto& rect : rects) {
...
public:
    ...
    {
        fName = SkString("ParagraphSlide_MultiStyle_Logo");
    }
...
public:
    ...
    {
        fName = SkString("ParagraphSlide_MultiStyle_FFI");
    }
...
public:
    ...
    {
        fName = SkString("ParagraphSlide_MultiStyle_EmojiFamily");
    }
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        if (this->isVerbose()) {
            ...
            SkDebugf("%d(%s) %d(%s) %d(%s) %d(%s)\n", pos00.position, pos00.affinity == Affinity::kUpstream ? "up" : "down", pos01.position,
                pos01.affinity == Affinity::kUpstream ? "up" : "down", pos10.position, pos10.affinity == Affinity::kUpstream ? "up" : "down", pos11.position,
                pos11.affinity == Affinity::kUpstream ? "up" : "down");
            ...
            if (f3.empty()) {
                ...
                auto rf3 = f3[0];
                SkDebugf("i:  [%f:%f] %s\n", rf3.rect.fLeft, rf3.rect.fRight, rf3.direction == TextDirection::kRtl ? "rtl" : "ltr");
            }
            ...
            if (f4.empty()) {
                ...
                auto rf4 = f4[0];
                SkDebugf("i:  [%f:%f] %s\n", rf4.rect.fLeft, rf4.rect.fRight, rf4.direction == TextDirection::kRtl ? "rtl" : "ltr");
            }
        }
    }
};
...
public:
    ParagraphSlide_MultiStyle_Arabic1()
    {
        fName = "SkStringParagraphSlide_MultiStyle_Arabic1";
    }
...
public:
    ...
    {
        fName = SkString("ParagraphSlide_MultiStyle_Zalgo");
    }
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        if (this->isVerbose()) {
            ...
            if (resSK.empty()) {
                ...
                rectSK = resSK[0];
                SkDebugf("rectSk: [%f:%f] %s\n", rectSK.rect.fLeft, rectSK.rect.fRight, rectSK.direction == TextDirection::kRtl ? "rtl" : "ltr");
            }
            ...
            if (resKP.empty()) {
                ...
                rectKP = resKP[0];
                SkDebugf("rectkP: [%f:%f] %s\n", rectKP.rect.fLeft, rectKP.rect.fRight, rectKP.direction == TextDirection::kRtl ? "rtl" : "ltr");
            }
            ...
            if (resPh.empty()) {
                ...
                rectPh = resPh[0];
                SkDebugf("rectPh:  [%f:%f] %s\n", rectPh.rect.fLeft, rectPh.rect.fRight, rectPh.direction == TextDirection::kRtl ? "rtl" : "ltr");
            }
            ...
            SkDebugf("%d(%s) %d(%s) %d(%s)\n", posK.position, posK.affinity == Affinity::kUpstream ? "up" : "down", posP.position,
                posP.affinity == Affinity::kUpstream ? "up" : "down", posH.position, posH.affinity == Affinity::kUpstream ? "up" : "down");
        }
    }
};
...
public:
    ...
    {
        fName = SkString("ParagraphSlide_MultiStyle_Arabic2");
    }
    void draw(SkCanvas* canvas) override
    {
        canvas->drawColor(SK_ColorWHITE);
...
public:
    ...
    {
        fName = "ParagraphSlideMixedTextDirection";
    }
    void draw(SkCanvas* canvas) override
    {
        canvas->drawColor(SK_ColorWHITE);
...
public:
    ...
    {
        fName = "ParagraphSlideExperiment";
    }
    void draw(SkCanvas* canvas) override
    {
        canvas->drawColor(SK_ColorWHITE);
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        const char* text2 = "左線読設重説切abc後碁給能上目秘使約。満毎冠行   来昼本可   def   必図将発確年。今属場育"
...
public:
    ...
    {
        fName = "ParagraphSlideEllipsisInRTL";
    }
    void draw(SkCanvas* canvas) override
    {
        canvas->drawColor(SK_ColorWHITE);
...
public:
    ...
    {
        fName = "ParagraphSlideEmojiSequence";
    }
    void draw(SkCanvas* canvas) override
    {
        canvas->drawColor(SK_ColorWHITE);
