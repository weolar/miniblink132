...
struct EditorLayer : public sk_app::Window::Layer {
    ...
    void setFont()
    {
        fEditor.setFont(SkFont(fontMgr()->matchFamilyStyle(kTypefaces[fTypefaceIndex], SkFontStyle(kFontWeight, kFontWidth, kFontSlant)), fFontSize));
    }
    ...
    bool onChar(SkUnichar c, skui::ModifierKey modi) override
    {
        ...
        if (!Any(modi & (skui::ModifierKey::kControl | skui::ModifierKey::kOption | skui::ModifierKey::kCommand))) {
        ...
        static constexpr skui::ModifierKey kCommandOrControl = skui::ModifierKey::kCommand | skui::ModifierKey::kControl;
    ...
    bool onKey(skui::Key key, skui::InputState state, skui::ModifierKey modifiers) override
    {
        ...
        using sknonstd::Any;
        skui::ModifierKey ctrlAltCmd = modifiers & (skui::ModifierKey::kControl | skui::ModifierKey::kOption | skui::ModifierKey::kCommand);
        ...
        } else if (sknonstd::Any(ctrlAltCmd & (skui::ModifierKey::kControl | skui::ModifierKey::kCommand))) {
            switch (key) {
            case skui::Key::kLeft:
...
struct EditorApplication : public sk_app::Application {
    ...
    EditorApplication(std::unique_ptr<sk_app::Window> win)
        : fWindow(std::move(win))
    {
    }
