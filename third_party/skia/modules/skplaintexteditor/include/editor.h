...
public:
    ...
    struct Text {
        ...
        {
            return Iterator { fLines.begin() };
        }
        Iterator end() const
        {
            return Iterator { fLines.end() };
        }
    };
...
static inline bool operator==(const SkPlainTextEditor::Editor::TextPosition& u, const SkPlainTextEditor::Editor::TextPosition& v)
{
...
static inline bool operator<(const SkPlainTextEditor::Editor::TextPosition& u, const SkPlainTextEditor::Editor::TextPosition& v)
{
    return u.fParagraphIndex < v.fParagraphIndex || (u.fParagraphIndex == v.fParagraphIndex && u.fTextByteIndex < v.fTextByteIndex);
}
