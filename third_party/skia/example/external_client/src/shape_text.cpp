...
constexpr const char* story = "The landing port at Titan had not changed much in five years.\n"
...
public:
    explicit OneFontStyleSet(sk_sp<SkTypeface> face)
        : face_(face)
    {
    }
...
public:
    explicit OneFontMgr(sk_sp<SkTypeface> face)
        : face_(face)
        , style_set_(sk_make_sp<OneFontStyleSet>(face))
    {
    }
...
int main(int argc, char** argv)
{
    ...
    sk_sp<SkSurface> surface = SkSurfaces::Raster(SkImageInfo::MakeN32(width, 200, kOpaque_SkAlphaType));
