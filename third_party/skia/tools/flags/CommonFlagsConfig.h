...
public:
    ...
    SkCommandLineConfigGpu(const SkString& tag, const skia_private::TArray<SkString>& viaParts, ContextType contextType, bool fakeGLESVer2,
        ...
        bool useDDLSink, bool slug, bool serializedSlug, bool remoteSlug, bool reducedShaders, SurfType);
...
public:
    ...
    SkCommandLineConfigGraphite(const SkString& tag, const skia_private::TArray<SkString>& viaParts, ContextType contextType, SkColorType colorType,
        SkAlphaType alphaType, bool testPrecompile)
    ...
    const SkCommandLineConfigGraphite* asConfigGraphite() const override
    {
        return this;
    }
