...
public:
    ...
    public:
        ...
        explicit StringArray(const skia_private::TArray<SkString>& strings)
            : fStrings(strings)
        {
        }
         ...
         */
        template <class E> SkString parseAndValidate(const char* name, const skia_private::THashMap<SkString, E>& possibleValues, E* out) const
        {
            if (size() == 0) {
...
#define DEFINE_bool(name, defaultValue, helpString)                                                                                                            \
    bool FLAGS_##name;                                                                                                                                         \
    [[maybe_unused]] static bool unused_##name = SkFlagInfo::CreateBoolFlag(TO_STRING(name), nullptr, &FLAGS_##name, defaultValue, helpString)
...
#define DEFINE_bool2(name, shortName, defaultValue, helpString)                                                                                                \
    bool FLAGS_##name;                                                                                                                                         \
    [[maybe_unused]] static bool unused_##name = SkFlagInfo::CreateBoolFlag(TO_STRING(name), TO_STRING(shortName), &FLAGS_##name, defaultValue, helpString)

#define DECLARE_bool(name) extern bool FLAGS_##name;

#define DEFINE_string(name, defaultValue, helpString)                                                                                                          \
    CommandLineFlags::StringArray FLAGS_##name;                                                                                                                \
    [[maybe_unused]] static bool unused_##name = SkFlagInfo::CreateStringFlag(TO_STRING(name), nullptr, &FLAGS_##name, defaultValue, helpString, nullptr)
#define DEFINE_extended_string(name, defaultValue, helpString, extendedHelpString)                                                                             \
    CommandLineFlags::StringArray FLAGS_##name;                                                                                                                \
    [[maybe_unused]] static bool unused_##name                                                                                                                 \
        = SkFlagInfo::CreateStringFlag(TO_STRING(name), nullptr, &FLAGS_##name, defaultValue, helpString, extendedHelpString)
...
#define DEFINE_string2(name, shortName, defaultValue, helpString)                                                                                              \
    CommandLineFlags::StringArray FLAGS_##name;                                                                                                                \
    [[maybe_unused]] static bool unused_##name                                                                                                                 \
        = SkFlagInfo::CreateStringFlag(TO_STRING(name), TO_STRING(shortName), &FLAGS_##name, defaultValue, helpString, nullptr)

#define DECLARE_string(name) extern CommandLineFlags::StringArray FLAGS_##name;

#define DEFINE_int(name, defaultValue, helpString)                                                                                                             \
    int FLAGS_##name;                                                                                                                                          \
    [[maybe_unused]] static bool unused_##name = SkFlagInfo::CreateIntFlag(TO_STRING(name), &FLAGS_##name, defaultValue, helpString)

#define DEFINE_int_2(name, shortName, defaultValue, helpString)                                                                                                \
    int FLAGS_##name;                                                                                                                                          \
    [[maybe_unused]] static bool unused_##name = SkFlagInfo::CreateIntFlag(TO_STRING(name), TO_STRING(shortName), &FLAGS_##name, defaultValue, helpString)

#define DECLARE_int(name) extern int FLAGS_##name;

#define DEFINE_double(name, defaultValue, helpString)                                                                                                          \
    double FLAGS_##name;                                                                                                                                       \
    [[maybe_unused]] static bool unused_##name = SkFlagInfo::CreateDoubleFlag(TO_STRING(name), &FLAGS_##name, defaultValue, helpString)
...
public:
     ...
     */
    static bool CreateStringFlag(const char* name, const char* shortName, CommandLineFlags::StringArray* pStrings, const char* defaultValue,
        const char* helpString, const char* extendedHelpString);
