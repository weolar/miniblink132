...
SkEventTracer::Handle SkPerfettoTrace::addTraceEvent(char phase, const uint8_t* categoryEnabledFlag, const char* name, uint64_t id, int numArgs,
    const char** argNames, const uint8_t* argTypes, const uint64_t* argValues, uint8_t flags)
{
    ...
    if (TRACE_EVENT_PHASE_COMPLETE == phase || TRACE_EVENT_PHASE_INSTANT == phase) {
        ...
        case 1: {
            this->triggerTraceEvent(categoryEnabledFlag, name, argNames[0], argTypes[0], argValues[0]);
            break;
        }
        case 2: {
            this->triggerTraceEvent(categoryEnabledFlag, name, argNames[0], argTypes[0], argValues[0], argNames[1], argTypes[1], argValues[1]);
            break;
        }
        }
...
void SkPerfettoTrace::updateTraceEventDuration(const uint8_t* categoryEnabledFlag, const char* name, SkEventTracer::Handle handle)
{
...
{
    perfetto::DynamicCategory category { this->getCategoryGroupName(categoryEnabledFlag) };
    TRACE_EVENT_BEGIN(category, nullptr, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
}

void SkPerfettoTrace::triggerTraceEvent(
    const uint8_t* categoryEnabledFlag, const char* eventName, const char* arg1Name, const uint8_t& arg1Type, const uint64_t& arg1Val)
{
    perfetto::DynamicCategory category { this->getCategoryGroupName(categoryEnabledFlag) };

    switch (arg1Type) {
    case TRACE_VALUE_TYPE_BOOL: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, SkToBool(arg1Val), [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_UINT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_INT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, static_cast<int64_t>(arg1Val), [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_DOUBLE: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, sk_bit_cast<double>(arg1Val), [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_POINTER: {
        TRACE_EVENT_BEGIN(
            category, nullptr, arg1Name, skia_private::TraceValueAsPointer(arg1Val), [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_COPY_STRING:
        [[fallthrough]]; // Perfetto always copies string data
    case TRACE_VALUE_TYPE_STRING: {
        TRACE_EVENT_BEGIN(
            category, nullptr, arg1Name, skia_private::TraceValueAsString(arg1Val), [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    default: {
        SkUNREACHABLE;
 ...
 */
template <typename T>
void begin_event_with_second_arg(
    const char* categoryName, const char* eventName, const char* arg1Name, T arg1Val, const char* arg2Name, const uint8_t& arg2Type, const uint64_t& arg2Val)
{
    ...
    case TRACE_VALUE_TYPE_BOOL: {
        TRACE_EVENT_BEGIN(
            category, nullptr, arg1Name, arg1Val, arg2Name, SkToBool(arg2Val), [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_UINT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg2Name, arg2Val, [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_INT: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg2Name, static_cast<int64_t>(arg2Val),
            [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_DOUBLE: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg2Name, sk_bit_cast<double>(arg2Val),
            [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_POINTER: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg2Name, skia_private::TraceValueAsPointer(arg2Val),
            [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    case TRACE_VALUE_TYPE_COPY_STRING:
        [[fallthrough]];
    case TRACE_VALUE_TYPE_STRING: {
        TRACE_EVENT_BEGIN(category, nullptr, arg1Name, arg1Val, arg2Name, skia_private::TraceValueAsString(arg2Val),
            [&](perfetto::EventContext ctx) { ctx.event()->set_name(eventName); });
        break;
    }
    default: {
...
void SkPerfettoTrace::triggerTraceEvent(const uint8_t* categoryEnabledFlag, const char* eventName, const char* arg1Name, const uint8_t& arg1Type,
    const uint64_t& arg1Val, const char* arg2Name, const uint8_t& arg2Type, const uint64_t& arg2Val)
{
    ...
    switch (arg1Type) {
    case TRACE_VALUE_TYPE_BOOL: {
        begin_event_with_second_arg(category, eventName, arg1Name, SkToBool(arg1Val), arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_UINT: {
        begin_event_with_second_arg(category, eventName, arg1Name, arg1Val, arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_INT: {
        begin_event_with_second_arg(category, eventName, arg1Name, static_cast<int64_t>(arg1Val), arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_DOUBLE: {
        begin_event_with_second_arg(category, eventName, arg1Name, sk_bit_cast<double>(arg1Val), arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_POINTER: {
        begin_event_with_second_arg(category, eventName, arg1Name, skia_private::TraceValueAsPointer(arg1Val), arg2Name, arg2Type, arg2Val);
        break;
    }
    case TRACE_VALUE_TYPE_COPY_STRING:
        [[fallthrough]];
    case TRACE_VALUE_TYPE_STRING: {
        begin_event_with_second_arg(category, eventName, arg1Name, skia_private::TraceValueAsString(arg1Val), arg2Name, arg2Type, arg2Val);
        break;
    }
    default: {
        SkUNREACHABLE;
