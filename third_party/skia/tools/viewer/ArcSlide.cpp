...
class ArcsSlide : public Slide {
    ...
    static void DrawLabel(SkCanvas* canvas, const SkRect& rect, SkScalar start, SkScalar sweep)
    {
        ...
        SkTextUtils::DrawString(canvas, str.c_str(), rect.centerX(), rect.fBottom + font.getSize() * 5 / 4, font, SkPaint(), SkTextUtils::kCenter_Align);
    }
    ...
    static void DrawArcs(SkCanvas* canvas)
    {
        ...
        static const SkScalar gAngles[] = { 0, 360, 0, 45, 0, -45, 720, 135, -90, 269, -90, 270, -90, 271, -180, -270, 225, 90 };
