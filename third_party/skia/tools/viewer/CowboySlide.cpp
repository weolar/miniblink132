...
public:
    AnimatedSVGSlide(const char* r, const char* n)
        : fResource(r)
    {
        fName = n;
    }
    ...
    void load(SkScalar w, SkScalar h) override
    {
        ...
        fDom = SkSVGDOM::Builder().setFontManager(ToolUtils::TestFontMgr()).setTextShapingFactory(SkShapers::BestAvailable()).make(svgStream);
        if (fDom) {
