...
protected:
    ...
    ClickHandlerSlide::Click* onFindClickHandler(SkScalar x, SkScalar y, skui::ModifierKey) override;
...
private:
    ...
    SkPoint fPoints[4] = { { 100.05f, 100.05f }, { 400.75f, 100.05f }, { 400.75f, 300.95f }, { 100.05f, 300.95f } };
...
ClickHandlerSlide::Click* StrokeVerbSlide::onFindClickHandler(SkScalar x, SkScalar y, skui::ModifierKey)
{
    for (int i = 0; i < 4; ++i) {
