...
static void draw_gradient2(SkCanvas* canvas, const SkRect& rect, SkScalar delta)
{
    ...
    SkScalar r1 = 2 * w / 5;
    SkPaint paint;
    paint.setShader(SkGradientShader::MakeTwoPointConical(c0, r0, c1, r1, colors, pos, std::size(pos), SkTileMode::kClamp));
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        canvas->drawString(txt, l + w / 2 + w * DELTA_SCALE * delta, t + h + SK_Scalar1 * 10, ToolUtils::DefaultFont(), SkPaint());
    }
