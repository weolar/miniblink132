...
{
    SkPoint src[4] = { { 556.25000f, 523.03003f }, { 556.23999f, 522.96002f }, { 556.21997f, 522.89001f }, { 556.21997f, 522.82001f } };
    SkPoint dst[11];
...
static void test_cubic2()
{
...

    {
        ...
        SkIRect ir;
        r.round(&ir);
        SkDebugf("[%g %g %g %g] [%x %x %x %x]\n", SkScalarToDouble(r.fLeft), SkScalarToDouble(r.fTop), SkScalarToDouble(r.fRight), SkScalarToDouble(r.fBottom),
...
public:
    ...
    void draw(SkCanvas* canvas) override
    {
        ...
        static const SkPaint::Join gJoins[] = { SkPaint::kBevel_Join, SkPaint::kMiter_Join, SkPaint::kRound_Join };
...
public:
    ...
    bool onChar(SkUnichar uni) override
    {
        ...
        case '=':
            ...
            break;
        case 'q':
            fShowInnerQuads = !fShowInnerQuads;
            break;
        default:
            return false;
        }
...
private:
    ...
    void showInnerQuads(SkCanvas* canvas)
    {
        ...
        SkPoint p0 = SkEvalQuadAt(&fPts[0], fT), p1 = SkEvalQuadAt(&fPts[1], fT), p2 = lerp(p0, p1, fT);
