...
public:
    TestingImageProvider()
        : fCache(kDefaultNumCachedImages)
    {
    }
    ...
    sk_sp<SkImage> findOrCreate(skgpu::graphite::Recorder* recorder, const SkImage* image, SkImage::RequiredProperties requiredProps) override
    {
