    ...
    : fSize(bitmap.info().dimensions())
{
    ...
    case kPremul_SkAlphaType:
        srcAlpha = skcms_AlphaFormat_PremulAsEncoded;
        break;
    }
    ...
    case kAlpha_8_SkColorType:
        srcFmt = skcms_PixelFormat_A_8;
        break;
    case kRGB_565_SkColorType:
        srcFmt = skcms_PixelFormat_BGR_565;
        break;
    case kARGB_4444_SkColorType:
        srcFmt = skcms_PixelFormat_ABGR_4444;
        break;
    case kRGBA_8888_SkColorType:
        srcFmt = skcms_PixelFormat_RGBA_8888;
        break;
    case kBGRA_8888_SkColorType:
        srcFmt = skcms_PixelFormat_BGRA_8888;
        break;
    case kSRGBA_8888_SkColorType:
        srcFmt = skcms_PixelFormat_RGBA_8888_sRGB;
        break;
    ...
    case kBGR_101010x_XR_SkColorType:
        srcFmt = skcms_PixelFormat_BGR_101010x_XR;
        break;
    case kGray_8_SkColorType:
        srcFmt = skcms_PixelFormat_G_8;
        break;
    ...
    case kRGBA_F16Norm_SkColorType:
        srcFmt = skcms_PixelFormat_RGBA_hhhh;
        break;
    case kRGBA_F16_SkColorType:
        srcFmt = skcms_PixelFormat_RGBA_hhhh;
        break;
    case kRGBA_F32_SkColorType:
        srcFmt = skcms_PixelFormat_RGBA_ffff;
        break;
    ...
    while (N > 0) {
        ...
        if (!skcms_Transform(src, srcFmt, srcAlpha, &srcProfile, dst, dstFmt, dstAlpha, &dstProfile, todo)) {
            SkASSERT(false);
...
bool HashAndEncode::encodePNG(SkWStream* st, const char* md5, CommandLineFlags::StringArray key, CommandLineFlags::StringArray properties) const
{
    if (!fPixels) {
        return false;
    }
    ...
    png_set_IHDR(png, info, (png_uint_32)fSize.width(), (png_uint_32)fSize.height(), 16 /*bits per channel*/
        ,
    ...
    static const sk_sp<SkData> profile = SkWriteICCProfile(SkNamedTransferFn::kRec2020, SkNamedGamut::kRec2020);
    png_set_iCCP(png, info, "Rec.2020", 0 /*compression type... no idea what options are available here*/, (png_const_bytep)profile->data(),
