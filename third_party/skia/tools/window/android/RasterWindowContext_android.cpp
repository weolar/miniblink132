...
RasterWindowContext_android::RasterWindowContext_android(ANativeWindow* window, const DisplayParams& params)
...
sk_sp<SkSurface> RasterWindowContext_android::getBackbufferSurface()
{
    if (nullptr == fBackbufferSurface) {
        ...
        fBackbufferSurface = SkSurfaces::WrapPixels(info, fBuffer.bits, fBuffer.stride * bytePerPixel, nullptr);
    }
