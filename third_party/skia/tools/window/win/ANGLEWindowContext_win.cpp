...
EGLDisplay ANGLEWindowContext_win::onGetEGLDisplay(PFNEGLGETPLATFORMDISPLAYEXTPROC eglGetPlatformDisplayEXT) const
{
...
NativeWindowType ANGLEWindowContext_win::onGetNativeWindow() const
{
    return fHWND;
}
