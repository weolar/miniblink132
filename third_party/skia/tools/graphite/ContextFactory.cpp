...
ContextFactory::OwnedContextInfo::OwnedContextInfo(
    skgpu::ContextType type, std::unique_ptr<GraphiteTestContext> testContext, std::unique_ptr<skgpu::graphite::Context> context)
    : fType(type)
...
ContextFactory::OwnedContextInfo& ContextFactory::OwnedContextInfo::operator=(OwnedContextInfo&&) = default;
