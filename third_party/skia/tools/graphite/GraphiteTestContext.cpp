...
void GraphiteTestContext::submitRecordingAndWaitOnSync(skgpu::graphite::Context* context, skgpu::graphite::Recording* recording)
{
...
{
    skgpu::graphite::SyncToCpu sync = context->priv().caps()->allowCpuSync() ? skgpu::graphite::SyncToCpu::kYes : skgpu::graphite::SyncToCpu::kNo;
    context->submit(sync);
