 ...
 */
sk_sp<SkImage> MakeBackendTextureImage(GrDirectContext*, const SkPixmap&, Renderable, GrSurfaceOrigin, Protected = Protected::kNo);

/** Creates a solid color image. */
sk_sp<SkImage> MakeBackendTextureImage(GrDirectContext*, const SkImageInfo& info, SkColor4f, Mipmapped = Mipmapped::kNo, Renderable = Renderable::kNo,
    GrSurfaceOrigin = GrSurfaceOrigin::kTopLeft_GrSurfaceOrigin, Protected isProtected = Protected::kNo);
#endif // SK_GANESH
 ...
 */
sk_sp<SkImage> MakeBackendTextureImage(skgpu::graphite::Recorder*, const SkPixmap&, Mipmapped, Renderable, Origin, Protected = Protected::kNo);

/** Creates a solid color image. */
sk_sp<SkImage> MakeBackendTextureImage(skgpu::graphite::Recorder*, const SkImageInfo&, SkColor4f, Mipmapped, Renderable, Origin, Protected = Protected::kNo);
