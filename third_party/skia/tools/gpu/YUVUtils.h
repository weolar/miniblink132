...
public:
    ...
    static std::unique_ptr<LazyYUVImage> Make(SkYUVAPixmaps, skgpu::Mipmapped = skgpu::Mipmapped::kNo, sk_sp<SkColorSpace> = nullptr);

    enum class Type { kFromPixmaps, kFromGenerator, kFromTextures, kFromImages };

    SkISize dimensions() const
    {
        return fPixmaps.yuvaInfo().dimensions();
    }
