...
template <> class TestCanvas<SkSlugTestKey> : public SkCanvas {
public:
...
template <> class TestCanvas<SkSerializeSlugTestKey> : public SkCanvas {
public:
    TestCanvas(SkCanvas* canvas);
    void onDrawGlyphRunList(const sktext::GlyphRunList& glyphRunList, const SkPaint& paint) override;
};
...
template <> class TestCanvas<SkRemoteSlugTestKey> : public SkCanvas {
public:
    TestCanvas(SkCanvas* canvas);
    ~TestCanvas() override;
    void onDrawGlyphRunList(const sktext::GlyphRunList& glyphRunList, const SkPaint& paint) override;
