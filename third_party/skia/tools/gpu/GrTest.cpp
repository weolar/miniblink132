...
#define DRAW_OP_TEST_EXTERN(Op) extern GrOp::Owner Op##__Test(GrPaint&&, SkRandom*, GrRecordingContext*, skgpu::ganesh::SurfaceDrawContext*, int)
...
void GrDrawRandomOp(SkRandom* random, skgpu::ganesh::SurfaceDrawContext* sdc, GrPaint&& paint)
{
    ...
    using MakeDrawOpFn = GrOp::Owner(GrPaint&&, SkRandom*, GrRecordingContext*, skgpu::ganesh::SurfaceDrawContext*, int numSamples);
