...
public:
    ...
    {
        return fGlobalOptions;
    }

private:
    ContextInfo getContextInfoInternal(ContextType type, ContextOverrides overrides, GrDirectContext* shareContext, uint32_t shareIndex);
...
public:
    ...
    {
        return skgpu::ganesh::ContextTypeBackend(fType);
    }
...
private:
    ContextInfo(skgpu::ContextType type, TestContext* testContext, GrDirectContext* context, const GrContextOptions& options)
        : fType(type)
