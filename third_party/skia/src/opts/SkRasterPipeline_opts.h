...
#if defined(SKRP_CPU_SCALAR) || defined(SKRP_CPU_NEON) || defined(SKRP_CPU_HSW) || defined(SKRP_CPU_SKX) || defined(SKRP_CPU_AVX) || defined(SKRP_CPU_SSE41)   \
...
template <typename T> SI T gather(const T* p, U32 ix)
{
    return p[ix];
}
...
SI U16 pack(U32 v)
{
    return __builtin_convertvector(v, U16);
}
SI U8 pack(U16 v)
{
    return __builtin_convertvector(v, U8);
}

SI F if_then_else(I32 c, F t, F e)
{
    return vbslq_f32((U32)c, t, e);
}
SI I32 if_then_else(I32 c, I32 t, I32 e)
{
    return vbslq_s32((U32)c, t, e);
}

#if defined(SK_CPU_ARM64)
SI bool any(I32 c)
{
    return vmaxvq_u32((U32)c) != 0;
}
SI bool all(I32 c)
{
    return vminvq_u32((U32)c) != 0;
}

SI F mad(F f, F m, F a)
{
    return vfmaq_f32(a, f, m);
}
SI F nmad(F f, F m, F a)
{
    return vfmsq_f32(a, f, m);
}
SI F floor_(F v)
{
    return vrndmq_f32(v);
...
SI F mad(F f, F m, F a)
{
    return vmlaq_f32(a, f, m);
}
SI F nmad(F f, F m, F a)
{
    return vmlsq_f32(a, f, m);
}
...
SI I32 min(I32 a, I32 b)
{
    return (I32)_mm512_min_epi32((__m512i)a, (__m512i)b);
}
SI U32 min(U32 a, U32 b)
{
    return (U32)_mm512_min_epu32((__m512i)a, (__m512i)b);
}
SI F max(F a, F b)
{
...
SI I32 max(I32 a, I32 b)
{
    return (I32)_mm512_max_epi32((__m512i)a, (__m512i)b);
}
SI U32 max(U32 a, U32 b)
{
    return (U32)_mm512_max_epu32((__m512i)a, (__m512i)b);
}
SI F abs_(F v)
{
...
SI I32 abs_(I32 v)
{
    return (I32)_mm512_abs_epi32((__m512i)v);
}
SI F floor_(F v)
{
...
SI I32 iround(F v)
{
    return (I32)_mm512_cvtps_epi32(v);
}
SI U32 round(F v)
{
    return (U32)_mm512_cvtps_epi32(v);
}
SI U32 round(F v, F scale)
{
    return (U32)_mm512_cvtps_epi32(v * scale);
}
SI U16 pack(U32 v)
{
    __m256i rst = _mm256_packus_epi32(_mm512_castsi512_si256((__m512i)v), _mm512_extracti64x4_epi64((__m512i)v, 1));
...
template <typename T> SI V<T> gather(const T* p, U32 ix)
{
    return V<T> { p[ix[0]], p[ix[1]], p[ix[2]], p[ix[3]], p[ix[4]], p[ix[5]], p[ix[6]], p[ix[7]], p[ix[8]], p[ix[9]], p[ix[10]], p[ix[11]], p[ix[12]],
        p[ix[13]], p[ix[14]], p[ix[15]] };
}
...
template <typename V, typename S> SI void scatter_masked(V src, S* dst, U32 ix, I32 mask)
{
...
SI void load2(const uint16_t* ptr, U16* r, U16* g)
{
    ...
    *r = (U16)_mm256_permute4x64_epi64(
        _mm256_packs_epi32(_mm256_srai_epi32(_mm256_slli_epi32(_01234567, 16), 16), _mm256_srai_epi32(_mm256_slli_epi32(_89abcdef, 16), 16)), 216);
    *g = (U16)_mm256_permute4x64_epi64(_mm256_packs_epi32(_mm256_srai_epi32(_01234567, 16), _mm256_srai_epi32(_89abcdef, 16)), 216);
}
SI void store2(uint16_t* ptr, U16 r, U16 g)
{
...
SI void load4(const uint16_t* ptr, U16* r, U16* g, U16* b, U16* a)
{
    __m256i _0123 = _mm256_loadu_si256((const __m256i*)ptr), _4567 = _mm256_loadu_si256(((const __m256i*)ptr) + 1),
            _89ab = _mm256_loadu_si256(((const __m256i*)ptr) + 2), _cdef = _mm256_loadu_si256(((const __m256i*)ptr) + 3);

    auto a0 = _mm256_unpacklo_epi16(_0123, _4567), a1 = _mm256_unpackhi_epi16(_0123, _4567), b0 = _mm256_unpacklo_epi16(a0, a1),
         b1 = _mm256_unpackhi_epi16(a0, a1), a2 = _mm256_unpacklo_epi16(_89ab, _cdef), a3 = _mm256_unpackhi_epi16(_89ab, _cdef),
         b2 = _mm256_unpacklo_epi16(a2, a3), b3 = _mm256_unpackhi_epi16(a2, a3), rr = _mm256_unpacklo_epi64(b0, b2), gg = _mm256_unpackhi_epi64(b0, b2),
         bb = _mm256_unpacklo_epi64(b1, b3), aa = _mm256_unpackhi_epi64(b1, b3);
...
SI void store4(uint16_t* ptr, U16 r, U16 g, U16 b, U16 a)
{
    auto rg012389ab = _mm256_unpacklo_epi16((__m256i)r, (__m256i)g), rg4567cdef = _mm256_unpackhi_epi16((__m256i)r, (__m256i)g),
         ba012389ab = _mm256_unpacklo_epi16((__m256i)b, (__m256i)a), ba4567cdef = _mm256_unpackhi_epi16((__m256i)b, (__m256i)a);

    auto _0189 = _mm256_unpacklo_epi32(rg012389ab, ba012389ab), _23ab = _mm256_unpackhi_epi32(rg012389ab, ba012389ab),
         _45cd = _mm256_unpacklo_epi32(rg4567cdef, ba4567cdef), _67ef = _mm256_unpackhi_epi32(rg4567cdef, ba4567cdef);

    auto _ab23 = _mm256_permutex_epi64(_23ab, 78), _0123 = _mm256_blend_epi32(_0189, _ab23, 0xf0),
         _89ab = _mm256_permutex_epi64(_mm256_blend_epi32(_0189, _ab23, 0x0f), 78), _ef67 = _mm256_permutex_epi64(_67ef, 78),
         _4567 = _mm256_blend_epi32(_45cd, _ef67, 0xf0), _cdef = _mm256_permutex_epi64(_mm256_blend_epi32(_45cd, _ef67, 0x0f), 78);
...
SI void load4(const float* ptr, F* r, F* g, F* b, F* a)
{
    ...
    F rg02468acf = _mm512_unpacklo_ps(_048c, _26ae), ba02468acf = _mm512_unpackhi_ps(_048c, _26ae), rg13579bde = _mm512_unpacklo_ps(_159d, _37bf),
...
SI void store4(float* ptr, F r, F g, F b, F a)
{
    F rg014589cd = _mm512_unpacklo_ps(r, g), rg2367abef = _mm512_unpackhi_ps(r, g), ba014589cd = _mm512_unpacklo_ps(b, a),
      ba2367abef = _mm512_unpackhi_ps(b, a);

    F _048c = (F)_mm512_unpacklo_pd((__m512d)rg014589cd, (__m512d)ba014589cd), _26ae = (F)_mm512_unpacklo_pd((__m512d)rg2367abef, (__m512d)ba2367abef),
      _159d = (F)_mm512_unpackhi_pd((__m512d)rg014589cd, (__m512d)ba014589cd), _37bf = (F)_mm512_unpackhi_pd((__m512d)rg2367abef, (__m512d)ba2367abef);
    ...
    F _0426 = (F)_mm512_permutex2var_pd((__m512d)_048c, _mm512_setr_epi64(0, 1, 2, 3, 12, 13, 14, 15), (__m512d)_ae26),
      _1537 = (F)_mm512_permutex2var_pd((__m512d)_159d, _mm512_setr_epi64(0, 1, 2, 3, 12, 13, 14, 15), (__m512d)_bf37),
      _5173 = _mm512_permutexvar_ps(index, _1537),
      _0123 = (F)_mm512_permutex2var_pd((__m512d)_0426, _mm512_setr_epi64(0, 1, 10, 11, 4, 5, 14, 15), (__m512d)_5173);

    F _5476 = (F)_mm512_permutex2var_pd((__m512d)_5173, _mm512_setr_epi64(0, 1, 10, 11, 4, 5, 14, 15), (__m512d)_0426),
      _4567 = _mm512_permutexvar_ps(index, _5476),
      _8cae = (F)_mm512_permutex2var_pd((__m512d)_8c04, _mm512_setr_epi64(0, 1, 2, 3, 12, 13, 14, 15), (__m512d)_26ae),
      _9dbf = (F)_mm512_permutex2var_pd((__m512d)_9d15, _mm512_setr_epi64(0, 1, 2, 3, 12, 13, 14, 15), (__m512d)_37bf),
      _d9fb = _mm512_permutexvar_ps(index, _9dbf),
      _89ab = (F)_mm512_permutex2var_pd((__m512d)_8cae, _mm512_setr_epi64(0, 1, 10, 11, 4, 5, 14, 15), (__m512d)_d9fb),
      _dcfe = (F)_mm512_permutex2var_pd((__m512d)_d9fb, _mm512_setr_epi64(0, 1, 10, 11, 4, 5, 14, 15), (__m512d)_8cae),
...
SI I32 min(I32 a, I32 b)
{
    return (I32)_mm256_min_epi32((__m256i)a, (__m256i)b);
}
SI U32 min(U32 a, U32 b)
{
    return (U32)_mm256_min_epu32((__m256i)a, (__m256i)b);
}
SI F max(F a, F b)
{
...
SI I32 max(I32 a, I32 b)
{
    return (I32)_mm256_max_epi32((__m256i)a, (__m256i)b);
}
SI U32 max(U32 a, U32 b)
{
    return (U32)_mm256_max_epu32((__m256i)a, (__m256i)b);
}
...
SI I32 abs_(I32 v)
{
    return (I32)_mm256_abs_epi32((__m256i)v);
}
SI F floor_(F v)
{
...
SI I32 iround(F v)
{
    return (I32)_mm256_cvtps_epi32(v);
}
SI U32 round(F v)
{
    return (U32)_mm256_cvtps_epi32(v);
}
SI U32 round(F v, F scale)
{
    return (U32)_mm256_cvtps_epi32(v * scale);
}
SI U16 pack(U32 v)
{
    return (U16)_mm_packus_epi32(_mm256_extractf128_si256((__m256i)v, 0), _mm256_extractf128_si256((__m256i)v, 1));
}
SI U8 pack(U16 v)
{
...
SI F if_then_else(I32 c, F t, F e)
{
    return _mm256_blendv_ps(e, t, (__m256)c);
}
SI I32 if_then_else(I32 c, I32 t, I32 e)
{
...
{
    __m256i parts[] = {
        _mm256_i32gather_epi64((const long long int*)p, _mm256_extracti128_si256((__m256i)ix, 0), 8),
        _mm256_i32gather_epi64((const long long int*)p, _mm256_extracti128_si256((__m256i)ix, 1), 8),
    };
    return sk_bit_cast<U64>(parts);
}
SI void scatter_masked(I32 src, int* dst, U32 ix, I32 mask)
...
SI void load2(const uint16_t* ptr, U16* r, U16* g)
{
    __m128i _0123 = _mm_loadu_si128(((const __m128i*)ptr) + 0), _4567 = _mm_loadu_si128(((const __m128i*)ptr) + 1);
    *r = (U16)_mm_packs_epi32(_mm_srai_epi32(_mm_slli_epi32(_0123, 16), 16), _mm_srai_epi32(_mm_slli_epi32(_4567, 16), 16));
    *g = (U16)_mm_packs_epi32(_mm_srai_epi32(_0123, 16), _mm_srai_epi32(_4567, 16));
}
SI void store2(uint16_t* ptr, U16 r, U16 g)
{
    auto _0123 = _mm_unpacklo_epi16((__m128i)r, (__m128i)g), _4567 = _mm_unpackhi_epi16((__m128i)r, (__m128i)g);
...
SI void load4(const uint16_t* ptr, U16* r, U16* g, U16* b, U16* a)
{
    __m128i _01 = _mm_loadu_si128(((const __m128i*)ptr) + 0), _23 = _mm_loadu_si128(((const __m128i*)ptr) + 1),
            _45 = _mm_loadu_si128(((const __m128i*)ptr) + 2), _67 = _mm_loadu_si128(((const __m128i*)ptr) + 3);
...
SI void store4(uint16_t* ptr, U16 r, U16 g, U16 b, U16 a)
{
    auto rg0123 = _mm_unpacklo_epi16((__m128i)r, (__m128i)g), // r0 g0 r1 g1 r2 g2 r3 g3
        ...
        ba0123 = _mm_unpacklo_epi16((__m128i)b, (__m128i)a), ba4567 = _mm_unpackhi_epi16((__m128i)b, (__m128i)a);

    auto _01 = _mm_unpacklo_epi32(rg0123, ba0123), _23 = _mm_unpackhi_epi32(rg0123, ba0123), _45 = _mm_unpacklo_epi32(rg4567, ba4567),
...
SI void load4(const float* ptr, F* r, F* g, F* b, F* a)
{
    F _04 = _mm256_castps128_ps256(_mm_loadu_ps(ptr + 0)), _15 = _mm256_castps128_ps256(_mm_loadu_ps(ptr + 4)),
      _26 = _mm256_castps128_ps256(_mm_loadu_ps(ptr + 8)), _37 = _mm256_castps128_ps256(_mm_loadu_ps(ptr + 12));
    ...
    F rg0145 = _mm256_unpacklo_ps(_04, _15), // r0 r1 g0 g1 | r4 r5 g4 g5
        ba0145 = _mm256_unpackhi_ps(_04, _15), rg2367 = _mm256_unpacklo_ps(_26, _37), ba2367 = _mm256_unpackhi_ps(_26, _37);
...
SI void store4(float* ptr, F r, F g, F b, F a)
{
    ...
    F _01 = _mm256_permute2f128_ps(_04, _15, 32), // 32 == 0010 0000 == lo, lo
        _23 = _mm256_permute2f128_ps(_26, _37, 32), _45 = _mm256_permute2f128_ps(_04, _15, 49), // 49 == 0011 0001 == hi, hi
...
SI I32 if_then_else(I32 c, I32 t, I32 e)
{
    return (I32)_mm_or_ps(_mm_and_ps((__m128)c, (__m128)t), _mm_andnot_ps((__m128)c, (__m128)e));
}
...
SI I32 min(I32 a, I32 b)
{
    return (I32)_mm_min_epi32((__m128i)a, (__m128i)b);
}
SI U32 min(U32 a, U32 b)
{
    return (U32)_mm_min_epu32((__m128i)a, (__m128i)b);
}
SI I32 max(I32 a, I32 b)
{
    return (I32)_mm_max_epi32((__m128i)a, (__m128i)b);
}
SI U32 max(U32 a, U32 b)
{
    return (U32)_mm_max_epu32((__m128i)a, (__m128i)b);
}
#else
SI I32 min(I32 a, I32 b)
{
...
SI I32 abs_(I32 v)
{
    return (I32)_mm_abs_epi32((__m128i)v);
}
#else
SI I32 abs_(I32 v)
{
...
SI I32 iround(F v)
{
    return (I32)_mm_cvtps_epi32(v);
}
SI U32 round(F v)
{
    return (U32)_mm_cvtps_epi32(v);
}
SI U32 round(F v, F scale)
{
    return (U32)_mm_cvtps_epi32(v * scale);
}
...
SI void store4(uint16_t* ptr, U16 r, U16 g, U16 b, U16 a)
{
    auto rg = _mm_unpacklo_epi16(widen_cast<__m128i>(r), widen_cast<__m128i>(g)), ba = _mm_unpacklo_epi16(widen_cast<__m128i>(b), widen_cast<__m128i>(a));
...
SI void load4(const float* ptr, F* r, F* g, F* b, F* a)
{
    F _0 = _mm_loadu_ps(ptr + 0), _1 = _mm_loadu_ps(ptr + 4), _2 = _mm_loadu_ps(ptr + 8), _3 = _mm_loadu_ps(ptr + 12);
...
SI F if_then_else(I32 c, F t, F e)
{
    return sk_bit_cast<Vec<8, float>>(__lasx_xvbitsel_v(sk_bit_cast<__m256i>(e), sk_bit_cast<__m256i>(t), sk_bit_cast<__m256i>(c)));
}

SI I32 if_then_else(I32 c, I32 t, I32 e)
{
    return sk_bit_cast<Vec<8, int32_t>>(__lasx_xvbitsel_v(sk_bit_cast<__m256i>(e), sk_bit_cast<__m256i>(t), sk_bit_cast<__m256i>(c)));
}
...
SI F abs_(F v)
{
    return (F)__lasx_xvand_v((I32)v, (I32)(0 - v));
}
SI I32 abs_(I32 v)
{
    return max(v, -v);
...
SI F rcp_approx(F v)
{
    return __lasx_xvfrecip_s(v);
}
SI F rcp_precise(F v)
{
    F e = rcp_approx(v);
    return e * nmad(v, e, F() + 2.0f);
}
SI F rsqrt_approx(F v)
{
    return __lasx_xvfrsqrt_s(v);
}
SI F sqrt_(F v)
{
...
SI U16 pack(U32 v)
{
    return __lsx_vpickev_h(__lsx_vsat_wu(emulate_lasx_d_xr2vr_h(v), 15), __lsx_vsat_wu(emulate_lasx_d_xr2vr_l(v), 15));
}
...
SI void load2(const uint16_t* ptr, U16* r, U16* g)
{
    U16 _0123 = __lsx_vld(ptr, 0), _4567 = __lsx_vld(ptr, 16);
    *r = __lsx_vpickev_h(__lsx_vsat_w(__lsx_vsrai_w(__lsx_vslli_w(_4567, 16), 16), 15), __lsx_vsat_w(__lsx_vsrai_w(__lsx_vslli_w(_0123, 16), 16), 15));
    *g = __lsx_vpickev_h(__lsx_vsat_w(__lsx_vsrai_w(_4567, 16), 15), __lsx_vsat_w(__lsx_vsrai_w(_0123, 16), 15));
}
SI void store2(uint16_t* ptr, U16 r, U16 g)
{
    auto _0123 = __lsx_vilvl_h(g, r), _4567 = __lsx_vilvh_h(g, r);
...
SI void store4(uint16_t* ptr, U16 r, U16 g, U16 b, U16 a)
{
    auto rg0123 = __lsx_vilvl_h(g, r), // r0 g0 r1 g1 r2 g2 r3 g3
        ...
        ba0123 = __lsx_vilvl_h(a, b), ba4567 = __lsx_vilvh_h(a, b);

    auto _01 = __lsx_vilvl_w(ba0123, rg0123), _23 = __lsx_vilvh_w(ba0123, rg0123), _45 = __lsx_vilvl_w(ba4567, rg4567), _67 = __lsx_vilvh_w(ba4567, rg4567);
...
SI void load4(const float* ptr, F* r, F* g, F* b, F* a)
{
    ...
    F rg0145 = (F)__lasx_xvilvl_w((__m256i)_15, (__m256i)_04), // r0 r1 g0 g1 | r4 r5 g4 g5
        ba0145 = (F)__lasx_xvilvh_w((__m256i)_15, (__m256i)_04), rg2367 = (F)__lasx_xvilvl_w((__m256i)_37, (__m256i)_26),
...
SI void store4(float* ptr, F r, F g, F b, F a)
{
    ...
    F _01 = (F)__lasx_xvpermi_q((__m256i)_04, (__m256i)_15, 0x02), _23 = (F)__lasx_xvpermi_q((__m256i)_26, (__m256i)_37, 0x02),
      _45 = (F)__lasx_xvpermi_q((__m256i)_04, (__m256i)_15, 0x13), _67 = (F)__lasx_xvpermi_q((__m256i)_26, (__m256i)_37, 0x13);
...
SI F if_then_else(I32 c, F t, F e)
{
    return sk_bit_cast<Vec<4, float>>(__lsx_vbitsel_v(sk_bit_cast<__m128i>(e), sk_bit_cast<__m128i>(t), sk_bit_cast<__m128i>(c)));
}

SI I32 if_then_else(I32 c, I32 t, I32 e)
{
    return sk_bit_cast<Vec<4, int32_t>>(__lsx_vbitsel_v(sk_bit_cast<__m128i>(e), sk_bit_cast<__m128i>(t), sk_bit_cast<__m128i>(c)));
}
...
SI F abs_(F v)
{
    return (F)__lsx_vand_v((I32)v, (I32)(0 - v));
}
SI I32 abs_(I32 v)
{
    return max(v, -v);
...
SI void store4(uint16_t* ptr, U16 r, U16 g, U16 b, U16 a)
{
    auto rg = __lsx_vilvl_h(widen_cast<__m128i>(g), widen_cast<__m128i>(r)), ba = __lsx_vilvl_h(widen_cast<__m128i>(a), widen_cast<__m128i>(b));
...
SI void load4(const float* ptr, F* r, F* g, F* b, F* a)
{
    F _0 = (F)__lsx_vld(ptr, 0), _1 = (F)__lsx_vld(ptr, 16), _2 = (F)__lsx_vld(ptr, 32), _3 = (F)__lsx_vld(ptr, 48);
...
static constexpr F F0 = F_(0.0f), F1 = F_(1.0f);

#if !defined(SKRP_CPU_SCALAR)
SI F min(F a, float b)
{
    return min(a, F_(b));
}
SI F min(float a, F b)
{
    return min(F_(a), b);
}
SI F max(F a, float b)
{
    return max(a, F_(b));
}
SI F max(float a, F b)
{
    return max(F_(a), b);
}

SI F mad(F f, F m, float a)
{
    return mad(f, m, F_(a));
}
SI F mad(F f, float m, F a)
{
    return mad(f, F_(m), a);
}
SI F mad(F f, float m, float a)
{
    return mad(f, F_(m), F_(a));
}
SI F mad(float f, F m, F a)
{
    return mad(F_(f), m, a);
}
SI F mad(float f, F m, float a)
{
    return mad(F_(f), m, F_(a));
}
SI F mad(float f, float m, F a)
{
    return mad(F_(f), F_(m), a);
}

SI F nmad(F f, F m, float a)
{
    return nmad(f, m, F_(a));
}
SI F nmad(F f, float m, F a)
{
    return nmad(f, F_(m), a);
}
SI F nmad(F f, float m, float a)
{
    return nmad(f, F_(m), F_(a));
}
SI F nmad(float f, F m, F a)
{
    return nmad(F_(f), m, a);
}
SI F nmad(float f, F m, float a)
{
    return nmad(F_(f), m, F_(a));
}
SI F nmad(float f, float m, F a)
{
    return nmad(F_(f), F_(m), a);
}
#endif
...
SI F cast(U32 v)
{
    return __builtin_convertvector((I32)v, F);
}
SI F cast64(U64 v)
{
...
SI U32 trunc_(F v)
{
    return (U32) __builtin_convertvector(v, I32);
}
SI U32 expand(U16 v)
{
...
#if !defined(SKRP_CPU_SCALAR)
SI F if_then_else(I32 c, F t, float e)
{
    return if_then_else(c, t, F_(e));
}
SI F if_then_else(I32 c, float t, F e)
{
    return if_then_else(c, F_(t), e);
}
SI F if_then_else(I32 c, float t, float e)
{
    return if_then_else(c, F_(t), F_(e));
}
#endif
...
SI F from_half(U16 h)
{
    ...
    return if_then_else(denorm, F0, sk_bit_cast<F>((s << 16) + (em << 13) + ((127 - 15) << 23)));
#endif
}
...
SI U16 to_half(F f)
{
    ...
    return pack((U32)if_then_else(denorm, I32_(0), (I32)((s >> 16) + (em >> 13) - ((127 - 15) << 10))));
#endif
}
...
#else
using Stage = void(ABI*)(SkRasterPipelineStage* program, size_t dx, size_t dy, std::byte* base, F, F, F, F, F, F, F, F);
#endif

static void start_pipeline(size_t dx, size_t dy, size_t xlimit, size_t ylimit, SkRasterPipelineStage* program,
    SkSpan<SkRasterPipeline_MemoryCtxPatch> memoryCtxPatches, uint8_t* tailPointer)
{
...
#define DECLARE_STAGE(name, ARG, STAGE_RET, INC, OFFSET, MUSTTAIL)                                                                                             \
    SI STAGE_RET name##_k(ARG, size_t dx, size_t dy, std::byte*& base, F& r, F& g, F& b, F& a, F& dr, F& dg, F& db, F& da);                                    \
    static void ABI name(Params* params, SkRasterPipelineStage* program, F r, F g, F b, F a)                                                                   \
    {                                                                                                                                                          \
        OFFSET name##_k(Ctx { program }, params->dx, params->dy, params->base, r, g, b, a, params->dr, params->dg, params->db, params->da);                    \
        INC;                                                                                                                                                   \
...
#define DECLARE_STAGE(name, ARG, STAGE_RET, INC, OFFSET, MUSTTAIL)                                                                                             \
    SI STAGE_RET name##_k(ARG, size_t dx, size_t dy, std::byte*& base, F& r, F& g, F& b, F& a, F& dr, F& dg, F& db, F& da);                                    \
    static void ABI name(SkRasterPipelineStage* program, size_t dx, size_t dy, std::byte* base, F r, F g, F b, F a, F dr, F dg, F db, F da)                    \
    {                                                                                                                                                          \
...
#define STAGE_TAIL(name, arg) DECLARE_STAGE(name, arg, void, ++program, /*no offset*/, SKRP_MUSTTAIL)

// A branch stage returns an integer, which is added directly to the program counter, and tailcalls.
#define STAGE_BRANCH(name, arg) DECLARE_STAGE(name, arg, int, /*no increment*/, program +=, SKRP_MUSTTAIL)
...
#else
static void ABI just_return(SkRasterPipelineStage*, size_t, size_t, std::byte*, F, F, F, F, F, F, F, F)
{
}
#endif
...
#else
static void ABI stack_checkpoint(SkRasterPipelineStage* program, size_t dx, size_t dy, std::byte* base, F r, F g, F b, F a, F dr, F dg, F db, F da)
{
    SkRasterPipeline_RewindCtx* ctx = Ctx { program };
    while (program) {
        auto next = (Stage)(++program)->fn;
...
static void ABI stack_rewind(SkRasterPipelineStage* program, size_t dx, size_t dy, std::byte* base, F r, F g, F b, F a, F dr, F dg, F db, F da)
{
    SkRasterPipeline_RewindCtx* ctx = Ctx { program };
    sk_unaligned_store(ctx->r, r);
    sk_unaligned_store(ctx->g, g);
...
template <typename V, typename T> SI V load(const T* src)
{
    return sk_unaligned_load<V>(src);
}

template <typename V, typename T> SI void store(T* dst, V v)
{
...
{
    const F inclusiveZ = F_(std::numeric_limits<float>::min()), inclusiveL = sk_bit_cast<F>(sk_bit_cast<U32>(F_(limit)) - 1);
...
SI uint32_t select_lane(uint32_t data, int /*lane*/)
{
    return data;
}
SI int32_t select_lane(int32_t data, int /*lane*/)
{
    return data;
}
#else
// In SIMD mode, `data` contains a vector of lanes.
SI uint32_t select_lane(U32 data, int lane)
{
    return data[lane];
}
SI int32_t select_lane(I32 data, int lane)
{
    return data[lane];
}
#endif
...
STAGE(dither, const float* rate)
{
    ...
    U32 X = U32_(dx) + sk_unaligned_load<U32>(iota), Y = U32_(dy);
...
BLEND_MODE(srcatop)
{
    return mad(s, da, d * inv(sa));
}
BLEND_MODE(dstatop)
{
    return mad(d, sa, s * inv(da));
}
BLEND_MODE(srcin)
{
    return s * da;
...
BLEND_MODE(multiply)
{
    return mad(s, d, mad(s, inv(da), d * inv(sa)));
}
BLEND_MODE(plus_)
{
    return min(s + d, 1.0f);
...
{
    return if_then_else(
        d == da, d + s * inv(da), if_then_else(s == 0, /* s + */ d * inv(sa), sa * (da - min(da, (da - d) * sa * rcp_fast(s))) + s * inv(da) + d * inv(sa)));
}
BLEND_MODE(colordodge)
{
    return if_then_else(
        d == 0, /* d + */ s * inv(da), if_then_else(s == sa, s + d * inv(sa), sa * min(da, (d * sa) * rcp_fast(sa - s)) + s * inv(da) + d * inv(sa)));
}
BLEND_MODE(hardlight)
{
    return s * inv(da) + d * inv(sa) + if_then_else(two(s) <= sa, two(s * d), sa * da - two((da - d) * (sa - s)));
}
BLEND_MODE(overlay)
{
    return s * inv(da) + d * inv(sa) + if_then_else(two(d) <= da, two(s * d), sa * da - two((da - d) * (sa - s)));
}

BLEND_MODE(softlight)
{
    F m = if_then_else(da > 0, d / da, 0.0f), s2 = two(s), m4 = two(two(m));
    ...
    F darkSrc = d * (sa + (s2 - sa) * (1.0f - m)), // Used in case 1.
        ...
        liteDst = sqrt_(m) - m, liteSrc = d * sa + da * (s2 - sa) * if_then_else(two(two(d)) <= da, darkDst, liteDst); // 2 or 3?
...
{
    F mn = min(*r, min(*g, *b)), mx = max(*r, max(*g, *b)), l = lum(*r, *g, *b), mn_scale = (l)*rcp_fast(l - mn), mx_scale = (a - l) * rcp_fast(mx - l);
    I32 clip_low = cond_to_mask(mn < 0 && l != mn), clip_high = cond_to_mask(mx > a && l != mx);
...
STAGE(srcover_rgba_8888, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    dst = to_unorm(r, 1, 255) | to_unorm(g, 1, 255) << 8 | to_unorm(b, 1, 255) << 16 | to_unorm(a, 1, 255) << 24;
    store(ptr, dst);
}
...
STAGE(rgb_to_hsl, NoCtx)
{
    ...
    F h = (1 / 6.0f)
        * if_then_else(mx == mn, 0.0f,
            if_then_else(mx == r, (g - b) * d_rcp + if_then_else(g < b, 6.0f, 0.0f), if_then_else(mx == g, (b - r) * d_rcp + 2.0f, (r - g) * d_rcp + 4.0f)));

    F l = (mx + mn) * 0.5f;
    F s = if_then_else(mx == mn, 0.0f, d / if_then_else(l > 0.5f, 2.0f - mx - mn, mx + mn));
...
STAGE(css_lab_to_xyz, NoCtx)
{
    ...
    F xyz[3] = { if_then_else(f_cubed[0] > e, f_cubed[0], (116 * f[0] - 16) * (1 / k)), if_then_else(r > k * e, f_cubed[1], r * (1 / k)),
...
{
    F l_ = r + 0.3963377774f * g + 0.2158037573f * b, m_ = r - 0.1055613458f * g - 0.0638541728f * b, s_ = r - 0.0894841775f * g - 1.2914855480f * b;

    F l = l_ * l_ * l_, m = m_ * m_ * m_, s = s_ * s_ * s_;
...
SI RGB css_hsl_to_srgb_(F h, F s, F l)
{
    ...
    F k[3] = { mod_(0 + h * (1 / 30.0f), 12), mod_(8 + h * (1 / 30.0f), 12), mod_(4 + h * (1 / 30.0f), 12) };
    F a = s * min(l, 1 - l);
    return { l - a * max(-1.0f, min(min(k[0] - 3.0f, 9.0f - k[0]), 1.0f)), l - a * max(-1.0f, min(min(k[1] - 3.0f, 9.0f - k[1]), 1.0f)),
...
{
    auto mptr = ptr_at_xy<const uint8_t>(&ctx->mul, dx, dy), aptr = ptr_at_xy<const uint8_t>(&ctx->add, dx, dy);

    F mul = from_byte(load<U8>(mptr)), add = from_byte(load<U8>(aptr));
...
STAGE(parametric, const skcms_TransferFunction* ctx)
{
    auto fn = [&](F v) {
        ...
        F r = if_then_else(v <= ctx->d, mad(ctx->c, v, ctx->f), approx_powf(mad(ctx->a, v, ctx->b), ctx->g) + ctx->e);
...
STAGE(PQish, const skcms_TransferFunction* ctx)
{
    auto fn = [&](F v) {
        ...
        F r = approx_powf(max(mad(ctx->b, approx_powf(v, ctx->c), ctx->a), 0.0f) / (mad(ctx->e, approx_powf(v, ctx->c), ctx->d)), ctx->f);
...
{
    auto ptr = ptr_at_xy<uint16_t>(ctx, dx, dy);
    U16 px = pack(to_unorm(r, 15) << 12 | to_unorm(g, 15) << 8 | to_unorm(b, 15) << 4 | to_unorm(a, 15));
    store(ptr, px);
}
...
STAGE(store_8888, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    U32 px = to_unorm(r, 255) | to_unorm(g, 255) << 8 | to_unorm(b, 255) << 16 | to_unorm(a, 255) << 24;
    store(ptr, px);
}
...
STAGE(store_16161616, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    U16 R = pack(to_unorm(r, 65535)), G = pack(to_unorm(g, 65535)), B = pack(to_unorm(b, 65535)), A = pack(to_unorm(a, 65535));
...
STAGE(store_10x6, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    U16 R = pack(to_unorm(r, 1023)) << 6, G = pack(to_unorm(g, 1023)) << 6, B = pack(to_unorm(b, 1023)) << 6, A = pack(to_unorm(a, 1023)) << 6;
...
STAGE(store_10101010_xr, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    U16 R = pack(to_unorm((r - min) / range, 1023)) << 6, G = pack(to_unorm((g - min) / range, 1023)) << 6, B = pack(to_unorm((b - min) / range, 1023)) << 6,
...
STAGE(store_1010102, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    U32 px = to_unorm(r, 1023) | to_unorm(g, 1023) << 10 | to_unorm(b, 1023) << 20 | to_unorm(a, 3) << 30;
    store(ptr, px);
}
STAGE(store_1010102_xr, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    static constexpr float max = 1.25098f;
    static constexpr float range = max - min;
    U32 px = to_unorm((r - min) / range, 1023) | to_unorm((g - min) / range, 1023) << 10 | to_unorm((b - min) / range, 1023) << 20 | to_unorm(a, 3) << 30;
    store(ptr, px);
}
...
STAGE(store_f16, const SkRasterPipeline_MemoryCtx* ctx)
{
    ...
    store4((uint16_t*)ptr, to_half(r), to_half(g), to_half(b), to_half(a));
}
...
{
    auto ptr = ptr_at_xy<uint32_t>(ctx, dx, dy);
    store2((uint16_t*)ptr, to_half(r), to_half(g));
}
...
STAGE(decal_x_and_y, SkRasterPipeline_DecalTileCtx* ctx)
{
    ...
    auto cond = (((0 < r) & (r < w)) | (r == ex)) & (((0 < g) & (g < h)) | (g == ey));
    sk_unaligned_store(ctx->mask, cond_to_mask(cond));
}
...
{
    auto R = mad(r, m[0], mad(g, m[3], b * m[6])), G = mad(r, m[1], mad(g, m[4], b * m[7])), B = mad(r, m[2], mad(g, m[5], b * m[8]));
    r = R;
    g = G;
    b = B;
}
...
{
    auto R = mad(r, m[0], mad(g, m[3], mad(b, m[6], m[9]))), G = mad(r, m[1], mad(g, m[4], mad(b, m[7], m[10]))),
...
{
    auto R = mad(r, m[0], mad(g, m[1], mad(b, m[2], mad(a, m[3], m[4])))), G = mad(r, m[5], mad(g, m[6], mad(b, m[7], mad(a, m[8], m[9])))),
         B = mad(r, m[10], mad(g, m[11], mad(b, m[12], mad(a, m[13], m[14])))), A = mad(r, m[15], mad(g, m[16], mad(b, m[17], mad(a, m[18], m[19]))));
    r = R;
    g = G;
    b = B;
    a = A;
...
STAGE(matrix_perspective, const float* m)
{
    ...
    auto R = mad(r, m[0], mad(g, m[1], m[2])), G = mad(r, m[3], mad(g, m[4], m[5])), Z = mad(r, m[6], mad(g, m[7], m[8]));
    r = R * rcp_precise(Z);
    g = G * rcp_precise(Z);
}
...
STAGE(xy_to_unit_angle, NoCtx)
{
    ...
    F phi = slope
        * (0.15912117063999176025390625f
            + s * (-5.185396969318389892578125e-2f + s * (2.476101927459239959716796875e-2f + s * (-7.0547382347285747528076171875e-3f))));
...
template <int kScale> SI void bicubic_x(SkRasterPipeline_SamplerCtx* ctx, F* x)
{
    *x = sk_unaligned_load<F>(ctx->x) + (kScale * 0.5f);
    ...
    F scalex;
    if (kScale == -3) {
        scalex = sk_unaligned_load<F>(ctx->wx[0]);
    }
    if (kScale == -1) {
        scalex = sk_unaligned_load<F>(ctx->wx[1]);
    }
    if (kScale == +1) {
        scalex = sk_unaligned_load<F>(ctx->wx[2]);
    }
    if (kScale == +3) {
        scalex = sk_unaligned_load<F>(ctx->wx[3]);
    }
    sk_unaligned_store(ctx->scalex, scalex);
}
template <int kScale> SI void bicubic_y(SkRasterPipeline_SamplerCtx* ctx, F* y)
{
    *y = sk_unaligned_load<F>(ctx->y) + (kScale * 0.5f);
    ...
    F scaley;
    if (kScale == -3) {
        scaley = sk_unaligned_load<F>(ctx->wy[0]);
    }
    if (kScale == -1) {
        scaley = sk_unaligned_load<F>(ctx->wy[1]);
    }
    if (kScale == +1) {
        scaley = sk_unaligned_load<F>(ctx->wy[2]);
    }
    if (kScale == +3) {
        scaley = sk_unaligned_load<F>(ctx->wy[3]);
    }
    sk_unaligned_store(ctx->scaley, scaley);
}
...
STAGE(perlin_noise, SkRasterPipeline_PerlinNoiseCtx* ctx)
{
    ...
    for (int octave = 0; octave < ctx->numOctaves; ++octave) {
        ...
        if (ctx->stitching) {
            ...
            floorValX -= sk_bit_cast<F>(cond_to_mask(floorValX >= stitchDataX) & sk_bit_cast<I32>(stitchDataX));
            floorValY -= sk_bit_cast<F>(cond_to_mask(floorValY >= stitchDataY) & sk_bit_cast<I32>(stitchDataY));
            ceilValX -= sk_bit_cast<F>(cond_to_mask(ceilValX >= stitchDataX) & sk_bit_cast<I32>(stitchDataX));
            ceilValY -= sk_bit_cast<F>(cond_to_mask(ceilValY >= stitchDataY) & sk_bit_cast<I32>(stitchDataY));
        }
...
#define update_execution_mask() a = sk_bit_cast<F>(sk_bit_cast<I32>(r) & sk_bit_cast<I32>(g) & sk_bit_cast<I32>(b))
...
template <int NumSlots> SI void copy_n_slots_unmasked_fn(SkRasterPipeline_BinaryOpCtx* packed, std::byte* base)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);
...
template <int NumSlots> SI void copy_n_immutable_unmasked_fn(SkRasterPipeline_BinaryOpCtx* packed, std::byte* base)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);
...
template <int NumSlots> SI void copy_n_slots_masked_fn(SkRasterPipeline_BinaryOpCtx* packed, std::byte* base, I32 mask)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);
    I32* dst = (I32*)(base + ctx.dst);
...
template <int LoopCount, typename OffsetType> SI void shuffle_fn(std::byte* ptr, OffsetType* offsets, int numSlots)
{
    F scratch[16];
...
template <int N> SI void small_swizzle_fn(SkRasterPipeline_SwizzleCtx* packed, std::byte* base)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);
...
template <int NumSlots> SI void swizzle_copy_masked_fn(I32* dst, const I32* src, uint16_t* offsets, I32 mask)
{
...
template <typename T, void (*ApplyFn)(T*)> SI void apply_adjacent_unary(T* dst, T* end)
{
    do {
        ApplyFn(dst);
        dst += 1;
...
#if defined(SKRP_CPU_SCALAR)
template <typename T> SI void cast_to_float_from_fn(T* dst)
{
...
#define DECLARE_UNARY_FLOAT(name)                                                                                                                              \
    STAGE_TAIL(name##_float, F* dst)                                                                                                                           \
    {                                                                                                                                                          \
        apply_adjacent_unary<F, &name##_fn>(dst, dst + 1);                                                                                                     \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_floats, F* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_unary<F, &name##_fn>(dst, dst + 2);                                                                                                     \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_floats, F* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_unary<F, &name##_fn>(dst, dst + 3);                                                                                                     \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_floats, F* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_unary<F, &name##_fn>(dst, dst + 4);                                                                                                     \
    }

#define DECLARE_UNARY_INT(name)                                                                                                                                \
    STAGE_TAIL(name##_int, I32* dst)                                                                                                                           \
    {                                                                                                                                                          \
        apply_adjacent_unary<I32, &name##_fn>(dst, dst + 1);                                                                                                   \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_ints, I32* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_unary<I32, &name##_fn>(dst, dst + 2);                                                                                                   \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_ints, I32* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_unary<I32, &name##_fn>(dst, dst + 3);                                                                                                   \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_ints, I32* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_unary<I32, &name##_fn>(dst, dst + 4);                                                                                                   \
    }

#define DECLARE_UNARY_UINT(name)                                                                                                                               \
    STAGE_TAIL(name##_uint, U32* dst)                                                                                                                          \
    {                                                                                                                                                          \
        apply_adjacent_unary<U32, &name##_fn>(dst, dst + 1);                                                                                                   \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_uints, U32* dst)                                                                                                                       \
    {                                                                                                                                                          \
        apply_adjacent_unary<U32, &name##_fn>(dst, dst + 2);                                                                                                   \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_uints, U32* dst)                                                                                                                       \
    {                                                                                                                                                          \
        apply_adjacent_unary<U32, &name##_fn>(dst, dst + 3);                                                                                                   \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_uints, U32* dst)                                                                                                                       \
    {                                                                                                                                                          \
        apply_adjacent_unary<U32, &name##_fn>(dst, dst + 4);                                                                                                   \
    }

DECLARE_UNARY_INT(cast_to_float_from)
DECLARE_UNARY_UINT(cast_to_float_from) DECLARE_UNARY_FLOAT(cast_to_int_from) DECLARE_UNARY_FLOAT(cast_to_uint_from) DECLARE_UNARY_FLOAT(floor)
    DECLARE_UNARY_FLOAT(ceil) DECLARE_UNARY_FLOAT(invsqrt) DECLARE_UNARY_INT(abs)
...
{
    F a00 = dst[0], a01 = dst[1], a10 = dst[2], a11 = dst[3];
    F det = nmad(a01, a10, a00 * a11), invdet = rcp_precise(det);
    dst[0] = invdet * a11;
    dst[1] = -invdet * a01;
    dst[2] = -invdet * a10;
    dst[3] = invdet * a00;
...
{
    F a00 = dst[0], a01 = dst[1], a02 = dst[2], a10 = dst[3], a11 = dst[4], a12 = dst[5], a20 = dst[6], a21 = dst[7], a22 = dst[8];
    F b01 = nmad(a12, a21, a22 * a11), b11 = nmad(a22, a10, a12 * a20), b21 = nmad(a11, a20, a21 * a10);
    F det = mad(a00, b01, mad(a01, b11, a02 * b21)), invdet = rcp_precise(det);
    dst[0] = invdet * b01;
...
{
    F a00 = dst[0], a01 = dst[1], a02 = dst[2], a03 = dst[3], a10 = dst[4], a11 = dst[5], a12 = dst[6], a13 = dst[7], a20 = dst[8], a21 = dst[9], a22 = dst[10],
      a23 = dst[11], a30 = dst[12], a31 = dst[13], a32 = dst[14], a33 = dst[15];
    F b00 = nmad(a01, a10, a00 * a11), b01 = nmad(a02, a10, a00 * a12), b02 = nmad(a03, a10, a00 * a13), b03 = nmad(a02, a11, a01 * a12),
      b04 = nmad(a03, a11, a01 * a13), b05 = nmad(a03, a12, a02 * a13), b06 = nmad(a21, a30, a20 * a31), b07 = nmad(a22, a30, a20 * a32),
      b08 = nmad(a23, a30, a20 * a33), b09 = nmad(a22, a31, a21 * a32), b10 = nmad(a23, a31, a21 * a33), b11 = nmad(a23, a32, a22 * a33),
      det = mad(b00, b11, b05 * b06) + mad(b02, b09, b03 * b08) - mad(b01, b10, b04 * b07), invdet = rcp_precise(det);
    b00 *= invdet;
    b01 *= invdet;
    b02 *= invdet;
    b03 *= invdet;
...
template <typename T, void (*ApplyFn)(T*, T*)> SI void apply_adjacent_binary(T* dst, T* src)
{
    T* end = src;
    do {
        ApplyFn(dst, src);
...
template <typename T, void (*ApplyFn)(T*, T*)> SI void apply_adjacent_binary_packed(SkRasterPipeline_BinaryOpCtx* packed, std::byte* base)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);
...
template <int N, typename V, typename S, void (*ApplyFn)(V*, V*)> SI void apply_binary_immediate(SkRasterPipeline_ConstantCtx* packed, std::byte* base)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);
...
template <typename T> SI void add_fn(T* dst, T* src)
{
    *dst += *src;
}

template <typename T> SI void sub_fn(T* dst, T* src)
{
    *dst -= *src;
}

template <typename T> SI void mul_fn(T* dst, T* src)
{
    *dst *= *src;
}

template <typename T> SI void div_fn(T* dst, T* src)
{
    T divisor = *src;
...
template <typename T> SI void max_fn(T* dst, T* src)
{
    *dst = max(*dst, *src);
}

template <typename T> SI void min_fn(T* dst, T* src)
{
    *dst = min(*dst, *src);
}

template <typename T> SI void cmplt_fn(T* dst, T* src)
{
...
template <typename T> SI void cmple_fn(T* dst, T* src)
{
    static_assert(sizeof(T) == sizeof(I32));
    I32 result = cond_to_mask(*dst <= *src);
    memcpy(dst, &result, sizeof(I32));
...
template <typename T> SI void cmpeq_fn(T* dst, T* src)
{
    static_assert(sizeof(T) == sizeof(I32));
    I32 result = cond_to_mask(*dst == *src);
    memcpy(dst, &result, sizeof(I32));
...
template <typename T> SI void cmpne_fn(T* dst, T* src)
{
    static_assert(sizeof(T) == sizeof(I32));
    I32 result = cond_to_mask(*dst != *src);
    memcpy(dst, &result, sizeof(I32));
...
#define DECLARE_BINARY_FLOAT(name)                                                                                                                             \
    STAGE_TAIL(name##_float, F* dst)                                                                                                                           \
    {                                                                                                                                                          \
        apply_adjacent_binary<F, &name##_fn>(dst, dst + 1);                                                                                                    \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_floats, F* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_binary<F, &name##_fn>(dst, dst + 2);                                                                                                    \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_floats, F* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_binary<F, &name##_fn>(dst, dst + 3);                                                                                                    \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_floats, F* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_binary<F, &name##_fn>(dst, dst + 4);                                                                                                    \
    }                                                                                                                                                          \
...
#define DECLARE_BINARY_INT(name)                                                                                                                               \
    STAGE_TAIL(name##_int, I32* dst)                                                                                                                           \
    {                                                                                                                                                          \
        apply_adjacent_binary<I32, &name##_fn>(dst, dst + 1);                                                                                                  \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_ints, I32* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_binary<I32, &name##_fn>(dst, dst + 2);                                                                                                  \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_ints, I32* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_binary<I32, &name##_fn>(dst, dst + 3);                                                                                                  \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_ints, I32* dst)                                                                                                                        \
    {                                                                                                                                                          \
        apply_adjacent_binary<I32, &name##_fn>(dst, dst + 4);                                                                                                  \
    }                                                                                                                                                          \
...
#define DECLARE_BINARY_UINT(name)                                                                                                                              \
    STAGE_TAIL(name##_uint, U32* dst)                                                                                                                          \
    {                                                                                                                                                          \
        apply_adjacent_binary<U32, &name##_fn>(dst, dst + 1);                                                                                                  \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_uints, U32* dst)                                                                                                                       \
    {                                                                                                                                                          \
        apply_adjacent_binary<U32, &name##_fn>(dst, dst + 2);                                                                                                  \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_uints, U32* dst)                                                                                                                       \
    {                                                                                                                                                          \
        apply_adjacent_binary<U32, &name##_fn>(dst, dst + 3);                                                                                                  \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_uints, U32* dst)                                                                                                                       \
    {                                                                                                                                                          \
        apply_adjacent_binary<U32, &name##_fn>(dst, dst + 4);                                                                                                  \
    }                                                                                                                                                          \
...
DECLARE_BINARY_FLOAT(add)
DECLARE_BINARY_INT(add) DECLARE_BINARY_FLOAT(sub) DECLARE_BINARY_INT(sub) DECLARE_BINARY_FLOAT(mul) DECLARE_BINARY_INT(mul) DECLARE_BINARY_FLOAT(div)
    DECLARE_BINARY_INT(div) DECLARE_BINARY_UINT(div) DECLARE_BINARY_INT(bitwise_and) DECLARE_BINARY_INT(bitwise_or) DECLARE_BINARY_INT(bitwise_xor)
        DECLARE_BINARY_FLOAT(mod) DECLARE_BINARY_FLOAT(min) DECLARE_BINARY_INT(min) DECLARE_BINARY_UINT(min) DECLARE_BINARY_FLOAT(max) DECLARE_BINARY_INT(max)
            DECLARE_BINARY_UINT(max) DECLARE_BINARY_FLOAT(cmplt) DECLARE_BINARY_INT(cmplt) DECLARE_BINARY_UINT(cmplt) DECLARE_BINARY_FLOAT(cmple)
                DECLARE_BINARY_INT(cmple) DECLARE_BINARY_UINT(cmple) DECLARE_BINARY_FLOAT(cmpeq) DECLARE_BINARY_INT(cmpeq) DECLARE_BINARY_FLOAT(cmpne)
                    DECLARE_BINARY_INT(cmpne)

    // Sufficiently complex ops only provide an N-way version, to avoid code bloat from the dedicated
    // 1-4 slot versions.
    DECLARE_N_WAY_BINARY_FLOAT(atan2) DECLARE_N_WAY_BINARY_FLOAT(pow)
...
#define DECLARE_IMM_BINARY_UINT(name)                                                                                                                          \
    ...
    {                                                                                                                                                          \
        ...
        DECLARE_IMM_BINARY_FLOAT(add) DECLARE_IMM_BINARY_INT(add) DECLARE_IMM_BINARY_FLOAT(mul) DECLARE_IMM_BINARY_INT(mul)
            DECLARE_MULTI_IMM_BINARY_INT(bitwise_and) DECLARE_IMM_BINARY_FLOAT(max) DECLARE_IMM_BINARY_FLOAT(min) DECLARE_IMM_BINARY_INT(bitwise_xor)
                DECLARE_IMM_BINARY_FLOAT(cmplt) DECLARE_IMM_BINARY_INT(cmplt) DECLARE_IMM_BINARY_UINT(cmplt) DECLARE_IMM_BINARY_FLOAT(cmple)
                    DECLARE_IMM_BINARY_INT(cmple) DECLARE_IMM_BINARY_UINT(cmple) DECLARE_IMM_BINARY_FLOAT(cmpeq) DECLARE_IMM_BINARY_INT(cmpeq)
...
{
    dst[0] = mad(dst[0], dst[2], dst[1] * dst[3]);
}

STAGE_TAIL(dot_3_floats, F* dst)
{
    dst[0] = mad(dst[0], dst[3], mad(dst[1], dst[4], dst[2] * dst[5]));
}

STAGE_TAIL(dot_4_floats, F* dst)
{
    dst[0] = mad(dst[0], dst[4], mad(dst[1], dst[5], mad(dst[2], dst[6], dst[3] * dst[7])));
}

// MxM, VxM and MxV multiplication all use matrix_multiply. Vectors are treated like a matrix with a
// single column or row.
template <int N> SI void matrix_multiply(SkRasterPipeline_MatrixMultiplyCtx* packed, std::byte* base)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);

    int outColumns = ctx.rightColumns, outRows = ctx.leftRows;
...
STAGE_TAIL(refract_4_floats, F* dst)
{
    ...
    F dotNI = mad(normal[0], incident[0], mad(normal[1], incident[1], mad(normal[2], incident[2], normal[3] * incident[3])));

    F k = 1.0 - eta * eta * (1.0 - dotNI * dotNI);
    F sqrt_k = sqrt_(k);

    for (int idx = 0; idx < 4; ++idx) {
        dst[idx] = if_then_else(k >= 0, eta * incident[idx] - (eta * dotNI + sqrt_k) * normal[idx], 0.0);
    }
}

// Ternary operations work like binary ops (see immediately above) but take two source inputs.
template <typename T, void (*ApplyFn)(T*, T*, T*)> SI void apply_adjacent_ternary(T* dst, T* src0, T* src1)
{
    int count = src0 - dst;
#if !defined(SKRP_CPU_SCALAR)
    SK_ASSUME(count >= 1);
...
template <typename T, void (*ApplyFn)(T*, T*, T*)> SI void apply_adjacent_ternary_packed(SkRasterPipeline_TernaryOpCtx* packed, std::byte* base)
{
    auto ctx = SkRPCtxUtils::Unpack(packed);
    std::byte* dst = base + ctx.dst;
...
#define DECLARE_TERNARY_FLOAT(name)                                                                                                                            \
    STAGE_TAIL(name##_float, F* p)                                                                                                                             \
    {                                                                                                                                                          \
        apply_adjacent_ternary<F, &name##_fn>(p, p + 1, p + 2);                                                                                                \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_floats, F* p)                                                                                                                          \
    {                                                                                                                                                          \
        apply_adjacent_ternary<F, &name##_fn>(p, p + 2, p + 4);                                                                                                \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_floats, F* p)                                                                                                                          \
    {                                                                                                                                                          \
        apply_adjacent_ternary<F, &name##_fn>(p, p + 3, p + 6);                                                                                                \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_floats, F* p)                                                                                                                          \
    {                                                                                                                                                          \
        apply_adjacent_ternary<F, &name##_fn>(p, p + 4, p + 8);                                                                                                \
    }                                                                                                                                                          \
    DECLARE_N_WAY_TERNARY_FLOAT(name)

#define DECLARE_TERNARY_INT(name)                                                                                                                              \
    STAGE_TAIL(name##_int, I32* p)                                                                                                                             \
    {                                                                                                                                                          \
        apply_adjacent_ternary<I32, &name##_fn>(p, p + 1, p + 2);                                                                                              \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_2_ints, I32* p)                                                                                                                          \
    {                                                                                                                                                          \
        apply_adjacent_ternary<I32, &name##_fn>(p, p + 2, p + 4);                                                                                              \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_3_ints, I32* p)                                                                                                                          \
    {                                                                                                                                                          \
        apply_adjacent_ternary<I32, &name##_fn>(p, p + 3, p + 6);                                                                                              \
    }                                                                                                                                                          \
    STAGE_TAIL(name##_4_ints, I32* p)                                                                                                                          \
    {                                                                                                                                                          \
...
STAGE(bicubic_clamp_8888, const SkRasterPipeline_GatherCtx* ctx)
{
    ...
    const float* w = ctx->weights;
    const F scaley[4] = { bicubic_wts(fy, w[0], w[4], w[8], w[12]), bicubic_wts(fy, w[1], w[5], w[9], w[13]), bicubic_wts(fy, w[2], w[6], w[10], w[14]),
        bicubic_wts(fy, w[3], w[7], w[11], w[15]) };
    const F scalex[4] = { bicubic_wts(fx, w[0], w[4], w[8], w[12]), bicubic_wts(fx, w[1], w[5], w[9], w[13]), bicubic_wts(fx, w[2], w[6], w[10], w[14]),
...
namespace lowp {
#if defined(SKRP_CPU_SCALAR) || defined(SK_ENABLE_OPTIMIZE_SIZE) || defined(SK_BUILD_FOR_GOOGLE3) || defined(SK_DISABLE_LOWP_RASTER_PIPELINE)
...
#if defined(__clang__)
SI constexpr U16 U16_(uint16_t x)
{
    return x;
}
SI constexpr I32 I32_(int32_t x)
...
static constexpr U16 U16_0 = U16_(0), U16_255 = U16_(255);
...
#else
using Stage = void(ABI*)(SkRasterPipelineStage* program, size_t dx, size_t dy, U16 r, U16 g, U16 b, U16 a, U16 dr, U16 dg, U16 db, U16 da);
#endif

static void start_pipeline(size_t x0, size_t y0, size_t xlimit, size_t ylimit, SkRasterPipelineStage* program,
    SkSpan<SkRasterPipeline_MemoryCtxPatch> memoryCtxPatches, uint8_t* tailPointer)
{
    uint8_t unreferencedTail;
    if (!tailPointer) {
...
#else
static void ABI just_return(SkRasterPipelineStage*, size_t, size_t, U16, U16, U16, U16, U16, U16, U16, U16)
{
}
#endif
...
#define STAGE_GG(name, ARG)                                                                                                                                    \
    ...
    static void ABI name(Params* params, SkRasterPipelineStage* program, U16 r, U16 g, U16 b, U16 a)                                                           \
    {                                                                                                                                                          \
...
#define STAGE_GP(name, ARG)                                                                                                                                    \
    SI void name##_k(ARG, size_t dx, size_t dy, F x, F y, U16& r, U16& g, U16& b, U16& a, U16& dr, U16& dg, U16& db, U16& da);                                 \
    static void ABI name(Params* params, SkRasterPipelineStage* program, U16 r, U16 g, U16 b, U16 a)                                                           \
    {                                                                                                                                                          \
        auto x = join<F>(r, g), y = join<F>(b, a);                                                                                                             \
        name##_k(Ctx { program }, params->dx, params->dy, x, y, r, g, b, a, params->dr, params->dg, params->db, params->da);                                   \
        auto fn = (Stage)(++program)->fn;                                                                                                                      \
        fn(params, program, r, g, b, a);                                                                                                                       \
    }                                                                                                                                                          \
    SI void name##_k(ARG, size_t dx, size_t dy, F x, F y, U16& r, U16& g, U16& b, U16& a, U16& dr, U16& dg, U16& db, U16& da)
...
#define STAGE_PP(name, ARG)                                                                                                                                    \
    SI void name##_k(ARG, size_t dx, size_t dy, U16& r, U16& g, U16& b, U16& a, U16& dr, U16& dg, U16& db, U16& da);                                           \
    static void ABI name(Params* params, SkRasterPipelineStage* program, U16 r, U16 g, U16 b, U16 a)                                                           \
    {                                                                                                                                                          \
        name##_k(Ctx { program }, params->dx, params->dy, r, g, b, a, params->dr, params->dg, params->db, params->da);                                         \
        auto fn = (Stage)(++program)->fn;                                                                                                                      \
        fn(params, program, r, g, b, a);                                                                                                                       \
    }                                                                                                                                                          \
    SI void name##_k(ARG, size_t dx, size_t dy, U16& r, U16& g, U16& b, U16& a, U16& dr, U16& dg, U16& db, U16& da)
...
#define STAGE_GG(name, ARG)                                                                                                                                    \
    SI void name##_k(ARG, size_t dx, size_t dy, F& x, F& y);                                                                                                   \
    static void ABI name(SkRasterPipelineStage* program, size_t dx, size_t dy, U16 r, U16 g, U16 b, U16 a, U16 dr, U16 dg, U16 db, U16 da)                     \
    {                                                                                                                                                          \
        auto x = join<F>(r, g), y = join<F>(b, a);                                                                                                             \
...
SI U16 max(U16 x, U16 y)
{
    return if_then_else(x < y, y, x);
}
SI U16 min(U16 x, U16 y)
{
    return if_then_else(x < y, x, y);
}

SI U16 max(U16 a, uint16_t b)
{
    return max(a, U16_(b));
}
SI U16 max(uint16_t a, U16 b)
{
    return max(U16_(a), b);
}
SI U16 min(U16 a, uint16_t b)
{
    return min(a, U16_(b));
}
SI U16 min(uint16_t a, U16 b)
{
    return min(U16_(a), b);
}

SI U16 from_float(float f)
{
    return U16_(f * 255.0f + 0.5f);
}

SI U16 lerp(U16 from, U16 to, U16 t)
{
    return div255(from * inv(t) + to * t);
}

template <typename D, typename S> SI D cast(S src)
{
...
SI I32 max(I32 a, int32_t b)
{
    return max(a, I32_(b));
}
SI I32 max(int32_t a, I32 b)
{
    return max(I32_(a), b);
}
SI I32 min(I32 a, int32_t b)
{
    return min(a, I32_(b));
}
SI I32 min(int32_t a, I32 b)
{
    return min(I32_(a), b);
}
...
SI F abs_(F x)
{
    return sk_bit_cast<F>(sk_bit_cast<I32>(x) & 0x7fffffff);
}
...
{
    // N.B. Unlike the other matrix_ stages, this matrix is row-major.
    auto X = mad(x, m[0], mad(y, m[1], m[2])), Y = mad(x, m[3], mad(y, m[4], m[5])), Z = mad(x, m[6], mad(y, m[7], m[8]));
    x = X * rcp_precise(Z);
    y = Y * rcp_precise(Z);
}
...
STAGE_PP(black_color, NoCtx)
{
    r = g = b = U16_0;
    a = U16_255;
}
STAGE_PP(white_color, NoCtx)
{
    r = g = b = U16_255;
    a = U16_255;
}
...
STAGE_PP(force_opaque, NoCtx)
{
    a = U16_255;
}
STAGE_PP(force_opaque_dst, NoCtx)
{
    da = U16_255;
}
...
BLEND_MODE(srcatop)
{
    return div255(s * da + d * inv(sa));
}
BLEND_MODE(dstatop)
{
    return div255(d * sa + s * inv(da));
}
BLEND_MODE(srcin)
{
    return div255(s * da);
...
BLEND_MODE(srcout)
{
    return div255(s * inv(da));
}
BLEND_MODE(dstout)
{
    return div255(d * inv(sa));
}
BLEND_MODE(srcover)
{
    return s + div255(d * inv(sa));
}
BLEND_MODE(dstover)
{
    return d + div255(s * inv(da));
}
BLEND_MODE(modulate)
{
    return div255(s * d);
...
BLEND_MODE(multiply)
{
    return div255(s * inv(da) + d * inv(sa) + s * d);
}
BLEND_MODE(plus_)
{
    return min(s + d, 255);
...
BLEND_MODE(srcin)
{
    return div255_accurate(s * da);
}
BLEND_MODE(dstin)
{
    return div255_accurate(d * sa);
}
BLEND_MODE(srcout)
{
    return div255_accurate(s * inv(da));
}
BLEND_MODE(dstout)
{
    return div255_accurate(d * inv(sa));
}
BLEND_MODE(srcover)
{
    return s + div255_accurate(d * inv(sa));
}
BLEND_MODE(dstover)
{
    return d + div255_accurate(s * inv(da));
}
BLEND_MODE(modulate)
{
    return div255_accurate(s * d);
}
BLEND_MODE(multiply)
{
    return div255(s * inv(da) + d * inv(sa) + s * d);
...
BLEND_MODE(screen)
{
    return s + d - div255_accurate(s * d);
}
BLEND_MODE(xor_)
{
    return div255(s * inv(da) + d * inv(sa));
...
BLEND_MODE(darken)
{
    return s + d - div255(max(s * da, d * sa));
}
BLEND_MODE(lighten)
{
    return s + d - div255(min(s * da, d * sa));
}
BLEND_MODE(difference)
{
    return s + d - 2 * div255(min(s * da, d * sa));
}
BLEND_MODE(exclusion)
{
    return s + d - 2 * div255(s * d);
}

BLEND_MODE(hardlight)
{
    return div255(s * inv(da) + d * inv(sa) + if_then_else(2 * s <= sa, 2 * s * d, sa * da - 2 * (sa - s) * (da - d)));
}
BLEND_MODE(overlay)
{
    return div255(s * inv(da) + d * inv(sa) + if_then_else(2 * d <= da, 2 * s * d, sa * da - 2 * (sa - s) * (da - d)));
}
#undef BLEND_MODE
...
{
    // Exclusive -> inclusive.
    const F w = F_(sk_bit_cast<float>(sk_bit_cast<uint32_t>(ctx->width) - 1)), h = F_(sk_bit_cast<float>(sk_bit_cast<uint32_t>(ctx->height) - 1));
...
template <typename T> SI U32 ix_and_ptr(T** ptr, const SkRasterPipeline_GatherCtx* ctx, I32 x, I32 y)
{
    // This flag doesn't make sense when the coords are integers.
    SkASSERT(ctx->roundDownAtInteger == 0);
    // Exclusive -> inclusive.
    const I32 w = I32_(ctx->width - 1), h = I32_(ctx->height - 1);
...
template <typename V, typename T> SI V load(const T* ptr)
{
    V v;
    memcpy(&v, ptr, sizeof(v));
    return v;
}
template <typename V, typename T> SI void store(T* ptr, V v)
{
...
template <> U32 gather(const uint32_t* ptr, U32 ix)
{
    ...
    return join<U32>(_mm256_i32gather_epi32((const int*)ptr, lo, 4), _mm256_i32gather_epi32((const int*)ptr, hi, 4));
}
#elif defined(SKRP_CPU_LASX)
template <typename V, typename T> SI V gather(const T* ptr, U32 ix)
{
...
SI void from_8888(U32 rgba, U16* r, U16* g, U16* b, U16* a)
{
    ...
    auto cast_U16 = [](U32 v) -> U16 { return (U16)_mm256_packus_epi32(_mm512_castsi512_si256((__m512i)v), _mm512_extracti64x4_epi64((__m512i)v, 1)); };
#elif defined(SKRP_CPU_HSW)
    // Swap the middle 128-bit lanes to make _mm256_packus_epi32() in cast_U16() work out nicely.
    __m256i _01, _23;
    split(rgba, &_01, &_23);
    __m256i _02 = _mm256_permute2x128_si256(_01, _23, 0x20), _13 = _mm256_permute2x128_si256(_01, _23, 0x31);
    ...
    __m256i _01, _23;
    split(rgba, &_01, &_23);
    __m256i _02 = __lasx_xvpermi_q(_01, _23, 0x02), _13 = __lasx_xvpermi_q(_01, _23, 0x13);
    rgba = join<U32>(_02, _13);
...
#else
    store(ptr, cast<U32>(r | (g << 8)) << 0 | cast<U32>(b | (a << 8)) << 16);
#endif
#endif
}
...
{
    U16 mul = load_8(ptr_at_xy<const uint8_t>(&ctx->mul, dx, dy)), add = load_8(ptr_at_xy<const uint8_t>(&ctx->add, dx, dy));
...
STAGE_GG(clamp_x_1, NoCtx)
{
    x = clamp_01_(x);
}
STAGE_GG(repeat_x_1, NoCtx)
{
    x = clamp_01_(x - floor_(x));
}
...
SI I16 cond_to_mask_16(I32 cond)
{
...
SI void gradient_lookup(const SkRasterPipeline_GradientCtx* c, U32 idx, F t, U16* r, U16* g, U16* b, U16* a)
{
    ...
    if (c->stopCount <= 8) {
        ...
        fr = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[0]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[0]), hi));
        br = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[0]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[0]), hi));
        fg = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[1]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[1]), hi));
        bg = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[1]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[1]), hi));
        fb = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[2]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[2]), hi));
        bb = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[2]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[2]), hi));
        fa = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[3]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->fs[3]), hi));
        ba = join<F>(_mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[3]), lo), _mm256_permutevar8x32_ps(_mm256_loadu_ps(c->bs[3]), hi));
    } else
#elif defined(SKRP_CPU_LASX)
    if (c->stopCount <= 8) {
        __m256i lo, hi;
        ...
        fr = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[0], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[0], 0), hi));
        br = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[0], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[0], 0), hi));
        fg = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[1], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[1], 0), hi));
        bg = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[1], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[1], 0), hi));
        fb = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[2], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[2], 0), hi));
        bb = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[2], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[2], 0), hi));
        fa = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[3], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->fs[3], 0), hi));
        ba = join<F>((__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[3], 0), lo), (__m256)__lasx_xvperm_w(__lasx_xvld(c->bs[3], 0), hi));
    } else
#elif defined(SKRP_CPU_LSX)
    if (c->stopCount <= 4) {
        __m128i lo, hi;
        split(idx, &lo, &hi);
        __m128i zero = __lsx_vldi(0);
        fr = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->fs[0], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->fs[0], 0)));
        br = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->bs[0], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->bs[0], 0)));
        fg = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->fs[1], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->fs[1], 0)));
        bg = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->bs[1], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->bs[1], 0)));
        fb = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->fs[2], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->fs[2], 0)));
        bb = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->bs[2], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->bs[2], 0)));
        fa = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->fs[3], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->fs[3], 0)));
        ba = join<F>((__m128)__lsx_vshuf_w(lo, zero, __lsx_vld(c->bs[3], 0)), (__m128)__lsx_vshuf_w(hi, zero, __lsx_vld(c->bs[3], 0)));
    } else
#endif
    {
    ...
    round_F_to_U16(mad(t, fr, br), mad(t, fg, bg), mad(t, fb, bb), mad(t, fa, ba), r, g, b, a);
}
...
{
    auto t = x;
    round_F_to_U16(mad(t, c->f[0], c->b[0]), mad(t, c->f[1], c->b[1]), mad(t, c->f[2], c->b[2]), mad(t, c->f[3], c->b[3]), &r, &g, &b, &a);
}
...
STAGE_GP(bilerp_clamp_8888, const SkRasterPipeline_GatherCtx* ctx)
{
...
#else
    I32 qx = cast<I32>(floor_(65536.0f * x + 0.5f)) - 32768, qy = cast<I32>(floor_(65536.0f * y + 0.5f)) - 32768;
#endif
    ...
    U16 topR = lerpX(leftR, rightR), topG = lerpX(leftG, rightG), topB = lerpX(leftB, rightB), topA = lerpX(leftA, rightA);
    ...
    U16 bottomR = lerpX(leftR, rightR), bottomG = lerpX(leftG, rightG), bottomB = lerpX(leftB, rightB), bottomA = lerpX(leftA, rightA);
...
namespace lowp {
static constexpr size_t lowp_N = N;
}
