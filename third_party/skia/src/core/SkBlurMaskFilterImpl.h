...
private:
    ...
    bool filterRectMask(SkMaskBuilder* dstM, const SkRect& r, const SkMatrix& matrix, SkIPoint* margin, SkMaskBuilder::CreateMode createMode) const;
    bool filterRRectMask(SkMaskBuilder* dstM, const SkRRect& r, const SkMatrix& matrix, SkIPoint* margin, SkMaskBuilder::CreateMode createMode) const;
