...
inline static constexpr size_t SkRasterPipeline_MaxScratchPerPatch = std::max(SkRasterPipeline_kMaxStride_highp * 16, // 16 == largest highp bpp (RGBA_F32)
...
struct SkRasterPipeline_CallbackCtx {
    void (*fn)(SkRasterPipeline_CallbackCtx* self, int active_pixels /*<= SkRasterPipeline_kMaxStride_highp*/);
