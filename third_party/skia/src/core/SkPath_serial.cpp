...
size_t SkPath::writeToMemoryAsRRect(void* storage) const
{
    ...
    int32_t packed = (fFillType << kFillType_SerializationShift) | (firstDir << kDirection_SerializationShift)
...
size_t SkPath::readFromMemory(const void* storage, size_t length)
{
    ...
    *this = SkPathPriv::MakePath(analysis, points, verbs, counts.vbs, conics, extract_filltype(packed), false);
    return buffer.pos();
}
