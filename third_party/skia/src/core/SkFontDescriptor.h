...
public:
    ...
    SkFontData(std::unique_ptr<SkStreamAsset> stream, int index, int paletteIndex, const SkFixed* axis, int axisCount,
    ...
    {
        return fPaletteIndex;
    }
    int getPaletteOverrideCount() const
    {
        return fPaletteOverrideCount;
    }
...
public:
    ...
    {
        return fPaletteEntryOverrideCount;
    }
    ...
    SkFontArguments getFontArguments() const
    {
        return SkFontArguments()
            ...
            .setPalette({ this->getPaletteIndex(), this->getPaletteEntryOverrides(), this->getPaletteEntryOverrideCount() });
    }
...
private:
    ...
    using Coordinates = skia_private::AutoSTMalloc<4, SkFontArguments::VariationPosition::Coordinate>;
