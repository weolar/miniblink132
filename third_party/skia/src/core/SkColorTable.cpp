...
sk_sp<SkColorTable> SkColorTable::Make(const uint8_t tableA[256], const uint8_t tableR[256], const uint8_t tableG[256], const uint8_t tableB[256])
{
    ...
    uint8_t *a = table.getAddr8(0, 0), *r = table.getAddr8(0, 1), *g = table.getAddr8(0, 2), *b = table.getAddr8(0, 3);
    for (int i = 0; i < 256; i++) {
