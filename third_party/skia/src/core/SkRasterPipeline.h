...
#if __has_cpp_attribute(clang::musttail) && !defined(__EMSCRIPTEN__) && !defined(SK_CPU_ARM32) && !defined(SK_CPU_LOONGARCH) && !defined(SK_CPU_PPC)           \
...
private:
    ...
    using StartPipelineFn = void (*)(size_t, size_t, size_t, size_t, SkRasterPipelineStage* program, SkSpan<SkRasterPipeline_MemoryCtxPatch>, uint8_t*);
