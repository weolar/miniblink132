...
bool SkPathEffect::filterPath(SkPath* dst, const SkPath& src, SkStrokeRec* rec, const SkRect* bounds, const SkMatrix& ctm) const
{
...
bool SkPathEffectBase::asPoints(PointData* results, const SkPath& src, const SkStrokeRec& rec, const SkMatrix& mx, const SkRect* rect) const
{
...
sk_sp<SkPathEffect> SkPathEffect::MakeCompose(sk_sp<SkPathEffect> outer, sk_sp<SkPathEffect> inner)
{
...
sk_sp<SkPathEffect> SkPathEffect::Deserialize(const void* data, size_t size, const SkDeserialProcs* procs)
{
