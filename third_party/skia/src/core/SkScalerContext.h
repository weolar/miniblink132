...
public:
    void setDeviceGamma(SkScalar g)
    {
        ...
        SkASSERT(SkSurfaceProps::kMinGammaInclusive <= g && g < SkIntToScalar(SkSurfaceProps::kMaxGammaExclusive));
    ...
    void setContrast(SkScalar c)
    {
        ...
        SkASSERT(SkSurfaceProps::kMinContrastInclusive <= c && c <= SkIntToScalar(SkSurfaceProps::kMaxContrastInclusive));
...
public:
    ...
    SkString dump() const
    {
        SkString msg;
        msg.appendf("    Rec\n");
        msg.appendf("      textsize %a prescale %a preskew %a post [%a %a %a %a]\n", fTextSize, fPreScaleX, fPreSkewX, fPost2x2[0][0], fPost2x2[0][1],
            fPost2x2[1][0], fPost2x2[1][1]);
     ...
     */
    bool computeMatrices(PreMatrixScale preMatrixScale, SkVector* scale, SkMatrix* remaining, SkMatrix* remainingWithoutRotation = nullptr,
...
public:
    ...
    static void MakeRecAndEffects(const SkFont& font, const SkPaint& paint, const SkSurfaceProps& surfaceProps, SkScalerContextFlags scalerContextFlags,
    ...
    {
        SkPaint paint;
        return MakeRecAndEffects(font, paint, SkSurfaceProps(), SkScalerContextFlags::kNone, SkMatrix::I(), rec, effects);
    }
    ...
    */
    ...
    static SkDescriptor* CreateDescriptorAndEffectsUsingPaint(const SkFont&, const SkPaint&, const SkSurfaceProps&, SkScalerContextFlags scalerContextFlags,
...
protected:
    ...
    static void GenerateImageFromPath(
        SkMaskBuilder& dst, const SkPath& path, const SkMaskGamma::PreBlend& maskPreBlend, bool doBGR, bool verticalLCD, bool a8FromLCD, bool hairline);
