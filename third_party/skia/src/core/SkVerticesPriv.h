...
public:
    ...
    {
        return fVertices->fMode;
    }

    bool hasColors() const
    {
        return SkToBool(fVertices->fColors);
    }
    bool hasTexCoords() const
    {
        return SkToBool(fVertices->fTexs);
    }
    bool hasIndices() const
    {
        return SkToBool(fVertices->fIndices);
    }

    int vertexCount() const
    {
        return fVertices->fVertexCount;
    }
    ...
    {
        return fVertices->fPositions;
    }
    const SkPoint* texCoords() const
    {
        return fVertices->fTexs;
    }
    const SkColor* colors() const
    {
        return fVertices->fColors;
    }
...
private:
    explicit SkVerticesPriv(SkVertices* vertices)
        : fVertices(vertices)
    {
    }
