...
#define SK_CALLABLE_TRAITS__INSTANCE(quals, varargs)                                                                                                           \
    template <typename R, typename... Args> struct SkCallableTraits<R(Args... varargs) quals> : sk_base_callable_traits<R, Args...> { };
...
#define SK_CALLABLE_TRAITS__INSTANCE(quals, varargs)                                                                                                           \
    template <typename T, typename R, typename... Args> struct SkCallableTraits<R (T::*)(Args... varargs) quals> : sk_base_callable_traits<R, Args...> { };

SK_CALLABLE_TRAITS__CV_REF_NE_VARARGS()
#undef SK_CALLABLE_TRAITS__INSTANCE

// pointer to field
template <typename T, typename R> struct SkCallableTraits<R T::*> : sk_base_callable_traits<typename std::add_lvalue_reference<R>::type> { };
