...
const void* SkDWriteFontFileStream::getMemoryBase()
{
    ...
    HRNM(fFontFileStream->ReadFileFragment(&fLockedMemory, 0, fileSize, &fFragmentLock), "Could not lock file fragment.");
    return fLockedMemory;
}
...
HRESULT SkDWriteFontFileStreamWrapper::Create(SkStreamAsset* stream, SkDWriteFontFileStreamWrapper** streamFontFileStream)
{
...
SK_STDMETHODIMP SkDWriteFontFileStreamWrapper::ReadFileFragment(void const** fragmentStart, UINT64 fileOffset, UINT64 fragmentSize, void** fragmentContext)
{
