...
public:
    ...
    SK_ALWAYS_INLINE constexpr explicit operator bool() const
    {
        return fValue;
    }
...
private:
    SK_ALWAYS_INLINE constexpr explicit SkEnumBitMask(int value)
        : fValue(value)
    {
    }
