...
public:
    ...
    static SkAdvancedTypefaceMetrics::FontType FontType(const SkPDFStrike&, const SkAdvancedTypefaceMetrics&);
    ...
    static skia_private::THashMap<SkGlyphID, SkString>& GetUnicodeMapEx(const SkTypeface& typeface, SkPDFDocument* canon);
    ...
    const SkPDFStrike& strike() const
    {
        return *fStrike;
    }
...
private:
    ...
    SkPDFFont(const SkPDFStrike*, SkGlyphID firstGlyphID, SkGlyphID lastGlyphID, SkAdvancedTypefaceMetrics::FontType fontType,
