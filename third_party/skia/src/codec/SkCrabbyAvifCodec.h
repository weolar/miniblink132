...
public:
     ...
     */
    static std::unique_ptr<SkCodec> MakeFromStream(std::unique_ptr<SkStream>, Result*, bool gainmapOnly = false);
...
private:
    SkCrabbyAvifCodec(SkEncodedInfo&&, std::unique_ptr<SkStream>, sk_sp<SkData>, AvifDecoder, SkEncodedOrigin, bool, bool);

    static std::unique_ptr<SkCodec> MakeFromData(std::unique_ptr<SkStream>, sk_sp<SkData>, Result*, bool gainmapOnly);
