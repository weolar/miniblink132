...
static bool cicp_get_primaries(uint8_t primaries, skcms_Matrix3x3* sk_primaries)
{
    ...
    case 3:
        ...
        break;
    case 4:
        return skcms_PrimariesToXYZD50(0.67f, 0.33f, 0.21f, 0.71f, 0.14f, 0.08f, 0.31f, 0.316f, sk_primaries);
    case 5:
        return skcms_PrimariesToXYZD50(0.64f, 0.33f, 0.29f, 0.60f, 0.15f, 0.06f, 0.3127f, 0.3290f, sk_primaries);
    case 6:
        return skcms_PrimariesToXYZD50(0.630f, 0.340f, 0.310f, 0.595f, 0.155f, 0.070f, 0.3127f, 0.3290f, sk_primaries);
    case 7:
        return skcms_PrimariesToXYZD50(0.630f, 0.340f, 0.310f, 0.595f, 0.155f, 0.070f, 0.3127f, 0.3290f, sk_primaries);
    case 8:
        return skcms_PrimariesToXYZD50(0.681f, 0.319f, 0.243f, 0.692f, 0.145f, 0.049f, 0.310f, 0.316f, sk_primaries);
    case 9:
        *sk_primaries = SkNamedGamut::kRec2020;
        return true;
    case 10:
        return skcms_PrimariesToXYZD50(1.f, 0.f, 0.f, 1.f, 0.f, 0.f, 1.f / 3.f, 1.f / 3.f, sk_primaries);
    case 11:
        return skcms_PrimariesToXYZD50(0.680f, 0.320f, 0.265f, 0.690f, 0.150f, 0.060f, 0.314f, 0.351f, sk_primaries);
    case 12:
        return skcms_PrimariesToXYZD50(0.680f, 0.320f, 0.265f, 0.690f, 0.150f, 0.060f, 0.3127f, 0.3290f, sk_primaries);
    case 22:
        return skcms_PrimariesToXYZD50(0.630f, 0.340f, 0.295f, 0.605f, 0.155f, 0.077f, 0.3127f, 0.3290f, sk_primaries);
    default:
        // Reserved.
        break;
    }
...
static bool cicp_get_transfer_fn(uint8_t transfer_characteristics, skcms_TransferFunction* trfn)
{
    ...
    case 6:
        *trfn = SkNamedTransferFn::kRec2020;
        return true;
    case 7:
        *trfn = { 2.222222222222f, 0.899626676224f, 0.100373323776f, 0.25f, 0.091286342118f, 0.f, 0.f };
        return true;
    case 8:
    ...
    case 16:
        ...
        *trfn = { -2.f, -1.55522297832f, 1.86045365631f, 32 / 2523.0f, 2413 / 128.0f, -2392 / 128.0f, 8192 / 1305.0f };
        return true;
    case 17:
    ...
    case 18:
        ...
        if (skcms_TransferFunction_makeScaledHLGish(trfn, 0.314509843f, 2.f, 2.f, 1.f / 0.17883277f, 0.28466892f, 0.55991073f)) {
            return true;
        }
        break;
    default:
...
static sk_sp<SkColorSpace> cicp_get_sk_color_space(
    uint8_t color_primaries, uint8_t transfer_characteristics, uint8_t matrix_coefficients, uint8_t full_range_flag)
{
    ...
    if (!cicp_get_transfer_fn(transfer_characteristics, &trfn))
        return nullptr;

    skcms_Matrix3x3 primaries;
    if (!cicp_get_primaries(color_primaries, &primaries))
        return nullptr;
...
std::unique_ptr<SkAndroidCodec> SkAndroidCodec::MakeFromData(sk_sp<SkData> data, SkPngChunkReader* chunkReader)
{
    if (!data) {
        return nullptr;
    }
...
SkColorType SkAndroidCodec::computeOutputColorType(SkColorType requestedColorType)
{
    ...
    return highPrecision ? kRGBA_F16_SkColorType : (colorDepth == 10 ? kRGBA_1010102_SkColorType : kN32_SkColorType);
}
...
sk_sp<SkColorSpace> SkAndroidCodec::computeOutputColorSpace(SkColorType outputColorType, sk_sp<SkColorSpace> prefColorSpace)
{
    ...
    case kRGBA_1010102_SkColorType: {
        ...
        if (encodedProfile) {
            ...
            if (encodedProfile->has_CICP) {
                const auto cicpColorSpace = cicp_get_sk_color_space(encodedProfile->CICP.color_primaries, encodedProfile->CICP.transfer_characteristics,
                    encodedProfile->CICP.matrix_coefficients, encodedProfile->CICP.video_full_range_flag);
                if (cicpColorSpace) {
            ...
            if (encodedProfile->has_toXYZD50) {
                return SkColorSpace::MakeRGB(SkNamedTransferFn::kSRGB, encodedProfile->toXYZD50);
            }
        }
...
int SkAndroidCodec::computeSampleSize(SkISize* desiredSize) const
{
    ...
    if (desiredSize->width() < 1 || desiredSize->height() < 1) {
        *desiredSize = SkISize::Make(std::max(1, desiredSize->width()), std::max(1, desiredSize->height()));
    }
...
SkISize SkAndroidCodec::getSampledSubsetDimensions(int sampleSize, const SkIRect& subset) const
{
    ...
    return { get_scaled_dimension(subset.width(), sampleSize), get_scaled_dimension(subset.height(), sampleSize) };
}

SkCodec::Result SkAndroidCodec::getAndroidPixels(const SkImageInfo& requestInfo, void* requestPixels, size_t requestRowBytes, const AndroidOptions* options)
{
    if (!requestPixels) {
    ...
    auto getPixelsFn = [&](const SkImageInfo& info, void* pixels, size_t rowBytes, const SkCodec::Options& opts, int requiredFrame) -> SkCodec::Result {
    ...
    if (auto result = fCodec->handleFrameIndex(requestInfo, requestPixels, requestRowBytes, *options, getPixelsFn); result != SkCodec::kSuccess) {
        return result;
    }
...
SkCodec::Result SkAndroidCodec::getAndroidPixels(const SkImageInfo& info, void* pixels, size_t rowBytes)
{
    return this->getAndroidPixels(info, pixels, rowBytes, nullptr);
}

bool SkAndroidCodec::getGainmapAndroidCodec(SkGainmapInfo* info, std::unique_ptr<SkAndroidCodec>* outCodec)
{
    if (outCodec) {
...
bool SkAndroidCodec::getAndroidGainmap(SkGainmapInfo* info, std::unique_ptr<SkStream>* outGainmapImageStream)
{
