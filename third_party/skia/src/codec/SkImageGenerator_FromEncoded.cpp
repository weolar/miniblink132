...
sk_sp<SkImage> DeferredFromEncodedData(sk_sp<SkData> encoded, std::optional<SkAlphaType> alphaType)
{
...
{
    return SkImages::DeferredFromGenerator(SkCodecImageGenerator::MakeFromCodec(std::move(codec), alphaType));
}
