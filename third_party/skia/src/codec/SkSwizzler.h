...
public:
    ...
    static std::unique_ptr<SkSwizzler> Make(
        const SkEncodedInfo& encodedInfo, const SkPMColor* ctable, const SkImageInfo& dstInfo, const SkCodec::Options&, const SkIRect* frame = nullptr);
     ...
     *  @return A new SkSwizzler or nullptr on failure.
     */
    static std::unique_ptr<SkSwizzler> MakeSimple(int srcBPP, const SkImageInfo& dstInfo, const SkCodec::Options&, const SkIRect* frame = nullptr);
...
private:
    ...
    static std::unique_ptr<SkSwizzler> Make(const SkImageInfo& dstInfo, RowProc fastProc, RowProc proc, const SkPMColor* ctable, int srcBPP, int dstBPP,
