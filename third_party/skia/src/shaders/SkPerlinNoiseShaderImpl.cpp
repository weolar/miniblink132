...
SkPerlinNoiseShader::SkPerlinNoiseShader(
    SkPerlinNoiseShaderType type, SkScalar baseFrequencyX, SkScalar baseFrequencyY, int numOctaves, SkScalar seed, const SkISize* tileSize)
    : fType(type)
...
bool SkPerlinNoiseShader::appendStages(const SkStageRec& rec, const SkShaders::MatrixRec& mRec) const
{
    ...
    fInitPaintingDataOnce([&] { const_cast<SkPerlinNoiseShader*>(this)->fPaintingData = this->getPaintingData(); });
...
namespace SkShaders {
sk_sp<SkShader> MakeFractalNoise(SkScalar baseFrequencyX, SkScalar baseFrequencyY, int numOctaves, SkScalar seed, const SkISize* tileSize)
{
    ...
    return sk_sp<SkShader>(new SkPerlinNoiseShader(SkPerlinNoiseShaderType::kFractalNoise, baseFrequencyX, baseFrequencyY, numOctaves, seed, tileSize));
}

sk_sp<SkShader> MakeTurbulence(SkScalar baseFrequencyX, SkScalar baseFrequencyY, int numOctaves, SkScalar seed, const SkISize* tileSize)
{
    if (!valid_input(baseFrequencyX, baseFrequencyY, numOctaves, tileSize, seed)) {
        return nullptr;
    }
    ...
    return sk_sp<SkShader>(new SkPerlinNoiseShader(SkPerlinNoiseShaderType::kTurbulence, baseFrequencyX, baseFrequencyY, numOctaves, seed, tileSize));
}
