...
bool SkWorkingColorSpaceShader::appendStages(const SkStageRec& rec, const SkShaders::MatrixRec& mRec) const
{
    ...
    SkColorInfo dst = { rec.fDstColorType, kPremul_SkAlphaType, dstCS }, working = { rec.fDstColorType, kPremul_SkAlphaType, fWorkingSpace };
    ...
    SkStageRec workingRec = { rec.fPipeline, rec.fAlloc, rec.fDstColorType, fWorkingSpace.get(), paintColorInWorkingSpace, rec.fSurfaceProps };
