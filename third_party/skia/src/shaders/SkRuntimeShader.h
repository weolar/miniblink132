...
public:
    ...
    SkRuntimeShader(sk_sp<SkRuntimeEffect> effect, sk_sp<SkSL::DebugTracePriv> debugTrace, UniformsCallback uniformsCallback,
    ...
    {
        return fEffect->alwaysOpaque();
    }

    ShaderType type() const override
    {
        return ShaderType::kRuntime;
    }
