...
void DrawImageRect(SkCanvas* canvas, const SkImage* image, const SkRect& src, const SkRect& dst, const SkSamplingOptions& sampling, const SkPaint* paint,
    SkCanvas::SrcRectConstraint constraint)
{
    ...
    if (!SkCanvasPriv::TopDevice(canvas)->drawAsTiledImageRect(canvas, image, &src, dst, sampling, p, constraint)) {
