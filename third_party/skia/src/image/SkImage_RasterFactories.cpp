...
sk_sp<SkImage> RasterFromCompressedTextureData(sk_sp<SkData> data, int width, int height, SkTextureCompressionType type)
{
    ...
    SkAlphaType at = SkTextureCompressionTypeIsOpaque(type) ? kOpaque_SkAlphaType : kPremul_SkAlphaType;
