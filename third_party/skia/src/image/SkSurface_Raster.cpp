...
SkSurface_Raster::SkSurface_Raster(
    const SkImageInfo& info, void* pixels, size_t rb, void (*releaseProc)(void* pixels, void* context), void* context, const SkSurfaceProps* props)
...
SkSurface_Raster::SkSurface_Raster(const SkImageInfo& info, sk_sp<SkPixelRef> pr, const SkSurfaceProps* props)
...
{
    return new SkCanvas(fBitmap, this->props());
}
...
sk_sp<SkSurface> WrapPixels(const SkImageInfo& info, void* pixels, size_t rowBytes, PixelsReleaseProc releaseProc, void* context, const SkSurfaceProps* props)
{
...
sk_sp<SkSurface> WrapPixels(const SkImageInfo& info, void* pixels, size_t rowBytes, const SkSurfaceProps* props)
{
