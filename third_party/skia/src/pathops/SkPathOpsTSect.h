...
private:
    ...
    SkDEBUGCODE(SkOpGlobalState* fDebugGlobalState;) SkDEBUGCODE(SkTSect* fDebugSect;) PATH_OPS_DEBUG_T_SECT_CODE(int fID;) friend class SkTSect;
};
...
private:
    ...
    bool fRemovedEndT;
    bool fHung;
    SkDEBUGCODE(SkOpGlobalState* fDebugGlobalState;) SkDEBUGCODE(SkTSect* fOppSect;) PATH_OPS_DEBUG_T_SECT_CODE(int fID;)
