...
extern SkDPoint (SkDCurve::*const Top[])(const SkPoint curve[], SkScalar cWeight, double tStart, double tEnd, double* topT);
...
static SkDPoint (*const CurveDPointAtT[])(const SkPoint[], SkScalar, double) = { nullptr, dline_xy_at_t, dquad_xy_at_t, dconic_xy_at_t, dcubic_xy_at_t };
...
static SkDPoint (*const CurveDDPointAtT[])(const SkDCurve&, double) = { nullptr, ddline_xy_at_t, ddquad_xy_at_t, ddconic_xy_at_t, ddcubic_xy_at_t };
...
static SkPoint (*const CurvePointAtT[])(const SkPoint[], SkScalar, double) = { nullptr, fline_xy_at_t, fquad_xy_at_t, fconic_xy_at_t, fcubic_xy_at_t };
...
static SkDVector (*const CurveDDSlopeAtT[])(const SkDCurve&, double) = { nullptr, ddline_dxdy_at_t, ddquad_dxdy_at_t, ddconic_dxdy_at_t, ddcubic_dxdy_at_t };
...
static SkVector (*const CurveSlopeAtT[])(const SkPoint[], SkScalar, double) = { nullptr, fline_dxdy_at_t, fquad_dxdy_at_t, fconic_dxdy_at_t, fcubic_dxdy_at_t };
