...
public:
    ...
    static sk_sp<SlugImpl> Make(const SkMatrix& viewMatrix, const sktext::GlyphRunList& glyphRunList, const SkPaint& paint, SkStrikeDeviceInfo strikeDeviceInfo,
    ...
    {
        return fSubRuns->initialPosition();
    }
    ...
    {
        SK_ABORT("All slugs are created by placement new.");
    }
