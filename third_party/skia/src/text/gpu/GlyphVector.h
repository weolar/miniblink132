...
public:
    ...
    {
        return GlyphVectorSize(fGlyphs.size());
    }
...
private:
    ...
    std::tuple<bool, int> regenerateAtlasForGanesh(int begin, int end, skgpu::MaskFormat maskFormat, int srcPadding, GrMeshDrawTarget*);
    ...
    std::tuple<bool, int> regenerateAtlasForGraphite(int begin, int end, skgpu::MaskFormat maskFormat, int srcPadding, skgpu::graphite::Recorder*);
