...
private:
    const SkScalar fMatrixMin, fMatrixMax;
};
#endif
...
public:
#if !defined(SK_DISABLE_SDF_TEXT)
    SubRunControl(bool ableToUseSDFT, bool useSDFTForSmallText, bool useSDFTForPerspectiveText, SkScalar min, SkScalar max, bool forcePathAA = false);
    ...
    {
        return fMaxDistanceFieldFontSize;
    }
#else
    SubRunControl(bool forcePathAA = false)
