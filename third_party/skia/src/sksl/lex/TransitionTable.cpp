...
static int add_compact_entry(const TransitionSet& transitionSet, const std::vector<int>& data, std::vector<CompactEntry>* entries)
{
...
static int add_full_entry(const TransitionSet& transitionMap, const std::vector<int>& data, std::vector<FullEntry>* entries)
{
