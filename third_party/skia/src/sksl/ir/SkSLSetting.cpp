...
static const CapsLookupTable& caps_lookup_table()
{
    ...
    static SkNoDestructor<CapsLookupTable> sCapsLookupTable(CapsLookupTable {
        ...
        CapsLookupTable::Pair("mustGuardDivisionEvenAfterExplicitZeroCheck", &ShaderCaps::fMustGuardDivisionEvenAfterExplicitZeroCheck),
        CapsLookupTable::Pair("atan2ImplementedAsAtanYOverX", &ShaderCaps::fAtan2ImplementedAsAtanYOverX),
        ...
        CapsLookupTable::Pair("rewriteMatrixVectorMultiply", &ShaderCaps::fRewriteMatrixVectorMultiply),
        CapsLookupTable::Pair("PerlinNoiseRoundingFix", &ShaderCaps::fPerlinNoiseRoundingFix),
    });
...
std::unique_ptr<Expression> Setting::Convert(const Context& context, Position pos, const std::string_view& name)
{
