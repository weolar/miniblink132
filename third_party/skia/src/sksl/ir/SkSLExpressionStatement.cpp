...
std::unique_ptr<Statement> ExpressionStatement::Convert(const Context& context, std::unique_ptr<Expression> expr)
{
...
std::unique_ptr<Statement> ExpressionStatement::Make(const Context& context, std::unique_ptr<Expression> expr)
{
