...
public:
    ...
    FunctionDefinition(Position pos, const FunctionDeclaration* declaration, std::unique_ptr<Statement> body)
    ...
    static std::unique_ptr<FunctionDefinition> Make(const Context& context, Position pos, const FunctionDeclaration& function, std::unique_ptr<Statement> body);
