...
bool Layout::checkPermittedLayout(const Context& context, Position pos, LayoutFlags permittedLayoutFlags) const
{
    ...
    if ((layoutFlags & (LayoutFlag::kTexture | LayoutFlag::kSampler)) && layoutFlags & LayoutFlag::kBinding) {
...
{
    return fFlags == other.fFlags && fLocation == other.fLocation && fOffset == other.fOffset && fBinding == other.fBinding && fTexture == other.fTexture
        && fSampler == other.fSampler && fIndex == other.fIndex && fSet == other.fSet && fBuiltin == other.fBuiltin
        && fInputAttachmentIndex == other.fInputAttachmentIndex && fLocalSizeX == other.fLocalSizeX && fLocalSizeY == other.fLocalSizeY
