...
std::unique_ptr<Statement> DoStatement::Convert(const Context& context, Position pos, std::unique_ptr<Statement> stmt, std::unique_ptr<Expression> test)
{
...
std::unique_ptr<Statement> DoStatement::Make(const Context& context, Position pos, std::unique_ptr<Statement> stmt, std::unique_ptr<Expression> test)
{
