...
#define BUFFER_BINDING(slot, type, policy)                                                                                                                     \
    {                                                                                                                                                          \
        /*type=*/ComputeStep::ResourceType::k##type##Buffer, /*flow=*/ComputeStep::DataFlow::kShared, /*policy=*/ComputeStep::ResourcePolicy::k##policy,       \
            /*slot=*/kVelloSlot_##slot,                                                                                                                        \
    }

#define TEXTURE_BINDING(slot, type, policy)                                                                                                                    \
    {                                                                                                                                                          \
        /*type=*/ComputeStep::ResourceType::k##type##Texture, /*flow=*/ComputeStep::DataFlow::kShared, /*policy=*/ComputeStep::ResourcePolicy::k##policy,      \
            /*slot=*/kVelloSlot_##slot,                                                                                                                        \
    }
...
VelloFineAreaStep::VelloFineAreaStep()
    : VelloFineStepBase(kFineAreaResources)
{
}
...
VelloFineMsaa8Step::VelloFineMsaa8Step()
    : VelloFineMsaaStepBase(kFineMsaaResources)
{
}
...
VelloFineMsaa8Alpha8Step::VelloFineMsaa8Alpha8Step()
    : VelloFineMsaaStepBase(kFineMsaaResources)
{
}
