...
public:
    ...
    bool readPixels(const SkPixmap&, const TextureProxy*, const SkImageInfo& srcImageInfo, int srcX, int srcY);
...
private:
    ...
    explicit ContextPriv(Context* context)
        : fContext(context)
    {
    }
