...
public:
    ...
    {
        return static_cast<const MtlCaps&>(*this->caps());
    }
...
private:
    MtlSharedContext(sk_cfp<id<MTLDevice>>, sk_sp<skgpu::MtlMemoryAllocator> memoryAllocator, std::unique_ptr<const MtlCaps>);
