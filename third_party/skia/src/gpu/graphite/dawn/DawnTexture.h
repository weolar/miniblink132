...
public:
    ...
    {
        return fSampleTextureView;
    }
    const wgpu::TextureView& renderTextureView() const
    {
        return fRenderTextureView;
    }

private:
    DawnTexture(const DawnSharedContext*, SkISize dimensions, const TextureInfo&, wgpu::Texture, wgpu::TextureView sampleTextureView,
        wgpu::TextureView renderTextureView, Ownership, skgpu::Budgeted);

    void freeGpuData() override;

    static std::pair<wgpu::TextureView, wgpu::TextureView> CreateTextureViews(const wgpu::Texture& texture, const TextureInfo& info);
