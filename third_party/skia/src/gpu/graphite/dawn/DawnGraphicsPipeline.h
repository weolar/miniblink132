...
public:
    ...
    static sk_sp<DawnGraphicsPipeline> Make(const DawnSharedContext* sharedContext, DawnResourceProvider* resourceProvider,
...
private:
    ...
    DawnGraphicsPipeline(const skgpu::graphite::SharedContext* sharedContext, const PipelineInfo& pipelineInfo,
        std::unique_ptr<AsyncPipelineCreation> pipelineCreationInfo, BindGroupLayouts groupLayouts, PrimitiveType primitiveType, uint32_t refValue,
