...
public:
    ...
    {
        return static_cast<const DawnCaps*>(this->caps());
    }
...
private:
    DawnSharedContext(const DawnBackendContext&, std::unique_ptr<const DawnCaps> caps, wgpu::ShaderModule noopFragment);
