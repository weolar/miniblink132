...
public:
    ...
    {
        return fUseAsyncPipelineCreation;
    }
    bool allowScopedErrorChecks() const
    {
        return fAllowScopedErrorChecks;
    }
    ...
    {
        return fSupportsPartialLoadResolve;
    }
...
private:
    ...
    struct FormatInfo {
        ...
        static const uint16_t kAllFlags = kTexturable_Flag | kRenderable_Flag | kMSAA_Flag | kResolve_Flag | kStorage_Flag;
