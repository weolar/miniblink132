...
public:
    ...
    //    pipeline layouts)
    static std::unique_ptr<ShaderInfo> Make(const Caps*, const ShaderCodeDictionary*, const RuntimeEffectDictionary*, const RenderStep*, UniquePaintParamsID,
        bool useStorageBuffers, skgpu::Swizzle writeSwizzle, skia_private::TArray<SamplerDesc>* outDescs = nullptr);
...
private:
    ...
    void generateVertexSkSL(const Caps*, const RenderStep*, bool useStorageBuffers);
    ...
    void generateFragmentSkSL(const Caps*, const ShaderCodeDictionary*, const RenderStep*, UniquePaintParamsID, bool useStorageBuffers,
        skgpu::Swizzle writeSwizzle, skia_private::TArray<SamplerDesc>* outDescs);
