...
BitmapTextRenderStep::BitmapTextRenderStep(skgpu::MaskFormat variant)
    : RenderStep("BitmapTextRenderStep", variant_name(variant), Flags(variant),
        /*uniforms=*/ { { "subRunDeviceMatrix", SkSLType::kFloat4x4 }, { "deviceToLocal", SkSLType::kFloat4x4 }, { "atlasSizeInv", SkSLType::kFloat2 } },
...
SkEnumBitMask<RenderStep::Flags> BitmapTextRenderStep::Flags(skgpu::MaskFormat variant)
{
    ...
    case skgpu::MaskFormat::kA565:
        return Flags::kPerformsShading | Flags::kHasTextures | Flags::kEmitsCoverage | Flags::kLCDCoverage;
    case skgpu::MaskFormat::kARGB:
...
std::string BitmapTextRenderStep::texturesAndSamplersSkSL(const ResourceBindingRequirements& bindingReqs, int* nextBindingIndex) const
{
    std::string result;
...
void BitmapTextRenderStep::writeVertices(DrawWriter* dw, const DrawParams& params, skvx::uint2 ssboIndices) const
{
