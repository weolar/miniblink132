...
GraphicsPipeline::GraphicsPipeline(const SharedContext* sharedContext, const PipelineInfo& pipelineInfo)
...
GraphicsPipeline::PipelineInfo::PipelineInfo(const ShaderInfo& shaderInfo, SkEnumBitMask<PipelineCreationFlags> pipelineCreationFlags)
    ...
    , fHasGradientBuffer(shaderInfo.hasGradientBuffer())
{
    ...
    fFromPrecompile = SkToBool(pipelineCreationFlags & PipelineCreationFlags::kForPrecompilation);
#endif
}
