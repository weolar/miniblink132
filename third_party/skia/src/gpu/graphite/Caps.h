...
public:
    ...
    virtual bool loadOpAffectsMSAAPipelines() const
    {
        return false;
    }
    ...
    {
        return fRequiredUniformBufferAlignment;
    }
    ...
    {
        return fRequiredStorageBufferAlignment;
    }
    ...
    {
        return fRequiredTransferBufferAlignment;
    }
    ...
    bool ndcYAxisPointsDown() const
    {
        return fNDCYAxisPointsDown;
    }
    ...
    {
        return fStorageBufferSupport
            && (fResourceBindingReqs.fStorageBufferLayout == Layout::kStd430 || fResourceBindingReqs.fStorageBufferLayout == Layout::kMetal);
    }

    // Returns whether a draw buffer can be mapped.
    bool drawBufferCanBeMapped() const
    {
        return fDrawBufferCanBeMapped;
    }

#if defined(GPU_TEST_UTILS)
    bool drawBufferCanBeMappedForReadback() const
    {
    ...
    {
        return fMinDistanceFieldFontSize;
    }
    float glyphsAsPathsFontSize() const
    {
        return fGlyphsAsPathsFontSize;
    }

    size_t glyphCacheTextureMaximumBytes() const
    {
        return fGlyphCacheTextureMaximumBytes;
    }
    int maxPathAtlasTextureSize() const
    {
        return fMaxPathAtlasTextureSize;
    }

    bool allowMultipleAtlasTextures() const
    {
        return fAllowMultipleAtlasTextures;
    }
    bool supportBilerpFromGlyphAtlas() const
    {
        return fSupportBilerpFromGlyphAtlas;
    }

    bool requireOrderedRecordings() const
    {
        return fRequireOrderedRecordings;
    }
