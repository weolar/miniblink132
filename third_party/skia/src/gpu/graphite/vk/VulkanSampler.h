...
public:
    static sk_sp<VulkanSampler> Make(const VulkanSharedContext*, const SamplerDesc&, sk_sp<VulkanYcbcrConversion> ycbcrConversion = nullptr);
    ...
    const VkSampler* constVkSamplerPtr() const
    {
        return &fSampler;
    }

private:
    VulkanSampler(const VulkanSharedContext*, const SamplerDesc&, VkSampler, sk_sp<VulkanYcbcrConversion>);
