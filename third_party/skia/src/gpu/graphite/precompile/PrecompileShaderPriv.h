...
public:
    ...
    {
        return fPrecompileShader->numChildCombinations();
    }

    int numCombinations() const
    {
        return fPrecompileShader->numCombinations();
    }
...
inline PrecompileShaderPriv PrecompileShader::priv()
{
    return PrecompileShaderPriv(this);
}
