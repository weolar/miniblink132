...
class PaintParams {
public:
    explicit PaintParams(const SkPaint&, sk_sp<SkBlender> primitiveBlender, const CircularRRectClip& analyticClip, sk_sp<SkShader> clipShader,
...
private:
    ...
    void handlePrimitiveColor(const KeyContext&, PaintParamsKeyBuilder*, PipelineDataGatherer*) const;
...
void Blend(const KeyContext&, PaintParamsKeyBuilder*, PipelineDataGatherer*, AddToKeyFn addBlendToKey, AddToKeyFn addSrcToKey, AddToKeyFn addDstToKey);
void Compose(const KeyContext&, PaintParamsKeyBuilder*, PipelineDataGatherer*, AddToKeyFn addInnerToKey, AddToKeyFn addOuterToKey);
// Add a fixed blend mode node for a specific SkBlendMode.
void AddFixedBlendMode(const KeyContext&, PaintParamsKeyBuilder*, PipelineDataGatherer*, SkBlendMode);
