...
public:
    ...
    bool testingShouldDeleteASAP() const
    {
...
private:
    ...
    DeleteASAP shouldDeleteASAP() const
    {
        return fDeleteASAP;
    }
    ...
    void makeBudgeted()
    {
        fBudgeted = skgpu::Budgeted::kYes;
    }
    void makeUnbudgeted()
    {
        fBudgeted = skgpu::Budgeted::kNo;
    }
