...
public:
    ...
    {
        return SkImage_Base::Type::kGraphiteYUVA;
    }
    ...
    {
        return fMipmapped == Mipmapped::kYes;
    }

    bool onIsProtected() const override
    {
        return fProtected == Protected::kYes;
    }
...
private:
    ...
    Image_YUVA(const YUVAProxies&, const SkYUVAInfo&, sk_sp<SkColorSpace>);
