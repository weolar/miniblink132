...
public:
    ...
    bool addCommands(Context*, CommandBuffer*, Surface* targetSurface, SkIVector targetTranslation, SkIRect targetClip);
    ...
    TaskList* taskList()
    {
        return fRecording->fRootTaskList.get();
    }
...
private:
    explicit RecordingPriv(Recording* recorder)
        : fRecording(recorder)
    {
    }
