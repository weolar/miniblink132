...
Texture::Texture(const SharedContext* sharedContext, SkISize dimensions, const TextureInfo& info, sk_sp<MutableTextureState> mutableState, Ownership ownership,
...
void Texture::onDumpMemoryStatistics(SkTraceMemoryDump* traceMemoryDump, const char* dumpName) const
{
