...
public:
    ...
    static sk_sp<RenderPassTask> Make(DrawPassList, const RenderPassDesc&, sk_sp<TextureProxy> target, sk_sp<TextureProxy> dstCopy, SkIRect dstCopyBounds);
...
private:
    RenderPassTask(DrawPassList, const RenderPassDesc&, sk_sp<TextureProxy> target, sk_sp<TextureProxy> dstCopy, SkIRect dstCopyBounds);
