...
public:
    ...
    static_assert(0 == static_cast<int>(ShapeType::kRect), "Blur shader code depends on AnalyticBlurMask::ShapeType");
    static_assert(1 == static_cast<int>(ShapeType::kRRect), "Blur shader code depends on AnalyticBlurMask::ShapeType");
    static_assert(2 == static_cast<int>(ShapeType::kCircle), "Blur shader code depends on AnalyticBlurMask::ShapeType");
...
private:
    AnalyticBlurMask(
        const Rect& drawBounds, const SkM44& devToScaledShape, ShapeType shapeType, const Rect& shapeData, const SkV2& blurData, sk_sp<TextureProxy> proxy)
    ...
    static std::optional<AnalyticBlurMask> MakeRect(Recorder*, const SkMatrix& localToDevice, float devSigma, const SkRect& srcRect);

    static std::optional<AnalyticBlurMask> MakeCircle(Recorder*, const SkMatrix& localToDevice, float devSigma, const SkRect& srcRect, const SkRect& devRect);

    static std::optional<AnalyticBlurMask> MakeRRect(
