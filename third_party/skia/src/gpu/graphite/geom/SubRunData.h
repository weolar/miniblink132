...
public:
    ...
    SubRunData(const sktext::gpu::AtlasSubRun* subRun, sk_sp<SkRefCnt> supportDataKeepAlive, Rect deviceBounds, const SkM44& deviceToLocal, int startGlyphIndex,
        int glyphCount, SkColor luminanceColor, bool useGammaCorrectDistanceTable, SkPixelGeometry pixelGeometry, Recorder* recorder,
    ...
    {
        return fLuminanceColor;
    }
    bool useGammaCorrectDistanceTable() const
    {
        return fUseGammaCorrectDistanceTable;
    }
