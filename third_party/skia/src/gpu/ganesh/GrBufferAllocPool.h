...
public:
    ...
    {
        return this->GrBufferAllocPool::makeSpace(drawCount * sizeof(GrDrawIndirectCommand), 4, buffer, offset);
    }
    ...
    {
        return this->GrBufferAllocPool::makeSpace(drawCount * sizeof(GrDrawIndexedIndirectCommand), 4, buffer, offset);
    }
