...
#define GR_DRAW_OP_TEST_DEFINE(Op)                                                                                                                             \
    GrOp::Owner Op##__Test(GrPaint&& paint, SkRandom* random, GrRecordingContext* context, skgpu::ganesh::SurfaceDrawContext* sdc, int numSamples)
#define GR_DRAW_OP_TEST_FRIEND(Op) friend GrOp::OpOwner Op##__Test(GrPaint&&, SkRandom*, GrRecordingContext*, skgpu::ganesh::SurfaceDrawContext*, int)
