...
GrDeferredDisplayList::GrDeferredDisplayList(
    const GrSurfaceCharacterization& characterization, sk_sp<GrRenderTargetProxy> targetProxy, sk_sp<LazyProxyData> lazyProxyData)
...
GrDeferredDisplayList::ProgramIterator::ProgramIterator(GrDirectContext* dContext, GrDeferredDisplayList* ddl)
    : fDContext(dContext)
