...
private:
    ...
    // Deferred version
    GrTextureRenderTargetProxy(const GrCaps&, const GrBackendFormat&, SkISize, int sampleCnt, skgpu::Mipmapped, GrMipmapStatus, SkBackingFit, skgpu::Budgeted,
        GrProtected, GrInternalSurfaceFlags, UseAllocator, GrDDLProvider creatingProvider, std::string_view label);

    // Lazy-callback version
    GrTextureRenderTargetProxy(const GrCaps&, LazyInstantiateCallback&&, const GrBackendFormat&, SkISize, int sampleCnt, skgpu::Mipmapped, GrMipmapStatus,
        SkBackingFit, skgpu::Budgeted, GrProtected, GrInternalSurfaceFlags, UseAllocator, GrDDLProvider creatingProvider, std::string_view label);
