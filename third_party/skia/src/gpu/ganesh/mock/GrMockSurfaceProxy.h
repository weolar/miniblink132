...
public:
    GrMockSurfaceProxy(SkString name, std::string_view label)
        : GrSurfaceProxy(GrBackendFormat::MakeMock(GrColorType::kRGBA_8888, SkTextureCompressionType::kNone), SkISize::Make(1, 1), SkBackingFit::kExact,
            skgpu::Budgeted::kNo, skgpu::Protected::kNo, GrInternalSurfaceFlags::kNone, UseAllocator::kNo, label)
    {
