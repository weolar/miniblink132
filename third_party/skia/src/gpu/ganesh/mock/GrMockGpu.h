...
public:
    ...
    std::unique_ptr<GrSemaphore> wrapBackendSemaphore(
        const GrBackendSemaphore& /* semaphore */, GrSemaphoreWrapType /* wraptype */, GrWrapOwnership /* ownership */) override
    {
        return nullptr;
    }
...
private:
    ...
    {
        return GrBackendFormat::MakeMock(GrColorType::kUnknown, SkTextureCompressionType::kNone, true);
    }
