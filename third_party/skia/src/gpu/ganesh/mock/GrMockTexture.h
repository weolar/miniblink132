...
public:
    GrMockTexture(
        GrMockGpu* gpu, skgpu::Budgeted budgeted, SkISize dimensions, GrMipmapStatus mipmapStatus, const GrMockTextureInfo& info, std::string_view label)
        : GrMockTexture(gpu, dimensions, mipmapStatus, info, label)
    {
        this->registerWithCache(budgeted);
    }

    GrMockTexture(GrMockGpu* gpu, SkISize dimensions, GrMipmapStatus mipmapStatus, const GrMockTextureInfo& info, GrWrapCacheable cacheable, GrIOType ioType,
...
public:
    ...
    size_t onGpuMemorySize() const override
    {
        ...
        return GrSurface::ComputeSize(this->backendFormat(), this->dimensions(), numColorSamples, skgpu::Mipmapped::kNo);
    }
...
public:
    // Internally created.
    GrMockTextureRenderTarget(GrMockGpu* gpu, skgpu::Budgeted budgeted, SkISize dimensions, int sampleCnt, GrMipmapStatus mipmapStatus,
        const GrMockTextureInfo& texInfo, const GrMockRenderTargetInfo& rtInfo, std::string_view label)
    ...
    GrMockTextureRenderTarget(GrMockGpu* gpu, SkISize dimensions, int sampleCnt, GrMipmapStatus mipmapStatus, const GrMockTextureInfo& texInfo,
...
private:
    ...
    size_t onGpuMemorySize() const override
    {
        ...
        return GrSurface::ComputeSize(this->backendFormat(), this->dimensions(), numColorSamples, this->mipmapped());
    }
