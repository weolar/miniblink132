...
sk_sp<SkData> PackCachedShaders(
    SkFourByteTag shaderType, const std::string shaders[], const SkSL::Program::Interface interfaces[], int numInterfaces, const ShaderMetadata* meta)
{
    ...
    for (int i = 0; i < kGrShaderTypeCount; ++i) {
        ...
        writer.writePad32(&interfaces[std::min(i, numInterfaces - 1)], sizeof(SkSL::Program::Interface));
    }
