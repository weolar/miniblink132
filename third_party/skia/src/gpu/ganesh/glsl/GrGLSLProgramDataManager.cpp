...
void GrGLSLProgramDataManager::setRuntimeEffectUniforms(
    SkSpan<const SkRuntimeEffect::Uniform> uniforms, SkSpan<const UniformHandle> handles, SkSpan<const Specialized> specialized, const void* src) const
{
    ...
    for (size_t uniformIdx = 0; uniformIdx < uniforms.size(); ++uniformIdx) {
        ...
        switch (u.type) {
        case Type::kFloat:
            this->set1fv(h, u.count, floatData());
            break;
        case Type::kFloat2:
            this->set2fv(h, u.count, floatData());
            break;
        case Type::kFloat3:
            this->set3fv(h, u.count, floatData());
            break;
        case Type::kFloat4:
            this->set4fv(h, u.count, floatData());
            break;

        case Type::kFloat2x2:
            this->setMatrix2fv(h, u.count, floatData());
            break;
        case Type::kFloat3x3:
            this->setMatrix3fv(h, u.count, floatData());
            break;
        case Type::kFloat4x4:
            this->setMatrix4fv(h, u.count, floatData());
            break;

        case Type::kInt:
            this->set1iv(h, u.count, intData());
            break;
        case Type::kInt2:
            this->set2iv(h, u.count, intData());
            break;
        case Type::kInt3:
            this->set3iv(h, u.count, intData());
            break;
        case Type::kInt4:
            this->set4iv(h, u.count, intData());
            break;
