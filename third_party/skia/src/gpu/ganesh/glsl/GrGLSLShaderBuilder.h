...
public:
    ...
    void appendTextureLookupAndBlend(
        const char* dst, SkBlendMode, SamplerHandle, const char* coordName, GrGLSLColorSpaceXformHelper* colorXformHelper = nullptr);
    ...
    */
    ...
    void defineConstantf(const char* type, const char* name, const char* fmt, ...) SK_PRINTF_LIKE(4, 5)
    {
