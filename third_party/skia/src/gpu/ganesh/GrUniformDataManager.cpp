...
int GrUniformDataManager::copyUniforms(void* dest, const void* src, int numUniforms, SkSLType uniformType) const
{
...
template <int N, SkSLType FullType, SkSLType HalfType> void GrUniformDataManager::set(UniformHandle u, const void* v) const
{
...
template <int N, SkSLType FullType, SkSLType HalfType> void GrUniformDataManager::setv(UniformHandle u, int arrayCount, const void* v) const
{
    const Uniform& uni = fUniforms[u.toIndex()];
    SkASSERT(uni.fType == FullType || uni.fType == HalfType);
...
void GrUniformDataManager::set4i(UniformHandle u, int32_t i0, int32_t i1, int32_t i2, int32_t i3) const
{
...
inline void GrUniformDataManager::setMatrices(UniformHandle u, int arrayCount, const float matrices[]) const
{
    const Uniform& uni = fUniforms[u.toIndex()];
    SkASSERT(uni.fType == FullType || uni.fType == HalfType);
    SkASSERT(arrayCount > 0);
