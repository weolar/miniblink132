...
public:
    ...
    void addDrawOp(GrDrawingManager*, GrOp::Owner, bool usesMSAA, const GrProcessorSet::Analysis&, GrAppliedClip&&, const GrDstProxyView&,
    ...
    void dump(const SkString& label, SkString indent, bool printDependencies, bool close) const override;
    ...
    {
        return fOpChains.size();
    }
    const GrOp* getChain(int index) const
    {
...
private:
    ...
    // resolve its texture.
    void setCannotMergeBackward()
    {
        fCannotMergeBackward = true;
    }
    ...
    public:
        ...
        GrOp::Owner appendOp(
            GrOp::Owner op, GrProcessorSet::Analysis, const GrDstProxyView*, const GrAppliedClip*, const GrCaps&, SkArenaAlloc* opsTaskArena, GrAuditTrail*);
    ...
    private:
        ...
        bool tryConcat(List*, GrProcessorSet::Analysis, const GrDstProxyView&, const GrAppliedClip*, const SkRect& bounds, const GrCaps&,
            SkArenaAlloc* opsTaskArena, GrAuditTrail*);
