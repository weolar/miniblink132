...
public:
    ...
    GrFPResult makeAtlasClipEffect(const skgpu::ganesh::SurfaceDrawContext*, const GrOp* opBeingClipped, std::unique_ptr<GrFragmentProcessor> inputFP,
...
private:
    ...
    bool addPathToAtlas(GrRecordingContext*, const SkMatrix&, const SkPath&, const SkRect& pathDevBounds, SkIRect* devIBounds, SkIPoint16* locationInAtlas,
        bool* transposedInAtlas, const DrawRefsAtlasCallback&);
