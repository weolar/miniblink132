...
public:
    ...
    {
        return fAtlasProxy.get();
    }
    const skgpu::Swizzle& atlasSwizzle() const
    {
        return fAtlasSwizzle;
    }
    ...
    void injectShaderCode(
        const GrGeometryProcessor::ProgramImpl::EmitArgs&, const GrShaderVar& devCoord, GrGLSLUniformHandler::UniformHandle* atlasAdjustUniformHandle) const;
