...
GrOp::Owner Make(GrRecordingContext*, GrPaint&&, GrAAType, const SkMatrix& viewMatrix, const SkRect&, const SkStrokeRec&);
...
GrOp::Owner MakeNested(GrRecordingContext*, GrPaint&&, const SkMatrix& viewMatrix, const SkRect rects[2]);
