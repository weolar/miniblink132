...
public:
    ...
    static void AddFillRectOps(SurfaceDrawContext*, const GrClip*, GrRecordingContext*, GrPaint&&, GrAAType, const SkMatrix& viewMatrix,
        const GrQuadSetEntry quads[], int quadCount, const GrUserStencilSettings* = nullptr);
...
private:
    ...
    static GrOp::Owner MakeOp(GrRecordingContext*, GrPaint&&, GrAAType, const SkMatrix& viewMatrix, const GrQuadSetEntry quads[], int quadCount,
