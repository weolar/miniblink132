...
GrRenderTarget::GrRenderTarget(
    GrGpu* gpu, const SkISize& dimensions, int sampleCount, GrProtected isProtected, std::string_view label, sk_sp<GrAttachment> stencil)
...
{
    auto stencilAttachment = (useMSAASurface) ? &GrRenderTarget::fMSAAStencilAttachment : &GrRenderTarget::fStencilAttachment;
