...
public:
    ...
    void prepareWithTriangles(GrMeshDrawTarget* target, const SkMatrix& shaderMatrix, GrInnerFanTriangulator::BreadcrumbTriangleList* extraTriangles,
    ...
    {
        this->prepareWithTriangles(target, shaderMatrix,
