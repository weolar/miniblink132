...
enum class GrStencilTest : uint16_t { kAlways, kNever, kGreater, kGEqual, kLess, kLEqual, kEqual, kNotEqual };
...
private:
    ...
    inline static constexpr GrStencilFlags kInvalid_PrivateFlag = static_cast<GrStencilFlags>(kLast_StencilFlag << 1);
