...
template <typename W> static W make_writer(void* p, int count, size_t elementSize)
{
...
skgpu::VertexWriter GrMeshDrawTarget::makeVertexWriter(size_t vertexSize, int vertexCount, sk_sp<const GrBuffer>* buffer, int* startVertex)
{
...
skgpu::IndexWriter GrMeshDrawTarget::makeIndexWriter(int indexCount, sk_sp<const GrBuffer>* buffer, int* startIndex)
{
...
{
    void* p = this->makeVertexSpaceAtLeast(vertexSize, minVertexCount, fallbackVertexCount, buffer, startVertex, actualVertexCount);
...
{
    void* p = this->makeIndexSpaceAtLeast(minIndexCount, fallbackIndexCount, buffer, startIndex, actualIndexCount);
