...
public:
    ...
    {
        return fColorAttachment->mtlTexture();
    }
    ...
    {
        return fResolveAttachment->mtlTexture();
    }
...
private:
    ...
    GrMtlRenderTarget(
        GrMtlGpu* gpu, SkISize, sk_sp<GrMtlAttachment> colorAttachment, sk_sp<GrMtlAttachment> resolveAttachment, Wrapped, std::string_view label);
