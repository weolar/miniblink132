...
public:
    ...
    bool isCompleted()
    {
        return fCmdBuffer.status == MTLCommandBufferStatusCompleted || fCmdBuffer.status == MTLCommandBufferStatusError;
    }
...
private:
    ...
    skia_private::STArray<kInitialTrackedResourcesCount, sk_sp<const GrManagedResource>> fTrackedResources;
