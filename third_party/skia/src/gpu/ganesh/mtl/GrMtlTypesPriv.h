...
#define GR_NORETAIN_BEGIN _Pragma("clang attribute push (__attribute__((objc_externally_retained)), apply_to=any(function,objc_method))")
...
GrMtlSurfaceInfo GrMtlTextureSpecToSurfaceInfo(const GrMtlTextureSpec& mtlSpec, uint32_t sampleCount, uint32_t levelCount, skgpu::Protected isProtected);
