...
public:
    ...
    void copySurfaceAsBlit(
        GrSurface* dst, GrSurface* src, GrMtlAttachment* dstAttachment, GrMtlAttachment* srcAttachment, const SkIRect& srcRect, const SkIPoint& dstPoint);
...
private:
    ...
    bool onWritePixels(GrSurface*, SkIRect, GrColorType surfaceColorType, GrColorType bufferColorType, const GrMipLevel[], int mipLevelCount,
    ...
    bool uploadToTexture(GrMtlTexture* tex, SkIRect rect, GrColorType dataColorType, const GrMipLevel texels[], int mipLevels);
    ...
    bool readOrTransferPixels(
        GrSurface* surface, SkIRect rect, GrColorType dstColorType, id<MTLBuffer> transferBuffer, size_t offset, size_t imageBytes, size_t rowBytes);
    ...
    bool createMtlTextureForBackendSurface(MTLPixelFormat, SkISize dimensions, int sampleCnt, GrTexturable, GrRenderable, skgpu::Mipmapped, GrMtlTextureInfo*);
