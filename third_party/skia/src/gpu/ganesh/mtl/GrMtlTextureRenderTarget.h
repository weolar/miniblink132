...
public:
    static sk_sp<GrMtlTextureRenderTarget> MakeNewTextureRenderTarget(
        GrMtlGpu*, skgpu::Budgeted, SkISize, int sampleCnt, MTLPixelFormat, uint32_t mipLevels, GrMipmapStatus, std::string_view label);
...
private:
    GrMtlTextureRenderTarget(GrMtlGpu* gpu, skgpu::Budgeted budgeted, SkISize, sk_sp<GrMtlAttachment> texture, sk_sp<GrMtlAttachment> colorAttachment,
        sk_sp<GrMtlAttachment> resolveAttachment, GrMipmapStatus, std::string_view label);

    GrMtlTextureRenderTarget(GrMtlGpu* gpu, SkISize, sk_sp<GrMtlAttachment> texture, sk_sp<GrMtlAttachment> colorAttachment,
        sk_sp<GrMtlAttachment> resolveAttachment, GrMipmapStatus, GrWrapCacheable cacheable, std::string_view label);
