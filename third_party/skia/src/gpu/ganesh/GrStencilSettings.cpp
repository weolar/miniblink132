...
constexpr const GrUserStencilSettings gUnused(
    GrUserStencilSettings::StaticInit<0x0000, GrUserStencilTest::kAlwaysIfInClip, 0xffff, GrUserStencilOp::kKeep, GrUserStencilOp::kKeep, 0x0000>());
...
void GrStencilSettings::reset(const GrUserStencilSettings& user, bool hasStencilClip, int numStencilBits)
{
...
void GrStencilSettings::reset(const GrStencilSettings& that)
{
    ...
    if (!this->isTwoSided()) {
        ...
        static_assert(sizeof(Face) == offsetof(GrStencilSettings, fCCWFace) - offsetof(GrStencilSettings, fCWFace));
    }
}
...
static constexpr GrStencilTest gUserStencilTestToRaw[kGrUserStencilTestCount] = {
    ...
    GrStencilTest::kAlways, GrStencilTest::kNever, GrStencilTest::kGreater, GrStencilTest::kGEqual, GrStencilTest::kLess, GrStencilTest::kLEqual,
    GrStencilTest::kEqual, GrStencilTest::kNotEqual
};
...
static constexpr GrStencilOp gUserStencilOpToRaw[kGrUserStencilOpCount] = {
    ...
    GrStencilOp::kZero, GrStencilOp::kReplace, GrStencilOp::kInvert, GrStencilOp::kIncWrap, GrStencilOp::kDecWrap,
...
void GrStencilSettings::Face::reset(const GrUserStencilSettings::Face& user, bool hasStencilClip, int numStencilBits)
{
    ...
    SkDEBUGCODE(GrUserStencilOp otherOp = std::min(user.fPassOp, user.fFailOp);) if (maxOp <= kLastUserOnlyStencilOp)
    {
        // Ops that only modify user bits.
...
static constexpr GrUserStencilSettings gZeroStencilClipBit(
    GrUserStencilSettings::StaticInit<0x0000, GrUserStencilTest::kAlways, 0xffff, GrUserStencilOp::kZeroClipBit, GrUserStencilOp::kZeroClipBit, 0x0000>());
