...
public:
    ...
    public:
        ...
        {
            return fGPUType != SkSLType::kVoid;
        }
    ...
    {
        return fVertexAttributes.count();
    }
    ...
    {
        return fInstanceAttributes.count();
    }
    ...
    {
        return SkToBool(fVertexAttributes.count());
    }
    bool hasInstanceAttributes() const
    {
        return SkToBool(fInstanceAttributes.count());
    }
    ...
    {
        return fVertexAttributes.stride();
    }
    size_t instanceStride() const
    {
        return fInstanceAttributes.stride();
    }
...
protected:
    ...
    {
        return { name, wideColor ? kFloat4_GrVertexAttribType : kUByte4_norm_GrVertexAttribType, SkSLType::kHalf4 };
    }
...
public:
    ...
    struct EmitArgs {
        EmitArgs(GrGLSLVertexBuilder* vertBuilder, GrGLSLFPFragmentBuilder* fragBuilder, GrGLSLVaryingHandler* varyingHandler,
            GrGLSLUniformHandler* uniformHandler, const GrShaderCaps* caps, const GrGeometryProcessor& geomProc, const char* outputColor,
    ...
    {
        return (ComputeMatrixKey(shaderCaps, viewMatrix) << kMatrixKeyBits) | ComputeMatrixKey(shaderCaps, localMatrix);
    }
...
protected:
    ...
    static void SetTransform(
        const GrGLSLProgramDataManager&, const GrShaderCaps&, const UniformHandle& uniform, const SkMatrix& matrix, SkMatrix* state = nullptr);
    ...
    static void WriteOutputPosition(GrGLSLVertexBuilder*, GrGLSLUniformHandler*, const GrShaderCaps&, GrGPArgs*, const char* posName,
    ...
    static void WriteLocalCoord(GrGLSLVertexBuilder*, GrGLSLUniformHandler*, const GrShaderCaps&, GrGPArgs*, GrShaderVar localVar, const SkMatrix& localMatrix,
...
private:
    ...
    // GpArgs::fPositionVar.
    FPCoordsMap collectTransforms(GrGLSLVertexBuilder* vb, GrGLSLVaryingHandler* varyingHandler, GrGLSLUniformHandler* uniformHandler,
...
public:
    ...
    {
        return fBackendFormat.textureType();
    }
