...
private:
    GrD3DPipelineStateBuilder(GrD3DGpu*, GrD3DRenderTarget*, const GrProgramDesc&, const GrProgramInfo&);
...
inline bool SkSLToHLSL(const SkSL::ShaderCaps* caps, const std::string& sksl, SkSL::ProgramKind programKind, const SkSL::ProgramSettings& settings,
    std::string* hlsl, SkSL::ProgramInterface* outInterface, ShaderErrorHandler* errorHandler)
{
    return SkSLToBackend(caps, &SkSL::ToHLSL, "HLSL", sksl, programKind, settings, hlsl, outInterface, errorHandler);
}
