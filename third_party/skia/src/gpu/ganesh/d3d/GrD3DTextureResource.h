...
public:
    ...
    {
        return fInfo.fSampleQualityPattern;
    }
    ...
    static bool InitTextureResourceInfo(
        GrD3DGpu* gpu, const D3D12_RESOURCE_DESC& desc, D3D12_RESOURCE_STATES initialState, GrProtected, D3D12_CLEAR_VALUE*, GrD3DTextureResourceInfo*);
