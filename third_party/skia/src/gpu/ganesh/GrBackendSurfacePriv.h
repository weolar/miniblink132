...
public:
    template <typename FormatData> static GrBackendFormat MakeGrBackendFormat(GrTextureType textureType, GrBackendApi api, const FormatData& data)
    {
    ...
    static GrBackendTexture MakeGrBackendTexture(
        int width, int height, std::string_view label, skgpu::Mipmapped mipped, GrBackendApi backend, GrTextureType texture, const TextureData& data)
    {
    ...
    static GrBackendRenderTarget MakeGrBackendRenderTarget(
        int width, int height, int sampleCnt, int stencilBits, GrBackendApi backend, bool framebufferOnly, const RenderTargetData& data)
    {
        return GrBackendRenderTarget(width, height, sampleCnt, stencilBits, backend, framebufferOnly, data);
    }
