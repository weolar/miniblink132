...
public:
    ...
    GrProcessorTestData(SkRandom* random, GrRecordingContext* context, int maxTreeDepth, int numViews, const ViewInfo views[]);
    GrProcessorTestData(
...
#define GR_DEFINE_FRAGMENT_PROCESSOR_TEST(Effect)                                                                                                              \
    GrFragmentProcessorTestFactory* Effect::gTestFactory = new GrFragmentProcessorTestFactory(Effect::TestCreate, #Effect);

#define GR_DEFINE_GEOMETRY_PROCESSOR_TEST(Effect)                                                                                                              \
    GrGeometryProcessorTestFactory* Effect::gTestFactory = new GrGeometryProcessorTestFactory(Effect::TestCreate, #Effect);

#define GR_DEFINE_XP_FACTORY_TEST(Factory) GrXPFactoryTestFactory* Factory::gTestFactory = new GrXPFactoryTestFactory(Factory::TestGet);
...
// The unit test relies on static initializers. Just declare the TestCreate function so that
// its definitions will compile.
#define GR_DECLARE_GEOMETRY_PROCESSOR_TEST static GrGeometryProcessor* TestCreate(GrProcessorTestData*);
