...
GrGLCaps::GrGLCaps(const GrContextOptions& contextOptions, const GrGLContextInfo& ctxInfo, const GrGLInterface* glInterface)
...
void GrGLCaps::init(const GrContextOptions& contextOptions, const GrGLContextInfo& ctxInfo, const GrGLInterface* gli)
{
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        fWritePixelsRowBytesSupport = version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_EXT_unpack_subimage");
        fReadPixelsRowBytesSupport = version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_NV_pack_subimage");
    ...
    if (((GR_IS_GR_GL(standard) && version >= GR_GL_VER(4, 3)) || (GR_IS_GR_GL_ES(standard) && version >= GR_GL_VER(3, 0))
    ...
    if (ctxInfo.vendor() == GrGLVendor::kARM || ctxInfo.vendor() == GrGLVendor::kImagination || ctxInfo.vendor() == GrGLVendor::kQualcomm) {
        fPreferFullscreenClears = true;
    }

    if (GR_IS_GR_GL(standard)) {
        fVertexArrayObjectSupport
            = version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_ARB_vertex_array_object") || ctxInfo.hasExtension("GL_APPLE_vertex_array_object");
    } else if (GR_IS_GR_GL_ES(standard)) {
        fVertexArrayObjectSupport = version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_OES_vertex_array_object");
    } else if (GR_IS_GR_WEBGL(standard)) {
        fVertexArrayObjectSupport
            = version >= GR_GL_VER(2, 0) || ctxInfo.hasExtension("GL_OES_vertex_array_object") || ctxInfo.hasExtension("OES_vertex_array_object");
    }
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        fDrawInstancedSupport = version >= GR_GL_VER(3, 0) || (ctxInfo.hasExtension("GL_EXT_draw_instanced") && ctxInfo.hasExtension("GL_EXT_instanced_arrays"))
    ...
    if (GR_IS_GR_GL(standard)) {
        if (version >= GR_GL_VER(3, 1) || ctxInfo.hasExtension("GL_ARB_texture_rectangle") || ctxInfo.hasExtension("GL_ANGLE_texture_rectangle")) {
            fRectangleTextureSupport = true;
        }
    } else if (GR_IS_GR_GL_ES(standard)) {
        fRectangleTextureSupport = ctxInfo.hasExtension("GL_ARB_texture_rectangle") || ctxInfo.hasExtension("GL_ANGLE_texture_rectangle");
    } else if (GR_IS_GR_WEBGL(standard)) {
        fRectangleTextureSupport = false;
    }
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        if (version < GR_GL_VER(3, 2) && !ctxInfo.hasExtension("GL_EXT_texture_border_clamp") && !ctxInfo.hasExtension("GL_NV_texture_border_clamp")
    ...
    if ((GR_IS_GR_GL_ES(standard) || GR_IS_GR_GL(standard)) && ctxInfo.hasExtension("GL_ARB_invalidate_subdata")) {
    ...
    if (GR_IS_GR_GL(standard)) {
        fClearTextureSupport = (version >= GR_GL_VER(4, 4) || ctxInfo.hasExtension("GL_ARB_clear_texture"));
    } else if (GR_IS_GR_GL_ES(standard)) {
     ...
     */
    fStrictProtectedness = fSupportsProtectedContent && ctxInfo.angleBackend() != GrGLANGLEBackend::kUnknown;
    ...
    **************************************************************************/
    ...
    if (GR_IS_GR_GL(standard)) {
        shaderCaps->fDualSourceBlendingSupport
            = (version >= GR_GL_VER(3, 3) || ctxInfo.hasExtension("GL_ARB_blend_func_extended")) && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;

        shaderCaps->fShaderDerivativeSupport = true;
        shaderCaps->fExplicitTextureLodSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;

        shaderCaps->fIntegerSupport = version >= GR_GL_VER(3, 0) && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;
        ...
        shaderCaps->fExplicitTextureLodSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;

        shaderCaps->fIntegerSupport = version >= GR_GL_VER(3, 0) && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;
        shaderCaps->fNonsquareMatrixSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;
        shaderCaps->fInverseHyperbolicSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;
    } else if (GR_IS_GR_WEBGL(standard)) {
        shaderCaps->fShaderDerivativeSupport
            = version >= GR_GL_VER(2, 0) || ctxInfo.hasExtension("GL_OES_standard_derivatives") || ctxInfo.hasExtension("OES_standard_derivatives");
        shaderCaps->fExplicitTextureLodSupport = version >= GR_GL_VER(2, 0) && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;
    ...
    if (GR_IS_GR_GL(standard)) {
        shaderCaps->fRewriteSwitchStatements = ctxInfo.glslGeneration() < SkSL::GLSLGeneration::k130; // introduced in GLSL 1.3
    } else if (GR_IS_GR_GL_ES(standard)) {
        shaderCaps->fRewriteSwitchStatements = ctxInfo.glslGeneration() < SkSL::GLSLGeneration::k300es; // introduced in GLSL ES3
    } else if (GR_IS_GR_WEBGL(standard)) {
        shaderCaps->fRewriteSwitchStatements = version < GR_GL_VER(2, 0); // introduced in WebGL 2
        shaderCaps->fCanUseVoidInSequenceExpressions = false; // removed in WebGL 2, use workaround in all versions for safety
    }
    ...
    if (GR_IS_GR_GL(standard) || GR_IS_GR_GL_ES(standard)) {
        ...
        if (clientArraysEnabled && !ctxInfo.isOverCommandBuffer() && !fIsCoreProfile
            && (ctxInfo.vendor() == GrGLVendor::kARM || ctxInfo.vendor() == GrGLVendor::kImagination || ctxInfo.vendor() == GrGLVendor::kQualcomm)) {
    ...
    if (GR_IS_GR_GL(standard)) {
        if (version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_ARB_framebuffer_object") || ctxInfo.hasExtension("GL_EXT_framebuffer_blit")) {
            fBlitFramebufferFlags = 0;
        }
    } else if (GR_IS_GR_GL_ES(standard)) {
        if (version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_NV_framebuffer_blit")) {
            fBlitFramebufferFlags
                = kNoFormatConversionForMSAASrc_BlitFramebufferFlag | kNoMSAADst_BlitFramebufferFlag | kRectsMustMatchForMSAASrc_BlitFramebufferFlag;
        } else if (ctxInfo.hasExtension("GL_CHROMIUM_framebuffer_multisample") || ctxInfo.hasExtension("GL_ANGLE_framebuffer_blit")) {
            // The CHROMIUM extension uses the ANGLE version of glBlitFramebuffer and includes its
            // limitations.
            fBlitFramebufferFlags = kNoScalingOrMirroring_BlitFramebufferFlag | kResolveMustBeFull_BlitFrambufferFlag | kNoMSAADst_BlitFramebufferFlag
                | kNoFormatConversion_BlitFramebufferFlag | kRectsMustMatchForMSAASrc_BlitFramebufferFlag;
        }
    ...
    if (GR_IS_GR_GL(standard)) {
        if (version >= GR_GL_VER(2, 1) || ctxInfo.hasExtension("GL_ARB_pixel_buffer_object") || ctxInfo.hasExtension("GL_EXT_pixel_buffer_object")) {
    ...
    if (GR_IS_GR_GL(standard) && (version >= GR_GL_VER(3, 1) || ctxInfo.hasExtension("GL_ARB_copy_buffer"))) {
        fTransferFromBufferToBufferSupport = true;
    } else if (GR_IS_GR_GL_ES(standard) && (version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_NV_copy_buffer"))) {
        fTransferFromBufferToBufferSupport = true;
    }
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        fMipmapSupport = true;
        fAnisoSupport = version >= GR_GL_VER(4, 6) || ctxInfo.hasExtension("GL_ARB_texture_filter_anisotropic")
            || ctxInfo.hasExtension("GL_EXT_texture_filter_anisotropic");
    } else if (GR_IS_GR_GL_ES(standard)) {
        // Unextended ES2 supports NPOT textures with clamp_to_edge and non-mip filters only
        // ES3 has no limitations.
        fNPOTTextureTileSupport = version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_OES_texture_npot");
        ...
        fAnisoSupport = ctxInfo.hasExtension("GL_EXT_texture_filter_anisotropic") || ctxInfo.hasExtension("EXT_texture_filter_anisotropic");
    }
    if (fAnisoSupport) {
    ...
    if (GR_IS_GR_GL(standard)) {
        fBaseVertexBaseInstanceSupport = version >= GR_GL_VER(4, 2) || ctxInfo.hasExtension("GL_ARB_base_instance");
        if (fBaseVertexBaseInstanceSupport) {
            fNativeDrawIndirectSupport = version >= GR_GL_VER(4, 0) || ctxInfo.hasExtension("GL_ARB_draw_indirect");
        ...
        fBaseVertexBaseInstanceSupport = ctxInfo.hasExtension("WEBGL_draw_instanced_base_vertex_base_instance");
        if (fBaseVertexBaseInstanceSupport && ctxInfo.hasExtension("GL_WEBGL_multi_draw_instanced_base_vertex_base_instance")) {
            fNativeDrawIndirectSupport = true;
            fMultiDrawType = MultiDrawType::kANGLEOrWebGL;
        }
    ...
    } else if (GR_IS_GR_GL(standard) && (version >= GR_GL_VER(3, 2) || ctxInfo.hasExtension("GL_ARB_sync"))) {
        fSemaphoreSupport = fFenceSyncSupport = true;
        fFenceType = FenceType::kSyncObject;
    } else if (GR_IS_GR_GL_ES(standard) && (version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_APPLE_sync"))) {
        fSemaphoreSupport = fFenceSyncSupport = true;
        fFenceType = FenceType::kSyncObject;
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        fProgramBinarySupport = (version >= GR_GL_VER(3, 0)) || ctxInfo.hasExtension("GL_OES_get_program_binary");
    ...
    if (fProgramBinarySupport) {
        ...
        if (count > 0) {
            ...
            GR_GL_GetIntegerv(gli, GR_GL_PROGRAM_BINARY_FORMATS, reinterpret_cast<GrGLint*>(fProgramBinaryFormats.data()));
        } else {
            fProgramBinarySupport = false;
        }
    }
    if (GR_IS_GR_GL(standard)) {
        fSamplerObjectSupport = version >= GR_GL_VER(3, 3) || ctxInfo.hasExtension("GL_ARB_sampler_objects");
    } else if (GR_IS_GR_GL_ES(standard)) {
    ...
    if (!contextOptions.fDisableDriverCorrectnessWorkarounds) {
        this->applyDriverCorrectnessWorkarounds(ctxInfo, contextOptions, gli, shaderCaps, &formatWorkarounds);
    }
...
{
    if (GR_IS_GR_GL(ctxInfo.standard()) && ctxInfo.version() < GR_GL_VER(4, 1) && !ctxInfo.hasExtension("GL_ARB_ES2_compatibility")) {
...
void GrGLCaps::initGLSL(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli)
{
    ...
    **************************************************************************/
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        shaderCaps->fFlatInterpolationSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es;
    } // not sure for WebGL
    ...
    shaderCaps->fPreferFlatInterpolation = !GR_IS_GR_WEBGL(standard) && shaderCaps->fFlatInterpolationSupport && ctxInfo.vendor() != GrGLVendor::kQualcomm
        && !angle_backend_is_d3d(ctxInfo.angleBackend()) && !angle_backend_is_metal(ctxInfo.angleBackend());
    if (GR_IS_GR_GL(standard)) {
        shaderCaps->fNoPerspectiveInterpolationSupport = ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k130;
    } else if (GR_IS_GR_GL_ES(standard)) {
        if (ctxInfo.hasExtension("GL_NV_shader_noperspective_interpolation") && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es) {
            shaderCaps->fNoPerspectiveInterpolationSupport = true;
            shaderCaps->fNoPerspectiveInterpolationExtensionString = "GL_NV_shader_noperspective_interpolation";
        }
    } // Not sure for WebGL
    ...
    shaderCaps->fVersionDeclString = get_glsl_version_decl_string(standard, shaderCaps->fGLSLGeneration, fIsCoreProfile);
    ...
    if (ctxInfo.angleBackend() == GrGLANGLEBackend::kMetal && ctxInfo.angleVendor() == GrGLVendor::kIntel) {
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        shaderCaps->fNonconstantArrayIndexSupport = (ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k300es);
    }
...
void GrGLCaps::initFSAASupport(const GrContextOptions& contextOptions, const GrGLContextInfo& ctxInfo, const GrGLInterface* gli)
{
...
void GrGLCaps::initBlendEqationSupport(const GrGLContextInfo& ctxInfo)
{
    ...
    } else if (ctxInfo.hasExtension("GL_KHR_blend_equation_advanced_coherent") && layoutQualifierSupport) {
        fBlendEquationSupport = kAdvancedCoherent_BlendEquationSupport;
...
void GrGLCaps::initStencilSupport(const GrGLContextInfo& ctxInfo)
{
    ...
    if (GR_IS_GR_GL(ctxInfo.standard())) {
        bool supportsPackedDS
            = ctxInfo.version() >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_EXT_packed_depth_stencil") || ctxInfo.hasExtension("GL_ARB_framebuffer_object");
...
static const char* multi_draw_type_name(GrGLCaps::MultiDrawType multiDrawType)
{
    ...
    case GrGLCaps::MultiDrawType::kNone:
        return "kNone";
    case GrGLCaps::MultiDrawType::kMultiDrawIndirect:
        return "kMultiDrawIndirect";
    case GrGLCaps::MultiDrawType::kANGLEOrWebGL:
        return "kMultiDrawIndirect";
    }
    SkUNREACHABLE;
}
...
void GrGLCaps::onDumpJSON(SkJSONWriter* writer) const
{
    ...
    auto msfboStr = [&] {
        ...
        case kES_IMG_MsToTexture_MSFBOType:
            return "IMG MS To Texture";
        case kES_EXT_MsToTexture_MSFBOType:
            return "EXT MS To Texture";
        }
        SkUNREACHABLE;
    };
    ...
    auto invalidateFBTypeStr = [&] {
        ...
        case kNone_InvalidateFBType:
            return "None";
        case kDiscard_InvalidateFBType:
            return "Discard";
        case kInvalidate_InvalidateFBType:
            return "Invalidate";
        }
        SkUNREACHABLE;
    };
    ...
    auto invalidateBufferTypeStr = [&] {
        ...
        case InvalidateBufferType::kNone:
            return "None";
        case InvalidateBufferType::kNullData:
            return "Null data hint";
        case InvalidateBufferType::kInvalidate:
            return "Invalidate";
        }
        SkUNREACHABLE;
    };
    ...
    auto mapBufferTypeStr = [&] {
        ...
        case kNone_MapBufferType:
            return "None";
        case kMapBuffer_MapBufferType:
            return "MapBuffer";
        case kMapBufferRange_MapBufferType:
            return "MapBufferRange";
        case kChromium_MapBufferType:
            return "Chromium";
        }
        SkUNREACHABLE;
    };
    ...
    writer->appendBool(
        "Intermediate texture for partial updates of unorm textures ever bound to FBOs", fDisallowTexSubImageForUnormConfigTexturesEverBoundToFBO);
    writer->appendBool("Intermediate texture for all updates of textures bound to FBOs", fUseDrawInsteadOfAllRenderTargetWrites);
    writer->appendBool("Max instances per draw without crashing (or zero)", fMaxInstancesPerDrawWithoutCrashing);
...
void GrGLCaps::getTexImageExternalFormatAndType(GrGLFormat surfaceFormat, GrGLenum* externalFormat, GrGLenum* externalType) const
{
...
void GrGLCaps::getTexSubImageDefaultFormatTypeAndColorType(GrGLFormat format, GrGLenum* externalFormat, GrGLenum* externalType, GrColorType* colorType) const
{
...
void GrGLCaps::getTexSubImageExternalFormatAndType(
    GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType, GrGLenum* externalFormat, GrGLenum* externalType) const
{
    this->getExternalFormat(surfaceFormat, surfaceColorType, memoryColorType, kTexImage_ExternalFormatUsage, externalFormat, externalType);
}

void GrGLCaps::getReadPixelsFormat(
    GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType, GrGLenum* externalFormat, GrGLenum* externalType) const
{
    this->getExternalFormat(surfaceFormat, surfaceColorType, memoryColorType, kReadPixels_ExternalFormatUsage, externalFormat, externalType);
}

void GrGLCaps::getExternalFormat(GrGLFormat surfaceFormat, GrColorType surfaceColorType, GrColorType memoryColorType, ExternalFormatUsage usage,
    GrGLenum* externalFormat, GrGLenum* externalType) const
{
    SkASSERT(externalFormat && externalType);
    *externalFormat = this->getFormatInfo(surfaceFormat).externalFormat(surfaceColorType, memoryColorType, usage);
    *externalType = this->getFormatInfo(surfaceFormat).externalType(surfaceColorType, memoryColorType);
}
...
void GrGLCaps::setStencilFormatIndexForFormat(GrGLFormat format, int index)
{
    ...
    this->getFormatInfo(format).fStencilFormatIndex = index < 0 ? FormatInfo::kUnsupported_StencilFormatIndex : index;
}
...
void GrGLCaps::initFormatTable(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli, const FormatWorkarounds& formatWorkarounds)
{
    GrGLStandard standard = ctxInfo.standard();
    // standard can be unused (optimized away) if SK_ASSUME_GL_ES is set
    sk_ignore_unused_variable(standard);
    ...
    if (GR_IS_GR_GL(standard)) {
        ...
        texStorageSupported = version >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_EXT_texture_storage");
    } else if (GR_IS_GR_WEBGL(standard)) {
    ...
    bool texImageSupportsSizedInternalFormat = (GR_IS_GR_GL(standard) || (GR_IS_GR_GL_ES(standard) && version >= GR_GL_VER(3, 0)));
    ...
    if ((GR_IS_GR_GL_ES(standard) && version < GR_GL_VER(3, 0)) || (GR_IS_GR_WEBGL(standard) && version < GR_GL_VER(2, 0))) {
    ...
    // Format: RGBA8
    {
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RGBA8 : GR_GL_RGBA;
        }

        bool supportsBGRAColorType = GR_IS_GR_GL(standard) && (version >= GR_GL_VER(1, 2) || ctxInfo.hasExtension("GL_EXT_bgra"));
        ...
        // Format: RGBA8, Surface: kRGBA_8888
        {
            ...
            ctInfo.fExternalIOFormats = std::make_unique<ColorTypeInfo::ExternalIOFormats[]>(ctInfo.fExternalIOFormatCount);
            int ioIdx = 0;
    ...
    // Format: R8
    {
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_R8 : GR_GL_RED;
        }
    ...
    // Format: ALPHA8
    {
        bool alpha8IsValidForGL = GR_IS_GR_GL(standard) && (!fIsCoreProfile || version <= GR_GL_VER(3, 0));
        ...
        bool alpha8SizedEnumSupported = alpha8IsValidForGL || (alpha8IsValidForGLES && ctxInfo.hasExtension("GL_EXT_texture_storage"));
        ...
        if (alpha8IsValidForGL) {
            ...
            alpha8IsRenderable = ctxInfo.version() >= GR_GL_VER(3, 0) || ctxInfo.hasExtension("GL_ARB_framebuffer_object");
        }
        ...
        if (alpha8TexStorageSupported) {
            ...
            // for glTexImage2D.
            if (!GR_IS_GR_GL_ES(standard) && texImageSupportsSizedInternalFormat && alpha8SizedEnumSupported) {
                info.fInternalFormatForTexImageOrStorage = GR_GL_ALPHA8;
            } else {
    ...
    if (GR_IS_GR_GL(standard) && !fIsCoreProfile) {
        ...
        lum8SizedFormatSupported = texStorageSupported && ctxInfo.hasExtension("GL_EXT_texture_storage");
    } else if (GR_IS_GR_WEBGL(standard)) {
        lum8Supported = true;
    }
    ...
    // Format: BGRA8
    {
        ...
        if (GR_IS_GR_GL_ES(standard)) {
            if (ctxInfo.hasExtension("GL_EXT_texture_format_BGRA8888")) {
                ...
                if (ctxInfo.angleBackend() != GrGLANGLEBackend::kUnknown && ctxInfo.angleDriver() != GrGLDriver::kMesa) {
                ...
                if (ctxInfo.hasExtension("GL_EXT_texture_storage") && !formatWorkarounds.fDisableBGRATextureStorageForIntelWindowsES) {
    ...
    // Format: RGB565
    {
        ...
        if (texStorageSupported && GR_IS_GR_GL_ES(standard)) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RGB565 : GR_GL_RGB;
        }
    ...
    // Format: RGBA16F
    {
        ...
        if (GR_IS_GR_GL(standard)) {
            ...
            if (version >= GR_GL_VER(3, 0)) {
                ...
                rgba16FRenderTargetSupport
                    = version >= GR_GL_VER(3, 2) || ctxInfo.hasExtension("GL_EXT_color_buffer_half_float") || ctxInfo.hasExtension("GL_EXT_color_buffer_float");
            } else if (ctxInfo.hasExtension("GL_OES_texture_half_float") && ctxInfo.hasExtension("GL_OES_texture_half_float_linear")) {
                rgba16FTextureSupport = true;
            ...
            if (version >= GR_GL_VER(2, 0)) {
                rgba16FTextureSupport = true;
                rgba16FRenderTargetSupport = ctxInfo.hasExtension("GL_EXT_color_buffer_half_float") || ctxInfo.hasExtension("EXT_color_buffer_half_float")
                    || ctxInfo.hasExtension("GL_EXT_color_buffer_float") || ctxInfo.hasExtension("EXT_color_buffer_float");
            } else if ((ctxInfo.hasExtension("GL_OES_texture_half_float") || ctxInfo.hasExtension("OES_texture_half_float"))
                && (ctxInfo.hasExtension("GL_OES_texture_half_float_linear") || ctxInfo.hasExtension("OES_texture_half_float_linear"))) {
                rgba16FTextureSupport = true;
        ...
        if (texStorageSupported && !formatWorkarounds.fDisableRGBA16FTexStorageForCrBug1008003) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RGBA16F : GR_GL_RGBA;
        }
    ...
    // Format: R16F
    {
        ...
        if (GR_IS_GR_GL(standard)) {
            ...
            if (version >= GR_GL_VER(3, 0)) {
                ...
                r16FRenderTargetSupport
                    = version >= GR_GL_VER(3, 2) || ctxInfo.hasExtension("GL_EXT_color_buffer_float") || ctxInfo.hasExtension("GL_EXT_color_buffer_half_float");
            }
        } else if (GR_IS_GR_WEBGL(standard)) {
            if (version >= GR_GL_VER(2, 0)) {
                r16FTextureSupport = true;
                r16FRenderTargetSupport = ctxInfo.hasExtension("GL_EXT_color_buffer_float") || ctxInfo.hasExtension("EXT_color_buffer_float");
            }
        }
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_R16F : GR_GL_RED;
        }
    ...
    // Format: RGBx8
    {
        ...
        if (GR_IS_GR_GL_ES(standard) && ctxInfo.hasExtension("GL_ANGLE_rgbx_internal_format") && (texStorageSupported || texImageSupportsSizedInternalFormat)) {
    ...
    // Format: RGB8
    {
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RGB8 : GR_GL_RGB;
        }
    ...
    // Format: RG8
    {
        ...
        if (!(info.fFlags & FormatInfo::kUseTexStorage_Flag)) {
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RG8 : GR_GL_RG;
        }
        if (rg8Support) {
            info.fColorTypeInfoCount = 1;
            info.fColorTypeInfos = std::make_unique<ColorTypeInfo[]>(info.fColorTypeInfoCount);
    ...
    // Format: RGB10_A2
    {
        ...
        if (GR_IS_GR_GL(standard) || (GR_IS_GR_GL_ES(standard) && version >= GR_GL_VER(3, 0))) {
            info.fFlags = FormatInfo::kTexturable_Flag | FormatInfo::kTransfers_Flag | msaaRenderFlags;
        } else if (GR_IS_GR_GL_ES(standard) && ctxInfo.hasExtension("GL_EXT_texture_type_2_10_10_10_REV")) {
            info.fFlags = FormatInfo::kTexturable_Flag | FormatInfo::kTransfers_Flag;
        } // No WebGL support
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RGB10_A2 : GR_GL_RGBA;
        }
    ...
    // Format: RGBA4
    {
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RGBA4 : GR_GL_RGBA;
        }
    ...
    // Format: SRGB8_ALPHA8
    {
        ...
        if (GR_IS_GR_GL(standard)) {
            ...
            // names.
            if (version >= GR_GL_VER(2, 0) || ctxInfo.hasExtension("GL_EXT_sRGB") || ctxInfo.hasExtension("EXT_sRGB")) {
                srgb8Alpha8TextureSupport = true;
                srgb8Alpha8RenderTargetSupport = true;
            }
            if (version < GR_GL_VER(2, 0)) {
        ...
        if (srgb8Alpha8TextureSupport) {
            ...
            if (srgb8Alpha8RenderTargetSupport) {
                info.fFlags |= formatWorkarounds.fDisableSRGBRenderWithMSAAForMacAMD ? nonMSAARenderFlags : msaaRenderFlags;
            }
        }
        if (srgb8Alpha8TexStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_SRGB8_ALPHA8 : GR_GL_SRGB_ALPHA;
        }
    ...
    // Format: R16
    {
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_R16 : GR_GL_RED;
        }
    ...
    // Format: RG16
    {
        ...
        info.fFormatType = FormatType::kNormalizedFixedPoint;
        info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RG16 : GR_GL_RG;
    ...
    // Format: RGBA16
    {
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RGBA16 : GR_GL_RGBA;
        }
    ...
    // Format:RG16F
    {
        ...
        if (GR_IS_GR_GL(standard)) {
            ...
            if (version >= GR_GL_VER(2, 0)) {
                rg16FTextureSupport = true;
                rg16FRenderTargetSupport = ctxInfo.hasExtension("GL_EXT_color_buffer_half_float") || ctxInfo.hasExtension("EXT_color_buffer_half_float")
                    || ctxInfo.hasExtension("GL_EXT_color_buffer_float") || ctxInfo.hasExtension("EXT_color_buffer_float");
            }
        }
        ...
        if (texStorageSupported) {
            ...
            info.fInternalFormatForTexImageOrStorage = texImageSupportsSizedInternalFormat ? GR_GL_RG16F : GR_GL_RG;
        }
    ...
    for (int i = 0; i < kGrGLColorFormatCount; ++i) {
        ...
        SkASSERT(!((formatInfo.fFlags & FormatInfo::kFBOColorAttachmentWithMSAA_Flag) && !(formatInfo.fFlags & FormatInfo::kFBOColorAttachment_Flag)));
...
void GrGLCaps::setupSampleCounts(const GrGLContextInfo& ctxInfo, const GrGLInterface* gli)
{
    ...
    for (int i = 0; i < kGrGLColorFormatCount; ++i) {
        if (FormatInfo::kFBOColorAttachmentWithMSAA_Flag & fFormatTable[i].fFlags) {
            ...
            if ((GR_IS_GR_GL(standard) && (version >= GR_GL_VER(4, 2) || ctxInfo.hasExtension("GL_ARB_internalformat_query")))
                ...
                const bool multisampleIsImplicit
                    = GrGLCaps::kES_IMG_MsToTexture_MSFBOType == fMSFBOType || GrGLCaps::kES_EXT_MsToTexture_MSFBOType == fMSFBOType;
                int count;
                GrGLFormat grGLFormat = static_cast<GrGLFormat>(i);
                GrGLenum glFormat = this->getRenderbufferInternalFormat(grGLFormat);
                GR_GL_GetInternalformativ(gli, GR_GL_RENDERBUFFER, glFormat, GR_GL_NUM_SAMPLE_COUNTS, 1, &count);
                if (count) {
                    std::unique_ptr<int[]> temp(new int[count]);
                    GR_GL_GetInternalformativ(gli, GR_GL_RENDERBUFFER, glFormat, GR_GL_SAMPLES, count, temp.get());
...
bool GrGLCaps::canCopyTexSubImage(GrGLFormat dstFormat, bool dstHasMSAARenderBuffer, const GrTextureType* dstTypeIfTexture, GrGLFormat srcFormat,
    bool srcHasMSAARenderBuffer, const GrTextureType* srcTypeIfTexture) const
{
    ...
    if (GR_IS_GR_GL_ES(fStandard)) {
        ...
        if ((dstFormat == GrGLFormat::kBGRA8 || srcFormat == GrGLFormat::kBGRA8) && !fAllowBGRA8CopyTexSubImage) {
            return false;
        }
        ...
        // ANGLE, for one, does not allow it. However, we've found it works on some drivers and
        // avoids bugs with using glBlitFramebuffer.
        if ((GrGLFormatIsSRGB(dstFormat) || GrGLFormatIsSRGB(srcFormat)) && !fAllowSRGBCopyTexSubImage) {
            return false;
        }
        ...
        if ((dstChannels & srcChannels) != srcChannels) {
            if (dstChannels == kGray_SkColorChannelFlag || dstChannels == kGrayAlpha_SkColorChannelFlags) {
    ...
    return this->canFormatBeFBOColorAttachment(srcFormat) && (!srcTypeIfTexture || *srcTypeIfTexture != GrTextureType::kExternal)
        && *dstTypeIfTexture != GrTextureType::kExternal;
}

bool GrGLCaps::canCopyAsBlit(GrGLFormat dstFormat, int dstSampleCnt, const GrTextureType* dstTypeIfTexture, GrGLFormat srcFormat, int srcSampleCnt,
    const GrTextureType* srcTypeIfTexture, const SkRect& srcBounds, bool srcBoundsExact, const SkIRect& srcRect, const SkIRect& dstRect) const
{
    auto blitFramebufferFlags = fBlitFramebufferFlags;
    if (!this->canFormatBeFBOColorAttachment(dstFormat) || !this->canFormatBeFBOColorAttachment(srcFormat)) {
        return false;
    }
    ...
    if (srcRect.width() != dstRect.width() || srcRect.height() != dstRect.height()) {
        ...
        if ((GrGLCaps::kNoScalingOrMirroring_BlitFramebufferFlag & blitFramebufferFlags) || this->useDrawInsteadOfAllRenderTargetWrites() || srcSampleCnt > 1) {
            return false;
        }
    }
...
{
    return this->isFormatRenderable(dstFormat, 1) && srcIsTexturable && !(fDisableScalingCopyAsDraws && scalingCopy);
}
...
bool GrGLCaps::onCanCopySurface(const GrSurfaceProxy* dst, const SkIRect& dstRect, const GrSurfaceProxy* src, const SkIRect& srcRect) const
{
    ...
    if (!scalingCopy
        && this->canCopyTexSubImage(
            dstFormat, has_msaa_render_buffer(dst, *this), dstTexTypePtr, srcFormat, has_msaa_render_buffer(src, *this), srcTexTypePtr)) {
        return true;
    }
    return this->canCopyAsBlit(
               dstFormat, dstSampleCnt, dstTexTypePtr, srcFormat, srcSampleCnt, srcTexTypePtr, src->getBoundsRect(), src->priv().isExact(), srcRect, dstRect)
        || this->canCopyAsDraw(dstFormat, SkToBool(srcTex), scalingCopy);
}

GrCaps::DstCopyRestrictions GrGLCaps::getDstCopyRestrictions(const GrRenderTargetProxy* src, GrColorType colorType) const
{
    // If the src is a texture, we can implement the blit as a draw assuming the config is
    // renderable.
    if (src->asTextureProxy() && !this->isFormatAsColorTypeRenderable(colorType, src->backendFormat())) {
        return {};
    }
    ...
    } else if (src->numSamples() > 1 && (fBlitFramebufferFlags & kRectsMustMatchForMSAASrc_BlitFramebufferFlag)) {
        blitFramebufferRestrictions.fRectsMustMatch = GrSurfaceProxy::RectsMustMatch::kYes;
    }
...
void GrGLCaps::applyDriverCorrectnessWorkarounds(const GrGLContextInfo& ctxInfo, const GrContextOptions& contextOptions, const GrGLInterface* glInterface,
    GrShaderCaps* shaderCaps, FormatWorkarounds* formatWorkarounds)
{
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno430 || ctxInfo.renderer() == GrGLRenderer::kAdreno4xx_other
    ...
    // 340.96 and 367.57.
    if (GR_IS_GR_GL(ctxInfo.standard()) && ctxInfo.driver() == GrGLDriver::kNVIDIA && ctxInfo.driverVersion() < GR_GL_DRIVER_VER(367, 57, 0)) {
        fClearTextureSupport = false;
    }
    ...
    if (ctxInfo.vendor() == GrGLVendor::kQualcomm || ctxInfo.renderer() == GrGLRenderer::kMali4xx || ctxInfo.renderer() == GrGLRenderer::kTegra_PreK1) {
        fAllowBGRA8CopyTexSubImage = true;
    }
    // glCopyTexSubImage2D works for sRGB with GLES 3.0 and on some GPUs with GLES 2.0
    if (ctxInfo.version() >= GR_GL_VER(3, 0) || ctxInfo.renderer() == GrGLRenderer::kMali4xx || ctxInfo.renderer() == GrGLRenderer::kTegra_PreK1) {
        fAllowSRGBCopyTexSubImage = true;
    }

    // http://anglebug.com/6030
    if (fMSFBOType == kES_EXT_MsToTexture_MSFBOType && ctxInfo.angleBackend() == GrGLANGLEBackend::kD3D11) {
        // As GL_EXT_multisampled_render_to_texture supporting issue,
        // fall back to default dmsaa path
        if ((ctxInfo.vendor() == GrGLVendor::kIntel || ctxInfo.angleVendor() == GrGLVendor::kIntel) && ctxInfo.renderer() >= GrGLRenderer::kIntelIceLake) {
            fMSFBOType = kStandard_MSFBOType;
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno3xx && ctxInfo.driverVersion() > GR_GL_DRIVER_VER(127, 0, 0)) {
        fMapBufferType = kNone_MapBufferType;
        fMapBufferFlags = kNone_MapFlags;
        fTransferFromBufferToTextureSupport = false;
        fTransferFromSurfaceToBufferSupport = false;
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kIntelSandyBridge && ctxInfo.driver() == GrGLDriver::kIntel) {
        fMapBufferType = kNone_MapBufferType;
        fMapBufferFlags = kNone_MapFlags;
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno615 || ctxInfo.renderer() == GrGLRenderer::kAdreno620) {
        fMSFBOType = kNone_MSFBOType;
        fMSAAResolvesAutomatically = false;
    }

#ifndef SK_BUILD_FOR_IOS
    if (ctxInfo.renderer() == GrGLRenderer::kPowerVR54x || ctxInfo.renderer() == GrGLRenderer::kPowerVRRogue
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAMDRadeonHD7xxx || ctxInfo.renderer() == GrGLRenderer::kAMDRadeonR9M4xx) {
        fPerformColorClearsAsDraws = true;
    }
    ...
    if (ctxInfo.vendor() == GrGLVendor::kIntel
        && (ctxInfo.driverVersion() < GR_GL_DRIVER_VER(10, 30, 12) || ctxInfo.renderer() == GrGLRenderer::kIntelBroadwell)) {
        fPerformColorClearsAsDraws = true;
    }
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kMali4xx || (ctxInfo.renderer() == GrGLRenderer::kWebGL && ctxInfo.webglRenderer() == GrGLRenderer::kMali4xx)) {
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno3xx && ctxInfo.driverVersion() > GR_GL_DRIVER_VER(53, 0, 0)) {
    ...
    if (fMipmapLevelControlSupport && !ctxInfo.isOverCommandBuffer() && // http://crbug.com/1224110
        (contextOptions.fDoManualMipmapping || ctxInfo.vendor() == GrGLVendor::kIntel || (ctxInfo.driver() == GrGLDriver::kNVIDIA && isMAC)
    ...
    if (ctxInfo.angleBackend() == GrGLANGLEBackend::kD3D9 || ctxInfo.angleBackend() == GrGLANGLEBackend::kD3D11) {
        fBaseVertexBaseInstanceSupport = false;
        fNativeDrawIndirectSupport = false;
        fMultiDrawType = MultiDrawType::kNone;
    }
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno530 || ctxInfo.renderer() == GrGLRenderer::kAdreno5xx_other) {
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno530 || ctxInfo.renderer() == GrGLRenderer::kAdreno5xx_other || ctxInfo.renderer() == GrGLRenderer::kAdreno615
        || ctxInfo.renderer() == GrGLRenderer::kAdreno620 || ctxInfo.renderer() == GrGLRenderer::kAdreno630 || ctxInfo.renderer() == GrGLRenderer::kAdreno640
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno3xx || ctxInfo.renderer() == GrGLRenderer::kAdreno4xx_other) {
        shaderCaps->fMustWriteToFragColor = true;
    }

    // Disabling advanced blend on various platforms with major known issues. We also block Chrome
    // command buffer for now until its own denylists can be updated.
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno430 || ctxInfo.renderer() == GrGLRenderer::kAdreno4xx_other || ctxInfo.renderer() == GrGLRenderer::kAdreno530
        || ctxInfo.renderer() == GrGLRenderer::kAdreno5xx_other || ctxInfo.driver() == GrGLDriver::kIntel || ctxInfo.angleVendor() == GrGLVendor::kIntel
        || ctxInfo.isOverCommandBuffer() || ctxInfo.vendor() == GrGLVendor::kARM /* http://skbug.com/11906 */) {
    ...
    if (((ctxInfo.driver() == GrGLDriver::kNVIDIA && ctxInfo.driverVersion() < GR_GL_DRIVER_VER(337, 00, 0))
            || (ctxInfo.angleBackend() == GrGLANGLEBackend::kOpenGL && ctxInfo.angleDriver() == GrGLDriver::kNVIDIA
    ...
    if (this->advancedBlendEquationSupport()) {
        if ((ctxInfo.driver() == GrGLDriver::kNVIDIA && ctxInfo.driverVersion() < GR_GL_DRIVER_VER(355, 00, 0))
            || (ctxInfo.angleBackend() == GrGLANGLEBackend::kOpenGL && ctxInfo.angleDriver() == GrGLDriver::kNVIDIA
                && ctxInfo.angleDriverVersion() < GR_GL_DRIVER_VER(355, 00, 0))) {
            // Disable color-dodge and color-burn on pre-355.00 NVIDIA.
            fAdvBlendEqDisableFlags |= (1 << static_cast<int>(skgpu::BlendEquation::kColorDodge)) | (1 << static_cast<int>(skgpu::BlendEquation::kColorBurn));
        }
        if (ctxInfo.vendor() == GrGLVendor::kARM) {
    ...
    // disable blending.
    if (ctxInfo.renderer() == GrGLRenderer::kAdreno530 || ctxInfo.renderer() == GrGLRenderer::kAdreno5xx_other || ctxInfo.renderer() == GrGLRenderer::kAdreno620
    ...
    // skbug.com/7713
    if (ctxInfo.hasExtension("GL_OES_EGL_image_external") && ctxInfo.glslGeneration() >= SkSL::GLSLGeneration::k330
    ...
    if (ctxInfo.vendor() == GrGLVendor::kIntel || // IntelIris640 drops draws completely.
        ...
        ctxInfo.renderer() == GrGLRenderer::kAdreno3xx || ctxInfo.renderer() == GrGLRenderer::kAdreno430 || ctxInfo.renderer() == GrGLRenderer::kAdreno4xx_other
        || // We get garbage on Adreno405.
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kPowerVRRogue && ctxInfo.driverVersion() < GR_GL_DRIVER_VER(1, 15, 0)) {
        fDisableTessellationPathRenderer = true;
    }
    ...
    if (ctxInfo.driver() == GrGLDriver::kIntel || (ctxInfo.angleVendor() == GrGLVendor::kIntel && ctxInfo.angleBackend() == GrGLANGLEBackend::kOpenGL)) {
    ...
    if (ctxInfo.vendor() == GrGLVendor::kQualcomm && SkSL::GLSLGeneration::k320es != ctxInfo.glslGeneration()) {
    ...
    formatWorkarounds->fDisableRGBA16FTexStorageForCrBug1008003 = ctxInfo.isOverCommandBuffer() && ctxInfo.version() < GR_GL_VER(3, 0);
    ...
    formatWorkarounds->fDisableBGRATextureStorageForIntelWindowsES = ctxInfo.driver() == GrGLDriver::kIntel && GR_IS_GR_GL_ES(ctxInfo.standard());
#endif
    ...
    formatWorkarounds->fDisableLuminance16F = (ctxInfo.renderer() == GrGLRenderer::kIntelBroadwell || ctxInfo.vendor() == GrGLVendor::kQualcomm)
    ...
    formatWorkarounds->fDisallowDirectRG8ReadPixels = ctxInfo.renderer() == GrGLRenderer::kAMDRadeonR9M3xx
        || ctxInfo.renderer() == GrGLRenderer::kAMDRadeonPro5xxx || ctxInfo.renderer() == GrGLRenderer::kAMDRadeonProVegaxx;
#endif
    ...
    if (ctxInfo.vendor() == GrGLVendor::kARM && !contextOptions.fAlwaysUseTexStorageWhenAvailable && !fSupportsProtectedContent) {
    ...
    if (fTiledRenderingSupport && (!glInterface->fFunctions.fStartTiling || !glInterface->fFunctions.fEndTiling)) {
    ...
    if (ctxInfo.vendor() == GrGLVendor::kIntel || ctxInfo.angleVendor() == GrGLVendor::kIntel) {
        ...
        if (ctxInfo.renderer() >= GrGLRenderer::kIntelIceLake && contextOptions.fAllowMSAAOnNewIntel) {
    ...
    if (ctxInfo.angleBackend() == GrGLANGLEBackend::kD3D9 && ctxInfo.angleVendor() == GrGLVendor::kATI) {
        fProgramBinarySupport = false;
    }
    ...
    if ((ctxInfo.renderer() == GrGLRenderer::kAdreno620 || ctxInfo.renderer() == GrGLRenderer::kAdreno640)
    ...
    // ChromeOS from here.
    if (ctxInfo.renderer() == GrGLRenderer::kPowerVRRogue && ctxInfo.driver() == GrGLDriver::kImagination
    ...
    if ((ctxInfo.renderer() == GrGLRenderer::kAdreno3xx && ctxInfo.driver() == GrGLDriver::kQualcomm) || (ctxInfo.renderer() == GrGLRenderer::kMaliG)) {
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kMaliT && ctxInfo.driver() == GrGLDriver::kARM && ctxInfo.driverVersion() < GR_GL_DRIVER_VER(1, 26, 0)) {
    ...
    if (ctxInfo.renderer() == GrGLRenderer::kMaliG && ctxInfo.driver() == GrGLDriver::kARM && ctxInfo.driverVersion() < GR_GL_DRIVER_VER(1, 19, 0)) {
        fAnisoSupport = false;
    }
    ...
    // these devices.
    if (ctxInfo.renderer() == GrGLRenderer::kMali4xx && ctxInfo.driverVersion() >= GR_GL_DRIVER_VER(2, 1, 19900)) {
    ...
    if (ctxInfo.vendor() == GrGLVendor::kIntel && ctxInfo.angleBackend() == GrGLANGLEBackend::kUnknown) {
...
GrCaps::SurfaceReadPixelsSupport GrGLCaps::surfaceSupportsReadPixels(const GrSurface* surface) const
{
...
GrCaps::SupportedRead GrGLCaps::onSupportedReadPixelsColorType(
    GrColorType srcColorType, const GrBackendFormat& srcBackendFormat, GrColorType dstColorType) const
{

    SkTextureCompressionType compression = GrBackendFormatToCompressionType(srcBackendFormat);
    if (compression != SkTextureCompressionType::kNone) {
        return { SkTextureCompressionTypeIsOpaque(compression) ? GrColorType::kRGB_888x : GrColorType::kRGBA_8888, 0 };
    }
        ...
        if (formatInfo.fColorTypeInfos[i].fColorType == srcColorType) {
            ...
            for (int j = 0; j < ctInfo.fExternalIOFormatCount; ++j) {
                ...
                if (ioInfo.fExternalReadFormat != 0) {
                    if (formatInfo.fHaveQueriedImplementationReadSupport || !ioInfo.fRequiresImplementationReadQuery) {
...
GrCaps::SupportedWrite GrGLCaps::supportedWritePixelsColorType(
    GrColorType surfaceColorType, const GrBackendFormat& surfaceFormat, GrColorType srcColorType) const
{
...
{
    return std::find(fProgramBinaryFormats.begin(), fProgramBinaryFormats.end(), binaryFormat) != fProgramBinaryFormats.end();
}
...
bool GrGLCaps::isFormatAsColorTypeRenderable(GrColorType ct, const GrBackendFormat& format, int sampleCount) const
{
...
void GrGLCaps::didQueryImplementationReadSupport(GrGLFormat format, GrGLenum readFormat, GrGLenum readType) const
{
...
bool GrGLCaps::onAreColorTypeAndFormatCompatible(GrColorType ct, const GrBackendFormat& format) const
{
...
GrBackendFormat GrGLCaps::getBackendFormatFromCompressionType(SkTextureCompressionType compressionType) const
{
    ...
    case SkTextureCompressionType::kBC1_RGB8_UNORM:
        if (this->isFormatTexturable(GrGLFormat::kCOMPRESSED_RGB8_BC1)) {
            return GrBackendFormats::MakeGL(GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT, GR_GL_TEXTURE_2D);
        }
        return {};
    case SkTextureCompressionType::kBC1_RGBA8_UNORM:
        if (this->isFormatTexturable(GrGLFormat::kCOMPRESSED_RGBA8_BC1)) {
            return GrBackendFormats::MakeGL(GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, GR_GL_TEXTURE_2D);
        }
        return {};
    }
...
skgpu::Swizzle GrGLCaps::onGetReadSwizzle(const GrBackendFormat& format, GrColorType colorType) const
{
    GrGLFormat glFormat = GrBackendFormats::AsGLFormat(format);
    const auto& info = this->getFormatInfo(glFormat);
    for (int i = 0; i < info.fColorTypeInfoCount; ++i) {
    ...
    SkDEBUGFAILF("Illegal color type (%d) and format (%d) combination.", (int)colorType, (int)glFormat);
    return {};
}

skgpu::Swizzle GrGLCaps::getWriteSwizzle(const GrBackendFormat& format, GrColorType colorType) const
{
    ...
    SkDEBUGFAILF("Illegal color type (%d) and format (%d) combination.", (int)colorType, (int)GrBackendFormats::AsGLFormat(format));
    return {};
}
...
GrProgramDesc GrGLCaps::makeDesc(GrRenderTarget* /* rt */, const GrProgramInfo& programInfo, ProgramDescOverrideFlags overrideFlags) const
{
...
std::vector<GrTest::TestFormatColorTypeCombination> GrGLCaps::getTestingCombinations() const
{
    std::vector<GrTest::TestFormatColorTypeCombination> combos = {
        { GrColorType::kAlpha_8, GrBackendFormats::MakeGL(GR_GL_ALPHA8, GR_GL_TEXTURE_2D) },
        { GrColorType::kAlpha_8, GrBackendFormats::MakeGL(GR_GL_R8, GR_GL_TEXTURE_2D) },
        { GrColorType::kBGR_565, GrBackendFormats::MakeGL(GR_GL_RGB565, GR_GL_TEXTURE_2D) },
        { GrColorType::kABGR_4444, GrBackendFormats::MakeGL(GR_GL_RGBA4, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGBA_8888, GrBackendFormats::MakeGL(GR_GL_RGBA8, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGBA_8888_SRGB, GrBackendFormats::MakeGL(GR_GL_SRGB8_ALPHA8, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_888x, GrBackendFormats::MakeGL(GR_GL_RGBA8, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_888x, GrBackendFormats::MakeGL(GR_GL_BGRA8, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_888x, GrBackendFormats::MakeGL(GR_GL_RGB8, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_888x, GrBackendFormats::MakeGL(GR_GL_COMPRESSED_RGB8_ETC2, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_888x, GrBackendFormats::MakeGL(GR_GL_COMPRESSED_ETC1_RGB8, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_888x, GrBackendFormats::MakeGL(GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGBA_8888, GrBackendFormats::MakeGL(GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT, GR_GL_TEXTURE_2D) },
        { GrColorType::kRG_88, GrBackendFormats::MakeGL(GR_GL_RG8, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGBA_1010102, GrBackendFormats::MakeGL(GR_GL_RGB10_A2, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_101010x, GrBackendFormats::MakeGL(GR_GL_RGB10_A2, GR_GL_TEXTURE_2D) },
        { GrColorType::kGray_8, GrBackendFormats::MakeGL(GR_GL_LUMINANCE8, GR_GL_TEXTURE_2D) },
        { GrColorType::kGray_8, GrBackendFormats::MakeGL(GR_GL_R8, GR_GL_TEXTURE_2D) },
        { GrColorType::kGrayAlpha_88, GrBackendFormats::MakeGL(GR_GL_LUMINANCE8_ALPHA8, GR_GL_TEXTURE_2D) },
        { GrColorType::kAlpha_F16, GrBackendFormats::MakeGL(GR_GL_R16F, GR_GL_TEXTURE_2D) },
        { GrColorType::kAlpha_F16, GrBackendFormats::MakeGL(GR_GL_LUMINANCE16F, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGBA_F16, GrBackendFormats::MakeGL(GR_GL_RGBA16F, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGBA_F16_Clamped, GrBackendFormats::MakeGL(GR_GL_RGBA16F, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGB_F16F16F16x, GrBackendFormats::MakeGL(GR_GL_RGBA16F, GR_GL_TEXTURE_2D) },
        { GrColorType::kAlpha_16, GrBackendFormats::MakeGL(GR_GL_R16, GR_GL_TEXTURE_2D) },
        { GrColorType::kRG_1616, GrBackendFormats::MakeGL(GR_GL_RG16, GR_GL_TEXTURE_2D) },
        { GrColorType::kRGBA_16161616, GrBackendFormats::MakeGL(GR_GL_RGBA16, GR_GL_TEXTURE_2D) },
        { GrColorType::kRG_F16, GrBackendFormats::MakeGL(GR_GL_RG16F, GR_GL_TEXTURE_2D) },
    };

    if (GR_IS_GR_GL(fStandard)) {
        combos.push_back({ GrColorType::kBGRA_8888, GrBackendFormats::MakeGL(GR_GL_RGBA8, GR_GL_TEXTURE_2D) });
        combos.push_back({ GrColorType::kBGRA_1010102, GrBackendFormats::MakeGL(GR_GL_RGB10_A2, GR_GL_TEXTURE_2D) });
    } else {
        SkASSERT(GR_IS_GR_GL_ES(fStandard) || GR_IS_GR_WEBGL(fStandard));

        combos.push_back({ GrColorType::kBGRA_8888, GrBackendFormats::MakeGL(GR_GL_BGRA8, GR_GL_TEXTURE_2D) });
    }
    if (this->rectangleTextureSupport()) {
        ...
        for (size_t i = 0; i < count2D; ++i) {
            ...
            combos.push_back({ combo2D.fColorType, GrBackendFormats::MakeGL(formatEnum, GR_GL_TEXTURE_RECTANGLE) });
        }
    }
    return combos;
}
