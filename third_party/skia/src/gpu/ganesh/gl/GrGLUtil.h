...
#define GR_GL_DRIVER_VER(major, minor, point) ((static_cast<uint64_t>(major) << 32) | (static_cast<uint64_t>(minor) << 16) | static_cast<uint64_t>(point))
...
static constexpr uint32_t GrGLFormatChannels(GrGLFormat format)
{
    ...
    case GrGLFormat::kLUMINANCE8_ALPHA8:
        return kGrayAlpha_SkColorChannelFlags;
...
enum class GrGLDriver { kMesa, kNVIDIA, kIntel, kQualcomm, kFreedreno, kAndroidEmulator, kImagination, kARM, kApple, kUnknown };
...
static constexpr GrGLFormat GrGLFormatFromGLEnum(GrGLenum glFormat)
{
    ...
    case GR_GL_LUMINANCE8_ALPHA8:
        return GrGLFormat::kLUMINANCE8_ALPHA8;
    case GR_GL_BGRA8:
    ...
    case GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT:
        return GrGLFormat::kCOMPRESSED_RGB8_BC1;
    case GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT:
        return GrGLFormat::kCOMPRESSED_RGBA8_BC1;
    case GR_GL_R16:
    ...
    case GR_GL_STENCIL_INDEX8:
        return GrGLFormat::kSTENCIL_INDEX8;
    case GR_GL_STENCIL_INDEX16:
        return GrGLFormat::kSTENCIL_INDEX16;
    case GR_GL_DEPTH24_STENCIL8:
...
static constexpr GrGLenum GrGLFormatToEnum(GrGLFormat format)
{
    ...
    case GrGLFormat::kLUMINANCE8_ALPHA8:
        return GR_GL_LUMINANCE8_ALPHA8;
    case GrGLFormat::kBGRA8:
        return GR_GL_BGRA8;
    case GrGLFormat::kRGB565:
        return GR_GL_RGB565;
    ...
    case GrGLFormat::kCOMPRESSED_RGB8_BC1:
        return GR_GL_COMPRESSED_RGB_S3TC_DXT1_EXT;
    case GrGLFormat::kCOMPRESSED_RGBA8_BC1:
        return GR_GL_COMPRESSED_RGBA_S3TC_DXT1_EXT;
    case GrGLFormat::kR16:
        return GR_GL_R16;
    case GrGLFormat::kRG16:
        return GR_GL_RG16;
    ...
    case GrGLFormat::kRG16F:
        return GR_GL_RG16F;
    case GrGLFormat::kSTENCIL_INDEX8:
        return GR_GL_STENCIL_INDEX8;
    case GrGLFormat::kSTENCIL_INDEX16:
        return GR_GL_STENCIL_INDEX16;
    case GrGLFormat::kDEPTH24_STENCIL8:
        return GR_GL_DEPTH24_STENCIL8;
    case GrGLFormat::kUnknown:
        return 0;
    }
    SkUNREACHABLE;
