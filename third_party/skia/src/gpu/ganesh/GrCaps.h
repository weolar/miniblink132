...
public:
    ...
    {
        return fNativeDrawIndirectSupport;
    }
    ...
    {
        return fConservativeRasterSupport;
    }
    bool wireframeSupport() const
    {
        return fWireframeSupport;
    }
    ...
    {
        return fPreferDiscardableMSAAAttachment;
    }
    ...
    {
        return this->shaderCaps()->fReducedShaderMode;
    }
     ...
     */
    virtual SupportedWrite supportedWritePixelsColorType(GrColorType surfaceColorType, const GrBackendFormat& surfaceFormat, GrColorType srcColorType) const
        = 0;
    ...
    {
        return fTransferPixelsToRowBytesSupport;
    }
    ...
    {
        return fTransferFromBufferToBufferSupport;
    }
    ...
    {
        return fSupportsProtectedContent;
    }
    ...
    {
        return fAvoidLargeIndexBufferDraws;
    }
    ...
    {
        return fDisableTessellationPathRenderer;
    }
    ...
    bool validateSurfaceParams(
        const SkISize&, const GrBackendFormat&, GrRenderable renderable, int renderTargetSampleCnt, skgpu::Mipmapped, GrTextureType) const;
