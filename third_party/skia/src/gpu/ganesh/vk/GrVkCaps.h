...
public:
     ...
     */
    GrVkCaps(const GrContextOptions&, const skgpu::VulkanInterface*, VkPhysicalDevice, const VkPhysicalDeviceFeatures2&, uint32_t instanceVersion,
        uint32_t physicalDeviceVersion, const skgpu::VulkanExtensions&, skgpu::Protected);
    ...
    {
        return fMustSyncCommandBuffersWithQueue;
    }
    ...
    {
        return fSupportsDRMFormatModifiers;
    }

    bool supportsDeviceFaultInfo() const
    {
        return fSupportsDeviceFaultInfo;
    }

    bool supportsFrameBoundary() const
    {
        return fSupportsFrameBoundary;
    }
    ...
    {
        return fMaxInputAttachmentDescriptors;
    }
    ...
    {
        return fGpuOnlyBuffersMorePerformant;
    }
    ...
    {
        return fMaxDrawIndirectDrawCount;
    }
    ...
    bool canCopyAsBlit(VkFormat dstConfig, int dstSampleCnt, bool dstIsLinear, bool dstHasYcbcr, VkFormat srcConfig, int srcSampleCnt, bool srcIsLinear,
    ...
    {
        return fSupportsDiscardableMSAAForDMSAA;
    }
    ...
    {
        return fSupportsMemorylessAttachments;
    }
...
private:
    ...
    void init(const GrContextOptions&, const skgpu::VulkanInterface*, VkPhysicalDevice, const VkPhysicalDeviceFeatures2&, uint32_t physicalDeviceVersion,
        const skgpu::VulkanExtensions&, GrProtected);
    void initGrCaps(const skgpu::VulkanInterface* vkInterface, VkPhysicalDevice physDev, const VkPhysicalDeviceProperties&,
        const VkPhysicalDeviceMemoryProperties&, const VkPhysicalDeviceFeatures2&, const skgpu::VulkanExtensions&);
    void initShaderCaps(const VkPhysicalDeviceProperties&, const VkPhysicalDeviceFeatures2&);

    void initFormatTable(const GrContextOptions&, const skgpu::VulkanInterface*, VkPhysicalDevice, const VkPhysicalDeviceProperties&,
        const VkPhysicalDeviceFeatures2&, const skgpu::VulkanExtensions&);
    ...
    struct FormatInfo {
        ...
        void init(const GrContextOptions&, const skgpu::VulkanInterface*, VkPhysicalDevice, const VkPhysicalDeviceProperties&, VkFormat);
        static void InitFormatFlags(VkFormatFeatureFlags, uint16_t* flags);
        void initSampleCounts(const GrContextOptions&, const skgpu::VulkanInterface*, VkPhysicalDevice, const VkPhysicalDeviceProperties&, VkFormat);
