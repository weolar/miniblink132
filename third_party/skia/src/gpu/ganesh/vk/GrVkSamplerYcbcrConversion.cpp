...
GrVkSamplerYcbcrConversion* GrVkSamplerYcbcrConversion::Create(GrVkGpu* gpu, const skgpu::VulkanYcbcrConversionInfo& info)
{
    ...
    VkResult result;
    GR_VK_CALL_RESULT(gpu, result, CreateSamplerYcbcrConversion(gpu->device(), &ycbcrCreateInfo, nullptr, &conversion));
...
void GrVkSamplerYcbcrConversion::freeGPUData() const
{
    ...
    GR_VK_CALL(fGpu->vkInterface(), DestroySamplerYcbcrConversion(fGpu->device(), fYcbcrConversion, nullptr));
}
...
GrVkSamplerYcbcrConversion::Key GrVkSamplerYcbcrConversion::GenerateKey(const skgpu::VulkanYcbcrConversionInfo& ycbcrInfo)
{
    ...
    SkASSERT(static_cast<int>(ycbcrInfo.fComponents.r <= 6) && static_cast<int>(ycbcrInfo.fComponents.g <= 6) && static_cast<int>(ycbcrInfo.fComponents.b <= 6)
