...
public:
    ...
    {
        return this->context()->matches(candidate);
    }
    ...
    {
        return this->context()->caps();
    }
    sk_sp<const GrCaps> refCaps() const;

    GrImageContext* asImageContext()
    {
        return this->context()->asImageContext();
    }
    GrRecordingContext* asRecordingContext()
    {
        return this->context()->asRecordingContext();
    }
    GrDirectContext* asDirectContext()
    {
        return this->context()->asDirectContext();
    }
