...
GrBackendFormat GrContext_Base::defaultBackendFormat(SkColorType skColorType, GrRenderable renderable) const
{
...
GrContextOptions::ShaderErrorHandler* GrBaseContextPriv::getShaderErrorHandler() const
{
    ...
    return options.fShaderErrorHandler ? options.fShaderErrorHandler : skgpu::DefaultShaderErrorHandler();
}
