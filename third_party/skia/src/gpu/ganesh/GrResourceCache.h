...
public:
    ...
    void dumpStatsKeyValuePairs(skia_private::TArray<SkString>* keys, skia_private::TArray<double>* value) const;
#endif
    ...
    private:
        ...
        using Bus = SkMessageBus<UnrefResourceMessage, GrDirectContext::DirectContextID,
            /*AllowCopyableMessage=*/false>;

        UnrefResourceMessage(sk_sp<GrGpuResource>&& resource, GrDirectContext::DirectContextID recipient)
...
private:
    ...
    void purgeUnlockedResources(const skgpu::StdSteadyClock::time_point* purgeTime, GrPurgeResourceOptions opts);
    ...
    struct ScratchMapTraits {
        ...
        static uint32_t Hash(const skgpu::ScratchKey& key)
        {
            return key.hash();
        }
    ...
    struct UniqueHashTraits {
        static const skgpu::UniqueKey& GetKey(const GrGpuResource& r)
        {
...
static inline bool SkShouldPostMessageToBus(const GrResourceCache::UnrefResourceMessage& msg, GrDirectContext::DirectContextID potentialRecipient)
{
