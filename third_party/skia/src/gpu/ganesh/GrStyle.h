...
public:
    ...
    bool isDashed() const
    {
        return SkPathEffectBase::DashType::kDash == fDashInfo.fType;
    }
     ...
     * matrix.
     */
    [[nodiscard]] bool applyPathEffectToPath(SkPath* dst, SkStrokeRec* remainingStoke, const SkPath& src, SkScalar scale) const;
     ...
     */
    [[nodiscard]] bool applyToPath(SkPath* dst, SkStrokeRec::InitStyle* fillOrHairline, const SkPath& src, SkScalar scale) const;
