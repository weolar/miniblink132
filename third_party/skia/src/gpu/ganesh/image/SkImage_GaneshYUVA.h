...
public:
    ...
    {
        return SkImage_Base::Type::kGaneshYUVA;
    }
    ...
    {
        return fYUVAProxies.textureOrigin();
    }
...
private:
    ...
    SkImage_GaneshYUVA(sk_sp<GrImageContext>, const SkImage_GaneshYUVA* image, sk_sp<SkColorSpace> targetCS, ColorSpaceMode csMode);
