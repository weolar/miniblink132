...
public:
    ...
    private:
        SkMutex fLock;
        skia_private::THashSet<const GrManagedResource*, GrManagedResource::Hash> fHashSet SK_GUARDED_BY(fLock);
    };
    ...
    virtual const GrManagedResource* asVkImageResource() const
    {
        return nullptr;
    }
#endif
