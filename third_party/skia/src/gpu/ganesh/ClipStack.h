...
private:
    ...
    public:
        ...
        const SkIRect& innerBounds() const
        {
            return fInnerBounds;
        }
        GrAA aa() const
    ...
    public:
        ...
        SkDEBUGCODE(const SaveRecord* owner() const { return fOwner; }) private : UniqueKey fKey;
    ...
    static GrFPResult GetSWMaskFP(GrRecordingContext* context, Mask::Stack* masks, const SaveRecord& current, const SkIRect& bounds, const Element** elements,
