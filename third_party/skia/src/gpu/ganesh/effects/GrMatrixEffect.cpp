...
std::unique_ptr<GrFragmentProcessor> GrMatrixEffect::Make(const SkMatrix& matrix, std::unique_ptr<GrFragmentProcessor> child)
{
...
std::unique_ptr<GrFragmentProcessor::ProgramImpl> GrMatrixEffect::onMakeProgramImpl() const
{
    ...
    public:
        ...
        {
            fMatrixVar = args.fUniformHandler->addUniform(&args.fFp, kFragment_GrShaderFlag, SkSLType::kFloat3x3, SkSL::SampleUsage::MatrixUniformName());
