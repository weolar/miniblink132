...
public:
    static GrGeometryProcessor* Make(SkArenaAlloc* arena, const SkPMColor4f& color, const SkMatrix& viewMatrix, const GrCaps& caps, const SkMatrix& localMatrix,
        bool usesLocalCoords, uint8_t coverage = 0xff)
    {
        ...
        return arena->make([&](void* ptr) { return new (ptr) GrConicEffect(color, viewMatrix, coverage, localMatrix, usesLocalCoords); });
    }
...
private:
    ...
    GrConicEffect(const SkPMColor4f&, const SkMatrix& viewMatrix, uint8_t coverage, const SkMatrix& localMatrix, bool usesLocalCoords);
    ...
    inline static constexpr Attribute kAttributes[]
        = { { "inPosition", kFloat2_GrVertexAttribType, SkSLType::kFloat2 }, { "inConicCoeffs", kFloat4_GrVertexAttribType, SkSLType::kHalf4 } };
...
public:
        ...
        bool usesLocalCoords, uint8_t coverage = 0xff)
    {
        ...
        return arena->make([&](void* ptr) { return new (ptr) GrQuadEffect(color, viewMatrix, coverage, localMatrix, usesLocalCoords); });
    }
...
private:
    ...
    GrQuadEffect(const SkPMColor4f&, const SkMatrix& viewMatrix, uint8_t coverage, const SkMatrix& localMatrix, bool usesLocalCoords);
    ...
    inline static constexpr Attribute kAttributes[]
        = { { "inPosition", kFloat2_GrVertexAttribType, SkSLType::kFloat2 }, { "inHairQuadEdge", kFloat4_GrVertexAttribType, SkSLType::kHalf4 } };
