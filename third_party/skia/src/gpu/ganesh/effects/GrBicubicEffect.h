...
public:
     ...
     */
    static std::unique_ptr<GrFragmentProcessor> Make(GrSurfaceProxyView view, SkAlphaType, const SkMatrix&, const GrSamplerState::WrapMode wrapX,
        const GrSamplerState::WrapMode wrapY, SkCubicResampler, Direction, const GrCaps&);
     ...
     */
    static std::unique_ptr<GrFragmentProcessor> MakeSubset(GrSurfaceProxyView view, SkAlphaType, const SkMatrix&, const GrSamplerState::WrapMode wrapX,
        const GrSamplerState::WrapMode wrapY, const SkRect& subset, SkCubicResampler, Direction, const GrCaps&);
     ...
     */
    static std::unique_ptr<GrFragmentProcessor> MakeSubset(GrSurfaceProxyView view, SkAlphaType, const SkMatrix&, const GrSamplerState::WrapMode wrapX,
        const GrSamplerState::WrapMode wrapY, const SkRect& subset, const SkRect& domain, SkCubicResampler, Direction, const GrCaps&);
     ...
     */
    static std::unique_ptr<GrFragmentProcessor> Make(std::unique_ptr<GrFragmentProcessor>, SkAlphaType, const SkMatrix&, SkCubicResampler, Direction);
...
private:
    ...
    GrBicubicEffect(std::unique_ptr<GrFragmentProcessor>, SkCubicResampler, Direction, Clamp);
