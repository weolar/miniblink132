...
public:
     ...
     */
    sk_sp<GrTextureProxy> createProxy(const GrBackendFormat&, SkISize dimensions, GrRenderable, int renderTargetSampleCnt, skgpu::Mipmapped, SkBackingFit,
        skgpu::Budgeted, GrProtected, std::string_view label, GrInternalSurfaceFlags = GrInternalSurfaceFlags::kNone,
    ...
    sk_sp<GrTextureProxy> createCompressedTextureProxy(
        SkISize dimensions, skgpu::Budgeted, skgpu::Mipmapped, GrProtected, SkTextureCompressionType, sk_sp<SkData> data);
    ...
    sk_sp<GrTextureProxy> wrapRenderableBackendTexture(
        const GrBackendTexture&, int sampleCnt, GrWrapOwnership, GrWrapCacheable, sk_sp<skgpu::RefCntedCallback> releaseHelper);
    ...
    static sk_sp<GrTextureProxy> CreatePromiseProxy(
        GrContextThreadSafeProxy*, LazyInstantiateCallback&&, const GrBackendFormat&, SkISize dimensions, skgpu::Mipmapped);
     ...
     */
    sk_sp<GrTextureProxy> createLazyProxy(LazyInstantiateCallback&&, const GrBackendFormat&, SkISize dimensions, skgpu::Mipmapped, GrMipmapStatus,
        GrInternalSurfaceFlags, SkBackingFit, skgpu::Budgeted, GrProtected, UseAllocator, std::string_view label);

    /** A null TextureInfo indicates a non-textureable render target. */
    sk_sp<GrRenderTargetProxy> createLazyRenderTargetProxy(LazyInstantiateCallback&&, const GrBackendFormat&, SkISize dimensions, int renderTargetSampleCnt,
        GrInternalSurfaceFlags, const TextureInfo*, GrMipmapStatus, SkBackingFit, skgpu::Budgeted, GrProtected, bool wrapsVkSecondaryCB,
    ...
    static sk_sp<GrTextureProxy> MakeFullyLazyProxy(
        LazyInstantiateCallback&&, const GrBackendFormat&, GrRenderable, int renderTargetSampleCnt, GrProtected, const GrCaps&, UseAllocator);
     ...
     */
    sk_sp<GrTextureProxy> testingOnly_createInstantiatedProxy(SkISize dimensions, const GrBackendFormat& format, GrRenderable renderable,
    ...
    sk_sp<GrTextureProxy> testingOnly_createInstantiatedProxy(SkISize dimensions, GrColorType colorType, GrRenderable renderable, int renderTargetSampleCnt,
        SkBackingFit fit, skgpu::Budgeted budgeted, GrProtected isProtected);
...
private:
    ...
    void processInvalidUniqueKeyImpl(const skgpu::UniqueKey&, GrTextureProxy*, InvalidateGPUResource, RemoveTableEntry);

    /*
     * Create an un-mipmapped texture proxy for the bitmap.
     */
    sk_sp<GrTextureProxy> createNonMippedProxyFromBitmap(const SkBitmap&, SkBackingFit, skgpu::Budgeted);
    /*
