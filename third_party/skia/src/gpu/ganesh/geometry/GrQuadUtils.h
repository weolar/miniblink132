...
private:
    ...
    struct EdgeVectors {
        ...
        void reset(const skvx::float4& xs, const skvx::float4& ys, const skvx::float4& ws, GrQuad::Type quadType);
    };
    ...
    struct EdgeEquations {
        ...
        int computeDegenerateQuad(const skvx::float4& signedEdgeDistances, skvx::float4* x2d, skvx::float4* y2d, skvx::Vec<4, int32_t>* aaMask) const;
    };
    ...
    struct OutsetRequest {
        ...
        void reset(const EdgeVectors& edgeVectors, GrQuad::Type quadType, const skvx::float4& edgeDistances);
    };
    ...
    struct Vertices {
        ...
        void asGrQuads(GrQuad* deviceOut, GrQuad::Type deviceType, GrQuad* localOut, GrQuad::Type localType) const;
        ...
        void moveTo(const skvx::float4& x2d, const skvx::float4& y2d, const skvx::Vec<4, int32_t>& mask);
    };
