...
sk_sp<SkImageFilter> SkImageFilters::Merge(sk_sp<SkImageFilter>* const filters, int count, const CropRect& cropRect)
{
    if (count <= 0 || !filters) {
    ...
    const skif::Mapping& mapping, const skif::LayerSpace<SkIRect>& desiredOutput, std::optional<skif::LayerSpace<SkIRect>> contentBounds) const
{
    ...
    return skif::LayerSpace<SkIRect>::Union(inputCount, [&](int i) { return this->getChildInputLayerBounds(i, mapping, desiredOutput, contentBounds); });
}
    ...
    const skif::Mapping& mapping, std::optional<skif::LayerSpace<SkIRect>> contentBounds) const
{
    ...
    auto childOutput = skif::LayerSpace<SkIRect>::Union(inputCount, [&](int i) {
