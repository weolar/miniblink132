...
struct SkOTTableOS2_V3 {
    ...
    union Type {
        struct Field {
            //8-15
            SK_OT_BYTE_BITFIELD(NoSubsetting, Bitmap, Reserved10, Reserved11, Reserved12, Reserved13, Reserved14, Reserved15)
            //0-7
    ...
    union UnicodeRange {
        struct Field {
            //l0 24-31
            SK_OT_BYTE_BITFIELD(Thai, Lao, Georgian, Reserved027, HangulJamo, LatinExtendedAdditional, GreekExtended, GeneralPunctuation)
            //l0 16-23
            SK_OT_BYTE_BITFIELD(Bengali, Gurmukhi, Gujarati, Oriya, Tamil, Telugu, Kannada, Malayalam)
            //l0 8-15
            SK_OT_BYTE_BITFIELD(Reserved008, Cyrillic, Armenian, Hebrew, Reserved012, Arabic, Reserved014, Devanagari)
            //l0 0-7
            SK_OT_BYTE_BITFIELD(
                BasicLatin, Latin1Supplement, LatinExtendedA, LatinExtendedB, IPAExtensions, SpacingModifierLetters, CombiningDiacriticalMarks, GreekAndCoptic)

            //l1 24-31
            SK_OT_BYTE_BITFIELD(Hangul, NonPlane0, Reserved058, CJKUnifiedIdeographs, PrivateUseArea, CJKCompatibilityIdeographs, AlphabeticPresentationForms,
                ArabicPresentationFormsA)
            //l1 16-23
            SK_OT_BYTE_BITFIELD(
                CJKSymbolsAndPunctuation, Hiragana, Katakana, Bopomofo, HangulCompatibilityJamo, Reserved053, EnclosedCJKLettersAndMonths, CJKCompatibility)
            //l1 8-15
            SK_OT_BYTE_BITFIELD(
            ...
            //l2 24-31
            SK_OT_BYTE_BITFIELD(MusicalSymbols, MathematicalAlphanumericSymbols, PrivateUse, VariationSelectors, Tags, Reserved093, Reserved094, Reserved095)
            //l2 16-23
            SK_OT_BYTE_BITFIELD(Khmer, Mongolian, Braille, Yi, Tagalog_Hanunoo_Buhid_Tagbanwa, OldItalic, Gothic, Deseret)
            //l2 8-15
            SK_OT_BYTE_BITFIELD(Thaana, Sinhala, Myanmar, Ethiopic, Cherokee, UnifiedCanadianSyllabics, Ogham, Runic)
            //l2 0-7
            SK_OT_BYTE_BITFIELD(
    ...
    union CodePageRange {
        struct Field {
            ...
            //l0 8-15
            SK_OT_BYTE_BITFIELD(Vietnamese, Reserved09, Reserved10, Reserved11, Reserved12, Reserved13, Reserved14, Reserved15)
            //l0 0-7
