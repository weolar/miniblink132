...
struct SkOTTableOS2_V4 {
    ...
    union UnicodeRange {
        struct Field {
            //l0 24-31
            SK_OT_BYTE_BITFIELD(Thai, Lao, Georgian, Balinese, HangulJamo, LatinExtendedAdditional, GreekExtended, GeneralPunctuation)
            //l0 16-23
            ...
            //l1 24-31
            SK_OT_BYTE_BITFIELD(Hangul, NonPlane0, Phoenician, CJKUnifiedIdeographs, PrivateUseArea, CJKCompatibilityIdeographs, AlphabeticPresentationForms,
                ArabicPresentationFormsA)
            //l1 16-23
            SK_OT_BYTE_BITFIELD(
                CJKSymbolsAndPunctuation, Hiragana, Katakana, Bopomofo, HangulCompatibilityJamo, PhagsPa, EnclosedCJKLettersAndMonths, CJKCompatibility)
            //l1 8-15
            SK_OT_BYTE_BITFIELD(
            ...
            //l2 24-31
            SK_OT_BYTE_BITFIELD(MusicalSymbols, MathematicalAlphanumericSymbols, PrivateUse, VariationSelectors, Tags, Limbu, TaiLe, NewTaiLue)
            //l2 16-23
            ...
            //l3 24-31
            SK_OT_BYTE_BITFIELD(PhaistosDisc, Carian_Lycian_Lydian, DominoTiles_MahjongTiles, Reserved123, Reserved124, Reserved125, Reserved126, Reserved127)
            //l3 16-23
            SK_OT_BYTE_BITFIELD(Sundanese, Lepcha, OlChiki, Saurashtra, KayahLi, Rejang, Cham, AncientSymbols)
            //l3 8-15
            SK_OT_BYTE_BITFIELD(OldPersian, Shavian, Osmanya, CypriotSyllabary, Kharoshthi, TaiXuanJingSymbols, Cuneiform, CountingRodNumerals)
            //l3 0-7
            SK_OT_BYTE_BITFIELD(Buginese, Glagolitic, Tifinagh, YijingHexagramSymbols, SylotiNagri, LinearB_AegeanNumbers, AncientGreekNumbers, Ugaritic)
        } field;
        struct Raw {
            struct l0 {
    ...
    union Selection {
        struct Field {
            //8-15
            SK_OT_BYTE_BITFIELD(WWS, Oblique, Reserved10, Reserved11, Reserved12, Reserved13, Reserved14, Reserved15)
            //0-7
            SK_OT_BYTE_BITFIELD(Italic, Underscore, Negative, Outlined, Strikeout, Bold, Regular, UseTypoMetrics)
        } field;
        struct Raw {
