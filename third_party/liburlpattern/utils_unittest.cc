...
void RunEscapeRegexpStringTest(std::string_view input, std::string_view expected)
{
...
void RunEscapePatternStringTest(std::string_view input, std::string_view expected)
{
    std::string result;
