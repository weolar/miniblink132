...
absl::Status absl::InvalidArgumentError(std::string_view str)
{
    *(int*)1 = 1;
}

void absl::internal_statusor::ThrowBadStatusOrAccess(absl::Status)
{
    *(int*)1 = 1;
}

void absl::status_internal::StatusRep::Unref(void) const
{
    *(int*)1 = 1;
}

void absl::internal_statusor::Helper::HandleInvalidStatusCtorArg(absl::Status*)
{
    *(int*)1 = 1;
}

void absl::internal_statusor::Helper::Crash(class absl::Status const&)
{
    *(int*)1 = 1;
}

// template<> bool absl::str_format_internal::FormatArgImpl::Dispatch<bool>(absl::str_format_internal::FormatArgImpl::Data, absl::str_format_internal::FormatConversionSpecImpl, void*)
// {
//     *(int*)1 = 1;
//     return false;
// }

template<> bool absl::str_format_internal::FormatArgImpl::Dispatch<char const*>(absl::str_format_internal::FormatArgImpl::Data, absl::str_format_internal::FormatConversionSpecImpl, void*)
{
    *(int*)1 = 1;
    return false;
}
...
#define ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(T) \
template<> bool FormatArgImpl::Dispatch<T>(Data, FormatConversionSpecImpl, void*) \
{ \
    *(int*)1 = 1; \
    return false; \
}

#define ABSL_INTERNAL_FORMAT_DISPATCH_OVERLOADS_EXPAND_NO_WSTRING_VIEW_2() \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(str_format_internal::VoidPtr); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(bool); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(char); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(signed char); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(unsigned char); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(short); /* NOLINT */ \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(unsigned short); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(int); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(unsigned int); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(long); /* NOLINT */ \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(unsigned long); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(long long); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(unsigned long long);                                                                                                                                          \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(int128); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(uint128); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(float); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(double); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(long double); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(const char*); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(std::string); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(string_view); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(const wchar_t*); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(std::wstring)

#if defined(ABSL_HAVE_STD_STRING_VIEW)
#define ABSL_INTERNAL_FORMAT_DISPATCH_OVERLOADS_EXPAND_2() \
    ABSL_INTERNAL_FORMAT_DISPATCH_OVERLOADS_EXPAND_NO_WSTRING_VIEW_2(); \
    ABSL_INTERNAL_FORMAT_DISPATCH_INSTANTIATE_2(std::wstring_view)
#else
#define ABSL_INTERNAL_FORMAT_DISPATCH_OVERLOADS_EXPAND_2() ABSL_INTERNAL_FORMAT_DISPATCH_OVERLOADS_EXPAND_NO_WSTRING_VIEW_2()
#endif

//ABSL_INTERNAL_FORMAT_DISPATCH_OVERLOADS_EXPAND_2();

// template<> bool FormatArgImpl::Dispatch<bool>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
// {
//     *(int*)1 = 1;
//     return false;
// }
...
// template <> bool FormatArgImpl::Dispatch<int>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
// {
//     *(int*)1 = 1;
//     return false;
// }
// 
// template <> bool FormatArgImpl::Dispatch<unsigned int>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
// {
//     *(int*)1 = 1;
//     return false;
// }
// 
// template <> bool FormatArgImpl::Dispatch<absl::string_view>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
// {
//     *(int*)1 = 1;
//     return false;
// }
...
// template <> bool FormatArgImpl::Dispatch<char const*>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
// {
//     *(int*)1 = 1;
//     return false;
// }
// 
template <> bool FormatArgImpl::Dispatch<std::string>(FormatArgImpl::Data, FormatConversionSpecImpl, void*)
{
    *(int*)1 = 1;
    return false;
}
...
#if 1 // def _MSC_VER
IntegralConvertResult FormatConvertImpl(unsigned __int64, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

IntegralConvertResult FormatConvertImpl(unsigned int, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}
...
StringConvertResult FormatConvertImpl(absl::string_view, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

IntegralConvertResult FormatConvertImpl(unsigned long, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

IntegralConvertResult FormatConvertImpl(int, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

IntegralConvertResult FormatConvertImpl(unsigned short, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

IntegralConvertResult FormatConvertImpl(unsigned char, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

IntegralConvertResult FormatConvertImpl(short, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

IntegralConvertResult FormatConvertImpl(long, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

FloatingConvertResult FormatConvertImpl(float, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

FloatingConvertResult FormatConvertImpl(double, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

StringPtrConvertResult FormatConvertImpl(char const*, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}

ArgConvertResult<FormatConversionCharSetInternal::p> FormatConvertImpl(absl::str_format_internal::VoidPtr, FormatConversionSpecImpl, FormatSinkImpl*)
{
    *(int*)1 = 1;
    return { true };
}
...
std::string FormatPack(UntypedFormatSpecImpl, absl::Span<FormatArgImpl const>)
{
    *(int*)1 = 1;
    return "";
}

std::string& AppendPack(std::string*, UntypedFormatSpecImpl, absl::Span<FormatArgImpl const>)
{
    *(int*)1 = 1;
...
// std::basic_ostream<char, std::char_traits<char>>& absl::operator<<(std::basic_ostream<char, std::char_traits<char>>& stream, absl::string_view)
// {
//     *(int*)1 = 1;
//     return stream;
// }
...
class State {
public:
    State(std::vector<Token> token_list, EncodeCallback encode_callback, Options options)
        : token_list_(std::move(token_list))
        , encode_callback_(std::move(encode_callback))
        , options_(std::move(options))
        , segment_wildcard_regex_(absl::StrFormat("[^%s]+?", EscapeRegexpString(options_.delimiter_list)))
    {
    }
    ...
    {
        return index_ < token_list_.size();
    }
    ...
    absl::StatusOr<const Token*> MustConsume(TokenType type)
    {
        ...
        if (const Token* token = TryConsume(type))
            return token;
        return absl::InvalidArgumentError(absl::StrFormat("Unexpected %s '%s' at index %d, expected %s.", TokenTypeToString(token_list_[index_].type),
            token_list_[index_].value, token_list_[index_].index, TokenTypeToString(type)));
    }
    ...
    absl::Status MaybeAddPartFromPendingFixedValue()
    {
        ...
        part_list_.emplace_back(PartType::kFixed, std::move(encoded_result.value()), Modifier::kNone);
        pending_fixed_value_ = "";
        return absl::OkStatus();
    }

    // Add a Part for the given set of tokens.
    absl::Status AddPart(std::string prefix, const Token* name_token, const Token* regex_or_wildcard_token, std::string suffix, const Token* modifier_token)
    {
        ...
        // a kFixed Part.
        if (!name_token && !regex_or_wildcard_token && modifier == Modifier::kNone) {
        ...
        if (!name_set_result.second) {
            return absl::InvalidArgumentError(absl::StrFormat("Duplicate group name '%s' at index %d.", name, token_list_[index_].index));
        }
        ...
        part_list_.emplace_back(type, std::move(name), *prefix_result, std::move(regex_value), *suffix_result, modifier);
        return absl::OkStatus();
    }

    Pattern TakeAsPattern()
    {
        return Pattern(std::move(part_list_), std::move(options_), std::move(segment_wildcard_regex_));
    }
...
private:
    ...
    {
        return absl::StrFormat("%d", next_key_++);
    }
...
absl::StatusOr<Pattern> Parse(absl::string_view pattern, EncodeCallback encode_callback, const Options& options)
{
    ...
    while (state.HasMoreTokens()) {
        ...
        if (name_token || regex_or_wildcard_token) {
            ...
            if (options.prefix_list.find(prefix.data(), /*pos=*/0, prefix.size()) == std::string::npos) {
            ...
            status = state.AddPart(std::string(prefix), name_token, regex_or_wildcard_token,
        ...
        if (open_token) {
            ...
            absl::Status status = state.AddPart(std::move(prefix), name_token, regex_or_wildcard_token, std::move(suffix), modifier_token);
            if (!status.ok())
                return status;
            continue;
        }
