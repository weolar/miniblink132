...
typedef std::function<absl::StatusOr<std::string>(std::string_view)> EncodeCallback;
...
absl::StatusOr<Pattern> Parse(std::string_view pattern, EncodeCallback callback, const Options& options = Options());
