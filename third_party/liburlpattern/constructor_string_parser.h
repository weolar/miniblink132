...
public:
    ...
    using ProtocolCheckCallback = std::function<absl::StatusOr<bool>(std::string_view)>;
    ...
    const ComponentSet& GetPresentComponents()
    {
        return present_components_;
    }
...
private:
    ...
    void ChangeStateWithoutSettingComponent(StringParseState new_state, Skip skip);
