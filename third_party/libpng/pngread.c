...
PNG_FUNCTION(png_structp, PNGAPI png_create_read_struct, (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn, png_error_ptr warn_fn),
    PNG_ALLOCATED)
{
 ...
 * needed.
 */
PNG_FUNCTION(png_structp, PNGAPI png_create_read_struct_2,
...
#if defined(PNG_READ_EXPAND_SUPPORTED) && defined(PNG_ARM_NEON_IMPLEMENTATION)
...

    {
       ...
       */
        if ((format & PNG_FORMAT_FLAG_COLOR) != 0
            && ((png_ptr->colorspace.flags & (PNG_COLORSPACE_HAVE_ENDPOINTS | PNG_COLORSPACE_ENDPOINTS_MATCH_sRGB | PNG_COLORSPACE_INVALID))
...
static png_uint_32 png_colormap_compose(
    png_image_read_control* display, png_uint_32 foreground, int foreground_encoding, png_uint_32 alpha, png_uint_32 background, int encoding)
{
 ...
 * be 8-bit.
 */
static void png_create_colormap_entry(
    png_image_read_control* display, png_uint_32 ip, png_uint_32 red, png_uint_32 green, png_uint_32 blue, png_uint_32 alpha, int encoding)
{
    png_imagep image = display->image;
    int output_encoding = (image->format & PNG_FORMAT_FLAG_LINEAR) != 0 ? P_LINEAR : P_sRGB;
    int convert_to_Y = (image->format & PNG_FORMAT_FLAG_COLOR) == 0 && (red != green || green != blue);
    ...
    */
    ...
    if (encoding == P_LINEAR) {
        if (convert_to_Y != 0) {
            ...
            png_uint_32 y = (png_uint_32)6968 * red + (png_uint_32)23434 * green + (png_uint_32)2366 * blue;
    ...
    /* Store the value. */
    {
        ...
        int afirst = (image->format & PNG_FORMAT_FLAG_AFIRST) != 0 && (image->format & PNG_FORMAT_FLAG_ALPHA) != 0;
#else
#define afirst 0
#endif
    ...
    */
    ...
    case PNG_COLOR_TYPE_GRAY:
        ...
        else /* bit depth is 16 */
        {
            ...
            if (png_ptr->num_trans > 0) {
                ...
                if ((output_format & PNG_FORMAT_FLAG_ALPHA) != 0)
                    ...
                    if (back_r == back_g && back_g == back_b) {
                      ...
                      */
                         ...
                         * matches.
                         */
                            png_create_colormap_entry(display, gray, back_g, back_g, back_g, 65535, P_LINEAR);
                        }
                ...
                */
                png_create_colormap_entry(display, 254, back_r, back_g, back_b, back_alpha, output_encoding);
            }
    ...
    case PNG_COLOR_TYPE_GRAY_ALPHA:
        ...
        else /* alpha is removed */
        {
             ...
             */
            if ((output_format & PNG_FORMAT_FLAG_COLOR) == 0 || (back_r == back_g && back_g == back_b)) {
                ...
                for (a = 1; a < 5; ++a) {
                   ...
                   */
                    ...
                    for (g = 0; g < 6; ++g) {
                        ...
                        png_create_colormap_entry(display, i++, PNG_sRGB_FROM_LINEAR(gray + back_rx), PNG_sRGB_FROM_LINEAR(gray + back_gx),
    ...
    case PNG_COLOR_TYPE_RGB_ALPHA:
        ...
        if ((output_format & PNG_FORMAT_FLAG_COLOR) == 0) {
             ...
             */
            if ((png_ptr->color_type == PNG_COLOR_TYPE_RGB_ALPHA || png_ptr->num_trans > 0) && (output_format & PNG_FORMAT_FLAG_ALPHA) != 0) {
                ...
                */
                if ((png_ptr->color_type == PNG_COLOR_TYPE_RGB_ALPHA || png_ptr->num_trans > 0) && png_gamma_not_sRGB(png_ptr->colorspace.gamma) != 0) {
                   ...
                   */
                    if (data_encoding == P_FILE) /* from the fixup above */
                    {
                      ...
                      */
                        ...
                        /* And make sure the corresponding palette entry matches.
                      */
                        png_create_colormap_entry(display, gray, back_g, back_g, back_g, 0 /*unused*/, P_LINEAR);
                    }
            ...
            if (png_ptr->color_type == PNG_COLOR_TYPE_RGB_ALPHA || png_ptr->num_trans > 0) {
                ...
                */
                if ((output_format & PNG_FORMAT_FLAG_ALPHA) != 0) {
                   ...
                   * processing.
                   */
                    unsigned int sample_size = PNG_IMAGE_SAMPLE_SIZE(output_format);
                    ...
                    png_create_colormap_entry(display, cmap_entries, back_r, back_g, back_b, 0 /*unused*/, output_encoding);
                   ...
                   * index.
                   */
                    if (memcmp((png_const_bytep)display->colormap + sample_size * cmap_entries,
                            (png_const_bytep)display->colormap + sample_size * PNG_RGB_INDEX(r, g, b), sample_size)
                        != 0) {
                      ...
                      */
                        for (r = 0; r < 256; r = (r << 1) | 0x7f) {
                            ...
                            */
                                for (b = 0; b < 256; b = (b << 1) | 0x7f)
                                    png_create_colormap_entry(display, cmap_entries++, png_colormap_compose(display, r, P_sRGB, 128, back_r, output_encoding),
                                        png_colormap_compose(display, g, P_sRGB, 128, back_g, output_encoding),
                                        png_colormap_compose(display, b, P_sRGB, 128, back_b, output_encoding), 0 /*unused*/, output_encoding);
                            }
                        }
    ...
    case PNG_COLOR_TYPE_PALETTE:
          ...
          */
        {
            ...
            int do_background = trans != NULL && (output_format & PNG_FORMAT_FLAG_ALPHA) == 0;
            unsigned int i;
            ...
            for (i = 0; i < cmap_entries; ++i) {
                if (do_background != 0 && i < num_trans && trans[i] < 255) {
                    if (trans[i] == 0)
                      ...
                      */
                        png_create_colormap_entry(display, i, png_colormap_compose(display, colormap[i].red, P_FILE, trans[i], back_r, output_encoding),
                            png_colormap_compose(display, colormap[i].green, P_FILE, trans[i], back_g, output_encoding),
                            png_colormap_compose(display, colormap[i].blue, P_FILE, trans[i], back_b, output_encoding),
                    ...
                    png_create_colormap_entry(
                        display, i, colormap[i].red, colormap[i].green, colormap[i].blue, i < num_trans ? trans[i] : 255U, P_FILE /*8-bit*/);
            }
    ...
    */
    ...
    case PNG_CMAP_GA:
        /* Output must be two channels and the 'G' one must be sRGB, the latter
          ...
          */
        if (info_ptr->color_type == PNG_COLOR_TYPE_GRAY_ALPHA && info_ptr->bit_depth == 8 && png_ptr->screen_gamma == PNG_GAMMA_sRGB
    ...
    case PNG_CMAP_RGB:
        ...
        if (info_ptr->color_type == PNG_COLOR_TYPE_RGB && info_ptr->bit_depth == 8 && png_ptr->screen_gamma == PNG_GAMMA_sRGB && image->colormap_entries == 216)
            break;
    ...
    case PNG_CMAP_RGB_ALPHA:
        ...
        if (info_ptr->color_type == PNG_COLOR_TYPE_RGB_ALPHA && info_ptr->bit_depth == 8 && png_ptr->screen_gamma == PNG_GAMMA_sRGB
    ...
    */
                        ...
                        for (; outrow < end_row; outrow += stepx) {
                            ...
                            if (alpha > 0) /* else no change to the output */
                            {
                               ...
                               */
                                    ...
                                    component += png_sRGB_table[outrow[0]] * (255 - alpha);
                                    component = PNG_sRGB_FROM_LINEAR(component);
                                }
    ...
    case 16:
          ...
          */
        {
            ...
            unsigned int preserve_alpha = (image->format & PNG_FORMAT_FLAG_ALPHA) != 0;
...
static int png_image_read_direct(png_voidp argument)
{
    ...
    */
    ...
    {
        png_uint_32 base_format = png_image_format(png_ptr) & ~PNG_FORMAT_FLAG_COLORMAP /* removed by png_set_expand */;
       ...
       */
        {
            ...
            if ((base_format & PNG_FORMAT_FLAG_LINEAR) != 0 && (image->flags & PNG_IMAGE_FLAG_16BIT_sRGB) == 0)
       ...
       */
        if (do_local_background != 0) {
          ...
          * final value.
          */
            if (png_muldiv(&gtest, output_gamma, png_ptr->colorspace.gamma, PNG_FP_1) != 0 && png_gamma_significant(gtest) == 0)
    ...
    */
...

    {
        ...
        if ((png_ptr->transformations & PNG_SWAP_ALPHA) != 0
            || ((png_ptr->transformations & PNG_ADD_ALPHA) != 0 && (png_ptr->flags & PNG_FLAG_FILLER_AFTER) == 0)) {
            if (do_local_background == 2)
       ...
       */
        if (image->width <= 0x7fffffffU / channels) /* no overflow */
        {
          ...
          */
             ...
             */
                if (image->height <= 0xffffffffU / PNG_IMAGE_PIXEL_COMPONENT_SIZE(image->format) / check) {
                   ...
                   */
                        if ((image->format & PNG_FORMAT_FLAG_COLORMAP) != 0)
                            result
                                = png_safe_execute(image, png_image_read_colormap, &display) && png_safe_execute(image, png_image_read_colormapped, &display);
