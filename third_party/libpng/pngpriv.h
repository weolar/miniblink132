 ...
 */
#if defined(__SSE4_1__) || defined(__AVX__) || defined(__SSSE3__) || defined(__SSE2__) || defined(_M_X64) || defined(_M_AMD64)                                 \
...
#define PNG_INTERNAL_CALLBACK(type, name, args, attributes) PNG_LINKAGE_CALLBACK PNG_FUNCTION(type, (PNGCBAPI name), args, PNG_EMPTY attributes)
#endif
...
#ifdef png_alignof
#define png_isaligned(ptr, type) (((type)((const char*)ptr - (const char*)0) & (type)(png_alignof(type) - 1)) == 0)
#else
...
#define PNG_STRING_FROM_CHUNK(s, c)                                                                                                                            \
    (void)(((char*)(s))[0] = (char)(((c) >> 24) & 0xff), ((char*)(s))[1] = (char)(((c) >> 16) & 0xff), ((char*)(s))[2] = (char)(((c) >> 8) & 0xff),            \
...
#define PNG_sRGB_FROM_LINEAR(linear) ((png_byte)(0xff & ((png_sRGB_base[(linear) >> 15] + ((((linear)&0x7fff) * png_sRGB_delta[(linear) >> 15]) >> 12)) >> 8)))
...
PNG_INTERNAL_FUNCTION(
    png_voidp, png_realloc_array, (png_const_structrp png_ptr, png_const_voidp array, int old_elements, int add_elements, size_t element_size), PNG_ALLOCATED);
...
PNG_INTERNAL_FUNCTION(void, png_write_IHDR,
    (png_structrp png_ptr, png_uint_32 width, png_uint_32 height, int bit_depth, int color_type, int compression_method, int filter_method,
...
PNG_INTERNAL_FUNCTION(void, png_write_iTXt,
    (png_structrp png_ptr, int compression, png_const_charp key, png_const_charp lang, png_const_charp lang_key, png_const_charp text), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_write_pCAL,
    (png_structrp png_ptr, png_charp purpose, png_int_32 X0, png_int_32 X1, int type, int nparams, png_const_charp units, png_charpp params), PNG_EMPTY);
#endif
 ...
 */
PNG_INTERNAL_FUNCTION(
    int, png_colorspace_set_chromaticities, (png_const_structrp png_ptr, png_colorspacerp colorspace, const png_xy* xy, int preferred), PNG_EMPTY);

PNG_INTERNAL_FUNCTION(
    int, png_colorspace_set_endpoints, (png_const_structrp png_ptr, png_colorspacerp colorspace, const png_XYZ* XYZ, int preferred), PNG_EMPTY);
...
PNG_INTERNAL_FUNCTION(int, png_colorspace_set_ICC,
...
#ifdef PNG_READ_iCCP_SUPPORTED
PNG_INTERNAL_FUNCTION(
    int, png_icc_check_length, (png_const_structrp png_ptr, png_colorspacerp colorspace, png_const_charp name, png_uint_32 profile_length), PNG_EMPTY);
#endif /* READ_iCCP */
...
PNG_INTERNAL_FUNCTION(void, png_check_IHDR,
    (png_const_structrp png_ptr, png_uint_32 width, png_uint_32 height, int bit_depth, int color_type, int interlace_type, int compression_type,
        int filter_type),
    PNG_EMPTY);
...
PNG_INTERNAL_FUNCTION(
    png_fixed_point, png_muldiv_warn, (png_const_structrp png_ptr, png_fixed_point a, png_int_32 multiplied_by, png_int_32 divided_by), PNG_EMPTY);
#endif
...
#if PNG_MIPS_MSA_OPT > 0
PNG_INTERNAL_FUNCTION(void, png_init_filter_functions_msa, (png_structp png_ptr, unsigned int bpp), PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_riffle_palette_neon, (png_structrp), PNG_EMPTY);
PNG_INTERNAL_FUNCTION(int, png_do_expand_palette_rgba8_neon, (png_structrp, png_row_infop, png_const_bytep, const png_bytepp, const png_bytepp), PNG_EMPTY);
PNG_INTERNAL_FUNCTION(int, png_do_expand_palette_rgb8_neon, (png_structrp, png_row_infop, png_const_bytep, const png_bytepp, const png_bytepp), PNG_EMPTY);
#endif
