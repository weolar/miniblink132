...
#define SH(val, pdst)                                                                                                                                          \
    {                                                                                                                                                          \
        ...
        uint16_t val_m = (val);                                                                                                                                \
                                                                                                                                                               \
        asm volatile("sh  %[val_m],  %[pdst_sh_m]  \n\t"                                                                                                       \
                                                                                                                                                               \
...
#define SH(val, pdst)                                                                                                                                          \
    {                                                                                                                                                          \
        ...
        uint16_t val_m = (val);                                                                                                                                \
                                                                                                                                                               \
        asm volatile("ush  %[val_m],  %[pdst_sh_m]  \n\t"                                                                                                      \
                                                                                                                                                               \
                     : [pdst_sh_m] "=m"(*pdst_sh_m)                                                                                                            \
                     : [val_m] "r"(val_m));                                                                                                                    \
    }
...
#define ADD3(in0, in1, in2, in3, in4, in5, out0, out1, out2)                                                                                                   \
    {                                                                                                                                                          \
...
void png_read_filter_row_up_msa(png_row_infop row_info, png_bytep row, png_const_bytep prev_row)
{
    ...
    for (i = 0; i < (istop >> 6); i++) {
        ...
        ADD4(src0, src4, src1, src5, src2, src6, src3, src7, src0, src1, src2, src3);
