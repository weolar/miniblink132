...
const static std::vector<std::tuple<const std::string, const std::string, const std::string>> SCALE_IMAGE_MD5
    = { std::make_tuple("2/1", "testout_420m_islow_2_1.ppm", "9f9de8c0612f8d06869b960b05abf9c9"),
          std::make_tuple("15/8", "testout_420m_islow_15_8.ppm", "b6875bc070720b899566cc06459b63b7"),
          std::make_tuple("13/8", "testout_420m_islow_13_8.ppm", "bc3452573c8152f6ae552939ee19f82f"),
          std::make_tuple("11/8", "testout_420m_islow_11_8.ppm", "d8cc73c0aaacd4556569b59437ba00a5"),
          std::make_tuple("9/8", "testout_420m_islow_9_8.ppm", "d25e61bc7eac0002f5b393aa223747b6"),
          std::make_tuple("7/8", "testout_420m_islow_7_8.ppm", "ddb564b7c74a09494016d6cd7502a946"),
          std::make_tuple("3/4", "testout_420m_islow_3_4.ppm", "8ed8e68808c3fbc4ea764fc9d2968646"),
          std::make_tuple("5/8", "testout_420m_islow_5_8.ppm", "a3363274999da2366a024efae6d16c9b"),
          std::make_tuple("1/2", "testout_420m_islow_1_2.ppm", "e692a315cea26b988c8e8b29a5dbcd81"),
          std::make_tuple("3/8", "testout_420m_islow_3_8.ppm", "79eca9175652ced755155c90e785a996"),
          std::make_tuple("1/4", "testout_420m_islow_1_4.ppm", "79cd778f8bf1a117690052cacdd54eca"),
          std::make_tuple("1/8", "testout_420m_islow_1_8.ppm", "391b3d4aca640c8567d6f8745eb2142f") };

class DJPEGTestScalingDCT : public ::testing::TestWithParam<std::tuple<const std::string, const std::string, const std::string>> { };
...
TEST_P(DJPEGTestScalingDCT, Test)
{
    ...
    char* command_line[] = { &prog_name[0], &arg1[0], &arg2[0], &arg3[0], &arg4[0], &arg5[0], &arg6[0], &arg7[0], &arg8[0], &arg9[0] };
...
INSTANTIATE_TEST_SUITE_P(TestScalingDCT, DJPEGTestScalingDCT, ::testing::ValuesIn(SCALE_IMAGE_MD5));
...
TEST(DJPEGTest, ISlow420256)
{
    ...
    char* command_line[] = { &prog_name[0], &arg1[0], &arg2[0], &arg3[0], &arg4[0], &arg5[0], &arg6[0], &arg7[0], &arg8[0] };
    // Generate test image file.
...
TEST(DJPEGTest, ISlow420565D)
{
    ...
    char* command_line[] = { &prog_name[0], &arg1[0], &arg2[0], &arg3[0], &arg4[0], &arg5[0], &arg6[0], &arg7[0] };
    // Generate test image file.
...
TEST(DJPEGTest, ISlow420AriSkip16139)
{
    ...
    base::FilePath output_path(GetTargetDirectory());
    output_path = output_path.AppendASCII("testout_420_islow_ari_skip16_139.ppm");
...
TEST(DJPEGTest, ISlow420AriCrop53x5344)
{
    ...
    GetTestFilePath(&input_image_path, "testimgari.jpg");
    base::FilePath output_path(GetTargetDirectory());
    output_path = output_path.AppendASCII("testout_420_islow_ari_crop53x53_4_4.ppm");
...
TEST(DJPEGTest, IFast420MAri)
{
    ...
    char* command_line[] = { &prog_name[0], &arg1[0], &arg2[0], &arg3[0], &arg4[0], &arg5[0] };
    // Generate test image file.
...
TEST(DJPEGTest, ISlow444AriCrop37x3700)
{
    ...
    base::FilePath output_path(GetTargetDirectory());
    output_path = output_path.AppendASCII("testout_444_islow_ari_crop37x37_0_0.ppm");
...
TEST(DJPEGTest, IFast422M)
{
    ...
    char* command_line[] = { &prog_name[0], &arg1[0], &arg2[0], &arg3[0], &arg4[0], &arg5[0], &arg6[0] };
    // Generate test image file.
...
TEST(DJPEGTest, ISlowProgCrop62x627171)
{
    ...
    base::FilePath output_path(GetTargetDirectory());
    output_path = output_path.AppendASCII("testout_420_islow_prog_crop62x62_71_71.ppm");
...
TEST(DJPEGTest, ISlowProg444Crop98x981313)
{
    ...
    base::FilePath output_path(GetTargetDirectory());
    output_path = output_path.AppendASCII("testout_444_islow_prog_crop98x98_13_13.ppm");
