...
void jsimd_encode_mcu_AC_first_prepare_neon(const JCOEF* block, const int* jpeg_natural_order_start, int Sl, int Al, JCOEF* values, size_t* zerobits)
{
   ...
   */
    ...
    const uint8x8_t bitmap_mask = vreinterpret_u8_u64(vmov_n_u64(0x8040201008040201));
...
int jsimd_encode_mcu_AC_refine_prepare_neon(const JCOEF* block, const int* jpeg_natural_order_start, int Sl, int Al, JCOEF* absvalues, size_t* bits)
{
   ...
   */
    ...
    for (i = 0; i < Sl / 16; i++) {
        ...
        uint8x8_t sign_coefs1 = vmovn_u16(vreinterpretq_u16_s16(vshrq_n_s16(coefs1, 15)));
        uint8x8_t sign_coefs2 = vmovn_u16(vreinterpretq_u16_s16(vshrq_n_s16(coefs2, 15)));
     ...
     */
        ...
        /* Compute and store data for signbits bitmap. */
        uint8x8_t sign_coefs = vmovn_u16(vreinterpretq_u16_s16(vshrq_n_s16(coefs, 15)));
