...
INLINE
LOCAL(void)
rgb_to_cmyk(JSAMPLE r, JSAMPLE g, JSAMPLE b, JSAMPLE* c, JSAMPLE* m, JSAMPLE* y, JSAMPLE* k)
{
...
INLINE
LOCAL(void)
cmyk_to_rgb(JSAMPLE c, JSAMPLE m, JSAMPLE y, JSAMPLE k, JSAMPLE* r, JSAMPLE* g, JSAMPLE* b)
{
