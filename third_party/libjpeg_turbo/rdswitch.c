...
GLOBAL(jpg_boolean)
read_quant_tables(j_compress_ptr cinfo, char* filename, jpg_boolean force_baseline)
...
#else
        jpeg_add_quant_table(cinfo, tblno, table, q_scale_factor[tblno], force_baseline);
#endif
        tblno++;
    }
...
{
    jpeg_add_quant_table(cinfo, 0, std_luminance_quant_tbl, q_scale_factor[0], force_baseline);
    jpeg_add_quant_table(cinfo, 1, std_chrominance_quant_tbl, q_scale_factor[1], force_baseline);
}
#endif

GLOBAL(jpg_boolean)
set_quality_ratings(j_compress_ptr cinfo, char* arg, jpg_boolean force_baseline)
