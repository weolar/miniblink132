...
jpeg_CreateDecompress(j_decompress_ptr cinfo, int version, size_t structsize)
{
   ...
   * here.
   */
    cinfo->master = (struct jpeg_decomp_master*)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_PERMANENT, sizeof(my_decomp_master));
...
GLOBAL(int)
jpeg_read_header(j_decompress_ptr cinfo, jpg_boolean require_image)
{
    int retcode;
