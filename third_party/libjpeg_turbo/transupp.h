...
typedef enum { JCROP_UNSET, JCROP_POS, JCROP_NEG, JCROP_FORCE, JCROP_REFLECT } JCROP_CODE;
...
typedef struct {
    ...
    jpg_boolean perfect; /* if TRUE, fail if partial MCUs are requested */
    jpg_boolean trim; /* if TRUE, trim partial MCUs as needed */
    jpg_boolean force_grayscale; /* if TRUE, convert color image to grayscale */
    jpg_boolean crop; /* if TRUE, crop or wipe source image, or drop */
    jpg_boolean slow_hflip; /* For best performance, the JXFORM_FLIP_H transform
...
EXTERN(jpg_boolean) jtransform_parse_crop_spec(jpeg_transform_info* info, const char* spec);
/* Request any required workspace */
EXTERN(jpg_boolean) jtransform_request_workspace(j_decompress_ptr srcinfo, jpeg_transform_info* info);
 ...
 */
EXTERN(jpg_boolean) jtransform_perfect_transform(JDIMENSION image_width, JDIMENSION image_height, int MCU_width, int MCU_height, JXFORM_CODE transform);
