...
public:
    ...
    void setMBView(mbWebView mbView)
    {
        m_mbView = mbView;
    }
...
private:
    ...
    static mbWebView MB_CALL_TYPE onCreateView(
        mbWebView parentWebviwe, void* param, mbNavigationType navType, const utf8* url, const mbWindowFeatures* features);
    static void MB_CALL_TYPE onDocumentReady(mbWebView webView, void* param, mbWebFrameHandle frameId);
    static void MB_CALL_TYPE onLoadingFinish(
    ...
    HWND m_backHwnd = nullptr;
    HWND m_forwardHwnd = nullptr;
    HWND m_reloadHwnd = nullptr;
    HWND m_stopHwnd = nullptr;
    HWND m_testHwnd = nullptr;
    HWND m_editHwnd = nullptr;
    HBRUSH m_hbrush = nullptr;

    HMENU m_hMenu = nullptr;
    HideWndHelp* m_hideWndHelp = nullptr;
};
