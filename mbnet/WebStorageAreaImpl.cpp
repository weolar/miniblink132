...
void WebStorageAreaImpl::setItemImpl(
    const blink::WebString& key, const blink::WebString& value, const blink::WebURL& pageUrl, blink::WebStorageArea::Result& result, bool isFromLoad)
{
...
void WebStorageAreaImpl::setItem(
    const blink::WebString& key, const blink::WebString& value, const blink::WebURL& pageUrl, blink::WebStorageArea::Result& result)
{
...
void WebStorageAreaImpl::dispatchStorageEvent(const String& key, const String& oldValue, const String& newValue, const blink::WebURL& pageUrl)
{
    ...
    if (m_isLocal) {
        blink::WebStorageEventDispatcher::dispatchLocalStorageEvent(
            key, oldValue, newValue, blink::KURL(blink::ParsedURLString, m_origin), pageUrl, nullptr, true);
    } else {
        blink::WebStorageEventDispatcher::dispatchSessionStorageEvent(
            key, oldValue, newValue, blink::KURL(blink::ParsedURLString, m_origin), pageUrl, *m_storageNamespace, nullptr, true);
    }
}
