...
static inline HINTERNET createInternetHandle(const blink::WebString& userAgent, bool asynchronous)
{
    ...
    HINTERNET internetHandle = InternetOpenW(
        (LPCWSTR)userAgentString.charactersWithNullTermination().data(), INTERNET_OPEN_TYPE_PRECONFIG, 0, 0, asynchronous ? INTERNET_FLAG_ASYNC : 0);
...
void WebURLLoaderWinINet::internetStatusCallback(
    HINTERNET internetHandle, DWORD_PTR context, DWORD internetStatus, LPVOID statusInformation, DWORD statusInformationLength)
{
...
public:
    ...
    const Vector<char>& getBuffer()
    {
        ...
        if (0 && m_debugTest) {
            ...
            appendCharToVector(m_buffer,
                "Cookie: xmuuid=XMGUEST-FC6BCE40-1587-11E5-9022-0B280AD5AED4; "
                "_newdevuuid="
                "s1DeZNMiYmxqQrVycDEzIWzF6RBj3RV508lG0RVCsUloulkN0LSna5AaIYA9ZpQCcrP78bV3eisBam9mH2oyqMYIDuvwyp0cKfsbR7iumcfZExrCNo945PecPxbXz4r605K18k5c4IaLzm"
                "Fgp2ot7b66B4wR9hbXT8IjaJ6yzkA2zUlhQ1v9tpGwoewiRMbWCzYDgoUI; _mmsid=1464599910378.2537; mstz=||1375463365.1|||; mstuid=1434610951973_2745; "
                "xm_vistor=1434610951973_2745_1464599910410-1464599910410; Hm_lvt_4982d57ea12df95a2b24715fb6440726=1464599910; "
                "Hm_lpvt_4982d57ea12df95a2b24715fb6440726=1464599910; MAEInstance=0e526c69015e323a49aa55ed7c91f0a7bdf1d210de13ca58f9f3f48ffb6cfabd\r\n");
...
bool testHttpDownload(KURL url, Vector<char>& buffer)
{
    ...
    HINTERNET httpFile;
    httpFile = HttpOpenRequestW(
        hConnect, L"GET", L"0072811/web_oa/opendoc.xml", HTTP_VERSION, NULL, 0, INTERNET_FLAG_NO_UI | INTERNET_FLAG_DONT_CACHE | INTERNET_FLAG_RELOAD, 1);
    if (httpFile == NULL) {
...
void WebURLLoaderWinINet::loadSynchronously(
    const blink::WebURLRequest& request, blink::WebURLResponse& response, blink::WebURLError& error, blink::WebData& data)
{
    Vector<char> buffer;
...
bool WebURLLoaderWinINet::start(const blink::WebURLRequest& request, blink::WebURLLoaderClient* client, bool asynchronously)
{
    ...
    DWORD flags = INTERNET_FLAG_KEEP_CONNECTION
        ...
        | INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTPS | INTERNET_FLAG_IGNORE_REDIRECT_TO_HTTP | INTERNET_FLAG_DONT_CACHE | INTERNET_FLAG_RELOAD;
    ...
    m_requestHandle = HttpOpenRequestW(m_connectHandle, (LPCWSTR)httpMethod.data(), (LPCWSTR)WTF::ensureUTF16UChar(urlStr, true).data(), 0,
        (LPCWSTR)httpReferrer.data(), httpAccept, flags, reinterpret_cast<DWORD_PTR>(this));
...
void WebURLLoaderWinINet::didChangePriority(blink::WebURLRequest::Priority new_priority, int intra_priority_value)
{
}

bool WebURLLoaderWinINet::attachThreadedDataReceiver(blink::WebThreadedDataReceiver* threaded_data_receiver)
{
    DebugBreak();
    return false;
}
