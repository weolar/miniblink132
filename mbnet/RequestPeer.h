...
public:
    ...
    virtual void OnCompletedRequest(
        int errorCode, bool wasIgnoredByHandler, bool staleCopyInCache, const std::string& securityInfo, const double& completionTime, int64 totalTransferSize)
        = 0;
    ...
    // function.
    virtual void OnReceivedCompletedResponse(const ResourceResponseInfo& info, PassOwnPtr<ReceivedData> data, int errorCode, bool wasIgnoredByHandler,
        bool staleCopyInCache, const std::string& securityInfo, const double& completionTime, int64 totalTransferSize)
        = 0;
