...
std::string CanonPathWithString(const blink::KURL& url, const std::string& path_string)
{
...
CanonicalCookie::CanonicalCookie(const blink::KURL& url, const std::string& name, const std::string& value, const std::string& domain, const std::string& path,
...
// static
CanonicalCookie::CookiePrefix CanonicalCookie::GetCookiePrefix(const std::string& name)
{
...
//
// static
bool CanonicalCookie::IsCookiePrefixValid(CanonicalCookie::CookiePrefix prefix, const blink::KURL& url, const ParsedCookie& parsed_cookie)
{
