...
bool StructTraits<mojo_base::mojom::ReadOnlyBufferDataView, base::span<const uint8_t>>::Read(
    mojo_base::mojom::ReadOnlyBufferDataView input, base::span<const uint8_t>* out)
{
