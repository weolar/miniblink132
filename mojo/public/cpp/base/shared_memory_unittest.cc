...
TEST(SharedMemoryMojomTest, ReadOnly)
{
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojo_base::mojom::ReadOnlySharedMemoryRegion>(region.region, read_only_out));
...
TEST(SharedMemoryMojomTest, Writable)
{
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojo_base::mojom::WritableSharedMemoryRegion>(region, writable_out));
...
TEST(SharedMemoryMojomTest, Unsafe)
{
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<mojo_base::mojom::UnsafeSharedMemoryRegion>(region, unsafe_out));
