...
bool StructTraits<mojo_base::mojom::DictionaryValueDataView, base::Value::Dict>::Read(mojo_base::mojom::DictionaryValueDataView data, base::Value::Dict* out)
{
...
bool StructTraits<mojo_base::mojom::ListValueDataView, base::Value::List>::Read(mojo_base::mojom::ListValueDataView data, base::Value::List* out)
{
...
bool StructTraits<mojo_base::mojom::DeprecatedDictionaryValueDataView, base::Value>::Read(
    mojo_base::mojom::DeprecatedDictionaryValueDataView data, base::Value* value_out)
{
    mojo::MapDataView<mojo::StringDataView, mojo_base::mojom::ValueDataView> view;
    data.GetStorageDataView(&view);
...
bool UnionTraits<mojo_base::mojom::ValueDataView, base::Value>::Read(mojo_base::mojom::ValueDataView data, base::Value* value_out)
{
    switch (data.tag()) {
    ...
    case mojo_base::mojom::ValueDataView::Tag::kBinaryValue: {
        ...
        const char* data_pointer = reinterpret_cast<const char*>(binary_data_view.data());
        base::Value::BlobStorage blob_storage(data_pointer, data_pointer + binary_data_view.size());
