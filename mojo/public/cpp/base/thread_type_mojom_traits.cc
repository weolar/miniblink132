...
// static
mojo_base::mojom::ThreadType EnumTraits<mojo_base::mojom::ThreadType, base::ThreadType>::ToMojom(base::ThreadType thread_type)
{
    switch (thread_type) {
...
// static
bool EnumTraits<mojo_base::mojom::ThreadType, base::ThreadType>::FromMojom(mojo_base::mojom::ThreadType input, base::ThreadType* out)
{
    switch (input) {
