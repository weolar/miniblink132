...
template <> struct COMPONENT_EXPORT(MOJO_BASE_TRAITS) StructTraits<mojo_base::mojom::RefCountedMemoryDataView, scoped_refptr<base::RefCountedMemory>> {
    static mojo_base::BigBuffer data(const scoped_refptr<base::RefCountedMemory>& in);
    ...
    static bool Read(mojo_base::mojom::RefCountedMemoryDataView data, scoped_refptr<base::RefCountedMemory>* out);
};
