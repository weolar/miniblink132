...
template <typename InputType, typename DataType> size_t SerializeStruct(InputType& input, mojo::Message* message, DataType** out_data)
{
...
template <typename InputType, typename DataType> size_t SerializeUnion(InputType& input, mojo::Message* message, DataType** out_data = nullptr)
{
    using StructType = typename InputType::Struct;
    using DataViewType = typename StructType::DataView;
    *message = mojo::Message(0, 0, 0, 0, nullptr);
...
size_t SerializeArray(InputType& input, bool nullable_elements, mojo::Message* message, typename DataViewType::Data_** out_data)
{
    *message = mojo::Message(0, 0, 0, 0, nullptr);
    const size_t payload_start = message->payload_buffer()->cursor();

    mojo::internal::MessageFragment<typename DataViewType::Data_> fragment(*message);
    mojo::internal::ContainerValidateParams validate_params(0, nullable_elements, nullptr);
...
TEST(UnionTest, PodValidation)
{
    ...
    mojo::internal::ValidationContext validation_context(data, static_cast<uint32_t>(size), 0, 0);
    EXPECT_TRUE(internal::PodUnion_Data::Validate(data, &validation_context, false));
}
...
TEST(UnionTest, SerializeIsNullInlined)
{
    ...
    PodUnionPtr pod2;
    mojo::internal::Deserialize<PodUnionDataView>(fragment.data(), &pod2, nullptr);
...
TEST(UnionTest, NullValidation)
{
    ...
    EXPECT_TRUE(internal::PodUnion_Data::Validate(buf, &validation_context, false));
}
...
TEST(UnionTest, OOBValidation)
{
    ...
    mojo::internal::MessageFragment<internal::PodUnion_Data> fragment(message);
    fragment.Allocate();
    mojo::internal::ValidationContext validation_context(fragment.data(), static_cast<uint32_t>(size), 0, 0);
    EXPECT_FALSE(internal::PodUnion_Data::Validate(fragment.data(), &validation_context, false));
}
...
TEST(UnionTest, UnknownEnumValueValidation)
{
    ...
    mojo::internal::ValidationContext validation_context(data, static_cast<uint32_t>(size), 0, 0);
    EXPECT_FALSE(internal::PodUnion_Data::Validate(data, &validation_context, false));
}

TEST(UnionTest, UnknownExtensibleEnumValueValidation)
{
    PodUnionPtr pod(PodUnion::NewFExtensibleEnum(static_cast<AnExtensibleEnum>(0xFFFF)));
...
TEST(UnionTest, NullStringValidation)
{
    ...
    mojo::internal::ValidationContext validation_context(fragment.data(), static_cast<uint32_t>(size), 0, 0);
    EXPECT_FALSE(internal::ObjectUnion_Data::Validate(buffer.data(), &validation_context, false));
}
...
TEST(UnionTest, StringValidateOOB)
{
    ...
    mojo::internal::ArrayHeader* array_header = reinterpret_cast<mojo::internal::ArrayHeader*>(ptr + *ptr);
    array_header->num_bytes = 20; // This should go out of bounds.
    array_header->num_elements = 20;
    mojo::internal::ValidationContext validation_context(fragment.data(), 32, 0, 0);
    EXPECT_FALSE(internal::ObjectUnion_Data::Validate(buffer.data(), &validation_context, false));
}
...
TEST(UnionTest, PodUnionInArraySerialization)
{
    ...
    EXPECT_EQ(40U, SerializeArray<ArrayDataView<PodUnionDataView>>(array, false, &message, &data));

    std::vector<PodUnionPtr> array2;
    mojo::internal::Deserialize<ArrayDataView<PodUnionDataView>>(data, &array2, nullptr);
...
TEST(UnionTest, PodUnionInArraySerializationWithNull)
{
    ...
    mojo::Message message;
    mojo::internal::Array_Data<internal::PodUnion_Data>* data;
    EXPECT_EQ(40U, SerializeArray<ArrayDataView<PodUnionDataView>>(array, true, &message, &data));
...
TEST(UnionTest, ObjectUnionInArraySerialization)
{
    ...
    const size_t size = SerializeArray<ArrayDataView<ObjectUnionDataView>>(array, false, &message, &data);
    EXPECT_EQ(72U, size);
    ...
    data = reinterpret_cast<mojo::internal::Array_Data<internal::ObjectUnion_Data>*>(new_buf.data());
    mojo::internal::ValidationContext validation_context(data, static_cast<uint32_t>(size), 0, 0);
    mojo::internal::ContainerValidateParams validate_params(0, false, nullptr);
    ASSERT_TRUE(mojo::internal::Array_Data<internal::ObjectUnion_Data>::Validate(data, &validation_context, &validate_params));

    std::vector<ObjectUnionPtr> array2;
    mojo::internal::Deserialize<ArrayDataView<ObjectUnionDataView>>(data, &array2, nullptr);
...
TEST(UnionTest, Serialization_UnionOfPods)
{
    ...
    mojo::internal::Deserialize<SmallStructDataView>(data, &deserialized, &message);
...
TEST(UnionTest, Serialization_UnionOfObjects)
{
    ...
    mojo::internal::Deserialize<SmallObjStructDataView>(data, &deserialized, nullptr);
...
{
    SmallStructNonNullableUnionPtr small_struct(SmallStructNonNullableUnion::New());

    constexpr size_t size = sizeof(internal::SmallStructNonNullableUnion_Data);
    Message message(0, 0, 0, 0, nullptr);
    mojo::internal::MessageFragment<internal::SmallStructNonNullableUnion_Data> fragment(message);
    fragment.Allocate();
    mojo::internal::ValidationContext validation_context(fragment.data(), static_cast<uint32_t>(size), 0, 0);
    EXPECT_FALSE(internal::SmallStructNonNullableUnion_Data::Validate(fragment.data(), &validation_context));
}
...
TEST(UnionTest, StructInUnionValidation)
{
    ...
    mojo::internal::ValidationContext validation_context(data, static_cast<uint32_t>(size), 0, 0);
    EXPECT_TRUE(internal::ObjectUnion_Data::Validate(data, &validation_context, false));
}
...
TEST(UnionTest, StructInUnionValidationNonNullable)
{
    ...
    mojo::internal::ValidationContext validation_context(data, static_cast<uint32_t>(size), 0, 0);
    EXPECT_FALSE(internal::ObjectUnion_Data::Validate(data, &validation_context, false));
}
...
TEST(UnionTest, HandleInUnionValidation)
{
    ...
    mojo::internal::ValidationContext validation_context(data, static_cast<uint32_t>(size), 1, 0);
    EXPECT_TRUE(internal::HandleUnion_Data::Validate(data, &validation_context, false));
}
...
TEST(UnionTest, HandleInUnionValidationNull)
{
    ...
    mojo::internal::ValidationContext validation_context(data, static_cast<uint32_t>(size), 1, 0);
    EXPECT_FALSE(internal::HandleUnion_Data::Validate(data, &validation_context, false));
}
...
TEST(UnionTest, UnionInInterface)
{
    ...
    remote->Echo(std::move(pod), base::BindOnce([](PodUnionPtr out) { EXPECT_EQ(16, out->get_f_int16()); }));
...
class ExtensibleTestUnionExchange : public mojom::ExtensibleTestUnionExchangeV1 {
public:
    explicit ExtensibleTestUnionExchange(PendingReceiver<mojom::ExtensibleTestUnionExchangeV2> receiver)
    {
        ...
        receiver_.Bind(PendingReceiver<mojom::ExtensibleTestUnionExchangeV1>(receiver.PassPipe()));
    }

    // mojom::ExtensibleTestUnionExchangeV1:
    void ExchangeWithBoolDefault(mojom::ExtensibleTestUnionV1WithBoolDefaultPtr u, ExchangeWithBoolDefaultCallback callback) override
    {
        std::move(callback).Run(std::move(u));
    }
    void ExchangeWithIntDefault(mojom::ExtensibleTestUnionV1WithIntDefaultPtr u, ExchangeWithIntDefaultCallback callback) override
    {
        std::move(callback).Run(std::move(u));
    }
    void ExchangeWithNullableDefault(mojom::ExtensibleTestUnionV1WithNullableDefaultPtr u, ExchangeWithNullableDefaultCallback callback) override
    {
        std::move(callback).Run(std::move(u));
    }
...
TEST(UnionTest, ExtensibleUnion)
{
...

    {
        ...
        remote->ExchangeWithNullableDefault(mojom::TestUnionV2::NewBlob({}), &result);
        ASSERT_TRUE(result);
