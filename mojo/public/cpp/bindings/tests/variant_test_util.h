...
template <typename Interface0, typename Interface1> PendingReceiver<Interface0> ConvertPendingReceiver(PendingReceiver<Interface1> receiver)
{
    static_assert(std::is_base_of<typename Interface0::Base_, Interface1>::value, "Interface types are not variants of the same mojom interface");
