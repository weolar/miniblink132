...
std::vector<absl::optional<std::vector<ScopedHandle>>> CreateTestNestedHandleArray()
{
...
protected:
    template <typename T> void TestWarning(T obj, mojo::internal::ValidationError expected_warning)
    {
        ...
        mojo::internal::MessageFragment<typename mojo::internal::MojomTypeTraits<MojomType>::Data> fragment(message);
        mojo::internal::Serialize<MojomType>(obj, fragment);
        EXPECT_EQ(expected_warning, warning_observer_.last_warning());
    }

    template <typename MojomType, typename T>
    void TestArrayWarning(T obj, mojo::internal::ValidationError expected_warning, const ContainerValidateParams* validate_params)
    {
        warning_observer_.set_last_warning(mojo::internal::VALIDATION_ERROR_NONE);
...
TEST_F(SerializationWarningTest, HandleInStruct)
{
    ...
    TestWarning(std::move(test_struct), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE);
...
TEST_F(SerializationWarningTest, StructInStruct)
{
    ...
    TestWarning(std::move(test_struct), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER);
...
TEST_F(SerializationWarningTest, FixedArrayOfStructsInStruct)
{
    ...
    TestWarning(std::move(test_struct), mojo::internal::VALIDATION_ERROR_UNEXPECTED_ARRAY_HEADER);
...
TEST_F(SerializationWarningTest, ArrayOfArraysOfHandles)
{
    ...
    ContainerValidateParams validate_params_0(0, true, new ContainerValidateParams(0, true, nullptr));
    TestArrayWarning<MojomType>(std::move(test_array), mojo::internal::VALIDATION_ERROR_NONE, &validate_params_0);

    test_array = CreateTestNestedHandleArray();
    test_array[0] = absl::nullopt;
    ContainerValidateParams validate_params_1(0, false, new ContainerValidateParams(0, true, nullptr));
    TestArrayWarning<MojomType>(std::move(test_array), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, &validate_params_1);

    test_array = CreateTestNestedHandleArray();
    (*test_array[1])[0] = ScopedHandle();
    ContainerValidateParams validate_params_2(0, true, new ContainerValidateParams(0, false, nullptr));
    TestArrayWarning<MojomType>(std::move(test_array), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE, &validate_params_2);
}
...
TEST_F(SerializationWarningTest, ArrayOfStrings)
{
    ...
    ContainerValidateParams validate_params_0(0, true, new ContainerValidateParams(0, false, nullptr));
    TestArrayWarning<MojomType>(std::move(test_array), mojo::internal::VALIDATION_ERROR_NONE, &validate_params_0);

    std::vector<absl::optional<std::string>> optional_test_array(3);
    ContainerValidateParams validate_params_1(0, false, new ContainerValidateParams(0, false, nullptr));
    TestArrayWarning<MojomType>(std::move(optional_test_array), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, &validate_params_1);

    test_array = std::vector<std::string>(2);
    ContainerValidateParams validate_params_2(3, true, new ContainerValidateParams(0, false, nullptr));
    TestArrayWarning<MojomType>(std::move(test_array), mojo::internal::VALIDATION_ERROR_UNEXPECTED_ARRAY_HEADER, &validate_params_2);
}
...
TEST_F(SerializationWarningTest, StructInUnion)
{
    ...
    TestUnionWarning(std::move(obj), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER);
}
...
TEST_F(SerializationWarningTest, HandleInUnion)
{
    ...
    TestUnionWarning(std::move(handle), mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE);
}
