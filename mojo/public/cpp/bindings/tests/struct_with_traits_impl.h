...
public:
    ...
    EnumWithTraitsImpl get_enum() const
    {
        return enum_;
    }
    ...
    base::StringPiece get_string_as_string_piece() const
    {
        return string_;
    }
    ...
    std::vector<std::string>& get_mutable_string_array()
    {
        return string_array_;
    }
    ...
    std::set<std::string>& get_mutable_string_set()
    {
        return string_set_;
    }

    const NestedStructWithTraitsImpl& get_struct() const
    {
        return struct_;
    }
    NestedStructWithTraitsImpl& get_mutable_struct()
    {
        return struct_;
    }
    ...
    const std::map<std::string, NestedStructWithTraitsImpl>& get_struct_map() const
    {
        return struct_map_;
    }
...
public:
    ...
    MoveOnlyStructWithTraitsImpl& operator=(const MoveOnlyStructWithTraitsImpl&) = delete;

    ~MoveOnlyStructWithTraitsImpl();

    ScopedHandle& get_mutable_handle()
    {
        return handle_;
    }
...
public:
    ...
    explicit UnionWithTraitsInt32(int32_t value)
        : value_(value)
    {
    }
...
public:
    UnionWithTraitsStruct()
    {
        type_ = Type::STRUCT;
    }
    explicit UnionWithTraitsStruct(int32_t value)
        : struct_(value)
    {
        type_ = Type::STRUCT;
    }
...
public:
    ...
    void set_was_serialized() const
    {
        was_serialized_ = true;
    }
    bool was_serialized() const
    {
        return was_serialized_;
    }

    void set_was_deserialized()
    {
        was_deserialized_ = true;
    }
    bool was_deserialized() const
    {
        return was_deserialized_;
    }
...
public:
    ...
    StructForceSerializeImpl& force()
    {
        return force_;
    }
    const StructForceSerializeImpl& force() const
    {
        return force_;
    }
