...
class BindingsTestBase : public testing::Test, public testing::WithParamInterface<BindingsTestSerializationMode> {
public:
    BindingsTestBase();
    ~BindingsTestBase();
...
#define INSTANTIATE_MOJO_BINDINGS_TEST_SUITE_P(fixture)                                                                                                        \
    INSTANTIATE_TEST_SUITE_P(, fixture,                                                                                                                        \
        testing::Values(mojo::BindingsTestSerializationMode::kSerializeBeforeSend, mojo::BindingsTestSerializationMode::kSerializeBeforeDispatch,              \
