...
TEST(ConstantTest, StructConstants)
{
    ...
    EXPECT_EQ(base::StringPiece(StructWithConstants::kStringValue), "struct test string contents");
}
...
TEST(ConstantTest, InterfaceConstants)
{
    ...
    EXPECT_EQ(base::StringPiece(InterfaceWithConstants::kStringValue), "interface test string contents");
    EXPECT_EQ(base::StringPiece(InterfaceWithConstants::Name_), "mojo.test.InterfaceWithConstants");
}
