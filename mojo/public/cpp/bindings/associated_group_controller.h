...
public:
    ...
    virtual InterfaceId AssociateInterface(ScopedInterfaceEndpointHandle handle_to_send) = 0;
    ...
    virtual ScopedInterfaceEndpointHandle CreateLocalEndpointHandle(InterfaceId id) = 0;

    // Closes an interface endpoint handle.
    virtual void CloseEndpointHandle(InterfaceId id, const absl::optional<DisconnectReason>& reason) = 0;
    ...
    virtual InterfaceEndpointController* AttachEndpointClient(
        const ScopedInterfaceEndpointHandle& handle, InterfaceEndpointClient* endpoint_client, scoped_refptr<base::SequencedTaskRunner> runner)
        = 0;
    ...
    virtual void DetachEndpointClient(const ScopedInterfaceEndpointHandle& handle) = 0;
...
protected:
    ...
    ScopedInterfaceEndpointHandle CreateScopedInterfaceEndpointHandle(InterfaceId id);
    ...
    bool NotifyAssociation(ScopedInterfaceEndpointHandle* handle_to_send, InterfaceId id);
