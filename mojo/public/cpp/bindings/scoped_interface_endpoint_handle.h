...
using ScopedInterfaceEndpointHandle = ScopedMessagePipeHandle;
#endif

// namespace internal {
// class AssociatedReceiverBase;
// class AssociatedInterfacePtrStateBase;
// }
//
...
//     static void CreatePairPendingAssociation(ScopedInterfaceEndpointHandle* handle0, ScopedInterfaceEndpointHandle* handle1);
//
...
//     ScopedInterfaceEndpointHandle& operator=(const ScopedInterfaceEndpointHandle&) = delete;
//
//     ~ScopedInterfaceEndpointHandle();
//
//     ScopedInterfaceEndpointHandle& operator=(ScopedInterfaceEndpointHandle&& other);
//
//     bool is_valid() const;
//
...
//     friend class internal::AssociatedReceiverBase;
//     friend class internal::AssociatedInterfacePtrStateBase;
//
//     class State;
//
//     // Used by AssociatedGroupController.
//     ScopedInterfaceEndpointHandle(InterfaceId id, scoped_refptr<AssociatedGroupController> group_controller);
//
//     // Used by AssociatedGroupController.
...
//     //     ever since.
//     base::RepeatingCallback<AssociatedGroupController*()> CreateGroupControllerGetter() const;
//
