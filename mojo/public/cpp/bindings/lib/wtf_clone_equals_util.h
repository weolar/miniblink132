...
template <typename T> struct CloneTraits<WTF::Vector<T>> {
...
template <typename K, typename V> struct CloneTraits<WTF::HashMap<K, V>> {
...
template <typename T> struct EqualsTraits<WTF::Vector<T>> {
...
template <typename K, typename V> struct EqualsTraits<WTF::HashMap<K, V>> {
