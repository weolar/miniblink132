...
template <typename Interface, typename SFINAE = void> struct SyncMethodTraits {
...
template <typename Interface> struct SyncMethodTraits<Interface, std::void_t<decltype(Interface::kSyncMethodOrdinals)>> {
    static constexpr base::span<const uint32_t> GetOrdinals()
    {
