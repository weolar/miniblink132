...
AssociatedGroup::AssociatedGroup(scoped_refptr<AssociatedGroupController> controller)
...
AssociatedGroup& AssociatedGroup::operator=(const AssociatedGroup& other) = default;
