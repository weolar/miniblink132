...
public:
    ...
    ControlMessageHandler(InterfaceEndpointClient* owner, uint32_t interface_version);
...
private:
    bool Run(Message* message, std::unique_ptr<MessageReceiverWithStatus> responder);
