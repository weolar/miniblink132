...
ThreadSafeForwarderBase::ThreadSafeForwarderBase(scoped_refptr<ThreadSafeProxy> proxy)
...
bool ThreadSafeForwarderBase::AcceptWithResponder(Message* message, std::unique_ptr<MessageReceiver> responder)
{
