...
PendingReceiverState::PendingReceiverState(PendingReceiverState&&) noexcept = default;

PendingReceiverState::~PendingReceiverState() = default;

PendingReceiverState& PendingReceiverState::operator=(PendingReceiverState&&) noexcept = default;
