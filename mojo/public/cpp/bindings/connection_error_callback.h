...
using ConnectionErrorWithReasonCallback = base::OnceCallback<void(uint32_t /* custom_reason */, const std::string& /* description */)>;
using RepeatingConnectionErrorWithReasonCallback = base::RepeatingCallback<void(uint32_t /* custom_reason */, const std::string& /* description */)>;
