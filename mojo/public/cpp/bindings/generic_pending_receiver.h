...
public:
    ...
    //GenericPendingReceiver(base::StringPiece interface_name, void** ptr);

    template <typename Interface>
    GenericPendingReceiver(mojo::PendingReceiver<Interface> receiver)
        : GenericPendingReceiver(Interface::Name_, /*receiver.PassPtrAddr()*/ receiver.PassPipe())
    {
    }
    ...
    mojo::MessagePipeHandle pipe() const
    {
        return pipe_.get();
    }
    ...
    template <typename Interface> mojo::PendingReceiver<Interface> As()
    {
...
private:
    ...
    //void** interface_addr_ = nullptr; // Interface**
};
