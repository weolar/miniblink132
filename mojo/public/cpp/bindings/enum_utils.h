...
template <typename TMojoEnum> absl::optional<TMojoEnum> ConvertIntToMojoEnum(base::StrictNumeric<int32_t> int_value)
{
    ...
    TMojoEnum enum_value = static_cast<TMojoEnum>(static_cast<int32_t>(int_value));
