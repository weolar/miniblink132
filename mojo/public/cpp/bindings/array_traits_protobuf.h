...
template <typename T> struct ArrayTraits<::google::protobuf::RepeatedPtrField<T>> {
    using Element = T;
    ...
    static const T* GetData(const ::google::protobuf::RepeatedPtrField<T>& input)
    {
        return input.data();
    }

    static T& GetAt(::google::protobuf::RepeatedPtrField<T>& input, size_t index)
    {
        return input.at(index);
    }

    static const T& GetAt(const ::google::protobuf::RepeatedPtrField<T>& input, size_t index)
    {
        return input.at(index);
    }
    ...
    static bool Resize(::google::protobuf::RepeatedPtrField<T>& input, size_t new_size)
    {
