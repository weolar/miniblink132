...
using DefaultProcessErrorHandler = base::RepeatingCallback<void(const std::string& error)>;
void MOJO_CPP_SYSTEM_EXPORT SetDefaultProcessErrorHandler(DefaultProcessErrorHandler handler);
