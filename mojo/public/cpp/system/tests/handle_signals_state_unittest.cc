...
TEST_F(HandleSignalsStateTest, SanityCheck)
{
    ...
    HandleSignalsState empty_signals(MOJO_HANDLE_SIGNAL_NONE, MOJO_HANDLE_SIGNAL_NONE);
    ...
    HandleSignalsState all_signals(MOJO_HANDLE_SIGNAL_READABLE | MOJO_HANDLE_SIGNAL_WRITABLE | MOJO_HANDLE_SIGNAL_PEER_CLOSED | MOJO_HANDLE_SIGNAL_PEER_REMOTE,
