...
FilteredDataSource::FilteredDataSource(std::unique_ptr<DataPipeProducer::DataSource> source, std::unique_ptr<Filter> filter)
...
FilteredDataSource::ReadResult FilteredDataSource::Read(uint64_t offset, base::span<char> buffer)
{
