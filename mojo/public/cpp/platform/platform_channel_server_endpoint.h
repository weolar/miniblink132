...
public:
    ...
    PlatformChannelServerEndpoint& operator=(const PlatformChannelServerEndpoint&) = delete;

    ~PlatformChannelServerEndpoint();

    PlatformChannelServerEndpoint& operator=(PlatformChannelServerEndpoint&& other);
