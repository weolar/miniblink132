...
public:
    ...
    // the platform handle.
    static void ToMojoPlatformHandle(PlatformHandle handle, MojoPlatformHandle* mojo_handle);
    ...
    static PlatformHandle FromMojoPlatformHandle(const MojoPlatformHandle* handle);
    ...
    {
        return type_ == Type::kHandle;
    }
    const base::win::ScopedHandle& GetHandle() const
    {
        return handle_;
    }
    ...
    bool is_valid() const
    {
        return is_valid_fd() || is_valid_handle();
    }
    bool is_valid_handle() const
    {
    ...
    const zx::handle& GetHandle() const
    {
        return handle_;
    }
    ...
    bool is_valid() const
    {
        return is_valid_fd() || is_valid_mach_port();
    }
    ...
    bool is_valid_mach_send() const
    {
        return mach_send_.is_valid();
    }
    bool is_mach_send() const
    {
        return type_ == Type::kMachSend;
    }
    ...
    bool is_valid_mach_receive() const
    {
        return mach_receive_.is_valid();
    }
    bool is_mach_receive() const
    {
        return type_ == Type::kMachReceive;
    }
...
#error "Unsupported platform."
    ...
    bool is_fd() const
    {
        return type_ == Type::kFd;
    }
    const base::ScopedFD& GetFD() const
    {
        return fd_;
    }
