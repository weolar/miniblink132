...
void MojoTestSupportLogPerfResult(const char* test_name, const char* sub_test_name, double value, const char* units);

// Opens a "/"-delimited file path relative to the source root.
FILE* MojoTestSupportOpenSourceRootRelativeFile(const char* source_root_relative_path);
...
//   rv[N] = NULL;
//
char** MojoTestSupportEnumerateSourceRootRelativeDirectory(const char* source_root_relative_path);
