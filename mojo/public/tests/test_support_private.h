...
public:
    ...
    virtual void LogPerfResult(const char* test_name, const char* sub_test_name, double value, const char* units) = 0;
    virtual FILE* OpenSourceRootRelativeFile(const char* relative_path) = 0;
    virtual char** EnumerateSourceRootRelativeDirectory(const char* relative_path) = 0;
};
