...
ConnectionParams::ConnectionParams(PlatformChannelServerEndpoint server_endpoint)
...
ConnectionParams& ConnectionParams::operator=(ConnectionParams&& params) = default;
