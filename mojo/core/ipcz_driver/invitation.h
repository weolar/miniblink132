...
public:
    ...
    static void SetDefaultProcessErrorHandler(MojoDefaultProcessErrorHandler handler);
    ...
    MojoResult Send(const MojoPlatformProcessHandle* process_handle, const MojoInvitationTransportEndpoint* transport_endpoint,
    ...
    static MojoHandle Accept(const MojoInvitationTransportEndpoint* transport_endpoint, const MojoAcceptInvitationOptions* options);
