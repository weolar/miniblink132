...
class MOJO_SYSTEM_IMPL_EXPORT WrappedPlatformHandle : public Object<WrappedPlatformHandle> {
public:
    ...
    static scoped_refptr<WrappedPlatformHandle> Deserialize(base::span<const uint8_t> data, base::span<PlatformHandle> handles);
