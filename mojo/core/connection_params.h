...
public:
    ...
    const PlatformChannelEndpoint& endpoint() const
    {
        return endpoint_;
    }
    ...
    bool is_untrusted_process() const
    {
        return is_untrusted_process_;
    }

    void set_leak_endpoint(bool leak_endpoint)
    {
        leak_endpoint_ = leak_endpoint;
    }
    bool leak_endpoint() const
    {
        return leak_endpoint_;
    }
