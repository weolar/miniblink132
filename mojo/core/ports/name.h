...
struct COMPONENT_EXPORT(MOJO_CORE_PORTS) PortName : Name {
    ...
    PortName(uint64_t v1, uint64_t v2)
        : Name(v1, v2)
    {
    }
};
...
struct COMPONENT_EXPORT(MOJO_CORE_PORTS) NodeName : Name {
    ...
    NodeName(uint64_t v1, uint64_t v2)
        : Name(v1, v2)
    {
    }
};
...
template <> struct COMPONENT_EXPORT(MOJO_CORE_PORTS) hash<mojo::core::ports::PortName> {
...
template <> struct COMPONENT_EXPORT(MOJO_CORE_PORTS) hash<mojo::core::ports::NodeName> {
