...
public:
    ...
    Port(uint64_t next_sequence_num_to_send, uint64_t next_sequence_num_to_receive);
    ...
    // events
    void TakePendingMessages(std::vector<std::unique_ptr<UserMessageEvent>>& messages);
