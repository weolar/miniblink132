...
TEST_F(NodeControllerTest, AcceptInvitationFailure)
{
    ...
    RunTestClient("SendInvalidAcceptInvitation", [&](MojoHandle h) { WriteMessage(h, "hi"); });
}

DEFINE_TEST_CLIENT_TEST_WITH_PIPE(SendInvalidAcceptInvitation, NodeControllerTest, h)
{
