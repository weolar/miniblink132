...
public:
    ...
    public:
        ...
        virtual void PostCompositorThreadCreated(base::SingleThreadTaskRunner* task_runner) = 0;
    ...
    VizMainImpl(Delegate* delegate, ExternalDependencies dependencies, std::unique_ptr<gpu::GpuInit> gpu_init);
    ...
    void CreateGpuService(mojo::PendingReceiver<mojom::GpuService> pending_receiver, mojo::PendingRemote<mojom::GpuHost> pending_gpu_host,
        mojo::PendingRemote<discardable_memory::mojom::DiscardableSharedMemoryManager> discardable_memory_manager,
        base::UnsafeSharedMemoryRegion use_shader_cache_shm_region, mojom::GpuServiceCreationParamsPtr params) override;
...
#if BUILDFLAG(IS_WIN)
    void CreateInfoCollectionGpuService(mojo::PendingReceiver<mojom::InfoCollectionGpuService> pending_receiver) override;
#endif
#if BUILDFLAG(IS_ANDROID)
    ...
    void StartDebugStream(mojo::PendingRemote<mojom::VizDebugOutput> debug_output) override;
    ...
    const GpuServiceImpl* gpu_service() const
    {
        *(int*)1 = 1;
        return nullptr;
        //return gpu_service_.get();
    ...
    discardable_memory::ClientDiscardableSharedMemoryManager* discardable_shared_memory_manager();
    ...
    void ExitProcess(/*ExitCode*/int immediate_exit_code);
...
private:
    ...
    {
        return io_thread_ ? io_thread_->task_runner() : dependencies_.io_thread_task_runner;
    }
...
//     std::unique_ptr<GpuServiceImpl> gpu_service_;
    ...
    std::unique_ptr<VizCompositorThreadRunnerImpl> viz_compositor_thread_runner_impl_;
    ...
    //scoped_refptr<discardable_memory::ClientDiscardableSharedMemoryManager> discardable_shared_memory_manager_;
};
