...
public:
    ...
    VizCompositorThreadRunnerImpl& operator=(const VizCompositorThreadRunnerImpl&) = delete;
    ...
    bool CreateHintSessionFactory(base::flat_set<base::PlatformThreadId> thread_ids, base::RepeatingClosure* wake_up_closure) override;
    void SetIOThreadId(base::PlatformThreadId io_thread_id) override
    {
    }
    void CreateFrameSinkManager(mojom::FrameSinkManagerParamsPtr params, GpuServiceImpl* gpu_service) override;
...
private:
    ...
    void CreateFrameSinkManagerOnCompositorThread(mojom::FrameSinkManagerParamsPtr params, GpuServiceImpl* gpu_service);
    ...
    //std::unique_ptr<SharedImageInterfaceProvider> shared_image_interface_provider_;
    ...
    std::unique_ptr<GmbVideoFramePoolContextProvider> gmb_video_frame_pool_context_provider_;
