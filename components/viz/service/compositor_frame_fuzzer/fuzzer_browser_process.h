...
public:
    ...
    void EmbedFuzzedCompositorFrame(CompositorFrame fuzzed_frame, std::vector<FuzzedBitmap> allocated_bitmaps);
...
private:
    ...
    mojo::AssociatedRemote<mojom::CompositorFrameSink> root_compositor_frame_sink_remote_;
    ...
    mojo::AssociatedRemote<mojom::ExternalBeginFrameController> external_begin_frame_controller_remote_;
