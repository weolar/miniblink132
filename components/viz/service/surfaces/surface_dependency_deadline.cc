...
SurfaceDependencyDeadline::SurfaceDependencyDeadline(const base::TickClock* tick_clock)
...
bool SurfaceDependencyDeadline::operator==(const SurfaceDependencyDeadline& other) const
{
