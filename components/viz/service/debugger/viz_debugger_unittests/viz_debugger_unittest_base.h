...
struct TestFilter {
    ...
    TestFilter(const std::string& anno_, const std::string& func_, const std::string& file_);

    TestFilter(const std::string& anno_, const std::string& func_, const std::string& file_, const bool& active_, const bool& enabled_);
