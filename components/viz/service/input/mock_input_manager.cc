...
bool MockInputManager::RIRExistsForFrameSinkId(const FrameSinkId& frame_sink_id)
{
    return base::Contains(rir_map_, frame_sink_id);
}

RenderInputRouterSupportBase* MockInputManager::GetSupportForFrameSink(const FrameSinkId& id)
{
