...
class VIZ_SERVICE_EXPORT RenderInputRouterSupportBase : public input::RenderWidgetHostViewInput {
public:
    RenderInputRouterSupportBase(const RenderInputRouterSupportBase&) = delete;
    RenderInputRouterSupportBase& operator=(const RenderInputRouterSupportBase&) = delete;
    ...
    public:
        ...
        virtual float GetDeviceScaleFactorForId(const FrameSinkId& frame_sink_id) = 0;
        virtual FrameSinkId GetRootCompositorFrameSinkId(const FrameSinkId& child_frame_sink_id) = 0;
        ...
        virtual RenderInputRouterSupportBase* GetParentRenderInputRouterSupport(const FrameSinkId& frame_sink_id) = 0;
        virtual RenderInputRouterSupportBase* GetRootRenderInputRouterSupport(const FrameSinkId& frame_sink_id) = 0;
    };
    ...
    void ProcessMouseEvent(const blink::WebMouseEvent& event, const ui::LatencyInfo& latency) override;
    void ProcessMouseWheelEvent(const blink::WebMouseWheelEvent& event, const ui::LatencyInfo& latency) override;
    void ProcessTouchEvent(const blink::WebTouchEvent& event, const ui::LatencyInfo& latency) override;
    void ProcessGestureEvent(const blink::WebGestureEvent& event, const ui::LatencyInfo& latency) override;
...
protected:
    explicit RenderInputRouterSupportBase(input::RenderInputRouter* rir, Delegate* delegate, const FrameSinkId& frame_sink_id);
