...
public:
    virtual bool OnMotionEvent(AInputEvent* input_event, const FrameSinkId& root_frame_sink_id) = 0;
};

class AndroidInputCallback {
public:
    AndroidInputCallback(const FrameSinkId& root_frame_sink_id, AndroidInputCallbackClient* client);
