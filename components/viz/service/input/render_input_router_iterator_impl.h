...
class VIZ_SERVICE_EXPORT RenderInputRouterIteratorImpl : public input::RenderInputRouterIterator {
public:
    explicit RenderInputRouterIteratorImpl(InputManager& input_manager, base::flat_set<FrameSinkId> rirs);

    RenderInputRouterIteratorImpl(const RenderInputRouterIteratorImpl&) = delete;
    RenderInputRouterIteratorImpl& operator=(const RenderInputRouterIteratorImpl&) = delete;
