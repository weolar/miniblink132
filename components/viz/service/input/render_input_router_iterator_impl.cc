...
RenderInputRouterIteratorImpl::RenderInputRouterIteratorImpl(InputManager& input_manager, base::flat_set<FrameSinkId> rirs)
    : input_manager_(input_manager)
    , render_input_routers_(std::move(rirs))
{
...
base::flat_set<FrameSinkId> RenderInputRouterIteratorImpl::GetRenderInputRoutersForTesting()
{
