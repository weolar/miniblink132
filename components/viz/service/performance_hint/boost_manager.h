...
public:
    ...
    base::TimeDelta GetFrameDurationAndMaybeUpdateBoostType(
        base::TimeDelta target_duration, base::TimeDelta actual_duration, base::TimeTicks draw_start, HintSession::BoostType preferable_boost_type);
...
private:
    ...
    void MaybeUpdateBoostType(base::TimeTicks draw_start, HintSession::BoostType boost_type);
