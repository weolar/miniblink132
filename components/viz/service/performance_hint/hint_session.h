...
public:
    ...
    virtual void ReportCpuCompletionTime(base::TimeDelta actual_duration, base::TimeTicks draw_start, BoostType preferable_boost_type) = 0;

    virtual void SetThreads(const base::flat_set<base::PlatformThreadId>& thread_ids) = 0;
};
...
public:
    ...
    static std::unique_ptr<HintSessionFactory> Create(base::flat_set<base::PlatformThreadId> permanent_thread_ids);
