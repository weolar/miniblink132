...
protected:
    ...
    static constexpr base::TimeDelta kTargetFrameDuration = base::Milliseconds(10);
    ...
    void ExecuteAndAssert(
        BoostType provided_boost_type, base::TimeTicks provided_draw_start, BoostType expected_boost_type, base::TimeDelta expected_frame_duration)
    {
        base::TimeDelta frame_duration
            = manager_.GetFrameDurationAndMaybeUpdateBoostType(kTargetFrameDuration, kActualFrameDuration, provided_draw_start, provided_boost_type);
...
TEST_F(BoostManagerTest, ScrollBoostExperimentEnabled)
{
    ...
    ExecuteAndAssert(BoostType::kDefault, draw_start, BoostType::kDefault, kActualFrameDuration);

    // Use BoostType::kScrollBoost, it takes effect immediately.
    ExecuteAndAssert(BoostType::kScrollBoost, draw_start, BoostType::kScrollBoost, 3 * kTargetFrameDuration);
    ...
    ExecuteAndAssert(BoostType::kDefault, draw_start, BoostType::kScrollBoost, 3 * kTargetFrameDuration);
...
TEST_F(BoostManagerTest, ScrollBoostExperimentDisabled)
{
    ...
    // is disabled.
    ExecuteAndAssert(BoostType::kScrollBoost, draw_start, BoostType::kDefault, kActualFrameDuration);
}
...
TEST_F(BoostManagerTest, WakeUpBoostExperimentEnabled)
{
    ...
    ExecuteAndAssert(BoostType::kWakeUpBoost, draw_start, BoostType::kWakeUpBoost, 1.5 * kTargetFrameDuration);

    // Use BoostType::kDefault, but it doesn't take effect, because the previously
    // set BoostType::kWakeUpBoost has not yet been exhausted.
    ExecuteAndAssert(BoostType::kDefault, draw_start, BoostType::kWakeUpBoost, 1.5 * kTargetFrameDuration);
...
TEST_F(BoostManagerTest, WakeUpBoostExperimentDisabled)
{
    ...
    // disabled.
    ExecuteAndAssert(BoostType::kWakeUpBoost, draw_start, BoostType::kDefault, 1.5 * kTargetFrameDuration);
    ExecuteAndAssert(BoostType::kDefault, draw_start, BoostType::kDefault, kActualFrameDuration);
}
