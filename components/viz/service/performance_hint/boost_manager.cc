...
base::TimeDelta BoostManager::GetFrameDurationAndMaybeUpdateBoostType(
    base::TimeDelta target_duration, base::TimeDelta actual_duration, base::TimeTicks draw_start, BoostType preferable_boost_type)
{
...
void BoostManager::MaybeUpdateBoostType(base::TimeTicks draw_start, BoostType boost_type)
{
    switch (boost_type) {
    case BoostType::kDefault:
