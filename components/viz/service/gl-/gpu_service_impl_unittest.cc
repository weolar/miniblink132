...
public:
    ...
    void SetUp() override
    {
        ...
        gpu_service_ = std::make_unique<GpuServiceImpl>(gpu_info, /*watchdog_thread=*/nullptr, io_thread_.task_runner(), gpu::GpuFeatureInfo(),
            gpu::GpuPreferences(), gpu::GPUInfo(), gpu::GpuFeatureInfo(), gfx::GpuExtraInfo(),
...
TEST_F(GpuServiceTest, LoseAllContexts)
{
    ...
    gpu_service()->InitializeWithHost(std::move(gpu_host_proxy), gpu::GpuProcessActivityFlags(),
