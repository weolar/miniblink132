...
class VIZ_SERVICE_EXPORT GmbVideoFramePoolContextProviderImpl : public GmbVideoFramePoolContextProvider {
public:
    ...
    GmbVideoFramePoolContextProviderImpl(const GmbVideoFramePoolContextProviderImpl& other) = delete;
    GmbVideoFramePoolContextProviderImpl& operator=(const GmbVideoFramePoolContextProviderImpl& other) = delete;

    ~GmbVideoFramePoolContextProviderImpl() override;

    std::unique_ptr<media::RenderableGpuMemoryBufferVideoFramePool::Context> CreateContext(base::OnceClosure on_context_lost) override;
