...
InFlightFrameDelivery::InFlightFrameDelivery(
    base::OnceClosure post_delivery_callback, base::OnceCallback<void(const media::VideoCaptureFeedback&)> feedback_callback)
...
void InFlightFrameDelivery::ProvideFeedback(const media::VideoCaptureFeedback& feedback)
{
