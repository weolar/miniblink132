...
public:
    ...
    public:
        ...
        virtual void OnFrameDamaged(const gfx::Size& root_render_pass_size, const gfx::Rect& damage_rect, base::TimeTicks expected_display_time,
    ...
    // size are empty.
    virtual std::optional<RegionProperties> GetRequestRegionProperties(const VideoCaptureSubTarget& sub_target) const = 0;
    ...
    virtual void RequestCopyOfOutput(PendingCopyOutputRequest pending_copy_output_request) = 0;
