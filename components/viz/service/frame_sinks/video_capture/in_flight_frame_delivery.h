...
class VIZ_SERVICE_EXPORT InFlightFrameDelivery final : public mojom::FrameSinkVideoConsumerFrameCallbacks {
public:
    InFlightFrameDelivery(base::OnceClosure post_delivery_callback, base::OnceCallback<void(const media::VideoCaptureFeedback&)> feedback_callback);
...
private:
    ...
    base::OnceCallback<void(const media::VideoCaptureFeedback&)> feedback_callback_;
};
