...
public:
    ...
    virtual CapturableFrameSink* FindCapturableFrameSink(const VideoCaptureTarget& target) = 0;
    ...
    virtual void OnCapturerConnectionLost(FrameSinkVideoCapturerImpl* capturer) = 0;
