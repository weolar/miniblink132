...
public:
    ...
    virtual void UnrefResources(const std::vector<ReturnedResource>& resources) = 0;
};
...
private:
    ...
    using ResourceIdInfoMap = std::unordered_map<ResourceId, ResourceRefs, ResourceIdHasher>;
