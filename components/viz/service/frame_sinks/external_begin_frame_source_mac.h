...
public:
    ...
    ExternalBeginFrameSourceMac(uint32_t restart_id, int64_t display_id, OutputSurface* output_surface);

    ExternalBeginFrameSourceMac(const ExternalBeginFrameSourceMac&) = delete;
    ExternalBeginFrameSourceMac& operator=(const ExternalBeginFrameSourceMac&) = delete;
    ...
    base::flat_set<base::TimeDelta> GetSupportedFrameIntervals(base::TimeDelta interval) override;
    ...
    void SetMultipleHWRefreshRatesCallback(MultipleHWRefreshRatesCallback callback);
...
// needed.
class VIZ_COMMON_EXPORT DelayBasedBeginFrameSourceMac : public DelayBasedBeginFrameSource {
public:
    DelayBasedBeginFrameSourceMac(std::unique_ptr<DelayBasedTimeSource> time_source, uint32_t restart_id);
    DelayBasedBeginFrameSourceMac(const DelayBasedBeginFrameSourceMac&) = delete;
    DelayBasedBeginFrameSourceMac& operator=(const DelayBasedBeginFrameSourceMac&) = delete;
