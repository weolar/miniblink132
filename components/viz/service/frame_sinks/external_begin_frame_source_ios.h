...
class VIZ_SERVICE_EXPORT ExternalBeginFrameSourceIOS : public ExternalBeginFrameSource, public ExternalBeginFrameSourceClient {
public:
    ...
    ExternalBeginFrameSourceIOS& operator=(const ExternalBeginFrameSourceIOS&) = delete;
    ...
    void OnVSync(base::TimeTicks vsync_time, base::TimeTicks next_vsync_time, base::TimeDelta vsync_interval);
