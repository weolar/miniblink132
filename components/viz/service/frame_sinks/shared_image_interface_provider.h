...
class VIZ_SERVICE_EXPORT SharedImageInterfaceProvider : public gpu::SharedContextState::ContextLostObserver {
public:
...
private:
    ...
    scoped_refptr<gpu::SharedContextState> shared_context_state_ GUARDED_BY(context_lock_);
};
