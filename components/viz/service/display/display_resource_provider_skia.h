...
class VIZ_SERVICE_EXPORT DisplayResourceProviderSkia : public DisplayResourceProvider {
public:
    ...
    class VIZ_SERVICE_EXPORT ScopedExclusiveReadLockSharedImage : public ScopedReadLockSharedImage {
    public:
        ScopedExclusiveReadLockSharedImage(DisplayResourceProviderSkia* resource_provider, ResourceId resource_id);
        ~ScopedExclusiveReadLockSharedImage();
        ScopedExclusiveReadLockSharedImage(ScopedExclusiveReadLockSharedImage&& other);
    };
    ...
    public:
        ...
        // class.
        LockSetForExternalUse(DisplayResourceProviderSkia* resource_provider, ExternalUseClient* client);
        ~LockSetForExternalUse();

        LockSetForExternalUse(const LockSetForExternalUse&) = delete;
        LockSetForExternalUse& operator=(const LockSetForExternalUse& other) = delete;
        ...
        ExternalUseClient::ImageContext* LockResource(ResourceId resource_id, bool maybe_concurrent_reads, bool raw_draw_if_possible = false);
    ...
    private:
        const raw_ptr<DisplayResourceProviderSkia, DanglingUntriaged> resource_provider_;
    ...
    void SetReleaseFence(ResourceFence* fence)
    {
        current_release_fence_ = fence;
    }
