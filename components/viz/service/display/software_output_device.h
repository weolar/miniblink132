...
public:
    ...
    explicit SoftwareOutputDevice(scoped_refptr<base::SequencedTaskRunner> task_runner);
    ...
    // completes.
    virtual void OnSwapBuffers(SwapBuffersCallback swap_ack_callback, gfx::FrameData data);
