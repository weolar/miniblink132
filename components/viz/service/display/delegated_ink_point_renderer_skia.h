...
class VIZ_SERVICE_EXPORT DelegatedInkPointRendererSkia : public DelegatedInkPointRendererBase {
public:
    DelegatedInkPointRendererSkia() = default;
    DelegatedInkPointRendererSkia(const DelegatedInkPointRendererSkia&) = delete;
    DelegatedInkPointRendererSkia& operator=(const DelegatedInkPointRendererSkia&) = delete;
    ...
    // space.
    void DrawDelegatedInkTrail(SkCanvas* canvas, const gfx::Transform& transform_to_render_pass);
