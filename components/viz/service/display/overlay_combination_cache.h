...
public:
    ...
    OverlayCombinationToTest GetOverlayCombinationToTest(base::span<OverlayProposedCandidate const> sorted_candidates, int max_overlays_considered);
    ...
    void DeclarePromotedCandidates(base::span<OverlayProposedCandidate const> attempted_candidates);
...
public:
    ...
    OverlayCombinationCache::CandidateId GetCandidateId(const OverlayProposedCandidate& candidate);
    ...
    void RemoveStaleIds(const OverlayCombinationCache::CandidateCombination& stale_candidates);
...
private:
    ...
    std::map<OverlayCacheKey, OverlayCombinationCache::CandidateId> candidate_ids_;
