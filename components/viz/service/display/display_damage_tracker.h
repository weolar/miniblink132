...
public:
    ...
    DisplayDamageTracker(SurfaceManager* surface_manager, SurfaceAggregator* aggregator);
    ...
    bool root_frame_missing() const
    {
        return root_frame_missing_;
    }
...
protected:
    ...
    void ProcessSurfaceDamage(const SurfaceId& surface_id, const BeginFrameAck& ack, bool display_damaged, HandleInteraction handle_interaction);
