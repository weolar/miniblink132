...
class VIZ_SERVICE_EXPORT DelegatedInkPointRendererBase : public gfx::mojom::DelegatedInkPointRenderer {
public:
    ...
    DelegatedInkPointRendererBase& operator=(const DelegatedInkPointRendererBase&) = delete;

    void InitMessagePipeline(mojo::PendingReceiver<gfx::mojom::DelegatedInkPointRenderer> receiver);
...
private:
    ...
    const std::unordered_map<int32_t, DelegatedInkTrailData>& GetPointsMapForTest() const
    {
        return pointer_ids_;
    }
