...
// static
cc::PixelTest::GraphicsBackend VizPixelTest::RenderTypeToBackend(RendererType renderer_type)
{
...
VizPixelTest::VizPixelTest(RendererType type)
    : PixelTest(RenderTypeToBackend(type))
    , renderer_type_(type)
{
}
...
VizPixelTestWithParam::VizPixelTestWithParam()
    : VizPixelTest(GetParam())
{
}
