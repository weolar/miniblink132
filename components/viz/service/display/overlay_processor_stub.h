...
class VIZ_SERVICE_EXPORT OverlayProcessorStub : public OverlayProcessorInterface {
public:
    ...
    void AdjustOutputSurfaceOverlay(std::optional<OutputSurfaceOverlayPlane>* output_surface_plane) final
    {
    }
