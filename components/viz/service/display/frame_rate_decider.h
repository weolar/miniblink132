...
public:
    ...
    public:
        ...
        virtual base::TimeDelta GetPreferredFrameIntervalForFrameSinkId(const FrameSinkId& id, mojom::CompositorFrameSinkType* type = nullptr) = 0;
    };
    ...
    FrameRateDecider(SurfaceManager* surface_manager, Client* client, bool hw_support_for_multiple_refresh_rates, bool output_surface_supports_set_frame_rate);
    ~FrameRateDecider() override;

    void SetSupportedFrameIntervals(base::flat_set<base::TimeDelta> supported_intervals);
...
private:
    ...
    ToggleFrameRateCase GetToggleFrameRateCase(const std::vector<base::TimeDelta>& fixed_interval_frame_sink_intervals) const;
