...
public:
    ...
    void PredictPoints(std::vector<gfx::DelegatedInkPoint>* ink_points_to_draw, gfx::DelegatedInkMetadata* metadata);
    void Reset();
    bool ContainsMatchingPoint(gfx::DelegatedInkMetadata* metadata) const;
    gfx::DelegatedInkPoint GetMatchingPoint(gfx::DelegatedInkMetadata* metadata) const;
