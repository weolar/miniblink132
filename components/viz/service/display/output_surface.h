...
public:
    ...
    const SkM44& color_matrix() const
    {
    ...
    // supported.
    virtual void SetUpdateVSyncParametersCallback(UpdateVSyncParametersCallback callback) = 0;
    ...
    // override this.
    virtual void SetNeedsSwapSizeNotifications(bool needs_swap_size_notifications);
    ...
    static void UpdateLatencyInfoOnSwap(const gfx::SwapResponse& response, std::vector<ui::LatencyInfo>* latency_info);
    ...
    virtual void ReadbackForTesting(CopyOutputRequest::CopyOutputRequestCallback result_callback);
