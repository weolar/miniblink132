...
class VIZ_SERVICE_EXPORT DisplaySchedulerBase : public DisplayDamageTracker::Delegate {
public:
    ...
    virtual void ReportFrameTime(base::TimeDelta frame_time, base::flat_set<base::PlatformThreadId> animation_thread_ids,
