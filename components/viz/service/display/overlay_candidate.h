...
public:
    ...
    static void ApplyClip(OverlayCandidate& candidate, const gfx::RectF& clip_rect);
    ...
    absl::variant<gfx::OverlayTransform, gfx::Transform> transform = gfx::OVERLAY_TRANSFORM_NONE;
