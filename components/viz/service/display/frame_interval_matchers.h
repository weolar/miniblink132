...
public:
    ...
    using ResultCallback = base::RepeatingCallback<void(Result, FrameIntervalMatcherType)>;
    ...
    struct VIZ_SERVICE_EXPORT Settings {
        ...
        absl::variant<absl::monostate, FixedIntervalSettings, ContinuousRangeSettings> interval_settings;
    ...
    static bool AreAlmostEqual(base::TimeDelta a, base::TimeDelta b, base::TimeDelta epsilon);

    virtual ~FrameIntervalMatcher() = default;

    FrameIntervalMatcherType type() const
    {
        return type_;
    }
