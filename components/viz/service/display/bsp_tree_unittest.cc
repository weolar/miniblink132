...
#define INT_VECTOR_FROM_ARRAY(array) std::vector<int>(array, array + std::size(array))

#define CREATE_DRAW_POLYGON(vertex_vector, normal, polygon_id) new DrawPolygon(NULL, vertex_vector, normal, polygon_id)

class BspTreeTest {
public:
    static void RunTest(base::circular_deque<std::unique_ptr<DrawPolygon>>* test_polygons, const std::vector<int>& compare_list)
    {
    ...
    static BspCompareResult SideCompare(const DrawPolygon& a, const DrawPolygon& b)
    {
...
TEST(BspTreeTest, NoSplit)
{
    ...
    std::unique_ptr<DrawPolygon> polygon_a(CREATE_DRAW_POLYGON(vertices_a, gfx::Vector3dF(0.0f, 0.0f, 1.0f), 0));
    std::unique_ptr<DrawPolygon> polygon_b(CREATE_DRAW_POLYGON(vertices_b, gfx::Vector3dF(0.0f, 0.0f, 1.0f), 1));
    std::unique_ptr<DrawPolygon> polygon_c(CREATE_DRAW_POLYGON(vertices_c, gfx::Vector3dF(0.0f, 0.0f, 1.0f), 2));
...
TEST(BspTreeTest, BasicSplit)
{
    ...
    std::unique_ptr<DrawPolygon> polygon_a(CREATE_DRAW_POLYGON(vertices_a, gfx::Vector3dF(0.0f, 0.0f, 1.0f), 0));
    std::unique_ptr<DrawPolygon> polygon_b(CREATE_DRAW_POLYGON(vertices_b, gfx::Vector3dF(-1.0f, 0.0f, 0.0f), 1));
...
TEST(BspTreeTest, ThreeWaySplit)
{
    ...
    std::unique_ptr<DrawPolygon> polygon_a(CREATE_DRAW_POLYGON(vertices_a, gfx::Vector3dF(0.0f, 0.0f, 1.0f), 0));
    std::unique_ptr<DrawPolygon> polygon_b(CREATE_DRAW_POLYGON(vertices_b, gfx::Vector3dF(-1.0f, 0.0f, 0.0f), 1));
    std::unique_ptr<DrawPolygon> polygon_c(CREATE_DRAW_POLYGON(vertices_c, gfx::Vector3dF(0.0f, 1.0f, 0.0f), 2));
...
TEST(BspTreeTest, Coplanar)
{
    ...
    std::unique_ptr<DrawPolygon> polygon_a_rev(CREATE_DRAW_POLYGON(vertices_a_rev, gfx::Vector3dF(0.0f, 0.0f, -1.0f), 0));
    std::unique_ptr<DrawPolygon> polygon_b_rev(CREATE_DRAW_POLYGON(vertices_b_rev, gfx::Vector3dF(0.0f, 0.0f, -1.0f), 1));
    std::unique_ptr<DrawPolygon> polygon_c_rev(CREATE_DRAW_POLYGON(vertices_c_rev, gfx::Vector3dF(0.0f, 0.0f, -1.0f), 2));
...
TEST(BspTreeTest, CoplanarSplit)
{
    ...
    std::unique_ptr<DrawPolygon> polygon_b(CREATE_DRAW_POLYGON(vertices_b, gfx::Vector3dF(0.0f, 0.0f, 1.0f), 1));
    std::unique_ptr<DrawPolygon> polygon_c(CREATE_DRAW_POLYGON(vertices_c, gfx::Vector3dF(0.0f, 0.0f, 1.0f), 2));
    std::unique_ptr<DrawPolygon> polygon_d(CREATE_DRAW_POLYGON(vertices_d, gfx::Vector3dF(-1.0f, 0.0f, 0.0f), 3));
