...
public:
    ...
    BspWalkActionDrawPolygon(DirectRenderer* renderer, const gfx::Rect& render_pass_scissor, bool using_scissor_as_optimization);
...
public:
    explicit BspWalkActionToVector(std::vector<raw_ptr<DrawPolygon, VectorExperimental>>* in_list);
    void operator()(DrawPolygon* item) override;
