...
TEST(DisplayUtilsTest, IsScrollOneElement)
{
    ...
    latency_info_scroll_update.AddLatencyNumber(ui::LatencyComponentType::INPUT_EVENT_LATENCY_SCROLL_UPDATE_ORIGINAL_COMPONENT);
    EXPECT_TRUE(IsScroll({ latency_info_scroll_update }));

    ui::LatencyInfo latency_info_first_scroll;
    latency_info_first_scroll.AddLatencyNumber(ui::LatencyComponentType::INPUT_EVENT_LATENCY_FIRST_SCROLL_UPDATE_ORIGINAL_COMPONENT);
...
TEST(DisplayUtilsTest, IsScroll)
{
    ...
    EXPECT_TRUE(IsScroll({ latency_info, latency_info_scroll_update, latency_info_first_scroll }));
