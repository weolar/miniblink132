...
public:
    ...
    static void EstimateAndRecordOverdrawAsUMAMetric(const AggregatedFrame* frame);
    ...
    void EstimateAndRecordOverdraw(const AggregatedFrame* frame, base::TimeTicks timestamp);
    ...
    base::TimeTicks start_time_for_testing() const
    {
        return start_time_;
    }
