...
public:
    ...
    {
        return renderer_type_ == RendererType::kSkiaGraphiteDawn || renderer_type_ == RendererType::kSkiaGraphiteMetal;
    }
...
class VizPixelTestWithParam : public VizPixelTest, public testing::WithParamInterface<RendererType> {
public:
