...
public:
    ...
    void CreateAndSendMetadata(const gfx::PointF& point, float diameter, SkColor4f color, base::TimeTicks timestamp, const gfx::RectF& presentation_area,
    ...
    void CreateAndSendPoint(const gfx::PointF& point, base::TimeTicks timestamp, int32_t pointer_id);
    ...
    void CreateAndSendPointFromLastPoint(int32_t pointer_id, const gfx::PointF& point);
