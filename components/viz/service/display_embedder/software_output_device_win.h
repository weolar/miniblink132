...
class VIZ_SERVICE_EXPORT SoftwareOutputDeviceWinBase : public SoftwareOutputDevice {
public:
    explicit SoftwareOutputDeviceWinBase(HWND hwnd);
    SoftwareOutputDeviceWinBase(const SoftwareOutputDeviceWinBase& other) = delete;
    SoftwareOutputDeviceWinBase& operator=(const SoftwareOutputDeviceWinBase& other) = delete;
...
class VIZ_SERVICE_EXPORT SoftwareOutputDeviceWinDirect : public SoftwareOutputDeviceWinBase, public OutputDeviceBacking::Client {
public:
...
class VIZ_SERVICE_EXPORT SoftwareOutputDeviceWinProxy : public SoftwareOutputDeviceWinBase {
public:
    SoftwareOutputDeviceWinProxy(HWND hwnd, mojo::PendingRemote<mojom::LayeredWindowUpdater> layered_window_updater);
...
VIZ_SERVICE_EXPORT std::unique_ptr<SoftwareOutputDevice> CreateSoftwareOutputDeviceWin(
    HWND hwnd, OutputDeviceBacking* backing, mojom::DisplayClient* display_client);
