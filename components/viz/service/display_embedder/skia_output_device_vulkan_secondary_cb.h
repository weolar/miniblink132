...
public:
    ...
    GrSemaphoresSubmitted Flush(SkSurface* sk_surface, VulkanContextProvider* vulkan_context_provider, std::vector<GrBackendSemaphore> end_semaphores,
        base::OnceClosure on_finished) override;
    bool Wait(SkSurface* sk_surface, int num_semaphores, const GrBackendSemaphore wait_semaphores[], bool delete_semaphores_after_wait) override;
    bool Draw(SkSurface* sk_surface, sk_sp<const GrDeferredDisplayList> ddl) override;
