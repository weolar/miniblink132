...
class VIZ_SERVICE_EXPORT SkiaOutputSurfaceDependencyImpl : public SkiaOutputSurfaceDependency {
public:
    SkiaOutputSurfaceDependencyImpl(GpuServiceImpl* gpu_service_impl, gpu::SurfaceHandle surface_handle);

    SkiaOutputSurfaceDependencyImpl(const SkiaOutputSurfaceDependencyImpl&) = delete;
    SkiaOutputSurfaceDependencyImpl& operator=(const SkiaOutputSurfaceDependencyImpl&) = delete;
    ...
    scoped_refptr<gl::GLSurface> CreateGLSurface(gl::GLSurfaceFormat format) override;
