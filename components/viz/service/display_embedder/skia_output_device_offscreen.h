...
public:
    SkiaOutputDeviceOffscreen(scoped_refptr<gpu::SharedContextState> context_state, gfx::SurfaceOrigin origin, bool has_alpha,
    ...
    SkiaOutputDeviceOffscreen& operator=(const SkiaOutputDeviceOffscreen&) = delete;
