...
public:
    explicit SoftwareOutputDeviceMac(scoped_refptr<base::SequencedTaskRunner> task_runner);
    ...
    size_t BufferQueueSizeForTesting() const
    {
...
private:
    ...
    void UpdateAndCopyBufferDamage(Buffer* previous_paint_buffer, const SkRegion& new_damage_rect);
