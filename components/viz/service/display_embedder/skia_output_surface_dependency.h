...
public:
    ...
    virtual scoped_refptr<gl::GLSurface> CreateGLSurface(gl::GLSurfaceFormat format) = 0;
    ...
    virtual base::ScopedClosureRunner CachePresenter(gl::Presenter* presenter) = 0;
#endif
