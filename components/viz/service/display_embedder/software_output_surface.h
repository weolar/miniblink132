...
public:
    explicit SoftwareOutputSurface(std::unique_ptr<SoftwareOutputDevice> software_device);
...
private:
    void SwapBuffersCallback(base::TimeTicks swap_time, int64_t swap_trace_id, const gfx::Size& pixel_size);
