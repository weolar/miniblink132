...
public:
    ...
    BufferQueue(SkiaOutputSurface* skia_output_surface, gpu::SurfaceHandle surface_handle, size_t number_of_buffers, bool is_protected = false);
    ...
    bool Reshape(const gfx::Size& size, const gfx::ColorSpace& color_space, RenderPassAlphaType alpha_type, SharedImageFormat format);
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(BufferQueueMockedSharedImageInterfaceTest, AllocateFails);
