...
public:
    ...
    void RunTests()
    {
        ...
        const uint64_t max_timebase_skew_us = VSyncParameterListener::kMaxTimebaseSkew.InMicroseconds();
...
private:
    ...
    bool WillSendUpdate(int64_t timebase_difference_us)
    {
        ...
        return listener.ShouldSendUpdate(timebase_ + base::Microseconds(timebase_difference_us), interval_);
    }
