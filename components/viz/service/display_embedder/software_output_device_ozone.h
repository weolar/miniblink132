...
class VIZ_SERVICE_EXPORT SoftwareOutputDeviceOzone : public SoftwareOutputDevice {
public:
    SoftwareOutputDeviceOzone(std::unique_ptr<ui::PlatformWindowSurface> platform_window_surface, std::unique_ptr<ui::SurfaceOzoneCanvas> surface_ozone);

    SoftwareOutputDeviceOzone(const SoftwareOutputDeviceOzone&) = delete;
    SoftwareOutputDeviceOzone& operator=(const SoftwareOutputDeviceOzone&) = delete;
