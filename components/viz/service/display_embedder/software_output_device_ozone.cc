...
SoftwareOutputDeviceOzone::SoftwareOutputDeviceOzone(
    std::unique_ptr<ui::PlatformWindowSurface> platform_window_surface, std::unique_ptr<ui::SurfaceOzoneCanvas> surface_ozone)
...
void SoftwareOutputDeviceOzone::Resize(const gfx::Size& viewport_pixel_size, float scale_factor)
{
...
void SoftwareOutputDeviceOzone::OnSwapBuffers(SwapBuffersCallback swap_ack_callback, gfx::FrameData data)
{
