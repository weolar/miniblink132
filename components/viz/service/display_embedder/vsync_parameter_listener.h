...
public:
    explicit VSyncParameterListener(mojo::PendingRemote<mojom::VSyncParameterObserver> observer);
    ...
    void OnVSyncParametersUpdated(base::TimeTicks timebase, base::TimeDelta interval);
