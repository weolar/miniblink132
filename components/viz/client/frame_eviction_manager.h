...
class VIZ_CLIENT_EXPORT FrameEvictionManager : public base::trace_event::MemoryDumpProvider {
public:
...
private:
    ...
    void SetOverridesForTesting(scoped_refptr<base::SingleThreadTaskRunner> task_runner, const base::TickClock* clock);
    ...
    // recent first.
    std::list<std::pair<FrameEvictionManagerClient*, base::TimeTicks>> unlocked_frames_;
