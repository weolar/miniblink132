...
TEST_F(HitTestQueryTest, OneSurface)
{
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds, transform_e_to_e, 0)); // e
    SendHitTestData();
    ...
    Target target1 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point1);
    EXPECT_EQ(target1.frame_sink_id, e_id);
    EXPECT_EQ(target1.location_in_target, point1);
    EXPECT_EQ(target1.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);

    // point2 is on the bounds of e so no target found.
    Target target2 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point2);
    ...
    Target target3 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point3);
    EXPECT_EQ(target3.frame_sink_id, e_id);
    EXPECT_EQ(target3.location_in_target, point3);
    EXPECT_EQ(target3.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
}
...
TEST_F(HitTestQueryTest, OneEmbedderTwoChildren)
{
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 2)); // e
    active_data_.push_back(
        AggregatedHitTestRegion(c1_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c1_bounds_in_e, transform_e_to_c1, 0)); // c1
    active_data_.push_back(
        AggregatedHitTestRegion(c2_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c2_bounds_in_e, transform_e_to_c2, 0)); // c2
    SendHitTestData();
    ...
    EXPECT_EQ(target2.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
    ...
    Target target4 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point4);
...
TEST_F(HitTestQueryTest, OneEmbedderRotatedChild)
{
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 1)); // e
    active_data_.push_back(
        AggregatedHitTestRegion(c_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c_bounds_in_e, transform_e_to_c, 0)); // c
    SendHitTestData();
...
TEST_F(HitTestQueryTest, ClippedChildWithTabAndTransparentBackground)
{
    ...
    gfx::Transform transform_e_to_e, transform_e_to_c, transform_c_to_a, transform_c_to_b;
    transform_e_to_c.Translate(-200, -100);
    transform_c_to_b.Translate(0, -100);
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 3)); // e
    active_data_.push_back(AggregatedHitTestRegion(c_id, HitTestRegionFlags::kHitTestChildSurface, c_bounds_in_e, transform_e_to_c, 2)); // c
    active_data_.push_back(
        AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, a_bounds_in_c, transform_c_to_a, 0)); // a
    active_data_.push_back(
        AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, b_bounds_in_c, transform_c_to_b, 0)); // b
    SendHitTestData();
    ...
    EXPECT_EQ(target4.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
}
...
TEST_F(HitTestQueryTest, ClippedChildWithChildUnderneath)
{
    ...
    gfx::Transform transform_e_to_e, transform_e_to_c, transform_c_to_a, transform_c_to_b, transform_e_to_d;
    transform_e_to_c.Translate(-200, -100);
    transform_c_to_b.Translate(0, -100);
    transform_e_to_d.Translate(-400, -50);
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 4)); // e
    active_data_.push_back(AggregatedHitTestRegion(c_id, HitTestRegionFlags::kHitTestChildSurface, c_bounds_in_e, transform_e_to_c, 2)); // c
    active_data_.push_back(
        AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, a_bounds_in_c, transform_c_to_a, 0)); // a
    active_data_.push_back(
        AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, b_bounds_in_c, transform_c_to_b, 0)); // b
    active_data_.push_back(
        AggregatedHitTestRegion(d_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, d_bounds_in_e, transform_e_to_d, 0)); // d
    SendHitTestData();
...
TEST_F(HitTestQueryTest, ClippedChildWithChildUnderneathTransform)
{
    ...
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors1, point1, &transformed_point));
    EXPECT_EQ(transformed_point, point1);
    std::vector<FrameSinkId> target_ancestors2 { a_id, c_id, e_id };
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors2, point2, &transformed_point));
    EXPECT_EQ(transformed_point, gfx::PointF(2, 2));
    std::vector<FrameSinkId> target_ancestors3 { d_id, e_id };
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors3, point3, &transformed_point));
    EXPECT_EQ(transformed_point, gfx::PointF(50, 100));
    std::vector<FrameSinkId> target_ancestors4 { b_id, c_id, e_id };
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors4, point4, &transformed_point));
    EXPECT_EQ(transformed_point, gfx::PointF(2, 2));
}
...
TEST_F(HitTestQueryTest, ClippedChildrenWithTabAndTransparentBackground)
{
    ...
    gfx::Transform transform_e_to_e, transform_e_to_c1, transform_c1_to_a, transform_c1_to_b, transform_e_to_c2, transform_c2_to_g, transform_c2_to_h;
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 6)); // e
    active_data_.push_back(AggregatedHitTestRegion(c1_id, HitTestRegionFlags::kHitTestChildSurface, c1_bounds_in_e, transform_e_to_c1, 2)); // c1
    active_data_.push_back(
        AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, a_bounds_in_c1, transform_c1_to_a, 0)); // a
    active_data_.push_back(
        AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, b_bounds_in_c1, transform_c1_to_b, 0)); // b
    active_data_.push_back(AggregatedHitTestRegion(c2_id, HitTestRegionFlags::kHitTestChildSurface, c2_bounds_in_e, transform_e_to_c2, 2)); // c2
    active_data_.push_back(
        AggregatedHitTestRegion(g_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, g_bounds_in_c2, transform_c2_to_g, 0)); // g
    active_data_.push_back(
        AggregatedHitTestRegion(h_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, h_bounds_in_c2, transform_c2_to_h, 0)); // h
    SendHitTestData();
    ...
    Target target5 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point5);
    EXPECT_EQ(target5.frame_sink_id, g_id);
    EXPECT_EQ(target5.location_in_target, gfx::PointF(50, 50));
    EXPECT_EQ(target5.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);

    Target target6 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point6);
    EXPECT_EQ(target6.frame_sink_id, e_id);
    EXPECT_EQ(target6.location_in_target, point6);
    EXPECT_EQ(target6.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);

    Target target7 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point7);
    EXPECT_EQ(target7.frame_sink_id, h_id);
    EXPECT_EQ(target7.location_in_target, gfx::PointF(150, 300));
    EXPECT_EQ(target7.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
}

// Tests transforming location to be in target's coordinate system given the
// target's ancestor list, in the case of
// ClippedChildrenWithTabAndTransparentBackground test.
TEST_F(HitTestQueryTest, ClippedChildrenWithTabAndTransparentBackgroundTransform)
{
    FrameSinkId e_id = FrameSinkId(1, 1);
    FrameSinkId c1_id = FrameSinkId(2, 2);
    FrameSinkId a_id = FrameSinkId(3, 3);
    ...
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors2, point2, &transformed_point));
    EXPECT_EQ(transformed_point, gfx::PointF(2, 2));
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors1, point3, &transformed_point));
    EXPECT_EQ(transformed_point, point3);
    std::vector<FrameSinkId> target_ancestors3 { b_id, c1_id, e_id };
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors3, point4, &transformed_point));
    EXPECT_EQ(transformed_point, gfx::PointF(2, 2));
    std::vector<FrameSinkId> target_ancestors4 { g_id, c2_id, e_id };
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors4, point5, &transformed_point));
    EXPECT_EQ(transformed_point, gfx::PointF(50, 50));
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors1, point6, &transformed_point));
    EXPECT_EQ(transformed_point, point6);
    std::vector<FrameSinkId> target_ancestors5 { h_id, c2_id, e_id };
    EXPECT_TRUE(hit_test_query().TransformLocationForTarget(target_ancestors5, point7, &transformed_point));
...
TEST_F(HitTestQueryTest, MultipleLayerChild)
{
    ...
    gfx::Transform transform_e_to_e, transform_e_to_c1, transform_c1_to_a, transform_a_to_b, transform_b_to_g, transform_e_to_c2;
    transform_e_to_c1.Translate(-100, -100);
    transform_a_to_b.Translate(-50, -30);
    transform_b_to_g.Translate(-150, -200);
    transform_e_to_c2.Translate(-400, -50);
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 5)); // e
    active_data_.push_back(AggregatedHitTestRegion(c1_id, HitTestRegionFlags::kHitTestChildSurface, c1_bounds_in_e, transform_e_to_c1, 3)); // c1
    active_data_.push_back(
        AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, a_bounds_in_c1, transform_c1_to_a, 2)); // a
    active_data_.push_back(
        AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, b_bounds_in_a, transform_a_to_b, 1)); // b
    active_data_.push_back(
        AggregatedHitTestRegion(g_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, g_bounds_in_b, transform_b_to_g, 0)); // g
    active_data_.push_back(
        AggregatedHitTestRegion(c2_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c2_bounds_in_e, transform_e_to_c2, 0)); // c2
    SendHitTestData();
...
TEST_F(HitTestQueryTest, MultipleLayerTransparentChild)
{
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 5)); // e
    active_data_.push_back(AggregatedHitTestRegion(c1_id, HitTestRegionFlags::kHitTestChildSurface, c1_bounds_in_e, transform_e_to_c1, 3)); // c1
    active_data_.push_back(AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestChildSurface, a_bounds_in_c1, transform_c1_to_a, 2)); // a
    active_data_.push_back(AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestChildSurface, b_bounds_in_a, transform_a_to_b, 1)); // b
    active_data_.push_back(AggregatedHitTestRegion(g_id, HitTestRegionFlags::kHitTestChildSurface, g_bounds_in_b, transform_b_to_g, 0)); // g
    active_data_.push_back(
        AggregatedHitTestRegion(c2_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c2_bounds_in_e, transform_e_to_c2, 0)); // c2
    SendHitTestData();
...
TEST_F(HitTestQueryTest, InvalidAggregatedHitTestRegionData)
{
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 3)); // e
    active_data_.push_back(AggregatedHitTestRegion(c_id, HitTestRegionFlags::kHitTestChildSurface, c_bounds_in_e, transform_e_to_c, INT32_MIN)); // c
    active_data_.push_back(
        AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, a_bounds_in_c, transform_c_to_a, 0)); // a
    active_data_.push_back(
        AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, b_bounds_in_c, transform_c_to_b, 0)); // b
    ...
    active_data_.clear();
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, INT32_MAX)); // e
    active_data_.push_back(AggregatedHitTestRegion(c_id, HitTestRegionFlags::kHitTestChildSurface, c_bounds_in_e, transform_e_to_c, 2)); // c
    active_data_.push_back(
        AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, a_bounds_in_c, transform_c_to_a, 0)); // a
    active_data_.push_back(
    ...
    Target target3 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point1);
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 3)); // e
    active_data_.push_back(AggregatedHitTestRegion(c_id, HitTestRegionFlags::kHitTestChildSurface, c_bounds_in_e, transform_e_to_c, 3)); // c
    active_data_.push_back(
        AggregatedHitTestRegion(a_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, a_bounds_in_c, transform_c_to_a, 0)); // a
    active_data_.push_back(
        AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, b_bounds_in_c, transform_c_to_b, 0)); // b
    ...
    Target target4 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point1);
    EXPECT_EQ(target4.frame_sink_id, FrameSinkId());
    EXPECT_EQ(target4.location_in_target, gfx::PointF());
    EXPECT_FALSE(target4.flags);
}
...
TEST_F(HitTestQueryTest, MouseTouchFlags)
{
    ...
    active_data_.push_back(AggregatedHitTestRegion(e_id,
        HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse | HitTestRegionFlags::kHitTestTouch, e_bounds_in_e, transform_e_to_e, 2)); // e
    active_data_.push_back(
        AggregatedHitTestRegion(c1_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c1_bounds_in_e, transform_e_to_c1, 0)); // c1
    active_data_.push_back(
        AggregatedHitTestRegion(c2_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestTouch, c2_bounds_in_e, transform_e_to_c2, 0)); // c2
    SendHitTestData();
    ...
    EXPECT_EQ(target1.frame_sink_id, e_id);
    EXPECT_EQ(target1.location_in_target, point1);
    EXPECT_EQ(target1.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse | HitTestRegionFlags::kHitTestTouch);

    Target target2 = hit_test_query().FindTargetForLocation(EventSource::TOUCH, point1);
    EXPECT_EQ(target2.frame_sink_id, c2_id);
    EXPECT_EQ(target2.location_in_target, gfx::PointF(5, 5));
    EXPECT_EQ(target2.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestTouch);

    Target target3 = hit_test_query().FindTargetForLocation(EventSource::MOUSE, point2);
    EXPECT_EQ(target3.frame_sink_id, c1_id);
    EXPECT_EQ(target3.location_in_target, gfx::PointF(50, 50));
    EXPECT_EQ(target3.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);

    Target target4 = hit_test_query().FindTargetForLocation(EventSource::TOUCH, point2);
    EXPECT_EQ(target4.frame_sink_id, c2_id);
    EXPECT_EQ(target4.location_in_target, gfx::PointF(75, 75));
    EXPECT_EQ(target4.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestTouch);
}
...
TEST_F(HitTestQueryTest, RootHitTestAskFlag)
{
    ...
    gfx::Rect e_bounds = gfx::Rect(0, 0, 600, 600);
    gfx::Transform transform_e_to_e;
    active_data_.push_back(AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse, e_bounds, transform_e_to_e, 0,
    ...
    EXPECT_EQ(target1.frame_sink_id, e_id);
    EXPECT_EQ(target1.location_in_target, point1);
    EXPECT_EQ(target1.flags, HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse);
...
TEST_F(HitTestQueryTest, ChildHitTestAskFlag)
{
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(c1_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c1_bounds_in_e, transform_e_to_c1, 0)); // c1
    active_data_.push_back(
        AggregatedHitTestRegion(c2_id, HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse, c2_bounds_in_e, transform_e_to_c2, 0,
    ...
    EXPECT_EQ(target3.frame_sink_id, c2_id);
    EXPECT_EQ(target3.location_in_target, gfx::PointF(100, 100));
    EXPECT_EQ(target3.flags, HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse);
}
...
TEST_F(HitTestQueryTest, NestedOOPIFs)
{
    ...
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 2)); // e
    active_data_.push_back(AggregatedHitTestRegion(c_id,
        HitTestRegionFlags::kHitTestChildSurface | HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse, c_bounds_in_e, transform_e_to_c, 1,
        AsyncHitTestReasons::kOverlappedRegion)); // c
    active_data_.push_back(
        AggregatedHitTestRegion(b_id, HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse, b_bounds_in_c, transform_c_to_b, 0,
    ...
    EXPECT_EQ(target2.location_in_target, gfx::PointF(2, 2));
    EXPECT_EQ(target2.flags, HitTestRegionFlags::kHitTestChildSurface | HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse);
    ...
    EXPECT_EQ(target3.flags, HitTestRegionFlags::kHitTestChildSurface | HitTestRegionFlags::kHitTestAsk | HitTestRegionFlags::kHitTestMouse);
}
...
TEST_F(HitTestQueryTest, TransparentOverlayRegions)
{
    ...
    gfx::Transform transform_e_to_e, transform_e_to_c1, transform_e_to_c2, transform_c1_to_d1;
    transform_e_to_c2.Translate(-200, -100);
    transform_c1_to_d1.Translate(-200, -200);
    active_data_.push_back(
        AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, e_bounds_in_e, transform_e_to_e, 3)); // e
    active_data_.push_back(AggregatedHitTestRegion(
        c1_id, HitTestRegionFlags::kHitTestChildSurface | HitTestRegionFlags::kHitTestMouse, c1_bounds_in_e, transform_e_to_c1, 1)); // c1
    active_data_.push_back(
        AggregatedHitTestRegion(d1_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, d1_bounds_in_c1, transform_c1_to_d1, 0)); // d1
    active_data_.push_back(
        AggregatedHitTestRegion(c2_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse, c2_bounds_in_e, transform_e_to_c2, 0)); // c2
    SendHitTestData();
...
TEST_F(HitTestQueryTest, FindTargetForLocationStartingFrom)
{
    ...
    gfx::PointF point1(99, 200);
    Target target1 = hit_test_query().FindTargetForLocationStartingFrom(EventSource::MOUSE, point1, e_id);
    EXPECT_EQ(target1.frame_sink_id, e_id);
    EXPECT_EQ(target1.location_in_target, point1);
    EXPECT_EQ(target1.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
    ...
    gfx::PointF point2(150, 150);
    Target target2 = hit_test_query().FindTargetForLocationStartingFrom(EventSource::MOUSE, point2, e_id);
    EXPECT_EQ(target2.frame_sink_id, c_id);
    EXPECT_EQ(target2.location_in_target, gfx::PointF(50, 50));
    EXPECT_EQ(target2.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
    ...
    Target target3 = hit_test_query().FindTargetForLocationStartingFrom(EventSource::MOUSE, point3, c_id);
    EXPECT_EQ(target3.frame_sink_id, c_id);
    EXPECT_EQ(target3.location_in_target, point3);
    EXPECT_EQ(target3.flags, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
}
...
TEST_F(HitTestQueryTest, OverlappedRootView)
{
    ...
    gfx::Transform transform_e_to_e, transform_e_to_c;
    transform_e_to_c.Translate(-200, -100);
    active_data_.push_back(AggregatedHitTestRegion(e_id, HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse | HitTestRegionFlags::kHitTestAsk,
        e_bounds_in_e, transform_e_to_e, 1,
        AsyncHitTestReasons::kOverlappedRegion)); // e
    active_data_.push_back(AggregatedHitTestRegion(
        c_id, HitTestRegionFlags::kHitTestChildSurface | kHitTestMine | HitTestRegionFlags::kHitTestMouse, c_bounds_in_e, transform_e_to_c, 0)); // c
    SendHitTestData();
    ...
    // point2 + transform_e_to_c  = (2, 2).
    EXPECT_EQ(target2.location_in_target, gfx::PointF(2, 2));
    EXPECT_EQ(target2.flags, HitTestRegionFlags::kHitTestChildSurface | HitTestRegionFlags::kHitTestMine | HitTestRegionFlags::kHitTestMouse);
}
