...
public:
    ...
    MOCK_METHOD2(RegisterFrameSinkId, void(const FrameSinkId& frame_sink_id, bool report_activation));
    MOCK_METHOD1(InvalidateFrameSinkId, void(const FrameSinkId& frame_sink_id));
    MOCK_METHOD2(SetFrameSinkDebugLabel, void(const FrameSinkId& frame_sink_id, const std::string& debug_label));
    MOCK_METHOD5(CreateCompositorFrameSink,
        void(const FrameSinkId&, const std::optional<FrameSinkBundleId>&, mojo::PendingReceiver<mojom::CompositorFrameSink>,
            mojo::PendingRemote<mojom::CompositorFrameSinkClient>, input::mojom::RenderInputRouterConfigPtr));
    ...
    MOCK_METHOD1(MockCreateRootCompositorFrameSink, void(const FrameSinkId& frame_sink_id));
    ...
    MOCK_METHOD1(MockDestroyCompositorFrameSink, void(const FrameSinkId& frame_sink_id));
    MOCK_METHOD2(RegisterFrameSinkHierarchy, void(const FrameSinkId& parent, const FrameSinkId& child));
    MOCK_METHOD2(UnregisterFrameSinkHierarchy, void(const FrameSinkId& parent, const FrameSinkId& child));
    MOCK_METHOD(void, Throttle, (const std::vector<FrameSinkId>& ids, base::TimeDelta interval), (override));
};
...
public:
    ...
    HostFrameSinkManager& host()
    {
        return host_manager_;
    }
    MockFrameSinkManagerImpl& impl()
    {
    ...
    {
        return host_manager_.frame_sink_manager_remote_.is_bound() || host_manager_.frame_sink_manager_client_receiver_.is_bound();
    }
    ...
    void RegisterFrameSinkIdWithFakeClient(const FrameSinkId& frame_sink_id, ReportFirstSurfaceActivation report_activation)
    {
        host_manager_.RegisterFrameSinkId(frame_sink_id, &host_client_, report_activation);
    }
    ...
    void ConnectToGpu()
    {
        ...
        manager_impl_ = std::make_unique<testing::StrictMock<MockFrameSinkManagerImpl>>();

        mojo::PendingRemote<mojom::FrameSinkManager> frame_sink_manager;
        mojo::PendingReceiver<mojom::FrameSinkManager> frame_sink_manager_receiver = frame_sink_manager.InitWithNewPipeAndPassReceiver();
        mojo::PendingRemote<mojom::FrameSinkManagerClient> frame_sink_manager_client;
        mojo::PendingReceiver<mojom::FrameSinkManagerClient> frame_sink_manager_client_receiver = frame_sink_manager_client.InitWithNewPipeAndPassReceiver();

        host_manager_.BindAndSetManager(std::move(frame_sink_manager_client_receiver), nullptr, std::move(frame_sink_manager));
        manager_impl_->BindReceiver(std::move(frame_sink_manager_receiver), std::move(frame_sink_manager_client));
    }
...
TEST_F(HostFrameSinkManagerTest, CreateCompositorFrameSinks)
{
    ...
    EXPECT_CALL(impl(), RegisterFrameSinkId(kFrameSinkChild1, true /* report_activation */));
    RegisterFrameSinkIdWithFakeClient(kFrameSinkChild1, ReportFirstSurfaceActivation::kYes);
    ...
    host().CreateCompositorFrameSink(kFrameSinkChild1, compositor_frame_sink.BindNewPipeAndPassReceiver(), compositor_frame_sink_client.BindInterfaceRemote());
    FlushHostAndVerifyExpectations();

    // Register but don't actually create CompositorFrameSink for parent.
    RegisterFrameSinkIdWithFakeClient(kFrameSinkParent1, ReportFirstSurfaceActivation::kYes);
    EXPECT_CALL(impl(), RegisterFrameSinkId(kFrameSinkParent1, true /* report_activation */));

    // Register should call through to FrameSinkManagerImpl and should work even
    // though |kFrameSinkParent1| was not created yet.
    EXPECT_CALL(impl(), RegisterFrameSinkHierarchy(kFrameSinkParent1, kFrameSinkChild1));
    ...
    EXPECT_CALL(impl(), UnregisterFrameSinkHierarchy(kFrameSinkParent1, kFrameSinkChild1));
...
TEST_F(HostFrameSinkManagerTest, CreateRootCompositorFrameSinks)
{
    ...
    host().CreateRootCompositorFrameSink(root_data1.BuildParams(kFrameSinkChild1));
    EXPECT_TRUE(FrameSinkDataExists(kFrameSinkChild1));
    ...
    host().CreateRootCompositorFrameSink(root_data2.BuildParams(kFrameSinkParent1));
...
TEST_F(HostFrameSinkManagerTest, HierarchyMultipleParents)
{
    ...
    EXPECT_CALL(impl(), RegisterFrameSinkId(id_parent1, true /* report_activation */));
    RegisterFrameSinkIdWithFakeClient(id_parent1, ReportFirstSurfaceActivation::kYes);
    RootCompositorFrameSinkData root_data1;
    ...
    EXPECT_CALL(impl(), RegisterFrameSinkId(id_parent2, true /* report_activation */));
    RegisterFrameSinkIdWithFakeClient(id_parent2, ReportFirstSurfaceActivation::kYes);
    RootCompositorFrameSinkData root_data2;
    ...
    EXPECT_CALL(impl(), RegisterFrameSinkId(id_child, true /* report_activation */));
    RegisterFrameSinkIdWithFakeClient(id_child, ReportFirstSurfaceActivation::kYes);
    MockCompositorFrameSinkClient compositor_frame_sink_client;
    mojo::Remote<mojom::CompositorFrameSink> compositor_frame_sink;
    EXPECT_CALL(impl(), CreateCompositorFrameSink(id_child, _, _, _, _));
    host().CreateCompositorFrameSink(id_child, compositor_frame_sink.BindNewPipeAndPassReceiver(), compositor_frame_sink_client.BindInterfaceRemote());
...
TEST_F(HostFrameSinkManagerTest, RestartOnGpuCrash)
{
    ...
    EXPECT_CALL(impl(), MockCreateRootCompositorFrameSink(kFrameSinkParent1));
    host().CreateRootCompositorFrameSink(root_data.BuildParams(kFrameSinkParent1));
...
TEST_F(HostFrameSinkManagerTest, DeletedHitTestQuery)
{
    ...
    GetFrameSinkManagerClient()->OnAggregatedHitTestRegionListUpdated(kFrameSinkParent1, {});
...
TEST_F(HostFrameSinkManagerTest, ContextLossRecreateRoot)
{
    ...
    RegisterFrameSinkIdWithFakeClient(kFrameSinkParent1, ReportFirstSurfaceActivation::kYes);
    RootCompositorFrameSinkData root_data1;
    host().CreateRootCompositorFrameSink(root_data1.BuildParams(kFrameSinkParent1));
...
TEST_F(HostFrameSinkManagerTest, ContextLossRecreateNonRoot)
{
    ...
    host().CreateCompositorFrameSink(
        kFrameSinkChild1, compositor_frame_sink1.BindNewPipeAndPassReceiver(), compositor_frame_sink_client1.BindInterfaceRemote());
    ...
    host().CreateCompositorFrameSink(
        kFrameSinkChild1, compositor_frame_sink2.BindNewPipeAndPassReceiver(), compositor_frame_sink_client2.BindInterfaceRemote());
...
{
    const std::vector<FrameSinkId> frame_sink_ids { FrameSinkId(1, 1), FrameSinkId(2, 2), FrameSinkId(3, 3) };
...
TEST_F(HostFrameSinkManagerTest, RegisterWithExistingClient)
{
    ...
    host().RegisterFrameSinkId(kFrameSinkChild1, &new_client_, ReportFirstSurfaceActivation::kYes);
    FlushHostAndVerifyExpectations();
