...
class VIZ_HOST_EXPORT CompositingModeReporterImpl : public mojom::CompositingModeReporter {
public:
    ...
    void BindReceiver(mojo::PendingReceiver<mojom::CompositingModeReporter> receiver);
    ...
    void AddCompositingModeWatcher(mojo::PendingRemote<mojom::CompositingModeWatcher> watcher) override;
