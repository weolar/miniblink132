...
void CompositingModeReporterImpl::BindReceiver(mojo::PendingReceiver<mojom::CompositingModeReporter> receiver)
{
...
void CompositingModeReporterImpl::AddCompositingModeWatcher(mojo::PendingRemote<mojom::CompositingModeWatcher> watcher)
{
    mojo::Remote<mojom::CompositingModeWatcher> watcher_remote(std::move(watcher));
    if (!gpu_)
