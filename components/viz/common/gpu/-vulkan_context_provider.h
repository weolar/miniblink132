...
class VIZ_VULKAN_CONTEXT_PROVIDER_EXPORT VulkanContextProvider : public base::RefCountedThreadSafe<VulkanContextProvider> {
public:
    ...
    virtual void EnqueueSecondaryCBSemaphores(std::vector<VkSemaphore> semaphores) = 0;
