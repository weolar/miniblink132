...
public:
    ...
    ContextCacheController(gpu::ContextSupport* context_support, scoped_refptr<base::SequencedTaskRunner> task_runner);
    ...
    virtual void ClientBecameNotVisible(std::unique_ptr<ScopedVisibility> scoped_visibility);
    ...
    virtual void ClientBecameNotVisibleDuringShutdown(std::unique_ptr<ScopedVisibility> scoped_visibility);
    ...
    void SetNotifyAllClientsVisibilityChangedCb(base::RepeatingCallback<void(bool)> on_clients_visibility_changed_cb);
