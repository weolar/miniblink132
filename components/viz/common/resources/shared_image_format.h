...
public:
    ...
    static constexpr SharedImageFormat MultiPlane(PlaneConfig plane_config, Subsampling subsampling, ChannelFormat channel_format)
    {
    ...
    {
        return plane_type_ == PlaneType::kMultiPlane;
    }
    ...
    bool PrefersExternalSampler() const
    {
        ...
        return is_multi_plane() ? format_.multiplanar_format.prefers_external_sampler : false;
#else
        return false;
#endif
    }
    ...
    {
#if BUILDFLAG(IS_OZONE)
        CHECK(is_multi_plane() && format_.multiplanar_format.prefers_external_sampler);
    ...
    std::optional<size_t> MaybeEstimatedPlaneSizeInBytes(int plane_index, const gfx::Size& size) const;
...
private:
    ...
    union SharedImageFormatUnion {
        ...
        explicit constexpr SharedImageFormatUnion(mojom::SingleplanarFormat singleplanar_format)
            : singleplanar_format(singleplanar_format)
        {
        }
        constexpr SharedImageFormatUnion(PlaneConfig plane_config, Subsampling subsampling, ChannelFormat channel_format)
    ...
    friend struct mojo::UnionTraits<mojom::SharedImageFormatDataView, SharedImageFormat>;
    friend struct mojo::StructTraits<mojom::MultiplanarFormatDataView, SharedImageFormatUnion::MultiplanarFormat>;

    explicit constexpr SharedImageFormat(mojom::SingleplanarFormat singleplanar_format)
        : plane_type_(PlaneType::kSinglePlane)
        , format_(singleplanar_format)
    {
    }
    constexpr SharedImageFormat(PlaneConfig plane_config, Subsampling subsampling, ChannelFormat channel_format)
...
class SinglePlaneFormat {
public:
    static constexpr SharedImageFormat kRGBA_8888 = SharedImageFormat(mojom::SingleplanarFormat::RGBA_8888);
    static constexpr SharedImageFormat kRGBA_4444 = SharedImageFormat(mojom::SingleplanarFormat::RGBA_4444);
    static constexpr SharedImageFormat kBGRA_8888 = SharedImageFormat(mojom::SingleplanarFormat::BGRA_8888);
    static constexpr SharedImageFormat kALPHA_8 = SharedImageFormat(mojom::SingleplanarFormat::ALPHA_8);
    static constexpr SharedImageFormat kLUMINANCE_8 = SharedImageFormat(mojom::SingleplanarFormat::LUMINANCE_8);
    static constexpr SharedImageFormat kRGB_565 = SharedImageFormat(mojom::SingleplanarFormat::RGB_565);
    static constexpr SharedImageFormat kBGR_565 = SharedImageFormat(mojom::SingleplanarFormat::BGR_565);
    static constexpr SharedImageFormat kETC1 = SharedImageFormat(mojom::SingleplanarFormat::ETC1);
    static constexpr SharedImageFormat kR_8 = SharedImageFormat(mojom::SingleplanarFormat::R_8);
    static constexpr SharedImageFormat kRG_88 = SharedImageFormat(mojom::SingleplanarFormat::RG_88);
    static constexpr SharedImageFormat kLUMINANCE_F16 = SharedImageFormat(mojom::SingleplanarFormat::LUMINANCE_F16);
    static constexpr SharedImageFormat kRGBA_F16 = SharedImageFormat(mojom::SingleplanarFormat::RGBA_F16);
    static constexpr SharedImageFormat kR_16 = SharedImageFormat(mojom::SingleplanarFormat::R_16);
    static constexpr SharedImageFormat kRG_1616 = SharedImageFormat(mojom::SingleplanarFormat::RG_1616);
    static constexpr SharedImageFormat kRGBX_8888 = SharedImageFormat(mojom::SingleplanarFormat::RGBX_8888);
    static constexpr SharedImageFormat kBGRX_8888 = SharedImageFormat(mojom::SingleplanarFormat::BGRX_8888);
    static constexpr SharedImageFormat kRGBA_1010102 = SharedImageFormat(mojom::SingleplanarFormat::RGBA_1010102);
    static constexpr SharedImageFormat kBGRA_1010102 = SharedImageFormat(mojom::SingleplanarFormat::BGRA_1010102);
    static constexpr SharedImageFormat kR_F16 = SharedImageFormat(mojom::SingleplanarFormat::R_F16);

    // All known singleplanar formats.
    static constexpr SharedImageFormat kAll[19] = { kRGBA_8888, kRGBA_4444, kBGRA_8888, kALPHA_8, kLUMINANCE_8, kRGB_565, kBGR_565, kETC1, kR_8, kRG_88,
        kLUMINANCE_F16, kRGBA_F16, kR_16, kRG_1616, kRGBX_8888, kBGRX_8888, kRGBA_1010102, kBGRA_1010102, kR_F16 };
};

// Constants for common multi-planar formats.
namespace MultiPlaneFormat {
inline constexpr SharedImageFormat kYV12
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_V_U, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k8);
inline constexpr SharedImageFormat kNV12
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k8);
inline constexpr SharedImageFormat kNV12A
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV_A, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k8);
inline constexpr SharedImageFormat kP010
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k10);
...
inline constexpr SharedImageFormat kNV16
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV, SharedImageFormat::Subsampling::k422, SharedImageFormat::ChannelFormat::k8);
inline constexpr SharedImageFormat kNV24
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV, SharedImageFormat::Subsampling::k444, SharedImageFormat::ChannelFormat::k8);
inline constexpr SharedImageFormat kP210
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV, SharedImageFormat::Subsampling::k422, SharedImageFormat::ChannelFormat::k10);
inline constexpr SharedImageFormat kP410
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV, SharedImageFormat::Subsampling::k444, SharedImageFormat::ChannelFormat::k10);
inline constexpr SharedImageFormat kI420
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_U_V, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k8);
inline constexpr SharedImageFormat kI420A
    = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_U_V_A, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k8);
} // namespace MultiPlaneFormat
