...
public:
    ...
    static SharedImageFormat BestSupportedTextureFormat(const gpu::Capabilities& caps)
    {
    ...
    static SharedImageFormat BestSupportedRenderBufferFormat(const gpu::Capabilities& caps)
    {
