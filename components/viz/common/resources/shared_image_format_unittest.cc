...
public:
    void TestNumChannelsInPlane(std::vector<int> expected_channels, SharedImageFormat format)
    {
        ASSERT_EQ(format.NumberOfPlanes(), static_cast<int>(expected_channels.size()));
        for (int plane_index = 0; plane_index < format.NumberOfPlanes(); plane_index++) {
            EXPECT_TRUE(format.IsValidPlaneIndex(plane_index));
            EXPECT_EQ(expected_channels[plane_index], format.NumChannelsInPlane(plane_index));
        }
    }
};
...
TEST_F(SharedImageFormatTest, MultiPlaneI422)
{
    ...
    SharedImageFormat format
        = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_U_V, SharedImageFormat::Subsampling::k422, SharedImageFormat::ChannelFormat::k8);
    // Test for NumChannelsInPlane
    std::vector<int> expected_channels = { 1, 1, 1 };
    TestNumChannelsInPlane(expected_channels, format);
...
TEST_F(SharedImageFormatTest, MultiPlaneI444)
{
    ...
    SharedImageFormat format
        = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_U_V, SharedImageFormat::Subsampling::k444, SharedImageFormat::ChannelFormat::k8);
    // Test for NumChannelsInPlane
    std::vector<int> expected_channels = { 1, 1, 1 };
    TestNumChannelsInPlane(expected_channels, format);
...
TEST_F(SharedImageFormatTest, MultiPlaneYUVBiplanar16bit)
{
    ...
    SharedImageFormat format
        = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k16);
    // Test for NumChannelsInPlane
    std::vector<int> expected_channels = { 1, 2 };
    TestNumChannelsInPlane(expected_channels, format);
...
TEST_F(SharedImageFormatTest, MultiPlaneYUVATriplanar)
{
    ...
    SharedImageFormat format
        = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_UV_A, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k16F);
    // Test for NumChannelsInPlane
...
TEST_F(SharedImageFormatTest, MultiPlaneYUV420P10)
{
    ...
    SharedImageFormat format
        = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_U_V, SharedImageFormat::Subsampling::k420, SharedImageFormat::ChannelFormat::k10);
    // Test for NumChannelsInPlane
    std::vector<int> expected_channels = { 1, 1, 1 };
    TestNumChannelsInPlane(expected_channels, format);
...
TEST_F(SharedImageFormatTest, MultiPlaneYUV422P10)
{
    ...
    SharedImageFormat format
        = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_U_V, SharedImageFormat::Subsampling::k422, SharedImageFormat::ChannelFormat::k10);
    // Test for NumChannelsInPlane
    std::vector<int> expected_channels = { 1, 1, 1 };
    TestNumChannelsInPlane(expected_channels, format);
...
TEST_F(SharedImageFormatTest, MultiPlaneYUV444P10)
{
    ...
    SharedImageFormat format
        = SharedImageFormat::MultiPlane(SharedImageFormat::PlaneConfig::kY_U_V, SharedImageFormat::Subsampling::k444, SharedImageFormat::ChannelFormat::k10);
    // Test for NumChannelsInPlane
    std::vector<int> expected_channels = { 1, 1, 1 };
    TestNumChannelsInPlane(expected_channels, format);
...
TEST_F(SharedImageFormatTest, EstimatedSizeInBytesOverflow)
{
    ...
    constexpr gfx::Size max_size(std::numeric_limits<int>::max(), std::numeric_limits<int>::max());
