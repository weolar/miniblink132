...
public:
    ...
    void ReplaceExistingQuadWithSolidColor(QuadList::Iterator at, SkColor4f color, SkBlendMode blend_mode);
    ...
    void ReplaceExistingQuadWithHolePunch(QuadList::Iterator quad, bool* quad_was_opaque = nullptr);
    ...
    static void CopyAllForTest(const std::vector<std::unique_ptr<RenderPassType>>& in, std::vector<std::unique_ptr<RenderPassType>>* out)
    {
