...
RenderPassDrawQuadInternal::RenderPassDrawQuadInternal(const RenderPassDrawQuadInternal& other) = default;

RenderPassDrawQuadInternal::~RenderPassDrawQuadInternal() = default;

void RenderPassDrawQuadInternal::ExtendValue(base::trace_event::TracedValue* value) const
{
    value->SetInteger("mask_resource_id", resources.ids[kMaskResourceIdIndex].GetUnsafeValue());
