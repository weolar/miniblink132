...
public:
    ...
    void SetNew(const SharedQuadState* shared_quad_state, const gfx::Rect& rect, const gfx::Rect& visible_rect, const SurfaceRange& range,
        SkColor4f background_color, bool stretch_content);

    void SetAll(const SharedQuadState* shared_quad_state, const gfx::Rect& rect, const gfx::Rect& visible_rect, bool needs_blending, const SurfaceRange& range,
        SkColor4f background_color, bool stretch_content, bool reflection, bool merge);
