...
TEST(CompositorFrameTransitionDirective, GettersReflectParameters)
{
    ...
    auto save_directive = CompositorFrameTransitionDirective::CreateSave(transition_token, /*maybe_cross_frame_sink=*/false, 1u, {}, {});
    ...
    auto animate_directive = CompositorFrameTransitionDirective::CreateAnimate(transition_token, /*maybe_cross_frame_sink=*/true, 2);
