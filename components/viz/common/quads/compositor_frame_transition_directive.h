...
public:
    ...
    static CompositorFrameTransitionDirective CreateSave(const blink::ViewTransitionToken& transition_token, bool maybe_cross_frame_sink, uint32_t sequence_id,
        std::vector<SharedElement> shared_elements, const gfx::DisplayColorSpaces& display_color_spaces);
    ...
    CompositorFrameTransitionDirective& operator=(const CompositorFrameTransitionDirective&);
    ...
    {
        return maybe_cross_frame_sink_;
    }
...
private:
    CompositorFrameTransitionDirective(const blink::ViewTransitionToken& transition_token, bool maybe_cross_frame_sink, uint32_t sequence_id, Type type,
        std::vector<SharedElement> shared_elements = {}, const gfx::DisplayColorSpaces& display_color_spaces = {});
