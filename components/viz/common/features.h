...
extern const VIZ_COMMON_EXPORT base::FeatureParam<DelegatedCompositingMode> kDelegatedCompositingModeParam;
...
VIZ_COMMON_EXPORT BASE_DECLARE_FEATURE(kTemporalSkipOverlaysWithRootCopyOutputRequests);
...
VIZ_COMMON_EXPORT extern const base::FeatureParam<int> kCALayerNewLimitManyVideos;
#endif
...
VIZ_COMMON_EXPORT BASE_DECLARE_FEATURE(kAllowForceMergeRenderPassWithRequireOverlayQuads);
...
VIZ_COMMON_EXPORT extern const base::FeatureParam<std::string> kADPFSocManufacturerAllowlist;
VIZ_COMMON_EXPORT extern const base::FeatureParam<std::string> kADPFSocManufacturerBlocklist;
VIZ_COMMON_EXPORT BASE_DECLARE_FEATURE(kEnableADPFScrollBoost);
VIZ_COMMON_EXPORT extern const base::FeatureParam<base::TimeDelta> kADPFBoostTimeout;
VIZ_COMMON_EXPORT extern const base::FeatureParam<double> kADPFMidFrameBoostDurationMultiplier;
...
VIZ_COMMON_EXPORT extern const base::FeatureParam<double> kSnapshotEvictedRootSurfaceScale;
...
VIZ_COMMON_EXPORT std::optional<uint64_t> NumCooldownFramesForAckOnSurfaceActivationDuringInteraction();
VIZ_COMMON_EXPORT extern const base::FeatureParam<int> kNumCooldownFramesForAckOnSurfaceActivationDuringInteraction;
