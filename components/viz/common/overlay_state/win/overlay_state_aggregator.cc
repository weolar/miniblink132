...
bool OverlayStateAggregator::SetPromotionHint(bool promoted)
{
    OverlayStateAggregator::PromotionState recommendation
        = promoted ? OverlayStateAggregator::PromotionState::kPromoted : OverlayStateAggregator::PromotionState::kNotPromoted;
...
OverlayStateAggregator::PromotionState OverlayStateAggregator::GetPromotionState()
{
