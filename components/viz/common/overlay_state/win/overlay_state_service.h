...
public:
    ...
    void RegisterObserver(mojo::PendingRemote<gpu::mojom::OverlayStateObserver> promotion_hint_observer, const gpu::Mailbox& mailbox);
...
private:
    ...
    void OnBoundObserverDisconnect(const gpu::Mailbox& mailbox, mojo::RemoteSetElementId);
    void OnStateChanged(const gpu::Mailbox& mailbox, OverlayStateAggregator::PromotionState promoted);
    void OnStateChangedOnTaskRunnerSequence(const gpu::Mailbox& mailbox, OverlayStateAggregator::PromotionState promoted);
    void SetPromotionHintOnTaskRunnerSequence(const gpu::Mailbox& mailbox, bool promoted);
