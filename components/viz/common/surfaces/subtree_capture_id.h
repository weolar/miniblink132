...
public:
    ...
    {
        return !subtree_id_.is_zero();
    }
    constexpr const base::Token& subtree_id() const
    {
        return subtree_id_;
    }

    friend std::strong_ordering operator<=>(const SubtreeCaptureId&, const SubtreeCaptureId&) = default;
