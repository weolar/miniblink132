...
RegionCaptureBounds::RegionCaptureBounds(base::flat_map<base::Token, gfx::Rect> bounds)
...
RegionCaptureBounds& RegionCaptureBounds::operator=(RegionCaptureBounds&&) = default;
RegionCaptureBounds& RegionCaptureBounds::operator=(const RegionCaptureBounds&) = default;
RegionCaptureBounds::~RegionCaptureBounds() = default;
...
void RegionCaptureBounds::Set(const RegionCaptureCropId& crop_id, const gfx::Rect& region)
{
