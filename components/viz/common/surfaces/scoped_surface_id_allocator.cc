...
ScopedSurfaceIdAllocator::ScopedSurfaceIdAllocator(base::OnceCallback<void()> allocation_task)
    : allocation_task_(std::move(allocation_task))
{
}

ScopedSurfaceIdAllocator::ScopedSurfaceIdAllocator(ParentLocalSurfaceIdAllocator* allocator, base::OnceCallback<void()> allocation_task)
...
ScopedSurfaceIdAllocator::ScopedSurfaceIdAllocator(ScopedSurfaceIdAllocator&& other)
...
ScopedSurfaceIdAllocator& ScopedSurfaceIdAllocator::operator=(ScopedSurfaceIdAllocator&& other)
{
