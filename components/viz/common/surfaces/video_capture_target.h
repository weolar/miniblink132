...
using VideoCaptureSubTarget = absl::variant<absl::monostate, SubtreeCaptureId, RegionCaptureCropId>;
...
struct VIZ_COMMON_EXPORT VideoCaptureTarget {
    ...
    // above.
    VideoCaptureTarget(FrameSinkId frame_sink_id, VideoCaptureSubTarget capture_sub_target);
    ...
    friend bool operator==(const VideoCaptureTarget&, const VideoCaptureTarget&) = default;
