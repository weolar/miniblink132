...
public:
    ...
    virtual SharedHighlightingDataDrivenTestResults GenerateAndNavigate(std::string html_content, std::string* start_parent_id, int start_offset_in_parent,
        absl::optional<int> start_text_offset, std::string* end_parent_id, int end_offset_in_parent, absl::optional<int> end_text_offset,
        std::string selected_text, std::string* highlight_text)
        = 0;
};
