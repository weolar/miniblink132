...
const size_t kTextDirectiveParameterNameLength = strlen(kTextDirectiveParameterName);

const char kSelectorDirectiveParameterName[] = "selector(";
const int kSelectorDirectiveParameterNameLength = strlen(kSelectorDirectiveParameterName);
...
const int kSelectorDirectiveValuePrefixLength = strlen(kSelectorDirectiveValuePrefix);

const char kSelectorDirectiveTypePrefix[] = "type=";
const int kSelectorDirectiveTypePrefixLength = strlen(kSelectorDirectiveTypePrefix);
