...
TEST(SummaryOperatorTest, Parse)
{
    const struct {
        const char* desc;
        const char* json;
        ::testing::Matcher<base::expected<SummaryOperator, SourceRegistrationError>> matches;
    } kTestCases[] = {
        {
            .desc = "missing",
            .json = R"json({})json",
        ...
        },
        {
            ...
            .matches = ErrorIs(SourceRegistrationError::kSummaryOperatorValueInvalid),
        },
        {
            .desc = "invalid_value",
...
TEST(SummaryBucketsTest, Parse)
{
    const struct {
        ...
        ::testing::Matcher<base::expected<SummaryBuckets, SourceRegistrationError>> matches;
    } kTestCases[] = {
        {
            .desc = "missing",
            .json = R"json({})json",
            .max_event_level_reports = MaxEventLevelReports(5),
            .matches = ValueIs(Property(&SummaryBuckets::starts, ElementsAre(1, 2, 3, 4, 5))),
        },
        {
            .desc = "wrong_type",
            .json = R"json({"summary_buckets": 1})json",
            .matches = ErrorIs(SourceRegistrationError::kSummaryBucketsListInvalid),
        },
        {
            .desc = "empty",
        ...
        },
        {
            ...
            .matches = ErrorIs(SourceRegistrationError::kSummaryBucketsValueInvalid),
        },
        {
        ...
        },
        {
            ...
            .max_event_level_reports = MaxEventLevelReports(3),
            .matches = ValueIs(Property(&SummaryBuckets::starts, ElementsAre(1, 3, 5))),
        },
        {
            .desc = "valid_max_uint32",
            .json = R"json({"summary_buckets": [4294967295]})json",
            .matches = ValueIs(Property(&SummaryBuckets::starts, ElementsAre(4294967295))),
        },
    };
    ...
    for (const auto& test_case : kTestCases) {
        ...
        EXPECT_THAT(SummaryBuckets::Parse(dict, test_case.max_event_level_reports), test_case.matches);
    }
}
