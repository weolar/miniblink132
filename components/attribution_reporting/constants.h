...
inline constexpr char kAggregatableFilteringIdsMaxBytes[] = "aggregatable_filtering_id_max_bytes";
inline constexpr char kAggregatableNamedBudgets[] = "named_budgets";
inline constexpr char kAggregatableReportWindow[] = "aggregatable_report_window";
...
inline constexpr char kDestinationLimitPriority[] = "destination_limit_priority";
...
inline constexpr char kAggregatableDeduplicationKeys[] = "aggregatable_deduplication_keys";
inline constexpr char kAggregatableSourceRegistrationTime[] = "aggregatable_source_registration_time";
...
inline constexpr char kAggregationCoordinatorOrigin[] = "aggregation_coordinator_origin";
...
inline constexpr char kAttributionReportingRegisterSourceHeader[] = "Attribution-Reporting-Register-Source";

inline constexpr char kAttributionReportingRegisterTriggerHeader[] = "Attribution-Reporting-Register-Trigger";

inline constexpr char kAttributionReportingRegisterOsSourceHeader[] = "Attribution-Reporting-Register-OS-Source";

inline constexpr char kAttributionReportingRegisterOsTriggerHeader[] = "Attribution-Reporting-Register-OS-Trigger";
