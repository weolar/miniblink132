...
public:
    ...
    static base::expected<AttributionScopesSet, mojom::SourceRegistrationError> FromJSON(base::Value::Dict&, uint32_t attribution_scope_limit);

    static base::expected<AttributionScopesSet, mojom::TriggerRegistrationError> FromJSON(base::Value::Dict&);
    ...
    friend bool operator==(const AttributionScopesSet&, const AttributionScopesSet&) = default;
