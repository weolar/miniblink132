...
public:
    static base::expected<SummaryBuckets, mojom::SourceRegistrationError> Parse(const base::Value::Dict&, MaxEventLevelReports);
    ...
    const base::flat_set<uint32_t>& starts() const
    {
        return starts_;
    }
    ...
    friend bool operator==(const SummaryBuckets&, const SummaryBuckets&) = default;
...
base::expected<mojom::SummaryOperator, mojom::SourceRegistrationError> ParseSummaryOperator(const base::Value::Dict&);
