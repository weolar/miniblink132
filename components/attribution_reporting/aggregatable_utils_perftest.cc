...
const TestCase kTestCases[] = {
    {
        ...
        *AggregatableTriggerConfig::Create(SourceRegistrationTimeConfig::kInclude,
            /*trigger_context_id=*/std::nullopt, AggregatableFilteringIdsMaxBytes()),
        0.008,
    },
    {
...
class AggregatableUtilsPerfTest : public testing::Test, public testing::WithParamInterface<TestCase> {
};
...
TEST_P(AggregatableUtilsPerfTest, GetNullAggregatableReports)
{
    ...
    perf_test::PerfResultReporter reporter("AttributionReporting.GetNullAggregatableReports", test_case.story_name);
    reporter.RegisterImportantMetric(".wall_time", "ms");
    reporter.AddResult(".wall_time", timer.TimePerLap());
}

INSTANTIATE_TEST_SUITE_P(
    , AggregatableUtilsPerfTest, testing::ValuesIn(kTestCases), [](const testing::TestParamInfo<TestCase>& info) { return info.param.story_name; });
