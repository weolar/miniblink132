...
TEST(EventReportWindowsTest, FromDefaults)
{
    const struct {
        ...
        },
        {
            ...
            base::Days(7),
            SourceType::kNavigation,
            Optional(AllOf(Property(&EventReportWindows::start_time, base::TimeDelta()),
                Property(&EventReportWindows::end_times, ElementsAre(base::Days(2), base::Days(7))))),
        },
        {
            ">-last-navigation",
            ...
            SourceType::kNavigation,
            Optional(AllOf(Property(&EventReportWindows::start_time, base::TimeDelta()),
                Property(&EventReportWindows::end_times, ElementsAre(base::Days(2), base::Days(7), base::Days(7) + base::Seconds(1))))),
        },
        {
            "<-last-navigation",
            base::Days(7) - base::Seconds(1),
            SourceType::kNavigation,
            Optional(AllOf(Property(&EventReportWindows::start_time, base::TimeDelta()),
                Property(&EventReportWindows::end_times, ElementsAre(base::Days(2), base::Days(7) - base::Seconds(1))))),
        },
        {
            "<-first-navigation",
            ...
            SourceType::kNavigation,
            Optional(AllOf(Property(&EventReportWindows::start_time, base::TimeDelta()),
                Property(&EventReportWindows::end_times, ElementsAre(base::Days(2) - base::Seconds(1))))),
        },
        {
            "event",
            base::Days(30),
            SourceType::kEvent,
            Optional(
                AllOf(Property(&EventReportWindows::start_time, base::TimeDelta()), Property(&EventReportWindows::end_times, ElementsAre(base::Days(30))))),
        },
    };

    for (const auto& test_case : kTestCases) {
        SCOPED_TRACE(test_case.desc);
        EXPECT_THAT(EventReportWindows::FromDefaults(test_case.report_window, test_case.source_type), test_case.matches);
    }
}
...
TEST(EventReportWindowsTest, CreateWindows)
{
    const struct {
        ...
        },
        {
            ...
            .start_time = base::Seconds(0),
            .end_times = { base::Hours(1), base::Hours(2), base::Hours(3), base::Hours(4), base::Hours(5), base::Hours(6) },
            .matches = Eq(std::nullopt),
        },
        {
        ...
        },
        {
            .name = "valid",
            .start_time = base::Seconds(0),
            .end_times = { base::Hours(1), base::Hours(2), base::Hours(3), base::Hours(4), base::Hours(5) },
            .matches = Optional(AllOf(Property(&EventReportWindows::start_time, base::Seconds(0)),
                Property(&EventReportWindows::end_times, ElementsAre(base::Hours(1), base::Hours(2), base::Hours(3), base::Hours(4), base::Hours(5))))),
        },
        {
            .name = "valid-non-zero_start_time",
            .start_time = base::Seconds(1),
            .end_times = { base::Hours(2), base::Hours(3), base::Hours(4), base::Hours(5), base::Hours(6) },
            .matches = Optional(AllOf(Property(&EventReportWindows::start_time, base::Seconds(1)),
                Property(&EventReportWindows::end_times, ElementsAre(base::Hours(2), base::Hours(3), base::Hours(4), base::Hours(5), base::Hours(6))))),
        },
    };
    for (const auto& test_case : kTestCases) {
        SCOPED_TRACE(test_case.name);
        auto actual = EventReportWindows::Create(test_case.start_time, test_case.end_times);
...
TEST(EventReportWindowsTest, Parse)
{
    const struct {
        const char* desc;
        const char* json;
        ::testing::Matcher<base::expected<EventReportWindows, SourceRegistrationError>> matches;
    ...
    } kTestCases[] = {
        {
            ...
            R"json({})json",
            ValueIs(*EventReportWindows::FromDefaults(base::Days(30), SourceType::kNavigation)),
            SourceType::kNavigation,
        },
        {
            "neither_field_present_event",
            R"json({})json",
            ValueIs(*EventReportWindows::FromDefaults(base::Days(30), SourceType::kEvent)),
            SourceType::kEvent,
        },
        {
            "event_report_window_valid_navigation",
            R"json({"event_report_window":"86401"})json",
            ValueIs(*EventReportWindows::FromDefaults(base::Seconds(86401), SourceType::kNavigation)),
        },
        {
            "event_report_window_valid_event",
            R"json({"event_report_window":"86401"})json",
            ValueIs(*EventReportWindows::FromDefaults(base::Seconds(86401), SourceType::kEvent)),
        },
        {
        ...
        },
        {
            ...
            ValueIs(*EventReportWindows::FromDefaults(base::Seconds(3600), SourceType::kNavigation)),
        },
        {
            .desc = "event_report_window_clamped_max",
            .json = R"json({"event_report_window":86401})json",
            .matches = ValueIs(*EventReportWindows::FromDefaults(base::Seconds(86400), SourceType::kNavigation)),
        ...
        },
        {
            ...
            .matches = ErrorIs(SourceRegistrationError::kEventReportWindowsStartTimeInvalid),
            .expiry = base::Seconds(86400),
        },
        {
        ...
        },
        {
            ...
            ErrorIs(SourceRegistrationError::kEventReportWindowsEndTimesListInvalid),
        },
        {
        ...
        },
        {
            ...
            ErrorIs(SourceRegistrationError::kEventReportWindowsEndTimeValueInvalid),
        },
        {
        ...
        },
        {
            ...
            ErrorIs(SourceRegistrationError::kEventReportWindowsEndTimeDurationLTEStart),
        },
        {
        ...
        },
        {
            ...
            ValueIs(AllOf(
                Property(&EventReportWindows::start_time, base::Seconds(3599)), Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(3600))))),
        },
        {
            .desc = "event_report_windows_end_time_clamped_max",
            .json = R"json({"event_report_windows":{"end_times":[86401]}})json",
            .matches = ValueIs(AllOf(
                Property(&EventReportWindows::start_time, base::Seconds(0)), Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(86400))))),
            .expiry = base::Seconds(86400),
        },
        {
            ...
            .matches = ValueIs(Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(86400)))),
            .expiry = base::Seconds(86400),
        },
        {
            ...
            ValueIs(AllOf(Property(&EventReportWindows::start_time, base::Seconds(0)),
                Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(3600), base::Seconds(10800), base::Seconds(21600))))),
        },
        {
            ...
            ValueIs(AllOf(Property(&EventReportWindows::start_time, base::Seconds(1)),
                Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(3600), base::Seconds(10800), base::Seconds(21600))))),
        },
        {
        ...
        },
        {
            ...
            ValueIs(AllOf(Property(&EventReportWindows::start_time, base::Seconds(7200)),
                Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(16000), base::Seconds(32000), base::Seconds(48000))))),
        },
        {
            ...
            ValueIs(
                AllOf(Property(&EventReportWindows::start_time, base::Seconds(0)), Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(3600))))),
        },
        {
    ...
    for (const auto& test_case : kTestCases) {
        SCOPED_TRACE(test_case.desc);
        auto actual = EventReportWindows::FromJSON(base::test::ParseJsonDict(test_case.json), test_case.expiry, test_case.source_type);
        EXPECT_THAT(actual, test_case.matches);
    }
}
...
{
    const EventReportWindows kDefaultReportWindows = *EventReportWindows::Create(base::Hours(0), { base::Hours(2), base::Days(1), base::Days(7) });
    ...
    for (const auto& test_case : kTestCases) {
        EXPECT_EQ(kDefaultReportWindows.ComputeReportTime(kSourceTime, test_case.trigger_time), test_case.expected);
    }
}

TEST(EventReportWindowsTest, ReportTimeAtWindow)
{
    const EventReportWindows kDefaultReportWindows = *EventReportWindows::Create(base::Hours(0), { base::Hours(1), base::Days(3), base::Days(7) });
    ...
    for (const auto& test_case : kTestCases) {
        EXPECT_EQ(kDefaultReportWindows.ReportTimeAtWindow(kSourceTime, test_case.index), test_case.expected);
    }
}
...
TEST(EventReportWindowsTest, StartTimeAtWindow)
{
    ...
    for (const auto& test_case : kTestCases) {
        EXPECT_EQ(kDefaultReportWindows.StartTimeAtWindow(kSourceTime, test_case.index), test_case.expected);
    }
}

TEST(EventReportWindowsTest, FallsWithin)
{
    const EventReportWindows kDefaultReportWindows = *EventReportWindows::Create(base::Hours(1), { base::Hours(2) });
    const EventReportWindows kDefaultReportWindowsNoStartTime = *EventReportWindows::Create(base::Hours(0), { base::Hours(2) });
    ...
    for (const auto& test_case : kTestCases) {
        EXPECT_EQ(test_case.report_windows.FallsWithin(test_case.trigger_moment), test_case.expected);
    }
}
...
TEST(EventReportWindowsTest, Serialize)
{
    const struct {
        ...
        {
            *EventReportWindows::Create(base::Seconds(0), { base::Days(1), base::Days(5) }),
            R"json({"event_report_windows": {
            "start_time":0,
        ...
        {
            *EventReportWindows::Create(base::Hours(1), { base::Days(1), base::Days(5) }),
            R"json({"event_report_windows": {
            "start_time":3600,
            "end_times":[86400,432000]
          }})json",
