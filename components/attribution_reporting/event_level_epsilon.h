...
public:
    static base::expected<EventLevelEpsilon, mojom::SourceRegistrationError> Parse(const base::Value::Dict&);
...
class COMPONENT_EXPORT(ATTRIBUTION_REPORTING) ScopedMaxEventLevelEpsilonForTesting {
public:
    explicit ScopedMaxEventLevelEpsilonForTesting(double);

    ~ScopedMaxEventLevelEpsilonForTesting();

    ScopedMaxEventLevelEpsilonForTesting(const ScopedMaxEventLevelEpsilonForTesting&) = delete;
    ScopedMaxEventLevelEpsilonForTesting& operator=(const ScopedMaxEventLevelEpsilonForTesting&) = delete;

    ScopedMaxEventLevelEpsilonForTesting(ScopedMaxEventLevelEpsilonForTesting&&) = delete;
    ScopedMaxEventLevelEpsilonForTesting& operator=(ScopedMaxEventLevelEpsilonForTesting&&) = delete;
