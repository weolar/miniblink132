...
public:
    ...
    static base::expected<AggregatableNamedBudgetDefs, mojom::SourceRegistrationError> FromJSON(const base::Value*);
    ...
    friend bool operator==(const AggregatableNamedBudgetDefs&, const AggregatableNamedBudgetDefs&) = default;
