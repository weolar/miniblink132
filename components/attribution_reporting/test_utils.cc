...
FiltersDisjunction FiltersForSourceType(mojom::SourceType source_type, std::optional<base::TimeDelta> lookback_window)
{
...
TriggerSpecs SpecsFromWindowList(const std::vector<int>& windows_per_type, bool collapse_into_single_spec, MaxEventLevelReports max_event_level_reports)
{
    ...
    bool supportable_by_single_spec = base::ranges::all_of(windows_per_type, [&](int w) { return w == windows_per_type[0]; });
    ...
    if (collapse_into_single_spec && supportable_by_single_spec) {
        ...
        raw_specs.emplace_back(*attribution_reporting::EventReportWindows::Create(base::Days(0), std::move(deltas)));
    } else {
    ...
    return *attribution_reporting::TriggerSpecs::Create(std::move(indices), std::move(raw_specs), max_event_level_reports);
}

std::ostream& operator<<(std::ostream& out, const AggregationKeys& aggregation_keys)
{
...
std::ostream& operator<<(std::ostream& out, const DestinationSet& destination_set)
{
    return out << destination_set.ToJson();
}

std::ostream& operator<<(std::ostream& out, const EventReportWindows& event_report_windows)
{
    base::Value::Dict dict;
...
std::ostream& operator<<(std::ostream& out, const AttributionScopesSet& attribution_scopes_set)
{
    base::Value::Dict dict;
...
std::ostream& operator<<(std::ostream& out, const AttributionScopesData& attribution_scopes_data)
{
    return out << attribution_scopes_data.ToJson();
}

std::ostream& operator<<(std::ostream& out, const AggregatableNamedBudgetDefs& budgets)
{
    base::Value::Dict dict;
...
std::ostream& operator<<(std::ostream& out, const AggregatableTriggerData& trigger_data)
{
    return out << trigger_data.ToJson();
}

std::ostream& operator<<(std::ostream& out, const EventTriggerData& event_trigger)
{
    return out << event_trigger.ToJson();
}

std::ostream& operator<<(std::ostream& out, const AggregatableNamedBudgetCandidate& budget)
{
...
std::ostream& operator<<(std::ostream& out, const AggregatableDedupKey& aggregatable_dedup_key)
{
...
{
    return out << "{url=" << item.url << ", debug_reporting=" << item.debug_reporting << "}";
}
...
std::ostream& operator<<(std::ostream& out, const TriggerSpecs::const_iterator& it)
{
    if (!it) {
        return out << "(end)";
    }
...
std::ostream& operator<<(std::ostream& out, const AggregatableTriggerConfig& aggregatable_trigger_config)
{
    base::Value::Dict dict;
...
{
    return out << "{trigger_data=" << r.trigger_data << ",window_index=" << r.window_index << "}";
}
...
std::ostream& operator<<(std::ostream& out, const AggregatableDebugReportingConfig& v)
{
    base::Value::Dict dict;
    v.Serialize(dict);
    return out << dict;
...
std::ostream& operator<<(std::ostream& out, const SourceAggregatableDebugReportingConfig& v)
{
    base::Value::Dict dict;
    v.Serialize(dict);
    return out << dict;
...
std::ostream& operator<<(std::ostream& out, const AggregatableDebugReportingContribution& v)
{
    return out << "{key_piece=" << HexEncodeAggregationKey(v.key_piece()) << ",value=" << v.value() << "}";
}
