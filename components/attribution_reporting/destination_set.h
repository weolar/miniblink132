...
public:
    ...
    static base::expected<DestinationSet, mojom::SourceRegistrationError> FromJSON(const base::Value*);
    ...
    friend bool operator==(const DestinationSet&, const DestinationSet&) = default;
