...
public:
    static std::optional<AggregatableValuesValue> Create(int value, uint64_t filtering_id);

    static base::expected<AggregatableValuesValue, mojom::TriggerRegistrationError> FromJSON(const base::Value&, mojom::TriggerRegistrationError);
    ...
    friend bool operator==(const AggregatableValuesValue&, const AggregatableValuesValue&) = default;
...
public:
    ...
    static base::expected<std::vector<AggregatableValues>, mojom::TriggerRegistrationError> FromJSON(base::Value*);
    ...
    friend bool operator==(const AggregatableValues&, const AggregatableValues&) = default;
