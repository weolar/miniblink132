...
using IssueTypes = base::EnumSet<IssueType, IssueType::kMinValue, IssueType::kMaxValue>;

struct /*COMPONENT_EXPORT(ATTRIBUTION_REPORTING)*/ RegistrarInfo {
    static RegistrarInfo Get(
        bool has_web_header, bool has_os_header, bool is_source, std::optional<Registrar> preferred_platform, network::mojom::AttributionSupport);
