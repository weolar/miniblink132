...
TEST(TriggerDataMatchingTest, Parse)
{
    const struct {
        const char* desc;
        const char* json;
        ::testing::Matcher<base::expected<TriggerDataMatching, SourceRegistrationError>> matches;
    } kTestCases[] = {
        {
            .desc = "missing",
            .json = R"json({})json",
        ...
        },
        {
            ...
            .matches = ErrorIs(SourceRegistrationError::kTriggerDataMatchingValueInvalid),
        },
        {
            .desc = "invalid_value",
...
TEST(TriggerSpecsTest, Default)
{
    ...
    EXPECT_THAT(TriggerSpecs(SourceType::kEvent, kReportWindows, MaxEventLevelReports(SourceType::kEvent)),
        AllOf(Property(&TriggerSpecs::SingleSharedSpec, IsTrue()), ElementsAre(Pair(0, TriggerSpec(kReportWindows)), Pair(1, TriggerSpec(kReportWindows)))));

    EXPECT_THAT(TriggerSpecs(SourceType::kNavigation, kReportWindows, MaxEventLevelReports(SourceType::kNavigation)),
        AllOf(Property(&TriggerSpecs::SingleSharedSpec, IsTrue()),
            ElementsAre(Pair(0, TriggerSpec(kReportWindows)), Pair(1, TriggerSpec(kReportWindows)), Pair(2, TriggerSpec(kReportWindows)),
                Pair(3, TriggerSpec(kReportWindows)), Pair(4, TriggerSpec(kReportWindows)), Pair(5, TriggerSpec(kReportWindows)),
                Pair(6, TriggerSpec(kReportWindows)), Pair(7, TriggerSpec(kReportWindows)))));
}
...
TEST(TriggerSpecsTest, Parse)
{
    ...
    const struct {
        ...
        ::testing::Matcher<base::expected<TriggerSpecs, SourceRegistrationError>> matches_full_flex;

        ::testing::Matcher<base::expected<TriggerSpecs, SourceRegistrationError>> matches_top_level_trigger_data;
    } kTestCases[] = {
        {
            .desc = "missing_navigation",
            .json = R"json({})json",
            .source_type = SourceType::kNavigation,
            .matches_full_flex = ValueIs(TriggerSpecs(SourceType::kNavigation, kDefaultReportWindows, MaxEventLevelReports(SourceType::kNavigation))),
            .matches_top_level_trigger_data
            = ValueIs(TriggerSpecs(SourceType::kNavigation, kDefaultReportWindows, MaxEventLevelReports(SourceType::kNavigation))),
        },
        {
            .desc = "missing_event",
            .json = R"json({})json",
            .source_type = SourceType::kEvent,
            .matches_full_flex = ValueIs(TriggerSpecs(SourceType::kEvent, kDefaultReportWindows, MaxEventLevelReports(SourceType::kEvent))),
            .matches_top_level_trigger_data = ValueIs(TriggerSpecs(SourceType::kEvent, kDefaultReportWindows, MaxEventLevelReports(SourceType::kEvent))),
        },
        {
            .desc = "trigger_specs_wrong_type",
            .json = R"json({"trigger_specs": 1})json",
            .matches_full_flex = ErrorIs(SourceRegistrationError::kTriggerSpecsWrongType),
        ...
        },
        {
            ...
            .matches_full_flex
            = ValueIs(AllOf(Property(&TriggerSpecs::empty, true), Property(&TriggerSpecs::size, 0u), Property(&TriggerSpecs::SingleSharedSpec, IsNull()), //
                IsEmpty())),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
            ...
            .matches_full_flex = ErrorIs(SourceRegistrationError::kTriggerSpecExcessiveTriggerData),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
        ...
        },
        {
            ...
            .json = R"json({"trigger_specs": [{}]})json",
            .matches_full_flex = ErrorIs(SourceRegistrationError::kTriggerSpecTriggerDataMissing),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
            .desc = "trigger_data_wrong_type",
            .json = R"json({"trigger_data": 1})json",
            .matches_full_flex = ErrorIs(SourceRegistrationError::kTriggerDataListInvalid),
            .matches_top_level_trigger_data = ErrorIs(SourceRegistrationError::kTriggerDataListInvalid),
        },
        {
            .desc = "spec_trigger_data_empty",
            .json = R"json({"trigger_specs": [{"trigger_data": []}]})json",
            .matches_full_flex = ErrorIs(SourceRegistrationError::kTriggerSpecTriggerDataListInvalid),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
        ...
        },
        {
            ...
            .matches_full_flex = ErrorIs(SourceRegistrationError::kExcessiveTriggerData),
            .matches_top_level_trigger_data = ErrorIs(SourceRegistrationError::kExcessiveTriggerData),
        },
        {
        ...
        },
        {
            ...
            .matches_top_level_trigger_data = ValueIs(AllOf(Property(&TriggerSpecs::empty, false), Property(&TriggerSpecs::size, 1u),
                Property(&TriggerSpecs::SingleSharedSpec, IsTrue()), ElementsAre(Key(0)))),
        },
        {
            ...
            .matches_top_level_trigger_data = ValueIs(ElementsAre(Key(4294967295))),
        },
        {
        ...
        },
        {
            ...
            .matches_full_flex = ErrorIs(SourceRegistrationError::kDuplicateTriggerData),
            .matches_top_level_trigger_data = ErrorIs(SourceRegistrationError::kDuplicateTriggerData),
        },
        {
            ...
            .matches_full_flex = ErrorIs(SourceRegistrationError::kTriggerSpecDuplicateTriggerData),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
        ...
        },
        {
            ...
            .matches_full_flex = ErrorIs(SourceRegistrationError::kInvalidTriggerDataForMatchingMode),
            .matches_top_level_trigger_data = ErrorIs(SourceRegistrationError::kInvalidTriggerDataForMatchingMode),
        },
        {
        ...
        },
        {
            ...
            .matches_full_flex = ErrorIs(SourceRegistrationError::kEventReportWindowsWrongType),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
            ...
            .matches_full_flex = ValueIs(
                ElementsAre(Pair(_, Property(&TriggerSpec::event_report_windows, Property(&EventReportWindows::end_times, ElementsAre(base::Seconds(3601))))))),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
            ...
            .matches_full_flex = ValueIs(ElementsAre(Pair(_, TriggerSpec(kDefaultReportWindows)))),
            .matches_top_level_trigger_data = ValueIs(_),
        },
        {
            .desc = "top_level_trigger_data_and_trigger_specs",
            .json = R"json({"trigger_data": [], "trigger_specs": []})json",
            .matches_full_flex = ErrorIs(SourceRegistrationError::kTopLevelTriggerDataAndTriggerSpecs),
        ...
        },
        {
            ...
            .matches_full_flex = ValueIs(Property(&TriggerSpecs::max_event_level_reports, 5)),
            .matches_top_level_trigger_data = ValueIs(Property(&TriggerSpecs::max_event_level_reports, 5)),
        },
        {
            // Tested more thoroughly in `max_event_level_reports_unittest.cc`
            .desc = "max_event_level_reports_invalid",
            .json = R"json({"max_event_level_reports":null})json",
            .matches_full_flex = ErrorIs(SourceRegistrationError::kMaxEventLevelReportsValueInvalid),
            .matches_top_level_trigger_data = ErrorIs(SourceRegistrationError::kMaxEventLevelReportsValueInvalid),
        },
    };
    ...
    for (const auto& test_case : kTestCases) {
...

        {
            ...
            EXPECT_THAT(TriggerSpecs::ParseFullFlexForTesting(dict, test_case.source_type, kExpiry, kDefaultReportWindows, test_case.trigger_data_matching),
...

        {
            ...
            EXPECT_THAT(TriggerSpecs::ParseTopLevelTriggerData(dict, test_case.source_type, kDefaultReportWindows, test_case.trigger_data_matching),
...
{
    {
        ...
        EXPECT_FALSE(kSpecs.find(/*trigger_data=*/1, TriggerDataMatching::kModulus));
    }
    ...
    const struct {
        ...
        { TriggerDataMatching::kExact, std::numeric_limits<uint64_t>::max(), kSpecs.end() },
        ...
        { TriggerDataMatching::kModulus, std::numeric_limits<uint64_t>::max(), Optional(Pair(5, kSpecList[0])) },
    };
    ...
    for (const auto& test_case : kTestCases) {
        ...
        EXPECT_THAT(kSpecs.find(test_case.trigger_data, test_case.trigger_data_matching), test_case.matches);
    }
}
...
TEST(TriggerSpecsTest, Find_ModulusContiguous)
{
    ...
    for (const auto& test_case : kTestCases) {
        ...
        EXPECT_THAT(kSpecs.find(test_case.trigger_data, TriggerDataMatching::kModulus), test_case.matches);
    }
}
