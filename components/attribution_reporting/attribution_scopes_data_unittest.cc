...
TEST(AttributionScopesDataTest, Parse)
{
    const struct {
        const char* desc;
        const char* json;
        ::testing::Matcher<base::expected<AttributionScopesData, SourceRegistrationError>> matches;
    } kTestCases[] = {
        {
            "wrong_type",
            R"json([])json",
        ...
        },
        {
            ...
            ValueIs(*AttributionScopesData::Create(AttributionScopesSet({ "1" }),
                /*attribution_scope_limit=*/1u, kDefaultMaxEventStates)),
        },
        {
            "empty_scopes",
            R"json({
        ...
        },
        {
            ...
            ValueIs(*AttributionScopesData::Create(AttributionScopesSet({ "1" }), /*attribution_scope_limit=*/1u,
