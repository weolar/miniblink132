...
TEST(AggregatableTriggerDataTest, FromJSON)
{
    struct {
        ...
        base::Value json;
        ::testing::Matcher<base::expected<AggregatableTriggerData, TriggerRegistrationError>> matches;
    } kTestCases[] = {
        {
            ...
            ValueIs(AllOf(Property(&AggregatableTriggerData::key_piece, 4660), Property(&AggregatableTriggerData::source_keys, IsEmpty()),
        ...
        },
        {
            ...
            ValueIs(Property(&AggregatableTriggerData::source_keys, ElementsAre("a", "b"))),
        },
        {
            "filters",
            base::test::ParseJson(R"json({
        ...
        },
        {
            ...
            ErrorIs(TriggerRegistrationError::kAggregatableTriggerDataKeyPieceMissing),
        },
        {
            "key_piece_wrong_type",
            base::test::ParseJson(R"json({"key_piece":123})json"),
            ErrorIs(TriggerRegistrationError::kAggregatableTriggerDataKeyPieceInvalid),
        },
        {
        ...
        },
        {
            ...
            base::test::ParseJson(R"json({"key_piece":"0x1234", "source_keys":{}})json"),
            ErrorIs(TriggerRegistrationError::kAggregatableTriggerDataSourceKeysInvalid),
        },
        {
            "source_keys_key_wrong_type",
            base::test::ParseJson(R"json({"key_piece":"0x1234", "source_keys":[123]})json"),
            ErrorIs(TriggerRegistrationError::kAggregatableTriggerDataSourceKeysInvalid),
        },
        {
            "filters_wrong_type",
    ...
    for (auto& test_case : kTestCases) {
        ...
        EXPECT_THAT(AggregatableTriggerData::FromJSON(test_case.json), test_case.matches);
    }
}
    ...
    const struct {
        ...
        },
        {
            AggregatableTriggerData(
                ...
                /*source_keys=*/ { "a", "b" },
                FilterPair(
                    /*positive=*/ { *FilterConfig::Create({ { "c", {} } }, /*lookback_window=*/base::Seconds(2)) },
