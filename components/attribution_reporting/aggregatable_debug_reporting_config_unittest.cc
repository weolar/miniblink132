...
TEST(AggregatableDebugReportingConfig, Parse)
{
    const struct {
        const char* desc;
        const char* json;
        ::testing::Matcher<base::expected<SourceAggregatableDebugReportingConfig, AggregatableDebugReportingConfigError>> matches_source;
        ::testing::Matcher<base::expected<AggregatableDebugReportingConfig, AggregatableDebugReportingConfigError>> matches_trigger;
        std::optional<AggregatableDebugReportingConfigError> expected_metric_source;
        std::optional<AggregatableDebugReportingConfigError> expected_metric_trigger;
    } kTestCases[] = {
        {
            .desc = "missing",
            .json = R"json({})json",
        ...
        },
        {
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kRootInvalid),
            .matches_trigger = ErrorIs(AggregatableDebugReportingConfigError::kRootInvalid),
            .expected_metric_source = AggregatableDebugReportingConfigError::kRootInvalid,
            .expected_metric_trigger = AggregatableDebugReportingConfigError::kRootInvalid,
        },
        {
            .desc = "budget_missing",
            .json = R"json({
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kBudgetInvalid),
            .matches_trigger = HasValue(),
            .expected_metric_source = AggregatableDebugReportingConfigError::kBudgetInvalid,
        },
        {
        ...
        },
        {
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kKeyPieceInvalid),
            .matches_trigger = ErrorIs(AggregatableDebugReportingConfigError::kKeyPieceInvalid),
            .expected_metric_source = AggregatableDebugReportingConfigError::kKeyPieceInvalid,
            .expected_metric_trigger = AggregatableDebugReportingConfigError::kKeyPieceInvalid,
        },
        {
        ...
        },
        {
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataInvalid),
            .matches_trigger = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataInvalid),
            .expected_metric_source = AggregatableDebugReportingConfigError::kDebugDataInvalid,
            .expected_metric_trigger = AggregatableDebugReportingConfigError::kDebugDataInvalid,
        },
        {
        ...
        },
        {
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataKeyPieceInvalid),
            .matches_trigger = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataKeyPieceInvalid),
            .expected_metric_source = AggregatableDebugReportingConfigError::kDebugDataKeyPieceInvalid,
            .expected_metric_trigger = AggregatableDebugReportingConfigError::kDebugDataKeyPieceInvalid,
        },
        {
        ...
        },
        {
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataValueInvalid),
            .matches_trigger = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataValueInvalid),
            .expected_metric_source = AggregatableDebugReportingConfigError::kDebugDataValueInvalid,
            .expected_metric_trigger = AggregatableDebugReportingConfigError::kDebugDataValueInvalid,
        },
        {
        ...
        },
        {
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataTypesInvalid),
            .matches_trigger = ErrorIs(AggregatableDebugReportingConfigError::kDebugDataTypesInvalid),
            .expected_metric_source = AggregatableDebugReportingConfigError::kDebugDataTypesInvalid,
            .expected_metric_trigger = AggregatableDebugReportingConfigError::kDebugDataTypesInvalid,
        },
        {
        ...
        },
        {
            ...
            .matches_source = ErrorIs(AggregatableDebugReportingConfigError::kAggregationCoordinatorOriginInvalid),
            .matches_trigger = ErrorIs(AggregatableDebugReportingConfigError::kAggregationCoordinatorOriginInvalid),
            .expected_metric_source = AggregatableDebugReportingConfigError::kAggregationCoordinatorOriginInvalid,
            .expected_metric_trigger = AggregatableDebugReportingConfigError::kAggregationCoordinatorOriginInvalid,
        },
        {
        ...
        },
        {
            ...
            .matches_source = ValueIs(AllOf(Property(&SourceAggregatableDebugReportingConfig::budget, 10),
                Property(&SourceAggregatableDebugReportingConfig::config,
                    AllOf(Field(&AggregatableDebugReportingConfig::key_piece, 15),
                        Field(&AggregatableDebugReportingConfig::aggregation_coordinator_origin, *SuitableOrigin::Create(GURL("https://a.test"))),
                        Field(&AggregatableDebugReportingConfig::debug_data,
                            AllOf(SizeIs(kNumSourceDebugDataTypes),
                                testing::Contains(Pair(DebugDataType::kSourceSuccess, *AggregatableDebugReportingContribution::Create(2, 3))))))))),
            .matches_trigger = ValueIs(AllOf(Field(&AggregatableDebugReportingConfig::key_piece, 15),
                Field(&AggregatableDebugReportingConfig::aggregation_coordinator_origin, *SuitableOrigin::Create(GURL("https://a.test"))),
                Field(&AggregatableDebugReportingConfig::debug_data,
                    AllOf(SizeIs(kNumTriggerDebugDataTypes),
                        testing::Contains(Pair(DebugDataType::kTriggerNoMatchingSource, *AggregatableDebugReportingContribution::Create(10, 9))))))),
        },
        {
            ...
            .matches_source = ValueIs(AllOf(Property(&SourceAggregatableDebugReportingConfig::budget, 10),
                Property(&SourceAggregatableDebugReportingConfig::config,
                    Field(&AggregatableDebugReportingConfig::debug_data, testing::Contains(Pair(_, *AggregatableDebugReportingContribution::Create(2, 3))))))),
            .matches_trigger
            = ValueIs(Field(&AggregatableDebugReportingConfig::debug_data, testing::Contains(Pair(_, *AggregatableDebugReportingContribution::Create(2, 3))))),
        },
    };

    aggregation_service::ScopedAggregationCoordinatorAllowlistForTesting scoped_coordinator_allowlist({ url::Origin::Create(GURL("https://a.test")) });

    base::test::ScopedFeatureList scoped_feature_list(features::kAttributionAggregatableDebugReporting);
    ...
    for (const auto& test_case : kTestCases) {
...

        {
            ...
            EXPECT_THAT(SourceAggregatableDebugReportingConfig::Parse(dict), test_case.matches_source);

            if (auto expected_metric_source = test_case.expected_metric_source; expected_metric_source.has_value()) {
                histograms.ExpectUniqueSample("Conversions.AggregatableDebugReporting.SourceRegistrationError", *expected_metric_source, 1);
            }
        }

        {
            ...
            base::Value::Dict dict = base::test::ParseJsonDict(test_case.json);
            EXPECT_THAT(AggregatableDebugReportingConfig::Parse(dict), test_case.matches_trigger);

            if (auto expected_metric_trigger = test_case.expected_metric_trigger; expected_metric_trigger.has_value()) {
                histograms.ExpectUniqueSample("Conversions.AggregatableDebugReporting.TriggerRegistrationError", *expected_metric_trigger, 1);
            }
        }
    }
}
...
TEST(AggregatableDebugReportingConfig, SourceDebugDataTypes)
{
    ...
    for (const auto& test_case : kTestCases) {
        ...
        base::Value::Dict dict = base::test::ParseJsonDict(base::ReplaceStringPlaceholders(json, { test_case.type_str }, /*offsets=*/nullptr));
        EXPECT_THAT(SourceAggregatableDebugReportingConfig::Parse(dict),
            ValueIs(Property(&SourceAggregatableDebugReportingConfig::config,
                Field(&AggregatableDebugReportingConfig::debug_data, ElementsAre(Pair(test_case.expected_type, _))))));
    }
}
...
TEST(AggregatableDebugReportingConfig, TriggerDebugDataTypes)
{
    ...
    for (const auto& test_case : kTestCases) {
        ...
        EXPECT_THAT(AggregatableDebugReportingConfig::Parse(dict),
            ValueIs(Field(&AggregatableDebugReportingConfig::debug_data, ElementsAre(Pair(test_case.expected_type, _)))));
    }
}
