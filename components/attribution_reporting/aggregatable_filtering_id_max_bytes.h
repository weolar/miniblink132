...
public:
    static base::expected<AggregatableFilteringIdsMaxBytes, mojom::TriggerRegistrationError> Parse(const base::Value::Dict&);
    ...
    AggregatableFilteringIdsMaxBytes(const AggregatableFilteringIdsMaxBytes&) = default;
    AggregatableFilteringIdsMaxBytes& operator=(const AggregatableFilteringIdsMaxBytes&) = default;

    AggregatableFilteringIdsMaxBytes(AggregatableFilteringIdsMaxBytes&&) = default;
    AggregatableFilteringIdsMaxBytes& operator=(AggregatableFilteringIdsMaxBytes&&) = default;

    friend bool operator==(AggregatableFilteringIdsMaxBytes, AggregatableFilteringIdsMaxBytes) = default;
