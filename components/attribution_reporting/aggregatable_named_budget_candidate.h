...
public:
    static base::expected<AggregatableNamedBudgetCandidate, mojom::TriggerRegistrationError> FromJSON(base::Value&);
    ...
    AggregatableNamedBudgetCandidate& operator=(const AggregatableNamedBudgetCandidate&);
    AggregatableNamedBudgetCandidate& operator=(AggregatableNamedBudgetCandidate&&);

    base::Value::Dict ToJson() const;

    friend bool operator==(const AggregatableNamedBudgetCandidate&, const AggregatableNamedBudgetCandidate&) = default;
