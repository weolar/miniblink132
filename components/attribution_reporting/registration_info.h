...
struct /*COMPONENT_EXPORT(ATTRIBUTION_REPORTING)*/ RegistrationInfo {
    ...
    static base::expected<RegistrationInfo, RegistrationInfoError> ParseInfo(std::string_view, bool cross_app_web_enabled);
    ...
    friend bool operator==(const RegistrationInfo&, const RegistrationInfo&) = default;
};
