...
TEST(AggregatableValuesTest, Parse_FilteringIdsEnabled)
{
    ...
    const struct {
        ...
        const char* json;
        ::testing::Matcher<base::expected<std::vector<AggregatableValues>, TriggerRegistrationError>> matches;
    } kTestCases[] = { {
                           "empty",
                           R"json({})json",
                           ValueIs(IsEmpty()),
        ...
        },
        {
            ...
            ValueIs(ElementsAre(AllOf(Property(&AggregatableValues::values,
                                          ElementsAre(Pair("a", *AggregatableValuesValue::Create(1, kDefaultFilteringId)),
                                              Pair("b", *AggregatableValuesValue::Create(65536, kDefaultFilteringId)))),
                Property(&AggregatableValues::filters, FilterPair())))),
        },
        {
            "valid_trailing_zero",
            R"json({"a": 2.0})json",
            ValueIs(ElementsAre(Property(&AggregatableValues::values, ElementsAre(Pair("a", *AggregatableValuesValue::Create(2, kDefaultFilteringId)))))),
        },
        {
        ...
        },
        {
            ...
            ValueIs(ElementsAre(AllOf(
                Property(&AggregatableValues::values,
                    ElementsAre(Pair("a", *AggregatableValuesValue::Create(1, kDefaultFilteringId)), Pair("b", *AggregatableValuesValue::Create(65536, 255)))),
                Property(&AggregatableValues::filters, FilterPair())))),
        },
        {
        ...
        },
        {
            ...
            ErrorIs(TriggerRegistrationError::kAggregatableValuesListValuesFieldMissing),
        },
        {
        ...
        },
        {
            ...
            ValueIs(ElementsAre(AllOf(Property(&AggregatableValues::values,
                                          ElementsAre(Pair("a", *AggregatableValuesValue::Create(1, kDefaultFilteringId)),
                                              Pair("b", *AggregatableValuesValue::Create(65536, kDefaultFilteringId)))),
                Property(&AggregatableValues::filters,
                    FilterPair(
    ...
    const struct {
        ...
        },
        {
            *AggregatableValues::Create(
                /*values=*/ { { "a", *AggregatableValuesValue::Create(1, kDefaultFilteringId) }, { "b", *AggregatableValuesValue::Create(2, 25) } },
                FilterPair()),
            R"json({"values":{
        ...
        {
            *AggregatableValues::Create(
                /*values=*/ { { "a", *AggregatableValuesValue::Create(1, 25) }, { "b", *AggregatableValuesValue::Create(2, kDefaultFilteringId) } },
