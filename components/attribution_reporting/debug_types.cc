...
#define SOURCE_DEBUG_DATA_TYPES(X)                                                                                                                             \
    ...
    X(kSourceDestinationPerDayRateLimit, "source-destination-per-day-rate-limit")                                                                              \
    ...
    X(kSourceReportingOriginPerSiteLimit, "source-reporting-origin-per-site-limit")                                                                            \
    ...
    X(kSourceTriggerStateCardinalityLimit, "source-trigger-state-cardinality-limit")                                                                           \
    X(kSourceUnknownError, "source-unknown-error")

#define TRIGGER_DEBUG_DATA_TYPES(X)                                                                                                                            \
    X(kTriggerAggregateAttributionsPerSourceDestinationLimit, "trigger-aggregate-attributions-per-source-destination-limit")                                   \
    ...
    X(kTriggerAggregateInsufficientNamedBudget, "trigger-aggregate-insufficient-named-budget")                                                                 \
    X(kTriggerAggregateInsufficientBudget, "trigger-aggregate-insufficient-budget")                                                                            \
    X(kTriggerAggregateNoContributions, "trigger-aggregate-no-contributions")                                                                                  \
    X(kTriggerAggregateReportWindowPassed, "trigger-aggregate-report-window-passed")                                                                           \
    X(kTriggerAggregateStorageLimit, "trigger-aggregate-storage-limit")                                                                                        \
    X(kTriggerEventAttributionsPerSourceDestinationLimit, "trigger-event-attributions-per-source-destination-limit")                                           \
    ...
    X(kTriggerEventNoMatchingConfigurations, "trigger-event-no-matching-configurations")                                                                       \
    X(kTriggerEventNoMatchingTriggerData, "trigger-event-no-matching-trigger-data")                                                                            \
    X(kTriggerEventNoise, "trigger-event-noise")                                                                                                               \
    X(kTriggerEventReportWindowNotStarted, "trigger-event-report-window-not-started")                                                                          \
...
base::expected<DebugDataType, ParseError> ParseSourceDebugDataType(std::string_view str)
{
    static constexpr auto kTypes = base::MakeFixedFlatMap<std::string_view, DebugDataType>({ SOURCE_DEBUG_DATA_TYPES(STR_TO_TYPE) });
...
base::expected<DebugDataType, ParseError> ParseTriggerDebugDataType(std::string_view str)
{
    static constexpr auto kTypes = base::MakeFixedFlatMap<std::string_view, DebugDataType>({ TRIGGER_DEBUG_DATA_TYPES(STR_TO_TYPE) });
