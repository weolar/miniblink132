...
public:
    ...
    static base::expected<AggregatableTriggerData, mojom::TriggerRegistrationError> FromJSON(base::Value& value);

    AggregatableTriggerData();

    AggregatableTriggerData(absl::uint128 key_piece, Keys source_keys, FilterPair);
    ...
    friend bool operator==(const AggregatableTriggerData&, const AggregatableTriggerData&) = default;
