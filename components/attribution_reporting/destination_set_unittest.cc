...
{
    EXPECT_THAT(DestinationSet::FromJSON(nullptr), ErrorIs(SourceRegistrationError::kDestinationMissing));

    const struct {
        const char* desc;
        const char* json;
        ::testing::Matcher<base::expected<DestinationSet, SourceRegistrationError>> matches;
    } kTestCases[] = {
        {
            "empty",
            R"json(null)json",
        ...
        },
        {
            ...
            ValueIs(Property(&DestinationSet::destinations, ElementsAre(net::SchemefulSite::Deserialize("https://d.example")))),
        },
        {
        ...
        },
        {
            ...
            ValueIs(Property(&DestinationSet::destinations,
                ElementsAre(net::SchemefulSite::Deserialize("https://d.example"), net::SchemefulSite::Deserialize("https://e.example"),
        ...
        },
        {
            ...
            ValueIs(Property(&DestinationSet::destinations,
                ElementsAre(net::SchemefulSite::Deserialize("https://d1.example"), net::SchemefulSite::Deserialize("https://d2.example"),
...
TEST(DestinationSetTest, ToJson)
{
    const struct {
        ...
        {
            *DestinationSet::Create({ net::SchemefulSite::Deserialize("https://d.example") }),
            R"json("https://d.example")json",
        },
        {
            *DestinationSet::Create({ net::SchemefulSite::Deserialize("https://d.example"), net::SchemefulSite::Deserialize("https://e.example"),
                net::SchemefulSite::Deserialize("https://f.example") }),
            R"json(
