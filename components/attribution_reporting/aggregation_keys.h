...
public:
    ...
    static base::expected<AggregationKeys, mojom::SourceRegistrationError> FromJSON(const base::Value*);
    ...
    friend bool operator==(const AggregationKeys&, const AggregationKeys&) = default;
