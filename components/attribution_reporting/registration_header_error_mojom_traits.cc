...
// static
bool StructTraits<attribution_reporting::mojom::RegistrationHeaderErrorDataView, attribution_reporting::RegistrationHeaderError>::Read(
    attribution_reporting::mojom::RegistrationHeaderErrorDataView data, attribution_reporting::RegistrationHeaderError* out)
{
...
UnionTraits<attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView, attribution_reporting::RegistrationHeaderErrorDetails>::GetTag(
    const attribution_reporting::RegistrationHeaderErrorDetails& details)
{
    return absl::visit(base::Overloaded {
                           [](attribution_reporting::mojom::SourceRegistrationError) {
                               return attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView::Tag::kSourceError;
                           },

                           [](attribution_reporting::mojom::TriggerRegistrationError) {
                               return attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView::Tag::kTriggerError;
                           },

                           [](attribution_reporting::OsSourceRegistrationError) {
                               return attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView::Tag::kOsSourceError;
                           },

                           [](attribution_reporting::OsTriggerRegistrationError) {
                               return attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView::Tag::kOsTriggerError;
                           },
                       },
        details);
}
...
// static
bool UnionTraits<attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView, attribution_reporting::RegistrationHeaderErrorDetails>::Read(
    attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView data, attribution_reporting::RegistrationHeaderErrorDetails* out)
{
    switch (data.tag()) {
    ...
    case attribution_reporting::mojom::RegistrationHeaderErrorDetailsDataView::Tag::kOsTriggerError:
        ...
        *out = attribution_reporting::OsTriggerRegistrationError(os_trigger_error);
        return true;
    }
