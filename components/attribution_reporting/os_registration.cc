...
base::expected<std::vector<OsRegistrationItem>, OsRegistrationError> ParseOsSourceOrTriggerHeader(std::string_view header)
{
...
base::expected<std::vector<OsRegistrationItem>, OsRegistrationError> ParseOsSourceOrTriggerHeader(const net::structured_headers::List& list)
{
    ...
    base::UmaHistogramCounts100("Conversions.OsRegistrationItemsPerHeader", items.size());
