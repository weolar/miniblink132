...
COMPONENT_EXPORT(ATTRIBUTION_REPORTING)
base::expected<mojom::DebugDataType, ParseError> ParseSourceDebugDataType(std::string_view);

COMPONENT_EXPORT(ATTRIBUTION_REPORTING)
base::expected<mojom::DebugDataType, ParseError> ParseTriggerDebugDataType(std::string_view);

using DebugDataTypes = base::EnumSet<mojom::DebugDataType, mojom::DebugDataType::kMinValue, mojom::DebugDataType::kMaxValue>;
