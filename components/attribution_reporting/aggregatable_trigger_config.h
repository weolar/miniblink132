...
public:
    static base::expected<AggregatableTriggerConfig, mojom::TriggerRegistrationError> Parse(base::Value::Dict&);

    static std::optional<AggregatableTriggerConfig> Create(
        mojom::SourceRegistrationTimeConfig, std::optional<std::string> trigger_context_id, AggregatableFilteringIdsMaxBytes);
    ...
    friend bool operator==(const AggregatableTriggerConfig&, const AggregatableTriggerConfig&) = default;
...
private:
    AggregatableTriggerConfig(mojom::SourceRegistrationTimeConfig, std::optional<std::string> trigger_context_id, AggregatableFilteringIdsMaxBytes);

    mojom::SourceRegistrationTimeConfig source_registration_time_config_ = mojom::SourceRegistrationTimeConfig::kExclude;
