...
public:
    ...
    std::string::const_iterator token_begin() const
    {
        return token_begin_;
    }
    std::string::const_iterator token_end() const
    {
        return token_end_;
    }
...
// end of the url.
bool ExtractURL(std::string::const_iterator begin, std::string::const_iterator end, std::string::const_iterator* url_begin,
    std::string::const_iterator* url_end, std::string::const_iterator* params_begin)
{
...
//         begin, end, ';', net::HttpUtil::NameValuePairsIterator::Values::NOT_REQUIRED, net::HttpUtil::NameValuePairsIterator::Quotes::STRICT_QUOTES);
...
//         if (!params_iterator.value_is_quoted() && params_iterator.value_piece().empty())
