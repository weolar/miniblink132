...
// printing.
#define EXPECT_BYTES_EQ(expected, actual) EXPECT_EQ(base::HexEncode(expected), base::HexEncode(actual))

#define EXPECT_BYTES_EQ_HEX(expected_hex, actual_bytes) EXPECT_BYTES_EQ(HexStringToBytes(expected_hex), actual_bytes)
