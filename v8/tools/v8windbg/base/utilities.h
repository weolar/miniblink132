...
inline std::u16string ConvertToU16String(std::string utf8_string)
{
    ...
    static_assert(sizeof(wchar_t) == sizeof(char16_t), "wrong wchar size");
    len_chars = ::MultiByteToWideChar(CP_UTF8, 0, utf8_string.c_str(), -1, reinterpret_cast<wchar_t*>(p_buff), len_chars);
...
{
    int len_chars = ::WideCharToMultiByte(CP_UTF8, 0, U16ToWChar(u16string.c_str()), -1, nullptr, 0, nullptr, nullptr);

    char* p_buff = static_cast<char*>(malloc(len_chars * sizeof(char)));

    len_chars = ::WideCharToMultiByte(CP_UTF8, 0, U16ToWChar(u16string.c_str()), -1, p_buff, len_chars, nullptr, nullptr);
...
HRESULT UnboxULong64(IModelObject* object, ULONG64* value, bool convert = false);
