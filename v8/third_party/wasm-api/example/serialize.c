...
int main(int argc, const char* argv[])
{
    ...
    own wasm_func_t* hello_func = wasm_func_new(store, hello_type, hello_callback);
    ...
    own wasm_instance_t* instance = wasm_instance_new(store, deserialized, imports, NULL);
    if (!instance) {
