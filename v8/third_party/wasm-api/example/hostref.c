...
{
    if (actual != expected && !(actual && expected && wasm_ref_same(actual, expected))) {
...
int main(int argc, const char* argv[])
{
    ...
    own wasm_functype_t* callback_type = wasm_functype_new_1_1(wasm_valtype_new(WASM_ANYREF), wasm_valtype_new(WASM_ANYREF));
