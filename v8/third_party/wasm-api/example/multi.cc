...
void run()
{
    ...
    auto tuple = wasm::ownvec<wasm::ValType>::make(
        wasm::ValType::make(wasm::I32), wasm::ValType::make(wasm::I64), wasm::ValType::make(wasm::I64), wasm::ValType::make(wasm::I32));
    auto callback_type = wasm::FuncType::make(tuple.deep_copy(), tuple.deep_copy());
    ...
    wasm::Val args[] = { wasm::Val::i32(1), wasm::Val::i64(2), wasm::Val::i64(3), wasm::Val::i32(4) };
    wasm::Val results[4];
