...
template <> struct ProtocolTypeTraits<std::unique_ptr<DeferredMessage>> {
...
#define V8_CRDTP_DESERIALIZE_FIELD(name, field) V8_CRDTP_DESERIALIZE_FILED_IMPL(name, field, false)
#define V8_CRDTP_DESERIALIZE_FIELD_OPT(name, field) V8_CRDTP_DESERIALIZE_FILED_IMPL(name, field, true)
...
#define V8_CRDTP_SERIALIZE_FIELD(name, field) __serializer.AddField(MakeSpan(name), field)
