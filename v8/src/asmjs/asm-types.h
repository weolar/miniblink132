...
public:
    ...
    enum : uint32_t {
#define DEFINE_TAG(CamelName, string_name, number, parent_types) kAsm##CamelName = ((1u << (number)) | (parent_types)),
...
private:
    ...
    {
        DCHECK_EQ(reinterpret_cast<uintptr_t>(this) & kAsmValueTypeTag, kAsmValueTypeTag);
    ...
    static AsmType* New(bitset_t bits)
    {
        ...
        return reinterpret_cast<AsmType*>(static_cast<uintptr_t>(bits | kAsmValueTypeTag));
    }
...
#define DECLARE_CAST(CamelName)                                                                                                                                \
    virtual Asm##CamelName* As##CamelName()                                                                                                                    \
    {                                                                                                                                                          \
        return nullptr;                                                                                                                                        \
    }
...
class V8_EXPORT_PRIVATE AsmOverloadedFunctionType final : public AsmCallableType {
public:
