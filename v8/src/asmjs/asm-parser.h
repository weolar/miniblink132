...
#undef V
    ...
    explicit AsmJsParser(Zone* zone, uintptr_t stack_limit, Utf16CharacterStream* stream);
    bool Run();
...
#undef V
    ...
    template <typename T> class CachedVectors {
    public:
    ...
    template <typename T> class CachedVector final : public ZoneVector<T> {
    public:
