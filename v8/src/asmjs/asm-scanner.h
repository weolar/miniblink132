...
#define V(name) kToken_##name,
                STDLIB_OTHER_LIST(V) KEYWORD_NAME_LIST(V)
#undef V
...
#undef V
    ...
    static constexpr base::uc32 kEndOfInputU = static_cast<base::uc32>(kEndOfInput);
