...
#define TF_BUILTIN(Name, AssemblerBase)                                                                                                                        \
    ...
    public:                                                                                                                                                    \
        ...
        void Generate##Name##Impl();                                                                                                                           \
                                                                                                                                                               \
        template <class T> TNode<T> Parameter(Descriptor::ParameterIndices index, cppgc::SourceLocation loc = cppgc::SourceLocation::Current())                \
        {                                                                                                                                                      \
            return CodeAssembler::Parameter<T>(static_cast<int>(index), loc);                                                                                  \
        }                                                                                                                                                      \
                                                                                                                                                               \
        template <class T> TNode<T> UncheckedParameter(Descriptor::ParameterIndices index)                                                                     \
        {                                                                                                                                                      \
...
#define TS_BUILTIN(Name, BaseAssembler)                                                                                                                        \
    ...
    public:                                                                                                                                                    \
        using Descriptor = Builtin_##Name##_InterfaceDescriptor;                                                                                               \
        Name##Assembler(compiler::turboshaft::PipelineData* data, Isolate* isolate, compiler::turboshaft::Graph& graph, Zone* phase_zone)                      \
            : BaseAssembler(data, graph, phase_zone)                                                                                                           \
        {                                                                                                                                                      \
        }                                                                                                                                                      \
        void Generate##Name##Impl();                                                                                                                           \
    };                                                                                                                                                         \
    void Builtins::Generate_##Name(compiler::turboshaft::PipelineData* data, Isolate* isolate, compiler::turboshaft::Graph& graph, Zone* phase_zone)           \
    {                                                                                                                                                          \
