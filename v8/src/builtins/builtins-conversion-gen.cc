...
TF_BUILTIN(ToNumber_Baseline, CodeStubAssembler)
{
    ...
    TNode<Number> result = CAST(ToNumberOrNumeric(context, input, &var_type_feedback, Object::Conversion::kToNumber));
...
TF_BUILTIN(ToNumeric_Baseline, CodeStubAssembler)
{
    ...
    TVARIABLE(Smi, var_type_feedback);
    TNode<Numeric> result = ToNumberOrNumeric(context, input, &var_type_feedback, Object::Conversion::kToNumeric);
