...
template <typename Next> class NumberBuiltinsReducer : public Next {
public:
    ...
    V<Object> BitwiseNot(V<Context> context, V<Object> input)
    {
        ...
        __ template TaggedToWord32OrBigIntImpl<Object::Conversion::kToNumeric>(context, input, IsKnownTaggedPointer::kNo, if_number, &if_bigint, nullptr);
        ...
        // BigInt case.
        {
            ...
            GOTO(done, __ CallRuntime_BigIntUnaryOp(isolate_, context, bigint_value, ::Operation::kBitwiseNot));
        }
