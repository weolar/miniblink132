...
#define BUILTIN_LIST_BASE_TIER1(CPP, TSJ, TFJ, TSC, TFC, TFS, TFH, ASM)                                                                                        \
    ...
    TFC(Call_ReceiverIsNullOrUndefined_Baseline_Compact, CallTrampoline_Baseline_Compact)                                                                      \
    TFC(Call_ReceiverIsNullOrUndefined_Baseline, CallTrampoline_Baseline)                                                                                      \
    TFC(Call_ReceiverIsNotNullOrUndefined_Baseline_Compact, CallTrampoline_Baseline_Compact)                                                                   \
    ...
    TFC(Call_ReceiverIsNullOrUndefined_WithFeedback, CallTrampoline_WithFeedback)                                                                              \
    TFC(Call_ReceiverIsNotNullOrUndefined_WithFeedback, CallTrampoline_WithFeedback)                                                                           \
    ...
    TFC(CallFunctionTemplate_CheckAccessAndCompatibleReceiver, CallFunctionTemplate)                                                                           \
                                                                                                                                                               \
    /* Construct */                                                                                                                                            \
    ...
    TFC(ConstructForwardAllArgs_WithFeedback, ConstructForwardAllArgs_WithFeedback)                                                                            \
    ...
    ASM(InterpreterPushArgsThenFastConstructFunction, InterpreterPushArgsThenConstruct)                                                                        \
    ASM(InterpreterPushArgsThenConstructArrayFunction, InterpreterPushArgsThenConstruct)                                                                       \
    ASM(InterpreterPushArgsThenConstructWithFinalSpread, InterpreterPushArgsThenConstruct)                                                                     \
    ...
    ASM(MaglevOptimizeCodeOrTailCallOptimizedCodeSlot, MaglevOptimizeCodeOrTailCallOptimizedCodeSlot)                                                          \
                                                                                                                                                               \
    /* Code life-cycle */                                                                                                                                      \
    ...
    TFH(KeyedStoreIC_SloppyArguments_NoTransitionGrowAndHandleCOW, StoreWithVector)                                                                            \
    TFH(KeyedStoreIC_SloppyArguments_NoTransitionIgnoreTypedArrayOOB, StoreWithVector)                                                                         \
    ...
    TFH(ElementsTransitionAndStore_NoTransitionGrowAndHandleCOW, StoreTransition)                                                                              \
    TFH(ElementsTransitionAndStore_NoTransitionIgnoreTypedArrayOOB, StoreTransition)                                                                           \
    ...
    TFC(CopyDataPropertiesWithExcludedPropertiesOnStack, CopyDataPropertiesWithExcludedPropertiesOnStack)                                                      \
    TFC(CopyDataPropertiesWithExcludedProperties, CopyDataPropertiesWithExcludedProperties)                                                                    \
                                                                                                                                                               \
    /* Abort */                                                                                                                                                \
    TFC(Abort, Abort)                                                                                                                                          \
    ...
    TFC(ArrayNoArgumentConstructor_PackedSmi_DontOverride, ArrayNoArgumentConstructor)                                                                         \
    TFC(ArrayNoArgumentConstructor_HoleySmi_DontOverride, ArrayNoArgumentConstructor)                                                                          \
    TFC(ArrayNoArgumentConstructor_PackedSmi_DisableAllocationSites, ArrayNoArgumentConstructor)                                                               \
    TFC(ArrayNoArgumentConstructor_HoleySmi_DisableAllocationSites, ArrayNoArgumentConstructor)                                                                \
    TFC(ArrayNoArgumentConstructor_Packed_DisableAllocationSites, ArrayNoArgumentConstructor)                                                                  \
    TFC(ArrayNoArgumentConstructor_Holey_DisableAllocationSites, ArrayNoArgumentConstructor)                                                                   \
    TFC(ArrayNoArgumentConstructor_PackedDouble_DisableAllocationSites, ArrayNoArgumentConstructor)                                                            \
    TFC(ArrayNoArgumentConstructor_HoleyDouble_DisableAllocationSites, ArrayNoArgumentConstructor)                                                             \
    TFC(ArraySingleArgumentConstructor_PackedSmi_DontOverride, ArraySingleArgumentConstructor)                                                                 \
    TFC(ArraySingleArgumentConstructor_HoleySmi_DontOverride, ArraySingleArgumentConstructor)                                                                  \
    TFC(ArraySingleArgumentConstructor_PackedSmi_DisableAllocationSites, ArraySingleArgumentConstructor)                                                       \
    TFC(ArraySingleArgumentConstructor_HoleySmi_DisableAllocationSites, ArraySingleArgumentConstructor)                                                        \
    TFC(ArraySingleArgumentConstructor_Packed_DisableAllocationSites, ArraySingleArgumentConstructor)                                                          \
    TFC(ArraySingleArgumentConstructor_Holey_DisableAllocationSites, ArraySingleArgumentConstructor)                                                           \
    TFC(ArraySingleArgumentConstructor_PackedDouble_DisableAllocationSites, ArraySingleArgumentConstructor)                                                    \
    TFC(ArraySingleArgumentConstructor_HoleyDouble_DisableAllocationSites, ArraySingleArgumentConstructor)                                                     \
    ...
    TFS(ArrayIncludesSmi, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                                  \
    TFS(ArrayIncludesSmiOrObject, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                          \
    TFS(ArrayIncludesPackedDoubles, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                        \
    TFS(ArrayIncludesHoleyDoubles, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                         \
    TFJ(ArrayIncludes, kDontAdaptArgumentsSentinel)                                                                                                            \
    /* ES6 #sec-array.prototype.indexof */                                                                                                                     \
    TFS(ArrayIndexOfSmi, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                                   \
    TFS(ArrayIndexOfSmiOrObject, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                           \
    TFS(ArrayIndexOfPackedDoubles, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                         \
    TFS(ArrayIndexOfHoleyDoubles, NeedsContext::kYes, kElements, kSearchElement, kLength, kFromIndex)                                                          \
    ...
    TFS(CreateArrayFromSlowBoilerplate, NeedsContext::kYes, kFeedbackVector, kSlot, kBoilerplateDescriptor, kFlags)                                            \
    TFS(CreateObjectFromSlowBoilerplate, NeedsContext::kYes, kFeedbackVector, kSlot, kBoilerplateDescriptor, kFlags)                                           \
    ...
    TFJ(AsyncFunctionAwaitRejectClosure, kJSArgcReceiverSlots + 1, kReceiver, kSentError)                                                                      \
    TFJ(AsyncFunctionAwaitResolveClosure, kJSArgcReceiverSlots + 1, kReceiver, kSentValue)                                                                     \
                                                                                                                                                               \
    /* BigInt */                                                                                                                                               \
    ...
    TFS(IterableToListMayPreserveHoles, NeedsContext::kYes, kIterable, kIteratorFn)                                                                            \
    TFS(IterableToListConvertHoles, NeedsContext::kYes, kIterable, kIteratorFn)                                                                                \
    IF_WASM(TFS, IterableToFixedArrayForWasm, NeedsContext::kYes, kIterable, kExpectedLength)                                                                  \
                                                                                                                                                               \
    ...
    TFJ(ObjectPrototypeHasOwnProperty, kJSArgcReceiverSlots + 1, kReceiver, kKey)                                                                              \
    TFJ(ObjectPrototypeIsPrototypeOf, kJSArgcReceiverSlots + 1, kReceiver, kValue)                                                                             \
    ...
    TFJ(RegExpConstructor, kJSArgcReceiverSlots + 2, kReceiver, kPattern, kFlags)                                                                              \
    ...
    TFJ(RegExpPrototypeCompile, kJSArgcReceiverSlots + 2, kReceiver, kPattern, kFlags)                                                                         \
    CPP(RegExpPrototypeToString, kDontAdaptArgumentsSentinel)                                                                                                  \
    CPP(RegExpRightContextGetter, JSParameterCount(0))                                                                                                         \
                                                                                                                                                               \
    /* RegExp helpers */                                                                                                                                       \
    TFS(RegExpExecAtom, NeedsContext::kYes, kRegExp, kString, kLastIndex, kMatchInfo)                                                                          \
    TFS(RegExpExecInternal, NeedsContext::kYes, kRegExp, kString, kLastIndex, kMatchInfo)                                                                      \
    ...
    TFS(ShadowRealmGetWrappedValue, NeedsContext::kYes, kCreationContext, kTargetContext, kValue)                                                              \
    CPP(ShadowRealmPrototypeEvaluate, JSParameterCount(1))                                                                                                     \
    TFJ(ShadowRealmPrototypeImportValue, kJSArgcReceiverSlots + 2, kReceiver, kSpecifier, kExportName)                                                         \
    TFJ(ShadowRealmImportValueFulfilled, kJSArgcReceiverSlots + 1, kReceiver, kExports)                                                                        \
    TFJ(ShadowRealmImportValueRejected, kJSArgcReceiverSlots + 1, kReceiver, kException)                                                                       \
                                                                                                                                                               \
    /* SharedArrayBuffer */                                                                                                                                    \
    ...
    CPP(SharedArrayBufferPrototypeGrow, JSParameterCount(1))                                                                                                   \
                                                                                                                                                               \
    TFJ(AtomicsLoad, kJSArgcReceiverSlots + 2, kReceiver, kArrayOrSharedObject, kIndexOrFieldName)                                                             \
    TFJ(AtomicsStore, kJSArgcReceiverSlots + 3, kReceiver, kArrayOrSharedObject, kIndexOrFieldName, kValue)                                                    \
    TFJ(AtomicsExchange, kJSArgcReceiverSlots + 3, kReceiver, kArrayOrSharedObject, kIndexOrFieldName, kValue)                                                 \
    TFJ(AtomicsCompareExchange, kJSArgcReceiverSlots + 4, kReceiver, kArrayOrSharedObject, kIndexOrFieldName, kOldValue, kNewValue)                            \
    ...
    TFJ(StringPrototypeReplace, kJSArgcReceiverSlots + 2, kReceiver, kSearch, kReplace)                                                                        \
    ...
    TFJ(AsyncGeneratorAwaitResolveClosure, kJSArgcReceiverSlots + 1, kReceiver, kValue)                                                                        \
    TFJ(AsyncGeneratorAwaitRejectClosure, kJSArgcReceiverSlots + 1, kReceiver, kValue)                                                                         \
    TFJ(AsyncGeneratorYieldWithAwaitResolveClosure, kJSArgcReceiverSlots + 1, kReceiver, kValue)                                                               \
    TFJ(AsyncGeneratorReturnClosedResolveClosure, kJSArgcReceiverSlots + 1, kReceiver, kValue)                                                                 \
    TFJ(AsyncGeneratorReturnClosedRejectClosure, kJSArgcReceiverSlots + 1, kReceiver, kValue)                                                                  \
    TFJ(AsyncGeneratorReturnResolveClosure, kJSArgcReceiverSlots + 1, kReceiver, kValue)                                                                       \
                                                                                                                                                               \
    ...
    TFJ(AsyncFromSyncIteratorCloseSyncAndRethrow, kJSArgcReceiverSlots + 1, kReceiver, kError)                                                                 \
    ...
    TFS(GetPropertyWithReceiver, NeedsContext::kYes, kObject, kKey, kReceiver, kOnNonExistent)                                                                 \
    ...
    ASM(MemMove, CCall)                                                                                                                                        \
    TFC(FindNonDefaultConstructorOrConstruct, FindNonDefaultConstructorOrConstruct)                                                                            \
    ...
    CPP(TemporalPlainDateTimePrototypeWithPlainTime, kDontAdaptArgumentsSentinel)                                                                              \
    /* Temporal #sec-temporal.plaindatetime.prototype.withplainDate */                                                                                         \
    CPP(TemporalPlainDateTimePrototypeWithPlainDate, kDontAdaptArgumentsSentinel)                                                                              \
    ...
    CPP(TemporalPlainDateTimePrototypeToLocaleString, kDontAdaptArgumentsSentinel)                                                                             \
    ...
    CPP(TemporalPlainDateTimePrototypeToZonedDateTime, kDontAdaptArgumentsSentinel)                                                                            \
    ...
    CPP(TemporalPlainDateTimePrototypeToPlainYearMonth, kDontAdaptArgumentsSentinel)                                                                           \
    /* Temporal #sec-temporal.plaindatetime.prototype.toplainmonthday */                                                                                       \
    CPP(TemporalPlainDateTimePrototypeToPlainMonthDay, kDontAdaptArgumentsSentinel)                                                                            \
    ...
    CPP(TemporalZonedDateTimePrototypeWithPlainTime, kDontAdaptArgumentsSentinel)                                                                              \
    /* Temporal #sec-temporal.zoneddatetime.prototype.withplaindate */                                                                                         \
    CPP(TemporalZonedDateTimePrototypeWithPlainDate, kDontAdaptArgumentsSentinel)                                                                              \
    ...
    CPP(TemporalZonedDateTimePrototypeToLocaleString, kDontAdaptArgumentsSentinel)                                                                             \
    ...
    CPP(TemporalZonedDateTimePrototypeToPlainDateTime, kDontAdaptArgumentsSentinel)                                                                            \
    /* Temporal #sec-temporal.zoneddatetime.prototype.toplainyearmonth */                                                                                      \
    CPP(TemporalZonedDateTimePrototypeToPlainYearMonth, kDontAdaptArgumentsSentinel)                                                                           \
    /* Temporal #sec-temporal.zoneddatetime.prototype.toplainmonthday */                                                                                       \
    CPP(TemporalZonedDateTimePrototypeToPlainMonthDay, kDontAdaptArgumentsSentinel)                                                                            \
    ...
    CPP(TemporalPlainYearMonthPrototypeToLocaleString, kDontAdaptArgumentsSentinel)                                                                            \
    ...
    CPP(TemporalPlainYearMonthPrototypeGetISOFields, kDontAdaptArgumentsSentinel)                                                                              \
                                                                                                                                                               \
    ...
    CPP(TemporalPlainMonthDayPrototypeToLocaleString, kDontAdaptArgumentsSentinel)                                                                             \
    ...
    CPP(TemporalTimeZonePrototypeGetOffsetNanosecondsFor, kDontAdaptArgumentsSentinel)                                                                         \
    /* Temporal #sec-temporal.timezone.prototype.getoffsetstringfor */                                                                                         \
    CPP(TemporalTimeZonePrototypeGetOffsetStringFor, kDontAdaptArgumentsSentinel)                                                                              \
    /* Temporal #sec-temporal.timezone.prototype.getplaindatetimefor */                                                                                        \
    CPP(TemporalTimeZonePrototypeGetPlainDateTimeFor, kDontAdaptArgumentsSentinel)                                                                             \
    ...
    CPP(TemporalTimeZonePrototypeGetPossibleInstantsFor, kDontAdaptArgumentsSentinel)                                                                          \
    ...
    CPP(TemporalTimeZonePrototypeGetPreviousTransition, kDontAdaptArgumentsSentinel)                                                                           \
    ...
    CPP(TemporalCalendarPrototypeYearMonthFromFields, kDontAdaptArgumentsSentinel)                                                                             \
    /* Temporal #sec-temporal.calendar.prototype.monthdayfromfields */                                                                                         \
    CPP(TemporalCalendarPrototypeMonthDayFromFields, kDontAdaptArgumentsSentinel)                                                                              \
    ...
    TFJ(TemporalCalendarPrototypeFields, kJSArgcReceiverSlots + 1, kReceiver, kIterable)                                                                       \
    ...
    TFJ(StringFixedArrayFromIterable, kJSArgcReceiverSlots + 1, kReceiver, kIterable)                                                                          \
    TFJ(TemporalInstantFixedArrayFromIterable, kJSArgcReceiverSlots + 1, kReceiver, kIterable)
...
// tiers.
#define BUILTIN_LIST_TIER0(CPP, TFJ, TFC, TFS, TFH, BCH, ASM) BUILTIN_LIST_BASE_TIER0(CPP, TFJ, TFC, TFS, TFH, ASM)
...
#define BUILTIN_LIST_C(V)                                                                                                                                      \
    BUILTIN_LIST(V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TSJ(V)                                                                                                                                    \
    BUILTIN_LIST(IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TFJ(V)                                                                                                                                    \
    BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TSC(V)                                                                                                                                    \
    BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TFC(V)                                                                                                                                    \
    BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TFS(V)                                                                                                                                    \
    BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_TFH(V)                                                                                                                                    \
    BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN)

#define BUILTIN_LIST_BCH(V)                                                                                                                                    \
    BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN)

#define BUILTIN_LIST_A(V)                                                                                                                                      \
    BUILTIN_LIST(IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN, V)
