...
#define TEMPORAL_NOW2(T)                                                                                                                                       \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T::Now(isolate, args.atOrUndefined(isolate, 1), args.atOrUndefined(isolate, 2)));                        \
    }
...
#define TEMPORAL_NOW_ISO1(T)                                                                                                                                   \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T::NowISO(isolate, args.atOrUndefined(isolate, 1)));                                                     \
    }
...
#define TEMPORAL_CONSTRUCTOR1(T)                                                                                                                               \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1)));              \
    }
...
#define TEMPORAL_PROTOTYPE_METHOD1(T, METHOD, name)                                                                                                            \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        CHECK_RECEIVER(JSTemporal##T, obj, "Temporal." #T ".prototype." #name);                                                                                \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T ::METHOD(isolate, obj, args.atOrUndefined(isolate, 1)));                                               \
    }
...
#define TEMPORAL_PROTOTYPE_METHOD2(T, METHOD, name)                                                                                                            \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        CHECK_RECEIVER(JSTemporal##T, obj, "Temporal." #T ".prototype." #name);                                                                                \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T ::METHOD(isolate, obj, args.atOrUndefined(isolate, 1), args.atOrUndefined(isolate, 2)));               \
    }
...
#define TEMPORAL_PROTOTYPE_METHOD3(T, METHOD, name)                                                                                                            \
    ...
    {                                                                                                                                                          \
        ...
        RETURN_RESULT_OR_FAILURE(                                                                                                                              \
            isolate, JSTemporal##T ::METHOD(isolate, obj, args.atOrUndefined(isolate, 1), args.atOrUndefined(isolate, 2), args.atOrUndefined(isolate, 3)));    \
    }
...
#define TEMPORAL_METHOD1(T, METHOD)                                                                                                                            \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T ::METHOD(isolate, args.atOrUndefined(isolate, 1)));                                                    \
    }
...
#define TEMPORAL_METHOD2(T, METHOD)                                                                                                                            \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        RETURN_RESULT_OR_FAILURE(isolate, JSTemporal##T ::METHOD(isolate, args.atOrUndefined(isolate, 1), args.atOrUndefined(isolate, 2)));                    \
    }
...
#define TEMPORAL_VALUE_OF(T)                                                                                                                                   \
    ...
    {                                                                                                                                                          \
        ...
        THROW_NEW_ERROR_RETURN_FAILURE(isolate,                                                                                                                \
            NewTypeError(MessageTemplate::kDoNotUse, isolate->factory()->NewStringFromAsciiChecked("Temporal." #T ".prototype.valueOf"),                       \
                isolate->factory()->NewStringFromAsciiChecked("use Temporal." #T ".prototype.compare for comparison.")));                                      \
    }
...
#define TEMPORAL_GET_SMI(T, METHOD, field)                                                                                                                     \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        CHECK_RECEIVER(JSTemporal##T, obj, "get Temporal." #T ".prototype." #field);                                                                           \
...
#define TEMPORAL_GET_NUMBER_AFTER_DIVID(T, M, field, scale, name)                                                                                              \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        CHECK_RECEIVER(JSTemporal##T, handle, "get Temporal." #T ".prototype." #name);                                                                         \
        Handle<BigInt> value;                                                                                                                                  \
        ASSIGN_RETURN_FAILURE_ON_EXCEPTION(                                                                                                                    \
            isolate, value, BigInt::Divide(isolate, Handle<BigInt>(handle->field(), isolate), BigInt::FromUint64(isolate, scale)));                            \
...
#define TEMPORAL_GET_BIGINT_AFTER_DIVID(T, M, field, scale, name)                                                                                              \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        CHECK_RECEIVER(JSTemporal##T, handle, "get Temporal." #T ".prototype." #name);                                                                         \
        RETURN_RESULT_OR_FAILURE(isolate, BigInt::Divide(isolate, Handle<BigInt>(handle->field(), isolate), BigInt::FromUint64(isolate, scale)));              \
    }
...
#define TEMPORAL_GET_BY_FORWARD_CALENDAR(T, METHOD, name)                                                                                                      \
    ...
    {                                                                                                                                                          \
        HandleScope scope(isolate);                                                                                                                            \
        CHECK_RECEIVER(JSTemporal##T, temporal_date, "get Temporal." #T ".prototype." #name);                                                                  \
        RETURN_RESULT_OR_FAILURE(isolate, temporal::Calendar##METHOD(isolate, handle(temporal_date->calendar(), isolate), temporal_date));                     \
    }
...
#define TEMPORAL_GET_BY_INVOKE_CALENDAR_METHOD(T, METHOD, name)                                                                                                \
    ...
    {                                                                                                                                                          \
        ...
        CHECK_RECEIVER(JSTemporal##T, date_like, "get Temporal." #T ".prototype." #name);                                                                      \
        ...
        RETURN_RESULT_OR_FAILURE(isolate, temporal::InvokeCalendarMethod(isolate, calendar, isolate->factory()->name##_string(), date_like));                  \
    }
...
BUILTIN(TemporalPlainDateConstructor)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate,
        JSTemporalPlainDate::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1), // iso_year
...
BUILTIN(TemporalPlainTimeConstructor)
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate,
        JSTemporalPlainTime::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1), // hour
...
BUILTIN(TemporalPlainDateTimeConstructor)
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate,
        JSTemporalPlainDateTime::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1), // iso_year
            args.atOrUndefined(isolate, 2), // iso_month
            args.atOrUndefined(isolate, 3), // iso_day
...
TEMPORAL_GET_BY_INVOKE_CALENDAR_METHOD(PlainDateTime, MonthsInYear, monthsInYear)
...
BUILTIN(TemporalPlainYearMonthConstructor)
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate,
        JSTemporalPlainYearMonth::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1), // iso_year
            args.atOrUndefined(isolate, 2), // iso_month
...
TEMPORAL_GET_BY_INVOKE_CALENDAR_METHOD(PlainYearMonth, MonthsInYear, monthsInYear)
...
BUILTIN(TemporalPlainMonthDayConstructor)
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate,
        JSTemporalPlainMonthDay::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1), // iso_month
...
#define TEMPORAL_ZONED_DATE_TIME_GET_PREPARE(M)                                                                                                                \
    ...
    ASSIGN_RETURN_FAILURE_ON_EXCEPTION(isolate, instant, temporal::CreateTemporalInstant(isolate, Handle<BigInt>(zoned_date_time->nanoseconds(), isolate)));   \
    ...
    ASSIGN_RETURN_FAILURE_ON_EXCEPTION(                                                                                                                        \
        isolate, temporal_date_time, temporal::BuiltinTimeZoneGetPlainDateTimeFor(isolate, time_zone, instant, calendar, method_name));
...
#define TEMPORAL_ZONED_DATE_TIME_GET_BY_FORWARD_TIME_ZONE_AND_CALENDAR(M)                                                                                      \
    ...
    {                                                                                                                                                          \
        ...
        RETURN_RESULT_OR_FAILURE(isolate, temporal::Calendar##M(isolate, calendar, temporal_date_time));                                                       \
    }
...
BUILTIN(TemporalZonedDateTimeConstructor)
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate,
        JSTemporalZonedDateTime::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1), // epoch_nanoseconds
...
TEMPORAL_GET_NUMBER_AFTER_DIVID(ZonedDateTime, EpochSeconds, nanoseconds, 1000000000, epochSeconds)
TEMPORAL_GET_NUMBER_AFTER_DIVID(ZonedDateTime, EpochMilliseconds, nanoseconds, 1000000, epochMilliseconds)
TEMPORAL_GET_BIGINT_AFTER_DIVID(ZonedDateTime, EpochMicroseconds, nanoseconds, 1000, epochMicroseconds)
...
TEMPORAL_ZONED_DATE_TIME_GET_INT_BY_FORWARD_TIME_ZONE(Millisecond, iso_millisecond)
TEMPORAL_ZONED_DATE_TIME_GET_INT_BY_FORWARD_TIME_ZONE(Microsecond, iso_microsecond)
TEMPORAL_ZONED_DATE_TIME_GET_INT_BY_FORWARD_TIME_ZONE(Nanosecond, iso_nanosecond)
...
BUILTIN(TemporalDurationConstructor)
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate,
        JSTemporalDuration::Constructor(isolate, args.target(), args.new_target(), args.atOrUndefined(isolate, 1), // years
...
BUILTIN(TemporalDurationCompare)
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(
        isolate, JSTemporalDuration::Compare(isolate, args.atOrUndefined(isolate, 1), args.atOrUndefined(isolate, 2), args.atOrUndefined(isolate, 3)));
}
...
TEMPORAL_GET_NUMBER_AFTER_DIVID(Instant, EpochSeconds, nanoseconds, 1000000000, epochSeconds)
TEMPORAL_GET_NUMBER_AFTER_DIVID(Instant, EpochMilliseconds, nanoseconds, 1000000, epochMilliseconds)
TEMPORAL_GET_BIGINT_AFTER_DIVID(Instant, EpochMicroseconds, nanoseconds, 1000, epochMicroseconds)
...
BUILTIN(TemporalCalendarPrototypeId)
{
    ...
    CHECK_RECEIVER(JSTemporalCalendar, calendar, "Temporal.Calendar.prototype.id");
...
BUILTIN(TemporalCalendarPrototypeToJSON)
{
    ...
    // 2. Perform ? RequireInternalSlot(calendar,
    // [[InitializedTemporalCalendar]]).
    CHECK_RECEIVER(JSTemporalCalendar, calendar, "Temporal.Calendar.prototype.toJSON");
    // 3. Return ? ToString(calendar).
    RETURN_RESULT_OR_FAILURE(isolate, Object::ToString(isolate, calendar));
}
...
BUILTIN(TemporalCalendarPrototypeToString)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, JSTemporalCalendar::ToString(isolate, calendar, method_name));
}
...
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate, temporal::ToTemporalCalendar(isolate, args.atOrUndefined(isolate, 1), "Temporal.Calendar.from"));
}
...
TEMPORAL_PROTOTYPE_METHOD1(TimeZone, GetOffsetNanosecondsFor, getOffsetNanosecondsFor)
...
TEMPORAL_PROTOTYPE_METHOD1(TimeZone, GetPossibleInstantsFor, getPossibleInstantFor)
TEMPORAL_PROTOTYPE_METHOD1(TimeZone, GetPreviousTransition, getPreviousTransition)
...
BUILTIN(TemporalTimeZonePrototypeId)
{
    ...
    CHECK_RECEIVER(JSTemporalTimeZone, time_zone, "Temporal.TimeZone.prototype.id");
...
BUILTIN(TemporalTimeZonePrototypeToJSON)
{
    ...
    // 2. Perform ? RequireInternalSlot(timeZone,
    // [[InitializedTemporalTimeZone]]).
    CHECK_RECEIVER(JSTemporalTimeZone, time_zone, "Temporal.TimeZone.prototype.toJSON");
    // 3. Return ? ToString(timeZone).
    RETURN_RESULT_OR_FAILURE(isolate, Object::ToString(isolate, time_zone));
}
...
BUILTIN(TemporalTimeZonePrototypeToString)
{
    ...
    RETURN_RESULT_OR_FAILURE(isolate, JSTemporalTimeZone::ToString(isolate, time_zone, method_name));
}
...
{
    HandleScope scope(isolate);
    RETURN_RESULT_OR_FAILURE(isolate, temporal::ToTemporalTimeZone(isolate, args.atOrUndefined(isolate, 1), "Temporal.TimeZone.from"));
}
