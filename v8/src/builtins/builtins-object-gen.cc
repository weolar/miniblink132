...
public:
    explicit ObjectEntriesValuesBuiltinsAssembler(compiler::CodeAssemblerState* state)
...
protected:
    ...
    TNode<JSArray> FastGetOwnValuesOrEntries(
        TNode<Context> context, TNode<JSObject> object, Label* if_call_runtime_with_fast_path, Label* if_no_properties, CollectType collect_type);

    TNode<JSArray> FinalizeValuesOrEntriesJSArray(
        TNode<Context> context, TNode<FixedArray> values_or_entries, TNode<IntPtrT> size, TNode<Map> array_map, Label* if_empty);
};

void ObjectBuiltinsAssembler::ReturnToStringFormat(TNode<Context> context, TNode<String> string)
{
    ...
    Return(CallBuiltin(builtin, context, CallBuiltin(builtin, context, lhs, string), rhs));
}

TNode<JSObject> ObjectBuiltinsAssembler::ConstructAccessorDescriptor(
    TNode<Context> context, TNode<Object> getter, TNode<Object> setter, TNode<BoolT> enumerable, TNode<BoolT> configurable)
{
    TNode<NativeContext> native_context = LoadNativeContext(context);
    TNode<Map> map = CAST(LoadContextElement(native_context, Context::ACCESSOR_PROPERTY_DESCRIPTOR_MAP_INDEX));
    TNode<JSObject> js_desc = AllocateJSObjectFromMap(map);

    StoreObjectFieldNoWriteBarrier(js_desc, JSAccessorPropertyDescriptor::kGetOffset, getter);
    StoreObjectFieldNoWriteBarrier(js_desc, JSAccessorPropertyDescriptor::kSetOffset, setter);
    StoreObjectFieldNoWriteBarrier(js_desc, JSAccessorPropertyDescriptor::kEnumerableOffset, SelectBooleanConstant(enumerable));
    StoreObjectFieldNoWriteBarrier(js_desc, JSAccessorPropertyDescriptor::kConfigurableOffset, SelectBooleanConstant(configurable));

    return js_desc;
}

TNode<JSObject> ObjectBuiltinsAssembler::ConstructDataDescriptor(
    TNode<Context> context, TNode<Object> value, TNode<BoolT> writable, TNode<BoolT> enumerable, TNode<BoolT> configurable)
{
    TNode<NativeContext> native_context = LoadNativeContext(context);
    TNode<Map> map = CAST(LoadContextElement(native_context, Context::DATA_PROPERTY_DESCRIPTOR_MAP_INDEX));
    TNode<JSObject> js_desc = AllocateJSObjectFromMap(map);

    StoreObjectFieldNoWriteBarrier(js_desc, JSDataPropertyDescriptor::kValueOffset, value);
    StoreObjectFieldNoWriteBarrier(js_desc, JSDataPropertyDescriptor::kWritableOffset, SelectBooleanConstant(writable));
    StoreObjectFieldNoWriteBarrier(js_desc, JSDataPropertyDescriptor::kEnumerableOffset, SelectBooleanConstant(enumerable));
    StoreObjectFieldNoWriteBarrier(js_desc, JSDataPropertyDescriptor::kConfigurableOffset, SelectBooleanConstant(configurable));

    return js_desc;
}

TNode<BoolT> ObjectEntriesValuesBuiltinsAssembler::IsPropertyEnumerable(TNode<Uint32T> details)
{
...
TNode<BoolT> ObjectEntriesValuesBuiltinsAssembler::IsPropertyKindAccessor(TNode<Uint32T> kind)
{
    return Word32Equal(kind, Int32Constant(static_cast<int>(PropertyKind::kAccessor)));
}

TNode<BoolT> ObjectEntriesValuesBuiltinsAssembler::IsPropertyKindData(TNode<Uint32T> kind)
{
    return Word32Equal(kind, Int32Constant(static_cast<int>(PropertyKind::kData)));
}

void ObjectEntriesValuesBuiltinsAssembler::GetOwnValuesOrEntries(TNode<Context> context, TNode<Object> maybe_object, CollectType collect_type)
{
    TNode<JSReceiver> receiver = ToObject_Inline(context, maybe_object);

    Label if_call_runtime_with_fast_path(this, Label::kDeferred), if_call_runtime(this, Label::kDeferred), if_no_properties(this, Label::kDeferred);
    ...
    TNode<JSArray> result = FastGetOwnValuesOrEntries(context, object, &if_call_runtime_with_fast_path, &if_no_properties, collect_type);
    Return(result);
    ...
    BIND(&if_no_properties);
    {
        ...
        TNode<JSArray> empty_array = AllocateJSArray(PACKED_ELEMENTS, array_map, IntPtrConstant(0), SmiConstant(0));
        Return(empty_array);
    }
    ...
    BIND(&if_call_runtime);
    {
        // In slow case, we simply call runtime.
        if (collect_type == CollectType::kEntries) {
            Return(CallRuntime(Runtime::kObjectEntriesSkipFastPath, context, receiver));
        } else {
            DCHECK(collect_type == CollectType::kValues);
            Return(CallRuntime(Runtime::kObjectValuesSkipFastPath, context, receiver));
        }
    }
}
    ...
    TNode<Context> context, TNode<JSObject> object, Label* if_call_runtime_with_fast_path, Label* if_no_properties, CollectType collect_type)
{
    ...
    Label if_has_enum_cache(this), if_not_has_enum_cache(this), collect_entries(this);
    TNode<IntPtrT> object_enum_length = Signed(DecodeWordFromWord32<Map::Bits3::EnumLengthBits>(bit_field3));
    TNode<BoolT> has_enum_cache = WordNotEqual(object_enum_length, IntPtrConstant(kInvalidEnumCacheSentinel));
    ...
    BIND(&if_has_enum_cache);
    {
        ...
        TNode<FixedArray> values_or_entries = CAST(AllocateFixedArray(PACKED_ELEMENTS, object_enum_length));
        ...
        FillFixedArrayWithValue(PACKED_ELEMENTS, values_or_entries, IntPtrConstant(0), object_enum_length, RootIndex::kTheHoleValue);
        ...
        Label loop(this, { &var_descriptor_number, &var_result_index }), after_loop(this), next_descriptor(this);
        Branch(IntPtrEqual(var_descriptor_number.value(), object_enum_length), &after_loop, &loop);
        ...
        BIND(&loop);
        {
            ...
            TNode<Name> next_key = LoadKeyByDescriptorEntry(descriptors, descriptor_entry);
            ...
            TNode<IntPtrT> descriptor_name_index = ToKeyIndex<DescriptorArray>(Unsigned(TruncateIntPtrToInt32(var_descriptor_number.value())));

            // Let value be ? Get(O, key).
            LoadPropertyFromFastObject(object, map, descriptors, descriptor_name_index, details, &var_property_value);
            ...
            if (collect_type == CollectType::kEntries) {
                ...
                std::tie(array, elements)
                    = AllocateUninitializedJSArrayWithElements(PACKED_ELEMENTS, array_map, SmiConstant(2), std::nullopt, IntPtrConstant(2));
            ...
            StoreFixedArrayElement(values_or_entries, var_result_index.value(), value);
            ...
            BIND(&next_descriptor);
            {
                ...
                Branch(IntPtrEqual(var_result_index.value(), object_enum_length), &after_loop, &loop);
            }
        }
        BIND(&after_loop);
        return FinalizeValuesOrEntriesJSArray(context, values_or_entries, var_result_index.value(), array_map, if_no_properties);
    }
}

TNode<JSArray> ObjectEntriesValuesBuiltinsAssembler::FinalizeValuesOrEntriesJSArray(
    TNode<Context> context, TNode<FixedArray> result, TNode<IntPtrT> size, TNode<Map> array_map, Label* if_empty)
{
...
TF_BUILTIN(ObjectPrototypeHasOwnProperty, ObjectBuiltinsAssembler)
{
    ...
    Label call_runtime(this), return_true(this), return_false(this), to_primitive(this);
...

    {
        ...
        Label if_index(this, &var_index), if_unique_name(this), if_notunique_name(this);
        TryToName(key, &if_index, &var_index, &if_unique_name, &var_unique, &call_runtime, &if_notunique_name);

        BIND(&if_unique_name);
        TryHasOwnProperty(heap_object, map, instance_type, var_unique.value(), &return_true, &return_false, &call_runtime);

        BIND(&if_index);
        {
            TryLookupElement(heap_object, map, instance_type, var_index.value(), &return_true, &return_false, &return_false, &call_runtime);
        }

        BIND(&if_notunique_name);
        {
            Label not_in_string_table(this);
            TryInternalizeString(CAST(key), &if_index, &var_index, &if_unique_name, &var_unique, &not_in_string_table, &call_runtime);
            ...
            BIND(&not_in_string_table);
            {
                ...
                Branch(IsSpecialReceiverInstanceType(instance_type), &call_runtime, &return_false);
            }
        }
    }
    BIND(&to_primitive);
...
TF_BUILTIN(ObjectAssign, ObjectBuiltinsAssembler)
{
    ...
    GotoIfForceSlowPath(&slow_path);
    {
        ...
        // enumerable properties" state in an Object.assign sidestep transition.
        {
            ...
            // current one.
            TNode<NativeContext> native_context = LoadNativeContext(context);
            TNode<Map> empty_object_literal_map = LoadObjectFunctionInitialMap(native_context);
            GotoIfNot(TaggedEqual(to_map, empty_object_literal_map), &slow_path);
            // Double-check that the meta map is not contextless.
            CSA_DCHECK(this, TaggedEqual(native_context, LoadMapConstructorOrBackPointerOrNativeContext(to_meta_map)));
        }
        ...
        constexpr uint32_t field3_exclusion_mask
            = Map::Bits3::IsDictionaryMapBit::kMask | Map::Bits3::IsDeprecatedBit::kMask | Map::Bits3::IsPrototypeMapBit::kMask;
        ...
        TNode<Uint32T> field3_descriptors_and_extensible_mask
            = Uint32Constant(Map::Bits3::NumberOfOwnDescriptorsBits::kMask | Map::Bits3::IsExtensibleBit::kMask | field3_exclusion_mask);
        // If the masked field3 equals the extensible bit, then the number of
        // descriptors was 0 -- which is what we need here.
        GotoIfNot(Word32Equal(Uint32Constant(Map::Bits3::IsExtensibleBit::encode(true)), Word32And(target_field3, field3_descriptors_and_extensible_mask)),
            &slow_path);
        ...
        TNode<Uint32T> field3_exclusion_mask_const = Uint32Constant(field3_exclusion_mask);
        GotoIfNot(Word32Equal(Uint32Constant(0), Word32And(source_field3, field3_exclusion_mask_const)), &slow_path);
        CSA_DCHECK(this,
            Word32BinaryNot(IsElementsKindInRange(LoadElementsKind(to_map), FIRST_ANY_NONEXTENSIBLE_ELEMENTS_KIND, LAST_ANY_NONEXTENSIBLE_ELEMENTS_KIND)));
        ...
        GotoIfNot(TaggedEqual(LoadElements(CAST(to)), EmptyFixedArrayConstant()), &slow_path);
        ...
        CSA_DCHECK(this, Word32Or(TaggedEqual(properties, EmptyFixedArrayConstant()), IsPropertyArray(CAST(properties))));
        ...
        TVARIABLE(Map, clone_map);
        {
            ...
            TNode<Object> side_step_transitions = CAST(LoadWeakFixedArrayElement(transitions, IntPtrConstant(TransitionArray::kSideStepTransitionsIndex)));
            GotoIf(TaggedIsSmi(side_step_transitions), &runtime_map_lookup);
            TNode<MaybeObject> maybe_target_map
                = LoadWeakFixedArrayElement(CAST(side_step_transitions), IntPtrConstant(SideStepTransition::index_of(SideStepTransition::Kind::kObjectAssign)));
            GotoIf(TaggedEqual(maybe_target_map, SmiConstant(SideStepTransition::Unreachable)), &slow_path);
            GotoIf(TaggedEqual(maybe_target_map, SmiConstant(SideStepTransition::Empty)), &runtime_map_lookup);
            TNode<Map> target_map = CAST(GetHeapObjectAssumeWeak(maybe_target_map, &runtime_map_lookup));
            GotoIf(IsDeprecatedMap(target_map), &runtime_map_lookup);
            TNode<MaybeObject> maybe_validity_cell = LoadWeakFixedArrayElement(
                CAST(side_step_transitions), IntPtrConstant(SideStepTransition::index_of(SideStepTransition::Kind::kObjectAssignValidityCell)));
            TNode<Cell> validity_cell = CAST(GetHeapObjectAssumeWeak(maybe_validity_cell, &runtime_map_lookup));
            GotoIfNot(TaggedEqual(LoadCellValue(validity_cell), SmiConstant(Map::kPrototypeChainValid)), &runtime_map_lookup);
            clone_map = target_map;
        }
        Goto(&continue_fast_path);

        BIND(&runtime_map_lookup);
        TNode<HeapObject> maybe_clone_map = CAST(CallRuntime(Runtime::kObjectAssignTryFastcase, context, from, to));
        ...
        CSA_DCHECK(this, IntPtrEqual(LoadMapInstanceSizeInWords(to_map), LoadMapInstanceSizeInWords(clone_map.value())));
        CSA_DCHECK(this, IntPtrEqual(LoadMapInobjectPropertiesStartInWords(to_map), LoadMapInobjectPropertiesStartInWords(clone_map.value())));
        FastCloneJSObject(
        ...
        Branch(IntPtrGreaterThan(args_length, IntPtrConstant(2)), &slow_path, &done);
    }
    BIND(&slow_path);
    ...
    {
        args.ForEach([=, this](TNode<Object> next_source) { CallBuiltin(Builtin::kSetDataProperties, context, to, next_source); }, slow_path_index.value());
        Goto(&done);
    }
...
TF_BUILTIN(ObjectKeys, ObjectBuiltinsAssembler)
{
    ...
    Label if_empty(this, Label::kDeferred), if_empty_elements(this), if_fast(this), if_slow(this, Label::kDeferred), if_join(this);
    ...
    TNode<UintPtrT> object_enum_length = DecodeWordFromWord32<Map::Bits3::EnumLengthBits>(object_bit_field3);
    GotoIf(WordEqual(object_enum_length, IntPtrConstant(kInvalidEnumCacheSentinel)), &if_slow);
    ...
    Branch(IsEmptySlowElementDictionary(object_elements), &if_empty_elements, &if_slow);
    ...
    BIND(&if_fast);
    {
        ...
        TNode<EnumCache> object_enum_cache = LoadObjectField<EnumCache>(object_descriptors, DescriptorArray::kEnumCacheOffset);
        auto object_enum_keys = LoadObjectField<FixedArrayBase>(object_enum_cache, EnumCache::kKeysOffset);
        ...
        std::tie(array, elements) = AllocateUninitializedJSArrayWithElements(PACKED_ELEMENTS, array_map, array_length, std::nullopt, object_enum_length_intptr);
    ...
    BIND(&if_slow);
    {
        ...
        TNode<FixedArray> elements = CAST(CallRuntime(Runtime::kObjectKeys, context, object));
    ...
    BIND(&if_join);
    {
        ...
        TNode<NativeContext> native_context = LoadNativeContext(context);
        TNode<Map> array_map = LoadJSArrayElementsMap(PACKED_ELEMENTS, native_context);
        TNode<JSArray> array = AllocateJSArray(array_map, var_elements.value(), var_length.value());
        Return(array);
    }
}
...
TF_BUILTIN(ObjectHasOwn, ObjectBuiltinsAssembler)
{
    ...
    Branch(IsNullOrUndefined(object), &undefined_or_null, &not_undefined_nor_null);

    BIND(&undefined_or_null);
    ThrowTypeError(context, MessageTemplate::kUndefinedOrNullToObject);

    BIND(&not_undefined_nor_null);
    Return(CallJSBuiltin(Builtin::kObjectPrototypeHasOwnProperty, context, target, new_target, object, key));
}
...
TF_BUILTIN(ObjectGetOwnPropertyNames, ObjectBuiltinsAssembler)
{
    ...
    TVARIABLE(Smi, var_length);
    TVARIABLE(FixedArrayBase, var_elements);
    Label if_empty(this, Label::kDeferred), if_empty_elements(this), if_fast(this), try_fast(this, Label::kDeferred), if_slow(this, Label::kDeferred),
        if_join(this);
    ...
    TNode<Uint32T> object_bit_field3 = LoadMapBitField3(object_map);
    TNode<UintPtrT> object_enum_length = DecodeWordFromWord32<Map::Bits3::EnumLengthBits>(object_bit_field3);
    GotoIf(WordEqual(object_enum_length, IntPtrConstant(kInvalidEnumCacheSentinel)), &try_fast);

    // Check whether all own properties are enumerable.
    TNode<UintPtrT> number_descriptors = DecodeWordFromWord32<Map::Bits3::NumberOfOwnDescriptorsBits>(object_bit_field3);
    ...
    BIND(&try_fast);
    {
        ...
        TNode<FixedArray> elements = CAST(CallRuntime(Runtime::kObjectGetOwnPropertyNamesTryFast, context, object));
        var_length = LoadObjectField<Smi>(elements, offsetof(FixedArray, length_));
        var_elements = elements;
        Goto(&if_join);
    }
    ...
    {
        // Let the runtime compute the elements.
        TNode<FixedArray> elements = CAST(CallRuntime(Runtime::kObjectGetOwnPropertyNames, context, object));
        var_length = LoadObjectField<Smi>(elements, offsetof(FixedArray, length_));
        var_elements = elements;
        Goto(&if_join);
    }
...
TF_BUILTIN(ObjectPrototypeIsPrototypeOf, ObjectBuiltinsAssembler)
{
    ...
    auto context = Parameter<Context>(Descriptor::kContext);
    Label if_receiverisnullorundefined(this, Label::kDeferred), if_valueisnotreceiver(this, Label::kDeferred);
...
TF_BUILTIN(ObjectToString, ObjectBuiltinsAssembler)
{
    ...
    Label checkstringtag(this), if_arguments(this), if_array(this), if_boolean(this), if_date(this), if_error(this), if_function(this),
        if_number(this, Label::kDeferred), if_object(this), if_primitive(this), if_proxy(this, { &var_holder, &var_holder_map }, Label::kDeferred),
        if_regexp(this), if_string(this), if_symbol(this, Label::kDeferred), if_value(this), if_bigint(this, Label::kDeferred);
    ...
    const struct {
        InstanceType value;
        Label* label;
    } kJumpTable[] = { { JS_OBJECT_TYPE, &if_object }, { JS_ARRAY_TYPE, &if_array }, { JS_REG_EXP_TYPE, &if_regexp },
        { JS_ARGUMENTS_OBJECT_TYPE, &if_arguments }, { JS_DATE_TYPE, &if_date }, { JS_API_OBJECT_TYPE, &if_object }, { JS_SPECIAL_API_OBJECT_TYPE, &if_object },
        { JS_PROXY_TYPE, &if_proxy }, { JS_ERROR_TYPE, &if_error }, { JS_PRIMITIVE_WRAPPER_TYPE, &if_value } };
    ...
    Switch(receiver_instance_type, &if_object, case_values, case_labels, arraysize(case_values));
    ...
    {
        TNode<NativeContext> native_context = LoadNativeContext(context);
        TNode<JSFunction> boolean_constructor = CAST(LoadContextElement(native_context, Context::BOOLEAN_FUNCTION_INDEX));
        TNode<Map> boolean_initial_map = LoadObjectField<Map>(boolean_constructor, JSFunction::kPrototypeOrInitialMapOffset);
        TNode<HeapObject> boolean_prototype = LoadObjectField<HeapObject>(boolean_initial_map, Map::kPrototypeOffset);
    ...
    {
        TNode<NativeContext> native_context = LoadNativeContext(context);
        TNode<JSFunction> number_constructor = CAST(LoadContextElement(native_context, Context::NUMBER_FUNCTION_INDEX));
        TNode<Map> number_initial_map = LoadObjectField<Map>(number_constructor, JSFunction::kPrototypeOrInitialMapOffset);
    ...
    {
        TNode<NativeContext> native_context = LoadNativeContext(context);
        TNode<JSFunction> string_constructor = CAST(LoadContextElement(native_context, Context::STRING_FUNCTION_INDEX));
        TNode<Map> string_initial_map = LoadObjectField<Map>(string_constructor, JSFunction::kPrototypeOrInitialMapOffset);
    ...
    {
        TNode<NativeContext> native_context = LoadNativeContext(context);
        TNode<JSFunction> symbol_constructor = CAST(LoadContextElement(native_context, Context::SYMBOL_FUNCTION_INDEX));
        TNode<Map> symbol_initial_map = LoadObjectField<Map>(symbol_constructor, JSFunction::kPrototypeOrInitialMapOffset);
    ...
    {
        TNode<NativeContext> native_context = LoadNativeContext(context);
        TNode<JSFunction> bigint_constructor = CAST(LoadContextElement(native_context, Context::BIGINT_FUNCTION_INDEX));
        TNode<Map> bigint_initial_map = LoadObjectField<Map>(bigint_constructor, JSFunction::kPrototypeOrInitialMapOffset);
        TNode<HeapObject> bigint_prototype = LoadObjectField<HeapObject>(bigint_initial_map, Map::kPrototypeOffset);
        var_default = ObjectToStringConstant();
    ...
    BIND(&if_value);
    {
        Label if_value_is_number(this, Label::kDeferred), if_value_is_boolean(this, Label::kDeferred), if_value_is_symbol(this, Label::kDeferred),
            if_value_is_bigint(this, Label::kDeferred), if_value_is_string(this, Label::kDeferred);

        TNode<Object> receiver_value = LoadJSPrimitiveWrapperValue(CAST(receiver_heap_object));
        ...
        TNode<Uint16T> receiver_value_instance_type = LoadMapInstanceType(receiver_value_map);
        GotoIf(IsBigIntInstanceType(receiver_value_instance_type), &if_value_is_bigint);
    ...
    BIND(&checkstringtag);
    {
        ...
        TNode<Object> tag = GetInterestingProperty(context, receiver, &var_holder, &var_holder_map, ToStringTagSymbolConstant(), &return_default);
    ...
    BIND(&if_proxy);
    {
        ...
        TNode<HeapObject> handler = CAST(LoadObjectField(receiver_heap_object, JSProxy::kHandlerOffset));
        ...
        // observable.
        TNode<Object> receiver_is_array = CallRuntime(Runtime::kArrayIsArray, context, receiver_heap_object);
        TNode<String> builtin_tag = Select<String>(
            IsTrue(receiver_is_array), [=, this] { return ArrayStringConstant(); },
            [=, this] {
                return Select<String>(
                    IsCallableMap(receiver_map), [=, this] { return FunctionStringConstant(); }, [=, this] { return ObjectStringConstant(); });
            });

        // Lookup the @@toStringTag property on the {receiver_heap_object}.
        TVARIABLE(Object, var_tag, GetProperty(context, receiver_heap_object, isolate()->factory()->to_string_tag_symbol()));
        Label if_tagisnotstring(this), if_tagisstring(this);
        GotoIf(TaggedIsSmi(var_tag.value()), &if_tagisnotstring);
        Branch(IsString(CAST(var_tag.value())), &if_tagisstring, &if_tagisnotstring);
        ...
        {
            ThrowTypeError(context, MessageTemplate::kProxyRevoked, "Object.prototype.toString");
        }
    }
}
...
TF_BUILTIN(ObjectCreate, ObjectBuiltinsAssembler)
{
    ...
    Label call_runtime(this, Label::kDeferred), prototype_valid(this), no_properties(this);
    ...
    BIND(&prototype_valid);
    {
        ...
        GotoIfNot(TaggedEqual(LoadElements(CAST(properties)), EmptyFixedArrayConstant()), &call_runtime);
        // Handle dictionary objects or fast objects with properties in runtime.
        TNode<Uint32T> bit_field3 = LoadMapBitField3(properties_map);
        GotoIf(IsSetWord32<Map::Bits3::IsDictionaryMapBit>(bit_field3), &call_runtime);
        Branch(IsSetWord32<Map::Bits3::NumberOfOwnDescriptorsBits>(bit_field3), &call_runtime, &no_properties);
    }
    ...
    BIND(&no_properties);
    {
        ...
        BIND(&non_null_proto);
        {
            ...
            GotoIf(TaggedEqual(prototype, LoadMapPrototype(map.value())), &instantiate_map);
            // Try loading the prototype info.
            TNode<PrototypeInfo> prototype_info = LoadMapPrototypeInfo(LoadMap(CAST(prototype)), &call_runtime);
            Comment("Load ObjectCreateMap from PrototypeInfo");
            TNode<HeapObject> derived_maps = CAST(LoadObjectField(prototype_info, PrototypeInfo::kDerivedMapsOffset));
            ...
            CSA_DCHECK(this, InstanceTypeEqual(LoadInstanceType(derived_maps), WEAK_ARRAY_LIST_TYPE));
            TNode<MaybeObject> maybe_map = UncheckedCast<MaybeObject>(LoadObjectField(derived_maps, IntPtrConstant(WeakArrayList::kHeaderSize)));
        ...
        {
            TNode<JSObject> instance = AllocateJSObjectFromMap(map.value(), new_properties.value());
    ...
    BIND(&call_runtime);
    {
        TNode<Object> result = CallRuntime(Runtime::kObjectCreate, native_context, prototype, properties);
...
TF_BUILTIN(CreateIterResultObject, ObjectBuiltinsAssembler)
{
    ...
    const TNode<Map> map = CAST(LoadContextElement(native_context, Context::ITERATOR_RESULT_MAP_INDEX));
...
TF_BUILTIN(CreateGeneratorObject, ObjectBuiltinsAssembler)
{
    ...
    TNode<SharedFunctionInfo> shared = LoadObjectField<SharedFunctionInfo>(closure, JSFunction::kSharedFunctionInfoOffset);
    ...
    TNode<IntPtrT> parameter_count = Signed(ChangeUint32ToWord(LoadBytecodeArrayParameterCountWithoutReceiver(bytecode_array)));

    TNode<IntPtrT> frame_size = ChangeInt32ToIntPtr(LoadObjectField<Int32T>(bytecode_array, BytecodeArray::kFrameSizeOffset));
    TNode<IntPtrT> length = IntPtrAdd(WordSar(frame_size, IntPtrConstant(kSystemPointerSizeLog2)), parameter_count);
    TNode<FixedArrayBase> parameters_and_registers = AllocateFixedArray(HOLEY_ELEMENTS, length);
    FillFixedArrayWithValue(HOLEY_ELEMENTS, parameters_and_registers, IntPtrConstant(0), length, RootIndex::kUndefinedValue);
    // TODO(cbruni): support start_offset to avoid double initialization.
    TNode<JSObject> result = AllocateJSObjectFromMap(map, std::nullopt, std::nullopt, AllocationFlag::kNone, kWithSlackTracking);
    StoreObjectFieldNoWriteBarrier(result, JSGeneratorObject::kFunctionOffset, closure);
    StoreObjectFieldNoWriteBarrier(result, JSGeneratorObject::kContextOffset, context);
    StoreObjectFieldNoWriteBarrier(result, JSGeneratorObject::kReceiverOffset, receiver);
    StoreObjectFieldNoWriteBarrier(result, JSGeneratorObject::kParametersAndRegistersOffset, parameters_and_registers);
    TNode<Smi> resume_mode = SmiConstant(JSGeneratorObject::ResumeMode::kNext);
    StoreObjectFieldNoWriteBarrier(result, JSGeneratorObject::kResumeModeOffset, resume_mode);
    TNode<Smi> executing = SmiConstant(JSGeneratorObject::kGeneratorExecuting);
    StoreObjectFieldNoWriteBarrier(result, JSGeneratorObject::kContinuationOffset, executing);
    GotoIfNot(InstanceTypeEqual(LoadMapInstanceType(map), JS_ASYNC_GENERATOR_OBJECT_TYPE), &done);
    StoreObjectFieldNoWriteBarrier(result, JSAsyncGeneratorObject::kIsAwaitingOffset, SmiConstant(0));
    Goto(&done);
    ...
    BIND(&runtime);
    {
        Return(CallRuntime(Runtime::kCreateJSGeneratorObject, context, closure, receiver));
    }
}
...
TF_BUILTIN(OrdinaryGetOwnPropertyDescriptor, ObjectBuiltinsAssembler)
{
    ...
    CSA_DCHECK(this, Word32BinaryNot(IsSpecialReceiverInstanceType(LoadMapInstanceType(LoadMap(object)))));

    Label if_notunique_name(this), if_iskeyunique(this), done(this), if_keyisindex(this), call_runtime(this);

    TVARIABLE(IntPtrT, var_index, IntPtrConstant(0));
    TVARIABLE(Name, var_name, name);
    TVARIABLE(HeapObject, result, UndefinedConstant());

    TryToName(name, &if_keyisindex, &var_index, &if_iskeyunique, &var_name, &call_runtime, &if_notunique_name);
    ...
    BIND(&if_notunique_name);
    {
        ...
        TryInternalizeString(CAST(name), &if_keyisindex, &var_index, &if_iskeyunique, &var_name, &done, &call_runtime);
    }
    ...
    BIND(&if_iskeyunique);
    {
        ...
        TryGetOwnProperty(context, object, object, map, instance_type, var_name.value(), &if_found_value, &var_value, &var_details, &var_raw_value, &done,
            &call_runtime, kReturnAccessorPair);

        BIND(&if_found_value);

        // 4. Return FromPropertyDetails(desc).
        result = AllocatePropertyDescriptorObject(context);
        InitializePropertyDescriptorObject(CAST(result.value()), var_value.value(), var_details.value(), &call_runtime);
        Goto(&done);
    }
    ...
    BIND(&call_runtime);
    TailCallRuntime(Runtime::kGetOwnPropertyDescriptorObject, context, object, var_name.value());
}
...
TF_BUILTIN(ObjectGetOwnPropertyDescriptor, ObjectBuiltinsAssembler)
{
    ...
    TNode<Object> desc = CallBuiltin(Builtin::kGetOwnPropertyDescriptor, context, object, key);
...
void ObjectBuiltinsAssembler::AddToDictionaryIf(TNode<BoolT> condition, TNode<Context> context, TNode<Object> object, TNode<HeapObject> name_dictionary,
    Handle<Name> name, TNode<Object> value, Label* bailout)
{
    Label done(this);
    GotoIfNot(condition, &done);

    AddToDictionary<PropertyDictionary>(CAST(name_dictionary), HeapConstantNoHole(name), value, bailout);
    Goto(&done);

    BIND(&done);
}

TNode<JSObject> ObjectBuiltinsAssembler::FromPropertyDescriptor(TNode<Context> context, TNode<PropertyDescriptorObject> desc)
{
    TVARIABLE(JSObject, js_descriptor);

    TNode<Int32T> flags = LoadAndUntagToWord32ObjectField(desc, PropertyDescriptorObject::kFlagsOffset);

    TNode<Int32T> has_flags = Word32And(flags, Int32Constant(PropertyDescriptorObject::kHasMask));

    Label if_accessor_desc(this), if_data_desc(this), if_generic_desc(this), return_desc(this);
    GotoIf(Word32Equal(has_flags, Int32Constant(PropertyDescriptorObject::kRegularAccessorPropertyBits)), &if_accessor_desc);
    GotoIf(Word32Equal(has_flags, Int32Constant(PropertyDescriptorObject::kRegularDataPropertyBits)), &if_data_desc);
    Goto(&if_generic_desc);

    BIND(&if_accessor_desc);
    {
        js_descriptor = ConstructAccessorDescriptor(context, LoadObjectField(desc, PropertyDescriptorObject::kGetOffset),
            LoadObjectField(desc, PropertyDescriptorObject::kSetOffset), IsSetWord32<PropertyDescriptorObject::IsEnumerableBit>(flags),
    ...
    BIND(&if_data_desc);
    {
        js_descriptor = ConstructDataDescriptor(context, LoadObjectField(desc, PropertyDescriptorObject::kValueOffset),
            IsSetWord32<PropertyDescriptorObject::IsWritableBit>(flags), IsSetWord32<PropertyDescriptorObject::IsEnumerableBit>(flags),
            IsSetWord32<PropertyDescriptorObject::IsConfigurableBit>(flags));
        Goto(&return_desc);
    }
    ...
    {
        TNode<NativeContext> native_context = LoadNativeContext(context);
        TNode<Map> map = CAST(LoadContextElement(native_context, Context::SLOW_OBJECT_WITH_OBJECT_PROTOTYPE_MAP));
        ...
        AddToDictionaryIf(IsNotTheHole(value), context, js_desc, properties, factory->value_string(), value, &bailout);
        AddToDictionaryIf(IsSetWord32<PropertyDescriptorObject::HasWritableBit>(flags), context, js_desc, properties, factory->writable_string(),
            SelectBooleanConstant(IsSetWord32<PropertyDescriptorObject::IsWritableBit>(flags)), &bailout);

        TNode<Object> get = LoadObjectField(desc, PropertyDescriptorObject::kGetOffset);
        AddToDictionaryIf(IsNotTheHole(get), context, js_desc, properties, factory->get_string(), get, &bailout);
        TNode<Object> set = LoadObjectField(desc, PropertyDescriptorObject::kSetOffset);
        AddToDictionaryIf(IsNotTheHole(set), context, js_desc, properties, factory->set_string(), set, &bailout);

        AddToDictionaryIf(IsSetWord32<PropertyDescriptorObject::HasEnumerableBit>(flags), context, js_desc, properties, factory->enumerable_string(),
            SelectBooleanConstant(IsSetWord32<PropertyDescriptorObject::IsEnumerableBit>(flags)), &bailout);
        AddToDictionaryIf(IsSetWord32<PropertyDescriptorObject::HasConfigurableBit>(flags), context, js_desc, properties, factory->configurable_string(),
            SelectBooleanConstant(IsSetWord32<PropertyDescriptorObject::IsConfigurableBit>(flags)), &bailout);
...
TNode<HeapObject> ObjectBuiltinsAssembler::FromPropertyDescriptor(TNode<Context> context, TNode<Object> desc)
{
    CSA_DCHECK(this, TaggedIsNotSmi(desc));

    if (IsUndefinedConstant(desc))
...
TNode<JSObject> ObjectBuiltinsAssembler::FromPropertyDetails(TNode<Context> context, TNode<Object> raw_value, TNode<Word32T> details, Label* if_bailout)
{
    TVARIABLE(JSObject, js_descriptor);
    ...
    BIND(&if_accessor_desc);
    {
        ...
        TNode<HeapObject> getter = LoadObjectField<HeapObject>(accessor_pair_value, AccessorPair::kGetterOffset);
        TNode<HeapObject> setter = LoadObjectField<HeapObject>(accessor_pair_value, AccessorPair::kSetterOffset);
        js_descriptor = ConstructAccessorDescriptor(context, GetAccessorOrUndefined(getter, if_bailout), GetAccessorOrUndefined(setter, if_bailout),
            IsNotSetWord32(details, PropertyDetails::kAttributesDontEnumMask), IsNotSetWord32(details, PropertyDetails::kAttributesDontDeleteMask));
        Goto(&return_desc);
    }

    BIND(&if_data_desc);
    {
        js_descriptor = ConstructDataDescriptor(context, raw_value, IsNotSetWord32(details, PropertyDetails::kAttributesReadOnlyMask),
            IsNotSetWord32(details, PropertyDetails::kAttributesDontEnumMask), IsNotSetWord32(details, PropertyDetails::kAttributesDontDeleteMask));
        Goto(&return_desc);
    }
