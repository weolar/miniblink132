...
void Generate_JSBuiltinsConstructStubHelper(MacroAssembler* masm)
{
    ...
    // Enter a construct frame.
    {
        ...
        __ Daddu(t2, fp, Operand(StandardFrameConstants::kCallerSPOffset + kSystemPointerSize));
...
void Builtins::Generate_JSConstructStubGeneric(MacroAssembler* masm)
{
    ...
    __ Branch(&leave_and_return, greater_equal, t2, Operand(FIRST_JS_RECEIVER_TYPE));
    ...
    MacroAssembler* masm, Register sfi, Register bytecode, Register scratch1, Label* is_baseline, Label* is_unavailable)
{
    ...
    __ Ld(data, FieldMemOperand(sfi, SharedFunctionInfo::kTrustedFunctionDataOffset));
...
void Builtins::Generate_ResumeGeneratorTrampoline(MacroAssembler* masm)
{
    ...
    __ RecordWriteField(a1, JSGeneratorObject::kInputOrDebugPosOffset, v0, a3, kRAHasNotBeenSaved, SaveFPRegsMode::kIgnore);
    ...
    __ Ld(t1, FieldMemOperand(a1, JSGeneratorObject::kParametersAndRegistersOffset));
    {
        ...
        __ Ld(kScratchReg, FieldMemOperand(kScratchReg, OFFSET_OF_DATA_START(FixedArray)));
        __ Push(kScratchReg);
        __ Branch(&loop);
        __ bind(&done_loop);
        // Push receiver.
    ...
    if (v8_flags.debug_code) {
        ...
        __ Ld(a3, FieldMemOperand(a4, JSFunction::kSharedFunctionInfoOffset));
        GetSharedFunctionInfoBytecodeOrBaseline(masm, a3, a3, a0, &is_baseline, &is_unavailable);
        __ jmp(&ok);
...
static void LeaveInterpreterFrame(MacroAssembler* masm, Register scratch1, Register scratch2)
{
    ...
    __ Ld(params_size, MemOperand(fp, InterpreterFrameConstants::kBytecodeArrayFromFp));
    __ Lhu(params_size, FieldMemOperand(params_size, BytecodeArray::kParameterSizeOffset));

    Register actual_params_size = scratch2;
    // Compute the size of the actual parameters + receiver (in bytes).
    __ Ld(actual_params_size, MemOperand(fp, StandardFrameConstants::kArgCOffset));
    ...
    Register scratch2, Register scratch3, Label* if_return)
{
    ...
    __ Daddu(bytecode_size_table, bytecode_size_table, Operand(kByteSize * interpreter::Bytecodes::kBytecodeCount));
    ...
    __ Daddu(scratch2, bytecode_array, bytecode_offset);
    __ Lbu(bytecode, MemOperand(scratch2));
    __ Daddu(bytecode_size_table, bytecode_size_table, Operand(2 * kByteSize * interpreter::Bytecodes::kBytecodeCount));
...
{
    __ Ld(scratch, FieldMemOperand(js_function, JSFunction::kSharedFunctionInfoOffset));
...
void Builtins::Generate_BaselineOutOfLinePrologue(MacroAssembler* masm)
{
    ...
    __ Ld(feedback_cell, FieldMemOperand(closure, JSFunction::kFeedbackCellOffset));
    __ Ld(feedback_vector, FieldMemOperand(feedback_cell, FeedbackCell::kValueOffset));
    {
        UseScratchRegisterScope temps(masm);
...
void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm, InterpreterEntryTrampolineMode mode)
{
    ...
    __ Ld(kScratchReg, FieldMemOperand(closure, JSFunction::kSharedFunctionInfoOffset));
    ResetSharedFunctionInfoAge(masm, kScratchReg);

    // The bytecode array could have been flushed from the shared function info,
    // if so, call into CompileLazy.
    Label is_baseline, compile_lazy;
    GetSharedFunctionInfoBytecodeOrBaseline(masm, kScratchReg, kInterpreterBytecodeArrayRegister, kScratchReg2, &is_baseline, &compile_lazy);
    ...
    __ Daddu(a0, kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister);
    __ Lbu(a7, MemOperand(a0));
    __ Dlsa(kScratchReg, kInterpreterDispatchTableRegister, a7, kSystemPointerSizeLog2);
    ...
    __ Ld(kInterpreterBytecodeArrayRegister, MemOperand(fp, InterpreterFrameConstants::kBytecodeArrayFromFp));
    __ Ld(kInterpreterBytecodeOffsetRegister, MemOperand(fp, InterpreterFrameConstants::kBytecodeOffsetFromFp));
    __ SmiUntag(kInterpreterBytecodeOffsetRegister);

    // Either return, or advance to the next bytecode and dispatch.
    Label do_return;
    __ Daddu(a1, kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister);
    ...
    __ bind(&is_baseline);
    {
        ...
        __ Ld(feedback_vector, FieldMemOperand(feedback_vector, FeedbackCell::kValueOffset));
...
void Builtins::Generate_ConstructForwardAllArgsImpl(MacroAssembler* masm, ForwardWhichFrame which_frame)
{
    ...
    // receiver.
    __ Daddu(a4, a4, Operand((StandardFrameConstants::kFixedSlotCountAboveFp + 1) * kSystemPointerSize));
...
void NewImplicitReceiver(MacroAssembler* masm)
{
    ...
    __ Sd(v0, MemOperand(fp, FastConstructFrameConstants::kImplicitReceiverOffset));
...
void Builtins::Generate_InterpreterPushArgsThenFastConstructFunction(MacroAssembler* masm)
{
    ...
    // on-stack receiver as the result.
    __ bind(&use_receiver);
    __ Ld(v0, MemOperand(fp, FastConstructFrameConstants::kImplicitReceiverOffset));
    __ JumpIfRoot(v0, RootIndex::kTheHoleValue, &do_throw);
...
static void Generate_InterpreterEnterBytecode(MacroAssembler* masm)
{
    ...
    __ Ld(t0, FieldMemOperand(t0, SharedFunctionInfo::kTrustedFunctionDataOffset));
    __ GetObjectType(t0, kInterpreterDispatchTableRegister, kInterpreterDispatchTableRegister);
    __ Branch(&builtin_trampoline, ne, kInterpreterDispatchTableRegister, Operand(INTERPRETER_DATA_TYPE));
...
void Generate_ContinueToBuiltinHelper(MacroAssembler* masm, bool javascript_builtin, bool with_result)
{
    ...
    if (with_result) {
        if (javascript_builtin) {
            ...
            __ Sd(v0, MemOperand(sp, config->num_allocatable_general_registers() * kSystemPointerSize + BuiltinContinuationFrameConstants::kFixedFrameSize));
        }
    }
    ...
    __ Pop(t0);
    __ Daddu(sp, sp, Operand(BuiltinContinuationFrameConstants::kFixedFrameSizeFromFp));
    __ Pop(ra);
...
void OnStackReplacement(MacroAssembler* masm, OsrSourceTier source, Register maybe_target_code)
{
    Label jump_to_optimized_code;
    {
        ...
        // this).
        __ Branch(&jump_to_optimized_code, ne, maybe_target_code, Operand(Smi::zero()));
    }
    ...
    __ Ld(a1, MemOperand(maybe_target_code, Code::kDeoptimizationDataOrInterpreterDataOffset - kHeapObjectTag));
...
void Builtins::Generate_BaselineOnStackReplacement(MacroAssembler* masm)
{
    ...
    __ Ld(kContextRegister, MemOperand(fp, BaselineFrameConstants::kContextOffset));
...
void Builtins::Generate_CallOrConstructForwardVarargs(MacroAssembler* masm, CallOrConstructMode mode, Builtin target_builtin)
{
    ...
    __ Branch(&stack_done, le, a7, Operand(zero_reg));
    {
        ...
        __ Daddu(a6, fp, Operand(CommonFrameConstants::kFixedFrameSizeAboveFp + kSystemPointerSize));
...
void Builtins::Generate_CallBoundFunctionImpl(MacroAssembler* masm)
{
    ...
    // Push [[BoundArguments]].
    {
        ...
        __ Daddu(a2, a2, Operand(OFFSET_OF_DATA_START(FixedArray) - kHeapObjectTag));
        __ bind(&loop);
...
void Builtins::Generate_WasmLiftoffFrameSetup(MacroAssembler* masm)
{
    ...
    __ Ld(vector, FieldMemOperand(kWasmImplicitArgRegister, WasmTrustedInstanceData::kFeedbackVectorsOffset));
    ...
    __ Ld(kWasmImplicitArgRegister, MemOperand(fp, WasmFrameConstants::kWasmInstanceDataOffset));
...
void Builtins::Generate_WasmCompileLazy(MacroAssembler* masm)
{
...

    {
        ...
        {
            CpuFeatureScope msa_scope(masm, MIPS_SIMD, CpuFeatureScope::CheckPolicy::kDontCheckSupported);
    ...
    __ Ld(t8, FieldMemOperand(kWasmImplicitArgRegister, WasmTrustedInstanceData::kJumpTableStartOffset));
    __ Daddu(t8, v0, t8);
...
void Builtins::Generate_WasmToJsWrapperAsm(MacroAssembler* masm)
{
    ...
    for (int i = cnt_fp - 1; i >= 0; i--) {
        __ Sdc1(wasm::kFpParamRegisters[i], MemOperand(sp, i * kDoubleSize + cnt_gp * kSystemPointerSize));
    }

    // Without wasm::kGpParamRegisters[0] here.
    for (int i = cnt_gp; i >= 1; i--) {
        __ Sd(wasm::kGpParamRegisters[i], MemOperand(sp, (i - 1) * kSystemPointerSize));
    }
...
void Builtins::Generate_CEntry(MacroAssembler* masm, int result_size, ArgvMode argv_mode, bool builtin_exit_frame, bool switch_to_central_stack)
{
    ...
    __ Ld(t9, __ ExternalReferenceAsOperand(pending_handler_entrypoint_address, no_reg));
    __ Jump(t9);
}
...
void Builtins::Generate_DoubleToI(MacroAssembler* masm)
{
    ...
    __ And(scratch, scratch, kFCSROverflowCauseMask | kFCSRUnderflowCauseMask | kFCSRInvalidOpCauseMask);
    ...
    __ Ext(result_reg, input_high, HeapNumber::kExponentShift, HeapNumber::kExponentBits);
    ...
    __ Subu(result_reg, result_reg, Operand(HeapNumber::kExponentBias + HeapNumber::kMantissaBits + 31));
...
void Builtins::Generate_CallApiCallbackImpl(MacroAssembler* masm, CallApiCallbackMode mode)
{
    ...
    FrameScope frame_scope(masm, StackFrame::MANUAL);
    if (mode == CallApiCallbackMode::kGeneric) {
        __ Ld(api_function_address, FieldMemOperand(func_templ, FunctionTemplateInfo::kMaybeRedirectedCallbackOffset));
    }
    ...
    __ Daddu(function_callback_info_arg, fp, Operand(FC::kFunctionCallbackInfoOffset));
...
void Builtins::Generate_CallApiGetter(MacroAssembler* masm)
{
    ...
    __ Ld(api_function_address, FieldMemOperand(callback, AccessorInfo::kMaybeRedirectedGetterOffset));
...
void Generate_DeoptimizationEntry(MacroAssembler* masm, DeoptimizeKind deopt_kind)
{
    ...
    const int kSavedRegistersAreaSize = (kNumberOfRegisters * kSystemPointerSize) + kMSARegsSize;
    ...
    __ Ld(frame_size, MemOperand(current_frame, FrameDescription::frame_size_offset()));
...
void Generate_BaselineOrInterpreterEntry(MacroAssembler* masm, bool next_bytecode, bool is_osr = false)
{
    ...
    __ Ld(code_obj, FieldMemOperand(closure, JSFunction::kSharedFunctionInfoOffset));

    if (is_osr) {
        ResetSharedFunctionInfoAge(masm, code_obj);
    }

    __ Ld(code_obj, FieldMemOperand(code_obj, SharedFunctionInfo::kTrustedFunctionDataOffset));
    ...
    __ Sd(feedback_cell, MemOperand(fp, BaselineFrameConstants::kFeedbackCellFromFp));
    feedback_cell = no_reg;
    // Update feedback vector cache.
    static_assert(InterpreterFrameConstants::kFeedbackVectorFromFp == BaselineFrameConstants::kFeedbackVectorFromFp);
    __ Sd(feedback_vector, MemOperand(fp, InterpreterFrameConstants::kFeedbackVectorFromFp));
    ...
    __ Dsubu(kInterpreterBytecodeOffsetRegister, kInterpreterBytecodeOffsetRegister, (BytecodeArray::kHeaderSize - kHeapObjectTag));
