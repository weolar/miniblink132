...
#define ACCESSOR_INFO_LIST_GENERATOR(V, _)                                                                                                                     \
    V(_, arguments_iterator, ArgumentsIterator, kHasNoSideEffect, kHasSideEffectToReceiver)                                                                    \
    V(_, array_length, ArrayLength, kHasNoSideEffect, kHasSideEffectToReceiver)                                                                                \
    V(_, bound_function_length, BoundFunctionLength, kHasNoSideEffect, kHasSideEffectToReceiver)                                                               \
    V(_, bound_function_name, BoundFunctionName, kHasNoSideEffect, kHasSideEffectToReceiver)                                                                   \
    ...
    V(_, value_unavailable, ValueUnavailable, kHasNoSideEffect, kHasSideEffectToReceiver)                                                                      \
    V(_, wrapped_function_length, WrappedFunctionLength, kHasNoSideEffect, kHasSideEffectToReceiver)                                                           \
    V(_, wrapped_function_name, WrappedFunctionName, kHasNoSideEffect, kHasSideEffectToReceiver)
...
#define ACCESSOR_GETTER_DECLARATION(_, accessor_name, AccessorName, ...)                                                                                       \
    static void AccessorName##Getter(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info);
    ACCESSOR_INFO_LIST_GENERATOR(ACCESSOR_GETTER_DECLARATION, /* not used */)
#undef ACCESSOR_GETTER_DECLARATION

#define ACCESSOR_GETTER_DECLARATION(AccessorName) static void AccessorName(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info);
    ACCESSOR_GETTER_LIST(ACCESSOR_GETTER_DECLARATION)
#undef ACCESSOR_GETTER_DECLARATION

#define ACCESSOR_SETTER_DECLARATION(AccessorName)                                                                                                              \
    static void AccessorName(v8::Local<v8::Name> name, v8::Local<v8::Value> value, const v8::PropertyCallbackInfo<v8::Boolean>& info);
    ACCESSOR_SETTER_LIST(ACCESSOR_SETTER_DECLARATION)
#undef ACCESSOR_SETTER_DECLARATION

#define ACCESSOR_CALLBACK_DECLARATION(_, AccessorName, ...) static void AccessorName(const v8::FunctionCallbackInfo<v8::Value>& info);
    ACCESSOR_CALLBACK_LIST_GENERATOR(ACCESSOR_CALLBACK_DECLARATION,
        /* not used */)
#undef ACCESSOR_CALLBACK_DECLARATION

#define COUNT_ACCESSOR(...) +1
    static constexpr int kAccessorInfoCount = ACCESSOR_INFO_LIST_GENERATOR(COUNT_ACCESSOR, /* not used */);

    static constexpr int kAccessorGetterCount = ACCESSOR_GETTER_LIST(COUNT_ACCESSOR);

    static constexpr int kAccessorSetterCount = ACCESSOR_SETTER_LIST(COUNT_ACCESSOR);

    static constexpr int kAccessorCallbackCount = ACCESSOR_CALLBACK_LIST_GENERATOR(COUNT_ACCESSOR, /* not used */);
#undef COUNT_ACCESSOR
    ...
    static bool IsJSObjectFieldAccessor(Isolate* isolate, DirectHandle<Map> map, Handle<Name> name, FieldIndex* field_index);
    ...
    using AccessorNameBooleanSetterCallback = void (*)(Local<v8::Name> property, Local<v8::Value> value, const PropertyCallbackInfo<v8::Boolean>& info);

    V8_EXPORT_PRIVATE static Handle<AccessorInfo> MakeAccessor(
        Isolate* isolate, Handle<Name> name, AccessorNameGetterCallback getter, AccessorNameBooleanSetterCallback setter);

private:
#define ACCESSOR_INFO_DECLARATION(_, accessor_name, AccessorName, ...) static Handle<AccessorInfo> Make##AccessorName##Info(Isolate* isolate);
