...
struct ParsedISO8601Result {
    ...
    int32_t time_nanosecond; // TimeFractionalPart production stored in nanosecond
    ...
    int32_t tzuo_nanosecond; // TimeZoneUTCOffsetFractionalPart stored in nanosecond
    ...
    int32_t offset_string_start; // Starting offset of TimeZoneNumericUTCOffset
        // in the input string.
    int32_t offset_string_length; // Length of TimeZoneNumericUTCOffset production
    ...
    {
        return tzuo_hour == kMinInt31;
    }
    bool tzuo_minute_is_undefined() const
    {
        return tzuo_minute == kMinInt31;
    }
    bool tzuo_second_is_undefined() const
    {
        return tzuo_second == kMinInt31;
    }
    bool tzuo_sign_is_undefined() const
    {
        return tzuo_sign == kMinInt31;
    }
...
public:
#define DEFINE_PARSE_METHOD(R, NAME) V8_WARN_UNUSED_RESULT static std::optional<R> Parse##NAME(Isolate* isolate, Handle<String> iso_string)
