...
private:
    ...
    void PostCallableExceptionPreparation(const std::string& catch_name, const Type* return_type, std::optional<Block*> catch_block, Stack<std::string>* stack,
...
#define EMIT_INSTRUCTION_DECLARATION(T) void EmitInstruction(const T& instruction, Stack<std::string>* stack) override;
