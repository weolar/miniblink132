...
public:
    ...
    template <class T> T* RegisterDeclarable(std::unique_ptr<T> d)
    {
        T* ptr = d.get();
    ...
    {
        Get().collect_kythe_data_ = true;
    }
    static bool collect_kythe_data()
    {
        return Get().collect_kythe_data_;
    }
    ...
    {
        Get().annotate_ir_ = true;
    }
    static bool annotate_ir()
    {
        return Get().annotate_ir_;
    }
    static Ast* ast()
    {
        return &Get().ast_;
...
public:
    ...
    {
        return Get().external_ptr_size_;
    }
    static size_t CppHeapPointerSize()
    {
        return Get().cppheap_ptr_size_;
    }
    static size_t TrustedPointerSize()
    {
        return Get().trusted_ptr_size_;
    }
    ...
    {
        return TaggedSize() < RawPtrSize();
    }
    static int SmiTagAndShiftSize()
    {
        return Get().smi_tag_and_shift_size_;
    }
