...
public:
    ...
    static constexpr int kParameterSpillsOffset[]
        = { TYPED_FRAME_PUSHED_VALUE_OFFSET(2), TYPED_FRAME_PUSHED_VALUE_OFFSET(3), TYPED_FRAME_PUSHED_VALUE_OFFSET(4) };
...
public:
    ...
    static constexpr DoubleRegList kPushedFpRegs = { xmm1, xmm2, xmm3, xmm4, xmm5, xmm6 };
