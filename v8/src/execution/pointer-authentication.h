...
public:
    ...
    // return it.
    V8_INLINE static Address AuthenticatePC(Address* pc_address, unsigned offset_from_sp);
    ...
    V8_INLINE static void ReplacePC(Address* pc_address, Address new_pc, int offset_from_sp);
    ...
    V8_INLINE static Address SignAndCheckPC(Isolate* isolate, Address pc, Address sp);
    ...
    V8_INLINE static Address MoveSignedPC(Isolate* isolate, Address pc, Address new_sp, Address old_sp);
};
