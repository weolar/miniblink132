...
public:
    ...
    static constexpr int kCPSlotSize = V8_EMBEDDED_CONSTANT_POOL_BOOL ? kSystemPointerSize : 0;
...
public:
    static constexpr int kFixedFrameSizeFromFp = 3 * kSystemPointerSize + kCPSlotSize;
    ...
    static constexpr int kExpressionsOffset = -4 * kSystemPointerSize - kCPSlotSize;
...
public:
    ...
    static constexpr int kFixedSlotCount = kFixedFrameSize / kSystemPointerSize;
    static constexpr int kFirstPushedFrameValueOffset = -kFixedFrameSizeFromFp - kSystemPointerSize;
};

#define FRAME_PUSHED_VALUE_OFFSET(parent, x) (parent::kFirstPushedFrameValueOffset - (x)*kSystemPointerSize)
#define FRAME_SIZE(parent, count) (parent::kFixedFrameSize + (count)*kSystemPointerSize)
#define FRAME_SIZE_FROM_FP(parent, count) (parent::kFixedFrameSizeFromFp + (count)*kSystemPointerSize)
#define DEFINE_FRAME_SIZES(parent, count)                                                                                                                      \
    static constexpr int kFixedFrameSize = FRAME_SIZE(parent, count);                                                                                          \
    static constexpr int kFixedSlotCount = kFixedFrameSize / kSystemPointerSize;                                                                               \
    static constexpr int kFixedFrameSizeFromFp = FRAME_SIZE_FROM_FP(parent, count);                                                                            \
    static constexpr int kFixedSlotCountFromFp = kFixedFrameSizeFromFp / kSystemPointerSize;                                                                   \
    static constexpr int kFirstPushedFrameValueOffset = parent::kFirstPushedFrameValueOffset - (count)*kSystemPointerSize;                                     \
    /* The number of slots added on top of given parent frame type. */                                                                                         \
    template <typename TParentFrameConstants> static constexpr int getExtraSlotsCountFrom()                                                                    \
    {                                                                                                                                                          \
    ...
    static constexpr int kExtraSlotCount = kFixedSlotCount - parent::kFixedSlotCount

#define STANDARD_FRAME_EXTRA_PUSHED_VALUE_OFFSET(x) FRAME_PUSHED_VALUE_OFFSET(StandardFrameConstants, x)
#define DEFINE_STANDARD_FRAME_SIZES(count) DEFINE_FRAME_SIZES(StandardFrameConstants, count)

#define TYPED_FRAME_PUSHED_VALUE_OFFSET(x) FRAME_PUSHED_VALUE_OFFSET(TypedFrameConstants, x)
#define DEFINE_TYPED_FRAME_SIZES(count) DEFINE_FRAME_SIZES(TypedFrameConstants, count)
...
public:
    // FP-relative.
    static constexpr int kContextOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(0);
    static constexpr int kImplicitReceiverOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(1);
    DEFINE_TYPED_FRAME_SIZES(2);
};
...
public:
    // FP-relative.
    static constexpr int kWasmInstanceDataOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(0);
    DEFINE_TYPED_FRAME_SIZES(1);
...
public:
    // FP-relative.
    static constexpr int kWasmInstanceObjectOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(0);
    DEFINE_TYPED_FRAME_SIZES(1);
};
...
public:
    ...
    static constexpr int kGCScanSlotCountOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(0);
...
public:
    ...
    static constexpr int kWrapperBufferOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(0);
    ...
    static constexpr size_t kWrapperBufferGPReturnRegister2 = kWrapperBufferGPReturnRegister1 + kSystemPointerSize;

    // Size of the wrapper buffer
    static constexpr int kWrapperBufferSize = kWrapperBufferGPReturnRegister2 + kSystemPointerSize;
    static_assert(kWrapperBufferParamEnd + kSystemPointerSize <= kWrapperBufferSize);
};
...
public:
    ...
    // This slot contains the number of slots at the top of the frame that need to
    // be scanned by the GC.
    static constexpr int kGCScanSlotCountOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(1);
...
public:
    ...
    static constexpr int kValueTypesArrayStartOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(4);
    // Array of arguments/return values.
    static constexpr int kArgRetsAddressOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(5);
    // Whether the array is for arguments or return values.
    static constexpr int kArgRetsIsArgsOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(6);
    ...
    static constexpr int kSignatureDataOffset = TYPED_FRAME_PUSHED_VALUE_OFFSET(8);
};
#endif // V8_ENABLE_DRUMBRAKE
...
#define EXIT_FRAME_PUSHED_VALUE_OFFSET(x) FRAME_PUSHED_VALUE_OFFSET(ExitFrameConstants, x)
...
public:
    ...
    static constexpr int kTargetOffset = kArgumentsArrayOffset + kTargetIndex * kSystemPointerSize;
    static constexpr int kNewTargetOffset = kArgumentsArrayOffset + kNewTargetIndex * kSystemPointerSize;
    static constexpr int kArgcOffset = kArgumentsArrayOffset + kArgcIndex * kSystemPointerSize;

    // JS arguments.
    static constexpr int kReceiverOffset = kArgumentsArrayOffset + kNumExtraArgs * kSystemPointerSize;

    static constexpr int kFirstArgumentOffset = kReceiverOffset + kSystemPointerSize;
};
...
public:
    ...
    static constexpr int kFCIImplicitArgsOffset = EXIT_FRAME_PUSHED_VALUE_OFFSET(2);
    ...
    static constexpr int kTargetOffset = kImplicitArgsArrayOffset + kFunctionCallbackInfoTargetIndex * kSystemPointerSize;
    static constexpr int kNewTargetOffset = kImplicitArgsArrayOffset + kFunctionCallbackInfoNewTargetIndex * kSystemPointerSize;
    static constexpr int kContextOffset = kImplicitArgsArrayOffset + kFunctionCallbackInfoContextIndex * kSystemPointerSize;
    static constexpr int kReturnValueOffset = kImplicitArgsArrayOffset + kFunctionCallbackInfoReturnValueIndex * kSystemPointerSize;

    // JS arguments.
    static constexpr int kReceiverOffset = kImplicitArgsArrayOffset + kFunctionCallbackInfoArgsLength * kSystemPointerSize;
...
public:
    ...
    static constexpr int kPropertyNameOffset = kArgsArrayOffset + kPropertyCallbackInfoPropertyKeyIndex * kSystemPointerSize;
    static constexpr int kReturnValueOffset = kArgsArrayOffset + kPropertyCallbackInfoReturnValueIndex * kSystemPointerSize;
    static constexpr int kReceiverOffset = kArgsArrayOffset + kPropertyCallbackInfoReceiverIndex * kSystemPointerSize;
    static constexpr int kHolderOffset = kArgsArrayOffset + kPropertyCallbackInfoHolderIndex * kSystemPointerSize;
...
public:
    // FP-relative.
    static constexpr int kBytecodeArrayFromFp = STANDARD_FRAME_EXTRA_PUSHED_VALUE_OFFSET(0);
    static constexpr int kBytecodeOffsetOrFeedbackCellFromFp = STANDARD_FRAME_EXTRA_PUSHED_VALUE_OFFSET(1);
    static constexpr int kFeedbackVectorFromFp = STANDARD_FRAME_EXTRA_PUSHED_VALUE_OFFSET(2);
    DEFINE_STANDARD_FRAME_SIZES(3);

    static constexpr int kFirstParamFromFp = StandardFrameConstants::kCallerSPOffset;
    static constexpr int kRegisterFileFromFp = -kFixedFrameSizeFromFp - kSystemPointerSize;
...
public:
    static constexpr int kBytecodeOffsetExpressionIndex = kBytecodeOffsetOrFeedbackCellExpressionIndex;

    static constexpr int kBytecodeOffsetFromFp = kBytecodeOffsetOrFeedbackCellFromFp;
};
...
public:
    static constexpr int kFeedbackCellExpressionIndex = kBytecodeOffsetOrFeedbackCellExpressionIndex;

    static constexpr int kFeedbackCellFromFp = kBytecodeOffsetOrFeedbackCellFromFp;
};
