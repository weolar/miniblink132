...
public:
    static inline uintptr_t JsLimitFromCLimit(v8::internal::Isolate* isolate, uintptr_t c_limit)
    {
        return Simulator::current(isolate)->StackLimit(c_limit);
    }

#if V8_ENABLE_WEBASSEMBLY
    static inline base::Vector<uint8_t> GetCentralStackView(v8::internal::Isolate* isolate)
    {
    ...
    static inline bool ShouldSwitchCStackForWasmStackSwitching()
    {
        return false;
    }
    ...
    static inline uintptr_t RegisterJSStackComparableAddress(v8::internal::Isolate* isolate)
    {
    ...
    static inline void UnregisterJSStackComparableAddress(v8::internal::Isolate* isolate)
    {
...
public:
    ...
    static inline base::Vector<uint8_t> GetCentralStackView(v8::internal::Isolate* isolate)
    {
        ...
        size_t size = v8_flags.stack_size * KB + wasm::StackMemory::kJSLimitOffsetKB * KB;
...
// platforms like UWP.
#if defined(V8_TARGET_OS_WIN) && !defined(V8_OS_WIN) && !defined(V8_OS_STARBOARD) && !defined(V8_TARGET_ARCH_ARM)
...
// platforms like UWP.
        ...
        volatile Address function_desc[] = { reinterpret_cast<Address>(fn_ptr_), 0, 0 };
        Signature* fn = reinterpret_cast<Signature*>(function_desc);
        return fn(args...);
#endif // V8_OS_ZOS
#else
...
template <typename Return, typename... Args> class GeneratedCode<Return(Args...)> : public GeneratedCode<Return, Args...> {
public:
