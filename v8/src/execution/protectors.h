...
#define DECLARED_PROTECTORS_ON_ISOLATE(V)                                                                                                                      \
    V(ArrayBufferDetaching, ArrayBufferDetachingProtector, array_buffer_detaching_protector)                                                                   \
    ...
    V(IsConcatSpreadableLookupChain, IsConcatSpreadableProtector, is_concat_spreadable_protector)                                                              \
    ...
    V(NoUndetectableObjects, NoUndetectableObjectsProtector, no_undetectable_objects_protector)                                                                \
                                                                                                                                                               \
    ...
    V(NumberStringNotRegexpLike, NumberStringNotRegexpLikeProtector, number_string_not_regexp_like_protector)                                                  \
    V(RegExpSpeciesLookupChain, RegExpSpeciesProtector, regexp_species_protector)                                                                              \
    ...
    V(PromiseResolveLookupChain, PromiseResolveProtector, promise_resolve_protector)                                                                           \
    V(PromiseSpeciesLookupChain, PromiseSpeciesProtector, promise_species_protector)                                                                           \
                                                                                                                                                               \
    ...
    V(StringIteratorLookupChain, StringIteratorProtector, string_iterator_protector)                                                                           \
    V(StringLengthOverflowLookupChain, StringLengthProtector, string_length_protector)                                                                         \
    /* This protects the ToPrimitive conversion of string wrappers (with the */                                                                                \
    /* default type hint NUMBER). */                                                                                                                           \
    V(StringWrapperToPrimitive, StringWrapperToPrimitiveProtector, string_wrapper_to_primitive_protector)                                                      \
    V(TypedArraySpeciesLookupChain, TypedArraySpeciesProtector, typed_array_species_protector)
