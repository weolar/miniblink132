...
class Factory;
template <typename Impl> class FactoryBase;
class LocalFactory;
class PropertyCell;
class ReadOnlyHeap;
class RootVisitor;
...
#define EXTRA_IMPORTANT_INTERNALIZED_STRING_ROOT_LIST(V) EXTRA_IMPORTANT_INTERNALIZED_STRING_LIST_GENERATOR(INTERNALIZED_STRING_LIST_ADAPTER, V)
...
#define STRONG_READ_ONLY_ROOT_LIST(V)                                                                                                                          \
    ...
    IF_WASM(V, Map, wasm_exported_function_data_map, WasmExportedFunctionDataMap)                                                                              \
...
#define BUILTINS_WITH_SFI_LIST_GENERATOR(APPLY, V)                                                                                                             \
    ...
    APPLY(V, AsyncFromSyncIteratorCloseSyncAndRethrow, async_from_sync_iterator_close_sync_and_rethrow)                                                        \
    APPLY(V, AsyncFunctionAwaitRejectClosure, async_function_await_reject_closure)                                                                             \
    APPLY(V, AsyncFunctionAwaitResolveClosure, async_function_await_resolve_closure)                                                                           \
    APPLY(V, AsyncGeneratorAwaitRejectClosure, async_generator_await_reject_closure)                                                                           \
    APPLY(V, AsyncGeneratorAwaitResolveClosure, async_generator_await_resolve_closure)                                                                         \
    APPLY(V, AsyncGeneratorYieldWithAwaitResolveClosure, async_generator_yield_with_await_resolve_closure)                                                     \
    APPLY(V, AsyncGeneratorReturnClosedResolveClosure, async_generator_return_closed_resolve_closure)                                                          \
    APPLY(V, AsyncGeneratorReturnClosedRejectClosure, async_generator_return_closed_reject_closure)                                                            \
    APPLY(V, AsyncGeneratorReturnResolveClosure, async_generator_return_resolve_closure)                                                                       \
    APPLY(V, AsyncIteratorValueUnwrap, async_iterator_value_unwrap)                                                                                            \
    APPLY(V, ArrayFromAsyncArrayLikeOnFulfilled, array_from_async_array_like_on_fulfilled)                                                                     \
    APPLY(V, ArrayFromAsyncArrayLikeOnRejected, array_from_async_array_like_on_rejected)                                                                       \
    APPLY(V, ArrayFromAsyncIterableOnFulfilled, array_from_async_iterable_on_fulfilled)                                                                        \
    APPLY(V, ArrayFromAsyncIterableOnRejected, array_from_async_iterable_on_rejected)                                                                          \
    APPLY(V, PromiseCapabilityDefaultResolve, promise_capability_default_resolve)                                                                              \
    ...
    APPLY(V, PromiseAllSettledResolveElementClosure, promise_all_settled_resolve_element_closure)                                                              \
    APPLY(V, PromiseAllSettledRejectElementClosure, promise_all_settled_reject_element_closure)                                                                \
    APPLY(V, PromiseAllResolveElementClosure, promise_all_resolve_element_closure)                                                                             \
    ...
    APPLY(V, AsyncIteratorPrototypeAsyncDisposeResolveClosure, async_iterator_prototype_async_dispose_resolve_closure)

#define BUILTINS_WITH_SFI_ROOTS_LIST_ADAPTER(V, CamelName, underscore_name, ...) V(SharedFunctionInfo, underscore_name##_shared_fun, CamelName##SharedFun)

#define BUILTINS_WITH_SFI_ROOTS_LIST(V) BUILTINS_WITH_SFI_LIST_GENERATOR(BUILTINS_WITH_SFI_ROOTS_LIST_ADAPTER, V)
...
#define STRONG_MUTABLE_IMMOVABLE_ROOT_LIST(V)                                                                                                                  \
    ...
    V(PropertyCell, no_undetectable_objects_protector, NoUndetectableObjectsProtector)                                                                         \
    ...
    V(PropertyCell, array_buffer_detaching_protector, ArrayBufferDetachingProtector)                                                                           \
    ...
    V(PropertyCell, string_wrapper_to_primitive_protector, StringWrapperToPrimitiveProtector)                                                                  \
    V(PropertyCell, number_string_not_regexp_like_protector, NumberStringNotRegexpLikeProtector)                                                               \
    /* Caches */                                                                                                                                               \
    ...
    V(SharedFunctionInfo, source_text_module_execute_async_module_fulfilled_sfi, SourceTextModuleExecuteAsyncModuleFulfilledSFI)                               \
    V(SharedFunctionInfo, source_text_module_execute_async_module_rejected_sfi, SourceTextModuleExecuteAsyncModuleRejectedSFI)                                 \
    V(SharedFunctionInfo, atomics_mutex_async_unlock_resolve_handler_sfi, AtomicsMutexAsyncUnlockResolveHandlerSFI)                                            \
    V(SharedFunctionInfo, atomics_mutex_async_unlock_reject_handler_sfi, AtomicsMutexAsyncUnlockRejectHandlerSFI)                                              \
    V(SharedFunctionInfo, atomics_condition_acquire_lock_sfi, AtomicsConditionAcquireLockSFI)                                                                  \
    V(SharedFunctionInfo, async_disposable_stack_on_fulfilled_shared_fun, AsyncDisposableStackOnFulfilledSharedFun)                                            \
    V(SharedFunctionInfo, async_disposable_stack_on_rejected_shared_fun, AsyncDisposableStackOnRejectedSharedFun)                                              \
    V(SharedFunctionInfo, async_dispose_from_sync_dispose_shared_fun, AsyncDisposeFromSyncDisposeSharedFun)                                                    \
...
#define STRONG_MUTABLE_MOVABLE_ROOT_LIST(V)                                                                                                                    \
    ...
    V(Object, feedback_vectors_for_profiling_tools, FeedbackVectorsForProfilingTools)                                                                          \
    ...
    V(Object, functions_marked_for_manual_optimization, FunctionsMarkedForManualOptimization)                                                                  \
    ...
    /* Internal SharedFunctionInfos */                                                                                                                         \
    V(FunctionTemplateInfo, error_stack_getter_fun_template, ErrorStackGetterSharedFun)                                                                        \
    V(FunctionTemplateInfo, error_stack_setter_fun_template, ErrorStackSetterSharedFun)
...
#define SMI_ROOT_LIST(V)                                                                                                                                       \
    ...
    V(Smi, construct_stub_create_deopt_pc_offset, ConstructStubCreateDeoptPCOffset)                                                                            \
    V(Smi, construct_stub_invoke_deopt_pc_offset, ConstructStubInvokeDeoptPCOffset)                                                                            \
    V(Smi, deopt_pc_offset_after_adapt_shadow_stack, DeoptPCOffsetAfterAdaptShadowStack)                                                                       \
    V(Smi, interpreter_entry_return_pc_offset, InterpreterEntryReturnPCOffset)

// Produces (String, name, CamelCase) entries
#define INTERNALIZED_STRING_ROOT_LIST(V)                                                                                                                       \
    IMPORTANT_INTERNALIZED_STRING_LIST_GENERATOR(INTERNALIZED_STRING_LIST_ADAPTER, V)                                                                          \
    NOT_IMPORTANT_INTERNALIZED_STRING_LIST_GENERATOR(INTERNALIZED_STRING_LIST_ADAPTER, V)
...
#define PRIVATE_SYMBOL_ROOT_LIST(V) PRIVATE_SYMBOL_LIST_GENERATOR(SYMBOL_ROOT_LIST_ADAPTER, V)
#define PUBLIC_SYMBOL_ROOT_LIST(V) PUBLIC_SYMBOL_LIST_GENERATOR(SYMBOL_ROOT_LIST_ADAPTER, V)
#define WELL_KNOWN_SYMBOL_ROOT_LIST(V) WELL_KNOWN_SYMBOL_LIST_GENERATOR(SYMBOL_ROOT_LIST_ADAPTER, V)

// Produces (Na,e, name, CamelCase) entries
#define NAME_FOR_PROTECTOR_ROOT_LIST(V)                                                                                                                        \
    INTERNALIZED_STRING_FOR_PROTECTOR_LIST_GENERATOR(INTERNALIZED_STRING_LIST_ADAPTER, V)                                                                      \
...
// entry
#define ACCESSOR_INFO_ROOT_LIST_ADAPTER(V, name, CamelName, ...) V(AccessorInfo, name##_accessor, CamelName##Accessor)

// Produces (AccessorInfo, name, CamelCase) entries
#define ACCESSOR_INFO_ROOT_LIST(V) ACCESSOR_INFO_LIST_GENERATOR(ACCESSOR_INFO_ROOT_LIST_ADAPTER, V)
...
#undef DECL
    ...
    kImmortalImmovableRootsCount = kReadOnlyRootsCount STRONG_MUTABLE_IMMOVABLE_ROOT_LIST(COUNT_ROOT),
    ...
    // roots).
    kMutableRootsCount = 0 STRONG_MUTABLE_IMMOVABLE_ROOT_LIST(COUNT_ROOT) STRONG_MUTABLE_MOVABLE_ROOT_LIST(COUNT_ROOT),
...
static_assert(RootIndex::kFirstNameForProtector <= RootIndex::kLastNameForProtector);
...
public:
    ...
    inline bool IsRootHandleLocation(Address* handle_location, RootIndex* index) const;

    template <typename T> bool IsRootHandle(IndirectHandle<T> handle, RootIndex* index) const;
    ...
    static constexpr bool IsReadOnly(RootIndex root_index)
    {
        ...
        return static_cast<unsigned>(root_index) <= static_cast<unsigned>(RootIndex::kLastReadOnlyRoot);
    }
...
private:
    ...
    FullObjectSlot end()
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kLastRoot) + 1]);
    }
    ...
    FullObjectSlot strong_or_read_only_roots_begin() const
    {
        ...
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kFirstStrongOrReadOnlyRoot)]);
    }
    FullObjectSlot strong_or_read_only_roots_end() const
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kLastStrongOrReadOnlyRoot) + 1]);
    }
    ...
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kFirstReadOnlyRoot)]);
    }
    FullObjectSlot read_only_roots_end() const
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kLastReadOnlyRoot) + 1]);
    }

    FullObjectSlot strong_roots_begin() const
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kFirstStrongRoot)]);
    }
    FullObjectSlot strong_roots_end() const
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kLastStrongRoot) + 1]);
    }

    FullObjectSlot smi_roots_begin() const
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kFirstSmiRoot)]);
    }
    FullObjectSlot smi_roots_end() const
    {
        return FullObjectSlot(&roots_[static_cast<size_t>(RootIndex::kLastSmiRoot) + 1]);
    }
