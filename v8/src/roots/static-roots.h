...
struct StaticReadOnlyRoot {
    ...
    static constexpr Tagged_t kUncachedExternalInternalizedTwoByteStringMap = 0x1cd;
    static constexpr Tagged_t kUncachedExternalInternalizedOneByteStringMap = 0x1f5;
    ...
    static constexpr Tagged_t kUncompiledDataWithoutPreparseDataWithJobMap = 0x16cd;
    ...
    static constexpr Tagged_t kshared_struct_map_elements_template_symbol = 0x5ed5;
    ...
    static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol = 0x5f05;
