...
public:
    explicit MaglevPrintingVisitor(MaglevGraphLabeller* graph_labeller, std::ostream& os);
...
inline void PrintGraph(std::ostream& os, MaglevCompilationInfo* compilation_info, Graph* const graph)
{
}
...
inline std::ostream& operator<<(std::ostream& os, const PrintNodeLabel& printer)
{
    printer.Print(os);
    return os;
}
