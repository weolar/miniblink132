...
#define DECLARE_NORELOC_PROTOTYPE(Name, target_type)                                                                                                           \
    ...
    void Name(target_type target, COND_TYPED_ARGS, BranchDelaySlot bd = PROTECT);                                                                              \
...
#define COND_ARGS Condition cond = al, Register rs = zero_reg, const Operand &rt = Operand(zero_reg), BranchDelaySlot bd = PROTECT
    ...
    void Ret(COND_ARGS);
    inline void Ret(BranchDelaySlot bd, Condition cond = al, Register rs = zero_reg, const Operand& rt = Operand(zero_reg))
    {
        Ret(cond, rs, rt, bd);
    }
...
// Number of instructions needed for calculation of switch table entry address
    ...
    void LoadCodeEntrypointFromJSDispatchTable(Register destination, MemOperand field_operand);
    ...
    void RecordWriteField(
        Register object, int offset, Register value, Register scratch, RAStatus ra_status, SaveFPRegsMode save_fp, SmiCheck smi_check = SmiCheck::kInline);
