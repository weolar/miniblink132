...
#define GENERAL_REGISTERS(R)                                                                                                                                   \
    R(x0)                                                                                                                                                      \
    R(x1) R(x2) R(x3) R(x4) R(x5) R(x6) R(x7) R(x8) R(x9) R(x10) R(x11) R(x12) R(x13) R(x14) R(x15) R(x16) R(x17) R(x18) R(x19) R(x20) R(x21) R(x22) R(x23)    \
...
#define ALWAYS_ALLOCATABLE_GENERAL_REGISTERS(R)                                                                                                                \
    R(x0)                                                                                                                                                      \
    R(x1) R(x2) R(x3) R(x4) R(x5) R(x6) R(x7) R(x8) R(x9) R(x10) R(x11) R(x12) R(x13) R(x14) R(x15) R(x19) R(x20) R(x21) R(x22) R(x23) R(x24) R(x25) R(x27)
...
#define FLOAT_REGISTERS(V)                                                                                                                                     \
    V(s0)                                                                                                                                                      \
    V(s1) V(s2) V(s3) V(s4) V(s5) V(s6) V(s7) V(s8) V(s9) V(s10) V(s11) V(s12) V(s13) V(s14) V(s15) V(s16) V(s17) V(s18) V(s19) V(s20) V(s21) V(s22) V(s23)    \
        V(s24) V(s25) V(s26) V(s27) V(s28) V(s29) V(s30) V(s31)

#define DOUBLE_REGISTERS(R)                                                                                                                                    \
    R(d0)                                                                                                                                                      \
    R(d1) R(d2) R(d3) R(d4) R(d5) R(d6) R(d7) R(d8) R(d9) R(d10) R(d11) R(d12) R(d13) R(d14) R(d15) R(d16) R(d17) R(d18) R(d19) R(d20) R(d21) R(d22) R(d23)    \
        R(d24) R(d25) R(d26) R(d27) R(d28) R(d29) R(d30) R(d31)

#define SIMD128_REGISTERS(V)                                                                                                                                   \
    V(q0)                                                                                                                                                      \
    V(q1) V(q2) V(q3) V(q4) V(q5) V(q6) V(q7) V(q8) V(q9) V(q10) V(q11) V(q12) V(q13) V(q14) V(q15) V(q16) V(q17) V(q18) V(q19) V(q20) V(q21) V(q22) V(q23)    \
        V(q24) V(q25) V(q26) V(q27) V(q28) V(q29) V(q30) V(q31)

#define VECTOR_REGISTERS(V)                                                                                                                                    \
    V(v0)                                                                                                                                                      \
    V(v1) V(v2) V(v3) V(v4) V(v5) V(v6) V(v7) V(v8) V(v9) V(v10) V(v11) V(v12) V(v13) V(v14) V(v15) V(v16) V(v17) V(v18) V(v19) V(v20) V(v21) V(v22) V(v23)    \
...
#define ALLOCATABLE_DOUBLE_REGISTERS(R)                                                                                                                        \
    R(d0)                                                                                                                                                      \
    R(d1) R(d2) R(d3) R(d4) R(d5) R(d6) R(d7) R(d8) R(d9) R(d10) R(d11) R(d12) R(d13) R(d14) R(d16) R(d17) R(d18) R(d19) R(d20) R(d21) R(d22) R(d23) R(d24)    \
        R(d25) R(d26) R(d27) R(d28)

#define MAGLEV_SCRATCH_DOUBLE_REGISTERS(R) R(d30) R(d31)
...
public:
    ...
    {
        return RegisterBase::operator==(other) && reg_size_ == other.reg_size_ && reg_type_ == other.reg_type_;
    }
    constexpr bool operator!=(const CPURegister& other) const
    {
...
protected:
    ...
    {
        return (size == kBRegSizeInBits || size == kHRegSizeInBits || size == kSRegSizeInBits || size == kDRegSizeInBits || size == kQRegSizeInBits)
...
static_assert(sizeof(CPURegister) <= sizeof(int), "CPURegister can efficiently be passed by value");
...
template <typename RegT> inline RegT ReassignRegister(RegT& source)
{
    RegT result = source;
    source = RegT::no_reg();
    return result;
...
public:
    ...
    bool Is1Q() const
    {
        return (Is128Bits() && (lane_count_ == 1));
    }
...
static_assert(sizeof(VRegister) <= sizeof(int), "VRegister can efficiently be passed by value");
...
#define ALIAS_REGISTER(register_class, alias, name) constexpr register_class alias = name
...
V8_EXPORT_PRIVATE bool AreAliased(const CPURegister& reg1, const CPURegister& reg2, const CPURegister& reg3 = NoReg, const CPURegister& reg4 = NoReg,
    const CPURegister& reg5 = NoReg, const CPURegister& reg6 = NoReg, const CPURegister& reg7 = NoReg, const CPURegister& reg8 = NoReg);

// AreSameSizeAndType returns true if all of the specified registers have the
// same size, and are of the same type. The system stack pointer may be
// specified. Arguments set to NoReg are ignored, as are any subsequent
// arguments. At least one argument (reg1) must be valid (not NoCPUReg).
V8_EXPORT_PRIVATE bool AreSameSizeAndType(const CPURegister& reg1, const CPURegister& reg2 = NoCPUReg, const CPURegister& reg3 = NoCPUReg,
    const CPURegister& reg4 = NoCPUReg, const CPURegister& reg5 = NoCPUReg, const CPURegister& reg6 = NoCPUReg, const CPURegister& reg7 = NoCPUReg,
...
bool AreEven(const CPURegister& reg1, const CPURegister& reg2, const CPURegister& reg3 = NoReg, const CPURegister& reg4 = NoReg,
    const CPURegister& reg5 = NoReg, const CPURegister& reg6 = NoReg, const CPURegister& reg7 = NoReg, const CPURegister& reg8 = NoReg);
