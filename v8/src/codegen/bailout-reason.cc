...
const char* GetBailoutReason(BailoutReason reason)
{
    ...
    static const char* error_messages_[] = { BAILOUT_MESSAGES_LIST(ERROR_MESSAGES_TEXTS) };
...
const char* GetAbortReason(AbortReason reason)
{
    ...
    static const char* error_messages_[] = { ABORT_MESSAGES_LIST(ERROR_MESSAGES_TEXTS) };
    return error_messages_[static_cast<int>(reason)];
}
