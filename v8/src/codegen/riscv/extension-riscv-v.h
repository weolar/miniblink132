...
#define DEFINE_OPIVV(name, funct6) void name##_vv(VRegister vd, VRegister vs2, VRegister vs1, MaskType mask = NoMask);

#define DEFINE_OPIVX(name, funct6) void name##_vx(VRegister vd, VRegister vs2, Register rs1, MaskType mask = NoMask);

#define DEFINE_OPIVI(name, funct6) void name##_vi(VRegister vd, VRegister vs2, int8_t imm5, MaskType mask = NoMask);

#define DEFINE_OPMVV(name, funct6) void name##_vv(VRegister vd, VRegister vs2, VRegister vs1, MaskType mask = NoMask);

#define DEFINE_OPMVX(name, funct6) void name##_vx(VRegister vd, VRegister vs2, Register rs1, MaskType mask = NoMask);

#define DEFINE_OPFVV(name, funct6) void name##_vv(VRegister vd, VRegister vs2, VRegister vs1, MaskType mask = NoMask);

#define DEFINE_OPFWV(name, funct6) void name##_wv(VRegister vd, VRegister vs2, VRegister vs1, MaskType mask = NoMask);

#define DEFINE_OPFRED(name, funct6) void name##_vs(VRegister vd, VRegister vs2, VRegister vs1, MaskType mask = NoMask);

#define DEFINE_OPFVF(name, funct6) void name##_vf(VRegister vd, VRegister vs2, FPURegister fs1, MaskType mask = NoMask);

#define DEFINE_OPFWF(name, funct6) void name##_wf(VRegister vd, VRegister vs2, FPURegister fs1, MaskType mask = NoMask);

#define DEFINE_OPFVV_FMA(name, funct6) void name##_vv(VRegister vd, VRegister vs1, VRegister vs2, MaskType mask = NoMask);

#define DEFINE_OPFVF_FMA(name, funct6) void name##_vf(VRegister vd, FPURegister fs1, VRegister vs2, MaskType mask = NoMask);

#define DEFINE_OPMVV_VIE(name) void name(VRegister vd, VRegister vs2, MaskType mask = NoMask);
...
protected:
    ...
    inline void vsetvlmax(Register rd, VSew vsew, Vlmul vlmul, TailAgnosticType tail = tu, MaskAgnosticType mask = mu)
    {
        vsetvli(rd, zero_reg, vsew, vlmul, tu, mu);
    }

    inline void vsetvl(VSew vsew, Vlmul vlmul, TailAgnosticType tail = tu, MaskAgnosticType mask = mu)
    {
