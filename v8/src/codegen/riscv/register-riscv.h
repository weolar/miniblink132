...
#define GENERAL_REGISTERS(V)                                                                                                                                   \
    V(zero_reg)                                                                                                                                                \
    V(ra) V(sp) V(gp) V(tp) V(t0) V(t1) V(t2) V(fp) V(s1) V(a0) V(a1) V(a2) V(a3) V(a4) V(a5) V(a6) V(a7) V(s2) V(s3) V(s4) V(s5) V(s6) V(s7) V(s8) V(s9)      \
...
// builtin-riscv64
#define ALWAYS_ALLOCATABLE_GENERAL_REGISTERS(V) V(a0) V(a1) V(a2) V(a3) V(a4) V(a5) V(a6) V(a7) V(t0) V(t1) V(t2) V(t4) V(s7) V(s8) V(s9) V(s10)
...
#define DOUBLE_REGISTERS(V)                                                                                                                                    \
    V(ft0)                                                                                                                                                     \
    V(ft1) V(ft2) V(ft3) V(ft4) V(ft5) V(ft6) V(ft7) V(fs0) V(fs1) V(fa0) V(fa1) V(fa2) V(fa3) V(fa4) V(fa5) V(fa6) V(fa7) V(fs2) V(fs3) V(fs4) V(fs5) V(fs6)  \
        V(fs7) V(fs8) V(fs9) V(fs10) V(fs11) V(ft8) V(ft9) V(ft10) V(ft11)
...
#define ALLOCATABLE_SIMD128_REGISTERS(V)                                                                                                                       \
    V(v1)                                                                                                                                                      \
    V(v2) V(v3) V(v4) V(v5) V(v6) V(v7) V(v10) V(v11) V(v12) V(v13) V(v14) V(v15) V(v16) V(v17) V(v18) V(v19) V(v20) V(v21) V(v22) V(v26) V(v27) V(v28) V(v29) \
        V(v30) V(v31)

#define ALLOCATABLE_DOUBLE_REGISTERS(V)                                                                                                                        \
    V(ft1) V(ft2) V(ft3) V(ft4) V(ft5) V(ft6) V(ft7) V(ft8) V(ft9) V(ft10) V(ft11) V(fa0) V(fa1) V(fa2) V(fa3) V(fa4) V(fa5) V(fa6) V(fa7)
...
public:
    explicit constexpr VRegister(int code)
        : RegisterBase(code)
    {
    }
};
...
#define DECLARE_VECTOR_REGISTER(R) constexpr VRegister R = VRegister::from_code(kVRCode_##R);
