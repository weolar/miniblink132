...
#define TORQUE_BUILTIN_LIST_TFC(V) BUILTIN_LIST_FROM_TORQUE(IGNORE_BUILTIN, IGNORE_BUILTIN, V, IGNORE_BUILTIN, IGNORE_BUILTIN, IGNORE_BUILTIN)
...
public:
    ...
    void InitializeRegisters(Flags flags, CodeEntrypointTag tag, int return_count, int parameter_count, StackArgumentOrder stack_order,
        int register_parameter_count, const Register* registers, const DoubleRegister* double_registers, const Register* return_registers,
    ...
    {
        return register_returns_[index];
    }
...
private:
    bool IsInitializedRegisters() const
    {
        const bool initialized
            = return_count_ != kUninitializedCount && param_count_ != kUninitializedCount && (register_param_count_ == 0 || register_params_ != nullptr);
...
protected:
    ...
    static constexpr inline std::array<Register, kJSBuiltinRegisterParams> DefaultJSRegisterArray();
...
// subclass.
template <typename DerivedDescriptor> class StaticCallInterfaceDescriptor : public CallInterfaceDescriptor {
public:
    // ===========================================================================
    // The following are the descriptor's CRTP configuration points, overwritable
    // by DerivedDescriptor.
    static constexpr int kReturnCount = CallInterfaceDescriptorData::kUninitializedCount;
    static constexpr int kParameterCount = CallInterfaceDescriptorData::kUninitializedCount;
    ...
    {
        return Flags((DerivedDescriptor::kNoContext ? CallInterfaceDescriptorData::kNoContext : 0)
            | (DerivedDescriptor::kAllowVarArgs ? CallInterfaceDescriptorData::kAllowVarArgs : 0)
            | (DerivedDescriptor::kNoStackScan ? CallInterfaceDescriptorData::kNoStackScan : 0)
            | (DerivedDescriptor::kCalleeSaveRegisters ? CallInterfaceDescriptorData::kCalleeSaveRegisters : 0));
    }
    ...
    static inline void VerifyArgumentRegisterCount(CallInterfaceDescriptorData* data, int nof_expected_args);
#endif
...
template <typename Descriptor> class StaticJSCallInterfaceDescriptor : public StaticCallInterfaceDescriptor<Descriptor> {
public:
    static constexpr auto kStackArgumentOrder = StackArgumentOrder::kJS;
    static constexpr inline auto registers();

    using StaticCallInterfaceDescriptor<Descriptor>::StaticCallInterfaceDescriptor;
};

template <Builtin kBuiltin> struct CallInterfaceDescriptorFor;
...
template <typename... Registers> constexpr std::array<Register, 1 + sizeof...(Registers)> RegisterArray(Register first_reg, Registers... regs)
{
...
template <typename... Registers> constexpr std::array<DoubleRegister, 1 + sizeof...(Registers)> DoubleRegisterArray(DoubleRegister first_reg, Registers... regs)
{
    DCHECK(!AreAliased(first_reg, regs...));
    return { first_reg, regs... };
}
...
#define DEFINE_PARAMETERS_ENTRY(...)                                                                                                                           \
    ...
    static constexpr StackArgumentOrder kStackArgumentOrder = StackArgumentOrder::kDefault;                                                                    \
...
#define DEFINE_PARAMETERS_VARARGS(...)                                                                                                                         \
    ...
    static constexpr StackArgumentOrder kStackArgumentOrder = StackArgumentOrder::kJS;
...
#define DEFINE_RESULT_AND_PARAMETER_TYPES(...)                                                                                                                 \
    ...
    static void InitializeTypes(CallInterfaceDescriptorData* data)                                                                                             \
    {                                                                                                                                                          \
        static_assert(kReturnCount + kParameterCount == arraysize(kMachineTypes), "Parameter names definition is not consistent with parameter types");        \
        data->InitializeTypes(kMachineTypes, arraysize(kMachineTypes));                                                                                        \
    }

#define DEFINE_PARAMETER_TYPES(...) DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged() /* result */, ##__VA_ARGS__)
...
#define SANDBOX_EXPOSED_DESCRIPTOR(tag) static constexpr CodeEntrypointTag kEntrypointTag = tag;
...
#define INTERNAL_DESCRIPTOR() static constexpr CodeEntrypointTag kEntrypointTag = kInvalidEntrypointTag;
...
class V8_EXPORT_PRIVATE VoidDescriptor : public StaticCallInterfaceDescriptor<VoidDescriptor> {
public:
...
// TODO(jgruber): Consider filling in the details here; however, this doesn't
// make too much sense as long as the descriptor isn't used or verified.
class CEntryDummyDescriptor : public StaticCallInterfaceDescriptor<CEntryDummyDescriptor> {
public:
    SANDBOX_EXPOSED_DESCRIPTOR(kDefaultCodeEntrypointTag)
    DEFINE_PARAMETERS()
    DEFINE_PARAMETER_TYPES()
...
class WasmDummyDescriptor : public StaticCallInterfaceDescriptor<WasmDummyDescriptor> {
public:
...
// TODO(wasm): Consider filling in details / defining real descriptors for all
// builtins still using this placeholder descriptor.
class WasmDummyWithJSLinkageDescriptor : public StaticCallInterfaceDescriptor<WasmDummyWithJSLinkageDescriptor> {
public:
...
class WasmHandleStackOverflowDescriptor : public StaticCallInterfaceDescriptor<WasmHandleStackOverflowDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class AllocateDescriptor : public StaticCallInterfaceDescriptor<AllocateDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class NewHeapNumberDescriptor : public StaticCallInterfaceDescriptor<NewHeapNumberDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class JSTrampolineDescriptor : public StaticJSCallInterfaceDescriptor<JSTrampolineDescriptor> {
public:
    SANDBOX_EXPOSED_DESCRIPTOR(kJSEntrypointTag)
...
class RegExpTrampolineDescriptor : public StaticCallInterfaceDescriptor<RegExpTrampolineDescriptor> {
public:
...
class ContextOnlyDescriptor : public StaticCallInterfaceDescriptor<ContextOnlyDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS()
    DEFINE_PARAMETER_TYPES()
...
class NoContextDescriptor : public StaticCallInterfaceDescriptor<NoContextDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
// input.
class LoadBaselineDescriptor : public StaticCallInterfaceDescriptor<LoadBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LoadGlobalNoFeedbackDescriptor : public StaticCallInterfaceDescriptor<LoadGlobalNoFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LoadNoFeedbackDescriptor : public StaticCallInterfaceDescriptor<LoadNoFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LoadGlobalDescriptor : public StaticCallInterfaceDescriptor<LoadGlobalDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LoadGlobalBaselineDescriptor : public StaticCallInterfaceDescriptor<LoadGlobalBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LookupWithVectorDescriptor : public StaticCallInterfaceDescriptor<LookupWithVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LookupTrampolineDescriptor : public StaticCallInterfaceDescriptor<LookupTrampolineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LookupBaselineDescriptor : public StaticCallInterfaceDescriptor<LookupBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class MaglevOptimizeCodeOrTailCallOptimizedCodeSlotDescriptor : public StaticCallInterfaceDescriptor<MaglevOptimizeCodeOrTailCallOptimizedCodeSlotDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class StoreNoFeedbackDescriptor : public StaticCallInterfaceDescriptor<StoreNoFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class StoreBaselineDescriptor : public StaticCallInterfaceDescriptor<StoreBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class StoreTransitionDescriptor : public StaticCallInterfaceDescriptor<StoreTransitionDescriptor> {
public:
...
class StoreWithVectorDescriptor : public StaticCallInterfaceDescriptor<StoreWithVectorDescriptor> {
public:
...
class StoreGlobalDescriptor : public StaticCallInterfaceDescriptor<StoreGlobalDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class StoreGlobalBaselineDescriptor : public StaticCallInterfaceDescriptor<StoreGlobalBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class StoreGlobalWithVectorDescriptor : public StaticCallInterfaceDescriptor<StoreGlobalWithVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class DefineKeyedOwnDescriptor : public StaticCallInterfaceDescriptor<DefineKeyedOwnDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class DefineKeyedOwnBaselineDescriptor : public StaticCallInterfaceDescriptor<DefineKeyedOwnBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class DefineKeyedOwnWithVectorDescriptor : public StaticCallInterfaceDescriptor<DefineKeyedOwnWithVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class LoadWithVectorDescriptor : public StaticCallInterfaceDescriptor<LoadWithVectorDescriptor> {
public:
...
class KeyedLoadBaselineDescriptor : public StaticCallInterfaceDescriptor<KeyedLoadBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kReceiver, kName, kSlot)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kReceiver
...
class KeyedLoadDescriptor : public StaticCallInterfaceDescriptor<KeyedLoadDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kReceiver, kName, kSlot)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kReceiver
...
class KeyedLoadWithVectorDescriptor : public StaticCallInterfaceDescriptor<KeyedLoadWithVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kReceiver, kName, kSlot, kVector)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kReceiver
...
class EnumeratedKeyedLoadBaselineDescriptor : public StaticCallInterfaceDescriptor<EnumeratedKeyedLoadBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class EnumeratedKeyedLoadDescriptor : public StaticCallInterfaceDescriptor<EnumeratedKeyedLoadDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class KeyedHasICBaselineDescriptor : public StaticCallInterfaceDescriptor<KeyedHasICBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kReceiver, kName, kSlot)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kReceiver
...
class KeyedHasICWithVectorDescriptor : public StaticCallInterfaceDescriptor<KeyedHasICWithVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kReceiver, kName, kSlot, kVector)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kReceiver
...
class LoadWithReceiverAndVectorDescriptor : public StaticCallInterfaceDescriptor<LoadWithReceiverAndVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    // TODO(v8:9497): Revert the Machine type for kSlot to the
    // TaggedSigned once Torque can emit better call descriptors
...
class LoadWithReceiverBaselineDescriptor : public StaticCallInterfaceDescriptor<LoadWithReceiverBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    // TODO(v8:9497): Revert the Machine type for kSlot to the
    // TaggedSigned once Torque can emit better call descriptors
...
class LoadGlobalWithVectorDescriptor : public StaticCallInterfaceDescriptor<LoadGlobalWithVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class FastNewObjectDescriptor : public StaticCallInterfaceDescriptor<FastNewObjectDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class WriteBarrierDescriptor final : public StaticCallInterfaceDescriptor<WriteBarrierDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class IndirectPointerWriteBarrierDescriptor final : public StaticCallInterfaceDescriptor<IndirectPointerWriteBarrierDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
#ifdef V8_IS_TSAN
class TSANStoreDescriptor final : public StaticCallInterfaceDescriptor<TSANStoreDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class TSANLoadDescriptor final : public StaticCallInterfaceDescriptor<TSANLoadDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class TypeConversionDescriptor final : public StaticCallInterfaceDescriptor<TypeConversionDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class TypeConversionNoContextDescriptor final : public StaticCallInterfaceDescriptor<TypeConversionNoContextDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class TypeConversion_BaselineDescriptor final : public StaticCallInterfaceDescriptor<TypeConversion_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class SingleParameterOnStackDescriptor final : public StaticCallInterfaceDescriptor<SingleParameterOnStackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kArgument)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged())
...
class AsyncFunctionStackParameterDescriptor final : public StaticCallInterfaceDescriptor<AsyncFunctionStackParameterDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class GetIteratorStackParameterDescriptor final : public StaticCallInterfaceDescriptor<GetIteratorStackParameterDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kReceiver, kCallSlot, kFeedback, kResult)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), MachineType::AnyTagged(), MachineType::AnyTagged(), MachineType::AnyTagged())
    DECLARE_DESCRIPTOR(GetIteratorStackParameterDescriptor)

    static constexpr auto registers();
};

class GetPropertyDescriptor final : public StaticCallInterfaceDescriptor<GetPropertyDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class TypeofDescriptor : public StaticCallInterfaceDescriptor<TypeofDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallTrampolineDescriptor : public StaticCallInterfaceDescriptor<CallTrampolineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CopyDataPropertiesWithExcludedPropertiesDescriptor : public StaticCallInterfaceDescriptor<CopyDataPropertiesWithExcludedPropertiesDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CopyDataPropertiesWithExcludedPropertiesOnStackDescriptor
    : public StaticCallInterfaceDescriptor<CopyDataPropertiesWithExcludedPropertiesOnStackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallVarargsDescriptor : public StaticCallInterfaceDescriptor<CallVarargsDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_VARARGS(kTarget, kActualArgumentsCount, kArgumentsLength, kArgumentsList)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kTarget
        MachineType::Int32(), // kActualArgumentsCount
...
class CallForwardVarargsDescriptor : public StaticCallInterfaceDescriptor<CallForwardVarargsDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallFunctionTemplateDescriptor : public StaticCallInterfaceDescriptor<CallFunctionTemplateDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallFunctionTemplateGenericDescriptor : public StaticCallInterfaceDescriptor<CallFunctionTemplateGenericDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_VARARGS(kFunctionTemplateInfo, kArgumentsCount, kTopmostScriptHavingContext)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kFunctionTemplateInfo
        MachineType::Int32(), // kArgumentsCount
...
class CallWithSpreadDescriptor : public StaticCallInterfaceDescriptor<CallWithSpreadDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallWithSpread_BaselineDescriptor : public StaticCallInterfaceDescriptor<CallWithSpread_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallWithSpread_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<CallWithSpread_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_VARARGS(kTarget, kArgumentsCount, kSpread, kSlot, kFeedbackVector, kReceiver)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kTarget
        MachineType::Int32(), // kArgumentsCount
        MachineType::AnyTagged(), // kSpread
        MachineType::UintPtr(), // kSlot
...
class CallWithArrayLikeDescriptor : public StaticCallInterfaceDescriptor<CallWithArrayLikeDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallWithArrayLike_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<CallWithArrayLike_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructStubDescriptor : public StaticCallInterfaceDescriptor<ConstructStubDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_JS_PARAMETERS()
    DEFINE_JS_PARAMETER_TYPES()
...
class ConstructVarargsDescriptor : public StaticCallInterfaceDescriptor<ConstructVarargsDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructForwardVarargsDescriptor : public StaticCallInterfaceDescriptor<ConstructForwardVarargsDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructWithSpreadDescriptor : public StaticCallInterfaceDescriptor<ConstructWithSpreadDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructWithSpread_BaselineDescriptor : public StaticCallInterfaceDescriptor<ConstructWithSpread_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructWithSpread_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<ConstructWithSpread_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructWithArrayLikeDescriptor : public StaticCallInterfaceDescriptor<ConstructWithArrayLikeDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructForwardAllArgsDescriptor : public StaticCallInterfaceDescriptor<ConstructForwardAllArgsDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructForwardAllArgs_BaselineDescriptor : public StaticCallInterfaceDescriptor<ConstructForwardAllArgs_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ConstructForwardAllArgs_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<ConstructForwardAllArgs_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ArrayConstructorDescriptor : public StaticJSCallInterfaceDescriptor<ArrayConstructorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ArrayNArgumentsConstructorDescriptor : public StaticCallInterfaceDescriptor<ArrayNArgumentsConstructorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ArrayNoArgumentConstructorDescriptor : public StaticCallInterfaceDescriptor<ArrayNoArgumentConstructorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    ...
    DEFINE_PARAMETERS(kFunction, kAllocationSite, kActualArgumentsCount, kFunctionParameter)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kFunction
        MachineType::AnyTagged(), // kAllocationSite
        MachineType::Int32(), // kActualArgumentsCount
...
class ArraySingleArgumentConstructorDescriptor : public StaticCallInterfaceDescriptor<ArraySingleArgumentConstructorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    // This descriptor declares same register arguments as the parent
    // ArrayNArgumentsConstructorDescriptor and it declares indices for
    // JS arguments passed on the expression stack.
    DEFINE_PARAMETERS(kFunction, kAllocationSite, kActualArgumentsCount, kArraySizeSmiParameter, kReceiverParameter)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kFunction
        MachineType::AnyTagged(), // kAllocationSite
        MachineType::Int32(), // kActualArgumentsCount
...
class CompareDescriptor : public StaticCallInterfaceDescriptor<CompareDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CompareNoContextDescriptor : public StaticCallInterfaceDescriptor<CompareNoContextDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class StringEqualDescriptor : public StaticCallInterfaceDescriptor<StringEqualDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class BinaryOpDescriptor : public StaticCallInterfaceDescriptor<BinaryOpDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kLeft, kRight)
...
class BinaryOp_BaselineDescriptor : public StaticCallInterfaceDescriptor<BinaryOp_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class BinarySmiOp_BaselineDescriptor : public StaticCallInterfaceDescriptor<BinarySmiOp_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kLeft, kRight, kSlot)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kLeft
...
class StringAtAsStringDescriptor final : public StaticCallInterfaceDescriptor<StringAtAsStringDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kReceiver, kPosition)
    // TODO(turbofan): Return untagged value here.
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::TaggedPointer(), // result string
        MachineType::AnyTagged(), // kReceiver
        MachineType::IntPtr()) // kPosition
    DECLARE_DESCRIPTOR(StringAtAsStringDescriptor)
};

class StringSubstringDescriptor final : public StaticCallInterfaceDescriptor<StringSubstringDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CppBuiltinAdaptorDescriptor : public StaticJSCallInterfaceDescriptor<CppBuiltinAdaptorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CreateFromSlowBoilerplateHelperDescriptor : public StaticCallInterfaceDescriptor<CreateFromSlowBoilerplateHelperDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(2, kAllocationSite, kBoilerplate)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged(), // result 1 (object)
...
class CEntry1ArgvOnStackDescriptor : public StaticCallInterfaceDescriptor<CEntry1ArgvOnStackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallApiCallbackOptimizedDescriptor : public StaticCallInterfaceDescriptor<CallApiCallbackOptimizedDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_VARARGS(kApiFunctionAddress, kActualArgumentsCount, kFunctionTemplateInfo, kHolder)
...
class CallApiCallbackGenericDescriptor : public StaticCallInterfaceDescriptor<CallApiCallbackGenericDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_VARARGS(kActualArgumentsCount, kTopmostScriptHavingContext, kFunctionTemplateInfo, kHolder)
    //                           receiver is implicit stack argument 1
    //                           argv are implicit stack arguments [2, 2 + kArgc[
...
class ApiGetterDescriptor : public StaticCallInterfaceDescriptor<ApiGetterDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class GrowArrayElementsDescriptor : public StaticCallInterfaceDescriptor<GrowArrayElementsDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class BaselineOutOfLinePrologueDescriptor : public StaticCallInterfaceDescriptor<BaselineOutOfLinePrologueDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kCalleeContext, kClosure, kJavaScriptCallArgCount, kStackFrameSize, kJavaScriptCallNewTarget, kInterpreterBytecodeArray)
    ...
    static constexpr int kMaxRegisterParams = StaticCallInterfaceDescriptor::kMaxRegisterParams + 1;
};

class BaselineLeaveFrameDescriptor : public StaticCallInterfaceDescriptor<BaselineLeaveFrameDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class OnStackReplacementDescriptor : public StaticCallInterfaceDescriptor<OnStackReplacementDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class V8_EXPORT_PRIVATE InterpreterDispatchDescriptor : public StaticCallInterfaceDescriptor<InterpreterDispatchDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kAccumulator, kBytecodeOffset, kBytecodeArray, kDispatchTable)
...
class InterpreterPushArgsThenCallDescriptor : public StaticCallInterfaceDescriptor<InterpreterPushArgsThenCallDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class InterpreterPushArgsThenConstructDescriptor : public StaticCallInterfaceDescriptor<InterpreterPushArgsThenConstructDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kNumberOfArguments, kFirstArgument, kConstructor, kNewTarget, kFeedbackElement)
    DEFINE_PARAMETER_TYPES(MachineType::Int32(), // kNumberOfArguments
        MachineType::Pointer(), // kFirstArgument
...
class InterpreterCEntry1Descriptor : public StaticCallInterfaceDescriptor<InterpreterCEntry1Descriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(1, kNumberOfArguments, kFirstArgument, kFunctionEntry)
...
class InterpreterCEntry2Descriptor : public StaticCallInterfaceDescriptor<InterpreterCEntry2Descriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(2, kNumberOfArguments, kFirstArgument, kFunctionEntry)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged(), // result 1
...
class FindNonDefaultConstructorOrConstructDescriptor : public StaticCallInterfaceDescriptor<FindNonDefaultConstructorOrConstructDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(2, kThisFunction, kNewTarget)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged(), // result 1 (true / false)
...
class ForInPrepareDescriptor : public StaticCallInterfaceDescriptor<ForInPrepareDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(2, kEnumerator, kVectorIndex, kFeedbackVector)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged(), // result 1 (cache array)
...
class ResumeGeneratorDescriptor final : public StaticCallInterfaceDescriptor<ResumeGeneratorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class ResumeGeneratorBaselineDescriptor final : public StaticCallInterfaceDescriptor<ResumeGeneratorBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kGeneratorObject, kRegisterCount)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::TaggedSigned(), // return type
...
class SuspendGeneratorBaselineDescriptor final : public StaticCallInterfaceDescriptor<SuspendGeneratorBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kGeneratorObject, kSuspendId, kBytecodeOffset, kRegisterCount)
...
class RestartFrameTrampolineDescriptor final : public StaticCallInterfaceDescriptor<RestartFrameTrampolineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS()
...
class RunMicrotasksEntryDescriptor final : public StaticCallInterfaceDescriptor<RunMicrotasksEntryDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class RunMicrotasksDescriptor final : public StaticCallInterfaceDescriptor<RunMicrotasksDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class WasmFloat32ToNumberDescriptor final : public StaticCallInterfaceDescriptor<WasmFloat32ToNumberDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kValue)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged(), // result
...
class WasmFloat64ToTaggedDescriptor final : public StaticCallInterfaceDescriptor<WasmFloat64ToTaggedDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kValue)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::AnyTagged(), // result
...
class WasmJSToWasmWrapperDescriptor final : public StaticCallInterfaceDescriptor<WasmJSToWasmWrapperDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class WasmToJSWrapperDescriptor final : public StaticCallInterfaceDescriptor<WasmToJSWrapperDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class WasmSuspendDescriptor final : public StaticCallInterfaceDescriptor<WasmSuspendDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class V8_EXPORT_PRIVATE I64ToBigIntDescriptor final : public StaticCallInterfaceDescriptor<I64ToBigIntDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kArgument)
...
class V8_EXPORT_PRIVATE I32PairToBigIntDescriptor final : public StaticCallInterfaceDescriptor<I32PairToBigIntDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class V8_EXPORT_PRIVATE BigIntToI64Descriptor final : public StaticCallInterfaceDescriptor<BigIntToI64Descriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kArgument)
...
class V8_EXPORT_PRIVATE BigIntToI32PairDescriptor final : public StaticCallInterfaceDescriptor<BigIntToI32PairDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CloneObjectWithVectorDescriptor final : public StaticCallInterfaceDescriptor<CloneObjectWithVectorDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CloneObjectBaselineDescriptor final : public StaticCallInterfaceDescriptor<CloneObjectBaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class BinaryOp_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<BinaryOp_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallTrampoline_Baseline_CompactDescriptor : public StaticCallInterfaceDescriptor<CallTrampoline_Baseline_CompactDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallTrampoline_BaselineDescriptor : public StaticCallInterfaceDescriptor<CallTrampoline_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CallTrampoline_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<CallTrampoline_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_VARARGS(kFunction, kActualArgumentsCount, kSlot, kFeedbackVector, kReceiver)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kFunction
        MachineType::Int32(), // kActualArgumentsCount
        MachineType::UintPtr(), // kSlot
        MachineType::AnyTagged(), // kFeedbackVector
...
class Compare_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<Compare_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS(kLeft, kRight, kSlot, kFeedbackVector)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kLeft
...
class Compare_BaselineDescriptor : public StaticCallInterfaceDescriptor<Compare_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_PARAMETERS_NO_CONTEXT(kLeft, kRight, kSlot)
    DEFINE_PARAMETER_TYPES(MachineType::AnyTagged(), // kLeft
...
class Construct_BaselineDescriptor : public StaticJSCallInterfaceDescriptor<Construct_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class Construct_WithFeedbackDescriptor : public StaticJSCallInterfaceDescriptor<Construct_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class UnaryOp_WithFeedbackDescriptor : public StaticCallInterfaceDescriptor<UnaryOp_WithFeedbackDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class UnaryOp_BaselineDescriptor : public StaticCallInterfaceDescriptor<UnaryOp_BaselineDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
...
class CheckTurboshaftFloat32TypeDescriptor : public StaticCallInterfaceDescriptor<CheckTurboshaftFloat32TypeDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(1, kValue, kExpectedType, kNodeId)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::TaggedPointer(), MachineTypeOf<Float32T>::value, MachineType::TaggedPointer(), MachineType::TaggedSigned())
    DECLARE_DEFAULT_DESCRIPTOR(CheckTurboshaftFloat32TypeDescriptor)
};

class CheckTurboshaftFloat64TypeDescriptor : public StaticCallInterfaceDescriptor<CheckTurboshaftFloat64TypeDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(1, kValue, kExpectedType, kNodeId)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::TaggedPointer(), MachineTypeOf<Float64T>::value, MachineType::TaggedPointer(), MachineType::TaggedSigned())
    DECLARE_DEFAULT_DESCRIPTOR(CheckTurboshaftFloat64TypeDescriptor)
};

class DebugPrintWordPtrDescriptor : public StaticCallInterfaceDescriptor<DebugPrintWordPtrDescriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(1, kValue)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::TaggedPointer(), MachineType::UintPtr())
    DECLARE_DEFAULT_DESCRIPTOR(DebugPrintWordPtrDescriptor)
};

class DebugPrintFloat64Descriptor : public StaticCallInterfaceDescriptor<DebugPrintFloat64Descriptor> {
public:
    INTERNAL_DESCRIPTOR()
    DEFINE_RESULT_AND_PARAMETERS(1, kValue)
    DEFINE_RESULT_AND_PARAMETER_TYPES(MachineType::TaggedPointer(), MachineType::Float64())
    DECLARE_DEFAULT_DESCRIPTOR(DebugPrintFloat64Descriptor)
};

#define DEFINE_TFS_BUILTIN_DESCRIPTOR(Name, DoesNeedContext, ...)                                                                                              \
    class Name##Descriptor : public StaticCallInterfaceDescriptor<Name##Descriptor> {                                                                          \
    public:                                                                                                                                                    \
        INTERNAL_DESCRIPTOR()                                                                                                                                  \
        DEFINE_PARAMETERS(__VA_ARGS__)                                                                                                                         \
...
#define DEF_KEY(name, ...)                                                                                                                                     \
    CallDescriptors::Key name##Descriptor::key()                                                                                                               \
    {                                                                                                                                                          \
        return CallDescriptors::name;                                                                                                                          \
    }
