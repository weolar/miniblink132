...
#define COND_ARGS Condition cond = al, Register rj = zero_reg, const Operand &rk = Operand(zero_reg)
...
#define DEFINE_INSTRUCTION(instr)                                                                                                                              \
    ...
    void instr(Register rj, Register rk, int32_t j)                                                                                                            \
    {                                                                                                                                                          \
        instr(rj, rk, Operand(j));                                                                                                                             \
    }

#define DEFINE_INSTRUCTION2(instr)                                                                                                                             \
    void instr(Register rj, const Operand& rk);                                                                                                                \
    void instr(Register rj, Register rk)                                                                                                                       \
    {                                                                                                                                                          \
        instr(rj, Operand(rk));                                                                                                                                \
    }                                                                                                                                                          \
    void instr(Register rj, int32_t j)                                                                                                                         \
    {                                                                                                                                                          \
        instr(rj, Operand(j));                                                                                                                                 \
    }
...
#undef COND_ARGS
    ...
    inline void Move(Register dst, Handle<HeapObject> handle)
    {
        li(dst, handle);
    }
    inline void Move(Register dst, Tagged<Smi> value)
    {
    ...
    void Alsl_w(Register rd, Register rj, Register rk, uint8_t sa, Register scratch = t7);
    void Alsl_d(Register rd, Register rj, Register rk, uint8_t sa, Register scratch = t7);
