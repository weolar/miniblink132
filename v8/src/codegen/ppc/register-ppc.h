...
#define GENERAL_REGISTERS(V)                                                                                                                                   \
    V(r0)                                                                                                                                                      \
    V(sp) V(r2) V(r3) V(r4) V(r5) V(r6) V(r7) V(r8) V(r9) V(r10) V(r11) V(ip) V(r13) V(r14) V(r15) V(r16) V(r17) V(r18) V(r19) V(r20) V(r21) V(r22) V(r23)     \
        V(r24) V(r25) V(r26) V(r27) V(r28) V(r29) V(r30) V(fp)

#define ALWAYS_ALLOCATABLE_GENERAL_REGISTERS(V)                                                                                                                \
    V(r3) V(r4) V(r5) V(r6) V(r7) V(r8) V(r9) V(r10) V(r14) V(r15) V(r16) V(r17) V(r18) V(r19) V(r20) V(r21) V(r22) V(r23) V(r24) V(r25) V(r26) V(r30)
...
#define ALLOCATABLE_DOUBLE_REGISTERS(V)                                                                                                                        \
    V(d1)                                                                                                                                                      \
    V(d2) V(d3) V(d4) V(d5) V(d6) V(d7) V(d8) V(d9) V(d10) V(d11) V(d12) V(d15) V(d16) V(d17) V(d18) V(d19) V(d20) V(d21) V(d22) V(d23) V(d24) V(d25) V(d26)   \
...
#define ALLOCATABLE_SIMD128_REGISTERS(V)                                                                                                                       \
    V(v0)                                                                                                                                                      \
    V(v1) V(v2) V(v3) V(v4) V(v5) V(v6) V(v7) V(v8) V(v9) V(v10) V(v11) V(v12) V(v16) V(v17) V(v18) V(v19) V(v20) V(v21) V(v22) V(v23) V(v24) V(v25) V(v26)    \
...
public:
    explicit constexpr Simd128Register(int code)
        : RegisterBase(code)
    {
    }
};
ASSERT_TRIVIALLY_COPYABLE(Simd128Register);
static_assert(sizeof(Simd128Register) <= sizeof(int), "Simd128Register can efficiently be passed by value");
