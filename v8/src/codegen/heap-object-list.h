...
#define BUILTINS_WITH_SFI_OBJECT_LIST_ADAPTER(V, CamelName, underscore_name, ...) V(CamelName##SharedFun, underscore_name##_shared_fun, CamelName##SharedFun)

#define BUILTINS_WITH_SFI_OBJECT_LIST(V) BUILTINS_WITH_SFI_LIST_GENERATOR(BUILTINS_WITH_SFI_OBJECT_LIST_ADAPTER, V)
...
#define UNIQUE_INSTANCE_TYPE_IMMUTABLE_IMMOVABLE_MAP_ADAPTER(V, rootIndexName, rootAccessorName, class_name) V(rootIndexName, rootAccessorName, class_name##Map)
...
#define HEAP_IMMUTABLE_IMMOVABLE_OBJECT_LIST(V)                                                                                                                \
    ...
    V(wasm_wrapped_object_symbol, wasm_wrapped_object_symbol, WasmWrappedObjectSymbol)                                                                         \
    V(zero_string, zero_string, ZeroString)                                                                                                                    \
    UNIQUE_INSTANCE_TYPE_MAP_LIST_GENERATOR(UNIQUE_INSTANCE_TYPE_IMMUTABLE_IMMOVABLE_MAP_ADAPTER, V)
