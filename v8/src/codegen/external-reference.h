...
#define EXTERNAL_REFERENCE_LIST(V)                                                                                                                             \
    ...
    IF_WASM(V, wasm_WebAssemblyMemoryGetBuffer, "wasm::WebAssemblyMemoryGetBuffer")                                                                            \
    IF_WASM(V, wasm_WebAssemblyMemoryGrow, "wasm::WebAssemblyMemoryGrow")                                                                                      \
    IF_WASM(V, wasm_WebAssemblyModule, "wasm::WebAssemblyModule")                                                                                              \
    IF_WASM(V, wasm_WebAssemblyModuleCustomSections, "wasm::WebAssemblyModuleCustomSections")                                                                  \
    ...
    IF_WASM(V, wasm_WebAssemblyTableGetLength, "wasm::WebAssemblyTableGetLength")                                                                              \
    ...
    V(address_of_wasm_f64x2_convert_low_i32x4_u_int_mask, "wasm_f64x2_convert_low_i32x4_u_int_mask")                                                           \
    ...
    V(address_of_wasm_i32x8_int32_overflow_as_float, "wasm_i32x8_int32_overflow_as_float")                                                                     \
    ...
    V(write_barrier_indirect_pointer_marking_from_code_function, "WriteBarrier::IndirectPointerMarkingFromCode")                                               \
    V(write_barrier_shared_marking_from_code_function, "WriteBarrier::SharedMarkingFromCode")                                                                  \
    ...
    V(atomic_pair_compare_exchange_function, "atomic_pair_compare_exchange_function")                                                                          \
    IF_TSAN(V, tsan_relaxed_store_function_8_bits, "tsan_relaxed_store_function_8_bits")                                                                       \
    IF_TSAN(V, tsan_relaxed_store_function_16_bits, "tsan_relaxed_store_function_16_bits")                                                                     \
    IF_TSAN(V, tsan_relaxed_store_function_32_bits, "tsan_relaxed_store_function_32_bits")                                                                     \
    IF_TSAN(V, tsan_relaxed_store_function_64_bits, "tsan_relaxed_store_function_64_bits")                                                                     \
    IF_TSAN(V, tsan_seq_cst_store_function_8_bits, "tsan_seq_cst_store_function_8_bits")                                                                       \
    IF_TSAN(V, tsan_seq_cst_store_function_16_bits, "tsan_seq_cst_store_function_16_bits")                                                                     \
    IF_TSAN(V, tsan_seq_cst_store_function_32_bits, "tsan_seq_cst_store_function_32_bits")                                                                     \
    IF_TSAN(V, tsan_seq_cst_store_function_64_bits, "tsan_seq_cst_store_function_64_bits")                                                                     \
    IF_TSAN(V, tsan_relaxed_load_function_32_bits, "tsan_relaxed_load_function_32_bits")                                                                       \
    IF_TSAN(V, tsan_relaxed_load_function_64_bits, "tsan_relaxed_load_function_64_bits")                                                                       \
    V(js_finalization_registry_remove_cell_from_unregister_token_map, "JSFinalizationRegistry::RemoveCellFromUnregisterTokenMap")                              \
    V(re_case_insensitive_compare_unicode, "RegExpMacroAssembler::CaseInsensitiveCompareUnicode()")                                                            \
    V(re_case_insensitive_compare_non_unicode, "RegExpMacroAssembler::CaseInsensitiveCompareNonUnicode()")                                                     \
    V(re_is_character_in_range_array, "RegExpMacroAssembler::IsCharacterInRangeArray()")                                                                       \
    V(re_check_stack_guard_state, "RegExpMacroAssembler*::CheckStackGuardState()")                                                                             \
    V(re_grow_stack, "NativeRegExpMacroAssembler::GrowStack()")                                                                                                \
    V(re_word_character_map, "NativeRegExpMacroAssembler::word_character_map")                                                                                 \
    V(re_match_for_call_from_js, "IrregexpInterpreter::MatchForCallFromJs")                                                                                    \
    V(re_experimental_match_for_call_from_js, "ExperimentalRegExp::MatchForCallFromJs")                                                                        \
    V(typed_array_and_rab_gsab_typed_array_elements_kind_shifts, "TypedArrayAndRabGsabTypedArrayElementsKindShifts")                                           \
    V(typed_array_and_rab_gsab_typed_array_elements_kind_sizes, "TypedArrayAndRabGsabTypedArrayElementsKindSizes")                                             \
...
#define EXTERNAL_REFERENCE_LIST_SANDBOX(V)                                                                                                                     \
    ...
    V(code_pointer_table_address, "IsolateGroup::current()->code_pointer_table()")                                                                             \
...
#define COUNT_EXTERNAL_REFERENCE(name, desc) +1
    static constexpr int kExternalReferenceCountIsolateIndependent = EXTERNAL_REFERENCE_LIST(COUNT_EXTERNAL_REFERENCE);
    static constexpr int kExternalReferenceCountIsolateDependent = EXTERNAL_REFERENCE_LIST_WITH_ISOLATE(COUNT_EXTERNAL_REFERENCE);
#undef COUNT_EXTERNAL_REFERENCE
    ...
    // GP and FP arguments.
    static V8_EXPORT_PRIVATE ExternalReference Create(
        Isolate* isolate, ApiFunction* ptr, Type type, Address* c_functions, const CFunctionInfo* const* c_signatures, unsigned num_functions);
    ...
    template <typename SubjectChar, typename PatternChar> static ExternalReference search_string_raw();

    V8_EXPORT_PRIVATE static ExternalReference FromRawAddress(Address address);

#define DECL_EXTERNAL_REFERENCE(name, desc) V8_EXPORT_PRIVATE static ExternalReference name();
    EXTERNAL_REFERENCE_LIST(DECL_EXTERNAL_REFERENCE)
#undef DECL_EXTERNAL_REFERENCE

#define DECL_EXTERNAL_REFERENCE(name, desc) static V8_EXPORT_PRIVATE ExternalReference name(Isolate* isolate);
    EXTERNAL_REFERENCE_LIST_WITH_ISOLATE(DECL_EXTERNAL_REFERENCE)
#undef DECL_EXTERNAL_REFERENCE

    V8_EXPORT_PRIVATE static ExternalReference isolate_address();

    V8_EXPORT_PRIVATE V8_NOINLINE static ExternalReference runtime_function_table_address_for_unittests(Isolate* isolate);
