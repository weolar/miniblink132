...
#define ASSERT_CONSECUTIVE(rep1, rep2)                                                                                                                         \
    static_assert(static_cast<uint8_t>(MachineRepresentation::k##rep1) + 1 == static_cast<uint8_t>(MachineRepresentation::k##rep2),                            \
...
static_assert(MachineRepresentation::kLastRepresentation == MachineRepresentation::kSimd256, "FP and SIMD representations must be last.");

static_assert(
    static_cast<int>(MachineRepresentation::kLastRepresentation) < kIntSize * kBitsPerByte, "Bit masks of MachineRepresentation should fit in an int");

V8_EXPORT_PRIVATE const char* MachineReprToString(MachineRepresentation);

enum class MachineSemantic : uint8_t { kNone, kBool, kInt32, kUint32, kInt64, kUint64, kSignedBigInt64, kUnsignedBigInt64, kNumber, kHoleyFloat64, kAny };

V8_EXPORT_PRIVATE inline constexpr int ElementSizeLog2Of(MachineRepresentation);

V8_EXPORT_PRIVATE inline constexpr int ElementSizeInBytes(MachineRepresentation);
...
public:
    ...
    {
        return representation() == MachineRepresentation::kTaggedPointer || representation() == MachineRepresentation::kTaggedSigned
    ...
    {
        return representation() == MachineRepresentation::kCompressedPointer || representation() == MachineRepresentation::kCompressed;
    }
    ...
    {
        return (kSystemPointerSize == 4) ? MachineRepresentation::kWord32 : MachineRepresentation::kWord64;
    }
    ...
    {
        return MachineType(MachineRepresentation::kWord16, MachineSemantic::kUint32);
    }
    ...
    {
        return MachineType(MachineRepresentation::kWord32, MachineSemantic::kUint32);
    }
    ...
    {
        return MachineType(MachineRepresentation::kWord64, MachineSemantic::kUint64);
    }
    constexpr static MachineType SignedBigInt64()
    {
        return MachineType(MachineRepresentation::kWord64, MachineSemantic::kSignedBigInt64);
    }
    constexpr static MachineType UnsignedBigInt64()
    {
        return MachineType(MachineRepresentation::kWord64, MachineSemantic::kUnsignedBigInt64);
    }
    constexpr static MachineType Float16()
    {
        return MachineType(MachineRepresentation::kFloat16, MachineSemantic::kNumber);
    }
    constexpr static MachineType Float32()
    {
        return MachineType(MachineRepresentation::kFloat32, MachineSemantic::kNumber);
    }
    constexpr static MachineType Float64()
    {
        return MachineType(MachineRepresentation::kFloat64, MachineSemantic::kNumber);
    }
    constexpr static MachineType HoleyFloat64()
    {
        return MachineType(MachineRepresentation::kFloat64, MachineSemantic::kHoleyFloat64);
    }
    ...
    {
        return MachineType(MachineRepresentation::kTaggedSigned, MachineSemantic::kInt32);
    }
    ...
    {
        return MachineType(MachineRepresentation::kCompressedPointer, MachineSemantic::kAny);
    }
    constexpr static MachineType AnyCompressed()
    {
        return MachineType(MachineRepresentation::kCompressed, MachineSemantic::kAny);
    }
    constexpr static MachineType SandboxedPointer()
    {
        return MachineType(MachineRepresentation::kSandboxedPointer, MachineSemantic::kInt64);
    }
    constexpr static MachineType ProtectedPointer()
    {
        return MachineType(MachineRepresentation::kProtectedPointer, MachineSemantic::kAny);
    }
    constexpr static MachineType IndirectPointer()
    {
        return MachineType(MachineRepresentation::kIndirectPointer, MachineSemantic::kInt32);
    }
    ...
    static MachineType TypeForCType(const CTypeInfo& type)
    {
        ...
        case CTypeInfo::Type::kAny:
            static_assert(sizeof(AnyCType) == kInt64Size, "CTypeInfo::Type::kAny is assumed to be of size 64 bits.");
            return MachineType::Int64();
...
V8_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, MachineRepresentation rep);
...
{
    return rep >= MachineRepresentation::kWord8 && rep <= MachineRepresentation::kWord64;
}
...
{
    return rep == MachineRepresentation::kTagged || rep == MachineRepresentation::kTaggedPointer || rep == MachineRepresentation::kMapWord;
}
...
constexpr inline bool CanBeTaggedOrCompressedPointer(MachineRepresentation rep)
{
    return CanBeTaggedPointer(rep) || CanBeCompressedPointer(rep) || rep == MachineRepresentation::kProtectedPointer;
}

constexpr inline bool CanBeTaggedOrCompressedOrIndirectPointer(MachineRepresentation rep)
{
    return CanBeTaggedPointer(rep) || CanBeCompressedPointer(rep) || CanBeIndirectPointer(rep);
}
...
V8_EXPORT_PRIVATE inline constexpr int ElementSizeLog2Of(MachineRepresentation rep)
{
    switch (rep) {
    case MachineRepresentation::kBit:
    case MachineRepresentation::kWord8:
...
constexpr int kMaximumReprSizeLog2 = ElementSizeLog2Of(MachineRepresentation::kSimd128);
constexpr int kMaximumReprSizeInBytes = 1 << kMaximumReprSizeLog2;

static_assert(kMaximumReprSizeLog2 >= ElementSizeLog2Of(MachineRepresentation::kTagged));
static_assert(kMaximumReprSizeLog2 >= ElementSizeLog2Of(MachineRepresentation::kWord64));

V8_EXPORT_PRIVATE inline constexpr int ElementSizeInBytes(MachineRepresentation rep)
{
...
V8_EXPORT_PRIVATE inline constexpr int ElementSizeInPointers(MachineRepresentation rep)
{
    return (ElementSizeInBytes(rep) + kSystemPointerSize - 1) / kSystemPointerSize;
}

// Converts representation to bit for representation masks.
V8_EXPORT_PRIVATE inline constexpr int RepresentationBit(MachineRepresentation rep)
{
