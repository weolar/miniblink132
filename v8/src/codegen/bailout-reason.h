...
#define ABORT_MESSAGES_LIST(V)                                                                                                                                 \
    ...
    V(kExpectedOptimizationSentinel, "Expected optimized code cell or optimization sentinel")                                                                  \
    V(kExpectedUndefinedOrCell, "Expected undefined or cell in register")                                                                                      \
    V(kExpectedFeedbackCell, "Expected feedback cell")                                                                                                         \
    V(kExpectedFeedbackVector, "Expected feedback vector")                                                                                                     \
    V(kExpectedBaselineData, "Expected baseline data")                                                                                                         \
    V(kFloat64IsNotAInt32, "Float64 cannot be converted to Int32 without loss of precision")                                                                   \
    V(kFunctionDataShouldBeBytecodeArrayOnInterpreterEntry, "The function_data field should be a BytecodeArray on interpreter entry")                          \
    ...
    V(kInvalidParametersAndRegistersInGenerator, "invalid parameters and registers in generator")                                                              \
    V(kMissingBytecodeArray, "Missing bytecode array from function")                                                                                           \
    V(kObjectNotTagged, "The object is not tagged")                                                                                                            \
    V(kObjectTagged, "The object is tagged")                                                                                                                   \
    V(kOffsetOutOfRange, "Offset out of range")                                                                                                                \
    V(kOperandIsASmi, "Operand is a smi")                                                                                                                      \
    V(kOperandIsASmiAndNotABoundFunction, "Operand is a smi and not a bound function")                                                                         \
    V(kOperandIsASmiAndNotAConstructor, "Operand is a smi and not a constructor")                                                                              \
    V(kOperandIsASmiAndNotAFunction, "Operand is a smi and not a function")                                                                                    \
    V(kOperandIsASmiAndNotAGeneratorObject, "Operand is a smi and not a generator object")                                                                     \
    ...
    V(kShouldNotDirectlyEnterOsrFunction, "Should not directly enter OSR-compiled function")                                                                   \
    V(kStackAccessBelowStackPointer, "Stack access below stack pointer")                                                                                       \
    V(kOsrUnexpectedStackSize, "Unexpected stack size on OSR entry")                                                                                           \
    V(kStackFrameTypesMustMatch, "Stack frame types must match")                                                                                               \
    V(kUint32IsNotAInt32, "Uint32 cannot be converted to Int32 without loss of precision")                                                                     \
    ...
    V(kUnexpectedFunctionIDForInvokeIntrinsic, "Unexpected runtime function id for the InvokeIntrinsic bytecode")                                              \
    ...
    V(kUnexpectedReturnFromFrameDropper, "Unexpectedly returned from dropping frames")                                                                         \
    V(kUnexpectedReturnFromThrow, "Unexpectedly returned from a throw")                                                                                        \
    V(kUnexpectedReturnFromWasmTrap, "Should not return after throwing a wasm trap")                                                                           \
    ...
    V(kWrongArgumentCountForInvokeIntrinsic, "Wrong number of arguments for intrinsic")                                                                        \
    V(kWrongFunctionCodeStart, "Wrong value in code start register passed")                                                                                    \
    V(kWrongFunctionContext, "Wrong context passed to function")                                                                                               \
    V(kWrongFunctionDispatchHandle, "Wrong value in dispatch handle register passed")                                                                          \
    ...
    V(kTurboshaftTypeAssertionFailed, "A type assertion failed in Turboshaft-generated code")                                                                  \
    V(kMetadataAreaStartDoesNotMatch, "The metadata doesn't belong to the chunk")                                                                              \
