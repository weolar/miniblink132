...
public:
    ...
    static constexpr int kMaxRegisters = std::max(kMaxFPRegisters, kMaxGeneralRegisters);
    ...
    RegisterConfiguration(AliasingKind fp_aliasing_kind, int num_general_registers, int num_double_registers, int num_simd128_registers,
