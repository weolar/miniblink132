...
template <typename PayloadTaggingScheme> struct TaggedPayload {
    static_assert(PayloadTaggingScheme::kMarkBit != 0, "Invalid kMarkBit specified in tagging scheme.");
    ...
    bool IsTaggedWith(typename PayloadTaggingScheme::TagType tag) const
    {
        ...
        uint64_t actual = (encoded_word_ & PayloadTaggingScheme::kTagMask) & ~PayloadTaggingScheme::kMarkBit;
        return expected == actual;
    }

    void SetMarkBit()
    {
        encoded_word_ |= PayloadTaggingScheme::kMarkBit;
    }
    ...
    {
        return static_cast<typename PayloadTaggingScheme::TagType>((encoded_word_ & PayloadTaggingScheme::kTagMask) | PayloadTaggingScheme::kMarkBit);
    }
