...
void TrustedPointerTableEntry::MakeTrustedPointerEntry(Address pointer, IndirectPointerTag tag, bool mark_as_alive)
{
...
void TrustedPointerTableEntry::SetPointer(Address pointer, IndirectPointerTag tag)
{
    DCHECK(!IsFreelistEntry());
...
Address TrustedPointerTable::Get(TrustedPointerHandle handle, IndirectPointerTag tag) const
{
...
void TrustedPointerTable::Set(TrustedPointerHandle handle, Address pointer, IndirectPointerTag tag)
{
...
TrustedPointerHandle TrustedPointerTable::AllocateAndInitializeEntry(Space* space, Address pointer, IndirectPointerTag tag)
{
...
void TrustedPointerTable::Mark(Space* space, TrustedPointerHandle handle)
{
    ...
    if (handle == kNullTrustedPointerHandle)
        return;
...
template <typename Callback> void TrustedPointerTable::IterateActiveEntriesIn(Space* space, Callback callback)
{
