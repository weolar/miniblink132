...
void CppHeapPointerTableEntry::MakePointerEntry(Address value, CppHeapPointerTag tag, bool mark_as_alive)
{
...
Address CppHeapPointerTableEntry::GetPointer(CppHeapPointerTagRange tag_range) const
{
...
void CppHeapPointerTableEntry::SetPointer(Address value, CppHeapPointerTag tag)
{
    // Top bits must be zero, otherwise we'd loose information when shifting.
    DCHECK_EQ(0, value >> (kBitsPerSystemPointer - kCppHeapPointerPayloadShift));
    DCHECK_NE(tag, CppHeapPointerTag::kFreeEntryTag);
...
bool CppHeapPointerTableEntry::HasPointer(CppHeapPointerTagRange tag_range) const
{
    auto payload = payload_.load(std::memory_order_relaxed);
...
Address CppHeapPointerTable::Get(CppHeapPointerHandle handle, CppHeapPointerTagRange tag_range) const
{
...
void CppHeapPointerTable::Set(CppHeapPointerHandle handle, Address value, CppHeapPointerTag tag)
{
...
CppHeapPointerHandle CppHeapPointerTable::AllocateAndInitializeEntry(Space* space, Address initial_value, CppHeapPointerTag tag)
{
...
void CppHeapPointerTable::Mark(Space* space, CppHeapPointerHandle handle, Address handle_location)
{
    DCHECK(space->BelongsTo(this));
...
bool CppHeapPointerTable::Contains(Space* space, CppHeapPointerHandle handle) const
{
    DCHECK(space->BelongsTo(this));
