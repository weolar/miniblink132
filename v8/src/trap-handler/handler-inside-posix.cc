...
bool IsKernelGeneratedSignal(siginfo_t* info)
{
    ...
    return info->si_code > 0 && info->si_code != SI_USER && info->si_code != SI_QUEUE && info->si_code != SI_TIMER && info->si_code != SI_ASYNCIO
...
bool TryHandleSignal(int signum, siginfo_t* info, void* context)
{
    ...
    if (!IsAccessedMemoryCovered(access_addr))
        return false;
...
#error "Unsupported architecture."
        ...
        if (!IsFaultAddressCovered(*simulated_ip_reg))
            return false;
