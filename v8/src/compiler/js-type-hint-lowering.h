...
public:
    ...
    public:
        ...
        static LoweringResult SideEffectFree(Node* value, Node* effect, Node* control)
        {
            ...
            return LoweringResult(LoweringResultKind::kSideEffectFree, value, effect, control);
        }

        static LoweringResult NoChange()
        {
            return LoweringResult(LoweringResultKind::kNoChange, nullptr, nullptr, nullptr);
        }

        static LoweringResult Exit(Node* control)
        {
            return LoweringResult(LoweringResultKind::kExit, nullptr, nullptr, control);
        }
    ...
    LoweringResult ReduceForInNextOperation(
