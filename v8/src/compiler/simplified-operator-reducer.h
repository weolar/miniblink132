...
class V8_EXPORT_PRIVATE SimplifiedOperatorReducer final : public NON_EXPORTED_BASE(AdvancedReducer) {
public:
    ...
    SimplifiedOperatorReducer& operator=(const SimplifiedOperatorReducer&) = delete;
