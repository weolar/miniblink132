...
public:
    ...
    Type const kDoubleRepresentableInt64 = CreateRange(std::numeric_limits<int64_t>::min(), kMaxDoubleRepresentableInt64);
    Type const kDoubleRepresentableInt64OrMinusZero = Type::Union(kDoubleRepresentableInt64, Type::MinusZero(), zone());
    Type const kDoubleRepresentableUint64 = CreateRange(std::numeric_limits<uint64_t>::min(), kMaxDoubleRepresentableUint64);
    ...
    Type const kMinusOneToOneOrMinusZeroOrNaN = Type::Union(Type::Union(CreateRange(-1.0, 1.0), Type::MinusZero(), zone()), Type::NaN(), zone());
    ...
    Type const kAdditiveSafeInteger = CreateRange(-4503599627370495.0, 4503599627370495.0);
    ...
    Type const kWeakFixedArrayLengthType = CreateRange(0.0, WeakFixedArray::kMaxCapacity);
    ...
    Type const kJSDateYearType = Type::Union(CreateRange(-271821, 275760), Type::NaN(), zone());
