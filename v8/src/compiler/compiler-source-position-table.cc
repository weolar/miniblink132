...
public:
    ...
    {
        source_positions_->SetSourcePosition(node, source_positions_->current_position_);
    }
...
void SourcePositionTable::SetSourcePosition(Node* node, SourcePosition position)
{
    DCHECK(IsEnabled());
