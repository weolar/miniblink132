...
protected:
    ...
    void MergeControlToEnd(Graph* graph, CommonOperatorBuilder* common, Node* node)
    {
...
public:
    GraphReducer(
        Zone* zone, Graph* graph, TickCounter* tick_counter, JSHeapBroker* broker, Node* dead = nullptr, ObserveNodeManager* observe_node_manager = nullptr);
