...
#define DECL_PIPELINE_PHASE_CONSTANTS_HELPER(Name, Kind, Mode)                                                                                                 \
    ...
    static constexpr RuntimeCallCounterId kRuntimeCallCounterId = RuntimeCallCounterId::kOptimize##Name;                                                       \
...
#define DECL_PIPELINE_PHASE_CONSTANTS(Name) DECL_PIPELINE_PHASE_CONSTANTS_HELPER(Name, PhaseKind::kTurbofan, RuntimeCallStats::kThreadSpecific)

#define DECL_MAIN_THREAD_PIPELINE_PHASE_CONSTANTS(Name) DECL_PIPELINE_PHASE_CONSTANTS_HELPER(Name, PhaseKind::kTurbofan, RuntimeCallStats::kExact)
...
inline constexpr char kRegisterAllocationZoneName[] = "register-allocation-zone";
inline constexpr char kRegisterAllocatorVerifierZoneName[] = "register-allocator-verifier-zone";
...
inline std::ostream& operator<<(std::ostream& out, TurbolizerCodeOffsetsInfoAsJSON s)
{
    out << ", \"codeOffsetsInfo\": {";
    out << "\"codeStartRegisterCheck\": " << s.offsets_info->code_start_register_check << ", ";
