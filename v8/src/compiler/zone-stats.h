...
public:
    ...
    public:
        explicit Scope(ZoneStats* zone_stats, const char* zone_name, bool support_zone_compression = false)
        ...
        Scope(Scope&& other) V8_NOEXCEPT : zone_name_(other.zone_name_),
        ...
        {
            if (zone_ == nullptr)
                zone_ = zone_stats_->NewEmptyZone(zone_name_, support_zone_compression_);
            return zone_;
        }
        void Destroy()
        {
