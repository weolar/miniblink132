...
public:
    enum class Enum : uint8_t {
        ...
        kCompressed = static_cast<int>(MaybeRegisterRepresentation::Enum::kCompressed),
    ...
    explicit constexpr RegisterRepresentation(Enum value)
        : MaybeRegisterRepresentation(static_cast<MaybeRegisterRepresentation::Enum>(value))
    {
    }
    ...
    {
        if (t.GetType() == CTypeInfo::Type::kVoid || t.GetType() == CTypeInfo::Type::kPointer) {
            return RegisterRepresentation::Tagged();
        } else if (t.GetType() == CTypeInfo::Type::kInt64 || t.GetType() == CTypeInfo::Type::kUint64) {
            ...
            return RegisterRepresentation::FromMachineType(MachineType::TypeForCType(t));
        }
    }
    ...
    constexpr RegisterRepresentation MapTaggedToWord() const
    {
        if (this->value() == RegisterRepresentation::Tagged()) {
            return COMPRESS_POINTERS_BOOL ? RegisterRepresentation::Word32() : RegisterRepresentation::WordPtr();
        }
        return *this;
    }
    ...
    {
        return V8_ENABLE_WASM_CODE_POINTER_TABLE_BOOL ? RegisterRepresentation::Word32() : RegisterRepresentation::WordPtr();
    }
};
...
constexpr bool RegisterRepresentation::AllowImplicitRepresentationChangeTo(RegisterRepresentation dst_rep, bool graph_created_from_turbofan) const
{
    if (*this == dst_rep) {
        return true;
    }
    ...
    case RegisterRepresentation::Word32():
        ...
        // tagged values.
        if (*this == any_of(RegisterRepresentation::Tagged(), RegisterRepresentation::Compressed())) {
            return true;
        }
        if (graph_created_from_turbofan && *this == RegisterRepresentation::Word64()) {
    ...
    case RegisterRepresentation::Word64():
        // We allow implicit tagged -> untagged conversions.
        if (kTaggedSize == kInt64Size && *this == RegisterRepresentation::Tagged()) {
            return true;
        }
        break;
    ...
    case RegisterRepresentation::Compressed():
        ...
        if (*this == any_of(RegisterRepresentation::Tagged(), RegisterRepresentation::WordPtr(), RegisterRepresentation::Word32())) {
            return true;
        }
        break;
    default:
...
V8_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, MaybeRegisterRepresentation rep);

template <typename T> struct MultiSwitch<T, std::enable_if_t<std::is_base_of_v<MaybeRegisterRepresentation, T>>> {
...
public:
    ...
    explicit constexpr WordRepresentation(Enum value)
        : RegisterRepresentation(static_cast<RegisterRepresentation::Enum>(value))
    {
    }
...
public:
    ...
    explicit constexpr MemoryRepresentation(Enum value)
        : value_(value)
    {
    }
...
V8_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, MemoryRepresentation rep);
