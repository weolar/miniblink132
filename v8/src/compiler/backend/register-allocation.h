...
inline int GetRegisterCount(const RegisterConfiguration* config, RegisterKind kind)
{
    switch (kind) {
...
inline int GetAllocatableRegisterCount(const RegisterConfiguration* config, RegisterKind kind)
{
    switch (kind) {
    case RegisterKind::kGeneral:
...
inline const int* GetAllocatableRegisterCodes(const RegisterConfiguration* config, RegisterKind kind)
{
    switch (kind) {
    case RegisterKind::kGeneral:
