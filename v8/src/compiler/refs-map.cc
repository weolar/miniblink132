...
using UnderlyingMap = base::TemplateHashMapImpl<Address, ObjectData*, AddressMatcher, ZoneAllocationPolicy>;
...
{
    return UnderlyingMap::LookupOrInsert(key, RefsMap::Hash(key), []() { return nullptr; });
}
