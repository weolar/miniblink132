...
public:
    ...
    static Schedule* ComputeSchedule(Zone* temp_zone, Graph* graph, Flags flags, TickCounter* tick_counter, const ProfileDataFromFile* profile_data);
...
private:
    ...
    Schedule* schedule_;
    Flags flags_;
    ZoneVector<NodeVector*> scheduled_nodes_; // Per-block list of nodes in reverse.
    ...
    Scheduler(
        Zone* zone, Graph* graph, Schedule* schedule, Flags flags, size_t node_count_hint_, TickCounter* tick_counter, const ProfileDataFromFile* profile_data);
