...
void ControlEquivalence::VisitPost(Node* node, Node* parent_node, DFSDirection direction)
{
...
void ControlEquivalence::VisitBackedge(Node* from, Node* to, DFSDirection direction)
{
...
void ControlEquivalence::DetermineParticipationEnqueue(ZoneQueue<Node*>& queue, Node* node)
{
...
void ControlEquivalence::DFSPush(DFSStack& stack, Node* node, Node* from, DFSDirection dir)
{
...
void ControlEquivalence::BracketListDelete(BracketList& blist, Node* to, DFSDirection direction)
{
