...
V8_WARN_UNUSED_RESULT inline bool IsValidHeapObject(Heap* heap, Tagged<HeapObject> object)
{
    return ReadOnlyHeap::Contains(object) || heap->Contains(object) || heap->SharedHeapContains(object);
}

V8_WARN_UNUSED_RESULT inline bool IsValidCodeObject(Heap* heap, Tagged<HeapObject> object)
{
