...
#define RO_ROOT_ACCESSOR(Type, name, CamelName)                                                                                                                \
    template <typename Impl> Handle<Type> FactoryBase<Impl>::name()                                                                                            \
    {                                                                                                                                                          \
...
template <typename Impl> Handle<Boolean> FactoryBase<Impl>::ToBoolean(bool value)
{
    return value ? Cast<Boolean>(impl()->true_value()) : Cast<Boolean>(impl()->false_value());
}

template <typename Impl> template <AllocationType allocation> Handle<Number> FactoryBase<Impl>::NewNumber(double value)
{
...
template <typename Impl> template <AllocationType allocation> Handle<Number> FactoryBase<Impl>::NewNumberFromInt(int32_t value)
{
...
template <typename Impl> template <AllocationType allocation> Handle<Number> FactoryBase<Impl>::NewNumberFromUint(uint32_t value)
{
...
template <typename Impl> template <AllocationType allocation> Handle<Number> FactoryBase<Impl>::NewNumberFromSize(size_t value)
{
...
template <typename Impl> template <AllocationType allocation> Handle<Number> FactoryBase<Impl>::NewNumberFromInt64(int64_t value)
{
...
template <typename Impl> template <AllocationType allocation> Handle<HeapNumber> FactoryBase<Impl>::NewHeapNumber(double value)
{
...
template <typename Impl> template <AllocationType allocation> Handle<HeapNumber> FactoryBase<Impl>::NewHeapNumberFromBits(uint64_t bits)
{
    Handle<HeapNumber> heap_number = NewHeapNumber<allocation>();
...
template <typename Impl> template <AllocationType allocation> Handle<HeapNumber> FactoryBase<Impl>::NewHeapNumberWithHoleNaN()
{
    return NewHeapNumberFromBits<allocation>(kHoleNanInt64);
}

template <typename Impl> template <typename StructType> Tagged<StructType> FactoryBase<Impl>::NewStructInternal(InstanceType type, AllocationType allocation)
{
...
template <typename Impl> Tagged<Struct> FactoryBase<Impl>::NewStructInternal(ReadOnlyRoots roots, Tagged<Map> map, int size, AllocationType allocation)
{
