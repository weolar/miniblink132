...
public:
    explicit SemiSpaceNewSpaceAllocatorPolicy(SemiSpaceNewSpace* space, MainAllocator* allocator)
...
public:
    ...
    V8_EXPORT_PRIVATE MainAllocator(
        LocalHeap* heap, SpaceWithLinearArea* space, IsNewGeneration is_new_generation, LinearAllocationArea* allocation_info = nullptr);
    ...
    V8_WARN_UNUSED_RESULT V8_EXPORT_PRIVATE AllocationResult AllocateRawForceAlignmentForTesting(
        int size_in_bytes, AllocationAlignment alignment, AllocationOrigin);
...
private:
    ...
    V8_WARN_UNUSED_RESULT V8_INLINE AllocationResult AllocateFastAligned(
    ...
    V8_WARN_UNUSED_RESULT AllocationResult AllocateRawSlowAligned(
    ...
    {
        return supports_extending_lab_;
    }
