...
public:
    ...
    using PretenuringFeedbackMap = std::unordered_map<Tagged<AllocationSite>, size_t, Object::Hasher>;
    ...
    template <FindMementoMode mode> static inline Tagged<AllocationMemento> FindAllocationMemento(Heap* heap, Tagged<Map> map, Tagged<HeapObject> object);
    template <FindMementoMode mode>
    static inline Tagged<AllocationMemento> FindAllocationMemento(Heap* heap, Tagged<Map> map, Tagged<HeapObject> object, int object_size);
