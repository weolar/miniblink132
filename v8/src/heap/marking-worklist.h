...
public:
    ...
    {
        return !context_worklists_.empty();
    }
...
public:
    ...
    explicit Local(MarkingWorklists* global, std::unique_ptr<CppMarkingState> cpp_marking_state = kNoCppMarkingState);
...
private:
    inline void SwitchToContextImpl(Address context, MarkingWorklist::Local* worklist);
