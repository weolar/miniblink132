...
private:
    V8_EXPORT static bool InYoungGenerationForStickyMarkbits(const MemoryChunk* chunk, Tagged<HeapObject> object);

    V8_EXPORT static void CheckYoungGenerationConsistency(const MemoryChunk* chunk);
};
