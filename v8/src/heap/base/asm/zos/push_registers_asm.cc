...
extern "C" void PushAllRegistersAndIterateStack(const Stack* sp, StackVisitor* sv, IterateStackCallback callback)
{
    __asm volatile(" lg 1,%0 \n" // Set up first parameter (sp)
                   ...
                   : "r0", "r1", "r2", "r3", "r5", "r6", "r7", "r9", "r10", "r11", "r12", "r13", "r14", "r15");
}
} // namespace base
} // namespace heap
