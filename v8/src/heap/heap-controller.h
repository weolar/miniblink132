...
template <typename Trait> class V8_EXPORT_PRIVATE MemoryController : public AllStatic {
public:
    ...
    static double GrowingFactor(Heap* heap, size_t max_heap_size, double gc_speed, double mutator_speed, Heap::HeapGrowingMode growing_mode);

    static size_t BoundAllocationLimit(
...
private:
    ...
    static double DynamicGrowingFactor(double gc_speed, double mutator_speed, double max_factor);
