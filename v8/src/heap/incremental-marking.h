...
public:
    ...
    public:
        ...
        PauseBlackAllocationScope& operator=(const PauseBlackAllocationScope&) = delete;
    ...
    bool IsCompacting()
    {
        return IsMajorMarking() && is_compacting_;
    }
    ...
    {
        return current_trace_id_.value();
    }
