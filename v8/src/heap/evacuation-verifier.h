...
class EvacuationVerifier final : public ObjectVisitorWithCageBases, public RootVisitor {
public:
...
private:
    ...
    template <typename TSlot> void VerifyPointersImpl(TSlot start, TSlot end);
