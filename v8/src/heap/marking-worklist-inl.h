...
template <typename Callback> void MarkingWorklists::Update(Callback callback)
{
...
void MarkingWorklists::Local::SwitchToContextImpl(Address context, MarkingWorklist::Local* worklist)
{
    active_ = worklist;
