...
#define TRACE_EVENT_API_GET_CATEGORY_GROUP_ENABLED platform->GetTracingController()->GetCategoryGroupEnabled
...
#define INTERNAL_TRACE_EVENT_ADD(phase, category_group, name, flags, ...)                                                                                      \
    ...
    do {                                                                                                                                                       \
        ...
        if (INTERNAL_TRACE_EVENT_CATEGORY_GROUP_ENABLED_FOR_RECORDING_MODE()) {                                                                                \
            cppgc::internal::AddTraceEvent(phase, INTERNAL_TRACE_EVENT_UID(category_group_enabled), name, nullptr /* scope */, 0 /* id */, 0 /* bind_id */,    \
                flags, platform, ##__VA_ARGS__);                                                                                                               \
        }                                                                                                                                                      \
    } while (false)
...
static V8_INLINE uint64_t AddTraceEventImpl(char phase, const uint8_t* category_group_enabled, const char* name, const char* scope, uint64_t id,
    uint64_t bind_id, int32_t num_args, const char** arg_names, const uint8_t* arg_types, const uint64_t* arg_values, unsigned int flags, Platform* platform)
{
    ...
    unsigned int flags, Platform* platform)
{
    return TRACE_EVENT_API_ADD_TRACE_EVENT(
        phase, category_group_enabled, name, scope, id, bind_id, 0 /* num_args */, nullptr, nullptr, nullptr, flags, platform);
}

template <class ARG1_TYPE>
static V8_INLINE uint64_t AddTraceEvent(char phase, const uint8_t* category_group_enabled, const char* name, const char* scope, uint64_t id, uint64_t bind_id,
    unsigned int flags, Platform* platform, const char* arg1_name, ARG1_TYPE&& arg1_val)
{
    ...
    return TRACE_EVENT_API_ADD_TRACE_EVENT(
        phase, category_group_enabled, name, scope, id, bind_id, num_args, &arg1_name, &arg_type, &arg_value, flags, platform);
}

template <class ARG1_TYPE, class ARG2_TYPE>
static V8_INLINE uint64_t AddTraceEvent(char phase, const uint8_t* category_group_enabled, const char* name, const char* scope, uint64_t id, uint64_t bind_id,
    unsigned int flags, Platform* platform, const char* arg1_name, ARG1_TYPE&& arg1_val, const char* arg2_name, ARG2_TYPE&& arg2_val)
{
    ...
    return TRACE_EVENT_API_ADD_TRACE_EVENT(
        phase, category_group_enabled, name, scope, id, bind_id, num_args, arg_names, arg_types, arg_values, flags, platform);
}
