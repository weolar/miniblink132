...
public:
    ...
    HeapBase(std::shared_ptr<cppgc::Platform> platform, const std::vector<std::unique_ptr<CustomSpaceBase>>& custom_spaces, StackSupport stack_support,
...
#if defined(CPPGC_YOUNG_GENERATION)
    OldToNewRememberedSet& remembered_set()
    {
    ...
    {
        return marking_support_;
    }
    SweepingType sweeping_support() const
    {
        return sweeping_support_;
    }
    ...
    {
        return generational_gc_supported() ? StickyBits::kEnabled : StickyBits::kDisabled;
    }
...
protected:
    ...
    EmbedderStackState stack_state_of_prev_gc_ = EmbedderStackState::kNoHeapPointers;
    ...
    HeapObjectNameForUnnamedObject name_for_unnamed_object_ = HeapObjectNameForUnnamedObject::kUseHiddenName;
