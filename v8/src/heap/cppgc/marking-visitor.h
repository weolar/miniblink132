...
class V8_EXPORT_PRIVATE ConcurrentMarkingVisitor final : public MarkingVisitorBase {
public:
...
class ConservativeMarkingVisitor : public ConservativeTracingVisitor, public heap::base::StackVisitor {
public:
