...
BaseSpace::BaseSpace(RawHeap* heap, size_t index, PageType type, bool is_compactable)
    : heap_(heap)
    , index_(index)
    , type_(type)
...
NormalPageSpace::NormalPageSpace(RawHeap* heap, size_t index, bool is_compactable)
