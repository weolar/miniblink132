...
public:
    ...
    template <typename TSlot> void Write(Tagged<HeapObject> host, TSlot slot, Tagged<HeapObject> value);
...
private:
    ...
    template <typename TSlot> inline void MarkRange(Tagged<HeapObject> value, TSlot start, TSlot end);
