...
template <typename ConcreteState, AccessMode access_mode> class MarkingStateBase {
public:
...
class MarkingState final : public MarkingStateBase<MarkingState, AccessMode::ATOMIC> {
public:
...
class NonAtomicMarkingState final : public MarkingStateBase<NonAtomicMarkingState, AccessMode::NON_ATOMIC> {
public:
