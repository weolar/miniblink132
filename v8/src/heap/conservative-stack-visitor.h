...
class V8_EXPORT_PRIVATE ConservativeStackVisitor : public ::heap::base::StackVisitor {
public:
    ...
    static ConservativeStackVisitor ForTesting(Isolate* isolate, GarbageCollector collector)
    {
        return ConservativeStackVisitor(isolate, nullptr, collector);
    }

private:
    ConservativeStackVisitor(Isolate* isolate, RootVisitor* delegate, GarbageCollector collector);
