...
class ObjectVisitorForwarder final : public HeapVisitor<ObjectVisitorForwarder> {
public:
    ...
    explicit ObjectVisitorForwarder(LocalIsolate* isolate, ObjectVisitor* visitor)
        : HeapVisitor(PtrComprCageBase(isolate->cage_base()), PtrComprCageBase(isolate->code_cage_base()))
        , visitor_(visitor)
    {
    }
