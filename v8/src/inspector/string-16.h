...
public:
    ...
    V8_EXPORT static String16 fromUTF16LE(const UChar* stringStart, size_t length);
    V8_EXPORT static String16 fromUTF16LE(const uint16_t* stringStart, size_t length);
    ...
    template <typename... T> static String16 concat(T... args);
...
public:
    ...
    template <typename T, typename... R> void appendAll(T first, R... rest)
    {
        append(first);
        appendAll(rest...);
    }
...
template <typename... T> String16 String16::concat(T... args)
{
