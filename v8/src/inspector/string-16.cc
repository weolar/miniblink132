...
int64_t charactersToInteger(const uint16_t* characters, size_t length, bool* ok = nullptr)
{
...
{
    std::unique_ptr<char[]> str(v8::internal::DoubleToPrecisionCString(number, precision));
