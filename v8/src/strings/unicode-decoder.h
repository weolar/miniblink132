...
template <class Decoder> class Utf8DecoderBase {
public:
    ...
    {
        return encoding_ <= Encoding::kLatin1;
    }
    ...
    template <typename Char> void Decode(Char* out, base::Vector<const uint8_t> data);
...
class V8_EXPORT_PRIVATE Utf8Decoder final : public Utf8DecoderBase<Utf8Decoder> {
public:
