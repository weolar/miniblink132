...
void ProcessorImpl::DivideSingle(RWDigits Q, digit_t* remainder, Digits A, digit_t b)
{
    DCHECK(b != 0);
    DCHECK(A.len() > 0);
    *remainder = 0;
...
void ProcessorImpl::DivideSchoolbook(RWDigits Q, RWDigits R, Digits A, Digits B)
{
