...
#define REGEXP_ERROR_MESSAGES(T)                                                                                                                               \
    ...
    T(NegatedCharacterClassWithStrings, "Negated character class may contain strings")
...
{
    return error == RegExpError::kStackOverflow || error == RegExpError::kAnalysisStackOverflow;
}
