...
public:
    ...
    static V8_WARN_UNUSED_RESULT MaybeHandle<JSAny> RegExpExec(Isolate* isolate, Handle<JSReceiver> regexp, Handle<String> string, Handle<Object> exec);
    ...
    static uint64_t AdvanceStringIndex(DirectHandle<String> string, uint64_t index, bool unicode);
    static V8_WARN_UNUSED_RESULT MaybeHandle<Object> SetAdvancedStringIndex(
        Isolate* isolate, Handle<JSReceiver> regexp, DirectHandle<String> string, bool unicode);
};
