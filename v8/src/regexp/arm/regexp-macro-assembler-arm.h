...
class V8_EXPORT_PRIVATE RegExpMacroAssemblerARM : public NativeRegExpMacroAssembler {
public:
...
private:
    ...
    void CallCheckStackGuardState(Operand extra_space_for_variables = Operand::Zero());
