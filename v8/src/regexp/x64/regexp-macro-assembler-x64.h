...
class V8_EXPORT_PRIVATE RegExpMacroAssemblerX64 : public NativeRegExpMacroAssembler {
public:
...
private:
    ...
    static constexpr int kInputStringOffset = kFrameTypeOffset - kSystemPointerSize;
    static constexpr int kStartIndexOffset = kInputStringOffset - kSystemPointerSize;
    static constexpr int kInputStartOffset = kStartIndexOffset - kSystemPointerSize;
    static constexpr int kInputEndOffset = kInputStartOffset - kSystemPointerSize;
    static constexpr int kRegisterOutputOffset = kInputEndOffset - kSystemPointerSize;
...
#else
    static constexpr int kBackupRbxOffset = kNumOutputRegistersOffset - kSystemPointerSize;
    ...
    static constexpr int kSuccessfulCapturesOffset = kLastCalleeSaveRegister - kSystemPointerSize;
