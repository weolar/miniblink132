...
class V8_EXPORT_PRIVATE RegExpMacroAssemblerIA32 : public NativeRegExpMacroAssembler {
public:
...
private:
    ...
    void CallCheckStackGuardState(Register scratch, Immediate extra_space = Immediate(0));
