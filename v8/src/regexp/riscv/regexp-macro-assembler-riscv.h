...
class V8_EXPORT_PRIVATE RegExpMacroAssemblerRISCV : public NativeRegExpMacroAssembler {
public:
...
private:
    ...
    static_assert(kFrameTypeOffset
        == (V8_EMBEDDED_CONSTANT_POOL_BOOL ? kSystemPointerSize + CommonFrameConstants::kContextOrFrameTypeOffset
    ...
    inline void SafeCall(Label* to, Condition cond, Register rs, const Operand& rt);
