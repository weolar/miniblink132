...
#define FOR_EACH_INTRINSIC_COMPILER(F, I) FOR_EACH_INTRINSIC_COMPILER_GENERIC(F, I)
#else
...
#define FOR_EACH_INTRINSIC_TEMPORAL(F, I) F(IsInvalidTemporalCalendarField, 2, 1)
...
#define FOR_EACH_INTRINSIC_RETURN_OBJECT(F) FOR_EACH_INTRINSIC_RETURN_OBJECT_IMPL(F, F)

#define FOR_EACH_INTRINSIC_RETURN_PAIR(F) FOR_EACH_INTRINSIC_RETURN_PAIR_IMPL(F, F)
...
#define F(name, nargs, ressize) Address Runtime_##name(int args_length, Address* args_object, Isolate* isolate);
...
#undef COUNT
    ...
    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static Maybe<bool> DeleteObjectProperty(
        Isolate* isolate, Handle<JSReceiver> receiver, Handle<Object> key, LanguageMode language_mode);
    ...
    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static MaybeHandle<Object> SetObjectProperty(Isolate* isolate, Handle<JSAny> object, Handle<Object> key,
        Handle<Object> value, MaybeHandle<JSAny> receiver, StoreOrigin store_origin, Maybe<ShouldThrow> should_throw = Nothing<ShouldThrow>());
    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static MaybeHandle<Object> SetObjectProperty(Isolate* isolate, Handle<JSAny> object, Handle<Object> key,
        Handle<Object> value, StoreOrigin store_origin, Maybe<ShouldThrow> should_throw = Nothing<ShouldThrow>());
    ...
    // on object.
    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static MaybeHandle<Object> DefineObjectOwnProperty(
        Isolate* isolate, Handle<JSAny> object, Handle<Object> key, Handle<Object> value, StoreOrigin store_origin);

    // When "receiver" is not passed, it defaults to "lookup_start_object".
    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static MaybeHandle<Object> GetObjectProperty(
        Isolate* isolate, Handle<JSAny> lookup_start_object, Handle<Object> key, Handle<JSAny> receiver = Handle<JSAny>(), bool* is_found = nullptr);
    ...
    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static MaybeHandle<Object> GetPrivateMember(Isolate* isolate, Handle<JSReceiver> receiver, Handle<String> desc);
    ...
    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static MaybeHandle<Object> SetPrivateMember(
        Isolate* isolate, Handle<JSReceiver> receiver, Handle<String> desc, Handle<Object> value);

    V8_WARN_UNUSED_RESULT static MaybeHandle<Object> HasProperty(Isolate* isolate, Handle<Object> object, Handle<Object> key);

    V8_EXPORT_PRIVATE V8_WARN_UNUSED_RESULT static MaybeHandle<JSArray> GetInternalProperties(Isolate* isolate, Handle<Object>);

    V8_WARN_UNUSED_RESULT static MaybeHandle<Object> ThrowIteratorError(Isolate* isolate, Handle<Object> object);
};
