...
public:
    ...
    {
        return new (frame_size) FrameDescription(frame_size, parameter_count, isolate);
    }
    ...
    Address GetFramePointerAddress()
    {
        ...
        int fp_offset = GetLastArgumentSlotOffset(pad_arguments_bottom_frame) - StandardFrameConstants::kCallerSPOffset;
    ...
    {
        base::WriteUnalignedValue(reinterpret_cast<char*>(GetFrameSlotPointer(offset)), value);
    }
    ...
    {
        return offsetof(FrameDescription, pc_);
    }
...
private:
    ...
    intptr_t* GetFrameSlotPointer(unsigned offset)
    {
        ...
        return reinterpret_cast<intptr_t*>(reinterpret_cast<Address>(this) + frame_content_offset() + offset);
    }
};
