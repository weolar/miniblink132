...
// guarantees:
#define ASSERT_OFFSET(BuiltinName) static_assert(IsolateData::builtin_tier0_entry_table_offset() + Builtins::ToInt(BuiltinName) * kSystemPointerSize <= 0x1000)
...
{
    double double_val = base::ReadUnalignedValue<Float64>(reinterpret_cast<Address>(simd128_registers_ + n)).get_scalar();
