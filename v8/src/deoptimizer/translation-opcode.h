...
#define PLUS_ONE(...) +1
static constexpr int kNumTranslationOpcodes = 0 TRANSLATION_OPCODE_LIST(PLUS_ONE);
static constexpr int kNumTranslationJsFrameOpcodes = 0 TRANSLATION_JS_FRAME_OPCODE_LIST(PLUS_ONE);
static constexpr int kNumTranslationFrameOpcodes = kNumTranslationJsFrameOpcodes TRANSLATION_FRAME_OPCODE_LIST(PLUS_ONE);
#undef PLUS_ONE
...
#define CASE(name, operand_count) static_assert(operand_count <= kMaxTranslationOperandCount);
TRANSLATION_OPCODE_LIST(CASE)
#undef CASE

inline bool TranslationOpcodeIsBegin(TranslationOpcode o)
{
    return o == TranslationOpcode::BEGIN_WITH_FEEDBACK || o == TranslationOpcode::BEGIN_WITHOUT_FEEDBACK;
}

inline bool IsTranslationFrameOpcode(TranslationOpcode o)
{
    static_assert(0 == static_cast<int>(TranslationOpcode::INTERPRETED_FRAME_WITH_RETURN));
...
{
    static_assert(kNumTranslationJsFrameOpcodes == static_cast<int>(TranslationOpcode::CONSTRUCT_CREATE_STUB_FRAME));
...
{
    return o == TranslationOpcode::INTERPRETED_FRAME_WITH_RETURN || o == TranslationOpcode::INTERPRETED_FRAME_WITHOUT_RETURN;
}
