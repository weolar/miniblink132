...
template <typename T, internal::ExternalPointerTag tag> inline T ToCData(i::Isolate* isolate, v8::internal::Tagged<v8::internal::Object> obj)
{
    static_assert(sizeof(T) == sizeof(v8::internal::Address));
    if (obj == v8::internal::Smi::zero())
        return nullptr;
    return reinterpret_cast<T>(v8::internal::Cast<v8::internal::Foreign>(obj)->foreign_address<tag>(isolate));
}

template <internal::ExternalPointerTag tag> inline v8::internal::Address ToCData(i::Isolate* isolate, v8::internal::Tagged<v8::internal::Object> obj)
{
    if (obj == v8::internal::Smi::zero())
        return v8::internal::kNullAddress;
    return v8::internal::Cast<v8::internal::Foreign>(obj)->foreign_address<tag>(isolate);
}

template <internal::ExternalPointerTag tag, typename T>
inline v8::internal::Handle<i::UnionOf<i::Smi, i::Foreign>> FromCData(v8::internal::Isolate* isolate, T obj)
{
    static_assert(sizeof(T) == sizeof(v8::internal::Address));
    if (obj == nullptr)
        return handle(v8::internal::Smi::zero(), isolate);
    return isolate->factory()->NewForeign<tag>(reinterpret_cast<v8::internal::Address>(obj));
}

template <internal::ExternalPointerTag tag>
inline v8::internal::Handle<i::UnionOf<i::Smi, i::Foreign>> FromCData(v8::internal::Isolate* isolate, v8::internal::Address obj)
{
...
template <class From, class To> inline Local<To> Utils::Convert(v8::internal::DirectHandle<From> obj)
{
...
#define MAKE_TO_LOCAL(Name)                                                                                                                                    \
    template <template <typename> typename HandleType, typename T, typename> inline auto Utils::Name(HandleType<T> obj)                                        \
    {                                                                                                                                                          \
...
#define MAKE_TO_LOCAL_PRIVATE(Name, From, To)                                                                                                                  \
    inline Local<v8::To> Utils::Name##_helper(v8::internal::DirectHandle<v8::internal::From> obj)                                                              \
    {                                                                                                                                                          \
...
#define MAKE_TO_LOCAL_TYPED_ARRAY(Type, typeName, TYPE, ctype)                                                                                                 \
    Local<v8::Type##Array> Utils::ToLocal##Type##Array(v8::internal::DirectHandle<v8::internal::JSTypedArray> obj)                                             \
    {                                                                                                                                                          \
...
#define MAKE_OPEN_HANDLE(From, To)                                                                                                                             \
    ...
    {                                                                                                                                                          \
        ...
        DCHECK(                                                                                                                                                \
            v8::internal::ValueHelper::IsEmpty(that) || Is##To(v8::internal::Tagged<v8::internal::Object>(v8::internal::ValueHelper::ValueAsAddress(that))));  \
        if (v8::internal::ValueHelper::IsEmpty(that)) {                                                                                                        \
            return v8::internal::Handle<v8::internal::To>::null();                                                                                             \
        }                                                                                                                                                      \
        return v8::internal::Handle<v8::internal::To>(v8::HandleScope::CreateHandleForCurrentIsolate(v8::internal::ValueHelper::ValueAsAddress(that)));        \
    }                                                                                                                                                          \
                                                                                                                                                               \
    v8::internal::DirectHandle<v8::internal::To> Utils::OpenDirectHandle(const v8::From* that, bool allow_empty_handle)                                        \
    {                                                                                                                                                          \
        DCHECK(allow_empty_handle || !v8::internal::ValueHelper::IsEmpty(that));                                                                               \
        DCHECK(                                                                                                                                                \
            v8::internal::ValueHelper::IsEmpty(that) || Is##To(v8::internal::Tagged<v8::internal::Object>(v8::internal::ValueHelper::ValueAsAddress(that))));  \
        return v8::internal::DirectHandle<v8::internal::To>(v8::internal::ValueHelper::ValueAsAddress(that));                                                  \
    }                                                                                                                                                          \
                                                                                                                                                               \
    v8::internal::IndirectHandle<v8::internal::To> Utils::OpenIndirectHandle(const v8::From* that, bool allow_empty_handle)                                    \
    {                                                                                                                                                          \
...
#define MAKE_OPEN_HANDLE(From, To)                                                                                                                             \
    ...
    {                                                                                                                                                          \
        ...
        DCHECK(                                                                                                                                                \
            v8::internal::ValueHelper::IsEmpty(that) || Is##To(v8::internal::Tagged<v8::internal::Object>(v8::internal::ValueHelper::ValueAsAddress(that))));  \
        return v8::internal::Handle<v8::internal::To>(reinterpret_cast<v8::internal::Address*>(const_cast<v8::From*>(that)));                                  \
    }                                                                                                                                                          \
                                                                                                                                                               \
    v8::internal::DirectHandle<v8::internal::To> Utils::OpenDirectHandle(const v8::From* that, bool allow_empty_handle)                                        \
    {                                                                                                                                                          \
...
template <bool do_callback> class V8_NODISCARD CallDepthScope {
public:
    ...
    ~CallDepthScope()
    {
        i::MicrotaskQueue* microtask_queue = i::Cast<i::NativeContext>(isolate_->context())->microtask_queue(isolate_);
        ...
        if (isolate_->thread_local_top()->CallDepthIsZero()
            && (isolate_->thread_local_top()->try_catch_handler_ == nullptr || !isolate_->is_execution_terminating())) {
...
private:
    ...
    bool CheckKeptObjectsClearedAfterMicrotaskCheckpoint(i::MicrotaskQueue* microtask_queue)
    {
        bool did_perform_microtask_checkpoint = isolate_->thread_local_top()->CallDepthIsZero() && do_callback && microtask_queue
            && microtask_queue->microtasks_policy() == MicrotasksPolicy::kAuto && !isolate_->is_execution_terminating();
        return !did_perform_microtask_checkpoint || IsUndefined(isolate_->heap()->weak_refs_keep_during_job(), isolate_);
    }
#endif
...
public:
   ...
   */
    template <class T> V8_INLINE Local<T> Escape(Local<T> value)
    {
#ifdef V8_ENABLE_DIRECT_HANDLE
        return value;
#else
    ...
    template <class T> V8_INLINE MaybeLocal<T> EscapeMaybe(MaybeLocal<T> maybe_value)
    {
        Local<T> value;
...
template <typename T> void CopySmiElementsToTypedBuffer(T* dst, uint32_t length, i::Tagged<i::FixedArray> elements)
{
    for (uint32_t i = 0; i < length; ++i) {
        double value = i::Object::NumberValue(i::Cast<i::Smi>(elements->get(static_cast<int>(i))));
...
template <typename T> void CopyDoubleElementsToTypedBuffer(T* dst, uint32_t length, i::Tagged<i::FixedDoubleArray> elements)
{
    for (uint32_t i = 0; i < length; ++i) {
...
template <CTypeInfo::Identifier type_info_id, typename T> bool CopyAndConvertArrayToCppBuffer(Local<Array> src, T* dst, uint32_t max_length)
{
    static_assert(std::is_same<T, typename i::CTypeInfoTraits<CTypeInfo(type_info_id).GetType()>::ctype>::value,
    ...
    case i::PACKED_SMI_ELEMENTS:
        CopySmiElementsToTypedBuffer(dst, length, i::Cast<i::FixedArray>(elements));
        return true;
    case i::PACKED_DOUBLE_ELEMENTS:
        CopyDoubleElementsToTypedBuffer(dst, length, i::Cast<i::FixedDoubleArray>(elements));
        return true;
    default:
        return false;
    }
...
template <const CTypeInfo* type_info, typename T> inline bool V8_EXPORT TryCopyAndConvertArrayToCppBuffer(Local<Array> src, T* dst, uint32_t max_length)
{
    return CopyAndConvertArrayToCppBuffer<type_info->GetId(), T>(src, dst, max_length);
}

template <CTypeInfo::Identifier type_info_id, typename T>
inline bool V8_EXPORT TryToCopyAndConvertArrayToCppBuffer(Local<Array> src, T* dst, uint32_t max_length)
{
