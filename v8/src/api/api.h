...
inline v8::internal::Address ToCData(v8::internal::Isolate* isolate, v8::internal::Tagged<v8::internal::Object> obj);

template <internal::ExternalPointerTag tag, typename T>
inline v8::internal::Handle<v8::internal::UnionOf<v8::internal::Smi, v8::internal::Foreign>> FromCData(v8::internal::Isolate* isolate, T obj);

template <internal::ExternalPointerTag tag>
inline v8::internal::Handle<v8::internal::UnionOf<v8::internal::Smi, v8::internal::Foreign>> FromCData(
...
#define DECLARE_TO_LOCAL(Name)                                                                                                                                 \
    template <template <typename> typename HandleType, typename T,                                                                                             \
        typename = std::enable_if_t<std::is_convertible_v<HandleType<T>, v8::internal::DirectHandle<T>>>>                                                      \
...
#define DECLARE_TO_LOCAL_TYPED_ARRAY(Type, typeName, TYPE, ctype)                                                                                              \
    static inline Local<v8::Type##Array> ToLocal##Type##Array(v8::internal::DirectHandle<v8::internal::JSTypedArray> obj);

    TYPED_ARRAYS(DECLARE_TO_LOCAL_TYPED_ARRAY)

#define DECLARE_OPEN_HANDLE(From, To)                                                                                                                          \
    static inline v8::internal::Handle<v8::internal::To> OpenHandle(const From* that, bool allow_empty_handle = false);                                        \
    static inline v8::internal::DirectHandle<v8::internal::To> OpenDirectHandle(const From* that, bool allow_empty_handle = false);                            \
    static inline v8::internal::IndirectHandle<v8::internal::To> OpenIndirectHandle(const From* that, bool allow_empty_handle = false);
...
#undef DECLARE_TO_LOCAL
    ...
    template <class From, class To> static inline Local<To> Convert(v8::internal::DirectHandle<From> obj);

    template <class T> static inline v8::internal::Handle<v8::internal::Object> OpenPersistent(const v8::PersistentBase<T>& persistent)
    {
        return v8::internal::Handle<v8::internal::Object>(persistent.slot());
    }

    template <class T> static inline v8::internal::Handle<v8::internal::Object> OpenPersistent(v8::Persistent<T>* persistent)
    {
        return OpenPersistent(*persistent);
    }

    template <class From, class To> static inline v8::internal::Handle<To> OpenHandle(v8::Local<From> handle)
    {
        return OpenHandle(*handle);
    }

    template <class From, class To> static inline v8::internal::DirectHandle<To> OpenDirectHandle(v8::Local<From> handle)
    {
        return OpenDirectHandle(*handle);
    }

private:
    V8_NOINLINE V8_PRESERVE_MOST static void ReportApiFailure(const char* location, const char* message);

#define DECLARE_TO_LOCAL_PRIVATE(Name, From, To) static inline Local<v8::To> Name##_helper(v8::internal::DirectHandle<v8::internal::From> obj);

    TO_LOCAL_LIST(DECLARE_TO_LOCAL_PRIVATE)
#undef DECLARE_TO_LOCAL_PRIVATE
};

template <class T> inline T* ToApi(v8::internal::Handle<v8::internal::Object> obj)
{
    return reinterpret_cast<T*>(obj.location());
}

template <class T> inline v8::Local<T> ToApiHandle(v8::internal::DirectHandle<v8::internal::Object> obj)
{
    return Utils::Convert<v8::internal::Object, T>(obj);
}

template <class T> inline bool ToLocal(v8::internal::MaybeHandle<v8::internal::Object> maybe, Local<T>* local)
{
...
public:
    ...
    V8_EXPORT_PRIVATE static char* Iterate(v8::internal::RootVisitor* v, char* data);
    ...
    inline size_t EnteredContextCount() const
    {
        return entered_contexts_.size();
    }
    ...
    inline DetachableVector<Address*>* blocks()
    {
        return &blocks_;
    }
...
bool HandleScopeImplementer::LastEnteredContextWas(Tagged<NativeContext> context)
{
...
{
    internal::Address* block = (spare_ != nullptr) ? spare_ : NewArray<internal::Address>(kHandleBlockSize);
    spare_ = nullptr;
    return block;
}
...
void HandleScopeImplementer::DeleteExtensions(internal::Address* prev_limit)
{
    while (!blocks_.empty()) {
        ...
        if (reinterpret_cast<Address>(block_start) < reinterpret_cast<Address>(prev_limit)
            && reinterpret_cast<Address>(prev_limit) <= reinterpret_cast<Address>(block_limit)) {
...
template <typename T> EXPORT_TEMPLATE_DECLARE(V8_EXPORT_PRIVATE) T ConvertDouble(double d);

template <typename T> EXPORT_TEMPLATE_DECLARE(V8_EXPORT_PRIVATE) bool ValidateCallbackInfo(const FunctionCallbackInfo<T>& info);

template <typename T> EXPORT_TEMPLATE_DECLARE(V8_EXPORT_PRIVATE) bool ValidateCallbackInfo(const PropertyCallbackInfo<T>& info);
...
public:
    ...
    ExternalMemoryAccounterBase& operator=(ExternalMemoryAccounterBase&&) V8_NOEXCEPT;
    ExternalMemoryAccounterBase(const ExternalMemoryAccounterBase&) = delete;
    ExternalMemoryAccounterBase& operator=(const ExternalMemoryAccounterBase&) = delete;
