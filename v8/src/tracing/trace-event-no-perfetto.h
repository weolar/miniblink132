...
#define TRACE_COUNTER_WITH_FLAG1(category_group, name, flag, value)                                                                                            \
    INTERNAL_TRACE_EVENT_ADD(TRACE_EVENT_PHASE_COUNTER, category_group, name, flag, "value", static_cast<int>(value))
...
#define TRACE_EVENT_NESTABLE_ASYNC_END_WITH_TIMESTAMP2(category_group, name, id, timestamp, arg1_name, arg1_val, arg2_name, arg2_val)                          \
    INTERNAL_TRACE_EVENT_ADD_WITH_ID_TID_AND_TIMESTAMP(TRACE_EVENT_PHASE_NESTABLE_ASYNC_END, category_group, name, id, TRACE_EVENT_API_CURRENT_THREAD_ID,      \
        timestamp, TRACE_EVENT_FLAG_NONE, arg1_name, arg1_val, arg2_name, arg2_val)
...
#define TRACE_EVENT_COPY_NESTABLE_ASYNC_BEGIN1(category_group, name, id, arg1_name, arg1_val)                                                                  \
    INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_NESTABLE_ASYNC_BEGIN, category_group, name, id, TRACE_EVENT_FLAG_COPY, arg1_name, arg1_val)
#define TRACE_EVENT_COPY_NESTABLE_ASYNC_BEGIN2(category_group, name, id, arg1_name, arg1_val, arg2_name, arg2_val)                                             \
    INTERNAL_TRACE_EVENT_ADD_WITH_ID(                                                                                                                          \
        TRACE_EVENT_PHASE_NESTABLE_ASYNC_BEGIN, category_group, name, id, TRACE_EVENT_FLAG_COPY, arg1_name, arg1_val, arg2_name, arg2_val)
...
#define TRACE_EVENT_COPY_NESTABLE_ASYNC_END1(category_group, name, id, arg1_name, arg1_val)                                                                    \
    INTERNAL_TRACE_EVENT_ADD_WITH_ID(TRACE_EVENT_PHASE_NESTABLE_ASYNC_END, category_group, name, id, TRACE_EVENT_FLAG_COPY, arg1_name, arg1_val)
