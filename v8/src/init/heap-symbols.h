...
#define EXTRA_IMPORTANT_INTERNALIZED_STRING_LIST_GENERATOR(V, _) V(_, empty_string, "")
...
#define PUBLIC_SYMBOL_FOR_PROTECTOR_LIST_GENERATOR(V, _) V(_, to_primitive_symbol, Symbol.toPrimitive)

#define WELL_KNOWN_SYMBOL_FOR_PROTECTOR_LIST_GENERATOR(V, _) V(_, is_concat_spreadable_symbol, Symbol.isConcatSpreadable)
