...
#define MESSAGE_TEMPLATES(T)                                                                                                                                   \
    ...
    T(ArrayBufferDetachKeyDoesntMatch, "Provided key doesn't match [[ArrayBufferDetachKey]]")                                                                  \
    T(ArrayBufferTooShort, "Derived ArrayBuffer constructor created a buffer which was too small")                                                             \
    T(ArrayBufferSpeciesThis, "ArrayBuffer subclass returned this from species constructor")                                                                   \
    ...
    T(AtomicsMutexNotOwnedByCurrentThread, "Atomics.Mutex is not owned by the current agent")                                                                  \
    T(AtomicsOperationNotAllowed, "% cannot be called in this context")                                                                                        \
    T(BadRoundingType, "RoundingType is not fractionDigits")                                                                                                   \
    T(BadSortComparisonFunction, "The comparison function must be either a function or undefined: %")                                                          \
    T(BigIntFromNumber,                                                                                                                                        \
        "The number % cannot be converted to a BigInt because it is not an "                                                                                   \
        "integer")                                                                                                                                             \
    T(BigIntFromObject, "Cannot convert % to a BigInt")                                                                                                        \
    T(BigIntMixedTypes, "Cannot mix BigInt and other types, use explicit conversions")                                                                         \
    ...
    T(CallSiteMethodUnsupportedInShadowRealm, "CallSite method % is unsupported inside ShadowRealms")                                                          \
    ...
    T(CannotFreezeArrayBufferView, "Cannot freeze array buffer views with elements")                                                                           \
    ...
    T(ConstructorNonCallable, "Class constructor % cannot be invoked without 'new'")                                                                           \
    T(AnonymousConstructorNonCallable, "Class constructors cannot be invoked without 'new'")                                                                   \
    ...
    T(DataViewNotArrayBuffer, "First argument to DataView constructor must be an ArrayBuffer")                                                                 \
    T(DateType, "this is not a Date object.")                                                                                                                  \
    T(DebuggerFrame, "Debugger: Invalid frame index.")                                                                                                         \
    T(DebuggerType, "Debugger: Parameters have wrong types.")                                                                                                  \
    T(DeclarationMissingInitializer, "Missing initializer in % declaration")                                                                                   \
    T(DefineDisallowed, "Cannot define property %, object is not extensible")                                                                                  \
    T(DefineDisallowedFixedLayout, "Cannot define property %, object has fixed layout")                                                                        \
    T(DetachedOperation, "Cannot perform % on a detached ArrayBuffer")                                                                                         \
    T(DoNotUse, "Do not use %; %")                                                                                                                             \
    T(DuplicateTemplateProperty, "Object template has duplicate property '%'")                                                                                 \
    T(ExtendsValueNotConstructor, "Class extends value % is not a constructor or null")                                                                        \
    T(FirstArgumentNotRegExp, "First argument to % must not be a regular expression")                                                                          \
    T(FunctionBind, "Bind must be called on a function")                                                                                                       \
    T(GeneratorRunning, "Generator is already running")                                                                                                        \
    T(IllegalInvocation, "Illegal invocation")                                                                                                                 \
    T(ImmutablePrototypeSet, "Immutable prototype object '%' cannot have their prototype set")                                                                 \
    ...
    T(InstanceofNonobjectProto, "Function has non-object prototype '%' in instanceof check")                                                                   \
    ...
    T(InvalidRegExpExecResult, "RegExp exec method returned something other than an Object or null")                                                           \
    ...
    T(IteratorReduceNoInitial, "Reduce of a done iterator with no initial value")                                                                              \
    T(IteratorResultNotAnObject, "Iterator result % is not an object")                                                                                         \
    T(SpreadIteratorSymbolNonCallable, "Spread syntax requires ...iterable[Symbol.iterator] to be a function")                                                 \
    ...
    T(LocaleNotEmpty, "First argument to Intl.Locale constructor can't be empty or missing")                                                                   \
    ...
    T(NonCallableInInstanceOfCheck, "Right-hand side of 'instanceof' is not callable")                                                                         \
    T(NonCoercible, "Cannot destructure '%' as it is %.")                                                                                                      \
    T(NonCoercibleWithProperty, "Cannot destructure property '%' of '%' as it is %.")                                                                          \
    T(NonExtensibleProto, "% is not extensible")                                                                                                               \
    T(NonObjectAttributesOption, "The 'with' option must be an object")                                                                                        \
    T(NonObjectInInstanceOfCheck, "Right-hand side of 'instanceof' is not an object")                                                                          \
    T(NonObjectPrivateNameAccess, "Cannot access private name % from %")                                                                                       \
    T(NonObjectPropertyLoad, "Cannot read properties of %")                                                                                                    \
    T(NonObjectPropertyLoadWithProperty, "Cannot read properties of % (reading '%')")                                                                          \
    T(NonObjectPropertyStore, "Cannot set properties of %")                                                                                                    \
    T(NonObjectPropertyStoreWithProperty, "Cannot set properties of % (setting '%')")                                                                          \
    T(NonObjectImportArgument, "The second argument to import() must be an object")                                                                            \
    ...
    T(PromiseNewTargetUndefined, "Promise constructor cannot be invoked without 'new'")                                                                        \
    T(NotConstructor, "% is not a constructor")                                                                                                                \
    T(NotDateObject, "this is not a Date object.")                                                                                                             \
    T(NotGeneric, "% requires that 'this' be a %")                                                                                                             \
    T(NotCallable, "% is not a function")                                                                                                                      \
    T(NotCallableOrIterable, "% is not a function or its return value is not iterable")                                                                        \
    T(NotCallableOrAsyncIterable, "% is not a function or its return value is not async iterable")                                                             \
    ...
    T(NotSuperConstructorAnonymousClass, "Super constructor % of anonymous class is not a constructor")                                                        \
    T(NotIntegerTypedArray, "% is not an integer typed array.")                                                                                                \
    T(NotInt32OrBigInt64TypedArray, "% is not an int32 or BigInt64 typed array.")                                                                              \
    T(NotSharedTypedArray, "% is not a shared typed array.")                                                                                                   \
    T(ObjectFixedLayout, "Cannot add property %, object has fixed layout")                                                                                     \
    T(ObjectGetterExpectingFunction, "Object.prototype.__defineGetter__: Expecting function")                                                                  \
    T(ObjectGetterCallable, "Getter must be a function: %")                                                                                                    \
    T(ObjectNotExtensible, "Cannot add property %, object is not extensible")                                                                                  \
    T(ObjectSetterExpectingFunction, "Object.prototype.__defineSetter__: Expecting function")                                                                  \
    T(ObjectSetterCallable, "Setter must be a function: %")                                                                                                    \
    T(OrdinaryFunctionCalledAsConstructor, "Function object that's not a constructor was created with new")                                                    \
    T(PromiseCyclic, "Chaining cycle detected for promise %")                                                                                                  \
    T(PromiseExecutorAlreadyInvoked, "Promise executor has already been invoked with non-undefined arguments")                                                 \
    T(PromiseNonCallable, "Promise resolve or reject function is not callable")                                                                                \
    T(PropertyDescObject, "Property description must be an object: %")                                                                                         \
    T(PropertyNotFunction, "'%' returned for property '%' of object '%' is not a function")                                                                    \
    T(ProtoObjectOrNull, "Object prototype may only be an Object or null: %")                                                                                  \
    T(PrototypeParentNotAnObject, "Class extends value does not have valid prototype property %")                                                              \
    T(ProxyConstructNonObject, "'construct' on proxy: trap returned non-object ('%')")                                                                         \
    ...
    T(ProxyGetPrototypeOfInvalid, "'getPrototypeOf' on proxy: trap returned neither object nor null")                                                          \
    ...
    T(ProxyNonObject, "Cannot create proxy with a non-object as target or handler")                                                                            \
    T(ProxyOwnKeysMissing, "'ownKeys' on proxy: trap result did not include '%'")                                                                              \
    T(ProxyOwnKeysNonExtensible,                                                                                                                               \
        "'ownKeys' on proxy: trap returned extra keys but proxy target is "                                                                                    \
        "non-extensible")                                                                                                                                      \
    T(ProxyOwnKeysDuplicateEntries, "'ownKeys' on proxy: trap returned duplicate entries")                                                                     \
    ...
    T(ProxyTrapReturnedFalsishFor, "'%' on proxy: trap returned falsish for property '%'")                                                                     \
    T(RedefineDisallowed, "Cannot redefine property: %")                                                                                                       \
    T(RedefineExternalArray, "Cannot redefine a property of an object with external array elements")                                                           \
    T(ReduceNoInitial, "Reduce of empty array with no initial value")                                                                                          \
    T(RegExpFlags, "Cannot supply flags when constructing one RegExp from another")                                                                            \
    T(RegExpNonObject, "% getter called on non-object %")                                                                                                      \
    T(RegExpNonRegExp, "% getter called on non-RegExp object")                                                                                                 \
    T(RegExpGlobalInvokedOnNonGlobal, "% called with a non-global RegExp argument")                                                                            \
    T(RelativeDateTimeFormatterBadParameters, "Incorrect RelativeDateTimeFormatter provided")                                                                  \
    T(ResolverNotAFunction, "Promise resolver % is not a function")                                                                                            \
    T(ReturnMethodNotCallable, "The iterator's 'return' method is not callable")                                                                               \
    T(SizeIsNaN, "The .size property is NaN")                                                                                                                  \
    T(ShadowRealmErrorStackNonString, "Error stack is not a string in ShadowRealm (%)")                                                                        \
    T(ShadowRealmErrorStackThrows, "Error stack getter threw in ShadowRealm (%)")                                                                              \
    T(SharedArrayBufferTooShort,                                                                                                                               \
        "Derived SharedArrayBuffer constructor created a buffer which was too "                                                                                \
        "small")                                                                                                                                               \
    T(SharedArrayBufferSpeciesThis, "SharedArrayBuffer subclass returned this from species constructor")                                                       \
    T(SharedStructTypeRegistryMismatch, "SharedStructType registered as '%' does not match")                                                                   \
    T(StaticPrototype, "Classes may not have a static property named 'prototype'")                                                                             \
    ...
    T(SymbolIteratorInvalid, "Result of the Symbol.iterator method is not an object")                                                                          \
    T(SymbolAsyncIteratorInvalid, "Result of the Symbol.asyncIterator method is not an object")                                                                \
    ...
    T(DisposableStackIsDisposed, "Cannot call % on an already-disposed DisposableStack")                                                                       \
    ...
    T(InvalidDataViewAccessorOffset, "Offset is outside the bounds of the DataView")                                                                           \
    ...
    T(MaximumFractionDigitsNotEqualMinimumFractionDigits, "maximumFractionDigits not equal to minimumFractionDigits")                                          \
    T(NormalizationForm, "The normalization form should be one of %.")                                                                                         \
    T(OutOfMemory, "%: Out of memory")                                                                                                                         \
    T(ZeroDigitNumericSeparator, "Numeric separator can not be used after leading 0.")                                                                         \
    T(NumberFormatRange, "% argument must be between 0 and 100")                                                                                               \
    T(TrailingNumericSeparator, "Numeric separators are not allowed at the end of numeric literals")                                                           \
    T(ContinuousNumericSeparator, "Only one underscore is allowed as numeric separator")                                                                       \
    T(PropertyValueOutOfRange, "% value is out of range.")                                                                                                     \
    T(StackOverflow, "Maximum call stack size exceeded")                                                                                                       \
    T(ToPrecisionFormatRange, "toPrecision() argument must be between 1 and 100")                                                                              \
    ...
    T(StructFieldCountOutOfRange, "Struct field count out of range (maximum of 999 allowed)")                                                                  \
    T(TypedArraySetOffsetOutOfBounds, "offset is out of bounds")                                                                                               \
    T(TypedArraySetSourceTooLarge, "Source is too large")                                                                                                      \
    T(TypedArrayTooLargeToSort, "Custom comparefn not supported for huge TypedArrays")                                                                         \
    T(ValueOutOfRange, "Value % out of range for % options property %")                                                                                        \
    T(CollectionGrowFailed, "% maximum size exceeded")                                                                                                         \
    T(MustBePositive, "% must be positive")                                                                                                                    \
    T(ArgumentIsNotUndefinedOrInteger, "% argument must be undefined or an integer")                                                                           \
    /* SyntaxError */                                                                                                                                          \
    ...
    T(GeneratorInSingleStatementContext, "Generators can only be declared at the top level or inside a block.")                                                \
    T(AsyncFunctionInSingleStatementContext,                                                                                                                   \
        "Async functions can only be declared at the top level or inside a "                                                                                   \
        "block.")                                                                                                                                              \
    T(IllegalBreak, "Illegal break statement")                                                                                                                 \
    T(ModuleExportNameWithoutFromClause, "String literal module export names must be followed by a 'from' clause")                                             \
    T(NoIterationStatement, "Illegal continue statement: no surrounding iteration statement")                                                                  \
    ...
    T(InvalidRestBindingPattern, "`...` must be followed by an identifier in declaration contexts")                                                            \
    ...
    T(InvalidLhsInPostfixOp, "Invalid left-hand side expression in postfix operation")                                                                         \
    T(InvalidLhsInPrefixOp, "Invalid left-hand side expression in prefix operation")                                                                           \
    T(InvalidModuleExportName, "Invalid module export name: contains unpaired surrogate")                                                                      \
    ...
    T(InvalidPrivateBrandReinitialization, "Cannot initialize private methods of class % twice on the same object")                                            \
    T(InvalidPrivateFieldReinitialization, "Cannot initialize % twice on the same object")                                                                     \
    ...
    T(InvalidUnusedPrivateStaticMethodAccessedByDebugger, "Unused static private method '%' cannot be accessed at debug time")                                 \
    T(InvalidUsingInForInLoop, "Invalid 'using' in for-in loop")                                                                                               \
    T(JsonParseUnexpectedEOS, "Unexpected end of JSON input")                                                                                                  \
    T(JsonParseUnexpectedTokenNumber, "Unexpected number in JSON at position % (line % column %)")                                                             \
    T(JsonParseUnexpectedTokenString, "Unexpected string in JSON at position % (line % column %)")                                                             \
    T(JsonParseUnterminatedString, "Unterminated string in JSON at position % (line % column %)")                                                              \
    T(JsonParseExpectedPropNameOrRBrace, "Expected property name or '}' in JSON at position % (line % column %)")                                              \
    ...
    T(JsonParseExpectedColonAfterPropertyName,                                                                                                                 \
        ...
        "%)")                                                                                                                                                  \
    T(JsonParseUnterminatedFractionalNumber, "Unterminated fractional number in JSON at position % (line % column %)")                                         \
    T(JsonParseUnexpectedNonWhiteSpaceCharacter,                                                                                                               \
        "Unexpected non-whitespace character after JSON at position "                                                                                          \
        "% (line % column %)")                                                                                                                                 \
    T(JsonParseBadEscapedCharacter, "Bad escaped character in JSON at position % (line % column %)")                                                           \
    T(JsonParseBadControlCharacter,                                                                                                                            \
        "Bad control character in string literal in JSON at position % (line % "                                                                               \
        "column %)")                                                                                                                                           \
    T(JsonParseBadUnicodeEscape, "Bad Unicode escape in JSON at position % (line % column %)")                                                                 \
    T(JsonParseNoNumberAfterMinusSign, "No number after minus sign in JSON at position % (line % column %)")                                                   \
    T(JsonParseShortString, "\"%\" is not valid JSON")                                                                                                         \
    T(JsonParseUnexpectedTokenShortString, "Unexpected token '%', \"%\" is not valid JSON")                                                                    \
    T(JsonParseUnexpectedTokenSurroundStringWithContext, "Unexpected token '%', ...\"%\"... is not valid JSON")                                                \
    T(JsonParseUnexpectedTokenEndStringWithContext, "Unexpected token '%', ...\"%\" is not valid JSON")                                                        \
    T(JsonParseUnexpectedTokenStartStringWithContext, "Unexpected token '%', \"%\"... is not valid JSON")                                                      \
    ...
    T(MultipleDefaultsInSwitch, "More than one default clause in switch statement")                                                                            \
    ...
    T(AwaitExpressionFormalParameter, "Illegal await-expression in formal parameters of async function")                                                       \
    ...
    T(TooManyElementsInPromiseCombinator, "Too many elements passed to Promise.%")                                                                             \
    ...
    T(WasmTrapBadSuspender, "attempting to suspend without a WebAssembly.promising export")                                                                    \
    T(WasmTrapStringIsolatedSurrogate, "Failed to encode string as UTF-8: contains unpaired surrogate")                                                        \
    ...
    T(DataCloneErrorDetachedArrayBuffer, "An ArrayBuffer is detached and could not be cloned.")                                                                \
    T(DataCloneErrorNonDetachableArrayBuffer, "ArrayBuffer is not detachable and could not be cloned.")                                                        \
    ...
    T(TraceEventNameLengthError, "Trace event name must not be an empty string.")                                                                              \
    ...
    T(WeakRefsCleanupMustBeCallable, "FinalizationRegistry: cleanup must be callable")                                                                         \
    T(InvalidWeakRefsRegisterTarget, "FinalizationRegistry.prototype.register: invalid target")                                                                \
...
{
    DCHECK_LT(static_cast<unsigned>(message_id), static_cast<unsigned>(MessageTemplate::kMessageCount));
