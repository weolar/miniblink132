...
#define NATIVE_CONTEXT_FIELDS(V)                                                                                                                               \
    ...
    V(CONTINUATION_PRESERVED_EMBEDDER_DATA_INDEX, HeapObject, continuation_preserved_embedder_data)                                                            \
    V(GENERATOR_NEXT_INTERNAL, JSFunction, generator_next_internal)                                                                                            \
    V(ASYNC_MODULE_EVALUATE_INTERNAL, JSFunction, async_module_evaluate_internal)                                                                              \
    ...
    V(RAB_GSAB_UINT8_CLAMPED_ARRAY_MAP_INDEX, Map, rab_gsab_uint8_clamped_array_map)                                                                           \
    ...
    V(ABSTRACT_MODULE_SOURCE_FUNCTION_INDEX, JSFunction, abstract_module_source_function)                                                                      \
    V(ABSTRACT_MODULE_SOURCE_PROTOTYPE_INDEX, JSObject, abstract_module_source_prototype)                                                                      \
    V(ACCESSOR_PROPERTY_DESCRIPTOR_MAP_INDEX, Map, accessor_property_descriptor_map)                                                                           \
    ...
    V(ASYNC_GENERATOR_FUNCTION_FUNCTION_INDEX, JSFunction, async_generator_function_function)                                                                  \
    V(BIGINT_FUNCTION_INDEX, JSFunction, bigint_function)                                                                                                      \
    V(BOOLEAN_FUNCTION_INDEX, JSFunction, boolean_function)                                                                                                    \
    V(BOUND_FUNCTION_WITH_CONSTRUCTOR_MAP_INDEX, Map, bound_function_with_constructor_map)                                                                     \
    V(BOUND_FUNCTION_WITHOUT_CONSTRUCTOR_MAP_INDEX, Map, bound_function_without_constructor_map)                                                               \
    ...
    V(ERROR_MESSAGE_FOR_WASM_CODE_GEN_INDEX, Object, error_message_for_wasm_code_gen)                                                                          \
    ...
    V(FAST_TEMPLATE_INSTANTIATIONS_CACHE_INDEX, FixedArray, fast_template_instantiations_cache)                                                                \
    V(FUNCTION_FUNCTION_INDEX, JSFunction, function_function)                                                                                                  \
    V(FUNCTION_PROTOTYPE_INDEX, JSObject, function_prototype)                                                                                                  \
    V(GENERATOR_FUNCTION_FUNCTION_INDEX, JSFunction, generator_function_function)                                                                              \
    V(GENERATOR_OBJECT_PROTOTYPE_MAP_INDEX, Map, generator_object_prototype_map)                                                                               \
    V(ASYNC_GENERATOR_OBJECT_PROTOTYPE_MAP_INDEX, Map, async_generator_object_prototype_map)                                                                   \
    V(INITIAL_ARRAY_ITERATOR_MAP_INDEX, Map, initial_array_iterator_map)                                                                                       \
    V(INITIAL_ARRAY_ITERATOR_PROTOTYPE_INDEX, JSObject, initial_array_iterator_prototype)                                                                      \
    ...
    V(INITIAL_ASYNC_ITERATOR_PROTOTYPE_INDEX, JSObject, initial_async_iterator_prototype)                                                                      \
    V(INITIAL_ASYNC_GENERATOR_PROTOTYPE_INDEX, JSObject, initial_async_generator_prototype)                                                                    \
    V(INITIAL_ITERATOR_PROTOTYPE_INDEX, JSObject, initial_iterator_prototype)                                                                                  \
    V(INITIAL_DISPOSABLE_STACK_PROTOTYPE_INDEX, JSObject, initial_disposable_stack_prototype)                                                                  \
    V(INITIAL_MAP_ITERATOR_PROTOTYPE_INDEX, JSObject, initial_map_iterator_prototype)                                                                          \
    V(INITIAL_MAP_PROTOTYPE_MAP_INDEX, Map, initial_map_prototype_map)                                                                                         \
    V(INITIAL_OBJECT_PROTOTYPE_INDEX, JSObject, initial_object_prototype)                                                                                      \
    V(INITIAL_SET_ITERATOR_PROTOTYPE_INDEX, JSObject, initial_set_iterator_prototype)                                                                          \
    ...
    V(INITIAL_STRING_ITERATOR_PROTOTYPE_INDEX, JSObject, initial_string_iterator_prototype)                                                                    \
    ...
    V(INTL_DATE_TIME_FORMAT_FUNCTION_INDEX, JSFunction, intl_date_time_format_function)                                                                        \
    V(INTL_DISPLAY_NAMES_FUNCTION_INDEX, JSFunction, intl_display_names_function)                                                                              \
    V(INTL_DURATION_FORMAT_FUNCTION_INDEX, JSFunction, intl_duration_format_function)                                                                          \
    V(INTL_NUMBER_FORMAT_FUNCTION_INDEX, JSFunction, intl_number_format_function)                                                                              \
    ...
    V(INTL_RELATIVE_TIME_FORMAT_FUNCTION_INDEX, JSFunction, intl_relative_time_format_function)                                                                \
    ...
    V(INTL_SEGMENT_DATA_OBJECT_WORDLIKE_MAP_INDEX, Map, intl_segment_data_object_wordlike_map)                                                                 \
    ...
    V(JS_ARRAY_HOLEY_SMI_ELEMENTS_MAP_INDEX, Map, js_array_holey_smi_elements_map)                                                                             \
    ...
    V(JS_ARRAY_PACKED_DOUBLE_ELEMENTS_MAP_INDEX, Map, js_array_packed_double_elements_map)                                                                     \
    V(JS_ARRAY_HOLEY_DOUBLE_ELEMENTS_MAP_INDEX, Map, js_array_holey_double_elements_map)                                                                       \
    V(JS_ARRAY_TEMPLATE_LITERAL_OBJECT_MAP, Map, js_array_template_literal_object_map)                                                                         \
    V(JS_DISPOSABLE_STACK_FUNCTION_INDEX, JSFunction, js_disposable_stack_function)                                                                            \
    V(JS_ASYNC_DISPOSABLE_STACK_FUNCTION_INDEX, JSFunction, js_async_disposable_stack_function)                                                                \
    ...
    V(JS_FINALIZATION_REGISTRY_FUNCTION_INDEX, JSFunction, js_finalization_registry_fun)                                                                       \
    V(JS_TEMPORAL_CALENDAR_FUNCTION_INDEX, JSFunction, temporal_calendar_function)                                                                             \
    V(JS_TEMPORAL_DURATION_FUNCTION_INDEX, JSFunction, temporal_duration_function)                                                                             \
    V(JS_TEMPORAL_INSTANT_FUNCTION_INDEX, JSFunction, temporal_instant_function)                                                                               \
    V(JS_TEMPORAL_PLAIN_DATE_FUNCTION_INDEX, JSFunction, temporal_plain_date_function)                                                                         \
    V(JS_TEMPORAL_PLAIN_DATE_TIME_FUNCTION_INDEX, JSFunction, temporal_plain_date_time_function)                                                               \
    V(JS_TEMPORAL_PLAIN_MONTH_DAY_FUNCTION_INDEX, JSFunction, temporal_plain_month_day_function)                                                               \
    V(JS_TEMPORAL_PLAIN_TIME_FUNCTION_INDEX, JSFunction, temporal_plain_time_function)                                                                         \
    V(JS_TEMPORAL_PLAIN_YEAR_MONTH_FUNCTION_INDEX, JSFunction, temporal_plain_year_month_function)                                                             \
    V(JS_TEMPORAL_TIME_ZONE_FUNCTION_INDEX, JSFunction, temporal_time_zone_function)                                                                           \
    V(JS_TEMPORAL_ZONED_DATE_TIME_FUNCTION_INDEX, JSFunction, temporal_zoned_date_time_function)                                                               \
    V(JSON_OBJECT, JSObject, json_object)                                                                                                                      \
    V(PROMISE_WITHRESOLVERS_RESULT_MAP_INDEX, Map, promise_withresolvers_result_map)                                                                           \
    V(TEMPORAL_OBJECT_INDEX, HeapObject, temporal_object)                                                                                                      \
    V(TEMPORAL_INSTANT_FIXED_ARRAY_FROM_ITERABLE_FUNCTION_INDEX, JSFunction, temporal_instant_fixed_array_from_iterable)                                       \
    V(STRING_FIXED_ARRAY_FROM_ITERABLE_FUNCTION_INDEX, JSFunction, string_fixed_array_from_iterable)                                                           \
    /* Context maps */                                                                                                                                         \
    ...
    V(PROMISE_HOOK_RESOLVE_FUNCTION_INDEX, Object, promise_hook_resolve_function)                                                                              \
    ...
    V(INITIAL_REGEXP_STRING_ITERATOR_PROTOTYPE_MAP_INDEX, Map, initial_regexp_string_iterator_prototype_map)                                                   \
    ...
    V(SLOW_OBJECT_WITH_NULL_PROTOTYPE_MAP, Map, slow_object_with_null_prototype_map)                                                                           \
    V(SLOW_OBJECT_WITH_OBJECT_PROTOTYPE_MAP, Map, slow_object_with_object_prototype_map)                                                                       \
    V(SLOW_TEMPLATE_INSTANTIATIONS_CACHE_INDEX, SimpleNumberDictionary, slow_template_instantiations_cache)                                                    \
    ...
    V(SLOPPY_FUNCTION_WITHOUT_PROTOTYPE_MAP_INDEX, Map, sloppy_function_without_prototype_map)                                                                 \
    V(SLOPPY_FUNCTION_WITH_READONLY_PROTOTYPE_MAP_INDEX, Map, sloppy_function_with_readonly_prototype_map)                                                     \
    V(STRICT_FUNCTION_MAP_INDEX, Map, strict_function_map)                                                                                                     \
    V(STRICT_FUNCTION_WITH_NAME_MAP_INDEX, Map, strict_function_with_name_map)                                                                                 \
    V(STRICT_FUNCTION_WITH_READONLY_PROTOTYPE_MAP_INDEX, Map, strict_function_with_readonly_prototype_map)                                                     \
    V(STRICT_FUNCTION_WITHOUT_PROTOTYPE_MAP_INDEX, Map, strict_function_without_prototype_map)                                                                 \
    ...
    V(GENERATOR_FUNCTION_WITH_NAME_MAP_INDEX, Map, generator_function_with_name_map)                                                                           \
    V(ASYNC_GENERATOR_FUNCTION_MAP_INDEX, Map, async_generator_function_map)                                                                                   \
    V(ASYNC_GENERATOR_FUNCTION_WITH_NAME_MAP_INDEX, Map, async_generator_function_with_name_map)                                                               \
    ...
    V(WASM_SUSPENDING_CONSTRUCTOR_INDEX, JSFunction, wasm_suspending_constructor)                                                                              \
    ...
    V(FINALIZATION_REGISTRY_CLEANUP_SOME, JSFunction, finalization_registry_cleanup_some)                                                                      \
    ...
    V(SHADOW_REALM_IMPORT_VALUE_REJECTED_INDEX, JSFunction, shadow_realm_import_value_rejected)                                                                \
    V(SUPPRESSED_ERROR_FUNCTION_INDEX, JSFunction, suppressed_error_function)                                                                                  \
    V(SYNTAX_ERROR_FUNCTION_INDEX, JSFunction, syntax_error_function)                                                                                          \
    V(TYPE_ERROR_FUNCTION_INDEX, JSFunction, type_error_function)                                                                                              \
    V(URI_ERROR_FUNCTION_INDEX, JSFunction, uri_error_function)                                                                                                \
    V(WASM_COMPILE_ERROR_FUNCTION_INDEX, JSFunction, wasm_compile_error_function)                                                                              \
    ...
    V(SHARED_SPACE_JS_OBJECT_HAS_INSTANCE_INDEX, JSFunction, shared_space_js_object_has_instance)
...
#undef NATIVE_CONTEXT_SLOT
    ...
    static const int kExtensionSize = (MIN_CONTEXT_EXTENDED_SLOTS - MIN_CONTEXT_SLOTS) * kTaggedSize;
    ...
    static const int FIRST_RAB_GSAB_TYPED_ARRAY_MAP_INDEX = RAB_GSAB_UINT8_ARRAY_MAP_INDEX;
...
#undef NATIVE_CONTEXT_FIELD_ACCESSORS
    ...
    //    always ABSENT.
    static Handle<Object> Lookup(Handle<Context> context, Handle<String> name, ContextLookupFlags flags, int* index, PropertyAttributes* attributes,
        InitializationFlag* init_flag, VariableMode* variable_mode, bool* is_sloppy_function_name = nullptr);

    static inline int FunctionMapIndex(LanguageMode language_mode, FunctionKind kind, bool has_shared_name);
    ...
    static Tagged<ContextSidePropertyCell> GetOrCreateContextSidePropertyCell(
        DirectHandle<Context> context, size_t index, ContextSidePropertyCell::Property property, Isolate* isolate);

    ContextSidePropertyCell::Property GetScriptContextSideProperty(size_t index) const;
...
private:
    ...
    inline void set_previous(Tagged<Context> context, WriteBarrierMode mode = UPDATE_WRITE_BARRIER);
...
public:
    ...
    inline void synchronized_set_script_context_table(Tagged<ScriptContextTable> script_context_table);
    ...
    inline Tagged<Map> TypedArrayElementsKindToCtorMap(ElementsKind element_kind) const;

    inline Tagged<Map> TypedArrayElementsKindToRabGsabCtorMap(ElementsKind element_kind) const;
...
#define NATIVE_CONTEXT_FIELDS_DEF(V)                                                                                                                           \
    ...
    V(kStartOfNativeContextFieldsOffset, (FIRST_WEAK_SLOT - MIN_CONTEXT_EXTENDED_SLOTS) * kTaggedSize)                                                         \
    V(kEndOfStrongFieldsOffset, 0)                                                                                                                             \
    V(kStartOfWeakFieldsOffset, (NATIVE_CONTEXT_SLOTS - FIRST_WEAK_SLOT) * kTaggedSize)                                                                        \
    ...
    DEFINE_FIELD_OFFSET_CONSTANTS(Context::kExtendedHeaderSize, NATIVE_CONTEXT_FIELDS_DEF)
...
class ScriptContextTable : public TaggedArrayBase<ScriptContextTable, ScriptContextTableShape> {
...
public:
    ...
    inline void set_names_to_context_index(Tagged<NameToIndexHashTable> value, WriteBarrierMode mode = UPDATE_WRITE_BARRIER);
    ...
    V8_EXPORT_PRIVATE bool Lookup(Handle<String> name, VariableLookupResult* result);

    V8_WARN_UNUSED_RESULT
    V8_EXPORT_PRIVATE static Handle<ScriptContextTable> Add(
        Isolate* isolate, Handle<ScriptContextTable> table, DirectHandle<Context> script_context, bool ignore_duplicates);
