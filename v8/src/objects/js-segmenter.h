...
public:
    ...
    // options.
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSSegmenter> New(Isolate* isolate, DirectHandle<Map> map, Handle<Object> locales, Handle<Object> options);

    V8_WARN_UNUSED_RESULT static Handle<JSObject> ResolvedOptions(Isolate* isolate, DirectHandle<JSSegmenter> segmenter_holder);
    ...
    Handle<String> static GetGranularityString(Isolate* isolate, Granularity granularity);
