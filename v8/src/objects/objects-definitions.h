...
#define STRING_TYPE_LIST(V)                                                                                                                                    \
    ...
    V(EXTERNAL_INTERNALIZED_TWO_BYTE_STRING_TYPE, sizeof(ExternalTwoByteString), external_internalized_two_byte_string, ExternalInternalizedTwoByteString)     \
    V(EXTERNAL_INTERNALIZED_ONE_BYTE_STRING_TYPE, sizeof(ExternalOneByteString), external_internalized_one_byte_string, ExternalInternalizedOneByteString)     \
    /* Start uncached external strings*/                                                                                                                       \
    V(UNCACHED_EXTERNAL_INTERNALIZED_TWO_BYTE_STRING_TYPE, sizeof(UncachedExternalString), uncached_external_internalized_two_byte_string,                     \
        UncachedExternalInternalizedTwoByteString)                                                                                                             \
    V(UNCACHED_EXTERNAL_INTERNALIZED_ONE_BYTE_STRING_TYPE, sizeof(UncachedExternalString), uncached_external_internalized_one_byte_string,                     \
        UncachedExternalInternalizedOneByteString)                                                                                                             \
    /* End internalized strings*/                                                                                                                              \
    V(UNCACHED_EXTERNAL_TWO_BYTE_STRING_TYPE, sizeof(UncachedExternalString), uncached_external_two_byte_string, UncachedExternalTwoByteString)                \
    V(UNCACHED_EXTERNAL_ONE_BYTE_STRING_TYPE, sizeof(UncachedExternalString), uncached_external_one_byte_string, UncachedExternalOneByteString)                \
    V(SHARED_UNCACHED_EXTERNAL_TWO_BYTE_STRING_TYPE, sizeof(UncachedExternalString), shared_uncached_external_two_byte_string,                                 \
        SharedUncachedExternalTwoByteString)                                                                                                                   \
    V(SHARED_UNCACHED_EXTERNAL_ONE_BYTE_STRING_TYPE, sizeof(UncachedExternalString), shared_uncached_external_one_byte_string,                                 \
        SharedUncachedExternalOneByteString)                                                                                                                   \
    /* End uncached external strings*/                                                                                                                         \
    V(EXTERNAL_TWO_BYTE_STRING_TYPE, sizeof(ExternalTwoByteString), external_two_byte_string, ExternalTwoByteString)                                           \
    V(EXTERNAL_ONE_BYTE_STRING_TYPE, sizeof(ExternalOneByteString), external_one_byte_string, ExternalOneByteString)                                           \
    V(SHARED_EXTERNAL_TWO_BYTE_STRING_TYPE, sizeof(ExternalTwoByteString), shared_external_two_byte_string, SharedExternalTwoByteString)                       \
    V(SHARED_EXTERNAL_ONE_BYTE_STRING_TYPE, sizeof(ExternalOneByteString), shared_external_one_byte_string, SharedExternalOneByteString)                       \
    /* End external strings*/                                                                                                                                  \
                                                                                                                                                               \
    V(CONS_TWO_BYTE_STRING_TYPE, sizeof(ConsString), cons_two_byte_string, ConsTwoByteString)                                                                  \
    V(CONS_ONE_BYTE_STRING_TYPE, sizeof(ConsString), cons_one_byte_string, ConsOneByteString)                                                                  \
    V(SLICED_TWO_BYTE_STRING_TYPE, sizeof(SlicedString), sliced_two_byte_string, SlicedTwoByteString)                                                          \
    V(SLICED_ONE_BYTE_STRING_TYPE, sizeof(SlicedString), sliced_one_byte_string, SlicedOneByteString)                                                          \
    V(THIN_TWO_BYTE_STRING_TYPE, sizeof(ThinString), thin_two_byte_string, ThinTwoByteString)                                                                  \
    V(THIN_ONE_BYTE_STRING_TYPE, sizeof(ThinString), thin_one_byte_string, ThinOneByteString)
...
#define STRUCT_LIST_GENERATOR(V, _)                                                                                                                            \
    V(_, PROMISE_FULFILL_REACTION_JOB_TASK_TYPE, PromiseFulfillReactionJobTask, promise_fulfill_reaction_job_task)                                             \
    V(_, PROMISE_REJECT_REACTION_JOB_TASK_TYPE, PromiseRejectReactionJobTask, promise_reject_reaction_job_task)                                                \
    V(_, CALLABLE_TASK_TYPE, CallableTask, callable_task)                                                                                                      \
    V(_, CALLBACK_TASK_TYPE, CallbackTask, callback_task)                                                                                                      \
    V(_, PROMISE_RESOLVE_THENABLE_JOB_TASK_TYPE, PromiseResolveThenableJobTask, promise_resolve_thenable_job_task)                                             \
    V(_, ACCESS_CHECK_INFO_TYPE, AccessCheckInfo, access_check_info)                                                                                           \
    V(_, ACCESSOR_PAIR_TYPE, AccessorPair, accessor_pair)                                                                                                      \
    V(_, ALIASED_ARGUMENTS_ENTRY_TYPE, AliasedArgumentsEntry, aliased_arguments_entry)                                                                         \
    V(_, ALLOCATION_MEMENTO_TYPE, AllocationMemento, allocation_memento)                                                                                       \
    V(_, ARRAY_BOILERPLATE_DESCRIPTION_TYPE, ArrayBoilerplateDescription, array_boilerplate_description)                                                       \
    IF_WASM(V, _, ASM_WASM_DATA_TYPE, AsmWasmData, asm_wasm_data)                                                                                              \
    V(_, ASYNC_GENERATOR_REQUEST_TYPE, AsyncGeneratorRequest, async_generator_request)                                                                         \
    ...
    V(_, PROPERTY_DESCRIPTOR_OBJECT_TYPE, PropertyDescriptorObject, property_descriptor_object)                                                                \
    V(_, PROTOTYPE_INFO_TYPE, PrototypeInfo, prototype_info)                                                                                                   \
    V(_, REG_EXP_BOILERPLATE_DESCRIPTION_TYPE, RegExpBoilerplateDescription, regexp_boilerplate_description)                                                   \
    ...
    V(_, SOURCE_TEXT_MODULE_INFO_ENTRY_TYPE, SourceTextModuleInfoEntry, module_info_entry)                                                                     \
    V(_, STACK_FRAME_INFO_TYPE, StackFrameInfo, stack_frame_info)                                                                                              \
    V(_, STACK_TRACE_INFO_TYPE, StackTraceInfo, stack_trace_info)                                                                                              \
    V(_, TEMPLATE_OBJECT_DESCRIPTION_TYPE, TemplateObjectDescription, template_object_description)                                                             \
...
#define STRUCT_MAPS_LIST_ADAPTER(V, NAME, Name, name) V(Map, name##_map, Name##Map)
...
#define ALLOCATION_SITE_LIST(V, _)                                                                                                                             \
    ...
    V(_, ALLOCATION_SITE_TYPE, AllocationSite, WithoutWeakNext, allocation_site_without_weaknext)

// Adapts one ALLOCATION_SITE_LIST entry to the ALLOCATION_SITE_MAPS_LIST entry
#define ALLOCATION_SITE_MAPS_LIST_ADAPTER(V, TYPE, Name, Size, name_size) V(Map, name_size##_map, Name##Size##Map)

// Produces (Map, allocation_site_name_map, AllocationSiteNameMap) entries
#define ALLOCATION_SITE_MAPS_LIST(V) ALLOCATION_SITE_LIST(ALLOCATION_SITE_MAPS_LIST_ADAPTER, V)
...
#define DATA_HANDLER_MAPS_LIST_ADAPTER(V, TYPE, Name, Size, name_size) V(Map, name_size##_map, Name##Size##Map)

// Produces (Map, handler_name_map, HandlerNameMap) entries
#define DATA_HANDLER_MAPS_LIST(V) DATA_HANDLER_LIST(DATA_HANDLER_MAPS_LIST_ADAPTER, V)
