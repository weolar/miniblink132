...
public:
    ...
    static Handle<Object> FindBreakPointInfo(Isolate* isolate, DirectHandle<DebugInfo> debug_info, DirectHandle<BreakPoint> break_point);
...
class BreakPointInfo : public TorqueGeneratedBreakPointInfo<BreakPointInfo, Struct> {
public:
    ...
    static MaybeHandle<BreakPoint> GetBreakPointById(Isolate* isolate, DirectHandle<BreakPointInfo> info, int breakpoint_id);
...
class CoverageInfo : public TorqueGeneratedCoverageInfo<CoverageInfo, HeapObject> {
public:
...
class StackFrameInfo : public TorqueGeneratedStackFrameInfo<StackFrameInfo, Struct> {
public:
    NEVER_READ_ONLY_SPACE
...
class StackTraceInfo : public TorqueGeneratedStackTraceInfo<StackTraceInfo, Struct> {
public:
    NEVER_READ_ONLY_SPACE
...
class ErrorStackData : public TorqueGeneratedErrorStackData<ErrorStackData, Struct> {
public:
    NEVER_READ_ONLY_SPACE
