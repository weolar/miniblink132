...
public:
    ...
    inline Tagged<TrustedObject> ReadProtectedPointerField(int offset, AcquireLoadTag) const;
    inline void WriteProtectedPointerField(int offset, Tagged<TrustedObject> value);
    inline void WriteProtectedPointerField(int offset, Tagged<TrustedObject> value, ReleaseStoreTag);
...
V8_OBJECT class TrustedObjectLayout : public HeapObjectLayout { public : DECL_VERIFIER(TrustedObject) } V8_OBJECT_END;
