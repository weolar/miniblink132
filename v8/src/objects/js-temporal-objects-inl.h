...
#define TEMPORAL_INLINE_SIGNED_GETTER_SETTER(T, data, field, lower, upper, B)                                                                                  \
    ...
    {                                                                                                                                                          \
        ...
        field &= (static_cast<uint32_t>(int32_t { -1 })) ^ (static_cast<uint32_t>(int32_t { -1 }) << B##Bits::kSize);                                          \
        hints = B##Bits::update(hints, field);                                                                                                                 \
        set_##data(hints);                                                                                                                                     \
    }                                                                                                                                                          \
    inline int32_t T::field() const                                                                                                                            \
    {                                                                                                                                                          \
        ...
        v |= ((int32_t { 1 } << (B##Bits::kSize - 1) & v) ? (static_cast<uint32_t>(int32_t { -1 }) << B##Bits::kSize) : 0);                                    \
        DCHECK_GE(upper, v);                                                                                                                                   \
        DCHECK_LE(lower, v);                                                                                                                                   \
        return v;                                                                                                                                              \
    }
...
#define TEMPORAL_DATE_INLINE_GETTER_SETTER(T, data)                                                                                                            \
    TEMPORAL_INLINE_SIGNED_GETTER_SETTER(T, data, iso_year, -271821, 275760, IsoYear)                                                                          \
...
#define TEMPORAL_TIME_INLINE_GETTER_SETTER(T, data1, data2)                                                                                                    \
    ...
    TEMPORAL_INLINE_GETTER_SETTER(T, data2, iso_millisecond, 0, 999, IsoMillisecond)                                                                           \
    TEMPORAL_INLINE_GETTER_SETTER(T, data2, iso_microsecond, 0, 999, IsoMicrosecond)                                                                           \
...
TEMPORAL_TIME_INLINE_GETTER_SETTER(JSTemporalPlainDateTime, hour_minute_second, second_parts)
...
BIT_FIELD_ACCESSORS(JSTemporalCalendar, flags, calendar_index, JSTemporalCalendar::CalendarIndexBits)
...
TEMPORAL_INLINE_SIGNED_GETTER_SETTER(
    JSTemporalTimeZone, flags, offset_milliseconds, -24 * 60 * 60 * 1000, 24 * 60 * 60 * 1000, OffsetMillisecondsOrTimeZoneIndex)

TEMPORAL_INLINE_SIGNED_GETTER_SETTER(JSTemporalTimeZone, details, offset_sub_milliseconds, -1000000, 1000000, OffsetSubMilliseconds)

BIT_FIELD_ACCESSORS(JSTemporalTimeZone, flags, offset_milliseconds_or_time_zone_index, JSTemporalTimeZone::OffsetMillisecondsOrTimeZoneIndexBits)
