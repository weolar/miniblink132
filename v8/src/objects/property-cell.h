...
class PropertyCell : public TorqueGeneratedPropertyCell<PropertyCell, HeapObject> {
public:
    ...
    inline void Transition(PropertyDetails new_details, DirectHandle<Object> new_value);
    // For protectors:
...
class ContextSidePropertyCell : public TorqueGeneratedContextSidePropertyCell<ContextSidePropertyCell, HeapObject> {
public:
    ...
    enum Property {
        ...
        // kMutableHeapNumber.
        kMutableHeapNumber = 3, // The slot holds a HeapNumber that can be mutated in-place by
    ...
    {
        return Smi::FromInt(Property::kConst);
    }
    static Tagged<Smi> SmiMarker()
    {
        return Smi::FromInt(Property::kSmi);
    }
    ...
    {
        return Smi::FromInt(Property::kOther);
    }
    ...
    using BodyDescriptor = FixedBodyDescriptor<kDependentCodeOffset, kSize, kSize>;
