...
#define RAB_GSAB_TYPED_ARRAYS_BASE(V)                                                                                                                          \
    ...
    V(RabGsabUint8Clamped, rab_gsab_uint8_clamped, RAB_GSAB_UINT8_CLAMPED, uint8_t)                                                                            \
    V(RabGsabFloat32, rab_gsab_float32, RAB_GSAB_FLOAT32, float)                                                                                               \
    V(RabGsabFloat64, rab_gsab_float64, RAB_GSAB_FLOAT64, double)

#define RAB_GSAB_TYPED_ARRAYS_FLOAT16(V) V(RabGsabFloat16, rab_gsab_float16, RAB_GSAB_FLOAT16, uint16_t)
...
#define RAB_GSAB_TYPED_ARRAYS_WITH_TYPED_ARRAY_TYPE_FLOAT16(V) V(Float16, rab_gsab_float16, RAB_GSAB_FLOAT16, uint16_t)
...
#define RAB_GSAB_TYPED_ARRAYS_WITH_NON_RAB_GSAB_ELEMENTS_KIND_BASE(V)                                                                                          \
    ...
    V(RabGsabBigUint64, rab_gsab_biguint64, RAB_GSAB_BIGUINT64, uint64_t, BIGUINT64)                                                                           \
    V(RabGsabBigInt64, rab_gsab_bigint64, RAB_GSAB_BIGINT64, int64_t, BIGINT64)                                                                                \
    V(RabGsabUint8Clamped, rab_gsab_uint8_clamped, RAB_GSAB_UINT8_CLAMPED, uint8_t, UINT8_CLAMPED)                                                             \
...
#define RAB_GSAB_TYPED_ARRAYS_WITH_NON_RAB_GSAB_ELEMENTS_KIND_FLOAT16(V) V(RabGsabFloat16, rab_gsab_float16, RAB_GSAB_FLOAT16, uint16_t, FLOAT16)
...
#define TYPED_ARRAY_ELEMENTS_KIND(Type, type, TYPE, ctype) TYPE##_ELEMENTS,
    TYPED_ARRAYS(TYPED_ARRAY_ELEMENTS_KIND) RAB_GSAB_TYPED_ARRAYS(TYPED_ARRAY_ELEMENTS_KIND)
...
{
    return base::IsInRange(kind, FAST_SLOPPY_ARGUMENTS_ELEMENTS, SLOW_SLOPPY_ARGUMENTS_ELEMENTS);
}

inline bool IsStringWrapperElementsKind(ElementsKind kind)
{
    return base::IsInRange(kind, FAST_STRING_WRAPPER_ELEMENTS, SLOW_STRING_WRAPPER_ELEMENTS);
}
...
{
    return base::IsInRange(kind, FIRST_RAB_GSAB_FIXED_TYPED_ARRAY_ELEMENTS_KIND, LAST_RAB_GSAB_FIXED_TYPED_ARRAY_ELEMENTS_KIND);
}

inline bool IsTypedArrayOrRabGsabTypedArrayElementsKind(ElementsKind kind)
{
    return base::IsInRange(kind, FIRST_FIXED_TYPED_ARRAY_ELEMENTS_KIND, LAST_RAB_GSAB_FIXED_TYPED_ARRAY_ELEMENTS_KIND);
}

inline bool IsBigIntTypedArrayElementsKind(ElementsKind kind)
{
    return kind == BIGINT64_ELEMENTS || kind == BIGUINT64_ELEMENTS || kind == RAB_GSAB_BIGINT64_ELEMENTS || kind == RAB_GSAB_BIGUINT64_ELEMENTS;
}
...
{
    return kind == FLOAT16_ELEMENTS || kind == RAB_GSAB_FLOAT16_ELEMENTS || kind == FLOAT32_ELEMENTS || kind == FLOAT64_ELEMENTS
...
{
    return kind == INT8_ELEMENTS || kind == RAB_GSAB_INT8_ELEMENTS || kind == INT16_ELEMENTS || kind == RAB_GSAB_INT16_ELEMENTS || kind == INT32_ELEMENTS
        || kind == RAB_GSAB_INT32_ELEMENTS;
}

inline bool IsUnsignedIntTypedArrayElementsKind(ElementsKind kind)
{
    return kind == UINT8_CLAMPED_ELEMENTS || kind == RAB_GSAB_UINT8_CLAMPED_ELEMENTS || kind == UINT8_ELEMENTS || kind == RAB_GSAB_UINT8_ELEMENTS
        || kind == UINT16_ELEMENTS || kind == RAB_GSAB_UINT16_ELEMENTS || kind == UINT32_ELEMENTS || kind == RAB_GSAB_UINT32_ELEMENTS;
}
...
{
    return kind == TERMINAL_FAST_ELEMENTS_KIND || IsTypedArrayOrRabGsabTypedArrayElementsKind(kind) || IsRabGsabTypedArrayElementsKind(kind);
}
...
{
    return IsFastElementsKind(kind) || IsTypedArrayOrRabGsabTypedArrayElementsKind(kind) || kind == FAST_SLOPPY_ARGUMENTS_ELEMENTS
...
{
    return base::IsInRange(kind, FIRST_ANY_NONEXTENSIBLE_ELEMENTS_KIND, LAST_ANY_NONEXTENSIBLE_ELEMENTS_KIND);
}

inline bool IsAnyNonextensibleElementsKind(ElementsKind kind)
{
    DCHECK_IMPLIES(IsAnyNonextensibleElementsKindUnchecked(kind), v8_flags.enable_sealed_frozen_elements_kind);
    return IsAnyNonextensibleElementsKindUnchecked(kind);
}

inline bool IsNonextensibleElementsKind(ElementsKind kind)
{
    DCHECK_IMPLIES(base::IsInRange(kind, PACKED_NONEXTENSIBLE_ELEMENTS, HOLEY_NONEXTENSIBLE_ELEMENTS), v8_flags.enable_sealed_frozen_elements_kind);
    return base::IsInRange(kind, PACKED_NONEXTENSIBLE_ELEMENTS, HOLEY_NONEXTENSIBLE_ELEMENTS);
}

inline bool IsSealedElementsKind(ElementsKind kind)
{
    DCHECK_IMPLIES(
        base::IsInRange(kind, PACKED_SEALED_ELEMENTS, HOLEY_SEALED_ELEMENTS) || IsSharedArrayElementsKind(kind), v8_flags.enable_sealed_frozen_elements_kind);
    return IsSharedArrayElementsKind(kind) || base::IsInRange(kind, PACKED_SEALED_ELEMENTS, HOLEY_SEALED_ELEMENTS);
}

inline bool IsFrozenElementsKind(ElementsKind kind)
{
    DCHECK_IMPLIES(base::IsInRange(kind, PACKED_FROZEN_ELEMENTS, HOLEY_FROZEN_ELEMENTS), v8_flags.enable_sealed_frozen_elements_kind);
...
inline bool IsFastOrNonextensibleOrSealedElementsKind(ElementsKind kind)
{
    ...
    DCHECK_IMPLIES(result, IsFastElementsKind(kind) || IsNonextensibleElementsKind(kind) || IsSealedElementsKind(kind));
...
{
    DCHECK_IMPLIES(
        kind == HOLEY_NONEXTENSIBLE_ELEMENTS || kind == HOLEY_SEALED_ELEMENTS || kind == HOLEY_FROZEN_ELEMENTS, v8_flags.enable_sealed_frozen_elements_kind);
    return kind == HOLEY_NONEXTENSIBLE_ELEMENTS || kind == HOLEY_SEALED_ELEMENTS || kind == HOLEY_FROZEN_ELEMENTS;
}
...
inline ElementsKind GetCorrespondingRabGsabElementsKind(ElementsKind typed_array_kind)
{
    DCHECK(IsTypedArrayElementsKind(typed_array_kind));
    return ElementsKind(typed_array_kind - FIRST_FIXED_TYPED_ARRAY_ELEMENTS_KIND + FIRST_RAB_GSAB_FIXED_TYPED_ARRAY_ELEMENTS_KIND);
}

inline ElementsKind GetCorrespondingNonRabGsabElementsKind(ElementsKind typed_array_kind)
{
    DCHECK(IsRabGsabTypedArrayElementsKind(typed_array_kind));
    return ElementsKind(typed_array_kind - FIRST_RAB_GSAB_FIXED_TYPED_ARRAY_ELEMENTS_KIND + FIRST_FIXED_TYPED_ARRAY_ELEMENTS_KIND);
}

inline bool UnionElementsKindUptoPackedness(ElementsKind* a_out, ElementsKind b)
{
    // Assert that the union of two ElementKinds can be computed via std::max.
    static_assert(PACKED_SMI_ELEMENTS < HOLEY_SMI_ELEMENTS, "ElementsKind union not computable via std::max.");
    static_assert(PACKED_ELEMENTS < HOLEY_ELEMENTS, "ElementsKind union not computable via std::max.");
    static_assert(PACKED_DOUBLE_ELEMENTS < HOLEY_DOUBLE_ELEMENTS, "ElementsKind union not computable via std::max.");
