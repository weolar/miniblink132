...
inline Tagged<ClearedWeakValue> ClearedValue(PtrComprCageBase cage_base)
{
    ...
    value = V8HeapCompressionScheme::DecompressTagged(cage_base, kClearedWeakHeapObjectLower32);
#else
...
template <typename THeapObjectSlot> void UpdateHeapObjectReferenceSlot(THeapObjectSlot slot, Tagged<HeapObject> value)
{
