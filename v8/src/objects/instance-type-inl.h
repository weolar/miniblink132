...
template <class type> V8_INLINE constexpr std::optional<RootIndex> UniqueMapOfInstanceTypeCheck()
{
    return {};
}

#define INSTANCE_TYPE_MAP(V, rootIndexName, rootAccessorName, class_name)                                                                                      \
    template <> V8_INLINE constexpr std::optional<RootIndex> UniqueMapOfInstanceTypeCheck<InstanceTypeTraits::class_name>()                                    \
    {                                                                                                                                                          \
...
#define INSTANCE_TYPE_CHECK(it, forinstancetype)                                                                                                               \
    if (type == forinstancetype) {                                                                                                                             \
        return InstanceTypeChecker::UniqueMapOfInstanceTypeCheck<InstanceTypeChecker::InstanceTypeTraits::it>();                                               \
    }
...
template <InstanceType type> constexpr bool kHasUniqueMapOfInstanceType = UniqueMapOfInstanceType(type).has_value();

template <InstanceType type>
constexpr RootIndex kUniqueMapOfInstanceType = kHasUniqueMapOfInstanceType<type> ? *UniqueMapOfInstanceType(type) : RootIndex::kRootListLength;
...
constexpr std::array<std::pair<InstanceTypeRange, TaggedAddressRange>, 9> kUniqueMapRangeOfInstanceTypeRangeList
    = { { { { ALLOCATION_SITE_TYPE, ALLOCATION_SITE_TYPE },
              { StaticReadOnlyRoot::kAllocationSiteWithWeakNextMap, StaticReadOnlyRoot::kAllocationSiteWithoutWeakNextMap } },
        { { FIRST_STRING_TYPE, LAST_STRING_TYPE }, { InstanceTypeChecker::kStringMapLowerBound, InstanceTypeChecker::kStringMapUpperBound } },
        { { FIRST_NAME_TYPE, LAST_NAME_TYPE }, { StaticReadOnlyRoot::kSeqTwoByteStringMap, StaticReadOnlyRoot::kSymbolMap } },
        { { ODDBALL_TYPE, ODDBALL_TYPE }, { StaticReadOnlyRoot::kUndefinedMap, StaticReadOnlyRoot::kBooleanMap } },
        { { HEAP_NUMBER_TYPE, ODDBALL_TYPE }, { StaticReadOnlyRoot::kUndefinedMap, StaticReadOnlyRoot::kHeapNumberMap } },
        { { BIGINT_TYPE, HEAP_NUMBER_TYPE }, { StaticReadOnlyRoot::kHeapNumberMap, StaticReadOnlyRoot::kBigIntMap } },
        { { FIRST_SMALL_ORDERED_HASH_TABLE_TYPE, LAST_SMALL_ORDERED_HASH_TABLE_TYPE },
            { StaticReadOnlyRoot::kSmallOrderedHashMapMap, StaticReadOnlyRoot::kSmallOrderedNameDictionaryMap } },
        { { FIRST_ABSTRACT_INTERNAL_CLASS_TYPE, LAST_ABSTRACT_INTERNAL_CLASS_TYPE },
            { StaticReadOnlyRoot::kAbstractInternalClassSubclass1Map, StaticReadOnlyRoot::kAbstractInternalClassSubclass2Map } },
        { { FIRST_TURBOFAN_TYPE_TYPE, LAST_TURBOFAN_TYPE_TYPE },
            { StaticReadOnlyRoot::kTurbofanBitsetTypeMap, StaticReadOnlyRoot::kTurbofanOtherNumberConstantTypeMap } } } };

struct kUniqueMapRangeOfStringType {
    static constexpr TaggedAddressRange kSeqString = { InstanceTypeChecker::kStringMapLowerBound, StaticReadOnlyRoot::kInternalizedOneByteStringMap };
    static constexpr TaggedAddressRange kInternalizedString
        = { StaticReadOnlyRoot::kInternalizedTwoByteStringMap, StaticReadOnlyRoot::kUncachedExternalInternalizedOneByteStringMap };
    static constexpr TaggedAddressRange kExternalString
        = { StaticReadOnlyRoot::kExternalInternalizedTwoByteStringMap, StaticReadOnlyRoot::kSharedExternalOneByteStringMap };
    static constexpr TaggedAddressRange kUncachedExternalString
        = { StaticReadOnlyRoot::kUncachedExternalInternalizedTwoByteStringMap, StaticReadOnlyRoot::kSharedUncachedExternalOneByteStringMap };
    static constexpr TaggedAddressRange kConsString = { StaticReadOnlyRoot::kConsTwoByteStringMap, StaticReadOnlyRoot::kConsOneByteStringMap };
    static constexpr TaggedAddressRange kSlicedString = { StaticReadOnlyRoot::kSlicedTwoByteStringMap, StaticReadOnlyRoot::kSlicedOneByteStringMap };
    static constexpr TaggedAddressRange kThinString = { StaticReadOnlyRoot::kThinTwoByteStringMap, StaticReadOnlyRoot::kThinOneByteStringMap };
};
...
static constexpr int kStringMapEncodingMask = 1 << base::bits::CountTrailingZerosNonZero(Map::kSize);
static constexpr int kOneByteStringMapBit = StaticReadOnlyRoot::kSeqOneByteStringMap & kStringMapEncodingMask;
static constexpr int kTwoByteStringMapBit = StaticReadOnlyRoot::kSeqTwoByteStringMap & kStringMapEncodingMask;

inline constexpr std::optional<TaggedAddressRange> UniqueMapRangeOfInstanceTypeRange(InstanceType first, InstanceType last)
{
    ...
    for (size_t i = 0; i < kUniqueMapRangeOfInstanceTypeRangeList.size(); ++i) {
        if (kUniqueMapRangeOfInstanceTypeRangeList[i].first.first == first && kUniqueMapRangeOfInstanceTypeRangeList[i].first.second == last) {
...
constexpr bool kHasUniqueMapRangeOfInstanceTypeRange = UniqueMapRangeOfInstanceTypeRange(first, last).has_value();

template <InstanceType first, InstanceType last>
constexpr TaggedAddressRange kUniqueMapRangeOfInstanceTypeRange
    = kHasUniqueMapRangeOfInstanceTypeRange<first, last> ? *UniqueMapRangeOfInstanceTypeRange(first, last) : NULL_ADDRESS_RANGE;

inline constexpr std::optional<TaggedAddressRange> UniqueMapRangeOfInstanceType(InstanceType type)
{
    return UniqueMapRangeOfInstanceTypeRange(type, type);
}

template <InstanceType type> constexpr bool kHasUniqueMapRangeOfInstanceType = UniqueMapRangeOfInstanceType(type).has_value();

template <InstanceType type>
constexpr TaggedAddressRange kUniqueMapRangeOfInstanceType = kHasUniqueMapRangeOfInstanceType<type> ? *UniqueMapRangeOfInstanceType(type) : NULL_ADDRESS_RANGE;

inline bool MayHaveMapCheckFastCase(InstanceType type)
{
    if (UniqueMapOfInstanceType(type))
        return true;
...
{
    return V8HeapCompressionScheme::CompressObject(map.ptr()) == StaticReadOnlyRootsPointerTable[static_cast<size_t>(expected)];
}

inline bool CheckInstanceMapRange(TaggedAddressRange expected, Tagged<Map> map)
{
...
#define INSTANCE_TYPE_CHECKER2(type, forinstancetype_)                                                                                                         \
    ...
    {                                                                                                                                                          \
        constexpr InstanceType forinstancetype = static_cast<InstanceType>(forinstancetype_);                                                                  \
        if constexpr (kHasUniqueMapOfInstanceType<forinstancetype>) {                                                                                          \
            return CheckInstanceMap(kUniqueMapOfInstanceType<forinstancetype>, map_object);                                                                    \
        }                                                                                                                                                      \
        if constexpr (kHasUniqueMapRangeOfInstanceType<forinstancetype>) {                                                                                     \
            return CheckInstanceMapRange(kUniqueMapRangeOfInstanceType<forinstancetype>, map_object);                                                          \
        }                                                                                                                                                      \
...
template <InstanceType lower_limit, InstanceType upper_limit> struct InstanceRangeChecker {
    static constexpr bool Check(InstanceType value)
    {
        return base::IsInRange(value, lower_limit, upper_limit);
    }
};
template <InstanceType upper_limit> struct InstanceRangeChecker<FIRST_TYPE, upper_limit> {
    static constexpr bool Check(InstanceType value)
    {
...
template <InstanceType lower_limit> struct InstanceRangeChecker<lower_limit, LAST_TYPE> {
    static constexpr bool Check(InstanceType value)
    {
...
#define INSTANCE_TYPE_CHECKER_RANGE1(type, first_instance_type, last_instance_type)                                                                            \
    V8_INLINE constexpr bool Is##type(InstanceType instance_type)                                                                                              \
    {                                                                                                                                                          \
        return InstanceRangeChecker<first_instance_type, last_instance_type>::Check(instance_type);                                                            \
    }
...
#define INSTANCE_TYPE_CHECKER_RANGE2(type, first_instance_type, last_instance_type)                                                                            \
    V8_INLINE bool Is##type(Tagged<Map> map_object)                                                                                                            \
    {                                                                                                                                                          \
        if constexpr (kHasUniqueMapRangeOfInstanceTypeRange<first_instance_type, last_instance_type>) {                                                        \
            return CheckInstanceMapRange(kUniqueMapRangeOfInstanceTypeRange<first_instance_type, last_instance_type>, map_object);                             \
        }                                                                                                                                                      \
        return Is##type(map_object->instance_type());                                                                                                          \
    }
...
{
#if V8_STATIC_ROOTS_BOOL
    return CheckInstanceMapRange(kUniqueMapRangeOfStringType::kInternalizedString, map_object);
#else
...
{
    return (instance_type & (kIsNotStringMask | kStringRepresentationMask)) == kSeqStringTag;
}

V8_INLINE bool IsSeqString(Tagged<Map> map_object)
{
#if V8_STATIC_ROOTS_BOOL
    return CheckInstanceMapRange(kUniqueMapRangeOfStringType::kSeqString, map_object);
#else
...
{
    return (instance_type & (kIsNotStringMask | kStringRepresentationMask)) == kExternalStringTag;
}

V8_INLINE bool IsExternalString(Tagged<Map> map_object)
{
#if V8_STATIC_ROOTS_BOOL
    return CheckInstanceMapRange(kUniqueMapRangeOfStringType::kExternalString, map_object);
#else
...
{
    return (instance_type & (kIsNotStringMask | kUncachedExternalStringMask | kStringRepresentationMask)) == (kExternalStringTag | kUncachedExternalStringTag);
}

V8_INLINE bool IsUncachedExternalString(Tagged<Map> map_object)
{
#if V8_STATIC_ROOTS_BOOL
    return CheckInstanceMapRange(kUniqueMapRangeOfStringType::kUncachedExternalString, map_object);
#else
...
{
#if V8_STATIC_ROOTS_BOOL
    return CheckInstanceMapRange(kUniqueMapRangeOfStringType::kConsString, map_object);
#else
...
{
#if V8_STATIC_ROOTS_BOOL
    return CheckInstanceMapRange(kUniqueMapRangeOfStringType::kSlicedString, map_object);
#else
...
{
#if V8_STATIC_ROOTS_BOOL
    return CheckInstanceMapRange(kUniqueMapRangeOfStringType::kThinString, map_object);
#else
...
{
    return !IsString(instance_type) && !IsBigInt(instance_type) && instance_type != HEAP_NUMBER_TYPE;
}
...
V8_INLINE constexpr bool IsNativeContextSpecific(InstanceType instance_type)
{
    ...
    if (IsContext(instance_type))
        return true;
    // All non-JSReceivers are never tied to any native context.
    if (!IsJSReceiver(instance_type))
        return false;

    // Most of the JSReceivers are tied to some native context modulo the
    // following exceptions.
    if (instance_type == JS_MESSAGE_OBJECT_TYPE || instance_type == JS_EXTERNAL_OBJECT_TYPE) {
