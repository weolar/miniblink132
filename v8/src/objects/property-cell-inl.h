...
ACCESSORS(PropertyCell, dependent_code, Tagged<DependentCode>, kDependentCodeOffset)
ACCESSORS(PropertyCell, name, Tagged<Name>, kNameOffset)
ACCESSORS(PropertyCell, property_details_raw, Tagged<Smi>, kPropertyDetailsRawOffset)
RELEASE_ACQUIRE_ACCESSORS(PropertyCell, property_details_raw, Tagged<Smi>, kPropertyDetailsRawOffset)
...
void PropertyCell::UpdatePropertyDetailsExceptCellType(PropertyDetails details)
{
...
void PropertyCell::Transition(PropertyDetails new_details, DirectHandle<Object> new_value)
{
...
RELEASE_ACQUIRE_ACCESSORS(ContextSidePropertyCell, context_side_property_raw, Tagged<Smi>, kPropertyDetailsRawOffset)

ACCESSORS(ContextSidePropertyCell, dependent_code, Tagged<DependentCode>, kDependentCodeOffset)

ContextSidePropertyCell::Property ContextSidePropertyCell::context_side_property() const
{
