...
void AccessorPair::set(AccessorComponent component, Tagged<Object> value, ReleaseStoreTag tag)
{
    if (component == ACCESSOR_GETTER) {
...
bool AccessorPair::Equals(Tagged<Object> getter_value, Tagged<Object> setter_value)
{
