...
class JSArgumentsObject : public TorqueGeneratedJSArgumentsObject<JSArgumentsObject, JSObject> {
public:
...
class JSSloppyArgumentsObject : public TorqueGeneratedJSSloppyArgumentsObject<JSSloppyArgumentsObject, JSArgumentsObject> {
public:
...
class JSStrictArgumentsObject : public TorqueGeneratedJSStrictArgumentsObject<JSStrictArgumentsObject, JSArgumentsObject> {
public:
    // Indices of in-object properties.
    static const int kLengthIndex = 0;
...
class AliasedArgumentsEntry : public TorqueGeneratedAliasedArgumentsEntry<AliasedArgumentsEntry, Struct> {
public:
...
public:
    ...
    static constexpr RootIndex kMapRootIndex = RootIndex::kSloppyArgumentsElementsMap;
...
class SloppyArgumentsElements : public TaggedArrayBase<SloppyArgumentsElements, SloppyArgumentsElementsShape> {
public:
    ...
    inline void set_arguments(Tagged<UnionOf<FixedArray, NumberDictionary>> value, WriteBarrierMode mode = UPDATE_WRITE_BARRIER);

    // Returns: Smi|TheHole.
    inline Tagged<UnionOf<Smi, Hole>> mapped_entries(int index, RelaxedLoadTag) const;
    inline void set_mapped_entries(int index, Tagged<UnionOf<Smi, Hole>> value);
    inline void set_mapped_entries(int index, Tagged<UnionOf<Smi, Hole>> value, RelaxedStoreTag);
