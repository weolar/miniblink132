...
class JSFunctionOrBoundFunctionOrWrappedFunction
    : public TorqueGeneratedJSFunctionOrBoundFunctionOrWrappedFunction<JSFunctionOrBoundFunctionOrWrappedFunction, JSObject> {
public:
...
class JSBoundFunction : public TorqueGeneratedJSBoundFunction<JSBoundFunction, JSFunctionOrBoundFunctionOrWrappedFunction> {
public:
...
class JSWrappedFunction : public TorqueGeneratedJSWrappedFunction<JSWrappedFunction, JSFunctionOrBoundFunctionOrWrappedFunction> {
public:
    ...
    static MaybeHandle<Object> Create(Isolate* isolate, DirectHandle<NativeContext> creation_context, Handle<JSReceiver> value);
...
class JSFunction : public TorqueGeneratedJSFunction<JSFunction, JSFunctionOrBoundFunctionOrWrappedFunction> {
public:
    // [prototype_or_initial_map]:
    DECL_RELEASE_ACQUIRE_ACCESSORS(prototype_or_initial_map, Tagged<UnionOf<JSPrototype, Map, Hole>>)
    ...
    inline void UpdateContextSpecializedCode(Isolate* isolate, Tagged<Code> code, WriteBarrierMode mode = WriteBarrierMode::UPDATE_WRITE_BARRIER);
    inline void UpdateMaybeContextSpecializedCode(Isolate* isolate, Tagged<Code> code, WriteBarrierMode mode = WriteBarrierMode::UPDATE_WRITE_BARRIER);
    inline void UpdateCode(Tagged<Code> code, WriteBarrierMode mode = WriteBarrierMode::UPDATE_WRITE_BARRIER);
    ...
    inline Tagged<Object> raw_code(IsolateForSandbox isolate, AcquireLoadTag) const;
    ...
    template <typename IsolateT> inline Tagged<AbstractCode> abstract_code(IsolateT* isolate);
    ...
    inline void set_dispatch_handle(JSDispatchHandle handle, WriteBarrierMode mode = WriteBarrierMode::UPDATE_WRITE_BARRIER);
    // Updates the Code in this function's dispatch table entry.
    inline void UpdateDispatchEntry(Tagged<Code> new_code, WriteBarrierMode mode = WriteBarrierMode::UPDATE_WRITE_BARRIER);
    ...
    void MarkForOptimization(Isolate* isolate, CodeKind target_kind, ConcurrencyMode mode);
    ...
    void SetInterruptBudget(Isolate* isolate, std::optional<CodeKind> override_active_tier = {});
    ...
    V8_EXPORT_PRIVATE static void EnsureFeedbackVector(Isolate* isolate, DirectHandle<JSFunction> function, IsCompiledScope* compiled_scope);
    ...
    static void EnsureClosureFeedbackCellArray(DirectHandle<JSFunction> function, bool reset_budget_for_feedback_allocation);
    ...
    inline void ResetIfCodeFlushed(Isolate* isolate,
    ...
    inline bool ShouldFlushBaselineCode(base::EnumSet<CodeFlushMode> code_flush_mode);
    ...
    static void SetInitialMap(Isolate* isolate, DirectHandle<JSFunction> function, Handle<Map> map, Handle<JSPrototype> prototype);
    ...
    V8_EXPORT_PRIVATE static void EnsureHasInitialMap(Handle<JSFunction> function);

    // Creates a map that matches the constructor's initial map, but with
    // [[prototype]] being new.target.prototype. Because new.target can be a
    // JSProxy, this can call back into JavaScript.
    V8_EXPORT_PRIVATE static V8_WARN_UNUSED_RESULT MaybeHandle<Map> GetDerivedMap(
        Isolate* isolate, Handle<JSFunction> constructor, Handle<JSReceiver> new_target);
    ...
    static V8_WARN_UNUSED_RESULT MaybeHandle<Map> GetDerivedRabGsabDataViewMap(Isolate* isolate, Handle<JSReceiver> new_target);
    ...
    static void SetPrototype(DirectHandle<JSFunction> function, Handle<Object> value);
    ...
    {
        return function_has_prototype_slot ? JSFunction::kSizeWithPrototype : JSFunction::kSizeWithoutPrototype;
    }
    ...
    static V8_WARN_UNUSED_RESULT int CalculateExpectedNofProperties(Isolate* isolate, Handle<JSFunction> function);
    ...
    static V8_WARN_UNUSED_RESULT bool SetName(Handle<JSFunction> function, Handle<Name> name, DirectHandle<String> prefix);
