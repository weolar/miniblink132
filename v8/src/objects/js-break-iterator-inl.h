...
ACCESSORS(JSV8BreakIterator, break_iterator, Tagged<Managed<icu::BreakIterator>>, kBreakIteratorOffset)
ACCESSORS(JSV8BreakIterator, unicode_string, Tagged<Managed<icu::UnicodeString>>, kUnicodeStringOffset)
