...
class AccessorInfo : public TorqueGeneratedAccessorInfo<AccessorInfo, HeapObject> {
public:
    ...
    // Return number added.
    static int AppendUnique(Isolate* isolate, Handle<Object> descriptors, Handle<FixedArray> array, int valid_descriptors);
...
class AccessCheckInfo : public TorqueGeneratedAccessCheckInfo<AccessCheckInfo, Struct> {
public:
...
class InterceptorInfo : public TorqueGeneratedInterceptorInfo<InterceptorInfo, Struct> {
public:
