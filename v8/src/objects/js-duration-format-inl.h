...
ACCESSORS(JSDurationFormat, icu_locale, Tagged<Managed<icu::Locale>>, kIcuLocaleOffset)
...
#define IMPL_INLINE_DISPLAY_SETTER_GETTER(f, R) IMPL_INLINE_SETTER_GETTER(Display, f##_display, R##DisplayBit, display_flags, kAlways)

#define IMPL_INLINE_FIELD_STYLE3_SETTER_GETTER(f, R) IMPL_INLINE_SETTER_GETTER(FieldStyle, f##_style, R##StyleBits, style_flags, kStyle3Max)

#define IMPL_INLINE_FIELD_STYLE4_SETTER_GETTER(f, R) IMPL_INLINE_SETTER_GETTER(FieldStyle, f##_style, R##StyleBits, style_flags, kStyle4Max)

#define IMPL_INLINE_FIELD_STYLE5_SETTER_GETTER(f, R) IMPL_INLINE_SETTER_GETTER(FieldStyle, f##_style, R##StyleBits, style_flags, kStyle5Max)
...
IMPL_INLINE_SETTER_GETTER(Separator, separator, SeparatorBits, style_flags, kMax)
...
ACCESSORS(JSDurationFormat, icu_number_formatter, Tagged<Managed<icu::number::LocalizedNumberFormatter>>, kIcuNumberFormatterOffset)
} // namespace internal
} // namespace v8
