...
class JSCollection : public TorqueGeneratedJSCollection<JSCollection, JSObject> {
public:
...
class JSSetIterator : public OrderedHashTableIterator<JSSetIterator, OrderedHashSet> {
public:
    // Dispatched behavior.
...
class JSMapIterator : public OrderedHashTableIterator<JSMapIterator, OrderedHashMap> {
public:
    // Dispatched behavior.
...
class JSWeakCollection : public TorqueGeneratedJSWeakCollection<JSWeakCollection, JSObject> {
public:
    static void Initialize(DirectHandle<JSWeakCollection> collection, Isolate* isolate);
    V8_EXPORT_PRIVATE static void Set(DirectHandle<JSWeakCollection> collection, Handle<Object> key, DirectHandle<Object> value, int32_t hash);
    static bool Delete(DirectHandle<JSWeakCollection> collection, Handle<Object> key, int32_t hash);
    static Handle<JSArray> GetEntries(DirectHandle<JSWeakCollection> holder, int max_entries);
