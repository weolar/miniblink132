...
#define VERIFY_SHIFT(Type, type, TYPE, ctype)                                                                                                                  \
    static_assert(kTypedArrayAndRabGsabTypedArrayElementsKindShifts[ElementsKind::TYPE##_ELEMENTS - ElementsKind::FIRST_FIXED_TYPED_ARRAY_ELEMENTS_KIND]       \
            == ElementsKindToShiftSize(ElementsKind::TYPE##_ELEMENTS),                                                                                         \
        "Shift of ElementsKind::" #TYPE "_ELEMENTS does not match in static table");
TYPED_ARRAYS(VERIFY_SHIFT)
RAB_GSAB_TYPED_ARRAYS(VERIFY_SHIFT)
#undef VERIFY_SHIFT

#define VERIFY_SIZE(Type, type, TYPE, ctype)                                                                                                                   \
    static_assert(kTypedArrayAndRabGsabTypedArrayElementsKindSizes[ElementsKind::TYPE##_ELEMENTS - ElementsKind::FIRST_FIXED_TYPED_ARRAY_ELEMENTS_KIND]        \
            == ElementsKindToByteSize(ElementsKind::TYPE##_ELEMENTS),                                                                                          \
        "Size of ElementsKind::" #TYPE "_ELEMENTS does not match in static table");
...
bool UnionElementsKindUptoSize(ElementsKind* a_out, ElementsKind b)
{
    ...
    static_assert(HOLEY_SMI_ELEMENTS < PACKED_ELEMENTS, "ElementsKind union not computable via std::max.");
