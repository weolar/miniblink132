...
enum StringRepresentationTag { kSeqStringTag = 0x0, kConsStringTag = 0x1, kExternalStringTag = 0x2, kSlicedStringTag = 0x3, kThinStringTag = 0x5 };
...
constexpr uint32_t kStringRepresentationAndEncodingMask = kStringRepresentationMask | kStringEncodingMask;
...
constexpr uint32_t kExternalOneByteStringTag = kExternalStringTag | kOneByteStringTag;
constexpr uint32_t kExternalTwoByteStringTag = kExternalStringTag | kTwoByteStringTag;
...
constexpr uint32_t kStringRepresentationEncodingAndSharedMask = kStringRepresentationAndEncodingMask | kSharedStringMask;
...
enum InstanceType : uint16_t {
    // String types.
    INTERNALIZED_TWO_BYTE_STRING_TYPE = kTwoByteStringTag | kSeqStringTag | kInternalizedTag,
    INTERNALIZED_ONE_BYTE_STRING_TYPE = kOneByteStringTag | kSeqStringTag | kInternalizedTag,
    EXTERNAL_INTERNALIZED_TWO_BYTE_STRING_TYPE = kTwoByteStringTag | kExternalStringTag | kInternalizedTag,
    EXTERNAL_INTERNALIZED_ONE_BYTE_STRING_TYPE = kOneByteStringTag | kExternalStringTag | kInternalizedTag,
    UNCACHED_EXTERNAL_INTERNALIZED_TWO_BYTE_STRING_TYPE = EXTERNAL_INTERNALIZED_TWO_BYTE_STRING_TYPE | kUncachedExternalStringTag | kInternalizedTag,
    UNCACHED_EXTERNAL_INTERNALIZED_ONE_BYTE_STRING_TYPE = EXTERNAL_INTERNALIZED_ONE_BYTE_STRING_TYPE | kUncachedExternalStringTag | kInternalizedTag,
    SEQ_TWO_BYTE_STRING_TYPE = INTERNALIZED_TWO_BYTE_STRING_TYPE | kNotInternalizedTag,
    SEQ_ONE_BYTE_STRING_TYPE = INTERNALIZED_ONE_BYTE_STRING_TYPE | kNotInternalizedTag,
    CONS_TWO_BYTE_STRING_TYPE = kTwoByteStringTag | kConsStringTag | kNotInternalizedTag,
    CONS_ONE_BYTE_STRING_TYPE = kOneByteStringTag | kConsStringTag | kNotInternalizedTag,
    SLICED_TWO_BYTE_STRING_TYPE = kTwoByteStringTag | kSlicedStringTag | kNotInternalizedTag,
    SLICED_ONE_BYTE_STRING_TYPE = kOneByteStringTag | kSlicedStringTag | kNotInternalizedTag,
    EXTERNAL_TWO_BYTE_STRING_TYPE = EXTERNAL_INTERNALIZED_TWO_BYTE_STRING_TYPE | kNotInternalizedTag,
    EXTERNAL_ONE_BYTE_STRING_TYPE = EXTERNAL_INTERNALIZED_ONE_BYTE_STRING_TYPE | kNotInternalizedTag,
    UNCACHED_EXTERNAL_TWO_BYTE_STRING_TYPE = UNCACHED_EXTERNAL_INTERNALIZED_TWO_BYTE_STRING_TYPE | kNotInternalizedTag,
    UNCACHED_EXTERNAL_ONE_BYTE_STRING_TYPE = UNCACHED_EXTERNAL_INTERNALIZED_ONE_BYTE_STRING_TYPE | kNotInternalizedTag,
    THIN_TWO_BYTE_STRING_TYPE = kTwoByteStringTag | kThinStringTag | kNotInternalizedTag,
    ...
    SHARED_EXTERNAL_TWO_BYTE_STRING_TYPE = EXTERNAL_TWO_BYTE_STRING_TYPE | kSharedStringTag,
    SHARED_EXTERNAL_ONE_BYTE_STRING_TYPE = EXTERNAL_ONE_BYTE_STRING_TYPE | kSharedStringTag,
    SHARED_UNCACHED_EXTERNAL_TWO_BYTE_STRING_TYPE = UNCACHED_EXTERNAL_TWO_BYTE_STRING_TYPE | kSharedStringTag,
    SHARED_UNCACHED_EXTERNAL_ONE_BYTE_STRING_TYPE = UNCACHED_EXTERNAL_ONE_BYTE_STRING_TYPE | kSharedStringTag,
...
#define CHECK_STRING_RANGE(TYPE, ...) static_assert(TYPE < FIRST_NONSTRING_TYPE);
...
static_assert(JS_CLASS_CONSTRUCTOR_TYPE < FIRST_CALLABLE_JS_FUNCTION_TYPE || JS_CLASS_CONSTRUCTOR_TYPE > LAST_CALLABLE_JS_FUNCTION_TYPE,
...
#define CHECK_INSTANCE_TYPE(TYPE)                                                                                                                              \
    static_assert((TYPE >= FIRST_JS_RECEIVER_TYPE && TYPE <= LAST_SPECIAL_RECEIVER_TYPE)                                                                       \
        == (IF_WASM(EXPAND, TYPE == WASM_STRUCT_TYPE || TYPE == WASM_ARRAY_TYPE ||) TYPE == JS_PROXY_TYPE || TYPE == JS_GLOBAL_OBJECT_TYPE                     \
            || TYPE == JS_GLOBAL_PROXY_TYPE || TYPE == JS_MODULE_NAMESPACE_TYPE || TYPE == JS_SPECIAL_API_OBJECT_TYPE));                                       \
    static_assert((TYPE >= FIRST_JS_RECEIVER_TYPE && TYPE <= LAST_CUSTOM_ELEMENTS_RECEIVER)                                                                    \
        == (IF_WASM(EXPAND, TYPE == WASM_STRUCT_TYPE || TYPE == WASM_ARRAY_TYPE ||) TYPE == JS_PROXY_TYPE || TYPE == JS_GLOBAL_OBJECT_TYPE                     \
            || TYPE == JS_GLOBAL_PROXY_TYPE || TYPE == JS_MODULE_NAMESPACE_TYPE || TYPE == JS_SPECIAL_API_OBJECT_TYPE || TYPE == JS_PRIMITIVE_WRAPPER_TYPE));
// clang-format on
...
#define UNIQUE_LEAF_INSTANCE_TYPE_MAP_LIST_GENERATOR(V, _)                                                                                                     \
    ...
    V(_, ArrayBoilerplateDescriptionMap, array_boilerplate_description_map, ArrayBoilerplateDescription)                                                       \
    ...
    V(_, SmallOrderedHashSetMap, small_ordered_hash_set_map, SmallOrderedHashSet)                                                                              \
    V(_, SmallOrderedHashMapMap, small_ordered_hash_map_map, SmallOrderedHashMap)                                                                              \
    V(_, SmallOrderedNameDictionaryMap, small_ordered_name_dictionary_map, SmallOrderedNameDictionary)                                                         \
...
#define UNIQUE_INSTANCE_TYPE_MAP_LIST_GENERATOR(V, _)                                                                                                          \
    ...
    V(_, OrderedNameDictionaryMap, ordered_name_dictionary_map, OrderedNameDictionary)                                                                         \
    ...
    V(_, GlobalContextSidePropertyCellMap, global_context_side_property_cell_map, ContextSidePropertyCell)                                                     \
...
static constexpr InstanceType PROPERTY_DICTIONARY_TYPE = SWISS_NAME_DICTIONARY_TYPE;
#else
