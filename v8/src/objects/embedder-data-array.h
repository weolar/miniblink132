...
class EmbedderDataArray : public TorqueGeneratedEmbedderDataArray<EmbedderDataArray, HeapObject> {
public:
    ...
    static Handle<EmbedderDataArray> EnsureCapacity(Isolate* isolate, Handle<EmbedderDataArray> array, int index);
