...
ACCESSORS(JSDisplayNames, internal, Tagged<Managed<DisplayNamesInternal>>, kInternalOffset)
...
inline void JSDisplayNames::set_language_display(LanguageDisplay language_display)
{
    DCHECK(LanguageDisplayBit::is_valid(language_display));
    set_flags(LanguageDisplayBit::update(flags(), language_display));
}

inline JSDisplayNames::LanguageDisplay JSDisplayNames::language_display() const
{
