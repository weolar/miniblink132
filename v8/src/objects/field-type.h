...
public:
    ...
    V8_EXPORT_PRIVATE static Handle<FieldType> Class(DirectHandle<Map> map, Isolate* isolate);
    ...
    V8_EXPORT_PRIVATE static bool Equals(Tagged<FieldType> type, Tagged<FieldType> other);
    V8_EXPORT_PRIVATE static void PrintTo(Tagged<FieldType> type, std::ostream& os);
};

bool IsClass(Tagged<FieldType> obj);
inline bool IsNone(Tagged<FieldType> obj)
{
    return obj == FieldType::None();
}
inline bool IsAny(Tagged<FieldType> obj)
{
    return obj == FieldType::Any();
}
