...
class JSNumberFormat : public TorqueGeneratedJSNumberFormat<JSNumberFormat, JSObject> {
public:
    ...
    V8_WARN_UNUSED_RESULT static MaybeHandle<JSNumberFormat> UnwrapNumberFormat(Isolate* isolate, Handle<JSReceiver> format_holder);

    // #sec-number-format-functions
    V8_WARN_UNUSED_RESULT static MaybeHandle<String> NumberFormatFunction(
        Isolate* isolate, DirectHandle<JSNumberFormat> number_format, Handle<Object> numeric_obj);

    // ecma402/#sec-intl.numberformat.prototype.resolvedoptions
    static Handle<JSObject> ResolvedOptions(Isolate* isolate, DirectHandle<JSNumberFormat> number_format);

    V8_WARN_UNUSED_RESULT static MaybeHandle<JSArray> FormatToParts(Isolate* isolate, DirectHandle<JSNumberFormat> number_format, Handle<Object> numeric_obj);

    // ecma402/#sec-formatnumericrange
    V8_WARN_UNUSED_RESULT static MaybeHandle<String> FormatNumericRange(
        Isolate* isolate, DirectHandle<JSNumberFormat> number_format, Handle<Object> x, Handle<Object> y);
    ...
    V8_WARN_UNUSED_RESULT static MaybeHandle<String> FormatNumeric(
        Isolate* isolate, const icu::number::LocalizedNumberFormatter& number_format, Handle<Object> numeric_obj);
    ...
    static Handle<String> RoundingModeString(Isolate* isolate, const icu::UnicodeString& skeleton);
    static Handle<String> RoundingPriorityString(Isolate* isolate, const icu::UnicodeString& skeleton);
    static Handle<String> TrailingZeroDisplayString(Isolate* isolate, const icu::UnicodeString& skeleton);
    static Handle<Object> RoundingIncrement(Isolate* isolate, const icu::UnicodeString& skeleton);
    ...
    V8_WARN_UNUSED_RESULT static Maybe<icu::number::LocalizedNumberRangeFormatter> GetRangeFormatter(
...
public:
    ...
    V8_EXPORT_PRIVATE static Maybe<IntlMathematicalValue> From(Isolate* isolate, Handle<Object> value);
    ...
    static Maybe<icu::number::FormattedNumberRange> FormatRange(Isolate* isolate, const icu::number::LocalizedNumberRangeFormatter& number_range_format,
