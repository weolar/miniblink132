...
public:
    ...
    bool operator==(const DeoptimizationLiteral& other) const
    {
        ...
        case DeoptimizationLiteralKind::kNumber:
            return base::bit_cast<uint64_t>(number_) == base::bit_cast<uint64_t>(other.number_);
...
public:
    ...
    static constexpr int kCompressedDataOffset = kUncompressedSizeOffset + kUncompressedSizeSize;
    static constexpr int kDeoptimizationFrameTranslationElementSize = kInt32Size;
#endif // V8_USE_ZLIB

#ifdef ENABLE_DISASSEMBLER
    void PrintFrameTranslation(std::ostream& os, int index, Tagged<ProtectedDeoptimizationLiteralArray> protected_literal_array,
...
class DeoptimizationFrameTranslation::Iterator : public DeoptTranslationIterator {
public:
...
public:
    using SharedFunctionInfoWrapperOrSmi = UnionOf<Smi, SharedFunctionInfoWrapper>;
...
#define DECL_ELEMENT_ACCESSORS(name, type)                                                                                                                     \
    ...
    DECL_ELEMENT_ACCESSORS(FrameTranslation, Tagged<DeoptimizationFrameTranslation>)
    DECL_ELEMENT_ACCESSORS(InlinedFunctionCount, Tagged<Smi>)
    DECL_ELEMENT_ACCESSORS(ProtectedLiteralArray, Tagged<ProtectedDeoptimizationLiteralArray>)
    ...
    DECL_ELEMENT_ACCESSORS(WrappedSharedFunctionInfo, Tagged<SharedFunctionInfoWrapperOrSmi>)
    DECL_ELEMENT_ACCESSORS(InliningPositions, Tagged<TrustedPodArray<InliningPosition>>)
