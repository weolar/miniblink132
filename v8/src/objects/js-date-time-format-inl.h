...
ACCESSORS(JSDateTimeFormat, icu_locale, Tagged<Managed<icu::Locale>>, kIcuLocaleOffset)
ACCESSORS(JSDateTimeFormat, icu_simple_date_format, Tagged<Managed<icu::SimpleDateFormat>>, kIcuSimpleDateFormatOffset)
ACCESSORS(JSDateTimeFormat, icu_date_interval_format, Tagged<Managed<icu::DateIntervalFormat>>, kIcuDateIntervalFormatOffset)
...
inline void JSDateTimeFormat::set_date_style(JSDateTimeFormat::DateTimeStyle date_style)
{
    int hints = flags();
...
inline void JSDateTimeFormat::set_time_style(JSDateTimeFormat::DateTimeStyle time_style)
{
    int hints = flags();
