...
void RegExpMatchInfo::set_last_subject(Tagged<String> value, WriteBarrierMode mode)
{
...
void RegExpMatchInfo::set_last_input(Tagged<Object> value, WriteBarrierMode mode)
{
    last_input_.store(this, value, mode);
}

int RegExpMatchInfo::capture(int index) const
{
