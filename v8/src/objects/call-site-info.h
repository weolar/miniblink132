...
public:
    ...
    static MaybeHandle<Script> GetScript(Isolate* isolate, DirectHandle<CallSiteInfo> info);
    ...
    V8_EXPORT_PRIVATE static Handle<PrimitiveHeapObject> GetFunctionName(DirectHandle<CallSiteInfo> info);
