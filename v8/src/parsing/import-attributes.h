...
class ImportAttributes : public ZoneMap<const AstRawString*, std::pair<const AstRawString*, Scanner::Location>, ImportAttributesKeyComparer> {
public:
    explicit ImportAttributes(Zone* zone)
        : ZoneMap<const AstRawString*, std::pair<const AstRawString*, Scanner::Location>, ImportAttributesKeyComparer>(zone)
    {
    }
};
