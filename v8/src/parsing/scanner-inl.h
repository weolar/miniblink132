...
// string.
template <int N> constexpr bool IsInString(const char (&s)[N], char c, size_t i = 0)
{
...
{
    if (!IsWhiteSpaceOrLineTerminator(c0_))
        return Token::kIllegal;
    ...
    do {
        ...
        if (V8_LIKELY(static_cast<unsigned>(c0_) <= kMaxAscii)) {
            ...
            case Token::kLessThan:
                ...
                if (c0_ == '<')
                    return Select('=', Token::kAssignShl, Token::kShl);
                if (c0_ == '!') {
            ...
            case Token::kGreaterThan:
                ...
                if (c0_ == '>') {
                    ...
                    if (c0_ == '>')
                        return Select('=', Token::kAssignShr, Token::kShr);
                    return Token::kSar;
                }
            ...
            case Token::kAssign:
                ...
                Advance();
                if (c0_ == '=')
                    return Select('=', Token::kEqStrict, Token::kEq);
                if (c0_ == '>')
            ...
            case Token::kMul:
                ...
                Advance();
                if (c0_ == '*')
                    return Select('=', Token::kAssignExp, Token::kExp);
                if (c0_ == '=')
            ...
            case Token::kBitAnd:
                ...
                Advance();
                if (c0_ == '&')
                    return Select('=', Token::kAssignAnd, Token::kAnd);
                if (c0_ == '=')
            ...
            case Token::kBitOr:
                ...
                Advance();
                if (c0_ == '|')
                    return Select('=', Token::kAssignOr, Token::kOr);
                if (c0_ == '=')
