...
std::vector<char> ReadCharsFromFile(FILE* file, bool* exists, bool verbose, const char* filename)
{
...
std::vector<char> ReadCharsFromFile(const char* filename, bool* exists, bool verbose)
{
