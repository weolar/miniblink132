...
public:
    ...
    public:
        ...
        bool operator==(const Iterator& other) const
        {
            ...
            DCHECK_IMPLIES(current_index_ == other.current_index_, ptr_ == other.ptr_);
    ...
    void Clear()
    {
        std::fill_n(data_begin_, data_length(), 0);
    }
    ...
    {
        return Iterator(this, Iterator::kStartTag);
    }
...
private:
    union DataStorage {
        ...
        explicit DataStorage(uintptr_t value)
            : inline_(value)
        {
        }
    };
    ...
    {
        return data_begin_ == &data_.inline_;
    }
...
public:
    ...
    {
        if (V8_UNLIKELY(!InBitsRange(value)))
            Grow(value, zone);
        bits_.Add(value);
    }
...
private:
    ...
    V8_NOINLINE void Grow(int needed_value, Zone* zone)
    {
        ...
        int new_length = std::max(kInitialLength, static_cast<int>(base::bits::RoundUpToPowerOfTwo32(static_cast<uint32_t>(needed_value + 1))));
