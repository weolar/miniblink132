...
class PointerToIndexHashMap : public base::TemplateHashMapImpl<uintptr_t, uint32_t, base::KeyEqualityMatcher<intptr_t>, base::DefaultAllocationPolicy> {
public:
...
template <> inline uintptr_t PointerToIndexHashMap<Address>::Key(Address value)
{
    return static_cast<uintptr_t>(value);
}

template <> inline uintptr_t PointerToIndexHashMap<Tagged<HeapObject>>::Key(Tagged<HeapObject> value)
{
    return value.ptr();
}

class AddressToIndexHashMap : public PointerToIndexHashMap<Address> { };
class HeapObjectToIndexHashMap : public PointerToIndexHashMap<Tagged<HeapObject>> { };
