...
enum ImportExportKindCode : uint8_t { kExternalFunction = 0, kExternalTable = 1, kExternalMemory = 2, kExternalGlobal = 3, kExternalTag = 4 };
...
static_assert(static_cast<uint32_t>(Internals::SmiValue(Internals::IntToSmi(static_cast<int>(kInvalidCanonicalIndex)))) == kInvalidCanonicalIndex);
