...
constexpr DoubleRegister kFpParamRegisters[] = { xmm1, xmm2, xmm3, xmm4, xmm5, xmm6 };
...
constexpr Register kGpParamRegisters[] = { a7, a0, a2, a3, a4, a5, a6 };
constexpr Register kGpReturnRegisters[] = { a0, a1 };
constexpr DoubleRegister kFpParamRegisters[] = { fa0, fa1, fa2, fa3, fa4, fa5, fa6, fa7 };
...
static_assert(kWasmImplicitArgRegister == kGpParamRegisters[kWasmInstanceDataParameterIndex]);
...
public:
    ...
    {
        int num_slots = AlignedSlotAllocator::NumSlotsForWidth(ElementSizeInBytes(type));
    ...
    {
        return slot_allocator_.Size();
    }

    void EndSlotArea()
    {
        slot_allocator_.AllocateUnaligned(0);
    }
...
public:
    ...
    constexpr LinkageLocationAllocator(const Register (&gp)[kNumGpRegs], const DoubleRegister (&fp)[kNumFpRegs], int slot_offset)
        : allocator_(LinkageAllocator(gp, fp))
