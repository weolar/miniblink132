...
public:
    StringBuilder()
        : on_growth_(kReplacePreviousChunk)
    {
    }
    ...
    size_t length() const
    {
        return static_cast<size_t>(cursor_ - start_);
    }
...
protected:
    ...
    explicit StringBuilder(OnGrowth on_growth)
        : on_growth_(on_growth)
    {
    }
    void start_here()
    {
