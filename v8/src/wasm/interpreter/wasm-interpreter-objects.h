...
public:
    static inline Tagged<WasmInstanceObject> get_wasm_instance(Tagged<Tuple2> interpreter_object);
    static inline void set_wasm_instance(Tagged<Tuple2> interpreter_object, Tagged<WasmInstanceObject> wasm_instance);

    static inline Tagged<Object> get_interpreter_handle(Tagged<Tuple2> interpreter_object);
    static inline void set_interpreter_handle(Tagged<Tuple2> interpreter_object, Tagged<Object> interpreter_handle);
    ...
    static bool RunInterpreter(Isolate* isolate, Address frame_pointer, Handle<WasmInstanceObject> instance, int func_index,
        const std::vector<wasm::WasmValue>& argument_values, std::vector<wasm::WasmValue>& return_values);
    static bool RunInterpreter(Isolate* isolate, Address frame_pointer, Handle<WasmInstanceObject> instance, int func_index, uint8_t* interpreter_sp);
