...
{
    return cache_state_.stack_state.empty() ? StaticStackFrameSize() : cache_state_.stack_state.back().offset();
}
...
void LiftoffAssembler::LoadFixedArrayLengthAsInt32(LiftoffRegister dst, Register array, LiftoffRegList pinned)
{
    int offset = offsetof(FixedArray, length_) - kHeapObjectTag;
    LoadSmiAsInt32(dst, array, offset);
}

void LiftoffAssembler::LoadSmiAsInt32(LiftoffRegister dst, Register src_addr, int32_t offset)
{
...
void LiftoffAssembler::LoadCodePointer(Register dst, Register src_addr, int32_t offset_imm)
{
    if constexpr (V8_ENABLE_WASM_CODE_POINTER_TABLE_BOOL) {
        return Load(LiftoffRegister(dst), src_addr, no_reg, offset_imm, LoadType::kI32Load);
    } else {
        return LoadFullPointer(dst, src_addr, offset_imm);
    }
}

void LiftoffAssembler::emit_ptrsize_add(Register dst, Register lhs, Register rhs)
{
    if constexpr (kSystemPointerSize == 8) {
        emit_i64_add(LiftoffRegister(dst), LiftoffRegister(lhs), LiftoffRegister(rhs));
    } else {
        emit_i32_add(dst, lhs, rhs);
    }
}

void LiftoffAssembler::emit_ptrsize_sub(Register dst, Register lhs, Register rhs)
{
    if constexpr (kSystemPointerSize == 8) {
        emit_i64_sub(LiftoffRegister(dst), LiftoffRegister(lhs), LiftoffRegister(rhs));
    } else {
        emit_i32_sub(dst, lhs, rhs);
    }
}

void LiftoffAssembler::emit_ptrsize_and(Register dst, Register lhs, Register rhs)
{
    if constexpr (kSystemPointerSize == 8) {
        emit_i64_and(LiftoffRegister(dst), LiftoffRegister(lhs), LiftoffRegister(rhs));
    } else {
        emit_i32_and(dst, lhs, rhs);
    }
}

void LiftoffAssembler::emit_ptrsize_shri(Register dst, Register src, int amount)
{
    if constexpr (kSystemPointerSize == 8) {
...
void LiftoffAssembler::emit_ptrsize_addi(Register dst, Register lhs, intptr_t imm)
{
    if constexpr (kSystemPointerSize == 8) {
...
void LiftoffAssembler::emit_ptrsize_muli(Register dst, Register lhs, int32_t imm)
{
    if constexpr (kSystemPointerSize == 8) {
...
void LiftoffAssembler::emit_ptrsize_set_cond(Condition condition, Register dst, LiftoffRegister lhs, LiftoffRegister rhs)
{
    if constexpr (kSystemPointerSize == 8) {
...
void LiftoffAssembler::bailout(LiftoffBailoutReason reason, const char* detail)
{
    DCHECK_NE(kSuccess, reason);
    if (bailout_reason_ != kSuccess)
        return;
    AbortCompilation();
...
void EmitI64IndependentHalfOperation(LiftoffAssembler* assm, LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs)
{
...
void EmitI64IndependentHalfOperationImm(LiftoffAssembler* assm, LiftoffRegister dst, LiftoffRegister lhs, int64_t imm)
{
...
{
    liftoff::EmitI64IndependentHalfOperation<&LiftoffAssembler::emit_i32_and>(this, dst, lhs, rhs);
}

void LiftoffAssembler::emit_i64_andi(LiftoffRegister dst, LiftoffRegister lhs, int32_t imm)
{
    liftoff::EmitI64IndependentHalfOperationImm<&LiftoffAssembler::emit_i32_andi>(this, dst, lhs, imm);
}

void LiftoffAssembler::emit_i64_or(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs)
{
    liftoff::EmitI64IndependentHalfOperation<&LiftoffAssembler::emit_i32_or>(this, dst, lhs, rhs);
}

void LiftoffAssembler::emit_i64_ori(LiftoffRegister dst, LiftoffRegister lhs, int32_t imm)
{
    liftoff::EmitI64IndependentHalfOperationImm<&LiftoffAssembler::emit_i32_ori>(this, dst, lhs, imm);
}

void LiftoffAssembler::emit_i64_xor(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs)
{
    liftoff::EmitI64IndependentHalfOperation<&LiftoffAssembler::emit_i32_xor>(this, dst, lhs, rhs);
}

void LiftoffAssembler::emit_i64_xori(LiftoffRegister dst, LiftoffRegister lhs, int32_t imm)
{
    liftoff::EmitI64IndependentHalfOperationImm<&LiftoffAssembler::emit_i32_xori>(this, dst, lhs, imm);
}
