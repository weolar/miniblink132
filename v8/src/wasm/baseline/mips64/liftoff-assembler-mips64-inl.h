...
template <typename T>
inline MemOperand GetMemOp(LiftoffAssembler* assm, Register addr, Register offset, T offset_imm, bool i64_offset = false, unsigned shift_amount = 0)
{
    if (offset != no_reg) {
        if (!i64_offset) {
...
inline void Store(LiftoffAssembler* assm, MemOperand dst, LiftoffRegister src, ValueKind kind)
{
    switch (kind) {
    case kI16:
...
inline void ChangeEndiannessLoad(LiftoffAssembler* assm, LiftoffRegister dst, LoadType type, LiftoffRegList pinned)
{
    bool is_float = false;
...
inline void ChangeEndiannessStore(LiftoffAssembler* assm, LiftoffRegister src, StoreType type, LiftoffRegList pinned)
{
    bool is_float = false;
...
void LiftoffAssembler::LoadTaggedPointerFromInstance(Register dst, Register instance, int32_t offset)
{
    ...
    Register dst, Register src_addr, Register offset_reg, int32_t offset_imm, uint32_t* protected_load_pc, bool needs_shift)
{
    ...
    MemOperand src_op = liftoff::GetMemOp(this, src_addr, offset_reg, offset_imm, false, shift_amount);
    Ld(dst, src_op);
    ...
    uint32_t* protected_store_pc, SkipWriteBarrier skip_write_barrier)
{
    ...
    Label exit;
    CheckPageFlag(dst_addr, scratch, MemoryChunk::kPointersFromHereAreInterestingMask, kZero, &exit);
    JumpIfSmi(src, &exit);
    CheckPageFlag(src, scratch, MemoryChunk::kPointersToHereAreInterestingMask, eq, &exit);
    ...
    bool is_load_mem, bool i64_offset, bool needs_shift)
{
    ...
    MemOperand src_op = liftoff::GetMemOp(this, src_addr, offset_reg, offset_imm, i64_offset, shift_amount);
...
void LiftoffAssembler::emit_i32_divs(Register dst, Register lhs, Register rhs, Label* trap_div_by_zero, Label* trap_div_unrepresentable)
{
    ...
    MacroAssembler::Branch(trap_div_unrepresentable, eq, kScratchReg2, Operand(zero_reg));
...
#define I32_BINOP(name, instruction)                                                                                                                           \
    void LiftoffAssembler::emit_i32_##name(Register dst, Register lhs, Register rhs)                                                                           \
    {                                                                                                                                                          \
...
#define I32_BINOP_I(name, instruction)                                                                                                                         \
    void LiftoffAssembler::emit_i32_##name##i(Register dst, Register lhs, int32_t imm)                                                                         \
    {                                                                                                                                                          \
...
#define I32_SHIFTOP(name, instruction)                                                                                                                         \
    void LiftoffAssembler::emit_i32_##name(Register dst, Register src, Register amount)                                                                        \
    {                                                                                                                                                          \
        instruction(dst, src, amount);                                                                                                                         \
    }
#define I32_SHIFTOP_I(name, instruction)                                                                                                                       \
    I32_SHIFTOP(name, instruction##v)                                                                                                                          \
    void LiftoffAssembler::emit_i32_##name##i(Register dst, Register src, int amount)                                                                          \
    {                                                                                                                                                          \
...
#define I64_BINOP(name, instruction)                                                                                                                           \
    void LiftoffAssembler::emit_i64_##name(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs)                                                      \
    {                                                                                                                                                          \
...
#define I64_BINOP_I(name, instruction)                                                                                                                         \
    void LiftoffAssembler::emit_i64_##name##i(LiftoffRegister dst, LiftoffRegister lhs, int32_t imm)                                                           \
    {                                                                                                                                                          \
...
#define I64_SHIFTOP(name, instruction)                                                                                                                         \
    void LiftoffAssembler::emit_i64_##name(LiftoffRegister dst, LiftoffRegister src, Register amount)                                                          \
    {                                                                                                                                                          \
        instruction(dst.gp(), src.gp(), amount);                                                                                                               \
    }
#define I64_SHIFTOP_I(name, instruction)                                                                                                                       \
    I64_SHIFTOP(name, instruction##v)                                                                                                                          \
    void LiftoffAssembler::emit_i64_##name##i(LiftoffRegister dst, LiftoffRegister src, int amount)                                                            \
    {                                                                                                                                                          \
        amount &= 63;                                                                                                                                          \
        if (amount < 32)                                                                                                                                       \
            instruction(dst.gp(), src.gp(), amount);                                                                                                           \
...
#define FP_BINOP(name, instruction)                                                                                                                            \
    void LiftoffAssembler::emit_##name(DoubleRegister dst, DoubleRegister lhs, DoubleRegister rhs)                                                             \
    {                                                                                                                                                          \
        instruction(dst, lhs, rhs);                                                                                                                            \
    }
...
bool LiftoffAssembler::emit_type_conversion(WasmOpcode opcode, LiftoffRegister dst, LiftoffRegister src, Label* trap)
{
    ...
    case kExprI32SConvertF32: {
        ...
        LiftoffRegister converted_back = GetUnusedRegister(kFpReg, LiftoffRegList { src, rounded });
...
{
    Label all_false;
    assm->BranchMSA(&all_false, MSA_BRANCH_V, all_zero, src.fp().toW(), USE_DELAY_SLOT);
    assm->li(dst.gp(), 0l);
    assm->li(dst.gp(), 1);
    assm->bind(&all_false);
}

inline void EmitAllTrue(LiftoffAssembler* assm, LiftoffRegister dst, LiftoffRegister src, MSABranchDF msa_branch_df)
{
    Label all_true;
    assm->BranchMSA(&all_true, msa_branch_df, all_not_zero, src.fp().toW(), USE_DELAY_SLOT);
    assm->li(dst.gp(), 1);
    assm->li(dst.gp(), 0l);
    assm->bind(&all_true);
}
...
{
    MemOperand src_op = liftoff::GetMemOp(this, addr, offset_reg, offset_imm, i64_offset);
    *protected_load_pc = pc_offset();
...
{
    MemOperand dst_op = liftoff::GetMemOp(this, dst, offset, offset_imm, i64_offset);
    if (protected_store_pc)
...
#define SIMD_BINOP(name1, name2, type)                                                                                                                         \
    void LiftoffAssembler::emit_##name1##_extmul_low_##name2(LiftoffRegister dst, LiftoffRegister src1, LiftoffRegister src2)                                  \
    {                                                                                                                                                          \
        MacroAssembler::ExtMulLow(type, dst.fp().toW(), src1.fp().toW(), src2.fp().toW());                                                                     \
    }                                                                                                                                                          \
    void LiftoffAssembler::emit_##name1##_extmul_high_##name2(LiftoffRegister dst, LiftoffRegister src1, LiftoffRegister src2)                                 \
    {                                                                                                                                                          \
        MacroAssembler::ExtMulHigh(type, dst.fp().toW(), src1.fp().toW(), src2.fp().toW());                                                                    \
    }
...
#define SIMD_BINOP(name1, name2, type)                                                                                                                         \
    void LiftoffAssembler::emit_##name1##_extadd_pairwise_##name2(LiftoffRegister dst, LiftoffRegister src)                                                    \
    {                                                                                                                                                          \
...
void LiftoffAssembler::emit_set_if_nan(Register dst, FPURegister src, ValueKind kind)
{
    UseScratchRegisterScope temps(this);
    Register scratch = temps.Acquire();
    Label not_nan;
...
void LiftoffAssembler::emit_s128_set_if_nan(Register dst, LiftoffRegister src, Register tmp_gp, LiftoffRegister tmp_s128, ValueKind lane_kind)
{
    ...
    BranchMSA(&not_nan, MSA_BRANCH_V, all_zero, tmp_s128.fp().toW(), USE_DELAY_SLOT);
    li(tmp_gp, 1);
