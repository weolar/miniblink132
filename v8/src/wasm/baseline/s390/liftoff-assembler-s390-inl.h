...
inline void StoreToMemory(LiftoffAssembler* assm, MemOperand dst, const LiftoffAssembler::VarState& src, Register scratch)
{
    if (src.is_reg()) {
        switch (src.kind()) {
        case kI16:
...
void LiftoffAssembler::PrepareTailCall(int num_callee_stack_params, int stack_param_delta)
{
    ...
    for (int i = slot_count - 1; i >= 0; --i) {
        ...
        StoreU64(scratch, MemOperand(fp, (i - stack_param_delta) * kSystemPointerSize));
    }
...
void LiftoffAssembler::PatchPrepareStackFrame(int offset, SafepointTableBuilder* safepoint_table_builder, bool feedback_vector_slot, size_t stack_param_slots)
{
    ...
    Assembler patching_assembler(AssemblerOptions {}, ExternalAssemblerBuffer(buffer_start_ + offset, LayInstrSize + kGap));
...
{
    MemOperand dst_op = MemOperand(dst_addr, offset_reg == no_reg ? r0 : offset_reg, offset_imm);
    ...
    Label exit;
    CheckPageFlag(dst_addr, r1, MemoryChunk::kPointersFromHereAreInterestingMask, to_condition(kZero), &exit);
    JumpIfSmi(src, &exit);
    CheckPageFlag(src, r1, MemoryChunk::kPointersToHereAreInterestingMask, eq, &exit);
    lay(r1, dst_op);
    CallRecordWriteStubSaveRegisters(dst_addr, r1, SaveFPRegsMode::kSave, StubCallMode::kCallWasmRuntimeStub);
    bind(&exit);
}
    ...
    bool is_load_mem, bool i64_offset, bool needs_shift)
{
    ...
    MemOperand src_op = MemOperand(src_addr, offset_reg == no_reg ? r0 : offset_reg, offset_imm);
    if (protected_load_pc)
        *protected_load_pc = pc_offset();
    switch (type.value()) {
...
{
    PREP_MEM_OPERAND(offset_reg, offset_imm, ip)
    lay(ip, MemOperand(dst_addr, offset_reg == no_reg ? r0 : offset_reg, offset_imm));
    ...
    LiftoffRegister result, StoreType type, bool i64_offset)
{
    ...
    case StoreType::kI32Store8:
    case StoreType::kI64Store8: {
        AtomicCmpExchangeU8(ip, result.gp(), expected.gp(), new_value.gp(), r0, r1);
        LoadU8(result.gp(), result.gp());
        break;
    }
    case StoreType::kI32Store16:
...
#define UNOP_LIST(V)                                                                                                                                           \
    ...
    V(i64_signextend_i8, lgbr, LiftoffRegister, LiftoffRegister, LFR_TO_REG, LFR_TO_REG, USE, , void)                                                          \
    V(i64_signextend_i16, lghr, LiftoffRegister, LiftoffRegister, LFR_TO_REG, LFR_TO_REG, USE, , void)                                                         \
    V(i64_signextend_i32, LoadS32, LiftoffRegister, LiftoffRegister, LFR_TO_REG, LFR_TO_REG, USE, , void)                                                      \
    ...
    V(f32_nearest_int, NearestIntF32, DoubleRegister, DoubleRegister, , , USE, true, bool)                                                                     \
    ...
    V(f64_nearest_int, NearestIntF64, DoubleRegister, DoubleRegister, , , USE, true, bool)                                                                     \
...
#define BINOP_LIST(V)                                                                                                                                          \
    V(f32_min, FloatMin, DoubleRegister, DoubleRegister, DoubleRegister, , , , USE, , void)                                                                    \
    V(f32_max, FloatMax, DoubleRegister, DoubleRegister, DoubleRegister, , , , USE, , void)                                                                    \
    V(f64_min, DoubleMin, DoubleRegister, DoubleRegister, DoubleRegister, , , , USE, , void)                                                                   \
    V(f64_max, DoubleMax, DoubleRegister, DoubleRegister, DoubleRegister, , , , USE, , void)                                                                   \
    ...
    V(i32_shli, ShiftLeftU32, Register, Register, int32_t, , , INT32_AND_WITH_1F, SIGN_EXT, , void)                                                            \
    V(i32_sari, ShiftRightS32, Register, Register, int32_t, , , INT32_AND_WITH_1F, SIGN_EXT, , void)                                                           \
    V(i32_shri, ShiftRightU32, Register, Register, int32_t, , , INT32_AND_WITH_1F, SIGN_EXT, , void)                                                           \
    V(i32_shl, ShiftLeftU32, Register, Register, Register, , , REGISTER_AND_WITH_1F, SIGN_EXT, , void)                                                         \
    V(i32_sar, ShiftRightS32, Register, Register, Register, , , REGISTER_AND_WITH_1F, SIGN_EXT, , void)                                                        \
    V(i32_shr, ShiftRightU32, Register, Register, Register, , , REGISTER_AND_WITH_1F, SIGN_EXT, , void)                                                        \
    V(i32_addi, AddS32, Register, Register, int32_t, , , Operand, SIGN_EXT, , void)                                                                            \
    V(i32_subi, SubS32, Register, Register, int32_t, , , Operand, SIGN_EXT, , void)                                                                            \
    ...
    V(i64_and, AndP, LiftoffRegister, LiftoffRegister, LiftoffRegister, LFR_TO_REG, LFR_TO_REG, LFR_TO_REG, USE, , void)                                       \
    V(i64_or, OrP, LiftoffRegister, LiftoffRegister, LiftoffRegister, LFR_TO_REG, LFR_TO_REG, LFR_TO_REG, USE, , void)                                         \
    V(i64_xor, XorP, LiftoffRegister, LiftoffRegister, LiftoffRegister, LFR_TO_REG, LFR_TO_REG, LFR_TO_REG, USE, , void)                                       \
    V(i64_shl, ShiftLeftU64, LiftoffRegister, LiftoffRegister, Register, LFR_TO_REG, LFR_TO_REG, , USE, , void)                                                \
    V(i64_sar, ShiftRightS64, LiftoffRegister, LiftoffRegister, Register, LFR_TO_REG, LFR_TO_REG, , USE, , void)                                               \
    V(i64_shr, ShiftRightU64, LiftoffRegister, LiftoffRegister, Register, LFR_TO_REG, LFR_TO_REG, , USE, , void)                                               \
    V(i64_addi, AddS64, LiftoffRegister, LiftoffRegister, int64_t, LFR_TO_REG, LFR_TO_REG, Operand, USE, , void)                                               \
    V(i64_andi, AndP, LiftoffRegister, LiftoffRegister, int32_t, LFR_TO_REG, LFR_TO_REG, Operand, USE, , void)                                                 \
    V(i64_ori, OrP, LiftoffRegister, LiftoffRegister, int32_t, LFR_TO_REG, LFR_TO_REG, Operand, USE, , void)                                                   \
    V(i64_xori, XorP, LiftoffRegister, LiftoffRegister, int32_t, LFR_TO_REG, LFR_TO_REG, Operand, USE, , void)                                                 \
    V(i64_shli, ShiftLeftU64, LiftoffRegister, LiftoffRegister, int32_t, LFR_TO_REG, LFR_TO_REG, Operand, USE, , void)                                         \
    V(i64_sari, ShiftRightS64, LiftoffRegister, LiftoffRegister, int32_t, LFR_TO_REG, LFR_TO_REG, Operand, USE, , void)                                        \
    V(i64_shri, ShiftRightU64, LiftoffRegister, LiftoffRegister, int32_t, LFR_TO_REG, LFR_TO_REG, Operand, USE, , void)
...
#define EMIT_SIMD_EXTRACT_LANE(name, op, dtype)                                                                                                                \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister src, uint8_t imm_lane_idx)                                                         \
    {                                                                                                                                                          \
...
#define EMIT_SIMD_REPLACE_LANE(name, op, stype)                                                                                                                \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister src1, LiftoffRegister src2, uint8_t imm_lane_idx)                                  \
    {                                                                                                                                                          \
...
#define EMIT_SIMD_EXT_MUL(name, op)                                                                                                                            \
    void LiftoffAssembler::emit_##name(LiftoffRegister dst, LiftoffRegister src1, LiftoffRegister src2)                                                        \
    {                                                                                                                                                          \
...
#define EMIT_SIMD_ADD_SUB_SAT(name, op)                                                                                                                        \
     ...
     * `EmitBinOp`. */                                                                           \
        ...
        Simd128Register temp = GetUnusedRegister(kFpReg, LiftoffRegList { dest, src1, src2 }).fp();                                                            \
...
#define EMIT_SIMD_EXT_ADD_PAIRWISE(name, op)                                                                                                                   \
    ...
    {                                                                                                                                                          \
        ...
        Simd128Register temp = GetUnusedRegister(kFpReg, LiftoffRegList { dest, src1 }).fp();                                                                  \
...
{
    PREP_MEM_OPERAND(offset_reg, offset_imm, ip)
    MemOperand src_op = MemOperand(addr, offset_reg == no_reg ? r0 : offset_reg, offset_imm);
    ...
    Register dst, Register offset, uintptr_t offset_imm, LiftoffRegister src, StoreType type, uint8_t lane, uint32_t* protected_store_pc, bool i64_offset)
{
    ...
    MemOperand dst_op = MemOperand(dst, offset == no_reg ? r0 : offset, offset_imm);
...
void LiftoffAssembler::emit_i16x8_q15mulr_sat_s(LiftoffRegister dst, LiftoffRegister src1, LiftoffRegister src2)
{
    ...
    Simd128Register temp1 = GetUnusedRegister(kFpReg, LiftoffRegList { dest, s1, s2 }).fp();
    Simd128Register temp2 = GetUnusedRegister(kFpReg, LiftoffRegList { dest, s1, s2, temp1 }).fp();
...
void LiftoffAssembler::emit_i32x4_dot_i8x16_i7x16_add_s(LiftoffRegister dst, LiftoffRegister lhs, LiftoffRegister rhs, LiftoffRegister acc)
{
    ...
    Simd128Register temp = GetUnusedRegister(kFpReg, LiftoffRegList { dst, lhs, rhs, acc }).fp();
    I32x4DotI8x16AddS(dst.fp(), lhs.fp(), rhs.fp(), acc.fp(), kScratchDoubleReg, temp);
}
...
#endif
    I8x16Shuffle(dst.fp(), lhs.fp(), rhs.fp(), vals[1], vals[0], r0, ip, kScratchDoubleReg);
}
...
void LiftoffAssembler::emit_s128_set_if_nan(Register dst, LiftoffRegister src, Register tmp_gp, LiftoffRegister tmp_s128, ValueKind lane_kind)
{
    Label return_nan, done;
    if (lane_kind == kF32) {
        vfce(tmp_s128.fp(), src.fp(), src.fp(), Condition(1), Condition(0), Condition(2));
        b(Condition(0x5), &return_nan); // If any or all are NaN.
    } else {
        DCHECK_EQ(lane_kind, kF64);
        vfce(tmp_s128.fp(), src.fp(), src.fp(), Condition(1), Condition(0), Condition(3));
...
void LiftoffStackSlots::Construct(int param_slots)
{
    ...
    for (auto& slot : slots_) {
        ...
        case LiftoffAssembler::VarState::kStack: {
            ...
            case kF32: {
                asm_->AllocateStackSpace(stack_decrement - kSystemPointerSize);
                asm_->LoadF32(kScratchDoubleReg, liftoff::GetStackSlot(slot.src_offset_ + stack_bias));
            ...
            case kF64: {
                ...
                asm_->LoadF64(kScratchDoubleReg, liftoff::GetStackSlot(slot.src_offset_));
            ...
            case kS128: {
                ...
                UseScratchRegisterScope temps(asm_);
                Register scratch = temps.Acquire();
                asm_->LoadV128(kScratchDoubleReg, liftoff::GetStackSlot(slot.src_offset_), scratch);
