...
V8_EXPORT_PRIVATE std::ostream& operator<<(std::ostream& os, const FunctionSig& function);
...
#define FOREACH_SIMD_MASK_OPERAND_OPCODE(V) V(I8x16Shuffle, 0xfd0d, s_ss, "i8x16.shuffle")
...
#define FOREACH_RELAXED_SIMD_OPCODE(V)                                                                                                                         \
    ...
    V(I32x4RelaxedTruncF64x2SZero, 0xfd103, s_s, "i32x4.relaxed_trunc_f64x2_s_zero")                                                                           \
...
#define FOREACH_NUMERIC_OPCODE(V) FOREACH_NUMERIC_OPCODE_WITH_SIG(V) FOREACH_NUMERIC_OPCODE_VARIADIC(V)
...
#define FOREACH_ATOMIC_OPCODE(V)                                                                                                                               \
    ...
    V(I32AtomicCompareExchange8U, 0xfe4a, i_iii, "i32.atomic.rmw8.cmpxchg_u", i_lii)                                                                           \
    V(I32AtomicCompareExchange16U, 0xfe4b, i_iii, "i32.atomic.rmw16.cmpxchg_u", i_lii)                                                                         \
    V(I64AtomicCompareExchange8U, 0xfe4c, l_ill, "i64.atomic.rmw8.cmpxchg_u", l_lll)                                                                           \
    V(I64AtomicCompareExchange16U, 0xfe4d, l_ill, "i64.atomic.rmw16.cmpxchg_u", l_lll)                                                                         \
    V(I64AtomicCompareExchange32U, 0xfe4e, l_ill, "i64.atomic.rmw32.cmpxchg_u", l_lll)
...
#define FOREACH_GC_OPCODE(V) /*              Force 80 columns               */                                                                                 \
    ...
    V(StringViewWtf8EncodeLossyUtf8, 0xfb94, _, "stringview_wtf8.encode_lossy_utf8")                                                                           \
...
#define DECLARE_ENUM(name) k##name,
    FOREACH_WASM_TRAPREASON(DECLARE_ENUM) kTrapCount
#undef DECLARE_ENUM
};
