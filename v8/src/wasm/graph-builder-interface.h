...
struct DanglingExceptions {
    ...
    void Add(compiler::Node* exception_value, compiler::Node* effect, compiler::Node* control)
    {
    ...
    size_t Size() const
    {
        return exception_values.size();
    }
};

V8_EXPORT_PRIVATE void BuildTFGraph(AccountingAllocator* allocator, WasmEnabledFeatures enabled, const WasmModule* module, compiler::WasmGraphBuilder* builder,
