...
public:
    static V8_EXPORT_PRIVATE MaybeHandle<Object> Global(
        Isolate* isolate, Handle<String> source, debug::EvaluateGlobalMode mode, REPLMode repl_mode = REPLMode::kNo);
    ...
    static V8_EXPORT_PRIVATE MaybeHandle<Object> Local(
        Isolate* isolate, StackFrameId frame_id, int inlined_jsframe_index, Handle<String> source, bool throw_on_side_effect);
...
private:
    ...
    public:
        ...
        Handle<Context> evaluation_context() const
        {
    ...
    static MaybeHandle<Object> Evaluate(Isolate* isolate, Handle<SharedFunctionInfo> outer_info, Handle<Context> context, Handle<Object> receiver,
