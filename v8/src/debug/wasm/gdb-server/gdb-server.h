...
public:
    ...
    {
        return has_module_list_changed_;
    }
...
private:
    ...
    template <typename Callback> auto RunSyncTask(Callback&& callback) const;
    ...
    public:
        ...
        void BreakProgramRequested(Local<v8::Context> paused_context, const std::vector<debug::BreakpointId>& inspector_break_points_hit,
            v8::debug::BreakReasons break_reasons) override;
        void ExceptionThrown(
            Local<v8::Context> paused_context, Local<Value> exception, Local<Value> promise, bool is_uncaught, debug::ExceptionType exception_type) override;
