...
#define ASSERT_SIGNED_INTEGER_TYPE(Type) static_assert(std::is_integral<Type>::value && std::is_signed<Type>::value, "use this for signed integer types");
...
template <> inline int16_t MulWithWraparound(int16_t a, int16_t b)
{
