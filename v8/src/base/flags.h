...
// int.
template <typename EnumT, typename BitfieldT = int, typename BitfieldStorageT = BitfieldT> class Flags final {
public:
...
#define DEFINE_OPERATORS_FOR_FLAGS(Type)                                                                                                                       \
    V8_ALLOW_UNUSED V8_WARN_UNUSED_RESULT inline constexpr Type operator&(Type::flag_type lhs, Type::flag_type rhs)                                            \
    {                                                                                                                                                          \
        return Type(lhs) & rhs;                                                                                                                                \
    }                                                                                                                                                          \
    V8_ALLOW_UNUSED V8_WARN_UNUSED_RESULT inline constexpr Type operator&(Type::flag_type lhs, const Type& rhs)                                                \
    {                                                                                                                                                          \
        return rhs & lhs;                                                                                                                                      \
    }                                                                                                                                                          \
    V8_ALLOW_UNUSED inline void operator&(Type::flag_type lhs, Type::mask_type rhs)                                                                            \
    {                                                                                                                                                          \
    }                                                                                                                                                          \
    V8_ALLOW_UNUSED V8_WARN_UNUSED_RESULT inline constexpr Type operator|(Type::flag_type lhs, Type::flag_type rhs)                                            \
    {                                                                                                                                                          \
