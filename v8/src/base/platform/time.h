...
public:
    ...
    {
        return FromDouble(milliseconds * TimeConstants::kMicrosecondsPerMillisecond);
    }
...
// source or timeline.
template <class TimeClass> class TimeBase : public TimeConstants {
public:
#if V8_OS_WIN
