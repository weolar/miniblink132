...
bool InitializeSymbols()
{
    ...
    std::wstring new_path(std::wstring(symbols_path.get()) + L";" + exe_path_wstring.substr(0, exe_path_wstring.find_last_of(L"\\/")));
...
#error Unsupported Arch
    ...
    while (StackWalk64(machine_type, GetCurrentProcess(), GetCurrentThread(), &stack_frame, &context_copy, nullptr, &SymFunctionTableAccess64,
