...
#define EXPORT_TEMPLATE_STYLE_2(export, _) EXPORT_TEMPLATE_STYLE_3(EXPORT_TEMPLATE_STYLE_MATCH_foj3FJo5StF0OvIzl7oMxA##export)
...
#define EXPORT_TEMPLATE_TEST(want, export) static_assert(EXPORT_TEMPLATE_INVOKE(TEST_##want, EXPORT_TEMPLATE_STYLE(export, ), export), #export)
