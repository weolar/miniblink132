...
template <typename Key, typename Value> struct TemplateHashMapEntry {
...
template <typename Key, typename Value> struct TemplateHashMapEntry<Key*, Value> {
    static_assert((!std::is_same<Value, NoHashMapValue>::value));
...
template <typename Value> struct TemplateHashMapEntry<Address, Value> {
    static_assert((!std::is_same<Value, NoHashMapValue>::value));
...
template <typename Key> struct TemplateHashMapEntry<Key, NoHashMapValue> {
    union {
        Key key;
