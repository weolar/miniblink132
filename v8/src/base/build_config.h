...
#if defined(V8_HOST_ARCH_ARM64) && defined(V8_OS_IOS) && defined(__IPHONE_17_4) && __IPHONE_OS_VERSION_MIN_REQUIRED >= __IPHONE_17_4
...
#endif
constexpr int kReturnAddressStackSlotCount = V8_TARGET_ARCH_STORES_RETURN_ADDRESS_ON_STACK ? 1 : 0;
...
#if (defined(V8_OS_MACOS) && defined(V8_HOST_ARCH_ARM64)) || (defined(V8_OS_ANDROID) && (defined(V8_HOST_ARCH_ARM64) || defined(V8_HOST_ARCH_X64)))            \
    || defined(V8_HOST_ARCH_LOONG64) || defined(V8_HOST_ARCH_MIPS64) || defined(V8_OS_IOS)
...
#elif defined(V8_OS_LINUX) && !defined(V8_OS_ANDROID) && (defined(V8_HOST_ARCH_ARM64) || defined(V8_HOST_ARCH_PPC64))
