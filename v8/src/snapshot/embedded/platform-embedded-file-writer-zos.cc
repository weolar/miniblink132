...
void PlatformEmbeddedFileWriterZOS::DeclareUint32(const char* name, uint32_t value)
{
...
void PlatformEmbeddedFileWriterZOS::SourceInfo(int fileid, const char* filename, int line)
{
    hlasmPrintLine(fp_, "* line %d \"%s\"\n", line, filename);
}

void PlatformEmbeddedFileWriterZOS::DeclareFunctionBegin(const char* name, uint32_t size)
{
    hlasmPrintLine(fp_, "*--------------------------------------------\n");
...
void PlatformEmbeddedFileWriterZOS::DeclareExternalFilename(int fileid, const char* filename)
{
    // Not used.
}
...
int PlatformEmbeddedFileWriterZOS::IndentedDataDirective(DataDirective directive)
{
    // Not used.
    return 0;
}
