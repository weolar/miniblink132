...
static constexpr int kNumberOfBytecodes = static_cast<int>(kFinalizeReadOnlySpace) + 1;
...
struct EncodedTagged {
    ...
    static constexpr int kPageIndexBits = kSize * 8 - kOffsetBits; // Determines max number of RO pages.
...
static_assert(EncodedExternalReference::kSize == sizeof(EncodedExternalReference));
