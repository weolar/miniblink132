...
public:
    ...
    {
        return jump_offset_ != kInvalidOffset;
    }
...
public:
    ...
    bool is_bound() const
    {
        DCHECK_IMPLIES(is_bound_, std::all_of(labels_.begin(), labels_.end(), [](const BytecodeLabel& l) { return !l.has_referrer_jump() || l.is_bound(); }));
        return is_bound_;
    }
