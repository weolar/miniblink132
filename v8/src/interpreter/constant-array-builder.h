...
public:
    ...
    template <typename IsolateT> EXPORT_TEMPLATE_DECLARE(V8_EXPORT_PRIVATE) Handle<TrustedFixedArray> ToFixedArray(IsolateT* isolate);
    ...
    template <typename IsolateT> EXPORT_TEMPLATE_DECLARE(V8_EXPORT_PRIVATE) MaybeHandle<Object> At(size_t index, IsolateT* isolate) const;
...
#undef CONSTRUCT_ENTRY
        ...
        template <typename IsolateT> Handle<Object> ToHandle(IsolateT* isolate) const;
...
#undef ENTRY_TAG
    ...
    struct ConstantArraySlice final : public ZoneObject {
        ...
        inline OperandSize operand_size() const
        {
