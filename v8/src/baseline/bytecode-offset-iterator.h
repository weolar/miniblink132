...
public:
    explicit BytecodeOffsetIterator(Handle<TrustedByteArray> mapping_table, Handle<BytecodeArray> bytecodes);
    // Non-handlified version for use when no GC can happen.
    explicit BytecodeOffsetIterator(Tagged<TrustedByteArray> mapping_table, Tagged<BytecodeArray> bytecodes);
