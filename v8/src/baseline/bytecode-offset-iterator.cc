...
BytecodeOffsetIterator::BytecodeOffsetIterator(Handle<TrustedByteArray> mapping_table, Handle<BytecodeArray> bytecodes)
...
BytecodeOffsetIterator::BytecodeOffsetIterator(Tagged<TrustedByteArray> mapping_table, Tagged<BytecodeArray> bytecodes)
    ...
    bytecode_iterator_(Handle<BytecodeArray>(reinterpret_cast<Address*>(&bytecode_handle_storage_)))
    , local_heap_(nullptr)
{
    no_gc_.emplace();
    Initialize();
