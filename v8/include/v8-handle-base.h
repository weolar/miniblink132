...
template <bool check_statically_enabled> class StackAllocated {
public:
...
protected:
    ...
    V8_INLINE explicit StackAllocated(const StackAllocated& other, no_checking_tag)
    {
    }
...
template <> class V8_TRIVIAL_ABI StackAllocated<true> : public StackAllocated<false> {
public:
    ...
    V8_INLINE StackAllocated(const StackAllocated& other)
    {
        VerifyOnStack();
    }
...
protected:
    ...
    V8_INLINE explicit StackAllocated(const StackAllocated& other, no_checking_tag tag)
...
protected:
    ...
    template <typename T, bool check_null = false> V8_INLINE T* value() const
    {
...
protected:
    ...
    V8_INLINE explicit DirectHandleBase(internal::Address ptr)
        : ptr_(ptr)
    {
    }
