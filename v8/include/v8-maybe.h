...
private:
    ...
    template <class U, std::enable_if_t<!std::is_lvalue_reference_v<U>>*> friend Maybe<U> Just(U&& u);
};
...
template <class T, std::enable_if_t<!std::is_lvalue_reference_v<T>>* = nullptr> inline Maybe<T> Just(T&& t)
{
