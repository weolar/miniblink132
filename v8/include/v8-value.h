...
template <> V8_INLINE Value* Value::Cast(Data* value)
{
...
bool Value::QuickIsString() const
{
    ...
    return I::CheckInstanceMapRange(obj, I::StaticReadOnlyRoot::kStringMapLowerBound, I::StaticReadOnlyRoot::kStringMapUpperBound);
#else
...
bool TypecheckWitness::Matches(Local<Value> candidate) const
{
    ...
    internal::Address cached = internal::ValueHelper::ValueAsAddress(*cached_map_);
