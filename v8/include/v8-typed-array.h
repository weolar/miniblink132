...
public:
   ...
   */
    ...
    static constexpr size_t kMaxByteLength = internal::kMaxSafeBufferSizeForSandbox;
#elif V8_HOST_ARCH_32_BIT
    static constexpr size_t kMaxByteLength = std::numeric_limits<int>::max();
#else
    // The maximum safe integer (2^53 - 1).
    static constexpr size_t kMaxByteLength = static_cast<size_t>((uint64_t { 1 } << 53) - 1);
#endif
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(uint8_t);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(int8_t);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(uint16_t);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(int16_t);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(uint32_t);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(int32_t);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(float);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(double);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(int64_t);
...
public:
   ...
   */
    static constexpr size_t kMaxLength = TypedArray::kMaxByteLength / sizeof(uint64_t);
