...
struct WasmModuleCompiled {
    ...
    WasmModuleCompiled(bool async, bool streamed, bool cached, bool deserialized, bool lazy, bool success, size_t code_size_in_bytes,
        size_t liftoff_bailout_count, int64_t wall_clock_duration_in_us)
        : async(async)
        , streamed(streamed)
        , cached(cached)
...
public:
    ...
    private:
        ...
        explicit ContextId(uintptr_t id)
            : id_(id)
        {
        }
