...
[[noreturn]] void V8_EXPORT FatalImpl(const char*, const SourceLocation& = SourceLocation::Current());

// Used to ignore -Wunused-variable.
template <typename> struct EatParams { };
...
#define CPPGC_DCHECK_MSG(condition, message) (static_cast<void>(::cppgc::internal::EatParams<decltype(static_cast<void>(condition), message)> {}))
