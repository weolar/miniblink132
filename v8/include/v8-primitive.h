...
public:
   ...
   * when length > kMaxLength. **/
    static V8_WARN_UNUSED_RESULT MaybeLocal<String> NewFromOneByte(
        Isolate* isolate, const uint8_t* data, NewStringType type = NewStringType::kNormal, int length = -1);

    /** Allocates a new string from UTF-16 data. Only returns an empty value when
   * length > kMaxLength. **/
    static V8_WARN_UNUSED_RESULT MaybeLocal<String> NewFromTwoByte(
        Isolate* isolate, const uint16_t* data, NewStringType type = NewStringType::kNormal, int length = -1);
   ...
   */
    ...
    public:
        V8_DEPRECATE_SOON("Prefer using String::ValueView if you can, or string->Write to a "
   ...
   */
    ...
    private:
        ...
        alignas(internal::Internals::kDisallowGarbageCollectionAlign) char no_gc_debug_scope_[internal::Internals::kDisallowGarbageCollectionSize];
    };
...
// terminator).
template <> inline V8_WARN_UNUSED_RESULT Local<String> String::NewFromUtf8Literal(Isolate* isolate, const char (&literal)[1], NewStringType type)
{
...
String::ExternalStringResource* String::GetExternalStringResource() const
{
    ...
    if (I::IsExternalTwoByteString(I::GetInstanceType(obj))) {
        ...
        A value = I::ReadExternalPointerField<internal::kExternalStringResourceTag>(isolate, obj, I::kStringResourceOffset);
...
String::ExternalStringResourceBase* String::GetExternalStringResourceBase(v8::Isolate* isolate, String::Encoding* encoding_out) const
{
    using A = internal::Address;
    using I = internal::Internals;
    A obj = internal::ValueHelper::ValueAsAddress(this);
