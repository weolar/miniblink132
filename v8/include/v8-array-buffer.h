...
public:
   ...
   */
    V8_DEPRECATED("Reallocate is unsafe, please do not use. Please allocate a new "
...
public:
   ...
   */
     ...
     */
        V8_DEPRECATED("Reallocate is unsafe, please do not use. Please allocate new memory "
                      "and copy instead.")
   ...
   */
    static MaybeLocal<ArrayBuffer> MaybeNew(
        Isolate* isolate, size_t byte_length, BackingStoreInitializationMode initialization_mode = BackingStoreInitializationMode::kZeroInitialized);
   ...
   */
    V8_DEPRECATED("Use the version which takes a key parameter (passing a null handle is "
                  "ok).")
    void Detach();
   ...
   */
    ...
    static constexpr int kInternalFieldCount = V8_ARRAY_BUFFER_INTERNAL_FIELD_COUNT;
...
public:
   ...
   */
    ...
    static constexpr int kInternalFieldCount = V8_ARRAY_BUFFER_VIEW_INTERNAL_FIELD_COUNT;
