...
TEST(Geometry, ScaleRectProportional)
{
    ...
    output_rect = ScaleSkRectProportional(SkRect::MakeXYWH(0, 0, 20, 20), SkRect::MakeXYWH(0, 0, 40, 40), SkRect::MakeXYWH(10, 10, 20, 20));
    EXPECT_EQ(output_rect, SkRect::MakeXYWH(5, 5, 10, 10));

    output_rect = ScaleSkRectProportional(SkRect::MakeXYWH(0, 10, 20, 80), SkRect::MakeXYWH(10, 20, 40, 80), SkRect::MakeXYWH(0, 30, 60, 20));
