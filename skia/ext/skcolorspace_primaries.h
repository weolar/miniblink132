...
SK_API bool operator==(const SkColorSpacePrimaries& a, const SkColorSpacePrimaries& b);
...
SK_API std::string SkColorSpacePrimariesToString(const SkColorSpacePrimaries& primaries);

// Given a matrix that transforms to XYZD50, compute the primaries with a D65
// white point that would produce this matrix.
SK_API SkColorSpacePrimaries GetD65PrimariesFromToXYZD50Matrix(const skcms_Matrix3x3& m);
...
static constexpr SkColorSpacePrimaries kSMPTE_RP_431_2 = { 0.680f, 0.320f, 0.265f, 0.690f, 0.150f, 0.060f, 0.314f, 0.351f };

// SMPTE EG 432-1, value 12.
static constexpr SkColorSpacePrimaries kSMPTE_EG_432_1 = { 0.680f, 0.320f, 0.265f, 0.690f, 0.150f, 0.060f, 0.3127f, 0.3290f };
...
static constexpr SkColorSpacePrimaries kITU_T_H273_Value22 = { 0.630f, 0.340f, 0.295f, 0.605f, 0.155f, 0.077f, 0.3127f, 0.3290f };
...
// 'prophoto-rgb'
static constexpr SkColorSpacePrimaries kProPhotoRGB = { 0.7347f, 0.2653f, 0.1596f, 0.8404f, 0.0366f, 0.0001f, 0.34567f, 0.35850f };
...
static constexpr SkColorSpacePrimaries kAppleGenericRGB = { 0.63002f, 0.34000f, 0.29505f, 0.60498f, 0.15501f, 0.07701f, 0.3127f, 0.3290f };

// Primaries where the colors are rotated and the gamut is huge. Good for
// testing.
static constexpr SkColorSpacePrimaries kWideGamutColorSpin = { 0.01f, 0.98f, 0.01f, 0.01f, 0.98f, 0.01f, 0.3127f, 0.3290f };
