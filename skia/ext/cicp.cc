...
bool CICPGetTransferFn(uint8_t transfer_characteristics, bool prefer_srgb_trfn, skcms_TransferFunction& trfn)
{
    ...
    case 0:
        ...
        break;
    case 1:
        trfn = prefer_srgb_trfn ? SkNamedTransferFnExt::kSRGB : SkNamedTransferFnExt::kRec709;
        return true;
    case 2:
        // Unspecified.
        break;
    ...
    case 5:
        ...
        return true;
    case 6:
        trfn = prefer_srgb_trfn ? SkNamedTransferFnExt::kSRGB : SkNamedTransferFnExt::kRec601;
        return true;
    case 7:
    ...
    case 10:
        ...
        break;
    case 11:
        trfn = prefer_srgb_trfn ? SkNamedTransferFnExt::kSRGB : SkNamedTransferFnExt::kIEC61966_2_4;
        break;
    case 12:
...
sk_sp<SkColorSpace> CICPGetSkColorSpace(
    uint8_t color_primaries, uint8_t transfer_characteristics, uint8_t matrix_coefficients, uint8_t full_range_flag, bool prefer_srgb_trfn)
{
...
bool CICPGetSkYUVColorSpace(uint8_t matrix_coefficients, uint8_t full_range_flag, uint8_t bits_per_color, SkYUVColorSpace& yuv_color_space)
{
    ...
    case 1:
        // Rec. ITU-R BT.709-6.
        yuv_color_space = full_range_flag ? kRec709_Full_SkYUVColorSpace : kRec709_Limited_SkYUVColorSpace;
        return true;
    case 5:
        // Rec. ITU-R BT.470-6 System B, G (historical).
    case 6:
        // Rec. ITU-R BT.601-7.
        yuv_color_space = full_range_flag ? kJPEG_SkYUVColorSpace : kRec601_Limited_SkYUVColorSpace;
        return true;
    case 9:
    ...
    case 10:
        ...
        case 8:
            yuv_color_space = full_range_flag ? kBT2020_8bit_Full_SkYUVColorSpace : kBT2020_8bit_Limited_SkYUVColorSpace;
            return true;
        case 10:
            yuv_color_space = full_range_flag ? kBT2020_10bit_Full_SkYUVColorSpace : kBT2020_10bit_Limited_SkYUVColorSpace;
            return true;
        case 12:
            yuv_color_space = full_range_flag ? kBT2020_12bit_Full_SkYUVColorSpace : kBT2020_12bit_Limited_SkYUVColorSpace;
            return true;
        case 16:
            yuv_color_space = full_range_flag ? kBT2020_16bit_Full_SkYUVColorSpace : kBT2020_16bit_Limited_SkYUVColorSpace;
            return true;
        default:
            break;
        }
