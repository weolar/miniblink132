...
public:
    OpacityFilterCanvas(SkCanvas* canvas, float opacity, bool disable_image_filtering);

protected:
    bool onFilter(SkPaint& paint) const override;

    void onDrawImage2(const SkImage*, SkScalar dx, SkScalar dy, const SkSamplingOptions&, const SkPaint*) override;
    ...
    void onDrawEdgeAAImageSet2(const ImageSetEntry imageSet[], int count, const SkPoint dstClips[], const SkMatrix preViewMatrices[], const SkSamplingOptions&,
