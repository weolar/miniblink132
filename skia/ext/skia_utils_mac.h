...
SK_API base::apple::ScopedCFTypeRef<CGColorRef> CGColorCreateFromSkColor(SkColor color);
...
SK_API SkBitmap NSImageRepToSkBitmap(NSImageRep* image, NSSize size, bool is_opaque);
