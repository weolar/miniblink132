...
// are supported.
SK_API bool CICPGetPrimaries(uint8_t primaries, SkColorSpacePrimaries& sk_primaries);
...
SK_API bool CICPGetTransferFn(uint8_t transfer_characteristics, bool prefer_srgb_trfn, skcms_TransferFunction& sk_trfn);
...
SK_API sk_sp<SkColorSpace> CICPGetSkColorSpace(
...
SK_API bool CICPGetSkYUVColorSpace(uint8_t matrix_coefficients, uint8_t full_range_flag, uint8_t bits_per_color, SkYUVColorSpace& yuv_color_space);
