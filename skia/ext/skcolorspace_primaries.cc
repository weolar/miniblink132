...
{
    return a.fRX == b.fRX && a.fRY == b.fRY && a.fGX == b.fGX && a.fGY == b.fGY && a.fBX == b.fBX && a.fBY == b.fBY && a.fWX == b.fWX && a.fWY == b.fWY;
}
...
std::string SkColorSpacePrimariesToString(const SkColorSpacePrimaries& primaries)
{
...
SkColorSpacePrimaries GetD65PrimariesFromToXYZD50Matrix(const skcms_Matrix3x3& m_d50)
{
