...
skcms_TransferFunction SK_API ScaleTransferFunction(const skcms_TransferFunction& f, float alpha);
...
bool SK_API IsScaledTransferFunction(const skcms_TransferFunction& x, const skcms_TransferFunction& y, float* alpha);
...
static constexpr skcms_TransferFunction kRec709 = { 2.222222222222f, 0.909672415686f, 0.090327584314f, 0.222222222222f, 0.081242858299f, 0.f, 0.f };
...
static constexpr skcms_TransferFunction kSMPTE_ST_240 = { 2.222222222222f, 0.899626676224f, 0.100373323776f, 0.25f, 0.091286342118f, 0.f, 0.f };
...
static constexpr skcms_TransferFunction kIEC61966_2_1 = { 2.4f, 0.947867345704f, 0.052132654296f, 0.077399380805f, 0.040449937172f };
...
static constexpr skcms_TransferFunction kSRGBExtended1023Over510
    = { SkNamedTransferFnExt::kSRGB.g, SkNamedTransferFnExt::kSRGB.a * 1023 / 510, SkNamedTransferFnExt::kSRGB.b, SkNamedTransferFnExt::kSRGB.c * 1023 / 510,
          SkNamedTransferFnExt::kSRGB.d * 1023 / 510, SkNamedTransferFnExt::kSRGB.e, SkNamedTransferFnExt::kSRGB.f };
