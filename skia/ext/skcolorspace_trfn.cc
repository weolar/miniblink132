...
skcms_TransferFunction ScaleTransferFunction(const skcms_TransferFunction& f, float alpha)
{
...
bool IsScaledTransferFunction(const skcms_TransferFunction& x, const skcms_TransferFunction& y, float* out_alpha)
{
