...
SK_API bool ReadSkFontIdentity(base::PickleIterator* iter, SkFontConfigInterface::FontIdentity* identity);
...
SK_API void WriteSkFontIdentity(base::Pickle* pickle, const SkFontConfigInterface::FontIdentity& identity);
...
SK_API std::string SkcmsTransferFunctionToString(const skcms_TransferFunction& f);
