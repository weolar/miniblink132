...
void RunTestCase(std::string& ipc_filter_message, SkBitmap& bitmap, SkCanvas* canvas)
{
    // This call shouldn't crash or cause ASAN to flag any memory issues
    // If nothing bad happens within this call, everything is fine
    sk_sp<SkImageFilter> flattenable = SkImageFilter::Deserialize(ipc_filter_message.c_str(), ipc_filter_message.size());
...
bool ReadAndRunTestCase(const char* filename, SkBitmap& bitmap, SkCanvas* canvas)
{
