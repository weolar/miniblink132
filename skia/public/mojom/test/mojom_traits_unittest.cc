...
mojo::StructPtr<skia::mojom::BitmapN32> ConstructBitmapN32(SkImageInfo info, const std::vector<unsigned char>& pixels)
{
...
mojo::StructPtr<skia::mojom::BitmapWithArbitraryBpp> ConstructBitmapWithArbitraryBpp(SkImageInfo info, int row_bytes, const std::vector<unsigned char>& pixels)
{
...
mojo::StructPtr<skia::mojom::BitmapMappedFromTrustedProcess> ConstructBitmapMappedFromTrustedProcess(
    SkImageInfo info, int row_bytes, const std::vector<unsigned char>& pixels)
{
...
// to bypass checks on the sending/serialization side.
mojo::StructPtr<skia::mojom::InlineBitmap> ConstructInlineBitmap(SkImageInfo info, const std::vector<unsigned char>& pixels)
{
...
// to bypass checks on the sending/serialization side.
mojo::StructPtr<skia::mojom::ImageInfo> ConstructImageInfo(SkColorType color_type, SkAlphaType alpha_type, uint32_t width, uint32_t height)
{
...
TEST(StructTraitsTest, ImageInfo)
{
    SkImageInfo input = SkImageInfo::Make(
        34, 56, SkColorType::kGray_8_SkColorType, SkAlphaType::kUnpremul_SkAlphaType, SkColorSpace::MakeRGB(SkNamedTransferFn::kSRGB, SkNamedGamut::kAdobeRGB));
    SkImageInfo output;
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::ImageInfo>(input, output));
    EXPECT_EQ(input, output);

    SkImageInfo another_input_with_null_color_space = SkImageInfo::Make(54, 43, SkColorType::kRGBA_8888_SkColorType, SkAlphaType::kPremul_SkAlphaType, nullptr);
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::ImageInfo>(another_input_with_null_color_space, output));
...
{
    SkImageInfo input = SkImageInfo::Make(std::numeric_limits<uint32_t>::max(), std::numeric_limits<uint32_t>::max(), SkColorType::kGray_8_SkColorType,
        SkAlphaType::kUnpremul_SkAlphaType, SkColorSpace::MakeRGB(SkNamedTransferFn::kSRGB, SkNamedGamut::kAdobeRGB));
    SkImageInfo output;
...
TEST(StructTraitsTest, ImageInfoOverflowSizeWithoutStructTrait)
{
    ...
    mojo::StructPtr<skia::mojom::ImageInfo> input = ConstructImageInfo(
        SkColorType::kGray_8_SkColorType, SkAlphaType::kUnpremul_SkAlphaType, std::numeric_limits<uint32_t>::max(), std::numeric_limits<uint32_t>::max());
    EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::ImageInfo>(input, output));
}

TEST(StructTraitsTest, ImageInfoCustomColorSpace)
{
    skcms_TransferFunction transfer { 0.1f, 0.2f, 0.3f, 0.4f, 0.5f, 0.6f, 0.7f };
    skcms_Matrix3x3 gamut { .vals = { { 0.1f, 0.2f, 0.3f }, { 0.4f, 0.5f, 0.6f }, { 0.7f, 0.8f, 0.9f } } };
    sk_sp<SkColorSpace> color_space = SkColorSpace::MakeRGB(transfer, gamut);
    SkImageInfo input = SkImageInfo::Make(12, 34, SkColorType::kRGBA_8888_SkColorType, kUnpremul_SkAlphaType, color_space);
    SkImageInfo output;
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::ImageInfo>(input, output));
...
TEST(StructTraitsTest, SkColorSpace)
{
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::SkcmsTransferFunction>(in_trfn, out_trfn));
    EXPECT_EQ(memcmp(&in_trfn, &out_trfn, sizeof(in_trfn)), 0);

    skcms_Matrix3x3 in_to_xyzd50 { .vals = { { 0.1f, 0.2f, 0.3f }, { 0.4f, 0.5f, 0.6f }, { 0.7f, 0.8f, 0.9f } } };
    skcms_Matrix3x3 out_to_xyzd50;
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::SkcmsMatrix3x3>(in_to_xyzd50, out_to_xyzd50));
    ...
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::SkColorSpace>(in_cs, out_cs));
    EXPECT_TRUE(SkColorSpace::Equals(in_cs.get(), out_cs.get()));

    sk_sp<SkColorSpace> in_null_cs;
    sk_sp<SkColorSpace> out_null_cs;
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::SkColorSpace>(in_null_cs, out_null_cs));
    EXPECT_EQ(out_null_cs.get(), nullptr);

    SkColorSpacePrimaries in_p = SkNamedPrimariesExt::kGenericFilm;
    SkColorSpacePrimaries out_p;
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::SkColorSpacePrimaries>(in_p, out_p));
...
TEST(StructTraitsTest, TileMode)
{
    ...
    SkTileMode output;
    ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::TileMode>(input, output));
    EXPECT_EQ(input, output);
...
{
    SkBitmap input;
    input.allocPixels(SkImageInfo::MakeN32Premul(10, 5, SkColorSpace::MakeRGB(SkNamedTransferFn::kLinear, SkNamedGamut::kRec2020)));
    ...
    {
        ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapN32>(input, output));
        BitmapsEqual(input, output);
    }
    {
        ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapWithArbitraryBpp>(input, output));
        BitmapsEqual(input, output);
    }
    {
        ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapMappedFromTrustedProcess>(input, output));
        BitmapsEqual(input, output);
    }
    {
        ASSERT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::InlineBitmap>(input, output));
        BitmapsEqual(input, output);
    }
}
...
{
    SkBitmap input;
    input.setInfo(SkImageInfo::MakeN32Premul(10, 5, SkColorSpace::MakeRGB(SkNamedTransferFn::kLinear, SkNamedGamut::kRec2020)));
    ...
    SkBitmap output;
    {
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapN32>(input, output));
        IsDefaultInit(output);
    }
    {
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapWithArbitraryBpp>(input, output));
        IsDefaultInit(output);
    }
    {
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapMappedFromTrustedProcess>(input, output));
        IsDefaultInit(output);
    }
    {
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::InlineBitmap>(input, output));
        IsDefaultInit(output);
    }
}
...
TEST(StructTraitsTest, InlineBitmapSerializeToString)
{
    ...
    SkBitmap output;
    ASSERT_TRUE(skia::mojom::InlineBitmap::Deserialize(std::move(serialized), &output));
    EXPECT_EQ(input.info(), output.info());
    EXPECT_EQ(input.rowBytes(), output.rowBytes());
    EXPECT_TRUE(gfx::BitmapsAreEqual(input, output));
}
...
TEST(StructTraitsTest, VerifyMojomConstruction)
{
    ...
    {
        mojo::StructPtr<skia::mojom::BitmapN32> input = ConstructBitmapN32(SkImageInfo::MakeN32Premul(1, 1), { 1, 2, 3, 4 });
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapN32>(input, output));
    }
    {
        mojo::StructPtr<skia::mojom::BitmapWithArbitraryBpp> input = ConstructBitmapWithArbitraryBpp(SkImageInfo::MakeN32Premul(1, 1), 0, { 1, 2, 3, 4 });
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapWithArbitraryBpp>(input, output));
    }
    {
        mojo::StructPtr<skia::mojom::BitmapMappedFromTrustedProcess> input
            = ConstructBitmapMappedFromTrustedProcess(SkImageInfo::MakeN32Premul(1, 1), 0, { 1, 2, 3, 4 });
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapMappedFromTrustedProcess>(input, output));
    }
    {
        mojo::StructPtr<skia::mojom::InlineBitmap> input = ConstructInlineBitmap(SkImageInfo::MakeN32Premul(1, 1), { 1, 2, 3, 4 });
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::InlineBitmap>(input, output));
    }
}
...
TEST(StructTraitsTest, BitmapTooWideToSerialize)
{
    ...
    SkBitmap input;
    input.allocPixels(SkImageInfo::MakeN32(kTooWide, 1, SkAlphaType::kUnpremul_SkAlphaType));
    input.eraseColor(SK_ColorYELLOW);
    SkBitmap output;
    {
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapN32>(input, output));
    }
    {
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapWithArbitraryBpp>(input, output));
    }
    {
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapMappedFromTrustedProcess>(input, output));
    }
    {
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::InlineBitmap>(input, output));
    }
}
...
TEST(StructTraitsTest, BitmapTooTallToSerialize)
{
    ...
    SkBitmap input;
    input.allocPixels(SkImageInfo::MakeN32(1, kTooTall, SkAlphaType::kUnpremul_SkAlphaType));
    input.eraseColor(SK_ColorYELLOW);
    SkBitmap output;
    {
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapN32>(input, output));
...
template <typename MojomType> static void BadRowBytes()
{
    SkImageInfo info = SkImageInfo::MakeN32(8, 5, kPremul_SkAlphaType, SkColorSpace::MakeSRGB());
...
TEST(StructTraitsTest, BitmapSerializeInvalidRowBytes_BitmapMappedFromTrustedProcess)
{
...
template <typename MojomType> static void BadColor(bool expect_crash)
{
...
TEST(StructTraitsTest, BitmapSerializeInvalidColorType_BitmapMappedFromTrustedProcess)
{
...
TEST(StructTraitsTest, BitmapDeserializeIgnoresRowBytes)
{
    ...
    size_t expected_row_bytes = 4;
    {
        mojo::StructPtr<skia::mojom::BitmapWithArbitraryBpp> input
            = ConstructBitmapWithArbitraryBpp(SkImageInfo::MakeN32Premul(1, 1), ignored_row_bytes, { 1, 2, 3, 4 });
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapWithArbitraryBpp>(input, output));
        EXPECT_EQ(expected_row_bytes, output.rowBytes());
    }
    {
        mojo::StructPtr<skia::mojom::BitmapMappedFromTrustedProcess> input
            = ConstructBitmapMappedFromTrustedProcess(SkImageInfo::MakeN32Premul(1, 1), ignored_row_bytes, { 1, 2, 3, 4 });
        EXPECT_TRUE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapMappedFromTrustedProcess>(input, output));
        EXPECT_EQ(expected_row_bytes, output.rowBytes());
    }
    {
...
TEST(StructTraitsTest, InlineBitmapDeserializeTooFewBytes)
{
    ...
    SkBitmap output;
    {
        mojo::StructPtr<skia::mojom::BitmapN32> input = ConstructBitmapN32(info, pixels);
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapN32>(input, output));
    }
    {
        mojo::StructPtr<skia::mojom::BitmapWithArbitraryBpp> input = ConstructBitmapWithArbitraryBpp(info, 0, pixels);
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapWithArbitraryBpp>(input, output));
    }
    {
        mojo::StructPtr<skia::mojom::BitmapMappedFromTrustedProcess> input = ConstructBitmapMappedFromTrustedProcess(info, 0, pixels);
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::BitmapMappedFromTrustedProcess>(input, output));
    }
    {
        mojo::StructPtr<skia::mojom::InlineBitmap> input = ConstructInlineBitmap(info, pixels);
        EXPECT_FALSE(mojo::test::SerializeAndDeserialize<skia::mojom::InlineBitmap>(input, output));
    }
}
