...
template <> struct StructTraits<skia::mojom::SkColor4fDataView, ::SkColor4f> {
    static float r(::SkColor4f color)
    {
        return color.fR;
    }
    static float g(::SkColor4f color)
    {
        return color.fG;
    }
    static float b(::SkColor4f color)
    {
        return color.fB;
    }
    static float a(::SkColor4f color)
    {
        return color.fA;
    }
