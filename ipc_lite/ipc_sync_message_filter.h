...
#ifndef LITE_IPC_IPC_SYNC_MESSAGE_FILTER_H_
#define LITE_IPC_IPC_SYNC_MESSAGE_FILTER_H_
...
class IPC_EXPORT SyncMessageFilter : public ChannelProxy::MessageFilter, public Sender {
public:
...
private:
    ...
    scoped_refptr<base::SingleThreadTaskRunner> listener_loop_;

    // The message loop where the Channel lives.
    //scoped_refptr<base::MessageLoopProxy> io_loop_;
    scoped_refptr<base::SingleThreadTaskRunner> io_loop_;
