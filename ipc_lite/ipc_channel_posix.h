...
#ifndef LITE_IPC_IPC_CHANNEL_POSIX_H_
#define LITE_IPC_IPC_CHANNEL_POSIX_H_
...
class Channel::ChannelImpl : public internal::ChannelReader, public /*MessageLoopForIO::Watcher*/ base::MessagePumpGlib::FdWatcher {
public:
...
private:
    ...
    // stop listening.
    /*base::FileDescriptorWatcher*/ base::MessagePumpForIO::FdWatchController server_listen_connection_watcher_;
    /*base::FileDescriptorWatcher*/ base::MessagePumpForIO::FdWatchController read_watcher_;
    /*base::FileDescriptorWatcher*/ base::MessagePumpForIO::FdWatchController write_watcher_;
    ...
    static const size_t kMaxReadFDs = (Channel::kReadBufferSize / sizeof(IPC::Message::Header)) * FileDescriptorSet::kMaxDescriptorsPerMessage;
