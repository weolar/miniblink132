...
#ifndef LITE_IPC_PARAM_TRAITS_MACROS_H_
#define LITE_IPC_PARAM_TRAITS_MACROS_H_
...
#define IPC_STRUCT_TRAITS_BEGIN(struct_name)                                                                                                                   \
    namespace IPC {                                                                                                                                            \
    template <> struct IPC_MESSAGE_EXPORT ParamTraits<struct_name> {                                                                                           \
...
//     namespace IPC {                                                                                                                                            \
//     template <> struct IPC_MESSAGE_EXPORT ParamTraits<enum_name> {                                                                                             \
...
#define IPC_ENUM_TRAITS_MIN_MAX_VALUE(typ, minvalue, maxvalue)                                                                                                 \
    IPC_ENUM_TRAITS_VALIDATE(typ,                                                                                                                              \
        (static_cast<std::underlying_type<typ>::type>(value) >= static_cast<std::underlying_type<typ>::type>(minvalue)                                         \
            && static_cast<std::underlying_type<typ>::type>(value) <= static_cast<std::underlying_type<typ>::type>(maxvalue)))
