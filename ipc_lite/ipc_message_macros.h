...
#ifndef LITE_IPC_IPC_MESSAGE_MACROS_H_
#define LITE_IPC_IPC_MESSAGE_MACROS_H_
...
#include "ipc_lite/ipc_message_utils_impl.h"
#endif
...
#define IPC_MESSAGE_CONTROL0(msg_class) IPC_MESSAGE_DECL(EMPTY, CONTROL, msg_class, 0, 0, (), ())

#define IPC_MESSAGE_CONTROL1(msg_class, type1) IPC_MESSAGE_DECL(ASYNC, CONTROL, msg_class, 1, 0, (type1), ())

#define IPC_MESSAGE_CONTROL2(msg_class, type1, type2) IPC_MESSAGE_DECL(ASYNC, CONTROL, msg_class, 2, 0, (type1, type2), ())

#define IPC_MESSAGE_CONTROL3(msg_class, type1, type2, type3) IPC_MESSAGE_DECL(ASYNC, CONTROL, msg_class, 3, 0, (type1, type2, type3), ())

#define IPC_MESSAGE_CONTROL4(msg_class, type1, type2, type3, type4) IPC_MESSAGE_DECL(ASYNC, CONTROL, msg_class, 4, 0, (type1, type2, type3, type4), ())
...
#define IPC_MESSAGE_ROUTED1(msg_class, type1) IPC_MESSAGE_DECL(ASYNC, ROUTED, msg_class, 1, 0, (type1), ())

#define IPC_MESSAGE_ROUTED2(msg_class, type1, type2) IPC_MESSAGE_DECL(ASYNC, ROUTED, msg_class, 2, 0, (type1, type2), ())

#define IPC_MESSAGE_ROUTED3(msg_class, type1, type2, type3) IPC_MESSAGE_DECL(ASYNC, ROUTED, msg_class, 3, 0, (type1, type2, type3), ())

#define IPC_MESSAGE_ROUTED4(msg_class, type1, type2, type3, type4) IPC_MESSAGE_DECL(ASYNC, ROUTED, msg_class, 4, 0, (type1, type2, type3, type4), ())
...
#define IPC_SYNC_MESSAGE_CONTROL0_0(msg_class) IPC_MESSAGE_DECL(SYNC, CONTROL, msg_class, 0, 0, (), ())

#define IPC_SYNC_MESSAGE_CONTROL0_1(msg_class, type1_out) IPC_MESSAGE_DECL(SYNC, CONTROL, msg_class, 0, 1, (), (type1_out))

#define IPC_SYNC_MESSAGE_CONTROL0_2(msg_class, type1_out, type2_out) IPC_MESSAGE_DECL(SYNC, CONTROL, msg_class, 0, 2, (), (type1_out, type2_out))
...
#define IPC_SYNC_MESSAGE_CONTROL1_0(msg_class, type1_in) IPC_MESSAGE_DECL(SYNC, CONTROL, msg_class, 1, 0, (type1_in), ())

#define IPC_SYNC_MESSAGE_CONTROL1_1(msg_class, type1_in, type1_out) IPC_MESSAGE_DECL(SYNC, CONTROL, msg_class, 1, 1, (type1_in), (type1_out))
...
#define IPC_SYNC_MESSAGE_CONTROL2_0(msg_class, type1_in, type2_in) IPC_MESSAGE_DECL(SYNC, CONTROL, msg_class, 2, 0, (type1_in, type2_in), ())
...
#define IPC_SYNC_MESSAGE_ROUTED0_0(msg_class) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 0, 0, (), ())

#define IPC_SYNC_MESSAGE_ROUTED0_1(msg_class, type1_out) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 0, 1, (), (type1_out))

#define IPC_SYNC_MESSAGE_ROUTED0_2(msg_class, type1_out, type2_out) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 0, 2, (), (type1_out, type2_out))
...
#define IPC_SYNC_MESSAGE_ROUTED1_0(msg_class, type1_in) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 1, 0, (type1_in), ())

#define IPC_SYNC_MESSAGE_ROUTED1_1(msg_class, type1_in, type1_out) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 1, 1, (type1_in), (type1_out))
...
#define IPC_SYNC_MESSAGE_ROUTED2_0(msg_class, type1_in, type2_in) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 2, 0, (type1_in, type2_in), ())

#define IPC_SYNC_MESSAGE_ROUTED2_1(msg_class, type1_in, type2_in, type1_out) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 2, 1, (type1_in, type2_in), (type1_out))
...
#define IPC_SYNC_MESSAGE_ROUTED3_0(msg_class, type1_in, type2_in, type3_in) IPC_MESSAGE_DECL(SYNC, ROUTED, msg_class, 3, 0, (type1_in, type2_in, type3_in), ())
...
#define IPC_ASYNC_MESSAGE_METHODS_GENERIC                                                                                                                      \
    template <class T, class S, class Method> static bool Dispatch(const Message* msg, T* obj, S* sender, Method func)                                         \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (Read(msg, &p)) {                                                                                                                                   \
...
#define IPC_ASYNC_MESSAGE_METHODS_1                                                                                                                            \
    ...
    template <class T, class S, typename TA> static bool Dispatch(const Message* msg, T* obj, S* sender, void (T::*func)(const Message&, TA))                  \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (Read(msg, &p)) {                                                                                                                                   \
            (obj->*func)(*msg, p.a);                                                                                                                           \
...
#define IPC_ASYNC_MESSAGE_METHODS_2                                                                                                                            \
    IPC_ASYNC_MESSAGE_METHODS_GENERIC                                                                                                                          \
    template <class T, class S, typename TA, typename TB> static bool Dispatch(const Message* msg, T* obj, S* sender, void (T::*func)(const Message&, TA, TB)) \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (Read(msg, &p)) {                                                                                                                                   \
    ...
    template <typename TA, typename TB> static bool Read(const IPC::Message* msg, TA* a, TB* b)                                                                \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (!Read(msg, &p))                                                                                                                                    \
            return false;                                                                                                                                      \
...
#define IPC_ASYNC_MESSAGE_METHODS_3                                                                                                                            \
    ...
    static bool Dispatch(const Message* msg, T* obj, S* sender, void (T::*func)(const Message&, TA, TB, TC))                                                   \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (Read(msg, &p)) {                                                                                                                                   \
    ...
    template <typename TA, typename TB, typename TC> static bool Read(const IPC::Message* msg, TA* a, TB* b, TC* c)                                            \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (!Read(msg, &p))                                                                                                                                    \
            return false;                                                                                                                                      \
...
#define IPC_ASYNC_MESSAGE_METHODS_4                                                                                                                            \
    ...
    static bool Dispatch(const Message* msg, T* obj, S* sender, void (T::*func)(const Message&, TA, TB, TC, TD))                                               \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (Read(msg, &p)) {                                                                                                                                   \
    ...
    template <typename TA, typename TB, typename TC, typename TD> static bool Read(const IPC::Message* msg, TA* a, TB* b, TC* c, TD* d)                        \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (!Read(msg, &p))                                                                                                                                    \
            return false;                                                                                                                                      \
...
#define IPC_ASYNC_MESSAGE_METHODS_5                                                                                                                            \
    IPC_ASYNC_MESSAGE_METHODS_GENERIC                                                                                                                          \
    template <class T, class S, typename TA, typename TB, typename TC, typename TD, typename TE>                                                               \
    static bool Dispatch(const Message* msg, T* obj, S* sender, void (T::*func)(const Message&, TA, TB, TC, TD, TE))                                           \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (Read(msg, &p)) {                                                                                                                                   \
    ...
    template <typename TA, typename TB, typename TC, typename TD, typename TE> static bool Read(const IPC::Message* msg, TA* a, TB* b, TC* c, TD* d, TE* e)    \
    {                                                                                                                                                          \
        Schema::Param p;                                                                                                                                       \
        if (!Read(msg, &p))                                                                                                                                    \
            return false;                                                                                                                                      \
...
#define IPC_SYNC_MESSAGE_METHODS_GENERIC                                                                                                                       \
    ...
    {                                                                                                                                                          \
        ...
        return Schema::DispatchWithSendParams(ok, send_params, msg, obj, sender, func);                                                                        \
    }                                                                                                                                                          \
    template <class T, class Method> static bool DispatchDelayReply(const Message* msg, T* obj, Method func)                                                   \
    {                                                                                                                                                          \
        Schema::SendParam send_params;                                                                                                                         \
        bool ok = ReadSendParam(msg, &send_params);                                                                                                            \
        return Schema::DispatchDelayReplyWithSendParams(ok, send_params, msg, obj, func);                                                                      \
    }
#define IPC_SYNC_MESSAGE_METHODS_0 IPC_SYNC_MESSAGE_METHODS_GENERIC
#define IPC_SYNC_MESSAGE_METHODS_1                                                                                                                             \
    IPC_SYNC_MESSAGE_METHODS_GENERIC                                                                                                                           \
    template <typename TA> static void WriteReplyParams(Message* reply, TA a)                                                                                  \
    {                                                                                                                                                          \
        Schema::WriteReplyParams(reply, a);                                                                                                                    \
    }
#define IPC_SYNC_MESSAGE_METHODS_2                                                                                                                             \
    IPC_SYNC_MESSAGE_METHODS_GENERIC                                                                                                                           \
    template <typename TA, typename TB> static void WriteReplyParams(Message* reply, TA a, TB b)                                                               \
    {                                                                                                                                                          \
        Schema::WriteReplyParams(reply, a, b);                                                                                                                 \
    }
#define IPC_SYNC_MESSAGE_METHODS_3                                                                                                                             \
    IPC_SYNC_MESSAGE_METHODS_GENERIC                                                                                                                           \
    template <typename TA, typename TB, typename TC> static void WriteReplyParams(Message* reply, TA a, TB b, TC c)                                            \
    {                                                                                                                                                          \
        Schema::WriteReplyParams(reply, a, b, c);                                                                                                              \
    }
#define IPC_SYNC_MESSAGE_METHODS_4                                                                                                                             \
    IPC_SYNC_MESSAGE_METHODS_GENERIC                                                                                                                           \
    template <typename TA, typename TB, typename TC, typename TD> static void WriteReplyParams(Message* reply, TA a, TB b, TC c, TD d)                         \
    {                                                                                                                                                          \
        Schema::WriteReplyParams(reply, a, b, c, d);                                                                                                           \
    }
#define IPC_SYNC_MESSAGE_METHODS_5                                                                                                                             \
    IPC_SYNC_MESSAGE_METHODS_GENERIC                                                                                                                           \
    template <typename TA, typename TB, typename TC, typename TD, typename TE> static void WriteReplyParams(Message* reply, TA a, TB b, TC c, TD d, TE e)      \
    {                                                                                                                                                          \
...
#define IPC_MESSAGE_DECL(sync, kind, msg_class, in_cnt, out_cnt, in_list, out_list)                                                                            \
    IPC_##sync##_##kind##_DECL(msg_class, in_cnt, out_cnt, in_list, out_list) IPC_MESSAGE_EXTRA(sync, kind, msg_class, in_cnt, out_cnt, in_list, out_list)
...
#define IPC_ASYNC_ROUTED_DECL(msg_class, in_cnt, out_cnt, in_list, out_list)                                                                                   \
    ...
    public:                                                                                                                                                    \
        ...
        typedef Schema::Param Param;                                                                                                                           \
        enum { ID = IPC_MESSAGE_ID() };                                                                                                                        \
        msg_class(int32 routing_id IPC_COMMA_##in_cnt IPC_TYPE_IN_##in_cnt in_list);                                                                           \
        virtual ~msg_class();                                                                                                                                  \
        static bool Read(const Message* msg, Schema::Param* p);                                                                                                \
        static void Log(std::string* name, const Message* msg, std::string* l);                                                                                \
        IPC_ASYNC_MESSAGE_METHODS_##in_cnt                                                                                                                     \
...
#define IPC_SYNC_CONTROL_DECL(msg_class, in_cnt, out_cnt, in_list, out_list)                                                                                   \
    ...
    public:                                                                                                                                                    \
        typedef IPC::SyncMessageSchema<IPC_TUPLE_IN_##in_cnt in_list, IPC_TUPLE_OUT_##out_cnt out_list> Schema;                                                \
        typedef Schema::ReplyParam ReplyParam;                                                                                                                 \
        typedef Schema::SendParam SendParam;                                                                                                                   \
        enum { ID = IPC_MESSAGE_ID() };                                                                                                                        \
        msg_class(IPC_TYPE_IN_##in_cnt in_list IPC_COMMA_AND_##in_cnt(IPC_COMMA_##out_cnt) IPC_TYPE_OUT_##out_cnt out_list);                                   \
        virtual ~msg_class();                                                                                                                                  \
        static bool ReadSendParam(const Message* msg, Schema::SendParam* p);                                                                                   \
        static bool ReadReplyParam(const Message* msg, TupleTypes<ReplyParam>::ValueTuple* p);                                                                 \
        static void Log(std::string* name, const Message* msg, std::string* l);                                                                                \
...
#define IPC_SYNC_ROUTED_DECL(msg_class, in_cnt, out_cnt, in_list, out_list)                                                                                    \
    ...
    public:                                                                                                                                                    \
        ...
        typedef Schema::SendParam SendParam;                                                                                                                   \
        enum { ID = IPC_MESSAGE_ID() };                                                                                                                        \
        msg_class(int32 routing_id IPC_COMMA_OR_##in_cnt(IPC_COMMA_##out_cnt) IPC_TYPE_IN_##in_cnt in_list IPC_COMMA_AND_##in_cnt(IPC_COMMA_##out_cnt)         \
...
#define IPC_MESSAGE_EXTRA(sync, kind, msg_class, in_cnt, out_cnt, in_list, out_list)                                                                           \
    IPC_##sync##_##kind##_IMPL(msg_class, in_cnt, out_cnt, in_list, out_list) IPC_##sync##_MESSAGE_LOG(msg_class)
...
#define IPC_ASYNC_ROUTED_IMPL(msg_class, in_cnt, out_cnt, in_list, out_list)                                                                                   \
    msg_class::msg_class(int32 routing_id IPC_COMMA_##in_cnt IPC_TYPE_IN_##in_cnt in_list)                                                                     \
        : IPC::Message(routing_id, ID, PRIORITY_NORMAL)                                                                                                        \
    {                                                                                                                                                          \
        Schema::Write(this, IPC_NAME_IN_##in_cnt in_list);                                                                                                     \
    }                                                                                                                                                          \
...
#define IPC_SYNC_CONTROL_IMPL(msg_class, in_cnt, out_cnt, in_list, out_list)                                                                                   \
    msg_class::msg_class(IPC_TYPE_IN_##in_cnt in_list IPC_COMMA_AND_##in_cnt(IPC_COMMA_##out_cnt) IPC_TYPE_OUT_##out_cnt out_list)                             \
        : IPC::SyncMessage(MSG_ROUTING_CONTROL, ID, PRIORITY_NORMAL, new IPC::ParamDeserializer<Schema::ReplyParam>(IPC_NAME_OUT_##out_cnt out_list))          \
    {                                                                                                                                                          \
        Schema::Write(this, IPC_NAME_IN_##in_cnt in_list);                                                                                                     \
    }                                                                                                                                                          \
    msg_class::~msg_class()                                                                                                                                    \
    ...
    bool msg_class::ReadReplyParam(const Message* msg, TupleTypes<ReplyParam>::ValueTuple* p)                                                                  \
    {                                                                                                                                                          \
        return Schema::ReadReplyParam(msg, p);                                                                                                                 \
    }

#define IPC_SYNC_ROUTED_IMPL(msg_class, in_cnt, out_cnt, in_list, out_list)                                                                                    \
    msg_class::msg_class(int32 routing_id IPC_COMMA_OR_##in_cnt(IPC_COMMA_##out_cnt) IPC_TYPE_IN_##in_cnt in_list IPC_COMMA_AND_##in_cnt(IPC_COMMA_##out_cnt)  \
            IPC_TYPE_OUT_##out_cnt out_list)                                                                                                                   \
        : IPC::SyncMessage(routing_id, ID, PRIORITY_NORMAL, new IPC::ParamDeserializer<Schema::ReplyParam>(IPC_NAME_OUT_##out_cnt out_list))                   \
    {                                                                                                                                                          \
        Schema::Write(this, IPC_NAME_IN_##in_cnt in_list);                                                                                                     \
    }                                                                                                                                                          \
    msg_class::~msg_class()                                                                                                                                    \
...
#define TRACK_RUN_IN_IPC_HANDLER(func)
...
#define IPC_MESSAGE_HANDLER(msg_class, member_func) IPC_MESSAGE_FORWARD(msg_class, this, _IpcMessageHandlerClass::member_func)
...
#define IPC_MESSAGE_HANDLER_DELAY_REPLY(msg_class, member_func) IPC_MESSAGE_FORWARD_DELAY_REPLY(msg_class, this, _IpcMessageHandlerClass::member_func)
...
#define IPC_MESSAGE_UNHANDLED_ERROR() IPC_MESSAGE_UNHANDLED(NOTREACHED() << "Invalid message with type = " << ipc_message__.type())
