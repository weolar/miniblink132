...
#ifndef LITE_IPC_IPC_PLATFORM_FILE_H_
#define LITE_IPC_IPC_PLATFORM_FILE_H_
...
{
#if defined(OS_WIN)
    return base::kInvalidPlatformFile /*kInvalidPlatformFileValue*/;
#elif defined(OS_POSIX)
    return base::FileDescriptor();
#endif
}

inline base::PlatformFile PlatformFileForTransitToPlatformFile(const PlatformFileForTransit& transit)
{
#if defined(OS_WIN)
    return transit;
#elif defined(OS_POSIX)
