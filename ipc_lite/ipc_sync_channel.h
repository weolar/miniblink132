...
#ifndef LITE_IPC_IPC_SYNC_CHANNEL_H_
#define LITE_IPC_IPC_SYNC_CHANNEL_H_
...
public:
    ...
    SyncChannel(const IPC::ChannelHandle& channel_handle, Channel::Mode mode, Listener* listener, base::SingleThreadTaskRunner* ipc_task_runner,
    ...
    SyncChannel(Listener* listener, base::SingleThreadTaskRunner* ipc_task_runner, base::WaitableEvent* shutdown_event);
...
protected:
    ...
    {
    public:
        SyncContext(Listener* listener, scoped_refptr<base::SingleThreadTaskRunner> ipc_task_runner, base::WaitableEvent* shutdown_event);
...
private:
    ...
    static void WaitForReply(SyncContext* context, base::WaitableEvent* pump_messages_event);
