...
IPC_SYNC_MESSAGE_CONTROL0_1(SyncChannelTestMsg_AnswerToLife, int /* answer */)

IPC_SYNC_MESSAGE_CONTROL1_1(SyncChannelTestMsg_Double, int /* in */, int /* out */)

IPC_SYNC_MESSAGE_CONTROL0_1(SyncChannelNestedTestMsg_String, std::string)
...
IPC_SYNC_MESSAGE_CONTROL3_4(Msg_C_3_4, bool, int, std::string, int, bool, std::string, bool)
...
IPC_SYNC_MESSAGE_ROUTED3_4(Msg_R_3_4, bool, int, std::string, int, bool, std::string, bool)
