...
#ifndef LITE_IPC_IPC_FORWARDING_MESSAGE_FILTER_H_
#define LITE_IPC_IPC_FORWARDING_MESSAGE_FILTER_H_
...
public:
    ...
    typedef base::RepeatingCallback<void(const Message&)> Handler;
    ...
    ForwardingMessageFilter(const uint32* message_ids_to_filter, size_t num_message_ids_to_filter, base::TaskRunner* target_task_runner);
