...
#ifndef LITE_IPC_IPC_MULTIPROCESS_TEST_H_
#define LITE_IPC_IPC_MULTIPROCESS_TEST_H_
...
#define MULTIPROCESS_IPC_TEST_MAIN(test_main) MULTIPROCESS_TEST_MAIN_WITH_SETUP(test_main, MultiProcessTestIPCSetUp)
