...
#ifndef LITE_IPC_IPC_SYNC_MESSAGE_H_
#define LITE_IPC_IPC_SYNC_MESSAGE_H_
...
public:
    SyncMessage(int32 routing_id, uint32 type, PriorityValue priority, MessageReplyDeserializer* deserializer);
    virtual ~SyncMessage();
...
private:
    ...
    virtual bool SerializeOutputParameters(const Message& msg, base::PickleIterator iter) = 0;
};
