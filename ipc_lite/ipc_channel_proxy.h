...
#ifndef LITE_IPC_IPC_CHANNEL_PROXY_H_
#define LITE_IPC_IPC_CHANNEL_PROXY_H_
...
public:
    ...
    class IPC_EXPORT MessageFilter : public base::RefCountedThreadSafe<MessageFilter, MessageFilterTraits> {
    public:
        MessageFilter();
    ...
    private:
        friend class base::RefCountedThreadSafe<MessageFilter, MessageFilterTraits>;
    };
    ...
    ChannelProxy(const IPC::ChannelHandle& channel_handle, Channel::Mode mode, Listener* listener, scoped_refptr<base::SingleThreadTaskRunner> ipc_task_runner);
    ...
    // thread.
    void Init(const IPC::ChannelHandle& channel_handle, Channel::Mode mode, bool create_pipe_now);
...
protected:
    ...
    public:
        Context(Listener* listener, scoped_refptr<base::SingleThreadTaskRunner> ipc_thread);
        void ClearIPCTaskRunner();
    ...
    private:
        ...
        // Create the Channel
        void CreateChannel(const IPC::ChannelHandle& channel_handle, const Channel::Mode& mode);
