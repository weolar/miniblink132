...
#ifndef LITE_IPC_IPC_LOGGING_H_
#define LITE_IPC_IPC_LOGGING_H_

#include "ipc_lite/ipc_message.h" // For IPC_MESSAGE_LOG_ENABLED.
...
typedef std::unordered_map<uint32, LogFunction> LogFunctionMap;
...
public:
    ...
    void OnPostDispatchMessage(const Message& message, const std::string& channel_id);
    ...
    // ipc_logging.cc.
    static void GetMessageText(uint32 type, std::string* name, const Message* message, std::string* params);
