...
#ifndef LITE_IPC_IPC_TESTS_H_
#define LITE_IPC_IPC_TESTS_H_
...
enum ChildType { TEST_CLIENT, TEST_DESCRIPTOR_CLIENT, TEST_DESCRIPTOR_CLIENT_SANDBOXED, TEST_REFLECTOR, FUZZER_SERVER, SYNC_SOCKET_SERVER };
