...
private:
    ...
    {
        IPC::Message* message = new IPC::Message(routing, type_id, IPC::Message::PRIORITY_NORMAL);
...
TEST_F(IPCFuzzingTest, MsgBadPayloadShort)
{
    ...
    IPC::Message* msg = new IPC::Message(MSG_ROUTING_CONTROL, MsgClassIS::ID, IPC::Message::PRIORITY_NORMAL);
    msg->WriteInt(666);
    chan.Send(msg);
...
TEST_F(IPCFuzzingTest, MsgBadPayloadArgs)
{
    ...
    IPC::Message* msg = new IPC::Message(MSG_ROUTING_CONTROL, MsgClassSI::ID, IPC::Message::PRIORITY_NORMAL);
...
#if defined(NDEBUG) && !defined(DCHECK_ALWAYS_ON)
    // Test a bad message.
    msg = new IPC::Message(MSG_ROUTING_CONTROL, MsgClassSI::ID, IPC::Message::PRIORITY_NORMAL);
    msg->WriteInt(2);
    EXPECT_FALSE(server.OnMessageReceived(*msg));
    delete msg;

    msg = new IPC::Message(MSG_ROUTING_CONTROL, MsgClassIS::ID, IPC::Message::PRIORITY_NORMAL);
    msg->WriteInt(0x64);
    msg->WriteInt(0x32);
    EXPECT_FALSE(server.OnMessageReceived(*msg));
    delete msg;
