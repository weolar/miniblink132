...
BigString::BigString(::mojo_base::BigBuffer data_in)
...
void BigString::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool BigString::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::mojo_base::mojom::blink::BigString::DataView, ::mojo_base::mojom::blink::BigStringPtr>::Read(
    ::mojo_base::mojom::blink::BigString::DataView input, ::mojo_base::mojom::blink::BigStringPtr* output)
{
    bool success = true;
