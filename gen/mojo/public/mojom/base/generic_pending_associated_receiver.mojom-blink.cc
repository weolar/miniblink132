...
GenericPendingAssociatedReceiver::GenericPendingAssociatedReceiver(
    const WTF::String& interface_name_in, ::mojo::PendingAssociatedReceiver<GenericAssociatedInterface> receiver_in)
...
void GenericPendingAssociatedReceiver::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool GenericPendingAssociatedReceiver::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
// static
bool GenericAssociatedInterfaceStubDispatch::Accept(GenericAssociatedInterface* impl, mojo::Message* message)
{
    return false;
}
...
bool GenericAssociatedInterfaceStubDispatch::AcceptWithResponder(
    GenericAssociatedInterface* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    return false;
}
namespace {
...
GenericAssociatedInterfaceAsyncWaiter::GenericAssociatedInterfaceAsyncWaiter(GenericAssociatedInterface* proxy)
    : proxy_(proxy)
{
}
