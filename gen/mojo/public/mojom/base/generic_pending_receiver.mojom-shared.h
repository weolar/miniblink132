...
template <> struct MojomTypeTraits<::mojo_base::mojom::GenericPendingReceiverDataView> {
...
public:
    ...
    GenericPendingReceiverDataView(internal::GenericPendingReceiver_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    mojo::ScopedMessagePipeHandle TakeReceivingPipe()
    {
        ...
        bool ret = mojo::internal::Deserialize<mojo::ScopedMessagePipeHandle>(&data_->receiving_pipe, &result, message_);
        DCHECK(ret);
        return result;
    }
...
template <typename MaybeConstUserType> struct Serializer<::mojo_base::mojom::GenericPendingReceiverDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::mojo_base::mojom::GenericPendingReceiverDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::mojo_base::mojom::internal::GenericPendingReceiver_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<mojo::ScopedMessagePipeHandle>(in_receiving_pipe, &fragment->receiving_pipe, &fragment.message());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(fragment->receiving_pipe),
            mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE, "invalid receiving_pipe in GenericPendingReceiver struct");
    }

    static bool Deserialize(::mojo_base::mojom::internal::GenericPendingReceiver_Data* input, UserType* output, Message* message)
    {
        if (!input)
...
inline void GenericPendingReceiverDataView::GetInterfaceNameDataView(mojo::StringDataView* output)
{
    auto pointer = data_->interface_name.Get();
