...
String16::String16(WTF::Vector<uint16_t> data_in)
...
void String16::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool String16::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
BigString16::BigString16(::mojo_base::BigBuffer data_in)
    : data(std::move(data_in))
{
}
...
void BigString16::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("data"), this->data,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool BigString16::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
bool StructTraits<::mojo_base::mojom::blink::String16::DataView, ::mojo_base::mojom::blink::String16Ptr>::Read(
    ::mojo_base::mojom::blink::String16::DataView input, ::mojo_base::mojom::blink::String16Ptr* output)
{
    bool success = true;
...
bool StructTraits<::mojo_base::mojom::blink::BigString16::DataView, ::mojo_base::mojom::blink::BigString16Ptr>::Read(
    ::mojo_base::mojom::blink::BigString16::DataView input, ::mojo_base::mojom::blink::BigString16Ptr* output)
{
    bool success = true;
