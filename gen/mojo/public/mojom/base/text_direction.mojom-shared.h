...
{
    return internal::TextDirection_Data::IsKnownValue(static_cast<int32_t>(value));
}
...
template <> struct hash<::mojo_base::mojom::TextDirection> : public mojo::internal::EnumHashImpl<::mojo_base::mojom::TextDirection> { };
...
template <typename MaybeConstUserType> struct Serializer<::mojo_base::mojom::TextDirection, MaybeConstUserType> {
    ...
    {
        return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(static_cast<::mojo_base::mojom::TextDirection>(input)), output);
    }
};
...
template <> struct COMPONENT_EXPORT(MOJO_BASE_MOJOM_SHARED) TraceFormatTraits<::mojo_base::mojom::TextDirection> {
