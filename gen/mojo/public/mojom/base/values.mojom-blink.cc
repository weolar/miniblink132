...
DictionaryValue::DictionaryValue(WTF::HashMap<WTF::String, ::base::Value> storage_in)
...
ListValue::ListValue(WTF::Vector<::base::Value> storage_in)
    : storage(std::move(storage_in))
{
}
...
void Value::set_binary_value(WTF::Vector<uint8_t> binary_value)
{
    if (tag_ == Tag::kBinaryValue) {
        *(data_.binary_value) = std::move(binary_value);
        ...
        data_.binary_value = new WTF::Vector<uint8_t>(std::move(binary_value));
    }
}
...
bool StructTraits<::mojo_base::mojom::blink::DictionaryValue::DataView, ::mojo_base::mojom::blink::DictionaryValuePtr>::Read(
    ::mojo_base::mojom::blink::DictionaryValue::DataView input, ::mojo_base::mojom::blink::DictionaryValuePtr* output)
{
    bool success = true;
...
bool StructTraits<::mojo_base::mojom::blink::ListValue::DataView, ::mojo_base::mojom::blink::ListValuePtr>::Read(
    ::mojo_base::mojom::blink::ListValue::DataView input, ::mojo_base::mojom::blink::ListValuePtr* output)
{
    bool success = true;
...
bool UnionTraits<::mojo_base::mojom::blink::Value::DataView, ::mojo_base::mojom::blink::ValuePtr>::Read(
    ::mojo_base::mojom::blink::Value::DataView input, ::mojo_base::mojom::blink::ValuePtr* output)
{
