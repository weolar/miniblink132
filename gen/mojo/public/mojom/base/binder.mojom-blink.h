...
template <typename ImplRefTraits> class BinderStub;

class BinderRequestValidator;

class COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) Binder : public BinderInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = BinderStub<ImplRefTraits>;
...
class COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) BinderProxy : public Binder {
public:
...
public:
    ...
    static bool AcceptWithResponder(Binder* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<Binder>> class BinderStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return BinderStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return BinderStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
