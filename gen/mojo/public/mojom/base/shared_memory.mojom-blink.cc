...
ReadOnlySharedMemoryRegion::ReadOnlySharedMemoryRegion(::mojo::ScopedSharedBufferHandle buffer_in)
...
void ReadOnlySharedMemoryRegion::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("buffer"), this->buffer,
...
bool ReadOnlySharedMemoryRegion::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
WritableSharedMemoryRegion::WritableSharedMemoryRegion(::mojo::ScopedSharedBufferHandle buffer_in)
    : buffer(std::move(buffer_in))
{
}
...
void WritableSharedMemoryRegion::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("buffer"), this->buffer,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool WritableSharedMemoryRegion::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
UnsafeSharedMemoryRegion::UnsafeSharedMemoryRegion(::mojo::ScopedSharedBufferHandle buffer_in)
    : buffer(std::move(buffer_in))
{
}
...
void UnsafeSharedMemoryRegion::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("buffer"), this->buffer,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool UnsafeSharedMemoryRegion::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
bool StructTraits<::mojo_base::mojom::blink::ReadOnlySharedMemoryRegion::DataView, ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr>::Read(
    ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegion::DataView input, ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr* output)
{
    bool success = true;
...
bool StructTraits<::mojo_base::mojom::blink::WritableSharedMemoryRegion::DataView, ::mojo_base::mojom::blink::WritableSharedMemoryRegionPtr>::Read(
    ::mojo_base::mojom::blink::WritableSharedMemoryRegion::DataView input, ::mojo_base::mojom::blink::WritableSharedMemoryRegionPtr* output)
{
    bool success = true;
...
bool StructTraits<::mojo_base::mojom::blink::UnsafeSharedMemoryRegion::DataView, ::mojo_base::mojom::blink::UnsafeSharedMemoryRegionPtr>::Read(
    ::mojo_base::mojom::blink::UnsafeSharedMemoryRegion::DataView input, ::mojo_base::mojom::blink::UnsafeSharedMemoryRegionPtr* output)
{
    bool success = true;
