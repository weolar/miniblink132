...
RefCountedMemory::RefCountedMemory(::mojo_base::BigBuffer data_in)
...
void RefCountedMemory::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool RefCountedMemory::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::mojo_base::mojom::blink::RefCountedMemory::DataView, ::mojo_base::mojom::blink::RefCountedMemoryPtr>::Read(
    ::mojo_base::mojom::blink::RefCountedMemory::DataView input, ::mojo_base::mojom::blink::RefCountedMemoryPtr* output)
{
    bool success = true;
