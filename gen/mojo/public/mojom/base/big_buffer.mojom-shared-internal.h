...
static_assert(sizeof(BigBuffer_Data) == mojo::internal::kUnionDataSize, "Bad sizeof(BigBuffer_Data)");
...
static_assert(sizeof(BigBufferSharedMemoryRegion_Data) == 16, "Bad sizeof(BigBufferSharedMemoryRegion_Data)");
// Used by BigBufferSharedMemoryRegion::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct BigBufferSharedMemoryRegion_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    BigBufferSharedMemoryRegion_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag BigBufferSharedMemoryRegion_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
