...
template <> struct MojomTypeTraits<::mojo_base::mojom::RefCountedMemoryDataView> {
...
public:
    ...
    RefCountedMemoryDataView(internal::RefCountedMemory_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
template <typename MaybeConstUserType> struct Serializer<::mojo_base::mojom::RefCountedMemoryDataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::mojo_base::mojom::RefCountedMemoryDataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::mojo_base::mojom::internal::RefCountedMemory_Data>& fragment)
    {
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in RefCountedMemory struct");
    }

    static bool Deserialize(::mojo_base::mojom::internal::RefCountedMemory_Data* input, UserType* output, Message* message)
    {
        if (!input)
...
inline void RefCountedMemoryDataView::GetDataDataView(::mojo_base::mojom::BigBufferDataView* output)
{
