...
// static
bool ByteString_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const ByteString_Data* object = static_cast<const ByteString_Data*>(data);
