...
ReadOnlyBuffer::ReadOnlyBuffer(WTF::Vector<uint8_t> buffer_in)
...
void ReadOnlyBuffer::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool ReadOnlyBuffer::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::mojo_base::mojom::blink::ReadOnlyBuffer::DataView, ::mojo_base::mojom::blink::ReadOnlyBufferPtr>::Read(
    ::mojo_base::mojom::blink::ReadOnlyBuffer::DataView input, ::mojo_base::mojom::blink::ReadOnlyBufferPtr* output)
{
    bool success = true;
