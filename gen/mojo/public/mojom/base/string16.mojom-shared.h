...
template <> struct MojomTypeTraits<::mojo_base::mojom::String16DataView> {
    using Data = ::mojo_base::mojom::internal::String16_Data;
    using DataAsArrayElement = Pointer<Data>;
    static constexpr MojomTypeCategory category = MojomTypeCategory::kStruct;
};

template <> struct MojomTypeTraits<::mojo_base::mojom::BigString16DataView> {
...
public:
    ...
    String16DataView(internal::String16_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetDataDataView(mojo::ArrayDataView<uint16_t>* output);
...
public:
    ...
    BigString16DataView(internal::BigString16_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
template <typename MaybeConstUserType> struct Serializer<::mojo_base::mojom::String16DataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::mojo_base::mojom::String16DataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::mojo_base::mojom::internal::String16_Data>& fragment)
    {
        ...
        mojo::internal::Serialize<mojo::ArrayDataView<uint16_t>>(in_data, data_fragment, &data_validate_params);
        fragment->data.Set(data_fragment.is_null() ? nullptr : data_fragment.data());
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in String16 struct");
    }

    static bool Deserialize(::mojo_base::mojom::internal::String16_Data* input, UserType* output, Message* message)
    {
        if (!input)
...
template <typename MaybeConstUserType> struct Serializer<::mojo_base::mojom::BigString16DataView, MaybeConstUserType> {
    using UserType = typename std::remove_const<MaybeConstUserType>::type;
    using Traits = StructTraits<::mojo_base::mojom::BigString16DataView, UserType>;

    static void Serialize(MaybeConstUserType& input, mojo::internal::MessageFragment<::mojo_base::mojom::internal::BigString16_Data>& fragment)
    {
        if (CallIsNullIfExists<Traits>(input))
            return;
        fragment.Allocate();
        ...
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            fragment->data.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null data in BigString16 struct");
    }

    static bool Deserialize(::mojo_base::mojom::internal::BigString16_Data* input, UserType* output, Message* message)
    {
        if (!input)
            return CallSetToNullIfExists<Traits>(output);
...
inline void String16DataView::GetDataDataView(mojo::ArrayDataView<uint16_t>* output)
{
    auto pointer = data_->data.Get();
    *output = mojo::ArrayDataView<uint16_t>(pointer, message_);
}

inline void BigString16DataView::GetDataDataView(::mojo_base::mojom::BigBufferDataView* output)
{
