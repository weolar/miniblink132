...
// static
bool UnguessableToken_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const UnguessableToken_Data* object = static_cast<const UnguessableToken_Data*>(data);
