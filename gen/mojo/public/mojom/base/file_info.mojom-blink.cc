...
FileInfo::FileInfo(int64_t size_in, bool is_directory_in, bool is_symbolic_link_in, ::base::Time last_modified_in, ::base::Time last_accessed_in,
...
void FileInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("is_symbolic_link"), this->is_symbolic_link,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type bool>"
#else
        "<value>"
...
bool FileInfo::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::mojo_base::mojom::blink::FileInfo::DataView, ::mojo_base::mojom::blink::FileInfoPtr>::Read(
    ::mojo_base::mojom::blink::FileInfo::DataView input, ::mojo_base::mojom::blink::FileInfoPtr* output)
{
    bool success = true;
