...
// static
bool SerializedHandle_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const SerializedHandle_Data* object = static_cast<const SerializedHandle_Data*>(data);

    if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(object->the_handle, 1, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateHandleOrInterface(object->the_handle, validation_context)) {
        return false;
    }

    if (!::mojo::native::internal::SerializedHandleType_Data ::Validate(object->type, validation_context))
        return false;
...
// static
bool NativeStruct_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const NativeStruct_Data* object = static_cast<const NativeStruct_Data*>(data);
    ...
    constexpr const mojo::internal::ContainerValidateParams& handles_validate_params = mojo::internal::GetArrayValidator<0, false, nullptr>();
    if (!mojo::internal::ValidateContainer(object->handles, validation_context, &handles_validate_params)) {
        return false;
    }
...
// static
void TraceFormatTraits<::mojo::native::SerializedHandleType>::WriteIntoTrace(perfetto::TracedValue context, ::mojo::native::SerializedHandleType value)
{
