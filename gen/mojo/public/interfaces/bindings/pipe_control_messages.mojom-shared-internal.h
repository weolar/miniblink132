...
static_assert(sizeof(DisconnectReason_Data) == 24, "Bad sizeof(DisconnectReason_Data)");
// Used by DisconnectReason::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct DisconnectReason_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    DisconnectReason_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag DisconnectReason_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
static_assert(sizeof(PeerAssociatedEndpointClosedEvent_Data) == 24, "Bad sizeof(PeerAssociatedEndpointClosedEvent_Data)");
// Used by PeerAssociatedEndpointClosedEvent::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct PeerAssociatedEndpointClosedEvent_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    PeerAssociatedEndpointClosedEvent_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag PeerAssociatedEndpointClosedEvent_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
static_assert(sizeof(PauseUntilFlushCompletes_Data) == 16, "Bad sizeof(PauseUntilFlushCompletes_Data)");
// Used by PauseUntilFlushCompletes::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct PauseUntilFlushCompletes_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    PauseUntilFlushCompletes_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag PauseUntilFlushCompletes_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
static_assert(sizeof(FlushAsync_Data) == 16, "Bad sizeof(FlushAsync_Data)");
// Used by FlushAsync::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct FlushAsync_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    FlushAsync_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag FlushAsync_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
