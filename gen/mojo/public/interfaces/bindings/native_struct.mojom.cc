...
SerializedHandle::SerializedHandle(::mojo::ScopedHandle the_handle_in, SerializedHandleType type_in)
...
void SerializedHandle::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("the_handle"), this->the_handle,
...
bool SerializedHandle::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
NativeStruct::NativeStruct(std::vector<uint8_t> data_in, std::optional<std::vector<SerializedHandlePtr>> handles_in)
...
void NativeStruct::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("handles"), this->handles,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool NativeStruct::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
bool StructTraits<::mojo::native::SerializedHandle::DataView, ::mojo::native::SerializedHandlePtr>::Read(
    ::mojo::native::SerializedHandle::DataView input, ::mojo::native::SerializedHandlePtr* output)
{
    bool success = true;
...
bool StructTraits<::mojo::native::NativeStruct::DataView, ::mojo::native::NativeStructPtr>::Read(
    ::mojo::native::NativeStruct::DataView input, ::mojo::native::NativeStructPtr* output)
{
    bool success = true;
