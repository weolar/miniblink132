...
DisconnectReason::DisconnectReason(uint32_t custom_reason_in, const std::string& description_in)
...
void DisconnectReason::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("custom_reason"), this->custom_reason,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool DisconnectReason::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
PeerAssociatedEndpointClosedEvent::PeerAssociatedEndpointClosedEvent(uint32_t id_in, DisconnectReasonPtr disconnect_reason_in)
    : id(std::move(id_in))
...
void PeerAssociatedEndpointClosedEvent::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("disconnect_reason"), this->disconnect_reason,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool PeerAssociatedEndpointClosedEvent::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
PauseUntilFlushCompletes::PauseUntilFlushCompletes(::mojo::ScopedMessagePipeHandle flush_pipe_in)
...
void PauseUntilFlushCompletes::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("flush_pipe"), this->flush_pipe,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool PauseUntilFlushCompletes::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
FlushAsync::FlushAsync(::mojo::ScopedMessagePipeHandle flusher_pipe_in)
...
void FlushAsync::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("flusher_pipe"), this->flusher_pipe,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::mojo::ScopedMessagePipeHandle>"
#else
        "<value>"
...
bool FlushAsync::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    return Data_::Validate(data, validation_context);
}
...
void RunOrClosePipeInput::set_peer_associated_endpoint_closed_event(PeerAssociatedEndpointClosedEventPtr peer_associated_endpoint_closed_event)
{
    if (tag_ == Tag::kPeerAssociatedEndpointClosedEvent) {
        *(data_.peer_associated_endpoint_closed_event) = std::move(peer_associated_endpoint_closed_event);
        ...
        DestroyActive();
        tag_ = Tag::kPeerAssociatedEndpointClosedEvent;
        data_.peer_associated_endpoint_closed_event = new PeerAssociatedEndpointClosedEventPtr(std::move(peer_associated_endpoint_closed_event));
    }
}
void RunOrClosePipeInput::set_pause_until_flush_completes(PauseUntilFlushCompletesPtr pause_until_flush_completes)
{
    if (tag_ == Tag::kPauseUntilFlushCompletes) {
        *(data_.pause_until_flush_completes) = std::move(pause_until_flush_completes);
        ...
        data_.pause_until_flush_completes = new PauseUntilFlushCompletesPtr(std::move(pause_until_flush_completes));
    }
}
void RunOrClosePipeInput::set_flush_async(FlushAsyncPtr flush_async)
{
    if (tag_ == Tag::kFlushAsync) {
        *(data_.flush_async) = std::move(flush_async);
        ...
        data_.flush_async = new FlushAsyncPtr(std::move(flush_async));
    }
}
...
bool StructTraits<::mojo::pipe_control::RunOrClosePipeMessageParams::DataView, ::mojo::pipe_control::RunOrClosePipeMessageParamsPtr>::Read(
    ::mojo::pipe_control::RunOrClosePipeMessageParams::DataView input, ::mojo::pipe_control::RunOrClosePipeMessageParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::mojo::pipe_control::DisconnectReason::DataView, ::mojo::pipe_control::DisconnectReasonPtr>::Read(
    ::mojo::pipe_control::DisconnectReason::DataView input, ::mojo::pipe_control::DisconnectReasonPtr* output)
{
    bool success = true;
...
bool StructTraits<::mojo::pipe_control::PauseUntilFlushCompletes::DataView, ::mojo::pipe_control::PauseUntilFlushCompletesPtr>::Read(
    ::mojo::pipe_control::PauseUntilFlushCompletes::DataView input, ::mojo::pipe_control::PauseUntilFlushCompletesPtr* output)
{
    bool success = true;
...
bool StructTraits<::mojo::pipe_control::FlushAsync::DataView, ::mojo::pipe_control::FlushAsyncPtr>::Read(
    ::mojo::pipe_control::FlushAsync::DataView input, ::mojo::pipe_control::FlushAsyncPtr* output)
{
    bool success = true;
...
bool UnionTraits<::mojo::pipe_control::RunOrClosePipeInput::DataView, ::mojo::pipe_control::RunOrClosePipeInputPtr>::Read(
    ::mojo::pipe_control::RunOrClosePipeInput::DataView input, ::mojo::pipe_control::RunOrClosePipeInputPtr* output)
{
    ...
    case Tag::kPeerAssociatedEndpointClosedEvent: {
        ...
        *output = UnionType::NewPeerAssociatedEndpointClosedEvent(std::move(result_peer_associated_endpoint_closed_event));
        break;
    }
    case Tag::kPauseUntilFlushCompletes: {
        ...
        *output = UnionType::NewPauseUntilFlushCompletes(std::move(result_pause_until_flush_completes));
        break;
    }
    case Tag::kFlushAsync: {
        ...
        *output = UnionType::NewFlushAsync(std::move(result_flush_async));
        break;
    }
    default:
