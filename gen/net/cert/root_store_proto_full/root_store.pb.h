...
class ConstraintSet final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:chrome_root_store.ConstraintSet) */ {
public:
...
class TrustAnchor final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:chrome_root_store.TrustAnchor) */ {
public:
    inline TrustAnchor()
        : TrustAnchor(nullptr)
    {
...
class RootStore final : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:chrome_root_store.RootStore) */ {
public:
    inline RootStore()
        : RootStore(nullptr)
    {
