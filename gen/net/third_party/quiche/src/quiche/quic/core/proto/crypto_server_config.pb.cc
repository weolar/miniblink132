...
PROTOBUF_CONSTEXPR QuicServerConfigProtobuf_PrivateKey::QuicServerConfigProtobuf_PrivateKey(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {},
        /*decltype(_impl_.private_key_)*/ { &::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized {} }, /*decltype(_impl_.tag_)*/ 0u }
{
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 QuicServerConfigProtobuf_PrivateKeyDefaultTypeInternal
...
PROTOBUF_CONSTEXPR QuicServerConfigProtobuf::QuicServerConfigProtobuf(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {}, /*decltype(_impl_.key_)*/ {},
        /*decltype(_impl_.config_)*/ { &::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized {} }, /*decltype(_impl_.primary_time_)*/ int64_t { 0 },
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 QuicServerConfigProtobufDefaultTypeInternal
...
QuicServerConfigProtobuf_PrivateKey::QuicServerConfigProtobuf_PrivateKey(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
...
inline void QuicServerConfigProtobuf_PrivateKey::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_)
        Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.private_key_) {}, decltype(_impl_.tag_) { 0u } };
    _impl_.private_key_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.private_key_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
uint8_t* QuicServerConfigProtobuf_PrivateKey::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void QuicServerConfigProtobuf_PrivateKey::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const QuicServerConfigProtobuf_PrivateKey*>(&from));
}
...
QuicServerConfigProtobuf::QuicServerConfigProtobuf(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned)
{
    SharedCtor(arena, is_message_owned);
    ...
    : ::PROTOBUF_NAMESPACE_ID::MessageLite()
{
    ...
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {},
        decltype(_impl_.key_) { from._impl_.key_ }, decltype(_impl_.config_) {}, decltype(_impl_.primary_time_) {}, decltype(_impl_.priority_) {} };
    ...
    ::memcpy(&_impl_.primary_time_, &from._impl_.primary_time_,
        static_cast<size_t>(reinterpret_cast<char*>(&_impl_.priority_) - reinterpret_cast<char*>(&_impl_.primary_time_)) + sizeof(_impl_.priority_));
    // @@protoc_insertion_point(copy_constructor:quic.QuicServerConfigProtobuf)
}

inline void QuicServerConfigProtobuf::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.key_) { arena }, decltype(_impl_.config_) {},
        decltype(_impl_.primary_time_) { int64_t { 0 } }, decltype(_impl_.priority_) { uint64_t { 0u } } };
    _impl_.config_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.config_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
uint8_t* QuicServerConfigProtobuf::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    // required bytes config = 1;
    if (cached_has_bits & 0x00000001u) {
        target = stream->WriteBytesMaybeAliased(1, this->_internal_config(), target);
    }
...
size_t QuicServerConfigProtobuf::ByteSizeLong() const
{
    ...
    if (_internal_has_config()) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(this->_internal_config());
    }
    uint32_t cached_has_bits = 0;
    // Prevent compiler warnings about cached_has_bits being unused
    (void)cached_has_bits;
...
void QuicServerConfigProtobuf::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const QuicServerConfigProtobuf*>(&from));
}
...
void QuicServerConfigProtobuf::InternalSwap(QuicServerConfigProtobuf* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&_impl_.config_, lhs_arena, &other->_impl_.config_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(QuicServerConfigProtobuf, _impl_.priority_)
        + sizeof(QuicServerConfigProtobuf::_impl_.priority_) - PROTOBUF_FIELD_OFFSET(QuicServerConfigProtobuf, _impl_.primary_time_)>(
        reinterpret_cast<char*>(&_impl_.primary_time_), reinterpret_cast<char*>(&other->_impl_.primary_time_));
}
