...
PROTOBUF_CONSTEXPR SourceAddressToken::SourceAddressToken(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {},
        ...
        /*decltype(_impl_.cached_network_parameters_)*/ nullptr, /*decltype(_impl_.timestamp_)*/ int64_t { 0 } }
{
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SourceAddressTokensDefaultTypeInternal
...
const ::quic::CachedNetworkParameters& SourceAddressToken::_Internal::cached_network_parameters(const SourceAddressToken* msg)
{
...
SourceAddressToken::SourceAddressToken(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    ...
    : ::PROTOBUF_NAMESPACE_ID::MessageLite()
{
    ...
    (void)_this;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.ip_) {},
        decltype(_impl_.cached_network_parameters_) { nullptr }, decltype(_impl_.timestamp_) {} };
...
inline void SourceAddressToken::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.ip_) {},
        decltype(_impl_.cached_network_parameters_) { nullptr }, decltype(_impl_.timestamp_) { int64_t { 0 } } };
    _impl_.ip_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.ip_.Set("", GetArenaForAllocation());
...
inline void SourceAddressToken::SharedDtor()
{
    ...
    if (this != internal_default_instance())
        delete _impl_.cached_network_parameters_;
}
...
uint8_t* SourceAddressToken::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    // required bytes ip = 1;
    if (cached_has_bits & 0x00000001u) {
        target = stream->WriteBytesMaybeAliased(1, this->_internal_ip(), target);
    }
    ...
    if (cached_has_bits & 0x00000002u) {
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            3, _Internal::cached_network_parameters(this), _Internal::cached_network_parameters(this).GetCachedSize(), target, stream);
    }
...
size_t SourceAddressToken::RequiredFieldsByteSizeFallback() const
{
    ...
    if (_internal_has_ip()) {
        // required bytes ip = 1;
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(this->_internal_ip());
    }
...
size_t SourceAddressToken::ByteSizeLong() const
{
    ...
    cached_has_bits = _impl_._has_bits_[0];
    if (cached_has_bits & 0x00000002u) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(*_impl_.cached_network_parameters_);
    }
...
void SourceAddressToken::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const SourceAddressToken*>(&from));
}
...
void SourceAddressToken::MergeFrom(const SourceAddressToken& from)
{
    ...
    if (cached_has_bits & 0x00000007u) {
        ...
        if (cached_has_bits & 0x00000002u) {
            _this->_internal_mutable_cached_network_parameters()->::quic::CachedNetworkParameters::MergeFrom(from._internal_cached_network_parameters());
        }
        if (cached_has_bits & 0x00000004u) {
            _this->_impl_.timestamp_ = from._impl_.timestamp_;
        }
...
void SourceAddressToken::InternalSwap(SourceAddressToken* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&_impl_.ip_, lhs_arena, &other->_impl_.ip_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(SourceAddressToken, _impl_.timestamp_) + sizeof(SourceAddressToken::_impl_.timestamp_)
        - PROTOBUF_FIELD_OFFSET(SourceAddressToken, _impl_.cached_network_parameters_)>(
        reinterpret_cast<char*>(&_impl_.cached_network_parameters_), reinterpret_cast<char*>(&other->_impl_.cached_network_parameters_));
}
...
SourceAddressTokens::SourceAddressTokens(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned)
{
    SharedCtor(arena, is_message_owned);
...
inline void SourceAddressTokens::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
...
uint8_t* SourceAddressTokens::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void SourceAddressTokens::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const SourceAddressTokens*>(&from));
}
