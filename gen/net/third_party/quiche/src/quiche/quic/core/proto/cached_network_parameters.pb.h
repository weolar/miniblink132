...
constexpr CachedNetworkParameters_PreviousConnectionState CachedNetworkParameters_PreviousConnectionState_PreviousConnectionState_MIN
    = CachedNetworkParameters_PreviousConnectionState_SLOW_START;
constexpr CachedNetworkParameters_PreviousConnectionState CachedNetworkParameters_PreviousConnectionState_PreviousConnectionState_MAX
    = CachedNetworkParameters_PreviousConnectionState_CONGESTION_AVOIDANCE;
constexpr int CachedNetworkParameters_PreviousConnectionState_PreviousConnectionState_ARRAYSIZE
    = CachedNetworkParameters_PreviousConnectionState_PreviousConnectionState_MAX + 1;
...
template <typename T> inline const std::string& CachedNetworkParameters_PreviousConnectionState_Name(T enum_t_value)
{
    static_assert(::std::is_same<T, CachedNetworkParameters_PreviousConnectionState>::value || ::std::is_integral<T>::value,
...
class COMPONENT_EXPORT(QUICHE) CachedNetworkParameters final : public ::PROTOBUF_NAMESPACE_ID::MessageLite
/* @@protoc_insertion_point(class_definition:quic.CachedNetworkParameters) */ {
public:
    inline CachedNetworkParameters()
        : CachedNetworkParameters(nullptr)
    {
    }
    ...
    {
        return reinterpret_cast<const CachedNetworkParameters*>(&_CachedNetworkParameters_default_instance_);
    }
...
protected:
    explicit CachedNetworkParameters(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
...
public:
    ...
    template <typename T> static inline const std::string& PreviousConnectionState_Name(T enum_t_value)
    {
        static_assert(::std::is_same<T, PreviousConnectionState>::value || ::std::is_integral<T>::value,
    ...
    static inline bool PreviousConnectionState_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PreviousConnectionState* value)
    {
...
public:
    ...
    template <typename ArgT0 = const std::string&, typename... ArgT> void set_serving_region(ArgT0&& arg0, ArgT... args);
...
template <typename ArgT0, typename... ArgT> inline PROTOBUF_ALWAYS_INLINE void CachedNetworkParameters::set_serving_region(ArgT0&& arg0, ArgT... args)
{
    _impl_._has_bits_[0] |= 0x00000001u;
    _impl_.serving_region_.Set(static_cast<ArgT0&&>(arg0), args..., GetArenaForAllocation());
...
{
    _impl_._has_bits_[0] |= 0x00000001u;
    _impl_.serving_region_.Set(value, GetArenaForAllocation());
}
inline std::string* CachedNetworkParameters::_internal_mutable_serving_region()
{
    _impl_._has_bits_[0] |= 0x00000001u;
    return _impl_.serving_region_.Mutable(GetArenaForAllocation());
}
inline std::string* CachedNetworkParameters::release_serving_region()
{
    ...
    _impl_._has_bits_[0] &= ~0x00000001u;
    auto* p = _impl_.serving_region_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    if (_impl_.serving_region_.IsDefault()) {
...
inline void CachedNetworkParameters::set_allocated_serving_region(std::string* serving_region)
{
    ...
    _impl_.serving_region_.SetAllocated(serving_region, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    if (_impl_.serving_region_.IsDefault()) {
        _impl_.serving_region_.Set("", GetArenaForAllocation());
    }
