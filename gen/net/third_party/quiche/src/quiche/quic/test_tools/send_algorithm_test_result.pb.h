...
public:
    inline SendAlgorithmTestResult()
        : SendAlgorithmTestResult(nullptr)
    {
    }
    ...
    {
        return reinterpret_cast<const SendAlgorithmTestResult*>(&_SendAlgorithmTestResult_default_instance_);
    }
...
protected:
    explicit SendAlgorithmTestResult(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
...
public:
    ...
    template <typename ArgT0 = const std::string&, typename... ArgT> void set_test_name(ArgT0&& arg0, ArgT... args);
...
template <typename ArgT0, typename... ArgT> inline PROTOBUF_ALWAYS_INLINE void SendAlgorithmTestResult::set_test_name(ArgT0&& arg0, ArgT... args)
{
    _impl_._has_bits_[0] |= 0x00000001u;
