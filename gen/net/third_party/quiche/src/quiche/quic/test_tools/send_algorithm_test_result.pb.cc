...
PROTOBUF_CONSTEXPR SendAlgorithmTestResult::SendAlgorithmTestResult(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {},
        ...
        /*decltype(_impl_.random_seed_)*/ uint64_t { 0u }, /*decltype(_impl_.simulated_duration_micros_)*/ int64_t { 0 } }
{
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SendAlgorithmTestResultDefaultTypeInternal
...
SendAlgorithmTestResult::SendAlgorithmTestResult(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    ...
    : ::PROTOBUF_NAMESPACE_ID::MessageLite()
{
    ...
    (void)_this;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.test_name_) {},
        decltype(_impl_.random_seed_) {}, decltype(_impl_.simulated_duration_micros_) {} };
    ...
    ::memcpy(&_impl_.random_seed_, &from._impl_.random_seed_,
        static_cast<size_t>(reinterpret_cast<char*>(&_impl_.simulated_duration_micros_) - reinterpret_cast<char*>(&_impl_.random_seed_))
            + sizeof(_impl_.simulated_duration_micros_));
    // @@protoc_insertion_point(copy_constructor:quic.SendAlgorithmTestResult)
}

inline void SendAlgorithmTestResult::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.test_name_) {},
        decltype(_impl_.random_seed_) { uint64_t { 0u } }, decltype(_impl_.simulated_duration_micros_) { int64_t { 0 } } };
    _impl_.test_name_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.test_name_.Set("", GetArenaForAllocation());
...
uint8_t* SendAlgorithmTestResult::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    // optional string test_name = 1;
    if (cached_has_bits & 0x00000001u) {
        target = stream->WriteStringMaybeAliased(1, this->_internal_test_name(), target);
    }
...
size_t SendAlgorithmTestResult::ByteSizeLong() const
{
    ...
    if (cached_has_bits & 0x00000007u) {
        // optional string test_name = 1;
        if (cached_has_bits & 0x00000001u) {
            total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(this->_internal_test_name());
        }
...
void SendAlgorithmTestResult::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const SendAlgorithmTestResult*>(&from));
}
...
void SendAlgorithmTestResult::InternalSwap(SendAlgorithmTestResult* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&_impl_.test_name_, lhs_arena, &other->_impl_.test_name_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(SendAlgorithmTestResult, _impl_.simulated_duration_micros_)
        + sizeof(SendAlgorithmTestResult::_impl_.simulated_duration_micros_) - PROTOBUF_FIELD_OFFSET(SendAlgorithmTestResult, _impl_.random_seed_)>(
        reinterpret_cast<char*>(&_impl_.random_seed_), reinterpret_cast<char*>(&other->_impl_.random_seed_));
}
