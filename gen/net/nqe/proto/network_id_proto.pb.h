...
public:
    inline NetworkIDProto()
        : NetworkIDProto(nullptr)
    {
    }
    ...
    {
        return reinterpret_cast<const NetworkIDProto*>(&_NetworkIDProto_default_instance_);
    }
...
protected:
    explicit NetworkIDProto(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
...
template <typename ArgT0, typename... ArgT> inline PROTOBUF_ALWAYS_INLINE void NetworkIDProto::set_id(ArgT0&& arg0, ArgT... args)
{
    _impl_._has_bits_[0] |= 0x00000001u;
