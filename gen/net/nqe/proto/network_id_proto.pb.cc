...
PROTOBUF_CONSTEXPR NetworkIDProto::NetworkIDProto(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {},
        /*decltype(_impl_.id_)*/ { &::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized {} }, /*decltype(_impl_.connection_type_)*/ 0,
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 NetworkIDProtoDefaultTypeInternal _NetworkIDProto_default_instance_;
} // namespace internal
} // namespace nqe
} // namespace net
namespace net {
...
public:
    using HasBits = decltype(std::declval<NetworkIDProto>()._impl_._has_bits_);
...
NetworkIDProto::NetworkIDProto(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    ...
    : ::PROTOBUF_NAMESPACE_ID::MessageLite()
{
    ...
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.id_) {},
        decltype(_impl_.connection_type_) {}, decltype(_impl_.signal_strength_) {} };
    ...
    ::memcpy(&_impl_.connection_type_, &from._impl_.connection_type_,
        static_cast<size_t>(reinterpret_cast<char*>(&_impl_.signal_strength_) - reinterpret_cast<char*>(&_impl_.connection_type_))
            + sizeof(_impl_.signal_strength_));
    // @@protoc_insertion_point(copy_constructor:net.nqe.internal.NetworkIDProto)
}

inline void NetworkIDProto::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.id_) {},
        decltype(_impl_.connection_type_) { 0 }, decltype(_impl_.signal_strength_) { 0 } };
    _impl_.id_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.id_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void NetworkIDProto::Clear()
{
    ...
    if (cached_has_bits & 0x00000006u) {
        ::memset(&_impl_.connection_type_, 0,
            static_cast<size_t>(reinterpret_cast<char*>(&_impl_.signal_strength_) - reinterpret_cast<char*>(&_impl_.connection_type_))
                + sizeof(_impl_.signal_strength_));
    }
    ...
    while (!ctx->Done(&ptr)) {
        ...
        case 1:
            if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
                ...
                _impl_.connection_type_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
                CHK_(ptr);
            } else
                goto handle_unusual;
            continue;
...
uint8_t* NetworkIDProto::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void NetworkIDProto::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const NetworkIDProto*>(&from));
}
...
void NetworkIDProto::InternalSwap(NetworkIDProto* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::memswap<PROTOBUF_FIELD_OFFSET(NetworkIDProto, _impl_.signal_strength_) + sizeof(NetworkIDProto::_impl_.signal_strength_)
        - PROTOBUF_FIELD_OFFSET(NetworkIDProto, _impl_.connection_type_)>(
        reinterpret_cast<char*>(&_impl_.connection_type_), reinterpret_cast<char*>(&other->_impl_.connection_type_));
}
