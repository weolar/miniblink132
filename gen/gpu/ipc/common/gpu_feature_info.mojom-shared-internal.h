...
#pragma pack(push, 1)
class COMPONENT_EXPORT(MOJOM_SHARED_GPU_EXPORT) GpuFeatureInfo_Data {
public:
    ...
    mojo::internal::Pointer<mojo::internal::Array_Data<int32_t>> supported_buffer_formats_for_allocation_and_texturing;
...
static_assert(sizeof(GpuFeatureInfo_Data) == 64, "Bad sizeof(GpuFeatureInfo_Data)");
// Used by GpuFeatureInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct GpuFeatureInfo_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    GpuFeatureInfo_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag GpuFeatureInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
