// gpu/ipc/common/client_gmb_interface.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef GPU_IPC_COMMON_CLIENT_GMB_INTERFACE_MOJOM_BLINK_H_
#define GPU_IPC_COMMON_CLIENT_GMB_INTERFACE_MOJOM_BLINK_H_
...
#include "gpu/ipc/common/client_gmb_interface.mojom-blink-forward.h" // IWYU pragma: export
...
// with not having this data in traces there.
    ...
    virtual void CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format, ::gfx::BufferUsage usage,
        ::gpu::mojom::blink::SurfaceHandlePtr surface_handle, CreateGpuMemoryBufferCallback callback)
        = 0;
...
public:
    ...
    void CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format, ::gfx::BufferUsage usage,
        ::gpu::mojom::blink::SurfaceHandlePtr surface_handle, CreateGpuMemoryBufferCallback callback) final;
...
#endif // GPU_IPC_COMMON_CLIENT_GMB_INTERFACE_MOJOM_BLINK_H_
