...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkExtensionProperties, T>::value>;
    using DataView = VkExtensionPropertiesDataView;
    using Data_ = internal::VkExtensionProperties_Data;

    template <typename... Args> static VkExtensionPropertiesPtr New(Args&&... args)
    {
        return VkExtensionPropertiesPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkExtensionPropertiesPtr From(const U& u)
    {
    ...
    VkExtensionProperties(const std::string& extensionName, uint32_t specVersion);
    ...
    template <typename StructPtrType = VkExtensionPropertiesPtr> VkExtensionPropertiesPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkExtensionProperties::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkExtensionProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    {
        return mojo::internal::SerializeImpl<VkExtensionProperties::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkExtensionProperties::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::VkExtensionProperties_UnserializedMessageContext<UserType, VkExtensionProperties::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        ...
        return mojo::internal::DeserializeImpl<VkExtensionProperties::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkExtensionProperties::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::VkExtensionProperties_UnserializedMessageContext<UserType, VkExtensionProperties::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkExtensionProperties::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, VkExtensionProperties::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkLayerProperties, T>::value>;
    using DataView = VkLayerPropertiesDataView;
    using Data_ = internal::VkLayerProperties_Data;

    template <typename... Args> static VkLayerPropertiesPtr New(Args&&... args)
    {
        return VkLayerPropertiesPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkLayerPropertiesPtr From(const U& u)
    {
    ...
    VkLayerProperties(const std::string& layerName, uint32_t specVersion, uint32_t implementationVersion, const std::string& description);
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = VkLayerPropertiesPtr> VkLayerPropertiesPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkLayerProperties::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkLayerProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VkLayerProperties::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkLayerProperties::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::VkLayerProperties_UnserializedMessageContext<UserType, VkLayerProperties::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<VkLayerProperties::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkLayerProperties::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::VkLayerProperties_UnserializedMessageContext<UserType, VkLayerProperties::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkLayerProperties::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, VkLayerProperties::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkExtent3D, T>::value>;
    using DataView = VkExtent3DDataView;
    using Data_ = internal::VkExtent3D_Data;

    template <typename... Args> static VkExtent3DPtr New(Args&&... args)
    {
        return VkExtent3DPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkExtent3DPtr From(const U& u)
    {
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = VkExtent3DPtr> VkExtent3DPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkExtent3D::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkExtent3D::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VkExtent3D::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkExtent3D::DataView>(input);
    }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::VkExtent3D_UnserializedMessageContext<UserType, VkExtent3D::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<VkExtent3D::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkExtent3D::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::VkExtent3D_UnserializedMessageContext<UserType, VkExtent3D::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkExtent3D::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, VkExtent3D::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkPhysicalDeviceLimits, T>::value>;
    using DataView = VkPhysicalDeviceLimitsDataView;
    using Data_ = internal::VkPhysicalDeviceLimits_Data;

    template <typename... Args> static VkPhysicalDeviceLimitsPtr New(Args&&... args)
    {
        return VkPhysicalDeviceLimitsPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkPhysicalDeviceLimitsPtr From(const U& u)
    {
    ...
    VkPhysicalDeviceLimits(uint32_t maxImageDimension1D, uint32_t maxImageDimension2D, uint32_t maxImageDimension3D, uint32_t maxImageDimensionCube,
        ...
        uint32_t maxGeometryInputComponents, uint32_t maxGeometryOutputComponents, uint32_t maxGeometryOutputVertices,
        uint32_t maxGeometryTotalOutputComponents, uint32_t maxFragmentInputComponents, uint32_t maxFragmentOutputAttachments,
        uint32_t maxFragmentDualSrcAttachments, uint32_t maxFragmentCombinedOutputResources, uint32_t maxComputeSharedMemorySize,
        std::vector<uint32_t> maxComputeWorkGroupCount, uint32_t maxComputeWorkGroupInvocations, std::vector<uint32_t> maxComputeWorkGroupSize,
        uint32_t subPixelPrecisionBits, uint32_t subTexelPrecisionBits, uint32_t mipmapPrecisionBits, uint32_t maxDrawIndexedIndexValue,
        uint32_t maxDrawIndirectCount, float maxSamplerLodBias, float maxSamplerAnisotropy, uint32_t maxViewports, std::vector<uint32_t> maxViewportDimensions,
        std::vector<float> viewportBoundsRange, uint32_t viewportSubPixelBits, uint64_t minMemoryMapAlignment, uint64_t minTexelBufferOffsetAlignment,
        uint64_t minUniformBufferOffsetAlignment, uint64_t minStorageBufferOffsetAlignment, int32_t minTexelOffset, uint32_t maxTexelOffset,
        int32_t minTexelGatherOffset, uint32_t maxTexelGatherOffset, float minInterpolationOffset, float maxInterpolationOffset,
        uint32_t subPixelInterpolationOffsetBits, uint32_t maxFramebufferWidth, uint32_t maxFramebufferHeight, uint32_t maxFramebufferLayers,
        uint32_t framebufferColorSampleCounts, uint32_t framebufferDepthSampleCounts, uint32_t framebufferStencilSampleCounts,
        uint32_t framebufferNoAttachmentsSampleCounts, uint32_t maxColorAttachments, uint32_t sampledImageColorSampleCounts,
        uint32_t sampledImageIntegerSampleCounts, uint32_t sampledImageDepthSampleCounts, uint32_t sampledImageStencilSampleCounts,
        uint32_t storageImageSampleCounts, uint32_t maxSampleMaskWords, bool timestampComputeAndGraphics, float timestampPeriod, uint32_t maxClipDistances,
        uint32_t maxCullDistances, uint32_t maxCombinedClipAndCullDistances, uint32_t discreteQueuePriorities, std::vector<float> pointSizeRange,
        std::vector<float> lineWidthRange, float pointSizeGranularity, float lineWidthGranularity, bool strictLines, bool standardSampleLocations,
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = VkPhysicalDeviceLimitsPtr> VkPhysicalDeviceLimitsPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkPhysicalDeviceLimits::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkPhysicalDeviceLimits::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VkPhysicalDeviceLimits::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkPhysicalDeviceLimits::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::VkPhysicalDeviceLimits_UnserializedMessageContext<UserType, VkPhysicalDeviceLimits::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceLimits::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkPhysicalDeviceLimits::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::VkPhysicalDeviceLimits_UnserializedMessageContext<UserType, VkPhysicalDeviceLimits::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceLimits::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, VkPhysicalDeviceLimits::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkPhysicalDeviceSparseProperties, T>::value>;
    using DataView = VkPhysicalDeviceSparsePropertiesDataView;
    using Data_ = internal::VkPhysicalDeviceSparseProperties_Data;

    template <typename... Args> static VkPhysicalDeviceSparsePropertiesPtr New(Args&&... args)
    {
        return VkPhysicalDeviceSparsePropertiesPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkPhysicalDeviceSparsePropertiesPtr From(const U& u)
    {
    ...
    VkPhysicalDeviceSparseProperties(bool residencyStandard2DBlockShape, bool residencyStandard2DMultisampleBlockShape, bool residencyStandard3DBlockShape,
        bool residencyAlignedMipSize, bool residencyNonResidentStrict);
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = VkPhysicalDeviceSparsePropertiesPtr> VkPhysicalDeviceSparsePropertiesPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkPhysicalDeviceSparseProperties::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkPhysicalDeviceSparseProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VkPhysicalDeviceSparseProperties::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkPhysicalDeviceSparseProperties::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::VkPhysicalDeviceSparseProperties_UnserializedMessageContext<UserType, VkPhysicalDeviceSparseProperties::DataView>>(
                0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceSparseProperties::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkPhysicalDeviceSparseProperties::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<
            internal::VkPhysicalDeviceSparseProperties_UnserializedMessageContext<UserType, VkPhysicalDeviceSparseProperties::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceSparseProperties::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, VkPhysicalDeviceSparseProperties::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkPhysicalDeviceProperties, T>::value>;
    using DataView = VkPhysicalDevicePropertiesDataView;
    using Data_ = internal::VkPhysicalDeviceProperties_Data;

    template <typename... Args> static VkPhysicalDevicePropertiesPtr New(Args&&... args)
    {
        return VkPhysicalDevicePropertiesPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkPhysicalDevicePropertiesPtr From(const U& u)
    {
    ...
    VkPhysicalDeviceProperties(uint32_t apiVersion, uint32_t driverVersion, uint32_t vendorID, uint32_t deviceID, ::VkPhysicalDeviceType deviceType,
        const std::string& deviceName, std::vector<uint8_t> pipelineCacheUUID, const ::VkPhysicalDeviceLimits& limits,
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = VkPhysicalDevicePropertiesPtr> VkPhysicalDevicePropertiesPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkPhysicalDeviceProperties::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkPhysicalDeviceProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VkPhysicalDeviceProperties::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkPhysicalDeviceProperties::DataView>(input);
    }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::VkPhysicalDeviceProperties_UnserializedMessageContext<UserType, VkPhysicalDeviceProperties::DataView>>(
                                 0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceProperties::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkPhysicalDeviceProperties::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::VkPhysicalDeviceProperties_UnserializedMessageContext<UserType, VkPhysicalDeviceProperties::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceProperties::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, VkPhysicalDeviceProperties::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkPhysicalDeviceFeatures, T>::value>;
    using DataView = VkPhysicalDeviceFeaturesDataView;
    using Data_ = internal::VkPhysicalDeviceFeatures_Data;

    template <typename... Args> static VkPhysicalDeviceFeaturesPtr New(Args&&... args)
    {
        return VkPhysicalDeviceFeaturesPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkPhysicalDeviceFeaturesPtr From(const U& u)
    {
    ...
    VkPhysicalDeviceFeatures(bool robustBufferAccess, bool fullDrawIndexUint32, bool imageCubeArray, bool independentBlend, bool geometryShader,
        bool tessellationShader, bool sampleRateShading, bool dualSrcBlend, bool logicOp, bool multiDrawIndirect, bool drawIndirectFirstInstance,
        bool depthClamp, bool depthBiasClamp, bool fillModeNonSolid, bool depthBounds, bool wideLines, bool largePoints, bool alphaToOne, bool multiViewport,
        bool samplerAnisotropy, bool textureCompressionETC2, bool textureCompressionASTC_LDR, bool textureCompressionBC, bool occlusionQueryPrecise,
        bool pipelineStatisticsQuery, bool vertexPipelineStoresAndAtomics, bool fragmentStoresAndAtomics, bool shaderTessellationAndGeometryPointSize,
        bool shaderImageGatherExtended, bool shaderStorageImageExtendedFormats, bool shaderStorageImageMultisample, bool shaderStorageImageReadWithoutFormat,
        bool shaderStorageImageWriteWithoutFormat, bool shaderUniformBufferArrayDynamicIndexing, bool shaderSampledImageArrayDynamicIndexing,
        bool shaderStorageBufferArrayDynamicIndexing, bool shaderStorageImageArrayDynamicIndexing, bool shaderClipDistance, bool shaderCullDistance,
        bool shaderFloat64, bool shaderInt64, bool shaderInt16, bool shaderResourceResidency, bool shaderResourceMinLod, bool sparseBinding,
        bool sparseResidencyBuffer, bool sparseResidencyImage2D, bool sparseResidencyImage3D, bool sparseResidency2Samples, bool sparseResidency4Samples,
        bool sparseResidency8Samples, bool sparseResidency16Samples, bool sparseResidencyAliased, bool variableMultisampleRate, bool inheritedQueries);
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = VkPhysicalDeviceFeaturesPtr> VkPhysicalDeviceFeaturesPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkPhysicalDeviceFeatures::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkPhysicalDeviceFeatures::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VkPhysicalDeviceFeatures::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkPhysicalDeviceFeatures::DataView>(input);
    }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::VkPhysicalDeviceFeatures_UnserializedMessageContext<UserType, VkPhysicalDeviceFeatures::DataView>>(
                                 0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceFeatures::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkPhysicalDeviceFeatures::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::VkPhysicalDeviceFeatures_UnserializedMessageContext<UserType, VkPhysicalDeviceFeatures::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkPhysicalDeviceFeatures::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, VkPhysicalDeviceFeatures::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<VkQueueFamilyProperties, T>::value>;
    using DataView = VkQueueFamilyPropertiesDataView;
    using Data_ = internal::VkQueueFamilyProperties_Data;

    template <typename... Args> static VkQueueFamilyPropertiesPtr New(Args&&... args)
    {
        return VkQueueFamilyPropertiesPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static VkQueueFamilyPropertiesPtr From(const U& u)
    {
    ...
    VkQueueFamilyProperties(uint32_t queueFlags, uint32_t queueCount, uint32_t timestampValidBits, const ::VkExtent3D& minImageTransferGranularity);
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = VkQueueFamilyPropertiesPtr> VkQueueFamilyPropertiesPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, VkQueueFamilyProperties::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, VkQueueFamilyProperties::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VkQueueFamilyProperties::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<VkQueueFamilyProperties::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::VkQueueFamilyProperties_UnserializedMessageContext<UserType, VkQueueFamilyProperties::DataView>>(0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<VkQueueFamilyProperties::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return VkQueueFamilyProperties::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::VkQueueFamilyProperties_UnserializedMessageContext<UserType, VkQueueFamilyProperties::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<VkQueueFamilyProperties::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, VkQueueFamilyProperties::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
template <typename StructPtrType> VkExtensionPropertiesPtr VkExtensionProperties::Clone() const
{
    return New(mojo::Clone(extensionName), mojo::Clone(specVersion));
}

template <typename T, VkExtensionProperties::EnableIfSame<T>*> bool VkExtensionProperties::Equals(const T& other_struct) const
{
...
template <typename T, VkExtensionProperties::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> VkLayerPropertiesPtr VkLayerProperties::Clone() const
{
    return New(mojo::Clone(layerName), mojo::Clone(specVersion), mojo::Clone(implementationVersion), mojo::Clone(description));
}

template <typename T, VkLayerProperties::EnableIfSame<T>*> bool VkLayerProperties::Equals(const T& other_struct) const
{
...
template <typename T, VkLayerProperties::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> VkPhysicalDeviceLimitsPtr VkPhysicalDeviceLimits::Clone() const
{
    return New(mojo::Clone(maxImageDimension1D), mojo::Clone(maxImageDimension2D), mojo::Clone(maxImageDimension3D), mojo::Clone(maxImageDimensionCube),
        mojo::Clone(maxImageArrayLayers), mojo::Clone(maxTexelBufferElements), mojo::Clone(maxUniformBufferRange), mojo::Clone(maxStorageBufferRange),
        mojo::Clone(maxPushConstantsSize), mojo::Clone(maxMemoryAllocationCount), mojo::Clone(maxSamplerAllocationCount), mojo::Clone(bufferImageGranularity),
        mojo::Clone(sparseAddressSpaceSize), mojo::Clone(maxBoundDescriptorSets), mojo::Clone(maxPerStageDescriptorSamplers),
        mojo::Clone(maxPerStageDescriptorUniformBuffers), mojo::Clone(maxPerStageDescriptorStorageBuffers), mojo::Clone(maxPerStageDescriptorSampledImages),
        mojo::Clone(maxPerStageDescriptorStorageImages), mojo::Clone(maxPerStageDescriptorInputAttachments), mojo::Clone(maxPerStageResources),
        mojo::Clone(maxDescriptorSetSamplers), mojo::Clone(maxDescriptorSetUniformBuffers), mojo::Clone(maxDescriptorSetUniformBuffersDynamic),
        mojo::Clone(maxDescriptorSetStorageBuffers), mojo::Clone(maxDescriptorSetStorageBuffersDynamic), mojo::Clone(maxDescriptorSetSampledImages),
        mojo::Clone(maxDescriptorSetStorageImages), mojo::Clone(maxDescriptorSetInputAttachments), mojo::Clone(maxVertexInputAttributes),
        mojo::Clone(maxVertexInputBindings), mojo::Clone(maxVertexInputAttributeOffset), mojo::Clone(maxVertexInputBindingStride),
        mojo::Clone(maxVertexOutputComponents), mojo::Clone(maxTessellationGenerationLevel), mojo::Clone(maxTessellationPatchSize),
        mojo::Clone(maxTessellationControlPerVertexInputComponents), mojo::Clone(maxTessellationControlPerVertexOutputComponents),
        mojo::Clone(maxTessellationControlPerPatchOutputComponents), mojo::Clone(maxTessellationControlTotalOutputComponents),
        mojo::Clone(maxTessellationEvaluationInputComponents), mojo::Clone(maxTessellationEvaluationOutputComponents),
        mojo::Clone(maxGeometryShaderInvocations), mojo::Clone(maxGeometryInputComponents), mojo::Clone(maxGeometryOutputComponents),
        mojo::Clone(maxGeometryOutputVertices), mojo::Clone(maxGeometryTotalOutputComponents), mojo::Clone(maxFragmentInputComponents),
        mojo::Clone(maxFragmentOutputAttachments), mojo::Clone(maxFragmentDualSrcAttachments), mojo::Clone(maxFragmentCombinedOutputResources),
        mojo::Clone(maxComputeSharedMemorySize), mojo::Clone(maxComputeWorkGroupCount), mojo::Clone(maxComputeWorkGroupInvocations),
        mojo::Clone(maxComputeWorkGroupSize), mojo::Clone(subPixelPrecisionBits), mojo::Clone(subTexelPrecisionBits), mojo::Clone(mipmapPrecisionBits),
        mojo::Clone(maxDrawIndexedIndexValue), mojo::Clone(maxDrawIndirectCount), mojo::Clone(maxSamplerLodBias), mojo::Clone(maxSamplerAnisotropy),
        mojo::Clone(maxViewports), mojo::Clone(maxViewportDimensions), mojo::Clone(viewportBoundsRange), mojo::Clone(viewportSubPixelBits),
        mojo::Clone(minMemoryMapAlignment), mojo::Clone(minTexelBufferOffsetAlignment), mojo::Clone(minUniformBufferOffsetAlignment),
        mojo::Clone(minStorageBufferOffsetAlignment), mojo::Clone(minTexelOffset), mojo::Clone(maxTexelOffset), mojo::Clone(minTexelGatherOffset),
        mojo::Clone(maxTexelGatherOffset), mojo::Clone(minInterpolationOffset), mojo::Clone(maxInterpolationOffset),
        mojo::Clone(subPixelInterpolationOffsetBits), mojo::Clone(maxFramebufferWidth), mojo::Clone(maxFramebufferHeight), mojo::Clone(maxFramebufferLayers),
        mojo::Clone(framebufferColorSampleCounts), mojo::Clone(framebufferDepthSampleCounts), mojo::Clone(framebufferStencilSampleCounts),
        mojo::Clone(framebufferNoAttachmentsSampleCounts), mojo::Clone(maxColorAttachments), mojo::Clone(sampledImageColorSampleCounts),
        mojo::Clone(sampledImageIntegerSampleCounts), mojo::Clone(sampledImageDepthSampleCounts), mojo::Clone(sampledImageStencilSampleCounts),
        mojo::Clone(storageImageSampleCounts), mojo::Clone(maxSampleMaskWords), mojo::Clone(timestampComputeAndGraphics), mojo::Clone(timestampPeriod),
        mojo::Clone(maxClipDistances), mojo::Clone(maxCullDistances), mojo::Clone(maxCombinedClipAndCullDistances), mojo::Clone(discreteQueuePriorities),
        mojo::Clone(pointSizeRange), mojo::Clone(lineWidthRange), mojo::Clone(pointSizeGranularity), mojo::Clone(lineWidthGranularity),
        mojo::Clone(strictLines), mojo::Clone(standardSampleLocations), mojo::Clone(optimalBufferCopyOffsetAlignment),
        mojo::Clone(optimalBufferCopyRowPitchAlignment), mojo::Clone(nonCoherentAtomSize));
}

template <typename T, VkPhysicalDeviceLimits::EnableIfSame<T>*> bool VkPhysicalDeviceLimits::Equals(const T& other_struct) const
{
...
template <typename T, VkPhysicalDeviceLimits::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> VkPhysicalDeviceSparsePropertiesPtr VkPhysicalDeviceSparseProperties::Clone() const
{
    return New(mojo::Clone(residencyStandard2DBlockShape), mojo::Clone(residencyStandard2DMultisampleBlockShape), mojo::Clone(residencyStandard3DBlockShape),
        mojo::Clone(residencyAlignedMipSize), mojo::Clone(residencyNonResidentStrict));
}

template <typename T, VkPhysicalDeviceSparseProperties::EnableIfSame<T>*> bool VkPhysicalDeviceSparseProperties::Equals(const T& other_struct) const
{
...
template <typename T, VkPhysicalDeviceSparseProperties::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> VkPhysicalDevicePropertiesPtr VkPhysicalDeviceProperties::Clone() const
{
    return New(mojo::Clone(apiVersion), mojo::Clone(driverVersion), mojo::Clone(vendorID), mojo::Clone(deviceID), mojo::Clone(deviceType),
        mojo::Clone(deviceName), mojo::Clone(pipelineCacheUUID), mojo::Clone(limits), mojo::Clone(sparseProperties));
}

template <typename T, VkPhysicalDeviceProperties::EnableIfSame<T>*> bool VkPhysicalDeviceProperties::Equals(const T& other_struct) const
{
...
template <typename T, VkPhysicalDeviceProperties::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> VkPhysicalDeviceFeaturesPtr VkPhysicalDeviceFeatures::Clone() const
{
    return New(mojo::Clone(robustBufferAccess), mojo::Clone(fullDrawIndexUint32), mojo::Clone(imageCubeArray), mojo::Clone(independentBlend),
        mojo::Clone(geometryShader), mojo::Clone(tessellationShader), mojo::Clone(sampleRateShading), mojo::Clone(dualSrcBlend), mojo::Clone(logicOp),
        mojo::Clone(multiDrawIndirect), mojo::Clone(drawIndirectFirstInstance), mojo::Clone(depthClamp), mojo::Clone(depthBiasClamp),
        mojo::Clone(fillModeNonSolid), mojo::Clone(depthBounds), mojo::Clone(wideLines), mojo::Clone(largePoints), mojo::Clone(alphaToOne),
        mojo::Clone(multiViewport), mojo::Clone(samplerAnisotropy), mojo::Clone(textureCompressionETC2), mojo::Clone(textureCompressionASTC_LDR),
        mojo::Clone(textureCompressionBC), mojo::Clone(occlusionQueryPrecise), mojo::Clone(pipelineStatisticsQuery),
        mojo::Clone(vertexPipelineStoresAndAtomics), mojo::Clone(fragmentStoresAndAtomics), mojo::Clone(shaderTessellationAndGeometryPointSize),
        mojo::Clone(shaderImageGatherExtended), mojo::Clone(shaderStorageImageExtendedFormats), mojo::Clone(shaderStorageImageMultisample),
        mojo::Clone(shaderStorageImageReadWithoutFormat), mojo::Clone(shaderStorageImageWriteWithoutFormat),
        mojo::Clone(shaderUniformBufferArrayDynamicIndexing), mojo::Clone(shaderSampledImageArrayDynamicIndexing),
        mojo::Clone(shaderStorageBufferArrayDynamicIndexing), mojo::Clone(shaderStorageImageArrayDynamicIndexing), mojo::Clone(shaderClipDistance),
        mojo::Clone(shaderCullDistance), mojo::Clone(shaderFloat64), mojo::Clone(shaderInt64), mojo::Clone(shaderInt16), mojo::Clone(shaderResourceResidency),
        mojo::Clone(shaderResourceMinLod), mojo::Clone(sparseBinding), mojo::Clone(sparseResidencyBuffer), mojo::Clone(sparseResidencyImage2D),
        mojo::Clone(sparseResidencyImage3D), mojo::Clone(sparseResidency2Samples), mojo::Clone(sparseResidency4Samples), mojo::Clone(sparseResidency8Samples),
        mojo::Clone(sparseResidency16Samples), mojo::Clone(sparseResidencyAliased), mojo::Clone(variableMultisampleRate), mojo::Clone(inheritedQueries));
}

template <typename T, VkPhysicalDeviceFeatures::EnableIfSame<T>*> bool VkPhysicalDeviceFeatures::Equals(const T& other_struct) const
{
...
template <typename T, VkPhysicalDeviceFeatures::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> VkExtent3DPtr VkExtent3D::Clone() const
{
    return New(mojo::Clone(width), mojo::Clone(height), mojo::Clone(depth));
}

template <typename T, VkExtent3D::EnableIfSame<T>*> bool VkExtent3D::Equals(const T& other_struct) const
{
...
template <typename T, VkExtent3D::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> VkQueueFamilyPropertiesPtr VkQueueFamilyProperties::Clone() const
{
    return New(mojo::Clone(queueFlags), mojo::Clone(queueCount), mojo::Clone(timestampValidBits), mojo::Clone(minImageTransferGranularity));
}

template <typename T, VkQueueFamilyProperties::EnableIfSame<T>*> bool VkQueueFamilyProperties::Equals(const T& other_struct) const
{
...
template <typename T, VkQueueFamilyProperties::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkExtensionProperties::DataView, ::gpu::mojom::VkExtensionPropertiesPtr> {
    static bool IsNull(const ::gpu::mojom::VkExtensionPropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkExtensionPropertiesPtr* output)
    {
        output->reset();
    }

    static const decltype(::gpu::mojom::VkExtensionProperties::extensionName)& extensionName(const ::gpu::mojom::VkExtensionPropertiesPtr& input)
    {
        return input->extensionName;
    }

    static decltype(::gpu::mojom::VkExtensionProperties::specVersion) specVersion(const ::gpu::mojom::VkExtensionPropertiesPtr& input)
    {
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkLayerProperties::DataView, ::gpu::mojom::VkLayerPropertiesPtr> {
    static bool IsNull(const ::gpu::mojom::VkLayerPropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkLayerPropertiesPtr* output)
    {
        output->reset();
    }

    static const decltype(::gpu::mojom::VkLayerProperties::layerName)& layerName(const ::gpu::mojom::VkLayerPropertiesPtr& input)
    {
        return input->layerName;
    }

    static decltype(::gpu::mojom::VkLayerProperties::specVersion) specVersion(const ::gpu::mojom::VkLayerPropertiesPtr& input)
    {
        return input->specVersion;
    }

    static decltype(::gpu::mojom::VkLayerProperties::implementationVersion) implementationVersion(const ::gpu::mojom::VkLayerPropertiesPtr& input)
    {
        return input->implementationVersion;
    }

    static const decltype(::gpu::mojom::VkLayerProperties::description)& description(const ::gpu::mojom::VkLayerPropertiesPtr& input)
    {
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkPhysicalDeviceLimits::DataView, ::gpu::mojom::VkPhysicalDeviceLimitsPtr> {
    static bool IsNull(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkPhysicalDeviceLimitsPtr* output)
    {
        output->reset();
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxImageDimension1D) maxImageDimension1D(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxImageDimension1D;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxImageDimension2D) maxImageDimension2D(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxImageDimension2D;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxImageDimension3D) maxImageDimension3D(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxImageDimension3D;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxImageDimensionCube) maxImageDimensionCube(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxImageDimensionCube;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxImageArrayLayers) maxImageArrayLayers(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxImageArrayLayers;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxTexelBufferElements) maxTexelBufferElements(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxTexelBufferElements;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxUniformBufferRange) maxUniformBufferRange(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxUniformBufferRange;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxStorageBufferRange) maxStorageBufferRange(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxStorageBufferRange;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxPushConstantsSize) maxPushConstantsSize(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::bufferImageGranularity) bufferImageGranularity(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->bufferImageGranularity;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::sparseAddressSpaceSize) sparseAddressSpaceSize(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->sparseAddressSpaceSize;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxBoundDescriptorSets) maxBoundDescriptorSets(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxPerStageResources) maxPerStageResources(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxVertexInputBindings) maxVertexInputBindings(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::subPixelPrecisionBits) subPixelPrecisionBits(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->subPixelPrecisionBits;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::subTexelPrecisionBits) subTexelPrecisionBits(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->subTexelPrecisionBits;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::mipmapPrecisionBits) mipmapPrecisionBits(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxDrawIndirectCount) maxDrawIndirectCount(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxDrawIndirectCount;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxSamplerLodBias) maxSamplerLodBias(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxSamplerLodBias;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxSamplerAnisotropy) maxSamplerAnisotropy(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxSamplerAnisotropy;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxViewports) maxViewports(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static const decltype(::gpu::mojom::VkPhysicalDeviceLimits::viewportBoundsRange)& viewportBoundsRange(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->viewportBoundsRange;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::viewportSubPixelBits) viewportSubPixelBits(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->viewportSubPixelBits;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::minMemoryMapAlignment) minMemoryMapAlignment(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::minTexelOffset) minTexelOffset(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->minTexelOffset;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxTexelOffset) maxTexelOffset(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxTexelOffset;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::minTexelGatherOffset) minTexelGatherOffset(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->minTexelGatherOffset;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxTexelGatherOffset) maxTexelGatherOffset(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxTexelGatherOffset;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::minInterpolationOffset) minInterpolationOffset(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->minInterpolationOffset;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxInterpolationOffset) maxInterpolationOffset(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxFramebufferWidth) maxFramebufferWidth(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxFramebufferWidth;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxFramebufferHeight) maxFramebufferHeight(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxFramebufferHeight;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxFramebufferLayers) maxFramebufferLayers(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxColorAttachments) maxColorAttachments(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxSampleMaskWords) maxSampleMaskWords(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::timestampPeriod) timestampPeriod(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->timestampPeriod;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxClipDistances) maxClipDistances(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->maxClipDistances;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::maxCullDistances) maxCullDistances(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::discreteQueuePriorities) discreteQueuePriorities(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->discreteQueuePriorities;
    }

    static const decltype(::gpu::mojom::VkPhysicalDeviceLimits::pointSizeRange)& pointSizeRange(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->pointSizeRange;
    }

    static const decltype(::gpu::mojom::VkPhysicalDeviceLimits::lineWidthRange)& lineWidthRange(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->lineWidthRange;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::pointSizeGranularity) pointSizeGranularity(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->pointSizeGranularity;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::lineWidthGranularity) lineWidthGranularity(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->lineWidthGranularity;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::strictLines) strictLines(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
        return input->strictLines;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::standardSampleLocations) standardSampleLocations(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceLimits::nonCoherentAtomSize) nonCoherentAtomSize(const ::gpu::mojom::VkPhysicalDeviceLimitsPtr& input)
    {
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkPhysicalDeviceSparseProperties::DataView, ::gpu::mojom::VkPhysicalDeviceSparsePropertiesPtr> {
    static bool IsNull(const ::gpu::mojom::VkPhysicalDeviceSparsePropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkPhysicalDeviceSparsePropertiesPtr* output)
    {
        output->reset();
    }
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkPhysicalDeviceProperties::DataView, ::gpu::mojom::VkPhysicalDevicePropertiesPtr> {
    static bool IsNull(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkPhysicalDevicePropertiesPtr* output)
    {
        output->reset();
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceProperties::apiVersion) apiVersion(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
        return input->apiVersion;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceProperties::driverVersion) driverVersion(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
        return input->driverVersion;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceProperties::vendorID) vendorID(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
        return input->vendorID;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceProperties::deviceID) deviceID(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
        return input->deviceID;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceProperties::deviceType) deviceType(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
        return input->deviceType;
    }

    static const decltype(::gpu::mojom::VkPhysicalDeviceProperties::deviceName)& deviceName(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
    ...
    static const decltype(::gpu::mojom::VkPhysicalDeviceProperties::limits)& limits(const ::gpu::mojom::VkPhysicalDevicePropertiesPtr& input)
    {
        return input->limits;
    }
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkPhysicalDeviceFeatures::DataView, ::gpu::mojom::VkPhysicalDeviceFeaturesPtr> {
    static bool IsNull(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkPhysicalDeviceFeaturesPtr* output)
    {
        output->reset();
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::robustBufferAccess) robustBufferAccess(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->robustBufferAccess;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::fullDrawIndexUint32) fullDrawIndexUint32(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->fullDrawIndexUint32;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::imageCubeArray) imageCubeArray(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->imageCubeArray;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::independentBlend) independentBlend(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->independentBlend;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::geometryShader) geometryShader(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->geometryShader;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::tessellationShader) tessellationShader(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->tessellationShader;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::sampleRateShading) sampleRateShading(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->sampleRateShading;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::dualSrcBlend) dualSrcBlend(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->dualSrcBlend;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::logicOp) logicOp(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->logicOp;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::multiDrawIndirect) multiDrawIndirect(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::depthClamp) depthClamp(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->depthClamp;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::depthBiasClamp) depthBiasClamp(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->depthBiasClamp;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::fillModeNonSolid) fillModeNonSolid(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->fillModeNonSolid;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::depthBounds) depthBounds(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->depthBounds;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::wideLines) wideLines(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->wideLines;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::largePoints) largePoints(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->largePoints;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::alphaToOne) alphaToOne(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->alphaToOne;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::multiViewport) multiViewport(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->multiViewport;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::samplerAnisotropy) samplerAnisotropy(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::textureCompressionBC) textureCompressionBC(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->textureCompressionBC;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::occlusionQueryPrecise) occlusionQueryPrecise(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::shaderClipDistance) shaderClipDistance(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->shaderClipDistance;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::shaderCullDistance) shaderCullDistance(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->shaderCullDistance;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::shaderFloat64) shaderFloat64(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->shaderFloat64;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::shaderInt64) shaderInt64(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->shaderInt64;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::shaderInt16) shaderInt16(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::shaderResourceMinLod) shaderResourceMinLod(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->shaderResourceMinLod;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::sparseBinding) sparseBinding(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
        return input->sparseBinding;
    }

    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::sparseResidencyBuffer) sparseResidencyBuffer(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::VkPhysicalDeviceFeatures::inheritedQueries) inheritedQueries(const ::gpu::mojom::VkPhysicalDeviceFeaturesPtr& input)
    {
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkExtent3D::DataView, ::gpu::mojom::VkExtent3DPtr> {
    static bool IsNull(const ::gpu::mojom::VkExtent3DPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkExtent3DPtr* output)
    {
        output->reset();
    }

    static decltype(::gpu::mojom::VkExtent3D::width) width(const ::gpu::mojom::VkExtent3DPtr& input)
    {
        return input->width;
    }

    static decltype(::gpu::mojom::VkExtent3D::height) height(const ::gpu::mojom::VkExtent3DPtr& input)
    {
        return input->height;
    }

    static decltype(::gpu::mojom::VkExtent3D::depth) depth(const ::gpu::mojom::VkExtent3DPtr& input)
    {
        return input->depth;
    }
...
template <> struct GPU_EXPORT StructTraits<::gpu::mojom::VkQueueFamilyProperties::DataView, ::gpu::mojom::VkQueueFamilyPropertiesPtr> {
    static bool IsNull(const ::gpu::mojom::VkQueueFamilyPropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::VkQueueFamilyPropertiesPtr* output)
    {
        output->reset();
    }

    static decltype(::gpu::mojom::VkQueueFamilyProperties::queueFlags) queueFlags(const ::gpu::mojom::VkQueueFamilyPropertiesPtr& input)
    {
        return input->queueFlags;
    }

    static decltype(::gpu::mojom::VkQueueFamilyProperties::queueCount) queueCount(const ::gpu::mojom::VkQueueFamilyPropertiesPtr& input)
    {
        return input->queueCount;
    }

    static decltype(::gpu::mojom::VkQueueFamilyProperties::timestampValidBits) timestampValidBits(const ::gpu::mojom::VkQueueFamilyPropertiesPtr& input)
    {
