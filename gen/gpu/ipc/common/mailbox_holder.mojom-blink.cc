...
MailboxHolder::MailboxHolder(const ::gpu::Mailbox& mailbox_in, const ::gpu::SyncToken& sync_token_in, uint32_t texture_target_in)
...
void MailboxHolder::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool MailboxHolder::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::gpu::mojom::blink::MailboxHolder::DataView, ::gpu::mojom::blink::MailboxHolderPtr>::Read(
    ::gpu::mojom::blink::MailboxHolder::DataView input, ::gpu::mojom::blink::MailboxHolderPtr* output)
{
    bool success = true;
