...
void ClientGmbInterfaceProxy::CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId in_id, const ::gfx::Size& in_size, ::gfx::BufferFormat in_format,
    ::gfx::BufferUsage in_usage, ::gpu::mojom::blink::SurfaceHandlePtr in_surface_handle, CreateGpuMemoryBufferCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send gpu::mojom::ClientGmbInterface::CreateGpuMemoryBuffer", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("surface_handle"), in_surface_handle, "<value of type ::gpu::mojom::blink::SurfaceHandlePtr>");
    });
#endif
    ...
    ClientGmbInterface* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case messages::ClientGmbInterface::kCreateGpuMemoryBuffer: {
        ...
        ::gpu::mojom::blink::SurfaceHandlePtr p_surface_handle {};
...
{
    const char* name = ::gpu::mojom::blink::ClientGmbInterface::Name_;
...
void ClientGmbInterfaceInterceptorForTesting::CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format,
    ::gfx::BufferUsage usage, ::gpu::mojom::blink::SurfaceHandlePtr surface_handle, CreateGpuMemoryBufferCallback callback)
{
...
void ClientGmbInterfaceAsyncWaiter::CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size, ::gfx::BufferFormat format,
    ::gfx::BufferUsage usage, ::gpu::mojom::blink::SurfaceHandlePtr surface_handle, ::gfx::GpuMemoryBufferHandle* out_buffer_handle)
{
    base::RunLoop loop;
...
::gfx::GpuMemoryBufferHandle ClientGmbInterfaceAsyncWaiter::CreateGpuMemoryBuffer(::gfx::GpuMemoryBufferId id, const ::gfx::Size& size,
    ::gfx::BufferFormat format, ::gfx::BufferUsage usage, ::gpu::mojom::blink::SurfaceHandlePtr surface_handle)
{
