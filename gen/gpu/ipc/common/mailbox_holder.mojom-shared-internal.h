...
static_assert(sizeof(MailboxHolder_Data) == 32, "Bad sizeof(MailboxHolder_Data)");
// Used by MailboxHolder::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct MailboxHolder_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    MailboxHolder_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag MailboxHolder_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
