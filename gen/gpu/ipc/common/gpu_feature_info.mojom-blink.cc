...
GpuFeatureInfo::GpuFeatureInfo(WTF::Vector<GpuFeatureStatus> status_values_in, WTF::Vector<int32_t> enabled_gpu_driver_bug_workarounds_in,
...
void GpuFeatureInfo::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("status_values"), this->status_values,
        ...
        "<value of type const WTF::Vector<GpuFeatureStatus>&>"
#else
        "<value>"
...
bool StructTraits<::gpu::mojom::blink::GpuFeatureInfo::DataView, ::gpu::mojom::blink::GpuFeatureInfoPtr>::Read(
    ::gpu::mojom::blink::GpuFeatureInfo::DataView input, ::gpu::mojom::blink::GpuFeatureInfoPtr* output)
{
    bool success = true;
