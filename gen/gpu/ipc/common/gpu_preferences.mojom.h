    ...
    , force_separate_egl_display_for_webgl_testing()
{
    ...
    {
        return mojo::internal::SerializeImpl<GpuPreferences::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::gpu::mojom::GpuPreferences::DataView, ::gpu::mojom::GpuPreferencesPtr> {
    static bool IsNull(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gpu::mojom::GpuPreferencesPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::gpu::mojom::GpuPreferences::gpu_startup_dialog) gpu_startup_dialog(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->gpu_startup_dialog;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_gpu_watchdog) disable_gpu_watchdog(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->disable_gpu_watchdog;
    }

    static decltype(::gpu::mojom::GpuPreferences::gpu_sandbox_start_early) gpu_sandbox_start_early(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->gpu_sandbox_start_early;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_low_latency_dxva) enable_low_latency_dxva(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_low_latency_dxva;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_zero_copy_dxgi_video) enable_zero_copy_dxgi_video(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_zero_copy_dxgi_video;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_nv12_dxgi_video) enable_nv12_dxgi_video(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_nv12_dxgi_video;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_software_rasterizer) disable_software_rasterizer(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->disable_software_rasterizer;
    }

    static decltype(::gpu::mojom::GpuPreferences::log_gpu_control_list_decisions) log_gpu_control_list_decisions(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->log_gpu_control_list_decisions;
    }

    static decltype(::gpu::mojom::GpuPreferences::compile_shader_always_succeeds) compile_shader_always_succeeds(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->compile_shader_always_succeeds;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_gl_error_limit) disable_gl_error_limit(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->disable_gl_error_limit;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_glsl_translator) disable_glsl_translator(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->disable_glsl_translator;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_shader_name_hashing) disable_shader_name_hashing(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->disable_shader_name_hashing;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_gpu_command_logging) enable_gpu_command_logging(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_command_logging;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_gpu_debugging) enable_gpu_debugging(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_debugging;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_gpu_service_logging_gpu) enable_gpu_service_logging_gpu(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_service_logging_gpu;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_gpu_driver_debug_logging) enable_gpu_driver_debug_logging(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_driver_debug_logging;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_gpu_program_cache) disable_gpu_program_cache(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->disable_gpu_program_cache;
    }

    static decltype(::gpu::mojom::GpuPreferences::enforce_gl_minimums) enforce_gl_minimums(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enforce_gl_minimums;
    }

    static decltype(::gpu::mojom::GpuPreferences::force_gpu_mem_available_bytes) force_gpu_mem_available_bytes(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::GpuPreferences::force_max_texture_size) force_max_texture_size(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->force_max_texture_size;
    }

    static decltype(::gpu::mojom::GpuPreferences::gpu_program_cache_size) gpu_program_cache_size(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->gpu_program_cache_size;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_gpu_shader_disk_cache) disable_gpu_shader_disk_cache(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::GpuPreferences::gl_shader_interm_output) gl_shader_interm_output(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->gl_shader_interm_output;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_android_surface_control) enable_android_surface_control(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_android_surface_control;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_gpu_service_logging) enable_gpu_service_logging(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_service_logging;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_gpu_service_tracing) enable_gpu_service_tracing(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_gpu_service_tracing;
    }

    static decltype(::gpu::mojom::GpuPreferences::use_passthrough_cmd_decoder) use_passthrough_cmd_decoder(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->use_passthrough_cmd_decoder;
    }

    static decltype(::gpu::mojom::GpuPreferences::ignore_gpu_blocklist) ignore_gpu_blocklist(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->ignore_gpu_blocklist;
    }

    static decltype(::gpu::mojom::GpuPreferences::watchdog_starts_backgrounded) watchdog_starts_backgrounded(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->watchdog_starts_backgrounded;
    }

    static decltype(::gpu::mojom::GpuPreferences::gr_context_type) gr_context_type(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->gr_context_type;
    }

    static decltype(::gpu::mojom::GpuPreferences::use_vulkan) use_vulkan(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->use_vulkan;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_vulkan_protected_memory) enable_vulkan_protected_memory(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_vulkan_protected_memory;
    }

    static decltype(::gpu::mojom::GpuPreferences::disable_vulkan_surface) disable_vulkan_surface(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::GpuPreferences::vulkan_heap_memory_limit) vulkan_heap_memory_limit(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->vulkan_heap_memory_limit;
    }

    static decltype(::gpu::mojom::GpuPreferences::vulkan_sync_cpu_memory_limit) vulkan_sync_cpu_memory_limit(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::GpuPreferences::enable_webgpu) enable_webgpu(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_webgpu;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_unsafe_webgpu) enable_unsafe_webgpu(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
    ...
    static decltype(::gpu::mojom::GpuPreferences::use_webgpu_adapter) use_webgpu_adapter(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->use_webgpu_adapter;
    }

    static decltype(::gpu::mojom::GpuPreferences::use_webgpu_power_preference) use_webgpu_power_preference(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->use_webgpu_power_preference;
    }

    static decltype(::gpu::mojom::GpuPreferences::force_webgpu_compat) force_webgpu_compat(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->force_webgpu_compat;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_dawn_backend_validation) enable_dawn_backend_validation(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enable_dawn_backend_validation;
    }

    static const decltype(::gpu::mojom::GpuPreferences::enabled_dawn_features_list)& enabled_dawn_features_list(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->enabled_dawn_features_list;
    }

    static const decltype(::gpu::mojom::GpuPreferences::disabled_dawn_features_list)& disabled_dawn_features_list(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
        return input->disabled_dawn_features_list;
    }

    static decltype(::gpu::mojom::GpuPreferences::enable_perf_data_collection) enable_perf_data_collection(const ::gpu::mojom::GpuPreferencesPtr& input)
    {
