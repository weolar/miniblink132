...
GestureData::GestureData(LocationDataPtr location_in, ::ui::GestureDeviceType device_type_in, GestureDataDetailsPtr details_in)
...
MouseData::MouseData(int32_t changed_button_flags_in, LocationDataPtr location_in, const ::ui::PointerDetails& pointer_details_in,
...
TouchData::TouchData(bool may_cause_scrolling_in, bool hovering_in, LocationDataPtr location_in, const ::ui::PointerDetails& pointer_details_in)
...
Event::Event(::ui::mojom::EventType action_in, int32_t flags_in, ::base::TimeTicks time_stamp_in, const ::ui::LatencyInfo& latency_in, KeyDataPtr key_data_in,
...
// static
bool StructTraits<::ui::mojom::KeyData::DataView, ::ui::mojom::KeyDataPtr>::Read(::ui::mojom::KeyData::DataView input, ::ui::mojom::KeyDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::ui::mojom::LocationData::DataView, ::ui::mojom::LocationDataPtr>::Read(
    ::ui::mojom::LocationData::DataView input, ::ui::mojom::LocationDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::ui::mojom::GesturePinchData::DataView, ::ui::mojom::GesturePinchDataPtr>::Read(
    ::ui::mojom::GesturePinchData::DataView input, ::ui::mojom::GesturePinchDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::ui::mojom::GestureSwipeData::DataView, ::ui::mojom::GestureSwipeDataPtr>::Read(
    ::ui::mojom::GestureSwipeData::DataView input, ::ui::mojom::GestureSwipeDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::ui::mojom::GestureData::DataView, ::ui::mojom::GestureDataPtr>::Read(
    ::ui::mojom::GestureData::DataView input, ::ui::mojom::GestureDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::ui::mojom::ScrollData::DataView, ::ui::mojom::ScrollDataPtr>::Read(
    ::ui::mojom::ScrollData::DataView input, ::ui::mojom::ScrollDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::ui::mojom::PointerDetails::DataView, ::ui::mojom::PointerDetailsPtr>::Read(
    ::ui::mojom::PointerDetails::DataView input, ::ui::mojom::PointerDetailsPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::ui::mojom::MouseData::DataView, ::ui::mojom::MouseDataPtr>::Read(::ui::mojom::MouseData::DataView input, ::ui::mojom::MouseDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::ui::mojom::TouchData::DataView, ::ui::mojom::TouchDataPtr>::Read(::ui::mojom::TouchData::DataView input, ::ui::mojom::TouchDataPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::ui::mojom::Event::DataView, ::ui::mojom::EventPtr>::Read(::ui::mojom::Event::DataView input, ::ui::mojom::EventPtr* output)
{
    bool success = true;
...
bool UnionTraits<::ui::mojom::GestureDataDetails::DataView, ::ui::mojom::GestureDataDetailsPtr>::Read(
    ::ui::mojom::GestureDataDetails::DataView input, ::ui::mojom::GestureDataDetailsPtr* output)
{
