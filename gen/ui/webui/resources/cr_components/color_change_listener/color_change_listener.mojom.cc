// ui/webui/resources/cr_components/color_change_listener/color_change_listener.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "ui/webui/resources/cr_components/color_change_listener/color_change_listener.mojom-params-data.h"
#include "ui/webui/resources/cr_components/color_change_listener/color_change_listener.mojom-shared-message-ids.h"

#include "ui/webui/resources/cr_components/color_change_listener/color_change_listener.mojom-import-headers.h"
#include "ui/webui/resources/cr_components/color_change_listener/color_change_listener.mojom-test-utils.h"

namespace color_change_listener::mojom {
const char PageHandler::Name_[] = "color_change_listener.mojom.PageHandler";
...
const char* PageHandler::MessageToMethodName_(mojo::Message& message)
{
    ...
    if (!is_response) {
        switch (static_cast<messages::PageHandler>(message.name())) {
        case messages::PageHandler::kSetPage:
            return "Receive color_change_listener::mojom::PageHandler::SetPage";
        }
    } else {
        switch (static_cast<messages::PageHandler>(message.name())) {
        case messages::PageHandler::kSetPage:
            return "Receive reply color_change_listener::mojom::PageHandler::SetPage";
        }
    }
...
uint32_t PageHandler::SetPage_Sym::IPCStableHash()
{
    ...
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)color_change_listener::mojom::PageHandler::SetPage");
...
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send color_change_listener::mojom::PageHandler::SetPage", "input_parameters", [&](perfetto::TracedValue context) {
    ...
    mojo::internal::MessageFragment<::color_change_listener::mojom::internal::PageHandler_SetPage_Params_Data> params(message);
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::color_change_listener::mojom::PageInterfaceBase>>(in_page, &params->page, &params.message());
...
{
    const char* name = ::color_change_listener::mojom::PageHandler::Name_;
    return mojo::internal::ValidateRequestGenericPacked(message, name, kPageHandlerValidationInfo);
}

const char Page::Name_[] = "color_change_listener.mojom.Page";

Page::IPCStableHashFunction Page::MessageToMethodInfo_(mojo::Message& message)
{
#if !BUILDFLAG(IS_FUCHSIA)
    switch (static_cast<messages::Page>(message.name())) {
    case messages::Page::kOnColorProviderChanged: {
        return &Page::OnColorProviderChanged_Sym::IPCStableHash;
    }
    }
#endif // !BUILDFLAG(IS_FUCHSIA)
    return nullptr;
...
const char* Page::MessageToMethodName_(mojo::Message& message)
{
    ...
    if (!is_response) {
        switch (static_cast<messages::Page>(message.name())) {
        case messages::Page::kOnColorProviderChanged:
            return "Receive color_change_listener::mojom::Page::OnColorProviderChanged";
        }
    } else {
        switch (static_cast<messages::Page>(message.name())) {
        case messages::Page::kOnColorProviderChanged:
            return "Receive reply color_change_listener::mojom::Page::OnColorProviderChanged";
        }
    }
    return "Receive unknown mojo message";
#else
...
#if !BUILDFLAG(IS_FUCHSIA)
uint32_t Page::OnColorProviderChanged_Sym::IPCStableHash()
{
    // This method's address is used for indetifiying the mojo method name after
    // symbolization. So each IPCStableHash should have a unique address.
    // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)color_change_listener::mojom::Page::OnColorProviderChanged");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
void PageProxy::OnColorProviderChanged()
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT0("mojom", "Send color_change_listener::mojom::Page::OnColorProviderChanged");
#endif
    ...
    const size_t estimated_payload_size = 0;
    mojo::Message message(base::to_underlying(messages::Page::kOnColorProviderChanged), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::color_change_listener::mojom::internal::Page_OnColorProviderChanged_Params_Data> params(message);
    params.Allocate();

#if defined(ENABLE_IPC_FUZZER)
    message.set_interface_name(Page::Name_);
    message.set_method_name("OnColorProviderChanged");
#endif
    // This return value may be ignored as false implies the Connector has
    // encountered an error, which will be visible through other means.
    ::mojo::internal::SendMojoMessage(*receiver_, message);
...
bool PageStubDispatch::Accept(Page* impl, mojo::Message* message)
{
    ...
    case messages::Page::kOnColorProviderChanged: {
        DCHECK(message->is_serialized());
        internal::Page_OnColorProviderChanged_Params_Data* params
            = reinterpret_cast<internal::Page_OnColorProviderChanged_Params_Data*>(message->mutable_payload());
...
static const mojo::internal::GenericValidationInfo kPageValidationInfo[] = {
    { &internal::Page_OnColorProviderChanged_Params_Data::Validate, nullptr /* no response */ },
};

bool PageRequestValidator::Accept(mojo::Message* message)
{
    const char* name = ::color_change_listener::mojom::Page::Name_;
...
void PageInterceptorForTesting::OnColorProviderChanged()
{
    GetForwardingInterface()->OnColorProviderChanged();
}
