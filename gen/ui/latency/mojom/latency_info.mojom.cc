...
LatencyInfo::LatencyInfo(const base::flat_map<::ui::LatencyComponentType, ::base::TimeTicks>& latency_components_in, int64_t trace_id_in, bool coalesced_in,
...
bool StructTraits<::ui::mojom::LatencyInfo::DataView, ::ui::mojom::LatencyInfoPtr>::Read(
    ::ui::mojom::LatencyInfo::DataView input, ::ui::mojom::LatencyInfoPtr* output)
{
    bool success = true;
