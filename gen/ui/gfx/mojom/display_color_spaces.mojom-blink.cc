...
DisplayColorSpaces::DisplayColorSpaces(WTF::Vector<::gfx::ColorSpace> color_spaces_in, WTF::Vector<::gfx::BufferFormat> buffer_formats_in,
...
bool StructTraits<::gfx::mojom::blink::DisplayColorSpaces::DataView, ::gfx::mojom::blink::DisplayColorSpacesPtr>::Read(
    ::gfx::mojom::blink::DisplayColorSpaces::DataView input, ::gfx::mojom::blink::DisplayColorSpacesPtr* output)
{
    bool success = true;
