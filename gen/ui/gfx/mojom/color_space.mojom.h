...
template <> struct StructTraits<::gfx::mojom::ColorSpace::DataView, ::gfx::mojom::ColorSpacePtr> {
    static bool IsNull(const ::gfx::mojom::ColorSpacePtr& input)
    {
        return !input;
    }
    static void SetToNull(::gfx::mojom::ColorSpacePtr* output)
    {
        output->reset();
    }

    static decltype(::gfx::mojom::ColorSpace::primaries) primaries(const ::gfx::mojom::ColorSpacePtr& input)
    {
        return input->primaries;
    }

    static decltype(::gfx::mojom::ColorSpace::transfer) transfer(const ::gfx::mojom::ColorSpacePtr& input)
    {
        return input->transfer;
    }

    static decltype(::gfx::mojom::ColorSpace::matrix) matrix(const ::gfx::mojom::ColorSpacePtr& input)
    {
        return input->matrix;
    }

    static decltype(::gfx::mojom::ColorSpace::range) range(const ::gfx::mojom::ColorSpacePtr& input)
    {
        return input->range;
    }

    static const decltype(::gfx::mojom::ColorSpace::custom_primary_matrix)& custom_primary_matrix(const ::gfx::mojom::ColorSpacePtr& input)
    {
        return input->custom_primary_matrix;
    }

    static const decltype(::gfx::mojom::ColorSpace::transfer_params)& transfer_params(const ::gfx::mojom::ColorSpacePtr& input)
    {
