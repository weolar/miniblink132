...
HDRMetadata::HDRMetadata(const std::optional<::gfx::HdrMetadataSmpteSt2086>& smpte_st_2086_in, const std::optional<::gfx::HdrMetadataCta861_3>& cta_861_3_in,
...
bool StructTraits<::gfx::mojom::HdrMetadataCta861_3::DataView, ::gfx::mojom::HdrMetadataCta861_3Ptr>::Read(
    ::gfx::mojom::HdrMetadataCta861_3::DataView input, ::gfx::mojom::HdrMetadataCta861_3Ptr* output)
{
    bool success = true;
...
bool StructTraits<::gfx::mojom::HdrMetadataSmpteSt2086::DataView, ::gfx::mojom::HdrMetadataSmpteSt2086Ptr>::Read(
    ::gfx::mojom::HdrMetadataSmpteSt2086::DataView input, ::gfx::mojom::HdrMetadataSmpteSt2086Ptr* output)
{
    bool success = true;
...
bool StructTraits<::gfx::mojom::HdrMetadataNdwl::DataView, ::gfx::mojom::HdrMetadataNdwlPtr>::Read(
    ::gfx::mojom::HdrMetadataNdwl::DataView input, ::gfx::mojom::HdrMetadataNdwlPtr* output)
{
    bool success = true;
...
bool StructTraits<::gfx::mojom::HdrMetadataExtendedRange::DataView, ::gfx::mojom::HdrMetadataExtendedRangePtr>::Read(
    ::gfx::mojom::HdrMetadataExtendedRange::DataView input, ::gfx::mojom::HdrMetadataExtendedRangePtr* output)
{
    bool success = true;
...
bool StructTraits<::gfx::mojom::HDRMetadata::DataView, ::gfx::mojom::HDRMetadataPtr>::Read(
    ::gfx::mojom::HDRMetadata::DataView input, ::gfx::mojom::HDRMetadataPtr* output)
{
    bool success = true;
