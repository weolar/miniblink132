...
static_assert(sizeof(Transform_Data) == 16, "Bad sizeof(Transform_Data)");
// Used by Transform::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct Transform_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    Transform_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag Transform_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
