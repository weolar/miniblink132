...
static_assert(sizeof(RRectF_Data) == 56, "Bad sizeof(RRectF_Data)");
// Used by RRectF::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct RRectF_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    RRectF_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag RRectF_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
