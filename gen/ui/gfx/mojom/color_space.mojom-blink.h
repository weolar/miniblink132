...
template <> struct StructTraits<::gfx::mojom::blink::ColorSpace::DataView, ::gfx::mojom::blink::ColorSpacePtr> {
    static bool IsNull(const ::gfx::mojom::blink::ColorSpacePtr& input)
    {
        return !input;
    }
    static void SetToNull(::gfx::mojom::blink::ColorSpacePtr* output)
    {
        output->reset();
    }

    static decltype(::gfx::mojom::blink::ColorSpace::primaries) primaries(const ::gfx::mojom::blink::ColorSpacePtr& input)
    {
        return input->primaries;
    }

    static decltype(::gfx::mojom::blink::ColorSpace::transfer) transfer(const ::gfx::mojom::blink::ColorSpacePtr& input)
    {
        return input->transfer;
    }

    static decltype(::gfx::mojom::blink::ColorSpace::matrix) matrix(const ::gfx::mojom::blink::ColorSpacePtr& input)
    {
        return input->matrix;
    }

    static decltype(::gfx::mojom::blink::ColorSpace::range) range(const ::gfx::mojom::blink::ColorSpacePtr& input)
    {
        return input->range;
    }

    static const decltype(::gfx::mojom::blink::ColorSpace::custom_primary_matrix)& custom_primary_matrix(const ::gfx::mojom::blink::ColorSpacePtr& input)
    {
        return input->custom_primary_matrix;
    }

    static const decltype(::gfx::mojom::blink::ColorSpace::transfer_params)& transfer_params(const ::gfx::mojom::blink::ColorSpacePtr& input)
    {
