...
LinearGradient::LinearGradient(int16_t angle_in, uint8_t step_count_in, std::vector<StepPtr> steps_in)
...
// static
bool StructTraits<::gfx::mojom::Step::DataView, ::gfx::mojom::StepPtr>::Read(::gfx::mojom::Step::DataView input, ::gfx::mojom::StepPtr* output)
{
    bool success = true;
...
bool StructTraits<::gfx::mojom::LinearGradient::DataView, ::gfx::mojom::LinearGradientPtr>::Read(
    ::gfx::mojom::LinearGradient::DataView input, ::gfx::mojom::LinearGradientPtr* output)
{
    bool success = true;
