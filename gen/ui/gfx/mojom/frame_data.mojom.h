...
template <> struct StructTraits<::gfx::mojom::FrameData::DataView, ::gfx::mojom::FrameDataPtr> {
    static bool IsNull(const ::gfx::mojom::FrameDataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::gfx::mojom::FrameDataPtr* output)
    {
        output->reset();
    }

    static decltype(::gfx::mojom::FrameData::seq) seq(const ::gfx::mojom::FrameDataPtr& input)
    {
        return input->seq;
    }

    static decltype(::gfx::mojom::FrameData::swap_trace_id) swap_trace_id(const ::gfx::mojom::FrameDataPtr& input)
    {
