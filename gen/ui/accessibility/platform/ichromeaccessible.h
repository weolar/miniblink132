...
typedef struct IChromeAccessibleDelegateVtbl {
    ...
    ULONG(STDMETHODCALLTYPE* AddRef)(IChromeAccessibleDelegate* This);

    DECLSPEC_XFGVIRT(IUnknown, Release)
    ULONG(STDMETHODCALLTYPE* Release)(IChromeAccessibleDelegate* This);

    DECLSPEC_XFGVIRT(IChromeAccessibleDelegate, put_bulkFetchResult)
    /* [id][propput] */ HRESULT(STDMETHODCALLTYPE* put_bulkFetchResult)(IChromeAccessibleDelegate* This,
        /* [in] */ LONG requestID,
        /* [in] */ BSTR resultJson);

    DECLSPEC_XFGVIRT(IChromeAccessibleDelegate, put_hitTestResult)
    /* [id][propput] */ HRESULT(STDMETHODCALLTYPE* put_hitTestResult)(IChromeAccessibleDelegate* This,
        /* [in] */ LONG requestID,
        /* [in] */ IUnknown* result);
...
#define IChromeAccessibleDelegate_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define IChromeAccessibleDelegate_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IChromeAccessibleDelegate_Release(This) ((This)->lpVtbl->Release(This))

#define IChromeAccessibleDelegate_put_bulkFetchResult(This, requestID, resultJson) ((This)->lpVtbl->put_bulkFetchResult(This, requestID, resultJson))

#define IChromeAccessibleDelegate_put_hitTestResult(This, requestID, result) ((This)->lpVtbl->put_hitTestResult(This, requestID, result))
...
typedef struct IChromeAccessibleVtbl {
    ...
    DECLSPEC_XFGVIRT(IUnknown, AddRef)
    ULONG(STDMETHODCALLTYPE* AddRef)(IChromeAccessible* This);

    DECLSPEC_XFGVIRT(IUnknown, Release)
    ULONG(STDMETHODCALLTYPE* Release)(IChromeAccessible* This);

    DECLSPEC_XFGVIRT(IChromeAccessible, get_bulkFetch)
    /* [id][propget] */ HRESULT(STDMETHODCALLTYPE* get_bulkFetch)(IChromeAccessible* This,
        /* [in] */ BSTR inputJson,
        /* [in] */ LONG requestID,
        /* [in] */ IChromeAccessibleDelegate* delegate);

    DECLSPEC_XFGVIRT(IChromeAccessible, get_hitTest)
    /* [id][propget] */ HRESULT(STDMETHODCALLTYPE* get_hitTest)(IChromeAccessible* This,
        /* [in] */ LONG screenPhysicalPixelX,
        /* [in] */ LONG screenPhysicalPixelY,
        /* [in] */ LONG requestID,
        /* [in] */ IChromeAccessibleDelegate* delegate);
...
#define IChromeAccessible_QueryInterface(This, riid, ppvObject) ((This)->lpVtbl->QueryInterface(This, riid, ppvObject))

#define IChromeAccessible_AddRef(This) ((This)->lpVtbl->AddRef(This))

#define IChromeAccessible_Release(This) ((This)->lpVtbl->Release(This))

#define IChromeAccessible_get_bulkFetch(This, inputJson, requestID, delegate) ((This)->lpVtbl->get_bulkFetch(This, inputJson, requestID, delegate))
