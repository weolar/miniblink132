...
AXUpdatesAndEvents::AXUpdatesAndEvents(const ::ui::AXTreeID& tree_id_in, std::vector<::ui::AXTreeUpdate> updates_in, std::vector<::ui::AXEvent> events_in)
...
bool StructTraits<::ax::mojom::AXUpdatesAndEvents::DataView, ::ax::mojom::AXUpdatesAndEventsPtr>::Read(
    ::ax::mojom::AXUpdatesAndEvents::DataView input, ::ax::mojom::AXUpdatesAndEventsPtr* output)
{
    bool success = true;
