    ...
    , relative_bounds()
{
    ...
    AXNodeData(int32_t id_in, ::ax::mojom::Role role_in, uint32_t state_in, uint64_t actions_in,
    ...
    {
        return mojo::internal::SerializeImpl<AXNodeData::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::ax::mojom::AXNodeData::DataView, ::ax::mojom::AXNodeDataPtr> {
    static bool IsNull(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::ax::mojom::AXNodeDataPtr* output)
    {
        output->reset();
    }

    static decltype(::ax::mojom::AXNodeData::id) id(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->id;
    }

    static decltype(::ax::mojom::AXNodeData::role) role(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->role;
    }

    static decltype(::ax::mojom::AXNodeData::state) state(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->state;
    }

    static decltype(::ax::mojom::AXNodeData::actions) actions(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->actions;
    }

    static const decltype(::ax::mojom::AXNodeData::string_attributes)& string_attributes(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->string_attributes;
    }

    static const decltype(::ax::mojom::AXNodeData::int_attributes)& int_attributes(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->int_attributes;
    }

    static const decltype(::ax::mojom::AXNodeData::float_attributes)& float_attributes(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->float_attributes;
    }

    static const decltype(::ax::mojom::AXNodeData::bool_attributes)& bool_attributes(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->bool_attributes;
    }

    static const decltype(::ax::mojom::AXNodeData::intlist_attributes)& intlist_attributes(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->intlist_attributes;
    }

    static const decltype(::ax::mojom::AXNodeData::stringlist_attributes)& stringlist_attributes(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->stringlist_attributes;
    }

    static const decltype(::ax::mojom::AXNodeData::html_attributes)& html_attributes(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->html_attributes;
    }

    static const decltype(::ax::mojom::AXNodeData::child_ids)& child_ids(const ::ax::mojom::AXNodeDataPtr& input)
    {
        return input->child_ids;
    }

    static const decltype(::ax::mojom::AXNodeData::relative_bounds)& relative_bounds(const ::ax::mojom::AXNodeDataPtr& input)
    {
