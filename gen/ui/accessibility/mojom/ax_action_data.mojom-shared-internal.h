...
private:
    friend class mojo::internal::MessageFragment<AXActionData_Data>;

    AXActionData_Data();
    ~AXActionData_Data() = delete;
};
static_assert(sizeof(AXActionData_Data) == 128, "Bad sizeof(AXActionData_Data)");
// Used by AXActionData::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct AXActionData_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    AXActionData_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<AXActionData_Data> fragment(message);
...
const mojo::internal::UnserializedMessageContext::Tag AXActionData_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
