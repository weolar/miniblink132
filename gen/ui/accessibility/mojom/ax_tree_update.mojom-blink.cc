...
AXTreeUpdate::AXTreeUpdate(bool has_tree_data_in, ::ax::mojom::blink::AXTreeDataPtr tree_data_in, int32_t node_id_to_clear_in, int32_t root_id_in,
...
AXTreeUpdate::AXTreeUpdate(bool has_tree_data_in, ::ax::mojom::blink::AXTreeDataPtr tree_data_in, int32_t node_id_to_clear_in, int32_t root_id_in,
    WTF::Vector<::ax::mojom::blink::AXNodeDataPtr> nodes_in, ::ax::mojom::blink::EventFrom event_from_in, ::ax::mojom::blink::Action event_from_action_in,
    WTF::Vector<::ax::mojom::blink::EventIntentPtr> event_intents_in, ::ax::mojom::blink::AXTreeChecksPtr tree_checks_in)
    : has_tree_data(std::move(has_tree_data_in))
    , tree_data(std::move(tree_data_in))
    , node_id_to_clear(std::move(node_id_to_clear_in))
    , root_id(std::move(root_id_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::ax::mojom::blink::AXTreeChecksPtr>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::ax::mojom::blink::AXTreeUpdate::DataView, ::ax::mojom::blink::AXTreeUpdatePtr>::Read(
    ::ax::mojom::blink::AXTreeUpdate::DataView input, ::ax::mojom::blink::AXTreeUpdatePtr* output)
{
    bool success = true;
