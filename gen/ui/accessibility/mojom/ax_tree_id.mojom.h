...
template <> struct UnionTraits<::ax::mojom::AXTreeID::DataView, ::ax::mojom::AXTreeIDPtr> {
    static bool IsNull(const ::ax::mojom::AXTreeIDPtr& input)
    {
        return !input;
    }
    static void SetToNull(::ax::mojom::AXTreeIDPtr* output)
    {
        output->reset();
    }
