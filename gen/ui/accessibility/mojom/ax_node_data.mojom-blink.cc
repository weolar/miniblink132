...
AXNodeData::AXNodeData(int32_t id_in, ::ax::mojom::blink::Role role_in, uint32_t state_in, uint64_t actions_in,
...
bool StructTraits<::ax::mojom::blink::AXNodeData::DataView, ::ax::mojom::blink::AXNodeDataPtr>::Read(
    ::ax::mojom::blink::AXNodeData::DataView input, ::ax::mojom::blink::AXNodeDataPtr* output)
{
    bool success = true;
