...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<ImeTextSpanInfoPtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::ui::mojom::blink::ImeTextSpanInfo::DataView, ::ui::mojom::blink::ImeTextSpanInfoPtr>::Read(
    ::ui::mojom::blink::ImeTextSpanInfo::DataView input, ::ui::mojom::blink::ImeTextSpanInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::ui::mojom::blink::TextInputState::DataView, ::ui::mojom::blink::TextInputStatePtr>::Read(
    ::ui::mojom::blink::TextInputState::DataView input, ::ui::mojom::blink::TextInputStatePtr* output)
{
    bool success = true;
