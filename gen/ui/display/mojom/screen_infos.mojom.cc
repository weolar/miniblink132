...
ScreenInfos::ScreenInfos(std::vector<::display::ScreenInfo> screen_infos_in, int64_t current_display_id_in, const ::gfx::Size& system_cursor_size_in)
...
bool StructTraits<::display::mojom::ScreenInfos::DataView, ::display::mojom::ScreenInfosPtr>::Read(
    ::display::mojom::ScreenInfos::DataView input, ::display::mojom::ScreenInfosPtr* output)
{
    bool success = true;
