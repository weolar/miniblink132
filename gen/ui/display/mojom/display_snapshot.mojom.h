...
#include "ui/display/mojom/display_snapshot.mojom-forward.h" // IWYU pragma: export
    ...
    , bits_per_channel()
{
    ...
    {
        return mojo::internal::SerializeImpl<DisplaySnapshotColorInfo::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , variable_refresh_rate_state()
{
    ...
    const ::gfx::Point& origin_in, const ::gfx::Size& physical_size_in, ::display::DisplayConnectionType type_in, uint64_t base_connector_id_in,
    std::vector<uint64_t> path_topology_in, bool is_aspect_preserving_scaling_in, bool has_overscan_in, ::display::PrivacyScreenState privacy_screen_state_in,
    bool has_content_protection_key_in, const ::display::DisplaySnapshot::ColorInfo& color_info_in, const std::string& display_name_in,
    const ::base::FilePath& sys_path_in, std::vector<::std::unique_ptr<::display::DisplayMode>> modes_in,
    ::display::mojom::PanelOrientation panel_orientation_in, std::vector<uint8_t> edid_in, uint64_t current_mode_index_in, bool has_current_mode_in,
    ...
    ::display::VariableRefreshRateState variable_refresh_rate_state_in)
...
template <> struct StructTraits<::display::mojom::DisplaySnapshotColorInfo::DataView, ::display::mojom::DisplaySnapshotColorInfoPtr> {
    static bool IsNull(const ::display::mojom::DisplaySnapshotColorInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::display::mojom::DisplaySnapshotColorInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::display::mojom::DisplaySnapshotColorInfo::color_space)& color_space(const ::display::mojom::DisplaySnapshotColorInfoPtr& input)
    {
        return input->color_space;
    }

    static const decltype(::display::mojom::DisplaySnapshotColorInfo::edid_primaries)& edid_primaries(
        const ::display::mojom::DisplaySnapshotColorInfoPtr& input)
    {
        return input->edid_primaries;
    }

    static decltype(::display::mojom::DisplaySnapshotColorInfo::edid_gamma) edid_gamma(const ::display::mojom::DisplaySnapshotColorInfoPtr& input)
    {
        return input->edid_gamma;
    }

    static const decltype(::display::mojom::DisplaySnapshotColorInfo::hdr_static_metadata)& hdr_static_metadata(
        const ::display::mojom::DisplaySnapshotColorInfoPtr& input)
    {
        return input->hdr_static_metadata;
    }

    static decltype(::display::mojom::DisplaySnapshotColorInfo::supports_color_temperature_adjustment) supports_color_temperature_adjustment(
        const ::display::mojom::DisplaySnapshotColorInfoPtr& input)
    {
        return input->supports_color_temperature_adjustment;
    }

    static decltype(::display::mojom::DisplaySnapshotColorInfo::bits_per_channel) bits_per_channel(const ::display::mojom::DisplaySnapshotColorInfoPtr& input)
    {
        return input->bits_per_channel;
    }

    static bool Read(::display::mojom::DisplaySnapshotColorInfo::DataView input, ::display::mojom::DisplaySnapshotColorInfoPtr* output);
};

template <> struct StructTraits<::display::mojom::DisplaySnapshot::DataView, ::display::mojom::DisplaySnapshotPtr> {
    static bool IsNull(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return !input;
    }
    static void SetToNull(::display::mojom::DisplaySnapshotPtr* output)
    {
        output->reset();
    }

    static decltype(::display::mojom::DisplaySnapshot::display_id) display_id(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->display_id;
    }

    static decltype(::display::mojom::DisplaySnapshot::port_display_id) port_display_id(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->port_display_id;
    }

    static decltype(::display::mojom::DisplaySnapshot::edid_display_id) edid_display_id(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->edid_display_id;
    }

    static decltype(::display::mojom::DisplaySnapshot::connector_index) connector_index(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->connector_index;
    }

    static const decltype(::display::mojom::DisplaySnapshot::origin)& origin(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->origin;
    }

    static const decltype(::display::mojom::DisplaySnapshot::physical_size)& physical_size(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->physical_size;
    }

    static decltype(::display::mojom::DisplaySnapshot::type) type(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->type;
    }

    static decltype(::display::mojom::DisplaySnapshot::base_connector_id) base_connector_id(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->base_connector_id;
    }

    static const decltype(::display::mojom::DisplaySnapshot::path_topology)& path_topology(const ::display::mojom::DisplaySnapshotPtr& input)
    {
    ...
    static decltype(::display::mojom::DisplaySnapshot::has_overscan) has_overscan(const ::display::mojom::DisplaySnapshotPtr& input)
    {
    ...
    static decltype(::display::mojom::DisplaySnapshot::has_content_protection_key) has_content_protection_key(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->has_content_protection_key;
    }

    static const decltype(::display::mojom::DisplaySnapshot::color_info)& color_info(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->color_info;
    }

    static const decltype(::display::mojom::DisplaySnapshot::display_name)& display_name(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->display_name;
    }

    static const decltype(::display::mojom::DisplaySnapshot::sys_path)& sys_path(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->sys_path;
    }

    static const decltype(::display::mojom::DisplaySnapshot::modes)& modes(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->modes;
    }

    static decltype(::display::mojom::DisplaySnapshot::panel_orientation) panel_orientation(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->panel_orientation;
    }

    static const decltype(::display::mojom::DisplaySnapshot::edid)& edid(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->edid;
    }
    ...
    static decltype(::display::mojom::DisplaySnapshot::has_current_mode) has_current_mode(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->has_current_mode;
    }

    static decltype(::display::mojom::DisplaySnapshot::native_mode_index) native_mode_index(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->native_mode_index;
    }

    static decltype(::display::mojom::DisplaySnapshot::has_native_mode) has_native_mode(const ::display::mojom::DisplaySnapshotPtr& input)
    {
        return input->has_native_mode;
    }

    static decltype(::display::mojom::DisplaySnapshot::product_code) product_code(const ::display::mojom::DisplaySnapshotPtr& input)
    {
    ...
    static decltype(::display::mojom::DisplaySnapshot::variable_refresh_rate_state) variable_refresh_rate_state(
        const ::display::mojom::DisplaySnapshotPtr& input)
    {
