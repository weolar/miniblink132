...
TF_BUILTIN(Load_FastSmiElements_0, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp18 = UnsafeCast_JSReceiver_OR_Undefined_OR_Null_OR_Boolean_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp17});
