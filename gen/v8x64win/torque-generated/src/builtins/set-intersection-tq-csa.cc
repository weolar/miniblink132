...
TF_BUILTIN(SetPrototypeIntersection, CodeStubAssembler) {
  ...
  if (block50.is_used()) {
    ...
    tmp60 = CollectionsBuiltinsAssembler(state_).AddToSetTable(TNode<Context>{parameter0}, TNode<OrderedHashSet>{phi_bb50_11}, TNode<Object>{tmp54}, TNode<String>{tmp59});
  ...
  if (block66.is_used()) {
    ...
    tmp77 = CollectionsBuiltinsAssembler(state_).AddToSetTable(TNode<Context>{parameter0}, TNode<OrderedHashSet>{phi_bb66_11}, TNode<Object>{tmp67}, TNode<String>{tmp76});
