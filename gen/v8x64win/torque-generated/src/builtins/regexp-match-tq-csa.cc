...
TNode<Object> RegExpPrototypeMatchBody_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_regexp, TNode<String> p_string, bool p_isFastPath) {
  ...
  if (block25.is_used()) {
    ca_.Bind(&block25);
    tmp15 = RegExpBuiltinsAssembler(state_).FlagGetter(TNode<Context>{p_context}, TNode<Object>{p_regexp}, JSRegExp::Flag::kUnicodeSets, p_isFastPath);
  ...
  if (block29.is_used()) {
    ...
    ca_.Branch(tmp20, &block27, std::vector<compiler::Node*>{phi_bb29_5, phi_bb29_6, phi_bb29_7}, &block28, std::vector<compiler::Node*>{phi_bb29_5, phi_bb29_6, phi_bb29_7});
  }
  ...
  if (block34.is_used()) {
    ...
    tmp23 = RegExpPrototypeExecBodyWithoutResultFast_0(state_, TNode<Context>{p_context}, TNode<JSRegExp>{tmp22}, TNode<String>{p_string}, &label24);
  ...
  if (block37.is_used()) {
    ...
    tmp25 = Method_RegExpMatchInfo_GetStartOfCapture_0(state_, TNode<RegExpMatchInfo>{tmp23}, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
    tmp26 = Method_RegExpMatchInfo_GetEndOfCapture_0(state_, TNode<RegExpMatchInfo>{tmp23}, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
  ...
  if (block35.is_used()) {
    ...
    ca_.Branch(tmp32, &block43, std::vector<compiler::Node*>{phi_bb35_5, phi_bb35_6, phi_bb35_7}, &block44, std::vector<compiler::Node*>{phi_bb35_5, phi_bb35_6, phi_bb35_7});
  }
  ...
  if (block36.is_used()) {
    ...
    ca_.Branch(tmp36, &block69, std::vector<compiler::Node*>{phi_bb36_5, phi_bb36_6, phi_bb36_7}, &block70, std::vector<compiler::Node*>{phi_bb36_5, phi_bb36_6, phi_bb36_7});
  }
  ...
  if (block33.is_used()) {
    ...
    ca_.Branch(tmp38, &block45, std::vector<compiler::Node*>{phi_bb33_5, phi_bb33_6, phi_bb33_7}, &block46, std::vector<compiler::Node*>{phi_bb33_5, phi_bb33_6, phi_bb33_7});
  }
  ...
  if (block46.is_used()) {
    ...
    tmp44 = ExtractFixedArray_0(state_, TNode<FixedArray>{phi_bb46_5}, TNode<IntPtrT>{tmp42}, TNode<IntPtrT>{phi_bb46_7}, TNode<IntPtrT>{phi_bb46_7}, TNode<Hole>{tmp43});
  ...
  if (block69.is_used()) {
    ...
    tmp54 = ExtractFixedArray_0(state_, TNode<FixedArray>{phi_bb69_5}, TNode<IntPtrT>{tmp52}, TNode<IntPtrT>{phi_bb69_7}, TNode<IntPtrT>{tmp51}, TNode<Hole>{tmp53});
  ...
  if (block70.is_used()) {
    ...
    ca_.Branch(tmp62, &block88, std::vector<compiler::Node*>{phi_bb70_7, phi_bb70_7, phi_bb70_7, phi_bb70_7}, &block89, std::vector<compiler::Node*>{phi_bb70_7, phi_bb70_7, phi_bb70_7, phi_bb70_7});
  }
  ...
  if (block96.is_used()) {
    ...
    tmp73 = RegExpBuiltinsAssembler(state_).AdvanceStringIndex(TNode<String>{p_string}, TNode<Number>{tmp72}, TNode<BoolT>{phi_bb26_5}, p_isFastPath);
    if ((p_isFastPath)) {
      ca_.Goto(&block101);
    } else {
      ca_.Goto(&block102);
