...
void VerifiedUnreachable_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp0}, "static_assert(false) at https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=2050&c=3");
    CodeStubAssembler(state_).Unreachable();
  }
}
