...
void OnDeviceSpeechRecognitionProxy::OnDeviceWebSpeechAvailable(const WTF::String& in_language, OnDeviceWebSpeechAvailableCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void OnDeviceSpeechRecognitionProxy::InstallOnDeviceSpeechRecognition(const WTF::String& in_language, InstallOnDeviceSpeechRecognitionCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void SpeechRecognitionSessionClientProxy::ResultRetrieved(WTF::Vector<::media::mojom::blink::WebSpeechRecognitionResultPtr> in_results)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionSessionClient::ResultRetrieved", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("results"), in_results, "<value of type WTF::Vector<::media::mojom::blink::WebSpeechRecognitionResultPtr>>");
    });
#endif
...
void SpeechRecognitionSessionClientProxy::ErrorOccurred(::media::mojom::blink::SpeechRecognitionErrorPtr in_error)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionSessionClient::ErrorOccurred", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), in_error, "<value of type ::media::mojom::blink::SpeechRecognitionErrorPtr>");
    });
#endif
...
void OnDeviceSpeechRecognitionInterceptorForTesting::InstallOnDeviceSpeechRecognition(
    const WTF::String& language, InstallOnDeviceSpeechRecognitionCallback callback)
{
...
void OnDeviceSpeechRecognitionAsyncWaiter::OnDeviceWebSpeechAvailable(const WTF::String& language, bool* out_available)
{
    base::RunLoop loop;
...
bool OnDeviceSpeechRecognitionAsyncWaiter::OnDeviceWebSpeechAvailable(const WTF::String& language)
{
...
void OnDeviceSpeechRecognitionAsyncWaiter::InstallOnDeviceSpeechRecognition(const WTF::String& language, bool* out_success)
{
    base::RunLoop loop;
...
bool OnDeviceSpeechRecognitionAsyncWaiter::InstallOnDeviceSpeechRecognition(const WTF::String& language)
{
    bool async_wait_result;
