    ...
    , initial_zoom_level()
{
    ...
    ::media::mojom::blink::CaptureHandlePtr capture_handle_in, int32_t initial_zoom_level_in)
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::DisplayMediaInformation::DataView, ::media::mojom::blink::DisplayMediaInformationPtr> {
    static bool IsNull(const ::media::mojom::blink::DisplayMediaInformationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::blink::DisplayMediaInformationPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::media::mojom::blink::DisplayMediaInformation::cursor) cursor(const ::media::mojom::blink::DisplayMediaInformationPtr& input)
    {
        return input->cursor;
    }
