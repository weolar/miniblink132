...
bool StructTraits<::media::mojom::blink::WebrtcPredictionFeatures::DataView, ::media::mojom::blink::WebrtcPredictionFeaturesPtr>::Read(
    ::media::mojom::blink::WebrtcPredictionFeatures::DataView input, ::media::mojom::blink::WebrtcPredictionFeaturesPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::WebrtcVideoStats::DataView, ::media::mojom::blink::WebrtcVideoStatsPtr>::Read(
    ::media::mojom::blink::WebrtcVideoStats::DataView input, ::media::mojom::blink::WebrtcVideoStatsPtr* output)
{
    bool success = true;
