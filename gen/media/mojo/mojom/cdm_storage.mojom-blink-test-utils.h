...
public:
    ...
    void Open(const WTF::String& file_name, CdmStorage::Status* out_status, ::mojo::PendingAssociatedRemote<CdmFile>* out_cdm_file);
...
public:
    ...
    ~CdmFileAsyncWaiter();
    void Read(CdmFile::Status* out_status, WTF::Vector<uint8_t>* out_data);

    void Write(const WTF::Vector<uint8_t>& data, CdmFile::Status* out_status);
    CdmFile::Status Write(const WTF::Vector<uint8_t>& data);
