...
void VideoDecodeStatsRecorderProxy::StartNewRecord(::media::mojom::PredictionFeaturesPtr in_features)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void VideoDecodeStatsRecorderProxy::UpdateRecord(::media::mojom::PredictionTargetsPtr in_targets)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::VideoDecodeStatsRecorder::UpdateRecord", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("targets"), in_targets, "<value of type ::media::mojom::PredictionTargetsPtr>");
    });
#endif
