...
KeySystemCapability::KeySystemCapability(
    const std::optional<::media::CdmCapability>& sw_secure_capability_in, const std::optional<::media::CdmCapability>& hw_secure_capability_in)
...
void KeySystemSupportObserverProxy::OnKeySystemSupportUpdated(const base::flat_map<std::string, ::media::KeySystemCapability>& in_key_systems)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::KeySystemSupportObserver::OnKeySystemSupportUpdated", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("key_systems"), in_key_systems, "<value of type const base::flat_map<std::string, ::media::KeySystemCapability>&>");
    });
#endif
...
bool KeySystemSupportObserverStubDispatch::Accept(KeySystemSupportObserver* impl, mojo::Message* message)
{
    ...
    case messages::KeySystemSupportObserver::kOnKeySystemSupportUpdated: {
        ...
        bool success = true;
        base::flat_map<std::string, ::media::KeySystemCapability> p_key_systems {};
