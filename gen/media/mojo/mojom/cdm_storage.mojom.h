...
#include "media/mojo/mojom/cdm_storage.mojom-forward.h" // IWYU pragma: export
#include <string>
#include <vector>
...
class CdmStorage : public CdmStorageInterfaceBase {
public:
...
class CdmFile : public CdmFileInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class CdmStorageProxy : public CdmStorage {
public:
...
class CdmFileProxy : public CdmFile {
public:
