...
class AudioInputStream : public AudioInputStreamInterfaceBase {
public:
...
class AudioInputStreamClient : public AudioInputStreamClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class AudioInputStreamObserver : public AudioInputStreamObserverInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class AudioInputStreamProxy : public AudioInputStream {
public:
...
class AudioInputStreamClientProxy : public AudioInputStreamClient {
public:
...
class AudioInputStreamObserverProxy : public AudioInputStreamObserver {
public:
