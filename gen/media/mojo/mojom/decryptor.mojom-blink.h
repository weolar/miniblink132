// media/mojo/mojom/decryptor.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_BLINK_H_
#define MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_BLINK_H_
...
#include "media/mojo/mojom/decryptor.mojom-features.h" // IWYU pragma: export
#include "media/mojo/mojom/decryptor.mojom-shared.h" // IWYU pragma: export
#include "media/mojo/mojom/decryptor.mojom-blink-forward.h" // IWYU pragma: export
...
template <typename ImplRefTraits> class DecryptorStub;

class DecryptorRequestValidator;
class DecryptorResponseValidator;

class BLINK_PLATFORM_EXPORT Decryptor : public DecryptorInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = DecryptorStub<ImplRefTraits>;
...
// with not having this data in traces there.
    ...
    virtual void Initialize(::mojo::ScopedDataPipeConsumerHandle audio_pipe, ::mojo::ScopedDataPipeConsumerHandle video_pipe,
    ...
    using DecryptAndDecodeVideoCallback
        = base::OnceCallback<void(Decryptor::Status, ::media::mojom::blink::VideoFramePtr, ::mojo::PendingRemote<FrameResourceReleaser>)>;
...
template <typename ImplRefTraits> class FrameResourceReleaserStub;

class FrameResourceReleaserRequestValidator;

class BLINK_PLATFORM_EXPORT FrameResourceReleaser : public FrameResourceReleaserInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
    ...
    template <typename ImplRefTraits> using Stub_ = FrameResourceReleaserStub<ImplRefTraits>;
...
//class BLINK_PLATFORM_EXPORT DecryptorProxy : public Decryptor {
//public:
...
//class BLINK_PLATFORM_EXPORT FrameResourceReleaserProxy : public FrameResourceReleaser {
//public:
...
//    static bool AcceptWithResponder(Decryptor* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
//};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<Decryptor>> class DecryptorStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return DecryptorStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return DecryptorStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
...
//    static bool AcceptWithResponder(FrameResourceReleaser* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
//};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<FrameResourceReleaser>>
//class FrameResourceReleaserStub : public mojo::MessageReceiverWithResponderStatus {
//public:
//    using ImplPointerType = typename ImplRefTraits::PointerType;
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return FrameResourceReleaserStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
//    bool AcceptWithResponder(mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder) override
//    {
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return FrameResourceReleaserStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
//    ImplPointerType sink_;
...
#endif // MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_BLINK_H_
