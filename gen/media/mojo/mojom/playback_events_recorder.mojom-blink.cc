...
#include "media/mojo/mojom/playback_events_recorder.mojom-blink-test-utils.h"
...
void PlaybackEventsRecorderProxy::OnError(::media::mojom::blink::PipelineStatusPtr in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PlaybackEventsRecorderProxy::OnPipelineStatistics(::media::mojom::blink::PipelineStatisticsPtr in_stats)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PlaybackEventsRecorderInterceptorForTesting::OnError(::media::mojom::blink::PipelineStatusPtr status)
{
...
void PlaybackEventsRecorderInterceptorForTesting::OnPipelineStatistics(::media::mojom::blink::PipelineStatisticsPtr stats)
{
