...
SpeechRecognitionHypothesis::SpeechRecognitionHypothesis(const ::std::u16string& utterance_in, double confidence_in)
...
WebSpeechRecognitionResult::WebSpeechRecognitionResult(std::vector<SpeechRecognitionHypothesisPtr> hypotheses_in, bool is_provisional_in)
...
bool StructTraits<::media::mojom::SpeechRecognitionHypothesis::DataView, ::media::mojom::SpeechRecognitionHypothesisPtr>::Read(
    ::media::mojom::SpeechRecognitionHypothesis::DataView input, ::media::mojom::SpeechRecognitionHypothesisPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::WebSpeechRecognitionResult::DataView, ::media::mojom::WebSpeechRecognitionResultPtr>::Read(
    ::media::mojom::WebSpeechRecognitionResult::DataView input, ::media::mojom::WebSpeechRecognitionResultPtr* output)
{
    bool success = true;
