...
#include "media/mojo/mojom/stable/stable_video_decoder.mojom-blink-forward.h" // IWYU pragma: export
...
// with not having this data in traces there.
    ...
    virtual void OnVideoFrameDecoded(
...
// with not having this data in traces there.
    ...
    using DecryptVideoBufferCallback
        = base::OnceCallback<void(::media::stable::mojom::blink::DecryptStatus, ::media::stable::mojom::blink::DecoderBufferPtr, const WTF::Vector<uint8_t>&)>;
...
// with not having this data in traces there.
    ...
    virtual bool GetSupportedConfigs(WTF::Vector<::media::stable::mojom::blink::SupportedVideoDecoderConfigPtr>* out_supported_configs,
        ::media::stable::mojom::blink::VideoDecoderType* out_decoder_type);

    using GetSupportedConfigsCallback
        = base::OnceCallback<void(WTF::Vector<::media::stable::mojom::blink::SupportedVideoDecoderConfigPtr>, ::media::stable::mojom::blink::VideoDecoderType)>;
    ...
    using InitializeCallback
        = base::OnceCallback<void(::media::stable::mojom::blink::StatusPtr, bool, int32_t, ::media::stable::mojom::blink::VideoDecoderType, bool)>;

    virtual void Initialize(::media::stable::mojom::blink::VideoDecoderConfigPtr config, bool low_delay, ::mojo::PendingRemote<StableCdmContext> cdm_context,
...
public:
    ...
    void OnVideoFrameDecoded(
        ::media::stable::mojom::blink::VideoFramePtr frame, bool can_read_without_stalling, const ::base::UnguessableToken& release_token) final;
...
public:
    ...
    void GetHwKeyData(
        ::media::stable::mojom::blink::DecryptConfigPtr decrypt_config, const WTF::Vector<uint8_t>& hw_identifier, GetHwKeyDataCallback callback) final;
    ...
    void ParseEncryptedSliceHeader(
        uint64_t secure_handle, uint32_t offset, const WTF::Vector<uint8_t>& stream_data, ParseEncryptedSliceHeaderCallback callback) final;

    void DecryptVideoBuffer(
        ::media::stable::mojom::blink::DecoderBufferPtr buffer, const WTF::Vector<uint8_t>& bytes, DecryptVideoBufferCallback callback) final;
...
public:
    ...
    bool GetSupportedConfigs(WTF::Vector<::media::stable::mojom::blink::SupportedVideoDecoderConfigPtr>* out_supported_configs,
        ::media::stable::mojom::blink::VideoDecoderType* out_decoder_type) final;
    ...
    void Construct(::mojo::PendingAssociatedRemote<VideoDecoderClient> client, ::mojo::PendingRemote<MediaLog> media_log,
        ::mojo::PendingReceiver<VideoFrameHandleReleaser> video_frame_handle_releaser, ::mojo::ScopedDataPipeConsumerHandle decoder_buffer_pipe,
        ::media::stable::mojom::blink::ColorSpacePtr target_color_space) final;
