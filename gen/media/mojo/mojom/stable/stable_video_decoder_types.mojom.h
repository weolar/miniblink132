    ...
    , cypher_bytes()
{
    ...
    {
        return mojo::internal::SerializeImpl<SubsampleEntry::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , max_frame_average_light_level()
{
    ...
    HDRMetadata(
    const ::gfx::HdrMetadataSmpteSt2086& color_volume_metadata_in, uint32_t max_content_light_level_in, uint32_t max_frame_average_light_level_in)
    ...
    , hdr_metadata()
{
    ...
    const ::gfx::Size& coded_size_in, const ::gfx::Rect& visible_rect_in, const ::gfx::Size& natural_size_in, std::vector<uint8_t> extra_data_in,
    ::media::EncryptionScheme encryption_scheme_in, const ::gfx::ColorSpace& color_space_info_in, const std::optional<::gfx::HDRMetadata>& hdr_metadata_in)
    ...
    , require_encrypted()
{
    ...
    SupportedVideoDecoderConfig(::media::VideoCodecProfile profile_min_in, ::media::VideoCodecProfile profile_max_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SupportedVideoDecoderConfig::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , data()
{
    ...
    StatusData(const std::string& group_in, StatusCode code_in, const std::string& message_in, std::vector<::base::Value> frames_in,
    const std::optional<::media::internal::StatusData>& cause_in, ::base::Value data_in)
    ...
    : internal()
{
    ...
    explicit Status(const std::optional<::media::internal::StatusData>& internal_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Status::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , side_data()
{
    ...
    bool is_key_frame_in, std::vector<uint8_t> raw_side_data_in, ::std::unique_ptr<::media::DecryptConfig> decrypt_config_in,
    ...
    DecoderBuffer(::base::TimeDelta timestamp, ::base::TimeDelta duration, bool is_end_of_stream, uint32_t data_size, bool is_key_frame,
        std::vector<uint8_t> raw_side_data, ::std::unique_ptr<::media::DecryptConfig> decrypt_config, ::base::TimeDelta front_discard,
        ::base::TimeDelta back_discard, DecoderBufferSideDataPtr side_data);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<DecoderBuffer::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , transfer_params()
{
    ...
    ColorSpace(::gfx::ColorSpace::PrimaryID primaries_in, ::gfx::ColorSpace::TransferID transfer_in, ::gfx::ColorSpace::MatrixID matrix_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ColorSpace::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , platform_handle()
{
    ...
    NativeGpuMemoryBufferHandle(::gfx::GpuMemoryBufferId id_in, ::media::stable::mojom::NativePixmapHandlePtr platform_handle_in)
    : id(std::move(id_in))
    ...
    , hdr_metadata()
{
    ...
    const ::gfx::Size& natural_size_in, ::base::TimeDelta timestamp_in, ::gfx::GpuMemoryBufferHandle gpu_memory_buffer_handle_in,
    const ::media::VideoFrameMetadata& metadata_in, const ::gfx::ColorSpace& color_space_in, const std::optional<::gfx::HDRMetadata>& hdr_metadata_in)
    ...
    , time()
{
    ...
    MediaLogRecord(int32_t id_in, ::media::MediaLogRecord::Type type_in, ::base::Value::Dict params_in, ::base::TimeTicks time_in)
    : id(std::move(id_in))
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MediaLogRecord::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::media::stable::mojom::SubsampleEntry::DataView, ::media::stable::mojom::SubsampleEntryPtr> {
    static bool IsNull(const ::media::stable::mojom::SubsampleEntryPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::SubsampleEntryPtr* output)
    {
        output->reset();
    }

    static decltype(::media::stable::mojom::SubsampleEntry::clear_bytes) clear_bytes(const ::media::stable::mojom::SubsampleEntryPtr& input)
    {
        return input->clear_bytes;
    }

    static decltype(::media::stable::mojom::SubsampleEntry::cypher_bytes) cypher_bytes(const ::media::stable::mojom::SubsampleEntryPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::DecryptConfig::DataView, ::media::stable::mojom::DecryptConfigPtr> {
    static bool IsNull(const ::media::stable::mojom::DecryptConfigPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::DecryptConfigPtr* output)
    {
        output->reset();
    }

    static decltype(::media::stable::mojom::DecryptConfig::encryption_scheme) encryption_scheme(const ::media::stable::mojom::DecryptConfigPtr& input)
    {
        return input->encryption_scheme;
    }

    static const decltype(::media::stable::mojom::DecryptConfig::key_id)& key_id(const ::media::stable::mojom::DecryptConfigPtr& input)
    {
        return input->key_id;
    }

    static const decltype(::media::stable::mojom::DecryptConfig::iv)& iv(const ::media::stable::mojom::DecryptConfigPtr& input)
    {
        return input->iv;
    }

    static const decltype(::media::stable::mojom::DecryptConfig::subsamples)& subsamples(const ::media::stable::mojom::DecryptConfigPtr& input)
    {
        return input->subsamples;
    }

    static const decltype(::media::stable::mojom::DecryptConfig::encryption_pattern)& encryption_pattern(const ::media::stable::mojom::DecryptConfigPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::ColorVolumeMetadata::DataView, ::media::stable::mojom::ColorVolumeMetadataPtr> {
    static bool IsNull(const ::media::stable::mojom::ColorVolumeMetadataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::ColorVolumeMetadataPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::stable::mojom::ColorVolumeMetadata::primary_r)& primary_r(const ::media::stable::mojom::ColorVolumeMetadataPtr& input)
    {
        return input->primary_r;
    }

    static const decltype(::media::stable::mojom::ColorVolumeMetadata::primary_g)& primary_g(const ::media::stable::mojom::ColorVolumeMetadataPtr& input)
    {
        return input->primary_g;
    }

    static const decltype(::media::stable::mojom::ColorVolumeMetadata::primary_b)& primary_b(const ::media::stable::mojom::ColorVolumeMetadataPtr& input)
    {
        return input->primary_b;
    }

    static const decltype(::media::stable::mojom::ColorVolumeMetadata::white_point)& white_point(const ::media::stable::mojom::ColorVolumeMetadataPtr& input)
    {
        return input->white_point;
    }

    static decltype(::media::stable::mojom::ColorVolumeMetadata::luminance_max) luminance_max(const ::media::stable::mojom::ColorVolumeMetadataPtr& input)
    {
        return input->luminance_max;
    }

    static decltype(::media::stable::mojom::ColorVolumeMetadata::luminance_min) luminance_min(const ::media::stable::mojom::ColorVolumeMetadataPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::HDRMetadata::DataView, ::media::stable::mojom::HDRMetadataPtr> {
    static bool IsNull(const ::media::stable::mojom::HDRMetadataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::HDRMetadataPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::media::stable::mojom::HDRMetadata::max_content_light_level) max_content_light_level(const ::media::stable::mojom::HDRMetadataPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::VideoDecoderConfig::DataView, ::media::stable::mojom::VideoDecoderConfigPtr> {
    static bool IsNull(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::VideoDecoderConfigPtr* output)
    {
        output->reset();
    }

    static decltype(::media::stable::mojom::VideoDecoderConfig::codec) codec(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->codec;
    }

    static decltype(::media::stable::mojom::VideoDecoderConfig::profile) profile(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->profile;
    }

    static decltype(::media::stable::mojom::VideoDecoderConfig::level) level(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->level;
    }

    static decltype(::media::stable::mojom::VideoDecoderConfig::has_alpha) has_alpha(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->has_alpha;
    }

    static const decltype(::media::stable::mojom::VideoDecoderConfig::coded_size)& coded_size(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->coded_size;
    }

    static const decltype(::media::stable::mojom::VideoDecoderConfig::visible_rect)& visible_rect(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->visible_rect;
    }

    static const decltype(::media::stable::mojom::VideoDecoderConfig::natural_size)& natural_size(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->natural_size;
    }

    static const decltype(::media::stable::mojom::VideoDecoderConfig::extra_data)& extra_data(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->extra_data;
    }

    static decltype(::media::stable::mojom::VideoDecoderConfig::encryption_scheme) encryption_scheme(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
        return input->encryption_scheme;
    }
    ...
    static const decltype(::media::stable::mojom::VideoDecoderConfig::hdr_metadata)& hdr_metadata(const ::media::stable::mojom::VideoDecoderConfigPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::SupportedVideoDecoderConfig::DataView, ::media::stable::mojom::SupportedVideoDecoderConfigPtr> {
    static bool IsNull(const ::media::stable::mojom::SupportedVideoDecoderConfigPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::SupportedVideoDecoderConfigPtr* output)
    {
        output->reset();
    }
...
template <> struct StructTraits<::media::stable::mojom::StatusData::DataView, ::media::stable::mojom::StatusDataPtr> {
    static bool IsNull(const ::media::stable::mojom::StatusDataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::StatusDataPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::stable::mojom::StatusData::group)& group(const ::media::stable::mojom::StatusDataPtr& input)
    {
        return input->group;
    }

    static decltype(::media::stable::mojom::StatusData::code) code(const ::media::stable::mojom::StatusDataPtr& input)
    {
        return input->code;
    }

    static const decltype(::media::stable::mojom::StatusData::message)& message(const ::media::stable::mojom::StatusDataPtr& input)
    {
        return input->message;
    }

    static const decltype(::media::stable::mojom::StatusData::frames)& frames(const ::media::stable::mojom::StatusDataPtr& input)
    {
        return input->frames;
    }

    static const decltype(::media::stable::mojom::StatusData::cause)& cause(const ::media::stable::mojom::StatusDataPtr& input)
    {
        return input->cause;
    }

    static const decltype(::media::stable::mojom::StatusData::data)& data(const ::media::stable::mojom::StatusDataPtr& input)
    {
        return input->data;
    }
...
template <> struct StructTraits<::media::stable::mojom::Status::DataView, ::media::stable::mojom::StatusPtr> {
    static bool IsNull(const ::media::stable::mojom::StatusPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::StatusPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::stable::mojom::Status::internal)& internal(const ::media::stable::mojom::StatusPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::DecoderBufferSideData::DataView, ::media::stable::mojom::DecoderBufferSideDataPtr> {
    static bool IsNull(const ::media::stable::mojom::DecoderBufferSideDataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::DecoderBufferSideDataPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::media::stable::mojom::DecoderBufferSideData::alpha_data)& alpha_data(const ::media::stable::mojom::DecoderBufferSideDataPtr& input)
    {
        return input->alpha_data;
    }

    static decltype(::media::stable::mojom::DecoderBufferSideData::secure_handle) secure_handle(const ::media::stable::mojom::DecoderBufferSideDataPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::DecoderBuffer::DataView, ::media::stable::mojom::DecoderBufferPtr> {
    static bool IsNull(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::DecoderBufferPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::stable::mojom::DecoderBuffer::timestamp)& timestamp(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->timestamp;
    }

    static const decltype(::media::stable::mojom::DecoderBuffer::duration)& duration(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->duration;
    }

    static decltype(::media::stable::mojom::DecoderBuffer::is_end_of_stream) is_end_of_stream(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->is_end_of_stream;
    }

    static decltype(::media::stable::mojom::DecoderBuffer::data_size) data_size(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->data_size;
    }

    static decltype(::media::stable::mojom::DecoderBuffer::is_key_frame) is_key_frame(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->is_key_frame;
    }

    static const decltype(::media::stable::mojom::DecoderBuffer::raw_side_data)& raw_side_data(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->raw_side_data;
    }

    static const decltype(::media::stable::mojom::DecoderBuffer::decrypt_config)& decrypt_config(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->decrypt_config;
    }

    static const decltype(::media::stable::mojom::DecoderBuffer::front_discard)& front_discard(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->front_discard;
    }

    static const decltype(::media::stable::mojom::DecoderBuffer::back_discard)& back_discard(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
        return input->back_discard;
    }

    static const decltype(::media::stable::mojom::DecoderBuffer::side_data)& side_data(const ::media::stable::mojom::DecoderBufferPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::ColorSpace::DataView, ::media::stable::mojom::ColorSpacePtr> {
    static bool IsNull(const ::media::stable::mojom::ColorSpacePtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::ColorSpacePtr* output)
    {
        output->reset();
    }

    static decltype(::media::stable::mojom::ColorSpace::primaries) primaries(const ::media::stable::mojom::ColorSpacePtr& input)
    {
        return input->primaries;
    }

    static decltype(::media::stable::mojom::ColorSpace::transfer) transfer(const ::media::stable::mojom::ColorSpacePtr& input)
    {
        return input->transfer;
    }

    static decltype(::media::stable::mojom::ColorSpace::matrix) matrix(const ::media::stable::mojom::ColorSpacePtr& input)
    {
        return input->matrix;
    }

    static decltype(::media::stable::mojom::ColorSpace::range) range(const ::media::stable::mojom::ColorSpacePtr& input)
    {
        return input->range;
    }

    static const decltype(::media::stable::mojom::ColorSpace::custom_primary_matrix)& custom_primary_matrix(const ::media::stable::mojom::ColorSpacePtr& input)
    {
        return input->custom_primary_matrix;
    }

    static const decltype(::media::stable::mojom::ColorSpace::transfer_params)& transfer_params(const ::media::stable::mojom::ColorSpacePtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::NativeGpuMemoryBufferHandle::DataView, ::media::stable::mojom::NativeGpuMemoryBufferHandlePtr> {
    static bool IsNull(const ::media::stable::mojom::NativeGpuMemoryBufferHandlePtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::NativeGpuMemoryBufferHandlePtr* output)
    {
        output->reset();
    }

    static const decltype(::media::stable::mojom::NativeGpuMemoryBufferHandle::id)& id(const ::media::stable::mojom::NativeGpuMemoryBufferHandlePtr& input)
    {
        return input->id;
    }
...
template <> struct StructTraits<::media::stable::mojom::VideoFrameMetadata::DataView, ::media::stable::mojom::VideoFrameMetadataPtr> {
    static bool IsNull(const ::media::stable::mojom::VideoFrameMetadataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::VideoFrameMetadataPtr* output)
    {
        output->reset();
    }

    static decltype(::media::stable::mojom::VideoFrameMetadata::protected_video) protected_video(const ::media::stable::mojom::VideoFrameMetadataPtr& input)
    {
        return input->protected_video;
    }

    static decltype(::media::stable::mojom::VideoFrameMetadata::hw_protected) hw_protected(const ::media::stable::mojom::VideoFrameMetadataPtr& input)
    {
        return input->hw_protected;
    }

    static decltype(::media::stable::mojom::VideoFrameMetadata::needs_detiling) needs_detiling(const ::media::stable::mojom::VideoFrameMetadataPtr& input)
    {
...
template <> struct StructTraits<::media::stable::mojom::VideoFrame::DataView, ::media::stable::mojom::VideoFramePtr> {
    static bool IsNull(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::VideoFramePtr* output)
    {
        output->reset();
    }

    static decltype(::media::stable::mojom::VideoFrame::format) format(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->format;
    }

    static const decltype(::media::stable::mojom::VideoFrame::coded_size)& coded_size(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->coded_size;
    }

    static const decltype(::media::stable::mojom::VideoFrame::visible_rect)& visible_rect(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->visible_rect;
    }

    static const decltype(::media::stable::mojom::VideoFrame::natural_size)& natural_size(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->natural_size;
    }

    static const decltype(::media::stable::mojom::VideoFrame::timestamp)& timestamp(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->timestamp;
    }

    static decltype(::media::stable::mojom::VideoFrame::gpu_memory_buffer_handle)& gpu_memory_buffer_handle(::media::stable::mojom::VideoFramePtr& input)
    {
        return input->gpu_memory_buffer_handle;
    }

    static const decltype(::media::stable::mojom::VideoFrame::metadata)& metadata(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->metadata;
    }

    static const decltype(::media::stable::mojom::VideoFrame::color_space)& color_space(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->color_space;
    }

    static const decltype(::media::stable::mojom::VideoFrame::hdr_metadata)& hdr_metadata(const ::media::stable::mojom::VideoFramePtr& input)
    {
        return input->hdr_metadata;
    }
...
template <> struct StructTraits<::media::stable::mojom::MediaLogRecord::DataView, ::media::stable::mojom::MediaLogRecordPtr> {
    static bool IsNull(const ::media::stable::mojom::MediaLogRecordPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::stable::mojom::MediaLogRecordPtr* output)
    {
        output->reset();
    }

    static decltype(::media::stable::mojom::MediaLogRecord::id) id(const ::media::stable::mojom::MediaLogRecordPtr& input)
    {
        return input->id;
    }

    static decltype(::media::stable::mojom::MediaLogRecord::type) type(const ::media::stable::mojom::MediaLogRecordPtr& input)
    {
        return input->type;
    }

    static const decltype(::media::stable::mojom::MediaLogRecord::params)& params(const ::media::stable::mojom::MediaLogRecordPtr& input)
    {
        return input->params;
    }

    static const decltype(::media::stable::mojom::MediaLogRecord::time)& time(const ::media::stable::mojom::MediaLogRecordPtr& input)
    {
        return input->time;
    }
