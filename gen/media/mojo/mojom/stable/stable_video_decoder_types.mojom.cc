...
Status::Status(const std::optional<::media::internal::StatusData>& internal_in)
...
DecoderBuffer::DecoderBuffer(::base::TimeDelta timestamp_in, ::base::TimeDelta duration_in, bool is_end_of_stream_in, uint32_t data_size_in,
    bool is_key_frame_in, std::vector<uint8_t> raw_side_data_in, ::std::unique_ptr<::media::DecryptConfig> decrypt_config_in,
    ::base::TimeDelta front_discard_in, ::base::TimeDelta back_discard_in, DecoderBufferSideDataPtr side_data_in)
    : timestamp(std::move(timestamp_in))
    , duration(std::move(duration_in))
    , is_end_of_stream(std::move(is_end_of_stream_in))
    , data_size(std::move(data_size_in))
...
bool StructTraits<::media::stable::mojom::DecoderBufferSideData::DataView, ::media::stable::mojom::DecoderBufferSideDataPtr>::Read(
    ::media::stable::mojom::DecoderBufferSideData::DataView input, ::media::stable::mojom::DecoderBufferSideDataPtr* output)
{
    bool success = true;
