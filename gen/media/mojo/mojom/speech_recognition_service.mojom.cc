...
void AudioSourceSpeechRecognitionContextProxy::BindAudioSourceFetcher(::mojo::PendingReceiver<AudioSourceFetcher> in_fetcher_receiver,
    ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient> in_client, ::media::mojom::SpeechRecognitionOptionsPtr in_options,
    BindAudioSourceFetcherCallback callback)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send media::mojom::AudioSourceSpeechRecognitionContext::BindAudioSourceFetcher", "input_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("client"), in_client, "<value of type ::mojo::PendingRemote<::media::mojom::SpeechRecognitionRecognizerClient>>");
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("options"), in_options, "<value of type ::media::mojom::SpeechRecognitionOptionsPtr>");
        });
#endif
    ...
    AudioSourceSpeechRecognitionContext* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case messages::AudioSourceSpeechRecognitionContext::kBindAudioSourceFetcher: {
        ...
        ::media::mojom::SpeechRecognitionOptionsPtr p_options {};
...
{
    const char* name = ::media::mojom::AudioSourceSpeechRecognitionContext::Name_;
...
void SpeechRecognitionServiceProxy::BindSpeechRecognitionContext(::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext> in_context)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionService::BindSpeechRecognitionContext", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("context"), in_context, "<value of type ::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext>>");
    });
#endif
...
void SpeechRecognitionServiceProxy::SetSodaPaths(
    const ::base::FilePath& in_binary_path, const base::flat_map<std::string, ::base::FilePath>& in_config_paths, const std::string& in_primary_language_name)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionService::SetSodaPaths", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("config_paths"), in_config_paths, "<value of type const base::flat_map<std::string, ::base::FilePath>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("primary_language_name"), in_primary_language_name, "<value of type const std::string&>");
    });
#endif
...
void SpeechRecognitionServiceProxy::SetSodaConfigPaths(const base::flat_map<std::string, ::base::FilePath>& in_config_paths)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool SpeechRecognitionServiceStubDispatch::Accept(SpeechRecognitionService* impl, mojo::Message* message)
{
    ...
    case messages::SpeechRecognitionService::kSetSodaPaths: {
        ...
        std::string p_primary_language_name {};
...
void AudioSourceFetcherProxy::Start(
    ::mojo::PendingRemote<::media::mojom::AudioStreamFactory> in_factory, const std::string& in_device_id, const ::media::AudioParameters& in_audio_parameters)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::AudioSourceFetcher::Start", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("factory"), in_factory, "<value of type ::mojo::PendingRemote<::media::mojom::AudioStreamFactory>>");
...
{
    const char* name = ::media::mojom::AudioSourceFetcher::Name_;
...
void SpeechRecognitionServiceInterceptorForTesting::BindSpeechRecognitionContext(::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext> context)
{
...
void SpeechRecognitionServiceInterceptorForTesting::SetSodaPaths(
    const ::base::FilePath& binary_path, const base::flat_map<std::string, ::base::FilePath>& config_paths, const std::string& primary_language_name)
{
...
void SpeechRecognitionServiceInterceptorForTesting::SetSodaConfigPaths(const base::flat_map<std::string, ::base::FilePath>& config_paths)
{
...
void AudioSourceFetcherInterceptorForTesting::Start(
    ::mojo::PendingRemote<::media::mojom::AudioStreamFactory> factory, const std::string& device_id, const ::media::AudioParameters& audio_parameters)
{
