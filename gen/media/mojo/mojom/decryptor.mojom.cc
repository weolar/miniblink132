...
void DecryptorProxy::Decrypt(::media::Decryptor::StreamType in_stream_type, ::media::mojom::DecoderBufferPtr in_encrypted, DecryptCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::Decryptor::Decrypt", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("stream_type"), in_stream_type, "<value of type ::media::Decryptor::StreamType>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("encrypted"), in_encrypted, "<value of type ::media::mojom::DecoderBufferPtr>");
    });
#endif
...
void DecryptorProxy::CancelDecrypt(::media::Decryptor::StreamType in_stream_type)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DecryptorProxy::InitializeAudioDecoder(const ::media::AudioDecoderConfig& in_config, InitializeAudioDecoderCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DecryptorProxy::InitializeVideoDecoder(const ::media::VideoDecoderConfig& in_config, InitializeVideoDecoderCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DecryptorProxy::DecryptAndDecodeAudio(::media::mojom::DecoderBufferPtr in_encrypted, DecryptAndDecodeAudioCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DecryptorProxy::DecryptAndDecodeVideo(::media::mojom::DecoderBufferPtr in_encrypted, DecryptAndDecodeVideoCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DecryptorProxy::ResetDecoder(::media::Decryptor::StreamType in_stream_type)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void DecryptorProxy::DeinitializeDecoder(::media::Decryptor::StreamType in_stream_type)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(::media::Decryptor::Status in_status, ::media::mojom::DecoderBufferPtr in_buffer);
};
...
void Decryptor_Decrypt_ProxyToResponder::Run(::media::Decryptor::Status in_status, ::media::mojom::DecoderBufferPtr in_buffer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(::media::Decryptor::Status in_status, std::vector<::media::mojom::AudioBufferPtr> in_audio_buffers);
};
...
void Decryptor_DecryptAndDecodeAudio_ProxyToResponder::Run(::media::Decryptor::Status in_status, std::vector<::media::mojom::AudioBufferPtr> in_audio_buffers)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply media::mojom::Decryptor::DecryptAndDecodeAudio", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("audio_buffers"), in_audio_buffers, "<value of type std::vector<::media::mojom::AudioBufferPtr>>");
    });
#endif
...
private:
    ...
    void Run(::media::Decryptor::Status in_status, const ::scoped_refptr<::media::VideoFrame>& in_video_frame,
        ::mojo::PendingRemote<FrameResourceReleaser> in_releaser);
};
    ...
    ::media::Decryptor::Status in_status, const ::scoped_refptr<::media::VideoFrame>& in_video_frame, ::mojo::PendingRemote<FrameResourceReleaser> in_releaser)
{
    ...
    TRACE_EVENT1("mojom", "Send reply media::mojom::Decryptor::DecryptAndDecodeVideo", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("status"), in_status, "<value of type ::media::Decryptor::Status>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("video_frame"), in_video_frame, "<value of type const ::scoped_refptr<::media::VideoFrame>&>");
...
{
    const char* name = ::media::mojom::Decryptor::Name_;
...
{
    const char* name = ::media::mojom::FrameResourceReleaser::Name_;
...
void DecryptorAsyncWaiter::Decrypt(::media::Decryptor::StreamType stream_type, ::media::mojom::DecoderBufferPtr encrypted,
    ::media::Decryptor::Status* out_status, ::media::mojom::DecoderBufferPtr* out_buffer)
{
    base::RunLoop loop;
    proxy_->Decrypt(std::move(stream_type), std::move(encrypted),
        base::BindOnce(
            [](base::RunLoop* loop, ::media::Decryptor::Status* out_status, ::media::mojom::DecoderBufferPtr* out_buffer, ::media::Decryptor::Status status,
...
void DecryptorAsyncWaiter::InitializeAudioDecoder(const ::media::AudioDecoderConfig& config, bool* out_success)
{
    base::RunLoop loop;
...
bool DecryptorAsyncWaiter::InitializeAudioDecoder(const ::media::AudioDecoderConfig& config)
{
...
void DecryptorAsyncWaiter::InitializeVideoDecoder(const ::media::VideoDecoderConfig& config, bool* out_success)
{
    base::RunLoop loop;
...
bool DecryptorAsyncWaiter::InitializeVideoDecoder(const ::media::VideoDecoderConfig& config)
{
    bool async_wait_result;
    ...
    ::media::mojom::DecoderBufferPtr encrypted, ::media::Decryptor::Status* out_status, std::vector<::media::mojom::AudioBufferPtr>* out_audio_buffers)
{
    ...
    proxy_->DecryptAndDecodeAudio(std::move(encrypted),
        base::BindOnce(
            [](base::RunLoop* loop, ::media::Decryptor::Status* out_status, std::vector<::media::mojom::AudioBufferPtr>* out_audio_buffers,
                ::media::Decryptor::Status status, std::vector<::media::mojom::AudioBufferPtr> audio_buffers) {
                *out_status = std::move(status);
...
void DecryptorAsyncWaiter::DecryptAndDecodeVideo(::media::mojom::DecoderBufferPtr encrypted, ::media::Decryptor::Status* out_status,
    ::scoped_refptr<::media::VideoFrame>* out_video_frame, ::mojo::PendingRemote<FrameResourceReleaser>* out_releaser)
{
    ...
    proxy_->DecryptAndDecodeVideo(std::move(encrypted),
        base::BindOnce(
            [](base::RunLoop* loop, ::media::Decryptor::Status* out_status, ::scoped_refptr<::media::VideoFrame>* out_video_frame,
                ::mojo::PendingRemote<FrameResourceReleaser>* out_releaser, ::media::Decryptor::Status status,
                const ::scoped_refptr<::media::VideoFrame>& video_frame, ::mojo::PendingRemote<FrameResourceReleaser> releaser) {
                *out_status = std::move(status);
