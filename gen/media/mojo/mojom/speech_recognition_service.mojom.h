...
#include "media/mojo/mojom/speech_recognition_service.mojom-forward.h" // IWYU pragma: export
...
class AudioSourceSpeechRecognitionContext : public AudioSourceSpeechRecognitionContextInterfaceBase {
public:
...
class SpeechRecognitionService : public SpeechRecognitionServiceInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void BindSpeechRecognitionContext(::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext> context) = 0;
    ...
    virtual void SetSodaConfigPaths(const base::flat_map<std::string, ::base::FilePath>& config_paths) = 0;
};
...
class AudioSourceFetcher : public AudioSourceFetcherInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class AudioSourceSpeechRecognitionContextProxy : public AudioSourceSpeechRecognitionContext {
public:
...
class SpeechRecognitionServiceProxy : public SpeechRecognitionService {
public:
    ...
    void BindSpeechRecognitionContext(::mojo::PendingReceiver<::media::mojom::SpeechRecognitionContext> context) final;

    void BindAudioSourceSpeechRecognitionContext(::mojo::PendingReceiver<AudioSourceSpeechRecognitionContext> context) final;

    void SetSodaPaths(
        const ::base::FilePath& binary_path, const base::flat_map<std::string, ::base::FilePath>& config_paths, const std::string& primary_language_name) final;

    void SetSodaParams(bool mask_offensive_words) final;

    void SetSodaConfigPaths(const base::flat_map<std::string, ::base::FilePath>& config_paths) final;

private:
    mojo::MessageReceiverWithResponder* receiver_;
};

class AudioSourceFetcherProxy : public AudioSourceFetcher {
public:
...
class AudioSourceSpeechRecognitionContextStubDispatch {
public:
...
//    ImplPointerType sink_;
//};
class AudioSourceFetcherStubDispatch {
public:
...
//    ImplPointerType sink_;
//};
//class AudioSourceSpeechRecognitionContextRequestValidator : public mojo::MessageReceiver {
//public:
//    bool Accept(mojo::Message* message) override;
//};
...
//    bool Accept(mojo::Message* message) override;
//};
//class AudioSourceFetcherRequestValidator : public mojo::MessageReceiver {
//public:
//    bool Accept(mojo::Message* message) override;
//};
//class AudioSourceSpeechRecognitionContextResponseValidator : public mojo::MessageReceiver {
//public:
//    bool Accept(mojo::Message* message) override;
//};
