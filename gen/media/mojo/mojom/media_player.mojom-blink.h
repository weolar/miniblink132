...
class BLINK_PLATFORM_EXPORT MediaPlayer : public MediaPlayerInterfaceBase {
public:
...
class BLINK_PLATFORM_EXPORT MediaPlayerObserverClient : public MediaPlayerObserverClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_PLATFORM_EXPORT MediaPlayerObserver : public MediaPlayerObserverInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_PLATFORM_EXPORT MediaPlayerHost : public MediaPlayerHostInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_PLATFORM_EXPORT MediaPlayerProxy : public MediaPlayer {
//public:
...
//class BLINK_PLATFORM_EXPORT MediaPlayerObserverClientProxy : public MediaPlayerObserverClient {
//public:
...
//class BLINK_PLATFORM_EXPORT MediaPlayerObserverProxy : public MediaPlayerObserver {
//public:
...
//class BLINK_PLATFORM_EXPORT MediaPlayerHostProxy : public MediaPlayerHost {
//public:
...
//    bool Accept(mojo::Message* message) override;
//};
//class BLINK_PLATFORM_EXPORT MediaPlayerResponseValidator : public mojo::MessageReceiver {
//public:
//    bool Accept(mojo::Message* message) override;
//};
