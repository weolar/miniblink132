...
AudioDataS16::AudioDataS16(int32_t channel_count_in, int32_t sample_rate_in, int32_t frame_count_in, std::vector<int16_t> data_in)
...
bool StructTraits<::media::mojom::AudioDataS16::DataView, ::media::mojom::AudioDataS16Ptr>::Read(
    ::media::mojom::AudioDataS16::DataView input, ::media::mojom::AudioDataS16Ptr* output)
{
    bool success = true;
