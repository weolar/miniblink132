...
#include "media/mojo/mojom/decryptor.mojom-forward.h" // IWYU pragma: export
...
class Decryptor : public DecryptorInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    using DecryptAndDecodeVideoCallback
        = base::OnceCallback<void(::media::Decryptor::Status, const ::scoped_refptr<::media::VideoFrame>&, ::mojo::PendingRemote<FrameResourceReleaser>)>;
...
class FrameResourceReleaser : public FrameResourceReleaserInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class DecryptorProxy : public Decryptor {
public:
...
class FrameResourceReleaserProxy : public FrameResourceReleaser {
public:
