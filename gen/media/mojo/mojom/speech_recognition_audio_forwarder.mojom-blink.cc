// media/mojo/mojom/speech_recognition_audio_forwarder.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "media/mojo/mojom/speech_recognition_audio_forwarder.mojom-blink-test-utils.h"
...
void SpeechRecognitionAudioForwarderProxy::AddAudioFromRenderer(::media::mojom::blink::AudioDataS16Ptr in_buffer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::media::mojom::blink::SpeechRecognitionAudioForwarder::Name_;
...
void SpeechRecognitionAudioForwarderInterceptorForTesting::AddAudioFromRenderer(::media::mojom::blink::AudioDataS16Ptr buffer)
{
