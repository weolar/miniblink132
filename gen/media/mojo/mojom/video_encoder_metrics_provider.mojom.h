...
class VideoEncoderMetricsProvider : public VideoEncoderMetricsProviderInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void Initialize(uint64_t encoder_id, VideoEncoderUseCase encoder_use_case, ::media::VideoCodecProfile profile, const ::gfx::Size& encode_size,
        bool is_hardware_encoder, ::media::SVCScalabilityMode svc_mode)
        = 0;
...
class VideoEncoderMetricsProviderProxy : public VideoEncoderMetricsProvider {
public:
    ...
    void Initialize(uint64_t encoder_id, VideoEncoderUseCase encoder_use_case, ::media::VideoCodecProfile profile, const ::gfx::Size& encode_size,
        bool is_hardware_encoder, ::media::SVCScalabilityMode svc_mode) final;
