...
DecryptConfig::DecryptConfig(EncryptionScheme encryption_scheme_in, const std::string& key_id_in, const std::string& iv_in,
...
AudioBuffer::AudioBuffer(SampleFormat sample_format_in, ChannelLayout channel_layout_in, int32_t channel_count_in, int32_t sample_rate_in,
...
StatusData::StatusData(const WTF::String& group_in, uint16_t code_in, const WTF::String& message_in, ::base::Value::List frames_in, StatusDataPtr cause_in,
...
void DecoderBufferSideDataNextConfig::set_next_audio_config(AudioDecoderConfigPtr next_audio_config)
{
    if (tag_ == Tag::kNextAudioConfig) {
        *(data_.next_audio_config) = std::move(next_audio_config);
        ...
        DestroyActive();
        tag_ = Tag::kNextAudioConfig;
        data_.next_audio_config = new AudioDecoderConfigPtr(std::move(next_audio_config));
    }
}
void DecoderBufferSideDataNextConfig::set_next_video_config(VideoDecoderConfigPtr next_video_config)
{
    if (tag_ == Tag::kNextVideoConfig) {
        *(data_.next_video_config) = std::move(next_video_config);
        ...
        data_.next_video_config = new VideoDecoderConfigPtr(std::move(next_video_config));
    }
}
...
bool StructTraits<::media::mojom::blink::VideoAspectRatio::DataView, ::media::mojom::blink::VideoAspectRatioPtr>::Read(
    ::media::mojom::blink::VideoAspectRatio::DataView input, ::media::mojom::blink::VideoAspectRatioPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::DecoderBufferSideData::DataView, ::media::mojom::blink::DecoderBufferSideDataPtr>::Read(
    ::media::mojom::blink::DecoderBufferSideData::DataView input, ::media::mojom::blink::DecoderBufferSideDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::DataDecoderBuffer::DataView, ::media::mojom::blink::DataDecoderBufferPtr>::Read(
    ::media::mojom::blink::DataDecoderBuffer::DataView input, ::media::mojom::blink::DataDecoderBufferPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::EosDecoderBuffer::DataView, ::media::mojom::blink::EosDecoderBufferPtr>::Read(
    ::media::mojom::blink::EosDecoderBuffer::DataView input, ::media::mojom::blink::EosDecoderBufferPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::media::mojom::blink::GpuMemoryBufferSharedImageVideoFrameData::DataView,
    ::media::mojom::blink::GpuMemoryBufferSharedImageVideoFrameDataPtr>::Read(::media::mojom::blink::GpuMemoryBufferSharedImageVideoFrameData::DataView input,
    ::media::mojom::blink::GpuMemoryBufferSharedImageVideoFrameDataPtr* output)
{
    bool success = true;
    ::media::mojom::blink::GpuMemoryBufferSharedImageVideoFrameDataPtr result(::media::mojom::blink::GpuMemoryBufferSharedImageVideoFrameData::New());
...
bool StructTraits<::media::mojom::blink::SharedImageVideoFrameData::DataView, ::media::mojom::blink::SharedImageVideoFrameDataPtr>::Read(
    ::media::mojom::blink::SharedImageVideoFrameData::DataView input, ::media::mojom::blink::SharedImageVideoFrameDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::OpaqueVideoFrameData::DataView, ::media::mojom::blink::OpaqueVideoFrameDataPtr>::Read(
    ::media::mojom::blink::OpaqueVideoFrameData::DataView input, ::media::mojom::blink::OpaqueVideoFrameDataPtr* output)
{
    bool success = true;
...
bool UnionTraits<::media::mojom::blink::DecoderBufferSideDataNextConfig::DataView, ::media::mojom::blink::DecoderBufferSideDataNextConfigPtr>::Read(
    ::media::mojom::blink::DecoderBufferSideDataNextConfig::DataView input, ::media::mojom::blink::DecoderBufferSideDataNextConfigPtr* output)
{
    ...
    ::media::mojom::blink::VideoFrameData::DataView input, ::media::mojom::blink::VideoFrameDataPtr* output)
{
    ...
    case Tag::kGpuMemoryBufferSharedImageData: {
        ::media::mojom::blink::GpuMemoryBufferSharedImageVideoFrameDataPtr result_gpu_memory_buffer_shared_image_data;
