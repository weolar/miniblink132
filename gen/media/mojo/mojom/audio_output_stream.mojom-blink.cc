...
void DeviceSwitchInterfaceProxy::SwitchAudioOutputDeviceId(const WTF::String& in_output_device_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::media::mojom::blink::DeviceSwitchInterface::Name_;
...
void AudioOutputStreamProviderClientInterceptorForTesting::Created(
    ::mojo::PendingRemote<AudioOutputStream> stream, ::media::mojom::blink::ReadWriteAudioDataPipePtr data_pipe)
{
...
void DeviceSwitchInterfaceInterceptorForTesting::SwitchAudioOutputDeviceId(const WTF::String& output_device_id)
{
