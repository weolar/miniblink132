...
HypothesisParts::HypothesisParts(WTF::Vector<WTF::String> text_in, ::base::TimeDelta hypothesis_part_offset_in)
...
TimingInformation::TimingInformation(
    ::base::TimeDelta audio_start_time_in, ::base::TimeDelta audio_end_time_in, std::optional<WTF::Vector<HypothesisPartsPtr>> hypothesis_parts_in)
...
SpeechRecognitionResult::SpeechRecognitionResult(const WTF::String& transcription_in, bool is_final_in, TimingInformationPtr timing_information_in)
...
LanguageIdentificationEvent::LanguageIdentificationEvent(const WTF::String& language_in, ConfidenceLevel confidence_level_in)
...
LanguageIdentificationEvent::LanguageIdentificationEvent(
    const WTF::String& language_in, ConfidenceLevel confidence_level_in, std::optional<AsrSwitchResult> asr_switch_result_in)
    : language(std::move(language_in))
    , confidence_level(std::move(confidence_level_in))
...
SpeechRecognitionOptions::SpeechRecognitionOptions(SpeechRecognitionMode recognition_mode_in, bool enable_formatting_in, const WTF::String& language_in)
...
SpeechRecognitionOptions::SpeechRecognitionOptions(SpeechRecognitionMode recognition_mode_in, bool enable_formatting_in, const WTF::String& language_in,
    bool is_server_based_in, RecognizerClientType recognizer_client_type_in, bool skip_continuously_empty_audio_in)
    : recognition_mode(std::move(recognition_mode_in))
    , enable_formatting(std::move(enable_formatting_in))
    , language(std::move(language_in))
    , is_server_based(std::move(is_server_based_in))
...
SpeechRecognitionOptions::SpeechRecognitionOptions(SpeechRecognitionMode recognition_mode_in, bool enable_formatting_in, const WTF::String& language_in,
    bool is_server_based_in, RecognizerClientType recognizer_client_type_in, bool skip_continuously_empty_audio_in,
    const WTF::String& experiment_recognizer_routing_key_in, int32_t channel_count_in, int32_t sample_rate_in)
    : recognition_mode(std::move(recognition_mode_in))
    , enable_formatting(std::move(enable_formatting_in))
    , language(std::move(language_in))
    , is_server_based(std::move(is_server_based_in))
...
void SpeechRecognitionContextProxy::BindWebSpeechRecognizer(::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionSession> in_session_receiver,
    ::mojo::PendingRemote<::media::mojom::blink::SpeechRecognitionSessionClient> in_session_client,
    ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionAudioForwarder> in_audio_forwarder, int32_t in_channel_count, int32_t in_sample_rate,
    SpeechRecognitionOptionsPtr in_options, bool in_continuous)
{
    ...
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionContext::BindWebSpeechRecognizer", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("session_receiver"), in_session_receiver, "<value of type ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionSession>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("session_client"), in_session_client, "<value of type ::mojo::PendingRemote<::media::mojom::blink::SpeechRecognitionSessionClient>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("audio_forwarder"), in_audio_forwarder,
...
bool SpeechRecognitionContextStubDispatch::Accept(SpeechRecognitionContext* impl, mojo::Message* message)
{
    ...
    case messages::SpeechRecognitionContext::kBindWebSpeechRecognizer: {
        ...
        bool success = true;
        ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionSession> p_session_receiver {};
        ::mojo::PendingRemote<::media::mojom::blink::SpeechRecognitionSessionClient> p_session_client {};
        ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionAudioForwarder> p_audio_forwarder {};
...
void SpeechRecognitionRecognizerProxy::SendAudioToSpeechRecognitionService(::media::mojom::blink::AudioDataS16Ptr in_buffer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send media::mojom::SpeechRecognitionRecognizer::SendAudioToSpeechRecognitionService", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("buffer"), in_buffer, "<value of type ::media::mojom::blink::AudioDataS16Ptr>");
        });
#endif
...
void SpeechRecognitionRecognizerProxy::OnLanguageChanged(const WTF::String& in_language)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionRecognizer::OnLanguageChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("language"), in_language, "<value of type const WTF::String&>");
    });
#endif
    ...
    SpeechRecognitionResultPtr in_result, OnSpeechRecognitionRecognitionEventCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send media::mojom::SpeechRecognitionRecognizerClient::OnSpeechRecognitionRecognitionEvent", "input_parameters",
        [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type SpeechRecognitionResultPtr>");
        });
#endif
...
void SpeechRecognitionBrowserObserverProxy::SpeechRecognitionLanguageChanged(const WTF::String& in_language)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::media::mojom::blink::SpeechRecognitionSurface::Name_;
...
{
    const char* name = ::media::mojom::blink::SpeechRecognitionSurfaceClient::Name_;
...
bool StructTraits<::media::mojom::blink::HypothesisParts::DataView, ::media::mojom::blink::HypothesisPartsPtr>::Read(
    ::media::mojom::blink::HypothesisParts::DataView input, ::media::mojom::blink::HypothesisPartsPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::TimingInformation::DataView, ::media::mojom::blink::TimingInformationPtr>::Read(
    ::media::mojom::blink::TimingInformation::DataView input, ::media::mojom::blink::TimingInformationPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::SpeechRecognitionResult::DataView, ::media::mojom::blink::SpeechRecognitionResultPtr>::Read(
    ::media::mojom::blink::SpeechRecognitionResult::DataView input, ::media::mojom::blink::SpeechRecognitionResultPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::LanguageIdentificationEvent::DataView, ::media::mojom::blink::LanguageIdentificationEventPtr>::Read(
    ::media::mojom::blink::LanguageIdentificationEvent::DataView input, ::media::mojom::blink::LanguageIdentificationEventPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::blink::SpeechRecognitionSurfaceMetadata::DataView, ::media::mojom::blink::SpeechRecognitionSurfaceMetadataPtr>::Read(
    ::media::mojom::blink::SpeechRecognitionSurfaceMetadata::DataView input, ::media::mojom::blink::SpeechRecognitionSurfaceMetadataPtr* output)
{
    bool success = true;
    ::media::mojom::blink::SpeechRecognitionSurfaceMetadataPtr result(::media::mojom::blink::SpeechRecognitionSurfaceMetadata::New());
...
bool StructTraits<::media::mojom::blink::SpeechRecognitionOptions::DataView, ::media::mojom::blink::SpeechRecognitionOptionsPtr>::Read(
    ::media::mojom::blink::SpeechRecognitionOptions::DataView input, ::media::mojom::blink::SpeechRecognitionOptionsPtr* output)
{
    bool success = true;
...
void SpeechRecognitionContextInterceptorForTesting::BindWebSpeechRecognizer(
    ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionSession> session_receiver,
    ::mojo::PendingRemote<::media::mojom::blink::SpeechRecognitionSessionClient> session_client,
    ::mojo::PendingReceiver<::media::mojom::blink::SpeechRecognitionAudioForwarder> audio_forwarder, int32_t channel_count, int32_t sample_rate,
...
void SpeechRecognitionRecognizerClientInterceptorForTesting::OnSpeechRecognitionRecognitionEvent(
    SpeechRecognitionResultPtr result, OnSpeechRecognitionRecognitionEventCallback callback)
{
...
void SpeechRecognitionRecognizerClientAsyncWaiter::OnSpeechRecognitionRecognitionEvent(SpeechRecognitionResultPtr result, bool* out_continue_recognition)
{
    base::RunLoop loop;
...
bool SpeechRecognitionRecognizerClientAsyncWaiter::OnSpeechRecognitionRecognitionEvent(SpeechRecognitionResultPtr result)
{
    bool async_wait_result;
