// media/mojo/mojom/decryptor.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_BLINK_TEST_UTILS_H_
#define MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_BLINK_TEST_UTILS_H_
...
public:
    ...
    void Decrypt(Decryptor::StreamType stream_type, ::media::mojom::blink::DecoderBufferPtr encrypted, Decryptor::Status* out_status,
        ::media::mojom::blink::DecoderBufferPtr* out_buffer);

    void InitializeAudioDecoder(::media::mojom::blink::AudioDecoderConfigPtr config, bool* out_success);
    bool InitializeAudioDecoder(::media::mojom::blink::AudioDecoderConfigPtr config);
    void InitializeVideoDecoder(::media::mojom::blink::VideoDecoderConfigPtr config, bool* out_success);
    bool InitializeVideoDecoder(::media::mojom::blink::VideoDecoderConfigPtr config);
    void DecryptAndDecodeAudio(::media::mojom::blink::DecoderBufferPtr encrypted, Decryptor::Status* out_status,
        WTF::Vector<::media::mojom::blink::AudioBufferPtr>* out_audio_buffers);

    void DecryptAndDecodeVideo(::media::mojom::blink::DecoderBufferPtr encrypted, Decryptor::Status* out_status,
...
#endif // MEDIA_MOJO_MOJOM_DECRYPTOR_MOJOM_BLINK_TEST_UTILS_H_
