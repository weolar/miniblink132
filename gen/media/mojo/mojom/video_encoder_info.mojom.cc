...
#include "media/mojo/mojom/video_encoder_info.mojom-test-utils.h"
...
VideoEncoderInfo::VideoEncoderInfo(const std::string& implementation_name_in, bool has_frame_delay_in, int32_t frame_delay_in, bool has_input_capacity_in,
...
bool StructTraits<::media::mojom::ResolutionBitrateLimit::DataView, ::media::mojom::ResolutionBitrateLimitPtr>::Read(
    ::media::mojom::ResolutionBitrateLimit::DataView input, ::media::mojom::ResolutionBitrateLimitPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::VideoEncoderInfo::DataView, ::media::mojom::VideoEncoderInfoPtr>::Read(
    ::media::mojom::VideoEncoderInfo::DataView input, ::media::mojom::VideoEncoderInfoPtr* output)
{
    bool success = true;
