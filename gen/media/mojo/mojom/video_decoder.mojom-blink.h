...
class BLINK_PLATFORM_EXPORT VideoFrameHandleReleaser : public VideoFrameHandleReleaserInterfaceBase {
public:
...
class BLINK_PLATFORM_EXPORT VideoDecoder : public VideoDecoderInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual bool GetSupportedConfigs(
        WTF::Vector<SupportedVideoDecoderConfigPtr>* out_supported_configs, ::media::mojom::blink::VideoDecoderType* out_decoder_type);

    using GetSupportedConfigsCallback = base::OnceCallback<void(WTF::Vector<SupportedVideoDecoderConfigPtr>, ::media::mojom::blink::VideoDecoderType)>;

    virtual void GetSupportedConfigs(GetSupportedConfigsCallback callback) = 0;

    virtual void Construct(::mojo::PendingAssociatedRemote<VideoDecoderClient> client, ::mojo::PendingRemote<::media::mojom::blink::MediaLog> media_log,
...
class BLINK_PLATFORM_EXPORT VideoDecoderClient : public VideoDecoderClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_PLATFORM_EXPORT VideoFrameHandleReleaserProxy : public VideoFrameHandleReleaser {
//public:
...
//class BLINK_PLATFORM_EXPORT VideoDecoderProxy : public VideoDecoder {
//public:
//    using InterfaceType = VideoDecoder;
//
//    explicit VideoDecoderProxy(mojo::MessageReceiverWithResponder* receiver);
//
//    bool GetSupportedConfigs(
//        WTF::Vector<SupportedVideoDecoderConfigPtr>* out_supported_configs, ::media::mojom::blink::VideoDecoderType* out_decoder_type) final;
//
...
//class BLINK_PLATFORM_EXPORT VideoDecoderClientProxy : public VideoDecoderClient {
//public:
...
//        ::media::mojom::blink::VideoFramePtr frame, bool can_read_without_stalling, const std::optional<::base::UnguessableToken>& release_token) final;
//
    ...
    , require_encrypted()
{
    ...
    SupportedVideoDecoderConfig(::media::mojom::blink::VideoCodecProfile profile_min_in,
    ...
    , route_id()
{
    ...
    CommandBufferId(const ::base::UnguessableToken& channel_token_in, int32_t route_id_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<CommandBufferId::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::SupportedVideoDecoderConfig::DataView, ::media::mojom::blink::SupportedVideoDecoderConfigPtr> {
    static bool IsNull(const ::media::mojom::blink::SupportedVideoDecoderConfigPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::blink::SupportedVideoDecoderConfigPtr* output)
    {
        output->reset();
    }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::media::mojom::blink::CommandBufferId::DataView, ::media::mojom::blink::CommandBufferIdPtr> {
    static bool IsNull(const ::media::mojom::blink::CommandBufferIdPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::blink::CommandBufferIdPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::mojom::blink::CommandBufferId::channel_token)& channel_token(const ::media::mojom::blink::CommandBufferIdPtr& input)
    {
        return input->channel_token;
    }

    static decltype(::media::mojom::blink::CommandBufferId::route_id) route_id(const ::media::mojom::blink::CommandBufferIdPtr& input)
    {
