// media/midi/midi_service.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<PortInfo_Data>;

    PortInfo_Data();
    ~PortInfo_Data() = delete;
};
static_assert(sizeof(PortInfo_Data) == 48, "Bad sizeof(PortInfo_Data)");
// Used by PortInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct PortInfo_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    PortInfo_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<PortInfo_Data> fragment(message);
...
const mojo::internal::UnserializedMessageContext::Tag PortInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
