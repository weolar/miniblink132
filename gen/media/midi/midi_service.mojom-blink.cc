...
PortInfo::PortInfo(const WTF::String& id_in, const WTF::String& manufacturer_in, const WTF::String& name_in, const WTF::String& version_in, PortState state_in)
    : id(std::move(id_in))
...
void MidiSessionClientProxy::DataReceived(uint32_t in_port, const WTF::Vector<uint8_t>& in_data, ::base::TimeTicks in_timestamp)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MidiSessionProxy::SendData(uint32_t in_port, const WTF::Vector<uint8_t>& in_data, ::base::TimeTicks in_timestamp)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::midi::mojom::blink::PortInfo::DataView, ::midi::mojom::blink::PortInfoPtr>::Read(
    ::midi::mojom::blink::PortInfo::DataView input, ::midi::mojom::blink::PortInfoPtr* output)
{
    bool success = true;
