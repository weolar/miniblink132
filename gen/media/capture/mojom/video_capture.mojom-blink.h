...
//class BLINK_PLATFORM_EXPORT VideoCaptureObserverProxy : public VideoCaptureObserver {
//public:
...
//class BLINK_PLATFORM_EXPORT VideoCaptureHostProxy : public VideoCaptureHost {
//public:
...
template <> struct BLINK_PLATFORM_EXPORT UnionTraits<::media::mojom::blink::VideoCaptureResult::DataView, ::media::mojom::blink::VideoCaptureResultPtr> {
    static bool IsNull(const ::media::mojom::blink::VideoCaptureResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::blink::VideoCaptureResultPtr* output)
    {
        output->reset();
    }
