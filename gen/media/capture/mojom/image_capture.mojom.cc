// media/capture/mojom/image_capture.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
PhotoState::PhotoState(std::vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    std::vector<MeteringMode> supported_exposure_modes_in, MeteringMode current_exposure_mode_in, std::vector<MeteringMode> supported_focus_modes_in,
    MeteringMode current_focus_mode_in, std::vector<Point2DPtr> points_of_interest_in, RangePtr exposure_compensation_in, RangePtr exposure_time_in,
    ...
    RedEyeReduction red_eye_reduction_in, RangePtr height_in, RangePtr width_in, std::vector<FillLightMode> fill_light_mode_in)
...
PhotoState::PhotoState(std::vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    RangePtr focus_distance_in, RangePtr pan_in, RangePtr tilt_in, RangePtr zoom_in, bool supports_torch_in, bool torch_in,
    RedEyeReduction red_eye_reduction_in, RangePtr height_in, RangePtr width_in, std::vector<FillLightMode> fill_light_mode_in,
    std::optional<std::vector<BackgroundBlurMode>> supported_background_blur_modes_in, BackgroundBlurMode background_blur_mode_in)
    : supported_white_balance_modes(std::move(supported_white_balance_modes_in))
    , current_white_balance_mode(std::move(current_white_balance_mode_in))
    , supported_exposure_modes(std::move(supported_exposure_modes_in))
    , current_exposure_mode(std::move(current_exposure_mode_in))
...
PhotoState::PhotoState(std::vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    RedEyeReduction red_eye_reduction_in, RangePtr height_in, RangePtr width_in, std::vector<FillLightMode> fill_light_mode_in,
    std::optional<std::vector<BackgroundBlurMode>> supported_background_blur_modes_in, BackgroundBlurMode background_blur_mode_in,
    std::optional<std::vector<MeteringMode>> supported_face_framing_modes_in, MeteringMode current_face_framing_mode_in)
    : supported_white_balance_modes(std::move(supported_white_balance_modes_in))
    , current_white_balance_mode(std::move(current_white_balance_mode_in))
    , supported_exposure_modes(std::move(supported_exposure_modes_in))
    , current_exposure_mode(std::move(current_exposure_mode_in))
...
PhotoState::PhotoState(std::vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    std::optional<std::vector<BackgroundBlurMode>> supported_background_blur_modes_in, BackgroundBlurMode background_blur_mode_in,
    std::optional<std::vector<MeteringMode>> supported_face_framing_modes_in, MeteringMode current_face_framing_mode_in,
    std::optional<std::vector<EyeGazeCorrectionMode>> supported_eye_gaze_correction_modes_in, EyeGazeCorrectionMode current_eye_gaze_correction_mode_in)
    : supported_white_balance_modes(std::move(supported_white_balance_modes_in))
    , current_white_balance_mode(std::move(current_white_balance_mode_in))
    , supported_exposure_modes(std::move(supported_exposure_modes_in))
    , current_exposure_mode(std::move(current_exposure_mode_in))
...
PhotoState::PhotoState(std::vector<MeteringMode> supported_white_balance_modes_in, MeteringMode current_white_balance_mode_in,
    ...
    std::optional<std::vector<MeteringMode>> supported_face_framing_modes_in, MeteringMode current_face_framing_mode_in,
    std::optional<std::vector<EyeGazeCorrectionMode>> supported_eye_gaze_correction_modes_in, EyeGazeCorrectionMode current_eye_gaze_correction_mode_in,
    std::optional<std::vector<bool>> supported_background_segmentation_mask_states_in, bool current_background_segmentation_mask_state_in)
    : supported_white_balance_modes(std::move(supported_white_balance_modes_in))
    , current_white_balance_mode(std::move(current_white_balance_mode_in))
    , supported_exposure_modes(std::move(supported_exposure_modes_in))
    , current_exposure_mode(std::move(current_exposure_mode_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::vector<MeteringMode>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type std::vector<Point2DPtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::vector<FillLightMode>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::optional<std::vector<BackgroundBlurMode>>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::optional<std::vector<MeteringMode>>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::optional<std::vector<EyeGazeCorrectionMode>>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
PhotoSettings::PhotoSettings(bool has_white_balance_mode_in, MeteringMode white_balance_mode_in, bool has_exposure_mode_in, MeteringMode exposure_mode_in,
    bool has_focus_mode_in, MeteringMode focus_mode_in, std::vector<Point2DPtr> points_of_interest_in, bool has_exposure_compensation_in,
...
Blob::Blob(const std::string& mime_type_in, std::vector<uint8_t> data_in)
...
void ImageCaptureProxy::GetPhotoState(const std::string& in_source_id, GetPhotoStateCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ImageCaptureProxy::SetPhotoOptions(const std::string& in_source_id, PhotoSettingsPtr in_settings, SetPhotoOptionsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ImageCaptureProxy::TakePhoto(const std::string& in_source_id, TakePhotoCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::media::mojom::ImageCapture::Name_;
...
// static
bool StructTraits<::media::mojom::Range::DataView, ::media::mojom::RangePtr>::Read(::media::mojom::Range::DataView input, ::media::mojom::RangePtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::PhotoState::DataView, ::media::mojom::PhotoStatePtr>::Read(
    ::media::mojom::PhotoState::DataView input, ::media::mojom::PhotoStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::Point2D::DataView, ::media::mojom::Point2DPtr>::Read(
    ::media::mojom::Point2D::DataView input, ::media::mojom::Point2DPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::PhotoSettings::DataView, ::media::mojom::PhotoSettingsPtr>::Read(
    ::media::mojom::PhotoSettings::DataView input, ::media::mojom::PhotoSettingsPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::media::mojom::Blob::DataView, ::media::mojom::BlobPtr>::Read(::media::mojom::Blob::DataView input, ::media::mojom::BlobPtr* output)
{
    bool success = true;
...
void ImageCaptureInterceptorForTesting::SetPhotoOptions(const std::string& source_id, PhotoSettingsPtr settings, SetPhotoOptionsCallback callback)
{
...
void ImageCaptureAsyncWaiter::GetPhotoState(const std::string& source_id, PhotoStatePtr* out_state)
{
    base::RunLoop loop;
...
PhotoStatePtr ImageCaptureAsyncWaiter::GetPhotoState(const std::string& source_id)
{
...
void ImageCaptureAsyncWaiter::SetPhotoOptions(const std::string& source_id, PhotoSettingsPtr settings, bool* out_success)
{
    base::RunLoop loop;
...
bool ImageCaptureAsyncWaiter::SetPhotoOptions(const std::string& source_id, PhotoSettingsPtr settings)
{
...
void ImageCaptureAsyncWaiter::TakePhoto(const std::string& source_id, BlobPtr* out_blob)
{
    base::RunLoop loop;
...
BlobPtr ImageCaptureAsyncWaiter::TakePhoto(const std::string& source_id)
{
