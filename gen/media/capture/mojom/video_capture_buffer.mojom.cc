...
bool StructTraits<::media::mojom::VideoFrameInfo::DataView, ::media::mojom::VideoFrameInfoPtr>::Read(
    ::media::mojom::VideoFrameInfo::DataView input, ::media::mojom::VideoFrameInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::ReadyBuffer::DataView, ::media::mojom::ReadyBufferPtr>::Read(
    ::media::mojom::ReadyBuffer::DataView input, ::media::mojom::ReadyBufferPtr* output)
{
    bool success = true;
...
bool StructTraits<::media::mojom::SharedImageBufferHandleSet::DataView, ::media::mojom::SharedImageBufferHandleSetPtr>::Read(
    ::media::mojom::SharedImageBufferHandleSet::DataView input, ::media::mojom::SharedImageBufferHandleSetPtr* output)
{
    bool success = true;
...
bool UnionTraits<::media::mojom::VideoBufferHandle::DataView, ::media::mojom::VideoBufferHandlePtr>::Read(
    ::media::mojom::VideoBufferHandle::DataView input, ::media::mojom::VideoBufferHandlePtr* output)
{
