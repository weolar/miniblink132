    ...
    , zoom()
{
    ...
    {
        return mojo::internal::SerializeImpl<VideoCaptureControlSupport::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , pixel_format()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VideoCaptureFormat::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , is_high_dpi_enabled()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VideoCaptureParams::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , has_frame_id(false)
{
    ...
    VideoCaptureFeedback(double resource_utilization, float max_framerate_fps, int32_t max_pixels, bool require_mapped_frame,
        std::optional<std::vector<::gfx::Size>> DEPRECATED_mapped_sizes, int32_t frame_id, bool has_frame_id);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VideoCaptureFeedback::DataView, std::vector<uint8_t>>(input);
    }
    ...
    : stride_by_plane()
{
    ...
    explicit PlaneStrides(std::vector<uint32_t> stride_by_plane_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PlaneStrides::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , availability()
{
    ...
    VideoCaptureDeviceDescriptor(const std::string& display_name_in, const std::string& device_id_in, const std::string& model_id_in,
    ...
    VideoCaptureDeviceDescriptor(const std::string& display_name, const std::string& device_id, const std::string& model_id,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VideoCaptureDeviceDescriptor::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , supported_formats()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VideoCaptureDeviceInfo::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::media::mojom::VideoCaptureControlSupport::DataView, ::media::mojom::VideoCaptureControlSupportPtr> {
    static bool IsNull(const ::media::mojom::VideoCaptureControlSupportPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::VideoCaptureControlSupportPtr* output)
    {
        output->reset();
    }

    static decltype(::media::mojom::VideoCaptureControlSupport::pan) pan(const ::media::mojom::VideoCaptureControlSupportPtr& input)
    {
        return input->pan;
    }

    static decltype(::media::mojom::VideoCaptureControlSupport::tilt) tilt(const ::media::mojom::VideoCaptureControlSupportPtr& input)
    {
        return input->tilt;
    }

    static decltype(::media::mojom::VideoCaptureControlSupport::zoom) zoom(const ::media::mojom::VideoCaptureControlSupportPtr& input)
    {
        return input->zoom;
    }
...
template <> struct StructTraits<::media::mojom::VideoCaptureFormat::DataView, ::media::mojom::VideoCaptureFormatPtr> {
    static bool IsNull(const ::media::mojom::VideoCaptureFormatPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::VideoCaptureFormatPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::mojom::VideoCaptureFormat::frame_size)& frame_size(const ::media::mojom::VideoCaptureFormatPtr& input)
    {
        return input->frame_size;
    }

    static decltype(::media::mojom::VideoCaptureFormat::frame_rate) frame_rate(const ::media::mojom::VideoCaptureFormatPtr& input)
    {
        return input->frame_rate;
    }

    static decltype(::media::mojom::VideoCaptureFormat::pixel_format) pixel_format(const ::media::mojom::VideoCaptureFormatPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::VideoCaptureParams::DataView, ::media::mojom::VideoCaptureParamsPtr> {
    static bool IsNull(const ::media::mojom::VideoCaptureParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::VideoCaptureParamsPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::mojom::VideoCaptureParams::requested_format)& requested_format(const ::media::mojom::VideoCaptureParamsPtr& input)
    {
        return input->requested_format;
    }

    static decltype(::media::mojom::VideoCaptureParams::buffer_type) buffer_type(const ::media::mojom::VideoCaptureParamsPtr& input)
    {
        return input->buffer_type;
    }

    static decltype(::media::mojom::VideoCaptureParams::resolution_change_policy) resolution_change_policy(const ::media::mojom::VideoCaptureParamsPtr& input)
    {
        return input->resolution_change_policy;
    }

    static decltype(::media::mojom::VideoCaptureParams::power_line_frequency) power_line_frequency(const ::media::mojom::VideoCaptureParamsPtr& input)
    {
        return input->power_line_frequency;
    }

    static decltype(::media::mojom::VideoCaptureParams::enable_face_detection) enable_face_detection(const ::media::mojom::VideoCaptureParamsPtr& input)
    {
        return input->enable_face_detection;
    }

    static decltype(::media::mojom::VideoCaptureParams::is_high_dpi_enabled) is_high_dpi_enabled(const ::media::mojom::VideoCaptureParamsPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::VideoCaptureFeedback::DataView, ::media::mojom::VideoCaptureFeedbackPtr> {
    static bool IsNull(const ::media::mojom::VideoCaptureFeedbackPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::VideoCaptureFeedbackPtr* output)
    {
        output->reset();
    }

    static decltype(::media::mojom::VideoCaptureFeedback::resource_utilization) resource_utilization(const ::media::mojom::VideoCaptureFeedbackPtr& input)
    {
        return input->resource_utilization;
    }

    static decltype(::media::mojom::VideoCaptureFeedback::max_framerate_fps) max_framerate_fps(const ::media::mojom::VideoCaptureFeedbackPtr& input)
    {
        return input->max_framerate_fps;
    }

    static decltype(::media::mojom::VideoCaptureFeedback::max_pixels) max_pixels(const ::media::mojom::VideoCaptureFeedbackPtr& input)
    {
        return input->max_pixels;
    }

    static decltype(::media::mojom::VideoCaptureFeedback::require_mapped_frame) require_mapped_frame(const ::media::mojom::VideoCaptureFeedbackPtr& input)
    {
    ...
    static decltype(::media::mojom::VideoCaptureFeedback::frame_id) frame_id(const ::media::mojom::VideoCaptureFeedbackPtr& input)
    {
        return input->frame_id;
    }

    static decltype(::media::mojom::VideoCaptureFeedback::has_frame_id) has_frame_id(const ::media::mojom::VideoCaptureFeedbackPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::PlaneStrides::DataView, ::media::mojom::PlaneStridesPtr> {
    static bool IsNull(const ::media::mojom::PlaneStridesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::PlaneStridesPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::mojom::PlaneStrides::stride_by_plane)& stride_by_plane(const ::media::mojom::PlaneStridesPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::VideoCaptureDeviceDescriptor::DataView, ::media::mojom::VideoCaptureDeviceDescriptorPtr> {
    static bool IsNull(const ::media::mojom::VideoCaptureDeviceDescriptorPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::VideoCaptureDeviceDescriptorPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::media::mojom::VideoCaptureDeviceDescriptor::device_id)& device_id(const ::media::mojom::VideoCaptureDeviceDescriptorPtr& input)
    {
        return input->device_id;
    }

    static const decltype(::media::mojom::VideoCaptureDeviceDescriptor::model_id)& model_id(const ::media::mojom::VideoCaptureDeviceDescriptorPtr& input)
    {
        return input->model_id;
    }

    static decltype(::media::mojom::VideoCaptureDeviceDescriptor::facing_mode) facing_mode(const ::media::mojom::VideoCaptureDeviceDescriptorPtr& input)
    {
        return input->facing_mode;
    }

    static decltype(::media::mojom::VideoCaptureDeviceDescriptor::capture_api) capture_api(const ::media::mojom::VideoCaptureDeviceDescriptorPtr& input)
    {
    ...
    static decltype(::media::mojom::VideoCaptureDeviceDescriptor::transport_type) transport_type(const ::media::mojom::VideoCaptureDeviceDescriptorPtr& input)
    {
        return input->transport_type;
    }

    static decltype(::media::mojom::VideoCaptureDeviceDescriptor::availability) availability(const ::media::mojom::VideoCaptureDeviceDescriptorPtr& input)
    {
...
template <> struct StructTraits<::media::mojom::VideoCaptureDeviceInfo::DataView, ::media::mojom::VideoCaptureDeviceInfoPtr> {
    static bool IsNull(const ::media::mojom::VideoCaptureDeviceInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::media::mojom::VideoCaptureDeviceInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::media::mojom::VideoCaptureDeviceInfo::descriptor)& descriptor(const ::media::mojom::VideoCaptureDeviceInfoPtr& input)
    {
        return input->descriptor;
    }

    static const decltype(::media::mojom::VideoCaptureDeviceInfo::supported_formats)& supported_formats(const ::media::mojom::VideoCaptureDeviceInfoPtr& input)
    {
