// media/learning/mojo/public/mojom/learning_task_controller.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MEDIA_LEARNING_MOJO_PUBLIC_MOJOM_LEARNING_TASK_CONTROLLER_MOJOM_TEST_UTILS_H_
#define MEDIA_LEARNING_MOJO_PUBLIC_MOJOM_LEARNING_TASK_CONTROLLER_MOJOM_TEST_UTILS_H_
...
class LearningTaskControllerInterceptorForTesting : public LearningTaskController {
    ...
    void BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features,
        const std::optional<::media::learning::TargetValue>& default_target) override;
...
public:
    ...
    void PredictDistribution(const std::vector<::media::learning::FeatureValue>& features, std::optional<::media::learning::TargetHistogram>* out_predicted);
...
#endif // MEDIA_LEARNING_MOJO_PUBLIC_MOJOM_LEARNING_TASK_CONTROLLER_MOJOM_TEST_UTILS_H_
