...
#include "media/learning/mojo/public/mojom/learning_task_controller.mojom-forward.h" // IWYU pragma: export
...
class LearningTaskController : public LearningTaskControllerInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features,
...
class LearningTaskControllerProxy : public LearningTaskController {
public:
    ...
    void BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features,
