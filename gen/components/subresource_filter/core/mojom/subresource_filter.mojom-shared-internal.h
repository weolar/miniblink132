...
static_assert(sizeof(ActivationState_Data) == 16, "Bad sizeof(ActivationState_Data)");
// Used by ActivationState::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct ActivationState_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    ActivationState_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag ActivationState_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class DocumentLoadStatistics_Data {
public:
    static bool Validate(const void* data, mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(DocumentLoadStatistics_Data) == 40, "Bad sizeof(DocumentLoadStatistics_Data)");
// Used by DocumentLoadStatistics::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct DocumentLoadStatistics_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    DocumentLoadStatistics_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag DocumentLoadStatistics_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
