...
struct IndexedRuleset FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE { VT_BLOCKLIST_INDEX = 4, VT_ALLOWLIST_INDEX = 6, VT_DEACTIVATION_INDEX = 8 };
    ...
    {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_BLOCKLIST_INDEX) && verifier.VerifyTable(blocklist_index())
            && VerifyOffset(verifier, VT_ALLOWLIST_INDEX) && verifier.VerifyTable(allowlist_index()) && VerifyOffset(verifier, VT_DEACTIVATION_INDEX)
            && verifier.VerifyTable(deactivation_index()) && verifier.EndTable();
    }
};
...
inline bool VerifyIndexedRulesetBuffer(::flatbuffers::Verifier& verifier)
{
    return verifier.VerifyBuffer<subresource_filter::flat::IndexedRuleset>(nullptr);
}

inline bool VerifySizePrefixedIndexedRulesetBuffer(::flatbuffers::Verifier& verifier)
{
    return verifier.VerifySizePrefixedBuffer<subresource_filter::flat::IndexedRuleset>(nullptr);
}

inline void FinishIndexedRulesetBuffer(::flatbuffers::FlatBufferBuilder& fbb, ::flatbuffers::Offset<subresource_filter::flat::IndexedRuleset> root)
{
    fbb.Finish(root);
}

inline void FinishSizePrefixedIndexedRulesetBuffer(::flatbuffers::FlatBufferBuilder& fbb, ::flatbuffers::Offset<subresource_filter::flat::IndexedRuleset> root)
{
