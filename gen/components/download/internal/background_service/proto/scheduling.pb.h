...
template <typename T> inline const std::string& SchedulingParams_NetworkRequirements_Name(T enum_t_value)
{
    static_assert(::std::is_same<T, SchedulingParams_NetworkRequirements>::value || ::std::is_integral<T>::value,
...
template <typename T> inline const std::string& SchedulingParams_BatteryRequirements_Name(T enum_t_value)
{
    static_assert(::std::is_same<T, SchedulingParams_BatteryRequirements>::value || ::std::is_integral<T>::value,
...
template <typename T> inline const std::string& SchedulingParams_Priority_Name(T enum_t_value)
{
    static_assert(::std::is_same<T, SchedulingParams_Priority>::value || ::std::is_integral<T>::value,
...
class SchedulingParams final : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:protodb.SchedulingParams) */ {
public:
    inline SchedulingParams()
        : SchedulingParams(nullptr)
    {
    }
    ...
    {
        return reinterpret_cast<const SchedulingParams*>(&_SchedulingParams_default_instance_);
    }
...
protected:
    explicit SchedulingParams(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned = false);
...
public:
    ...
    template <typename T> static inline const std::string& NetworkRequirements_Name(T enum_t_value)
    {
        static_assert(
            ::std::is_same<T, NetworkRequirements>::value || ::std::is_integral<T>::value, "Incorrect type passed to function NetworkRequirements_Name.");
        return SchedulingParams_NetworkRequirements_Name(enum_t_value);
    }
    static inline bool NetworkRequirements_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name, NetworkRequirements* value)
    {
    ...
    template <typename T> static inline const std::string& BatteryRequirements_Name(T enum_t_value)
    {
        static_assert(
            ::std::is_same<T, BatteryRequirements>::value || ::std::is_integral<T>::value, "Incorrect type passed to function BatteryRequirements_Name.");
        return SchedulingParams_BatteryRequirements_Name(enum_t_value);
    }
    static inline bool BatteryRequirements_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name, BatteryRequirements* value)
    {
    ...
    template <typename T> static inline const std::string& Priority_Name(T enum_t_value)
    {
    ...
    static inline bool Priority_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Priority* value)
    {
