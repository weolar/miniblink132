...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> DownloadSource_strings[13] = {};

static const char DownloadSource_names[] = "CONTEXT_MENU"
                                           "DRAG_AND_DROP"
                                           "EXTENSION_API"
                                           "EXTENSION_INSTALLER"
                                           "FROM_RENDERER"
...
const std::string& DownloadSource_Name(DownloadSource value)
{
    static const bool dummy
        = ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(DownloadSource_entries, DownloadSource_entries_by_number, 13, DownloadSource_strings);
    (void)dummy;
    int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(DownloadSource_entries, DownloadSource_entries_by_number, 13, value);
    return idx == -1 ? ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyString() : DownloadSource_strings[idx].get();
}
bool DownloadSource_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DownloadSource* value)
{
    int int_value;
    bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(DownloadSource_entries, 13, name, &int_value);
    if (success) {
