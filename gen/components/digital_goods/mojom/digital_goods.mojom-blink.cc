...
ItemDetails::ItemDetails(const WTF::String& item_id_in, const WTF::String& title_in, const WTF::String& description_in,
...
ItemDetails::ItemDetails(const WTF::String& item_id_in, const WTF::String& title_in, const WTF::String& description_in,
    ::payments::mojom::blink::PaymentCurrencyAmountPtr price_in, const WTF::String& subscription_period_in, const WTF::String& free_trial_period_in,
    ::payments::mojom::blink::PaymentCurrencyAmountPtr introductory_price_in, const WTF::String& introductory_price_period_in,
    uint32_t introductory_price_cycles_in, ItemType type_in, std::optional<WTF::Vector<::blink::KURL>> icon_urls_in)
    : item_id(std::move(item_id_in))
    , title(std::move(title_in))
    , description(std::move(description_in))
    , price(std::move(price_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const std::optional<WTF::Vector<::blink::KURL>>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
PurchaseReference::PurchaseReference(const WTF::String& item_id_in, const WTF::String& purchase_token_in)
    : item_id(std::move(item_id_in))
...
bool StructTraits<::payments::mojom::blink::ItemDetails::DataView, ::payments::mojom::blink::ItemDetailsPtr>::Read(
    ::payments::mojom::blink::ItemDetails::DataView input, ::payments::mojom::blink::ItemDetailsPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PurchaseReference::DataView, ::payments::mojom::blink::PurchaseReferencePtr>::Read(
    ::payments::mojom::blink::PurchaseReference::DataView input, ::payments::mojom::blink::PurchaseReferencePtr* output)
{
    bool success = true;
