...
static_assert(sizeof(MediaImage_Data) == 24, "Bad sizeof(MediaImage_Data)");
...
static_assert(sizeof(MediaStatus_Data) == 64, "Bad sizeof(MediaStatus_Data)");
// Used by MediaStatus::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct MediaStatus_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    MediaStatus_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag MediaStatus_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
