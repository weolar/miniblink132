...
// with not having this data in traces there.
    ...
    using VerifyIpProtectionCoreHostForTestingCallback
        = base::OnceCallback<void(const std::optional<::ip_protection::BlindSignedAuthToken>&, std::optional<::base::Time>)>;
...
// with not having this data in traces there.
    ...
    using TryGetAuthTokensCallback
        = base::OnceCallback<void(const std::optional<std::vector<::ip_protection::BlindSignedAuthToken>>&, std::optional<::base::Time>)>;

    virtual void TryGetAuthTokens(uint32_t batch_size, ::ip_protection::mojom::ProxyLayer proxy_layer, TryGetAuthTokensCallback callback) = 0;

    using GetProxyConfigCallback
        = base::OnceCallback<void(const std::optional<std::vector<::net::ProxyChain>>&, const std::optional<::ip_protection::GeoHint>&)>;
...
public:
    ...
    void TryGetAuthTokens(uint32_t batch_size, ::ip_protection::mojom::ProxyLayer proxy_layer, TryGetAuthTokensCallback callback) final;
