...
ProductSpecificationsSet::ProductSpecificationsSet(const std::string& name_in, const ::base::Uuid& uuid_in, std::vector<::GURL> urls_in)
...
bool StructTraits<::commerce::shared::mojom::ProductSpecificationsSet::DataView, ::commerce::shared::mojom::ProductSpecificationsSetPtr>::Read(
    ::commerce::shared::mojom::ProductSpecificationsSet::DataView input, ::commerce::shared::mojom::ProductSpecificationsSetPtr* output)
{
    bool success = true;
