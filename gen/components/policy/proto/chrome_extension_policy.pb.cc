...
PROTOBUF_CONSTEXPR ExternalPolicyData::ExternalPolicyData(::_pbi::ConstantInitialized)
...
ExternalPolicyData::ExternalPolicyData(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    ...
    : ::PROTOBUF_NAMESPACE_ID::MessageLite()
{
    ...
    (void)_this;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.download_url_) {},
...
inline void ExternalPolicyData::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_)
        Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.download_url_) {}, decltype(_impl_.secure_hash_) {} };
    _impl_.download_url_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.download_url_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
uint8_t* ExternalPolicyData::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    // optional string download_url = 1;
    if (cached_has_bits & 0x00000001u) {
        target = stream->WriteStringMaybeAliased(1, this->_internal_download_url(), target);
    }

    // optional bytes secure_hash = 2;
    if (cached_has_bits & 0x00000002u) {
        target = stream->WriteBytesMaybeAliased(2, this->_internal_secure_hash(), target);
    }
...
size_t ExternalPolicyData::ByteSizeLong() const
{
    ...
    if (cached_has_bits & 0x00000003u) {
        ...
        // optional bytes secure_hash = 2;
        if (cached_has_bits & 0x00000002u) {
            total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(this->_internal_secure_hash());
        }
    }
    if (PROTOBUF_PREDICT_FALSE(_internal_metadata_.have_unknown_fields())) {
...
void ExternalPolicyData::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const ExternalPolicyData*>(&from));
}
...
void ExternalPolicyData::InternalSwap(ExternalPolicyData* other)
{
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&_impl_.download_url_, lhs_arena, &other->_impl_.download_url_, rhs_arena);
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(&_impl_.secure_hash_, lhs_arena, &other->_impl_.secure_hash_, rhs_arena);
}
