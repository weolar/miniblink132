...
public:
    ...
    public:
        enum { NoFieldsSet = 0, SelectorsSet = 1 << 1, AllFieldsSet = (SelectorsSet | 0) };
...
public:
    ...
    public:
        enum { NoFieldsSet = 0, SelectorListSet = 1 << 1, StyleSet = 1 << 2, AllFieldsSet = (SelectorListSet | StyleSet | 0) };
...
public:
    ...
    virtual DispatchResponse setStyleTexts(
        std::unique_ptr<protocol::Array<protocol::CSS::StyleDeclarationEdit>> in_edits, std::unique_ptr<protocol::Array<protocol::CSS::CSSStyle>>* out_styles)
        = 0;
};
