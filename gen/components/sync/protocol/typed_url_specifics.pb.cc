...
namespace sync_pb {
PROTOBUF_CONSTEXPR TypedUrlSpecifics::TypedUrlSpecifics(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {}, /*decltype(_impl_.visits_)*/ {},
        /*decltype(_impl_._visits_cached_byte_size_)*/ { 0 }, /*decltype(_impl_.visit_transitions_)*/ {},
        /*decltype(_impl_._visit_transitions_cached_byte_size_)*/ { 0 },
        /*decltype(_impl_.url_)*/ { &::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized {} },
        /*decltype(_impl_.title_)*/ { &::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized {} }, /*decltype(_impl_.hidden_)*/ false }
{
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TypedUrlSpecificsDefaultTypeInternal _TypedUrlSpecifics_default_instance_;
} // namespace sync_pb
namespace sync_pb {
...
public:
    using HasBits = decltype(std::declval<TypedUrlSpecifics>()._impl_._has_bits_);
...
TypedUrlSpecifics::TypedUrlSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
...
{
    TypedUrlSpecifics* const _this = this;
    (void)_this;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {},
        decltype(_impl_.visits_) { from._impl_.visits_ }, /*decltype(_impl_._visits_cached_byte_size_)*/ { 0 },
        decltype(_impl_.visit_transitions_) { from._impl_.visit_transitions_ }, /*decltype(_impl_._visit_transitions_cached_byte_size_)*/ { 0 },
        decltype(_impl_.url_) {}, decltype(_impl_.title_) {}, decltype(_impl_.hidden_) {} };
...
inline void TypedUrlSpecifics::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.visits_) { arena },
        /*decltype(_impl_._visits_cached_byte_size_)*/ { 0 }, decltype(_impl_.visit_transitions_) { arena },
        /*decltype(_impl_._visit_transitions_cached_byte_size_)*/ { 0 }, decltype(_impl_.url_) {}, decltype(_impl_.title_) {},
...
inline void TypedUrlSpecifics::SharedDtor()
{
    ...
    _impl_.visits_.~RepeatedField();
    _impl_.visit_transitions_.~RepeatedField();
    _impl_.url_.Destroy();
...
uint8_t* TypedUrlSpecifics::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    // repeated int64 visits = 7 [packed = true];
    {
        int byte_size = _impl_._visits_cached_byte_size_.load(std::memory_order_relaxed);
        if (byte_size > 0) {
            target = stream->WriteInt64Packed(7, _internal_visits(), byte_size, target);
        }
    }

    // repeated int32 visit_transitions = 8 [packed = true];
    {
        int byte_size = _impl_._visit_transitions_cached_byte_size_.load(std::memory_order_relaxed);
        if (byte_size > 0) {
            target = stream->WriteInt32Packed(8, _internal_visit_transitions(), byte_size, target);
        }
    }
...
size_t TypedUrlSpecifics::ByteSizeLong() const
{
    ...
    // repeated int64 visits = 7 [packed = true];
    {
        size_t data_size = ::_pbi::WireFormatLite::Int64Size(this->_impl_.visits_);
        if (data_size > 0) {
            total_size += 1 + ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
        }
        int cached_size = ::_pbi::ToCachedSize(data_size);
        _impl_._visits_cached_byte_size_.store(cached_size, std::memory_order_relaxed);
        total_size += data_size;
    }

    // repeated int32 visit_transitions = 8 [packed = true];
    {
        size_t data_size = ::_pbi::WireFormatLite::Int32Size(this->_impl_.visit_transitions_);
        if (data_size > 0) {
            total_size += 1 + ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
        }
        int cached_size = ::_pbi::ToCachedSize(data_size);
        _impl_._visit_transitions_cached_byte_size_.store(cached_size, std::memory_order_relaxed);
        total_size += data_size;
    }
...
void TypedUrlSpecifics::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const TypedUrlSpecifics*>(&from));
}
...
void TypedUrlSpecifics::MergeFrom(const TypedUrlSpecifics& from)
{
    ...
    _this->_impl_.visit_transitions_.MergeFrom(from._impl_.visit_transitions_);
...
void TypedUrlSpecifics::InternalSwap(TypedUrlSpecifics* other)
{
    ...
    _impl_.visit_transitions_.InternalSwap(&other->_impl_.visit_transitions_);
