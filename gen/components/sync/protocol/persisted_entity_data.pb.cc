...
namespace sync_pb {
PROTOBUF_CONSTEXPR PersistedEntityData::PersistedEntityData(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {},
        /*decltype(_impl_.name_)*/ { &::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized {} }, /*decltype(_impl_.specifics_)*/ nullptr }
{
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PersistedEntityDataDefaultTypeInternal
...
public:
    using HasBits = decltype(std::declval<PersistedEntityData>()._impl_._has_bits_);
...
const ::sync_pb::EntitySpecifics& PersistedEntityData::_Internal::specifics(const PersistedEntityData* msg)
{
...
PersistedEntityData::PersistedEntityData(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
...
inline void PersistedEntityData::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_)
        Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.name_) {}, decltype(_impl_.specifics_) { nullptr } };
    _impl_.name_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.name_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
uint8_t* PersistedEntityData::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void PersistedEntityData::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const PersistedEntityData*>(&from));
}
