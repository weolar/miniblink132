...
namespace sync_pb {
PROTOBUF_CONSTEXPR SyncInvalidationsPayload_DataTypeInvalidation::SyncInvalidationsPayload_DataTypeInvalidation(::_pbi::ConstantInitialized)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SyncInvalidationsPayload_DataTypeInvalidationDefaultTypeInternal
    _SyncInvalidationsPayload_DataTypeInvalidation_default_instance_;
PROTOBUF_CONSTEXPR SyncInvalidationsPayload::SyncInvalidationsPayload(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {}, /*decltype(_impl_.data_type_invalidations_)*/ {},
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SyncInvalidationsPayloadDefaultTypeInternal
...
public:
    using HasBits = decltype(std::declval<SyncInvalidationsPayload_DataTypeInvalidation>()._impl_._has_bits_);
...
SyncInvalidationsPayload_DataTypeInvalidation::SyncInvalidationsPayload_DataTypeInvalidation(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
...
{
    SyncInvalidationsPayload_DataTypeInvalidation* const _this = this;
    (void)_this;
...
inline void SyncInvalidationsPayload_DataTypeInvalidation::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
...
uint8_t* SyncInvalidationsPayload_DataTypeInvalidation::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void SyncInvalidationsPayload_DataTypeInvalidation::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const SyncInvalidationsPayload_DataTypeInvalidation*>(&from));
}
...
void SyncInvalidationsPayload_DataTypeInvalidation::MergeFrom(const SyncInvalidationsPayload_DataTypeInvalidation& from)
{
    ...
    if (from._internal_has_data_type_id()) {
        _this->_internal_set_data_type_id(from._internal_data_type_id());
    }
...
void SyncInvalidationsPayload_DataTypeInvalidation::InternalSwap(SyncInvalidationsPayload_DataTypeInvalidation* other)
{
    ...
    swap(_impl_.data_type_id_, other->_impl_.data_type_id_);
}
...
public:
    using HasBits = decltype(std::declval<SyncInvalidationsPayload>()._impl_._has_bits_);
...
SyncInvalidationsPayload::SyncInvalidationsPayload(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned)
{
    SharedCtor(arena, is_message_owned);
...
SyncInvalidationsPayload::SyncInvalidationsPayload(const SyncInvalidationsPayload& from)
    : ::PROTOBUF_NAMESPACE_ID::MessageLite()
{
    SyncInvalidationsPayload* const _this = this;
    (void)_this;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {},
        decltype(_impl_.data_type_invalidations_) { from._impl_.data_type_invalidations_ }, decltype(_impl_.hint_) {}, decltype(_impl_.version_) {} };
...
inline void SyncInvalidationsPayload::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.data_type_invalidations_) { arena },
        decltype(_impl_.hint_) {}, decltype(_impl_.version_) { int64_t { 0 } } };
    _impl_.hint_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.hint_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
{
    GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
    _impl_.data_type_invalidations_.~RepeatedPtrField();
...
uint8_t* SyncInvalidationsPayload::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
    ...
    // repeated .sync_pb.SyncInvalidationsPayload.DataTypeInvalidation data_type_invalidations = 1;
    for (unsigned i = 0, n = static_cast<unsigned>(this->_internal_data_type_invalidations_size()); i < n; i++) {
    ...
    // optional bytes hint = 2;
    if (cached_has_bits & 0x00000001u) {
        target = stream->WriteBytesMaybeAliased(2, this->_internal_hint(), target);
    }
...
size_t SyncInvalidationsPayload::ByteSizeLong() const
{
    ...
    for (const auto& msg : this->_impl_.data_type_invalidations_) {
...
void SyncInvalidationsPayload::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const SyncInvalidationsPayload*>(&from));
}
...
void SyncInvalidationsPayload::MergeFrom(const SyncInvalidationsPayload& from)
{
    ...
    _this->_impl_.data_type_invalidations_.MergeFrom(from._impl_.data_type_invalidations_);
...
void SyncInvalidationsPayload::InternalSwap(SyncInvalidationsPayload* other)
{
    ...
    _internal_metadata_.InternalSwap(&other->_internal_metadata_);
    swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
    _impl_.data_type_invalidations_.InternalSwap(&other->_impl_.data_type_invalidations_);
...
template <>
PROTOBUF_NOINLINE ::sync_pb::SyncInvalidationsPayload_DataTypeInvalidation* Arena::CreateMaybeMessage<::sync_pb::SyncInvalidationsPayload_DataTypeInvalidation>(
    Arena* arena)
{
