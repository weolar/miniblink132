...
namespace sync_pb {
PROTOBUF_CONSTEXPR ExtensionSettingSpecifics::ExtensionSettingSpecifics(::_pbi::ConstantInitialized)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ExtensionSettingSpecificsDefaultTypeInternal
...
public:
    using HasBits = decltype(std::declval<ExtensionSettingSpecifics>()._impl_._has_bits_);
...
ExtensionSettingSpecifics::ExtensionSettingSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
...
{
    ExtensionSettingSpecifics* const _this = this;
    (void)_this;
...
inline void ExtensionSettingSpecifics::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.extension_id_) {}, decltype(_impl_.key_) {},
...
uint8_t* ExtensionSettingSpecifics::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void ExtensionSettingSpecifics::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const ExtensionSettingSpecifics*>(&from));
}
