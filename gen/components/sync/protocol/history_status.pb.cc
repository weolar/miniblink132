...
namespace sync_pb {
PROTOBUF_CONSTEXPR HistoryStatusRequest::HistoryStatusRequest(::_pbi::ConstantInitialized)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 HistoryStatusRequestDefaultTypeInternal
    _HistoryStatusRequest_default_instance_;
PROTOBUF_CONSTEXPR HistoryStatusResponse::HistoryStatusResponse(::_pbi::ConstantInitialized)
    : _impl_ { /*decltype(_impl_._has_bits_)*/ {}, /*decltype(_impl_._cached_size_)*/ {}, /*decltype(_impl_.has_derived_data_)*/ false,
        /*decltype(_impl_.min_poll_interval_seconds_)*/ 3600 }
{
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 HistoryStatusResponseDefaultTypeInternal
...
HistoryStatusRequest::HistoryStatusRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
...
{
    HistoryStatusRequest* const _this = this;
    (void)_this;
...
inline void HistoryStatusRequest::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
...
uint8_t* HistoryStatusRequest::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void HistoryStatusRequest::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const HistoryStatusRequest*>(&from));
}
...
public:
    using HasBits = decltype(std::declval<HistoryStatusResponse>()._impl_._has_bits_);
...
HistoryStatusResponse::HistoryStatusResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena, bool is_message_owned)
    : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned)
{
    SharedCtor(arena, is_message_owned);
...
HistoryStatusResponse::HistoryStatusResponse(const HistoryStatusResponse& from)
    : ::PROTOBUF_NAMESPACE_ID::MessageLite()
{
    HistoryStatusResponse* const _this = this;
    (void)_this;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) { from._impl_._has_bits_ }, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.has_derived_data_) {},
        decltype(_impl_.min_poll_interval_seconds_) {} };

    _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
    ::memcpy(&_impl_.has_derived_data_, &from._impl_.has_derived_data_,
        static_cast<size_t>(reinterpret_cast<char*>(&_impl_.min_poll_interval_seconds_) - reinterpret_cast<char*>(&_impl_.has_derived_data_))
            + sizeof(_impl_.min_poll_interval_seconds_));
    // @@protoc_insertion_point(copy_constructor:sync_pb.HistoryStatusResponse)
}

inline void HistoryStatusResponse::SharedCtor(::_pb::Arena* arena, bool is_message_owned)
{
    (void)arena;
    (void)is_message_owned;
    new (&_impl_) Impl_ { decltype(_impl_._has_bits_) {}, /*decltype(_impl_._cached_size_)*/ {}, decltype(_impl_.has_derived_data_) { false },
        decltype(_impl_.min_poll_interval_seconds_) { 3600 } };
}
    ...
    while (!ctx->Done(&ptr)) {
        ...
        case 1:
            if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
                ...
                _impl_.min_poll_interval_seconds_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
                CHK_(ptr);
            } else
                goto handle_unusual;
            continue;
        ...
        case 2:
            if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
                ...
                _impl_.has_derived_data_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
                CHK_(ptr);
            } else
                goto handle_unusual;
            continue;
...
uint8_t* HistoryStatusResponse::_InternalSerialize(uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const
{
...
void HistoryStatusResponse::CheckTypeAndMergeFrom(const ::PROTOBUF_NAMESPACE_ID::MessageLite& from)
{
    MergeFrom(*::_pbi::DownCast<const HistoryStatusResponse*>(&from));
}
...
void HistoryStatusResponse::MergeFrom(const HistoryStatusResponse& from)
{
    ...
    if (cached_has_bits & 0x00000003u) {
        if (cached_has_bits & 0x00000001u) {
            _this->_impl_.has_derived_data_ = from._impl_.has_derived_data_;
        }
        if (cached_has_bits & 0x00000002u) {
            _this->_impl_.min_poll_interval_seconds_ = from._impl_.min_poll_interval_seconds_;
        }
...
void HistoryStatusResponse::InternalSwap(HistoryStatusResponse* other)
{
    ...
    swap(_impl_.has_derived_data_, other->_impl_.has_derived_data_);
    swap(_impl_.min_poll_interval_seconds_, other->_impl_.min_poll_interval_seconds_);
}
