    ...
    , key()
{
    ...
    Key(::os_crypt_async::mojom::blink::Algorithm algorithm_in, ::base::UnsafeSharedMemoryRegion key_in)
    ...
    , key_entries()
{
    ...
    Encryptor(const WTF::String& provider_for_encryption_in, WTF::HashMap<WTF::String, KeyPtr> key_entries_in)
    ...
    WTF::String provider_for_encryption;

    WTF::HashMap<WTF::String, KeyPtr> key_entries;
...
template <> struct StructTraits<::os_crypt_async::mojom::blink::Key::DataView, ::os_crypt_async::mojom::blink::KeyPtr> {
    static bool IsNull(const ::os_crypt_async::mojom::blink::KeyPtr& input)
    {
        return !input;
    }
    static void SetToNull(::os_crypt_async::mojom::blink::KeyPtr* output)
    {
        output->reset();
    }

    static decltype(::os_crypt_async::mojom::blink::Key::algorithm) algorithm(const ::os_crypt_async::mojom::blink::KeyPtr& input)
    {
        return input->algorithm;
    }

    static decltype(::os_crypt_async::mojom::blink::Key::key)& key(::os_crypt_async::mojom::blink::KeyPtr& input)
    {
        return input->key;
    }
...
template <> struct StructTraits<::os_crypt_async::mojom::blink::Encryptor::DataView, ::os_crypt_async::mojom::blink::EncryptorPtr> {
    static bool IsNull(const ::os_crypt_async::mojom::blink::EncryptorPtr& input)
    {
        return !input;
    }
    static void SetToNull(::os_crypt_async::mojom::blink::EncryptorPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::os_crypt_async::mojom::blink::Encryptor::key_entries)& key_entries(::os_crypt_async::mojom::blink::EncryptorPtr& input)
    {
