...
VariationsHeaders::VariationsHeaders(const base::flat_map<GoogleWebVisibility, std::string>& headers_map_in)
...
void VariationsHeaders::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("headers_map"), this->headers_map,
...
bool VariationsHeaders::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::variations::mojom::VariationsHeaders::DataView, ::variations::mojom::VariationsHeadersPtr>::Read(
    ::variations::mojom::VariationsHeaders::DataView input, ::variations::mojom::VariationsHeadersPtr* output)
{
    bool success = true;
