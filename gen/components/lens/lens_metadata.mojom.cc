...
LatencyLog::LatencyLog(Phase phase_in, const ::gfx::Size& original_size_in, const ::gfx::Size& downscaled_size_in, ImageFormat image_format_in,
...
void LatencyLog::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("original_size"), this->original_size,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("downscaled_size"), this->downscaled_size,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const ::gfx::Size&>"
#else
        "<value>"
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("encoded_bytes_size"), this->encoded_bytes_size,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool LatencyLog::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::lens::mojom::LatencyLog::DataView, ::lens::mojom::LatencyLogPtr>::Read(
    ::lens::mojom::LatencyLog::DataView input, ::lens::mojom::LatencyLogPtr* output)
{
    bool success = true;
