...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM) DocumentCoordinationUnit : public DocumentCoordinationUnitInterfaceBase {
public:
...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM) ProcessCoordinationUnit : public ProcessCoordinationUnitInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void OnRemoteIframeAttached(const ::blink::LocalFrameToken& parent_frame_token, const ::blink::RemoteFrameToken& remote_frame_token,
        ::performance_manager::mojom::IframeAttributionDataPtr iframe_attribution_data)
        = 0;
...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM) DocumentCoordinationUnitProxy : public DocumentCoordinationUnit {
public:
...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM) ProcessCoordinationUnitProxy : public ProcessCoordinationUnit {
public:
    ...
    void OnV8ContextCreated(::performance_manager::mojom::V8ContextDescriptionPtr description,
        ::performance_manager::mojom::IframeAttributionDataPtr iframe_attribution_data) final;
...
//    bool Accept(mojo::Message* message) override;
//};
//class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM) ProcessCoordinationUnitResponseValidator : public mojo::MessageReceiver {
//public:
//    bool Accept(mojo::Message* message) override;
//};
