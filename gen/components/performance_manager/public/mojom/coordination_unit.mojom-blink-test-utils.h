...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM_BLINK) DocumentCoordinationUnitInterceptorForTesting : public DocumentCoordinationUnit {
    ...
    void OnWebMemoryMeasurementRequested(
        ::performance_manager::mojom::blink::WebMemoryMeasurement::Mode mode, OnWebMemoryMeasurementRequestedCallback callback) override;
};
...
public:
    ...
    ::performance_manager::mojom::blink::WebMemoryMeasurementPtr OnWebMemoryMeasurementRequested(
