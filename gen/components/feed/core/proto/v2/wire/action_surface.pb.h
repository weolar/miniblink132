...
template <typename T> inline const std::string& ActionSurface_Name(T enum_t_value)
{
    static_assert(::std::is_same<T, ActionSurface>::value || ::std::is_integral<T>::value, "Incorrect type passed to function ActionSurface_Name.");
