...
template <typename ImplRefTraits> class GpuDataManagerStub;

class GpuDataManagerRequestValidator;
class GpuDataManagerResponseValidator;

class COMPONENT_EXPORT(BLINK_GPU_MOJOM) GpuDataManager : public GpuDataManagerInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = GpuDataManagerStub<ImplRefTraits>;
...
class COMPONENT_EXPORT(BLINK_GPU_MOJOM) GpuDataManagerProxy : public GpuDataManager {
public:
...
public:
    ...
    static bool AcceptWithResponder(GpuDataManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<GpuDataManager>> class GpuDataManagerStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return GpuDataManagerStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return GpuDataManagerStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
