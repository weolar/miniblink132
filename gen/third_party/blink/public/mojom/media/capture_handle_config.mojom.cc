...
#include "third_party/blink/public/mojom/media/capture_handle_config.mojom-test-utils.h"
...
bool StructTraits<::blink::mojom::CaptureHandleConfig::DataView, ::blink::mojom::CaptureHandleConfigPtr>::Read(
    ::blink::mojom::CaptureHandleConfig::DataView input, ::blink::mojom::CaptureHandleConfigPtr* output)
{
    bool success = true;
