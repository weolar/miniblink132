...
class BLINK_COMMON_EXPORT BlobReaderClient : public BlobReaderClientInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT Blob : public BlobInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void Load(::mojo::PendingReceiver<::network::mojom::URLLoader> loader, const std::string& request_method, const ::net::HttpRequestHeaders& headers,
...
//class BLINK_COMMON_EXPORT BlobReaderClientProxy : public BlobReaderClient {
//public:
...
//class BLINK_COMMON_EXPORT BlobProxy : public Blob {
//public:
...
//        ::mojo::PendingRemote<::network::mojom::URLLoaderClient> client) final;
//
