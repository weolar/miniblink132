...
class BLINK_COMMON_EXPORT FileBackedBlobFactory : public FileBackedBlobFactoryInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual bool RegisterBlobSync(
        ::mojo::PendingReceiver<::blink::mojom::Blob> blob, const std::string& uuid, const std::string& content_type, ::blink::mojom::DataElementFilePtr file);

    using RegisterBlobSyncCallback = base::OnceCallback<void()>;

    virtual void RegisterBlobSync(::mojo::PendingReceiver<::blink::mojom::Blob> blob, const std::string& uuid, const std::string& content_type,
        ::blink::mojom::DataElementFilePtr file, RegisterBlobSyncCallback callback)
        = 0;
};

//class BLINK_COMMON_EXPORT FileBackedBlobFactoryProxy : public FileBackedBlobFactory {
//public:
...
//        ::blink::mojom::DataElementFilePtr file) final;
//
//    bool RegisterBlobSync(::mojo::PendingReceiver<::blink::mojom::Blob> blob, const std::string& uuid, const std::string& content_type,
//        ::blink::mojom::DataElementFilePtr file) final;
//
//    void RegisterBlobSync(::mojo::PendingReceiver<::blink::mojom::Blob> blob, const std::string& uuid, const std::string& content_type,
//        ::blink::mojom::DataElementFilePtr file, RegisterBlobSyncCallback callback) final;
//
//private:
