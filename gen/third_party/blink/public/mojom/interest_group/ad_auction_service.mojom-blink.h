...
// with not having this data in traces there.
    ...
    virtual void ResolvedBuyerCurrenciesPromise(
...
// with not having this data in traces there.
    ...
    virtual void LeaveInterestGroup(const ::scoped_refptr<const ::blink::SecurityOrigin>& owner, const WTF::String& name, LeaveInterestGroupCallback callback)
        = 0;
    ...
    virtual void ClearOriginJoinedInterestGroups(const ::scoped_refptr<const ::blink::SecurityOrigin>& owner,
    ...
    virtual void GetInterestGroupAdAuctionData(const ::scoped_refptr<const ::blink::SecurityOrigin>& seller,
...
//class PLATFORM_EXPORT AbortableAdAuctionProxy : public AbortableAdAuction {
//public:
...
//        const std::optional<WTF::HashMap<::scoped_refptr<const ::blink::SecurityOrigin>, WTF::String>>& per_buyer_signals) final;
//
//    void ResolvedBuyerTimeoutsPromise(AuctionAdConfigAuctionIdPtr auction, AuctionAdConfigBuyerTimeoutField field,
//        ::blink::mojom::blink::AuctionAdConfigBuyerTimeoutsPtr buyer_timeouts) final;
//
//    void ResolvedBuyerCurrenciesPromise(
//        AuctionAdConfigAuctionIdPtr auction, ::blink::mojom::blink::AuctionAdConfigBuyerCurrenciesPtr per_buyer_currencies) final;
//
//    void ResolvedDirectFromSellerSignalsPromise(
//        AuctionAdConfigAuctionIdPtr auction, ::blink::mojom::blink::DirectFromSellerSignalsPtr direct_from_seller_signals) final;
//
//    void ResolvedDirectFromSellerSignalsHeaderAdSlotPromise(
//        AuctionAdConfigAuctionIdPtr auction, const WTF::String& direct_from_seller_signals_header_ad_slot) final;
//
//    void ResolvedDeprecatedRenderURLReplacementsPromise(
//        AuctionAdConfigAuctionIdPtr auction, WTF::Vector<::blink::mojom::blink::AdKeywordReplacementPtr> deprecated_render_url_replacements) final;
//
...
//class PLATFORM_EXPORT AdAuctionServiceProxy : public AdAuctionService {
//public:
...
//
//    void RunAdAuction(
//        ::blink::mojom::blink::AuctionAdConfigPtr config, ::mojo::PendingReceiver<AbortableAdAuction> abort_receiver, RunAdAuctionCallback callback) final;
//
...
//        ClearOriginJoinedInterestGroupsCallback callback) final;
//
...
//        const ::blink::KURL& uuid_url, WTF::Vector<::blink::mojom::blink::AdKeywordReplacementPtr> replacements, DeprecatedReplaceInURNCallback callback) final;
//
//    void GetInterestGroupAdAuctionData(const ::scoped_refptr<const ::blink::SecurityOrigin>& seller,
//        const ::scoped_refptr<const ::blink::SecurityOrigin>& coordinator, ::blink::mojom::blink::AuctionDataConfigPtr config,
//        GetInterestGroupAdAuctionDataCallback callback) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::AuctionAdConfigAuctionId::DataView, ::blink::mojom::blink::AuctionAdConfigAuctionIdPtr> {
    static bool IsNull(const ::blink::mojom::blink::AuctionAdConfigAuctionIdPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::AuctionAdConfigAuctionIdPtr* output)
    {
        output->reset();
    }
