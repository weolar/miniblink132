...
File::File(const ::WTF::String& path_in, uint64_t offset_in, uint64_t length_in, ::base::Time modification_time_in)
...
RequestBody::RequestBody(WTF::Vector<ElementPtr> elements_in, int64_t identifier_in, bool contains_sensitive_info_in)
...
HttpBody::HttpBody(const ::WTF::String& http_content_type_in, RequestBodyPtr request_body_in, bool contains_passwords_in)
...
ViewState::ViewState(const ::gfx::PointF& visual_viewport_scroll_offset_in, const ::gfx::Point& scroll_offset_in, double page_scale_factor_in,
    const ::WTF::String& scroll_anchor_selector_in, const std::optional<::gfx::PointF>& scroll_anchor_offset_in, uint64_t scroll_anchor_simhash_in)
    : visual_viewport_scroll_offset(std::move(visual_viewport_scroll_offset_in))
    , scroll_offset(std::move(scroll_offset_in))
    , page_scale_factor(std::move(page_scale_factor_in))
...
FrameState::FrameState(const ::WTF::String& url_string_in, const ::WTF::String& referrer_in, const ::WTF::String& target_in,
...
FrameState::FrameState(const ::WTF::String& url_string_in, const ::WTF::String& referrer_in, const ::WTF::String& target_in,
    ...
    ViewStatePtr view_state_in, int64_t item_sequence_number_in, int64_t document_sequence_number_in,
    ::network::mojom::blink::ReferrerPolicy referrer_policy_in, HttpBodyPtr http_body_in, WTF::Vector<FrameStatePtr> children_in,
    const WTF::String& initiator_origin_in, const ::WTF::String& navigation_api_key_in, const ::WTF::String& navigation_api_id_in)
    : url_string(std::move(url_string_in))
    , referrer(std::move(referrer_in))
    , target(std::move(target_in))
    , state_object(std::move(state_object_in))
...
FrameState::FrameState(const ::WTF::String& url_string_in, const ::WTF::String& referrer_in, const ::WTF::String& target_in,
    ...
    ::network::mojom::blink::ReferrerPolicy referrer_policy_in, HttpBodyPtr http_body_in, WTF::Vector<FrameStatePtr> children_in,
    const WTF::String& initiator_origin_in, const ::WTF::String& navigation_api_key_in, const ::WTF::String& navigation_api_id_in,
    const ::WTF::String& navigation_api_state_in, bool protect_url_in_navigation_api_in)
    : url_string(std::move(url_string_in))
    , referrer(std::move(referrer_in))
    , target(std::move(target_in))
    , state_object(std::move(state_object_in))
...
FrameState::FrameState(const ::WTF::String& url_string_in, const ::WTF::String& referrer_in, const ::WTF::String& target_in,
    ...
    ::network::mojom::blink::ReferrerPolicy referrer_policy_in, HttpBodyPtr http_body_in, WTF::Vector<FrameStatePtr> children_in,
    const WTF::String& initiator_origin_in, const ::WTF::String& navigation_api_key_in, const ::WTF::String& navigation_api_id_in,
    const ::WTF::String& navigation_api_state_in, bool protect_url_in_navigation_api_in, const ::WTF::String& initiator_base_url_string_in)
    : url_string(std::move(url_string_in))
    , referrer(std::move(referrer_in))
    , target(std::move(target_in))
    , state_object(std::move(state_object_in))
...
PageState::PageState(WTF::Vector<::WTF::String> referenced_files_in, FrameStatePtr top_in)
...
void Element::set_blob_uuid(const WTF::String& blob_uuid)
{
    if (tag_ == Tag::kBlobUuid) {
        *(data_.blob_uuid) = std::move(blob_uuid);
        ...
        DestroyActive();
        tag_ = Tag::kBlobUuid;
        data_.blob_uuid = new WTF::String(std::move(blob_uuid));
    }
}
void Element::set_bytes(WTF::Vector<uint8_t> bytes)
{
    if (tag_ == Tag::kBytes) {
        *(data_.bytes) = std::move(bytes);
        ...
        DestroyActive();
        tag_ = Tag::kBytes;
        data_.bytes = new WTF::Vector<uint8_t>(std::move(bytes));
    }
}
...
bool StructTraits<::blink::mojom::blink::DEPRECATED_FileSystemFile::DataView, ::blink::mojom::blink::DEPRECATED_FileSystemFilePtr>::Read(
    ::blink::mojom::blink::DEPRECATED_FileSystemFile::DataView input, ::blink::mojom::blink::DEPRECATED_FileSystemFilePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::File::DataView, ::blink::mojom::blink::FilePtr>::Read(
    ::blink::mojom::blink::File::DataView input, ::blink::mojom::blink::FilePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::RequestBody::DataView, ::blink::mojom::blink::RequestBodyPtr>::Read(
    ::blink::mojom::blink::RequestBody::DataView input, ::blink::mojom::blink::RequestBodyPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::HttpBody::DataView, ::blink::mojom::blink::HttpBodyPtr>::Read(
    ::blink::mojom::blink::HttpBody::DataView input, ::blink::mojom::blink::HttpBodyPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::ViewState::DataView, ::blink::mojom::blink::ViewStatePtr>::Read(
    ::blink::mojom::blink::ViewState::DataView input, ::blink::mojom::blink::ViewStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::FrameState::DataView, ::blink::mojom::blink::FrameStatePtr>::Read(
    ::blink::mojom::blink::FrameState::DataView input, ::blink::mojom::blink::FrameStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::PageState::DataView, ::blink::mojom::blink::PageStatePtr>::Read(
    ::blink::mojom::blink::PageState::DataView input, ::blink::mojom::blink::PageStatePtr* output)
{
    bool success = true;
...
bool UnionTraits<::blink::mojom::blink::Element::DataView, ::blink::mojom::blink::ElementPtr>::Read(
    ::blink::mojom::blink::Element::DataView input, ::blink::mojom::blink::ElementPtr* output)
{
