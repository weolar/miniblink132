...
class PLATFORM_EXPORT ManifestManager : public ManifestManagerInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    using RequestManifestCallback
        = base::OnceCallback<void(::blink::mojom::blink::ManifestRequestResult, const ::blink::KURL&, ::blink::mojom::blink::ManifestPtr)>;

    virtual void RequestManifest(RequestManifestCallback callback) = 0;

    using RequestManifestDebugInfoCallback
        = base::OnceCallback<void(const ::blink::KURL&, ::blink::mojom::blink::ManifestPtr, ::blink::mojom::blink::ManifestDebugInfoPtr)>;
...
//class PLATFORM_EXPORT ManifestManagerProxy : public ManifestManager {
//public:
...
//        ParseManifestFromStringCallback callback) final;
//
//private:
