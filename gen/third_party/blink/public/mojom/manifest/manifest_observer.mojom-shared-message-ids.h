// third_party/blink/public/mojom/manifest/manifest_observer.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class ManifestUrlChangeObserver : uint32_t {
    kManifestUrlChanged = 0,
};
