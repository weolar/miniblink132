// third_party/blink/public/mojom/push_messaging/push_messaging.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
public:
    ...
    PushMessagingAsyncWaiter(const PushMessagingAsyncWaiter&) = delete;
    PushMessagingAsyncWaiter& operator=(const PushMessagingAsyncWaiter&) = delete;

    ~PushMessagingAsyncWaiter();
    void Subscribe(int64_t service_worker_registration_id, PushSubscriptionOptionsPtr options, bool user_gesture,
        ::blink::mojom::blink::PushRegistrationStatus* out_status, PushSubscriptionPtr* out_subscription);

    void Unsubscribe(int64_t service_worker_registration_id, PushErrorType* out_error_type, bool* out_did_unsubscribe, WTF::String* out_error_message);
