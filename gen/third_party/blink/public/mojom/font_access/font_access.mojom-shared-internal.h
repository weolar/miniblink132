...
static_assert(sizeof(FontData_Data) == 40, "Bad sizeof(FontData_Data)");
// Used by FontData::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct FontData_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    FontData_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag FontData_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
