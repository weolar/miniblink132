...
class BLINK_COMMON_EXPORT WebPrintJobStateObserver : public WebPrintJobStateObserverInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT WebPrintJobController : public WebPrintJobControllerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_COMMON_EXPORT WebPrinter : public WebPrinterInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_COMMON_EXPORT WebPrintingService : public WebPrintingServiceInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT WebPrintJobStateObserverProxy : public WebPrintJobStateObserver {
//public:
...
//class BLINK_COMMON_EXPORT WebPrintJobControllerProxy : public WebPrintJobController {
//public:
...
//class BLINK_COMMON_EXPORT WebPrinterProxy : public WebPrinter {
//public:
...
//class BLINK_COMMON_EXPORT WebPrintingServiceProxy : public WebPrintingService {
//public:
    ...
    , to()
{
    ...
    {
        return mojo::internal::SerializeImpl<WebPrintingRange::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , pages_printed(0U)
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebPrintJobUpdate::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    static GetPrintersResultPtr NewPrinters(std::vector<WebPrinterInfoPtr> value)
    {
    ...
    , printer_remote()
{
    ...
    WebPrinterInfo(const std::string& printer_name_in, ::mojo::PendingRemote<WebPrinter> printer_remote_in)
    ...
    , y_dimension()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebPrintingMediaSize::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , media_size_name()
{
    ...
    WebPrintingMediaCollection(WebPrintingMediaSizePtr media_size_in, const std::string& media_size_name_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebPrintingMediaCollection::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , sides_supported()
{
    ...
    WebPrintingMediaCollectionPtr media_col_default_in, std::vector<WebPrintingMediaCollectionPtr> media_col_database_in,
    const std::optional<std::string>& media_source_default_in, std::vector<std::string> media_source_supported_in,
    WebPrintingMultipleDocumentHandling multiple_document_handling_default_in,
    std::vector<WebPrintingMultipleDocumentHandling> multiple_document_handling_supported_in, WebPrintingOrientationRequested orientation_requested_default_in,
    std::vector<WebPrintingOrientationRequested> orientation_requested_supported_in, const ::gfx::Size& printer_resolution_default_in,
    std::vector<::gfx::Size> printer_resolution_supported_in, WebPrintColorMode print_color_mode_default_in,
    std::vector<WebPrintColorMode> print_color_mode_supported_in, WebPrinterState printer_state_in, const std::string& printer_state_message_in,
    std::vector<WebPrinterStateReason> printer_state_reasons_in, std::optional<WebPrintingSides> sides_default_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebPrinterAttributes::DataView, std::vector<uint8_t>>(input);
    }
    ...
    : media_size()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebPrintingMediaCollectionRequested::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , sides()
{
    ...
    WebPrintJobTemplateAttributes(const std::string& job_name_in, uint32_t copies_in,
    WebPrintingMediaCollectionRequestedPtr media_col_in, const std::optional<std::string>& media_source_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<WebPrintJobTemplateAttributes::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , controller()
{
    ...
    WebPrintJobInfo(const std::string& job_name_in, uint32_t job_pages_in, ::mojo::PendingReceiver<WebPrintJobStateObserver> observer_in,
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrinterInfo::DataView, ::blink::mojom::WebPrinterInfoPtr> {
    static bool IsNull(const ::blink::mojom::WebPrinterInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrinterInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::WebPrinterInfo::printer_name)& printer_name(const ::blink::mojom::WebPrinterInfoPtr& input)
    {
        return input->printer_name;
    }

    static decltype(::blink::mojom::WebPrinterInfo::printer_remote)& printer_remote(::blink::mojom::WebPrinterInfoPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrintingRange::DataView, ::blink::mojom::WebPrintingRangePtr> {
    static bool IsNull(const ::blink::mojom::WebPrintingRangePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintingRangePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::WebPrintingRange::from) from(const ::blink::mojom::WebPrintingRangePtr& input)
    {
        return input->from;
    }

    static decltype(::blink::mojom::WebPrintingRange::to) to(const ::blink::mojom::WebPrintingRangePtr& input)
    {
        return input->to;
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrintingMediaSize::DataView, ::blink::mojom::WebPrintingMediaSizePtr> {
    static bool IsNull(const ::blink::mojom::WebPrintingMediaSizePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintingMediaSizePtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::WebPrintingMediaSize::x_dimension)& x_dimension(const ::blink::mojom::WebPrintingMediaSizePtr& input)
    {
        return input->x_dimension;
    }

    static const decltype(::blink::mojom::WebPrintingMediaSize::y_dimension)& y_dimension(const ::blink::mojom::WebPrintingMediaSizePtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrintingMediaCollection::DataView, ::blink::mojom::WebPrintingMediaCollectionPtr> {
    static bool IsNull(const ::blink::mojom::WebPrintingMediaCollectionPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintingMediaCollectionPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::WebPrintingMediaCollection::media_size)& media_size(const ::blink::mojom::WebPrintingMediaCollectionPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrinterAttributes::DataView, ::blink::mojom::WebPrinterAttributesPtr> {
    static bool IsNull(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrinterAttributesPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::WebPrinterAttributes::copies_default) copies_default(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
        return input->copies_default;
    }

    static const decltype(::blink::mojom::WebPrinterAttributes::copies_supported)& copies_supported(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
        return input->copies_supported;
    }

    static const decltype(::blink::mojom::WebPrinterAttributes::media_col_default)& media_col_default(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
        return input->media_col_default;
    }

    static const decltype(::blink::mojom::WebPrinterAttributes::media_col_database)& media_col_database(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPrinterAttributes::printer_state) printer_state(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPrinterAttributes::sides_default) sides_default(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
        return input->sides_default;
    }

    static const decltype(::blink::mojom::WebPrinterAttributes::sides_supported)& sides_supported(const ::blink::mojom::WebPrinterAttributesPtr& input)
    {
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrintingMediaCollectionRequested::DataView, ::blink::mojom::WebPrintingMediaCollectionRequestedPtr> {
    static bool IsNull(const ::blink::mojom::WebPrintingMediaCollectionRequestedPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintingMediaCollectionRequestedPtr* output)
    {
        output->reset();
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrintJobTemplateAttributes::DataView, ::blink::mojom::WebPrintJobTemplateAttributesPtr> {
    static bool IsNull(const ::blink::mojom::WebPrintJobTemplateAttributesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintJobTemplateAttributesPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::WebPrintJobTemplateAttributes::job_name)& job_name(const ::blink::mojom::WebPrintJobTemplateAttributesPtr& input)
    {
        return input->job_name;
    }

    static decltype(::blink::mojom::WebPrintJobTemplateAttributes::copies) copies(const ::blink::mojom::WebPrintJobTemplateAttributesPtr& input)
    {
        return input->copies;
    }

    static const decltype(::blink::mojom::WebPrintJobTemplateAttributes::media_col)& media_col(const ::blink::mojom::WebPrintJobTemplateAttributesPtr& input)
    {
    ...
    static decltype(::blink::mojom::WebPrintJobTemplateAttributes::sides) sides(const ::blink::mojom::WebPrintJobTemplateAttributesPtr& input)
    {
        return input->sides;
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrintJobUpdate::DataView, ::blink::mojom::WebPrintJobUpdatePtr> {
    static bool IsNull(const ::blink::mojom::WebPrintJobUpdatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintJobUpdatePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::WebPrintJobUpdate::state) state(const ::blink::mojom::WebPrintJobUpdatePtr& input)
    {
        return input->state;
    }

    static decltype(::blink::mojom::WebPrintJobUpdate::pages_printed) pages_printed(const ::blink::mojom::WebPrintJobUpdatePtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPrintJobInfo::DataView, ::blink::mojom::WebPrintJobInfoPtr> {
    static bool IsNull(const ::blink::mojom::WebPrintJobInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintJobInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::WebPrintJobInfo::job_name)& job_name(const ::blink::mojom::WebPrintJobInfoPtr& input)
    {
        return input->job_name;
    }

    static decltype(::blink::mojom::WebPrintJobInfo::job_pages) job_pages(const ::blink::mojom::WebPrintJobInfoPtr& input)
    {
        return input->job_pages;
    }

    static decltype(::blink::mojom::WebPrintJobInfo::observer)& observer(::blink::mojom::WebPrintJobInfoPtr& input)
    {
        return input->observer;
    }

    static decltype(::blink::mojom::WebPrintJobInfo::controller)& controller(::blink::mojom::WebPrintJobInfoPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::WebPrintingMediaSizeDimension::DataView, ::blink::mojom::WebPrintingMediaSizeDimensionPtr> {
    static bool IsNull(const ::blink::mojom::WebPrintingMediaSizeDimensionPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintingMediaSizeDimensionPtr* output)
    {
        output->reset();
    }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::GetPrintersResult::DataView, ::blink::mojom::GetPrintersResultPtr> {
    static bool IsNull(const ::blink::mojom::GetPrintersResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::GetPrintersResultPtr* output)
    {
        output->reset();
    }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::WebPrinterFetchResult::DataView, ::blink::mojom::WebPrinterFetchResultPtr> {
    static bool IsNull(const ::blink::mojom::WebPrinterFetchResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrinterFetchResultPtr* output)
    {
        output->reset();
    }
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::WebPrintResult::DataView, ::blink::mojom::WebPrintResultPtr> {
    static bool IsNull(const ::blink::mojom::WebPrintResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WebPrintResultPtr* output)
    {
        output->reset();
    }
