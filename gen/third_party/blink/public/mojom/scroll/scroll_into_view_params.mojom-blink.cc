...
ScrollIntoViewParams::ScrollIntoViewParams(ScrollAlignmentPtr align_x_in, ScrollAlignmentPtr align_y_in, ::blink::mojom::blink::ScrollType type_in,
...
bool StructTraits<::blink::mojom::blink::ScrollAlignment::DataView, ::blink::mojom::blink::ScrollAlignmentPtr>::Read(
    ::blink::mojom::blink::ScrollAlignment::DataView input, ::blink::mojom::blink::ScrollAlignmentPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::FocusedEditableParams::DataView, ::blink::mojom::blink::FocusedEditableParamsPtr>::Read(
    ::blink::mojom::blink::FocusedEditableParams::DataView input, ::blink::mojom::blink::FocusedEditableParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::ScrollIntoViewParams::DataView, ::blink::mojom::blink::ScrollIntoViewParamsPtr>::Read(
    ::blink::mojom::blink::ScrollIntoViewParams::DataView input, ::blink::mojom::blink::ScrollIntoViewParamsPtr* output)
{
    bool success = true;
