...
class BLINK_COMMON_EXPORT IDBFactoryClientInterceptorForTesting : public IDBFactoryClient {
    ...
    void UpgradeNeeded(::mojo::PendingAssociatedRemote<IDBDatabase> pending_database, int64_t old_version, IDBDataLoss data_loss,
        const std::string& data_loss_message, const ::blink::IndexedDBDatabaseMetadata& db_metadata) override;
...
class BLINK_COMMON_EXPORT IDBCursorInterceptorForTesting : public IDBCursor {
    ...
    void Continue(const ::blink::IndexedDBKey& key, const ::blink::IndexedDBKey& primary_key, ContinueCallback callback) override;
...
public:
    ...
    void Continue(const ::blink::IndexedDBKey& key, const ::blink::IndexedDBKey& primary_key, IDBCursorResultPtr* out_result);
    IDBCursorResultPtr Continue(const ::blink::IndexedDBKey& key, const ::blink::IndexedDBKey& primary_key);
...
class BLINK_COMMON_EXPORT IDBTransactionInterceptorForTesting : public IDBTransaction {
    ...
    void Put(int64_t object_store_id, IDBValuePtr value, const ::blink::IndexedDBKey& key, IDBPutMode mode,
        const std::vector<::blink::IndexedDBIndexKeys>& index_keys, PutCallback callback) override;
...
public:
    ...
    IDBTransactionPutResultPtr Put(int64_t object_store_id, IDBValuePtr value, const ::blink::IndexedDBKey& key, IDBPutMode mode,
...
class BLINK_COMMON_EXPORT IDBDatabaseInterceptorForTesting : public IDBDatabase {
    ...
    void CreateTransaction(::mojo::PendingAssociatedReceiver<IDBTransaction> transaction_receiver, int64_t transaction_id,
        const std::vector<int64_t>& object_store_ids, IDBTransactionMode mode, IDBTransactionDurability durability) override;
    ...
    void GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, IDBGetAllResultType result_type,
        int64_t max_count, IDBCursorDirection direction, GetAllCallback callback) override;
    ...
    void OpenCursor(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range,
        IDBCursorDirection direction, bool key_only, IDBTaskType task_type, OpenCursorCallback callback) override;
    void Count(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, CountCallback callback) override;
    void DeleteRange(int64_t transaction_id, int64_t object_store_id, const ::blink::IndexedDBKeyRange& key_range, DeleteRangeCallback callback) override;
...
public:
    ...
    void GetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, IDBGetAllResultType result_type,
        int64_t max_count, IDBCursorDirection direction, ::mojo::PendingAssociatedReceiver<IDBDatabaseGetAllResultSink>* out_receiver);
    ...
    void DeleteRange(int64_t transaction_id, int64_t object_store_id, const ::blink::IndexedDBKeyRange& key_range, bool* out_success);
    bool DeleteRange(int64_t transaction_id, int64_t object_store_id, const ::blink::IndexedDBKeyRange& key_range);
...
public:
    ...
    void GetDatabaseInfo(std::vector<IDBNameAndVersionPtr>* out_names_and_versions, IDBErrorPtr* out_error);
