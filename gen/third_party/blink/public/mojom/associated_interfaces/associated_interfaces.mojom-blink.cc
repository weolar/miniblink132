...
void AssociatedInterfaceProviderProxy::GetAssociatedInterface(const WTF::String& in_name, ::mojo::PendingAssociatedReceiver<AssociatedInterface> in_receiver)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void AssociatedInterfaceProviderInterceptorForTesting::GetAssociatedInterface(
    const WTF::String& name, ::mojo::PendingAssociatedReceiver<AssociatedInterface> receiver)
{
