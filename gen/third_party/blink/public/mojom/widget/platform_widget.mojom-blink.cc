...
void WidgetHostProxy::UpdateTooltipUnderCursor(const ::WTF::String& in_tooltip_text, ::base::i18n::TextDirection in_text_direction_hint)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::WidgetHost::UpdateTooltipUnderCursor", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("tooltip_text"), in_tooltip_text, "<value of type const ::WTF::String&>");
...
void WidgetHostProxy::TextInputStateChanged(::ui::mojom::blink::TextInputStatePtr in_state)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::WidgetHost::TextInputStateChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("state"), in_state, "<value of type ::ui::mojom::blink::TextInputStatePtr>");
    });
#endif
...
void WidgetHostProxy::CreateFrameSink(::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> in_compositor_frame_sink_receiver,
    ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> in_compositor_frame_sink_client)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void WidgetHostProxy::RegisterRenderFrameMetadataObserver(
    ::mojo::PendingReceiver<::cc::mojom::blink::RenderFrameMetadataObserverClient> in_render_frame_metadata_observer_client_receiver,
    ::mojo::PendingRemote<::cc::mojom::blink::RenderFrameMetadataObserver> in_render_frame_metadata_observer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void WidgetProxy::WasShown(bool in_was_evicted, ::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr in_record_tab_switch_time_request)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void WidgetProxy::RequestSuccessfulPresentationTimeForNextFrame(::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr in_visible_time_request)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::Widget::RequestSuccessfulPresentationTimeForNextFrame", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("visible_time_request"), in_visible_time_request, "<value of type ::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr>");
    });
#endif
    ...
    ::mojo::PendingReceiver<::blink::mojom::blink::WidgetInputHandler> in_request, ::mojo::PendingRemote<::blink::mojom::blink::WidgetInputHandlerHost> in_host)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::RenderInputRouterClient::GetWidgetInputHandler", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("request"), in_request, "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::WidgetInputHandler>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("host"), in_host, "<value of type ::mojo::PendingRemote<::blink::mojom::blink::WidgetInputHandlerHost>>");
    });
#endif
...
void RenderInputRouterClientProxy::ShowContextMenu(::ui::mojom::blink::MenuSourceType in_source_type, const ::gfx::Point& in_location)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void RenderInputRouterClientProxy::BindInputTargetClient(::mojo::PendingReceiver<::viz::mojom::blink::InputTargetClient> in_host)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::RenderInputRouterClient::BindInputTargetClient", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("host"), in_host, "<value of type ::mojo::PendingReceiver<::viz::mojom::blink::InputTargetClient>>");
    });
#endif
...
{
    const char* name = ::blink::mojom::blink::RenderInputRouterClient::Name_;
...
void WidgetHostInterceptorForTesting::CreateFrameSink(::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> compositor_frame_sink_receiver,
...
void WidgetInterceptorForTesting::RequestSuccessfulPresentationTimeForNextFrame(
    ::blink::mojom::blink::RecordContentToVisibleTimeRequestPtr visible_time_request)
{
