    ...
    , show_reason_unfolding(false)
{
    ...
    {
        return mojo::internal::SerializeImpl<RecordContentToVisibleTimeRequest::DataView, std::vector<uint8_t>>(input);
    }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::RecordContentToVisibleTimeRequest::DataView, ::blink::mojom::RecordContentToVisibleTimeRequestPtr> {
    static bool IsNull(const ::blink::mojom::RecordContentToVisibleTimeRequestPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::RecordContentToVisibleTimeRequestPtr* output)
    {
        output->reset();
    }
