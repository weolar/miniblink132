    ...
    , virtual_keyboard_resize_height_physical_px()
{
    ...
    {
        return mojo::internal::SerializeImpl<VisualProperties::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::VisualProperties::DataView, ::blink::mojom::VisualPropertiesPtr> {
    static bool IsNull(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::VisualPropertiesPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::VisualProperties::screen_infos)& screen_infos(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->screen_infos;
    }

    static decltype(::blink::mojom::VisualProperties::auto_resize_enabled) auto_resize_enabled(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->auto_resize_enabled;
    }

    static decltype(::blink::mojom::VisualProperties::resizable) resizable(const ::blink::mojom::VisualPropertiesPtr& input)
    {
    ...
    static const decltype(::blink::mojom::VisualProperties::new_size)& new_size(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->new_size;
    }

    static const decltype(::blink::mojom::VisualProperties::visible_viewport_size)& visible_viewport_size(const ::blink::mojom::VisualPropertiesPtr& input)
    {
    ...
    static const decltype(::blink::mojom::VisualProperties::browser_controls_params)& browser_controls_params(const ::blink::mojom::VisualPropertiesPtr& input)
    {
    ...
    static const decltype(::blink::mojom::VisualProperties::local_surface_id)& local_surface_id(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->local_surface_id;
    }

    static decltype(::blink::mojom::VisualProperties::is_fullscreen_granted) is_fullscreen_granted(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->is_fullscreen_granted;
    }

    static decltype(::blink::mojom::VisualProperties::display_mode) display_mode(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->display_mode;
    }

    static decltype(::blink::mojom::VisualProperties::window_show_state) window_show_state(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->window_show_state;
    }

    static decltype(::blink::mojom::VisualProperties::capture_sequence_number) capture_sequence_number(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->capture_sequence_number;
    }

    static decltype(::blink::mojom::VisualProperties::zoom_level) zoom_level(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->zoom_level;
    }

    static decltype(::blink::mojom::VisualProperties::css_zoom_factor) css_zoom_factor(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->css_zoom_factor;
    }

    static decltype(::blink::mojom::VisualProperties::page_scale_factor) page_scale_factor(const ::blink::mojom::VisualPropertiesPtr& input)
    {
        return input->page_scale_factor;
    }

    static decltype(::blink::mojom::VisualProperties::compositing_scale_factor) compositing_scale_factor(const ::blink::mojom::VisualPropertiesPtr& input)
    {
    ...
    static decltype(::blink::mojom::VisualProperties::is_pinch_gesture_active) is_pinch_gesture_active(const ::blink::mojom::VisualPropertiesPtr& input)
    {
    ...
    static decltype(::blink::mojom::VisualProperties::virtual_keyboard_resize_height_physical_px) virtual_keyboard_resize_height_physical_px(
        const ::blink::mojom::VisualPropertiesPtr& input)
    {
