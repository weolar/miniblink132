...
class BLINK_COMMON_EXPORT WidgetCompositor : public WidgetCompositorInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT WidgetHost : public WidgetHostInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void UpdateTooltipFromKeyboard(const ::std::u16string& tooltip_text, ::base::i18n::TextDirection text_direction_hint, const ::gfx::Rect& bounds)
        = 0;
    ...
    virtual void CreateFrameSink(::mojo::PendingReceiver<::viz::mojom::CompositorFrameSink> compositor_frame_sink_receiver,
...
class BLINK_COMMON_EXPORT Widget : public WidgetInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_COMMON_EXPORT RenderInputRouterClient : public RenderInputRouterClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT WidgetCompositorProxy : public WidgetCompositor {
//public:
...
//class BLINK_COMMON_EXPORT WidgetHostProxy : public WidgetHost {
//public:
...
//        ::mojo::PendingRemote<::viz::mojom::CompositorFrameSinkClient> compositor_frame_sink_client) final;
//
//    void RegisterRenderFrameMetadataObserver(
//        ::mojo::PendingReceiver<::cc::mojom::RenderFrameMetadataObserverClient> render_frame_metadata_observer_client_receiver,
//        ::mojo::PendingRemote<::cc::mojom::RenderFrameMetadataObserver> render_frame_metadata_observer) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};

//class BLINK_COMMON_EXPORT WidgetProxy : public Widget {
//public:
...
//class BLINK_COMMON_EXPORT RenderInputRouterClientProxy : public RenderInputRouterClient {
//public:
...
//        ::mojo::PendingReceiver<::blink::mojom::WidgetInputHandler> request, ::mojo::PendingRemote<::blink::mojom::WidgetInputHandlerHost> host) final;
//
