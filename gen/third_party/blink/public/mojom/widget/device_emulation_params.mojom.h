    ...
    , device_posture()
{
    ...
    {
        return mojo::internal::SerializeImpl<DeviceEmulationParams::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::DeviceEmulationParams::DataView, ::blink::mojom::DeviceEmulationParamsPtr> {
    static bool IsNull(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::DeviceEmulationParamsPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::DeviceEmulationParams::screen_type) screen_type(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->screen_type;
    }

    static const decltype(::blink::mojom::DeviceEmulationParams::screen_size)& screen_size(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->screen_size;
    }

    static const decltype(::blink::mojom::DeviceEmulationParams::view_position)& view_position(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->view_position;
    }

    static const decltype(::blink::mojom::DeviceEmulationParams::view_size)& view_size(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->view_size;
    }

    static decltype(::blink::mojom::DeviceEmulationParams::device_scale_factor) device_scale_factor(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->device_scale_factor;
    }

    static decltype(::blink::mojom::DeviceEmulationParams::scale) scale(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->scale;
    }

    static const decltype(::blink::mojom::DeviceEmulationParams::viewport_offset)& viewport_offset(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->viewport_offset;
    }

    static decltype(::blink::mojom::DeviceEmulationParams::viewport_scale) viewport_scale(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::DeviceEmulationParams::viewport_segments)& viewport_segments(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
        return input->viewport_segments;
    }

    static decltype(::blink::mojom::DeviceEmulationParams::device_posture) device_posture(const ::blink::mojom::DeviceEmulationParamsPtr& input)
    {
