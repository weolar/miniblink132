...
// static
bool WindowFeatures_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const WindowFeatures_Data* object = static_cast<const WindowFeatures_Data*>(data);
