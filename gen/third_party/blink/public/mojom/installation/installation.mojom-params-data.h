// third_party/blink/public/mojom/installation/installation.mojom-params-data.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<InstallationService_OnInstall_Params_Data>;

    InstallationService_OnInstall_Params_Data();
    ~InstallationService_OnInstall_Params_Data() = delete;
};
static_assert(sizeof(InstallationService_OnInstall_Params_Data) == 8, "Bad sizeof(InstallationService_OnInstall_Params_Data)");

} // namespace internal

class InstallationService_OnInstall_ParamsDataView {
public:
    InstallationService_OnInstall_ParamsDataView() = default;

    InstallationService_OnInstall_ParamsDataView(internal::InstallationService_OnInstall_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
