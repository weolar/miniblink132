...
AdProperties::AdProperties(const WTF::String& width_in, const WTF::String& height_in, const WTF::String& slot_in, const WTF::String& lang_in,
...
AdTargeting::AdTargeting(std::optional<WTF::Vector<WTF::String>> interests_in, AdGeolocationPtr geolocation_in)
...
AdRequestConfig::AdRequestConfig(const ::blink::KURL& ad_request_url_in, WTF::Vector<AdPropertiesPtr> ad_properties_in, const WTF::String& publisher_code_in,
...
bool StructTraits<::blink::mojom::blink::AdProperties::DataView, ::blink::mojom::blink::AdPropertiesPtr>::Read(
    ::blink::mojom::blink::AdProperties::DataView input, ::blink::mojom::blink::AdPropertiesPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::AdGeolocation::DataView, ::blink::mojom::blink::AdGeolocationPtr>::Read(
    ::blink::mojom::blink::AdGeolocation::DataView input, ::blink::mojom::blink::AdGeolocationPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::AdTargeting::DataView, ::blink::mojom::blink::AdTargetingPtr>::Read(
    ::blink::mojom::blink::AdTargeting::DataView input, ::blink::mojom::blink::AdTargetingPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::AdRequestConfig::DataView, ::blink::mojom::blink::AdRequestConfigPtr>::Read(
    ::blink::mojom::blink::AdRequestConfig::DataView input, ::blink::mojom::blink::AdRequestConfigPtr* output)
{
    bool success = true;
