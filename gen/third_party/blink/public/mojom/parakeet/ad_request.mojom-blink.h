    ...
    , longitude()
{
    ...
    {
        return mojo::internal::SerializeImpl<AdGeolocation::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    , bid_floor()
{
    ...
    AdProperties(const WTF::String& width_in, const WTF::String& height_in, const WTF::String& slot_in, const WTF::String& lang_in,
    const WTF::String& ad_type_in, double bid_floor_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AdProperties::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    , geolocation()
{
    ...
    AdTargeting(std::optional<WTF::Vector<WTF::String>> interests_in, AdGeolocationPtr geolocation_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AdTargeting::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    , fallback_source()
{
    ...
    AdRequestConfig(const ::blink::KURL& ad_request_url_in, WTF::Vector<AdPropertiesPtr> ad_properties_in, const WTF::String& publisher_code_in,
    AdTargetingPtr targeting_in, std::optional<WTF::Vector<AdSignals>> anonymized_proxied_signals_in, const std::optional<::blink::KURL>& fallback_source_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AdRequestConfig::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdProperties::DataView, ::blink::mojom::blink::AdPropertiesPtr> {
    static bool IsNull(const ::blink::mojom::blink::AdPropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::AdPropertiesPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::blink::AdProperties::width)& width(const ::blink::mojom::blink::AdPropertiesPtr& input)
    {
        return input->width;
    }

    static const decltype(::blink::mojom::blink::AdProperties::height)& height(const ::blink::mojom::blink::AdPropertiesPtr& input)
    {
        return input->height;
    }

    static const decltype(::blink::mojom::blink::AdProperties::slot)& slot(const ::blink::mojom::blink::AdPropertiesPtr& input)
    {
        return input->slot;
    }

    static const decltype(::blink::mojom::blink::AdProperties::lang)& lang(const ::blink::mojom::blink::AdPropertiesPtr& input)
    {
        return input->lang;
    }

    static const decltype(::blink::mojom::blink::AdProperties::ad_type)& ad_type(const ::blink::mojom::blink::AdPropertiesPtr& input)
    {
        return input->ad_type;
    }

    static decltype(::blink::mojom::blink::AdProperties::bid_floor) bid_floor(const ::blink::mojom::blink::AdPropertiesPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdGeolocation::DataView, ::blink::mojom::blink::AdGeolocationPtr> {
    static bool IsNull(const ::blink::mojom::blink::AdGeolocationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::AdGeolocationPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::blink::AdGeolocation::latitude) latitude(const ::blink::mojom::blink::AdGeolocationPtr& input)
    {
        return input->latitude;
    }

    static decltype(::blink::mojom::blink::AdGeolocation::longitude) longitude(const ::blink::mojom::blink::AdGeolocationPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdTargeting::DataView, ::blink::mojom::blink::AdTargetingPtr> {
    static bool IsNull(const ::blink::mojom::blink::AdTargetingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::AdTargetingPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::blink::AdTargeting::interests)& interests(const ::blink::mojom::blink::AdTargetingPtr& input)
    {
        return input->interests;
    }

    static const decltype(::blink::mojom::blink::AdTargeting::geolocation)& geolocation(const ::blink::mojom::blink::AdTargetingPtr& input)
    {
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::AdRequestConfig::DataView, ::blink::mojom::blink::AdRequestConfigPtr> {
    static bool IsNull(const ::blink::mojom::blink::AdRequestConfigPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::AdRequestConfigPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::blink::AdRequestConfig::ad_request_url)& ad_request_url(const ::blink::mojom::blink::AdRequestConfigPtr& input)
    {
        return input->ad_request_url;
    }

    static const decltype(::blink::mojom::blink::AdRequestConfig::ad_properties)& ad_properties(const ::blink::mojom::blink::AdRequestConfigPtr& input)
    {
        return input->ad_properties;
    }

    static const decltype(::blink::mojom::blink::AdRequestConfig::publisher_code)& publisher_code(const ::blink::mojom::blink::AdRequestConfigPtr& input)
    {
        return input->publisher_code;
    }

    static const decltype(::blink::mojom::blink::AdRequestConfig::targeting)& targeting(const ::blink::mojom::blink::AdRequestConfigPtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::AdRequestConfig::fallback_source)& fallback_source(const ::blink::mojom::blink::AdRequestConfigPtr& input)
    {
