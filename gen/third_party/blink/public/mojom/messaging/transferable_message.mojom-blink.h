    ...
    , parent_task_id()
{
    ...
    TransferableMessage(::blink::BlinkCloneableMessage message_in, WTF::Vector<::blink::MessagePortDescriptor> ports_in,
    ...
    ::blink::mojom::blink::UserActivationSnapshotPtr user_activation_in, ::blink::mojom::blink::DelegatedCapability delegated_capability_in,
    ...
    WTF::Vector<::blink::MessagePortDescriptor> ports;

    WTF::Vector<::blink::MessagePortDescriptor> stream_channels;

    WTF::Vector<::blink::ArrayBufferContents> array_buffer_contents_array;

    WTF::Vector<::blink::mojom::blink::SerializedStaticBitmapImagePtr> image_bitmap_contents_array;
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::TransferableMessage::DataView, ::blink::mojom::blink::TransferableMessagePtr> {
    static bool IsNull(const ::blink::mojom::blink::TransferableMessagePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::TransferableMessagePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::blink::TransferableMessage::message)& message(::blink::mojom::blink::TransferableMessagePtr& input)
    {
        return input->message;
    }

    static decltype(::blink::mojom::blink::TransferableMessage::ports)& ports(::blink::mojom::blink::TransferableMessagePtr& input)
    {
        return input->ports;
    }

    static decltype(::blink::mojom::blink::TransferableMessage::stream_channels)& stream_channels(::blink::mojom::blink::TransferableMessagePtr& input)
    {
    ...
    static const decltype(::blink::mojom::blink::TransferableMessage::parent_task_id)& parent_task_id(
        const ::blink::mojom::blink::TransferableMessagePtr& input)
    {
