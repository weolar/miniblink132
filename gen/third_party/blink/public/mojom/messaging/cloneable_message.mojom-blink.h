    ...
    , file_system_access_tokens()
{
    ...
    CloneableMessage(::mojo_base::BigBuffer encoded_message_in, WTF::Vector<::scoped_refptr<::blink::BlobDataHandle>> blobs_in,
    const ::scoped_refptr<const ::blink::SecurityOrigin>& sender_origin_in, uint64_t stack_trace_id_in, int64_t stack_trace_debugger_id_first_in,
    ...
    WTF::Vector<::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>> file_system_access_tokens;
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::CloneableMessage::DataView, ::blink::mojom::blink::CloneableMessagePtr> {
    static bool IsNull(const ::blink::mojom::blink::CloneableMessagePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::CloneableMessagePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::blink::CloneableMessage::encoded_message)& encoded_message(::blink::mojom::blink::CloneableMessagePtr& input)
    {
        return input->encoded_message;
    }

    static decltype(::blink::mojom::blink::CloneableMessage::blobs)& blobs(::blink::mojom::blink::CloneableMessagePtr& input)
    {
        return input->blobs;
    }

    static const decltype(::blink::mojom::blink::CloneableMessage::sender_origin)& sender_origin(const ::blink::mojom::blink::CloneableMessagePtr& input)
    {
        return input->sender_origin;
    }

    static decltype(::blink::mojom::blink::CloneableMessage::stack_trace_id) stack_trace_id(const ::blink::mojom::blink::CloneableMessagePtr& input)
    {
