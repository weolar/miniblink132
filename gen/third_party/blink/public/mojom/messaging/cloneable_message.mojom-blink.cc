...
CloneableMessage::CloneableMessage(::mojo_base::BigBuffer encoded_message_in, WTF::Vector<::scoped_refptr<::blink::BlobDataHandle>> blobs_in,
...
bool StructTraits<::blink::mojom::blink::CloneableMessage::DataView, ::blink::mojom::blink::CloneableMessagePtr>::Read(
    ::blink::mojom::blink::CloneableMessage::DataView input, ::blink::mojom::blink::CloneableMessagePtr* output)
{
    bool success = true;
