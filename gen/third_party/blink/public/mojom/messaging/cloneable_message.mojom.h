...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<CloneableMessage, T>::value>;
    using DataView = CloneableMessageDataView;
    using Data_ = internal::CloneableMessage_Data;

    template <typename... Args> static CloneableMessagePtr New(Args&&... args)
    {
        return CloneableMessagePtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static CloneableMessagePtr From(const U& u)
    {
    ...
    , file_system_access_tokens()
{
    ...
    CloneableMessage(::mojo_base::BigBuffer encoded_message_in, std::vector<::blink::mojom::SerializedBlobPtr> blobs_in,
    ...
    ~CloneableMessage() = default;

    // Clone() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = CloneableMessagePtr> CloneableMessagePtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, CloneableMessage::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, CloneableMessage::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    {
        return mojo::internal::SerializeAsMessageImpl<CloneableMessage::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::CloneableMessage_UnserializedMessageContext<UserType, CloneableMessage::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        ...
        return mojo::internal::DeserializeImpl<CloneableMessage::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return CloneableMessage::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::CloneableMessage_UnserializedMessageContext<UserType, CloneableMessage::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<CloneableMessage::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, CloneableMessage::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
template <typename StructPtrType> CloneableMessagePtr CloneableMessage::Clone() const
{
    return New(mojo::Clone(encoded_message), mojo::Clone(blobs), mojo::Clone(sender_origin), mojo::Clone(stack_trace_id),
        mojo::Clone(stack_trace_debugger_id_first), mojo::Clone(stack_trace_debugger_id_second), mojo::Clone(stack_trace_should_pause),
        mojo::Clone(sender_agent_cluster_id), mojo::Clone(locked_to_sender_agent_cluster), mojo::Clone(file_system_access_tokens));
}

template <typename T, CloneableMessage::EnableIfSame<T>*> bool CloneableMessage::Equals(const T& other_struct) const
{
...
template <typename T, CloneableMessage::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::CloneableMessage::DataView, ::blink::mojom::CloneableMessagePtr> {
    static bool IsNull(const ::blink::mojom::CloneableMessagePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::CloneableMessagePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::CloneableMessage::encoded_message)& encoded_message(::blink::mojom::CloneableMessagePtr& input)
    {
        return input->encoded_message;
    }

    static decltype(::blink::mojom::CloneableMessage::blobs)& blobs(::blink::mojom::CloneableMessagePtr& input)
    {
        return input->blobs;
    }

    static const decltype(::blink::mojom::CloneableMessage::sender_origin)& sender_origin(const ::blink::mojom::CloneableMessagePtr& input)
    {
        return input->sender_origin;
    }

    static decltype(::blink::mojom::CloneableMessage::stack_trace_id) stack_trace_id(const ::blink::mojom::CloneableMessagePtr& input)
    {
    ...
    static decltype(::blink::mojom::CloneableMessage::stack_trace_should_pause) stack_trace_should_pause(const ::blink::mojom::CloneableMessagePtr& input)
    {
        return input->stack_trace_should_pause;
    }

    static const decltype(::blink::mojom::CloneableMessage::sender_agent_cluster_id)& sender_agent_cluster_id(const ::blink::mojom::CloneableMessagePtr& input)
    {
    ...
    static decltype(::blink::mojom::CloneableMessage::file_system_access_tokens)& file_system_access_tokens(::blink::mojom::CloneableMessagePtr& input)
    {
