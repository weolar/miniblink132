...
static_assert(sizeof(UserActivationSnapshot_Data) == 16, "Bad sizeof(UserActivationSnapshot_Data)");
// Used by UserActivationSnapshot::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct UserActivationSnapshot_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    UserActivationSnapshot_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag UserActivationSnapshot_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
