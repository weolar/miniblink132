// third_party/blink/public/mojom/installedapp/related_application.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/installedapp/related_application.mojom-test-utils.h"
...
RelatedApplication::RelatedApplication(const std::string& platform_in, const std::optional<std::string>& url_in, const std::optional<std::string>& id_in,
...
bool StructTraits<::blink::mojom::RelatedApplication::DataView, ::blink::mojom::RelatedApplicationPtr>::Read(
    ::blink::mojom::RelatedApplication::DataView input, ::blink::mojom::RelatedApplicationPtr* output)
{
    bool success = true;
