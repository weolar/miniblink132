...
ExtendableMessageEvent::ExtendableMessageEvent(::blink::BlinkTransferableMessage message_in,
...
void ServiceWorkerHostProxy::GetClients(::blink::mojom::blink::ServiceWorkerClientQueryOptionsPtr in_options, GetClientsCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorkerHost::GetClients", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("options"), in_options, "<value of type ::blink::mojom::blink::ServiceWorkerClientQueryOptionsPtr>");
    });
#endif
...
void ServiceWorkerHost_GetClients_ProxyToResponder::Run(WTF::Vector<::blink::mojom::blink::ServiceWorkerClientInfoPtr> in_clients)
{
    ...
    TRACE_EVENT1("mojom", "Send reply blink::mojom::ServiceWorkerHost::GetClients", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("clients"), in_clients, "<value of type WTF::Vector<::blink::mojom::blink::ServiceWorkerClientInfoPtr>>");
    });
#endif
...
void ServiceWorkerProxy::InitializeGlobalScope(::mojo::PendingAssociatedRemote<ServiceWorkerHost> in_service_worker_host,
    ::mojo::PendingAssociatedRemote<::blink::mojom::blink::AssociatedInterfaceProvider> in_associated_interfaces_to_browser,
    ::mojo::PendingAssociatedReceiver<::blink::mojom::blink::AssociatedInterfaceProvider> in_associated_interfaces_from_browser,
    ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr in_registration_info,
    ::blink::mojom::blink::ServiceWorkerObjectInfoPtr in_service_worker_info, FetchHandlerExistence in_fetch_handler_existence,
    ::mojo::PendingReceiver<::blink::mojom::blink::ReportingObserver> in_reporting_observer_receiver,
    ::blink::mojom::blink::AncestorFrameType in_ancestor_frame_type, const ::blink::BlinkStorageKey& in_storage_key)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorker::InitializeGlobalScope", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("ancestor_frame_type"), in_ancestor_frame_type, "<value of type ::blink::mojom::blink::AncestorFrameType>");
    ...
    ::blink::mojom::blink::BackgroundFetchRegistrationPtr in_registration, DispatchBackgroundFetchAbortEventCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorker::DispatchBackgroundFetchAbortEvent", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("registration"), in_registration, "<value of type ::blink::mojom::blink::BackgroundFetchRegistrationPtr>");
    });
#endif
    ...
    ::blink::mojom::blink::PushSubscriptionPtr in_new_subscription, DispatchPushSubscriptionChangeEventCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorker::DispatchPushSubscriptionChangeEvent", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("old_subscription"), in_old_subscription, "<value of type ::blink::mojom::blink::PushSubscriptionPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("new_subscription"), in_new_subscription, "<value of type ::blink::mojom::blink::PushSubscriptionPtr>");
    });
#endif
    ...
    ::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> in_result_of_can_make_payment, DispatchCanMakePaymentEventCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorker::DispatchCanMakePaymentEvent", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("event_data"), in_event_data, "<value of type ::payments::mojom::blink::CanMakePaymentEventDataPtr>");
    ...
    ::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> in_response_callback, DispatchPaymentRequestEventCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorker::DispatchPaymentRequestEvent", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("request_data"), in_request_data, "<value of type ::payments::mojom::blink::PaymentRequestEventDataPtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("response_callback"), in_response_callback,
            "<value of type ::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback>>");
    });
#endif
...
WTF::Vector<::blink::mojom::blink::ServiceWorkerClientInfoPtr> ServiceWorkerHostAsyncWaiter::GetClients(
...
void ServiceWorkerHostAsyncWaiter::NavigateClient(const WTF::String& client_uuid, const ::blink::KURL& url, bool* out_success,
...
void ServiceWorkerInterceptorForTesting::DispatchCookieChangeEvent(
    ::network::mojom::blink::CookieChangeInfoPtr change, DispatchCookieChangeEventCallback callback)
{
...
void ServiceWorkerInterceptorForTesting::DispatchNotificationClickEvent(const WTF::String& notification_id,
    ::blink::mojom::blink::NotificationDataPtr notification_data, int32_t action_index, const ::WTF::String& reply,
...
void ServiceWorkerInterceptorForTesting::DispatchPushSubscriptionChangeEvent(::blink::mojom::blink::PushSubscriptionPtr old_subscription,
...
void ServiceWorkerInterceptorForTesting::DispatchSyncEvent(
    const WTF::String& tag, bool last_chance, ::base::TimeDelta timeout, DispatchSyncEventCallback callback)
{
...
void ServiceWorkerInterceptorForTesting::DispatchPeriodicSyncEvent(
    const WTF::String& tag, ::base::TimeDelta timeout, DispatchPeriodicSyncEventCallback callback)
{
...
void ServiceWorkerAsyncWaiter::DispatchInstallEvent(::blink::mojom::blink::ServiceWorkerEventStatus* out_status, uint32_t* out_fetch_count)
{
    ...
    proxy_->DispatchInstallEvent(base::BindOnce(
        [](base::RunLoop* loop, ::blink::mojom::blink::ServiceWorkerEventStatus* out_status, uint32_t* out_fetch_count,
            ::blink::mojom::blink::ServiceWorkerEventStatus status, uint32_t fetch_count) {
...
::blink::mojom::blink::ServiceWorkerEventStatus ServiceWorkerAsyncWaiter::DispatchFetchEventForMainResource(
    ::blink::mojom::blink::DispatchFetchEventParamsPtr params,
    ::mojo::PendingRemote<::blink::mojom::blink::ServiceWorkerFetchResponseCallback> response_callback)
{
    ::blink::mojom::blink::ServiceWorkerEventStatus async_wait_result;
...
void ServiceWorkerAsyncWaiter::DispatchNotificationCloseEvent(const WTF::String& notification_id, ::blink::mojom::blink::NotificationDataPtr notification_data,
    ::blink::mojom::blink::ServiceWorkerEventStatus* out_status)
{
    base::RunLoop loop;
...
::blink::mojom::blink::ServiceWorkerEventStatus ServiceWorkerAsyncWaiter::DispatchPaymentRequestEvent(
    ::payments::mojom::blink::PaymentRequestEventDataPtr request_data,
    ::mojo::PendingRemote<::payments::mojom::blink::PaymentHandlerResponseCallback> response_callback)
{
    ::blink::mojom::blink::ServiceWorkerEventStatus async_wait_result;
