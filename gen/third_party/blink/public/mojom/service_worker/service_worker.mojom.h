...
#include "third_party/blink/public/mojom/service_worker/service_worker.mojom-forward.h" // IWYU pragma: export
...
class BLINK_COMMON_EXPORT ServiceWorkerHost : public ServiceWorkerHostInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT ServiceWorker : public ServiceWorkerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void DispatchFetchEventForMainResource(::blink::mojom::DispatchFetchEventParamsPtr params,
    ...
    virtual void DispatchNotificationClickEvent(const std::string& notification_id, const ::blink::PlatformNotificationData& notification_data,
        int32_t action_index, const std::optional<::std::u16string>& reply, DispatchNotificationClickEventCallback callback)
        = 0;
    ...
    virtual void DispatchPushSubscriptionChangeEvent(::blink::mojom::PushSubscriptionPtr old_subscription, ::blink::mojom::PushSubscriptionPtr new_subscription,
    ...
    virtual void DispatchCanMakePaymentEvent(::payments::mojom::CanMakePaymentEventDataPtr event_data,
    ...
    virtual void DispatchPaymentRequestEvent(::payments::mojom::PaymentRequestEventDataPtr request_data,
...
//class BLINK_COMMON_EXPORT ServiceWorkerHostProxy : public ServiceWorkerHost {
//public:
...
//class BLINK_COMMON_EXPORT ServiceWorkerProxy : public ServiceWorker {
//public:
...
//        ::blink::mojom::ServiceWorkerRegistrationObjectInfoPtr registration_info, ::blink::mojom::ServiceWorkerObjectInfoPtr service_worker_info,
//        FetchHandlerExistence fetch_handler_existence, ::mojo::PendingReceiver<::blink::mojom::ReportingObserver> reporting_observer_receiver,
//        ::blink::mojom::AncestorFrameType ancestor_frame_type, const ::blink::StorageKey& storage_key) final;
//
...
//        ::blink::mojom::BackgroundFetchRegistrationPtr registration, DispatchBackgroundFetchAbortEventCallback callback) final;
//
//    void DispatchBackgroundFetchClickEvent(
//        ::blink::mojom::BackgroundFetchRegistrationPtr registration, DispatchBackgroundFetchClickEventCallback callback) final;
//
...
//        ::blink::mojom::BackgroundFetchRegistrationPtr registration, DispatchBackgroundFetchSuccessEventCallback callback) final;
//
...
//        ::mojo::PendingRemote<::blink::mojom::ServiceWorkerFetchResponseCallback> response_callback, DispatchFetchEventForMainResourceCallback callback) final;
//
...
//        const std::optional<::std::u16string>& reply, DispatchNotificationClickEventCallback callback) final;
//
//    void DispatchNotificationCloseEvent(
//        const std::string& notification_id, const ::blink::PlatformNotificationData& notification_data, DispatchNotificationCloseEventCallback callback) final;
//
...
//        DispatchPushSubscriptionChangeEventCallback callback) final;
//
...
//        ::mojo::PendingRemote<::payments::mojom::PaymentHandlerResponseCallback> result_of_abort_payment, DispatchAbortPaymentEventCallback callback) final;
//
...
//        ::mojo::PendingRemote<::payments::mojom::PaymentHandlerResponseCallback> response_callback, DispatchPaymentRequestEventCallback callback) final;
//
...
//
//    void ExecuteScriptForTest(const ::std::u16string& javascript, bool wants_result, ExecuteScriptForTestCallback callback) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};
    ...
    , source_info_for_service_worker()
{
    ...
    ExtendableMessageEvent(::blink::TransferableMessage message_in, const ::url::Origin& source_origin_in,
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ExtendableMessageEvent::DataView, ::blink::mojom::ExtendableMessageEventPtr> {
    static bool IsNull(const ::blink::mojom::ExtendableMessageEventPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::ExtendableMessageEventPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::ExtendableMessageEvent::message)& message(::blink::mojom::ExtendableMessageEventPtr& input)
    {
        return input->message;
    }

    static const decltype(::blink::mojom::ExtendableMessageEvent::source_origin)& source_origin(const ::blink::mojom::ExtendableMessageEventPtr& input)
    {
