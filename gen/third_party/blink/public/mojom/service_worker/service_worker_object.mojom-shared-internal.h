...
static_assert(sizeof(ServiceWorkerObjectInfo_Data) == 40, "Bad sizeof(ServiceWorkerObjectInfo_Data)");
// Used by ServiceWorkerObjectInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct ServiceWorkerObjectInfo_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    ServiceWorkerObjectInfo_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag ServiceWorkerObjectInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
