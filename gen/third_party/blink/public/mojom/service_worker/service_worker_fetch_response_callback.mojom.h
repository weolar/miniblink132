...
class BLINK_COMMON_EXPORT ServiceWorkerFetchResponseCallback : public ServiceWorkerFetchResponseCallbackInterfaceBase {
public:
...
//class BLINK_COMMON_EXPORT ServiceWorkerFetchResponseCallbackProxy : public ServiceWorkerFetchResponseCallback {
//public:
    ...
    , respond_with_settled_time()
{
    ...
    {
        return mojo::internal::SerializeImpl<ServiceWorkerFetchEventTiming::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ServiceWorkerFetchEventTiming::DataView, ::blink::mojom::ServiceWorkerFetchEventTimingPtr> {
    static bool IsNull(const ::blink::mojom::ServiceWorkerFetchEventTimingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::ServiceWorkerFetchEventTimingPtr* output)
    {
        output->reset();
    }
