...
using EmbeddedWorkerInstanceClientInterfaceBase = EmbeddedWorkerInstanceClientInterfaceBase;
using EmbeddedWorkerInstanceHostInterfaceBase = EmbeddedWorkerInstanceHostInterfaceBase;
