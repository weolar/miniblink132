...
class BLINK_COMMON_EXPORT EmbeddedWorkerInstanceClient : public EmbeddedWorkerInstanceClientInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT EmbeddedWorkerInstanceHost : public EmbeddedWorkerInstanceHostInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void OnStarted(::blink::mojom::ServiceWorkerStartStatus status, ::blink::mojom::ServiceWorkerFetchHandlerType fetch_handler_type,
        bool has_hid_event_handlers, bool has_usb_event_handlers, int32_t thread_id, EmbeddedWorkerStartTimingPtr start_timing)
        = 0;

    virtual void OnReportException(const ::std::u16string& error_message, int32_t line_number, int32_t column_number, const ::GURL& source_url) = 0;

    virtual void OnReportConsoleMessage(::blink::mojom::ConsoleMessageSource source, ::blink::mojom::ConsoleMessageLevel message_level,
        const ::std::u16string& message, int32_t line_number, const ::GURL& source_url)
        = 0;

    virtual void OnStopped() = 0;
};

//class BLINK_COMMON_EXPORT EmbeddedWorkerInstanceClientProxy : public EmbeddedWorkerInstanceClient {
//public:
...
//class BLINK_COMMON_EXPORT EmbeddedWorkerInstanceHostProxy : public EmbeddedWorkerInstanceHost {
//public:
...
//        ::mojo::PendingRemote<::blink::mojom::DevToolsAgent> agent, ::mojo::PendingReceiver<::blink::mojom::DevToolsAgentHost> agent_host) final;
//
...
//
//    void OnReportException(const ::std::u16string& error_message, int32_t line_number, int32_t column_number, const ::GURL& source_url) final;
//
...
//        int32_t line_number, const ::GURL& source_url) final;
//
    ...
    , cors_exempt_header_list()
{
    ...
    EmbeddedWorkerStartParams(int64_t service_worker_version_id_in, const ::GURL& scope_in, const ::GURL& script_url_in,
    ...
    std::vector<std::string> forced_enabled_runtime_features;

    ::mojo::PendingReceiver<::blink::mojom::ServiceWorker> service_worker_receiver;

    ::mojo::PendingReceiver<::service_manager::mojom::InterfaceProvider> interface_provider;
    ...
    , script_evaluation_end_time()
{
    ...
    {
        return mojo::internal::SerializeImpl<EmbeddedWorkerStartTiming::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::EmbeddedWorkerStartParams::DataView, ::blink::mojom::EmbeddedWorkerStartParamsPtr> {
    static bool IsNull(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::EmbeddedWorkerStartParamsPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::blink::mojom::EmbeddedWorkerStartParams::scope)& scope(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->scope;
    }

    static const decltype(::blink::mojom::EmbeddedWorkerStartParams::script_url)& script_url(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->script_url;
    }

    static decltype(::blink::mojom::EmbeddedWorkerStartParams::script_type) script_type(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::EmbeddedWorkerStartParams::user_agent)& user_agent(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->user_agent;
    }

    static const decltype(::blink::mojom::EmbeddedWorkerStartParams::ua_metadata)& ua_metadata(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::EmbeddedWorkerStartParams::wait_for_debugger) wait_for_debugger(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->wait_for_debugger;
    }

    static decltype(::blink::mojom::EmbeddedWorkerStartParams::is_installed) is_installed(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static const decltype(::blink::mojom::EmbeddedWorkerStartParams::forced_enabled_runtime_features)& forced_enabled_runtime_features(
        const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::EmbeddedWorkerStartParams::interface_provider)& interface_provider(::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->interface_provider;
    }

    static decltype(::blink::mojom::EmbeddedWorkerStartParams::controller_receiver)& controller_receiver(::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::EmbeddedWorkerStartParams::instance_host)& instance_host(::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->instance_host;
    }

    static decltype(::blink::mojom::EmbeddedWorkerStartParams::provider_info)& provider_info(::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
    ...
    static decltype(::blink::mojom::EmbeddedWorkerStartParams::ukm_source_id) ukm_source_id(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->ukm_source_id;
    }

    static decltype(::blink::mojom::EmbeddedWorkerStartParams::main_script_load_params)& main_script_load_params(
        ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->main_script_load_params;
    }

    static decltype(::blink::mojom::EmbeddedWorkerStartParams::policy_container)& policy_container(::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->policy_container;
    }

    static const decltype(::blink::mojom::EmbeddedWorkerStartParams::storage_key)& storage_key(const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
        return input->storage_key;
    }

    static const decltype(::blink::mojom::EmbeddedWorkerStartParams::cors_exempt_header_list)& cors_exempt_header_list(
        const ::blink::mojom::EmbeddedWorkerStartParamsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::EmbeddedWorkerStartTiming::DataView, ::blink::mojom::EmbeddedWorkerStartTimingPtr> {
    static bool IsNull(const ::blink::mojom::EmbeddedWorkerStartTimingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::EmbeddedWorkerStartTimingPtr* output)
    {
        output->reset();
    }
