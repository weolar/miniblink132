...
EmbeddedWorkerStartParams::EmbeddedWorkerStartParams(int64_t service_worker_version_id_in, const ::GURL& scope_in, const ::GURL& script_url_in,
    ::blink::mojom::ScriptType script_type_in, ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object_in,
    const std::string& user_agent_in, const ::blink::UserAgentMetadata& ua_metadata_in, int32_t service_worker_route_id_in,
    const ::base::UnguessableToken& devtools_worker_token_in, const ::GURL& script_url_to_skip_throttling_in, bool wait_for_debugger_in, bool is_installed_in,
    const ::blink::RendererPreferences& renderer_preferences_in, std::vector<std::string> forced_enabled_runtime_features_in,
    ...
    ::mojo::PendingAssociatedRemote<EmbeddedWorkerInstanceHost> instance_host_in, ::blink::mojom::ServiceWorkerProviderInfoForStartWorkerPtr provider_info_in,
    ...
    ::mojo::PendingReceiver<::blink::mojom::SubresourceLoaderUpdater> subresource_loader_updater_in, const ::blink::ServiceWorkerToken& service_worker_token_in,
    int64_t ukm_source_id_in, ::blink::mojom::WorkerMainScriptLoadParamsPtr main_script_load_params_in, ::blink::mojom::PolicyContainerPtr policy_container_in,
    const ::blink::StorageKey& storage_key_in, std::vector<std::string> cors_exempt_header_list_in)
...
void EmbeddedWorkerInstanceHostProxy::CountFeature(::blink::mojom::WebFeature in_feature)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void EmbeddedWorkerInstanceHostProxy::OnStarted(::blink::mojom::ServiceWorkerStartStatus in_status,
    ::blink::mojom::ServiceWorkerFetchHandlerType in_fetch_handler_type, bool in_has_hid_event_handlers, bool in_has_usb_event_handlers, int32_t in_thread_id,
    EmbeddedWorkerStartTimingPtr in_start_timing)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::EmbeddedWorkerInstanceHost::OnStarted", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("status"), in_status, "<value of type ::blink::mojom::ServiceWorkerStartStatus>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("fetch_handler_type"), in_fetch_handler_type, "<value of type ::blink::mojom::ServiceWorkerFetchHandlerType>");
    ...
    const ::std::u16string& in_error_message, int32_t in_line_number, int32_t in_column_number, const ::GURL& in_source_url)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::EmbeddedWorkerInstanceHost::OnReportException", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error_message"), in_error_message, "<value of type const ::std::u16string&>");
...
void EmbeddedWorkerInstanceHostProxy::OnReportConsoleMessage(::blink::mojom::ConsoleMessageSource in_source,
    ::blink::mojom::ConsoleMessageLevel in_message_level, const ::std::u16string& in_message, int32_t in_line_number, const ::GURL& in_source_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::EmbeddedWorkerInstanceHost::OnReportConsoleMessage", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("source"), in_source, "<value of type ::blink::mojom::ConsoleMessageSource>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("message_level"), in_message_level, "<value of type ::blink::mojom::ConsoleMessageLevel>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("message"), in_message, "<value of type const ::std::u16string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("line_number"), in_line_number, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("source_url"), in_source_url, "<value of type const ::GURL&>");
    });
#endif
...
bool StructTraits<::blink::mojom::EmbeddedWorkerStartParams::DataView, ::blink::mojom::EmbeddedWorkerStartParamsPtr>::Read(
    ::blink::mojom::EmbeddedWorkerStartParams::DataView input, ::blink::mojom::EmbeddedWorkerStartParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::EmbeddedWorkerStartTiming::DataView, ::blink::mojom::EmbeddedWorkerStartTimingPtr>::Read(
    ::blink::mojom::EmbeddedWorkerStartTiming::DataView input, ::blink::mojom::EmbeddedWorkerStartTimingPtr* output)
{
    bool success = true;
...
void EmbeddedWorkerInstanceHostInterceptorForTesting::OnStarted(::blink::mojom::ServiceWorkerStartStatus status,
    ::blink::mojom::ServiceWorkerFetchHandlerType fetch_handler_type, bool has_hid_event_handlers, bool has_usb_event_handlers, int32_t thread_id,
...
void EmbeddedWorkerInstanceHostInterceptorForTesting::OnReportException(
    const ::std::u16string& error_message, int32_t line_number, int32_t column_number, const ::GURL& source_url)
{
...
void EmbeddedWorkerInstanceHostInterceptorForTesting::OnReportConsoleMessage(::blink::mojom::ConsoleMessageSource source,
    ::blink::mojom::ConsoleMessageLevel message_level, const ::std::u16string& message, int32_t line_number, const ::GURL& source_url)
{
