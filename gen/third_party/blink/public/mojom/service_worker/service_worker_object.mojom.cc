...
ServiceWorkerObjectInfo::ServiceWorkerObjectInfo(int64_t version_id_in, ::blink::mojom::ServiceWorkerState state_in, const ::GURL& url_in,
...
void ServiceWorkerObjectHostProxy::PostMessageToServiceWorker(::blink::TransferableMessage in_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ServiceWorkerObjectProxy::StateChanged(::blink::mojom::ServiceWorkerState in_state)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ServiceWorkerObject::StateChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("state"), in_state, "<value of type ::blink::mojom::ServiceWorkerState>");
    });
#endif
...
bool StructTraits<::blink::mojom::ServiceWorkerObjectInfo::DataView, ::blink::mojom::ServiceWorkerObjectInfoPtr>::Read(
    ::blink::mojom::ServiceWorkerObjectInfo::DataView input, ::blink::mojom::ServiceWorkerObjectInfoPtr* output)
{
    bool success = true;
