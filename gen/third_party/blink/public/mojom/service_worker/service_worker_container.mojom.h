...
#include "third_party/blink/public/mojom/service_worker/service_worker_container.mojom-forward.h" // IWYU pragma: export
...
#include "third_party/blink/public/mojom/service_worker/service_worker_embedded_worker_status.mojom-forward.h"
...
class BLINK_COMMON_EXPORT ServiceWorkerContainerHost : public ServiceWorkerContainerHostInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    using RegisterCallback = base::OnceCallback<void(
        ::blink::mojom::ServiceWorkerErrorType, const std::optional<std::string>&, ::blink::mojom::ServiceWorkerRegistrationObjectInfoPtr)>;

    virtual void Register(const ::GURL& script_url, ::blink::mojom::ServiceWorkerRegistrationOptionsPtr options,
    ...
    using GetRegistrationsCallback = base::OnceCallback<void(::blink::mojom::ServiceWorkerErrorType, const std::optional<std::string>&,
        std::optional<std::vector<::blink::mojom::ServiceWorkerRegistrationObjectInfoPtr>>)>;
...
class BLINK_COMMON_EXPORT ServiceWorkerContainer : public ServiceWorkerContainerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT ServiceWorkerContainerHostProxy : public ServiceWorkerContainerHost {
//public:
...
//
//    void Register(const ::GURL& script_url, ::blink::mojom::ServiceWorkerRegistrationOptionsPtr options,
//        ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, RegisterCallback callback) final;
//
...
//class BLINK_COMMON_EXPORT ServiceWorkerContainerProxy : public ServiceWorkerContainer {
//public:
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ServiceWorkerContainerInfoForClient::DataView, ::blink::mojom::ServiceWorkerContainerInfoForClientPtr> {
    static bool IsNull(const ::blink::mojom::ServiceWorkerContainerInfoForClientPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::ServiceWorkerContainerInfoForClientPtr* output)
    {
        output->reset();
    }
