// third_party/blink/public/mojom/service_worker/service_worker_fetch_response_callback.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class ServiceWorkerFetchResponseCallback : uint32_t {
    kOnResponse = 0,
    kOnResponseStream = 1,
    kOnFallback = 2,
};
