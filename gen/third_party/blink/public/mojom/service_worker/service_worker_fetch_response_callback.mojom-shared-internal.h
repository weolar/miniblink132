// third_party/blink/public/mojom/service_worker/service_worker_fetch_response_callback.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<ServiceWorkerFetchEventTiming_Data>;

    ServiceWorkerFetchEventTiming_Data();
    ~ServiceWorkerFetchEventTiming_Data() = delete;
};
static_assert(sizeof(ServiceWorkerFetchEventTiming_Data) == 24, "Bad sizeof(ServiceWorkerFetchEventTiming_Data)");
// Used by ServiceWorkerFetchEventTiming::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct ServiceWorkerFetchEventTiming_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    ServiceWorkerFetchEventTiming_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<ServiceWorkerFetchEventTiming_Data> fragment(message);
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag ServiceWorkerFetchEventTiming_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
