...
ServiceWorkerScriptInfo::ServiceWorkerScriptInfo(const ::GURL& script_url_in, const std::string& encoding_in,
...
void ServiceWorkerInstalledScriptsManagerHostProxy::RequestInstalledScript(const ::GURL& in_script_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
bool StructTraits<::blink::mojom::ServiceWorkerInstalledScriptsInfo::DataView, ::blink::mojom::ServiceWorkerInstalledScriptsInfoPtr>::Read(
    ::blink::mojom::ServiceWorkerInstalledScriptsInfo::DataView input, ::blink::mojom::ServiceWorkerInstalledScriptsInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::ServiceWorkerScriptInfo::DataView, ::blink::mojom::ServiceWorkerScriptInfoPtr>::Read(
    ::blink::mojom::ServiceWorkerScriptInfo::DataView input, ::blink::mojom::ServiceWorkerScriptInfoPtr* output)
{
    bool success = true;
