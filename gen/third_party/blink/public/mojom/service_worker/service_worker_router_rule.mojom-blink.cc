// third_party/blink/public/mojom/service_worker/service_worker_router_rule.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/service_worker/service_worker_router_rule.mojom-blink-import-headers.h"
#include "third_party/blink/public/mojom/service_worker/service_worker_router_rule.mojom-blink-test-utils.h"
...
ServiceWorkerRouterRequestCondition::ServiceWorkerRouterRequestCondition(const WTF::String& method_in, bool has_mode_in,
...
ServiceWorkerRouterOrCondition::ServiceWorkerRouterOrCondition(WTF::Vector<ServiceWorkerRouterConditionPtr> conditions_in)
...
ServiceWorkerRouterCacheSource::ServiceWorkerRouterCacheSource(const WTF::String& cache_name_in)
...
ServiceWorkerRouterRule::ServiceWorkerRouterRule(ServiceWorkerRouterConditionPtr condition_in, WTF::Vector<ServiceWorkerRouterSourcePtr> sources_in)
    : condition(std::move(condition_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<ServiceWorkerRouterSourcePtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
ServiceWorkerRouterRules::ServiceWorkerRouterRules(WTF::Vector<ServiceWorkerRouterRulePtr> rules_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<ServiceWorkerRouterRulePtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterRunningStatusCondition::DataView,
    ::blink::mojom::blink::ServiceWorkerRouterRunningStatusConditionPtr>::Read(::blink::mojom::blink::ServiceWorkerRouterRunningStatusCondition::DataView input,
    ::blink::mojom::blink::ServiceWorkerRouterRunningStatusConditionPtr* output)
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterRunningStatusConditionPtr result(::blink::mojom::blink::ServiceWorkerRouterRunningStatusCondition::New());
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterRequestCondition::DataView, ::blink::mojom::blink::ServiceWorkerRouterRequestConditionPtr>::Read(
...
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterRequestConditionPtr result(::blink::mojom::blink::ServiceWorkerRouterRequestCondition::New());
...
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterOrCondition::DataView, ::blink::mojom::blink::ServiceWorkerRouterOrConditionPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterOrCondition::DataView input, ::blink::mojom::blink::ServiceWorkerRouterOrConditionPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterNotCondition::DataView, ::blink::mojom::blink::ServiceWorkerRouterNotConditionPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterNotCondition::DataView input, ::blink::mojom::blink::ServiceWorkerRouterNotConditionPtr* output)
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterNotConditionPtr result(::blink::mojom::blink::ServiceWorkerRouterNotCondition::New());
...
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterCondition::DataView, ::blink::mojom::blink::ServiceWorkerRouterConditionPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterCondition::DataView input, ::blink::mojom::blink::ServiceWorkerRouterConditionPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterNetworkSource::DataView, ::blink::mojom::blink::ServiceWorkerRouterNetworkSourcePtr>::Read(
...
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterNetworkSourcePtr result(::blink::mojom::blink::ServiceWorkerRouterNetworkSource::New());
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterRaceSource::DataView, ::blink::mojom::blink::ServiceWorkerRouterRaceSourcePtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterRaceSource::DataView input, ::blink::mojom::blink::ServiceWorkerRouterRaceSourcePtr* output)
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterRaceSourcePtr result(::blink::mojom::blink::ServiceWorkerRouterRaceSource::New());
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterFetchEventSource::DataView, ::blink::mojom::blink::ServiceWorkerRouterFetchEventSourcePtr>::Read(
...
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterFetchEventSourcePtr result(::blink::mojom::blink::ServiceWorkerRouterFetchEventSource::New());
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterCacheSource::DataView, ::blink::mojom::blink::ServiceWorkerRouterCacheSourcePtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterCacheSource::DataView input, ::blink::mojom::blink::ServiceWorkerRouterCacheSourcePtr* output)
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterCacheSourcePtr result(::blink::mojom::blink::ServiceWorkerRouterCacheSource::New());
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterRule::DataView, ::blink::mojom::blink::ServiceWorkerRouterRulePtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterRule::DataView input, ::blink::mojom::blink::ServiceWorkerRouterRulePtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterRules::DataView, ::blink::mojom::blink::ServiceWorkerRouterRulesPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterRules::DataView input, ::blink::mojom::blink::ServiceWorkerRouterRulesPtr* output)
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterRulesPtr result(::blink::mojom::blink::ServiceWorkerRouterRules::New());
...
// static
bool UnionTraits<::blink::mojom::blink::ServiceWorkerRouterSource::DataView, ::blink::mojom::blink::ServiceWorkerRouterSourcePtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterSource::DataView input, ::blink::mojom::blink::ServiceWorkerRouterSourcePtr* output)
{
    using UnionType = ::blink::mojom::blink::ServiceWorkerRouterSource;
    using Tag = UnionType::Tag;

    switch (input.tag()) {
    case Tag::kNetworkSource: {
        ::blink::mojom::blink::ServiceWorkerRouterNetworkSourcePtr result_network_source;
    ...
    case Tag::kRaceSource: {
        ::blink::mojom::blink::ServiceWorkerRouterRaceSourcePtr result_race_source;
    ...
    case Tag::kFetchEventSource: {
        ::blink::mojom::blink::ServiceWorkerRouterFetchEventSourcePtr result_fetch_event_source;
    ...
    case Tag::kCacheSource: {
        ::blink::mojom::blink::ServiceWorkerRouterCacheSourcePtr result_cache_source;
