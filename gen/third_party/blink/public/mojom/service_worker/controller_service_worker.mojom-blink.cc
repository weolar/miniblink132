// third_party/blink/public/mojom/service_worker/controller_service_worker.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::ServiceWorkerRunningStatusCallback>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
ControllerServiceWorkerInfo::ControllerServiceWorkerInfo(::blink::mojom::blink::ControllerServiceWorkerMode mode_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::blink::mojom::blink::ControllerServiceWorkerMode>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::blink::mojom::blink::ServiceWorkerFetchHandlerBypassOption>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void ControllerServiceWorkerProxy::DispatchFetchEventForSubresource(::blink::mojom::blink::DispatchFetchEventParamsPtr in_params,
    ::mojo::PendingRemote<::blink::mojom::blink::ServiceWorkerFetchResponseCallback> in_response_callback, DispatchFetchEventForSubresourceCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void ControllerServiceWorkerProxy::Clone(::mojo::PendingReceiver<ControllerServiceWorker> in_receiver,
    ...
    ::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter> in_coep_reporter)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ControllerServiceWorker::Clone", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("coep_reporter"), in_coep_reporter,
...
void ControllerServiceWorker_DispatchFetchEventForSubresource_ProxyToResponder::Run(::blink::mojom::blink::ServiceWorkerEventStatus in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool ControllerServiceWorkerStubDispatch::Accept(ControllerServiceWorker* impl, mojo::Message* message)
{
    ...
    case messages::ControllerServiceWorker::kClone: {
        ...
        ::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter> p_coep_reporter {};
...
{
    const char* name = ::blink::mojom::blink::ControllerServiceWorker::Name_;
...
{
    const char* name = ::blink::mojom::blink::ControllerServiceWorkerConnector::Name_;
...
// static
bool StructTraits<::blink::mojom::blink::ServiceWorkerRouterData::DataView, ::blink::mojom::blink::ServiceWorkerRouterDataPtr>::Read(
    ::blink::mojom::blink::ServiceWorkerRouterData::DataView input, ::blink::mojom::blink::ServiceWorkerRouterDataPtr* output)
{
    bool success = true;
    ::blink::mojom::blink::ServiceWorkerRouterDataPtr result(::blink::mojom::blink::ServiceWorkerRouterData::New());
...
bool StructTraits<::blink::mojom::blink::ControllerServiceWorkerInfo::DataView, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr>::Read(
    ::blink::mojom::blink::ControllerServiceWorkerInfo::DataView input, ::blink::mojom::blink::ControllerServiceWorkerInfoPtr* output)
{
    bool success = true;
...
void ControllerServiceWorkerInterceptorForTesting::DispatchFetchEventForSubresource(::blink::mojom::blink::DispatchFetchEventParamsPtr params,
...
void ControllerServiceWorkerAsyncWaiter::DispatchFetchEventForSubresource(::blink::mojom::blink::DispatchFetchEventParamsPtr params,
...
::blink::mojom::blink::ServiceWorkerEventStatus ControllerServiceWorkerAsyncWaiter::DispatchFetchEventForSubresource(
