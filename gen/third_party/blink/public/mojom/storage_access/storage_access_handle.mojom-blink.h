...
class MODULES_EXPORT StorageAccessHandle : public StorageAccessHandleInterfaceBase {
public:
...
class MODULES_EXPORT StorageAccessHandleProxy : public StorageAccessHandle {
public:
