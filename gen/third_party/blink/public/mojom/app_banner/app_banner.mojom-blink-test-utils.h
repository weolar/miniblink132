// third_party/blink/public/mojom/app_banner/app_banner.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT AppBannerControllerInterceptorForTesting : public AppBannerController {
    ...
    void BannerPromptRequest(::mojo::PendingRemote<AppBannerService> service, ::mojo::PendingReceiver<AppBannerEvent> event_receiver,
        const WTF::Vector<WTF::String>& platform, BannerPromptRequestCallback callback) override;
};
class PLATFORM_EXPORT AppBannerControllerAsyncWaiter {
public:
    explicit AppBannerControllerAsyncWaiter(AppBannerController* proxy);

    AppBannerControllerAsyncWaiter(const AppBannerControllerAsyncWaiter&) = delete;
    AppBannerControllerAsyncWaiter& operator=(const AppBannerControllerAsyncWaiter&) = delete;

    ~AppBannerControllerAsyncWaiter();
    void BannerPromptRequest(::mojo::PendingRemote<AppBannerService> service, ::mojo::PendingReceiver<AppBannerEvent> event_receiver,
        const WTF::Vector<WTF::String>& platform, AppBannerPromptReply* out_reply);
    AppBannerPromptReply BannerPromptRequest(
...
public:
    ...
    AppBannerEventAsyncWaiter(const AppBannerEventAsyncWaiter&) = delete;
    AppBannerEventAsyncWaiter& operator=(const AppBannerEventAsyncWaiter&) = delete;
...
public:
    ...
    AppBannerServiceAsyncWaiter(const AppBannerServiceAsyncWaiter&) = delete;
    AppBannerServiceAsyncWaiter& operator=(const AppBannerServiceAsyncWaiter&) = delete;
