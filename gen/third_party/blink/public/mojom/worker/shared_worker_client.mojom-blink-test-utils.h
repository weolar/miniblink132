// third_party/blink/public/mojom/worker/shared_worker_client.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
public:
    ...
    SharedWorkerClientAsyncWaiter(const SharedWorkerClientAsyncWaiter&) = delete;
    SharedWorkerClientAsyncWaiter& operator=(const SharedWorkerClientAsyncWaiter&) = delete;
