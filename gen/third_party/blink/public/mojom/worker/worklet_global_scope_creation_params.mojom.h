...
class BLINK_COMMON_EXPORT WorkletDevToolsHost : public WorkletDevToolsHostInterfaceBase {
public:
...
//class BLINK_COMMON_EXPORT WorkletDevToolsHostProxy : public WorkletDevToolsHost {
//public:
    ...
    , wait_for_debugger()
{
    ...
    WorkletGlobalScopeCreationParams(const ::GURL& script_url_in, const ::url::Origin& starter_origin_in,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WorkletGlobalScopeCreationParams::DataView, ::blink::mojom::WorkletGlobalScopeCreationParamsPtr> {
    static bool IsNull(const ::blink::mojom::WorkletGlobalScopeCreationParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::WorkletGlobalScopeCreationParamsPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::blink::mojom::WorkletGlobalScopeCreationParams::devtools_host)& devtools_host(::blink::mojom::WorkletGlobalScopeCreationParamsPtr& input)
    {
