// third_party/blink/public/mojom/worker/shared_worker_connector.mojom-blink-forward.h is auto generated by mojom_bindings_generator.py, do not edit
...
using SharedWorkerConnectorInterfaceBase = SharedWorkerConnectorInterfaceBase;
