...
// static
bool SharedWorkerConnector_Connect_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const SharedWorkerConnector_Connect_Params_Data* object = static_cast<const SharedWorkerConnector_Connect_Params_Data*>(data);
    ...
    if (!mojo::internal::ValidatePointerNonNullable(object->message_port, 4, validation_context)) {
        return false;
    }
