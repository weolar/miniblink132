// third_party/blink/public/mojom/worker/worker_main_script_load_params.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/worker/worker_main_script_load_params.mojom-blink-test-utils.h"
...
WorkerMainScriptLoadParams::WorkerMainScriptLoadParams(int32_t request_id_in, ::network::mojom::blink::URLResponseHeadPtr response_head_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::network::mojom::blink::URLLoaderClientEndpointsPtr>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::blink::mojom::blink::WorkerMainScriptLoadParams::DataView, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr>::Read(
    ::blink::mojom::blink::WorkerMainScriptLoadParams::DataView input, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr* output)
{
    bool success = true;
