    ...
    , same_site_cookies(SharedWorkerSameSiteCookies::kNone)
{
    ...
    SharedWorkerInfo(const ::blink::KURL& url_in, ::blink::mojom::blink::WorkerOptionsPtr options_in,
    WTF::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policies_in,
    ::blink::mojom::blink::FetchClientSettingsObjectPtr outside_fetch_client_settings_object_in, SharedWorkerSameSiteCookies same_site_cookies_in)
    : url(std::move(url_in))
    ...
    {
        return mojo::internal::SerializeImpl<SharedWorkerInfo::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::SharedWorkerInfo::DataView, ::blink::mojom::blink::SharedWorkerInfoPtr> {
    static bool IsNull(const ::blink::mojom::blink::SharedWorkerInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::SharedWorkerInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::blink::SharedWorkerInfo::url)& url(const ::blink::mojom::blink::SharedWorkerInfoPtr& input)
    {
        return input->url;
    }

    static const decltype(::blink::mojom::blink::SharedWorkerInfo::options)& options(const ::blink::mojom::blink::SharedWorkerInfoPtr& input)
    {
    ...
    static decltype(::blink::mojom::blink::SharedWorkerInfo::same_site_cookies) same_site_cookies(const ::blink::mojom::blink::SharedWorkerInfoPtr& input)
    {
