...
void SharedWorkerClientProxy::OnCreated(::blink::mojom::SharedWorkerCreationContextType in_creation_context_type)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::SharedWorkerClient::OnCreated", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("creation_context_type"), in_creation_context_type, "<value of type ::blink::mojom::SharedWorkerCreationContextType>");
    });
#endif
...
void SharedWorkerClientProxy::OnConnected(const std::vector<::blink::mojom::WebFeature>& in_features_used)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::SharedWorkerClient::OnConnected", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("features_used"), in_features_used, "<value of type const std::vector<::blink::mojom::WebFeature>&>");
    });
#endif
...
void SharedWorkerClientProxy::OnScriptLoadFailed(const std::string& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void SharedWorkerClientProxy::OnFeatureUsed(::blink::mojom::WebFeature in_feature)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void SharedWorkerClientInterceptorForTesting::OnScriptLoadFailed(const std::string& error_message)
{
