    ...
    , redirect_response_heads()
{
    ...
    WorkerMainScriptLoadParams(int32_t request_id_in, ::network::mojom::blink::URLResponseHeadPtr response_head_in,
    ::mojo::ScopedDataPipeConsumerHandle response_body_in, ::network::mojom::blink::URLLoaderClientEndpointsPtr url_loader_client_endpoints_in,
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WorkerMainScriptLoadParams::DataView, ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr> {
    static bool IsNull(const ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::WorkerMainScriptLoadParamsPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::blink::WorkerMainScriptLoadParams::request_id) request_id(const ::blink::mojom::blink::WorkerMainScriptLoadParamsPtr& input)
    {
