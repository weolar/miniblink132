...
void SharedWorkerHostProxy::OnScriptLoadFailed(const WTF::String& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void SharedWorkerHostProxy::OnFeatureUsed(::blink::mojom::blink::WebFeature in_feature)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
