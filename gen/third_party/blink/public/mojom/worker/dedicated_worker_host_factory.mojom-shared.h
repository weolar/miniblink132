// third_party/blink/public/mojom/worker/dedicated_worker_host_factory.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
using DedicatedWorkerHostFactoryClientPtrDataView = mojo::InterfacePtrDataView<DedicatedWorkerHostFactoryClientInterfaceBase>;
using DedicatedWorkerHostFactoryClientRequestDataView = mojo::InterfaceRequestDataView<DedicatedWorkerHostFactoryClientInterfaceBase>;
using DedicatedWorkerHostFactoryClientAssociatedPtrInfoDataView = mojo::AssociatedInterfacePtrInfoDataView<DedicatedWorkerHostFactoryClientInterfaceBase>;
using DedicatedWorkerHostFactoryClientAssociatedRequestDataView = mojo::AssociatedInterfaceRequestDataView<DedicatedWorkerHostFactoryClientInterfaceBase>;
class DedicatedWorkerHostFactoryInterfaceBase { };

using DedicatedWorkerHostFactoryPtrDataView = mojo::InterfacePtrDataView<DedicatedWorkerHostFactoryInterfaceBase>;
using DedicatedWorkerHostFactoryRequestDataView = mojo::InterfaceRequestDataView<DedicatedWorkerHostFactoryInterfaceBase>;
using DedicatedWorkerHostFactoryAssociatedPtrInfoDataView = mojo::AssociatedInterfacePtrInfoDataView<DedicatedWorkerHostFactoryInterfaceBase>;
using DedicatedWorkerHostFactoryAssociatedRequestDataView = mojo::AssociatedInterfaceRequestDataView<DedicatedWorkerHostFactoryInterfaceBase>;
