// third_party/blink/public/mojom/worker/shared_worker_factory.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
using SharedWorkerFactoryPtrDataView = mojo::InterfacePtrDataView<SharedWorkerFactoryInterfaceBase>;
using SharedWorkerFactoryRequestDataView = mojo::InterfaceRequestDataView<SharedWorkerFactoryInterfaceBase>;
using SharedWorkerFactoryAssociatedPtrInfoDataView = mojo::AssociatedInterfacePtrInfoDataView<SharedWorkerFactoryInterfaceBase>;
using SharedWorkerFactoryAssociatedRequestDataView = mojo::AssociatedInterfaceRequestDataView<SharedWorkerFactoryInterfaceBase>;
