...
enum class CSSSampleId : int32_t {
    ...
    kMasonryTrackEnd = 802,

    kMasonryTrackStart = 803,

    kMasonryTemplateTracks = 804,
...
{
    return internal::CSSSampleId_Data::IsKnownValue(static_cast<int32_t>(value));
}
...
template <> struct hash<::blink::mojom::CSSSampleId> : public mojo::internal::EnumHashImpl<::blink::mojom::CSSSampleId> { };
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::CSSSampleId, MaybeConstUserType> {
    ...
    {
        return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::CSSSampleId>(input)), output);
    }
};
...
template <> struct COMPONENT_EXPORT(WEB_FEATURE_MOJO_BINDINGS_MOJOM_SHARED) TraceFormatTraits<::blink::mojom::CSSSampleId> {
