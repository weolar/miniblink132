...
enum class WebFeature : int32_t {
    ...
    kBlobStoreAccessAcrossTopLevelSite = 4169,

    kBlobStoreAccessUnknownTopLevelSite = 4170,
...
{
    return internal::WebFeature_Data::IsKnownValue(static_cast<int32_t>(value));
}
...
template <> struct hash<::blink::mojom::WebFeature> : public mojo::internal::EnumHashImpl<::blink::mojom::WebFeature> { };
...
template <typename MaybeConstUserType> struct Serializer<::blink::mojom::WebFeature, MaybeConstUserType> {
    ...
    {
        return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(static_cast<::blink::mojom::WebFeature>(input)), output);
    }
};
...
template <> struct COMPONENT_EXPORT(WEB_FEATURE_MOJO_BINDINGS_MOJOM_SHARED) TraceFormatTraits<::blink::mojom::WebFeature> {
