// third_party/blink/public/mojom/contacts/contacts_manager.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class ContactsManager : uint32_t {
    kSelect = 0,
};
