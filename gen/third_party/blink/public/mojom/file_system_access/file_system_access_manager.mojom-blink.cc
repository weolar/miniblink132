...
AcceptsTypesInfo::AcceptsTypesInfo(WTF::Vector<ChooseFileSystemEntryAcceptsOptionPtr> accepts_in, bool include_accepts_all_in)
...
SaveFilePickerOptions::SaveFilePickerOptions(AcceptsTypesInfoPtr accepts_types_info_in, const WTF::String& suggested_name_in)
    : accepts_types_info(std::move(accepts_types_info_in))
...
FilePickerOptions::FilePickerOptions(TypeSpecificFilePickerOptionsUnionPtr type_specific_options_in, const WTF::String& starting_directory_id_in,
...
void FilePickerStartInOptionsUnion::set_directory_token(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken> directory_token)
{
    if (tag_ == Tag::kDirectoryToken) {
        *(data_.directory_token) = std::move(directory_token);
        ...
        data_.directory_token = new ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>(std::move(directory_token));
    }
}
...
void FileSystemAccessManagerProxy::GetSandboxedFileSystemForDevtools(
    const WTF::Vector<WTF::String>& in_directory_path_components, GetSandboxedFileSystemForDevtoolsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void FileSystemAccessManagerProxy::GetFileHandleFromToken(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken> in_token,
    ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessFileHandle> in_file_handle)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::GetFileHandleFromToken", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("token"), in_token, "<value of type ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("file_handle"), in_file_handle, "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessFileHandle>>");
    });
#endif
...
void FileSystemAccessManagerProxy::GetDirectoryHandleFromToken(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken> in_token,
    ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessDirectoryHandle> in_directory_handle)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::GetDirectoryHandleFromToken", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("token"), in_token, "<value of type ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("directory_handle"), in_directory_handle,
    ...
    ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDataTransferToken> in_token, GetEntryFromDataTransferTokenCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::GetEntryFromDataTransferToken", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("token"), in_token, "<value of type ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDataTransferToken>>");
    });
#endif
...
void FileSystemAccessManagerProxy::BindObserverHost(::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessObserverHost> in_observer_host)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemAccessManager::BindObserverHost", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("observer_host"), in_observer_host, "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessObserverHost>>");
    });
#endif
...
private:
    ...
    void Run(::blink::mojom::blink::FileSystemAccessErrorPtr in_result, WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr> in_entries);
};
    ...
    ::blink::mojom::blink::FileSystemAccessErrorPtr in_result, WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr> in_entries)
{
    ...
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemAccessManager::ChooseEntries", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type ::blink::mojom::blink::FileSystemAccessErrorPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("entries"), in_entries, "<value of type WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr>>");
    });
#endif
...
private:
    ...
    void Run(::blink::mojom::blink::FileSystemAccessErrorPtr in_result, ::blink::mojom::blink::FileSystemAccessEntryPtr in_entry);
};
...
void FileSystemAccessManager_GetEntryFromDataTransferToken_ProxyToResponder::Run(
    ::blink::mojom::blink::FileSystemAccessErrorPtr in_result, ::blink::mojom::blink::FileSystemAccessEntryPtr in_entry)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemAccessManager::GetEntryFromDataTransferToken", "async_response_parameters",
        [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type ::blink::mojom::blink::FileSystemAccessErrorPtr>");
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("entry"), in_entry, "<value of type ::blink::mojom::blink::FileSystemAccessEntryPtr>");
        });
#endif
...
bool StructTraits<::blink::mojom::blink::AcceptsTypesInfo::DataView, ::blink::mojom::blink::AcceptsTypesInfoPtr>::Read(
    ::blink::mojom::blink::AcceptsTypesInfo::DataView input, ::blink::mojom::blink::AcceptsTypesInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::OpenFilePickerOptions::DataView, ::blink::mojom::blink::OpenFilePickerOptionsPtr>::Read(
    ::blink::mojom::blink::OpenFilePickerOptions::DataView input, ::blink::mojom::blink::OpenFilePickerOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::SaveFilePickerOptions::DataView, ::blink::mojom::blink::SaveFilePickerOptionsPtr>::Read(
    ::blink::mojom::blink::SaveFilePickerOptions::DataView input, ::blink::mojom::blink::SaveFilePickerOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::DirectoryPickerOptions::DataView, ::blink::mojom::blink::DirectoryPickerOptionsPtr>::Read(
    ::blink::mojom::blink::DirectoryPickerOptions::DataView input, ::blink::mojom::blink::DirectoryPickerOptionsPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::blink::mojom::blink::FilePickerOptions::DataView, ::blink::mojom::blink::FilePickerOptionsPtr>::Read(
    ::blink::mojom::blink::FilePickerOptions::DataView input, ::blink::mojom::blink::FilePickerOptionsPtr* output)
{
    bool success = true;
    ::blink::mojom::blink::FilePickerOptionsPtr result(::blink::mojom::blink::FilePickerOptions::New());
...
// static
bool UnionTraits<::blink::mojom::blink::TypeSpecificFilePickerOptionsUnion::DataView, ::blink::mojom::blink::TypeSpecificFilePickerOptionsUnionPtr>::Read(
...
{
    using UnionType = ::blink::mojom::blink::TypeSpecificFilePickerOptionsUnion;
...
// static
bool UnionTraits<::blink::mojom::blink::FilePickerStartInOptionsUnion::DataView, ::blink::mojom::blink::FilePickerStartInOptionsUnionPtr>::Read(
    ::blink::mojom::blink::FilePickerStartInOptionsUnion::DataView input, ::blink::mojom::blink::FilePickerStartInOptionsUnionPtr* output)
{
    using UnionType = ::blink::mojom::blink::FilePickerStartInOptionsUnion;
    using Tag = UnionType::Tag;

    switch (input.tag()) {
    case Tag::kWellKnownDirectory: {
        ::blink::mojom::blink::WellKnownDirectory result_well_known_directory;
    ...
    case Tag::kDirectoryToken: {
        *output = UnionType::NewDirectoryToken(input.TakeDirectoryToken<::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>>());
        break;
    }
    default:
...
void FileSystemAccessManagerInterceptorForTesting::GetFileHandleFromToken(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken> token,
...
void FileSystemAccessManagerInterceptorForTesting::GetDirectoryHandleFromToken(
...
void FileSystemAccessManagerInterceptorForTesting::BindObserverHost(::mojo::PendingReceiver<::blink::mojom::blink::FileSystemAccessObserverHost> observer_host)
{
...
void FileSystemAccessManagerAsyncWaiter::GetSandboxedFileSystemForDevtools(const WTF::Vector<WTF::String>& directory_path_components,
    ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result, ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDirectoryHandle>* out_directory)
{
    base::RunLoop loop;
...
void FileSystemAccessManagerAsyncWaiter::ChooseEntries(FilePickerOptionsPtr options, ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result,
    WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr>* out_entries)
{
    ...
    proxy_->ChooseEntries(std::move(options),
        base::BindOnce(
            [](base::RunLoop* loop, ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result,
                WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr>* out_entries, ::blink::mojom::blink::FileSystemAccessErrorPtr result,
                WTF::Vector<::blink::mojom::blink::FileSystemAccessEntryPtr> entries) {
                *out_result = std::move(result);
...
void FileSystemAccessManagerAsyncWaiter::GetEntryFromDataTransferToken(::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDataTransferToken> token,
    ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result, ::blink::mojom::blink::FileSystemAccessEntryPtr* out_entry)
{
    ...
    proxy_->GetEntryFromDataTransferToken(std::move(token),
        base::BindOnce(
            [](base::RunLoop* loop, ::blink::mojom::blink::FileSystemAccessErrorPtr* out_result, ::blink::mojom::blink::FileSystemAccessEntryPtr* out_entry,
                ::blink::mojom::blink::FileSystemAccessErrorPtr result, ::blink::mojom::blink::FileSystemAccessEntryPtr entry) {
                *out_result = std::move(result);
