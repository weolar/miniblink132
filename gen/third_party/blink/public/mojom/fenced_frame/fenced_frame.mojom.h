...
class BLINK_COMMON_EXPORT FencedFrameOwnerHost : public FencedFrameOwnerHostInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void Navigate(const ::GURL& url, ::base::TimeTicks navigation_start_time, const std::optional<::std::u16string>& embedder_shared_storage_context)
        = 0;

    virtual void DidChangeFramePolicy(const ::blink::FramePolicy& frame_policy) = 0;
};

//class BLINK_COMMON_EXPORT FencedFrameOwnerHostProxy : public FencedFrameOwnerHost {
//public:
