...
GetKeyboardLayoutMapResult::GetKeyboardLayoutMapResult(GetKeyboardLayoutMapStatus status_in, const WTF::HashMap<WTF::String, WTF::String>& layout_map_in)
...
void KeyboardLockServiceProxy::RequestKeyboardLock(const WTF::Vector<WTF::String>& in_key_codes, RequestKeyboardLockCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::KeyboardLockService::RequestKeyboardLock", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("key_codes"), in_key_codes, "<value of type const WTF::Vector<WTF::String>&>");
    });
#endif
...
bool StructTraits<::blink::mojom::blink::GetKeyboardLayoutMapResult::DataView, ::blink::mojom::blink::GetKeyboardLayoutMapResultPtr>::Read(
    ::blink::mojom::blink::GetKeyboardLayoutMapResult::DataView input, ::blink::mojom::blink::GetKeyboardLayoutMapResultPtr* output)
{
    bool success = true;
...
void KeyboardLockServiceAsyncWaiter::RequestKeyboardLock(const WTF::Vector<WTF::String>& key_codes, KeyboardLockRequestResult* out_result)
{
    base::RunLoop loop;
...
KeyboardLockRequestResult KeyboardLockServiceAsyncWaiter::RequestKeyboardLock(const WTF::Vector<WTF::String>& key_codes)
{
