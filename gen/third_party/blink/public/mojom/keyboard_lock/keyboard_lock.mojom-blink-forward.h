...
using KeyboardLockRequestResult = KeyboardLockRequestResult;
using GetKeyboardLayoutMapStatus = GetKeyboardLayoutMapStatus;
using KeyboardLockServiceInterfaceBase = KeyboardLockServiceInterfaceBase;
