...
MenuItem::MenuItem(const WTF::String& label_in, const WTF::String& tool_tip_in, MenuItem::Type type_in, uint32_t action_in,
...
void PopupMenuClientProxy::DidAcceptIndices(const WTF::Vector<int32_t>& in_indices)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::PopupMenuClient::DidAcceptIndices", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("indices"), in_indices, "<value of type const WTF::Vector<int32_t>&>");
    });
#endif
...
bool StructTraits<::blink::mojom::blink::MenuItem::DataView, ::blink::mojom::blink::MenuItemPtr>::Read(
    ::blink::mojom::blink::MenuItem::DataView input, ::blink::mojom::blink::MenuItemPtr* output)
{
    bool success = true;
