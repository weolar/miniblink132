...
ColorSuggestion::ColorSuggestion(uint32_t color_in, const WTF::String& label_in)
...
bool StructTraits<::blink::mojom::blink::ColorSuggestion::DataView, ::blink::mojom::blink::ColorSuggestionPtr>::Read(
    ::blink::mojom::blink::ColorSuggestion::DataView input, ::blink::mojom::blink::ColorSuggestionPtr* output)
{
    bool success = true;
