...
void BroadcastChannelProviderProxy::ConnectToChannel(const std::string& in_name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> in_client,
...
void BroadcastChannelProviderInterceptorForTesting::ConnectToChannel(const std::string& name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> client,
