...
DragItemString::DragItemString(const std::string& string_type_in, const ::std::u16string& string_data_in, const std::optional<::std::u16string>& title_in,
...
DragItemBinary::DragItemBinary(::mojo_base::BigBuffer data_in, bool is_image_accessible_in, const ::GURL& source_url_in,
...
DragData::DragData(std::vector<DragItemPtr> items_in, const std::optional<std::string>& file_system_id_in, bool force_default_action_in,
...
DragEventSourceInfo::DragEventSourceInfo(const ::gfx::Point& location_in, ::ui::mojom::DragEventSource source_in)
...
void DragItem::set_file(::blink::mojom::DataTransferFilePtr file)
{
    if (tag_ == Tag::kFile) {
        *(data_.file) = std::move(file);
        ...
        DestroyActive();
        tag_ = Tag::kFile;
        data_.file = new ::blink::mojom::DataTransferFilePtr(std::move(file));
    }
}
...
bool StructTraits<::blink::mojom::AllowedDragOperations::DataView, ::blink::mojom::AllowedDragOperationsPtr>::Read(
    ::blink::mojom::AllowedDragOperations::DataView input, ::blink::mojom::AllowedDragOperationsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::DragItemString::DataView, ::blink::mojom::DragItemStringPtr>::Read(
    ::blink::mojom::DragItemString::DataView input, ::blink::mojom::DragItemStringPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::DragItemBinary::DataView, ::blink::mojom::DragItemBinaryPtr>::Read(
    ::blink::mojom::DragItemBinary::DataView input, ::blink::mojom::DragItemBinaryPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::DragItemFileSystemFile::DataView, ::blink::mojom::DragItemFileSystemFilePtr>::Read(
    ::blink::mojom::DragItemFileSystemFile::DataView input, ::blink::mojom::DragItemFileSystemFilePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::DragData::DataView, ::blink::mojom::DragDataPtr>::Read(
    ::blink::mojom::DragData::DataView input, ::blink::mojom::DragDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::DragEventSourceInfo::DataView, ::blink::mojom::DragEventSourceInfoPtr>::Read(
    ::blink::mojom::DragEventSourceInfo::DataView input, ::blink::mojom::DragEventSourceInfoPtr* output)
{
    bool success = true;
...
bool UnionTraits<::blink::mojom::DragItem::DataView, ::blink::mojom::DragItemPtr>::Read(
    ::blink::mojom::DragItem::DataView input, ::blink::mojom::DragItemPtr* output)
{
