// third_party/blink/public/mojom/mediasession/media_session.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT MediaSessionClientInterceptorForTesting : public MediaSessionClient {
    ...
    void DidReceiveAction(::media_session::mojom::blink::MediaSessionAction action, MediaSessionActionDetailsPtr details) override;
};
class PLATFORM_EXPORT MediaSessionClientAsyncWaiter {
public:
    explicit MediaSessionClientAsyncWaiter(MediaSessionClient* proxy);

    MediaSessionClientAsyncWaiter(const MediaSessionClientAsyncWaiter&) = delete;
    MediaSessionClientAsyncWaiter& operator=(const MediaSessionClientAsyncWaiter&) = delete;
...
class PLATFORM_EXPORT MediaSessionServiceInterceptorForTesting : public MediaSessionService {
    ...
    void SetPositionState(::media_session::mojom::blink::MediaPositionPtr position) override;
    void SetMetadata(SpecMediaMetadataPtr metadata) override;
    void SetMicrophoneState(::media_session::mojom::blink::MicrophoneState microphone_state) override;
    void SetCameraState(::media_session::mojom::blink::CameraState camera_state) override;
...
public:
    ...
    MediaSessionServiceAsyncWaiter(const MediaSessionServiceAsyncWaiter&) = delete;
    MediaSessionServiceAsyncWaiter& operator=(const MediaSessionServiceAsyncWaiter&) = delete;
