...
BackgroundFetchRegistrationData::BackgroundFetchRegistrationData(const WTF::String& developer_id_in, uint64_t upload_total_in, uint64_t uploaded_in,
...
void BackgroundFetchServiceProxy::Fetch(int64_t in_service_worker_registration_id, const WTF::String& in_developer_id,
    WTF::Vector<::blink::mojom::blink::FetchAPIRequestPtr> in_requests, BackgroundFetchOptionsPtr in_options, const ::SkBitmap& in_icon,
    BackgroundFetchUkmDataPtr in_ukm_data, FetchCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::BackgroundFetchService::Fetch", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("developer_id"), in_developer_id, "<value of type const WTF::String&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("requests"), in_requests, "<value of type WTF::Vector<::blink::mojom::blink::FetchAPIRequestPtr>>");
...
private:
    ...
    void Run(BackgroundFetchError in_error, const WTF::Vector<WTF::String>& in_developer_ids);
};
...
void BackgroundFetchService_GetDeveloperIds_ProxyToResponder::Run(BackgroundFetchError in_error, const WTF::Vector<WTF::String>& in_developer_ids)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::BackgroundFetchService::GetDeveloperIds", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error"), in_error, "<value of type BackgroundFetchError>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("developer_ids"), in_developer_ids, "<value of type const WTF::Vector<WTF::String>&>");
    });
#endif
...
void BackgroundFetchRegistrationServiceProxy::UpdateUI(const WTF::String& in_title, const ::SkBitmap& in_icon, UpdateUICallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void BackgroundFetchRegistrationServiceProxy::MatchRequests(::blink::mojom::blink::FetchAPIRequestPtr in_request_to_match,
    ::blink::mojom::blink::CacheQueryOptionsPtr in_cache_query_options, bool in_match_all, MatchRequestsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::BackgroundFetchRegistrationService::MatchRequests", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("request_to_match"), in_request_to_match, "<value of type ::blink::mojom::blink::FetchAPIRequestPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("cache_query_options"), in_cache_query_options, "<value of type ::blink::mojom::blink::CacheQueryOptionsPtr>");
...
private:
    ...
    void Run(WTF::Vector<BackgroundFetchSettledFetchPtr> in_fetches);
};
...
void BackgroundFetchRegistrationService_MatchRequests_ProxyToResponder::Run(WTF::Vector<BackgroundFetchSettledFetchPtr> in_fetches)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply blink::mojom::BackgroundFetchRegistrationService::MatchRequests", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("fetches"), in_fetches, "<value of type WTF::Vector<BackgroundFetchSettledFetchPtr>>");
        });
#endif
...
bool StructTraits<::blink::mojom::blink::BackgroundFetchSettledFetch::DataView, ::blink::mojom::blink::BackgroundFetchSettledFetchPtr>::Read(
    ::blink::mojom::blink::BackgroundFetchSettledFetch::DataView input, ::blink::mojom::blink::BackgroundFetchSettledFetchPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::BackgroundFetchOptions::DataView, ::blink::mojom::blink::BackgroundFetchOptionsPtr>::Read(
    ::blink::mojom::blink::BackgroundFetchOptions::DataView input, ::blink::mojom::blink::BackgroundFetchOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::BackgroundFetchRegistrationData::DataView, ::blink::mojom::blink::BackgroundFetchRegistrationDataPtr>::Read(
    ::blink::mojom::blink::BackgroundFetchRegistrationData::DataView input, ::blink::mojom::blink::BackgroundFetchRegistrationDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::BackgroundFetchRegistration::DataView, ::blink::mojom::blink::BackgroundFetchRegistrationPtr>::Read(
    ::blink::mojom::blink::BackgroundFetchRegistration::DataView input, ::blink::mojom::blink::BackgroundFetchRegistrationPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::BackgroundFetchUkmData::DataView, ::blink::mojom::blink::BackgroundFetchUkmDataPtr>::Read(
    ::blink::mojom::blink::BackgroundFetchUkmData::DataView input, ::blink::mojom::blink::BackgroundFetchUkmDataPtr* output)
{
    bool success = true;
...
void BackgroundFetchRegistrationObserverInterceptorForTesting::OnRequestCompleted(
    ::blink::mojom::blink::FetchAPIRequestPtr request, ::blink::mojom::blink::FetchAPIResponsePtr response)
{
...
void BackgroundFetchServiceInterceptorForTesting::Fetch(int64_t service_worker_registration_id, const WTF::String& developer_id,
    WTF::Vector<::blink::mojom::blink::FetchAPIRequestPtr> requests, BackgroundFetchOptionsPtr options, const ::SkBitmap& icon,
    BackgroundFetchUkmDataPtr ukm_data, FetchCallback callback)
{
...
void BackgroundFetchServiceInterceptorForTesting::GetRegistration(
    int64_t service_worker_registration_id, const WTF::String& developer_id, GetRegistrationCallback callback)
{
...
void BackgroundFetchServiceAsyncWaiter::Fetch(int64_t service_worker_registration_id, const WTF::String& developer_id,
    WTF::Vector<::blink::mojom::blink::FetchAPIRequestPtr> requests, BackgroundFetchOptionsPtr options, const ::SkBitmap& icon,
    BackgroundFetchUkmDataPtr ukm_data, BackgroundFetchError* out_error, BackgroundFetchRegistrationPtr* out_registration)
{
    base::RunLoop loop;
    ...
    int64_t service_worker_registration_id, BackgroundFetchError* out_error, WTF::Vector<WTF::String>* out_developer_ids)
{
    ...
    proxy_->GetDeveloperIds(std::move(service_worker_registration_id),
        base::BindOnce(
            [](base::RunLoop* loop, BackgroundFetchError* out_error, WTF::Vector<WTF::String>* out_developer_ids, BackgroundFetchError error,
                const WTF::Vector<WTF::String>& developer_ids) {
                *out_error = std::move(error);
...
void BackgroundFetchRegistrationServiceInterceptorForTesting::MatchRequests(::blink::mojom::blink::FetchAPIRequestPtr request_to_match,
    ::blink::mojom::blink::CacheQueryOptionsPtr cache_query_options, bool match_all, MatchRequestsCallback callback)
{
...
void BackgroundFetchRegistrationServiceAsyncWaiter::UpdateUI(const WTF::String& title, const ::SkBitmap& icon, BackgroundFetchError* out_error)
{
    base::RunLoop loop;
...
BackgroundFetchError BackgroundFetchRegistrationServiceAsyncWaiter::UpdateUI(const WTF::String& title, const ::SkBitmap& icon)
{
...
void BackgroundFetchRegistrationServiceAsyncWaiter::MatchRequests(::blink::mojom::blink::FetchAPIRequestPtr request_to_match,
    ::blink::mojom::blink::CacheQueryOptionsPtr cache_query_options, bool match_all, WTF::Vector<BackgroundFetchSettledFetchPtr>* out_fetches)
{
    base::RunLoop loop;
    proxy_->MatchRequests(std::move(request_to_match), std::move(cache_query_options), std::move(match_all),
        base::BindOnce(
            [](base::RunLoop* loop, WTF::Vector<BackgroundFetchSettledFetchPtr>* out_fetches, WTF::Vector<BackgroundFetchSettledFetchPtr> fetches) {
...
WTF::Vector<BackgroundFetchSettledFetchPtr> BackgroundFetchRegistrationServiceAsyncWaiter::MatchRequests(
    ::blink::mojom::blink::FetchAPIRequestPtr request_to_match, ::blink::mojom::blink::CacheQueryOptionsPtr cache_query_options, bool match_all)
{
    WTF::Vector<BackgroundFetchSettledFetchPtr> async_wait_result;
