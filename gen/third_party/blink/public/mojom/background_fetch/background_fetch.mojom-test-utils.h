// third_party/blink/public/mojom/background_fetch/background_fetch.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
public:
    ...
    void GetRegistration(int64_t service_worker_registration_id, const std::string& developer_id, BackgroundFetchError* out_error,
        BackgroundFetchRegistrationPtr* out_registration);

    void GetDeveloperIds(int64_t service_worker_registration_id, BackgroundFetchError* out_error, std::vector<std::string>* out_developer_ids);
...
public:
    ...
    void UpdateUI(const std::optional<std::string>& title, const ::SkBitmap& icon, BackgroundFetchError* out_error);
    ...
    std::vector<BackgroundFetchSettledFetchPtr> MatchRequests(
