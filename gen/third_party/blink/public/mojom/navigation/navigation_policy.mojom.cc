...
bool StructTraits<::blink::mojom::NavigationDownloadTypes::DataView, ::blink::mojom::NavigationDownloadTypesPtr>::Read(
    ::blink::mojom::NavigationDownloadTypes::DataView input, ::blink::mojom::NavigationDownloadTypesPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::NavigationDownloadPolicy::DataView, ::blink::mojom::NavigationDownloadPolicyPtr>::Read(
    ::blink::mojom::NavigationDownloadPolicy::DataView input, ::blink::mojom::NavigationDownloadPolicyPtr* output)
{
    bool success = true;
