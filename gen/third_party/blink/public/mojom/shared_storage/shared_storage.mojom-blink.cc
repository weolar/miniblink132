...
SharedStorageUrlWithMetadata::SharedStorageUrlWithMetadata(const ::blink::KURL& url_in, const WTF::HashMap<WTF::String, ::blink::KURL>& reporting_metadata_in)
    : url(std::move(url_in))
...
PrivateAggregationConfig::PrivateAggregationConfig(const ::scoped_refptr<const ::blink::SecurityOrigin>& aggregation_coordinator_origin_in,
    const WTF::String& context_id_in, uint32_t filtering_id_max_bytes_in)
...
void SharedStorageWorkletHostProxy::SelectURL(const WTF::String& in_name, WTF::Vector<SharedStorageUrlWithMetadataPtr> in_urls_with_metadata,
    ::blink::BlinkCloneableMessage in_serialized_data, bool in_keep_alive_after_operation, PrivateAggregationConfigPtr in_private_aggregation_config,
    const ::WTF::String& in_saved_query_name, SelectURLCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::SharedStorageWorkletHost::SelectURL", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("urls_with_metadata"), in_urls_with_metadata, "<value of type WTF::Vector<SharedStorageUrlWithMetadataPtr>>");
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("saved_query_name"), in_saved_query_name, "<value of type const ::WTF::String&>");
    });
#endif
...
void SharedStorageWorkletHostProxy::Run(const WTF::String& in_name, ::blink::BlinkCloneableMessage in_serialized_data, bool in_keep_alive_after_operation,
...
private:
    ...
    void Run(bool in_success, const WTF::String& in_error_message, const std::optional<::blink::FencedFrame::RedactedFencedFrameConfig>& in_config);
};
...
void SharedStorageWorkletHost_Run_ProxyToResponder::Run(bool in_success, const WTF::String& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void SharedStorageDocumentServiceProxy::CreateWorklet(const ::blink::KURL& in_script_source_url,
    const ::scoped_refptr<const ::blink::SecurityOrigin>& in_data_origin, ::network::mojom::blink::CredentialsMode in_credentials_mode,
    const WTF::Vector<::blink::mojom::blink::OriginTrialFeature>& in_origin_trial_features,
    ::mojo::PendingAssociatedReceiver<SharedStorageWorkletHost> in_worklet_host, CreateWorkletCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::SharedStorageDocumentService::CreateWorklet", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("data_origin"), in_data_origin, "<value of type const ::scoped_refptr<const ::blink::SecurityOrigin>&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("credentials_mode"), in_credentials_mode, "<value of type ::network::mojom::blink::CredentialsMode>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("origin_trial_features"), in_origin_trial_features, "<value of type const WTF::Vector<::blink::mojom::blink::OriginTrialFeature>&>");
        perfetto::WriteIntoTracedValueWithFallback(
...
void SharedStorageDocumentServiceProxy::SharedStorageGet(const ::WTF::String& in_key, SharedStorageGetCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void SharedStorageDocumentService_CreateWorklet_ProxyToResponder::Run(bool in_success, const WTF::String& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
private:
    ...
    void Run(SharedStorageGetStatus in_status, const WTF::String& in_error_message, const ::WTF::String& in_value);
};
...
void SharedStorageDocumentService_SharedStorageUpdate_ProxyToResponder::Run(const WTF::String& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
bool StructTraits<::blink::mojom::blink::SharedStorageUrlWithMetadata::DataView, ::blink::mojom::blink::SharedStorageUrlWithMetadataPtr>::Read(
    ::blink::mojom::blink::SharedStorageUrlWithMetadata::DataView input, ::blink::mojom::blink::SharedStorageUrlWithMetadataPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::PrivateAggregationConfig::DataView, ::blink::mojom::blink::PrivateAggregationConfigPtr>::Read(
    ::blink::mojom::blink::PrivateAggregationConfig::DataView input, ::blink::mojom::blink::PrivateAggregationConfigPtr* output)
{
    bool success = true;
...
void SharedStorageWorkletHostInterceptorForTesting::SelectURL(const WTF::String& name, WTF::Vector<SharedStorageUrlWithMetadataPtr> urls_with_metadata,
...
void SharedStorageWorkletHostInterceptorForTesting::Run(const WTF::String& name, ::blink::BlinkCloneableMessage serialized_data,
    bool keep_alive_after_operation, PrivateAggregationConfigPtr private_aggregation_config, RunCallback callback)
{
...
void SharedStorageWorkletHostAsyncWaiter::SelectURL(const WTF::String& name, WTF::Vector<SharedStorageUrlWithMetadataPtr> urls_with_metadata,
    ::blink::BlinkCloneableMessage serialized_data, bool keep_alive_after_operation, PrivateAggregationConfigPtr private_aggregation_config,
    const ::WTF::String& saved_query_name, bool* out_success, WTF::String* out_error_message,
    std::optional<::blink::FencedFrame::RedactedFencedFrameConfig>* out_config)
{
    ...
    proxy_->SelectURL(std::move(name), std::move(urls_with_metadata), std::move(serialized_data), std::move(keep_alive_after_operation),
        ...
        base::BindOnce(
            [](base::RunLoop* loop, bool* out_success, WTF::String* out_error_message,
                std::optional<::blink::FencedFrame::RedactedFencedFrameConfig>* out_config, bool success, const WTF::String& error_message,
...
void SharedStorageWorkletHostAsyncWaiter::Run(const WTF::String& name, ::blink::BlinkCloneableMessage serialized_data, bool keep_alive_after_operation,
...
void SharedStorageDocumentServiceInterceptorForTesting::CreateWorklet(const ::blink::KURL& script_source_url,
    const ::scoped_refptr<const ::blink::SecurityOrigin>& data_origin, ::network::mojom::blink::CredentialsMode credentials_mode,
    const WTF::Vector<::blink::mojom::blink::OriginTrialFeature>& origin_trial_features,
...
void SharedStorageDocumentServiceAsyncWaiter::CreateWorklet(const ::blink::KURL& script_source_url,
    const ::scoped_refptr<const ::blink::SecurityOrigin>& data_origin, ::network::mojom::blink::CredentialsMode credentials_mode,
    const WTF::Vector<::blink::mojom::blink::OriginTrialFeature>& origin_trial_features,
    ...
    const ::WTF::String& key, SharedStorageGetStatus* out_status, WTF::String* out_error_message, ::WTF::String* out_value)
{
    ...
    proxy_->SharedStorageGet(std::move(key),
        base::BindOnce(
            [](base::RunLoop* loop, SharedStorageGetStatus* out_status, WTF::String* out_error_message, ::WTF::String* out_value, SharedStorageGetStatus status,
                const WTF::String& error_message, const ::WTF::String& value) {
...
WTF::String SharedStorageDocumentServiceAsyncWaiter::SharedStorageUpdate(::network::mojom::blink::SharedStorageModifierMethodPtr method)
{
