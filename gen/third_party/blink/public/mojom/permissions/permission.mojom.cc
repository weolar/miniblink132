...
TopLevelStorageAccessPermissionDescriptor::TopLevelStorageAccessPermissionDescriptor(const ::url::Origin& requestedOrigin_in)
...
void PermissionObserverProxy::OnPermissionStatusChange(::blink::mojom::PermissionStatus in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::blink::mojom::PermissionObserver::Name_;
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::EmbeddedPermissionControlClient::OnEmbeddedPermissionControlRegistered", "input_parameters",
        [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("statuses"), in_statuses, "<value of type const std::optional<std::vector<::blink::mojom::PermissionStatus>>&>");
        });
#endif
...
{
    const char* name = ::blink::mojom::EmbeddedPermissionControlClient::Name_;
    ...
    std::vector<PermissionDescriptorPtr> in_permissions, ::mojo::PendingRemote<EmbeddedPermissionControlClient> in_client)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send blink::mojom::PermissionService::RegisterPageEmbeddedPermissionControl", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("permissions"), in_permissions, "<value of type std::vector<PermissionDescriptorPtr>>");
            perfetto::WriteIntoTracedValueWithFallback(
...
void PermissionServiceProxy::RequestPermissions(std::vector<PermissionDescriptorPtr> in_permission, bool in_user_gesture, RequestPermissionsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::PermissionService::RequestPermissions", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("permission"), in_permission, "<value of type std::vector<PermissionDescriptorPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("user_gesture"), in_user_gesture, "<value of type bool>");
    });
#endif
    ...
    PermissionDescriptorPtr in_permission, ::blink::mojom::PermissionStatus in_last_known_status, ::mojo::PendingRemote<PermissionObserver> in_observer)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::PermissionService::AddPermissionObserver", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("permission"), in_permission, "<value of type PermissionDescriptorPtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("last_known_status"), in_last_known_status, "<value of type ::blink::mojom::PermissionStatus>");
...
void PermissionServiceProxy::NotifyEventListener(PermissionDescriptorPtr in_permission, const std::string& in_event_type, bool in_is_added)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PermissionService_HasPermission_ProxyToResponder::Run(::blink::mojom::PermissionStatus in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PermissionService_RequestPermission_ProxyToResponder::Run(::blink::mojom::PermissionStatus in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(const std::vector<::blink::mojom::PermissionStatus>& in_statuses);
};
...
void PermissionService_RequestPermissions_ProxyToResponder::Run(const std::vector<::blink::mojom::PermissionStatus>& in_statuses)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::PermissionService::RequestPermissions", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("statuses"), in_statuses, "<value of type const std::vector<::blink::mojom::PermissionStatus>&>");
    });
#endif
...
void PermissionService_RevokePermission_ProxyToResponder::Run(::blink::mojom::PermissionStatus in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::blink::mojom::PermissionService::Name_;
...
bool StructTraits<::blink::mojom::MidiPermissionDescriptor::DataView, ::blink::mojom::MidiPermissionDescriptorPtr>::Read(
    ::blink::mojom::MidiPermissionDescriptor::DataView input, ::blink::mojom::MidiPermissionDescriptorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::ClipboardPermissionDescriptor::DataView, ::blink::mojom::ClipboardPermissionDescriptorPtr>::Read(
    ::blink::mojom::ClipboardPermissionDescriptor::DataView input, ::blink::mojom::ClipboardPermissionDescriptorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::CameraDevicePermissionDescriptor::DataView, ::blink::mojom::CameraDevicePermissionDescriptorPtr>::Read(
    ::blink::mojom::CameraDevicePermissionDescriptor::DataView input, ::blink::mojom::CameraDevicePermissionDescriptorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::FullscreenPermissionDescriptor::DataView, ::blink::mojom::FullscreenPermissionDescriptorPtr>::Read(
    ::blink::mojom::FullscreenPermissionDescriptor::DataView input, ::blink::mojom::FullscreenPermissionDescriptorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PermissionDescriptor::DataView, ::blink::mojom::PermissionDescriptorPtr>::Read(
    ::blink::mojom::PermissionDescriptor::DataView input, ::blink::mojom::PermissionDescriptorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::EmbeddedPermissionRequestDescriptor::DataView, ::blink::mojom::EmbeddedPermissionRequestDescriptorPtr>::Read(
    ::blink::mojom::EmbeddedPermissionRequestDescriptor::DataView input, ::blink::mojom::EmbeddedPermissionRequestDescriptorPtr* output)
{
    bool success = true;
...
bool UnionTraits<::blink::mojom::PermissionDescriptorExtension::DataView, ::blink::mojom::PermissionDescriptorExtensionPtr>::Read(
    ::blink::mojom::PermissionDescriptorExtension::DataView input, ::blink::mojom::PermissionDescriptorExtensionPtr* output)
{
...
void EmbeddedPermissionControlClientInterceptorForTesting::OnEmbeddedPermissionControlRegistered(
    bool allow, const std::optional<std::vector<::blink::mojom::PermissionStatus>>& statuses)
{
...
void PermissionServiceInterceptorForTesting::RequestPermissions(
    std::vector<PermissionDescriptorPtr> permission, bool user_gesture, RequestPermissionsCallback callback)
{
...
void PermissionServiceAsyncWaiter::HasPermission(PermissionDescriptorPtr permission, ::blink::mojom::PermissionStatus* out_status)
{
    base::RunLoop loop;
...
::blink::mojom::PermissionStatus PermissionServiceAsyncWaiter::HasPermission(PermissionDescriptorPtr permission)
{
...
void PermissionServiceAsyncWaiter::RequestPermission(PermissionDescriptorPtr permission, bool user_gesture, ::blink::mojom::PermissionStatus* out_status)
{
    base::RunLoop loop;
...
::blink::mojom::PermissionStatus PermissionServiceAsyncWaiter::RequestPermission(PermissionDescriptorPtr permission, bool user_gesture)
{
    ::blink::mojom::PermissionStatus async_wait_result;
    ...
    std::vector<PermissionDescriptorPtr> permission, bool user_gesture, std::vector<::blink::mojom::PermissionStatus>* out_statuses)
{
    ...
    proxy_->RequestPermissions(std::move(permission), std::move(user_gesture),
        base::BindOnce(
            [](base::RunLoop* loop, std::vector<::blink::mojom::PermissionStatus>* out_statuses,
...
void PermissionServiceAsyncWaiter::RevokePermission(PermissionDescriptorPtr permission, ::blink::mojom::PermissionStatus* out_status)
{
    base::RunLoop loop;
...
::blink::mojom::PermissionStatus PermissionServiceAsyncWaiter::RevokePermission(PermissionDescriptorPtr permission)
{
    ::blink::mojom::PermissionStatus async_wait_result;
