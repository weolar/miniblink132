// third_party/blink/public/mojom/webdatabase/web_database.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT WebDatabaseHostInterceptorForTesting : public WebDatabaseHost {
    ...
    void Opened(
        const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::WTF::String& database_name, const ::WTF::String& database_description) override;
...
public:
    ...
    void OpenFile(const ::WTF::String& vfs_file_name, int32_t desired_flags, ::base::File* out_file);
    ::base::File OpenFile(const ::WTF::String& vfs_file_name, int32_t desired_flags);
    void DeleteFile(const ::WTF::String& vfs_file_name, bool sync_dir, int32_t* out_sqlite_error_code);
    int32_t DeleteFile(const ::WTF::String& vfs_file_name, bool sync_dir);
    void GetFileAttributes(const ::WTF::String& vfs_file_name, int32_t* out_attributes);
    int32_t GetFileAttributes(const ::WTF::String& vfs_file_name);
    void GetSpaceAvailable(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, int64_t* out_space_available);
    int64_t GetSpaceAvailable(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin);
