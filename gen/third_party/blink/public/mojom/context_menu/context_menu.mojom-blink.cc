...
CustomContextMenuItem::CustomContextMenuItem(const ::WTF::String& label_in, AcceleratorPtr accelerator_in, const ::WTF::String& icon_in,
...
UntrustworthyContextMenuParams::UntrustworthyContextMenuParams(ContextMenuDataMediaType media_type_in, int32_t x_in, int32_t y_in,
...
void ContextMenuClientProxy::ContextMenuClosed(const ::blink::KURL& in_link_followed)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ContextMenuClient::ContextMenuClosed", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("link_followed"), in_link_followed, "<value of type const ::blink::KURL&>");
    });
#endif
...
bool StructTraits<::blink::mojom::blink::Accelerator::DataView, ::blink::mojom::blink::AcceleratorPtr>::Read(
    ::blink::mojom::blink::Accelerator::DataView input, ::blink::mojom::blink::AcceleratorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::FormRendererId::DataView, ::blink::mojom::blink::FormRendererIdPtr>::Read(
    ::blink::mojom::blink::FormRendererId::DataView input, ::blink::mojom::blink::FormRendererIdPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::FieldRendererId::DataView, ::blink::mojom::blink::FieldRendererIdPtr>::Read(
    ::blink::mojom::blink::FieldRendererId::DataView input, ::blink::mojom::blink::FieldRendererIdPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::CustomContextMenuItem::DataView, ::blink::mojom::blink::CustomContextMenuItemPtr>::Read(
    ::blink::mojom::blink::CustomContextMenuItem::DataView input, ::blink::mojom::blink::CustomContextMenuItemPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::UntrustworthyContextMenuParams::DataView, ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr>::Read(
    ::blink::mojom::blink::UntrustworthyContextMenuParams::DataView input, ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr* output)
{
    bool success = true;
