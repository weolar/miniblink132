...
static_assert(sizeof(WebPage_Data) == 32, "Bad sizeof(WebPage_Data)");
// Used by WebPage::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct WebPage_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    WebPage_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag WebPage_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
