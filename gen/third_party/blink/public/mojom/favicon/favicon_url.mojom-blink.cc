...
FaviconURL::FaviconURL(const ::blink::KURL& icon_url_in, FaviconIconType icon_type_in, WTF::Vector<::gfx::Size> icon_sizes_in, bool is_default_icon_in)
...
bool StructTraits<::blink::mojom::blink::FaviconURL::DataView, ::blink::mojom::blink::FaviconURLPtr>::Read(
    ::blink::mojom::blink::FaviconURL::DataView input, ::blink::mojom::blink::FaviconURLPtr* output)
{
    bool success = true;
