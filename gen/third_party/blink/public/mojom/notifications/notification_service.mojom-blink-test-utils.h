// third_party/blink/public/mojom/notifications/notification_service.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT NotificationServiceInterceptorForTesting : public NotificationService {
    ...
    void DisplayNonPersistentNotification(const WTF::String& token, ::blink::mojom::blink::NotificationDataPtr notification_data,
        ::blink::mojom::blink::NotificationResourcesPtr notification_resources,
        ::mojo::PendingRemote<NonPersistentNotificationListener> event_listener) override;
    ...
    void DisplayPersistentNotification(int64_t service_worker_registration_id, ::blink::mojom::blink::NotificationDataPtr notification_data,
        ::blink::mojom::blink::NotificationResourcesPtr notification_resources, DisplayPersistentNotificationCallback callback) override;
    void ClosePersistentNotification(const WTF::String& notification_id) override;
    void GetNotifications(
        int64_t service_worker_registration_id, const WTF::String& filter_tag, bool include_triggered, GetNotificationsCallback callback) override;
};
...
public:
    ...
    void GetPermissionStatus(::blink::mojom::blink::PermissionStatus* out_status);
    ::blink::mojom::blink::PermissionStatus GetPermissionStatus();
    void DisplayPersistentNotification(int64_t service_worker_registration_id, ::blink::mojom::blink::NotificationDataPtr notification_data,
        ::blink::mojom::blink::NotificationResourcesPtr notification_resources, PersistentNotificationError* out_error);
    ...
    void GetNotifications(int64_t service_worker_registration_id, const WTF::String& filter_tag, bool include_triggered,
