// third_party/blink/public/mojom/notifications/notification_service.mojom.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/notifications/notification_service.mojom-forward.h" // IWYU pragma: export
...
class BLINK_COMMON_EXPORT NonPersistentNotificationListener : public NonPersistentNotificationListenerInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT NotificationService : public NotificationServiceInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void DisplayNonPersistentNotification(const std::string& token, const ::blink::PlatformNotificationData& notification_data,
        const ::blink::NotificationResources& notification_resources, ::mojo::PendingRemote<NonPersistentNotificationListener> event_listener)
        = 0;
    ...
    virtual void DisplayPersistentNotification(int64_t service_worker_registration_id, const ::blink::PlatformNotificationData& notification_data,
        const ::blink::NotificationResources& notification_resources, DisplayPersistentNotificationCallback callback)
        = 0;
...
//class BLINK_COMMON_EXPORT NonPersistentNotificationListenerProxy : public NonPersistentNotificationListener {
//public:
...
//class BLINK_COMMON_EXPORT NotificationServiceProxy : public NotificationService {
//public:
...
//
//    void DisplayNonPersistentNotification(const std::string& token, const ::blink::PlatformNotificationData& notification_data,
//        const ::blink::NotificationResources& notification_resources, ::mojo::PendingRemote<NonPersistentNotificationListener> event_listener) final;
//
//    void CloseNonPersistentNotification(const std::string& token) final;
//
//    void DisplayPersistentNotification(int64_t service_worker_registration_id, const ::blink::PlatformNotificationData& notification_data,
//        const ::blink::NotificationResources& notification_resources, DisplayPersistentNotificationCallback callback) final;
//
//    void ClosePersistentNotification(const std::string& notification_id) final;
//
//    void GetNotifications(
//        int64_t service_worker_registration_id, const std::string& filter_tag, bool include_triggered, GetNotificationsCallback callback) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};
