...
class PLATFORM_EXPORT LeakDetector : public LeakDetectorInterfaceBase {
public:
...
//class PLATFORM_EXPORT LeakDetectorProxy : public LeakDetector {
//public:
    ...
    , number_of_live_resource_fetchers()
{
    ...
    {
        return mojo::internal::SerializeImpl<LeakDetectionResult::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::LeakDetectionResult::DataView, ::blink::mojom::blink::LeakDetectionResultPtr> {
    static bool IsNull(const ::blink::mojom::blink::LeakDetectionResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::LeakDetectionResultPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::blink::mojom::blink::LeakDetectionResult::number_of_live_context_lifecycle_state_observers)
    number_of_live_context_lifecycle_state_observers(const ::blink::mojom::blink::LeakDetectionResultPtr& input)
    {
