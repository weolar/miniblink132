...
#include "third_party/blink/public/mojom/leak_detector/leak_detector.mojom-forward.h" // IWYU pragma: export
#include <string>
#include <vector>
...
template <typename ImplRefTraits> class LeakDetectorStub;

class LeakDetectorRequestValidator;
class LeakDetectorResponseValidator;

class BLINK_COMMON_EXPORT LeakDetector : public LeakDetectorInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = LeakDetectorStub<ImplRefTraits>;
...
//class BLINK_COMMON_EXPORT LeakDetectorProxy : public LeakDetector {
//public:
...
//    static bool AcceptWithResponder(LeakDetector* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
//};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<LeakDetector>> class LeakDetectorStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return LeakDetectorStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return LeakDetectorStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<LeakDetectionResult, T>::value>;
    using DataView = LeakDetectionResultDataView;
    using Data_ = internal::LeakDetectionResult_Data;

    template <typename... Args> static LeakDetectionResultPtr New(Args&&... args)
    {
        return LeakDetectionResultPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static LeakDetectionResultPtr From(const U& u)
    {
    ...
    , number_of_live_resource_fetchers()
{
    ...
    LeakDetectionResult(uint32_t number_of_live_audio_nodes_in, uint32_t number_of_live_documents_in, uint32_t number_of_live_nodes_in,
    ...
    ~LeakDetectionResult() = default;

    // Clone() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = LeakDetectionResultPtr> LeakDetectionResultPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, LeakDetectionResult::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, LeakDetectionResult::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    {
        return mojo::internal::SerializeImpl<LeakDetectionResult::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<LeakDetectionResult::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::LeakDetectionResult_UnserializedMessageContext<UserType, LeakDetectionResult::DataView>>(0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        ...
        return mojo::internal::DeserializeImpl<LeakDetectionResult::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return LeakDetectionResult::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context = input.TakeUnserializedContext<internal::LeakDetectionResult_UnserializedMessageContext<UserType, LeakDetectionResult::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<LeakDetectionResult::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, LeakDetectionResult::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
template <typename StructPtrType> LeakDetectionResultPtr LeakDetectionResult::Clone() const
{
    return New(mojo::Clone(number_of_live_audio_nodes), mojo::Clone(number_of_live_documents), mojo::Clone(number_of_live_nodes),
        mojo::Clone(number_of_live_layout_objects), mojo::Clone(number_of_live_resources), mojo::Clone(number_of_live_context_lifecycle_state_observers),
        mojo::Clone(number_of_live_frames), mojo::Clone(number_of_live_v8_per_context_data), mojo::Clone(number_of_worker_global_scopes),
        mojo::Clone(number_of_live_ua_css_resources), mojo::Clone(number_of_live_resource_fetchers));
}

template <typename T, LeakDetectionResult::EnableIfSame<T>*> bool LeakDetectionResult::Equals(const T& other_struct) const
{
...
template <typename T, LeakDetectionResult::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::LeakDetectionResult::DataView, ::blink::mojom::LeakDetectionResultPtr> {
    static bool IsNull(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::LeakDetectionResultPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_documents) number_of_live_documents(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
        return input->number_of_live_documents;
    }

    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_nodes) number_of_live_nodes(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
    ...
    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_resources) number_of_live_resources(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
    ...
    static decltype(::blink::mojom::LeakDetectionResult::number_of_live_frames) number_of_live_frames(const ::blink::mojom::LeakDetectionResultPtr& input)
    {
