// third_party/blink/public/mojom/leak_detector/leak_detector.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class LeakDetector : uint32_t {
    kPerformLeakDetection = 0,
};
