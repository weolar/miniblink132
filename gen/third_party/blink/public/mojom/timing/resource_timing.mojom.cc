...
ServerTimingInfo::ServerTimingInfo(const std::string& name_in, double duration_in, const std::string& description_in)
...
ResourceTimingInfo::ResourceTimingInfo(const std::string& name_in, ::base::TimeTicks start_time_in, const std::string& alpn_negotiated_protocol_in,
...
bool StructTraits<::blink::mojom::ServerTimingInfo::DataView, ::blink::mojom::ServerTimingInfoPtr>::Read(
    ::blink::mojom::ServerTimingInfo::DataView input, ::blink::mojom::ServerTimingInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::ResourceTimingInfo::DataView, ::blink::mojom::ResourceTimingInfoPtr>::Read(
    ::blink::mojom::ResourceTimingInfo::DataView input, ::blink::mojom::ResourceTimingInfoPtr* output)
{
    bool success = true;
