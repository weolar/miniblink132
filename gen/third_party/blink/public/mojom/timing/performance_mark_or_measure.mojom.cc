...
PerformanceMarkOrMeasure::PerformanceMarkOrMeasure(const std::string& name_in, PerformanceMarkOrMeasure::EntryType entry_type_in, double start_time_in,
...
bool StructTraits<::blink::mojom::PerformanceMarkOrMeasure::DataView, ::blink::mojom::PerformanceMarkOrMeasurePtr>::Read(
    ::blink::mojom::PerformanceMarkOrMeasure::DataView input, ::blink::mojom::PerformanceMarkOrMeasurePtr* output)
{
    bool success = true;
