...
//class BLINK_COMMON_EXPORT SpeculationHostProxy : public SpeculationHost {
//public:
    ...
    , injection_type(SpeculationInjectionType::kNone)
{
    ...
    SpeculationCandidate(const ::GURL& url_in, SpeculationAction action_in, ::blink::mojom::ReferrerPtr referrer_in,
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SpeculationCandidate::DataView, ::blink::mojom::SpeculationCandidatePtr> {
    static bool IsNull(const ::blink::mojom::SpeculationCandidatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::SpeculationCandidatePtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::SpeculationCandidate::url)& url(const ::blink::mojom::SpeculationCandidatePtr& input)
    {
        return input->url;
    }

    static decltype(::blink::mojom::SpeculationCandidate::action) action(const ::blink::mojom::SpeculationCandidatePtr& input)
    {
        return input->action;
    }

    static const decltype(::blink::mojom::SpeculationCandidate::referrer)& referrer(const ::blink::mojom::SpeculationCandidatePtr& input)
    {
    ...
    static decltype(::blink::mojom::SpeculationCandidate::eagerness) eagerness(const ::blink::mojom::SpeculationCandidatePtr& input)
    {
        return input->eagerness;
    }

    static const decltype(::blink::mojom::SpeculationCandidate::no_vary_search_hint)& no_vary_search_hint(const ::blink::mojom::SpeculationCandidatePtr& input)
    {
        return input->no_vary_search_hint;
    }

    static decltype(::blink::mojom::SpeculationCandidate::injection_type) injection_type(const ::blink::mojom::SpeculationCandidatePtr& input)
    {
