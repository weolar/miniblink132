...
SpeculationCandidate::SpeculationCandidate(const ::GURL& url_in, SpeculationAction action_in, ::blink::mojom::ReferrerPtr referrer_in,
    ...
    ::network::mojom::NoVarySearchPtr no_vary_search_hint_in, SpeculationInjectionType injection_type_in)
    : url(std::move(url_in))
...
void SpeculationHostProxy::UpdateSpeculationCandidates(std::vector<SpeculationCandidatePtr> in_candidates)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::SpeculationHost::UpdateSpeculationCandidates", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("candidates"), in_candidates, "<value of type std::vector<SpeculationCandidatePtr>>");
    });
#endif
...
void SpeculationHostProxy::InitiatePreview(const ::GURL& in_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::blink::mojom::SpeculationCandidate::DataView, ::blink::mojom::SpeculationCandidatePtr>::Read(
    ::blink::mojom::SpeculationCandidate::DataView input, ::blink::mojom::SpeculationCandidatePtr* output)
{
    bool success = true;
