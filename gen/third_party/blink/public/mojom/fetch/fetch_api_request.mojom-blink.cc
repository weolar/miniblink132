...
FetchAPIRequestHeaders::FetchAPIRequestHeaders(const WTF::HashMap<WTF::String, WTF::String>& headers_in)
...
FetchAPIRequestBody::FetchAPIRequestBody(WTF::Vector<::network::DataElement> elements_in, uint64_t identifier_in, bool contains_sensitive_info_in)
...
FetchAPIRequest::FetchAPIRequest(::network::mojom::blink::RequestMode mode_in, bool is_main_resource_load_in,
...
void FetchAPIRequest::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("headers"), this->headers,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::WTF::HashMap<::WTF::String, WTF::String, WTF::CaseFoldingHashTraits<WTF::String>>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::blink::mojom::blink::FetchAPIRequestHeaders::DataView, ::blink::mojom::blink::FetchAPIRequestHeadersPtr>::Read(
    ::blink::mojom::blink::FetchAPIRequestHeaders::DataView input, ::blink::mojom::blink::FetchAPIRequestHeadersPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::FetchAPIRequestBody::DataView, ::blink::mojom::blink::FetchAPIRequestBodyPtr>::Read(
    ::blink::mojom::blink::FetchAPIRequestBody::DataView input, ::blink::mojom::blink::FetchAPIRequestBodyPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::FetchAPIRequest::DataView, ::blink::mojom::blink::FetchAPIRequestPtr>::Read(
    ::blink::mojom::blink::FetchAPIRequest::DataView input, ::blink::mojom::blink::FetchAPIRequestPtr* output)
{
    bool success = true;
