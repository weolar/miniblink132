    ...
    : headers()
{
    ...
    explicit FetchAPIRequestHeaders(const base::flat_map<std::string, std::string>& headers_in)
    ...
    {
        return mojo::internal::SerializeImpl<FetchAPIRequestHeaders::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , contains_sensitive_info()
{
    ...
    FetchAPIRequestBody(std::vector<::network::DataElement> elements_in, uint64_t identifier_in, bool contains_sensitive_info_in)
    ...
    , service_worker_race_network_request_token()
{
    ...
    FetchAPIRequest(::network::mojom::RequestMode mode_in, bool is_main_resource_load_in, ::network::mojom::RequestDestination destination_in,
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FetchAPIRequestHeaders::DataView, ::blink::mojom::FetchAPIRequestHeadersPtr> {
    static bool IsNull(const ::blink::mojom::FetchAPIRequestHeadersPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::FetchAPIRequestHeadersPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::FetchAPIRequestHeaders::headers)& headers(const ::blink::mojom::FetchAPIRequestHeadersPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FetchAPIRequestBody::DataView, ::blink::mojom::FetchAPIRequestBodyPtr> {
    static bool IsNull(const ::blink::mojom::FetchAPIRequestBodyPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::FetchAPIRequestBodyPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::FetchAPIRequestBody::elements)& elements(::blink::mojom::FetchAPIRequestBodyPtr& input)
    {
        return input->elements;
    }

    static decltype(::blink::mojom::FetchAPIRequestBody::identifier) identifier(const ::blink::mojom::FetchAPIRequestBodyPtr& input)
    {
        return input->identifier;
    }

    static decltype(::blink::mojom::FetchAPIRequestBody::contains_sensitive_info) contains_sensitive_info(const ::blink::mojom::FetchAPIRequestBodyPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FetchAPIRequest::DataView, ::blink::mojom::FetchAPIRequestPtr> {
    static bool IsNull(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::FetchAPIRequestPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::FetchAPIRequest::mode) mode(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->mode;
    }

    static decltype(::blink::mojom::FetchAPIRequest::is_main_resource_load) is_main_resource_load(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->is_main_resource_load;
    }

    static decltype(::blink::mojom::FetchAPIRequest::destination) destination(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->destination;
    }

    static decltype(::blink::mojom::FetchAPIRequest::frame_type) frame_type(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->frame_type;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::url)& url(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->url;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::method)& method(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->method;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::headers)& headers(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->headers;
    }

    static decltype(::blink::mojom::FetchAPIRequest::blob)& blob(::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->blob;
    }

    static decltype(::blink::mojom::FetchAPIRequest::body)& body(::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->body;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::request_initiator)& request_initiator(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
    ...
    static const decltype(::blink::mojom::FetchAPIRequest::referrer)& referrer(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->referrer;
    }

    static decltype(::blink::mojom::FetchAPIRequest::credentials_mode) credentials_mode(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->credentials_mode;
    }

    static decltype(::blink::mojom::FetchAPIRequest::cache_mode) cache_mode(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->cache_mode;
    }

    static decltype(::blink::mojom::FetchAPIRequest::redirect_mode) redirect_mode(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->redirect_mode;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::integrity)& integrity(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->integrity;
    }

    static decltype(::blink::mojom::FetchAPIRequest::priority) priority(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->priority;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::fetch_window_id)& fetch_window_id(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->fetch_window_id;
    }

    static decltype(::blink::mojom::FetchAPIRequest::keepalive) keepalive(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->keepalive;
    }

    static decltype(::blink::mojom::FetchAPIRequest::is_reload) is_reload(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->is_reload;
    }

    static decltype(::blink::mojom::FetchAPIRequest::is_history_navigation) is_history_navigation(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->is_history_navigation;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::devtools_stack_id)& devtools_stack_id(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->devtools_stack_id;
    }

    static const decltype(::blink::mojom::FetchAPIRequest::trust_token_params)& trust_token_params(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
        return input->trust_token_params;
    }

    static decltype(::blink::mojom::FetchAPIRequest::target_address_space) target_address_space(const ::blink::mojom::FetchAPIRequestPtr& input)
    {
