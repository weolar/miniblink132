...
StorageKey::StorageKey(const ::url::Origin& origin_in, const ::net::SchemefulSite& top_level_site_in, const std::optional<::base::UnguessableToken>& nonce_in,
...
bool StructTraits<::blink::mojom::StorageKey::DataView, ::blink::mojom::StorageKeyPtr>::Read(
    ::blink::mojom::StorageKey::DataView input, ::blink::mojom::StorageKeyPtr* output)
{
    bool success = true;
