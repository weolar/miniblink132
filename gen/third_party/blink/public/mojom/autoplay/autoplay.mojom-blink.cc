...
AutoplayConfigurationClient::IPCStableHashFunction AutoplayConfigurationClient::MessageToMethodInfo_(mojo::Message& message)
{
    ...
    switch (static_cast<messages::AutoplayConfigurationClient>(message.name())) {
    case messages::AutoplayConfigurationClient::kAddAutoplayFlags: {
...
uint32_t AutoplayConfigurationClient::AddAutoplayFlags_Sym::IPCStableHash()
{
    ...
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)blink::mojom::AutoplayConfigurationClient::AddAutoplayFlags");
...
void AutoplayConfigurationClientProxy::AddAutoplayFlags(const ::scoped_refptr<const ::blink::SecurityOrigin>& in_origin, int32_t in_flags)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::AutoplayConfigurationClient::AddAutoplayFlags", "input_parameters", [&](perfetto::TracedValue context) {
    ...
    mojo::Message message(base::to_underlying(messages::AutoplayConfigurationClient::kAddAutoplayFlags), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::blink::mojom::internal::AutoplayConfigurationClient_AddAutoplayFlags_Params_Data> params(message);
    params.Allocate();
...
// static
bool AutoplayConfigurationClientStubDispatch::Accept(AutoplayConfigurationClient* impl, mojo::Message* message)
{
    switch (static_cast<messages::AutoplayConfigurationClient>(message->header()->name)) {
    case messages::AutoplayConfigurationClient::kAddAutoplayFlags: {
        DCHECK(message->is_serialized());
        internal::AutoplayConfigurationClient_AddAutoplayFlags_Params_Data* params
            = reinterpret_cast<internal::AutoplayConfigurationClient_AddAutoplayFlags_Params_Data*>(message->mutable_payload());
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, AutoplayConfigurationClient::Name_, 0, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->AddAutoplayFlags(std::move(p_origin), std::move(p_flags));
        return true;
    }
    }
    return false;
...
bool AutoplayConfigurationClientStubDispatch::AcceptWithResponder(
    AutoplayConfigurationClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const mojo::internal::GenericValidationInfo kAutoplayConfigurationClientValidationInfo[] = {
    { &internal::AutoplayConfigurationClient_AddAutoplayFlags_Params_Data::Validate, nullptr /* no response */ },
};
...
AutoplayConfigurationClientAsyncWaiter::AutoplayConfigurationClientAsyncWaiter(AutoplayConfigurationClient* proxy)
    : proxy_(proxy)
{
}
