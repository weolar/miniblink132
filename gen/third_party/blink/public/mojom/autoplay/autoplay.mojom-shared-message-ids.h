// third_party/blink/public/mojom/autoplay/autoplay.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class AutoplayConfigurationClient : uint32_t {
    kAddAutoplayFlags = 0,
};
