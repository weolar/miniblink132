...
void ContentSecurityNotifierProxy::NotifyInsecureContentRan(const ::blink::KURL& in_origin, const ::blink::KURL& in_insecure_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::ContentSecurityNotifier::NotifyInsecureContentRan", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("insecure_url"), in_insecure_url, "<value of type const ::blink::KURL&>");
    });
#endif
