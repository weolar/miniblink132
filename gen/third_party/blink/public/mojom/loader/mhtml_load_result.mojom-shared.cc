...
NOINLINE static const char* MHTMLLoadResultToStringHelper(MHTMLLoadResult value)
{
...
// static
void TraceFormatTraits<::blink::mojom::MHTMLLoadResult>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::MHTMLLoadResult value)
{
