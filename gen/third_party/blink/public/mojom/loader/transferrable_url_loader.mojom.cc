...
TransferrableURLLoader::TransferrableURLLoader(const ::GURL& url_in, ::mojo::PendingRemote<::network::mojom::URLLoader> url_loader_in,
...
bool StructTraits<::blink::mojom::TransferrableURLLoader::DataView, ::blink::mojom::TransferrableURLLoaderPtr>::Read(
    ::blink::mojom::TransferrableURLLoader::DataView input, ::blink::mojom::TransferrableURLLoaderPtr* output)
{
    bool success = true;
