    ...
    , bypass_redirect_checks(false)
{
    ...
    URLLoaderFactoryBundle(::mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory> default_factory_in,
    WTF::HashMap<WTF::String, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory>> scheme_specific_factories_in,
    WTF::HashMap<::scoped_refptr<const ::blink::SecurityOrigin>, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory>> isolated_world_factories_in,
    ...
    WTF::HashMap<WTF::String, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory>> scheme_specific_factories;

    WTF::HashMap<::scoped_refptr<const ::blink::SecurityOrigin>, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory>> isolated_world_factories;
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::URLLoaderFactoryBundle::DataView, ::blink::mojom::blink::URLLoaderFactoryBundlePtr> {
    static bool IsNull(const ::blink::mojom::blink::URLLoaderFactoryBundlePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::URLLoaderFactoryBundlePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::blink::URLLoaderFactoryBundle::default_factory)& default_factory(::blink::mojom::blink::URLLoaderFactoryBundlePtr& input)
    {
