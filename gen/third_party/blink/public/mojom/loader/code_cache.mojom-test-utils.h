// third_party/blink/public/mojom/loader/code_cache.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_COMMON_EXPORT CodeCacheHostInterceptorForTesting : public CodeCacheHost {
    ...
    void DidGenerateCacheableMetadataInCacheStorage(
        const ::GURL& url, ::base::Time expected_response_time, ::mojo_base::BigBuffer data, const std::string& cache_storage_cache_name) override;
};
...
public:
    ...
    void FetchCachedCode(CodeCacheType cache_type, const ::GURL& url, ::base::Time* out_response_time, ::mojo_base::BigBuffer* out_data);
