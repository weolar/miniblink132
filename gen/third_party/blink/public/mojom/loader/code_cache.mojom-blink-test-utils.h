...
class PLATFORM_EXPORT CodeCacheHostInterceptorForTesting : public CodeCacheHost {
    ...
    void DidGenerateCacheableMetadata(
        CodeCacheType cache_type, const ::blink::KURL& url, ::base::Time expected_response_time, ::mojo_base::BigBuffer data) override;
...
public:
    ...
    void FetchCachedCode(CodeCacheType cache_type, const ::blink::KURL& url, ::base::Time* out_response_time, ::mojo_base::BigBuffer* out_data);
