    ...
    TRACE_EVENT1(
        "mojom", "Send blink::mojom::ResourceLoadInfoNotifier::NotifyResourceRedirectReceived", "input_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("redirect_info"), in_redirect_info, "<value of type ::network::mojom::blink::URLRequestRedirectInfoPtr>");
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("redirect_response"), in_redirect_response, "<value of type ::network::mojom::blink::URLResponseHeadPtr>");
        });
#endif
...
void ResourceLoadInfoNotifierProxy::NotifyResourceResponseReceived(int64_t in_request_id, const ::url::SchemeHostPort& in_final_response_url,
    ::network::mojom::blink::URLResponseHeadPtr in_head, ::network::mojom::blink::RequestDestination in_request_destination, bool in_is_ad_resource)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
    ...
    ::blink::mojom::blink::ResourceLoadInfoPtr in_resource_load_info, const ::network::URLLoaderCompletionStatus& in_status)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::ResourceLoadInfoNotifier::NotifyResourceLoadCompleted", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("resource_load_info"), in_resource_load_info, "<value of type ::blink::mojom::blink::ResourceLoadInfoPtr>");
