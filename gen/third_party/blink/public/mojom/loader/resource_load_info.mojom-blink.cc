...
RedirectInfo::RedirectInfo(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin_of_new_url_in, CommonNetworkInfoPtr network_info_in)
...
ResourceLoadInfo::ResourceLoadInfo(int64_t request_id_in, const ::blink::KURL& final_url_in, const ::blink::KURL& referrer_in,
...
bool StructTraits<::blink::mojom::blink::CommonNetworkInfo::DataView, ::blink::mojom::blink::CommonNetworkInfoPtr>::Read(
    ::blink::mojom::blink::CommonNetworkInfo::DataView input, ::blink::mojom::blink::CommonNetworkInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::RedirectInfo::DataView, ::blink::mojom::blink::RedirectInfoPtr>::Read(
    ::blink::mojom::blink::RedirectInfo::DataView input, ::blink::mojom::blink::RedirectInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::ResourceLoadInfo::DataView, ::blink::mojom::blink::ResourceLoadInfoPtr>::Read(
    ::blink::mojom::blink::ResourceLoadInfo::DataView input, ::blink::mojom::blink::ResourceLoadInfoPtr* output)
{
    bool success = true;
