...
#include "third_party/blink/public/mojom/loader/navigation_predictor.mojom-forward.h" // IWYU pragma: export
...
// with not having this data in traces there.
    ...
    virtual void ReportNewAnchorElements(std::vector<AnchorElementMetricsPtr> metrics, const std::vector<uint32_t>& removed_elements) = 0;

    virtual void ReportAnchorElementsEnteredViewport(std::vector<AnchorElementEnteredViewportPtr> elements) = 0;

    virtual void ReportAnchorElementsLeftViewport(std::vector<AnchorElementLeftViewportPtr> elements) = 0;

    virtual void ReportAnchorElementsPositionUpdate(std::vector<AnchorElementPositionUpdatePtr> elements) = 0;
...
//class BLINK_COMMON_EXPORT AnchorElementMetricsHostProxy : public AnchorElementMetricsHost {
//public:
...
//
//    void ReportNewAnchorElements(std::vector<AnchorElementMetricsPtr> metrics, const std::vector<uint32_t>& removed_elements) final;
//
//    void ReportAnchorElementsEnteredViewport(std::vector<AnchorElementEnteredViewportPtr> elements) final;
//
//    void ReportAnchorElementsLeftViewport(std::vector<AnchorElementLeftViewportPtr> elements) final;
//
//    void ReportAnchorElementsPositionUpdate(std::vector<AnchorElementPositionUpdatePtr> elements) final;
//
...
class BLINK_COMMON_EXPORT AnchorElementPointerEventForMLModel {
public:
    ...
    , user_interaction_event_type()
{
    ...
    {
        return mojo::internal::SerializeImpl<AnchorElementPointerEventForMLModel::DataView, std::vector<uint8_t>>(input);
    }
...
class BLINK_COMMON_EXPORT AnchorElementPositionUpdate {
public:
    ...
    , distance_from_pointer_down_ratio()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnchorElementPositionUpdate::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , navigation_start_to_click()
{
    ...
    AnchorElementClick(uint32_t anchor_id_in, const ::GURL& target_url_in, ::base::TimeDelta navigation_start_to_click_in)
    : anchor_id(std::move(anchor_id_in))
    , target_url(std::move(target_url_in))
...
class BLINK_COMMON_EXPORT AnchorElementPointerDataOnHoverTimerFired {
public:
    ...
    , pointer_data()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnchorElementPointerDataOnHoverTimerFired::DataView, std::vector<uint8_t>>(input);
    }
    ...
    ::blink::mojom::AnchorElementPointerDataPtr pointer_data;
...
class BLINK_COMMON_EXPORT AnchorElementLeftViewport {
public:
    ...
    , time_in_viewport()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnchorElementLeftViewport::DataView, std::vector<uint8_t>>(input);
    }
...
class BLINK_COMMON_EXPORT AnchorElementPointerOver {
public:
    ...
    , navigation_start_to_pointer_over()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnchorElementPointerOver::DataView, std::vector<uint8_t>>(input);
    }
...
class BLINK_COMMON_EXPORT AnchorElementPointerOut {
public:
    ...
    , hover_dwell_time()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnchorElementPointerOut::DataView, std::vector<uint8_t>>(input);
    }
...
class BLINK_COMMON_EXPORT AnchorElementPointerDown {
public:
    ...
    , navigation_start_to_pointer_down()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnchorElementPointerDown::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementMetrics::DataView, ::blink::mojom::AnchorElementMetricsPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementMetricsPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementMetrics::anchor_id) anchor_id(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
        return input->anchor_id;
    }

    static decltype(::blink::mojom::AnchorElementMetrics::ratio_area) ratio_area(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
    ...
    static decltype(::blink::mojom::AnchorElementMetrics::is_in_iframe) is_in_iframe(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
        return input->is_in_iframe;
    }

    static decltype(::blink::mojom::AnchorElementMetrics::contains_image) contains_image(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
        return input->contains_image;
    }

    static decltype(::blink::mojom::AnchorElementMetrics::is_same_host) is_same_host(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
    ...
    static decltype(::blink::mojom::AnchorElementMetrics::font_size_px) font_size_px(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
        return input->font_size_px;
    }

    static decltype(::blink::mojom::AnchorElementMetrics::font_weight) font_weight(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
        return input->font_weight;
    }

    static const decltype(::blink::mojom::AnchorElementMetrics::target_url)& target_url(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
        return input->target_url;
    }

    static const decltype(::blink::mojom::AnchorElementMetrics::viewport_size)& viewport_size(const ::blink::mojom::AnchorElementMetricsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementClick::DataView, ::blink::mojom::AnchorElementClickPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementClickPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementClickPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementClick::anchor_id) anchor_id(const ::blink::mojom::AnchorElementClickPtr& input)
    {
        return input->anchor_id;
    }

    static const decltype(::blink::mojom::AnchorElementClick::target_url)& target_url(const ::blink::mojom::AnchorElementClickPtr& input)
    {
        return input->target_url;
    }

    static const decltype(::blink::mojom::AnchorElementClick::navigation_start_to_click)& navigation_start_to_click(
        const ::blink::mojom::AnchorElementClickPtr& input)
    {
...
struct BLINK_COMMON_EXPORT
    StructTraits<::blink::mojom::AnchorElementPointerDataOnHoverTimerFired::DataView, ::blink::mojom::AnchorElementPointerDataOnHoverTimerFiredPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementPointerDataOnHoverTimerFiredPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementPointerDataOnHoverTimerFiredPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementPointerDataOnHoverTimerFired::anchor_id) anchor_id(
        const ::blink::mojom::AnchorElementPointerDataOnHoverTimerFiredPtr& input)
    {
        return input->anchor_id;
    }

    static const decltype(::blink::mojom::AnchorElementPointerDataOnHoverTimerFired::pointer_data)& pointer_data(
        const ::blink::mojom::AnchorElementPointerDataOnHoverTimerFiredPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementEnteredViewport::DataView, ::blink::mojom::AnchorElementEnteredViewportPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementEnteredViewportPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementEnteredViewportPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementEnteredViewport::anchor_id) anchor_id(const ::blink::mojom::AnchorElementEnteredViewportPtr& input)
    {
        return input->anchor_id;
    }

    static const decltype(::blink::mojom::AnchorElementEnteredViewport::navigation_start_to_entered_viewport)& navigation_start_to_entered_viewport(
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementLeftViewport::DataView, ::blink::mojom::AnchorElementLeftViewportPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementLeftViewportPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementLeftViewportPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementLeftViewport::anchor_id) anchor_id(const ::blink::mojom::AnchorElementLeftViewportPtr& input)
    {
        return input->anchor_id;
    }

    static const decltype(::blink::mojom::AnchorElementLeftViewport::time_in_viewport)& time_in_viewport(
        const ::blink::mojom::AnchorElementLeftViewportPtr& input)
    {
        return input->time_in_viewport;
    }

    static bool Read(::blink::mojom::AnchorElementLeftViewport::DataView input, ::blink::mojom::AnchorElementLeftViewportPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementPointerOver::DataView, ::blink::mojom::AnchorElementPointerOverPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementPointerOverPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementPointerOverPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementPointerOver::anchor_id) anchor_id(const ::blink::mojom::AnchorElementPointerOverPtr& input)
    {
        return input->anchor_id;
    }

    static const decltype(::blink::mojom::AnchorElementPointerOver::navigation_start_to_pointer_over)& navigation_start_to_pointer_over(
        const ::blink::mojom::AnchorElementPointerOverPtr& input)
    {
        return input->navigation_start_to_pointer_over;
    }

    static bool Read(::blink::mojom::AnchorElementPointerOver::DataView input, ::blink::mojom::AnchorElementPointerOverPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementPointerOut::DataView, ::blink::mojom::AnchorElementPointerOutPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementPointerOutPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementPointerOutPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementPointerOut::anchor_id) anchor_id(const ::blink::mojom::AnchorElementPointerOutPtr& input)
    {
        return input->anchor_id;
    }

    static const decltype(::blink::mojom::AnchorElementPointerOut::hover_dwell_time)& hover_dwell_time(const ::blink::mojom::AnchorElementPointerOutPtr& input)
    {
        return input->hover_dwell_time;
    }

    static bool Read(::blink::mojom::AnchorElementPointerOut::DataView input, ::blink::mojom::AnchorElementPointerOutPtr* output);
};

template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementPointerEventForMLModel::DataView, ::blink::mojom::AnchorElementPointerEventForMLModelPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementPointerEventForMLModelPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementPointerEventForMLModelPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementPointerEventForMLModel::anchor_id) anchor_id(
        const ::blink::mojom::AnchorElementPointerEventForMLModelPtr& input)
    {
        return input->anchor_id;
    }

    static decltype(::blink::mojom::AnchorElementPointerEventForMLModel::is_mouse) is_mouse(const ::blink::mojom::AnchorElementPointerEventForMLModelPtr& input)
    {
        return input->is_mouse;
    }

    static decltype(::blink::mojom::AnchorElementPointerEventForMLModel::user_interaction_event_type) user_interaction_event_type(
        const ::blink::mojom::AnchorElementPointerEventForMLModelPtr& input)
    {
        return input->user_interaction_event_type;
    }

    static bool Read(::blink::mojom::AnchorElementPointerEventForMLModel::DataView input, ::blink::mojom::AnchorElementPointerEventForMLModelPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementPointerDown::DataView, ::blink::mojom::AnchorElementPointerDownPtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementPointerDownPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementPointerDownPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementPointerDown::anchor_id) anchor_id(const ::blink::mojom::AnchorElementPointerDownPtr& input)
    {
        return input->anchor_id;
    }

    static const decltype(::blink::mojom::AnchorElementPointerDown::navigation_start_to_pointer_down)& navigation_start_to_pointer_down(
        const ::blink::mojom::AnchorElementPointerDownPtr& input)
    {
        return input->navigation_start_to_pointer_down;
    }

    static bool Read(::blink::mojom::AnchorElementPointerDown::DataView input, ::blink::mojom::AnchorElementPointerDownPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AnchorElementPositionUpdate::DataView, ::blink::mojom::AnchorElementPositionUpdatePtr> {
    static bool IsNull(const ::blink::mojom::AnchorElementPositionUpdatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AnchorElementPositionUpdatePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::AnchorElementPositionUpdate::anchor_id) anchor_id(const ::blink::mojom::AnchorElementPositionUpdatePtr& input)
    {
        return input->anchor_id;
    }

    static decltype(::blink::mojom::AnchorElementPositionUpdate::vertical_position_ratio) vertical_position_ratio(
        const ::blink::mojom::AnchorElementPositionUpdatePtr& input)
    {
        return input->vertical_position_ratio;
    }

    static decltype(::blink::mojom::AnchorElementPositionUpdate::distance_from_pointer_down_ratio) distance_from_pointer_down_ratio(
        const ::blink::mojom::AnchorElementPositionUpdatePtr& input)
    {
        return input->distance_from_pointer_down_ratio;
    }

    static bool Read(::blink::mojom::AnchorElementPositionUpdate::DataView input, ::blink::mojom::AnchorElementPositionUpdatePtr* output);
};
