...
#include "third_party/blink/public/mojom/mediastream/media_devices.mojom-forward.h" // IWYU pragma: export
...
class BLINK_COMMON_EXPORT MediaDevicesDispatcherHost : public MediaDevicesDispatcherHostInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    using EnumerateDevicesCallback = base::OnceCallback<void(const std::vector<std::vector<::blink::WebMediaDeviceInfo>>&,
        std::vector<VideoInputDeviceCapabilitiesPtr>, std::vector<AudioInputDeviceCapabilitiesPtr>)>;
    ...
    virtual void SetCaptureHandleConfig(::blink::mojom::CaptureHandleConfigPtr config) = 0;

    virtual void CloseFocusWindowOfOpportunity(const std::string& label) = 0;
    ...
    virtual void SelectAudioOutput(const std::string& device_id, SelectAudioOutputCallback callback) = 0;
};
...
class BLINK_COMMON_EXPORT MediaDevicesListener : public MediaDevicesListenerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void OnDevicesChanged(MediaDeviceType type, const std::vector<::blink::WebMediaDeviceInfo>& device_infos) = 0;
};

//class BLINK_COMMON_EXPORT MediaDevicesDispatcherHostProxy : public MediaDevicesDispatcherHost {
//public:
...
//
//    void SetCaptureHandleConfig(::blink::mojom::CaptureHandleConfigPtr config) final;
//
...
//
//    void SelectAudioOutput(const std::string& device_id, SelectAudioOutputCallback callback) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};

//class BLINK_COMMON_EXPORT MediaDevicesListenerProxy : public MediaDevicesListener {
//public:
//    using InterfaceType = MediaDevicesListener;
//
//    explicit MediaDevicesListenerProxy(mojo::MessageReceiverWithResponder* receiver);
//
//    void OnDevicesChanged(MediaDeviceType type, const std::vector<::blink::WebMediaDeviceInfo>& device_infos) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};
    ...
    , availability()
{
    ...
    MediaDeviceInfo(const std::string& device_id_in, const std::string& label_in, const std::string& group_id_in,
    ...
    {
        return mojo::internal::SerializeImpl<MediaDeviceInfo::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , availability()
{
    ...
    VideoInputDeviceCapabilities(const std::string& device_id_in, const std::string& group_id_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VideoInputDeviceCapabilities::DataView, std::vector<uint8_t>>(input);
    }
...
class BLINK_COMMON_EXPORT SelectAudioOutputResult {
public:
    ...
    , device_info()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SelectAudioOutputResult::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , latency()
{
    ...
    AudioInputDeviceCapabilities(const std::string& device_id_in, const std::string& group_id_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AudioInputDeviceCapabilities::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::MediaDeviceInfo::DataView, ::blink::mojom::MediaDeviceInfoPtr> {
    static bool IsNull(const ::blink::mojom::MediaDeviceInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::MediaDeviceInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::MediaDeviceInfo::device_id)& device_id(const ::blink::mojom::MediaDeviceInfoPtr& input)
    {
        return input->device_id;
    }

    static const decltype(::blink::mojom::MediaDeviceInfo::label)& label(const ::blink::mojom::MediaDeviceInfoPtr& input)
    {
        return input->label;
    }

    static const decltype(::blink::mojom::MediaDeviceInfo::group_id)& group_id(const ::blink::mojom::MediaDeviceInfoPtr& input)
    {
        return input->group_id;
    }

    static const decltype(::blink::mojom::MediaDeviceInfo::control_support)& control_support(const ::blink::mojom::MediaDeviceInfoPtr& input)
    {
        return input->control_support;
    }

    static decltype(::blink::mojom::MediaDeviceInfo::facing_mode) facing_mode(const ::blink::mojom::MediaDeviceInfoPtr& input)
    {
        return input->facing_mode;
    }

    static decltype(::blink::mojom::MediaDeviceInfo::availability) availability(const ::blink::mojom::MediaDeviceInfoPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::VideoInputDeviceCapabilities::DataView, ::blink::mojom::VideoInputDeviceCapabilitiesPtr> {
    static bool IsNull(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::VideoInputDeviceCapabilitiesPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::VideoInputDeviceCapabilities::device_id)& device_id(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input)
    {
        return input->device_id;
    }

    static const decltype(::blink::mojom::VideoInputDeviceCapabilities::group_id)& group_id(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input)
    {
        return input->group_id;
    }
    ...
    static const decltype(::blink::mojom::VideoInputDeviceCapabilities::formats)& formats(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input)
    {
        return input->formats;
    }

    static decltype(::blink::mojom::VideoInputDeviceCapabilities::facing_mode) facing_mode(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input)
    {
        return input->facing_mode;
    }

    static decltype(::blink::mojom::VideoInputDeviceCapabilities::availability) availability(const ::blink::mojom::VideoInputDeviceCapabilitiesPtr& input)
    {
        return input->availability;
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SelectAudioOutputResult::DataView, ::blink::mojom::SelectAudioOutputResultPtr> {
    static bool IsNull(const ::blink::mojom::SelectAudioOutputResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::SelectAudioOutputResultPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::SelectAudioOutputResult::status) status(const ::blink::mojom::SelectAudioOutputResultPtr& input)
    {
        return input->status;
    }

    static const decltype(::blink::mojom::SelectAudioOutputResult::device_info)& device_info(const ::blink::mojom::SelectAudioOutputResultPtr& input)
    {
        return input->device_info;
    }

    static bool Read(::blink::mojom::SelectAudioOutputResult::DataView input, ::blink::mojom::SelectAudioOutputResultPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AudioInputDeviceCapabilities::DataView, ::blink::mojom::AudioInputDeviceCapabilitiesPtr> {
    static bool IsNull(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::AudioInputDeviceCapabilitiesPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::AudioInputDeviceCapabilities::device_id)& device_id(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
        return input->device_id;
    }

    static const decltype(::blink::mojom::AudioInputDeviceCapabilities::group_id)& group_id(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
        return input->group_id;
    }

    static const decltype(::blink::mojom::AudioInputDeviceCapabilities::parameters)& parameters(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
        return input->parameters;
    }

    static decltype(::blink::mojom::AudioInputDeviceCapabilities::is_valid) is_valid(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
        return input->is_valid;
    }

    static decltype(::blink::mojom::AudioInputDeviceCapabilities::channels) channels(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
        return input->channels;
    }

    static decltype(::blink::mojom::AudioInputDeviceCapabilities::sample_rate) sample_rate(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
        return input->sample_rate;
    }

    static const decltype(::blink::mojom::AudioInputDeviceCapabilities::latency)& latency(const ::blink::mojom::AudioInputDeviceCapabilitiesPtr& input)
    {
