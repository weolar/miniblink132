...
SearchBySessionId::SearchBySessionId(const WTF::HashMap<WTF::String, ::base::UnguessableToken>& session_id_map_in)
...
void SearchBySessionId::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("session_id_map"), this->session_id_map,
        ...
        "<value of type const WTF::HashMap<WTF::String, ::base::UnguessableToken>&>"
#else
        "<value>"
...
MediaStreamDevice::MediaStreamDevice(MediaStreamType type_in, const WTF::String& id_in, int64_t display_id_in, ::media::VideoFacingMode video_facing_in,
...
TrackControls::TrackControls(MediaStreamType stream_type_in, WTF::Vector<WTF::String> device_ids_in)
...
GetOpenDeviceResponse::GetOpenDeviceResponse(const WTF::String& label_in, const ::blink::MediaStreamDevice& device_in, bool pan_tilt_zoom_allowed_in)
...
StreamDevicesSet::StreamDevicesSet(WTF::Vector<StreamDevicesPtr> stream_devices_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<StreamDevicesPtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void MediaStreamDeviceObserverProxy::OnDeviceStopped(const WTF::String& in_label, const ::blink::MediaStreamDevice& in_device)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDeviceObserverProxy::OnDeviceCaptureConfigurationChange(const WTF::String& in_label, const ::blink::MediaStreamDevice& in_device)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void MediaStreamDeviceObserverProxy::OnDeviceCaptureHandleChange(const WTF::String& in_label, const ::blink::MediaStreamDevice& in_device)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDeviceObserverProxy::OnZoomLevelChange(const WTF::String& in_label, const ::blink::MediaStreamDevice& in_device, int32_t in_zoom_level)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::FocusCapturedSurface(const WTF::String& in_label, bool in_focus)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::StopStreamDevice(const WTF::String& in_device_id, const std::optional<::base::UnguessableToken>& in_session_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::OpenDevice(int32_t in_request_id, const WTF::String& in_device_id, MediaStreamType in_type, OpenDeviceCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::CloseDevice(const WTF::String& in_label)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaStreamDispatcherHostProxy::ApplySubCaptureTarget(const ::base::UnguessableToken& in_session_id, ::media::mojom::blink::SubCaptureTargetType in_type,
...
private:
    ...
    void Run(MediaStreamRequestResult in_result, const WTF::String& in_label, StreamDevicesSetPtr in_stream_devices, bool in_pan_tilt_zoom_allowed);
};
...
void MediaStreamDispatcherHost_GenerateStreams_ProxyToResponder::Run(
    MediaStreamRequestResult in_result, const WTF::String& in_label, StreamDevicesSetPtr in_stream_devices, bool in_pan_tilt_zoom_allowed)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
private:
    ...
    void Run(bool in_success, const WTF::String& in_label, const ::blink::MediaStreamDevice& in_device);
};
...
void MediaStreamDispatcherHost_OpenDevice_ProxyToResponder::Run(bool in_success, const WTF::String& in_label, const ::blink::MediaStreamDevice& in_device)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(::media::mojom::blink::ApplySubCaptureTargetResult in_result);
};
...
void MediaStreamDispatcherHost_ApplySubCaptureTarget_ProxyToResponder::Run(::media::mojom::blink::ApplySubCaptureTargetResult in_result)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply blink::mojom::MediaStreamDispatcherHost::ApplySubCaptureTarget", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type ::media::mojom::blink::ApplySubCaptureTargetResult>");
        });
#endif
...
bool StructTraits<::blink::mojom::blink::SearchOnlyByDeviceId::DataView, ::blink::mojom::blink::SearchOnlyByDeviceIdPtr>::Read(
    ::blink::mojom::blink::SearchOnlyByDeviceId::DataView input, ::blink::mojom::blink::SearchOnlyByDeviceIdPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::SearchBySessionId::DataView, ::blink::mojom::blink::SearchBySessionIdPtr>::Read(
    ::blink::mojom::blink::SearchBySessionId::DataView input, ::blink::mojom::blink::SearchBySessionIdPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::MediaStreamDevice::DataView, ::blink::mojom::blink::MediaStreamDevicePtr>::Read(
    ::blink::mojom::blink::MediaStreamDevice::DataView input, ::blink::mojom::blink::MediaStreamDevicePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::TrackControls::DataView, ::blink::mojom::blink::TrackControlsPtr>::Read(
    ::blink::mojom::blink::TrackControls::DataView input, ::blink::mojom::blink::TrackControlsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::StreamControls::DataView, ::blink::mojom::blink::StreamControlsPtr>::Read(
    ::blink::mojom::blink::StreamControls::DataView input, ::blink::mojom::blink::StreamControlsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::GetOpenDeviceResponse::DataView, ::blink::mojom::blink::GetOpenDeviceResponsePtr>::Read(
    ::blink::mojom::blink::GetOpenDeviceResponse::DataView input, ::blink::mojom::blink::GetOpenDeviceResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::CapturedWheelAction::DataView, ::blink::mojom::blink::CapturedWheelActionPtr>::Read(
    ::blink::mojom::blink::CapturedWheelAction::DataView input, ::blink::mojom::blink::CapturedWheelActionPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::StreamDevices::DataView, ::blink::mojom::blink::StreamDevicesPtr>::Read(
    ::blink::mojom::blink::StreamDevices::DataView input, ::blink::mojom::blink::StreamDevicesPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::StreamDevicesSet::DataView, ::blink::mojom::blink::StreamDevicesSetPtr>::Read(
    ::blink::mojom::blink::StreamDevicesSet::DataView input, ::blink::mojom::blink::StreamDevicesSetPtr* output)
{
    bool success = true;
...
bool UnionTraits<::blink::mojom::blink::StreamSelectionInfo::DataView, ::blink::mojom::blink::StreamSelectionInfoPtr>::Read(
    ::blink::mojom::blink::StreamSelectionInfo::DataView input, ::blink::mojom::blink::StreamSelectionInfoPtr* output)
{
...
void MediaStreamDeviceObserverInterceptorForTesting::OnDeviceChanged(
    const WTF::String& label, const ::blink::MediaStreamDevice& old_device, const ::blink::MediaStreamDevice& new_device)
{
...
void MediaStreamDeviceObserverInterceptorForTesting::OnDeviceRequestStateChange(
    const WTF::String& label, const ::blink::MediaStreamDevice& device, MediaStreamStateChange new_state)
{
    GetForwardingInterface()->OnDeviceRequestStateChange(std::move(label), std::move(device), std::move(new_state));
}
void MediaStreamDeviceObserverInterceptorForTesting::OnDeviceCaptureConfigurationChange(const WTF::String& label, const ::blink::MediaStreamDevice& device)
{
    GetForwardingInterface()->OnDeviceCaptureConfigurationChange(std::move(label), std::move(device));
}
void MediaStreamDeviceObserverInterceptorForTesting::OnDeviceCaptureHandleChange(const WTF::String& label, const ::blink::MediaStreamDevice& device)
{
    GetForwardingInterface()->OnDeviceCaptureHandleChange(std::move(label), std::move(device));
}
void MediaStreamDeviceObserverInterceptorForTesting::OnZoomLevelChange(const WTF::String& label, const ::blink::MediaStreamDevice& device, int32_t zoom_level)
{
...
void MediaStreamDispatcherHostInterceptorForTesting::FocusCapturedSurface(const WTF::String& label, bool focus)
{
...
void MediaStreamDispatcherHostInterceptorForTesting::OpenDevice(
    int32_t request_id, const WTF::String& device_id, MediaStreamType type, OpenDeviceCallback callback)
{
...
void MediaStreamDispatcherHostAsyncWaiter::GenerateStreams(int32_t request_id, const ::blink::StreamControls& controls, bool user_gesture,
    StreamSelectionInfoPtr audio_stream_selection_info, MediaStreamRequestResult* out_result, WTF::String* out_label, StreamDevicesSetPtr* out_stream_devices,
    bool* out_pan_tilt_zoom_allowed)
{
    ...
    proxy_->GenerateStreams(std::move(request_id), std::move(controls), std::move(user_gesture), std::move(audio_stream_selection_info),
        base::BindOnce(
            [](base::RunLoop* loop, MediaStreamRequestResult* out_result, WTF::String* out_label, StreamDevicesSetPtr* out_stream_devices,
                bool* out_pan_tilt_zoom_allowed, MediaStreamRequestResult result, const WTF::String& label, StreamDevicesSetPtr stream_devices,
    ...
    int32_t request_id, const WTF::String& device_id, MediaStreamType type, bool* out_success, WTF::String* out_label, ::blink::MediaStreamDevice* out_device)
{
    ...
    proxy_->OpenDevice(std::move(request_id), std::move(device_id), std::move(type),
        base::BindOnce(
            [](base::RunLoop* loop, bool* out_success, WTF::String* out_label, ::blink::MediaStreamDevice* out_device, bool success, const WTF::String& label,
...
void MediaStreamDispatcherHostAsyncWaiter::ApplySubCaptureTarget(const ::base::UnguessableToken& session_id, ::media::mojom::blink::SubCaptureTargetType type,
    const ::base::Token& sub_capture_target, uint32_t sub_capture_target_version, ::media::mojom::blink::ApplySubCaptureTargetResult* out_result)
{
    ...
    proxy_->ApplySubCaptureTarget(std::move(session_id), std::move(type), std::move(sub_capture_target), std::move(sub_capture_target_version),
        base::BindOnce(
            [](base::RunLoop* loop, ::media::mojom::blink::ApplySubCaptureTargetResult* out_result, ::media::mojom::blink::ApplySubCaptureTargetResult result) {
                *out_result = std::move(result);
                loop->Quit();
            },
            &loop, out_result));
...
::media::mojom::blink::ApplySubCaptureTargetResult MediaStreamDispatcherHostAsyncWaiter::ApplySubCaptureTarget(const ::base::UnguessableToken& session_id,
    ::media::mojom::blink::SubCaptureTargetType type, const ::base::Token& sub_capture_target, uint32_t sub_capture_target_version)
{
