...
class BLINK_COMMON_EXPORT MediaStreamDeviceObserver : public MediaStreamDeviceObserverInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void OnDeviceRequestStateChange(const std::string& label, const ::blink::MediaStreamDevice& device, MediaStreamStateChange new_state) = 0;

    virtual void OnDeviceCaptureConfigurationChange(const std::string& label, const ::blink::MediaStreamDevice& device) = 0;
...
class BLINK_COMMON_EXPORT MediaStreamDispatcherHost : public MediaStreamDispatcherHostInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    using GenerateStreamsCallback = base::OnceCallback<void(MediaStreamRequestResult, const std::string&, StreamDevicesSetPtr, bool)>;
    ...
    virtual void FocusCapturedSurface(const std::string& label, bool focus) = 0;
    ...
    virtual void OpenDevice(int32_t request_id, const std::string& device_id, MediaStreamType type, OpenDeviceCallback callback) = 0;
    ...
    virtual void ApplySubCaptureTarget(const ::base::UnguessableToken& session_id, ::media::mojom::SubCaptureTargetType type,
...
class BLINK_COMMON_EXPORT MediaStreamTrackMetricsHost : public MediaStreamTrackMetricsHostInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT MediaStreamDeviceObserverProxy : public MediaStreamDeviceObserver {
//public:
...
//
//    void OnDeviceRequestStateChange(const std::string& label, const ::blink::MediaStreamDevice& device, MediaStreamStateChange new_state) final;
//
...
//class BLINK_COMMON_EXPORT MediaStreamDispatcherHostProxy : public MediaStreamDispatcherHost {
//public:
...
//
//    void FocusCapturedSurface(const std::string& label, bool focus) final;
//
...
//        uint32_t sub_capture_target_version, ApplySubCaptureTargetCallback callback) final;
//
...
//class BLINK_COMMON_EXPORT MediaStreamTrackMetricsHostProxy : public MediaStreamTrackMetricsHost {
//public:
    ...
    SearchOnlyByDeviceId()
{
    ...
    {
        return mojo::internal::SerializeImpl<SearchOnlyByDeviceId::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , wheel_delta_y()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<CapturedWheelAction::DataView, std::vector<uint8_t>>(input);
    }
    ...
    : session_id_map()
{
    ...
    explicit SearchBySessionId(const base::flat_map<std::string, ::base::UnguessableToken>& session_id_map_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SearchBySessionId::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , display_media_info()
{
    ...
    MediaStreamDevice(MediaStreamType type_in, const std::string& id_in, int64_t display_id_in, ::media::VideoFacingMode video_facing_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<MediaStreamDevice::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , device_ids()
{
    ...
    TrackControls(MediaStreamType stream_type_in, std::vector<std::string> device_ids_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<TrackControls::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , exclude_monitor_type_surfaces()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<StreamControls::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , pan_tilt_zoom_allowed()
{
    ...
    GetOpenDeviceResponse(const std::string& label_in, const ::blink::MediaStreamDevice& device_in, bool pan_tilt_zoom_allowed_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<GetOpenDeviceResponse::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , video_device()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<StreamDevices::DataView, std::vector<uint8_t>>(input);
    }
    ...
    : stream_devices()
{
    ...
    explicit StreamDevicesSet(std::vector<StreamDevicesPtr> stream_devices_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<StreamDevicesSet::DataView, std::vector<uint8_t>>(input);
    }
    ...
    std::vector<StreamDevicesPtr> stream_devices;
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SearchOnlyByDeviceId::DataView, ::blink::mojom::SearchOnlyByDeviceIdPtr> {
    static bool IsNull(const ::blink::mojom::SearchOnlyByDeviceIdPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::SearchOnlyByDeviceIdPtr* output)
    {
        output->reset();
    }

    static bool Read(::blink::mojom::SearchOnlyByDeviceId::DataView input, ::blink::mojom::SearchOnlyByDeviceIdPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SearchBySessionId::DataView, ::blink::mojom::SearchBySessionIdPtr> {
    static bool IsNull(const ::blink::mojom::SearchBySessionIdPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::SearchBySessionIdPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::SearchBySessionId::session_id_map)& session_id_map(const ::blink::mojom::SearchBySessionIdPtr& input)
    {
        return input->session_id_map;
    }

    static bool Read(::blink::mojom::SearchBySessionId::DataView input, ::blink::mojom::SearchBySessionIdPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::MediaStreamDevice::DataView, ::blink::mojom::MediaStreamDevicePtr> {
    static bool IsNull(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::MediaStreamDevicePtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::MediaStreamDevice::type) type(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->type;
    }

    static const decltype(::blink::mojom::MediaStreamDevice::id)& id(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->id;
    }

    static decltype(::blink::mojom::MediaStreamDevice::display_id) display_id(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->display_id;
    }

    static decltype(::blink::mojom::MediaStreamDevice::video_facing) video_facing(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->video_facing;
    }

    static const decltype(::blink::mojom::MediaStreamDevice::group_id)& group_id(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
    ...
    static const decltype(::blink::mojom::MediaStreamDevice::name)& name(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->name;
    }

    static const decltype(::blink::mojom::MediaStreamDevice::input)& input(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->input;
    }

    static const decltype(::blink::mojom::MediaStreamDevice::session_id)& session_id(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
        return input->session_id;
    }

    static const decltype(::blink::mojom::MediaStreamDevice::display_media_info)& display_media_info(const ::blink::mojom::MediaStreamDevicePtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TrackControls::DataView, ::blink::mojom::TrackControlsPtr> {
    static bool IsNull(const ::blink::mojom::TrackControlsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::TrackControlsPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::TrackControls::stream_type) stream_type(const ::blink::mojom::TrackControlsPtr& input)
    {
        return input->stream_type;
    }

    static const decltype(::blink::mojom::TrackControls::device_ids)& device_ids(const ::blink::mojom::TrackControlsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamControls::DataView, ::blink::mojom::StreamControlsPtr> {
    static bool IsNull(const ::blink::mojom::StreamControlsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::StreamControlsPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::StreamControls::audio)& audio(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->audio;
    }

    static const decltype(::blink::mojom::StreamControls::video)& video(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->video;
    }

    static decltype(::blink::mojom::StreamControls::hotword_enabled) hotword_enabled(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->hotword_enabled;
    }

    static decltype(::blink::mojom::StreamControls::disable_local_echo) disable_local_echo(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->disable_local_echo;
    }

    static decltype(::blink::mojom::StreamControls::suppress_local_audio_playback) suppress_local_audio_playback(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->suppress_local_audio_playback;
    }

    static decltype(::blink::mojom::StreamControls::exclude_system_audio) exclude_system_audio(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->exclude_system_audio;
    }

    static decltype(::blink::mojom::StreamControls::exclude_self_browser_surface) exclude_self_browser_surface(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->exclude_self_browser_surface;
    }

    static decltype(::blink::mojom::StreamControls::request_pan_tilt_zoom_permission) request_pan_tilt_zoom_permission(
        const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->request_pan_tilt_zoom_permission;
    }

    static decltype(::blink::mojom::StreamControls::request_all_screens) request_all_screens(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->request_all_screens;
    }

    static decltype(::blink::mojom::StreamControls::preferred_display_surface) preferred_display_surface(const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->preferred_display_surface;
    }

    static decltype(::blink::mojom::StreamControls::dynamic_surface_switching_requested) dynamic_surface_switching_requested(
        const ::blink::mojom::StreamControlsPtr& input)
    {
        return input->dynamic_surface_switching_requested;
    }

    static decltype(::blink::mojom::StreamControls::exclude_monitor_type_surfaces) exclude_monitor_type_surfaces(const ::blink::mojom::StreamControlsPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::GetOpenDeviceResponse::DataView, ::blink::mojom::GetOpenDeviceResponsePtr> {
    static bool IsNull(const ::blink::mojom::GetOpenDeviceResponsePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::GetOpenDeviceResponsePtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::GetOpenDeviceResponse::label)& label(const ::blink::mojom::GetOpenDeviceResponsePtr& input)
    {
        return input->label;
    }

    static const decltype(::blink::mojom::GetOpenDeviceResponse::device)& device(const ::blink::mojom::GetOpenDeviceResponsePtr& input)
    {
        return input->device;
    }

    static decltype(::blink::mojom::GetOpenDeviceResponse::pan_tilt_zoom_allowed) pan_tilt_zoom_allowed(const ::blink::mojom::GetOpenDeviceResponsePtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::CapturedWheelAction::DataView, ::blink::mojom::CapturedWheelActionPtr> {
    static bool IsNull(const ::blink::mojom::CapturedWheelActionPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::CapturedWheelActionPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::CapturedWheelAction::relative_x) relative_x(const ::blink::mojom::CapturedWheelActionPtr& input)
    {
        return input->relative_x;
    }

    static decltype(::blink::mojom::CapturedWheelAction::relative_y) relative_y(const ::blink::mojom::CapturedWheelActionPtr& input)
    {
        return input->relative_y;
    }

    static decltype(::blink::mojom::CapturedWheelAction::wheel_delta_x) wheel_delta_x(const ::blink::mojom::CapturedWheelActionPtr& input)
    {
        return input->wheel_delta_x;
    }

    static decltype(::blink::mojom::CapturedWheelAction::wheel_delta_y) wheel_delta_y(const ::blink::mojom::CapturedWheelActionPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamDevices::DataView, ::blink::mojom::StreamDevicesPtr> {
    static bool IsNull(const ::blink::mojom::StreamDevicesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::StreamDevicesPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::StreamDevices::audio_device)& audio_device(const ::blink::mojom::StreamDevicesPtr& input)
    {
        return input->audio_device;
    }

    static const decltype(::blink::mojom::StreamDevices::video_device)& video_device(const ::blink::mojom::StreamDevicesPtr& input)
    {
        return input->video_device;
    }

    static bool Read(::blink::mojom::StreamDevices::DataView input, ::blink::mojom::StreamDevicesPtr* output);
};

template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamDevicesSet::DataView, ::blink::mojom::StreamDevicesSetPtr> {
    static bool IsNull(const ::blink::mojom::StreamDevicesSetPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::StreamDevicesSetPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::StreamDevicesSet::stream_devices)& stream_devices(const ::blink::mojom::StreamDevicesSetPtr& input)
    {
        return input->stream_devices;
    }

    static bool Read(::blink::mojom::StreamDevicesSet::DataView input, ::blink::mojom::StreamDevicesSetPtr* output);
};

template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::StreamSelectionInfo::DataView, ::blink::mojom::StreamSelectionInfoPtr> {
    static bool IsNull(const ::blink::mojom::StreamSelectionInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::StreamSelectionInfoPtr* output)
    {
        output->reset();
    }

    static ::blink::mojom::StreamSelectionInfo::Tag GetTag(const ::blink::mojom::StreamSelectionInfoPtr& input)
    {
        return input->which();
    }

    static const ::blink::mojom::SearchOnlyByDeviceIdPtr& search_only_by_device_id(const ::blink::mojom::StreamSelectionInfoPtr& input)
    {
        return input->get_search_only_by_device_id();
    }

    static const ::blink::mojom::SearchBySessionIdPtr& search_by_session_id(const ::blink::mojom::StreamSelectionInfoPtr& input)
    {
        return input->get_search_by_session_id();
    }

    static bool Read(::blink::mojom::StreamSelectionInfo::DataView input, ::blink::mojom::StreamSelectionInfoPtr* output);
};
