...
// static
bool BrowserInterfaceBroker_GetInterface_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const BrowserInterfaceBroker_GetInterface_Params_Data* object = static_cast<const BrowserInterfaceBroker_GetInterface_Params_Data*>(data);
