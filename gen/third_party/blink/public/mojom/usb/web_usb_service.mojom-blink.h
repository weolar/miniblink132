...
class PLATFORM_EXPORT WebUsbService : public WebUsbServiceInterfaceBase {
public:
...
//class PLATFORM_EXPORT WebUsbServiceProxy : public WebUsbService {
//public:
    ...
    , exclusion_filters()
{
    ...
    {
        return mojo::internal::SerializeImpl<WebUsbRequestDeviceOptions::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::WebUsbRequestDeviceOptions::DataView, ::blink::mojom::blink::WebUsbRequestDeviceOptionsPtr> {
    static bool IsNull(const ::blink::mojom::blink::WebUsbRequestDeviceOptionsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::WebUsbRequestDeviceOptionsPtr* output)
    {
        output->reset();
    }
