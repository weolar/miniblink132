...
public:
    ...
    void GetRegistrations(int64_t service_worker_registration_id, BackgroundSyncError* out_err, std::vector<SyncRegistrationOptionsPtr>* out_registrations);
...
public:
    ...
    void Unregister(int64_t service_worker_registration_id, const std::string& tag, BackgroundSyncError* out_err);
    BackgroundSyncError Unregister(int64_t service_worker_registration_id, const std::string& tag);
    void GetRegistrations(int64_t service_worker_registration_id, BackgroundSyncError* out_err, std::vector<SyncRegistrationOptionsPtr>* out_registrations);
