...
#include "third_party/blink/public/mojom/peerconnection/peer_connection_tracker.mojom-blink-forward.h" // IWYU pragma: export
...
// with not having this data in traces there.
    ...
    virtual void GetUserMediaSuccess(int32_t request_id, const WTF::String& stream_id, const WTF::String& audio_track_info, const WTF::String& video_track_info)
        = 0;

    virtual void GetUserMediaFailure(int32_t request_id, const WTF::String& error, const WTF::String& error_message) = 0;

    virtual void GetDisplayMedia(int32_t request_id, bool audio, bool video, const WTF::String& audio_constraints, const WTF::String& video_constraints) = 0;
    ...
    virtual void GetDisplayMediaFailure(int32_t request_id, const WTF::String& error, const WTF::String& error_message) = 0;
...
//class PLATFORM_EXPORT PeerConnectionManagerProxy : public PeerConnectionManager {
//public:
...
//class PLATFORM_EXPORT PeerConnectionTrackerHostProxy : public PeerConnectionTrackerHost {
//public:
...
//
//    void GetDisplayMedia(int32_t request_id, bool audio, bool video, const WTF::String& audio_constraints, const WTF::String& video_constraints) final;
//
//    void GetDisplayMediaSuccess(
//        int32_t request_id, const WTF::String& stream_id, const WTF::String& audio_track_info, const WTF::String& video_track_info) final;
//
//    void GetDisplayMediaFailure(int32_t request_id, const WTF::String& error, const WTF::String& error_message) final;
//
    ...
    , url()
{
    ...
    PeerConnectionInfo(int32_t lid_in, const WTF::String& rtc_configuration_in, const WTF::String& url_in)
    : lid(std::move(lid_in))
...
template <> struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PeerConnectionInfo::DataView, ::blink::mojom::blink::PeerConnectionInfoPtr> {
    static bool IsNull(const ::blink::mojom::blink::PeerConnectionInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::PeerConnectionInfoPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::blink::PeerConnectionInfo::lid) lid(const ::blink::mojom::blink::PeerConnectionInfoPtr& input)
    {
        return input->lid;
    }
    ...
    static const decltype(::blink::mojom::blink::PeerConnectionInfo::url)& url(const ::blink::mojom::blink::PeerConnectionInfoPtr& input)
    {
        return input->url;
    }
