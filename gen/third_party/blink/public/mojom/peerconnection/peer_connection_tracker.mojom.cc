...
PeerConnectionInfo::PeerConnectionInfo(int32_t lid_in, const std::string& rtc_configuration_in, const std::optional<std::string>& url_in)
    : lid(std::move(lid_in))
...
void PeerConnectionTrackerHostProxy::UpdatePeerConnection(int32_t in_lid, const std::string& in_type, const std::string& in_value)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PeerConnectionTrackerHostProxy::OnPeerConnectionSessionIdSet(int32_t in_lid, const std::string& in_session_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    int32_t in_request_id, bool in_audio, bool in_video, const std::string& in_audio_constraints, const std::string& in_video_constraints)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::PeerConnectionTrackerHost::GetUserMedia", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("audio_constraints"), in_audio_constraints, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("video_constraints"), in_video_constraints, "<value of type const std::string&>");
    });
#endif
    ...
    int32_t in_request_id, const std::string& in_stream_id, const std::string& in_audio_track_info, const std::string& in_video_track_info)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::PeerConnectionTrackerHost::GetUserMediaSuccess", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("request_id"), in_request_id, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("stream_id"), in_stream_id, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("audio_track_info"), in_audio_track_info, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("video_track_info"), in_video_track_info, "<value of type const std::string&>");
    });
#endif
...
void PeerConnectionTrackerHostProxy::GetUserMediaFailure(int32_t in_request_id, const std::string& in_error, const std::string& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PeerConnectionTrackerHostProxy::GetDisplayMediaFailure(int32_t in_request_id, const std::string& in_error, const std::string& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PeerConnectionTrackerHostProxy::WebRtcEventLogWrite(int32_t in_lid, const std::vector<uint8_t>& in_output)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::PeerConnectionTrackerHost::WebRtcEventLogWrite", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("lid"), in_lid, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("output"), in_output, "<value of type const std::vector<uint8_t>&>");
    });
#endif
...
bool StructTraits<::blink::mojom::PeerConnectionInfo::DataView, ::blink::mojom::PeerConnectionInfoPtr>::Read(
    ::blink::mojom::PeerConnectionInfo::DataView input, ::blink::mojom::PeerConnectionInfoPtr* output)
{
    bool success = true;
...
void PeerConnectionTrackerHostInterceptorForTesting::GetUserMedia(
    int32_t request_id, bool audio, bool video, const std::string& audio_constraints, const std::string& video_constraints)
{
