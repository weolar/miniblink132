...
class BLINK_COMMON_EXPORT PeerConnectionManager : public PeerConnectionManagerInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT PeerConnectionTrackerHost : public PeerConnectionTrackerHostInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void GetUserMediaSuccess(int32_t request_id, const std::string& stream_id, const std::string& audio_track_info, const std::string& video_track_info)
        = 0;
    ...
    virtual void GetDisplayMediaSuccess(
        int32_t request_id, const std::string& stream_id, const std::string& audio_track_info, const std::string& video_track_info)
        = 0;
...
//class BLINK_COMMON_EXPORT PeerConnectionManagerProxy : public PeerConnectionManager {
//public:
...
//class BLINK_COMMON_EXPORT PeerConnectionTrackerHostProxy : public PeerConnectionTrackerHost {
//public:
...
//        int32_t request_id, const std::string& stream_id, const std::string& audio_track_info, const std::string& video_track_info) final;
//
...
//    static bool AcceptWithResponder(PeerConnectionManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
//};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<PeerConnectionManager>>
//class PeerConnectionManagerStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return PeerConnectionManagerStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return PeerConnectionManagerStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
...
//    static bool AcceptWithResponder(PeerConnectionTrackerHost* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
//};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<PeerConnectionTrackerHost>>
//class PeerConnectionTrackerHostStub : public mojo::MessageReceiverWithResponderStatus {
//public:
//    using ImplPointerType = typename ImplRefTraits::PointerType;
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return PeerConnectionTrackerHostStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
//    bool AcceptWithResponder(mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder) override
//    {
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return PeerConnectionTrackerHostStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
//    ImplPointerType sink_;
...
public:
    ...
    template <typename... Args> static PeerConnectionInfoPtr New(Args&&... args)
    {
        return PeerConnectionInfoPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static PeerConnectionInfoPtr From(const U& u)
    {
    ...
    , url()
{
    ...
    PeerConnectionInfo(int32_t lid_in, const std::string& rtc_configuration_in, const std::optional<std::string>& url_in)
    : lid(std::move(lid_in))
    ...
    template <typename T, PeerConnectionInfo::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    {
        return mojo::internal::SerializeImpl<PeerConnectionInfo::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<PeerConnectionInfo::DataView>(input);
    }
    ...
    {
        return mojo::Message(
            std::make_unique<internal::PeerConnectionInfo_UnserializedMessageContext<UserType, PeerConnectionInfo::DataView>>(0, 0, std::move(input)),
    ...
    {
        return PeerConnectionInfo::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }
...
{
    return New(mojo::Clone(lid), mojo::Clone(rtc_configuration), mojo::Clone(url));
}
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PeerConnectionInfo::DataView, ::blink::mojom::PeerConnectionInfoPtr> {
    static bool IsNull(const ::blink::mojom::PeerConnectionInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::PeerConnectionInfoPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::PeerConnectionInfo::lid) lid(const ::blink::mojom::PeerConnectionInfoPtr& input)
    {
        return input->lid;
    }

    static const decltype(::blink::mojom::PeerConnectionInfo::rtc_configuration)& rtc_configuration(const ::blink::mojom::PeerConnectionInfoPtr& input)
    {
        return input->rtc_configuration;
    }

    static const decltype(::blink::mojom::PeerConnectionInfo::url)& url(const ::blink::mojom::PeerConnectionInfoPtr& input)
    {
        return input->url;
    }
