...
class PLATFORM_EXPORT PeerConnectionTrackerHostInterceptorForTesting : public PeerConnectionTrackerHost {
    ...
    void GetUserMedia(int32_t request_id, bool audio, bool video, const WTF::String& audio_constraints, const WTF::String& video_constraints) override;
    void GetUserMediaSuccess(
        int32_t request_id, const WTF::String& stream_id, const WTF::String& audio_track_info, const WTF::String& video_track_info) override;
    void GetUserMediaFailure(int32_t request_id, const WTF::String& error, const WTF::String& error_message) override;
    void GetDisplayMedia(int32_t request_id, bool audio, bool video, const WTF::String& audio_constraints, const WTF::String& video_constraints) override;
    void GetDisplayMediaSuccess(
        int32_t request_id, const WTF::String& stream_id, const WTF::String& audio_track_info, const WTF::String& video_track_info) override;
    void GetDisplayMediaFailure(int32_t request_id, const WTF::String& error, const WTF::String& error_message) override;
