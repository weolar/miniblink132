    ...
    , local_surface_id()
{
    ...
    const ::gfx::Size& max_size_for_auto_resize_in, WTF::Vector<::gfx::Rect> root_widget_viewport_segments_in, const ::gfx::Rect& compositor_viewport_in,
    ...
    {
        return mojo::internal::SerializeImpl<FrameVisualProperties::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <> struct CORE_EXPORT StructTraits<::blink::mojom::blink::FrameVisualProperties::DataView, ::blink::mojom::blink::FrameVisualPropertiesPtr> {
    static bool IsNull(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::FrameVisualPropertiesPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::blink::mojom::blink::FrameVisualProperties::zoom_level) zoom_level(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
        return input->zoom_level;
    }

    static decltype(::blink::mojom::blink::FrameVisualProperties::css_zoom_factor) css_zoom_factor(const ::blink::mojom::blink::FrameVisualPropertiesPtr& input)
    {
