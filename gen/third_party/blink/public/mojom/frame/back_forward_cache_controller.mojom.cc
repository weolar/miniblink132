...
BlockingDetails::BlockingDetails(uint32_t feature_in, ::blink::mojom::ScriptSourceLocationPtr source_in)
    ...
    ::blink::mojom::RendererEvictionReason in_reason, ::blink::mojom::ScriptSourceLocationPtr in_source)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send blink::mojom::BackForwardCacheControllerHost::EvictFromBackForwardCache", "input_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("reason"), in_reason, "<value of type ::blink::mojom::RendererEvictionReason>");
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("source"), in_source, "<value of type ::blink::mojom::ScriptSourceLocationPtr>");
        });
#endif
...
void BackForwardCacheControllerHostProxy::DidChangeBackForwardCacheDisablingFeatures(std::vector<BlockingDetailsPtr> in_details)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::BackForwardCacheControllerHost::DidChangeBackForwardCacheDisablingFeatures", "input_parameters",
        [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("details"), in_details, "<value of type std::vector<BlockingDetailsPtr>>");
        });
#endif
...
{
    const char* name = ::blink::mojom::BackForwardCacheControllerHost::Name_;
...
bool StructTraits<::blink::mojom::BlockingDetails::DataView, ::blink::mojom::BlockingDetailsPtr>::Read(
    ::blink::mojom::BlockingDetails::DataView input, ::blink::mojom::BlockingDetailsPtr* output)
{
    bool success = true;
...
void BackForwardCacheControllerHostInterceptorForTesting::EvictFromBackForwardCache(
    ::blink::mojom::RendererEvictionReason reason, ::blink::mojom::ScriptSourceLocationPtr source)
{
