    ...
    , main_frame_transform()
{
    ...
    {
        return mojo::internal::SerializeImpl<ViewportIntersectionState::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ViewportIntersectionState::DataView, ::blink::mojom::ViewportIntersectionStatePtr> {
    static bool IsNull(const ::blink::mojom::ViewportIntersectionStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::ViewportIntersectionStatePtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::blink::mojom::ViewportIntersectionState::occlusion_state) occlusion_state(const ::blink::mojom::ViewportIntersectionStatePtr& input)
    {
