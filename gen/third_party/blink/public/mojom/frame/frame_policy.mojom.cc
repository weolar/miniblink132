...
FramePolicy::FramePolicy(::network::mojom::WebSandboxFlags sandbox_flags_in, std::vector<::blink::ParsedPermissionsPolicyDeclaration> container_policy_in,
...
bool StructTraits<::blink::mojom::FramePolicy::DataView, ::blink::mojom::FramePolicyPtr>::Read(
    ::blink::mojom::FramePolicy::DataView input, ::blink::mojom::FramePolicyPtr* output)
{
    bool success = true;
