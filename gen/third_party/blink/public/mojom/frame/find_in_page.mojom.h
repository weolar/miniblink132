...
class BLINK_COMMON_EXPORT FindInPage : public FindInPageInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT FindInPageClient : public FindInPageClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT FindInPageProxy : public FindInPage {
//public:
...
//class BLINK_COMMON_EXPORT FindInPageClientProxy : public FindInPageClient {
//public:
    ...
    , run_synchronously_for_testing(false)
{
    ...
    {
        return mojo::internal::SerializeImpl<FindOptions::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FindOptions::DataView, ::blink::mojom::FindOptionsPtr> {
    static bool IsNull(const ::blink::mojom::FindOptionsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::FindOptionsPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::FindOptions::forward) forward(const ::blink::mojom::FindOptionsPtr& input)
    {
        return input->forward;
    }

    static decltype(::blink::mojom::FindOptions::match_case) match_case(const ::blink::mojom::FindOptionsPtr& input)
    {
        return input->match_case;
    }

    static decltype(::blink::mojom::FindOptions::new_session) new_session(const ::blink::mojom::FindOptionsPtr& input)
    {
        return input->new_session;
    }

    static decltype(::blink::mojom::FindOptions::find_match) find_match(const ::blink::mojom::FindOptionsPtr& input)
    {
        return input->find_match;
    }

    static decltype(::blink::mojom::FindOptions::force) force(const ::blink::mojom::FindOptionsPtr& input)
    {
        return input->force;
    }

    static decltype(::blink::mojom::FindOptions::run_synchronously_for_testing) run_synchronously_for_testing(const ::blink::mojom::FindOptionsPtr& input)
    {
