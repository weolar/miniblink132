    ...
    , is_ad_frame(false)
{
    ...
    FrameReplicationState(const ::url::Origin& origin_in, const std::string& name_in, const std::string& unique_name_in,
    ...
    {
        return mojo::internal::SerializeImpl<FrameReplicationState::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FrameReplicationState::DataView, ::blink::mojom::FrameReplicationStatePtr> {
    static bool IsNull(const ::blink::mojom::FrameReplicationStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::FrameReplicationStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::FrameReplicationState::origin)& origin(const ::blink::mojom::FrameReplicationStatePtr& input)
    {
        return input->origin;
    }

    static const decltype(::blink::mojom::FrameReplicationState::name)& name(const ::blink::mojom::FrameReplicationStatePtr& input)
    {
        return input->name;
    }

    static const decltype(::blink::mojom::FrameReplicationState::unique_name)& unique_name(const ::blink::mojom::FrameReplicationStatePtr& input)
    {
    ...
    static decltype(::blink::mojom::FrameReplicationState::active_sandbox_flags) active_sandbox_flags(const ::blink::mojom::FrameReplicationStatePtr& input)
    {
        return input->active_sandbox_flags;
    }

    static const decltype(::blink::mojom::FrameReplicationState::frame_policy)& frame_policy(const ::blink::mojom::FrameReplicationStatePtr& input)
    {
    ...
    static decltype(::blink::mojom::FrameReplicationState::is_ad_frame) is_ad_frame(const ::blink::mojom::FrameReplicationStatePtr& input)
    {
