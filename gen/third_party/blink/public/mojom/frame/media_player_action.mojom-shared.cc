...
// static
bool MediaPlayerAction_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const MediaPlayerAction_Data* object = static_cast<const MediaPlayerAction_Data*>(data);

    if (!::blink::mojom::internal::MediaPlayerActionType_Data ::Validate(object->type, validation_context))
        return false;
...
// static
void TraceFormatTraits<::blink::mojom::MediaPlayerActionType>::WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::MediaPlayerActionType value)
{
