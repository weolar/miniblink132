...
void WebSocketConnectorProxy::Connect(const ::GURL& in_url, const std::vector<std::string>& in_requested_protocols,
    const ::net::SiteForCookies& in_site_for_cookies, const std::optional<std::string>& in_user_agent,
    ::net::StorageAccessApiStatus in_storage_access_api_status, ::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient> in_handshake_client,
    const std::optional<::base::UnguessableToken>& in_throttling_profile_id)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::WebSocketConnector::Connect", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("user_agent"), in_user_agent, "<value of type const std::optional<std::string>&>");
        perfetto::WriteIntoTracedValueWithFallback(
...
void WebSocketConnectorInterceptorForTesting::Connect(const ::GURL& url, const std::vector<std::string>& requested_protocols,
    const ::net::SiteForCookies& site_for_cookies, const std::optional<std::string>& user_agent, ::net::StorageAccessApiStatus storage_access_api_status,
    ::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient> handshake_client, const std::optional<::base::UnguessableToken>& throttling_profile_id)
{
