...
class PLATFORM_EXPORT ManagedConfigurationObserver : public ManagedConfigurationObserverInterfaceBase {
public:
...
class PLATFORM_EXPORT DeviceAPIService : public DeviceAPIServiceInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class PLATFORM_EXPORT ManagedConfigurationService : public ManagedConfigurationServiceInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class PLATFORM_EXPORT ManagedConfigurationObserverProxy : public ManagedConfigurationObserver {
//public:
...
//class PLATFORM_EXPORT DeviceAPIServiceProxy : public DeviceAPIService {
//public:
...
//class PLATFORM_EXPORT ManagedConfigurationServiceProxy : public ManagedConfigurationService {
//public:
...
public:
    ...
    static DeviceAttributeResultPtr NewErrorMessage(const WTF::String& value)
    {
    ...
    static DeviceAttributeResultPtr NewAttribute(const WTF::String& value)
    {
        auto result = DeviceAttributeResultPtr(std::in_place);
    ...
    void set_attribute(const WTF::String& attribute);
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::DeviceAttributeResult::DataView, ::blink::mojom::blink::DeviceAttributeResultPtr> {
    static bool IsNull(const ::blink::mojom::blink::DeviceAttributeResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::DeviceAttributeResultPtr* output)
    {
        output->reset();
    }
