...
class BLINK_COMMON_EXPORT SpeechSynthesisVoiceListObserver : public SpeechSynthesisVoiceListObserverInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT SpeechSynthesisClient : public SpeechSynthesisClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_COMMON_EXPORT SpeechSynthesis : public SpeechSynthesisInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT SpeechSynthesisVoiceListObserverProxy : public SpeechSynthesisVoiceListObserver {
//public:
...
//class BLINK_COMMON_EXPORT SpeechSynthesisClientProxy : public SpeechSynthesisClient {
//public:
...
//class BLINK_COMMON_EXPORT SpeechSynthesisProxy : public SpeechSynthesis {
//public:
    ...
    , pitch()
{
    ...
    {
        return mojo::internal::SerializeImpl<SpeechSynthesisUtterance::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , is_default()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SpeechSynthesisVoice::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SpeechSynthesisUtterance::DataView, ::blink::mojom::SpeechSynthesisUtterancePtr> {
    static bool IsNull(const ::blink::mojom::SpeechSynthesisUtterancePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::SpeechSynthesisUtterancePtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::SpeechSynthesisUtterance::text)& text(const ::blink::mojom::SpeechSynthesisUtterancePtr& input)
    {
        return input->text;
    }

    static const decltype(::blink::mojom::SpeechSynthesisUtterance::lang)& lang(const ::blink::mojom::SpeechSynthesisUtterancePtr& input)
    {
        return input->lang;
    }

    static const decltype(::blink::mojom::SpeechSynthesisUtterance::voice)& voice(const ::blink::mojom::SpeechSynthesisUtterancePtr& input)
    {
        return input->voice;
    }

    static decltype(::blink::mojom::SpeechSynthesisUtterance::volume) volume(const ::blink::mojom::SpeechSynthesisUtterancePtr& input)
    {
        return input->volume;
    }

    static decltype(::blink::mojom::SpeechSynthesisUtterance::rate) rate(const ::blink::mojom::SpeechSynthesisUtterancePtr& input)
    {
        return input->rate;
    }

    static decltype(::blink::mojom::SpeechSynthesisUtterance::pitch) pitch(const ::blink::mojom::SpeechSynthesisUtterancePtr& input)
    {
        return input->pitch;
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SpeechSynthesisVoice::DataView, ::blink::mojom::SpeechSynthesisVoicePtr> {
    static bool IsNull(const ::blink::mojom::SpeechSynthesisVoicePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::SpeechSynthesisVoicePtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::SpeechSynthesisVoice::voice_uri)& voice_uri(const ::blink::mojom::SpeechSynthesisVoicePtr& input)
    {
        return input->voice_uri;
    }

    static const decltype(::blink::mojom::SpeechSynthesisVoice::name)& name(const ::blink::mojom::SpeechSynthesisVoicePtr& input)
    {
        return input->name;
    }

    static const decltype(::blink::mojom::SpeechSynthesisVoice::lang)& lang(const ::blink::mojom::SpeechSynthesisVoicePtr& input)
    {
        return input->lang;
    }

    static decltype(::blink::mojom::SpeechSynthesisVoice::is_local_service) is_local_service(const ::blink::mojom::SpeechSynthesisVoicePtr& input)
    {
        return input->is_local_service;
    }

    static decltype(::blink::mojom::SpeechSynthesisVoice::is_default) is_default(const ::blink::mojom::SpeechSynthesisVoicePtr& input)
    {
