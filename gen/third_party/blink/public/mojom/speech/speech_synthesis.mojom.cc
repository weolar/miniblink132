...
SpeechSynthesisUtterance::SpeechSynthesisUtterance(
    const std::string& text_in, const std::string& lang_in, const std::string& voice_in, double volume_in, double rate_in, double pitch_in)
...
SpeechSynthesisVoice::SpeechSynthesisVoice(
    const std::string& voice_uri_in, const std::string& name_in, const std::string& lang_in, bool is_local_service_in, bool is_default_in)
...
void SpeechSynthesisVoiceListObserverProxy::OnSetVoiceList(std::vector<SpeechSynthesisVoicePtr> in_voice_list)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::SpeechSynthesisVoiceListObserver::OnSetVoiceList", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("voice_list"), in_voice_list, "<value of type std::vector<SpeechSynthesisVoicePtr>>");
    });
#endif
...
bool StructTraits<::blink::mojom::SpeechSynthesisUtterance::DataView, ::blink::mojom::SpeechSynthesisUtterancePtr>::Read(
    ::blink::mojom::SpeechSynthesisUtterance::DataView input, ::blink::mojom::SpeechSynthesisUtterancePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::SpeechSynthesisVoice::DataView, ::blink::mojom::SpeechSynthesisVoicePtr>::Read(
    ::blink::mojom::SpeechSynthesisVoice::DataView input, ::blink::mojom::SpeechSynthesisVoicePtr* output)
{
    bool success = true;
