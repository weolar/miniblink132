...
class PLATFORM_EXPORT PresentationServiceInterceptorForTesting : public PresentationService {
    ...
    void ReconnectPresentation(
        const WTF::Vector<::blink::KURL>& presentation_urls, const WTF::String& presentation_id, ReconnectPresentationCallback callback) override;
...
public:
    ...
    void StartPresentation(const WTF::Vector<::blink::KURL>& presentation_urls, PresentationConnectionResultPtr* out_result, PresentationErrorPtr* out_error);

    void ReconnectPresentation(const WTF::Vector<::blink::KURL>& presentation_urls, const WTF::String& presentation_id,
