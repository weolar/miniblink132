// third_party/blink/public/mojom/presentation/presentation.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_COMMON_EXPORT PresentationServiceInterceptorForTesting : public PresentationService {
    ...
    void ReconnectPresentation(
        const std::vector<::GURL>& presentation_urls, const std::string& presentation_id, ReconnectPresentationCallback callback) override;
...
public:
    ...
    void StartPresentation(const std::vector<::GURL>& presentation_urls, PresentationConnectionResultPtr* out_result, PresentationErrorPtr* out_error);

    void ReconnectPresentation(const std::vector<::GURL>& presentation_urls, const std::string& presentation_id, PresentationConnectionResultPtr* out_result,
