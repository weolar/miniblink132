// third_party/blink/public/mojom/presentation/presentation.mojom.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/presentation/presentation.mojom-forward.h" // IWYU pragma: export
...
class BLINK_COMMON_EXPORT PresentationConnection : public PresentationConnectionInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT PresentationService : public PresentationServiceInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void ReconnectPresentation(const std::vector<::GURL>& presentation_urls, const std::string& presentation_id, ReconnectPresentationCallback callback)
        = 0;
...
class BLINK_COMMON_EXPORT PresentationController : public PresentationControllerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_COMMON_EXPORT PresentationReceiver : public PresentationReceiverInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT PresentationConnectionProxy : public PresentationConnection {
//public:
...
//class BLINK_COMMON_EXPORT PresentationServiceProxy : public PresentationService {
//public:
...
//class BLINK_COMMON_EXPORT PresentationControllerProxy : public PresentationController {
//public:
...
//class BLINK_COMMON_EXPORT PresentationReceiverProxy : public PresentationReceiver {
//public:
    ...
    , message()
{
    ...
    PresentationError(PresentationErrorType error_type_in, const std::string& message_in)
    ...
    {
        return mojo::internal::SerializeImpl<PresentationError::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    static PresentationConnectionMessagePtr NewMessage(const std::string& value)
    {
    ...
    static PresentationConnectionMessagePtr NewData(std::vector<uint8_t> value)
    {
        auto result = PresentationConnectionMessagePtr(std::in_place);
    ...
    , id()
{
    ...
    PresentationInfo(const ::GURL& url_in, const std::string& id_in)
    : url(std::move(url_in))
    , id(std::move(id_in)){
}
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PresentationInfo::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PresentationInfo::DataView, ::blink::mojom::PresentationInfoPtr> {
    static bool IsNull(const ::blink::mojom::PresentationInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::PresentationInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::PresentationInfo::url)& url(const ::blink::mojom::PresentationInfoPtr& input)
    {
        return input->url;
    }

    static const decltype(::blink::mojom::PresentationInfo::id)& id(const ::blink::mojom::PresentationInfoPtr& input)
    {
        return input->id;
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PresentationError::DataView, ::blink::mojom::PresentationErrorPtr> {
    static bool IsNull(const ::blink::mojom::PresentationErrorPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::PresentationErrorPtr* output)
    {
        output->reset();
    }

    static decltype(::blink::mojom::PresentationError::error_type) error_type(const ::blink::mojom::PresentationErrorPtr& input)
    {
        return input->error_type;
    }

    static const decltype(::blink::mojom::PresentationError::message)& message(const ::blink::mojom::PresentationErrorPtr& input)
    {
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PresentationConnectionResult::DataView, ::blink::mojom::PresentationConnectionResultPtr> {
    static bool IsNull(const ::blink::mojom::PresentationConnectionResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::PresentationConnectionResultPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::blink::mojom::PresentationConnectionResult::connection_remote)& connection_remote(::blink::mojom::PresentationConnectionResultPtr& input)
    {
        return input->connection_remote;
    }

    static decltype(::blink::mojom::PresentationConnectionResult::connection_receiver)& connection_receiver(
...
template <> struct BLINK_COMMON_EXPORT UnionTraits<::blink::mojom::PresentationConnectionMessage::DataView, ::blink::mojom::PresentationConnectionMessagePtr> {
    static bool IsNull(const ::blink::mojom::PresentationConnectionMessagePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::PresentationConnectionMessagePtr* output)
    {
        output->reset();
    }
