// third_party/blink/public/mojom/renderer_preference_watcher.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class RendererPreferenceWatcher : uint32_t {
    kNotifyUpdate = 0,
};
