...
SupplementalPubKeysResponse::SupplementalPubKeysResponse(std::vector<std::vector<uint8_t>> signatures_in)
...
MakeCredentialAuthenticatorResponse::MakeCredentialAuthenticatorResponse(CommonCredentialInfoPtr info_in,
...
GetAssertionAuthenticatorResponse::GetAssertionAuthenticatorResponse(CommonCredentialInfoPtr info_in,
...
PublicKeyCredentialRpEntity::PublicKeyCredentialRpEntity(const std::string& id_in, const std::string& name_in)
    : id(std::move(id_in))
...
PublicKeyCredentialUserEntity::PublicKeyCredentialUserEntity(std::vector<uint8_t> id_in, const std::string& name_in, const std::string& display_name_in)
    : id(std::move(id_in))
    , name(std::move(name_in))
...
PublicKeyCredentialParameters::PublicKeyCredentialParameters(::device::CredentialType type_in, int32_t algorithm_identifier_in)
...
CableAuthentication::CableAuthentication(uint8_t version_in, std::optional<std::vector<uint8_t>> client_eid_in,
...
PRFValues::PRFValues(std::optional<std::vector<uint8_t>> id_in, std::vector<uint8_t> first_in, std::optional<std::vector<uint8_t>> second_in)
    : id(std::move(id_in))
...
PaymentOptions::PaymentOptions(::payments::mojom::PaymentCurrencyAmountPtr total_in, PaymentCredentialInstrumentPtr instrument_in,
...
PaymentCredentialInstrument::PaymentCredentialInstrument(const std::string& display_name_in, const ::GURL& icon_in, bool iconMustBeShown_in)
    : display_name(std::move(display_name_in))
...
RemoteDesktopClientOverride::RemoteDesktopClientOverride(const ::url::Origin& origin_in, bool same_origin_with_ancestors_in)
...
AuthenticationExtensionsClientInputs::AuthenticationExtensionsClientInputs(const std::optional<std::string>& appid_in,
...
AuthenticatorSelectionCriteria::AuthenticatorSelectionCriteria(::device::AuthenticatorAttachment authenticator_attachment_in,
...
PublicKeyCredentialCreationOptions::PublicKeyCredentialCreationOptions(const ::device::PublicKeyCredentialRpEntity& relying_party_in,
...
WebAuthnDOMExceptionDetails::WebAuthnDOMExceptionDetails(const std::string& name_in, const std::string& message_in)
    : name(std::move(name_in))
...
PublicKeyCredentialReportOptions::PublicKeyCredentialReportOptions(const std::string& relying_party_id_in,
...
AllAcceptedCredentialsOptions::AllAcceptedCredentialsOptions(std::vector<uint8_t> user_id_in, std::vector<std::vector<uint8_t>> all_accepted_credentials_ids_in)
...
CurrentUserDetailsOptions::CurrentUserDetailsOptions(std::vector<uint8_t> user_id_in, const std::string& name_in, const std::string& display_name_in)
    : user_id(std::move(user_id_in))
    , name(std::move(name_in))
    , display_name(std::move(display_name_in))
{
...
WebAuthnClientCapability::WebAuthnClientCapability(const std::string& name_in, bool supported_in)
    : name(std::move(name_in))
...
private:
    ...
    void Run(std::vector<WebAuthnClientCapabilityPtr> in_capabilities);
};
...
void Authenticator_GetClientCapabilities_ProxyToResponder::Run(std::vector<WebAuthnClientCapabilityPtr> in_capabilities)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::Authenticator::GetClientCapabilities", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("capabilities"), in_capabilities, "<value of type std::vector<WebAuthnClientCapabilityPtr>>");
    });
#endif
...
bool StructTraits<::blink::mojom::CommonCredentialInfo::DataView, ::blink::mojom::CommonCredentialInfoPtr>::Read(
    ::blink::mojom::CommonCredentialInfo::DataView input, ::blink::mojom::CommonCredentialInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::SupplementalPubKeysResponse::DataView, ::blink::mojom::SupplementalPubKeysResponsePtr>::Read(
    ::blink::mojom::SupplementalPubKeysResponse::DataView input, ::blink::mojom::SupplementalPubKeysResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::MakeCredentialAuthenticatorResponse::DataView, ::blink::mojom::MakeCredentialAuthenticatorResponsePtr>::Read(
    ::blink::mojom::MakeCredentialAuthenticatorResponse::DataView input, ::blink::mojom::MakeCredentialAuthenticatorResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::GetAssertionAuthenticatorResponse::DataView, ::blink::mojom::GetAssertionAuthenticatorResponsePtr>::Read(
    ::blink::mojom::GetAssertionAuthenticatorResponse::DataView input, ::blink::mojom::GetAssertionAuthenticatorResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::AuthenticationExtensionsClientOutputs::DataView, ::blink::mojom::AuthenticationExtensionsClientOutputsPtr>::Read(
    ::blink::mojom::AuthenticationExtensionsClientOutputs::DataView input, ::blink::mojom::AuthenticationExtensionsClientOutputsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PublicKeyCredentialRpEntity::DataView, ::blink::mojom::PublicKeyCredentialRpEntityPtr>::Read(
    ::blink::mojom::PublicKeyCredentialRpEntity::DataView input, ::blink::mojom::PublicKeyCredentialRpEntityPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PublicKeyCredentialUserEntity::DataView, ::blink::mojom::PublicKeyCredentialUserEntityPtr>::Read(
    ::blink::mojom::PublicKeyCredentialUserEntity::DataView input, ::blink::mojom::PublicKeyCredentialUserEntityPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PublicKeyCredentialParameters::DataView, ::blink::mojom::PublicKeyCredentialParametersPtr>::Read(
    ::blink::mojom::PublicKeyCredentialParameters::DataView input, ::blink::mojom::PublicKeyCredentialParametersPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::CableAuthentication::DataView, ::blink::mojom::CableAuthenticationPtr>::Read(
    ::blink::mojom::CableAuthentication::DataView input, ::blink::mojom::CableAuthenticationPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PRFValues::DataView, ::blink::mojom::PRFValuesPtr>::Read(
    ::blink::mojom::PRFValues::DataView input, ::blink::mojom::PRFValuesPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PaymentOptions::DataView, ::blink::mojom::PaymentOptionsPtr>::Read(
    ::blink::mojom::PaymentOptions::DataView input, ::blink::mojom::PaymentOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PaymentCredentialInstrument::DataView, ::blink::mojom::PaymentCredentialInstrumentPtr>::Read(
    ::blink::mojom::PaymentCredentialInstrument::DataView input, ::blink::mojom::PaymentCredentialInstrumentPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::RemoteDesktopClientOverride::DataView, ::blink::mojom::RemoteDesktopClientOverridePtr>::Read(
    ::blink::mojom::RemoteDesktopClientOverride::DataView input, ::blink::mojom::RemoteDesktopClientOverridePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::SupplementalPubKeysRequest::DataView, ::blink::mojom::SupplementalPubKeysRequestPtr>::Read(
    ::blink::mojom::SupplementalPubKeysRequest::DataView input, ::blink::mojom::SupplementalPubKeysRequestPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PublicKeyCredentialRequestOptions::DataView, ::blink::mojom::PublicKeyCredentialRequestOptionsPtr>::Read(
    ::blink::mojom::PublicKeyCredentialRequestOptions::DataView input, ::blink::mojom::PublicKeyCredentialRequestOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::AuthenticationExtensionsClientInputs::DataView, ::blink::mojom::AuthenticationExtensionsClientInputsPtr>::Read(
    ::blink::mojom::AuthenticationExtensionsClientInputs::DataView input, ::blink::mojom::AuthenticationExtensionsClientInputsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::AuthenticatorSelectionCriteria::DataView, ::blink::mojom::AuthenticatorSelectionCriteriaPtr>::Read(
    ::blink::mojom::AuthenticatorSelectionCriteria::DataView input, ::blink::mojom::AuthenticatorSelectionCriteriaPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PublicKeyCredentialCreationOptions::DataView, ::blink::mojom::PublicKeyCredentialCreationOptionsPtr>::Read(
    ::blink::mojom::PublicKeyCredentialCreationOptions::DataView input, ::blink::mojom::PublicKeyCredentialCreationOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PublicKeyCredentialDescriptor::DataView, ::blink::mojom::PublicKeyCredentialDescriptorPtr>::Read(
    ::blink::mojom::PublicKeyCredentialDescriptor::DataView input, ::blink::mojom::PublicKeyCredentialDescriptorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::WebAuthnDOMExceptionDetails::DataView, ::blink::mojom::WebAuthnDOMExceptionDetailsPtr>::Read(
    ::blink::mojom::WebAuthnDOMExceptionDetails::DataView input, ::blink::mojom::WebAuthnDOMExceptionDetailsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::PublicKeyCredentialReportOptions::DataView, ::blink::mojom::PublicKeyCredentialReportOptionsPtr>::Read(
    ::blink::mojom::PublicKeyCredentialReportOptions::DataView input, ::blink::mojom::PublicKeyCredentialReportOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::AllAcceptedCredentialsOptions::DataView, ::blink::mojom::AllAcceptedCredentialsOptionsPtr>::Read(
    ::blink::mojom::AllAcceptedCredentialsOptions::DataView input, ::blink::mojom::AllAcceptedCredentialsOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::CurrentUserDetailsOptions::DataView, ::blink::mojom::CurrentUserDetailsOptionsPtr>::Read(
    ::blink::mojom::CurrentUserDetailsOptions::DataView input, ::blink::mojom::CurrentUserDetailsOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::WebAuthnClientCapability::DataView, ::blink::mojom::WebAuthnClientCapabilityPtr>::Read(
    ::blink::mojom::WebAuthnClientCapability::DataView input, ::blink::mojom::WebAuthnClientCapabilityPtr* output)
{
    bool success = true;
...
void AuthenticatorAsyncWaiter::GetClientCapabilities(std::vector<WebAuthnClientCapabilityPtr>* out_capabilities)
{
    base::RunLoop loop;
    proxy_->GetClientCapabilities(base::BindOnce(
        [](base::RunLoop* loop, std::vector<WebAuthnClientCapabilityPtr>* out_capabilities, std::vector<WebAuthnClientCapabilityPtr> capabilities) {
