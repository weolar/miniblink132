...
class BLINK_COMMON_EXPORT DomStorageProvider : public DomStorageProviderInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT DomStorage : public DomStorageInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void BindSessionStorageArea(const ::blink::StorageKey& storage_key, const ::blink::LocalFrameToken& local_frame_token,
...
class BLINK_COMMON_EXPORT DomStorageClient : public DomStorageClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT DomStorageProviderProxy : public DomStorageProvider {
//public:
...
//class BLINK_COMMON_EXPORT DomStorageProxy : public DomStorage {
//public:
...
//        ::mojo::PendingReceiver<::blink::mojom::StorageArea> area) final;
//
...
//        ::mojo::PendingReceiver<::blink::mojom::StorageArea> session_namespace) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};

//class BLINK_COMMON_EXPORT DomStorageClientProxy : public DomStorageClient {
//public:
