...
#include "third_party/blink/public/mojom/badging/badging.mojom-blink-forward.h" // IWYU pragma: export
...
class PLATFORM_EXPORT BadgeService : public BadgeServiceInterfaceBase {
public:
...
//class PLATFORM_EXPORT BadgeServiceProxy : public BadgeService {
//public:
...
template <> struct PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::BadgeValue::DataView, ::blink::mojom::blink::BadgeValuePtr> {
    static bool IsNull(const ::blink::mojom::blink::BadgeValuePtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::blink::BadgeValuePtr* output)
    {
        output->reset();
    }
