// third_party/blink/public/mojom/input/input_host.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class PLATFORM_EXPORT TextSuggestionHostInterceptorForTesting : public TextSuggestionHost {
    ...
    void ShowSpellCheckSuggestionMenu(
        double caret_x, double caret_y, const WTF::String& marked_text, WTF::Vector<SpellCheckSuggestionPtr> suggestions) override;
...
public:
    ...
    TextSuggestionHostAsyncWaiter(const TextSuggestionHostAsyncWaiter&) = delete;
    TextSuggestionHostAsyncWaiter& operator=(const TextSuggestionHostAsyncWaiter&) = delete;
