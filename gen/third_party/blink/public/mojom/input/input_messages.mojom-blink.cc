...
void TextSuggestionBackendProxy::ApplySpellCheckSuggestion(const WTF::String& in_suggestion)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::TextSuggestionBackend::ApplySpellCheckSuggestion", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("suggestion"), in_suggestion, "<value of type const WTF::String&>");
    });
#endif
...
void TextSuggestionBackendProxy::OnNewWordAddedToDictionary(const WTF::String& in_suggestion)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::blink::mojom::blink::TextSuggestionBackend::Name_;
