...
class PLATFORM_EXPORT PointerLockContext : public PointerLockContextInterfaceBase {
public:
...
//class PLATFORM_EXPORT PointerLockContextProxy : public PointerLockContext {
//public:
