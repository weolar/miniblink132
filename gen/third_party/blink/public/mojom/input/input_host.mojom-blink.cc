...
SpellCheckSuggestion::SpellCheckSuggestion(const WTF::String& suggestion_in)
    ...
    double in_caret_x, double in_caret_y, const WTF::String& in_marked_text, WTF::Vector<SpellCheckSuggestionPtr> in_suggestions)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::TextSuggestionHost::ShowSpellCheckSuggestionMenu", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("marked_text"), in_marked_text, "<value of type const WTF::String&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("suggestions"), in_suggestions, "<value of type WTF::Vector<SpellCheckSuggestionPtr>>");
    });
#endif
    ...
    double in_caret_x, double in_caret_y, const WTF::String& in_marked_text, WTF::Vector<TextSuggestionPtr> in_suggestions)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::TextSuggestionHost::ShowTextSuggestionMenu", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("caret_y"), in_caret_y, "<value of type double>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("marked_text"), in_marked_text, "<value of type const WTF::String&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("suggestions"), in_suggestions, "<value of type WTF::Vector<TextSuggestionPtr>>");
    });
#endif
...
bool StructTraits<::blink::mojom::blink::SpellCheckSuggestion::DataView, ::blink::mojom::blink::SpellCheckSuggestionPtr>::Read(
    ::blink::mojom::blink::SpellCheckSuggestion::DataView input, ::blink::mojom::blink::SpellCheckSuggestionPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::TextSuggestion::DataView, ::blink::mojom::blink::TextSuggestionPtr>::Read(
    ::blink::mojom::blink::TextSuggestion::DataView input, ::blink::mojom::blink::TextSuggestionPtr* output)
{
    bool success = true;
...
void TextSuggestionHostInterceptorForTesting::ShowSpellCheckSuggestionMenu(
    double caret_x, double caret_y, const WTF::String& marked_text, WTF::Vector<SpellCheckSuggestionPtr> suggestions)
{
...
void TextSuggestionHostInterceptorForTesting::ShowTextSuggestionMenu(
    double caret_x, double caret_y, const WTF::String& marked_text, WTF::Vector<TextSuggestionPtr> suggestions)
{
