...
private:
    ...
    void Run(::blink::mojom::blink::PointerLockResult in_result);
};
...
void PointerLockContext_RequestMouseLockChange_ProxyToResponder::Run(::blink::mojom::blink::PointerLockResult in_result)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void PointerLockContextAsyncWaiter::RequestMouseLockChange(bool unadjusted_movement, ::blink::mojom::blink::PointerLockResult* out_result)
{
    base::RunLoop loop;
    proxy_->RequestMouseLockChange(std::move(unadjusted_movement),
        base::BindOnce(
            [](base::RunLoop* loop, ::blink::mojom::blink::PointerLockResult* out_result, ::blink::mojom::blink::PointerLockResult result) {
...
::blink::mojom::blink::PointerLockResult PointerLockContextAsyncWaiter::RequestMouseLockChange(bool unadjusted_movement)
{
