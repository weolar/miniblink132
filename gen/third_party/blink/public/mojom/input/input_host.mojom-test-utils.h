// third_party/blink/public/mojom/input/input_host.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_COMMON_EXPORT TextSuggestionHostInterceptorForTesting : public TextSuggestionHost {
    ...
    void ShowSpellCheckSuggestionMenu(
        double caret_x, double caret_y, const std::string& marked_text, std::vector<SpellCheckSuggestionPtr> suggestions) override;
