// third_party/blink/public/mojom/input/input_host.mojom-blink-forward.h is auto generated by mojom_bindings_generator.py, do not edit
...
using TextSuggestionHostInterfaceBase = TextSuggestionHostInterfaceBase;
