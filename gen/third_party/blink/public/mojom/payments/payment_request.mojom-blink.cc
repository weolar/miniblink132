...
PaymentResponse::PaymentResponse(const WTF::String& method_name_in, const WTF::String& stringified_details_in,
...
PayerDetail::PayerDetail(const WTF::String& email_in, const WTF::String& name_in, const WTF::String& phone_in)
...
PaymentItem::PaymentItem(const WTF::String& label_in, ::payments::mojom::blink::PaymentCurrencyAmountPtr amount_in, bool pending_in)
...
SecurePaymentConfirmationRequest::SecurePaymentConfirmationRequest(WTF::Vector<WTF::Vector<uint8_t>> credential_ids_in, WTF::Vector<uint8_t> challenge_in,
...
NetworkOrIssuerInformation::NetworkOrIssuerInformation(const WTF::String& name_in, const ::blink::KURL& icon_in)
    : name(std::move(name_in))
...
PaymentMethodData::PaymentMethodData(const WTF::String& supported_method_in, const WTF::String& stringified_data_in, AndroidPayEnvironment environment_in,
...
PaymentDetails::PaymentDetails(PaymentItemPtr total_in, std::optional<WTF::Vector<PaymentItemPtr>> display_items_in,
...
void PaymentRequestClientProxy::OnPaymentMethodChange(const WTF::String& in_method_name, const WTF::String& in_stringified_details)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send payments::mojom::PaymentRequestClient::OnPaymentMethodChange", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("stringified_details"), in_stringified_details, "<value of type const WTF::String&>");
    });
#endif
...
void PaymentRequestClientProxy::OnShippingAddressChange(::payments::mojom::blink::PaymentAddressPtr in_address)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send payments::mojom::PaymentRequestClient::OnShippingAddressChange", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("address"), in_address, "<value of type ::payments::mojom::blink::PaymentAddressPtr>");
    });
#endif
...
void PaymentRequestClientProxy::OnShippingOptionChange(const WTF::String& in_shipping_option_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PaymentRequestClientProxy::OnError(PaymentErrorReason in_error, const WTF::String& in_error_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void PaymentRequestProxy::Init(::mojo::PendingRemote<PaymentRequestClient> in_client, WTF::Vector<PaymentMethodDataPtr> in_method_data,
    PaymentDetailsPtr in_details, PaymentOptionsPtr in_options)
{
    ...
    TRACE_EVENT1("mojom", "Send payments::mojom::PaymentRequest::Init", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("method_data"), in_method_data, "<value of type WTF::Vector<PaymentMethodDataPtr>>");
...
void PaymentRequestProxy::Retry(::payments::mojom::blink::PaymentValidationErrorsPtr in_errors)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send payments::mojom::PaymentRequest::Retry", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("errors"), in_errors, "<value of type ::payments::mojom::blink::PaymentValidationErrorsPtr>");
    });
#endif
...
bool StructTraits<::payments::mojom::blink::PaymentResponse::DataView, ::payments::mojom::blink::PaymentResponsePtr>::Read(
    ::payments::mojom::blink::PaymentResponse::DataView input, ::payments::mojom::blink::PaymentResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PayerDetail::DataView, ::payments::mojom::blink::PayerDetailPtr>::Read(
    ::payments::mojom::blink::PayerDetail::DataView input, ::payments::mojom::blink::PayerDetailPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PaymentItem::DataView, ::payments::mojom::blink::PaymentItemPtr>::Read(
    ::payments::mojom::blink::PaymentItem::DataView input, ::payments::mojom::blink::PaymentItemPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PaymentShippingOption::DataView, ::payments::mojom::blink::PaymentShippingOptionPtr>::Read(
    ::payments::mojom::blink::PaymentShippingOption::DataView input, ::payments::mojom::blink::PaymentShippingOptionPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::NetworkOrIssuerInformation::DataView, ::payments::mojom::blink::NetworkOrIssuerInformationPtr>::Read(
    ::payments::mojom::blink::NetworkOrIssuerInformation::DataView input, ::payments::mojom::blink::NetworkOrIssuerInformationPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PaymentMethodData::DataView, ::payments::mojom::blink::PaymentMethodDataPtr>::Read(
    ::payments::mojom::blink::PaymentMethodData::DataView input, ::payments::mojom::blink::PaymentMethodDataPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PaymentDetailsModifier::DataView, ::payments::mojom::blink::PaymentDetailsModifierPtr>::Read(
    ::payments::mojom::blink::PaymentDetailsModifier::DataView input, ::payments::mojom::blink::PaymentDetailsModifierPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PaymentDetails::DataView, ::payments::mojom::blink::PaymentDetailsPtr>::Read(
    ::payments::mojom::blink::PaymentDetails::DataView input, ::payments::mojom::blink::PaymentDetailsPtr* output)
{
    bool success = true;
...
bool StructTraits<::payments::mojom::blink::PaymentOptions::DataView, ::payments::mojom::blink::PaymentOptionsPtr>::Read(
    ::payments::mojom::blink::PaymentOptions::DataView input, ::payments::mojom::blink::PaymentOptionsPtr* output)
{
    bool success = true;
...
bool PaymentRequestClientAsyncWaiter::AllowConnectToSource(const ::blink::KURL& url, const ::blink::KURL& url_before_redirects, bool did_follow_redirect)
{
