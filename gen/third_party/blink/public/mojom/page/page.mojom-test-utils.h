...
class BLINK_COMMON_EXPORT PageBroadcastInterceptorForTesting : public PageBroadcast {
    ...
    void CreateRemoteMainFrame(const ::blink::RemoteFrameToken& token, const std::optional<::blink::FrameToken>& opener_frame_token,
        ...
        ::blink::mojom::RemoteMainFrameInterfacesPtr remote_main_frame_interfaces) override;
