...
ProximateCharacterRangeBounds::ProximateCharacterRangeBounds(const ::gfx::Range& range_in, WTF::Vector<::gfx::Rect> bounds_in)
...
void FrameWidgetProxy::DragTargetDragEnter(const ::blink::WebDragData& in_drag_data, const ::gfx::PointF& in_point_in_viewport,
...
void FrameWidgetProxy::DragSourceEndedAt(const ::gfx::PointF& in_point_in_viewport, const ::gfx::PointF& in_screen_point,
    ::ui::mojom::blink::DragOperation in_drag_operation, DragSourceEndedAtCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FrameWidgetProxy::BindWidgetCompositor(::mojo::PendingReceiver<::blink::mojom::blink::WidgetCompositor> in_host)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FrameWidget::BindWidgetCompositor", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("host"), in_host, "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::WidgetCompositor>>");
    });
#endif
...
private:
    ...
    void Run(::ui::mojom::blink::DragOperation in_operation, bool in_document_is_handling_drag);
};
...
void FrameWidget_DragTargetDragEnter_ProxyToResponder::Run(::ui::mojom::blink::DragOperation in_operation, bool in_document_is_handling_drag)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FrameWidget_DragTargetDragOver_ProxyToResponder::Run(::ui::mojom::blink::DragOperation in_operation, bool in_document_is_handling_drag)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::blink::mojom::blink::ProximateCharacterRangeBounds::DataView, ::blink::mojom::blink::ProximateCharacterRangeBoundsPtr>::Read(
    ::blink::mojom::blink::ProximateCharacterRangeBounds::DataView input, ::blink::mojom::blink::ProximateCharacterRangeBoundsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::StylusWritingFocusResult::DataView, ::blink::mojom::blink::StylusWritingFocusResultPtr>::Read(
    ::blink::mojom::blink::StylusWritingFocusResult::DataView input, ::blink::mojom::blink::StylusWritingFocusResultPtr* output)
{
    bool success = true;
...
void FrameWidgetInterceptorForTesting::DragTargetDragEnter(const ::blink::WebDragData& drag_data, const ::gfx::PointF& point_in_viewport,
...
void FrameWidgetInterceptorForTesting::DragTargetDrop(const ::blink::WebDragData& drag_data, const ::gfx::PointF& point_in_viewport,
...
void FrameWidgetInterceptorForTesting::DragSourceEndedAt(const ::gfx::PointF& point_in_viewport, const ::gfx::PointF& screen_point,
    ::ui::mojom::blink::DragOperation drag_operation, DragSourceEndedAtCallback callback)
{
...
void FrameWidgetAsyncWaiter::DragTargetDragEnter(const ::blink::WebDragData& drag_data, const ::gfx::PointF& point_in_viewport,
    const ::gfx::PointF& screen_point, ::blink::DragOperationsMask operations_allowed, uint32_t key_modifiers, ::ui::mojom::blink::DragOperation* out_operation,
    bool* out_document_is_handling_drag)
{
    ...
    proxy_->DragTargetDragEnter(std::move(drag_data), std::move(point_in_viewport), std::move(screen_point), std::move(operations_allowed),
        ...
        base::BindOnce(
            [](base::RunLoop* loop, ::ui::mojom::blink::DragOperation* out_operation, bool* out_document_is_handling_drag,
                ::ui::mojom::blink::DragOperation operation, bool document_is_handling_drag) {
