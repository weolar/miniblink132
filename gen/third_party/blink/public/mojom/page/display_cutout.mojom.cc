...
uint32_t DisplayCutoutHost::NotifyViewportFitChanged_Sym::IPCStableHash()
{
    ...
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)blink::mojom::DisplayCutoutHost::NotifyViewportFitChanged");
...
void DisplayCutoutHostProxy::NotifyViewportFitChanged(ViewportFit in_value)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::DisplayCutoutHost::NotifyViewportFitChanged", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("value"), in_value, "<value of type ViewportFit>");
    });
#endif
    ...
    mojo::Message message(base::to_underlying(messages::DisplayCutoutHost::kNotifyViewportFitChanged), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::blink::mojom::internal::DisplayCutoutHost_NotifyViewportFitChanged_Params_Data> params(message);
    params.Allocate();
    mojo::internal::Serialize<::blink::mojom::ViewportFit>(in_value, &params->value);
...
// static
bool DisplayCutoutHostStubDispatch::Accept(DisplayCutoutHost* impl, mojo::Message* message)
{
    ...
    case messages::DisplayCutoutHost::kNotifyViewportFitChanged: {
        ...
        internal::DisplayCutoutHost_NotifyViewportFitChanged_Params_Data* params
            = reinterpret_cast<internal::DisplayCutoutHost_NotifyViewportFitChanged_Params_Data*>(message->mutable_payload());
        ...
        if (success && !input_data_view.ReadValue(&p_value))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, DisplayCutoutHost::Name_, 0, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->NotifyViewportFitChanged(std::move(p_value));
        return true;
    }
    }
    return false;
...
bool DisplayCutoutHostStubDispatch::AcceptWithResponder(
    DisplayCutoutHost* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const mojo::internal::GenericValidationInfo kDisplayCutoutHostValidationInfo[] = {
    { &internal::DisplayCutoutHost_NotifyViewportFitChanged_Params_Data::Validate, nullptr /* no response */ },
};

bool DisplayCutoutHostRequestValidator::Accept(mojo::Message* message)
{
    const char* name = ::blink::mojom::DisplayCutoutHost::Name_;
...
uint32_t DisplayCutoutClient::SetSafeArea_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)blink::mojom::DisplayCutoutClient::SetSafeArea");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
void DisplayCutoutClientProxy::SetSafeArea(const ::gfx::Insets& in_safe_area)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::DisplayCutoutClient::SetSafeArea", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("safe_area"), in_safe_area, "<value of type const ::gfx::Insets&>");
    });
#endif
    ...
    const size_t estimated_payload_size = 0;
    mojo::Message message(base::to_underlying(messages::DisplayCutoutClient::kSetSafeArea), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::blink::mojom::internal::DisplayCutoutClient_SetSafeArea_Params_Data> params(message);
    params.Allocate();
    mojo::internal::MessageFragment<typename decltype(params->safe_area)::BaseType> safe_area_fragment(params.message());
    mojo::internal::Serialize<::gfx::mojom::InsetsDataView>(in_safe_area, safe_area_fragment);
    params->safe_area.Set(safe_area_fragment.is_null() ? nullptr : safe_area_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->safe_area.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null safe_area in DisplayCutoutClient.SetSafeArea request");
...
// static
bool DisplayCutoutClientStubDispatch::Accept(DisplayCutoutClient* impl, mojo::Message* message)
{
    ...
    case messages::DisplayCutoutClient::kSetSafeArea: {
        ...
        internal::DisplayCutoutClient_SetSafeArea_Params_Data* params
            = reinterpret_cast<internal::DisplayCutoutClient_SetSafeArea_Params_Data*>(message->mutable_payload());
        ...
        if (success && !input_data_view.ReadSafeArea(&p_safe_area))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, DisplayCutoutClient::Name_, 0, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->SetSafeArea(std::move(p_safe_area));
        return true;
    }
    }
    return false;
...
bool DisplayCutoutClientStubDispatch::AcceptWithResponder(
    DisplayCutoutClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    [[maybe_unused]] const bool message_is_sync = message->has_flag(mojo::Message::kFlagIsSync);
    [[maybe_unused]] const uint64_t request_id = message->request_id();
    switch (static_cast<messages::DisplayCutoutClient>(message->header()->name)) {
...
static const mojo::internal::GenericValidationInfo kDisplayCutoutClientValidationInfo[] = {
    { &internal::DisplayCutoutClient_SetSafeArea_Params_Data::Validate, nullptr /* no response */ },
};

bool DisplayCutoutClientRequestValidator::Accept(mojo::Message* message)
{
    const char* name = ::blink::mojom::DisplayCutoutClient::Name_;
...
DisplayCutoutHostAsyncWaiter::DisplayCutoutHostAsyncWaiter(DisplayCutoutHost* proxy)
    : proxy_(proxy)
{
}
...
DisplayCutoutClientAsyncWaiter::DisplayCutoutClientAsyncWaiter(DisplayCutoutClient* proxy)
    : proxy_(proxy)
{
}
