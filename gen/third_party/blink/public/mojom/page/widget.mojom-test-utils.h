...
class BLINK_COMMON_EXPORT FrameWidgetInterceptorForTesting : public FrameWidget {
    ...
    void SetViewportIntersection(
        ::blink::mojom::ViewportIntersectionStatePtr intersection_state, const std::optional<::blink::VisualProperties>& visual_properties) override;
...
public:
    ...
    void DragTargetDragOver(const ::gfx::PointF& point_in_viewport, const ::gfx::PointF& screen_point, ::blink::DragOperationsMask operations_allowed,
        uint32_t key_modifiers, ::ui::mojom::DragOperation* out_operation, bool* out_document_is_handling_drag);
