...
CacheStorageVerboseError::CacheStorageVerboseError(CacheStorageError value_in, const WTF::String& message_in)
...
MultiCacheQueryOptions::MultiCacheQueryOptions(CacheQueryOptionsPtr query_options_in, const ::WTF::String& cache_name_in)
...
BatchOperation::BatchOperation(OperationType operation_type_in, ::blink::mojom::blink::FetchAPIRequestPtr request_in,
...
EagerResponse::EagerResponse(::blink::mojom::blink::FetchAPIResponsePtr response_in, ::mojo::ScopedDataPipeConsumerHandle pipe_in,
...
CacheEntry::CacheEntry(::blink::mojom::blink::FetchAPIRequestPtr request_in, ::blink::mojom::blink::FetchAPIResponsePtr response_in)
    : request(std::move(request_in))
    , response(std::move(response_in))
{
}
...
void MatchResult::set_response(::blink::mojom::blink::FetchAPIResponsePtr response)
{
    if (tag_ == Tag::kResponse) {
        *(data_.response) = std::move(response);
        ...
        DestroyActive();
        tag_ = Tag::kResponse;
        data_.response = new ::blink::mojom::blink::FetchAPIResponsePtr(std::move(response));
    }
}
...
void MatchAllResult::set_responses(WTF::Vector<::blink::mojom::blink::FetchAPIResponsePtr> responses)
{
    if (tag_ == Tag::kResponses) {
        *(data_.responses) = std::move(responses);
        ...
        DestroyActive();
        tag_ = Tag::kResponses;
        data_.responses = new WTF::Vector<::blink::mojom::blink::FetchAPIResponsePtr>(std::move(responses));
    }
}
...
void GetAllMatchedEntriesResult::set_entries(WTF::Vector<CacheEntryPtr> entries)
{
    if (tag_ == Tag::kEntries) {
        *(data_.entries) = std::move(entries);
        ...
        DestroyActive();
        tag_ = Tag::kEntries;
        data_.entries = new WTF::Vector<CacheEntryPtr>(std::move(entries));
    }
}
...
void CacheKeysResult::set_keys(WTF::Vector<::blink::mojom::blink::FetchAPIRequestPtr> keys)
{
    if (tag_ == Tag::kKeys) {
        *(data_.keys) = std::move(keys);
        ...
        DestroyActive();
        tag_ = Tag::kKeys;
        data_.keys = new WTF::Vector<::blink::mojom::blink::FetchAPIRequestPtr>(std::move(keys));
    }
}
...
void CacheStorageCacheProxy::Match(::blink::mojom::blink::FetchAPIRequestPtr in_request, CacheQueryOptionsPtr in_query_options, bool in_in_related_fetch_event,
    bool in_in_range_fetch_event, int64_t in_trace_id, MatchCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::CacheStorageCache::Match", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("request"), in_request, "<value of type ::blink::mojom::blink::FetchAPIRequestPtr>");
...
void CacheStorageCacheProxy::Batch(WTF::Vector<BatchOperationPtr> in_batch_operations, int64_t in_trace_id, BatchCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::CacheStorageCache::Batch", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("batch_operations"), in_batch_operations, "<value of type WTF::Vector<BatchOperationPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("trace_id"), in_trace_id, "<value of type int64_t>");
    });
#endif
...
void CacheStorageProxy::Has(const ::WTF::String& in_cache_name, int64_t in_trace_id, HasCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::CacheStorage::Has", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cache_name"), in_cache_name, "<value of type const ::WTF::String&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("trace_id"), in_trace_id, "<value of type int64_t>");
    });
#endif
...
void CacheStorageProxy::Delete(const ::WTF::String& in_cache_name, int64_t in_trace_id, DeleteCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageProxy::Match(::blink::mojom::blink::FetchAPIRequestPtr in_request, MultiCacheQueryOptionsPtr in_match_options, bool in_in_related_fetch_event,
    bool in_in_range_fetch_event, int64_t in_trace_id, MatchCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorageProxy::Open(const ::WTF::String& in_cache_name, int64_t in_trace_id, OpenCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void CacheStorage_Keys_ProxyToResponder::Run(const WTF::Vector<::WTF::String>& in_keys)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::blink::mojom::blink::CacheStorageVerboseError::DataView, ::blink::mojom::blink::CacheStorageVerboseErrorPtr>::Read(
    ::blink::mojom::blink::CacheStorageVerboseError::DataView input, ::blink::mojom::blink::CacheStorageVerboseErrorPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::CacheQueryOptions::DataView, ::blink::mojom::blink::CacheQueryOptionsPtr>::Read(
    ::blink::mojom::blink::CacheQueryOptions::DataView input, ::blink::mojom::blink::CacheQueryOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::MultiCacheQueryOptions::DataView, ::blink::mojom::blink::MultiCacheQueryOptionsPtr>::Read(
    ::blink::mojom::blink::MultiCacheQueryOptions::DataView input, ::blink::mojom::blink::MultiCacheQueryOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::BatchOperation::DataView, ::blink::mojom::blink::BatchOperationPtr>::Read(
    ::blink::mojom::blink::BatchOperation::DataView input, ::blink::mojom::blink::BatchOperationPtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::EagerResponse::DataView, ::blink::mojom::blink::EagerResponsePtr>::Read(
    ::blink::mojom::blink::EagerResponse::DataView input, ::blink::mojom::blink::EagerResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::blink::mojom::blink::CacheEntry::DataView, ::blink::mojom::blink::CacheEntryPtr>::Read(
    ::blink::mojom::blink::CacheEntry::DataView input, ::blink::mojom::blink::CacheEntryPtr* output)
{
    bool success = true;
...
bool UnionTraits<::blink::mojom::blink::OpenResult::DataView, ::blink::mojom::blink::OpenResultPtr>::Read(
    ::blink::mojom::blink::OpenResult::DataView input, ::blink::mojom::blink::OpenResultPtr* output)
{
    ...
    case Tag::kCache: {
        *output = UnionType::NewCache(input.TakeCache<::mojo::PendingAssociatedRemote<::blink::mojom::blink::CacheStorageCache>>());
        break;
    }
    default:
...
bool UnionTraits<::blink::mojom::blink::MatchResult::DataView, ::blink::mojom::blink::MatchResultPtr>::Read(
    ::blink::mojom::blink::MatchResult::DataView input, ::blink::mojom::blink::MatchResultPtr* output)
{
...
bool UnionTraits<::blink::mojom::blink::MatchAllResult::DataView, ::blink::mojom::blink::MatchAllResultPtr>::Read(
    ::blink::mojom::blink::MatchAllResult::DataView input, ::blink::mojom::blink::MatchAllResultPtr* output)
{
...
bool UnionTraits<::blink::mojom::blink::GetAllMatchedEntriesResult::DataView, ::blink::mojom::blink::GetAllMatchedEntriesResultPtr>::Read(
    ::blink::mojom::blink::GetAllMatchedEntriesResult::DataView input, ::blink::mojom::blink::GetAllMatchedEntriesResultPtr* output)
{
...
bool UnionTraits<::blink::mojom::blink::CacheKeysResult::DataView, ::blink::mojom::blink::CacheKeysResultPtr>::Read(
    ::blink::mojom::blink::CacheKeysResult::DataView input, ::blink::mojom::blink::CacheKeysResultPtr* output)
{
...
void CacheStorageCacheInterceptorForTesting::Match(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options,
    bool in_related_fetch_event, bool in_range_fetch_event, int64_t trace_id, MatchCallback callback)
{
...
void CacheStorageCacheInterceptorForTesting::MatchAll(
    ::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, int64_t trace_id, MatchAllCallback callback)
{
...
void CacheStorageCacheInterceptorForTesting::Keys(
    ::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, int64_t trace_id, KeysCallback callback)
{
...
void CacheStorageCacheAsyncWaiter::Match(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, bool in_related_fetch_event,
...
MatchResultPtr CacheStorageCacheAsyncWaiter::Match(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options,
    bool in_related_fetch_event, bool in_range_fetch_event, int64_t trace_id)
{
...
MatchAllResultPtr CacheStorageCacheAsyncWaiter::MatchAll(
    ::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, int64_t trace_id)
{
...
CacheKeysResultPtr CacheStorageCacheAsyncWaiter::Keys(::blink::mojom::blink::FetchAPIRequestPtr request, CacheQueryOptionsPtr query_options, int64_t trace_id)
{
...
void CacheStorageCacheAsyncWaiter::Batch(WTF::Vector<BatchOperationPtr> batch_operations, int64_t trace_id, CacheStorageVerboseErrorPtr* out_result)
{
    base::RunLoop loop;
...
CacheStorageVerboseErrorPtr CacheStorageCacheAsyncWaiter::Batch(WTF::Vector<BatchOperationPtr> batch_operations, int64_t trace_id)
{
...
void CacheStorageInterceptorForTesting::Match(::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options,
    bool in_related_fetch_event, bool in_range_fetch_event, int64_t trace_id, MatchCallback callback)
{
...
void CacheStorageAsyncWaiter::Has(const ::WTF::String& cache_name, int64_t trace_id, CacheStorageError* out_result)
{
    base::RunLoop loop;
...
CacheStorageError CacheStorageAsyncWaiter::Has(const ::WTF::String& cache_name, int64_t trace_id)
{
    CacheStorageError async_wait_result;
...
void CacheStorageAsyncWaiter::Delete(const ::WTF::String& cache_name, int64_t trace_id, CacheStorageError* out_result)
{
    base::RunLoop loop;
...
CacheStorageError CacheStorageAsyncWaiter::Delete(const ::WTF::String& cache_name, int64_t trace_id)
{
    CacheStorageError async_wait_result;
...
void CacheStorageAsyncWaiter::Keys(int64_t trace_id, WTF::Vector<::WTF::String>* out_keys)
{
    base::RunLoop loop;
...
WTF::Vector<::WTF::String> CacheStorageAsyncWaiter::Keys(int64_t trace_id)
{
...
void CacheStorageAsyncWaiter::Match(::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options, bool in_related_fetch_event,
    bool in_range_fetch_event, int64_t trace_id, MatchResultPtr* out_result)
{
    base::RunLoop loop;
...
MatchResultPtr CacheStorageAsyncWaiter::Match(::blink::mojom::blink::FetchAPIRequestPtr request, MultiCacheQueryOptionsPtr match_options,
    bool in_related_fetch_event, bool in_range_fetch_event, int64_t trace_id)
{
    MatchResultPtr async_wait_result;
...
void CacheStorageAsyncWaiter::Open(const ::WTF::String& cache_name, int64_t trace_id, OpenResultPtr* out_result)
{
    base::RunLoop loop;
...
OpenResultPtr CacheStorageAsyncWaiter::Open(const ::WTF::String& cache_name, int64_t trace_id)
{
