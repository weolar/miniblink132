...
FileSystemInfo::FileSystemInfo(const std::string& name_in, const ::GURL& root_url_in, FileSystemType mount_type_in)
...
{
    const char* name = ::blink::mojom::FileSystemCancellableOperation::Name_;
...
void FileSystemOperationListenerProxy::ResultsRetrieved(std::vector<::filesystem::mojom::DirectoryEntryPtr> in_entries, bool in_has_more)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemOperationListener::ResultsRetrieved", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("entries"), in_entries, "<value of type std::vector<::filesystem::mojom::DirectoryEntryPtr>>");
...
{
    const char* name = ::blink::mojom::FileSystemOperationListener::Name_;
...
{
    const char* name = ::blink::mojom::ReceivedSnapshotListener::Name_;
...
bool FileSystemManager::ResolveURL(
...
bool FileSystemManager::WriteSync(
...
bool FileSystemManager::CreateSnapshotFile(const ::GURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path,
...
bool FileSystemManager::RegisterBlob(const std::string& content_type, const ::GURL& url, uint64_t length,
    std::optional<::base::Time> expected_modification_time, ::blink::mojom::SerializedBlobPtr* out_blob)
{
    NOTREACHED();
}
class FileSystemManager_Open_HandleSyncResponse : public mojo::MessageReceiver {
public:
    FileSystemManager_Open_HandleSyncResponse(bool* result, std::string* out_name, ::GURL* out_root_url, ::base::File::Error* out_error_code)
        : result_(result)
        , out_name_(out_name)
...
public:
    FileSystemManager_RegisterBlob_HandleSyncResponse(bool* result, ::blink::mojom::SerializedBlobPtr* out_blob)
        : result_(result)
        , out_blob_(out_blob)
    {
        DCHECK(!*result_);
...
bool FileSystemManagerProxy::Open(const ::url::Origin& param_origin, FileSystemType param_file_system_type, std::string* out_param_name,
    ::GURL* out_param_root_url, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    TRACE_EVENT_END1("mojom", "FileSystemManager::Open", "sync_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("name"), out_param_name, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("root_url"), out_param_root_url, "<value of type const ::GURL&>");
...
void FileSystemManagerProxy::Open(const ::url::Origin& in_origin, FileSystemType in_file_system_type, OpenCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::ResolveURL(const ::GURL& param_filesystem_url, FileSystemInfoPtr* out_param_info, ::base::FilePath* out_param_file_path,
    bool* out_param_is_directory, ::base::File::Error* out_param_error_code)
{
    ...
    TRACE_EVENT_BEGIN1("mojom", "Call blink::mojom::FileSystemManager::ResolveURL (sync)", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("filesystem_url"), param_filesystem_url, "<value of type const ::GURL&>");
    });
#else
...
void FileSystemManagerProxy::ResolveURL(const ::GURL& in_filesystem_url, ResolveURLCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemManager::ResolveURL", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("filesystem_url"), in_filesystem_url, "<value of type const ::GURL&>");
    });
#endif
...
bool FileSystemManagerProxy::Move(const ::GURL& param_src_path, const ::GURL& param_dest_path, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT_BEGIN1("mojom", "Call blink::mojom::FileSystemManager::Move (sync)", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("src_path"), param_src_path, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("dest_path"), param_dest_path, "<value of type const ::GURL&>");
    });
#else
...
void FileSystemManagerProxy::Move(const ::GURL& in_src_path, const ::GURL& in_dest_path, MoveCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemManager::Move", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("src_path"), in_src_path, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("dest_path"), in_dest_path, "<value of type const ::GURL&>");
    });
#endif
...
bool FileSystemManagerProxy::Copy(const ::GURL& param_src_path, const ::GURL& param_dest_path, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::Copy(const ::GURL& in_src_path, const ::GURL& in_dest_path, CopyCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::Remove(const ::GURL& param_path, bool param_recursive, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT_BEGIN1("mojom", "Call blink::mojom::FileSystemManager::Remove (sync)", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("path"), param_path, "<value of type const ::GURL&>");
...
void FileSystemManagerProxy::Remove(const ::GURL& in_path, bool in_recursive, RemoveCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemManager::Remove", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("path"), in_path, "<value of type const ::GURL&>");
...
bool FileSystemManagerProxy::ReadMetadata(const ::GURL& param_path, ::base::File::Info* out_param_file_info, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::ReadMetadata(const ::GURL& in_path, ReadMetadataCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::Create(const ::GURL& in_path, bool in_exclusive, bool in_is_directory, bool in_recursive, CreateCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::Exists(const ::GURL& param_path, bool param_is_directory, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::Exists(const ::GURL& in_path, bool in_is_directory, ExistsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::ReadDirectory(const ::GURL& in_path, ::mojo::PendingRemote<FileSystemOperationListener> in_listener)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    const ::GURL& param_path, std::vector<::filesystem::mojom::DirectoryEntryPtr>* out_param_entries, ::base::File::Error* out_param_error_code)
{
    ...
    TRACE_EVENT_END1("mojom", "FileSystemManager::ReadDirectorySync", "sync_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("entries"), out_param_entries, "<value of type std::vector<::filesystem::mojom::DirectoryEntryPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error_code"), out_param_error_code, "<value of type ::base::File::Error>");
    });
#endif
    return result;
...
void FileSystemManagerProxy::ReadDirectorySync(const ::GURL& in_path, ReadDirectorySyncCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::Write(const ::GURL& in_file_path, ::mojo::PendingRemote<::blink::mojom::Blob> in_blob, int64_t in_position,
    ::mojo::PendingReceiver<FileSystemCancellableOperation> in_op_receiver, ::mojo::PendingRemote<FileSystemOperationListener> in_listener)
{
    ...
    TRACE_EVENT1("mojom", "Send blink::mojom::FileSystemManager::Write", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("file_path"), in_file_path, "<value of type const ::GURL&>");
...
bool FileSystemManagerProxy::WriteSync(const ::GURL& param_file_path, ::mojo::PendingRemote<::blink::mojom::Blob> param_blob, int64_t param_position,
    int64_t* out_param_byte_count, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT_BEGIN1("mojom", "Call blink::mojom::FileSystemManager::WriteSync (sync)", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("file_path"), param_file_path, "<value of type const ::GURL&>");
...
bool FileSystemManagerProxy::TruncateSync(const ::GURL& param_file_path, int64_t param_length, ::base::File::Error* out_param_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::TruncateSync(const ::GURL& in_file_path, int64_t in_length, TruncateSyncCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::CreateSnapshotFile(const ::GURL& param_file_path, ::base::File::Info* out_param_file_info,
...
void FileSystemManagerProxy::CreateSnapshotFile(const ::GURL& in_file_path, CreateSnapshotFileCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::GetPlatformPath(const ::GURL& param_file_path, ::base::FilePath* out_param_platform_path)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void FileSystemManagerProxy::GetPlatformPath(const ::GURL& in_file_path, GetPlatformPathCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool FileSystemManagerProxy::RegisterBlob(const std::string& param_content_type, const ::GURL& param_url, uint64_t param_length,
    std::optional<::base::Time> param_expected_modification_time, ::blink::mojom::SerializedBlobPtr* out_param_blob)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    TRACE_EVENT_END1("mojom", "FileSystemManager::RegisterBlob", "sync_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("blob"), out_param_blob, "<value of type ::blink::mojom::SerializedBlobPtr>");
    });
#endif
    return result;
}

void FileSystemManagerProxy::RegisterBlob(const std::string& in_content_type, const ::GURL& in_url, uint64_t in_length,
...
private:
    ...
    void Run(const std::string& in_name, const ::GURL& in_root_url, ::base::File::Error in_error_code);
};
...
void FileSystemManager_Open_ProxyToResponder::Run(const std::string& in_name, const ::GURL& in_root_url, ::base::File::Error in_error_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply blink::mojom::FileSystemManager::Open", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("root_url"), in_root_url, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("error_code"), in_error_code, "<value of type ::base::File::Error>");
    });
#endif
...
private:
    ...
    void Run(std::vector<::filesystem::mojom::DirectoryEntryPtr> in_entries, ::base::File::Error in_error_code);
};
...
void FileSystemManager_RegisterBlob_ProxyToResponder::Run(::blink::mojom::SerializedBlobPtr in_blob)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::blink::mojom::FileSystemManager::Name_;
...
bool StructTraits<::blink::mojom::FileSystemInfo::DataView, ::blink::mojom::FileSystemInfoPtr>::Read(
    ::blink::mojom::FileSystemInfo::DataView input, ::blink::mojom::FileSystemInfoPtr* output)
{
    bool success = true;
...
void FileSystemManagerInterceptorForTesting::Write(const ::GURL& file_path, ::mojo::PendingRemote<::blink::mojom::Blob> blob, int64_t position,
...
void FileSystemManagerInterceptorForTesting::WriteSync(
    const ::GURL& file_path, ::mojo::PendingRemote<::blink::mojom::Blob> blob, int64_t position, WriteSyncCallback callback)
{
...
void FileSystemManagerInterceptorForTesting::Truncate(
    const ::GURL& file_path, int64_t length, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, TruncateCallback callback)
{
...
void FileSystemManagerInterceptorForTesting::RegisterBlob(
    const std::string& content_type, const ::GURL& url, uint64_t length, std::optional<::base::Time> expected_modification_time, RegisterBlobCallback callback)
{
    ...
    const ::url::Origin& origin, FileSystemType file_system_type, std::string* out_name, ::GURL* out_root_url, ::base::File::Error* out_error_code)
{
    ...
    proxy_->Open(std::move(origin), std::move(file_system_type),
        base::BindOnce(
            [](base::RunLoop* loop, std::string* out_name, ::GURL* out_root_url, ::base::File::Error* out_error_code, const std::string& name,
                const ::GURL& root_url, ::base::File::Error error_code) {
...
void FileSystemManagerAsyncWaiter::Move(const ::GURL& src_path, const ::GURL& dest_path, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
::base::File::Error FileSystemManagerAsyncWaiter::Move(const ::GURL& src_path, const ::GURL& dest_path)
{
    ::base::File::Error async_wait_result;
...
void FileSystemManagerAsyncWaiter::Copy(const ::GURL& src_path, const ::GURL& dest_path, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
::base::File::Error FileSystemManagerAsyncWaiter::Copy(const ::GURL& src_path, const ::GURL& dest_path)
{
    ::base::File::Error async_wait_result;
...
void FileSystemManagerAsyncWaiter::Remove(const ::GURL& path, bool recursive, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
::base::File::Error FileSystemManagerAsyncWaiter::Remove(const ::GURL& path, bool recursive)
{
    ::base::File::Error async_wait_result;
...
void FileSystemManagerAsyncWaiter::ReadMetadata(const ::GURL& path, ::base::File::Info* out_file_info, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
void FileSystemManagerAsyncWaiter::Create(const ::GURL& path, bool exclusive, bool is_directory, bool recursive, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
::base::File::Error FileSystemManagerAsyncWaiter::Create(const ::GURL& path, bool exclusive, bool is_directory, bool recursive)
{
    ::base::File::Error async_wait_result;
...
void FileSystemManagerAsyncWaiter::Exists(const ::GURL& path, bool is_directory, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
::base::File::Error FileSystemManagerAsyncWaiter::Exists(const ::GURL& path, bool is_directory)
{
    ::base::File::Error async_wait_result;
    ...
    const ::GURL& path, std::vector<::filesystem::mojom::DirectoryEntryPtr>* out_entries, ::base::File::Error* out_error_code)
{
    ...
    proxy_->ReadDirectorySync(std::move(path),
        base::BindOnce(
            [](base::RunLoop* loop, std::vector<::filesystem::mojom::DirectoryEntryPtr>* out_entries, ::base::File::Error* out_error_code,
                std::vector<::filesystem::mojom::DirectoryEntryPtr> entries, ::base::File::Error error_code) {
...
void FileSystemManagerAsyncWaiter::TruncateSync(const ::GURL& file_path, int64_t length, ::base::File::Error* out_error_code)
{
    base::RunLoop loop;
...
::base::File::Error FileSystemManagerAsyncWaiter::TruncateSync(const ::GURL& file_path, int64_t length)
{
    ::base::File::Error async_wait_result;
...
void FileSystemManagerAsyncWaiter::CreateSnapshotFile(const ::GURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path,
    ::base::File::Error* out_error_code, ::mojo::PendingRemote<ReceivedSnapshotListener>* out_snapshot_listener)
{
    base::RunLoop loop;
...
void FileSystemManagerAsyncWaiter::GetPlatformPath(const ::GURL& file_path, ::base::FilePath* out_platform_path)
{
    base::RunLoop loop;
...
::base::FilePath FileSystemManagerAsyncWaiter::GetPlatformPath(const ::GURL& file_path)
{
...
void FileSystemManagerAsyncWaiter::RegisterBlob(const std::string& content_type, const ::GURL& url, uint64_t length,
    std::optional<::base::Time> expected_modification_time, ::blink::mojom::SerializedBlobPtr* out_blob)
{
    base::RunLoop loop;
