...
class BLINK_COMMON_EXPORT FileSystemCancellableOperation : public FileSystemCancellableOperationInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT FileSystemOperationListener : public FileSystemOperationListenerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_COMMON_EXPORT ReceivedSnapshotListener : public ReceivedSnapshotListenerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class BLINK_COMMON_EXPORT FileSystemManager : public FileSystemManagerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual bool ResolveURL(const ::GURL& filesystem_url, FileSystemInfoPtr* out_info, ::base::FilePath* out_file_path, bool* out_is_directory,
    ...
    virtual void Write(const ::GURL& file_path, ::mojo::PendingRemote<::blink::mojom::Blob> blob, int64_t position,
    ...
    virtual bool WriteSync(const ::GURL& file_path, ::mojo::PendingRemote<::blink::mojom::Blob> blob, int64_t position, int64_t* out_byte_count,
        ::base::File::Error* out_error_code);
    ...
    virtual bool CreateSnapshotFile(const ::GURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path,
    ...
    virtual bool RegisterBlob(const std::string& content_type, const ::GURL& url, uint64_t length, std::optional<::base::Time> expected_modification_time,
        ::blink::mojom::SerializedBlobPtr* out_blob);

    using RegisterBlobCallback = base::OnceCallback<void(::blink::mojom::SerializedBlobPtr)>;

    virtual void RegisterBlob(const std::string& content_type, const ::GURL& url, uint64_t length, std::optional<::base::Time> expected_modification_time,
        RegisterBlobCallback callback)
        = 0;
};

//class BLINK_COMMON_EXPORT FileSystemCancellableOperationProxy : public FileSystemCancellableOperation {
//public:
...
//class BLINK_COMMON_EXPORT FileSystemOperationListenerProxy : public FileSystemOperationListener {
//public:
...
//class BLINK_COMMON_EXPORT ReceivedSnapshotListenerProxy : public ReceivedSnapshotListener {
//public:
...
//class BLINK_COMMON_EXPORT FileSystemManagerProxy : public FileSystemManager {
//public:
...
//
//    bool Open(
//        const ::url::Origin& origin, FileSystemType file_system_type, std::string* out_name, ::GURL* out_root_url, ::base::File::Error* out_error_code) final;
//
//    void Open(const ::url::Origin& origin, FileSystemType file_system_type, OpenCallback callback) final;
//
//    bool ResolveURL(const ::GURL& filesystem_url, FileSystemInfoPtr* out_info, ::base::FilePath* out_file_path, bool* out_is_directory,
...
//
//    bool WriteSync(const ::GURL& file_path, ::mojo::PendingRemote<::blink::mojom::Blob> blob, int64_t position, int64_t* out_byte_count,
//        ::base::File::Error* out_error_code) final;
//
...
//
//    void Truncate(
//        const ::GURL& file_path, int64_t length, ::mojo::PendingReceiver<FileSystemCancellableOperation> op_receiver, TruncateCallback callback) final;
//
...
//
//    bool CreateSnapshotFile(const ::GURL& file_path, ::base::File::Info* out_file_info, ::base::FilePath* out_platform_path,
...
//
//    bool RegisterBlob(const std::string& content_type, const ::GURL& url, uint64_t length, std::optional<::base::Time> expected_modification_time,
//        ::blink::mojom::SerializedBlobPtr* out_blob) final;
//
    ...
    , mount_type(FileSystemType::kTemporary)
{
    ...
    FileSystemInfo(const std::string& name_in, const ::GURL& root_url_in, FileSystemType mount_type_in)
    ...
    {
        return mojo::internal::SerializeImpl<FileSystemInfo::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FileSystemInfo::DataView, ::blink::mojom::FileSystemInfoPtr> {
    static bool IsNull(const ::blink::mojom::FileSystemInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::blink::mojom::FileSystemInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::blink::mojom::FileSystemInfo::name)& name(const ::blink::mojom::FileSystemInfoPtr& input)
    {
        return input->name;
    }

    static const decltype(::blink::mojom::FileSystemInfo::root_url)& root_url(const ::blink::mojom::FileSystemInfoPtr& input)
    {
        return input->root_url;
    }

    static decltype(::blink::mojom::FileSystemInfo::mount_type) mount_type(const ::blink::mojom::FileSystemInfoPtr& input)
    {
