// third_party/blink/public/mojom/filesystem/file_system.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<FileSystemInfo_Data>;

    FileSystemInfo_Data();
    ~FileSystemInfo_Data() = delete;
};
static_assert(sizeof(FileSystemInfo_Data) == 32, "Bad sizeof(FileSystemInfo_Data)");
// Used by FileSystemInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct FileSystemInfo_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    FileSystemInfo_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<FileSystemInfo_Data> fragment(message);
...
const mojo::internal::UnserializedMessageContext::Tag FileSystemInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
