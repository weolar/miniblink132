...
void DevToolsFrontendProxy::SetupDevToolsFrontend(const std::string& in_api_script, ::mojo::PendingAssociatedRemote<DevToolsFrontendHost> in_host)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::DevToolsFrontend::SetupDevToolsFrontend", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("api_script"), in_api_script, "<value of type const std::string&>");
...
void DevToolsFrontendProxy::SetupDevToolsExtensionAPI(const std::string& in_extension_api)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send blink::mojom::DevToolsFrontend::SetupDevToolsExtensionAPI", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("extension_api"), in_extension_api, "<value of type const std::string&>");
    });
#endif
