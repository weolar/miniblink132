...
class BLINK_COMMON_EXPORT DevicePostureProvider : public DevicePostureProviderInterfaceBase {
public:
...
class BLINK_COMMON_EXPORT DevicePostureClient : public DevicePostureClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_COMMON_EXPORT DevicePostureProviderProxy : public DevicePostureProvider {
//public:
...
//class BLINK_COMMON_EXPORT DevicePostureClientProxy : public DevicePostureClient {
//public:
