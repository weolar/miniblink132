...
const WrapperTypeInfo& PresentationConnectionAvailableEvent::wrapper_type_info_ = V8PresentationConnectionAvailableEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, PresentationConnectionAvailableEvent>::value,
...
void ConnectionAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<PresentationConnection, std::remove_cvref_t<decltype(return_value)>>,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<PresentationConnectionAvailableEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8PresentationConnectionAvailableEvent::InstallInterfaceTemplate(
...
void V8PresentationConnectionAvailableEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "connection", "PresentationConnectionAvailableEvent", ConnectionAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "isTrusted", "PresentationConnectionAvailableEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
