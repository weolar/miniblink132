...
const WrapperTypeInfo& WebGLTimerQueryEXT::wrapper_type_info_ = V8WebGLTimerQueryEXT::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, WebGLTimerQueryEXT>::value,
...
void V8WebGLTimerQueryEXT::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
