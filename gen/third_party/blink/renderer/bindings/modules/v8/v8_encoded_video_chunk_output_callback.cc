...
const char* V8EncodedVideoChunkOutputCallback::NameInHeapSnapshot() const
{
    return "V8EncodedVideoChunkOutputCallback";
}

v8::Maybe<void> V8EncodedVideoChunkOutputCallback::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedVideoChunk* arg1_chunk, const EncodedVideoChunkMetadata* arg2_metadata)
{
...
void V8EncodedVideoChunkOutputCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedVideoChunk* arg1_chunk, const EncodedVideoChunkMetadata* arg2_metadata)
{
    v8::Isolate* isolate = GetIsolate();
