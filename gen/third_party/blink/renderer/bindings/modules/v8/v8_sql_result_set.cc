...
bool V8SQLResultSet::IsExposed(ExecutionContext* execution_context)
{
    return false;
}
...
const WrapperTypeInfo V8SQLResultSet::wrapper_type_info_ {
    gin::kEmbedderBlink,
    V8SQLResultSet::InstallInterfaceTemplate,
    V8SQLResultSet::InstallContextDependentProperties,
    "SQLResultSet",
    nullptr,
    V8SQLResultSet::kThisTag,
    V8SQLResultSet::kMaxSubclassTag,
...
const WrapperTypeInfo& SQLResultSet::wrapper_type_info_ = V8SQLResultSet::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SQLResultSet>::value,
    "SQLResultSet inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace {

namespace v8_sql_result_set {
...
void RowsAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("SQLResultSet.rows.get");
    ...
    static_assert(bindings::IsReturnTypeCompatible<SQLResultSetRowList, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void InsertIdAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{

    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SQLResultSet_insertId_Getter");
    BLINK_BINDINGS_TRACE_EVENT("SQLResultSet.insertId.get");

    v8::Isolate* isolate = info.GetIsolate();
    v8::Local<v8::Object> v8_receiver = info.This();
    SQLResultSet* blink_receiver = V8SQLResultSet::ToWrappableUnsafe(isolate, v8_receiver);
    ExceptionState exception_state(isolate);
    auto&& return_value = blink_receiver->insertId(exception_state);
...
void RowsAffectedAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{

    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SQLResultSet_rowsAffected_Getter");
    BLINK_BINDINGS_TRACE_EVENT("SQLResultSet.rowsAffected.get");
...
using namespace v8_sql_result_set;

} // namespace

void V8SQLResultSet::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8SQLResultSet::GetWrapperTypeInfo();
...
void V8SQLResultSet::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "rows", "SQLResultSet", RowsAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "insertId", "SQLResultSet", InsertIdAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "rowsAffected", "SQLResultSet", RowsAffectedAttributeGetCallback, nullptr, unsigned(v8::None),
...
void V8SQLResultSet::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object,
