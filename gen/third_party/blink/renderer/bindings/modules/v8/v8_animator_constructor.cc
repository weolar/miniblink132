...
const char* V8AnimatorConstructor::NameInHeapSnapshot() const
{
    return "V8AnimatorConstructor";
}

v8::Maybe<ScriptValue> V8AnimatorConstructor::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_options, const ScriptValue& arg2_state)
{
