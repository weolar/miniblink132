...
const WrapperTypeInfo V8GPUMapMode::wrapper_type_info_ {
    ...
    "GPUMapMode",
    nullptr,
    V8GPUMapMode::kThisTag,
    V8GPUMapMode::kMaxSubclassTag,
...
void V8GPUMapMode::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
