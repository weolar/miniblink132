...
const WrapperTypeInfo V8InstallEvent::wrapper_type_info_ {
    ...
    V8InstallEvent::InstallContextDependentProperties,
    "InstallEvent",
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<InstallEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void AddRoutesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<IDLUndefined> return_value = blink_receiver->addRoutes(script_state, arg1_rules, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "isTrusted", "InstallEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
...
void V8InstallEvent::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object,
    ...
    FeatureSelector feature_selector)
{
    ...
    if ((feature_selector.IsAll() && RuntimeEnabledFeatures::ServiceWorkerStaticRouterEnabled(execution_context))
        || feature_selector.IsAnyOf(mojom::blink::OriginTrialFeature::kServiceWorkerStaticRouter)) {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "addRoutes", "InstallEvent", AddRoutesOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
