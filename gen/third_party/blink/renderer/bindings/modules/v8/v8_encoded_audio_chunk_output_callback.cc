...
const char* V8EncodedAudioChunkOutputCallback::NameInHeapSnapshot() const
{
    return "V8EncodedAudioChunkOutputCallback";
}

v8::Maybe<void> V8EncodedAudioChunkOutputCallback::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedAudioChunk* arg1_output, const EncodedAudioChunkMetadata* arg2_metadata)
{
...
void V8EncodedAudioChunkOutputCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedAudioChunk* arg1_output, const EncodedAudioChunkMetadata* arg2_metadata)
{
    v8::Isolate* isolate = GetIsolate();
