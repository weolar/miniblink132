...
V8UnionCanvasFilterOrString::V8UnionCanvasFilterOrString(const String& value)
    : content_type_(ContentType::kString)
    , member_string_(value)
{
}

V8UnionCanvasFilterOrString::V8UnionCanvasFilterOrString(String&& value)
    : content_type_(ContentType::kString)
...
{
    TraceIfNeeded<Member<CanvasFilter>>::Trace(visitor, member_canvas_filter_);
