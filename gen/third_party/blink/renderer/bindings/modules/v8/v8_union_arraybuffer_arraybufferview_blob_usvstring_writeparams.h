...
public:
    ...
    enum class ContentType { kArrayBuffer, kArrayBufferView, kBlob, kUSVString, kWriteParams };

    static V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams* Create(
        v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(DOMArrayBuffer* value)
        : content_type_(ContentType::kArrayBuffer)
        , member_array_buffer_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(NotShared<DOMArrayBufferView> value)
        : content_type_(ContentType::kArrayBufferView)
        , member_array_buffer_view_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(Blob* value)
    ...
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(WriteParams* value)
