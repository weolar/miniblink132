...
const WrapperTypeInfo& SpeechRecognitionAlternative::wrapper_type_info_ = V8SpeechRecognitionAlternative::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SpeechRecognitionAlternative>::value,
...
void V8SpeechRecognitionAlternative::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "transcript", "SpeechRecognitionAlternative", TranscriptAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "confidence", "SpeechRecognitionAlternative", ConfidenceAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
...
void V8SpeechRecognitionAlternative::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
