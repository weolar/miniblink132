...
void PaymentInstrument::setName(String&& value)
{
...
void PaymentInstrument::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    dictionary_from_v8_context.SetCurrentPropertyName("capabilities");
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLObject, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate),
            fallback_presence_var, member_capabilities_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<ImageObject>, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_icons_, member_icons_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_method_, member_method_, class_like_name, exception_state)) {
        return;
    }
