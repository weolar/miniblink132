...
const WrapperTypeInfo& WebGLDrawInstancedBaseVertexBaseInstance::wrapper_type_info_ = V8WebGLDrawInstancedBaseVertexBaseInstance::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, WebGLDrawInstancedBaseVertexBaseInstance>::value,
...
void DrawElementsInstancedBaseVertexBaseInstanceWEBGLOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(
        info.GetIsolate(), "Blink_WebGLDrawInstancedBaseVertexBaseInstance_drawElementsInstancedBaseVertexBaseInstanceWEBGL");
    ...
    blink_receiver->drawElementsInstancedBaseVertexBaseInstanceWEBGL(
        arg1_mode, arg2_count, arg3_type, arg4_offset, arg5_instance_count, arg6_basevertex, arg7_baseinstance);
}
...
void V8WebGLDrawInstancedBaseVertexBaseInstance::InstallInterfaceTemplate(
...
void V8WebGLDrawInstancedBaseVertexBaseInstance::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "drawArraysInstancedBaseInstanceWEBGL", "WebGLDrawInstancedBaseVertexBaseInstance", DrawArraysInstancedBaseInstanceWEBGLOperationCallback, 5,
            ...
            { "drawElementsInstancedBaseVertexBaseInstanceWEBGL", "WebGLDrawInstancedBaseVertexBaseInstance",
                DrawElementsInstancedBaseVertexBaseInstanceWEBGLOperationCallback, 7, unsigned(v8::None),
...
void V8WebGLDrawInstancedBaseVertexBaseInstance::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
