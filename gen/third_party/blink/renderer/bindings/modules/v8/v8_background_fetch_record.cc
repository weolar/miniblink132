...
const WrapperTypeInfo& BackgroundFetchRecord::wrapper_type_info_ = V8BackgroundFetchRecord::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, BackgroundFetchRecord>::value,
...
void ResponseReadyAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<Response> return_value = blink_receiver->responseReady(script_state);
...
void V8BackgroundFetchRecord::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "request", "BackgroundFetchRecord", RequestAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "responseReady", "BackgroundFetchRecord", ResponseReadyAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
