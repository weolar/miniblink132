...
v8::Maybe<void> V8SQLTransactionCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction)
{
    const char* const class_like_name = "SQLTransactionCallback";
...
void V8SQLTransactionCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction)
{
    v8::Isolate* isolate = GetIsolate();
    v8::TryCatch try_catch(isolate);
    try_catch.SetVerbose(true);

    std::ignore = handleEvent(arg0_receiver, arg1_transaction);
}
