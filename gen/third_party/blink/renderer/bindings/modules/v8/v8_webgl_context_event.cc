...
const WrapperTypeInfo& WebGLContextEvent::wrapper_type_info_ = V8WebGLContextEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, WebGLContextEvent>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<WebGLContextEventInit>::NativeValue(
        std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init;
    ...
    static_assert(bindings::IsReturnTypeCompatible<WebGLContextEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8WebGLContextEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "statusMessage", "WebGLContextEvent", StatusMessageAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "isTrusted", "WebGLContextEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
