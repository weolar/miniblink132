...
{
    TraceIfNeeded<Member<EncryptionPattern>>::Trace(visitor, member_encryption_pattern_);
    TraceIfNeeded<String>::Trace(visitor, member_encryption_scheme_);
    TraceIfNeeded<Member<V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared>>::Trace(visitor, member_initialization_vector_);
    TraceIfNeeded<Member<V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared>>::Trace(visitor, member_key_id_);
    TraceIfNeeded<HeapVector<Member<SubsampleEntry>>>::Trace(visitor, member_subsample_layout_);
...
void DecryptConfig::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<EncryptionPattern, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate),
            has_encryption_pattern_, member_encryption_pattern_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate),
            fallback_presence_var, member_encryption_scheme_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared, is_required>(isolate, current_context,
            v8_dictionary, v8_own_member_names[2].Get(isolate), fallback_presence_var, member_initialization_vector_, class_like_name, exception_state)) {
        return;
    }
    dictionary_from_v8_context.SetCurrentPropertyName("keyId");
    if (!bindings::GetDictionaryMemberFromV8Object<V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared, is_required>(isolate, current_context,
            v8_dictionary, v8_own_member_names[3].Get(isolate), fallback_presence_var, member_key_id_, class_like_name, exception_state)) {
        return;
    }
    dictionary_from_v8_context.SetCurrentPropertyName("subsampleLayout");
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<SubsampleEntry>, is_required>(isolate, current_context, v8_dictionary,
            v8_own_member_names[4].Get(isolate), fallback_presence_var, member_subsample_layout_, class_like_name, exception_state)) {
        return;
    }
}
