...
class MODULES_EXPORT V8PaymentInstruments final : public bindings::V8InterfaceBridge<V8PaymentInstruments, PaymentInstruments> {
...
public:
    ...
    static constexpr v8::CppHeapPointerTag kThisTag = static_cast<v8::CppHeapPointerTag>(1177);
    static constexpr v8::CppHeapPointerTag kMaxSubclassTag = static_cast<v8::CppHeapPointerTag>(1177);
...
private:
    ...
    friend class PaymentInstruments;
};
