...
public:
    ...
    [[nodiscard]] v8::Maybe<void> handleEvent(
    ...
    void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction, SQLResultSet* arg2_result_set);
};
