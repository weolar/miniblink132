...
const WrapperTypeInfo& PresentationRequest::wrapper_type_info_ = V8PresentationRequest::wrapper_type_info_;

// [ActiveScriptWrappable]
static_assert(std::is_base_of<ActiveScriptWrappableBase, PresentationRequest>::value,
...
void ConstructorOverload1(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<PresentationRequest, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void ConstructorOverload2(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ExecutionContext* execution_context = current_execution_context;
    ExceptionState exception_state(isolate);
    auto&& arg1_urls = NativeValueTraits<IDLSequence<V8UnionPresentationSourceOrUSVString>>::ArgumentValue(isolate, 0, info[0], exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void GetAvailabilityOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<PresentationAvailability> return_value = blink_receiver->getAvailability(script_state, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void ReconnectOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<PresentationConnection> return_value = blink_receiver->reconnect(script_state, arg1_id, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
void StartOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ExceptionState exception_state(isolate, exception_context_type, class_like_name, property_name);
    ScriptPromise<PresentationConnection> return_value = blink_receiver->start(script_state, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
void V8PresentationRequest::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "onconnectionavailable", "PresentationRequest", OnconnectionavailableAttributeGetCallback, OnconnectionavailableAttributeSetCallback,
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "getAvailability", "PresentationRequest", GetAvailabilityOperationCallback, 0, unsigned(v8::None),
            ...
            { "reconnect", "PresentationRequest", ReconnectOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "start", "PresentationRequest", StartOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
