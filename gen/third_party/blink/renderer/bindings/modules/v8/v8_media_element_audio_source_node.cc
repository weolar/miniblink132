...
void MediaElementAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<HTMLMediaElement, std::remove_cvref_t<decltype(return_value)>>,
...
void V8MediaElementAudioSourceNode::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "mediaElement", "MediaElementAudioSourceNode", MediaElementAttributeGetCallback, nullptr, unsigned(v8::None),
