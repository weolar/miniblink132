...
const WrapperTypeInfo& PresentationConnectionList::wrapper_type_info_ = V8PresentationConnectionList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, PresentationConnectionList>::value,
...
void ConnectionsAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<IDLArray<PresentationConnection>, std::remove_cvref_t<decltype(return_value)>>,
...
void V8PresentationConnectionList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "connections", "PresentationConnectionList", ConnectionsAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "onconnectionavailable", "PresentationConnectionList", OnconnectionavailableAttributeGetCallback, OnconnectionavailableAttributeSetCallback,
