...
class MODULES_EXPORT V8FileSystemChangeRecord final : public bindings::V8InterfaceBridge<V8FileSystemChangeRecord, FileSystemChangeRecord> {
...
public:
    ...
    static constexpr v8::CppHeapPointerTag kThisTag = static_cast<v8::CppHeapPointerTag>(1103);
    static constexpr v8::CppHeapPointerTag kMaxSubclassTag = static_cast<v8::CppHeapPointerTag>(1103);
...
private:
    ...
    friend class FileSystemChangeRecord;
};
