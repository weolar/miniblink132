...
public:
    ...
    explicit V8BlinkAudioWorkletProcessCallback(v8::Local<v8::Object> callback_object)
    ...
    [[nodiscard]] v8::Maybe<ScriptValue> Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_inputs,
