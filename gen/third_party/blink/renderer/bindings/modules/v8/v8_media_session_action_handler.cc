...
const char* V8MediaSessionActionHandler::NameInHeapSnapshot() const
{
...
void V8MediaSessionActionHandler::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const MediaSessionActionDetails* arg1_details)
{
    v8::Isolate* isolate = GetIsolate();
