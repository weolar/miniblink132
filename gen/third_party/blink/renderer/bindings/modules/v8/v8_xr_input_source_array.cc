...
const WrapperTypeInfo& XRInputSourceArray::wrapper_type_info_ = V8XRInputSourceArray::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, XRInputSourceArray>::value,
...
v8::Intercepted V8XRInputSourceArray::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<XRInputSource, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
    return v8::Intercepted::kYes;
}

v8::Intercepted V8XRInputSourceArray::IndexedPropertySetterCallback(
...
v8::Intercepted V8XRInputSourceArray::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8XRInputSourceArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8XRInputSourceArray::IndexedPropertyGetterCallback(index, info);
...
void V8XRInputSourceArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8XRInputSourceArray::IndexedPropertyGetterCallback, V8XRInputSourceArray::IndexedPropertySetterCallback,
            nullptr, // query
            V8XRInputSourceArray::IndexedPropertyDeleterCallback, V8XRInputSourceArray::IndexedPropertyEnumeratorCallback,
            V8XRInputSourceArray::IndexedPropertyDefinerCallback, V8XRInputSourceArray::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(),
...
void V8XRInputSourceArray::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "XRInputSourceArray", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
