...
void CreateAnchorOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<XRAnchor> return_value = blink_receiver->createAnchor(script_state, exception_state);
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "getPose", "XRHitTestResult", GetPoseOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    if (RuntimeEnabledFeatures::WebXREnabled()) {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "createAnchor", "XRHitTestResult", CreateAnchorOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
