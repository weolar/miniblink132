...
void CollectedClientData::FillTemplateProperties(WTF::Vector<std::string_view>& properties) const
{
...
void CollectedClientData::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate),
            has_token_binding_id_, member_token_binding_id_, class_like_name, exception_state)) {
        return;
    }
