...
class MODULES_EXPORT V8USBIsochronousOutTransferResult final
    : public bindings::V8InterfaceBridge<V8USBIsochronousOutTransferResult, USBIsochronousOutTransferResult> {
...
public:
    ...
    static constexpr v8::CppHeapPointerTag kThisTag = static_cast<v8::CppHeapPointerTag>(1377);
    static constexpr v8::CppHeapPointerTag kMaxSubclassTag = static_cast<v8::CppHeapPointerTag>(1377);
