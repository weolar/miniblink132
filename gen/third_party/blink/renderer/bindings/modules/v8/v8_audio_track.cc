...
void V8AudioTrack::Impl::Init()
{
    V8AudioTrack::install_interface_template_func_ = InstallInterfaceTemplate;
    V8AudioTrack::install_unconditional_props_func_ = InstallUnconditionalProperties;
    V8AudioTrack::install_context_independent_props_func_ = InstallContextIndependentProperties;
}

namespace {

namespace v8_audio_track {
...
void IdAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("AudioTrack.id.get");

    v8::Isolate* isolate = info.GetIsolate();
    v8::Local<v8::Object> v8_receiver = info.This();
    AudioTrack* blink_receiver = V8AudioTrack::ToWrappableUnsafe(isolate, v8_receiver);
...
void KindAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("AudioTrack.kind.get");
...
void LabelAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("AudioTrack.label.get");
...
void LanguageAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("AudioTrack.language.get");
...
void EnabledAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("AudioTrack.enabled.get");
...
void EnabledAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("AudioTrack.enabled.set");
...
void SourceBufferAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("AudioTrack.sourceBuffer.get");
...
using namespace v8_audio_track;

} // namespace

void V8AudioTrack::Impl::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8AudioTrack::GetWrapperTypeInfo();
...
void V8AudioTrack::Impl::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "id", "AudioTrack", IdAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "kind", "AudioTrack", KindAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "label", "AudioTrack", LabelAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "language", "AudioTrack", LanguageAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "enabled", "AudioTrack", EnabledAttributeGetCallback, EnabledAttributeSetCallback, unsigned(v8::None),
...
void V8AudioTrack::Impl::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    using bindings::IDLMemberInstaller;
    ...
    if (RuntimeEnabledFeatures::AudioVideoTracksEnabled()) {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "sourceBuffer", "AudioTrack", SourceBufferAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
