...
{
    TraceIfNeeded<Member<MLSupportLimits>>::Trace(visitor, member_condition_);
    TraceIfNeeded<Member<MLSupportLimits>>::Trace(visitor, member_false_value_);
    TraceIfNeeded<Member<MLSupportLimits>>::Trace(visitor, member_output_);
    TraceIfNeeded<Member<MLSupportLimits>>::Trace(visitor, member_true_value_);
    bindings::DictionaryBase::Trace(visitor);
}

void MLWhereSupportLimits::FillTemplateProperties(WTF::Vector<std::string_view>& properties) const
{
...
void MLWhereSupportLimits::FillValuesImpl(ScriptState* script_state, base::span<v8::MaybeLocal<v8::Value>> values) const
{
    ...
    if (hasCondition()) {
        values[0] = ToV8Traits<MLSupportLimits>::ToV8(script_state, member_condition_.Get());
        DCHECK(!values[0].IsEmpty());
    }
    if (hasFalseValue()) {
        values[1] = ToV8Traits<MLSupportLimits>::ToV8(script_state, member_false_value_.Get());
        DCHECK(!values[1].IsEmpty());
    }
    if (hasOutput()) {
        values[2] = ToV8Traits<MLSupportLimits>::ToV8(script_state, member_output_.Get());
        DCHECK(!values[2].IsEmpty());
    }
    if (hasTrueValue()) {
        values[3] = ToV8Traits<MLSupportLimits>::ToV8(script_state, member_true_value_.Get());
...
void MLWhereSupportLimits::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<MLSupportLimits, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate),
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<MLSupportLimits, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate),
            has_false_value_, member_false_value_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<MLSupportLimits, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_output_, member_output_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<MLSupportLimits, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate),
            has_true_value_, member_true_value_, class_like_name, exception_state)) {
        return;
    }
}
