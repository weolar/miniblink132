...
AuthenticationExtensionsPaymentInputs* AuthenticationExtensionsPaymentInputs::Create(
...
{
    TraceIfNeeded<bool>::Trace(visitor, member_is_payment_);
    bindings::DictionaryBase::Trace(visitor);
}

void AuthenticationExtensionsPaymentInputs::FillTemplateProperties(WTF::Vector<std::string_view>& properties) const
{
...
void AuthenticationExtensionsPaymentInputs::FillValuesImpl(ScriptState* script_state, base::span<v8::MaybeLocal<v8::Value>> values) const
{
    ...
    if (hasIsPayment()) {
        values[0] = ToV8Traits<IDLBoolean>::ToV8(script_state, member_is_payment_);
...
void AuthenticationExtensionsPaymentInputs::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate),
            has_is_payment_, member_is_payment_, class_like_name, exception_state)) {
        return;
    }
}
