...
const WrapperTypeInfo& DOMPluginArray::wrapper_type_info_ = V8PluginArray::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, DOMPluginArray>::value,
...
v8::Intercepted V8PluginArray::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<IDLNullable<DOMPlugin>, std::remove_cvref_t<decltype(return_value)>>,
...
v8::Intercepted V8PluginArray::NamedPropertySetterCallback(
...
v8::Intercepted V8PluginArray::NamedPropertyDefinerCallback(
...
v8::Intercepted V8PluginArray::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    //  of performing the steps listed in the description of operation with P as the
    //  only argument value."
    auto intercepted = V8PluginArray::NamedPropertyGetterCallback(v8_property_name, info);
    // "Return OrdinaryGetOwnProperty(O, P)."
...
v8::Intercepted V8PluginArray::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<void>& info)
{
...
v8::Intercepted V8PluginArray::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8PluginArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8PluginArray::IndexedPropertyGetterCallback(index, info);
    if (intercepted == v8::Intercepted::kNo) {
        // step 3. Return OrdinaryGetOwnProperty(O, P).
        // Do not intercept.  Fallback to OrdinaryGetOwnProperty.
        return v8::Intercepted::kNo;
...
void RefreshOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<IDLBoolean>::NativeValue(
        std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg1_reload { false };
...
void V8PluginArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::NamedPropertyHandlerConfiguration(V8PluginArray::NamedPropertyGetterCallback, V8PluginArray::NamedPropertySetterCallback,
            V8PluginArray::NamedPropertyQueryCallback, V8PluginArray::NamedPropertyDeleterCallback, V8PluginArray::NamedPropertyEnumeratorCallback,
            V8PluginArray::NamedPropertyDefinerCallback, V8PluginArray::NamedPropertyDescriptorCallback, v8::Local<v8::Value>(),
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8PluginArray::IndexedPropertyGetterCallback, V8PluginArray::IndexedPropertySetterCallback,
            nullptr, // query
            V8PluginArray::IndexedPropertyDeleterCallback, V8PluginArray::IndexedPropertyEnumeratorCallback, V8PluginArray::IndexedPropertyDefinerCallback,
            V8PluginArray::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));
...
void V8PluginArray::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "PluginArray", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", "PluginArray", ItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "namedItem", "PluginArray", NamedItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "refresh", "PluginArray", RefreshOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
