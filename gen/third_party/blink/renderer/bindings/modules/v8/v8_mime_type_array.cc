...
const WrapperTypeInfo& DOMMimeTypeArray::wrapper_type_info_ = V8MimeTypeArray::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, DOMMimeTypeArray>::value,
...
v8::Intercepted V8MimeTypeArray::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<IDLNullable<DOMMimeType>, std::remove_cvref_t<decltype(return_value)>>,
...
v8::Intercepted V8MimeTypeArray::NamedPropertySetterCallback(
...
v8::Intercepted V8MimeTypeArray::NamedPropertyDefinerCallback(
...
v8::Intercepted V8MimeTypeArray::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    //  of performing the steps listed in the description of operation with P as the
    //  only argument value."
    auto intercepted = V8MimeTypeArray::NamedPropertyGetterCallback(v8_property_name, info);
    // "Return OrdinaryGetOwnProperty(O, P)."
...
v8::Intercepted V8MimeTypeArray::IndexedPropertySetterCallback(
...
v8::Intercepted V8MimeTypeArray::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8MimeTypeArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8MimeTypeArray::IndexedPropertyGetterCallback(index, info);
    if (intercepted == v8::Intercepted::kNo) {
        // step 3. Return OrdinaryGetOwnProperty(O, P).
        // Do not intercept.  Fallback to OrdinaryGetOwnProperty.
        return v8::Intercepted::kNo;
...
void V8MimeTypeArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::NamedPropertyHandlerConfiguration(V8MimeTypeArray::NamedPropertyGetterCallback, V8MimeTypeArray::NamedPropertySetterCallback,
            V8MimeTypeArray::NamedPropertyQueryCallback, V8MimeTypeArray::NamedPropertyDeleterCallback, V8MimeTypeArray::NamedPropertyEnumeratorCallback,
            V8MimeTypeArray::NamedPropertyDefinerCallback, V8MimeTypeArray::NamedPropertyDescriptorCallback, v8::Local<v8::Value>(),
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8MimeTypeArray::IndexedPropertyGetterCallback,
        V8MimeTypeArray::IndexedPropertySetterCallback,
        nullptr, // query
        V8MimeTypeArray::IndexedPropertyDeleterCallback, V8MimeTypeArray::IndexedPropertyEnumeratorCallback, V8MimeTypeArray::IndexedPropertyDefinerCallback,
        V8MimeTypeArray::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));
...
void V8MimeTypeArray::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "MimeTypeArray", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", "MimeTypeArray", ItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "namedItem", "MimeTypeArray", NamedItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
