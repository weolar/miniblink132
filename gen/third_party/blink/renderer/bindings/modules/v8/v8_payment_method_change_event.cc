...
const WrapperTypeInfo& PaymentMethodChangeEvent::wrapper_type_info_ = V8PaymentMethodChangeEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, PaymentMethodChangeEvent>::value,
...
void MethodDetailsAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    auto&& return_value = blink_receiver->methodDetails(script_state);
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<PaymentMethodChangeEventInit>::NativeValue(
    ...
    static_assert(bindings::IsReturnTypeCompatible<PaymentMethodChangeEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8PaymentMethodChangeEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "methodName", "PaymentMethodChangeEvent", MethodNameAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "methodDetails", "PaymentMethodChangeEvent", MethodDetailsAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "isTrusted", "PaymentMethodChangeEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
