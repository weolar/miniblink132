...
const WrapperTypeInfo& RestrictionTarget::wrapper_type_info_ = V8RestrictionTarget::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, RestrictionTarget>::value,
...
void FromElementStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<RestrictionTarget> return_value = RestrictionTarget::fromElement(script_state, arg1_element, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void V8RestrictionTarget::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object,
    ...
    FeatureSelector feature_selector)
{
    ...
    if (execution_context->IsWindow() && (feature_selector.IsAll() && RuntimeEnabledFeatures::ElementCaptureEnabled())) {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "fromElement", "RestrictionTarget", FromElementStaticOperationCallback, 1, unsigned(v8::None),
