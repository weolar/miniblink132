...
MediaDecodingConfiguration::MediaDecodingConfiguration(v8::Isolate* isolate)
    : MediaConfiguration(isolate)
{
}
...
void MediaDecodingConfiguration::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<MediaCapabilitiesKeySystemConfiguration, is_optional>(isolate, current_context, v8_dictionary,
            v8_own_member_names[0].Get(isolate), has_key_system_configuration_, member_key_system_configuration_, class_like_name, exception_state)) {
        return;
    }
    dictionary_from_v8_context.SetCurrentPropertyName("type");
    constexpr bool is_required = true;
    bool fallback_presence_var;
    if (!bindings::GetDictionaryMemberFromV8Object<V8MediaDecodingType, is_required>(isolate, current_context, v8_dictionary,
            v8_own_member_names[1].Get(isolate), fallback_presence_var, member_type_, class_like_name, exception_state)) {
        return;
    }
}
