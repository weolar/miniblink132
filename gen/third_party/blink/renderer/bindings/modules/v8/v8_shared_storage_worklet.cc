...
bool V8SharedStorageWorklet::IsExposed(ExecutionContext* execution_context)
{

    return execution_context->IsWindow() && RuntimeEnabledFeatures::SharedStorageAPIEnabled();
}
...
const WrapperTypeInfo V8SharedStorageWorklet::wrapper_type_info_ {
    ...
    nullptr,
    V8SharedStorageWorklet::kThisTag,
    V8SharedStorageWorklet::kMaxSubclassTag,
...
const WrapperTypeInfo& SharedStorageWorklet::wrapper_type_info_ = V8SharedStorageWorklet::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SharedStorageWorklet>::value,
...
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SharedStorageWorklet_addModule");
    BLINK_BINDINGS_TRACE_EVENT("SharedStorageWorklet.addModule");
    ...
    // [Measure], [MeasureAs]
    UseCounter::Count(current_execution_context, WebFeature::kSharedStorageAPI_AddModule_Method);
...
using namespace v8_shared_storage_worklet;

} // namespace

void V8SharedStorageWorklet::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8SharedStorageWorklet::GetWrapperTypeInfo();
...
void V8SharedStorageWorklet::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "addModule", "SharedStorageWorklet", AddModuleOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...
void V8SharedStorageWorklet::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
    ...
    v8::Local<v8::Template> interface_template, FeatureSelector feature_selector)
{
    ...
    if (execution_context->IsWindow() && (feature_selector.IsAll() && RuntimeEnabledFeatures::SharedStorageAPIM125Enabled())) {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "run", "SharedStorageWorklet", RunOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "selectURL", "SharedStorageWorklet", SelectURLOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
        v8::Local<v8::FunctionTemplate> interface_function_template = interface_template.As<v8::FunctionTemplate>();
