...
const char* V8RTCSessionDescriptionCallback::NameInHeapSnapshot() const
{
    return "V8RTCSessionDescriptionCallback";
}

v8::Maybe<void> V8RTCSessionDescriptionCallback::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const RTCSessionDescriptionInit* arg1_description)
{
...
void V8RTCSessionDescriptionCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const RTCSessionDescriptionInit* arg1_description)
{
    v8::Isolate* isolate = GetIsolate();
