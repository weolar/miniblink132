...
const WrapperTypeInfo& AudioDestinationNode::wrapper_type_info_ = V8AudioDestinationNode::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, AudioDestinationNode>::value,
...
void V8AudioDestinationNode::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "maxChannelCount", "AudioDestinationNode", MaxChannelCountAttributeGetCallback, nullptr, unsigned(v8::None),
