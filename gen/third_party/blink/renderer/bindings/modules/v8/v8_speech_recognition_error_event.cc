...
const WrapperTypeInfo V8SpeechRecognitionErrorEvent::wrapper_type_info_ {
    ...
    V8SpeechRecognitionErrorEvent::InstallContextDependentProperties,
...
const WrapperTypeInfo& SpeechRecognitionErrorEvent::wrapper_type_info_ = V8SpeechRecognitionErrorEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SpeechRecognitionErrorEvent>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<SpeechRecognitionErrorEventInit>::NativeValue(
    ...
    static_assert(bindings::IsReturnTypeCompatible<SpeechRecognitionErrorEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8SpeechRecognitionErrorEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "error", "SpeechRecognitionErrorEvent", ErrorAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "message", "SpeechRecognitionErrorEvent", MessageAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "isTrusted", "SpeechRecognitionErrorEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
...
void V8SpeechRecognitionErrorEvent::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
