...
const WrapperTypeInfo& ImageCapture::wrapper_type_info_ = V8ImageCapture::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, ImageCapture>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<ImageCapture, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void GetPhotoCapabilitiesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<PhotoCapabilities> return_value = blink_receiver->getPhotoCapabilities(script_state);
...
void GetPhotoSettingsOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptState* receiver_script_state = ScriptState::ForRelevantRealm(isolate, v8_receiver);
    ScriptState* script_state = receiver_script_state;
    ScriptPromise<PhotoSettings> return_value = blink_receiver->getPhotoSettings(script_state);
    bindings::V8SetReturnValue(info, return_value);
}
...
void GrabFrameOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptState* receiver_script_state = ScriptState::ForRelevantRealm(isolate, v8_receiver);
    ScriptState* script_state = receiver_script_state;
    ScriptPromise<ImageBitmap> return_value = blink_receiver->grabFrame(script_state);
    bindings::V8SetReturnValue(info, return_value);
}
...
void TakePhotoOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptState* receiver_script_state = ScriptState::ForRelevantRealm(isolate, v8_receiver);
    ScriptState* script_state = receiver_script_state;
    decltype(NativeValueTraits<PhotoSettings>::NativeValue(
        std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg1_photo_settings;
    ...
    ScriptPromise<Blob> return_value = blink_receiver->takePhoto(script_state, arg1_photo_settings);
    bindings::V8SetReturnValue(info, return_value);
}
...
void V8ImageCapture::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "track", "ImageCapture", TrackAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "getPhotoCapabilities", "ImageCapture", GetPhotoCapabilitiesOperationCallback, 0, unsigned(v8::None),
            ...
            { "getPhotoSettings", "ImageCapture", GetPhotoSettingsOperationCallback, 0, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(v8::SideEffectType::kHasSideEffect) },
            { "grabFrame", "ImageCapture", GrabFrameOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "takePhoto", "ImageCapture", TakePhotoOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
