...
const char* V8PressureUpdateCallback::NameInHeapSnapshot() const
{
    return "V8PressureUpdateCallback";
}

v8::Maybe<void> V8PressureUpdateCallback::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<PressureRecord>>& arg1_changes, PressureObserver* arg2_observer)
{
...
void V8PressureUpdateCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<PressureRecord>>& arg1_changes, PressureObserver* arg2_observer)
{
    v8::Isolate* isolate = GetIsolate();
