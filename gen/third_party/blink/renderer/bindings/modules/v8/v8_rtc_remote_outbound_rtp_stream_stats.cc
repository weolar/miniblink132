...
RTCRemoteOutboundRtpStreamStats::RTCRemoteOutboundRtpStreamStats(v8::Isolate* isolate)
...
void RTCRemoteOutboundRtpStreamStats::Trace(Visitor* visitor) const
{
    ...
    TraceIfNeeded<double>::Trace(visitor, member_remote_timestamp_);
    TraceIfNeeded<uint64_t>::Trace(visitor, member_reports_sent_);
...
void RTCRemoteOutboundRtpStreamStats::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_local_id_, member_local_id_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLDouble, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate),
            has_remote_timestamp_, member_remote_timestamp_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongLong, is_optional>(isolate, current_context, v8_dictionary,
            v8_own_member_names[2].Get(isolate), has_reports_sent_, member_reports_sent_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongLong, is_optional>(isolate, current_context, v8_dictionary,
            v8_own_member_names[4].Get(isolate), has_round_trip_time_measurements_, member_round_trip_time_measurements_, class_like_name, exception_state)) {
        return;
    }
