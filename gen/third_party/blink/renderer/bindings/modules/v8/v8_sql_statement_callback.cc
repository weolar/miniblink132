...
const char* V8SQLStatementCallback::NameInHeapSnapshot() const
{
    return "V8SQLStatementCallback";
}

v8::Maybe<void> V8SQLStatementCallback::handleEvent(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction, SQLResultSet* arg2_result_set)
{
    const char* const class_like_name = "SQLStatementCallback";
...
void V8SQLStatementCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, SQLTransaction* arg1_transaction, SQLResultSet* arg2_result_set)
{
    v8::Isolate* isolate = GetIsolate();
    ...
    std::ignore = handleEvent(arg0_receiver, arg1_transaction, arg2_result_set);
}
