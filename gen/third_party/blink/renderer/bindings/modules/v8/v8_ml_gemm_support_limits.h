...
public:
    ...
    MLSupportLimits* a() const
    {
        DCHECK(hasA());
        return member_a_.Get();
    }
    MLSupportLimits* getAOr(MLSupportLimits* fallback_value) const
    {
        if (!hasA()) {
    ...
    void setA(MLSupportLimits* value)
    {
        member_a_ = value;
        has_a_ = true;
        DCHECK(member_a_);
    ...
    MLSupportLimits* b() const
    {
        DCHECK(hasB());
        return member_b_.Get();
    }
    MLSupportLimits* getBOr(MLSupportLimits* fallback_value) const
    {
        if (!hasB()) {
            return fallback_value;
        }
    ...
    void setB(MLSupportLimits* value)
    {
        member_b_ = value;
        has_b_ = true;
        DCHECK(member_b_);
    ...
    MLSupportLimits* c() const
    {
        DCHECK(hasC());
        return member_c_.Get();
    }
    MLSupportLimits* getCOr(MLSupportLimits* fallback_value) const
    {
        if (!hasC()) {
            return fallback_value;
        }
    ...
    void setC(MLSupportLimits* value)
    {
        member_c_ = value;
        has_c_ = true;
        DCHECK(member_c_);
...
private:
    ...
    Member<MLSupportLimits> member_a_;
    Member<MLSupportLimits> member_b_;
    Member<MLSupportLimits> member_c_;
