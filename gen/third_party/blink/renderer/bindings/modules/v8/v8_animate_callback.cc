...
const char* V8AnimateCallback::NameInHeapSnapshot() const
{
    return "V8AnimateCallback";
}

v8::Maybe<void> V8AnimateCallback::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_current_time, const V8UnionWorkletAnimationEffectOrWorkletGroupEffect* arg2_effect)
{
...
void V8AnimateCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_current_time, const V8UnionWorkletAnimationEffectOrWorkletGroupEffect* arg2_effect)
{
    v8::Isolate* isolate = GetIsolate();
