...
public:
    ...
    enum class ContentType { kGPUExtent3DDict, kUnsignedLongEnforceRangeSequence };

    static V8UnionGPUExtent3DDictOrUnsignedLongEnforceRangeSequence* Create(
        v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

    explicit V8UnionGPUExtent3DDictOrUnsignedLongEnforceRangeSequence(GPUExtent3DDict* value)
