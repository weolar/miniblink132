...
bool V8SQLResultSetRowList::IsExposed(ExecutionContext* execution_context)
{
    return false;
}
...
const WrapperTypeInfo V8SQLResultSetRowList::wrapper_type_info_ {
    gin::kEmbedderBlink,
    V8SQLResultSetRowList::InstallInterfaceTemplate,
    V8SQLResultSetRowList::InstallContextDependentProperties,
    "SQLResultSetRowList",
    nullptr,
    V8SQLResultSetRowList::kThisTag,
    V8SQLResultSetRowList::kMaxSubclassTag,
...
const WrapperTypeInfo& SQLResultSetRowList::wrapper_type_info_ = V8SQLResultSetRowList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SQLResultSetRowList>::value,
    "SQLResultSetRowList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8SQLResultSetRowList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto&& return_value = blink_receiver->item(script_state, index, exception_state);
...
v8::Intercepted V8SQLResultSetRowList::IndexedPropertySetterCallback(
    uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<void>& info)
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SQLResultSetRowList_IndexedPropertySetter");
...
v8::Intercepted V8SQLResultSetRowList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info)
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SQLResultSetRowList_IndexedPropertyDeleter");
...
v8::Intercepted V8SQLResultSetRowList::IndexedPropertyDefinerCallback(
    uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<void>& info)
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SQLResultSetRowList_IndexedPropertyDefiner");
...
v8::Intercepted V8SQLResultSetRowList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SQLResultSetRowList_IndexedPropertyDescriptor");
    ...
    auto intercepted = V8SQLResultSetRowList::IndexedPropertyGetterCallback(index, info);
...
namespace v8_sql_result_set_row_list {
...
void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("SQLResultSetRowList.length.get");
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("SQLResultSetRowList.item");
    ...
    auto&& return_value = blink_receiver->item(script_state, arg1_index, exception_state);
    static_assert(bindings::IsReturnTypeCompatible<IDLAny, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    if (exception_state.HadException()) [[unlikely]] {
        return;
...
using namespace v8_sql_result_set_row_list;

} // namespace

void V8SQLResultSetRowList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8SQLResultSetRowList::GetWrapperTypeInfo();
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8SQLResultSetRowList::IndexedPropertyGetterCallback, V8SQLResultSetRowList::IndexedPropertySetterCallback,
            nullptr, // query
            V8SQLResultSetRowList::IndexedPropertyDeleterCallback, V8SQLResultSetRowList::IndexedPropertyEnumeratorCallback,
            V8SQLResultSetRowList::IndexedPropertyDefinerCallback, V8SQLResultSetRowList::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(),
...
void V8SQLResultSetRowList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "SQLResultSetRowList", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", "SQLResultSetRowList", ItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
...
void V8SQLResultSetRowList::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
