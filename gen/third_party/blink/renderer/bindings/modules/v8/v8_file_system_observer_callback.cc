...
const char* V8FileSystemObserverCallback::NameInHeapSnapshot() const
{
    return "V8FileSystemObserverCallback";
}

v8::Maybe<void> V8FileSystemObserverCallback::Invoke(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<FileSystemChangeRecord>>& arg1_records, FileSystemObserver* arg2_observer)
{
...
void V8FileSystemObserverCallback::InvokeAndReportException(
    bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<FileSystemChangeRecord>>& arg1_records, FileSystemObserver* arg2_observer)
{
    v8::Isolate* isolate = GetIsolate();
