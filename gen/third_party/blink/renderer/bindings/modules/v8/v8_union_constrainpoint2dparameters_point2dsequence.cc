...
V8UnionConstrainPoint2DParametersOrPoint2DSequence* V8UnionConstrainPoint2DParametersOrPoint2DSequence::Create(
...
V8UnionConstrainPoint2DParametersOrPoint2DSequence::V8UnionConstrainPoint2DParametersOrPoint2DSequence(const HeapVector<Member<Point2D>>& value)
    : content_type_(ContentType::kPoint2DSequence)
    , member_point_2d_sequence_(value)
{
}

V8UnionConstrainPoint2DParametersOrPoint2DSequence::V8UnionConstrainPoint2DParametersOrPoint2DSequence(HeapVector<Member<Point2D>>&& value)
    : content_type_(ContentType::kPoint2DSequence)
