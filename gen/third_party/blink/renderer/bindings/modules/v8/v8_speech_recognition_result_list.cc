...
const WrapperTypeInfo& SpeechRecognitionResultList::wrapper_type_info_ = V8SpeechRecognitionResultList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SpeechRecognitionResultList>::value,
...
v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<SpeechRecognitionResult, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
    return v8::Intercepted::kYes;
}

v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertySetterCallback(
...
v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8SpeechRecognitionResultList::IndexedPropertyGetterCallback(index, info);
...
void V8SpeechRecognitionResultList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8SpeechRecognitionResultList::IndexedPropertyGetterCallback,
        V8SpeechRecognitionResultList::IndexedPropertySetterCallback,
        nullptr, // query
        V8SpeechRecognitionResultList::IndexedPropertyDeleterCallback, V8SpeechRecognitionResultList::IndexedPropertyEnumeratorCallback,
        V8SpeechRecognitionResultList::IndexedPropertyDefinerCallback, V8SpeechRecognitionResultList::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(),
...
void V8SpeechRecognitionResultList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "SpeechRecognitionResultList", LengthAttributeGetCallback, nullptr, unsigned(v8::None),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", "SpeechRecognitionResultList", ItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...
void V8SpeechRecognitionResultList::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
