...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<TextDetector, std::remove_cvref_t<decltype(return_value)>>,
...
void DetectOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<IDLSequence<DetectedText>> return_value = blink_receiver->detect(script_state, arg1_image, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "detect", "TextDetector", DetectOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
