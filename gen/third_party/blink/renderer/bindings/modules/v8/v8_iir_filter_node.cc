...
const WrapperTypeInfo& IIRFilterNode::wrapper_type_info_ = V8IIRFilterNode::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, IIRFilterNode>::value,
...
void V8IIRFilterNode::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "getFrequencyResponse", "IIRFilterNode", GetFrequencyResponseOperationCallback, 3, unsigned(v8::None),
