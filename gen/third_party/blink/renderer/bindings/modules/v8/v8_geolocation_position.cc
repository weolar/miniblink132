...
const WrapperTypeInfo& Geoposition::wrapper_type_info_ = V8GeolocationPosition::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, Geoposition>::value,
...
void CoordsAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<GeolocationCoordinates, std::remove_cvref_t<decltype(return_value)>>,
...
void V8GeolocationPosition::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "coords", "GeolocationPosition", CoordsAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "timestamp", "GeolocationPosition", TimestampAttributeGetCallback, nullptr, unsigned(v8::None),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "toJSON", "GeolocationPosition", ToJSONOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
