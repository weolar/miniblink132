...
RTCRtpDecodingParameters::RTCRtpDecodingParameters(v8::Isolate* isolate)
...
void RTCRtpDecodingParameters::FillTemplateProperties(WTF::Vector<std::string_view>& properties) const
{
