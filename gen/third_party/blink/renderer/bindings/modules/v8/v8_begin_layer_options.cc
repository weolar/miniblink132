...
BeginLayerOptions::BeginLayerOptions()
    : member_filter_(nullptr)
{
}

BeginLayerOptions::BeginLayerOptions(v8::Isolate* isolate)
    : member_filter_(nullptr)
{
}
...
void BeginLayerOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<V8UnionObjectOrObjectArrayOrString>, is_optional>(isolate, current_context, v8_dictionary,
            v8_own_member_names[0].Get(isolate), fallback_presence_var, member_filter_, class_like_name, exception_state)) {
        return;
    }
}
