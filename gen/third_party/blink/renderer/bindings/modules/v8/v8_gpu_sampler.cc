...
const WrapperTypeInfo& GPUSampler::wrapper_type_info_ = V8GPUSampler::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, GPUSampler>::value,
...
void V8GPUSampler::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "label", "GPUSampler", LabelAttributeGetCallback, LabelAttributeSetCallback, unsigned(v8::None),
