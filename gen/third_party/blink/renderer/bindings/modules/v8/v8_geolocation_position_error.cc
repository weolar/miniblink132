...
const WrapperTypeInfo& GeolocationPositionError::wrapper_type_info_ = V8GeolocationPositionError::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, GeolocationPositionError>::value,
...
void V8GeolocationPositionError::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "code", "GeolocationPositionError", CodeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "message", "GeolocationPositionError", MessageAttributeGetCallback, nullptr, unsigned(v8::None),
