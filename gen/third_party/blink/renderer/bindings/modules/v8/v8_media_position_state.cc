...
void MediaPositionState::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLUnrestrictedDouble, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_duration_, member_duration_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLDouble, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate),
            has_playback_rate_, member_playback_rate_, class_like_name, exception_state)) {
        return;
    }
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLDouble, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_position_, member_position_, class_like_name, exception_state)) {
        return;
    }
}
