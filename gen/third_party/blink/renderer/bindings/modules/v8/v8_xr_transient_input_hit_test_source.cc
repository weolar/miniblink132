...
const WrapperTypeInfo& XRTransientInputHitTestSource::wrapper_type_info_ = V8XRTransientInputHitTestSource::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, XRTransientInputHitTestSource>::value,
...
void V8XRTransientInputHitTestSource::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "cancel", "XRTransientInputHitTestSource", CancelOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
