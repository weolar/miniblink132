...
const WrapperTypeInfo& SpeechRecognitionResult::wrapper_type_info_ = V8SpeechRecognitionResult::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SpeechRecognitionResult>::value,
...
v8::Intercepted V8SpeechRecognitionResult::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<SpeechRecognitionAlternative, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
    return v8::Intercepted::kYes;
}

v8::Intercepted V8SpeechRecognitionResult::IndexedPropertySetterCallback(
...
v8::Intercepted V8SpeechRecognitionResult::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8SpeechRecognitionResult::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8SpeechRecognitionResult::IndexedPropertyGetterCallback(index, info);
...
void V8SpeechRecognitionResult::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8SpeechRecognitionResult::IndexedPropertyGetterCallback,
        V8SpeechRecognitionResult::IndexedPropertySetterCallback,
        nullptr, // query
        V8SpeechRecognitionResult::IndexedPropertyDeleterCallback, V8SpeechRecognitionResult::IndexedPropertyEnumeratorCallback,
        V8SpeechRecognitionResult::IndexedPropertyDefinerCallback, V8SpeechRecognitionResult::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(),
...
void V8SpeechRecognitionResult::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "SpeechRecognitionResult", LengthAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "isFinal", "SpeechRecognitionResult", IsFinalAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", "SpeechRecognitionResult", ItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...
void V8SpeechRecognitionResult::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
