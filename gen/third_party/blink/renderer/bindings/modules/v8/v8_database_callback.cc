...
const char* V8DatabaseCallback::NameInHeapSnapshot() const
{
    return "V8DatabaseCallback";
}

v8::Maybe<void> V8DatabaseCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Database* arg1_database)
{
    const char* const class_like_name = "DatabaseCallback";
...
v8::Maybe<void> V8DatabaseCallback::Construct(Database* arg1_database)
{
    const char* const class_like_name = "DatabaseCallback";
...
void V8DatabaseCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Database* arg1_database)
{
    v8::Isolate* isolate = GetIsolate();
    v8::TryCatch try_catch(isolate);
    try_catch.SetVerbose(true);

    std::ignore = Invoke(arg0_receiver, arg1_database);
}
