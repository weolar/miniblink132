...
{
    TraceIfNeeded<Vector<V8XRDepthDataFormat>>::Trace(visitor, member_data_format_preference_);
    TraceIfNeeded<Vector<V8XRDepthUsage>>::Trace(visitor, member_usage_preference_);
...
void XRDepthStateInit::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8XRDepthDataFormat>, is_required>(isolate, current_context, v8_dictionary,
            v8_own_member_names[0].Get(isolate), fallback_presence_var, member_data_format_preference_, class_like_name, exception_state)) {
        return;
    }
    dictionary_from_v8_context.SetCurrentPropertyName("usagePreference");
    if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8XRDepthUsage>, is_required>(isolate, current_context, v8_dictionary,
            v8_own_member_names[1].Get(isolate), fallback_presence_var, member_usage_preference_, class_like_name, exception_state)) {
        return;
    }
}
