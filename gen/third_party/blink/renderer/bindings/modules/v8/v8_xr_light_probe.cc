...
const WrapperTypeInfo& XRLightProbe::wrapper_type_info_ = V8XRLightProbe::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, XRLightProbe>::value,
...
void V8XRLightProbe::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "probeSpace", "XRLightProbe", ProbeSpaceAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "onreflectionchange", "XRLightProbe", OnreflectionchangeAttributeGetCallback, OnreflectionchangeAttributeSetCallback, unsigned(v8::None),
