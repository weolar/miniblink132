...
const WrapperTypeInfo& GPUShaderModule::wrapper_type_info_ = V8GPUShaderModule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, GPUShaderModule>::value,
...
void GetCompilationInfoOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<GPUCompilationInfo> return_value = blink_receiver->getCompilationInfo(script_state);
...
void V8GPUShaderModule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "label", "GPUShaderModule", LabelAttributeGetCallback, LabelAttributeSetCallback, unsigned(v8::None),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "getCompilationInfo", "GPUShaderModule", GetCompilationInfoOperationCallback, 0, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
