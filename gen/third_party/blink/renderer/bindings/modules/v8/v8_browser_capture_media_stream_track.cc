...
const WrapperTypeInfo& BrowserCaptureMediaStreamTrack::wrapper_type_info_ = V8BrowserCaptureMediaStreamTrack::wrapper_type_info_;

// [ActiveScriptWrappable]
static_assert(std::is_base_of<ActiveScriptWrappableBase, BrowserCaptureMediaStreamTrack>::value,
...
void CropToOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<IDLUndefined> return_value = blink_receiver->cropTo(script_state, arg1_crop_id, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void RestrictToOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<IDLUndefined> return_value = blink_receiver->restrictTo(script_state, arg1_target, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
void V8BrowserCaptureMediaStreamTrack::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    if (RuntimeEnabledFeatures::RegionCaptureEnabled()) {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "cropTo", "BrowserCaptureMediaStreamTrack", CropToOperationCallback, 1, unsigned(v8::None),
    ...
    if (RuntimeEnabledFeatures::ElementCaptureEnabled()) {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "restrictTo", "BrowserCaptureMediaStreamTrack", RestrictToOperationCallback, 1, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(v8::SideEffectType::kHasSideEffect) },
        };
