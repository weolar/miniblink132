...
bool V8TimestampTrigger::IsExposed(ExecutionContext* execution_context)
{
    ...
    return (execution_context->IsWindow() || execution_context->IsWorkerGlobalScope())
        && RuntimeEnabledFeatures::NotificationTriggersEnabled(execution_context);
}
...
const WrapperTypeInfo& TimestampTrigger::wrapper_type_info_ = V8TimestampTrigger::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, TimestampTrigger>::value,
...
void V8TimestampTrigger::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "timestamp", "TimestampTrigger", TimestampAttributeGetCallback, nullptr, unsigned(v8::None),
