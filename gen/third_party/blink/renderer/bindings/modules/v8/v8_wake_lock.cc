...
const WrapperTypeInfo& WakeLock::wrapper_type_info_ = V8WakeLock::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, WakeLock>::value,
...
void RequestOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<V8WakeLockType>::NativeValue(
        std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg1_type { V8WakeLockType::Enum::kScreen };
    ...
    ScriptPromise<WakeLockSentinel> return_value = blink_receiver->request(script_state, arg1_type, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void V8WakeLock::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "request", "WakeLock", RequestOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
