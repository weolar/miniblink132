...
const WrapperTypeInfo& PresentationReceiver::wrapper_type_info_ = V8PresentationReceiver::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, PresentationReceiver>::value,
...
void ConnectionListAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise<PresentationConnectionList> return_value = blink_receiver->connectionList(script_state);
...
void V8PresentationReceiver::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "connectionList", "PresentationReceiver", ConnectionListAttributeGetCallback, nullptr, unsigned(v8::None),
