...
const WrapperTypeInfo& HTMLTitleElement::wrapper_type_info_ = V8HTMLTitleElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLTitleElement>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTitleElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLTitleElement);
}
...
void V8HTMLTitleElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "text", "HTMLTitleElement", TextAttributeGetCallback, TextAttributeSetCallback, unsigned(v8::None),
