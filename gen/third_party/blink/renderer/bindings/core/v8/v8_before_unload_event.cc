...
const WrapperTypeInfo& BeforeUnloadEvent::wrapper_type_info_ = V8BeforeUnloadEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, BeforeUnloadEvent>::value,
...
void V8BeforeUnloadEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "returnValue", "BeforeUnloadEvent", ReturnValueAttributeGetCallback, ReturnValueAttributeSetCallback, unsigned(v8::None),
            ...
            { "isTrusted", "BeforeUnloadEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
