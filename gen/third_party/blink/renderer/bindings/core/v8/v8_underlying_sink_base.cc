...
bool V8UnderlyingSinkBase::IsExposed(ExecutionContext* execution_context)
{
    return false;
}
...
const WrapperTypeInfo V8UnderlyingSinkBase::wrapper_type_info_ {
    gin::kEmbedderBlink,
    V8UnderlyingSinkBase::InstallInterfaceTemplate,
    V8UnderlyingSinkBase::InstallContextDependentProperties,
    "UnderlyingSinkBase",
    nullptr,
    V8UnderlyingSinkBase::kThisTag,
    V8UnderlyingSinkBase::kMaxSubclassTag,
...
const WrapperTypeInfo& UnderlyingSinkBase::wrapper_type_info_ = V8UnderlyingSinkBase::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, UnderlyingSinkBase>::value,
    "UnderlyingSinkBase inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace {

namespace v8_underlying_sink_base {

void TypeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{

    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_UnderlyingSinkBase_type_Getter");
    BLINK_BINDINGS_TRACE_EVENT("UnderlyingSinkBase.type.get");
...
void AbortOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("UnderlyingSinkBase.abort");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);

    v8::Isolate* isolate = info.GetIsolate();
    v8::Local<v8::Object> v8_receiver = info.This();
    if (!V8UnderlyingSinkBase::HasInstance(isolate, v8_receiver)) {
    ...
    const char* const class_like_name = "UnderlyingSinkBase";
    ...
    ScriptPromise<IDLUndefined> return_value = blink_receiver->abort(script_state, arg1_reason, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
void CloseOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("UnderlyingSinkBase.close");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);
...
void StartOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("UnderlyingSinkBase.start");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);
    ...
    ScriptPromise<IDLUndefined> return_value = blink_receiver->start(script_state, arg1_controller, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
void WriteOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("UnderlyingSinkBase.write");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);
    ...
    auto&& arg2_controller = NativeValueTraits<IDLAny>::ArgumentValue(isolate, 1, info[1], exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    ScriptPromise<IDLUndefined> return_value = blink_receiver->write(script_state, arg1_chunk, arg2_controller, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
using namespace v8_underlying_sink_base;

} // namespace

void V8UnderlyingSinkBase::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8UnderlyingSinkBase::GetWrapperTypeInfo();
...
void V8UnderlyingSinkBase::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "type", "UnderlyingSinkBase", TypeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "abort", "UnderlyingSinkBase", AbortOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "close", "UnderlyingSinkBase", CloseOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "start", "UnderlyingSinkBase", StartOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
            { "write", "UnderlyingSinkBase", WriteOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
...
void V8UnderlyingSinkBase::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
