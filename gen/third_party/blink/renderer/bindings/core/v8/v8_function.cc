...
const char* V8Function::NameInHeapSnapshot() const
{
    return "V8Function";
}
...
v8::Maybe<ScriptValue> V8Function::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_arguments)
{
    ...
    bindings::CallbackInvokeHelper<CallbackFunctionWithTaskAttributionBase, bindings::CallbackInvokeHelperMode::kDefault,
...
v8::Maybe<ScriptValue> V8Function::Construct(const HeapVector<ScriptValue>& arg1_arguments)
{
    ...
    bindings::CallbackInvokeHelper<CallbackFunctionWithTaskAttributionBase, bindings::CallbackInvokeHelperMode::kConstructorCall,
        bindings::CallbackReturnTypeIsPromise::kNo>
        helper(this, class_like_name, property_name);
