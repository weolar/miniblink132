...
const WrapperTypeInfo& ResourceProgressEvent::wrapper_type_info_ = V8ResourceProgressEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, ResourceProgressEvent>::value,
...
void V8ResourceProgressEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "url", "ResourceProgressEvent", UrlAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "isTrusted", "ResourceProgressEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
...
void V8ResourceProgressEvent::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
