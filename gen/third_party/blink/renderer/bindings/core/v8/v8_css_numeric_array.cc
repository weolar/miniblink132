...
const WrapperTypeInfo& CSSNumericArray::wrapper_type_info_ = V8CSSNumericArray::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSNumericArray>::value,
...
v8::Intercepted V8CSSNumericArray::IndexedPropertySetterCallback(
...
v8::Intercepted V8CSSNumericArray::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8CSSNumericArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8CSSNumericArray::IndexedPropertyGetterCallback(index, info);
...
void V8CSSNumericArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8CSSNumericArray::IndexedPropertyGetterCallback, V8CSSNumericArray::IndexedPropertySetterCallback,
            nullptr, // query
            V8CSSNumericArray::IndexedPropertyDeleterCallback, V8CSSNumericArray::IndexedPropertyEnumeratorCallback,
            V8CSSNumericArray::IndexedPropertyDefinerCallback, V8CSSNumericArray::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(),
...
void V8CSSNumericArray::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "CSSNumericArray", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
