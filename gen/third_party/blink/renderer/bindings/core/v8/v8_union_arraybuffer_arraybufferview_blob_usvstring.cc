...
V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString* V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::Create(
...
V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString(const String& value)
    : content_type_(ContentType::kUSVString)
    , member_usv_string_(value)
{
}

V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString(String&& value)
    : content_type_(ContentType::kUSVString)
...
V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::GetAsV8UnionArrayBufferOrArrayBufferViewOrUSVString() const
{
    switch (content_type_) {
    case ContentType::kArrayBuffer: {
