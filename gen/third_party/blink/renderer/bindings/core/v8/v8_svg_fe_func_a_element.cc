...
const WrapperTypeInfo& SVGFEFuncAElement::wrapper_type_info_ = V8SVGFEFuncAElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SVGFEFuncAElement>::value,
