...
const WrapperTypeInfo& ProcessingInstruction::wrapper_type_info_ = V8ProcessingInstruction::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, ProcessingInstruction>::value,
...
void V8ProcessingInstruction::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "target", "ProcessingInstruction", TargetAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "sheet", "ProcessingInstruction", SheetAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
