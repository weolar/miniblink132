...
{
    TraceIfNeeded<Member<MojoHandle>>::Trace(visitor, member_consumer_);
    TraceIfNeeded<Member<MojoHandle>>::Trace(visitor, member_producer_);
    TraceIfNeeded<uint32_t>::Trace(visitor, member_result_);
    bindings::DictionaryBase::Trace(visitor);
}

void MojoCreateDataPipeResult::FillTemplateProperties(WTF::Vector<std::string_view>& properties) const
{
...
void MojoCreateDataPipeResult::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<MojoHandle, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_consumer_, member_consumer_, class_like_name, exception_state)) {
        return;
    }
    dictionary_from_v8_context.SetCurrentPropertyName("producer");
    if (!bindings::GetDictionaryMemberFromV8Object<MojoHandle, is_optional>(
            isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_producer_, member_producer_, class_like_name, exception_state)) {
        return;
    }
