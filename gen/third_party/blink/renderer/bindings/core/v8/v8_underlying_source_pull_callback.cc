...
v8::Maybe<ScriptPromise<IDLUndefined>> V8UnderlyingSourcePullCallback::Invoke(
...
v8::Maybe<ScriptPromise<IDLUndefined>> V8UnderlyingSourcePullCallback::Construct(
    const V8UnionReadableByteStreamControllerOrReadableStreamDefaultController* arg1_controller)
{
    const char* const class_like_name = "UnderlyingSourcePullCallback";
