...
public:
    ...
    enum class ContentType { kObservableInspector, kObserverCallback };
    ...
    explicit V8UnionObservableInspectorOrObserverCallback(ObservableInspector* value)
        : content_type_(ContentType::kObservableInspector)
        , member_observable_inspector_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionObservableInspectorOrObserverCallback(V8ObserverCallback* value)
