...
NavigationNavigateOptions::NavigationNavigateOptions(v8::Isolate* isolate)
...
void NavigationNavigateOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state)
{
    ...
    if (!bindings::GetDictionaryMemberFromV8Object<V8NavigationHistoryBehavior, is_optional>(isolate, current_context, v8_dictionary,
            v8_own_member_names[0].Get(isolate), fallback_presence_var, member_history_, class_like_name, exception_state)) {
        return;
    }
