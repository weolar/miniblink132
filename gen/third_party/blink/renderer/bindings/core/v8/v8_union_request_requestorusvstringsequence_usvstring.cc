...
V8UnionRequestOrRequestOrUSVStringSequenceOrUSVString::V8UnionRequestOrRequestOrUSVStringSequenceOrUSVString(
    const HeapVector<Member<V8UnionRequestOrUSVString>>& value)
...
V8UnionRequestOrRequestOrUSVStringSequenceOrUSVString::V8UnionRequestOrRequestOrUSVStringSequenceOrUSVString(
    HeapVector<Member<V8UnionRequestOrUSVString>>&& value)
    : content_type_(ContentType::kRequestOrUSVStringSequence)
