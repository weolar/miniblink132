...
class CORE_EXPORT V8SVGAnimatedPreserveAspectRatio final
    : public bindings::V8InterfaceBridge<V8SVGAnimatedPreserveAspectRatio, SVGAnimatedPreserveAspectRatio> {
...
public:
    ...
    static constexpr v8::CppHeapPointerTag kThisTag = static_cast<v8::CppHeapPointerTag>(928);
    static constexpr v8::CppHeapPointerTag kMaxSubclassTag = static_cast<v8::CppHeapPointerTag>(928);
