...
const WrapperTypeInfo& DocumentTimeline::wrapper_type_info_ = V8DocumentTimeline::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, DocumentTimeline>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<DocumentTimelineOptions>::NativeValue(
