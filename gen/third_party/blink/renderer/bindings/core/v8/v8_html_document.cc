...
const WrapperTypeInfo& HTMLDocument::wrapper_type_info_ = V8HTMLDocument::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLDocument>::value,
...
void V8HTMLDocument::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "location", "HTMLDocument", LocationAttributeGetCallback, LocationAttributeSetCallback, unsigned(v8::DontDelete),
