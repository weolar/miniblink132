...
class V8DeathAwareScriptWrappable final : public bindings::V8InterfaceBridge<V8DeathAwareScriptWrappable, DeathAwareScriptWrappable> {
...
public:
    ...
    static constexpr v8::CppHeapPointerTag kThisTag = static_cast<v8::CppHeapPointerTag>(1000);
    static constexpr v8::CppHeapPointerTag kMaxSubclassTag = static_cast<v8::CppHeapPointerTag>(1000);
...
private:
    ...
    friend class DeathAwareScriptWrappable;
};
