...
const WrapperTypeInfo& SVGSymbolElement::wrapper_type_info_ = V8SVGSymbolElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SVGSymbolElement>::value,
...
void V8SVGSymbolElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "viewBox", "SVGSymbolElement", ViewBoxAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "preserveAspectRatio", "SVGSymbolElement", PreserveAspectRatioAttributeGetCallback, nullptr, unsigned(v8::None),
