...
const WrapperTypeInfo& FetchLaterResult::wrapper_type_info_ = V8FetchLaterResult::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, FetchLaterResult>::value,
...
void V8FetchLaterResult::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "activated", "FetchLaterResult", ActivatedAttributeGetCallback, nullptr, unsigned(v8::None),
