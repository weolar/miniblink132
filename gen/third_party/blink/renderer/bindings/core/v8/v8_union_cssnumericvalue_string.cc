...
V8UnionCSSNumericValueOrString::V8UnionCSSNumericValueOrString(const String& value)
    : content_type_(ContentType::kString)
    , member_string_(value)
{
}

V8UnionCSSNumericValueOrString::V8UnionCSSNumericValueOrString(String&& value)
    : content_type_(ContentType::kString)
