...
const WrapperTypeInfo& HTMLHeadingElement::wrapper_type_info_ = V8HTMLHeadingElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLHeadingElement>::value,
...
void AlignAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "HTMLHeadingElement";
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLHeadingElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLHeadingElement);
}
...
void V8HTMLHeadingElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "align", "HTMLHeadingElement", AlignAttributeGetCallback, AlignAttributeSetCallback, unsigned(v8::None),
