...
const WrapperTypeInfo& HitTestLayerRectList::wrapper_type_info_ = V8HitTestLayerRectList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HitTestLayerRectList>::value,
...
v8::Intercepted V8HitTestLayerRectList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<HitTestLayerRect, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
    return v8::Intercepted::kYes;
}

v8::Intercepted V8HitTestLayerRectList::IndexedPropertySetterCallback(
...
v8::Intercepted V8HitTestLayerRectList::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8HitTestLayerRectList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8HitTestLayerRectList::IndexedPropertyGetterCallback(index, info);
...
void V8HitTestLayerRectList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8HitTestLayerRectList::IndexedPropertyGetterCallback, V8HitTestLayerRectList::IndexedPropertySetterCallback,
            nullptr, // query
            V8HitTestLayerRectList::IndexedPropertyDeleterCallback, V8HitTestLayerRectList::IndexedPropertyEnumeratorCallback,
            V8HitTestLayerRectList::IndexedPropertyDefinerCallback, V8HitTestLayerRectList::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(),
...
void V8HitTestLayerRectList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "HitTestLayerRectList", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", "HitTestLayerRectList", ItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
