...
const WrapperTypeInfo& SVGAnimatedTransformList::wrapper_type_info_ = V8SVGAnimatedTransformList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SVGAnimatedTransformList>::value,
...
void BaseValAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<SVGTransformListTearOff, std::remove_cvref_t<decltype(return_value)>>,
...
void V8SVGAnimatedTransformList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "baseVal", "SVGAnimatedTransformList", BaseValAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "animVal", "SVGAnimatedTransformList", AnimValAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
