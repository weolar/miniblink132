...
const WrapperTypeInfo& HTMLHtmlElement::wrapper_type_info_ = V8HTMLHtmlElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLHtmlElement>::value,
...
void V8HTMLHtmlElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "version", "HTMLHtmlElement", VersionAttributeGetCallback, VersionAttributeSetCallback, unsigned(v8::None),
