...
const WrapperTypeInfo V8CountQueuingStrategy::wrapper_type_info_ {
    ...
    nullptr,
    V8CountQueuingStrategy::kThisTag,
    V8CountQueuingStrategy::kMaxSubclassTag,
...
void HighWaterMarkAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    CountQueuingStrategy* blink_receiver = V8CountQueuingStrategy::ToWrappableUnsafe(isolate, v8_receiver);
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<CountQueuingStrategy, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8CountQueuingStrategy::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    interface_function_template->SetInterfaceName(V8String(isolate, "CountQueuingStrategy"));
    ...
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "highWaterMark", "CountQueuingStrategy", HighWaterMarkAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "size", "CountQueuingStrategy", SizeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
