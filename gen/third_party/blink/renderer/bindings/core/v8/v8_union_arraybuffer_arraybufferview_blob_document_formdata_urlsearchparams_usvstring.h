...
public:
    ...
    enum class ContentType { kArrayBuffer, kArrayBufferView, kBlob, kDocument, kFormData, kURLSearchParams, kUSVString };

    static V8UnionArrayBufferOrArrayBufferViewOrBlobOrDocumentOrFormDataOrURLSearchParamsOrUSVString* Create(
        v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrDocumentOrFormDataOrURLSearchParamsOrUSVString(DOMArrayBuffer* value)
        : content_type_(ContentType::kArrayBuffer)
        , member_array_buffer_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrDocumentOrFormDataOrURLSearchParamsOrUSVString(NotShared<DOMArrayBufferView> value)
        : content_type_(ContentType::kArrayBufferView)
        , member_array_buffer_view_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrDocumentOrFormDataOrURLSearchParamsOrUSVString(Blob* value)
        : content_type_(ContentType::kBlob)
        , member_blob_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrDocumentOrFormDataOrURLSearchParamsOrUSVString(Document* value)
        : content_type_(ContentType::kDocument)
        , member_document_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrDocumentOrFormDataOrURLSearchParamsOrUSVString(FormData* value)
        : content_type_(ContentType::kFormData)
        , member_form_data_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrDocumentOrFormDataOrURLSearchParamsOrUSVString(URLSearchParams* value)
