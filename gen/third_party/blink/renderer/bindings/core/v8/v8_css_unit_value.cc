...
const WrapperTypeInfo& CSSUnitValue::wrapper_type_info_ = V8CSSUnitValue::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSUnitValue>::value,
...
void V8CSSUnitValue::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "value", "CSSUnitValue", ValueAttributeGetCallback, ValueAttributeSetCallback, unsigned(v8::None),
            ...
            { "unit", "CSSUnitValue", UnitAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
