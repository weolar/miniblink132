...
const WrapperTypeInfo& CSSNamespaceRule::wrapper_type_info_ = V8CSSNamespaceRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSNamespaceRule>::value,
...
void V8CSSNamespaceRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "namespaceURI", "CSSNamespaceRule", NamespaceURIAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "prefix", "CSSNamespaceRule", PrefixAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
