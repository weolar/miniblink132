...
bool V8LayoutChild::IsExposed(ExecutionContext* execution_context)
{
...
const WrapperTypeInfo V8LayoutChild::wrapper_type_info_ {
    gin::kEmbedderBlink,
    V8LayoutChild::InstallInterfaceTemplate,
    nullptr,
    "LayoutChild",
    nullptr,
    V8LayoutChild::kThisTag,
    V8LayoutChild::kMaxSubclassTag,
...
const WrapperTypeInfo& CustomLayoutChild::wrapper_type_info_ = V8LayoutChild::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CustomLayoutChild>::value,
    "CustomLayoutChild inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace {

namespace v8_layout_child {
...
void StyleMapAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("LayoutChild.styleMap.get");
...
void IntrinsicSizesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CustomLayoutChild_intrinsicSizes");
    BLINK_BINDINGS_TRACE_EVENT("LayoutChild.intrinsicSizes");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);

    v8::Isolate* isolate = info.GetIsolate();
    v8::Local<v8::Object> v8_receiver = info.This();
    if (!V8LayoutChild::HasInstance(isolate, v8_receiver)) {
    ...
    const char* const class_like_name = "LayoutChild";
    const char* const property_name = "intrinsicSizes";
    ExceptionState exception_state(isolate, exception_context_type, class_like_name, property_name);
    ScriptPromise<CustomIntrinsicSizes> return_value = blink_receiver->intrinsicSizes(script_state, exception_state);
...
void LayoutNextFragmentOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CustomLayoutChild_layoutNextFragment");
    BLINK_BINDINGS_TRACE_EVENT("LayoutChild.layoutNextFragment");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);
    ...
    ScriptState* receiver_script_state = ScriptState::ForRelevantRealm(isolate, v8_receiver);
    ScriptState* script_state = receiver_script_state;
    decltype(NativeValueTraits<CustomLayoutConstraintsOptions>::NativeValue(
        std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg1_options;
    const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
    const char* const class_like_name = "LayoutChild";
    const char* const property_name = "layoutNextFragment";
    ExceptionState exception_state(isolate, exception_context_type, class_like_name, property_name);
    if (info[0]->IsUndefined()) {
        arg1_options = CustomLayoutConstraintsOptions::Create();
    } else {
        arg1_options = NativeValueTraits<CustomLayoutConstraintsOptions>::ArgumentValue(isolate, 0, info[0], exception_state);
        if (exception_state.HadException()) [[unlikely]] {
            return;
        }
    }
    ScriptPromise<CustomLayoutFragment> return_value = blink_receiver->layoutNextFragment(script_state, arg1_options, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
using namespace v8_layout_child;

} // namespace

void V8LayoutChild::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8LayoutChild::GetWrapperTypeInfo();
...
void V8LayoutChild::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "styleMap", "LayoutChild", StyleMapAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "intrinsicSizes", "LayoutChild", IntrinsicSizesOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "layoutNextFragment", "LayoutChild", LayoutNextFragmentOperationCallback, 0, unsigned(v8::None),
