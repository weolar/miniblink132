...
const WrapperTypeInfo& HTMLMenuElement::wrapper_type_info_ = V8HTMLMenuElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLMenuElement>::value,
...
void CompactAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "HTMLMenuElement";
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLMenuElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLMenuElement);
}
...
void V8HTMLMenuElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "compact", "HTMLMenuElement", CompactAttributeGetCallback, CompactAttributeSetCallback, unsigned(v8::None),
