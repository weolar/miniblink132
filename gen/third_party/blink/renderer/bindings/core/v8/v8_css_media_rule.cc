...
const WrapperTypeInfo& CSSMediaRule::wrapper_type_info_ = V8CSSMediaRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSMediaRule>::value,
...
void V8CSSMediaRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "media", "CSSMediaRule", MediaAttributeGetCallback, MediaAttributeSetCallback, unsigned(v8::None),
