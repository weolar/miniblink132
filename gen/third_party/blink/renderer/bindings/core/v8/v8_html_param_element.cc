...
const WrapperTypeInfo& HTMLParamElement::wrapper_type_info_ = V8HTMLParamElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLParamElement>::value,
...
void NameAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "HTMLParamElement";
...
void ValueTypeAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "HTMLParamElement";
    const char* const property_name = "valueType";
    bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kValuetypeAttr, class_like_name, property_name);
}
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLParamElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLParamElement);
}
...
void V8HTMLParamElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "name", "HTMLParamElement", NameAttributeGetCallback, NameAttributeSetCallback, unsigned(v8::None),
            ...
            { "value", "HTMLParamElement", ValueAttributeGetCallback, ValueAttributeSetCallback, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "type", "HTMLParamElement", TypeAttributeGetCallback, TypeAttributeSetCallback, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "valueType", "HTMLParamElement", ValueTypeAttributeGetCallback, ValueTypeAttributeSetCallback, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
