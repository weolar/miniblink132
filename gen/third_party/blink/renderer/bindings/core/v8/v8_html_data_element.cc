...
const WrapperTypeInfo& HTMLDataElement::wrapper_type_info_ = V8HTMLDataElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLDataElement>::value,
...
void ValueAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "HTMLDataElement";
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLDataElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLDataElement);
}
...
void V8HTMLDataElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "value", "HTMLDataElement", ValueAttributeGetCallback, ValueAttributeSetCallback, unsigned(v8::None),
