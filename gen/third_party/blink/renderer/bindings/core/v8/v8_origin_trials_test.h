...
class V8OriginTrialsTest final : public bindings::V8InterfaceBridge<V8OriginTrialsTest, OriginTrialsTest> {
...
public:
    ...
    static constexpr v8::CppHeapPointerTag kThisTag = static_cast<v8::CppHeapPointerTag>(1008);
    static constexpr v8::CppHeapPointerTag kMaxSubclassTag = static_cast<v8::CppHeapPointerTag>(1008);
