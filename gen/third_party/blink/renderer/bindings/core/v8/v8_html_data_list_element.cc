...
const WrapperTypeInfo& HTMLDataListElement::wrapper_type_info_ = V8HTMLDataListElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLDataListElement>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLDataListElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLDataListElement);
}
...
void V8HTMLDataListElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "options", "HTMLDataListElement", OptionsAttributeGetCallback, nullptr, unsigned(v8::None),
