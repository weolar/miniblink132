...
const WrapperTypeInfo& TrackEvent::wrapper_type_info_ = V8TrackEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, TrackEvent>::value,
...
void TrackAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<IDLNullable<V8UnionAudioTrackOrTextTrackOrVideoTrack>, std::remove_cvref_t<decltype(return_value)>>,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<TrackEventInit>::NativeValue(
    ...
    static_assert(bindings::IsReturnTypeCompatible<TrackEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8TrackEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "track", "TrackEvent", TrackAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "isTrusted", "TrackEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
