...
bool V8ReadableStreamDefaultReader::IsExposed(ExecutionContext* execution_context)
{
...
const WrapperTypeInfo V8ReadableStreamDefaultReader::wrapper_type_info_ {
    gin::kEmbedderBlink,
    V8ReadableStreamDefaultReader::InstallInterfaceTemplate,
    V8ReadableStreamDefaultReader::InstallContextDependentProperties,
    "ReadableStreamDefaultReader",
    nullptr,
    V8ReadableStreamDefaultReader::kThisTag,
    V8ReadableStreamDefaultReader::kMaxSubclassTag,
...
const WrapperTypeInfo& ReadableStreamDefaultReader::wrapper_type_info_ = V8ReadableStreamDefaultReader::wrapper_type_info_;

// [ActiveScriptWrappable]
static_assert(std::is_base_of<ActiveScriptWrappableBase, ReadableStreamDefaultReader>::value,
    "ReadableStreamDefaultReader does not inherit from ActiveScriptWrappable<> despite "
    "the IDL has [ActiveScriptWrappable] extended attribute.");

namespace {

namespace v8_readable_stream_default_reader {
...
void ClosedAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!V8ReadableStreamDefaultReader::HasInstance(isolate, v8_receiver)) {
    ...
    BLINK_BINDINGS_TRACE_EVENT("ReadableStreamDefaultReader.closed.get");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("ReadableStreamDefaultReader.constructor");
    ...
    auto&& return_value = ReadableStreamDefaultReader::Create(script_state, arg1_stream, exception_state);
    static_assert(bindings::IsReturnTypeCompatible<ReadableStreamDefaultReader, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8ReadableStreamDefaultReader::GetWrapperTypeInfo(), v8_receiver);
...
void CancelOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("ReadableStreamDefaultReader.cancel");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);
...
void ReadOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("ReadableStreamDefaultReader.read");
    // Promise returning function: Convert a TypeError to a reject promise.
    ExceptionToRejectPromiseScope reject_promise_scope(info);
    ...
    ExceptionState exception_state(isolate, exception_context_type, class_like_name, property_name);
    ScriptPromise<ReadableStreamReadResult> return_value = blink_receiver->read(script_state, exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    bindings::V8SetReturnValue(info, return_value);
...
void ReleaseLockOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("ReadableStreamDefaultReader.releaseLock");
...
using namespace v8_readable_stream_default_reader;

} // namespace

void V8ReadableStreamDefaultReader::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8ReadableStreamDefaultReader::GetWrapperTypeInfo();
    ...
    interface_function_template->SetInterfaceName(V8String(isolate, "ReadableStreamDefaultReader"));
...
void V8ReadableStreamDefaultReader::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world,
    v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "read", "ReadableStreamDefaultReader", ReadOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "releaseLock", "ReadableStreamDefaultReader", ReleaseLockOperationCallback, 0, unsigned(v8::None),
...
void V8ReadableStreamDefaultReader::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
    ...
    v8::Local<v8::Template> interface_template, FeatureSelector feature_selector)
{
    ...
    if ((execution_context->IsWindow() || execution_context->IsWorkerGlobalScope() || execution_context->IsWorkletGlobalScope()) && feature_selector.IsAll()) {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "closed", "ReadableStreamDefaultReader", ClosedAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
    ...
    if ((execution_context->IsWindow() || execution_context->IsWorkerGlobalScope() || execution_context->IsWorkletGlobalScope()) && feature_selector.IsAll()) {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "cancel", "ReadableStreamDefaultReader", CancelOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect) },
        };
        v8::Local<v8::FunctionTemplate> interface_function_template = interface_template.As<v8::FunctionTemplate>();
