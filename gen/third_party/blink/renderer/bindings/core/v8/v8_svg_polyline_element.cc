...
const WrapperTypeInfo& SVGPolylineElement::wrapper_type_info_ = V8SVGPolylineElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SVGPolylineElement>::value,
...
void PointsAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<SVGPointListTearOff, std::remove_cvref_t<decltype(return_value)>>,
...
void V8SVGPolylineElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "points", "SVGPolylineElement", PointsAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "animatedPoints", "SVGPolylineElement", AnimatedPointsAttributeGetCallback, nullptr, unsigned(v8::None),
