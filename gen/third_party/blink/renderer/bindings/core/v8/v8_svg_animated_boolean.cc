...
const WrapperTypeInfo& SVGAnimatedBoolean::wrapper_type_info_ = V8SVGAnimatedBoolean::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SVGAnimatedBoolean>::value,
...
void V8SVGAnimatedBoolean::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "baseVal", "SVGAnimatedBoolean", BaseValAttributeGetCallback, BaseValAttributeSetCallback, unsigned(v8::None),
            ...
            { "animVal", "SVGAnimatedBoolean", AnimValAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
