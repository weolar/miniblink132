...
const WrapperTypeInfo& CSSTransition::wrapper_type_info_ = V8CSSTransition::wrapper_type_info_;

// [ActiveScriptWrappable]
static_assert(std::is_base_of<ActiveScriptWrappableBase, CSSTransition>::value,
...
void V8CSSTransition::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "transitionProperty", "CSSTransition", TransitionPropertyAttributeGetCallback, nullptr, unsigned(v8::None),
