...
const char* V8IntrinsicSizesCallback::NameInHeapSnapshot() const
{
    return "V8IntrinsicSizesCallback";
}

v8::Maybe<ScriptValue> V8IntrinsicSizesCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver,
