...
const WrapperTypeInfo& CSSAnimation::wrapper_type_info_ = V8CSSAnimation::wrapper_type_info_;

// [ActiveScriptWrappable]
static_assert(std::is_base_of<ActiveScriptWrappableBase, CSSAnimation>::value,
...
void V8CSSAnimation::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "animationName", "CSSAnimation", AnimationNameAttributeGetCallback, nullptr, unsigned(v8::None),
