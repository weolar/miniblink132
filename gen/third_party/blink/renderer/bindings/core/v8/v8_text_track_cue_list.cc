...
const WrapperTypeInfo& TextTrackCueList::wrapper_type_info_ = V8TextTrackCueList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, TextTrackCueList>::value,
...
v8::Intercepted V8TextTrackCueList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<TextTrackCue, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
    return v8::Intercepted::kYes;
}

v8::Intercepted V8TextTrackCueList::IndexedPropertySetterCallback(
...
v8::Intercepted V8TextTrackCueList::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8TextTrackCueList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8TextTrackCueList::IndexedPropertyGetterCallback(index, info);
...
void GetCueByIdOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<IDLNullable<TextTrackCue>, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
void V8TextTrackCueList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::IndexedPropertyHandlerConfiguration(V8TextTrackCueList::IndexedPropertyGetterCallback, V8TextTrackCueList::IndexedPropertySetterCallback,
            nullptr, // query
            V8TextTrackCueList::IndexedPropertyDeleterCallback, V8TextTrackCueList::IndexedPropertyEnumeratorCallback,
            V8TextTrackCueList::IndexedPropertyDefinerCallback, V8TextTrackCueList::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(),
...
void V8TextTrackCueList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "TextTrackCueList", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "getCueById", "TextTrackCueList", GetCueByIdOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
