...
const WrapperTypeInfo& HTMLTableCaptionElement::wrapper_type_info_ = V8HTMLTableCaptionElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLTableCaptionElement>::value,
...
void AlignAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "HTMLTableCaptionElement";
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTableCaptionElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLTableCaptionElement);
}
...
void V8HTMLTableCaptionElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "align", "HTMLTableCaptionElement", AlignAttributeGetCallback, AlignAttributeSetCallback, unsigned(v8::None),
