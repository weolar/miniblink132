...
const WrapperTypeInfo& MediaQueryListEvent::wrapper_type_info_ = V8MediaQueryListEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, MediaQueryListEvent>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<MediaQueryListEventInit>::NativeValue(
    ...
    static_assert(bindings::IsReturnTypeCompatible<MediaQueryListEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8MediaQueryListEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "media", "MediaQueryListEvent", MediaAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "matches", "MediaQueryListEvent", MatchesAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "isTrusted", "MediaQueryListEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
