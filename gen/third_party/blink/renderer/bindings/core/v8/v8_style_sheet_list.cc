...
const WrapperTypeInfo& StyleSheetList::wrapper_type_info_ = V8StyleSheetList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, StyleSheetList>::value,
...
v8::Intercepted V8StyleSheetList::NamedPropertySetterCallback(
...
v8::Intercepted V8StyleSheetList::NamedPropertyDefinerCallback(
...
v8::Intercepted V8StyleSheetList::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    //  of performing the steps listed in the description of operation with P as the
    //  only argument value."
    auto intercepted = V8StyleSheetList::NamedPropertyGetterCallback(v8_property_name, info);
    // "Return OrdinaryGetOwnProperty(O, P)."
...
v8::Intercepted V8StyleSheetList::IndexedPropertySetterCallback(
...
v8::Intercepted V8StyleSheetList::IndexedPropertyDefinerCallback(
...
v8::Intercepted V8StyleSheetList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    auto intercepted = V8StyleSheetList::IndexedPropertyGetterCallback(index, info);
    if (intercepted == v8::Intercepted::kNo) {
        // step 3. Return OrdinaryGetOwnProperty(O, P).
        // Do not intercept.  Fallback to OrdinaryGetOwnProperty.
        return v8::Intercepted::kNo;
...
void V8StyleSheetList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    ...
    instance_object_template->SetHandler(
        v8::NamedPropertyHandlerConfiguration(V8StyleSheetList::NamedPropertyGetterCallback, V8StyleSheetList::NamedPropertySetterCallback,
            nullptr, // query
            V8StyleSheetList::NamedPropertyDeleterCallback,
            nullptr, // enumerator
            V8StyleSheetList::NamedPropertyDefinerCallback, V8StyleSheetList::NamedPropertyDescriptorCallback, v8::Local<v8::Value>(),
    ...
    instance_object_template->SetHandler(v8::IndexedPropertyHandlerConfiguration(V8StyleSheetList::IndexedPropertyGetterCallback,
        V8StyleSheetList::IndexedPropertySetterCallback,
        nullptr, // query
        V8StyleSheetList::IndexedPropertyDeleterCallback, V8StyleSheetList::IndexedPropertyEnumeratorCallback, V8StyleSheetList::IndexedPropertyDefinerCallback,
        V8StyleSheetList::IndexedPropertyDescriptorCallback, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kHasNoSideEffect));
...
void V8StyleSheetList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "StyleSheetList", LengthAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "item", "StyleSheetList", ItemOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
