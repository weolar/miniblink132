...
bool V8LayoutShiftAttribution::IsExposed(ExecutionContext* execution_context)
{
...
const WrapperTypeInfo V8LayoutShiftAttribution::wrapper_type_info_ {
    gin::kEmbedderBlink,
    V8LayoutShiftAttribution::InstallInterfaceTemplate,
    nullptr,
    "LayoutShiftAttribution",
    nullptr,
    V8LayoutShiftAttribution::kThisTag,
    V8LayoutShiftAttribution::kMaxSubclassTag,
...
const WrapperTypeInfo& LayoutShiftAttribution::wrapper_type_info_ = V8LayoutShiftAttribution::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, LayoutShiftAttribution>::value,
    "LayoutShiftAttribution inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace {

namespace v8_layout_shift_attribution {
...
void NodeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("LayoutShiftAttribution.node.get");
...
void PreviousRectAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{

    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LayoutShiftAttribution_previousRect_Getter");
    BLINK_BINDINGS_TRACE_EVENT("LayoutShiftAttribution.previousRect.get");
...
void CurrentRectAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{

    RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LayoutShiftAttribution_currentRect_Getter");
    BLINK_BINDINGS_TRACE_EVENT("LayoutShiftAttribution.currentRect.get");
...
using namespace v8_layout_shift_attribution;

} // namespace

void V8LayoutShiftAttribution::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template)
{
    const WrapperTypeInfo* const wrapper_type_info = V8LayoutShiftAttribution::GetWrapperTypeInfo();
...
void V8LayoutShiftAttribution::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "node", "LayoutShiftAttribution", NodeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "previousRect", "LayoutShiftAttribution", PreviousRectAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "currentRect", "LayoutShiftAttribution", CurrentRectAttributeGetCallback, nullptr, unsigned(v8::None),
                unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds),
                unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect),
                unsigned(V8PrivateProperty::CachedAccessor::kNone) },
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "toJSON", "LayoutShiftAttribution", ToJSONOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
