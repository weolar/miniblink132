...
bool V8OverscrollEvent::IsExposed(ExecutionContext* execution_context)
{
    ...
    return execution_context->IsWindow() && RuntimeEnabledFeatures::OverscrollCustomizationEnabled();
}
...
const WrapperTypeInfo& OverscrollEvent::wrapper_type_info_ = V8OverscrollEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, OverscrollEvent>::value,
...
void DeltaXAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("OverscrollEvent.deltaX.get");
...
void DeltaYAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    BLINK_BINDINGS_TRACE_EVENT("OverscrollEvent.deltaY.get");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    auto&& arg2_bubbles = NativeValueTraits<IDLBoolean>::ArgumentValue(isolate, 1, info[1], exception_state);
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
    decltype(NativeValueTraits<OverscrollEventInit>::NativeValue(
        std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg3_event_init_dict;
    if (info[2]->IsUndefined()) {
        arg3_event_init_dict = OverscrollEventInit::Create();
    } else {
        arg3_event_init_dict = NativeValueTraits<OverscrollEventInit>::ArgumentValue(isolate, 2, info[2], exception_state);
        if (exception_state.HadException()) [[unlikely]] {
            return;
        }
    }
    auto&& return_value = OverscrollEvent::Create(arg1_type, arg2_bubbles, arg3_event_init_dict);
    static_assert(bindings::IsReturnTypeCompatible<OverscrollEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8OverscrollEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "deltaX", "OverscrollEvent", DeltaXAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "deltaY", "OverscrollEvent", DeltaYAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
                unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck),
                unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck),
                unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone) },
            { "isTrusted", "OverscrollEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
