...
public:
    ...
    enum class ContentType { kArrayBuffer, kArrayBufferView, kBlob, kFormData, kURLSearchParams, kUSVString };

    static V8UnionArrayBufferOrArrayBufferViewOrBlobOrFormDataOrURLSearchParamsOrUSVString* Create(
        v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrFormDataOrURLSearchParamsOrUSVString(DOMArrayBuffer* value)
        : content_type_(ContentType::kArrayBuffer)
        , member_array_buffer_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrFormDataOrURLSearchParamsOrUSVString(NotShared<DOMArrayBufferView> value)
        : content_type_(ContentType::kArrayBufferView)
        , member_array_buffer_view_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrFormDataOrURLSearchParamsOrUSVString(Blob* value)
        : content_type_(ContentType::kBlob)
        , member_blob_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrFormDataOrURLSearchParamsOrUSVString(FormData* value)
        : content_type_(ContentType::kFormData)
        , member_form_data_(value)
    {
        DCHECK(value);
    }
    explicit V8UnionArrayBufferOrArrayBufferViewOrBlobOrFormDataOrURLSearchParamsOrUSVString(URLSearchParams* value)
