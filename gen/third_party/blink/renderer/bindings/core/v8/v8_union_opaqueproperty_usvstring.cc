...
V8UnionOpaquePropertyOrUSVString::V8UnionOpaquePropertyOrUSVString(const String& value)
    : content_type_(ContentType::kUSVString)
    , member_usv_string_(value)
{
}

V8UnionOpaquePropertyOrUSVString::V8UnionOpaquePropertyOrUSVString(String&& value)
    : content_type_(ContentType::kUSVString)
