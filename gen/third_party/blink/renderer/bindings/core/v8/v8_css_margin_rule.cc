...
bool V8CSSMarginRule::IsExposed(ExecutionContext* execution_context)
{
    ...
    return execution_context->IsWindow() && RuntimeEnabledFeatures::PageMarginBoxesEnabled();
}
...
const WrapperTypeInfo& CSSMarginRule::wrapper_type_info_ = V8CSSMarginRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSMarginRule>::value,
...
void V8CSSMarginRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "name", "CSSMarginRule", NameAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "style", "CSSMarginRule", StyleAttributeGetCallback, StyleAttributeSetCallback, unsigned(v8::None),
