...
const WrapperTypeInfo& CSSPositionTryRule::wrapper_type_info_ = V8CSSPositionTryRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSPositionTryRule>::value,
...
void V8CSSPositionTryRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "name", "CSSPositionTryRule", NameAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "style", "CSSPositionTryRule", StyleAttributeGetCallback, StyleAttributeSetCallback, unsigned(v8::None),
