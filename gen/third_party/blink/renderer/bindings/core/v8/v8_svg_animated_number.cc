...
const WrapperTypeInfo& SVGAnimatedNumber::wrapper_type_info_ = V8SVGAnimatedNumber::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SVGAnimatedNumber>::value,
...
void V8SVGAnimatedNumber::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "baseVal", "SVGAnimatedNumber", BaseValAttributeGetCallback, BaseValAttributeSetCallback, unsigned(v8::None),
            ...
            { "animVal", "SVGAnimatedNumber", AnimValAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
