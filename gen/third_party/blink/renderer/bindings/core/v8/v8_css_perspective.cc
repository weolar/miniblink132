...
const WrapperTypeInfo& CSSPerspective::wrapper_type_info_ = V8CSSPerspective::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSPerspective>::value,
...
void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<V8UnionCSSKeywordValueOrCSSNumericValueOrString, std::remove_cvref_t<decltype(return_value)>>,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    static_assert(bindings::IsReturnTypeCompatible<CSSPerspective, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
    if (exception_state.HadException()) [[unlikely]] {
        return;
    }
...
void V8CSSPerspective::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "length", "CSSPerspective", LengthAttributeGetCallback, LengthAttributeSetCallback, unsigned(v8::None),
