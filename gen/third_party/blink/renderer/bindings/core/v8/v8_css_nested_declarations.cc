...
bool V8CSSNestedDeclarations::IsExposed(ExecutionContext* execution_context)
{
    ...
    return execution_context->IsWindow() && RuntimeEnabledFeatures::CSSNestedDeclarationsEnabled();
}
...
const WrapperTypeInfo& CSSNestedDeclarationsRule::wrapper_type_info_ = V8CSSNestedDeclarations::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CSSNestedDeclarationsRule>::value,
...
void V8CSSNestedDeclarations::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "style", "CSSNestedDeclarations", StyleAttributeGetCallback, StyleAttributeSetCallback, unsigned(v8::None),
