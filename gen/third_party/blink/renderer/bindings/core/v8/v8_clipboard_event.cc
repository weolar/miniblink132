...
const WrapperTypeInfo& ClipboardEvent::wrapper_type_info_ = V8ClipboardEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, ClipboardEvent>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<ClipboardEventInit>::NativeValue(
    ...
    static_assert(bindings::IsReturnTypeCompatible<ClipboardEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8ClipboardEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "clipboardData", "ClipboardEvent", ClipboardDataAttributeGetCallback, nullptr, unsigned(v8::None),
            ...
            { "isTrusted", "ClipboardEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
