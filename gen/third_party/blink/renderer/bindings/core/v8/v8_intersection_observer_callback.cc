...
const char* V8IntersectionObserverCallback::NameInHeapSnapshot() const
{
    return "V8IntersectionObserverCallback";
}

v8::Maybe<void> V8IntersectionObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver,
    const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer)
{
...
v8::Maybe<void> V8IntersectionObserverCallback::Construct(
    const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer)
{
    const char* const class_like_name = "IntersectionObserverCallback";
...
void V8IntersectionObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver,
    const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer)
{
    v8::Isolate* isolate = GetIsolate();
