...
const WrapperTypeInfo& SVGNumberTearOff::wrapper_type_info_ = V8SVGNumber::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, SVGNumberTearOff>::value,
...
void V8SVGNumber::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "value", "SVGNumber", ValueAttributeGetCallback, ValueAttributeSetCallback, unsigned(v8::None),
