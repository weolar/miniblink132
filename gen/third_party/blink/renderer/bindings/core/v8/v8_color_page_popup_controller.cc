...
const WrapperTypeInfo& ColorPagePopupController::wrapper_type_info_ = V8ColorPagePopupController::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, ColorPagePopupController>::value,
...
void V8ColorPagePopupController::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "openEyeDropper", "ColorPagePopupController", OpenEyeDropperOperationCallback, 0, unsigned(v8::None),
...
void V8ColorPagePopupController::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world,
