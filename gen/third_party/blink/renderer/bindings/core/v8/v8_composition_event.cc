...
const WrapperTypeInfo& CompositionEvent::wrapper_type_info_ = V8CompositionEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, CompositionEvent>::value,
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    decltype(NativeValueTraits<CompositionEventInit>::NativeValue(
    ...
    static_assert(bindings::IsReturnTypeCompatible<CompositionEvent, std::remove_cvref_t<decltype(return_value)>>,
        "Return type from native call is incompatible to the type specified in IDL");
...
void V8CompositionEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
    ...
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interface_function_template);
    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "data", "CompositionEvent", DataAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
            ...
            { "isTrusted", "CompositionEvent", IsTrustedAttributeGetCallback, nullptr, unsigned(v8::DontDelete),
...

    {
        static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
            { "initCompositionEvent", "CompositionEvent", InitCompositionEventOperationCallback, 1, unsigned(v8::None),
