...
const WrapperTypeInfo& HTMLMapElement::wrapper_type_info_ = V8HTMLMapElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(!std::is_base_of<ActiveScriptWrappableBase, HTMLMapElement>::value,
...
void NameAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    const char* const class_like_name = "HTMLMapElement";
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    // [HTMLConstructor]
    V8HTMLConstructor::HtmlConstructor(info, *V8HTMLMapElement::GetWrapperTypeInfo(), HTMLElementType::kHTMLMapElement);
}
...
void V8HTMLMapElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template,
    v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template)
{
...

    {
        static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
            { "name", "HTMLMapElement", NameAttributeGetCallback, NameAttributeSetCallback, unsigned(v8::None),
            ...
            { "areas", "HTMLMapElement", AreasAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype),
