...
public:
    ...
    bool hasHandler()
    {
        return m_handler.has_value();
    }
    v8_inspector::protocol::Runtime::API::RemoteObject* getHandler(v8_inspector::protocol::Runtime::API::RemoteObject* defaultValue)
    {
        return m_handler.has_value() ? &m_handler.value() : defaultValue;
    }
    void setHandler(std::unique_ptr<v8_inspector::protocol::Runtime::API::RemoteObject> value)
    {
        m_handler = std::move(value);
    }

    bool hasOriginalHandler()
    {
        return m_originalHandler.has_value();
    }
    ...
    {
        return m_originalHandler.has_value() ? &m_originalHandler.value() : defaultValue;
    }
    void setOriginalHandler(std::unique_ptr<v8_inspector::protocol::Runtime::API::RemoteObject> value)
    {
        m_originalHandler = std::move(value);
    }
    ...
    template <int STATE> class EventListenerBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            TypeSet = 1 << 1,
...
public:
    ...
    virtual DispatchResponse getEventListeners(const String& in_objectId, Maybe<int> in_depth, Maybe<bool> in_pierce,
