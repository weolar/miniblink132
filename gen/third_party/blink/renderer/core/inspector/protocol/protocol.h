...
template <typename T> struct ProtocolTypeTraits<T, typename std::enable_if<std::is_base_of<blink::protocol::Value, T>::value>::type> {
...
template <> struct ProtocolTypeTraits<std::unique_ptr<blink::protocol::Value>> {
...
template <> struct ProtocolTypeTraits<std::unique_ptr<blink::protocol::DictionaryValue>> {
...
template <> struct ProtocolTypeTraits<std::unique_ptr<blink::protocol::Object>> {
...
template <> struct ProtocolTypeTraits<blink::protocol::Object> {
