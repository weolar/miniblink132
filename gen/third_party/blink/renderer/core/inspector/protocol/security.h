...
public:
    ...
    bool hasCertificateNetworkError()
    {
        return m_certificateNetworkError.has_value();
    }
    String getCertificateNetworkError(const String& defaultValue) const
    {
        return m_certificateNetworkError.value_or(defaultValue);
    }
    void setCertificateNetworkError(const String& value)
    {
        m_certificateNetworkError = value;
    }

    bool getCertificateHasWeakSignature()
    {
        return m_certificateHasWeakSignature;
    }
    void setCertificateHasWeakSignature(bool value)
    {
        m_certificateHasWeakSignature = value;
    }

    bool getCertificateHasSha1Signature()
    {
        return m_certificateHasSha1Signature;
    }
    void setCertificateHasSha1Signature(bool value)
    {
        m_certificateHasSha1Signature = value;
    }
    ...
    void setModernSSL(bool value)
    {
        m_modernSSL = value;
    }

    bool getObsoleteSslProtocol()
    {
        return m_obsoleteSslProtocol;
    }
    void setObsoleteSslProtocol(bool value)
    {
        m_obsoleteSslProtocol = value;
    }

    bool getObsoleteSslKeyExchange()
    {
        return m_obsoleteSslKeyExchange;
    }
    void setObsoleteSslKeyExchange(bool value)
    {
        m_obsoleteSslKeyExchange = value;
    }

    bool getObsoleteSslCipher()
    {
        return m_obsoleteSslCipher;
    }
    void setObsoleteSslCipher(bool value)
    {
        m_obsoleteSslCipher = value;
    }

    bool getObsoleteSslSignature()
    {
        return m_obsoleteSslSignature;
    }
    void setObsoleteSslSignature(bool value)
    {
        m_obsoleteSslSignature = value;
    }

    template <int STATE> class CertificateSecurityStateBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            ProtocolSet = 1 << 1,
            ...
            AllFieldsSet = (ProtocolSet | KeyExchangeSet | CipherSet | CertificateSet | SubjectNameSet | IssuerSet | ValidFromSet | ValidToSet
                | CertificateHasWeakSignatureSet | CertificateHasSha1SignatureSet | ModernSSLSet | ObsoleteSslProtocolSet | ObsoleteSslKeyExchangeSet
                | ObsoleteSslCipherSet | ObsoleteSslSignatureSet | 0)
        };
    ...
    private:
        ...
        CertificateSecurityStateBuilder()
            : m_result(new CertificateSecurityState())
        {
        }
...
public:
    ...
    String getSafetyTipStatus()
    {
        return m_safetyTipStatus;
    }
    void setSafetyTipStatus(const String& value)
    {
        m_safetyTipStatus = value;
    }

    bool hasSafeUrl()
    {
        return m_safeUrl.has_value();
    }
    String getSafeUrl(const String& defaultValue) const
    {
        return m_safeUrl.value_or(defaultValue);
    }
    void setSafeUrl(const String& value)
    {
        m_safeUrl = value;
    }

    template <int STATE> class SafetyTipInfoBuilder {
    public:
        enum { NoFieldsSet = 0, SafetyTipStatusSet = 1 << 1, AllFieldsSet = (SafetyTipStatusSet | 0) };
...
public:
    ...
    bool hasCertificateSecurityState()
    {
        return m_certificateSecurityState.has_value();
    }
    ...
    {
        return m_certificateSecurityState.has_value() ? &m_certificateSecurityState.value() : defaultValue;
    }
    void setCertificateSecurityState(std::unique_ptr<protocol::Security::CertificateSecurityState> value)
    {
        m_certificateSecurityState = std::move(value);
    }

    bool hasSafetyTipInfo()
    {
        return m_safetyTipInfo.has_value();
    }
    protocol::Security::SafetyTipInfo* getSafetyTipInfo(protocol::Security::SafetyTipInfo* defaultValue)
    {
        return m_safetyTipInfo.has_value() ? &m_safetyTipInfo.value() : defaultValue;
    }
    void setSafetyTipInfo(std::unique_ptr<protocol::Security::SafetyTipInfo> value)
    {
        m_safetyTipInfo = std::move(value);
    }

    protocol::Array<String>* getSecurityStateIssueIds()
    {
        return m_securityStateIssueIds.get();
    }
    void setSecurityStateIssueIds(std::unique_ptr<protocol::Array<String>> value)
    {
        m_securityStateIssueIds = std::move(value);
    }

    template <int STATE> class VisibleSecurityStateBuilder {
    public:
        enum {
            NoFieldsSet = 0,
    ...
    private:
        ...
        VisibleSecurityStateBuilder()
            : m_result(new VisibleSecurityState())
        {
        }
...
public:
    ...
    {
        return m_recommendations.has_value();
    }
    protocol::Array<String>* getRecommendations(protocol::Array<String>* defaultValue)
    {
        return m_recommendations.has_value() ? &m_recommendations.value() : defaultValue;
    }
    void setRecommendations(std::unique_ptr<protocol::Array<String>> value)
    {
        m_recommendations = std::move(value);
    }

    template <int STATE> class SecurityStateExplanationBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            SecurityStateSet = 1 << 1,
...
public:
    ...
    template <int STATE> class InsecureContentStatusBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            ...
            AllFieldsSet = (RanMixedContentSet | DisplayedMixedContentSet | ContainedMixedFormSet | RanContentWithCertErrorsSet
                | DisplayedContentWithCertErrorsSet | RanInsecureContentStyleSet | DisplayedInsecureContentStyleSet | 0)
        };
...
public:
    ...
    void securityStateChanged(const String& securityState, bool schemeIsCryptographic,
        std::unique_ptr<protocol::Array<protocol::Security::SecurityStateExplanation>> explanations,
        std::unique_ptr<protocol::Security::InsecureContentStatus> insecureContentStatus, Maybe<String> summary = Maybe<String>());
