...
public:
    ...
    void setStackTrace(std::unique_ptr<v8_inspector::protocol::Runtime::API::StackTrace> value)
    {
    ...
    {
        return m_networkRequestId.has_value();
    }
    ...
    bool hasArgs()
    {
        return m_args.has_value();
    }
    protocol::Array<v8_inspector::protocol::Runtime::API::RemoteObject>* getArgs(
        protocol::Array<v8_inspector::protocol::Runtime::API::RemoteObject>* defaultValue)
    {
        return m_args.has_value() ? &m_args.value() : defaultValue;
    }
    void setArgs(std::unique_ptr<protocol::Array<v8_inspector::protocol::Runtime::API::RemoteObject>> value)
    {
    ...
    public:
        ...
        LogEntryBuilder<STATE>& setArgs(std::unique_ptr<protocol::Array<v8_inspector::protocol::Runtime::API::RemoteObject>> value)
        {
...
private:
    ...
    Maybe<protocol::Array<v8_inspector::protocol::Runtime::API::RemoteObject>> m_args;
};
...
public:
    ...
    template <int STATE> class ViolationSettingBuilder {
    public:
        enum { NoFieldsSet = 0, NameSet = 1 << 1, ThresholdSet = 1 << 2, AllFieldsSet = (NameSet | ThresholdSet | 0) };
