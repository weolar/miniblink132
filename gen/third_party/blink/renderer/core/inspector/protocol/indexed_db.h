...
public:
    ...
    protocol::Array<protocol::IndexedDB::ObjectStore>* getObjectStores()
    {
        return m_objectStores.get();
    }
    void setObjectStores(std::unique_ptr<protocol::Array<protocol::IndexedDB::ObjectStore>> value)
    {
        m_objectStores = std::move(value);
    }

    template <int STATE> class DatabaseWithObjectStoresBuilder {
    public:
        enum { NoFieldsSet = 0, NameSet = 1 << 1, VersionSet = 1 << 2, ObjectStoresSet = 1 << 3, AllFieldsSet = (NameSet | VersionSet | ObjectStoresSet | 0) };
...
public:
    ...
    protocol::IndexedDB::KeyPath* getKeyPath()
    {
        return m_keyPath.get();
    }
    void setKeyPath(std::unique_ptr<protocol::IndexedDB::KeyPath> value)
    {
        m_keyPath = std::move(value);
    }
    ...
    protocol::Array<protocol::IndexedDB::ObjectStoreIndex>* getIndexes()
    {
        return m_indexes.get();
    }
    void setIndexes(std::unique_ptr<protocol::Array<protocol::IndexedDB::ObjectStoreIndex>> value)
    {
        m_indexes = std::move(value);
    }

    template <int STATE> class ObjectStoreBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            NameSet = 1 << 1,
...
public:
    ...
    template <int STATE> class ObjectStoreIndexBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            NameSet = 1 << 1,
...
public:
    ...
    {
        return m_array.has_value() ? &m_array.value() : defaultValue;
    }
    void setArray(std::unique_ptr<protocol::Array<protocol::IndexedDB::Key>> value)
    {
        m_array = std::move(value);
    }

    template <int STATE> class KeyBuilder {
    public:
...
public:
    ...
    {
        return m_lower.has_value() ? &m_lower.value() : defaultValue;
    }
    void setLower(std::unique_ptr<protocol::IndexedDB::Key> value)
    {
        m_lower = std::move(value);
    }
    ...
    {
        return m_upper.has_value() ? &m_upper.value() : defaultValue;
    }
    void setUpper(std::unique_ptr<protocol::IndexedDB::Key> value)
    {
        m_upper = std::move(value);
    }
    ...
    void setUpperOpen(bool value)
    {
        m_upperOpen = value;
    }

    template <int STATE> class KeyRangeBuilder {
    public:
        enum { NoFieldsSet = 0, LowerOpenSet = 1 << 1, UpperOpenSet = 1 << 2, AllFieldsSet = (LowerOpenSet | UpperOpenSet | 0) };
...
public:
    ...
    v8_inspector::protocol::Runtime::API::RemoteObject* getKey()
    {
        return m_key.get();
    }
    void setKey(std::unique_ptr<v8_inspector::protocol::Runtime::API::RemoteObject> value)
    {
        m_key = std::move(value);
    }

    v8_inspector::protocol::Runtime::API::RemoteObject* getPrimaryKey()
    {
        return m_primaryKey.get();
    }
    void setPrimaryKey(std::unique_ptr<v8_inspector::protocol::Runtime::API::RemoteObject> value)
    {
        m_primaryKey = std::move(value);
    }

    v8_inspector::protocol::Runtime::API::RemoteObject* getValue()
    {
        return m_value.get();
    }
    void setValue(std::unique_ptr<v8_inspector::protocol::Runtime::API::RemoteObject> value)
    {
        m_value = std::move(value);
    }

    template <int STATE> class DataEntryBuilder {
    public:
        enum { NoFieldsSet = 0, KeySet = 1 << 1, PrimaryKeySet = 1 << 2, ValueSet = 1 << 3, AllFieldsSet = (KeySet | PrimaryKeySet | ValueSet | 0) };
...
public:
    ...
    void setArray(std::unique_ptr<protocol::Array<String>> value)
    {
        m_array = std::move(value);
    }

    template <int STATE> class KeyPathBuilder {
    public:
        enum { NoFieldsSet = 0, TypeSet = 1 << 1, AllFieldsSet = (TypeSet | 0) };
...
public:
    ...
    virtual void clearObjectStore(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, Maybe<protocol::Storage::StorageBucket> in_storageBucket,
        const String& in_databaseName, const String& in_objectStoreName, std::unique_ptr<ClearObjectStoreCallback> callback)
        = 0;
    ...
    virtual void deleteDatabase(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, Maybe<protocol::Storage::StorageBucket> in_storageBucket,
        const String& in_databaseName, std::unique_ptr<DeleteDatabaseCallback> callback)
        = 0;
    ...
    virtual void deleteObjectStoreEntries(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey,
        Maybe<protocol::Storage::StorageBucket> in_storageBucket, const String& in_databaseName, const String& in_objectStoreName,
        std::unique_ptr<protocol::IndexedDB::KeyRange> in_keyRange, std::unique_ptr<DeleteObjectStoreEntriesCallback> callback)
        = 0;
    ...
    virtual void requestData(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, Maybe<protocol::Storage::StorageBucket> in_storageBucket,
        const String& in_databaseName, const String& in_objectStoreName, const String& in_indexName, int in_skipCount, int in_pageSize,
        Maybe<protocol::IndexedDB::KeyRange> in_keyRange, std::unique_ptr<RequestDataCallback> callback)
        = 0;
    ...
    virtual void getMetadata(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, Maybe<protocol::Storage::StorageBucket> in_storageBucket,
        const String& in_databaseName, const String& in_objectStoreName, std::unique_ptr<GetMetadataCallback> callback)
        = 0;
    ...
    virtual void requestDatabase(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, Maybe<protocol::Storage::StorageBucket> in_storageBucket,
        const String& in_databaseName, std::unique_ptr<RequestDatabaseCallback> callback)
        = 0;
    ...
    virtual void requestDatabaseNames(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, Maybe<protocol::Storage::StorageBucket> in_storageBucket,
        std::unique_ptr<RequestDatabaseNamesCallback> callback)
        = 0;
};
