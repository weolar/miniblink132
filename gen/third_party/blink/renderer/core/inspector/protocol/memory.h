...
public:
    ...
    protocol::Array<String>* getStack()
    {
        return m_stack.get();
    }
    void setStack(std::unique_ptr<protocol::Array<String>> value)
    {
        m_stack = std::move(value);
    }

    template <int STATE> class SamplingProfileNodeBuilder {
    public:
        enum { NoFieldsSet = 0, SizeSet = 1 << 1, TotalSet = 1 << 2, StackSet = 1 << 3, AllFieldsSet = (SizeSet | TotalSet | StackSet | 0) };
    ...
    private:
        ...
        SamplingProfileNodeBuilder()
            : m_result(new SamplingProfileNode())
        {
        }
...
public:
    ...
    protocol::Array<protocol::Memory::SamplingProfileNode>* getSamples()
    {
        return m_samples.get();
    }
    void setSamples(std::unique_ptr<protocol::Array<protocol::Memory::SamplingProfileNode>> value)
    {
        m_samples = std::move(value);
    }

    protocol::Array<protocol::Memory::Module>* getModules()
    {
        return m_modules.get();
    }
    void setModules(std::unique_ptr<protocol::Array<protocol::Memory::Module>> value)
    {
        m_modules = std::move(value);
    }

    template <int STATE> class SamplingProfileBuilder {
    public:
        enum { NoFieldsSet = 0, SamplesSet = 1 << 1, ModulesSet = 1 << 2, AllFieldsSet = (SamplesSet | ModulesSet | 0) };
...
public:
    ...
    void setBaseAddress(const String& value)
    {
        m_baseAddress = value;
    }
    ...
    template <int STATE> class ModuleBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            NameSet = 1 << 1,
