...
public:
    ...
    protocol::Array<protocol::CacheStorage::Header>* getRequestHeaders()
    {
        return m_requestHeaders.get();
    }
    void setRequestHeaders(std::unique_ptr<protocol::Array<protocol::CacheStorage::Header>> value)
    {
    ...
    void setResponseStatusText(const String& value)
    {
        m_responseStatusText = value;
    }
    ...
    void setResponseType(const String& value)
    {
        m_responseType = value;
    }

    protocol::Array<protocol::CacheStorage::Header>* getResponseHeaders()
    {
        return m_responseHeaders.get();
    }
    void setResponseHeaders(std::unique_ptr<protocol::Array<protocol::CacheStorage::Header>> value)
    {
    ...
    public:
        enum {
            ...
            AllFieldsSet = (RequestURLSet | RequestMethodSet | RequestHeadersSet | ResponseTimeSet | ResponseStatusSet | ResponseStatusTextSet | ResponseTypeSet
                | ResponseHeadersSet | 0)
        };
...
public:
    ...
    void setCacheId(const String& value)
    {
        m_cacheId = value;
    }
    ...
    bool hasStorageBucket()
    {
        return m_storageBucket.has_value();
    }
    protocol::Storage::StorageBucket* getStorageBucket(protocol::Storage::StorageBucket* defaultValue)
    {
        return m_storageBucket.has_value() ? &m_storageBucket.value() : defaultValue;
    }
    void setStorageBucket(std::unique_ptr<protocol::Storage::StorageBucket> value)
    {
        m_storageBucket = std::move(value);
    }
    ...
    template <int STATE> class CacheBuilder {
    public:
        enum {
            NoFieldsSet = 0,
            CacheIdSet = 1 << 1,
        ...
        CacheBuilder<STATE | StorageKeySet>& setStorageKey(const String& value)
        {
        ...
        CacheBuilder<STATE>& setStorageBucket(std::unique_ptr<protocol::Storage::StorageBucket> value)
        {
...
private:
    ...
    String m_storageKey;
    Maybe<protocol::Storage::StorageBucket> m_storageBucket;
    String m_cacheName;
};
...
public:
    ...
    template <int STATE> class HeaderBuilder {
    public:
...
public:
    ...
    void setBody(const Binary& value)
    {
        m_body = value;
    }

    template <int STATE> class CachedResponseBuilder {
    public:
        enum { NoFieldsSet = 0, BodySet = 1 << 1, AllFieldsSet = (BodySet | 0) };
...
public:
    ...
    virtual void requestCacheNames(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, Maybe<protocol::Storage::StorageBucket> in_storageBucket,
    ...
    virtual void requestCachedResponse(const String& in_cacheId, const String& in_requestURL,
        std::unique_ptr<protocol::Array<protocol::CacheStorage::Header>> in_requestHeaders, std::unique_ptr<RequestCachedResponseCallback> callback)
        = 0;
    ...
    virtual void requestEntries(const String& in_cacheId, Maybe<int> in_skipCount, Maybe<int> in_pageSize, Maybe<String> in_pathFilter,
