...
// static
bool SkColor4f_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const SkColor4f_Data* object = static_cast<const SkColor4f_Data*>(data);
