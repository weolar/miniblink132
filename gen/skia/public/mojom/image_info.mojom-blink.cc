...
bool StructTraits<::skia::mojom::blink::ImageInfo::DataView, ::skia::mojom::blink::ImageInfoPtr>::Read(
    ::skia::mojom::blink::ImageInfo::DataView input, ::skia::mojom::blink::ImageInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::skia::mojom::blink::BitmapN32ImageInfo::DataView, ::skia::mojom::blink::BitmapN32ImageInfoPtr>::Read(
    ::skia::mojom::blink::BitmapN32ImageInfo::DataView input, ::skia::mojom::blink::BitmapN32ImageInfoPtr* output)
{
    bool success = true;
