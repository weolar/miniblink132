...
{
    const char* name = ::cc::mojom::RenderFrameMetadataObserver::Name_;
...
{
    const char* name = ::cc::mojom::RenderFrameMetadataObserverClient::Name_;
...
bool StructTraits<::cc::mojom::DelegatedInkBrowserMetadata::DataView, ::cc::mojom::DelegatedInkBrowserMetadataPtr>::Read(
    ::cc::mojom::DelegatedInkBrowserMetadata::DataView input, ::cc::mojom::DelegatedInkBrowserMetadataPtr* output)
{
    bool success = true;
...
bool StructTraits<::cc::mojom::RenderFrameMetadata::DataView, ::cc::mojom::RenderFrameMetadataPtr>::Read(
    ::cc::mojom::RenderFrameMetadata::DataView input, ::cc::mojom::RenderFrameMetadataPtr* output)
{
    bool success = true;
