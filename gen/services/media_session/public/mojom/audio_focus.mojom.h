// services/media_session/public/mojom/audio_focus.mojom.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/media_session/public/mojom/audio_focus.mojom-forward.h" // IWYU pragma: export
...
class AudioFocusObserver : public AudioFocusObserverInterfaceBase {
public:
...
class AudioFocusRequestClient : public AudioFocusRequestClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class AudioFocusManager : public AudioFocusManagerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void RequestAudioFocus(::mojo::PendingReceiver<AudioFocusRequestClient> client, ::mojo::PendingRemote<::media_session::mojom::MediaSession> session,
    ...
    virtual void RequestGroupedAudioFocus(const ::base::UnguessableToken& request_id, ::mojo::PendingReceiver<AudioFocusRequestClient> client,
        ...
        const ::base::UnguessableToken& group_id, RequestGroupedAudioFocusCallback callback)
        = 0;
    ...
    virtual void SetSource(const ::base::UnguessableToken& identity, const std::string& name) = 0;
    ...
    using GetSourceFocusRequestsCallback = base::OnceCallback<void(std::vector<AudioFocusRequestStatePtr>)>;
...
class AudioFocusManagerDebug : public AudioFocusManagerDebugInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class AudioFocusObserverProxy : public AudioFocusObserver {
public:
...
class AudioFocusRequestClientProxy : public AudioFocusRequestClient {
public:
...
class AudioFocusManagerProxy : public AudioFocusManager {
public:
    ...
    void RequestAudioFocus(::mojo::PendingReceiver<AudioFocusRequestClient> client, ::mojo::PendingRemote<::media_session::mojom::MediaSession> session,
        ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type, RequestAudioFocusCallback callback) final;

    void RequestGroupedAudioFocus(const ::base::UnguessableToken& request_id, ::mojo::PendingReceiver<AudioFocusRequestClient> client,
        ::mojo::PendingRemote<::media_session::mojom::MediaSession> session, ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType type,
        const ::base::UnguessableToken& group_id, RequestGroupedAudioFocusCallback callback) final;
    ...
    void SetSource(const ::base::UnguessableToken& identity, const std::string& name) final;
...
class AudioFocusManagerDebugProxy : public AudioFocusManagerDebug {
public:
...
public:
    ...
    AudioFocusRequestState(::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType audio_focus_type);

    AudioFocusRequestState(
        ::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType audio_focus_type, const std::optional<std::string>& source_name);

    AudioFocusRequestState(::media_session::mojom::MediaSessionInfoPtr session_info, AudioFocusType audio_focus_type,
        const std::optional<std::string>& source_name, const std::optional<::base::UnguessableToken>& request_id);
    ...
    {
        return mojo::internal::SerializeImpl<AudioFocusRequestState::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::media_session::mojom::AudioFocusRequestState::DataView, ::media_session::mojom::AudioFocusRequestStatePtr> {
    static bool IsNull(const ::media_session::mojom::AudioFocusRequestStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::media_session::mojom::AudioFocusRequestStatePtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::media_session::mojom::AudioFocusRequestState::source_id)& source_id(const ::media_session::mojom::AudioFocusRequestStatePtr& input)
    {
