...
MediaImage::MediaImage(const ::blink::KURL& src_in, const ::WTF::String& type_in, WTF::Vector<::gfx::Size> sizes_in)
    : src(std::move(src_in))
...
ChapterInformation::ChapterInformation(const ::WTF::String& title_in, ::base::TimeDelta startTime_in, WTF::Vector<MediaImagePtr> artwork_in)
...
MediaMetadata::MediaMetadata(const ::WTF::String& title_in, const ::WTF::String& artist_in, const ::WTF::String& album_in, const ::WTF::String& source_title_in)
    : title(std::move(title_in))
...
MediaMetadata::MediaMetadata(const ::WTF::String& title_in, const ::WTF::String& artist_in, const ::WTF::String& album_in, const ::WTF::String& source_title_in,
    std::optional<WTF::Vector<ChapterInformationPtr>> chapters_in)
    : title(std::move(title_in))
    , artist(std::move(artist_in))
    , album(std::move(album_in))
    , source_title(std::move(source_title_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type std::optional<WTF::Vector<ChapterInformationPtr>>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
MediaImageBitmap::MediaImageBitmap(int32_t width_in, int32_t height_in, WTF::Vector<uint8_t> pixel_data_in)
...
MediaImageBitmap::MediaImageBitmap(int32_t width_in, int32_t height_in, WTF::Vector<uint8_t> pixel_data_in, MediaImageBitmapColorType color_type_in)
    : width(std::move(width_in))
    , height(std::move(height_in))
    , pixel_data(std::move(pixel_data_in))
...
RemotePlaybackMetadata::RemotePlaybackMetadata(const WTF::String& video_codec_in, const WTF::String& audio_codec_in, bool remote_playback_disabled_in)
...
RemotePlaybackMetadata::RemotePlaybackMetadata(const WTF::String& video_codec_in, const WTF::String& audio_codec_in, bool remote_playback_disabled_in,
    bool remote_playback_started_in, const WTF::String& unused_field_in)
    : video_codec(std::move(video_codec_in))
    , audio_codec(std::move(audio_codec_in))
    , remote_playback_disabled(std::move(remote_playback_disabled_in))
...
RemotePlaybackMetadata::RemotePlaybackMetadata(const WTF::String& video_codec_in, const WTF::String& audio_codec_in, bool remote_playback_disabled_in,
    bool remote_playback_started_in, const WTF::String& unused_field_in, bool is_encrypted_media_in)
    : video_codec(std::move(video_codec_in))
    , audio_codec(std::move(audio_codec_in))
    , remote_playback_disabled(std::move(remote_playback_disabled_in))
    , remote_playback_started(std::move(remote_playback_started_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool deprecated_is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in,
    MediaAudioVideoState deprecated_audio_video_state_in, const WTF::String& audio_sink_id_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool deprecated_is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in,
    MediaAudioVideoState deprecated_audio_video_state_in, const WTF::String& audio_sink_id_in,
    std::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in, CameraState camera_state_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionInfo::MediaSessionInfo(MediaSessionInfo::SessionState state_in, bool force_duck_in, MediaPlaybackState playback_state_in, bool is_controllable_in,
    bool prefer_stop_for_gain_focus_loss_in, bool deprecated_is_sensitive_in, MediaPictureInPictureState picture_in_picture_state_in,
    MediaAudioVideoState deprecated_audio_video_state_in, const WTF::String& audio_sink_id_in,
    std::optional<WTF::Vector<MediaAudioVideoState>> audio_video_states_in, MicrophoneState microphone_state_in, CameraState camera_state_in, bool muted_in)
    : state(std::move(state_in))
    , force_duck(std::move(force_duck_in))
    , playback_state(std::move(playback_state_in))
    , is_controllable(std::move(is_controllable_in))
...
MediaSessionDebugInfo::MediaSessionDebugInfo(const WTF::String& name_in, const WTF::String& owner_in, const WTF::String& state_in)
...
void MediaSessionObserverProxy::MediaSessionMetadataChanged(MediaMetadataPtr in_metadata)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionMetadataChanged", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("metadata"), in_metadata, "<value of type MediaMetadataPtr>");
        });
#endif
...
void MediaSessionObserverProxy::MediaSessionActionsChanged(const WTF::Vector<MediaSessionAction>& in_action)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionActionsChanged", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("action"), in_action, "<value of type const WTF::Vector<MediaSessionAction>&>");
        });
#endif
...
void MediaSessionObserverProxy::MediaSessionImagesChanged(WTF::HashMap<MediaSessionImageType, WTF::Vector<MediaImagePtr>> in_images)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionImagesChanged", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("images"), in_images, "<value of type WTF::HashMap<MediaSessionImageType, WTF::Vector<MediaImagePtr>>>");
    });
#endif
...
void MediaSessionObserverProxy::MediaSessionPositionChanged(MediaPositionPtr in_position)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send media_session::mojom::MediaSessionObserver::MediaSessionPositionChanged", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("position"), in_position, "<value of type MediaPositionPtr>");
        });
#endif
    ...
    MediaImagePtr in_image, int32_t in_minimum_size_px, int32_t in_desired_size_px, GetMediaImageBitmapCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send media_session::mojom::MediaSession::GetMediaImageBitmap", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("image"), in_image, "<value of type MediaImagePtr>");
...
void MediaSessionProxy::SetAudioSinkId(const WTF::String& in_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(MediaImageBitmapPtr in_image);
};
...
void MediaSession_GetMediaImageBitmap_ProxyToResponder::Run(MediaImageBitmapPtr in_image)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply media_session::mojom::MediaSession::GetMediaImageBitmap", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("image"), in_image, "<value of type MediaImageBitmapPtr>");
        });
#endif
...
bool StructTraits<::media_session::mojom::blink::MediaImage::DataView, ::media_session::mojom::blink::MediaImagePtr>::Read(
    ::media_session::mojom::blink::MediaImage::DataView input, ::media_session::mojom::blink::MediaImagePtr* output)
{
    bool success = true;
...
bool StructTraits<::media_session::mojom::blink::ChapterInformation::DataView, ::media_session::mojom::blink::ChapterInformationPtr>::Read(
    ::media_session::mojom::blink::ChapterInformation::DataView input, ::media_session::mojom::blink::ChapterInformationPtr* output)
{
    bool success = true;
...
bool StructTraits<::media_session::mojom::blink::MediaMetadata::DataView, ::media_session::mojom::blink::MediaMetadataPtr>::Read(
    ::media_session::mojom::blink::MediaMetadata::DataView input, ::media_session::mojom::blink::MediaMetadataPtr* output)
{
    bool success = true;
...
bool StructTraits<::media_session::mojom::blink::MediaImageBitmap::DataView, ::media_session::mojom::blink::MediaImageBitmapPtr>::Read(
    ::media_session::mojom::blink::MediaImageBitmap::DataView input, ::media_session::mojom::blink::MediaImageBitmapPtr* output)
{
    bool success = true;
...
bool StructTraits<::media_session::mojom::blink::MediaPosition::DataView, ::media_session::mojom::blink::MediaPositionPtr>::Read(
    ::media_session::mojom::blink::MediaPosition::DataView input, ::media_session::mojom::blink::MediaPositionPtr* output)
{
    bool success = true;
...
bool StructTraits<::media_session::mojom::blink::RemotePlaybackMetadata::DataView, ::media_session::mojom::blink::RemotePlaybackMetadataPtr>::Read(
    ::media_session::mojom::blink::RemotePlaybackMetadata::DataView input, ::media_session::mojom::blink::RemotePlaybackMetadataPtr* output)
{
    bool success = true;
...
bool StructTraits<::media_session::mojom::blink::MediaSessionInfo::DataView, ::media_session::mojom::blink::MediaSessionInfoPtr>::Read(
    ::media_session::mojom::blink::MediaSessionInfo::DataView input, ::media_session::mojom::blink::MediaSessionInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::media_session::mojom::blink::MediaSessionDebugInfo::DataView, ::media_session::mojom::blink::MediaSessionDebugInfoPtr>::Read(
    ::media_session::mojom::blink::MediaSessionDebugInfo::DataView input, ::media_session::mojom::blink::MediaSessionDebugInfoPtr* output)
{
    bool success = true;
...
void MediaSessionInterceptorForTesting::GetMediaImageBitmap(
    MediaImagePtr image, int32_t minimum_size_px, int32_t desired_size_px, GetMediaImageBitmapCallback callback)
{
...
void MediaSessionInterceptorForTesting::SetAudioSinkId(const WTF::String& id)
{
...
void MediaSessionAsyncWaiter::GetMediaImageBitmap(MediaImagePtr image, int32_t minimum_size_px, int32_t desired_size_px, MediaImageBitmapPtr* out_image)
{
    base::RunLoop loop;
    proxy_->GetMediaImageBitmap(std::move(image), std::move(minimum_size_px), std::move(desired_size_px),
        base::BindOnce(
            [](base::RunLoop* loop, MediaImageBitmapPtr* out_image, MediaImageBitmapPtr image) {
...
MediaImageBitmapPtr MediaSessionAsyncWaiter::GetMediaImageBitmap(MediaImagePtr image, int32_t minimum_size_px, int32_t desired_size_px)
{
