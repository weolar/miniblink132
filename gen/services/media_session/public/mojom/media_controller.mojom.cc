...
void MediaControllerProxy::ObserveImages(::media_session::mojom::MediaSessionImageType in_type, int32_t in_minimum_size_px, int32_t in_desired_size_px,
...
void MediaControllerProxy::SetAudioSinkId(const std::optional<std::string>& in_id)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaControllerObserverProxy::MediaSessionMetadataChanged(const std::optional<::media_session::MediaMetadata>& in_metadata)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void MediaControllerObserverProxy::MediaSessionActionsChanged(const std::vector<::media_session::mojom::MediaSessionAction>& in_action)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send media_session::mojom::MediaControllerObserver::MediaSessionActionsChanged", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("action"), in_action, "<value of type const std::vector<::media_session::mojom::MediaSessionAction>&>");
        });
#endif
...
void MediaControllerObserverProxy::MediaSessionPositionChanged(const std::optional<::media_session::MediaPosition>& in_position)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void MediaControllerImageObserverProxy::MediaControllerChapterImageChanged(int32_t in_index, const ::SkBitmap& in_bitmap)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void MediaControllerInterceptorForTesting::ObserveImages(::media_session::mojom::MediaSessionImageType type, int32_t minimum_size_px, int32_t desired_size_px,
...
void MediaControllerImageObserverInterceptorForTesting::MediaControllerImageChanged(
    ::media_session::mojom::MediaSessionImageType type, const ::SkBitmap& bitmap)
{
