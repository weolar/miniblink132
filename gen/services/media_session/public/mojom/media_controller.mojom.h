...
class MediaControllerManager : public MediaControllerManagerInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void ObserveImages(::media_session::mojom::MediaSessionImageType type, int32_t minimum_size_px, int32_t desired_size_px,
...
class MediaControllerObserver : public MediaControllerObserverInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class MediaControllerImageObserver : public MediaControllerImageObserverInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class MediaControllerManagerProxy : public MediaControllerManager {
public:
...
class MediaControllerObserverProxy : public MediaControllerObserver {
public:
...
class MediaControllerImageObserverProxy : public MediaControllerImageObserver {
public:
