...
class BLINK_PLATFORM_EXPORT RestrictedUDPSocket : public RestrictedUDPSocketInterfaceBase {
public:
...
//class BLINK_PLATFORM_EXPORT RestrictedUDPSocketProxy : public RestrictedUDPSocket {
//public:
    ...
    : socket_options()
{
    ...
    explicit RestrictedUDPSocketParams(::network::mojom::blink::UDPSocketOptionsPtr socket_options_in)
    ...
    ~RestrictedUDPSocketParams() = default;
    ...
    {
        return mojo::internal::SerializeImpl<RestrictedUDPSocketParams::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::RestrictedUDPSocketParams::DataView, ::network::mojom::blink::RestrictedUDPSocketParamsPtr> {
    static bool IsNull(const ::network::mojom::blink::RestrictedUDPSocketParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::RestrictedUDPSocketParamsPtr* output)
    {
        output->reset();
    }
