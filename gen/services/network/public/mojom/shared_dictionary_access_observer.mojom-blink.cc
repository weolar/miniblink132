...
SharedDictionaryAccessDetails::SharedDictionaryAccessDetails(SharedDictionaryAccessDetails::Type type_in, const ::blink::KURL& url_in,
...
bool StructTraits<::network::mojom::blink::SharedDictionaryAccessDetails::DataView, ::network::mojom::blink::SharedDictionaryAccessDetailsPtr>::Read(
    ::network::mojom::blink::SharedDictionaryAccessDetails::DataView input, ::network::mojom::blink::SharedDictionaryAccessDetailsPtr* output)
{
    bool success = true;
