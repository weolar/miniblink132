...
CustomProxyConfig::CustomProxyConfig(const ::net::ProxyConfig::ProxyRules& rules_in, bool should_override_existing_config_in,
...
CertVerifierServiceRemoteParams::CertVerifierServiceRemoteParams(::mojo::PendingRemote<::cert_verifier::mojom::CertVerifierService> cert_verifier_service_in,
...
HttpAuthStaticNetworkContextParams::HttpAuthStaticNetworkContextParams()
    : allow_default_credentials(mojo::internal::ConvertEnumValue<::network::mojom::DefaultCredentials, ::net::HttpAuthPreferences::DefaultCredentials>(
        ::network::mojom::DefaultCredentials::ALLOW_DEFAULT_CREDENTIALS))
{
}

HttpAuthStaticNetworkContextParams::HttpAuthStaticNetworkContextParams(::net::HttpAuthPreferences::DefaultCredentials allow_default_credentials_in)
...
CTPolicy::CTPolicy(std::vector<std::string> excluded_hosts_in, std::vector<std::string> excluded_spkis_in)
...
NetworkContextFilePaths::NetworkContextFilePaths(std::optional<::network::TransferableDirectory> shared_dictionary_directory_in,
    std::optional<::network::TransferableDirectory> http_cache_directory_in, ::network::TransferableDirectory data_directory_in,
...
SocketBrokerRemotes::SocketBrokerRemotes(
    ::mojo::PendingRemote<::network::mojom::SocketBroker> client_in, ::mojo::PendingRemote<::network::mojom::SocketBroker> server_in)
...
NetworkContextParams::NetworkContextParams(const std::string& user_agent_in, const std::string& accept_language_in, bool enable_brotli_in, bool enable_zstd_in,
    ...
    ::mojo::PendingRemote<::proxy_resolver_win::mojom::WindowsSystemProxyResolver> windows_system_proxy_resolver_in, bool enable_encrypted_cookies_in,
    ...
    int32_t http_cache_max_size_in, ::mojo::PendingRemote<::network::mojom::HttpCacheBackendFileOperationsFactory> http_cache_file_operations_factory_in,
    bool disable_idle_sockets_close_on_memory_pressure_in, ::network::mojom::SSLConfigPtr initial_ssl_config_in,
    ...
    ::mojo::PendingReceiver<::network::mojom::ProxyConfigClient> proxy_config_client_receiver_in, CustomProxyConfigPtr initial_custom_proxy_config_in,
    ...
    ::mojo::PendingRemote<::network::mojom::ProxyErrorClient> proxy_error_client_in, SocketBrokerRemotesPtr socket_brokers_in,
    ::mojo::PendingRemote<::ip_protection::mojom::CoreHost> ip_protection_core_host_in,
    ::mojo::PendingReceiver<::ip_protection::mojom::CoreControl> ip_protection_control_in, bool enable_ip_protection_in, bool pac_quick_check_enabled_in,
    ...
    CertVerifierServiceRemoteParamsPtr cert_verifier_params_in, ::network::mojom::CookieManagerParamsPtr cookie_manager_params_in,
    bool enable_domain_reliability_in, const std::string& domain_reliability_upload_reporter_in, bool discard_domain_reliablity_uploads_in,
    std::optional<::base::TimeDelta> reporting_delivery_interval_in, bool skip_reporting_send_permission_check_in,
    std::vector<::network::mojom::CorsOriginAccessPatternsPtr> cors_origin_access_list_in, std::vector<std::string> cors_exempt_header_list_in,
    bool allow_any_cors_exempt_header_for_browser_in, std::vector<std::string> hsts_policy_bypass_list_in,
    ...
    bool acam_preflight_spec_conformant_in, const std::optional<std::string>& cookie_deprecation_label_in,
    ::mojo::PendingRemote<::network::mojom::CookieEncryptionProvider> cookie_encryption_provider_in, bool device_bound_sessions_enabled_in,
    int64_t bound_network_in, const std::optional<base::flat_map<std::string, ::GURL>>& enterprise_reporting_endpoints_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::mojo::PendingRemote<::proxy_resolver_win::mojom::WindowsSystemProxyResolver>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
SharedDictionaryInfo::SharedDictionaryInfo(const std::string& match_in, std::vector<::network::mojom::RequestDestination> match_dest_in,
    const std::string& id_in, const ::GURL& dictionary_url_in, ::base::Time last_fetch_time_in, ::base::Time response_time_in, ::base::TimeDelta expiration_in,
    ::base::Time last_used_time_in, uint64_t size_in, const ::net::SHA256HashValue& hash_in)
...
SignedExchangeReport::SignedExchangeReport(bool success_in, const std::string& type_in, const ::GURL& outer_url_in, const ::GURL& inner_url_in,
    const ::GURL& cert_url_in, const std::string& referrer_in, const ::net::IPAddress& server_ip_address_in, const std::string& protocol_in,
    const std::string& method_in, int32_t status_code_in, ::base::TimeDelta elapsed_time_in)
...
URLLoaderFactoryOverride::URLLoaderFactoryOverride(::mojo::PendingRemote<::network::mojom::URLLoaderFactory> overriding_factory_in,
    ::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> overridden_factory_receiver_in, bool skip_cors_enabled_scheme_check_in)
...
URLLoaderFactoryParams::URLLoaderFactoryParams(int32_t process_id_in, const std::optional<::url::Origin>& request_initiator_origin_lock_in,
    ...
    ::mojo::PendingRemote<::network::mojom::DevToolsObserver> devtools_observer_in, TrustTokenOperationPolicyVerdict trust_token_issuance_policy_in,
    TrustTokenOperationPolicyVerdict trust_token_redemption_policy_in, const std::string& debug_tag_in,
    const ::net::CookieSettingOverrides& cookie_setting_overrides_in, bool require_cross_site_request_for_cookies_in)
...
void TrustedHeaderClientProxy::OnHeadersReceived(const std::string& in_headers, const ::net::IPEndPoint& in_remote_endpoint, OnHeadersReceivedCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::TrustedHeaderClient::OnHeadersReceived", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("headers"), in_headers, "<value of type const std::string&>");
...
private:
    ...
    void Run(int32_t in_result, const std::optional<std::string>& in_headers, const std::optional<::GURL>& in_preserve_fragment_on_redirect_url);
};
    ...
    int32_t in_result, const std::optional<std::string>& in_headers, const std::optional<::GURL>& in_preserve_fragment_on_redirect_url)
{
    ...
    TRACE_EVENT1("mojom", "Send reply network::mojom::TrustedHeaderClient::OnHeadersReceived", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type int32_t>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("headers"), in_headers, "<value of type const std::optional<std::string>&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("preserve_fragment_on_redirect_url"), in_preserve_fragment_on_redirect_url, "<value of type const std::optional<::GURL>&>");
    });
#endif
...
{
    const char* name = ::network::mojom::PreloadedSharedDictionaryInfoHandle::Name_;
...
void NetworkContextProxy::SetClient(::mojo::PendingRemote<::network::mojom::NetworkContextClient> in_client)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::SetClient", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("client"), in_client, "<value of type ::mojo::PendingRemote<::network::mojom::NetworkContextClient>>");
    });
#endif
    ...
    ::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> in_url_loader_factory, URLLoaderFactoryParamsPtr in_params)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateURLLoaderFactory", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("url_loader_factory"), in_url_loader_factory, "<value of type ::mojo::PendingReceiver<::network::mojom::URLLoaderFactory>>");
    ...
    ::network::mojom::ObliviousHttpRequestPtr in_request, ::mojo::PendingRemote<::network::mojom::ObliviousHttpClient> in_client)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::GetViaObliviousHttp", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("request"), in_request, "<value of type ::network::mojom::ObliviousHttpRequestPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("client"), in_client, "<value of type ::mojo::PendingRemote<::network::mojom::ObliviousHttpClient>>");
    });
#endif
...
void NetworkContextProxy::GetCookieManager(::mojo::PendingReceiver<::network::mojom::CookieManager> in_cookie_manager)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::GetCookieManager", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("cookie_manager"), in_cookie_manager, "<value of type ::mojo::PendingReceiver<::network::mojom::CookieManager>>");
    });
#endif
...
void NetworkContextProxy::GetRestrictedCookieManager(::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> in_restricted_cookie_manager,
    ::network::mojom::RestrictedCookieManagerRole in_role, const ::url::Origin& in_origin, const ::net::IsolationInfo& in_isolation_info,
    const ::net::CookieSettingOverrides& in_cookie_setting_overrides, ::mojo::PendingRemote<::network::mojom::CookieAccessObserver> in_cookie_observer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::GetRestrictedCookieManager", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("role"), in_role, "<value of type ::network::mojom::RestrictedCookieManagerRole>");
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("cookie_setting_overrides"), in_cookie_setting_overrides, "<value of type const ::net::CookieSettingOverrides&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("cookie_observer"), in_cookie_observer, "<value of type ::mojo::PendingRemote<::network::mojom::CookieAccessObserver>>");
    });
#endif
...
void NetworkContextProxy::ClearTrustTokenData(::network::mojom::ClearDataFilterPtr in_filter, ClearTrustTokenDataCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::ClearTrustTokenData", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("filter"), in_filter, "<value of type ::network::mojom::ClearDataFilterPtr>");
    });
#endif
...
void NetworkContextProxy::DeleteStoredTrustTokens(const ::url::Origin& in_issuer, DeleteStoredTrustTokensCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::DeleteStoredTrustTokens", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("issuer"), in_issuer, "<value of type const ::url::Origin&>");
    });
#endif
    ...
    const ::GURL& in_url, const std::string& in_http_method, const ::net::NetworkIsolationKey& in_key, bool in_include_credentials)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::NotifyExternalCacheHit", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("http_method"), in_http_method, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("key"), in_key, "<value of type const ::net::NetworkIsolationKey&>");
...
void NetworkContextProxy::ClearHostCache(::network::mojom::ClearDataFilterPtr in_filter, ClearHostCacheCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::ClearCorsPreflightCache(::network::mojom::ClearDataFilterPtr in_filter, ClearCorsPreflightCacheCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::ClearReportingCacheReports(::network::mojom::ClearDataFilterPtr in_filter, ClearReportingCacheReportsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::ClearReportingCacheClients(::network::mojom::ClearDataFilterPtr in_filter, ClearReportingCacheClientsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::ClearNetworkErrorLogging(::network::mojom::ClearDataFilterPtr in_filter, ClearNetworkErrorLoggingCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    const ::net::SharedDictionaryIsolationKey& in_isolation_key, ClearSharedDictionaryCacheForIsolationKeyCallback callback)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send network::mojom::NetworkContext::ClearSharedDictionaryCacheForIsolationKey", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("isolation_key"), in_isolation_key, "<value of type const ::net::SharedDictionaryIsolationKey&>");
        });
#endif
...
void NetworkContextProxy::SetDocumentReportingEndpoints(const ::base::UnguessableToken& in_reporting_source, const ::url::Origin& in_origin,
    const ::net::IsolationInfo& in_isolation_info, const base::flat_map<std::string, std::string>& in_endpoints)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::SetDocumentReportingEndpoints", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("origin"), in_origin, "<value of type const ::url::Origin&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("isolation_info"), in_isolation_info, "<value of type const ::net::IsolationInfo&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("endpoints"), in_endpoints, "<value of type const base::flat_map<std::string, std::string>&>");
    });
#endif
...
void NetworkContextProxy::SetEnterpriseReportingEndpoints(const base::flat_map<std::string, ::GURL>& in_endpoints)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::SetEnterpriseReportingEndpoints", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("endpoints"), in_endpoints, "<value of type const base::flat_map<std::string, ::GURL>&>");
    });
#endif
...
void NetworkContextProxy::QueueReport(const std::string& in_type, const std::string& in_group, const ::GURL& in_url,
    const std::optional<::base::UnguessableToken>& in_reporting_source, const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    ::base::Value::Dict in_body)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::QueueReport", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("type"), in_type, "<value of type const std::string&>");
...
void NetworkContextProxy::QueueEnterpriseReport(const std::string& in_type, const std::string& in_group, const ::GURL& in_url, ::base::Value::Dict in_body)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::QueueSignedExchangeReport(SignedExchangeReportPtr in_report, const ::net::NetworkAnonymizationKey& in_network_anonymization_key)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::SetAcceptLanguage(const std::string& in_new_accept_language)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::SetAcceptLanguage", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("new_accept_language"), in_new_accept_language, "<value of type const std::string&>");
    });
#endif
    ...
    ::mojo::PendingReceiver<::network::mojom::UDPSocket> in_receiver, ::mojo::PendingRemote<::network::mojom::UDPSocketListener> in_listener)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateUDPSocket", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::UDPSocket>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("listener"), in_listener, "<value of type ::mojo::PendingRemote<::network::mojom::UDPSocketListener>>");
    });
#endif
...
void NetworkContextProxy::CreateRestrictedUDPSocket(const ::net::IPEndPoint& in_addr, ::network::mojom::RestrictedUDPSocketMode in_mode,
    const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, ::network::mojom::RestrictedUDPSocketParamsPtr in_params,
    ::mojo::PendingReceiver<::network::mojom::RestrictedUDPSocket> in_receiver, ::mojo::PendingRemote<::network::mojom::UDPSocketListener> in_listener,
    CreateRestrictedUDPSocketCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateRestrictedUDPSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("mode"), in_mode, "<value of type ::network::mojom::RestrictedUDPSocketMode>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("traffic_annotation"), in_traffic_annotation, "<value of type const ::net::MutableNetworkTrafficAnnotationTag&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("params"), in_params, "<value of type ::network::mojom::RestrictedUDPSocketParamsPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::RestrictedUDPSocket>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("listener"), in_listener, "<value of type ::mojo::PendingRemote<::network::mojom::UDPSocketListener>>");
    });
#endif
...
void NetworkContextProxy::CreateTCPServerSocket(const ::net::IPEndPoint& in_local_addr, ::network::mojom::TCPServerSocketOptionsPtr in_options,
    const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> in_socket,
    CreateTCPServerSocketCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateTCPServerSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("options"), in_options, "<value of type ::network::mojom::TCPServerSocketOptionsPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("traffic_annotation"), in_traffic_annotation, "<value of type const ::net::MutableNetworkTrafficAnnotationTag&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("socket"), in_socket, "<value of type ::mojo::PendingReceiver<::network::mojom::TCPServerSocket>>");
    });
#endif
...
void NetworkContextProxy::CreateTCPConnectedSocket(const std::optional<::net::IPEndPoint>& in_local_addr, const ::net::AddressList& in_remote_addr_list,
    ::network::mojom::TCPConnectedSocketOptionsPtr in_tcp_connected_socket_options, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation,
    ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket> in_socket, ::mojo::PendingRemote<::network::mojom::SocketObserver> in_observer,
    CreateTCPConnectedSocketCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateTCPConnectedSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("tcp_connected_socket_options"), in_tcp_connected_socket_options, "<value of type ::network::mojom::TCPConnectedSocketOptionsPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("traffic_annotation"), in_traffic_annotation, "<value of type const ::net::MutableNetworkTrafficAnnotationTag&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("socket"), in_socket, "<value of type ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket>>");
        perfetto::WriteIntoTracedValueWithFallback(
...
void NetworkContextProxy::CreateTCPBoundSocket(const ::net::IPEndPoint& in_local_addr, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation,
    ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket> in_socket, CreateTCPBoundSocketCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateTCPBoundSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("traffic_annotation"), in_traffic_annotation, "<value of type const ::net::MutableNetworkTrafficAnnotationTag&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("socket"), in_socket, "<value of type ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket>>");
    });
#endif
...
void NetworkContextProxy::CreateProxyResolvingSocketFactory(::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory> in_factory)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateProxyResolvingSocketFactory", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("factory"), in_factory, "<value of type ::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory>>");
    });
#endif
...
void NetworkContextProxy::LookUpProxyForURL(const ::GURL& in_url, const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    ::mojo::PendingRemote<::network::mojom::ProxyLookupClient> in_proxy_lookup_client)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::LookUpProxyForURL", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("proxy_lookup_client"), in_proxy_lookup_client, "<value of type ::mojo::PendingRemote<::network::mojom::ProxyLookupClient>>");
    });
#endif
...
void NetworkContextProxy::CreateWebSocket(const ::GURL& in_url, const std::vector<std::string>& in_requested_protocols,
    ...
    std::vector<::network::mojom::HttpHeaderPtr> in_additional_headers, int32_t in_process_id, const ::url::Origin& in_origin, uint32_t in_options,
    const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation,
    ::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient> in_handshake_client,
    ::mojo::PendingRemote<::network::mojom::URLLoaderNetworkServiceObserver> in_url_loader_network_observer,
    ::mojo::PendingRemote<::network::mojom::WebSocketAuthenticationHandler> in_auth_handler, ::mojo::PendingRemote<TrustedHeaderClient> in_header_client,
    const std::optional<::base::UnguessableToken>& in_throttling_profile_id)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateWebSocket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url"), in_url, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("requested_protocols"), in_requested_protocols, "<value of type const std::vector<std::string>&>");
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("isolation_info"), in_isolation_info, "<value of type const ::net::IsolationInfo&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("additional_headers"), in_additional_headers, "<value of type std::vector<::network::mojom::HttpHeaderPtr>>");
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("traffic_annotation"), in_traffic_annotation, "<value of type const ::net::MutableNetworkTrafficAnnotationTag&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("handshake_client"), in_handshake_client, "<value of type ::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient>>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url_loader_network_observer"), in_url_loader_network_observer,
            "<value of type ::mojo::PendingRemote<::network::mojom::URLLoaderNetworkServiceObserver>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("auth_handler"), in_auth_handler, "<value of type ::mojo::PendingRemote<::network::mojom::WebSocketAuthenticationHandler>>");
        perfetto::WriteIntoTracedValueWithFallback(
...
void NetworkContextProxy::CreateWebTransport(const ::GURL& in_url, const ::url::Origin& in_origin,
    const ::net::NetworkAnonymizationKey& in_network_anonymization_key, std::vector<::network::mojom::WebTransportCertificateFingerprintPtr> in_fingerprints,
    ::mojo::PendingRemote<::network::mojom::WebTransportHandshakeClient> in_handshake_client)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateWebTransport", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("handshake_client"), in_handshake_client, "<value of type ::mojo::PendingRemote<::network::mojom::WebTransportHandshakeClient>>");
    });
#endif
...
void NetworkContextProxy::CreateNetLogExporter(::mojo::PendingReceiver<::network::mojom::NetLogExporter> in_receiver)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateNetLogExporter", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::NetLogExporter>>");
    });
#endif
...
void NetworkContextProxy::PreconnectSockets(uint32_t in_num_streams, const ::GURL& in_url, ::network::mojom::CredentialsMode in_credentials_mode,
    const ::net::NetworkAnonymizationKey& in_network_anonymization_key, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::CreateP2PSocketManager(const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    ::mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient> in_client,
    ::mojo::PendingReceiver<::network::mojom::P2PTrustedSocketManager> in_trusted_socket_manager,
    ::mojo::PendingReceiver<::network::mojom::P2PSocketManager> in_socket_manager)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateP2PSocketManager", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("client"), in_client, "<value of type ::mojo::PendingRemote<::network::mojom::P2PTrustedSocketManagerClient>>");
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("socket_manager"), in_socket_manager, "<value of type ::mojo::PendingReceiver<::network::mojom::P2PSocketManager>>");
    });
#endif
...
void NetworkContextProxy::CreateMdnsResponder(::mojo::PendingReceiver<::network::mojom::MdnsResponder> in_responder_receiver)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateMdnsResponder", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("responder_receiver"), in_responder_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::MdnsResponder>>");
    });
#endif
...
void NetworkContextProxy::ResolveHost(::network::mojom::HostResolverHostPtr in_host, const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    ::network::mojom::ResolveHostParametersPtr in_optional_parameters, ::mojo::PendingRemote<::network::mojom::ResolveHostClient> in_response_client)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::ResolveHost", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("host"), in_host, "<value of type ::network::mojom::HostResolverHostPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("optional_parameters"), in_optional_parameters, "<value of type ::network::mojom::ResolveHostParametersPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("response_client"), in_response_client, "<value of type ::mojo::PendingRemote<::network::mojom::ResolveHostClient>>");
    });
#endif
    ...
    const std::optional<::net::DnsConfigOverrides>& in_config_overrides, ::mojo::PendingReceiver<::network::mojom::HostResolver> in_host_resolver)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::CreateHostResolver", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("config_overrides"), in_config_overrides, "<value of type const std::optional<::net::DnsConfigOverrides>&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("host_resolver"), in_host_resolver, "<value of type ::mojo::PendingReceiver<::network::mojom::HostResolver>>");
    });
#endif
...
void NetworkContextProxy::VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& in_certificate, const ::GURL& in_url,
    const std::string& in_ocsp_response, const std::string& in_sct_list, VerifyCertForSignedExchangeCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::VerifyCertForSignedExchange", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("certificate"), in_certificate, "<value of type const ::scoped_refptr<::net::X509Certificate>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("url"), in_url, "<value of type const ::GURL&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("ocsp_response"), in_ocsp_response, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("sct_list"), in_sct_list, "<value of type const std::string&>");
    });
#endif
...
void NetworkContextProxy::AddHSTS(const std::string& in_host, ::base::Time in_expiry, bool in_include_subdomains, AddHSTSCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::IsHSTSActiveForHost(const std::string& in_host, IsHSTSActiveForHostCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::GetHSTSState(const std::string& in_domain, GetHSTSStateCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::GetHSTSState", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("domain"), in_domain, "<value of type const std::string&>");
    });
#endif
...
void NetworkContextProxy::SetCorsOriginAccessListsForOrigin(const ::url::Origin& in_source_origin,
    std::vector<::network::mojom::CorsOriginPatternPtr> in_allow_patterns, std::vector<::network::mojom::CorsOriginPatternPtr> in_block_patterns,
    SetCorsOriginAccessListsForOriginCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::SetCorsOriginAccessListsForOrigin", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("allow_patterns"), in_allow_patterns, "<value of type std::vector<::network::mojom::CorsOriginPatternPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("block_patterns"), in_block_patterns, "<value of type std::vector<::network::mojom::CorsOriginPatternPtr>>");
    });
#endif
...
void NetworkContextProxy::DeleteDynamicDataForHost(const std::string& in_host, DeleteDynamicDataForHostCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::AddAuthCacheEntry(const ::net::AuthChallengeInfo& in_challenge, const ::net::NetworkAnonymizationKey& in_network_anonymization_key,
    const ::net::AuthCredentials& in_credentials, AddAuthCacheEntryCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::AddAuthCacheEntry", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("network_anonymization_key"), in_network_anonymization_key, "<value of type const ::net::NetworkAnonymizationKey&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("credentials"), in_credentials, "<value of type const ::net::AuthCredentials&>");
    });
#endif
...
void NetworkContextProxy::VerifyCertificateForTesting(const ::scoped_refptr<::net::X509Certificate>& in_certificate, const std::string& in_hostname,
    const std::string& in_ocsp_response, const std::string& in_sct_list, VerifyCertificateForTestingCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::VerifyCertificateForTesting", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("certificate"), in_certificate, "<value of type const ::scoped_refptr<::net::X509Certificate>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("hostname"), in_hostname, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("ocsp_response"), in_ocsp_response, "<value of type const std::string&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("sct_list"), in_sct_list, "<value of type const std::string&>");
    });
#endif
...
bool NetworkContextProxy::AddDomainReliabilityContextForTesting(const ::url::Origin& param_origin, const ::GURL& param_upload_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT_BEGIN1(
        "mojom", "Call network::mojom::NetworkContext::AddDomainReliabilityContextForTesting (sync)", "input_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("upload_url"), param_upload_url, "<value of type const ::GURL&>");
        });
#else
    ...
    const ::url::Origin& in_origin, const ::GURL& in_upload_url, AddDomainReliabilityContextForTestingCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::AddDomainReliabilityContextForTesting", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("origin"), in_origin, "<value of type const ::url::Origin&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("upload_url"), in_upload_url, "<value of type const ::GURL&>");
    });
#endif
...
void NetworkContextProxy::AddReportingApiObserver(::mojo::PendingRemote<::network::mojom::ReportingApiObserver> in_observer)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::AddReportingApiObserver", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("observer"), in_observer, "<value of type ::mojo::PendingRemote<::network::mojom::ReportingApiObserver>>");
    });
#endif
...
void NetworkContextProxy::GetSharedDictionaryInfo(const ::net::SharedDictionaryIsolationKey& in_isolation_key, GetSharedDictionaryInfoCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::FlushCachedClientCertIfNeeded(const ::net::HostPortPair& in_host, const ::scoped_refptr<::net::X509Certificate>& in_certificate)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::FlushMatchingCachedClientCert(const ::scoped_refptr<::net::X509Certificate>& in_certificate)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkContextProxy::SetCookieDeprecationLabel(const std::optional<std::string>& in_label)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::SetCookieDeprecationLabel", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("label"), in_label, "<value of type const std::optional<std::string>&>");
    });
#endif
...
void NetworkContextProxy::RevokeNetworkForNonces(const std::vector<::base::UnguessableToken>& in_nonces, RevokeNetworkForNoncesCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkContext::RevokeNetworkForNonces", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("nonces"), in_nonces, "<value of type const std::vector<::base::UnguessableToken>&>");
    });
#endif
...
void NetworkContextProxy::ClearNonces(const std::vector<::base::UnguessableToken>& in_nonces)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    const ::GURL& in_exempted_url, const ::base::UnguessableToken& in_nonce, ExemptUrlFromNetworkRevocationForNonceCallback callback)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send network::mojom::NetworkContext::ExemptUrlFromNetworkRevocationForNonce", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("exempted_url"), in_exempted_url, "<value of type const ::GURL&>");
...
private:
    ...
    void Run(std::vector<::network::mojom::StoredTrustTokensForIssuerPtr> in_tokens);
};
...
void NetworkContext_GetStoredTrustTokenCounts_ProxyToResponder::Run(std::vector<::network::mojom::StoredTrustTokensForIssuerPtr> in_tokens)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply network::mojom::NetworkContext::GetStoredTrustTokenCounts", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("tokens"), in_tokens, "<value of type std::vector<::network::mojom::StoredTrustTokensForIssuerPtr>>");
        });
#endif
...
private:
    ...
    void Run(base::flat_map<::url::Origin, std::vector<::network::mojom::ToplevelRedemptionRecordPtr>> in_issuer_redemption_record_map);
};
...
private:
    ...
    void Run(::network::mojom::DeleteStoredTrustTokensStatus in_status);
};
...
void NetworkContext_DeleteStoredTrustTokens_ProxyToResponder::Run(::network::mojom::DeleteStoredTrustTokensStatus in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply network::mojom::NetworkContext::DeleteStoredTrustTokens", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("status"), in_status, "<value of type ::network::mojom::DeleteStoredTrustTokensStatus>");
        });
#endif
...
private:
    ...
    void Run(int32_t in_error_code, const ::net::CertVerifyResult& in_cv_result, bool in_pkp_bypassed);
};
...
void NetworkContext_VerifyCertForSignedExchange_ProxyToResponder::Run(int32_t in_error_code, const ::net::CertVerifyResult& in_cv_result, bool in_pkp_bypassed)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply network::mojom::NetworkContext::VerifyCertForSignedExchange", "async_response_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cv_result"), in_cv_result, "<value of type const ::net::CertVerifyResult&>");
...
void NetworkContext_LookupServerBasicAuthCredentials_ProxyToResponder::Run(const std::optional<::net::AuthCredentials>& in_credentials)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(const std::vector<::net::SharedDictionaryUsageInfo>& in_usage_info);
};
...
void NetworkContext_GetSharedDictionaryUsageInfo_ProxyToResponder::Run(const std::vector<::net::SharedDictionaryUsageInfo>& in_usage_info)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply network::mojom::NetworkContext::GetSharedDictionaryUsageInfo", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("usage_info"), in_usage_info, "<value of type const std::vector<::net::SharedDictionaryUsageInfo>&>");
        });
#endif
...
private:
    ...
    void Run(std::vector<SharedDictionaryInfoPtr> in_dictionaries);
};
...
void NetworkContext_GetSharedDictionaryInfo_ProxyToResponder::Run(std::vector<SharedDictionaryInfoPtr> in_dictionaries)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send reply network::mojom::NetworkContext::GetSharedDictionaryInfo", "async_response_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("dictionaries"), in_dictionaries, "<value of type std::vector<SharedDictionaryInfoPtr>>");
        });
#endif
...
void NetworkContext_GetSharedDictionaryOriginsBetween_ProxyToResponder::Run(const std::vector<::url::Origin>& in_origins)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::network::mojom::CustomProxyConfig::DataView, ::network::mojom::CustomProxyConfigPtr>::Read(
    ::network::mojom::CustomProxyConfig::DataView input, ::network::mojom::CustomProxyConfigPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::CertVerifierServiceRemoteParams::DataView, ::network::mojom::CertVerifierServiceRemoteParamsPtr>::Read(
    ::network::mojom::CertVerifierServiceRemoteParams::DataView input, ::network::mojom::CertVerifierServiceRemoteParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::HttpAuthStaticNetworkContextParams::DataView, ::network::mojom::HttpAuthStaticNetworkContextParamsPtr>::Read(
    ::network::mojom::HttpAuthStaticNetworkContextParams::DataView input, ::network::mojom::HttpAuthStaticNetworkContextParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::CTPolicy::DataView, ::network::mojom::CTPolicyPtr>::Read(
    ::network::mojom::CTPolicy::DataView input, ::network::mojom::CTPolicyPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::NetworkContextFilePaths::DataView, ::network::mojom::NetworkContextFilePathsPtr>::Read(
    ::network::mojom::NetworkContextFilePaths::DataView input, ::network::mojom::NetworkContextFilePathsPtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::network::mojom::SocketBrokerRemotes::DataView, ::network::mojom::SocketBrokerRemotesPtr>::Read(
    ::network::mojom::SocketBrokerRemotes::DataView input, ::network::mojom::SocketBrokerRemotesPtr* output)
{
    bool success = true;
    ::network::mojom::SocketBrokerRemotesPtr result(::network::mojom::SocketBrokerRemotes::New());
...
bool StructTraits<::network::mojom::NetworkContextParams::DataView, ::network::mojom::NetworkContextParamsPtr>::Read(
    ::network::mojom::NetworkContextParams::DataView input, ::network::mojom::NetworkContextParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::NetworkConditions::DataView, ::network::mojom::NetworkConditionsPtr>::Read(
    ::network::mojom::NetworkConditions::DataView input, ::network::mojom::NetworkConditionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::SharedDictionaryInfo::DataView, ::network::mojom::SharedDictionaryInfoPtr>::Read(
    ::network::mojom::SharedDictionaryInfo::DataView input, ::network::mojom::SharedDictionaryInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::SignedExchangeReport::DataView, ::network::mojom::SignedExchangeReportPtr>::Read(
    ::network::mojom::SignedExchangeReport::DataView input, ::network::mojom::SignedExchangeReportPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::URLLoaderFactoryOverride::DataView, ::network::mojom::URLLoaderFactoryOverridePtr>::Read(
    ::network::mojom::URLLoaderFactoryOverride::DataView input, ::network::mojom::URLLoaderFactoryOverridePtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::URLLoaderFactoryParams::DataView, ::network::mojom::URLLoaderFactoryParamsPtr>::Read(
    ::network::mojom::URLLoaderFactoryParams::DataView input, ::network::mojom::URLLoaderFactoryParamsPtr* output)
{
    bool success = true;
...
void TrustedHeaderClientInterceptorForTesting::OnHeadersReceived(
    const std::string& headers, const ::net::IPEndPoint& remote_endpoint, OnHeadersReceivedCallback callback)
{
...
void TrustedHeaderClientAsyncWaiter::OnHeadersReceived(const std::string& headers, const ::net::IPEndPoint& remote_endpoint, int32_t* out_result,
    std::optional<std::string>* out_headers, std::optional<::GURL>* out_preserve_fragment_on_redirect_url)
{
    base::RunLoop loop;
    proxy_->OnHeadersReceived(std::move(headers), std::move(remote_endpoint),
        base::BindOnce(
            [](base::RunLoop* loop, int32_t* out_result, std::optional<std::string>* out_headers, std::optional<::GURL>* out_preserve_fragment_on_redirect_url,
                int32_t result, const std::optional<std::string>& headers, const std::optional<::GURL>& preserve_fragment_on_redirect_url) {
                *out_result = std::move(result);
                *out_headers = std::move(headers);
...
void NetworkContextInterceptorForTesting::CreateURLLoaderFactory(
    ::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> url_loader_factory, URLLoaderFactoryParamsPtr params)
{
...
void NetworkContextInterceptorForTesting::GetViaObliviousHttp(
    ::network::mojom::ObliviousHttpRequestPtr request, ::mojo::PendingRemote<::network::mojom::ObliviousHttpClient> client)
{
...
void NetworkContextInterceptorForTesting::GetRestrictedCookieManager(
    ::mojo::PendingReceiver<::network::mojom::RestrictedCookieManager> restricted_cookie_manager, ::network::mojom::RestrictedCookieManagerRole role,
    const ::url::Origin& origin, const ::net::IsolationInfo& isolation_info, const ::net::CookieSettingOverrides& cookie_setting_overrides,
...
void NetworkContextInterceptorForTesting::ClearTrustTokenData(::network::mojom::ClearDataFilterPtr filter, ClearTrustTokenDataCallback callback)
{
...
void NetworkContextInterceptorForTesting::ClearHttpCache(
    ::base::Time start_time, ::base::Time end_time, ::network::mojom::ClearDataFilterPtr filter, ClearHttpCacheCallback callback)
{
...
void NetworkContextInterceptorForTesting::NotifyExternalCacheHit(
    const ::GURL& url, const std::string& http_method, const ::net::NetworkIsolationKey& key, bool include_credentials)
{
...
void NetworkContextInterceptorForTesting::ClearHostCache(::network::mojom::ClearDataFilterPtr filter, ClearHostCacheCallback callback)
{
...
void NetworkContextInterceptorForTesting::ClearCorsPreflightCache(::network::mojom::ClearDataFilterPtr filter, ClearCorsPreflightCacheCallback callback)
{
    GetForwardingInterface()->ClearCorsPreflightCache(std::move(filter), std::move(callback));
}
void NetworkContextInterceptorForTesting::ClearReportingCacheReports(::network::mojom::ClearDataFilterPtr filter, ClearReportingCacheReportsCallback callback)
{
    GetForwardingInterface()->ClearReportingCacheReports(std::move(filter), std::move(callback));
}
void NetworkContextInterceptorForTesting::ClearReportingCacheClients(::network::mojom::ClearDataFilterPtr filter, ClearReportingCacheClientsCallback callback)
{
    GetForwardingInterface()->ClearReportingCacheClients(std::move(filter), std::move(callback));
}
void NetworkContextInterceptorForTesting::ClearNetworkErrorLogging(::network::mojom::ClearDataFilterPtr filter, ClearNetworkErrorLoggingCallback callback)
{
...
void NetworkContextInterceptorForTesting::SetDocumentReportingEndpoints(const ::base::UnguessableToken& reporting_source, const ::url::Origin& origin,
...
void NetworkContextInterceptorForTesting::SetEnterpriseReportingEndpoints(const base::flat_map<std::string, ::GURL>& endpoints)
{
...
void NetworkContextInterceptorForTesting::QueueReport(const std::string& type, const std::string& group, const ::GURL& url,
    const std::optional<::base::UnguessableToken>& reporting_source, const ::net::NetworkAnonymizationKey& network_anonymization_key, ::base::Value::Dict body)
{
...
void NetworkContextInterceptorForTesting::QueueEnterpriseReport(const std::string& type, const std::string& group, const ::GURL& url, ::base::Value::Dict body)
{
...
void NetworkContextInterceptorForTesting::QueueSignedExchangeReport(
    SignedExchangeReportPtr report, const ::net::NetworkAnonymizationKey& network_anonymization_key)
{
...
void NetworkContextInterceptorForTesting::CreateRestrictedUDPSocket(const ::net::IPEndPoint& addr, ::network::mojom::RestrictedUDPSocketMode mode,
...
void NetworkContextInterceptorForTesting::CreateTCPServerSocket(const ::net::IPEndPoint& local_addr, ::network::mojom::TCPServerSocketOptionsPtr options,
...
void NetworkContextInterceptorForTesting::CreateTCPConnectedSocket(const std::optional<::net::IPEndPoint>& local_addr,
    const ::net::AddressList& remote_addr_list, ::network::mojom::TCPConnectedSocketOptionsPtr tcp_connected_socket_options,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket> socket,
    ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, CreateTCPConnectedSocketCallback callback)
{
...
void NetworkContextInterceptorForTesting::CreateTCPBoundSocket(const ::net::IPEndPoint& local_addr,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket> socket,
...
void NetworkContextInterceptorForTesting::LookUpProxyForURL(const ::GURL& url, const ::net::NetworkAnonymizationKey& network_anonymization_key,
...
void NetworkContextInterceptorForTesting::CreateWebSocket(const ::GURL& url, const std::vector<std::string>& requested_protocols,
...
void NetworkContextInterceptorForTesting::CreateWebTransport(const ::GURL& url, const ::url::Origin& origin,
    const ::net::NetworkAnonymizationKey& network_anonymization_key, std::vector<::network::mojom::WebTransportCertificateFingerprintPtr> fingerprints,
...
void NetworkContextInterceptorForTesting::PreconnectSockets(uint32_t num_streams, const ::GURL& url, ::network::mojom::CredentialsMode credentials_mode,
...
void NetworkContextInterceptorForTesting::CreateP2PSocketManager(const ::net::NetworkAnonymizationKey& network_anonymization_key,
...
void NetworkContextInterceptorForTesting::ResolveHost(::network::mojom::HostResolverHostPtr host,
    const ::net::NetworkAnonymizationKey& network_anonymization_key, ::network::mojom::ResolveHostParametersPtr optional_parameters,
...
void NetworkContextInterceptorForTesting::VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url,
    const std::string& ocsp_response, const std::string& sct_list, VerifyCertForSignedExchangeCallback callback)
{
...
void NetworkContextInterceptorForTesting::SetCorsOriginAccessListsForOrigin(const ::url::Origin& source_origin,
    std::vector<::network::mojom::CorsOriginPatternPtr> allow_patterns, std::vector<::network::mojom::CorsOriginPatternPtr> block_patterns,
    SetCorsOriginAccessListsForOriginCallback callback)
{
...
void NetworkContextInterceptorForTesting::AddAuthCacheEntry(const ::net::AuthChallengeInfo& challenge,
    const ::net::NetworkAnonymizationKey& network_anonymization_key, const ::net::AuthCredentials& credentials, AddAuthCacheEntryCallback callback)
{
...
void NetworkContextInterceptorForTesting::VerifyCertificateForTesting(const ::scoped_refptr<::net::X509Certificate>& certificate, const std::string& hostname,
...
void NetworkContextInterceptorForTesting::GetSharedDictionaryInfo(
    const ::net::SharedDictionaryIsolationKey& isolation_key, GetSharedDictionaryInfoCallback callback)
{
...
void NetworkContextInterceptorForTesting::FlushCachedClientCertIfNeeded(
    const ::net::HostPortPair& host, const ::scoped_refptr<::net::X509Certificate>& certificate)
{
    GetForwardingInterface()->FlushCachedClientCertIfNeeded(std::move(host), std::move(certificate));
}
void NetworkContextInterceptorForTesting::FlushMatchingCachedClientCert(const ::scoped_refptr<::net::X509Certificate>& certificate)
{
...
void NetworkContextInterceptorForTesting::RevokeNetworkForNonces(const std::vector<::base::UnguessableToken>& nonces, RevokeNetworkForNoncesCallback callback)
{
    GetForwardingInterface()->RevokeNetworkForNonces(std::move(nonces), std::move(callback));
}
void NetworkContextInterceptorForTesting::ClearNonces(const std::vector<::base::UnguessableToken>& nonces)
{
...
void NetworkContextAsyncWaiter::ClearTrustTokenData(::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::GetStoredTrustTokenCounts(std::vector<::network::mojom::StoredTrustTokensForIssuerPtr>* out_tokens)
{
    base::RunLoop loop;
    proxy_->GetStoredTrustTokenCounts(base::BindOnce(
        [](base::RunLoop* loop, std::vector<::network::mojom::StoredTrustTokensForIssuerPtr>* out_tokens,
...
std::vector<::network::mojom::StoredTrustTokensForIssuerPtr> NetworkContextAsyncWaiter::GetStoredTrustTokenCounts()
{
    std::vector<::network::mojom::StoredTrustTokensForIssuerPtr> async_wait_result;
    ...
    base::flat_map<::url::Origin, std::vector<::network::mojom::ToplevelRedemptionRecordPtr>>* out_issuer_redemption_record_map)
{
    ...
    proxy_->GetPrivateStateTokenRedemptionRecords(base::BindOnce(
        [](base::RunLoop* loop, base::flat_map<::url::Origin, std::vector<::network::mojom::ToplevelRedemptionRecordPtr>>* out_issuer_redemption_record_map,
            base::flat_map<::url::Origin, std::vector<::network::mojom::ToplevelRedemptionRecordPtr>> issuer_redemption_record_map) {
...
base::flat_map<::url::Origin, std::vector<::network::mojom::ToplevelRedemptionRecordPtr>> NetworkContextAsyncWaiter::GetPrivateStateTokenRedemptionRecords()
{
    base::flat_map<::url::Origin, std::vector<::network::mojom::ToplevelRedemptionRecordPtr>> async_wait_result;
    GetPrivateStateTokenRedemptionRecords(&async_wait_result);
    return async_wait_result;
}

void NetworkContextAsyncWaiter::DeleteStoredTrustTokens(const ::url::Origin& issuer, ::network::mojom::DeleteStoredTrustTokensStatus* out_status)
{
    base::RunLoop loop;
    proxy_->DeleteStoredTrustTokens(std::move(issuer),
        base::BindOnce(
            [](base::RunLoop* loop, ::network::mojom::DeleteStoredTrustTokensStatus* out_status, ::network::mojom::DeleteStoredTrustTokensStatus status) {
...
::network::mojom::DeleteStoredTrustTokensStatus NetworkContextAsyncWaiter::DeleteStoredTrustTokens(const ::url::Origin& issuer)
{
    ::network::mojom::DeleteStoredTrustTokensStatus async_wait_result;
...
void NetworkContextAsyncWaiter::ClearHttpCache(::base::Time start_time, ::base::Time end_time, ::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearHostCache(::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearHttpAuthCache(::base::Time start_time, ::base::Time end_time, ::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearCorsPreflightCache(::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearReportingCacheReports(::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearReportingCacheClients(::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearNetworkErrorLogging(::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearDomainReliability(::network::mojom::ClearDataFilterPtr filter, NetworkContext::DomainReliabilityClearMode mode)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearSharedDictionaryCache(::base::Time start_time, ::base::Time end_time, ::network::mojom::ClearDataFilterPtr filter)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ClearSharedDictionaryCacheForIsolationKey(const ::net::SharedDictionaryIsolationKey& isolation_key)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::CreateRestrictedUDPSocket(const ::net::IPEndPoint& addr, ::network::mojom::RestrictedUDPSocketMode mode,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::network::mojom::RestrictedUDPSocketParamsPtr params,
    ::mojo::PendingReceiver<::network::mojom::RestrictedUDPSocket> receiver, ::mojo::PendingRemote<::network::mojom::UDPSocketListener> listener,
...
void NetworkContextAsyncWaiter::CreateTCPServerSocket(const ::net::IPEndPoint& local_addr, ::network::mojom::TCPServerSocketOptionsPtr options,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> socket, int32_t* out_result,
...
void NetworkContextAsyncWaiter::CreateTCPConnectedSocket(const std::optional<::net::IPEndPoint>& local_addr, const ::net::AddressList& remote_addr_list,
...
void NetworkContextAsyncWaiter::VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url,
    const std::string& ocsp_response, const std::string& sct_list, int32_t* out_error_code, ::net::CertVerifyResult* out_cv_result, bool* out_pkp_bypassed)
{
    ...
    proxy_->VerifyCertForSignedExchange(std::move(certificate), std::move(url), std::move(ocsp_response), std::move(sct_list),
        base::BindOnce(
            [](base::RunLoop* loop, int32_t* out_error_code, ::net::CertVerifyResult* out_cv_result, bool* out_pkp_bypassed, int32_t error_code,
                const ::net::CertVerifyResult& cv_result, bool pkp_bypassed) {
...
void NetworkContextAsyncWaiter::AddHSTS(const std::string& host, ::base::Time expiry, bool include_subdomains)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::IsHSTSActiveForHost(const std::string& host, bool* out_result)
{
    base::RunLoop loop;
...
bool NetworkContextAsyncWaiter::IsHSTSActiveForHost(const std::string& host)
{
    bool async_wait_result;
...
void NetworkContextAsyncWaiter::GetHSTSState(const std::string& domain, ::base::Value::Dict* out_state)
{
    base::RunLoop loop;
...
::base::Value::Dict NetworkContextAsyncWaiter::GetHSTSState(const std::string& domain)
{
...
void NetworkContextAsyncWaiter::SetCorsOriginAccessListsForOrigin(const ::url::Origin& source_origin,
    std::vector<::network::mojom::CorsOriginPatternPtr> allow_patterns, std::vector<::network::mojom::CorsOriginPatternPtr> block_patterns)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::DeleteDynamicDataForHost(const std::string& host, bool* out_result)
{
    base::RunLoop loop;
...
bool NetworkContextAsyncWaiter::DeleteDynamicDataForHost(const std::string& host)
{
    bool async_wait_result;
...
void NetworkContextAsyncWaiter::VerifyCertificateForTesting(const ::scoped_refptr<::net::X509Certificate>& certificate, const std::string& hostname,
    const std::string& ocsp_response, const std::string& sct_list, int32_t* out_error_code)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::AddDomainReliabilityContextForTesting(const ::url::Origin& origin, const ::GURL& upload_url)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::GetSharedDictionaryUsageInfo(std::vector<::net::SharedDictionaryUsageInfo>* out_usage_info)
{
    base::RunLoop loop;
    proxy_->GetSharedDictionaryUsageInfo(base::BindOnce(
        [](base::RunLoop* loop, std::vector<::net::SharedDictionaryUsageInfo>* out_usage_info,
...
std::vector<::net::SharedDictionaryUsageInfo> NetworkContextAsyncWaiter::GetSharedDictionaryUsageInfo()
{
    std::vector<::net::SharedDictionaryUsageInfo> async_wait_result;
    ...
    const ::net::SharedDictionaryIsolationKey& isolation_key, std::vector<SharedDictionaryInfoPtr>* out_dictionaries)
{
    ...
    proxy_->GetSharedDictionaryInfo(std::move(isolation_key),
        base::BindOnce(
            [](base::RunLoop* loop, std::vector<SharedDictionaryInfoPtr>* out_dictionaries, std::vector<SharedDictionaryInfoPtr> dictionaries) {
...
std::vector<SharedDictionaryInfoPtr> NetworkContextAsyncWaiter::GetSharedDictionaryInfo(const ::net::SharedDictionaryIsolationKey& isolation_key)
{
    std::vector<SharedDictionaryInfoPtr> async_wait_result;
    GetSharedDictionaryInfo(std::move(isolation_key), &async_wait_result);
    return async_wait_result;
}

void NetworkContextAsyncWaiter::GetSharedDictionaryOriginsBetween(::base::Time start_time, ::base::Time end_time, std::vector<::url::Origin>* out_origins)
{
    base::RunLoop loop;
...
std::vector<::url::Origin> NetworkContextAsyncWaiter::GetSharedDictionaryOriginsBetween(::base::Time start_time, ::base::Time end_time)
{
...
void NetworkContextAsyncWaiter::RevokeNetworkForNonces(const std::vector<::base::UnguessableToken>& nonces)
{
    base::RunLoop loop;
...
void NetworkContextAsyncWaiter::ExemptUrlFromNetworkRevocationForNonce(const ::GURL& exempted_url, const ::base::UnguessableToken& nonce)
{
    base::RunLoop loop;
