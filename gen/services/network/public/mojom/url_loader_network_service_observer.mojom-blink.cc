...
LoadInfo::LoadInfo(::base::TimeTicks timestamp_in, const WTF::String& host_in, uint32_t load_state_in, const ::WTF::String& state_param_in,
...
void ClientCertificateResponderProxy::ContinueWithCertificate(::network::mojom::blink::X509CertificatePtr in_x509_certificate,
    const WTF::String& in_provider_name, const WTF::Vector<uint16_t>& in_algorithm_preferences, ::mojo::PendingRemote<SSLPrivateKey> in_ssl_private_key)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ClientCertificateResponder::ContinueWithCertificate", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("x509_certificate"), in_x509_certificate, "<value of type ::network::mojom::blink::X509CertificatePtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("provider_name"), in_provider_name, "<value of type const WTF::String&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("algorithm_preferences"), in_algorithm_preferences, "<value of type const WTF::Vector<uint16_t>&>");
    ...
    ::network::mojom::blink::SSLCertRequestInfoPtr in_cert_info, ::mojo::PendingRemote<ClientCertificateResponder> in_cert_responder)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnCertificateRequested", "input_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("cert_info"), in_cert_info, "<value of type ::network::mojom::blink::SSLCertRequestInfoPtr>");
            perfetto::WriteIntoTracedValueWithFallback(
...
void URLLoaderNetworkServiceObserverProxy::OnAuthRequired(const std::optional<::base::UnguessableToken>& in_window_id, int32_t in_request_id,
    const ::blink::KURL& in_url, bool in_first_auth_attempt, const ::net::AuthChallengeInfo& in_auth_info,
    ::network::mojom::blink::HttpResponseHeadersPtr in_head_headers, ::mojo::PendingRemote<AuthChallengeResponder> in_auth_challenge_responder)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnAuthRequired", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("head_headers"), in_head_headers, "<value of type ::network::mojom::blink::HttpResponseHeadersPtr>");
        perfetto::WriteIntoTracedValueWithFallback(
...
void URLLoaderNetworkServiceObserverProxy::OnPrivateNetworkAccessPermissionRequired(const ::blink::KURL& in_url, const ::net::IPAddress& in_ip_address,
    const WTF::String& in_private_network_device_id, const WTF::String& in_private_network_device_name,
    OnPrivateNetworkAccessPermissionRequiredCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnPrivateNetworkAccessPermissionRequired", "input_parameters",
        [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("private_network_device_id"), in_private_network_device_id, "<value of type const WTF::String&>");
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("private_network_device_name"), in_private_network_device_name, "<value of type const WTF::String&>");
        });
#endif
...
void URLLoaderNetworkServiceObserverProxy::OnClearSiteData(const ::blink::KURL& in_url, const WTF::String& in_header_value, int32_t in_load_flags,
    ::network::mojom::blink::CookiePartitionKeyPtr in_cookie_partition_key, bool in_partitioned_state_allowed_only, OnClearSiteDataCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void URLLoaderNetworkServiceObserverProxy::OnSharedStorageHeaderReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& in_request_origin,
    WTF::Vector<SharedStorageOperationPtr> in_operations, OnSharedStorageHeaderReceivedCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
        "mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnSharedStorageHeaderReceived", "input_parameters", [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("request_origin"), in_request_origin, "<value of type const ::scoped_refptr<const ::blink::SecurityOrigin>&>");
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("operations"), in_operations, "<value of type WTF::Vector<SharedStorageOperationPtr>>");
        });
#endif
...
void URLLoaderNetworkServiceObserverProxy::OnWebSocketConnectedToPrivateNetwork(::network::mojom::blink::IPAddressSpace in_ip_address_space)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnWebSocketConnectedToPrivateNetwork", "input_parameters",
        [&](perfetto::TracedValue context) {
            auto dict = std::move(context).WriteDictionary();
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("ip_address_space"), in_ip_address_space, "<value of type ::network::mojom::blink::IPAddressSpace>");
        });
#endif
...
bool StructTraits<::network::mojom::blink::SharedStorageOperation::DataView, ::network::mojom::blink::SharedStorageOperationPtr>::Read(
    ::network::mojom::blink::SharedStorageOperation::DataView input, ::network::mojom::blink::SharedStorageOperationPtr* output)
{
    bool success = true;
...
void ClientCertificateResponderInterceptorForTesting::ContinueWithCertificate(::network::mojom::blink::X509CertificatePtr x509_certificate,
    const WTF::String& provider_name, const WTF::Vector<uint16_t>& algorithm_preferences, ::mojo::PendingRemote<SSLPrivateKey> ssl_private_key)
{
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnAuthRequired(const std::optional<::base::UnguessableToken>& window_id, int32_t request_id,
    const ::blink::KURL& url, bool first_auth_attempt, const ::net::AuthChallengeInfo& auth_info, ::network::mojom::blink::HttpResponseHeadersPtr head_headers,
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnPrivateNetworkAccessPermissionRequired(const ::blink::KURL& url,
    const ::net::IPAddress& ip_address, const WTF::String& private_network_device_id, const WTF::String& private_network_device_name,
    OnPrivateNetworkAccessPermissionRequiredCallback callback)
{
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnSharedStorageHeaderReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& request_origin,
...
void URLLoaderNetworkServiceObserverAsyncWaiter::OnPrivateNetworkAccessPermissionRequired(const ::blink::KURL& url, const ::net::IPAddress& ip_address,
    const WTF::String& private_network_device_id, const WTF::String& private_network_device_name, bool* out_permission_granted)
{
    base::RunLoop loop;
...
void URLLoaderNetworkServiceObserverAsyncWaiter::OnClearSiteData(const ::blink::KURL& url, const WTF::String& header_value, int32_t load_flags,
