...
class BLINK_PLATFORM_EXPORT P2PSocketManagerInterceptorForTesting : public P2PSocketManager {
    ...
    void GetHostAddressWithFamily(const WTF::String& host_name, int32_t address_family, bool enable_mdns, GetHostAddressWithFamilyCallback callback) override;
...
public:
    ...
    void GetHostAddress(const WTF::String& host_name, bool enable_mdns, WTF::Vector<::net::IPAddress>* out_addresses);
    WTF::Vector<::net::IPAddress> GetHostAddress(const WTF::String& host_name, bool enable_mdns);
    void GetHostAddressWithFamily(const WTF::String& host_name, int32_t address_family, bool enable_mdns, WTF::Vector<::net::IPAddress>* out_addresses);
    WTF::Vector<::net::IPAddress> GetHostAddressWithFamily(const WTF::String& host_name, int32_t address_family, bool enable_mdns);
...
class BLINK_PLATFORM_EXPORT P2PSocketInterceptorForTesting : public P2PSocket {
    ...
    void SendBatch(WTF::Vector<P2PSendPacketPtr> packet_batch) override;
...
class BLINK_PLATFORM_EXPORT P2PSocketClientInterceptorForTesting : public P2PSocketClient {
    ...
    void SendBatchComplete(const WTF::Vector<::network::P2PSendPacketMetrics>& send_metrics_batch) override;
