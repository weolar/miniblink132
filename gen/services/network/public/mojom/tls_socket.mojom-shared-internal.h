...
static_assert(sizeof(TLSClientSocketOptions_Data) == 24, "Bad sizeof(TLSClientSocketOptions_Data)");
// Used by TLSClientSocketOptions::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct TLSClientSocketOptions_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    TLSClientSocketOptions_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag TLSClientSocketOptions_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
