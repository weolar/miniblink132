...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::HashMap<::content_settings::mojom::blink::ContentSettingsType, "
        "WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr>>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
CookieSameSiteContextMetadata::CookieSameSiteContextMetadata(CookieSameSiteContextMetadataDowngradeType cross_site_redirect_downgrade_in,
...
size_t CookieSameSiteContextMetadata::Hash(size_t seed) const
{
    ...
    seed = mojo::internal::WTFHash(seed, this->http_method_bug_1221316);
    return seed;
}
...
CookieSameSiteContext::CookieSameSiteContext(ContextType context_in, ContextType schemeful_context_in, CookieSameSiteContextMetadataPtr metadata_in,
...
CanonicalCookie::CanonicalCookie(const WTF::String& name_in, const WTF::String& value_in, const WTF::String& domain_in, const WTF::String& path_in,
...
CookieOrLineWithAccessResult::CookieOrLineWithAccessResult(CookieOrLinePtr cookie_or_line_in, CookieAccessResultPtr access_result_in)
...
CookieAccessResult::CookieAccessResult(CookieEffectiveSameSite effective_same_site_in, CookieAccessSemantics access_semantics_in,
...
CookieWithAccessResult::CookieWithAccessResult(const ::net::CanonicalCookie& cookie_in, CookieAccessResultPtr access_result_in)
    : cookie(std::move(cookie_in))
    , access_result(std::move(access_result_in))
{
}
...
CookieChangeInfo::CookieChangeInfo(const ::net::CanonicalCookie& cookie_in, CookieAccessResultPtr access_result_in, CookieChangeCause cause_in)
    : cookie(std::move(cookie_in))
    , access_result(std::move(access_result_in))
...
void CookieOrLine::set_cookie_string(const WTF::String& cookie_string)
{
    if (tag_ == Tag::kCookieString) {
        *(data_.cookie_string) = std::move(cookie_string);
        ...
        data_.cookie_string = new WTF::String(std::move(cookie_string));
    }
}
...
void CookieChangeListenerProxy::OnCookieChange(CookieChangeInfoPtr in_change)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieChangeListener::OnCookieChange", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("change"), in_change, "<value of type CookieChangeInfoPtr>");
    });
#endif
...
void CookieManagerProxy::GetCookieList(const ::blink::KURL& in_url, CookieOptionsPtr in_cookie_options,
    ::network::mojom::blink::CookiePartitionKeyCollectionPtr in_cookie_partition_key_collection, GetCookieListCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::GetCookieList", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cookie_options"), in_cookie_options, "<value of type CookieOptionsPtr>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cookie_partition_key_collection"), in_cookie_partition_key_collection,
            "<value of type ::network::mojom::blink::CookiePartitionKeyCollectionPtr>");
    });
#endif
...
void CookieManagerProxy::SetContentSettings(::content_settings::mojom::blink::ContentSettingsType in_content_settings_type,
    WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr> in_settings, SetContentSettingsCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieManager::SetContentSettings", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("content_settings_type"), in_content_settings_type, "<value of type ::content_settings::mojom::blink::ContentSettingsType>");
        perfetto::WriteIntoTracedValueWithFallback(
...
private:
    ...
    void Run(const WTF::Vector<::net::CanonicalCookie>& in_cookies);
};
...
void CookieManager_GetAllCookies_ProxyToResponder::Run(const WTF::Vector<::net::CanonicalCookie>& in_cookies)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieManager::GetAllCookies", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cookies"), in_cookies, "<value of type const WTF::Vector<::net::CanonicalCookie>&>");
    });
#endif
...
private:
    ...
    void Run(const WTF::Vector<::net::CanonicalCookie>& in_cookies, const WTF::Vector<CookieAccessSemantics>& in_access_semantics_list);
};
    ...
    const WTF::Vector<::net::CanonicalCookie>& in_cookies, const WTF::Vector<CookieAccessSemantics>& in_access_semantics_list)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send reply network::mojom::CookieManager::GetAllCookiesWithAccessSemantics", "async_response_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cookies"), in_cookies, "<value of type const WTF::Vector<::net::CanonicalCookie>&>");
            perfetto::WriteIntoTracedValueWithFallback(
                dict.AddItem("access_semantics_list"), in_access_semantics_list, "<value of type const WTF::Vector<CookieAccessSemantics>&>");
        });
#endif
...
private:
    ...
    void Run(WTF::Vector<CookieWithAccessResultPtr> in_cookies, WTF::Vector<CookieWithAccessResultPtr> in_excluded_cookies);
};
    ...
    WTF::Vector<CookieWithAccessResultPtr> in_cookies, WTF::Vector<CookieWithAccessResultPtr> in_excluded_cookies)
{
    ...
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieManager::GetCookieList", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("cookies"), in_cookies, "<value of type WTF::Vector<CookieWithAccessResultPtr>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("excluded_cookies"), in_excluded_cookies, "<value of type WTF::Vector<CookieWithAccessResultPtr>>");
    });
#endif
...
private:
    ...
    void Run(CookieAccessResultPtr in_access_result);
};
...
void CookieManager_SetCanonicalCookie_ProxyToResponder::Run(CookieAccessResultPtr in_access_result)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieManager::SetCanonicalCookie", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("access_result"), in_access_result, "<value of type CookieAccessResultPtr>");
    });
#endif
...
bool StructTraits<::network::mojom::blink::CookieManagerParams::DataView, ::network::mojom::blink::CookieManagerParamsPtr>::Read(
    ::network::mojom::blink::CookieManagerParams::DataView input, ::network::mojom::blink::CookieManagerParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieSameSiteContextMetadata::DataView, ::network::mojom::blink::CookieSameSiteContextMetadataPtr>::Read(
    ::network::mojom::blink::CookieSameSiteContextMetadata::DataView input, ::network::mojom::blink::CookieSameSiteContextMetadataPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieSameSiteContext::DataView, ::network::mojom::blink::CookieSameSiteContextPtr>::Read(
    ::network::mojom::blink::CookieSameSiteContext::DataView input, ::network::mojom::blink::CookieSameSiteContextPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieOptions::DataView, ::network::mojom::blink::CookieOptionsPtr>::Read(
    ::network::mojom::blink::CookieOptions::DataView input, ::network::mojom::blink::CookieOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CanonicalCookie::DataView, ::network::mojom::blink::CanonicalCookiePtr>::Read(
    ::network::mojom::blink::CanonicalCookie::DataView input, ::network::mojom::blink::CanonicalCookiePtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieInclusionStatus::DataView, ::network::mojom::blink::CookieInclusionStatusPtr>::Read(
    ::network::mojom::blink::CookieInclusionStatus::DataView input, ::network::mojom::blink::CookieInclusionStatusPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieAndLineWithAccessResult::DataView, ::network::mojom::blink::CookieAndLineWithAccessResultPtr>::Read(
    ::network::mojom::blink::CookieAndLineWithAccessResult::DataView input, ::network::mojom::blink::CookieAndLineWithAccessResultPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieOrLineWithAccessResult::DataView, ::network::mojom::blink::CookieOrLineWithAccessResultPtr>::Read(
    ::network::mojom::blink::CookieOrLineWithAccessResult::DataView input, ::network::mojom::blink::CookieOrLineWithAccessResultPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieAccessResult::DataView, ::network::mojom::blink::CookieAccessResultPtr>::Read(
    ::network::mojom::blink::CookieAccessResult::DataView input, ::network::mojom::blink::CookieAccessResultPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieWithAccessResult::DataView, ::network::mojom::blink::CookieWithAccessResultPtr>::Read(
    ::network::mojom::blink::CookieWithAccessResult::DataView input, ::network::mojom::blink::CookieWithAccessResultPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieChangeInfo::DataView, ::network::mojom::blink::CookieChangeInfoPtr>::Read(
    ::network::mojom::blink::CookieChangeInfo::DataView input, ::network::mojom::blink::CookieChangeInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CookieDeletionFilter::DataView, ::network::mojom::blink::CookieDeletionFilterPtr>::Read(
    ::network::mojom::blink::CookieDeletionFilter::DataView input, ::network::mojom::blink::CookieDeletionFilterPtr* output)
{
    bool success = true;
...
bool UnionTraits<::network::mojom::blink::CookieOrLine::DataView, ::network::mojom::blink::CookieOrLinePtr>::Read(
    ::network::mojom::blink::CookieOrLine::DataView input, ::network::mojom::blink::CookieOrLinePtr* output)
{
...
void CookieManagerInterceptorForTesting::GetCookieList(const ::blink::KURL& url, CookieOptionsPtr cookie_options,
...
void CookieManagerInterceptorForTesting::AddCookieChangeListener(
    const ::blink::KURL& url, const WTF::String& name, ::mojo::PendingRemote<CookieChangeListener> listener)
{
...
void CookieManagerInterceptorForTesting::SetContentSettings(::content_settings::mojom::blink::ContentSettingsType content_settings_type,
...
void CookieManagerAsyncWaiter::GetAllCookies(WTF::Vector<::net::CanonicalCookie>* out_cookies)
{
    base::RunLoop loop;
    proxy_->GetAllCookies(base::BindOnce(
        [](base::RunLoop* loop, WTF::Vector<::net::CanonicalCookie>* out_cookies, const WTF::Vector<::net::CanonicalCookie>& cookies) {
...
{
    WTF::Vector<::net::CanonicalCookie> async_wait_result;
    ...
    WTF::Vector<::net::CanonicalCookie>* out_cookies, WTF::Vector<CookieAccessSemantics>* out_access_semantics_list)
{
    ...
    proxy_->GetAllCookiesWithAccessSemantics(base::BindOnce(
        [](base::RunLoop* loop, WTF::Vector<::net::CanonicalCookie>* out_cookies, WTF::Vector<CookieAccessSemantics>* out_access_semantics_list,
            const WTF::Vector<::net::CanonicalCookie>& cookies, const WTF::Vector<CookieAccessSemantics>& access_semantics_list) {
            *out_cookies = std::move(cookies);
...
void CookieManagerAsyncWaiter::GetCookieList(const ::blink::KURL& url, CookieOptionsPtr cookie_options,
    ...
    WTF::Vector<CookieWithAccessResultPtr>* out_excluded_cookies)
{
    ...
    proxy_->GetCookieList(std::move(url), std::move(cookie_options), std::move(cookie_partition_key_collection),
        base::BindOnce(
            [](base::RunLoop* loop, WTF::Vector<CookieWithAccessResultPtr>* out_cookies, WTF::Vector<CookieWithAccessResultPtr>* out_excluded_cookies,
                WTF::Vector<CookieWithAccessResultPtr> cookies, WTF::Vector<CookieWithAccessResultPtr> excluded_cookies) {
                *out_cookies = std::move(cookies);
    ...
    const ::net::CanonicalCookie& cookie, const ::blink::KURL& source_url, CookieOptionsPtr cookie_options, CookieAccessResultPtr* out_access_result)
{
    ...
    proxy_->SetCanonicalCookie(std::move(cookie), std::move(source_url), std::move(cookie_options),
        base::BindOnce(
            [](base::RunLoop* loop, CookieAccessResultPtr* out_access_result, CookieAccessResultPtr access_result) {
...
void CookieManagerAsyncWaiter::SetContentSettings(::content_settings::mojom::blink::ContentSettingsType content_settings_type,
