    ...
    , document_isolation_policy()
{
    ...
    {
        return mojo::internal::SerializeImpl<ClientSecurityState::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::network::mojom::ClientSecurityState::DataView, ::network::mojom::ClientSecurityStatePtr> {
    static bool IsNull(const ::network::mojom::ClientSecurityStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::ClientSecurityStatePtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::network::mojom::ClientSecurityState::is_web_secure_context) is_web_secure_context(const ::network::mojom::ClientSecurityStatePtr& input)
    {
        return input->is_web_secure_context;
    }

    static decltype(::network::mojom::ClientSecurityState::ip_address_space) ip_address_space(const ::network::mojom::ClientSecurityStatePtr& input)
    {
