...
CertWithConstraints::CertWithConstraints(
    std::vector<uint8_t> certificate_in, std::vector<std::string> permitted_dns_names_in, std::vector<CIDRPtr> permitted_cidrs_in)
...
AdditionalCertificates::AdditionalCertificates(std::vector<std::vector<uint8_t>> all_certificates_in, std::vector<std::vector<uint8_t>> trust_anchors_in,
    std::vector<std::vector<uint8_t>> trust_anchors_with_enforced_constraints_in,
    std::vector<CertWithConstraintsPtr> trust_anchors_with_additional_constraints_in, std::vector<CertWithConstraintsPtr> trust_anchors_and_leafs_in,
    std::vector<CertWithConstraintsPtr> trust_leafs_in, std::vector<std::vector<uint8_t>> distrusted_spkis_in, bool include_system_trust_store_in)
...
{
    const char* name = ::cert_verifier::mojom::CertVerifierServiceUpdater::Name_;
...
bool StructTraits<::cert_verifier::mojom::CIDR::DataView, ::cert_verifier::mojom::CIDRPtr>::Read(
    ::cert_verifier::mojom::CIDR::DataView input, ::cert_verifier::mojom::CIDRPtr* output)
{
    bool success = true;
...
bool StructTraits<::cert_verifier::mojom::CertWithConstraints::DataView, ::cert_verifier::mojom::CertWithConstraintsPtr>::Read(
    ::cert_verifier::mojom::CertWithConstraints::DataView input, ::cert_verifier::mojom::CertWithConstraintsPtr* output)
{
    bool success = true;
...
bool StructTraits<::cert_verifier::mojom::AdditionalCertificates::DataView, ::cert_verifier::mojom::AdditionalCertificatesPtr>::Read(
    ::cert_verifier::mojom::AdditionalCertificates::DataView input, ::cert_verifier::mojom::AdditionalCertificatesPtr* output)
{
    bool success = true;
