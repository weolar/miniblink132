...
BlockedByResponseReasonWrapper::BlockedByResponseReasonWrapper(::network::mojom::BlockedByResponseReason reason_in)
...
bool StructTraits<::network::mojom::BlockedByResponseReasonWrapper::DataView, ::network::mojom::BlockedByResponseReasonWrapperPtr>::Read(
    ::network::mojom::BlockedByResponseReasonWrapper::DataView input, ::network::mojom::BlockedByResponseReasonWrapperPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::URLLoaderCompletionStatus::DataView, ::network::mojom::URLLoaderCompletionStatusPtr>::Read(
    ::network::mojom::URLLoaderCompletionStatus::DataView input, ::network::mojom::URLLoaderCompletionStatusPtr* output)
{
    bool success = true;
