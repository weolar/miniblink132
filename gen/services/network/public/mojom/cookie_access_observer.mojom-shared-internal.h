...
static_assert(sizeof(CookieAccessDetails_Data) == 64, "Bad sizeof(CookieAccessDetails_Data)");
// Used by CookieAccessDetails::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct CookieAccessDetails_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    CookieAccessDetails_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag CookieAccessDetails_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
