    ...
    , load_with_storage_access(false)
{
    ...
    {
        return mojo::internal::SerializeImpl<URLResponseHead::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::network::mojom::URLResponseHead::DataView, ::network::mojom::URLResponseHeadPtr> {
    static bool IsNull(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::URLResponseHeadPtr* output)
    {
        output->reset();
    }

    static const decltype(::network::mojom::URLResponseHead::request_time)& request_time(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->request_time;
    }

    static const decltype(::network::mojom::URLResponseHead::response_time)& response_time(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->response_time;
    }

    static const decltype(::network::mojom::URLResponseHead::original_response_time)& original_response_time(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->original_response_time;
    }

    static const decltype(::network::mojom::URLResponseHead::headers)& headers(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->headers;
    }

    static const decltype(::network::mojom::URLResponseHead::mime_type)& mime_type(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->mime_type;
    }

    static const decltype(::network::mojom::URLResponseHead::charset)& charset(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->charset;
    }

    static decltype(::network::mojom::URLResponseHead::content_length) content_length(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->content_length;
    }

    static decltype(::network::mojom::URLResponseHead::encoded_data_length) encoded_data_length(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->encoded_data_length;
    }

    static const decltype(::network::mojom::URLResponseHead::encoded_body_length)& encoded_body_length(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->encoded_body_length;
    }

    static decltype(::network::mojom::URLResponseHead::network_accessed) network_accessed(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->network_accessed;
    }

    static const decltype(::network::mojom::URLResponseHead::load_timing)& load_timing(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->load_timing;
    }

    static decltype(::network::mojom::URLResponseHead::emitted_extra_info) emitted_extra_info(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->emitted_extra_info;
    }

    static decltype(::network::mojom::URLResponseHead::was_fetched_via_spdy) was_fetched_via_spdy(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->was_fetched_via_spdy;
    }

    static decltype(::network::mojom::URLResponseHead::was_alpn_negotiated) was_alpn_negotiated(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::connection_info) connection_info(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::alternate_protocol_usage) alternate_protocol_usage(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->alternate_protocol_usage;
    }

    static const decltype(::network::mojom::URLResponseHead::remote_endpoint)& remote_endpoint(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->remote_endpoint;
    }

    static decltype(::network::mojom::URLResponseHead::client_address_space) client_address_space(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->client_address_space;
    }

    static decltype(::network::mojom::URLResponseHead::response_address_space) response_address_space(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->response_address_space;
    }

    static decltype(::network::mojom::URLResponseHead::is_validated) is_validated(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->is_validated;
    }

    static decltype(::network::mojom::URLResponseHead::was_fetched_via_cache) was_fetched_via_cache(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->was_fetched_via_cache;
    }

    static decltype(::network::mojom::URLResponseHead::navigation_delivery_type) navigation_delivery_type(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->navigation_delivery_type;
    }

    static const decltype(::network::mojom::URLResponseHead::proxy_chain)& proxy_chain(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::response_type) response_type(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->response_type;
    }

    static decltype(::network::mojom::URLResponseHead::padding) padding(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::cert_status) cert_status(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->cert_status;
    }

    static const decltype(::network::mojom::URLResponseHead::ssl_info)& ssl_info(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->ssl_info;
    }

    static const decltype(::network::mojom::URLResponseHead::request_cookies)& request_cookies(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::did_mime_sniff) did_mime_sniff(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::was_in_prefetch_cache) was_in_prefetch_cache(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::was_cookie_in_request) was_cookie_in_request(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->was_cookie_in_request;
    }

    static decltype(::network::mojom::URLResponseHead::intercepted_by_plugin) intercepted_by_plugin(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->intercepted_by_plugin;
    }

    static decltype(::network::mojom::URLResponseHead::has_range_requested) has_range_requested(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->has_range_requested;
    }

    static decltype(::network::mojom::URLResponseHead::timing_allow_passed) timing_allow_passed(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->timing_allow_passed;
    }

    static const decltype(::network::mojom::URLResponseHead::auth_challenge_info)& auth_challenge_info(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->auth_challenge_info;
    }

    static const decltype(::network::mojom::URLResponseHead::request_start)& request_start(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->request_start;
    }

    static const decltype(::network::mojom::URLResponseHead::response_start)& response_start(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->response_start;
    }

    static const decltype(::network::mojom::URLResponseHead::parsed_headers)& parsed_headers(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static const decltype(::network::mojom::URLResponseHead::dns_aliases)& dns_aliases(const ::network::mojom::URLResponseHeadPtr& input)
    {
    ...
    static decltype(::network::mojom::URLResponseHead::did_use_shared_dictionary) did_use_shared_dictionary(const ::network::mojom::URLResponseHeadPtr& input)
    {
        return input->did_use_shared_dictionary;
    }

    static decltype(::network::mojom::URLResponseHead::load_with_storage_access) load_with_storage_access(const ::network::mojom::URLResponseHeadPtr& input)
    {
