...
CookieAccessDetails::CookieAccessDetails(CookieAccessDetails::Type type_in, const ::blink::KURL& url_in,
...
void CookieAccessObserverProxy::OnCookiesAccessed(WTF::Vector<CookieAccessDetailsPtr> in_details)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::CookieAccessObserver::OnCookiesAccessed", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("details"), in_details, "<value of type WTF::Vector<CookieAccessDetailsPtr>>");
    });
#endif
...
bool StructTraits<::network::mojom::blink::CookieAccessDetails::DataView, ::network::mojom::blink::CookieAccessDetailsPtr>::Read(
    ::network::mojom::blink::CookieAccessDetails::DataView input, ::network::mojom::blink::CookieAccessDetailsPtr* output)
{
    bool success = true;
