...
ReportingApiReport::ReportingApiReport(const ::base::UnguessableToken& id_in, const ::blink::KURL& url_in, const WTF::String& group_in,
...
ReportingApiEndpoint::ReportingApiEndpoint(const ::blink::KURL& url_in, int32_t attempted_uploads_in, int32_t successful_uploads_in,
...
void ReportingApiObserverProxy::OnReportAdded(ReportingApiReportPtr in_report)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ReportingApiObserver::OnReportAdded", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("report"), in_report, "<value of type ReportingApiReportPtr>");
    });
#endif
...
void ReportingApiObserverProxy::OnReportUpdated(ReportingApiReportPtr in_report)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ReportingApiObserverProxy::OnEndpointsUpdatedForOrigin(WTF::Vector<ReportingApiEndpointPtr> in_endpoints)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ReportingApiObserver::OnEndpointsUpdatedForOrigin", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("endpoints"), in_endpoints, "<value of type WTF::Vector<ReportingApiEndpointPtr>>");
    });
#endif
...
bool StructTraits<::network::mojom::blink::ReportingApiReport::DataView, ::network::mojom::blink::ReportingApiReportPtr>::Read(
    ::network::mojom::blink::ReportingApiReport::DataView input, ::network::mojom::blink::ReportingApiReportPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::ReportingApiEndpoint::DataView, ::network::mojom::blink::ReportingApiEndpointPtr>::Read(
    ::network::mojom::blink::ReportingApiEndpoint::DataView input, ::network::mojom::blink::ReportingApiEndpointPtr* output)
{
    bool success = true;
