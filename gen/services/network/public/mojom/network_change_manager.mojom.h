...
class NetworkChangeManagerClient : public NetworkChangeManagerClientInterfaceBase {
public:
...
class NetworkChangeManager : public NetworkChangeManagerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class NetworkChangeManagerClientProxy : public NetworkChangeManagerClient {
public:
...
class NetworkChangeManagerProxy : public NetworkChangeManager {
public:
