...
void URLLoaderProxy::FollowRedirect(const std::vector<std::string>& in_removed_headers, const ::net::HttpRequestHeaders& in_modified_headers,
    const ::net::HttpRequestHeaders& in_modified_cors_exempt_headers, const std::optional<::GURL>& in_new_url)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoader::FollowRedirect", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("removed_headers"), in_removed_headers, "<value of type const std::vector<std::string>&>");
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("new_url"), in_new_url, "<value of type const std::optional<::GURL>&>");
    });
#endif
...
void URLLoaderClientProxy::OnReceiveEarlyHints(::network::mojom::EarlyHintsPtr in_early_hints)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::URLLoaderClient::OnReceiveEarlyHints", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("early_hints"), in_early_hints, "<value of type ::network::mojom::EarlyHintsPtr>");
    });
#endif
...
void URLLoaderClientProxy::OnReceiveRedirect(const ::net::RedirectInfo& in_redirect_info, ::network::mojom::URLResponseHeadPtr in_head)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::network::mojom::URLLoaderClientEndpoints::DataView, ::network::mojom::URLLoaderClientEndpointsPtr>::Read(
    ::network::mojom::URLLoaderClientEndpoints::DataView input, ::network::mojom::URLLoaderClientEndpointsPtr* output)
{
    bool success = true;
...
void URLLoaderInterceptorForTesting::FollowRedirect(const std::vector<std::string>& removed_headers, const ::net::HttpRequestHeaders& modified_headers,
