...
class BLINK_PLATFORM_EXPORT URLLoaderFactory : public URLLoaderFactoryInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t request_id, uint32_t options,
    ...
    virtual void CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t request_id, uint32_t options,
        ::network::ResourceRequest& request, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client,
        const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation)
    {
...
//class BLINK_PLATFORM_EXPORT URLLoaderFactoryProxy : public URLLoaderFactory {
//public:
