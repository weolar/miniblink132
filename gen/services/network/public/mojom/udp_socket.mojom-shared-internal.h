...
static_assert(sizeof(UDPSocketOptions_Data) == 32, "Bad sizeof(UDPSocketOptions_Data)");
// Used by UDPSocketOptions::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct UDPSocketOptions_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    UDPSocketOptions_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag UDPSocketOptions_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
