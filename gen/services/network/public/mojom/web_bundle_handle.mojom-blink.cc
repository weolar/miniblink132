...
uint32_t WebBundleHandle::Clone_Sym::IPCStableHash()
{
    ...
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)network::mojom::WebBundleHandle::Clone");
...
uint32_t WebBundleHandle::OnWebBundleError_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)network::mojom::WebBundleHandle::OnWebBundleError");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
uint32_t WebBundleHandle::OnWebBundleLoadFinished_Sym::IPCStableHash()
{
    ...
    // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
    // hash instead of __LINE__.
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)network::mojom::WebBundleHandle::OnWebBundleLoadFinished");
    const uint32_t hash = kHash;
    base::debug::Alias(&hash);
    return hash;
}
...
void WebBundleHandleProxy::Clone(::mojo::PendingReceiver<WebBundleHandle> in_receiver)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::WebBundleHandle::Clone", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<WebBundleHandle>>");
    });
#endif
    ...
    mojo::Message message(base::to_underlying(messages::WebBundleHandle::kClone), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::network::mojom::internal::WebBundleHandle_Clone_Params_Data> params(message);
    params.Allocate();
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->receiver),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE, "invalid receiver in WebBundleHandle.Clone request");
...
void WebBundleHandleProxy::OnWebBundleError(WebBundleErrorType in_type, const WTF::String& in_message)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::WebBundleHandle::OnWebBundleError", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("type"), in_type, "<value of type WebBundleErrorType>");
    ...
    const size_t estimated_payload_size = 0;
    mojo::Message message(base::to_underlying(messages::WebBundleHandle::kOnWebBundleError), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::network::mojom::internal::WebBundleHandle_OnWebBundleError_Params_Data> params(message);
    params.Allocate();
    mojo::internal::Serialize<::network::mojom::WebBundleErrorType>(in_type, &params->type);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        params->message.is_null(), mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER, "null message in WebBundleHandle.OnWebBundleError request");
...
void WebBundleHandleProxy::OnWebBundleLoadFinished(bool in_success)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::WebBundleHandle::OnWebBundleLoadFinished", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
    ...
    const size_t estimated_payload_size = 0;
    mojo::Message message(base::to_underlying(messages::WebBundleHandle::kOnWebBundleLoadFinished), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::network::mojom::internal::WebBundleHandle_OnWebBundleLoadFinished_Params_Data> params(message);
    params.Allocate();
...
// static
bool WebBundleHandleStubDispatch::Accept(WebBundleHandle* impl, mojo::Message* message)
{
    switch (static_cast<messages::WebBundleHandle>(message->header()->name)) {
    case messages::WebBundleHandle::kClone: {
        DCHECK(message->is_serialized());
        internal::WebBundleHandle_Clone_Params_Data* params = reinterpret_cast<internal::WebBundleHandle_Clone_Params_Data*>(message->mutable_payload());
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, WebBundleHandle::Name_, 0, false);
            return false;
        }
    ...
    case messages::WebBundleHandle::kOnWebBundleError: {
        ...
        internal::WebBundleHandle_OnWebBundleError_Params_Data* params
            = reinterpret_cast<internal::WebBundleHandle_OnWebBundleError_Params_Data*>(message->mutable_payload());
        ...
        if (success && !input_data_view.ReadMessage(&p_message))
            success = false;
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, WebBundleHandle::Name_, 1, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->OnWebBundleError(std::move(p_type), std::move(p_message));
        return true;
    }
    case messages::WebBundleHandle::kOnWebBundleLoadFinished: {
        DCHECK(message->is_serialized());
        internal::WebBundleHandle_OnWebBundleLoadFinished_Params_Data* params
            = reinterpret_cast<internal::WebBundleHandle_OnWebBundleLoadFinished_Params_Data*>(message->mutable_payload());
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, WebBundleHandle::Name_, 2, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->OnWebBundleLoadFinished(std::move(p_success));
        return true;
    }
    }
    return false;
...
// static
bool WebBundleHandleStubDispatch::AcceptWithResponder(WebBundleHandle* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const mojo::internal::GenericValidationInfo kWebBundleHandleValidationInfo[] = {
    { &internal::WebBundleHandle_Clone_Params_Data::Validate, nullptr /* no response */ },
    { &internal::WebBundleHandle_OnWebBundleError_Params_Data::Validate, nullptr /* no response */ },
    { &internal::WebBundleHandle_OnWebBundleLoadFinished_Params_Data::Validate, nullptr /* no response */ },
};
...
WebBundleHandleAsyncWaiter::WebBundleHandleAsyncWaiter(WebBundleHandle* proxy)
    : proxy_(proxy)
{
}
