...
class BLINK_PLATFORM_EXPORT URLLoader : public URLLoaderInterfaceBase {
public:
...
// with not having this data in traces there.
    ...
    virtual void FollowRedirect(const WTF::Vector<WTF::String>& removed_headers, const ::net::HttpRequestHeaders& modified_headers,
...
class BLINK_PLATFORM_EXPORT URLLoaderClient : public URLLoaderClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_PLATFORM_EXPORT URLLoaderProxy : public URLLoader {
//public:
...
//        const ::net::HttpRequestHeaders& modified_cors_exempt_headers, const std::optional<::blink::KURL>& new_url) final;
//
...
//class BLINK_PLATFORM_EXPORT URLLoaderClientProxy : public URLLoaderClient {
//public:
...
//        std::optional<::mojo_base::BigBuffer> cached_metadata) final;
//
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLLoaderClientEndpoints::DataView, ::network::mojom::blink::URLLoaderClientEndpointsPtr> {
    static bool IsNull(const ::network::mojom::blink::URLLoaderClientEndpointsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::URLLoaderClientEndpointsPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::blink::URLLoaderClientEndpoints::url_loader)& url_loader(::network::mojom::blink::URLLoaderClientEndpointsPtr& input)
    {
