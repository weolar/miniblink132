...
CookiePartitionKeyCollection::CookiePartitionKeyCollection(bool contains_all_partitions_in, std::vector<::net::CookiePartitionKey> keys_in)
...
bool StructTraits<::network::mojom::CookiePartitionKey::DataView, ::network::mojom::CookiePartitionKeyPtr>::Read(
    ::network::mojom::CookiePartitionKey::DataView input, ::network::mojom::CookiePartitionKeyPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::CookiePartitionKeyCollection::DataView, ::network::mojom::CookiePartitionKeyCollectionPtr>::Read(
    ::network::mojom::CookiePartitionKeyCollection::DataView input, ::network::mojom::CookiePartitionKeyCollectionPtr* output)
{
    bool success = true;
