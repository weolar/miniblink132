...
// static
bool ChunkedDataPipeGetter_GetSize_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const ChunkedDataPipeGetter_GetSize_Params_Data* object = static_cast<const ChunkedDataPipeGetter_GetSize_Params_Data*>(data);
...
// static
bool ChunkedDataPipeGetter_GetSize_ResponseParams_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
...
// static
bool ChunkedDataPipeGetter_StartReading_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const ChunkedDataPipeGetter_StartReading_Params_Data* object = static_cast<const ChunkedDataPipeGetter_StartReading_Params_Data*>(data);
