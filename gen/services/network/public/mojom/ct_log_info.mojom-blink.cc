...
PreviousOperatorEntry::PreviousOperatorEntry(const WTF::String& name_in, ::base::Time end_time_in)
...
CTLogInfo::CTLogInfo(const std::string& id_in, const std::string& public_key_in, const WTF::String& name_in, std::optional<::base::Time> disqualified_at_in,
...
bool StructTraits<::network::mojom::blink::PreviousOperatorEntry::DataView, ::network::mojom::blink::PreviousOperatorEntryPtr>::Read(
    ::network::mojom::blink::PreviousOperatorEntry::DataView input, ::network::mojom::blink::PreviousOperatorEntryPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::CTLogInfo::DataView, ::network::mojom::blink::CTLogInfoPtr>::Read(
    ::network::mojom::blink::CTLogInfo::DataView input, ::network::mojom::blink::CTLogInfoPtr* output)
{
    bool success = true;
