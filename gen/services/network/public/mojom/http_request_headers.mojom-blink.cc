...
HttpRequestHeaderKeyValuePair::HttpRequestHeaderKeyValuePair(const WTF::String& key_in, const std::string& value_in)
    : key(std::move(key_in))
...
HttpRequestHeaders::HttpRequestHeaders(WTF::Vector<HttpRequestHeaderKeyValuePairPtr> headers_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<HttpRequestHeaderKeyValuePairPtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::network::mojom::blink::HttpRequestHeaderKeyValuePair::DataView, ::network::mojom::blink::HttpRequestHeaderKeyValuePairPtr>::Read(
    ::network::mojom::blink::HttpRequestHeaderKeyValuePair::DataView input, ::network::mojom::blink::HttpRequestHeaderKeyValuePairPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::HttpRequestHeaders::DataView, ::network::mojom::blink::HttpRequestHeadersPtr>::Read(
    ::network::mojom::blink::HttpRequestHeaders::DataView input, ::network::mojom::blink::HttpRequestHeadersPtr* output)
{
    bool success = true;
