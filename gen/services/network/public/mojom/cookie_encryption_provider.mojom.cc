...
private:
    ...
    void Run(::os_crypt_async::Encryptor in_encryptor);
};
...
void CookieEncryptionProvider_GetEncryptor_ProxyToResponder::Run(::os_crypt_async::Encryptor in_encryptor)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::CookieEncryptionProvider::GetEncryptor", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("encryptor"), in_encryptor, "<value of type ::os_crypt_async::Encryptor>");
    });
#endif
...
void CookieEncryptionProviderAsyncWaiter::GetEncryptor(::os_crypt_async::Encryptor* out_encryptor)
{
    base::RunLoop loop;
    proxy_->GetEncryptor(base::BindOnce(
        [](base::RunLoop* loop, ::os_crypt_async::Encryptor* out_encryptor, ::os_crypt_async::Encryptor encryptor) {
