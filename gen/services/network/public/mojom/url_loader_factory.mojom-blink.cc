...
void URLLoaderFactoryProxy::CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> in_loader, int32_t in_request_id,
    uint32_t in_options, const ::network::ResourceRequest& in_request, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> in_client,
...
void URLLoaderFactoryInterceptorForTesting::CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t request_id,
    uint32_t options, const ::network::ResourceRequest& request, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client,
