...
ParsedHeaders::ParsedHeaders(WTF::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policy_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const WTF::Vector<::network::mojom::blink::LoadingMode>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::network::mojom::blink::ParsedHeaders::DataView, ::network::mojom::blink::ParsedHeadersPtr>::Read(
    ::network::mojom::blink::ParsedHeaders::DataView input, ::network::mojom::blink::ParsedHeadersPtr* output)
{
    bool success = true;
