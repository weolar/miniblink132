...
DigitallySigned::DigitallySigned(::net::ct::DigitallySigned::HashAlgorithm hash_algorithm_in,
...
bool StructTraits<::network::mojom::DigitallySigned::DataView, ::network::mojom::DigitallySignedPtr>::Read(
    ::network::mojom::DigitallySigned::DataView input, ::network::mojom::DigitallySignedPtr* output)
{
    bool success = true;
