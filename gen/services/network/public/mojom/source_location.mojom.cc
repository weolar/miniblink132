...
SourceLocation::SourceLocation(const std::string& url_in, uint32_t line_in, uint32_t column_in)
    : url(std::move(url_in))
...
bool StructTraits<::network::mojom::SourceLocation::DataView, ::network::mojom::SourceLocationPtr>::Read(
    ::network::mojom::SourceLocation::DataView input, ::network::mojom::SourceLocationPtr* output)
{
    bool success = true;
