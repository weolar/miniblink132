...
IsolationInfo::IsolationInfo(IsolationInfoRequestType request_type_in, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin_in,
...
bool StructTraits<::network::mojom::blink::IsolationInfo::DataView, ::network::mojom::blink::IsolationInfoPtr>::Read(
    ::network::mojom::blink::IsolationInfo::DataView input, ::network::mojom::blink::IsolationInfoPtr* output)
{
    bool success = true;
