...
IPEndPoint::IPEndPoint(const ::net::IPAddress& address_in, uint16_t port_in)
...
void IPEndPoint::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool IPEndPoint::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::network::mojom::blink::IPEndPoint::DataView, ::network::mojom::blink::IPEndPointPtr>::Read(
    ::network::mojom::blink::IPEndPoint::DataView input, ::network::mojom::blink::IPEndPointPtr* output)
{
    bool success = true;
