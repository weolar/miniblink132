...
ObliviousHttpRequestBody::ObliviousHttpRequestBody(const std::string& content_in, const WTF::String& content_type_in)
...
ObliviousHttpRequest::ObliviousHttpRequest(const ::blink::KURL& relay_url_in, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation_in,
...
{
    const char* name = ::network::mojom::blink::ObliviousHttpClient::Name_;
...
bool StructTraits<::network::mojom::blink::ObliviousHttpRequestBody::DataView, ::network::mojom::blink::ObliviousHttpRequestBodyPtr>::Read(
    ::network::mojom::blink::ObliviousHttpRequestBody::DataView input, ::network::mojom::blink::ObliviousHttpRequestBodyPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::ObliviousHttpResponse::DataView, ::network::mojom::blink::ObliviousHttpResponsePtr>::Read(
    ::network::mojom::blink::ObliviousHttpResponse::DataView input, ::network::mojom::blink::ObliviousHttpResponsePtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::ObliviousHttpRequest::DataView, ::network::mojom::blink::ObliviousHttpRequestPtr>::Read(
    ::network::mojom::blink::ObliviousHttpRequest::DataView input, ::network::mojom::blink::ObliviousHttpRequestPtr* output)
{
    bool success = true;
...
bool UnionTraits<::network::mojom::blink::ObliviousHttpCompletionResult::DataView, ::network::mojom::blink::ObliviousHttpCompletionResultPtr>::Read(
    ::network::mojom::blink::ObliviousHttpCompletionResult::DataView input, ::network::mojom::blink::ObliviousHttpCompletionResultPtr* output)
{
