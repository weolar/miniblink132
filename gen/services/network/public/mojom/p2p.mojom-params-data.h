...
static_assert(
    sizeof(P2PNetworkNotificationClient_NetworkListChanged_Params_Data) == 32, "Bad sizeof(P2PNetworkNotificationClient_NetworkListChanged_Params_Data)");
...
static_assert(sizeof(P2PSocketManager_StartNetworkNotifications_Params_Data) == 16, "Bad sizeof(P2PSocketManager_StartNetworkNotifications_Params_Data)");
...
static_assert(sizeof(P2PSocketManager_GetHostAddress_Params_Data) == 24, "Bad sizeof(P2PSocketManager_GetHostAddress_Params_Data)");
...
static_assert(sizeof(P2PSocketManager_GetHostAddress_ResponseParams_Data) == 16, "Bad sizeof(P2PSocketManager_GetHostAddress_ResponseParams_Data)");
...
static_assert(sizeof(P2PSocketManager_GetHostAddressWithFamily_Params_Data) == 24, "Bad sizeof(P2PSocketManager_GetHostAddressWithFamily_Params_Data)");
...
static_assert(
    sizeof(P2PSocketManager_GetHostAddressWithFamily_ResponseParams_Data) == 16, "Bad sizeof(P2PSocketManager_GetHostAddressWithFamily_ResponseParams_Data)");
...
static_assert(sizeof(P2PSocketManager_CreateSocket_Params_Data) == 64, "Bad sizeof(P2PSocketManager_CreateSocket_Params_Data)");
...
static_assert(sizeof(P2PSocket_Send_Params_Data) == 24, "Bad sizeof(P2PSocket_Send_Params_Data)");
...
static_assert(sizeof(P2PSocket_SendBatch_Params_Data) == 16, "Bad sizeof(P2PSocket_SendBatch_Params_Data)");
...
static_assert(sizeof(P2PSocket_SetOption_Params_Data) == 16, "Bad sizeof(P2PSocket_SetOption_Params_Data)");
...
static_assert(sizeof(P2PSocketClient_SocketCreated_Params_Data) == 24, "Bad sizeof(P2PSocketClient_SocketCreated_Params_Data)");
...
static_assert(sizeof(P2PSocketClient_SendComplete_Params_Data) == 16, "Bad sizeof(P2PSocketClient_SendComplete_Params_Data)");
...
static_assert(sizeof(P2PSocketClient_SendBatchComplete_Params_Data) == 16, "Bad sizeof(P2PSocketClient_SendBatchComplete_Params_Data)");
...
static_assert(sizeof(P2PSocketClient_DataReceived_Params_Data) == 16, "Bad sizeof(P2PSocketClient_DataReceived_Params_Data)");
...
public:
    ...
    P2PNetworkNotificationClient_NetworkListChanged_ParamsDataView(
        internal::P2PNetworkNotificationClient_NetworkListChanged_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetDefaultIpv4LocalAddressDataView(::network::mojom::IPAddressDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadDefaultIpv4LocalAddress(UserType* output)
    {
    ...
    inline void GetDefaultIpv6LocalAddressDataView(::network::mojom::IPAddressDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadDefaultIpv6LocalAddress(UserType* output)
    {
...
public:
    ...
    P2PSocketManager_StartNetworkNotifications_ParamsDataView(internal::P2PSocketManager_StartNetworkNotifications_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::P2PNetworkNotificationClientInterfaceBase>>(
...
public:
    ...
    P2PSocketManager_GetHostAddress_ParamsDataView(internal::P2PSocketManager_GetHostAddress_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    P2PSocketManager_GetHostAddress_ResponseParamsDataView(internal::P2PSocketManager_GetHostAddress_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetAddressesDataView(mojo::ArrayDataView<::network::mojom::IPAddressDataView>* output);
...
public:
    ...
    P2PSocketManager_GetHostAddressWithFamily_ParamsDataView(internal::P2PSocketManager_GetHostAddressWithFamily_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    P2PSocketManager_GetHostAddressWithFamily_ResponseParamsDataView(
        internal::P2PSocketManager_GetHostAddressWithFamily_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    P2PSocketManager_CreateSocket_ParamsDataView(internal::P2PSocketManager_CreateSocket_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    template <typename UserType> [[nodiscard]] bool ReadType(UserType* output) const
    {
        ...
        return mojo::internal::Deserialize<::network::mojom::P2PSocketType>(data_value, output);
    }
    P2PSocketType type() const
    {
        return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::P2PSocketType>(data_->type));
    }
    inline void GetLocalAddressDataView(::network::mojom::IPEndPointDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadLocalAddress(UserType* output)
    {
    ...
    inline void GetPortRangeDataView(P2PPortRangeDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadPortRange(UserType* output)
    {

        auto* pointer = data_->port_range.Get();
        return mojo::internal::Deserialize<::network::mojom::P2PPortRangeDataView>(pointer, output, message_);
    }
    inline void GetRemoteAddressDataView(P2PHostAndIPEndPointDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadRemoteAddress(UserType* output)
    {

        auto* pointer = data_->remote_address.Get();
        return mojo::internal::Deserialize<::network::mojom::P2PHostAndIPEndPointDataView>(pointer, output, message_);
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfacePtrDataView<::network::mojom::P2PSocketClientInterfaceBase>>(&data_->client, &result, message_);
        DCHECK(ret);
        return result;
    }
    ...
    {
        UserType result;
        bool ret = mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::network::mojom::P2PSocketInterfaceBase>>(&data_->socket, &result, message_);
        DCHECK(ret);
        return result;
    }
...
public:
    ...
    P2PSocket_Send_ParamsDataView(internal::P2PSocket_Send_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    P2PSocket_SendBatch_ParamsDataView(internal::P2PSocket_SendBatch_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetPacketBatchDataView(mojo::ArrayDataView<P2PSendPacketDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadPacketBatch(UserType* output)
    {

        auto* pointer = data_->packet_batch.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::network::mojom::P2PSendPacketDataView>>(pointer, output, message_);
    }
...
public:
    ...
    P2PSocket_SetOption_ParamsDataView(internal::P2PSocket_SetOption_Params_Data* data, mojo::Message* message)
        : data_(data)
    {
    }
    ...
    template <typename UserType> [[nodiscard]] bool ReadOption(UserType* output) const
    {
        ...
        return mojo::internal::Deserialize<::network::mojom::P2PSocketOption>(data_value, output);
    }
    P2PSocketOption option() const
    {
        return ::mojo::internal::ToKnownEnumValueHelper(static_cast<::network::mojom::P2PSocketOption>(data_->option));
    }
    int32_t value() const
    {
        return data_->value;
...
public:
    ...
    P2PSocketClient_SocketCreated_ParamsDataView(internal::P2PSocketClient_SocketCreated_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetRemoteAddressDataView(::network::mojom::IPEndPointDataView* output);
...
public:
    ...
    P2PSocketClient_SendComplete_ParamsDataView(internal::P2PSocketClient_SendComplete_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetSendMetricsDataView(P2PSendPacketMetricsDataView* output);

    template <typename UserType> [[nodiscard]] bool ReadSendMetrics(UserType* output)
    {

        auto* pointer = data_->send_metrics.Get();
        return mojo::internal::Deserialize<::network::mojom::P2PSendPacketMetricsDataView>(pointer, output, message_);
    }
...
public:
    ...
    P2PSocketClient_SendBatchComplete_ParamsDataView(internal::P2PSocketClient_SendBatchComplete_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetSendMetricsBatchDataView(mojo::ArrayDataView<P2PSendPacketMetricsDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadSendMetricsBatch(UserType* output)
    {

        auto* pointer = data_->send_metrics_batch.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::network::mojom::P2PSendPacketMetricsDataView>>(pointer, output, message_);
    }
...
public:
    ...
    P2PSocketClient_DataReceived_ParamsDataView(internal::P2PSocketClient_DataReceived_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetPacketsDataView(mojo::ArrayDataView<P2PReceivedPacketDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadPackets(UserType* output)
    {

        auto* pointer = data_->packets.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::network::mojom::P2PReceivedPacketDataView>>(pointer, output, message_);
    }
...
inline void P2PNetworkNotificationClient_NetworkListChanged_ParamsDataView::GetDefaultIpv4LocalAddressDataView(::network::mojom::IPAddressDataView* output)
{
    auto pointer = data_->default_ipv4_local_address.Get();
    *output = ::network::mojom::IPAddressDataView(pointer, message_);
}
inline void P2PNetworkNotificationClient_NetworkListChanged_ParamsDataView::GetDefaultIpv6LocalAddressDataView(::network::mojom::IPAddressDataView* output)
{
    auto pointer = data_->default_ipv6_local_address.Get();
    *output = ::network::mojom::IPAddressDataView(pointer, message_);
}

inline void P2PSocketManager_GetHostAddress_ParamsDataView::GetHostNameDataView(mojo::StringDataView* output)
{
    auto pointer = data_->host_name.Get();
    *output = mojo::StringDataView(pointer, message_);
}

inline void P2PSocketManager_GetHostAddress_ResponseParamsDataView::GetAddressesDataView(mojo::ArrayDataView<::network::mojom::IPAddressDataView>* output)
{
    auto pointer = data_->addresses.Get();
    *output = mojo::ArrayDataView<::network::mojom::IPAddressDataView>(pointer, message_);
}

inline void P2PSocketManager_GetHostAddressWithFamily_ParamsDataView::GetHostNameDataView(mojo::StringDataView* output)
{
    auto pointer = data_->host_name.Get();
    *output = mojo::StringDataView(pointer, message_);
}
...
inline void P2PSocketManager_CreateSocket_ParamsDataView::GetLocalAddressDataView(::network::mojom::IPEndPointDataView* output)
{
    auto pointer = data_->local_address.Get();
    *output = ::network::mojom::IPEndPointDataView(pointer, message_);
}
inline void P2PSocketManager_CreateSocket_ParamsDataView::GetPortRangeDataView(P2PPortRangeDataView* output)
{
    auto pointer = data_->port_range.Get();
    *output = P2PPortRangeDataView(pointer, message_);
}
inline void P2PSocketManager_CreateSocket_ParamsDataView::GetRemoteAddressDataView(P2PHostAndIPEndPointDataView* output)
{
    auto pointer = data_->remote_address.Get();
    *output = P2PHostAndIPEndPointDataView(pointer, message_);
}
inline void P2PSocketManager_CreateSocket_ParamsDataView::GetTrafficAnnotationDataView(::network::mojom::MutableNetworkTrafficAnnotationTagDataView* output)
{
    auto pointer = data_->traffic_annotation.Get();
    *output = ::network::mojom::MutableNetworkTrafficAnnotationTagDataView(pointer, message_);
}
inline void P2PSocketManager_CreateSocket_ParamsDataView::GetDevtoolsTokenDataView(::mojo_base::mojom::UnguessableTokenDataView* output)
{
    auto pointer = data_->devtools_token.Get();
    *output = ::mojo_base::mojom::UnguessableTokenDataView(pointer, message_);
}

inline void P2PSocket_Send_ParamsDataView::GetDataDataView(::mojo_base::mojom::ReadOnlyBufferDataView* output)
{
    auto pointer = data_->data.Get();
    *output = ::mojo_base::mojom::ReadOnlyBufferDataView(pointer, message_);
}
inline void P2PSocket_Send_ParamsDataView::GetPacketInfoDataView(P2PPacketInfoDataView* output)
{
    auto pointer = data_->packet_info.Get();
    *output = P2PPacketInfoDataView(pointer, message_);
}

inline void P2PSocket_SendBatch_ParamsDataView::GetPacketBatchDataView(mojo::ArrayDataView<P2PSendPacketDataView>* output)
{
    auto pointer = data_->packet_batch.Get();
    *output = mojo::ArrayDataView<P2PSendPacketDataView>(pointer, message_);
}

inline void P2PSocketClient_SocketCreated_ParamsDataView::GetLocalAddressDataView(::network::mojom::IPEndPointDataView* output)
{
    auto pointer = data_->local_address.Get();
    *output = ::network::mojom::IPEndPointDataView(pointer, message_);
}
inline void P2PSocketClient_SocketCreated_ParamsDataView::GetRemoteAddressDataView(::network::mojom::IPEndPointDataView* output)
{
    auto pointer = data_->remote_address.Get();
    *output = ::network::mojom::IPEndPointDataView(pointer, message_);
}

inline void P2PSocketClient_SendComplete_ParamsDataView::GetSendMetricsDataView(P2PSendPacketMetricsDataView* output)
{
    auto pointer = data_->send_metrics.Get();
    *output = P2PSendPacketMetricsDataView(pointer, message_);
}

inline void P2PSocketClient_SendBatchComplete_ParamsDataView::GetSendMetricsBatchDataView(mojo::ArrayDataView<P2PSendPacketMetricsDataView>* output)
{
    auto pointer = data_->send_metrics_batch.Get();
    *output = mojo::ArrayDataView<P2PSendPacketMetricsDataView>(pointer, message_);
}

inline void P2PSocketClient_DataReceived_ParamsDataView::GetPacketsDataView(mojo::ArrayDataView<P2PReceivedPacketDataView>* output)
{
    auto pointer = data_->packets.Get();
