...
AddressList::AddressList(std::vector<::net::IPEndPoint> addresses_in, std::vector<std::string> dns_aliases_in)
...
bool StructTraits<::network::mojom::AddressList::DataView, ::network::mojom::AddressListPtr>::Read(
    ::network::mojom::AddressList::DataView input, ::network::mojom::AddressListPtr* output)
{
    bool success = true;
