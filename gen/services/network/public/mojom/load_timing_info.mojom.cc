...
LoadTimingInfo::LoadTimingInfo(bool socket_reused_in, uint32_t socket_log_id_in, ::base::Time request_start_time_in, ::base::TimeTicks request_start_in,
    ::base::TimeTicks proxy_resolve_start_in, ::base::TimeTicks proxy_resolve_end_in, const ::net::LoadTimingInfo::ConnectTiming& connect_timing_in,
...
bool StructTraits<::network::mojom::LoadTimingInfoConnectTiming::DataView, ::network::mojom::LoadTimingInfoConnectTimingPtr>::Read(
    ::network::mojom::LoadTimingInfoConnectTiming::DataView input, ::network::mojom::LoadTimingInfoConnectTimingPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::LoadTimingInfo::DataView, ::network::mojom::LoadTimingInfoPtr>::Read(
    ::network::mojom::LoadTimingInfo::DataView input, ::network::mojom::LoadTimingInfoPtr* output)
{
    bool success = true;
