...
CrossOriginEmbedderPolicy::CrossOriginEmbedderPolicy(CrossOriginEmbedderPolicyValue value_in, const std::optional<std::string>& reporting_endpoint_in,
    CrossOriginEmbedderPolicyValue report_only_value_in, const std::optional<std::string>& report_only_reporting_endpoint_in)
    ...
    const ::GURL& in_blocked_url, ::network::mojom::RequestDestination in_destination, bool in_report_only)
{
    ...
    TRACE_EVENT1(
        "mojom", "Send network::mojom::CrossOriginEmbedderPolicyReporter::QueueCorpViolationReport", "input_parameters", [&](perfetto::TracedValue context) {
            ...
            perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("destination"), in_destination, "<value of type ::network::mojom::RequestDestination>");
...
bool StructTraits<::network::mojom::CrossOriginEmbedderPolicy::DataView, ::network::mojom::CrossOriginEmbedderPolicyPtr>::Read(
    ::network::mojom::CrossOriginEmbedderPolicy::DataView input, ::network::mojom::CrossOriginEmbedderPolicyPtr* output)
{
    bool success = true;
...
void CrossOriginEmbedderPolicyReporterInterceptorForTesting::QueueCorpViolationReport(
    const ::GURL& blocked_url, ::network::mojom::RequestDestination destination, bool report_only)
{
