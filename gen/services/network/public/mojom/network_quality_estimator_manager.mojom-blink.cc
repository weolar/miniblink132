...
void NetworkQualityEstimatorManagerClientProxy::OnNetworkQualityChanged(::network::mojom::blink::EffectiveConnectionType in_type, ::base::TimeDelta in_http_rtt,
    ::base::TimeDelta in_transport_rtt, int32_t in_downlink_bandwidth_kbps)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
