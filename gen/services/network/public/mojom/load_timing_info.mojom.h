    ...
    , ssl_end()
{
    ...
    {
        return mojo::internal::SerializeImpl<LoadTimingInfoConnectTiming::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , service_worker_cache_lookup_start()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<LoadTimingInfo::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::network::mojom::LoadTimingInfoConnectTiming::DataView, ::network::mojom::LoadTimingInfoConnectTimingPtr> {
    static bool IsNull(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::LoadTimingInfoConnectTimingPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::network::mojom::LoadTimingInfoConnectTiming::ssl_start)& ssl_start(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input)
    {
        return input->ssl_start;
    }

    static const decltype(::network::mojom::LoadTimingInfoConnectTiming::ssl_end)& ssl_end(const ::network::mojom::LoadTimingInfoConnectTimingPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::LoadTimingInfo::DataView, ::network::mojom::LoadTimingInfoPtr> {
    static bool IsNull(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::LoadTimingInfoPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::LoadTimingInfo::socket_reused) socket_reused(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->socket_reused;
    }

    static decltype(::network::mojom::LoadTimingInfo::socket_log_id) socket_log_id(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->socket_log_id;
    }

    static const decltype(::network::mojom::LoadTimingInfo::request_start_time)& request_start_time(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->request_start_time;
    }

    static const decltype(::network::mojom::LoadTimingInfo::request_start)& request_start(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->request_start;
    }

    static const decltype(::network::mojom::LoadTimingInfo::proxy_resolve_start)& proxy_resolve_start(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->proxy_resolve_start;
    }

    static const decltype(::network::mojom::LoadTimingInfo::proxy_resolve_end)& proxy_resolve_end(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->proxy_resolve_end;
    }

    static const decltype(::network::mojom::LoadTimingInfo::connect_timing)& connect_timing(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->connect_timing;
    }

    static const decltype(::network::mojom::LoadTimingInfo::send_start)& send_start(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->send_start;
    }

    static const decltype(::network::mojom::LoadTimingInfo::send_end)& send_end(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->send_end;
    }

    static const decltype(::network::mojom::LoadTimingInfo::receive_headers_start)& receive_headers_start(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->receive_headers_start;
    }

    static const decltype(::network::mojom::LoadTimingInfo::receive_headers_end)& receive_headers_end(const ::network::mojom::LoadTimingInfoPtr& input)
    {
    ...
    static const decltype(::network::mojom::LoadTimingInfo::first_early_hints_time)& first_early_hints_time(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->first_early_hints_time;
    }

    static const decltype(::network::mojom::LoadTimingInfo::push_start)& push_start(const ::network::mojom::LoadTimingInfoPtr& input)
    {
        return input->push_start;
    }

    static const decltype(::network::mojom::LoadTimingInfo::push_end)& push_end(const ::network::mojom::LoadTimingInfoPtr& input)
    {
