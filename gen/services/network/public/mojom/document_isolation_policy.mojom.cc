...
DocumentIsolationPolicy::DocumentIsolationPolicy(DocumentIsolationPolicyValue value_in, const std::optional<std::string>& reporting_endpoint_in,
...
bool StructTraits<::network::mojom::DocumentIsolationPolicy::DataView, ::network::mojom::DocumentIsolationPolicyPtr>::Read(
    ::network::mojom::DocumentIsolationPolicy::DataView input, ::network::mojom::DocumentIsolationPolicyPtr* output)
{
    bool success = true;
