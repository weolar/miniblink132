    ...
    , minor_value()
{
    ...
    {
        return mojo::internal::SerializeImpl<HttpVersion::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , port()
{
    ...
    HostPortPair(const std::string& host_in, uint16_t port_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<HostPortPair::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , is_secure_network_error(false)
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ResolveErrorInfo::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , path()
{
    ...
    AuthChallengeInfo(bool is_proxy_in, const ::url::SchemeHostPort& challenger_in, const std::string& scheme_in, const std::string& realm_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AuthChallengeInfo::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , host_and_port()
{
    ...
    ProxyServer(::net::ProxyServer::Scheme scheme_in, const std::optional<::net::HostPortPair>& host_and_port_in)
    : scheme(std::move(scheme_in))
    ...
    , ip_protection_chain_id()
{
    ...
    ProxyChain(std::optional<std::vector<::net::ProxyServer>> proxy_servers_in, int32_t ip_protection_chain_id_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ProxyChain::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , signature_algorithms()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SSLCertRequestInfo::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , start_time()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<NetLogSource::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::network::mojom::AuthChallengeInfo::DataView, ::network::mojom::AuthChallengeInfoPtr> {
    static bool IsNull(const ::network::mojom::AuthChallengeInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::AuthChallengeInfoPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::AuthChallengeInfo::is_proxy) is_proxy(const ::network::mojom::AuthChallengeInfoPtr& input)
    {
        return input->is_proxy;
    }

    static const decltype(::network::mojom::AuthChallengeInfo::challenger)& challenger(const ::network::mojom::AuthChallengeInfoPtr& input)
    {
        return input->challenger;
    }

    static const decltype(::network::mojom::AuthChallengeInfo::scheme)& scheme(const ::network::mojom::AuthChallengeInfoPtr& input)
    {
        return input->scheme;
    }

    static const decltype(::network::mojom::AuthChallengeInfo::realm)& realm(const ::network::mojom::AuthChallengeInfoPtr& input)
    {
        return input->realm;
    }

    static const decltype(::network::mojom::AuthChallengeInfo::challenge)& challenge(const ::network::mojom::AuthChallengeInfoPtr& input)
    {
        return input->challenge;
    }

    static const decltype(::network::mojom::AuthChallengeInfo::path)& path(const ::network::mojom::AuthChallengeInfoPtr& input)
    {
        return input->path;
    }
...
template <> struct StructTraits<::network::mojom::HttpVersion::DataView, ::network::mojom::HttpVersionPtr> {
    static bool IsNull(const ::network::mojom::HttpVersionPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::HttpVersionPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::HttpVersion::major_value) major_value(const ::network::mojom::HttpVersionPtr& input)
    {
        return input->major_value;
    }

    static decltype(::network::mojom::HttpVersion::minor_value) minor_value(const ::network::mojom::HttpVersionPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::HostPortPair::DataView, ::network::mojom::HostPortPairPtr> {
    static bool IsNull(const ::network::mojom::HostPortPairPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::HostPortPairPtr* output)
    {
        output->reset();
    }

    static const decltype(::network::mojom::HostPortPair::host)& host(const ::network::mojom::HostPortPairPtr& input)
    {
        return input->host;
    }

    static decltype(::network::mojom::HostPortPair::port) port(const ::network::mojom::HostPortPairPtr& input)
    {
        return input->port;
    }
...
template <> struct StructTraits<::network::mojom::ProxyServer::DataView, ::network::mojom::ProxyServerPtr> {
    static bool IsNull(const ::network::mojom::ProxyServerPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::ProxyServerPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::ProxyServer::scheme) scheme(const ::network::mojom::ProxyServerPtr& input)
    {
        return input->scheme;
    }

    static const decltype(::network::mojom::ProxyServer::host_and_port)& host_and_port(const ::network::mojom::ProxyServerPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::ProxyChain::DataView, ::network::mojom::ProxyChainPtr> {
    static bool IsNull(const ::network::mojom::ProxyChainPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::ProxyChainPtr* output)
    {
        output->reset();
    }

    static const decltype(::network::mojom::ProxyChain::proxy_servers)& proxy_servers(const ::network::mojom::ProxyChainPtr& input)
    {
        return input->proxy_servers;
    }

    static decltype(::network::mojom::ProxyChain::ip_protection_chain_id) ip_protection_chain_id(const ::network::mojom::ProxyChainPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::ResolveErrorInfo::DataView, ::network::mojom::ResolveErrorInfoPtr> {
    static bool IsNull(const ::network::mojom::ResolveErrorInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::ResolveErrorInfoPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::ResolveErrorInfo::error) error(const ::network::mojom::ResolveErrorInfoPtr& input)
    {
        return input->error;
    }

    static decltype(::network::mojom::ResolveErrorInfo::is_secure_network_error) is_secure_network_error(const ::network::mojom::ResolveErrorInfoPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::SSLCertRequestInfo::DataView, ::network::mojom::SSLCertRequestInfoPtr> {
    static bool IsNull(const ::network::mojom::SSLCertRequestInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::SSLCertRequestInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::network::mojom::SSLCertRequestInfo::host_and_port)& host_and_port(const ::network::mojom::SSLCertRequestInfoPtr& input)
    {
        return input->host_and_port;
    }

    static decltype(::network::mojom::SSLCertRequestInfo::is_proxy) is_proxy(const ::network::mojom::SSLCertRequestInfoPtr& input)
    {
        return input->is_proxy;
    }

    static const decltype(::network::mojom::SSLCertRequestInfo::cert_authorities)& cert_authorities(const ::network::mojom::SSLCertRequestInfoPtr& input)
    {
...
template <> struct StructTraits<::network::mojom::NetLogSource::DataView, ::network::mojom::NetLogSourcePtr> {
    static bool IsNull(const ::network::mojom::NetLogSourcePtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::NetLogSourcePtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::NetLogSource::source_type) source_type(const ::network::mojom::NetLogSourcePtr& input)
    {
        return input->source_type;
    }

    static decltype(::network::mojom::NetLogSource::source_id) source_id(const ::network::mojom::NetLogSourcePtr& input)
    {
        return input->source_id;
    }

    static const decltype(::network::mojom::NetLogSource::start_time)& start_time(const ::network::mojom::NetLogSourcePtr& input)
    {
