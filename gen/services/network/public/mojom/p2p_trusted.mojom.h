...
class P2PTrustedSocketManagerClient : public P2PTrustedSocketManagerClientInterfaceBase {
public:
...
class P2PTrustedSocketManager : public P2PTrustedSocketManagerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class P2PTrustedSocketManagerClientProxy : public P2PTrustedSocketManagerClient {
public:
...
class P2PTrustedSocketManagerProxy : public P2PTrustedSocketManager {
public:
