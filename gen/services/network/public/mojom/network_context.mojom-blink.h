...
#include "components/ip_protection/mojom/core.mojom-blink-forward.h"
...
class BLINK_PLATFORM_EXPORT PreloadedSharedDictionaryInfoHandle : public PreloadedSharedDictionaryInfoHandleInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void CreateURLLoaderFactory(::mojo::PendingReceiver<::network::mojom::blink::URLLoaderFactory> url_loader_factory, URLLoaderFactoryParamsPtr params)
        = 0;

    virtual void ResetURLLoaderFactories() = 0;

    virtual void GetViaObliviousHttp(
    ...
    using GetPrivateStateTokenRedemptionRecordsCallback = base::OnceCallback<void(
    ...
    virtual void SetEnterpriseReportingEndpoints(const WTF::HashMap<WTF::String, ::blink::KURL>& endpoints) = 0;

    virtual void SendReportsAndRemoveSource(const ::base::UnguessableToken& reporting_source) = 0;

    virtual void QueueReport(const WTF::String& type, const WTF::String& group, const ::blink::KURL& url,
    ...
    virtual void QueueEnterpriseReport(const WTF::String& type, const WTF::String& group, const ::blink::KURL& url, ::base::Value::Dict body) = 0;
    ...
    virtual void CreateRestrictedUDPSocket(const ::net::IPEndPoint& addr, ::network::mojom::blink::RestrictedUDPSocketMode mode,
        ...
        ::mojo::PendingRemote<::network::mojom::blink::UDPSocketListener> listener, CreateRestrictedUDPSocketCallback callback)
        = 0;

    using CreateTCPServerSocketCallback = base::OnceCallback<void(int32_t, const std::optional<::net::IPEndPoint>&)>;

    virtual void CreateTCPServerSocket(const ::net::IPEndPoint& local_addr, ::network::mojom::blink::TCPServerSocketOptionsPtr options,
    ...
    virtual void CreateTCPConnectedSocket(const std::optional<::net::IPEndPoint>& local_addr, ::network::mojom::blink::AddressListPtr remote_addr_list,
    ...
    virtual void PreconnectSockets(uint32_t num_streams, const ::blink::KURL& url, ::network::mojom::blink::CredentialsMode credentials_mode,
        ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation)
        = 0;
    ...
    virtual void LookupServerBasicAuthCredentials(const ::blink::KURL& url, ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key,
    ...
    virtual void VerifyCertificateForTesting(::network::mojom::blink::X509CertificatePtr certificate, const WTF::String& hostname,
    ...
    using GetSharedDictionaryUsageInfoCallback = base::OnceCallback<void(WTF::Vector<::network::mojom::blink::SharedDictionaryUsageInfoPtr>)>;

    virtual void GetSharedDictionaryUsageInfo(GetSharedDictionaryUsageInfoCallback callback) = 0;

    using GetSharedDictionaryInfoCallback = base::OnceCallback<void(WTF::Vector<SharedDictionaryInfoPtr>)>;
    ...
    using GetSharedDictionaryOriginsBetweenCallback = base::OnceCallback<void(const WTF::Vector<::scoped_refptr<const ::blink::SecurityOrigin>>&)>;
    ...
    virtual void FlushCachedClientCertIfNeeded(const ::net::HostPortPair& host, ::network::mojom::blink::X509CertificatePtr certificate) = 0;

    virtual void FlushMatchingCachedClientCert(::network::mojom::blink::X509CertificatePtr certificate) = 0;

    virtual void SetCookieDeprecationLabel(const WTF::String& label) = 0;

    using RevokeNetworkForNoncesCallback = base::OnceCallback<void()>;

    virtual void RevokeNetworkForNonces(const WTF::Vector<::base::UnguessableToken>& nonces, RevokeNetworkForNoncesCallback callback) = 0;

    virtual void ClearNonces(const WTF::Vector<::base::UnguessableToken>& nonces) = 0;
...
//class BLINK_PLATFORM_EXPORT CustomProxyConnectionObserverProxy : public CustomProxyConnectionObserver {
//public:
...
//        const ::net::ProxyChain& proxy_chain, uint64_t chain_index, ::network::mojom::blink::HttpResponseHeadersPtr response_headers) final;
//
//private:
//    mojo::MessageReceiverWithResponder* receiver_;
//};

//class BLINK_PLATFORM_EXPORT CustomProxyConfigClientProxy : public CustomProxyConfigClient {
//public:
...
//class BLINK_PLATFORM_EXPORT TrustedHeaderClientProxy : public TrustedHeaderClient {
//public:
...
//class BLINK_PLATFORM_EXPORT TrustedURLLoaderHeaderClientProxy : public TrustedURLLoaderHeaderClient {
//public:
...
//class BLINK_PLATFORM_EXPORT PreloadedSharedDictionaryInfoHandleProxy : public PreloadedSharedDictionaryInfoHandle {
//public:
...
//class BLINK_PLATFORM_EXPORT NetworkContextProxy : public NetworkContext {
//public:
...
//        ::network::mojom::blink::ObliviousHttpRequestPtr request, ::mojo::PendingRemote<::network::mojom::blink::ObliviousHttpClient> client) final;
//
...
//        const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin) final;
//
...
//
//    void ClearHttpCache(
//        ::base::Time start_time, ::base::Time end_time, ::network::mojom::blink::ClearDataFilterPtr filter, ClearHttpCacheCallback callback) final;
//
...
//        const ::blink::KURL& url, const WTF::String& http_method, ::network::mojom::blink::NetworkIsolationKeyPtr key, bool include_credentials) final;
//
...
//        ::base::Time start_time, ::base::Time end_time, ::network::mojom::blink::ClearDataFilterPtr filter, ClearHttpAuthCacheCallback callback) final;
//
...
//        ::network::mojom::blink::ClearDataFilterPtr filter, NetworkContext::DomainReliabilityClearMode mode, ClearDomainReliabilityCallback callback) final;
//
//    void ClearSharedDictionaryCache(
//        ::base::Time start_time, ::base::Time end_time, ::network::mojom::blink::ClearDataFilterPtr filter, ClearSharedDictionaryCacheCallback callback) final;
//
//    void ClearSharedDictionaryCacheForIsolationKey(
//        ::network::mojom::blink::SharedDictionaryIsolationKeyPtr isolation_key, ClearSharedDictionaryCacheForIsolationKeyCallback callback) final;
//
...
//        const ::net::IsolationInfo& isolation_info, const WTF::HashMap<WTF::String, WTF::String>& endpoints) final;
//
//    void SetEnterpriseReportingEndpoints(const WTF::HashMap<WTF::String, ::blink::KURL>& endpoints) final;
//
...
//        const std::optional<::base::UnguessableToken>& reporting_source, ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key,
//        ::base::Value::Dict body) final;
//
//    void QueueEnterpriseReport(const WTF::String& type, const WTF::String& group, const ::blink::KURL& url, ::base::Value::Dict body) final;
//
...
//        ::mojo::PendingReceiver<::network::mojom::blink::UDPSocket> receiver, ::mojo::PendingRemote<::network::mojom::blink::UDPSocketListener> listener) final;
//
//    void CreateRestrictedUDPSocket(const ::net::IPEndPoint& addr, ::network::mojom::blink::RestrictedUDPSocketMode mode,
//        const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::network::mojom::blink::RestrictedUDPSocketParamsPtr params,
//        ::mojo::PendingReceiver<::network::mojom::blink::RestrictedUDPSocket> receiver,
//        ::mojo::PendingRemote<::network::mojom::blink::UDPSocketListener> listener, CreateRestrictedUDPSocketCallback callback) final;
//
...
//        ::mojo::PendingRemote<::network::mojom::blink::P2PTrustedSocketManagerClient> client,
//        ::mojo::PendingReceiver<::network::mojom::blink::P2PTrustedSocketManager> trusted_socket_manager,
//        ::mojo::PendingReceiver<::network::mojom::blink::P2PSocketManager> socket_manager) final;
//
...
//        ::network::mojom::blink::ResolveHostParametersPtr optional_parameters,
//        ::mojo::PendingRemote<::network::mojom::blink::ResolveHostClient> response_client) final;
//
//    void CreateHostResolver(
//        ::network::mojom::blink::DnsConfigOverridesPtr config_overrides, ::mojo::PendingReceiver<::network::mojom::blink::HostResolver> host_resolver) final;
//
...
//        const WTF::String& sct_list, VerifyCertForSignedExchangeCallback callback) final;
//
...
//        WTF::Vector<::network::mojom::blink::CorsOriginPatternPtr> allow_patterns, WTF::Vector<::network::mojom::blink::CorsOriginPatternPtr> block_patterns,
//        SetCorsOriginAccessListsForOriginCallback callback) final;
//
...
//        const WTF::String& sct_list, VerifyCertificateForTestingCallback callback) final;
//
...
//        const WTF::Vector<::blink::KURL>& urls, ::mojo::PendingReceiver<PreloadedSharedDictionaryInfoHandle> preload_handle) final;
//
...
//
//    void FlushCachedClientCertIfNeeded(const ::net::HostPortPair& host, ::network::mojom::blink::X509CertificatePtr certificate) final;
//
//    void FlushMatchingCachedClientCert(::network::mojom::blink::X509CertificatePtr certificate) final;
//
//    void SetCookieDeprecationLabel(const WTF::String& label) final;
//
//    void RevokeNetworkForNonces(const WTF::Vector<::base::UnguessableToken>& nonces, RevokeNetworkForNoncesCallback callback) final;
//
//    void ClearNonces(const WTF::Vector<::base::UnguessableToken>& nonces) final;
//
//    void ExemptUrlFromNetworkRevocationForNonce(
//        const ::blink::KURL& exempted_url, const ::base::UnguessableToken& nonce, ExemptUrlFromNetworkRevocationForNonceCallback callback) final;
//
...
//    ImplPointerType sink_;
//};
//class BLINK_PLATFORM_EXPORT PreloadedSharedDictionaryInfoHandleStubDispatch {
//public:
...
//    bool Accept(mojo::Message* message) override;
//};
//class BLINK_PLATFORM_EXPORT PreloadedSharedDictionaryInfoHandleRequestValidator : public mojo::MessageReceiver {
//public:
//    bool Accept(mojo::Message* message) override;
//};
    ...
    , connect_tunnel_headers()
{
    ...
    CustomProxyConfig(::network::mojom::blink::ProxyRulesPtr rules_in, bool should_override_existing_config_in,
    ...
    , excluded_spkis()
{
    ...
    CTPolicy(WTF::Vector<WTF::String> excluded_hosts_in, WTF::Vector<WTF::String> excluded_spkis_in)
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<CTPolicy::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    , trigger_migration(false)
{
    ...
    NetworkContextFilePaths(::network::mojom::blink::TransferableDirectoryPtr shared_dictionary_directory_in,
...
class BLINK_PLATFORM_EXPORT SocketBrokerRemotes {
public:
    ...
    , server()
{
    ...
    ::mojo::PendingRemote<::network::mojom::blink::SocketBroker> client;

    ::mojo::PendingRemote<::network::mojom::blink::SocketBroker> server;
    ...
    , enterprise_reporting_endpoints()
{
    ...
    NetworkContextParams(const WTF::String& user_agent_in, const WTF::String& accept_language_in, bool enable_brotli_in, bool enable_zstd_in,
    ...
    ::mojo::PendingRemote<::ip_protection::mojom::blink::CoreHost> ip_protection_core_host;

    ::mojo::PendingReceiver<::ip_protection::mojom::blink::CoreControl> ip_protection_control;
    ...
    std::optional<WTF::HashMap<WTF::String, ::blink::KURL>> enterprise_reporting_endpoints;
...
class BLINK_PLATFORM_EXPORT SharedDictionaryInfo {
public:
    ...
    , hash()
{
    ...
    SharedDictionaryInfo(const WTF::String& match_in, WTF::Vector<::network::mojom::blink::RequestDestination> match_dest_in,
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SharedDictionaryInfo::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    , elapsed_time()
{
    ...
    SignedExchangeReport(bool success_in, const WTF::String& type_in, const ::blink::KURL& outer_url_in, const ::blink::KURL& inner_url_in,
    ...
    , require_cross_site_request_for_cookies(false)
{
    ...
    URLLoaderFactoryParams(int32_t process_id_in, const ::scoped_refptr<const ::blink::SecurityOrigin>& request_initiator_origin_lock_in,
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::CustomProxyConfig::DataView, ::network::mojom::blink::CustomProxyConfigPtr> {
    static bool IsNull(const ::network::mojom::blink::CustomProxyConfigPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::CustomProxyConfigPtr* output)
    {
        output->reset();
    }

    static const decltype(::network::mojom::blink::CustomProxyConfig::rules)& rules(const ::network::mojom::blink::CustomProxyConfigPtr& input)
    {
        return input->rules;
    }
...
struct BLINK_PLATFORM_EXPORT
    StructTraits<::network::mojom::blink::CertVerifierServiceRemoteParams::DataView, ::network::mojom::blink::CertVerifierServiceRemoteParamsPtr> {
    static bool IsNull(const ::network::mojom::blink::CertVerifierServiceRemoteParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::CertVerifierServiceRemoteParamsPtr* output)
    {
        output->reset();
    }
...
template <>
struct BLINK_PLATFORM_EXPORT
    StructTraits<::network::mojom::blink::HttpAuthStaticNetworkContextParams::DataView, ::network::mojom::blink::HttpAuthStaticNetworkContextParamsPtr> {
    static bool IsNull(const ::network::mojom::blink::HttpAuthStaticNetworkContextParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::HttpAuthStaticNetworkContextParamsPtr* output)
    {
        output->reset();
    }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::CTPolicy::DataView, ::network::mojom::blink::CTPolicyPtr> {
    static bool IsNull(const ::network::mojom::blink::CTPolicyPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::CTPolicyPtr* output)
    {
        output->reset();
    }

    static const decltype(::network::mojom::blink::CTPolicy::excluded_hosts)& excluded_hosts(const ::network::mojom::blink::CTPolicyPtr& input)
    {
        return input->excluded_hosts;
    }

    static const decltype(::network::mojom::blink::CTPolicy::excluded_spkis)& excluded_spkis(const ::network::mojom::blink::CTPolicyPtr& input)
    {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::NetworkContextFilePaths::DataView, ::network::mojom::blink::NetworkContextFilePathsPtr> {
    static bool IsNull(const ::network::mojom::blink::NetworkContextFilePathsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::NetworkContextFilePathsPtr* output)
    {
        output->reset();
    }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SocketBrokerRemotes::DataView, ::network::mojom::blink::SocketBrokerRemotesPtr> {
    static bool IsNull(const ::network::mojom::blink::SocketBrokerRemotesPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::SocketBrokerRemotesPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::blink::SocketBrokerRemotes::client)& client(::network::mojom::blink::SocketBrokerRemotesPtr& input)
    {
        return input->client;
    }

    static decltype(::network::mojom::blink::SocketBrokerRemotes::server)& server(::network::mojom::blink::SocketBrokerRemotesPtr& input)
    {
        return input->server;
    }

    static bool Read(::network::mojom::blink::SocketBrokerRemotes::DataView input, ::network::mojom::blink::SocketBrokerRemotesPtr* output);
};

template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::NetworkContextParams::DataView, ::network::mojom::blink::NetworkContextParamsPtr> {
    static bool IsNull(const ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::NetworkContextParamsPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::network::mojom::blink::NetworkContextParams::enable_zstd) enable_zstd(const ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::NetworkContextParams::enable_locking_cookie_database) enable_locking_cookie_database(
        const ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::NetworkContextParams::socket_brokers)& socket_brokers(::network::mojom::blink::NetworkContextParamsPtr& input)
    {
        return input->socket_brokers;
    }

    static decltype(::network::mojom::blink::NetworkContextParams::ip_protection_core_host)& ip_protection_core_host(
        ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
        return input->ip_protection_core_host;
    }

    static decltype(::network::mojom::blink::NetworkContextParams::ip_protection_control)& ip_protection_control(
        ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
        return input->ip_protection_control;
    }

    static decltype(::network::mojom::blink::NetworkContextParams::enable_ip_protection) enable_ip_protection(
        const ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::NetworkContextParams::file_paths)& file_paths(::network::mojom::blink::NetworkContextParamsPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::NetworkContextParams::cookie_deprecation_label)& cookie_deprecation_label(
        const ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::NetworkContextParams::bound_network) bound_network(const ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
        return input->bound_network;
    }

    static const decltype(::network::mojom::blink::NetworkContextParams::enterprise_reporting_endpoints)& enterprise_reporting_endpoints(
        const ::network::mojom::blink::NetworkContextParamsPtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::NetworkConditions::DataView, ::network::mojom::blink::NetworkConditionsPtr> {
    static bool IsNull(const ::network::mojom::blink::NetworkConditionsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::NetworkConditionsPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::blink::NetworkConditions::offline) offline(const ::network::mojom::blink::NetworkConditionsPtr& input)
    {
        return input->offline;
    }

    static const decltype(::network::mojom::blink::NetworkConditions::latency)& latency(const ::network::mojom::blink::NetworkConditionsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::NetworkConditions::packet_loss) packet_loss(const ::network::mojom::blink::NetworkConditionsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::NetworkConditions::packet_reordering) packet_reordering(const ::network::mojom::blink::NetworkConditionsPtr& input)
    {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SharedDictionaryInfo::DataView, ::network::mojom::blink::SharedDictionaryInfoPtr> {
    static bool IsNull(const ::network::mojom::blink::SharedDictionaryInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::SharedDictionaryInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::network::mojom::blink::SharedDictionaryInfo::match)& match(const ::network::mojom::blink::SharedDictionaryInfoPtr& input)
    {
        return input->match;
    }

    static const decltype(::network::mojom::blink::SharedDictionaryInfo::match_dest)& match_dest(const ::network::mojom::blink::SharedDictionaryInfoPtr& input)
    {
        return input->match_dest;
    }

    static const decltype(::network::mojom::blink::SharedDictionaryInfo::id)& id(const ::network::mojom::blink::SharedDictionaryInfoPtr& input)
    {
        return input->id;
    }
    ...
    static const decltype(::network::mojom::blink::SharedDictionaryInfo::expiration)& expiration(const ::network::mojom::blink::SharedDictionaryInfoPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::SharedDictionaryInfo::size) size(const ::network::mojom::blink::SharedDictionaryInfoPtr& input)
    {
        return input->size;
    }

    static const decltype(::network::mojom::blink::SharedDictionaryInfo::hash)& hash(const ::network::mojom::blink::SharedDictionaryInfoPtr& input)
    {
        return input->hash;
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SignedExchangeReport::DataView, ::network::mojom::blink::SignedExchangeReportPtr> {
    static bool IsNull(const ::network::mojom::blink::SignedExchangeReportPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::SignedExchangeReportPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::blink::SignedExchangeReport::success) success(const ::network::mojom::blink::SignedExchangeReportPtr& input)
    {
        return input->success;
    }

    static const decltype(::network::mojom::blink::SignedExchangeReport::type)& type(const ::network::mojom::blink::SignedExchangeReportPtr& input)
    {
        return input->type;
    }
    ...
    static const decltype(::network::mojom::blink::SignedExchangeReport::method)& method(const ::network::mojom::blink::SignedExchangeReportPtr& input)
    {
        return input->method;
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLLoaderFactoryOverride::DataView, ::network::mojom::blink::URLLoaderFactoryOverridePtr> {
    static bool IsNull(const ::network::mojom::blink::URLLoaderFactoryOverridePtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::URLLoaderFactoryOverridePtr* output)
    {
        output->reset();
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLLoaderFactoryParams::DataView, ::network::mojom::blink::URLLoaderFactoryParamsPtr> {
    static bool IsNull(const ::network::mojom::blink::URLLoaderFactoryParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::URLLoaderFactoryParamsPtr* output)
    {
        output->reset();
    }
