...
static_assert(sizeof(ProxyResolvingSocketOptions_Data) == 16, "Bad sizeof(ProxyResolvingSocketOptions_Data)");
// Used by ProxyResolvingSocketOptions::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct ProxyResolvingSocketOptions_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    ProxyResolvingSocketOptions_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag ProxyResolvingSocketOptions_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
