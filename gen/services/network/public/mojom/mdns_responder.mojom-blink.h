...
template <typename ImplRefTraits> class MdnsResponderStub;

class MdnsResponderRequestValidator;
class MdnsResponderResponseValidator;

class BLINK_PLATFORM_EXPORT MdnsResponder : public MdnsResponderInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = MdnsResponderStub<ImplRefTraits>;
...
//class BLINK_PLATFORM_EXPORT MdnsResponderProxy : public MdnsResponder {
//public:
...
//    static bool AcceptWithResponder(MdnsResponder* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
//};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<MdnsResponder>> class MdnsResponderStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return MdnsResponderStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return MdnsResponderStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
