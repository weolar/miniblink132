...
void P2PTrustedSocketManagerClientProxy::DumpPacket(const std::vector<uint8_t>& in_packet_header, uint64_t in_packet_length, bool in_incoming)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::P2PTrustedSocketManagerClient::DumpPacket", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("packet_header"), in_packet_header, "<value of type const std::vector<uint8_t>&>");
