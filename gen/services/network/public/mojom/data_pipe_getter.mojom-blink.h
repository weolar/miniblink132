...
template <typename ImplRefTraits> class DataPipeGetterStub;

class DataPipeGetterRequestValidator;
class DataPipeGetterResponseValidator;

class BLINK_PLATFORM_EXPORT DataPipeGetter : public DataPipeGetterInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = DataPipeGetterStub<ImplRefTraits>;
...
//class BLINK_PLATFORM_EXPORT DataPipeGetterProxy : public DataPipeGetter {
//public:
...
//    static bool AcceptWithResponder(DataPipeGetter* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
//};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<DataPipeGetter>> class DataPipeGetterStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return DataPipeGetterStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return DataPipeGetterStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
