    ...
    , allow_cross_origin_event_reporting()
{
    ...
    ParsedHeaders(WTF::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policy_in,
    ::network::mojom::blink::AllowCSPFromHeaderValuePtr allow_csp_from_in, const ::network::CrossOriginEmbedderPolicy& cross_origin_embedder_policy_in,
    ...
    OriginAgentClusterValue origin_agent_cluster_in, std::optional<WTF::Vector<::network::mojom::blink::WebClientHintsType>> accept_ch_in,
    std::optional<WTF::Vector<::network::mojom::blink::WebClientHintsType>> critical_ch_in, bool client_hints_ignored_due_to_clear_site_data_header_in,
    ::network::mojom::blink::XFrameOptionsValue xfo_in, WTF::Vector<::network::mojom::blink::LinkHeaderPtr> link_headers_in,
    ::network::mojom::blink::TimingAllowOriginPtr timing_allow_origin_in, WTF::Vector<::network::mojom::blink::LoadingMode> supports_loading_mode_in,
    const std::optional<WTF::HashMap<WTF::String, WTF::String>>& reporting_endpoints_in, std::optional<WTF::Vector<WTF::String>> cookie_indices_in,
    std::optional<WTF::Vector<WTF::String>> avail_language_in, std::optional<WTF::Vector<WTF::String>> content_language_in,
    ::network::mojom::blink::NoVarySearchWithParseErrorPtr no_vary_search_with_parse_error_in, bool observe_browsing_topics_in,
    ...
    {
        return mojo::internal::SerializeImpl<ParsedHeaders::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    std::optional<WTF::Vector<WTF::String>> cookie_indices;

    std::optional<WTF::Vector<WTF::String>> avail_language;
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::ParsedHeaders::DataView, ::network::mojom::blink::ParsedHeadersPtr> {
    static bool IsNull(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::ParsedHeadersPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::network::mojom::blink::ParsedHeaders::allow_csp_from)& allow_csp_from(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::ParsedHeaders::origin_agent_cluster) origin_agent_cluster(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->origin_agent_cluster;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::accept_ch)& accept_ch(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->accept_ch;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::critical_ch)& critical_ch(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->critical_ch;
    }

    static decltype(::network::mojom::blink::ParsedHeaders::client_hints_ignored_due_to_clear_site_data_header)
    client_hints_ignored_due_to_clear_site_data_header(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->client_hints_ignored_due_to_clear_site_data_header;
    }

    static decltype(::network::mojom::blink::ParsedHeaders::xfo) xfo(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->xfo;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::link_headers)& link_headers(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
    ...
    static const decltype(::network::mojom::blink::ParsedHeaders::cookie_indices)& cookie_indices(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->cookie_indices;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::avail_language)& avail_language(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
        return input->avail_language;
    }

    static const decltype(::network::mojom::blink::ParsedHeaders::content_language)& content_language(const ::network::mojom::blink::ParsedHeadersPtr& input)
    {
