...
void ProxyResolvingSocketProxy::UpgradeToTLS(const ::net::HostPortPair& in_host_port_pair,
    ...
    ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> in_observer, UpgradeToTLSCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ProxyResolvingSocketFactoryProxy::CreateProxyResolvingSocket(const ::blink::KURL& in_url,
    ::network::mojom::blink::NetworkAnonymizationKeyPtr in_network_anonymization_key, ProxyResolvingSocketOptionsPtr in_options,
    const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, ::mojo::PendingReceiver<ProxyResolvingSocket> in_socket,
    ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> in_observer, CreateProxyResolvingSocketCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
bool StructTraits<::network::mojom::blink::ProxyResolvingSocketOptions::DataView, ::network::mojom::blink::ProxyResolvingSocketOptionsPtr>::Read(
    ::network::mojom::blink::ProxyResolvingSocketOptions::DataView input, ::network::mojom::blink::ProxyResolvingSocketOptionsPtr* output)
{
    bool success = true;
...
void ProxyResolvingSocketInterceptorForTesting::UpgradeToTLS(const ::net::HostPortPair& host_port_pair,
    ...
    ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> observer, UpgradeToTLSCallback callback)
{
...
void ProxyResolvingSocketAsyncWaiter::UpgradeToTLS(const ::net::HostPortPair& host_port_pair,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::blink::TLSClientSocket> receiver,
    ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> observer, int32_t* out_net_error, ::mojo::ScopedDataPipeConsumerHandle* out_receive_stream,
...
void ProxyResolvingSocketFactoryInterceptorForTesting::CreateProxyResolvingSocket(const ::blink::KURL& url,
    ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key, ProxyResolvingSocketOptionsPtr options,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<ProxyResolvingSocket> socket,
    ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> observer, CreateProxyResolvingSocketCallback callback)
{
...
void ProxyResolvingSocketFactoryAsyncWaiter::CreateProxyResolvingSocket(const ::blink::KURL& url,
    ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key, ProxyResolvingSocketOptionsPtr options,
    const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<ProxyResolvingSocket> socket,
