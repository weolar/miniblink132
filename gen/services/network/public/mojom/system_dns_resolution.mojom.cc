    ...
    const std::optional<std::string>& in_hostname, ::net::AddressFamily in_addr_family, int32_t in_flags, uint64_t in_network, ResolveCallback callback)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::SystemDnsResolver::Resolve", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("hostname"), in_hostname, "<value of type const std::optional<std::string>&>");
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("addr_family"), in_addr_family, "<value of type ::net::AddressFamily>");
...
void SystemDnsResolver_Resolve_ProxyToResponder::Run(const ::net::AddressList& in_addr_list, int32_t in_os_error, int32_t in_net_error)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
{
    const char* name = ::network::mojom::SystemDnsResolver::Name_;
...
void SystemDnsResolverAsyncWaiter::Resolve(const std::optional<std::string>& hostname, ::net::AddressFamily addr_family, int32_t flags, uint64_t network,
