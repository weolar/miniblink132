...
void ProxyLookupClientProxy::OnProxyLookupComplete(int32_t in_net_error, const std::optional<::net::ProxyInfo>& in_proxy_info)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ProxyLookupClient::OnProxyLookupComplete", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("proxy_info"), in_proxy_info, "<value of type const std::optional<::net::ProxyInfo>&>");
    });
#endif
