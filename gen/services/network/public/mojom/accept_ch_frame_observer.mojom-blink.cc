...
void AcceptCHFrameObserverProxy::OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& in_origin,
    const WTF::Vector<::network::mojom::blink::WebClientHintsType>& in_accept_ch_frame, OnAcceptCHFrameReceivedCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::AcceptCHFrameObserver::OnAcceptCHFrameReceived", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("accept_ch_frame"), in_accept_ch_frame, "<value of type const WTF::Vector<::network::mojom::blink::WebClientHintsType>&>");
    });
#endif
...
void AcceptCHFrameObserverInterceptorForTesting::OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin,
...
void AcceptCHFrameObserverAsyncWaiter::OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin,
