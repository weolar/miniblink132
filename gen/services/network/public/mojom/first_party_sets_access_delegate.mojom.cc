...
FirstPartySetsReadyEvent::FirstPartySetsReadyEvent(::net::FirstPartySetsContextConfig config_in, ::net::FirstPartySetsCacheFilter cache_filter_in)
...
bool StructTraits<::network::mojom::FirstPartySetsAccessDelegateParams::DataView, ::network::mojom::FirstPartySetsAccessDelegateParamsPtr>::Read(
    ::network::mojom::FirstPartySetsAccessDelegateParams::DataView input, ::network::mojom::FirstPartySetsAccessDelegateParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::FirstPartySetsReadyEvent::DataView, ::network::mojom::FirstPartySetsReadyEventPtr>::Read(
    ::network::mojom::FirstPartySetsReadyEvent::DataView input, ::network::mojom::FirstPartySetsReadyEventPtr* output)
{
    bool success = true;
