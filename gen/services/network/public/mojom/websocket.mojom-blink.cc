...
HttpHeader::HttpHeader(const WTF::String& name_in, const WTF::String& value_in)
...
WebSocketHandshakeRequest::WebSocketHandshakeRequest(const ::blink::KURL& url_in, WTF::Vector<HttpHeaderPtr> headers_in, const WTF::String& headers_text_in)
    : url(std::move(url_in))
...
WebSocketHandshakeResponse::WebSocketHandshakeResponse(const ::blink::KURL& url_in, ::network::mojom::blink::HttpVersionPtr http_version_in,
    int32_t status_code_in, const WTF::String& status_text_in, const ::net::IPEndPoint& remote_endpoint_in, WTF::Vector<HttpHeaderPtr> headers_in,
    const WTF::String& headers_text_in, const WTF::String& selected_protocol_in, const WTF::String& extensions_in)
    : url(std::move(url_in))
...
void WebSocketAuthenticationHandlerProxy::OnAuthRequired(const ::net::AuthChallengeInfo& in_info, ::network::mojom::blink::HttpResponseHeadersPtr in_headers,
...
void WebSocketAuthenticationHandler_OnAuthRequired_ProxyToResponder::Run(::network::mojom::blink::AuthCredentialsPtr in_credentials)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void WebSocketHandshakeClientProxy::OnFailure(const WTF::String& in_message, int32_t in_net_error, int32_t in_response_code)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void WebSocketClientProxy::OnDropChannel(bool in_was_clean, uint16_t in_code, const WTF::String& in_reason)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::WebSocketClient::OnDropChannel", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("reason"), in_reason, "<value of type const WTF::String&>");
    });
#endif
...
void WebSocketProxy::StartClosingHandshake(uint16_t in_code, const WTF::String& in_reason)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::network::mojom::blink::HttpHeader::DataView, ::network::mojom::blink::HttpHeaderPtr>::Read(
    ::network::mojom::blink::HttpHeader::DataView input, ::network::mojom::blink::HttpHeaderPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::WebSocketHandshakeRequest::DataView, ::network::mojom::blink::WebSocketHandshakeRequestPtr>::Read(
    ::network::mojom::blink::WebSocketHandshakeRequest::DataView input, ::network::mojom::blink::WebSocketHandshakeRequestPtr* output)
{
    bool success = true;
...
bool StructTraits<::network::mojom::blink::WebSocketHandshakeResponse::DataView, ::network::mojom::blink::WebSocketHandshakeResponsePtr>::Read(
    ::network::mojom::blink::WebSocketHandshakeResponse::DataView input, ::network::mojom::blink::WebSocketHandshakeResponsePtr* output)
{
    bool success = true;
...
void WebSocketAuthenticationHandlerInterceptorForTesting::OnAuthRequired(const ::net::AuthChallengeInfo& info,
    ::network::mojom::blink::HttpResponseHeadersPtr headers, const ::net::IPEndPoint& remote_endpoint, OnAuthRequiredCallback callback)
{
...
void WebSocketAuthenticationHandlerAsyncWaiter::OnAuthRequired(const ::net::AuthChallengeInfo& info, ::network::mojom::blink::HttpResponseHeadersPtr headers,
    const ::net::IPEndPoint& remote_endpoint, ::network::mojom::blink::AuthCredentialsPtr* out_credentials)
{
    base::RunLoop loop;
