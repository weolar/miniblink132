...
MutablePartialNetworkTrafficAnnotationTag::MutablePartialNetworkTrafficAnnotationTag(uint32_t unique_id_hash_code_in, uint32_t completing_id_hash_code_in)
...
void MutablePartialNetworkTrafficAnnotationTag::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("completing_id_hash_code"), this->completing_id_hash_code,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type uint32_t>"
#else
        "<value>"
...
bool MutablePartialNetworkTrafficAnnotationTag::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
// static
bool StructTraits<::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTag::DataView,
    ::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTagPtr>::Read(::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTag::DataView
                                                                                     input,
