...
HttpAuthDynamicParams::HttpAuthDynamicParams(std::optional<std::vector<std::string>> allowed_schemes_in,
    std::vector<std::string> patterns_allowed_to_use_all_schemes_in, const std::string& server_allowlist_in, const std::string& delegate_allowlist_in,
    ...
    const std::string& android_negotiate_account_type_in, bool allow_gssapi_library_load_in, bool basic_over_http_enabled_in)
...
NetworkServiceParams::NetworkServiceParams(::network::mojom::ConnectionType initial_connection_type_in,
    ::network::mojom::ConnectionSubtype initial_connection_subtype_in, std::vector<EnvironmentVariablePtr> environment_in,
    ::mojo::PendingRemote<::network::mojom::URLLoaderNetworkServiceObserver> default_observer_in, bool first_party_sets_enabled_in,
...
SCTAuditingConfiguration::SCTAuditingConfiguration(double sampling_rate_in, ::base::TimeDelta log_expected_ingestion_delay_in,
    ::base::TimeDelta log_max_ingestion_random_delay_in, const ::GURL& report_uri_in, const ::GURL& hashdance_lookup_uri_in,
    ...
    ::mojo::PendingRemote<::network::mojom::NetLogProxySource> in_proxy_source, ::mojo::PendingReceiver<::network::mojom::NetLogProxySink> in_proxy_sink)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::AttachNetLogProxy", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("proxy_source"), in_proxy_source, "<value of type ::mojo::PendingRemote<::network::mojom::NetLogProxySource>>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("proxy_sink"), in_proxy_sink, "<value of type ::mojo::PendingReceiver<::network::mojom::NetLogProxySink>>");
    });
#endif
    ...
    ::mojo::PendingReceiver<::network::mojom::NetworkContext> in_context, ::network::mojom::NetworkContextParamsPtr in_params)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::CreateNetworkContext", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("context"), in_context, "<value of type ::mojo::PendingReceiver<::network::mojom::NetworkContext>>");
...
void NetworkServiceProxy::ConfigureStubHostResolver(bool in_insecure_dns_client_enabled, ::net::SecureDnsMode in_secure_dns_mode,
    const ::net::DnsOverHttpsConfig& in_dns_over_https_config, bool in_additional_dns_types_enabled)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::ConfigureStubHostResolver", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("dns_over_https_config"), in_dns_over_https_config, "<value of type const ::net::DnsOverHttpsConfig&>");
...
void NetworkServiceProxy::GetDnsConfigChangeManager(::mojo::PendingReceiver<::network::mojom::DnsConfigChangeManager> in_receiver)
{
    ...
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::GetDnsConfigChangeManager", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::DnsConfigChangeManager>>");
    });
#endif
...
void NetworkServiceProxy::UpdateCtLogList(std::vector<::network::mojom::CTLogInfoPtr> in_log_list, UpdateCtLogListCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void NetworkServiceProxy::BindTestInterfaceForTesting(::mojo::PendingReceiver<::network::mojom::NetworkServiceTest> in_receiver)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::BindTestInterfaceForTesting", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("receiver"), in_receiver, "<value of type ::mojo::PendingReceiver<::network::mojom::NetworkServiceTest>>");
    });
#endif
...
void NetworkServiceProxy::UpdateMaskedDomainList(::mojo_base::ProtoWrapper in_masked_domain_list, const std::vector<std::string>& in_exclusion_list)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::UpdateMaskedDomainList", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("exclusion_list"), in_exclusion_list, "<value of type const std::vector<std::string>&>");
    });
#endif
...
void NetworkServiceProxy::SetNetworkAnnotationMonitor(::mojo::PendingRemote<::network::mojom::NetworkAnnotationMonitor> in_remote)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::NetworkService::SetNetworkAnnotationMonitor", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("remote"), in_remote, "<value of type ::mojo::PendingRemote<::network::mojom::NetworkAnnotationMonitor>>");
    });
#endif
...
void NetworkServiceProxy::SetTpcdMetadataGrants(const std::vector<::ContentSettingPatternSource>& in_settings)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
private:
    ...
    void Run(const std::optional<std::vector<::net::NetworkInterface>>& in_networks);
};
...
void NetworkService_GetNetworkList_ProxyToResponder::Run(const std::optional<std::vector<::net::NetworkInterface>>& in_networks)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply network::mojom::NetworkService::GetNetworkList", "async_response_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("networks"), in_networks, "<value of type const std::optional<std::vector<::net::NetworkInterface>>&>");
    });
#endif
...
bool NetworkServiceStubDispatch::Accept(NetworkService* impl, mojo::Message* message)
{
    ...
    case messages::NetworkService::kUpdateMaskedDomainList: {
        ...
        std::vector<std::string> p_exclusion_list {};
...
void NetworkServiceInterceptorForTesting::StartNetLog(
    ::base::File file, uint64_t max_total_size, ::net::NetLogCaptureMode capture_mode, ::base::Value::Dict constants)
{
...
void NetworkServiceInterceptorForTesting::CreateNetworkContext(
    ::mojo::PendingReceiver<::network::mojom::NetworkContext> context, ::network::mojom::NetworkContextParamsPtr params)
{
    GetForwardingInterface()->CreateNetworkContext(std::move(context), std::move(params));
}
void NetworkServiceInterceptorForTesting::ConfigureStubHostResolver(bool insecure_dns_client_enabled, ::net::SecureDnsMode secure_dns_mode,
...
void NetworkServiceInterceptorForTesting::UpdateCtKnownPopularSCTs(
    const std::vector<std::vector<uint8_t>>& sct_hashes, UpdateCtKnownPopularSCTsCallback callback)
{
...
void NetworkServiceInterceptorForTesting::ParseHeaders(
    const ::GURL& url, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ParseHeadersCallback callback)
{
...
void NetworkServiceAsyncWaiter::GetNetworkList(uint32_t policy, std::optional<std::vector<::net::NetworkInterface>>* out_networks)
{
    base::RunLoop loop;
    proxy_->GetNetworkList(std::move(policy),
        base::BindOnce(
            [](base::RunLoop* loop, std::optional<std::vector<::net::NetworkInterface>>* out_networks,
                const std::optional<std::vector<::net::NetworkInterface>>& networks) {
...
std::optional<std::vector<::net::NetworkInterface>> NetworkServiceAsyncWaiter::GetNetworkList(uint32_t policy)
{
...
void NetworkServiceAsyncWaiter::UpdateCtLogList(std::vector<::network::mojom::CTLogInfoPtr> log_list)
{
    base::RunLoop loop;
