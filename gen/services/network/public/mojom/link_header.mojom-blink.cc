...
LinkHeader::LinkHeader(const ::blink::KURL& href_in, LinkRelAttribute rel_in, LinkAsAttribute as_in, CrossOriginAttribute cross_origin_in,
...
bool StructTraits<::network::mojom::blink::LinkHeader::DataView, ::network::mojom::blink::LinkHeaderPtr>::Read(
    ::network::mojom::blink::LinkHeader::DataView input, ::network::mojom::blink::LinkHeaderPtr* output)
{
    bool success = true;
