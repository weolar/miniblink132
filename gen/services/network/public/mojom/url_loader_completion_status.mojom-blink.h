    ...
    : reason()
{
    ...
    explicit BlockedByResponseReasonWrapper(::network::mojom::blink::BlockedByResponseReason reason_in)
    ...
    {
        return mojo::internal::SerializeImpl<BlockedByResponseReasonWrapper::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    , should_collapse_initiator(false)
{
    ...
    template <typename UserType> static WTF::Vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<URLLoaderCompletionStatus::DataView, WTF::Vector<uint8_t>>(input);
    }
...
struct BLINK_PLATFORM_EXPORT
    StructTraits<::network::mojom::blink::BlockedByResponseReasonWrapper::DataView, ::network::mojom::blink::BlockedByResponseReasonWrapperPtr> {
    static bool IsNull(const ::network::mojom::blink::BlockedByResponseReasonWrapperPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::BlockedByResponseReasonWrapperPtr* output)
    {
        output->reset();
    }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLLoaderCompletionStatus::DataView, ::network::mojom::blink::URLLoaderCompletionStatusPtr> {
    static bool IsNull(const ::network::mojom::blink::URLLoaderCompletionStatusPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::URLLoaderCompletionStatusPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::network::mojom::blink::URLLoaderCompletionStatus::exists_in_memory_cache) exists_in_memory_cache(
        const ::network::mojom::blink::URLLoaderCompletionStatusPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::URLLoaderCompletionStatus::private_network_access_preflight_result) private_network_access_preflight_result(
        const ::network::mojom::blink::URLLoaderCompletionStatusPtr& input)
    {
