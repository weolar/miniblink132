...
class BLINK_PLATFORM_EXPORT UDPSocket : public UDPSocketInterfaceBase {
public:
...
class BLINK_PLATFORM_EXPORT UDPSocketListener : public UDPSocketListenerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_PLATFORM_EXPORT UDPSocketProxy : public UDPSocket {
//public:
...
//class BLINK_PLATFORM_EXPORT UDPSocketListenerProxy : public UDPSocketListener {
//public:
    ...
    , ipv6_only()
{
    ...
    UDPSocketOptions(bool allow_address_reuse_in, bool allow_broadcast_in, bool allow_address_sharing_for_multicast_in,
    ...
    {
        return mojo::internal::SerializeImpl<UDPSocketOptions::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::UDPSocketOptions::DataView, ::network::mojom::blink::UDPSocketOptionsPtr> {
    static bool IsNull(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::UDPSocketOptionsPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::network::mojom::blink::UDPSocketOptions::allow_broadcast) allow_broadcast(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::UDPSocketOptions::send_buffer_size) send_buffer_size(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
    ...
    static decltype(::network::mojom::blink::UDPSocketOptions::ipv6_only) ipv6_only(const ::network::mojom::blink::UDPSocketOptionsPtr& input)
    {
