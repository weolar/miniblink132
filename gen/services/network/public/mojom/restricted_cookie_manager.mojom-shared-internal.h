...
static_assert(sizeof(CookieManagerGetOptions_Data) == 24, "Bad sizeof(CookieManagerGetOptions_Data)");
// Used by CookieManagerGetOptions::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct CookieManagerGetOptions_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    CookieManagerGetOptions_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag CookieManagerGetOptions_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
