...
SiteForCookies::SiteForCookies(const ::net::SchemefulSite& site_in, bool schemefully_same_in)
...
bool StructTraits<::network::mojom::SiteForCookies::DataView, ::network::mojom::SiteForCookiesPtr>::Read(
    ::network::mojom::SiteForCookies::DataView input, ::network::mojom::SiteForCookiesPtr* output)
{
    bool success = true;
