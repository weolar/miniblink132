...
RequestParams::RequestParams(const ::scoped_refptr<::net::X509Certificate>& certificate_in, const std::string& hostname_in, int32_t flags_in,
...
void URLLoaderFactoryConnectorProxy::CreateURLLoaderFactory(::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> in_url_loader_factory)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1(
...
void CertVerifierServiceProxy::Verify(const ::net::CertVerifier::RequestParams& in_params, const ::net::NetLogSource& in_net_log_source,
    ::mojo::PendingRemote<CertVerifierRequest> in_cert_verifier_request)
{
    ...
    TRACE_EVENT1("mojom", "Send cert_verifier::mojom::CertVerifierService::Verify", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("params"), in_params, "<value of type const ::net::CertVerifier::RequestParams&>");
...
void CertVerifierServiceProxy::SetConfig(const ::net::CertVerifier::Config& in_config)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send cert_verifier::mojom::CertVerifierService::SetConfig", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("config"), in_config, "<value of type const ::net::CertVerifier::Config&>");
    });
#endif
...
{
    const char* name = ::cert_verifier::mojom::CertVerifierServiceClient::Name_;
...
void CertVerifierRequestProxy::Complete(const ::net::CertVerifyResult& in_result, int32_t in_net_error)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send cert_verifier::mojom::CertVerifierRequest::Complete", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type const ::net::CertVerifyResult&>");
...
bool StructTraits<::cert_verifier::mojom::RequestParams::DataView, ::cert_verifier::mojom::RequestParamsPtr>::Read(
    ::cert_verifier::mojom::RequestParams::DataView input, ::cert_verifier::mojom::RequestParamsPtr* output)
{
    bool success = true;
...
bool StructTraits<::cert_verifier::mojom::CertVerifierConfig::DataView, ::cert_verifier::mojom::CertVerifierConfigPtr>::Read(
    ::cert_verifier::mojom::CertVerifierConfig::DataView input, ::cert_verifier::mojom::CertVerifierConfigPtr* output)
{
    bool success = true;
...
void CertVerifierServiceInterceptorForTesting::EnableNetworkAccess(
    ::mojo::PendingRemote<::network::mojom::URLLoaderFactory> url_loader_factory, ::mojo::PendingRemote<URLLoaderFactoryConnector> reconnector)
{
    GetForwardingInterface()->EnableNetworkAccess(std::move(url_loader_factory), std::move(reconnector));
}
void CertVerifierServiceInterceptorForTesting::Verify(const ::net::CertVerifier::RequestParams& params, const ::net::NetLogSource& net_log_source,
