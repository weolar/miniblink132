...
ProxyConfigWithAnnotation::ProxyConfigWithAnnotation(const ::net::ProxyConfig& value_in, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation_in)
...
void ProxyConfigClientProxy::OnProxyConfigUpdated(const ::net::ProxyConfigWithAnnotation& in_proxy_config)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ProxyConfigClient::OnProxyConfigUpdated", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("proxy_config"), in_proxy_config, "<value of type const ::net::ProxyConfigWithAnnotation&>");
    });
#endif
...
void ProxyErrorClientProxy::OnPACScriptError(int32_t in_line_number, const std::string& in_details)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send network::mojom::ProxyErrorClient::OnPACScriptError", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("details"), in_details, "<value of type const std::string&>");
    });
#endif
...
bool StructTraits<::network::mojom::ProxyConfigWithAnnotation::DataView, ::network::mojom::ProxyConfigWithAnnotationPtr>::Read(
    ::network::mojom::ProxyConfigWithAnnotation::DataView input, ::network::mojom::ProxyConfigWithAnnotationPtr* output)
{
    bool success = true;
