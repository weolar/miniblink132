...
TLSClientSocketOptions::TLSClientSocketOptions(
    ::network::mojom::SSLVersion version_min_in, ::network::mojom::SSLVersion version_max_in, bool send_ssl_info_in, bool unsafely_skip_cert_verification_in)
...
bool StructTraits<::network::mojom::TLSClientSocketOptions::DataView, ::network::mojom::TLSClientSocketOptionsPtr>::Read(
    ::network::mojom::TLSClientSocketOptions::DataView input, ::network::mojom::TLSClientSocketOptionsPtr* output)
{
    bool success = true;
