...
template <typename ImplRefTraits> class ProxyConfigClientStub;

class ProxyConfigClientRequestValidator;
class ProxyConfigClientResponseValidator;

class ProxyConfigClient : public ProxyConfigClientInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = ProxyConfigClientStub<ImplRefTraits>;
...
template <typename ImplRefTraits> class ProxyConfigPollerClientStub;

class ProxyConfigPollerClientRequestValidator;

class ProxyConfigPollerClient : public ProxyConfigPollerClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
    ...
    template <typename ImplRefTraits> using Stub_ = ProxyConfigPollerClientStub<ImplRefTraits>;
...
template <typename ImplRefTraits> class ProxyErrorClientStub;

class ProxyErrorClientRequestValidator;

class ProxyErrorClient : public ProxyErrorClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
    ...
    template <typename ImplRefTraits> using Stub_ = ProxyErrorClientStub<ImplRefTraits>;
...
class ProxyConfigClientProxy : public ProxyConfigClient {
public:
...
class ProxyConfigPollerClientProxy : public ProxyConfigPollerClient {
public:
...
class ProxyErrorClientProxy : public ProxyErrorClient {
public:
...
public:
    ...
    static bool AcceptWithResponder(ProxyConfigClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<ProxyConfigClient>> class ProxyConfigClientStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return ProxyConfigClientStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return ProxyConfigClientStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
...
public:
    ...
    static bool AcceptWithResponder(ProxyConfigPollerClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<ProxyConfigPollerClient>>
//class ProxyConfigPollerClientStub : public mojo::MessageReceiverWithResponderStatus {
//public:
//    using ImplPointerType = typename ImplRefTraits::PointerType;
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return ProxyConfigPollerClientStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
//    bool AcceptWithResponder(mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder) override
//    {
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return ProxyConfigPollerClientStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
//    ImplPointerType sink_;
...
public:
    ...
    static bool AcceptWithResponder(ProxyErrorClient* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<ProxyErrorClient>> class ProxyErrorClientStub : public mojo::MessageReceiverWithResponderStatus {
//public:
//    using ImplPointerType = typename ImplRefTraits::PointerType;
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return ProxyErrorClientStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
//    bool AcceptWithResponder(mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder) override
//    {
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return ProxyErrorClientStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
//    ImplPointerType sink_;
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<ProxyConfigWithAnnotation, T>::value>;
    using DataView = ProxyConfigWithAnnotationDataView;
    using Data_ = internal::ProxyConfigWithAnnotation_Data;

    template <typename... Args> static ProxyConfigWithAnnotationPtr New(Args&&... args)
    {
        return ProxyConfigWithAnnotationPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static ProxyConfigWithAnnotationPtr From(const U& u)
    {
    ...
    ProxyConfigWithAnnotation(::network::mojom::blink::ProxyConfigPtr value, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation);
    ...
    template <typename StructPtrType = ProxyConfigWithAnnotationPtr> ProxyConfigWithAnnotationPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    {
        return mojo::internal::SerializeAsMessageImpl<ProxyConfigWithAnnotation::DataView>(input);
    }
    ...
    {
        return mojo::Message(std::make_unique<internal::ProxyConfigWithAnnotation_UnserializedMessageContext<UserType, ProxyConfigWithAnnotation::DataView>>(
                                 0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        ...
        return mojo::internal::DeserializeImpl<ProxyConfigWithAnnotation::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return ProxyConfigWithAnnotation::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::ProxyConfigWithAnnotation_UnserializedMessageContext<UserType, ProxyConfigWithAnnotation::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<ProxyConfigWithAnnotation::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
template <typename StructPtrType> ProxyConfigWithAnnotationPtr ProxyConfigWithAnnotation::Clone() const
{
    return New(mojo::Clone(value), mojo::Clone(traffic_annotation));
}

template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>*> bool ProxyConfigWithAnnotation::Equals(const T& other_struct) const
{
...
template <typename T, ProxyConfigWithAnnotation::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <> struct StructTraits<::network::mojom::blink::ProxyConfigWithAnnotation::DataView, ::network::mojom::blink::ProxyConfigWithAnnotationPtr> {
    static bool IsNull(const ::network::mojom::blink::ProxyConfigWithAnnotationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::network::mojom::blink::ProxyConfigWithAnnotationPtr* output)
    {
        output->reset();
    }

    static decltype(::network::mojom::blink::ProxyConfigWithAnnotation::value)& value(::network::mojom::blink::ProxyConfigWithAnnotationPtr& input)
    {
        return input->value;
    }
