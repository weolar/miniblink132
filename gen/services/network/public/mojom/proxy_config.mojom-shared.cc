...
// static
bool ProxyBypassRules_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const ProxyBypassRules_Data* object = static_cast<const ProxyBypassRules_Data*>(data);
...
// static
bool ProxyList_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    if (!ValidateUnversionedStructHeaderAndSizeAndClaimMemory(data, 16, validation_context)) {
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const ProxyList_Data* object = static_cast<const ProxyList_Data*>(data);

    if (!mojo::internal::ValidatePointerNonNullable(object->proxies, 1, validation_context)) {
        return false;
    }
    ...
    if (!mojo::internal::ValidateContainer(object->proxies, validation_context, &proxies_validate_params)) {
        return false;
    }
...
// static
bool ProxyRules_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const ProxyRules_Data* object = static_cast<const ProxyRules_Data*>(data);

    if (!mojo::internal::ValidatePointerNonNullable(object->bypass_rules, 1, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->bypass_rules, validation_context))
        return false;

    if (!::network::mojom::internal::ProxyRulesType_Data ::Validate(object->type, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->single_proxies, 4, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->single_proxies, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->proxies_for_http, 5, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->proxies_for_http, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->proxies_for_https, 6, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->proxies_for_https, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->proxies_for_ftp, 7, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->proxies_for_ftp, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->fallback_proxies, 8, validation_context)) {
        return false;
    }
...
// static
bool ProxyConfig_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const ProxyConfig_Data* object = static_cast<const ProxyConfig_Data*>(data);

    if (!mojo::internal::ValidatePointerNonNullable(object->pac_url, 3, validation_context)) {
        return false;
    }
    if (!mojo::internal::ValidateStruct(object->pac_url, validation_context))
        return false;

    if (!mojo::internal::ValidatePointerNonNullable(object->proxy_rules, 5, validation_context)) {
        return false;
    }
...
// static
void TraceFormatTraits<::network::mojom::ProxyRulesType>::WriteIntoTrace(perfetto::TracedValue context, ::network::mojom::ProxyRulesType value)
{
