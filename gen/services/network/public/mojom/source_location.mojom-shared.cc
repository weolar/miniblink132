...
// static
bool SourceLocation_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const SourceLocation_Data* object = static_cast<const SourceLocation_Data*>(data);
