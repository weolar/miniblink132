...
CorsErrorStatus::CorsErrorStatus(CorsError cors_error_in, const std::string& failed_parameter_in, ::network::mojom::IPAddressSpace target_address_space_in,
...
bool StructTraits<::network::mojom::CorsErrorStatus::DataView, ::network::mojom::CorsErrorStatusPtr>::Read(
    ::network::mojom::CorsErrorStatus::DataView input, ::network::mojom::CorsErrorStatusPtr* output)
{
    bool success = true;
