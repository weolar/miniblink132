...
using SingularUkmInterfaceInterfaceBase = SingularUkmInterfaceInterfaceBase;
using UkmRecorderClientInterfaceInterfaceBase = UkmRecorderClientInterfaceInterfaceBase;
using UkmRecorderInterfaceInterfaceBase = UkmRecorderInterfaceInterfaceBase;
using UkmRecorderFactoryInterfaceBase = UkmRecorderFactoryInterfaceBase;
class UkmEntry;
