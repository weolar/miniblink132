// services/service_manager/public/mojom/connector.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<Identity_Data>;

    Identity_Data();
    ~Identity_Data() = delete;
};
static_assert(sizeof(Identity_Data) == 40, "Bad sizeof(Identity_Data)");
// Used by Identity::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct Identity_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    Identity_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<Identity_Data> fragment(message);
...
const mojo::internal::UnserializedMessageContext::Tag Identity_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
static_assert(sizeof(ServiceInfo_Data) == 16, "Bad sizeof(ServiceInfo_Data)");
// Used by ServiceInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct ServiceInfo_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    ServiceInfo_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
        : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
        , user_data_(std::move(input))
    {
    }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag ServiceInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
