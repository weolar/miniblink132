// services/service_manager/public/mojom/service_manager.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<RunningServiceInfo_Data>;

    RunningServiceInfo_Data();
    ~RunningServiceInfo_Data() = delete;
};
static_assert(sizeof(RunningServiceInfo_Data) == 24, "Bad sizeof(RunningServiceInfo_Data)");
// Used by RunningServiceInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct RunningServiceInfo_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    RunningServiceInfo_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<RunningServiceInfo_Data> fragment(message);
...
const mojo::internal::UnserializedMessageContext::Tag RunningServiceInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
