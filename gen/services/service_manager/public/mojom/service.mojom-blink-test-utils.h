// services/service_manager/public/mojom/service.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class COMPONENT_EXPORT(SERVICE_MANAGER_MOJOM_BLINK) ServiceInterceptorForTesting : public Service {
    ...
    void OnBindInterface(
        BindSourceInfoPtr source, const WTF::String& interface_name, ::mojo::ScopedMessagePipeHandle interface_pipe, OnBindInterfaceCallback callback) override;
    void CreatePackagedServiceInstance(::service_manager::mojom::blink::IdentityPtr identity, ::mojo::PendingReceiver<Service> receiver,
        ::mojo::PendingRemote<::service_manager::mojom::blink::ProcessMetadata> metadata) override;
};
...
public:
    ...
    ~ServiceAsyncWaiter();
    void OnStart(::service_manager::mojom::blink::IdentityPtr identity,
    ...
    void OnBindInterface(BindSourceInfoPtr source, const WTF::String& interface_name, ::mojo::ScopedMessagePipeHandle interface_pipe);
