// services/webnn/public/mojom/webnn_error.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/webnn/public/mojom/webnn_error.mojom-blink-test-utils.h"
...
Error::Error(Error::Code code_in, const WTF::String& message_in)
...
// static
bool StructTraits<::webnn::mojom::blink::Error::DataView, ::webnn::mojom::blink::ErrorPtr>::Read(
    ::webnn::mojom::blink::Error::DataView input, ::webnn::mojom::blink::ErrorPtr* output)
{
    bool success = true;
    ::webnn::mojom::blink::ErrorPtr result(::webnn::mojom::blink::Error::New());
