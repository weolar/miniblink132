...
class COMPONENT_EXPORT(WEBNN_MOJOM) WebNNGraph : public WebNNGraphInterfaceBase {
public:
...
class COMPONENT_EXPORT(WEBNN_MOJOM) WebNNGraphProxy : public WebNNGraph {
public:
    ...
    void Dispatch(const base::flat_map<std::string, ::blink::WebNNTensorToken>& named_inputs,
        const base::flat_map<std::string, ::blink::WebNNTensorToken>& named_outputs) final;
...
public:
    ...
    {
        return mojo::internal::SerializeImpl<Size2d::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    ElementWiseUnary(ElementWiseUnary::Kind kind, uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ElementWiseUnary::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Expand(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Expand::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ConstantPadding::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<EdgePadding::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ReflectionPadding::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SymmetricPadding::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Matmul(uint64_t a_operand_id, uint64_t b_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Matmul::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) Range {
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Range::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Elu(uint64_t input_operand_id, uint64_t output_operand_id, float alpha, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Elu::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) GatherND {
public:
    ...
    GatherND(uint64_t input_operand_id, uint64_t indices_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<GatherND::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Gelu(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Gelu::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    HardSwish(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<HardSwish::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    LeakyRelu(uint64_t input_operand_id, uint64_t output_operand_id, float alpha, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<LeakyRelu::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Prelu(uint64_t input_operand_id, uint64_t slope_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Prelu::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Relu(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Relu::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Reshape(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Reshape::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Sigmoid(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Sigmoid::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Softmax(uint64_t input_operand_id, uint64_t output_operand_id, uint32_t axis, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Softmax::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Softplus(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Softplus::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Softsign(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Softsign::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Tanh(uint64_t input_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Tanh::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    static ComputeResultPtr NewNamedOutputs(base::flat_map<std::string, ::mojo_base::BigBuffer> value)
    {
    ...
    static ComputeResultPtr NewError(::webnn::mojom::ErrorPtr value)
    {
        auto result = ComputeResultPtr(std::in_place);
    ...
    base::flat_map<std::string, ::mojo_base::BigBuffer>& get_named_outputs() const
    {
        CHECK(tag_ == Tag::kNamedOutputs);
        return *(data_.named_outputs);
    }

    void set_named_outputs(base::flat_map<std::string, ::mojo_base::BigBuffer> named_outputs);
...
public:
    ...
    OperandDescriptor(DataType data_type, std::vector<uint32_t> shape);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<OperandDescriptor::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Operand(Operand::Kind kind, const ::webnn::OperandDescriptor& descriptor, const std::optional<std::string>& name);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Operand::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    ArgMinMax(ArgMinMax::Kind kind, uint64_t input_operand_id, uint64_t output_operand_id, uint32_t axis, bool keep_dimensions, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ArgMinMax::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    BatchNormalization(uint64_t input_operand_id, uint64_t mean_operand_id, uint64_t variance_operand_id, uint64_t output_operand_id,
        std::optional<uint64_t> scale_operand_id, std::optional<uint64_t> bias_operand_id, uint32_t axis, float epsilon, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<BatchNormalization::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Clamp(uint64_t input_operand_id, uint64_t output_operand_id, float min_value, float max_value, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Clamp::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Concat(std::vector<uint64_t> input_operand_ids, uint64_t output_operand_id, uint32_t axis, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Concat::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Padding2d::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Conv2d(Conv2d::Kind kind, uint64_t input_operand_id, uint64_t filter_operand_id, uint64_t output_operand_id, Padding2dPtr padding, Size2dPtr strides,
        Size2dPtr dilations, uint32_t groups, std::optional<uint64_t> bias_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Conv2d::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) CumulativeSum {
public:
    ...
    CumulativeSum(uint64_t input_operand_id, uint64_t output_operand_id, uint32_t axis, bool exclusive, bool reversed, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<CumulativeSum::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) DequantizeLinear {
public:
    ...
    DequantizeLinear(
        uint64_t input_operand_id, uint64_t scale_operand_id, uint64_t zero_point_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<DequantizeLinear::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    ElementWiseBinary(ElementWiseBinary::Kind kind, uint64_t lhs_operand_id, uint64_t rhs_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ElementWiseBinary::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    InstanceNormalization(uint64_t input_operand_id, uint64_t output_operand_id, std::optional<uint64_t> scale_operand_id,
        std::optional<uint64_t> bias_operand_id, float epsilon, ::webnn::mojom::InputOperandLayout layout, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<InstanceNormalization::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Pad(uint64_t input_operand_id, uint64_t output_operand_id, std::vector<uint32_t> beginning_padding, std::vector<uint32_t> ending_padding,
        PaddingModePtr mode, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Pad::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Reduce(
        Reduce::Kind kind, uint64_t input_operand_id, uint64_t output_operand_id, std::vector<uint32_t> axes, bool keep_dimensions, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Reduce::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Pool2d(Pool2d::Kind kind, uint64_t input_operand_id, uint64_t output_operand_id, Size2dPtr window_dimensions, Padding2dPtr padding, Size2dPtr strides,
        Size2dPtr dilations, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Pool2d::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Slice(uint64_t input_operand_id, uint64_t output_operand_id, std::vector<::webnn::Range> ranges, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Slice::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Gather(uint64_t input_operand_id, uint64_t indices_operand_id, uint64_t output_operand_id, uint32_t axis, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Gather::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    GatherElements(uint64_t input_operand_id, uint64_t indices_operand_id, uint64_t output_operand_id, uint32_t axis, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<GatherElements::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Gru(uint64_t input_operand_id, uint64_t weight_operand_id, uint64_t recurrent_weight_operand_id, uint32_t steps, uint32_t hidden_size,
        std::vector<uint64_t> output_operand_ids, std::optional<uint64_t> bias_operand_id, std::optional<uint64_t> recurrent_bias_operand_id,
        ...
        GruWeightLayout layout, std::vector<RecurrentNetworkActivation> activations, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Gru::DataView, std::vector<uint8_t>>(input);
    }
    ...
    std::vector<RecurrentNetworkActivation> activations;
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<GruCell::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Gemm(uint64_t a_operand_id, uint64_t b_operand_id, uint64_t output_operand_id, std::optional<uint64_t> c_operand_id, float alpha, float beta,
        bool a_transpose, bool b_transpose, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Gemm::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    HardSigmoid(uint64_t input_operand_id, uint64_t output_operand_id, float alpha, float beta, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<HardSigmoid::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    LayerNormalization(uint64_t input_operand_id, uint64_t output_operand_id, std::optional<uint64_t> scale_operand_id, std::optional<uint64_t> bias_operand_id,
        std::vector<uint32_t> axes, float epsilon, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<LayerNormalization::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Linear(uint64_t input_operand_id, uint64_t output_operand_id, float alpha, float beta, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Linear::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Lstm(uint64_t input_operand_id, uint64_t weight_operand_id, uint64_t recurrent_weight_operand_id, std::vector<uint64_t> output_operand_ids, uint32_t steps,
        ...
        std::vector<RecurrentNetworkActivation> activations, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Lstm::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    LstmCell(uint64_t input_operand_id, uint64_t weight_operand_id, uint64_t recurrent_weight_operand_id, uint64_t hidden_state_operand_id,
        uint64_t cell_state_operand_id, std::vector<uint64_t> output_operand_ids, uint32_t hidden_size, std::optional<uint64_t> bias_operand_id,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<LstmCell::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) QuantizeLinear {
public:
    ...
    QuantizeLinear(uint64_t input_operand_id, uint64_t scale_operand_id, uint64_t zero_point_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<QuantizeLinear::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) ScatterElements {
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ScatterElements::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) ScatterND {
public:
    ...
    ScatterND(uint64_t input_operand_id, uint64_t indices_operand_id, uint64_t updates_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ScatterND::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Split(uint64_t input_operand_id, std::vector<uint64_t> output_operand_ids, uint32_t axis, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Split::DataView, std::vector<uint8_t>>(input);
    }
...
class COMPONENT_EXPORT(WEBNN_MOJOM) Tile {
public:
    ...
    Tile(uint64_t input_operand_id, uint64_t output_operand_id, std::vector<uint32_t> repetitions, const std::string& label);
...
public:
    ...
    Transpose(uint64_t input_operand_id, uint64_t output_operand_id, std::vector<uint32_t> permutation, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Transpose::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Triangular(uint64_t input_operand_id, uint64_t output_operand_id, bool upper, int32_t diagonal, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Triangular::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Resample2d(uint64_t input_operand_id, uint64_t output_operand_id, Resample2d::InterpolationMode mode, std::optional<std::vector<float>> scales,
        std::vector<uint32_t> axes, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Resample2d::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    Where(uint64_t condition_operand_id, uint64_t true_value_operand_id, uint64_t false_value_operand_id, uint64_t output_operand_id, const std::string& label);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<Where::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    GraphInfo(base::flat_map<uint64_t, OperandPtr> id_to_operand_map, std::vector<uint64_t> input_operands, std::vector<uint64_t> output_operands,
        std::vector<OperationPtr> operations, base::flat_map<uint64_t, ::mojo_base::BigBuffer> constant_id_to_buffer_map);
    ...
    base::flat_map<uint64_t, OperandPtr> id_to_operand_map;

    std::vector<uint64_t> input_operands;

    std::vector<uint64_t> output_operands;
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::OperandDescriptor::DataView, ::webnn::mojom::OperandDescriptorPtr> {
    static bool IsNull(const ::webnn::mojom::OperandDescriptorPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::OperandDescriptorPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::OperandDescriptor::data_type) data_type(const ::webnn::mojom::OperandDescriptorPtr& input)
    {
        return input->data_type;
    }

    static const decltype(::webnn::mojom::OperandDescriptor::shape)& shape(const ::webnn::mojom::OperandDescriptorPtr& input)
    {
        return input->shape;
    }

    static bool Read(::webnn::mojom::OperandDescriptor::DataView input, ::webnn::mojom::OperandDescriptorPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Operand::DataView, ::webnn::mojom::OperandPtr> {
    static bool IsNull(const ::webnn::mojom::OperandPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::OperandPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Operand::kind) kind(const ::webnn::mojom::OperandPtr& input)
    {
        return input->kind;
    }

    static const decltype(::webnn::mojom::Operand::descriptor)& descriptor(const ::webnn::mojom::OperandPtr& input)
    {
        return input->descriptor;
    }

    static const decltype(::webnn::mojom::Operand::name)& name(const ::webnn::mojom::OperandPtr& input)
    {
        return input->name;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::ArgMinMax::DataView, ::webnn::mojom::ArgMinMaxPtr> {
    static bool IsNull(const ::webnn::mojom::ArgMinMaxPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ArgMinMaxPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::ArgMinMax::kind) kind(const ::webnn::mojom::ArgMinMaxPtr& input)
    {
        return input->kind;
    }

    static decltype(::webnn::mojom::ArgMinMax::input_operand_id) input_operand_id(const ::webnn::mojom::ArgMinMaxPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::ArgMinMax::output_operand_id) output_operand_id(const ::webnn::mojom::ArgMinMaxPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::ArgMinMax::axis) axis(const ::webnn::mojom::ArgMinMaxPtr& input)
    {
        return input->axis;
    }

    static decltype(::webnn::mojom::ArgMinMax::keep_dimensions) keep_dimensions(const ::webnn::mojom::ArgMinMaxPtr& input)
    {
        return input->keep_dimensions;
    }

    static const decltype(::webnn::mojom::ArgMinMax::label)& label(const ::webnn::mojom::ArgMinMaxPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::BatchNormalization::DataView, ::webnn::mojom::BatchNormalizationPtr> {
    static bool IsNull(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::BatchNormalizationPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::BatchNormalization::input_operand_id) input_operand_id(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::BatchNormalization::mean_operand_id) mean_operand_id(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->mean_operand_id;
    }

    static decltype(::webnn::mojom::BatchNormalization::variance_operand_id) variance_operand_id(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->variance_operand_id;
    }

    static decltype(::webnn::mojom::BatchNormalization::output_operand_id) output_operand_id(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::BatchNormalization::scale_operand_id) scale_operand_id(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->scale_operand_id;
    }

    static decltype(::webnn::mojom::BatchNormalization::bias_operand_id) bias_operand_id(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->bias_operand_id;
    }

    static decltype(::webnn::mojom::BatchNormalization::axis) axis(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->axis;
    }

    static decltype(::webnn::mojom::BatchNormalization::epsilon) epsilon(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->epsilon;
    }

    static const decltype(::webnn::mojom::BatchNormalization::label)& label(const ::webnn::mojom::BatchNormalizationPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Clamp::DataView, ::webnn::mojom::ClampPtr> {
    static bool IsNull(const ::webnn::mojom::ClampPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ClampPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Clamp::input_operand_id) input_operand_id(const ::webnn::mojom::ClampPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Clamp::output_operand_id) output_operand_id(const ::webnn::mojom::ClampPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Clamp::min_value) min_value(const ::webnn::mojom::ClampPtr& input)
    {
        return input->min_value;
    }

    static decltype(::webnn::mojom::Clamp::max_value) max_value(const ::webnn::mojom::ClampPtr& input)
    {
        return input->max_value;
    }

    static const decltype(::webnn::mojom::Clamp::label)& label(const ::webnn::mojom::ClampPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Clamp::DataView input, ::webnn::mojom::ClampPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Concat::DataView, ::webnn::mojom::ConcatPtr> {
    static bool IsNull(const ::webnn::mojom::ConcatPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ConcatPtr* output)
    {
        output->reset();
    }

    static const decltype(::webnn::mojom::Concat::input_operand_ids)& input_operand_ids(const ::webnn::mojom::ConcatPtr& input)
    {
        return input->input_operand_ids;
    }

    static decltype(::webnn::mojom::Concat::output_operand_id) output_operand_id(const ::webnn::mojom::ConcatPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Concat::axis) axis(const ::webnn::mojom::ConcatPtr& input)
    {
        return input->axis;
    }

    static const decltype(::webnn::mojom::Concat::label)& label(const ::webnn::mojom::ConcatPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Concat::DataView input, ::webnn::mojom::ConcatPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Size2d::DataView, ::webnn::mojom::Size2dPtr> {
    static bool IsNull(const ::webnn::mojom::Size2dPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::Size2dPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Size2d::height) height(const ::webnn::mojom::Size2dPtr& input)
    {
        return input->height;
    }

    static decltype(::webnn::mojom::Size2d::width) width(const ::webnn::mojom::Size2dPtr& input)
    {
        return input->width;
    }

    static bool Read(::webnn::mojom::Size2d::DataView input, ::webnn::mojom::Size2dPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Padding2d::DataView, ::webnn::mojom::Padding2dPtr> {
    static bool IsNull(const ::webnn::mojom::Padding2dPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::Padding2dPtr* output)
    {
        output->reset();
    }

    static const decltype(::webnn::mojom::Padding2d::beginning)& beginning(const ::webnn::mojom::Padding2dPtr& input)
    {
        return input->beginning;
    }

    static const decltype(::webnn::mojom::Padding2d::ending)& ending(const ::webnn::mojom::Padding2dPtr& input)
    {
        return input->ending;
    }

    static bool Read(::webnn::mojom::Padding2d::DataView input, ::webnn::mojom::Padding2dPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Conv2d::DataView, ::webnn::mojom::Conv2dPtr> {
    static bool IsNull(const ::webnn::mojom::Conv2dPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::Conv2dPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Conv2d::kind) kind(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->kind;
    }

    static decltype(::webnn::mojom::Conv2d::input_operand_id) input_operand_id(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Conv2d::filter_operand_id) filter_operand_id(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->filter_operand_id;
    }

    static decltype(::webnn::mojom::Conv2d::output_operand_id) output_operand_id(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Conv2d::padding)& padding(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->padding;
    }

    static const decltype(::webnn::mojom::Conv2d::strides)& strides(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->strides;
    }

    static const decltype(::webnn::mojom::Conv2d::dilations)& dilations(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->dilations;
    }

    static decltype(::webnn::mojom::Conv2d::groups) groups(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->groups;
    }

    static decltype(::webnn::mojom::Conv2d::bias_operand_id) bias_operand_id(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->bias_operand_id;
    }

    static const decltype(::webnn::mojom::Conv2d::label)& label(const ::webnn::mojom::Conv2dPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Conv2d::DataView input, ::webnn::mojom::Conv2dPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::CumulativeSum::DataView, ::webnn::mojom::CumulativeSumPtr> {
    static bool IsNull(const ::webnn::mojom::CumulativeSumPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::CumulativeSumPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::CumulativeSum::input_operand_id) input_operand_id(const ::webnn::mojom::CumulativeSumPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::CumulativeSum::output_operand_id) output_operand_id(const ::webnn::mojom::CumulativeSumPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::CumulativeSum::axis) axis(const ::webnn::mojom::CumulativeSumPtr& input)
    {
        return input->axis;
    }

    static decltype(::webnn::mojom::CumulativeSum::exclusive) exclusive(const ::webnn::mojom::CumulativeSumPtr& input)
    {
        return input->exclusive;
    }

    static decltype(::webnn::mojom::CumulativeSum::reversed) reversed(const ::webnn::mojom::CumulativeSumPtr& input)
    {
        return input->reversed;
    }

    static const decltype(::webnn::mojom::CumulativeSum::label)& label(const ::webnn::mojom::CumulativeSumPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::CumulativeSum::DataView input, ::webnn::mojom::CumulativeSumPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::DequantizeLinear::DataView, ::webnn::mojom::DequantizeLinearPtr> {
    static bool IsNull(const ::webnn::mojom::DequantizeLinearPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::DequantizeLinearPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::DequantizeLinear::input_operand_id) input_operand_id(const ::webnn::mojom::DequantizeLinearPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::DequantizeLinear::scale_operand_id) scale_operand_id(const ::webnn::mojom::DequantizeLinearPtr& input)
    {
        return input->scale_operand_id;
    }

    static decltype(::webnn::mojom::DequantizeLinear::zero_point_operand_id) zero_point_operand_id(const ::webnn::mojom::DequantizeLinearPtr& input)
    {
        return input->zero_point_operand_id;
    }

    static decltype(::webnn::mojom::DequantizeLinear::output_operand_id) output_operand_id(const ::webnn::mojom::DequantizeLinearPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::DequantizeLinear::label)& label(const ::webnn::mojom::DequantizeLinearPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::DequantizeLinear::DataView input, ::webnn::mojom::DequantizeLinearPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::ElementWiseBinary::DataView, ::webnn::mojom::ElementWiseBinaryPtr> {
    static bool IsNull(const ::webnn::mojom::ElementWiseBinaryPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ElementWiseBinaryPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::ElementWiseBinary::kind) kind(const ::webnn::mojom::ElementWiseBinaryPtr& input)
    {
        return input->kind;
    }

    static decltype(::webnn::mojom::ElementWiseBinary::lhs_operand_id) lhs_operand_id(const ::webnn::mojom::ElementWiseBinaryPtr& input)
    {
        return input->lhs_operand_id;
    }

    static decltype(::webnn::mojom::ElementWiseBinary::rhs_operand_id) rhs_operand_id(const ::webnn::mojom::ElementWiseBinaryPtr& input)
    {
        return input->rhs_operand_id;
    }

    static decltype(::webnn::mojom::ElementWiseBinary::output_operand_id) output_operand_id(const ::webnn::mojom::ElementWiseBinaryPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::ElementWiseBinary::label)& label(const ::webnn::mojom::ElementWiseBinaryPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::ElementWiseBinary::DataView input, ::webnn::mojom::ElementWiseBinaryPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::ElementWiseUnary::DataView, ::webnn::mojom::ElementWiseUnaryPtr> {
    static bool IsNull(const ::webnn::mojom::ElementWiseUnaryPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ElementWiseUnaryPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::ElementWiseUnary::kind) kind(const ::webnn::mojom::ElementWiseUnaryPtr& input)
    {
        return input->kind;
    }

    static decltype(::webnn::mojom::ElementWiseUnary::input_operand_id) input_operand_id(const ::webnn::mojom::ElementWiseUnaryPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::ElementWiseUnary::output_operand_id) output_operand_id(const ::webnn::mojom::ElementWiseUnaryPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::ElementWiseUnary::label)& label(const ::webnn::mojom::ElementWiseUnaryPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Expand::DataView, ::webnn::mojom::ExpandPtr> {
    static bool IsNull(const ::webnn::mojom::ExpandPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ExpandPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Expand::input_operand_id) input_operand_id(const ::webnn::mojom::ExpandPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Expand::output_operand_id) output_operand_id(const ::webnn::mojom::ExpandPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Expand::label)& label(const ::webnn::mojom::ExpandPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::ConstantPadding::DataView, ::webnn::mojom::ConstantPaddingPtr> {
    static bool IsNull(const ::webnn::mojom::ConstantPaddingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ConstantPaddingPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::ConstantPadding::value) value(const ::webnn::mojom::ConstantPaddingPtr& input)
    {
        return input->value;
    }

    static bool Read(::webnn::mojom::ConstantPadding::DataView input, ::webnn::mojom::ConstantPaddingPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::EdgePadding::DataView, ::webnn::mojom::EdgePaddingPtr> {
    static bool IsNull(const ::webnn::mojom::EdgePaddingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::EdgePaddingPtr* output)
    {
        output->reset();
    }

    static bool Read(::webnn::mojom::EdgePadding::DataView input, ::webnn::mojom::EdgePaddingPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::ReflectionPadding::DataView, ::webnn::mojom::ReflectionPaddingPtr> {
    static bool IsNull(const ::webnn::mojom::ReflectionPaddingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ReflectionPaddingPtr* output)
    {
        output->reset();
    }

    static bool Read(::webnn::mojom::ReflectionPadding::DataView input, ::webnn::mojom::ReflectionPaddingPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::SymmetricPadding::DataView, ::webnn::mojom::SymmetricPaddingPtr> {
    static bool IsNull(const ::webnn::mojom::SymmetricPaddingPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::SymmetricPaddingPtr* output)
    {
        output->reset();
    }

    static bool Read(::webnn::mojom::SymmetricPadding::DataView input, ::webnn::mojom::SymmetricPaddingPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::InstanceNormalization::DataView, ::webnn::mojom::InstanceNormalizationPtr> {
    static bool IsNull(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::InstanceNormalizationPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::InstanceNormalization::input_operand_id) input_operand_id(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::InstanceNormalization::output_operand_id) output_operand_id(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::InstanceNormalization::scale_operand_id) scale_operand_id(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return input->scale_operand_id;
    }

    static decltype(::webnn::mojom::InstanceNormalization::bias_operand_id) bias_operand_id(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return input->bias_operand_id;
    }

    static decltype(::webnn::mojom::InstanceNormalization::epsilon) epsilon(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return input->epsilon;
    }

    static decltype(::webnn::mojom::InstanceNormalization::layout) layout(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return input->layout;
    }

    static const decltype(::webnn::mojom::InstanceNormalization::label)& label(const ::webnn::mojom::InstanceNormalizationPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Matmul::DataView, ::webnn::mojom::MatmulPtr> {
    static bool IsNull(const ::webnn::mojom::MatmulPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::MatmulPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Matmul::a_operand_id) a_operand_id(const ::webnn::mojom::MatmulPtr& input)
    {
        return input->a_operand_id;
    }

    static decltype(::webnn::mojom::Matmul::b_operand_id) b_operand_id(const ::webnn::mojom::MatmulPtr& input)
    {
        return input->b_operand_id;
    }

    static decltype(::webnn::mojom::Matmul::output_operand_id) output_operand_id(const ::webnn::mojom::MatmulPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Matmul::label)& label(const ::webnn::mojom::MatmulPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Pad::DataView, ::webnn::mojom::PadPtr> {
    static bool IsNull(const ::webnn::mojom::PadPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::PadPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Pad::input_operand_id) input_operand_id(const ::webnn::mojom::PadPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Pad::output_operand_id) output_operand_id(const ::webnn::mojom::PadPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Pad::beginning_padding)& beginning_padding(const ::webnn::mojom::PadPtr& input)
    {
        return input->beginning_padding;
    }

    static const decltype(::webnn::mojom::Pad::ending_padding)& ending_padding(const ::webnn::mojom::PadPtr& input)
    {
        return input->ending_padding;
    }

    static const decltype(::webnn::mojom::Pad::mode)& mode(const ::webnn::mojom::PadPtr& input)
    {
        return input->mode;
    }

    static const decltype(::webnn::mojom::Pad::label)& label(const ::webnn::mojom::PadPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Reduce::DataView, ::webnn::mojom::ReducePtr> {
    static bool IsNull(const ::webnn::mojom::ReducePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ReducePtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Reduce::kind) kind(const ::webnn::mojom::ReducePtr& input)
    {
        return input->kind;
    }

    static decltype(::webnn::mojom::Reduce::input_operand_id) input_operand_id(const ::webnn::mojom::ReducePtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Reduce::output_operand_id) output_operand_id(const ::webnn::mojom::ReducePtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Reduce::axes)& axes(const ::webnn::mojom::ReducePtr& input)
    {
        return input->axes;
    }

    static decltype(::webnn::mojom::Reduce::keep_dimensions) keep_dimensions(const ::webnn::mojom::ReducePtr& input)
    {
        return input->keep_dimensions;
    }

    static const decltype(::webnn::mojom::Reduce::label)& label(const ::webnn::mojom::ReducePtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Pool2d::DataView, ::webnn::mojom::Pool2dPtr> {
    static bool IsNull(const ::webnn::mojom::Pool2dPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::Pool2dPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Pool2d::kind) kind(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->kind;
    }

    static decltype(::webnn::mojom::Pool2d::input_operand_id) input_operand_id(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Pool2d::output_operand_id) output_operand_id(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Pool2d::window_dimensions)& window_dimensions(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->window_dimensions;
    }

    static const decltype(::webnn::mojom::Pool2d::padding)& padding(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->padding;
    }

    static const decltype(::webnn::mojom::Pool2d::strides)& strides(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->strides;
    }

    static const decltype(::webnn::mojom::Pool2d::dilations)& dilations(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->dilations;
    }

    static const decltype(::webnn::mojom::Pool2d::label)& label(const ::webnn::mojom::Pool2dPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Pool2d::DataView input, ::webnn::mojom::Pool2dPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Range::DataView, ::webnn::mojom::RangePtr> {
    static bool IsNull(const ::webnn::mojom::RangePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::RangePtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Range::start) start(const ::webnn::mojom::RangePtr& input)
    {
        return input->start;
    }

    static decltype(::webnn::mojom::Range::size) size(const ::webnn::mojom::RangePtr& input)
    {
        return input->size;
    }

    static decltype(::webnn::mojom::Range::stride) stride(const ::webnn::mojom::RangePtr& input)
    {
        return input->stride;
    }

    static bool Read(::webnn::mojom::Range::DataView input, ::webnn::mojom::RangePtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Slice::DataView, ::webnn::mojom::SlicePtr> {
    static bool IsNull(const ::webnn::mojom::SlicePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::SlicePtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Slice::input_operand_id) input_operand_id(const ::webnn::mojom::SlicePtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Slice::output_operand_id) output_operand_id(const ::webnn::mojom::SlicePtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Slice::ranges)& ranges(const ::webnn::mojom::SlicePtr& input)
    {
        return input->ranges;
    }

    static const decltype(::webnn::mojom::Slice::label)& label(const ::webnn::mojom::SlicePtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Slice::DataView input, ::webnn::mojom::SlicePtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Elu::DataView, ::webnn::mojom::EluPtr> {
    static bool IsNull(const ::webnn::mojom::EluPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::EluPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Elu::input_operand_id) input_operand_id(const ::webnn::mojom::EluPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Elu::output_operand_id) output_operand_id(const ::webnn::mojom::EluPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Elu::alpha) alpha(const ::webnn::mojom::EluPtr& input)
    {
        return input->alpha;
    }

    static const decltype(::webnn::mojom::Elu::label)& label(const ::webnn::mojom::EluPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Gather::DataView, ::webnn::mojom::GatherPtr> {
    static bool IsNull(const ::webnn::mojom::GatherPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GatherPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Gather::input_operand_id) input_operand_id(const ::webnn::mojom::GatherPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Gather::indices_operand_id) indices_operand_id(const ::webnn::mojom::GatherPtr& input)
    {
        return input->indices_operand_id;
    }

    static decltype(::webnn::mojom::Gather::output_operand_id) output_operand_id(const ::webnn::mojom::GatherPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Gather::axis) axis(const ::webnn::mojom::GatherPtr& input)
    {
        return input->axis;
    }

    static const decltype(::webnn::mojom::Gather::label)& label(const ::webnn::mojom::GatherPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::GatherElements::DataView, ::webnn::mojom::GatherElementsPtr> {
    static bool IsNull(const ::webnn::mojom::GatherElementsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GatherElementsPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::GatherElements::input_operand_id) input_operand_id(const ::webnn::mojom::GatherElementsPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::GatherElements::indices_operand_id) indices_operand_id(const ::webnn::mojom::GatherElementsPtr& input)
    {
        return input->indices_operand_id;
    }

    static decltype(::webnn::mojom::GatherElements::output_operand_id) output_operand_id(const ::webnn::mojom::GatherElementsPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::GatherElements::axis) axis(const ::webnn::mojom::GatherElementsPtr& input)
    {
        return input->axis;
    }

    static const decltype(::webnn::mojom::GatherElements::label)& label(const ::webnn::mojom::GatherElementsPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::GatherElements::DataView input, ::webnn::mojom::GatherElementsPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::GatherND::DataView, ::webnn::mojom::GatherNDPtr> {
    static bool IsNull(const ::webnn::mojom::GatherNDPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GatherNDPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::GatherND::input_operand_id) input_operand_id(const ::webnn::mojom::GatherNDPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::GatherND::indices_operand_id) indices_operand_id(const ::webnn::mojom::GatherNDPtr& input)
    {
        return input->indices_operand_id;
    }

    static decltype(::webnn::mojom::GatherND::output_operand_id) output_operand_id(const ::webnn::mojom::GatherNDPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::GatherND::label)& label(const ::webnn::mojom::GatherNDPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::GatherND::DataView input, ::webnn::mojom::GatherNDPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Gelu::DataView, ::webnn::mojom::GeluPtr> {
    static bool IsNull(const ::webnn::mojom::GeluPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GeluPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Gelu::input_operand_id) input_operand_id(const ::webnn::mojom::GeluPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Gelu::output_operand_id) output_operand_id(const ::webnn::mojom::GeluPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Gelu::label)& label(const ::webnn::mojom::GeluPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Gelu::DataView input, ::webnn::mojom::GeluPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Gru::DataView, ::webnn::mojom::GruPtr> {
    static bool IsNull(const ::webnn::mojom::GruPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GruPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Gru::input_operand_id) input_operand_id(const ::webnn::mojom::GruPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Gru::weight_operand_id) weight_operand_id(const ::webnn::mojom::GruPtr& input)
    {
        return input->weight_operand_id;
    }

    static decltype(::webnn::mojom::Gru::recurrent_weight_operand_id) recurrent_weight_operand_id(const ::webnn::mojom::GruPtr& input)
    {
        return input->recurrent_weight_operand_id;
    }

    static decltype(::webnn::mojom::Gru::steps) steps(const ::webnn::mojom::GruPtr& input)
    {
        return input->steps;
    }

    static decltype(::webnn::mojom::Gru::hidden_size) hidden_size(const ::webnn::mojom::GruPtr& input)
    {
        return input->hidden_size;
    }

    static const decltype(::webnn::mojom::Gru::output_operand_ids)& output_operand_ids(const ::webnn::mojom::GruPtr& input)
    {
        return input->output_operand_ids;
    }

    static decltype(::webnn::mojom::Gru::bias_operand_id) bias_operand_id(const ::webnn::mojom::GruPtr& input)
    {
        return input->bias_operand_id;
    }

    static decltype(::webnn::mojom::Gru::recurrent_bias_operand_id) recurrent_bias_operand_id(const ::webnn::mojom::GruPtr& input)
    {
        return input->recurrent_bias_operand_id;
    }

    static decltype(::webnn::mojom::Gru::initial_hidden_state_operand_id) initial_hidden_state_operand_id(const ::webnn::mojom::GruPtr& input)
    {
        return input->initial_hidden_state_operand_id;
    }

    static decltype(::webnn::mojom::Gru::reset_after) reset_after(const ::webnn::mojom::GruPtr& input)
    {
        return input->reset_after;
    }

    static decltype(::webnn::mojom::Gru::return_sequence) return_sequence(const ::webnn::mojom::GruPtr& input)
    {
        return input->return_sequence;
    }

    static decltype(::webnn::mojom::Gru::direction) direction(const ::webnn::mojom::GruPtr& input)
    {
        return input->direction;
    }

    static decltype(::webnn::mojom::Gru::layout) layout(const ::webnn::mojom::GruPtr& input)
    {
        return input->layout;
    }

    static const decltype(::webnn::mojom::Gru::activations)& activations(const ::webnn::mojom::GruPtr& input)
    {
        return input->activations;
    }

    static const decltype(::webnn::mojom::Gru::label)& label(const ::webnn::mojom::GruPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Gru::DataView input, ::webnn::mojom::GruPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::GruCell::DataView, ::webnn::mojom::GruCellPtr> {
    static bool IsNull(const ::webnn::mojom::GruCellPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GruCellPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::GruCell::input_operand_id) input_operand_id(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::GruCell::weight_operand_id) weight_operand_id(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->weight_operand_id;
    }

    static decltype(::webnn::mojom::GruCell::recurrent_weight_operand_id) recurrent_weight_operand_id(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->recurrent_weight_operand_id;
    }

    static decltype(::webnn::mojom::GruCell::hidden_state_operand_id) hidden_state_operand_id(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->hidden_state_operand_id;
    }

    static decltype(::webnn::mojom::GruCell::hidden_size) hidden_size(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->hidden_size;
    }

    static decltype(::webnn::mojom::GruCell::output_operand_id) output_operand_id(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::GruCell::bias_operand_id) bias_operand_id(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->bias_operand_id;
    }

    static decltype(::webnn::mojom::GruCell::recurrent_bias_operand_id) recurrent_bias_operand_id(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->recurrent_bias_operand_id;
    }

    static decltype(::webnn::mojom::GruCell::reset_after) reset_after(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->reset_after;
    }

    static decltype(::webnn::mojom::GruCell::layout) layout(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->layout;
    }

    static const decltype(::webnn::mojom::GruCell::activations)& activations(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->activations;
    }

    static const decltype(::webnn::mojom::GruCell::label)& label(const ::webnn::mojom::GruCellPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::GruCell::DataView input, ::webnn::mojom::GruCellPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Gemm::DataView, ::webnn::mojom::GemmPtr> {
    static bool IsNull(const ::webnn::mojom::GemmPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GemmPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Gemm::a_operand_id) a_operand_id(const ::webnn::mojom::GemmPtr& input)
    {
        return input->a_operand_id;
    }

    static decltype(::webnn::mojom::Gemm::b_operand_id) b_operand_id(const ::webnn::mojom::GemmPtr& input)
    {
        return input->b_operand_id;
    }

    static decltype(::webnn::mojom::Gemm::output_operand_id) output_operand_id(const ::webnn::mojom::GemmPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Gemm::c_operand_id) c_operand_id(const ::webnn::mojom::GemmPtr& input)
    {
        return input->c_operand_id;
    }

    static decltype(::webnn::mojom::Gemm::alpha) alpha(const ::webnn::mojom::GemmPtr& input)
    {
        return input->alpha;
    }

    static decltype(::webnn::mojom::Gemm::beta) beta(const ::webnn::mojom::GemmPtr& input)
    {
        return input->beta;
    }

    static decltype(::webnn::mojom::Gemm::a_transpose) a_transpose(const ::webnn::mojom::GemmPtr& input)
    {
        return input->a_transpose;
    }

    static decltype(::webnn::mojom::Gemm::b_transpose) b_transpose(const ::webnn::mojom::GemmPtr& input)
    {
        return input->b_transpose;
    }

    static const decltype(::webnn::mojom::Gemm::label)& label(const ::webnn::mojom::GemmPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::HardSigmoid::DataView, ::webnn::mojom::HardSigmoidPtr> {
    static bool IsNull(const ::webnn::mojom::HardSigmoidPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::HardSigmoidPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::HardSigmoid::input_operand_id) input_operand_id(const ::webnn::mojom::HardSigmoidPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::HardSigmoid::output_operand_id) output_operand_id(const ::webnn::mojom::HardSigmoidPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::HardSigmoid::alpha) alpha(const ::webnn::mojom::HardSigmoidPtr& input)
    {
        return input->alpha;
    }

    static decltype(::webnn::mojom::HardSigmoid::beta) beta(const ::webnn::mojom::HardSigmoidPtr& input)
    {
        return input->beta;
    }

    static const decltype(::webnn::mojom::HardSigmoid::label)& label(const ::webnn::mojom::HardSigmoidPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::HardSigmoid::DataView input, ::webnn::mojom::HardSigmoidPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::HardSwish::DataView, ::webnn::mojom::HardSwishPtr> {
    static bool IsNull(const ::webnn::mojom::HardSwishPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::HardSwishPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::HardSwish::input_operand_id) input_operand_id(const ::webnn::mojom::HardSwishPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::HardSwish::output_operand_id) output_operand_id(const ::webnn::mojom::HardSwishPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::HardSwish::label)& label(const ::webnn::mojom::HardSwishPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::LayerNormalization::DataView, ::webnn::mojom::LayerNormalizationPtr> {
    static bool IsNull(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::LayerNormalizationPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::LayerNormalization::input_operand_id) input_operand_id(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::LayerNormalization::output_operand_id) output_operand_id(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::LayerNormalization::scale_operand_id) scale_operand_id(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return input->scale_operand_id;
    }

    static decltype(::webnn::mojom::LayerNormalization::bias_operand_id) bias_operand_id(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return input->bias_operand_id;
    }

    static const decltype(::webnn::mojom::LayerNormalization::axes)& axes(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return input->axes;
    }

    static decltype(::webnn::mojom::LayerNormalization::epsilon) epsilon(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return input->epsilon;
    }

    static const decltype(::webnn::mojom::LayerNormalization::label)& label(const ::webnn::mojom::LayerNormalizationPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::LeakyRelu::DataView, ::webnn::mojom::LeakyReluPtr> {
    static bool IsNull(const ::webnn::mojom::LeakyReluPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::LeakyReluPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::LeakyRelu::input_operand_id) input_operand_id(const ::webnn::mojom::LeakyReluPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::LeakyRelu::output_operand_id) output_operand_id(const ::webnn::mojom::LeakyReluPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::LeakyRelu::alpha) alpha(const ::webnn::mojom::LeakyReluPtr& input)
    {
        return input->alpha;
    }

    static const decltype(::webnn::mojom::LeakyRelu::label)& label(const ::webnn::mojom::LeakyReluPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Linear::DataView, ::webnn::mojom::LinearPtr> {
    static bool IsNull(const ::webnn::mojom::LinearPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::LinearPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Linear::input_operand_id) input_operand_id(const ::webnn::mojom::LinearPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Linear::output_operand_id) output_operand_id(const ::webnn::mojom::LinearPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Linear::alpha) alpha(const ::webnn::mojom::LinearPtr& input)
    {
        return input->alpha;
    }

    static decltype(::webnn::mojom::Linear::beta) beta(const ::webnn::mojom::LinearPtr& input)
    {
        return input->beta;
    }

    static const decltype(::webnn::mojom::Linear::label)& label(const ::webnn::mojom::LinearPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Lstm::DataView, ::webnn::mojom::LstmPtr> {
    static bool IsNull(const ::webnn::mojom::LstmPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::LstmPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Lstm::input_operand_id) input_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Lstm::weight_operand_id) weight_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->weight_operand_id;
    }

    static decltype(::webnn::mojom::Lstm::recurrent_weight_operand_id) recurrent_weight_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->recurrent_weight_operand_id;
    }

    static const decltype(::webnn::mojom::Lstm::output_operand_ids)& output_operand_ids(const ::webnn::mojom::LstmPtr& input)
    {
        return input->output_operand_ids;
    }

    static decltype(::webnn::mojom::Lstm::steps) steps(const ::webnn::mojom::LstmPtr& input)
    {
        return input->steps;
    }

    static decltype(::webnn::mojom::Lstm::hidden_size) hidden_size(const ::webnn::mojom::LstmPtr& input)
    {
        return input->hidden_size;
    }

    static decltype(::webnn::mojom::Lstm::bias_operand_id) bias_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->bias_operand_id;
    }

    static decltype(::webnn::mojom::Lstm::recurrent_bias_operand_id) recurrent_bias_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->recurrent_bias_operand_id;
    }

    static decltype(::webnn::mojom::Lstm::peephole_weight_operand_id) peephole_weight_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->peephole_weight_operand_id;
    }

    static decltype(::webnn::mojom::Lstm::initial_hidden_state_operand_id) initial_hidden_state_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->initial_hidden_state_operand_id;
    }

    static decltype(::webnn::mojom::Lstm::initial_cell_state_operand_id) initial_cell_state_operand_id(const ::webnn::mojom::LstmPtr& input)
    {
        return input->initial_cell_state_operand_id;
    }

    static decltype(::webnn::mojom::Lstm::return_sequence) return_sequence(const ::webnn::mojom::LstmPtr& input)
    {
        return input->return_sequence;
    }

    static decltype(::webnn::mojom::Lstm::direction) direction(const ::webnn::mojom::LstmPtr& input)
    {
        return input->direction;
    }

    static decltype(::webnn::mojom::Lstm::layout) layout(const ::webnn::mojom::LstmPtr& input)
    {
        return input->layout;
    }

    static const decltype(::webnn::mojom::Lstm::activations)& activations(const ::webnn::mojom::LstmPtr& input)
    {
        return input->activations;
    }

    static const decltype(::webnn::mojom::Lstm::label)& label(const ::webnn::mojom::LstmPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Lstm::DataView input, ::webnn::mojom::LstmPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::LstmCell::DataView, ::webnn::mojom::LstmCellPtr> {
    static bool IsNull(const ::webnn::mojom::LstmCellPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::LstmCellPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::LstmCell::input_operand_id) input_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::LstmCell::weight_operand_id) weight_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->weight_operand_id;
    }

    static decltype(::webnn::mojom::LstmCell::recurrent_weight_operand_id) recurrent_weight_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->recurrent_weight_operand_id;
    }

    static decltype(::webnn::mojom::LstmCell::hidden_state_operand_id) hidden_state_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->hidden_state_operand_id;
    }

    static decltype(::webnn::mojom::LstmCell::cell_state_operand_id) cell_state_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->cell_state_operand_id;
    }

    static const decltype(::webnn::mojom::LstmCell::output_operand_ids)& output_operand_ids(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->output_operand_ids;
    }

    static decltype(::webnn::mojom::LstmCell::hidden_size) hidden_size(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->hidden_size;
    }

    static decltype(::webnn::mojom::LstmCell::bias_operand_id) bias_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->bias_operand_id;
    }

    static decltype(::webnn::mojom::LstmCell::recurrent_bias_operand_id) recurrent_bias_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->recurrent_bias_operand_id;
    }

    static decltype(::webnn::mojom::LstmCell::peephole_weight_operand_id) peephole_weight_operand_id(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->peephole_weight_operand_id;
    }

    static decltype(::webnn::mojom::LstmCell::layout) layout(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->layout;
    }

    static const decltype(::webnn::mojom::LstmCell::activations)& activations(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->activations;
    }

    static const decltype(::webnn::mojom::LstmCell::label)& label(const ::webnn::mojom::LstmCellPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::LstmCell::DataView input, ::webnn::mojom::LstmCellPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Prelu::DataView, ::webnn::mojom::PreluPtr> {
    static bool IsNull(const ::webnn::mojom::PreluPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::PreluPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Prelu::input_operand_id) input_operand_id(const ::webnn::mojom::PreluPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Prelu::slope_operand_id) slope_operand_id(const ::webnn::mojom::PreluPtr& input)
    {
        return input->slope_operand_id;
    }

    static decltype(::webnn::mojom::Prelu::output_operand_id) output_operand_id(const ::webnn::mojom::PreluPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Prelu::label)& label(const ::webnn::mojom::PreluPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Prelu::DataView input, ::webnn::mojom::PreluPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::QuantizeLinear::DataView, ::webnn::mojom::QuantizeLinearPtr> {
    static bool IsNull(const ::webnn::mojom::QuantizeLinearPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::QuantizeLinearPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::QuantizeLinear::input_operand_id) input_operand_id(const ::webnn::mojom::QuantizeLinearPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::QuantizeLinear::scale_operand_id) scale_operand_id(const ::webnn::mojom::QuantizeLinearPtr& input)
    {
        return input->scale_operand_id;
    }

    static decltype(::webnn::mojom::QuantizeLinear::zero_point_operand_id) zero_point_operand_id(const ::webnn::mojom::QuantizeLinearPtr& input)
    {
        return input->zero_point_operand_id;
    }

    static decltype(::webnn::mojom::QuantizeLinear::output_operand_id) output_operand_id(const ::webnn::mojom::QuantizeLinearPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::QuantizeLinear::label)& label(const ::webnn::mojom::QuantizeLinearPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::QuantizeLinear::DataView input, ::webnn::mojom::QuantizeLinearPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Relu::DataView, ::webnn::mojom::ReluPtr> {
    static bool IsNull(const ::webnn::mojom::ReluPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ReluPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Relu::input_operand_id) input_operand_id(const ::webnn::mojom::ReluPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Relu::output_operand_id) output_operand_id(const ::webnn::mojom::ReluPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Relu::label)& label(const ::webnn::mojom::ReluPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Relu::DataView input, ::webnn::mojom::ReluPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Reshape::DataView, ::webnn::mojom::ReshapePtr> {
    static bool IsNull(const ::webnn::mojom::ReshapePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ReshapePtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Reshape::input_operand_id) input_operand_id(const ::webnn::mojom::ReshapePtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Reshape::output_operand_id) output_operand_id(const ::webnn::mojom::ReshapePtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Reshape::label)& label(const ::webnn::mojom::ReshapePtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Reshape::DataView input, ::webnn::mojom::ReshapePtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::ScatterElements::DataView, ::webnn::mojom::ScatterElementsPtr> {
    static bool IsNull(const ::webnn::mojom::ScatterElementsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ScatterElementsPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::ScatterElements::input_operand_id) input_operand_id(const ::webnn::mojom::ScatterElementsPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::ScatterElements::indices_operand_id) indices_operand_id(const ::webnn::mojom::ScatterElementsPtr& input)
    {
        return input->indices_operand_id;
    }

    static decltype(::webnn::mojom::ScatterElements::updates_operand_id) updates_operand_id(const ::webnn::mojom::ScatterElementsPtr& input)
    {
        return input->updates_operand_id;
    }

    static decltype(::webnn::mojom::ScatterElements::output_operand_id) output_operand_id(const ::webnn::mojom::ScatterElementsPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::ScatterElements::axis) axis(const ::webnn::mojom::ScatterElementsPtr& input)
    {
        return input->axis;
    }

    static const decltype(::webnn::mojom::ScatterElements::label)& label(const ::webnn::mojom::ScatterElementsPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::ScatterElements::DataView input, ::webnn::mojom::ScatterElementsPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::ScatterND::DataView, ::webnn::mojom::ScatterNDPtr> {
    static bool IsNull(const ::webnn::mojom::ScatterNDPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ScatterNDPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::ScatterND::input_operand_id) input_operand_id(const ::webnn::mojom::ScatterNDPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::ScatterND::indices_operand_id) indices_operand_id(const ::webnn::mojom::ScatterNDPtr& input)
    {
        return input->indices_operand_id;
    }

    static decltype(::webnn::mojom::ScatterND::updates_operand_id) updates_operand_id(const ::webnn::mojom::ScatterNDPtr& input)
    {
        return input->updates_operand_id;
    }

    static decltype(::webnn::mojom::ScatterND::output_operand_id) output_operand_id(const ::webnn::mojom::ScatterNDPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::ScatterND::label)& label(const ::webnn::mojom::ScatterNDPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::ScatterND::DataView input, ::webnn::mojom::ScatterNDPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Sigmoid::DataView, ::webnn::mojom::SigmoidPtr> {
    static bool IsNull(const ::webnn::mojom::SigmoidPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::SigmoidPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Sigmoid::input_operand_id) input_operand_id(const ::webnn::mojom::SigmoidPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Sigmoid::output_operand_id) output_operand_id(const ::webnn::mojom::SigmoidPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Sigmoid::label)& label(const ::webnn::mojom::SigmoidPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Sigmoid::DataView input, ::webnn::mojom::SigmoidPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Softmax::DataView, ::webnn::mojom::SoftmaxPtr> {
    static bool IsNull(const ::webnn::mojom::SoftmaxPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::SoftmaxPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Softmax::input_operand_id) input_operand_id(const ::webnn::mojom::SoftmaxPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Softmax::output_operand_id) output_operand_id(const ::webnn::mojom::SoftmaxPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Softmax::axis) axis(const ::webnn::mojom::SoftmaxPtr& input)
    {
        return input->axis;
    }

    static const decltype(::webnn::mojom::Softmax::label)& label(const ::webnn::mojom::SoftmaxPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Softmax::DataView input, ::webnn::mojom::SoftmaxPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Softplus::DataView, ::webnn::mojom::SoftplusPtr> {
    static bool IsNull(const ::webnn::mojom::SoftplusPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::SoftplusPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Softplus::input_operand_id) input_operand_id(const ::webnn::mojom::SoftplusPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Softplus::output_operand_id) output_operand_id(const ::webnn::mojom::SoftplusPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Softplus::label)& label(const ::webnn::mojom::SoftplusPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Softsign::DataView, ::webnn::mojom::SoftsignPtr> {
    static bool IsNull(const ::webnn::mojom::SoftsignPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::SoftsignPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Softsign::input_operand_id) input_operand_id(const ::webnn::mojom::SoftsignPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Softsign::output_operand_id) output_operand_id(const ::webnn::mojom::SoftsignPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Softsign::label)& label(const ::webnn::mojom::SoftsignPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Softsign::DataView input, ::webnn::mojom::SoftsignPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Split::DataView, ::webnn::mojom::SplitPtr> {
    static bool IsNull(const ::webnn::mojom::SplitPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::SplitPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Split::input_operand_id) input_operand_id(const ::webnn::mojom::SplitPtr& input)
    {
        return input->input_operand_id;
    }

    static const decltype(::webnn::mojom::Split::output_operand_ids)& output_operand_ids(const ::webnn::mojom::SplitPtr& input)
    {
        return input->output_operand_ids;
    }

    static decltype(::webnn::mojom::Split::axis) axis(const ::webnn::mojom::SplitPtr& input)
    {
        return input->axis;
    }

    static const decltype(::webnn::mojom::Split::label)& label(const ::webnn::mojom::SplitPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Split::DataView input, ::webnn::mojom::SplitPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Tanh::DataView, ::webnn::mojom::TanhPtr> {
    static bool IsNull(const ::webnn::mojom::TanhPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::TanhPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Tanh::input_operand_id) input_operand_id(const ::webnn::mojom::TanhPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Tanh::output_operand_id) output_operand_id(const ::webnn::mojom::TanhPtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Tanh::label)& label(const ::webnn::mojom::TanhPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Tanh::DataView input, ::webnn::mojom::TanhPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Tile::DataView, ::webnn::mojom::TilePtr> {
    static bool IsNull(const ::webnn::mojom::TilePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::TilePtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Tile::input_operand_id) input_operand_id(const ::webnn::mojom::TilePtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Tile::output_operand_id) output_operand_id(const ::webnn::mojom::TilePtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Tile::repetitions)& repetitions(const ::webnn::mojom::TilePtr& input)
    {
        return input->repetitions;
    }

    static const decltype(::webnn::mojom::Tile::label)& label(const ::webnn::mojom::TilePtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Tile::DataView input, ::webnn::mojom::TilePtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Transpose::DataView, ::webnn::mojom::TransposePtr> {
    static bool IsNull(const ::webnn::mojom::TransposePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::TransposePtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Transpose::input_operand_id) input_operand_id(const ::webnn::mojom::TransposePtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Transpose::output_operand_id) output_operand_id(const ::webnn::mojom::TransposePtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Transpose::permutation)& permutation(const ::webnn::mojom::TransposePtr& input)
    {
        return input->permutation;
    }

    static const decltype(::webnn::mojom::Transpose::label)& label(const ::webnn::mojom::TransposePtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Transpose::DataView input, ::webnn::mojom::TransposePtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Triangular::DataView, ::webnn::mojom::TriangularPtr> {
    static bool IsNull(const ::webnn::mojom::TriangularPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::TriangularPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Triangular::input_operand_id) input_operand_id(const ::webnn::mojom::TriangularPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Triangular::output_operand_id) output_operand_id(const ::webnn::mojom::TriangularPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Triangular::upper) upper(const ::webnn::mojom::TriangularPtr& input)
    {
        return input->upper;
    }

    static decltype(::webnn::mojom::Triangular::diagonal) diagonal(const ::webnn::mojom::TriangularPtr& input)
    {
        return input->diagonal;
    }

    static const decltype(::webnn::mojom::Triangular::label)& label(const ::webnn::mojom::TriangularPtr& input)
    {
        return input->label;
    }

    static bool Read(::webnn::mojom::Triangular::DataView input, ::webnn::mojom::TriangularPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Resample2d::DataView, ::webnn::mojom::Resample2dPtr> {
    static bool IsNull(const ::webnn::mojom::Resample2dPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::Resample2dPtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Resample2d::input_operand_id) input_operand_id(const ::webnn::mojom::Resample2dPtr& input)
    {
        return input->input_operand_id;
    }

    static decltype(::webnn::mojom::Resample2d::output_operand_id) output_operand_id(const ::webnn::mojom::Resample2dPtr& input)
    {
        return input->output_operand_id;
    }

    static decltype(::webnn::mojom::Resample2d::mode) mode(const ::webnn::mojom::Resample2dPtr& input)
    {
        return input->mode;
    }

    static const decltype(::webnn::mojom::Resample2d::scales)& scales(const ::webnn::mojom::Resample2dPtr& input)
    {
        return input->scales;
    }

    static const decltype(::webnn::mojom::Resample2d::axes)& axes(const ::webnn::mojom::Resample2dPtr& input)
    {
        return input->axes;
    }

    static const decltype(::webnn::mojom::Resample2d::label)& label(const ::webnn::mojom::Resample2dPtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::Where::DataView, ::webnn::mojom::WherePtr> {
    static bool IsNull(const ::webnn::mojom::WherePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::WherePtr* output)
    {
        output->reset();
    }

    static decltype(::webnn::mojom::Where::condition_operand_id) condition_operand_id(const ::webnn::mojom::WherePtr& input)
    {
        return input->condition_operand_id;
    }

    static decltype(::webnn::mojom::Where::true_value_operand_id) true_value_operand_id(const ::webnn::mojom::WherePtr& input)
    {
        return input->true_value_operand_id;
    }

    static decltype(::webnn::mojom::Where::false_value_operand_id) false_value_operand_id(const ::webnn::mojom::WherePtr& input)
    {
        return input->false_value_operand_id;
    }

    static decltype(::webnn::mojom::Where::output_operand_id) output_operand_id(const ::webnn::mojom::WherePtr& input)
    {
        return input->output_operand_id;
    }

    static const decltype(::webnn::mojom::Where::label)& label(const ::webnn::mojom::WherePtr& input)
    {
        return input->label;
    }
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) StructTraits<::webnn::mojom::GraphInfo::DataView, ::webnn::mojom::GraphInfoPtr> {
    static bool IsNull(const ::webnn::mojom::GraphInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::GraphInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::webnn::mojom::GraphInfo::id_to_operand_map)& id_to_operand_map(const ::webnn::mojom::GraphInfoPtr& input)
    {
        return input->id_to_operand_map;
    }

    static const decltype(::webnn::mojom::GraphInfo::input_operands)& input_operands(const ::webnn::mojom::GraphInfoPtr& input)
    {
        return input->input_operands;
    }

    static const decltype(::webnn::mojom::GraphInfo::output_operands)& output_operands(const ::webnn::mojom::GraphInfoPtr& input)
    {
        return input->output_operands;
    }

    static const decltype(::webnn::mojom::GraphInfo::operations)& operations(const ::webnn::mojom::GraphInfoPtr& input)
    {
        return input->operations;
    }

    static decltype(::webnn::mojom::GraphInfo::constant_id_to_buffer_map)& constant_id_to_buffer_map(::webnn::mojom::GraphInfoPtr& input)
    {
        return input->constant_id_to_buffer_map;
    }

    static bool Read(::webnn::mojom::GraphInfo::DataView input, ::webnn::mojom::GraphInfoPtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) UnionTraits<::webnn::mojom::PaddingMode::DataView, ::webnn::mojom::PaddingModePtr> {
    static bool IsNull(const ::webnn::mojom::PaddingModePtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::PaddingModePtr* output)
    {
        output->reset();
    }

    static ::webnn::mojom::PaddingMode::Tag GetTag(const ::webnn::mojom::PaddingModePtr& input)
    {
        return input->which();
    }

    static const ::webnn::mojom::ConstantPaddingPtr& constant(const ::webnn::mojom::PaddingModePtr& input)
    {
        return input->get_constant();
    }

    static const ::webnn::mojom::EdgePaddingPtr& edge(const ::webnn::mojom::PaddingModePtr& input)
    {
        return input->get_edge();
    }

    static const ::webnn::mojom::ReflectionPaddingPtr& reflection(const ::webnn::mojom::PaddingModePtr& input)
    {
        return input->get_reflection();
    }

    static const ::webnn::mojom::SymmetricPaddingPtr& symmetric(const ::webnn::mojom::PaddingModePtr& input)
    {
        return input->get_symmetric();
    }

    static bool Read(::webnn::mojom::PaddingMode::DataView input, ::webnn::mojom::PaddingModePtr* output);
};

template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) UnionTraits<::webnn::mojom::Operation::DataView, ::webnn::mojom::OperationPtr> {
    static bool IsNull(const ::webnn::mojom::OperationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::OperationPtr* output)
    {
        output->reset();
    }

    static ::webnn::mojom::Operation::Tag GetTag(const ::webnn::mojom::OperationPtr& input)
    {
        return input->which();
    }
    ...
    static const ::webnn::mojom::ConcatPtr& concat(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_concat();
    }

    static const ::webnn::mojom::Conv2dPtr& conv2d(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_conv2d();
    }

    static const ::webnn::mojom::CumulativeSumPtr& cumulative_sum(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_cumulative_sum();
    }

    static const ::webnn::mojom::DequantizeLinearPtr& dequantize_linear(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_dequantize_linear();
    }

    static const ::webnn::mojom::ElementWiseBinaryPtr& element_wise_binary(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::GatherElementsPtr& gather_elements(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_gather_elements();
    }

    static const ::webnn::mojom::GatherNDPtr& gather_nd(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_gather_nd();
    }

    static const ::webnn::mojom::GeluPtr& gelu(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::GruPtr& gru(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_gru();
    }

    static const ::webnn::mojom::GruCellPtr& gru_cell(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::LstmPtr& lstm(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_lstm();
    }

    static const ::webnn::mojom::LstmCellPtr& lstm_cell(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::Pool2dPtr& pool2d(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::QuantizeLinearPtr& quantize_linear(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::Resample2dPtr& resample2d(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_resample2d();
    }

    static const ::webnn::mojom::ReshapePtr& reshape(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_reshape();
    }

    static const ::webnn::mojom::ScatterElementsPtr& scatter_elements(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_scatter_elements();
    }

    static const ::webnn::mojom::ScatterNDPtr& scatter_nd(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_scatter_nd();
    }

    static const ::webnn::mojom::SigmoidPtr& sigmoid(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_sigmoid();
    }

    static const ::webnn::mojom::SlicePtr& slice(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_slice();
    }

    static const ::webnn::mojom::SoftmaxPtr& softmax(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::SoftsignPtr& softsign(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::TanhPtr& tanh(const ::webnn::mojom::OperationPtr& input)
    {
        return input->get_tanh();
    }

    static const ::webnn::mojom::TilePtr& tile(const ::webnn::mojom::OperationPtr& input)
    {
    ...
    static const ::webnn::mojom::TriangularPtr& triangular(const ::webnn::mojom::OperationPtr& input)
    {
...
template <> struct COMPONENT_EXPORT(WEBNN_MOJOM) UnionTraits<::webnn::mojom::ComputeResult::DataView, ::webnn::mojom::ComputeResultPtr> {
    static bool IsNull(const ::webnn::mojom::ComputeResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::webnn::mojom::ComputeResultPtr* output)
    {
        output->reset();
    }

    static ::webnn::mojom::ComputeResult::Tag GetTag(const ::webnn::mojom::ComputeResultPtr& input)
    {
        return input->which();
    }

    static base::flat_map<std::string, ::mojo_base::BigBuffer>& named_outputs(::webnn::mojom::ComputeResultPtr& input)
    {
        return input->get_named_outputs();
    }

    static const ::webnn::mojom::ErrorPtr& error(const ::webnn::mojom::ComputeResultPtr& input)
    {
        return input->get_error();
    }

    static bool Read(::webnn::mojom::ComputeResult::DataView input, ::webnn::mojom::ComputeResultPtr* output);
};
