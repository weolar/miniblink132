...
CreateContextSuccess::CreateContextSuccess(::mojo::PendingRemote<::webnn::mojom::WebNNContext> context_remote_in,
...
{
    const char* name = ::webnn::mojom::WebNNContextProvider::Name_;
...
bool StructTraits<::webnn::mojom::CreateContextOptions::DataView, ::webnn::mojom::CreateContextOptionsPtr>::Read(
    ::webnn::mojom::CreateContextOptions::DataView input, ::webnn::mojom::CreateContextOptionsPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::CreateContextSuccess::DataView, ::webnn::mojom::CreateContextSuccessPtr>::Read(
    ::webnn::mojom::CreateContextSuccess::DataView input, ::webnn::mojom::CreateContextSuccessPtr* output)
{
    bool success = true;
...
bool UnionTraits<::webnn::mojom::CreateContextResult::DataView, ::webnn::mojom::CreateContextResultPtr>::Read(
    ::webnn::mojom::CreateContextResult::DataView input, ::webnn::mojom::CreateContextResultPtr* output)
{
