...
public:
    ...
    void CreateGraph(::webnn::mojom::GraphInfoPtr graph_info, CreateGraphResultPtr* out_result);
    CreateGraphResultPtr CreateGraph(::webnn::mojom::GraphInfoPtr graph_info);
