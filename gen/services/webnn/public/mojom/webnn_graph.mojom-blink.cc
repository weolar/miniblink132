...
OperandDescriptor::OperandDescriptor(DataType data_type_in, WTF::Vector<uint32_t> shape_in)
...
Operand::Operand(Operand::Kind kind_in, const ::webnn::OperandDescriptor& descriptor_in, const WTF::String& name_in)
...
{
    seed = mojo::internal::WTFHash(seed, this->kind);
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->axis);
    seed = mojo::internal::WTFHash(seed, this->keep_dimensions);
...
Clamp::Clamp(uint64_t input_operand_id_in, uint64_t output_operand_id_in, float min_value_in, float max_value_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
size_t Clamp::Hash(size_t seed) const
{
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->min_value);
    seed = mojo::internal::WTFHash(seed, this->max_value);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
Concat::Concat(WTF::Vector<uint64_t> input_operand_ids_in, uint64_t output_operand_id_in, uint32_t axis_in, const WTF::String& label_in)
...
Conv2d::Conv2d(Conv2d::Kind kind_in, uint64_t input_operand_id_in, uint64_t filter_operand_id_in, uint64_t output_operand_id_in, Padding2dPtr padding_in,
    Size2dPtr strides_in, Size2dPtr dilations_in, uint32_t groups_in, std::optional<uint64_t> bias_operand_id_in, const WTF::String& label_in)
    : kind(std::move(kind_in))
    , input_operand_id(std::move(input_operand_id_in))
...
CumulativeSum::CumulativeSum(
    uint64_t input_operand_id_in, uint64_t output_operand_id_in, uint32_t axis_in, bool exclusive_in, bool reversed_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , axis(std::move(axis_in))
...
size_t CumulativeSum::Hash(size_t seed) const
{
    ...
    seed = mojo::internal::WTFHash(seed, this->reversed);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
DequantizeLinear::DequantizeLinear(
    uint64_t input_operand_id_in, uint64_t scale_operand_id_in, uint64_t zero_point_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , scale_operand_id(std::move(scale_operand_id_in))
...
{
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->scale_operand_id);
    seed = mojo::internal::WTFHash(seed, this->zero_point_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
ElementWiseBinary::ElementWiseBinary(
    ElementWiseBinary::Kind kind_in, uint64_t lhs_operand_id_in, uint64_t rhs_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : kind(std::move(kind_in))
...
{
    seed = mojo::internal::WTFHash(seed, this->kind);
    seed = mojo::internal::WTFHash(seed, this->lhs_operand_id);
    seed = mojo::internal::WTFHash(seed, this->rhs_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
ElementWiseUnary::ElementWiseUnary(ElementWiseUnary::Kind kind_in, uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : kind(std::move(kind_in))
    , input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
...
Expand::Expand(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
InstanceNormalization::InstanceNormalization(uint64_t input_operand_id_in, uint64_t output_operand_id_in, std::optional<uint64_t> scale_operand_id_in,
    std::optional<uint64_t> bias_operand_id_in, float epsilon_in, ::webnn::mojom::blink::InputOperandLayout layout_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , scale_operand_id(std::move(scale_operand_id_in))
    , bias_operand_id(std::move(bias_operand_id_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type ::webnn::mojom::blink::InputOperandLayout>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
Matmul::Matmul(uint64_t a_operand_id_in, uint64_t b_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
...
{
    seed = mojo::internal::WTFHash(seed, this->a_operand_id);
    seed = mojo::internal::WTFHash(seed, this->b_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
Pad::Pad(uint64_t input_operand_id_in, uint64_t output_operand_id_in, WTF::Vector<uint32_t> beginning_padding_in, WTF::Vector<uint32_t> ending_padding_in,
    PaddingModePtr mode_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
Reduce::Reduce(Reduce::Kind kind_in, uint64_t input_operand_id_in, uint64_t output_operand_id_in, WTF::Vector<uint32_t> axes_in, bool keep_dimensions_in,
    const WTF::String& label_in)
    : kind(std::move(kind_in))
    , input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
Pool2d::Pool2d(Pool2d::Kind kind_in, uint64_t input_operand_id_in, uint64_t output_operand_id_in, Size2dPtr window_dimensions_in, Padding2dPtr padding_in,
    Size2dPtr strides_in, Size2dPtr dilations_in, const WTF::String& label_in)
    : kind(std::move(kind_in))
    , input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
size_t Pool2d::Hash(size_t seed) const
{
    ...
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->window_dimensions);
    seed = mojo::internal::WTFHash(seed, this->padding);
    seed = mojo::internal::WTFHash(seed, this->strides);
    seed = mojo::internal::WTFHash(seed, this->dilations);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
Slice::Slice(uint64_t input_operand_id_in, uint64_t output_operand_id_in, WTF::Vector<::webnn::Range> ranges_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const WTF::Vector<::webnn::Range>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
Elu::Elu(uint64_t input_operand_id_in, uint64_t output_operand_id_in, float alpha_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
Gather::Gather(uint64_t input_operand_id_in, uint64_t indices_operand_id_in, uint64_t output_operand_id_in, uint32_t axis_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
...
{
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->indices_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->axis);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
...
GatherElements::GatherElements(
    uint64_t input_operand_id_in, uint64_t indices_operand_id_in, uint64_t output_operand_id_in, uint32_t axis_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , indices_operand_id(std::move(indices_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , axis(std::move(axis_in))
...
GatherND::GatherND(uint64_t input_operand_id_in, uint64_t indices_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , indices_operand_id(std::move(indices_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
...
Gelu::Gelu(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
Gru::Gru(uint64_t input_operand_id_in, uint64_t weight_operand_id_in, uint64_t recurrent_weight_operand_id_in, uint32_t steps_in, uint32_t hidden_size_in,
    WTF::Vector<uint64_t> output_operand_ids_in, std::optional<uint64_t> bias_operand_id_in, std::optional<uint64_t> recurrent_bias_operand_id_in,
    ...
    GruWeightLayout layout_in, WTF::Vector<RecurrentNetworkActivation> activations_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type const WTF::Vector<RecurrentNetworkActivation>&>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
GruCell::GruCell(uint64_t input_operand_id_in, uint64_t weight_operand_id_in, uint64_t recurrent_weight_operand_id_in, uint64_t hidden_state_operand_id_in,
    ...
    bool reset_after_in, GruWeightLayout layout_in, WTF::Vector<RecurrentNetworkActivation> activations_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , weight_operand_id(std::move(weight_operand_id_in))
    , recurrent_weight_operand_id(std::move(recurrent_weight_operand_id_in))
...
Gemm::Gemm(uint64_t a_operand_id_in, uint64_t b_operand_id_in, uint64_t output_operand_id_in, std::optional<uint64_t> c_operand_id_in, float alpha_in,
    float beta_in, bool a_transpose_in, bool b_transpose_in, const WTF::String& label_in)
    : a_operand_id(std::move(a_operand_id_in))
    , b_operand_id(std::move(b_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
HardSigmoid::HardSigmoid(uint64_t input_operand_id_in, uint64_t output_operand_id_in, float alpha_in, float beta_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , alpha(std::move(alpha_in))
    , beta(std::move(beta_in))
...
HardSwish::HardSwish(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
LayerNormalization::LayerNormalization(uint64_t input_operand_id_in, uint64_t output_operand_id_in, std::optional<uint64_t> scale_operand_id_in,
    std::optional<uint64_t> bias_operand_id_in, WTF::Vector<uint32_t> axes_in, float epsilon_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , scale_operand_id(std::move(scale_operand_id_in))
    , bias_operand_id(std::move(bias_operand_id_in))
...
LeakyRelu::LeakyRelu(uint64_t input_operand_id_in, uint64_t output_operand_id_in, float alpha_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , alpha(std::move(alpha_in))
    , label(std::move(label_in))
...
Linear::Linear(uint64_t input_operand_id_in, uint64_t output_operand_id_in, float alpha_in, float beta_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , alpha(std::move(alpha_in))
    , beta(std::move(beta_in))
...
Lstm::Lstm(uint64_t input_operand_id_in, uint64_t weight_operand_id_in, uint64_t recurrent_weight_operand_id_in, WTF::Vector<uint64_t> output_operand_ids_in,
    ...
    WTF::Vector<RecurrentNetworkActivation> activations_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , weight_operand_id(std::move(weight_operand_id_in))
    , recurrent_weight_operand_id(std::move(recurrent_weight_operand_id_in))
    , output_operand_ids(std::move(output_operand_ids_in))
...
LstmCell::LstmCell(uint64_t input_operand_id_in, uint64_t weight_operand_id_in, uint64_t recurrent_weight_operand_id_in, uint64_t hidden_state_operand_id_in,
    uint64_t cell_state_operand_id_in, WTF::Vector<uint64_t> output_operand_ids_in, uint32_t hidden_size_in, std::optional<uint64_t> bias_operand_id_in,
...
Prelu::Prelu(uint64_t input_operand_id_in, uint64_t slope_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
...
{
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->slope_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
Relu::Relu(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
Reshape::Reshape(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
ScatterElements::ScatterElements(uint64_t input_operand_id_in, uint64_t indices_operand_id_in, uint64_t updates_operand_id_in, uint64_t output_operand_id_in,
    uint32_t axis_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , indices_operand_id(std::move(indices_operand_id_in))
...
size_t ScatterElements::Hash(size_t seed) const
{
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->indices_operand_id);
    seed = mojo::internal::WTFHash(seed, this->updates_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->axis);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
...
ScatterND::ScatterND(
    uint64_t input_operand_id_in, uint64_t indices_operand_id_in, uint64_t updates_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , indices_operand_id(std::move(indices_operand_id_in))
    , updates_operand_id(std::move(updates_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
Sigmoid::Sigmoid(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
Softmax::Softmax(uint64_t input_operand_id_in, uint64_t output_operand_id_in, uint32_t axis_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , axis(std::move(axis_in))
    , label(std::move(label_in))
...
Softplus::Softplus(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
Softsign::Softsign(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
Split::Split(uint64_t input_operand_id_in, WTF::Vector<uint64_t> output_operand_ids_in, uint32_t axis_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_ids(std::move(output_operand_ids_in))
    , axis(std::move(axis_in))
    , label(std::move(label_in))
...
Tanh::Tanh(uint64_t input_operand_id_in, uint64_t output_operand_id_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , label(std::move(label_in))
{
...
Tile::Tile(uint64_t input_operand_id_in, uint64_t output_operand_id_in, WTF::Vector<uint32_t> repetitions_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
Transpose::Transpose(uint64_t input_operand_id_in, uint64_t output_operand_id_in, WTF::Vector<uint32_t> permutation_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
Triangular::Triangular(uint64_t input_operand_id_in, uint64_t output_operand_id_in, bool upper_in, int32_t diagonal_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
...
size_t Triangular::Hash(size_t seed) const
{
    seed = mojo::internal::WTFHash(seed, this->input_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->upper);
    seed = mojo::internal::WTFHash(seed, this->diagonal);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
Resample2d::Resample2d(uint64_t input_operand_id_in, uint64_t output_operand_id_in, Resample2d::InterpolationMode mode_in,
    std::optional<WTF::Vector<float>> scales_in, WTF::Vector<uint32_t> axes_in, const WTF::String& label_in)
    : input_operand_id(std::move(input_operand_id_in))
    , output_operand_id(std::move(output_operand_id_in))
    , mode(std::move(mode_in))
...
{
    seed = mojo::internal::WTFHash(seed, this->condition_operand_id);
    seed = mojo::internal::WTFHash(seed, this->true_value_operand_id);
    seed = mojo::internal::WTFHash(seed, this->false_value_operand_id);
    seed = mojo::internal::WTFHash(seed, this->output_operand_id);
    seed = mojo::internal::WTFHash(seed, this->label);
    return seed;
}
...
GraphInfo::GraphInfo(WTF::HashMap<uint64_t, OperandPtr> id_to_operand_map_in, WTF::Vector<uint64_t> input_operands_in, WTF::Vector<uint64_t> output_operands_in,
    WTF::Vector<OperationPtr> operations_in, WTF::HashMap<uint64_t, ::mojo_base::BigBuffer> constant_id_to_buffer_map_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::HashMap<uint64_t, OperandPtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::Vector<OperationPtr>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type WTF::HashMap<uint64_t, ::mojo_base::BigBuffer>>"
#else
        "<value>"
#endif // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t PaddingMode::Hash(size_t seed) const
{
    ...
    case Tag::kEdge:
        return mojo::internal::WTFHash(seed, *data_.edge);
    case Tag::kReflection:
        return mojo::internal::WTFHash(seed, *data_.reflection);
    case Tag::kSymmetric:
        return mojo::internal::WTFHash(seed, *data_.symmetric);
    default:
        NOTREACHED();
    }
}
...
{
    data_.named_outputs = new WTF::HashMap<WTF::String, ::mojo_base::BigBuffer>;
}
...
void ComputeResult::set_named_outputs(WTF::HashMap<WTF::String, ::mojo_base::BigBuffer> named_outputs)
{
    if (tag_ == Tag::kNamedOutputs) {
        *(data_.named_outputs) = std::move(named_outputs);
        ...
        DestroyActive();
        tag_ = Tag::kNamedOutputs;
        data_.named_outputs = new WTF::HashMap<WTF::String, ::mojo_base::BigBuffer>(std::move(named_outputs));
    }
}
void ComputeResult::set_error(::webnn::mojom::blink::ErrorPtr error)
{
    if (tag_ == Tag::kError) {
...
void WebNNGraphProxy::Compute(WTF::HashMap<WTF::String, ::mojo_base::BigBuffer> in_named_inputs, ComputeCallback callback)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send webnn::mojom::WebNNGraph::Compute", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("named_inputs"), in_named_inputs, "<value of type WTF::HashMap<WTF::String, ::mojo_base::BigBuffer>>");
    });
#endif
...
void WebNNGraphProxy::Dispatch(
    const WTF::HashMap<WTF::String, ::blink::WebNNTensorToken>& in_named_inputs, const WTF::HashMap<WTF::String, ::blink::WebNNTensorToken>& in_named_outputs)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send webnn::mojom::WebNNGraph::Dispatch", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("named_inputs"), in_named_inputs, "<value of type const WTF::HashMap<WTF::String, ::blink::WebNNTensorToken>&>");
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("named_outputs"), in_named_outputs, "<value of type const WTF::HashMap<WTF::String, ::blink::WebNNTensorToken>&>");
    });
#endif
...
bool WebNNGraphStubDispatch::Accept(WebNNGraph* impl, mojo::Message* message)
{
    ...
    case messages::WebNNGraph::kDispatch: {
        ...
        bool success = true;
        WTF::HashMap<WTF::String, ::blink::WebNNTensorToken> p_named_inputs {};
        WTF::HashMap<WTF::String, ::blink::WebNNTensorToken> p_named_outputs {};
...
bool WebNNGraphStubDispatch::AcceptWithResponder(WebNNGraph* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
    ...
    case messages::WebNNGraph::kCompute: {
        ...
        // Validation for WebNNGraph.0
        bool success = true;
        WTF::HashMap<WTF::String, ::mojo_base::BigBuffer> p_named_inputs {};
...
{
    const char* name = ::webnn::mojom::blink::WebNNGraph::Name_;
...
bool StructTraits<::webnn::mojom::blink::OperandDescriptor::DataView, ::webnn::mojom::blink::OperandDescriptorPtr>::Read(
    ::webnn::mojom::blink::OperandDescriptor::DataView input, ::webnn::mojom::blink::OperandDescriptorPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Operand::DataView, ::webnn::mojom::blink::OperandPtr>::Read(
    ::webnn::mojom::blink::Operand::DataView input, ::webnn::mojom::blink::OperandPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::ArgMinMax::DataView, ::webnn::mojom::blink::ArgMinMaxPtr>::Read(
    ::webnn::mojom::blink::ArgMinMax::DataView input, ::webnn::mojom::blink::ArgMinMaxPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::BatchNormalization::DataView, ::webnn::mojom::blink::BatchNormalizationPtr>::Read(
    ::webnn::mojom::blink::BatchNormalization::DataView input, ::webnn::mojom::blink::BatchNormalizationPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Clamp::DataView, ::webnn::mojom::blink::ClampPtr>::Read(
    ::webnn::mojom::blink::Clamp::DataView input, ::webnn::mojom::blink::ClampPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Concat::DataView, ::webnn::mojom::blink::ConcatPtr>::Read(
    ::webnn::mojom::blink::Concat::DataView input, ::webnn::mojom::blink::ConcatPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Size2d::DataView, ::webnn::mojom::blink::Size2dPtr>::Read(
    ::webnn::mojom::blink::Size2d::DataView input, ::webnn::mojom::blink::Size2dPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Padding2d::DataView, ::webnn::mojom::blink::Padding2dPtr>::Read(
    ::webnn::mojom::blink::Padding2d::DataView input, ::webnn::mojom::blink::Padding2dPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Conv2d::DataView, ::webnn::mojom::blink::Conv2dPtr>::Read(
    ::webnn::mojom::blink::Conv2d::DataView input, ::webnn::mojom::blink::Conv2dPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::CumulativeSum::DataView, ::webnn::mojom::blink::CumulativeSumPtr>::Read(
    ::webnn::mojom::blink::CumulativeSum::DataView input, ::webnn::mojom::blink::CumulativeSumPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::DequantizeLinear::DataView, ::webnn::mojom::blink::DequantizeLinearPtr>::Read(
    ::webnn::mojom::blink::DequantizeLinear::DataView input, ::webnn::mojom::blink::DequantizeLinearPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::ElementWiseBinary::DataView, ::webnn::mojom::blink::ElementWiseBinaryPtr>::Read(
    ::webnn::mojom::blink::ElementWiseBinary::DataView input, ::webnn::mojom::blink::ElementWiseBinaryPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::ElementWiseUnary::DataView, ::webnn::mojom::blink::ElementWiseUnaryPtr>::Read(
    ::webnn::mojom::blink::ElementWiseUnary::DataView input, ::webnn::mojom::blink::ElementWiseUnaryPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Expand::DataView, ::webnn::mojom::blink::ExpandPtr>::Read(
    ::webnn::mojom::blink::Expand::DataView input, ::webnn::mojom::blink::ExpandPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::ConstantPadding::DataView, ::webnn::mojom::blink::ConstantPaddingPtr>::Read(
    ::webnn::mojom::blink::ConstantPadding::DataView input, ::webnn::mojom::blink::ConstantPaddingPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::EdgePadding::DataView, ::webnn::mojom::blink::EdgePaddingPtr>::Read(
    ::webnn::mojom::blink::EdgePadding::DataView input, ::webnn::mojom::blink::EdgePaddingPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::ReflectionPadding::DataView, ::webnn::mojom::blink::ReflectionPaddingPtr>::Read(
    ::webnn::mojom::blink::ReflectionPadding::DataView input, ::webnn::mojom::blink::ReflectionPaddingPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::SymmetricPadding::DataView, ::webnn::mojom::blink::SymmetricPaddingPtr>::Read(
    ::webnn::mojom::blink::SymmetricPadding::DataView input, ::webnn::mojom::blink::SymmetricPaddingPtr* output)
{
    bool success = true;
    ::webnn::mojom::blink::SymmetricPaddingPtr result(::webnn::mojom::blink::SymmetricPadding::New());
...
bool StructTraits<::webnn::mojom::blink::InstanceNormalization::DataView, ::webnn::mojom::blink::InstanceNormalizationPtr>::Read(
    ::webnn::mojom::blink::InstanceNormalization::DataView input, ::webnn::mojom::blink::InstanceNormalizationPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Matmul::DataView, ::webnn::mojom::blink::MatmulPtr>::Read(
    ::webnn::mojom::blink::Matmul::DataView input, ::webnn::mojom::blink::MatmulPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Pad::DataView, ::webnn::mojom::blink::PadPtr>::Read(
    ::webnn::mojom::blink::Pad::DataView input, ::webnn::mojom::blink::PadPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Reduce::DataView, ::webnn::mojom::blink::ReducePtr>::Read(
    ::webnn::mojom::blink::Reduce::DataView input, ::webnn::mojom::blink::ReducePtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Pool2d::DataView, ::webnn::mojom::blink::Pool2dPtr>::Read(
    ::webnn::mojom::blink::Pool2d::DataView input, ::webnn::mojom::blink::Pool2dPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Range::DataView, ::webnn::mojom::blink::RangePtr>::Read(
    ::webnn::mojom::blink::Range::DataView input, ::webnn::mojom::blink::RangePtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Slice::DataView, ::webnn::mojom::blink::SlicePtr>::Read(
    ::webnn::mojom::blink::Slice::DataView input, ::webnn::mojom::blink::SlicePtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Elu::DataView, ::webnn::mojom::blink::EluPtr>::Read(
    ::webnn::mojom::blink::Elu::DataView input, ::webnn::mojom::blink::EluPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Gather::DataView, ::webnn::mojom::blink::GatherPtr>::Read(
    ::webnn::mojom::blink::Gather::DataView input, ::webnn::mojom::blink::GatherPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::GatherElements::DataView, ::webnn::mojom::blink::GatherElementsPtr>::Read(
    ::webnn::mojom::blink::GatherElements::DataView input, ::webnn::mojom::blink::GatherElementsPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::GatherND::DataView, ::webnn::mojom::blink::GatherNDPtr>::Read(
    ::webnn::mojom::blink::GatherND::DataView input, ::webnn::mojom::blink::GatherNDPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Gelu::DataView, ::webnn::mojom::blink::GeluPtr>::Read(
    ::webnn::mojom::blink::Gelu::DataView input, ::webnn::mojom::blink::GeluPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Gru::DataView, ::webnn::mojom::blink::GruPtr>::Read(
    ::webnn::mojom::blink::Gru::DataView input, ::webnn::mojom::blink::GruPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::GruCell::DataView, ::webnn::mojom::blink::GruCellPtr>::Read(
    ::webnn::mojom::blink::GruCell::DataView input, ::webnn::mojom::blink::GruCellPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Gemm::DataView, ::webnn::mojom::blink::GemmPtr>::Read(
    ::webnn::mojom::blink::Gemm::DataView input, ::webnn::mojom::blink::GemmPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::HardSigmoid::DataView, ::webnn::mojom::blink::HardSigmoidPtr>::Read(
    ::webnn::mojom::blink::HardSigmoid::DataView input, ::webnn::mojom::blink::HardSigmoidPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::HardSwish::DataView, ::webnn::mojom::blink::HardSwishPtr>::Read(
    ::webnn::mojom::blink::HardSwish::DataView input, ::webnn::mojom::blink::HardSwishPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::LayerNormalization::DataView, ::webnn::mojom::blink::LayerNormalizationPtr>::Read(
    ::webnn::mojom::blink::LayerNormalization::DataView input, ::webnn::mojom::blink::LayerNormalizationPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::LeakyRelu::DataView, ::webnn::mojom::blink::LeakyReluPtr>::Read(
    ::webnn::mojom::blink::LeakyRelu::DataView input, ::webnn::mojom::blink::LeakyReluPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Linear::DataView, ::webnn::mojom::blink::LinearPtr>::Read(
    ::webnn::mojom::blink::Linear::DataView input, ::webnn::mojom::blink::LinearPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Lstm::DataView, ::webnn::mojom::blink::LstmPtr>::Read(
    ::webnn::mojom::blink::Lstm::DataView input, ::webnn::mojom::blink::LstmPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::LstmCell::DataView, ::webnn::mojom::blink::LstmCellPtr>::Read(
    ::webnn::mojom::blink::LstmCell::DataView input, ::webnn::mojom::blink::LstmCellPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Prelu::DataView, ::webnn::mojom::blink::PreluPtr>::Read(
    ::webnn::mojom::blink::Prelu::DataView input, ::webnn::mojom::blink::PreluPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::QuantizeLinear::DataView, ::webnn::mojom::blink::QuantizeLinearPtr>::Read(
    ::webnn::mojom::blink::QuantizeLinear::DataView input, ::webnn::mojom::blink::QuantizeLinearPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Relu::DataView, ::webnn::mojom::blink::ReluPtr>::Read(
    ::webnn::mojom::blink::Relu::DataView input, ::webnn::mojom::blink::ReluPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Reshape::DataView, ::webnn::mojom::blink::ReshapePtr>::Read(
    ::webnn::mojom::blink::Reshape::DataView input, ::webnn::mojom::blink::ReshapePtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::ScatterElements::DataView, ::webnn::mojom::blink::ScatterElementsPtr>::Read(
    ::webnn::mojom::blink::ScatterElements::DataView input, ::webnn::mojom::blink::ScatterElementsPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::ScatterND::DataView, ::webnn::mojom::blink::ScatterNDPtr>::Read(
    ::webnn::mojom::blink::ScatterND::DataView input, ::webnn::mojom::blink::ScatterNDPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Sigmoid::DataView, ::webnn::mojom::blink::SigmoidPtr>::Read(
    ::webnn::mojom::blink::Sigmoid::DataView input, ::webnn::mojom::blink::SigmoidPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Softmax::DataView, ::webnn::mojom::blink::SoftmaxPtr>::Read(
    ::webnn::mojom::blink::Softmax::DataView input, ::webnn::mojom::blink::SoftmaxPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Softplus::DataView, ::webnn::mojom::blink::SoftplusPtr>::Read(
    ::webnn::mojom::blink::Softplus::DataView input, ::webnn::mojom::blink::SoftplusPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Softsign::DataView, ::webnn::mojom::blink::SoftsignPtr>::Read(
    ::webnn::mojom::blink::Softsign::DataView input, ::webnn::mojom::blink::SoftsignPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Split::DataView, ::webnn::mojom::blink::SplitPtr>::Read(
    ::webnn::mojom::blink::Split::DataView input, ::webnn::mojom::blink::SplitPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Tanh::DataView, ::webnn::mojom::blink::TanhPtr>::Read(
    ::webnn::mojom::blink::Tanh::DataView input, ::webnn::mojom::blink::TanhPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Tile::DataView, ::webnn::mojom::blink::TilePtr>::Read(
    ::webnn::mojom::blink::Tile::DataView input, ::webnn::mojom::blink::TilePtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Transpose::DataView, ::webnn::mojom::blink::TransposePtr>::Read(
    ::webnn::mojom::blink::Transpose::DataView input, ::webnn::mojom::blink::TransposePtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Triangular::DataView, ::webnn::mojom::blink::TriangularPtr>::Read(
    ::webnn::mojom::blink::Triangular::DataView input, ::webnn::mojom::blink::TriangularPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Resample2d::DataView, ::webnn::mojom::blink::Resample2dPtr>::Read(
    ::webnn::mojom::blink::Resample2d::DataView input, ::webnn::mojom::blink::Resample2dPtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::Where::DataView, ::webnn::mojom::blink::WherePtr>::Read(
    ::webnn::mojom::blink::Where::DataView input, ::webnn::mojom::blink::WherePtr* output)
{
    bool success = true;
...
bool StructTraits<::webnn::mojom::blink::GraphInfo::DataView, ::webnn::mojom::blink::GraphInfoPtr>::Read(
    ::webnn::mojom::blink::GraphInfo::DataView input, ::webnn::mojom::blink::GraphInfoPtr* output)
{
    bool success = true;
...
bool UnionTraits<::webnn::mojom::blink::PaddingMode::DataView, ::webnn::mojom::blink::PaddingModePtr>::Read(
    ::webnn::mojom::blink::PaddingMode::DataView input, ::webnn::mojom::blink::PaddingModePtr* output)
{
    ...
    case Tag::kSymmetric: {
        ::webnn::mojom::blink::SymmetricPaddingPtr result_symmetric;
...
bool UnionTraits<::webnn::mojom::blink::Operation::DataView, ::webnn::mojom::blink::OperationPtr>::Read(
    ::webnn::mojom::blink::Operation::DataView input, ::webnn::mojom::blink::OperationPtr* output)
{
...
bool UnionTraits<::webnn::mojom::blink::ComputeResult::DataView, ::webnn::mojom::blink::ComputeResultPtr>::Read(
    ::webnn::mojom::blink::ComputeResult::DataView input, ::webnn::mojom::blink::ComputeResultPtr* output)
{
    using UnionType = ::webnn::mojom::blink::ComputeResult;
    using Tag = UnionType::Tag;

    switch (input.tag()) {
    case Tag::kNamedOutputs: {
        WTF::HashMap<WTF::String, ::mojo_base::BigBuffer> result_named_outputs;
...
void WebNNGraphAsyncWaiter::Compute(WTF::HashMap<WTF::String, ::mojo_base::BigBuffer> named_inputs, ComputeResultPtr* out_result)
{
    base::RunLoop loop;
...
ComputeResultPtr WebNNGraphAsyncWaiter::Compute(WTF::HashMap<WTF::String, ::mojo_base::BigBuffer> named_inputs)
{
