    ...
    , presentation_feedback()
{
    ...
    {
        return mojo::internal::SerializeImpl<FrameTimingDetails::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::viz::mojom::FrameTimingDetails::DataView, ::viz::mojom::FrameTimingDetailsPtr> {
    static bool IsNull(const ::viz::mojom::FrameTimingDetailsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::FrameTimingDetailsPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::viz::mojom::FrameTimingDetails::draw_start_timestamp)& draw_start_timestamp(const ::viz::mojom::FrameTimingDetailsPtr& input)
    {
        return input->draw_start_timestamp;
    }

    static const decltype(::viz::mojom::FrameTimingDetails::swap_timings)& swap_timings(const ::viz::mojom::FrameTimingDetailsPtr& input)
    {
        return input->swap_timings;
    }

    static const decltype(::viz::mojom::FrameTimingDetails::presentation_feedback)& presentation_feedback(const ::viz::mojom::FrameTimingDetailsPtr& input)
    {
