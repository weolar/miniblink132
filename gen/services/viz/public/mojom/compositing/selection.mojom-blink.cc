...
Selection::Selection(const ::gfx::SelectionBound& start_in, const ::gfx::SelectionBound& end_in)
...
void Selection::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool Selection::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::viz::mojom::blink::Selection::DataView, ::viz::mojom::blink::SelectionPtr>::Read(
    ::viz::mojom::blink::Selection::DataView input, ::viz::mojom::blink::SelectionPtr* output)
{
    bool success = true;
