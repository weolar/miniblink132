...
CopyOutputRequest::CopyOutputRequest(::viz::mojom::CopyOutputResultFormat result_format_in, ::viz::mojom::CopyOutputResultDestination result_destination_in,
    const ::gfx::Vector2d& scale_from_in, const ::gfx::Vector2d& scale_to_in, const std::optional<::base::UnguessableToken>& source_in,
    const std::optional<::gfx::Rect>& area_in, const std::optional<::gfx::Rect>& result_selection_in,
...
void CopyOutputResultSenderProxy::SendResult(::std::unique_ptr<::viz::CopyOutputResult> in_result)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send viz::mojom::CopyOutputResultSender::SendResult", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("result"), in_result, "<value of type ::std::unique_ptr<::viz::CopyOutputResult>>");
    });
#endif
...
bool StructTraits<::viz::mojom::CopyOutputRequest::DataView, ::viz::mojom::CopyOutputRequestPtr>::Read(
    ::viz::mojom::CopyOutputRequest::DataView input, ::viz::mojom::CopyOutputRequestPtr* output)
{
    bool success = true;
