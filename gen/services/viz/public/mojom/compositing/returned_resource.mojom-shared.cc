...
// static
bool ReturnedResource_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const ReturnedResource_Data* object = static_cast<const ReturnedResource_Data*>(data);
