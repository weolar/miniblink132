...
// static
bool StructTraits<::viz::mojom::blink::CompositorFrameTransitionDirectiveSharedElement::DataView,
    ::viz::mojom::blink::CompositorFrameTransitionDirectiveSharedElementPtr>::
    Read(::viz::mojom::blink::CompositorFrameTransitionDirectiveSharedElement::DataView input,
