    ...
    , scroll_tree_index()
{
    ...
    Layer(int64_t id_in, ::cc::mojom::LayerType type_in, const ::gfx::Size& bounds_in, bool contents_opaque_in, bool contents_opaque_for_text_in,
    ...
    {
        return mojo::internal::SerializeImpl<Layer::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , needs_scroll_adjustment_in_y()
{
    ...
    AnchorPositionScrollData(std::vector<::cc::ElementId> adjustment_container_ids_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AnchorPositionScrollData::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , total_containing_block_sticky_offset()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<StickyPositionNodeData::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , anchor_position_scroll_data()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<TransformTreeUpdate::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , visible_frame_element_id()
{
    ...
    TransformNode(int32_t id_in, int32_t parent_id_in, int32_t parent_frame_id_in, ::cc::ElementId element_id_in, const ::gfx::Transform& local_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<TransformNode::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , pixel_moving_filter_id()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ClipNode::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , target_id()
{
    ...
    EffectNode(int32_t id_in, int32_t parent_id_in, int32_t transform_id_in, int32_t clip_id_in, ::cc::ElementId element_id_in, float opacity_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<EffectNode::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , is_composited()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ScrollNode::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::viz::mojom::Layer::DataView, ::viz::mojom::LayerPtr> {
    static bool IsNull(const ::viz::mojom::LayerPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::LayerPtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::Layer::id) id(const ::viz::mojom::LayerPtr& input)
    {
        return input->id;
    }

    static decltype(::viz::mojom::Layer::type) type(const ::viz::mojom::LayerPtr& input)
    {
        return input->type;
    }

    static const decltype(::viz::mojom::Layer::bounds)& bounds(const ::viz::mojom::LayerPtr& input)
    {
        return input->bounds;
    }

    static decltype(::viz::mojom::Layer::contents_opaque) contents_opaque(const ::viz::mojom::LayerPtr& input)
    {
        return input->contents_opaque;
    }

    static decltype(::viz::mojom::Layer::contents_opaque_for_text) contents_opaque_for_text(const ::viz::mojom::LayerPtr& input)
    {
        return input->contents_opaque_for_text;
    }

    static decltype(::viz::mojom::Layer::is_drawable) is_drawable(const ::viz::mojom::LayerPtr& input)
    {
        return input->is_drawable;
    }

    static const decltype(::viz::mojom::Layer::background_color)& background_color(const ::viz::mojom::LayerPtr& input)
    {
        return input->background_color;
    }

    static const decltype(::viz::mojom::Layer::safe_opaque_background_color)& safe_opaque_background_color(const ::viz::mojom::LayerPtr& input)
    {
        return input->safe_opaque_background_color;
    }

    static const decltype(::viz::mojom::Layer::element_id)& element_id(const ::viz::mojom::LayerPtr& input)
    {
        return input->element_id;
    }

    static const decltype(::viz::mojom::Layer::update_rect)& update_rect(const ::viz::mojom::LayerPtr& input)
    {
        return input->update_rect;
    }

    static const decltype(::viz::mojom::Layer::offset_to_transform_parent)& offset_to_transform_parent(const ::viz::mojom::LayerPtr& input)
    {
        return input->offset_to_transform_parent;
    }

    static decltype(::viz::mojom::Layer::transform_tree_index) transform_tree_index(const ::viz::mojom::LayerPtr& input)
    {
        return input->transform_tree_index;
    }

    static decltype(::viz::mojom::Layer::clip_tree_index) clip_tree_index(const ::viz::mojom::LayerPtr& input)
    {
        return input->clip_tree_index;
    }

    static decltype(::viz::mojom::Layer::effect_tree_index) effect_tree_index(const ::viz::mojom::LayerPtr& input)
    {
        return input->effect_tree_index;
    }

    static decltype(::viz::mojom::Layer::scroll_tree_index) scroll_tree_index(const ::viz::mojom::LayerPtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::AnchorPositionScrollData::DataView, ::viz::mojom::AnchorPositionScrollDataPtr> {
    static bool IsNull(const ::viz::mojom::AnchorPositionScrollDataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::AnchorPositionScrollDataPtr* output)
    {
        output->reset();
    }
...
template <> struct StructTraits<::viz::mojom::StickyPositionNodeData::DataView, ::viz::mojom::StickyPositionNodeDataPtr> {
    static bool IsNull(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::StickyPositionNodeDataPtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::StickyPositionNodeData::scroll_ancestor) scroll_ancestor(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->scroll_ancestor;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::is_anchored_left) is_anchored_left(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->is_anchored_left;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::is_anchored_right) is_anchored_right(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->is_anchored_right;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::is_anchored_top) is_anchored_top(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->is_anchored_top;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::is_anchored_bottom) is_anchored_bottom(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->is_anchored_bottom;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::left_offset) left_offset(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->left_offset;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::right_offset) right_offset(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->right_offset;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::top_offset) top_offset(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->top_offset;
    }

    static decltype(::viz::mojom::StickyPositionNodeData::bottom_offset) bottom_offset(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
        return input->bottom_offset;
    }

    static const decltype(::viz::mojom::StickyPositionNodeData::constraint_box_rect)& constraint_box_rect(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
    ...
    static const decltype(::viz::mojom::StickyPositionNodeData::scroll_container_relative_containing_block_rect)&
    scroll_container_relative_containing_block_rect(const ::viz::mojom::StickyPositionNodeDataPtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::TransformTreeUpdate::DataView, ::viz::mojom::TransformTreeUpdatePtr> {
    static bool IsNull(const ::viz::mojom::TransformTreeUpdatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::TransformTreeUpdatePtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::TransformTreeUpdate::page_scale_factor) page_scale_factor(const ::viz::mojom::TransformTreeUpdatePtr& input)
    {
        return input->page_scale_factor;
    }

    static decltype(::viz::mojom::TransformTreeUpdate::device_scale_factor) device_scale_factor(const ::viz::mojom::TransformTreeUpdatePtr& input)
    {
    ...
    static const decltype(::viz::mojom::TransformTreeUpdate::sticky_position_data)& sticky_position_data(const ::viz::mojom::TransformTreeUpdatePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::TransformNode::DataView, ::viz::mojom::TransformNodePtr> {
    static bool IsNull(const ::viz::mojom::TransformNodePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::TransformNodePtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::TransformNode::id) id(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->id;
    }

    static decltype(::viz::mojom::TransformNode::parent_id) parent_id(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->parent_id;
    }

    static decltype(::viz::mojom::TransformNode::parent_frame_id) parent_frame_id(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->parent_frame_id;
    }

    static const decltype(::viz::mojom::TransformNode::element_id)& element_id(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->element_id;
    }

    static const decltype(::viz::mojom::TransformNode::local)& local(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->local;
    }

    static const decltype(::viz::mojom::TransformNode::origin)& origin(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->origin;
    }

    static const decltype(::viz::mojom::TransformNode::scroll_offset)& scroll_offset(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->scroll_offset;
    }

    static const decltype(::viz::mojom::TransformNode::snap_amount)& snap_amount(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->snap_amount;
    }

    static decltype(::viz::mojom::TransformNode::sticky_position_constraint_id) sticky_position_constraint_id(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->sticky_position_constraint_id;
    }

    static decltype(::viz::mojom::TransformNode::anchor_position_scroll_data_id) anchor_position_scroll_data_id(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->anchor_position_scroll_data_id;
    }

    static decltype(::viz::mojom::TransformNode::sorting_context_id) sorting_context_id(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->sorting_context_id;
    }

    static decltype(::viz::mojom::TransformNode::has_potential_animation) has_potential_animation(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->has_potential_animation;
    }

    static decltype(::viz::mojom::TransformNode::is_currently_animating) is_currently_animating(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->is_currently_animating;
    }

    static decltype(::viz::mojom::TransformNode::flattens_inherited_transform) flattens_inherited_transform(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->flattens_inherited_transform;
    }

    static decltype(::viz::mojom::TransformNode::scrolls) scrolls(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->scrolls;
    }

    static decltype(::viz::mojom::TransformNode::should_undo_overscroll) should_undo_overscroll(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->should_undo_overscroll;
    }

    static decltype(::viz::mojom::TransformNode::should_be_snapped) should_be_snapped(const ::viz::mojom::TransformNodePtr& input)
    {
    ...
    static decltype(::viz::mojom::TransformNode::in_subtree_of_page_scale_layer) in_subtree_of_page_scale_layer(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->in_subtree_of_page_scale_layer;
    }

    static decltype(::viz::mojom::TransformNode::transform_changed) transform_changed(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->transform_changed;
    }

    static decltype(::viz::mojom::TransformNode::delegates_to_parent_for_backface) delegates_to_parent_for_backface(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->delegates_to_parent_for_backface;
    }

    static decltype(::viz::mojom::TransformNode::will_change_transform) will_change_transform(const ::viz::mojom::TransformNodePtr& input)
    {
        return input->will_change_transform;
    }

    static const decltype(::viz::mojom::TransformNode::visible_frame_element_id)& visible_frame_element_id(const ::viz::mojom::TransformNodePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::ClipNode::DataView, ::viz::mojom::ClipNodePtr> {
    static bool IsNull(const ::viz::mojom::ClipNodePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::ClipNodePtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::ClipNode::id) id(const ::viz::mojom::ClipNodePtr& input)
    {
        return input->id;
    }

    static decltype(::viz::mojom::ClipNode::parent_id) parent_id(const ::viz::mojom::ClipNodePtr& input)
    {
        return input->parent_id;
    }

    static decltype(::viz::mojom::ClipNode::transform_id) transform_id(const ::viz::mojom::ClipNodePtr& input)
    {
        return input->transform_id;
    }

    static const decltype(::viz::mojom::ClipNode::clip)& clip(const ::viz::mojom::ClipNodePtr& input)
    {
        return input->clip;
    }

    static decltype(::viz::mojom::ClipNode::pixel_moving_filter_id) pixel_moving_filter_id(const ::viz::mojom::ClipNodePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::EffectNode::DataView, ::viz::mojom::EffectNodePtr> {
    static bool IsNull(const ::viz::mojom::EffectNodePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::EffectNodePtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::EffectNode::id) id(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->id;
    }

    static decltype(::viz::mojom::EffectNode::parent_id) parent_id(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->parent_id;
    }

    static decltype(::viz::mojom::EffectNode::transform_id) transform_id(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->transform_id;
    }

    static decltype(::viz::mojom::EffectNode::clip_id) clip_id(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->clip_id;
    }

    static const decltype(::viz::mojom::EffectNode::element_id)& element_id(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->element_id;
    }

    static decltype(::viz::mojom::EffectNode::opacity) opacity(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->opacity;
    }

    static decltype(::viz::mojom::EffectNode::has_render_surface) has_render_surface(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->has_render_surface;
    }

    static const decltype(::viz::mojom::EffectNode::surface_contents_scale)& surface_contents_scale(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->surface_contents_scale;
    }

    static decltype(::viz::mojom::EffectNode::blend_mode) blend_mode(const ::viz::mojom::EffectNodePtr& input)
    {
        return input->blend_mode;
    }

    static decltype(::viz::mojom::EffectNode::target_id) target_id(const ::viz::mojom::EffectNodePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::ScrollNode::DataView, ::viz::mojom::ScrollNodePtr> {
    static bool IsNull(const ::viz::mojom::ScrollNodePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::ScrollNodePtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::ScrollNode::id) id(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->id;
    }

    static decltype(::viz::mojom::ScrollNode::parent_id) parent_id(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->parent_id;
    }

    static decltype(::viz::mojom::ScrollNode::transform_id) transform_id(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->transform_id;
    }

    static const decltype(::viz::mojom::ScrollNode::container_bounds)& container_bounds(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->container_bounds;
    }

    static const decltype(::viz::mojom::ScrollNode::bounds)& bounds(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->bounds;
    }

    static const decltype(::viz::mojom::ScrollNode::element_id)& element_id(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->element_id;
    }
    ...
    static decltype(::viz::mojom::ScrollNode::scrolls_inner_viewport) scrolls_inner_viewport(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->scrolls_inner_viewport;
    }

    static decltype(::viz::mojom::ScrollNode::scrolls_outer_viewport) scrolls_outer_viewport(const ::viz::mojom::ScrollNodePtr& input)
    {
    ...
    static decltype(::viz::mojom::ScrollNode::user_scrollable_horizontal) user_scrollable_horizontal(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->user_scrollable_horizontal;
    }

    static decltype(::viz::mojom::ScrollNode::user_scrollable_vertical) user_scrollable_vertical(const ::viz::mojom::ScrollNodePtr& input)
    {
        return input->user_scrollable_vertical;
    }

    static decltype(::viz::mojom::ScrollNode::is_composited) is_composited(const ::viz::mojom::ScrollNodePtr& input)
    {
