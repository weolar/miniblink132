    ...
    , radii()
{
    ...
    RoundedDisplayMasksInfo(bool is_horizontally_positioned_in, std::vector<uint8_t> radii_in)
    ...
    {
        return mojo::internal::SerializeImpl<RoundedDisplayMasksInfo::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , width()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<DebugBorderQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , intersects_damage_under()
{
    ...
    CompositorRenderPassQuadState(const ::viz::CompositorRenderPassId& render_pass_id_in,
    const ::viz::ResourceId& mask_resource_id_in, const ::gfx::RectF& mask_uv_rect_in, const ::gfx::Size& mask_texture_size_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<CompositorRenderPassQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , force_anti_aliasing_off()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SolidColorQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , allow_merge()
{
    ...
    SurfaceQuadState(const ::viz::SurfaceRange& surface_range_in, const ::SkColor4f& default_background_color_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SurfaceQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , rounded_display_masks_info()
{
    ...
    TextureQuadState(const ::viz::ResourceId& resource_id_in, const ::gfx::Size& resource_size_in_pixels_in, bool premultiplied_alpha_in,
    const ::gfx::PointF& uv_top_left_in, const ::gfx::PointF& uv_bottom_right_in, const ::SkColor4f& background_color_in, bool y_flipped_in,
    bool nearest_neighbor_in, bool secure_output_only_in, bool is_stream_video_in, bool is_video_frame_in, bool force_rgbx_in,
    ::gfx::ProtectedVideoType protected_video_type_in, const std::optional<::gfx::Rect>& damage_rect_in, OverlayPriority overlay_priority_hint_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<TextureQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , force_anti_aliasing_off()
{
    ...
    const ::viz::ResourceId& resource_id_in, bool nearest_neighbor_in, bool force_anti_aliasing_off_in)
    : tex_coord_rect(std::move(tex_coord_rect_in))
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<TileQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    : overlay_plane_id()
{
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VideoHoleQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    : element_resource_id()
{
    ...
    explicit SharedElementQuadState(const ::viz::ViewTransitionElementResourceId& element_resource_id_in)
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<SharedElementQuadState::DataView, std::vector<uint8_t>>(input);
    }
    ...
    , draw_quad_state()
{
    ...
    DrawQuad(const ::gfx::Rect& rect_in, const ::gfx::Rect& visible_rect_in, bool needs_blending_in, const std::optional<::viz::SharedQuadState>& sqs_in,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<DrawQuad::DataView, std::vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::viz::mojom::RoundedDisplayMasksInfo::DataView, ::viz::mojom::RoundedDisplayMasksInfoPtr> {
    static bool IsNull(const ::viz::mojom::RoundedDisplayMasksInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::RoundedDisplayMasksInfoPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::viz::mojom::RoundedDisplayMasksInfo::radii)& radii(const ::viz::mojom::RoundedDisplayMasksInfoPtr& input)
    {
        return input->radii;
    }
...
template <> struct StructTraits<::viz::mojom::DebugBorderQuadState::DataView, ::viz::mojom::DebugBorderQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::DebugBorderQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::DebugBorderQuadStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::DebugBorderQuadState::color)& color(const ::viz::mojom::DebugBorderQuadStatePtr& input)
    {
        return input->color;
    }

    static decltype(::viz::mojom::DebugBorderQuadState::width) width(const ::viz::mojom::DebugBorderQuadStatePtr& input)
    {
        return input->width;
    }
...
template <> struct StructTraits<::viz::mojom::CompositorRenderPassQuadState::DataView, ::viz::mojom::CompositorRenderPassQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::CompositorRenderPassQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::CompositorRenderPassQuadStatePtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::viz::mojom::CompositorRenderPassQuadState::mask_uv_rect)& mask_uv_rect(const ::viz::mojom::CompositorRenderPassQuadStatePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::SolidColorQuadState::DataView, ::viz::mojom::SolidColorQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::SolidColorQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::SolidColorQuadStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::SolidColorQuadState::color)& color(const ::viz::mojom::SolidColorQuadStatePtr& input)
    {
        return input->color;
    }

    static decltype(::viz::mojom::SolidColorQuadState::force_anti_aliasing_off) force_anti_aliasing_off(const ::viz::mojom::SolidColorQuadStatePtr& input)
    {
        return input->force_anti_aliasing_off;
    }
...
template <> struct StructTraits<::viz::mojom::SurfaceQuadState::DataView, ::viz::mojom::SurfaceQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::SurfaceQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::SurfaceQuadStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::SurfaceQuadState::surface_range)& surface_range(const ::viz::mojom::SurfaceQuadStatePtr& input)
    {
        return input->surface_range;
    }

    static const decltype(::viz::mojom::SurfaceQuadState::default_background_color)& default_background_color(const ::viz::mojom::SurfaceQuadStatePtr& input)
    {
    ...
    static decltype(::viz::mojom::SurfaceQuadState::is_reflection) is_reflection(const ::viz::mojom::SurfaceQuadStatePtr& input)
    {
        return input->is_reflection;
    }

    static decltype(::viz::mojom::SurfaceQuadState::allow_merge) allow_merge(const ::viz::mojom::SurfaceQuadStatePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::TextureQuadState::DataView, ::viz::mojom::TextureQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::TextureQuadStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::TextureQuadState::resource_id)& resource_id(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->resource_id;
    }

    static const decltype(::viz::mojom::TextureQuadState::resource_size_in_pixels)& resource_size_in_pixels(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->resource_size_in_pixels;
    }

    static decltype(::viz::mojom::TextureQuadState::premultiplied_alpha) premultiplied_alpha(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->premultiplied_alpha;
    }

    static const decltype(::viz::mojom::TextureQuadState::uv_top_left)& uv_top_left(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->uv_top_left;
    }

    static const decltype(::viz::mojom::TextureQuadState::uv_bottom_right)& uv_bottom_right(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->uv_bottom_right;
    }

    static const decltype(::viz::mojom::TextureQuadState::background_color)& background_color(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->background_color;
    }

    static decltype(::viz::mojom::TextureQuadState::y_flipped) y_flipped(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->y_flipped;
    }

    static decltype(::viz::mojom::TextureQuadState::nearest_neighbor) nearest_neighbor(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->nearest_neighbor;
    }

    static decltype(::viz::mojom::TextureQuadState::secure_output_only) secure_output_only(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->secure_output_only;
    }

    static decltype(::viz::mojom::TextureQuadState::is_stream_video) is_stream_video(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->is_stream_video;
    }

    static decltype(::viz::mojom::TextureQuadState::is_video_frame) is_video_frame(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->is_video_frame;
    }

    static decltype(::viz::mojom::TextureQuadState::force_rgbx) force_rgbx(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->force_rgbx;
    }

    static decltype(::viz::mojom::TextureQuadState::protected_video_type) protected_video_type(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->protected_video_type;
    }

    static const decltype(::viz::mojom::TextureQuadState::damage_rect)& damage_rect(const ::viz::mojom::TextureQuadStatePtr& input)
    {
        return input->damage_rect;
    }

    static decltype(::viz::mojom::TextureQuadState::overlay_priority_hint) overlay_priority_hint(const ::viz::mojom::TextureQuadStatePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::TileQuadState::DataView, ::viz::mojom::TileQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::TileQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::TileQuadStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::TileQuadState::tex_coord_rect)& tex_coord_rect(const ::viz::mojom::TileQuadStatePtr& input)
    {
        return input->tex_coord_rect;
    }

    static const decltype(::viz::mojom::TileQuadState::texture_size)& texture_size(const ::viz::mojom::TileQuadStatePtr& input)
    {
        return input->texture_size;
    }

    static decltype(::viz::mojom::TileQuadState::is_premultiplied) is_premultiplied(const ::viz::mojom::TileQuadStatePtr& input)
    {
        return input->is_premultiplied;
    }

    static const decltype(::viz::mojom::TileQuadState::resource_id)& resource_id(const ::viz::mojom::TileQuadStatePtr& input)
    {
        return input->resource_id;
    }

    static decltype(::viz::mojom::TileQuadState::nearest_neighbor) nearest_neighbor(const ::viz::mojom::TileQuadStatePtr& input)
    {
        return input->nearest_neighbor;
    }

    static decltype(::viz::mojom::TileQuadState::force_anti_aliasing_off) force_anti_aliasing_off(const ::viz::mojom::TileQuadStatePtr& input)
    {
        return input->force_anti_aliasing_off;
    }
...
template <> struct StructTraits<::viz::mojom::VideoHoleQuadState::DataView, ::viz::mojom::VideoHoleQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::VideoHoleQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::VideoHoleQuadStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::VideoHoleQuadState::overlay_plane_id)& overlay_plane_id(const ::viz::mojom::VideoHoleQuadStatePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::SharedElementQuadState::DataView, ::viz::mojom::SharedElementQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::SharedElementQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::SharedElementQuadStatePtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::SharedElementQuadState::element_resource_id)& element_resource_id(const ::viz::mojom::SharedElementQuadStatePtr& input)
    {
...
template <> struct StructTraits<::viz::mojom::DrawQuad::DataView, ::viz::mojom::DrawQuadPtr> {
    static bool IsNull(const ::viz::mojom::DrawQuadPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::DrawQuadPtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::DrawQuad::rect)& rect(const ::viz::mojom::DrawQuadPtr& input)
    {
        return input->rect;
    }

    static const decltype(::viz::mojom::DrawQuad::visible_rect)& visible_rect(const ::viz::mojom::DrawQuadPtr& input)
    {
        return input->visible_rect;
    }

    static decltype(::viz::mojom::DrawQuad::needs_blending) needs_blending(const ::viz::mojom::DrawQuadPtr& input)
    {
        return input->needs_blending;
    }

    static const decltype(::viz::mojom::DrawQuad::sqs)& sqs(const ::viz::mojom::DrawQuadPtr& input)
    {
        return input->sqs;
    }

    static const decltype(::viz::mojom::DrawQuad::draw_quad_state)& draw_quad_state(const ::viz::mojom::DrawQuadPtr& input)
    {
...
template <> struct UnionTraits<::viz::mojom::DrawQuadState::DataView, ::viz::mojom::DrawQuadStatePtr> {
    static bool IsNull(const ::viz::mojom::DrawQuadStatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::DrawQuadStatePtr* output)
    {
        output->reset();
    }
