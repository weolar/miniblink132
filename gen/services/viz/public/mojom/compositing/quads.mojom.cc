...
RoundedDisplayMasksInfo::RoundedDisplayMasksInfo(bool is_horizontally_positioned_in, std::vector<uint8_t> radii_in)
...
CompositorRenderPassQuadState::CompositorRenderPassQuadState(const ::viz::CompositorRenderPassId& render_pass_id_in,
...
SurfaceQuadState::SurfaceQuadState(const ::viz::SurfaceRange& surface_range_in, const ::SkColor4f& default_background_color_in,
...
TextureQuadState::TextureQuadState(const ::viz::ResourceId& resource_id_in, const ::gfx::Size& resource_size_in_pixels_in, bool premultiplied_alpha_in,
...
SharedElementQuadState::SharedElementQuadState(const ::viz::ViewTransitionElementResourceId& element_resource_id_in)
...
DrawQuad::DrawQuad(const ::gfx::Rect& rect_in, const ::gfx::Rect& visible_rect_in, bool needs_blending_in, const std::optional<::viz::SharedQuadState>& sqs_in,
...
bool StructTraits<::viz::mojom::RoundedDisplayMasksInfo::DataView, ::viz::mojom::RoundedDisplayMasksInfoPtr>::Read(
    ::viz::mojom::RoundedDisplayMasksInfo::DataView input, ::viz::mojom::RoundedDisplayMasksInfoPtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::DebugBorderQuadState::DataView, ::viz::mojom::DebugBorderQuadStatePtr>::Read(
    ::viz::mojom::DebugBorderQuadState::DataView input, ::viz::mojom::DebugBorderQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::CompositorRenderPassQuadState::DataView, ::viz::mojom::CompositorRenderPassQuadStatePtr>::Read(
    ::viz::mojom::CompositorRenderPassQuadState::DataView input, ::viz::mojom::CompositorRenderPassQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::SolidColorQuadState::DataView, ::viz::mojom::SolidColorQuadStatePtr>::Read(
    ::viz::mojom::SolidColorQuadState::DataView input, ::viz::mojom::SolidColorQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::SurfaceQuadState::DataView, ::viz::mojom::SurfaceQuadStatePtr>::Read(
    ::viz::mojom::SurfaceQuadState::DataView input, ::viz::mojom::SurfaceQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::TextureQuadState::DataView, ::viz::mojom::TextureQuadStatePtr>::Read(
    ::viz::mojom::TextureQuadState::DataView input, ::viz::mojom::TextureQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::TileQuadState::DataView, ::viz::mojom::TileQuadStatePtr>::Read(
    ::viz::mojom::TileQuadState::DataView input, ::viz::mojom::TileQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::VideoHoleQuadState::DataView, ::viz::mojom::VideoHoleQuadStatePtr>::Read(
    ::viz::mojom::VideoHoleQuadState::DataView input, ::viz::mojom::VideoHoleQuadStatePtr* output)
{
    bool success = true;
...
bool StructTraits<::viz::mojom::SharedElementQuadState::DataView, ::viz::mojom::SharedElementQuadStatePtr>::Read(
    ::viz::mojom::SharedElementQuadState::DataView input, ::viz::mojom::SharedElementQuadStatePtr* output)
{
    bool success = true;
...
// static
bool StructTraits<::viz::mojom::DrawQuad::DataView, ::viz::mojom::DrawQuadPtr>::Read(::viz::mojom::DrawQuad::DataView input, ::viz::mojom::DrawQuadPtr* output)
{
    bool success = true;
...
bool UnionTraits<::viz::mojom::DrawQuadState::DataView, ::viz::mojom::DrawQuadStatePtr>::Read(
    ::viz::mojom::DrawQuadState::DataView input, ::viz::mojom::DrawQuadStatePtr* output)
{
