...
class BLINK_PLATFORM_EXPORT LayerContext : public LayerContextInterfaceBase {
public:
...
class BLINK_PLATFORM_EXPORT LayerContextClient : public LayerContextClientInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
//class BLINK_PLATFORM_EXPORT LayerContextProxy : public LayerContext {
//public:
...
//class BLINK_PLATFORM_EXPORT LayerContextClientProxy : public LayerContextClient {
//public:
    ...
    , removed_animation_timelines()
{
    ...
    {
        return mojo::internal::SerializeImpl<LayerTreeUpdate::DataView, WTF::Vector<uint8_t>>(input);
    }
    ...
    WTF::Vector<::viz::mojom::blink::LayerPtr> layers;

    std::optional<WTF::Vector<int32_t>> layer_order;

    ::viz::mojom::blink::TransformTreeUpdatePtr transform_tree_update;

    WTF::Vector<::viz::mojom::blink::TransformNodePtr> transform_nodes;

    WTF::Vector<::viz::mojom::blink::ClipNodePtr> clip_nodes;

    WTF::Vector<::viz::mojom::blink::EffectNodePtr> effect_nodes;

    WTF::Vector<::viz::mojom::blink::ScrollNodePtr> scroll_nodes;
    ...
    WTF::Vector<::viz::mojom::blink::TilingPtr> tilings;

    std::optional<WTF::Vector<::viz::mojom::blink::AnimationTimelinePtr>> animation_timelines;

    std::optional<WTF::Vector<int32_t>> removed_animation_timelines;
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::LayerTreeUpdate::DataView, ::viz::mojom::blink::LayerTreeUpdatePtr> {
    static bool IsNull(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::blink::LayerTreeUpdatePtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::source_frame_number) source_frame_number(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->source_frame_number;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::trace_id) trace_id(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->trace_id;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::device_viewport)& device_viewport(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->device_viewport;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::device_scale_factor) device_scale_factor(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::LayerTreeUpdate::background_color)& background_color(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
    ...
    static decltype(::viz::mojom::blink::LayerTreeUpdate::page_scale_transform) page_scale_transform(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->page_scale_transform;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::inner_scroll) inner_scroll(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->inner_scroll;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::outer_clip) outer_clip(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->outer_clip;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::outer_scroll) outer_scroll(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->outer_scroll;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::layers)& layers(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->layers;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::layer_order)& layer_order(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::LayerTreeUpdate::transform_nodes)& transform_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->transform_nodes;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::clip_nodes)& clip_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->clip_nodes;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::effect_nodes)& effect_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->effect_nodes;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::scroll_nodes)& scroll_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->scroll_nodes;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::num_transform_nodes) num_transform_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->num_transform_nodes;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::num_clip_nodes) num_clip_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->num_clip_nodes;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::num_effect_nodes) num_effect_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->num_effect_nodes;
    }

    static decltype(::viz::mojom::blink::LayerTreeUpdate::num_scroll_nodes) num_scroll_nodes(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->num_scroll_nodes;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::tilings)& tilings(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
        return input->tilings;
    }

    static const decltype(::viz::mojom::blink::LayerTreeUpdate::animation_timelines)& animation_timelines(const ::viz::mojom::blink::LayerTreeUpdatePtr& input)
    {
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::PendingLayerContext::DataView, ::viz::mojom::blink::PendingLayerContextPtr> {
    static bool IsNull(const ::viz::mojom::blink::PendingLayerContextPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::blink::PendingLayerContextPtr* output)
    {
        output->reset();
    }

    static decltype(::viz::mojom::blink::PendingLayerContext::receiver)& receiver(::viz::mojom::blink::PendingLayerContextPtr& input)
    {
        return input->receiver;
    }

    static decltype(::viz::mojom::blink::PendingLayerContext::client)& client(::viz::mojom::blink::PendingLayerContextPtr& input)
    {
        return input->client;
    }
