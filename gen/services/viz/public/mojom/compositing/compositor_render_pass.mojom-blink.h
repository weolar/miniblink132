    ...
    , has_per_quad_damage()
{
    ...
    CompositorRenderPass(::viz::mojom::blink::CompositorRenderPassIdPtr id_in, const ::gfx::Rect& output_rect_in,
    const ::gfx::Rect& damage_rect_in, const ::gfx::Transform& transform_to_root_target_in, ::viz::mojom::blink::FilterOperationsPtr filters_in,
    ::viz::mojom::blink::FilterOperationsPtr backdrop_filters_in, ::gfx::mojom::blink::RRectFPtr backdrop_filter_bounds_in,
    const ::viz::SubtreeCaptureId& subtree_capture_id_in, const ::gfx::Size& subtree_size_in,
    ::viz::mojom::blink::ViewTransitionElementResourceIdPtr view_transition_element_resource_id_in, bool has_transparent_background_in,
    bool cache_render_pass_in, bool has_damage_from_contributing_content_in, bool generate_mipmap_in,
    WTF::Vector<::viz::mojom::blink::CopyOutputRequestPtr> copy_requests_in, WTF::Vector<::viz::mojom::blink::DrawQuadPtr> quad_list_in,
...
template <> struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::CompositorRenderPass::DataView, ::viz::mojom::blink::CompositorRenderPassPtr> {
    static bool IsNull(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return !input;
    }
    static void SetToNull(::viz::mojom::blink::CompositorRenderPassPtr* output)
    {
        output->reset();
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::id)& id(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->id;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::output_rect)& output_rect(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->output_rect;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::damage_rect)& damage_rect(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPass::filters)& filters(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
    ...
    static const decltype(::viz::mojom::blink::CompositorRenderPass::subtree_size)& subtree_size(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
    ...
    static decltype(::viz::mojom::blink::CompositorRenderPass::cache_render_pass) cache_render_pass(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
    ...
    static decltype(::viz::mojom::blink::CompositorRenderPass::generate_mipmap) generate_mipmap(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->generate_mipmap;
    }

    static decltype(::viz::mojom::blink::CompositorRenderPass::copy_requests)& copy_requests(::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
        return input->copy_requests;
    }

    static const decltype(::viz::mojom::blink::CompositorRenderPass::quad_list)& quad_list(const ::viz::mojom::blink::CompositorRenderPassPtr& input)
    {
