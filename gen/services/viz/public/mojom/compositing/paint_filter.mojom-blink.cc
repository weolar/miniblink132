...
PaintFilter::PaintFilter(std::optional<WTF::Vector<uint8_t>> data_in)
...
void PaintFilter::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
...
bool PaintFilter::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::viz::mojom::blink::PaintFilter::DataView, ::viz::mojom::blink::PaintFilterPtr>::Read(
    ::viz::mojom::blink::PaintFilter::DataView input, ::viz::mojom::blink::PaintFilterPtr* output)
{
    bool success = true;
