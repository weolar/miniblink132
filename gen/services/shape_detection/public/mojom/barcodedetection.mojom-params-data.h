...
static_assert(sizeof(BarcodeDetection_Detect_Params_Data) == 16, "Bad sizeof(BarcodeDetection_Detect_Params_Data)");
...
static_assert(sizeof(BarcodeDetection_Detect_ResponseParams_Data) == 16, "Bad sizeof(BarcodeDetection_Detect_ResponseParams_Data)");
...
public:
    ...
    BarcodeDetection_Detect_ParamsDataView(internal::BarcodeDetection_Detect_Params_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
...
public:
    ...
    BarcodeDetection_Detect_ResponseParamsDataView(internal::BarcodeDetection_Detect_ResponseParams_Data* data, mojo::Message* message)
        : data_(data)
        , message_(message)
    {
    }
    ...
    inline void GetResultsDataView(mojo::ArrayDataView<BarcodeDetectionResultDataView>* output);

    template <typename UserType> [[nodiscard]] bool ReadResults(UserType* output)
    {

        auto* pointer = data_->results.Get();
        return mojo::internal::Deserialize<mojo::ArrayDataView<::shape_detection::mojom::BarcodeDetectionResultDataView>>(pointer, output, message_);
    }
...
inline void BarcodeDetection_Detect_ParamsDataView::GetBitmapDataDataView(::skia::mojom::BitmapN32DataView* output)
{
    auto pointer = data_->bitmap_data.Get();
    *output = ::skia::mojom::BitmapN32DataView(pointer, message_);
}

inline void BarcodeDetection_Detect_ResponseParamsDataView::GetResultsDataView(mojo::ArrayDataView<BarcodeDetectionResultDataView>* output)
{
    auto pointer = data_->results.Get();
