// services/shape_detection/public/mojom/facedetection_provider.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class FaceDetectionProvider : uint32_t {
    kCreateFaceDetection = 0,
};
