...
public:
    ...
    TextDetectionResult(const WTF::String& raw_value, const ::gfx::RectF& bounding_box, WTF::Vector<::gfx::PointF> corner_points);
    ...
    {
        return mojo::internal::SerializeImpl<TextDetectionResult::DataView, WTF::Vector<uint8_t>>(input);
    }
...
template <> struct StructTraits<::shape_detection::mojom::blink::TextDetectionResult::DataView, ::shape_detection::mojom::blink::TextDetectionResultPtr> {
    static bool IsNull(const ::shape_detection::mojom::blink::TextDetectionResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::shape_detection::mojom::blink::TextDetectionResultPtr* output)
    {
        output->reset();
    }
