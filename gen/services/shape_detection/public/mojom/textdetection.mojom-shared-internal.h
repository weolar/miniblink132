// services/shape_detection/public/mojom/textdetection.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<TextDetectionResult_Data>;

    TextDetectionResult_Data();
    ~TextDetectionResult_Data() = delete;
};
static_assert(sizeof(TextDetectionResult_Data) == 32, "Bad sizeof(TextDetectionResult_Data)");
// Used by TextDetectionResult::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct TextDetectionResult_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    TextDetectionResult_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<TextDetectionResult_Data> fragment(message);
...
const mojo::internal::UnserializedMessageContext::Tag TextDetectionResult_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
