...
class BarcodeDetectionProviderInterceptorForTesting : public BarcodeDetectionProvider {
    ...
    void CreateBarcodeDetection(
        ::mojo::PendingReceiver<::shape_detection::mojom::blink::BarcodeDetection> receiver, BarcodeDetectorOptionsPtr options) override;
...
public:
    ...
    void EnumerateSupportedFormats(WTF::Vector<::shape_detection::mojom::blink::BarcodeFormat>* out_supported_formats);
    WTF::Vector<::shape_detection::mojom::blink::BarcodeFormat> EnumerateSupportedFormats();
