...
#include "services/shape_detection/public/mojom/facedetection_provider.mojom-blink-forward.h" // IWYU pragma: export
...
template <typename ImplRefTraits> class FaceDetectionProviderStub;

class FaceDetectionProviderRequestValidator;

class FaceDetectionProvider : public FaceDetectionProviderInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = FaceDetectionProviderStub<ImplRefTraits>;
...
// with not having this data in traces there.
    ...
    virtual void CreateFaceDetection(
...
class FaceDetectionProviderProxy : public FaceDetectionProvider {
public:
    ...
    void CreateFaceDetection(::mojo::PendingReceiver<::shape_detection::mojom::blink::FaceDetection> receiver,
        ::shape_detection::mojom::blink::FaceDetectorOptionsPtr options) final;
...
public:
    ...
    static bool AcceptWithResponder(FaceDetectionProvider* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<FaceDetectionProvider>>
//class FaceDetectionProviderStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return FaceDetectionProviderStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return FaceDetectionProviderStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
