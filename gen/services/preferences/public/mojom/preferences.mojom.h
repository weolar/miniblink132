...
template <typename ImplRefTraits> class ResetOnLoadObserverStub;

class ResetOnLoadObserverRequestValidator;

class ResetOnLoadObserver : public ResetOnLoadObserverInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = ResetOnLoadObserverStub<ImplRefTraits>;
...
class ResetOnLoadObserverProxy : public ResetOnLoadObserver {
public:
...
public:
    ...
    static bool AcceptWithResponder(ResetOnLoadObserver* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<ResetOnLoadObserver>>
//class ResetOnLoadObserverStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return ResetOnLoadObserverStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return ResetOnLoadObserverStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<TrackedPersistentPrefStoreConfiguration, T>::value>;
    ...
    template <typename... Args> static TrackedPersistentPrefStoreConfigurationPtr New(Args&&... args)
    {
        return TrackedPersistentPrefStoreConfigurationPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static TrackedPersistentPrefStoreConfigurationPtr From(const U& u)
    {
    ...
    TrackedPersistentPrefStoreConfiguration(const ::base::FilePath& unprotected_pref_filename, const ::base::FilePath& protected_pref_filename,
        std::vector<TrackedPreferenceMetadataPtr> tracking_configuration, uint64_t reporting_ids_count, const std::string& seed,
        const std::string& legacy_device_id, const std::string& registry_seed, const ::std::u16string& registry_path,
    ...
    template <typename StructPtrType = TrackedPersistentPrefStoreConfigurationPtr> TrackedPersistentPrefStoreConfigurationPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, TrackedPersistentPrefStoreConfiguration::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, TrackedPersistentPrefStoreConfiguration::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    {
        return mojo::internal::SerializeAsMessageImpl<TrackedPersistentPrefStoreConfiguration::DataView>(input);
    }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(
            std::make_unique<
                internal::TrackedPersistentPrefStoreConfiguration_UnserializedMessageContext<UserType, TrackedPersistentPrefStoreConfiguration::DataView>>(
                0, 0, std::move(input)),
    ...
    template <typename UserType> static bool Deserialize(const void* data, size_t data_num_bytes, UserType* output)
    {
        ...
        return mojo::internal::DeserializeImpl<TrackedPersistentPrefStoreConfiguration::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return TrackedPersistentPrefStoreConfiguration::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }
...
template <typename T, TrackedPersistentPrefStoreConfiguration::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
public:
    template <typename T> using EnableIfSame = std::enable_if_t<std::is_same<TrackedPreferenceMetadata, T>::value>;
    ...
    template <typename... Args> static TrackedPreferenceMetadataPtr New(Args&&... args)
    {
        return TrackedPreferenceMetadataPtr(std::in_place, std::forward<Args>(args)...);
    }

    template <typename U> static TrackedPreferenceMetadataPtr From(const U& u)
    {
    ...
    TrackedPreferenceMetadata(uint64_t reporting_id, const std::string& name, TrackedPreferenceMetadata::EnforcementLevel enforcement_level,
        TrackedPreferenceMetadata::PrefTrackingStrategy strategy, TrackedPreferenceMetadata::ValueType value_type);
    ...
    // bindings generator does not need to know whether Clone() or copy
    // constructor/assignment are available for members.
    template <typename StructPtrType = TrackedPreferenceMetadataPtr> TrackedPreferenceMetadataPtr Clone() const;

    // Equals() is a template so it is only instantiated if it is used. Thus, the
    // bindings generator does not need to know whether Equals() or == operator
    // are available for members.
    template <typename T, TrackedPreferenceMetadata::EnableIfSame<T>* = nullptr> bool Equals(const T& other) const;

    template <typename T, TrackedPreferenceMetadata::EnableIfSame<T>* = nullptr> bool operator==(const T& rhs) const
    {
        return Equals(rhs);
    }
    ...
    {
        return mojo::internal::SerializeImpl<TrackedPreferenceMetadata::DataView, std::vector<uint8_t>>(input);
    }

    template <typename UserType> static mojo::Message SerializeAsMessage(UserType* input)
    {
        return mojo::internal::SerializeAsMessageImpl<TrackedPreferenceMetadata::DataView>(input);
    }
    ...
    template <typename UserType> static mojo::Message WrapAsMessage(UserType input)
    {
        return mojo::Message(std::make_unique<internal::TrackedPreferenceMetadata_UnserializedMessageContext<UserType, TrackedPreferenceMetadata::DataView>>(
                                 0, 0, std::move(input)),
            MOJO_CREATE_MESSAGE_FLAG_NONE);
    }
    ...
    {
        mojo::Message message;
        return mojo::internal::DeserializeImpl<TrackedPreferenceMetadata::DataView>(message, data, data_num_bytes, output, Validate);
    }

    template <typename UserType> static bool Deserialize(base::span<const uint8_t> input, UserType* output)
    {
        return TrackedPreferenceMetadata::Deserialize(input.empty() ? nullptr : input.data(), input.size(), output);
    }

    template <typename UserType> static bool DeserializeFromMessage(mojo::Message input, UserType* output)
    {
        auto context
            = input.TakeUnserializedContext<internal::TrackedPreferenceMetadata_UnserializedMessageContext<UserType, TrackedPreferenceMetadata::DataView>>();
        if (context) {
            *output = std::move(context->TakeData());
            return true;
        }
        input.SerializeIfNecessary();
        return mojo::internal::DeserializeImpl<TrackedPreferenceMetadata::DataView>(input, input.payload(), input.payload_num_bytes(), output, Validate);
    }
...
// are used. Thus, the bindings generator does not need to know whether
// comparison operators are available for members.
template <typename T, TrackedPreferenceMetadata::EnableIfSame<T>* = nullptr> bool operator<(const T& lhs, const T& rhs);
...
template <typename StructPtrType> TrackedPersistentPrefStoreConfigurationPtr TrackedPersistentPrefStoreConfiguration::Clone() const
{
    return New(mojo::Clone(unprotected_pref_filename), mojo::Clone(protected_pref_filename), mojo::Clone(tracking_configuration),
        mojo::Clone(reporting_ids_count), mojo::Clone(seed), mojo::Clone(legacy_device_id), mojo::Clone(registry_seed), mojo::Clone(registry_path),
        mojo::Clone(validation_delegate), mojo::Clone(reset_on_load_observer));
}
...
template <typename T, TrackedPersistentPrefStoreConfiguration::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <typename StructPtrType> TrackedPreferenceMetadataPtr TrackedPreferenceMetadata::Clone() const
{
    return New(mojo::Clone(reporting_id), mojo::Clone(name), mojo::Clone(enforcement_level), mojo::Clone(strategy), mojo::Clone(value_type));
}

template <typename T, TrackedPreferenceMetadata::EnableIfSame<T>*> bool TrackedPreferenceMetadata::Equals(const T& other_struct) const
{
...
template <typename T, TrackedPreferenceMetadata::EnableIfSame<T>*> bool operator<(const T& lhs, const T& rhs)
{
...
template <> struct StructTraits<::prefs::mojom::TrackedPersistentPrefStoreConfiguration::DataView, ::prefs::mojom::TrackedPersistentPrefStoreConfigurationPtr> {
    static bool IsNull(const ::prefs::mojom::TrackedPersistentPrefStoreConfigurationPtr& input)
    {
        return !input;
    }
    static void SetToNull(::prefs::mojom::TrackedPersistentPrefStoreConfigurationPtr* output)
    {
        output->reset();
    }
...
template <> struct StructTraits<::prefs::mojom::TrackedPreferenceMetadata::DataView, ::prefs::mojom::TrackedPreferenceMetadataPtr> {
    static bool IsNull(const ::prefs::mojom::TrackedPreferenceMetadataPtr& input)
    {
        return !input;
    }
    static void SetToNull(::prefs::mojom::TrackedPreferenceMetadataPtr* output)
    {
        output->reset();
    }

    static decltype(::prefs::mojom::TrackedPreferenceMetadata::reporting_id) reporting_id(const ::prefs::mojom::TrackedPreferenceMetadataPtr& input)
    {
        return input->reporting_id;
    }

    static const decltype(::prefs::mojom::TrackedPreferenceMetadata::name)& name(const ::prefs::mojom::TrackedPreferenceMetadataPtr& input)
    {
        return input->name;
    }

    static decltype(::prefs::mojom::TrackedPreferenceMetadata::enforcement_level) enforcement_level(const ::prefs::mojom::TrackedPreferenceMetadataPtr& input)
    {
        return input->enforcement_level;
    }

    static decltype(::prefs::mojom::TrackedPreferenceMetadata::strategy) strategy(const ::prefs::mojom::TrackedPreferenceMetadataPtr& input)
    {
        return input->strategy;
    }

    static decltype(::prefs::mojom::TrackedPreferenceMetadata::value_type) value_type(const ::prefs::mojom::TrackedPreferenceMetadataPtr& input)
    {
