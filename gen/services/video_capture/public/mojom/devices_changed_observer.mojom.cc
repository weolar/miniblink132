...
DevicesChangedObserver::IPCStableHashFunction DevicesChangedObserver::MessageToMethodInfo_(mojo::Message& message)
{
    ...
    switch (static_cast<messages::DevicesChangedObserver>(message.name())) {
    case messages::DevicesChangedObserver::kOnDevicesChanged: {
...
uint32_t DevicesChangedObserver::OnDevicesChanged_Sym::IPCStableHash()
{
    ...
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)video_capture::mojom::DevicesChangedObserver::OnDevicesChanged");
...
void DevicesChangedObserverProxy::OnDevicesChanged()
{
    ...
    mojo::Message message(base::to_underlying(messages::DevicesChangedObserver::kOnDevicesChanged), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::video_capture::mojom::internal::DevicesChangedObserver_OnDevicesChanged_Params_Data> params(message);
    params.Allocate();
...
// static
bool DevicesChangedObserverStubDispatch::Accept(DevicesChangedObserver* impl, mojo::Message* message)
{
    switch (static_cast<messages::DevicesChangedObserver>(message->header()->name)) {
    case messages::DevicesChangedObserver::kOnDevicesChanged: {
        DCHECK(message->is_serialized());
        internal::DevicesChangedObserver_OnDevicesChanged_Params_Data* params
            = reinterpret_cast<internal::DevicesChangedObserver_OnDevicesChanged_Params_Data*>(message->mutable_payload());
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, DevicesChangedObserver::Name_, 0, false);
            return false;
        }
...
bool DevicesChangedObserverStubDispatch::AcceptWithResponder(
    DevicesChangedObserver* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const mojo::internal::GenericValidationInfo kDevicesChangedObserverValidationInfo[] = {
    { &internal::DevicesChangedObserver_OnDevicesChanged_Params_Data::Validate, nullptr /* no response */ },
};
...
DevicesChangedObserverAsyncWaiter::DevicesChangedObserverAsyncWaiter(DevicesChangedObserver* proxy)
    : proxy_(proxy)
{
}
