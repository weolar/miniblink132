...
static_assert(sizeof(ReadyFrameInBuffer_Data) == 24, "Bad sizeof(ReadyFrameInBuffer_Data)");
// Used by ReadyFrameInBuffer::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct ReadyFrameInBuffer_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    ReadyFrameInBuffer_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag ReadyFrameInBuffer_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
