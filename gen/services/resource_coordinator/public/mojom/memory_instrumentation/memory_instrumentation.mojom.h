...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) ClientProcess : public ClientProcessInterfaceBase {
public:
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) HeapProfiler : public HeapProfilerInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) HeapProfilerHelper : public HeapProfilerHelperInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) Coordinator : public CoordinatorInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
// with not having this data in traces there.
    ...
    virtual void RequestGlobalMemoryDump(::base::trace_event::MemoryDumpType dump_type, ::base::trace_event::MemoryDumpLevelOfDetail level_of_detail,
        ::base::trace_event::MemoryDumpDeterminism determinism, const std::vector<std::string>& allocator_dump_names, RequestGlobalMemoryDumpCallback callback)
        = 0;
    ...
    virtual void RequestGlobalMemoryDumpAndAppendToTrace(::base::trace_event::MemoryDumpType dump_type,
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) CoordinatorConnector : public CoordinatorConnectorInterfaceBase {
public:
    using IPCStableHashFunction = uint32_t (*)();
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) ClientProcessProxy : public ClientProcess {
public:
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) HeapProfilerProxy : public HeapProfiler {
public:
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) HeapProfilerHelperProxy : public HeapProfilerHelper {
public:
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) CoordinatorProxy : public Coordinator {
public:
    ...
    void RequestGlobalMemoryDump(::base::trace_event::MemoryDumpType dump_type, ::base::trace_event::MemoryDumpLevelOfDetail level_of_detail,
        ...
        RequestGlobalMemoryDumpCallback callback) final;

    void RequestGlobalMemoryDumpForPid(
        ::base::ProcessId pid, const std::vector<std::string>& allocator_dump_names, RequestGlobalMemoryDumpForPidCallback callback) final;
    ...
    void RequestGlobalMemoryDumpAndAppendToTrace(::base::trace_event::MemoryDumpType dump_type, ::base::trace_event::MemoryDumpLevelOfDetail level_of_detail,
        ::base::trace_event::MemoryDumpDeterminism determinism, RequestGlobalMemoryDumpAndAppendToTraceCallback callback) final;

private:
    mojo::MessageReceiverWithResponder* receiver_;
};

class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM) CoordinatorConnectorProxy : public CoordinatorConnector {
public:
...
public:
    ...
    RequestArgs(uint64_t dump_guid, ::base::trace_event::MemoryDumpType dump_type, ::base::trace_event::MemoryDumpLevelOfDetail level_of_detail,
    ...
    {
        return mojo::internal::SerializeImpl<RequestArgs::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RawAllocatorDumpEdge::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AggregatedMetrics::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    static RawAllocatorDumpEntryValuePtr NewValueString(const std::string& value)
    {
        auto result = RawAllocatorDumpEntryValuePtr(std::in_place);
    ...
    void set_value_string(const std::string& value_string);
...
public:
    ...
    RawAllocatorDumpEntry(const std::string& name, const std::string& units, RawAllocatorDumpEntryValuePtr value);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RawAllocatorDumpEntry::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    RawAllocatorDump(uint64_t id, const std::string& absolute_name, bool weak, ::base::trace_event::MemoryDumpLevelOfDetail level_of_detail,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RawAllocatorDump::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    RawProcessMemoryDump(::base::trace_event::MemoryDumpLevelOfDetail level_of_detail,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RawProcessMemoryDump::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    VmRegion(uint64_t start_address, uint64_t size_in_bytes, uint64_t module_timestamp, const std::string& module_debugid, const std::string& module_debug_path,
        uint32_t protection_flags, const std::string& mapped_file, uint64_t byte_stats_private_dirty_resident, uint64_t byte_stats_private_clean_resident,
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<VmRegion::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<PlatformPrivateFootprint::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    RawOSMemDump(uint32_t resident_set_kb, uint32_t peak_resident_set_kb, bool is_peak_rss_resettable, PlatformPrivateFootprintPtr platform_private_footprint,
        std::vector<VmRegionPtr> memory_maps, std::vector<uint8_t> native_library_pages_bitmap);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<RawOSMemDump::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<OSMemDump::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    AllocatorMemDump(const base::flat_map<std::string, uint64_t>& numeric_entries, base::flat_map<std::string, AllocatorMemDumpPtr> children);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<AllocatorMemDump::DataView, std::vector<uint8_t>>(input);
    }
    ...
    base::flat_map<std::string, AllocatorMemDumpPtr> children;
...
public:
    ...
    ProcessMemoryDump(ProcessType process_type, OSMemDumpPtr os_dump, base::flat_map<std::string, AllocatorMemDumpPtr> chrome_allocator_dumps,
        ::base::ProcessId pid, const std::optional<std::string>& service_name);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<ProcessMemoryDump::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    GlobalMemoryDump(::base::TimeTicks start_time, std::vector<ProcessMemoryDumpPtr> process_dumps, AggregatedMetricsPtr aggregated_metrics);
    ...
    template <typename UserType> static std::vector<uint8_t> Serialize(UserType* input)
    {
        return mojo::internal::SerializeImpl<GlobalMemoryDump::DataView, std::vector<uint8_t>>(input);
    }
...
public:
    ...
    HeapProfileResult(::base::ProcessId pid, const ::std::string& json);
...
struct COMPONENT_EXPORT(
    RESOURCE_COORDINATOR_PUBLIC_MOJOM) StructTraits<::memory_instrumentation::mojom::RequestArgs::DataView, ::memory_instrumentation::mojom::RequestArgsPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::RequestArgsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::RequestArgsPtr* output)
    {
        output->reset();
    }

    static decltype(::memory_instrumentation::mojom::RequestArgs::dump_guid) dump_guid(const ::memory_instrumentation::mojom::RequestArgsPtr& input)
    {
        return input->dump_guid;
    }

    static decltype(::memory_instrumentation::mojom::RequestArgs::dump_type) dump_type(const ::memory_instrumentation::mojom::RequestArgsPtr& input)
    {
        return input->dump_type;
    }

    static decltype(::memory_instrumentation::mojom::RequestArgs::level_of_detail) level_of_detail(const ::memory_instrumentation::mojom::RequestArgsPtr& input)
    {
        return input->level_of_detail;
    }

    static decltype(::memory_instrumentation::mojom::RequestArgs::determinism) determinism(const ::memory_instrumentation::mojom::RequestArgsPtr& input)
    {
...
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::RawAllocatorDumpEdge::DataView, ::memory_instrumentation::mojom::RawAllocatorDumpEdgePtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::RawAllocatorDumpEdgePtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::RawAllocatorDumpEdgePtr* output)
    {
        output->reset();
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::RawAllocatorDumpEntry::DataView, ::memory_instrumentation::mojom::RawAllocatorDumpEntryPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::RawAllocatorDumpEntryPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::RawAllocatorDumpEntryPtr* output)
    {
        output->reset();
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::RawAllocatorDump::DataView, ::memory_instrumentation::mojom::RawAllocatorDumpPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::RawAllocatorDumpPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::RawAllocatorDumpPtr* output)
    {
        output->reset();
    }

    static decltype(::memory_instrumentation::mojom::RawAllocatorDump::id) id(const ::memory_instrumentation::mojom::RawAllocatorDumpPtr& input)
    {
        return input->id;
    }
    ...
    static decltype(::memory_instrumentation::mojom::RawAllocatorDump::weak) weak(const ::memory_instrumentation::mojom::RawAllocatorDumpPtr& input)
    {
        return input->weak;
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::RawProcessMemoryDump::DataView, ::memory_instrumentation::mojom::RawProcessMemoryDumpPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::RawProcessMemoryDumpPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::RawProcessMemoryDumpPtr* output)
    {
        output->reset();
    }
...
template <>
struct COMPONENT_EXPORT(
    RESOURCE_COORDINATOR_PUBLIC_MOJOM) StructTraits<::memory_instrumentation::mojom::VmRegion::DataView, ::memory_instrumentation::mojom::VmRegionPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::VmRegionPtr* output)
    {
        output->reset();
    }

    static decltype(::memory_instrumentation::mojom::VmRegion::start_address) start_address(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
        return input->start_address;
    }

    static decltype(::memory_instrumentation::mojom::VmRegion::size_in_bytes) size_in_bytes(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
        return input->size_in_bytes;
    }

    static decltype(::memory_instrumentation::mojom::VmRegion::module_timestamp) module_timestamp(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
        return input->module_timestamp;
    }

    static const decltype(::memory_instrumentation::mojom::VmRegion::module_debugid)& module_debugid(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
    ...
    static decltype(::memory_instrumentation::mojom::VmRegion::protection_flags) protection_flags(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
        return input->protection_flags;
    }

    static const decltype(::memory_instrumentation::mojom::VmRegion::mapped_file)& mapped_file(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
    ...
    static decltype(::memory_instrumentation::mojom::VmRegion::byte_stats_swapped) byte_stats_swapped(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
        return input->byte_stats_swapped;
    }

    static decltype(::memory_instrumentation::mojom::VmRegion::byte_locked) byte_locked(const ::memory_instrumentation::mojom::VmRegionPtr& input)
    {
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::PlatformPrivateFootprint::DataView, ::memory_instrumentation::mojom::PlatformPrivateFootprintPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::PlatformPrivateFootprintPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::PlatformPrivateFootprintPtr* output)
    {
        output->reset();
    }
...
template <>
struct COMPONENT_EXPORT(
    RESOURCE_COORDINATOR_PUBLIC_MOJOM) StructTraits<::memory_instrumentation::mojom::RawOSMemDump::DataView, ::memory_instrumentation::mojom::RawOSMemDumpPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::RawOSMemDumpPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::RawOSMemDumpPtr* output)
    {
        output->reset();
    }
...
template <>
struct COMPONENT_EXPORT(
    RESOURCE_COORDINATOR_PUBLIC_MOJOM) StructTraits<::memory_instrumentation::mojom::OSMemDump::DataView, ::memory_instrumentation::mojom::OSMemDumpPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::OSMemDumpPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::OSMemDumpPtr* output)
    {
        output->reset();
    }

    static decltype(::memory_instrumentation::mojom::OSMemDump::resident_set_kb) resident_set_kb(const ::memory_instrumentation::mojom::OSMemDumpPtr& input)
    {
        return input->resident_set_kb;
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::AllocatorMemDump::DataView, ::memory_instrumentation::mojom::AllocatorMemDumpPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::AllocatorMemDumpPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::AllocatorMemDumpPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::memory_instrumentation::mojom::AllocatorMemDump::children)& children(
        const ::memory_instrumentation::mojom::AllocatorMemDumpPtr& input)
    {
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::ProcessMemoryDump::DataView, ::memory_instrumentation::mojom::ProcessMemoryDumpPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::ProcessMemoryDumpPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::ProcessMemoryDumpPtr* output)
    {
        output->reset();
    }
    ...
    static const decltype(::memory_instrumentation::mojom::ProcessMemoryDump::pid)& pid(const ::memory_instrumentation::mojom::ProcessMemoryDumpPtr& input)
    {
        return input->pid;
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::AggregatedMetrics::DataView, ::memory_instrumentation::mojom::AggregatedMetricsPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::AggregatedMetricsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::AggregatedMetricsPtr* output)
    {
        output->reset();
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::GlobalMemoryDump::DataView, ::memory_instrumentation::mojom::GlobalMemoryDumpPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::GlobalMemoryDumpPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::GlobalMemoryDumpPtr* output)
    {
        output->reset();
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    StructTraits<::memory_instrumentation::mojom::HeapProfileResult::DataView, ::memory_instrumentation::mojom::HeapProfileResultPtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::HeapProfileResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::HeapProfileResultPtr* output)
    {
        output->reset();
    }

    static const decltype(::memory_instrumentation::mojom::HeapProfileResult::pid)& pid(const ::memory_instrumentation::mojom::HeapProfileResultPtr& input)
    {
        return input->pid;
    }

    static decltype(::memory_instrumentation::mojom::HeapProfileResult::json)& json(::memory_instrumentation::mojom::HeapProfileResultPtr& input)
    {
        return input->json;
    }
...
template <>
struct COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM)
    UnionTraits<::memory_instrumentation::mojom::RawAllocatorDumpEntryValue::DataView, ::memory_instrumentation::mojom::RawAllocatorDumpEntryValuePtr> {
    static bool IsNull(const ::memory_instrumentation::mojom::RawAllocatorDumpEntryValuePtr& input)
    {
        return !input;
    }
    static void SetToNull(::memory_instrumentation::mojom::RawAllocatorDumpEntryValuePtr* output)
    {
        output->reset();
    }
