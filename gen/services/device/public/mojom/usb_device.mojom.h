...
#include "services/device/public/mojom/usb_device.mojom-forward.h" // IWYU pragma: export
...
// with not having this data in traces there.
    ...
    virtual void IsochronousTransferOut(uint8_t endpoint_number, ::base::span<const ::uint8_t> data, const std::vector<uint32_t>& packet_lengths,
...
class UsbDeviceProxy : public UsbDevice {
public:
    ...
    void IsochronousTransferIn(
        uint8_t endpoint_number, const std::vector<uint32_t>& packet_lengths, uint32_t timeout, IsochronousTransferInCallback callback) final;
...
class UsbDeviceClientProxy : public UsbDeviceClient {
public:
...
public:
    ...
    UsbIsochronousPacket(uint32_t length, uint32_t transferred_length, UsbTransferStatus status);
...
public:
    ...
    UsbEndpointInfo(uint8_t endpoint_number, UsbTransferDirection direction, UsbTransferType type, uint32_t packet_size,
        UsbSynchronizationType synchronization_type, UsbUsageType usage_type, uint8_t polling_interval, std::vector<uint8_t> extra_data);
...
public:
    ...
    UsbAlternateInterfaceInfo(uint8_t alternate_setting, uint8_t class_code, uint8_t subclass_code, uint8_t protocol_code,
        const std::optional<::std::u16string>& interface_name, std::vector<UsbEndpointInfoPtr> endpoints, std::vector<uint8_t> extra_data);
...
public:
    ...
    UsbInterfaceInfo(uint8_t interface_number, uint8_t first_interface, std::vector<UsbAlternateInterfaceInfoPtr> alternates);
...
public:
    ...
    UsbConfigurationInfo(uint8_t configuration_value, const std::optional<::std::u16string>& configuration_name, bool self_powered, bool remote_wakeup,
        uint8_t maximum_power, std::vector<UsbInterfaceInfoPtr> interfaces, std::vector<uint8_t> extra_data);
...
public:
    ...
    UsbDeviceInfo(const std::string& guid, uint8_t usb_version_major, uint8_t usb_version_minor, uint8_t usb_version_subminor, uint8_t class_code,
        uint8_t subclass_code, uint8_t protocol_code, uint32_t bus_number, uint32_t port_number, uint16_t vendor_id, uint16_t product_id,
        uint8_t device_version_major, uint8_t device_version_minor, uint8_t device_version_subminor, const std::optional<::std::u16string>& manufacturer_name,
        const std::optional<::std::u16string>& product_name, const std::optional<::std::u16string>& serial_number,
        const std::optional<::GURL>& webusb_landing_page, uint8_t active_configuration, std::vector<UsbConfigurationInfoPtr> configurations);
...
public:
    ...
    UsbControlTransferParams(UsbControlTransferType type, UsbControlTransferRecipient recipient, uint8_t request, uint16_t value, uint16_t index);
...
template <> struct StructTraits<::device::mojom::UsbEndpointInfo::DataView, ::device::mojom::UsbEndpointInfoPtr> {
    static bool IsNull(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbEndpointInfoPtr* output)
    {
        output->reset();
    }

    static decltype(::device::mojom::UsbEndpointInfo::endpoint_number) endpoint_number(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
        return input->endpoint_number;
    }

    static decltype(::device::mojom::UsbEndpointInfo::direction) direction(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
        return input->direction;
    }

    static decltype(::device::mojom::UsbEndpointInfo::type) type(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
        return input->type;
    }

    static decltype(::device::mojom::UsbEndpointInfo::packet_size) packet_size(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
    ...
    static decltype(::device::mojom::UsbEndpointInfo::usage_type) usage_type(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
        return input->usage_type;
    }

    static decltype(::device::mojom::UsbEndpointInfo::polling_interval) polling_interval(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
        return input->polling_interval;
    }

    static const decltype(::device::mojom::UsbEndpointInfo::extra_data)& extra_data(const ::device::mojom::UsbEndpointInfoPtr& input)
    {
...
template <> struct StructTraits<::device::mojom::UsbAlternateInterfaceInfo::DataView, ::device::mojom::UsbAlternateInterfaceInfoPtr> {
    static bool IsNull(const ::device::mojom::UsbAlternateInterfaceInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbAlternateInterfaceInfoPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::device::mojom::UsbAlternateInterfaceInfo::class_code) class_code(const ::device::mojom::UsbAlternateInterfaceInfoPtr& input)
    {
    ...
    static const decltype(::device::mojom::UsbAlternateInterfaceInfo::endpoints)& endpoints(const ::device::mojom::UsbAlternateInterfaceInfoPtr& input)
    {
...
template <> struct StructTraits<::device::mojom::UsbInterfaceInfo::DataView, ::device::mojom::UsbInterfaceInfoPtr> {
    static bool IsNull(const ::device::mojom::UsbInterfaceInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbInterfaceInfoPtr* output)
    {
        output->reset();
    }

    static decltype(::device::mojom::UsbInterfaceInfo::interface_number) interface_number(const ::device::mojom::UsbInterfaceInfoPtr& input)
    {
        return input->interface_number;
    }

    static decltype(::device::mojom::UsbInterfaceInfo::first_interface) first_interface(const ::device::mojom::UsbInterfaceInfoPtr& input)
    {
        return input->first_interface;
    }

    static const decltype(::device::mojom::UsbInterfaceInfo::alternates)& alternates(const ::device::mojom::UsbInterfaceInfoPtr& input)
    {
...
template <> struct StructTraits<::device::mojom::UsbConfigurationInfo::DataView, ::device::mojom::UsbConfigurationInfoPtr> {
    static bool IsNull(const ::device::mojom::UsbConfigurationInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbConfigurationInfoPtr* output)
    {
        output->reset();
    }
    ...
    static decltype(::device::mojom::UsbConfigurationInfo::self_powered) self_powered(const ::device::mojom::UsbConfigurationInfoPtr& input)
    {
        return input->self_powered;
    }

    static decltype(::device::mojom::UsbConfigurationInfo::remote_wakeup) remote_wakeup(const ::device::mojom::UsbConfigurationInfoPtr& input)
    {
        return input->remote_wakeup;
    }

    static decltype(::device::mojom::UsbConfigurationInfo::maximum_power) maximum_power(const ::device::mojom::UsbConfigurationInfoPtr& input)
    {
        return input->maximum_power;
    }

    static const decltype(::device::mojom::UsbConfigurationInfo::interfaces)& interfaces(const ::device::mojom::UsbConfigurationInfoPtr& input)
    {
        return input->interfaces;
    }

    static const decltype(::device::mojom::UsbConfigurationInfo::extra_data)& extra_data(const ::device::mojom::UsbConfigurationInfoPtr& input)
    {
        return input->extra_data;
    }
...
template <> struct StructTraits<::device::mojom::UsbDeviceInfo::DataView, ::device::mojom::UsbDeviceInfoPtr> {
    static bool IsNull(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbDeviceInfoPtr* output)
    {
        output->reset();
    }

    static const decltype(::device::mojom::UsbDeviceInfo::guid)& guid(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->guid;
    }

    static decltype(::device::mojom::UsbDeviceInfo::usb_version_major) usb_version_major(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->usb_version_major;
    }

    static decltype(::device::mojom::UsbDeviceInfo::usb_version_minor) usb_version_minor(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
    ...
    static decltype(::device::mojom::UsbDeviceInfo::class_code) class_code(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->class_code;
    }

    static decltype(::device::mojom::UsbDeviceInfo::subclass_code) subclass_code(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->subclass_code;
    }

    static decltype(::device::mojom::UsbDeviceInfo::protocol_code) protocol_code(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->protocol_code;
    }

    static decltype(::device::mojom::UsbDeviceInfo::bus_number) bus_number(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->bus_number;
    }

    static decltype(::device::mojom::UsbDeviceInfo::port_number) port_number(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->port_number;
    }

    static decltype(::device::mojom::UsbDeviceInfo::vendor_id) vendor_id(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->vendor_id;
    }

    static decltype(::device::mojom::UsbDeviceInfo::product_id) product_id(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
    ...
    static const decltype(::device::mojom::UsbDeviceInfo::manufacturer_name)& manufacturer_name(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->manufacturer_name;
    }

    static const decltype(::device::mojom::UsbDeviceInfo::product_name)& product_name(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
        return input->product_name;
    }

    static const decltype(::device::mojom::UsbDeviceInfo::serial_number)& serial_number(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
    ...
    static const decltype(::device::mojom::UsbDeviceInfo::configurations)& configurations(const ::device::mojom::UsbDeviceInfoPtr& input)
    {
...
template <> struct StructTraits<::device::mojom::UsbControlTransferParams::DataView, ::device::mojom::UsbControlTransferParamsPtr> {
    static bool IsNull(const ::device::mojom::UsbControlTransferParamsPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbControlTransferParamsPtr* output)
    {
        output->reset();
    }

    static decltype(::device::mojom::UsbControlTransferParams::type) type(const ::device::mojom::UsbControlTransferParamsPtr& input)
    {
        return input->type;
    }

    static decltype(::device::mojom::UsbControlTransferParams::recipient) recipient(const ::device::mojom::UsbControlTransferParamsPtr& input)
    {
        return input->recipient;
    }

    static decltype(::device::mojom::UsbControlTransferParams::request) request(const ::device::mojom::UsbControlTransferParamsPtr& input)
    {
        return input->request;
    }

    static decltype(::device::mojom::UsbControlTransferParams::value) value(const ::device::mojom::UsbControlTransferParamsPtr& input)
    {
        return input->value;
    }

    static decltype(::device::mojom::UsbControlTransferParams::index) index(const ::device::mojom::UsbControlTransferParamsPtr& input)
    {
        return input->index;
    }
...
template <> struct StructTraits<::device::mojom::UsbIsochronousPacket::DataView, ::device::mojom::UsbIsochronousPacketPtr> {
    static bool IsNull(const ::device::mojom::UsbIsochronousPacketPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbIsochronousPacketPtr* output)
    {
        output->reset();
    }

    static decltype(::device::mojom::UsbIsochronousPacket::length) length(const ::device::mojom::UsbIsochronousPacketPtr& input)
    {
        return input->length;
    }
    ...
    static decltype(::device::mojom::UsbIsochronousPacket::status) status(const ::device::mojom::UsbIsochronousPacketPtr& input)
    {
        return input->status;
    }
...
template <> struct UnionTraits<::device::mojom::UsbOpenDeviceResult::DataView, ::device::mojom::UsbOpenDeviceResultPtr> {
    static bool IsNull(const ::device::mojom::UsbOpenDeviceResultPtr& input)
    {
        return !input;
    }
    static void SetToNull(::device::mojom::UsbOpenDeviceResultPtr* output)
    {
        output->reset();
    }

    static ::device::mojom::UsbOpenDeviceResult::Tag GetTag(const ::device::mojom::UsbOpenDeviceResultPtr& input)
    {
        return input->which();
    }

    static ::device::mojom::UsbOpenDeviceSuccess success(const ::device::mojom::UsbOpenDeviceResultPtr& input)
    {
        return input->get_success();
    }

    static ::device::mojom::UsbOpenDeviceError error(const ::device::mojom::UsbOpenDeviceResultPtr& input)
    {
        return input->get_error();
    }

    static bool Read(::device::mojom::UsbOpenDeviceResult::DataView input, ::device::mojom::UsbOpenDeviceResultPtr* output);
};
