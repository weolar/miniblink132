// services/device/public/mojom/hid.mojom-blink-forward.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2019 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_DEVICE_PUBLIC_MOJOM_HID_MOJOM_BLINK_FORWARD_H_
#define SERVICES_DEVICE_PUBLIC_MOJOM_HID_MOJOM_BLINK_FORWARD_H_
...
using HidBusType = HidBusType;
using HidManagerClientInterfaceBase = HidManagerClientInterfaceBase;
using HidManagerInterfaceBase = HidManagerInterfaceBase;
using HidConnectionInterfaceBase = HidConnectionInterfaceBase;
using HidConnectionClientInterfaceBase = HidConnectionClientInterfaceBase;
using HidConnectionWatcherInterfaceBase = HidConnectionWatcherInterfaceBase;
...
#endif // SERVICES_DEVICE_PUBLIC_MOJOM_HID_MOJOM_BLINK_FORWARD_H_
