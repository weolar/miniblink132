...
#include "services/device/public/mojom/usb_manager_client.mojom-forward.h" // IWYU pragma: export
...
class UsbDeviceManagerClient : public UsbDeviceManagerClientInterfaceBase {
public:
...
class UsbDeviceManagerClientProxy : public UsbDeviceManagerClient {
public:
