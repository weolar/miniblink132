...
private:
    ...
    void Run(::device::mojom::blink::BatteryStatusPtr in_status);
};
...
void BatteryMonitor_QueryNextStatus_ProxyToResponder::Run(::device::mojom::blink::BatteryStatusPtr in_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send reply device::mojom::BatteryMonitor::QueryNextStatus", "async_response_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("status"), in_status, "<value of type ::device::mojom::blink::BatteryStatusPtr>");
    });
#endif
...
void BatteryMonitorAsyncWaiter::QueryNextStatus(::device::mojom::blink::BatteryStatusPtr* out_status)
{
    base::RunLoop loop;
    proxy_->QueryNextStatus(base::BindOnce(
        [](base::RunLoop* loop, ::device::mojom::blink::BatteryStatusPtr* out_status, ::device::mojom::blink::BatteryStatusPtr status) {
...
::device::mojom::blink::BatteryStatusPtr BatteryMonitorAsyncWaiter::QueryNextStatus()
{
    ::device::mojom::blink::BatteryStatusPtr async_wait_result;
