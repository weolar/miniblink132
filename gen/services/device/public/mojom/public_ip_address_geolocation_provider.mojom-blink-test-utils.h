// services/device/public/mojom/public_ip_address_geolocation_provider.mojom-blink-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class BLINK_PLATFORM_EXPORT PublicIpAddressGeolocationProviderInterceptorForTesting : public PublicIpAddressGeolocationProvider {
    ...
    void CreateGeolocation(::network::mojom::blink::MutablePartialNetworkTrafficAnnotationTagPtr tag,
        ::mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver, ::device::mojom::blink::GeolocationClientId client_id) override;
};
