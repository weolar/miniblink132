// services/device/public/mojom/wake_lock_context.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
public:
    ...
    WakeLockContextAsyncWaiter(const WakeLockContextAsyncWaiter&) = delete;
    WakeLockContextAsyncWaiter& operator=(const WakeLockContextAsyncWaiter&) = delete;
