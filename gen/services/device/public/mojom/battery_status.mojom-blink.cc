...
BatteryStatus::BatteryStatus(bool charging_in, double charging_time_in, double discharging_time_in, double level_in)
...
void BatteryStatus::WriteIntoTrace(perfetto::TracedValue traced_context) const
{
    [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("charging"), this->charging,
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("charging_time"), this->charging_time,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    ...
    perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("discharging_time"), this->discharging_time,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
        "<value of type double>"
#else
        "<value>"
...
bool BatteryStatus::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
...
bool StructTraits<::device::mojom::blink::BatteryStatus::DataView, ::device::mojom::blink::BatteryStatusPtr>::Read(
    ::device::mojom::blink::BatteryStatus::DataView input, ::device::mojom::blink::BatteryStatusPtr* output)
{
    bool success = true;
