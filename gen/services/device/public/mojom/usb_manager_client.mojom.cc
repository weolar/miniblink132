...
void UsbDeviceManagerClientProxy::OnDeviceAdded(::device::mojom::UsbDeviceInfoPtr in_device_info)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send device::mojom::UsbDeviceManagerClient::OnDeviceAdded", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(dict.AddItem("device_info"), in_device_info, "<value of type ::device::mojom::UsbDeviceInfoPtr>");
    });
#endif
...
void UsbDeviceManagerClientProxy::OnDeviceRemoved(::device::mojom::UsbDeviceInfoPtr in_device_info)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
