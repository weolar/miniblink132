...
GeopositionError::GeopositionError(GeopositionErrorCode error_code_in, const std::string& error_message_in, const std::string& error_technical_in)
...
bool StructTraits<::device::mojom::GeopositionError::DataView, ::device::mojom::GeopositionErrorPtr>::Read(
    ::device::mojom::GeopositionError::DataView input, ::device::mojom::GeopositionErrorPtr* output)
{
    bool success = true;
...
bool UnionTraits<::device::mojom::GeopositionResult::DataView, ::device::mojom::GeopositionResultPtr>::Read(
    ::device::mojom::GeopositionResult::DataView input, ::device::mojom::GeopositionResultPtr* output)
{
