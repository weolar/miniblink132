...
public:
    ...
    void GetDevicesAndSetClient(::mojo::PendingAssociatedRemote<HidManagerClient> client, std::vector<HidDeviceInfoPtr>* out_devices);
    std::vector<HidDeviceInfoPtr> GetDevicesAndSetClient(::mojo::PendingAssociatedRemote<HidManagerClient> client);
    void GetDevices(std::vector<HidDeviceInfoPtr>* out_devices);
    ...
    ::mojo::PendingRemote<HidConnection> Connect(const std::string& device_guid, ::mojo::PendingRemote<HidConnectionClient> connection_client,
        ::mojo::PendingRemote<HidConnectionWatcher> watcher, bool allow_protected_reports, bool allow_fido_reports);
...
public:
    ...
    void Read(bool* out_success, uint8_t* out_report_id, std::optional<std::vector<uint8_t>>* out_buffer);

    void Write(uint8_t report_id, const std::vector<uint8_t>& buffer, bool* out_success);
    bool Write(uint8_t report_id, const std::vector<uint8_t>& buffer);
    void GetFeatureReport(uint8_t report_id, bool* out_success, std::optional<std::vector<uint8_t>>* out_buffer);

    void SendFeatureReport(uint8_t report_id, const std::vector<uint8_t>& buffer, bool* out_success);
