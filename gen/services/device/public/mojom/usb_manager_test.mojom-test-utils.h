...
class UsbDeviceManagerTestInterceptorForTesting : public UsbDeviceManagerTest {
    ...
    void AddDeviceForTesting(
        const std::string& name, const std::string& serial_number, const std::string& landing_page, AddDeviceForTestingCallback callback) override;
...
public:
    ...
    void GetTestDevices(std::vector<TestDeviceInfoPtr>* out_devices);
