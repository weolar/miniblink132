...
void PowerMonitorClientProxy::PowerStateChange(::mojo_base::mojom::blink::BatteryPowerStatus in_battery_power_status)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send device::mojom::PowerMonitorClient::PowerStateChange", "input_parameters", [&](perfetto::TracedValue context) {
        ...
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("battery_power_status"), in_battery_power_status, "<value of type ::mojo_base::mojom::blink::BatteryPowerStatus>");
    });
#endif
...
bool PowerMonitorClientStubDispatch::Accept(PowerMonitorClient* impl, mojo::Message* message)
{
    ...
    case messages::PowerMonitorClient::kPowerStateChange: {
        ...
        bool success = true;
        ::mojo_base::mojom::blink::BatteryPowerStatus p_battery_power_status {};
...
void PowerMonitorClientInterceptorForTesting::PowerStateChange(::mojo_base::mojom::blink::BatteryPowerStatus battery_power_status)
{
