...
class DeviceServiceInterceptorForTesting : public DeviceService {
    ...
    void BindGeolocationInternals(::mojo::PendingReceiver<::device::mojom::GeolocationInternals> receiver) override;
    void BindBatteryMonitor(::mojo::PendingReceiver<::device::mojom::BatteryMonitor> receiver) override;
    void BindPressureManager(::mojo::PendingReceiver<::device::mojom::PressureManager> receiver) override;
    void BindVibrationManager(::mojo::PendingReceiver<::device::mojom::VibrationManager> receiver,
        ::mojo::PendingRemote<::device::mojom::VibrationManagerListener> listener) override;
    void BindHidManager(::mojo::PendingReceiver<::device::mojom::HidManager> receiver) override;
