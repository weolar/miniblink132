...
// static
bool Geolocation_SetHighAccuracy_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    [[maybe_unused]] const Geolocation_SetHighAccuracy_Params_Data* object = static_cast<const Geolocation_SetHighAccuracy_Params_Data*>(data);
...
// static
bool Geolocation_QueryNextPosition_Params_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
    ...
    // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
    // the message comes from an older version.
    [[maybe_unused]] const Geolocation_QueryNextPosition_Params_Data* object = static_cast<const Geolocation_QueryNextPosition_Params_Data*>(data);
...
// static
bool Geolocation_QueryNextPosition_ResponseParams_Data::Validate(const void* data, mojo::internal::ValidationContext* validation_context)
{
    if (!data)
        return true;
