// services/device/public/mojom/geolocation_control.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
GeolocationControl::IPCStableHashFunction GeolocationControl::MessageToMethodInfo_(mojo::Message& message)
{
    ...
    switch (static_cast<messages::GeolocationControl>(message.name())) {
    case messages::GeolocationControl::kUserDidOptIntoLocationServices: {
...
uint32_t GeolocationControl::UserDidOptIntoLocationServices_Sym::IPCStableHash()
{
    ...
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)device::mojom::GeolocationControl::UserDidOptIntoLocationServices");
...
void GeolocationControlProxy::UserDidOptIntoLocationServices()
{
    ...
    mojo::Message message(base::to_underlying(messages::GeolocationControl::kUserDidOptIntoLocationServices), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::device::mojom::internal::GeolocationControl_UserDidOptIntoLocationServices_Params_Data> params(message);
    params.Allocate();
...
// static
bool GeolocationControlStubDispatch::Accept(GeolocationControl* impl, mojo::Message* message)
{
    switch (static_cast<messages::GeolocationControl>(message->header()->name)) {
    case messages::GeolocationControl::kUserDidOptIntoLocationServices: {
        DCHECK(message->is_serialized());
        internal::GeolocationControl_UserDidOptIntoLocationServices_Params_Data* params
            = reinterpret_cast<internal::GeolocationControl_UserDidOptIntoLocationServices_Params_Data*>(message->mutable_payload());
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, GeolocationControl::Name_, 0, false);
            return false;
        }
...
bool GeolocationControlStubDispatch::AcceptWithResponder(
    GeolocationControl* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const mojo::internal::GenericValidationInfo kGeolocationControlValidationInfo[] = {
    { &internal::GeolocationControl_UserDidOptIntoLocationServices_Params_Data::Validate, nullptr /* no response */ },
};

bool GeolocationControlRequestValidator::Accept(mojo::Message* message)
{
    const char* name = ::device::mojom::GeolocationControl::Name_;
...
GeolocationControlAsyncWaiter::GeolocationControlAsyncWaiter(GeolocationControl* proxy)
    : proxy_(proxy)
{
}
