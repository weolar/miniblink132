...
LogFactoryManager::IPCStableHashFunction LogFactoryManager::MessageToMethodInfo_(mojo::Message& message)
{
    ...
    switch (static_cast<messages::LogFactoryManager>(message.name())) {
    case messages::LogFactoryManager::kSetLogFactory: {
...
uint32_t LogFactoryManager::SetLogFactory_Sym::IPCStableHash()
{
    ...
    constexpr uint32_t kHash = base::MD5Hash32Constexpr("(Impl)audio::mojom::LogFactoryManager::SetLogFactory");
...
void LogFactoryManagerProxy::SetLogFactory(::mojo::PendingRemote<::media::mojom::AudioLogFactory> in_factory)
{
#if BUILDFLAG(MOJO_TRACE_ENABLED)
    TRACE_EVENT1("mojom", "Send audio::mojom::LogFactoryManager::SetLogFactory", "input_parameters", [&](perfetto::TracedValue context) {
        auto dict = std::move(context).WriteDictionary();
        perfetto::WriteIntoTracedValueWithFallback(
            dict.AddItem("factory"), in_factory, "<value of type ::mojo::PendingRemote<::media::mojom::AudioLogFactory>>");
    });
#endif
    ...
    mojo::Message message(base::to_underlying(messages::LogFactoryManager::kSetLogFactory), kFlags, estimated_payload_size);
    mojo::internal::MessageFragment<::audio::mojom::internal::LogFactoryManager_SetLogFactory_Params_Data> params(message);
    params.Allocate();
    mojo::internal::Serialize<mojo::InterfacePtrDataView<::media::mojom::AudioLogFactoryInterfaceBase>>(in_factory, &params->factory, &params.message());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(!mojo::internal::IsHandleOrInterfaceValid(params->factory),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE, "invalid factory in LogFactoryManager.SetLogFactory request");
...
// static
bool LogFactoryManagerStubDispatch::Accept(LogFactoryManager* impl, mojo::Message* message)
{
    switch (static_cast<messages::LogFactoryManager>(message->header()->name)) {
    case messages::LogFactoryManager::kSetLogFactory: {
        DCHECK(message->is_serialized());
        internal::LogFactoryManager_SetLogFactory_Params_Data* params
            = reinterpret_cast<internal::LogFactoryManager_SetLogFactory_Params_Data*>(message->mutable_payload());
        ...
        if (!success) {
            ReportValidationErrorForMessage(message, mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED, LogFactoryManager::Name_, 0, false);
            return false;
        }
        // A null |impl| means no implementation was bound.
        DCHECK(impl);
        impl->SetLogFactory(std::move(p_factory));
        return true;
    }
    }
    return false;
...
bool LogFactoryManagerStubDispatch::AcceptWithResponder(
    LogFactoryManager* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder)
{
...
static const mojo::internal::GenericValidationInfo kLogFactoryManagerValidationInfo[] = {
    { &internal::LogFactoryManager_SetLogFactory_Params_Data::Validate, nullptr /* no response */ },
};
...
LogFactoryManagerAsyncWaiter::LogFactoryManagerAsyncWaiter(LogFactoryManager* proxy)
    : proxy_(proxy)
{
}
