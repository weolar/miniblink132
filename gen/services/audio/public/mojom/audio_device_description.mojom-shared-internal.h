...
public:
    ...
    uint8_t is_communications_device : 1;
    uint8_t padfinal_[7];
...
static_assert(sizeof(AudioDeviceDescription_Data) == 40, "Bad sizeof(AudioDeviceDescription_Data)");
// Used by AudioDeviceDescription::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct AudioDeviceDescription_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    AudioDeviceDescription_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
const mojo::internal::UnserializedMessageContext::Tag AudioDeviceDescription_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
