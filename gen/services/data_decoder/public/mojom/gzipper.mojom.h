...
template <typename ImplRefTraits> class GzipperStub;

class GzipperRequestValidator;
class GzipperResponseValidator;

class Gzipper : public GzipperInterfaceBase {
public:
    ...
    template <typename ImplRefTraits> using Stub_ = GzipperStub<ImplRefTraits>;
...
class GzipperProxy : public Gzipper {
public:
...
public:
    ...
    static bool AcceptWithResponder(Gzipper* impl, mojo::Message* message, std::unique_ptr<mojo::MessageReceiverWithStatus> responder);
};

//template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<Gzipper>> class GzipperStub : public mojo::MessageReceiverWithResponderStatus {
//public:
...
//            return false;
//        return GzipperStubDispatch::Accept(ImplRefTraits::GetRawPointer(&sink_), message);
//    }
//
...
//        if (ImplRefTraits::IsNull(sink_))
//            return false;
//        return GzipperStubDispatch::AcceptWithResponder(ImplRefTraits::GetRawPointer(&sink_), message, std::move(responder));
//    }
//
//private:
