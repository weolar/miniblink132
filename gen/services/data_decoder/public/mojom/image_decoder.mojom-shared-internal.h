// services/data_decoder/public/mojom/image_decoder.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
private:
    friend class mojo::internal::MessageFragment<AnimationFrame_Data>;

    AnimationFrame_Data();
    ~AnimationFrame_Data() = delete;
};
static_assert(sizeof(AnimationFrame_Data) == 24, "Bad sizeof(AnimationFrame_Data)");
// Used by AnimationFrame::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView> struct AnimationFrame_UnserializedMessageContext : public mojo::internal::UnserializedMessageContext {
public:
    static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

    AnimationFrame_UnserializedMessageContext(uint32_t message_name, uint32_t message_flags, UserType input)
...
private:
    ...
    {
        mojo::internal::MessageFragment<AnimationFrame_Data> fragment(message);
...
const mojo::internal::UnserializedMessageContext::Tag AnimationFrame_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
