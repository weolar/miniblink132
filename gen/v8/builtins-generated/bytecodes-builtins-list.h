...
#define BUILTIN_LIST_BYTECODE_HANDLERS(V)                                                                                                                      \
    ...
    V(LdaLookupScriptContextSlotInsideTypeofExtraWideHandler, interpreter::OperandScale::kQuadruple,                                                           \
        interpreter::Bytecode::kLdaLookupScriptContextSlotInsideTypeof)                                                                                        \
    ...
    V(FindNonDefaultConstructorOrConstructExtraWideHandler, interpreter::OperandScale::kQuadruple,                                                             \
