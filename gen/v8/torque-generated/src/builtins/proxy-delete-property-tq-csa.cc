...
TF_BUILTIN(ProxyDeleteProperty, CodeStubAssembler)
{
    ...
    if (block28.is_used()) {
        ...
        tmp10 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { tmp7 }, TNode<Object> { tmp2 }, TNode<Object> { tmp6 }, TNode<Object> { parameter2 });
    ...
    if (block32.is_used()) {
        ...
        CodeStubAssembler(state_).ThrowTypeError(
            TNode<Context> { parameter0 }, MessageTemplate::kProxyTrapReturnedFalsishFor, TNode<Object> { tmp15 }, TNode<Object> { parameter2 });
    }
    ...
    if (block31.is_used()) {
        ca_.Bind(&block31);
        ProxiesCodeStubAssembler(state_).CheckDeleteTrapResult(
            TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp6 }, TNode<JSProxy> { parameter1 }, TNode<Name> { parameter2 });
        tmp17 = True_0(state_);
