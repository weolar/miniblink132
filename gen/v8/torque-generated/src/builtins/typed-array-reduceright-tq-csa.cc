...
TNode<Object> ReduceRightAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context,
    TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedArrayAndLength, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue)
{
    ...
    if (block18.is_used()) {
        ...
        tmp17 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { tmp15 },
            TNode<Object> { ca_.UncheckedCast<Object>(phi_bb18_11) }, TNode<Object> { phi_bb5_10 }, TNode<Object> { tmp16 }, TNode<Object> { tmp0 });
...
TF_BUILTIN(TypedArrayPrototypeReduceRight, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp16 = ReduceRightAllElements_0(state_, TNode<Context> { parameter0 },
