...
TF_BUILTIN(GroupByGeneric, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch10__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp9 = CodeStubAssembler(state_).Call(
                TNode<Context> { parameter0 }, TNode<Object> { parameter3 }, TNode<Object> { tmp8 }, TNode<Object> { tmp7 }, TNode<Object> { phi_bb10_10 });
        }
        ...
        tmp15 = CollectionsBuiltinsAssembler(state_).AddValueToKeyedGroup(
            TNode<OrderedHashMap> { phi_bb10_6 }, TNode<Object> { tmp12 }, TNode<Object> { tmp7 }, TNode<String> { parameter5 });
    ...
    TNode<Boolean> p_coerceToProperty, const char* p_methodName)
{
    ...
    if (block16.is_used()) {
        ...
        ca_.Branch(tmp15, &block14, std::vector<compiler::Node*> { phi_bb16_5, phi_bb16_9, phi_bb16_13 }, &block15,
            std::vector<compiler::Node*> { phi_bb16_5, phi_bb16_9, phi_bb16_13 });
    }
    ...
    if (block14.is_used()) {
        ...
        ca_.Branch(tmp18, &block20, std::vector<compiler::Node*> { phi_bb14_5, phi_bb14_9, phi_bb14_13 }, &block21,
            std::vector<compiler::Node*> { phi_bb14_5, phi_bb14_9, phi_bb14_13 });
    }
    ...
    if (block21.is_used()) {
        ...
        ca_.Branch(tmp19, &block22, std::vector<compiler::Node*> { phi_bb21_5, phi_bb21_9, phi_bb21_13 }, &block23,
            std::vector<compiler::Node*> { phi_bb21_5, phi_bb21_9, phi_bb21_13 });
    }
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp11, &block27, std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_13, phi_bb23_13, phi_bb23_13 }, &block28,
            std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_13, phi_bb23_13, phi_bb23_13 });
    }
    ...
    if (block24.is_used()) {
        ...
        tmp27 = CodeStubAssembler(state_).Call(
            TNode<Context> { p_context }, TNode<Object> { tmp1 }, TNode<Object> { tmp26 }, TNode<Object> { phi_bb24_14 }, TNode<Object> { phi_bb24_13 });
        ...
        tmp30 = CollectionsBuiltinsAssembler(state_).AddValueToKeyedGroup(
            TNode<OrderedHashMap> { phi_bb24_5 }, TNode<Object> { tmp28 }, TNode<Object> { phi_bb24_14 }, TNode<String> { tmp29 });
    ...
    if (block36.is_used()) {
        ...
        ca_.Branch(tmp35, &block34, std::vector<compiler::Node*> { phi_bb36_5, phi_bb36_9, phi_bb36_13 }, &block35,
            std::vector<compiler::Node*> { phi_bb36_5, phi_bb36_9, phi_bb36_13 });
    }
    ...
    if (block34.is_used()) {
        ...
        tmp38 = CodeStubAssembler(state_).Call(
            TNode<Context> { p_context }, TNode<Object> { tmp1 }, TNode<Object> { tmp37 }, TNode<Object> { tmp36 }, TNode<Object> { phi_bb34_13 });
        ...
        tmp41 = CollectionsBuiltinsAssembler(state_).AddValueToKeyedGroup(
            TNode<OrderedHashMap> { phi_bb34_5 }, TNode<Object> { tmp39 }, TNode<Object> { tmp36 }, TNode<String> { tmp40 });
...
TF_BUILTIN(ObjectGroupBy, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = True_0(state_);
        tmp1 = GroupByImpl_0(
            state_, TNode<Context> { parameter0 }, TNode<Object> { parameter2 }, TNode<Object> { parameter3 }, TNode<Boolean> { tmp0 }, "Object.groupBy");
    ...
    if (block5.is_used()) {
        ...
        ca_.Branch(tmp13, &block3, std::vector<compiler::Node*> { phi_bb5_8, phi_bb5_9, phi_bb5_10 }, &block4,
    ...
    if (block3.is_used()) {
        ...
        std::tie(tmp14, tmp15, tmp16) = CollectionsBuiltinsAssembler(state_)
                                            .NextKeyValueIndexTupleUnmodifiedTable(TNode<OrderedHashMap> { tmp2 }, TNode<Int32T> { tmp3 },
                                                TNode<Int32T> { tmp4 }, TNode<IntPtrT> { phi_bb3_10 }, &label17)
                                            .Flatten();
