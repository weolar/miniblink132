...
TF_BUILTIN(StringPrototypeMatch, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = StringMatchSearch_StringMatchFunctor_0(state_, TNode<NativeContext> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 },
            TorqueStructStringMatchFunctor_0 {}, "String.prototype.match");
...
TF_BUILTIN(StringPrototypeSearch, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = StringMatchSearch_StringSearchFunctor_0(state_, TNode<NativeContext> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 },
            TorqueStructStringSearchFunctor_0 {}, "String.prototype.search");
        CodeStubAssembler(state_).Return(tmp0);
    }
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/string-match-search.tq?l=77&c=10
TNode<Object> StringMatchSearch_StringMatchFunctor_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<Object> p_receiver,
    TNode<Object> p_regexp, TorqueStructStringMatchFunctor_0 p_functor, const char* p_methodName)
{
...
TNode<Object> StringMatchSearch_StringSearchFunctor_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<Object> p_receiver,
    TNode<Object> p_regexp, TorqueStructStringSearchFunctor_0 p_functor, const char* p_methodName)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
