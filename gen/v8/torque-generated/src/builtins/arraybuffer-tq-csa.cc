...
TF_BUILTIN(ArrayBufferPrototypeGetByteLength, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        CodeStubAssembler(state_).ThrowTypeError(
            TNode<Context> { parameter0 }, MessageTemplate::kIncompatibleMethodReceiver, TNode<Object> { tmp4 }, TNode<Object> { parameter1 });
    }
...
TF_BUILTIN(SharedArrayBufferPrototypeGetMaxByteLength, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        CodeStubAssembler(state_).ThrowTypeError(
            TNode<Context> { parameter0 }, MessageTemplate::kIncompatibleMethodReceiver, TNode<Object> { tmp5 }, TNode<Object> { parameter1 });
    }
