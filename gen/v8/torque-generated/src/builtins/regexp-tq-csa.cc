...
TNode<Object> RegExpExec_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string)
{
    ...
    if (block11.is_used()) {
        ...
        CodeStubAssembler(state_).ThrowTypeError(
            TNode<Context> { p_context }, MessageTemplate::kIncompatibleMethodReceiver, TNode<Object> { tmp9 }, TNode<Object> { p_receiver });
    }
...
TNode<RegExpMatchInfo> RegExpPrototypeExecBodyWithoutResult_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp,
    TNode<String> p_string, TNode<Number> p_regexpLastIndex, bool p_isFastPath, compiler::CodeAssemblerLabel* label_IfDidNotMatch)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block12.is_used()) {
        ...
        tmp18 = RegExpBuiltinsAssembler(state_).RegExpExecInternal(TNode<Context> { p_context }, TNode<JSRegExp> { p_regexp }, TNode<String> { p_string },
            TNode<Number> { phi_bb12_4 }, TNode<RegExpMatchInfo> { tmp17 });
        tmp19 = Null_0(state_);
    ...
    if (block20.is_used()) {
        ...
        tmp22 = Method_RegExpMatchInfo_GetEndOfCapture_0(
            state_, TNode<RegExpMatchInfo> { tmp21 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
...
TNode<RegExpMatchInfo> RegExpPrototypeExecBodyWithoutResultFast_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp,
    TNode<String> p_string, compiler::CodeAssemblerLabel* label_IfDidNotMatch)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp1 = RegExpPrototypeExecBodyWithoutResult_0(
            state_, TNode<Context> { p_context }, TNode<JSRegExp> { p_regexp }, TNode<String> { p_string }, TNode<Number> { tmp0 }, true, &label2);
        ca_.Goto(&block3);
        if (label2.is_used()) {
            ca_.Bind(&label2);
            ca_.Goto(&block4);
...
TNode<RegExpMatchInfo> RegExpPrototypeExecBodyWithoutResultFast_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp,
    TNode<String> p_string, TNode<Number> p_lastIndex, compiler::CodeAssemblerLabel* label_IfDidNotMatch)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        compiler::CodeAssemblerLabel label1(&ca_);
        tmp0 = RegExpPrototypeExecBodyWithoutResult_0(
            state_, TNode<Context> { p_context }, TNode<JSRegExp> { p_regexp }, TNode<String> { p_string }, TNode<Number> { p_lastIndex }, true, &label1);
        ca_.Goto(&block3);
        if (label1.is_used()) {
            ca_.Bind(&label1);
            ca_.Goto(&block4);
...
TNode<Object> RegExpPrototypeExecBody_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string, bool p_isFastPath)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block8.is_used()) {
        ...
        CodeStubAssembler(state_).ThrowTypeError(
            TNode<Context> { p_context }, MessageTemplate::kIncompatibleMethodReceiver, TNode<Object> { tmp3 }, TNode<Object> { p_receiver });
    }
    ...
    if (block4.is_used()) {
        ...
        tmp5 = RegExpPrototypeExecBodyWithoutResult_0(
            state_, TNode<Context> { p_context }, TNode<JSRegExp> { phi_bb4_3 }, TNode<String> { p_string }, TNode<Number> { tmp4 }, p_isFastPath, &label6);
    ...
    if (block11.is_used()) {
        ...
        tmp8 = RegExpBuiltinsAssembler(state_).ConstructNewResultFromMatchInfo(
            TNode<Context> { p_context }, TNode<JSRegExp> { phi_bb11_3 }, TNode<RegExpMatchInfo> { tmp5 }, TNode<String> { p_string }, TNode<Number> { tmp4 });
...
TNode<Object> FlagGetter_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, JSRegExp::Flag p_flag, int31_t p_counter,
    const char* p_methodName)
{
    ...
    if (block7.is_used()) {
        ca_.Bind(&block7);
        if (((CodeStubAssembler(state_).ConstexprInt31NotEqual(
                p_counter, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull))))))) {
            ca_.Goto(&block8);
        } else {
            ca_.Goto(&block9);
        }
...
TF_BUILTIN(RegExpPrototypeGlobalGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kGlobal, kNoCounterFlagGetter_0(state_),
...
TF_BUILTIN(RegExpPrototypeIgnoreCaseGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kIgnoreCase, kNoCounterFlagGetter_0(state_),
...
TF_BUILTIN(RegExpPrototypeMultilineGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kMultiline, kNoCounterFlagGetter_0(state_),
...
TF_BUILTIN(RegExpPrototypeHasIndicesGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kHasIndices, kNoCounterFlagGetter_0(state_),
...
TF_BUILTIN(RegExpPrototypeLinearGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kLinear, kNoCounterFlagGetter_0(state_),
...
TF_BUILTIN(RegExpPrototypeDotAllGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kDotAll, kNoCounterFlagGetter_0(state_),
...
TF_BUILTIN(RegExpPrototypeStickyGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kSticky,
            v8::Isolate::kRegExpPrototypeStickyGetter, "RegExp.prototype.sticky");
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(RegExpPrototypeUnicodeGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kUnicode,
            v8::Isolate::kRegExpPrototypeUnicodeGetter, "RegExp.prototype.unicode");
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(RegExpPrototypeUnicodeSetsGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FlagGetter_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, JSRegExp::Flag::kUnicodeSets, kNoCounterFlagGetter_0(state_),
...
TF_BUILTIN(RegExpPrototypeFlagsGetter, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        CodeStubAssembler(state_).ThrowIfNotJSReceiver(
            TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, MessageTemplate::kRegExpNonObject, "RegExp.prototype.flags");
        compiler::CodeAssemblerLabel label1(&ca_);
...
TNode<Object> RegExpCreate_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_maybeString, TNode<String> p_flags)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<Object> RegExpCreate_1(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Map> p_initialMap, TNode<Object> p_maybeString, TNode<String> p_flags)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<JSRegExp> Cast_FastJSRegExp_1(
