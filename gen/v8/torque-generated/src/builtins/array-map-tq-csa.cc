...
TF_BUILTIN(ArrayMapLoopContinuation, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp5 = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { parameter2 }, TNode<Object> { parameter3 }, TNode<Object> { tmp4 },
            TNode<Object> { phi_bb5_8 }, TNode<Object> { parameter5 });
...
TNode<JSArray> FastArrayMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_fastO, TNode<Smi> p_len,
    TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout,
    compiler::TypedCodeAssemblerVariable<JSArray>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_1)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Int32T> block73(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Int32T> block70(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Int32T, BoolT> block76(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Int32T, BoolT> block77(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Int32T, BoolT, BoolT> block78(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Int32T> block74(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Int32T> block75(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Smi, Smi, Smi> block90(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Smi, Smi, Smi> block91(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Smi, Smi, Smi> block102(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, Smi, Smi, Smi> block103(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Smi, Smi, Smi, JSArray> block81(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Smi, JSArray, BoolT, BoolT, BoolT, Int32T, BoolT, BoolT> block120(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block7.is_used()) {
        ...
        ca_.Branch(tmp9, &block5, std::vector<compiler::Node*> { phi_bb7_5, phi_bb7_7, phi_bb7_11, phi_bb7_12, phi_bb7_13 }, &block6,
            std::vector<compiler::Node*> { phi_bb7_5, phi_bb7_7, phi_bb7_11, phi_bb7_12, phi_bb7_13 });
    }
    ...
    if (block5.is_used()) {
        ...
        ca_.Branch(tmp12, &block12, std::vector<compiler::Node*> { phi_bb5_5, phi_bb5_7, phi_bb5_11, phi_bb5_12, phi_bb5_13 }, &block13,
            std::vector<compiler::Node*> { phi_bb5_5, phi_bb5_7, phi_bb5_11, phi_bb5_12, phi_bb5_13 });
    }
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(tmp13, &block14, std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_7, phi_bb13_11, phi_bb13_12, phi_bb13_13 }, &block15,
            std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_7, phi_bb13_11, phi_bb13_12, phi_bb13_13 });
    }
    ...
    if (block15.is_used()) {
        ...
        ca_.Branch(tmp17, &block16, std::vector<compiler::Node*> { phi_bb15_5, phi_bb15_11, phi_bb15_12, phi_bb15_13 }, &block17,
            std::vector<compiler::Node*> { phi_bb15_5, phi_bb15_11, phi_bb15_12, phi_bb15_13 });
    }
    ...
    if (block17.is_used()) {
        ...
        ca_.Branch(tmp4, &block22, std::vector<compiler::Node*> { phi_bb17_5, phi_bb17_11, phi_bb17_12, phi_bb17_13, phi_bb17_5, phi_bb17_5 }, &block23,
            std::vector<compiler::Node*> { phi_bb17_5, phi_bb17_11, phi_bb17_12, phi_bb17_13, phi_bb17_5, phi_bb17_5 });
    }
    ...
    if (block21.is_used()) {
        ...
        tmp22 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { p_thisArg },
            TNode<Object> { phi_bb21_18 }, TNode<Object> { phi_bb21_5 }, TNode<Object> { tmp14 });
    ...
    if (block33.is_used()) {
        ...
        ca_.Branch(tmp33, &block39,
            std::vector<compiler::Node*> { phi_bb33_5, phi_bb33_11, phi_bb33_12, phi_bb33_13, phi_bb33_16, phi_bb33_20, phi_bb33_20, phi_bb33_20 }, &block40,
            std::vector<compiler::Node*> { phi_bb33_5, phi_bb33_11, phi_bb33_12, phi_bb33_13, phi_bb33_16, phi_bb33_20, phi_bb33_20, phi_bb33_20 });
    }
    ...
    if (block46.is_used()) {
        ...
        ca_.Branch(tmp46, &block59, std::vector<compiler::Node*> { phi_bb46_5, phi_bb46_13, phi_bb46_16, phi_bb46_20, phi_bb46_20, phi_bb46_20 }, &block60,
            std::vector<compiler::Node*> { phi_bb46_5, phi_bb46_13, phi_bb46_16, phi_bb46_20, phi_bb46_20, phi_bb46_20 });
    }
    ...
    if (block45.is_used()) {
        ...
        ca_.Branch(tmp54, &block51, std::vector<compiler::Node*> { phi_bb45_5, phi_bb45_12, phi_bb45_13, phi_bb45_16, phi_bb45_20, phi_bb45_20, phi_bb45_20 },
            &block52, std::vector<compiler::Node*> { phi_bb45_5, phi_bb45_12, phi_bb45_13, phi_bb45_16, phi_bb45_20, phi_bb45_20, phi_bb45_20 });
    }
    ...
    if (block6.is_used()) {
        ...
        ca_.Branch(tmp69, &block111, std::vector<compiler::Node*> { phi_bb6_5, phi_bb6_7, phi_bb6_11, phi_bb6_12, phi_bb6_13 }, &block112,
            std::vector<compiler::Node*> { phi_bb6_5, phi_bb6_7, phi_bb6_11, phi_bb6_12, phi_bb6_13, tmp68 });
    }
    ...
    if (block4.is_used()) {
        ...
        ca_.Branch(tmp73, &block69,
            std::vector<compiler::Node*> { phi_bb4_5, phi_bb4_7, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_14, phi_bb4_14 }, &block70,
            std::vector<compiler::Node*> { phi_bb4_5, phi_bb4_7, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_14, phi_bb4_14, tmp72 });
    }
    ...
    if (block69.is_used()) {
        ...
        ca_.Branch(phi_bb69_12, &block71,
            std::vector<compiler::Node*> { phi_bb69_5, phi_bb69_7, phi_bb69_11, phi_bb69_12, phi_bb69_13, phi_bb69_14, phi_bb69_15, phi_bb69_18 }, &block72,
            std::vector<compiler::Node*> { phi_bb69_5, phi_bb69_7, phi_bb69_11, phi_bb69_12, phi_bb69_13, phi_bb69_14, phi_bb69_15, phi_bb69_18 });
    }
    ...
    if (block70.is_used()) {
        ...
        ca_.Branch(phi_bb70_13, &block76,
            std::vector<compiler::Node*> {
                phi_bb70_5, phi_bb70_7, phi_bb70_11, phi_bb70_12, phi_bb70_13, phi_bb70_14, phi_bb70_15, phi_bb70_18, phi_bb70_20, phi_bb70_13 },
            &block77,
            std::vector<compiler::Node*> {
                phi_bb70_5, phi_bb70_7, phi_bb70_11, phi_bb70_12, phi_bb70_13, phi_bb70_14, phi_bb70_15, phi_bb70_18, phi_bb70_20, phi_bb70_13 });
    }
    ...
    if (block76.is_used()) {
        ca_.Bind(
            &block76, &phi_bb76_5, &phi_bb76_7, &phi_bb76_11, &phi_bb76_12, &phi_bb76_13, &phi_bb76_14, &phi_bb76_15, &phi_bb76_18, &phi_bb76_20, &phi_bb76_21);
        tmp76 = FromConstexpr_bool_constexpr_bool_0(state_, true);
        ca_.Goto(
            &block78, phi_bb76_5, phi_bb76_7, phi_bb76_11, phi_bb76_12, phi_bb76_13, phi_bb76_14, phi_bb76_15, phi_bb76_18, phi_bb76_20, phi_bb76_21, tmp76);
    }
    ...
    if (block77.is_used()) {
        ca_.Bind(
            &block77, &phi_bb77_5, &phi_bb77_7, &phi_bb77_11, &phi_bb77_12, &phi_bb77_13, &phi_bb77_14, &phi_bb77_15, &phi_bb77_18, &phi_bb77_20, &phi_bb77_21);
        tmp77 = CodeStubAssembler(state_).SmiLessThan(TNode<Smi> { phi_bb77_18 }, TNode<Smi> { tmp71 });
        ca_.Goto(
            &block78, phi_bb77_5, phi_bb77_7, phi_bb77_11, phi_bb77_12, phi_bb77_13, phi_bb77_14, phi_bb77_15, phi_bb77_18, phi_bb77_20, phi_bb77_21, tmp77);
    }
    ...
    if (block78.is_used()) {
        ca_.Bind(&block78, &phi_bb78_5, &phi_bb78_7, &phi_bb78_11, &phi_bb78_12, &phi_bb78_13, &phi_bb78_14, &phi_bb78_15, &phi_bb78_18, &phi_bb78_20,
            &phi_bb78_21, &phi_bb78_22);
        ca_.Branch(phi_bb78_22, &block74,
            std::vector<compiler::Node*> { phi_bb78_5, phi_bb78_7, phi_bb78_11, phi_bb78_12, phi_bb78_13, phi_bb78_14, phi_bb78_15, phi_bb78_18, phi_bb78_20 },
            &block75,
            std::vector<compiler::Node*> { phi_bb78_5, phi_bb78_7, phi_bb78_11, phi_bb78_12, phi_bb78_13, phi_bb78_14, phi_bb78_15, phi_bb78_18, phi_bb78_20 });
    }
    ...
    if (block75.is_used()) {
        ...
        ca_.Branch(tmp81, &block79,
            std::vector<compiler::Node*> { phi_bb75_5, phi_bb75_7, phi_bb75_11, phi_bb75_12, phi_bb75_13, phi_bb75_14, phi_bb75_15, phi_bb75_18 }, &block80,
            std::vector<compiler::Node*> { phi_bb75_5, phi_bb75_7, phi_bb75_11, phi_bb75_12, phi_bb75_13, phi_bb75_14, phi_bb75_15, phi_bb75_18 });
    }
    ...
    if (block84.is_used()) {
        ...
        ca_.Branch(tmp86, &block82,
            std::vector<compiler::Node*> { phi_bb84_5, phi_bb84_7, phi_bb84_11, phi_bb84_12, phi_bb84_13, phi_bb84_14, phi_bb84_15, phi_bb84_18, phi_bb84_24 },
            &block83,
            std::vector<compiler::Node*> { phi_bb84_5, phi_bb84_7, phi_bb84_11, phi_bb84_12, phi_bb84_13, phi_bb84_14, phi_bb84_15, phi_bb84_18, phi_bb84_24 });
    }
    ...
    if (block91.is_used()) {
        ca_.Bind(&block91, &phi_bb91_5, &phi_bb91_7, &phi_bb91_11, &phi_bb91_12, &phi_bb91_13, &phi_bb91_14, &phi_bb91_15, &phi_bb91_18, &phi_bb91_24,
            &phi_bb91_29, &phi_bb91_30);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block96.is_used()) {
        ...
        std::tie(tmp102, tmp103, tmp104) = FieldSliceFixedDoubleArrayValues_0(state_, TNode<FixedDoubleArray> { tmp83 }).Flatten();
        ...
        ca_.Branch(tmp108, &block102,
            std::vector<compiler::Node*> {
                phi_bb96_5, phi_bb96_7, phi_bb96_11, phi_bb96_12, phi_bb96_13, phi_bb96_14, phi_bb96_15, phi_bb96_18, phi_bb96_24, phi_bb96_24, phi_bb96_24 },
            &block103,
            std::vector<compiler::Node*> {
                phi_bb96_5, phi_bb96_7, phi_bb96_11, phi_bb96_12, phi_bb96_13, phi_bb96_14, phi_bb96_15, phi_bb96_18, phi_bb96_24, phi_bb96_24, phi_bb96_24 });
    }
    ...
    if (block102.is_used()) {
        ca_.Bind(&block102, &phi_bb102_5, &phi_bb102_7, &phi_bb102_11, &phi_bb102_12, &phi_bb102_13, &phi_bb102_14, &phi_bb102_15, &phi_bb102_18, &phi_bb102_24,
            &phi_bb102_31, &phi_bb102_32);
        ...
        StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp111 }, TNode<IntPtrT> { tmp112 }, TorqueStructUnsafe_0 {} },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp113 }, TNode<Float64T> { tmp114 } });
    ...
    if (block103.is_used()) {
        ca_.Bind(&block103, &phi_bb103_5, &phi_bb103_7, &phi_bb103_11, &phi_bb103_12, &phi_bb103_13, &phi_bb103_14, &phi_bb103_15, &phi_bb103_18, &phi_bb103_24,
            &phi_bb103_31, &phi_bb103_32);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block111.is_used()) {
        ...
        ca_.Branch(phi_bb111_12, &block113, std::vector<compiler::Node*> { phi_bb111_5, phi_bb111_7, phi_bb111_11, phi_bb111_12, phi_bb111_13 }, &block114,
            std::vector<compiler::Node*> { phi_bb111_5, phi_bb111_7, phi_bb111_11, phi_bb111_12, phi_bb111_13 });
    }
    ...
    if (block112.is_used()) {
        ...
        ca_.Branch(phi_bb112_13, &block118,
            std::vector<compiler::Node*> { phi_bb112_5, phi_bb112_7, phi_bb112_11, phi_bb112_12, phi_bb112_13, phi_bb112_19, phi_bb112_13 }, &block119,
            std::vector<compiler::Node*> { phi_bb112_5, phi_bb112_7, phi_bb112_11, phi_bb112_12, phi_bb112_13, phi_bb112_19, phi_bb112_13 });
    }
    ...
    if (block120.is_used()) {
        ...
        ca_.Branch(phi_bb120_21, &block116, std::vector<compiler::Node*> { phi_bb120_5, phi_bb120_7, phi_bb120_11, phi_bb120_12, phi_bb120_13, phi_bb120_19 },
            &block117, std::vector<compiler::Node*> { phi_bb120_5, phi_bb120_7, phi_bb120_11, phi_bb120_12, phi_bb120_13, phi_bb120_19 });
    }
    ...
    if (block117.is_used()) {
        ...
        ca_.Branch(tmp127, &block121, std::vector<compiler::Node*> { phi_bb117_5, phi_bb117_7, phi_bb117_11, phi_bb117_12, phi_bb117_13 }, &block122,
            std::vector<compiler::Node*> { phi_bb117_5, phi_bb117_7, phi_bb117_11, phi_bb117_12, phi_bb117_13 });
    }
    ...
    if (block126.is_used()) {
        ...
        ca_.Branch(tmp132, &block124, std::vector<compiler::Node*> { phi_bb126_5, phi_bb126_7, phi_bb126_11, phi_bb126_12, phi_bb126_13, phi_bb126_23 },
            &block125, std::vector<compiler::Node*> { phi_bb126_5, phi_bb126_7, phi_bb126_11, phi_bb126_12, phi_bb126_13, phi_bb126_23 });
    }
    ...
    if (block124.is_used()) {
        ...
        ca_.Branch(tmp139, &block132,
            std::vector<compiler::Node*> { phi_bb124_5, phi_bb124_7, phi_bb124_11, phi_bb124_12, phi_bb124_13, phi_bb124_23, phi_bb124_23, phi_bb124_23 },
            &block133,
            std::vector<compiler::Node*> { phi_bb124_5, phi_bb124_7, phi_bb124_11, phi_bb124_12, phi_bb124_13, phi_bb124_23, phi_bb124_23, phi_bb124_23 });
    }
    ...
    if (block138.is_used()) {
        ...
        std::tie(tmp148, tmp149, tmp150) = FieldSliceFixedDoubleArrayValues_0(state_, TNode<FixedDoubleArray> { tmp129 }).Flatten();
        ...
        ca_.Branch(tmp154, &block144,
            std::vector<compiler::Node*> { phi_bb138_5, phi_bb138_7, phi_bb138_11, phi_bb138_12, phi_bb138_13, phi_bb138_23, phi_bb138_23, phi_bb138_23 },
            &block145,
            std::vector<compiler::Node*> { phi_bb138_5, phi_bb138_7, phi_bb138_11, phi_bb138_12, phi_bb138_13, phi_bb138_23, phi_bb138_23, phi_bb138_23 });
    }
    ...
    if (block144.is_used()) {
        ...
        StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp157 }, TNode<IntPtrT> { tmp158 }, TorqueStructUnsafe_0 {} },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp159 }, TNode<Float64T> { tmp160 } });
...
TF_BUILTIN(ArrayMap, CodeStubAssembler)
{
    ...
    if (block4.is_used()) {
        ...
        tmp6 = CodeStubAssembler(state_).GetArgumentValue(
    ...
    if (block5.is_used()) {
        ...
        tmp10 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp9 });
    ...
    if (block15.is_used()) {
        ...
        tmp17 = FastArrayMap_0(state_, TNode<Context> { parameter0 }, TNode<JSArray> { tmp13 }, TNode<Smi> { tmp15 }, TNode<JSReceiver> { tmp7 },
            TNode<Object> { tmp10 }, &label18, &tmp19, &tmp20);
        ca_.Goto(&block17);
        if (label18.is_used()) {
            ca_.Bind(&label18);
            ca_.Goto(&block18);
    ...
    if (block2.is_used()) {
        ...
        tmp24 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp23 });
...
TNode<JSArray> Cast_FastJSArrayForRead_1(
