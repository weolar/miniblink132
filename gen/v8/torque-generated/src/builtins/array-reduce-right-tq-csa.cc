...
TF_BUILTIN(ArrayReduceRightLoopContinuation, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ...
        tmp9 = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { parameter2 }, TNode<Object> { tmp8 },
            TNode<Object> { ca_.UncheckedCast<Object>(phi_bb10_11) }, TNode<Object> { tmp5 }, TNode<Object> { phi_bb10_8 }, TNode<Object> { parameter4 });
...
TNode<Object> FastArrayReduceRight_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len,
    TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialAccumulator, compiler::CodeAssemblerLabel* label_Bailout,
    compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1)
{
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(tmp15, &block11, std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_9, phi_bb13_12 }, &block12,
            std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_9, phi_bb13_12 });
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp18, &block18, std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_9, phi_bb11_12 }, &block19,
            std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_9, phi_bb11_12 });
    }
    ...
    if (block19.is_used()) {
        ...
        ca_.Branch(tmp19, &block20, std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_9, phi_bb19_12 }, &block21,
            std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_9, phi_bb19_12 });
    }
    ...
    if (block21.is_used()) {
        ...
        ca_.Branch(
            tmp23, &block22, std::vector<compiler::Node*> { phi_bb21_5, phi_bb21_12 }, &block23, std::vector<compiler::Node*> { phi_bb21_5, phi_bb21_12 });
    }
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp11, &block28, std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_12, phi_bb23_12, phi_bb23_12 }, &block29,
            std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_12, phi_bb23_12, phi_bb23_12 });
    }
    ...
    if (block38.is_used()) {
        ...
        tmp31 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { tmp30 },
            TNode<Object> { ca_.UncheckedCast<Object>(phi_bb38_14) }, TNode<Object> { phi_bb27_17 }, TNode<Object> { phi_bb38_12 }, TNode<Object> { tmp20 });
...
TF_BUILTIN(ArrayReduceRight, CodeStubAssembler)
{
    ...
    if (block9.is_used()) {
        ...
        tmp14 = FastArrayReduceRight_0(state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 },
            TNode<Object> { phi_bb9_9 }, &label15, &tmp16, &tmp17);
        ca_.Goto(&block13);
        if (label15.is_used()) {
            ca_.Bind(&label15);
            ca_.Goto(&block14);
    ...
    if (block2.is_used()) {
        ...
        tmp20 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp19 });
