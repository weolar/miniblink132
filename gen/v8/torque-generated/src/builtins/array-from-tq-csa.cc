...
TF_BUILTIN(ArrayFrom, CodeStubAssembler)
{
    ...
    if (block6.is_used()) {
        ...
        tmp14 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp13 });
    ...
    if (block26.is_used()) {
        ...
        std::tie(tmp37, tmp38)
            = IteratorBuiltinsAssembler(state_).GetIterator(TNode<Context> { parameter0 }, TNode<Object> { tmp12 }, TNode<Object> { tmp24 }).Flatten();
    ...
    if (block32.is_used()) {
        ...
        ca_.Branch(
            tmp41, &block30, std::vector<compiler::Node*> { phi_bb32_10, phi_bb32_16 }, &block31, std::vector<compiler::Node*> { phi_bb32_10, phi_bb32_16 });
    }
    ...
    if (block30.is_used()) {
        ...
        tmp42 = IteratorBuiltinsAssembler(state_).IteratorStep(
            TNode<Context> { parameter0 }, TorqueStructIteratorRecord { TNode<JSReceiver> { tmp37 }, TNode<Object> { tmp38 } }, TNode<Map> { tmp39 }, &label43);
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(phi_bb39_10, &block41, std::vector<compiler::Node*> { phi_bb39_10, phi_bb39_16 }, &block42,
            std::vector<compiler::Node*> { phi_bb39_10, phi_bb39_16 });
    }
    ...
    if (block41.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch49__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp48 = CodeStubAssembler(state_).Call(
                TNode<Context> { parameter0 }, TNode<Object> { tmp45 }, TNode<Object> { tmp16 }, TNode<Object> { tmp44 }, TNode<Object> { phi_bb41_16 });
        }
    ...
    if (block56.is_used()) {
        ...
        tmp64 = CodeStubAssembler(state_).AllocateJSArray(
            ElementsKind::PACKED_SMI_ELEMENTS, TNode<Map> { tmp63 }, TNode<IntPtrT> { tmp62 }, TNode<Smi> { tmp61 });
    ...
    if (block63.is_used()) {
        ...
        ca_.Branch(tmp70, &block61, std::vector<compiler::Node*> { phi_bb63_10, phi_bb63_13, phi_bb63_14 }, &block62,
            std::vector<compiler::Node*> { phi_bb63_10, phi_bb63_13, phi_bb63_14 });
    }
    ...
    if (block61.is_used()) {
        ...
        ca_.Branch(phi_bb61_10, &block64, std::vector<compiler::Node*> { phi_bb61_10, phi_bb61_13, phi_bb61_14 }, &block65,
            std::vector<compiler::Node*> { phi_bb61_10, phi_bb61_13, phi_bb61_14 });
    }
    ...
    if (block64.is_used()) {
        ...
        tmp73 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { tmp72 }, TNode<Object> { tmp16 }, TNode<Object> { tmp71 }, TNode<Object> { phi_bb64_14 });
