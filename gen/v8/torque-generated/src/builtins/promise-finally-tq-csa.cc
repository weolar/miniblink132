...
TNode<IntPtrT> FromConstexpr_PromiseValueThunkOrReasonContextSlot_constexpr_kValueSlot_0(
    compiler::CodeAssemblerState* state_, PromiseBuiltins::PromiseValueThunkOrReasonContextSlot p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-finally.tq?l=11&c=1
TNode<IntPtrT> FromConstexpr_PromiseValueThunkOrReasonContextSlot_constexpr_kPromiseValueThunkOrReasonContextLength_0(
    compiler::CodeAssemblerState* state_, PromiseBuiltins::PromiseValueThunkOrReasonContextSlot p_o)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<IntPtrT> FromConstexpr_PromiseFinallyContextSlot_constexpr_kOnFinallySlot_0(
    compiler::CodeAssemblerState* state_, PromiseBuiltins::PromiseFinallyContextSlot p_o)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-finally.tq?l=18&c=1
TNode<IntPtrT> FromConstexpr_PromiseFinallyContextSlot_constexpr_kConstructorSlot_0(
    compiler::CodeAssemblerState* state_, PromiseBuiltins::PromiseFinallyContextSlot p_o)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-finally.tq?l=18&c=1
TNode<IntPtrT> FromConstexpr_PromiseFinallyContextSlot_constexpr_kPromiseFinallyContextLength_0(
    compiler::CodeAssemblerState* state_, PromiseBuiltins::PromiseFinallyContextSlot p_o)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TF_BUILTIN(PromiseValueThunkFinally, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp2, tmp3)
            = ContextSlot_PromiseValueThunkOrReasonContext_PromiseValueThunkOrReasonContext_JSAny_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp1 })
                  .Flatten();
...
TNode<JSFunction> CreateThrowerFunction_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_reason)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        InitContextSlot_PromiseValueThunkOrReasonContext_PromiseValueThunkOrReasonContext_JSAny_JSAny_0(
            state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp3 }, TNode<Object> { p_reason });
        tmp4 = CodeStubAssembler(state_).AllocateRootFunctionWithContext(
            RootIndex::kPromiseThrowerFinallySharedFun, TNode<Context> { tmp2 }, TNode<NativeContext> { p_nativeContext });
        ca_.Goto(&block2);
    }
...
TF_BUILTIN(PromiseCatchFinally, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp2, tmp3)
            = ContextSlot_PromiseFinallyContext_PromiseFinallyContext_Callable_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp1 }).Flatten();
        ...
        std::tie(tmp8, tmp9)
            = ContextSlot_PromiseFinallyContext_PromiseFinallyContext_Constructor_0(state_, TNode<Context> { tmp0 }, TNode<IntPtrT> { tmp7 }).Flatten();
...
TNode<JSFunction> CreateValueThunkFunction_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_value)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp3 = kValueSlot_0(state_);
        InitContextSlot_PromiseValueThunkOrReasonContext_PromiseValueThunkOrReasonContext_JSAny_JSAny_0(
            state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp3 }, TNode<Object> { p_value });
        tmp4 = CodeStubAssembler(state_).AllocateRootFunctionWithContext(
            RootIndex::kPromiseValueThunkFinallySharedFun, TNode<Context> { tmp2 }, TNode<NativeContext> { p_nativeContext });
        ca_.Goto(&block2);
    }
...
TorqueStructPromiseFinallyFunctions_0 CreatePromiseFinallyFunctions_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context,
    TNode<NativeContext> p_nativeContext, TNode<JSReceiver> p_onFinally, TNode<JSReceiver> p_constructor)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        InitContextSlot_PromiseFinallyContext_PromiseFinallyContext_Callable_Callable_0(
            state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp3 }, TNode<JSReceiver> { p_onFinally });
        tmp4 = kConstructorSlot_0(state_);
        InitContextSlot_PromiseFinallyContext_PromiseFinallyContext_Constructor_Constructor_0(
            state_, TNode<Context> { tmp2 }, TNode<IntPtrT> { tmp4 }, TNode<JSReceiver> { p_constructor });
        tmp5 = CodeStubAssembler(state_).AllocateRootFunctionWithContext(
            RootIndex::kPromiseThenFinallySharedFun, TNode<Context> { tmp2 }, TNode<NativeContext> { p_nativeContext });
        tmp6 = CodeStubAssembler(state_).AllocateRootFunctionWithContext(
            RootIndex::kPromiseCatchFinallySharedFun, TNode<Context> { tmp2 }, TNode<NativeContext> { p_nativeContext });
        ca_.Goto(&block2);
    }
...
TF_BUILTIN(PromisePrototypeFinally, CodeStubAssembler)
{
    ...
    if (block18.is_used()) {
        ca_.Bind(&block18);
        std::tie(tmp20, tmp21) = CreatePromiseFinallyFunctions_0(
            state_, TNode<Context> { parameter0 }, TNode<NativeContext> { tmp3 }, TNode<JSReceiver> { tmp18 }, TNode<JSReceiver> { phi_bb8_6 })
                                     .Flatten();
    ...
    if (block16.is_used()) {
        ...
        tmp22 = InvokeThen_1(state_, TNode<Context> { parameter0 }, TNode<NativeContext> { tmp3 }, TNode<Object> { parameter1 }, TNode<Object> { phi_bb16_8 },
            TNode<Object> { phi_bb16_9 });
...
TorqueStructReference_JSAny_0 ContextSlot_PromiseValueThunkOrReasonContext_PromiseValueThunkOrReasonContext_JSAny_0(
...
void InitContextSlot_PromiseValueThunkOrReasonContext_PromiseValueThunkOrReasonContext_JSAny_JSAny_0(
...
TorqueStructReference_Callable_0 ContextSlot_PromiseFinallyContext_PromiseFinallyContext_Callable_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TorqueStructReference_Constructor_0 ContextSlot_PromiseFinallyContext_PromiseFinallyContext_Constructor_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
void InitContextSlot_PromiseFinallyContext_PromiseFinallyContext_Callable_Callable_0(
...
void InitContextSlot_PromiseFinallyContext_PromiseFinallyContext_Constructor_Constructor_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index, TNode<JSReceiver> p_value)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
