...
TF_BUILTIN(StringPrototypeToString, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = CodeStubAssembler(state_).ToThisValue(
            TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, PrimitiveType::kString, "String.prototype.toString");
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StringPrototypeValueOf, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = CodeStubAssembler(state_).ToThisValue(
            TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, PrimitiveType::kString, "String.prototype.valueOf");
        CodeStubAssembler(state_).Return(tmp0);
    }
}
...
TF_BUILTIN(StringToList, CodeStubAssembler)
{
    ...
    if (block1.is_used()) {
        ...
        tmp11 = StringBuiltinsAssembler(state_).LoadSurrogatePairAt(
            TNode<String> { parameter1 }, TNode<IntPtrT> { tmp0 }, TNode<IntPtrT> { phi_bb1_8 }, UnicodeEncoding::UTF16);
...
TF_BUILTIN(StringPrototypeCharAt, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label4(&ca_);
        GenerateStringAt_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, "String.prototype.charAt",
            &label0, &tmp1, &tmp2, &tmp3, &label4);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block5);
        }
...
TF_BUILTIN(StringPrototypeCharCodeAt, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        compiler::CodeAssemblerLabel label4(&ca_);
        GenerateStringAt_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, "String.prototype.charCodeAt",
            &label0, &tmp1, &tmp2, &tmp3, &label4);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block5);
...
TF_BUILTIN(StringPrototypeCodePointAt, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        compiler::CodeAssemblerLabel label0(&ca_);
        compiler::CodeAssemblerLabel label4(&ca_);
        GenerateStringAt_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, "String.prototype.codePointAt",
            &label0, &tmp1, &tmp2, &tmp3, &label4);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block5);
    ...
    if (block5.is_used()) {
        ...
        tmp7 = StringBuiltinsAssembler(state_).LoadSurrogatePairAt(
            TNode<String> { tmp1.value() }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp6 }, UnicodeEncoding::UTF32);
