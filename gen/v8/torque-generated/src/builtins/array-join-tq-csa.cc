...
TF_BUILTIN(LoadJoinElement_FastDoubleElements_0, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        std::tie(tmp15, tmp16) = LoadFloat64OrHole_0(
            state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp13 }, TNode<IntPtrT> { tmp14 }, TorqueStructUnsafe_0 {} })
                                     .Flatten();
...
TF_BUILTIN(ConvertToLocaleString, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ca_.Bind(&block5);
        tmp6 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { tmp4 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, TNode<Object> { parameter3 });
...
TNode<BoolT> CannotUseSameArrayAccessor_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BuiltinPtr> p_loadFn,
    TNode<JSReceiver> p_receiver, TNode<Map> p_originalMap, TNode<Number> p_originalLen)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = CodeStubAssembler(state_).SmiEqual(
            TNode<Smi> { p_loadFn }, TNode<Smi> { ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadJoinElement_GenericElementsAccessor_0)) });
...
TNode<BoolT> CannotUseSameArrayAccessor_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BuiltinPtr> p__loadFn,
    TNode<JSReceiver> p_receiver, TNode<Map> p__initialMap, TNode<Number> p__initialLen)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TorqueStructBuffer_0 NewBuffer_0(compiler::CodeAssemblerState* state_, TNode<UintPtrT> p_len, TNode<String> p_sep)
{
    ...
    ca_.Bind(&block10);
    return TorqueStructBuffer_0 { TNode<FixedArray> { tmp4 }, TNode<IntPtrT> { tmp8 }, TNode<IntPtrT> { tmp9 }, TNode<BoolT> { tmp6 },
        TNode<PrimitiveHeapObject> { tmp7 } };
}
...
TNode<String> BufferJoin_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructBuffer_0 p_buffer, TNode<String> p_sep)
{
    ...
    if (block33.is_used()) {
        ...
        tmp27 = ArrayBuiltinsAssembler(state_).CallJSArrayArrayJoinConcatToSequentialString(
            TNode<FixedArray> { p_buffer.fixedArray }, TNode<IntPtrT> { p_buffer.index }, TNode<String> { p_sep }, TNode<String> { phi_bb33_8 });
...
TNode<Object> ArrayJoin_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver,
    TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block2.is_used()) {
        ...
        tmp29 = ArrayJoinImpl_JSArray_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_receiver }, TNode<String> { p_sep },
            TNode<Number> { p_lenNumber }, p_useToLocaleString, TNode<Object> { p_locales }, TNode<Object> { p_options }, TNode<BuiltinPtr> { phi_bb2_8 });
...
TNode<Object> ArrayJoin_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_receiver,
    TNode<String> p_sep, TNode<Number> p_lenNumber, TNode<Object> p_locales, TNode<Object> p_options)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block4.is_used()) {
        ...
        tmp52 = ArrayJoinImpl_JSTypedArray_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_receiver }, TNode<String> { p_sep },
            TNode<Number> { p_lenNumber }, p_useToLocaleString, TNode<Object> { p_locales }, TNode<Object> { p_options }, TNode<BuiltinPtr> { phi_bb4_8 });
        ca_.Goto(&block77);
    }
...
TF_BUILTIN(JoinStackPush, CodeStubAssembler)
{
    ...
    if (block1.is_used()) {
        ...
        ca_.Branch(tmp8, &block9, std::vector<compiler::Node*> { phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4 }, &block10,
            std::vector<compiler::Node*> { phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4 });
    }
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(tmp21, &block19, std::vector<compiler::Node*> { phi_bb13_4, phi_bb13_4, phi_bb13_4, phi_bb13_4, phi_bb13_4 }, &block20,
            std::vector<compiler::Node*> { phi_bb13_4, phi_bb13_4, phi_bb13_4, phi_bb13_4, phi_bb13_4 });
    }
...
TF_BUILTIN(JoinStackPop, CodeStubAssembler)
{
    ...
    if (block1.is_used()) {
        ...
        tmp7 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT> { tmp5 });
        tmp8 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp6 }, TNode<UintPtrT> { tmp7 });
        ca_.Branch(tmp8, &block11, std::vector<compiler::Node*> { phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4 }, &block12,
            std::vector<compiler::Node*> { phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4, phi_bb1_4 });
    }
    ...
    if (block16.is_used()) {
        ...
        ca_.Branch(tmp27, &block25, std::vector<compiler::Node*> { phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4 }, &block26,
            std::vector<compiler::Node*> { phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4, phi_bb16_4 });
    }
...
TF_BUILTIN(ArrayPrototypeJoin, CodeStubAssembler)
{
    ...
    if (block2.is_used()) {
        ...
        tmp8 = CycleProtectedArrayJoin_JSArray_0(state_, TNode<Context> { parameter0 }, false, TNode<JSReceiver> { tmp2 }, TNode<Number> { tmp3 },
            TNode<Object> { tmp1 }, TNode<Object> { tmp6 }, TNode<Object> { tmp7 });
...
TF_BUILTIN(ArrayPrototypeToLocaleString, CodeStubAssembler)
{
    ...
    if (block2.is_used()) {
        ...
        tmp9 = CycleProtectedArrayJoin_JSArray_0(state_, TNode<Context> { parameter0 }, true, TNode<JSReceiver> { tmp4 }, TNode<Number> { tmp5 },
            TNode<Object> { tmp8 }, TNode<Object> { tmp1 }, TNode<Object> { tmp3 });
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp0 });
        tmp2 = TypedArrayBuiltinsAssembler(state_).ValidateTypedArrayAndGetLength(
            TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, "%TypedArray%.prototype.join");
        ...
        tmp6 = Undefined_0(state_);
        tmp7 = CycleProtectedArrayJoin_JSTypedArray_0(state_, TNode<Context> { parameter0 }, false, TNode<JSReceiver> { tmp3 }, TNode<Number> { tmp4 },
            TNode<Object> { tmp1 }, TNode<Object> { tmp5 }, TNode<Object> { tmp6 });
    ...
    if (block0.is_used()) {
        ...
        tmp3 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp2 });
        tmp4 = TypedArrayBuiltinsAssembler(state_).ValidateTypedArrayAndGetLength(
            TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, "%TypedArray%.prototype.toLocaleString");
        ...
        tmp8 = CycleProtectedArrayJoin_JSTypedArray_0(state_, TNode<Context> { parameter0 }, true, TNode<JSReceiver> { tmp5 }, TNode<Number> { tmp6 },
            TNode<Object> { tmp7 }, TNode<Object> { tmp1 }, TNode<Object> { tmp3 });
        arguments.PopAndReturn(tmp8);
    }
}
...
TNode<String> ArrayJoinImpl_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_sep,
    TNode<Number> p_lengthNumber, bool p_useToLocaleString, TNode<Object> p_locales, TNode<Object> p_options, TNode<BuiltinPtr> p_initialLoadFn)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT> block4(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT> block2(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT> block5(
        &ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT> block6(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT> block7(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT> block8(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block9(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block12(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block13(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block10(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block17(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block16(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block18(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block19(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block23(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block22(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block24(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block25(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block26(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject> block27(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String> block20(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String> block14(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String> block11(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block32(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block33(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String, BoolT> block34(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block30(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block31(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block35(
        &ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block36(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block37(
        &ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block38(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block29(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block39(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String, FixedArray> block51(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String, FixedArray> block52(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block59(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block58(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block61(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block60(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block56(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block65(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block64(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String, FixedArray> block78(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String, FixedArray> block79(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block55(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block40(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, String, String, String> block41(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT> block3(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT>
        block85(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT>
        block86(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT, BoolT>
        block87(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT>
        block83(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT>
        block84(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT,
        IntPtrT>
        block88(&ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT,
        IntPtrT>
        block89(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT, IntPtrT>
        block90(&ca_, compiler::CodeAssemblerLabel::kDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT, IntPtrT>
        block91(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<IntPtrT, BuiltinPtr, FixedArray, IntPtrT, IntPtrT, BoolT, PrimitiveHeapObject, UintPtrT, IntPtrT, IntPtrT>
        block82(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block4.is_used()) {
        ...
        ca_.Branch(tmp11, &block2,
            std::vector<compiler::Node*> { phi_bb4_10, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_15, phi_bb4_16, phi_bb4_17 }, &block3,
            std::vector<compiler::Node*> { phi_bb4_10, phi_bb4_11, phi_bb4_12, phi_bb4_13, phi_bb4_14, phi_bb4_15, phi_bb4_16, phi_bb4_17 });
    }
    ...
    if (block2.is_used()) {
        ...
        tmp12 = CannotUseSameArrayAccessor_JSArray_0(state_, TNode<Context> { p_context }, TNode<BuiltinPtr> { phi_bb2_11 }, TNode<JSReceiver> { p_receiver },
            TNode<Map> { tmp1 }, TNode<Number> { p_lengthNumber });
        ca_.Branch(tmp12, &block5,
            std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16, phi_bb2_17 }, &block6,
            std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16, phi_bb2_17 });
    }
    ...
    if (block5.is_used()) {
        ...
        ca_.Goto(&block6, phi_bb5_10, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadJoinElement_GenericElementsAccessor_0)), phi_bb5_12,
            phi_bb5_13, phi_bb5_14, phi_bb5_15, phi_bb5_16, phi_bb5_17);
    }
    ...
    if (block6.is_used()) {
        ...
        ca_.Branch(tmp14, &block7, std::vector<compiler::Node*> { phi_bb6_10, phi_bb6_12, phi_bb6_13, phi_bb6_14, phi_bb6_15, phi_bb6_16, phi_bb6_17 }, &block8,
            std::vector<compiler::Node*> { phi_bb6_10, phi_bb6_12, phi_bb6_13, phi_bb6_14, phi_bb6_15, phi_bb6_16, phi_bb6_17 });
    }
    ...
    if (block8.is_used()) {
        ...
        tmp19 = CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(0)), phi_bb6_11, p_context, p_receiver, phi_bb8_17);
    ...
    if (block9.is_used()) {
        ...
        ca_.Branch(tmp22, &block12, std::vector<compiler::Node*> { phi_bb9_12, phi_bb9_13, phi_bb9_14, phi_bb9_15, phi_bb9_16 }, &block13,
            std::vector<compiler::Node*> { phi_bb9_12, phi_bb9_13, phi_bb9_14, phi_bb9_15, phi_bb9_16 });
    }
    ...
    if (block16.is_used()) {
        ...
        ca_.Branch(tmp28, &block18, std::vector<compiler::Node*> { phi_bb16_12, phi_bb16_13, phi_bb16_14, phi_bb16_15, phi_bb16_16 }, &block19,
            std::vector<compiler::Node*> { phi_bb16_12, phi_bb16_13, phi_bb16_14, phi_bb16_15, phi_bb16_16 });
    }
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp29, &block24, std::vector<compiler::Node*> { phi_bb23_12, phi_bb23_13, phi_bb23_14, phi_bb23_15, phi_bb23_16 }, &block25,
            std::vector<compiler::Node*> { phi_bb23_12, phi_bb23_13, phi_bb23_14, phi_bb23_15, phi_bb23_16 });
    }
    ...
    if (block25.is_used()) {
        ...
        ca_.Branch(tmp33, &block26, std::vector<compiler::Node*> { phi_bb25_12, phi_bb25_13, phi_bb25_14, phi_bb25_15, phi_bb25_16 }, &block27,
            std::vector<compiler::Node*> { phi_bb25_12, phi_bb25_13, phi_bb25_14, phi_bb25_15, phi_bb25_16 });
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp40, &block32,
            std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_16, phi_bb11_19, phi_bb11_19, phi_bb11_19 }, &block33,
            std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13, phi_bb11_14, phi_bb11_15, phi_bb11_16, phi_bb11_19, phi_bb11_19, phi_bb11_19 });
    }
    ...
    if (block34.is_used()) {
        ...
        ca_.Branch(phi_bb34_38, &block30,
            std::vector<compiler::Node*> { phi_bb34_12, phi_bb34_13, phi_bb34_14, phi_bb34_15, phi_bb34_16, phi_bb34_19, phi_bb34_20, phi_bb34_25 }, &block31,
            std::vector<compiler::Node*> { phi_bb34_12, phi_bb34_13, phi_bb34_14, phi_bb34_15, phi_bb34_16, phi_bb34_19, phi_bb34_20, phi_bb34_25 });
    }
    ...
    if (block31.is_used()) {
        ...
        ca_.Branch(tmp46, &block35,
            std::vector<compiler::Node*> { phi_bb31_12, phi_bb31_13, phi_bb31_14, phi_bb31_15, phi_bb31_16, phi_bb31_19, phi_bb31_20, phi_bb31_25 }, &block36,
            std::vector<compiler::Node*> { phi_bb31_12, phi_bb31_13, phi_bb31_14, phi_bb31_15, phi_bb31_16, phi_bb31_19, phi_bb31_20, phi_bb31_25 });
    }
    ...
    if (block36.is_used()) {
        ...
        ca_.Branch(tmp38, &block37, std::vector<compiler::Node*> { phi_bb36_12, phi_bb36_13, phi_bb36_15, phi_bb36_16, phi_bb36_19, phi_bb36_20, phi_bb36_25 },
            &block38, std::vector<compiler::Node*> { phi_bb36_12, phi_bb36_13, phi_bb36_15, phi_bb36_16, phi_bb36_19, phi_bb36_20, phi_bb36_25 });
    }
    ...
    if (block29.is_used()) {
        ...
        ca_.Branch(tmp55, &block39, std::vector<compiler::Node*> { phi_bb29_12, phi_bb29_13, phi_bb29_15, phi_bb29_16, phi_bb29_19, phi_bb29_20, phi_bb29_25 },
            &block40, std::vector<compiler::Node*> { phi_bb29_12, phi_bb29_13, phi_bb29_15, phi_bb29_16, phi_bb29_19, phi_bb29_20, phi_bb29_25 });
    }
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(tmp63, &block51,
            std::vector<compiler::Node*> { phi_bb39_12, phi_bb39_13, phi_bb39_15, phi_bb39_16, phi_bb39_19, phi_bb39_20, phi_bb39_25, phi_bb39_12 }, &block52,
            std::vector<compiler::Node*> { phi_bb39_12, phi_bb39_13, phi_bb39_15, phi_bb39_16, phi_bb39_19, phi_bb39_20, phi_bb39_25, phi_bb39_12 });
    }
    ...
    if (block64.is_used()) {
        ...
        ca_.Branch(tmp86, &block78,
            std::vector<compiler::Node*> { phi_bb64_12, phi_bb64_13, phi_bb64_15, phi_bb64_16, phi_bb64_19, phi_bb64_20, phi_bb64_25, phi_bb64_12 }, &block79,
            std::vector<compiler::Node*> { phi_bb64_12, phi_bb64_13, phi_bb64_15, phi_bb64_16, phi_bb64_19, phi_bb64_20, phi_bb64_25, phi_bb64_12 });
    }
    ...
    if (block3.is_used()) {
        ...
        ca_.Branch(tmp102, &block85,
            std::vector<compiler::Node*> {
                phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_17, phi_bb3_10, phi_bb3_10 },
            &block86,
            std::vector<compiler::Node*> {
                phi_bb3_10, phi_bb3_11, phi_bb3_12, phi_bb3_13, phi_bb3_14, phi_bb3_15, phi_bb3_16, phi_bb3_17, phi_bb3_10, phi_bb3_10 });
    }
    ...
    TNode<BoolT> tmp103;
    if (block85.is_used()) {
        ca_.Bind(&block85, &phi_bb85_10, &phi_bb85_11, &phi_bb85_12, &phi_bb85_13, &phi_bb85_14, &phi_bb85_15, &phi_bb85_16, &phi_bb85_17, &phi_bb85_18,
            &phi_bb85_22);
        tmp103 = FromConstexpr_bool_constexpr_bool_0(state_, true);
        ca_.Goto(
            &block87, phi_bb85_10, phi_bb85_11, phi_bb85_12, phi_bb85_13, phi_bb85_14, phi_bb85_15, phi_bb85_16, phi_bb85_17, phi_bb85_18, phi_bb85_22, tmp103);
    }
    ...
    TNode<BoolT> tmp105;
    if (block86.is_used()) {
        ca_.Bind(&block86, &phi_bb86_10, &phi_bb86_11, &phi_bb86_12, &phi_bb86_13, &phi_bb86_14, &phi_bb86_15, &phi_bb86_16, &phi_bb86_17, &phi_bb86_18,
            &phi_bb86_22);
        ...
        ca_.Goto(
            &block87, phi_bb86_10, phi_bb86_11, phi_bb86_12, phi_bb86_13, phi_bb86_14, phi_bb86_15, phi_bb86_16, phi_bb86_17, phi_bb86_18, phi_bb86_22, tmp105);
    }
    ...
    if (block87.is_used()) {
        ca_.Bind(&block87, &phi_bb87_10, &phi_bb87_11, &phi_bb87_12, &phi_bb87_13, &phi_bb87_14, &phi_bb87_15, &phi_bb87_16, &phi_bb87_17, &phi_bb87_18,
            &phi_bb87_22, &phi_bb87_26);
        ca_.Branch(phi_bb87_26, &block83,
            std::vector<compiler::Node*> {
                phi_bb87_10, phi_bb87_11, phi_bb87_12, phi_bb87_13, phi_bb87_14, phi_bb87_15, phi_bb87_16, phi_bb87_17, phi_bb87_18, phi_bb87_22 },
            &block84,
            std::vector<compiler::Node*> {
                phi_bb87_10, phi_bb87_11, phi_bb87_12, phi_bb87_13, phi_bb87_14, phi_bb87_15, phi_bb87_16, phi_bb87_17, phi_bb87_18, phi_bb87_22 });
    }
    ...
    if (block83.is_used()) {
        ca_.Bind(&block83, &phi_bb83_10, &phi_bb83_11, &phi_bb83_12, &phi_bb83_13, &phi_bb83_14, &phi_bb83_15, &phi_bb83_16, &phi_bb83_17, &phi_bb83_18,
            &phi_bb83_22);
    ...
    TNode<BoolT> tmp108;
    if (block84.is_used()) {
        ca_.Bind(&block84, &phi_bb84_10, &phi_bb84_11, &phi_bb84_12, &phi_bb84_13, &phi_bb84_14, &phi_bb84_15, &phi_bb84_16, &phi_bb84_17, &phi_bb84_18,
            &phi_bb84_22);
        ...
        ca_.Branch(tmp108, &block88,
            ...
            &block89,
            std::vector<compiler::Node*> { phi_bb84_10, phi_bb84_11, phi_bb84_12, phi_bb84_13, phi_bb84_14, phi_bb84_15, phi_bb84_16, phi_bb84_17, phi_bb84_18,
                phi_bb84_22, phi_bb84_22 });
    }
    ...
    if (block88.is_used()) {
        ca_.Bind(&block88, &phi_bb88_10, &phi_bb88_11, &phi_bb88_12, &phi_bb88_13, &phi_bb88_14, &phi_bb88_15, &phi_bb88_16, &phi_bb88_17, &phi_bb88_18,
            &phi_bb88_22, &phi_bb88_25);
        CodeStubAssembler(state_).CallRuntime(Runtime::kThrowInvalidStringLength, p_context);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block89.is_used()) {
        ca_.Bind(&block89, &phi_bb89_10, &phi_bb89_11, &phi_bb89_12, &phi_bb89_13, &phi_bb89_14, &phi_bb89_15, &phi_bb89_16, &phi_bb89_17, &phi_bb89_18,
        ...
        ca_.Branch(tmp100, &block90,
            std::vector<compiler::Node*> {
                phi_bb89_10, phi_bb89_11, phi_bb89_12, phi_bb89_13, phi_bb89_15, phi_bb89_16, phi_bb89_17, phi_bb89_18, phi_bb89_22, phi_bb89_25 },
            &block91,
            std::vector<compiler::Node*> {
                phi_bb89_10, phi_bb89_11, phi_bb89_12, phi_bb89_13, phi_bb89_15, phi_bb89_16, phi_bb89_17, phi_bb89_18, phi_bb89_22, phi_bb89_25 });
    }
    ...
    TNode<Null> tmp114;
    if (block90.is_used()) {
        ca_.Bind(&block90, &phi_bb90_10, &phi_bb90_11, &phi_bb90_12, &phi_bb90_13, &phi_bb90_15, &phi_bb90_16, &phi_bb90_17, &phi_bb90_18, &phi_bb90_22,
            &phi_bb90_25);
    ...
    if (block91.is_used()) {
        ca_.Bind(&block91, &phi_bb91_10, &phi_bb91_11, &phi_bb91_12, &phi_bb91_13, &phi_bb91_15, &phi_bb91_16, &phi_bb91_17, &phi_bb91_18, &phi_bb91_22,
            &phi_bb91_25);
    ...
    TNode<String> tmp115;
    if (block82.is_used()) {
        ca_.Bind(&block82, &phi_bb82_10, &phi_bb82_11, &phi_bb82_12, &phi_bb82_13, &phi_bb82_14, &phi_bb82_15, &phi_bb82_16, &phi_bb82_17, &phi_bb82_18,
            &phi_bb82_22);
        tmp115 = BufferJoin_0(state_, TNode<Context> { p_context },
            TorqueStructBuffer_0 { TNode<FixedArray> { phi_bb82_12 }, TNode<IntPtrT> { phi_bb82_13 }, TNode<IntPtrT> { phi_bb82_14 },
                TNode<BoolT> { phi_bb82_15 }, TNode<PrimitiveHeapObject> { phi_bb82_16 } },
            TNode<String> { p_sep });
        ca_.Goto(&block92);
    }
...
TF_BUILTIN(LoadJoinTypedElement_Int32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Int32Elements_0(state_)));
...
TF_BUILTIN(LoadJoinTypedElement_Float16Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Float16Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Float32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Float32Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Float64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Float64Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Uint8ClampedElements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Uint8ClampedElements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_BigUint64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_BigUint64Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_BigInt64Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_BigInt64Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Uint8Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Uint8Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Int8Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Int8Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Uint16Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Uint16Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Int16Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Int16Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}
...
TF_BUILTIN(LoadJoinTypedElement_Uint32Elements_0, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray> { tmp0 });
        tmp2 = CodeStubAssembler(state_).LoadFixedTypedArrayElementAsTagged(
            TNode<RawPtrT> { tmp1 }, TNode<UintPtrT> { parameter2 }, (KindForArrayType_Uint32Elements_0(state_)));
        CodeStubAssembler(state_).Return(tmp2);
    }
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-join.tq?l=500&c=10
TNode<String> ArrayJoinImpl_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_sep,
    TNode<Number> p_lengthNumber, bool p_useToLocaleString, TNode<Object> p_locales, TNode<Object> p_options, TNode<BuiltinPtr> p_initialLoadFn)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2, &phi_bb2_10, &phi_bb2_11, &phi_bb2_12, &phi_bb2_13, &phi_bb2_14, &phi_bb2_15, &phi_bb2_16, &phi_bb2_17);
        tmp12 = CannotUseSameArrayAccessor_JSTypedArray_0(state_, TNode<Context> { p_context }, TNode<BuiltinPtr> { phi_bb2_11 },
            TNode<JSReceiver> { p_receiver }, TNode<Map> { tmp1 }, TNode<Number> { p_lengthNumber });
        ca_.Branch(tmp12, &block5,
            std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16, phi_bb2_17 }, &block6,
            std::vector<compiler::Node*> { phi_bb2_10, phi_bb2_11, phi_bb2_12, phi_bb2_13, phi_bb2_14, phi_bb2_15, phi_bb2_16, phi_bb2_17 });
    }
...
TorqueStructReference_Undefined_OR_FixedArray_0 NativeContextSlot_Context_Undefined_OR_FixedArray_0(
...
TNode<FixedArray> StoreAndGrowFixedArray_JSReceiver_0(
    compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<JSReceiver> p_element)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block7.is_used()) {
        ...
        tmp15 = ExtractFixedArray_0(
            state_, TNode<FixedArray> { p_fixedArray }, TNode<IntPtrT> { tmp14 }, TNode<IntPtrT> { tmp0 }, TNode<IntPtrT> { tmp12 }, TNode<Hole> { tmp13 });
...
TNode<Object> CycleProtectedArrayJoin_JSArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString, TNode<JSReceiver> p_o,
    TNode<Number> p_len, TNode<Object> p_sepObj, TNode<Object> p_locales, TNode<Object> p_options)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block6.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch9__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp8 = ArrayJoin_JSArray_0(state_, TNode<Context> { p_context }, p_useToLocaleString, TNode<JSReceiver> { p_o }, TNode<String> { phi_bb4_6 },
                TNode<Number> { p_len }, TNode<Object> { p_locales }, TNode<Object> { p_options });
        }
...
TNode<Object> CycleProtectedArrayJoin_JSTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, bool p_useToLocaleString,
    TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Object> p_sepObj, TNode<Object> p_locales, TNode<Object> p_options)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block6.is_used()) {
        ...
        {
            compiler::ScopedExceptionHandler s(&ca_, &catch9__label);
            tmp8 = ArrayJoin_JSTypedArray_0(state_, TNode<Context> { p_context }, p_useToLocaleString, TNode<JSReceiver> { p_o }, TNode<String> { phi_bb4_6 },
                TNode<Number> { p_len }, TNode<Object> { p_locales }, TNode<Object> { p_options });
        }
        if (catch9__label.is_used()) {
            compiler::CodeAssemblerLabel catch9_skip(&ca_);
...
TNode<FixedArray> StoreAndGrowFixedArray_Smi_0(
    compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<Smi> p_element)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<FixedArray> StoreAndGrowFixedArray_String_0(
    compiler::CodeAssemblerState* state_, TNode<FixedArray> p_fixedArray, TNode<IntPtrT> p_index, TNode<String> p_element)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
