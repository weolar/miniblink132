...
TNode<JSObject> ObjectFromEntriesFastCase_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_iterable, compiler::CodeAssemblerLabel* label_IfSlow)
{
...
TF_BUILTIN(ObjectFromEntries, CodeStubAssembler)
{
    ...
    if (block17.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch15__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp13 = IteratorBuiltinsAssembler(state_).IteratorStep(TNode<Context> { parameter0 },
                TorqueStructIteratorRecord { TNode<JSReceiver> { tmp7 }, TNode<Object> { tmp8 } }, TNode<Map> { tmp6 }, &label14);
        }
...
TNode<JSArray> Cast_FastJSArrayWithNoCustomIteration_1(
