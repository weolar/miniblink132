...
TF_BUILTIN(SetPrototypeSymmetricDifference, CodeStubAssembler)
{
    ...
    if (block3.is_used()) {
        ...
        std::tie(tmp4, tmp5, tmp6, tmp7)
            = GetSetRecord_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter2 }, "Set.prototype.symmetricDifference").Flatten();
    ...
    if (block31.is_used()) {
        ...
        ca_.Branch(tmp41, &block29, std::vector<compiler::Node*> { phi_bb31_14, phi_bb31_15, phi_bb31_23, phi_bb31_24 }, &block30,
            std::vector<compiler::Node*> { phi_bb31_14, phi_bb31_15, phi_bb31_23, phi_bb31_24 });
    }
    ...
    if (block29.is_used()) {
        ...
        std::tie(tmp42, tmp43) = CollectionsBuiltinsAssembler(state_)
                                     .NextKeyIndexPairUnmodifiedTable(TNode<OrderedHashSet> { tmp36 }, TNode<Int32T> { tmp37 }, TNode<Int32T> { tmp38 },
                                         TNode<IntPtrT> { phi_bb29_24 }, &label44)
                                     .Flatten();
    ...
    if (block33.is_used()) {
        ...
        std::tie(tmp45, tmp46) = FastSymmetricDifference_0(state_, TNode<Context> { parameter0 }, TNode<Object> { tmp42 },
            TorqueStructStableJSSetBackingTableWitness_0 { TNode<JSSet> { tmp11 }, TNode<OrderedHashSet> { tmp12 } },
            TorqueStructOrderedHashSetAndNumberOfElements_0 { TNode<OrderedHashSet> { phi_bb33_14 }, TNode<Smi> { phi_bb33_15 } },
    ...
    if (block37.is_used()) {
        ...
        CheckSetRecordHasJSMapMethods_0(
            state_, TorqueStructSetRecord { TNode<JSReceiver> { tmp4 }, TNode<Number> { tmp5 }, TNode<Object> { tmp6 }, TNode<Object> { tmp7 } }, &label47);
        ca_.Goto(&block39);
        if (label47.is_used()) {
            ca_.Bind(&label47);
            ca_.Goto(&block40);
    ...
    if (block44.is_used()) {
        ...
        ca_.Branch(tmp56, &block42, std::vector<compiler::Node*> { phi_bb44_14, phi_bb44_15, phi_bb44_23, phi_bb44_24, phi_bb44_25 }, &block43,
            std::vector<compiler::Node*> { phi_bb44_14, phi_bb44_15, phi_bb44_23, phi_bb44_24, phi_bb44_25 });
    }
    ...
    if (block42.is_used()) {
        ...
        std::tie(tmp57, tmp58, tmp59) = CollectionsBuiltinsAssembler(state_)
                                            .NextKeyValueIndexTupleUnmodifiedTable(TNode<OrderedHashMap> { tmp50 }, TNode<Int32T> { tmp51 },
                                                TNode<Int32T> { tmp52 }, TNode<IntPtrT> { phi_bb42_25 }, &label60)
                                            .Flatten();
    ...
    if (block46.is_used()) {
        ...
        std::tie(tmp61, tmp62) = FastSymmetricDifference_0(state_, TNode<Context> { parameter0 }, TNode<Object> { tmp57 },
            TorqueStructStableJSSetBackingTableWitness_0 { TNode<JSSet> { tmp11 }, TNode<OrderedHashSet> { tmp12 } },
            TorqueStructOrderedHashSetAndNumberOfElements_0 { TNode<OrderedHashSet> { phi_bb46_14 }, TNode<Smi> { phi_bb46_15 } },
            "Set.prototype.symmetricDifference")
                                     .Flatten();
    ...
    if (block50.is_used()) {
        ...
        ca_.Branch(tmp63, &block48, std::vector<compiler::Node*> { phi_bb50_12, phi_bb50_14, phi_bb50_15, phi_bb50_16 }, &block49,
            std::vector<compiler::Node*> { phi_bb50_12, phi_bb50_14, phi_bb50_15, phi_bb50_16 });
    }
    ...
    if (block48.is_used()) {
        ...
        tmp64 = IteratorBuiltinsAssembler(state_).IteratorStep(
            TNode<Context> { parameter0 }, TorqueStructIteratorRecord { TNode<JSReceiver> { tmp9 }, TNode<Object> { tmp10 } }, TNode<Map> { tmp0 }, &label65);
    ...
    if (block60.is_used()) {
        ...
        ca_.Branch(
            tmp76, &block62, std::vector<compiler::Node*> { phi_bb60_14, phi_bb60_15 }, &block63, std::vector<compiler::Node*> { phi_bb60_14, phi_bb60_15 });
    }
    ...
    if (block62.is_used()) {
        ...
        ca_.Branch(
            tmp68, &block66, std::vector<compiler::Node*> { phi_bb62_14, phi_bb62_15 }, &block67, std::vector<compiler::Node*> { phi_bb62_14, phi_bb62_15 });
    }
    ...
    if (block66.is_used()) {
        ...
        tmp77 = CollectionsBuiltinsAssembler(state_).DeleteFromSetTable(
            TNode<Context> { parameter0 }, TNode<OrderedHashSet> { phi_bb66_14 }, TNode<Object> { tmp67 }, &label78);
    ...
    if (block63.is_used()) {
        ...
        ca_.Branch(
            tmp79, &block72, std::vector<compiler::Node*> { phi_bb63_14, phi_bb63_15 }, &block73, std::vector<compiler::Node*> { phi_bb63_14, phi_bb63_15 });
    }
    ...
    if (block72.is_used()) {
        ...
        tmp81 = CollectionsBuiltinsAssembler(state_).AddToSetTable(
            TNode<Context> { parameter0 }, TNode<OrderedHashSet> { phi_bb72_14 }, TNode<Object> { tmp67 }, TNode<String> { tmp80 });
...
TorqueStructOrderedHashSetAndNumberOfElements_0 FastSymmetricDifference_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context,
    TNode<Object> p_nextValue, TorqueStructStableJSSetBackingTableWitness_0 p_table,
    TorqueStructOrderedHashSetAndNumberOfElements_0 p_resultSetDataAndNumberOfElements, const char* p_methodName)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = CollectionsBuiltinsAssembler(state_).TableHasKey(
            TNode<Context> { p_context }, TNode<OrderedHashSet> { p_resultSetDataAndNumberOfElements.setData }, TNode<Object> { tmp0 });
    ...
    if (block7.is_used()) {
        ...
        tmp2 = CollectionsBuiltinsAssembler(state_).DeleteFromSetTable(
            TNode<Context> { p_context }, TNode<OrderedHashSet> { p_resultSetDataAndNumberOfElements.setData }, TNode<Object> { tmp0 }, &label3);
        ca_.Goto(&block12);
        if (label3.is_used()) {
            ca_.Bind(&label3);
            ca_.Goto(&block13);
    ...
    if (block8.is_used()) {
        ...
        tmp5 = CollectionsBuiltinsAssembler(state_).AddToSetTable(
            TNode<Context> { p_context }, TNode<OrderedHashSet> { p_resultSetDataAndNumberOfElements.setData }, TNode<Object> { tmp0 }, TNode<String> { tmp4 });
