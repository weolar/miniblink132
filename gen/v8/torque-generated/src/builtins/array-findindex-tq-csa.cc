...
TF_BUILTIN(ArrayFindIndexLoopContinuation, CodeStubAssembler)
{
    ...
    if (block1.is_used()) {
        ...
        tmp2 = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { parameter2 }, TNode<Object> { parameter3 }, TNode<Object> { tmp1 },
            TNode<Object> { phi_bb1_7 }, TNode<Object> { parameter4 });
...
TNode<Number> FastArrayFindIndex_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len,
    ...
    compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0)
{
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp8, &block29, std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_5, phi_bb23_5, phi_bb23_5, phi_bb23_5 }, &block30,
            std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_5, phi_bb23_5, phi_bb23_5, phi_bb23_5 });
    }
    ...
    if (block25.is_used()) {
        ...
        tmp24 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { p_thisArg },
            TNode<Object> { phi_bb25_18 }, TNode<Object> { phi_bb25_5 }, TNode<Object> { tmp16 });
...
TF_BUILTIN(ArrayPrototypeFindIndex, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp11 = FastArrayFindIndex_0(state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 },
