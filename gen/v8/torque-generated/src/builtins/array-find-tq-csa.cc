...
TNode<Object> FastArrayFind_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len,
...
TF_BUILTIN(ArrayPrototypeFind, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp11 = FastArrayFind_0(state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 },
