...
TNode<Boolean> EveryAllElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context,
    TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedArrayAndLength, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg)
{
    compiler::CodeAssembler ca_(state_);
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp7, &block13, std::vector<compiler::Node*> { phi_bb11_6, phi_bb11_8, phi_bb11_10, phi_bb11_11 }, &block14,
            std::vector<compiler::Node*> { phi_bb11_6, phi_bb11_8, phi_bb11_10, phi_bb11_11 });
    }
    ...
    if (block14.is_used()) {
        ...
        tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(1)), tmp2, TNode<Object>(), tmp8, phi_bb14_8));
    ...
    if (block6.is_used()) {
        ...
        tmp12 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { p_thisArg },
            TNode<Object> { phi_bb6_9 }, TNode<Object> { tmp11 }, TNode<Object> { tmp0 });
    ...
    if (block11.is_used()) {
        ...
        tmp12 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp11 });
        tmp13 = EveryAllElements_0(state_, TNode<Context> { parameter0 },
            TorqueStructAttachedJSTypedArrayAndLength_0 { TNode<JSTypedArray> { tmp2 }, TNode<UintPtrT> { tmp3 } }, TNode<JSReceiver> { tmp7 },
            TNode<Object> { tmp12 });
...
TNode<JSTypedArray> Cast_JSTypedArray_1(
