...
TNode<BoolT> IsSubstringAt_0(compiler::CodeAssemblerState* state_, TNode<String> p_string, TNode<String> p_searchStr, TNode<IntPtrT> p_start)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = TwoStringsToSlices_bool_IsSubstringAtFunctor_0(
            state_, TNode<String> { p_string }, TNode<String> { p_searchStr }, TorqueStructIsSubstringAtFunctor_0 { TNode<IntPtrT> { p_start } });
        ca_.Goto(&block2);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<String> p_s1, TNode<String> p_s2, TorqueStructIsSubstringAtFunctor_0 p_f)
{
    ...
    if (block56.is_used()) {
        ...
        tmp128 = Call_char8_char8_0(state_, TorqueStructIsSubstringAtFunctor_0 { TNode<IntPtrT> { p_f.start } },
            TorqueStructSlice_char8_ConstReference_char8_0 {
    ...
    if (block54.is_used()) {
        ...
        tmp129 = Call_char8_char16_0(state_, TorqueStructIsSubstringAtFunctor_0 { TNode<IntPtrT> { p_f.start } },
            TorqueStructSlice_char8_ConstReference_char8_0 {
    ...
    if (block107.is_used()) {
        ...
        tmp194 = Call_char16_char8_0(state_, TorqueStructIsSubstringAtFunctor_0 { TNode<IntPtrT> { p_f.start } },
            TorqueStructSlice_char16_ConstReference_char16_0 {
    ...
    if (block105.is_used()) {
        ...
        tmp195 = Call_char16_char16_0(state_, TorqueStructIsSubstringAtFunctor_0 { TNode<IntPtrT> { p_f.start } },
            TorqueStructSlice_char16_ConstReference_char16_0 {
    ...
    TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr, TNode<IntPtrT> p_start)
{
    ...
    if (block10.is_used()) {
        ...
        ca_.Branch(
            tmp9, &block8, std::vector<compiler::Node*> { phi_bb10_11, phi_bb10_14 }, &block9, std::vector<compiler::Node*> { phi_bb10_11, phi_bb10_14 });
    }
    ...
    TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr, TNode<IntPtrT> p_start)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        compiler::CodeAssemblerLabel label3(&ca_);
        std::tie(tmp0, tmp1, tmp2) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { p_string.object }, TNode<IntPtrT> { p_string.offset }, TNode<IntPtrT> { p_string.length }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { p_start }, TNode<IntPtrT> { p_searchStr.length }, &label3)
                                         .Flatten();
