...
TF_BUILTIN(FastFunctionPrototypeBind, CodeStubAssembler)
{
    ...
    if (block12.is_used()) {
        ...
        CheckAccessor_0(state_, TNode<Context> { parameter0 }, TNode<DescriptorArray> { tmp17 },
            JSFunctionOrBoundFunctionOrWrappedFunction::kLengthDescriptorIndex, TNode<Name> { tmp18 }, &label19);
        ca_.Goto(&block13);
        if (label19.is_used()) {
            ca_.Bind(&label19);
            ca_.Goto(&block14);
    ...
    if (block13.is_used()) {
        ...
        compiler::CodeAssemblerLabel label21(&ca_);
        CheckAccessor_0(state_, TNode<Context> { parameter0 }, TNode<DescriptorArray> { tmp17 },
            JSFunctionOrBoundFunctionOrWrappedFunction::kNameDescriptorIndex, TNode<Name> { tmp20 }, &label21);
        ca_.Goto(&block15);
        if (label21.is_used()) {
            ca_.Bind(&label21);
            ca_.Goto(&block16);
    ...
    if (block24.is_used()) {
        ...
        tmp44 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { tmp42 },
            TorqueStructArgumentsIterator_0 { TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
    ...
    if (block25.is_used()) {
        ...
        tmp46 = CodeStubAssembler(state_).GetArgumentValue(
    ...
    TNode<Int32T> tmp61;
    TNode<JSDispatchHandleT> tmp62;
    if (block2.is_used()) {
        ca_.Bind(&block2);
        tmp60 = LoadTargetFromFrame_0(state_);
        tmp61 = Convert_int32_intptr_0(state_, TNode<IntPtrT> { torque_arguments.actual_count });
        tmp62 = kInvalidDispatchHandle_0(state_);
        CodeStubAssembler(state_).TailCallJSBuiltin(Builtin::kFunctionPrototypeBind, parameter0, tmp60, parameter2, tmp61, tmp62);
    }
}
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/function.tq?l=79&c=14
...
TNode<FixedArray> NewFixedArray_ArgumentsIterator_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_length, TorqueStructArgumentsIterator_0 p_it)
{
    ...
    if (block5.is_used()) {
        ...
        InitializeFieldsFromIterator_Object_ArgumentsIterator_0(state_,
            ...
            TorqueStructArgumentsIterator_0 { TorqueStructArguments { TNode<RawPtrT> { p_it.arguments.frame }, TNode<RawPtrT> { p_it.arguments.base },
