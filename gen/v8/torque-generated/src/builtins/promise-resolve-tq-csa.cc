...
TF_BUILTIN(PromiseResolve, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp12 },
            "static_assert(nativeContext == LoadNativeContext(context)) at "
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-resolve.tq?l=44&c=5");
...
TF_BUILTIN(ResolvePromise, CodeStubAssembler)
{
    ...
    if (block31.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp36 },
            "static_assert(nativeContext == LoadNativeContext(context)) at "
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-resolve.tq?l=156&c=7");
    ...
    if (block7.is_used()) {
        ...
        tmp49 = NewPromiseResolveThenableJobTask_0(
            state_, TNode<Context> { parameter0 }, TNode<JSPromise> { parameter1 }, TNode<JSReceiver> { tmp47 }, TNode<JSReceiver> { tmp48 });
