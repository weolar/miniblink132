...
TNode<FixedArray> Extract_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_source, TNode<Smi> p_startIndex,
    TNode<Smi> p_count, TNode<Smi> p_resultCapacity)
{
    ...
    if (block0.is_used()) {
        ...
        tmp4 = ExtractFixedArray_0(
            state_, TNode<FixedArray> { p_source }, TNode<IntPtrT> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 }, TNode<Hole> { tmp3 });
        ca_.Goto(&block2);
    }
...
TNode<FixedArrayBase> Extract_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_source, TNode<Smi> p_startIndex,
    TNode<Smi> p_count, TNode<Smi> p_resultCapacity)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block5.is_used()) {
        ...
        tmp5 = ExtractFixedDoubleArray_0(state_, TNode<FixedDoubleArray> { ca_.UncheckedCast<FixedDoubleArray>(p_source) }, TNode<IntPtrT> { tmp2 },
            TNode<IntPtrT> { tmp3 }, TNode<IntPtrT> { tmp4 });
...
TNode<Int32T> TransitionElementsKindForInsertionIfNeeded_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_a,
    TNode<Int32T> p_originalElementsKind, TorqueStructArguments p_args, IntegerLiteral p_argsStart)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block6.is_used()) {
        ...
        tmp2 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base },
                                                              TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            TNode<IntPtrT> { phi_bb6_8 });
...
TNode<Object> FastArraySplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o,
    TNode<Number> p_originalLengthNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber,
    compiler::CodeAssemblerLabel* label_Bailout)
{
    ...
    if (block20.is_used()) {
        ca_.Bind(&block20);
        tmp20 = TransitionElementsKindForInsertionIfNeeded_0(state_, TNode<Context> { p_context }, TNode<JSArray> { tmp8 }, TNode<Int32T> { tmp16 },
            TorqueStructArguments {
                TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base }, TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            IntegerLiteral(false, 0x2ull));
    ...
    if (block27.is_used()) {
        ca_.Bind(&block27);
        FastSplice_FixedArray_JSAny_0(state_, TNode<Context> { p_context },
            TorqueStructArguments {
                TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base }, TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            TNode<JSArray> { tmp8 }, TNode<Smi> { tmp23 }, TNode<Smi> { tmp7 }, TNode<Smi> { tmp2 }, TNode<Smi> { p_insertCount }, TNode<Smi> { tmp4 });
        ca_.Goto(&block29);
    }

    if (block28.is_used()) {
        ca_.Bind(&block28);
        FastSplice_FixedDoubleArray_Number_0(state_, TNode<Context> { p_context },
            TorqueStructArguments {
                TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base }, TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            TNode<JSArray> { tmp8 }, TNode<Smi> { tmp23 }, TNode<Smi> { tmp7 }, TNode<Smi> { tmp2 }, TNode<Smi> { p_insertCount }, TNode<Smi> { tmp4 });
        ca_.Goto(&block29);
...
TNode<Object> FillDeletedElementsArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_actualStart,
    TNode<Number> p_actualDeleteCount, TNode<JSReceiver> p_a)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void HandleForwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount,
...
void HandleBackwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount,
    TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<Object> SlowSplice_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_arguments, TNode<JSReceiver> p_o,
    TNode<Number> p_len, TNode<Number> p_actualStart, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp1 = FillDeletedElementsArray_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_o }, TNode<Number> { p_actualStart },
            TNode<Number> { p_actualDeleteCount }, TNode<JSReceiver> { tmp0 });
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2);
        HandleForwardCase_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_o }, TNode<Number> { p_len }, TNode<Number> { p_insertCount },
            TNode<Number> { p_actualStart }, TNode<Number> { p_actualDeleteCount });
        ca_.Goto(&block4);
    }
    ...
    if (block5.is_used()) {
        ca_.Bind(&block5);
        HandleBackwardCase_0(state_, TNode<Context> { p_context }, TNode<JSReceiver> { p_o }, TNode<Number> { p_len }, TNode<Number> { p_insertCount },
            TNode<Number> { p_actualStart }, TNode<Number> { p_actualDeleteCount });
        ca_.Goto(&block6);
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(
            tmp7, &block9, std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13 }, &block10, std::vector<compiler::Node*> { phi_bb11_12, phi_bb11_13 });
    }
    ...
    if (block9.is_used()) {
        ...
        tmp8 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { p_arguments.frame }, TNode<RawPtrT> { p_arguments.base },
...
TF_BUILTIN(ArrayPrototypeSplice, CodeStubAssembler)
{
    ...
    if (block9.is_used()) {
        ...
        tmp23 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp22 });
    ...
    if (block12.is_used()) {
        ...
        tmp33 = FastArraySplice_0(state_, TNode<Context> { parameter0 },
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<JSReceiver> { tmp0 }, TNode<Number> { tmp1 }, TNode<Number> { phi_bb3_10 }, TNode<Smi> { phi_bb12_11 }, TNode<Number> { phi_bb12_12 },
            &label34);
    ...
    if (block16.is_used()) {
        ...
        tmp35 = SlowSplice_0(state_, TNode<Context> { parameter0 },
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<JSReceiver> { tmp0 }, TNode<Number> { tmp1 }, TNode<Number> { phi_bb3_10 }, TNode<Smi> { phi_bb16_11 }, TNode<Number> { phi_bb16_12 });
...
void FastSplice_FixedArray_JSAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a,
    TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block10.is_used()) {
        ...
        tmp17 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp18 = Extract_0(
            state_, TNode<Context> { p_context }, TNode<FixedArray> { tmp3 }, TNode<Smi> { tmp17 }, TNode<Smi> { p_actualStart }, TNode<Smi> { tmp16 });
    ...
    if (block12.is_used()) {
        ...
        DoCopyElements_FixedArray_0(
            state_, TNode<FixedArray> { tmp19 }, TNode<Smi> { tmp4 }, TNode<FixedArray> { tmp25 }, TNode<Smi> { tmp5 }, TNode<Smi> { tmp7 });
        ca_.Goto(&block13);
    }
    ...
    if (block3.is_used()) {
        ca_.Bind(&block3);
        InsertArgumentsIntoFastPackedArray_FixedArray_JSAny_0(state_, TNode<JSArray> { p_a }, TNode<Smi> { p_actualStart },
            TorqueStructArguments {
                TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base }, TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            IntegerLiteral(false, 0x2ull), TNode<Smi> { p_insertCount });
...
void FastSplice_FixedDoubleArray_Number_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a,
    TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block10.is_used()) {
        ...
        tmp17 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp18 = Extract_1(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { tmp3 }, TNode<Smi> { tmp17 }, TNode<Smi> { p_actualStart }, TNode<Smi> { tmp16 });
    ...
    if (block12.is_used()) {
        ...
        DoCopyElements_FixedDoubleArray_0(
            state_, TNode<FixedDoubleArray> { tmp19 }, TNode<Smi> { tmp4 }, TNode<FixedDoubleArray> { tmp25 }, TNode<Smi> { tmp5 }, TNode<Smi> { tmp7 });
        ca_.Goto(&block13);
    }
    ...
    if (block3.is_used()) {
        ca_.Bind(&block3);
        InsertArgumentsIntoFastPackedArray_FixedDoubleArray_Number_0(state_, TNode<JSArray> { p_a }, TNode<Smi> { p_actualStart },
            TorqueStructArguments {
                TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base }, TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            IntegerLiteral(false, 0x2ull), TNode<Smi> { p_insertCount });
        tmp26 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
...
void DoMoveElements_FixedArray_0(
    compiler::CodeAssemblerState* state_, TNode<FixedArray> p_elements, TNode<Smi> p_dstIndex, TNode<Smi> p_srcIndex, TNode<Smi> p_count)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void DoCopyElements_FixedArray_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_dstElements, TNode<Smi> p_dstIndex, TNode<FixedArray> p_srcElements,
    TNode<Smi> p_srcIndex, TNode<Smi> p_count)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp1 = Convert_intptr_Smi_0(state_, TNode<Smi> { p_srcIndex });
        tmp2 = Convert_intptr_Smi_0(state_, TNode<Smi> { p_count });
        TorqueCopyElements_0(state_, TNode<FixedArray> { p_dstElements }, TNode<IntPtrT> { tmp0 }, TNode<FixedArray> { p_srcElements }, TNode<IntPtrT> { tmp1 },
            TNode<IntPtrT> { tmp2 });
        ca_.Goto(&block2);
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-splice.tq?l=95&c=7
void DoMoveElements_FixedDoubleArray_0(
    compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_elements, TNode<Smi> p_dstIndex, TNode<Smi> p_srcIndex, TNode<Smi> p_count)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-splice.tq?l=97&c=7
void StoreHoles_FixedDoubleArray_0(
    compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_elements, TNode<Smi> p_holeStartIndex, TNode<Smi> p_holeEndIndex)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-splice.tq?l=110&c=11
void DoCopyElements_FixedDoubleArray_0(compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_dstElements, TNode<Smi> p_dstIndex,
    TNode<FixedDoubleArray> p_srcElements, TNode<Smi> p_srcIndex, TNode<Smi> p_count)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp1 = Convert_intptr_Smi_0(state_, TNode<Smi> { p_srcIndex });
        tmp2 = Convert_intptr_Smi_0(state_, TNode<Smi> { p_count });
        TorqueCopyElements_1(state_, TNode<FixedDoubleArray> { p_dstElements }, TNode<IntPtrT> { tmp0 }, TNode<FixedDoubleArray> { p_srcElements },
            TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 });
        ca_.Goto(&block2);
    }
