...
TF_BUILTIN(ArrayFindLastIndexLoopContinuation, CodeStubAssembler)
{
    ...
    if (block1.is_used()) {
        ...
        tmp3 = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<Object> { parameter2 }, TNode<Object> { tmp2 },
            TNode<Object> { phi_bb1_5 }, TNode<Object> { parameter3 });
...
TNode<Number> FastArrayFindLastIndex_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len,
    TNode<JSReceiver> p_predicate, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout,
    compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0)
{
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp11, &block29, std::vector<compiler::Node*> { phi_bb23_6, phi_bb23_6, phi_bb23_6, phi_bb23_6, phi_bb23_6 }, &block30,
            std::vector<compiler::Node*> { phi_bb23_6, phi_bb23_6, phi_bb23_6, phi_bb23_6, phi_bb23_6 });
    }
    ...
    if (block25.is_used()) {
        ...
        tmp28 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_predicate }, TNode<Object> { p_thisArg },
            TNode<Object> { phi_bb25_18 }, TNode<Object> { phi_bb25_6 }, TNode<Object> { tmp20 });
...
TF_BUILTIN(ArrayPrototypeFindLastIndex, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp11 = FastArrayFindLastIndex_0(state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 },
