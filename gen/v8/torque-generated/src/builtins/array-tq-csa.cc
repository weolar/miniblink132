...
void EnsureWriteableFastElements_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_array)
{
    ...
    if (block14.is_used()) {
        ...
        tmp15 = ExtractFixedArray_0(
            state_, TNode<FixedArray> { tmp12 }, TNode<IntPtrT> { tmp14 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp10 }, TNode<Hole> { tmp13 });
...
TNode<Object> LoadElementOrUndefined_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_a, TNode<Smi> p_i)
{
    ...
    if (block6.is_used()) {
        ...
        tmp12 = UnsafeCast_JSReceiver_OR_Undefined_OR_Null_OR_Boolean_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
            state_, TNode<Context> { p_context }, TNode<Object> { tmp11 });
...
void StoreArrayHole_0(compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_elements, TNode<Smi> p_k)
{
    ...
    if (block6.is_used()) {
        ...
        StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp10 }, TorqueStructUnsafe_0 {} },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp11 }, TNode<Float64T> { tmp12 } });
        ca_.Goto(&block10);
    }
