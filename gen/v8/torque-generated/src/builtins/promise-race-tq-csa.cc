...
TF_BUILTIN(PromiseRace, CodeStubAssembler)
{
    ...
    if (block11.is_used()) {
        ...
        tmp15 = True_0(state_);
        tmp16 = CodeStubAssembler(state_).SetPropertyStrict(
            TNode<Context> { parameter0 }, TNode<Object> { tmp9 }, TNode<Object> { tmp14 }, TNode<Object> { tmp15 });
        ca_.Goto(&block12);
    }
    ...
    if (block22.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch39__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp37 = IteratorBuiltinsAssembler(state_).IteratorStep(TNode<Context> { parameter0 },
                TorqueStructIteratorRecord { TNode<JSReceiver> { tmp20 }, TNode<Object> { tmp21 } }, TNode<Map> { tmp29 }, &label38);
        }
    ...
    if (block30.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch59__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp58 = CodeStubAssembler(state_).Call(
                TNode<Context> { parameter0 }, TNode<Object> { tmp49 }, TNode<Object> { tmp45 }, TNode<Object> { tmp52 }, TNode<Object> { tmp55 });
        }
    ...
    if (block39.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch81__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp80 = CodeStubAssembler(state_).SetPropertyStrict(
                TNode<Context> { parameter0 }, TNode<Object> { tmp58 }, TNode<Object> { tmp79 }, TNode<Object> { tmp11 });
        }
