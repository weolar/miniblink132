...
TNode<Object> LoadElement_FixedArray_Object_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index)
{
...
TorqueStructfloat64_or_hole_0 LoadElement_FixedDoubleArray_float64_or_hole_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block6.is_used()) {
        ...
        std::tie(tmp12, tmp13) = LoadFloat64OrHole_0(
            state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp10 }, TNode<IntPtrT> { tmp11 }, TorqueStructUnsafe_0 {} })
                                     .Flatten();
        ca_.Goto(&block10);
    }
...
void StoreElement_FixedArray_Object_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, TNode<Object> p_value)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void StoreElement_FixedDoubleArray_float64_or_hole_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, TorqueStructfloat64_or_hole_0 p_value)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block6.is_used()) {
        ...
        tmp9 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp8 });
        std::tie(tmp10, tmp11) = NewReference_float64_or_hole_0(state_, TNode<Object> { tmp1 }, TNode<IntPtrT> { tmp9 }).Flatten();
        StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp10 }, TNode<IntPtrT> { tmp11 }, TorqueStructUnsafe_0 {} },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { p_value.is_hole }, TNode<Float64T> { p_value.value } });
        ca_.Goto(&block10);
    }
...
TNode<Object> GenericArrayReverse_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver)
{
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(
            phi_bb13_11, &block9, std::vector<compiler::Node*> { phi_bb13_4, phi_bb13_5 }, &block10, std::vector<compiler::Node*> { phi_bb13_4, phi_bb13_5 });
    }
    ...
    if (block19.is_used()) {
        ...
        ca_.Branch(
            phi_bb19_11, &block15, std::vector<compiler::Node*> { phi_bb19_4, phi_bb19_5 }, &block16, std::vector<compiler::Node*> { phi_bb19_4, phi_bb19_5 });
    }
    ...
    if (block25.is_used()) {
        ...
        ca_.Branch(
            phi_bb25_11, &block21, std::vector<compiler::Node*> { phi_bb25_4, phi_bb25_5 }, &block22, std::vector<compiler::Node*> { phi_bb25_4, phi_bb25_5 });
    }
...
void TryFastPackedArrayReverse_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, compiler::CodeAssemblerLabel* label_Slow)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<JSArray> Cast_FastJSArray_1(
...
void FastArrayReverse_FixedArray_Object_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length)
{
    ...
    if (block2.is_used()) {
        ...
        StoreElement_FixedArray_Object_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { p_elements }, TNode<Smi> { phi_bb2_3 }, TNode<Object> { tmp5 });
        StoreElement_FixedArray_Object_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { p_elements }, TNode<Smi> { phi_bb2_4 }, TNode<Object> { tmp4 });
...
void FastArrayReverse_FixedDoubleArray_float64_or_hole_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2, &phi_bb2_3, &phi_bb2_4);
        std::tie(tmp4, tmp5) = LoadElement_FixedDoubleArray_float64_or_hole_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { p_elements }, TNode<Smi> { phi_bb2_3 })
                                   .Flatten();
        std::tie(tmp6, tmp7) = LoadElement_FixedDoubleArray_float64_or_hole_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { p_elements }, TNode<Smi> { phi_bb2_4 })
                                   .Flatten();
        StoreElement_FixedDoubleArray_float64_or_hole_0(state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { p_elements }, TNode<Smi> { phi_bb2_3 },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp6 }, TNode<Float64T> { tmp7 } });
        StoreElement_FixedDoubleArray_float64_or_hole_0(state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { p_elements }, TNode<Smi> { phi_bb2_4 },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp4 }, TNode<Float64T> { tmp5 } });
        tmp8 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
