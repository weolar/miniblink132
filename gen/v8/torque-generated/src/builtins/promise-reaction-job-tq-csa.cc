...
TNode<Object> RejectPromiseReactionJob_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_promiseOrCapability,
    TNode<Object> p_reason, PromiseReaction::Type p_reactionType)
{
    ...
    if (block12.is_used()) {
        ...
        tmp7 = CodeStubAssembler(state_).LoadReference<Object>(
            CodeStubAssembler::Reference { ca_.UncheckedCast<PromiseCapability>(p_promiseOrCapability), tmp6 });
    ...
    if (block3.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp12 },
            "static_assert(reactionType == kPromiseReactionFulfill) at "
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-reaction-job.tq?l=32&c=5");
...
TNode<Object> FuflfillPromiseReactionJob_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<HeapObject> p_promiseOrCapability,
    TNode<Object> p_result, PromiseReaction::Type p_reactionType)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block9.is_used()) {
        ...
        tmp6 = CodeStubAssembler(state_).LoadReference<Object>(
            CodeStubAssembler::Reference { ca_.UncheckedCast<PromiseCapability>(p_promiseOrCapability), tmp5 });
    ...
    if (block12.is_used()) {
        ...
        tmp14 = RejectPromiseReactionJob_0(
            state_, TNode<Context> { p_context }, TNode<HeapObject> { p_promiseOrCapability }, TNode<Object> { tmp11 }, p_reactionType);
        ca_.Goto(&block1, tmp14);
    }
...
TNode<Object> PromiseReactionJob_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_argument, TNode<HeapObject> p_handler,
    TNode<HeapObject> p_promiseOrCapability, PromiseReaction::Type p_reactionType)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block5.is_used()) {
        ca_.Bind(&block5);
        tmp2 = FuflfillPromiseReactionJob_0(
            state_, TNode<Context> { p_context }, TNode<HeapObject> { p_promiseOrCapability }, TNode<Object> { p_argument }, p_reactionType);
    ...
    if (block6.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp3 },
            ...
            "https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/promise-reaction-job.tq?l=79&c=7");
        tmp4 = RejectPromiseReactionJob_0(
            state_, TNode<Context> { p_context }, TNode<HeapObject> { p_promiseOrCapability }, TNode<Object> { p_argument }, p_reactionType);
        ca_.Goto(&block1, tmp4);
    }
    ...
    if (block13.is_used()) {
        ...
        compiler::CodeAssemblerExceptionHandlerLabel catch21__label(&ca_, compiler::CodeAssemblerLabel::kDeferred);
        {
            ...
            tmp20 = FuflfillPromiseReactionJob_0(
                state_, TNode<Context> { p_context }, TNode<HeapObject> { p_promiseOrCapability }, TNode<Object> { tmp9 }, p_reactionType);
        }
    ...
    if (block9.is_used()) {
        ...
        tmp24 = RejectPromiseReactionJob_0(
            state_, TNode<Context> { p_context }, TNode<HeapObject> { p_promiseOrCapability }, TNode<Object> { phi_bb9_4 }, p_reactionType);
...
TF_BUILTIN(PromiseFulfillReactionJob, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = PromiseReactionJob_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<HeapObject> { parameter2 },
            TNode<HeapObject> { parameter3 }, PromiseReaction::kFulfill);
...
TF_BUILTIN(PromiseRejectReactionJob, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = PromiseReactionJob_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<HeapObject> { parameter2 },
            TNode<HeapObject> { parameter3 }, PromiseReaction::kReject);
        CodeStubAssembler(state_).Return(tmp0);
    }
}
