...
TF_BUILTIN(StringRepeat, CodeStubAssembler)
{
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp2, &block9, std::vector<compiler::Node*> { phi_bb11_3, phi_bb11_4, phi_bb11_5 }, &block10,
            std::vector<compiler::Node*> { phi_bb11_3, phi_bb11_4, phi_bb11_5 });
    }
    ...
    if (block9.is_used()) {
        ...
        ca_.Branch(tmp6, &block12, std::vector<compiler::Node*> { phi_bb9_3, phi_bb9_4, phi_bb9_5 }, &block13,
            std::vector<compiler::Node*> { phi_bb9_3, phi_bb9_4, phi_bb9_5 });
    }
