...
void TryInitializeAsMonomorphic_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_maybeTarget,
    TNode<FeedbackVector> p_feedbackVector, TNode<UintPtrT> p_slotId, compiler::CodeAssemblerLabel* label_TransitionToMegamorphic)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block11.is_used()) {
        ...
        tmp12 = CodeStubAssembler(state_).StoreWeakReferenceInFeedbackVector(
            TNode<FeedbackVector> { p_feedbackVector }, TNode<UintPtrT> { p_slotId }, TNode<HeapObject> { tmp0 });
...
void TransitionToMegamorphic_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FeedbackVector> p_feedbackVector, TNode<UintPtrT> p_slotId)
{
    ...
    if (block0.is_used()) {
        ...
        CodeStubAssembler(state_).StoreFeedbackVectorSlot(
            TNode<FeedbackVector> { p_feedbackVector }, TNode<UintPtrT> { p_slotId }, TNode<MaybeObject> { tmp0 });
...
TNode<BoolT> FeedbackValueIsReceiver_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FeedbackVector> p_feedbackVector, TNode<UintPtrT> p_slotId)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void SetCallFeedbackContent_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FeedbackVector> p_feedbackVector, TNode<UintPtrT> p_slotId,
    CallFeedbackContent p_callFeedbackContent)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block4.is_used()) {
        ...
        CodeStubAssembler(state_).StoreFeedbackVectorSlot(
            TNode<FeedbackVector> { p_feedbackVector }, TNode<UintPtrT> { p_slotId }, TNode<MaybeObject> { tmp13 }, SKIP_WRITE_BARRIER, kTaggedSize);
...
void CollectCallFeedback_0(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, std::function<TNode<Object>()> p_maybeReceiver,
    TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId)
{
    ...
    if (block26.is_used()) {
        ca_.Bind(&block26);
        SetCallFeedbackContent_0(
            state_, TNode<Context> { p_context }, TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { p_slotId }, CallFeedbackContent::kTarget);
        ca_.Goto(&block16);
    }
    ...
    if (block33.is_used()) {
        ...
        TryInitializeAsMonomorphic_0(
            state_, TNode<Context> { p_context }, TNode<Object> { p_maybeTarget }, TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { p_slotId }, &label13);
        ca_.Goto(&block35);
        if (label13.is_used()) {
            ca_.Bind(&label13);
            ca_.Goto(&block36);
    ...
    if (block44.is_used()) {
        ca_.Bind(&block44);
        tmp25 = CodeStubAssembler(state_).StoreWeakReferenceInFeedbackVector(
            TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { p_slotId }, TNode<HeapObject> { tmp22 });
    ...
    if (block45.is_used()) {
        ...
        SetCallFeedbackContent_0(
            state_, TNode<Context> { p_context }, TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { p_slotId }, CallFeedbackContent::kReceiver);
    ...
    if (block47.is_used()) {
        ...
        TryInitializeAsMonomorphic_0(
            state_, TNode<Context> { p_context }, TNode<Object> { phi_bb47_6 }, TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { p_slotId }, &label28);
        ca_.Goto(&block52);
        if (label28.is_used()) {
            ca_.Bind(&label28);
            ca_.Goto(&block53);
...
void CollectInstanceOfFeedback_0(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, TNode<Context> p_context,
    TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId)
{
    ...
    if (block16.is_used()) {
        ...
        TryInitializeAsMonomorphic_0(
            state_, TNode<Context> { p_context }, TNode<Object> { p_maybeTarget }, TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { p_slotId }, &label8);
        ca_.Goto(&block25);
        if (label8.is_used()) {
            ca_.Bind(&label8);
            ca_.Goto(&block26);
...
TNode<FeedbackVector> CastFeedbackVector_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_maybeFeedbackVector,
    UpdateFeedbackMode p_updateFeedbackMode, compiler::CodeAssemblerLabel* label_Fallback)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void CollectConstructFeedback_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_target, TNode<Object> p_newTarget,
    ...
    compiler::TypedCodeAssemblerVariable<AllocationSite>* label_ConstructArray_parameter_0)
{
    ...
    if (block12.is_used()) {
        ca_.Bind(&block12);
        tmp2 = CodeStubAssembler(state_).TaggedIndexToIntPtr(TNode<TaggedIndex> { p_slotId });
    ...
    TNode<AllocationSite> tmp13;
    if (block28.is_used()) {
        ca_.Bind(&block28);
        tmp13 = UnsafeCast_AllocationSite_0(state_, TNode<Context> { p_context }, TNode<Object> { tmp10 });
    ...
    TNode<AllocationSite> tmp17;
    if (block32.is_used()) {
        ca_.Bind(&block32);
        tmp17 = CodeStubAssembler(state_).CreateAllocationSiteInFeedbackVector(TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { tmp3 });
        CodeStubAssembler(state_).ReportFeedbackUpdate(TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { tmp3 }, "Construct:CreateAllocationSite");
    ...
    if (block33.is_used()) {
        ...
        TryInitializeAsMonomorphic_0(
            state_, TNode<Context> { p_context }, TNode<Object> { p_newTarget }, TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { tmp3 }, &label18);
        ca_.Goto(&block34);
        if (label18.is_used()) {
            ca_.Bind(&label18);
            ca_.Goto(&block35);
    ...
    if (block15.is_used()) {
        ca_.Bind(&block15);
        TransitionToMegamorphic_0(state_, TNode<Context> { p_context }, TNode<FeedbackVector> { tmp0 }, TNode<UintPtrT> { tmp3 });
        ca_.Goto(&block14);
    }
