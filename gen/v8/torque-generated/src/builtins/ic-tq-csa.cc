...
void CollectCallFeedback_1(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, std::function<TNode<Object>()> p_maybeReceiver,
    TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        CollectCallFeedback_0(state_, TNode<Object> { p_maybeTarget }, std::function<TNode<Object>()> { p_maybeReceiver }, TNode<Context> { p_context },
...
void CollectInstanceOfFeedback_1(compiler::CodeAssemblerState* state_, TNode<Object> p_maybeTarget, TNode<Context> p_context,
    TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        CollectInstanceOfFeedback_0(
            state_, TNode<Object> { p_maybeTarget }, TNode<Context> { p_context }, TNode<HeapObject> { p_maybeFeedbackVector }, TNode<UintPtrT> { p_slotId });
        ca_.Goto(&block2);
    }
...
void CollectConstructFeedback_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_target, TNode<Object> p_newTarget,
    ...
    compiler::TypedCodeAssemblerVariable<AllocationSite>* label_ConstructArray_parameter_0)
{
    ...
    if (block0.is_used()) {
        ...
        CollectConstructFeedback_0(state_, TNode<Context> { p_context }, TNode<Object> { p_target }, TNode<Object> { p_newTarget },
            TNode<HeapObject> { p_maybeFeedbackVector }, TNode<TaggedIndex> { p_slotId }, p_updateFeedbackMode, &label0, &label1, &tmp2);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block3);
        }
