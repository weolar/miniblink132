...
TF_BUILTIN(StringPrototypeReplaceAll, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ca_.Bind(&block10);
        tmp10 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { tmp8 }, TNode<Object> { parameter2 }, TNode<Object> { parameter1 }, TNode<Object> { parameter3 });
    ...
    if (block16.is_used()) {
        ...
        ca_.Branch(tmp24, &block14, std::vector<compiler::Node*> { phi_bb16_10, phi_bb16_11, phi_bb16_12 }, &block15,
            std::vector<compiler::Node*> { phi_bb16_10, phi_bb16_11, phi_bb16_12 });
    }
    ...
    if (block14.is_used()) {
        ...
        ca_.Branch(tmp13, &block17, std::vector<compiler::Node*> { phi_bb14_10, phi_bb14_11, phi_bb14_12 }, &block18,
            std::vector<compiler::Node*> { phi_bb14_10, phi_bb14_11, phi_bb14_12 });
    }
    ...
    if (block17.is_used()) {
        ...
        tmp27 = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { tmp25 }, TNode<Object> { tmp26 }, TNode<Object> { tmp12 },
            TNode<Object> { phi_bb17_12 }, TNode<Object> { tmp11 });
    ...
    if (block18.is_used()) {
        ...
        tmp31 = StringBuiltinsAssembler(state_).GetSubstitution(
            TNode<Context> { parameter0 }, TNode<String> { tmp11 }, TNode<Smi> { phi_bb18_12 }, TNode<Smi> { tmp30 }, TNode<String> { tmp29 });
    ...
    if (block15.is_used()) {
        ...
        ca_.Branch(tmp43, &block20, std::vector<compiler::Node*> { phi_bb15_10, phi_bb15_11, phi_bb15_12 }, &block21,
            std::vector<compiler::Node*> { phi_bb15_10, phi_bb15_11, phi_bb15_12 });
    }
