...
TF_BUILTIN(ArrayEveryLoopContinuation, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp5 = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { parameter2 }, TNode<Object> { parameter3 }, TNode<Object> { tmp4 },
            TNode<Object> { phi_bb5_9 }, TNode<Object> { parameter5 });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-every.tq?l=84&c=1
TNode<Object> FastArrayEvery_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len,
    ...
    compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0)
{
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp8, &block28, std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_5, phi_bb23_5 }, &block29,
            std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_5, phi_bb23_5 });
    }
    ...
    if (block27.is_used()) {
        ...
        tmp23 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { p_thisArg },
            TNode<Object> { phi_bb27_18 }, TNode<Object> { phi_bb27_5 }, TNode<Object> { tmp16 });
...
TF_BUILTIN(ArrayEvery, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp11 = FastArrayEvery_0(state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 },
            TNode<Object> { tmp10 }, &label12, &tmp13);
        ca_.Goto(&block9);
        if (label12.is_used()) {
            ca_.Bind(&label12);
            ca_.Goto(&block10);
    ...
    if (block2.is_used()) {
        ...
        tmp18 = CodeStubAssembler(state_).GetArgumentValue(
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<IntPtrT> { tmp17 });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-every.tq?l=16&c=22
TNode<JSReceiver> Cast_JSReceiver_1(
...
TNode<JSReceiver> Cast_Callable_1(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
