...
TF_BUILTIN(ArrayReduceLoopContinuation, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ...
        tmp8 = CodeStubAssembler(state_).Call(TNode<Context> { parameter0 }, TNode<Object> { parameter2 }, TNode<Object> { tmp7 },
            TNode<Object> { ca_.UncheckedCast<Object>(phi_bb10_11) }, TNode<Object> { tmp4 }, TNode<Object> { phi_bb10_8 }, TNode<Object> { parameter4 });
...
TNode<Object> FastArrayReduce_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len,
    ...
    compiler::TypedCodeAssemblerVariable<Number>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Object>* label_Bailout_parameter_1)
{
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(tmp11, &block11, std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_8, phi_bb13_11 }, &block12,
            std::vector<compiler::Node*> { phi_bb13_5, phi_bb13_8, phi_bb13_11 });
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp14, &block18, std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_8, phi_bb11_11 }, &block19,
            std::vector<compiler::Node*> { phi_bb11_5, phi_bb11_8, phi_bb11_11 });
    }
    ...
    if (block19.is_used()) {
        ...
        ca_.Branch(tmp15, &block20, std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_8, phi_bb19_11 }, &block21,
            std::vector<compiler::Node*> { phi_bb19_5, phi_bb19_8, phi_bb19_11 });
    }
    ...
    if (block21.is_used()) {
        ...
        ca_.Branch(
            tmp19, &block22, std::vector<compiler::Node*> { phi_bb21_5, phi_bb21_11 }, &block23, std::vector<compiler::Node*> { phi_bb21_5, phi_bb21_11 });
    }
    ...
    if (block23.is_used()) {
        ...
        ca_.Branch(tmp9, &block28, std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_11, phi_bb23_11, phi_bb23_11 }, &block29,
            std::vector<compiler::Node*> { phi_bb23_5, phi_bb23_11, phi_bb23_11, phi_bb23_11 });
    }
    ...
    if (block38.is_used()) {
        ...
        tmp27 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { tmp26 },
            TNode<Object> { ca_.UncheckedCast<Object>(phi_bb38_13) }, TNode<Object> { phi_bb27_16 }, TNode<Object> { phi_bb38_11 }, TNode<Object> { tmp16 });
...
TF_BUILTIN(ArrayReduce, CodeStubAssembler)
{
    ...
    if (block9.is_used()) {
        ...
        tmp14 = FastArrayReduce_0(state_, TNode<Context> { parameter0 }, TNode<JSReceiver> { tmp1 }, TNode<Number> { tmp2 }, TNode<JSReceiver> { tmp7 },
