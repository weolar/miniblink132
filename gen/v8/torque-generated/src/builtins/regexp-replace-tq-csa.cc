...
TNode<IntPtrT> RegExpReplaceCallableNoExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements,
    TNode<IntPtrT> p_matchesCapacity, TNode<String> p_string, TNode<JSReceiver> p_replaceFn)
{
    ...
    if (block2.is_used()) {
        ...
        ca_.Branch(tmp8, &block10, std::vector<compiler::Node*> { phi_bb2_5, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6 }, &block11,
            std::vector<compiler::Node*> { phi_bb2_5, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6, phi_bb2_6 });
    }
    ...
    if (block31.is_used()) {
        ...
        tmp45 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_replaceFn }, TNode<Object> { tmp44 }, TNode<Object> { tmp16 },
            TNode<Object> { phi_bb31_5 }, TNode<Object> { p_string });
        ...
        ca_.Branch(tmp52, &block37, std::vector<compiler::Node*> { phi_bb31_5, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6 }, &block38,
            std::vector<compiler::Node*> { phi_bb31_5, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6, phi_bb31_6 });
    }
...
TNode<IntPtrT> RegExpReplaceCallableWithExplicitCaptures_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements,
    TNode<IntPtrT> p_matchesCapacity, TNode<JSReceiver> p_replaceFn)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block2.is_used()) {
        ...
        ca_.Branch(tmp7, &block12, std::vector<compiler::Node*> { phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4 }, &block13,
            std::vector<compiler::Node*> { phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4, phi_bb2_4 });
    }
    ...
    if (block7.is_used()) {
        ...
        ca_.Branch(tmp20, &block22, std::vector<compiler::Node*> { phi_bb7_4, phi_bb7_4, phi_bb7_4, phi_bb7_4, phi_bb7_4 }, &block23,
            std::vector<compiler::Node*> { phi_bb7_4, phi_bb7_4, phi_bb7_4, phi_bb7_4, phi_bb7_4 });
    }
    ...
    if (block26.is_used()) {
        ...
        tmp31 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { tmp28 }, TNode<Object> { tmp29 }, TNode<Object> { p_replaceFn },
            TNode<Object> { tmp30 }, TNode<Object> { tmp26 });
        ...
        ca_.Branch(tmp37, &block32, std::vector<compiler::Node*> { phi_bb26_4, phi_bb26_4, phi_bb26_4, phi_bb26_4, phi_bb26_4 }, &block33,
            std::vector<compiler::Node*> { phi_bb26_4, phi_bb26_4, phi_bb26_4, phi_bb26_4, phi_bb26_4 });
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<JSReceiver> p_replaceFn)
{
    ...
    if (block8.is_used()) {
        ca_.Bind(&block8);
        tmp17 = RegExpReplaceCallableNoExplicitCaptures_0(state_, TNode<Context> { p_context }, TNode<FixedArray> { tmp6 }, TNode<IntPtrT> { tmp11 },
    ...
    if (block9.is_used()) {
        ca_.Bind(&block9);
        tmp18 = RegExpReplaceCallableWithExplicitCaptures_0(
            state_, TNode<Context> { p_context }, TNode<FixedArray> { tmp6 }, TNode<IntPtrT> { tmp11 }, TNode<JSReceiver> { p_replaceFn });
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<String> p_replaceString)
{
    ...
    if (block9.is_used()) {
        ...
        ca_.Branch(tmp10, &block7, std::vector<compiler::Node*> { phi_bb9_4, phi_bb9_5, phi_bb9_6 }, &block8,
            std::vector<compiler::Node*> { phi_bb9_4, phi_bb9_5, phi_bb9_6 });
    }
    ...
    if (block7.is_used()) {
        ...
        tmp11 = RegExpPrototypeExecBodyWithoutResultFast_0(
            state_, TNode<Context> { p_context }, TNode<JSRegExp> { p_regexp }, TNode<String> { p_string }, &label12);
    ...
    if (block12.is_used()) {
        ...
        tmp13 = Method_RegExpMatchInfo_GetStartOfCapture_0(
            state_, TNode<RegExpMatchInfo> { tmp11 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
        tmp14 = Method_RegExpMatchInfo_GetEndOfCapture_0(
            state_, TNode<RegExpMatchInfo> { tmp11 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))));
...
TF_BUILTIN(RegExpReplace, CodeStubAssembler)
{
    ...
    if (block9.is_used()) {
        ca_.Bind(&block9);
        tmp6 = RegExpReplaceFastGlobalCallable_0(
            state_, TNode<Context> { parameter0 }, TNode<JSRegExp> { parameter1 }, TNode<String> { parameter2 }, TNode<JSReceiver> { tmp0 });
    ...
    if (block18.is_used()) {
        ca_.Bind(&block18);
        tmp13
            = RegExpReplaceFastString_0(state_, TNode<Context> { parameter0 }, TNode<JSRegExp> { tmp3 }, TNode<String> { parameter2 }, TNode<String> { tmp2 });
...
TF_BUILTIN(RegExpPrototypeReplace, CodeStubAssembler)
{
    ...
    if (block4.is_used()) {
        ...
        CodeStubAssembler(state_).ThrowTypeError(
            TNode<Context> { parameter0 }, MessageTemplate::kIncompatibleMethodReceiver, TNode<Object> { tmp6 }, TNode<Object> { parameter1 });
    }
