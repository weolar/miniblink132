    ...
    TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedArrayAndLength, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue)
{
    ...
    if (block4.is_used()) {
        ...
        ca_.Branch(tmp4, &block2, std::vector<compiler::Node*> { phi_bb4_6, phi_bb4_8, phi_bb4_9 }, &block3,
            std::vector<compiler::Node*> { phi_bb4_6, phi_bb4_8, phi_bb4_9 });
    }
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp7, &block13, std::vector<compiler::Node*> { phi_bb11_6, phi_bb11_8, phi_bb11_9, phi_bb11_11, phi_bb11_12 }, &block14,
            std::vector<compiler::Node*> { phi_bb11_6, phi_bb11_8, phi_bb11_9, phi_bb11_11, phi_bb11_12 });
    }
    ...
    if (block14.is_used()) {
        ...
        tmp9 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(1)), tmp2, TNode<Object>(), tmp8, phi_bb14_9));
    ...
    if (block19.is_used()) {
        ...
        tmp15 = CodeStubAssembler(state_).Call(TNode<Context> { p_context }, TNode<Object> { p_callbackfn }, TNode<Object> { tmp13 },
            TNode<Object> { ca_.UncheckedCast<Object>(phi_bb19_11) }, TNode<Object> { phi_bb6_10 }, TNode<Object> { tmp14 }, TNode<Object> { tmp0 });
...
TF_BUILTIN(TypedArrayPrototypeReduce, CodeStubAssembler)
{
    ...
    if (block15.is_used()) {
        ...
        tmp16 = ReduceAllElements_0(state_, TNode<Context> { parameter0 },
