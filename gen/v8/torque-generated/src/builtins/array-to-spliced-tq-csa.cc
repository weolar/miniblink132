    ...
    TNode<Smi> p_newLenSmi, TNode<Smi> p_actualStartSmi, TNode<Smi> p_insertCountSmi, TNode<Smi> p_actualDeleteCountSmi)
{
    ...
    if (block2.is_used()) {
        ...
        CodeStubAssembler(state_).CopyElements(
            p_kind, TNode<FixedArrayBase> { tmp4 }, TNode<IntPtrT> { tmp9 }, TNode<FixedArrayBase> { tmp8 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp1 });
        ca_.Goto(&block3);
    }
    ...
    if (block9.is_used()) {
        ...
        CodeStubAssembler(state_).CopyElements(p_kind, TNode<FixedArrayBase> { tmp4 }, TNode<IntPtrT> { tmp15 }, TNode<FixedArrayBase> { tmp21 },
            TNode<IntPtrT> { tmp19 }, TNode<IntPtrT> { tmp16 });
        ca_.Goto(&block10);
    }
...
TNode<JSArray> TryFastArrayToSpliced_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o,
    TNode<Number> p_originalLenNumber, TNode<Number> p_newLenNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount,
    TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Slow)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block17.is_used()) {
        ca_.Bind(&block17);
        tmp19 = CopyFastPackedArrayForToSpliced_0(state_, TNode<Context> { p_context }, ElementsKind::PACKED_SMI_ELEMENTS, TNode<JSArray> { tmp6 },
            TNode<Smi> { tmp0 }, TNode<Smi> { tmp2 }, TNode<Smi> { p_insertCount }, TNode<Smi> { tmp4 });
    ...
    if (block20.is_used()) {
        ca_.Bind(&block20);
        tmp22 = CopyFastPackedArrayForToSpliced_0(state_, TNode<Context> { p_context }, ElementsKind::PACKED_ELEMENTS, TNode<JSArray> { tmp6 },
            TNode<Smi> { tmp0 }, TNode<Smi> { tmp2 }, TNode<Smi> { p_insertCount }, TNode<Smi> { tmp4 });
    ...
    if (block21.is_used()) {
        ca_.Bind(&block21);
        tmp23 = CopyFastPackedArrayForToSpliced_0(state_, TNode<Context> { p_context }, ElementsKind::PACKED_DOUBLE_ELEMENTS, TNode<JSArray> { tmp6 },
            TNode<Smi> { tmp0 }, TNode<Smi> { tmp2 }, TNode<Smi> { p_insertCount }, TNode<Smi> { tmp4 });
    ...
    if (block19.is_used()) {
        ...
        tmp24 = TransitionElementsKindForInsertionIfNeeded_0(state_, TNode<Context> { p_context }, TNode<JSArray> { phi_bb19_17 }, TNode<Int32T> { tmp14 },
    ...
    if (block31.is_used()) {
        ...
        InsertArgumentsIntoFastPackedArray_FixedArray_JSAny_0(state_, TNode<JSArray> { phi_bb31_17 }, TNode<Smi> { tmp2 },
            TorqueStructArguments {
                TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base }, TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
    ...
    if (block32.is_used()) {
        ...
        InsertArgumentsIntoFastPackedArray_FixedDoubleArray_Number_0(state_, TNode<JSArray> { phi_bb32_17 }, TNode<Smi> { tmp2 },
            TorqueStructArguments {
                TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base }, TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            IntegerLiteral(false, 0x2ull), TNode<Smi> { p_insertCount });
...
TNode<JSArray> GenericArrayToSpliced_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o,
    TNode<Number> p_newLen, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block7.is_used()) {
        ...
        tmp12 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base },
    ...
    if (block13.is_used()) {
        ...
        ca_.Branch(
            tmp18, &block11, std::vector<compiler::Node*> { phi_bb13_10, phi_bb13_11 }, &block12, std::vector<compiler::Node*> { phi_bb13_10, phi_bb13_11 });
    }
...
TF_BUILTIN(ArrayPrototypeToSpliced, CodeStubAssembler)
{
    ...
    if (block12.is_used()) {
        ...
        ca_.Branch(
            tmp34, &block13, std::vector<compiler::Node*> { phi_bb12_12, phi_bb12_13 }, &block14, std::vector<compiler::Node*> { phi_bb12_12, phi_bb12_13 });
    }
    ...
    if (block14.is_used()) {
        ...
        ca_.Branch(
            tmp38, &block17, std::vector<compiler::Node*> { phi_bb14_12, phi_bb14_13 }, &block18, std::vector<compiler::Node*> { phi_bb14_12, phi_bb14_13 });
    }
    ...
    if (block18.is_used()) {
        ...
        tmp39 = TryFastArrayToSpliced_0(state_, TNode<Context> { parameter0 },
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<JSReceiver> { tmp4 }, TNode<Number> { tmp5 }, TNode<Number> { tmp30 }, TNode<Number> { phi_bb3_11 }, TNode<Smi> { phi_bb18_12 },
            TNode<Number> { phi_bb18_13 }, &label40);
    ...
    if (block16.is_used()) {
        ...
        tmp41 = GenericArrayToSpliced_0(state_, TNode<Context> { parameter0 },
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            TNode<JSReceiver> { tmp4 }, TNode<Number> { tmp30 }, TNode<Number> { phi_bb3_11 }, TNode<Number> { phi_bb16_13 });
...
void InsertArgumentsIntoFastPackedArray_FixedArray_JSAny_0(compiler::CodeAssemblerState* state_, TNode<JSArray> p_dst, TNode<Smi> p_dstStart,
    TorqueStructArguments p_args, IntegerLiteral p_argsStart, TNode<Smi> p_insertCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block21.is_used()) {
        ...
        tmp7 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { p_args.frame }, TNode<RawPtrT> { p_args.base },
                                                              TNode<IntPtrT> { p_args.length }, TNode<IntPtrT> { p_args.actual_count } },
            TNode<IntPtrT> { phi_bb21_9 });
...
void InsertArgumentsIntoFastPackedArray_FixedDoubleArray_Number_0(compiler::CodeAssemblerState* state_, TNode<JSArray> p_dst, TNode<Smi> p_dstStart,
    TorqueStructArguments p_args, IntegerLiteral p_argsStart, TNode<Smi> p_insertCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
