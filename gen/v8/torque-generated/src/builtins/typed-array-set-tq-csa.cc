...
TF_BUILTIN(TypedArrayPrototypeSet, CodeStubAssembler)
{
    ...
    if (block23.is_used()) {
        ...
        TypedArrayPrototypeSetArray_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 }, TNode<JSTypedArray> { tmp0 },
            TNode<UintPtrT> { tmp14 }, TNode<Object> { tmp17 }, TNode<UintPtrT> { phi_bb23_8 }, TNode<BoolT> { phi_bb23_7 }, &label20);
    ...
    if (block24.is_used()) {
        ...
        TypedArrayPrototypeSetTypedArray_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 },
            TorqueStructAttachedJSTypedArrayAndLength_0 { TNode<JSTypedArray> { tmp13 }, TNode<UintPtrT> { tmp14 } },
            TorqueStructAttachedJSTypedArrayAndLength_0 { TNode<JSTypedArray> { tmp21 }, TNode<UintPtrT> { tmp22 } }, TNode<UintPtrT> { phi_bb24_8 },
            TNode<BoolT> { phi_bb24_7 }, &label24);
...
void TypedArrayPrototypeSetArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<JSTypedArray> p_target,
    TNode<UintPtrT> p_targetLength, TNode<Object> p_arrayArg, TNode<UintPtrT> p_targetOffset, TNode<BoolT> p_targetOffsetOverflowed,
    compiler::CodeAssemblerLabel* label_IfOffsetOutOfBounds)
{
    compiler::CodeAssembler ca_(state_);
    ...
    if (block22.is_used()) {
        ca_.Bind(&block22);
        tmp16 = CodeStubAssembler(state_).IsElementsKindInRange(
            TNode<Int32T> { tmp13 }, ElementsKind::PACKED_DOUBLE_ELEMENTS, ElementsKind::HOLEY_DOUBLE_ELEMENTS);
    ...
    if (block27.is_used()) {
        ca_.Bind(&block27);
        TypedArrayBuiltinsAssembler(state_).CallCCopyFastNumberJSArrayElementsToTypedArray(
            TNode<Context> { p_context }, TNode<JSArray> { tmp9 }, TNode<JSTypedArray> { tmp17 }, TNode<UintPtrT> { tmp2 }, TNode<UintPtrT> { p_targetOffset });
        ca_.Goto(&block11);
    }
...
void TypedArrayPrototypeSetTypedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver,
    TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedTargetAndLength, TorqueStructAttachedJSTypedArrayAndLength_0 p_attachedSourceAndLength,
    TNode<UintPtrT> p_targetOffset, TNode<BoolT> p_targetOffsetOverflowed, compiler::CodeAssemblerLabel* label_IfOffsetOutOfBounds)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block4.is_used()) {
        ...
        CheckIntegerIndexAdditionOverflow_0(state_, TNode<UintPtrT> { p_attachedSourceAndLength.length }, TNode<UintPtrT> { p_targetOffset },
            TNode<UintPtrT> { p_attachedTargetAndLength.length }, &label0);
        ca_.Goto(&block5);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block6);
    ...
    if (block11.is_used()) {
        ...
        ca_.Branch(tmp12, &block34, std::vector<compiler::Node*> {}, &block35, std::vector<compiler::Node*> {});
    }
    ...
    if (block32.is_used()) {
        ca_.Bind(&block32, &phi_bb32_19);
        ca_.Branch(phi_bb32_19, &block28, std::vector<compiler::Node*> {}, &block29, std::vector<compiler::Node*> {});
    }
    ...
    if (block28.is_used()) {
        ...
        TypedArrayBuiltinsAssembler(state_).CallCRelaxedMemmove(TNode<RawPtrT> { tmp25 }, TNode<RawPtrT> { tmp33 }, TNode<UintPtrT> { tmp18 });
        ca_.Goto(&block33);
    }
    ...
    if (block29.is_used()) {
        ...
        TypedArrayBuiltinsAssembler(state_).CallCMemmove(TNode<RawPtrT> { tmp25 }, TNode<RawPtrT> { tmp34 }, TNode<UintPtrT> { tmp18 });
        ca_.Goto(&block33);
    }
    ...
    if (block35.is_used()) {
        ...
        ca_.Branch(tmp36, &block36, std::vector<compiler::Node*> {}, &block37, std::vector<compiler::Node*> {});
    }
    ...
    if (block37.is_used()) {
        ca_.Bind(&block37);
        TypedArrayBuiltinsAssembler(state_).CallCCopyTypedArrayElementsToTypedArray(TNode<JSTypedArray> { p_attachedSourceAndLength.array },
            TNode<JSTypedArray> { p_attachedTargetAndLength.array }, TNode<UintPtrT> { p_attachedSourceAndLength.length }, TNode<UintPtrT> { p_targetOffset });
        ca_.Goto(&block7);
    }
