...
TNode<Object> TryFastArrayShift_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver,
    compiler::CodeAssemblerLabel* label_Slow, compiler::CodeAssemblerLabel* label_Runtime)
{
    ...
    if (block56.is_used()) {
        ca_.Bind(&block56);
        std::tie(tmp49, tmp50, tmp51) = FieldSliceFixedDoubleArrayValues_0(state_, TNode<FixedDoubleArray> { tmp47 }).Flatten();
    ...
    if (block62.is_used()) {
        ...
        StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp58 }, TNode<IntPtrT> { tmp59 }, TorqueStructUnsafe_0 {} },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp60 }, TNode<Float64T> { tmp61 } });
        ca_.Goto(&block53);
    }
...
TNode<Object> GenericArrayShift_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver)
{
    ...
    if (block2.is_used()) {
        ...
        tmp6 = ca_.CallBuiltin<Object>(Builtin::kSetProperty, p_context, tmp0, tmp4, tmp5);
    ...
    if (block7.is_used()) {
        ...
        tmp18 = ca_.CallBuiltin<Object>(Builtin::kSetProperty, p_context, tmp0, tmp13, tmp17);
    ...
    if (block5.is_used()) {
        ...
        tmp30 = ca_.CallBuiltin<Object>(Builtin::kSetProperty, p_context, tmp0, tmp27, tmp29);
