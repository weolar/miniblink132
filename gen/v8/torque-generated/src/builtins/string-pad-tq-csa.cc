...
TNode<String> StringPad_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TorqueStructArguments p_arguments,
    const char* p_methodName, int31_t p_variant)
{
    compiler::CodeAssembler ca_(state_);
    ...
    if (block14.is_used()) {
        ...
        tmp16 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments { TNode<RawPtrT> { p_arguments.frame }, TNode<RawPtrT> { p_arguments.base },
                                                               TNode<IntPtrT> { p_arguments.length }, TNode<IntPtrT> { p_arguments.actual_count } },
            TNode<IntPtrT> { tmp15 });
    ...
    if (block15.is_used()) {
        ...
        ca_.Branch(
            tmp24, &block24, std::vector<compiler::Node*> { phi_bb15_9, phi_bb15_10 }, &block25, std::vector<compiler::Node*> { phi_bb15_9, phi_bb15_10 });
    }
    ...
    if (block25.is_used()) {
        ...
        ca_.Branch(
            tmp27, &block26, std::vector<compiler::Node*> { phi_bb25_9, phi_bb25_10 }, &block27, std::vector<compiler::Node*> { phi_bb25_9, phi_bb25_10 });
    }
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(
            tmp30, &block32, std::vector<compiler::Node*> { phi_bb27_9, phi_bb27_10 }, &block33, std::vector<compiler::Node*> { phi_bb27_9, phi_bb27_10 });
    }
    ...
    if (block33.is_used()) {
        ...
        ca_.Branch(tmp39, &block35, std::vector<compiler::Node*> { phi_bb33_9, phi_bb33_10 }, &block36,
            std::vector<compiler::Node*> { phi_bb33_9, phi_bb33_10, tmp37 });
    }
    ...
    if (block34.is_used()) {
        ...
        ca_.Branch(tmp44, &block41, std::vector<compiler::Node*> { phi_bb34_9, phi_bb34_10, phi_bb34_13 }, &block42,
            std::vector<compiler::Node*> { phi_bb34_9, phi_bb34_10, phi_bb34_13 });
    }
...
TF_BUILTIN(StringPrototypePadStart, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = StringPad_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 },
            ...
            "String.prototype.padStart", kStringPadStart_0(state_));
...
TF_BUILTIN(StringPrototypePadEnd, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = StringPad_0(state_, TNode<Context> { parameter0 }, TNode<Object> { parameter1 },
            TorqueStructArguments { TNode<RawPtrT> { torque_arguments.frame }, TNode<RawPtrT> { torque_arguments.base },
                TNode<IntPtrT> { torque_arguments.length }, TNode<IntPtrT> { torque_arguments.actual_count } },
            "String.prototype.padEnd", kStringPadEnd_0(state_));
        arguments.PopAndReturn(tmp0);
    }
}
