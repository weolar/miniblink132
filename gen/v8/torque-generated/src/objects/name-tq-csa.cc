...
TNode<Uint32T> kNameEmptyHashField_0(compiler::CodeAssemblerState* state_)
{
    ...
    TNode<Uint32T> tmp4;
    tmp4 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).UpdateWord32<base::BitField<Name::HashFieldType, 0, 2, uint32_t>>(
        ca_.UncheckedCast<Word32T>(tmp2), ca_.UncheckedCast<Uint32T>(tmp3), true));
    TNode<Uint32T> tmp5;
    tmp5 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    TNode<Uint32T> tmp6;
    tmp6 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).UpdateWord32<base::BitField<uint32_t, 2, 24, uint32_t>>(
        ca_.UncheckedCast<Word32T>(tmp4), ca_.UncheckedCast<Uint32T>(tmp5), true));
    TNode<Uint32T> tmp7;
    tmp7 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    TNode<Uint32T> tmp8;
    tmp8 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).UpdateWord32<base::BitField<uint32_t, 26, 6, uint32_t>>(
        ca_.UncheckedCast<Word32T>(tmp6), ca_.UncheckedCast<Uint32T>(tmp7), true));
...
TNode<Uint32T> kArrayIndexLengthBitsShift_0(compiler::CodeAssemblerState* state_)
{
    ...
    ca_.Bind(&block0);
    TNode<Uint32T> tmp0;
    tmp0 = FromConstexpr_uint32_constexpr_int31_0(
        state_, (CodeStubAssembler(state_).ConstexprInt31Add(Name::HashFieldTypeBits::kSize, Name::kArrayIndexValueBits)));
    return TNode<Uint32T> { tmp0 };
}
...
TNode<BoolT> IsIntegerIndex_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_hash)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).DecodeWord32<base::BitField<Name::HashFieldType, 0, 2, uint32_t>>(ca_.UncheckedCast<Word32T>(p_hash)));
...
TNode<Name> DownCastForTorqueClass_Name_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(128), static_cast<InstanceType>(0))));
...
TNode<Symbol> DownCastForTorqueClass_Symbol_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(128), static_cast<InstanceType>(128))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
