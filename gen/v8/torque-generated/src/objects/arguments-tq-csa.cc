...
TNode<SloppyArgumentsElements> Cast_SloppyArgumentsElements_0(
...
TNode<AliasedArgumentsEntry> Cast_AliasedArgumentsEntry_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<JSArgumentsObject> NewJSSloppyArgumentsObject_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<JSFunction> p_callee)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<JSArgumentsObject> NewJSFastAliasedArgumentsObject_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length, TNode<JSFunction> p_callee)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TorqueStructParameterMapIterator_0 NewParameterMapIterator_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_mappedCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block3.is_used()) {
        ...
        tmp7 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).DecodeWord32<base::BitField<VariableAllocationInfo, 7, 2, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp2)));
...
TorqueStructParameterValueIterator_0 NewParameterValueIterator_0(
    compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_mappedCount, TorqueStructArguments p_arguments)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    ca_.Bind(&block2);
    return TorqueStructParameterValueIterator_0 { TNode<IntPtrT> { p_mappedCount },
        TorqueStructArguments { TNode<RawPtrT> { p_arguments.frame }, TNode<RawPtrT> { p_arguments.base }, TNode<IntPtrT> { p_arguments.length },
            TNode<IntPtrT> { p_arguments.actual_count } },
        TNode<IntPtrT> { p_mappedCount } };
}
...
TNode<JSArray> NewAllArguments_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_argumentCount)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp1, tmp2, tmp3, tmp4)
            = CodeStubAssembler(state_).GetFrameArguments(TNode<RawPtrT> { p_frame }, TNode<IntPtrT> { p_argumentCount }).Flatten();
        tmp5 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp6 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructArgumentsIterator_0 {
                TorqueStructArguments { TNode<RawPtrT> { tmp1 }, TNode<RawPtrT> { tmp2 }, TNode<IntPtrT> { tmp3 }, TNode<IntPtrT> { tmp4 } },
                TNode<IntPtrT> { tmp5 } });
...
TNode<FixedArray> NewRestArgumentsElements_0(
    compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_argumentCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block4.is_used()) {
        ...
        std::tie(tmp3, tmp4, tmp5, tmp6)
            = CodeStubAssembler(state_).GetFrameArguments(TNode<RawPtrT> { p_frame }, TNode<IntPtrT> { p_argumentCount }).Flatten();
        tmp7 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { phi_bb4_3 },
            TorqueStructArgumentsIterator_0 {
                TorqueStructArguments { TNode<RawPtrT> { tmp3 }, TNode<RawPtrT> { tmp4 }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp6 } },
                TNode<IntPtrT> { p_formalParameterCount } });
        ca_.Goto(&block6);
    }
...
TNode<FixedArray> NewStrictArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_argumentCount)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2, tmp3)
            = CodeStubAssembler(state_).GetFrameArguments(TNode<RawPtrT> { p_frame }, TNode<IntPtrT> { p_argumentCount }).Flatten();
        tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp5 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructArgumentsIterator_0 {
                TorqueStructArguments { TNode<RawPtrT> { tmp0 }, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp3 } },
                TNode<IntPtrT> { tmp4 } });
        ca_.Goto(&block2);
    }
...
TNode<FixedArray> NewSloppyArgumentsElements_0(
    compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_argumentCount)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block2.is_used()) {
        ...
        tmp7 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructArgumentsIterator_0 {
                TorqueStructArguments { TNode<RawPtrT> { tmp0 }, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp3 } },
                TNode<IntPtrT> { tmp6 } });
    ...
    if (block3.is_used()) {
        ...
        std::tie(tmp9, tmp10, tmp11, tmp12, tmp13, tmp14) = NewParameterValueIterator_0(state_, TNode<IntPtrT> { tmp8 },
            TorqueStructArguments { TNode<RawPtrT> { tmp0 }, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
                TNode<IntPtrT> { tmp3 } }).Flatten();
        tmp15 = NewFixedArray_ParameterValueIterator_0(state_, TNode<IntPtrT> { p_argumentCount },
            TorqueStructParameterValueIterator_0 { TNode<IntPtrT> { tmp9 },
                TorqueStructArguments { TNode<RawPtrT> { tmp10 }, TNode<RawPtrT> { tmp11 }, TNode<IntPtrT> { tmp12 }, TNode<IntPtrT> { tmp13 } },
                TNode<IntPtrT> { tmp14 } });
...
TNode<JSArgumentsObject> NewSloppyArguments_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructFrameWithArgumentsInfo_0 p_info, TNode<JSFunction> p_callee)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block3.is_used()) {
        ...
        tmp10 = NewSloppyArgumentsElements_ParameterMapIterator_0(state_, TNode<Smi> { tmp9 }, TNode<Context> { p_context }, TNode<FixedArray> { tmp2 },
            TorqueStructParameterMapIterator_0 { TNode<IntPtrT> { tmp7 }, TNode<IntPtrT> { tmp8 } });
        tmp11 = Convert_Smi_intptr_0(state_, TNode<IntPtrT> { tmp0 });
        tmp12 = NewJSFastAliasedArgumentsObject_0(
            state_, TNode<Context> { p_context }, TNode<FixedArrayBase> { tmp10 }, TNode<Smi> { tmp11 }, TNode<JSFunction> { p_callee });
...
TNode<JSArray> EmitFastNewRestArguments_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSFunction> p__f)
{
    ...
    if (block0.is_used()) {
        ...
        tmp3 = NewRestArguments_0(
            state_, TNode<Context> { p_context }, TorqueStructFrameWithArgumentsInfo_0 { TNode<RawPtrT> { tmp0 }, TNode<BInt> { tmp1 }, TNode<BInt> { tmp2 } });
        ca_.Goto(&block2);
    }
...
TNode<JSArgumentsObject> EmitFastNewSloppyArguments_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSFunction> p_f)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = GetFrameWithArgumentsInfo_0(state_, TNode<Context> { p_context }).Flatten();
        tmp3 = NewSloppyArguments_0(state_, TNode<Context> { p_context },
            TorqueStructFrameWithArgumentsInfo_0 { TNode<RawPtrT> { tmp0 }, TNode<BInt> { tmp1 }, TNode<BInt> { tmp2 } }, TNode<JSFunction> { p_f });
        ca_.Goto(&block2);
    }
...
TNode<JSArray> NewRestArgumentsFromArguments_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_arguments, TNode<IntPtrT> p_start)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = GetFastPackedElementsJSArrayMap_0(state_, TNode<Context> { p_context });
        tmp1 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT> { p_arguments.length }, TNode<IntPtrT> { p_start });
        tmp2 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT> { tmp1 },
            TorqueStructArgumentsIterator_0 { TorqueStructArguments { TNode<RawPtrT> { p_arguments.frame }, TNode<RawPtrT> { p_arguments.base },
                                                  TNode<IntPtrT> { p_arguments.length }, TNode<IntPtrT> { p_arguments.actual_count } },
                TNode<IntPtrT> { p_start } });
        tmp3 = NewJSArray_0(state_, TNode<Context> { p_context }, TNode<Map> { tmp0 }, TNode<FixedArrayBase> { tmp2 });
        ca_.Goto(&block6);
    }
...
TorqueStructReference_Object_0 AccessSloppyArgumentsCommon_0(
    compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<Object> SloppyArgumentsLoad_0(
    compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<Object> SloppyArgumentsHas_0(
    compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<Object> SloppyArgumentsStore_0(compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, TNode<Object> p_value,
    compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 FieldSliceSloppyArgumentsElementsMappedEntries_0(
    compiler::CodeAssemblerState* state_, TNode<SloppyArgumentsElements> p_o)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp4, tmp5, tmp6)
            = NewMutableSlice_Smi_OR_TheHole_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp3 }, TNode<IntPtrT> { tmp2 }).Flatten();
        ca_.Goto(&block2);
    }

    ca_.Bind(&block2);
    return TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 { TNode<Object> { tmp4 }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp6 },
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=31&c=3
void StoreSloppyArgumentsElementsMappedEntries_0(
    compiler::CodeAssemblerState* state_, TNode<SloppyArgumentsElements> p_o, TNode<IntPtrT> p_i, TNode<Object> p_v)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=5&c=1
TNode<JSArgumentsObject> DownCastForTorqueClass_JSArgumentsObject_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(2118), static_cast<InstanceType>(2118))));
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=27&c=1
TNode<SloppyArgumentsElements> DownCastForTorqueClass_SloppyArgumentsElements_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(219), static_cast<InstanceType>(219))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=41&c=1
TNode<AliasedArgumentsEntry> DownCastForTorqueClass_AliasedArgumentsEntry_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(141), static_cast<InstanceType>(141))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
...
TNode<FixedArray> NewFixedArray_ParameterValueIterator_0(
    compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_length, TorqueStructParameterValueIterator_0 p_it)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block5.is_used()) {
        ...
        InitializeFieldsFromIterator_Object_ParameterValueIterator_0(state_,
            ...
            TorqueStructParameterValueIterator_0 { TNode<IntPtrT> { p_it.mapped_count },
                TorqueStructArguments { TNode<RawPtrT> { p_it.arguments.frame }, TNode<RawPtrT> { p_it.arguments.base },
                    TNode<IntPtrT> { p_it.arguments.length }, TNode<IntPtrT> { p_it.arguments.actual_count } },
...
TNode<SloppyArgumentsElements> NewSloppyArgumentsElements_ParameterMapIterator_0(
    compiler::CodeAssemblerState* state_, TNode<Smi> p_length, TNode<Context> p_context, TNode<FixedArray> p_arguments, TorqueStructParameterMapIterator_0 p_it)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        InitializeFieldsFromIterator_Smi_OR_TheHole_ParameterMapIterator_0(state_,
            ...
            TorqueStructParameterMapIterator_0 { TNode<IntPtrT> { p_it.currentIndex }, TNode<IntPtrT> { p_it.endInterationIndex } });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=31&c=3
TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 NewMutableSlice_Smi_OR_TheHole_0(
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 {
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
        TorqueStructUnsafe_0 {} };
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=37&c=10
void InitializeFieldsFromIterator_Smi_OR_TheHole_ParameterMapIterator_0(compiler::CodeAssemblerState* state_,
    TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 p_target, TorqueStructParameterMapIterator_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=37&c=10
void InitializeFieldsFromIterator_Smi_OR_TheHole_ConstantIterator_TheHole_0(compiler::CodeAssemblerState* state_,
    TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 p_target, TorqueStructConstantIterator_TheHole_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
