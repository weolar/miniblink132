    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_length, compiler::CodeAssemblerLabel* label_Slow)
{
    ...
    if (block6.is_used()) {
        ...
        CodeStubAssembler(state_).FillFixedArrayWithSmiZero(
            ElementsKind::PACKED_SMI_ELEMENTS, TNode<FixedArray> { tmp7 }, TNode<IntPtrT> { tmp8 }, TNode<IntPtrT> { p_length });
    ...
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_a, TNode<Smi> p_index, compiler::CodeAssemblerLabel* label_IfHole)
{
    ...
    if (block11.is_used()) {
        ...
        tmp16 = UnsafeCast_JSReceiver_OR_Undefined_OR_Null_OR_Boolean_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
            state_, TNode<Context> { p_context }, TNode<Object> { tmp15 });
    ...
    compiler::CodeAssemblerState* state_, TNode<FixedArray> p_elements, TNode<IntPtrT> p_dstIndex, TNode<IntPtrT> p_srcIndex, TNode<IntPtrT> p_count)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        CodeStubAssembler(state_).MoveElements(ElementsKind::HOLEY_SMI_ELEMENTS, TNode<FixedArrayBase> { p_elements }, TNode<IntPtrT> { p_dstIndex },
    ...
    compiler::CodeAssemblerState* state_, TNode<FixedArray> p_elements, TNode<IntPtrT> p_dstIndex, TNode<IntPtrT> p_srcIndex, TNode<IntPtrT> p_count)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        CodeStubAssembler(state_).MoveElements(ElementsKind::HOLEY_ELEMENTS, TNode<FixedArrayBase> { p_elements }, TNode<IntPtrT> { p_dstIndex },
            TNode<IntPtrT> { p_srcIndex }, TNode<IntPtrT> { p_count });
        ca_.Goto(&block2);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_elements, TNode<IntPtrT> p_dstIndex, TNode<IntPtrT> p_srcIndex, TNode<IntPtrT> p_count)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        CodeStubAssembler(state_).MoveElements(ElementsKind::HOLEY_DOUBLE_ELEMENTS, TNode<FixedArrayBase> { p_elements }, TNode<IntPtrT> { p_dstIndex },
            TNode<IntPtrT> { p_srcIndex }, TNode<IntPtrT> { p_count });
        ca_.Goto(&block2);
    }
    ...
    TNode<IntPtrT> p_srcIndex, TNode<IntPtrT> p_count)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        CodeStubAssembler(state_).CopyElements(ElementsKind::HOLEY_ELEMENTS, TNode<FixedArrayBase> { p_dstElements }, TNode<IntPtrT> { p_dstIndex },
            TNode<FixedArrayBase> { p_srcElements }, TNode<IntPtrT> { p_srcIndex }, TNode<IntPtrT> { p_count });
        ca_.Goto(&block2);
    }
    ...
    TNode<FixedDoubleArray> p_srcElements, TNode<IntPtrT> p_srcIndex, TNode<IntPtrT> p_count)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        CodeStubAssembler(state_).CopyElements(ElementsKind::HOLEY_DOUBLE_ELEMENTS, TNode<FixedArrayBase> { p_dstElements }, TNode<IntPtrT> { p_dstIndex },
            TNode<FixedArrayBase> { p_srcElements }, TNode<IntPtrT> { p_srcIndex }, TNode<IntPtrT> { p_count });
        ca_.Goto(&block2);
    }
...
TorqueStructFastJSArrayWitness_0 NewFastJSArrayWitness_0(compiler::CodeAssemblerState* state_, TNode<JSArray> p_array)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructFastJSArrayWitness_0 { TNode<JSArray> { p_array }, TNode<JSArray> { p_array }, TNode<Map> { tmp4 }, TNode<BoolT> { tmp5 },
        TNode<BoolT> { tmp6 }, TNode<BoolT> { tmp7 } };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(2120), static_cast<InstanceType>(2120))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
...
TNode<JSArray> DownCastForTorqueClass_JSArray_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(2119), static_cast<InstanceType>(2119))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
