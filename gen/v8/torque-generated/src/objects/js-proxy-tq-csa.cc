...
TNode<JSProxy> DownCastForTorqueClass_JSProxy_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block7.is_used()) {
        ...
        tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, static_cast<InstanceType>(298));
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(298), static_cast<InstanceType>(298))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
