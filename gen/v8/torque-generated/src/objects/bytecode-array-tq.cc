...
class TorqueGeneratedBytecodeArrayAsserts {
    ...
    static_assert(kLengthOffset == BytecodeArray::kLengthOffset, "Values of BytecodeArray::kLengthOffset defined in Torque and C++ do not match");
    static_assert(kWrapperOffset == BytecodeArray::kWrapperOffset, "Values of BytecodeArray::kWrapperOffset defined in Torque and C++ do not match");
    ...
    static_assert(
        kHandlerTableOffset == BytecodeArray::kHandlerTableOffset, "Values of BytecodeArray::kHandlerTableOffset defined in Torque and C++ do not match");
    static_assert(
        kConstantPoolOffset == BytecodeArray::kConstantPoolOffset, "Values of BytecodeArray::kConstantPoolOffset defined in Torque and C++ do not match");
    static_assert(kFrameSizeOffset == BytecodeArray::kFrameSizeOffset, "Values of BytecodeArray::kFrameSizeOffset defined in Torque and C++ do not match");
    static_assert(
        kParameterSizeOffset == BytecodeArray::kParameterSizeOffset, "Values of BytecodeArray::kParameterSizeOffset defined in Torque and C++ do not match");
    static_assert(
        kMaxArgumentsOffset == BytecodeArray::kMaxArgumentsOffset, "Values of BytecodeArray::kMaxArgumentsOffset defined in Torque and C++ do not match");
    ...
    static_assert(kBytesOffset == BytecodeArray::kBytesOffset, "Values of BytecodeArray::kBytesOffset defined in Torque and C++ do not match");
};
...
class TorqueGeneratedBytecodeWrapperAsserts {
    ...
    static_assert(kBytecodeOffset == BytecodeWrapper::kBytecodeOffset, "Values of BytecodeWrapper::kBytecodeOffset defined in Torque and C++ do not match");
