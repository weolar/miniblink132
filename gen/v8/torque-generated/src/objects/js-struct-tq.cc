...
template <> void TorqueGeneratedAlwaysSharedSpaceJSObject<AlwaysSharedSpaceJSObject, JSObject>::AlwaysSharedSpaceJSObjectVerify(Isolate* isolate)
{
...
template <> void TorqueGeneratedJSSharedStruct<JSSharedStruct, AlwaysSharedSpaceJSObject>::JSSharedStructVerify(Isolate* isolate)
{
