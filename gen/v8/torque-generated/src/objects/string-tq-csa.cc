...
TF_BUILTIN(StringSlowFlatten, CodeStubAssembler)
{
    ...
    if (block10.is_used()) {
        ...
        CodeStubAssembler(state_).StringWriteToFlatOneByte(
            TNode<String> { phi_bb10_1 }, TNode<RawPtrT> { tmp23 }, TNode<Int32T> { tmp26 }, TNode<Int32T> { tmp25 });
    ...
    if (block11.is_used()) {
        ...
        CodeStubAssembler(state_).StringWriteToFlatTwoByte(
            TNode<String> { phi_bb11_1 }, TNode<RawPtrT> { tmp36 }, TNode<Int32T> { tmp39 }, TNode<Int32T> { tmp38 });
...
void StaticAssertStringLengthFitsSmi_0(compiler::CodeAssemblerState* state_)
{
    ...
    if (block0.is_used()) {
        ...
        CodeStubAssembler(state_).StaticAssert(TNode<BoolT> { tmp0 },
            "static_assert(kMaxStringLengthFitsSmi) at https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=349&c=3");
        ca_.Goto(&block2);
    }
...
TNode<IntPtrT> AbstractStringIndexOf_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search,
    TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = StringBuiltinsAssembler(state_).SearchOneByteStringInTwoByteString(TNode<RawPtrT> { p_subject }, TNode<IntPtrT> { p_subjectLen },
            TNode<RawPtrT> { p_search }, TNode<IntPtrT> { p_searchLen }, TNode<IntPtrT> { p_fromIndex });
        ca_.Goto(&block2);
    }
...
TNode<IntPtrT> AbstractStringIndexOf_1(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search,
    TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2);
        tmp2 = StringBuiltinsAssembler(state_).SearchOneByteInOneByteString(
            TNode<RawPtrT> { p_subject }, TNode<IntPtrT> { p_subjectLen }, TNode<RawPtrT> { p_search }, TNode<IntPtrT> { p_fromIndex });
        ca_.Goto(&block1, tmp2);
    }
    ...
    if (block3.is_used()) {
        ca_.Bind(&block3);
        tmp3 = StringBuiltinsAssembler(state_).SearchOneByteStringInOneByteString(TNode<RawPtrT> { p_subject }, TNode<IntPtrT> { p_subjectLen },
            TNode<RawPtrT> { p_search }, TNode<IntPtrT> { p_searchLen }, TNode<IntPtrT> { p_fromIndex });
        ca_.Goto(&block1, tmp3);
    }
...
TNode<IntPtrT> AbstractStringIndexOf_2(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search,
    TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = StringBuiltinsAssembler(state_).SearchTwoByteStringInTwoByteString(TNode<RawPtrT> { p_subject }, TNode<IntPtrT> { p_subjectLen },
            TNode<RawPtrT> { p_search }, TNode<IntPtrT> { p_searchLen }, TNode<IntPtrT> { p_fromIndex });
        ca_.Goto(&block2);
    }
...
TNode<IntPtrT> AbstractStringIndexOf_3(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_subject, TNode<IntPtrT> p_subjectLen, TNode<RawPtrT> p_search,
    TNode<IntPtrT> p_searchLen, TNode<IntPtrT> p_fromIndex)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = StringBuiltinsAssembler(state_).SearchTwoByteStringInOneByteString(TNode<RawPtrT> { p_subject }, TNode<IntPtrT> { p_subjectLen },
            TNode<RawPtrT> { p_search }, TNode<IntPtrT> { p_searchLen }, TNode<IntPtrT> { p_fromIndex });
        ca_.Goto(&block2);
    }
...
TNode<Smi> AbstractStringIndexOf_4(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<String> p_string, TNode<String> p_searchString, TNode<Smi> p_fromIndex)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block8.is_used()) {
        ca_.Bind(&block8);
        tmp11 = TwoStringsToSlices_Smi_AbstractStringIndexOfFunctor_0(
            state_, TNode<String> { p_string }, TNode<String> { p_searchString }, TorqueStructAbstractStringIndexOfFunctor_0 { TNode<Smi> { p_fromIndex } });
...
TF_BUILTIN(StringIndexOf, CodeStubAssembler)
{
    ...
    if (block8.is_used()) {
        ca_.Bind(&block8);
        tmp13 = TwoStringsToSlices_Smi_AbstractStringIndexOfFunctor_0(
            state_, TNode<String> { parameter0 }, TNode<String> { parameter1 }, TorqueStructAbstractStringIndexOfFunctor_0 { TNode<Smi> { tmp1 } });
...
TNode<BoolT> Method_String_IsOneByteRepresentationUnderneath_0(compiler::CodeAssemblerState* state_, TNode<String> p_this)
{
    ...
    compiler::CodeAssemblerParameterizedLabel<String, String> block16(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<String, String> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<String, String> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<String, String> block23(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block8.is_used()) {
        ...
        ca_.Goto(&block15, phi_bb8_1, phi_bb8_2);
        if (label4.is_used()) {
            ca_.Bind(&label4);
            ca_.Goto(&block16, phi_bb8_1, phi_bb8_2);
        }
    }
    ...
    if (block7.is_used()) {
        ...
        tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
        tmp6 = CodeStubAssembler(state_).LoadReference<String>(CodeStubAssembler::Reference { tmp1, tmp5 });
        ca_.Goto(&block5, tmp6, phi_bb7_2);
    }

    TNode<String> phi_bb16_1;
    TNode<String> phi_bb16_2;
    TNode<SlicedString> tmp7;
    if (block16.is_used()) {
        ca_.Bind(&block16, &phi_bb16_1, &phi_bb16_2);
        compiler::CodeAssemblerLabel label8(&ca_);
        tmp7 = Cast_SlicedString_1(state_, TNode<String> { ca_.UncheckedCast<String>(phi_bb16_2) }, &label8);
        ca_.Goto(&block23, phi_bb16_1, phi_bb16_2);
        if (label8.is_used()) {
            ca_.Bind(&label8);
            ca_.Goto(&block24, phi_bb16_1, phi_bb16_2);
        }
    }
...
TorqueStructSlice_char16_ConstReference_char16_0 FieldSliceSeqTwoByteStringChars_0(compiler::CodeAssemblerState* state_, TNode<SeqTwoByteString> p_o)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp4 }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp6 },
...
TorqueStructSlice_char8_ConstReference_char8_0 Subslice_char8_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_ConstReference_char8_0 p_slice,
    TNode<IntPtrT> p_start, TNode<IntPtrT> p_length, compiler::CodeAssemblerLabel* label_OutOfBounds)
{
    ...
    if (block6.is_used()) {
        ...
        std::tie(tmp9, tmp10, tmp11)
            = NewConstSlice_char8_0(state_, TNode<Object> { p_slice.object }, TNode<IntPtrT> { tmp8 }, TNode<IntPtrT> { p_length }).Flatten();
        ca_.Goto(&block7);
    }
    ...
    ca_.Bind(&block7);
    return TorqueStructSlice_char8_ConstReference_char8_0 { TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp11 },
        TorqueStructUnsafe_0 {} };
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=292&c=22
TorqueStructSlice_char16_ConstReference_char16_0 Subslice_char16_0(compiler::CodeAssemblerState* state_,
    TorqueStructSlice_char16_ConstReference_char16_0 p_slice, TNode<IntPtrT> p_start, TNode<IntPtrT> p_length, compiler::CodeAssemblerLabel* label_OutOfBounds)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block6.is_used()) {
        ...
        tmp8 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT> { p_slice.offset }, TNode<IntPtrT> { tmp7 });
        std::tie(tmp9, tmp10, tmp11)
            = NewConstSlice_char16_0(state_, TNode<Object> { p_slice.object }, TNode<IntPtrT> { tmp8 }, TNode<IntPtrT> { p_length }).Flatten();
        ca_.Goto(&block7);
    }
    ...
    ca_.Bind(&block7);
    return TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp11 },
        TorqueStructUnsafe_0 {} };
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=305&c=22
TorqueStructSlice_char8_ConstReference_char8_0 NewOffHeapConstSlice_char8_0(
    compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_startPointer, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ...
        tmp1 = Convert_WasmCodePointer_RawPtr_char8_0(state_, TNode<RawPtrT> { p_startPointer });
        ...
        std::tie(tmp5, tmp6, tmp7) = (TorqueStructSlice_char8_ConstReference_char8_0 {
...
TorqueStructSlice_char16_ConstReference_char16_0 NewOffHeapConstSlice_char16_0(
    compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_startPointer, TNode<IntPtrT> p_length)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = kZeroBitPattern_0(state_);
        tmp1 = Convert_WasmCodePointer_RawPtr_char16_0(state_, TNode<RawPtrT> { p_startPointer });
        tmp2 = Convert_intptr_WasmCodePointer_0(state_, TNode<RawPtrT> { tmp1 });
        tmp3 = FromConstexpr_intptr_constexpr_int31_0(state_, kHeapObjectTag);
        tmp4 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp3 });
        std::tie(tmp5, tmp6, tmp7) = (TorqueStructSlice_char16_ConstReference_char16_0 {
                                          TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp4 }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_char16_ConstReference_char16_0 { TNode<Object> { tmp5 }, TNode<IntPtrT> { tmp6 }, TNode<IntPtrT> { tmp7 },
        TorqueStructUnsafe_0 {} };
}
...
TNode<String> DownCastForTorqueClass_String_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(127), static_cast<InstanceType>(0))));
...
TNode<SeqOneByteString> AllocateNonEmptySeqOneByteString_UninitializedIterator_0(
    compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructUninitializedIterator_0 p_content)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp13 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
        InitializeFieldsFromIterator_char8_UninitializedIterator_0(state_,
            TorqueStructSlice_char8_MutableReference_char8_0 {
                TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp13 }, TNode<IntPtrT> { tmp3 }, TorqueStructUnsafe_0 {} },
            TorqueStructUninitializedIterator_0 {});
...
TNode<SeqTwoByteString> AllocateNonEmptySeqTwoByteString_UninitializedIterator_0(
    compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructUninitializedIterator_0 p_content)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    TNode<IntPtrT> tmp12;
    TNode<IntPtrT> tmp13;
    TNode<SeqTwoByteString> tmp14;
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = kSeqTwoByteStringMap_0(state_);
        tmp1 = kNameEmptyHashField_0(state_);
        tmp2 = CodeStubAssembler(state_).Signed(TNode<Uint32T> { p_length });
        tmp3 = Convert_intptr_int32_0(state_, TNode<Int32T> { tmp2 });
        tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
        ...
        CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference { tmp9, tmp12 }, tmp2);
        tmp13 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
        InitializeFieldsFromIterator_char16_UninitializedIterator_0(state_,
            TorqueStructSlice_char16_MutableReference_char16_0 {
                TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp13 }, TNode<IntPtrT> { tmp3 }, TorqueStructUnsafe_0 {} },
            TorqueStructUninitializedIterator_0 {});
        tmp14 = TORQUE_CAST(TNode<HeapObject> { tmp9 });
        ca_.Goto(&block9);
...
TNode<String> AllocateSeqOneByteString_UninitializedIterator_0(
    compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructUninitializedIterator_0 p_content)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<String> AllocateSeqTwoByteString_UninitializedIterator_0(
    compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructUninitializedIterator_0 p_content)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<Smi> TwoStringsToSlices_Smi_AbstractStringIndexOfFunctor_0(
    compiler::CodeAssemblerState* state_, TNode<String> p_s1, TNode<String> p_s2, TorqueStructAbstractStringIndexOfFunctor_0 p_f)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, String> block63(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, String> block62(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block67(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block66(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block75(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block74(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block95(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block94(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block103(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block102(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, String> block114(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, String> block113(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block118(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block117(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block126(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block125(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block146(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block145(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block154(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, String, IntPtrT, String, IntPtrT> block153(
        &ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block11.is_used()) {
        ...
        std::tie(tmp12, tmp13, tmp14) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp11 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb11_6 }, TNode<IntPtrT> { tmp3 }, &label15)
                                            .Flatten();
    ...
    if (block19.is_used()) {
        ...
        std::tie(tmp21, tmp22, tmp23) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp18 }, TNode<IntPtrT> { tmp19 }, TNode<IntPtrT> { tmp20 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb19_6 }, TNode<IntPtrT> { tmp3 }, &label24)
                                            .Flatten();
    ...
    if (block39.is_used()) {
        ...
        std::tie(tmp49, tmp50, tmp51) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp46 }, TNode<IntPtrT> { tmp47 }, TNode<IntPtrT> { tmp48 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb39_6 }, TNode<IntPtrT> { tmp3 }, &label52)
                                            .Flatten();
    ...
    if (block47.is_used()) {
        ...
        std::tie(tmp60, tmp61, tmp62) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp57 }, TNode<IntPtrT> { tmp58 }, TNode<IntPtrT> { tmp59 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb47_6 }, TNode<IntPtrT> { tmp3 }, &label63)
                                            .Flatten();
    ...
    if (block59.is_used()) {
        ...
        ca_.Branch(tmp68, &block57, std::vector<compiler::Node*> { phi_bb59_3, phi_bb59_4, phi_bb59_5, phi_bb59_8, phi_bb59_9 }, &block58,
            std::vector<compiler::Node*> { phi_bb59_3, phi_bb59_4, phi_bb59_5, phi_bb59_8, phi_bb59_9 });
    }
    ...
    if (block62.is_used()) {
        ...
        std::tie(tmp76, tmp77, tmp78) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp73 }, TNode<IntPtrT> { tmp74 }, TNode<IntPtrT> { tmp75 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb62_9 }, TNode<IntPtrT> { tmp67 }, &label79)
                                            .Flatten();
    ...
    if (block70.is_used()) {
        ...
        std::tie(tmp85, tmp86, tmp87) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp82 }, TNode<IntPtrT> { tmp83 }, TNode<IntPtrT> { tmp84 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb70_9 }, TNode<IntPtrT> { tmp67 }, &label88)
                                            .Flatten();
    ...
    if (block90.is_used()) {
        ...
        std::tie(tmp113, tmp114, tmp115) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp110 }, TNode<IntPtrT> { tmp111 }, TNode<IntPtrT> { tmp112 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb90_9 }, TNode<IntPtrT> { tmp67 }, &label116)
                                               .Flatten();
    ...
    if (block98.is_used()) {
        ...
        std::tie(tmp124, tmp125, tmp126) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp121 }, TNode<IntPtrT> { tmp122 }, TNode<IntPtrT> { tmp123 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb98_9 }, TNode<IntPtrT> { tmp67 }, &label127)
                                               .Flatten();
    ...
    if (block56.is_used()) {
        ...
        tmp128 = Call_char8_char8_1(state_, TorqueStructAbstractStringIndexOfFunctor_0 { TNode<Smi> { p_f.fromIndex } },
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { phi_bb56_3 }, TNode<IntPtrT> { phi_bb56_4 }, TNode<IntPtrT> { phi_bb56_5 }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char8_ConstReference_char8_0 {
    ...
    if (block54.is_used()) {
        ...
        tmp129 = Call_char8_char16_1(state_, TorqueStructAbstractStringIndexOfFunctor_0 { TNode<Smi> { p_f.fromIndex } },
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { phi_bb54_3 }, TNode<IntPtrT> { phi_bb54_4 }, TNode<IntPtrT> { phi_bb54_5 }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { phi_bb54_6 }, TNode<IntPtrT> { phi_bb54_7 }, TNode<IntPtrT> { phi_bb54_8 }, TorqueStructUnsafe_0 {} });
    ...
    if (block110.is_used()) {
        ...
        ca_.Branch(tmp134, &block108, std::vector<compiler::Node*> { phi_bb110_3, phi_bb110_4, phi_bb110_5, phi_bb110_8, phi_bb110_9 }, &block109,
            std::vector<compiler::Node*> { phi_bb110_3, phi_bb110_4, phi_bb110_5, phi_bb110_8, phi_bb110_9 });
    }
    ...
    if (block113.is_used()) {
        ...
        std::tie(tmp142, tmp143, tmp144) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp139 }, TNode<IntPtrT> { tmp140 }, TNode<IntPtrT> { tmp141 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb113_9 }, TNode<IntPtrT> { tmp133 }, &label145)
                                               .Flatten();
    ...
    if (block121.is_used()) {
        ...
        std::tie(tmp151, tmp152, tmp153) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp148 }, TNode<IntPtrT> { tmp149 }, TNode<IntPtrT> { tmp150 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb121_9 }, TNode<IntPtrT> { tmp133 }, &label154)
                                               .Flatten();
    ...
    if (block141.is_used()) {
        ...
        std::tie(tmp179, tmp180, tmp181) = Subslice_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { tmp176 }, TNode<IntPtrT> { tmp177 }, TNode<IntPtrT> { tmp178 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb141_9 }, TNode<IntPtrT> { tmp133 }, &label182)
                                               .Flatten();
    ...
    if (block149.is_used()) {
        ...
        std::tie(tmp190, tmp191, tmp192) = Subslice_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { tmp187 }, TNode<IntPtrT> { tmp188 }, TNode<IntPtrT> { tmp189 }, TorqueStructUnsafe_0 {} },
            TNode<IntPtrT> { phi_bb149_9 }, TNode<IntPtrT> { tmp133 }, &label193)
                                               .Flatten();
    ...
    if (block107.is_used()) {
        ...
        tmp194 = Call_char16_char8_1(state_, TorqueStructAbstractStringIndexOfFunctor_0 { TNode<Smi> { p_f.fromIndex } },
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { phi_bb107_3 }, TNode<IntPtrT> { phi_bb107_4 }, TNode<IntPtrT> { phi_bb107_5 }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char8_ConstReference_char8_0 {
    ...
    if (block105.is_used()) {
        ...
        tmp195 = Call_char16_char16_1(state_, TorqueStructAbstractStringIndexOfFunctor_0 { TNode<Smi> { p_f.fromIndex } },
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { phi_bb105_3 }, TNode<IntPtrT> { phi_bb105_4 }, TNode<IntPtrT> { phi_bb105_5 }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { phi_bb105_6 }, TNode<IntPtrT> { phi_bb105_7 }, TNode<IntPtrT> { phi_bb105_8 }, TorqueStructUnsafe_0 {} });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=141&c=9
TorqueStructSlice_char8_ConstReference_char8_0 NewConstSlice_char8_0(
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_char8_ConstReference_char8_0 {
...
TNode<BoolT> Call_char8_char8_0(compiler::CodeAssemblerState* state_, TorqueStructIsSubstringAtFunctor_0 p_self,
    TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp0 = IsSubstringAt_char8_char8_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { p_string.object }, TNode<IntPtrT> { p_string.offset }, TNode<IntPtrT> { p_string.length }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char8_ConstReference_char8_0 {
...
TNode<BoolT> Call_char8_char16_0(compiler::CodeAssemblerState* state_, TorqueStructIsSubstringAtFunctor_0 p_self,
    TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char16_ConstReference_char16_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = IsSubstringAt_char8_char16_0(state_,
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { p_string.object }, TNode<IntPtrT> { p_string.offset }, TNode<IntPtrT> { p_string.length }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { p_searchStr.object }, TNode<IntPtrT> { p_searchStr.offset }, TNode<IntPtrT> { p_searchStr.length }, TorqueStructUnsafe_0 {} },
...
TNode<BoolT> Call_char16_char8_0(compiler::CodeAssemblerState* state_, TorqueStructIsSubstringAtFunctor_0 p_self,
    TorqueStructSlice_char16_ConstReference_char16_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = IsSubstringAt_char16_char8_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { p_string.object }, TNode<IntPtrT> { p_string.offset }, TNode<IntPtrT> { p_string.length }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char8_ConstReference_char8_0 {
                TNode<Object> { p_searchStr.object }, TNode<IntPtrT> { p_searchStr.offset }, TNode<IntPtrT> { p_searchStr.length }, TorqueStructUnsafe_0 {} },
...
TNode<BoolT> Call_char16_char16_0(compiler::CodeAssemblerState* state_, TorqueStructIsSubstringAtFunctor_0 p_self,
    TorqueStructSlice_char16_ConstReference_char16_0 p_string, TorqueStructSlice_char16_ConstReference_char16_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = IsSubstringAt_char16_char16_0(state_,
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { p_string.object }, TNode<IntPtrT> { p_string.offset }, TNode<IntPtrT> { p_string.length }, TorqueStructUnsafe_0 {} },
            TorqueStructSlice_char16_ConstReference_char16_0 {
                TNode<Object> { p_searchStr.object }, TNode<IntPtrT> { p_searchStr.offset }, TNode<IntPtrT> { p_searchStr.length }, TorqueStructUnsafe_0 {} },
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=331&c=14
TNode<Smi> Call_char8_char8_1(compiler::CodeAssemblerState* state_, TorqueStructAbstractStringIndexOfFunctor_0 p_self,
    TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ...
        tmp5 = AbstractStringIndexOf_1(state_, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { p_string.length }, TNode<RawPtrT> { tmp3 },
            TNode<IntPtrT> { p_searchStr.length }, TNode<IntPtrT> { tmp4 });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=333&c=14
TNode<Smi> Call_char8_char16_1(compiler::CodeAssemblerState* state_, TorqueStructAbstractStringIndexOfFunctor_0 p_self,
    TorqueStructSlice_char8_ConstReference_char8_0 p_string, TorqueStructSlice_char16_ConstReference_char16_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ...
        tmp3 = (TNode<RawPtrT> { tmp2 });
        tmp4 = Convert_intptr_Smi_0(state_, TNode<Smi> { p_self.fromIndex });
        tmp5 = AbstractStringIndexOf_3(state_, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { p_string.length }, TNode<RawPtrT> { tmp3 },
            TNode<IntPtrT> { p_searchStr.length }, TNode<IntPtrT> { tmp4 });
        tmp6 = Convert_Smi_intptr_0(state_, TNode<IntPtrT> { tmp5 });
        ca_.Goto(&block4);
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=339&c=14
TNode<Smi> Call_char16_char8_1(compiler::CodeAssemblerState* state_, TorqueStructAbstractStringIndexOfFunctor_0 p_self,
    TorqueStructSlice_char16_ConstReference_char16_0 p_string, TorqueStructSlice_char8_ConstReference_char8_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ...
        tmp3 = (TNode<RawPtrT> { tmp2 });
        tmp4 = Convert_intptr_Smi_0(state_, TNode<Smi> { p_self.fromIndex });
        tmp5 = AbstractStringIndexOf_0(state_, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { p_string.length }, TNode<RawPtrT> { tmp3 },
            TNode<IntPtrT> { p_searchStr.length }, TNode<IntPtrT> { tmp4 });
        tmp6 = Convert_Smi_intptr_0(state_, TNode<IntPtrT> { tmp5 });
        ca_.Goto(&block4);
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=341&c=14
TNode<Smi> Call_char16_char16_1(compiler::CodeAssemblerState* state_, TorqueStructAbstractStringIndexOfFunctor_0 p_self,
    TorqueStructSlice_char16_ConstReference_char16_0 p_string, TorqueStructSlice_char16_ConstReference_char16_0 p_searchStr)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ...
        tmp3 = (TNode<RawPtrT> { tmp2 });
        tmp4 = Convert_intptr_Smi_0(state_, TNode<Smi> { p_self.fromIndex });
        tmp5 = AbstractStringIndexOf_2(state_, TNode<RawPtrT> { tmp1 }, TNode<IntPtrT> { p_string.length }, TNode<RawPtrT> { tmp3 },
            TNode<IntPtrT> { p_searchStr.length }, TNode<IntPtrT> { tmp4 });
        tmp6 = Convert_Smi_intptr_0(state_, TNode<IntPtrT> { tmp5 });
        ca_.Goto(&block4);
    }
...
TNode<SeqTwoByteString> AllocateNonEmptySeqTwoByteString_SliceIterator_char16_ConstReference_char16_0(
    compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TorqueStructSliceIterator_char16_ConstReference_char16_0 p_content)
{
    ...
    if (block0.is_used()) {
        ...
        CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference { tmp9, tmp12 }, tmp2);
        tmp13 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
        InitializeFieldsFromIterator_char16_SliceIterator_char16_ConstReference_char16_0(state_,
            TorqueStructSlice_char16_MutableReference_char16_0 {
                TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp13 }, TNode<IntPtrT> { tmp3 }, TorqueStructUnsafe_0 {} },
            TorqueStructSliceIterator_char16_ConstReference_char16_0 {
...
void InitializeFieldsFromIterator_char8_TwoByteToOneByteIterator_0(
    compiler::CodeAssemblerState* state_, TorqueStructSlice_char8_MutableReference_char8_0 p_target, TorqueStructTwoByteToOneByteIterator_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/string.tq?l=170&c=10
void InitializeFieldsFromIterator_char8_SliceIterator_char8_ConstReference_char8_0(compiler::CodeAssemblerState* state_,
    TorqueStructSlice_char8_MutableReference_char8_0 p_target, TorqueStructSliceIterator_char8_ConstReference_char8_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void InitializeFieldsFromIterator_char16_SliceIterator_char16_ConstReference_char16_0(compiler::CodeAssemblerState* state_,
    TorqueStructSlice_char16_MutableReference_char16_0 p_target, TorqueStructSliceIterator_char16_ConstReference_char16_0 p_originIterator)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
