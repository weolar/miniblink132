...
class TorqueGeneratedObjectBoilerplateDescriptionAsserts {
    ...
    static_assert(kBackingStoreSizeOffset == offsetof(ObjectBoilerplateDescription, backing_store_size_),
        "Value of ObjectBoilerplateDescription::kBackingStoreSizeOffset defined in Torque and offset of field ObjectBoilerplateDescription::backing_store_size "
        "in C++ do not match");
    ...
    static_assert(kRawEntriesOffset == OFFSET_OF_DATA_START(ObjectBoilerplateDescription),
        "Value of ObjectBoilerplateDescription::kRawEntriesOffset defined in Torque and offset of field ObjectBoilerplateDescription::raw_entries in C++ do "
        "not match");
};
...
class TorqueGeneratedRegExpBoilerplateDescriptionAsserts {
    ...
    static_assert(
        kDataOffset == RegExpBoilerplateDescription::kDataOffset, "Values of RegExpBoilerplateDescription::kDataOffset defined in Torque and C++ do not match");
