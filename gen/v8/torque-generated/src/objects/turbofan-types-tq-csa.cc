...
TNode<BoolT> TestTurbofanBitsetType_0(compiler::CodeAssemblerState* state_, TNode<Object> p_value, TNode<Uint32T> p_bitsetLow, TNode<Uint32T> p_bitsetHigh)
{
    ...
    if (block21.is_used()) {
        ca_.Bind(&block21);
        tmp19
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 10, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block30.is_used()) {
        ca_.Bind(&block30);
        tmp28
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 12, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block47.is_used()) {
        ca_.Bind(&block47);
        tmp41
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 13, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block54.is_used()) {
        ca_.Bind(&block54);
        tmp46
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 14, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block60.is_used()) {
        ca_.Bind(&block60);
        tmp53
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 18, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block61.is_used()) {
        ca_.Bind(&block61);
        tmp54
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 19, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block73.is_used()) {
        ca_.Bind(&block73);
        tmp62
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 21, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block74.is_used()) {
        ca_.Bind(&block74);
        tmp63
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 20, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block78.is_used()) {
        ca_.Bind(&block78);
        tmp66
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 22, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block82.is_used()) {
        ca_.Bind(&block82);
        tmp69
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 1, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetHigh)));
    ...
    if (block86.is_used()) {
        ca_.Bind(&block86);
        tmp72
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 25, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block120.is_used()) {
        ca_.Bind(&block120);
        tmp76
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 29, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block125.is_used()) {
        ca_.Bind(&block125);
        tmp83
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 26, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block131.is_used()) {
        ca_.Bind(&block131);
        tmp89
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 27, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block143.is_used()) {
        ca_.Bind(&block143);
        tmp99
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 28, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block148.is_used()) {
        ca_.Bind(&block148);
        tmp103 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    ...
    if (block156.is_used()) {
        ...
        tmp107 = Cast_String_0(state_, TNode<HeapObject> { tmp105 }, &label108);
        ca_.Goto(&block158);
        if (label108.is_used()) {
            ca_.Bind(&label108);
            ca_.Goto(&block159);
    ...
    if (block154.is_used()) {
        ...
        ca_.Goto(&block152, tmp110);
    }

    TNode<BoolT> phi_bb152_8;
    if (block152.is_used()) {
        ca_.Bind(&block152, &phi_bb152_8);
        ca_.Branch(phi_bb152_8, &block150, std::vector<compiler::Node*> {}, &block151, std::vector<compiler::Node*> {});
    }
    ...
    if (block150.is_used()) {
        ca_.Bind(&block150);
        tmp111
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 2, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetHigh)));
    ...
    if (block151.is_used()) {
        ca_.Bind(&block151);
        tmp112
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 16, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block165.is_used()) {
        ca_.Bind(&block165);
        tmp118
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 17, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block168.is_used()) {
        ca_.Bind(&block168);
        tmp123
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 15, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    if (block178.is_used()) {
        ca_.Bind(&block178);
        tmp126
            = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 30, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(p_bitsetLow)));
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block0.is_used()) {
        ...
        if (((CodeStubAssembler(state_).ConstexprInt31Equal(static_cast<InstanceType>(239), static_cast<InstanceType>(243))))) {
            ca_.Goto(&block3);
        } else {
            ca_.Goto(&block4);
        }
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(243), static_cast<InstanceType>(239))));
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(239), static_cast<InstanceType>(239))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(243), static_cast<InstanceType>(243))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(242), static_cast<InstanceType>(242))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(240), static_cast<InstanceType>(240))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4);
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(241), static_cast<InstanceType>(241))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
        tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference { tmp1, tmp9 });
        tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T> { tmp10 });
        tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T> { tmp11 });
