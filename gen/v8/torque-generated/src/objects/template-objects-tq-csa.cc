...
TNode<TemplateObjectDescription> Cast_TemplateObjectDescription_0(
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/template-objects.tq?l=5&c=1
TNode<TemplateObjectDescription> DownCastForTorqueClass_TemplateObjectDescription_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(172), static_cast<InstanceType>(172))));
