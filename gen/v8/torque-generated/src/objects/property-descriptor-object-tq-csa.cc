    ...
    compiler::CodeAssemblerState* state_, TNode<BoolT> p__extensible, TNode<PropertyDescriptorObject> p_newDesc, TNode<PropertyDescriptorObject> p_current)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = Method_PropertyDescriptorObject_IsEmptyOrEquivalentTo_0(
            state_, TNode<PropertyDescriptorObject> { p_newDesc }, TNode<PropertyDescriptorObject> { p_current });
    ...
    if (block3.is_used()) {
        ...
        tmp4 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 3, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp3))));
    ...
    if (block4.is_used()) {
        ...
        tmp8 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 4, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp7))));
    ...
    if (block8.is_used()) {
        ...
        tmp11 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 3, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp10))));
    ...
    if (block7.is_used()) {
        ...
        tmp16 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 2, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp15))));
    ...
    if (block13.is_used()) {
        ...
        tmp20 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 1, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp19))));
        ...
        tmp23 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 1, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp22))));
    ...
    if (block21.is_used()) {
        ...
        tmp36 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 8, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp35))));
    ...
    if (block25.is_used()) {
        ...
        tmp47 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 9, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp46))));
    ...
    if (block22.is_used()) {
        ...
        tmp58 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 5, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp57))));
    ...
    if (block34.is_used()) {
        ...
        tmp62 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 5, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp61))));
    ...
    if (block37.is_used()) {
        ...
        tmp66 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 7, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp65))));
    ...
    compiler::CodeAssemblerState* state_, TNode<BoolT> p_extensible, TNode<HeapObject> p_newDesc, TNode<PropertyDescriptorObject> p_current)
{
    ...
    if (block5.is_used()) {
        ca_.Bind(&block5);
        tmp2 = IsCompatiblePropertyDescriptor_0(state_, TNode<BoolT> { p_extensible },
            TNode<PropertyDescriptorObject> { ca_.UncheckedCast<PropertyDescriptorObject>(p_newDesc) }, TNode<PropertyDescriptorObject> { p_current });
    ...
    compiler::CodeAssemblerState* state_, TNode<BoolT> p_extensible, TNode<HeapObject> p_newDesc, TNode<HeapObject> p_current)
{
    ...
    if (block5.is_used()) {
        ca_.Bind(&block5);
        tmp2 = IsCompatiblePropertyDescriptor_1(state_, TNode<BoolT> { p_extensible }, TNode<HeapObject> { p_newDesc },
            TNode<PropertyDescriptorObject> { ca_.UncheckedCast<PropertyDescriptorObject>(p_current) });
        ca_.Goto(&block1, tmp2);
    }
...
void CompletePropertyDescriptor_0(compiler::CodeAssemblerState* state_, TNode<PropertyDescriptorObject> p_desc)
{
    ...
    if (block2.is_used()) {
        ...
        tmp4 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 7, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp3))));
        tmp5 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT> { tmp4 });
    ...
    if (block5.is_used()) {
        ...
        tmp9 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 7, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp7)), ca_.UncheckedCast<Uint32T>(tmp8))));
    ...
    if (block6.is_used()) {
        ...
        tmp14 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 6, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp13))));
    ...
    if (block7.is_used()) {
        ...
        tmp19 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 6, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp17)), ca_.UncheckedCast<Uint32T>(tmp18))));
        ...
        tmp23 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 5, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp21)), ca_.UncheckedCast<Uint32T>(tmp22))));
    ...
    if (block3.is_used()) {
        ...
        tmp26 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 8, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp25))));
    ...
    if (block9.is_used()) {
        ...
        tmp31 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 8, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp29)), ca_.UncheckedCast<Uint32T>(tmp30))));
    ...
    if (block10.is_used()) {
        ...
        tmp36 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 9, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp35))));
    ...
    if (block11.is_used()) {
        ...
        tmp41 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 9, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp39)), ca_.UncheckedCast<Uint32T>(tmp40))));
    ...
    if (block4.is_used()) {
        ...
        tmp46 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 2, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp45))));
    ...
    if (block13.is_used()) {
        ...
        tmp51 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 2, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp49)), ca_.UncheckedCast<Uint32T>(tmp50))));
        ...
        tmp54 = FromConstexpr_bool_constexpr_bool_0(state_, false);
        tmp55 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 1, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp53)), ca_.UncheckedCast<Uint32T>(tmp54))));
    ...
    if (block14.is_used()) {
        ...
        tmp58 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 4, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp57))));
        tmp59 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT> { tmp58 });
    ...
    if (block15.is_used()) {
        ...
        tmp63 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 4, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp61)), ca_.UncheckedCast<Uint32T>(tmp62))));
        ...
        tmp67 = ca_.UncheckedCast<Smi>(ca_.BitcastWordToTaggedSigned(CodeStubAssembler(state_).UpdateWord32InWord<base::BitField<bool, 3, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp65)), ca_.UncheckedCast<Uint32T>(tmp66))));
...
TNode<BoolT> Method_PropertyDescriptorObject_IsDataDescriptor_0(compiler::CodeAssemblerState* state_, TNode<PropertyDescriptorObject> p_this)
{
    ...
    if (block0.is_used()) {
        ...
        tmp2 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 7, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp1))));
    ...
    if (block3.is_used()) {
        ...
        tmp6 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 6, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp5))));
...
TNode<BoolT> Method_PropertyDescriptorObject_IsAccessorDescriptor_0(compiler::CodeAssemblerState* state_, TNode<PropertyDescriptorObject> p_this)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp1 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_this, tmp0 });
        tmp2 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 8, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp1))));
        ca_.Branch(tmp2, &block2, std::vector<compiler::Node*> {}, &block3, std::vector<compiler::Node*> {});
    }
    ...
    if (block3.is_used()) {
        ...
        tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp5 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_this, tmp4 });
        tmp6 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 9, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp5))));
        ca_.Goto(&block4, tmp6);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<PropertyDescriptorObject> p_this, TNode<PropertyDescriptorObject> p_current)
{
    ...
    if (block0.is_used()) {
        ...
        tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp1 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_this, tmp0 });
        tmp2 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 2, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp1))));
    ...
    if (block3.is_used()) {
        ...
        tmp7 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 1, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp6))));
        ...
        tmp10 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 1, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp9))));
    ...
    if (block5.is_used()) {
        ...
        tmp14 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 4, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp13))));
        tmp15 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT> { tmp14 });
    ...
    if (block9.is_used()) {
        ...
        tmp19 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 3, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp18))));
        tmp20 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp21 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_current, tmp20 });
        tmp22 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 3, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp21))));
    ...
    if (block11.is_used()) {
        ...
        tmp27 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 7, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp26))));
    ...
    if (block17.is_used()) {
        ...
        tmp38 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 6, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp37))));
    ...
    if (block21.is_used()) {
        ...
        tmp43 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 5, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp42))));
        tmp44 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp45 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference { p_current, tmp44 });
        tmp46 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 5, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp45))));
    ...
    if (block23.is_used()) {
        ...
        tmp51 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 8, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp50))));
    ...
    if (block29.is_used()) {
        ...
        tmp62 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32FromWord<base::BitField<bool, 9, 1, uintptr_t>>(
            ca_.UncheckedCast<WordT>(ca_.BitcastTaggedToWordForTagAndSmiBits(tmp61))));
    ...
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(163), static_cast<InstanceType>(163))));
