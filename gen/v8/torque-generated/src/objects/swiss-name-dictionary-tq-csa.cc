...
TNode<SwissNameDictionary> Cast_SwissNameDictionary_0(
...
TNode<IntPtrT> SwissNameDictionaryCapacityFor_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_atLeastSpaceFor)
{
    ...
    if (block8.is_used()) {
        ca_.Bind(&block8);
        tmp8 = FromConstexpr_bool_constexpr_bool_0(state_,
            (CodeStubAssembler(state_).ConstexprInt32Equal(
                swiss_table::Group::kWidth, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x10ull))))));
    ...
    if (block11.is_used()) {
        ca_.Bind(&block11);
        tmp10 = FromConstexpr_bool_constexpr_bool_0(state_,
            (CodeStubAssembler(state_).ConstexprInt32Equal(
                swiss_table::Group::kWidth, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull))))));
...
TNode<IntPtrT> SwissNameDictionarySizeFor_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_capacity)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_,
            (CodeStubAssembler(state_).ConstexprInt31Add(
                (CodeStubAssembler(state_).ConstexprInt31Mul(
                    (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull))), kTaggedSize)),
                (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull))))));
        ...
        tmp4 = FromConstexpr_intptr_constexpr_int32_0(state_,
            (CodeStubAssembler(state_).ConstexprInt32Add(
                (CodeStubAssembler(state_).ConstexprInt32Add(
                    HeapObject::kHeaderSize, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull))))),
                kTaggedSize)));
...
void SwissNameDictionaryDelete_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<IntPtrT> p_entry,
    compiler::CodeAssemblerLabel* label_Shrunk, compiler::TypedCodeAssemblerVariable<SwissNameDictionary>* label_Shrunk_parameter_0)
{
    ...
    if (block0.is_used()) {
        ...
        CodeStubAssembler(state_).StoreSwissNameDictionaryKeyAndValue(
            TNode<SwissNameDictionary> { p_table }, TNode<IntPtrT> { p_entry }, TNode<Object> { tmp6 }, TNode<Object> { tmp7 });
        tmp8 = FromConstexpr_uint8_constexpr_uint8_0(state_, static_cast<uint8_t>(swiss_table::Ctrl::kDeleted));
        CodeStubAssembler(state_).SwissNameDictionarySetCtrl(
            TNode<SwissNameDictionary> { p_table }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { p_entry }, TNode<Uint8T> { tmp8 });
...
void SwissNameDictionaryFindEntrySIMD_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key,
...
void SwissNameDictionaryFindEntryPortable_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key,
    compiler::CodeAssemblerLabel* label_Found, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_Found_parameter_0,
    compiler::CodeAssemblerLabel* label_NotFound)
{
    compiler::CodeAssembler ca_(state_);
...
void SwissNameDictionaryAddSIMD_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key, TNode<Object> p_value,
    TNode<Uint8T> p_propertyDetails, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        compiler::CodeAssemblerLabel label0(&ca_);
        Add_GroupSse2Loader_0(
            state_, TNode<SwissNameDictionary> { p_table }, TNode<Name> { p_key }, TNode<Object> { p_value }, TNode<Uint8T> { p_propertyDetails }, &label0);
        ca_.Goto(&block3);
        if (label0.is_used()) {
            ca_.Bind(&label0);
            ca_.Goto(&block4);
...
void SwissNameDictionaryAddPortable_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key, TNode<Object> p_value,
    TNode<Uint8T> p_propertyDetails, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TorqueStructSlice_uint8_MutableReference_uint8_0 FieldSliceSwissNameDictionaryPropertyDetailsTable_0(
    compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_o)
{
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_uint8_MutableReference_uint8_0 { TNode<Object> { tmp10 }, TNode<IntPtrT> { tmp11 }, TNode<IntPtrT> { tmp12 },
        TorqueStructUnsafe_0 {} };
}
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/swiss-name-dictionary.tq?l=7&c=1
TNode<SwissNameDictionary> DownCastForTorqueClass_SwissNameDictionary_0(
    compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(285), static_cast<InstanceType>(285))));
...
void FindEntry_GroupSse2Loader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key,
    compiler::CodeAssemblerLabel* label_Found, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_Found_parameter_0,
    compiler::CodeAssemblerLabel* label_NotFound)
{
    compiler::CodeAssembler ca_(state_);
    ...
    if (block10.is_used()) {
        ...
        ca_.Branch(tmp29, &block8, std::vector<compiler::Node*> { phi_bb10_8, phi_bb10_9, phi_bb10_11 }, &block9,
            std::vector<compiler::Node*> { phi_bb10_8, phi_bb10_9, phi_bb10_11 });
    }
    ...
    if (block8.is_used()) {
        ...
        ca_.Branch(tmp37, &block14, std::vector<compiler::Node*> { phi_bb8_8, phi_bb8_9, phi_bb8_11 }, &block15,
            std::vector<compiler::Node*> { phi_bb8_8, phi_bb8_9, phi_bb8_11 });
    }
    ...
    if (block9.is_used()) {
        ...
        ca_.Branch(tmp46, &block17, std::vector<compiler::Node*> { phi_bb9_8, phi_bb9_9, phi_bb9_11 }, &block18,
            std::vector<compiler::Node*> { phi_bb9_8, phi_bb9_9, phi_bb9_11 });
    }
...
void FindEntry_GroupPortableLoader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key,
    compiler::CodeAssemblerLabel* label_Found, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_Found_parameter_0,
    compiler::CodeAssemblerLabel* label_NotFound)
{
    compiler::CodeAssembler ca_(state_);
    ...
    if (block10.is_used()) {
        ...
        ca_.Branch(tmp33, &block8, std::vector<compiler::Node*> { phi_bb10_8, phi_bb10_9, phi_bb10_11 }, &block9,
            std::vector<compiler::Node*> { phi_bb10_8, phi_bb10_9, phi_bb10_11 });
    }
    ...
    if (block8.is_used()) {
        ...
        ca_.Branch(tmp44, &block14, std::vector<compiler::Node*> { phi_bb8_8, phi_bb8_9, phi_bb8_11 }, &block15,
            std::vector<compiler::Node*> { phi_bb8_8, phi_bb8_9, phi_bb8_11 });
    }
    ...
    if (block9.is_used()) {
        ...
        ca_.Branch(tmp53, &block17, std::vector<compiler::Node*> { phi_bb9_8, phi_bb9_9, phi_bb9_11 }, &block18,
            std::vector<compiler::Node*> { phi_bb9_8, phi_bb9_9, phi_bb9_11 });
    }
...
void Add_GroupSse2Loader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key, TNode<Object> p_value,
    TNode<Uint8T> p_propertyDetails, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block0.is_used()) {
        ...
        tmp8 = CodeStubAssembler(state_).SwissNameDictionaryIncreaseElementCountOrBailout(
            TNode<ByteArray> { tmp7 }, TNode<IntPtrT> { tmp2 }, TNode<Uint32T> { tmp5 }, &label9);
        ca_.Goto(&block5);
        if (label9.is_used()) {
            ca_.Bind(&label9);
            ca_.Goto(&block6);
    ...
    if (block5.is_used()) {
        ...
        CodeStubAssembler(state_).StoreSwissNameDictionaryKeyAndValue(
            TNode<SwissNameDictionary> { p_table }, TNode<IntPtrT> { tmp12 }, TNode<Object> { p_key }, TNode<Object> { p_value });
        tmp13 = Convert_intptr_uint32_0(state_, TNode<Uint32T> { tmp8 });
        CodeStubAssembler(state_).StoreSwissNameDictionaryEnumToEntryMapping(
            TNode<SwissNameDictionary> { p_table }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp13 }, TNode<Int32T> { tmp11 });
        ...
        CodeStubAssembler(state_).SwissNameDictionarySetCtrl(
            TNode<SwissNameDictionary> { p_table }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp12 }, TNode<Uint8T> { tmp16 });
        CodeStubAssembler(state_).StoreSwissNameDictionaryPropertyDetails(
            TNode<SwissNameDictionary> { p_table }, TNode<IntPtrT> { tmp2 }, TNode<IntPtrT> { tmp12 }, TNode<Uint8T> { p_propertyDetails });
        ca_.Goto(&block7);
    }
...
void Add_GroupPortableLoader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key, TNode<Object> p_value,
    TNode<Uint8T> p_propertyDetails, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
...
TNode<Int32T> FindFirstEmpty_GroupSse2Loader_0(
    compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<IntPtrT> p_capacity, TNode<Uint32T> p_hash)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/swiss-name-dictionary.tq?l=230&c=24
TNode<Int32T> FindFirstEmpty_GroupPortableLoader_0(
    compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<IntPtrT> p_capacity, TNode<Uint32T> p_hash)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
