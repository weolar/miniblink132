...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/scope-info.tq?l=32&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/scope-info.tq?l=32&c=1
TNode<Uint32T> FromConstexpr_VariableMode_constexpr_kAwaitUsing_0(compiler::CodeAssemblerState* state_, VariableMode p_o)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/scope-info.tq?l=48&c=1
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_scopeInfo, TNode<Name> p_name, compiler::CodeAssemblerLabel* label_NotFound)
{
    ...
    if (block3.is_used()) {
        ...
        ca_.Branch(tmp10, &block13, std::vector<compiler::Node*> { phi_bb3_3, phi_bb3_3, phi_bb3_3, phi_bb3_3, phi_bb3_3 }, &block14,
            std::vector<compiler::Node*> { phi_bb3_3, phi_bb3_3, phi_bb3_3, phi_bb3_3, phi_bb3_3 });
    }
...
TorqueStructSlice_Smi_ConstReference_Smi_0 FieldSliceScopeInfoModuleVariableCount_0(compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        tmp3 = FromConstexpr_uint32_constexpr_uint32_0(state_, ScopeType::MODULE_SCOPE);
    ...
    if (block4.is_used()) {
        ...
        std::tie(tmp9, tmp10, tmp11) = NewConstSlice_Smi_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp8 }, TNode<IntPtrT> { tmp7 }).Flatten();
        ca_.Goto(&block6);
    }

    ca_.Bind(&block6);
    return TorqueStructSlice_Smi_ConstReference_Smi_0 { TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp10 }, TNode<IntPtrT> { tmp11 }, TorqueStructUnsafe_0 {} };
}
...
TorqueStructSlice_String_MutableReference_String_0 FieldSliceScopeInfoContextLocalNames_0(compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block4.is_used()) {
        ...
        std::tie(tmp15, tmp16, tmp17) = NewMutableSlice_String_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp14 }).Flatten();
        ca_.Goto(&block6);
    }

    ca_.Bind(&block6);
    return TorqueStructSlice_String_MutableReference_String_0 { TNode<Object> { tmp15 }, TNode<IntPtrT> { tmp16 }, TNode<IntPtrT> { tmp17 },
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block4.is_used()) {
        ...
        std::tie(tmp14, tmp15, tmp16)
            = NewMutableSlice_NameToIndexHashTable_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp13 }).Flatten();
        ca_.Goto(&block6);
    }

    ca_.Bind(&block6);
    return TorqueStructSlice_NameToIndexHashTable_MutableReference_NameToIndexHashTable_0 { TNode<Object> { tmp14 }, TNode<IntPtrT> { tmp15 },
        TNode<IntPtrT> { tmp16 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        std::tie(tmp9, tmp10, tmp11)
            = NewMutableSlice_SmiTagged_VariableProperties_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp8 }).Flatten();
        ca_.Goto(&block2);
    }

    ca_.Bind(&block2);
    return TorqueStructSlice_SmiTagged_VariableProperties_MutableReference_SmiTagged_VariableProperties_0 { TNode<Object> { tmp9 }, TNode<IntPtrT> { tmp10 },
...
TorqueStructSlice_Smi_MutableReference_Smi_0 FieldSliceScopeInfoSavedClassVariableInfo_0(compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    ca_.Bind(&block6);
    return TorqueStructSlice_Smi_MutableReference_Smi_0 { TNode<Object> { tmp12 }, TNode<IntPtrT> { tmp13 }, TNode<IntPtrT> { tmp14 },
        TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block0.is_used()) {
        ...
        tmp6 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
        tmp7 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference { p_o, tmp6 });
        tmp8 = ca_.UncheckedCast<Uint32T>(
            CodeStubAssembler(state_).DecodeWord32<base::BitField<VariableAllocationInfo, 12, 2, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp7)));
    ...
    if (block4.is_used()) {
        ...
        tmp13 = Convert_intptr_intptr_0(state_, TNode<IntPtrT> { phi_bb4_8 });
        std::tie(tmp14, tmp15, tmp16)
            = NewMutableSlice_FunctionVariableInfo_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp13 }).Flatten();
        ca_.Goto(&block6);
    }

    ca_.Bind(&block6);
    return TorqueStructSlice_FunctionVariableInfo_MutableReference_FunctionVariableInfo_0 { TNode<Object> { tmp14 }, TNode<IntPtrT> { tmp15 },
        TNode<IntPtrT> { tmp16 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block4.is_used()) {
        ca_.Bind(&block4, &phi_bb4_8);
        tmp11 = Convert_intptr_intptr_0(state_, TNode<IntPtrT> { phi_bb4_8 });
        std::tie(tmp12, tmp13, tmp14)
            = NewMutableSlice_Undefined_OR_String_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp11 }).Flatten();
        ca_.Goto(&block6);
    }

    ca_.Bind(&block6);
    return TorqueStructSlice_Undefined_OR_String_MutableReference_Undefined_OR_String_0 { TNode<Object> { tmp12 }, TNode<IntPtrT> { tmp13 },
        TNode<IntPtrT> { tmp14 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block4.is_used()) {
        ...
        tmp11 = Convert_intptr_intptr_0(state_, TNode<IntPtrT> { phi_bb4_8 });
        std::tie(tmp12, tmp13, tmp14)
            = NewMutableSlice_TheHole_OR_ScopeInfo_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp11 }).Flatten();
        ca_.Goto(&block6);
    }

    ca_.Bind(&block6);
    return TorqueStructSlice_TheHole_OR_ScopeInfo_MutableReference_TheHole_OR_ScopeInfo_0 { TNode<Object> { tmp12 }, TNode<IntPtrT> { tmp13 },
        TNode<IntPtrT> { tmp14 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block4.is_used()) {
        ...
        tmp13 = Convert_intptr_intptr_0(state_, TNode<IntPtrT> { phi_bb4_8 });
        std::tie(tmp14, tmp15, tmp16)
            = NewMutableSlice_SourceTextModuleInfo_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp13 }).Flatten();
        ca_.Goto(&block6);
    }

    ca_.Bind(&block6);
    return TorqueStructSlice_SourceTextModuleInfo_MutableReference_SourceTextModuleInfo_0 { TNode<Object> { tmp14 }, TNode<IntPtrT> { tmp15 },
        TNode<IntPtrT> { tmp16 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<ScopeInfo> p_o)
{
    ...
    if (block4.is_used()) {
        ...
        std::tie(tmp25, tmp26, tmp27)
            = NewMutableSlice_ModuleVariable_0(state_, TNode<Object> { p_o }, TNode<IntPtrT> { tmp5 }, TNode<IntPtrT> { tmp24 }).Flatten();
        ca_.Goto(&block14);
    }

    ca_.Bind(&block14);
    return TorqueStructSlice_ModuleVariable_MutableReference_ModuleVariable_0 { TNode<Object> { tmp25 }, TNode<IntPtrT> { tmp26 }, TNode<IntPtrT> { tmp27 },
        TorqueStructUnsafe_0 {} };
}
...
TNode<ScopeInfo> DownCastForTorqueClass_ScopeInfo_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(279), static_cast<InstanceType>(279))));
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_Smi_ConstReference_Smi_0 {
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_String_MutableReference_String_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_String_MutableReference_String_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
        TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_NameToIndexHashTable_MutableReference_NameToIndexHashTable_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_NameToIndexHashTable_MutableReference_NameToIndexHashTable_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 },
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_SmiTagged_VariableProperties_MutableReference_SmiTagged_VariableProperties_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_SmiTagged_VariableProperties_MutableReference_SmiTagged_VariableProperties_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 },
        TNode<IntPtrT> { tmp2 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_Smi_MutableReference_Smi_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_FunctionVariableInfo_MutableReference_FunctionVariableInfo_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_FunctionVariableInfo_MutableReference_FunctionVariableInfo_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 },
        TNode<IntPtrT> { tmp2 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_Undefined_OR_String_MutableReference_Undefined_OR_String_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_Undefined_OR_String_MutableReference_Undefined_OR_String_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 },
        TNode<IntPtrT> { tmp2 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_TheHole_OR_ScopeInfo_MutableReference_TheHole_OR_ScopeInfo_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_TheHole_OR_ScopeInfo_MutableReference_TheHole_OR_ScopeInfo_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 },
        TNode<IntPtrT> { tmp2 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_SourceTextModuleInfo_MutableReference_SourceTextModuleInfo_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_SourceTextModuleInfo_MutableReference_SourceTextModuleInfo_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 },
        TNode<IntPtrT> { tmp2 }, TorqueStructUnsafe_0 {} };
}
    ...
    compiler::CodeAssemblerState* state_, TNode<Object> p_object, TNode<IntPtrT> p_offset, TNode<IntPtrT> p_length)
{
    ...
    if (block0.is_used()) {
        ca_.Bind(&block0);
        std::tie(tmp0, tmp1, tmp2) = (TorqueStructSlice_ModuleVariable_MutableReference_ModuleVariable_0 {
                                          TNode<Object> { p_object }, TNode<IntPtrT> { p_offset }, TNode<IntPtrT> { p_length }, TorqueStructUnsafe_0 {} })
                                         .Flatten();
        ca_.Goto(&block2);
    }
    ...
    ca_.Bind(&block2);
    return TorqueStructSlice_ModuleVariable_MutableReference_ModuleVariable_0 { TNode<Object> { tmp0 }, TNode<IntPtrT> { tmp1 }, TNode<IntPtrT> { tmp2 },
        TorqueStructUnsafe_0 {} };
}
