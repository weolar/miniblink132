...
template <> void TorqueGeneratedStruct<Struct, HeapObject>::StructVerify(Isolate* isolate)
{
...
template <> void TorqueGeneratedClassPositions<ClassPositions, Struct>::ClassPositionsVerify(Isolate* isolate)
{
...
template <> void TorqueGeneratedAccessorPair<AccessorPair, Struct>::AccessorPairVerify(Isolate* isolate)
{
...
template <> void TorqueGeneratedTuple2<Tuple2, Struct>::Tuple2Verify(Isolate* isolate)
{
