...
TNode<SortState> NewSortState_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<HeapObject> p_comparefn,
    TNode<Number> p_initialReceiverLength, bool p_isToSorted)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block13.is_used()) {
        ca_.Bind(&block13);
        ca_.Goto(&block15, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoad_FastDoubleElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kStore_FastDoubleElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kDelete_FastDoubleElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kCanUseSameAccessor_FastDoubleElements_0)));
    }
    ...
    if (block16.is_used()) {
        ca_.Bind(&block16);
        ca_.Goto(&block18, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoad_FastSmiElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kStore_FastSmiElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kDelete_FastSmiElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kCanUseSameAccessor_FastSmiElements_0)));
    }

    if (block17.is_used()) {
        ca_.Bind(&block17);
        ca_.Goto(&block18, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoad_FastObjectElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kStore_FastObjectElements_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kDelete_FastObjectElements_0)),
    ...
    if (block21.is_used()) {
        ...
        ca_.Goto(&block6, phi_bb21_6, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kStore_GenericElementsAccessor_0)),
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kDelete_GenericElementsAccessor_0)),
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=218&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=225&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=229&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=233&c=1
...
TF_BUILTIN(Load_FastSmiElements_0, CodeStubAssembler)
{
    ...
    if (block5.is_used()) {
        ...
        tmp18 = UnsafeCast_JSReceiver_OR_Undefined_OR_Null_OR_Boolean_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0(
            state_, TNode<Context> { parameter0 }, TNode<Object> { tmp17 });
...
TF_BUILTIN(Load_FastDoubleElements_0, CodeStubAssembler)
{
    ...
    if (block7.is_used()) {
        ...
        std::tie(tmp17, tmp18) = LoadFloat64OrHole_0(
            state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp15 }, TNode<IntPtrT> { tmp16 }, TorqueStructUnsafe_0 {} })
                                     .Flatten();
...
TF_BUILTIN(Delete_FastDoubleElements_0, CodeStubAssembler)
{
    ...
    if (block9.is_used()) {
        ...
        StoreFloat64OrHole_0(state_, TorqueStructReference_float64_or_hole_0 { TNode<Object> { tmp15 }, TNode<IntPtrT> { tmp16 }, TorqueStructUnsafe_0 {} },
            TorqueStructfloat64_or_hole_0 { TNode<BoolT> { tmp17 }, TNode<Float64T> { tmp18 } });
...
TF_BUILTIN(SortCompareUserFn, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp2 = CodeStubAssembler(state_).Call(
            TNode<Context> { parameter0 }, TNode<Object> { tmp0 }, TNode<Object> { tmp1 }, TNode<Object> { parameter2 }, TNode<Object> { parameter3 });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=418&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=425&c=1
TNode<Smi> GetPendingRunBase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_pendingRuns, TNode<Smi> p_run)
{
    ...
    if (block0.is_used()) {
        ...
        tmp3 = CodeStubAssembler(state_).SmiShl(
            TNode<Smi> { p_run }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=430&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=435&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=440&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=461&c=1
...
TF_BUILTIN(Copy, CodeStubAssembler)
{
    ...
    if (block20.is_used()) {
        ...
        ca_.Branch(tmp16, &block27, std::vector<compiler::Node*> { phi_bb20_6, phi_bb20_7, phi_bb20_7 }, &block28,
            std::vector<compiler::Node*> { phi_bb20_6, phi_bb20_7, phi_bb20_7 });
    }
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(tmp29, &block35, std::vector<compiler::Node*> { phi_bb27_12, phi_bb27_13, phi_bb27_6, phi_bb27_6 }, &block36,
            std::vector<compiler::Node*> { phi_bb27_12, phi_bb27_13, phi_bb27_6, phi_bb27_6 });
    }
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(tmp45, &block46, std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_7 }, &block47,
            std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_7 });
    }
    ...
    if (block46.is_used()) {
        ...
        ca_.Branch(tmp58, &block54, std::vector<compiler::Node*> { phi_bb46_13, phi_bb46_14, phi_bb46_6, phi_bb46_6 }, &block55,
            std::vector<compiler::Node*> { phi_bb46_13, phi_bb46_14, phi_bb46_6, phi_bb46_6 });
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=520&c=1
void BinaryInsertionSort_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_low, TNode<Smi> p_startArg, TNode<Smi> p_high)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block13.is_used()) {
        ...
        tmp11 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT> { tmp8 });
        tmp12 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp10 }, TNode<UintPtrT> { tmp11 });
        ca_.Branch(tmp12, &block21, std::vector<compiler::Node*> { phi_bb13_6, phi_bb13_6, phi_bb13_6, phi_bb13_6 }, &block22,
            std::vector<compiler::Node*> { phi_bb13_6, phi_bb13_6, phi_bb13_6, phi_bb13_6 });
    }
    ...
    if (block31.is_used()) {
        ...
        ca_.Branch(tmp19, &block29, std::vector<compiler::Node*> { phi_bb31_6, phi_bb31_7, phi_bb31_8 }, &block30,
            std::vector<compiler::Node*> { phi_bb31_6, phi_bb31_7, phi_bb31_8 });
    }
    ...
    if (block29.is_used()) {
        ...
        tmp21 = CodeStubAssembler(state_).SmiSar(
            TNode<Smi> { tmp20 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
        ...
        tmp29 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp27 }, TNode<UintPtrT> { tmp28 });
        ca_.Branch(tmp29, &block36, std::vector<compiler::Node*> { phi_bb29_6, phi_bb29_7, phi_bb29_8 }, &block37,
            std::vector<compiler::Node*> { phi_bb29_6, phi_bb29_7, phi_bb29_8 });
    }
    ...
    if (block36.is_used()) {
        ...
        tmp36 = Method_SortState_Compare_0(
            state_, TNode<Context> { p_context }, TNode<SortState> { p_sortState }, TNode<Object> { tmp18 }, TNode<Object> { tmp35 });
        ...
        ca_.Branch(tmp38, &block40, std::vector<compiler::Node*> { phi_bb36_6, phi_bb36_7, phi_bb36_8 }, &block41,
            std::vector<compiler::Node*> { phi_bb36_6, phi_bb36_7, phi_bb36_8 });
    }
    ...
    if (block49.is_used()) {
        ...
        ca_.Branch(tmp41, &block47, std::vector<compiler::Node*> { phi_bb49_6, phi_bb49_7, phi_bb49_8, phi_bb49_10 }, &block48,
            std::vector<compiler::Node*> { phi_bb49_6, phi_bb49_7, phi_bb49_8, phi_bb49_10 });
    }
    ...
    if (block47.is_used()) {
        ...
        ca_.Branch(tmp48, &block55, std::vector<compiler::Node*> { phi_bb47_6, phi_bb47_7, phi_bb47_8, phi_bb47_10, phi_bb47_10, phi_bb47_10 }, &block56,
            std::vector<compiler::Node*> { phi_bb47_6, phi_bb47_7, phi_bb47_8, phi_bb47_10, phi_bb47_10, phi_bb47_10 });
    }
    ...
    if (block55.is_used()) {
        ...
        ca_.Branch(tmp61, &block63, std::vector<compiler::Node*> { phi_bb55_6, phi_bb55_7, phi_bb55_8, phi_bb55_10, phi_bb55_15, phi_bb55_16 }, &block64,
            std::vector<compiler::Node*> { phi_bb55_6, phi_bb55_7, phi_bb55_8, phi_bb55_10, phi_bb55_15, phi_bb55_16 });
    }
    ...
    if (block48.is_used()) {
        ...
        ca_.Branch(tmp75, &block71, std::vector<compiler::Node*> { phi_bb48_6, phi_bb48_7, phi_bb48_8, phi_bb48_7, phi_bb48_7 }, &block72,
            std::vector<compiler::Node*> { phi_bb48_6, phi_bb48_7, phi_bb48_8, phi_bb48_7, phi_bb48_7 });
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=586&c=1
TNode<Smi> CountAndMakeRun_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_lowArg, TNode<Smi> p_high)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block20.is_used()) {
        ...
        tmp35 = Method_SortState_Compare_0(
            state_, TNode<Context> { p_context }, TNode<SortState> { p_sortState }, TNode<Object> { tmp19 }, TNode<Object> { tmp34 });
    ...
    if (block30.is_used()) {
        ...
        ca_.Branch(tmp42, &block28, std::vector<compiler::Node*> { phi_bb30_6, phi_bb30_9, phi_bb30_11, phi_bb30_12 }, &block29,
            std::vector<compiler::Node*> { phi_bb30_6, phi_bb30_9, phi_bb30_11, phi_bb30_12 });
    }
    ...
    if (block28.is_used()) {
        ...
        ca_.Branch(tmp49, &block36, std::vector<compiler::Node*> { phi_bb28_6, phi_bb28_9, phi_bb28_11, phi_bb28_12, phi_bb28_12, phi_bb28_12 }, &block37,
            std::vector<compiler::Node*> { phi_bb28_6, phi_bb28_9, phi_bb28_11, phi_bb28_12, phi_bb28_12, phi_bb28_12 });
    }
    ...
    if (block36.is_used()) {
        ...
        tmp56 = Method_SortState_Compare_0(
            state_, TNode<Context> { p_context }, TNode<SortState> { p_sortState }, TNode<Object> { tmp55 }, TNode<Object> { phi_bb36_11 });
        ca_.Branch(phi_bb26_10, &block40, std::vector<compiler::Node*> { phi_bb36_6, phi_bb36_11, phi_bb36_12 }, &block41,
            std::vector<compiler::Node*> { phi_bb36_6, phi_bb36_11, phi_bb36_12 });
    }
    ...
    if (block40.is_used()) {
        ...
        ca_.Branch(tmp58, &block43, std::vector<compiler::Node*> { phi_bb40_6, phi_bb40_11, phi_bb40_12 }, &block44,
            std::vector<compiler::Node*> { phi_bb40_6, phi_bb40_11, phi_bb40_12 });
    }
    ...
    if (block41.is_used()) {
        ...
        ca_.Branch(tmp60, &block45, std::vector<compiler::Node*> { phi_bb41_6, phi_bb41_11, phi_bb41_12 }, &block46,
            std::vector<compiler::Node*> { phi_bb41_6, phi_bb41_11, phi_bb41_12 });
    }
    ...
    if (block29.is_used()) {
        ...
        ca_.Branch(phi_bb26_10, &block47, std::vector<compiler::Node*> { phi_bb29_6, phi_bb29_9, phi_bb29_11 }, &block48,
            std::vector<compiler::Node*> { phi_bb29_6, phi_bb29_9, phi_bb29_11 });
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=629&c=1
void ReverseRange_0(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_array, TNode<Smi> p_from, TNode<Smi> p_to)
{
    ...
    if (block2.is_used()) {
        ...
        tmp9 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp7 }, TNode<UintPtrT> { tmp8 });
        ca_.Branch(tmp9, &block9, std::vector<compiler::Node*> { phi_bb2_3, phi_bb2_4, phi_bb2_3, phi_bb2_3 }, &block10,
            std::vector<compiler::Node*> { phi_bb2_3, phi_bb2_4, phi_bb2_3, phi_bb2_3 });
    }
    ...
    if (block9.is_used()) {
        ...
        ca_.Branch(tmp21, &block17, std::vector<compiler::Node*> { phi_bb9_3, phi_bb9_4, phi_bb9_4, phi_bb9_4 }, &block18,
            std::vector<compiler::Node*> { phi_bb9_3, phi_bb9_4, phi_bb9_4, phi_bb9_4 });
    }
    ...
    if (block17.is_used()) {
        ...
        ca_.Branch(tmp35, &block25, std::vector<compiler::Node*> { phi_bb17_4, phi_bb17_3, phi_bb17_3 }, &block26,
            std::vector<compiler::Node*> { phi_bb17_4, phi_bb17_3, phi_bb17_3 });
    }
...
TF_BUILTIN(MergeAt, CodeStubAssembler)
{
    ...
    if (block61.is_used()) {
        ca_.Bind(&block61);
        MergeLow_0(state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Smi> { tmp45 }, TNode<Smi> { tmp46 }, TNode<Smi> { tmp9 },
            TNode<Smi> { tmp68 });
        ca_.Goto(&block63);
    }
    ...
    if (block62.is_used()) {
        ca_.Bind(&block62);
        MergeHigh_0(state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Smi> { tmp45 }, TNode<Smi> { tmp46 }, TNode<Smi> { tmp9 },
            TNode<Smi> { tmp68 });
        ca_.Goto(&block63);
    }
...
TF_BUILTIN(GallopLeft, CodeStubAssembler)
{
    ...
    if (block19.is_used()) {
        ...
        tmp16 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { tmp15 }, TNode<Object> { parameter3 });
    ...
    if (block28.is_used()) {
        ...
        ca_.Branch(tmp20, &block26, std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 }, &block27,
            std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 });
    }
    ...
    if (block26.is_used()) {
        ...
        tmp28 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT> { tmp23 });
        tmp29 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp27 }, TNode<UintPtrT> { tmp28 });
        ca_.Branch(tmp29, &block33, std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 }, &block34,
            std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 });
    }
    ...
    if (block33.is_used()) {
        ...
        tmp36 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { tmp35 }, TNode<Object> { parameter3 });
        tmp37 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ...
    if (block38.is_used()) {
        ...
        tmp39 = CodeStubAssembler(state_).SmiShl(
            TNode<Smi> { phi_bb38_8 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
        tmp40 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(tmp44, &block41, std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 }, &block42,
            std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 });
    }
    ...
    if (block49.is_used()) {
        ...
        ca_.Branch(tmp49, &block47, std::vector<compiler::Node*> { phi_bb49_7, phi_bb49_8, phi_bb49_10 }, &block48,
            std::vector<compiler::Node*> { phi_bb49_7, phi_bb49_8, phi_bb49_10 });
    }
    ...
    if (block47.is_used()) {
        ...
        tmp57 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT> { tmp52 });
        tmp58 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp56 }, TNode<UintPtrT> { tmp57 });
        ca_.Branch(tmp58, &block54, std::vector<compiler::Node*> { phi_bb47_7, phi_bb47_8, phi_bb47_10 }, &block55,
            std::vector<compiler::Node*> { phi_bb47_7, phi_bb47_8, phi_bb47_10 });
    }
    ...
    if (block54.is_used()) {
        ...
        tmp65 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { tmp64 }, TNode<Object> { parameter3 });
    ...
    if (block59.is_used()) {
        ...
        tmp68 = CodeStubAssembler(state_).SmiShl(
            TNode<Smi> { phi_bb59_8 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
    ...
    if (block48.is_used()) {
        ...
        ca_.Branch(tmp73, &block62, std::vector<compiler::Node*> { phi_bb48_7, phi_bb48_8, phi_bb48_10 }, &block63,
            std::vector<compiler::Node*> { phi_bb48_7, phi_bb48_8, phi_bb48_10 });
    }
    ...
    if (block76.is_used()) {
        ...
        ca_.Branch(tmp78, &block74, std::vector<compiler::Node*> { phi_bb76_7, phi_bb76_8, phi_bb76_10 }, &block75,
            std::vector<compiler::Node*> { phi_bb76_7, phi_bb76_8, phi_bb76_10 });
    }
    ...
    if (block74.is_used()) {
        ...
        tmp80 = CodeStubAssembler(state_).SmiSar(
            TNode<Smi> { tmp79 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
        ...
        ca_.Branch(tmp89, &block81, std::vector<compiler::Node*> { phi_bb74_7, phi_bb74_8, phi_bb74_10 }, &block82,
            std::vector<compiler::Node*> { phi_bb74_7, phi_bb74_8, phi_bb74_10 });
    }
    ...
    if (block81.is_used()) {
        ...
        tmp96 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { tmp95 }, TNode<Object> { parameter3 });
...
TF_BUILTIN(GallopRight, CodeStubAssembler)
{
    ...
    if (block19.is_used()) {
        ...
        tmp15 = UnsafeCast_JSAny_0(state_, TNode<Context> { parameter0 }, TNode<Object> { tmp14 });
        tmp16 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { parameter3 }, TNode<Object> { tmp15 });
        tmp17 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp18 = NumberIsLessThan_0(state_, TNode<Number> { tmp16 }, TNode<Number> { tmp17 });
        ca_.Branch(tmp18, &block23, std::vector<compiler::Node*> {}, &block24, std::vector<compiler::Node*> {});
    }
    ...
    if (block28.is_used()) {
        ...
        ca_.Branch(tmp21, &block26, std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 }, &block27,
            std::vector<compiler::Node*> { phi_bb28_7, phi_bb28_8, phi_bb28_10 });
    }
    ...
    if (block26.is_used()) {
        ...
        ca_.Branch(tmp30, &block33, std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 }, &block34,
            std::vector<compiler::Node*> { phi_bb26_7, phi_bb26_8, phi_bb26_10 });
    }
    ...
    if (block33.is_used()) {
        ...
        tmp37 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { parameter3 }, TNode<Object> { tmp36 });
    ...
    if (block38.is_used()) {
        ca_.Bind(&block38, &phi_bb38_7, &phi_bb38_8);
        tmp40 = CodeStubAssembler(state_).SmiShl(
            TNode<Smi> { phi_bb38_8 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
    ...
    if (block27.is_used()) {
        ...
        ca_.Branch(tmp45, &block41, std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 }, &block42,
            std::vector<compiler::Node*> { phi_bb27_7, phi_bb27_8, phi_bb27_10 });
    }
    ...
    if (block45.is_used()) {
        ...
        ca_.Branch(tmp49, &block43, std::vector<compiler::Node*> { phi_bb45_7, phi_bb45_8, phi_bb45_10 }, &block44,
            std::vector<compiler::Node*> { phi_bb45_7, phi_bb45_8, phi_bb45_10 });
    }
    ...
    if (block43.is_used()) {
        ...
        tmp57 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT> { tmp52 });
        tmp58 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp56 }, TNode<UintPtrT> { tmp57 });
        ca_.Branch(tmp58, &block50, std::vector<compiler::Node*> { phi_bb43_7, phi_bb43_8, phi_bb43_10 }, &block51,
            std::vector<compiler::Node*> { phi_bb43_7, phi_bb43_8, phi_bb43_10 });
    }
    ...
    if (block50.is_used()) {
        ...
        tmp64 = UnsafeCast_JSAny_0(state_, TNode<Context> { parameter0 }, TNode<Object> { tmp63 });
        tmp65 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { parameter3 }, TNode<Object> { tmp64 });
        tmp66 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp67 = NumberIsLessThan_0(state_, TNode<Number> { tmp65 }, TNode<Number> { tmp66 });
    ...
    if (block55.is_used()) {
        ...
        tmp68 = CodeStubAssembler(state_).SmiShl(
            TNode<Smi> { phi_bb55_8 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
        tmp69 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
        tmp70 = CodeStubAssembler(state_).SmiAdd(TNode<Smi> { tmp68 }, TNode<Smi> { tmp69 });
        tmp71 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp72 = CodeStubAssembler(state_).SmiLessThanOrEqual(TNode<Smi> { tmp70 }, TNode<Smi> { tmp71 });
    ...
    if (block44.is_used()) {
        ...
        ca_.Branch(tmp73, &block58, std::vector<compiler::Node*> { phi_bb44_7, phi_bb44_8, phi_bb44_10 }, &block59,
            std::vector<compiler::Node*> { phi_bb44_7, phi_bb44_8, phi_bb44_10 });
    }
    ...
    if (block72.is_used()) {
        ...
        ca_.Branch(tmp78, &block70, std::vector<compiler::Node*> { phi_bb72_7, phi_bb72_8, phi_bb72_10 }, &block71,
            std::vector<compiler::Node*> { phi_bb72_7, phi_bb72_8, phi_bb72_10 });
    }
    ...
    if (block70.is_used()) {
        ...
        tmp88 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT> { tmp84 });
        tmp89 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp87 }, TNode<UintPtrT> { tmp88 });
        ca_.Branch(tmp89, &block77, std::vector<compiler::Node*> { phi_bb70_7, phi_bb70_8, phi_bb70_10 }, &block78,
            std::vector<compiler::Node*> { phi_bb70_7, phi_bb70_8, phi_bb70_10 });
    }
    ...
    if (block77.is_used()) {
        ...
        tmp95 = UnsafeCast_JSAny_0(state_, TNode<Context> { parameter0 }, TNode<Object> { tmp94 });
        tmp96 = Method_SortState_Compare_0(
            state_, TNode<Context> { parameter0 }, TNode<SortState> { parameter1 }, TNode<Object> { parameter3 }, TNode<Object> { tmp95 });
        tmp97 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
        tmp98 = NumberIsLessThan_0(state_, TNode<Number> { tmp96 }, TNode<Number> { tmp97 });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=916&c=1
void MergeLow_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_baseA, TNode<Smi> p_lengthAArg,
    TNode<Smi> p_baseB, TNode<Smi> p_lengthBArg)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block46.is_used()) {
        ...
        ca_.Branch(tmp41, &block44, std::vector<compiler::Node*> { phi_bb46_6, phi_bb46_7, phi_bb46_10, phi_bb46_11, phi_bb46_12, phi_bb46_13 }, &block45,
            std::vector<compiler::Node*> { phi_bb46_6, phi_bb46_7, phi_bb46_10, phi_bb46_11, phi_bb46_12, phi_bb46_13 });
    }
    ...
    if (block49.is_used()) {
        ...
        ca_.Branch(tmp44, &block47,
            std::vector<compiler::Node*> { phi_bb49_6, phi_bb49_7, phi_bb49_10, phi_bb49_11, phi_bb49_12, phi_bb49_13, phi_bb49_14, phi_bb49_15 }, &block48,
            std::vector<compiler::Node*> { phi_bb49_6, phi_bb49_7, phi_bb49_10, phi_bb49_11, phi_bb49_12, phi_bb49_13, phi_bb49_14, phi_bb49_15 });
    }
    ...
    if (block47.is_used()) {
        ...
        ca_.Branch(tmp51, &block61,
            std::vector<compiler::Node*> {
                phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_12, phi_bb47_12 },
            &block62,
            std::vector<compiler::Node*> {
                phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_12, phi_bb47_12 });
    }
    ...
    if (block61.is_used()) {
        ca_.Bind(
            &block61, &phi_bb61_6, &phi_bb61_7, &phi_bb61_10, &phi_bb61_11, &phi_bb61_12, &phi_bb61_13, &phi_bb61_14, &phi_bb61_15, &phi_bb61_21, &phi_bb61_22);
        ...
        ca_.Branch(tmp64, &block69,
            std::vector<compiler::Node*> {
                phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_11, phi_bb61_11 },
            &block70,
            std::vector<compiler::Node*> {
                phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_11, phi_bb61_11 });
    }
    ...
    if (block62.is_used()) {
        ca_.Bind(
            &block62, &phi_bb62_6, &phi_bb62_7, &phi_bb62_10, &phi_bb62_11, &phi_bb62_12, &phi_bb62_13, &phi_bb62_14, &phi_bb62_15, &phi_bb62_21, &phi_bb62_22);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block69.is_used()) {
        ca_.Bind(
            &block69, &phi_bb69_6, &phi_bb69_7, &phi_bb69_10, &phi_bb69_11, &phi_bb69_12, &phi_bb69_13, &phi_bb69_14, &phi_bb69_15, &phi_bb69_22, &phi_bb69_23);
        ...
        tmp71 = Method_SortState_Compare_0(
            state_, TNode<Context> { p_context }, TNode<SortState> { p_sortState }, TNode<Object> { tmp57 }, TNode<Object> { tmp70 });
        ...
        ca_.Branch(tmp73, &block73,
            std::vector<compiler::Node*> { phi_bb69_6, phi_bb69_7, phi_bb69_10, phi_bb69_11, phi_bb69_12, phi_bb69_13, phi_bb69_14, phi_bb69_15 }, &block74,
            std::vector<compiler::Node*> { phi_bb69_6, phi_bb69_7, phi_bb69_10, phi_bb69_11, phi_bb69_12, phi_bb69_13, phi_bb69_14, phi_bb69_15 });
    }
    ...
    if (block70.is_used()) {
        ca_.Bind(
            &block70, &phi_bb70_6, &phi_bb70_7, &phi_bb70_10, &phi_bb70_11, &phi_bb70_12, &phi_bb70_13, &phi_bb70_14, &phi_bb70_15, &phi_bb70_22, &phi_bb70_23);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block73.is_used()) {
        ...
        ca_.Branch(tmp82, &block80,
            std::vector<compiler::Node*> { phi_bb73_6, phi_bb73_7, phi_bb73_11, phi_bb73_12, phi_bb73_13, phi_bb73_14, phi_bb73_15, phi_bb73_10, phi_bb73_10 },
            &block81,
            std::vector<compiler::Node*> { phi_bb73_6, phi_bb73_7, phi_bb73_11, phi_bb73_12, phi_bb73_13, phi_bb73_14, phi_bb73_15, phi_bb73_10, phi_bb73_10 });
    }
    ...
    if (block80.is_used()) {
        ...
        ca_.Branch(tmp95, &block88,
            std::vector<compiler::Node*> {
                phi_bb80_6, phi_bb80_7, phi_bb80_11, phi_bb80_13, phi_bb80_14, phi_bb80_15, phi_bb80_21, phi_bb80_22, phi_bb80_12, phi_bb80_12 },
            &block89,
            std::vector<compiler::Node*> {
                phi_bb80_6, phi_bb80_7, phi_bb80_11, phi_bb80_13, phi_bb80_14, phi_bb80_15, phi_bb80_21, phi_bb80_22, phi_bb80_12, phi_bb80_12 });
    }
    ...
    if (block88.is_used()) {
        ca_.Bind(
            &block88, &phi_bb88_6, &phi_bb88_7, &phi_bb88_11, &phi_bb88_13, &phi_bb88_14, &phi_bb88_15, &phi_bb88_21, &phi_bb88_22, &phi_bb88_29, &phi_bb88_30);
        ...
        ca_.Branch(tmp107, &block92, std::vector<compiler::Node*> { phi_bb88_6, phi_bb88_11, phi_bb88_13 }, &block93,
            std::vector<compiler::Node*> { phi_bb88_6, phi_bb88_11, phi_bb88_13 });
    }
    ...
    if (block89.is_used()) {
        ca_.Bind(
            &block89, &phi_bb89_6, &phi_bb89_7, &phi_bb89_11, &phi_bb89_13, &phi_bb89_14, &phi_bb89_15, &phi_bb89_21, &phi_bb89_22, &phi_bb89_29, &phi_bb89_30);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block93.is_used()) {
        ...
        ca_.Branch(tmp108, &block94, std::vector<compiler::Node*> { phi_bb93_6, phi_bb93_11, phi_bb93_13 }, &block95,
            std::vector<compiler::Node*> { phi_bb93_6, phi_bb93_11, phi_bb93_13 });
    }
    ...
    if (block74.is_used()) {
        ...
        ca_.Branch(tmp117, &block100,
            std::vector<compiler::Node*> { phi_bb74_6, phi_bb74_7, phi_bb74_11, phi_bb74_12, phi_bb74_13, phi_bb74_14, phi_bb74_15, phi_bb74_10, phi_bb74_10 },
            &block101,
            std::vector<compiler::Node*> { phi_bb74_6, phi_bb74_7, phi_bb74_11, phi_bb74_12, phi_bb74_13, phi_bb74_14, phi_bb74_15, phi_bb74_10, phi_bb74_10 });
    }
    ...
    if (block100.is_used()) {
        ca_.Bind(
            &block100, &phi_bb100_6, &phi_bb100_7, &phi_bb100_11, &phi_bb100_12, &phi_bb100_13, &phi_bb100_14, &phi_bb100_15, &phi_bb100_21, &phi_bb100_22);
        ...
        ca_.Branch(tmp130, &block108,
            std::vector<compiler::Node*> {
                phi_bb100_6, phi_bb100_7, phi_bb100_12, phi_bb100_13, phi_bb100_14, phi_bb100_15, phi_bb100_21, phi_bb100_22, phi_bb100_11, phi_bb100_11 },
            &block109,
            std::vector<compiler::Node*> {
                phi_bb100_6, phi_bb100_7, phi_bb100_12, phi_bb100_13, phi_bb100_14, phi_bb100_15, phi_bb100_21, phi_bb100_22, phi_bb100_11, phi_bb100_11 });
    }
    ...
    if (block101.is_used()) {
        ca_.Bind(
            &block101, &phi_bb101_6, &phi_bb101_7, &phi_bb101_11, &phi_bb101_12, &phi_bb101_13, &phi_bb101_14, &phi_bb101_15, &phi_bb101_21, &phi_bb101_22);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    TNode<BoolT> tmp142;
    if (block108.is_used()) {
        ca_.Bind(&block108, &phi_bb108_6, &phi_bb108_7, &phi_bb108_12, &phi_bb108_13, &phi_bb108_14, &phi_bb108_15, &phi_bb108_21, &phi_bb108_22, &phi_bb108_29,
            &phi_bb108_30);
        ...
        ca_.Branch(tmp142, &block112, std::vector<compiler::Node*> { phi_bb108_7, phi_bb108_12, phi_bb108_13 }, &block113,
            std::vector<compiler::Node*> { phi_bb108_7, phi_bb108_12, phi_bb108_13 });
    }
    ...
    if (block109.is_used()) {
        ca_.Bind(&block109, &phi_bb109_6, &phi_bb109_7, &phi_bb109_12, &phi_bb109_13, &phi_bb109_14, &phi_bb109_15, &phi_bb109_21, &phi_bb109_22, &phi_bb109_29,
            &phi_bb109_30);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block113.is_used()) {
        ...
        ca_.Branch(tmp143, &block114, std::vector<compiler::Node*> { phi_bb113_7, phi_bb113_12, phi_bb113_13 }, &block115,
            std::vector<compiler::Node*> { phi_bb113_7, phi_bb113_12, phi_bb113_13 });
    }
    ...
    if (block118.is_used()) {
        ca_.Bind(
            &block118, &phi_bb118_6, &phi_bb118_7, &phi_bb118_10, &phi_bb118_11, &phi_bb118_12, &phi_bb118_13, &phi_bb118_14, &phi_bb118_15, &phi_bb118_16);
        ...
        ca_.Branch(tmp148, &block119,
            std::vector<compiler::Node*> {
                phi_bb118_6, phi_bb118_7, phi_bb118_10, phi_bb118_11, phi_bb118_12, phi_bb118_13, phi_bb118_14, phi_bb118_15, phi_bb118_16 },
            &block120,
            std::vector<compiler::Node*> {
                phi_bb118_6, phi_bb118_7, phi_bb118_10, phi_bb118_11, phi_bb118_12, phi_bb118_13, phi_bb118_14, phi_bb118_15, phi_bb118_16 });
    }
    ...
    if (block119.is_used()) {
        ca_.Bind(
            &block119, &phi_bb119_6, &phi_bb119_7, &phi_bb119_10, &phi_bb119_11, &phi_bb119_12, &phi_bb119_13, &phi_bb119_14, &phi_bb119_15, &phi_bb119_16);
    ...
    if (block120.is_used()) {
        ca_.Bind(
            &block120, &phi_bb120_6, &phi_bb120_7, &phi_bb120_10, &phi_bb120_11, &phi_bb120_12, &phi_bb120_13, &phi_bb120_14, &phi_bb120_15, &phi_bb120_16);
    ...
    if (block121.is_used()) {
        ca_.Bind(&block121, &phi_bb121_6, &phi_bb121_7, &phi_bb121_10, &phi_bb121_11, &phi_bb121_12, &phi_bb121_13, &phi_bb121_14, &phi_bb121_15, &phi_bb121_16,
            &phi_bb121_18);
        ca_.Branch(phi_bb121_18, &block122,
            std::vector<compiler::Node*> {
                phi_bb121_6, phi_bb121_7, phi_bb121_10, phi_bb121_11, phi_bb121_12, phi_bb121_13, phi_bb121_14, phi_bb121_15, phi_bb121_16 },
            &block123,
            std::vector<compiler::Node*> {
                phi_bb121_6, phi_bb121_7, phi_bb121_10, phi_bb121_11, phi_bb121_12, phi_bb121_13, phi_bb121_14, phi_bb121_15, phi_bb121_16 });
    }
    ...
    if (block122.is_used()) {
        ca_.Bind(
            &block122, &phi_bb122_6, &phi_bb122_7, &phi_bb122_10, &phi_bb122_11, &phi_bb122_12, &phi_bb122_13, &phi_bb122_14, &phi_bb122_15, &phi_bb122_16);
    ...
    if (block123.is_used()) {
        ca_.Bind(
            &block123, &phi_bb123_6, &phi_bb123_7, &phi_bb123_10, &phi_bb123_11, &phi_bb123_12, &phi_bb123_13, &phi_bb123_14, &phi_bb123_15, &phi_bb123_16);
        ca_.Goto(&block124, phi_bb123_6, phi_bb123_7, phi_bb123_10, phi_bb123_11, phi_bb123_12, phi_bb123_13, phi_bb123_14, phi_bb123_15, phi_bb123_16,
            phi_bb123_16);
    }
    ...
    if (block124.is_used()) {
        ca_.Bind(&block124, &phi_bb124_6, &phi_bb124_7, &phi_bb124_10, &phi_bb124_11, &phi_bb124_12, &phi_bb124_13, &phi_bb124_14, &phi_bb124_15, &phi_bb124_16,
            &phi_bb124_18);
        ca_.Branch(phi_bb124_18, &block116,
            std::vector<compiler::Node*> {
    ...
    if (block116.is_used()) {
        ca_.Bind(
            &block116, &phi_bb116_6, &phi_bb116_7, &phi_bb116_10, &phi_bb116_11, &phi_bb116_12, &phi_bb116_13, &phi_bb116_14, &phi_bb116_15, &phi_bb116_16);
    ...
    if (block136.is_used()) {
        ca_.Bind(
            &block136, &phi_bb136_6, &phi_bb136_7, &phi_bb136_10, &phi_bb136_11, &phi_bb136_12, &phi_bb136_14, &phi_bb136_15, &phi_bb136_22, &phi_bb136_23);
        ...
        ca_.Branch(tmp175, &block144, std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 },
            &block145, std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 });
    }
    ...
    if (block137.is_used()) {
        ca_.Bind(
            &block137, &phi_bb137_6, &phi_bb137_7, &phi_bb137_10, &phi_bb137_11, &phi_bb137_12, &phi_bb137_14, &phi_bb137_15, &phi_bb137_22, &phi_bb137_23);
        CodeStubAssembler(state_).Unreachable();
    }
    ...
    if (block144.is_used()) {
        ...
        ca_.Branch(tmp181, &block146, std::vector<compiler::Node*> { phi_bb144_7, phi_bb144_12, phi_bb144_15 }, &block147,
            std::vector<compiler::Node*> { phi_bb144_7, phi_bb144_12, phi_bb144_15 });
    }
    ...
    if (block147.is_used()) {
        ...
        ca_.Branch(tmp183, &block148, std::vector<compiler::Node*> { phi_bb147_7, phi_bb147_12, phi_bb147_15 }, &block149,
            std::vector<compiler::Node*> { phi_bb147_7, phi_bb147_12, phi_bb147_15 });
    }
    ...
    if (block145.is_used()) {
        ...
        ca_.Branch(tmp192, &block154,
            std::vector<compiler::Node*> { phi_bb145_6, phi_bb145_7, phi_bb145_11, phi_bb145_12, phi_bb145_15, phi_bb145_10, phi_bb145_10 }, &block155,
            std::vector<compiler::Node*> { phi_bb145_6, phi_bb145_7, phi_bb145_11, phi_bb145_12, phi_bb145_15, phi_bb145_10, phi_bb145_10 });
    }
    ...
    if (block154.is_used()) {
        ...
        ca_.Branch(tmp205, &block162,
            std::vector<compiler::Node*> { phi_bb154_6, phi_bb154_7, phi_bb154_11, phi_bb154_15, phi_bb154_21, phi_bb154_22, phi_bb154_12, phi_bb154_12 },
            &block163,
            std::vector<compiler::Node*> { phi_bb154_6, phi_bb154_7, phi_bb154_11, phi_bb154_15, phi_bb154_21, phi_bb154_22, phi_bb154_12, phi_bb154_12 });
    }
    ...
    if (block162.is_used()) {
        ...
        ca_.Branch(tmp214, &block166, std::vector<compiler::Node*> { phi_bb162_6, phi_bb162_11, phi_bb162_15 }, &block167,
            std::vector<compiler::Node*> { phi_bb162_6, phi_bb162_11, phi_bb162_15 });
    }
    ...
    if (block167.is_used()) {
        ...
        ca_.Branch(tmp221, &block172, std::vector<compiler::Node*> { phi_bb167_6, phi_bb167_11, phi_bb167_15, phi_bb167_11, phi_bb167_11 }, &block173,
            std::vector<compiler::Node*> { phi_bb167_6, phi_bb167_11, phi_bb167_15, phi_bb167_11, phi_bb167_11 });
    }
    ...
    if (block172.is_used()) {
        ...
        ca_.Branch(tmp231, &block180, std::vector<compiler::Node*> { phi_bb172_6, phi_bb172_11 }, &block181,
            std::vector<compiler::Node*> { phi_bb172_6, tmp212, tmp188, phi_bb172_11, tmp201 });
    }
    ...
    if (block180.is_used()) {
        ...
        ca_.Branch(tmp237, &block182, std::vector<compiler::Node*> { phi_bb180_6, phi_bb180_11 }, &block183,
            std::vector<compiler::Node*> { phi_bb180_6, phi_bb180_11 });
    }
    ...
    if (block181.is_used()) {
        ...
        ca_.Branch(tmp246, &block188, std::vector<compiler::Node*> { phi_bb181_6, phi_bb181_7, phi_bb181_11, phi_bb181_12, phi_bb181_10, phi_bb181_10 },
            &block189, std::vector<compiler::Node*> { phi_bb181_6, phi_bb181_7, phi_bb181_11, phi_bb181_12, phi_bb181_10, phi_bb181_10 });
    }
    ...
    if (block188.is_used()) {
        ...
        ca_.Branch(tmp259, &block196,
            std::vector<compiler::Node*> { phi_bb188_6, phi_bb188_7, phi_bb188_12, phi_bb188_21, phi_bb188_22, phi_bb188_11, phi_bb188_11 }, &block197,
            std::vector<compiler::Node*> { phi_bb188_6, phi_bb188_7, phi_bb188_12, phi_bb188_21, phi_bb188_22, phi_bb188_11, phi_bb188_11 });
    }
    ...
    if (block196.is_used()) {
        ...
        ca_.Branch(tmp268, &block200, std::vector<compiler::Node*> { phi_bb196_7, phi_bb196_12 }, &block201,
            std::vector<compiler::Node*> { phi_bb196_7, phi_bb196_12 });
    }
    ...
    if (block117.is_used()) {
        ca_.Bind(
            &block117, &phi_bb117_6, &phi_bb117_7, &phi_bb117_10, &phi_bb117_11, &phi_bb117_12, &phi_bb117_13, &phi_bb117_14, &phi_bb117_15, &phi_bb117_16);
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(tmp273, &block202, std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_10, phi_bb39_11, phi_bb39_12 }, &block203,
            std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_10, phi_bb39_11, phi_bb39_12 });
    }
    ...
    if (block37.is_used()) {
        ...
        ca_.Branch(tmp283, &block215, std::vector<compiler::Node*> { phi_bb37_6, phi_bb37_7, phi_bb37_10, phi_bb37_11, phi_bb37_12 }, &block216,
            std::vector<compiler::Node*> { phi_bb37_6, phi_bb37_7, phi_bb37_10, phi_bb37_11, phi_bb37_12 });
    }
    ...
    if (block215.is_used()) {
        ...
        ca_.Branch(tmp294, &block223,
            std::vector<compiler::Node*> { phi_bb215_6, phi_bb215_7, phi_bb215_10, phi_bb215_11, phi_bb215_12, phi_bb215_11, phi_bb215_11 }, &block224,
            std::vector<compiler::Node*> { phi_bb215_6, phi_bb215_7, phi_bb215_10, phi_bb215_11, phi_bb215_12, phi_bb215_11, phi_bb215_11 });
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=1047&c=1
void MergeHigh_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_baseA, TNode<Smi> p_lengthAArg,
    TNode<Smi> p_baseB, TNode<Smi> p_lengthBArg)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    ...
    if (block46.is_used()) {
        ...
        ca_.Branch(tmp48, &block44, std::vector<compiler::Node*> { phi_bb46_6, phi_bb46_7, phi_bb46_10, phi_bb46_11, phi_bb46_12, phi_bb46_13 }, &block45,
            std::vector<compiler::Node*> { phi_bb46_6, phi_bb46_7, phi_bb46_10, phi_bb46_11, phi_bb46_12, phi_bb46_13 });
    }
    ...
    if (block47.is_used()) {
        ...
        tmp58 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp56 }, TNode<UintPtrT> { tmp57 });
        ca_.Branch(tmp58, &block61,
            std::vector<compiler::Node*> {
                phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_11, phi_bb47_11 },
            &block62,
            std::vector<compiler::Node*> {
                phi_bb47_6, phi_bb47_7, phi_bb47_10, phi_bb47_11, phi_bb47_12, phi_bb47_13, phi_bb47_14, phi_bb47_15, phi_bb47_11, phi_bb47_11 });
    }
    ...
    if (block61.is_used()) {
        ...
        ca_.Branch(tmp71, &block69,
            std::vector<compiler::Node*> {
                phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_12, phi_bb61_12 },
            &block70,
            std::vector<compiler::Node*> {
                phi_bb61_6, phi_bb61_7, phi_bb61_10, phi_bb61_11, phi_bb61_12, phi_bb61_13, phi_bb61_14, phi_bb61_15, phi_bb61_12, phi_bb61_12 });
    }
    ...
    if (block69.is_used()) {
        ...
        tmp78 = Method_SortState_Compare_0(
            state_, TNode<Context> { p_context }, TNode<SortState> { p_sortState }, TNode<Object> { tmp64 }, TNode<Object> { tmp77 });
    ...
    if (block88.is_used()) {
        ...
        ca_.Branch(tmp114, &block92, std::vector<compiler::Node*> { phi_bb88_7, phi_bb88_11, phi_bb88_13 }, &block93,
            std::vector<compiler::Node*> { phi_bb88_7, phi_bb88_11, phi_bb88_13 });
    }
    ...
    if (block93.is_used()) {
        ...
        ca_.Branch(tmp115, &block94, std::vector<compiler::Node*> { phi_bb93_7, phi_bb93_11, phi_bb93_13 }, &block95,
            std::vector<compiler::Node*> { phi_bb93_7, phi_bb93_11, phi_bb93_13 });
    }
    ...
    if (block108.is_used()) {
        ...
        ca_.Branch(tmp149, &block112, std::vector<compiler::Node*> { phi_bb108_6, phi_bb108_12, phi_bb108_13 }, &block113,
            std::vector<compiler::Node*> { phi_bb108_6, phi_bb108_12, phi_bb108_13 });
    }
    ...
    if (block113.is_used()) {
        ...
        ca_.Branch(tmp150, &block114, std::vector<compiler::Node*> { phi_bb113_6, phi_bb113_12, phi_bb113_13 }, &block115,
            std::vector<compiler::Node*> { phi_bb113_6, phi_bb113_12, phi_bb113_13 });
    }
    ...
    if (block136.is_used()) {
        ...
        ca_.Branch(tmp184, &block144, std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 },
            &block145, std::vector<compiler::Node*> { phi_bb136_6, phi_bb136_7, phi_bb136_10, phi_bb136_11, phi_bb136_12, phi_bb136_15 });
    }
    ...
    if (block144.is_used()) {
        ...
        ca_.Branch(tmp194, &block146, std::vector<compiler::Node*> { phi_bb144_7, phi_bb144_11, phi_bb144_15 }, &block147,
            std::vector<compiler::Node*> { phi_bb144_7, phi_bb144_11, phi_bb144_15 });
    }
    ...
    if (block145.is_used()) {
        ...
        ca_.Branch(tmp203, &block152,
            std::vector<compiler::Node*> { phi_bb145_6, phi_bb145_7, phi_bb145_11, phi_bb145_12, phi_bb145_15, phi_bb145_10, phi_bb145_10 }, &block153,
            std::vector<compiler::Node*> { phi_bb145_6, phi_bb145_7, phi_bb145_11, phi_bb145_12, phi_bb145_15, phi_bb145_10, phi_bb145_10 });
    }
    ...
    if (block152.is_used()) {
        ...
        ca_.Branch(tmp216, &block160,
            std::vector<compiler::Node*> { phi_bb152_6, phi_bb152_7, phi_bb152_12, phi_bb152_15, phi_bb152_22, phi_bb152_23, phi_bb152_11, phi_bb152_11 },
            &block161,
            std::vector<compiler::Node*> { phi_bb152_6, phi_bb152_7, phi_bb152_12, phi_bb152_15, phi_bb152_22, phi_bb152_23, phi_bb152_11, phi_bb152_11 });
    }
    ...
    if (block160.is_used()) {
        ...
        ca_.Branch(tmp225, &block164, std::vector<compiler::Node*> { phi_bb160_6, phi_bb160_12, phi_bb160_15 }, &block165,
            std::vector<compiler::Node*> { phi_bb160_6, phi_bb160_12, phi_bb160_15 });
    }
    ...
    if (block165.is_used()) {
        ...
        ca_.Branch(tmp232, &block170, std::vector<compiler::Node*> { phi_bb165_6, phi_bb165_12, phi_bb165_15, phi_bb165_12, phi_bb165_12 }, &block171,
            std::vector<compiler::Node*> { phi_bb165_6, phi_bb165_12, phi_bb165_15, phi_bb165_12, phi_bb165_12 });
    }
    ...
    if (block170.is_used()) {
        ...
        ca_.Branch(tmp245, &block178, std::vector<compiler::Node*> { phi_bb170_6, phi_bb170_12 }, &block179,
            std::vector<compiler::Node*> { phi_bb170_6, tmp223, tmp199, tmp212, phi_bb170_12 });
    }
    ...
    if (block178.is_used()) {
        ...
        ca_.Branch(tmp255, &block180, std::vector<compiler::Node*> { phi_bb178_6, phi_bb178_12 }, &block181,
            std::vector<compiler::Node*> { phi_bb178_6, phi_bb178_12 });
    }
    ...
    if (block181.is_used()) {
        ...
        ca_.Branch(tmp257, &block182, std::vector<compiler::Node*> { phi_bb181_6, phi_bb181_12 }, &block183,
            std::vector<compiler::Node*> { phi_bb181_6, phi_bb181_12 });
    }
    ...
    if (block179.is_used()) {
        ...
        ca_.Branch(tmp266, &block188, std::vector<compiler::Node*> { phi_bb179_6, phi_bb179_7, phi_bb179_11, phi_bb179_12, phi_bb179_10, phi_bb179_10 },
            &block189, std::vector<compiler::Node*> { phi_bb179_6, phi_bb179_7, phi_bb179_11, phi_bb179_12, phi_bb179_10, phi_bb179_10 });
    }
    ...
    if (block188.is_used()) {
        ...
        ca_.Branch(tmp279, &block196,
            std::vector<compiler::Node*> { phi_bb188_6, phi_bb188_7, phi_bb188_11, phi_bb188_22, phi_bb188_23, phi_bb188_12, phi_bb188_12 }, &block197,
            std::vector<compiler::Node*> { phi_bb188_6, phi_bb188_7, phi_bb188_11, phi_bb188_22, phi_bb188_23, phi_bb188_12, phi_bb188_12 });
    }
    ...
    if (block196.is_used()) {
        ...
        ca_.Branch(tmp288, &block200, std::vector<compiler::Node*> { phi_bb196_7, phi_bb196_11 }, &block201,
            std::vector<compiler::Node*> { phi_bb196_7, phi_bb196_11 });
    }
    ...
    if (block39.is_used()) {
        ...
        ca_.Branch(tmp293, &block202, std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_10, phi_bb39_11, phi_bb39_12 }, &block203,
            std::vector<compiler::Node*> { phi_bb39_6, phi_bb39_7, phi_bb39_10, phi_bb39_11, phi_bb39_12 });
    }
    ...
    if (block37.is_used()) {
        ...
        ca_.Branch(tmp312, &block219, std::vector<compiler::Node*> { phi_bb37_6, phi_bb37_7, phi_bb37_11 }, &block220,
            std::vector<compiler::Node*> { phi_bb37_6, phi_bb37_7, phi_bb37_11 });
    }
    ...
    if (block219.is_used()) {
        ...
        ca_.Branch(tmp323, &block227, std::vector<compiler::Node*> { phi_bb219_6, phi_bb219_7, phi_bb219_11, phi_bb219_11, phi_bb219_11 }, &block228,
            std::vector<compiler::Node*> { phi_bb219_6, phi_bb219_7, phi_bb219_11, phi_bb219_11, phi_bb219_11 });
    }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=1191&c=1
TNode<Smi> ComputeMinRunLength_0(compiler::CodeAssemblerState* state_, TNode<Smi> p_nArg)
{
    ...
    if (block6.is_used()) {
        ...
        tmp6 = CodeStubAssembler(state_).SmiSar(
            TNode<Smi> { phi_bb6_1 }, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))));
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=1207&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=1227&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=1255&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=1272&c=1
void ArrayTimSortImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_length)
{
    ...
    if (block7.is_used()) {
        ...
        BinaryInsertionSort_0(
            state_, TNode<Context> { p_context }, TNode<SortState> { p_sortState }, TNode<Smi> { phi_bb7_4 }, TNode<Smi> { tmp10 }, TNode<Smi> { tmp11 });
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=1306&c=1
TNode<Smi> CompactReceiverElementsIntoWorkArray_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, bool p_isToSorted)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block16.is_used()) {
        ...
        ca_.Branch(tmp19, &block14, std::vector<compiler::Node*> { phi_bb16_2, phi_bb16_3, phi_bb16_4, phi_bb16_7, phi_bb16_8, phi_bb16_9 }, &block15,
            std::vector<compiler::Node*> { phi_bb16_2, phi_bb16_3, phi_bb16_4, phi_bb16_7, phi_bb16_8, phi_bb16_9 });
    }
    ...
    if (block14.is_used()) {
        ...
        tmp20 = CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(5)), tmp9, p_context, p_sortState, phi_bb14_9);
        tmp21 = TheHole_0(state_);
        tmp22 = CodeStubAssembler(state_).TaggedEqual(TNode<Object> { tmp20 }, TNode<HeapObject> { tmp21 });
        ca_.Branch(tmp22, &block18, std::vector<compiler::Node*> { phi_bb14_2, phi_bb14_3, phi_bb14_4, phi_bb14_7, phi_bb14_8, phi_bb14_9 }, &block19,
            std::vector<compiler::Node*> { phi_bb14_2, phi_bb14_3, phi_bb14_4, phi_bb14_7, phi_bb14_8, phi_bb14_9 });
    }
    ...
    if (block19.is_used()) {
        ...
        ca_.Branch(tmp26, &block24, std::vector<compiler::Node*> { phi_bb19_2, phi_bb19_3, phi_bb19_4, phi_bb19_7, phi_bb19_8, phi_bb19_9 }, &block25,
            std::vector<compiler::Node*> { phi_bb19_2, phi_bb19_3, phi_bb19_4, phi_bb19_7, phi_bb19_8, phi_bb19_9 });
    }
    ...
    if (block25.is_used()) {
        ...
        ca_.Branch(tmp29, &block33, std::vector<compiler::Node*> { phi_bb25_2, phi_bb25_3, phi_bb25_4, phi_bb25_7, phi_bb25_8, phi_bb25_9 }, &block34,
            std::vector<compiler::Node*> { phi_bb25_2, phi_bb25_3, phi_bb25_4, phi_bb25_7, phi_bb25_8, phi_bb25_9 });
    }
    ...
    if (block33.is_used()) {
        ...
        tmp37 = ExtractFixedArray_0(
            state_, TNode<FixedArray> { phi_bb33_2 }, TNode<IntPtrT> { tmp35 }, TNode<IntPtrT> { phi_bb33_4 }, TNode<IntPtrT> { tmp34 }, TNode<Hole> { tmp36 });
    ...
    if (block34.is_used()) {
        ...
        tmp45 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp43 }, TNode<UintPtrT> { tmp44 });
        ca_.Branch(tmp45, &block52, std::vector<compiler::Node*> { phi_bb34_7, phi_bb34_8, phi_bb34_9, phi_bb34_4, phi_bb34_4, phi_bb34_4, phi_bb34_4 },
            &block53, std::vector<compiler::Node*> { phi_bb34_7, phi_bb34_8, phi_bb34_9, phi_bb34_4, phi_bb34_4, phi_bb34_4, phi_bb34_4 });
    }
...
void CopyWorkArrayToReceiver_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_sortState, TNode<Smi> p_numberOfNonUndefined)
{
    ...
    if (block10.is_used()) {
        ...
        tmp11 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT> { tmp8 });
        tmp12 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT> { tmp10 }, TNode<UintPtrT> { tmp11 });
        ca_.Branch(tmp12, &block18, std::vector<compiler::Node*> { phi_bb10_5, phi_bb10_5, phi_bb10_5, phi_bb10_5 }, &block19,
            std::vector<compiler::Node*> { phi_bb10_5, phi_bb10_5, phi_bb10_5, phi_bb10_5 });
    }
    ...
    if (block18.is_used()) {
        ...
        tmp17 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference { tmp15, tmp16 });
        tmp18 = UnsafeCast_JSAny_0(state_, TNode<Context> { p_context }, TNode<Object> { tmp17 });
        tmp19 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(6)), tmp1, p_context, p_sortState, phi_bb18_8, tmp18));
    ...
    if (block22.is_used()) {
        ...
        tmp27 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(6)), tmp1, p_context, p_sortState, phi_bb22_5, tmp26));
    ...
    if (block26.is_used()) {
        ...
        tmp35 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(7)), tmp33, p_context, p_sortState, phi_bb26_5));
...
TF_BUILTIN(ArrayPrototypeSort, CodeStubAssembler)
{
    ...
    if (block0.is_used()) {
        ...
        tmp2 = Cast_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_1(
            state_, TNode<Context> { parameter0 }, TNode<Object> { tmp1 }, &label3);
        ca_.Goto(&block3);
        if (label3.is_used()) {
            ca_.Bind(&label3);
            ca_.Goto(&block4);
...
TNode<Number> Method_SortState_Compare_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_this, TNode<Object> p_x, TNode<Object> p_y)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block0.is_used()) {
        ...
        tmp4 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(9)), tmp1, p_context, tmp3, p_x, p_y));
        ca_.Goto(&block2);
    }
...
void Method_SortState_CheckAccessor_0(
    compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<SortState> p_this, compiler::CodeAssemblerLabel* label_Bailout)
{
    compiler::CodeAssembler ca_(state_);
    compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
    compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    if (block4.is_used()) {
        ...
        tmp12 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(
            Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(8)), tmp5, p_context, tmp7, tmp9, tmp11));
...
void Method_SortState_ResetToGenericAccessor_0(compiler::CodeAssemblerState* state_, TNode<SortState> p_this, bool p_isToSorted)
{
    ...
    if (block2.is_used()) {
        ca_.Bind(&block2);
        tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 24);
        CodeStubAssembler(state_).StoreReference<BuiltinPtr>(CodeStubAssembler::Reference { p_this, tmp0 },
            ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoadNoHasPropertyCheck_GenericElementsAccessor_0)));
        ca_.Goto(&block4);
    }
    ...
    if (block3.is_used()) {
        ...
        CodeStubAssembler(state_).StoreReference<BuiltinPtr>(
            CodeStubAssembler::Reference { p_this, tmp1 }, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kLoad_GenericElementsAccessor_0)));
        ca_.Goto(&block4);
    }
    ...
    if (block4.is_used()) {
        ...
        CodeStubAssembler(state_).StoreReference<BuiltinPtr>(
            CodeStubAssembler::Reference { p_this, tmp2 }, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kStore_GenericElementsAccessor_0)));
        tmp3 = FromConstexpr_intptr_constexpr_int31_0(state_, 32);
        CodeStubAssembler(state_).StoreReference<BuiltinPtr>(
            CodeStubAssembler::Reference { p_this, tmp3 }, ca_.UncheckedCast<BuiltinPtr>(ca_.SmiConstant(Builtin::kDelete_GenericElementsAccessor_0)));
        ca_.Goto(&block5);
    }
...
TNode<SortState> DownCastForTorqueClass_SortState_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError)
{
    ...
    if (block4.is_used()) {
        ...
        tmp8 = FromConstexpr_int32_constexpr_int32_0(
            state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(284), static_cast<InstanceType>(284))));
        tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=264&c=18
