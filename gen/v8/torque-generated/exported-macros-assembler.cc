...
TNode<UintPtrT> TorqueGeneratedExportedMacrosAssembler::ChangeSafeIntegerNumberToUintPtr(
    TNode<Number> p_value, compiler::CodeAssemblerLabel* label_IfUIntPtrOverflow)
{
...
TNode<UintPtrT> TorqueGeneratedExportedMacrosAssembler::ToIndex(
    TNode<Context> p_context, TNode<Object> p_value, compiler::CodeAssemblerLabel* label_IfRangeError)
{
...
void TorqueGeneratedExportedMacrosAssembler::BranchIfFastJSArray(
    TNode<Object> p_o, TNode<Context> p_context, compiler::CodeAssemblerLabel* label_True, compiler::CodeAssemblerLabel* label_False)
{
...
void TorqueGeneratedExportedMacrosAssembler::BranchIfFastJSArrayForRead(
    TNode<Object> p_o, TNode<Context> p_context, compiler::CodeAssemblerLabel* label_True, compiler::CodeAssemblerLabel* label_False)
{
...
TorqueStructKeyValuePair TorqueGeneratedExportedMacrosAssembler::LoadKeyValuePairNoSideEffects(
    TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_MayHaveSideEffects)
{
...
void TorqueGeneratedExportedMacrosAssembler::CollectCallFeedback(TNode<Object> p_maybeTarget, std::function<TNode<Object>()> p_maybeReceiver,
    TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId)
{
...
void TorqueGeneratedExportedMacrosAssembler::CollectInstanceOfFeedback(
    TNode<Object> p_maybeTarget, TNode<Context> p_context, TNode<HeapObject> p_maybeFeedbackVector, TNode<UintPtrT> p_slotId)
{
...
void TorqueGeneratedExportedMacrosAssembler::CollectConstructFeedback(TNode<Context> p_context, TNode<Object> p_target, TNode<Object> p_newTarget,
    TNode<HeapObject> p_maybeFeedbackVector, TNode<TaggedIndex> p_slotId, UpdateFeedbackMode p_updateFeedbackMode,
    compiler::CodeAssemblerLabel* label_ConstructGeneric, compiler::CodeAssemblerLabel* label_ConstructArray,
    compiler::TypedCodeAssemblerVariable<AllocationSite>* label_ConstructArray_parameter_0)
{
    return CollectConstructFeedback_1(state_, p_context, p_target, p_newTarget, p_maybeFeedbackVector, p_slotId, p_updateFeedbackMode, label_ConstructGeneric,
        label_ConstructArray, label_ConstructArray_parameter_0);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/internal.tq?l=49&c=1
TNode<Object> TorqueGeneratedExportedMacrosAssembler::ForInNextSlow(TNode<Context> p_context, TNode<UintPtrT> p_slot, TNode<HeapObject> p_receiver,
    TNode<Object> p_key, TNode<Object> p_cacheType, TNode<HeapObject> p_maybeFeedbackVector, UpdateFeedbackMode p_guaranteedFeedback)
{
...
TorqueStructIteratorRecord TorqueGeneratedExportedMacrosAssembler::GetIteratorRecordAfterCreateAsyncFromSyncIterator(
    TNode<Context> p_context, TorqueStructIteratorRecord p_asyncIterator)
{
...
TNode<Context> TorqueGeneratedExportedMacrosAssembler::CreatePromiseCapabilitiesExecutorContext(
    TNode<NativeContext> p_nativeContext, TNode<PromiseCapability> p_capability)
{
...
TNode<PromiseCapability> TorqueGeneratedExportedMacrosAssembler::CreatePromiseCapability(
    TNode<HeapObject> p_promise, TNode<HeapObject> p_resolve, TNode<HeapObject> p_reject)
{
...
TorqueStructPromiseResolvingFunctions TorqueGeneratedExportedMacrosAssembler::CreatePromiseResolvingFunctions(
    TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<Boolean> p_debugEvent, TNode<NativeContext> p_nativeContext)
{
...
void TorqueGeneratedExportedMacrosAssembler::PerformPromiseThenImpl(TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<HeapObject> p_onFulfilled,
    TNode<HeapObject> p_onRejected, TNode<HeapObject> p_resultPromiseOrCapability)
{
...
TNode<Context> TorqueGeneratedExportedMacrosAssembler::CreatePromiseResolvingFunctionsContext(
    TNode<Context> p_context, TNode<JSPromise> p_promise, TNode<Boolean> p_debugEvent, TNode<NativeContext> p_nativeContext)
{
...
void TorqueGeneratedExportedMacrosAssembler::RunContextPromiseHookBefore(
    TNode<Context> p_context, TNode<HeapObject> p_promiseOrCapability, TNode<Uint32T> p_flags)
{
...
void TorqueGeneratedExportedMacrosAssembler::RunContextPromiseHookAfter(
    TNode<Context> p_context, TNode<HeapObject> p_promiseOrCapability, TNode<Uint32T> p_flags)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::RegExpPrototypeExecBodyFast(
    TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<String> p_string)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::RegExpPrototypeMatchAllImpl(
    TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_receiver, TNode<Object> p_string)
{
...
TNode<RegExpMatchInfo> TorqueGeneratedExportedMacrosAssembler::RegExpPrototypeExecBodyWithoutResultFast(
    TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, compiler::CodeAssemblerLabel* label_IfDidNotMatch)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::RegExpCreate(
    TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TNode<Object> p_maybeString, TNode<String> p_flags)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::RegExpCreate(
    TNode<Context> p_context, TNode<Map> p_initialMap, TNode<Object> p_maybeString, TNode<String> p_flags)
{
...
TNode<JSTypedArray> TorqueGeneratedExportedMacrosAssembler::TypedArrayCreateByLength(
    TNode<Context> p_context, TNode<JSReceiver> p_constructor, TNode<Number> p_length, const char* p_methodName)
{
...
TNode<JSTypedArray> TorqueGeneratedExportedMacrosAssembler::TypedArraySpeciesCreateByLength(
    TNode<Context> p_context, const char* p_methodName, TNode<JSTypedArray> p_exemplar, TNode<UintPtrT> p_length)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::SloppyArgumentsLoad(
    TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::SloppyArgumentsHas(
    TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::SloppyArgumentsStore(
    TNode<JSObject> p_receiver, TNode<Object> p_keyObject, TNode<Object> p_value, compiler::CodeAssemblerLabel* label_Bailout)
{
...
TNode<Object> TorqueGeneratedExportedMacrosAssembler::LoadScriptContextElement(TNode<Context> p_c, TNode<IntPtrT> p_i)
{
    return LoadScriptContextElement_0(state_, p_c, p_i);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=216&c=1
TNode<Object> TorqueGeneratedExportedMacrosAssembler::LoadScriptContextElement(TNode<Context> p_c, TNode<Smi> p_i)
{
    return LoadScriptContextElement_1(state_, p_c, p_i);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=221&c=1
TNode<Object> TorqueGeneratedExportedMacrosAssembler::LoadScriptContextElement(TNode<Context> p_c, int32_t p_i)
{
    return LoadScriptContextElement_2(state_, p_c, p_i);
}
...
TNode<JSArrayIterator> TorqueGeneratedExportedMacrosAssembler::CreateArrayIterator(
    TNode<NativeContext> p_context, TNode<JSReceiver> p_array, IterationKind p_kind, TNode<Number> p_nextIndex)
{
...
TNode<JSArrayIterator> TorqueGeneratedExportedMacrosAssembler::CreateArrayIterator(
    TNode<NativeContext> p_context, TNode<JSReceiver> p_array, IterationKind p_kind)
{
...
TNode<BoolT> TorqueGeneratedExportedMacrosAssembler::IsCompatiblePropertyDescriptor(
    TNode<BoolT> p_extensible, TNode<HeapObject> p_newDesc, TNode<HeapObject> p_current)
{
...
TNode<IntPtrT> TorqueGeneratedExportedMacrosAssembler::IndexOfLocalName(
    TNode<ScopeInfo> p_scopeInfo, TNode<Name> p_name, compiler::CodeAssemblerLabel* label_NotFound)
{
...
void TorqueGeneratedExportedMacrosAssembler::SwissNameDictionaryDelete(TNode<SwissNameDictionary> p_table, TNode<IntPtrT> p_entry,
    compiler::CodeAssemblerLabel* label_Shrunk, compiler::TypedCodeAssemblerVariable<SwissNameDictionary>* label_Shrunk_parameter_0)
{
...
void TorqueGeneratedExportedMacrosAssembler::SwissNameDictionaryFindEntrySIMD(TNode<SwissNameDictionary> p_table, TNode<Name> p_key,
    compiler::CodeAssemblerLabel* label_Found, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_Found_parameter_0,
    compiler::CodeAssemblerLabel* label_NotFound)
{
...
void TorqueGeneratedExportedMacrosAssembler::SwissNameDictionaryFindEntryPortable(TNode<SwissNameDictionary> p_table, TNode<Name> p_key,
    compiler::CodeAssemblerLabel* label_Found, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_Found_parameter_0,
    compiler::CodeAssemblerLabel* label_NotFound)
{
...
void TorqueGeneratedExportedMacrosAssembler::SwissNameDictionaryAddSIMD(
    TNode<SwissNameDictionary> p_table, TNode<Name> p_key, TNode<Object> p_value, TNode<Uint8T> p_propertyDetails, compiler::CodeAssemblerLabel* label_Bailout)
{
...
void TorqueGeneratedExportedMacrosAssembler::SwissNameDictionaryAddPortable(
    TNode<SwissNameDictionary> p_table, TNode<Name> p_key, TNode<Object> p_value, TNode<Uint8T> p_propertyDetails, compiler::CodeAssemblerLabel* label_Bailout)
{
...
void TorqueGeneratedExportedMacrosAssembler::TestBitFieldLoad(
    TNode<Uint8T> p_val, TNode<BoolT> p_expectedA, TNode<Uint16T> p_expectedB, TNode<Uint32T> p_expectedC, TNode<BoolT> p_expectedD)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=56&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSAPIObjectWithEmbedderSlotsCppHeapWrappable(
    TNode<JSAPIObjectWithEmbedderSlots> p_o, TNode<CppHeapPointerT> p_v)
{
...
TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceSloppyArgumentsElementsMappedEntries(
    TNode<SloppyArgumentsElements> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/arguments.tq?l=31&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreSloppyArgumentsElementsMappedEntries(
    TNode<SloppyArgumentsElements> p_o, TNode<IntPtrT> p_i, TNode<Object> p_v)
{
...
TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoContextLocalNamesHashtable(TNode<ScopeInfo> p_o)
{
...
TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoContextLocalInfos(TNode<ScopeInfo> p_o)
{
...
TorqueStructSlice_FunctionVariableInfo_MutableReference_FunctionVariableInfo_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoFunctionVariableInfo(
    TNode<ScopeInfo> p_o)
{
...
TorqueStructSlice_Undefined_OR_String_MutableReference_Undefined_OR_String_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoInferredFunctionName(
    TNode<ScopeInfo> p_o)
{
...
TorqueStructSlice_TheHole_OR_ScopeInfo_MutableReference_TheHole_OR_ScopeInfo_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoOuterScopeInfo(
    TNode<ScopeInfo> p_o)
{
...
TorqueStructSlice_SourceTextModuleInfo_MutableReference_SourceTextModuleInfo_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoModuleInfo(
    TNode<ScopeInfo> p_o)
{
...
TorqueStructSlice_ModuleVariable_MutableReference_ModuleVariable_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceScopeInfoModuleVariables(
    TNode<ScopeInfo> p_o)
{
...
TorqueStructSlice_float64_or_hole_MutableReference_float64_or_hole_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceFixedDoubleArrayValues(
    TNode<FixedDoubleArray> p_o)
{
...
TorqueStructSlice_CoverageInfoSlot_MutableReference_CoverageInfoSlot_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceCoverageInfoSlots(
    TNode<CoverageInfo> p_o)
{
...
TorqueStructSlice_DescriptorEntry_MutableReference_DescriptorEntry_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceDescriptorArrayDescriptors(
    TNode<DescriptorArray> p_o)
{
...
TorqueStructSlice_FeedbackCell_MutableReference_FeedbackCell_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceClosureFeedbackCellArrayObjects(
    TNode<ClosureFeedbackCellArray> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=41&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreClosureFeedbackCellArrayObjects(
    TNode<ClosureFeedbackCellArray> p_o, TNode<IntPtrT> p_i, TNode<FeedbackCell> p_v)
{
    return StoreClosureFeedbackCellArrayObjects_0(state_, p_o, p_i, p_v);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=46&c=9
...
TorqueStructSlice_MaybeObject_MutableReference_MaybeObject_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceFeedbackVectorRawFeedbackSlots(
    TNode<FeedbackVector> p_o)
{
...
TorqueStructSlice_Smi_OR_TrustedObject_MutableReference_Smi_OR_TrustedObject_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceProtectedFixedArrayObjects(
    TNode<ProtectedFixedArray> p_o)
{
...
TorqueStructSlice_MaybeObject_MutableReference_MaybeObject_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceTrustedWeakFixedArrayObjects(
    TNode<TrustedWeakFixedArray> p_o)
{
...
TNode<HeapObject> TorqueGeneratedExportedMacrosAssembler::LoadJSMessageObjectStackTrace(TNode<JSMessageObject> p_o)
{
    return LoadJSMessageObjectStackTrace_0(state_, p_o);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=135&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreJSMessageObjectStackTrace(TNode<JSMessageObject> p_o, TNode<HeapObject> p_v)
{
...
TorqueStructSlice_Object_MutableReference_Object_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceObjectBoilerplateDescriptionRawEntries(
    TNode<ObjectBoilerplateDescription> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/literal-objects.tq?l=10&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreObjectBoilerplateDescriptionRawEntries(
    TNode<ObjectBoilerplateDescription> p_o, TNode<IntPtrT> p_i, TNode<Object> p_v)
{
...
TorqueStructSlice_JSReceiver_OR_Undefined_OR_Null_OR_Boolean_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_MutableReference_JSReceiver_OR_Undefined_OR_Null_OR_Boolean_OR_Symbol_OR_String_OR_BigInt_OR_HeapNumber_OR_Smi_OR_TheHole_0
...
TorqueStructSlice_HashMapEntry_MutableReference_HashMapEntry_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceSmallOrderedHashMapDataTable(
    TNode<SmallOrderedHashMap> p_o)
{
...
TorqueStructSlice_uint8_MutableReference_uint8_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceSmallOrderedNameDictionaryPadding1(
    TNode<SmallOrderedNameDictionary> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/ordered-hash-table.tq?l=110&c=31
void TorqueGeneratedExportedMacrosAssembler::StoreSmallOrderedNameDictionaryPadding1(
    TNode<SmallOrderedNameDictionary> p_o, TNode<IntPtrT> p_i, TNode<Uint8T> p_v)
{
...
TorqueStructSlice_NameDictionaryEntry_MutableReference_NameDictionaryEntry_0
TorqueGeneratedExportedMacrosAssembler::FieldSliceSmallOrderedNameDictionaryDataTable(TNode<SmallOrderedNameDictionary> p_o)
{
...
TorqueStructSlice_uint8_MutableReference_uint8_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceSmallOrderedNameDictionaryHashTable(
    TNode<SmallOrderedNameDictionary> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/ordered-hash-table.tq?l=113&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreSmallOrderedNameDictionaryHashTable(
    TNode<SmallOrderedNameDictionary> p_o, TNode<IntPtrT> p_i, TNode<Uint8T> p_v)
{
...
TorqueStructSlice_uint8_MutableReference_uint8_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceSmallOrderedNameDictionaryChainTable(
    TNode<SmallOrderedNameDictionary> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/ordered-hash-table.tq?l=114&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreSmallOrderedNameDictionaryChainTable(
    TNode<SmallOrderedNameDictionary> p_o, TNode<IntPtrT> p_i, TNode<Uint8T> p_v)
{
...
TNode<Smi> TorqueGeneratedExportedMacrosAssembler::LoadContextSidePropertyCellPropertyDetailsRaw(TNode<ContextSidePropertyCell> p_o)
{
    return LoadContextSidePropertyCellPropertyDetailsRaw_0(state_, p_o);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/property-cell.tq?l=15&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreContextSidePropertyCellPropertyDetailsRaw(TNode<ContextSidePropertyCell> p_o, TNode<Smi> p_v)
{
    return StoreContextSidePropertyCellPropertyDetailsRaw_0(state_, p_o, p_v);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/property-cell.tq?l=16&c=3
TNode<WeakArrayList> TorqueGeneratedExportedMacrosAssembler::LoadContextSidePropertyCellDependentCode(TNode<ContextSidePropertyCell> p_o)
{
    return LoadContextSidePropertyCellDependentCode_0(state_, p_o);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/property-cell.tq?l=16&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreContextSidePropertyCellDependentCode(TNode<ContextSidePropertyCell> p_o, TNode<WeakArrayList> p_v)
{
    return StoreContextSidePropertyCellDependentCode_0(state_, p_o, p_v);
}
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=162&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreUncompiledDataWithoutPreparseDataWithJobJob(
    TNode<UncompiledDataWithoutPreparseDataWithJob> p_o, TNode<RawPtrT> p_v)
{
...
TorqueStructSlice_uint8_MutableReference_uint8_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceSwissNameDictionaryPropertyDetailsTable(
...
TorqueStructSlice_uint32_MutableReference_uint32_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceTurboshaftWord32SetTypeElements(
    TNode<TurboshaftWord32SetType> p_o)
{
...
TorqueStructSlice_uint32_MutableReference_uint32_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceTurboshaftWord64SetTypeElementsHigh(
    TNode<TurboshaftWord64SetType> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/turboshaft-types.tq?l=61&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreTurboshaftWord64SetTypeElementsHigh(
    TNode<TurboshaftWord64SetType> p_o, TNode<IntPtrT> p_i, TNode<Uint32T> p_v)
{
...
TorqueStructSlice_uint32_MutableReference_uint32_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceTurboshaftWord64SetTypeElementsLow(
    TNode<TurboshaftWord64SetType> p_o)
{
...
TorqueStructSlice_float64_MutableReference_float64_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceTurboshaftFloat64SetTypeElements(
    TNode<TurboshaftFloat64SetType> p_o)
{
...
TorqueStructSlice_Smi_MutableReference_Smi_0 TorqueGeneratedExportedMacrosAssembler::FieldSliceInternalClassWithStructElementsEntries(
    TNode<InternalClassWithStructElements> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1201&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreInternalClassWithStructElementsEntries(
    TNode<InternalClassWithStructElements> p_o, TNode<IntPtrT> p_i, TNode<Smi> p_v)
{
...
TorqueGeneratedExportedMacrosAssembler::FieldSliceInternalClassWithStructElementsMoreEntries(TNode<InternalClassWithStructElements> p_o)
{
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=243&c=3
...
TNode<Uint32T> TorqueGeneratedExportedMacrosAssembler::LoadWasmTypeInfoModuleTypeIndex(TNode<WasmTypeInfo> p_o)
{
    return LoadWasmTypeInfoModuleTypeIndex_0(state_, p_o);
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=286&c=3
void TorqueGeneratedExportedMacrosAssembler::StoreWasmTypeInfoModuleTypeIndex(TNode<WasmTypeInfo> p_o, TNode<Uint32T> p_v)
{
    return StoreWasmTypeInfoModuleTypeIndex_0(state_, p_o, p_v);
}
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=291&c=9
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=292&c=3
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=315&c=3
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=327&c=3
