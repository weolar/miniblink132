...
std::vector<std::unique_ptr<ObjectProperty>> TqHeapObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "map", "v8::internal::TaggedMember<v8::internal::Map>", GetMapAddress(), 1, 4, std::move(map_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSReceiver::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("properties_or_hash", "v8::internal::TaggedMember<v8::internal::Object>", GetPropertiesOrHashAddress(), 1,
        4, std::move(properties_or_hash_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqOddball::GetToNumberRawValue(
...
std::vector<std::unique_ptr<ObjectProperty>> TqOddball::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("to_number_raw",
        CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"),
        GetToNumberRawAddress(), 1, 8, std::move(to_number_raw_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> to_string_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("to_string", "v8::internal::TaggedMember<v8::internal::String>", GetToStringAddress(), 1, 4,
        std::move(to_string_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> to_number_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("to_number", "v8::internal::TaggedMember<v8::internal::Object>", GetToNumberAddress(), 1, 4,
        std::move(to_number_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> type_of_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("type_of", "v8::internal::TaggedMember<v8::internal::String>", GetTypeOfAddress(), 1, 4,
        std::move(type_of_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> kind_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "kind", "v8::internal::TaggedMember<v8::internal::Object>", GetKindAddress(), 1, 4, std::move(kind_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqName::GetRawHashFieldValue(
    d::MemoryAccessor accessor) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqName::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    raw_hash_field_struct_field_list.push_back(std::make_unique<StructProperty>("hash_field_type",
        CheckTypeName<Name::HashFieldType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "Name::HashFieldType"),
        0, 2, 0));
    raw_hash_field_struct_field_list.push_back(std::make_unique<StructProperty>("array_index_value",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 24, 2));
    raw_hash_field_struct_field_list.push_back(std::make_unique<StructProperty>("array_index_length",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 6, 26));
    result.push_back(std::make_unique<ObjectProperty>("raw_hash_field",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetRawHashFieldAddress(), 1, 4, std::move(raw_hash_field_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSymbol::GetFlagsValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqSymbol::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_private", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_well_known_symbol",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_in_public_symbol_table",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_interesting_symbol",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_private_name",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_private_brand",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    result.push_back(std::make_unique<ObjectProperty>("flags",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> description_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("description", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetDescriptionAddress(),
        1, 4, std::move(description_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqString::GetLengthValue(
    d::MemoryAccessor accessor) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqString::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("length",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetLengthAddress(),
        1, 4, std::move(length_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqHeapNumber::GetValueValue(
    d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqHeapNumber::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("value",
        CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"), GetValueAddress(), 1,
        8, std::move(value_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqContext::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "length", "v8::internal::TaggedMember<v8::internal::Object>", GetLengthAddress(), 1, 4, std::move(length_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_elements.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("elements", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_elements.value), std::get<2>(indexed_field_slice_elements.value), 4,
            std::move(elements_struct_field_list), GetArrayKind(indexed_field_slice_elements.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> elements_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("elements", "v8::internal::TaggedMember<v8::internal::FixedArrayBase>", GetElementsAddress(), 1, 4,
        std::move(elements_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSPromise::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("reactions_or_result", "v8::internal::TaggedMember<v8::internal::Object>", GetReactionsOrResultAddress(),
        1, 4, std::move(reactions_or_result_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("status",
        CheckTypeName<Promise::PromiseState /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "Promise::PromiseState"),
        0, 2, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "has_handler", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_silent", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("async_task_id",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 27, 5));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSFunction::GetCodeValue(
    d::MemoryAccessor accessor) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSFunction::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("code",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetCodeAddress(), 1, 4, std::move(code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> shared_function_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("shared_function_info", "v8::internal::TaggedMember<v8::internal::SharedFunctionInfo>",
        GetSharedFunctionInfoAddress(), 1, 4, std::move(shared_function_info_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("context", "v8::internal::TaggedMember<v8::internal::Context>", GetContextAddress(), 1, 4,
        std::move(context_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> feedback_cell_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("feedback_cell", "v8::internal::TaggedMember<v8::internal::FeedbackCell>", GetFeedbackCellAddress(), 1, 4,
        std::move(feedback_cell_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> prototype_or_initial_map_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("prototype_or_initial_map", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetPrototypeOrInitialMapAddress(), 1, 4, std::move(prototype_or_initial_map_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqFixedArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_objects.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("objects", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_objects.value), std::get<2>(indexed_field_slice_objects.value), 4,
            std::move(objects_struct_field_list), GetArrayKind(indexed_field_slice_objects.validity)));
    }
    return result;
}
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqForeign::GetForeignAddressValue(
    d::MemoryAccessor accessor) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqForeign::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("foreign_address",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetForeignAddressAddress(), 1, 4, std::move(foreign_address_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSProxy::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("target", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetTargetAddress(), 1, 4,
        std::move(target_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> handler_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("handler", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetHandlerAddress(), 1, 4,
        std::move(handler_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSWrappedFunction::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("wrapped_target_function", "v8::internal::TaggedMember<v8::internal::JSReceiver>",
        GetWrappedTargetFunctionAddress(), 1, 4, std::move(wrapped_target_function_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("context", "v8::internal::TaggedMember<v8::internal::NativeContext>", GetContextAddress(), 1, 4,
        std::move(context_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSBoundFunction::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("bound_target_function", "v8::internal::TaggedMember<v8::internal::JSReceiver>",
        GetBoundTargetFunctionAddress(), 1, 4, std::move(bound_target_function_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_this_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_this", "v8::internal::TaggedMember<v8::internal::Object>", GetBoundThisAddress(), 1, 4,
        std::move(bound_this_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_arguments_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_arguments", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetBoundArgumentsAddress(), 1,
        4, std::move(bound_arguments_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqHole::GetRawNumericValueValue(
    d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqHole::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("raw_numeric_value",
        CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"),
        GetRawNumericValueAddress(), 1, 8, std::move(raw_numeric_value_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<CppHeapPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqJSAPIObjectWithEmbedderSlots::GetCppHeapWrappableValue(d::MemoryAccessor accessor) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSAPIObjectWithEmbedderSlots::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("cpp_heap_wrappable",
        CheckTypeName<CppHeapPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("CppHeapPointer_t"),
        GetCppHeapWrappableAddress(), 1, 4, std::move(cpp_heap_wrappable_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<CppHeapPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqJSSpecialObject::GetCppHeapWrappableValue(d::MemoryAccessor accessor) const
{
    CppHeapPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetCppHeapWrappableAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmFuncRef::GetTrustedInternalValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmFuncRef::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("trusted_internal",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetTrustedInternalAddress(), 1, 4, std::move(trusted_internal_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqTemplateInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("serial_number", "v8::internal::TaggedMember<v8::internal::Object>", GetSerialNumberAddress(), 1, 4,
        std::move(serial_number_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> number_of_properties_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("number_of_properties", "v8::internal::TaggedMember<v8::internal::Object>",
        GetNumberOfPropertiesAddress(), 1, 4, std::move(number_of_properties_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> property_list_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("property_list", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetPropertyListAddress(), 1, 4,
        std::move(property_list_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> property_accessors_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("property_accessors", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetPropertyAccessorsAddress(), 1, 4, std::move(property_accessors_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqFunctionTemplateInfo::GetFlagValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<int16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqFunctionTemplateInfo::GetLengthValue(
    d::MemoryAccessor accessor) const
{
...
Value<InstanceType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqFunctionTemplateInfo::GetInstanceTypeValue(d::MemoryAccessor accessor) const
{
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqFunctionTemplateInfo::GetExceptionContextValue(d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqFunctionTemplateInfo::GetMaybeRedirectedCallbackValue(d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqFunctionTemplateInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("class_name", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetClassNameAddress(), 1,
        4, std::move(class_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> interface_name_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("interface_name", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>",
        GetInterfaceNameAddress(), 1, 4, std::move(interface_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> signature_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("signature", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetSignatureAddress(), 1, 4,
        std::move(signature_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> rare_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("rare_data", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetRareDataAddress(), 1, 4,
        std::move(rare_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> shared_function_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("shared_function_info", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetSharedFunctionInfoAddress(), 1, 4, std::move(shared_function_info_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> cached_property_name_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("cached_property_name", "v8::internal::TaggedMember<v8::internal::Object>",
        GetCachedPropertyNameAddress(), 1, 4, std::move(cached_property_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> callback_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("callback_data", "v8::internal::TaggedMember<v8::internal::Object>", GetCallbackDataAddress(), 1, 4,
        std::move(callback_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flag_struct_field_list;
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("is_object_template_call_handler",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("has_side_effects",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("undetectable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("needs_access_check",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("read_only_prototype",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("remove_prototype",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("accept_any_receiver",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>(
        "published", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("allowed_receiver_instance_type_range_start",
        CheckTypeName<InstanceType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("InstanceType"), 0, 12,
        8));
    flag_struct_field_list.push_back(std::make_unique<StructProperty>("allowed_receiver_instance_type_range_end",
        CheckTypeName<InstanceType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("InstanceType"), 0, 12,
        20));
    result.push_back(std::make_unique<ObjectProperty>("flag",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), GetFlagAddress(),
        1, 4, std::move(flag_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("length",
        CheckTypeName<int16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int16_t"), GetLengthAddress(),
        1, 2, std::move(length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_type_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_type",
        CheckTypeName<InstanceType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("InstanceType"),
        GetInstanceTypeAddress(), 1, 2, std::move(instance_type_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> exception_context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("exception_context",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetExceptionContextAddress(), 1, 4, std::move(exception_context_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> maybe_redirected_callback_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("maybe_redirected_callback",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetMaybeRedirectedCallbackAddress(), 1, 4, std::move(maybe_redirected_callback_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWeakCell::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("finalization_registry", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetFinalizationRegistryAddress(), 1, 4, std::move(finalization_registry_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> target_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("target", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetTargetAddress(), 1, 4,
        std::move(target_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> unregister_token_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("unregister_token", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetUnregisterTokenAddress(),
        1, 4, std::move(unregister_token_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> holdings_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("holdings", "v8::internal::TaggedMember<v8::internal::Object>", GetHoldingsAddress(), 1, 4,
        std::move(holdings_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> prev_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "prev", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetPrevAddress(), 1, 4, std::move(prev_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> next_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "next", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetNextAddress(), 1, 4, std::move(next_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> key_list_prev_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("key_list_prev", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetKeyListPrevAddress(), 1, 4,
        std::move(key_list_prev_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> key_list_next_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("key_list_next", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetKeyListNextAddress(), 1, 4,
        std::move(key_list_next_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqMap::GetInstanceSizeInWordsValue(
    d::MemoryAccessor accessor) const
{
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqMap::GetInobjectPropertiesStartOrConstructorFunctionIndexValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqMap::GetUsedOrUnusedInstanceSizeInWordsValue(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqMap::GetVisitorIdValue(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<InstanceType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqMap::GetInstanceTypeValue(
    d::MemoryAccessor accessor) const
{
    InstanceType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetInstanceTypeAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqMap::GetBitFieldValue(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqMap::GetBitField2Value(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqMap::GetBitField3Value(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqMap::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("instance_size_in_words",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetInstanceSizeInWordsAddress(), 1, 1, std::move(instance_size_in_words_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> inobject_properties_start_or_constructor_function_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("inobject_properties_start_or_constructor_function_index",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetInobjectPropertiesStartOrConstructorFunctionIndexAddress(), 1, 1,
        std::move(inobject_properties_start_or_constructor_function_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> used_or_unused_instance_size_in_words_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("used_or_unused_instance_size_in_words",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetUsedOrUnusedInstanceSizeInWordsAddress(), 1, 1, std::move(used_or_unused_instance_size_in_words_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> visitor_id_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("visitor_id",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetVisitorIdAddress(), 1, 1, std::move(visitor_id_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_type_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_type",
        CheckTypeName<InstanceType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("InstanceType"),
        GetInstanceTypeAddress(), 1, 2, std::move(instance_type_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bit_field_struct_field_list;
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("has_non_instance_prototype",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_callable", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("has_named_interceptor",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("has_indexed_interceptor",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_undetectable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_access_check_needed",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_constructor",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("has_prototype_slot",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    result.push_back(std::make_unique<ObjectProperty>("bit_field",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetBitFieldAddress(), 1, 1, std::move(bit_field_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bit_field2_struct_field_list;
    bit_field2_struct_field_list.push_back(std::make_unique<StructProperty>("new_target_is_base",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    bit_field2_struct_field_list.push_back(std::make_unique<StructProperty>("is_immutable_prototype",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    bit_field2_struct_field_list.push_back(std::make_unique<StructProperty>("elements_kind",
        CheckTypeName<ElementsKind /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ElementsKind"), 0, 6,
        2));
    result.push_back(std::make_unique<ObjectProperty>("bit_field2",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetBitField2Address(), 1, 1, std::move(bit_field2_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bit_field3_struct_field_list;
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("enum_length",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 0));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("number_of_own_descriptors",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 10));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("is_prototype_map",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 20));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("is_dictionary_map",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 21));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("owns_descriptors",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 22));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("is_in_retained_map_list",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 23));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("is_deprecated",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 24));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("is_unstable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 25));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("is_migration_target",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 26));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("is_extensible",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 27));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("may_have_interesting_properties",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 28));
    bit_field3_struct_field_list.push_back(std::make_unique<StructProperty>("construction_counter",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 3, 29));
    result.push_back(std::make_unique<ObjectProperty>("bit_field3",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetBitField3Address(), 1, 4, std::move(bit_field3_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> prototype_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("prototype", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetPrototypeAddress(), 1, 4,
        std::move(prototype_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> constructor_or_back_pointer_or_native_context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("constructor_or_back_pointer_or_native_context", "v8::internal::TaggedMember<v8::internal::Object>",
        GetConstructorOrBackPointerOrNativeContextAddress(), 1, 4, std::move(constructor_or_back_pointer_or_native_context_struct_field_list),
        d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_descriptors_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_descriptors", "v8::internal::TaggedMember<v8::internal::DescriptorArray>",
        GetInstanceDescriptorsAddress(), 1, 4, std::move(instance_descriptors_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> dependent_code_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("dependent_code", "v8::internal::TaggedMember<v8::internal::WeakArrayList>", GetDependentCodeAddress(), 1,
        4, std::move(dependent_code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> prototype_validity_cell_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("prototype_validity_cell", "v8::internal::TaggedMember<v8::internal::Object>",
        GetPrototypeValidityCellAddress(), 1, 4, std::move(prototype_validity_cell_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> transitions_or_prototype_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("transitions_or_prototype_info", "v8::internal::TaggedMember<v8::internal::Object>",
        GetTransitionsOrPrototypeInfoAddress(), 1, 4, std::move(transitions_or_prototype_info_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSCollection::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "table", "v8::internal::TaggedMember<v8::internal::Object>", GetTableAddress(), 1, 4, std::move(table_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqPromiseCapability::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("promise", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetPromiseAddress(), 1, 4,
        std::move(promise_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> resolve_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("resolve", "v8::internal::TaggedMember<v8::internal::Object>", GetResolveAddress(), 1, 4,
        std::move(resolve_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> reject_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "reject", "v8::internal::TaggedMember<v8::internal::Object>", GetRejectAddress(), 1, 4, std::move(reject_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBufferView::GetBitFieldValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetBitFieldAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBufferView::GetRawByteOffsetValue(
    d::MemoryAccessor accessor) const
{
...
Value<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBufferView::GetRawByteLengthValue(
    d::MemoryAccessor accessor) const
{
    uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSArrayBufferView::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("buffer", "v8::internal::TaggedMember<v8::internal::JSArrayBuffer>", GetBufferAddress(), 1, 4,
        std::move(buffer_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bit_field_struct_field_list;
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_length_tracking",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_backed_by_rab",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    result.push_back(std::make_unique<ObjectProperty>("bit_field",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetBitFieldAddress(), 1, 4, std::move(bit_field_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_byte_offset_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("raw_byte_offset",
        CheckTypeName<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uintptr_t"),
        GetRawByteOffsetAddress(), 1, 4, std::move(raw_byte_offset_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_byte_length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("raw_byte_length",
        CheckTypeName<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uintptr_t"),
        GetRawByteLengthAddress(), 1, 4, std::move(raw_byte_length_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSTypedArray::GetRawLengthValue(
    d::MemoryAccessor accessor) const
{
    uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSTypedArray::GetExternalPointerValue(
    d::MemoryAccessor accessor) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTypedArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("raw_length",
        CheckTypeName<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uintptr_t"),
        GetRawLengthAddress(), 1, 4, std::move(raw_length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> external_pointer_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("external_pointer",
        CheckTypeName<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("Address"),
        GetExternalPointerAddress(), 1, 4, std::move(external_pointer_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> base_pointer_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("base_pointer", "v8::internal::TaggedMember<v8::internal::Object>", GetBasePointerAddress(), 1, 4,
        std::move(base_pointer_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqDataHandler::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("smi_handler", "v8::internal::TaggedMember<v8::internal::Object>", GetSmiHandlerAddress(), 1, 4,
        std::move(smi_handler_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> validity_cell_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("validity_cell", "v8::internal::TaggedMember<v8::internal::Object>", GetValidityCellAddress(), 1, 4,
        std::move(validity_cell_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data1_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data1", "v8::internal::TaggedMember<v8::internal::Object>", GetData1Address(), 1, 4, std::move(data1_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data2_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data2", "v8::internal::TaggedMember<v8::internal::Object>", GetData2Address(), 1, 4, std::move(data2_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data3_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data3", "v8::internal::TaggedMember<v8::internal::Object>", GetData3Address(), 1, 4, std::move(data3_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqAllocationMemento::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("allocation_site", "v8::internal::TaggedMember<v8::internal::AllocationSite>", GetAllocationSiteAddress(),
        1, 4, std::move(allocation_site_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqInterceptorInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "getter", "v8::internal::TaggedMember<v8::internal::Object>", GetGetterAddress(), 1, 4, std::move(getter_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> setter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "setter", "v8::internal::TaggedMember<v8::internal::Object>", GetSetterAddress(), 1, 4, std::move(setter_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> query_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "query", "v8::internal::TaggedMember<v8::internal::Object>", GetQueryAddress(), 1, 4, std::move(query_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> descriptor_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("descriptor", "v8::internal::TaggedMember<v8::internal::Object>", GetDescriptorAddress(), 1, 4,
        std::move(descriptor_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> deleter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("deleter", "v8::internal::TaggedMember<v8::internal::Object>", GetDeleterAddress(), 1, 4,
        std::move(deleter_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> enumerator_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("enumerator", "v8::internal::TaggedMember<v8::internal::Object>", GetEnumeratorAddress(), 1, 4,
        std::move(enumerator_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> definer_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("definer", "v8::internal::TaggedMember<v8::internal::Object>", GetDefinerAddress(), 1, 4,
        std::move(definer_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data", "v8::internal::TaggedMember<v8::internal::Object>", GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("can_intercept_symbols",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "non_masking", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "named", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_no_side_effect",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_new_callbacks_signature",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqAccessCheckInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("callback", "v8::internal::TaggedMember<v8::internal::Object>", GetCallbackAddress(), 1, 4,
        std::move(callback_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> named_interceptor_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("named_interceptor", "v8::internal::TaggedMember<v8::internal::Object>", GetNamedInterceptorAddress(), 1,
        4, std::move(named_interceptor_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> indexed_interceptor_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("indexed_interceptor", "v8::internal::TaggedMember<v8::internal::Object>", GetIndexedInterceptorAddress(),
        1, 4, std::move(indexed_interceptor_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data", "v8::internal::TaggedMember<v8::internal::Object>", GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqAccessorInfo::GetMaybeRedirectedGetterValue(d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqAccessorInfo::GetSetterValue(
    d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetSetterAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqAccessorInfo::GetFlagsValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetFlagsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqAccessorInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "name", "v8::internal::TaggedMember<v8::internal::Name>", GetNameAddress(), 1, 4, std::move(name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data", "v8::internal::TaggedMember<v8::internal::Object>", GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> maybe_redirected_getter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("maybe_redirected_getter",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetMaybeRedirectedGetterAddress(), 1, 4, std::move(maybe_redirected_getter_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> setter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("setter",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetSetterAddress(), 1, 4, std::move(setter_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_sloppy", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("replace_on_access",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("getter_side_effect_type",
        CheckTypeName<SideEffectType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("SideEffectType"), 0, 2,
        2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("setter_side_effect_type",
        CheckTypeName<SideEffectType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("SideEffectType"), 0, 2,
        4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("initial_attributes",
        CheckTypeName<PropertyAttributes /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "PropertyAttributes"),
        0, 3, 6));
    result.push_back(std::make_unique<ObjectProperty>("flags",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSSloppyArgumentsObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "callee", "v8::internal::TaggedMember<v8::internal::Object>", GetCalleeAddress(), 1, 4, std::move(callee_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqSloppyArgumentsElements::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("arguments", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetArgumentsAddress(), 1, 4,
        std::move(arguments_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_mapped_entries.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("mapped_entries", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_mapped_entries.value), std::get<2>(indexed_field_slice_mapped_entries.value), 4,
            std::move(mapped_entries_struct_field_list), GetArrayKind(indexed_field_slice_mapped_entries.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqAliasedArgumentsEntry::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("aliased_context_slot", "v8::internal::TaggedMember<v8::internal::Object>",
        GetAliasedContextSlotAddress(), 1, 4, std::move(aliased_context_slot_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqCallSiteInfo::GetCodeObjectValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqCallSiteInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("code_object",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetCodeObjectAddress(), 1, 4, std::move(code_object_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> receiver_or_instance_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("receiver_or_instance", "v8::internal::TaggedMember<v8::internal::Object>",
        GetReceiverOrInstanceAddress(), 1, 4, std::move(receiver_or_instance_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> function_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("function", "v8::internal::TaggedMember<v8::internal::Object>", GetFunctionAddress(), 1, 4,
        std::move(function_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> code_offset_or_source_position_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("code_offset_or_source_position", "v8::internal::TaggedMember<v8::internal::Object>",
        GetCodeOffsetOrSourcePositionAddress(), 1, 4, std::move(code_offset_or_source_position_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_wasm", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_asm_js_wasm",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_strict", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_constructor",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_asm_js_at_number_conversion",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_async", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_builtin", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_source_position_computed",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 8));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> parameters_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parameters", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetParametersAddress(), 1, 4,
        std::move(parameters_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqCell::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> value_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "value", "v8::internal::TaggedMember<v8::internal::Object>", GetValueAddress(), 1, 4, std::move(value_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWeakArrayList::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("capacity", "v8::internal::TaggedMember<v8::internal::Object>", GetCapacityAddress(), 1, 4,
        std::move(capacity_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "length", "v8::internal::TaggedMember<v8::internal::Object>", GetLengthAddress(), 1, 4, std::move(length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> objects_struct_field_list;
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqBytecodeArray::GetFrameSizeValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqBytecodeArray::GetParameterSizeValue(
    d::MemoryAccessor accessor) const
{
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqBytecodeArray::GetMaxArgumentsValue(
    d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqBytecodeArray::GetIncomingNewTargetOrGeneratorRegisterValue(d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqBytecodeArray::GetBytesValue(
    d::MemoryAccessor accessor, size_t offset) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqBytecodeArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("wrapper", "v8::internal::TaggedMember<v8::internal::BytecodeWrapper>", GetWrapperAddress(), 1, 4,
        std::move(wrapper_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> source_position_table_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("source_position_table", "v8::internal::TaggedMember<v8::internal::Object>",
        GetSourcePositionTableAddress(), 1, 4, std::move(source_position_table_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> handler_table_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("handler_table", "v8::internal::TaggedMember<v8::internal::Object>", GetHandlerTableAddress(), 1, 4,
        std::move(handler_table_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> constant_pool_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("constant_pool", "v8::internal::TaggedMember<v8::internal::Object>", GetConstantPoolAddress(), 1, 4,
        std::move(constant_pool_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> frame_size_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("frame_size",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetFrameSizeAddress(), 1, 4, std::move(frame_size_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> parameter_size_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parameter_size",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetParameterSizeAddress(), 1, 2, std::move(parameter_size_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> max_arguments_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("max_arguments",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetMaxArgumentsAddress(), 1, 2, std::move(max_arguments_struct_field_list), d::PropertyKind::kSingle));
    ...
    result.push_back(std::make_unique<ObjectProperty>("incoming_new_target_or_generator_register",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetIncomingNewTargetOrGeneratorRegisterAddress(), 1, 4, std::move(incoming_new_target_or_generator_register_struct_field_list),
        d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_bytes.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("bytes",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_bytes.value), std::get<2>(indexed_field_slice_bytes.value), 1,
            std::move(bytes_struct_field_list), GetArrayKind(indexed_field_slice_bytes.validity)));
    }
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqBytecodeWrapper::GetBytecodeValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqBytecodeWrapper::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("bytecode",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetBytecodeAddress(), 1, 4, std::move(bytecode_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqScriptContextTable::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("names_to_context_index", "v8::internal::TaggedMember<v8::internal::NameToIndexHashTable>",
        GetNamesToContextIndexAddress(), 1, 4, std::move(names_to_context_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> objects_struct_field_list;
    auto indexed_field_slice_objects = TqDebugFieldSliceScriptContextTableObjects(accessor, address_);
    if (indexed_field_slice_objects.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("objects", "v8::internal::TaggedMember<v8::internal::Context>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_objects.value), std::get<2>(indexed_field_slice_objects.value), 4,
            std::move(objects_struct_field_list), GetArrayKind(indexed_field_slice_objects.validity)));
    }
    return result;
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqScopeInfo::GetFlagsValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetFlagsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqScopeInfo::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("scope_type",
        CheckTypeName<ScopeType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ScopeType"), 0, 4, 0));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("sloppy_eval_can_extend_vars",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("language_mode",
        CheckTypeName<LanguageMode /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("LanguageMode"), 0, 1,
        5));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("declaration_scope",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("receiver_variable",
        CheckTypeName<VariableAllocationInfo /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "VariableAllocationInfo"),
        0, 2, 7));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("class_scope_has_private_brand",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 9));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_saved_class_variable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 10));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_new_target",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 11));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("function_variable",
        CheckTypeName<VariableAllocationInfo /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "VariableAllocationInfo"),
        0, 2, 12));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_inferred_function_name",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 14));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_asm_module",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 15));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_simple_parameters",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 16));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("function_kind",
        CheckTypeName<FunctionKind /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("FunctionKind"), 0, 5,
        17));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_outer_scope_info",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 22));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_debug_evaluate_scope",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 23));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("force_context_allocation",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 24));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("private_name_lookup_skips_outer_class",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 25));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_context_extension_slot",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 26));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_hidden", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 27));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_empty", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 28));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_wrapped_function",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 29));
    result.push_back(std::make_unique<ObjectProperty>("flags",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> parameter_count_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parameter_count", "v8::internal::TaggedMember<v8::internal::Object>", GetParameterCountAddress(), 1, 4,
        std::move(parameter_count_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> context_local_count_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("context_local_count", "v8::internal::TaggedMember<v8::internal::Object>", GetContextLocalCountAddress(),
        1, 4, std::move(context_local_count_struct_field_list), d::PropertyKind::kSingle));
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "position_info", "", GetPositionInfoAddress(), 1, 8, std::move(position_info_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_module_variable_count.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("module_variable_count", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_module_variable_count.value),
            std::get<2>(indexed_field_slice_module_variable_count.value), 4, std::move(module_variable_count_struct_field_list),
            GetArrayKind(indexed_field_slice_module_variable_count.validity)));
    }
    ...
    if (indexed_field_slice_context_local_names.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("context_local_names", "v8::internal::TaggedMember<v8::internal::String>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_context_local_names.value),
            std::get<2>(indexed_field_slice_context_local_names.value), 4, std::move(context_local_names_struct_field_list),
            GetArrayKind(indexed_field_slice_context_local_names.validity)));
    }
    ...
    if (indexed_field_slice_context_local_names_hashtable.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("context_local_names_hashtable", "v8::internal::TaggedMember<v8::internal::NameToIndexHashTable>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_context_local_names_hashtable.value),
            std::get<2>(indexed_field_slice_context_local_names_hashtable.value), 4, std::move(context_local_names_hashtable_struct_field_list),
            GetArrayKind(indexed_field_slice_context_local_names_hashtable.validity)));
    }
    std::vector<std::unique_ptr<StructProperty>> context_local_infos_struct_field_list;
    context_local_infos_struct_field_list.push_back(std::make_unique<StructProperty>("variable_mode",
        CheckTypeName<VariableMode /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("VariableMode"), 0, 4,
        1));
    context_local_infos_struct_field_list.push_back(std::make_unique<StructProperty>("init_flag",
        CheckTypeName<InitializationFlag /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "InitializationFlag"),
        0, 1, 5));
    context_local_infos_struct_field_list.push_back(std::make_unique<StructProperty>("maybe_assigned_flag",
        CheckTypeName<MaybeAssignedFlag /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("MaybeAssignedFlag"),
        0, 1, 6));
    context_local_infos_struct_field_list.push_back(std::make_unique<StructProperty>("parameter_number",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 16, 7));
    context_local_infos_struct_field_list.push_back(std::make_unique<StructProperty>("is_static_flag",
        CheckTypeName<IsStaticFlag /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("IsStaticFlag"), 0, 1,
        23));
    ...
    if (indexed_field_slice_context_local_infos.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("context_local_infos", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_context_local_infos.value),
            std::get<2>(indexed_field_slice_context_local_infos.value), 4, std::move(context_local_infos_struct_field_list),
            GetArrayKind(indexed_field_slice_context_local_infos.validity)));
    }
    ...
    if (indexed_field_slice_saved_class_variable_info.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("saved_class_variable_info", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_saved_class_variable_info.value),
            std::get<2>(indexed_field_slice_saved_class_variable_info.value), 4, std::move(saved_class_variable_info_struct_field_list),
            GetArrayKind(indexed_field_slice_saved_class_variable_info.validity)));
    }
    ...
    function_variable_info_struct_field_list.push_back(
        std::make_unique<StructProperty>("context_or_stack_slot_index", "v8::internal::TaggedMember<v8::internal::Object>", 4, 0, 0));
    ...
    if (indexed_field_slice_function_variable_info.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("function_variable_info", "",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_function_variable_info.value),
            std::get<2>(indexed_field_slice_function_variable_info.value), 8, std::move(function_variable_info_struct_field_list),
            GetArrayKind(indexed_field_slice_function_variable_info.validity)));
    }
    ...
    if (indexed_field_slice_inferred_function_name.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("inferred_function_name", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_inferred_function_name.value),
            std::get<2>(indexed_field_slice_inferred_function_name.value), 4, std::move(inferred_function_name_struct_field_list),
    ...
    if (indexed_field_slice_outer_scope_info.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("outer_scope_info", "v8::internal::TaggedMember<v8::internal::HeapObject>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_outer_scope_info.value), std::get<2>(indexed_field_slice_outer_scope_info.value), 4,
            std::move(outer_scope_info_struct_field_list), GetArrayKind(indexed_field_slice_outer_scope_info.validity)));
    }
    ...
    if (indexed_field_slice_module_info.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("module_info", "v8::internal::TaggedMember<v8::internal::FixedArray>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_module_info.value), std::get<2>(indexed_field_slice_module_info.value), 4,
            std::move(module_info_struct_field_list), GetArrayKind(indexed_field_slice_module_info.validity)));
    }
    ...
    if (indexed_field_slice_module_variables.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("module_variables", "",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_module_variables.value), std::get<2>(indexed_field_slice_module_variables.value), 12,
            std::move(module_variables_struct_field_list), GetArrayKind(indexed_field_slice_module_variables.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqFixedDoubleArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_values.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("values", "", address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_values.value),
            std::get<2>(indexed_field_slice_values.value), 8, std::move(values_struct_field_list), GetArrayKind(indexed_field_slice_values.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqRegExpMatchInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("number_of_capture_registers", "v8::internal::TaggedMember<v8::internal::Object>",
        GetNumberOfCaptureRegistersAddress(), 1, 4, std::move(number_of_capture_registers_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> last_subject_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("last_subject", "v8::internal::TaggedMember<v8::internal::String>", GetLastSubjectAddress(), 1, 4,
        std::move(last_subject_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> last_input_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("last_input", "v8::internal::TaggedMember<v8::internal::Object>", GetLastInputAddress(), 1, 4,
        std::move(last_input_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> objects_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqBreakPoint::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "id", "v8::internal::TaggedMember<v8::internal::Object>", GetIdAddress(), 1, 4, std::move(id_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> condition_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("condition", "v8::internal::TaggedMember<v8::internal::String>", GetConditionAddress(), 1, 4,
        std::move(condition_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqBreakPointInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("source_position", "v8::internal::TaggedMember<v8::internal::Object>", GetSourcePositionAddress(), 1, 4,
        std::move(source_position_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> break_points_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("break_points", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBreakPointsAddress(), 1, 4,
        std::move(break_points_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqDebugInfo::GetOriginalBytecodeArrayValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqDebugInfo::GetDebugBytecodeArrayValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqDebugInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("shared", "v8::internal::TaggedMember<v8::internal::SharedFunctionInfo>", GetSharedAddress(), 1, 4,
        std::move(shared_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> debugger_hints_struct_field_list;
    debugger_hints_struct_field_list.push_back(std::make_unique<StructProperty>("side_effect_state",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 2, 1));
    debugger_hints_struct_field_list.push_back(std::make_unique<StructProperty>("debug_is_blackboxed",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    debugger_hints_struct_field_list.push_back(std::make_unique<StructProperty>("computed_debug_is_blackboxed",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    debugger_hints_struct_field_list.push_back(std::make_unique<StructProperty>("debugging_id",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 20, 5));
    result.push_back(std::make_unique<ObjectProperty>("debugger_hints", "v8::internal::TaggedMember<v8::internal::Object>", GetDebuggerHintsAddress(), 1, 4,
        std::move(debugger_hints_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> break_points_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("break_points", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetBreakPointsAddress(), 1, 4,
        std::move(break_points_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_break_info",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("prepared_for_debug_execution",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_coverage_info",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("break_at_entry",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("can_break_at_entry",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("debug_execution_mode",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> coverage_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("coverage_info", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetCoverageInfoAddress(), 1, 4,
        std::move(coverage_info_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> original_bytecode_array_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("original_bytecode_array",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetOriginalBytecodeArrayAddress(), 1, 4, std::move(original_bytecode_array_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> debug_bytecode_array_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("debug_bytecode_array",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetDebugBytecodeArrayAddress(), 1, 4, std::move(debug_bytecode_array_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqCoverageInfo::GetSlotCountValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqCoverageInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("slot_count",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetSlotCountAddress(), 1, 4, std::move(slot_count_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> slots_struct_field_list;
    slots_struct_field_list.push_back(std::make_unique<StructProperty>("start_source_position",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 0, 0));
    slots_struct_field_list.push_back(std::make_unique<StructProperty>("end_source_position",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 4, 0, 0));
    slots_struct_field_list.push_back(std::make_unique<StructProperty>("block_count",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 8, 0, 0));
    slots_struct_field_list.push_back(std::make_unique<StructProperty>("padding",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 12, 0, 0));
    ...
    if (indexed_field_slice_slots.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("slots", "", address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_slots.value),
            std::get<2>(indexed_field_slice_slots.value), 16, std::move(slots_struct_field_list), GetArrayKind(indexed_field_slice_slots.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqStackFrameInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("shared_or_script", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetSharedOrScriptAddress(), 1,
        4, std::move(shared_or_script_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> function_name_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("function_name", "v8::internal::TaggedMember<v8::internal::String>", GetFunctionNameAddress(), 1, 4,
        std::move(function_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_constructor",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("bytecode_offset_or_source_position",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 30, 2));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqStackTraceInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("frames", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetFramesAddress(), 1, 4,
        std::move(frames_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqErrorStackData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("call_site_infos_or_formatted_stack", "v8::internal::TaggedMember<v8::internal::Object>",
        GetCallSiteInfosOrFormattedStackAddress(), 1, 4, std::move(call_site_infos_or_formatted_stack_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> stack_trace_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("stack_trace", "v8::internal::TaggedMember<v8::internal::StackTraceInfo>", GetStackTraceAddress(), 1, 4,
        std::move(stack_trace_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqEnumCache::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "keys", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetKeysAddress(), 1, 4, std::move(keys_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> indices_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("indices", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetIndicesAddress(), 1, 4,
        std::move(indices_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqClassPositions::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "start", "v8::internal::TaggedMember<v8::internal::Object>", GetStartAddress(), 1, 4, std::move(start_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> end_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "end", "v8::internal::TaggedMember<v8::internal::Object>", GetEndAddress(), 1, 4, std::move(end_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqDescriptorArray::GetNumberOfAllDescriptorsValue(d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqDescriptorArray::GetNumberOfDescriptorsValue(d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqDescriptorArray::GetRawGcStateValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqDescriptorArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("number_of_all_descriptors",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetNumberOfAllDescriptorsAddress(), 1, 2, std::move(number_of_all_descriptors_struct_field_list), d::PropertyKind::kSingle));
    ...
    result.push_back(std::make_unique<ObjectProperty>("number_of_descriptors",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetNumberOfDescriptorsAddress(), 1, 2, std::move(number_of_descriptors_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_gc_state_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("raw_gc_state",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetRawGcStateAddress(), 1, 4, std::move(raw_gc_state_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> enum_cache_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("enum_cache", "v8::internal::TaggedMember<v8::internal::EnumCache>", GetEnumCacheAddress(), 1, 4,
        std::move(enum_cache_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_descriptors.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("descriptors", "", address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_descriptors.value),
            std::get<2>(indexed_field_slice_descriptors.value), 12, std::move(descriptors_struct_field_list),
            GetArrayKind(indexed_field_slice_descriptors.validity)));
    }
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqFeedbackCell::GetInterruptBudgetValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqFeedbackCell::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqStruct::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> value_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("value", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetValueAddress(), 1, 4,
        std::move(value_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> interrupt_budget_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("interrupt_budget",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetInterruptBudgetAddress(), 1, 4, std::move(interrupt_budget_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uintptr_t> TqClosureFeedbackCellArray::GetLengthValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetLengthAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
...
std::vector<std::unique_ptr<ObjectProperty>> TqClosureFeedbackCellArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_objects.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("objects", "v8::internal::TaggedMember<v8::internal::FeedbackCell>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_objects.value), std::get<2>(indexed_field_slice_objects.value), 4,
            std::move(objects_struct_field_list), GetArrayKind(indexed_field_slice_objects.validity)));
    }
    return result;
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqFeedbackVector::GetLengthValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetLengthAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqFeedbackVector::GetInvocationCountValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqFeedbackVector::GetInvocationCountBeforeStableValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqFeedbackVector::GetOsrStateValue(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqFeedbackVector::GetFlagsValue(
    d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetFlagsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqFeedbackVector::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("invocation_count",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetInvocationCountAddress(), 1, 4, std::move(invocation_count_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> invocation_count_before_stable_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("invocation_count_before_stable",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetInvocationCountBeforeStableAddress(), 1, 1, std::move(invocation_count_before_stable_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> osr_state_struct_field_list;
    osr_state_struct_field_list.push_back(std::make_unique<StructProperty>("osr_urgency",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 3, 0));
    osr_state_struct_field_list.push_back(std::make_unique<StructProperty>("maybe_has_maglev_osr_code",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    osr_state_struct_field_list.push_back(std::make_unique<StructProperty>("maybe_has_turbofan_osr_code",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    osr_state_struct_field_list.push_back(std::make_unique<StructProperty>("dont_use_these_bits_unless_beneficial",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 3, 5));
    result.push_back(std::make_unique<ObjectProperty>("osr_state",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetOsrStateAddress(), 1, 1, std::move(osr_state_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("tiering_state",
        CheckTypeName<TieringState /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TieringState"), 0, 3,
        0));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("log_next_execution",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("maybe_has_maglev_code",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("maybe_has_turbofan_code",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("osr_tiering_in_progress",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("interrupt_budget_reset_by_ic_change",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("all_your_bits_are_belong_to_jgruber",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 8, 8));
    result.push_back(std::make_unique<ObjectProperty>("flags",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetFlagsAddress(), 1, 2, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> shared_function_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("shared_function_info", "v8::internal::TaggedMember<v8::internal::SharedFunctionInfo>",
        GetSharedFunctionInfoAddress(), 1, 4, std::move(shared_function_info_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> closure_feedback_cell_array_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("closure_feedback_cell_array", "v8::internal::TaggedMember<v8::internal::ClosureFeedbackCellArray>",
        GetClosureFeedbackCellArrayAddress(), 1, 4, std::move(closure_feedback_cell_array_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> parent_feedback_cell_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parent_feedback_cell", "v8::internal::TaggedMember<v8::internal::FeedbackCell>",
        GetParentFeedbackCellAddress(), 1, 4, std::move(parent_feedback_cell_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> maybe_optimized_code_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("maybe_optimized_code", "v8::internal::TaggedMember<v8::internal::Object>",
        GetMaybeOptimizedCodeAddress(), 1, 4, std::move(maybe_optimized_code_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_raw_feedback_slots.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("raw_feedback_slots", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_raw_feedback_slots.value), std::get<2>(indexed_field_slice_raw_feedback_slots.value),
            4, std::move(raw_feedback_slots_struct_field_list), GetArrayKind(indexed_field_slice_raw_feedback_slots.validity)));
    }
    return result;
}
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqByteArray::GetValuesValue(
    d::MemoryAccessor accessor, size_t offset) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqByteArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_values.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("values",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_values.value), std::get<2>(indexed_field_slice_values.value), 1,
            std::move(values_struct_field_list), GetArrayKind(indexed_field_slice_values.validity)));
    }
    return result;
}
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTrustedByteArray::GetValuesValue(
    d::MemoryAccessor accessor, size_t offset) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetValuesAddress() + offset * sizeof(value), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTrustedForeign::GetForeignAddressValue(
    d::MemoryAccessor accessor) const
{
    Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetForeignAddressAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqFreeSpace::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "size", "v8::internal::TaggedMember<v8::internal::Object>", GetSizeAddress(), 1, 4, std::move(size_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> next_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "next", "v8::internal::TaggedMember<v8::internal::Object>", GetNextAddress(), 1, 4, std::move(next_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBuffer::GetRawByteLengthValue(
    d::MemoryAccessor accessor) const
{
    uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetRawByteLengthAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBuffer::GetRawMaxByteLengthValue(
    d::MemoryAccessor accessor) const
{
    uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBuffer::GetBackingStoreValue(
    d::MemoryAccessor accessor) const
{
    Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBuffer::GetExtensionValue(
    d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSArrayBuffer::GetBitFieldValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetBitFieldAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSArrayBuffer::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("detach_key", "v8::internal::TaggedMember<v8::internal::Object>", GetDetachKeyAddress(), 1, 4,
        std::move(detach_key_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_byte_length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("raw_byte_length",
        CheckTypeName<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uintptr_t"),
        GetRawByteLengthAddress(), 1, 4, std::move(raw_byte_length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_max_byte_length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("raw_max_byte_length",
        CheckTypeName<uintptr_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uintptr_t"),
        GetRawMaxByteLengthAddress(), 1, 4, std::move(raw_max_byte_length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> backing_store_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("backing_store",
        CheckTypeName<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("Address"),
        GetBackingStoreAddress(), 1, 4, std::move(backing_store_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> extension_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("extension",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetExtensionAddress(), 1, 4, std::move(extension_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bit_field_struct_field_list;
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_external", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_detachable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("was_detached",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_asm_js_memory",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_shared", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("is_resizable_by_js",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    result.push_back(std::make_unique<ObjectProperty>("bit_field",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetBitFieldAddress(), 1, 4, std::move(bit_field_struct_field_list), d::PropertyKind::kSingle));
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqJSDataViewOrRabGsabDataView::GetDataPointerValue(d::MemoryAccessor accessor) const
{
    Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDataViewOrRabGsabDataView::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("data_pointer",
        CheckTypeName<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("Address"),
        GetDataPointerAddress(), 1, 4, std::move(data_pointer_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSArrayIterator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("iterated_object", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetIteratedObjectAddress(), 1,
        4, std::move(iterated_object_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> next_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("next_index", "v8::internal::TaggedMember<v8::internal::Object>", GetNextIndexAddress(), 1, 4,
        std::move(next_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> kind_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "kind", "v8::internal::TaggedMember<v8::internal::Object>", GetKindAddress(), 1, 4, std::move(kind_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqTemplateLiteralObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "raw", "v8::internal::TaggedMember<v8::internal::JSArray>", GetRawAddress(), 1, 4, std::move(raw_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> function_literal_id_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("function_literal_id", "v8::internal::TaggedMember<v8::internal::Object>", GetFunctionLiteralIdAddress(),
        1, 4, std::move(function_literal_id_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> slot_id_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("slot_id", "v8::internal::TaggedMember<v8::internal::Object>", GetSlotIdAddress(), 1, 4,
        std::move(slot_id_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqJSSynchronizationPrimitive::GetWaiterQueueHeadValue(d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSSynchronizationPrimitive::GetStateValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSSynchronizationPrimitive::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("waiter_queue_head",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetWaiterQueueHeadAddress(), 1, 4, std::move(waiter_queue_head_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> state_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("state",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetStateAddress(), 1, 4, std::move(state_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSAtomicsMutex::GetOwnerThreadIdValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSAtomicsMutex::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("owner_thread_id",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetOwnerThreadIdAddress(), 1, 4, std::move(owner_thread_id_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSCollectionIterator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "index", "v8::internal::TaggedMember<v8::internal::Object>", GetIndexAddress(), 1, 4, std::move(index_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDisposableStackBase::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("stack", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetStackAddress(), 1, 4,
        std::move(stack_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> status_struct_field_list;
    status_struct_field_list.push_back(std::make_unique<StructProperty>("state",
        CheckTypeName<DisposableStackState /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "DisposableStackState"),
        0, 1, 1));
    status_struct_field_list.push_back(std::make_unique<StructProperty>(
        "needsAwait", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    status_struct_field_list.push_back(std::make_unique<StructProperty>(
        "hasAwaited", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    status_struct_field_list.push_back(std::make_unique<StructProperty>("length",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 28, 4));
    result.push_back(std::make_unique<ObjectProperty>(
        "status", "v8::internal::TaggedMember<v8::internal::Object>", GetStatusAddress(), 1, 4, std::move(status_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> error_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "error", "v8::internal::TaggedMember<v8::internal::Object>", GetErrorAddress(), 1, 4, std::move(error_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSGeneratorObject::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> function_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("function", "v8::internal::TaggedMember<v8::internal::JSFunction>", GetFunctionAddress(), 1, 4,
        std::move(function_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("context", "v8::internal::TaggedMember<v8::internal::Context>", GetContextAddress(), 1, 4,
        std::move(context_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> receiver_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("receiver", "v8::internal::TaggedMember<v8::internal::Object>", GetReceiverAddress(), 1, 4,
        std::move(receiver_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> input_or_debug_pos_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("input_or_debug_pos", "v8::internal::TaggedMember<v8::internal::Object>", GetInputOrDebugPosAddress(), 1,
        4, std::move(input_or_debug_pos_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> resume_mode_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("resume_mode", "v8::internal::TaggedMember<v8::internal::Object>", GetResumeModeAddress(), 1, 4,
        std::move(resume_mode_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> continuation_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("continuation", "v8::internal::TaggedMember<v8::internal::Object>", GetContinuationAddress(), 1, 4,
        std::move(continuation_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> parameters_and_registers_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parameters_and_registers", "v8::internal::TaggedMember<v8::internal::FixedArray>",
        GetParametersAndRegistersAddress(), 1, 4, std::move(parameters_and_registers_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSAsyncFunctionObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> promise_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("promise", "v8::internal::TaggedMember<v8::internal::JSPromise>", GetPromiseAddress(), 1, 4,
        std::move(promise_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSAsyncGeneratorObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("queue", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetQueueAddress(), 1, 4,
        std::move(queue_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> is_awaiting_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("is_awaiting", "v8::internal::TaggedMember<v8::internal::Object>", GetIsAwaitingAddress(), 1, 4,
        std::move(is_awaiting_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetUnderlyingObjectAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
}
...
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetUnderlyingNextAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
}
...
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> underlying_object_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("underlying_object", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetUnderlyingObjectAddress(),
        1, 4, std::move(underlying_object_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> underlying_next_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("underlying_next", "v8::internal::TaggedMember<v8::internal::Object>", GetUnderlyingNextAddress(), 1, 4,
        std::move(underlying_next_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSIteratorMapHelper::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("mapper", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetMapperAddress(), 1, 4,
        std::move(mapper_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> counter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("counter", "v8::internal::TaggedMember<v8::internal::Object>", GetCounterAddress(), 1, 4,
        std::move(counter_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSIteratorFilterHelper::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("predicate", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetPredicateAddress(), 1, 4,
        std::move(predicate_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> counter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("counter", "v8::internal::TaggedMember<v8::internal::Object>", GetCounterAddress(), 1, 4,
        std::move(counter_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSIteratorTakeHelper::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("remaining", "v8::internal::TaggedMember<v8::internal::Object>", GetRemainingAddress(), 1, 4,
        std::move(remaining_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSIteratorFlatMapHelper::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    innerIterator_struct_field_list.push_back(std::make_unique<StructProperty>("object", "v8::internal::TaggedMember<v8::internal::JSReceiver>", 0, 0, 0));
    innerIterator_struct_field_list.push_back(std::make_unique<StructProperty>("next", "v8::internal::TaggedMember<v8::internal::Object>", 4, 0, 0));
    result.push_back(std::make_unique<ObjectProperty>(
        "innerIterator", "", GetInnerIteratorAddress(), 1, 8, std::move(innerIterator_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> innerAlive_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("innerAlive", "v8::internal::TaggedMember<v8::internal::Boolean>", GetInnerAliveAddress(), 1, 4,
        std::move(innerAlive_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSExternalObject::GetValueValue(
    d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetValueAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSExternalObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("value",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetValueAddress(), 1, 4, std::move(value_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSGlobalObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("global_proxy", "v8::internal::TaggedMember<v8::internal::JSGlobalProxy>", GetGlobalProxyAddress(), 1, 4,
        std::move(global_proxy_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSMessageObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("message_type", "v8::internal::TaggedMember<v8::internal::Object>", GetMessageTypeAddress(), 1, 4,
        std::move(message_type_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> argument_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("argument", "v8::internal::TaggedMember<v8::internal::Object>", GetArgumentAddress(), 1, 4,
        std::move(argument_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> script_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "script", "v8::internal::TaggedMember<v8::internal::Script>", GetScriptAddress(), 1, 4, std::move(script_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> stack_trace_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("stack_trace", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetStackTraceAddress(), 1, 4,
        std::move(stack_trace_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> shared_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("shared_info", "v8::internal::TaggedMember<v8::internal::Object>", GetSharedInfoAddress(), 1, 4,
        std::move(shared_info_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bytecode_offset_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bytecode_offset", "v8::internal::TaggedMember<v8::internal::Object>", GetBytecodeOffsetAddress(), 1, 4,
        std::move(bytecode_offset_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> start_position_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("start_position", "v8::internal::TaggedMember<v8::internal::Object>", GetStartPositionAddress(), 1, 4,
        std::move(start_position_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> end_position_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("end_position", "v8::internal::TaggedMember<v8::internal::Object>", GetEndPositionAddress(), 1, 4,
        std::move(end_position_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> error_level_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("error_level", "v8::internal::TaggedMember<v8::internal::Object>", GetErrorLevelAddress(), 1, 4,
        std::move(error_level_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSDate::GetValueValue(
    d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetValueAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDate::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "year", "v8::internal::TaggedMember<v8::internal::Object>", GetYearAddress(), 1, 4, std::move(year_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> month_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "month", "v8::internal::TaggedMember<v8::internal::Object>", GetMonthAddress(), 1, 4, std::move(month_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> day_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "day", "v8::internal::TaggedMember<v8::internal::Object>", GetDayAddress(), 1, 4, std::move(day_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> weekday_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("weekday", "v8::internal::TaggedMember<v8::internal::Object>", GetWeekdayAddress(), 1, 4,
        std::move(weekday_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> hour_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "hour", "v8::internal::TaggedMember<v8::internal::Object>", GetHourAddress(), 1, 4, std::move(hour_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> min_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "min", "v8::internal::TaggedMember<v8::internal::Object>", GetMinAddress(), 1, 4, std::move(min_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> sec_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "sec", "v8::internal::TaggedMember<v8::internal::Object>", GetSecAddress(), 1, 4, std::move(sec_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> cache_stamp_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("cache_stamp", "v8::internal::TaggedMember<v8::internal::Object>", GetCacheStampAddress(), 1, 4,
        std::move(cache_stamp_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSAsyncFromSyncIterator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("sync_iterator", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetSyncIteratorAddress(), 1, 4,
        std::move(sync_iterator_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> next_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "next", "v8::internal::TaggedMember<v8::internal::Object>", GetNextAddress(), 1, 4, std::move(next_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSStringIterator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "string", "v8::internal::TaggedMember<v8::internal::String>", GetStringAddress(), 1, 4, std::move(string_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "index", "v8::internal::TaggedMember<v8::internal::Object>", GetIndexAddress(), 1, 4, std::move(index_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSValidIteratorWrapper::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(
        std::make_unique<ObjectProperty>("underlying", "", GetUnderlyingAddress(), 1, 8, std::move(underlying_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSProxyRevocableResult::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "proxy", "v8::internal::TaggedMember<v8::internal::Object>", GetProxyAddress(), 1, 4, std::move(proxy_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> revoke_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "revoke", "v8::internal::TaggedMember<v8::internal::Object>", GetRevokeAddress(), 1, 4, std::move(revoke_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSRegExpStringIterator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("iterating_reg_exp", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetIteratingRegExpAddress(),
        1, 4, std::move(iterating_reg_exp_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> iterated_string_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("iterated_string", "v8::internal::TaggedMember<v8::internal::String>", GetIteratedStringAddress(), 1, 4,
        std::move(iterated_string_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "done", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "global", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "unicode", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqRegExpData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("type_tag", "v8::internal::TaggedMember<v8::internal::Object>", GetTypeTagAddress(), 1, 4,
        std::move(type_tag_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> source_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "source", "v8::internal::TaggedMember<v8::internal::String>", GetSourceAddress(), 1, 4, std::move(source_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> wrapper_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("wrapper", "v8::internal::TaggedMember<v8::internal::RegExpDataWrapper>", GetWrapperAddress(), 1, 4,
        std::move(wrapper_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqAtomRegExpData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("pattern", "v8::internal::TaggedMember<v8::internal::String>", GetPatternAddress(), 1, 4,
        std::move(pattern_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqIrRegExpData::GetLatin1CodeValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqIrRegExpData::GetUc16CodeValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqIrRegExpData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("latin1_bytecode", "v8::internal::TaggedMember<v8::internal::Object>", GetLatin1BytecodeAddress(), 1, 4,
        std::move(latin1_bytecode_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> uc16_bytecode_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("uc16_bytecode", "v8::internal::TaggedMember<v8::internal::Object>", GetUc16BytecodeAddress(), 1, 4,
        std::move(uc16_bytecode_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> latin1_code_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("latin1_code",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetLatin1CodeAddress(), 1, 4, std::move(latin1_code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> uc16_code_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("uc16_code",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetUc16CodeAddress(), 1, 4, std::move(uc16_code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> capture_name_map_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("capture_name_map", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetCaptureNameMapAddress(), 1,
        4, std::move(capture_name_map_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> max_register_count_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("max_register_count", "v8::internal::TaggedMember<v8::internal::Object>", GetMaxRegisterCountAddress(), 1,
        4, std::move(max_register_count_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> capture_count_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("capture_count", "v8::internal::TaggedMember<v8::internal::Object>", GetCaptureCountAddress(), 1, 4,
        std::move(capture_count_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> ticks_until_tier_up_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("ticks_until_tier_up", "v8::internal::TaggedMember<v8::internal::Object>", GetTicksUntilTierUpAddress(),
        1, 4, std::move(ticks_until_tier_up_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> backtrack_limit_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("backtrack_limit", "v8::internal::TaggedMember<v8::internal::Object>", GetBacktrackLimitAddress(), 1, 4,
        std::move(backtrack_limit_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqRegExpDataWrapper::GetDataValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqRegExpDataWrapper::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqStruct::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("data",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqJSRegExp::GetDataValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSRegExp::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("data",
        ...
        GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> source_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("source", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetSourceAddress(), 1, 4,
        std::move(source_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSRegExpResult::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "input", "v8::internal::TaggedMember<v8::internal::Object>", GetInputAddress(), 1, 4, std::move(input_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> groups_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "groups", "v8::internal::TaggedMember<v8::internal::Object>", GetGroupsAddress(), 1, 4, std::move(groups_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> names_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("names", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetNamesAddress(), 1, 4,
        std::move(names_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> regexp_input_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("regexp_input", "v8::internal::TaggedMember<v8::internal::String>", GetRegexpInputAddress(), 1, 4,
        std::move(regexp_input_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> regexp_last_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("regexp_last_index", "v8::internal::TaggedMember<v8::internal::Object>", GetRegexpLastIndexAddress(), 1,
        4, std::move(regexp_last_index_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSRegExpResultWithIndices::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> indices_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("indices", "v8::internal::TaggedMember<v8::internal::Object>", GetIndicesAddress(), 1, 4,
        std::move(indices_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSShadowRealm::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("native_context", "v8::internal::TaggedMember<v8::internal::NativeContext>", GetNativeContextAddress(), 1,
        4, std::move(native_context_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalCalendar::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("calendar_index",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 5, 1));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalDuration::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "years", "v8::internal::TaggedMember<v8::internal::Object>", GetYearsAddress(), 1, 4, std::move(years_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> months_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "months", "v8::internal::TaggedMember<v8::internal::Object>", GetMonthsAddress(), 1, 4, std::move(months_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> weeks_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "weeks", "v8::internal::TaggedMember<v8::internal::Object>", GetWeeksAddress(), 1, 4, std::move(weeks_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> days_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "days", "v8::internal::TaggedMember<v8::internal::Object>", GetDaysAddress(), 1, 4, std::move(days_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> hours_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "hours", "v8::internal::TaggedMember<v8::internal::Object>", GetHoursAddress(), 1, 4, std::move(hours_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> minutes_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("minutes", "v8::internal::TaggedMember<v8::internal::Object>", GetMinutesAddress(), 1, 4,
        std::move(minutes_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> seconds_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("seconds", "v8::internal::TaggedMember<v8::internal::Object>", GetSecondsAddress(), 1, 4,
        std::move(seconds_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> milliseconds_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("milliseconds", "v8::internal::TaggedMember<v8::internal::Object>", GetMillisecondsAddress(), 1, 4,
        std::move(milliseconds_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> microseconds_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("microseconds", "v8::internal::TaggedMember<v8::internal::Object>", GetMicrosecondsAddress(), 1, 4,
        std::move(microseconds_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> nanoseconds_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("nanoseconds", "v8::internal::TaggedMember<v8::internal::Object>", GetNanosecondsAddress(), 1, 4,
        std::move(nanoseconds_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalInstant::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> nanoseconds_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("nanoseconds", "v8::internal::TaggedMember<v8::internal::BigInt>", GetNanosecondsAddress(), 1, 4,
        std::move(nanoseconds_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalPlainDateTime::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    year_month_day_struct_field_list.push_back(std::make_unique<StructProperty>("iso_year",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 20, 1));
    year_month_day_struct_field_list.push_back(std::make_unique<StructProperty>("iso_month",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 4, 21));
    year_month_day_struct_field_list.push_back(std::make_unique<StructProperty>("iso_day",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 5, 25));
    result.push_back(std::make_unique<ObjectProperty>("year_month_day", "v8::internal::TaggedMember<v8::internal::Object>", GetYearMonthDayAddress(), 1, 4,
        std::move(year_month_day_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> hour_minute_second_struct_field_list;
    hour_minute_second_struct_field_list.push_back(std::make_unique<StructProperty>("iso_hour",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 5, 1));
    hour_minute_second_struct_field_list.push_back(std::make_unique<StructProperty>("iso_minute",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 6, 6));
    hour_minute_second_struct_field_list.push_back(std::make_unique<StructProperty>("iso_second",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 6, 12));
    result.push_back(std::make_unique<ObjectProperty>("hour_minute_second", "v8::internal::TaggedMember<v8::internal::Object>", GetHourMinuteSecondAddress(), 1,
        4, std::move(hour_minute_second_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> second_parts_struct_field_list;
    second_parts_struct_field_list.push_back(std::make_unique<StructProperty>("iso_millisecond",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 1));
    second_parts_struct_field_list.push_back(std::make_unique<StructProperty>("iso_microsecond",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 11));
    second_parts_struct_field_list.push_back(std::make_unique<StructProperty>("iso_nanosecond",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 10, 21));
    result.push_back(std::make_unique<ObjectProperty>("second_parts", "v8::internal::TaggedMember<v8::internal::Object>", GetSecondPartsAddress(), 1, 4,
        std::move(second_parts_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> calendar_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("calendar", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetCalendarAddress(), 1, 4,
        std::move(calendar_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalTimeZone::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_offset", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("offset_milliseconds_or_time_zone_index",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 28, 2));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> details_struct_field_list;
    details_struct_field_list.push_back(std::make_unique<StructProperty>("offset_sub_milliseconds",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 21, 1));
    result.push_back(std::make_unique<ObjectProperty>("details", "v8::internal::TaggedMember<v8::internal::Object>", GetDetailsAddress(), 1, 4,
        std::move(details_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSTemporalZonedDateTime::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("time_zone", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetTimeZoneAddress(), 1, 4,
        std::move(time_zone_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> calendar_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("calendar", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetCalendarAddress(), 1, 4,
        std::move(calendar_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSFinalizationRegistry::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("cleanup", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetCleanupAddress(), 1, 4,
        std::move(cleanup_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> active_cells_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("active_cells", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetActiveCellsAddress(), 1, 4,
        std::move(active_cells_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> cleared_cells_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("cleared_cells", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetClearedCellsAddress(), 1, 4,
        std::move(cleared_cells_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> key_map_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("key_map", "v8::internal::TaggedMember<v8::internal::Object>", GetKeyMapAddress(), 1, 4,
        std::move(key_map_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> next_dirty_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("next_dirty", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetNextDirtyAddress(), 1, 4,
        std::move(next_dirty_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
...
Value<uintptr_t> TqObjectBoilerplateDescription::GetLengthValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetLengthAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
...
std::vector<std::unique_ptr<ObjectProperty>> TqObjectBoilerplateDescription::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("backing_store_size", "v8::internal::TaggedMember<v8::internal::Object>", GetBackingStoreSizeAddress(), 1,
        4, std::move(backing_store_size_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_raw_entries.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("raw_entries", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_raw_entries.value), std::get<2>(indexed_field_slice_raw_entries.value), 4,
            std::move(raw_entries_struct_field_list), GetArrayKind(indexed_field_slice_raw_entries.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqArrayBoilerplateDescription::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("constant_elements", "v8::internal::TaggedMember<v8::internal::FixedArrayBase>",
        GetConstantElementsAddress(), 1, 4, std::move(constant_elements_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqRegExpBoilerplateDescription::GetDataValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
std::vector<std::unique_ptr<ObjectProperty>> TqRegExpBoilerplateDescription::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "global", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "ignore_case", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "multiline", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "sticky", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "unicode", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "dot_all", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "linear", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "has_indices", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 8));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("unicode_sets",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 9));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqClassBoilerplate::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("arguments_count", "v8::internal::TaggedMember<v8::internal::Object>", GetArgumentsCountAddress(), 1, 4,
        std::move(arguments_count_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> static_properties_template_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("static_properties_template", "v8::internal::TaggedMember<v8::internal::Object>",
        GetStaticPropertiesTemplateAddress(), 1, 4, std::move(static_properties_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> static_elements_template_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("static_elements_template", "v8::internal::TaggedMember<v8::internal::Object>",
        GetStaticElementsTemplateAddress(), 1, 4, std::move(static_elements_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> static_computed_properties_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("static_computed_properties", "v8::internal::TaggedMember<v8::internal::FixedArray>",
        GetStaticComputedPropertiesAddress(), 1, 4, std::move(static_computed_properties_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_properties_template_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_properties_template", "v8::internal::TaggedMember<v8::internal::Object>",
        GetInstancePropertiesTemplateAddress(), 1, 4, std::move(instance_properties_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_elements_template_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_elements_template", "v8::internal::TaggedMember<v8::internal::Object>",
        GetInstanceElementsTemplateAddress(), 1, 4, std::move(instance_elements_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_computed_properties_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_computed_properties", "v8::internal::TaggedMember<v8::internal::FixedArray>",
        GetInstanceComputedPropertiesAddress(), 1, 4, std::move(instance_computed_properties_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqMegaDomHandler::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("accessor", "v8::internal::TaggedMember<v8::internal::Object>", GetAccessorAddress(), 1, 4,
        std::move(accessor_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("context", "v8::internal::TaggedMember<v8::internal::Object>", GetContextAddress(), 1, 4,
        std::move(context_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqMicrotask::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("continuation_preserved_embedder_data", "v8::internal::TaggedMember<v8::internal::Object>",
        GetContinuationPreservedEmbedderDataAddress(), 1, 4, std::move(continuation_preserved_embedder_data_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqCallbackTask::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> callback_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("callback", "v8::internal::TaggedMember<v8::internal::Foreign>", GetCallbackAddress(), 1, 4,
        std::move(callback_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data", "v8::internal::TaggedMember<v8::internal::Foreign>", GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqCallableTask::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("callable", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetCallableAddress(), 1, 4,
        std::move(callable_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("context", "v8::internal::TaggedMember<v8::internal::Context>", GetContextAddress(), 1, 4,
        std::move(context_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqModule::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("exports", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetExportsAddress(), 1, 4,
        std::move(exports_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> hash_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "hash", "v8::internal::TaggedMember<v8::internal::Object>", GetHashAddress(), 1, 4, std::move(hash_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> status_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "status", "v8::internal::TaggedMember<v8::internal::Object>", GetStatusAddress(), 1, 4, std::move(status_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> module_namespace_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("module_namespace", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetModuleNamespaceAddress(),
        1, 4, std::move(module_namespace_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> exception_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("exception", "v8::internal::TaggedMember<v8::internal::Object>", GetExceptionAddress(), 1, 4,
        std::move(exception_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> top_level_capability_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("top_level_capability", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetTopLevelCapabilityAddress(), 1, 4, std::move(top_level_capability_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSModuleNamespace::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "module", "v8::internal::TaggedMember<v8::internal::Module>", GetModuleAddress(), 1, 4, std::move(module_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqScriptOrModule::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("resource_name", "v8::internal::TaggedMember<v8::internal::Object>", GetResourceNameAddress(), 1, 4,
        std::move(resource_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> host_defined_options_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("host_defined_options", "v8::internal::TaggedMember<v8::internal::FixedArray>",
        GetHostDefinedOptionsAddress(), 1, 4, std::move(host_defined_options_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSmallOrderedHashSet::GetNumberOfElementsValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSmallOrderedHashSet::GetNumberOfDeletedElementsValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSmallOrderedHashSet::GetNumberOfBucketsValue(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSmallOrderedHashSet::GetPaddingValue(
    d::MemoryAccessor accessor, size_t offset) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqSmallOrderedHashSet::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("number_of_elements",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetNumberOfElementsAddress(), 1, 1, std::move(number_of_elements_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> number_of_deleted_elements_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("number_of_deleted_elements",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetNumberOfDeletedElementsAddress(), 1, 1, std::move(number_of_deleted_elements_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> number_of_buckets_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("number_of_buckets",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetNumberOfBucketsAddress(), 1, 1, std::move(number_of_buckets_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_padding.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("padding",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_padding.value), std::get<2>(indexed_field_slice_padding.value), 1,
            std::move(padding_struct_field_list), GetArrayKind(indexed_field_slice_padding.validity)));
    }
    ...
    if (indexed_field_slice_data_table.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("data_table", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_data_table.value), std::get<2>(indexed_field_slice_data_table.value), 4,
            std::move(data_table_struct_field_list), GetArrayKind(indexed_field_slice_data_table.validity)));
    }
    ...
    if (indexed_field_slice_hash_table.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("hash_table",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_hash_table.value), std::get<2>(indexed_field_slice_hash_table.value), 1,
            std::move(hash_table_struct_field_list), GetArrayKind(indexed_field_slice_hash_table.validity)));
    }
    ...
    if (indexed_field_slice_chain_table.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("chain_table",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_chain_table.value), std::get<2>(indexed_field_slice_chain_table.value), 1,
            std::move(chain_table_struct_field_list), GetArrayKind(indexed_field_slice_chain_table.validity)));
    }
    return result;
}
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSmallOrderedHashMap::GetNumberOfElementsValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetNumberOfElementsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSmallOrderedHashMap::GetNumberOfDeletedElementsValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetNumberOfDeletedElementsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSmallOrderedHashMap::GetNumberOfBucketsValue(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetNumberOfBucketsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSmallOrderedHashMap::GetPaddingValue(
    d::MemoryAccessor accessor, size_t offset) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetPaddingAddress() + offset * sizeof(value), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqSmallOrderedHashMap::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_data_table.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("data_table", "", address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_data_table.value),
            std::get<2>(indexed_field_slice_data_table.value), 8, std::move(data_table_struct_field_list),
            GetArrayKind(indexed_field_slice_data_table.validity)));
    }
    std::vector<std::unique_ptr<StructProperty>> hash_table_struct_field_list;
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSmallOrderedNameDictionary::GetHashValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetHashAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSmallOrderedNameDictionary::GetNumberOfElementsValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetNumberOfElementsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSmallOrderedNameDictionary::GetNumberOfDeletedElementsValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetNumberOfDeletedElementsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSmallOrderedNameDictionary::GetNumberOfBucketsValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetNumberOfBucketsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSmallOrderedNameDictionary::GetPadding1Value(
    d::MemoryAccessor accessor, size_t offset) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqSmallOrderedNameDictionary::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqSmallOrderedHashTable::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> hash_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("hash",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetHashAddress(),
    ...
    if (indexed_field_slice_padding_1.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("padding_1",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_padding_1.value), std::get<2>(indexed_field_slice_padding_1.value), 1,
            std::move(padding_1_struct_field_list), GetArrayKind(indexed_field_slice_padding_1.validity)));
    }
    std::vector<std::unique_ptr<StructProperty>> data_table_struct_field_list;
    data_table_struct_field_list.push_back(std::make_unique<StructProperty>("key", "v8::internal::TaggedMember<v8::internal::Object>", 0, 0, 0));
    data_table_struct_field_list.push_back(std::make_unique<StructProperty>("value", "v8::internal::TaggedMember<v8::internal::Object>", 4, 0, 0));
    ...
    if (indexed_field_slice_data_table.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("data_table", "", address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_data_table.value),
            std::get<2>(indexed_field_slice_data_table.value), 12, std::move(data_table_struct_field_list),
            GetArrayKind(indexed_field_slice_data_table.validity)));
    }
    std::vector<std::unique_ptr<StructProperty>> hash_table_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqPromiseReaction::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("reject_handler", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetRejectHandlerAddress(), 1, 4,
        std::move(reject_handler_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> fulfill_handler_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("fulfill_handler", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetFulfillHandlerAddress(), 1,
        4, std::move(fulfill_handler_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> promise_or_capability_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("promise_or_capability", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetPromiseOrCapabilityAddress(), 1, 4, std::move(promise_or_capability_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqPromiseResolveThenableJobTask::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("promise_to_resolve", "v8::internal::TaggedMember<v8::internal::JSPromise>", GetPromiseToResolveAddress(),
        1, 4, std::move(promise_to_resolve_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> thenable_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("thenable", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetThenableAddress(), 1, 4,
        std::move(thenable_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> then_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "then", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetThenAddress(), 1, 4, std::move(then_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqPropertyArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("length_and_hash", "v8::internal::TaggedMember<v8::internal::Object>", GetLengthAndHashAddress(), 1, 4,
        std::move(length_and_hash_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqPropertyCell::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("property_details_raw", "v8::internal::TaggedMember<v8::internal::Object>",
        GetPropertyDetailsRawAddress(), 1, 4, std::move(property_details_raw_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> value_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "value", "v8::internal::TaggedMember<v8::internal::Object>", GetValueAddress(), 1, 4, std::move(value_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> dependent_code_struct_field_list;
...
const char* TqContextSidePropertyCell::GetName() const
{
    return "v8::internal::ContextSidePropertyCell";
}

void TqContextSidePropertyCell::Visit(TqObjectVisitor* visitor) const
{
    visitor->VisitContextSidePropertyCell(this);
}

bool TqContextSidePropertyCell::IsSuperclassOf(const TqObject* other) const
{
    return GetName() != other->GetName() && dynamic_cast<const TqContextSidePropertyCell*>(other) != nullptr;
}

uintptr_t TqContextSidePropertyCell::GetPropertyDetailsRawAddress() const
{
    return address_ - i::kHeapObjectTag + 4;
}

Value<uintptr_t> TqContextSidePropertyCell::GetPropertyDetailsRawValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetPropertyDetailsRawAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
...
uintptr_t TqContextSidePropertyCell::GetDependentCodeAddress() const
{
    return address_ - i::kHeapObjectTag + 8;
}

Value<uintptr_t> TqContextSidePropertyCell::GetDependentCodeValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetDependentCodeAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
...
std::vector<std::unique_ptr<ObjectProperty>> TqContextSidePropertyCell::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> property_details_raw_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("property_details_raw", "v8::internal::TaggedMember<v8::internal::Object>",
...
std::vector<std::unique_ptr<ObjectProperty>> TqPropertyDescriptorObject::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqStruct::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_enumerable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_enumerable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_configurable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_configurable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_writable", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_writable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "has_value", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "has_get", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 8));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "has_set", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 9));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> value_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "get", "v8::internal::TaggedMember<v8::internal::Object>", GetGetAddress(), 1, 4, std::move(get_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> set_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "set", "v8::internal::TaggedMember<v8::internal::Object>", GetSetAddress(), 1, 4, std::move(set_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqPrototypeInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("prototype_users", "v8::internal::TaggedMember<v8::internal::Object>", GetPrototypeUsersAddress(), 1, 4,
        std::move(prototype_users_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> prototype_chain_enum_cache_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("prototype_chain_enum_cache", "v8::internal::TaggedMember<v8::internal::Object>",
        GetPrototypeChainEnumCacheAddress(), 1, 4, std::move(prototype_chain_enum_cache_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> registry_slot_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("registry_slot", "v8::internal::TaggedMember<v8::internal::Object>", GetRegistrySlotAddress(), 1, 4,
        std::move(registry_slot_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bit_field_struct_field_list;
    bit_field_struct_field_list.push_back(std::make_unique<StructProperty>("should_be_fast",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    result.push_back(std::make_unique<ObjectProperty>("bit_field", "v8::internal::TaggedMember<v8::internal::Object>", GetBitFieldAddress(), 1, 4,
        std::move(bit_field_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> derived_maps_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("derived_maps", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetDerivedMapsAddress(), 1, 4,
        std::move(derived_maps_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqScript::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> name_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "name", "v8::internal::TaggedMember<v8::internal::Object>", GetNameAddress(), 1, 4, std::move(name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> line_offset_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("line_offset", "v8::internal::TaggedMember<v8::internal::Object>", GetLineOffsetAddress(), 1, 4,
        std::move(line_offset_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> column_offset_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("column_offset", "v8::internal::TaggedMember<v8::internal::Object>", GetColumnOffsetAddress(), 1, 4,
        std::move(column_offset_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> context_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("context_data", "v8::internal::TaggedMember<v8::internal::Object>", GetContextDataAddress(), 1, 4,
        std::move(context_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> script_type_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("script_type", "v8::internal::TaggedMember<v8::internal::Object>", GetScriptTypeAddress(), 1, 4,
        std::move(script_type_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> line_ends_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("line_ends", "v8::internal::TaggedMember<v8::internal::Object>", GetLineEndsAddress(), 1, 4,
        std::move(line_ends_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> id_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "id", "v8::internal::TaggedMember<v8::internal::Object>", GetIdAddress(), 1, 4, std::move(id_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> eval_from_shared_or_wrapped_arguments_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("eval_from_shared_or_wrapped_arguments", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetEvalFromSharedOrWrappedArgumentsAddress(), 1, 4, std::move(eval_from_shared_or_wrapped_arguments_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> eval_from_position_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("eval_from_position", "v8::internal::TaggedMember<v8::internal::Object>", GetEvalFromPositionAddress(), 1,
        4, std::move(eval_from_position_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> infos_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("infos", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetInfosAddress(), 1, 4,
        std::move(infos_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> compiled_lazy_function_positions_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("compiled_lazy_function_positions", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetCompiledLazyFunctionPositionsAddress(), 1, 4, std::move(compiled_lazy_function_positions_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("compilation_type",
        CheckTypeName<Script::CompilationType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "Script::CompilationType"),
        0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("compilation_state",
        CheckTypeName<Script::CompilationState /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "Script::CompilationState"),
        0, 1, 2));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_repl_mode",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("origin_options",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 4, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("break_on_entry",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 8));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("produce_compile_hints",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 9));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("deserialized",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 10));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> source_url_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("source_url", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetSourceUrlAddress(), 1,
        4, std::move(source_url_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> source_mapping_url_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("source_mapping_url", "v8::internal::TaggedMember<v8::internal::Object>", GetSourceMappingUrlAddress(), 1,
        4, std::move(source_mapping_url_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> host_defined_options_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("host_defined_options", "v8::internal::TaggedMember<v8::internal::FixedArray>",
        GetHostDefinedOptionsAddress(), 1, 4, std::move(host_defined_options_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> source_hash_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("source_hash", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetSourceHashAddress(), 1,
        4, std::move(source_hash_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqPreparseData::GetDataLengthValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqPreparseData::GetChildrenLengthValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqPreparseData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("data_length",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetDataLengthAddress(), 1, 4, std::move(data_length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> children_length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("children_length",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetChildrenLengthAddress(), 1, 4, std::move(children_length_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqInterpreterData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("bytecode_array", "v8::internal::TaggedMember<v8::internal::Object>", GetBytecodeArrayAddress(), 1, 4,
        std::move(bytecode_array_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> interpreter_trampoline_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("interpreter_trampoline", "v8::internal::TaggedMember<v8::internal::Object>",
        GetInterpreterTrampolineAddress(), 1, 4, std::move(interpreter_trampoline_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSharedFunctionInfo::GetTrustedFunctionDataValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSharedFunctionInfo::GetLengthValue(
    d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetLengthAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSharedFunctionInfo::GetFormalParameterCountValue(d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSharedFunctionInfo::GetFunctionTokenOffsetValue(d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSharedFunctionInfo::GetExpectedNofPropertiesValue(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSharedFunctionInfo::GetFlags2Value(
    d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSharedFunctionInfo::GetFlagsValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetFlagsAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqSharedFunctionInfo::GetFunctionLiteralIdValue(d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetFunctionLiteralIdAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSharedFunctionInfo::GetUniqueIdValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSharedFunctionInfo::GetAgeValue(
    d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSharedFunctionInfo::GetPaddingValue(
    d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqSharedFunctionInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("trusted_function_data",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetTrustedFunctionDataAddress(), 1, 4, std::move(trusted_function_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> untrusted_function_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("untrusted_function_data", "v8::internal::TaggedMember<v8::internal::Object>",
        GetUntrustedFunctionDataAddress(), 1, 4, std::move(untrusted_function_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> name_or_scope_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("name_or_scope_info", "v8::internal::TaggedMember<v8::internal::Object>", GetNameOrScopeInfoAddress(), 1,
        4, std::move(name_or_scope_info_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> outer_scope_info_or_feedback_metadata_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("outer_scope_info_or_feedback_metadata", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetOuterScopeInfoOrFeedbackMetadataAddress(), 1, 4, std::move(outer_scope_info_or_feedback_metadata_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> script_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("script", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetScriptAddress(), 1, 4,
        std::move(script_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("length",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetLengthAddress(), 1, 2, std::move(length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> formal_parameter_count_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("formal_parameter_count",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetFormalParameterCountAddress(), 1, 2, std::move(formal_parameter_count_struct_field_list), d::PropertyKind::kSingle));
    ...
    result.push_back(std::make_unique<ObjectProperty>("function_token_offset",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetFunctionTokenOffsetAddress(), 1, 2, std::move(function_token_offset_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> expected_nof_properties_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("expected_nof_properties",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetExpectedNofPropertiesAddress(), 1, 1, std::move(expected_nof_properties_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags2_struct_field_list;
    flags2_struct_field_list.push_back(std::make_unique<StructProperty>("class_scope_has_private_brand",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    flags2_struct_field_list.push_back(std::make_unique<StructProperty>("has_static_private_methods_or_accessors",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags2_struct_field_list.push_back(std::make_unique<StructProperty>("is_sparkplug_compiling",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    flags2_struct_field_list.push_back(std::make_unique<StructProperty>("maglev_compilation_failed",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    flags2_struct_field_list.push_back(std::make_unique<StructProperty>("cached_tiering_decision",
        CheckTypeName<CachedTieringDecision /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "CachedTieringDecision"),
        0, 3, 4));
    flags2_struct_field_list.push_back(std::make_unique<StructProperty>("function_context_independent_compiled",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    result.push_back(std::make_unique<ObjectProperty>("flags2",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"), GetFlags2Address(),
        1, 1, std::move(flags2_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("function_kind",
        CheckTypeName<FunctionKind /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("FunctionKind"), 0, 5,
        0));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_native", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>(
        "is_strict", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("function_syntax_kind",
        CheckTypeName<FunctionSyntaxKind /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "FunctionSyntaxKind"),
        0, 3, 7));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_class_constructor",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 10));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_duplicate_parameters",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 11));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("allow_lazy_compilation",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 12));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("is_asm_wasm_broken",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 13));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("function_map_index",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 5, 14));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("disabled_optimization_reason",
        CheckTypeName<BailoutReason /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("BailoutReason"), 0, 4,
        19));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("requires_instance_members_initializer",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 23));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("construct_as_builtin",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 24));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("name_should_print_as_anonymous",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 25));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_reported_binary_coverage",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 26));
    ...
    result.push_back(std::make_unique<ObjectProperty>("flags",
        ...
        GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> function_literal_id_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("function_literal_id",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetFunctionLiteralIdAddress(), 1, 4, std::move(function_literal_id_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> unique_id_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("unique_id",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetUniqueIdAddress(), 1, 4, std::move(unique_id_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> age_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("age",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"), GetAgeAddress(),
        1, 2, std::move(age_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> padding_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("padding",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetPaddingAddress(), 1, 2, std::move(padding_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqSharedFunctionInfoWrapper::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqTrustedObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> shared_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("shared_info", "v8::internal::TaggedMember<v8::internal::SharedFunctionInfo>", GetSharedInfoAddress(), 1,
        4, std::move(shared_info_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqUncompiledData::GetStartPositionValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetStartPositionAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqUncompiledData::GetEndPositionValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetEndPositionAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqUncompiledData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("inferred_name", "v8::internal::TaggedMember<v8::internal::String>", GetInferredNameAddress(), 1, 4,
        std::move(inferred_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> start_position_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("start_position",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetStartPositionAddress(), 1, 4, std::move(start_position_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> end_position_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("end_position",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetEndPositionAddress(), 1, 4, std::move(end_position_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqUncompiledDataWithPreparseData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("preparse_data", "v8::internal::TaggedMember<v8::internal::PreparseData>", GetPreparseDataAddress(), 1, 4,
        std::move(preparse_data_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqUncompiledDataWithoutPreparseDataWithJob::GetJobValue(d::MemoryAccessor accessor) const
{
    Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqUncompiledDataWithoutPreparseDataWithJob::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("job",
        CheckTypeName<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("Address"), GetJobAddress(), 1,
        4, std::move(job_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqUncompiledDataWithPreparseDataAndJob::GetJobValue(d::MemoryAccessor accessor) const
{
    Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetJobAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
std::vector<std::unique_ptr<ObjectProperty>> TqOnHeapBasicBlockProfilerData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("block_ids", "v8::internal::TaggedMember<v8::internal::ByteArray>", GetBlockIdsAddress(), 1, 4,
        std::move(block_ids_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> counts_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("counts", "v8::internal::TaggedMember<v8::internal::ByteArray>", GetCountsAddress(), 1, 4,
        std::move(counts_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> branches_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("branches", "v8::internal::TaggedMember<v8::internal::ByteArray>", GetBranchesAddress(), 1, 4,
        std::move(branches_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> name_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "name", "v8::internal::TaggedMember<v8::internal::String>", GetNameAddress(), 1, 4, std::move(name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> schedule_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("schedule", "v8::internal::TaggedMember<v8::internal::String>", GetScheduleAddress(), 1, 4,
        std::move(schedule_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> code_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "code", "v8::internal::TaggedMember<v8::internal::String>", GetCodeAddress(), 1, 4, std::move(code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> hash_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "hash", "v8::internal::TaggedMember<v8::internal::Object>", GetHashAddress(), 1, 4, std::move(hash_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqSourceTextModule::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> code_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "code", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetCodeAddress(), 1, 4, std::move(code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> regular_exports_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("regular_exports", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetRegularExportsAddress(), 1,
        4, std::move(regular_exports_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> regular_imports_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("regular_imports", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetRegularImportsAddress(), 1,
        4, std::move(regular_imports_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> requested_modules_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("requested_modules", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetRequestedModulesAddress(),
        1, 4, std::move(requested_modules_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> import_meta_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("import_meta", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetImportMetaAddress(), 1, 4,
        std::move(import_meta_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> cycle_root_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("cycle_root", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetCycleRootAddress(), 1, 4,
        std::move(cycle_root_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> async_parent_modules_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("async_parent_modules", "v8::internal::TaggedMember<v8::internal::ArrayList>",
        GetAsyncParentModulesAddress(), 1, 4, std::move(async_parent_modules_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> dfs_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("dfs_index", "v8::internal::TaggedMember<v8::internal::Object>", GetDfsIndexAddress(), 1, 4,
        std::move(dfs_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> dfs_ancestor_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("dfs_ancestor_index", "v8::internal::TaggedMember<v8::internal::Object>", GetDfsAncestorIndexAddress(), 1,
        4, std::move(dfs_ancestor_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> pending_async_dependencies_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("pending_async_dependencies", "v8::internal::TaggedMember<v8::internal::Object>",
        GetPendingAsyncDependenciesAddress(), 1, 4, std::move(pending_async_dependencies_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("has_toplevel_await",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("async_evaluation_ordinal",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 30, 2));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqModuleRequest::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("specifier", "v8::internal::TaggedMember<v8::internal::String>", GetSpecifierAddress(), 1, 4,
        std::move(specifier_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> import_attributes_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("import_attributes", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetImportAttributesAddress(),
        1, 4, std::move(import_attributes_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("phase",
        CheckTypeName<ModuleImportPhase /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ModuleImportPhase"),
        0, 1, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("position",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 30, 2));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqSourceTextModuleInfoEntry::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("export_name", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetExportNameAddress(), 1,
        4, std::move(export_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> local_name_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("local_name", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetLocalNameAddress(), 1,
        4, std::move(local_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> import_name_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("import_name", "v8::internal::TaggedMember<v8::internal::PrimitiveHeapObject>", GetImportNameAddress(), 1,
        4, std::move(import_name_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> module_request_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("module_request", "v8::internal::TaggedMember<v8::internal::Object>", GetModuleRequestAddress(), 1, 4,
        std::move(module_request_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> cell_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("cell_index", "v8::internal::TaggedMember<v8::internal::Object>", GetCellIndexAddress(), 1, 4,
        std::move(cell_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> beg_pos_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("beg_pos", "v8::internal::TaggedMember<v8::internal::Object>", GetBegPosAddress(), 1, 4,
        std::move(beg_pos_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> end_pos_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("end_pos", "v8::internal::TaggedMember<v8::internal::Object>", GetEndPosAddress(), 1, 4,
        std::move(end_pos_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqConsString::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "first", "v8::internal::TaggedMember<v8::internal::String>", GetFirstAddress(), 1, 4, std::move(first_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> second_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "second", "v8::internal::TaggedMember<v8::internal::String>", GetSecondAddress(), 1, 4, std::move(second_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqExternalString::GetResourceValue(
    d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqExternalString::GetResourceDataValue(d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqExternalString::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("resource",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetResourceAddress(), 1, 4, std::move(resource_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> resource_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("resource_data",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetResourceDataAddress(), 1, 4, std::move(resource_data_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<char /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSeqOneByteString::GetCharsValue(
    d::MemoryAccessor accessor, size_t offset) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqSeqOneByteString::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_chars.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("chars",
            CheckTypeName<char /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("char"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_chars.value), std::get<2>(indexed_field_slice_chars.value), 1,
            std::move(chars_struct_field_list), GetArrayKind(indexed_field_slice_chars.validity)));
    }
    return result;
}
...
Value<char16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSeqTwoByteString::GetCharsValue(
    d::MemoryAccessor accessor, size_t offset) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqSeqTwoByteString::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_chars.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("chars",
            CheckTypeName<char16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("char16_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_chars.value), std::get<2>(indexed_field_slice_chars.value), 2,
            std::move(chars_struct_field_list), GetArrayKind(indexed_field_slice_chars.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqSlicedString::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "parent", "v8::internal::TaggedMember<v8::internal::String>", GetParentAddress(), 1, 4, std::move(parent_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> offset_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "offset", "v8::internal::TaggedMember<v8::internal::Object>", GetOffsetAddress(), 1, 4, std::move(offset_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqThinString::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "actual", "v8::internal::TaggedMember<v8::internal::String>", GetActualAddress(), 1, 4, std::move(actual_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqTuple2::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "value1", "v8::internal::TaggedMember<v8::internal::Object>", GetValue1Address(), 1, 4, std::move(value1_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> value2_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "value2", "v8::internal::TaggedMember<v8::internal::Object>", GetValue2Address(), 1, 4, std::move(value2_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSwissNameDictionary::GetHashValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetHashAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqSwissNameDictionary::GetCapacityValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetCapacityAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqSwissNameDictionary::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> hash_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("hash",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), GetHashAddress(),
        1, 4, std::move(hash_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> capacity_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("capacity",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"),
        GetCapacityAddress(), 1, 4, std::move(capacity_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> meta_table_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("meta_table", "v8::internal::TaggedMember<v8::internal::ByteArray>", GetMetaTableAddress(), 1, 4,
        std::move(meta_table_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data_table_struct_field_list;
    ...
    if (indexed_field_slice_ctrl_table.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("ctrl_table",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_ctrl_table.value), std::get<2>(indexed_field_slice_ctrl_table.value), 1,
            std::move(ctrl_table_struct_field_list), GetArrayKind(indexed_field_slice_ctrl_table.validity)));
    }
    ...
    if (indexed_field_slice_property_details_table.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("property_details_table",
            CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_property_details_table.value),
            std::get<2>(indexed_field_slice_property_details_table.value), 1, std::move(property_details_table_struct_field_list),
            GetArrayKind(indexed_field_slice_property_details_table.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqSyntheticModule::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("export_names", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetExportNamesAddress(), 1, 4,
        std::move(export_names_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> evaluation_steps_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("evaluation_steps", "v8::internal::TaggedMember<v8::internal::Foreign>", GetEvaluationStepsAddress(), 1,
        4, std::move(evaluation_steps_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqTemplateObjectDescription::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("raw_strings", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetRawStringsAddress(), 1, 4,
        std::move(raw_strings_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> cooked_strings_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("cooked_strings", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetCookedStringsAddress(), 1, 4,
        std::move(cooked_strings_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqFunctionTemplateRareData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("prototype_template", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetPrototypeTemplateAddress(), 1, 4, std::move(prototype_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> prototype_provider_template_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("prototype_provider_template", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetPrototypeProviderTemplateAddress(), 1, 4, std::move(prototype_provider_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> parent_template_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parent_template", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetParentTemplateAddress(), 1,
        4, std::move(parent_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> named_property_handler_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("named_property_handler", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetNamedPropertyHandlerAddress(), 1, 4, std::move(named_property_handler_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> indexed_property_handler_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("indexed_property_handler", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetIndexedPropertyHandlerAddress(), 1, 4, std::move(indexed_property_handler_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_template_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_template", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetInstanceTemplateAddress(),
        1, 4, std::move(instance_template_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instance_call_handler_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instance_call_handler", "v8::internal::TaggedMember<v8::internal::HeapObject>",
        GetInstanceCallHandlerAddress(), 1, 4, std::move(instance_call_handler_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> access_check_info_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("access_check_info", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetAccessCheckInfoAddress(),
        1, 4, std::move(access_check_info_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> c_function_overloads_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("c_function_overloads", "v8::internal::TaggedMember<v8::internal::FixedArray>",
        GetCFunctionOverloadsAddress(), 1, 4, std::move(c_function_overloads_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqObjectTemplateInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("constructor", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetConstructorAddress(), 1, 4,
        std::move(constructor_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data_struct_field_list;
    data_struct_field_list.push_back(std::make_unique<StructProperty>("is_immutable_prototype",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    data_struct_field_list.push_back(std::make_unique<StructProperty>("is_code_kind",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    data_struct_field_list.push_back(std::make_unique<StructProperty>("embedder_field_count",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 28, 3));
    result.push_back(std::make_unique<ObjectProperty>(
        "data", "v8::internal::TaggedMember<v8::internal::Object>", GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
uintptr_t TqDictionaryTemplateInfo::GetSerialNumberAddress() const
{
    return address_ - i::kHeapObjectTag + 8;
}

Value<uintptr_t> TqDictionaryTemplateInfo::GetSerialNumberValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetSerialNumberAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
...
std::vector<std::unique_ptr<ObjectProperty>> TqDictionaryTemplateInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("property_names", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetPropertyNamesAddress(), 1, 4,
        std::move(property_names_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> serial_number_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("serial_number", "v8::internal::TaggedMember<v8::internal::Object>", GetSerialNumberAddress(), 1, 4,
        std::move(serial_number_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurbofanBitsetType::GetBitsetLowValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurbofanBitsetType::GetBitsetHighValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurbofanBitsetType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("_unused_padding_field_1",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_unsigned31",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_unsigned32",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_signed32",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 3));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_number",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 4));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_string",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 5));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "negative31", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 6));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "null", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 7));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "undefined", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 8));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "boolean", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 9));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "unsigned30", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 10));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "minus_zero", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 11));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "naN", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 12));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "symbol", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 13));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("internalized_string",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 14));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_callable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 15));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_object",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 16));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_undetectable",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 17));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("callable_proxy",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 18));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_proxy",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 19));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("callable_function",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 20));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("class_constructor",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 21));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("bound_function",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 22));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_internal",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 23));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("external_pointer",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 24));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>(
        "array", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 25));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("unsigned_big_int_63",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 26));
    ...
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("negative_big_int_63",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 28));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("other_big_int",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 29));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("wasm_object",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 30));
    bitset_low_struct_field_list.push_back(std::make_unique<StructProperty>("sandboxed_pointer",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 31));
    result.push_back(std::make_unique<ObjectProperty>("bitset_low",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetBitsetLowAddress(), 1, 4, std::move(bitset_low_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bitset_high_struct_field_list;
    bitset_high_struct_field_list.push_back(std::make_unique<StructProperty>(
        "machine", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    bitset_high_struct_field_list.push_back(std::make_unique<StructProperty>(
        "hole", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    bitset_high_struct_field_list.push_back(std::make_unique<StructProperty>("string_wrapper",
        CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 2));
    result.push_back(std::make_unique<ObjectProperty>("bitset_high",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetBitsetHighAddress(), 1, 4, std::move(bitset_high_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurbofanUnionType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("type1", "v8::internal::TaggedMember<v8::internal::TurbofanType>", GetType1Address(), 1, 4,
        std::move(type1_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> type2_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("type2", "v8::internal::TaggedMember<v8::internal::TurbofanType>", GetType2Address(), 1, 4,
        std::move(type2_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurbofanRangeType::GetMinValue(
    d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetMinAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurbofanRangeType::GetMaxValue(
    d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurbofanRangeType::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqTurbofanType::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> min_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("min",
        CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"), GetMinAddress(), 1,
        8, std::move(min_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> max_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("max",
        CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"), GetMaxAddress(), 1,
        8, std::move(max_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurbofanHeapConstantType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("constant", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetConstantAddress(), 1, 4,
        std::move(constant_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqTurbofanOtherNumberConstantType::GetConstantValue(d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetConstantAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurbofanOtherNumberConstantType::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqTurbofanType::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> constant_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("constant",
        CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"), GetConstantAddress(),
        1, 8, std::move(constant_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord32RangeType::GetFromValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord32RangeType::GetToValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurboshaftWord32RangeType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("from",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), GetFromAddress(),
        1, 4, std::move(from_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> to_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("to",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), GetToAddress(),
        1, 4, std::move(to_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord32SetType::GetSetSizeValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord32SetType::GetElementsValue(
    d::MemoryAccessor accessor, size_t offset) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetElementsAddress() + offset * sizeof(value), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurboshaftWord32SetType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("set_size",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetSetSizeAddress(), 1, 4, std::move(set_size_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> elements_struct_field_list;
    auto indexed_field_slice_elements = TqDebugFieldSliceTurboshaftWord32SetTypeElements(accessor, address_);
    if (indexed_field_slice_elements.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("elements",
            CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_elements.value), std::get<2>(indexed_field_slice_elements.value), 4,
            std::move(elements_struct_field_list), GetArrayKind(indexed_field_slice_elements.validity)));
    }
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord64RangeType::GetFromHighValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord64RangeType::GetFromLowValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord64RangeType::GetToHighValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord64RangeType::GetToLowValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurboshaftWord64RangeType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("from_high",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetFromHighAddress(), 1, 4, std::move(from_high_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> from_low_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("from_low",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetFromLowAddress(), 1, 4, std::move(from_low_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> to_high_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("to_high",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetToHighAddress(), 1, 4, std::move(to_high_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> to_low_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("to_low",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetToLowAddress(), 1, 4, std::move(to_low_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftWord64SetType::GetSetSizeValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetSetSizeAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqTurboshaftWord64SetType::GetElementsHighValue(d::MemoryAccessor accessor, size_t offset) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurboshaftWord64SetType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_elements_high.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("elements_high",
            CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_elements_high.value), std::get<2>(indexed_field_slice_elements_high.value), 4,
            std::move(elements_high_struct_field_list), GetArrayKind(indexed_field_slice_elements_high.validity)));
    }
    ...
    if (indexed_field_slice_elements_low.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("elements_low",
            CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_elements_low.value), std::get<2>(indexed_field_slice_elements_low.value), 4,
            std::move(elements_low_struct_field_list), GetArrayKind(indexed_field_slice_elements_low.validity)));
    }
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqTurboshaftFloat64Type::GetSpecialValuesValue(d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurboshaftFloat64Type::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    special_values_struct_field_list.push_back(std::make_unique<StructProperty>(
        "nan", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 0));
    special_values_struct_field_list.push_back(std::make_unique<StructProperty>(
        "minus_zero", CheckTypeName<bool /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("bool"), 0, 1, 1));
    special_values_struct_field_list.push_back(std::make_unique<StructProperty>("_unused",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"), 0, 30, 2));
    result.push_back(std::make_unique<ObjectProperty>("special_values",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetSpecialValuesAddress(), 1, 4, std::move(special_values_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftFloat64RangeType::GetPaddingValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetPaddingAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftFloat64RangeType::GetMinValue(
    d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetMinAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftFloat64RangeType::GetMaxValue(
    d::MemoryAccessor accessor) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetMaxAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurboshaftFloat64RangeType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("_padding",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetPaddingAddress(), 1, 4, std::move(_padding_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> min_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("min",
        CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"), GetMinAddress(), 1,
        8, std::move(min_struct_field_list), d::PropertyKind::kSingle));
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftFloat64SetType::GetSetSizeValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetSetSizeAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
Value<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqTurboshaftFloat64SetType::GetElementsValue(
    d::MemoryAccessor accessor, size_t offset) const
{
    double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetElementsAddress() + offset * sizeof(value), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqTurboshaftFloat64SetType::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    if (indexed_field_slice_elements.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("elements",
            CheckTypeName<double /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("double"),
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_elements.value), std::get<2>(indexed_field_slice_elements.value), 8,
            std::move(elements_struct_field_list), GetArrayKind(indexed_field_slice_elements.validity)));
    }
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqInternalClass::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "a", "v8::internal::TaggedMember<v8::internal::Object>", GetAAddress(), 1, 4, std::move(a_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> b_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "b", "v8::internal::TaggedMember<v8::internal::Object>", GetBAddress(), 1, 4, std::move(b_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqSmiBox::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("unrelated", "v8::internal::TaggedMember<v8::internal::Object>", GetUnrelatedAddress(), 1, 4,
        std::move(unrelated_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqExportedSubClassBase::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> a_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "a", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetAAddress(), 1, 4, std::move(a_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> b_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "b", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBAddress(), 1, 4, std::move(b_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqExportedSubClass::GetCFieldValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqExportedSubClass::GetDFieldValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqExportedSubClass::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("c_field",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetCFieldAddress(),
        1, 4, std::move(c_field_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> d_field_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("d_field",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetDFieldAddress(),
        1, 4, std::move(d_field_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> e_field_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("e_field", "v8::internal::TaggedMember<v8::internal::Object>", GetEFieldAddress(), 1, 4,
        std::move(e_field_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqInternalClassWithStructElements::GetDummy1Value(d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqInternalClassWithStructElements::GetDummy2Value(d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqInternalClassWithStructElements::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("dummy1",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetDummy1Address(),
    ...
    result.push_back(std::make_unique<ObjectProperty>("dummy2",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetDummy2Address(),
        1, 4, std::move(dummy2_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> count_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "count", "v8::internal::TaggedMember<v8::internal::Object>", GetCountAddress(), 1, 4, std::move(count_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "data", "v8::internal::TaggedMember<v8::internal::Object>", GetDataAddress(), 1, 4, std::move(data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> object_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "object", "v8::internal::TaggedMember<v8::internal::Object>", GetObjectAddress(), 1, 4, std::move(object_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_entries.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("entries", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_entries.value), std::get<2>(indexed_field_slice_entries.value), 4,
            std::move(entries_struct_field_list), GetArrayKind(indexed_field_slice_entries.validity)));
    }
    std::vector<std::unique_ptr<StructProperty>> more_entries_struct_field_list;
    more_entries_struct_field_list.push_back(std::make_unique<StructProperty>("a", "v8::internal::TaggedMember<v8::internal::Object>", 0, 0, 0));
    more_entries_struct_field_list.push_back(std::make_unique<StructProperty>("b", "v8::internal::TaggedMember<v8::internal::Object>", 4, 0, 0));
    ...
    if (indexed_field_slice_more_entries.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("more_entries", "",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_more_entries.value), std::get<2>(indexed_field_slice_more_entries.value), 8,
            std::move(more_entries_struct_field_list), GetArrayKind(indexed_field_slice_more_entries.validity)));
    }
    return result;
}
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqExportedSubClass2::GetXFieldValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqExportedSubClass2::GetYFieldValue(
    d::MemoryAccessor accessor) const
{
    int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqExportedSubClass2::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("x_field",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetXFieldAddress(),
        1, 4, std::move(x_field_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> y_field_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("y_field",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), GetYFieldAddress(),
        1, 4, std::move(y_field_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> z_field_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("z_field", "v8::internal::TaggedMember<v8::internal::Object>", GetZFieldAddress(), 1, 4,
        std::move(z_field_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqSortState::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> receiver_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("receiver", "v8::internal::TaggedMember<v8::internal::JSReceiver>", GetReceiverAddress(), 1, 4,
        std::move(receiver_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> initialReceiverMap_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("initialReceiverMap", "v8::internal::TaggedMember<v8::internal::Map>", GetInitialReceiverMapAddress(), 1,
        4, std::move(initialReceiverMap_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> initialReceiverLength_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("initialReceiverLength", "v8::internal::TaggedMember<v8::internal::Object>",
        GetInitialReceiverLengthAddress(), 1, 4, std::move(initialReceiverLength_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> userCmpFn_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("userCmpFn", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetUserCmpFnAddress(), 1, 4,
        std::move(userCmpFn_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> sortComparePtr_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("sortComparePtr", "v8::internal::TaggedMember<v8::internal::Object>", GetSortComparePtrAddress(), 1, 4,
        std::move(sortComparePtr_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> loadFn_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "loadFn", "v8::internal::TaggedMember<v8::internal::Object>", GetLoadFnAddress(), 1, 4, std::move(loadFn_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> storeFn_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("storeFn", "v8::internal::TaggedMember<v8::internal::Object>", GetStoreFnAddress(), 1, 4,
        std::move(storeFn_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> deleteFn_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("deleteFn", "v8::internal::TaggedMember<v8::internal::Object>", GetDeleteFnAddress(), 1, 4,
        std::move(deleteFn_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> canUseSameAccessorFn_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("canUseSameAccessorFn", "v8::internal::TaggedMember<v8::internal::Object>",
        GetCanUseSameAccessorFnAddress(), 1, 4, std::move(canUseSameAccessorFn_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> minGallop_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("minGallop", "v8::internal::TaggedMember<v8::internal::Object>", GetMinGallopAddress(), 1, 4,
        std::move(minGallop_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> pendingRunsSize_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("pendingRunsSize", "v8::internal::TaggedMember<v8::internal::Object>", GetPendingRunsSizeAddress(), 1, 4,
        std::move(pendingRunsSize_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> pendingRuns_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("pendingRuns", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetPendingRunsAddress(), 1, 4,
        std::move(pendingRuns_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> workArray_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("workArray", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetWorkArrayAddress(), 1, 4,
        std::move(workArray_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> tempArray_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("tempArray", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetTempArrayAddress(), 1, 4,
        std::move(tempArray_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> sortLength_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("sortLength", "v8::internal::TaggedMember<v8::internal::Object>", GetSortLengthAddress(), 1, 4,
        std::move(sortLength_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> numberOfUndefined_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("numberOfUndefined", "v8::internal::TaggedMember<v8::internal::Object>", GetNumberOfUndefinedAddress(), 1,
        4, std::move(numberOfUndefined_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSV8BreakIterator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "locale", "v8::internal::TaggedMember<v8::internal::String>", GetLocaleAddress(), 1, 4, std::move(locale_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> break_iterator_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("break_iterator", "v8::internal::TaggedMember<v8::internal::Foreign>", GetBreakIteratorAddress(), 1, 4,
        std::move(break_iterator_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> unicode_string_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("unicode_string", "v8::internal::TaggedMember<v8::internal::Foreign>", GetUnicodeStringAddress(), 1, 4,
        std::move(unicode_string_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_adopt_text_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_adopt_text", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBoundAdoptTextAddress(), 1,
        4, std::move(bound_adopt_text_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_first_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_first", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBoundFirstAddress(), 1, 4,
        std::move(bound_first_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_next_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_next", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBoundNextAddress(), 1, 4,
        std::move(bound_next_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_current_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_current", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBoundCurrentAddress(), 1, 4,
        std::move(bound_current_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_break_type_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_break_type", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBoundBreakTypeAddress(), 1,
        4, std::move(bound_break_type_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSCollator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("icu_collator", "v8::internal::TaggedMember<v8::internal::Foreign>", GetIcuCollatorAddress(), 1, 4,
        std::move(icu_collator_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_compare_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_compare", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBoundCompareAddress(), 1, 4,
        std::move(bound_compare_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> locale_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "locale", "v8::internal::TaggedMember<v8::internal::String>", GetLocaleAddress(), 1, 4, std::move(locale_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDateTimeFormat::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("icu_locale", "v8::internal::TaggedMember<v8::internal::Foreign>", GetIcuLocaleAddress(), 1, 4,
        std::move(icu_locale_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> icu_simple_date_format_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("icu_simple_date_format", "v8::internal::TaggedMember<v8::internal::Foreign>",
        GetIcuSimpleDateFormatAddress(), 1, 4, std::move(icu_simple_date_format_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> icu_date_interval_format_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("icu_date_interval_format", "v8::internal::TaggedMember<v8::internal::Foreign>",
        GetIcuDateIntervalFormatAddress(), 1, 4, std::move(icu_date_interval_format_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> bound_format_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("bound_format", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetBoundFormatAddress(), 1, 4,
        std::move(bound_format_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("hour_cycle",
        CheckTypeName<JSDateTimeFormat::HourCycle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDateTimeFormat::HourCycle"),
        0, 3, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("date_style",
        CheckTypeName<JSDateTimeFormat::DateTimeStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDateTimeFormat::DateTimeStyle"),
        0, 3, 4));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("time_style",
        CheckTypeName<JSDateTimeFormat::DateTimeStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDateTimeFormat::DateTimeStyle"),
        0, 3, 7));
    result.push_back(std::make_unique<ObjectProperty>(
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDisplayNames::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("internal", "v8::internal::TaggedMember<v8::internal::Foreign>", GetInternalAddress(), 1, 4,
        std::move(internal_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("style",
        CheckTypeName<JSDisplayNames::Style /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDisplayNames::Style"),
        0, 2, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("fallback",
        CheckTypeName<JSDisplayNames::Fallback /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDisplayNames::Fallback"),
        0, 1, 3));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("language_display",
        CheckTypeName<JSDisplayNames::LanguageDisplay /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDisplayNames::LanguageDisplay"),
        0, 1, 4));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSDurationFormat::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("style",
        CheckTypeName<JSDurationFormat::Style /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Style"),
        0, 2, 1));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("years_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 2, 3));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("months_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 2, 5));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("weeks_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 2, 7));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("days_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 2, 9));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("hours_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 3, 11));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("minutes_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 3, 14));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("seconds_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 3, 17));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("milliseconds_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 3, 20));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("microseconds_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 3, 23));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("nanoseconds_style",
        CheckTypeName<JSDurationFormat::FieldStyle /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::FieldStyle"),
        0, 3, 26));
    style_flags_struct_field_list.push_back(std::make_unique<StructProperty>("separator",
        CheckTypeName<JSDurationFormat::Separator /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Separator"),
        0, 2, 29));
    result.push_back(std::make_unique<ObjectProperty>("style_flags", "v8::internal::TaggedMember<v8::internal::Object>", GetStyleFlagsAddress(), 1, 4,
        std::move(style_flags_struct_field_list), d::PropertyKind::kSingle));
    ...
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("years_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 1));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("months_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 2));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("weeks_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 3));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("days_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 4));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("hours_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 5));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("minutes_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 6));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("seconds_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 7));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("milliseconds_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 8));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("microseconds_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 9));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("nanoseconds_display",
        CheckTypeName<JSDurationFormat::Display /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSDurationFormat::Display"),
        0, 1, 10));
    display_flags_struct_field_list.push_back(std::make_unique<StructProperty>("fractional_digits",
        CheckTypeName<int32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("int32_t"), 0, 4, 11));
    result.push_back(std::make_unique<ObjectProperty>("display_flags", "v8::internal::TaggedMember<v8::internal::Object>", GetDisplayFlagsAddress(), 1, 4,
        std::move(display_flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> icu_locale_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("icu_locale", "v8::internal::TaggedMember<v8::internal::Foreign>", GetIcuLocaleAddress(), 1, 4,
        std::move(icu_locale_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> icu_number_formatter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("icu_number_formatter", "v8::internal::TaggedMember<v8::internal::Foreign>",
        GetIcuNumberFormatterAddress(), 1, 4, std::move(icu_number_formatter_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSListFormat::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("icu_formatter", "v8::internal::TaggedMember<v8::internal::Foreign>", GetIcuFormatterAddress(), 1, 4,
        std::move(icu_formatter_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("style",
        CheckTypeName<JSListFormat::Style /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSListFormat::Style"),
        0, 2, 1));
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("Type",
        CheckTypeName<JSListFormat::Type /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSListFormat::Type"),
        0, 2, 3));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSPluralRules::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("Type",
        CheckTypeName<JSPluralRules::Type /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSPluralRules::Type"),
        0, 1, 1));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> icu_plural_rules_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("icu_plural_rules", "v8::internal::TaggedMember<v8::internal::Foreign>", GetIcuPluralRulesAddress(), 1, 4,
        std::move(icu_plural_rules_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> icu_number_formatter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("icu_number_formatter", "v8::internal::TaggedMember<v8::internal::Foreign>",
        GetIcuNumberFormatterAddress(), 1, 4, std::move(icu_number_formatter_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSRelativeTimeFormat::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("numberingSystem", "v8::internal::TaggedMember<v8::internal::String>", GetNumberingSystemAddress(), 1, 4,
        std::move(numberingSystem_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> icu_formatter_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("icu_formatter", "v8::internal::TaggedMember<v8::internal::Foreign>", GetIcuFormatterAddress(), 1, 4,
        std::move(icu_formatter_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("numeric",
        CheckTypeName<JSRelativeTimeFormat::Numeric /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "JSRelativeTimeFormat::Numeric"),
        0, 1, 1));
    result.push_back(std::make_unique<ObjectProperty>(
        "flags", "v8::internal::TaggedMember<v8::internal::Object>", GetFlagsAddress(), 1, 4, std::move(flags_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSSegmentIterator::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("icu_break_iterator", "v8::internal::TaggedMember<v8::internal::Foreign>", GetIcuBreakIteratorAddress(),
        1, 4, std::move(icu_break_iterator_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_string_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("raw_string", "v8::internal::TaggedMember<v8::internal::String>", GetRawStringAddress(), 1, 4,
        std::move(raw_string_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> unicode_string_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("unicode_string", "v8::internal::TaggedMember<v8::internal::Foreign>", GetUnicodeStringAddress(), 1, 4,
        std::move(unicode_string_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> flags_struct_field_list;
    flags_struct_field_list.push_back(std::make_unique<StructProperty>("granularity",
        CheckTypeName<JSSegmenter::Granularity /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSSegmentDataObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("segment", "v8::internal::TaggedMember<v8::internal::String>", GetSegmentAddress(), 1, 4,
        std::move(segment_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "index", "v8::internal::TaggedMember<v8::internal::Object>", GetIndexAddress(), 1, 4, std::move(index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> input_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "input", "v8::internal::TaggedMember<v8::internal::String>", GetInputAddress(), 1, 4, std::move(input_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqJSSegmentDataObjectWithIsWordLike::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("is_word_like", "v8::internal::TaggedMember<v8::internal::Boolean>", GetIsWordLikeAddress(), 1, 4,
        std::move(is_word_like_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
uintptr_t TqWasmImportData::GetSuspendAddress() const
{
    return address_ - i::kHeapObjectTag + 16;
}

Value<uintptr_t> TqWasmImportData::GetSuspendValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
...
uintptr_t TqWasmImportData::GetCallOriginAddress() const
{
    return address_ - i::kHeapObjectTag + 24;
}

Value<uintptr_t> TqWasmImportData::GetCallOriginValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
...
Value<const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmImportData::GetSigValue(d::MemoryAccessor accessor) const
{
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmImportData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("protected_instance_data", "v8::internal::TaggedMember<v8::internal::Object>",
        GetProtectedInstanceDataAddress(), 1, 4, std::move(protected_instance_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> native_context_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("native_context", "v8::internal::TaggedMember<v8::internal::NativeContext>", GetNativeContextAddress(), 1,
        4, std::move(native_context_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> callable_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("callable", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetCallableAddress(), 1, 4,
        std::move(callable_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> suspend_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("suspend", "v8::internal::TaggedMember<v8::internal::Object>", GetSuspendAddress(), 1, 4,
        std::move(suspend_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> wrapper_budget_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("wrapper_budget", "v8::internal::TaggedMember<v8::internal::Object>", GetWrapperBudgetAddress(), 1, 4,
        std::move(wrapper_budget_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> call_origin_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("call_origin", "v8::internal::TaggedMember<v8::internal::Object>", GetCallOriginAddress(), 1, 4,
        std::move(call_origin_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> sig_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("sig",
        CheckTypeName<const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "const wasm::CanonicalSig*"),
        GetSigAddress(), 1, 4, std::move(sig_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmInstanceObject::GetTrustedDataValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmInstanceObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("trusted_data",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetTrustedDataAddress(), 1, 4, std::move(trusted_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> module_object_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("module_object", "v8::internal::TaggedMember<v8::internal::WasmModuleObject>", GetModuleObjectAddress(),
        1, 4, std::move(module_object_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> exports_object_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("exports_object", "v8::internal::TaggedMember<v8::internal::JSObject>", GetExportsObjectAddress(), 1, 4,
        std::move(exports_object_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmFastApiCallData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("cached_map", "v8::internal::TaggedMember<v8::internal::Object>", GetCachedMapAddress(), 1, 4,
        std::move(cached_map_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmInternalFunction::GetCallTargetValue(
    d::MemoryAccessor accessor) const
{
    Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmInternalFunction::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("protected_implicit_arg", "v8::internal::TaggedMember<v8::internal::Object>",
        GetProtectedImplicitArgAddress(), 1, 4, std::move(protected_implicit_arg_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> external_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("external", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetExternalAddress(), 1, 4,
        std::move(external_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> function_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("function_index", "v8::internal::TaggedMember<v8::internal::Object>", GetFunctionIndexAddress(), 1, 4,
        std::move(function_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> call_target_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("call_target",
        CheckTypeName<Address /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("Address"),
        GetCallTargetAddress(), 1, 4, std::move(call_target_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmFunctionData::GetWrapperCodeValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmFunctionData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("wrapper_code",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetWrapperCodeAddress(), 1, 4, std::move(wrapper_code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> func_ref_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("func_ref", "v8::internal::TaggedMember<v8::internal::WasmFuncRef>", GetFuncRefAddress(), 1, 4,
        std::move(func_ref_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> js_promise_flags_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("js_promise_flags", "v8::internal::TaggedMember<v8::internal::Object>", GetJsPromiseFlagsAddress(), 1, 4,
        std::move(js_promise_flags_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> protected_internal_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("protected_internal", "v8::internal::TaggedMember<v8::internal::Object>", GetProtectedInternalAddress(),
        1, 4, std::move(protected_internal_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmExportedFunctionData::GetCWrapperCodeValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmExportedFunctionData::GetSigValue(d::MemoryAccessor accessor) const
{
    const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetSigAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmExportedFunctionData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("function_index", "v8::internal::TaggedMember<v8::internal::Object>", GetFunctionIndexAddress(), 1, 4,
        std::move(function_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> wrapper_budget_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("wrapper_budget", "v8::internal::TaggedMember<v8::internal::Cell>", GetWrapperBudgetAddress(), 1, 4,
        std::move(wrapper_budget_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> canonical_type_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("canonical_type_index", "v8::internal::TaggedMember<v8::internal::Object>",
        GetCanonicalTypeIndexAddress(), 1, 4, std::move(canonical_type_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> packed_args_size_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("packed_args_size", "v8::internal::TaggedMember<v8::internal::Object>", GetPackedArgsSizeAddress(), 1, 4,
        std::move(packed_args_size_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> c_wrapper_code_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("c_wrapper_code",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetCWrapperCodeAddress(), 1, 4, std::move(c_wrapper_code_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> sig_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("sig",
        CheckTypeName<const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "const wasm::CanonicalSig*"),
...
uintptr_t TqWasmJSFunctionData::GetCanonicalSigIndexAddress() const
{
    return address_ - i::kHeapObjectTag + 20;
}

Value<uintptr_t> TqWasmJSFunctionData::GetCanonicalSigIndexValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetCanonicalSigIndexAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
}

uintptr_t TqWasmJSFunctionData::GetProtectedOffheapDataAddress() const
{
    return address_ - i::kHeapObjectTag + 24;
}

Value<uintptr_t> TqWasmJSFunctionData::GetProtectedOffheapDataValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetProtectedOffheapDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
}
...
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqWasmFunctionData::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> canonical_sig_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("canonical_sig_index", "v8::internal::TaggedMember<v8::internal::Object>", GetCanonicalSigIndexAddress(),
        1, 4, std::move(canonical_sig_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> protected_offheap_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("protected_offheap_data", "v8::internal::TaggedMember<v8::internal::Object>",
        GetProtectedOffheapDataAddress(), 1, 4, std::move(protected_offheap_data_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
uintptr_t TqWasmCapiFunctionData::GetCanonicalSigIndexAddress() const
{
    return address_ - i::kHeapObjectTag + 20;
}

Value<uintptr_t> TqWasmCapiFunctionData::GetCanonicalSigIndexValue(d::MemoryAccessor accessor) const
{
    i::Tagged_t value {};
    d::MemoryAccessResult validity = accessor(GetCanonicalSigIndexAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, EnsureDecompressed(value, address_) };
...
uintptr_t TqWasmCapiFunctionData::GetSigAddress() const
{
    return address_ - i::kHeapObjectTag + 28;
}

Value<const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmCapiFunctionData::GetSigValue(d::MemoryAccessor accessor) const
{
    const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetSigAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmCapiFunctionData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("embedder_data", "v8::internal::TaggedMember<v8::internal::Foreign>", GetEmbedderDataAddress(), 1, 4,
        std::move(embedder_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> sig_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("sig",
        CheckTypeName<const wasm::CanonicalSig* /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>(
            "const wasm::CanonicalSig*"),
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmResumeData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("suspender", "v8::internal::TaggedMember<v8::internal::WasmSuspenderObject>", GetSuspenderAddress(), 1, 4,
        std::move(suspender_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> on_resume_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("on_resume", "v8::internal::TaggedMember<v8::internal::Object>", GetOnResumeAddress(), 1, 4,
        std::move(on_resume_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmContinuationObject::GetStackValue(d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetStackAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmContinuationObject::GetJmpbufValue(d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmContinuationObject::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> parent_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parent", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetParentAddress(), 1, 4,
        std::move(parent_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> stack_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("stack",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetStackAddress(), 1, 4, std::move(stack_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> jmpbuf_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("jmpbuf",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetJmpbufAddress(), 1, 4, std::move(jmpbuf_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmSuspenderObject::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqHeapObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> continuation_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("continuation", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetContinuationAddress(), 1, 4,
        std::move(continuation_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> parent_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("parent", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetParentAddress(), 1, 4,
        std::move(parent_struct_field_list), d::PropertyKind::kSingle));
    ...
    result.push_back(std::make_unique<ObjectProperty>("resume", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetResumeAddress(), 1, 4,
        std::move(resume_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> reject_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("reject", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetRejectAddress(), 1, 4,
        std::move(reject_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> state_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "state", "v8::internal::TaggedMember<v8::internal::Object>", GetStateAddress(), 1, 4, std::move(state_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmModuleObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("managed_native_module", "v8::internal::TaggedMember<v8::internal::Foreign>",
        GetManagedNativeModuleAddress(), 1, 4, std::move(managed_native_module_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> script_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "script", "v8::internal::TaggedMember<v8::internal::Script>", GetScriptAddress(), 1, 4, std::move(script_struct_field_list), d::PropertyKind::kSingle));
    return result;
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmTableObject::GetTrustedDataValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetTrustedDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
Value<wasm::AddressType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmTableObject::GetAddressTypeValue(d::MemoryAccessor accessor) const
{
...
Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmTableObject::GetPaddingForAddressType0Value(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmTableObject::GetPaddingForAddressType1Value(d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTableObject::GetProperties(d::MemoryAccessor accessor) const
{
    std::vector<std::unique_ptr<ObjectProperty>> result = TqJSObject::GetProperties(accessor);
    std::vector<std::unique_ptr<StructProperty>> entries_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("entries", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetEntriesAddress(), 1, 4,
        std::move(entries_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> current_length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("current_length", "v8::internal::TaggedMember<v8::internal::Object>", GetCurrentLengthAddress(), 1, 4,
        std::move(current_length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> maximum_length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("maximum_length", "v8::internal::TaggedMember<v8::internal::Object>", GetMaximumLengthAddress(), 1, 4,
        std::move(maximum_length_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> uses_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "uses", "v8::internal::TaggedMember<v8::internal::FixedArray>", GetUsesAddress(), 1, 4, std::move(uses_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_type_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("raw_type", "v8::internal::TaggedMember<v8::internal::Object>", GetRawTypeAddress(), 1, 4,
        std::move(raw_type_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> trusted_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("trusted_data",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetTrustedDataAddress(), 1, 4, std::move(trusted_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> address_type_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("address_type",
        CheckTypeName<wasm::AddressType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("wasm::AddressType"),
        GetAddressTypeAddress(), 1, 1, std::move(address_type_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> padding_for_address_type_0_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("padding_for_address_type_0",
        CheckTypeName<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint8_t"),
        GetPaddingForAddressType0Address(), 1, 1, std::move(padding_for_address_type_0_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> padding_for_address_type_1_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("padding_for_address_type_1",
        CheckTypeName<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint16_t"),
        GetPaddingForAddressType1Address(), 1, 2, std::move(padding_for_address_type_1_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<wasm::AddressType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmMemoryObject::GetAddressTypeValue(d::MemoryAccessor accessor) const
{
    wasm::AddressType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetAddressTypeAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
uintptr_t TqWasmMemoryObject::GetPaddingForAddressType0Address() const
{
    return address_ - i::kHeapObjectTag + 25;
}

Value<uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmMemoryObject::GetPaddingForAddressType0Value(d::MemoryAccessor accessor) const
{
    uint8_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetPaddingForAddressType0Address(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
uintptr_t TqWasmMemoryObject::GetPaddingForAddressType1Address() const
{
    return address_ - i::kHeapObjectTag + 26;
}

Value<uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmMemoryObject::GetPaddingForAddressType1Value(d::MemoryAccessor accessor) const
{
    uint16_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetPaddingForAddressType1Address(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmMemoryObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("array_buffer", "v8::internal::TaggedMember<v8::internal::JSArrayBuffer>", GetArrayBufferAddress(), 1, 4,
        std::move(array_buffer_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> maximum_pages_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("maximum_pages", "v8::internal::TaggedMember<v8::internal::Object>", GetMaximumPagesAddress(), 1, 4,
        std::move(maximum_pages_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> instances_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("instances", "v8::internal::TaggedMember<v8::internal::WeakArrayList>", GetInstancesAddress(), 1, 4,
        std::move(instances_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> address_type_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("address_type",
        CheckTypeName<wasm::AddressType /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("wasm::AddressType"),
        GetAddressTypeAddress(), 1, 1, std::move(address_type_struct_field_list), d::PropertyKind::kSingle));
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>
TqWasmGlobalObject::GetTrustedDataValue(d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetTrustedDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmGlobalObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("untagged_buffer", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetUntaggedBufferAddress(), 1,
        4, std::move(untagged_buffer_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> tagged_buffer_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("tagged_buffer", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetTaggedBufferAddress(), 1, 4,
        std::move(tagged_buffer_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> offset_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "offset", "v8::internal::TaggedMember<v8::internal::Object>", GetOffsetAddress(), 1, 4, std::move(offset_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> raw_type_struct_field_list;
    ...
    result.push_back(std::make_unique<ObjectProperty>("is_mutable", "v8::internal::TaggedMember<v8::internal::Object>", GetIsMutableAddress(), 1, 4,
        std::move(is_mutable_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmTagObject::GetTrustedDataValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetTrustedDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTagObject::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("serialized_signature", "v8::internal::TaggedMember<v8::internal::ByteArray>",
        GetSerializedSignatureAddress(), 1, 4, std::move(serialized_signature_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> tag_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>(
        "tag", "v8::internal::TaggedMember<v8::internal::HeapObject>", GetTagAddress(), 1, 4, std::move(tag_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> canonical_type_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("canonical_type_index", "v8::internal::TaggedMember<v8::internal::Object>",
        GetCanonicalTypeIndexAddress(), 1, 4, std::move(canonical_type_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> trusted_data_struct_field_list;
...
std::vector<std::unique_ptr<ObjectProperty>> TqAsmWasmData::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("uses_bitset", "v8::internal::TaggedMember<v8::internal::HeapNumber>", GetUsesBitsetAddress(), 1, 4,
        std::move(uses_bitset_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmTypeInfo::GetNativeTypeValue(
    d::MemoryAccessor accessor) const
{
    ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
...
uintptr_t TqWasmTypeInfo::GetModuleTypeIndexAddress() const
{
    return address_ - i::kHeapObjectTag + 8;
}

Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmTypeInfo::GetModuleTypeIndexValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetModuleTypeIndexAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
    return { validity, value };
}

uintptr_t TqWasmTypeInfo::GetTrustedDataAddress() const
{
    return address_ - i::kHeapObjectTag + 12;
}

Value<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmTypeInfo::GetTrustedDataValue(
    d::MemoryAccessor accessor) const
{
    TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetTrustedDataAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmTypeInfo::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("native_type",
        CheckTypeName<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("ExternalPointer_t"),
        GetNativeTypeAddress(), 1, 4, std::move(native_type_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> module_type_index_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("module_type_index",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetModuleTypeIndexAddress(), 1, 4, std::move(module_type_index_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> trusted_data_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("trusted_data",
        CheckTypeName<TrustedPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("TrustedPointer_t"),
        GetTrustedDataAddress(), 1, 4, std::move(trusted_data_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> supertypes_length_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("supertypes_length", "v8::internal::TaggedMember<v8::internal::Object>", GetSupertypesLengthAddress(), 1,
        4, std::move(supertypes_length_struct_field_list), d::PropertyKind::kSingle));
    ...
    if (indexed_field_slice_supertypes.validity == d::MemoryAccessResult::kOk) {
        result.push_back(std::make_unique<ObjectProperty>("supertypes", "v8::internal::TaggedMember<v8::internal::Object>",
            address_ - i::kHeapObjectTag + std::get<1>(indexed_field_slice_supertypes.value), std::get<2>(indexed_field_slice_supertypes.value), 4,
            std::move(supertypes_struct_field_list), GetArrayKind(indexed_field_slice_supertypes.validity)));
    }
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmArray::GetLengthValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetLengthAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmArray::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>("length",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetLengthAddress(), 1, 4, std::move(length_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
...
Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> TqWasmStringViewIter::GetOffsetValue(
    d::MemoryAccessor accessor) const
{
    uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/ value {};
    d::MemoryAccessResult validity = accessor(GetOffsetAddress(), reinterpret_cast<uint8_t*>(&value), sizeof(value));
...
std::vector<std::unique_ptr<ObjectProperty>> TqWasmStringViewIter::GetProperties(d::MemoryAccessor accessor) const
{
    ...
    result.push_back(std::make_unique<ObjectProperty>(
        "string", "v8::internal::TaggedMember<v8::internal::String>", GetStringAddress(), 1, 4, std::move(string_struct_field_list), d::PropertyKind::kSingle));
    std::vector<std::unique_ptr<StructProperty>> offset_struct_field_list;
    result.push_back(std::make_unique<ObjectProperty>("offset",
        CheckTypeName<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/>("uint32_t"),
        GetOffsetAddress(), 1, 4, std::move(offset_struct_field_list), d::PropertyKind::kSingle));
    return result;
}
