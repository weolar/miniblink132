...
#define DEFINE_TORQUE_GENERATED_DISPOSABLE_STACK_STATUS()                                                                                                      \
    ...
    using LengthBits = base::BitField<int32_t, 3, 28, uint32_t>;
...
#define DEFINE_TORQUE_GENERATED_JS_TEMPORAL_CALENDAR_FLAGS() using CalendarIndexBits = base::BitField<int32_t, 0, 5, uint32_t>;
...
#define DEFINE_TORQUE_GENERATED_JS_TEMPORAL_TIME_ZONE_SUB_MILLISECONDS() using OffsetSubMillisecondsBits = base::BitField<int32_t, 0, 21, uint32_t>;
...
#define DEFINE_TORQUE_GENERATED_JS_SEGMENT_ITERATOR_FLAGS() using GranularityBits = base::BitField<JSSegmenter::Granularity, 0, 2, uint32_t>;

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-segmenter.tq?l=9&c=1
#define DEFINE_TORQUE_GENERATED_JS_SEGMENTER_FLAGS() using GranularityBits = base::BitField<JSSegmenter::Granularity, 0, 2, uint32_t>;

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-segments.tq?l=7&c=1
#define DEFINE_TORQUE_GENERATED_JS_SEGMENTS_FLAGS() using GranularityBits = base::BitField<JSSegmenter::Granularity, 0, 2, uint32_t>;
