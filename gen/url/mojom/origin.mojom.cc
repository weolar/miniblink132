...
Origin::Origin(const std::string& scheme_in, const std::string& host_in, uint16_t port_in, const std::optional<::base::UnguessableToken>& nonce_if_opaque_in)
...
// static
bool StructTraits<::url::mojom::Origin::DataView, ::url::mojom::OriginPtr>::Read(::url::mojom::Origin::DataView input, ::url::mojom::OriginPtr* output)
{
    bool success = true;
