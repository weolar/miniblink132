...
public:
    ...
    void BeginVisitRenderNode(RenderNode* v) override
    {
        NOTREACHED();
    }
...
ForwardRenderSimulator::ForwardRenderSimulator(std::unique_ptr<RenderNode> root, int window_width, int window_height)
