...
class GrContextForWebGPUInterface : public GrContextOptions::ShaderErrorHandler {
public:
    GrContextForWebGPUInterface(gpu::webgpu::WebGPUInterface* webgpu, gpu::ContextSupport* context_support, const gpu::Capabilities& capabilities,
        size_t max_resource_cache_bytes, size_t max_glyph_cache_texture_bytes);

    GrContextForWebGPUInterface(const GrContextForWebGPUInterface&) = delete;
    GrContextForWebGPUInterface& operator=(const GrContextForWebGPUInterface&) = delete;
