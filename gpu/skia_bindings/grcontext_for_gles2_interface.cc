...
GrContextForGLES2Interface::GrContextForGLES2Interface(gpu::gles2::GLES2Interface* gl, gpu::ContextSupport* context_support,
    const gpu::Capabilities& capabilities, size_t max_resource_cache_bytes, size_t max_glyph_cache_texture_bytes, bool support_bilerp_from_flyph_atlas)
...
void GrContextForGLES2Interface::compileError(const char* shader, const char* errors)
{
