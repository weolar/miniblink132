...
protected:
    ...
    {
        constexpr const char kVertexShader[] = "void main() { gl_Position = vec4(0.0, 0.0, 0.0, 1.0); }";
...
TEST_F(GLUnallocatedTextureTest, RenderUnallocatedTextureExternal)
{
    ...
    constexpr const char kFragmentShader[] = "#extension GL_OES_EGL_image_external : enable\n"
...
TEST_F(GLUnallocatedTextureTest, RenderUnallocatedTextureRectange)
{
    ...
    constexpr const char kFragmentShader[] = "#extension GL_ARB_texture_rectangle : enable\n"
