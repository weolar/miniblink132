...
{
#if BUILDFLAG(IS_MAC)
    EXPECT_TRUE(GLTestHelper::HasExtension("GL_EXT_occlusion_query_boolean")) << "GL_EXT_occlusion_query_boolean is required on OSX";
#endif
    ...
    static const char* v_shader_str = "uniform mat4 worldMatrix;\n"
