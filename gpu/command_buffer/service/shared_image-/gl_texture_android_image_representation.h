...
// Android.
class GLTextureAndroidImageRepresentation : public GLTextureImageRepresentation {
public:
    GLTextureAndroidImageRepresentation(SharedImageManager* manager, AndroidImageBacking* backing, MemoryTypeTracker* tracker, gles2::Texture* texture);
    ~GLTextureAndroidImageRepresentation() override;

    GLTextureAndroidImageRepresentation(const GLTextureAndroidImageRepresentation&) = delete;
    GLTextureAndroidImageRepresentation& operator=(const GLTextureAndroidImageRepresentation&) = delete;
