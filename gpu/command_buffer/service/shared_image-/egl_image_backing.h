...
public:
    EGLImageBacking(const Mailbox& mailbox, viz::SharedImageFormat format, const gfx::Size& size, const gfx::ColorSpace& color_space,
        ...
        const GLCommonImageBackingFactory::FormatInfo& format_into, const GpuDriverBugWorkarounds& workarounds, bool use_passthrough,
...
private:
    ...
    // is created from it.
    scoped_refptr<TextureHolder> GenEGLImageSibling(base::span<const uint8_t> pixel_data);
    ...
    base::flat_set<const GLRepresentationShared*> active_readers_ GUARDED_BY(lock_);
