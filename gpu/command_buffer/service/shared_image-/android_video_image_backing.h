...
public:
    ...
    static absl::optional<VulkanYCbCrInfo> GetYcbcrInfo(TextureOwner* texture_owner, viz::VulkanContextProvider* vulkan_context_provider);
...
protected:
    AndroidVideoImageBacking(const Mailbox& mailbox, const gfx::Size& size, const gfx::ColorSpace color_space, GrSurfaceOrigin surface_origin,
        SkAlphaType alpha_type, bool is_thread_safe);

    std::unique_ptr<gles2::AbstractTexture> GenAbstractTexture(const bool passthrough);
};
