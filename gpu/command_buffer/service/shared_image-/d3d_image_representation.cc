...
GLTexturePassthroughD3DImageRepresentation::GLTexturePassthroughD3DImageRepresentation(
...
bool GLTexturePassthroughD3DImageRepresentation::BeginAccess(GLenum mode)
{
    ...
    auto texture = GLTexturePassthroughImageRepresentation::GetTexturePassthrough();
...
DawnD3DImageRepresentation::DawnD3DImageRepresentation(SharedImageManager* manager, SharedImageBacking* backing, MemoryTypeTracker* tracker, WGPUDevice device,
...
WGPUTexture DawnD3DImageRepresentation::BeginAccess(WGPUTextureUsage usage)
{
    ...
    descriptor.isSwapChainTexture = (d3d_image_backing->usage() & SHARED_IMAGE_USAGE_WEBGPU_SWAP_CHAIN_TEXTURE);
