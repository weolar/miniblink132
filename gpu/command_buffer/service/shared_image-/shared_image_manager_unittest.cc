...
TEST(SharedImageManagerTest, MemoryDumps)
{
    ...
    base::trace_event::MemoryDumpArgs args = { base::trace_event::MemoryDumpLevelOfDetail::BACKGROUND };
    ...
    DCHECK_EQ(entry.entry_type, base::trace_event::MemoryAllocatorDump::Entry::kUint64);
