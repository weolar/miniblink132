...
public:
    ...
    std::unique_ptr<DawnImageRepresentation> ProduceDawn(const Mailbox& mailbox, MemoryTypeTracker* ref, WGPUDevice device, WGPUBackendType backend_type);
    std::unique_ptr<OverlayImageRepresentation> ProduceOverlay(const Mailbox& mailbox, MemoryTypeTracker* ref);
    std::unique_ptr<VaapiImageRepresentation> ProduceVASurface(const Mailbox& mailbox, MemoryTypeTracker* ref, VaapiDependenciesFactory* dep_factory);
