...
public:
    DawnAHardwareBufferImageRepresentation(SharedImageManager* manager, AndroidImageBacking* backing, MemoryTypeTracker* tracker, WGPUDevice device,
        WGPUTextureFormat format, AHardwareBuffer* buffer, scoped_refptr<base::RefCountedData<DawnProcTable>> dawn_procs);
