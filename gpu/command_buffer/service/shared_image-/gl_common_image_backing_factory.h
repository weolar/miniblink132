...
protected:
    GLCommonImageBackingFactory(const GpuPreferences& gpu_preferences, const GpuDriverBugWorkarounds& workarounds, const gles2::FeatureInfo* feature_info,
    ...
    bool CanCreateSharedImage(const gfx::Size& size, base::span<const uint8_t> pixel_data, const FormatInfo& format_info, GLenum target);
