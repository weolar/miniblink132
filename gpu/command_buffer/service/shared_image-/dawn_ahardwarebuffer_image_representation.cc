...
DawnAHardwareBufferImageRepresentation::DawnAHardwareBufferImageRepresentation(SharedImageManager* manager, AndroidImageBacking* backing,
    MemoryTypeTracker* tracker, WGPUDevice device, WGPUTextureFormat format, AHardwareBuffer* buffer,
...
WGPUTexture DawnAHardwareBufferImageRepresentation::BeginAccess(WGPUTextureUsage usage)
{
