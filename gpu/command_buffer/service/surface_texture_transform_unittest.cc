...
protected:
    ...
    void DoTest(float matrix[16], gfx::Size rotated_visible_size, gfx::Size expected_coded_size, bool rotated)
    {
        gfx::Size coded_size;
        gfx::Rect visible_rect;
        ASSERT_TRUE(SurfaceTextureGLOwner::DecomposeTransform(matrix, rotated_visible_size, &coded_size, &visible_rect));

        EXPECT_EQ(coded_size, expected_coded_size);
        EXPECT_EQ(visible_rect.origin(), gfx::Point(0, 0));
        EXPECT_EQ(visible_rect.size(), GetRotatedSize(rotated_visible_size, rotated));
    }
};

TEST_F(SurfaceTextureTransformTest, Rotation0)
{
    float matrix[16] = { 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, -0.990809, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000,
        0.991728, 0.000000, 1.000000 };
...
{
    float matrix[16] = { 0.000000, -0.990809, 0.000000, 0.000000, -1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 1.000000,
        0.991728, 0.000000, 1.000000 };
    gfx::Size coded_size(1920, 1088); // Has padding
...
{
    float matrix[16] = { -1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.990809, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 1.000000,
        0.000919, 0.000000, 1.000000 };
    gfx::Size coded_size(1920, 1088); // Has padding
    gfx::Size rotated_visible_size(1920, 1080);
...
{
    float matrix[16] = { 0.000000, 0.990809, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000,
        0.000919, 0.000000, 1.000000 };
    gfx::Size coded_size(1920, 1088); // Has padding
    gfx::Size rotated_visible_size(1080, 1920);
...
{
    float matrix[16] = { 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,
...
{
    float matrix[16] = { 0.986111, 0.000000, 0.000000, 0.000000, 0.000000, -1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000,
...
{
    float matrix[16] = { 0.986111, 0.000000, 0.000000, 0.000000, 0.000000, -1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.001157,
        1.000000, 0.000000, 1.000000 };
    gfx::Size coded_size(432, 240);
