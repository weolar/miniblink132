...
class RASTER_EXPORT GrShaderCache : public GrContextOptions::PersistentCache, public base::trace_event::MemoryDumpProvider {
public:
    ...
    public:
        ...
        virtual void StoreShader(const std::string& key, const std::string& shader) = 0;
    };
...
private:
    ...
    template <typename Iterator> void EraseFromCache(Iterator it);
    ...
    base::flat_map<base::PlatformThreadId, int32_t> current_client_id_ GUARDED_BY(lock_);
