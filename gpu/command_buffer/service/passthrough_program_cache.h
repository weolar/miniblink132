...
public:
    ...
    PassthroughProgramCache(size_t max_cache_size_bytes, bool disable_gpu_shader_disk_cache, ValueAddedHook* value_added_hook = nullptr);
    ...
    static void BlobCacheSet(const void* key, EGLsizeiANDROID key_size, const void* value, EGLsizeiANDROID value_size);

    static EGLsizeiANDROID BlobCacheGet(const void* key, EGLsizeiANDROID key_size, void* value, EGLsizeiANDROID value_size);
...
private:
    ...
    public:
        ProgramCacheValue(Value&& program_blob, PassthroughProgramCache* program_cache);
    ...
    EGLsizeiANDROID BlobCacheGetImpl(const void* key, EGLsizeiANDROID key_size, void* value, EGLsizeiANDROID value_size);
    void BlobCacheSetImpl(const void* key, EGLsizeiANDROID key_size, const void* value, EGLsizeiANDROID value_size);
