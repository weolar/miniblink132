...
class GPU_GLES2_EXPORT DXGISharedHandleState : public base::subtle::RefCountedThreadSafeBase {
public:
    REQUIRE_ADOPTION_FOR_REFCOUNTED_TYPE();

    DXGISharedHandleState(base::PassKey<DXGISharedHandleManager>, scoped_refptr<DXGISharedHandleManager> manager, gfx::DXGIHandleToken token,
    ...
    Microsoft::WRL::ComPtr<ID3D11Texture2D> GetOrCreateD3D11Texture(Microsoft::WRL::ComPtr<ID3D11Device> d3d11_device);
    ...
    void MaybeCacheSharedTextureMemory(const wgpu::Device& device, wgpu::SharedTextureMemory memory);
...
private:
    ...
    using D3D11TextureStateMap = base::flat_map<Microsoft::WRL::ComPtr<ID3D11Device>, D3D11TextureState>;
    ...
    using DawnSharedTextureMemoryCache = base::flat_map<WGPUDevice, wgpu::SharedTextureMemory>;
    DawnSharedTextureMemoryCache dawn_shared_texture_memory_cache_ GUARDED_BY(lock_);
...
class GPU_GLES2_EXPORT DXGISharedHandleManager : public base::RefCountedThreadSafe<DXGISharedHandleManager> {
public:
...
private:
    ...
    using SharedHandleMap = base::flat_map<gfx::DXGIHandleToken, DXGISharedHandleState*>;
