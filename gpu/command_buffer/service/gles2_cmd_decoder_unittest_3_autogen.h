...
{
    cmds::VertexAttrib1fvImmediate& cmd = *GetImmediateAs<cmds::VertexAttrib1fvImmediate>();
...
{
    cmds::VertexAttrib2fvImmediate& cmd = *GetImmediateAs<cmds::VertexAttrib2fvImmediate>();
...
{
    cmds::VertexAttrib3fvImmediate& cmd = *GetImmediateAs<cmds::VertexAttrib3fvImmediate>();
...
{
    cmds::VertexAttrib4fvImmediate& cmd = *GetImmediateAs<cmds::VertexAttrib4fvImmediate>();
...
{
    cmds::VertexAttribI4ivImmediate& cmd = *GetImmediateAs<cmds::VertexAttribI4ivImmediate>();
...
{
    cmds::VertexAttribI4uivImmediate& cmd = *GetImmediateAs<cmds::VertexAttribI4uivImmediate>();
