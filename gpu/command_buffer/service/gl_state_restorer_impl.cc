...
GLStateRestorerImpl::GLStateRestorerImpl(base::WeakPtr<GLContextVirtualDelegate> delegate)
    : delegate_(delegate)
{
}
...
void GLStateRestorerImpl::RestoreState(const gl::GLStateRestorer* prev_state)
{
    ...
    delegate_->RestoreState(restorer_impl ? restorer_impl->GetContextState() : nullptr);
}
