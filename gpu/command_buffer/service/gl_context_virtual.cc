...
GLContextVirtual::GLContextVirtual(gl::GLShareGroup* share_group, gl::GLContext* shared_context, base::WeakPtr<GLContextVirtualDelegate> delegate)
...
bool GLContextVirtual::InitializeImpl(gl::GLSurface* compatible_surface, const gl::GLContextAttribs& attribs)
{
...
void GLContextVirtual::AddMetalSharedEventsForBackpressure(std::vector<std::unique_ptr<BackpressureMetalSharedEvent>> events)
{
