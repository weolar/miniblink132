...
protected:
    void CheckReadPixelsOutOfRange(GLint in_read_x, GLint in_read_y, GLsizei in_read_width, GLsizei in_read_height, bool init);
};
...
public:
    ...
    void DirtyStateMaskTest(GLuint color_bits, bool depth_mask, GLuint front_stencil_mask, GLuint back_stencil_mask);
...
class GLES2WebGLDecoderPassthroughTest : public GLES2DecoderPassthroughTestBase {
public:
