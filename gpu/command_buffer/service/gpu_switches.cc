...
const char kForceGpuMemDiscardableLimitMb[] = "force-gpu-mem-discardable-limit-mb";
...
// everywhere.
const char kEnableThreadedTextureMailboxes[] = "enable-threaded-texture-mailboxes";
