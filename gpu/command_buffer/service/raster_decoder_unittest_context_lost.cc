...
protected:
    ...
    void OOM(GLenum reset_status, error::ContextLostReason expected_other_reason)
    {
        ...
        EXPECT_EQ(GL_OUT_OF_MEMORY, static_cast<GLint>(*GetSharedMemoryAs<GLenum*>()));
    }
};
...
INSTANTIATE_TEST_SUITE_P(Service, RasterDecoderLostContextTest, ::testing::Bool());
