...
public:
    MockTextureOwner(GLuint fake_texture_id, gl::GLContext* fake_context, gl::GLSurface* fake_surface, bool binds_texture_on_update = false);
    ...
    MOCK_METHOD3(GetCodedSizeAndVisibleRect, bool(gfx::Size rotated_visible_size, gfx::Size* coded_size, gfx::Rect* visible_rect));
    MOCK_METHOD1(RunWhenBufferIsAvailable, void(base::OnceClosure));

    MOCK_METHOD2(OnMemoryDump, bool(const base::trace_event::MemoryDumpArgs& args, base::trace_event::ProcessMemoryDump* pmd));
