...
Validators::Validators()
    : mailbox_flags(valid_mailbox_flags_table, std::size(valid_mailbox_flags_table))
    , power_preference(valid_power_preference_table, std::size(valid_power_preference_table))
{
}
