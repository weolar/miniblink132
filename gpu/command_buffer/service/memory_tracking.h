...
public:
    ...
    public:
        ...
        virtual void OnMemoryAllocatedChange(CommandBufferId id, uint64_t old_size, uint64_t new_size, GpuPeakMemoryAllocationSource source) = 0;
    };
...
public:
    ...
    // For testing.
    MemoryTypeTracker(MemoryTracker* memory_tracker, scoped_refptr<base::SequencedTaskRunner> task_runner);
    ...
    const MemoryTracker* memory_tracker() const
    {
