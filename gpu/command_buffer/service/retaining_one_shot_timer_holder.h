...
class GPU_EXPORT RetainingOneShotTimerHolder : public base::RefCountedThreadSafe<RetainingOneShotTimerHolder> {
public:
    ...
    RetainingOneShotTimerHolder(const RetainingOneShotTimerHolder& other) = delete;
    RetainingOneShotTimerHolder& operator=(const RetainingOneShotTimerHolder& other) = delete;
