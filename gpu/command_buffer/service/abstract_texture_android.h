...
public:
    static std::unique_ptr<AbstractTextureAndroid> CreateForValidating(gfx::Size size);
    static std::unique_ptr<AbstractTextureAndroid> CreateForPassthrough(gfx::Size size);
    static std::unique_ptr<AbstractTextureAndroid> CreateForTesting(GLuint texture_id);

    explicit AbstractTextureAndroid(std::unique_ptr<TextureBase> texture);
    explicit AbstractTextureAndroid(gles2::Texture* texture);
    explicit AbstractTextureAndroid(scoped_refptr<gles2::TexturePassthrough> texture, const gfx::Size& size);
    ...
    {
        return GetTextureBase()->service_id();
    }
