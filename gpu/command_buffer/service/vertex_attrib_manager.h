...
public:
    ...
    bool enabled_in_driver() const
    {
        return enabled_in_driver_;
    }

    // Find the maximum vertex accessed, accounting for instancing.
    GLuint MaxVertexAccessed(GLsizei primcount, GLuint max_vertex_accessed) const
    {
    ...
    GLuint MaxVertexAccessed(GLsizei primcount, GLuint max_vertex_accessed, GLint basevertex, GLuint baseinstance) const
    {
        return divisor_ ? ((primcount - 1) / divisor_) + baseinstance : max_vertex_accessed + basevertex;
    }
...
private:
    ...
    void SetInfo(Buffer* buffer, GLint size, GLenum type, GLboolean normalized, GLsizei gl_stride, GLsizei real_stride, GLsizei offset, GLboolean integer);
...
class GPU_GLES2_EXPORT VertexAttribManager : public base::RefCounted<VertexAttribManager> {
public:
    typedef std::list<raw_ptr<VertexAttrib, CtnExperimental>> VertexAttribList;
    ...
    void SetAttribInfo(
        GLuint index, Buffer* buffer, GLint size, GLenum type, GLboolean normalized, GLsizei gl_stride, GLsizei real_stride, GLsizei offset, GLboolean integer)
    {
        ...
        if (attrib) {
            ...
            attrib->SetInfo(buffer, size, type, normalized, gl_stride, real_stride, offset, integer);
    ...
    bool ValidateBindings(const char* function_name, GLES2Decoder* decoder, FeatureInfo* feature_info, BufferManager* buffer_manager, Program* current_program,
        GLuint max_vertex_accessed, bool instanced, GLsizei primcount, GLint basevertex, GLuint baseinstance);
...
private:
    ...
    VertexAttribManager(VertexArrayManager* manager, GLuint service_id, uint32_t num_vertex_attribs, bool do_buffer_refcounting);
