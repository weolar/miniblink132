...
public:
    TransformFeedback(TransformFeedbackManager* manager, GLuint client_id, GLuint service_id);
    ...
    void DoBindTransformFeedback(GLenum target, TransformFeedback* last_bound_transform_feedback, Buffer* bound_transform_feedback_buffer);
    ...
    bool GetVerticesNeededForDraw(GLenum mode, GLsizei count, GLsizei primcount, GLsizei pending_vertices_drawn, GLsizei* vertices_out) const;
...
public:
    ...
    TransformFeedbackManager(GLuint max_transform_feedback_separate_attribs, bool needs_emulation);
...
private:
    ...
    std::unordered_map<GLuint, scoped_refptr<TransformFeedback>> transform_feedbacks_;
