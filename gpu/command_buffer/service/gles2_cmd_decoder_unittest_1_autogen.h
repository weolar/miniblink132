...
TEST_P(GLES2DecoderTest1, BindBufferValidArgsNewId)
{
    ...
    EXPECT_CALL(*gl_, GenBuffersARB(1, _)).WillOnce(SetArgPointee<1>(kNewServiceId));
    SpecializedSetup<cmds::BindBuffer, 0>(true);
    cmds::BindBuffer cmd;
...
TEST_P(GLES2DecoderTest1, BindFramebufferValidArgsNewId)
{
    ...
    EXPECT_CALL(*gl_, GenFramebuffersEXT(1, _)).WillOnce(SetArgPointee<1>(kNewServiceId));
    SpecializedSetup<cmds::BindFramebuffer, 0>(true);
    cmds::BindFramebuffer cmd;
...
{
    EXPECT_CALL(*gl_, BindRenderbufferEXT(GL_RENDERBUFFER, kServiceRenderbufferId));
...
TEST_P(GLES2DecoderTest1, BindRenderbufferValidArgsNewId)
{
    ...
    EXPECT_CALL(*gl_, GenRenderbuffersEXT(1, _)).WillOnce(SetArgPointee<1>(kNewServiceId));
    SpecializedSetup<cmds::BindRenderbuffer, 0>(true);
    cmds::BindRenderbuffer cmd;
...
{
    EXPECT_CALL(*gl_, CreateShader(GL_VERTEX_SHADER)).WillOnce(Return(kNewServiceId));
...
TEST_P(GLES2DecoderTest1, DeleteBuffersImmediateValidArgs)
{
    ...
    cmds::DeleteBuffersImmediate& cmd = *GetImmediateAs<cmds::DeleteBuffersImmediate>();
    SpecializedSetup<cmds::DeleteBuffersImmediate, 0>(true);
    cmd.Init(1, &client_buffer_id_);
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(client_buffer_id_)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
...
{
    EXPECT_CALL(*gl_, DeleteFramebuffersEXT(1, Pointee(kServiceFramebufferId))).Times(1);
    cmds::DeleteFramebuffersImmediate& cmd = *GetImmediateAs<cmds::DeleteFramebuffersImmediate>();
    SpecializedSetup<cmds::DeleteFramebuffersImmediate, 0>(true);
    cmd.Init(1, &client_framebuffer_id_);
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(client_framebuffer_id_)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
...
{
    EXPECT_CALL(*gl_, DeleteRenderbuffersEXT(1, Pointee(kServiceRenderbufferId))).Times(1);
    cmds::DeleteRenderbuffersImmediate& cmd = *GetImmediateAs<cmds::DeleteRenderbuffersImmediate>();
    SpecializedSetup<cmds::DeleteRenderbuffersImmediate, 0>(true);
    cmd.Init(1, &client_renderbuffer_id_);
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(client_renderbuffer_id_)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
...
TEST_P(GLES3DecoderTest1, DeleteSamplersImmediateValidArgs)
{
    ...
    cmds::DeleteSamplersImmediate& cmd = *GetImmediateAs<cmds::DeleteSamplersImmediate>();
    SpecializedSetup<cmds::DeleteSamplersImmediate, 0>(true);
    cmd.Init(1, &client_sampler_id_);
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(client_sampler_id_)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
...
TEST_P(GLES2DecoderTest1, DeleteTexturesImmediateValidArgs)
{
    ...
    cmds::DeleteTexturesImmediate& cmd = *GetImmediateAs<cmds::DeleteTexturesImmediate>();
    SpecializedSetup<cmds::DeleteTexturesImmediate, 0>(true);
    cmd.Init(1, &client_texture_id_);
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(client_texture_id_)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
...
TEST_P(GLES3DecoderTest1, FenceSyncValidArgs)
{
    ...
    EXPECT_CALL(*gl_, FenceSync(GL_SYNC_GPU_COMMANDS_COMPLETE, 0)).WillOnce(Return(kNewServiceIdGLuint));
...
{
    EXPECT_CALL(*gl_, FramebufferRenderbufferEXT(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_RENDERBUFFER, kServiceRenderbufferId));
...
TEST_P(GLES2DecoderTest1, FramebufferRenderbufferInvalidArgs0_0)
{
    ...
    cmds::FramebufferRenderbuffer cmd;
    cmd.Init(GL_RENDERBUFFER, GL_COLOR_ATTACHMENT0, GL_RENDERBUFFER, client_renderbuffer_id_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, FramebufferRenderbufferInvalidArgs2_0)
{
    ...
    SpecializedSetup<cmds::FramebufferRenderbuffer, 0>(false);
    cmds::FramebufferRenderbuffer cmd;
    cmd.Init(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_FRAMEBUFFER, client_renderbuffer_id_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, GenBuffersImmediateInvalidArgs)
{
    ...
    cmd->Init(1, &client_buffer_id_);
    EXPECT_EQ(error::kInvalidArguments, ExecuteImmediateCmd(*cmd, sizeof(&client_buffer_id_)));
}
...
{
    EXPECT_CALL(*gl_, GenFramebuffersEXT(1, _)).WillOnce(SetArgPointee<1>(kNewServiceId));
    cmds::GenFramebuffersImmediate* cmd = GetImmediateAs<cmds::GenFramebuffersImmediate>();
    GLuint temp = kNewClientId;
...
TEST_P(GLES2DecoderTest1, GenFramebuffersImmediateInvalidArgs)
{
    ...
    cmd->Init(1, &client_framebuffer_id_);
    EXPECT_EQ(error::kInvalidArguments, ExecuteImmediateCmd(*cmd, sizeof(&client_framebuffer_id_)));
}

TEST_P(GLES2DecoderTest1, GenRenderbuffersImmediateValidArgs)
{
    EXPECT_CALL(*gl_, GenRenderbuffersEXT(1, _)).WillOnce(SetArgPointee<1>(kNewServiceId));
    cmds::GenRenderbuffersImmediate* cmd = GetImmediateAs<cmds::GenRenderbuffersImmediate>();
    GLuint temp = kNewClientId;
...
TEST_P(GLES2DecoderTest1, GenRenderbuffersImmediateInvalidArgs)
{
    ...
    cmd->Init(1, &client_renderbuffer_id_);
    EXPECT_EQ(error::kInvalidArguments, ExecuteImmediateCmd(*cmd, sizeof(&client_renderbuffer_id_)));
}

TEST_P(GLES3DecoderTest1, GenSamplersImmediateValidArgs)
{
    EXPECT_CALL(*gl_, GenSamplers(1, _)).WillOnce(SetArgPointee<1>(kNewServiceId));
...
TEST_P(GLES3DecoderTest1, GenSamplersImmediateInvalidArgs)
{
    ...
    cmd->Init(1, &client_sampler_id_);
    EXPECT_EQ(error::kInvalidArguments, ExecuteImmediateCmd(*cmd, sizeof(&client_sampler_id_)));
}
...
TEST_P(GLES2DecoderTest1, GenTexturesImmediateValidArgs)
{
    ...
    cmds::GenTexturesImmediate* cmd = GetImmediateAs<cmds::GenTexturesImmediate>();
    GLuint temp = kNewClientId;
...
TEST_P(GLES2DecoderTest1, GenTexturesImmediateInvalidArgs)
{
    ...
    cmd->Init(1, &client_texture_id_);
    EXPECT_EQ(error::kInvalidArguments, ExecuteImmediateCmd(*cmd, sizeof(&client_texture_id_)));
}

TEST_P(GLES3DecoderTest1, GenTransformFeedbacksImmediateValidArgs)
{
    EXPECT_CALL(*gl_, GenTransformFeedbacks(1, _)).WillOnce(SetArgPointee<1>(kNewServiceId));
...
TEST_P(GLES3DecoderTest1, GenTransformFeedbacksImmediateInvalidArgs)
{
    ...
    EXPECT_EQ(error::kInvalidArguments, ExecuteImmediateCmd(*cmd, sizeof(&client_transformfeedback_id_)));
}
...
TEST_P(GLES2DecoderTest1, GetBooleanvValidArgs)
{
    ...
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_ACTIVE_TEXTURE), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, GetBooleanvInvalidArgs0_0)
{
    ...
    cmds::GetBooleanv::Result* result = static_cast<cmds::GetBooleanv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetBooleanv cmd;
...
TEST_P(GLES3DecoderTest1, GetBufferParameteri64vValidArgs)
{
    ...
    cmd.Init(GL_ARRAY_BUFFER, GL_BUFFER_SIZE, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_BUFFER_SIZE), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, GetBufferParameterivInvalidArgs0_0)
{
    ...
    cmds::GetBufferParameteriv::Result* result = static_cast<cmds::GetBufferParameteriv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetBufferParameteriv cmd;
    cmd.Init(GL_RENDERBUFFER, GL_BUFFER_SIZE, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, GetBufferParameterivInvalidArgs1_0)
{
    ...
    result->size = 0;
    cmds::GetBufferParameteriv cmd;
    cmd.Init(GL_ARRAY_BUFFER, GL_PIXEL_PACK_BUFFER, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, GetBufferParameterivInvalidArgs2_1)
{
    ...
    result->size = 0;
    cmds::GetBufferParameteriv cmd;
    cmd.Init(GL_ARRAY_BUFFER, GL_BUFFER_SIZE, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES2DecoderTest1, GetFloatvInvalidArgs0_0)
{
    ...
    cmds::GetFloatv::Result* result = static_cast<cmds::GetFloatv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetFloatv cmd;
    cmd.Init(GL_FOG_HINT, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
...
TEST_P(GLES2DecoderTest1, GetFramebufferAttachmentParameterivValidArgs)
{
    ...
    Result* result = static_cast<Result*>(shared_memory_address_);
    EXPECT_CALL(*gl_, GetFramebufferAttachmentParameterivEXT(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE, result->GetData()));
    result->size = 0;
    ...
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, GetFramebufferAttachmentParameterivInvalidArgs0_0)
{
    ...
    cmds::GetFramebufferAttachmentParameteriv::Result* result = static_cast<cmds::GetFramebufferAttachmentParameteriv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetFramebufferAttachmentParameteriv cmd;
    cmd.Init(GL_RENDERBUFFER, GL_COLOR_ATTACHMENT0, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest1, GetFramebufferAttachmentParameterivInvalidArgs3_0)
{
    ...
    result->size = 0;
    cmds::GetFramebufferAttachmentParameteriv cmd;
    cmd.Init(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE, kInvalidSharedMemoryId, 0);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES2DecoderTest1, GetFramebufferAttachmentParameterivInvalidArgs3_1)
{
    ...
    result->size = 0;
    cmds::GetFramebufferAttachmentParameteriv cmd;
    cmd.Init(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES2DecoderTest1, GetIntegervInvalidArgs0_0)
{
    ...
    cmds::GetIntegerv::Result* result = static_cast<cmds::GetIntegerv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetIntegerv cmd;
    cmd.Init(GL_FOG_HINT, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
