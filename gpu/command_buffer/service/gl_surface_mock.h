...
public:
    ...
    MOCK_METHOD4(Resize, bool(const gfx::Size& size, float scale_factor, const gfx::ColorSpace& color_space, bool alpha));
    MOCK_METHOD0(IsOffscreen, bool());
    MOCK_METHOD2(SwapBuffers, gfx::SwapResult(PresentationCallback callback, gfx::FrameData data));
    MOCK_METHOD6(PostSubBuffer, gfx::SwapResult(int x, int y, int width, int height, PresentationCallback callback, gfx::FrameData data));
