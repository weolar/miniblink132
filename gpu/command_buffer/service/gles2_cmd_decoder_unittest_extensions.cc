...
INSTANTIATE_TEST_SUITE_P(Service, GLES2DecoderTestWithBlendEquationAdvanced, ::testing::Bool());
...
INSTANTIATE_TEST_SUITE_P(Service, GLES3DecoderTestWithEXTWindowRectangles, ::testing::Bool());

TEST_P(GLES3DecoderTestWithEXTWindowRectangles, WindowRectanglesEXTImmediateValidArgs)
{
    cmds::WindowRectanglesEXTImmediate& cmd = *GetImmediateAs<cmds::WindowRectanglesEXTImmediate>();
