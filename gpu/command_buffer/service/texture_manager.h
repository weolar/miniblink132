...
class GPU_GLES2_EXPORT TexturePassthrough final : public TextureBase, public base::RefCounted<TexturePassthrough> {
public:
...
public:
    ...
    void set_wrap_r(GLenum wrap_r)
    {
        sampler_state_.wrap_r = wrap_r;
    }
    ...
    GLint unclamped_base_level() const
    {
        return unclamped_base_level_;
    }

    GLint unclamped_max_level() const
    {
        return unclamped_max_level_;
    }
    ...
    bool GetLevelSize(GLint target, GLint level, GLsizei* width, GLsizei* height, GLsizei* depth) const;

    // Get the type of a level. Returns false if level does not exist.
    bool GetLevelType(GLint target, GLint level, GLenum* type, GLenum* internal_format) const;
    ...
    bool CompatibleWithSamplerUniformType(GLenum type, const SamplerState& sampler_state) const;

    // Returns true of the given dimensions are inside the dimensions of the
    // level.
    bool ValidForTexture(GLint target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth) const;
    ...
    void SetLevelClearedRect(GLenum target, GLint level, const gfx::Rect& cleared_rect);
    ...
    void DumpLevelMemory(base::trace_event::ProcessMemoryDump* pmd, uint64_t client_tracing_id, const std::string& dump_name) const;
    ...
    static bool ColorRenderable(const FeatureInfo* feature_info, GLenum internal_format, bool immutable);
    ...
    void SetLevelInfo(GLenum target, GLint level, GLenum internal_format, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format,
    ...
    {
        return sampler_state_.min_filter != GL_NEAREST && sampler_state_.min_filter != GL_LINEAR;
    }
...
private:
    ...
    GLenum SetParameteri(const FeatureInfo* feature_info, GLenum pname, GLint param);
    GLenum SetParameterf(const FeatureInfo* feature_info, GLenum pname, GLfloat param);
    ...
    bool CanRenderWithSampler(const FeatureInfo* feature_info, const SamplerState& sampler_state) const;
    ...
    static bool TextureFaceComplete(const Texture::LevelInfo& first_face, size_t face_index, GLenum target, GLenum internal_format, GLsizei width,
    ...
    static bool TextureMipComplete(const Texture::LevelInfo& base_level_face, GLenum target, GLint level_diff, GLenum internal_format, GLsizei width,
        GLsizei height, GLsizei depth, GLenum format, GLenum type);

    static bool TextureFilterable(const FeatureInfo* feature_info, GLenum internal_format, GLenum type, bool immutable);

    // Update info about this texture.
    void Update();

    // Appends a signature for the given level.
    void AddToSignature(const FeatureInfo* feature_info, GLenum target, GLint level, std::string* signature) const;
    ...
    // texture.
    void UpdateMipCleared(LevelInfo* info, GLsizei width, GLsizei height, const gfx::Rect& cleared_rect);
    ...
    void UpdateFaceNumMipLevels(size_t face_index, GLint width, GLint height, GLint depth);
    ...
    // destroyed.
    GLuint owned_service_id() const
    {
        return owned_service_id_;
    }
...
public:
    ...
    static scoped_refptr<TextureRef> Create(TextureManager* manager, GLuint client_id, GLuint service_id);
    ...
    void SetSharedImageRepresentation(std::unique_ptr<GLTextureImageRepresentation> shared_image);
    ...
    const std::unique_ptr<GLTextureImageRepresentation::ScopedAccess>& shared_image_scoped_access() const
    {
...
private:
    ...
    std::unique_ptr<GLTextureImageRepresentation::ScopedAccess> shared_image_scoped_access_;
};
...
class GPU_GLES2_EXPORT TextureManager : public base::trace_event::MemoryDumpProvider {
public:
    ...
    enum DefaultAndBlackTextures { kTexture2D, kTexture3D, kTexture2DArray, kCubeMap, kExternalOES, kRectangleARB, kNumDefaultTextures };

    TextureManager(MemoryTracker* memory_tracker, FeatureInfo* feature_info, GLsizei max_texture_size, GLsizei max_cube_map_texture_size,
        GLsizei max_rectangle_texture_size, GLsizei max_3d_texture_size, GLsizei max_array_texture_layers, bool use_default_textures,
    ...
    static GLsizei ComputeMipMapCount(GLenum target, GLsizei width, GLsizei height, GLsizei depth);
    ...
    bool ValidForTarget(GLenum target, GLint level, GLsizei width, GLsizei height, GLsizei depth);
    bool ValidForTextureTarget(const Texture* texture, GLint level, GLsizei width, GLsizei height, GLsizei depth);
    ...
    bool CanRenderWithSampler(const TextureRef* ref, const SamplerState& sampler_state) const
    {
        return ref->texture()->CanRenderWithSampler(feature_info_.get(), sampler_state);
    }
    ...
    //           GL_TEXTURE_2D_ARRAY or GL_TEXTURE_3D (for GLES3)
    //   max_levels: The maximum levels this type of target can have.
    void SetTarget(TextureRef* ref, GLenum target);

    // Set the info for a particular level in a TexureInfo.
    void SetLevelInfo(TextureRef* ref, GLenum target, GLint level, GLenum internal_format, GLsizei width, GLsizei height, GLsizei depth, GLint border,
        GLenum format, GLenum type, const gfx::Rect& cleared_rect);
    ...
    // ID.
    TextureRef* ConsumeSharedImage(GLuint client_id, std::unique_ptr<GLTextureImageRepresentation> shared_image);

    // Sets |rect| of mip as cleared.
    void SetLevelClearedRect(TextureRef* ref, GLenum target, GLint level, const gfx::Rect& cleared_rect);

    // Sets a mip as cleared.
    void SetLevelCleared(TextureRef* ref, GLenum target, GLint level, bool cleared);

    // Sets a texture parameter of a Texture
    // Returns GL_NO_ERROR on success. Otherwise the error to generate.
    // TODO(gman): Expand to SetParameteriv,fv
    void SetParameteri(const char* function_name, ErrorState* error_state, TextureRef* ref, GLenum pname, GLint param);
    void SetParameterf(const char* function_name, ErrorState* error_state, TextureRef* ref, GLenum pname, GLfloat param);
    ...
    static bool ClearTextureLevel(DecoderContext* decoder, TextureRef* ref, GLenum target, GLint level);

    static bool ClearTextureLevel(DecoderContext* decoder, Texture* texture, GLenum target, GLint level);
    ...
    void AddToSignature(TextureRef* ref, GLenum target, GLint level, std::string* signature) const;
    ...
    bool ValidateTexImage(ContextState* state, ErrorState* error_state, const char* function_name, const DoTexImageArguments& args,
        // Pointer to TextureRef filled in if validation
        // successful. Presumes the pointer is valid.
        TextureRef** texture_ref);

    void ValidateAndDoTexImage(DecoderTextureState* texture_state, ContextState* state, ErrorState* error_state, DecoderFramebufferState* framebuffer_state,
        const char* function_name, const DoTexImageArguments& args);
    ...
    bool ValidateTexSubImage(ContextState* state, ErrorState* error_state, const char* function_name, const DoTexSubImageArguments& args,
        // Pointer to TextureRef filled in if validation
        // successful. Presumes the pointer is valid.
        TextureRef** texture_ref);

    void ValidateAndDoTexSubImage(DecoderContext* decoder, DecoderTextureState* texture_state, ContextState* state, ErrorState* error_state,
    ...
    TextureRef* GetTextureInfoForTargetUnlessDefault(ContextState* state, GLenum target);
    ...
    static bool CombineAdjacentRects(const gfx::Rect& rect1, const gfx::Rect& rect2, gfx::Rect* result);
    ...
    static const Texture::CompatibilitySwizzle* GetCompatibilitySwizzle(const gles2::FeatureInfo* feature_info, GLenum format);
    static GLenum AdjustTexInternalFormat(const gles2::FeatureInfo* feature_info, GLenum format, GLenum type);
    static GLenum AdjustTexFormat(const gles2::FeatureInfo* feature_info, GLenum format);

    static GLenum AdjustTexStorageFormat(const gles2::FeatureInfo* feature_info, GLenum format);

    void WorkaroundCopyTexImageCubeMap(DecoderTextureState* texture_state, ContextState* state, ErrorState* error_state,
...
private:
    ...
    scoped_refptr<TextureRef> CreateDefaultAndBlackTextures(GLenum target, GLuint* black_texture);

    void DoTexImage(DecoderTextureState* texture_state, ContextState* state, ErrorState* error_state, DecoderFramebufferState* framebuffer_state,
    ...
    void ReserveTexImageToBeFilled(DecoderTextureState* texture_state, ContextState* state, ErrorState* error_state, DecoderFramebufferState* framebuffer_state,
        const char* function_name, TextureRef* texture_ref, const DoTexImageArguments& args);

    void DoTexSubImageWithAlignmentWorkaround(DecoderTextureState* texture_state, ContextState* state, const DoTexSubImageArguments& args);

    void DoTexSubImageRowByRowWorkaround(
    ...
    void DoCubeMapWorkaround(DecoderTextureState* texture_state, ContextState* state, ErrorState* error_state, DecoderFramebufferState* framebuffer_state,
        TextureRef* texture_ref, const char* function_name, const DoTexImageArguments& args);
    ...
    void UpdateCanRenderCondition(Texture::CanRenderCondition old_condition, Texture::CanRenderCondition new_condition);
    void UpdateNumImages(int delta);
    void IncFramebufferStateChangeCount();

    // Helper function called by OnMemoryDump.
    void DumpTextureRef(base::trace_event::ProcessMemoryDump* pmd, TextureRef* ref);
    ...
    std::vector<raw_ptr<FramebufferManager, VectorExperimental>> framebuffer_managers_;
    ...
    std::vector<raw_ptr<DestructionObserver, VectorExperimental>> destruction_observers_;
