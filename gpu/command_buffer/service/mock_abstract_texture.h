...
class MockAbstractTexture : public ::testing::NiceMock<gpu::gles2::AbstractTexture>, public base::SupportsWeakPtr<MockAbstractTexture> {
public:
    MockAbstractTexture();
    ...
    MOCK_METHOD2(BindStreamTextureImage, void(gl::GLImage* image, GLuint service_id));
