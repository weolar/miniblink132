...
// to this cache.
class GPU_GLES2_EXPORT ShaderTranslatorCache : public ShaderTranslator::DestructionObserver {
public:
    ...
    scoped_refptr<ShaderTranslator> GetTranslator(sh::GLenum shader_type, ShShaderSpec shader_spec, const ShBuiltInResources* resources,
        ShShaderOutput shader_output_language, const ShCompileOptions& driver_bug_workarounds);
...
private:
    ...
    struct ShaderTranslatorInitParams {
        ...
        ShaderTranslatorInitParams(sh::GLenum shader_type, ShShaderSpec shader_spec, const ShBuiltInResources& resources, ShShaderOutput shader_output_language,
    ...
    private:
        ...
        ShaderTranslatorInitParams& operator=(const ShaderTranslatorInitParams&) = delete;
    };

    const GpuPreferences gpu_preferences_;

    typedef std::map<ShaderTranslatorInitParams, raw_ptr<ShaderTranslator, CtnExperimental>> Cache;
    Cache cache_;
};
