...
DawnSharedTextureHolder::SharedTextureData::SharedTextureData(SharedTextureData&&) = default;

DawnSharedTextureHolder::SharedTextureData& DawnSharedTextureHolder::SharedTextureData::operator=(SharedTextureData&&) = default;
...
DawnSharedTextureHolder::DawnSharedTextureHolder(DawnSharedTextureHolder&&) = default;

DawnSharedTextureHolder& DawnSharedTextureHolder::operator=(DawnSharedTextureHolder&&) = default;

DawnSharedTextureHolder::WGPUTextureCache* DawnSharedTextureHolder::GetWGPUTextureCache(const wgpu::Device& device)
{
...
wgpu::SharedTextureMemory DawnSharedTextureHolder::GetSharedTextureMemory(const wgpu::Device& device)
{
    auto iter = shared_texture_data_cache_.find(device.Get());
    if (iter == shared_texture_data_cache_.end()) {
        return nullptr;
...
void DawnSharedTextureHolder::MaybeCacheSharedTextureMemory(const wgpu::Device& device, const wgpu::SharedTextureMemory& memory)
{
    if (!memory) {
        return;
    }
    ...
    shared_texture_data_cache_.emplace(device.Get(), std::move(shared_texture_data));
}

wgpu::Texture DawnSharedTextureHolder::GetCachedWGPUTexture(const wgpu::Device& device, wgpu::TextureUsage texture_usage)
{
...
void DawnSharedTextureHolder::RemoveWGPUTextureFromCache(const wgpu::Device& device, const wgpu::Texture& texture)
{
    auto* texture_cache = GetWGPUTextureCache(device);
    if (!texture_cache) {
        return;
...
void DawnSharedTextureHolder::MaybeCacheWGPUTexture(const wgpu::Device& device, const wgpu::Texture& texture)
{
    if (!texture) {
        return;
    }
...
void DawnSharedTextureHolder::DestroyWGPUTextureIfNotCached(const wgpu::Device& device, const wgpu::Texture& texture)
{
