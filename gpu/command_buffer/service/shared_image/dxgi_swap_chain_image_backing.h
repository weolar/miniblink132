...
class GPU_GLES2_EXPORT DXGISwapChainImageBacking : public ClearTrackingSharedImageBacking {
public:
    static std::unique_ptr<DXGISwapChainImageBacking> Create(Microsoft::WRL::ComPtr<ID3D11Device> d3d11_device, const Mailbox& mailbox,
    ...
    DXGISwapChainImageBacking& operator=(const DXGISwapChainImageBacking&) = delete;
...
private:
    DXGISwapChainImageBacking(const Mailbox& mailbox, viz::SharedImageFormat format, const gfx::Size& size, const gfx::ColorSpace& color_space,
        GrSurfaceOrigin surface_origin, SkAlphaType alpha_type, gpu::SharedImageUsageSet usage, std::string debug_label,
        Microsoft::WRL::ComPtr<ID3D11Device> d3d11_device, Microsoft::WRL::ComPtr<IDXGISwapChain1> dxgi_swap_chain,
    ...
    {
        return std::make_optional<gl::DCLayerOverlayImage>(size(), dxgi_swap_chain_);
    }
    ...
    wgpu::Texture BeginAccessDawn(const wgpu::Device& device, wgpu::TextureUsage usage, wgpu::TextureUsage internal_usage, const gfx::Rect& update_rect);
