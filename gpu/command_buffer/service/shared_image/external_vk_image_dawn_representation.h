...
public:
    ExternalVkImageDawnImageRepresentation(SharedImageManager* manager, SharedImageBacking* backing, MemoryTypeTracker* tracker, wgpu::Device device,
        wgpu::TextureFormat dawn_format, std::vector<wgpu::TextureFormat> view_formats, base::ScopedFD memory_fd);

    ExternalVkImageDawnImageRepresentation(const ExternalVkImageDawnImageRepresentation&) = delete;
    ExternalVkImageDawnImageRepresentation& operator=(const ExternalVkImageDawnImageRepresentation&) = delete;
