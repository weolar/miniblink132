...
class WrappedGraphiteTextureHolder : public base::RefCountedThreadSafe<WrappedGraphiteTextureHolder> {
public:
    WrappedGraphiteTextureHolder(skgpu::graphite::BackendTexture backend_texture, scoped_refptr<SharedContextState> context_state,
