...
GLTexturePassthroughAndroidImageRepresentation::GLTexturePassthroughAndroidImageRepresentation(SharedImageManager* manager, AndroidImageBacking* backing,
    MemoryTypeTracker* tracker, gl::ScopedEGLImage egl_image, scoped_refptr<gles2::TexturePassthrough> texture)
...
GLTexturePassthroughAndroidImageRepresentation::~GLTexturePassthroughAndroidImageRepresentation()
{
    EndAccess();
    if (!has_context())
...
const scoped_refptr<gles2::TexturePassthrough>& GLTexturePassthroughAndroidImageRepresentation::GetTexturePassthrough(int plane_index)
{
...
bool GLTexturePassthroughAndroidImageRepresentation::BeginAccess(GLenum mode)
{
    ...
    bool read_write_mode = (mode == GL_SHARED_IMAGE_ACCESS_MODE_READWRITE_CHROMIUM);
