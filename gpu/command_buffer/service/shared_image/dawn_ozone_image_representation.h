...
public:
    DawnOzoneImageRepresentation(SharedImageManager* manager, SharedImageBacking* backing, MemoryTypeTracker* tracker, wgpu::Device device,
        wgpu::TextureFormat format, std::vector<wgpu::TextureFormat> view_formats, scoped_refptr<gfx::NativePixmap> pixmap);

    DawnOzoneImageRepresentation(const DawnOzoneImageRepresentation&) = delete;
    DawnOzoneImageRepresentation& operator=(const DawnOzoneImageRepresentation&) = delete;
