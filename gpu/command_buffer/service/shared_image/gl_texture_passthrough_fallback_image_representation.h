...
class GLTexturePassthroughFallbackImageRepresentation : public GLTexturePassthroughImageRepresentation {
public:
    GLTexturePassthroughFallbackImageRepresentation(SharedImageManager* manager, SharedImageBacking* backing, MemoryTypeTracker* tracker,
        gl::ProgressReporter* progress_reporter, const GLFormatCaps& gl_format_caps);
