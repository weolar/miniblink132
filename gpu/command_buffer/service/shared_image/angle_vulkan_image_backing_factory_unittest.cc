...
constexpr gpu::SharedImageUsageSet kUsage = SHARED_IMAGE_USAGE_RASTER_READ | SHARED_IMAGE_USAGE_RASTER_WRITE | SHARED_IMAGE_USAGE_GLES2_READ;
...
// in right mode.
class AngleVulkanImageBackingFactoryTest : public SharedImageTestBase, public testing::WithParamInterface<viz::SharedImageFormat> {
public:
    static void SetUpTestSuite()
    {
        ...
        g_scoped_feature_list->InitWithFeatures({ features::kVulkan, features::kVulkanFromANGLE, features::kDefaultANGLEVulkan }, {});
    ...
    void SetUp() override
    {
        ASSERT_EQ(gl::GetGLImplementationParts(), gl::GLImplementationParts(gl::ANGLEImplementation::kVulkan));

        ASSERT_NO_FATAL_FAILURE(InitializeContext(GrContextType::kVulkan));
        backing_factory_ = std::make_unique<AngleVulkanImageBackingFactory>(gpu_preferences_, gpu_workarounds_, context_state_.get());
    }
};
...
TEST_P(AngleVulkanImageBackingFactoryTest, Basic)
{
    ...
    bool supported = backing_factory_->CanCreateSharedImage(kUsage, format, size, /*thread_safe=*/false, gfx::EMPTY_BUFFER, GrContextType::kVulkan, {});
...
const auto kFormats = ::testing::Values(viz::SinglePlaneFormat::kRGBA_8888, viz::SinglePlaneFormat::kBGRA_8888, viz::SinglePlaneFormat::kR_8,
    viz::SinglePlaneFormat::kRG_88, viz::MultiPlaneFormat::kNV12, viz::MultiPlaneFormat::kYV12, viz::MultiPlaneFormat::kI420);

INSTANTIATE_TEST_SUITE_P(, AngleVulkanImageBackingFactoryTest, kFormats, TestParamToString);
