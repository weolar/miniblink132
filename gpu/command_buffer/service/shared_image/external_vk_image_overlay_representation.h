...
class ExternalVkImageOverlayImageRepresentation : public OverlayImageRepresentation {
public:
    ExternalVkImageOverlayImageRepresentation(gpu::SharedImageManager* manager, ExternalVkImageBacking* backing, MemoryTypeTracker* tracker);
    ~ExternalVkImageOverlayImageRepresentation() override;
    ExternalVkImageOverlayImageRepresentation(const ExternalVkImageOverlayImageRepresentation&) = delete;
    ExternalVkImageOverlayImageRepresentation& operator=(const ExternalVkImageOverlayImageRepresentation&) = delete;
