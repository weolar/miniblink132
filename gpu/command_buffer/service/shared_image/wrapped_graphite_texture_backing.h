...
public:
    WrappedGraphiteTextureBacking(base::PassKey<WrappedSkImageBackingFactory>, const Mailbox& mailbox, viz::SharedImageFormat format, const gfx::Size& size,
    ...
    WrappedGraphiteTextureBacking& operator=(const WrappedGraphiteTextureBacking&) = delete;
...
private:
    ...
    const std::vector<scoped_refptr<WrappedGraphiteTextureHolder>>& GetWrappedGraphiteTextureHolders();
