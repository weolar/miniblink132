...
public:
    ...
    TestImageBacking(const Mailbox& mailbox, viz::SharedImageFormat format, const gfx::Size& size, const gfx::ColorSpace& color_space,
    ...
    void SetPurgeableCallbacks(const PurgeableCallback& set_purgeable_callback, const PurgeableCallback& set_not_purgeable_callback)
    {
    ...
    {
        return textures_[0]->service_id();
    }
    void set_can_access(bool can_access)
    {
        can_access_ = can_access;
    }
    ...
    bool in_use_by_window_server() const
    {
        return in_use_by_window_server_;
    }
...
public:
    ...
    {
        static_cast<TestImageBacking*>(backing())->set_in_use_by_window_server(in_use);
    }
