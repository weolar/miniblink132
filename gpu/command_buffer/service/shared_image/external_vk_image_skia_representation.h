...
class ExternalVkImageSkiaImageRepresentation : public SkiaGaneshImageRepresentation {
public:
    ExternalVkImageSkiaImageRepresentation(GrDirectContext* gr_context, SharedImageManager* manager, SharedImageBacking* backing, MemoryTypeTracker* tracker);
