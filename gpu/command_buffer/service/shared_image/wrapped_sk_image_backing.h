...
public:
    WrappedSkImageBacking(base::PassKey<WrappedSkImageBackingFactory>, const Mailbox& mailbox, viz::SharedImageFormat format, const gfx::Size& size,
    ...
    // supported.
    bool InitializeWithData(const std::string& debug_label, base::span<const uint8_t> pixels);
...
private:
    ...
    std::vector<sk_sp<SkSurface>> GetSkSurfaces(int final_msaa_count, const SkSurfaceProps& surface_props, scoped_refptr<SharedContextState> context_state);
