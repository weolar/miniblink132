...
class GPU_GLES2_EXPORT DawnGLTextureRepresentation : public DawnImageRepresentation {
public:
    DawnGLTextureRepresentation(std::unique_ptr<GLTextureImageRepresentationBase> gl_representation, SharedImageManager* manager, SharedImageBacking* backing,
        MemoryTypeTracker* tracker, wgpu::Device device, std::vector<wgpu::TextureFormat> view_formats);
