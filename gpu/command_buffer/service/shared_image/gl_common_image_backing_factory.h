...
class GPU_GLES2_EXPORT GLCommonImageBackingFactory : public SharedImageBackingFactory {
public:
    struct FormatInfo {
        FormatInfo();
...
protected:
    GLCommonImageBackingFactory(SharedImageUsageSet supported_usages, const GpuPreferences& gpu_preferences, const GpuDriverBugWorkarounds& workarounds,
    ...
    bool CanCreateTexture(viz::SharedImageFormat format, const gfx::Size& size, base::span<const uint8_t> pixel_data, GLenum target);
