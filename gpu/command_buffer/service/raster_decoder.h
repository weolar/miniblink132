...
class GPU_GLES2_EXPORT RasterDecoder : public DecoderContext, public CommonDecoder {
public:
    static RasterDecoder* Create(DecoderClient* client, CommandBufferServiceBase* command_buffer_service, gles2::Outputter* outputter,
        ...
        scoped_refptr<SharedContextState> shared_context_state, bool is_priviliged);
...
protected:
    RasterDecoder(DecoderClient* client, CommandBufferServiceBase* command_buffer_service, gles2::Outputter* outputter);
