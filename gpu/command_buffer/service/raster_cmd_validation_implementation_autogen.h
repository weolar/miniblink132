...
bool Validators::GpuRasterMsaaModeValidator::IsValid(const gpu::raster::MsaaMode value) const
{
    switch (value) {
...
Validators::Validators()
    ...
    , texture_mag_filter_mode(valid_texture_mag_filter_mode_table, std::size(valid_texture_mag_filter_mode_table))
    , texture_min_filter_mode(valid_texture_min_filter_mode_table, std::size(valid_texture_min_filter_mode_table))
    , texture_parameter(valid_texture_parameter_table, std::size(valid_texture_parameter_table))
    , texture_wrap_mode(valid_texture_wrap_mode_table, std::size(valid_texture_wrap_mode_table))
    , gfx_buffer_usage(valid_gfx_buffer_usage_table, std::size(valid_gfx_buffer_usage_table))
{
}
