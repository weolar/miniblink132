...
class DawnServiceMemoryTransferService final : public dawn::wire::server::MemoryTransferService {
public:
    ...
    bool DeserializeReadHandle(const void* deserialize_pointer, size_t deserialize_size, ReadHandle** read_handle) override;

    bool DeserializeWriteHandle(const void* deserialize_pointer, size_t deserialize_size, WriteHandle** write_handle) override;
