...
TEST_P(GLES2DecoderTest2, GetProgramivValidArgs)
{
    ...
    cmd.Init(client_program_id_, GL_DELETE_STATUS, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_DELETE_STATUS), result->GetNumResults());
...
TEST_P(GLES2DecoderTest2, GetProgramivInvalidArgs1_0)
{
    ...
    cmds::GetProgramiv::Result* result = static_cast<cmds::GetProgramiv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetProgramiv cmd;
    cmd.Init(client_program_id_, GL_PROGRAM_BINARY_RETRIEVABLE_HINT, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
...
TEST_P(GLES2DecoderTest2, GetProgramivInvalidArgs2_1)
{
    ...
    result->size = 0;
    cmds::GetProgramiv cmd;
    cmd.Init(client_program_id_, GL_DELETE_STATUS, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES2DecoderTest2, GetRenderbufferParameterivValidArgs)
{
    ...
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_RENDERBUFFER_RED_SIZE), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetRenderbufferParameterivInvalidArgs0_0)
{
    ...
    cmds::GetRenderbufferParameteriv::Result* result = static_cast<cmds::GetRenderbufferParameteriv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetRenderbufferParameteriv cmd;
    cmd.Init(GL_FRAMEBUFFER, GL_RENDERBUFFER_RED_SIZE, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetRenderbufferParameterivInvalidArgs2_0)
{
    ...
    result->size = 0;
    cmds::GetRenderbufferParameteriv cmd;
    cmd.Init(GL_RENDERBUFFER, GL_RENDERBUFFER_RED_SIZE, kInvalidSharedMemoryId, 0);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES2DecoderTest2, GetRenderbufferParameterivInvalidArgs2_1)
{
    ...
    result->size = 0;
    cmds::GetRenderbufferParameteriv cmd;
    cmd.Init(GL_RENDERBUFFER, GL_RENDERBUFFER_RED_SIZE, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES3DecoderTest2, GetSamplerParameterfvValidArgs)
{
    ...
    Result* result = static_cast<Result*>(shared_memory_address_);
    EXPECT_CALL(*gl_, GetSamplerParameterfv(kServiceSamplerId, GL_TEXTURE_MAG_FILTER, result->GetData()));
    result->size = 0;
    cmds::GetSamplerParameterfv cmd;
    cmd.Init(client_sampler_id_, GL_TEXTURE_MAG_FILTER, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_TEXTURE_MAG_FILTER), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES3DecoderTest2, GetSamplerParameterivValidArgs)
{
    ...
    Result* result = static_cast<Result*>(shared_memory_address_);
    EXPECT_CALL(*gl_, GetSamplerParameteriv(kServiceSamplerId, GL_TEXTURE_MAG_FILTER, result->GetData()));
    result->size = 0;
...
TEST_P(GLES2DecoderTest2, GetShaderivValidArgs)
{
    ...
    Result* result = static_cast<Result*>(shared_memory_address_);
    EXPECT_CALL(*gl_, GetShaderiv(kServiceShaderId, GL_SHADER_TYPE, result->GetData()));
    result->size = 0;
    cmds::GetShaderiv cmd;
    cmd.Init(client_shader_id_, GL_SHADER_TYPE, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_SHADER_TYPE), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetShaderivInvalidArgs2_0)
{
    ...
    cmds::GetShaderiv::Result* result = static_cast<cmds::GetShaderiv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetShaderiv cmd;
...
TEST_P(GLES2DecoderTest2, GetShaderivInvalidArgs2_1)
{
    ...
    result->size = 0;
    cmds::GetShaderiv cmd;
    cmd.Init(client_shader_id_, GL_SHADER_TYPE, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES3DecoderTest2, GetSyncivValidArgs)
{
    ...
    Result* result = static_cast<Result*>(shared_memory_address_);
    EXPECT_CALL(*gl_,
        GetSynciv(reinterpret_cast<GLsync>(kServiceSyncId), GL_SYNC_STATUS, decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_SYNC_STATUS), nullptr,
            result->GetData()));
    result->size = 0;
    cmds::GetSynciv cmd;
    cmd.Init(client_sync_id_, GL_SYNC_STATUS, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_SYNC_STATUS), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetTexParameterfvValidArgs)
{
    ...
    cmd.Init(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_TEXTURE_MAG_FILTER), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetTexParameterfvInvalidArgs0_0)
{
    ...
    cmds::GetTexParameterfv::Result* result = static_cast<cmds::GetTexParameterfv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetTexParameterfv cmd;
    cmd.Init(GL_PROXY_TEXTURE_CUBE_MAP, GL_TEXTURE_MAG_FILTER, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetTexParameterfvInvalidArgs1_0)
{
    ...
    result->size = 0;
    cmds::GetTexParameterfv cmd;
    cmd.Init(GL_TEXTURE_2D, GL_GENERATE_MIPMAP, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
    EXPECT_EQ(GL_INVALID_ENUM, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetTexParameterfvInvalidArgs2_1)
{
    ...
    result->size = 0;
    cmds::GetTexParameterfv cmd;
    cmd.Init(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES2DecoderTest2, GetTexParameterivValidArgs)
{
    ...
    Result* result = static_cast<Result*>(shared_memory_address_);
    EXPECT_CALL(*gl_, GetTexParameteriv(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, result->GetData()));
    result->size = 0;
...
TEST_P(GLES2DecoderTest2, GetTexParameterivInvalidArgs0_0)
{
    ...
    cmds::GetTexParameteriv::Result* result = static_cast<cmds::GetTexParameteriv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetTexParameteriv cmd;
    cmd.Init(GL_PROXY_TEXTURE_CUBE_MAP, GL_TEXTURE_MAG_FILTER, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
...
TEST_P(GLES2DecoderTest2, GetVertexAttribfvValidArgs)
{
    ...
    cmd.Init(1, GL_VERTEX_ATTRIB_ARRAY_NORMALIZED, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(decoder_->GetGLES2Util()->GLGetNumValuesReturned(GL_VERTEX_ATTRIB_ARRAY_NORMALIZED), result->GetNumResults());
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES2DecoderTest2, GetVertexAttribfvInvalidArgs2_0)
{
    ...
    cmds::GetVertexAttribfv::Result* result = static_cast<cmds::GetVertexAttribfv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetVertexAttribfv cmd;
...
TEST_P(GLES2DecoderTest2, GetVertexAttribfvInvalidArgs2_1)
{
    ...
    result->size = 0;
    cmds::GetVertexAttribfv cmd;
    cmd.Init(1, GL_VERTEX_ATTRIB_ARRAY_NORMALIZED, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    EXPECT_EQ(0u, result->size);
}
...
TEST_P(GLES2DecoderTest2, GetVertexAttribivInvalidArgs2_0)
{
    ...
    cmds::GetVertexAttribiv::Result* result = static_cast<cmds::GetVertexAttribiv::Result*>(shared_memory_address_);
    result->size = 0;
    cmds::GetVertexAttribiv cmd;
    cmd.Init(1, GL_VERTEX_ATTRIB_ARRAY_NORMALIZED, kInvalidSharedMemoryId, 0);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
...
TEST_P(GLES2DecoderTest2, IsFramebufferInvalidArgsBadSharedMemoryId)
{
    ...
    cmds::IsFramebuffer cmd;
    cmd.Init(client_framebuffer_id_, kInvalidSharedMemoryId, shared_memory_offset_);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    cmd.Init(client_framebuffer_id_, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
}
...
TEST_P(GLES2DecoderTest2, IsRenderbufferInvalidArgsBadSharedMemoryId)
{
    ...
    cmds::IsRenderbuffer cmd;
    cmd.Init(client_renderbuffer_id_, kInvalidSharedMemoryId, shared_memory_offset_);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    cmd.Init(client_renderbuffer_id_, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
}
...
TEST_P(GLES3DecoderTest2, IsTransformFeedbackValidArgs)
{
    ...
    cmd.Init(client_transformfeedback_id_, shared_memory_id_, shared_memory_offset_);
    EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
TEST_P(GLES3DecoderTest2, IsTransformFeedbackInvalidArgsBadSharedMemoryId)
{
    ...
    cmds::IsTransformFeedback cmd;
    cmd.Init(client_transformfeedback_id_, kInvalidSharedMemoryId, shared_memory_offset_);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
    cmd.Init(client_transformfeedback_id_, shared_memory_id_, kInvalidSharedMemoryOffset);
    EXPECT_EQ(error::kOutOfBounds, ExecuteCmd(cmd));
}
...
{
    EXPECT_CALL(*gl_, SamplerParameterf(kServiceSamplerId, GL_TEXTURE_MAG_FILTER, GL_NEAREST));
...
{
    cmds::SamplerParameterfvImmediate& cmd = *GetImmediateAs<cmds::SamplerParameterfvImmediate>();
    SpecializedSetup<cmds::SamplerParameterfvImmediate, 0>(true);
    GLfloat temp[1] = {
        GL_NEAREST,
    };
    cmd.Init(client_sampler_id_, GL_TEXTURE_MAG_FILTER, &temp[0]);
    EXPECT_CALL(*gl_, SamplerParameterf(kServiceSamplerId, GL_TEXTURE_MAG_FILTER, temp[0]));
...
{
    EXPECT_CALL(*gl_, SamplerParameteri(kServiceSamplerId, GL_TEXTURE_MAG_FILTER, GL_NEAREST));
...
{
    cmds::SamplerParameterivImmediate& cmd = *GetImmediateAs<cmds::SamplerParameterivImmediate>();
    SpecializedSetup<cmds::SamplerParameterivImmediate, 0>(true);
    GLint temp[1] = {
        GL_NEAREST,
    };
    cmd.Init(client_sampler_id_, GL_TEXTURE_MAG_FILTER, &temp[0]);
    EXPECT_CALL(*gl_, SamplerParameteri(kServiceSamplerId, GL_TEXTURE_MAG_FILTER, temp[0]));
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
{
    EXPECT_CALL(*gl_, TexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST));
...
{
    cmds::TexParameterfvImmediate& cmd = *GetImmediateAs<cmds::TexParameterfvImmediate>();
    SpecializedSetup<cmds::TexParameterfvImmediate, 0>(true);
    GLfloat temp[1] = {
        GL_NEAREST,
    };
    cmd.Init(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, &temp[0]);
    EXPECT_CALL(*gl_, TexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, temp[0]));
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
...
{
    EXPECT_CALL(*gl_, TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST));
...
{
    cmds::TexParameterivImmediate& cmd = *GetImmediateAs<cmds::TexParameterivImmediate>();
    SpecializedSetup<cmds::TexParameterivImmediate, 0>(true);
    GLint temp[1] = {
        GL_NEAREST,
    };
    cmd.Init(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, &temp[0]);
    EXPECT_CALL(*gl_, TexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, temp[0]));
    EXPECT_EQ(error::kNoError, ExecuteImmediateCmd(cmd, sizeof(temp)));
    EXPECT_EQ(GL_NO_ERROR, GetGLError());
}
