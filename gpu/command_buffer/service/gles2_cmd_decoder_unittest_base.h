...
class GLES2DecoderTestBase : public ::testing::TestWithParam<bool>, public DecoderClient {
public:
    ...
    template <typename T> void GenHelper(GLuint client_id)
    {
    ...
    // certain commands.
    template <typename T, int id> void SpecializedSetup(bool valid)
    {
    }

    template <typename T> T* GetImmediateAs()
    {
    ...
    template <typename T> error::Error ExecuteCmd(const T& cmd)
    {
        static_assert(T::kArgFlags == cmd::kFixed, "T::kArgFlags should equal cmd::kFixed");
        int entries_processed = 0;
        return decoder_->DoCommands(1, (const void*)&cmd, ComputeNumEntries(sizeof(cmd)), &entries_processed);
    }

    template <typename T> error::Error ExecuteImmediateCmd(const T& cmd, size_t data_size)
    {
        static_assert(T::kArgFlags == cmd::kAtLeastN, "T::kArgFlags should equal cmd::kAtLeastN");
        int entries_processed = 0;
        return decoder_->DoCommands(1, (const void*)&cmd, ComputeNumEntries(sizeof(cmd) + data_size), &entries_processed);
    }

    template <typename T> T GetSharedMemoryAs()
    {
        return reinterpret_cast<T>(shared_memory_address_.get());
    }

    template <typename T> T GetSharedMemoryAsWithOffset(uint32_t offset)
    {
        void* ptr = reinterpret_cast<int8_t*>(shared_memory_address_.get()) + offset;
    ...
    {
        return decoder_->GetTransformFeedbackManager()->GetTransformFeedback(client_id);
    }
    ...
    void SetBucketAsCStrings(uint32_t bucket_id, GLsizei count, const char** str, GLsizei count_in_header, char str_end);
    ...
    void InitDecoderWithWorkarounds(const InitState& init, const GpuDriverBugWorkarounds& workarounds);
    ContextResult MaybeInitDecoderWithWorkarounds(const InitState& init, const GpuDriverBugWorkarounds& workarounds);
    ...
    SharedImageManager* GetSharedImageManager()
    {
    ...
    void SetupShader(AttribInfo* attribs, size_t num_attribs, UniformInfo* uniforms, size_t num_uniforms, GLuint client_id, GLuint service_id,
        GLuint vertex_shader_client_id, GLuint vertex_shader_service_id, GLuint fragment_shader_client_id, GLuint fragment_shader_service_id);
    ...
    void SetupExpectationsForInternalFormatSampleCountsHelper(GLenum target, GLenum internal_format, GLint expected_num_sample_counts, GLint expected_sample0);
    void DoRenderbufferStorageMultisampleCHROMIUM(GLenum target, GLsizei samples, GLenum internal_format, GLsizei width, GLsizei height, bool expect_bind);
    ...
    void DoBindTransformFeedback(GLenum target, GLuint client_id, GLuint service_id);
    ...
    void DoCompressedTexImage2D(GLenum target, GLint level, GLenum format, GLsizei width, GLsizei height, GLint border, GLsizei size, uint32_t bucket_id);
    void DoTexImage2D(GLenum target, GLint level, GLenum internal_format, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type,
        uint32_t shared_memory_id, uint32_t shared_memory_offset);
    void DoTexImage2DConvertInternalFormat(GLenum target, GLint level, GLenum requested_internal_format, GLsizei width, GLsizei height, GLint border,
        GLenum format, GLenum type, uint32_t shared_memory_id, uint32_t shared_memory_offset, GLenum expected_internal_format);
    void DoTexImage3D(GLenum target, GLint level, GLenum internal_format, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format,
    ...
    void DoRenderbufferStorage(GLenum target, GLenum internal_format, GLsizei width, GLsizei height, GLenum error);
    ...
    void DoFramebufferTexture2D(
        GLenum target, GLenum attachment, GLenum tex_target, GLuint texture_client_id, GLuint texture_service_id, GLint level, GLenum error);
    GLenum DoCheckFramebufferStatus(GLenum target);
    void DoVertexAttribPointer(GLuint index, GLint size, GLenum type, GLsizei stride, GLuint offset);
    ...
    void DoBufferSubData(GLenum target, GLint offset, GLsizei size, const void* data);
    ...
    void SetupClearTextureExpectations(GLuint service_id, GLuint old_service_id, GLenum bind_target, GLenum target, GLint level, GLenum format, GLenum type,
        GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLuint bound_pixel_unpack_buffer);

    void SetupClearTexture3DExpectations(GLsizeiptr buffer_size, GLenum target, GLuint tex_service_id, GLint level, GLenum format, GLenum type,
        size_t tex_sub_image_3d_num_calls, GLint* xoffset, GLint* yoffset, GLint* zoffset, GLsizei* width, GLsizei* height, GLsizei* depth,
        GLuint bound_pixel_unpack_buffer);

    void SetupExpectationsForRestoreClearState(GLclampf restore_red, GLclampf restore_green, GLclampf restore_blue, GLclampf restore_alpha,
        GLuint restore_stencil, GLclampf restore_depth, bool restore_scissor_test, GLint restore_scissor_x, GLint restore_scissor_y,
        GLsizei restore_scissor_width, GLsizei restore_scissor_height);

    void SetupExpectationsForFramebufferClearing(GLenum target, GLuint clear_bits, GLclampf restore_red, GLclampf restore_green, GLclampf restore_blue,
        GLclampf restore_alpha, GLuint restore_stencil, GLclampf restore_depth, bool restore_scissor_test, GLint restore_scissor_x, GLint restore_scissor_y,
        GLsizei restore_scissor_width, GLsizei restore_scissor_height);

    void SetupExpectationsForFramebufferClearingMulti(GLuint read_framebuffer_service_id, GLuint draw_framebuffer_service_id, GLenum target, GLuint clear_bits,
        GLclampf restore_red, GLclampf restore_green, GLclampf restore_blue, GLclampf restore_alpha, GLuint restore_stencil, GLclampf restore_depth,
        bool restore_scissor_test, GLint restore_scissor_x, GLint restore_scissor_y, GLsizei restore_scissor_width, GLsizei restore_scissor_height);

    void SetupExpectationsForDepthMask(bool mask);
    void SetupExpectationsForEnableDisable(GLenum cap, bool enable);
    void SetupExpectationsForColorMask(bool red, bool green, bool blue, bool alpha);
    void SetupExpectationsForStencilMask(GLuint front_mask, GLuint back_mask);

    void SetupExpectationsForApplyingDirtyState(bool framebuffer_is_rgb, bool framebuffer_has_depth, bool framebuffer_has_stencil,
        GLuint color_bits, // NOTE! bits are 0x1000, 0x0100, 0x0010, and 0x0001
        bool depth_mask, bool depth_enabled, GLuint front_stencil_mask, GLuint back_stencil_mask, bool stencil_enabled);
    ...
    {
        return reinterpret_cast<GLvoid*>(i);
    }

    template <typename Command, typename Result> bool IsObjectHelper(GLuint client_id)
    {
...
protected:
    ...
    static const int32_t kInvalidSharedMemoryId = FakeCommandBufferServiceBase::kTransferBufferBaseId - 1;
...
private:
    ...
    raw_ptr<MockCopyTextureResourceManager, DanglingUntriaged> copy_texture_manager_; // not owned
    raw_ptr<MockCopyTexImageResourceManager, DanglingUntriaged> copy_tex_image_blitter_; // not owned
};
...
class GLES2DecoderPassthroughTestBase : public testing::Test, public DecoderClient {
public:
    ...
    template <typename Command> bool IsObjectHelper(GLuint client_id)
    {
        typename Command::Result* result = static_cast<typename Command::Result*>(shared_memory_address_);
        Command cmd;
        cmd.Init(client_id, shared_memory_id_, kSharedMemoryOffset);
        EXPECT_EQ(error::kNoError, ExecuteCmd(cmd));
        bool isObject = static_cast<bool>(*result);
    ...
    template <typename T> T GetSharedMemoryAsWithSize(size_t* out_shmem_size)
    {
    ...
    template <typename T> T GetSharedMemoryAsWithOffsetAndSize(uint32_t offset, size_t* out_shmem_size)
    {
    ...
    GLES2DecoderPassthroughImpl* GetDecoder() const
    {
        return decoder_.get();
    }
    ...
    SharedImageRepresentationFactory* GetSharedImageRepresentationFactory() const
    {
    ...
    const base::circular_deque<GLES2DecoderPassthroughImpl::PendingReadPixels>& GetPendingReadPixels() const
    {
...
protected:
    ...
    void DoBufferData(GLenum target, GLsizei size, const void* data, GLenum usage);
    void DoBufferSubData(GLenum target, GLint offset, GLsizeiptr size, const void* data);
    ...
    void DoFramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture_client_id, GLint level);
