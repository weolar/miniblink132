...
GPU_GLES2_EXPORT gl::GLContextAttribs GenerateGLContextAttribsForDecoder(const ContextCreationAttribs& attribs_helper, const ContextGroup* context_group);

GPU_GLES2_EXPORT gl::GLContextAttribs GenerateGLContextAttribsForCompositor(bool use_passthrough_cmd_decoder);

// Returns true if the passthrough command decoder has been requested
GPU_GLES2_EXPORT bool UsePassthroughCommandDecoder(const base::CommandLine* command_line);
...
GPU_GLES2_EXPORT GpuPreferences ParseGpuPreferences(const base::CommandLine* command_line);
...
GPU_GLES2_EXPORT GrContextType ParseGrContextType(const base::CommandLine* command_line);
