...
public:
    ...
    virtual bool IsImageSupported(const cc::ImageHeaderMetadata* image_metadata) const = 0;

    virtual bool IsJpegDecodeAccelerationSupported() const = 0;

    virtual bool IsWebPDecodeAccelerationSupported() const = 0;

    virtual SyncToken ScheduleImageDecode(base::span<const uint8_t> encoded_data, const gfx::Size& output_size,
