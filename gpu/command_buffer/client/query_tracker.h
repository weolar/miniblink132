...
public:
    ...
    virtual void IssueBeginQuery(GLenum target, GLuint id, uint32_t sync_data_shm_id, uint32_t sync_data_shm_offset) = 0;
    virtual void IssueEndQuery(GLenum target, GLuint submit_count) = 0;
    virtual void IssueQueryCounter(GLuint id, GLenum target, uint32_t sync_data_shm_id, uint32_t sync_data_shm_offset, GLuint submit_count) = 0;
    virtual void IssueSetDisjointValueSync(uint32_t sync_data_shm_id, uint32_t sync_data_shm_offset) = 0;
...
public:
    ...
    public:
        ...
        base::subtle::Atomic32 submit_count() const
        {
            return info_.submit_count;
        }
        ...
        // flushed.
        bool CheckResultsAvailable(CommandBufferHelper* helper, bool flush_if_pending);
