...
virtual void ClearBufferfi(GLenum buffer, GLint drawbuffers, GLfloat depth, GLint stencil) = 0;
virtual void ClearBufferfv(GLenum buffer, GLint drawbuffers, const GLfloat* value) = 0;
virtual void ClearBufferiv(GLenum buffer, GLint drawbuffers, const GLint* value) = 0;
virtual void ClearBufferuiv(GLenum buffer, GLint drawbuffers, const GLuint* value) = 0;
...
virtual void CompressedTexSubImage2D(
    ...
    = 0;
virtual void CompressedTexImage3D(
    ...
    = 0;
virtual void CompressedTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth,
...
virtual void DrawRangeElements(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void* indices) = 0;
...
virtual void GetActiveUniformBlockiv(GLuint program, GLuint index, GLenum pname, GLint* params) = 0;
virtual void GetActiveUniformBlockName(GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, char* name) = 0;
virtual void GetActiveUniformsiv(GLuint program, GLsizei count, const GLuint* indices, GLenum pname, GLint* params) = 0;
...
virtual void GetInternalformativ(GLenum target, GLenum format, GLenum pname, GLsizei bufSize, GLint* params) = 0;
...
virtual void GetTransformFeedbackVarying(GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLsizei* size, GLenum* type, char* name) = 0;
...
virtual void GetUniformIndices(GLuint program, GLsizei count, const char* const* names, GLuint* indices) = 0;
...
virtual void InvalidateFramebuffer(GLenum target, GLsizei count, const GLenum* attachments) = 0;
virtual void InvalidateSubFramebuffer(GLenum target, GLsizei count, const GLenum* attachments, GLint x, GLint y, GLsizei width, GLsizei height) = 0;
...
virtual void SamplerParameterfv(GLuint sampler, GLenum pname, const GLfloat* params) = 0;
virtual void SamplerParameteri(GLuint sampler, GLenum pname, GLint param) = 0;
virtual void SamplerParameteriv(GLuint sampler, GLenum pname, const GLint* params) = 0;
...
virtual void ShaderSource(GLuint shader, GLsizei count, const GLchar* const* str, const GLint* length) = 0;
virtual void ShallowFinishCHROMIUM() = 0;
virtual void OrderingBarrierCHROMIUM() = 0;
virtual void MultiDrawArraysWEBGL(GLenum mode, const GLint* firsts, const GLsizei* counts, GLsizei drawcount) = 0;
virtual void MultiDrawArraysInstancedWEBGL(GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instance_counts, GLsizei drawcount) = 0;
virtual void MultiDrawArraysInstancedBaseInstanceWEBGL(
    ...
    = 0;
virtual void MultiDrawElementsWEBGL(GLenum mode, const GLsizei* counts, GLenum type, const GLsizei* offsets, GLsizei drawcount) = 0;
virtual void MultiDrawElementsInstancedWEBGL(
    GLenum mode, const GLsizei* counts, GLenum type, const GLsizei* offsets, const GLsizei* instance_counts, GLsizei drawcount)
    = 0;
virtual void MultiDrawElementsInstancedBaseVertexBaseInstanceWEBGL(GLenum mode, const GLsizei* counts, GLenum type, const GLsizei* offsets,
...
virtual void TexImage2D(
    ...
    = 0;
virtual void TexImage3D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format,
...
virtual void TexSubImage2D(
    ...
    = 0;
virtual void TexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format,
    GLenum type, const void* pixels)
    = 0;
virtual void TransformFeedbackVaryings(GLuint program, GLsizei count, const char* const* varyings, GLenum buffermode) = 0;
...
virtual void Uniform4ui(GLint location, GLuint x, GLuint y, GLuint z, GLuint w) = 0;
virtual void Uniform4uiv(GLint location, GLsizei count, const GLuint* v) = 0;
virtual void UniformBlockBinding(GLuint program, GLuint index, GLuint binding) = 0;
...
virtual void VertexAttribI4i(GLuint indx, GLint x, GLint y, GLint z, GLint w) = 0;
virtual void VertexAttribI4iv(GLuint indx, const GLint* values) = 0;
virtual void VertexAttribI4ui(GLuint indx, GLuint x, GLuint y, GLuint z, GLuint w) = 0;
virtual void VertexAttribI4uiv(GLuint indx, const GLuint* values) = 0;
virtual void VertexAttribIPointer(GLuint indx, GLint size, GLenum type, GLsizei stride, const void* ptr) = 0;
...
virtual void BlitFramebufferCHROMIUM(
    ...
    = 0;
virtual void RenderbufferStorageMultisampleCHROMIUM(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) = 0;
virtual void RenderbufferStorageMultisampleAdvancedAMD(
    GLenum target, GLsizei samples, GLsizei storageSamples, GLenum internalformat, GLsizei width, GLsizei height)
    = 0;
virtual void RenderbufferStorageMultisampleEXT(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) = 0;
virtual void FramebufferTexture2DMultisampleEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples) = 0;
virtual void TexStorage2DEXT(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height) = 0;
...
virtual void GetQueryObjecti64vEXT(GLuint id, GLenum pname, GLint64* params) = 0;
virtual void GetQueryObjectui64vEXT(GLuint id, GLenum pname, GLuint64* params) = 0;
...
virtual void FramebufferParameteri(GLenum target, GLenum pname, GLint param) = 0;
...
virtual void DrawElementsIndirect(GLenum mode, GLenum type, const void* offset) = 0;
virtual void GetProgramInterfaceiv(GLuint program, GLenum program_interface, GLenum pname, GLint* params) = 0;
virtual GLuint GetProgramResourceIndex(GLuint program, GLenum program_interface, const char* name) = 0;
virtual void GetProgramResourceName(GLuint program, GLenum program_interface, GLuint index, GLsizei bufsize, GLsizei* length, char* name) = 0;
virtual void GetProgramResourceiv(
    ...
    = 0;
virtual GLint GetProgramResourceLocation(GLuint program, GLenum program_interface, const char* name) = 0;
...
virtual GLuint GetMaxValueInBufferCHROMIUM(GLuint buffer_id, GLsizei count, GLenum type, GLuint offset) = 0;
...
virtual void* MapBufferSubDataCHROMIUM(GLuint target, GLintptr offset, GLsizeiptr size, GLenum access) = 0;
virtual void UnmapBufferSubDataCHROMIUM(const void* mem) = 0;
virtual void* MapBufferRange(GLenum target, GLintptr offset, GLsizeiptr size, GLbitfield access) = 0;
virtual GLboolean UnmapBuffer(GLenum target) = 0;
virtual void FlushMappedBufferRange(GLenum target, GLintptr offset, GLsizeiptr size) = 0;
...
virtual void ResizeCHROMIUM(GLuint width, GLuint height, GLfloat scale_factor, GLcolorSpace color_space, GLboolean alpha) = 0;
virtual const GLchar* GetRequestableExtensionsCHROMIUM() = 0;
virtual void RequestExtensionCHROMIUM(const char* extension) = 0;
virtual void GetProgramInfoCHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) = 0;
virtual void GetUniformBlocksCHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) = 0;
virtual void GetTransformFeedbackVaryingsCHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) = 0;
virtual void GetUniformsES3CHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) = 0;
virtual void DescheduleUntilFinishedCHROMIUM() = 0;
virtual void GetTranslatedShaderSourceANGLE(GLuint shader, GLsizei bufsize, GLsizei* length, char* source) = 0;
virtual void CopyTextureCHROMIUM(GLuint source_id, GLint source_level, GLenum dest_target, GLuint dest_id, GLint dest_level, GLint internalformat,
    GLenum dest_type, GLboolean unpack_flip_y, GLboolean unpack_premultiply_alpha, GLboolean unpack_unmultiply_alpha)
    = 0;
virtual void CopySubTextureCHROMIUM(GLuint source_id, GLint source_level, GLenum dest_target, GLuint dest_id, GLint dest_level, GLint xoffset, GLint yoffset,
    ...
    = 0;
virtual void DrawArraysInstancedANGLE(GLenum mode, GLint first, GLsizei count, GLsizei primcount) = 0;
virtual void DrawArraysInstancedBaseInstanceANGLE(GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance) = 0;
virtual void DrawElementsInstancedANGLE(GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei primcount) = 0;
...
virtual void BindUniformLocationCHROMIUM(GLuint program, GLint location, const char* name) = 0;
virtual void TraceBeginCHROMIUM(const char* category_name, const char* trace_name) = 0;
virtual void TraceEndCHROMIUM() = 0;
virtual void DiscardFramebufferEXT(GLenum target, GLsizei count, const GLenum* attachments) = 0;
...
virtual void BindFragDataLocationIndexedEXT(GLuint program, GLuint colorNumber, GLuint index, const char* name) = 0;
virtual void BindFragDataLocationEXT(GLuint program, GLuint colorNumber, const char* name) = 0;
...
virtual void WindowRectanglesEXT(GLenum mode, GLsizei count, const GLint* box) = 0;
...
virtual void FramebufferTextureMultiviewOVR(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews) = 0;
virtual void MaxShaderCompilerThreadsKHR(GLuint count) = 0;
virtual GLuint CreateAndTexStorage2DSharedImageCHROMIUM(const GLbyte* mailbox) = 0;
virtual void BeginSharedImageAccessDirectCHROMIUM(GLuint texture, GLenum mode) = 0;
virtual void EndSharedImageAccessDirectCHROMIUM(GLuint texture) = 0;
virtual void CopySharedImageINTERNAL(GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height, const GLbyte* mailboxes) = 0;
virtual void CopySharedImageToTextureINTERNAL(GLuint texture, GLenum target, GLuint internal_format, GLenum type, GLint src_x, GLint src_y, GLsizei width,
    GLsizei height, GLboolean flip_y, const GLbyte* src_mailbox)
    = 0;
virtual GLboolean ReadbackARGBImagePixelsINTERNAL(const GLbyte* mailbox, const void* dst_color_space, GLuint dst_color_space_size, GLuint dst_size,
    ...
    void* pixels)
    = 0;
virtual void WritePixelsYUVINTERNAL(const GLbyte* mailbox, GLuint src_size_plane1, GLuint src_size_plane2, GLuint src_size_plane3, GLuint src_size_plane4,
    GLuint src_width, GLuint src_height, GLuint src_plane_config, GLuint src_subsampling, GLuint src_datatype, GLuint src_row_bytes_plane1,
    GLuint src_row_bytes_plane2, GLuint src_row_bytes_plane3, GLuint src_row_bytes_plane4, const void* src_pixels_plane1, const void* src_pixels_plane2,
...
virtual void BlendEquationSeparateiOES(GLuint buf, GLenum modeRGB, GLenum modeAlpha) = 0;
virtual void BlendFunciOES(GLuint buf, GLenum src, GLenum dst) = 0;
virtual void BlendFuncSeparateiOES(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha) = 0;
virtual void ColorMaskiOES(GLuint buf, GLboolean r, GLboolean g, GLboolean b, GLboolean a) = 0;
virtual GLboolean IsEnablediOES(GLenum target, GLuint index) = 0;
virtual void ProvokingVertexANGLE(GLenum provokeMode) = 0;
virtual void FramebufferMemorylessPixelLocalStorageANGLE(GLint plane, GLenum internalformat) = 0;
virtual void FramebufferTexturePixelLocalStorageANGLE(GLint plane, GLuint backingtexture, GLint level, GLint layer) = 0;
virtual void FramebufferPixelLocalClearValuefvANGLE(GLint plane, const GLfloat* value) = 0;
virtual void FramebufferPixelLocalClearValueivANGLE(GLint plane, const GLint* value) = 0;
virtual void FramebufferPixelLocalClearValueuivANGLE(GLint plane, const GLuint* value) = 0;
virtual void BeginPixelLocalStorageANGLE(GLsizei count, const GLenum* loadops) = 0;
virtual void EndPixelLocalStorageANGLE(GLsizei count, const GLenum* storeops) = 0;
...
virtual void GetFramebufferPixelLocalStorageParameterfvANGLE(GLint plane, GLenum pname, GLfloat* params) = 0;
virtual void GetFramebufferPixelLocalStorageParameterivANGLE(GLint plane, GLenum pname, GLint* params) = 0;
virtual void ClipControlEXT(GLenum origin, GLenum depth) = 0;
virtual void PolygonModeANGLE(GLenum face, GLenum mode) = 0;
virtual void PolygonOffsetClampEXT(GLfloat factor, GLfloat units, GLfloat clamp) = 0;
