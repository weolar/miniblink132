...
void GLES2TraceImplementation::GenUnverifiedSyncTokenCHROMIUM(GLbyte* sync_token)
{
    gl_->GenUnverifiedSyncTokenCHROMIUM(sync_token);
}
void GLES2TraceImplementation::VerifySyncTokensCHROMIUM(GLbyte** sync_tokens, GLsizei count)
{
