...
public:
    ...
    ClientDiscardableTextureManager(const ClientDiscardableTextureManager&) = delete;
    ClientDiscardableTextureManager& operator=(const ClientDiscardableTextureManager&) = delete;

    ~ClientDiscardableTextureManager();
    ClientDiscardableHandle InitializeTexture(CommandBuffer* command_buffer, uint32_t texture_id);
