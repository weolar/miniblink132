...
void ClearBufferfi(GLenum buffer, GLint drawbuffers, GLfloat depth, GLint stencil) override;

void ClearBufferfv(GLenum buffer, GLint drawbuffers, const GLfloat* value) override;

void ClearBufferiv(GLenum buffer, GLint drawbuffers, const GLint* value) override;

void ClearBufferuiv(GLenum buffer, GLint drawbuffers, const GLuint* value) override;
...
void CompressedTexImage3D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize,
...
void DrawRangeElements(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void* indices) override;
...
void GetActiveUniformBlockiv(GLuint program, GLuint index, GLenum pname, GLint* params) override;

void GetActiveUniformBlockName(GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, char* name) override;

void GetActiveUniformsiv(GLuint program, GLsizei count, const GLuint* indices, GLenum pname, GLint* params) override;
...
void GetInternalformativ(GLenum target, GLenum format, GLenum pname, GLsizei bufSize, GLint* params) override;
...
void GetTransformFeedbackVarying(GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLsizei* size, GLenum* type, char* name) override;
...
void GetUniformIndices(GLuint program, GLsizei count, const char* const* names, GLuint* indices) override;
...
void InvalidateFramebuffer(GLenum target, GLsizei count, const GLenum* attachments) override;

void InvalidateSubFramebuffer(GLenum target, GLsizei count, const GLenum* attachments, GLint x, GLint y, GLsizei width, GLsizei height) override;
...
void SamplerParameterfv(GLuint sampler, GLenum pname, const GLfloat* params) override;

void SamplerParameteri(GLuint sampler, GLenum pname, GLint param) override;

void SamplerParameteriv(GLuint sampler, GLenum pname, const GLint* params) override;
...
void ShaderSource(GLuint shader, GLsizei count, const GLchar* const* str, const GLint* length) override;

void ShallowFinishCHROMIUM() override;

void OrderingBarrierCHROMIUM() override;

void MultiDrawArraysWEBGL(GLenum mode, const GLint* firsts, const GLsizei* counts, GLsizei drawcount) override;

void MultiDrawArraysInstancedWEBGL(GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instance_counts, GLsizei drawcount) override;

void MultiDrawArraysInstancedBaseInstanceWEBGL(
    GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instance_counts, const GLuint* baseinstances, GLsizei drawcount) override;

void MultiDrawElementsWEBGL(GLenum mode, const GLsizei* counts, GLenum type, const GLsizei* offsets, GLsizei drawcount) override;

void MultiDrawElementsInstancedWEBGL(
    GLenum mode, const GLsizei* counts, GLenum type, const GLsizei* offsets, const GLsizei* instance_counts, GLsizei drawcount) override;

void MultiDrawElementsInstancedBaseVertexBaseInstanceWEBGL(GLenum mode, const GLsizei* counts, GLenum type, const GLsizei* offsets,
    const GLsizei* instance_counts, const GLint* basevertices, const GLuint* baseinstances, GLsizei drawcount) override;
...
void TexImage3D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type,
...
void TransformFeedbackVaryings(GLuint program, GLsizei count, const char* const* varyings, GLenum buffermode) override;
...
void Uniform4ui(GLint location, GLuint x, GLuint y, GLuint z, GLuint w) override;
...
void VertexAttribI4ui(GLuint indx, GLuint x, GLuint y, GLuint z, GLuint w) override;

void VertexAttribI4uiv(GLuint indx, const GLuint* values) override;

void VertexAttribIPointer(GLuint indx, GLint size, GLenum type, GLsizei stride, const void* ptr) override;
...
void RenderbufferStorageMultisampleCHROMIUM(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) override;
...
void RenderbufferStorageMultisampleEXT(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height) override;

void FramebufferTexture2DMultisampleEXT(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLsizei samples) override;

void TexStorage2DEXT(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height) override;
...
void BindImageTexture(GLuint unit, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLenum format) override;

void DispatchCompute(GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z) override;

void DispatchComputeIndirect(GLintptr offset) override;

void DrawArraysIndirect(GLenum mode, const void* offset) override;

void DrawElementsIndirect(GLenum mode, GLenum type, const void* offset) override;

void GetProgramInterfaceiv(GLuint program, GLenum program_interface, GLenum pname, GLint* params) override;

GLuint GetProgramResourceIndex(GLuint program, GLenum program_interface, const char* name) override;

void GetProgramResourceName(GLuint program, GLenum program_interface, GLuint index, GLsizei bufsize, GLsizei* length, char* name) override;

void GetProgramResourceiv(
    GLuint program, GLenum program_interface, GLuint index, GLsizei prop_count, const GLenum* props, GLsizei bufsize, GLsizei* length, GLint* params) override;

GLint GetProgramResourceLocation(GLuint program, GLenum program_interface, const char* name) override;
...
GLuint GetMaxValueInBufferCHROMIUM(GLuint buffer_id, GLsizei count, GLenum type, GLuint offset) override;
...
void* MapBufferSubDataCHROMIUM(GLuint target, GLintptr offset, GLsizeiptr size, GLenum access) override;

void UnmapBufferSubDataCHROMIUM(const void* mem) override;

void* MapBufferRange(GLenum target, GLintptr offset, GLsizeiptr size, GLbitfield access) override;

GLboolean UnmapBuffer(GLenum target) override;

void FlushMappedBufferRange(GLenum target, GLintptr offset, GLsizeiptr size) override;

void* MapTexSubImage2DCHROMIUM(
    GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLenum access) override;

void UnmapTexSubImage2DCHROMIUM(const void* mem) override;

void ResizeCHROMIUM(GLuint width, GLuint height, GLfloat scale_factor, GLcolorSpace color_space, GLboolean alpha) override;

const GLchar* GetRequestableExtensionsCHROMIUM() override;

void RequestExtensionCHROMIUM(const char* extension) override;

void GetProgramInfoCHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) override;

void GetUniformBlocksCHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) override;

void GetTransformFeedbackVaryingsCHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) override;

void GetUniformsES3CHROMIUM(GLuint program, GLsizei bufsize, GLsizei* size, void* info) override;

void DescheduleUntilFinishedCHROMIUM() override;

void GetTranslatedShaderSourceANGLE(GLuint shader, GLsizei bufsize, GLsizei* length, char* source) override;
...
void CopyTextureCHROMIUM(GLuint source_id, GLint source_level, GLenum dest_target, GLuint dest_id, GLint dest_level, GLint internalformat, GLenum dest_type,
    GLboolean unpack_flip_y, GLboolean unpack_premultiply_alpha, GLboolean unpack_unmultiply_alpha) override;
...
void CopySubTextureCHROMIUM(GLuint source_id, GLint source_level, GLenum dest_target, GLuint dest_id, GLint dest_level, GLint xoffset, GLint yoffset, GLint x,
    GLint y, GLsizei width, GLsizei height, GLboolean unpack_flip_y, GLboolean unpack_premultiply_alpha, GLboolean unpack_unmultiply_alpha) override;

void DrawArraysInstancedANGLE(GLenum mode, GLint first, GLsizei count, GLsizei primcount) override;

void DrawArraysInstancedBaseInstanceANGLE(GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance) override;

void DrawElementsInstancedANGLE(GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei primcount) override;
...
void BindUniformLocationCHROMIUM(GLuint program, GLint location, const char* name) override;

void TraceBeginCHROMIUM(const char* category_name, const char* trace_name) override;

void TraceEndCHROMIUM() override;

void DiscardFramebufferEXT(GLenum target, GLsizei count, const GLenum* attachments) override;
...
void BindFragDataLocationIndexedEXT(GLuint program, GLuint colorNumber, GLuint index, const char* name) override;

void BindFragDataLocationEXT(GLuint program, GLuint colorNumber, const char* name) override;
...
void FramebufferTextureMultiviewOVR(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews) override;
...
void CopySharedImageINTERNAL(GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height, const GLbyte* mailboxes) override;

void CopySharedImageToTextureINTERNAL(GLuint texture, GLenum target, GLuint internal_format, GLenum type, GLint src_x, GLint src_y, GLsizei width,
    GLsizei height, GLboolean flip_y, const GLbyte* src_mailbox) override;

GLboolean ReadbackARGBImagePixelsINTERNAL(const GLbyte* mailbox, const void* dst_color_space, GLuint dst_color_space_size, GLuint dst_size, GLuint dst_width,
    GLuint dst_height, GLuint dst_color_type, GLuint dst_alpha_type, GLuint dst_row_bytes, GLint src_x, GLint src_y, GLint plane_index, void* pixels) override;

void WritePixelsYUVINTERNAL(const GLbyte* mailbox, GLuint src_size_plane1, GLuint src_size_plane2, GLuint src_size_plane3, GLuint src_size_plane4,
    ...
    const void* src_pixels_plane3, const void* src_pixels_plane4) override;
...
void BlendEquationSeparateiOES(GLuint buf, GLenum modeRGB, GLenum modeAlpha) override;

void BlendFunciOES(GLuint buf, GLenum src, GLenum dst) override;

void BlendFuncSeparateiOES(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha) override;

void ColorMaskiOES(GLuint buf, GLboolean r, GLboolean g, GLboolean b, GLboolean a) override;

GLboolean IsEnablediOES(GLenum target, GLuint index) override;

void ProvokingVertexANGLE(GLenum provokeMode) override;

void FramebufferMemorylessPixelLocalStorageANGLE(GLint plane, GLenum internalformat) override;

void FramebufferTexturePixelLocalStorageANGLE(GLint plane, GLuint backingtexture, GLint level, GLint layer) override;

void FramebufferPixelLocalClearValuefvANGLE(GLint plane, const GLfloat* value) override;

void FramebufferPixelLocalClearValueivANGLE(GLint plane, const GLint* value) override;

void FramebufferPixelLocalClearValueuivANGLE(GLint plane, const GLuint* value) override;
...
void GetFramebufferPixelLocalStorageParameterfvANGLE(GLint plane, GLenum pname, GLfloat* params) override;

void GetFramebufferPixelLocalStorageParameterivANGLE(GLint plane, GLenum pname, GLint* params) override;

void ClipControlEXT(GLenum origin, GLenum depth) override;

void PolygonModeANGLE(GLenum face, GLenum mode) override;

void PolygonOffsetClampEXT(GLfloat factor, GLfloat units, GLfloat clamp) override;
