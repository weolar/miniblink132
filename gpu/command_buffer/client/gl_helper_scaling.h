...
public:
    ...
    std::unique_ptr<GLHelper::ScalerInterface> CreateGrayscalePlanerizer(bool flipped_source, bool flip_output, bool swizzle);
    std::unique_ptr<GLHelper::ScalerInterface> CreateI420Planerizer(int plane, // 0=Y, 1=U, 2=V
        bool flipped_source, bool flip_output, bool swizzle);
    ...
    std::unique_ptr<GLHelper::ScalerInterface> CreateI420MrtPass1Planerizer(bool flipped_source, bool flip_output, bool swizzle);
    std::unique_ptr<GLHelper::ScalerInterface> CreateI420MrtPass2Planerizer(bool swizzle);
...
private:
    ...
    struct ScaleOp {
        ...
        static void AddOps(int src, int dst, bool scale_x, bool allow3, base::circular_deque<ScaleOp>* ops)
        {
    ...
    static void ComputeScalerStages(GLHelper::ScalerQuality quality, const gfx::Vector2d& scale_from, const gfx::Vector2d& scale_to, bool flipped_source,
    ...
    // ComputeScalerStages.
    static void ConvertScalerOpsToScalerStages(GLHelper::ScalerQuality quality, gfx::Vector2d scale_from, base::circular_deque<GLHelperScaling::ScaleOp>* x_ops,
        base::circular_deque<GLHelperScaling::ScaleOp>* y_ops, std::vector<ScalerStage>* scaler_stages);
