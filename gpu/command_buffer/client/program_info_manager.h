...
public:
    ...
    bool GetProgramiv(GLES2Implementation* gl, GLuint program, GLenum pname, GLint* params);

    GLint GetAttribLocation(GLES2Implementation* gl, GLuint program, const char* name);

    GLint GetUniformLocation(GLES2Implementation* gl, GLuint program, const char* name);

    GLint GetFragDataIndex(GLES2Implementation* gl, GLuint program, const char* name);

    GLint GetFragDataLocation(GLES2Implementation* gl, GLuint program, const char* name);

    bool GetActiveAttrib(GLES2Implementation* gl, GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLint* size, GLenum* type, char* name);

    bool GetActiveUniform(GLES2Implementation* gl, GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLint* size, GLenum* type, char* name);

    GLuint GetUniformBlockIndex(GLES2Implementation* gl, GLuint program, const char* name);

    bool GetActiveUniformBlockName(GLES2Implementation* gl, GLuint program, GLuint index, GLsizei buf_size, GLsizei* length, char* name);

    bool GetActiveUniformBlockiv(GLES2Implementation* gl, GLuint program, GLuint index, GLenum pname, GLint* params);
    ...
    void UniformBlockBinding(GLES2Implementation* gl, GLuint program, GLuint index, GLuint binding);
    ...
    bool GetUniformIndices(GLES2Implementation* gl, GLuint program, GLsizei count, const char* const* names, GLuint* indices);

    bool GetActiveUniformsiv(GLES2Implementation* gl, GLuint program, GLsizei count, const GLuint* indices, GLenum pname, GLint* params);

    bool GetProgramInterfaceiv(GLES2Implementation* gl, GLuint program, GLenum program_interface, GLenum pname, GLint* params);

    GLuint GetProgramResourceIndex(GLES2Implementation* gl, GLuint program, GLenum program_interface, const char* name);

    bool GetProgramResourceName(GLES2Implementation* gl, GLuint program, GLenum program_interface, GLuint index, GLsizei bufsize, GLsizei* length, char* name);

    bool GetProgramResourceiv(GLES2Implementation* gl, GLuint program, GLenum program_interface, GLuint index, GLsizei prop_count, const GLenum* props,
        GLsizei bufsize, GLsizei* length, GLint* params);

    GLint GetProgramResourceLocation(GLES2Implementation* gl, GLuint program, GLenum program_interface, const char* name);
    ...
    void UpdateProgramInfo(GLuint program, base::span<const int8_t> result, ProgramInfoType type);
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(ProgramInfoManagerTest, UpdateES3TransformFeedbackVaryings);
    FRIEND_TEST_ALL_PREFIXES(ProgramInfoManagerTest, GetActiveUniformsivCached);
    ...
    public:
        ...
        bool GetUniformsiv(GLsizei count, const GLuint* indices, GLenum pname, GLint* params);
        ...
        const TransformFeedbackVarying* GetTransformFeedbackVarying(GLuint index) const;
    ...
    Program* GetProgramInfo(GLES2Implementation* gl, GLuint program, ProgramInfoType type) EXCLUSIVE_LOCKS_REQUIRED(lock_);
