...
void WebGPUInterfaceStub::VerifySyncTokensCHROMIUM(GLbyte** sync_tokens, GLsizei count)
{
}
...
ReservedTexture WebGPUInterfaceStub::ReserveTexture(WGPUDevice, const WGPUTextureDescriptor*)
{
    return { nullptr, 0, 0, 0, 0 };
}

ReservedBuffer WebGPUInterfaceStub::ReserveBuffer(WGPUDevice device, const WGPUBufferDescriptor*)
{
    return { nullptr, 0, 0, 0, 0 };
}
...
void WebGPUInterfaceStub::AssociateMailbox(GLuint device_id, GLuint device_generation, GLuint id, GLuint generation, uint64_t usage, uint64_t internal_usage,
    const WGPUTextureFormat* view_formats, GLuint view_format_count, MailboxFlags flags, const Mailbox& mailbox)
{
}

void WebGPUInterfaceStub::AssociateMailboxForBuffer(
    GLuint device_id, GLuint device_generation, GLuint id, GLuint generation, uint64_t usage, const Mailbox& mailbox)
{
}
