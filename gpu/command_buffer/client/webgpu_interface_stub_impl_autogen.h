...
void WebGPUInterfaceStub::DissociateMailbox(GLuint /* texture_id */, GLuint /* texture_generation */)
{
}
void WebGPUInterfaceStub::DissociateMailboxForBuffer(GLuint /* buffer_id */, GLuint /* buffer_generation */)
{
}
void WebGPUInterfaceStub::DissociateMailboxForPresent(
    GLuint /* device_id */, GLuint /* device_generation */, GLuint /* texture_id */, GLuint /* texture_generation */)
{
}
void WebGPUInterfaceStub::SetWebGPUExecutionContextToken(
    uint32_t /* type */, uint32_t /* high_high */, uint32_t /* high_low */, uint32_t /* low_high */, uint32_t /* low_low */)
{
}
