...
namespace raster {
class RASTER_EXPORT ClientFontManager : public SkStrikeServer::DiscardableHandleManager {
public:
...
private:
    ...
    base::flat_map<SkDiscardableHandleId, ClientDiscardableHandle::Id> discardable_handle_map_;
