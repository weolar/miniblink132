...
static_assert(sizeof(DawnReturnDataHeader) % GPU_DAWN_RETURN_DATA_ALIGNMENT == 0, "DawnReturnDataHeader must align to GPU_DAWN_RETURN_DATA_ALIGNMENT");

struct DawnReturnCommandsInfoHeader {
    DawnReturnDataHeader return_data_header = { DawnReturnDataType::kDawnCommands };
};

static_assert(offsetof(DawnReturnCommandsInfoHeader, return_data_header) == 0, "The offset of return_data_header must be 0");
...
static_assert(offsetof(DawnReturnCommandsInfo, header) == 0, "The offset of header must be 0");
