...
TEST_F(WebGPUFormatTest, DawnCommands)
{
    ...
    void* next_cmd
        = cmd.Set(&cmd, static_cast<uint32_t>(11), static_cast<uint32_t>(12), static_cast<uint32_t>(13), static_cast<uint32_t>(14), static_cast<uint32_t>(15));
    EXPECT_EQ(static_cast<uint32_t>(cmds::DawnCommands::kCmdId), cmd.header.command);
...
TEST_F(WebGPUFormatTest, AssociateMailboxImmediate)
{
    ...
    cmds::AssociateMailboxImmediate& cmd = *GetBufferAs<cmds::AssociateMailboxImmediate>();
    const GLsizei kNumElements = 9;
    const size_t kExpectedCmdSize = sizeof(cmd) + kNumElements * sizeof(GLuint) * 1;
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(1), static_cast<GLuint>(2), static_cast<GLuint>(3), static_cast<GLuint>(4), static_cast<uint64_t>(5),
        static_cast<uint64_t>(6), static_cast<MailboxFlags>(7), static_cast<GLuint>(8), static_cast<GLuint>(9), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::AssociateMailboxImmediate::kCmdId), cmd.header.command);
...
TEST_F(WebGPUFormatTest, AssociateMailboxForBufferImmediate)
{
    ...
    cmds::AssociateMailboxForBufferImmediate& cmd = *GetBufferAs<cmds::AssociateMailboxForBufferImmediate>();
    void* next_cmd
        = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12), static_cast<GLuint>(13), static_cast<GLuint>(14), static_cast<uint64_t>(15), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::AssociateMailboxForBufferImmediate::kCmdId), cmd.header.command);
...
TEST_F(WebGPUFormatTest, DissociateMailbox)
{
    ...
    EXPECT_EQ(static_cast<uint32_t>(cmds::DissociateMailbox::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
...
{
    cmds::DissociateMailboxForBuffer& cmd = *GetBufferAs<cmds::DissociateMailboxForBuffer>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12));
    EXPECT_EQ(static_cast<uint32_t>(cmds::DissociateMailboxForBuffer::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
...
{
    cmds::DissociateMailboxForPresent& cmd = *GetBufferAs<cmds::DissociateMailboxForPresent>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12), static_cast<GLuint>(13), static_cast<GLuint>(14));
    EXPECT_EQ(static_cast<uint32_t>(cmds::DissociateMailboxForPresent::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
    EXPECT_EQ(static_cast<GLuint>(11), cmd.device_id);
    EXPECT_EQ(static_cast<GLuint>(12), cmd.device_generation);
...
{
    cmds::SetWebGPUExecutionContextToken& cmd = *GetBufferAs<cmds::SetWebGPUExecutionContextToken>();
    void* next_cmd
        = cmd.Set(&cmd, static_cast<uint32_t>(11), static_cast<uint32_t>(12), static_cast<uint32_t>(13), static_cast<uint32_t>(14), static_cast<uint32_t>(15));
    EXPECT_EQ(static_cast<uint32_t>(cmds::SetWebGPUExecutionContextToken::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
