...
struct SerializableSkiaHandle {
    ...
    SerializableSkiaHandle(uint32_t handle_id, uint32_t shm_id, uint32_t byte_offset)
        : handle_id(handle_id)
        , shm_id(shm_id)
...
protected:
    DiscardableHandleBase(scoped_refptr<Buffer> buffer, uint32_t byte_offset, int32_t shm_id);
...
public:
    ...
    ClientDiscardableHandle(scoped_refptr<Buffer> buffer, uint32_t byte_offset, int32_t shm_id);
...
public:
    ...
    ServiceDiscardableHandle(scoped_refptr<Buffer> buffer, uint32_t byte_offset, int32_t shm_id);
