...
TEST_F(RasterFormatTest, BeginRasterCHROMIUMImmediate)
{
    ...
    cmds::BeginRasterCHROMIUMImmediate& cmd = *GetBufferAs<cmds::BeginRasterCHROMIUMImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLfloat>(11), static_cast<GLfloat>(12), static_cast<GLfloat>(13), static_cast<GLfloat>(14),
        static_cast<GLboolean>(15), static_cast<GLuint>(16), static_cast<gpu::raster::MsaaMode>(17), static_cast<GLboolean>(18), static_cast<GLboolean>(19),
        static_cast<GLfloat>(20), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::BeginRasterCHROMIUMImmediate::kCmdId), cmd.header.command);
...
TEST_F(RasterFormatTest, RasterCHROMIUM)
{
    ...
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12), static_cast<GLsizeiptr>(13), static_cast<GLuint>(14),
        static_cast<GLuint>(15), static_cast<GLsizeiptr>(16));
    EXPECT_EQ(static_cast<uint32_t>(cmds::RasterCHROMIUM::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
...
TEST_F(RasterFormatTest, EndRasterCHROMIUM)
{
    ...
    void* next_cmd = cmd.Set(&cmd);
    EXPECT_EQ(static_cast<uint32_t>(cmds::EndRasterCHROMIUM::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
    CheckBytesWrittenMatchesExpectedSize(next_cmd, sizeof(cmd));
}
...
{
    cmds::CreateTransferCacheEntryINTERNAL& cmd = *GetBufferAs<cmds::CreateTransferCacheEntryINTERNAL>();
    ...
    EXPECT_EQ(static_cast<uint32_t>(cmds::CreateTransferCacheEntryINTERNAL::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
...
{
    cmds::DeleteTransferCacheEntryINTERNAL& cmd = *GetBufferAs<cmds::DeleteTransferCacheEntryINTERNAL>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12));
    EXPECT_EQ(static_cast<uint32_t>(cmds::DeleteTransferCacheEntryINTERNAL::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
    EXPECT_EQ(static_cast<GLuint>(11), cmd.entry_type);
    EXPECT_EQ(static_cast<GLuint>(12), cmd.entry_id);
    CheckBytesWrittenMatchesExpectedSize(next_cmd, sizeof(cmd));
...
{
    cmds::UnlockTransferCacheEntryINTERNAL& cmd = *GetBufferAs<cmds::UnlockTransferCacheEntryINTERNAL>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12));
    EXPECT_EQ(static_cast<uint32_t>(cmds::UnlockTransferCacheEntryINTERNAL::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
    EXPECT_EQ(static_cast<GLuint>(11), cmd.entry_type);
    EXPECT_EQ(static_cast<GLuint>(12), cmd.entry_id);
    CheckBytesWrittenMatchesExpectedSize(next_cmd, sizeof(cmd));
...
TEST_F(RasterFormatTest, DeletePaintCachePathsINTERNALImmediate)
{
    ...
    cmds::DeletePaintCachePathsINTERNALImmediate& cmd = *GetBufferAs<cmds::DeletePaintCachePathsINTERNALImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLsizei>(std::size(ids)), ids);
    EXPECT_EQ(static_cast<uint32_t>(cmds::DeletePaintCachePathsINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(cmd.n * 4u), cmd.header.size * 4u);
    EXPECT_EQ(static_cast<GLsizei>(std::size(ids)), cmd.n);
    CheckBytesWrittenMatchesExpectedSize(next_cmd, sizeof(cmd) + RoundSizeToMultipleOfEntries(std::size(ids) * 4u));
    EXPECT_EQ(0, memcmp(ids, ImmediateDataAddress(&cmd), sizeof(ids)));
...
{
    cmds::DeletePaintCachePathsINTERNAL& cmd = *GetBufferAs<cmds::DeletePaintCachePathsINTERNAL>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLsizei>(11), static_cast<uint32_t>(12), static_cast<uint32_t>(13));
    EXPECT_EQ(static_cast<uint32_t>(cmds::DeletePaintCachePathsINTERNAL::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
...
{
    cmds::ClearPaintCacheINTERNAL& cmd = *GetBufferAs<cmds::ClearPaintCacheINTERNAL>();
    void* next_cmd = cmd.Set(&cmd);
    EXPECT_EQ(static_cast<uint32_t>(cmds::ClearPaintCacheINTERNAL::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd), cmd.header.size * 4u);
    CheckBytesWrittenMatchesExpectedSize(next_cmd, sizeof(cmd));
}
...
TEST_F(RasterFormatTest, WritePixelsINTERNALImmediate)
{
    ...
    cmds::WritePixelsINTERNALImmediate& cmd = *GetBufferAs<cmds::WritePixelsINTERNALImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLint>(11), static_cast<GLint>(12), static_cast<GLuint>(13), static_cast<GLuint>(14), static_cast<GLuint>(15),
        static_cast<GLuint>(16), static_cast<GLuint>(17), static_cast<GLint>(18), static_cast<GLuint>(19), static_cast<GLuint>(20), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::WritePixelsINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(sizeof(data)), cmd.header.size * 4u);
...
TEST_F(RasterFormatTest, WritePixelsYUVINTERNALImmediate)
{
    ...
    cmds::WritePixelsYUVINTERNALImmediate& cmd = *GetBufferAs<cmds::WritePixelsYUVINTERNALImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12), static_cast<GLuint>(13), static_cast<GLuint>(14), static_cast<GLuint>(15),
        ...
        static_cast<GLuint>(22), static_cast<GLuint>(23), static_cast<GLuint>(24), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::WritePixelsYUVINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(sizeof(data)), cmd.header.size * 4u);
...
TEST_F(RasterFormatTest, ReadbackARGBImagePixelsINTERNALImmediate)
{
    ...
    cmds::ReadbackARGBImagePixelsINTERNALImmediate& cmd = *GetBufferAs<cmds::ReadbackARGBImagePixelsINTERNALImmediate>();
    ...
    EXPECT_EQ(static_cast<uint32_t>(cmds::ReadbackARGBImagePixelsINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(sizeof(data)), cmd.header.size * 4u);
...
TEST_F(RasterFormatTest, ReadbackYUVImagePixelsINTERNALImmediate)
{
    ...
    cmds::ReadbackYUVImagePixelsINTERNALImmediate& cmd = *GetBufferAs<cmds::ReadbackYUVImagePixelsINTERNALImmediate>();
    void* next_cmd = cmd.Set(&cmd, static_cast<GLuint>(11), static_cast<GLuint>(12), static_cast<GLint>(13), static_cast<GLuint>(14), static_cast<GLuint>(15),
        static_cast<GLuint>(16), static_cast<GLuint>(17), static_cast<GLuint>(18), static_cast<GLuint>(19), static_cast<GLuint>(20), data);
    EXPECT_EQ(static_cast<uint32_t>(cmds::ReadbackYUVImagePixelsINTERNALImmediate::kCmdId), cmd.header.command);
    EXPECT_EQ(sizeof(cmd) + RoundSizeToMultipleOfEntries(sizeof(data)), cmd.header.size * 4u);
