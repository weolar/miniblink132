...
TEST(ActivityFlagsTest, BasicUsage)
{
    ...
    EXPECT_FALSE(host_flags.IsFlagSet(ActivityFlagsBase::FLAG_LOADING_PROGRAM_BINARY));
    ...
    {
        GpuProcessActivityFlags::ScopedSetFlag scoped_set_flag(&service_flags, ActivityFlagsBase::FLAG_LOADING_PROGRAM_BINARY);
        EXPECT_TRUE(host_flags.IsFlagSet(ActivityFlagsBase::FLAG_LOADING_PROGRAM_BINARY));
    }
    EXPECT_FALSE(host_flags.IsFlagSet(ActivityFlagsBase::FLAG_LOADING_PROGRAM_BINARY));
}
