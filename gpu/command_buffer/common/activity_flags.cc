...
GpuProcessActivityFlags::GpuProcessActivityFlags(GpuProcessActivityFlags&& other) = default;

GpuProcessActivityFlags::GpuProcessActivityFlags(base::UnsafeSharedMemoryRegion region)
{
