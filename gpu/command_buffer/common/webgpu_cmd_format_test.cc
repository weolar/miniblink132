...
protected:
    ...
    void CheckBytesWritten(const void* end, size_t expected_size, size_t written_size)
    {
        size_t actual_size = static_cast<const unsigned char*>(end) - GetBufferAs<const unsigned char>();
    ...
    void CheckBytesWrittenMatchesExpectedSize(const void* end, size_t expected_size)
    {
