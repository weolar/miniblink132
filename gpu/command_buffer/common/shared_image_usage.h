...
public:
    ...
    constexpr SharedImageUsageSet(SharedImageUsage mask)
        : set_storage_(mask)
    {
    }
    ...
    // usage.
    explicit constexpr SharedImageUsageSet(uint32_t mask)
        : set_storage_(mask)
    {
    }

    constexpr SharedImageUsageSet(std::initializer_list<SharedImageUsage> usages)
    {
...
private:
    friend inline constexpr bool operator==(gpu::SharedImageUsageSet set_a, gpu::SharedImageUsageSet set_b);

    friend inline constexpr gpu::SharedImageUsageSet operator|(gpu::SharedImageUsageSet set_a, gpu::SharedImageUsage mask_b);
    friend inline constexpr gpu::SharedImageUsageSet operator|(gpu::SharedImageUsage mask_a, gpu::SharedImageUsageSet set_b);
    friend inline constexpr gpu::SharedImageUsageSet operator|(gpu::SharedImageUsage mask_a, gpu::SharedImageUsage mask_b);

    friend inline constexpr const SharedImageUsageSet Intersection(gpu::SharedImageUsageSet set_a, gpu::SharedImageUsageSet set_b);
    uint32_t set_storage_ = 0;
};

inline constexpr const SharedImageUsageSet Intersection(gpu::SharedImageUsageSet set_a, gpu::SharedImageUsageSet set_b)
{
...
inline constexpr gpu::SharedImageUsageSet operator|(gpu::SharedImageUsageSet set_a, gpu::SharedImageUsageSet set_b)
{
    set_a.PutAll(set_b);
    return set_a;
}

inline constexpr gpu::SharedImageUsageSet operator|(gpu::SharedImageUsageSet set_a, gpu::SharedImageUsage mask_b)
{
    set_a.PutAll(mask_b);
    return set_a;
}

inline constexpr gpu::SharedImageUsageSet operator|(gpu::SharedImageUsage mask_a, gpu::SharedImageUsageSet set_b)
{
    // Set union is order independent.
    return set_b | mask_a;
}

inline constexpr gpu::SharedImageUsageSet operator|(gpu::SharedImageUsage mask_a, gpu::SharedImageUsage mask_b)
{
    return gpu::SharedImageUsageSet(mask_a) | mask_b;
}

inline constexpr bool operator==(gpu::SharedImageUsageSet set_a, gpu::SharedImageUsageSet set_b)
{
...
GPU_EXPORT std::string CreateLabelForSharedImageUsage(SharedImageUsageSet usage);
