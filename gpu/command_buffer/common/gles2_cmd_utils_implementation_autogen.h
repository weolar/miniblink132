...
std::string GLES2Util::GetStringGLState(uint32_t value)
{
    static const EnumToString string_table[] = {
        ...
        { GL_BIND_GENERATES_RESOURCE_CHROMIUM, "GL_BIND_GENERATES_RESOURCE_CHROMIUM" },
...
std::string GLES2Util::GetStringQueryObjectParameter(uint32_t value)
{
    static const EnumToString string_table[] = {
        ...
        { GL_QUERY_RESULT_AVAILABLE_NO_FLUSH_CHROMIUM_EXT, "GL_QUERY_RESULT_AVAILABLE_NO_FLUSH_CHROMIUM_EXT" },
    };
    return GLES2Util::GetQualifiedEnumString(string_table, std::size(string_table), value);
}
...
std::string GLES2Util::GetStringQueryTarget(uint32_t value)
{
    static const EnumToString string_table[] = {
        ...
        { GL_ASYNC_PIXEL_PACK_COMPLETED_CHROMIUM, "GL_ASYNC_PIXEL_PACK_COMPLETED_CHROMIUM" },
        { GL_COMMANDS_COMPLETED_CHROMIUM, "GL_COMMANDS_COMPLETED_CHROMIUM" },
        { GL_READBACK_SHADOW_COPIES_UPDATED_CHROMIUM, "GL_READBACK_SHADOW_COPIES_UPDATED_CHROMIUM" },
        { GL_PROGRAM_COMPLETION_QUERY_CHROMIUM, "GL_PROGRAM_COMPLETION_QUERY_CHROMIUM" },
    };
    return GLES2Util::GetQualifiedEnumString(string_table, std::size(string_table), value);
}
...
std::string GLES2Util::GetStringTextureDepthRenderableInternalFormat(uint32_t value)
{
    static const EnumToString string_table[] = {
        { GL_DEPTH_COMPONENT16, "GL_DEPTH_COMPONENT16" },
        { GL_DEPTH_COMPONENT24, "GL_DEPTH_COMPONENT24" },
...
std::string GLES2Util::GetStringTextureSizedColorRenderableInternalFormat(uint32_t value)
{
    static const EnumToString string_table[] = {
        { GL_R8, "GL_R8" },
        { GL_R8UI, "GL_R8UI" },
...
std::string GLES2Util::GetStringTextureSizedTextureFilterableInternalFormat(uint32_t value)
{
    static const EnumToString string_table[] = {
        { GL_R8, "GL_R8" },
        { GL_R8_SNORM, "GL_R8_SNORM" },
...
std::string GLES2Util::GetStringTextureStencilRenderableInternalFormat(uint32_t value)
{
    static const EnumToString string_table[] = {
        { GL_STENCIL_INDEX8, "GL_STENCIL_INDEX8" },
        { GL_DEPTH24_STENCIL8, "GL_DEPTH24_STENCIL8" },
