...
{
    return usage.HasAny(SHARED_IMAGE_USAGE_GLES2_READ | SHARED_IMAGE_USAGE_GLES2_WRITE);
}
...
std::string CreateLabelForSharedImageUsage(SharedImageUsageSet usage)
{
    ...
    const std::pair<SharedImageUsage, const char*> kUsages[] = {
        ...
        { SHARED_IMAGE_USAGE_RASTER_DELEGATED_COMPOSITING, "RasterDelegatedCompositing" },
