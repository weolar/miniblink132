...
#endif
crash_reporter::CrashKeyString<4> gpu_gl_context_is_virtual("gpu-gl-context-is-virtual");
crash_reporter::CrashKeyString<20> available_physical_memory_in_mb("available-physical-memory-in-mb");
...
crash_reporter::CrashKeyString<1024> gpu_gl_error_message("gpu-gl-error-message");
crash_reporter::CrashKeyString<4> gpu_watchdog_kill_after_power_resume("gpu-watchdog-kill-after-power-resume");
crash_reporter::CrashKeyString<4> gpu_watchdog_crashed_in_gpu_init("gpu-watchdog-crashed-in-gpu-init");
...
crash_reporter::CrashKeyString<128> list_of_hung_threads("list-of-hung-threads");
