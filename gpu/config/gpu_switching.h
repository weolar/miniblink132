...
GPU_EXPORT bool SwitchableGPUsSupported(const GPUInfo& gpu_info, const base::CommandLine& command_line);
...
GPU_EXPORT void InitializeSwitchableGPUs(const std::vector<int32_t>& driver_bug_workarounds);
