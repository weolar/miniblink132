...
public:
    ...
    int32_t GetTestExpectation(const std::string& test_name, const GPUTestBotConfig& bot_config) const;
...
private:
    ...
    bool UpdateTestConfig(GPUTestConfig* config, const std::string& gpu_device_id, size_t line_number);
    ...
    void PushErrorMessage(const std::string& message, size_t entry1_line_number, size_t entry2_line_number);
