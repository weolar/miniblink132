...
const GpuControlList::Conditions kExceptionsForEntry44[2] = {
    {
        ...
        { GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr }, // os_version
        0x8086, // vendor_id
        std::size(kDevicesForGpuControlTestingEntry44Exception0), // Devices size
    ...
    },
    {
        ...
        { GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr }, // os_version
        0x8086, // vendor_id
        std::size(kDevicesForGpuControlTestingEntry44Exception1), // Devices size
...
const GpuControlList::Conditions kExceptionsForEntry65[1] = {
    {
        ...
        nullptr, // GL strings
        nullptr, // machine model info
        std::size(kIntelGpuSeriesForEntry65Exception0), // intel_gpu_series size
...
const GpuControlList::Conditions kExceptionsForEntry77[2] = {
    {
        ...
        { GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr }, // os_version
        0x1002, // vendor_id
        std::size(kDevicesForGpuControlTestingEntry77Exception0), // Devices size
    ...
    },
    {
        ...
        { GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr }, // os_version
        0x1002, // vendor_id
        std::size(kDevicesForGpuControlTestingEntry77Exception1), // Devices size
