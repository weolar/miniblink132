...
class GPU_EXPORT ImageDecodeAcceleratorProxy : public ImageDecodeAcceleratorInterface {
public:
    ...
    ImageDecodeAcceleratorProxy& operator=(const ImageDecodeAcceleratorProxy&) = delete;
    ...
    bool IsImageSupported(const cc::ImageHeaderMetadata* image_metadata) const override;
    ...
    // is created.
    SyncToken ScheduleImageDecode(base::span<const uint8_t> encoded_data, const gfx::Size& output_size, CommandBufferId raster_decoder_command_buffer_id,
