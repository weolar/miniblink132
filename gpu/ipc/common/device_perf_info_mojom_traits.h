...
#if BUILDFLAG(IS_WIN)
template <> struct GPU_EXPORT EnumTraits<gpu::mojom::Direct3DFeatureLevel, D3D_FEATURE_LEVEL> {
    static gpu::mojom::Direct3DFeatureLevel ToMojom(D3D_FEATURE_LEVEL d3d_feature_level);
    static bool FromMojom(gpu::mojom::Direct3DFeatureLevel input, D3D_FEATURE_LEVEL* out);
};
#endif // BUILDFLAG(IS_WIN)

template <> struct GPU_EXPORT EnumTraits<gpu::mojom::HasDiscreteGpu, gpu::HasDiscreteGpu> {
    static gpu::mojom::HasDiscreteGpu ToMojom(gpu::HasDiscreteGpu has_discrete_gpu);
    static bool FromMojom(gpu::mojom::HasDiscreteGpu input, gpu::HasDiscreteGpu* out);
};

template <> struct GPU_EXPORT StructTraits<gpu::mojom::DevicePerfInfoDataView, gpu::DevicePerfInfo> {
    static bool Read(gpu::mojom::DevicePerfInfoDataView data, gpu::DevicePerfInfo* out);
    ...
    static D3D_FEATURE_LEVEL d3d11_feature_level(const gpu::DevicePerfInfo& info)
    {
