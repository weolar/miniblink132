...
#if BUILDFLAG(IS_WIN)
// static
gpu::mojom::Direct3DFeatureLevel EnumTraits<gpu::mojom::Direct3DFeatureLevel, D3D_FEATURE_LEVEL>::ToMojom(D3D_FEATURE_LEVEL d3d_feature_level)
{
...
// static
bool EnumTraits<gpu::mojom::Direct3DFeatureLevel, D3D_FEATURE_LEVEL>::FromMojom(gpu::mojom::Direct3DFeatureLevel input, D3D_FEATURE_LEVEL* out)
{
    switch (input) {
...
gpu::mojom::HasDiscreteGpu EnumTraits<gpu::mojom::HasDiscreteGpu, gpu::HasDiscreteGpu>::ToMojom(gpu::HasDiscreteGpu has_discrete_gpu)
{
    ...
    NOTREACHED() << "Invalid gpu::HasDiscreteGpu: " << static_cast<int>(has_discrete_gpu);
}

// static
bool EnumTraits<gpu::mojom::HasDiscreteGpu, gpu::HasDiscreteGpu>::FromMojom(gpu::mojom::HasDiscreteGpu input, gpu::HasDiscreteGpu* out)
{
    switch (input) {
...
// static
bool StructTraits<gpu::mojom::DevicePerfInfoDataView, gpu::DevicePerfInfo>::Read(gpu::mojom::DevicePerfInfoDataView data, gpu::DevicePerfInfo* out)
{
