...
template <> struct GPU_EXPORT StructTraits<gpu::mojom::SurfaceHandleDataView, gpu::SurfaceHandle> {
    ...
    static bool Read(gpu::mojom::SurfaceHandleDataView data, gpu::SurfaceHandle* out)
    {
