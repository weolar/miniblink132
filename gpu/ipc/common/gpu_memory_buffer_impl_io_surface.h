...
public:
    ...
    GpuMemoryBufferImplIOSurface& operator=(const GpuMemoryBufferImplIOSurface&) = delete;

    ~GpuMemoryBufferImplIOSurface() override;

    static constexpr gfx::GpuMemoryBufferType kBufferType = gfx::IO_SURFACE_BUFFER;
