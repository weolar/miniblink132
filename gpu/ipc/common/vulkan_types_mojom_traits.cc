...
// static
bool StructTraits<gpu::mojom::VkExtensionPropertiesDataView, VkExtensionProperties>::Read(
    gpu::mojom::VkExtensionPropertiesDataView data, VkExtensionProperties* out)
{
...
// static
bool StructTraits<gpu::mojom::VkLayerPropertiesDataView, VkLayerProperties>::Read(gpu::mojom::VkLayerPropertiesDataView data, VkLayerProperties* out)
{
...
// static
bool StructTraits<gpu::mojom::VkPhysicalDevicePropertiesDataView, VkPhysicalDeviceProperties>::Read(
    gpu::mojom::VkPhysicalDevicePropertiesDataView data, VkPhysicalDeviceProperties* out)
{
...
// static
bool StructTraits<gpu::mojom::VkPhysicalDeviceLimitsDataView, VkPhysicalDeviceLimits>::Read(
    gpu::mojom::VkPhysicalDeviceLimitsDataView data, VkPhysicalDeviceLimits* out)
{
    ...
    out->maxPerStageDescriptorUniformBuffers = data.maxPerStageDescriptorUniformBuffers();

    out->maxPerStageDescriptorStorageBuffers = data.maxPerStageDescriptorStorageBuffers();

    out->maxPerStageDescriptorSampledImages = data.maxPerStageDescriptorSampledImages();

    out->maxPerStageDescriptorStorageImages = data.maxPerStageDescriptorStorageImages();

    out->maxPerStageDescriptorInputAttachments = data.maxPerStageDescriptorInputAttachments();
    ...
    out->maxDescriptorSetUniformBuffersDynamic = data.maxDescriptorSetUniformBuffersDynamic();

    out->maxDescriptorSetStorageBuffers = data.maxDescriptorSetStorageBuffers();

    out->maxDescriptorSetStorageBuffersDynamic = data.maxDescriptorSetStorageBuffersDynamic();
    ...
    out->maxDescriptorSetInputAttachments = data.maxDescriptorSetInputAttachments();
    ...
    out->maxTessellationControlPerVertexInputComponents = data.maxTessellationControlPerVertexInputComponents();

    out->maxTessellationControlPerVertexOutputComponents = data.maxTessellationControlPerVertexOutputComponents();

    out->maxTessellationControlPerPatchOutputComponents = data.maxTessellationControlPerPatchOutputComponents();

    out->maxTessellationControlTotalOutputComponents = data.maxTessellationControlTotalOutputComponents();

    out->maxTessellationEvaluationInputComponents = data.maxTessellationEvaluationInputComponents();

    out->maxTessellationEvaluationOutputComponents = data.maxTessellationEvaluationOutputComponents();
    ...
    out->maxGeometryTotalOutputComponents = data.maxGeometryTotalOutputComponents();
    ...
    out->maxFragmentCombinedOutputResources = data.maxFragmentCombinedOutputResources();
    ...
    out->framebufferNoAttachmentsSampleCounts = data.framebufferNoAttachmentsSampleCounts();
    ...
    out->optimalBufferCopyOffsetAlignment = data.optimalBufferCopyOffsetAlignment();

    out->optimalBufferCopyRowPitchAlignment = data.optimalBufferCopyRowPitchAlignment();
...
// static
bool StructTraits<gpu::mojom::VkPhysicalDeviceSparsePropertiesDataView, VkPhysicalDeviceSparseProperties>::Read(
    gpu::mojom::VkPhysicalDeviceSparsePropertiesDataView data, VkPhysicalDeviceSparseProperties* out)
{
    out->residencyStandard2DBlockShape = data.residencyStandard2DBlockShape();

    out->residencyStandard2DMultisampleBlockShape = data.residencyStandard2DMultisampleBlockShape();
...
// static
bool StructTraits<gpu::mojom::VkPhysicalDeviceFeaturesDataView, VkPhysicalDeviceFeatures>::Read(
    gpu::mojom::VkPhysicalDeviceFeaturesDataView data, VkPhysicalDeviceFeatures* out)
{
    ...
    out->shaderTessellationAndGeometryPointSize = data.shaderTessellationAndGeometryPointSize();

    out->shaderImageGatherExtended = data.shaderImageGatherExtended();

    out->shaderStorageImageExtendedFormats = data.shaderStorageImageExtendedFormats();

    out->shaderStorageImageMultisample = data.shaderStorageImageMultisample();

    out->shaderStorageImageReadWithoutFormat = data.shaderStorageImageReadWithoutFormat();

    out->shaderStorageImageWriteWithoutFormat = data.shaderStorageImageWriteWithoutFormat();

    out->shaderUniformBufferArrayDynamicIndexing = data.shaderUniformBufferArrayDynamicIndexing();

    out->shaderSampledImageArrayDynamicIndexing = data.shaderSampledImageArrayDynamicIndexing();

    out->shaderStorageBufferArrayDynamicIndexing = data.shaderStorageBufferArrayDynamicIndexing();

    out->shaderStorageImageArrayDynamicIndexing = data.shaderStorageImageArrayDynamicIndexing();
...
// static
bool StructTraits<gpu::mojom::VkQueueFamilyPropertiesDataView, VkQueueFamilyProperties>::Read(
    gpu::mojom::VkQueueFamilyPropertiesDataView data, VkQueueFamilyProperties* out)
{
...
// static
bool StructTraits<gpu::mojom::VkExtent3DDataView, VkExtent3D>::Read(gpu::mojom::VkExtent3DDataView data, VkExtent3D* out)
{
