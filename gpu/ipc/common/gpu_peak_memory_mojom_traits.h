...
template <> struct GPU_EXPORT EnumTraits<gpu::mojom::GpuPeakMemoryAllocationSource, gpu::GpuPeakMemoryAllocationSource> {
    static gpu::mojom::GpuPeakMemoryAllocationSource ToMojom(gpu::GpuPeakMemoryAllocationSource gpu_peak_memory_allocation_source)
    {
        ...
        NOTREACHED() << "Invalid GpuPeakMemoryAllocationSource:" << static_cast<int>(gpu_peak_memory_allocation_source);
    }

    static bool FromMojom(gpu::mojom::GpuPeakMemoryAllocationSource input, gpu::GpuPeakMemoryAllocationSource* out)
    {
        switch (input) {
