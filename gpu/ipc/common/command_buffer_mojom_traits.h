...
template <> struct GPU_EXPORT StructTraits<gpu::mojom::CommandBufferStateDataView, gpu::CommandBuffer::State> {
public:
    ...
    static gpu::error::ContextLostReason context_lost_reason(const gpu::CommandBuffer::State& state)
    {
    ...
    static bool Read(gpu::mojom::CommandBufferStateDataView data, gpu::CommandBuffer::State* out);
};
