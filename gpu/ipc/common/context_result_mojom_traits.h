...
template <> struct GPU_EXPORT EnumTraits<gpu::mojom::ContextResult, gpu::ContextResult> {
    ...
    static bool FromMojom(gpu::mojom::ContextResult input, gpu::ContextResult* out)
    {
        switch (input) {
