...
// static
gpu::mojom::GpuDiskCacheType EnumTraits<gpu::mojom::GpuDiskCacheType, gpu::GpuDiskCacheType>::ToMojom(gpu::GpuDiskCacheType gpu_disk_cache_type)
{
...
// static
bool EnumTraits<gpu::mojom::GpuDiskCacheType, gpu::GpuDiskCacheType>::FromMojom(gpu::mojom::GpuDiskCacheType input, gpu::GpuDiskCacheType* out)
{
    switch (input) {
...
// static
bool UnionTraits<gpu::mojom::GpuDiskCacheHandleDataView, gpu::GpuDiskCacheHandle>::IsNull(const gpu::GpuDiskCacheHandle& handle)
{
    return absl::holds_alternative<absl::monostate>(handle);
}

void UnionTraits<gpu::mojom::GpuDiskCacheHandleDataView, gpu::GpuDiskCacheHandle>::SetToNull(gpu::GpuDiskCacheHandle* handle)
{
    *handle = gpu::GpuDiskCacheHandle();
}

// static
bool UnionTraits<gpu::mojom::GpuDiskCacheHandleDataView, gpu::GpuDiskCacheHandle>::Read(
    gpu::mojom::GpuDiskCacheHandleDataView input, gpu::GpuDiskCacheHandle* output)
{
...
// static
gpu::mojom::GpuDiskCacheHandleDataView::Tag UnionTraits<gpu::mojom::GpuDiskCacheHandleDataView, gpu::GpuDiskCacheHandle>::GetTag(
...
// static
gpu::GpuDiskCacheGlShaderHandle UnionTraits<gpu::mojom::GpuDiskCacheHandleDataView, gpu::GpuDiskCacheHandle>::gl_shader_handle(
    const gpu::GpuDiskCacheHandle& handle)
{
...
// static
gpu::GpuDiskCacheDawnWebGPUHandle UnionTraits<gpu::mojom::GpuDiskCacheHandleDataView, gpu::GpuDiskCacheHandle>::dawn_webgpu_handle(
    const gpu::GpuDiskCacheHandle& handle)
{
...
// static
gpu::GpuDiskCacheDawnGraphiteHandle UnionTraits<gpu::mojom::GpuDiskCacheHandleDataView, gpu::GpuDiskCacheHandle>::dawn_graphite_handle(
    const gpu::GpuDiskCacheHandle& handle)
{
