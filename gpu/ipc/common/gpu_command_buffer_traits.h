...
template <> struct GPU_EXPORT ParamTraits<gpu::SyncToken> {
...
template <> struct GPU_EXPORT ParamTraits<gpu::Mailbox> {
...
template <> struct GPU_EXPORT ParamTraits<gpu::MailboxHolder> {
...
template <> struct GPU_EXPORT ParamTraits<gpu::VulkanYCbCrInfo> {
...
template <> struct GPU_EXPORT ParamTraits<gpu::GpuMemoryBufferFormatSet> {
