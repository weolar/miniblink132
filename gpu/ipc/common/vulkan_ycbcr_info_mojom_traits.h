...
template <> struct GPU_EXPORT StructTraits<gpu::mojom::VulkanYCbCrInfoDataView, gpu::VulkanYCbCrInfo> {
    ...
    static bool Read(gpu::mojom::VulkanYCbCrInfoDataView data, gpu::VulkanYCbCrInfo* out)
    {
