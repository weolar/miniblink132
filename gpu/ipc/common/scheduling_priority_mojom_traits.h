...
template <> struct GPU_EXPORT EnumTraits<gpu::mojom::SchedulingPriority, gpu::SchedulingPriority> {
    static gpu::mojom::SchedulingPriority ToMojom(gpu::SchedulingPriority priority)
    {
        switch (priority) {
    ...
    static bool FromMojom(gpu::mojom::SchedulingPriority priority, gpu::SchedulingPriority* out_priority)
    {
        switch (priority) {
