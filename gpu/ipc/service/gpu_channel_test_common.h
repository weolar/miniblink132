...
public:
    ...
    GpuChannelTestCommon(std::vector<int32_t> enabled_workarounds, bool use_stub_bindings);
...
protected:
    ...
    GpuChannelManager* channel_manager() const
    {
    ...
    void CreateCommandBuffer(GpuChannel& channel, mojom::CreateCommandBufferParamsPtr init_params, int32_t routing_id,
