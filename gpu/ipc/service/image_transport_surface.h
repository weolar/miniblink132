...
public:
    ...
    static scoped_refptr<gl::Presenter> CreatePresenter(gl::GLDisplay* display, const GpuDriverBugWorkarounds& workarounds,
    ...
    static scoped_refptr<gl::GLSurface> CreateNativeGLSurface(gl::GLDisplay* display, SurfaceHandle surface_handle, gl::GLSurfaceFormat format);
