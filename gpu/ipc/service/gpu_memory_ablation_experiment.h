...
// GetPeakMemory.
class GPU_IPC_SERVICE_EXPORT GpuMemoryAblationExperiment : public MemoryTracker {
public:
    ...
    GpuMemoryAblationExperiment(GpuChannelManager* channel_manager, scoped_refptr<base::SequencedTaskRunner> task_runner);
...
private:
    ...
    base::flat_map<uint32_t /*sequence_num*/, uint64_t /*peak_memory*/> sequences_;
