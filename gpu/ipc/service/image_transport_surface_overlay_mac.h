...
public:
    ImageTransportSurfaceOverlayMacEGL(DawnContextProvider* dawn_context_provider);
...
private:
    ...
    gfx::SwapResult SwapBuffersInternal(gl::GLSurface::SwapCompletionCallback completion_callback, gl::GLSurface::PresentationCallback presentation_callback);

    void BufferPresented(gl::GLSurface::PresentationCallback callback, const gfx::PresentationFeedback& feedback);
