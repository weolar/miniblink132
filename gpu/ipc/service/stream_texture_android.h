...
// gpu main thread.
class StreamTexture : public RefCountedLockHelperDrDc, public StreamTextureSharedImageInterface, public mojom::StreamTexture {
public:
    static scoped_refptr<StreamTexture> Create(GpuChannel* channel, int stream_id, mojo::PendingAssociatedReceiver<mojom::StreamTexture> receiver);
...
private:
    ...
    static void RunCallback(scoped_refptr<base::SingleThreadTaskRunner> task_runner, base::WeakPtr<StreamTexture> weak_stream_texture);
    ...
    void StartListening(mojo::PendingAssociatedRemote<mojom::StreamTextureClient> client) override;
