...
public:
    ...
    static scoped_refptr<DCOMPTexture> Create(GpuChannel* channel, int route_id, mojo::PendingAssociatedReceiver<mojom::DCOMPTexture> receiver);
    ...
    void SetProtectedVideoType(gfx::ProtectedVideoType protected_video_type) override;
...
private:
    ...
    void StartListening(mojo::PendingAssociatedRemote<mojom::DCOMPTextureClient> client) override;
