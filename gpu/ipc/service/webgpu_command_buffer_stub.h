...
class GPU_IPC_SERVICE_EXPORT WebGPUCommandBufferStub final : public CommandBufferStub {
public:
    WebGPUCommandBufferStub(GpuChannel* channel, const mojom::CreateCommandBufferParams& init_params, CommandBufferId command_buffer_id, SequenceId sequence_id,
