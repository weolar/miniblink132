...
public:
    static std::unique_ptr<VulkanSurfaceWin32> Create(VkInstance vk_instance, HWND parent_window);
    class WindowThread;
    VulkanSurfaceWin32(base::PassKey<VulkanSurfaceWin32> pass_key, VkInstance vk_instance, VkSurfaceKHR vk_surface, scoped_refptr<WindowThread> thread,
...
private:
    // VulkanSurface:
    bool Reshape(const gfx::Size& size, gfx::OverlayTransform pre_transform) override;
