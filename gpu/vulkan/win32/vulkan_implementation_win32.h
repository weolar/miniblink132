...
class COMPONENT_EXPORT(VULKAN_WIN32) VulkanImplementationWin32 : public VulkanImplementation {
public:
    explicit VulkanImplementationWin32(bool use_swiftshader);

    VulkanImplementationWin32(const VulkanImplementationWin32&) = delete;
    VulkanImplementationWin32& operator=(const VulkanImplementationWin32&) = delete;
