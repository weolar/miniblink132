...
#define glMultiDrawArraysInstancedWEBGL GLES2_GET_FUN(MultiDrawArraysInstancedWEBGL)
#define glMultiDrawArraysInstancedBaseInstanceWEBGL GLES2_GET_FUN(MultiDrawArraysInstancedBaseInstanceWEBGL)
#define glMultiDrawElementsWEBGL GLES2_GET_FUN(MultiDrawElementsWEBGL)
#define glMultiDrawElementsInstancedWEBGL GLES2_GET_FUN(MultiDrawElementsInstancedWEBGL)
...
#define glRenderbufferStorageMultisampleCHROMIUM GLES2_GET_FUN(RenderbufferStorageMultisampleCHROMIUM)
#define glRenderbufferStorageMultisampleAdvancedAMD GLES2_GET_FUN(RenderbufferStorageMultisampleAdvancedAMD)
...
#define glSetDisjointValueSyncCHROMIUM GLES2_GET_FUN(SetDisjointValueSyncCHROMIUM)
...
#define glGetTransformFeedbackVaryingsCHROMIUM GLES2_GET_FUN(GetTransformFeedbackVaryingsCHROMIUM)
#define glGetUniformsES3CHROMIUM GLES2_GET_FUN(GetUniformsES3CHROMIUM)
#define glDescheduleUntilFinishedCHROMIUM GLES2_GET_FUN(DescheduleUntilFinishedCHROMIUM)
...
#define glDrawArraysInstancedBaseInstanceANGLE GLES2_GET_FUN(DrawArraysInstancedBaseInstanceANGLE)
#define glDrawElementsInstancedANGLE GLES2_GET_FUN(DrawElementsInstancedANGLE)
#define glDrawElementsInstancedBaseVertexBaseInstanceANGLE GLES2_GET_FUN(DrawElementsInstancedBaseVertexBaseInstanceANGLE)
#define glVertexAttribDivisorANGLE GLES2_GET_FUN(VertexAttribDivisorANGLE)
#define glProduceTextureDirectCHROMIUM GLES2_GET_FUN(ProduceTextureDirectCHROMIUM)
...
#define glContextVisibilityHintCHROMIUM GLES2_GET_FUN(ContextVisibilityHintCHROMIUM)
...
#define glBindFragDataLocationIndexedEXT GLES2_GET_FUN(BindFragDataLocationIndexedEXT)
...
#define glInitializeDiscardableTextureCHROMIUM GLES2_GET_FUN(InitializeDiscardableTextureCHROMIUM)
#define glUnlockDiscardableTextureCHROMIUM GLES2_GET_FUN(UnlockDiscardableTextureCHROMIUM)
#define glLockDiscardableTextureCHROMIUM GLES2_GET_FUN(LockDiscardableTextureCHROMIUM)
...
#define glCreateClientGpuFenceCHROMIUM GLES2_GET_FUN(CreateClientGpuFenceCHROMIUM)
...
#define glInvalidateReadbackBufferShadowDataCHROMIUM GLES2_GET_FUN(InvalidateReadbackBufferShadowDataCHROMIUM)
#define glFramebufferTextureMultiviewOVR GLES2_GET_FUN(FramebufferTextureMultiviewOVR)
#define glMaxShaderCompilerThreadsKHR GLES2_GET_FUN(MaxShaderCompilerThreadsKHR)
#define glCreateAndTexStorage2DSharedImageCHROMIUM GLES2_GET_FUN(CreateAndTexStorage2DSharedImageCHROMIUM)
#define glBeginSharedImageAccessDirectCHROMIUM GLES2_GET_FUN(BeginSharedImageAccessDirectCHROMIUM)
#define glEndSharedImageAccessDirectCHROMIUM GLES2_GET_FUN(EndSharedImageAccessDirectCHROMIUM)
