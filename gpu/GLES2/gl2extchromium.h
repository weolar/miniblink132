...
GL_APICALL void GL_APIENTRY glProduceTextureDirectCHROMIUM(GLuint texture, GLbyte* mailbox);
...
typedef void(GL_APIENTRYP PFNGLPRODUCETEXTUREDIRECTCHROMIUMPROC)(GLuint texture, GLenum target, const GLbyte* mailbox);
typedef GLuint(GL_APIENTRYP PFNGLCREATEANDCONSUMETEXTURECHROMIUMPROC)(const GLbyte* mailbox);
...
#endif
typedef void*(GL_APIENTRY PFNGLMAPBUFFERCHROMIUM)(GLuint target, GLenum access);
...
#endif
typedef void*(GL_APIENTRYP PFNGLMAPBUFFERSUBDATACHROMIUMPROC)(GLuint target, GLintptr offset, GLsizeiptr size, GLenum access);
typedef void(GL_APIENTRYP PFNGLUNMAPBUFFERSUBDATACHROMIUMPROC)(const void* mem);
typedef void*(GL_APIENTRYP PFNGLMAPTEXSUBIMAGE2DCHROMIUMPROC)(
    GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, GLenum access);
typedef void(GL_APIENTRYP PFNGLUNMAPTEXSUBIMAGE2DCHROMIUMPROC)(const void* mem);
...
typedef void(GL_APIENTRYP PFNGLREQUESTEXTENSIONCHROMIUMPROC)(const char* extension);
...
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void GL_APIENTRY glBindUniformLocationCHROMIUM(GLuint program, GLint location, const char* name);
#endif
typedef void(GL_APIENTRYP PFNGLBINDUNIFORMLOCATIONCHROMIUMPROC)(GLuint program, GLint location, const char* name);
...
GL_APICALL void GL_APIENTRY glBlitFramebufferCHROMIUM(
...
typedef void(GL_APIENTRYP PFNGLBLITFRAMEBUFFERCHROMIUMPROC)(
    GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
...
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void GL_APIENTRY glCopyTextureCHROMIUM(GLenum source_id, GLint source_level, GLenum dest_target, GLenum dest_id, GLint dest_level,
...
GL_APICALL void GL_APIENTRY glCopySubTextureCHROMIUM(GLenum source_id, GLint source_level, GLenum dest_target, GLenum dest_id, GLint dest_level, GLint xoffset,
...
#endif
typedef void(GL_APIENTRYP PFNGLCOPYTEXTURECHROMIUMPROC)(GLenum source_id, GLint source_level, GLenum dest_target, GLenum dest_id, GLint dest_level,
    GLint internalformat, GLenum dest_type, GLboolean unpack_flip_y, GLboolean unpack_premultiply_alpha, GLboolean unpack_unmultiply_alpha);

typedef void(GL_APIENTRYP PFNGLCOPYSUBTEXTURECHROMIUMPROC)(GLenum source_id, GLint source_level, GLenum dest_target, GLenum dest_id, GLint dest_level,
...
#endif
typedef GLboolean(GL_APIENTRYP PFNGLENABLEFEATURECHROMIUMPROC)(const char* feature);
...
#endif
typedef void(GL_APIENTRYP PFNGLRESIZECHROMIUMPROC)(GLuint width, GLuint height, GLfloat scale_factor, GLcolorSpace color_space, GLboolean alpha);
...
#endif
typedef void(GL_APIENTRYP PFNGLGETPROGRAMINFOCHROMIUMPROC)(GLuint program, GLsizei bufsize, GLsizei* size, void* info);
...
typedef void(GL_APIENTRYP PFNGLGENUNVERIFIEDSYNCTOKENCHROMIUMPROC)(GLbyte* sync_token);
typedef void(GL_APIENTRYP PFNGLVERIFYSYNCTOKENSCHROMIUMPROC)(GLbyte** sync_tokens, GLsizei count);
typedef void(GL_APIENTRYP PFNGLWAITSYNCTOKENCHROMIUM)(const GLbyte* sync_tokens);
...
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void GL_APIENTRY glBindFragDataLocationIndexedEXT(GLuint program, GLuint colorNumber, GLuint index, const char* name);
GL_APICALL void GL_APIENTRY glBindFragDataLocationEXT(GLuint program, GLuint colorNumber, const char* name);
GL_APICALL GLint GL_APIENTRY glGetFragDataIndexEXT(GLuint program, const char* name);
#endif

typedef void(GL_APIENTRYP PFNGLBINDFRAGDATALOCATIONINDEXEDEXT)(GLuint program, GLuint colorNumber, GLuint index, const char* name);
typedef void(GL_APIENTRYP PFNGLBINDFRAGDATALOCATIONEXT)(GLuint program, GLuint colorNumber, const char* name);
typedef GLint(GL_APIENTRYP PFNGLGETFRAGDATAINDEXEXT)(GLuint program, const GLchar* name);
