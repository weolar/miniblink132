...
extern "C" {
EGLAPI void EGLAPIENTRY CommandBufferGLESSetNextCreateWindowSurfaceCreatesPBuffer(EGLDisplay dpy, EGLint width, EGLint height)
{
    gles2_conform_support::egl::ThreadState* ts = gles2_conform_support::egl::ThreadState::Get();
