...
class Context : public base::RefCountedThreadSafe<Context>, public gpu::GpuControl {
public:
    ...
    bool is_current_in_some_thread() const
    {
        return is_current_in_some_thread_;
    }
    ...
    static bool MakeCurrent(Context* current_context, Surface* current_surface, Context* new_context, Surface* new_surface);
    ...
    static void SetPlatformGpuFeatureInfo(const gpu::GpuFeatureInfo& gpu_feature_info);
