...
public:
    ...
    template <typename T> T ReturnError(EGLint error, T return_value)
    {
        error_code_ = error;
        return return_value;
    }
    template <typename T> T ReturnSuccess(T return_value)
    {
    ...
    public:
        ...
        AutoCurrentContextRestore& operator=(const AutoCurrentContextRestore&) = delete;
