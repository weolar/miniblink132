...
EGLImageKHR GTFCreateEGLImage(int width, int height, GLenum format, GLenum type)
{
    ...
    static const EGLint attrib[] = { EGL_IMAGE_PRESERVED_KHR, EGL_TRUE, EGL_GL_TEXTURE_LEVEL_KHR, 0, EGL_NONE };
    ...
    EGLImageKHR egl_image
        = egl_create_image_khr_(eglGetCurrentDisplay(), eglGetCurrentContext(), EGL_GL_TEXTURE_2D_KHR, reinterpret_cast<EGLClientBuffer>(texture), attrib);
