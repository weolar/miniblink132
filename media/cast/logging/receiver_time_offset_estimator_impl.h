...
class ReceiverTimeOffsetEstimatorImpl final : public ReceiverTimeOffsetEstimator {
public:
    ReceiverTimeOffsetEstimatorImpl();

    ReceiverTimeOffsetEstimatorImpl(const ReceiverTimeOffsetEstimatorImpl&) = delete;
    ReceiverTimeOffsetEstimatorImpl& operator=(const ReceiverTimeOffsetEstimatorImpl&) = delete;
    ...
    bool GetReceiverOffsetBounds(base::TimeDelta* lower_bound, base::TimeDelta* upper_bound) final;
...
private:
    ...
    public:
        ...
        base::TimeDelta bound() const
        {
            return bound_;
        }

        void SetSent(RtpTimeTicks rtp, uint16_t packet_id, bool audio, base::TimeTicks t);

        void SetReceived(RtpTimeTicks rtp, uint16_t packet_id, bool audio, base::TimeTicks t);
