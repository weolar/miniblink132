...
public:
    SizeAdaptableVideoEncoderBase(const scoped_refptr<CastEnvironment>& cast_environment, const FrameSenderConfig& video_config,
    ...
    SizeAdaptableVideoEncoderBase& operator=(const SizeAdaptableVideoEncoderBase&) = delete;
...
protected:
    ...
    const FrameSenderConfig& video_config() const
    {
