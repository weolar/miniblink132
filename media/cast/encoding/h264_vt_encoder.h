...
class H264VideoToolboxEncoder final : public VideoEncoder, public base::PowerSuspendObserver {
public:
    ...
    bool EncodeVideoFrame(scoped_refptr<media::VideoFrame> video_frame, base::TimeTicks reference_time, FrameEncodedCallback frame_encoded_callback) override;
