...
public:
    ...
    AudioSender(scoped_refptr<CastEnvironment> cast_environment, const FrameSenderConfig& audio_config, StatusChangeOnceCallback status_change_cb,
    ...
    virtual void InsertAudio(std::unique_ptr<AudioBus> audio_bus, base::TimeTicks recorded_time);
...
private:
    ...
    void OnEncodedAudioFrame(std::unique_ptr<SenderEncodedFrame> encoded_frame, int samples_skipped);
