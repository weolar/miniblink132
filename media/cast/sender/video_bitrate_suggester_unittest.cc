...
protected:
    ...
    {
        video_bitrate_suggester_ = std::make_unique<VideoBitrateSuggester>(kVideoConfig,
    ...
    {
        feature_list_.InitAndEnableFeature(media::kCastStreamingExponentialVideoBitrateAlgorithm);
    }

    void UseLinearAlgorithm()
    {
        feature_list_.InitAndDisableFeature(media::kCastStreamingExponentialVideoBitrateAlgorithm);
    }
...
TEST_F(VideoBitrateSuggesterTest, SuggestsBitratesCorrectlyWithExponentialAlgorithm)
{
...
TEST_F(VideoBitrateSuggesterTest, SuggestsBitratesCorrectlyWithLinearAlgorithm)
{
    UseLinearAlgorithm();
