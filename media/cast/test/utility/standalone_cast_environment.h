...
class StandaloneCastEnvironment : public CastEnvironment, public base::ThreadChecker {
public:
    StandaloneCastEnvironment();

    StandaloneCastEnvironment(const StandaloneCastEnvironment&) = delete;
    StandaloneCastEnvironment& operator=(const StandaloneCastEnvironment&) = delete;
