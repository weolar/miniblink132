...
FrameSenderConfig GetDefaultVideoSenderConfig()
{
    ...
    config.start_bitrate = config.min_bitrate = config.max_bitrate = kDefaultMaxVideoBitrate;
    ...
    video_codec_params.max_number_of_video_buffers_used = kDefaultNumberOfVideoBuffers;
