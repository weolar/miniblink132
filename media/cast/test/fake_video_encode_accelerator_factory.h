...
public:
    explicit FakeVideoEncodeAcceleratorFactory(const scoped_refptr<base::SingleThreadTaskRunner>& task_runner);

    FakeVideoEncodeAcceleratorFactory(const FakeVideoEncodeAcceleratorFactory&) = delete;
    FakeVideoEncodeAcceleratorFactory& operator=(const FakeVideoEncodeAcceleratorFactory&) = delete;
    ...
    void CreateVideoEncodeAccelerator(ReceiveVideoEncodeAcceleratorCallback callback);
