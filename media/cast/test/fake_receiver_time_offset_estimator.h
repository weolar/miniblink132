...
class FakeReceiverTimeOffsetEstimator final : public ReceiverTimeOffsetEstimator {
public:
    FakeReceiverTimeOffsetEstimator(base::TimeDelta offset);

    FakeReceiverTimeOffsetEstimator(const FakeReceiverTimeOffsetEstimator&) = delete;
    FakeReceiverTimeOffsetEstimator& operator=(const FakeReceiverTimeOffsetEstimator&) = delete;
