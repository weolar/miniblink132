...
LoopBackTransport::LoopBackTransport(scoped_refptr<CastEnvironment> cast_environment)
...
void LoopBackTransport::Initialize(std::unique_ptr<test::PacketPipe> pipe, const PacketReceiverCallback& packet_receiver,
    const scoped_refptr<base::SingleThreadTaskRunner>& task_runner, const base::TickClock* clock)
{
