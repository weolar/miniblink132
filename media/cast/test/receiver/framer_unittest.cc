...
protected:
        ...
        , framer_(&testing_clock_, &mock_rtp_payload_feedback_, 0, true, 0)
    {
        ...
        EXPECT_CALL(mock_rtp_payload_feedback_, CastFeedback(testing::_)).WillRepeatedly(testing::Return());
    }
...
TEST_F(FramerTest, AlwaysStartWithKey)
{
    ...
    complete = framer_.InsertPacket(&payload_[0], payload_.size(), rtp_header_, &duplicate);
