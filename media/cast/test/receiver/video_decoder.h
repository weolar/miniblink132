...
public:
    ...
    typedef base::RepeatingCallback<void(scoped_refptr<VideoFrame> frame, bool is_continuous)> DecodeFrameCallback;

    VideoDecoder(const scoped_refptr<CastEnvironment>& cast_environment, Codec codec);
