...
public:
    CastMessageBuilder(const base::TickClock* clock, RtpPayloadFeedback* incoming_payload_feedback, const Framer* framer, uint32_t media_ssrc,
...
private:
    ...
    FrameId last_acked_frame_id() const
    {
        return cast_msg_.ack_frame_id;
    }
