...
class RtpPacketizer {
public:
    RtpPacketizer(PacedSender* const transport, PacketStorage* packet_storage, RtpPacketizerConfig rtp_packetizer_config);
    ~RtpPacketizer();
    ...
    {
        return send_octet_count_;
    }

private:
    void BuildCommonRtpHeader(Packet* packet, bool marker_bit, RtpTimeTicks rtp_timestamp);
