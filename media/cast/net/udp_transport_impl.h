...
public:
    ...
    UdpTransportImpl(const scoped_refptr<base::SingleThreadTaskRunner>& io_thread_proxy, const net::IPEndPoint& local_end_point,
...
private:
    ...
    void OnSent(const scoped_refptr<net::IOBuffer>& buf, PacketRef packet, base::OnceClosure cb, int result);
