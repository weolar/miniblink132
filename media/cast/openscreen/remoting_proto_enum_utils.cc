...
std::optional<media::AudioCodec> ToMediaAudioCodec(openscreen::cast::AudioDecoderConfig::Codec value)
{
...
std::optional<openscreen::cast::AudioDecoderConfig::Codec> ToProtoAudioDecoderConfigCodec(media::AudioCodec value)
{
...
std::optional<media::SampleFormat> ToMediaSampleFormat(openscreen::cast::AudioDecoderConfig::SampleFormat value)
{
    using OriginType = openscreen::cast::AudioDecoderConfig;
...
std::optional<openscreen::cast::AudioDecoderConfig::SampleFormat> ToProtoAudioDecoderConfigSampleFormat(media::SampleFormat value)
{
...
std::optional<media::ChannelLayout> ToMediaChannelLayout(openscreen::cast::AudioDecoderConfig::ChannelLayout value)
{
    using OriginType = openscreen::cast::AudioDecoderConfig;
...
std::optional<openscreen::cast::AudioDecoderConfig::ChannelLayout> ToProtoAudioDecoderConfigChannelLayout(media::ChannelLayout value)
{
...
std::optional<media::VideoCodec> ToMediaVideoCodec(openscreen::cast::VideoDecoderConfig::Codec value)
{
...
std::optional<openscreen::cast::VideoDecoderConfig::Codec> ToProtoVideoDecoderConfigCodec(media::VideoCodec value)
{
...
std::optional<media::VideoCodecProfile> ToMediaVideoCodecProfile(openscreen::cast::VideoDecoderConfig::Profile value)
{
    using OriginType = openscreen::cast::VideoDecoderConfig;
...
std::optional<openscreen::cast::VideoDecoderConfig::Profile> ToProtoVideoDecoderConfigProfile(media::VideoCodecProfile value)
{
...
std::optional<media::VideoPixelFormat> ToMediaVideoPixelFormat(openscreen::cast::VideoDecoderConfig::Format value)
{
    using OriginType = openscreen::cast::VideoDecoderConfig;
...
std::optional<media::BufferingState> ToMediaBufferingState(openscreen::cast::RendererClientOnBufferingStateChange::State value)
{
...
std::optional<openscreen::cast::RendererClientOnBufferingStateChange::State> ToProtoMediaBufferingState(media::BufferingState value)
{
...
std::optional<media::DemuxerStream::Status> ToDemuxerStreamStatus(openscreen::cast::DemuxerStreamReadUntilCallback::Status value)
{
...
std::optional<openscreen::cast::DemuxerStreamReadUntilCallback::Status> ToProtoDemuxerStreamStatus(media::DemuxerStream::Status value)
{
