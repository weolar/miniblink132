...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForStatisticsUpdate)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_RC_ONSTATISTICSUPDATE);
...
{
    auto rpc = CreateMessageForBufferingStateChange(media::BufferingState::BUFFERING_HAVE_NOTHING);
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_RC_ONBUFFERINGSTATECHANGE);
    auto* message = rpc->mutable_rendererclient_onbufferingstatechange_rpc();
    ASSERT_NE(message, nullptr);
    EXPECT_EQ(message->state(), openscreen::cast::RendererClientOnBufferingStateChange::BUFFERING_HAVE_NOTHING);

    rpc = CreateMessageForBufferingStateChange(media::BufferingState::BUFFERING_HAVE_ENOUGH);
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_RC_ONBUFFERINGSTATECHANGE);
    message = rpc->mutable_rendererclient_onbufferingstatechange_rpc();
    ASSERT_NE(message, nullptr);
    EXPECT_EQ(message->state(), openscreen::cast::RendererClientOnBufferingStateChange::BUFFERING_HAVE_ENOUGH);
}
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForAudioConfigChange)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_RC_ONAUDIOCONFIGCHANGE);
    ...
    ASSERT_TRUE(ConvertProtoToAudioDecoderConfig(*proto_audio_config, &audio_output_config));
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForVideoConfigChange)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_RC_ONVIDEOCONFIGCHANGE);
    ...
    ASSERT_TRUE(ConvertProtoToVideoDecoderConfig(*proto_video_config, &converted));
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForVideoNaturalSizeChange)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_RC_ONVIDEONATURALSIZECHANGE);
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForVideoOpacityChange)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_RC_ONVIDEOOPACITYCHANGE);
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForInitializationComplete)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_R_INITIALIZE_CALLBACK);
    EXPECT_EQ(rpc->boolean_value(), true);
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForFlushComplete)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_R_FLUSHUNTIL_CALLBACK);
}
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForAcquireRendererDone)
{
    ...
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_ACQUIRE_RENDERER_DONE);
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForDemuxerStreamReadUntil)
{
    ...
    const auto rpc = CreateMessageForDemuxerStreamReadUntil(kTestHandle, kTotalCount);
...
TEST_F(RemotingMessageFactoriesTest, CreateMessageForDemuxerStreamEnableBitstreamConverter)
{
    const auto rpc = CreateMessageForDemuxerStreamEnableBitstreamConverter();
    EXPECT_EQ(rpc->proc(), openscreen::cast::RpcMessage::RPC_DS_ENABLEBITSTREAMCONVERTER);
}
