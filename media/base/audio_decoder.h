...
public:
    ...
    // Initialize().
    virtual void Initialize(const AudioDecoderConfig& config, CdmContext* cdm_context, InitCB init_cb, const OutputCB& output_cb, const WaitingCB& waiting_cb)
        = 0;
    ...
    virtual void Decode(scoped_refptr<DecoderBuffer> buffer, DecodeCB decode_cb) = 0;
