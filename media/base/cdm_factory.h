...
struct CreateCdmStatusTraits {
    ...
    {
        return "CreateCdmStatus";
    }
    static constexpr Codes OkEnumValue()
    {
        return Codes::kSuccess;
    }
};
...
using CdmCreatedCB = base::OnceCallback<void(const scoped_refptr<ContentDecryptionModule>&, CreateCdmStatus status)>;
...
public:
    ...
    // asynchronously.
    virtual void Create(const CdmConfig& cdm_config, const SessionMessageCB& session_message_cb, const SessionClosedCB& session_closed_cb,
