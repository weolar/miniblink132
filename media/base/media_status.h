...
using RemotePlayStateChangeCB = base::RepeatingCallback<void(MediaStatus::State)>;
using RequestRemotePlayStateChangeCB = base::OnceCallback<void(RemotePlayStateChangeCB)>;
