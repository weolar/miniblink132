...
public:
    ...
    AudioDecoderConfig(AudioCodec codec, SampleFormat sample_format, ChannelLayout channel_layout, int samples_per_second,
    ...
    void Initialize(AudioCodec codec, SampleFormat sample_format, ChannelLayout channel_layout, int samples_per_second, const std::vector<uint8_t>& extra_data,
        EncryptionScheme encryption_scheme, base::TimeDelta seek_preroll, int codec_delay);
    ...
    base::TimeDelta seek_preroll() const
    {
    ...
    void set_profile(AudioCodecProfile profile)
    {
        profile_ = profile;
    }
    ...
    const std::vector<uint8_t>& aac_extra_data() const
    {
        return aac_extra_data_;
    }
