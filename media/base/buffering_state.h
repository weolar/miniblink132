...
template <SerializableBufferingStateType T> struct SerializableBufferingState {
...
using BufferingStateCB = base::RepeatingCallback<void(BufferingState, BufferingStateChangeReason)>;

std::string BufferingStateToString(BufferingState state, BufferingStateChangeReason reason = BUFFERING_CHANGE_REASON_UNKNOWN);
