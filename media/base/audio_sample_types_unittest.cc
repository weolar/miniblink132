...
template <typename TestConfig> class SampleTypeTraitsTest : public testing::Test { };
...
struct UnsignedInt8ToFloat32TestConfig {
    ...
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
...
struct SignedInt16ToFloat32TestConfig {
    ...
    static const char* config_name()
    {
        return "SignedInt16ToFloat32TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return SourceTraits::ToFloat(source_value);
...
struct SignedInt32ToFloat32TestConfig {
    ...
    static const char* config_name()
    {
        return "SignedInt32ToFloat32TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return SourceTraits::ToFloat(source_value);
...
struct Float32ToUnsignedInt8TestConfig {
    ...
    static const char* config_name()
    {
        return "Float32ToUnsignedInt8TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
...
struct Float32ToSignedInt16TestConfig {
    ...
    static const char* config_name()
    {
        return "Float32ToSignedInt16TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return TargetTraits::FromFloat(source_value);
...
struct Float32ToSignedInt32TestConfig {
    ...
    static const char* config_name()
    {
        return "Float32ToSignedInt32TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return TargetTraits::FromFloat(source_value);
...
struct UnsignedInt8ToFloat64TestConfig {
    ...
    static const char* config_name()
    {
        return "UnsignedInt8ToFloat64TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
...
struct SignedInt16ToFloat64TestConfig {
    ...
    static const char* config_name()
    {
        return "SignedInt16ToFloat64TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return SourceTraits::ToDouble(source_value);
...
struct SignedInt32ToFloat64TestConfig {
    ...
    static const char* config_name()
    {
        return "SignedInt32ToFloat64TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return SourceTraits::ToDouble(source_value);
...
struct Float64ToUnsignedInt8TestConfig {
    ...
    static const char* config_name()
    {
        return "Float64ToUnsignedInt8TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
...
struct Float64ToSignedInt16TestConfig {
    ...
    static const char* config_name()
    {
        return "Float64ToSignedInt16TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return TargetTraits::FromDouble(source_value);
...
struct Float64ToSignedInt32TestConfig {
    ...
    static const char* config_name()
    {
        return "Float64ToSignedInt32TestConfig";
    }
    static TargetTraits::ValueType PerformConversion(SourceTraits::ValueType source_value)
    {
        return TargetTraits::FromDouble(source_value);
...
TYPED_TEST_P(SampleTypeTraitsTest, ConvertExampleValues)
{
...

    {
        ...
        ASSERT_EQ(target_zero_point, Config::PerformConversion(SourceTraits::kZeroPointValue));
    }
    {
...

    {
        ...
        if (std::numeric_limits<SourceType>::is_integer && std::is_floating_point<TargetType>::value) {
            ...
            ASSERT_NEAR(expected_target_value, Config::PerformConversion(source_value), kTolerance);
...
typedef ::testing::Types<UnsignedInt8ToFloat32TestConfig, SignedInt16ToFloat32TestConfig, SignedInt32ToFloat32TestConfig, Float32ToUnsignedInt8TestConfig,
    Float32ToSignedInt16TestConfig, Float32ToSignedInt32TestConfig, UnsignedInt8ToFloat64TestConfig, SignedInt16ToFloat64TestConfig,
    SignedInt32ToFloat64TestConfig, Float64ToUnsignedInt8TestConfig, Float64ToSignedInt16TestConfig, Float64ToSignedInt32TestConfig>
    TestConfigs;
