...
class AudioRendererSink : public base::RefCountedThreadSafe<media::AudioRendererSink> {
public:
    ...
    public:
        ...
        virtual int Render(base::TimeDelta delay, base::TimeTicks delay_timestamp, const AudioGlitchInfo& glitch_info, AudioBus* dest) = 0;
    ...
    virtual void Initialize(const AudioParameters& params, RenderCallback* callback) = 0;
...
public:
    ...
    virtual void SwitchOutputDevice(const std::string& device_id, OutputDeviceStatusCB callback) = 0;
