...
public:
    static AudioGlitchInfo SingleBoundedSystemGlitch(const base::TimeDelta duration, const AudioGlitchInfo::Direction direction)
    {
...
TEST(AudioGlitchInfo, SingleBoundedSystemGlitch)
{
    base::HistogramTester histogram_tester_;
    {
        ...
        EXPECT_EQ(AudioGlitchInfoTester::SingleBoundedSystemGlitch(base::Seconds(1.5), AudioGlitchInfo::Direction::kRender), result);
        histogram_tester_.ExpectTimeBucketCount("Media.Audio.Render.SystemGlitchDuration", base::Seconds(1.5), 1);
    }
    {
        AudioGlitchInfo result { .duration = base::Seconds(0.5), .count = 1 };
        EXPECT_EQ(AudioGlitchInfoTester::SingleBoundedSystemGlitch(base::Seconds(0.5), AudioGlitchInfo::Direction::kCapture), result);
        histogram_tester_.ExpectTimeBucketCount("Media.Audio.Capture.SystemGlitchDuration", base::Seconds(0.5), 1);
    }
}
