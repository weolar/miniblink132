...
class FakeAudioRenderCallback : public AudioRendererSink::RenderCallback, public AudioConverter::InputCallback {
public:
    ...
    int Render(base::TimeDelta delay, base::TimeTicks delay_timestamp, const AudioGlitchInfo& glitch_info, AudioBus* audio_bus) override;
    ...
    void set_half_fill(bool half_fill)
    {
        half_fill_ = half_fill;
    }
    ...
    base::TimeDelta last_delay() const
    {
        return last_delay_;
    }
    ...
    void set_needs_fade_in(bool needs_fade_in)
    {
        needs_fade_in_ = needs_fade_in;
    }

    int last_channel_count() const
    {
        return last_channel_count_;
    }
