...
public:
    ...
    void AddBaseFactory(RendererType type, std::unique_ptr<RendererFactory> factory);
    void AddConditionalFactory(RendererType type, std::unique_ptr<RendererFactory> factory, ConditionalFactoryCB callback);
    ...
    void StartRequestRemotePlayStateCB(RequestRemotePlayStateChangeCB callback_request);
