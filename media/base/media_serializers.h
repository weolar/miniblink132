...
template <typename T> struct MediaSerializer<const T> {
...
template <typename T> struct MediaSerializer<T&> {
    static base::Value Serialize(const T& value)
    {
        return MediaSerializer<T>::Serialize(value);
    }
...
template <> struct MediaSerializer<base::Value> {
...
template <> struct MediaSerializer<base::Value::List> {
...
template <typename VecType> struct MediaSerializer<std::vector<VecType>> {
...
template <typename T> struct MediaSerializer<std::unique_ptr<T>> {
...
template <typename OptType> struct MediaSerializer<std::optional<OptType>> {
    static base::Value Serialize(const std::optional<OptType>& opt)
    {
        return opt ? MediaSerializer<OptType>::Serialize(opt.value()) : base::Value("unset"); // TODO(tmathmeyer) maybe empty string?
    }
};

// Sometimes raw strings won't template match to a char*.
template <int len> struct MediaSerializer<char[len]> {
...
template <> struct MediaSerializer<double> {
...
template <> struct MediaSerializer<int64_t> {
...
template <> struct MediaSerializer<uint32_t> {
...
template <> struct MediaSerializer<float> {
...
// |result|.
#define FIELD_SERIALIZE(NAME, CONSTEXPR) result.Set(NAME, MediaSerialize(CONSTEXPR))

// Class (simple)
template <> struct MediaSerializer<gfx::Size> {
...
// Class (simple)
template <> struct MediaSerializer<gfx::Rect> {
...
// enum (simple)
template <> struct MediaSerializer<base::TimeDelta> {
...
// enum (simple)
template <> struct MediaSerializer<base::Time> {
...
// Enum (simple)
template <> struct MediaSerializer<RendererType> {
...
// Enum (simple)
template <> struct MediaSerializer<VideoDecoderType> {
...
// Enum (simple)
template <> struct MediaSerializer<AudioDecoderType> {
...
// Enum (simple)
template <> struct MediaSerializer<AudioCodec> {
...
// Enum (simple)
template <> struct MediaSerializer<AudioCodecProfile> {
...
// Enum (simple)
template <> struct MediaSerializer<VideoCodec> {
...
// Enum (simple)
template <> struct MediaSerializer<VideoCodecProfile> {
...
// Enum (simple)
template <> struct MediaSerializer<ChannelLayout> {
...
// Enum (simple)
template <> struct MediaSerializer<SampleFormat> {
...
// Class (complex)
template <> struct MediaSerializer<CdmConfig> {
    static base::Value Serialize(const CdmConfig& value)
    {
        base::Value::Dict result;
        FIELD_SERIALIZE("key_system", value.key_system);
        FIELD_SERIALIZE("allow_distinctive_identifier", value.allow_distinctive_identifier);
...
// Enum (complex)
template <> struct MediaSerializer<EncryptionScheme> {
...
// Class (complex)
template <> struct MediaSerializer<VideoTransformation> {
...
// Class (simple)
template <> struct MediaSerializer<VideoColorSpace> {
...
// Class (complex)
template <> struct MediaSerializer<gfx::HDRMetadata> {
...
// Class (complex)
template <> struct MediaSerializer<AudioDecoderConfig> {
    static base::Value Serialize(const AudioDecoderConfig& value)
    {
        ...
        FIELD_SERIALIZE("discard decoder delay", value.should_discard_decoder_delay());
...
// Enum (simple)
template <> struct MediaSerializer<VideoDecoderConfig::AlphaMode> {
    static inline base::Value Serialize(VideoDecoderConfig::AlphaMode value)
    {
        return base::Value(value == VideoDecoderConfig::AlphaMode::kHasAlpha ? "has_alpha" : "is_opaque");
    }
};

// Class (complex)
template <> struct MediaSerializer<VideoDecoderConfig> {
...
// enum (simple)
template <> struct MediaSerializer<BufferingState> {
    static inline base::Value Serialize(const BufferingState value)
    {
        return base::Value(value == BufferingState::BUFFERING_HAVE_ENOUGH ? "BUFFERING_HAVE_ENOUGH" : "BUFFERING_HAVE_NOTHING");
    }
};

// enum (complex)
template <> struct MediaSerializer<BufferingStateChangeReason> {
...
// Class (complex)
template <SerializableBufferingStateType T> struct MediaSerializer<SerializableBufferingState<T>> {
...
// Class (complex)
template <typename T> struct MediaSerializerDebug<TypedStatus<T>> {
...
// Class (complex)
template <> struct MediaSerializer<StatusData> {
...
// Class (complex)
template <> struct MediaSerializer<base::Location> {
    static base::Value Serialize(const base::Location& value)
    {
        base::Value::Dict result;
        FIELD_SERIALIZE(StatusConstants::kFileKey, value.file_name() ? value.file_name() : "unknown");
...
// Enum (simple)
template <> struct MediaSerializer<VideoColorSpace::PrimaryID> {
...
// Enum (simple)
template <> struct MediaSerializer<VideoColorSpace::TransferID> {
...
// Enum (simple)
template <> struct MediaSerializer<VideoColorSpace::MatrixID> {
...
// Enum (simple)
template <> struct MediaSerializer<gfx::ColorSpace::RangeID> {
...
template <> struct MediaSerializer<MediaTrack::Id> {
...
template <typename T> struct MediaSerializer<Ranges<T>> {
