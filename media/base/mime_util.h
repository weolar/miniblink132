...
MEDIA_EXPORT void SplitCodecs(std::string_view, std::vector<std::string>* codecs_out);
...
// codec).
MEDIA_EXPORT std::optional<VideoType> ParseVideoCodecString(std::string_view mime_type, std::string_view codec_id, bool allow_ambiguous_matches = false);
...
MEDIA_EXPORT bool ParseAudioCodecString(std::string_view mime_type, std::string_view codec_id, bool* out_is_ambiguous, AudioCodec* out_codec);
...
MEDIA_EXPORT SupportsType IsSupportedMediaFormat(std::string_view mime_type, const std::vector<std::string>& codecs);

// Similar to the above, but for encrypted formats.
MEDIA_EXPORT SupportsType IsSupportedEncryptedMediaFormat(std::string_view mime_type, const std::vector<std::string>& codecs);
