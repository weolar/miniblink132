...
public:
    ...
    using DecryptCB = base::OnceCallback<void(Status, scoped_refptr<DecoderBuffer>)>;
    ...
    virtual void Decrypt(StreamType stream_type, scoped_refptr<DecoderBuffer> encrypted, DecryptCB decrypt_cb) = 0;
    ...
    // upon completion.
    virtual void InitializeAudioDecoder(const AudioDecoderConfig& config, DecoderInitCB init_cb) = 0;
    virtual void InitializeVideoDecoder(const VideoDecoderConfig& config, DecoderInitCB init_cb) = 0;
    ...
    using VideoDecodeCB = base::OnceCallback<void(Status, scoped_refptr<VideoFrame>)>;
    ...
    virtual void DecryptAndDecodeAudio(scoped_refptr<DecoderBuffer> encrypted, AudioDecodeCB audio_decode_cb) = 0;
    virtual void DecryptAndDecodeVideo(scoped_refptr<DecoderBuffer> encrypted, VideoDecodeCB video_decode_cb) = 0;
