...
uint32_t MEDIA_EXPORT ReadKeyPressMonitorCount(const base::ReadOnlySharedMemoryMapping& shmem);
void MEDIA_EXPORT WriteKeyPressMonitorCount(base::WritableSharedMemoryMapping& shmem, uint32_t count);
...
private:
    ...
    virtual void StartKeyboardMonitoring(base::WritableSharedMemoryMapping mapping) = 0;
