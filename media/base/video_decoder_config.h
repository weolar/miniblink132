...
public:
    ...
    VideoDecoderConfig(VideoCodec codec, VideoCodecProfile profile, AlphaMode alpha_mode, const VideoColorSpace& color_space,
    ...
    void Initialize(VideoCodec codec, VideoCodecProfile profile, AlphaMode alpha_mode, const VideoColorSpace& color_space, VideoTransformation transformation,
        const gfx::Size& coded_size, const gfx::Rect& visible_rect, const gfx::Size& natural_size, const std::vector<uint8_t>& extra_data,
    ...
    void set_profile(VideoCodecProfile profile)
    {
        profile_ = profile;
    }
    ...
    VideoTransformation video_transformation() const
    {
    ...
    void set_coded_size(const gfx::Size& coded_size)
    {
    ...
    const VideoAspectRatio& aspect_ratio() const
    {
    ...
    // Codec level.
    void set_level(VideoCodecLevel level)
    {
        level_ = level;
    }
    VideoCodecLevel level() const
    {
        return level_;
    }
