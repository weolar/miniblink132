...
private:
    ...
    static AudioGlitchInfo SingleBoundedSystemGlitch(const base::TimeDelta duration, const Direction direction);
};

MEDIA_EXPORT bool operator==(const AudioGlitchInfo& lhs, const AudioGlitchInfo& rhs);
