...
public:
    ...
    NullVideoSink(bool clockless, base::TimeDelta interval, const NewFrameCB& new_frame_cb, const scoped_refptr<base::SingleThreadTaskRunner>& task_runner);
    ...
    void Stop() override;
    void PaintSingleFrame(scoped_refptr<VideoFrame> frame, bool repaint_duplicate_frame) override;
    ...
    void set_stop_cb(base::OnceClosure stop_cb)
    {
    ...
    void set_clockless(bool clockless)
    {
