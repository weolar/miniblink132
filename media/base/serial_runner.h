...
public:
    ...
    typedef base::OnceCallback<void(PipelineStatusCallback)> BoundPipelineStatusCallback;
    ...
    static std::unique_ptr<SerialRunner> Run(Queue&& bound_fns, PipelineStatusCallback done_cb);
