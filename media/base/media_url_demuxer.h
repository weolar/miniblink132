...
public:
    MediaUrlDemuxer(const scoped_refptr<base::SequencedTaskRunner>& task_runner, const GURL& media_url, const net::SiteForCookies& site_for_cookies,
        const url::Origin& top_frame_origin, net::StorageAccessApiStatus storage_access_api_status, bool allow_credentials, bool is_hls);
