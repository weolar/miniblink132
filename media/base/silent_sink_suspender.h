...
class MEDIA_EXPORT SilentSinkSuspender : public AudioRendererSink::RenderCallback {
public:
    ...
    SilentSinkSuspender(AudioRendererSink::RenderCallback* callback, base::TimeDelta silence_timeout, const AudioParameters& params,
