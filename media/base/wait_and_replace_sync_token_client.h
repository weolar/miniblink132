...
class MEDIA_EXPORT WaitAndReplaceSyncTokenClient : public VideoFrame::SyncTokenClient {
public:
    ...
    WaitAndReplaceSyncTokenClient& operator=(const WaitAndReplaceSyncTokenClient&) = delete;
