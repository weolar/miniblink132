...
struct MEDIA_EXPORT KeySystemCapability {
    KeySystemCapability();
    KeySystemCapability(std::optional<CdmCapability> sw_secure_capability, std::optional<CdmCapability> hw_secure_capability);
...
bool MEDIA_EXPORT operator==(const KeySystemCapability& lhs, const KeySystemCapability& rhs);
