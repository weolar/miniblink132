...
using KeySystemCapabilities = base::flat_map<std::string, media::KeySystemCapability>;
...
public:
    ...
    KeySystemSupportRegistration& operator=(const KeySystemSupportRegistration&) = delete;
