...
public:
    ...
    int kernel_storage_size_for_testing()
    {
        return kernel_storage_size_;
    }
...
private:
    ...
    static float Convolve_C(const int kernel_size, const float* input_ptr, const float* k1, const float* k2, double kernel_interpolation_factor);
#if defined(ARCH_CPU_X86_FAMILY)
    static float Convolve_SSE(const int kernel_size, const float* input_ptr, const float* k1, const float* k2, double kernel_interpolation_factor);
    static float Convolve_AVX2(const int kernel_size, const float* input_ptr, const float* k1, const float* k2, double kernel_interpolation_factor);
#elif defined(ARCH_CPU_ARM_FAMILY) && defined(USE_NEON)
    static float Convolve_NEON(const int kernel_size, const float* input_ptr, const float* k1, const float* k2, double kernel_interpolation_factor);
#endif
    ...
    using ConvolveProc = float (*)(const int, const float*, const float*, const float*, double);
