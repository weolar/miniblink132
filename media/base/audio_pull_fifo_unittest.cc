...
public:
    AudioPullFifoTest()
        : pull_fifo_(kChannels, kMaxFramesInFifo, base::BindRepeating(&AudioPullFifoTest::ProvideInput, base::Unretained(this)))
    ...
    {
        int start_value = 0;
        SCOPED_TRACE(base::StringPrintf("Checking frames_to_consume %d", frames_to_consume));
...
INSTANTIATE_TEST_SUITE_P(AudioPullFifoTest, AudioPullFifoTest, testing::Values(544, 512, 512, 512, 512, 2048, 544, 441, 440, 433, 500));
