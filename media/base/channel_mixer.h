...
public:
    ...
    ChannelMixer(ChannelLayout input_layout, int input_channels, ChannelLayout output_layout, int output_channels);
    ...
    // case.
    void TransformPartial(const AudioBus* input, int frame_count, AudioBus* output);

private:
    void Initialize(ChannelLayout input_layout, int input_channels, ChannelLayout output_layout, int output_channels);
