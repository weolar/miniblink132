...
bool ARGBScale(const VideoFrame& src_frame, VideoFrame& dst_frame, libyuv::FilterMode filter);
...
bool NV12xScale(const VideoFrame& src_frame, VideoFrame& dst_frame, libyuv::FilterMode filter);
