...
void ContentDecryptionModule::GetStatusForPolicy(HdcpVersion min_hdcp_version, std::unique_ptr<KeyStatusCdmPromise> promise)
{
...
// static
void ContentDecryptionModuleTraits::Destruct(const ContentDecryptionModule* cdm)
{
    cdm->DeleteOnCorrectThread();
}

std::optional<media::HdcpVersion> MaybeHdcpVersionFromString(const std::string& hdcp_version_string)
{
