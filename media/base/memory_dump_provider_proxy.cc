...
MemoryDumpProviderProxy::MemoryDumpProviderProxy(const char* name, scoped_refptr<base::SequencedTaskRunner> task_runner, MemoryDumpCB dump_cb)
...
bool MemoryDumpProviderProxy::OnMemoryDump(const base::trace_event::MemoryDumpArgs& args, base::trace_event::ProcessMemoryDump* pmd)
{
