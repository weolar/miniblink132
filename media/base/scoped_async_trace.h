...
template <TraceCategory category> class MEDIA_EXPORT TypedScopedAsyncTrace {
public:
    ...
    static std::unique_ptr<TypedScopedAsyncTrace<category>> CreateIfEnabled(const char* name);
