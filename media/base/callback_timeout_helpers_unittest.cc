...
{
    auto wrapped_callback = WrapCallbackWithTimeoutHandler(original_callback_.Get(), base::Seconds(1), timeout_handler_.Get());
...
{
    auto wrapped_callback = WrapCallbackWithDefaultInvokeIfTimeout(original_callback_.Get(), base::Seconds(1), 456);
