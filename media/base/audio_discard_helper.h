...
public:
    ...
    AudioDiscardHelper(int sample_rate, size_t decoder_delay, bool delayed_discard);
    ...
    bool ProcessBuffers(const DecoderBuffer::TimeInfo& time_info, AudioBuffer* decoded_buffer);
    ...
    size_t decoder_delay() const
    {
        return decoder_delay_;
    }
