...
void MediaResource::ForwardDurationChangeToDemuxerHost(base::TimeDelta duration)
{
    // Only implemented by MediaUrlDemuxer, for the MediaPlayerRendererClient.
    NOTREACHED();
}

void MediaResource::SetHeaders(base::flat_map<std::string, std::string> headers)
{
