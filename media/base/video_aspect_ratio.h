...
public:
    ...
    VideoAspectRatio(const gfx::Rect& visible_rect, const gfx::Size& natural_size);
...
private:
    friend struct mojo::StructTraits<mojom::VideoAspectRatioDataView, VideoAspectRatio>;
