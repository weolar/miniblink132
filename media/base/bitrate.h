...
public:
    ...
    static Bitrate VariableBitrate(uint64_t target_bps, uint64_t peak_bps) = delete;
    static Bitrate VariableBitrate(uint64_t target_bps, uint32_t peak_bps) = delete;
    static Bitrate VariableBitrate(uint32_t target_bps, uint64_t peak_bps) = delete;
    ...
    constexpr uint32_t target_bps() const
    {
        return target_bps_;
    }
