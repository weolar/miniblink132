...
SupportsType IsSupportedEncryptedMediaFormat(std::string_view mime_type, const std::vector<std::string>& codecs)
{
...
std::optional<VideoType> ParseVideoCodecString(std::string_view mime_type, std::string_view codec_id, bool allow_ambiguous_matches)
{
    return GetMimeUtil()->ParseVideoCodecString(mime_type, codec_id, allow_ambiguous_matches);
}

bool ParseAudioCodecString(std::string_view mime_type, std::string_view codec_id, bool* ambiguous_codec_string, AudioCodec* out_codec)
{
    return GetMimeUtil()->ParseAudioCodecString(mime_type, codec_id, ambiguous_codec_string, out_codec);
}
