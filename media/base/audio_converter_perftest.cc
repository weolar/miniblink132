...
void RunConvertBenchmark(const AudioParameters& in_params, const AudioParameters& out_params, bool fifo, const std::string& trace_name)
{
...
TEST(AudioConverterPerfTest, ConvertBenchmark)
{
    ...
    AudioParameters input_params(AudioParameters::AUDIO_PCM_LINEAR, media::ChannelLayoutConfig::Mono(), 48000, 2048);
    AudioParameters output_params(AudioParameters::AUDIO_PCM_LINEAR, media::ChannelLayoutConfig::Stereo(), 44100, 440);
...
TEST(AudioConverterPerfTest, ConvertBenchmarkFIFO)
{
    ...
    AudioParameters input_params(AudioParameters::AUDIO_PCM_LINEAR, media::ChannelLayoutConfig::Stereo(), 44100, 2048);
    AudioParameters output_params(AudioParameters::AUDIO_PCM_LINEAR, media::ChannelLayoutConfig::Stereo(), 44100, 440);

    RunConvertBenchmark(input_params, output_params, true, "convert_fifo_only");
    RunConvertBenchmark(input_params, output_params, false, "convert_pass_through");
}
