...
public:
    ...
    static int GetHighLatencyBufferSize(int sample_rate, int preferred_buffer_size);
    ...
    static int GetExactBufferSize(base::TimeDelta duration, int sample_rate, int hardware_buffer_size, int min_hardware_buffer_size,
