...
template <typename T> class StructPtr;
} // namespace mojo
...
public:
    ...
    static scoped_refptr<AudioBuffer> CopyFrom(SampleFormat sample_format, ChannelLayout channel_layout, int channel_count, int sample_rate, int frame_count,
        const uint8_t* const* data, const base::TimeDelta timestamp, scoped_refptr<AudioBufferMemoryPool> pool = nullptr);
    ...
    static scoped_refptr<AudioBuffer> CopyFrom(ChannelLayout channel_layout, int sample_rate, const base::TimeDelta timestamp, const AudioBus* audio_bus,
    ...
    static scoped_refptr<AudioBuffer> CopyFrom(
        int sample_rate, const base::TimeDelta timestamp, const AudioBus* audio_bus, scoped_refptr<AudioBufferMemoryPool> pool = nullptr);
    ...
    static scoped_refptr<AudioBuffer> CopyBitstreamFrom(SampleFormat sample_format, ChannelLayout channel_layout, int channel_count, int sample_rate,
        int frame_count, const uint8_t* const* data, const size_t data_size, const base::TimeDelta timestamp,
        scoped_refptr<AudioBufferMemoryPool> pool = nullptr);
    ...
    // AudioBufferMemoryPool can be provided to avoid thrashing memory.
    static scoped_refptr<AudioBuffer> CreateBuffer(SampleFormat sample_format, ChannelLayout channel_layout, int channel_count, int sample_rate,
        int frame_count, scoped_refptr<AudioBufferMemoryPool> pool = nullptr);
    ...
    static scoped_refptr<AudioBuffer> CreateBitstreamBuffer(SampleFormat sample_format, ChannelLayout channel_layout, int channel_count, int sample_rate,
        int frame_count, size_t data_size, scoped_refptr<AudioBufferMemoryPool> pool = nullptr);
    ...
    static scoped_refptr<AudioBuffer> CreateFromExternalMemory(SampleFormat sample_format, ChannelLayout channel_layout, int channel_count, int sample_rate,
        int frame_count, const base::TimeDelta timestamp, std::unique_ptr<ExternalMemory> external_memory);
    ...
    static std::unique_ptr<AudioBus> WrapOrCopyToAudioBus(scoped_refptr<AudioBuffer> audio_buffer);
    ...
    void ReadFrames(int frames_to_copy, int source_frame_offset, int dest_frame_offset, AudioBus* dest) const;
...
private:
    ...
    friend struct mojo::TypeConverter<mojo::StructPtr<mojom::AudioBuffer>, AudioBuffer>;
    ...
    // copied to).
    AudioBuffer(SampleFormat sample_format, ChannelLayout channel_layout, int channel_count, int sample_rate, int frame_count, bool create_buffer,
    ...
    AudioBuffer(SampleFormat sample_format, ChannelLayout channel_layout, int channel_count, int sample_rate, int frame_count, const base::TimeDelta timestamp,
...
class MEDIA_EXPORT AudioBufferMemoryPool : public base::RefCountedThreadSafe<AudioBufferMemoryPool> {
public:
    ...
    public:
        ExternalMemoryFromPool(scoped_refptr<AudioBufferMemoryPool> pool, std::unique_ptr<uint8_t, base::AlignedFreeDeleter> memory, size_t size);
