...
using ObserveOverlayStateCB = base::RepeatingCallback<std::unique_ptr<media::OverlayStateObserverSubscription>(
    const gpu::Mailbox& mailbox, OverlayStateObserverSubscription::StateChangedCB on_state_changed_cb)>;
