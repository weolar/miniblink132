...
class MEDIA_EXPORT DXGIDeviceManager : public base::RefCountedThreadSafe<DXGIDeviceManager> {
public:
    ...
    virtual HRESULT CheckDeviceRemovedAndGetDevice(Microsoft::WRL::ComPtr<ID3D11Device>* new_device);
    ...
    HRESULT RegisterWithMediaSource(Microsoft::WRL::ComPtr<IMFMediaSource> media_source);
...
protected:
    ...
    DXGIDeviceManager(Microsoft::WRL::ComPtr<IMFDXGIDeviceManager> mf_dxgi_device_manager, UINT d3d_device_reset_token, CHROME_LUID luid);
