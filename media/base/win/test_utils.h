...
#define MOCK_STDCALL_METHOD0(Name, Types) MOCK_METHOD0_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD1(Name, Types) MOCK_METHOD1_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD2(Name, Types) MOCK_METHOD2_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD3(Name, Types) MOCK_METHOD3_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD4(Name, Types) MOCK_METHOD4_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD5(Name, Types) MOCK_METHOD5_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD6(Name, Types) MOCK_METHOD6_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD7(Name, Types) MOCK_METHOD7_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD8(Name, Types) MOCK_METHOD8_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD9(Name, Types) MOCK_METHOD9_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)

#define MOCK_STDCALL_METHOD10(Name, Types) MOCK_METHOD10_WITH_CALLTYPE(STDMETHODCALLTYPE, Name, Types)
...
//                           Return(S_OK)));
ACTION_TEMPLATE(SetComPointee, HAS_1_TEMPLATE_PARAMS(int, k), AND_1_VALUE_PARAMS(p))
{
    p->AddRef();
    *std::get<k>(args) = p;
}
...
ACTION_TEMPLATE(SetComPointeeAndReturnOk, HAS_1_TEMPLATE_PARAMS(int, k), AND_1_VALUE_PARAMS(p))
{
    p->AddRef();
    *std::get<k>(args) = p;
    return S_OK;
...
ACTION_TEMPLATE(SaveComPtr, HAS_1_TEMPLATE_PARAMS(int, k), AND_1_VALUE_PARAMS(p))
{
...
template <typename Interface> Microsoft::WRL::ComPtr<Interface> MakeComPtr()
{
