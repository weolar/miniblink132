...
MFVideoTransferFunction ColorSpaceToMFTransfer(gfx::ColorSpace::TransferID color_space)
{
    switch (color_space) {
...
MFVideoTransferMatrix ColorSpaceToMFMatrix(gfx::ColorSpace::MatrixID color_space)
{
    switch (color_space) {
...
gfx::ColorSpace GetMediaTypeColorSpace(IMFMediaType* media_type)
{
    ...
    VideoColorSpace guesser = VideoColorSpace::FromGfxColorSpace(gfx::ColorSpace(primary, transfer, matrix, range));
    return guesser.GuessGfxColorSpace();
}

void GetMediaTypeColorValues(const gfx::ColorSpace& color_space, MFVideoPrimaries* out_primaries, MFVideoTransferFunction* out_transfer,
    MFVideoTransferMatrix* out_matrix, MFNominalRange* out_range)
{
