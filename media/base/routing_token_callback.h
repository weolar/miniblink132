...
using RoutingTokenCallback = base::OnceCallback<void(const base::UnguessableToken&)>;
...
using RequestRoutingTokenCallback = base::RepeatingCallback<void(RoutingTokenCallback)>;
