...
MEDIA_EXPORT std::ostream& operator<<(std::ostream& os, const DecoderStatus& status);
...
public:
    ...
    ScopedDecodeTrace(const char* trace_name, bool is_key_frame, base::TimeDelta timestamp);
