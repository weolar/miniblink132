...
class AudioCapturerSource : public base::RefCountedThreadSafe<media::AudioCapturerSource> {
public:
    ...
    public:
        ...
        virtual void Capture(
            const AudioBus* audio_source, base::TimeTicks audio_capture_time, const AudioGlitchInfo& glitch_info, double volume, bool key_pressed)
            = 0;
    ...
    virtual void Initialize(const AudioParameters& params, CaptureCallback* callback) = 0;
