...
public:
    ...
    MockAudioRendererSink(const std::string& device_id, OutputDeviceStatus device_status);
    MockAudioRendererSink(const std::string& device_id, OutputDeviceStatus device_status, const AudioParameters& device_output_params);
    ...
    void Initialize(const AudioParameters& params, RenderCallback* renderer) override;
