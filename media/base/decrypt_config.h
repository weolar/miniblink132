...
public:
    ...
    static std::unique_ptr<DecryptConfig> CreateCencConfig(const std::string& key_id, const std::string& iv, const std::vector<SubsampleEntry>& subsamples);
    ...
    DecryptConfig(EncryptionScheme encryption_scheme, const std::string& key_id, const std::string& iv, const std::vector<SubsampleEntry>& subsamples,
    ...
    std::unique_ptr<DecryptConfig> CopyNewSubsamplesIV(const std::vector<SubsampleEntry>& subsamples, const std::string& iv) const;
...
inline std::ostream& operator<<(std::ostream& os, const media::DecryptConfig& obj)
{
    return obj.Print(os);
}
