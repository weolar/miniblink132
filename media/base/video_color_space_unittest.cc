...
TEST(VideoColorSpaceTest, PartiallyValid)
{
    ...
    auto guessed_cs = video_cs.GuessGfxColorSpace();
    EXPECT_TRUE(guessed_cs.IsValid());
    EXPECT_EQ(guessed_cs,
        gfx::ColorSpace(
            gfx::ColorSpace::PrimaryID::BT709, gfx::ColorSpace::TransferID::BT709, gfx::ColorSpace::MatrixID::BT709, gfx::ColorSpace::RangeID::DERIVED));
}
...
TEST(VideoColorSpaceTest, UnknownVideoToSRGB)
{
    ...
    VideoColorSpace invalid_video_color_space = VideoColorSpace(
        VideoColorSpace::PrimaryID::INVALID, VideoColorSpace::TransferID::INVALID, VideoColorSpace::MatrixID::INVALID, gfx::ColorSpace::RangeID::LIMITED);
    gfx::ColorSpace unknown = invalid_video_color_space.GuessGfxColorSpace();
    gfx::ColorSpace sRGB = gfx::ColorSpace::CreateSRGB();
    std::unique_ptr<gfx::ColorTransform> t(gfx::ColorTransform::NewColorTransform(unknown, sRGB));
