...
TEST(ParseDolbyAc4CodecIdTest, DolbyAc4CodecIds)
{
    ...
    EXPECT_TRUE(ParseDolbyAc4CodecId("ac-4.02.01.00", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_EQ(bitstream_version, 0x02);
    EXPECT_EQ(presentation_version, 0x01);
    EXPECT_EQ(presentation_level, 0);

    // For IMS case:
    EXPECT_TRUE(ParseDolbyAc4CodecId("ac-4.02.02.00", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_EQ(bitstream_version, 0x02);
    EXPECT_EQ(presentation_version, 0x02);
    EXPECT_EQ(presentation_level, 0);

    EXPECT_TRUE(ParseDolbyAc4CodecId("ac-4.02.01.04", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_EQ(bitstream_version, 0x02);
    EXPECT_EQ(presentation_version, 0x01);
    EXPECT_EQ(presentation_level, 0x04);

    EXPECT_FALSE(ParseDolbyAc4CodecId("ac-4.00.00.00", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_FALSE(ParseDolbyAc4CodecId("ac-4.01.00.00", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_FALSE(ParseDolbyAc4CodecId("ac-4.02.00.00", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_FALSE(ParseDolbyAc4CodecId("ac-4.02.01.08", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_FALSE(ParseDolbyAc4CodecId("ac4.02.01.00", &bitstream_version, &presentation_version, &presentation_level));
    EXPECT_FALSE(ParseDolbyAc4CodecId("ac-4.02.01.00.00", &bitstream_version, &presentation_version, &presentation_level));
}
...
TEST(ParseIamfCodecIdTest, IamfCodecIds)
{
    ...
    EXPECT_TRUE(ParseIamfCodecId("iamf.000.000.ipcm", &primary_profile, &additional_profile));
    EXPECT_EQ(primary_profile, 0x00);
    EXPECT_EQ(additional_profile, 0x00);

    EXPECT_TRUE(ParseIamfCodecId("iamf.001.001.ipcm", &primary_profile, &additional_profile));
    EXPECT_EQ(primary_profile, 0x01);
    EXPECT_EQ(additional_profile, 0x01);

    EXPECT_TRUE(ParseIamfCodecId("iamf.000.001.ipcm", &primary_profile, &additional_profile));
    EXPECT_EQ(primary_profile, 0x00);
    EXPECT_EQ(additional_profile, 0x01);

    EXPECT_TRUE(ParseIamfCodecId("iamf.001.000.ipcm", &primary_profile, &additional_profile));
    EXPECT_EQ(primary_profile, 0x01);
    EXPECT_EQ(additional_profile, 0x00);

    EXPECT_TRUE(ParseIamfCodecId("iamf.001.002.ipcm", &primary_profile, &additional_profile));
    EXPECT_EQ(primary_profile, 0x01);
    EXPECT_EQ(additional_profile, 0x02);

    EXPECT_TRUE(ParseIamfCodecId("iamf.255.255.ipcm", &primary_profile, &additional_profile));
    ...
    EXPECT_FALSE(ParseIamfCodecId("iamf.000.000.000.mp4a.40.2", nullptr, nullptr));
