...
MEDIA_EXPORT std::string BuildH264MimeSuffix(VideoCodecProfile profile, uint8_t level);

MEDIA_EXPORT VideoCodec VideoCodecProfileToVideoCodec(VideoCodecProfile profile);

MEDIA_EXPORT std::ostream& operator<<(std::ostream& os, const VideoCodec& codec);
