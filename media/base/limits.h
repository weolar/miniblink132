...
inline constexpr int kMaxPacketSizeInBytes = kMaxBytesPerSample * kMaxChannels * kMaxSamplesPerPacket;
...
inline constexpr int kMaxVideoDecodeThreads = 16; // Matches ffmpeg's MAX_AUTO_THREADS. Higher values can result in
