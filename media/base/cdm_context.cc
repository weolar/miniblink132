...
std::unique_ptr<CallbackRegistration> CdmContext::RegisterEventCB(EventCB /* event_cb */)
{
    return nullptr;
}
...
scoped_refptr<MediaFoundationCdmProxy> CdmContext::GetMediaFoundationCdmProxy()
{
    return nullptr;
}
#endif
