...
public:
    ...
    typedef base::RepeatingCallback<void(int frame_delay, AudioBus* audio_bus)> ReadCB;
    ...
    MultiChannelResampler(int channels, double io_sample_rate_ratio, size_t request_frames, const ReadCB read_cb);
