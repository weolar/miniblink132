...
template <MediaLogProperty PROP, typename T> struct MediaLogPropertyTypeSupport { };
...
template <MediaLogEvent EVENT, typename T = internal::UnmatchableType> struct MediaLogEventTypeSupport { };
...
#define MEDIA_LOG_PROPERTY_SUPPORTS_TYPE(PROPERTY, TYPE)                                                                                                       \
    template <> struct MediaLogPropertyTypeSupport<MediaLogProperty::PROPERTY, TYPE> {                                                                         \
...
#define MEDIA_LOG_EVENT_NAMED_DATA(EVENT, TYPE, DISPLAY)                                                                                                       \
    template <> struct MediaLogEventTypeSupport<MediaLogEvent::EVENT, TYPE> {                                                                                  \
...
#define MEDIA_LOG_EVENT_TYPELESS(EVENT)                                                                                                                        \
    template <> struct MediaLogEventTypeSupport<MediaLogEvent::EVENT> {                                                                                        \
        static std::string TypeName()                                                                                                                          \
        {                                                                                                                                                      \
            return #EVENT;                                                                                                                                     \
        }                                                                                                                                                      \
