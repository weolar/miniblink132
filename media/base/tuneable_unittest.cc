...
public:
    ...
    void SetUp() override
    {
        ...
        scoped_feature_list_.InitAndEnableFeatureWithParameters(kMediaOptimizer, params_);
    }
...
TEST_F(TuneableTest, IntTuneableFromDefaultWithClamps)
{
    ...
    Tuneable<int> t_default(kTuneableIntUnset, min_value, default_value, max_value);
...
TEST_F(TuneableTest, OtherSpecializationsCompile)
{
    ...
    Tuneable<base::TimeDelta> time_delta_tuneable("whatever", min_value, default_value, max_value);
...
TEST_F(TuneableTest, TimeDeltaIsSpecifiedInMilliseconds)
{
    ...
    Tuneable<base::TimeDelta> t(kTuneableTimeDeltaFiveSeconds, min_value, min_value, max_value);
