...
class MockAndroidOverlay : public testing::NiceMock<AndroidOverlay>, public DestructionObservable {
public:
    MockAndroidOverlay();
    ...
    AndroidOverlayConfig* config() const
    {
        return config_.get();
    }
    ...
    void AddSurfaceDestroyedCallback(AndroidOverlayConfig::DestroyedCB cb) override;
