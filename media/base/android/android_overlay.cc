...
void AndroidOverlay::AddSurfaceDestroyedCallback(AndroidOverlayConfig::DestroyedCB cb)
{
...
void AndroidOverlay::RunSurfaceDestroyedCallbacks()
{
    ...
    std::list<AndroidOverlayConfig::DestroyedCB> cbs = std::move(destruction_cbs_);
...
void AndroidOverlay::AddOverlayDeletedCallback(AndroidOverlayConfig::DeletedCB cb)
{
