...
public:
    JniHdrMetadata(const VideoColorSpace& color_space, const gfx::HDRMetadata& hdr_metadata);
    ...
    jfloat PrimaryBChromaticityX(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj);
    jfloat PrimaryBChromaticityY(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj);
    jfloat WhitePointChromaticityX(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj);
    jfloat WhitePointChromaticityY(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj);
    jfloat MaxColorVolumeLuminance(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj);
    jfloat MinColorVolumeLuminance(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj);
