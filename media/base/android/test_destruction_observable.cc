...
std::unique_ptr<DestructionObserver> DestructionObservable::CreateDestructionObserver()
{
    ...
    : destructed_(false)
{
    ...
    observable->destruction_cb.ReplaceClosure(base::BindOnce(&DestructionObserver::OnObservableDestructed, weak_factory_.GetWeakPtr()));
}
