...
{
    Callbacks c;
    c.OverlayReady = base::BindRepeating(&MockAndroidOverlay::OnOverlayReady, weak_factory_.GetWeakPtr());
    c.OverlayFailed = base::BindRepeating(&MockAndroidOverlay::OnOverlayFailed, weak_factory_.GetWeakPtr());
    c.SurfaceDestroyed = base::BindRepeating(&MockAndroidOverlay::OnSurfaceDestroyed, weak_factory_.GetWeakPtr());
    c.PowerEfficientState = base::BindRepeating(&MockAndroidOverlay::OnPowerEfficientState, weak_factory_.GetWeakPtr());
...
void MockAndroidOverlay::AddSurfaceDestroyedCallback(AndroidOverlayConfig::DestroyedCB cb)
{
