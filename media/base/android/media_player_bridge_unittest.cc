...
public:
    MediaPlayerBridgeTest()
        : bridge_(GURL(), net::SiteForCookies(), url::Origin(), net::StorageAccessApiStatus::kNone, "", false, &client_, false, false,
...
protected:
    ...
    {
        bridge_.OnMediaError(error);
    }

    void SimulatePlaybackCompleted()
    {
        bridge_.OnPlaybackComplete();
    }
