...
public:
    MediaDrmBridgeFactory(CreateFetcherCB create_fetcher_cb, CreateStorageCB create_storage_cb);
...
private:
    ...
    void OnMediaCryptoReady(JavaObjectPtr media_crypto, bool requires_secure_video_codec);
    ...
    MediaDrmBridge::SecurityLevel security_level_ = MediaDrmBridge::SECURITY_LEVEL_DEFAULT;
