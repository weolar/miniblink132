...
class MEDIA_EXPORT MockMediaCryptoContext : public CdmContext, public testing::NiceMock<MediaCryptoContext> {
public:
    ...
    MOCK_METHOD1(SetMediaCryptoReadyCB_, void(MediaCryptoReadyCB& media_crypto_ready_cb));
