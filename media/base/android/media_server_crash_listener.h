...
public:
    ...
    MediaServerCrashListener(OnMediaServerCrashCB on_server_crash_cb, scoped_refptr<base::SingleThreadTaskRunner> callback_task_runner);
    ...
    void OnMediaServerCrashDetected(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jboolean watchdog_needs_release);
