...
public:
    ...
    public:
        ...
        virtual double ProvideInput(AudioBus* audio_bus, uint32_t frames_delayed, const AudioGlitchInfo& glitch_info) = 0;
    ...
    AudioConverter(const AudioParameters& input_params, const AudioParameters& output_params, bool disable_fifo);
    ...
    void ConvertWithInfo(uint32_t frames_delayed, const AudioGlitchInfo& glitch_info, AudioBus* dest);
    ...
    bool empty() const
    {
        return transform_inputs_.empty();
    }
