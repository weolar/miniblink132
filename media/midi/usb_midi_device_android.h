...
public:
    ...
    UsbMidiDeviceAndroid(const base::android::JavaRef<jobject>& raw_device, UsbMidiDeviceDelegate* delegate);
    ...
    void OnData(JNIEnv* env, jint endpoint_number, const base::android::JavaParamRef<jbyteArray>& data);
