...
public:
    ...
    virtual void ReceiveUsbMidiData(UsbMidiDevice* device, int endpoint_number, const uint8_t* data, size_t size, base::TimeTicks time) = 0;
...
public:
    ...
    public:
        ...
        virtual void EnumerateDevices(UsbMidiDeviceDelegate* delegate, Callback callback) = 0;
    };
