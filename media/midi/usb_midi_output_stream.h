...
private:
    ...
    bool PushSysExMessage(const std::vector<uint8_t>& data, size_t* current, std::vector<uint8_t>* data_to_send);
    bool PushSysCommonMessage(const std::vector<uint8_t>& data, size_t* current, std::vector<uint8_t>* data_to_send);
    void PushSysRTMessage(const std::vector<uint8_t>& data, size_t* current, std::vector<uint8_t>* data_to_send);
    bool PushChannelMessage(const std::vector<uint8_t>& data, size_t* current, std::vector<uint8_t>* data_to_send);
