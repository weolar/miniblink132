...
public:
    ...
    public:
        ...
        virtual void OnReceivedData(MidiInputPortAndroid* port, const uint8_t* data, size_t size, base::TimeTicks time) = 0;
    };
    ...
    void OnData(JNIEnv* env, const base::android::JavaParamRef<jbyteArray>& data, jint offset, jint size, jlong timestamp);
