...
public:
    DecryptingRendererFactory(MediaLog* media_log, std::unique_ptr<media::RendererFactory> renderer_factory);

    DecryptingRendererFactory(const DecryptingRendererFactory&) = delete;
    DecryptingRendererFactory& operator=(const DecryptingRendererFactory&) = delete;
