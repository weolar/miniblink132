...
scoped_refptr<VideoFrame> VideoOverlayFactory::CreateFrame(const gfx::Size& size)
{
    ...
    scoped_refptr<VideoFrame> frame = VideoFrame::CreateVideoHoleFrame(overlay_plane_id_,
        size, // natural size
