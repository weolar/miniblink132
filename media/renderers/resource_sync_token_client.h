...
class MEDIA_EXPORT ResourceSyncTokenClient : public VideoFrame::SyncTokenClient {
public:
    ...
    ResourceSyncTokenClient(gpu::InterfaceBase* gl, gpu::SyncToken old_frame_release_token, gpu::SyncToken new_plane_release_token);
