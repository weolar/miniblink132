...
LabelledExample::LabelledExample(FeatureVector feature_vector, TargetValue target)
    : features(std::move(feature_vector))
    , target_value(target)
{
}

LabelledExample::LabelledExample(std::initializer_list<FeatureValue> init_list, TargetValue target)
    : features(init_list)
    , target_value(target)
{
}
...
LabelledExample& LabelledExample::operator=(const LabelledExample& rhs) = default;

LabelledExample& LabelledExample::operator=(LabelledExample&& rhs) noexcept = default;
