...
class COMPONENT_EXPORT(LEARNING_COMMON) LearningSession : public base::SupportsUserData::Data {
public:
    LearningSession();
    ...
    virtual std::unique_ptr<LearningTaskController> GetController(const std::string& task_name) = 0;
};
