...
void FeatureDictionary::Lookup(const LearningTask& task, FeatureVector* features) const
{
...
void FeatureDictionary::Add(const std::string& name, const FeatureValue& value)
{
