...
public:
    ...
    virtual Model::PredictionCB GetPredictionCallback(const PredictionInfo& prediction_info);
...
protected:
    ...
    virtual void OnPrediction(const PredictionInfo& prediction_info, TargetHistogram predicted) = 0;
