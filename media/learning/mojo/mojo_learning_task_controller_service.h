...
class COMPONENT_EXPORT(MEDIA_LEARNING_MOJO) MojoLearningTaskControllerService : public mojom::LearningTaskController {
public:
    ...
    explicit MojoLearningTaskControllerService(
        const LearningTask& task, ukm::SourceId source_id, std::unique_ptr<::media::learning::LearningTaskController> impl);

    MojoLearningTaskControllerService(const MojoLearningTaskControllerService&) = delete;
    MojoLearningTaskControllerService& operator=(const MojoLearningTaskControllerService&) = delete;
