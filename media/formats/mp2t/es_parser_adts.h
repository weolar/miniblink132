...
public:
    using NewAudioConfigCB = base::RepeatingCallback<void(const AudioDecoderConfig&)>;

    EsParserAdts(NewAudioConfigCB new_audio_config_cb, EmitBufferCB emit_buffer_cb, bool sbr_in_mimetype);
    EsParserAdts(NewAudioConfigCB new_audio_config_cb, EmitBufferCB emit_buffer_cb, GetDecryptConfigCB get_decrypt_config_cb,
...
private:
    ...
    void CalculateSubsamplesForAdtsFrame(const AdtsFrame& adts_frame, std::vector<SubsampleEntry>* subsamples);
