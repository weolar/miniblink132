...
TsSectionCetsEcm::TsSectionCetsEcm(const RegisterNewKeyIdAndIvCB& register_new_key_id_and_iv_cb)
...
bool TsSectionCetsEcm::Parse(bool payload_unit_start_indicator, base::span<const uint8_t> buf)
{
