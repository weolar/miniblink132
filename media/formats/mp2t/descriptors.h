...
public:
    ...
    bool HasRegistrationDescriptor(int64_t* format_identifier, std::string* additional_info) const;
    ...
    // descriptor.
    bool HasCADescriptor(int* system_id, int* pid, std::string* private_data) const;
    ...
    bool HasCADescriptorCenc(int* ca_pid, int* pssh_pid, EncryptionScheme* scheme) const;
