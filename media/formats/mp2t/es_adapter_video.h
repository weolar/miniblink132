...
public:
    ...
    using EmitBufferCB = base::RepeatingCallback<void(scoped_refptr<StreamParserBuffer>)>;

    EsAdapterVideo(NewVideoConfigCB new_video_config_cb, EmitBufferCB emit_buffer_cb);
