...
bool EsParserAdtsTest::Process(const std::vector<Packet>& pes_packets, bool sbr_in_mimetype)
{
    EsParserAdts es_parser(base::BindRepeating(&EsParserAdtsTest::NewAudioConfig, base::Unretained(this)),
        base::BindRepeating(&EsParserAdtsTest::EmitBuffer, base::Unretained(this)), sbr_in_mimetype);
