...
public:
    ...
    // kNoTimestamp.
    base::TimeDelta GetAudioDefaultDuration(const int64_t timecode_scale_in_ns) const;
    base::TimeDelta GetVideoDefaultDuration(const int64_t timecode_scale_in_ns) const;
    ...
    int detected_audio_track_count() const
    {
        return detected_audio_track_count_;
    }

    int detected_video_track_count() const
    {
        return detected_video_track_count_;
    }
...
private:
    ...
    base::TimeDelta PrecisionCappedDefaultDuration(const int64_t timecode_scale_in_ns, const int64_t duration_in_ns) const;
