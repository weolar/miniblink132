...
private:
    ...
    class Track {
    public:
        Track(int track_num, TrackType track_type, base::TimeDelta default_duration, MediaLog* media_log);
        ...
        const BufferQueue& ready_buffers() const
        {
        ...
        base::TimeDelta default_duration() const
        {
...
public:
    WebMClusterParser(int64_t timecode_scale_ns, int audio_track_num, base::TimeDelta audio_default_duration, int video_track_num,
    ...
    base::TimeDelta cluster_start_time() const
    {
...
private:
    ...
    bool ParseBlock(bool is_simple_block, const uint8_t* buf, size_t size, const uint8_t* additional, int additional_size, int duration,
        int64_t discard_padding, bool reference_block_set);
    bool OnBlock(bool is_simple_block, int track_num, int timecode, int duration, const uint8_t* data, size_t size, const uint8_t* additional,
        size_t additional_size, int64_t discard_padding, bool is_keyframe);
