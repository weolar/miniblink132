...
{
    return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionType required.");
}

MATCHER(MissingProjectionPoseYaw, "")
{
    return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionPoseYaw required.");
}

MATCHER(MissingProjectionPosePitch, "")
{
    return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionPosePitch required.");
}

MATCHER(MissingProjectionPoseRoll, "")
{
    return CONTAINS_STRING(arg, "Projection element is incomplete; ProjectionPoseRoll required.");
}

class WebMProjectionParserTest : public testing::Test {
public:
    WebMProjectionParserTest()
        : projection_parser_(&media_log_)
    ...
    void VideoClientOnListEnd(int id)
    {
