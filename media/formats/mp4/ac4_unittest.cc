...
TEST_F(AC4Test, ShortInvalidInputTest)
{
    ...
    EXPECT_FALSE(Parse({ kTestData, kTestData + std::size(kTestData) / sizeof(uint8_t) }));
}
...
TEST_F(AC4Test, ChannelBasedCodingInputTest)
{
    ...
    constexpr uint8_t kTestData[] { 0x20, 0x9a, 0x01, 0x60, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xff, 0xe0, 0x01, 0x0e, 0xf9, 0x00, 0x00, 0x09, 0x00, 0x00,
        0x11, 0xca, 0x02, 0x00, 0x00, 0x11, 0xc0, 0x80 };

    EXPECT_TRUE(Parse({ kTestData, kTestData + std::size(kTestData) / sizeof(uint8_t) }));
...
TEST_F(AC4Test, IMSInputTest)
{
    ...
    // Channel mode        : Stereo
    // Channel layout      : L R
    constexpr uint8_t kTestData[] { 0x20, 0xba, 0x02, 0x40, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xff, 0xe0, 0x02, 0x0f, 0xf8, 0x80, 0x00, 0x00, 0x42, 0x00,
        0x00, 0x02, 0x50, 0x10, 0x00, 0x00, 0x03, 0x08, 0xc0, 0x01, 0x0f, 0xf8, 0x80, 0x00, 0x00, 0x42, 0x00, 0x00, 0x02, 0x50, 0x10, 0x00, 0x00, 0x03, 0x00,
        0xc0 };
...
TEST_F(AC4Test, AJOCInputTest)
{
    ...
    constexpr uint8_t kTestData[] { 0x20, 0xba, 0x01, 0x40, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xff, 0xe0, 0x01, 0x0b, 0xfc, 0x80, 0x00, 0x00, 0x08, 0x02,
        0x28, 0x3d, 0x20, 0x00, 0x00 };
