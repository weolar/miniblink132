...
public:
    ...
    H265AnnexBToHevcBitstreamConverter(const H265AnnexBToHevcBitstreamConverter&) = delete;
    H265AnnexBToHevcBitstreamConverter& operator=(const H265AnnexBToHevcBitstreamConverter&) = delete;
    ...
    MP4Status ConvertChunk(base::span<const uint8_t> input, base::span<uint8_t> output, bool* config_changed_out, size_t* size_out);
