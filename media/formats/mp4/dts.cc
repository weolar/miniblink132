...
{
    DVLOG(3) << "dts_sampling_freq " << dts_sampling_frequency_ << "max_bitrate " << max_bitrate_ << "avg_bitrate " << avg_bitrate_ << "pcm_sample_depth "
             << static_cast<int>(pcm_sample_depth_) << "frame_duration " << frame_duration_;
}
