...
TEST(ESDescriptorTest, SingleByteLengthTest)
{
    ...
    uint8_t buffer[] = { 0x03, 0x19, 0x00, 0x01, 0x00, 0x04, 0x11, 0x40, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x02,
...
{
    ESDescriptor es_desc;
    uint8_t buffer[] = { 0x03, 0x19, 0x00, 0x01, 0x00, 0x04, 0x11, 0x66, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x02,
        0x12, 0x10, 0x06, 0x01, 0x02 };
    std::vector<uint8_t> data;
...
{
    ESDescriptor es_desc;
    uint8_t buffer[] = { 0x03, 0x80, 0x19, 0x00, 0x01, 0x00, 0x04, 0x80, 0x80, 0x11, 0x40, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
TEST(ESDescriptorTest, FiveByteLengthTest)
{
    ESDescriptor es_desc;
    uint8_t buffer[] = { 0x03, 0x80, 0x19, 0x00, 0x01, 0x00, 0x04, 0x80, 0x80, 0x11, 0x40, 0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x05, 0x80, 0x80, 0x80, 0x80, 0x02, 0x12, 0x10, 0x06, 0x01, 0x02 };
    std::vector<uint8_t> data;
