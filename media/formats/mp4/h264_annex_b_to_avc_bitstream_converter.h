...
public:
    ...
    H264AnnexBToAvcBitstreamConverter(const H264AnnexBToAvcBitstreamConverter&) = delete;
    H264AnnexBToAvcBitstreamConverter& operator=(const H264AnnexBToAvcBitstreamConverter&) = delete;
