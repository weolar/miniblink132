...
enum Tag { kESDescrTag = 0x03, kDecoderConfigDescrTag = 0x04, kDecoderSpecificInfoTag = 0x05 };
...
public:
    ...
    static std::vector<uint8_t> CreateEsds(const std::vector<uint8_t>& aac_extra_data);
