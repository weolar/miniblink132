...
public:
    ...
    H26xAnnexBToBitstreamConverter(const H26xAnnexBToBitstreamConverter&) = delete;
    H26xAnnexBToBitstreamConverter& operator=(const H26xAnnexBToBitstreamConverter&) = delete;
