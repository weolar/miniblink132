...
SampleDescription& SampleDescription::operator=(const SampleDescription&) = default;

#if BUILDFLAG(USE_PROPRIETARY_CODECS)
ElementaryStreamDescriptor::ElementaryStreamDescriptor() = default;
ElementaryStreamDescriptor::~ElementaryStreamDescriptor() = default;
ElementaryStreamDescriptor::ElementaryStreamDescriptor(const ElementaryStreamDescriptor&) = default;
ElementaryStreamDescriptor& ElementaryStreamDescriptor::operator=(const ElementaryStreamDescriptor&) = default;
#endif

TrackFragmentRun::TrackFragmentRun() = default;
TrackFragmentRun::~TrackFragmentRun() = default;
TrackFragmentRun::TrackFragmentRun(const TrackFragmentRun&) = default;
TrackFragmentRun& TrackFragmentRun::operator=(const TrackFragmentRun&) = default;
...
TrackFragmentRandomAccess::~TrackFragmentRandomAccess() = default;
TrackFragmentRandomAccess::TrackFragmentRandomAccess(const TrackFragmentRandomAccess&) = default;
TrackFragmentRandomAccess& TrackFragmentRandomAccess::operator=(const TrackFragmentRandomAccess&) = default;

AudioSampleEntry::AudioSampleEntry(AudioCodec in_codec, uint32_t in_sample_rate, uint8_t in_channel_count)
    : codec(in_codec)
...
AudioSampleEntry& AudioSampleEntry::operator=(const AudioSampleEntry&) = default;

VPCodecConfiguration::VPCodecConfiguration(VideoCodecProfile in_profile, uint8_t in_level, const gfx::ColorSpace& in_color_space)
    : profile(in_profile)
    , level(in_level)
...
VisualSampleEntry::VisualSampleEntry(VideoCodec in_codec)
    : codec(in_codec)
{
}
VisualSampleEntry::~VisualSampleEntry() = default;
VisualSampleEntry::VisualSampleEntry(const VisualSampleEntry&) = default;
VisualSampleEntry& VisualSampleEntry::operator=(const VisualSampleEntry&) = default;
...
TrackHeader::TrackHeader(uint32_t in_track_id, bool in_is_audio)
    ...
    , is_audio(in_is_audio)
{
}

Track::Track(uint32_t track_id, bool is_audio)
    : header(track_id, is_audio)
    , media(is_audio)
{
}
...
AV1CodecConfiguration::~AV1CodecConfiguration() = default;
AV1CodecConfiguration::AV1CodecConfiguration(const AV1CodecConfiguration&) = default;
AV1CodecConfiguration& AV1CodecConfiguration::operator=(const AV1CodecConfiguration&) = default;
