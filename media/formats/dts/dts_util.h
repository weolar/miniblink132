...
MEDIA_EXPORT int ParseTotalSampleCount(const uint8_t* data, size_t size, AudioCodec dts_codec_type);
...
MEDIA_EXPORT int WrapDTSWithIEC61937(base::span<const uint8_t> input_data, base::span<uint8_t> output_data, AudioCodec dts_codec_type);
