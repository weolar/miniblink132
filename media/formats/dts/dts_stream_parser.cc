...
int DTSStreamParser::ParseFrameHeader(const uint8_t* data, int size, int* frame_size, int* sample_rate, ChannelLayout* channel_layout, int* sample_count,
    bool* metadata_frame, std::vector<uint8_t>* extra_data)
{
    ...
    constexpr int kSampleRateCore[16] = { 0, 8000, 16000, 32000, 0, 0, 11025, 22050, 44100, 0, 0, 12000, 24000, 48000, 0, 0 };
