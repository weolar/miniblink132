...
template <typename... Strings> scoped_refptr<MediaPlaylist> CreateMediaPlaylist(Strings... strings)
{
...
{
    auto segment_stream = std::make_unique<SegmentStream>(CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0",
                                                              "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD", "#EXTINF:9.2,", "video.ts", "#EXT-X-ENDLIST"),
        /*seekable=*/true);
...
{
    auto segment_stream
        = std::make_unique<SegmentStream>(CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0",
                                              "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD", "#EXTINF:9.2,", "video1.ts", "#EXTINF:9.2,", "video2.ts", "#EXT-X-ENDLIST"),
            /*seekable=*/true);
...
TEST(SegmentStreamUnittest, SeekablePlaylistAdapt)
{
    auto segment_stream = std::make_unique<SegmentStream>(
        CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0", "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD", "#EXTINF:9.2,",
            "video1_low.ts", "#EXTINF:9.2,", "video2_low.ts", "#EXTINF:9.2,", "video3_low.ts", "#EXTINF:9.2,", "video4_low.ts", "#EXTINF:9.2,", "video5_low.ts",
            "#EXT-X-ENDLIST"),
        /*seekable=*/true);
    ...
    segment_stream->SetNewPlaylist(CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0",
        "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD", "#EXTINF:9.2,", "video1_high.ts", "#EXTINF:9.2,", "video2_high.ts", "#EXTINF:9.2,", "video3_high.ts", "#EXTINF:9.2,",
        "video4_high.ts", "#EXTINF:9.2,", "video5_high.ts", "#EXT-X-ENDLIST"));
    ...
    // adapt downwards:
    segment_stream->SetNewPlaylist(CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0",
        "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD", "#EXTINF:9.2,", "video1_low.ts", "#EXTINF:9.2,", "video2_low.ts", "#EXTINF:9.2,", "video3_low.ts", "#EXTINF:9.2,",
        "video4_low.ts", "#EXTINF:9.2,", "video5_low.ts", "#EXT-X-ENDLIST"));
...
{
    auto segment_stream = std::make_unique<SegmentStream>(
        CreateMediaPlaylist("#EXT-X-VERSION:1", "#EXT-X-TARGETDURATION:2", "#EXT-X-MEDIA-SEQUENCE:20909320", "#EXTINF:2.00000,", "playlist_800Kb_20909320.ts",
            "#EXTINF:2.00000,", "playlist_800Kb_20909321.ts", "#EXTINF:2.00000,", "playlist_800Kb_20909322.ts", "#EXTINF:2.00000,",
            "playlist_800Kb_20909323.ts", "#EXTINF:2.00000,", "playlist_800Kb_20909324.ts", "#EXTINF:2.00000,", "playlist_800Kb_20909325.ts",
            "#EXTINF:2.00000,", "playlist_800Kb_20909326.ts", "#EXTINF:2.00000,", "playlist_800Kb_20909327.ts", "#EXTINF:2.00000,",
            "playlist_800Kb_20909328.ts", "#EXTINF:2.00000,", "playlist_800Kb_20909329.ts"),
        false);
    ...
    segment_stream->SetNewPlaylist(CreateMediaPlaylist("#EXT-X-VERSION:1", "#EXT-X-TARGETDURATION:2", "#EXT-X-MEDIA-SEQUENCE:20909321", "#EXTINF:2.00000,",
        "playlist_2500Kb_20909321.ts", "#EXTINF:2.00000,", "playlist_2500Kb_20909322.ts", "#EXTINF:2.00000,", "playlist_2500Kb_20909323.ts", "#EXTINF:2.00000,",
        "playlist_2500Kb_20909324.ts", "#EXTINF:2.00000,", "playlist_2500Kb_20909325.ts", "#EXTINF:2.00000,", "playlist_2500Kb_20909326.ts", "#EXTINF:2.00000,",
        "playlist_2500Kb_20909327.ts", "#EXTINF:2.00000,", "playlist_2500Kb_20909328.ts", "#EXTINF:2.00000,", "playlist_2500Kb_20909329.ts", "#EXTINF:2.00000,",
...
{
    auto segment_stream
        = std::make_unique<SegmentStream>(CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:10",
                                              "#EXT-X-MEDIA-PLAYLIST-TYPE:LIVE", "#EXTINF:9.2,", "video10_low.ts", "#EXTINF:9.2,", "video11_low.ts",
                                              "#EXTINF:9.2,", "video12_low.ts", "#EXTINF:9.2,", "video13_low.ts", "#EXTINF:9.2,", "video14_low.ts"),
            /*seekable=*/false);
    ...
    // pick right up at 14.
    segment_stream->SetNewPlaylist(CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:12",
        "#EXT-X-MEDIA-PLAYLIST-TYPE:LIVE", "#EXTINF:9.2,", "video12_low.ts", "#EXTINF:9.2,", "video13_low.ts", "#EXTINF:9.2,", "video14_low.ts", "#EXTINF:9.2,",
        "video15_low.ts", "#EXTINF:9.2,", "video16_low.ts", "#EXT-X-ENDLIST"));
    ...
    segment_stream->SetNewPlaylist(CreateMediaPlaylist("#EXT-X-TARGETDURATION:10", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:15",
        "#EXT-X-MEDIA-PLAYLIST-TYPE:LIVE", "#EXTINF:9.2,", "video15_low.ts", "#EXTINF:9.2,", "video16_low.ts", "#EXTINF:9.2,", "video17_low.ts", "#EXTINF:9.2,",
        "video18_low.ts", "#EXTINF:9.2,", "video19_low.ts", "#EXT-X-ENDLIST"));
    ASSERT_FALSE(segment_stream->Exhausted());
...
{
    auto segment_stream = std::make_unique<SegmentStream>(
        CreateMediaPlaylist("#EXT-X-TARGETDURATION:12", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0", "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD",
            "#EXTINF:12.00000,", // Encrypted content commonly leads with
            "playlist_100000Kb_0.ts", // a few clear segments.
            "#EXT-X-KEY:METHOD=AES-128,URI=\"example.com/key1\"", "#EXTINF:12.0000000,", "playlist_100000Kb_1.ts", "#EXTINF:12.0000000,",
            "playlist_100000Kb_2.ts", "#EXTINF:12.0000000,", "playlist_100000Kb_3.ts", "#EXTINF:12.0000000,", "playlist_100000Kb_4.ts",
            "#EXT-X-KEY:METHOD=AES-128,URI=\"example.com/key2\"", "#EXTINF:12.0000000,", "playlist_100000Kb_5.ts", "#EXTINF:12.0000000,",
            "playlist_100000Kb_6.ts", "#EXTINF:12.0000000,", "playlist_100000Kb_7.ts", "#EXTINF:12.0000000,", "playlist_100000Kb_8.ts"),
        true);
    ...
    segment_stream->SetNewPlaylist(
        CreateMediaPlaylist("#EXT-X-TARGETDURATION:12", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0", "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD",
            ...
            "#EXT-X-KEY:METHOD=AES-128,URI=\"example.com/key3\"", "#EXTINF:12.0000000,", "playlist_200000Kb_1.ts", "#EXTINF:12.0000000,",
            "playlist_200000Kb_2.ts", "#EXTINF:12.0000000,", "playlist_200000Kb_3.ts", "#EXTINF:12.0000000,", "playlist_200000Kb_4.ts",
            "#EXT-X-KEY:METHOD=AES-128,URI=\"example.com/key4\"", "#EXTINF:12.0000000,", "playlist_200000Kb_5.ts", "#EXTINF:12.0000000,",
            "playlist_200000Kb_6.ts", "#EXTINF:12.0000000,", "playlist_200000Kb_7.ts", "#EXTINF:12.0000000,", "playlist_200000Kb_8.ts"));
    ...
    segment_stream->SetNewPlaylist(
        CreateMediaPlaylist("#EXT-X-TARGETDURATION:12", "#EXT-X-VERSION:1", "#EXT-X-MEDIA-SEQUENCE:0", "#EXT-X-MEDIA-PLAYLIST-TYPE:VOD",
            ...
            "#EXT-X-KEY:METHOD=AES-128,URI=\"example.com/key3\"", "#EXTINF:12.0000000,", "playlist_300000Kb_1.ts", "#EXTINF:12.0000000,",
            "playlist_300000Kb_2.ts", "#EXTINF:12.0000000,", "playlist_300000Kb_3.ts", "#EXTINF:12.0000000,", "playlist_300000Kb_4.ts",
            "#EXT-X-KEY:METHOD=AES-128,URI=\"example.com/key4\"", "#EXTINF:12.0000000,", "playlist_300000Kb_5.ts", "#EXTINF:12.0000000,",
            "playlist_300000Kb_6.ts", "#EXTINF:12.0000000,", "playlist_300000Kb_7.ts", "#EXTINF:12.0000000,", "playlist_300000Kb_8.ts"));
