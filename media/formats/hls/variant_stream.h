...
public:
    ...
    VariantStream(GURL primary_rendition_uri, types::DecimalInteger bandwidth, std::optional<types::DecimalInteger> average_bandwidth,
        std::optional<types::DecimalFloatingPoint> score, std::optional<std::vector<std::string>> codecs, std::optional<types::DecimalResolution> resolution,
        std::optional<types::DecimalFloatingPoint> frame_rate, scoped_refptr<AudioRenditionGroup> audio_renditions,
    ...
    const GURL& GetPrimaryRenditionUri() const
    {
        return primary_rendition_uri_;
    }
    ...
    types::DecimalInteger GetBandwidth() const
    {
        return bandwidth_;
    }
    ...
    std::optional<types::DecimalFloatingPoint> GetScore() const
    {
        return score_;
    }
    ...
    const std::string Format(const std::vector<FormatComponent>& components, uint32_t stream_index) const;
