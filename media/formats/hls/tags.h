...
struct MEDIA_EXPORT XDefineTag {
    ...
    static XDefineTag CreateDefinition(types::VariableName name, std::string_view value);
...
struct MEDIA_EXPORT XMediaTag {
    ...
    static ParseStatus::Or<XMediaTag> Parse(TagItem, const VariableDictionary& variable_dict, VariableDictionary::SubstitutionBuffer& sub_buffer);
...
struct MEDIA_EXPORT XStreamInfTag {
    ...
    static ParseStatus::Or<XStreamInfTag> Parse(TagItem, const VariableDictionary& variable_dict, VariableDictionary::SubstitutionBuffer& sub_buffer);
...
struct MEDIA_EXPORT XMapTag {
    ...
    static ParseStatus::Or<XMapTag> Parse(TagItem, const VariableDictionary& variable_dict, VariableDictionary::SubstitutionBuffer& sub_buffer);
...
struct MEDIA_EXPORT XPartTag {
    ...
    static ParseStatus::Or<XPartTag> Parse(TagItem, const VariableDictionary& variable_dict, VariableDictionary::SubstitutionBuffer& sub_buffer);
...
struct MEDIA_EXPORT XSkipTag {
    ...
    static ParseStatus::Or<XSkipTag> Parse(TagItem, const VariableDictionary& variable_dict, VariableDictionary::SubstitutionBuffer& sub_buffer);
    ...
    std::optional<std::vector<std::string>> recently_removed_dateranges = std::nullopt;
};
...
struct MEDIA_EXPORT XRenditionReportTag {
    ...
    static ParseStatus::Or<XRenditionReportTag> Parse(TagItem, const VariableDictionary&, VariableDictionary::SubstitutionBuffer&);
...
struct MEDIA_EXPORT XKeyTag {
    ...
    static ParseStatus::Or<XKeyTag> Parse(TagItem, const VariableDictionary&, VariableDictionary::SubstitutionBuffer&);
...
struct MEDIA_EXPORT XSessionKeyTag {
    ...
    static ParseStatus::Or<XSessionKeyTag> Parse(TagItem, const VariableDictionary&, VariableDictionary::SubstitutionBuffer&);
