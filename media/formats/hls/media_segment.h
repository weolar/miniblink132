...
public:
    ...
    class MEDIA_EXPORT InitializationSegment : public base::RefCounted<InitializationSegment> {
    public:
        REQUIRE_ADOPTION_FOR_REFCOUNTED_TYPE();
        ...
        InitializationSegment& operator=(const InitializationSegment& copy) = delete;
        ...
        // indicates the range.
        std::optional<types::ByteRange> GetByteRange() const
        {
            return byte_range_;
        }
    ...
    public:
        ...
        EncryptionData(GURL uri, XKeyTagMethod method, XKeyTagKeyFormat format, IVContainer iv);
        ...
        XKeyTagMethod GetMethod() const
        {
            return method_;
        }
        crypto::SymmetricKey* GetKey() const
        {
            return key_.get();
        }
        XKeyTagKeyFormat GetKeyFormat() const
        {
            return format_;
        }

        bool NeedsKeyFetch() const
        {
            return !key_;
        }
        ...
        std::optional<std::string> GetIVStr(types::DecimalInteger media_sequence_number) const;
    ...
    MediaSegment(base::TimeDelta duration, types::DecimalInteger media_sequence_number, types::DecimalInteger discontinuity_sequence_number, GURL uri,
        scoped_refptr<InitializationSegment> initialization_segment, scoped_refptr<EncryptionData> encryption_data, std::optional<types::ByteRange> byte_range,
        std::optional<types::DecimalInteger> bitrate, bool has_discontinuity, bool is_gap, bool has_new_init_segment, bool has_new_encryption_data);
    ...
    bool HasNewInitSegment() const
    {
        return has_new_init_segment_;
    }
    ...
    bool HasNewEncryptionData() const
    {
        return has_new_encryption_data_;
    }
    ...
    // bits-per-second.
    std::optional<types::DecimalInteger> GetBitRate() const
    {
        return bitrate_;
    }
