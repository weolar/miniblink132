...
public:
    ...
    static constexpr base::TimeDelta kMaxTargetDuration = base::TimeDelta::FiniteMax() / 10;
    ...
    base::TimeDelta GetTargetDuration() const
    {
    ...
    // actual duration.
    base::TimeDelta GetComputedDuration() const
    {
        return computed_duration_;
    }
    ...
    std::optional<PlaylistType> GetPlaylistType() const
    {
    ...
    bool IsIFramesOnly() const
    {
        return i_frames_only_;
    }
    ...
    bool HasMediaSequenceTag() const
    {
        return has_media_sequence_tag_;
    }
    ...
    // https://datatracker.ietf.org/doc/html/draft-pantos-hls-rfc8216bis#section-6.2.5.1
    bool CanSkipDateRanges() const
    {
        return can_skip_dateranges_;
    }
    ...
    base::TimeDelta GetHoldBackDistance() const
    {
        return hold_back_distance_;
    }
    ...
    bool CanBlockReload() const
    {
        return can_block_reload_;
    }
    ...
    static ParseStatus::Or<scoped_refptr<MediaPlaylist>> Parse(
        std::string_view source, GURL uri, types::DecimalInteger version, const MultivariantPlaylist* parent_playlist, TagRecorder* tag_recorder = nullptr);
