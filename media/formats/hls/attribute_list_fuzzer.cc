...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    auto attributes
        = AttributeMap::MakeStorage("ALLOWED-CPC", "AUDIO", "AVERAGE-BANDWIDTH", "BANDWIDTH", "CLOSED-CAPTIONS", "CODECS", "FRAME-RATE", "HDCP-LEVEL",
            "PATHWAY-ID"
            "RESOLUTION",
    ...
    CHECK(error == ParseStatusCode::kReachedEOF || error == ParseStatusCode::kMalformedAttributeList
