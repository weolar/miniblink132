...
public:
    ...
    std::optional<std::string_view> Find(types::VariableName name) const&& = delete;
    ...
    ParseStatus::Or<ResolvedSourceString> Resolve(SourceString input, SubstitutionBuffer& buffer) const;
