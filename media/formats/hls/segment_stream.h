...
using SegmentInfo = std::tuple<scoped_refptr<MediaSegment>, base::TimeDelta, base::TimeDelta>;
...
private:
    ...
    public:
        ...
        SegmentIndex(types::DecimalInteger discontinuity, types::DecimalInteger media);
