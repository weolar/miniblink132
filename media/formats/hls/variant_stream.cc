...
VariantStream::VariantStream(GURL primary_rendition_uri, types::DecimalInteger bandwidth, std::optional<types::DecimalInteger> average_bandwidth,
    ...
    std::optional<types::DecimalFloatingPoint> frame_rate, scoped_refptr<AudioRenditionGroup> audio_rendition_group,
...
const std::string VariantStream::Format(const std::vector<FormatComponent>& components, uint32_t stream_index) const
{
