...
BASE_FEATURE(kWebRtcAllowDxgiGdiZeroHz, "AllowDxgiGdiZeroHz", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcAllowWgcScreenCapturer, "AllowWgcScreenCapturer", base::FEATURE_DISABLED_BY_DEFAULT);

// When enabled we will tell WebRTC that we want to use the
// Windows.Graphics.Capture API based window capturer, if it is available.
BASE_FEATURE(kWebRtcAllowWgcWindowCapturer, "AllowWgcWindowCapturer", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcAllowWgcScreenZeroHz, "AllowWgcScreenZeroHz", base::FEATURE_DISABLED_BY_DEFAULT);
// This flag only has an effect if kWebRtcAllowWgcWindowCapturer is enabled.
BASE_FEATURE(kWebRtcAllowWgcWindowZeroHz, "AllowWgcWindowZeroHz", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcAllowInputVolumeAdjustment, "WebRtcAllowInputVolumeAdjustment", base::FEATURE_ENABLED_BY_DEFAULT);
...
// needed).
BASE_FEATURE(kWebRtcApmDownmixCaptureAudioMethod, "WebRtcApmDownmixCaptureAudioMethod", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcApmTellsIfPlayoutReferenceIsNeeded, "WebRtcApmTellsIfPlayoutReferenceIsNeeded", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcAllowH265Send, "WebRtcAllowH265Send", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcAllowH265Receive, "WebRtcAllowH265Receive", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcApm48kHzSampleRateOnAndroidKillSwitch, "WebRtcApm48kHzSampleRateOnAndroidKillSwitch", base::FEATURE_DISABLED_BY_DEFAULT);
#endif
