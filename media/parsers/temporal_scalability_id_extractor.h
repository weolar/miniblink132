...
public:
    ...
    bool ParseChunk(base::span<const uint8_t> chunk, uint32_t frame_id, BitstreamMetadata& md);
...
private:
    ...
    bool ParseVP9(base::span<const uint8_t> chunk, uint32_t frame_id, int tid_by_svc_spec, BitstreamMetadata& md);

    bool ParseAV1(base::span<const uint8_t> chunk, uint32_t frame_id, int tid_by_svc_spec, BitstreamMetadata& md);
