...
struct MEDIA_EXPORT H265ScalingListData {
    ...
    uint8_t scaling_list_8x8[kNumScalingListMatrices][kScalingListSizeId1To3Count];
    uint8_t scaling_list_16x16[kNumScalingListMatrices][kScalingListSizeId1To3Count];
    uint8_t scaling_list_32x32[kNumScalingListMatrices][kScalingListSizeId1To3Count];
    ...
    uint8_t GetScalingList4x4EntryInRasterOrder(size_t matrix_id, size_t raster_idx) const;
    uint8_t GetScalingList8x8EntryInRasterOrder(size_t matrix_id, size_t raster_idx) const;
    uint8_t GetScalingList16x16EntryInRasterOrder(size_t matrix_id, size_t raster_idx) const;
    uint8_t GetScalingList32x32EntryInRasterOrder(size_t matrix_id, size_t raster_idx) const;
};
