...
TEST(JpegParserTest, Parsing)
{
    ...
    base::FilePath file_path = data_dir.AppendASCII("media").AppendASCII("test").AppendASCII("data").AppendASCII("pixel-1280x720.jpg");
...
TEST(JpegParserTest, TrailingZerosShouldBeIgnored)
{
    base::FilePath data_dir;
    ASSERT_TRUE(base::PathService::Get(base::DIR_SRC_TEST_DATA_ROOT, &data_dir));
    base::FilePath file_path = data_dir.AppendASCII("media").AppendASCII("test").AppendASCII("data").AppendASCII("pixel-1280x720-trailing-zeros.jpg");
...
TEST(JpegParserTest, CodedSizeNotEqualVisibleSize)
{
    ...
    base::FilePath file_path = data_dir.AppendASCII("media").AppendASCII("test").AppendASCII("data").AppendASCII("blank-1x1.jpg");
