...
struct Vp8EntropyHeader {
    uint8_t coeff_probs[kNumBlockTypes][kNumCoeffBands][kNumPrevCoeffContexts][kNumEntropyNodes];
...
struct MEDIA_EXPORT Vp8FrameHeader {
    ...
    GoldenRefreshMode copy_buffer_to_golden = GoldenRefreshMode::NO_GOLDEN_REFRESH;
...
private:
    ...
    bool ParseIntraProbs(Vp8EntropyHeader* ehdr, bool update_curr_probs, bool keyframe);
