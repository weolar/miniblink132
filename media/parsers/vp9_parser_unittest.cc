...
protected:
    ...
    void Initialize(std::string_view filename, bool parsing_compressed_header)
    {
        ...
        if (parsing_compressed_header) {
            base::FilePath context_path = GetTestDataFilePath(std::string(filename).append(".context"));
...
TEST_F(Vp9ParserTest, AlignedFrameSubsampleParsing)
{
    ...
    expected.push_back(DecryptConfig::CreateCbcsConfig(kKeyID, kInitialIV, { SubsampleEntry(16, 16) }, std::nullopt));

    expected.push_back(DecryptConfig::CreateCbcsConfig(kKeyID, kIVIncrementOne, { SubsampleEntry(16, 16) }, std::nullopt));
...
TEST_F(Vp9ParserTest, UnalignedFrameSubsampleParsing)
{
    ...
    std::vector<std::unique_ptr<DecryptConfig>> expected;
    expected.push_back(DecryptConfig::CreateCbcsConfig(kKeyID, kInitialIV, { SubsampleEntry(32, 0) }, std::nullopt));
...
TEST_F(Vp9ParserTest, ClearSectionRollsOverSubsampleParsing)
{
    ...
    std::vector<std::unique_ptr<DecryptConfig>> expected;
    expected.push_back(DecryptConfig::CreateCbcsConfig(kKeyID, kInitialIV, { SubsampleEntry(16, 16), SubsampleEntry(16, 0) }, std::nullopt));
...
TEST_F(Vp9ParserTest, FirstFrame2xSubsampleParsing)
{
    ...
    std::vector<std::unique_ptr<DecryptConfig>> expected;
    expected.push_back(DecryptConfig::CreateCbcsConfig(kKeyID, kInitialIV, { SubsampleEntry(16, 16), SubsampleEntry(16, 16) }, std::nullopt));

    expected.push_back(DecryptConfig::CreateCbcsConfig(kKeyID, kIVIncrementTwo, { SubsampleEntry(16, 16) }, std::nullopt));
...
TEST_F(Vp9ParserTest, UnalignedBigFrameSubsampleParsing)
{
    ...
    std::vector<std::unique_ptr<DecryptConfig>> expected;
    expected.push_back(
        DecryptConfig::CreateCbcsConfig(kKeyID, kInitialIV, { SubsampleEntry(16, 16), SubsampleEntry(16, 16), SubsampleEntry(8, 0) }, std::nullopt));
