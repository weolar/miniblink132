...
public:
    ...
    int32_t ComputePicOrderCnt(const H266SPS* sps, const H266PPS* pps, const H266VPS* vps, const H266PictureHeader* ph, const H266SliceHeader& slice_hdr);
    ...
    // when RPR is enabled.
    static void ComputeRefPicPocList(const H266SPS* sps, const H266PPS* pps, const H266VPS* vps, const H266PictureHeader* ph, const H266SliceHeader& slice_hdr,
