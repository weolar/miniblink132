...
public:
    static std::unique_ptr<GenericDmaBufVideoFrameMapper> Create(VideoPixelFormat format);

    GenericDmaBufVideoFrameMapper(const GenericDmaBufVideoFrameMapper&) = delete;
    GenericDmaBufVideoFrameMapper& operator=(const GenericDmaBufVideoFrameMapper&) = delete;
