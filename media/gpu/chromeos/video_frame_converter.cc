...
void VideoFrameConverter::Initialize(scoped_refptr<base::SequencedTaskRunner> parent_task_runner, OutputCB output_cb)
{
...
void default_delete<media::VideoFrameConverter>::operator()(media::VideoFrameConverter* ptr) const
{
    ptr->Destroy();
}
