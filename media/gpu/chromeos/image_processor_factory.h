...
public:
    ...
    using PickFormatCB
        = base::RepeatingCallback<std::optional<Fourcc>(const std::vector<Fourcc>& /* candidates */, std::optional<Fourcc> /* preferred_fourcc */)>;
    ...
    static std::unique_ptr<ImageProcessor> Create(const ImageProcessor::PortConfig& input_config, const ImageProcessor::PortConfig& output_config,
    ...
    static std::unique_ptr<ImageProcessor> CreateWithInputCandidates(const std::vector<ImageProcessor::PixelLayoutCandidate>& input_candidates,
    ...
    static std::unique_ptr<ImageProcessor> CreateLibYUVImageProcessorWithInputCandidatesForTesting(
    ...
    static std::unique_ptr<ImageProcessor> CreateGLImageProcessorWithInputCandidatesForTesting(
        const std::vector<ImageProcessor::PixelLayoutCandidate>& input_candidates, const gfx::Rect& input_visible_rect, const gfx::Size& output_size,
        size_t num_buffers, scoped_refptr<base::SequencedTaskRunner> client_task_runner, PickFormatCB out_format_picker, ImageProcessor::ErrorCB error_cb);
#endif
