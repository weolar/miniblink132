...
public:
    ...
    virtual scoped_refptr<const gfx::NativePixmapDmaBuf> GetNativePixmapDmaBuf() const = 0;
    ...
    virtual std::unique_ptr<VideoFrame::ScopedMapping> MapGMBOrSharedImage() const = 0;
    ...
    virtual void set_hdr_metadata(const std::optional<gfx::HDRMetadata>& hdr_metadata) = 0;
    ...
    virtual scoped_refptr<FrameResource> CreateWrappingFrame(const gfx::Rect& visible_rect, const gfx::Size& natural_size) = 0;
    ...
    virtual gfx::GpuMemoryBufferHandle GetGpuMemoryBufferHandleForTesting() const = 0;
