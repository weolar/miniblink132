...
public:
    using CreateFrameCB = base::RepeatingCallback<CroStatus::Or<scoped_refptr<FrameResource>>(
        VideoPixelFormat, const gfx::Size&, const gfx::Rect&, const gfx::Size&, bool, bool, bool, base::TimeDelta)>;
    ...
    virtual void set_parent_task_runner(scoped_refptr<base::SequencedTaskRunner> parent_task_runner);
    ...
    virtual CroStatus::Or<GpuBufferLayout> Initialize(const Fourcc& fourcc, const gfx::Size& coded_size, const gfx::Rect& visible_rect,
        const gfx::Size& natural_size, size_t max_num_frames, bool use_protected, bool use_linear_buffers = false)
        = 0;
