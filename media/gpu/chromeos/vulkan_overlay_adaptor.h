...
public:
    ...
    static std::unique_ptr<VulkanOverlayAdaptor> Create(bool is_protected, TiledImageFormat format = kMM21, const gfx::Size& max_size = gfx::Size(3840, 2160));
    ...
    void Process(gpu::VulkanImage& in_image, const gfx::Size& input_visible_size, gpu::VulkanImage& out_image, const gfx::RectF& display_rect,
        const gfx::RectF& crop_rect, gfx::OverlayTransform transform, std::vector<VkSemaphore>& begin_semaphores, std::vector<VkSemaphore>& end_sempahores);
...
private:
    ...
    VulkanOverlayAdaptor(std::unique_ptr<gpu::VulkanImplementation> vulkan_implementation,
        std::unique_ptr<VulkanOverlayAdaptor::VulkanDeviceQueueWrapper> vulkan_device_queue,
        std::unique_ptr<VulkanOverlayAdaptor::VulkanCommandPoolWrapper> command_pool,
    ...
    std::unique_ptr<VulkanOverlayAdaptor::VulkanDeviceQueueWrapper> vulkan_device_queue_;
    ...
    std::unique_ptr<VulkanOverlayAdaptor::VulkanRenderPass> transform_render_pass_;
    ...
    std::unique_ptr<VulkanOverlayAdaptor::VulkanDescriptorPool> convert_descriptor_pool_;
    std::unique_ptr<VulkanOverlayAdaptor::VulkanDescriptorPool> transform_descriptor_pool_;
