...
public:
    ...
    static scoped_refptr<VideoFrameResource> Create(scoped_refptr<VideoFrame> frame);
    static scoped_refptr<const VideoFrameResource> CreateConst(scoped_refptr<const VideoFrame> frame);
