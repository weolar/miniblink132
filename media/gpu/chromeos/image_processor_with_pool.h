...
public:
    ...
    static CroStatus::Or<std::unique_ptr<ImageProcessorWithPool>> Create(std::unique_ptr<ImageProcessor> image_processor,
    ...
    void Process(scoped_refptr<FrameResource> frame, FrameResourceReadyCB ready_cb);
    ...
    {
        return image_processor_->backend_type();
    }
...
private:
    ...
    void OnFrameProcessed(FrameResourceReadyCB ready_cb, scoped_refptr<FrameResource> frame);
    ...
    base::queue<std::pair<scoped_refptr<FrameResource>, FrameResourceReadyCB>> pending_frames_;
