...
public:
    ...
    explicit D3D11VideoDecoderImpl(std::unique_ptr<MediaLog> media_log, base::RepeatingCallback<scoped_refptr<CommandBufferHelper>()> get_helper_cb);
    ...
    using ReturnPictureBufferCB = base::RepeatingCallback<void(scoped_refptr<D3D11PictureBuffer>)>;
