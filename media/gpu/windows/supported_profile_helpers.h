...
MEDIA_GPU_EXPORT GUID GetHEVCRangeExtensionPrivateGUID(uint8_t bitdepth, VideoChromaSampling chroma_sampling);
#endif // BUILDFLAG(ENABLE_HEVC_PARSER_AND_HW_DECODER)

// Get the DXGI_FORMAT for the video decoder output texture, according to the
// bit depth and chroma sampling format.
MEDIA_GPU_EXPORT DXGI_FORMAT GetOutputDXGIFormat(uint8_t bitdepth, VideoChromaSampling chroma_sampling);
...
using SupportedResolutionRangeMap = base::flat_map<VideoCodecProfile, SupportedResolutionRange>;
