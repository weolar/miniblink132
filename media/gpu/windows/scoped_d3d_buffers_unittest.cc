...
{
    D3DInputBuffer input_buffer(std::unique_ptr<ScopedD3DBuffer>(new MemoryBuffer(size_)));
...
{
    ScopedRandomAccessD3DInputBuffer buffer(std::unique_ptr<ScopedD3DBuffer>(new MemoryBuffer(size_)));
...
{
    ScopedSequenceD3DInputBuffer buffer(std::unique_ptr<ScopedD3DBuffer>(new MemoryBuffer(size_)));
