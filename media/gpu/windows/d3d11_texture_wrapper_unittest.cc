...
public:
    void SetUp() override
    {
        ...
        display_ = gl::GLSurfaceTestSupport::InitializeOneOffImplementation(gl::GLImplementationParts(gl::ANGLEImplementation::kD3D11));
        ...
        fake_command_buffer_helper_ = base::MakeRefCounted<FakeCommandBufferHelper>(task_runner_);
        get_helper_cb_ = base::BindRepeating([](scoped_refptr<CommandBufferHelper> helper) { return helper; }, fake_command_buffer_helper_);
    }
...
TEST_F(D3D11TextureWrapperUnittest, NV12InitSucceeds)
{
    ...
    auto wrapper = std::make_unique<DefaultTexture2DWrapper>(size_, color_space_, dxgi_format,
        /*device=*/nullptr);
    const D3D11Status init_result = wrapper->Init(task_runner_, get_helper_cb_, /*in_texture=*/nullptr,
