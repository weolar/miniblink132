...
public:
    ...
    {
        output_queue_.SetOutputCB(base::BindRepeating(&VideoToolboxOutputQueueTest::OnOutput, base::Unretained(this)));
    }
...
protected:
    ...
    void Flush()
    {
        output_queue_.Flush(base::BindOnce(&VideoToolboxOutputQueueTest::OnFlush, base::Unretained(this)));
    }

    base::test::TaskEnvironment task_environment_;
    VideoToolboxOutputQueue output_queue_ { task_environment_.GetMainThreadTaskRunner() };
};
