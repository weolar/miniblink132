...
class MEDIA_GPU_EXPORT VideoToolboxVP9Accelerator : public VP9Decoder::VP9Accelerator {
public:
    using DecodeCB
    ...
    VideoToolboxVP9Accelerator(std::unique_ptr<MediaLog> media_log, std::optional<gfx::HDRMetadata> hdr_metadata, DecodeCB decode_cb, OutputCB output_cb);
