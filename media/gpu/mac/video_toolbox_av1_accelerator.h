...
class MEDIA_GPU_EXPORT VideoToolboxAV1Accelerator : public AV1Decoder::AV1Accelerator {
public:
    using DecodeCB
    ...
    VideoToolboxAV1Accelerator(std::unique_ptr<MediaLog> media_log, std::optional<gfx::HDRMetadata> hdr_metadata, DecodeCB decode_cb, OutputCB output_cb);
    ...
    Status SubmitDecode(const AV1Picture& pic, const libgav1::ObuSequenceHeader& sequence_header, const AV1ReferenceFrameVector& ref_frames,
...
private:
    bool ProcessFormat(const AV1Picture& pic, const libgav1::ObuSequenceHeader& sequence_header, base::span<const uint8_t> data);
