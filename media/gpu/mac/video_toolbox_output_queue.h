...
public:
    ...
    explicit VideoToolboxOutputQueue(scoped_refptr<base::SequencedTaskRunner> task_runner);
    ...
    void FulfillPicture(scoped_refptr<CodecPicture> picture, scoped_refptr<VideoFrame> frame);
...
private:
    ...
    base::flat_map<scoped_refptr<CodecPicture>, scoped_refptr<VideoFrame>> fulfilled_pictures_;
};
