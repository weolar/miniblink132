...
public:
    ...
    public:
        ...
        virtual scoped_refptr<VP9Picture> CreateVP9PictureSecure(uint64_t secure_handle);
        ...
        virtual Status SubmitDecode(scoped_refptr<VP9Picture> pic, const Vp9SegmentationParams& segm_params, const Vp9LoopFilterParams& lf_params,
    ...
    explicit VP9Decoder(
        std::unique_ptr<VP9Accelerator> accelerator, VideoCodecProfile profile, const VideoColorSpace& container_color_space = VideoColorSpace());
