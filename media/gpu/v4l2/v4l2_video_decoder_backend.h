...
public:
    ...
    public:
        ...
        virtual void ChangeResolution(gfx::Size pic_size, gfx::Rect visible_rect, size_t num_codec_reference_frames, uint8_t bit_depth) = 0;
    ...
    virtual void EnqueueDecodeTask(scoped_refptr<DecoderBuffer> buffer, VideoDecoder::DecodeCB decode_cb) = 0;
    ...
    // queue.
    virtual bool ApplyResolution(const gfx::Size& pic_size, const gfx::Rect& visible_rect) = 0;
...
protected:
    V4L2VideoDecoderBackend(Client* const client, scoped_refptr<V4L2Device> device);
