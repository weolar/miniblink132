...
{
    auto layout = V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_NV12, V4L2_FIELD_ANY, { 320 }, { 86400 }));
...
{
    auto layout = V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_NV12, V4L2_FIELD_ANY, { 320, 320 }, { 57600, 28800 }));
    ASSERT_TRUE(layout.has_value());
    EXPECT_EQ(PIXEL_FORMAT_NV12, layout->format());
    EXPECT_EQ(gfx::Size(300, 180), layout->coded_size());
...
{
    auto layout = V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_YUV420, V4L2_FIELD_ANY, { 320 }, { 86400 }));
    ASSERT_TRUE(layout.has_value());
...
{
    auto layout = V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutput(300, 180, V4L2_PIX_FMT_NV12, V4L2_FIELD_ANY, 320, 86400));
...
{
    auto layout = V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_NV16, V4L2_FIELD_ANY, { 320 }, { 86400 }));
    EXPECT_FALSE(layout.has_value());
}
...
{
    auto layout = V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_YUV422M, V4L2_FIELD_ANY, { 320 }, { 86400 }));
    EXPECT_FALSE(layout.has_value());
}
...
{
    auto layout = V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_YUV420, V4L2_FIELD_ANY, { 319 }, { 86400 }));
    EXPECT_FALSE(layout.has_value());
}
