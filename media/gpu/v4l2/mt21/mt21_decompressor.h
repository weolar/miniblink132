...
struct MT21DecompressionJob : public base::RefCounted<MT21DecompressionJob> {
    ...
    MT21DecompressionJob(const uint8_t* src, const uint8_t* footer, size_t offset, uint8_t* dest, size_t width, size_t height, bool is_chroma);
    const uint8_t* src;
...
public:
    ...
    void MT21ToNV12(const uint8_t* src_y, const uint8_t* src_uv, const size_t y_buf_size, const size_t uv_buf_size, uint8_t* dest_y, uint8_t* dest_uv);
