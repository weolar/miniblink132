...
class MEDIA_GPU_EXPORT V4L2VideoEncodeAccelerator : public VideoEncodeAccelerator {
public:
    ...
    V4L2VideoEncodeAccelerator& operator=(const V4L2VideoEncodeAccelerator&) = delete;
...
private:
    ...
    struct InputFrameInfo {
        ...
        InputFrameInfo(scoped_refptr<VideoFrame> frame, bool force_keyframe, size_t index);
    ...
    // encode.
    void FrameProcessed(bool force_keyframe, base::TimeDelta timestamp, size_t output_buffer_index, scoped_refptr<VideoFrame> frame);
    ...
    bool CreateImageProcessor(const VideoFrameLayout& input_layout, const VideoPixelFormat output_format, const gfx::Size& output_size,
    ...
    void RequestEncodingParametersChangeTask(const VideoBitrateAllocation& bitrate_allocation, uint32_t framerate, const std::optional<gfx::Size>& size);
    ...
    bool SetFormats(VideoPixelFormat input_format, VideoCodecProfile output_profile);
    ...
    std::optional<struct v4l2_format> NegotiateInputFormat(VideoPixelFormat input_format, const gfx::Size& frame_size);
    ...
    BitstreamBufferMetadata GetMetadata(const uint8_t* data, size_t data_size_bytes, bool key_frame, base::TimeDelta timestamp);
    ...
    size_t CopyIntoOutputBuffer(const uint8_t* bitstream_data, size_t bitstream_size, std::unique_ptr<BitstreamBufferRef> buffer_ref);
