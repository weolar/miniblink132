...
v4l2_format V4L2FormatVideoOutput(uint32_t width, uint32_t height, uint32_t pixelformat, uint32_t field, uint32_t bytesperline, uint32_t sizeimage)
{
    v4l2_format format;
...
v4l2_format V4L2FormatVideoOutputMplane(
    uint32_t width, uint32_t height, uint32_t pixelformat, uint32_t field, std::vector<uint32_t> bytesperlines, std::vector<uint32_t> sizeimages)
{
    ...
    if (bytesperlines.size() != sizeimages.size() || bytesperlines.size() > static_cast<size_t>(VIDEO_MAX_PLANES)) {
...
{
    auto layout = V4L2Device::V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_NV12, V4L2_FIELD_ANY, { 320 }, { 86400 }));
    ...
    ostream << *layout;
    const std::string kNoModifierStr = ModifierToHexString(gfx::NativePixmapHandle::kNoModifier);
...
{
    auto layout
        = V4L2Device::V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_NV12, V4L2_FIELD_ANY, { 320, 320 }, { 57600, 28800 }));
    ASSERT_TRUE(layout.has_value());
    EXPECT_EQ(PIXEL_FORMAT_NV12, layout->format());
    EXPECT_EQ(gfx::Size(300, 180), layout->coded_size());
    std::vector<ColorPlaneLayout> expected_planes({ { 320, 0u, 57600u }, { 320, 0u, 28800u } });
    EXPECT_EQ(expected_planes, layout->planes());
...
{
    auto layout = V4L2Device::V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_YUV420, V4L2_FIELD_ANY, { 320 }, { 86400 }));
    ASSERT_TRUE(layout.has_value());
    EXPECT_EQ(PIXEL_FORMAT_I420, layout->format());
    EXPECT_EQ(gfx::Size(300, 180), layout->coded_size());
    std::vector<ColorPlaneLayout> expected_planes({ { 320, 0u, 86400 }, { 160, 57600u, 14400u }, { 160, 72000u, 14400u } });
    EXPECT_EQ(expected_planes, layout->planes());
    std::ostringstream ostream;
    ostream << *layout;
    const std::string kNoModifierStr = ModifierToHexString(gfx::NativePixmapHandle::kNoModifier);
...
{
    auto layout = V4L2Device::V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutput(300, 180, V4L2_PIX_FMT_NV12, V4L2_FIELD_ANY, 320, 86400));
...
{
    auto layout = V4L2Device::V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_NV16, V4L2_FIELD_ANY, { 320 }, { 86400 }));
    EXPECT_FALSE(layout.has_value());
}
...
{
    auto layout = V4L2Device::V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_YUV422M, V4L2_FIELD_ANY, { 320 }, { 86400 }));
    EXPECT_FALSE(layout.has_value());
}
...
{
    auto layout = V4L2Device::V4L2FormatToVideoFrameLayout(V4L2FormatVideoOutputMplane(300, 180, V4L2_PIX_FMT_YUV420, V4L2_FIELD_ANY, { 319 }, { 86400 }));
    EXPECT_FALSE(layout.has_value());
}
