...
public:
    explicit V4L2VideoDecoderDelegateVP8(V4L2DecodeSurfaceHandler* surface_handler, V4L2Device* device);

    V4L2VideoDecoderDelegateVP8(const V4L2VideoDecoderDelegateVP8&) = delete;
    V4L2VideoDecoderDelegateVP8& operator=(const V4L2VideoDecoderDelegateVP8&) = delete;
