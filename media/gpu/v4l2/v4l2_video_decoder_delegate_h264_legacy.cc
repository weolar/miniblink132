...
V4L2VideoDecoderDelegateH264Legacy::V4L2VideoDecoderDelegateH264Legacy(V4L2DecodeSurfaceHandler* surface_handler, V4L2Device* device)
    : num_slices_(0)
...
scoped_refptr<H264Picture> V4L2VideoDecoderDelegateH264Legacy::CreateH264Picture()
{
...
void V4L2VideoDecoderDelegateH264Legacy::H264PictureListToDPBIndicesList(const H264Picture::Vector& src_pic_list, uint8_t dst_list[kDPBIndicesListSize])
{
    size_t i;
...
void V4L2VideoDecoderDelegateH264Legacy::H264DPBToV4L2DPB(const H264DPB& dpb, std::vector<scoped_refptr<V4L2DecodeSurface>>* ref_surfaces)
{
...
H264Decoder::H264Accelerator::Status V4L2VideoDecoderDelegateH264Legacy::SubmitFrameMetadata(const H264SPS* sps, const H264PPS* pps, const H264DPB& dpb,
...
#define SET_V4L2_PPS_FLAG_IF(cond, flag) v4l2_pps.flags |= ((pps->cond) ? (flag) : 0)
    ...
    SET_V4L2_PPS_FLAG_IF(pic_scaling_matrix_present_flag, V4L2_H264_PPS_FLAG_PIC_SCALING_MATRIX_PRESENT);
#undef SET_V4L2_PPS_FLAG_IF
    ...
    H264PictureListToDPBIndicesList(ref_pic_listp0, priv_->v4l2_decode_param.ref_pic_list_p0);
    H264PictureListToDPBIndicesList(ref_pic_listb0, priv_->v4l2_decode_param.ref_pic_list_b0);
    H264PictureListToDPBIndicesList(ref_pic_listb1, priv_->v4l2_decode_param.ref_pic_list_b1);
...
H264Decoder::H264Accelerator::Status V4L2VideoDecoderDelegateH264Legacy::SubmitSlice(const H264PPS* pps, const H264SliceHeader* slice_hdr,
    ...
    const std::vector<SubsampleEntry>& subsamples)
{
    ...
    struct v4l2_ctrl_h264_slice_param& v4l2_slice_param = priv_->v4l2_slice_params[num_slices_++];
...
#define SET_V4L2_SPARM_FLAG_IF(cond, flag) v4l2_slice_param.flags |= ((slice_hdr->cond) ? (flag) : 0)
    ...
    SET_V4L2_SPARM_FLAG_IF(direct_spatial_mv_pred_flag, V4L2_SLICE_FLAG_DIRECT_SPATIAL_MV_PRED);
...
#undef SET_V4L2_SPARM_FLAG_IF
    ...
    H264PictureListToDPBIndicesList(ref_pic_list0, v4l2_slice_param.ref_pic_list0);
    H264PictureListToDPBIndicesList(ref_pic_list1, v4l2_slice_param.ref_pic_list1);
    ...
    return surface_handler_->SubmitSlice(dec_surface.get(), data_copy.get(), data_copy_size) ? Status::kOk : Status::kFail;
}

H264Decoder::H264Accelerator::Status V4L2VideoDecoderDelegateH264Legacy::SubmitDecode(scoped_refptr<H264Picture> pic)
{
    scoped_refptr<V4L2DecodeSurface> dec_surface = H264PictureToV4L2DecodeSurface(pic.get());
...
bool V4L2VideoDecoderDelegateH264Legacy::OutputPicture(scoped_refptr<H264Picture> pic)
{
...
scoped_refptr<V4L2DecodeSurface> V4L2VideoDecoderDelegateH264Legacy::H264PictureToV4L2DecodeSurface(H264Picture* pic)
{
