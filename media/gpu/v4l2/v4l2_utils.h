...
using MmapAsCallback = base::RepeatingCallback<void*(void*, unsigned int, int, int, unsigned int)>;
...
// secure handle.
using SecureBufferAllocatedCB = base::OnceCallback<void(base::ScopedFD fd, uint64_t secure_handle)>;

using AllocateSecureBufferAsCallback = base::RepeatingCallback<void(uint32_t size, SecureBufferAllocatedCB callback)>;
