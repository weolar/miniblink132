...
public:
    ...
    V4L2DecodeSurface(V4L2WritableBufferRef input_buffer, V4L2WritableBufferRef output_buffer, scoped_refptr<FrameResource> frame, uint64_t secure_handle);
    ...
    void SetReferenceSurfaces(std::vector<scoped_refptr<V4L2DecodeSurface>> ref_surfaces);
    ...
    scoped_refptr<FrameResource> frame() const
    {
        return frame_;
    }
...
public:
    V4L2RequestDecodeSurface(V4L2WritableBufferRef input_buffer, V4L2WritableBufferRef output_buffer, scoped_refptr<FrameResource> frame,
        uint64_t secure_handle, V4L2RequestRef request_ref)
        : V4L2DecodeSurface(std::move(input_buffer), std::move(output_buffer), std::move(frame), secure_handle)
