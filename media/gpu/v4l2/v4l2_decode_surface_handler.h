...
class V4L2DecodeSurfaceHandler : public DecodeSurfaceHandler<V4L2DecodeSurface> {
public:
    ...
    virtual scoped_refptr<V4L2DecodeSurface> CreateSecureSurface(uint64_t secure_handle) = 0;
    ...
    virtual bool SubmitSlice(V4L2DecodeSurface* dec_surface, const uint8_t* data, size_t size) = 0;
