...
public:
    ...
    {
        return reference_type_ == kShortTermCurrBefore || reference_type_ == kShortTermCurrAfter || reference_type_ == kShortTermFoll;
    }
    bool IsUnused() const
    {
        return reference_type_ == kUnused;
    }
