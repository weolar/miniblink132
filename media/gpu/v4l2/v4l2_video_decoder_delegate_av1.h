...
public:
    V4L2VideoDecoderDelegateAV1(V4L2DecodeSurfaceHandler* surface_handler, V4L2Device* device);

    V4L2VideoDecoderDelegateAV1(const V4L2VideoDecoderDelegateAV1&) = delete;
    V4L2VideoDecoderDelegateAV1& operator=(const V4L2VideoDecoderDelegateAV1&) = delete;
    ...
    scoped_refptr<AV1Picture> CreateAV1PictureSecure(bool apply_grain, uint64_t secure_handle) override;
    ...
    Status SubmitDecode(const AV1Picture& pic, const libgav1::ObuSequenceHeader& sequence_header, const AV1ReferenceFrameVector& ref_frames,
        const libgav1::Vector<libgav1::TileBuffer>& tile_buffers, base::span<const uint8_t> stream) override;
