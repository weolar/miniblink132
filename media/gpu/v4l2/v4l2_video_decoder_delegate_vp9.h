...
public:
    explicit V4L2VideoDecoderDelegateVP9(V4L2DecodeSurfaceHandler* surface_handler, V4L2Device* device);

    V4L2VideoDecoderDelegateVP9(const V4L2VideoDecoderDelegateVP9&) = delete;
    V4L2VideoDecoderDelegateVP9& operator=(const V4L2VideoDecoderDelegateVP9&) = delete;

    ~V4L2VideoDecoderDelegateVP9() override;

    // VP9Decoder::VP9Accelerator implementation.
    scoped_refptr<VP9Picture> CreateVP9Picture() override;
    scoped_refptr<VP9Picture> CreateVP9PictureSecure(uint64_t secure_handle) override;
