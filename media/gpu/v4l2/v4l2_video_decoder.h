...
class MEDIA_GPU_EXPORT V4L2VideoDecoder : public VideoDecoderMixin, public V4L2VideoDecoderBackend::Client {
public:
    ...
    void ChangeResolution(gfx::Size pic_size, gfx::Rect visible_rect, size_t num_codec_reference_frames, uint8_t bit_depth) override;
    void OutputFrame(scoped_refptr<FrameResource> frame, const gfx::Rect& visible_rect, const VideoColorSpace& color_space, base::TimeDelta timestamp) override;
...
private:
    ...
    CroStatus SetupOutputFormat(const gfx::Size& size, const gfx::Rect& visible_rect, size_t num_codec_reference_frames, uint8_t bit_depth);
    ...
    CroStatus ContinueChangeResolution(const gfx::Size& pic_size, const gfx::Rect& visible_rect, size_t num_codec_reference_frames, uint8_t bit_depth);
    ...
    void AllocateSecureBufferCB(SecureBufferAllocatedCB callback, mojo::PlatformHandle secure_buffer);
