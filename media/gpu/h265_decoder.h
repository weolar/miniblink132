...
public:
    ...
    public:
        ...
        virtual scoped_refptr<H265Picture> CreateH265PictureSecure(uint64_t secure_handle);
        ...
        virtual void ProcessVPS(const H265VPS* vps, base::span<const uint8_t> vps_nalu_data);
        ...
        virtual void ProcessSPS(const H265SPS* sps, base::span<const uint8_t> sps_nalu_data);
        ...
        virtual void ProcessPPS(const H265PPS* pps, base::span<const uint8_t> pps_nalu_data);
        ...
        virtual Status SubmitFrameMetadata(const H265SPS* sps, const H265PPS* pps, const H265SliceHeader* slice_hdr, const H265Picture::Vector& ref_pic_list,
        ...
        // Returns kOk if successful, kFail if there are errors, or kTryAgain if
        // the accelerator needs additional data before being able to proceed.
        virtual Status SubmitSlice(const H265SPS* sps, const H265PPS* pps, const H265SliceHeader* slice_hdr, const H265Picture::Vector& ref_pic_list0,
    ...
    H265Decoder(std::unique_ptr<H265Accelerator> accelerator, VideoCodecProfile profile, const VideoColorSpace& container_color_space = VideoColorSpace());
...
private:
    ...
    bool FinishPicture(scoped_refptr<H265Picture> pic, std::unique_ptr<H265SliceHeader> slice_hdr);
    ...
    // |curr_pic_|.
    void CalcPictureOrderCount(const H265PPS* pps, const H265SliceHeader* slice_hdr);
    ...
    bool CalcRefPicPocs(const H265SPS* sps, const H265PPS* pps, const H265SliceHeader* slice_hdr);
    ...
    bool BuildRefPicLists(const H265SPS* sps, const H265PPS* pps, const H265SliceHeader* slice_hdr);
