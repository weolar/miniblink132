...
// variant.
class MEDIA_GPU_EXPORT CommandBufferHelper : public base::RefCountedDeleteOnSequence<CommandBufferHelper> {
public:
    ...
    static scoped_refptr<CommandBufferHelper> Create(gpu::CommandBufferStub* stub);
    ...
    virtual void WaitForSyncToken(gpu::SyncToken sync_token, base::OnceClosure done_cb) = 0;
...
protected:
    explicit CommandBufferHelper(scoped_refptr<base::SequencedTaskRunner> task_runner);
