...
void BuildPackedH264SPS(H26xAnnexBBitstreamBuilder& bitstream_builder, const H264SPS& sps)
{
    ...
    if (sps.vui_parameters_present_flag) {
        ...
        if (sps.nal_hrd_parameters_present_flag) {
            ...
            CHECK_LT(base::checked_cast<size_t>(sps.cpb_cnt_minus1), std::size(sps.bit_rate_value_minus1));
            ...
            bitstream_builder.AppendBits(5, sps.initial_cpb_removal_delay_length_minus_1);
        ...
        bitstream_builder.AppendBool(false); // motion_vectors_over_pic_boundaries_flag
...
void BuildPackedH264PPS(H26xAnnexBBitstreamBuilder& bitstream_builder, const H264SPS& sps, const H264PPS& pps)
{
    ...
    bitstream_builder.AppendBool(pps.bottom_field_pic_order_in_frame_present_flag);
