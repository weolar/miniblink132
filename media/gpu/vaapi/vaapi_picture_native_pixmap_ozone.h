...
public:
    VaapiPictureNativePixmapOzone(scoped_refptr<VaapiWrapper> vaapi_wrapper, const MakeGLContextCurrentCallback& make_context_current_cb,
        const BindGLImageCallback& bind_image_cb_, int32_t picture_buffer_id, const gfx::Size& size, const gfx::Size& visible_size, uint32_t texture_id,
    ...
    VaapiPictureNativePixmapOzone& operator=(const VaapiPictureNativePixmapOzone&) = delete;
