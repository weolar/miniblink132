...
public:
    VaapiPictureNativePixmapEgl(scoped_refptr<VaapiWrapper> vaapi_wrapper, const MakeGLContextCurrentCallback& make_context_current_cb,
    ...
    VaapiPictureNativePixmapEgl& operator=(const VaapiPictureNativePixmapEgl&) = delete;
