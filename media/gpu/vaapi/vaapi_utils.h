...
public:
    ...
    static std::unique_ptr<ScopedVABufferMapping> Create(const base::Lock* lock, VADisplay va_display, VABufferID buffer_id);
...
private:
    ...
    ScopedVABufferMapping(const base::Lock* lock, VADisplay va_display, VABufferID buffer_id, void* va_buffer_data);
...
public:
    ...
    static std::unique_ptr<ScopedVABuffer> Create(base::Lock* lock, VADisplay va_display, VAContextID va_context_id, VABufferType va_buffer_type, size_t size);
    static std::unique_ptr<ScopedVABuffer> CreateForTesting(VABufferID buffer_id, VABufferType buffer_type, size_t size);
...
private:
    ScopedVABuffer(base::Lock* lock, VADisplay va_display, VABufferID va_buffer_id, VABufferType va_buffer_type, size_t size);
...
private:
    ScopedVAImage(base::Lock* lock, VADisplay va_display, const VAImage& image, std::unique_ptr<ScopedVABufferMapping> va_buffer);
...
public:
    ScopedVASurface(scoped_refptr<VaapiWrapper> vaapi_wrapper, VASurfaceID va_surface_id, const gfx::Size& size, unsigned int va_rt_format);
