...
public:
    ...
    VaapiDecodeSurfaceHandler& operator=(const VaapiDecodeSurfaceHandler&) = delete;
    ...
    virtual void SurfaceReady(VASurfaceID va_surface_id, int32_t bitstream_id, const gfx::Rect& visible_rect, const VideoColorSpace& color_space) = 0;
};
