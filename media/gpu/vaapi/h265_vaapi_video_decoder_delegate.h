...
class H265VaapiVideoDecoderDelegate : public H265Decoder::H265Accelerator, public VaapiVideoDecoderDelegate {
public:
    H265VaapiVideoDecoderDelegate(VaapiDecodeSurfaceHandler* vaapi_dec, scoped_refptr<VaapiWrapper> vaapi_wrapper,
    ...
    H265VaapiVideoDecoderDelegate& operator=(const H265VaapiVideoDecoderDelegate&) = delete;
...
private:
    ...
    void FillVARefFramesFromRefList(const H265Picture::Vector& ref_pic_list, VAPictureHEVC* va_pics);
