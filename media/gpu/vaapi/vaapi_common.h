...
public:
    ...
    VASurfaceID va_surface_id() const
    {
...
public:
    VaapiAV1Picture(std::unique_ptr<VASurfaceHandle> display_va_surface, std::unique_ptr<VASurfaceHandle> reconstruct_va_surface);
