...
using VaapiImageDecoderMap = base::small_map<std::unordered_map<gpu::ImageDecodeAcceleratorType, std::unique_ptr<VaapiImageDecoder>>>;
...
class VaapiImageDecodeAcceleratorWorker : public gpu::ImageDecodeAcceleratorWorker {
public:
    ...
    VaapiImageDecodeAcceleratorWorker(const VaapiImageDecodeAcceleratorWorker&) = delete;
    VaapiImageDecodeAcceleratorWorker& operator=(const VaapiImageDecodeAcceleratorWorker&) = delete;
...
private:
    ...
    VaapiImageDecodeAcceleratorWorker(VaapiImageDecoderVector decoders, gpu::ImageDecodeAcceleratorSupportedProfiles supported_profiles);
    ...
    VaapiImageDecoder* GetInitializedDecoder(const std::vector<uint8_t>& encoded_data);
    ...
    base::WeakPtrFactory<VaapiImageDecodeAcceleratorWorker> decoder_weak_this_factory_ { this };
};
...
template <> struct default_delete<media::VaapiImageDecodeAcceleratorWorker> {
