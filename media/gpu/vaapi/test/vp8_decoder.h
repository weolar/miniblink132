...
public:
    Vp8Decoder(std::unique_ptr<IvfParser> ivf_parser, const VaapiDevice& va_device, SharedVASurface::FetchPolicy fetch_policy);
...
private:
    ...
    void FillVp8DataStructures(const Vp8FrameHeader& frame_hdr, VAIQMatrixBufferVP8& iq_matrix_buf, VAProbabilityDataBufferVP8& prob_buf,
        VAPictureParameterBufferVP8& pic_param, VASliceParameterBufferVP8& slice_param);

    void RefreshReferenceSlots(Vp8FrameHeader& vp8_frame_header, scoped_refptr<SharedVASurface> surface);
