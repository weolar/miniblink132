...
public:
    ...
    static std::unique_ptr<FakeSurface> Create(IdType id, unsigned int format, unsigned int width, unsigned int height,
...
private:
    FakeSurface(IdType id, unsigned int format, uint32_t va_fourcc, unsigned int width, unsigned int height, std::vector<VASurfaceAttrib> attrib_list,
