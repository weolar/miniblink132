...
public:
    VpxDecoderDelegate(int picture_width_hint, int picture_height_hint, VAProfile profile);
    ...
    void EnqueueWork(const std::vector<raw_ptr<const FakeBuffer>>& buffers) override;
    void Run() override;
