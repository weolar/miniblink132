...
public:
    H264Decoder(const uint8_t* stream_data, size_t stream_len, const VaapiDevice& va_device, SharedVASurface::FetchPolicy fetch_policy);
...
private:
    ...
    bool InitNonexistingPicture(scoped_refptr<H264Picture> pic, int frame_num, bool ref);
