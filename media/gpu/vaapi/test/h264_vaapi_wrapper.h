...
public:
    ...
    // Start a new frame.
    void SubmitFrameMetadata(const H264SPS* sps, const H264PPS* pps, const H264DPB& dpb, const H264Picture::Vector& ref_pic_listp0,
    ...
    void SubmitSlice(const H264PPS* pps, const H264SliceHeader* slice_header, const H264Picture::Vector& ref_pic_list0,
