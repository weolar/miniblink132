...
class VP9VaapiVideoDecoderDelegate : public VP9Decoder::VP9Accelerator, public VaapiVideoDecoderDelegate {
public:
    VP9VaapiVideoDecoderDelegate(VaapiDecodeSurfaceHandler* const vaapi_dec, scoped_refptr<VaapiWrapper> vaapi_wrapper,
    ...
    VP9VaapiVideoDecoderDelegate& operator=(const VP9VaapiVideoDecoderDelegate&) = delete;

    ~VP9VaapiVideoDecoderDelegate() override;

    // VP9Decoder::VP9Accelerator implementation.
    scoped_refptr<VP9Picture> CreateVP9Picture() override;
    Status SubmitDecode(scoped_refptr<VP9Picture> pic, const Vp9SegmentationParams& seg, const Vp9LoopFilterParams& lf,
