...
#define STATIC_ASSERT_ENUM_MATCH(name) static_assert(name == static_cast<VideoCodecProfile>(gpu::name), #name " value must match in media and gpu.")
...
// static
VideoDecodeAccelerator::Capabilities GpuVideoAcceleratorUtil::ConvertGpuToMediaDecodeCapabilities(
...
// static
VideoDecodeAccelerator::SupportedProfiles GpuVideoAcceleratorUtil::ConvertGpuToMediaDecodeProfiles(
...
// static
gpu::VideoDecodeAcceleratorCapabilities GpuVideoAcceleratorUtil::ConvertMediaToGpuDecodeCapabilities(
...
// static
gpu::VideoDecodeAcceleratorSupportedProfiles GpuVideoAcceleratorUtil::ConvertMediaToGpuDecodeProfiles(
...
// static
gpu::VideoDecodeAcceleratorSupportedProfiles GpuVideoAcceleratorUtil::ConvertMediaConfigsToGpuDecodeProfiles(const SupportedVideoDecoderConfigs& configs)
{
    gpu::VideoDecodeAcceleratorSupportedProfiles profiles;
...
// static
VideoEncodeAccelerator::SupportedProfiles GpuVideoAcceleratorUtil::ConvertGpuToMediaEncodeProfiles(
...
// static
gpu::VideoEncodeAcceleratorSupportedProfiles GpuVideoAcceleratorUtil::ConvertMediaToGpuEncodeProfiles(
