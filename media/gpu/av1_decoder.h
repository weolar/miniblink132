...
namespace media {
using AV1ReferenceFrameVector = std::array<scoped_refptr<AV1Picture>, libgav1::kNumReferenceFrameTypes>;
...
public:
    ...
    public:
        ...
        virtual scoped_refptr<AV1Picture> CreateAV1PictureSecure(bool apply_grain, uint64_t secure_handle);
        ...
        virtual Status SubmitDecode(const AV1Picture& pic, const libgav1::ObuSequenceHeader& sequence_header, const AV1ReferenceFrameVector& ref_frames,
    ...
    AV1Decoder(std::unique_ptr<AV1Accelerator> accelerator, VideoCodecProfile profile, const VideoColorSpace& container_color_space = VideoColorSpace());
    ~AV1Decoder() override;
...
private:
    ...
    AV1Accelerator::Status DecodeAndOutputPicture(scoped_refptr<AV1Picture> pic, const libgav1::Vector<libgav1::TileBuffer>& tile_buffers);
