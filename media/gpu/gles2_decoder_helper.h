...
public:
    static std::unique_ptr<GLES2DecoderHelper> Create(gpu::DecoderContext* decoder);
    ...
    virtual std::unique_ptr<gpu::gles2::AbstractTexture> CreateTexture(
        GLenum target, GLenum internal_format, GLsizei width, GLsizei height, GLenum format, GLenum type)
        = 0;
    ...
    virtual gpu::Mailbox CreateMailbox(gpu::gles2::AbstractTexture* texture_ref) = 0;
};
