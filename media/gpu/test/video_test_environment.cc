...
#if BUILDFLAG(IS_WIN)
    test_name = base::FilePath::FromASCII(base::StringPrintf("%s", test_info->name())).value();
    test_suite_name = base::FilePath::FromASCII(base::StringPrintf("%s", test_info->test_suite_name())).value();
#else
