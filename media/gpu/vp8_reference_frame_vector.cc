...
void Vp8ReferenceFrameVector::Refresh(scoped_refptr<VP8Picture> pic)
{
    ...
    if (frame_hdr->refresh_alternate_frame) {
        ...
        case Vp8FrameHeader::COPY_LAST_TO_ALT:
            ...
            reference_frames_[Vp8RefType::VP8_FRAME_ALTREF] = reference_frames_[Vp8RefType::VP8_FRAME_LAST];
            break;

        case Vp8FrameHeader::COPY_GOLDEN_TO_ALT:
            DCHECK(reference_frames_[Vp8RefType::VP8_FRAME_GOLDEN]);
            reference_frames_[Vp8RefType::VP8_FRAME_ALTREF] = reference_frames_[Vp8RefType::VP8_FRAME_GOLDEN];
            break;
    ...
    if (frame_hdr->refresh_golden_frame) {
        ...
        case Vp8FrameHeader::COPY_LAST_TO_GOLDEN:
            DCHECK(reference_frames_[Vp8RefType::VP8_FRAME_LAST]);
            reference_frames_[Vp8RefType::VP8_FRAME_GOLDEN] = reference_frames_[Vp8RefType::VP8_FRAME_LAST];
            break;

        case Vp8FrameHeader::COPY_ALT_TO_GOLDEN:
            DCHECK(reference_frames_[Vp8RefType::VP8_FRAME_ALTREF]);
            reference_frames_[Vp8RefType::VP8_FRAME_GOLDEN] = reference_frames_[Vp8RefType::VP8_FRAME_ALTREF];
            break;
...
scoped_refptr<VP8Picture> Vp8ReferenceFrameVector::GetFrame(Vp8RefType type) const
{
    DCHECK_CALLED_ON_VALID_SEQUENCE(sequence_checker_);
