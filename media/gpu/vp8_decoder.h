...
public:
    ...
    public:
        ...
        virtual bool SubmitDecode(scoped_refptr<VP8Picture> pic, const Vp8ReferenceFrameVector& reference_frames) = 0;
    ...
    explicit VP8Decoder(std::unique_ptr<VP8Accelerator> accelerator, const VideoColorSpace& container_color_space = VideoColorSpace());
