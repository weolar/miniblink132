...
TEST_F(H264RateControlUtilTest, RunBasicH264RateControllerUtilTest)
{
    ...
    EXPECT_EQ(base::Seconds(1), h264_rate_control_util::ClampedTimestampDiff(base::Seconds(1), base::Seconds(0)));

    EXPECT_EQ(base::Seconds(0), h264_rate_control_util::ClampedTimestampDiff(base::Seconds(0), base::Seconds(1)));

    EXPECT_EQ(base::Minutes(5), h264_rate_control_util::ClampedTimestampDiff(base::Seconds(400), base::Seconds(0)));
}
