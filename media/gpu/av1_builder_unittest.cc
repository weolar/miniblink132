...
public:
    ...
    AV1BitstreamBuilder::FrameHeader MakeFrameHeader(uint32_t frame_id)
    {
        ...
        pic_hdr.frame_type = frame_id == 0 ? libgav1::FrameType::kFrameKey : libgav1::FrameType::kFrameInter;
...
{
    const std::vector<uint8_t> expected_packed_data = { 0b00010010, 0b00000011, 0b10100000 };
...
{
    const std::vector<uint8_t> expected_packed_data = { 0b00100000, 0b00000000, 0b00000000, 0b01100011, 0b11111100, 0b00010011, 0b11111100, 0b00001011,
        0b00111101, 0b11111111, 0b11001111, 0b11000000, 0b10100000 };
    AV1BitstreamBuilder seq_header_obu = AV1BitstreamBuilder::BuildSequenceHeaderOBU(MakeSequenceHeader());
...
TEST_F(AV1BuilderTest, BuildFrameOBU)
{
    const std::vector<uint8_t> expected_packed_keyframe
        = { 0b00010000, 0b00000000, 0b01000110, 0b01000000, 0b00000000, 0b10000010, 0b00001000, 0b00100101, 0b01100000, 0b00000000, 0b00000000, 0b00000000,
              0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00011000 };
    const std::vector<uint8_t> expected_packed_interframe = { 0b00110000, 0b0000001, 0b00000000, 0b00100000, 0b00000000, 0b00000000, 0b00000000, 0b10001100,
        0b10000000, 0b00000001, 0b00000100, 0b00010000, 0b01001010, 0b11000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000,
        0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00000000, 0b00101000, 0b00000000 };
    AV1BitstreamBuilder::SequenceHeader seq_hdr = MakeSequenceHeader();
    AV1BitstreamBuilder frame_obu_key = AV1BitstreamBuilder::BuildFrameHeaderOBU(seq_hdr, MakeFrameHeader(0));
    AV1BitstreamBuilder frame_obu_inter = AV1BitstreamBuilder::BuildFrameHeaderOBU(seq_hdr, MakeFrameHeader(1));
