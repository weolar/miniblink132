...
public:
    ...
    Status SubmitDecode(scoped_refptr<media::VP9Picture> pic, const media::Vp9SegmentationParams& segm_params, const media::Vp9LoopFilterParams& lf_params,
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    media::VP9Decoder decoder(std::make_unique<FakeVP9Accelerator>(), media::VP9PROFILE_PROFILE0);
