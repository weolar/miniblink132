...
class GpuVideoDecodeAccelerator : public VideoDecodeAccelerator::Client, public gpu::CommandBufferStub::DestructionObserver {
public:
    ...
    GpuVideoDecodeAccelerator(
        gpu::CommandBufferStub* stub, const scoped_refptr<base::SingleThreadTaskRunner>& io_task_runner, const AndroidOverlayMojoFactoryCB& factory);

    GpuVideoDecodeAccelerator() = delete;
    GpuVideoDecodeAccelerator(const GpuVideoDecodeAccelerator&) = delete;
    GpuVideoDecodeAccelerator& operator=(const GpuVideoDecodeAccelerator&) = delete;
    ...
    static gpu::VideoDecodeAcceleratorCapabilities GetCapabilities(const gpu::GpuPreferences& gpu_preferences, const gpu::GpuDriverBugWorkarounds& workarounds);
    ...
    bool Initialize(const VideoDecodeAccelerator::Config& config, mojo::PendingAssociatedReceiver<mojom::GpuAcceleratedVideoDecoder> receiver,
        mojo::PendingAssociatedRemote<mojom::GpuAcceleratedVideoDecoderClient> client);
...
private:
    ...
    void OnAssignPictureBuffers(std::vector<mojom::PictureBufferAssignmentPtr> assignments);
    ...
    mojo::SharedAssociatedRemote<mojom::GpuAcceleratedVideoDecoderClient> decoder_client_;
    ...
    // cleared.
    std::map<int32_t, std::vector<scoped_refptr<gpu::gles2::TextureRef>>> uncleared_textures_;
};
