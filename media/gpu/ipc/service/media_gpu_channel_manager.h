...
public:
    ...
    void AddChannel(int32_t client_id, const base::UnguessableToken& channel_token);
...
private:
    ...
    std::unordered_map<int32_t, std::unique_ptr<MediaGpuChannel>> media_gpu_channels_;
