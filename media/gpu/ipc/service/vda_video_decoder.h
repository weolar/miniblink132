...
class VdaVideoDecoder : public VideoDecoder, public VideoDecodeAccelerator::Client {
public:
    using GetStubCB = base::RepeatingCallback<gpu::CommandBufferStub*()>;
    using CreatePictureBufferManagerCB = base::OnceCallback<scoped_refptr<PictureBufferManager>(PictureBufferManager::ReusePictureBufferCB)>;
    using CreateCommandBufferHelperCB = base::OnceCallback<scoped_refptr<CommandBufferHelper>()>;
    using CreateAndInitializeVdaCB = base::RepeatingCallback<std::unique_ptr<VideoDecodeAccelerator>(
        scoped_refptr<CommandBufferHelper>, VideoDecodeAccelerator::Client*, MediaLog*, const VideoDecodeAccelerator::Config&)>;
    using GetVdaCapabilitiesCB = base::OnceCallback<VideoDecodeAccelerator::Capabilities(const gpu::GpuPreferences&, const gpu::GpuDriverBugWorkarounds&)>;
    ...
    static std::unique_ptr<VideoDecoder> Create(scoped_refptr<base::SingleThreadTaskRunner> parent_task_runner,
...
private:
    ...
    //     VideoFrames.
    VdaVideoDecoder(scoped_refptr<base::SingleThreadTaskRunner> parent_task_runner, scoped_refptr<base::SingleThreadTaskRunner> gpu_task_runner,
    ...
    void ProvidePictureBuffers(uint32_t requested_num_of_buffers, VideoPixelFormat format, uint32_t textures_per_buffer, const gfx::Size& dimensions,
        uint32_t texture_target) override;
    void ProvidePictureBuffersWithVisibleRect(uint32_t requested_num_of_buffers, VideoPixelFormat format, uint32_t textures_per_buffer,
        const gfx::Size& dimensions, const gfx::Rect& visible_rect, uint32_t texture_target) override;
    ...
    void DecodeOnGpuThread(scoped_refptr<DecoderBuffer> buffer, int32_t bitstream_id);
    ...
    void ProvidePictureBuffersAsync(uint32_t count, VideoPixelFormat pixel_format, uint32_t planes, gfx::Size texture_size, GLenum texture_target);
    ...
    std::unique_ptr<base::WeakPtrFactory<VideoDecodeAccelerator>> gpu_weak_vda_factory_;
