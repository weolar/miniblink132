...
class GpuVideoDecodeAcceleratorHost : public VideoDecodeAccelerator,
...
public:
    ...
    GpuVideoDecodeAcceleratorHost& operator=(GpuVideoDecodeAcceleratorHost&) = delete;
...
private:
    ...
    void OnProvidePictureBuffers(
        uint32_t num_requested_buffers, VideoPixelFormat format, uint32_t textures_per_buffer, const gfx::Size& dimensions, uint32_t texture_target) override;
    ...
    // construction time.
    mojo::AssociatedReceiver<mojom::GpuAcceleratedVideoDecoderClient> client_receiver_ { this };
