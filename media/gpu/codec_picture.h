...
class MEDIA_GPU_EXPORT CodecPicture : public base::RefCountedThreadSafe<CodecPicture> {
public:
    CodecPicture();
    ...
    void set_bitstream_id(int32_t bitstream_id)
    {
    ...
    const VideoColorSpace& get_colorspace() const
    {
        return colorspace_;
    }
