...
void MockAndroidVideoSurfaceChooser::SetClientCallbacks(UseOverlayCB use_overlay_cb, UseTextureOwnerCB use_texture_owner_cb)
{
...
void MockAndroidVideoSurfaceChooser::UpdateState(std::optional<AndroidOverlayFactoryCB> factory, const State& new_state)
{
    MockUpdateState();
    if (factory) {
...
void MockAndroidVideoSurfaceChooser::ProvideOverlay(std::unique_ptr<AndroidOverlay> overlay)
{
