...
MEDIA_GPU_EXPORT const std::vector<MediaCodecEncoderInfo>& GetEncoderInfoCache();
...
MEDIA_GPU_EXPORT const std::vector<MediaCodecDecoderInfo>& GetDecoderInfoCache();
