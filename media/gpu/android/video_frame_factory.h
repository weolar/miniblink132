...
public:
    using InitCB = base::RepeatingCallback<void(scoped_refptr<gpu::TextureOwner>)>;
    ...
    virtual void CreateVideoFrame(std::unique_ptr<CodecOutputBuffer> output_buffer, base::TimeDelta timestamp, gfx::Size natural_size,
