...
class MEDIA_GPU_EXPORT CodecSurfaceBundle : public base::RefCountedDeleteOnSequence<CodecSurfaceBundle> {
public:
    ...
    explicit CodecSurfaceBundle(scoped_refptr<gpu::TextureOwner> texture_owner, scoped_refptr<gpu::RefCountedLock> drdc_lock);
    ...
    scoped_refptr<CodecBufferWaitCoordinator> codec_buffer_wait_coordinator() const
    {
