...
class MEDIA_GPU_EXPORT CodecImageGroup : public base::RefCountedThreadSafe<CodecImageGroup>, public gpu::RefCountedLockHelperDrDc {
public:
    ...
    CodecImageGroup(
        scoped_refptr<base::SequencedTaskRunner> task_runner, scoped_refptr<CodecSurfaceBundle> bundle, scoped_refptr<gpu::RefCountedLock> drdc_lock);
