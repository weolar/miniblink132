...
public:
    ...
    using UseOverlayCB = base::RepeatingCallback<void(std::unique_ptr<AndroidOverlay> overlay)>;
    ...
    AndroidVideoSurfaceChooser& operator=(const AndroidVideoSurfaceChooser&) = delete;
    ...
    virtual void SetClientCallbacks(UseOverlayCB use_overlay_cb, UseTextureOwnerCB use_texture_owner_cb) = 0;
    ...
    virtual void UpdateState(std::optional<AndroidOverlayFactoryCB> new_factory, const State& new_state) = 0;
};
