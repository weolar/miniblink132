...
class MEDIA_GPU_EXPORT PromotionHintAggregatorImpl : public PromotionHintAggregator {
public:
    ...
    PromotionHintAggregatorImpl& operator=(const PromotionHintAggregatorImpl&) = delete;
