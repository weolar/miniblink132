...
class REQUIRES_ANDROID_API(NDK_MEDIA_CODEC_MIN_API) MEDIA_GPU_EXPORT NdkAudioEncoder : public AudioEncoder, public NdkMediaCodecWrapper::Client {
public:
    ...
    void Initialize(const Options& options, OutputCB output_callback, EncoderStatusCB done_cb) override;
...
private:
    ...
    FlushState flush_state_ GUARDED_BY_CONTEXT(sequence_checker_) = NdkAudioEncoder::FlushState::kNone;
    ...
    std::unique_ptr<ConvertingAudioFifo> fifo_ GUARDED_BY_CONTEXT(sequence_checker_);
