...
{
    return MediaCodecUtil::IsKnownUnaccelerated(codec, MediaCodecDirection::DECODER);
}
...
void DeviceInfo::AddSupportedCodecProfileLevels(std::vector<CodecProfileLevel>* result)
{
