...
public:
    ...
    MockAndroidVideoSurfaceChooser(const MockAndroidVideoSurfaceChooser&) = delete;
    MockAndroidVideoSurfaceChooser& operator=(const MockAndroidVideoSurfaceChooser&) = delete;
    ...
    void UpdateState(std::optional<AndroidOverlayFactoryCB> factory, const State& new_state) override;
