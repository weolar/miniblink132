...
void BuildPackedH265ProfileTierLevel(
    H26xAnnexBBitstreamBuilder& builder, const H265ProfileTierLevel& profile_tier_level, bool profile_present_flag, uint8_t max_num_sub_layers_minus1)
{
    ...
    if (profile_present_flag) {
        ...
        builder.AppendBits(32, profile_tier_level.general_profile_compatibility_flags);
        ...
        builder.AppendBits(1, profile_tier_level.general_non_packed_constraint_flag);
        builder.AppendBits(1, profile_tier_level.general_frame_only_constraint_flag);
...
void BuildPackedH265VPS(H26xAnnexBBitstreamBuilder& builder, const H265VPS& vps)
{
    ...
    BuildPackedH265ProfileTierLevel(builder, vps.profile_tier_level, true, vps.vps_max_sub_layers_minus1);
...
void BuildPackedH265SPS(H26xAnnexBBitstreamBuilder& builder, const H265SPS& sps)
{
    ...
    BuildPackedH265ProfileTierLevel(builder, sps.profile_tier_level, true, sps.sps_max_sub_layers_minus1);
    ...
    bool conformance_window_flag
        = sps.conf_win_left_offset > 0 || sps.conf_win_right_offset > 0 || sps.conf_win_top_offset > 0 || sps.conf_win_bottom_offset > 0;
    ...
    if (sps.long_term_ref_pics_present_flag) {
        ...
        for (int i = 0; i < sps.num_long_term_ref_pics_sps; i++) {
            builder.AppendBits(sps.log2_max_pic_order_cnt_lsb_minus4 + 4, sps.lt_ref_pic_poc_lsb_sps[i]);
...
void BuildPackedH265PPS(H26xAnnexBBitstreamBuilder& builder, const H265PPS& pps)
{
