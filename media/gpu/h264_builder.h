...
MEDIA_GPU_EXPORT void BuildPackedH264SPS(H26xAnnexBBitstreamBuilder& bitstream_builder, const H264SPS& sps);
// Build the packed bitstream of H264PPS into |bitstream_builder|.
MEDIA_GPU_EXPORT void BuildPackedH264PPS(H26xAnnexBBitstreamBuilder& bitstream_builder, const H264SPS& sps, const H264PPS& pps);
