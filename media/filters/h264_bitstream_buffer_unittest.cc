...
class H264BitstreamBufferAppendBitsTest : public ::testing::TestWithParam<uint64_t> { };
...
INSTANTIATE_TEST_SUITE_P(AppendNumBits, H264BitstreamBufferAppendBitsTest, ::testing::Range(static_cast<uint64_t>(1), static_cast<uint64_t>(65)));
} // namespace media
