...
class H26xAnnexBBitstreamBuilderAppendBitsTest : public ::testing::TestWithParam<uint64_t> { };
...
INSTANTIATE_TEST_SUITE_P(AppendNumBits, H26xAnnexBBitstreamBuilderAppendBitsTest, ::testing::Range(static_cast<uint64_t>(1), static_cast<uint64_t>(65)));
} // namespace media
