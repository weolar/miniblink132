...
private:
    ...
    using ScopedAudioConverterRef = base::apple::ScopedTypeRef<AudioConverterRef, ScopedAudioConverterRefTraits>;

    bool CreateDecoder(const AudioDecoderConfig& config);

    void OnOutputReady(DecoderBuffer::TimeInfo time_info, scoped_refptr<AudioBuffer> output_buffer);
