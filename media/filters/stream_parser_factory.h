...
public:
    ...
    static SupportsType IsTypeSupported(std::string_view type, base::span<const std::string> codecs);
    ...
    // attempted decode.
    static std::unique_ptr<StreamParser> Create(std::string_view type, base::span<const std::string> codecs, MediaLog* media_log);
    static std::unique_ptr<StreamParser> Create(std::unique_ptr<AudioDecoderConfig> audio_config);
    static std::unique_ptr<StreamParser> Create(std::unique_ptr<VideoDecoderConfig> video_config);
    ...
    static std::unique_ptr<StreamParser> CreateRelaxedParser(RelaxedParserSupportedType mime);
#endif
};
