...
class MEDIA_EXPORT H264BitstreamBuffer : public base::RefCountedThreadSafe<H264BitstreamBuffer> {
public:
    H264BitstreamBuffer();
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(H264BitstreamBufferAppendBitsTest, AppendAndVerifyBits);
