...
public:
    ...
    bool ProcessFrames(const StreamParser::BufferQueueMap& buffer_queue_map, base::TimeDelta append_window_start, base::TimeDelta append_window_end,
...
private:
    ...
    bool HandlePartialAppendWindowTrimming(base::TimeDelta append_window_start, base::TimeDelta append_window_end, scoped_refptr<StreamParserBuffer> buffer);
    ...
    bool CheckAudioPresentationOrder(const StreamParserBuffer& frame, bool track_needs_random_access_point);
    ...
    base::TimeDelta last_audio_pts_for_nonkeyframe_monotonicity_check_ = kNoTimestamp;
