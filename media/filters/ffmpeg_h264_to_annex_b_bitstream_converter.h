...
class MEDIA_EXPORT FFmpegH264ToAnnexBBitstreamConverter : public FFmpegBitstreamConverter {
public:
    ...
    explicit FFmpegH264ToAnnexBBitstreamConverter(AVCodecParameters* stream_codec_parameters);

    FFmpegH264ToAnnexBBitstreamConverter(const FFmpegH264ToAnnexBBitstreamConverter&) = delete;
    FFmpegH264ToAnnexBBitstreamConverter& operator=(const FFmpegH264ToAnnexBBitstreamConverter&) = delete;
...
private:
    ...
    raw_ptr<AVCodecParameters, AcrossTasksDanglingUntriaged> stream_codec_parameters_;
};
