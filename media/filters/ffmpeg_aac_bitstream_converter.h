...
class MEDIA_EXPORT FFmpegAACBitstreamConverter : public FFmpegBitstreamConverter {
public:
    ...
    explicit FFmpegAACBitstreamConverter(AVCodecParameters* stream_codec_parameters);

    FFmpegAACBitstreamConverter(const FFmpegAACBitstreamConverter&) = delete;
    FFmpegAACBitstreamConverter& operator=(const FFmpegAACBitstreamConverter&) = delete;
