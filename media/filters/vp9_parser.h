...
public:
    ...
    using ContextRefreshCallback = base::OnceCallback<void(const Vp9FrameContext&)>;
    ...
    public:
        ...
        public:
            ...
            bool needs_client_update() const
            {
                return needs_client_update_;
            }
        ...
        // |frame_context|.
        void UpdateFrameContext(size_t frame_context_idx, const Vp9FrameContext& frame_context);
