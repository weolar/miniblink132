...
class MEDIA_EXPORT FFmpegH265ToAnnexBBitstreamConverter : public FFmpegBitstreamConverter {
public:
    ...
    explicit FFmpegH265ToAnnexBBitstreamConverter(AVCodecParameters* stream_codec_parameters);

    FFmpegH265ToAnnexBBitstreamConverter(const FFmpegH265ToAnnexBBitstreamConverter&) = delete;
    FFmpegH265ToAnnexBBitstreamConverter& operator=(const FFmpegH265ToAnnexBBitstreamConverter&) = delete;
