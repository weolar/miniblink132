...
class MEDIA_EXPORT FrameBufferPool : public base::RefCountedThreadSafe<FrameBufferPool>, public base::trace_event::MemoryDumpProvider {
public:
    FrameBufferPool();
...
private:
    ...
    // destroyed.
    void OnVideoFrameDestroyed(scoped_refptr<base::SequencedTaskRunner> task_runner, FrameBuffer* frame_buffer);
