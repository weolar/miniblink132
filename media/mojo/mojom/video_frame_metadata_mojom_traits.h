...
template <> struct EnumTraits<media::mojom::EffectState, intermediate::EffectState> {
    static media::mojom::EffectState ToMojom(intermediate::EffectState input);

    static bool FromMojom(media::mojom::EffectState input, intermediate::EffectState* output);
};

template <> struct StructTraits<media::mojom::VideoFrameMetadataDataView, media::VideoFrameMetadata> {
    ...
    static bool texture_origin_is_top_left(const media::VideoFrameMetadata& input)
    {
        return input.texture_origin_is_top_left;
    }

    static uint32_t sub_capture_target_version(const media::VideoFrameMetadata& input)
    {
    ...
    static const std::optional<media::VideoTransformation>& transformation(const media::VideoFrameMetadata& input)
    {
    ...
    static const std::optional<gfx::Rect>& capture_update_rect(const media::VideoFrameMetadata& input)
    {
        return input.capture_update_rect;
    }

    static const std::optional<gfx::Size>& source_size(const media::VideoFrameMetadata& input)
    {
        return input.source_size;
    }

    static const std::optional<gfx::Rect>& region_capture_rect(const media::VideoFrameMetadata& input)
    {
        return input.region_capture_rect;
    }

    static const std::optional<base::UnguessableToken>& tracking_token(const media::VideoFrameMetadata& input)
    {
        return input.tracking_token;
    }

    static std::optional<base::TimeTicks> receive_time(const media::VideoFrameMetadata& input)
    {
        return input.receive_time;
    }

    static std::optional<base::TimeTicks> capture_begin_time(const media::VideoFrameMetadata& input)
    {
        return input.capture_begin_time;
    }

    static std::optional<base::TimeTicks> capture_end_time(const media::VideoFrameMetadata& input)
    {
        return input.capture_end_time;
    }

    static std::optional<base::TimeTicks> decode_begin_time(const media::VideoFrameMetadata& input)
    {
        return input.decode_begin_time;
    }

    static std::optional<base::TimeTicks> decode_end_time(const media::VideoFrameMetadata& input)
    {
        return input.decode_end_time;
    }

    static std::optional<base::TimeTicks> reference_time(const media::VideoFrameMetadata& input)
    {
        return input.reference_time;
    }

    static std::optional<base::TimeDelta> processing_time(const media::VideoFrameMetadata& input)
    {
        return input.processing_time;
    }

    static std::optional<base::TimeDelta> frame_duration(const media::VideoFrameMetadata& input)
    {
        return input.frame_duration;
    }

    static std::optional<base::TimeDelta> wallclock_frame_duration(const media::VideoFrameMetadata& input)
    {
        return input.wallclock_frame_duration;
    }

    static std::optional<uint64_t> frame_sequence(const media::VideoFrameMetadata& input)
    {
        return input.frame_sequence;
    }

    static intermediate::EffectState background_blur(const media::VideoFrameMetadata& input)
    {
        if (!input.background_blur) {
            return intermediate::EffectState::kUnknown;
        }

        return input.background_blur->enabled ? intermediate::EffectState::kEnabled : intermediate::EffectState::kDisabled;
    }

    static bool Read(media::mojom::VideoFrameMetadataDataView input, media::VideoFrameMetadata* output);
};
