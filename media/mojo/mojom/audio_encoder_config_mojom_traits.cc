...
// static
media::mojom::AacOutputFormat EnumTraits<media::mojom::AacOutputFormat, media::AudioEncoder::AacOutputFormat>::ToMojom(
...
// static
bool EnumTraits<media::mojom::AacOutputFormat, media::AudioEncoder::AacOutputFormat>::FromMojom(
    media::mojom::AacOutputFormat format, media::AudioEncoder::AacOutputFormat* output)
{
    switch (format) {
...
// static
bool StructTraits<media::mojom::AacAudioEncoderConfigDataView, media::AudioEncoder::AacOptions>::Read(
    media::mojom::AacAudioEncoderConfigDataView input, media::AudioEncoder::AacOptions* output)
{
...
// static
bool StructTraits<media::mojom::AudioEncoderConfigDataView, media::AudioEncoderConfig>::Read(
    media::mojom::AudioEncoderConfigDataView input, media::AudioEncoderConfig* output)
{
    ...
    if (input.sample_rate() < media::limits::kMinSampleRate || input.sample_rate() > media::limits::kMaxSampleRate)
        return false;
