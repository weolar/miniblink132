...
TEST(AudioProcessingMojomTraitsTest, AudioProcessingSettings)
{
    ...
    mojo::test::SerializeAndDeserialize<media::mojom::AudioProcessingSettings>(settings_in, settings_out);
    ...
    settings_in.transient_noise_suppression = !settings_in.transient_noise_suppression;
    ...
    settings_in.multi_channel_capture_processing = !settings_in.multi_channel_capture_processing;
...
TEST(AudioProcessingMojomTraitsTest, AudioProcessingStats)
{
    ...
    mojo::test::SerializeAndDeserialize<media::mojom::AudioProcessingStats>(stats_in, stats_out);

    EXPECT_EQ(stats_in.echo_return_loss, stats_out.echo_return_loss);
    EXPECT_EQ(stats_in.echo_return_loss_enhancement, stats_out.echo_return_loss_enhancement);
