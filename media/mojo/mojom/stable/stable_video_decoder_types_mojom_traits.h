...
template <> struct EnumTraits<media::stable::mojom::CdmContextEvent, ::media::CdmContext::Event> {
    static media::stable::mojom::CdmContextEvent ToMojom(::media::CdmContext::Event input)
    {
        switch (input) {
    ...
    static bool FromMojom(media::stable::mojom::CdmContextEvent input, ::media::CdmContext::Event* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::stable::mojom::ColorSpacePrimaryID, gfx::ColorSpace::PrimaryID> {
    static media::stable::mojom::ColorSpacePrimaryID ToMojom(gfx::ColorSpace::PrimaryID input)
    {
        switch (input) {
    ...
    static bool FromMojom(media::stable::mojom::ColorSpacePrimaryID input, gfx::ColorSpace::PrimaryID* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::stable::mojom::ColorSpaceTransferID, gfx::ColorSpace::TransferID> {
    static media::stable::mojom::ColorSpaceTransferID ToMojom(gfx::ColorSpace::TransferID input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::ColorSpaceTransferID input, gfx::ColorSpace::TransferID* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::stable::mojom::ColorSpaceMatrixID, gfx::ColorSpace::MatrixID> {
    static media::stable::mojom::ColorSpaceMatrixID ToMojom(gfx::ColorSpace::MatrixID input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::ColorSpaceMatrixID input, gfx::ColorSpace::MatrixID* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::stable::mojom::ColorSpaceRangeID, gfx::ColorSpace::RangeID> {
    static media::stable::mojom::ColorSpaceRangeID ToMojom(gfx::ColorSpace::RangeID input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::ColorSpaceRangeID input, gfx::ColorSpace::RangeID* output)
    {
        switch (input) {
...
template <> struct StructTraits<media::stable::mojom::ColorSpaceDataView, gfx::ColorSpace> {
    ...
    static base::span<const float> custom_primary_matrix(const gfx::ColorSpace& input);

    static base::span<const float> transfer_params(const gfx::ColorSpace& input);

    static bool Read(media::stable::mojom::ColorSpaceDataView data, gfx::ColorSpace* output);
};

template <> struct StructTraits<media::stable::mojom::ColorVolumeMetadataDataView, gfx::HdrMetadataSmpteSt2086> {
    ...
    static bool Read(media::stable::mojom::ColorVolumeMetadataDataView data, gfx::HdrMetadataSmpteSt2086* output);
};

template <> struct StructTraits<media::stable::mojom::DecoderBufferDataView, scoped_refptr<media::DecoderBuffer>> {
    ...
    static base::TimeDelta timestamp(const scoped_refptr<media::DecoderBuffer>& input);

    static base::TimeDelta duration(const scoped_refptr<media::DecoderBuffer>& input);

    static bool is_end_of_stream(const scoped_refptr<media::DecoderBuffer>& input);
    ...
    static std::vector<uint8_t> raw_side_data(const scoped_refptr<media::DecoderBuffer>& input);

    static std::unique_ptr<media::DecryptConfig> decrypt_config(const scoped_refptr<media::DecoderBuffer>& input);

    static base::TimeDelta front_discard(const scoped_refptr<media::DecoderBuffer>& input);

    static base::TimeDelta back_discard(const scoped_refptr<media::DecoderBuffer>& input);

    static std::unique_ptr<media::DecoderBufferSideData> side_data(const scoped_refptr<media::DecoderBuffer>& input);

    static bool Read(media::stable::mojom::DecoderBufferDataView input, scoped_refptr<media::DecoderBuffer>* output);
};

template <> struct StructTraits<media::stable::mojom::DecoderBufferSideDataDataView, std::unique_ptr<media::DecoderBufferSideData>> {
    static bool IsNull(const std::unique_ptr<media::DecoderBufferSideData>& input)
    {
        return !input;
    }
    ...
    static std::vector<uint32_t> spatial_layers(const std::unique_ptr<media::DecoderBufferSideData>& input);
    static std::vector<uint8_t> alpha_data(const std::unique_ptr<media::DecoderBufferSideData>& input);
    static uint64_t secure_handle(const std::unique_ptr<media::DecoderBufferSideData>& input);

    static bool Read(media::stable::mojom::DecoderBufferSideDataDataView data, std::unique_ptr<media::DecoderBufferSideData>* output);
};

template <> struct StructTraits<media::stable::mojom::DecryptConfigDataView, std::unique_ptr<media::DecryptConfig>> {
    ...
    static media::EncryptionScheme encryption_scheme(const std::unique_ptr<media::DecryptConfig>& input);

    static const std::string& key_id(const std::unique_ptr<media::DecryptConfig>& input);

    static const std::string& iv(const std::unique_ptr<media::DecryptConfig>& input);

    static const std::vector<media::SubsampleEntry>& subsamples(const std::unique_ptr<media::DecryptConfig>& input);

    static const std::optional<media::EncryptionPattern>& encryption_pattern(const std::unique_ptr<media::DecryptConfig>& input);

    static bool Read(media::stable::mojom::DecryptConfigDataView input, std::unique_ptr<media::DecryptConfig>* output);
};

template <> struct EnumTraits<media::stable::mojom::DecryptStatus, ::media::Decryptor::Status> {
    static media::stable::mojom::DecryptStatus ToMojom(::media::Decryptor::Status input)
    {
        switch (input) {
    ...
    static bool FromMojom(media::stable::mojom::DecryptStatus input, ::media::Decryptor::Status* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::stable::mojom::EncryptionScheme, ::media::EncryptionScheme> {
    static media::stable::mojom::EncryptionScheme ToMojom(::media::EncryptionScheme input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::EncryptionScheme input, media::EncryptionScheme* output)
    {
        switch (input) {
...
template <> struct StructTraits<media::stable::mojom::HDRMetadataDataView, gfx::HDRMetadata> {
    ...
    static gfx::HdrMetadataSmpteSt2086 color_volume_metadata(const gfx::HDRMetadata& input);

    static bool Read(media::stable::mojom::HDRMetadataDataView data, gfx::HDRMetadata* output);
};

template <> struct EnumTraits<media::stable::mojom::MediaLogRecord_Type, media::MediaLogRecord::Type> {
    static media::stable::mojom::MediaLogRecord_Type ToMojom(media::MediaLogRecord::Type input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::MediaLogRecord_Type input, media::MediaLogRecord::Type* output)
    {
        switch (input) {
...
template <> struct StructTraits<media::stable::mojom::MediaLogRecordDataView, media::MediaLogRecord> {
    ...
    static bool Read(media::stable::mojom::MediaLogRecordDataView input, media::MediaLogRecord* output);
};

template <> struct StructTraits<media::stable::mojom::NativeGpuMemoryBufferHandleDataView, gfx::GpuMemoryBufferHandle> {
    static const gfx::GpuMemoryBufferId& id(const gfx::GpuMemoryBufferHandle& input);

#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
    static gfx::NativePixmapHandle platform_handle(gfx::GpuMemoryBufferHandle& input);
#else
    static media::stable::mojom::NativePixmapHandlePtr platform_handle(gfx::GpuMemoryBufferHandle& input)
    {
    ...
    static bool Read(media::stable::mojom::NativeGpuMemoryBufferHandleDataView data, gfx::GpuMemoryBufferHandle* output);
};

template <> struct StructTraits<media::stable::mojom::StatusDataDataView, media::internal::StatusData> {
    static media::stable::mojom::StatusCode code(const media::internal::StatusData& input);
    ...
    static const base::Value::List& frames(const media::internal::StatusData& input);

    static std::optional<media::internal::StatusData> cause(const media::internal::StatusData& input);

    static const base::Value& data(const media::internal::StatusData& input);

    static bool Read(media::stable::mojom::StatusDataDataView data, media::internal::StatusData* output);
};

template <> struct StructTraits<media::stable::mojom::StatusDataView, media::DecoderStatus> {
    static mojo::OptionalAsPointer<const media::internal::StatusData> internal(const media::DecoderStatus& input);

    static bool Read(media::stable::mojom::StatusDataView data, media::DecoderStatus* output);
};

template <> struct StructTraits<media::stable::mojom::SupportedVideoDecoderConfigDataView, media::SupportedVideoDecoderConfig> {
    static media::VideoCodecProfile profile_min(const media::SupportedVideoDecoderConfig& input);

    static media::VideoCodecProfile profile_max(const media::SupportedVideoDecoderConfig& input);

    static const gfx::Size& coded_size_min(const media::SupportedVideoDecoderConfig& input);

    static const gfx::Size& coded_size_max(const media::SupportedVideoDecoderConfig& input);

    static bool allow_encrypted(const media::SupportedVideoDecoderConfig& input);

    static bool require_encrypted(const media::SupportedVideoDecoderConfig& input);

    static bool Read(media::stable::mojom::SupportedVideoDecoderConfigDataView input, media::SupportedVideoDecoderConfig* output);
};

template <> struct EnumTraits<media::stable::mojom::VideoCodec, ::media::VideoCodec> {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::VideoCodec input, media::VideoCodec* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::stable::mojom::VideoCodecProfile, ::media::VideoCodecProfile> {
    static media::stable::mojom::VideoCodecProfile ToMojom(::media::VideoCodecProfile input)
    {
        switch (input) {
        ...
        case ::media::VideoCodecProfile::H264PROFILE_HIGH444PREDICTIVEPROFILE:
            return media::stable::mojom::VideoCodecProfile::kH264ProfileHigh444Predictive;
        case ::media::VideoCodecProfile::H264PROFILE_SCALABLEBASELINE:
            return media::stable::mojom::VideoCodecProfile::kH264ProfileScalableBaseline;
        case ::media::VideoCodecProfile::H264PROFILE_SCALABLEHIGH:
            return media::stable::mojom::VideoCodecProfile::kH264ProfileScalableHigh;
        ...
        case ::media::VideoCodecProfile::H264PROFILE_MULTIVIEWHIGH:
            return media::stable::mojom::VideoCodecProfile::kH264ProfileMultiviewHigh;
        ...
        case ::media::VideoCodecProfile::HEVCPROFILE_MAIN_STILL_PICTURE:
            return media::stable::mojom::VideoCodecProfile::kHEVCProfileMainStillPicture;
        ...
        case ::media::VideoCodecProfile::HEVCPROFILE_HIGH_THROUGHPUT:
            return media::stable::mojom::VideoCodecProfile::kHEVCProfileHighThroughput;
        case ::media::VideoCodecProfile::HEVCPROFILE_MULTIVIEW_MAIN:
            return media::stable::mojom::VideoCodecProfile::kHEVCProfileMultiviewMain;
        case ::media::VideoCodecProfile::HEVCPROFILE_SCALABLE_MAIN:
            return media::stable::mojom::VideoCodecProfile::kHEVCProfileScalableMain;
        ...
        case ::media::VideoCodecProfile::HEVCPROFILE_SCREEN_EXTENDED:
            return media::stable::mojom::VideoCodecProfile::kHEVCProfileScreenExtended;
        case ::media::VideoCodecProfile::HEVCPROFILE_SCALABLE_REXT:
            return media::stable::mojom::VideoCodecProfile::kHEVCProfileScalableRext;
        case ::media::VideoCodecProfile::HEVCPROFILE_HIGH_THROUGHPUT_SCREEN_EXTENDED:
            return media::stable::mojom::VideoCodecProfile::kHEVCProfileHighThroughputScreenExtended;
        ...
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN12_INTRA:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain12Intra;
        case ::media::VideoCodecProfile::VVCPROIFLE_MULTILAYER_MAIN10:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMultilayerMain10;
        ...
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN12_444_INTRA:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain12444Intra;
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN16_444_INTRA:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain16444Intra;
        ...
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN10_STILL_PICTURE:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain10Still;
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN12_STILL_PICTURE:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain12Still;
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN10_444_STILL_PICTURE:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain10444Still;
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN12_444_STILL_PICTURE:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain12444Still;
        case ::media::VideoCodecProfile::VVCPROFILE_MAIN16_444_STILL_PICTURE:
            return ::media::stable::mojom::VideoCodecProfile::kVVCProfileMain16444Still;
        }
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::VideoCodecProfile input, media::VideoCodecProfile* output)
    {
        switch (input) {
        ...
        case media::stable::mojom::VideoCodecProfile::kH264ProfileHigh422:
            *output = ::media::VideoCodecProfile::H264PROFILE_HIGH422PROFILE;
            return true;
        case media::stable::mojom::VideoCodecProfile::kH264ProfileHigh444Predictive:
            *output = ::media::VideoCodecProfile::H264PROFILE_HIGH444PREDICTIVEPROFILE;
            return true;
        case media::stable::mojom::VideoCodecProfile::kH264ProfileScalableBaseline:
        ...
        case media::stable::mojom::VideoCodecProfile::kHEVCProfileMain10:
            *output = ::media::VideoCodecProfile::HEVCPROFILE_MAIN10;
            return true;
        case media::stable::mojom::VideoCodecProfile::kHEVCProfileMainStillPicture:
        ...
        case media::stable::mojom::VideoCodecProfile::kHEVCProfileScalableRext:
            *output = ::media::VideoCodecProfile::HEVCPROFILE_SCALABLE_REXT;
            return true;
        case media::stable::mojom::VideoCodecProfile::kHEVCProfileHighThroughputScreenExtended:
            *output = ::media::VideoCodecProfile::HEVCPROFILE_HIGH_THROUGHPUT_SCREEN_EXTENDED;
            return true;
        case media::stable::mojom::VideoCodecProfile::kDolbyVisionProfile0:
            *output = ::media::VideoCodecProfile::DOLBYVISION_PROFILE0;
            return true;
        case media::stable::mojom::VideoCodecProfile::kDeprecatedDolbyVisionProfile4:
            return false;
        ...
        case media::stable::mojom::VideoCodecProfile::kVVCProfileMain16444Intra:
            *output = ::media::VideoCodecProfile::VVCPROFILE_MAIN16_444_INTRA;
            return true;
        case media::stable::mojom::VideoCodecProfile::kVVCProfileMultilayerMain10444:
        ...
        case media::stable::mojom::VideoCodecProfile::kVVCProfileMain10444Still:
            *output = ::media::VideoCodecProfile::VVCPROFILE_MAIN10_444_STILL_PICTURE;
            return true;
        case media::stable::mojom::VideoCodecProfile::kVVCProfileMain12444Still:
            *output = ::media::VideoCodecProfile::VVCPROFILE_MAIN12_444_STILL_PICTURE;
            return true;
        case media::stable::mojom::VideoCodecProfile::kVVCProfileMain16444Still:
            *output = ::media::VideoCodecProfile::VVCPROFILE_MAIN16_444_STILL_PICTURE;
            return true;
        }
...
template <> struct StructTraits<media::stable::mojom::VideoDecoderConfigDataView, media::VideoDecoderConfig> {
    static media::VideoCodec codec(const media::VideoDecoderConfig& input);

    static media::VideoCodecProfile profile(const media::VideoDecoderConfig& input);
    ...
    static const std::vector<uint8_t>& extra_data(const media::VideoDecoderConfig& input);

    static media::EncryptionScheme encryption_scheme(const media::VideoDecoderConfig& input);

    static const gfx::ColorSpace color_space_info(const media::VideoDecoderConfig& input);

    static const std::optional<gfx::HDRMetadata>& hdr_metadata(const media::VideoDecoderConfig& input);

    static uint32_t level(const media::VideoDecoderConfig& input);

    static bool Read(media::stable::mojom::VideoDecoderConfigDataView input, media::VideoDecoderConfig* output);
};

template <> struct EnumTraits<media::stable::mojom::VideoDecoderType, ::media::VideoDecoderType> {
    static media::stable::mojom::VideoDecoderType ToMojom(::media::VideoDecoderType input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::VideoDecoderType input, ::media::VideoDecoderType* output)
    {
        switch (input) {
...
template <> struct StructTraits<media::stable::mojom::VideoFrameMetadataDataView, media::VideoFrameMetadata> {
    ...
    static bool Read(media::stable::mojom::VideoFrameMetadataDataView input, media::VideoFrameMetadata* output);
};

template <> struct EnumTraits<media::stable::mojom::VideoPixelFormat, ::media::VideoPixelFormat> {
    static media::stable::mojom::VideoPixelFormat ToMojom(::media::VideoPixelFormat input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::VideoPixelFormat input, ::media::VideoPixelFormat* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::stable::mojom::WaitingReason, media::WaitingReason> {
    static media::stable::mojom::WaitingReason ToMojom(media::WaitingReason input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::stable::mojom::WaitingReason input, media::WaitingReason* output)
    {
        switch (input) {
...
template <> struct StructTraits<media::stable::mojom::SubsampleEntryDataView, ::media::SubsampleEntry> {
    ...
    static bool Read(media::stable::mojom::SubsampleEntryDataView input, ::media::SubsampleEntry* output);
};
