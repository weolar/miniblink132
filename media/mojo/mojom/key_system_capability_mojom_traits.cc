...
// static
bool StructTraits<media::mojom::KeySystemCapabilityDataView, media::KeySystemCapability>::Read(
    media::mojom::KeySystemCapabilityDataView input, media::KeySystemCapability* output)
{
    ...
    *output = media::KeySystemCapability(std::move(sw_secure_capability), std::move(hw_secure_capability));
    return true;
}
