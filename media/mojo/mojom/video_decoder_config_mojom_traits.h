...
template <> struct StructTraits<media::mojom::VideoDecoderConfigDataView, media::VideoDecoderConfig> {
    ...
    {
        return input.alpha_mode() == media::VideoDecoderConfig::AlphaMode::kHasAlpha;
    }
    ...
    static const media::VideoAspectRatio& aspect_ratio(const media::VideoDecoderConfig& input)
    {
    ...
    static const media::VideoColorSpace& color_space_info(const media::VideoDecoderConfig& input)
    {
        return input.color_space_info();
    }

    static media::VideoTransformation transformation(const media::VideoDecoderConfig& input)
    {
    ...
    static bool Read(media::mojom::VideoDecoderConfigDataView input, media::VideoDecoderConfig* output);
};
