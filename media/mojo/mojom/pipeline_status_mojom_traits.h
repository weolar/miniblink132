...
template <> struct StructTraits<media::mojom::PipelineStatisticsDataView, media::PipelineStatistics> {
    ...
    static bool Read(media::mojom::PipelineStatisticsDataView data, media::PipelineStatistics* output)
    {
...
template <> struct StructTraits<media::mojom::AudioPipelineInfoDataView, media::AudioPipelineInfo> {
    static media::AudioDecoderType decoder_type(const media::AudioPipelineInfo& input)
    {
    ...
    static bool has_decrypting_demuxer_stream(const media::AudioPipelineInfo& input)
    {
        return input.has_decrypting_demuxer_stream;
    }

    static media::EncryptionType encryption_type(const media::AudioPipelineInfo& input)
    {
        return input.encryption_type;
    }

    static bool Read(media::mojom::AudioPipelineInfoDataView data, media::AudioPipelineInfo* output)
    {
        output->is_platform_decoder = data.is_platform_decoder();
        output->has_decrypting_demuxer_stream = data.has_decrypting_demuxer_stream();
        return data.ReadEncryptionType(&output->encryption_type) && data.ReadDecoderType(&output->decoder_type);
    }
};

template <> struct StructTraits<media::mojom::VideoPipelineInfoDataView, media::VideoPipelineInfo> {
    static media::VideoDecoderType decoder_type(const media::VideoPipelineInfo& input)
    {
        return input.decoder_type;
    }
    ...
    static bool has_decrypting_demuxer_stream(const media::VideoPipelineInfo& input)
    {
        return input.has_decrypting_demuxer_stream;
    }

    static media::EncryptionType encryption_type(const media::VideoPipelineInfo& input)
    {
        return input.encryption_type;
    }

    static bool Read(media::mojom::VideoPipelineInfoDataView data, media::VideoPipelineInfo* output)
    {
        output->is_platform_decoder = data.is_platform_decoder();
        output->has_decrypting_demuxer_stream = data.has_decrypting_demuxer_stream();
        return data.ReadEncryptionType(&output->encryption_type) && data.ReadDecoderType(&output->decoder_type);
