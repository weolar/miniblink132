...
// static
bool StructTraits<media::mojom::EncodedAudioBufferDataView, media::EncodedAudioBuffer>::Read(
    media::mojom::EncodedAudioBufferDataView input, media::EncodedAudioBuffer* output)
{
    ...
    *output = media::EncodedAudioBuffer(params, base::HeapArray<uint8_t>::CopiedFrom(data_view), timestamp, duration);
    return true;
}
