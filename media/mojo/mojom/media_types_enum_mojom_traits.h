...
#if BUILDFLAG(IS_WIN)
template <> struct EnumTraits<media::mojom::CdmEvent, ::media::CdmEvent> {
    ...
    static bool FromMojom(media::mojom::CdmEvent input, ::media::CdmEvent* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::mojom::CdmSessionClosedReason, ::media::CdmSessionClosedReason> {
    static media::mojom::CdmSessionClosedReason ToMojom(::media::CdmSessionClosedReason input)
    {
        switch (input) {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::mojom::CdmSessionClosedReason input, ::media::CdmSessionClosedReason* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::mojom::EncryptionType, ::media::EncryptionType> {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::mojom::EncryptionType input, ::media::EncryptionType* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::mojom::SVCScalabilityMode, media::SVCScalabilityMode> {
    static media::mojom::SVCScalabilityMode ToMojom(media::SVCScalabilityMode input)
    {
        switch (input) {
    ...
    static bool FromMojom(media::mojom::SVCScalabilityMode input, media::SVCScalabilityMode* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::mojom::SVCInterLayerPredMode, media::SVCInterLayerPredMode> {
    static media::mojom::SVCInterLayerPredMode ToMojom(media::SVCInterLayerPredMode input)
    {
        switch (input) {
    ...
    static bool FromMojom(media::mojom::SVCInterLayerPredMode input, media::SVCInterLayerPredMode* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::mojom::VideoRotation, ::media::VideoRotation> {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::mojom::VideoRotation input, media::VideoRotation* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::mojom::RendererType, ::media::RendererType> {
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::mojom::RendererType input, ::media::RendererType* output)
    {
        switch (input) {
...
template <> struct EnumTraits<media::mojom::CreateCdmStatus, media::CreateCdmStatus> {
    static media::mojom::CreateCdmStatus ToMojom(media::CreateCdmStatus input)
    {
        ...
        case media::CreateCdmStatus::kAndroidUnsupportedMediaCryptoScheme:
            return media::mojom::CreateCdmStatus::kAndroidUnsupportedMediaCryptoScheme;
        }
    ...
    // Returning false results in deserialization failure and causes the
    // message pipe receiving it to be disconnected.
    static bool FromMojom(media::mojom::CreateCdmStatus input, media::CreateCdmStatus* output)
    {
        switch (input) {
