...
// static
media::mojom::EffectState EnumTraits<media::mojom::EffectState, intermediate::EffectState>::ToMojom(intermediate::EffectState input)
{
    switch (input) {
...
// static
bool EnumTraits<media::mojom::EffectState, intermediate::EffectState>::FromMojom(media::mojom::EffectState input, intermediate::EffectState* output)
{
    switch (input) {
    case media::mojom::EffectState::kUnknown:
...
// static
bool StructTraits<media::mojom::VideoFrameMetadataDataView, media::VideoFrameMetadata>::Read(
    media::mojom::VideoFrameMetadataDataView input, media::VideoFrameMetadata* output)
{
    // int.
    ...
    READ_AND_ASSIGN_OPT(media::VideoTransformation, transformation, Transformation);
    ...
    READ_AND_ASSIGN_OPT(base::TimeDelta, wallclock_frame_duration, WallclockFrameDuration);
