...
// static
bool StructTraits<media::mojom::AudioProcessingStatsDataView, media::AudioProcessingStats>::Read(
    media::mojom::AudioProcessingStatsDataView input, media::AudioProcessingStats* out_stats)
{
...
// static
bool StructTraits<media::mojom::AudioProcessingSettingsDataView, media::AudioProcessingSettings>::Read(
    media::mojom::AudioProcessingSettingsDataView input, media::AudioProcessingSettings* out_settings)
{
    *out_settings = media::AudioProcessingSettings();
    ...
    out_settings->transient_noise_suppression = input.transient_noise_suppression();
    out_settings->automatic_gain_control = input.automatic_gain_control();
    out_settings->high_pass_filter = input.high_pass_filter();
    out_settings->multi_channel_capture_processing = input.multi_channel_capture_processing();
