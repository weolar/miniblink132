...
template <> struct StructTraits<media::mojom::AudioProcessingStatsDataView, media::AudioProcessingStats> {
public:
    ...
    static bool has_echo_return_loss_enhancement(const media::AudioProcessingStats& input)
    {
        return input.echo_return_loss_enhancement.has_value();
    }
    static double echo_return_loss_enhancement(const media::AudioProcessingStats& input)
    {
        return input.echo_return_loss_enhancement.value_or(0.0);
    }

    static bool Read(media::mojom::AudioProcessingStatsDataView input, media::AudioProcessingStats* out_stats);
};

template <> struct StructTraits<media::mojom::AudioProcessingSettingsDataView, media::AudioProcessingSettings> {
public:
    ...
    static bool transient_noise_suppression(const media::AudioProcessingSettings& s)
    {
    ...
    static bool multi_channel_capture_processing(const media::AudioProcessingSettings& s)
    {
    ...
    static bool Read(media::mojom::AudioProcessingSettingsDataView input, media::AudioProcessingSettings* out_settings);
};
