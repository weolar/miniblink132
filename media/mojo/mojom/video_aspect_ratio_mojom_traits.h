...
template <> struct StructTraits<media::mojom::VideoAspectRatioDataView, media::VideoAspectRatio> {
    static media::mojom::VideoAspectRatio_Type type(const media::VideoAspectRatio& input)
    {
        switch (input.type_) {
    ...
    static bool Read(media::mojom::VideoAspectRatioDataView data, media::VideoAspectRatio* output)
    {
        switch (data.type()) {
