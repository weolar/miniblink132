...
EnumTraits<media::mojom::VideoEncodeAcceleratorSupportedRateControlMode, media::VideoEncodeAccelerator::SupportedRateControlMode>::ToMojom(
    media::VideoEncodeAccelerator::SupportedRateControlMode mode)
{
    switch (mode) {
    case media::VideoEncodeAccelerator::kNoMode:
        return media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kNoMode;
    case media::VideoEncodeAccelerator::kConstantMode:
        return media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kConstantMode;
    case media::VideoEncodeAccelerator::kVariableMode:
        return media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kVariableMode;
    case media::VideoEncodeAccelerator::kExternalMode:
        return media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kExternalMode;
    }
    NOTREACHED();
}

// static
bool EnumTraits<media::mojom::VideoEncodeAcceleratorSupportedRateControlMode, media::VideoEncodeAccelerator::SupportedRateControlMode>::FromMojom(
    media::mojom::VideoEncodeAcceleratorSupportedRateControlMode mode, media::VideoEncodeAccelerator::SupportedRateControlMode* out)
{
    switch (mode) {
    case media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kNoMode:
        *out = media::VideoEncodeAccelerator::kNoMode;
        return true;
    case media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kConstantMode:
        *out = media::VideoEncodeAccelerator::kConstantMode;
        return true;
    case media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kVariableMode:
        *out = media::VideoEncodeAccelerator::kVariableMode;
        return true;
    case media::mojom::VideoEncodeAcceleratorSupportedRateControlMode::kExternalMode:
...
// static
bool StructTraits<media::mojom::VideoEncodeAcceleratorSupportedProfileDataView, media::VideoEncodeAccelerator::SupportedProfile>::Read(
    media::mojom::VideoEncodeAcceleratorSupportedProfileDataView data, media::VideoEncodeAccelerator::SupportedProfile* out)
{
    if (!data.ReadMinResolution(&out->min_resolution) || !data.ReadMaxResolution(&out->max_resolution) || !data.ReadProfile(&out->profile)) {
        return false;
    }
...
// static
bool StructTraits<media::mojom::VariableBitratePeakDataView, uint32_t>::Read(media::mojom::VariableBitratePeakDataView data, uint32_t* out_peak_bps)
{
...
// static
std::vector<uint32_t> StructTraits<media::mojom::VideoBitrateAllocationDataView, media::VideoBitrateAllocation>::bitrates(
    const media::VideoBitrateAllocation& bitrate_allocation)
{
    std::vector<uint32_t> bitrates;
    uint32_t sum_bps = 0;
    for (size_t si = 0; si < media::VideoBitrateAllocation::kMaxSpatialLayers; ++si) {
        for (size_t ti = 0; ti < media::VideoBitrateAllocation::kMaxTemporalLayers; ++ti) {
...
// static
bool StructTraits<media::mojom::VideoBitrateAllocationDataView, media::VideoBitrateAllocation>::Read(
    media::mojom::VideoBitrateAllocationDataView data, media::VideoBitrateAllocation* out_bitrate_allocation)
{
    std::optional<uint32_t> peak_bps;
    if (!data.ReadVariableBitratePeak(&peak_bps))
        return false;
    if (peak_bps.has_value()) {
        *out_bitrate_allocation = media::VideoBitrateAllocation(media::Bitrate::Mode::kVariable);
    } else {
        *out_bitrate_allocation = media::VideoBitrateAllocation(media::Bitrate::Mode::kConstant);
    }
    ArrayDataView<uint32_t> bitrates;
    data.GetBitratesDataView(&bitrates);
    size_t size = bitrates.size();
    if (size > media::VideoBitrateAllocation::kMaxSpatialLayers * media::VideoBitrateAllocation::kMaxTemporalLayers) {
        return false;
    }
...
// static
bool StructTraits<media::mojom::VideoEncodeOptionsDataView, media::VideoEncoder::EncodeOptions>::Read(
    media::mojom::VideoEncodeOptionsDataView data, media::VideoEncoder::EncodeOptions* out_options)
{
...
// static
bool UnionTraits<media::mojom::OptionalMetadataDataView, media::BitstreamBufferMetadata>::Read(
    media::mojom::OptionalMetadataDataView data, media::BitstreamBufferMetadata* out)
{
    switch (data.tag()) {
...
// static
bool StructTraits<media::mojom::BitstreamBufferMetadataDataView, media::BitstreamBufferMetadata>::Read(
    media::mojom::BitstreamBufferMetadataDataView data, media::BitstreamBufferMetadata* metadata)
{
...
// static
bool StructTraits<media::mojom::DropFrameMetadataDataView, media::DropFrameMetadata>::Read(
    media::mojom::DropFrameMetadataDataView data, media::DropFrameMetadata* out_metadata)
{
...
// static
bool StructTraits<media::mojom::H264MetadataDataView, media::H264Metadata>::Read(media::mojom::H264MetadataDataView data, media::H264Metadata* out_metadata)
{
...
// static
bool StructTraits<media::mojom::Vp8MetadataDataView, media::Vp8Metadata>::Read(media::mojom::Vp8MetadataDataView data, media::Vp8Metadata* out_metadata)
{
...
// static
bool StructTraits<media::mojom::Vp9MetadataDataView, media::Vp9Metadata>::Read(media::mojom::Vp9MetadataDataView data, media::Vp9Metadata* out_metadata)
{
    out_metadata->inter_pic_predicted = data.inter_pic_predicted();
    out_metadata->temporal_up_switch = data.temporal_up_switch();
    out_metadata->referenced_by_upper_spatial_layers = data.referenced_by_upper_spatial_layers();
    out_metadata->reference_lower_spatial_layers = data.reference_lower_spatial_layers();
    out_metadata->end_of_picture = data.end_of_picture();
    out_metadata->temporal_idx = data.temporal_idx();
    out_metadata->spatial_idx = data.spatial_idx();
    out_metadata->begin_active_spatial_layer_index = data.begin_active_spatial_layer_index();
    out_metadata->end_active_spatial_layer_index = data.end_active_spatial_layer_index();
    return data.ReadSpatialLayerResolutions(&out_metadata->spatial_layer_resolutions) && data.ReadPDiffs(&out_metadata->p_diffs);
}

// static
bool StructTraits<media::mojom::SVCGenericMetadataDataView, media::SVCGenericMetadata>::Read(
    media::mojom::SVCGenericMetadataDataView data, media::SVCGenericMetadata* out_metadata)
{
...
EnumTraits<media::mojom::VideoEncodeAcceleratorConfig_StorageType, media::VideoEncodeAccelerator::Config::StorageType>::ToMojom(
    media::VideoEncodeAccelerator::Config::StorageType input)
{
    ...
    case media::VideoEncodeAccelerator::Config::StorageType::kGpuMemoryBuffer:
        return media::mojom::VideoEncodeAcceleratorConfig_StorageType::kGpuMemoryBuffer;
...
// static
bool EnumTraits<media::mojom::VideoEncodeAcceleratorConfig_StorageType, media::VideoEncodeAccelerator::Config::StorageType>::FromMojom(
    media::mojom::VideoEncodeAcceleratorConfig_StorageType input, media::VideoEncodeAccelerator::Config::StorageType* output)
{
    switch (input) {
    case media::mojom::VideoEncodeAcceleratorConfig_StorageType::kShmem:
        *output = media::VideoEncodeAccelerator::Config::StorageType::kShmem;
        return true;
    case media::mojom::VideoEncodeAcceleratorConfig_StorageType::kGpuMemoryBuffer:
        *output = media::VideoEncodeAccelerator::Config::StorageType::kGpuMemoryBuffer;
        return true;
    }
    NOTREACHED();
}
...
EnumTraits<media::mojom::VideoEncodeAcceleratorConfig_EncoderType, media::VideoEncodeAccelerator::Config::EncoderType>::ToMojom(
    media::VideoEncodeAccelerator::Config::EncoderType input)
{
    ...
    case media::VideoEncodeAccelerator::Config::EncoderType::kNoPreference:
        return media::mojom::VideoEncodeAcceleratorConfig_EncoderType::kNoPreference;
    }
    NOTREACHED();
}

// static
bool EnumTraits<media::mojom::VideoEncodeAcceleratorConfig_EncoderType, media::VideoEncodeAccelerator::Config::EncoderType>::FromMojom(
    media::mojom::VideoEncodeAcceleratorConfig_EncoderType input, media::VideoEncodeAccelerator::Config::EncoderType* output)
{
    switch (input) {
    ...
    case media::mojom::VideoEncodeAcceleratorConfig_EncoderType::kNoPreference:
        *output = media::VideoEncodeAccelerator::Config::EncoderType::kNoPreference;
        return true;
    }
    NOTREACHED();
}
...
EnumTraits<media::mojom::VideoEncodeAcceleratorConfig_ContentType, media::VideoEncodeAccelerator::Config::ContentType>::ToMojom(
...
// static
bool EnumTraits<media::mojom::VideoEncodeAcceleratorConfig_ContentType, media::VideoEncodeAccelerator::Config::ContentType>::FromMojom(
    media::mojom::VideoEncodeAcceleratorConfig_ContentType input, media::VideoEncodeAccelerator::Config::ContentType* output)
{
    switch (input) {
...
// static
bool StructTraits<media::mojom::SpatialLayerDataView, media::VideoEncodeAccelerator::Config::SpatialLayer>::Read(
    media::mojom::SpatialLayerDataView input, media::VideoEncodeAccelerator::Config::SpatialLayer* output)
{
...
// static
bool StructTraits<media::mojom::ConstantBitrateDataView, media::Bitrate>::Read(media::mojom::ConstantBitrateDataView input, media::Bitrate* output)
{
...
// static
bool StructTraits<media::mojom::VariableBitrateDataView, media::Bitrate>::Read(media::mojom::VariableBitrateDataView input, media::Bitrate* output)
{
    if (input.target_bps() > input.peak_bps())
        return false;
    if (input.peak_bps() == 0u)
        return false;
    *output = media::Bitrate::VariableBitrate(input.target_bps(), input.peak_bps());
    return true;
}

// static
bool StructTraits<media::mojom::ExternalBitrateDataView, media::Bitrate>::Read(media::mojom::ExternalBitrateDataView input, media::Bitrate* output)
{
...
// static
media::mojom::BitrateDataView::Tag UnionTraits<media::mojom::BitrateDataView, media::Bitrate>::GetTag(const media::Bitrate& input)
{
    switch (input.mode()) {
...
// static
bool UnionTraits<media::mojom::BitrateDataView, media::Bitrate>::Read(media::mojom::BitrateDataView input, media::Bitrate* output)
{
    switch (input.tag()) {
...
// static
bool StructTraits<media::mojom::VideoEncodeAcceleratorConfigDataView, media::VideoEncodeAccelerator::Config>::Read(
    media::mojom::VideoEncodeAcceleratorConfigDataView input, media::VideoEncodeAccelerator::Config* output)
{
    ...
    static_assert(sizeof(CheckVEAConfig) == sizeof(media::VideoEncodeAccelerator::Config),
    ...
    *output = media::VideoEncodeAccelerator::Config(input_format, input_visible_size, output_profile, bitrate, framerate, storage_type, content_type);
