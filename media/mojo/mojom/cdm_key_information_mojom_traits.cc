...
// static
MojomKeyStatus EnumTraits<MojomKeyStatus, NativeKeyStatus>::ToMojom(NativeKeyStatus error)
{
    switch (error) {
...
// static
bool EnumTraits<MojomKeyStatus, NativeKeyStatus>::FromMojom(MojomKeyStatus error, NativeKeyStatus* out)
{
    switch (error) {
...
// static
bool StructTraits<media::mojom::CdmKeyInformationDataView, std::unique_ptr<media::CdmKeyInformation>>::Read(
    media::mojom::CdmKeyInformationDataView input, std::unique_ptr<media::CdmKeyInformation>* output)
{
    ...
    *output = std::make_unique<media::CdmKeyInformation>(key_id.data(), key_id.size(), status, input.system_code());
    return true;
}
