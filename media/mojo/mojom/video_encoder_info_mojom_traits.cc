...
// static
bool StructTraits<media::mojom::ResolutionBitrateLimitDataView, media::ResolutionBitrateLimit>::Read(
    media::mojom::ResolutionBitrateLimitDataView data, media::ResolutionBitrateLimit* out)
{
...
// static
bool StructTraits<media::mojom::VideoEncoderInfoDataView, media::VideoEncoderInfo>::Read(
    media::mojom::VideoEncoderInfoDataView data, media::VideoEncoderInfo* out)
{
    ...
    out->apply_alignment_to_all_simulcast_layers = data.apply_alignment_to_all_simulcast_layers();
