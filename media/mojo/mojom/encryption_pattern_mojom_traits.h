...
template <> struct StructTraits<media::mojom::EncryptionPatternDataView, media::EncryptionPattern> {
    ...
    static bool Read(media::mojom::EncryptionPatternDataView input, media::EncryptionPattern* output);
};
