...
public:
    explicit MojoDataPipeReader(mojo::ScopedDataPipeConsumerHandle consumer_handle);
...
public:
    explicit MojoDataPipeWriter(mojo::ScopedDataPipeProducerHandle producer_handle);
