...
public:
    explicit MojoVideoEncodeAccelerator(mojo::PendingRemote<mojom::VideoEncodeAccelerator> vea);

    MojoVideoEncodeAccelerator(const MojoVideoEncodeAccelerator&) = delete;
    MojoVideoEncodeAccelerator& operator=(const MojoVideoEncodeAccelerator&) = delete;
    ...
    void Encode(scoped_refptr<VideoFrame> frame, const VideoEncoder::EncodeOptions&) override;
    void UseOutputBitstreamBuffer(BitstreamBuffer buffer) override;
    void RequestEncodingParametersChange(const Bitrate& bitrate, uint32_t framerate_num, const std::optional<gfx::Size>& size) override;
