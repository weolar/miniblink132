...
public:
    MojoRenderer(const scoped_refptr<base::SequencedTaskRunner>& task_runner, std::unique_ptr<VideoOverlayFactory> video_overlay_factory,
    ...
    void Initialize(MediaResource* media_resource, media::RendererClient* client, PipelineStatusCallback init_cb) override;
...
private:
    ...
    raw_ptr<VideoRendererSink, FlakyDanglingUntriaged | AcrossTasksDanglingUntriaged> video_renderer_sink_ = nullptr;
