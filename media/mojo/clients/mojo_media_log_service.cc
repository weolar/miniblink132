...
MojoMediaLogService::MojoMediaLogService(std::unique_ptr<media::MediaLog> media_log)
...
void MojoMediaLogService::AddLogRecord(const MediaLogRecord& event)
{
    ...
    std::unique_ptr<media::MediaLogRecord> modified_event = std::make_unique<media::MediaLogRecord>(event);
