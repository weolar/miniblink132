...
class MojoAndroidOverlay : public AndroidOverlay, public mojom::AndroidOverlayClient {
public:
    MojoAndroidOverlay(
    ...
    void OnSynchronouslyDestroyed(OnSynchronouslyDestroyedCallback done_cb) override;
