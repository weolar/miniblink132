...
// platform.
std::unique_ptr<MediaService> MEDIA_MOJO_EXPORT CreateMediaService(mojo::PendingReceiver<mojom::MediaService> receiver);
...
std::unique_ptr<MediaService> MEDIA_MOJO_EXPORT CreateGpuMediaService(
    mojo::PendingReceiver<mojom::MediaService> receiver, std::unique_ptr<GpuMojoMediaClient> client);

// Creates a MediaService instance using the TestMojoMediaClient.
std::unique_ptr<MediaService> MEDIA_MOJO_EXPORT CreateMediaServiceForTesting(mojo::PendingReceiver<mojom::MediaService> receiver);
