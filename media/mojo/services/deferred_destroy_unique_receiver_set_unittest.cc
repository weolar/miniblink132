...
public:
    DeferredDestroyPingImpl()
    {
        ++instance_count;
    }
    ~DeferredDestroyPingImpl() override
    {
        --instance_count;
    }
...
DeferredDestroyPingImpl* AddDeferredDestroyReceiver(DeferredDestroyUniqueReceiverSet<PingService>* receivers, mojo::PendingRemote<PingService>* ptr)
{
...
TEST_F(DeferredDestroyUniqueReceiverSetTest, Destructor)
{
    ...
    auto receivers = std::make_unique<DeferredDestroyUniqueReceiverSet<PingService>>();
