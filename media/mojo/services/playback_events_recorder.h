...
class MEDIA_MOJO_EXPORT PlaybackEventsRecorder final : public mojom::PlaybackEventsRecorder {
public:
    static void Create(mojo::PendingReceiver<mojom::PlaybackEventsRecorder> receiver);

    PlaybackEventsRecorder();
    ~PlaybackEventsRecorder() final;

    PlaybackEventsRecorder(const PlaybackEventsRecorder&) = delete;
    PlaybackEventsRecorder& operator=(const PlaybackEventsRecorder&) = delete;
