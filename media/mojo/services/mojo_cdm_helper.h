...
class MEDIA_MOJO_EXPORT MojoCdmHelper final : public CdmAuxiliaryHelper, public MojoCdmFileIO::Delegate {
public:
    ...
    void EnableProtection(uint32_t desired_protection_mask, EnableProtectionCB callback) final;
    void ChallengePlatform(const std::string& service_id, const std::string& challenge, ChallengePlatformCB callback) final;
