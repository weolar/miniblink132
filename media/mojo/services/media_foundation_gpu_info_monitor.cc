...
void MediaFoundationGpuInfoMonitor::UpdateGpuInfo(const gpu::GPUInfo& gpu_info)
{
...
base::CallbackListSubscription MediaFoundationGpuInfoMonitor::AddLuidObserver(MediaFoundationGpuInfoMonitor::LuidObservers::CallbackType cb)
{
