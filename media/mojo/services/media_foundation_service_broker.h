...
class MEDIA_MOJO_EXPORT MediaFoundationServiceBroker final : public mojom::MediaFoundationServiceBroker, public mojom::GpuInfoObserver {
public:
    ...
    MediaFoundationServiceBroker(mojo::PendingReceiver<mojom::MediaFoundationServiceBroker> receiver, base::OnceClosure ensure_sandboxed_cb);
    MediaFoundationServiceBroker(const MediaFoundationServiceBroker&) = delete;
    MediaFoundationServiceBroker operator=(const MediaFoundationServiceBroker&) = delete;
    ~MediaFoundationServiceBroker() final;

    // mojom::MediaFoundationServiceBroker:
    void UpdateGpuInfo(const gpu::GPUInfo& gpu_info, UpdateGpuInfoCallback callback) final;
    void GetService(const base::FilePath& cdm_path, mojo::PendingReceiver<mojom::MediaFoundationService> service_receiver) final;
