...
// to handle this.
template <typename F, typename... T> class MojoCdmPromise final : public CdmPromiseTemplate<T...> {
public:
    ...
    void reject(CdmPromise::Exception exception, uint32_t system_code, const std::string& error_message) final;
