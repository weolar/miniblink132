...
class MEDIA_MOJO_EXPORT MediaDrmSupportService final : public mojom::MediaDrmSupport {
public:
    explicit MediaDrmSupportService(mojo::PendingReceiver<mojom::MediaDrmSupport> receiver);
