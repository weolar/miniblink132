...
class MEDIA_MOJO_EXPORT WebrtcVideoPerfRecorder : public media::mojom::WebrtcVideoPerfRecorder {
public:
    ...
    static void Create(media::WebrtcVideoPerfHistory* webrtc_video_perf_history, mojo::PendingReceiver<media::mojom::WebrtcVideoPerfRecorder> receiver);

    explicit WebrtcVideoPerfRecorder(WebrtcVideoPerfHistory::SaveCallback save_cb);
    ...
    void UpdateRecord(media::mojom::WebrtcPredictionFeaturesPtr features, media::mojom::WebrtcVideoStatsPtr video_stats) override;
