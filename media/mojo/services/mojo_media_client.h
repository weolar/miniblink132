...
public:
    ...
    virtual std::unique_ptr<AudioDecoder> CreateAudioDecoder(scoped_refptr<base::SequencedTaskRunner> task_runner, std::unique_ptr<MediaLog> media_log);

    virtual std::unique_ptr<AudioEncoder> CreateAudioEncoder(scoped_refptr<base::SequencedTaskRunner> task_runner);

    virtual SupportedAudioDecoderConfigs GetSupportedAudioDecoderConfigs();

    virtual std::vector<SupportedVideoDecoderConfig> GetSupportedVideoDecoderConfigs();
    ...
    virtual void NotifyDecoderSupportKnown(mojo::PendingRemote<stable::mojom::StableVideoDecoder> oop_video_decoder,
        base::OnceCallback<void(mojo::PendingRemote<stable::mojom::StableVideoDecoder>)> cb);
#endif // BUILDFLAG(ALLOW_OOP_VIDEO_DECODER)

    virtual std::unique_ptr<VideoDecoder> CreateVideoDecoder(scoped_refptr<base::SequencedTaskRunner> task_runner, MediaLog* media_log,
    ...
    virtual std::unique_ptr<Renderer> CreateRenderer(mojom::FrameInterfaceFactory* frame_interfaces, scoped_refptr<base::SingleThreadTaskRunner> task_runner,
        MediaLog* media_log, const std::string& audio_device_id);
    ...
    virtual std::unique_ptr<Renderer> CreateCastRenderer(mojom::FrameInterfaceFactory* frame_interfaces,
...
#if BUILDFLAG(IS_WIN)
    virtual std::unique_ptr<Renderer> CreateMediaFoundationRenderer(scoped_refptr<base::SingleThreadTaskRunner> task_runner,
    ...
    virtual std::unique_ptr<CdmFactory> CreateCdmFactory(mojom::FrameInterfaceFactory* frame_interfaces);
