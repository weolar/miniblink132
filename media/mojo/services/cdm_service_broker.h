...
class MEDIA_MOJO_EXPORT CdmServiceBroker final : public mojom::CdmServiceBroker {
public:
    CdmServiceBroker(std::unique_ptr<CdmService::Client> client, mojo::PendingReceiver<mojom::CdmServiceBroker> receiver);
