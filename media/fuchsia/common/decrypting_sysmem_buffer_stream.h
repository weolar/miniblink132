...
public:
    DecryptingSysmemBufferStream(SysmemAllocatorClient* sysmem_allocator, CdmContext* cdm_context, Decryptor::StreamType stream_type);
    ~DecryptingSysmemBufferStream() override;

    DecryptingSysmemBufferStream(const DecryptingSysmemBufferStream&) = delete;
    DecryptingSysmemBufferStream& operator=(const DecryptingSysmemBufferStream&) = delete;
