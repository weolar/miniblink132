...
public:
    ...
    static fuchsia::sysmem2::BufferCollectionConstraints GetRecommendedConstraints(
    ...
    static std::vector<VmoBuffer> CreateBuffersFromSysmemCollection(fuchsia::sysmem2::BufferCollectionInfo* info, bool writable);
    ...
    // to map the buffer.
    [[nodiscard]] bool Initialize(zx::vmo vmo, bool writable, size_t offset, size_t size, fuchsia::sysmem2::CoherencyDomain coherency_domain);
