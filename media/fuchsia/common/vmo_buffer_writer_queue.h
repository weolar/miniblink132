...
public:
    ...
    using SendPacketCB = base::RepeatingCallback<void(const DecoderBuffer* buffer, StreamProcessorHelper::IoPacket packet)>;
    ...
    void Start(std::vector<VmoBuffer> buffers, SendPacketCB send_packet_cb, EndOfStreamCB end_of_stream_cb);
