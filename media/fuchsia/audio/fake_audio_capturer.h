...
// for tests.
class FakeAudioCapturer final : public fuchsia::media::testing::AudioCapturer_TestBase {
public:
    ...
    explicit FakeAudioCapturer(fidl::InterfaceRequest<fuchsia::media::AudioCapturer> request = {});
...
class FakeAudioCapturerFactory final : public fuchsia::media::testing::Audio_TestBase {
public:
    ...
    void CreateAudioCapturer(fidl::InterfaceRequest<fuchsia::media::AudioCapturer> request, bool loopback) override;
