...
class FakeAudioDeviceEnumerator final : public fuchsia::media::testing::AudioDeviceEnumerator_TestBase {
public:
    ...
    FakeAudioDeviceEnumerator& operator=(const FakeAudioDeviceEnumerator&) = delete;
