...
FakeAudioDeviceEnumeratorLocalComponent::FakeAudioDeviceEnumeratorLocalComponent() = default;

FakeAudioDeviceEnumeratorLocalComponent::~FakeAudioDeviceEnumeratorLocalComponent() = default;

void FakeAudioDeviceEnumeratorLocalComponent::GetDevices(GetDevicesCallback callback)
{
...
void FakeAudioDeviceEnumeratorLocalComponent::NotImplemented_(const std::string& name)
{
