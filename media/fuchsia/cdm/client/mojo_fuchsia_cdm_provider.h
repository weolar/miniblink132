...
public:
    ...
    explicit MojoFuchsiaCdmProvider(blink::BrowserInterfaceBrokerProxy* interface_broker);
    ...
    void CreateCdmInterface(const std::string& key_system, fidl::InterfaceRequest<fuchsia::media::drm::ContentDecryptionModule> cdm_request) override;

private:
    blink::BrowserInterfaceBrokerProxy* const interface_broker_;
    mojo::Remote<media::mojom::FuchsiaMediaResourceProvider> media_resource_provider_;
};
