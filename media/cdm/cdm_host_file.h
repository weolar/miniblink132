...
struct MEDIA_EXPORT CdmHostFilePath {
    CdmHostFilePath(const base::FilePath& file_path, const base::FilePath& sig_file_path);
    ~CdmHostFilePath();
...
public:
    ...
    static std::unique_ptr<CdmHostFile> Create(const base::FilePath& file_path, const base::FilePath& sig_file_path);
...
private:
    CdmHostFile(const base::FilePath& file_path, base::File file, base::File sig_file);
