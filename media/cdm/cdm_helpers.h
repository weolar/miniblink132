...
class MEDIA_EXPORT VideoFrameImpl : public cdm::VideoFrame, public cdm::VideoFrame_2 {
public:
    VideoFrameImpl();
    ...
    virtual scoped_refptr<media::VideoFrame> TransformToVideoFrame(gfx::Size natural_size) = 0;
