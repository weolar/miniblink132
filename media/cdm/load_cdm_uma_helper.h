...
void ReportLoadErrorCode(const std::string& uma_prefix, const base::NativeLibraryLoadError* error);

// Reports the loading time of CDM library to UMA.
void ReportLoadTime(const std::string& uma_prefix, const base::TimeDelta load_time);
