...
struct MEDIA_EXPORT VideoCodecInfo {
    VideoCodecInfo();
    VideoCodecInfo(base::flat_set<VideoCodecProfile> supported_profiles, bool supports_clear_lead);
...
bool MEDIA_EXPORT operator==(const VideoCodecInfo& lhs, const VideoCodecInfo& rhs);
...
struct MEDIA_EXPORT CdmCapability {
    ...
    CdmCapability();
    CdmCapability(base::flat_set<AudioCodec> audio_codecs, VideoCodecMap video_codecs, base::flat_set<EncryptionScheme> encryption_schemes,
...
bool MEDIA_EXPORT operator==(const CdmCapability& lhs, const CdmCapability& rhs);
