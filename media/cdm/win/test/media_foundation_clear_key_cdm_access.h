...
class MediaFoundationClearKeyCdmAccess final : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>,
                                                   IMFContentDecryptionModuleAccess, Microsoft::WRL::FtmBase> {
public:
    MediaFoundationClearKeyCdmAccess();
    MediaFoundationClearKeyCdmAccess(const MediaFoundationClearKeyCdmAccess&) = delete;
    MediaFoundationClearKeyCdmAccess& operator=(const MediaFoundationClearKeyCdmAccess&) = delete;
    ~MediaFoundationClearKeyCdmAccess() override;

    HRESULT RuntimeClassInitialize();

    // IMFContentDecryptionModuleAccess
    STDMETHODIMP CreateContentDecryptionModule(_In_opt_ IPropertyStore* properties, _COM_Outptr_ IMFContentDecryptionModule** cdm) override;
