...
class MockMediaProtectionPMPServer final : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>,
                                               ABI::Windows::Media::Protection::IMediaProtectionPMPServer, IMFGetService, Microsoft::WRL::FtmBase> {
public:
    ...
    MockMediaProtectionPMPServer& operator=(const MockMediaProtectionPMPServer&) = delete;

    HRESULT RuntimeClassInitialize(ABI::Windows::Foundation::Collections::IPropertySet* property_pmp);

    // IInspectable
    STDMETHODIMP GetIids(_COM_Outptr_ ULONG* iidCount, _COM_Outptr_ IID** iids) override;
    ...
    STDMETHODIMP get_Properties(_COM_Outptr_ ABI::Windows::Foundation::Collections::IPropertySet** ppProperties) override;
...
private:
    Microsoft::WRL::ComPtr<ABI::Windows::Foundation::Collections::IPropertySet> property_pmp_;
