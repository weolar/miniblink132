...
BOOL WINAPI DllMain(_In_opt_ HINSTANCE instance, _In_ DWORD reason, _In_opt_ LPVOID reserved)
{
...
HRESULT WINAPI DllGetActivationFactory(_In_ HSTRING activatible_class_id, _COM_Outptr_ IActivationFactory** factory)
{
