...
MockLibraryCdm::MockLibraryCdm(HostInterface* host, const std::string& key_system)
...
void MockLibraryCdm::Initialize(bool allow_distinctive_identifier, bool allow_persistent_state, bool use_hw_secure_codecs)
{
