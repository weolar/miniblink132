...
std::optional<int> GetSupportedCdmInterfaceVersionOverrideFromCommandLine()
{
    ...
    auto version_string = command_line->GetSwitchValueASCII(switches::kOverrideEnabledCdmInterfaceVersion);
...
bool IsSupportedAndEnabledCdmInterfaceVersion(int version)
{
    ...
    auto version_override = GetSupportedCdmInterfaceVersionOverrideFromCommandLine();
    if (version_override)
