...
public:
    ...
    virtual bool StartStream(AudioOutputStream::AudioSourceCallback* callback, AudioOutputProxy* stream_proxy) = 0;
    ...
    virtual void StreamVolumeSet(AudioOutputProxy* stream_proxy, double volume) = 0;
