...
{
    std::vector<AudioDeviceDescription> device_descriptions { AudioDeviceDescription("Super fantastic microphone", "uniqueId", "groupId") };
...
{
    std::vector<AudioDeviceDescription> device_descriptions { AudioDeviceDescription("User's AirPods", "uniqueId", "groupId") };
    AudioDeviceDescription::LocalizeDeviceDescriptions(&device_descriptions);
...
TEST(AudioDeviceDescriptionTest, LocalizedUserNameInDefaultDeviceIsSanitized)
{
    std::vector<AudioDeviceDescription> device_descriptions {
        ...
        AudioDeviceDescription("AirPods User Hands-Free AG Audio", "uniqueId", "groupId"),
...
TEST(AudioDeviceDescriptionTest, IsLoopbackDevice)
{
    ...
    EXPECT_TRUE(AudioDeviceDescription::IsLoopbackDevice(AudioDeviceDescription::kLoopbackWithMuteDeviceId));
    EXPECT_TRUE(AudioDeviceDescription::IsLoopbackDevice(AudioDeviceDescription::kLoopbackWithoutChromeId));
    EXPECT_FALSE(AudioDeviceDescription::IsLoopbackDevice(AudioDeviceDescription::kDefaultDeviceId));
}
