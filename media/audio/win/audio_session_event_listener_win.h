...
class MEDIA_EXPORT AudioSessionEventListener
    : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>, IAudioSessionEvents> {
public:
...
private:
    ...
    IFACEMETHODIMP OnChannelVolumeChanged(DWORD channel_count, float new_channel_volume_array[], DWORD changed_channel, LPCGUID event_context) override;
    IFACEMETHODIMP OnDisplayNameChanged(LPCWSTR new_display_name, LPCGUID event_context) override;
    IFACEMETHODIMP OnGroupingParamChanged(LPCGUID new_grouping_param, LPCGUID event_context) override;
    IFACEMETHODIMP OnIconPathChanged(LPCWSTR new_icon_path, LPCGUID event_context) override;
    IFACEMETHODIMP OnSessionDisconnected(AudioSessionDisconnectReason disconnect_reason) override;
    IFACEMETHODIMP OnSimpleVolumeChanged(float new_volume, BOOL new_mute, LPCGUID event_context) override;
