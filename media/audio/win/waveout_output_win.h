...
public:
    ...
    PCMWaveOutAudioOutputStream(AudioManagerWin* manager, const AudioParameters& params, int num_buffers, UINT device_id);

    PCMWaveOutAudioOutputStream(const PCMWaveOutAudioOutputStream&) = delete;
    PCMWaveOutAudioOutputStream& operator=(const PCMWaveOutAudioOutputStream&) = delete;
