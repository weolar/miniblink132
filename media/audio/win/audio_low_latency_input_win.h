...
class MEDIA_EXPORT WASAPIAudioInputStream : public AgcAudioStream<AudioInputStream>,
...
public:
    ...
    WASAPIAudioInputStream(AudioManagerWin* manager, const AudioParameters& params, const std::string& device_id, AudioManager::LogCallback log_callback);
...
private:
    ...
    std::vector<ABI::Windows::Media::Effects::AudioEffectType> default_effect_types_;
    // List of supported and active capture effects for the selected device in
