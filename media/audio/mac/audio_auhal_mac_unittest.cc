...
public:
    ...
    AudioOutputStream* Create()
    {
        return manager_->MakeAudioOutputStream(
            manager_device_info_.GetDefaultOutputStreamParameters(), "", base::BindRepeating(&AUHALStreamTest::OnLogMessage, base::Unretained(this)));
    }
...
TEST_F(AUHALStreamTest, HardwareSampleRate)
{
    ...
    const AudioParameters preferred_params = manager_device_info_.GetDefaultOutputStreamParameters();
