...
public:
    static AudioOutputStream* MakeFakeStream(AudioManagerBase* manager, const AudioParameters& params);
...
private:
    FakeAudioOutputStream(AudioManagerBase* manager, const AudioParameters& params);
