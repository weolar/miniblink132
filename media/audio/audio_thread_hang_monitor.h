...
public:
    using Ptr = std::unique_ptr<AudioThreadHangMonitor, base::OnTaskRunnerDeleter>;
    ...
    static Ptr Create(HangAction hang_action, std::optional<base::TimeDelta> hang_deadline, const base::TickClock* clock,
        scoped_refptr<base::SingleThreadTaskRunner> audio_thread_task_runner, scoped_refptr<base::SequencedTaskRunner> monitor_task_runner = nullptr);
...
private:
    ...
    class SharedAtomicFlag final : public base::RefCountedThreadSafe<SharedAtomicFlag> {
    public:
        SharedAtomicFlag();
    ...
    AudioThreadHangMonitor(HangAction hang_action, std::optional<base::TimeDelta> hang_deadline, const base::TickClock* clock,
    ...
    void SetHangActionCallbacksForTesting(base::RepeatingClosure dump_callback, base::RepeatingClosure terminate_process_callback);
