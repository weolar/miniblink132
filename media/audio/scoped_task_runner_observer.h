...
class ScopedTaskRunnerObserver : public base::CurrentThread::DestructionObserver {
public:
    explicit ScopedTaskRunnerObserver(const scoped_refptr<base::SingleThreadTaskRunner>& task_runner);
