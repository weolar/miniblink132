...
bool MEDIA_EXPORT InitPulse(pa_threaded_mainloop** mainloop, pa_context** context);
...
bool WaitForOperationCompletion(
    pa_threaded_mainloop* mainloop, pa_operation* operation, pa_context* optional_context = nullptr, pa_stream* optional_stream = nullptr);
