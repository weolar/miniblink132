...
public:
    AudioManagerFuchsia(std::unique_ptr<AudioThread> audio_thread, AudioLogFactory* audio_log_factory);
...
private:
    AudioInputStream* MakeInputStream(const AudioParameters& input_params, const std::string& device_id);
