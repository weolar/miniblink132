...
public:
    ...
    MockAudioDebugRecordingManager(const MockAudioDebugRecordingManager&) = delete;
    MockAudioDebugRecordingManager& operator=(const MockAudioDebugRecordingManager&) = delete;

    ~MockAudioDebugRecordingManager() override;

    MOCK_METHOD1(EnableDebugRecording, void(AudioDebugRecordingManager::CreateWavFileCallback create_file_callback));
