...
public:
    ...
    void ReportCallback(base::TimeDelta delay, const media::AudioGlitchInfo& glitch_info);
...
private:
    ...
    using AggregateLogCallback = base::RepeatingCallback<void(int value, SamplingPeriod sampling_period)>;
