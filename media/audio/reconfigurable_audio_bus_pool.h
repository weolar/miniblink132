...
public:
    explicit ReconfigurableAudioBusPoolImpl(base::TimeDelta preallocated_audio_bus_pool_duration);
    ReconfigurableAudioBusPoolImpl(const ReconfigurableAudioBusPoolImpl&) = delete;
    ReconfigurableAudioBusPoolImpl& operator=(const ReconfigurableAudioBusPoolImpl&) = delete;
