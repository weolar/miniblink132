...
public:
    ...
    public:
        ...
        virtual void OnStreamCreated(
            int stream_id, base::ReadOnlySharedMemoryRegion shared_memory_region, std::unique_ptr<base::CancelableSyncSocket> socket, bool initially_muted)
            = 0;
    ...
    virtual void OnSetOutputDeviceForAec(const std::string& raw_output_device_id) = 0;
};
