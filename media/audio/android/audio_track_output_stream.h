...
public:
    AudioTrackOutputStream(AudioManagerBase* manager, const AudioParameters& params);
    ...
    base::android::ScopedJavaLocalRef<jobject> OnMoreData(JNIEnv* env, jobject obj, jobject audio_data, jlong delay);
