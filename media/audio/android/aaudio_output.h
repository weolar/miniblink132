...
class REQUIRES_ANDROID_API(AAUDIO_MIN_API) AAudioOutputStream : public MuteableAudioOutputStream, public AAudioStreamWrapper::DataCallback {
public:
    AAudioOutputStream(AudioManagerAndroid* manager, const AudioParameters& params, aaudio_usage_t usage);
