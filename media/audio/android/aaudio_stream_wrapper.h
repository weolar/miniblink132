...
public:
    ...
    AAudioStreamWrapper(DataCallback* callback, StreamType stream_type, const AudioParameters& params, aaudio_usage_t usage);
    ...
    aaudio_data_callback_result_t OnAudioDataRequested(void* audio_data, int32_t num_frames);
