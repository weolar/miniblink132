...
public:
    AudioBusPoolTest()
        : params_(AudioParameters::AUDIO_PCM_LINEAR, ChannelLayoutConfig::Stereo(), 1000, 100)
    {
    }
    ...
    {
        audio_bus_pool_.reset(new AudioBusPoolImpl(params_, preallocated, max_capacity, base::BindLambdaForTesting([&](const AudioParameters& params) {
