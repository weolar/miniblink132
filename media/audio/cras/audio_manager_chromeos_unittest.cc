...
class GetStreamParametersForSystem : public ::testing::Test, public ::testing::WithParamInterface<std::tuple<int, bool, int32_t, bool, bool>> {
protected:
...
INSTANTIATE_TEST_SUITE_P(AllInputParameters, GetStreamParametersForSystem,
    ::testing::Combine(::testing::Values(512, kDefaultInputBufferSize), ::testing::Values(false, true),
        ::testing::Values(kNoAecFlaggedGroupId, kAecTestGroupId), ::testing::Values(false, true), ::testing::Values(false, true)));

TEST_P(GetStreamParametersForSystem, DefaultBehavior)
{
    GetTestParameters();
    AudioParameters params = AudioManagerChromeOS::GetStreamParametersForSystem(user_buffer_size_, system_apm_info_);
...
TEST_P(GetStreamParametersForSystem, BehaviorWithCrOSEnforceSystemAecDisallowed)
{
...
TEST_P(GetStreamParametersForSystem, BehaviorWithCrOSEnforceSystemAecNsAndAecAgc)
{
    base::test::ScopedFeatureList feature_list;
...
// See go/chrome-dcheck-on-cros or http://crbug.com/1113456 for more details.
#if !BUILDFLAG(IS_CHROMEOS_ASH)
TEST_P(GetStreamParametersForSystem, BehaviorWithCrOSEnforceSystemAecNsAgcAndDisallowedSystemAec)
{
    base::test::ScopedFeatureList feature_list;
    feature_list.InitAndEnableFeature(features::kCrOSEnforceSystemAecNsAgc);
    feature_list.InitAndDisableFeature(features::kCrOSSystemAEC);
...
class AllowedDspParameters : public ::testing::Test, public ::testing::WithParamInterface<std::tuple<bool, bool, bool>> {
protected:
    // Retrieve test parameter values.
    void GetTestParameters()
    {
...
INSTANTIATE_TEST_SUITE_P(AllAllowedDspInputParameters, AllowedDspParameters,
