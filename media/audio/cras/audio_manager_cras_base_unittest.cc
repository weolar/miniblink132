...
protected:
    ...
    ~AudioManagerCrasBaseTest() override
    {
...
{
    MockAecdumpRecordingManager* mock_aecdump_recording_manager = new MockAecdumpRecordingManager(mock_manager_->GetTaskRunner());
    mock_manager_->SetAecDumpRecordingManager(mock_aecdump_recording_manager->AsWeakPtr());
