...
public:
    explicit MockAecdumpRecordingManager(scoped_refptr<base::SingleThreadTaskRunner> task_runner);

    MockAecdumpRecordingManager(const MockAecdumpRecordingManager&) = delete;
    MockAecdumpRecordingManager& operator=(const MockAecdumpRecordingManager&) = delete;
