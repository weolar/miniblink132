...
public:
    ...
    AudioDeviceInfoAccessorForTests(const AudioDeviceInfoAccessorForTests&) = delete;
    AudioDeviceInfoAccessorForTests& operator=(const AudioDeviceInfoAccessorForTests&) = delete;

    bool HasAudioOutputDevices();

    bool HasAudioInputDevices();

    void GetAudioInputDeviceDescriptions(AudioDeviceDescriptions* device_descriptions);

    void GetAudioOutputDeviceDescriptions(AudioDeviceDescriptions* device_descriptions);
