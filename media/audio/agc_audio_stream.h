...
template <typename AudioInterface> class MEDIA_EXPORT AgcAudioStream : public AudioInterface {
public:
    // Time between two successive timer events.
    static constexpr base::TimeDelta kIntervalBetweenVolumeUpdates = base::Milliseconds(1000);
...
protected:
    ...
    void StartAgc()
    {
        ...
        timer_.Start(FROM_HERE, kIntervalBetweenVolumeUpdates, this, &AgcAudioStream::QueryAndStoreNewMicrophoneVolume);
    }
