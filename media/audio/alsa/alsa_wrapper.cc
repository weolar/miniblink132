...
int AlsaWrapper::PcmOpen(snd_pcm_t** handle, const char* name, snd_pcm_stream_t stream, int mode)
{
...
snd_pcm_sframes_t AlsaWrapper::PcmWritei(snd_pcm_t* handle, const void* buffer, snd_pcm_uframes_t size)
{
    return snd_pcm_writei(handle, buffer, size);
}

snd_pcm_sframes_t AlsaWrapper::PcmReadi(snd_pcm_t* handle, void* buffer, snd_pcm_uframes_t size)
{
...
int AlsaWrapper::PcmSetParams(
    snd_pcm_t* handle, snd_pcm_format_t format, snd_pcm_access_t access, unsigned int channels, unsigned int rate, int soft_resample, unsigned int latency)
{
    return snd_pcm_set_params(handle, format, access, channels, rate, soft_resample, latency);
}

int AlsaWrapper::PcmGetParams(snd_pcm_t* handle, snd_pcm_uframes_t* buffer_size, snd_pcm_uframes_t* period_size)
{
...
int AlsaWrapper::PcmHwParamsAny(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params)
{
...
int AlsaWrapper::PcmHwParamsSetRateResample(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, unsigned int value)
{
    return snd_pcm_hw_params_set_rate_resample(handle, hw_params, value);
}

int AlsaWrapper::PcmHwParamsSetRateNear(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, unsigned int* rate, int* direction)
{
    return snd_pcm_hw_params_set_rate_near(handle, hw_params, rate, direction);
}

int AlsaWrapper::PcmHwParamsTestFormat(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, snd_pcm_format_t format)
{
...
int AlsaWrapper::PcmHwParamsGetChannelsMin(const snd_pcm_hw_params_t* hw_params, unsigned int* min_channels)
{
    return snd_pcm_hw_params_get_channels_min(hw_params, min_channels);
}

int AlsaWrapper::PcmHwParamsGetChannelsMax(const snd_pcm_hw_params_t* hw_params, unsigned int* max_channels)
{
    return snd_pcm_hw_params_get_channels_min(hw_params, max_channels);
}

int AlsaWrapper::PcmHwParamsSetFormat(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, snd_pcm_format_t format)
{
    return snd_pcm_hw_params_set_format(handle, hw_params, format);
}

int AlsaWrapper::PcmHwParamsSetAccess(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, snd_pcm_access_t access)
{
    return snd_pcm_hw_params_set_access(handle, hw_params, access);
}

int AlsaWrapper::PcmHwParamsSetChannels(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, unsigned int channels)
{
    return snd_pcm_hw_params_set_channels(handle, hw_params, channels);
}

int AlsaWrapper::PcmHwParamsSetBufferSizeNear(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, snd_pcm_uframes_t* buffer_size)
{
    return snd_pcm_hw_params_set_buffer_size_near(handle, hw_params, buffer_size);
}

int AlsaWrapper::PcmHwParamsSetPeriodSizeNear(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params, snd_pcm_uframes_t* period_size, int* direction)
{
    return snd_pcm_hw_params_set_period_size_near(handle, hw_params, period_size, direction);
}

int AlsaWrapper::PcmHwParams(snd_pcm_t* handle, snd_pcm_hw_params_t* hw_params)
{
...
int AlsaWrapper::PcmSwParamsCurrent(snd_pcm_t* handle, snd_pcm_sw_params_t* sw_params)
{
    return snd_pcm_sw_params_current(handle, sw_params);
}

int AlsaWrapper::PcmSwParamsSetStartThreshold(snd_pcm_t* handle, snd_pcm_sw_params_t* sw_params, snd_pcm_uframes_t start_threshold)
{
    return snd_pcm_sw_params_set_start_threshold(handle, sw_params, start_threshold);
}

int AlsaWrapper::PcmSwParamsSetAvailMin(snd_pcm_t* handle, snd_pcm_sw_params_t* sw_params, snd_pcm_uframes_t period_size)
{
    return snd_pcm_sw_params_set_avail_min(handle, sw_params, period_size);
}

int AlsaWrapper::PcmSwParams(snd_pcm_t* handle, snd_pcm_sw_params_t* sw_params)
{
...
int AlsaWrapper::MixerElementRegister(snd_mixer_t* mixer, struct snd_mixer_selem_regopt* options, snd_mixer_class_t** classp)
{
...
int AlsaWrapper::MixerSelemSetCaptureVolumeAll(snd_mixer_elem_t* elem, long value)
{
    return snd_mixer_selem_set_capture_volume_all(elem, value);
}

int AlsaWrapper::MixerSelemGetCaptureVolume(snd_mixer_elem_t* elem, snd_mixer_selem_channel_id_t channel, long* value)
{
...
int AlsaWrapper::MixerSelemGetCaptureVolumeRange(snd_mixer_elem_t* elem, long* min, long* max)
{
...
void AlsaWrapper::MixerElemSetCallback(snd_mixer_elem_t* obj, snd_mixer_elem_callback_t val)
{
    snd_mixer_elem_set_callback(obj, val);
}

void AlsaWrapper::MixerElemSetCallbackPrivate(snd_mixer_elem_t* obj, void* val)
{
    snd_mixer_elem_set_callback_private(obj, val);
}

snd_mixer_elem_t* AlsaWrapper::MixerFindSelem(snd_mixer_t* mixer, const snd_mixer_selem_id_t* id)
{
...
int AlsaWrapper::MixerPollDescriptors(snd_mixer_t* mixer, struct pollfd* pfds, unsigned int space)
{
...
int AlsaWrapper::MixerSelemGetPlaybackSwitch(snd_mixer_elem_t* elem, snd_mixer_selem_channel_id_t channel, int* value)
{
    return snd_mixer_selem_get_playback_switch(elem, channel, value);
}

int AlsaWrapper::MixerSelemGetPlaybackVolume(snd_mixer_elem_t* elem, snd_mixer_selem_channel_id_t channel, long* value)
{
    return snd_mixer_selem_get_playback_volume(elem, channel, value);
}

int AlsaWrapper::MixerSelemGetPlaybackVolumeRange(snd_mixer_elem_t* elem, long* min, long* max)
{
    return snd_mixer_selem_get_playback_volume_range(elem, min, max);
}

int AlsaWrapper::MixerSelemAskPlaybackVolDb(snd_mixer_elem_t* elem, long value, long* db_value)
{
    return snd_mixer_selem_ask_playback_vol_dB(elem, value, db_value);
}

int AlsaWrapper::MixerSelemAskPlaybackDbVol(snd_mixer_elem_t* elem, long db_value, long* value)
{
...
void AlsaWrapper::MixerSelemIdSetIndex(snd_mixer_selem_id_t* obj, unsigned int val)
{
    snd_mixer_selem_id_set_index(obj, val);
}

void AlsaWrapper::MixerSelemIdSetName(snd_mixer_selem_id_t* obj, const char* val)
{
    snd_mixer_selem_id_set_name(obj, val);
}

int AlsaWrapper::MixerSelemSetPlaybackSwitch(snd_mixer_elem_t* elem, snd_mixer_selem_channel_id_t channel, int value)
{
    return snd_mixer_selem_set_playback_switch(elem, channel, value);
}

int AlsaWrapper::MixerSelemSetPlaybackSwitchAll(snd_mixer_elem_t* elem, int value)
{
    return snd_mixer_selem_set_playback_switch_all(elem, value);
}

int AlsaWrapper::MixerSelemSetPlaybackVolumeAll(snd_mixer_elem_t* elem, long value)
{
