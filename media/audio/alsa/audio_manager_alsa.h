...
public:
    AudioManagerAlsa(std::unique_ptr<AudioThread> audio_thread, AudioLogFactory* audio_log_factory);
...
private:
    ...
    // given type.
    void GetAlsaDevicesInfo(StreamType type, void** hint, AudioDeviceNames* device_names);
    ...
    static void AddAlsaDeviceFromSwitch(const char* switch_name, AudioDeviceNames* device_names);
