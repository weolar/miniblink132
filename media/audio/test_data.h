...
const char kTestFloatAudioData[] = "RIFF\x26\x00\x00\x00WAVEfmt \x10\x00\x00\x00"
...
const char kTestExtensibleAudioData[] = "RIFF\x44\x00\x00\x00WAVEfmt \x28\x00\x00\x00"
...
const size_t kTestExtensibleAudioDataSize = std::size(kTestExtensibleAudioData) - 1;
