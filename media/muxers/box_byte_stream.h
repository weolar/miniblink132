...
public:
    ...
    void StartFullBox(mp4::FourCC fourcc, uint32_t flags = 0, uint8_t version = 0);
    ...
    bool has_open_boxes() const
    {
        return !size_offsets_.empty();
    }
    ...
    std::vector<size_t> GetSizeOffsetsForTesting() const
    {
        return size_offsets_;
    }
