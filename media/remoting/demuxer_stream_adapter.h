...
public:
    ...
    //                   be shut down.
    DemuxerStreamAdapter(scoped_refptr<base::SingleThreadTaskRunner> main_task_runner, scoped_refptr<base::SequencedTaskRunner> media_task_runner,
        const std::string& name, DemuxerStream* demuxer_stream, const openscreen::WeakPtr<openscreen::cast::RpcMessenger>& rpc_messenger, int rpc_handle,
        mojo::PendingRemote<mojom::RemotingDataStreamSender> stream_sender_remote, mojo::ScopedDataPipeProducerHandle producer_handle,
    ...
    bool is_processing_read_request() const
    {
        ...
        return read_until_callback_handle_ != openscreen::cast::RpcMessenger::kInvalidHandle;
    }
...
private:
    ...
    void OnNewBuffersRead(DemuxerStream::Status status, DemuxerStream::DecoderBufferVector buffers_queue);
    void OnNewBuffer(DemuxerStream::Status status, scoped_refptr<DecoderBuffer> input);
