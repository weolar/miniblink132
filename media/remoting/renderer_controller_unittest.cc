...
mojom::RemotingSinkMetadataPtr GetDefaultSinkMetadata(bool enable)
{
    ...
    metadata->video_capabilities.push_back(mojom::RemotingSinkVideoCapability::CODEC_VP8);
    metadata->audio_capabilities.push_back(mojom::RemotingSinkAudioCapability::CODEC_BASELINE_SET);
...
class RendererControllerTest : public ::testing::Test, public MediaObserverClient {
public:
    ...
    void InitializeControllerWithSink(const PipelineMetadata& pipeline_metadata, mojom::RemotingSinkMetadataPtr sink_metadata)
    {
    ...
    void InitializeControllerAndBecomeDominant(const PipelineMetadata& pipeline_metadata, mojom::RemotingSinkMetadataPtr sink_metadata)
    {
    ...
    {
        return controller_->ShouldBeRemoting();
    }
...
{
    InitializeControllerAndBecomeDominant(DefaultMetadata(VideoCodec::kVP8), GetDefaultSinkMetadata(true));
...
{
    InitializeControllerAndBecomeDominant(DefaultMetadata(VideoCodec::kVP8), GetDefaultSinkMetadata(false));
...
{
    InitializeControllerAndBecomeDominant(DefaultMetadata(VideoCodec::kVP9), GetDefaultSinkMetadata(true));
    ...
    sink_metadata->video_capabilities.push_back(mojom::RemotingSinkVideoCapability::CODEC_VP9);
...
{
    InitializeControllerAndBecomeDominant(DefaultMetadata(VideoCodec::kHEVC), GetDefaultSinkMetadata(true));
    ...
    ExpectInLocalRendering();
    mojom::RemotingSinkMetadataPtr sink_metadata = GetDefaultSinkMetadata(true);
    sink_metadata->video_capabilities.push_back(mojom::RemotingSinkVideoCapability::CODEC_HEVC);
...
TEST_F(RendererControllerTest, WithAACAudioCodec)
{
    const AudioDecoderConfig audio_config
        = AudioDecoderConfig(AudioCodec::kAAC, kSampleFormatPlanarF32, CHANNEL_LAYOUT_STEREO, 44100, EmptyExtraData(), EncryptionScheme::kUnencrypted);
    PipelineMetadata pipeline_metadata = DefaultMetadata(VideoCodec::kVP8);
    pipeline_metadata.audio_decoder_config = audio_config;
    InitializeControllerAndBecomeDominant(pipeline_metadata, GetDefaultSinkMetadata(true));
    ...
    ExpectInLocalRendering();
    mojom::RemotingSinkMetadataPtr sink_metadata = GetDefaultSinkMetadata(true);
    sink_metadata->audio_capabilities.push_back(mojom::RemotingSinkAudioCapability::CODEC_AAC);
...
{
    const AudioDecoderConfig audio_config
        = AudioDecoderConfig(AudioCodec::kOpus, kSampleFormatPlanarF32, CHANNEL_LAYOUT_STEREO, 44100, EmptyExtraData(), EncryptionScheme::kUnencrypted);
    PipelineMetadata pipeline_metadata = DefaultMetadata(VideoCodec::kVP8);
    pipeline_metadata.audio_decoder_config = audio_config;
    InitializeControllerAndBecomeDominant(pipeline_metadata, GetDefaultSinkMetadata(true));
    ...
    RunUntilIdle();
    mojom::RemotingSinkMetadataPtr sink_metadata = GetDefaultSinkMetadata(true);
    sink_metadata->audio_capabilities.push_back(mojom::RemotingSinkAudioCapability::CODEC_OPUS);
...
{
    InitializeControllerWithSink(DefaultMetadata(VideoCodec::kVP8), GetDefaultSinkMetadata(true));
...
{
    mojom::RemotingSinkMetadataPtr sink_metadata = GetDefaultSinkMetadata(true);
    sink_metadata->video_capabilities.push_back(mojom::RemotingSinkVideoCapability::SUPPORT_4K);
    InitializeControllerWithSink(DefaultMetadata(VideoCodec::kVP8), std::move(sink_metadata));
    set_pixels_per_second_(high_pixel_rate);
