...
private:
    ...
    void SendFrameToSink(uint32_t frame_count, scoped_refptr<media::DecoderBuffer> decoder_buffer, DemuxerStream::Type type);
    ...
    // Handle of |receiver_|
    int receiver_renderer_handle_ = openscreen::cast::RpcMessenger::kInvalidHandle;
