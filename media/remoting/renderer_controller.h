...
class RendererController final : public mojom::RemotingSource, public MediaObserver {
public:
    RendererController(mojo::PendingReceiver<mojom::RemotingSource> source_receiver, mojo::PendingRemote<mojom::Remoter> remoter);
    ...
    using DataPipeStartCallback
        = base::OnceCallback<void(mojo::PendingRemote<mojom::RemotingDataStreamSender> audio, mojo::PendingRemote<mojom::RemotingDataStreamSender> video,
            mojo::ScopedDataPipeProducerHandle audio_handle, mojo::ScopedDataPipeProducerHandle video_handle)>;
    ...
    void StartDataPipe(uint32_t data_pipe_capacity, bool audio, bool video, DataPipeStartCallback done_callback);
...
private:
    ...
    void UpdateFromSessionState(StartTrigger start_trigger, StopTrigger stop_trigger);
    ...
    void UpdateAndMaybeSwitch(StartTrigger start_trigger, StopTrigger stop_trigger);
    ...
    void DoCalculatePixelRate(int decoded_frame_count_before_delay, base::TimeTicks delayed_start_time);
