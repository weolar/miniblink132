...
public:
    ...
    MockGpuMemoryBufferManager& operator=(const MockGpuMemoryBufferManager&) = delete;
    ...
    MOCK_METHOD3(CopyGpuMemoryBufferAsync,
        void(gfx::GpuMemoryBufferHandle buffer_handle, base::UnsafeSharedMemoryRegion memory_region, base::OnceCallback<void(bool)> callback));
