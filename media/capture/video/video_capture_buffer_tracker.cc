...
bool VideoCaptureBufferTracker::IsSameGpuMemoryBuffer(const gfx::GpuMemoryBufferHandle& handle) const
{
    return false;
}

void VideoCaptureBufferTracker::OnHeldByConsumersChanged(bool is_held_by_consumers)
{
}
