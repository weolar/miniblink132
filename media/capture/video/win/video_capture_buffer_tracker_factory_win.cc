...
VideoCaptureBufferTrackerFactoryWin::VideoCaptureBufferTrackerFactoryWin(scoped_refptr<DXGIDeviceManager> dxgi_device_manager)
...
std::unique_ptr<VideoCaptureBufferTracker> VideoCaptureBufferTrackerFactoryWin::CreateTracker(VideoCaptureBufferType buffer_type)
{
    switch (buffer_type) {
...
std::unique_ptr<VideoCaptureBufferTracker> VideoCaptureBufferTrackerFactoryWin::CreateTrackerForExternalGpuMemoryBuffer(
