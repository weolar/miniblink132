...
class CAPTURE_EXPORT GpuMemoryBufferTrackerWin final : public VideoCaptureBufferTracker {
public:
    explicit GpuMemoryBufferTrackerWin(scoped_refptr<DXGIDeviceManager> dxgi_device_manager);
    GpuMemoryBufferTrackerWin(gfx::GpuMemoryBufferHandle gmb_handle, scoped_refptr<DXGIDeviceManager> dxgi_device_manager);

    GpuMemoryBufferTrackerWin(const GpuMemoryBufferTrackerWin&) = delete;
    GpuMemoryBufferTrackerWin& operator=(const GpuMemoryBufferTrackerWin&) = delete;
    ...
    bool IsSameGpuMemoryBuffer(const gfx::GpuMemoryBufferHandle& handle) const override;
...
private:
    bool CreateBufferInternal(gfx::GpuMemoryBufferHandle buffer_handle, const gfx::Size& dimensions);
