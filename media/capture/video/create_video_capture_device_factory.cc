...
std::unique_ptr<VideoCaptureDeviceFactory> CreateFakeVideoCaptureDeviceFactory()
{
    ...
    if (command_line->HasSwitch(switches::kUseFileForFakeVideoCapture)) {
        ...
        FakeVideoCaptureDeviceFactory::ParseFakeDevicesConfigFromOptionsString(
            command_line->GetSwitchValueASCII(switches::kUseFakeDeviceForMediaStream), &config);
...
std::unique_ptr<VideoCaptureDeviceFactory> CreatePlatformSpecificVideoCaptureDeviceFactory(scoped_refptr<base::SingleThreadTaskRunner> ui_task_runner)
{
#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS)
...
std::unique_ptr<VideoCaptureDeviceFactory> CreateVideoCaptureDeviceFactory(scoped_refptr<base::SingleThreadTaskRunner> ui_task_runner)
{
