...
class CAPTURE_EXPORT GpuMemoryBufferTrackerApple final : public VideoCaptureBufferTracker {
public:
    GpuMemoryBufferTrackerApple();
    explicit GpuMemoryBufferTrackerApple(base::apple::ScopedCFTypeRef<IOSurfaceRef> io_surface);

    GpuMemoryBufferTrackerApple(const GpuMemoryBufferTrackerApple&) = delete;
    GpuMemoryBufferTrackerApple& operator=(const GpuMemoryBufferTrackerApple&) = delete;
