...
// devices.
class CAPTURE_EXPORT VideoCaptureDeviceFactoryApple : public VideoCaptureDeviceFactory {
public:
    VideoCaptureDeviceFactoryApple();

    VideoCaptureDeviceFactoryApple(const VideoCaptureDeviceFactoryApple&) = delete;
    VideoCaptureDeviceFactoryApple& operator=(const VideoCaptureDeviceFactoryApple&) = delete;
