...
public:
    ...
    V4l2GpuMemoryBufferTrackerTest(const V4l2GpuMemoryBufferTrackerTest&) = delete;
    V4l2GpuMemoryBufferTrackerTest& operator=(const V4l2GpuMemoryBufferTrackerTest&) = delete;
...
TEST_F(V4l2GpuMemoryBufferTrackerTest, CreateSuccess)
{
    ...
    EXPECT_TRUE(tracker->Init(dimensions, VideoPixelFormat::PIXEL_FORMAT_NV12, nullptr));
}
...
{
    constexpr gfx::Size dimensions = { 1280, 720 };
    constexpr VideoPixelFormat invalid_format = VideoPixelFormat::PIXEL_FORMAT_I420;

    auto tracker = std::make_unique<V4L2GpuMemoryBufferTracker>();
    EXPECT_FALSE(tracker->Init(dimensions, invalid_format, nullptr));
}

TEST_F(V4l2GpuMemoryBufferTrackerTest, InitFailedAsEmptyTestSharedImageInterface)
{
    constexpr gfx::Size dimensions = { 1280, 720 };
    constexpr VideoPixelFormat format = VideoPixelFormat::PIXEL_FORMAT_NV12;
