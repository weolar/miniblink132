...
// devices.
class CAPTURE_EXPORT VideoCaptureDeviceFactoryWebRtc : public VideoCaptureDeviceFactory, webrtc::VideoCaptureOptions::Callback {
public:
    VideoCaptureDeviceFactoryWebRtc();

    VideoCaptureDeviceFactoryWebRtc(const VideoCaptureDeviceFactoryWebRtc&) = delete;
    VideoCaptureDeviceFactoryWebRtc& operator=(const VideoCaptureDeviceFactoryWebRtc&) = delete;
    VideoCaptureDeviceFactoryWebRtc& operator=(const VideoCaptureDeviceFactoryWebRtc&&) = delete;
    ...
    static webrtc::VideoType WebRtcVideoTypeFromChromiumPixelFormat(VideoPixelFormat pixel_format);
    static VideoPixelFormat WebRtcVideoTypeToChromiumPixelFormat(webrtc::VideoType video_type);
...
private:
    ...
    webrtc::VideoCaptureOptions::Status status_ { webrtc::VideoCaptureOptions::Status::UNINITIALIZED };
