...
// GpuMemoryBuffers.
class CAPTURE_EXPORT V4L2GpuMemoryBufferTracker final : public VideoCaptureBufferTracker, public VideoCaptureGpuContextLostObserver {
public:
...
private:
    ...
    base::WeakPtrFactory<VideoCaptureGpuContextLostObserver> weak_ptr_factory_ { this };
};
