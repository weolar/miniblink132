...
class VideoCaptureDeviceWebRtc : public VideoCaptureDevice, public webrtc::RawVideoSinkInterface {
public:
    static VideoCaptureErrorOrDevice Create(webrtc::VideoCaptureOptions* options, const VideoCaptureDeviceDescriptor& device_descriptor);

    explicit VideoCaptureDeviceWebRtc(webrtc::VideoCaptureOptions* options, rtc::scoped_refptr<webrtc::VideoCaptureModule> capture_module);
    ...
    int32_t OnRawFrame(uint8_t* video_frame, size_t video_frame_length, const webrtc::VideoCaptureCapability& frame_info, webrtc::VideoRotation rotation,
