...
void* V4L2CaptureDeviceImpl::mmap(void* start, size_t length, int prot, int flags, int fd, off_t offset)
{
...
int V4L2CaptureDeviceImpl::poll(struct pollfd* ufds, unsigned int nfds, int timeout)
{
