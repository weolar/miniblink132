...
class VideoCaptureDeviceFactoryV4L2Test : public ::testing::TestWithParam<VideoCaptureDeviceDescriptor> {
public:
    ...
    void SetUp() override
    {
        factory_ = std::make_unique<VideoCaptureDeviceFactoryV4L2>(base::SingleThreadTaskRunner::GetCurrentDefault());
...
INSTANTIATE_TEST_SUITE_P(All, VideoCaptureDeviceFactoryV4L2Test,
...
TEST_F(VideoCaptureDeviceFactoryV4L2Test, ReceiveFramesFromSinglePlaneFakeDevice)
{
    // Setup
    ...
    EXPECT_CALL(*client_ptr, OnIncomingCapturedData).WillRepeatedly(InvokeWithoutArgs([&wait_loop]() {
