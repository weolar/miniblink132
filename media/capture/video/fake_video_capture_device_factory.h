...
class CAPTURE_EXPORT FakeVideoCaptureDeviceFactory : public VideoCaptureDeviceFactory {
public:
    static constexpr const char kDeviceConfigForGetPhotoStateFails[] = "GetPhotoStateFails";
    static constexpr const char kDeviceConfigForSetPhotoOptionsFails[] = "SetPhotoOptionsFails";
    static constexpr const char kDeviceConfigForTakePhotoFails[] = "TakePhotoFails";
    ...
    static std::unique_ptr<VideoCaptureDevice> CreateDeviceWithSettings(
        const FakeVideoCaptureDeviceSettings& settings, std::unique_ptr<gpu::GpuMemoryBufferSupport> gmb_support = nullptr);

    static std::unique_ptr<VideoCaptureDevice> CreateDeviceWithDefaultResolutions(VideoPixelFormat pixel_format,
        FakeVideoCaptureDevice::DeliveryMode delivery_mode, float frame_rate, std::unique_ptr<gpu::GpuMemoryBufferSupport> gmb_support = nullptr);
    ...
    static void ParseFakeDevicesConfigFromOptionsString(const std::string options_string, std::vector<FakeVideoCaptureDeviceSettings>* config);
    ...
    void SetToCustomDevicesConfig(const std::vector<FakeVideoCaptureDeviceSettings>& config);
