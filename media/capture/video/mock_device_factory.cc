...
media::VideoCaptureFormat kSupportedFormat(gfx::Size(640, 480), 25.0f, media::PIXEL_FORMAT_I420);
...
void MockDeviceFactory::AddMockDevice(media::VideoCaptureDevice* device, const media::VideoCaptureDeviceDescriptor& descriptor)
{
...
VideoCaptureErrorOrDevice MockDeviceFactory::CreateDevice(const media::VideoCaptureDeviceDescriptor& device_descriptor)
{
    ...
    return VideoCaptureErrorOrDevice(std::make_unique<RawPointerVideoCaptureDevice>(devices_[device_descriptor]));
}
