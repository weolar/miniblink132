...
// given |task_runner|.
class CAPTURE_EXPORT VideoFrameReceiverOnTaskRunner : public VideoFrameReceiver {
public:
    explicit VideoFrameReceiverOnTaskRunner(const base::WeakPtr<VideoFrameReceiver>& receiver, scoped_refptr<base::SingleThreadTaskRunner> task_runner);
