...
public:
    explicit VideoCaptureSystemImpl(std::unique_ptr<VideoCaptureDeviceFactory> factory);
...
private:
    ...
    const VideoCaptureDeviceInfo* LookupDeviceInfoFromId(const std::string& device_id);
