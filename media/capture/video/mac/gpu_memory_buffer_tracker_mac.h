...
class CAPTURE_EXPORT GpuMemoryBufferTrackerMac final : public VideoCaptureBufferTracker {
public:
    GpuMemoryBufferTrackerMac();
    explicit GpuMemoryBufferTrackerMac(base::ScopedCFTypeRef<IOSurfaceRef> io_surface);

    GpuMemoryBufferTrackerMac(const GpuMemoryBufferTrackerMac&) = delete;
    GpuMemoryBufferTrackerMac& operator=(const GpuMemoryBufferTrackerMac&) = delete;
