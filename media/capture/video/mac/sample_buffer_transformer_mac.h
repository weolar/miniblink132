...
public:
    ...
    void Reconfigure(
        Transformer transformer, OSType destination_pixel_format, const gfx::Size& destination_size, absl::optional<size_t> buffer_pool_size = absl::nullopt);
    ...
    base::ScopedCFTypeRef<CVPixelBufferRef> Transform(CVPixelBufferRef pixel_buffer);
    base::ScopedCFTypeRef<CVPixelBufferRef> Transform(CMSampleBufferRef sample_buffer);
