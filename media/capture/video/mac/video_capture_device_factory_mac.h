...
class CAPTURE_EXPORT VideoCaptureDeviceFactoryMac : public VideoCaptureDeviceFactory {
public:
    VideoCaptureDeviceFactoryMac();

    VideoCaptureDeviceFactoryMac(const VideoCaptureDeviceFactoryMac&) = delete;
    VideoCaptureDeviceFactoryMac& operator=(const VideoCaptureDeviceFactoryMac&) = delete;
