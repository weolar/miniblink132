...
class CAPTURE_EXPORT GpuMemoryBufferTrackerCros final : public VideoCaptureBufferTracker {
public:
    GpuMemoryBufferTrackerCros();

    GpuMemoryBufferTrackerCros(const GpuMemoryBufferTrackerCros&) = delete;
    GpuMemoryBufferTrackerCros& operator=(const GpuMemoryBufferTrackerCros&) = delete;
