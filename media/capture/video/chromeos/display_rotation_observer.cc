...
ScreenObserverDelegate::ScreenObserverDelegate(OnScreenRotationChangedCallback on_screen_rotation_changed_callback)
    : on_screen_rotation_changed_callback_(on_screen_rotation_changed_callback)
{
...
void ScreenObserverDelegate::OnDisplayRotationChanged(cros::mojom::ClockwiseRotation rotation)
{
