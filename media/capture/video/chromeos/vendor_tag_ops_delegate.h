...
public:
    VendorTagOpsDelegate(scoped_refptr<base::SingleThreadTaskRunner> ipc_task_runner);
...
private:
    ...
    void OnGotSectionName(uint32_t tag, const std::optional<std::string>& section_name);
