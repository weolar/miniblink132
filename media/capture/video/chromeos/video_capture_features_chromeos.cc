...
BASE_FEATURE(kDisableCameraFrameRotationAtSource, "DisableCameraFrameRotationAtSource", base::FEATURE_DISABLED_BY_DEFAULT);
...
bool ShouldEnableAutoFraming()
{
    ...
    std::string value = command_line->GetSwitchValueASCII(media::switches::kAutoFramingOverride);
