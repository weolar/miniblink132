...
public:
    ...
    explicit ScreenObserverDelegate(OnScreenRotationChangedCallback on_screen_rotation_changed_callback);
    ...
    void OnDisplayRotationChanged(cros::mojom::ClockwiseRotation rotation) override;
