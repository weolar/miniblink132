...
using MojoJpegEncodeAcceleratorFactoryCB = base::RepeatingCallback<void(mojo::PendingReceiver<chromeos_camera::mojom::JpegEncodeAccelerator>)>;
...
class CAPTURE_EXPORT JpegAcceleratorProviderImpl final : public cros::mojom::JpegAcceleratorProvider,
                                                         public chromeos::mojo_service_manager::mojom::ServiceProvider {
public:
    JpegAcceleratorProviderImpl(MojoMjpegDecodeAcceleratorFactoryCB jda_factory, MojoJpegEncodeAcceleratorFactoryCB jea_factory);
    ~JpegAcceleratorProviderImpl() override;
    JpegAcceleratorProviderImpl(const JpegAcceleratorProviderImpl&) = delete;
    JpegAcceleratorProviderImpl& operator=(const JpegAcceleratorProviderImpl&) = delete;
