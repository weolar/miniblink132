...
// longer needed.
class MojoServiceManagerObserver : public chromeos::mojo_service_manager::mojom::ServiceObserver {
public:
    ...
    MojoServiceManagerObserver& operator=(const MojoServiceManagerObserver&) = delete;

private:
    MojoServiceManagerObserver(const std::string& service_name, base::RepeatingClosure on_register_callback, base::RepeatingClosure on_unregister_callback);

    void OnServiceEvent(chromeos::mojo_service_manager::mojom::ServiceEventPtr event) override;

    void QueryCallback(chromeos::mojo_service_manager::mojom::ErrorOrServiceStatePtr result);
    ...
    mojo::Receiver<chromeos::mojo_service_manager::mojom::ServiceObserver> observer_receiver_ { this };
