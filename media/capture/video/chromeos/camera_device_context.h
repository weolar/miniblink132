...
public:
    ...
    bool AddClient(ClientType client_type, std::unique_ptr<VideoCaptureDevice::Client> client);
    ...
    void SubmitCapturedVideoCaptureBuffer(ClientType client_type, VideoCaptureDevice::Client::Buffer buffer, const VideoCaptureFormat& frame_format,
        base::TimeTicks reference_time, base::TimeDelta timestamp, const VideoFrameMetadata& metadata);
    ...
    void SubmitCapturedGpuMemoryBuffer(ClientType client_type, gfx::GpuMemoryBuffer* buffer, const VideoCaptureFormat& frame_format,
    ...
    bool ReserveVideoCaptureBufferFromPool(ClientType client_type, gfx::Size size, VideoPixelFormat format, VideoCaptureDevice::Client::Buffer* buffer,
        int* require_new_buffer_id = nullptr, int* retire_old_buffer_id = nullptr);
...
private:
    ...
    base::flat_map<ClientType, std::unique_ptr<VideoCaptureDevice::Client>> clients_ GUARDED_BY(client_lock_);
