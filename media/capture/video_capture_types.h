...
enum class VideoCaptureBufferType { kSharedMemory, kMailboxHolder, kGpuMemoryBuffer };
...
static_assert(static_cast<int>(PowerLineFrequency::kDefault) == 0, "static_cast<int>(PowerLineFrequency::kDefault) must equal 0.");
static_assert(static_cast<int>(PowerLineFrequency::k50Hz) == 50, "static_cast<int>(PowerLineFrequency::k50Hz) must equal 50.");
static_assert(static_cast<int>(PowerLineFrequency::k60Hz) == 60, "static_cast<int>(PowerLineFrequency::k60Hz) must equal 60.");
...
struct CAPTURE_EXPORT VideoCaptureFormat {
    VideoCaptureFormat();
    VideoCaptureFormat(const gfx::Size& frame_size, float frame_rate, VideoPixelFormat pixel_format);
...
struct CAPTURE_EXPORT VideoCaptureParams {
    ...
    struct SuggestedConstraints {
        ...
        {
            return min_frame_size == other.min_frame_size && max_frame_size == other.max_frame_size && fixed_aspect_ratio == other.fixed_aspect_ratio;
        }
    };
    ...
    {
        return requested_format == other.requested_format && resolution_change_policy == other.resolution_change_policy
            && power_line_frequency == other.power_line_frequency && is_high_dpi_enabled == other.is_high_dpi_enabled;
    }
...
CAPTURE_EXPORT std::ostream& operator<<(std::ostream& os, const VideoCaptureParams::SuggestedConstraints& constraints);
