...
public:
    ...
    void ConsiderPresentationEvent(const gfx::Rect& damage_rect, base::TimeTicks event_time);
    ...
    base::TimeTicks frame_timestamp() const
    {
    ...
    // returns true.
    base::TimeDelta sampling_period() const
    {
        return sampling_period_;
    }

    // Accessors to currently-detected animating region/period, for logging.
    const gfx::Rect& detected_region() const
    {
        return detected_region_;
    }
    base::TimeDelta detected_period() const
    {
        return detected_period_;
    }
...
private:
    ...
    // duration.
    bool AnalyzeObservations(base::TimeTicks event_time, gfx::Rect* rect, base::TimeDelta* period) const;
    ...
    static base::TimeDelta ComputeSamplingPeriod(base::TimeDelta animation_period, base::TimeDelta target_sampling_period, base::TimeDelta min_capture_period);
    ...
    enum { NOT_SAMPLING, START_SAMPLING, SHOULD_NOT_SAMPLE, SHOULD_SAMPLE } sampling_state_;
