...
const char kVideoCaptureUseGpuMemoryBuffer[] = "video-capture-use-gpu-memory-buffer";
...
const char kDisableVideoCaptureUseGpuMemoryBuffer[] = "disable-video-capture-use-gpu-memory-buffer";
...
#if BUILDFLAG(IS_WIN)
BASE_FEATURE(kMediaFoundationCameraUsageMonitoring, "MediaFoundationCameraUsageMonitoring", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kWebRtcPipeWireCamera, "WebRtcPipeWireCamera", base::FEATURE_DISABLED_BY_DEFAULT);
