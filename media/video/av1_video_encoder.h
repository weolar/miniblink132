...
private:
    ...
    VideoEncoderOutput GetEncoderOutput(int temporal_id, base::TimeDelta timestamp, gfx::ColorSpace color_space) const;
    EncoderStatus::Or<int> AssignNextTemporalId(bool key_frame);
    void UpdateEncoderColorSpace();

    using aom_codec_unique_ptr = std::unique_ptr<aom_codec_ctx_t, void (*)(aom_codec_ctx_t*)>;
