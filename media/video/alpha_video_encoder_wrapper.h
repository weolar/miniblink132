...
public:
    AlphaVideoEncoderWrapper(std::unique_ptr<VideoEncoder> yuv_encoder, std::unique_ptr<VideoEncoder> alpha_encoder);
...
private:
    void YuvOutputCallback(VideoEncoderOutput output, std::optional<CodecDescription> desc);
    void AlphaOutputCallback(VideoEncoderOutput output, std::optional<CodecDescription> desc);
