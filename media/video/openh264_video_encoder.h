...
private:
    EncoderStatus DrainOutputs(const SFrameBSInfo& frame_info, base::TimeDelta timestamp, gfx::ColorSpace color_space);
    ...
    using svc_encoder_unique_ptr = std::unique_ptr<ISVCEncoder, ISVCEncoderDeleter>;
