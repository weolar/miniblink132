...
struct MEDIA_EXPORT ResolutionBitrateLimit {
    ...
    ResolutionBitrateLimit(const gfx::Size& frame_size, int min_start_bitrate_bps, int min_bitrate_bps, int max_bitrate_bps);
    ~ResolutionBitrateLimit();
...
MEDIA_EXPORT bool operator==(const ResolutionBitrateLimit& lhs, const ResolutionBitrateLimit& rhs);
...
MEDIA_EXPORT bool operator==(const VideoEncoderInfo& lhs, const VideoEncoderInfo& rhs);
