...
public:
    ...
    MockVideoDecodeAccelerator& operator=(const MockVideoDecodeAccelerator&) = delete;
    ...
    MOCK_METHOD2(Decode, void(scoped_refptr<DecoderBuffer> buffer, int32_t bitstream_id));
    MOCK_METHOD1(AssignPictureBuffers, void(const std::vector<PictureBuffer>& buffers));
    MOCK_METHOD1(ReusePictureBuffer, void(int32_t picture_buffer_id));
    MOCK_METHOD0(Flush, void());
    MOCK_METHOD0(Reset, void());
    MOCK_METHOD0(Destroy, void());
    MOCK_METHOD2(TryToSetupDecodeOnSeparateThread, bool(const base::WeakPtr<Client>&, const scoped_refptr<base::SingleThreadTaskRunner>&));
