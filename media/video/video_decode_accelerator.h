...
public:
    ...
    virtual void Decode(scoped_refptr<DecoderBuffer> buffer, int32_t bitstream_id);
    ...
    virtual void AssignPictureBuffers(const std::vector<PictureBuffer>& buffers) = 0;
    ...
    virtual void ImportBufferForPicture(int32_t picture_buffer_id, VideoPixelFormat pixel_format, gfx::GpuMemoryBufferHandle gpu_memory_buffer_handle);
...
// use the destructor.
template <> struct MEDIA_EXPORT default_delete<media::VideoDecodeAccelerator> {
