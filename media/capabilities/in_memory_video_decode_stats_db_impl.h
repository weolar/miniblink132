...
public:
    ...
    explicit InMemoryVideoDecodeStatsDBImpl(VideoDecodeStatsDBProvider* seed_db_provider);

    InMemoryVideoDecodeStatsDBImpl(const InMemoryVideoDecodeStatsDBImpl&) = delete;
    InMemoryVideoDecodeStatsDBImpl& operator=(const InMemoryVideoDecodeStatsDBImpl&) = delete;
...
private:
    ...
    void OnGotSeedDB(base::OnceCallback<void(bool)> init_cb, VideoDecodeStatsDB* seed_db);
    ...
    void CompleteAppendWithSeedData(const VideoDescKey& key, const DecodeStatsEntry& entry, AppendDecodeStatsCB append_done_cb, bool read_success,
    ...
    void OnGotSeedEntry(const VideoDescKey& key, GetDecodeStatsCB get_stats_cb, bool success, std::unique_ptr<DecodeStatsEntry> seed_entry);
