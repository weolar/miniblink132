...
public:
    ...
    void AppendStats(const VideoDecodeStatsDB::VideoDescKey& video_key, learning::FeatureValue origin, const VideoDecodeStatsDB::DecodeStatsEntry& new_stats);

private:
    // Convenience function to begin and complete an observation.
    void AddExample(learning::LearningTaskController* controller, const learning::LabelledExample& example);
    ...
    std::unique_ptr<learning::LearningTaskController> base_unweighted_table_controller_;
    std::unique_ptr<learning::LearningTaskController> base_unweighted_tree_controller_;
    std::unique_ptr<learning::LearningTaskController> base_unweighted_tree_200_controller_;
    std::unique_ptr<learning::LearningTaskController> enhanced_unweighted_tree_200_controller_;
};
