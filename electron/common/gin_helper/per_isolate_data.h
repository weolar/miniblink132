...
#ifndef GIN_HELPER_PER_ISOLATE_DATA_H_
#define GIN_HELPER_PER_ISOLATE_DATA_H_
...
public:
    ...
    // lazily.
    void SetObjectTemplate(gin::WrapperInfo* info, v8::Local<v8::ObjectTemplate> object_template);
    void SetFunctionTemplate(gin::WrapperInfo* info, v8::Local<v8::FunctionTemplate> function_template);
    ...
    v8::Local<v8::ObjectTemplate> GetObjectTemplate(gin::WrapperInfo* info);
    v8::Local<v8::FunctionTemplate> GetFunctionTemplate(gin::WrapperInfo* info);
...
private:
    typedef std::map<gin::WrapperInfo*, v8::Eternal<v8::ObjectTemplate>> ObjectTemplateMap;
    typedef std::map<gin::WrapperInfo*, v8::Eternal<v8::FunctionTemplate>> FunctionTemplateMap;
    typedef std::map<WrappableBase*, IndexedPropertyInterceptor*> IndexedPropertyInterceptorMap;
    typedef std::map<WrappableBase*, NamedPropertyInterceptor*> NamedPropertyInterceptorMap;
