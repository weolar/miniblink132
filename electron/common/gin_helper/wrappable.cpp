...
{
    isolate_ = isolate;
    wrapper->SetAlignedPointerInInternalField(::gin_helper::InternalFields::kWrapperInfoIndex, info);
    wrapper->SetAlignedPointerInInternalField(::gin_helper::InternalFields::kEncodedValueIndex, this);
...
WrappableBase* WrappableBase::GetNativePtr(v8::Local<v8::Object> handle, WrapperInfo* info)
{
    ...
    WrapperInfo* infoSelf = (WrapperInfo*)handle->GetAlignedPointerFromInternalField(::gin_helper::InternalFields::kWrapperInfoIndex);
    if (infoSelf != info)
        return nullptr;

    void* ptr = handle->GetAlignedPointerFromInternalField(::gin_helper::InternalFields::kEncodedValueIndex);
...
v8::Local<v8::Object> WrappableBase::GetWrapperImpl(v8::Isolate* isolate, WrapperInfo* info)
{
    ...
    CHECK(::gin_helper::InternalFields::kNumberOfInternalFields == templ->InternalFieldCount());
...
void* FromV8Impl(v8::Isolate* isolate, v8::Local<v8::Value> val, WrapperInfo* wrapper_info)
{
    if (!val->IsObject())
        return NULL;
    ...
    return obj->GetAlignedPointerFromInternalField(::gin_helper::InternalFields::kEncodedValueIndex);
}
