...
void Dictionary::GetBydefaultVal(const char* name, bool defaultVal, bool* outResult) const
{
    ...
    *outResult = result->ToBoolean(this->isolate())->BooleanValue(this->isolate());
}
...
void Dictionary::GetBydefaultVal(const char* name, const std::string& defaultVal, std::string* outResult) const
{
    ...
    v8::String::Utf8Value str(this->isolate(), v);
    *outResult = *str;
}

void Dictionary::GetBydefaultVal(const char* name, const std::u16string& defaultVal, std::u16string* outResult) const
{
