...
#ifndef GIN_HELPER_WRAPPABLE_H_
#define GIN_HELPER_WRAPPABLE_H_
...
namespace internal {
GIN_EXPORT void* FromV8Impl(v8::Isolate* isolate, v8::Local<v8::Value> val, gin::WrapperInfo* info);
} // namespace internal
...
protected:
    ...
    void InitWith(v8::Isolate* isolate, v8::Local<v8::Object> wrapper, gin_helper::WrapperInfo* info);
    ...
    v8::Local<v8::Object> GetWrapperImpl(v8::Isolate* isolate, ::gin_helper::WrapperInfo* wrapper_info);

public:
    static WrappableBase* GetNativePtr(v8::Local<v8::Object> handle, ::gin_helper::WrapperInfo* info);
...
template <typename T> class Wrappable : public WrappableBase {
public:
...
template <typename T> struct Converter<T*, typename std::enable_if<std::is_convertible<T*, WrappableBase*>::value>::type> {
    ...
    {
        *out = static_cast<T*>(static_cast<WrappableBase*>(internal::FromV8Impl(isolate, val, &T::kWrapperInfo)));
        return *out != NULL;
    }
};
