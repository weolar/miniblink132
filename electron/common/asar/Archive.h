...
private:
    ...
    std::unique_ptr<base::Value::Dict> header_;

    // Cached external temporary files.
    //base::ScopedPtrHashMap<base::FilePath, std::unique_ptr<ScopedTemporaryFile>> external_files_;
    std::map<base::FilePath, ScopedTemporaryFile*> external_files_;
