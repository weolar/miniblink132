...
#include "electron/browser/relauncher.h"
...
bool RelaunchAppWithHelper(const base::FilePath& helper, const StringVector& relauncher_args, const StringVector& argv)
{
    ...
    relaunch_argv.insert(relaunch_argv.end(), relauncher_args.begin(), relauncher_args.end());
    ...
    fd_map.push_back(std::make_pair(pipe_write_fd.get(), internal::kRelauncherSyncFD));
#endif
