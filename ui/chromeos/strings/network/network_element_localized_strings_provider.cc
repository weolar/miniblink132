...
constexpr webui::LocalizedString kElementLocalizedStrings[] = {
    ...
    { "missingEapDefaultServerCaSubjectVerification", IDS_NETWORK_EAP_DEFAULT_SERVER_CA_WITHOUT_SUBJECT_VERIFICATION },
    ...
    { "networkListItemConnectedNoConnectivity", IDS_STATUSBAR_NETWORK_DEVICE_CONNECTED_NO_CONNECTIVITY },
    ...
    { "networkListItemCellularSignIn", IDS_STATUSBAR_NETWORK_DEVICE_CELLULAR_SIGNIN },
    ...
    { "networkListItemActivateAfterDeviceSetup", IDS_NETWORK_LIST_ACTIVATE_AFTER_DEVICE_SETUP },
    { "networkListItemSubpageButtonLabel", IDS_NETWORK_LIST_ITEM_SUBPAGE_BUTTON_LABEL },
    { "networkListItemLabel", IDS_NETWORK_LIST_ITEM_LABEL },
    { "networkListItemLabelCellular", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR },
    { "networkListItemLabelCellularWithProviderName", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_WITH_PROVIDER_NAME },
    { "networkListItemLabelCellularManaged", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_MANAGED },
    { "networkListItemLabelCellularManagedWithProviderName", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_MANAGED_WITH_PROVIDER_NAME },
    { "networkListItemLabelEthernetManaged", IDS_NETWORK_LIST_ITEM_LABEL_ETHERNET_MANAGED },
    { "networkListItemLabelTether", IDS_NETWORK_LIST_ITEM_LABEL_TETHER },
    { "networkListItemLabelTetherWithProviderName", IDS_NETWORK_LIST_ITEM_LABEL_TETHER_WITH_PROVIDER_NAME },
    { "networkListItemLabelWifi", IDS_NETWORK_LIST_ITEM_LABEL_WIFI },
    { "networkListItemLabelWifiManaged", IDS_NETWORK_LIST_ITEM_LABEL_WIFI_MANAGED },
    { "networkListItemLabelEthernetWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_ETHERNET_WITH_CONNECTION_STATUS },
    { "networkListItemLabelEthernetManagedWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_ETHERNET_MANAGED_WITH_CONNECTION_STATUS },
    { "networkListItemLabelCellularWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_WITH_CONNECTION_STATUS },
    { "networkListItemLabelCellularWithConnectionStatusAndProviderName", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_WITH_CONNECTION_STATUS_AND_PROVIDER_NAME },
    { "networkListItemLabelCellularManagedWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_MANAGED_WITH_CONNECTION_STATUS },
    ...
    { "networkListItemLabelCellularUnactivated", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_UNACTIVATED },
    { "networkListItemLabelCellularUnactivatedWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_UNACTIVATED_WITH_CONNECTION_STATUS },
    { "networkListItemLabelWifiWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_WIFI_WITH_CONNECTION_STATUS },
    { "networkListItemLabelWifiManagedWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_WIFI_MANAGED_WITH_CONNECTION_STATUS },
    { "networkListItemLabelTetherWithConnectionStatus", IDS_NETWORK_LIST_ITEM_LABEL_TETHER_WITH_CONNECTION_STATUS },
    { "networkListItemLabelTetherWithConnectionStatusAndProviderName", IDS_NETWORK_LIST_ITEM_LABEL_TETHER_WITH_CONNECTION_STATUS_AND_PROVIDER_NAME },
    { "networkListItemLabelESimPendingProfile", IDS_NETWORK_LIST_ITEM_LABEL_ESIM_PENDING_PROFILE },
    { "networkListItemLabelESimPendingProfileWithProviderName", IDS_NETWORK_LIST_ITEM_LABEL_ESIM_PENDING_PROFILE_WITH_PROVIDER_NAME },
    { "networkListItemLabelActivateAfterSetup", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_ACTIVATE_AFTER_SETUP },
    { "networkListItemLabelActivateAfterSetupWithProviderName", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_ACTIVATE_AFTER_SETUP_WITH_PROVIDER_NAME },
    { "networkListItemLabelManagedActivateAfterSetup", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_MANAGED_ACTIVATE_AFTER_SETUP },
    { "networkListItemLabelManagedActivateAfterSetupWithProviderName", IDS_NETWORK_LIST_ITEM_LABEL_CELLULAR_MANAGED_ACTIVATE_AFTER_SETUP_WITH_PROVIDER_NAME },
    { "networkListItemLabelESimPendingProfileInstalling", IDS_NETWORK_LIST_ITEM_LABEL_ESIM_PENDING_PROFILE_INSTALLING },
    { "networkListItemLabelESimPendingProfileWithProviderNameInstalling", IDS_NETWORK_LIST_ITEM_LABEL_ESIM_PENDING_PROFILE_WITH_PROVIDER_NAME_INSTALLING },
    { "wifiNetworkStatusSecured", IDS_WIFI_NETWORK_STATUS_SECURED },
    { "wifiNetworkStatusUnsecured", IDS_WIFI_NETWORK_STATUS_UNSECURED },
    { "networkListItemUpdatedCellularSimCardLocked", IDS_NETWORK_LIST_UPDATED_CELLULAR_SIM_CARD_LOCKED },
    ...
    { "networkListItemActivateA11yLabel", IDS_NETWORK_LIST_ITEM_ACTIVATE_A11Y_LABEL },
    { "networkListItemActivating", IDS_NETWORK_LIST_ITEM_ACTIVATING },
    { "networkListItemCellularBlockedA11yLabel", IDS_NETWORK_LIST_ITEM_CELLULAR_BLOCKED_A11Y_LABEL },
    { "networkListItemCellularBlockedWithConnectionStatusA11yLabel", IDS_NETWORK_LIST_ITEM_CELLULAR_BLOCKED_WITH_CONNECTION_STATUS_A11Y_LABEL },
    { "networkListItemWiFiBlockedA11yLabel", IDS_NETWORK_LIST_ITEM_WIFI_BLOCKED_A11Y_LABEL },
    { "networkListItemWiFiBlockedWithConnectionStatusA11yLabel", IDS_NETWORK_LIST_ITEM_WIFI_BLOCKED_WITH_CONNECTION_STATUS_A11Y_LABEL },
    { "networkListItemUnavailableSimNetwork", IDS_NETWORK_LIST_ITEM_UNAVAILABLE_SIM_NETWORK },
    { "networkListItemDownload", IDS_NETWORK_LIST_ITEM_DOWNLOAD },
    { "networkListItemDownloadA11yLabel", IDS_NETWORK_LIST_ITEM_DOWNLOAD_A11Y_LABEL },
...
void AddLocalizedStrings(content::WebUIDataSource* html_source)
{
    ...
    html_source->AddLocalizedString("OncTypeTether", ash::features::IsInstantHotspotRebrandEnabled() ? IDS_NETWORK_TYPE_HOTSPOT : IDS_NETWORK_TYPE_TETHER);
}
...
void AddLocalizedValuesToBuilder(::login::LocalizedValuesBuilder* builder)
{
    ...
    builder->Add("OncTypeTether", ash::features::IsInstantHotspotRebrandEnabled() ? IDS_NETWORK_TYPE_HOTSPOT : IDS_NETWORK_TYPE_TETHER);
}
...
void AddOncLocalizedStrings(content::WebUIDataSource* html_source)
{
    static constexpr webui::LocalizedString kLocalizedStrings[] = {
        ...
        { "OncCellular-APN-AccessPointName", IDS_ONC_CELLULAR_APN_ACCESS_POINT_NAME },
        { "OncCellular-APN-AccessPointName_none", IDS_ONC_CELLULAR_APN_ACCESS_POINT_NAME_NONE },
        ...
        { "OncCellular-APN-Attach_TooltipText", IDS_ONC_CELLULAR_APN_ATTACH_TOOLTIP_TEXT },
        { "OncCellular-ActivationState", IDS_ONC_CELLULAR_ACTIVATION_STATE },
        { "OncCellular-ActivationState_Activated", IDS_ONC_CELLULAR_ACTIVATION_STATE_ACTIVATED },
        { "OncCellular-ActivationState_Activating", IDS_ONC_CELLULAR_ACTIVATION_STATE_ACTIVATING },
        { "OncCellular-ActivationState_NotActivated", IDS_ONC_CELLULAR_ACTIVATION_STATE_NOT_ACTIVATED },
        { "OncCellular-ActivationState_PartiallyActivated", IDS_ONC_CELLULAR_ACTIVATION_STATE_PARTIALLY_ACTIVATED },
        { "OncCellular-ActivationState_NoService", IDS_ONC_CELLULAR_ACTIVATION_STATE_NO_SERVICE },
        ...
        { "OncCellular-HomeProvider-Country", IDS_ONC_CELLULAR_HOME_PROVIDER_COUNTRY },
        ...
        { "OncCellular-RoamingState_Roaming", IDS_ONC_CELLULAR_ROAMING_STATE_ROAMING },
        { "OncCellular-ServingOperator-Code", IDS_ONC_CELLULAR_SERVING_OPERATOR_CODE },
        { "OncCellular-ServingOperator-Name", IDS_ONC_CELLULAR_SERVING_OPERATOR_NAME },
        ...
        { "OncTether-BatteryPercentage_Value", IDS_ONC_TETHER_BATTERY_PERCENTAGE_VALUE },
        ...
        { "OncTether-SignalStrength_Medium", IDS_ONC_TETHER_SIGNAL_STRENGTH_MEDIUM },
        { "OncTether-SignalStrength_Strong", IDS_ONC_TETHER_SIGNAL_STRENGTH_STRONG },
        ...
        { "OncVPN-OpenVPN-CompressionAlgorithm", IDS_ONC_VPN_OPENVPN_COMPRESSION_ALGORITHM },
        ...
        { "OncVPN-WireGuard-Peer-PresharedKey", IDS_ONC_VPN_WIREGUARD_PRESHARED_KEY },
        { "OncVPN-WireGuard-Peer-PersistentKeepalive", IDS_ONC_VPN_WIREGUARD_PERSISTENT_KEEPALIVE },
        ...
        { "OncVPN-WireGuard-Key_UseCurrent", IDS_ONC_VPN_WIREGUARD_KEY_USE_CURRENT },
        { "OncVPN-WireGuard-Key_GenerateNew", IDS_ONC_VPN_WIREGUARD_KEY_GENERATE_NEW },
        ...
        { "OncHotspot-WiFi-Security_WPA2WPA3", IDS_ONC_HOTSPOT_WIFI_SECURITY_WPA2WPA3 },
    };
...
void AddDetailsLocalizedStrings(content::WebUIDataSource* html_source)
{
    static constexpr webui::LocalizedString kLocalizedStrings[] = {
        ...
        { "apnSettingsZeroStateDescription", IDS_SETTINGS_APN_ZERO_STATE_DESCRIPTION },
        { "apnSettingsZeroStateDescriptionWithAddLink", IDS_SETTINGS_APN_ZERO_STATE_DESCRIPTION_WITH_ADD_LINK },
        { "apnSettingsDatabaseApnsErrorMessage", IDS_SETTINGS_APN_DATABASE_APNS_ERROR_MESSAGE },
        { "apnSettingsCustomApnsErrorMessage", IDS_SETTINGS_APN_CUSTOM_APNS_ERROR_MESSAGE },
        ...
        { "apnA11yUserFriendlyNameIndicator", IDS_SETTINGS_APN_A11Y_USER_FRIENDLY_NAME_INDICATOR },
        ...
        { "apnSelectionDialogDescription", IDS_SETTINGS_APN_SELECTION_DIALOG_DESCRIPTION },
        { "apnSelectionDialogUseApn", IDS_SETTINGS_APN_SELECTION_DIALOG_BUTTON_USE_APN },
        { "apnSelectionDialogA11yUseApnEnabled", IDS_SETTINGS_APN_SELECTION_DIALOG_A11Y_USE_APN_ENABLED },
        { "apnSelectionDialogA11yUseApnDisabled", IDS_SETTINGS_APN_SELECTION_DIALOG_A11Y_USE_APN_DISABLED },
        { "apnSelectionDialogListItemSelected", IDS_SETTINGS_APN_SELECTION_DIALOG_LIST_ITEM_SELECTED },
        { "apnDetailApnErrorMaxChars", IDS_SETTINGS_APN_INPUT_LABEL_ERROR_MAX_CHARS },
        { "apnDetailApnErrorInvalidChar", IDS_SETTINGS_APN_INPUT_LABEL_ERROR_INVALID_CHAR },
        { "apnDetailAdvancedSettings", IDS_SETTINGS_APN_DIALOG_ADVANCED_SETTING },
        { "apnDetailApnTypes", IDS_SETTINGS_APN_DIALOG_APN_TYPES },
        { "apnDetailApnTypeDefault", IDS_SETTINGS_APN_DIALOG_APN_TYPE_DEFAULT_CHECKBOX },
        { "apnDetailApnTypeAttach", IDS_SETTINGS_APN_DIALOG_APN_TYPE_ATTACH_CHECKBOX },
        { "apnA11yDefaultAndAttachApn", IDS_SETTINGS_APN_A11Y_DEFAULT_AND_ATTACH_APN },
        { "apnA11yDefaultApnOnly", IDS_SETTINGS_APN_A11Y_DEFAULT_APN_ONLY },
        { "apnA11yAttachApnOnly", IDS_SETTINGS_APN_A11Y_ATTACH_APN_ONLY },
        { "apnDetailDefaultApnRequired", IDS_SETTINGS_APN_DIALOG_DEFAULT_APN_REQUIRED },
        ...
        { "apnWarningPromptForDisableRemove", IDS_SETTINGS_APN_WARNING_PROMPT_FOR_DISABLE_REMOVE },
        ...
        { "apnDetailDialogA11yAddEnabled", IDS_SETTINGS_APN_DIALOG_A11Y_ADD_ENABLED },
        { "apnDetailDialogA11ySaveEnabled", IDS_SETTINGS_APN_DIALOG_A11Y_SAVE_ENABLED },
        { "apnDetailDialogA11yAddDisabled", IDS_SETTINGS_APN_DIALOG_A11Y_ADD_DISABLED },
        { "apnDetailDialogA11ySaveDisabled", IDS_SETTINGS_APN_DIALOG_A11Y_SAVE_DISABLED },
        ...
        { "networkProxyAddException", IDS_SETTINGS_INTERNET_NETWORK_PROXY_ADD_EXCEPTION },
        { "networkProxyAllowShared", IDS_SETTINGS_INTERNET_NETWORK_PROXY_ALLOW_SHARED },
        { "networkProxyAllowSharedEnableWarningTitle", IDS_SETTINGS_INTERNET_NETWORK_PROXY_ALLOW_SHARED_ENABLE_WARNING_TITLE },
        { "networkProxyAllowSharedDisableWarningTitle", IDS_SETTINGS_INTERNET_NETWORK_PROXY_ALLOW_SHARED_DISABLE_WARNING_TITLE },
        { "networkProxyAllowSharedWarningMessage", IDS_SETTINGS_INTERNET_NETWORK_PROXY_ALLOW_SHARED_WARNING_MESSAGE },
        { "networkProxyAutoConfig", IDS_SETTINGS_INTERNET_NETWORK_PROXY_AUTO_CONFIG },
        { "networkProxyConnectionType", IDS_SETTINGS_INTERNET_NETWORK_PROXY_CONNECTION_TYPE },
        { "networkProxyEnforcedPolicy", IDS_SETTINGS_INTERNET_NETWORK_PROXY_ENFORCED_POLICY },
        { "networkProxyExceptionInputA11yLabel", IDS_SETTINGS_INTERNET_NETWORK_PROXY_EXCEPTION_INPUT_ACCESSIBILITY_LABEL },
        { "networkProxyExceptionList", IDS_SETTINGS_INTERNET_NETWORK_PROXY_EXCEPTION_LIST },
        { "networkProxyExceptionRemoveA11yLabel", IDS_SETTINGS_INTERNET_NETWORK_PROXY_EXCEPT_REMOVE_ACCESSIBILITY_LABEL },
        { "networkProxyFtp", IDS_SETTINGS_INTERNET_NETWORK_PROXY_FTP_PROXY },
        { "networkProxyHostInputA11yLabel", IDS_SETTINGS_INTERNET_NETWORK_PROXY_HOST_INPUT_ACCESSIBILITY_LABEL },
        { "networkProxyHttp", IDS_SETTINGS_INTERNET_NETWORK_PROXY_HTTP_PROXY },
        { "networkProxyPort", IDS_SETTINGS_INTERNET_NETWORK_PROXY_PORT },
        { "networkProxyPortInputA11yLabel", IDS_SETTINGS_INTERNET_NETWORK_PROXY_PORT_INPUT_ACCESSIBILITY_LABEL },
        ...
        { "networkProxyTypeDirect", IDS_SETTINGS_INTERNET_NETWORK_PROXY_TYPE_DIRECT },
        { "networkProxyTypeManual", IDS_SETTINGS_INTERNET_NETWORK_PROXY_TYPE_MANUAL },
        ...
        { "networkSimChangePinTitle", IDS_SETTINGS_INTERNET_NETWORK_SIM_CHANGE_PIN_TITLE },
        { "networkSimLockedTooltip", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_TOOLTIP },
        { "networkSimEnter", IDS_SETTINGS_INTERNET_NETWORK_SIM_BUTTON_ENTER },
        { "networkSimEnterNewPin", IDS_SETTINGS_INTERNET_NETWORK_SIM_ENTER_NEW_PIN },
        { "networkSimEnterOldPin", IDS_SETTINGS_INTERNET_NETWORK_SIM_ENTER_OLD_PIN },
        { "networkSimEnterPin", IDS_SETTINGS_INTERNET_NETWORK_SIM_ENTER_PIN },
        { "networkSimEnterPinTitle", IDS_SETTINGS_INTERNET_NETWORK_SIM_ENTER_PIN_TITLE },
        { "networkSimEnterPinDescription", IDS_SETTINGS_INTERNET_NETWORK_SIM_ENTER_PIN_DESCRIPTION },
        { "networkSimEnterPinSubtext", IDS_SETTINGS_INTERNET_NETWORK_SIM_ENTER_PIN_DESCRIPTION_TEXT_LABEL },
        ...
        { "networkSimLockEnableSublabel", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCK_ENABLE_SUBLABEL },
        { "networkSimLockedTitle", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_TITLE },
        { "networkSimLockPolicyAdminSubtitle", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCK_POLICY_ADMIN_SUBTITLE },
        { "networkSimLockedPinSubtitle", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_PIN_SUBTITLE },
        { "networkSimPukDialogSubtitle", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_PUK_SUBTITLE },
        { "networkSimPukDialogManagedSubtitle", IDS_SETTINGS_INTERNET_NETWORK_MANAGED_SIM_LOCKED_PUK_SUBTITLE },
        { "networkSimPukDialogManagedWarningNoFailures", IDS_SETTINGS_INTERNET_NETWORK_MANAGED_SIM_LOCKED_PUK_WARNING_NO_FAILURES },
        { "networkSimPukDialogWarningNoFailures", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_PUK_WARNING_NO_FAILURES },
        { "networkSimPukDialogWarningWithFailure", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_PUK_WARNING_WITH_FAILURE },
        { "networkSimPukDialogWarningWithFailures", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_PUK_WARNING_WITH_FAILURES },
        { "networkSimPukDialogManagedWarningWithFailure", IDS_SETTINGS_INTERNET_NETWORK_MANAGED_SIM_LOCKED_PUK_WARNING_WITH_FAILURE },
        { "networkSimPukDialogManagedWarningWithFailures", IDS_SETTINGS_INTERNET_NETWORK_MANAGED_SIM_LOCKED_PUK_WARNING_WITH_FAILURES },
        { "networkSimLockedWarning", IDS_SETTINGS_INTERNET_NETWORK_SIM_LOCKED_WARNING },
        { "networkSimReEnterNewPin", IDS_SETTINGS_INTERNET_NETWORK_SIM_RE_ENTER_NEW_PIN },
        { "networkSimReEnterNewPin", IDS_SETTINGS_INTERNET_NETWORK_SIM_RE_ENTER_NEW_PIN },
        { "networkSimErrorIncorrectPin", IDS_SETTINGS_INTERNET_NETWORK_SIM_ERROR_INCORRECT_PIN },
        { "networkSimErrorIncorrectPinPlural", IDS_SETTINGS_INTERNET_NETWORK_SIM_ERROR_INCORRECT_PIN_PLURAL },
        { "networkSimErrorIncorrectPuk", IDS_SETTINGS_INTERNET_NETWORK_SIM_ERROR_INCORRECT_PUK },
        { "networkSimErrorInvalidPin", IDS_SETTINGS_INTERNET_NETWORK_SIM_ERROR_INVALID_PIN },
        { "networkSimErrorInvalidPinPlural", IDS_SETTINGS_INTERNET_NETWORK_SIM_ERROR_INVALID_PIN_PLURAL },
        { "networkSimErrorInvalidPuk", IDS_SETTINGS_INTERNET_NETWORK_SIM_ERROR_INVALID_PUK },
        { "networkSimErrorPinMismatch", IDS_SETTINGS_INTERNET_NETWORK_SIM_ERROR_PIN_MISMATCH },
        ...
        { "networkCellularScanCompleted", IDS_SETTINGS_INTERNET_NETWORK_CELLULAR_SCAN_COMPLETED },
        { "networkCellularScanConnectedHelp", IDS_SETTINGS_INTERNET_NETWORK_CELLULAR_SCAN_CONNECTED_HELP },
        { "networkCellularScanning", IDS_SETTINGS_INTERNET_NETWORK_CELLULAR_SCANNING },
        { "networkCellularNoNetworks", IDS_SETTINGS_INTERNET_NETWORK_CELLULAR_NO_NETWORKS },
        { "networkNameservers", IDS_SETTINGS_INTERNET_NETWORK_NAMESERVERS },
        { "networkNameserversAutomatic", IDS_SETTINGS_INTERNET_NETWORK_NAMESERVERS_AUTOMATIC },
        { "networkNameserversCustom", IDS_SETTINGS_INTERNET_NETWORK_NAMESERVERS_CUSTOM },
        { "networkNameserversGoogle", IDS_SETTINGS_INTERNET_NETWORK_NAMESERVERS_GOOGLE },
        { "networkNameserversCustomInputA11yLabel", IDS_SETTINGS_INTERNET_NETWORK_NAMESERVERS_INPUT_ACCESSIBILITY_LABEL },
        ...
        { "remove", IDS_REMOVE },
        { "controlledSettingPolicy", IDS_SETTINGS_INTERNET_NETWORK_SETTING_MANAGED_BY_ADMIN_TOOLTIP },
    };
    html_source->AddLocalizedStrings(kLocalizedStrings);

    html_source->AddBoolean("isApnRevampEnabled", ash::features::IsApnRevampEnabled());
    html_source->AddBoolean("isApnRevampAndAllowApnModificationPolicyEnabled", ash::features::IsApnRevampAndAllowApnModificationPolicyEnabled());

    html_source->AddString(
        "apnSettingsDescriptionWithLink", l10n_util::GetStringFUTF16(IDS_SETTINGS_APN_DESCRIPTION_WITH_LEARN_MORE_LINK, chrome::kApnSettingsLearnMoreUrl));

    html_source->AddString("apnSelectionDialogDescriptionWithLink",
        l10n_util::GetStringFUTF16(IDS_SETTINGS_APN_SELECTION_DIALOG_DESCRIPTION_WITH_LINK, chrome::kApnSettingsLearnMoreUrl));
}
...
void AddConfigLocalizedStrings(content::WebUIDataSource* html_source)
{
    static constexpr webui::LocalizedString kLocalizedStrings[] = {
        ...
        { "networkCertificateName", IDS_SETTINGS_INTERNET_NETWORK_CERTIFICATE_NAME },
        { "networkCertificateNameHardwareBacked", IDS_SETTINGS_INTERNET_NETWORK_CERTIFICATE_NAME_HARDWARE_BACKED },
        { "networkCertificateNoneInstalled", IDS_SETTINGS_INTERNET_NETWORK_CERTIFICATE_NONE_INSTALLED },
        { "networkConfigSaveCredentials", IDS_SETTINGS_INTERNET_CONFIG_SAVE_CREDENTIALS },
    ...
    html_source->AddBoolean("eapGtcWifiAuthentication", ash::features::IsEapGtcWifiAuthenticationEnabled());

    html_source->AddBoolean("showHiddenNetworkWarning", base::FeatureList::IsEnabled(ash::features::kHiddenNetworkWarning));
    ...
    html_source->AddBoolean("shareNetworkDefault", !ash::LoginState::Get()->UserHasNetworkProfile() || ash::LoginState::Get()->IsKioskSession());
    // Authenticated and Kiosk users can toggle the share state.
    html_source->AddBoolean("shareNetworkAllowEnable", ash::LoginState::Get()->IsUserAuthenticated() || ash::LoginState::Get()->IsKioskSession());

    html_source->AddBoolean("ephemeralNetworkPoliciesEnabled", ash::policy_util::AreEphemeralNetworkPoliciesEnabled());
}

void AddErrorLocalizedStrings(content::WebUIDataSource* html_source)
{
    static constexpr webui::LocalizedString kLocalizedStrings[] = {
        { "Error.CannotChangeSharedConfig", IDS_NETWORK_ERROR_CANNOT_CHANGE_SHARED_CONFIG },
        { "Error.PolicyControlled", IDS_NETWORK_ERROR_POLICY_CONTROLLED },
        { "networkErrorNoUserCertificate", IDS_NETWORK_ERROR_NO_USER_CERT },
        { ash::NetworkConnectionHandler::kErrorPassphraseRequired, IDS_NETWORK_ERROR_PASSPHRASE_REQUIRED },
        { "networkErrorUnknown", IDS_NETWORK_ERROR_UNKNOWN },
        { "networkErrorNotAvailableForNetworkAuth", IDS_SETTINGS_INTERNET_NETWORK_NOT_AVAILABLE_FOR_NETWORK_AUTH },
    };
    html_source->AddLocalizedStrings(kLocalizedStrings);
    ...
    for (const auto* error : shill_errors) {
        html_source->AddString(error, base::UTF16ToUTF8(ui::shill_error::GetShillErrorString(error, "")));
    }
}
