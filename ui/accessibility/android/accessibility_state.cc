...
{
    static base::NoDestructor<std::vector<AccessibilityState::AccessibilityStateDelegate*>> delegates;
    return *delegates;
}
...
// static
void JNI_AccessibilityState_OnDisplayInversionEnabledChanged(JNIEnv* env, jboolean enabled)
{
    AccessibilityState::NotifyDisplayInversionEnabledObservers((bool)enabled);
}

// static
void JNI_AccessibilityState_RecordAccessibilityServiceInfoHistograms(JNIEnv* env)
{
    AccessibilityState::NotifyRecordAccessibilityServiceInfoHistogram();
}

// static
void AccessibilityState::RegisterAccessibilityStateDelegate(AccessibilityStateDelegate* delegate)
{
    GetDelegates().push_back(delegate);
}

// static
void AccessibilityState::UnregisterAccessibilityStateDelegate(AccessibilityStateDelegate* delegate)
{
...
// static
void AccessibilityState::NotifyContrastLevelObservers(bool highContrastEnabled)
{
    for (AccessibilityStateDelegate* delegate : GetDelegates()) {
...
// static
void JNI_AccessibilityState_OnContrastLevelChanged(JNIEnv* env, jboolean highContrastEnabled)
{
...
{
    JNIEnv* env = AttachCurrentThread();
    return Java_AccessibilityAutofillHelper_shouldRespectDisplayedPasswordText(env);
}
...
{
    JNIEnv* env = AttachCurrentThread();
    Java_AccessibilityAutofillHelper_forceRespectDisplayedPasswordTextForTesting(env);
}
