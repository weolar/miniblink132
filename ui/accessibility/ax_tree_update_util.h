...
AX_EXPORT bool AXTreeUpdatesCanBeMerged(const AXTreeUpdate& u1, const AXTreeUpdate& u2);
...
AX_EXPORT bool MergeAXTreeUpdates(const std::vector<AXTreeUpdate>& src, std::vector<AXTreeUpdate>* dst);
