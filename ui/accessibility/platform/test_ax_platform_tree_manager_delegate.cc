...
void TestAXPlatformTreeManagerDelegate::AccessibilityPerformAction(const AXActionData& data)
{
}
...
gfx::AcceleratedWidget TestAXPlatformTreeManagerDelegate::AccessibilityGetAcceleratedWidget()
{
    return accelerated_widget_;
}

gfx::NativeViewAccessible TestAXPlatformTreeManagerDelegate::AccessibilityGetNativeViewAccessible()
{
    return nullptr;
}

gfx::NativeViewAccessible TestAXPlatformTreeManagerDelegate::AccessibilityGetNativeViewAccessibleForWindow()
{
    return nullptr;
}

void TestAXPlatformTreeManagerDelegate::AccessibilityHitTest(const gfx::Point& point_in_frame_pixels, const ax::mojom::Event& opt_event_to_fire,
    int opt_request_id, base::OnceCallback<void(AXPlatformTreeManager* hit_manager, AXNodeID hit_node_id)> opt_callback)
{
}
...
content::WebContentsAccessibility* TestAXPlatformTreeManagerDelegate::AccessibilityGetWebContentsAccessibility()
{
    return nullptr;
}
