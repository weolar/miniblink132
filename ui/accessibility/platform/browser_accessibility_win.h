...
COMPONENT_EXPORT(AX_PLATFORM) BrowserAccessibilityWin* ToBrowserAccessibilityWin(BrowserAccessibility* obj);

COMPONENT_EXPORT(AX_PLATFORM) const BrowserAccessibilityWin* ToBrowserAccessibilityWin(const BrowserAccessibility* obj);
