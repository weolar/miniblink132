...
public:
    BrowserAccessibilityAuraLinux(BrowserAccessibilityManager* manager, AXNode* node);
    ~BrowserAccessibilityAuraLinux() override;
    BrowserAccessibilityAuraLinux(const BrowserAccessibilityAuraLinux&) = delete;
    BrowserAccessibilityAuraLinux& operator=(const BrowserAccessibilityAuraLinux&) = delete;
...
COMPONENT_EXPORT(AX_PLATFORM) BrowserAccessibilityAuraLinux* ToBrowserAccessibilityAuraLinux(BrowserAccessibility* obj);
