...
class AXPlatformNodeId : public base::StrongAlias<class AXPlatformNodeIdTag, int32_t> {
public:
    ...
    constexpr explicit AXPlatformNodeId(base::PassKey<AXNodeIdDelegate>, int32_t v)
