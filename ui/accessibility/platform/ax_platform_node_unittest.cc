...
AXTreeUpdate AXPlatformNodeTest::BuildTextField()
{
    ...
    text_field_node.AddStringAttribute(ax::mojom::StringAttribute::kHtmlTag, "input");
    text_field_node.AddStringAttribute(ax::mojom::StringAttribute::kInputType, "text");
...
AXTreeUpdate AXPlatformNodeTest::BuildTextFieldWithSelectionRange(int32_t start, int32_t stop)
{
    AXNodeData text_field_node;
    text_field_node.id = 1;
    text_field_node.role = ax::mojom::Role::kTextField;
    ...
    text_field_node.AddIntAttribute(ax::mojom::IntAttribute::kTextSelStart, start);
...
AXTreeUpdate AXPlatformNodeTest::BuildContentEditable()
{
    ...
    content_editable_node.AddBoolAttribute(ax::mojom::BoolAttribute::kNonAtomicTextFieldRoot, true);
...
AXTreeUpdate AXPlatformNodeTest::BuildContentEditableWithSelectionRange(int32_t start, int32_t end)
{
    AXNodeData content_editable_node;
    content_editable_node.id = 1;
    content_editable_node.role = ax::mojom::Role::kGroup;
    content_editable_node.AddState(ax::mojom::State::kEditable);
    content_editable_node.AddState(ax::mojom::State::kRichlyEditable);
    content_editable_node.AddBoolAttribute(ax::mojom::BoolAttribute::kSelected, true);
    content_editable_node.AddBoolAttribute(ax::mojom::BoolAttribute::kNonAtomicTextFieldRoot, true);
    content_editable_node.SetValue("How now brown cow.");
...
AXTreeUpdate AXPlatformNodeTest::AXPlatformNodeTest::Build3X3Table()
{
  ...
  */
    ...
    table_column_header_1.AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, 0);
    table_column_header_1.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 0);
    ...
    table_column_header_2.AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, 0);
    table_column_header_2.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 1);
    ...
    table_column_header_3.AddStringAttribute(ax::mojom::StringAttribute::kDescription, "column header 2");
    table_column_header_3.AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, 0);
    table_column_header_3.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 2);
    ...
    table_row_header_1.AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, 1);
    table_row_header_1.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 0);
    ...
    table_cell_1.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 1);
    ...
    table_cell_2.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 2);
    ...
    // Either ax::mojom::StringAttribute::kName -or-
    // ax::mojom::StringAttribute::kDescription is acceptable for a description
    table_row_header_2.AddStringAttribute(ax::mojom::StringAttribute::kDescription, "row header 2");
    table_row_header_2.AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, 2);
    table_row_header_2.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 0);
    ...
    table_cell_3.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 1);
    ...
    table_cell_4.AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 2);
...
AXTreeUpdate AXPlatformNodeTest::BuildAriaColumnAndRowCountGrids()
{
    ...
    rowcolindex_cell.AddIntAttribute(ax::mojom::IntAttribute::kAriaCellColumnIndex, 5);
    rowcolindex_cell.AddIntAttribute(ax::mojom::IntAttribute::kAriaCellRowIndex, 4);
    ...
    rowcolcount_grid.AddIntAttribute(ax::mojom::IntAttribute::kAriaColumnCount, 3);
    ...
    unknown_grid.AddIntAttribute(ax::mojom::IntAttribute::kAriaRowCount, ax::mojom::kUnknownAriaColumnOrRowCount);
    unknown_grid.AddIntAttribute(ax::mojom::IntAttribute::kAriaColumnCount, ax::mojom::kUnknownAriaColumnOrRowCount);
...
AXTreeUpdate AXPlatformNodeTest::BuildListBox(
    bool option_1_is_selected, bool option_2_is_selected, bool option_3_is_selected, const std::vector<ax::mojom::State>& additional_state)
{
    AXNodeData listbox;
    listbox.id = 1;
