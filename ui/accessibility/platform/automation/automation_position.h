...
class COMPONENT_EXPORT(AX_PLATFORM) AutomationPosition final : public gin::Wrappable<AutomationPosition> {
public:
    AutomationPosition(const AXNode& node, AXPositionKind kind, int offset, bool is_upstream);
