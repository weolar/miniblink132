...
public:
    ...
    using NativeWindowHandlerCallback = base::RepeatingCallback<AXPlatformNode*(gfx::NativeWindow)>;
    ...
    virtual void AnnounceTextAs(const std::u16string& text, AnnouncementType announcement_type) = 0;
#endif
...
private:
    static base::LazyInstance<NativeWindowHandlerCallback>::Leaky native_window_handler_;
