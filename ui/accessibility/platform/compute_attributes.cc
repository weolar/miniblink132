...
std::optional<int32_t> GetCellAttribute(const AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
...
std::optional<int32_t> GetRowAttribute(const AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
...
std::optional<int32_t> GetTableAttribute(const AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
...
std::optional<int> GetOrderedSetItemAttribute(const AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
...
std::optional<int> GetOrderedSetAttribute(const AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    switch (attribute) {
    case ax::mojom::IntAttribute::kSetSize:
        return delegate->GetSetSize();
...
std::optional<int32_t> GetFromData(const AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
    int32_t value;
...
std::optional<int32_t> ComputeAttribute(const AXPlatformNodeDelegate* delegate, ax::mojom::IntAttribute attribute)
{
