...
public:
    ...
    AXPlatformTreeManagerDelegate& operator=(const AXPlatformTreeManagerDelegate&) = delete;
    ...
    virtual gfx::NativeViewAccessible AccessibilityGetNativeViewAccessibleForWindow() = 0;
    ...
    virtual void AccessibilityHitTest(const gfx::Point& point_in_view_pixels, const ax::mojom::Event& opt_event_to_fire, int opt_request_id,
        base::OnceCallback<void(AXPlatformTreeManager* hit_manager, AXNodeID hit_node_id)> opt_callback)
        = 0;
    ...
    virtual content::WebContentsAccessibility* AccessibilityGetWebContentsAccessibility() = 0;
