...
public:
    ...
    gfx::NativeViewAccessible AccessibilityGetNativeViewAccessibleForWindow() override;
    ...
    content::WebContentsAccessibility* AccessibilityGetWebContentsAccessibility() override;
