...
// renumber.
enum class AXTextStateChangeType { kUnknown = 0, kEdit = 1, kSelectionMove = 2, kSelectionExtend = 3, kSelectionBoundary = 4 };
...
// modified slightly to comply with Chromium's C++ Style Guide. Please do not
// renumber.
enum class AXTextSelectionDirection { kUnknown = 0, kBeginning = 1, kEnd = 2, kPrevious = 3, kNext = 4, kDiscontiguous = 5 };
...
struct AXTextSelection final {
    ...
    static AXTextSelection FromDirectionAndGranularity(ax::mojom::TextBoundary text_boundary, ax::mojom::MoveDirection move_direction);
    ...
    AXTextSelection(AXTextSelectionDirection direction, AXTextSelectionGranularity granularity, bool focus_change);
...
struct COMPONENT_EXPORT(AX_PLATFORM) AXTextStateChangeIntent final {
    ...
    AXTextStateChangeIntent(AXTextStateChangeType type, AXTextSelection selection);
