...
class AXPlatformRelationWin : public SequenceAffineComObjectRoot, public IAccessibleRelation {
public:
    ...
    // criteria.
    static int EnumerateRelationships(AXPlatformNodeBase* node, int desired_index, const std::wstring& desired_ia2_relation, std::wstring* out_ia2_relation,
