...
class COMPONENT_EXPORT(AX_PLATFORM) AXTreeFormatterAuraLinux : public AXTreeFormatterBase {
public:
...
private:
    ...
    void AddHypertextProperties(AtkObject* atk_object, base::Value::Dict* dict) const;
    void AddActionProperties(AtkObject* atk_object, base::Value::Dict* dict) const;
    void AddRelationProperties(AtkObject* atk_object, base::Value::Dict* dict) const;
    ...
    void AddTableCellProperties(const AXPlatformNodeAuraLinux* node, AtkObject* atk_object, base::Value::Dict* dict) const;
