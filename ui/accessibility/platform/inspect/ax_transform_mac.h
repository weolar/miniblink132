...
base::Value::Dict AXCustomContentToBaseValue(AXCustomContent*) API_AVAILABLE(macosx(11.0));
...
base::Value AXPositionToBaseValue(const AXPlatformNodeDelegate::AXPosition&, const AXTreeIndexerMac*);
...
COMPONENT_EXPORT(AX_PLATFORM)
base::Value NSAttributedStringToBaseValue(NSAttributedString*, const AXTreeIndexerMac*);
...
COMPONENT_EXPORT(AX_PLATFORM)
base::Value::Dict AXNSDictionaryToBaseValue(NSDictionary*, const AXTreeIndexerMac*);
