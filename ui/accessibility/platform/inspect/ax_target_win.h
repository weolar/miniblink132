...
using IA2TextSelectionContainerComPtr = Microsoft::WRL::ComPtr<IAccessibleTextSelectionContainer>;
...
private:
    using VariantType = absl::variant<std::string, int, IAccessibleComPtr, IA2ComPtr, IA2HypertextComPtr, IA2TableComPtr, IA2TableCellComPtr, IA2TextComPtr,
        IA2TextSelectionContainerComPtr, IA2ValueComPtr, ScopedCoMemArray<LONG>, ScopedCoMemArray<IA2TextSelection>>;
