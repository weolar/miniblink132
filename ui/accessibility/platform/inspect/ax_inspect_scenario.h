...
public:
    explicit AXInspectScenario(const std::vector<AXPropertyFilter>& default_filters = {});
...
private:
    ...
    static Directive ParseDirective(const std::string& directive_prefix, std::string_view directive);
