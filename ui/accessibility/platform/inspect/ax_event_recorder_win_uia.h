...
class COMPONENT_EXPORT(AX_PLATFORM) AXEventRecorderWinUia : public AXEventRecorder {
public:
...
private:
    ...
    public:
        ...
        void Init(AXEventRecorderWinUia* owner, HWND hwnd, base::RunLoop& initialization_loop, base::RunLoop& shutdown_loop);
    ...
    private:
        ...
        public:
            ...
            void Init(AXEventRecorderWinUia::Thread* owner, Microsoft::WRL::ComPtr<IUIAutomationElement> root);
            void CleanUp();
            ...
            IFACEMETHODIMP HandlePropertyChangedEvent(IUIAutomationElement* sender, PROPERTYID property_id, VARIANT new_value) override;

            // IUIAutomationStructureChangedEventHandler interface.
            IFACEMETHODIMP HandleStructureChangedEvent(IUIAutomationElement* sender, StructureChangeType change_type, SAFEARRAY* runtime_id) override;

            // IUIAutomationEventHandler interface.
            IFACEMETHODIMP HandleAutomationEvent(IUIAutomationElement* sender, EVENTID event_id) override;
