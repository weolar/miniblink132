...
class COMPONENT_EXPORT(AX_PLATFORM) AXEventRecorderWin : public AXEventRecorder {
public:
    ...
    AXEventRecorderWin(base::ProcessId pid, const AXTreeSelector& selector, ListenerType listenerType = kSync);
    ...
    static CALLBACK void WinEventHookThunk(HWINEVENTHOOK handle, DWORD event, HWND hwnd, LONG obj_id, LONG child_id, DWORD event_thread, DWORD event_time);
