...
{
    static constexpr auto kTypeToString = base::MakeFixedFlatMap<std::string_view, TypeConstant>(
        { { kAndroidString, kAndroid }, { kAndroidExternalString, kAndroidExternal }, { kBlinkString, kBlink }, { kFuchsiaString, kFuchsia },
            { kMacString, kMac }, { kLinuxString, kLinux }, { kWinIA2String, kWinIA2 }, { kWinUIAString, kWinUIA } });
