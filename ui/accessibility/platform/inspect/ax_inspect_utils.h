 ...
 */
std::string COMPONENT_EXPORT(AX_PLATFORM) AXMakeSetKey(const std::string& key_name);
 ...
 * FormatValue.
 */
std::string COMPONENT_EXPORT(AX_PLATFORM) AXMakeOrderedKey(const std::string& key_name, int position);

/**
 * Formats a value.
 */
std::string COMPONENT_EXPORT(AX_PLATFORM) AXFormatValue(const base::Value& value);
