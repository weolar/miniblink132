...
typedef bool (*AccessibilityMatchPredicate)(BrowserAccessibility* start_element, BrowserAccessibility* this_element);

#define DECLARE_ACCESSIBILITY_PREDICATE(PredicateName)                                                                                                         \
    COMPONENT_EXPORT(AX_PLATFORM) bool PredicateName(BrowserAccessibility* start_element, BrowserAccessibility* this_element)
...
public:
    ...
    OneShotAccessibilityTreeSearch(const OneShotAccessibilityTreeSearch&) = delete;
    OneShotAccessibilityTreeSearch& operator=(const OneShotAccessibilityTreeSearch&) = delete;
