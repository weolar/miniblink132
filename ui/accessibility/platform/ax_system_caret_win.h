...
class COMPONENT_EXPORT(AX_PLATFORM) AXSystemCaretWin : private AXPlatformNodeDelegate {
public:
...
private:
    ...
    using deleter = std::integral_constant<decltype(AXSystemCaretWin::AXPlatformNodeWinDeleter)*, AXSystemCaretWin::AXPlatformNodeWinDeleter>;
