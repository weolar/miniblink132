...
std::u16string AXPlatformNodeDelegate::GetTextContentUTF16() const
{
    ...
    std::u16string value = GetString16Attribute(ax::mojom::StringAttribute::kValue);
    if (!value.empty())
        return value;
    ...
    for (size_t i = 0; i < GetChildCount(); ++i) {
        ...
        // const_cast.
        const AXPlatformNode* child = AXPlatformNode::FromNativeViewAccessible(const_cast<AXPlatformNodeDelegate*>(this)->ChildAtIndex(i));
...
std::u16string AXPlatformNodeDelegate::GetValueForControl() const
{
    ...
    if (GetData().IsRangeValueSupported() && value.empty()) {
        float numeric_value = GetData().GetFloatAttribute(ax::mojom::FloatAttribute::kValueForRange);
        if (numeric_value || GetData().HasFloatAttribute(ax::mojom::FloatAttribute::kValueForRange)) {
...
AXNodePosition::AXPositionInstance AXPlatformNodeDelegate::CreatePositionAt(int offset, ax::mojom::TextAffinity affinity) const
{
    if (node_)
...
AXNodePosition::AXPositionInstance AXPlatformNodeDelegate::CreateTextPositionAt(int offset, ax::mojom::TextAffinity affinity) const
{
    if (node_) {
        DCHECK(node_->tree()) << "All nodes should be owned by an accessibility tree.\n" << *node_;
...
std::optional<size_t> AXPlatformNodeDelegate::GetIndexInParent() const
{
    ...
    for (size_t i = 0; i < parent->GetChildCount(); i++) {
        AXPlatformNode* child_node = AXPlatformNode::FromNativeViewAccessible(parent->ChildAtIndex(i));
...
gfx::NativeViewAccessible AXPlatformNodeDelegate::ChildAtIndex(size_t index) const
{
    return nullptr;
}
...
bool AXPlatformNodeDelegate::IsChildOfLeaf() const
{
    ...
    const AXPlatformNodeDelegate* parent = const_cast<AXPlatformNodeDelegate*>(this)->GetParentDelegate();
    if (!parent)
        return false;
    if (parent->IsLeaf())
        return true;
...
bool AXPlatformNodeDelegate::IsDescendantOfAtomicTextField() const
{
    ...
    // TODO(nektar): Add const to all tree traversal methods and remove
    // const_cast.
    for (AXPlatformNodeDelegate* ancestor_delegate = const_cast<AXPlatformNodeDelegate*>(this); ancestor_delegate;
         ancestor_delegate = static_cast<AXPlatformNodeDelegate*>(ancestor_delegate->GetParentDelegate())) {
...
bool AXPlatformNodeDelegate::IsIgnored() const
{
    ...
    return GetRole() == ax::mojom::Role::kNone || HasState(ax::mojom::State::kIgnored);
}
...
gfx::NativeViewAccessible AXPlatformNodeDelegate::GetLowestPlatformAncestor() const
{
    AXPlatformNodeDelegate* current_delegate = const_cast<AXPlatformNodeDelegate*>(this);
    AXPlatformNodeDelegate* lowest_unignored_delegate = current_delegate;
    if (lowest_unignored_delegate->IsIgnored()) {
        lowest_unignored_delegate = static_cast<AXPlatformNodeDelegate*>(lowest_unignored_delegate->GetParentDelegate());
    }
    DCHECK(!lowest_unignored_delegate || !lowest_unignored_delegate->IsIgnored()) << "`AXPlatformNodeDelegate::GetParentDelegate()` should return "
    ...
    for (AXPlatformNodeDelegate* ancestor_delegate = lowest_unignored_delegate; ancestor_delegate;
         ancestor_delegate = static_cast<AXPlatformNodeDelegate*>(ancestor_delegate->GetParentDelegate())) {
...
gfx::NativeViewAccessible AXPlatformNodeDelegate::GetSelectionContainer() const
{
    // TODO(nektar): Add const to all tree traversal methods and remove
    // const_cast.
    for (AXPlatformNodeDelegate* ancestor_delegate = const_cast<AXPlatformNodeDelegate*>(this); ancestor_delegate;
...
const std::map<int, int>& AXPlatformNodeDelegate::GetHypertextOffsetToHyperlinkChildIndex() const
{
    if (node_)
...
bool AXPlatformNodeDelegate::SetHypertextSelection(int start_offset, int end_offset)
{
...
TextAttributeMap AXPlatformNodeDelegate::ComputeTextAttributeMap(const TextAttributeList& default_attributes) const
{
...
gfx::Rect AXPlatformNodeDelegate::GetHypertextRangeBoundsRect(const int start_offset, const int end_offset, const AXCoordinateSystem coordinate_system,
    const AXClippingBehavior clipping_behavior, AXOffscreenResult* offscreen_result) const
{
    return gfx::Rect();
}

gfx::Rect AXPlatformNodeDelegate::GetInnerTextRangeBoundsRect(const int start_offset, const int end_offset, const AXCoordinateSystem coordinate_system,
    const AXClippingBehavior clipping_behavior, AXOffscreenResult* offscreen_result) const
{
    return gfx::Rect();
}

gfx::NativeViewAccessible AXPlatformNodeDelegate::HitTestSync(int screen_physical_pixel_x, int screen_physical_pixel_y) const
{
    return nullptr;
}
...
AXPlatformNode* AXPlatformNodeDelegate::GetFromTreeIDAndNodeID(const AXTreeID& ax_tree_id, int32_t id)
{
    return nullptr;
}

AXPlatformNode* AXPlatformNodeDelegate::GetTargetNodeForRelation(ax::mojom::IntAttribute attr)
{
...
std::vector<AXPlatformNode*> AXPlatformNodeDelegate::GetTargetNodesForRelation(ax::mojom::IntListAttribute attr)
{
...
std::vector<AXPlatformNode*> AXPlatformNodeDelegate::GetSourceNodesForReverseRelations(ax::mojom::IntAttribute attr)
{
...
std::vector<AXPlatformNode*> AXPlatformNodeDelegate::GetSourceNodesForReverseRelations(ax::mojom::IntListAttribute attr)
{
    return std::vector<AXPlatformNode*>();
}

std::vector<AXPlatformNode*> AXPlatformNodeDelegate::GetNodesFromRelationIdSet(const std::set<AXNodeID>& ids)
{
    std::vector<AXPlatformNode*> nodes;
...
bool AXPlatformNodeDelegate::IsValidRelationTarget(AXPlatformNode* target) const
{
    if (!target) {
...
{
    static const base::NoDestructor<AXUniqueId> empty_unique_id(AXUniqueId::Create());
    return empty_unique_id->Get();
}

AXPlatformNodeDelegate* AXPlatformNodeDelegate::GetParentDelegate() const
{
    AXPlatformNode* parent_node = AXPlatformNode::FromNativeViewAccessible(GetParent());
    if (parent_node)
...
bool AXPlatformNodeDelegate::HasBoolAttribute(ax::mojom::BoolAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetBoolAttribute(ax::mojom::BoolAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetBoolAttribute(ax::mojom::BoolAttribute attribute, bool* value) const
{
...
bool AXPlatformNodeDelegate::HasFloatAttribute(ax::mojom::FloatAttribute attribute) const
{
    if (node_)
...
float AXPlatformNodeDelegate::GetFloatAttribute(ax::mojom::FloatAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetFloatAttribute(ax::mojom::FloatAttribute attribute, float* value) const
{
...
const std::vector<std::pair<ax::mojom::IntAttribute, int32_t>>& AXPlatformNodeDelegate::GetIntAttributes() const
{
    if (node_)
...
bool AXPlatformNodeDelegate::HasIntAttribute(ax::mojom::IntAttribute attribute) const
{
    if (node_)
...
int AXPlatformNodeDelegate::GetIntAttribute(ax::mojom::IntAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetIntAttribute(ax::mojom::IntAttribute attribute, int* value) const
{
...
const std::vector<std::pair<ax::mojom::StringAttribute, std::string>>& AXPlatformNodeDelegate::GetStringAttributes() const
{
    if (node_)
...
bool AXPlatformNodeDelegate::HasStringAttribute(ax::mojom::StringAttribute attribute) const
{
    if (node_)
...
const std::string& AXPlatformNodeDelegate::GetStringAttribute(ax::mojom::StringAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetStringAttribute(ax::mojom::StringAttribute attribute, std::string* value) const
{
...
std::u16string AXPlatformNodeDelegate::GetString16Attribute(ax::mojom::StringAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetString16Attribute(ax::mojom::StringAttribute attribute, std::u16string* value) const
{
    bool found = HasStringAttribute(attribute);
    if (found) {
...
const std::string& AXPlatformNodeDelegate::GetInheritedStringAttribute(ax::mojom::StringAttribute attribute) const
{
    if (node_)
...
std::u16string AXPlatformNodeDelegate::GetInheritedString16Attribute(ax::mojom::StringAttribute attribute) const
{
    if (node_)
...
const std::vector<std::pair<ax::mojom::IntListAttribute, std::vector<int32_t>>>& AXPlatformNodeDelegate::GetIntListAttributes() const
{
    if (node_)
...
bool AXPlatformNodeDelegate::HasIntListAttribute(ax::mojom::IntListAttribute attribute) const
{
    if (node_)
...
const std::vector<int32_t>& AXPlatformNodeDelegate::GetIntListAttribute(ax::mojom::IntListAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetIntListAttribute(ax::mojom::IntListAttribute attribute, std::vector<int32_t>* value) const
{
...
bool AXPlatformNodeDelegate::HasStringListAttribute(ax::mojom::StringListAttribute attribute) const
{
    if (node_)
...
const std::vector<std::string>& AXPlatformNodeDelegate::GetStringListAttribute(ax::mojom::StringListAttribute attribute) const
{
    if (node_)
...
bool AXPlatformNodeDelegate::GetStringListAttribute(ax::mojom::StringListAttribute attribute, std::vector<std::string>* value) const
{
...
gfx::Rect AXPlatformNodeDelegate::GetClippedScreenBoundsRect(AXOffscreenResult* offscreen_result) const
{
    return GetBoundsRect(AXCoordinateSystem::kScreenDIPs, AXClippingBehavior::kClipped, offscreen_result);
}

gfx::Rect AXPlatformNodeDelegate::GetUnclippedScreenBoundsRect(AXOffscreenResult* offscreen_result) const
{
    return GetBoundsRect(AXCoordinateSystem::kScreenDIPs, AXClippingBehavior::kUnclipped, offscreen_result);
}

gfx::Rect AXPlatformNodeDelegate::GetClippedRootFrameBoundsRect(AXOffscreenResult* offscreen_result) const
{
    return GetBoundsRect(AXCoordinateSystem::kRootFrame, AXClippingBehavior::kClipped, offscreen_result);
}

gfx::Rect AXPlatformNodeDelegate::GetUnclippedRootFrameBoundsRect(AXOffscreenResult* offscreen_result) const
{
    return GetBoundsRect(AXCoordinateSystem::kRootFrame, AXClippingBehavior::kUnclipped, offscreen_result);
}

gfx::Rect AXPlatformNodeDelegate::GetClippedFrameBoundsRect(AXOffscreenResult* offscreen_result) const
{
    return GetBoundsRect(AXCoordinateSystem::kFrame, AXClippingBehavior::kClipped, offscreen_result);
}

gfx::Rect AXPlatformNodeDelegate::GetUnclippedFrameBoundsRect(AXOffscreenResult* offscreen_result) const
{
    return GetBoundsRect(AXCoordinateSystem::kFrame, AXClippingBehavior::kUnclipped, offscreen_result);
}

bool AXPlatformNodeDelegate::HasDefaultActionVerb() const
{
    return GetData().GetDefaultActionVerb() != ax::mojom::DefaultActionVerb::kNone;
}

std::vector<ax::mojom::Action> AXPlatformNodeDelegate::GetSupportedActions() const
{
    static constexpr auto kActionsThatCanBeExposed = base::MakeFixedFlatSet<ax::mojom::Action>(
        { ax::mojom::Action::kDecrement, ax::mojom::Action::kIncrement, ax::mojom::Action::kScrollUp, ax::mojom::Action::kScrollDown,
            ax::mojom::Action::kScrollLeft, ax::mojom::Action::kScrollRight, ax::mojom::Action::kScrollForward, ax::mojom::Action::kScrollBackward });
...
bool AXPlatformNodeDelegate::HasTextStyle(ax::mojom::TextStyle text_style) const
{
    if (node_)
...
std::vector<int32_t> AXPlatformNodeDelegate::GetColHeaderNodeIds(int col_index) const
{
    if (node_)
...
std::vector<int32_t> AXPlatformNodeDelegate::GetRowHeaderNodeIds(int row_index) const
{
    if (node_)
...
std::optional<int32_t> AXPlatformNodeDelegate::GetCellId(int row_index, int col_index) const
{
    if (node_) {
...
std::optional<int32_t> AXPlatformNodeDelegate::GetCellIdAriaCoords(int aria_row_index, int aria_col_index) const
{
    if (node_) {
        AXNode* cell = node()->GetTableCellFromAriaCoords(aria_row_index, aria_col_index);
        if (!cell) {
            return std::nullopt;
        }
        return cell->id();
...
std::optional<int32_t> AXPlatformNodeDelegate::CellIndexToId(int cell_index) const
{
    if (node_) {
...
gfx::AcceleratedWidget AXPlatformNodeDelegate::GetTargetForNativeAccessibilityEvent()
{
    return gfx::kNullAcceleratedWidget;
}

bool AXPlatformNodeDelegate::AccessibilityPerformAction(const AXActionData& data)
{
    return false;
}

std::u16string AXPlatformNodeDelegate::GetLocalizedRoleDescriptionForUnlabeledImage() const
{
    return std::u16string();
}

std::u16string AXPlatformNodeDelegate::GetLocalizedStringForImageAnnotationStatus(ax::mojom::ImageAnnotationStatus status) const
{
    return std::u16string();
}

std::u16string AXPlatformNodeDelegate::GetLocalizedStringForLandmarkType() const
{
    return std::u16string();
}

std::u16string AXPlatformNodeDelegate::GetLocalizedStringForRoleDescription() const
{
    return std::u16string();
}

std::u16string AXPlatformNodeDelegate::GetStyleNameAttributeAsLocalizedString() const
{
    return std::u16string();
}
...
const std::vector<gfx::NativeViewAccessible> AXPlatformNodeDelegate::GetUIADirectChildrenInRange(AXPlatformNodeDelegate* start, AXPlatformNodeDelegate* end)
{
    return {};
}
