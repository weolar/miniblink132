...
class COMPONENT_EXPORT(AX_PLATFORM) __declspec(uuid("3e1c192b-4348-45ac-8eb6-4b58eeb3dcca")) AXPlatformNodeTextProviderWin : public SequenceAffineComObjectRoot,
...
public:
    ...
    IFACEMETHODIMP RangeFromChild(IRawElementProviderSimple* child, ITextRangeProvider** range) override;
    ...
    IFACEMETHODIMP get_SupportedTextSelection(enum SupportedTextSelection* text_selection) override;
    ...
    static void GetRangeFromChild(AXPlatformNodeWin* ancestor, AXPlatformNodeWin* descendant, ITextRangeProvider** range);

    // Create a dengerate text range at the start of the specified node.
    static void CreateDegenerateRangeAtStart(AXPlatformNodeWin* node, ITextRangeProvider** range);
