...
// static
base::LazyInstance<AXPlatformNode::NativeWindowHandlerCallback>::Leaky AXPlatformNode::native_window_handler_ = LAZY_INSTANCE_INITIALIZER;
...
// static
AXPlatformNode* AXPlatformNode::FromNativeWindow(gfx::NativeWindow native_window)
{
...
// static
void AXPlatformNode::RegisterNativeWindowHandler(AXPlatformNode::NativeWindowHandlerCallback handler)
{
...
// static
void AXPlatformNode::SetPopupFocusOverride(gfx::NativeViewAccessible popup_focus_override)
{
