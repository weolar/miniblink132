...
public:
    ...
    public:
        ...
        using HitTestCallback = base::OnceCallback<void(const fidl::Response<fuchsia_accessibility_semantics::SemanticListener::HitTest>&)>;
        ...
        virtual bool OnAccessibilityAction(uint32_t node_id, fuchsia_accessibility_semantics::Action action) = 0;
        ...
        // hit tests.
        virtual void OnHitTest(fuchsia_math::PointF point, HitTestCallback callback) = 0;
    ...
    virtual void SendEvent(fuchsia_accessibility_semantics::SemanticEvent event) = 0;
