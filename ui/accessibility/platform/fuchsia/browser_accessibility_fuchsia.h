...
public:
    BrowserAccessibilityFuchsia(BrowserAccessibilityManager* manager, AXNode* node);
    ~BrowserAccessibilityFuchsia() override;

    // Disallow copy and assign.
    BrowserAccessibilityFuchsia(const BrowserAccessibilityFuchsia&) = delete;
    BrowserAccessibilityFuchsia& operator=(const BrowserAccessibilityFuchsia&) = delete;
...
private:
    ...
    void UpdateNode();
    void DeleteNode();
    std::vector<fuchsia_accessibility_semantics::Action> GetFuchsiaActions() const;
...
BrowserAccessibilityFuchsia* COMPONENT_EXPORT(AX_PLATFORM) ToBrowserAccessibilityFuchsia(BrowserAccessibility* obj);
