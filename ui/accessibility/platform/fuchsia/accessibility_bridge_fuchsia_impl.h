...
class COMPONENT_EXPORT(AX_PLATFORM) AccessibilityBridgeFuchsiaImpl final : public AccessibilityBridgeFuchsia, public AXFuchsiaSemanticProvider::Delegate {
public:
    ...
    // do not reconnect).
    AccessibilityBridgeFuchsiaImpl(aura::Window* root_window, fuchsia_ui_views::ViewRef view_ref, base::RepeatingCallback<void(bool)> on_semantics_enabled,
        OnConnectionClosedCallback on_connection_closed, inspect::Node inspect_node);
    ...
    void set_semantic_provider_for_test(std::unique_ptr<AXFuchsiaSemanticProvider> semantic_provider);
...
private:
    ...
    base::flat_map<int /* request_id */, HitTestCallback> pending_hit_test_completers_;
