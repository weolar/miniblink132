...
public:
    ...
    AccessibilityBridgeFuchsiaRegistry(const AccessibilityBridgeFuchsiaRegistry&) = delete;
    AccessibilityBridgeFuchsiaRegistry& operator=(const AccessibilityBridgeFuchsiaRegistry&) = delete;
    ...
    void RegisterAccessibilityBridge(aura::Window* window, AccessibilityBridgeFuchsia* accessibility_bridge);
...
private:
    base::flat_map<aura::Window*, AccessibilityBridgeFuchsia*> window_to_bridge_map_;
};
