...
class MockIRawElementProviderSimple : public SequenceAffineComObjectRoot, public IRawElementProviderSimple {
public:
...
protected:
    ...
    template <typename T> Microsoft::WRL::ComPtr<T> QueryInterfaceFromNodeId(AXNodeID id);
    template <typename T> Microsoft::WRL::ComPtr<T> QueryInterfaceFromNode(AXNode* node);
    ...
    Microsoft::WRL::ComPtr<IRawElementProviderSimple> GetIRawElementProviderSimpleFromId(const AXNodeID node_id);
    ...
    Microsoft::WRL::ComPtr<IAccessible2> ToIAccessible2(Microsoft::WRL::ComPtr<IUnknown> unknown);
    Microsoft::WRL::ComPtr<IAccessible2> ToIAccessible2(Microsoft::WRL::ComPtr<IAccessible> accessible);
    Microsoft::WRL::ComPtr<IAccessible2_2> ToIAccessible2_2(Microsoft::WRL::ComPtr<IAccessible> accessible);
