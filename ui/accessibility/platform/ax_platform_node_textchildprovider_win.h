...
namespace ui {
class COMPONENT_EXPORT(AX_PLATFORM) AXPlatformNodeTextChildProviderWin : public SequenceAffineComObjectRoot, public ITextChildProvider {
public:
    ...
    IFACEMETHODIMP get_TextContainer(IRawElementProviderSimple** pRetVal) override;
