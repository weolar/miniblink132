...
const char kAXAutoCompleteTextViewClassname[] = "android.widget.AutoCompleteTextView";
...
const char kAXHorizontalScrollViewClassname[] = "android.widget.HorizontalScrollView";
...
const char kAXMultiAutoCompleteTextViewClassname[] = "android.widget.MultiAutoCompleteTextView";
