...
ax::mojom::StringAttribute StringToStringAttribute(const std::string& string_attribute)
{
    if (string_attribute == "kNone") {
        ...
        NOTREACHED() << "An invalid StringAttribute was provided: " << string_attribute;
    }
}
...
ax::mojom::BoolAttribute StringToBoolAttribute(const std::string& bool_attribute)
{
