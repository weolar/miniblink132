...
AX_BASE_EXPORT const char* ToString(ax::mojom::DefaultActionVerb default_action_verb);

// ax::mojom::Mutation
AX_BASE_EXPORT const char* ToString(ax::mojom::Mutation mutation);

// ax::mojom::StringAttribute
AX_BASE_EXPORT const char* ToString(ax::mojom::StringAttribute string_attribute);
AX_BASE_EXPORT ax::mojom::StringAttribute StringToStringAttribute(const std::string& string_attribute);

// ax::mojom::IntAttribute
AX_BASE_EXPORT const char* ToString(ax::mojom::IntAttribute int_attribute);
AX_BASE_EXPORT ax::mojom::IntAttribute StringToIntAttribute(const std::string& int_attribute);
...
AX_BASE_EXPORT ax::mojom::BoolAttribute StringToBoolAttribute(const std::string& bool_attribute);

// ax::mojom::IntListAttribute
AX_BASE_EXPORT const char* ToString(ax::mojom::IntListAttribute int_list_attribute);

// ax::mojom::StringListAttribute
AX_BASE_EXPORT const char* ToString(ax::mojom::StringListAttribute string_list_attribute);
...
AX_BASE_EXPORT const char* ToString(ax::mojom::WritingDirection writing_direction);
...
AX_BASE_EXPORT const char* ToString(ax::mojom::TextDecorationStyle text_decoration_style);

// ax::mojom::AriaCurrentState
AX_BASE_EXPORT const char* ToString(ax::mojom::AriaCurrentState aria_current_state);
...
AX_BASE_EXPORT const char* ToString(ax::mojom::DescriptionFrom description_from);
...
AX_BASE_EXPORT const char* ToString(ax::mojom::AriaNotificationInterrupt interrupt);

// ax::mojom::AriaNotificationPriority
AX_BASE_EXPORT const char* ToString(ax::mojom::AriaNotificationPriority priority);

template <typename T> std::optional<T> MaybeParseAXEnum(const char* attribute)
{
    static const base::NoDestructor<base::flat_map<std::string, T>> attr_map([] {
        ...
        entries.reserve(base::to_underlying(T::kMaxValue) - base::to_underlying(T::kMinValue) + 2);
        entries.push_back({ "", T::kNone });
        for (auto i = base::to_underlying(T::kMinValue); i <= base::to_underlying(T::kMaxValue); ++i) {
            T attr = T { i };
...
template <typename T> T ParseAXEnum(const char* attribute)
{
