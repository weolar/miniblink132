...
{
    std::string str;
    for (uint32_t i = static_cast<uint32_t>(ax::mojom::State::kNone) + 1; i <= static_cast<uint32_t>(ax::mojom::State::kMaxValue); ++i) {
...
{
    std::string str;
    for (uint32_t i = static_cast<uint32_t>(ax::mojom::Action::kNone) + 1; i <= static_cast<uint32_t>(ax::mojom::Action::kMaxValue); ++i) {
...
std::string VectorToString(const std::vector<ItemType>& items, ItemToStringFunction itemToStringFunction)
{
    std::string str;
...
{
    return VectorToString(items, [](const int32_t item) { return base::NumberToString(item); });
}

// Helper function that finds a key in a vector of pairs by matching on the
// first value, and returns an iterator.
template <typename FirstType, typename SecondType>
typename std::vector<std::pair<FirstType, SecondType>>::const_iterator FindInVectorOfPairs(
    FirstType first, const std::vector<std::pair<FirstType, SecondType>>& vector)
{
    return base::ranges::find(vector, first, &std::pair<FirstType, SecondType>::first);
}
...
const std::string& AXNodeData::GetStringAttribute(ax::mojom::StringAttribute attribute) const
{
    auto iter = FindInVectorOfPairs(attribute, string_attributes);
    return iter != string_attributes.end() ? iter->second : base::EmptyString();
}

std::u16string AXNodeData::GetString16Attribute(ax::mojom::StringAttribute attribute) const
{
...
const std::vector<int32_t>& AXNodeData::GetIntListAttribute(ax::mojom::IntListAttribute attribute) const
{
...
const std::vector<std::string>& AXNodeData::GetStringListAttribute(ax::mojom::StringListAttribute attribute) const
{
...
void AXNodeData::AddChildTreeId(const AXTreeID& tree_id)
{
    ...
    string_attributes.emplace_back(ax::mojom::StringAttribute::kChildTreeId, tree_id_str);
}
...
std::optional<AXTreeID> AXNodeData::GetChildTreeID() const
{
    ...
    const std::string& child_tree_id_str = GetStringAttribute(ax::mojom::StringAttribute::kChildTreeId);
    DCHECK(!child_tree_id_str.empty());
    return AXTreeID::FromString(child_tree_id_str);
}

void AXNodeData::AddBoolAttribute(ax::mojom::BoolAttribute attribute, bool value)
{
...
void AXNodeData::AddFloatAttribute(ax::mojom::FloatAttribute attribute, float value)
{
...
void AXNodeData::AddStringAttribute(ax::mojom::StringAttribute attribute, const std::string& value)
{
    DCHECK_NE(attribute, ax::mojom::StringAttribute::kNone);
    DCHECK_NE(attribute, ax::mojom::StringAttribute::kChildTreeId) << "Use AddChildTreeId.";
    if (HasStringAttribute(attribute))
        RemoveStringAttribute(attribute);
    string_attributes.emplace_back(attribute, value);
}

void AXNodeData::AddIntListAttribute(ax::mojom::IntListAttribute attribute, const std::vector<int32_t>& value)
{
...
void AXNodeData::AddStringListAttribute(ax::mojom::StringListAttribute attribute, const std::vector<std::string>& value)
{
...
{
    DCHECK_NE(attribute, ax::mojom::BoolAttribute::kNone);
    std::erase_if(bool_attributes, [attribute](const auto& bool_attribute) { return bool_attribute.first == attribute; });
}

void AXNodeData::RemoveIntAttribute(ax::mojom::IntAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::IntAttribute::kNone);
    std::erase_if(int_attributes, [attribute](const auto& int_attribute) { return int_attribute.first == attribute; });
}

void AXNodeData::RemoveFloatAttribute(ax::mojom::FloatAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::FloatAttribute::kNone);
    std::erase_if(float_attributes, [attribute](const auto& float_attribute) { return float_attribute.first == attribute; });
}

void AXNodeData::RemoveStringAttribute(ax::mojom::StringAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::StringAttribute::kNone);
    std::erase_if(string_attributes, [attribute](const auto& string_attribute) { return string_attribute.first == attribute; });
}

void AXNodeData::RemoveIntListAttribute(ax::mojom::IntListAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::IntListAttribute::kNone);
    std::erase_if(intlist_attributes, [attribute](const auto& intlist_attribute) { return intlist_attribute.first == attribute; });
}

void AXNodeData::RemoveStringListAttribute(ax::mojom::StringListAttribute attribute)
{
    DCHECK_NE(attribute, ax::mojom::StringListAttribute::kNone);
    std::erase_if(stringlist_attributes, [attribute](const auto& stringlist_attribute) { return stringlist_attribute.first == attribute; });
}
...
void AXNodeData::SetName(const std::string& name)
{
    ...
    DCHECK(name.empty() || (role != ax::mojom::Role::kNone && role != ax::mojom::Role::kUnknown))
        << "Cannot set name to '" << name << "' on class: '" << GetStringAttribute(ax::mojom::StringAttribute::kClassName)
        << "' because a valid role is needed to set the default NameFrom "
           "attribute. Set the role first.";

    auto iter = base::ranges::find(string_attributes, ax::mojom::StringAttribute::kName, &std::pair<ax::mojom::StringAttribute, std::string>::first);
    ...
    if (!name.empty() && GetNameFrom() == ax::mojom::NameFrom::kAttributeExplicitlyEmpty) {
...
void AXNodeData::SetNameChecked(const std::string& name)
{
    ...
    DCHECK_EQ(name.empty(), GetNameFrom() == ax::mojom::NameFrom::kAttributeExplicitlyEmpty)
        << "If the accessible name of Role::" << role << " class: '" << GetStringAttribute(ax::mojom::StringAttribute::kClassName)
...
void AXNodeData::SetDescription(const std::string& description)
{
    ...
    if (!description.empty() && GetDescriptionFrom() == ax::mojom::DescriptionFrom::kAttributeExplicitlyEmpty) {
        RemoveIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom);
    }

    DCHECK_EQ(description.empty(), GetDescriptionFrom() == ax::mojom::DescriptionFrom::kAttributeExplicitlyEmpty)
        << "If the accessible description of Role::" << role << " class: '" << GetStringAttribute(ax::mojom::StringAttribute::kClassName)
...
bool AXNodeData::HasTextStyle(ax::mojom::TextStyle text_style_enum) const
{
    ...
    return IsFlagSet(static_cast<uint32_t>(style), static_cast<uint32_t>(text_style_enum));
}

void AXNodeData::AddState(ax::mojom::State state_enum)
{
    DCHECK_GT(static_cast<int>(state_enum), static_cast<int>(ax::mojom::State::kNone));
    DCHECK_LE(static_cast<int>(state_enum), static_cast<int>(ax::mojom::State::kMaxValue));
...
void AXNodeData::AddAction(ax::mojom::Action action_enum)
{
    ...
    case ax::mojom::Action::kFocus: {
        ax::mojom::Action excluded_action = (action_enum == ax::mojom::Action::kBlur) ? ax::mojom::Action::kFocus : ax::mojom::Action::kBlur;
...
{
    DCHECK_GT(static_cast<int>(action_enum), static_cast<int>(ax::mojom::Action::kNone));
    DCHECK_LE(static_cast<int>(action_enum), static_cast<int>(ax::mojom::Action::kMaxValue));
...
{
    DCHECK_GE(static_cast<int>(text_style_enum), static_cast<int>(ax::mojom::TextStyle::kMinValue));
    DCHECK_LE(static_cast<int>(text_style_enum), static_cast<int>(ax::mojom::TextStyle::kMaxValue));
    int32_t style = GetIntAttribute(ax::mojom::IntAttribute::kTextStyle);
    style = ModifyFlag(static_cast<uint32_t>(style), static_cast<uint32_t>(text_style_enum), true);
...
{
    return static_cast<ax::mojom::CheckedState>(GetIntAttribute(ax::mojom::IntAttribute::kCheckedState));
}
...
void AXNodeData::SetCheckedState(ax::mojom::CheckedState checked_state)
{
    ...
    if (checked_state != ax::mojom::CheckedState::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kCheckedState, static_cast<int32_t>(checked_state));
    }
}
...
{
    return static_cast<ax::mojom::DefaultActionVerb>(GetIntAttribute(ax::mojom::IntAttribute::kDefaultActionVerb));
}

void AXNodeData::SetDefaultActionVerb(ax::mojom::DefaultActionVerb default_action_verb)
{
    ...
    if (default_action_verb != ax::mojom::DefaultActionVerb::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kDefaultActionVerb, static_cast<int32_t>(default_action_verb));
    }
}

ax::mojom::HasPopup AXNodeData::GetHasPopup() const
{
    return static_cast<ax::mojom::HasPopup>(GetIntAttribute(ax::mojom::IntAttribute::kHasPopup));
}
...
void AXNodeData::SetHasPopup(ax::mojom::HasPopup has_popup)
{
    ...
    if (has_popup != ax::mojom::HasPopup::kFalse) {
        AddIntAttribute(ax::mojom::IntAttribute::kHasPopup, static_cast<int32_t>(has_popup));
    }
}

ax::mojom::IsPopup AXNodeData::GetIsPopup() const
{
    return static_cast<ax::mojom::IsPopup>(GetIntAttribute(ax::mojom::IntAttribute::kIsPopup));
}
...
void AXNodeData::SetIsPopup(ax::mojom::IsPopup is_popup)
{
    ...
    if (is_popup != ax::mojom::IsPopup::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kIsPopup, static_cast<int32_t>(is_popup));
    }
}

ax::mojom::InvalidState AXNodeData::GetInvalidState() const
{
    return static_cast<ax::mojom::InvalidState>(GetIntAttribute(ax::mojom::IntAttribute::kInvalidState));
}
...
void AXNodeData::SetInvalidState(ax::mojom::InvalidState invalid_state)
{
    ...
    if (invalid_state != ax::mojom::InvalidState::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kInvalidState, static_cast<int32_t>(invalid_state));
    }
}

ax::mojom::NameFrom AXNodeData::GetNameFrom() const
{
    return static_cast<ax::mojom::NameFrom>(GetIntAttribute(ax::mojom::IntAttribute::kNameFrom));
}
...
void AXNodeData::SetNameFrom(ax::mojom::NameFrom name_from)
{
    ...
    if (name_from != ax::mojom::NameFrom::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kNameFrom, static_cast<int32_t>(name_from));
    }
}

ax::mojom::DescriptionFrom AXNodeData::GetDescriptionFrom() const
{
    return static_cast<ax::mojom::DescriptionFrom>(GetIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom));
}

void AXNodeData::SetDescriptionFrom(ax::mojom::DescriptionFrom description_from)
{
    if (HasIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom))
        RemoveIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom);
    if (description_from != ax::mojom::DescriptionFrom::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom, static_cast<int32_t>(description_from));
    }
}

ax::mojom::DetailsFrom AXNodeData::GetDetailsFrom() const
{
    return static_cast<ax::mojom::DetailsFrom>(GetIntAttribute(ax::mojom::IntAttribute::kDetailsFrom));
}
...
void AXNodeData::SetDetailsFrom(ax::mojom::DetailsFrom details_from)
{
    ...
    AddIntAttribute(ax::mojom::IntAttribute::kDetailsFrom, static_cast<int32_t>(details_from));
}

ax::mojom::TextPosition AXNodeData::GetTextPosition() const
{
    return static_cast<ax::mojom::TextPosition>(GetIntAttribute(ax::mojom::IntAttribute::kTextPosition));
}
...
void AXNodeData::SetTextPosition(ax::mojom::TextPosition text_position)
{
    ...
    if (text_position != ax::mojom::TextPosition::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kTextPosition, static_cast<int32_t>(text_position));
    }
}

ax::mojom::ImageAnnotationStatus AXNodeData::GetImageAnnotationStatus() const
{
    return static_cast<ax::mojom::ImageAnnotationStatus>(GetIntAttribute(ax::mojom::IntAttribute::kImageAnnotationStatus));
}

void AXNodeData::SetImageAnnotationStatus(ax::mojom::ImageAnnotationStatus status)
{
    ...
    if (status != ax::mojom::ImageAnnotationStatus::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kImageAnnotationStatus, static_cast<int32_t>(status));
    }
}

ax::mojom::Restriction AXNodeData::GetRestriction() const
{
    return static_cast<ax::mojom::Restriction>(GetIntAttribute(ax::mojom::IntAttribute::kRestriction));
}
...
void AXNodeData::SetRestriction(ax::mojom::Restriction restriction)
{
    ...
    if (restriction != ax::mojom::Restriction::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kRestriction, static_cast<int32_t>(restriction));
    }
}

ax::mojom::ListStyle AXNodeData::GetListStyle() const
{
    return static_cast<ax::mojom::ListStyle>(GetIntAttribute(ax::mojom::IntAttribute::kListStyle));
}
...
void AXNodeData::SetListStyle(ax::mojom::ListStyle list_style)
{
    ...
    if (list_style != ax::mojom::ListStyle::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kListStyle, static_cast<int32_t>(list_style));
    }
}

ax::mojom::TextAlign AXNodeData::GetTextAlign() const
{
    return static_cast<ax::mojom::TextAlign>(GetIntAttribute(ax::mojom::IntAttribute::kTextAlign));
}
...
void AXNodeData::SetTextAlign(ax::mojom::TextAlign text_align)
{
    ...
    AddIntAttribute(ax::mojom::IntAttribute::kTextAlign, static_cast<int32_t>(text_align));
}

ax::mojom::WritingDirection AXNodeData::GetTextDirection() const
{
    return static_cast<ax::mojom::WritingDirection>(GetIntAttribute(ax::mojom::IntAttribute::kTextDirection));
}
...
void AXNodeData::SetTextDirection(ax::mojom::WritingDirection text_direction)
{
    ...
    if (text_direction != ax::mojom::WritingDirection::kNone) {
        AddIntAttribute(ax::mojom::IntAttribute::kTextDirection, static_cast<int32_t>(text_direction));
    }
}
...
bool AXNodeData::IsActiveLiveRegionRoot() const
{
    ...
    const std::string& aria_live_status = GetStringAttribute(ax::mojom::StringAttribute::kLiveStatus);
...
bool AXNodeData::IsClickable() const
{
    ...
    if (HasIntAttribute(ax::mojom::IntAttribute::kDefaultActionVerb) && (GetDefaultActionVerb() != ax::mojom::DefaultActionVerb::kClickAncestor))
        return true;
...
bool AXNodeData::IsContainedInActiveLiveRegion() const
{
    ...
    const std::string& aria_container_live_status = GetStringAttribute(ax::mojom::StringAttribute::kContainerLiveStatus);

    return aria_container_live_status != "off" && HasStringAttribute(ax::mojom::StringAttribute::kName);
}

bool AXNodeData::IsSelectable() const
{
    // It's selectable if it has the attribute, whether it's true or false.
    return HasBoolAttribute(ax::mojom::BoolAttribute::kSelected) && GetRestriction() != ax::mojom::Restriction::kDisabled;
}
...
bool AXNodeData::IsInvocable() const
{
    ...
    return IsLink(role) || (IsClickable() && !IsActivatable() && !SupportsExpandCollapse() && !SupportsToggle(role));
}
...
bool AXNodeData::IsAtomicTextField() const
{
    ...
    return (ui::IsTextField(role) || IsSpinnerTextField()) && !GetBoolAttribute(ax::mojom::BoolAttribute::kNonAtomicTextFieldRoot);
}
...
bool AXNodeData::IsSpinnerTextField() const
{
    ...
    return !(HasState(ax::mojom::State::kRichlyEditable) && !GetBoolAttribute(ax::mojom::BoolAttribute::kNonAtomicTextFieldRoot));
}
...
{
    if (GetHasPopup() != ax::mojom::HasPopup::kFalse || HasState(ax::mojom::State::kExpanded) || HasState(ax::mojom::State::kCollapsed))
        return true;
...
std::string AXNodeData::ToString(bool verbose) const
{
    ...
    if (HasStringAttribute(ax::mojom::StringAttribute::kHtmlTag)) {
        result += base::StringPrintf(" <%s", GetStringAttribute(ax::mojom::StringAttribute::kHtmlTag).c_str());
        if (HasStringAttribute(ax::mojom::StringAttribute::kClassName)) {
            result += base::StringPrintf(".%s", GetStringAttribute(ax::mojom::StringAttribute::kClassName).c_str());
        }
        if (HasStringAttribute(ax::mojom::StringAttribute::kHtmlId)) {
            const std::string& id_attr = GetStringAttribute(ax::mojom::StringAttribute::kHtmlId);
            result += base::StringPrintf("#%s", id_attr.c_str());
        }
        result += ">";
    } else if (HasStringAttribute(ax::mojom::StringAttribute::kClassName)) {
        result += " class_name=" + GetStringAttribute(ax::mojom::StringAttribute::kClassName);
    }
    ...
    if (!ui::IsText(role) && HasIntAttribute(ax::mojom::IntAttribute::kNameFrom)) {
        result += " name_from=";
        result += ui::ToString(static_cast<ax::mojom::NameFrom>(GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)));
    }
    ...
    for (const std::pair<ax::mojom::IntAttribute, int32_t>& int_attribute : int_attributes) {
        std::string value = base::NumberToString(int_attribute.second);
        switch (int_attribute.first) {
        case ax::mojom::IntAttribute::kDefaultActionVerb:
            result += std::string(" action=") + ui::ToString(static_cast<ax::mojom::DefaultActionVerb>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kScrollX:
        ...
        case ax::mojom::IntAttribute::kDescriptionFrom:
            ...
            result += ui::ToString(static_cast<ax::mojom::DescriptionFrom>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kDetailsFrom:
            result += " details_from=";
            result += ui::ToString(static_cast<ax::mojom::DetailsFrom>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kActivedescendantId:
        ...
        case ax::mojom::IntAttribute::kColorValue:
            ...
            break;
        case ax::mojom::IntAttribute::kAriaCurrentState:
            switch (static_cast<ax::mojom::AriaCurrentState>(int_attribute.second)) {
            ...
            break;
        case ax::mojom::IntAttribute::kBackgroundColor:
            result += base::StringPrintf(" background_color=&%X", int_attribute.second);
            break;
        case ax::mojom::IntAttribute::kColor:
        ...
        case ax::mojom::IntAttribute::kTextAlign:
            result += " text_align=";
            result += ui::ToString(static_cast<ax::mojom::TextAlign>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kTextDirection:
            switch (static_cast<ax::mojom::WritingDirection>(int_attribute.second)) {
        ...
        case ax::mojom::IntAttribute::kTextOverlineStyle:
            result += std::string(" text_overline_style=") + ui::ToString(static_cast<ax::mojom::TextDecorationStyle>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kTextStrikethroughStyle:
            result += std::string(" text_strikethrough_style=") + ui::ToString(static_cast<ax::mojom::TextDecorationStyle>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kTextUnderlineStyle:
            result += std::string(" text_underline_style=") + ui::ToString(static_cast<ax::mojom::TextDecorationStyle>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kSetSize:
        ...
        case ax::mojom::IntAttribute::kPreviousWindowFocusId:
            ...
            break;
        case ax::mojom::IntAttribute::kImageAnnotationStatus:
            result += std::string(" image_annotation_status=") + ui::ToString(static_cast<ax::mojom::ImageAnnotationStatus>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kDropeffectDeprecated:
        ...
        case ax::mojom::IntAttribute::kDOMNodeIdDeprecated:
            break;
        case ax::mojom::IntAttribute::kAriaNotificationInterruptDeprecated:
            result += std::string(" aria_notification_interrupt=") + ui::ToString(static_cast<ax::mojom::AriaNotificationInterrupt>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kAriaNotificationPriorityDeprecated:
            result += std::string(" aria_notification_priority=") + ui::ToString(static_cast<ax::mojom::AriaNotificationPriority>(int_attribute.second));
            break;
        case ax::mojom::IntAttribute::kMaxLength:
    ...
    for (const std::pair<ax::mojom::StringAttribute, std::string>& string_attribute : string_attributes) {
        ...
        case ax::mojom::StringAttribute::kImageDataUrl:
            result += " image_data_url=(" + base::NumberToString(static_cast<int>(value.size())) + " bytes)";
            break;
    ...
    for (const std::pair<ax::mojom::FloatAttribute, float>& float_attribute : float_attributes) {
    ...
    for (const std::pair<ax::mojom::BoolAttribute, bool>& bool_attribute : bool_attributes) {
    ...
    for (const std::pair<ax::mojom::IntListAttribute, std::vector<int32_t>>& intlist_attribute : intlist_attributes) {
        ...
        case ax::mojom::IntListAttribute::kMarkerTypes: {
            std::string types_str = VectorToString(values, [](const int32_t type) {
                ...
                if (type & static_cast<int32_t>(ax::mojom::MarkerType::kTextMatch))
                    type_str += "text_match&";
                if (type & static_cast<int32_t>(ax::mojom::MarkerType::kActiveSuggestion))
        ...
        case ax::mojom::IntListAttribute::kMarkerEnds:
            ...
            break;
        case ax::mojom::IntListAttribute::kHighlightTypes: {
            std::string highlight_types_str = VectorToString(values, [](const int32_t highlight_type) {
                if (static_cast<ax::mojom::HighlightType>(highlight_type) == ax::mojom::HighlightType::kNone)
                    return "";
                return ui::ToString(static_cast<ax::mojom::HighlightType>(highlight_type));
            });
        ...
        case ax::mojom::IntListAttribute::kTextOperationEndOffsets:
            ...
            break;
        case ax::mojom::IntListAttribute::kTextOperationStartAnchorIds:
            result += " text_operation_start_anchor_ids=" + IntVectorToString(values);
            break;
        case ax::mojom::IntListAttribute::kTextOperationEndAnchorIds:
        ...
        case ax::mojom::IntListAttribute::kAriaNotificationInterruptProperties:
            result += " aria_notification_interrupt_properties="
                + VectorToString(values, [](int32_t interrupt) { return ui::ToString(static_cast<ax::mojom::AriaNotificationInterrupt>(interrupt)); });
            break;
        case ax::mojom::IntListAttribute::kAriaNotificationPriorityProperties:
            result += " aria_notification_priority_properties="
                + VectorToString(values, [](int32_t priority) { return ui::ToString(static_cast<ax::mojom::AriaNotificationPriority>(priority)); });
            break;
        }
    }

    for (const std::pair<ax::mojom::StringListAttribute, std::vector<std::string>>& stringlist_attribute : stringlist_attributes) {
        ...
        case ax::mojom::StringListAttribute::kAriaNotificationAnnouncements:
            result += " aria_notification_announcements=" + base::JoinString(values, ",");
            break;
        ...
        case ax::mojom::StringListAttribute::kCustomActionDescriptions:
            result += " custom_action_descriptions=" + base::JoinString(values, ",");
            break;
    ...
    for (const std::pair<std::string, std::string>& string_pair : html_attributes) {
...
{
    // Simple fields.
    size_t total_size = sizeof(id) + sizeof(role) + sizeof(state) + sizeof(actions) + sizeof(relative_bounds);
...
void AXNodeData::AccumulateSize(AXNodeData::AXNodeDataSize& node_data_size) const
{
    node_data_size.int_attribute_size += int_attributes.size() * (sizeof(ax::mojom::IntAttribute) + sizeof(int32_t));
    node_data_size.float_attribute_size += float_attributes.size() * (sizeof(ax::mojom::FloatAttribute) + sizeof(float));
    node_data_size.bool_attribute_size += bool_attributes.size() * (sizeof(ax::mojom::BoolAttribute) + sizeof(bool));
    node_data_size.child_ids_size = child_ids.size() * sizeof(int32_t);

    for (const auto& pair : string_attributes) {
        node_data_size.string_attribute_size += sizeof(ax::mojom::StringAttribute) + pair.second.size() * sizeof(char);
    }

    for (const auto& pair : intlist_attributes) {
        node_data_size.int_list_attribhute_size += sizeof(ax::mojom::IntListAttribute) + pair.second.size() * sizeof(int32_t);
    }

    for (const auto& pair : stringlist_attributes) {
        node_data_size.string_list_attribute_size += sizeof(ax::mojom::StringListAttribute);
    ...
    for (const auto& pair : html_attributes) {
        node_data_size.html_attribute_size += pair.first.size() * sizeof(char) + pair.second.size() * sizeof(char);
    }
}

size_t AXNodeData::AXNodeDataSize::ByteSize() const
{
    return int_attribute_size + float_attribute_size + bool_attribute_size + string_attribute_size + int_list_attribhute_size + string_list_attribute_size
        + html_attribute_size + child_ids_size;
}
