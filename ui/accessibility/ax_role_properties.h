...
// children.
AX_BASE_EXPORT bool IsContainerWithSelectableChildren(const ax::mojom::Role role);
...
AX_BASE_EXPORT bool ShouldHaveReadonlyStateByDefault(const ax::mojom::Role role);
...
AX_BASE_EXPORT bool SupportsArrowKeysForExpandCollapse(const ax::mojom::Role role);
