...
class AXPositionPerfTest : public ::testing::Test, public TestSingleAXTreeManager {
public:
...
void AXPositionPerfTest::SetUp()
{
    ...
    constexpr int kNumberOfStaticTextNodes = kNumberOfGroups * kStaticTextNodesPerGroup;

    constexpr int kGroupNodesStartIndex = 1;
    constexpr int kStaticTextNodesStartIndex = kGroupNodesStartIndex + kNumberOfGroups;
    ...
    for (int text_index = 0; text_index < kNumberOfStaticTextNodes; ++text_index) {
...
TEST_F(AXPositionPerfTest, AsTreePositionFromTextPosition)
{
    TestPositionType text_position = CreateTextPosition(
        /*anchor_id=*/1, /*text_offset=*/103, ax::mojom::TextAffinity::kDownstream);
...
{
    TestPositionType tree_position = CreateTreePosition(*ax_tree()->root(), /*child_index=*/4);
...
TEST_F(AXPositionPerfTest, CompareTextPositions)
{
    ...
    TestPositionType text_position_2 = CreateTextPosition(
        /*anchor_id=*/27, /*text_offset=*/1, ax::mojom::TextAffinity::kDownstream);
