...
AXLocationChange& AXLocationChange::operator=(AXLocationChange&& other) = default;
AXLocationChange::AXLocationChange(const AXLocationChange& other) = default;
AXLocationChange& AXLocationChange::operator=(const AXLocationChange& other) = default;
...
AXScrollChange& AXScrollChange::operator=(const AXScrollChange& other) = default;
AXScrollChange::~AXScrollChange() = default;

AXLocationAndScrollUpdates::AXLocationAndScrollUpdates() = default;
AXLocationAndScrollUpdates::AXLocationAndScrollUpdates(AXLocationAndScrollUpdates&& other) = default;
AXLocationAndScrollUpdates& AXLocationAndScrollUpdates::operator=(AXLocationAndScrollUpdates&& other) = default;
AXLocationAndScrollUpdates::~AXLocationAndScrollUpdates() = default;
} // namespace ui
