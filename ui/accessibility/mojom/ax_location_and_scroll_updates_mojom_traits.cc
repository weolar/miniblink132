...
// static
bool StructTraits<ax::mojom::AXLocationChangeDataView, ui::AXLocationChange>::Read(ax::mojom::AXLocationChangeDataView data, ui::AXLocationChange* out)
{
    out->id = data.id();
...
bool StructTraits<ax::mojom::AXScrollChangeDataView, ui::AXScrollChange>::Read(ax::mojom::AXScrollChangeDataView data, ui::AXScrollChange* out)
{
    out->id = data.id();
...
bool StructTraits<ax::mojom::AXLocationAndScrollUpdatesDataView, ui::AXLocationAndScrollUpdates>::Read(
    ax::mojom::AXLocationAndScrollUpdatesDataView data, ui::AXLocationAndScrollUpdates* out)
{
