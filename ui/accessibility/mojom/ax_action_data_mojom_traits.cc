...
// static
bool StructTraits<ax::mojom::AXActionDataDataView, ui::AXActionData>::Read(ax::mojom::AXActionDataDataView data, ui::AXActionData* out)
{
    ...
    if (data.target_node_id() != ui::kInvalidAXNodeID && data.target_role() != ax::mojom::Role::kUnknown) {
    ...
    return data.ReadTargetRect(&out->target_rect) && data.ReadTargetPoint(&out->target_point) && data.ReadValue(&out->value)
