...
template <> struct StructTraits<ax::mojom::AXUpdatesAndEventsDataView, ui::AXUpdatesAndEvents> {
    static const ui::AXTreeID& tree_id(const ui::AXUpdatesAndEvents& p)
    {
        return p.ax_tree_id;
    }
    static const std::vector<ui::AXTreeUpdate>& updates(const ui::AXUpdatesAndEvents& p)
    {
        return p.updates;
    }
    static const std::vector<ui::AXEvent>& events(const ui::AXUpdatesAndEvents& p)
    {
        return p.events;
    }
    static bool Read(ax::mojom::AXUpdatesAndEventsDataView data, ui::AXUpdatesAndEvents* out);
};
