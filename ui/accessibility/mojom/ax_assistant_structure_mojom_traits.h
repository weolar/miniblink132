...
template <> struct StructTraits<ax::mojom::AssistantTreeDataView, std::unique_ptr<ui::AssistantTree>> {
    ...
    static const std::vector<std::unique_ptr<ui::AssistantNode>>& nodes(const std::unique_ptr<ui::AssistantTree>& tree)
    {
        return tree->nodes;
    }
    static bool Read(ax::mojom::AssistantTreeDataView data, std::unique_ptr<ui::AssistantTree>* out);
};

template <> struct StructTraits<ax::mojom::AssistantNodeDataView, std::unique_ptr<ui::AssistantNode>> {
    static const std::vector<int32_t>& children_indices(const std::unique_ptr<ui::AssistantNode>& node)
    {
        return node->children_indices;
    }
    static const gfx::Rect& unclipped_rect(const std::unique_ptr<ui::AssistantNode>& node)
    {
    ...
    static const std::u16string& text(const std::unique_ptr<ui::AssistantNode>& node)
    {
        return node->text;
    }
    ...
    static const std::optional<gfx::Range>& selection(const std::unique_ptr<ui::AssistantNode>& node)
    {
        return node->selection;
    }
    static const std::string& class_name(const std::unique_ptr<ui::AssistantNode>& node)
    {
        return node->class_name;
    }
    static const std::optional<std::string>& role(const std::unique_ptr<ui::AssistantNode>& node)
    {
        return node->role;
    }
    static bool Read(ax::mojom::AssistantNodeDataView data, std::unique_ptr<ui::AssistantNode>* out);
};
