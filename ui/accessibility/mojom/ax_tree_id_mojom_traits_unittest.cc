...
TEST(AXTreeIDMojomTraitsTest, TestSerializeAndDeserializeAXTreeID)
{
    ...
    EXPECT_TRUE(SerializeAndDeserialize<ax::mojom::AXTreeID>(empty_input, empty_output));
    ...
    EXPECT_TRUE(SerializeAndDeserialize<ax::mojom::AXTreeID>(unknown_input, unknown_output));
    ...
    EXPECT_TRUE(SerializeAndDeserialize<ax::mojom::AXTreeID>(token_input, token_output));
