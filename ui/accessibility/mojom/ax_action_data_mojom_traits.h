...
template <> struct StructTraits<ax::mojom::AXActionDataDataView, ui::AXActionData> {
    ...
    static int32_t request_id(const ui::AXActionData& a)
    {
        return a.request_id;
    }
    static int32_t flags(const ui::AXActionData& a)
    {
        return a.flags;
    }
    ...
    static const std::string& value(const ui::AXActionData& a)
    {
        return a.value;
    }
    ...
    static ax::mojom::ScrollAlignment horizontal_scroll_alignment(const ui::AXActionData& a)
    {
        return a.horizontal_scroll_alignment;
    }
    static ax::mojom::ScrollAlignment vertical_scroll_alignment(const ui::AXActionData& a)
    {
    ...
    static const std::optional<ui::AXTreeID> child_tree_id(const ui::AXActionData& a)
    {
