...
TEST(AXEventMojomTraitsTest, RoundTrip)
{
    ...
    editing_intent.input_event_type = ax::mojom::InputEventType::kDeleteWordForward;
    ...
    const std::vector<ui::AXEventIntent> event_intents { editing_intent, selection_intent };
