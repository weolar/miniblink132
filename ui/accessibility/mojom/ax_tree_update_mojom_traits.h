...
template <> struct StructTraits<ax::mojom::AXTreeUpdateDataView, ui::AXTreeUpdate> {
    ...
    static int32_t root_id(const ui::AXTreeUpdate& p)
    {
        return p.root_id;
    }
    ...
    static const std::vector<ui::AXEventIntent>& event_intents(const ui::AXTreeUpdate& p)
    {
        return p.event_intents;
    }

    static const std::optional<ui::AXTreeChecks> tree_checks(const ui::AXTreeUpdate& p)
    {
