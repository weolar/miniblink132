...
template <> struct StructTraits<ax::mojom::AXTreeDataDataView, ui::AXTreeData> {
    ...
    static bool loaded(const ui::AXTreeData& p)
    {
        return p.loaded;
    }
    ...
    static const std::string& title(const ui::AXTreeData& p)
    {
        return p.title;
    }
    static const std::string& url(const ui::AXTreeData& p)
    {
        return p.url;
    }
    static int32_t focus_id(const ui::AXTreeData& p)
    {
        return p.focus_id;
    }
