...
public:
    ...
    void SetAXTreeID(const AXTreeID& ax_tree_id, AXActionHandlerBase* action_handler);
...
private:
    ...
    std::map<AXTreeID, raw_ptr<AXActionHandlerBase, CtnExperimental>> id_to_action_handler_;
