...
protected:
    ...
    std::unique_ptr<AXTree> CreateMultipageDocument(AXNodeData& root_data, AXNodeData& page_1_data, AXNodeData& page_1_text_data, AXNodeData& page_2_data,
        AXNodeData& page_2_text_data, AXNodeData& page_3_data, AXNodeData& page_3_text_data) const;
    ...
    void CreateBrowserWindow(AXNodeData& window, AXNodeData& back_button, AXNodeData& web_view, AXNodeData& root_web_area, AXNodeData& iframe_root,
        AXNodeData& paragraph, AXNodeData& address_bar, std::vector<TestSingleAXTreeManager>& out_managers) const;

    // Creates a document with three static text objects each containing text in a
    // different language.
    std::unique_ptr<AXTree> CreateMultilingualDocument(std::vector<int>* text_offsets) const;

    void AssertTextLengthEquals(const AXNodeID& node_id, int expected_text_length) const;

    // Creates a new AXTree from a vector of nodes.
    // Assumes the first node in the vector is the root.
    std::unique_ptr<AXTree> CreateAXTree(const std::vector<AXNodeData>& nodes, const AXTreeID& parent_tree_id = AXTreeID()) const;
...
class AXPositionExpandToEnclosingTextBoundaryTestWithParam : public AXPositionTest,
                                                             public ::testing::WithParamInterface<ExpandToEnclosingTextBoundaryTestParam> {
public:
    AXPositionExpandToEnclosingTextBoundaryTestWithParam() = default;

    AXPositionExpandToEnclosingTextBoundaryTestWithParam(const AXPositionExpandToEnclosingTextBoundaryTestWithParam&) = delete;
    AXPositionExpandToEnclosingTextBoundaryTestWithParam& operator=(const AXPositionExpandToEnclosingTextBoundaryTestWithParam&) = delete;
...
class AXPositionCreatePositionAtTextBoundaryTestWithParam : public AXPositionTest, public ::testing::WithParamInterface<CreatePositionAtTextBoundaryTestParam> {
public:
    AXPositionCreatePositionAtTextBoundaryTestWithParam() = default;

    AXPositionCreatePositionAtTextBoundaryTestWithParam(const AXPositionCreatePositionAtTextBoundaryTestWithParam&) = delete;
    AXPositionCreatePositionAtTextBoundaryTestWithParam& operator=(const AXPositionCreatePositionAtTextBoundaryTestWithParam&) = delete;
...
class AXPositionTextNavigationTestWithParam : public AXPositionTest, public ::testing::WithParamInterface<TextNavigationTestParam> {
public:
    AXPositionTextNavigationTestWithParam() = default;

    AXPositionTextNavigationTestWithParam(const AXPositionTextNavigationTestWithParam&) = delete;
    AXPositionTextNavigationTestWithParam& operator=(const AXPositionTextNavigationTestWithParam&) = delete;
...
AXPositionTest::AXPositionTest()
    : ax_embedded_object_behaviour_(AXEmbeddedObjectBehavior::kSuppressCharacter)
{
}
...
void AXPositionTest::SetUp()
{
    ...
    window.AddStringAttribute(ax::mojom::StringAttribute::kClassName, "BrowserRootView");
    ...
    non_client_view.AddStringAttribute(ax::mojom::StringAttribute::kClassName, "NonClientView");
    ...
    web_view.AddStringAttribute(ax::mojom::StringAttribute::kClassName, "WebView");
    non_client_view.child_ids = { web_view.id };

    std::unique_ptr<AXTree> views_tree = CreateAXTree({ window, non_client_view, web_view });
    ...
    button_.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    check_box_.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    text_field_.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    text_field_.AddState(ax::mojom::State::kEditable);
    text_field_.SetValue(TEXT_VALUE);
    text_field_.AddIntListAttribute(ax::mojom::IntListAttribute::kLineStarts, std::vector<int32_t> { 0, 7 });
    ...
    static_text1_.AddIntAttribute(ax::mojom::IntAttribute::kTextStyle, static_cast<int32_t>(ax::mojom::TextStyle::kBold));

    inline_box1_.role = ax::mojom::Role::kInlineTextBox;
    inline_box1_.AddState(ax::mojom::State::kEditable);
    inline_box1_.SetName("Line 1");
    inline_box1_.AddIntListAttribute(ax::mojom::IntListAttribute::kSentenceStarts, { 0 });
    inline_box1_.AddIntListAttribute(ax::mojom::IntListAttribute::kSentenceEnds, { 6 });
    inline_box1_.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 0, 5 });
    inline_box1_.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 4, 6 });
    inline_box1_.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, line_break_.id);

    line_break_.role = ax::mojom::Role::kLineBreak;
    line_break_.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    line_break_.AddState(ax::mojom::State::kEditable);
    line_break_.SetName("\n");
    line_break_.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, inline_box1_.id);
    ...
    inline_box2_.AddIntListAttribute(ax::mojom::IntListAttribute::kSentenceStarts, { 0 });
    inline_box2_.AddIntListAttribute(ax::mojom::IntListAttribute::kSentenceEnds, { 6 });
    inline_box2_.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 0, 5 });
    inline_box2_.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 4, 6 });

    AXTreeUpdate initial_state;
    initial_state.root_id = 1;
    initial_state.nodes = { root_, button_, check_box_, text_field_, static_text1_, inline_box1_, line_break_, static_text2_, inline_box2_ };
...
std::unique_ptr<AXTree> AXPositionTest::CreateMultipageDocument(AXNodeData& root_data, AXNodeData& page_1_data, AXNodeData& page_1_text_data,
    AXNodeData& page_2_data, AXNodeData& page_2_text_data, AXNodeData& page_3_data, AXNodeData& page_3_text_data) const
{
    root_data.id = 1;
    ...
    page_1_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsPageBreakingObject, true);

    page_1_text_data.id = 3;
    page_1_text_data.role = ax::mojom::Role::kStaticText;
    page_1_text_data.SetName("some text on page 1");
    page_1_text_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    page_1_data.child_ids = { 3 };

    page_2_data.id = 4;
    page_2_data.role = ax::mojom::Role::kRegion;
    page_2_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsPageBreakingObject, true);

    page_2_text_data.id = 5;
    page_2_text_data.role = ax::mojom::Role::kStaticText;
    page_2_text_data.SetName("some text on page 2");
    page_2_text_data.AddIntAttribute(ax::mojom::IntAttribute::kTextStyle, static_cast<int32_t>(ax::mojom::TextStyle::kBold));
    page_2_data.child_ids = { 5 };

    page_3_data.id = 6;
    page_3_data.role = ax::mojom::Role::kRegion;
    page_3_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsPageBreakingObject, true);
    ...
    return CreateAXTree({ root_data, page_1_data, page_1_text_data, page_2_data, page_2_text_data, page_3_data, page_3_text_data });
}

void AXPositionTest::CreateBrowserWindow(AXNodeData& window, AXNodeData& back_button, AXNodeData& web_view, AXNodeData& root_web_area, AXNodeData& iframe_root,
    AXNodeData& paragraph, AXNodeData& address_bar, std::vector<TestSingleAXTreeManager>& out_managers) const
{
    // First tree: Views.
    window.id = 1;
    ...
    browser_view.AddStringAttribute(ax::mojom::StringAttribute::kClassName, "BrowserView");

    AXNodeData toolbar;
    toolbar.id = 4;
    toolbar.role = ax::mojom::Role::kPane;
    toolbar.AddStringAttribute(ax::mojom::StringAttribute::kClassName, "ToolbarView");
    ...
    back_button.AddStringAttribute(ax::mojom::StringAttribute::kClassName, "ToolbarButton");
    ...
    address_bar.AddStringAttribute(ax::mojom::StringAttribute::kAutoComplete, "both");
    address_bar.AddStringAttribute(ax::mojom::StringAttribute::kClassName, "OmniboxViewViews");
    ...
    root_web_area.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);

    AXNodeData iframe;
    iframe.id = 2;
    iframe.role = ax::mojom::Role::kIframe;
    iframe.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);

    paragraph.id = 3;
    paragraph.role = ax::mojom::Role::kParagraph;
    paragraph.SetName("After iframe");
    paragraph.SetNameFrom(ax::mojom::NameFrom::kContents);
    paragraph.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    iframe_root.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);

    std::unique_ptr<AXTree> views_tree = CreateAXTree({ window, non_client_view, browser_view, toolbar, back_button, web_view, address_bar });
    std::unique_ptr<AXTree> webpage_tree = CreateAXTree({ root_web_area, iframe, paragraph }, views_tree->GetAXTreeID());
    std::unique_ptr<AXTree> iframe_tree = CreateAXTree({ iframe_root }, webpage_tree->GetAXTreeID());
...
std::unique_ptr<AXTree> AXPositionTest::CreateMultilingualDocument(std::vector<int>* text_offsets) const
{
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        EXPECT_EQ(1u, grapheme.length()) << "All English characters should be one UTF16 code unit in length.";
        text_offsets->push_back(text_offsets->back() + static_cast<int>(grapheme.length()));
    ...
    for (int i = 5; i < 8; ++i) {
        std::u16string grapheme = base::WideToUTF16(kGraphemeClusters[i]);
        EXPECT_LT(0u, grapheme.length()) << "One of the Thai characters should be one UTF16 code unit, "
...
void AXPositionTest::AssertTextLengthEquals(const AXNodeID& node_id, int expected_text_length) const
{
    TestPositionType text_position = CreateTextPosition(node_id, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(expected_text_length, text_position->MaxTextOffset());
    ASSERT_EQ(expected_text_length, static_cast<int>(text_position->GetText().length()));
}

std::unique_ptr<AXTree> AXPositionTest::CreateAXTree(const std::vector<AXNodeData>& nodes, const AXTreeID& parent_tree_id) const
{
...
TEST_F(AXPositionTest, DISABLED_Clone)
{
    ...
    TestPositionType tree_position = CreateTreePosition(root_, 0 /* child_index */);
    ...
    EXPECT_DEATH_IF_SUPPORTED(CreateTreePosition(root_, AXNodePosition::BEFORE_TEXT), "Creating invalid positions is disallowed.");

    TestPositionType text_position = CreateTextPosition(text_field_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(text_field_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    copy_position = text_position->Clone();
    ASSERT_NE(nullptr, copy_position);
...
TEST_F(AXPositionTest, Serialize)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType copy_position = AXNodePosition::Unserialize(null_position->Serialize());
    ASSERT_NE(nullptr, copy_position);
    EXPECT_TRUE(copy_position->IsNullPosition());

    TestPositionType tree_position = CreateTreePosition(root_, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
...
TEST_F(AXPositionTest, ToString)
{
    ...
    root_data.child_ids = { static_text_data_1.id, static_text_data_2.id, static_text_data_3.id };

    SetTree(CreateAXTree({ root_data, static_text_data_1, static_text_data_2, static_text_data_3 }));

    TestPositionType text_position_1 = CreateTextPosition(root_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_1->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=1 text_offset=0 affinity=downstream "
              "annotated_text=<s>ome text\xEF\xBF\xBCmore text",
        text_position_1->ToString());

    TestPositionType text_position_2 = CreateTextPosition(root_data, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_2->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=1 text_offset=5 affinity=downstream "
              "annotated_text=some <t>ext\xEF\xBF\xBCmore text",
        text_position_2->ToString());

    TestPositionType text_position_3 = CreateTextPosition(root_data, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_3->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=1 text_offset=9 affinity=downstream "
              "annotated_text=some text<\xEF\xBF\xBC>more text",
        text_position_3->ToString());

    TestPositionType text_position_4 = CreateTextPosition(root_data, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_4->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=1 text_offset=10 affinity=downstream "
              "annotated_text=some text\xEF\xBF\xBC<m>ore text",
        text_position_4->ToString());

    TestPositionType text_position_5 = CreateTextPosition(root_data, 19 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_5->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=1 text_offset=19 affinity=downstream "
              "annotated_text=some text\xEF\xBF\xBCmore text<>",
        text_position_5->ToString());

    TestPositionType text_position_6 = CreateTextPosition(static_text_data_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_6->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=3 text_offset=0 affinity=downstream "
              "annotated_text=<\xEF\xBF\xBC>",
        text_position_6->ToString());

    TestPositionType text_position_7 = CreateTextPosition(static_text_data_2, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_7->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=3 text_offset=1 affinity=downstream "
              "annotated_text=\xEF\xBF\xBC<>",
        text_position_7->ToString());

    TestPositionType text_position_8 = CreateTextPosition(static_text_data_3, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_8->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=4 text_offset=0 affinity=downstream "
              "annotated_text=<m>ore text",
        text_position_8->ToString());

    TestPositionType text_position_9 = CreateTextPosition(static_text_data_3, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_9->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=4 text_offset=5 affinity=downstream "
              "annotated_text=more <t>ext",
        text_position_9->ToString());

    TestPositionType text_position_10 = CreateTextPosition(static_text_data_3, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_10->IsTextPosition());
    EXPECT_EQ("TextPosition anchor_id=4 text_offset=9 affinity=downstream "
...
TEST_F(AXPositionTest, DISABLED_IsIgnored)
{
    ...
    SetTree(CreateAXTree({ root_data, static_text_data_1, inline_box_data_1, container_data, static_text_data_2, inline_box_data_2 }));
    ...
    TestPositionType text_position_3 = CreateTextPosition(root_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_3->IsTextPosition());
    ...
    TestPositionType text_position_4 = CreateTextPosition(root_data, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_4->IsTextPosition());
    // Same as above.
    ...
    // ignored.
    TestPositionType text_position_5 = CreateTextPosition(container_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_5->IsTextPosition());
    ...
    TestPositionType text_position_7 = CreateTextPosition(inline_box_data_1, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position_7->IsTextPosition());
    ...
    TestPositionType tree_position_1 = CreateTreePosition(root_data, 0 /* child_index */);
    ...
    TestPositionType tree_position_2 = CreateTreePosition(root_data, 1 /* child_index */);
    ...
    TestPositionType tree_position_3 = CreateTreePosition(inline_box_data_1, 0 /* child_index */);
    ...
    TestPositionType tree_position_4 = CreateTreePosition(inline_box_data_1, AXNodePosition::BEFORE_TEXT);
    ...
    TestPositionType tree_position_5 = CreateTreePosition(root_data, 2 /* child_index */);
    ...
    // node's children.
    EXPECT_DEATH_IF_SUPPORTED(CreateTreePosition(static_text_data_1, AXNodePosition::BEFORE_TEXT), "Creating invalid positions is disallowed.");
}
...
{
    TestPositionType text_position = CreateTextPosition(root_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(button_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(u"", text_position->GetText());
}
...
{
    TestPositionType text_position = CreateTextPosition(check_box_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(u"", text_position->GetText());
}
...
{
    TestPositionType text_position = CreateTextPosition(static_text1_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(u"Line 1", text_position->GetText());
}
...
{
    TestPositionType text_position = CreateTextPosition(line_break_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    // "Line <1>".
    TestPositionType text_field_position = CreateTextPosition(text_field_, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_FALSE(text_field_position->IsPointingToLineBreak());
    // "Line 1<>".
    TestPositionType static_text1_position = CreateTextPosition(static_text1_, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, static_text1_position);
    EXPECT_FALSE(static_text1_position->IsPointingToLineBreak());
    // Before the line break.
    text_field_position = CreateTextPosition(text_field_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_TRUE(text_field_position->IsPointingToLineBreak());
    // After the line break.
    text_field_position = CreateTextPosition(text_field_, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_FALSE(text_field_position->IsPointingToLineBreak());
    text_field_position = CreateTextPosition(text_field_, 7 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_field_position);
    EXPECT_TRUE(text_field_position->IsPointingToLineBreak());

    TestPositionType line_break_position = CreateTextPosition(line_break_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, line_break_position);
    EXPECT_TRUE(line_break_position->IsPointingToLineBreak());
    line_break_position = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, line_break_position);
    EXPECT_TRUE(line_break_position->IsPointingToLineBreak());
    // An upstream affinity should not matter on leaf nodes.
    line_break_position = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, line_break_position);
    EXPECT_TRUE(line_break_position->IsPointingToLineBreak());
    ...
    TestPositionType root_data_position = CreateTextPosition(root_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_data_position);
    EXPECT_FALSE(root_data_position->IsPointingToLineBreak());
    root_data_position = CreateTextPosition(root_data, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_data_position);
    EXPECT_TRUE(root_data_position->IsPointingToLineBreak());
    root_data_position = CreateTextPosition(root_data, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_data_position);
    EXPECT_FALSE(root_data_position->IsPointingToLineBreak());
}
...
{
    TestPositionType button_position = CreateTextPosition(button_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    EXPECT_FALSE(button_position->IsInWhiteSpace()) << "Positions anchored to nodes with no text in them should not be "
    ...
    TestPositionType text_field_position = CreateTextPosition(text_field_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
...
TEST_F(AXPositionTest, GetMaxTextOffsetAndGetTextWithGeneratedContent)
{
    ...
    SetTree(CreateAXTree({ root_1, text_field_2, static_text_3, inline_box_4, static_text_5, inline_box_6 }));

    TestPositionType text_position = CreateTextPosition(text_field_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsTextPosition());
    EXPECT_EQ(38, text_position->MaxTextOffset());
    EXPECT_EQ(u"Placeholder from generated content3.14", text_position->GetText());
}
...
TEST_F(AXPositionTest, AtStartOfAnchorWithTextPosition)
{
    ...
    text_position = CreateTextPosition(inline_box1_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfAnchor());

    text_position = CreateTextPosition(inline_box1_, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfAnchor());
}
...
{
    TestPositionType tree_position = CreateTreePosition(root_, 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtEndOfAnchor());

    text_position = CreateTextPosition(inline_box1_, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfAnchor());

    text_position = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfAnchor());
}
...
TEST_F(AXPositionTest, AtStartOfLineWithTextPosition)
{
    ...
    text_position = CreateTextPosition(line_break_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    ...
    text_position = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    ...
    // An upstream affinity should not affect the outcome since there is no soft
    // line break.
    text_position = CreateTextPosition(inline_box2_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());

    text_position = CreateTextPosition(inline_box2_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
}
...
TEST_F(AXPositionTest, AtStartOfLineStaticTextExtraPrecedingSpace)
{
    ...
    TestPositionType text_position = CreateTextPosition(static_text1, 1 /* child_index */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(text_position->AtStartOfLine());
}

TEST_F(AXPositionTest, AtEndOfLineWithTextPosition)
{
    TestPositionType text_position = CreateTextPosition(inline_box1_, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(inline_box1_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box2_, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(inline_box2_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtEndOfLine());
}
...
TEST_F(AXPositionTest, AtStartOfBlankLine)
{
    ...
    TestPositionType tree_position = CreateTreePosition(text_field_, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_TRUE(tree_position->AtStartOfLine());

    TestPositionType text_position = CreateTextPosition(line_break_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
...
TEST_F(AXPositionTest, AtStartAndEndOfLineWhenAtEndOfTextSpan)
{
    ...
    // "kIsLineBreakingObject" is not strictly necessary but is added for
    // completeness.
    root_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    inline_box_data_2.role = ax::mojom::Role::kInlineTextBox;
    inline_box_data_1.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box_data_2.id);
    inline_box_data_2.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, inline_box_data_1.id);
    ...
    inline_box_data_3.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box_data_4.id);
    inline_box_data_4.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, inline_box_data_3.id);
    ...
    static_text_data_1.child_ids = { inline_box_data_1.id, inline_box_data_2.id, inline_box_data_3.id, inline_box_data_4.id };
    ...
    SetTree(CreateAXTree(
        { root_data, static_text_data_1, inline_box_data_1, inline_box_data_2, inline_box_data_3, inline_box_data_4, static_text_data_2, inline_box_data_5 }));

    // An "after text" tree position - after the soft line break.
    TestPositionType tree_position = CreateTreePosition(inline_box_data_2, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_TRUE(tree_position->AtStartOfLine());
    EXPECT_FALSE(tree_position->AtEndOfLine());
    ...
    TestPositionType text_position = CreateTextPosition(inline_box_data_2, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(inline_box_data_4, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    EXPECT_TRUE(text_position->AtEndOfLine());
...
TEST_F(AXPositionTest, AtStartAndEndOfLineInsideTextField)
{
    ...
    text_field_data_1.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    text_field_data_1.AddState(ax::mojom::State::kEditable);
    ...
    inline_box_data_2.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box_data_3.id);
    inline_box_data_3.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, inline_box_data_2.id);
    ...
    // "kIsLineBreakingObject" is not strictly necessary.
    text_field_data_2.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    static_text_data_1.child_ids = { inline_box_data_1.id, inline_box_data_2.id, inline_box_data_3.id };
    static_text_data_2.child_ids = { inline_box_data_4.id, inline_box_data_5.id, inline_box_data_6.id };
    ...
    SetTree(CreateAXTree({ root_data, text_field_data_1, static_text_data_1, inline_box_data_1, inline_box_data_2, inline_box_data_3, text_field_data_2,
        static_text_data_2, inline_box_data_4, inline_box_data_5, inline_box_data_6 }));

    TestPositionType tree_position = CreateTreePosition(text_field_data_1, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    EXPECT_TRUE(tree_position->AtStartOfLine());
    EXPECT_FALSE(tree_position->AtEndOfLine());
    ...
    TestPositionType text_position = CreateTextPosition(text_field_data_1, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(text_field_data_1, 16 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    EXPECT_TRUE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(text_field_data_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->AtStartOfLine());
    EXPECT_FALSE(text_position->AtEndOfLine());

    text_position = CreateTextPosition(text_field_data_2, 16 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    EXPECT_FALSE(text_position->AtStartOfLine());
    EXPECT_TRUE(text_position->AtEndOfLine());
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithPreservedNewLine)
{
    ...
    container_data.id = 4;
    container_data.role = ax::mojom::Role::kGenericContainer;
    container_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    preserved_newline_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root_data, static_text_data_1, some_text_data, container_data, static_text_data_2, preserved_newline_data, more_text_data }));

    // Text position "some tex<t>\nmore text".
    TestPositionType text_position1 = CreateTextPosition(root_data, 8 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position1->AtEndOfParagraph());
    EXPECT_FALSE(text_position1->AtStartOfParagraph());

    // Text position "some text<\n>more text".
    TestPositionType text_position2 = CreateTextPosition(root_data, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position2->AtEndOfParagraph());
    EXPECT_TRUE(text_position2->AtStartOfParagraph());

    // Text position "some text<\n>more text".
    TestPositionType text_position3 = CreateTextPosition(root_data, 9 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_TRUE(text_position3->AtEndOfParagraph());
    EXPECT_FALSE(text_position3->AtStartOfParagraph());

    // Text position "some text\n<m>ore text".
    TestPositionType text_position4 = CreateTextPosition(root_data, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position4->AtEndOfParagraph());
    EXPECT_TRUE(text_position4->AtStartOfParagraph());

    // Text position "some text\n<m>ore text".
    TestPositionType text_position5 = CreateTextPosition(root_data, 10 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_FALSE(text_position5->AtEndOfParagraph());
    EXPECT_FALSE(text_position5->AtStartOfParagraph());

    // Text position "<\n>more text".
    TestPositionType text_position6 = CreateTextPosition(container_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position6->AtEndOfParagraph());
    EXPECT_TRUE(text_position6->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position7 = CreateTextPosition(container_data, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position7->AtEndOfParagraph());
    EXPECT_TRUE(text_position7->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position8 = CreateTextPosition(container_data, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_FALSE(text_position8->AtEndOfParagraph());
    EXPECT_FALSE(text_position8->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position9 = CreateTextPosition(static_text_data_2, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position9->AtEndOfParagraph());
    EXPECT_TRUE(text_position9->AtStartOfParagraph());

    // Text position "\n<m>ore text".
    TestPositionType text_position10 = CreateTextPosition(static_text_data_2, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    EXPECT_FALSE(text_position10->AtEndOfParagraph());
    EXPECT_FALSE(text_position10->AtStartOfParagraph());

    TestPositionType text_position11 = CreateTextPosition(preserved_newline_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position11->AtEndOfParagraph());
    EXPECT_TRUE(text_position11->AtStartOfParagraph());

    TestPositionType text_position12 = CreateTextPosition(preserved_newline_data, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position12->AtEndOfParagraph());
    EXPECT_FALSE(text_position12->AtStartOfParagraph());

    TestPositionType text_position13 = CreateTextPosition(more_text_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position13->AtEndOfParagraph());
    EXPECT_TRUE(text_position13->AtStartOfParagraph());

    TestPositionType text_position14 = CreateTextPosition(more_text_data, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, TreePositionAtStartOrEndOfListMarkerAnchor)
{
    ...
    TestPositionType start_of_anchor = tree_position->CreatePositionAtStartOfAnchor();
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphOnAListMarker)
{
    ...
    list_item1.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    static_text2.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box3.id);
    ...
    inline_box3.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, static_text2.id);

    list_item2.role = ax::mojom::Role::kListItem;
    list_item2.child_ids = { list_marker_ng.id, static_text4.id };
    list_item2.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    list_marker_ng.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box4.id);
    ...
    inline_box4.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, list_marker_ng.id);
    ...
    SetTree(CreateAXTree({ root, static_text1, inline_box1, list, list_item1, list_marker_legacy, static_text2, static_text3, inline_box3, list_item2,
        list_marker_ng, static_text4, inline_box4, static_text5, inline_box5 }));
    ...
    // bullet / item.
    TestPositionType text_position = CreateTextPosition(static_text1, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    ...
    // to a position that is before the list itself, or before the first list
    // bullet / item.
    text_position = CreateTextPosition(inline_box1, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position before the list.
    text_position = CreateTextPosition(list, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // "AtStartOfParagraph".
    text_position = CreateTextPosition(list, 14 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    // An upstream text position after the list. It should be "AtEndOfParagraph".
    text_position = CreateTextPosition(list, 14 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position before the first list bullet (the Legacy Layout one).
    text_position = CreateTextPosition(list_marker_legacy, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    text_position = CreateTextPosition(list_marker_legacy, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->IsIgnored());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(list_marker_legacy, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->IsIgnored());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(list_marker_legacy, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->IsIgnored());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(list_marker_ng, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    text_position = CreateTextPosition(list_marker_ng, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsLeaf());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // bullet.
    text_position = CreateTextPosition(static_text3, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // A text position before the text contents of the first list item - not the
    // bullet.
    text_position = CreateTextPosition(inline_box3, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the first list item.
    text_position = CreateTextPosition(static_text3, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the first list item.
    text_position = CreateTextPosition(inline_box3, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    ...
    // bullet.
    text_position = CreateTextPosition(static_text4, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    ...
    // A text position before the text contents of the second list item - not the
    // bullet.
    text_position = CreateTextPosition(inline_box4, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the second list item.
    text_position = CreateTextPosition(static_text4, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position after the text contents of the second list item.
    text_position = CreateTextPosition(inline_box4, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_FALSE(text_position->AtStartOfParagraph());
    EXPECT_TRUE(text_position->AtEndOfParagraph());

    // A text position before the text "After list.".
    text_position = CreateTextPosition(inline_box5, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    EXPECT_FALSE(text_position->AtEndOfParagraph());
}

TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithLeadingAndTrailingWhitespace)
{
    // This test ensures that "At{Start|End}OfParagraph" work correctly when a
    // text position is on a preserved newline character.
    //
    ...
    container_data_a.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    inline_text_data_a.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);

    AXNodeData container_data_b;
    container_data_b.id = 5;
    container_data_b.role = ax::mojom::Role::kGenericContainer;
    container_data_b.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    container_data_c.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    inline_text_data_c.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);

    root_data.child_ids = { container_data_a.id, container_data_b.id, container_data_c.id };
    ...
    static_text_data_b.child_ids = { inline_text_data_b_1.id, inline_text_data_b_2.id, inline_text_data_b_3.id };
    container_data_c.child_ids = { static_text_data_c.id };
    static_text_data_c.child_ids = { inline_text_data_c.id };

    SetTree(CreateAXTree({ root_data, container_data_a, container_data_b, container_data_c, static_text_data_a, static_text_data_b, static_text_data_c,
        inline_text_data_a, inline_text_data_b_1, inline_text_data_b_2, inline_text_data_b_3, inline_text_data_c }));

    // Before the first "\n".
    TestPositionType text_position1 = CreateTextPosition(inline_text_data_a, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position1->AtEndOfParagraph());
    ...
    TestPositionType text_position2 = CreateTextPosition(inline_text_data_a, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position2->AtEndOfParagraph());
    EXPECT_FALSE(text_position2->AtStartOfParagraph());

    // Before "some".
    TestPositionType text_position3 = CreateTextPosition(inline_text_data_b_1, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position3->AtEndOfParagraph());
    EXPECT_TRUE(text_position3->AtStartOfParagraph());

    // After "some".
    TestPositionType text_position4 = CreateTextPosition(inline_text_data_b_1, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position4->AtEndOfParagraph());
    EXPECT_FALSE(text_position4->AtStartOfParagraph());

    // Before " ".
    TestPositionType text_position5 = CreateTextPosition(inline_text_data_b_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position5->AtEndOfParagraph());
    EXPECT_FALSE(text_position5->AtStartOfParagraph());

    // After " ".
    TestPositionType text_position6 = CreateTextPosition(inline_text_data_b_2, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position6->AtEndOfParagraph());
    EXPECT_FALSE(text_position6->AtStartOfParagraph());

    // Before "text".
    TestPositionType text_position7 = CreateTextPosition(inline_text_data_b_3, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position7->AtEndOfParagraph());
    EXPECT_FALSE(text_position7->AtStartOfParagraph());

    // After "text".
    TestPositionType text_position8 = CreateTextPosition(inline_text_data_b_3, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position8->AtEndOfParagraph());
    EXPECT_FALSE(text_position8->AtStartOfParagraph());

    // Before the second "\n".
    TestPositionType text_position9 = CreateTextPosition(inline_text_data_c, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position9->AtEndOfParagraph());
    EXPECT_TRUE(text_position9->AtStartOfParagraph());

    // After the second "\n".
    TestPositionType text_position10 = CreateTextPosition(inline_text_data_c, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, AtStartOrEndOfParagraphWithIgnoredNodes)
{
    ...
    TestPositionType text_position2 = CreateTextPosition(inline_text_data_a, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position2->AtEndOfParagraph());
    EXPECT_FALSE(text_position2->AtStartOfParagraph());
    ...
    TestPositionType text_position10 = CreateTextPosition(inline_text_data_c, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position10->AtEndOfParagraph());
    EXPECT_FALSE(text_position10->AtStartOfParagraph());
}
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);
    ...
    root_1.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root_1, link_2, static_text_3, inline_box_4, image_5, static_text_6, inline_box_7 }));

    // Before "hello".
    TestPositionType text_position = CreateTextPosition(inline_box_4, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    EXPECT_TRUE(text_position->AtStartOfParagraph());
    ...
    text_position = CreateTextPosition(inline_box_4, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    EXPECT_FALSE(text_position->AtStartOfParagraph());

    // Before the image's embedded object character.
    text_position = CreateTextPosition(image_5, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    EXPECT_TRUE(text_position->AtStartOfParagraph());

    // After the image's embedded object character.
    text_position = CreateTextPosition(image_5, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    EXPECT_FALSE(text_position->AtStartOfParagraph());

    // Before "world".
    text_position = CreateTextPosition(inline_box_7, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_FALSE(text_position->AtEndOfParagraph());
    EXPECT_TRUE(text_position->AtStartOfParagraph());

    // After "world".
    text_position = CreateTextPosition(inline_box_7, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->AtEndOfParagraph());
    EXPECT_FALSE(text_position->AtStartOfParagraph());
}
...
TEST_F(AXPositionTest, CreateNextOrPreviousParagraphPositionWithIgnoredNodes)
{
    ...
    root_data.role = ax::mojom::Role::kRootWebArea;
    root_data.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    root_data.child_ids = { static_text_data_a.id, ignored_container_data_a.id, static_text_data_b.id, ignored_container_data_b.id, static_text_data_c.id };
    ...
    ignored_container_data_a.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    ignored_container_data_b.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root_data, static_text_data_a, inline_text_data_a, ignored_container_data_a, static_text_data_b, inline_text_data_b_1,
        inline_text_data_b_2, inline_text_data_b_3, ignored_container_data_b, static_text_data_c, inline_text_data_c }));

    TestPositionType paragraph_start_position = CreateTextPosition(inline_text_data_a, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_start_position
        = paragraph_start_position->CreateNextParagraphStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    paragraph_start_position = CreateTextPosition(inline_text_data_c, 15 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_start_position = paragraph_start_position->CreatePreviousParagraphStartPosition(
        { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_TRUE(paragraph_start_position->IsTextPosition());
    EXPECT_EQ(inline_text_data_c.id, paragraph_start_position->anchor_id());
    EXPECT_EQ(0, paragraph_start_position->text_offset());
    paragraph_start_position = paragraph_start_position->CreatePreviousParagraphStartPosition(
    ...
    TestPositionType paragraph_end_position = CreateTextPosition(inline_text_data_a, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_end_position
        = paragraph_end_position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    paragraph_end_position = CreateTextPosition(inline_text_data_c, 15 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    paragraph_end_position
        = paragraph_end_position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_TRUE(paragraph_end_position->IsTextPosition());
    EXPECT_EQ(inline_text_data_b_3.id, paragraph_end_position->anchor_id());
    // "paragraph<>".
    EXPECT_EQ(9, paragraph_end_position->text_offset());
...
TEST_F(AXPositionTest, CreatePreviousParagraphEndPositionStopAtAnchorBoundaryWithConsecutiveParentChildLineBreakingObjects)
{
    ...
    SetTree(CreateAXTree({ root_data, static_text_data_a, container_data_a, container_data_b, static_text_data_b }));

    TestPositionType test_position = CreateTextPosition(root_data, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);

    test_position
        = test_position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
...
TEST_F(AXPositionTest, LowestCommonAncestor)
{
    ...
    TestPositionType root_position = CreateTreePosition(root_, 3 /* child_index */);
    ASSERT_NE(nullptr, root_position);
    // A "before text" position.
    TestPositionType button_position = CreateTreePosition(button_, AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, button_position);
    TestPositionType text_field_position = CreateTreePosition(text_field_, 2 /* child_index */);
    ASSERT_NE(nullptr, text_field_position);
    TestPositionType static_text1_position = CreateTreePosition(static_text1_, 0 /* child_index */);
    ASSERT_NE(nullptr, static_text1_position);
    TestPositionType static_text2_position = CreateTreePosition(static_text2_, 0 /* child_index */);
    ASSERT_NE(nullptr, static_text2_position);
    TestPositionType inline_box1_position = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, inline_box1_position);
    ASSERT_TRUE(inline_box1_position->IsTextPosition());
    TestPositionType inline_box2_position = CreateTextPosition(inline_box2_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, inline_box2_position);
    ASSERT_TRUE(inline_box2_position->IsTextPosition());

    TestPositionType test_position = root_position->LowestCommonAncestorPosition(*null_position.get(), ax::mojom::MoveDirection::kForward);
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());

    test_position = root_position->LowestCommonAncestorPosition(*root_position.get(), ax::mojom::MoveDirection::kForward);
    ...
    test_position = button_position->LowestCommonAncestorPosition(*text_field_position.get(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(root_.id, test_position->anchor_id());
    ...
    test_position = static_text2_position->LowestCommonAncestorPosition(*static_text1_position.get(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    test_position = static_text1_position->LowestCommonAncestorPosition(*text_field_position.get(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(text_field_.id, test_position->anchor_id());
    ...
    test_position = inline_box1_position->LowestCommonAncestorPosition(*inline_box2_position.get(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(text_field_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());

    test_position = inline_box2_position->LowestCommonAncestorPosition(*inline_box1_position.get(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(text_field_.id, test_position->anchor_id());
...
TEST_F(AXPositionTest, AsTreePositionWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_field_, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box2_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(text_field_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, AsLeafTreePositionWithTreePosition)
{
    ...
    TestPositionType tree_position = CreateTreePosition(text_field_, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
...
TEST_F(AXPositionTest, AsLeafTreePositionWithTextPosition)
{
    ...
    // position).
    TestPositionType text_position = CreateTextPosition(root_, 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(root_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(text_field_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    ...
    // box.
    text_position = CreateTextPosition(root_, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(text_field_, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    // Create a text position on the root, pointing to the line break character
    // inside the text field.
    text_position = CreateTextPosition(root_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    // Create a text position pointing to the line break character inside the text
    // field.
    text_position = CreateTextPosition(text_field_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    text_position = CreateTextPosition(text_field_, 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
    ...
    // text position.
    text_position = CreateTextPosition(root_, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTreePosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTreePosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTreePositionAndEmptyLeafDescendants)
{
    ...
    TestPositionType tree_position = CreateTreePosition(root_data, 1 /* child_index */);
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPosition)
{
    ...
    text_position = CreateTextPosition(root_, 10 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTextPosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTextPosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPositionAndEmptyTextSandwich)
{
    ...
    TestPositionType text_position = CreateTextPosition(root_data, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_FALSE(text_position->IsLeafTextPosition());
    TestPositionType test_position = text_position->AsLeafTextPosition();
    ...
    text_position = CreateTextPosition(root_data, 9 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->AsLeafTextPosition();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsLeafTextPosition());
...
TEST_F(AXPositionTest, AsLeafTextPositionWithTextPositionAndEmbeddedObject)
{
    ...
    SetTree(CreateAXTree({ root, image, paragraph, link, static_text, inline_box }));

    TestPositionType before_root = CreateTextPosition(root, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_root);
    TestPositionType middle_root = CreateTextPosition(root, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_root);
    TestPositionType middle_root_upstream = CreateTextPosition(root, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, middle_root_upstream);
    TestPositionType after_root = CreateTextPosition(root, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    // completeness.
    TestPositionType after_root_upstream = CreateTextPosition(root, 2 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, after_root_upstream);

    TestPositionType before_image = CreateTextPosition(image, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType after_image = CreateTextPosition(image, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_image);

    TestPositionType before_paragraph = CreateTextPosition(paragraph, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType after_paragraph = CreateTextPosition(paragraph, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_paragraph);
    // A position with an upstream affinity after the paragraph should make no
    // difference compared with a downstream affinity, but we'll test it for
    // completeness.
    TestPositionType after_paragraph_upstream = CreateTextPosition(paragraph, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, after_paragraph_upstream);

    TestPositionType before_link = CreateTextPosition(link, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_link);
    // The llink has the text "Hello" inside it.
    TestPositionType after_link = CreateTextPosition(link, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_link);
    // A position with an upstream affinity after the link should make no
    // difference compared with a downstream affinity, but we'll test it for
    // completeness.
    TestPositionType after_link_upstream = CreateTextPosition(link, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, after_link_upstream);

    TestPositionType before_inline_box = CreateTextPosition(inline_box, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_inline_box);
    // The inline box has the text "Hello" inside it.
    TestPositionType after_inline_box = CreateTextPosition(inline_box, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, AsUnignoredPosition)
{
    ...
    SetTree(CreateAXTree({ root_data, static_text_data_1, inline_box_data_1, inline_box_data_2, container_data, static_text_data_2, inline_box_data_3 }));
    ...
    TestPositionType text_position = CreateTextPosition(container_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    TestPositionType test_position = text_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(root_data.id, test_position->anchor_id());
    ...
    // "After text" position.
    text_position = CreateTextPosition(container_data, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    // Changing the adjustment behavior should not affect the outcome.
    test_position = text_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveBackward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(root_data.id, test_position->anchor_id());
    ...
    TestPositionType tree_position = CreateTreePosition(container_data, 0 /* child_index */);
    EXPECT_TRUE(tree_position->IsIgnored());
    test_position = tree_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    EXPECT_TRUE(tree_position->IsIgnored());
    // Changing the adjustment behavior should not affect the outcome.
    test_position = tree_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveBackward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(inline_box_data_3.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
    ...
    text_position = CreateTextPosition(root_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    test_position = text_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box_data_1.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    text_position = CreateTextPosition(root_data, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    test_position = text_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box_data_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_TRUE(text_position->IsIgnored());
    test_position = text_position->AsUnignoredPosition(AXPositionAdjustmentBehavior::kMoveForward);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    tree_position = CreateTreePosition(inline_box_data_2, AXNodePosition::BEFORE_TEXT);
    EXPECT_TRUE(tree_position->IsIgnored());
...
TEST_F(AXPositionTest, CreatePositionAtTextBoundaryContentStartEndIsIgnored)
{
    ...
    inline_box_data_1.SetName("One");
    inline_box_data_1.AddState(ax::mojom::State::kIgnored);
    inline_box_data_1.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, { 0 });
    inline_box_data_1.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, { 3 });
    inline_box_data_1.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, kInlineBox2Id);
    ...
    inline_box_data_2.role = ax::mojom::Role::kInlineTextBox;
    inline_box_data_2.SetName("Two");
    inline_box_data_2.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, { 0 });
    inline_box_data_2.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, { 3 });
    inline_box_data_2.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, kInlineBox1Id);
    inline_box_data_2.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, kInlineBox3Id);
    ...
    inline_box_data_3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, { 0 });
    inline_box_data_3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, { 5 });
    inline_box_data_3.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, kInlineBox2Id);
    inline_box_data_3.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, kInlineBox4Id);
    ...
    inline_box_data_3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, { 0 });
    inline_box_data_3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, { 4 });
    inline_box_data_3.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, kInlineBox3Id);

    root_data.child_ids = { static_text_data_1.id, static_text_data_2.id, static_text_data_3.id, static_text_data_4.id };
    static_text_data_1.child_ids = { inline_box_data_1.id };
    static_text_data_2.child_ids = { inline_box_data_2.id };
    static_text_data_3.child_ids = { inline_box_data_3.id };
    static_text_data_4.child_ids = { inline_box_data_4.id };

    SetTree(CreateAXTree({ root_data, static_text_data_1, static_text_data_2, static_text_data_3, static_text_data_4, inline_box_data_1, inline_box_data_2,
        inline_box_data_3, inline_box_data_4 }));

    TestPositionType text_position = CreateTextPosition(inline_box_data_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(text_position->IsIgnored());
    TestPositionType test_position = text_position->CreatePositionAtTextBoundary(ax::mojom::TextBoundary::kWordStart, ax::mojom::MoveDirection::kForward,
        { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box_data_3.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    EXPECT_EQ(ax::mojom::TextAffinity::kDownstream, test_position->affinity());
    test_position = text_position->CreatePositionAtTextBoundary(ax::mojom::TextBoundary::kWordStart, ax::mojom::MoveDirection::kBackward,
        { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(inline_box_data_3, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(text_position->IsIgnored());
    test_position = text_position->CreatePositionAtTextBoundary(ax::mojom::TextBoundary::kWordStart, ax::mojom::MoveDirection::kForward,
        { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box_data_3.id, test_position->anchor_id());
...
TEST_F(AXPositionTest, CreatePositionAtInvalidGraphemeBoundary)
{
    ...
    TestPositionType test_position = CreateTextPosition(*GetTree()->root(), 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    test_position = CreateTextPosition(*GetTree()->root(), 10 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfAnchorWithNullPosition)
{
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreatePositionAtStartOfAnchor();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
TEST_F(AXPositionTest, CreatePositionAtStartOfAnchorWithTreePosition)
{
    TestPositionType tree_position = CreateTreePosition(root_, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    TestPositionType test_position = tree_position->CreatePositionAtStartOfAnchor();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(root_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionType test_position = text_position->CreatePositionAtStartOfAnchor();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    text_position = CreateTextPosition(inline_box1_, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtPreviousFormatStartWithNullPosition)
{
    ...
    TestPositionType test_position
        = null_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    test_position = null_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    test_position
        = null_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);
    TestPositionType tree_position = CreateTreePosition(static_text1_, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());

    TestPositionType test_position
        = tree_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    test_position
        = test_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    // it's at a boundary.
    test_position = test_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(button_.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());
    ...
    test_position = test_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);
    TestPositionType text_position = CreateTextPosition(inline_box1_, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());

    TestPositionType test_position
        = text_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtNextFormatEndWithNullPosition)
{
    ...
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position
        = null_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    test_position = null_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);
    TestPositionType tree_position = CreateTreePosition(button_, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());

    TestPositionType test_position
        = tree_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(check_box_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
    ...
    test_position
        = test_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
    ...
    // AXBoundaryDetection::kCheckInitialPosition shouldn't move at all since
    // it's at a boundary.
    test_position = test_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
    ...
    test_position = test_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);
    TestPositionType text_position = CreateTextPosition(button_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());

    TestPositionType test_position
        = text_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(button_.id, test_position->anchor_id());
    EXPECT_EQ(1, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtNextFormatEndOnEmbeddedObject)
{
    ...
    root_1.child_ids = { heading_2.id, popup_button_5.id, heading_8.id, popup_button_11.id, popup_button_14.id, static_text_17.id };
    ...
    SetTree(CreateAXTree({ root_1, heading_2, static_text_3, inline_text_4, popup_button_5, menu_list_popup_6, menu_list_option_7, heading_8, static_text_9,
        inline_text_10, popup_button_11, menu_list_popup_12, menu_list_option_13, popup_button_14, menu_list_popup_15, menu_list_option_16, static_text_17,
        inline_text_18 }));

    // Creating initial text position at "<h>eading 1...".
    TestPositionType text_position = CreateTextPosition(inline_text_4, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    TestPositionType format_end_position
        = text_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    EXPECT_EQ("heading 1", format_end_position->GetAnchor()->GetStringAttribute(ax::mojom::StringAttribute::kName));

    // Move position to end of format at "heading 1|select, option 1|<>...", which
    // is at the end of embedded object <select, option 1> (popup_button_5).
    format_end_position
        = format_end_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, format_end_position);
    EXPECT_TRUE(format_end_position->IsTextPosition());
    EXPECT_EQ(popup_button_5.id, format_end_position->anchor_id());
    EXPECT_EQ(1, format_end_position->text_offset());
    EXPECT_EQ("option 1", format_end_position->GetAnchor()->GetStringAttribute(ax::mojom::StringAttribute::kName));
    ...
    EXPECT_EQ(9, format_end_position->text_offset());
    EXPECT_EQ("heading 2", format_end_position->GetAnchor()->GetStringAttribute(ax::mojom::StringAttribute::kName));
    ...
    EXPECT_EQ(1, format_end_position->text_offset());
    EXPECT_EQ("option 2", format_end_position->GetAnchor()->GetStringAttribute(ax::mojom::StringAttribute::kName));
    ...
    EXPECT_EQ(1, format_end_position->text_offset());
    EXPECT_EQ("option 3", format_end_position->GetAnchor()->GetStringAttribute(ax::mojom::StringAttribute::kName));
    ...
    EXPECT_EQ(9, format_end_position->text_offset());
    EXPECT_EQ("more text", format_end_position->GetAnchor()->GetStringAttribute(ax::mojom::StringAttribute::kName));
}
...
TEST_F(AXPositionTest, CreatePositionAtFormatBoundaryWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_data, 8 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    TestPositionType test_position
        = text_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(more_text_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreateNextFormatEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
...
TEST_F(AXPositionTest, MoveByFormatWithIgnoredNodes)
{
    ...
    root_1.role = ax::mojom::Role::kRootWebArea;
    root_1.child_ids = { generic_container_2.id, generic_container_8.id, generic_container_15.id, generic_container_19.id };
    ...
    generic_container_8.child_ids = { heading_9.id, static_text_12.id, generic_container_14.id };
    ...
    generic_container_19.child_ids = { generic_container_20.id, static_text_21.id, heading_23.id };
    ...
    SetTree(CreateAXTree({ root_1, generic_container_2, button_3, static_text_4, inline_box_5, svg_root_6, generic_container_7, generic_container_8, heading_9,
        static_text_10, inline_box_11, static_text_12, inline_box_13, generic_container_14, generic_container_15, heading_16, static_text_17, inline_box_18,
        generic_container_19, generic_container_20, static_text_21, inline_box_22, heading_23, static_text_24, inline_box_25 }));
    ...
    {
        // Forward movement
        TestPositionType text_position = CreateTextPosition(inline_box_5, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        ...
        // Backward movement
        text_position = CreateTextPosition(inline_box_11, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        EXPECT_EQ(inline_box_11.id, text_position->anchor_id());
    ...
    {
        // Forward movement
        TestPositionType text_position = CreateTextPosition(inline_box_11, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
        EXPECT_EQ(inline_box_11.id, text_position->anchor_id());
        EXPECT_EQ(7, text_position->text_offset());
        ...
        // Backward movement
        text_position = CreateTextPosition(inline_box_25, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
        ASSERT_NE(nullptr, text_position);
        EXPECT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtPageBoundaryWithNullPosition)
{
    ...
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position
        = null_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());

    test_position = null_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());

    test_position = null_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());

    test_position = null_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
{
    AXNodeData root_data, page_1_data, page_1_text_data, page_2_data, page_2_text_data, page_3_data, page_3_text_data;
    SetTree(CreateMultipageDocument(root_data, page_1_data, page_1_text_data, page_2_data, page_2_text_data, page_3_data, page_3_text_data));

    // Test CreateNextPageStartPosition at the start of the whole content.
    TestPositionType tree_position = CreateTreePosition(page_1_data, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
    ...
    // it's at a boundary.
    TestPositionType test_position
        = tree_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_1_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());

    test_position = tree_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    test_position
        = tree_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());
    ...
    test_position = tree_position->CreateNextPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_1_data.id, test_position->anchor_id());
    EXPECT_EQ(1, test_position->child_index());

    test_position = test_position->CreateNextPageEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());

    test_position = test_position->CreateNextPageEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
    ...
    test_position
        = test_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_3_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());

    test_position = test_position->CreateNextPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_3_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());
    ...
    TestPositionType null_position
        = test_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, null_position);
    EXPECT_TRUE(null_position->IsNullPosition());

    null_position = test_position->CreateNextPageEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, null_position);
    EXPECT_TRUE(null_position->IsNullPosition());

    // Now move backward through the accessibility tree.
    tree_position = test_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ...
    test_position
        = tree_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());

    test_position = tree_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->child_index());

    test_position = test_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());
    ...
    test_position
        = test_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_1_text_data.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());

    test_position = test_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_1_text_data.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());
    ...
    test_position
        = test_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(page_1_text_data.id, test_position->anchor_id());
    EXPECT_EQ(AXNodePosition::BEFORE_TEXT, test_position->child_index());
    ...
    null_position = test_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, null_position);
    EXPECT_TRUE(null_position->IsNullPosition());

    null_position = test_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, null_position);
    EXPECT_TRUE(null_position->IsNullPosition());
}
...
TEST_F(AXPositionTest, CreatePositionAtPageBoundaryWithTextPosition)
{
    ...
    // Test CreateNextPageStartPosition at the start of the whole content.
    TestPositionType text_position = CreateTextPosition(page_1_text_data, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    // it's at a boundary.
    TestPositionType test_position
        = text_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_1_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());

    test_position = text_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    test_position
        = text_position->CreateNextPageStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    // Now move backward through the accessibility tree.
    text_position = test_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ...
    test_position
        = text_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(19, test_position->text_offset());

    test_position = text_position->CreatePreviousPageEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(page_2_text_data.id, test_position->anchor_id());
    EXPECT_EQ(19, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtPageBoundaryWithNonPaginatedDocument)
{
    ...
    TestPositionType text_position = CreateTextPosition(static_text1_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    // page)
    TestPositionType test_position
        = text_position->CreatePreviousPageStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(button_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    test_position = text_position->CreateNextPageEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(6, test_position->text_offset());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfAXTreeWithNullPosition)
{
    ...
    AXNodeData window, back_button, web_view, root_web_area, iframe_root, paragraph, address_bar;
    std::vector<TestSingleAXTreeManager> trees;
    ASSERT_NO_FATAL_FAILURE(CreateBrowserWindow(window, back_button, web_view, root_web_area, iframe_root, paragraph, address_bar, trees));

    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreatePositionAtStartOfAXTree();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfAXTreeWithTreePosition)
{
    ...
    TestPositionType tree_position = CreateTreePosition(views_tree, window, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    TestPositionType test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(views_tree, back_button, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(views_tree, back_button, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(webpage_tree, root_web_area, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(webpage_tree, root_web_area, 1 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(webpage_tree, paragraph, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(webpage_tree, paragraph, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(iframe_tree, iframe_root, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
    ...
    tree_position = CreateTreePosition(iframe_tree, iframe_root, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    test_position = tree_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfAXTreeWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(views_tree, window, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    TestPositionType test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_TRUE(test_position->AtStartOfAXTree());
    EXPECT_EQ(views_tree_id, test_position->tree_id());
    ...
    text_position = CreateTextPosition(views_tree, window, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ...
    text_position = CreateTextPosition(views_tree, back_button, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(views_tree, back_button, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(views_tree, web_view, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(views_tree, web_view, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(webpage_tree, root_web_area, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(webpage_tree, root_web_area, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(webpage_tree, paragraph, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(webpage_tree, paragraph, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(iframe_tree, iframe_root, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(iframe_tree, iframe_root, 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtStartOfAXTree();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfContentWithNullPosition)
{
    ...
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreatePositionAtStartOfContent();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
TEST_F(AXPositionTest, CreatePositionAtStartOfContentWithTreePosition)
{
    ...
    TestPositionType tree_position = CreateTreePosition(views_tree, window, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    TestPositionType test_position = tree_position->CreatePositionAtStartOfContent();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
...
TEST_F(AXPositionTest, CreatePositionAtStartOfContentWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(views_tree, window, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    TestPositionType test_position = text_position->CreatePositionAtStartOfContent();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_TRUE(test_position->AtStartOfContent());
    EXPECT_EQ(views_tree_id, test_position->tree_id());
...
TEST_F(AXPositionTest, CreatePositionAtEndOfContentWithNullPosition)
{
    ...
    TestPositionType null_position = AXNodePosition::CreateNullPosition();
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position = null_position->CreatePositionAtEndOfContent();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
TEST_F(AXPositionTest, CreatePositionAtEndOfContentWithTreePosition)
{
    ...
    TestPositionType tree_position = CreateTreePosition(views_tree, window, 0 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    TestPositionType test_position = tree_position->CreatePositionAtEndOfContent();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition());
...
TEST_F(AXPositionTest, CreatePositionAtEndOfContentWithTextPosition)
{
    ...
    TestPositionType text_position = CreateTextPosition(views_tree, window, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    TestPositionType test_position = text_position->CreatePositionAtEndOfContent();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_TRUE(test_position->AtEndOfContent());
    EXPECT_EQ(views_tree_id, test_position->tree_id());
    ...
    text_position = CreateTextPosition(webpage_tree, root_web_area, 12 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreatePositionAtEndOfContent();
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
...
{
    TestPositionType tree_position = CreateTreePosition(root_, 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position);
...
{
    TestPositionType text_position = CreateTextPosition(static_text1_, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(static_text2_, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType tree_position = CreateTreePosition(check_box_, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ...
    test_position = tree_position->CreateParentPosition();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTreePosition()) << "We should cross into a minimalistic Views tree.";

    tree_position = CreateTreePosition(inline_box2_, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ASSERT_TRUE(tree_position->IsTreePosition());
...
TEST_F(AXPositionTest, CreateParentPositionWithTextPosition)
{
    // Create a position that points at the end of the first line, right after the
    // check box.
    TestPositionType text_position = CreateTextPosition(check_box_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(root_, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    test_position = text_position->CreateParentPosition();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition()) << "We should cross into a minimalistic Views tree.";
...
TEST_F(AXPositionTest, CreateParentPositionWithMoveDirection)
{
    ...
    paragraph_5.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root_1, link_2, static_text_3, inline_box_4, paragraph_5, static_text_6, inline_box_7 }));
    ...
    TestPositionType tree_position = CreateTreePosition(inline_box_4, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    TestPositionType ancestor_position = tree_position->CreateAncestorPosition(GetRoot(), ax::mojom::MoveDirection::kForward);
    ...
    tree_position = CreateTreePosition(inline_box_4, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, tree_position);
    ancestor_position = tree_position->CreateAncestorPosition(GetRoot(), ax::mojom::MoveDirection::kBackward);
    ASSERT_NE(nullptr, ancestor_position);
    EXPECT_TRUE(ancestor_position->IsTreePosition());
    EXPECT_EQ(root_1.id, ancestor_position->anchor_id());
    // The child index should be before the "object replacement character" for the
    ...
    ASSERT_NE(nullptr, tree_position);
    ancestor_position = tree_position->CreateAncestorPosition(GetRoot(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, ancestor_position);
    EXPECT_TRUE(ancestor_position->IsTreePosition());
    EXPECT_EQ(root_1.id, ancestor_position->anchor_id());
    ...
    TestPositionType text_position = CreateTextPosition(inline_box_4, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ancestor_position = text_position->CreateAncestorPosition(GetRoot(), ax::mojom::MoveDirection::kForward);
    ASSERT_NE(nullptr, ancestor_position);
    ...
    EXPECT_EQ(ax::mojom::TextAffinity::kDownstream, ancestor_position->affinity());

    // Find the equivalent position on the root, when the original position is
    // before "Hello", with a backward direction.
    text_position = CreateTextPosition(inline_box_4, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ancestor_position = text_position->CreateAncestorPosition(GetRoot(), ax::mojom::MoveDirection::kBackward);
    ASSERT_NE(nullptr, ancestor_position);
    EXPECT_TRUE(ancestor_position->IsTextPosition());
    EXPECT_EQ(root_1.id, ancestor_position->anchor_id());
    // The text offset should be before the "object replacement character" for the
...
TEST_F(AXPositionTest, CreateParentAndLeafPositionWithIgnoredNodes)
{
    ...
    root.role = ax::mojom::Role::kRootWebArea;
    root.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    root.child_ids = { generic_container_ignored.id, static_text_ignored_1.id, static_text_ignored_2.id, static_text_2.id };

    generic_container_ignored.role = ax::mojom::Role::kGenericContainer;
    generic_container_ignored.AddState(ax::mojom::State::kIgnored);
    generic_container_ignored.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    static_text_ignored_1.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    static_text_ignored_2.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    static_text_2.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root, generic_container_ignored, static_text_1, inline_box_1, static_text_ignored_1, inline_box_ignored_1, static_text_ignored_2,
    ...
    TestPositionType middle_root = CreateTextPosition(root, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(middle_root->IsNullPosition());

    // "Hello<W>orld"
    // At the start of the second line before "World".
    TestPositionType middle_root_upstream = CreateTextPosition(root, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ...
    TestPositionType after_root = CreateTextPosition(root, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_root->IsNullPosition());

    // "<H>ello"
    TestPositionType before_inline_box_1 = CreateTextPosition(inline_box_1, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_1->IsNullPosition());
    // "Hello<>"
    TestPositionType after_inline_box_1 = CreateTextPosition(inline_box_1, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_inline_box_1->IsNullPosition());

    // "<I>gnored1"
    TestPositionType before_inline_box_ignored_1 = CreateTextPosition(inline_box_ignored_1, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_ignored_1->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_1->IsIgnored());

    TestPositionType before_inline_box_ignored_1_tree = CreateTreePosition(inline_box_ignored_1, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_ignored_1_tree->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_1_tree->IsIgnored());
    TestPositionType after_inline_box_ignored_1_tree = CreateTreePosition(inline_box_ignored_1, 0 /* child_index */);
    ASSERT_FALSE(after_inline_box_ignored_1_tree->IsNullPosition());
    ASSERT_TRUE(after_inline_box_ignored_1_tree->IsIgnored());

    // "<I>gnored2"
    TestPositionType before_inline_box_ignored_2 = CreateTextPosition(inline_box_ignored_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_ignored_2->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_2->IsIgnored());

    TestPositionType before_inline_box_ignored_2_tree = CreateTreePosition(inline_box_ignored_2, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_ignored_2_tree->IsNullPosition());
    ASSERT_TRUE(before_inline_box_ignored_2_tree->IsIgnored());
    TestPositionType after_inline_box_ignored_2_tree = CreateTreePosition(inline_box_ignored_2, 0 /* child_index */);
    ASSERT_FALSE(after_inline_box_ignored_2_tree->IsNullPosition());
    ASSERT_TRUE(after_inline_box_ignored_2_tree->IsIgnored());

    // "<W>orld"
    TestPositionType before_inline_box_2 = CreateTextPosition(inline_box_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_2->IsNullPosition());
    // "World<>"
    TestPositionType after_inline_box_2 = CreateTextPosition(inline_box_2, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_inline_box_2->IsNullPosition());

    TestPositionType parent_position = before_inline_box_1->CreateParentPosition()->CreateParentPosition();
    ...
    // container.
    parent_position = after_inline_box_1->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    ...
    // equivalent position.
    parent_position = before_inline_box_ignored_1->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTextPosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(5, parent_position->text_offset());
    ...
    parent_position = before_inline_box_ignored_1_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(1, parent_position->child_index());

    parent_position = after_inline_box_ignored_1_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(2, parent_position->child_index());

    parent_position = before_inline_box_ignored_2->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTextPosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(5, parent_position->text_offset());
    ...
    parent_position = before_inline_box_ignored_2_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(2, parent_position->child_index());

    parent_position = after_inline_box_ignored_2_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    ...
    parent_position = before_inline_box_2->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTextPosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(5, parent_position->text_offset());
    ...
    parent_position = after_inline_box_2->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTextPosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
...
TEST_F(AXPositionTest, CreateParentAndLeafPositionWithEmptyNodes)
{
    ...
    root.role = ax::mojom::Role::kRootWebArea;
    root.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    root.child_ids = { link.id, static_text_empty.id, button_empty.id, static_text_2.id };
    ...
    static_text_empty.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    button_empty.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root, link, static_text_1, inline_box_1, static_text_empty, inline_box_empty, button_empty, static_text_2, inline_box_2 }));
    ...
    TestPositionType before_inline_box_empty = CreateTextPosition(inline_box_empty, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_inline_box_empty->IsNullPosition());

    TestPositionType before_inline_box_empty_tree = CreateTreePosition(inline_box_empty, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_empty_tree->IsNullPosition());
    TestPositionType after_inline_box_empty_tree = CreateTreePosition(inline_box_empty, 0 /* child_index */);
    ASSERT_FALSE(after_inline_box_empty_tree->IsNullPosition());

    TestPositionType before_button_empty = CreateTextPosition(button_empty, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(before_button_empty->IsNullPosition());

    TestPositionType before_button_empty_tree = CreateTreePosition(button_empty, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_button_empty_tree->IsNullPosition());
    TestPositionType after_button_empty_tree = CreateTreePosition(button_empty, 0 /* child_index */);
    ...
    // considered as part of the previous line when finding the unignored root
    // equivalent position.
    parent_position = before_inline_box_empty->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTextPosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(5, parent_position->text_offset());
    ...
    parent_position = before_inline_box_empty_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(1, parent_position->child_index());

    parent_position = after_inline_box_empty_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(2, parent_position->child_index());
...
TEST_F(AXPositionTest, CreateParentAndLeafPositionWithEmbeddedObjects)
{
    ...
    SetTree(CreateAXTree({ root, paragraph, static_text_1, inline_box_1, static_text_2, inline_box_2, button_empty }));
    ...
    // affinity).
    TestPositionType middle_root
        = CreateTextPosition(root, AXNode::kEmbeddedObjectCharacterLengthUTF16 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(middle_root->IsNullPosition());
    TestPositionType middle_root_upstream
        = CreateTextPosition(root, AXNode::kEmbeddedObjectCharacterLengthUTF16 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_FALSE(middle_root_upstream->IsNullPosition());

    // The root has 7 characters: two embedded objects and the word "Hello".
    TestPositionType after_root = CreateTextPosition(root, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_root->IsNullPosition());
    ...
    ASSERT_FALSE(before_inline_box_1->IsNullPosition());
    // "Paragraph<>"
    TestPositionType after_inline_box_1 = CreateTextPosition(inline_box_1, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_FALSE(after_inline_box_1->IsNullPosition());

    TestPositionType after_inline_box_1_tree = CreateTreePosition(inline_box_1, 0 /* child_index */);
    ...
    TestPositionType before_inline_box_2_tree = CreateTreePosition(inline_box_2, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_FALSE(before_inline_box_2_tree->IsNullPosition());
    TestPositionType after_inline_box_2_tree = CreateTreePosition(inline_box_2, 0 /* child_index */);
    ...
    TestPositionType parent_position = before_inline_box_1->CreateParentPosition()->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTextPosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(0, parent_position->text_offset());
    ...
    parent_position = after_inline_box_1->CreateParentPosition()->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTextPosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(AXNode::kEmbeddedObjectCharacterLengthUTF16, parent_position->text_offset());
    EXPECT_EQ(ax::mojom::TextAffinity::kUpstream, parent_position->affinity());

    parent_position = after_inline_box_1_tree->CreateParentPosition()->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(1, parent_position->child_index());
    ...
    parent_position = before_inline_box_2_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(1, parent_position->child_index());

    parent_position = after_inline_box_2_tree->CreateParentPosition()->CreateParentPosition();
    ASSERT_NE(nullptr, parent_position);
    EXPECT_TRUE(parent_position->IsTreePosition());
    EXPECT_EQ(root.id, parent_position->anchor_id());
    EXPECT_EQ(2, parent_position->child_index());
    ...
    EXPECT_EQ(AXNode::kEmbeddedObjectCharacterLengthUTF16, leaf_position->text_offset());
    EXPECT_EQ(ax::mojom::TextAffinity::kDownstream, leaf_position->affinity());
}
...
{
    TestPositionType check_box_position = CreateTreePosition(root_, 1 /* child_index */);
    ASSERT_NE(nullptr, check_box_position);
    TestPositionType test_position = check_box_position->CreateNextLeafTextPosition();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTreeID(), test_position->tree_id());
    EXPECT_EQ(check_box_.id, test_position->anchor_id());
    ...
    TestPositionType root_position = CreateTextPosition(root_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, root_position);
    ...
    TestPositionType text_field_position = CreateTreePosition(root_, 2 /* child_index */);
    ASSERT_NE(nullptr, text_field_position);
    ...
    TestPositionType root_position2 = CreateTextPosition(root_, 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
{
    TestPositionType text_position = CreateTextPosition(inline_box2_, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionType test_position = text_position->CreatePreviousLeafTextPosition();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTreeID(), test_position->tree_id());
    EXPECT_EQ(line_break_.id, test_position->anchor_id());
    ...
    TestPositionType before_text_position = CreateTreePosition(inline_box2_, AXNodePosition::BEFORE_TEXT);
    ...
    // box.
    TestPositionType check_box_position = CreateTextPosition(check_box_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, check_box_position);
...
{
    TestPositionType root_position = CreateTreePosition(root_, 0 /* child_index */);
    ASSERT_TRUE(root_position->IsTreePosition());

    TestPositionType button_position = CreateTreePosition(button_, AXNodePosition::BEFORE_TEXT);
    TestPositionType checkbox_position = CreateTreePosition(check_box_, AXNodePosition::BEFORE_TEXT);
    TestPositionType inline_box1_position = CreateTreePosition(inline_box1_, AXNodePosition::BEFORE_TEXT);
    TestPositionType line_break_position = CreateTreePosition(line_break_, AXNodePosition::BEFORE_TEXT);
    TestPositionType inline_box2_position = CreateTreePosition(inline_box2_, AXNodePosition::BEFORE_TEXT);
    ...
    TestPositionType root_text_position = CreateTextPosition(root_, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType inline_box1_text_position = CreateTextPosition(inline_box1_, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, CreatePreviousLeafTreePosition)
{
    ...
    TestPositionType test_position = inline_box2_position->CreatePreviousLeafTreePosition();
    EXPECT_TRUE(test_position->IsTreePosition());
    EXPECT_EQ(*test_position, *line_break_position);
    ...
    TestPositionType inline_box2_text_position = CreateTextPosition(inline_box2_, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, AsLeafTextPositionBeforeAndAfterCharacterWithNullPosition)
{
    ...
    TestPositionType test_position = null_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
...
TEST_F(AXPositionTest, DISABLED_AsLeafTextPositionBeforeAndAfterCharacterWithInvalidPosition)
{
    AXNodeData root_data;
    root_data.id = 1;
    root_data.role = ax::mojom::Role::kRootWebArea;
    ...
    TestPositionType text_position = CreateTextPosition(text_data, 9 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsTextPosition());
    ...
    TestPositionType text_position_before = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_TRUE(text_position_before->IsNullPosition());

    // Likewise for |AsLeafTextPositionAfterCharacter|.
    TestPositionType text_position_after = text_position->AsLeafTextPositionAfterCharacter();
...
TEST_F(AXPositionTest, AsLeafTextPositionBeforeAndAfterCharacterAtInvalidGraphemeBoundary)
{
    ...
    test_position = CreateTextPosition(*GetTree()->root(), 10 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, AsLeafTextPositionBeforeCharacterNoAdjustment)
{
    ...
    TestPositionType text_position = CreateTextPosition(root_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionType test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(line_break_.id, test_position->anchor_id());
    EXPECT_EQ(0, test_position->text_offset());
    ...
    text_position = CreateTextPosition(static_text1_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, AsLeafTextPositionAfterCharacterNoAdjustment)
{
    ...
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionType test_position = text_position->AsLeafTextPositionAfterCharacter();
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(6, test_position->text_offset());
    ...
    text_position = CreateTextPosition(root_, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionType test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(inline_box2_, 6 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(root_, 13 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, AsLeafTextPositionBeforeCharacterIncludingGeneratedNewlines)
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);

    TestPositionType text_position = CreateTextPosition(button_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionType test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(root_, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(check_box_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(root_, 2 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionBeforeCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, AsLeafTextPositionAfterCharacter)
{
    ...
    text_position = CreateTextPosition(inline_box1_, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionAfterCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionAfterCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, AsLeafTextPositionAfterCharacterIncludingGeneratedNewlines)
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);
    ...
    text_position = CreateTextPosition(button_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionAfterCharacter();
    EXPECT_NE(nullptr, test_position);
    ...
    text_position = CreateTextPosition(check_box_.id, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    test_position = text_position->AsLeafTextPositionAfterCharacter();
    EXPECT_NE(nullptr, test_position);
...
TEST_F(AXPositionTest, CreateNextAndPreviousCharacterPositionWithNullPosition)
{
    ...
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position
        = null_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    test_position = null_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
TEST_F(AXPositionTest, AsValidPosition)
{
    ...
    TestPositionType test_position
        = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_TRUE(test_position->IsValid());
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(text_data.id, test_position->anchor_id());
    EXPECT_EQ(9, test_position->text_offset());
    test_position = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    ...
    test_position = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_TRUE(test_position->IsValid());
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(text_data.id, test_position->anchor_id());
...
TEST_F(AXPositionTest, AsValidPositionInDescendantOfEmptyObject)
{
    ...
    TestPositionType text_position = CreateTextPosition(inline_box_4, 3, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsTextPosition());
    EXPECT_TRUE(text_position->IsValid());
...
{
    TestPositionType text_position = CreateTextPosition(inline_box1_, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(5, test_position->text_offset());
    test_position = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(5, test_position->text_offset());
    test_position
        = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box1_.id, test_position->anchor_id());
    EXPECT_EQ(5, test_position->text_offset());
    ...
    text_position = CreateTextPosition(check_box_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(text_field_, 12 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePreviousCharacterPosition)
{
    ...
    TestPositionType test_position
        = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(5, test_position->text_offset());
    test_position = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(4, test_position->text_offset());
    test_position
        = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(4, test_position->text_offset());
    test_position
        = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(4, test_position->text_offset());
    ...
    test_position = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(inline_box2_.id, test_position->anchor_id());
    EXPECT_EQ(1, test_position->text_offset());
    ...
    text_position = CreateTextPosition(text_field_, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePreviousCharacterPositionIncludingGeneratedNewlines)
{
    ScopedAXEmbeddedObjectBehaviorSetter ax_embedded_object_behavior(AXEmbeddedObjectBehavior::kExposeCharacterForHypertext);

    TestPositionType text_position = CreateTextPosition(inline_box2_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(button_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreateNextCharacterPositionAtGraphemeBoundary)
{
    ...
    TestPositionType test_position = CreateTextPosition(*GetTree()->root(), 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, test_position);
    ASSERT_TRUE(test_position->IsTextPosition());

    for (auto iter = (text_offsets.begin() + 1); iter != text_offsets.end(); ++iter) {
        const int text_offset = *iter;
        test_position = test_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
        ASSERT_NE(nullptr, test_position);
        EXPECT_TRUE(test_position->IsTextPosition());
    ...
    test_position = CreateTextPosition(*GetTree()->root(), 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    test_position = test_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
    EXPECT_EQ(3, test_position->text_offset());
    ...
    test_position = CreateTextPosition(*GetTree()->root(), 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    test_position = test_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
    ...
    test_position = CreateTextPosition(*GetTree()->root(), 9 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    test_position = test_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
...
TEST_F(AXPositionTest, CreatePreviousCharacterPositionAtGraphemeBoundary)
{
    ...
    TestPositionType test_position = CreateTextPosition(*GetTree()->root(), text_offsets.back() /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, test_position);
    ASSERT_TRUE(test_position->IsTextPosition());

    for (auto iter = (text_offsets.rbegin() + 1); iter != text_offsets.rend(); ++iter) {
        const int text_offset = *iter;
        test_position = test_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
        ASSERT_NE(nullptr, test_position);
        EXPECT_TRUE(test_position->IsTextPosition());
    ...
    test_position = CreateTextPosition(*GetTree()->root(), 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    test_position = test_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ASSERT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsTextPosition());
    EXPECT_EQ(GetTree()->root()->id(), test_position->anchor_id());
    EXPECT_EQ(3, test_position->text_offset());
...
TEST_F(AXPositionTest, ReciprocalCreateNextAndPreviousCharacterPosition)
{
    ...
    while (!text_position->IsNullPosition()) {
        TestPositionType moved_position
            = text_position->CreateNextCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    tree_position = CreateTreePosition(root_, root_.child_ids.size() /* child_index */);
    ...
    while (!text_position->IsNullPosition()) {
        TestPositionType moved_position
            = text_position->CreatePreviousCharacterPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
        ASSERT_NE(nullptr, moved_position);
...
TEST_F(AXPositionTest, CreateNextAndPreviousWordStartPositionWithNullPosition)
{
    ...
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position
        = null_position->CreateNextWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    test_position = null_position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
TEST_F(AXPositionTest, CreateNextAndPreviousWordEndPositionWithNullPosition)
{
    ...
    ASSERT_NE(nullptr, null_position);
    TestPositionType test_position
        = null_position->CreateNextWordEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
    test_position = null_position->CreatePreviousWordEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_NE(nullptr, test_position);
    EXPECT_TRUE(test_position->IsNullPosition());
}
...
TEST_F(AXPositionTest, OperatorEquals)
{
    ...
    TestPositionType button_position1 = CreateTreePosition(root_, 0 /* child_index */);
    ASSERT_NE(nullptr, button_position1);
    TestPositionType button_position2 = CreateTreePosition(root_, 0 /* child_index */);
    ...
    // positions.
    ASSERT_EQ(*AXNodePosition::CreateNullPosition(), *AXNodePosition::CreateNullPosition());

    // An invalid position should not be equivalent to an "after children"
    // position.
    TestPositionType tree_position1 = CreateTreePosition(root_, 3 /* child_index */);
    ...
    tree_position1 = CreateTreePosition(inline_box1_, AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, tree_position1);
    tree_position2 = CreateTreePosition(inline_box1_, AXNodePosition::BEFORE_TEXT);
    ASSERT_NE(nullptr, tree_position2);
    EXPECT_EQ(*tree_position1, *tree_position2);
    ...
    TestPositionType text_position1 = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    TestPositionType text_position2 = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_EQ(*text_position1, *text_position2);

    text_position2 = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);

    // Text offsets should match.
    text_position1 = CreateTextPosition(inline_box1_, 5 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    EXPECT_NE(*text_position1, *text_position2);

    // Two "after text" positions on the same node should be equivalent.
    text_position1 = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_EQ(*text_position1, *text_position2);
    ...
    text_position1 = CreateTextPosition(static_text1_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(inline_box1_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_EQ(*text_position1, *text_position2);

    // ...and at the end of the document.
    text_position1 = CreateTextPosition(static_text2_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(inline_box2_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    // Validate that we're actually at the end of the whole content by normalizing
    // to the equivalent "before character" position.
    EXPECT_TRUE(text_position1->AsLeafTextPositionBeforeCharacter()->IsNullPosition());
    EXPECT_TRUE(text_position2->AsLeafTextPositionBeforeCharacter()->IsNullPosition());
...
{
    TestPositionType text_position_one = CreateTextPosition(root_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position_one);
    ASSERT_TRUE(text_position_one->IsTextPosition());

    TestPositionType text_position_two = CreateTextPosition(root_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
...
TEST_F(AXPositionTest, OperatorEqualsSameTextOffsetDifferentAnchorIdRoot)
{
    ...
    TestPositionType text_position_two = CreateTextPosition(check_box_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position_two);
    ASSERT_TRUE(text_position_two->IsTextPosition());
...
{
    TestPositionType text_position_one = CreateTextPosition(button_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position_one);
    ASSERT_TRUE(text_position_one->IsTextPosition());
...
TEST_F(AXPositionTest, OperatorEqualsTextPositionsInTextField)
{
    ...
    text_field_2.AddStringAttribute(ax::mojom::StringAttribute::kHtmlTag, "input");
    ...
    SetTree(CreateAXTree({ root_1, text_field_2, generic_container_3, static_text_4, inline_box_5 }));

    // TextPosition anchor_id=5 anchor_role=inlineTextBox text_offset=4
    // annotated_text=hell<o>
    TestPositionType inline_text_position = CreateTextPosition(inline_box_5, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, inline_text_position);

    // TextPosition anchor_id=2 anchor_role=textField text_offset=4
    // annotated_text=hell<o>
    TestPositionType text_field_position = CreateTextPosition(text_field_2, 4 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_field_position);
...
TEST_F(AXPositionTest, OperatorEqualsTextPositionsInSearchBox)
{
    ...
    search_box_2.AddStringAttribute(ax::mojom::StringAttribute::kHtmlTag, "input");
    ...
    SetTree(
        CreateAXTree({ root_1, search_box_2, generic_container_3, generic_container_4, static_text_5, inline_box_6, button_7, static_text_8, inline_box_9 }));

    // TextPosition anchor_role=inlineTextBox_6 text_offset=5
    // annotated_text=hello<>
    TestPositionType inline_text_position = CreateTextPosition(inline_box_6, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, inline_text_position);

    // TextPosition anchor_role=search_box_2 text_offset=5 annotated_text=hello<>
    TestPositionType search_box_position = CreateTextPosition(search_box_2, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    TestPositionType static_text_position = CreateTextPosition(static_text_8, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, static_text_position);

    // TextPosition anchor_role=button_7 text_offset=0 annotated_text=<X>
    TestPositionType button_position = CreateTextPosition(button_7, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, button_position);
...
TEST_F(AXPositionTest, OperatorsTreePositionsAroundEmbeddedCharacter)
{
    ...
    paragraph_2.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    paragraph_6.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root_1, paragraph_2, link_3, static_text_4, inline_box_5, paragraph_6, static_text_7, inline_box_8 }));

    TestPositionType before_root_1 = CreateTreePosition(root_1, 0 /* child_index */);
    ASSERT_NE(nullptr, before_root_1);
    TestPositionType middle_root_1 = CreateTreePosition(root_1, 1 /* child_index */);
    ASSERT_NE(nullptr, middle_root_1);
    TestPositionType after_root_1 = CreateTreePosition(root_1, 2 /* child_index */);
    ASSERT_NE(nullptr, after_root_1);

    TestPositionType before_paragraph_2 = CreateTreePosition(paragraph_2, 0 /* child_index */);
    ASSERT_NE(nullptr, before_paragraph_2);
    TestPositionType after_paragraph_2 = CreateTreePosition(paragraph_2, 1 /* child_index */);
    ASSERT_NE(nullptr, after_paragraph_2);

    TestPositionType before_paragraph_6 = CreateTreePosition(paragraph_6, 0 /* child_index */);
    ASSERT_NE(nullptr, before_paragraph_6);
    TestPositionType after_paragraph_6 = CreateTreePosition(paragraph_6, 1 /* child_index */);
    ASSERT_NE(nullptr, before_paragraph_6);

    TestPositionType before_inline_box_5 = CreateTreePosition(inline_box_5, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, before_inline_box_5);
    TestPositionType after_inline_box_5 = CreateTreePosition(inline_box_5, 0 /* child_index */);
    ASSERT_NE(nullptr, after_inline_box_5);

    TestPositionType before_inline_box_8 = CreateTreePosition(inline_box_8, AXNodePosition::BEFORE_TEXT /* child_index */);
    ASSERT_NE(nullptr, before_inline_box_8);
    TestPositionType after_inline_box_8 = CreateTreePosition(inline_box_8, 0 /* child_index */);
...
TEST_F(AXPositionTest, OperatorsTextPositionsAroundEmbeddedCharacter)
{
    ...
    TestPositionType before_root_1 = CreateTextPosition(root_1, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_root_1);
    TestPositionType middle_root_1 = CreateTextPosition(root_1, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_root_1);
    TestPositionType middle_root_1_upstream = CreateTextPosition(root_1, 1 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, middle_root_1_upstream);
    TestPositionType after_root_1 = CreateTextPosition(root_1, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_root_1);

    TestPositionType before_paragraph_2 = CreateTextPosition(paragraph_2, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_paragraph_2);
    // The first paragraph has a link inside it, so it will only expose a single
    // "embedded object replacement character".
    TestPositionType after_paragraph_2 = CreateTextPosition(paragraph_2, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_paragraph_2);

    TestPositionType before_paragraph_6 = CreateTextPosition(paragraph_6, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_paragraph_6);
    // The second paragraph contains "World".
    TestPositionType after_paragraph_6 = CreateTextPosition(paragraph_6, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_paragraph_6);

    TestPositionType before_inline_box_5 = CreateTextPosition(inline_box_5, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_inline_box_5);
    TestPositionType middle_inline_box_5 = CreateTextPosition(inline_box_5, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_inline_box_5);
    // "Hello".
    TestPositionType after_inline_box_5 = CreateTextPosition(inline_box_5, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_inline_box_5);

    TestPositionType before_inline_box_8 = CreateTextPosition(inline_box_8, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, before_inline_box_8);
    TestPositionType middle_inline_box_8 = CreateTextPosition(inline_box_8, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, middle_inline_box_8);
    // "World".
    TestPositionType after_inline_box_8 = CreateTextPosition(inline_box_8, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, after_inline_box_8);
    ...
    paragraph_2.RemoveBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject);
    inline_box_5.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box_8.id);
    paragraph_6.AddState(ax::mojom::State::kIgnored);
    paragraph_6.RemoveBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject);
    inline_box_8.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, inline_box_5.id);
    AXTreeUpdate update;
...
TEST_F(AXPositionTest, OperatorsLessThanAndGreaterThan)
{
    ...
    TestPositionType button_position1 = CreateTreePosition(root_, 0 /* child_index */);
    ASSERT_NE(nullptr, button_position1);
    TestPositionType button_position2 = CreateTreePosition(root_, 1 /* child_index */);
    ASSERT_NE(nullptr, button_position2);
    EXPECT_LT(*button_position1, *button_position2);
    EXPECT_GT(*button_position2, *button_position1);

    TestPositionType tree_position1 = CreateTreePosition(text_field_, 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position1);
    // An "after children" position.
    TestPositionType tree_position2 = CreateTreePosition(text_field_, 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position2);
    ...
    TestPositionType text_position1 = CreateTextPosition(inline_box1_, 2 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    TestPositionType text_position2 = CreateTextPosition(inline_box1_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ...
    ASSERT_TRUE(text_position1->IsTextPosition());
    // A "before text" position.
    text_position2 = CreateTextPosition(line_break_, 0 /* text_offset */, ax::mojom::TextAffinity::kUpstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position1 = CreateTextPosition(text_field_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(inline_box1_, 5 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position1 = CreateTextPosition(inline_box2_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    text_position2 = CreateTextPosition(line_break_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position2 = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
    ...
    text_position1 = CreateTextPosition(inline_box2_, 6 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_TRUE(text_position1->IsTextPosition());
    // Validate that we're actually at the end of the whole content by normalizing
    // to the equivalent "before character" position.
    ...
    text_position2 = CreateTextPosition(static_text2_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position2);
    ASSERT_TRUE(text_position2->IsTextPosition());
    EXPECT_GT(*text_position1, *text_position2);
    EXPECT_LT(*text_position2, *text_position1);
...
TEST_F(AXPositionTest, Swap)
{
    ...
    TestPositionType tree_position1 = CreateTreePosition(root_, 2 /* child_index */);
    ASSERT_NE(nullptr, tree_position1);
    TestPositionType tree_position2 = CreateTreePosition(text_field_, 3 /* child_index */);
    ASSERT_NE(nullptr, tree_position2);
    ...
    TestPositionType text_position = CreateTextPosition(line_break_, 1 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
...
TEST_F(AXPositionTest, CreateNextAnchorPosition)
{
    ...
    text_field_data.AddStringAttribute(ax::mojom::StringAttribute::kHtmlTag, "input");
    ...
    SetTree(CreateAXTree({ root_data, text_data, text_field_data, empty_text_data, more_text_data }));

    // Test that CreateNextAnchorPosition will successfully navigate past the
    // empty text field.
    TestPositionType text_position1 = CreateTextPosition(text_data, 8 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position1);
    ASSERT_FALSE(text_position1->CreateNextAnchorPosition()->CreateNextAnchorPosition()->IsNullPosition());
}
...
TEST_F(AXPositionTest, CreateLinePositionsMultipleAnchorsInSingleLine)
{
    ...
    inline_box1.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box2.id);
    ...
    inline_box2.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, inline_box1.id);
    inline_box2.AddIntAttribute(ax::mojom::IntAttribute::kNextOnLineId, inline_box3.id);
    ...
    inline_box3.AddIntAttribute(ax::mojom::IntAttribute::kPreviousOnLineId, inline_box2.id);

    SetTree(CreateAXTree({ root, static_text1, inline_box1, inline_block, static_text2, inline_box2, static_text3, inline_box3 }));

    TestPositionType text_position = CreateTextPosition(inline_block, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());

    TestPositionType next_line_start_position
        = text_position->CreateNextLineStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    TestPositionType previous_line_start_position
        = text_position->CreatePreviousLineStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    TestPositionType next_line_end_position
        = text_position->CreateNextLineEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    TestPositionType previous_line_end_position
        = text_position->CreatePreviousLineEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
...
TEST_F(AXPositionTest, CreateNextWordPositionInList)
{
    ...
    inline_box1.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 0 });
    inline_box1.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 3 });
    ...
    inline_box2.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 0, 6 });
    inline_box2.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 5 });
    ...
    inline_box3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 0 });
    inline_box3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 3 });
    ...
    inline_box4.role = ax::mojom::Role::kInlineTextBox;
    inline_box4.SetName("second item");
    inline_box4.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 0, 7 });
    inline_box4.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 6 });

    SetTree(CreateAXTree({ root, list, list_item1, list_marker1, static_text1, inline_box1, static_text2, inline_box2, list_item2, list_marker2, static_text3,
        inline_box3, static_text4, inline_box4 }));

    TestPositionType text_position = CreateTextPosition(inline_box1, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ...
    // "1. <f>irst item\n2. second item"
    text_position
        = text_position->CreateNextWordStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
...
TEST_F(AXPositionTest, CreatePreviousWordPositionInList)
{
    ...
    TestPositionType text_position = CreateTextPosition(inline_box4, 11 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(inline_box4.id, text_position->anchor_id());
    ...
    // "1. first item\n2. second <i>tem"
    text_position
        = text_position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, text_position);
    ASSERT_TRUE(text_position->IsTextPosition());
    ASSERT_EQ(inline_box4.id, text_position->anchor_id());
    ASSERT_EQ(7, text_position->text_offset());
...
TEST_F(AXPositionTest, EmptyObjectReplacedByCharacterTextNavigation)
{
    ...
    root_1.role = ax::mojom::Role::kRootWebArea;
    root_1.child_ids = { static_text_2.id, text_field_4.id, static_text_6.id, heading_8.id, generic_container_11.id, generic_container_12.id, static_text_13.id,
        button_14.id };
    ...
    inline_box_3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 0 });
    inline_box_3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 6 });
    ...
    inline_box_7.role = ax::mojom::Role::kInlineTextBox;
    inline_box_7.SetName(" world");
    inline_box_7.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, std::vector<int32_t> { 1 });
    inline_box_7.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, std::vector<int32_t> { 6 });
    ...
    generic_container_11.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    generic_container_11.AddState(ax::mojom::State::kIgnored);

    generic_container_12.role = ax::mojom::Role::kGenericContainer;
    generic_container_12.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    ...
    SetTree(CreateAXTree({ root_1, static_text_2, inline_box_3, text_field_4, generic_container_5, static_text_6, inline_box_7, heading_8, static_text_9,
        inline_box_10, generic_container_11, generic_container_12, static_text_13, button_14, generic_container_15, generic_container_16 }));

    // CreateNextWordStartPosition tests.
    TestPositionType position = CreateTextPosition(inline_box_3, 0 /* child_index_or_text_offset */, ax::mojom::TextAffinity::kDownstream);

    TestPositionType result_position
        = position->CreateNextWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ...
    result_position = position->CreateNextWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_TRUE(result_position->IsTextPosition());
    ...
    position = std::move(result_position);
    result_position = position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_TRUE(result_position->IsTextPosition());
    EXPECT_EQ(text_field_4.id, result_position->anchor_id());
    EXPECT_EQ(0, result_position->text_offset());
    EXPECT_EQ(ax::mojom::TextAffinity::kDownstream, result_position->affinity());
    ...
    position = std::move(result_position);
    result_position = position->CreateNextWordEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_TRUE(result_position->IsTextPosition());
    EXPECT_EQ(inline_box_3.id, result_position->anchor_id());
    ...
    position = std::move(result_position);
    result_position = position->CreatePreviousWordEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    EXPECT_TRUE(result_position->IsTextPosition());
    // The position would be on `text_field_4` instead of on `generic_container_5`
    // because the latter is ignored, and by design we prefer not to create
    // positions on ignored nodes if it could be avoided.
    ...
    position = CreateTextPosition(generic_container_5, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ...
    position = CreateTextPosition(root_1, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);

    // Hello <embedded> world<embedded><embedded>hey<embedded><embedded>
    std::u16string expected_text = base::StrCat({ u"Hello ", AXNode::kEmbeddedObjectCharacterUTF16, u" world", AXNode::kEmbeddedObjectCharacterUTF16,
        AXNode::kEmbeddedObjectCharacterUTF16, u"hey", AXNode::kEmbeddedObjectCharacterUTF16 });
    EXPECT_EQ(expected_text, position->GetText());

    // A position on an empty object that has been replaced by an "embedded object
    // replacement character".
    position = CreateTextPosition(text_field_4, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    EXPECT_EQ(AXNode::kEmbeddedObjectCharacterLengthUTF16, position->MaxTextOffset()) << *position;
    ...
    TestPositionType text_position = CreateTextPosition(generic_container_12, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);

    text_position = text_position->CreatePreviousFormatStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
    ASSERT_NE(nullptr, text_position);
    EXPECT_TRUE(text_position->IsTextPosition());
    ...
    text_position = CreateTextPosition(static_text_13, 3 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, text_position);

    text_position
        = text_position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, text_position);
    ...
    TestPositionType generic_container_position = CreateTreePosition(generic_container_16, AXNodePosition::BEFORE_TEXT);
...
TEST_F(AXPositionTest, EmptyObjectReplacedByCharacterEmbedObject)
{
    ...
    // empty object.
    TestPositionType tree_position = CreateTreePosition(embed_object, 0 /* child_index */);
    ASSERT_TRUE(tree_position->IsTreePosition());
...
TEST_F(AXPositionTest, TextNavigationWithCollapsedCombobox)
{
    ...
    inline_box_3.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, { 0 });
    ...
    menu_list_option_6.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);

    static_text_7.role = ax::mojom::Role::kStaticText;
    static_text_7.SetName("3.14");
    static_text_7.AddBoolAttribute(ax::mojom::BoolAttribute::kIsLineBreakingObject, true);
    static_text_7.child_ids = { inline_box_8.id };

    inline_box_8.role = ax::mojom::Role::kInlineTextBox;
    inline_box_8.SetName("3.14");
    inline_box_8.AddIntListAttribute(ax::mojom::IntListAttribute::kWordStarts, { 0 });
    inline_box_8.AddIntListAttribute(ax::mojom::IntListAttribute::kWordEnds, { 4 });

    SetTree(CreateAXTree({ root_1, static_text_2, inline_box_3, popup_button_4, menu_list_popup_5, menu_list_option_6, static_text_7, inline_box_8 }));

    // Collapsed - Forward navigation.
    TestPositionType position = CreateTextPosition(inline_box_3, 0, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, position);

    position = position->CreateNextParagraphStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, position);
    ...
    position = CreateTextPosition(inline_box_8, 4, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, position);

    position = position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
    ASSERT_NE(nullptr, position);
    EXPECT_EQ(popup_button_4.id, position->anchor_id());
    ...
    position = CreateTextPosition(inline_box_3, 0, ax::mojom::TextAffinity::kDownstream);
    ASSERT_NE(nullptr, position);
...
TEST_F(AXPositionTest, GetUnignoredSelectionWithLeafNodes)
{
    ...
    TestPositionType child_2_at_before_text = CreateTreePosition(child_2_data, AXNodePosition::BEFORE_TEXT);
    ...
    TestPositionType parent_at_before_text = CreateTreePosition(parent_data, AXNodePosition::BEFORE_TEXT);
    ...
    for (TestPositionType::pointer position : { parent_at_0.get(), child_1_at_0.get(), child_2_at_before_text.get() }) {
        ...
        int expected_offset = valid->AtEndOfAnchor() ? static_cast<int>(parent_node.GetChildCount()) : AXNodePosition::BEFORE_TEXT;
...
TEST_P(AXPositionExpandToEnclosingTextBoundaryTestWithParam, TextPositionBeforeLine2)
{
    ...
    TestPositionType text_position = CreateTextPosition(text_field_, 7 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position->IsTextPosition());
    TestPositionRange range = text_position->ExpandToEnclosingTextBoundary(GetParam().boundary, GetParam().expand_behavior);
...
{
    TestPositionType text_position = CreateTextPosition(static_text2_, 0 /* text_offset */, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position->IsTextPosition());
    text_position = text_position->CreatePositionAtTextBoundary(GetParam().boundary, GetParam().direction, GetParam().movement_options);
    EXPECT_NE(nullptr, text_position);
...
{
    TestPositionType text_position = CreateTextPosition(GetParam().start_node_id, GetParam().start_offset, ax::mojom::TextAffinity::kDownstream);
    ASSERT_TRUE(text_position->IsTextPosition());
...
{
    TestPositionType text_position = CreateTextPosition(GetParam().start_node_id, GetParam().start_offset, ax::mojom::TextAffinity::kUpstream);
    ASSERT_TRUE(text_position->IsTextPosition());
...
INSTANTIATE_TEST_SUITE_P(ExpandToEnclosingTextBoundary, AXPositionExpandToEnclosingTextBoundaryTestWithParam,
    ::testing::Values(ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kCharacter, AXRangeExpandBehavior::kLeftFirst,
                          ...
                          "annotated_text=Line 1\nL<i>ne 2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kCharacter, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kFormatEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=upstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kFormatEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=upstream "
            "annotated_text=Line 1\n<L>ine 2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kLineEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kLineEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStart, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStart, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStartOrEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStartOrEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kObject, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kObject, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStart, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStart, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStartOrEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStartOrEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStart, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStart, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStartOrEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStartOrEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=13 affinity=downstream "
            "annotated_text=Line 1\nLine 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWebPage, AXRangeExpandBehavior::kLeftFirst,
        ...
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWebPage, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=1 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2",
            "TextPosition anchor_id=9 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWordEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=11 affinity=downstream "
            "annotated_text=Line 1\nLine< >2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWordEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<\n>Line 2",
            "TextPosition anchor_id=4 text_offset=11 affinity=downstream "
            "annotated_text=Line 1\nLine< >2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStart, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=12 affinity=downstream "
            "annotated_text=Line 1\nLine <2>" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStart, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=5 affinity=downstream "
            "annotated_text=Line <1>\nLine 2",
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStartOrEnd, AXRangeExpandBehavior::kLeftFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=11 affinity=downstream "
            "annotated_text=Line 1\nLine< >2" },
        ExpandToEnclosingTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStartOrEnd, AXRangeExpandBehavior::kRightFirst,
            "TextPosition anchor_id=4 text_offset=7 affinity=downstream "
            "annotated_text=Line 1\n<L>ine 2",
            "TextPosition anchor_id=4 text_offset=11 affinity=downstream "
            "annotated_text=Line 1\nLine< >2" }));
...
INSTANTIATE_TEST_SUITE_P(CreatePositionAtTextBoundary, AXPositionCreatePositionAtTextBoundaryTestWithParam,
    ::testing::Values(CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kCharacter, ax::mojom::MoveDirection::kBackward,
                          { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
                          "TextPosition anchor_id=7 text_offset=0 affinity=downstream "
                          "annotated_text=<\n>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kCharacter, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=1 affinity=downstream "
            "annotated_text=L<i>ne 2" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kFormatStart, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=7 text_offset=0 affinity=downstream "
            "annotated_text=<\n>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kFormatEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kLineEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=7 text_offset=0 affinity=downstream "
            "annotated_text=<\n>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kLineEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStart, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStart, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition }, "NullPosition" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStartOrEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kLineStartOrEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kObject, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 2" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kObject, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStart, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStart, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition }, "NullPosition" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStartOrEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kParagraphStartOrEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStart, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStart, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition }, "NullPosition" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStartOrEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kSentenceStartOrEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWebPage, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=1 text_offset=0 affinity=downstream "
            "annotated_text=<L>ine 1\nLine 2" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWebPage, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=9 text_offset=6 affinity=downstream "
            "annotated_text=Line 2<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWordEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=6 affinity=downstream "
            "annotated_text=Line 1<>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWordEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=4 affinity=downstream "
            "annotated_text=Line< >2" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStart, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=5 affinity=downstream "
            "annotated_text=Line <1>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStart, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=5 affinity=downstream "
            "annotated_text=Line <2>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStartOrEnd, ax::mojom::MoveDirection::kBackward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=6 text_offset=5 affinity=downstream "
            "annotated_text=Line <1>" },
        CreatePositionAtTextBoundaryTestParam { ax::mojom::TextBoundary::kWordStartOrEnd, ax::mojom::MoveDirection::kForward,
            { AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition },
            "TextPosition anchor_id=8 text_offset=4 affinity=downstream "
            "annotated_text=Line< >2" }));

INSTANTIATE_TEST_SUITE_P(CreateNextSentenceStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
        ...
        TextNavigationTestParam {
            ...
            INLINE_BOX2_ID, 4 /* text_offset */, { "NullPosition" } }));

INSTANTIATE_TEST_SUITE_P(CreateNextSentenceStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
        ...
        TextNavigationTestParam {
            ...
            INLINE_BOX2_ID, 4 /* text_offset */,
            { "TextPosition anchor_id=9 text_offset=6 "
              "affinity=downstream annotated_text=Line 2<>",
                "TextPosition anchor_id=9 text_offset=6 "
                "affinity=downstream annotated_text=Line 2<>" } }));

INSTANTIATE_TEST_SUITE_P(CreateNextSentenceStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
...
INSTANTIATE_TEST_SUITE_P(CreateNextSentenceStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
                          ...
                          { "TextPosition anchor_id=1 text_offset=7 "
                            "affinity=downstream annotated_text=Line 1\n<L>ine 2",
                              ...
                              "TextPosition anchor_id=1 text_offset=13 "
                              "affinity=downstream annotated_text=Line 1\nLine 2<>" } },
        TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
                                     return position->CreateNextSentenceStartPosition(
                                         { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
                                 }),
            TEXT_FIELD_ID, 0 /* text_offset */,
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
                "TextPosition anchor_id=1 text_offset=0 "
                "affinity=downstream annotated_text=<L>ine 1\nLine 2",
        ...
        TextNavigationTestParam {
            ...
            TEXT_FIELD_ID, 13 /* text_offset at end of text field */,
            { "TextPosition anchor_id=4 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
                "TextPosition anchor_id=4 text_offset=0 "
                "affinity=downstream annotated_text=<L>ine 1\nLine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
                                                   return position->CreatePreviousSentenceStartPosition(
                                                       { AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
                                               }),
                          ROOT_ID, 13 /* text_offset at end of root. */,
                          { "TextPosition anchor_id=1 text_offset=7 "
                            "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary,
    AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
                                                   return position->CreatePreviousSentenceStartPosition(
                                                       { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
                                               }),
                          ROOT_ID, 13 /* text_offset */,
                          { "TextPosition anchor_id=1 text_offset=7 "
                            "affinity=downstream annotated_text=Line 1\n<L>ine 2",
                              "TextPosition anchor_id=1 text_offset=0 "
                              "affinity=downstream annotated_text=<L>ine 1\nLine 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextSentenceEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
...
INSTANTIATE_TEST_SUITE_P(CreateNextSentenceEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextSentenceEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextSentenceEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextSentenceEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
        ...
        TextNavigationTestParam {
            ...
            STATIC_TEXT1_ID, 5 /* text_offset */, { "NullPosition" } },
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousSentenceEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousSentenceEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
                                                   return position->CreatePreviousSentenceEndPosition(
                                                       { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
                                               }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=5 "
              "affinity=downstream annotated_text=Line <1>\nLine 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=5 "
              "affinity=downstream annotated_text=Line <1>\nLine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=12 "
              "affinity=downstream annotated_text=Line 1\nLine <2>",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=12 "
              "affinity=downstream annotated_text=Line 1\nLine <2>",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=4 "
              "affinity=downstream annotated_text=Line< >1\nLine 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextWordEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextWordEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=4 "
              "affinity=downstream annotated_text=Line< >1\nLine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=11 "
              "affinity=downstream annotated_text=Line 1\nLine< >2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=11 "
              "affinity=downstream annotated_text=Line 1\nLine< >2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousWordEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousWordEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineStartPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at the end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
                "TextPosition anchor_id=1 text_offset=0 "
                "affinity=downstream annotated_text=<L>ine 1\nLine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at the end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextLineEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextLineEndPosition({ AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
        ...
        TextNavigationTestParam {
            ...
            ROOT_ID, 5 /* text_offset on the last character of "Line 1". */, { "NullPosition" } },
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            TEXT_FIELD_ID, 5 /* text_offset on the last character of "Line 1". */, { "NullPosition" } },
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
        ...
        TextNavigationTestParam {
            ...
            INLINE_BOX2_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=7 text_offset=0 "
              "affinity=downstream annotated_text=<\n>",
                "NullPosition" } }));

INSTANTIATE_TEST_SUITE_P(CreatePreviousLineEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousLineEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),

            ROOT_ID, 12 /* text_offset one before the end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
                "TextPosition anchor_id=1 text_offset=6 "
                "affinity=downstream annotated_text=Line 1<\n>Line 2" } },
        TextNavigationTestParam {
            ...
            TEXT_FIELD_ID, 12 /* text_offset one before the end of text field */,
            { "TextPosition anchor_id=4 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
                "TextPosition anchor_id=4 text_offset=6 "
                "affinity=downstream annotated_text=Line 1<\n>Line 2" } },
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousLineEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2" } },
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphStartPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphStartPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
                                                   return position->CreateNextParagraphStartPosition(
                                                       { AXBoundaryBehavior::kStopAtLastAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
                                               }),
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphStartPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphStartPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at the end of root. */,
            { "TextPosition anchor_id=1 text_offset=7 "
              "affinity=downstream annotated_text=Line 1\n<L>ine 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphStartPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphStartPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary,
    AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
                                                   return position->CreatePreviousParagraphStartPosition(
                                                       { AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
                                               }),
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 0 /* text_offset */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreateNextParagraphEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreateNextParagraphEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
        ...
        TextNavigationTestParam {
            ...
            LINE_BREAK_ID, 1 /* text_offset */,
            { "TextPosition anchor_id=7 text_offset=1 affinity=downstream "
              "annotated_text=\n<>",
                "TextPosition anchor_id=7 text_offset=1 affinity=downstream "
                "annotated_text=\n<>" } }));

INSTANTIATE_TEST_SUITE_P(CreateNextParagraphEndPositionWithBoundaryBehaviorStopAtLastAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphEndPositionWithBoundaryBehaviorCrossBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kCrossBoundary, AXBoundaryDetection::kDontCheckInitialPosition });
            }),
            ROOT_ID, 13 /* text_offset at end of root. */,
            { "TextPosition anchor_id=1 text_offset=6 "
              "affinity=downstream annotated_text=Line 1<\n>Line 2",
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphEndPositionWithBoundaryBehaviorStopAtAnchorBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(TextNavigationTestParam { base::BindRepeating([](const TestPositionType& position) {
...
INSTANTIATE_TEST_SUITE_P(CreatePreviousParagraphEndPositionWithBoundaryBehaviorStopAtAnchorBoundaryOrIfAlreadyAtBoundary, AXPositionTextNavigationTestWithParam,
    ::testing::Values(
        TextNavigationTestParam {
            base::BindRepeating([](const TestPositionType& position) {
                return position->CreatePreviousParagraphEndPosition({ AXBoundaryBehavior::kStopAtAnchorBoundary, AXBoundaryDetection::kCheckInitialPosition });
            }),
