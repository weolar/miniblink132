...
// accessibility tree.
class AX_EXPORT AXTreeSourceAdapter : public AXTreeSource<const AXNode*, AXTreeData*, AXNodeData> {
public:
    explicit AXTreeSourceAdapter(AXTree* tree)
        : tree_(tree)
    {
    }
...
AXTreeSource<const AXNode*, AXTreeData*, AXNodeData>* AXSerializableTree::CreateTreeSource()
{
