...
TEST(AXSelectionTest, UnignoredSelection)
{
    ...
    TestSingleAXTreeManager test_ax_tree_manager(std::make_unique<AXTree>(tree_update));
    AXSelection unignored_selection = test_ax_tree_manager.GetTree()->GetUnignoredSelection();
