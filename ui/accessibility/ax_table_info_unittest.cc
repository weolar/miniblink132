...
void MakeCell(AXNodeData* cell, int id, int row_index, int col_index, int row_span = 1, int col_span = 1)
{
    cell->id = id;
    cell->role = ax::mojom::Role::kCell;
    cell->AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, row_index);
    cell->AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, col_index);
    if (row_span > 1)
        cell->AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowSpan, row_span);
    if (col_span > 1)
        cell->AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnSpan, col_span);
}

void MakeColumnHeader(AXNodeData* cell, int id, int row_index, int col_index, int row_span = 1, int col_span = 1)
{
    MakeCell(cell, id, row_index, col_index, row_span, col_span);
    cell->role = ax::mojom::Role::kColumnHeader;
}

void MakeRowHeader(AXNodeData* cell, int id, int row_index, int col_index, int row_span = 1, int col_span = 1)
{
    MakeCell(cell, id, row_index, col_index, row_span, col_span);
...
TEST_F(AXTableInfoTest, ExtraMacNodes)
{
    ...
    EXPECT_EQ(true, extra_node_0->HasIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds));
    indirect_child_ids = extra_node_0->GetIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds);
    ...
    EXPECT_EQ(true, extra_node_1->HasIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds));
    indirect_child_ids = extra_node_1->GetIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds);
    EXPECT_EQ(2U, indirect_child_ids.size());
    ...
    indirect_child_ids.clear();
    EXPECT_EQ(true, extra_node_2->HasIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds));
    indirect_child_ids = extra_node_2->GetIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds);
    EXPECT_EQ(2U, indirect_child_ids.size());
    EXPECT_EQ(4, indirect_child_ids[0]);
...
TEST_F(AXTableInfoTest, TableWithNoRows)
{
    ...
    initial_state.nodes[1].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellRowIndex, 0);
    initial_state.nodes[1].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellColumnIndex, 0);
    initial_state.nodes[2].id = 12;
    initial_state.nodes[2].role = ax::mojom::Role::kCell;
    initial_state.nodes[2].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellRowIndex, 0);
    initial_state.nodes[2].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellColumnIndex, 1);
    initial_state.nodes[3].id = 13;
    initial_state.nodes[3].role = ax::mojom::Role::kCell;
    initial_state.nodes[3].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellRowIndex, 1);
    initial_state.nodes[3].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellColumnIndex, 0);
    initial_state.nodes[4].id = 14;
    initial_state.nodes[4].role = ax::mojom::Role::kCell;
    initial_state.nodes[4].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellRowIndex, 1);
    initial_state.nodes[4].int_attributes.emplace_back(ax::mojom::IntAttribute::kTableCellColumnIndex, 1);
    AXTree tree(initial_state);
    AXNode* table = tree.root();
...
TEST_F(AXTableInfoTest, TableWithPartialIndices)
{
    ...
    AXTreeUpdate update = initial_state;
    update.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::kTableColumnCount, 5);
    update.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::kTableRowCount, 2);
    update.nodes[5].AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, 2);
    update.nodes[5].AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 0);
    update.nodes[6].AddIntAttribute(ax::mojom::IntAttribute::kTableCellRowIndex, 2);
    update.nodes[6].AddIntAttribute(ax::mojom::IntAttribute::kTableCellColumnIndex, 2);
    EXPECT_TRUE(tree.Unserialize(update));
...
TEST_F(AXTableInfoTest, AriaIndicesInferred)
{
    ...
    initial_state.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::kAriaRowCount, 5);
    initial_state.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::kAriaColumnCount, 5);
    initial_state.nodes[0].child_ids = { 2, 3, 4 };
    MakeRow(&initial_state.nodes[1], 2, 0);
    initial_state.nodes[1].child_ids = { 5, 6, 7 };
    MakeRow(&initial_state.nodes[2], 3, 1);
    initial_state.nodes[2].AddIntAttribute(ax::mojom::IntAttribute::kAriaCellRowIndex, 4);
    initial_state.nodes[2].child_ids = { 8, 9, 10 };
    MakeRow(&initial_state.nodes[3], 4, 2);
    initial_state.nodes[3].AddIntAttribute(ax::mojom::IntAttribute::kAriaCellRowIndex, 4);
    initial_state.nodes[3].child_ids = { 11, 12, 13 };
    MakeCell(&initial_state.nodes[4], 5, 0, 0);
    initial_state.nodes[4].AddIntAttribute(ax::mojom::IntAttribute::kAriaCellRowIndex, 2);
    initial_state.nodes[4].AddIntAttribute(ax::mojom::IntAttribute::kAriaCellColumnIndex, 2);
    MakeCell(&initial_state.nodes[5], 6, 0, 1);
    ...
    initial_state.nodes[10].AddIntAttribute(ax::mojom::IntAttribute::kAriaCellColumnIndex, 3);
    MakeCell(&initial_state.nodes[11], 12, 2, 1);
    initial_state.nodes[11].AddIntAttribute(ax::mojom::IntAttribute::kAriaCellColumnIndex, 2);
    MakeCell(&initial_state.nodes[12], 13, 2, 2);
    initial_state.nodes[12].AddIntAttribute(ax::mojom::IntAttribute::kAriaCellColumnIndex, 1);
    AXTree tree(initial_state);
    AXNode* table = tree.root();
