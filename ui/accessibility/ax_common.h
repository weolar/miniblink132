...
#if (!defined(NDEBUG) || defined(ADDRESS_SANITIZER) || defined(LEAK_SANITIZER) || defined(MEMORY_SANITIZER) || defined(THREAD_SANITIZER)                       \
    || defined(UNDEFINED_SANITIZER) || DCHECK_IS_ON())                                                                                                         \
    && BUILDFLAG(USE_BLINK)
