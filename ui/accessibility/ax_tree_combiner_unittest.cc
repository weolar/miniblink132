...
TEST(CombineAXTreesTest, MapAllIdAttributes)
{
    ...
    tree.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::kTableColumnHeaderId, 22);
    tree.nodes[0].AddIntAttribute(ax::mojom::IntAttribute::kActivedescendantId, 22);
    std::vector<AXNodeID> ids { 22 };
    tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds, ids);
    tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::kControlsIds, ids);
    tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::kDescribedbyIds, ids);
    tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::kFlowtoIds, ids);
    tree.nodes[0].AddIntListAttribute(ax::mojom::IntListAttribute::kLabelledbyIds, ids);
    tree.nodes[1].id = 22;
    tree.nodes[2].id = 100;
    ...
    EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(ax::mojom::IntAttribute::kTableHeaderId));
    EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(ax::mojom::IntAttribute::kTableRowHeaderId));
    EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(ax::mojom::IntAttribute::kTableColumnHeaderId));
    EXPECT_EQ(2, combined.nodes[0].GetIntAttribute(ax::mojom::IntAttribute::kActivedescendantId));
    EXPECT_EQ(2, combined.nodes[0].GetIntListAttribute(ax::mojom::IntListAttribute::kIndirectChildIds)[0]);
    EXPECT_EQ(2, combined.nodes[0].GetIntListAttribute(ax::mojom::IntListAttribute::kControlsIds)[0]);
    EXPECT_EQ(2, combined.nodes[0].GetIntListAttribute(ax::mojom::IntListAttribute::kDescribedbyIds)[0]);
    EXPECT_EQ(2, combined.nodes[0].GetIntListAttribute(ax::mojom::IntListAttribute::kFlowtoIds)[0]);
    EXPECT_EQ(2, combined.nodes[0].GetIntListAttribute(ax::mojom::IntListAttribute::kLabelledbyIds)[0]);
}
