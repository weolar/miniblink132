...
private:
    ...
    void BuildCellDataVectorFromCellNodes(const std::vector<std::vector<AXNode*>>& cell_nodes_per_row);
    void BuildCellData(AXNode* cell, AXNode* row_or_first_cell, CellBuildState& state);
