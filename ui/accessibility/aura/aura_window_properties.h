...
AX_EXPORT extern const aura::WindowProperty<ax::mojom::Role>* const kAXRoleOverride;
...
AX_EXPORT extern const aura::WindowProperty<bool>* const kAXConsiderInvisibleAndIgnoreChildren;
