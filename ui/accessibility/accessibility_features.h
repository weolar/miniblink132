...
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kAccessibilityPruneRedundantInlineConnectivity);
...
// feature.
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kExperimentalAccessibilityDictationContextChecking);
AX_BASE_EXPORT bool IsExperimentalAccessibilityDictationContextCheckingEnabled();

// Download Google TTS High Quality voices.
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kExperimentalAccessibilityGoogleTtsHighQualityVoices);
AX_BASE_EXPORT bool IsExperimentalAccessibilityGoogleTtsHighQualityVoicesEnabled();
...
// limit.
AX_BASE_EXPORT const base::FeatureParam<int> kAccessibilitySnapshotStressTestsMaxNodes { &kAccessibilitySnapshotStressTests,
...
AX_BASE_EXPORT BASE_DECLARE_FEATURE(kReadAnythingReadAloudAutomaticWordHighlighting);
