...
{
    experimental_flags_ = value ? (experimental_flags_ | experimental_flag) : (experimental_flags_ & ~experimental_flag);
}
...
std::string AXMode::ToString() const
{
    ...
    for (uint32_t mode_flag = AXMode::kFirstModeFlag; mode_flag <= AXMode::kLastModeFlag; mode_flag = mode_flag << 1) {
    ...
    for (uint32_t experimental_mode_flag = AXMode::kExperimentalFirstFlag; experimental_mode_flag <= AXMode::kExperimentalLastFlag;
