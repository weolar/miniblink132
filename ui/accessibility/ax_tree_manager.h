...
public:
    ...
    static void AlwaysFailFast()
    {
        is_fail_fast_mode_ = true;
    }
    static bool IsFailFastMode()
    {
        return is_fail_fast_mode_;
    }
    ...
    virtual void FireGeneratedEvent(AXEventGenerator::Event event_type, const AXNode* node)
    {
    }
    ...
    const AXEventGenerator& event_generator() const
    {
        return event_generator_;
    }
    AXEventGenerator& event_generator()
    {
        return event_generator_;
    }
