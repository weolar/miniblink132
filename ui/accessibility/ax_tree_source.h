...
public:
    ...
    virtual void SerializeNode(AXNodeSource node, AXNodeDataType* out_data) const = 0;
    ...
    virtual void AddObserver(AXTreeSourceObserver<AXNodeSource, AXTreeDataType, AXNodeDataType>* observer)
    {
        NOTIMPLEMENTED();
    }

    virtual void RemoveObserver(AXTreeSourceObserver<AXNodeSource, AXTreeDataType, AXNodeDataType>* observer)
    {
        NOTIMPLEMENTED();
    }
