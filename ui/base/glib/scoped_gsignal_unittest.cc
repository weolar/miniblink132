...
{
    g_signal_newv("some-signal", test_object_get_type(), (GSignalFlags)(G_SIGNAL_RUN_LAST | G_SIGNAL_NO_RECURSE | G_SIGNAL_NO_HOOKS), nullptr, nullptr, nullptr,
        nullptr, G_TYPE_NONE, 0, nullptr);
}
...
TEST(ScopedGSignalTest, Construction)
{
    ...
    ScopedGSignal signal(instance, "some-signal", base::BindRepeating([](GObject* obj) {}));
...
TEST(ScopedGSignalTest, DisconnectsOnDestruction)
{
    ...
    {
        ScopedGSignal signal(instance, "some-signal", base::BindRepeating([](bool* fired, GObject* obj) { *fired = true; }, &signal_fired));
        EXPECT_TRUE(signal.Connected());
    }
...
TEST(ScopedGSignalTest, MoveConstruct)
{
    ...
    ScopedGSignal signal1(instance, "some-signal", base::BindRepeating([](GObject* obj) {}));
...
TEST(ScopedGSignalTest, InvalidSignal)
{
    ...
    ScopedGSignal signal(instance, "invalid-signal", base::BindRepeating([](GObject* obj) {}));
    EXPECT_FALSE(signal.Connected());
}
