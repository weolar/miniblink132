...
public:
    explicit ScopedSetSupportedResourceScaleFactors(const std::vector<ResourceScaleFactor>& new_scale_factors);
    ScopedSetSupportedResourceScaleFactors(const ScopedSetSupportedResourceScaleFactors&) = delete;
    ScopedSetSupportedResourceScaleFactors& operator=(const ScopedSetSupportedResourceScaleFactors&) = delete;
