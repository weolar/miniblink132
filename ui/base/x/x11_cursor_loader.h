...
public:
    ...
    XCursorLoader(x11::Connection* connection, base::RepeatingClosure on_cursor_config_changed);
    ...
    scoped_refptr<X11Cursor> CreateCursor(const SkBitmap& bitmap, const gfx::Point& hotspot);

private:
    friend class XCursorLoaderTest;

    void LoadCursorImpl(scoped_refptr<X11Cursor> cursor, const std::vector<std::string>& names, const std::vector<XCursorLoader::Image>& images);
    ...
    void OnPropertyChanged(x11::Atom property, const x11::GetPropertyResponse& value);
