...
class COMPONENT_EXPORT(UI_BASE_X) XGlobalShortcutListener : public PlatformEventDispatcher {
public:
...
protected:
    ...
    void StartListening();
    void StopListening();
    bool RegisterAccelerator(KeyboardCode key_code, bool is_alt_down, bool is_ctrl_down, bool is_shift_down);
    void UnregisterAccelerator(KeyboardCode key_code, bool is_alt_down, bool is_ctrl_down, bool is_shift_down);
