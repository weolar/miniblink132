...
class COMPONENT_EXPORT(UI_BASE_X) XOSExchangeDataProvider : public OSExchangeDataProvider {
public:
    ...
    XOSExchangeDataProvider(x11::Window x_window, x11::Window source_window, const SelectionFormatMap& selection);
    ...
    void SetPickledData(const ClipboardFormatType& format, const base::Pickle& pickle) override;
    ...
    void SetDragImage(const gfx::ImageSkia& image, const gfx::Vector2d& cursor_offset) override;
...
protected:
    ...
    bool own_window() const
    {
        return own_window_;
    }
    x11::Window x_window() const
    {
        return x_window_;
    }
    const SelectionFormatMap& format_map() const
    {
        return format_map_;
    }
    ...
    SelectionOwner& selection_owner() const
    {
    ...
    void InsertData(x11::Atom format, const scoped_refptr<base::RefCountedMemory>& data);
