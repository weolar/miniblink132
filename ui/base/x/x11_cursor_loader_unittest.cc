...
namespace {
std::vector<XCursorLoader::Image> ParseFile(base::span<const uint32_t> data, uint32_t preferred_size)
{
    ...
    return ParseCursorFile(base::MakeRefCounted<base::RefCountedBytes>(std::move(vec)), preferred_size);
}
