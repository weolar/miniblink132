...
class COMPONENT_EXPORT(UI_BASE_X) XDisplayManager : public X11WorkspaceHandler::Delegate {
public:
    class Delegate;
...
private:
    ...
    void SetDisplayList(std::vector<display::Display> displays, size_t primary_display_index);
