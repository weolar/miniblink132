...
public:
    ...
    X11SoftwareBitmapPresenter(x11::Connection& connection, gfx::AcceleratedWidget widget, bool enable_multibuffering);

    X11SoftwareBitmapPresenter(const X11SoftwareBitmapPresenter&) = delete;
    X11SoftwareBitmapPresenter& operator=(const X11SoftwareBitmapPresenter&) = delete;
