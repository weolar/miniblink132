...
class COMPONENT_EXPORT(UI_BASE_X) X11CursorFactory : public CursorFactory, public CursorThemeManagerObserver {
public:
    X11CursorFactory();
...
#if BUILDFLAG(IS_LINUX)
    base::ScopedObservation<LinuxUi, CursorThemeManagerObserver> cursor_theme_observation_ { this };
#endif
};
