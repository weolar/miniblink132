...
class DragSourceWin : public Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>, IDropSource> {
public:
    // Factory method to avoid exporting the class and all it derives from.
    static COMPONENT_EXPORT(UI_BASE) Microsoft::WRL::ComPtr<DragSourceWin> Create();
    ...
    // terminates.
    void set_data(const OSExchangeData* data)
    {
        data_ = data;
    }
