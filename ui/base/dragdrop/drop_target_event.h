...
public:
    DropTargetEvent(const OSExchangeData& data, const gfx::PointF& location, const gfx::PointF& root_location, int source_operations);
    ...
    int source_operations() const
    {
        return source_operations_;
    }
