...
class COMPONENT_EXPORT(UI_BASE) OSExchangeDataProviderMac : public OSExchangeDataProvider {
public:
    ...
    // object.
    static std::unique_ptr<OSExchangeDataProviderMac> CreateProviderWrappingPasteboard(NSPasteboard* pasteboard);
