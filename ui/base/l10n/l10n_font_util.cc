...
int GetLocalizedContentsWidthForFontList(int col_resource_id, const gfx::FontList& font_list)
{
    int chars = 0;
...
int GetLocalizedContentsHeightForFontList(int row_resource_id, const gfx::FontList& font_list)
{
    int lines = 0;
