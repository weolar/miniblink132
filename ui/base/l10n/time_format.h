...
public:
    ...
    static std::u16string Simple(Format format, Length length, const base::TimeDelta& delta);
    ...
    static std::u16string SimpleWithMonthAndYear(Format format, Length length, const base::TimeDelta& delta, bool use_month_and_year);

    // Equivalent to
    // DetailedWithMonthAndYear(format, length, cutoff, delta, false);
    static std::u16string Detailed(Format format, Length length, int cutoff, const base::TimeDelta& delta);
    ...
    static std::u16string DetailedWithMonthAndYear(Format format, Length length, int cutoff, const base::TimeDelta& delta, bool use_month_and_year);
    ...
    static std::u16string RelativeDate(const base::Time& time, const base::Time* optional_midnight_today);
};
