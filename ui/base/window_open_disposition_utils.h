...
WindowOpenDisposition DispositionFromClick(bool middle_button, bool alt_key, bool ctrl_key, bool meta_key, bool shift_key,
    WindowOpenDisposition disposition_for_current_tab = WindowOpenDisposition::CURRENT_TAB);

// As with DispositionFromClick(), but using |event_flags| as in ui::MouseEvent.
COMPONENT_EXPORT(UI_BASE)
WindowOpenDisposition DispositionFromEventFlags(int event_flags, WindowOpenDisposition disposition_for_current_tab = WindowOpenDisposition::CURRENT_TAB);
