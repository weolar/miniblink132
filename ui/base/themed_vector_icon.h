...
public:
    ThemedVectorIcon();
    explicit ThemedVectorIcon(const gfx::VectorIcon* icon, ColorId color_id = kColorMenuIcon, int icon_size = 0, const gfx::VectorIcon* badge = nullptr);
    ...
    // removed.
    ThemedVectorIcon(const gfx::VectorIcon* icon, SkColor color, int icon_size = 0, const gfx::VectorIcon* badge = nullptr);
    ...
    gfx::ImageSkia GetImageSkia(const ColorProvider* color_provider, int icon_size) const;
