...
#define IMAGE_GRID(x)                                                                                                                                          \
    {                                                                                                                                                          \
        x##_TOP_LEFT, x##_TOP, x##_TOP_RIGHT, x##_LEFT, x##_CENTER, x##_RIGHT, x##_BOTTOM_LEFT, x##_BOTTOM, x##_BOTTOM_RIGHT,                                  \
    }
...
#define IMAGE_GRID_NO_CENTER(x)                                                                                                                                \
    {                                                                                                                                                          \
        x##_TOP_LEFT, x##_TOP, x##_TOP_RIGHT, x##_LEFT, EMPTY_IMAGE, x##_RIGHT, x##_BOTTOM_LEFT, x##_BOTTOM, x##_BOTTOM_RIGHT,                                 \
    }
...
#define IMAGE_GRID_HORIZONTAL(x)                                                                                                                               \
    {                                                                                                                                                          \
        x##_LEFT, x##_CENTER, x##_RIGHT, EMPTY_IMAGE, EMPTY_IMAGE, EMPTY_IMAGE, EMPTY_IMAGE, EMPTY_IMAGE, EMPTY_IMAGE                                          \
    }
...
#define IMAGE_GRID_VERTICAL(x)                                                                                                                                 \
    {                                                                                                                                                          \
        x##_TOP, EMPTY_IMAGE, EMPTY_IMAGE, x##_CENTER, EMPTY_IMAGE, EMPTY_IMAGE, x##_BOTTOM, EMPTY_IMAGE, EMPTY_IMAGE                                          \
    }
...
std::unique_ptr<gfx::NineImagePainter> CreateNineImagePainter(const int image_ids[]);
