...
// be unaltered.
COMPONENT_EXPORT(UI_BASE)
std::string ReplaceTemplateExpressions(std::string_view source, const TemplateReplacements& replacements, bool skip_unexpected_placeholder_check = false);
...
//     _template: html` ... `,
COMPONENT_EXPORT(UI_BASE)
bool ReplaceTemplateExpressionsInJS(std::string_view source, const TemplateReplacements& replacements, std::string* output);
