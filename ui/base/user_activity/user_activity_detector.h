...
class COMPONENT_EXPORT(UI_BASE) UserActivityDetector : public PlatformEventObserver {
public:
    ...
    std::string last_activity_name() const
    {
        return last_activity_name_;
    }

    void set_now_for_test(base::TimeTicks now)
    {
        now_for_test_ = now;
    }
