...
zcr_extended_text_input_v1_input_type ConvertFromTextInputType(TextInputType text_input_type)
{
...
zcr_extended_text_input_v1_input_mode ConvertFromTextInputMode(TextInputMode text_input_mode)
{
