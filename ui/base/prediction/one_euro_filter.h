...
public:
    OneEuroFilter(double mincutoff = kDefaultMincutoff, double beta = kDefaultBeta);
    ...
    bool Filter(const base::TimeTicks& timestamp, gfx::PointF* position) const override;
