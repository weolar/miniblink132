...
class COMPONENT_EXPORT(UI_BASE_PREDICTION) KalmanPredictor : public InputPredictor {
public:
    ...
    enum PredictionOptions { kNone = 0x0, kHeuristicsEnabled = 0x1, kDirectionCutOffEnabled = 0x2 };
    ...
    std::unique_ptr<InputData> GeneratePrediction(base::TimeTicks predict_time, base::TimeDelta frame_interval) override;
