...
public:
    ...
    void SetUp() override
    {
        predictor_ = std::make_unique<LinearPredictor>(LinearPredictor::EquationOrder::kFirstOrder);
    }
};
...
public:
    ...
    LinearPredictorSecondOrderTest(const LinearPredictorSecondOrderTest&) = delete;
    LinearPredictorSecondOrderTest& operator=(const LinearPredictorSecondOrderTest&) = delete;

    void SetUp() override
    {
        predictor_ = std::make_unique<LinearPredictor>(LinearPredictor::EquationOrder::kSecondOrder);
    }
};
