...
class COMPONENT_EXPORT(UI_BASE_PREDICTION) LinearResampling : public InputPredictor {
public:
    ...
    std::unique_ptr<InputData> GeneratePrediction(base::TimeTicks frame_time, base::TimeDelta frame_interval) override;
