...
#define _METADATA_HEADER2(new_class_name, ancestor_class_name)                                                                                                 \
    static_assert(ui::metadata::kHasClassMetadata<ancestor_class_name>,                                                                                        \
        #ancestor_class_name " doesn't implement metadata. Make "                                                                                              \
...
#define METADATA_HEADER(class_name, ancestor_class_name) _METADATA_HEADER2(class_name, ancestor_class_name)
...
#define DECLARE_TEMPLATE_METADATA(class_name_alias, template_name)                                                                                             \
    DECLARE_TEMPLATE_METADATA_INTERNAL(class_name_alias, METADATA_CLASS_NAME_INTERNAL(template_name))
