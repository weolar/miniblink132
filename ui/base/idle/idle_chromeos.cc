...
{
    const base::TimeDelta idle_time = base::TimeTicks::Now() - ui::UserActivityDetector::Get()->last_activity_time();
...
bool CheckIdleStateIsLocked()
{
    ...
    // locked.
    return ash::SessionManagerClient::Get() && ash::SessionManagerClient::Get()->IsScreenLocked();
}
