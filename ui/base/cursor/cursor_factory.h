...
public:
    ...
    virtual scoped_refptr<PlatformCursor> GetDefaultCursor(mojom::CursorType type, float scale);
    ...
    // `hotspot` and `scale`.
    virtual scoped_refptr<PlatformCursor> CreateImageCursor(mojom::CursorType type, const SkBitmap& bitmap, const gfx::Point& hotspot, float scale);
