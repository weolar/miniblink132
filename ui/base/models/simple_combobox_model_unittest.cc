...
TEST(SimpleComboboxModelTest, StringItems)
{
    std::vector<ui::SimpleComboboxModel::Item> items
        = { ui::SimpleComboboxModel::Item(u"item0"), ui::SimpleComboboxModel::Item::CreateSeparator(), ui::SimpleComboboxModel::Item(u"item2") };
    ...
    // Update items.
    model.UpdateItemList({ ui::SimpleComboboxModel::Item(u"item3"), ui::SimpleComboboxModel::Item(u"item4") });
...
{
    ui::SimpleComboboxModel::Item item16(u"Text16", u"SecondaryText16", ui::ImageModel::FromImage(gfx::test::CreateImage(16, 16)));

    ui::SimpleComboboxModel::Item item20(u"Text20", u"SecondaryText20", ui::ImageModel::FromImage(gfx::test::CreateImage(20, 20)));
