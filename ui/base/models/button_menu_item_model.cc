...
bool ButtonMenuItemModel::Delegate::IsItemForCommandIdDynamic(int command_id) const
{
    return false;
}

std::u16string ButtonMenuItemModel::Delegate::GetLabelForCommandId(int command_id) const
{
...
bool ButtonMenuItemModel::Delegate::DoesCommandIdDismissMenu(int command_id) const
{
    return true;
}

bool ButtonMenuItemModel::Delegate::GetAcceleratorForCommandId(int command_id, ui::Accelerator* accelerator) const
{
    return false;
}
...
ButtonMenuItemModel::ButtonMenuItemModel(int string_id, ButtonMenuItemModel::Delegate* delegate)
...
void ButtonMenuItemModel::AddGroupItemWithStringId(int command_id, int string_id)
{
    Item item = { command_id, TYPE_BUTTON, l10n_util::GetStringUTF16(string_id), true };
...
{
    Item item = { command_id, TYPE_BUTTON_LABEL, l10n_util::GetStringUTF16(string_id), false };
    items_.push_back(item);
}
...
ButtonMenuItemModel::ButtonType ButtonMenuItemModel::GetTypeAt(size_t index) const
{
...
bool ButtonMenuItemModel::GetAcceleratorAt(size_t index, ui::Accelerator* accelerator) const
{
    return delegate_ && delegate_->GetAcceleratorForCommandId(GetCommandIdAt(index), accelerator);
}

std::u16string ButtonMenuItemModel::GetLabelAt(size_t index) const
{
    return IsItemDynamicAt(index) ? delegate_->GetLabelForCommandId(GetCommandIdAt(index)) : items_[index].label;
}
