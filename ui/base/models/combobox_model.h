...
public:
    ...
    virtual std::optional<ui::ColorId> GetDropdownForegroundColorIdAt(size_t index) const;

    // The background color of the dropdown. If not overridden, this returns
    // std::nullopt and the default color will be used.
    virtual std::optional<ui::ColorId> GetDropdownBackgroundColorIdAt(size_t index) const;

    // The hover / selected color for the dropdown. If not overridden, this
    // returns std::nullopt and the default color will be used.
    virtual std::optional<ui::ColorId> GetDropdownSelectedBackgroundColorIdAt(size_t index) const;
