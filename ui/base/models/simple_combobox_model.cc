...
SimpleComboboxModel::Item::Item(std::u16string text, std::u16string dropdown_secondary_text, ui::ImageModel icon)
    : text(std::move(text))
    , dropdown_secondary_text(std::move(dropdown_secondary_text))
    , icon(std::move(icon))
{
}
SimpleComboboxModel::Item::Item(const SimpleComboboxModel::Item& other) = default;
SimpleComboboxModel::Item& SimpleComboboxModel::Item::operator=(const SimpleComboboxModel::Item& other) = default;
SimpleComboboxModel::Item::Item(SimpleComboboxModel::Item&& other) = default;
SimpleComboboxModel::Item& SimpleComboboxModel::Item::operator=(SimpleComboboxModel::Item&& other) = default;
...
std::u16string SimpleComboboxModel::GetDropDownSecondaryTextAt(size_t index) const
{
