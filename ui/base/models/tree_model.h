...
public:
    ...
    virtual void TreeNodeAdded(TreeModel* model, TreeModelNode* parent, size_t index)
    {
    }

    // Notification that nodes were removed from the specified parent.
    virtual void TreeNodeRemoved(TreeModel* model, TreeModelNode* parent, size_t index)
    {
    }
...
public:
    ...
    virtual std::optional<size_t> GetIndexOf(TreeModelNode* parent, TreeModelNode* child) const = 0;
