...
public:
    ...
    virtual bool GetAcceleratorAt(size_t index, ui::Accelerator* accelerator) const = 0;
    ...
    static bool GetModelAndIndexForCommandId(int command_id, MenuModel** model, size_t* index);
