...
private:
    ...
    void set_dialog_model(DialogModel* model)
    {
        dialog_model_ = model;
    }
...
public:
    ...
    public:
        ...
        Button(base::RepeatingCallback<void(const Event&)> callback, const Params& params);
        ...
        const std::optional<ButtonStyle> style() const
        {
            return style_;
        }
    ...
    public:
        ...
        Builder& SetBannerImage(ImageModel banner, ImageModel dark_mode_banner = ImageModel())
        {
        ...
        Builder& SetIcon(ImageModel icon, ImageModel dark_mode_icon = ImageModel())
        {
        ...
        Builder& AddOkButton(ButtonCallbackVariant callback, const Button::Params& params = Button::Params());
        Builder& AddCancelButton(ButtonCallbackVariant callback, const Button::Params& params = Button::Params());
        ...
        Builder& AddExtraButton(base::RepeatingCallback<void(const Event&)> callback, const Button::Params& params);
        ...
        {
            model_->AddCombobox(id, std::move(label), std::move(combobox_model), params);
            return *this;
        }
        ...
        {
            model_->AddMenuItem(std::move(icon), std::move(label), std::move(callback), params);
            return *this;
        }
        ...
        Builder& AddTitleItem(std::u16string label, ElementIdentifier id = ElementIdentifier())
        {
        ...
        Builder& AddPasswordField(ElementIdentifier id, std::u16string label, std::u16string accessible_text, std::u16string incorrect_password_text,
            const DialogModelPasswordField::Params& params = DialogModelPasswordField::Params())
        {
            model_->AddPasswordField(id, std::move(label), std::move(accessible_text), std::move(incorrect_password_text), params);
            return *this;
        }
    ...
    private:
        Builder& AddButtonInternal(
            ButtonCallbackVariant callback, const Button::Params& params, std::optional<Button>& model_button, ButtonCallbackVariant& model_callback);

        std::unique_ptr<DialogModel> model_;
    };

    DialogModel(base::PassKey<DialogModel::Builder>, std::unique_ptr<DialogModelDelegate> delegate);
    ...
    void AddCombobox(ElementIdentifier id, std::u16string label, std::unique_ptr<ui::ComboboxModel> combobox_model,
        const DialogModelCombobox::Params& params = DialogModelCombobox::Params())
    {
        contents_.AddCombobox(id, std::move(label), std::move(combobox_model), params);
    }
    ...
    void AddMenuItem(ImageModel icon, std::u16string label, base::RepeatingCallback<void(int)> callback,
        const DialogModelMenuItem::Params& params = DialogModelMenuItem::Params())
    {
        contents_.AddMenuItem(std::move(icon), std::move(label), std::move(callback), params);
    }
    ...
    void AddPasswordField(ElementIdentifier id, std::u16string label, std::u16string accessible_text, std::u16string incorrect_password_text,
        const DialogModelPasswordField::Params& params = DialogModelField::Params())
    {
        contents_.AddPasswordField(id, std::move(label), std::move(accessible_text), std::move(incorrect_password_text), params);
    }
    ...
    const std::optional<bool>& override_show_close_button(base::PassKey<DialogModelHost>) const
    {
    ...
    const ImageModel& icon(base::PassKey<DialogModelHost>) const
    {
        return icon_;
    }
    ...
    const std::optional<mojom::DialogButton>& override_default_button(base::PassKey<DialogModelHost>) const
    {
        return override_default_button_;
    }

    ElementIdentifier initially_focused_field(base::PassKey<DialogModelHost>) const
    {
    ...
    DialogModelLabel::TextReplacement* extra_link(base::PassKey<DialogModelHost>)
    {
    ...
    DialogModelSection* contents()
    {
        return &contents_;
    }

    // TODO(pbos): Replace this with a section() or something.
    const std::vector<std::unique_ptr<DialogModelField>>& fields(base::PassKey<DialogModelHost>)
    {
