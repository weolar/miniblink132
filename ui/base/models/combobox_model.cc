...
{
    observers_.Notify(&ui::ComboboxModelObserver::OnComboboxModelDestroying, this);
}
...
std::optional<ui::ColorId> ComboboxModel::GetDropdownForegroundColorIdAt(size_t index) const
{
    return std::nullopt;
}

std::optional<ui::ColorId> ComboboxModel::GetDropdownBackgroundColorIdAt(size_t index) const
{
    return std::nullopt;
}

std::optional<ui::ColorId> ComboboxModel::GetDropdownSelectedBackgroundColorIdAt(size_t index) const
{
    return std::nullopt;
}
