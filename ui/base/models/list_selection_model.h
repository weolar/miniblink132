...
public:
    ...
    void set_anchor(std::optional<size_t> anchor)
    {
        anchor_ = anchor;
    }
    std::optional<size_t> anchor() const
    {
        return anchor_;
    }

    // See class description for details of active.
    void set_active(std::optional<size_t> active)
    {
        active_ = active;
    }
    std::optional<size_t> active() const
    {
        return active_;
    }
    ...
    // order.
    const SelectedIndices& selected_indices() const
    {
