...
class ListModelTest : public testing::Test, public ListModelObserver {
public:
    ListModelTest()
        : added_count_(0)
        , removed_count_(0)
    ...
    void ExpectCountsEqual(size_t added_count, size_t removed_count, size_t moved_count, size_t changed_count)
    {
