...
{
    static constexpr gfx::PathElement path[] = { gfx::CommandType::CIRCLE, 24, 18, 5 };
...
const gfx::VectorIcon& GetRectVectorIcon()
{
    static constexpr gfx::PathElement path[]
        = { gfx::CommandType::LINE_TO, 0, 10, gfx::CommandType::LINE_TO, 10, 10, gfx::CommandType::LINE_TO, 10, 0, gfx::CommandType::CLOSE };
...
{
    ImageModel image_model = ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuIcon, 16);
...
{
    ImageModel image_model = ImageModel::FromImage(gfx::test::CreateImage(16, 16));
...
TEST(ImageModelTest, CheckForImageGenerator)
{
    ImageModel image_model = ImageModel::FromImageGenerator(
        base::BindRepeating([](const ui::ColorProvider*) { return gfx::test::CreateImage(16, 16).AsImageSkia(); }), gfx::Size(16, 16));
...
TEST(ImageModelTest, Size)
{
    ...
    EXPECT_EQ(gfx::Size(16, 16), ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuIcon, 16).Size());
    EXPECT_EQ(gfx::Size(16, 16), ImageModel::FromImage(gfx::test::CreateImage(16, 16)).Size());
...
TEST(ImageModelTest, CheckAssignVectorIcon)
{
    ...
    VectorIconModel vector_icon_model_src = ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuIcon, 16).GetVectorIcon();
...
TEST(ImageModelTest, CheckAssignImage)
{
    ...
    ImageModel image_model_src = ImageModel::FromImage(gfx::test::CreateImage(16, 16));
    ...
    image_model_src = ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuIcon, 16);
...
TEST(ImageModelTest, CheckEqual)
{
    ...
    image_model_dest = ImageModel::FromVectorIcon(GetRectVectorIcon(), ui::kColorMenuIcon, 16);
    EXPECT_NE(image_model_src, image_model_dest);
    image_model_src = ImageModel::FromVectorIcon(GetRectVectorIcon(), ui::kColorMenuIcon, 16);
    EXPECT_EQ(image_model_src, image_model_dest);
    image_model_dest = ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuIcon, 16);
    EXPECT_NE(image_model_src, image_model_dest);
    image_model_src = image_model_dest;
    EXPECT_EQ(image_model_src, image_model_dest);

    image_model_src = ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuIcon, 16);
    image_model_dest = ImageModel::FromVectorIcon(GetCircleVectorIcon(), SK_ColorMAGENTA, 16);
    EXPECT_NE(image_model_src, image_model_dest);

    image_model_src = ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuIcon, 16);
    image_model_dest = ImageModel::FromVectorIcon(GetCircleVectorIcon(), ui::kColorMenuItemForeground, 16);
    EXPECT_NE(image_model_src, image_model_dest);

    image_model_src = ImageModel::FromVectorIcon(GetCircleVectorIcon(), SK_ColorCYAN, 16);
    image_model_dest = ImageModel::FromVectorIcon(GetCircleVectorIcon(), SK_ColorMAGENTA, 16);
    EXPECT_NE(image_model_src, image_model_dest);

    image_model_src = ImageModel::FromVectorIcon(GetCircleVectorIcon(), SK_ColorMAGENTA, 1);
    image_model_dest = ImageModel::FromVectorIcon(GetCircleVectorIcon(), SK_ColorMAGENTA, 2);
    EXPECT_NE(image_model_src, image_model_dest);

    auto generator = base::BindRepeating([](const ui::ColorProvider*) { return gfx::test::CreateImage(16, 16).AsImageSkia(); });
    image_model_src = ImageModel::FromImageGenerator(generator, gfx::Size(16, 16));
    EXPECT_NE(image_model_src, image_model_dest);
    image_model_dest = ImageModel::FromImageGenerator(generator, gfx::Size(16, 16));
    EXPECT_EQ(image_model_src, image_model_dest);
    image_model_dest = ImageModel::FromImageGenerator(generator, gfx::Size(8, 8));
    EXPECT_NE(image_model_src, image_model_dest);
    image_model_dest = ImageModel::FromImageGenerator(
        base::BindRepeating([](const ui::ColorProvider*) { return gfx::test::CreateImage(8, 8).AsImageSkia(); }), gfx::Size(16, 16));
    EXPECT_NE(image_model_src, image_model_dest);
    image_model_src = image_model_dest;
    EXPECT_EQ(image_model_src, image_model_dest);
}
...
TEST(ImageModelTest, ShouldRasterizeVectorIcon)
{
    ...
    gfx::ImageSkia image_skia = ui::ImageModel::FromVectorIcon(vector_icons::kSyncIcon).Rasterize(&color_provider);
...
TEST(ImageModelTest, ShouldRasterizeImage)
{
    ...
    gfx::ImageSkia image_skia = ui::ImageModel::FromImage(image).Rasterize(nullptr);
    EXPECT_FALSE(image_skia.isNull());
