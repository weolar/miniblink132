...
public:
    ...
    const gfx::VectorIcon* vector_icon() const
    {
        return vector_icon_;
    }
    int icon_size() const
    ...
    {
        return absl::get<ColorId>(color_);
    }
    SkColor color() const
    {
    ...
    {
        return absl::holds_alternative<SkColor>(color_);
    }
    const gfx::VectorIcon* badge_icon() const
    {
        return badge_icon_;
    }
...
private:
    ...
    VectorIconModel(const gfx::VectorIcon& vector_icon, ColorId color_id, int icon_size, const gfx::VectorIcon* badge_icon);
    ...
    VectorIconModel(const gfx::VectorIcon& vector_icon, SkColor color, int icon_size, const gfx::VectorIcon* badge_icon);
...
public:
    using ImageGenerator = base::RepeatingCallback<gfx::ImageSkia(const ui::ColorProvider*)>;
    ...
    static ImageModel FromVectorIcon(
        const gfx::VectorIcon& vector_icon, ColorId color_id = kColorMenuIcon, int icon_size = 0, const gfx::VectorIcon* badge_icon = nullptr);
    static ImageModel FromVectorIcon(const gfx::VectorIcon& vector_icon, SkColor color, int icon_size = 0, const gfx::VectorIcon* badge_icon = nullptr);
    ...
    static ImageModel FromImageGenerator(ImageGenerator generator, gfx::Size size);
