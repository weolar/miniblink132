...
BASE_FEATURE(kApplyNativeOccludedRegionToWindowTracker, "ApplyNativeOccludedRegionToWindowTracker", base::FEATURE_DISABLED_BY_DEFAULT);

// If enabled, calculate native window occlusion - Windows-only.
BASE_FEATURE(kCalculateNativeWinOcclusion, "CalculateNativeWinOcclusion", base::FEATURE_ENABLED_BY_DEFAULT);

// If enabled, listen for screen power state change and factor into the native
// window occlusion detection - Windows-only.
BASE_FEATURE(kScreenPowerListenerForNativeWinOcclusion, "ScreenPowerListenerForNativeWinOcclusion", base::FEATURE_ENABLED_BY_DEFAULT);

// Once enabled, the exact behavior is dictated by the field trial param
// name `kApplyNativeOcclusionToCompositorType`.
BASE_FEATURE(kApplyNativeOcclusionToCompositor, "ApplyNativeOcclusionToCompositor", base::FEATURE_DISABLED_BY_DEFAULT);

// If enabled, native window occlusion tracking will always be used, even if
// CHROME_HEADLESS is set.
BASE_FEATURE(kAlwaysTrackNativeWindowOcclusionForTest, "AlwaysTrackNativeWindowOcclusionForTest", base::FEATURE_DISABLED_BY_DEFAULT);

// Field trial param name for `kApplyNativeOcclusionToCompositor`.
const base::FeatureParam<std::string> kApplyNativeOcclusionToCompositorType { &kApplyNativeOcclusionToCompositor, "type", /*default=*/"" };
...
const char kApplyNativeOcclusionToCompositorTypeThrottleAndRelease[] = "throttle_and_release";
#endif // BUILDFLAG(IS_WIN)

#if BUILDFLAG(IS_CHROMEOS)
// Integrate input method specific settings to Chrome OS settings page.
// https://crbug.com/895886.
BASE_FEATURE(kSettingsShowsPerKeyboardSettings, "InputMethodIntegratedSettings", base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kDeprecateAltClick, "DeprecateAltClick", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kNotificationsIgnoreRequireInteraction, "NotificationsIgnoreRequireInteraction", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kShortcutCustomization, "ShortcutCustomization", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kSupportF11AndF12KeyShortcuts, "SupportF11AndF12KeyShortcuts", base::FEATURE_ENABLED_BY_DEFAULT);
...
bool AreF11AndF12ShortcutsEnabled()
{
    ...
    if (::ui::ShortcutMappingPrefDelegate::IsInitialized()) {
        ::ui::ShortcutMappingPrefDelegate* instance = ::ui::ShortcutMappingPrefDelegate::GetInstance();
        if (instance && instance->IsDeviceEnterpriseManaged()) {
            return instance->IsI18nShortcutPrefEnabled() && base::FeatureList::IsEnabled(features::kSupportF11AndF12KeyShortcuts);
        }
    }
...
BASE_FEATURE(kOzoneBubblesUsePlatformWidgets, "OzoneBubblesUsePlatformWidgets", base::FEATURE_DISABLED_BY_DEFAULT);

// Controls whether support for Wayland's linux-drm-syncobj is enabled.
BASE_FEATURE(kWaylandLinuxDrmSyncobj, "WaylandLinuxDrmSyncobj", base::FEATURE_DISABLED_BY_DEFAULT);

// Controls whether support for Wayland's per-surface scaling is enabled.
BASE_FEATURE(kWaylandPerSurfaceScale, "WaylandPerSurfaceScale", base::FEATURE_DISABLED_BY_DEFAULT);

// Controls whether Wayland text-input-v3 protocol support is enabled.
BASE_FEATURE(kWaylandTextInputV3, "WaylandTextInputV3", base::FEATURE_DISABLED_BY_DEFAULT);

// Controls whether support for "Large Text" accessibility setting via UI
// scaling is enabled.
BASE_FEATURE(kWaylandUiScale, "WaylandUiScale", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kOverrideDefaultOzonePlatformHintToAuto, "OverrideDefaultOzonePlatformHintToAuto", base::FEATURE_DISABLED_BY_DEFAULT);
#endif // BUILDFLAG(IS_LINUX)

// Update of the virtual keyboard settings UI as described in
// https://crbug.com/876901.
BASE_FEATURE(kInputMethodSettingsUiUpdate, "InputMethodSettingsUiUpdate", base::FEATURE_DISABLED_BY_DEFAULT);
...
// touch slop.
BASE_FEATURE(kStylusSpecificTapSlop, "StylusSpecificTapSlop", base::FEATURE_ENABLED_BY_DEFAULT);

// Allows system caption style for WebVTT Captions.
BASE_FEATURE(kSystemCaptionStyle, "SystemCaptionStyle", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kSystemCursorSizeSupported, "SystemCursorSizeSupported",
#if BUILDFLAG(IS_WIN)
...
BASE_FEATURE(kSystemKeyboardLock, "SystemKeyboardLock", base::FEATURE_ENABLED_BY_DEFAULT);

// Enables GPU rasterization for all UI drawing (where not blocklisted).
BASE_FEATURE(kUiGpuRasterization, "UiGpuRasterization",
#if BUILDFLAG(IS_APPLE) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_WIN)
    base::FEATURE_ENABLED_BY_DEFAULT
#else
    base::FEATURE_DISABLED_BY_DEFAULT
#endif
...
BASE_FEATURE(kUiCompositorScrollWithLayers, "UiCompositorScrollWithLayers",
...
BASE_FEATURE(kExperimentalFlingAnimation, "ExperimentalFlingAnimation",
...
#if BUILDFLAG(IS_ANDROID)
BASE_FEATURE(kClipboardFiles, "ClipboardFiles", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kFocusFollowsCursor, "FocusFollowsCursor", base::FEATURE_DISABLED_BY_DEFAULT);

#if BUILDFLAG(IS_CHROMEOS)
// This feature supersedes kNewShortcutMapping.
BASE_FEATURE(kImprovedKeyboardShortcuts, "ImprovedKeyboardShortcuts", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kTouchTextEditingRedesign, "TouchTextEditingRedesign",
#if BUILDFLAG(IS_CHROMEOS)
    base::FEATURE_ENABLED_BY_DEFAULT
#else
    base::FEATURE_DISABLED_BY_DEFAULT
...
{
    static const bool forced_colors_enabled = base::FeatureList::IsEnabled(features::kForcedColors);
...
BASE_FEATURE(kKeyboardAccessibleTooltip, "KeyboardAccessibleTooltip", base::FEATURE_DISABLED_BY_DEFAULT);

bool IsKeyboardAccessibleTooltipEnabled()
{
    static const bool keyboard_accessible_tooltip_enabled = base::FeatureList::IsEnabled(features::kKeyboardAccessibleTooltip);
    return keyboard_accessible_tooltip_enabled;
}

BASE_FEATURE(kSynchronousPageFlipTesting, "SynchronousPageFlipTesting", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kResamplingScrollEventsExperimentalPrediction, "ResamplingScrollEventsExperimentalPrediction", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kUIDebugTools, "ui-debug-tools", base::FEATURE_DISABLED_BY_DEFAULT);
...
#else
        base::FeatureList::IsEnabled(kSwipeToMoveCursor) || IsTouchTextEditingRedesignEnabled();
#endif
    return enabled;
}
...
const base::FeatureParam<double> kRawDrawTileSizeFactor { &kRawDraw, "TileSizeFactor", 1 };

const base::FeatureParam<bool> kIsRawDrawUsingMSAA { &kRawDraw, "IsUsingMSAA", false };
bool IsUsingRawDraw()
{
...
BASE_FEATURE(kVariableRefreshRateAvailable, "VariableRefreshRateAvailable", base::FEATURE_DISABLED_BY_DEFAULT);
BASE_FEATURE(kEnableVariableRefreshRate, "EnableVariableRefreshRate", base::FEATURE_DISABLED_BY_DEFAULT);
bool IsVariableRefreshRateEnabled()
{
    ...
    if (!(base::FeatureList::GetInstance() && base::FeatureList::GetInstance()->IsFeatureOverridden(kEnableVariableRefreshRate.name))
...
BASE_FEATURE(kBubbleMetricsApi, "BubbleMetricsApi", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kCr2023MacFontSmoothing, "Cr2023MacFontSmoothing", base::FEATURE_ENABLED_BY_DEFAULT);
#endif // BUILDFLAG(IS_APPLE)

#if BUILDFLAG(IS_WIN)
BASE_FEATURE(kUseGammaContrastRegistrySettings, "UseGammaContrastRegistrySettings", base::FEATURE_ENABLED_BY_DEFAULT);
BASE_FEATURE(kIncreaseWindowsTextContrast, "IncreaseWindowsTextContrast", base::FEATURE_ENABLED_BY_DEFAULT);
#endif // BUILDFLAG(IS_WIN)

BASE_FEATURE(kBubbleFrameViewTitleIsHeading, "BubbleFrameViewTitleIsHeading", base::FEATURE_ENABLED_BY_DEFAULT);

BASE_FEATURE(kEnableGestureBeginEndTypes, "EnableGestureBeginEndTypes", base::FEATURE_DISABLED_BY_DEFAULT);

BASE_FEATURE(kUseUtf8EncodingForSvgImage, "UseUtf8EncodingForSvgImage", base::FEATURE_ENABLED_BY_DEFAULT);

// Enables copy bookmark and writes url format to clipboard with empty title.
BASE_FEATURE(kWriteBookmarkWithoutTitle, "WriteBookmarkWithoutTitle", base::FEATURE_ENABLED_BY_DEFAULT);

// If enabled, fullscreen window state is updated asynchronously.
BASE_FEATURE(kAsyncFullscreenWindowState, "AsyncFullscreenWindowState", base::FEATURE_DISABLED_BY_DEFAULT);
