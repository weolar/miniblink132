...
public:
    ...
    MockMediaKeysListenerDelegate& operator=(const MockMediaKeysListenerDelegate&) = delete;
    ...
    void OnMediaKeysAccelerator(const Accelerator& accelerator) override
    {
        ...
        if (key_event_wait_loop_ && received_events_.size() >= num_key_events_to_wait_for_) {
...
public:
    ...
    GlobalMediaKeysListenerWinInteractiveTest(const GlobalMediaKeysListenerWinInteractiveTest&) = delete;
    GlobalMediaKeysListenerWinInteractiveTest& operator=(const GlobalMediaKeysListenerWinInteractiveTest&) = delete;
