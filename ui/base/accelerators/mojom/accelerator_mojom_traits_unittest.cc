...
{
    Accelerator accelerator(KeyboardCode::VKEY_TAB, EF_NUM_LOCK_ON, ui::Accelerator::KeyState::RELEASED, base::TimeTicks() + base::Milliseconds(1));
    Accelerator deserialized;
    ASSERT_TRUE(mojom::Accelerator::Deserialize(mojom::Accelerator::Serialize(&accelerator), &deserialized));
