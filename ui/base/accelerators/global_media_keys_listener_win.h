...
class COMPONENT_EXPORT(UI_BASE) GlobalMediaKeysListenerWin : public MediaKeysListener {
public:
    ...
    GlobalMediaKeysListenerWin& operator=(const GlobalMediaKeysListenerWin&) = delete;
...
private:
    ...
    base::flat_map<KeyboardCode, std::unique_ptr<gfx::SingletonHwndHotKeyObserver>> key_codes_hotkey_observers_;
};
