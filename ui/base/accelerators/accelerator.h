...
public:
    ...
    Accelerator(KeyboardCode key_code, int modifiers, KeyState key_state = KeyState::PRESSED, base::TimeTicks time_stamp = base::TimeTicks());
    ...
    Accelerator(KeyboardCode key_code, DomCode code, int modifiers, KeyState key_state = KeyState::PRESSED, base::TimeTicks time_stamp = base::TimeTicks());
#endif
    ...
    void set_key_state(KeyState state)
    {
        key_state_ = state;
    }
    KeyState key_state() const
    {
        return key_state_;
    }
...
public:
    ...
    virtual bool GetAcceleratorForCommandId(int command_id, Accelerator* accelerator) const = 0;
