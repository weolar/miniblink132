...
public:
    ...
    void Register(const std::vector<ui::Accelerator>& accelerators, HandlerPriority priority, AcceleratorTarget* target);
    ...
    inline void RegisterAccelerator(const Accelerator& accelerator, HandlerPriority priority, AcceleratorTarget* target)
    {
...
private:
    ...
    public:
        ...
        void RegisterWithPriority(AcceleratorTarget* target, HandlerPriority priority);
