...
template <> struct EnumTraits<blink::mojom::ClipboardBuffer, ui::ClipboardBuffer> {
    ...
    static bool FromMojom(blink::mojom::ClipboardBuffer buffer, ui::ClipboardBuffer* out)
    {
        switch (buffer) {
