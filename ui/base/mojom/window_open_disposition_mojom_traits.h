...
template <> struct EnumTraits<ui::mojom::WindowOpenDisposition, WindowOpenDisposition> {
    static ui::mojom::WindowOpenDisposition ToMojom(WindowOpenDisposition disposition)
    {
        switch (disposition) {
    ...
    static bool FromMojom(ui::mojom::WindowOpenDisposition disposition, WindowOpenDisposition* out)
    {
        switch (disposition) {
