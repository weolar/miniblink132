...
void UIBaseTestSuite::Initialize()
{
    ...
    base::apple::SetOverrideFrameworkBundlePath(exe_path.AppendASCII("ui_unittests Framework.framework"));
    ui::ResourceBundle::InitSharedInstanceWithLocale("en-US", NULL, ui::ResourceBundle::LOAD_COMMON_RESOURCES);
    ...
    // necessary framework.
    ui::ResourceBundle::InitSharedInstanceWithLocale("en-US", NULL, ui::ResourceBundle::DO_NOT_LOAD_COMMON_RESOURCES);
    ...
    ui::ResourceBundle::InitSharedInstanceWithPakPath(assets_path.AppendASCII("ui_test.pak"));
    ...
    result = base::PathService::Get(ui::DIR_RESOURCE_PAKS_ANDROID, &dir_resources);
...
#endif
    DCHECK(result);
    base::FilePath ui_base_test_resources_pak = dir_resources.Append(FILE_PATH_LITERAL("ui_base_test_resources.pak"));
    ui::ResourceBundle::GetSharedInstance().AddDataPackFromPath(ui_base_test_resources_pak, ui::kScaleFactorNone);
}
...
int main(int argc, char** argv)
{
    ...
    mojo::core::Init();
    return base::LaunchUnitTests(argc, argv, base::BindOnce(&UIBaseTestSuite::Run, base::Unretained(&test_suite)));
}
