...
void SkiaGoldMatchingAlgorithm::AppendAlgorithmToCmdline(base::CommandLine& cmd) const
{
    cmd.AppendSwitchASCII("add-test-optional-key", base::JoinString({ "image_matching_algorithm", GetCommandLineSwitchName() }, ":"));
}
...
void ExactSkiaGoldMatchingAlgorithm::AppendAlgorithmToCmdline(base::CommandLine& cmd) const
{
...
FuzzySkiaGoldMatchingAlgorithm::FuzzySkiaGoldMatchingAlgorithm(int max_different_pixels, int pixel_delta_threshold, int ignored_border_thickness)
...
void FuzzySkiaGoldMatchingAlgorithm::AppendAlgorithmToCmdline(base::CommandLine& cmd) const
{
    SkiaGoldMatchingAlgorithm::AppendAlgorithmToCmdline(cmd);
    cmd.AppendSwitchASCII("add-test-optional-key", base::JoinString({ kMaxDifferentPixels, base::NumberToString(max_different_pixels_) }, ":"));
    cmd.AppendSwitchASCII("add-test-optional-key", base::JoinString({ kPixelDeltaThreshold, base::NumberToString(pixel_delta_threshold_) }, ":"));

    if (ignored_border_thickness_)
        cmd.AppendSwitchASCII("add-test-optional-key", base::JoinString({ kIgnoredBorderThickness, base::NumberToString(ignored_border_thickness_) }, ":"));
}
...
SobelSkiaGoldMatchingAlgorithm::SobelSkiaGoldMatchingAlgorithm(
    int max_different_pixels, int pixel_delta_threshold, int edge_threshold, int ignored_border_thickness)
    : FuzzySkiaGoldMatchingAlgorithm(max_different_pixels, pixel_delta_threshold, ignored_border_thickness)
...
void SobelSkiaGoldMatchingAlgorithm::AppendAlgorithmToCmdline(base::CommandLine& cmd) const
{
    FuzzySkiaGoldMatchingAlgorithm::AppendAlgorithmToCmdline(cmd);
    cmd.AppendSwitchASCII("add-test-optional-key", base::JoinString({ kEdgeThreshold, base::NumberToString(edge_threshold_) }, ":"));
}
...
void PositiveIfOnlyImageAlgorithm::AppendAlgorithmToCmdline(base::CommandLine& cmd) const
{
    SkiaGoldMatchingAlgorithm::AppendAlgorithmToCmdline(cmd);
