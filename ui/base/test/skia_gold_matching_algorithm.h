...
public:
    FuzzySkiaGoldMatchingAlgorithm(int max_different_pixels, int pixel_delta_threshold, int ignored_border_thickness = 0);
...
public:
    SobelSkiaGoldMatchingAlgorithm(int max_different_pixels, int pixel_delta_threshold, int edge_threshold, int ignored_border_thickness = 0);
