...
DummyTextInputClient::DummyTextInputClient(TextInputType text_input_type, TextInputMode text_input_mode)
...
void DummyTextInputClient::SetCompositionText(const CompositionText& composition)
{
...
void DummyTextInputClient::InsertText(const std::u16string& text, InsertTextCursorBehavior cursor_behavior)
{
...
#if BUILDFLAG(IS_WIN)
std::optional<gfx::Rect> DummyTextInputClient::GetProximateCharacterBounds(const gfx::Range& range) const
{
    return std::nullopt;
}

std::optional<size_t> DummyTextInputClient::GetProximateCharacterIndexFromPoint(const gfx::Point& point, IndexFromPointFlags flags) const
{
    return std::nullopt;
}
#endif // BUILDFLAG(IS_WIN)

bool DummyTextInputClient::GetCompositionCharacterBounds(size_t index, gfx::Rect* rect) const
{
    return false;
}
...
bool DummyTextInputClient::GetTextFromRange(const gfx::Range& range, std::u16string* text) const
{
    return false;
}
...
bool DummyTextInputClient::ChangeTextDirectionAndLayoutAlignment(base::i18n::TextDirection direction)
{
    return false;
}

void DummyTextInputClient::ExtendSelectionAndDelete(size_t before, size_t after)
{
}
...
bool DummyTextInputClient::IsTextEditCommandEnabled(TextEditCommand command) const
{
    return false;
}

void DummyTextInputClient::SetTextEditCommandForNextKeyEvent(TextEditCommand command)
{
}
...
bool DummyTextInputClient::SetCompositionFromExistingText(const gfx::Range& range, const std::vector<ui::ImeTextSpan>& ui_ime_text_spans)
{
    return false;
}
#endif
...
bool DummyTextInputClient::SetAutocorrectRange(const gfx::Range& range)
{
...
std::optional<GrammarFragment> DummyTextInputClient::GetGrammarFragmentAtCursor() const
{
...
bool DummyTextInputClient::AddGrammarFragments(const std::vector<GrammarFragment>& fragments)
{
...
void DummyTextInputClient::GetActiveTextInputControlLayoutBounds(std::optional<gfx::Rect>* control_bounds, std::optional<gfx::Rect>* selection_bounds)
{
}
#endif
