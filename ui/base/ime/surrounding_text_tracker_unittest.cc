...
{
    SurroundingTextTracker tracker;
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 0u,
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 0u, gfx::Range(2, 5))); // Select "cde".
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u,
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(3, 5)));
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(4, 6)));
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(4, 13)));
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(11, 13)));
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(12, 13)));
    ...
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(13)));
...
TEST(SurroundingTextTracker, InsertText)
{
    ...
    tracker.OnInsertText(u"xyz", TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText);
    EXPECT_EQ(u"abcxyzdefg", tracker.predicted_state().surrounding_text);
    EXPECT_EQ(0u, tracker.predicted_state().utf16_offset);
    EXPECT_EQ(gfx::Range(6), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"abcxyzdefg", 0u, gfx::Range(6)));

    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 0u,
                                                                gfx::Range(3))); // Set cursor between c and d.

    tracker.OnInsertText(u"xyz", TextInputClient::InsertTextCursorBehavior::kMoveCursorBeforeText);
    EXPECT_EQ(u"abcxyzdefg", tracker.predicted_state().surrounding_text);
    EXPECT_EQ(0u, tracker.predicted_state().utf16_offset);
    EXPECT_EQ(gfx::Range(3), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"abcxyzdefg", 0u, gfx::Range(3)));

    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 0u, gfx::Range(3, 4))); // Set selection on "d".
    ...
    EXPECT_EQ(gfx::Range(6), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"abcxyzefg", 0u, gfx::Range(6)));
    ...
    EXPECT_EQ(gfx::Range(3), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"abcxyzefg", 0u, gfx::Range(3)));

    // With offset.
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(8))); // Set cursor after "c"
    ...
    EXPECT_EQ(gfx::Range(11), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"abcxyzdefg", 5u, gfx::Range(11)));

    // Selection is before offset.
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(3, 4)));
    ...
    EXPECT_EQ(gfx::Range(6), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"xyz", 3u, gfx::Range(6)));
    ...
    EXPECT_EQ(gfx::Range(6), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"xyzabcdefg", 3u, gfx::Range(6)));
    ...
    EXPECT_EQ(gfx::Range(7), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"xyzbcdefg", 4u, gfx::Range(7)));
    ...
    EXPECT_EQ(gfx::Range(7), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"xyz", 4u, gfx::Range(7)));
    ...
    EXPECT_EQ(gfx::Range(14), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"abcdefxyz", 5u, gfx::Range(14)));
    ...
    EXPECT_EQ(gfx::Range(15), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"abcdefgxyz", 5u, gfx::Range(15)));

    // Selection is after the surrounding text.
    tracker.Reset();
    ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 5u, gfx::Range(13, 14)));
    ...
    EXPECT_EQ(gfx::Range(16), tracker.predicted_state().selection);
    EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"xyz", 13u, gfx::Range(16)));
...

    {
        ...
        tracker.OnInsertText(s, TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText);

        tracker.OnInsertText(s, TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText);
    }
    EXPECT_EQ(SurroundingTextTracker::UpdateResult::kUpdated, tracker.Update(u"yz", 14u, gfx::Range(16)));
}

TEST(SurroundingTextTracker, InsertTextWithComposition)
{
    // Aliases to just the test data shorter.
    constexpr auto kMoveCursorBeforeText = TextInputClient::InsertTextCursorBehavior::kMoveCursorBeforeText;
    constexpr auto kMoveCursorAfterText = TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText;
    ...
    for (const auto& test_case : kTestData) {
        ...
        ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", 0u, test_case.selection));
        ...
        // Verification.
        EXPECT_EQ(test_case.expected_surrounding_text, tracker.predicted_state().surrounding_text);
        EXPECT_EQ(test_case.expected_selection, tracker.predicted_state().selection);
        EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    }
}
...
TEST(SurroundingTextTracker, ExtendSelectionAndDelete)
{
    ...
    for (const auto& test_case : kTestData) {
        SurroundingTextTracker tracker;
        ASSERT_EQ(SurroundingTextTracker::UpdateResult::kReset, tracker.Update(u"abcdefg", test_case.utf16_offset, test_case.selection));
        ...
        EXPECT_EQ(test_case.expected_surrounding_text, tracker.predicted_state().surrounding_text);
        EXPECT_EQ(test_case.expected_utf16_offset, tracker.predicted_state().utf16_offset);
        EXPECT_EQ(test_case.expected_selection, tracker.predicted_state().selection);
        EXPECT_TRUE(tracker.predicted_state().composition.is_empty());
    }
}
