...
public:
    ...
    virtual void SetImeKeyEventDispatcher(ImeKeyEventDispatcher* ime_key_event_dispatcher) = 0;
    ...
    virtual bool OnUntranslatedIMEMessage(const CHROME_MSG event, NativeEventResult* result) = 0;
    ...
    [[nodiscard]] virtual ui::EventDispatchDetails DispatchKeyEvent(ui::KeyEvent* event) = 0;
    ...
    virtual void SetVirtualKeyboardControllerForTesting(std::unique_ptr<VirtualKeyboardController> controller) = 0;
};
