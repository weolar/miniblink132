...
void IMEBridge::SetCurrentInputContext(const TextInputMethod::InputContext& input_context)
{
...
void IMEBridge::SetCandidateWindowHandler(IMECandidateWindowHandlerInterface* handler)
{
    candidate_window_handler_ = handler;
}

IMECandidateWindowHandlerInterface* IMEBridge::GetCandidateWindowHandler() const
{
    return candidate_window_handler_;
}

void IMEBridge::SetAssistiveWindowHandler(IMEAssistiveWindowHandlerInterface* handler)
{
    assistive_window_handler_ = handler;
}

IMEAssistiveWindowHandlerInterface* IMEBridge::GetAssistiveWindowHandler() const
{
