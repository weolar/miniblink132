...
public:
    ...
    void SetCurrentInputContext(const TextInputMethod::InputContext& input_context);
...
private:
    ...
    raw_ptr<IMECandidateWindowHandlerInterface, LeakedDanglingUntriaged> candidate_window_handler_ = nullptr;
    raw_ptr<IMEAssistiveWindowHandlerInterface, DanglingUntriaged> assistive_window_handler_ = nullptr;
};
