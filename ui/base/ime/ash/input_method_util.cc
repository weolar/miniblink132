...
const struct {
    ...
    { "zh-hant-t-i0-cangjie-1987", IDS_LANGUAGES_MEDIUM_LEN_NAME_CHINESE_TRADITIONAL },
    { "zh-hant-t-i0-cangjie-1987-x-m0-simplified", IDS_LANGUAGES_MEDIUM_LEN_NAME_CHINESE_TRADITIONAL },
    { extension_ime_util::kBrailleImeEngineId, IDS_LANGUAGES_MEDIUM_LEN_NAME_BRAILLE },
};
...
const size_t kEnglishToResourceIdArraySize = std::size(kEnglishToResourceIdArray);
...
const struct InputMethodNameMap {
    ...
    { "__MSG_INPUTMETHOD_HANGUL_3_SET_390__", IDS_IME_NAME_INPUTMETHOD_HANGUL_3_SET_390 },
    { "__MSG_INPUTMETHOD_HANGUL_3_SET_FINAL__", IDS_IME_NAME_INPUTMETHOD_HANGUL_3_SET_FINAL },
    { "__MSG_INPUTMETHOD_HANGUL_3_SET_NO_SHIFT__", IDS_IME_NAME_INPUTMETHOD_HANGUL_3_SET_NO_SHIFT },
    { "__MSG_INPUTMETHOD_HANGUL_AHNMATAE__", IDS_IME_NAME_INPUTMETHOD_HANGUL_AHNMATAE },
    { "__MSG_INPUTMETHOD_HANGUL_ROMAJA__", IDS_IME_NAME_INPUTMETHOD_HANGUL_ROMAJA },
    ...
    { "__MSG_INPUTMETHOD_TRADITIONAL_PINYIN__", IDS_IME_NAME_INPUTMETHOD_TRADITIONAL_PINYIN },
    ...
    { "__MSG_KEYBOARD_ARMENIAN_PHONETIC__", IDS_IME_NAME_KEYBOARD_ARMENIAN_PHONETIC },
    ...
    { "__MSG_KEYBOARD_BENGALI_PHONETIC__", IDS_IME_NAME_KEYBOARD_BENGALI_PHONETIC },
    { "__MSG_KEYBOARD_BRAZILIAN__", IDS_IME_NAME_KEYBOARD_BRAZILIAN },
    { "__MSG_KEYBOARD_BULGARIAN_PHONETIC__", IDS_IME_NAME_KEYBOARD_BULGARIAN_PHONETIC },
    { "__MSG_KEYBOARD_BULGARIAN__", IDS_IME_NAME_KEYBOARD_BULGARIAN },
    { "__MSG_KEYBOARD_CANADIAN_ENGLISH__", IDS_IME_NAME_KEYBOARD_CANADIAN_ENGLISH },
    { "__MSG_KEYBOARD_CANADIAN_FRENCH__", IDS_IME_NAME_KEYBOARD_CANADIAN_FRENCH },
    { "__MSG_KEYBOARD_CANADIAN_MULTILINGUAL__", IDS_IME_NAME_KEYBOARD_CANADIAN_MULTILINGUAL },
    ...
    { "__MSG_KEYBOARD_DEVANAGARI_PHONETIC__", IDS_IME_NAME_KEYBOARD_DEVANAGARI_PHONETIC },
    { "__MSG_KEYBOARD_ENGLISH_INDIA__", IDS_IME_NAME_KEYBOARD_ENGLISH_INDIA },
    { "__MSG_KEYBOARD_ENGLISH_PAKISTAN__", IDS_IME_NAME_KEYBOARD_ENGLISH_PAKISTAN },
    { "__MSG_KEYBOARD_ENGLISH_SOUTH_AFRICA__", IDS_IME_NAME_KEYBOARD_ENGLISH_SOUTH_AFRICA },
    ...
    { "__MSG_KEYBOARD_GUJARATI_PHONETIC__", IDS_IME_NAME_KEYBOARD_GUJARATI_PHONETIC },
    { "__MSG_KEYBOARD_HEBREW__", IDS_IME_NAME_KEYBOARD_HEBREW },
    { "__MSG_KEYBOARD_HINDI_INSCRIPT__", IDS_IME_NAME_KEYBOARD_HINDI_INSCRIPT },
    { "__MSG_KEYBOARD_HUNGARIAN_QWERTY__", IDS_IME_NAME_KEYBOARD_HUNGARIAN_QWERTY },
    ...
    { "__MSG_KEYBOARD_KANNADA_PHONETIC__", IDS_IME_NAME_KEYBOARD_KANNADA_PHONETIC },
    ...
    { "__MSG_KEYBOARD_MALAYALAM_PHONETIC__", IDS_IME_NAME_KEYBOARD_MALAYALAM_PHONETIC },
    ...
    { "__MSG_KEYBOARD_NETHERLANDS_US_INTERNATIONAL_PC__", IDS_IME_NAME_KEYBOARD_NETHERLANDS_US_INTERNATIONAL_PC },
    ...
    { "__MSG_KEYBOARD_PORTUGUESE_US_INTERNATIONAL__", IDS_IME_NAME_KEYBOARD_PORTUGUESE_US_INTERNATIONAL },
    { "__MSG_KEYBOARD_PORTUGUESE__", IDS_IME_NAME_KEYBOARD_PORTUGUESE },
    { "__MSG_KEYBOARD_ROMANIAN_STANDARD__", IDS_IME_NAME_KEYBOARD_ROMANIAN_STANDARD },
    { "__MSG_KEYBOARD_ROMANIAN__", IDS_IME_NAME_KEYBOARD_ROMANIAN },
    { "__MSG_KEYBOARD_RUSSIAN_PHONETIC_AATSEEL__", IDS_IME_NAME_KEYBOARD_RUSSIAN_PHONETIC_AATSEEL },
    { "__MSG_KEYBOARD_RUSSIAN_PHONETIC_YAZHERT__", IDS_IME_NAME_KEYBOARD_RUSSIAN_PHONETIC_YAZHERT },
    { "__MSG_KEYBOARD_RUSSIAN_PHONETIC__", IDS_IME_NAME_KEYBOARD_RUSSIAN_PHONETIC },
    ...
    { "__MSG_KEYBOARD_SORANIKURDISH_AR__", IDS_IME_NAME_KEYBOARD_SORANIKURDISH_AR },
    { "__MSG_KEYBOARD_SORANIKURDISH_EN__", IDS_IME_NAME_KEYBOARD_SORANIKURDISH_EN },
    ...
    { "__MSG_KEYBOARD_TAMIL_TYPEWRITER__", IDS_IME_NAME_KEYBOARD_TAMIL_TYPEWRITER },
    ...
    { "__MSG_KEYBOARD_US_INTERNATIONAL_PC__", IDS_IME_NAME_KEYBOARD_US_INTERNATIONAL_PC },
    { "__MSG_KEYBOARD_US_INTERNATIONAL__", IDS_IME_NAME_KEYBOARD_US_INTERNATIONAL },
    { "__MSG_KEYBOARD_US_WORKMAN_INTERNATIONAL__", IDS_IME_NAME_KEYBOARD_US_WORKMAN_INTERNATIONAL },
    ...
    { "__MSG_KEYBOARD_VIETNAMESE_TELEX__", IDS_IME_NAME_KEYBOARD_VIETNAMESE_TELEX },
...
void MultimapDeduplicatedInsert(LanguageCodeToIdsMap& multimap, const std::string& key, const std::string& value)
{
    ...
    : delegate_(delegate)
{
    ...
    for (const auto& map_entry : kEnglishToResourceIdArray) {
        map_storage.emplace_back(map_entry.english_string_from_ibus, map_entry.resource_id);
    }

    english_to_resource_id_ = EnglishToIDMap(std::move(map_storage));
    DCHECK(english_to_resource_id_.size() == kEnglishToResourceIdArraySize) << "Duplicate string is found";
}

InputMethodUtil::~InputMethodUtil() = default;

std::string InputMethodUtil::GetLocalizedDisplayName(const InputMethodDescriptor& descriptor)
{
    ...
    if (disp.starts_with("__MSG_")) {
        ...
        const InputMethodNameMap* p = std::lower_bound(map, map + map_size, map_key);
...
bool InputMethodUtil::IsValidInputMethodId(const std::string& input_method_id) const
{
    // We can't check the component extension is whilelisted or not here because
    // it might not be initialized.
    return GetInputMethodDescriptorFromId(input_method_id) != nullptr || extension_ime_util::IsComponentExtensionIME(input_method_id)
...
{
    return base::StartsWith(input_method_id, "xkb:", base::CompareCase::INSENSITIVE_ASCII) || extension_ime_util::IsKeyboardLayoutExtension(input_method_id);
}

std::u16string InputMethodUtil::GetInputMethodMediumName(const InputMethodDescriptor& input_method) const
{
    ...
    for (const auto& i : kMappingImeIdToMediumLenNameResourceId) {
        if (extension_ime_util::GetInputMethodIDByEngineID(i.engine_id) == input_method.id()) {
...
std::u16string InputMethodUtil::GetInputMethodLongNameInternal(const InputMethodDescriptor& input_method, bool short_name) const
{
    ...
    if (short_name || localized_display_name.empty()) {
        ...
        std::string key_string = extension_ime_util::IsKeyboardLayoutExtension(input_method_id)
        ...
        if (iter == english_to_resource_id_.end()) {
            ...
            LOG(ERROR) << "Resource ID is not found for: " << input_method_id << ", " << key_string;
...
std::u16string InputMethodUtil::GetInputMethodLongNameStripped(const InputMethodDescriptor& input_method) const
{
    return GetInputMethodLongNameInternal(input_method, true /* short_name */);
}

std::u16string InputMethodUtil::GetInputMethodLongName(const InputMethodDescriptor& input_method) const
{
    return GetInputMethodLongNameInternal(input_method, false /* short_name */);
}

const InputMethodDescriptor* InputMethodUtil::GetInputMethodDescriptorFromId(const std::string& input_method_id) const
{
...
bool InputMethodUtil::GetInputMethodIdsFromLanguageCode(
    std::string_view normalized_language_code, InputMethodType type, std::vector<std::string>* out_input_method_ids) const
{
    return GetInputMethodIdsFromLanguageCodeInternal(language_code_to_ids_, normalized_language_code, type, out_input_method_ids);
}

bool InputMethodUtil::GetInputMethodIdsFromLanguageCodeInternal(const LanguageCodeToIdsMap& language_code_to_ids, std::string_view normalized_language_code,
    InputMethodType type, std::vector<std::string>* out_input_method_ids)
{
    DCHECK(out_input_method_ids);
    out_input_method_ids->clear();

    bool result = false;
    std::pair<LanguageCodeToIdsMap::const_iterator, LanguageCodeToIdsMap::const_iterator> range = language_code_to_ids.equal_range(normalized_language_code);
...
std::vector<std::string> InputMethodUtil::GetInputMethodIdsFromHandwritingLanguage(std::string_view handwriting_language)
{
    std::vector<std::string> input_method_ids;

    using It = LanguageCodeToIdsMap::const_iterator;
    std::pair<It, It> range = handwriting_language_to_ids_.equal_range(handwriting_language);
...
void InputMethodUtil::GetFirstLoginInputMethodIds(
    const std::string& language_code, const InputMethodDescriptor& preferred_input_method, std::vector<std::string>* out_input_method_ids) const
{
    out_input_method_ids->clear();
    ...
    for (const auto& i : kDefaultInputMethodRecommendation) {
        if (i.locale == language_code && (!i.layout[0] || i.layout == current_layout)) {
            out_input_method_ids->push_back(extension_ime_util::GetInputMethodIDByEngineID(i.engine_id));
            return;
        }
    }

    std::vector<std::string> input_method_ids;
    GetInputMethodIdsFromLanguageCode(language_code, kAllInputMethods, &input_method_ids);
    // Uses the first input method as the most popular one.
    if (input_method_ids.size() > 0 && preferred_input_method.id() != input_method_ids[0]) {
        out_input_method_ids->push_back(input_method_ids[0]);
    }
}

void InputMethodUtil::GetLanguageCodesFromInputMethodIds(const std::vector<std::string>& input_method_ids, std::vector<std::string>* out_language_codes) const
{
    out_language_codes->clear();

    for (const auto& i : input_method_ids) {
        const std::string& input_method_id = i;
        const InputMethodDescriptor* input_method = GetInputMethodDescriptorFromId(input_method_id);
        if (!input_method) {
...
std::string InputMethodUtil::GetLanguageDefaultInputMethodId(const std::string& language_code)
{
    std::vector<std::string> candidates;
    GetInputMethodIdsFromLanguageCode(language_code, input_method::kKeyboardLayoutsOnly, &candidates);
    if (candidates.size()) {
...
std::string InputMethodUtil::GetMigratedInputMethod(const std::string& input_method_id)
{
    ...
    if (extension_ime_util::IsComponentExtensionIME(id)) {
        std::string id_new = extension_ime_util::GetInputMethodIDByEngineID(extension_ime_util::GetComponentIDByInputMethodID(id));
...
bool InputMethodUtil::GetMigratedInputMethodIDs(std::vector<std::string>* input_method_ids)
{
...
void InputMethodUtil::UpdateHardwareLayoutCache()
{
    ...
    if (cached_hardware_layouts_.empty()) {
        cached_hardware_layouts_ = base::SplitString(delegate_->GetHardwareKeyboardLayouts(), ",", base::KEEP_WHITESPACE, base::SPLIT_WANT_NONEMPTY);
    }
...
void InputMethodUtil::SetHardwareKeyboardLayoutForTesting(const std::string& layout)
{
...
const std::vector<std::string>& InputMethodUtil::GetHardwareLoginInputMethodIds()
{
    DCHECK(thread_checker_.CalledOnValidThread());
    UpdateHardwareLayoutCache();
...
bool InputMethodUtil::IsLoginKeyboard(const std::string& input_method_id) const
{
    const InputMethodDescriptor* ime = GetInputMethodDescriptorFromId(input_method_id);
...
void InputMethodUtil::AppendInputMethods(const InputMethodDescriptors& imes)
{
    for (const auto& input_method : imes) {
        DCHECK(!input_method.language_codes().empty());
        const std::vector<std::string>& language_codes = input_method.language_codes();
        id_to_descriptor_[input_method.id()] = input_method;

        for (const auto& language_code : language_codes) {
            MultimapDeduplicatedInsert(language_code_to_ids_, language_code, input_method.id());
        }

        const std::optional<std::string>& handwriting_language = input_method.handwriting_language();
        if (handwriting_language.has_value()) {
            MultimapDeduplicatedInsert(handwriting_language_to_ids_, *handwriting_language, input_method.id());
        }
    }
}
...
void InputMethodUtil::InitXkbInputMethodsForTesting(const InputMethodDescriptors& imes)
{
    cached_hardware_layouts_.clear();
...
InputMethodDescriptor InputMethodUtil::GetFallbackInputMethodDescriptor()
{
    ...
    return InputMethodDescriptor(extension_ime_util::GetInputMethodIDByEngineID("xkb:us::eng"), "", "US",
        "us", // layout
        languages,
        true, // login keyboard.
