...
void MockIMECandidateWindowHandler::UpdateLookupTable(const ui::CandidateWindow& table)
{
    ++update_lookup_table_call_count_;
...
void MockIMECandidateWindowHandler::UpdatePreeditText(const std::u16string& text, uint32_t cursor_pos, bool visible)
{
}

void MockIMECandidateWindowHandler::SetCursorAndCompositionBounds(const gfx::Rect& cursor_bounds, const gfx::Rect& composition_bounds)
{
