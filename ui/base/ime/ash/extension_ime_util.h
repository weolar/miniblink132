...
std::string COMPONENT_EXPORT(UI_BASE_IME_ASH) GetInputMethodID(const std::string& extension_id, const std::string& engine_id);
...
std::string COMPONENT_EXPORT(UI_BASE_IME_ASH) GetComponentInputMethodID(const std::string& extension_id, const std::string& engine_id);
...
std::string COMPONENT_EXPORT(UI_BASE_IME_ASH) GetArcInputMethodID(const std::string& extension_id, const std::string& engine_id);
...
std::string COMPONENT_EXPORT(UI_BASE_IME_ASH) GetExtensionIDFromInputMethodID(const std::string& input_method_id);
...
std::string COMPONENT_EXPORT(UI_BASE_IME_ASH) GetInputMethodIDByEngineID(const std::string& engine_id);
...
bool COMPONENT_EXPORT(UI_BASE_IME_ASH) IsExtensionIME(const std::string& input_method_id);
...
bool COMPONENT_EXPORT(UI_BASE_IME_ASH) IsComponentExtensionIME(const std::string& input_method_id);
...
bool COMPONENT_EXPORT(UI_BASE_IME_ASH) IsArcIME(const std::string& input_method_id);

// Returns true if the |input_method_id| is the extension based xkb keyboard,
// otherwise returns false.
bool COMPONENT_EXPORT(UI_BASE_IME_ASH) IsKeyboardLayoutExtension(const std::string& input_method_id);
...
std::string COMPONENT_EXPORT(UI_BASE_IME_ASH) GetComponentIDByInputMethodID(const std::string& input_method_id);

// Only used when ash::features::kImeKoreanModeSwitchDebug flag is enabled.
// TODO(b/302460634): Remove when no longer needed.
bool COMPONENT_EXPORT(UI_BASE_IME_ASH) IsCros1pKorean(const std::string& input_method_id);
