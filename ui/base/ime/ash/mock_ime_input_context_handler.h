...
class COMPONENT_EXPORT(UI_BASE_IME_ASH) MockIMEInputContextHandler : public TextInputTarget {
public:
    ...
    void set_cursor_range(gfx::Range range)
    {
        cursor_range_ = range;
    }
    int commit_text_call_count() const
    {
        return commit_text_call_count_;
    }
    ...
    int send_key_event_call_count() const
    {
        return sent_key_events_.size();
    }

    const std::u16string& last_commit_text() const
    {
