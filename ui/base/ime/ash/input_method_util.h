...
using LanguageCodeToIdsMap = std::multimap<std::string, std::string, std::less<>>;
...
public:
    ...
    std::u16string GetInputMethodMediumName(const InputMethodDescriptor& input_method) const;
    std::u16string GetInputMethodLongNameStripped(const InputMethodDescriptor& input_method) const;
    std::u16string GetInputMethodLongName(const InputMethodDescriptor& input_method) const;
    ...
    const InputMethodDescriptor* GetInputMethodDescriptorFromId(const std::string& input_method_id) const;
    ...
    bool GetInputMethodIdsFromLanguageCode(std::string_view language_code, InputMethodType type, std::vector<std::string>* out_input_method_ids) const;

    std::vector<std::string> GetInputMethodIdsFromHandwritingLanguage(std::string_view handwriting_language);
    ...
    void GetLanguageCodesFromInputMethodIds(const std::vector<std::string>& input_method_ids, std::vector<std::string>* out_language_codes) const;
    ...
    static bool GetMigratedInputMethodIDs(std::vector<std::string>* input_method_ids);
    ...
    static std::string GetLocalizedDisplayName(const InputMethodDescriptor& descriptor);
    ...
    using InputMethodIdToDescriptorMap = std::map<std::string, InputMethodDescriptor>;
...
protected:
    ...
    static bool GetInputMethodIdsFromLanguageCodeInternal(const LanguageCodeToIdsMap& language_code_to_ids, std::string_view normalized_language_code,
...
private:
    ...
    std::u16string GetInputMethodLongNameInternal(const InputMethodDescriptor& input_method, bool short_name) const;
