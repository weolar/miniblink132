...
public:
    ...
    InputMethodDescriptor(const std::string& id, const std::string& name, const std::string& indicator, const std::string& keyboard_layout,
    ...
    const GURL& options_page_url() const
    {
        return options_page_url_;
    }
    const GURL& input_view_url() const
    {
        return input_view_url_;
    }
    const std::string& keyboard_layout() const
    {
        return keyboard_layout_;
    }
    bool is_login_keyboard() const
    {
