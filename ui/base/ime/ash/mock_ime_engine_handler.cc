...
void MockIMEEngineHandler::ProcessKeyEvent(const ui::KeyEvent& key_event, KeyEventDoneCallback callback)
{
...
ui::VirtualKeyboardController* MockIMEEngineHandler::GetVirtualKeyboardController() const
{
    return nullptr;
}
...
void MockIMEEngineHandler::AssistiveWindowChanged(const ash::ime::AssistiveWindow& window)
{
}

void MockIMEEngineHandler::SetSurroundingText(const std::u16string& text, const gfx::Range selection_range, uint32_t offset_pos)
{
