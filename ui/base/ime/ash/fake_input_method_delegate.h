...
class COMPONENT_EXPORT(UI_BASE_IME_ASH) FakeInputMethodDelegate : public InputMethodDelegate {
public:
    using GetLocalizedStringCallback = base::RepeatingCallback<std::u16string(int)>;
    ...
    void set_get_localized_string_callback(const GetLocalizedStringCallback& callback)
    {
