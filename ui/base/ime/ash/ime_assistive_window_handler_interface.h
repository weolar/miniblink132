...
public:
    ...
    virtual void SetAssistiveWindowProperties(const input_method::AssistiveWindowProperties& window)
    {
    }
    ...
    // parameters.
    virtual void SetButtonHighlighted(const ui::ime::AssistiveWindowButton& button, bool highlighted)
    {
    }
