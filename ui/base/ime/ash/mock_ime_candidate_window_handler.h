...
class COMPONENT_EXPORT(UI_BASE_IME_ASH) MockIMECandidateWindowHandler : public IMECandidateWindowHandlerInterface {
public:
    ...
    void UpdatePreeditText(const std::u16string& text, uint32_t cursor_pos, bool visible) override;
    void SetCursorAndCompositionBounds(const gfx::Rect& cursor_bounds, const gfx::Rect& composition_bounds) override;
