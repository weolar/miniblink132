...
public:
    using KeyEventDoneCallback = base::OnceCallback<void(ui::ime::KeyEventHandledState)>;
    ...
    struct InputContext {
        explicit InputContext(ui::TextInputType type)
            : type(type)
        {
        }
        ...
        AutocapitalizationMode autocapitalization_mode = AutocapitalizationMode::kUnspecified;
        // How this input field was focused.
        ui::TextInputClient::FocusReason focus_reason = ui::TextInputClient::FOCUS_REASON_NONE;
    ...
    virtual void ProcessKeyEvent(const ui::KeyEvent& key_event, KeyEventDoneCallback callback) = 0;
    ...
    virtual void SetSurroundingText(const std::u16string& text, gfx::Range selection_range, uint32_t offset_pos) = 0;
    ...
    virtual ui::VirtualKeyboardController* GetVirtualKeyboardController() const = 0;
    ...
    virtual void AssistiveWindowButtonClicked(const ui::ime::AssistiveWindowButton& button)
    {
    }
