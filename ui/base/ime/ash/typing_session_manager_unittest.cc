...
public:
    TypingSessionManagerTest()
        : typing_session_manager_(&test_clock_)
    {
    }
...
TEST_F(TypingSessionManagerTest, RecordMetricsForSimpleTypingSession)
{
    ...
    histogram_tester.ExpectUniqueSample("InputMethod.CharactersPerSession", 35, 1);
...
TEST_F(TypingSessionManagerTest, RecordMetricsForAutomaticallyEndedTypingSession)
{
    base::HistogramTester histogram_tester;
...
TEST_F(TypingSessionManagerTest, DoNotRecordInvalidTypingSessionAutomaticallyEnded)
{
    base::HistogramTester histogram_tester;
