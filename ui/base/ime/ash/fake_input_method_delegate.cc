...
std::u16string FakeInputMethodDelegate::GetLocalizedString(int resource_id) const
{
...
void FakeInputMethodDelegate::SetHardwareKeyboardLayoutForTesting(const std::string& layout)
{
