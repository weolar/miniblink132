...
std::optional<size_t> Utf16OffsetFromUtf8Offset(std::string_view text, size_t utf8_offset)
{
...
std::optional<size_t> Utf8OffsetFromUtf16Offset(std::u16string_view text, size_t utf16_offset)
{
