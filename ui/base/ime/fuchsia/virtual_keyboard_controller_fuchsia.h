...
class COMPONENT_EXPORT(UI_BASE_IME) VirtualKeyboardControllerFuchsia : public VirtualKeyboardController {
public:
    // |input_method| must outlive |this|.
    VirtualKeyboardControllerFuchsia(fuchsia_ui_views::ViewRef view_ref, ui::InputMethodBase* input_method);
    ~VirtualKeyboardControllerFuchsia() override;

    VirtualKeyboardControllerFuchsia(VirtualKeyboardControllerFuchsia&) = delete;
    VirtualKeyboardControllerFuchsia operator=(VirtualKeyboardControllerFuchsia&) = delete;
...
private:
    ...
    void OnVisibilityChange(const fidl::Result<fuchsia_input_virtualkeyboard::Controller::WatchVisibility>& result);
    ...
    fuchsia_input_virtualkeyboard::TextType requested_type_ = fuchsia_input_virtualkeyboard::TextType::kAlphanumeric;
    fidl::Client<fuchsia_input_virtualkeyboard::Controller> controller_client_;
    base::FidlErrorEventLogger<fuchsia_input_virtualkeyboard::Controller> controller_error_logger_ { "fuchsia.input.virtualkeyboard.Controller" };
