...
public:
    ...
    void ExpectClientChange(TextInputClient* previous_client, TextInputClient* next_client)
    {
    ...
    void OnWillChangeFocusedClient(TextInputClient* focused_before, TextInputClient* focused)
    {
    ...
    void OnDidChangeFocusedClient(TextInputClient* focused_before, TextInputClient* focused)
    {
        EXPECT_TRUE(call_expected_);
...
private:
    ...
    // InputMethodBase:
    void OnWillChangeFocusedClient(TextInputClient* focused_before, TextInputClient* focused) override
    {
        verifier_->OnWillChangeFocusedClient(focused_before, focused);
    }

    void OnDidChangeFocusedClient(TextInputClient* focused_before, TextInputClient* focused) override
    {
...
typedef base::ScopedObservation<InputMethod, InputMethodObserver> InputMethodScopedObservation;

void SetFocusedTextInputClient(InputMethod* input_method, TextInputClient* text_input_client)
{
...
TEST_F(InputMethodBaseTest, SetFocusedTextInputClient)
{
...

    {
        ...
        verifier.ExpectClientChange(&text_input_client_1st, &text_input_client_2nd);
