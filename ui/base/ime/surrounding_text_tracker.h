...
public:
    ...
    UpdateResult Update(const std::u16string_view surrounding_text, size_t utf16_offset, const gfx::Range& selection);
    ...
    void OnInsertText(const std::u16string_view text, TextInputClient::InsertTextCursorBehavior cursor_behavior);
...
private:
    ...
    void ResetInternal(std::u16string_view surrounding_text, size_t utf16_offset, const gfx::Range& selection);
