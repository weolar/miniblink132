...
void DummyInputMethod::SetImeKeyEventDispatcher(ImeKeyEventDispatcher* ime_key_event_dispatcher)
{
}
...
#if BUILDFLAG(IS_WIN)
bool DummyInputMethod::OnUntranslatedIMEMessage(const CHROME_MSG event, NativeEventResult* result)
{
    return false;
}
...
ui::EventDispatchDetails DummyInputMethod::DispatchKeyEvent(ui::KeyEvent* event)
{
...
void DummyInputMethod::SetVirtualKeyboardControllerForTesting(std::unique_ptr<VirtualKeyboardController> controller)
{
}
