...
using LinuxInputMethodContextFactory = base::RepeatingCallback<std::unique_ptr<ui::LinuxInputMethodContext>(LinuxInputMethodContextDelegate*)>;
...
COMPONENT_EXPORT(UI_BASE_IME_LINUX)
std::unique_ptr<LinuxInputMethodContext> CreateLinuxInputMethodContext(LinuxInputMethodContextDelegate* delegate);
