...
public:
    ...
    virtual void WillUpdateFocus(TextInputClient* old_client, TextInputClient* new_client)
    {
    }
...
public:
    ...
    virtual void OnSetPreeditRegion(const gfx::Range& range, const std::vector<ImeTextSpan>& spans) = 0;
