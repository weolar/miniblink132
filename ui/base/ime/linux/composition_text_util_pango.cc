...
void ExtractCompositionTextFromGtkPreedit(const char* utf8_text, PangoAttrList* attrs, int cursor_position, CompositionText* composition)
{
    *composition = CompositionText();
    ...
    size_t cursor_offset = char16_offsets[std::clamp(cursor_position, 0, char_length)];
    ...
    if (attrs) {
        ...
        do {
            ...
            if (background_attr || underline_attr) {
                ...
                ImeTextSpan ime_text_span(ImeTextSpan::Type::kComposition, char16_offsets[start], char16_offsets[end], ImeTextSpan::Thickness::kThin,
