...
// interface.
class COMPONENT_EXPORT(UI_BASE_IME_LINUX) InputMethodAuraLinux : public InputMethodBase, public LinuxInputMethodContextDelegate {
public:
...
private:
    ...
    ui::EventDispatchDetails DispatchImeFilteredKeyPressEvent(ui::KeyEvent* event);
    ...
    void OnPreeditUpdate(const ui::CompositionText& composition_text, bool force_update_client);
    ...
    [[nodiscard]] ui::EventDispatchDetails SendFakeProcessKeyEvent(ui::KeyEvent* event) const;
