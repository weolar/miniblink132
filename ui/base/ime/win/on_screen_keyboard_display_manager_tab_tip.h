...
class COMPONENT_EXPORT(UI_BASE_IME_WIN) OnScreenKeyboardDisplayManagerTabTip final : public VirtualKeyboardController {
public:
    OnScreenKeyboardDisplayManagerTabTip(HWND hwnd);

    OnScreenKeyboardDisplayManagerTabTip(const OnScreenKeyboardDisplayManagerTabTip&) = delete;
    OnScreenKeyboardDisplayManagerTabTip& operator=(const OnScreenKeyboardDisplayManagerTabTip&) = delete;
