...
public:
    ...
    unsigned enable_ime_call_count() const
    {
        return enable_ime_call_count_;
    }

    // Call count of DisableIME().
    unsigned disable_ime_call_count() const
    {
        return disable_ime_call_count_;
    }
    ...
    unsigned on_text_layout_changed() const
    {
    ...
    TextInputClient* text_input_clinet() const
    {
        return text_input_client_;
    }

    // Returns currently focused window handle.
    HWND focused_window() const
    {
