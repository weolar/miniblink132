...
public:
    ...
    static void ReplaceThreadLocalTSFBridge(std::unique_ptr<TSFBridge> new_instance);
    ...
    virtual void SetFocusedClient(HWND focused_window, TextInputClient* client) = 0;
    ...
    virtual void RemoveImeKeyEventDispatcher(ImeKeyEventDispatcher* ime_key_event_dispatcher) = 0;
