...
class COMPONENT_EXPORT(UI_BASE_IME_WIN) InputMethodWinTSF : public InputMethodWinBase {
public:
    InputMethodWinTSF(ImeKeyEventDispatcher* ime_key_event_dispatcher, HWND attached_window_handle);
    ...
    bool OnUntranslatedIMEMessage(const CHROME_MSG event, NativeEventResult* result) override;
