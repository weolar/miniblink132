...
{
    *os << " input_type: " << testing::PrintToString(data.input_type) << "; input_mode: " << testing::PrintToString(data.input_mode);
}

class TSFInputScopeTest : public testing::TestWithParam<GetInputScopesTestCase> { };
...
const GetInputScopesTestCase kGetInputScopesTestCases[] = {
    ...
    { TEXT_INPUT_TYPE_EMAIL, TEXT_INPUT_MODE_DEFAULT, 1, { IS_EMAIL_SMTPEMAILADDRESS } },
    { TEXT_INPUT_TYPE_NUMBER, TEXT_INPUT_MODE_DEFAULT, 1, { IS_NUMBER } },
    { TEXT_INPUT_TYPE_TELEPHONE, TEXT_INPUT_MODE_DEFAULT, 1, { IS_TELEPHONE_FULLTELEPHONENUMBER } },
    ...
    { TEXT_INPUT_TYPE_CONTENT_EDITABLE, TEXT_INPUT_MODE_DEFAULT, 1, { IS_DEFAULT } },
    ...
    { TEXT_INPUT_TYPE_NONE, TEXT_INPUT_MODE_TEL, 1, { IS_TELEPHONE_FULLTELEPHONENUMBER } },
    { TEXT_INPUT_TYPE_NONE, TEXT_INPUT_MODE_EMAIL, 1, { IS_EMAIL_SMTPEMAILADDRESS } },
    { TEXT_INPUT_TYPE_NONE, TEXT_INPUT_MODE_URL, 1, { IS_URL } },
    { TEXT_INPUT_TYPE_NONE, TEXT_INPUT_MODE_SEARCH, 1, { IS_SEARCH } },
    // Mixed test cases.
    { TEXT_INPUT_TYPE_EMAIL, TEXT_INPUT_MODE_EMAIL, 1, { IS_EMAIL_SMTPEMAILADDRESS } },
    { TEXT_INPUT_TYPE_NUMBER, TEXT_INPUT_MODE_NUMERIC, 2, { IS_NUMBER, IS_DIGITS } },
    { TEXT_INPUT_TYPE_TELEPHONE, TEXT_INPUT_MODE_TEL, 1, { IS_TELEPHONE_FULLTELEPHONENUMBER } },
...
TEST_P(TSFInputScopeTest, GetInputScopes)
{
    ...
    std::vector<InputScope> input_scopes = tsf_inputscope::GetInputScopes(test_case.input_type, test_case.input_mode);
...
INSTANTIATE_TEST_SUITE_P(All, TSFInputScopeTest, ::testing::ValuesIn(kGetInputScopesTestCases));
...
class TSFCreateInputScopeTest : public testing::TestWithParam<CreateInputScopesTestCase> { };
const CreateInputScopesTestCase kCreateInputScopesTestCases[] = {
    ...
    // Mixed test cases.
    { TEXT_INPUT_TYPE_NUMBER, TEXT_INPUT_MODE_NUMERIC, true, 2, { IS_NUMBER, IS_DIGITS } },
...
TEST_P(TSFCreateInputScopeTest, CreateInputScopes)
{
    ...
    Microsoft::WRL::ComPtr<ITfInputScope> input_scope
        = tsf_inputscope::CreateInputScope(test_case.input_type, test_case.input_mode, test_case.should_do_learning);
...
INSTANTIATE_TEST_SUITE_P(All, TSFCreateInputScopeTest, ::testing::ValuesIn(kCreateInputScopesTestCases));
