...
void MockTSFBridge::SetFocusedClient(HWND focused_window, TextInputClient* client)
{
...
void MockTSFBridge::SetImeKeyEventDispatcher(ImeKeyEventDispatcher* ime_key_event_dispatcher)
{
    ime_key_event_dispatcher_ = ime_key_event_dispatcher;
}

void MockTSFBridge::RemoveImeKeyEventDispatcher(ImeKeyEventDispatcher* ime_key_event_dispatcher)
{
