...
{
    visible_ = true;
    observers_.Notify(&VirtualKeyboardControllerObserver::OnKeyboardVisible, gfx::Rect());
    return true;
}
...
void VirtualKeyboardControllerStub::AddObserver(VirtualKeyboardControllerObserver* observer)
{
    observers_.AddObserver(observer);
}

void VirtualKeyboardControllerStub::RemoveObserver(VirtualKeyboardControllerObserver* observer)
{
