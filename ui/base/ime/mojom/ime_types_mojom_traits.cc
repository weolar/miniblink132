...
// static
ui::mojom::TextInputAction EnumTraits<ui::mojom::TextInputAction, ui::TextInputAction>::ToMojom(ui::TextInputAction text_input_action)
{
...
// static
bool EnumTraits<ui::mojom::TextInputAction, ui::TextInputAction>::FromMojom(ui::mojom::TextInputAction input, ui::TextInputAction* out)
{
    switch (input) {
...
// static
ui::mojom::TextInputMode EnumTraits<ui::mojom::TextInputMode, ui::TextInputMode>::ToMojom(ui::TextInputMode text_input_mode)
{
...
// static
bool EnumTraits<ui::mojom::TextInputMode, ui::TextInputMode>::FromMojom(ui::mojom::TextInputMode input, ui::TextInputMode* out)
{
    switch (input) {
...
// static
ui::mojom::TextInputType EnumTraits<ui::mojom::TextInputType, ui::TextInputType>::ToMojom(ui::TextInputType text_input_type)
{
...
// static
bool EnumTraits<ui::mojom::TextInputType, ui::TextInputType>::FromMojom(ui::mojom::TextInputType input, ui::TextInputType* out)
{
    switch (input) {
...
// static
bool StructTraits<ui::mojom::ImeTextSpanDataView, ui::ImeTextSpan>::Read(ui::mojom::ImeTextSpanDataView data, ui::ImeTextSpan* out)
{
    if (data.is_null())
        return false;
...
// static
ui::mojom::ImeTextSpanType EnumTraits<ui::mojom::ImeTextSpanType, ui::ImeTextSpan::Type>::ToMojom(ui::ImeTextSpan::Type ime_text_span_type)
{
...
// static
bool EnumTraits<ui::mojom::ImeTextSpanType, ui::ImeTextSpan::Type>::FromMojom(ui::mojom::ImeTextSpanType type, ui::ImeTextSpan::Type* out)
{
    switch (type) {
...
// static
ui::mojom::ImeTextSpanThickness EnumTraits<ui::mojom::ImeTextSpanThickness, ui::ImeTextSpan::Thickness>::ToMojom(ui::ImeTextSpan::Thickness thickness)
{
    switch (thickness) {
...
// static
bool EnumTraits<ui::mojom::ImeTextSpanThickness, ui::ImeTextSpan::Thickness>::FromMojom(ui::mojom::ImeTextSpanThickness input, ui::ImeTextSpan::Thickness* out)
{
    switch (input) {
...
// static
ui::mojom::ImeTextSpanUnderlineStyle EnumTraits<ui::mojom::ImeTextSpanUnderlineStyle, ui::ImeTextSpan::UnderlineStyle>::ToMojom(
...
// static
bool EnumTraits<ui::mojom::ImeTextSpanUnderlineStyle, ui::ImeTextSpan::UnderlineStyle>::FromMojom(
    ui::mojom::ImeTextSpanUnderlineStyle input, ui::ImeTextSpan::UnderlineStyle* out)
{
    switch (input) {
