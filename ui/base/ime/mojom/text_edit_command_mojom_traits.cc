...
ui::mojom::TextEditCommand EnumTraits<ui::mojom::TextEditCommand, ui::TextEditCommand>::ToMojom(ui::TextEditCommand input)
{
    switch (input) {
...
bool EnumTraits<ui::mojom::TextEditCommand, ui::TextEditCommand>::FromMojom(ui::mojom::TextEditCommand input, ui::TextEditCommand* output)
{
    switch (input) {
#include "ui/base/ime/text_edit_commands.inc"
    }
