...
class COMPONENT_EXPORT(UI_BASE_IME) VirtualKeyboardControllerStub final : public VirtualKeyboardController {
public:
    VirtualKeyboardControllerStub();

    VirtualKeyboardControllerStub(const VirtualKeyboardControllerStub&) = delete;
    VirtualKeyboardControllerStub& operator=(const VirtualKeyboardControllerStub&) = delete;
