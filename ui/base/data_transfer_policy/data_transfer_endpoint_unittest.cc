...
{
    DataTransferEndpoint original1(EndpointType::kClipboardHistory, { .notify_if_restricted = true });
...
{
    DataTransferEndpoint default_endpoint1(EndpointType::kDefault, { .notify_if_restricted = true });
    DataTransferEndpoint default_endpoint2(EndpointType::kDefault, { .notify_if_restricted = false });
