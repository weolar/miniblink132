...
[[nodiscard]] COMPONENT_EXPORT(UI_BASE_CLIPBOARD) std::vector<uint8_t> EncodeBitmapToPng(const SkBitmap& bitmap);
...
[[nodiscard]] COMPONENT_EXPORT(UI_BASE_CLIPBOARD) std::vector<uint8_t> EncodeBitmapToPngAcceptJank(const SkBitmap& bitmap);
