...
private:
    ...
    void WritePortableTextRepresentation(ClipboardBuffer buffer, const ObjectMap& objects);
    ...
    void AddSourceToClipboard(const ClipboardBuffer buffer, std::unique_ptr<DataTransferEndpoint> data_src);
