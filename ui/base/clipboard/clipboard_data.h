...
public:
    ...
    const std::string& markup_data() const
    {
        return markup_data_;
    }
    ...
    const std::string& bookmark_title() const
    {
        return bookmark_title_;
    }
    ...
    void SetCustomData(const ClipboardFormatType& format, const std::string& data);

    bool web_smart_paste() const
    {
        return web_smart_paste_;
    }
    ...
    const std::vector<ui::FileInfo>& filenames() const
    {
        return filenames_;
    }
    ...
    const std::optional<DataTransferEndpoint>& source() const
    {
        return src_;
    }
...
#if BUILDFLAG(IS_CHROMEOS)
    std::optional<base::Time> commit_time() const
    {
        return commit_time_;
    }
