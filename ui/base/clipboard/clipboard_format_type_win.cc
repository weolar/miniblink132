...
ClipboardFormatType::ClipboardFormatType(UINT native_format, LONG index, DWORD tymed)
...
// static
ClipboardFormatType ClipboardFormatType::Deserialize(const std::string& serialization)
{
...
// static
ClipboardFormatType ClipboardFormatType::CustomPlatformType(const std::string& format_string)
{
    ...
    return ClipboardFormatType(RegisterClipboardFormatChecked(base::ASCIIToWide(format_string).c_str()));
}

// static
const ClipboardFormatType& ClipboardFormatType::WebCustomFormatMap()
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"Web Custom Format Map"));
    return *format;
}
...
// static
ClipboardFormatType ClipboardFormatType::GetType(const std::string& format_string)
{
    return ClipboardFormatType(RegisterClipboardFormatChecked(base::ASCIIToWide(format_string).c_str()));
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_INETURLW));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"HTML Format"));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_MIME_SVG_XML));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"Rich Text Format"));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"PNG"));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_INETURLA));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_FILENAMEA));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_MIME_HTML));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_FILEDESCRIPTORA));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_FILEDESCRIPTORW));
    return *format;
}
...
const ClipboardFormatType& ClipboardFormatType::FileContentZeroType()
{
    ...
    // content.
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_FILECONTENTS), 0);
    return *format;
}
...
{
    static base::NoDestructor<std::map<LONG, ClipboardFormatType>> index_to_type_map;
    return *index_to_type_map;
}

// static
const ClipboardFormatType& ClipboardFormatType::FileContentAtIndexType(LONG index)
{
    auto& index_to_type_map = FileContentTypeMap();

    auto insert_or_assign_result = index_to_type_map.insert(
        { index, ClipboardFormatType(RegisterClipboardFormatChecked(CFSTR_FILECONTENTS), index, TYMED_HGLOBAL | TYMED_ISTREAM | TYMED_ISTORAGE) });
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_FILENAMEW));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(CFSTR_SHELLIDLIST));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"text/x-moz-url"));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"WebKit Smart Paste Format"));
    return *format;
}
...
const ClipboardFormatType& ClipboardFormatType::DataTransferCustomType()
{
    ...
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"Chromium Web Custom MIME Data Format"));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"Chromium internal source URL"));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"CanIncludeInClipboardHistory"));
    return *format;
}
...
{
    static base::NoDestructor<ClipboardFormatType> format(RegisterClipboardFormatChecked(L"CanUploadToCloudClipboard"));
    return *format;
}
