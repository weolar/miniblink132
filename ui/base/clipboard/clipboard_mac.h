...
private:
    ...
    void ReadPngInternal(ClipboardBuffer buffer, NSPasteboard* pasteboard, ReadPngCallback callback) const;
    std::optional<DataTransferEndpoint> GetSourceInternal(ClipboardBuffer buffer, NSPasteboard* pasteboard) const;
    void ClearInternal(ClipboardBuffer buffer, NSPasteboard* pasteboard);
    void WritePortableAndPlatformRepresentationsInternal(ClipboardBuffer buffer, const ObjectMap& objects,
        std::vector<Clipboard::PlatformRepresentation> platform_representations, std::unique_ptr<DataTransferEndpoint> data_src, NSPasteboard* pasteboard,
