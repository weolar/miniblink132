...
{
    return base::StrCat({ "application/web;type=\"custom/format", base::NumberToString(index), "\"" });
}

// static
const ClipboardFormatType& ClipboardFormatType::WebCustomFormatMap()
{
    static base::NoDestructor<ClipboardFormatType> type("application/web;type=\"custom/formatmap\"");
    return *type;
}
...
{
    static base::NoDestructor<ClipboardFormatType> type(kMimeTypeWebkitSmartPaste);
    return *type;
}
...
{
    static base::NoDestructor<ClipboardFormatType> type(kMimeTypeDataTransferCustomData);
    return *type;
}
