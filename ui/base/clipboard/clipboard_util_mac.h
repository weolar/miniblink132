...
class COMPONENT_EXPORT(UI_BASE_CLIPBOARD) UniquePasteboard : public base::RefCounted<UniquePasteboard> {
public:
    UniquePasteboard();
...
NSArray<NSPasteboardItem*>* PasteboardItemsFromUrls(NSArray<NSString*>* urls, NSArray<NSString*>* titles);
...
COMPONENT_EXPORT(UI_BASE_CLIPBOARD)
NSArray<URLAndTitle*>* URLsAndTitlesFromPasteboard(NSPasteboard* pboard, bool include_files);
...
COMPONENT_EXPORT(UI_BASE_CLIPBOARD)
void WriteFilesToPasteboard(NSPasteboard* pboard, const std::vector<FileInfo>& files);
