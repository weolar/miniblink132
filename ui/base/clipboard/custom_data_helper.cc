...
std::optional<std::u16string> ReadCustomDataForType(base::span<const uint8_t> data, std::u16string_view type)
{
    base::Pickle pickle = base::Pickle::WithData(data);
    base::PickleIterator iter(pickle);
...
std::optional<std::unordered_map<std::u16string, std::u16string>> ReadCustomDataIntoMap(base::span<const uint8_t> data)
{
    base::Pickle pickle = base::Pickle::WithData(data);
    base::PickleIterator iter(pickle);
