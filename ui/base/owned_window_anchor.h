...
struct OwnedWindowAnchor {
    ...
    OwnedWindowConstraintAdjustment constraint_adjustment = OwnedWindowConstraintAdjustment::kAdjustmentNone;
};

} // namespace ui

inline constexpr ui::OwnedWindowConstraintAdjustment operator|(ui::OwnedWindowConstraintAdjustment l, ui::OwnedWindowConstraintAdjustment r)
{
    using T = std::underlying_type_t<ui::OwnedWindowConstraintAdjustment>;
    return static_cast<ui::OwnedWindowConstraintAdjustment>(static_cast<T>(l) | static_cast<T>(r));
}
