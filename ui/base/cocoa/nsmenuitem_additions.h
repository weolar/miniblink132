...
- (void)cr_setKeyEquivalent:(NSString*)aString modifierMask:(NSEventModifierFlags)mask;
...
// source.
void COMPONENT_EXPORT(UI_BASE) SetIsInputSourceCommandQwertyForTesting(bool is_command_qwerty);

void COMPONENT_EXPORT(UI_BASE) SetIsInputSourceDvorakRightOrLeftForTesting(bool is_dvorak_right_or_left);

void COMPONENT_EXPORT(UI_BASE) SetIsInputSourceCommandHebrewForTesting(bool is_command_hebrew);

void COMPONENT_EXPORT(UI_BASE) SetIsInputSourceCommandArabicForTesting(bool is_command_arabic);
...
// held.
bool COMPONENT_EXPORT(UI_BASE) IsKeyboardLayoutCommandQwerty(NSString* layout_id);
