...
public:
    ...
    public:
        ...
        virtual remote_cocoa::mojom::Application* GetRemoteCocoaApplication() const = 0;
    ...
    virtual void ViewsHostableSetParentAccessible(gfx::NativeViewAccessible parent_accessibility_element) = 0;
