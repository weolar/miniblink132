...
public:
    ...
    public:
        ...
        virtual ActionResult PressButton(TrackedElement* element, InputType input_type);
        ...
        virtual ActionResult SelectMenuItem(TrackedElement* element, InputType input_type);
        ...
        virtual ActionResult DoDefaultAction(TrackedElement* element, InputType input_type);
        ...
        // zero-indexed.
        virtual ActionResult SelectTab(TrackedElement* tab_collection, size_t index, InputType input_type);
        ...
        virtual ActionResult SelectDropdownItem(TrackedElement* dropdown, size_t index, InputType input_type);

        // Sets or modifies the text of a text box, editable combobox, etc.
        virtual ActionResult EnterText(TrackedElement* element, std::u16string text, TextEntryMode mode);
        ...
        virtual ActionResult SendAccelerator(TrackedElement* element, Accelerator accelerator);
#endif
    ...
    template <class T> T* AddSimulator(std::unique_ptr<T> simulator)
    {
    ...
    ActionResult PressButton(TrackedElement* element, InputType input_type = InputType::kDontCare);
    ...
    ActionResult SelectMenuItem(TrackedElement* element, InputType input_type = InputType::kDontCare);
    ...
    ActionResult SelectTab(TrackedElement* tab_collection, size_t index, InputType input_type = InputType::kDontCare);
    ...
    ActionResult SelectDropdownItem(TrackedElement* dropdown, size_t index, InputType input_type = InputType::kDontCare);
    ...
    ActionResult DoDefaultAction(TrackedElement* element, InputType input_type = InputType::kDontCare);
    ...
    ActionResult EnterText(TrackedElement* element, std::u16string text, TextEntryMode mode = TextEntryMode::kReplaceAll);
    ...
    // accelerators.
    ActionResult SendAccelerator(TrackedElement* element, Accelerator accelerator);
#endif
