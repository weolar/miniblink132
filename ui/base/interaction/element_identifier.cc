...
ElementIdentifier ElementIdentifier::FromRawValue(intptr_t value)
{
    ...
    const auto* impl = reinterpret_cast<const internal::ElementIdentifierImpl*>(value);
...
// static
void ElementIdentifier::RegisterKnownIdentifier(ElementIdentifier element_identifier)
{
    ...
    DCHECK(!existing || existing == element_identifier) << "Duplicate identifier: " << element_identifier.handle_->name;
#endif
