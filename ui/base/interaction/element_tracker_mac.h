...
public:
    TrackedElementMac(ElementIdentifier identifier, ElementContext context, const gfx::Rect& screen_bounds);
...
public:
    ...
    void NotifyMenuItemShown(NSMenu* menu, ElementIdentifier identifier, const gfx::Rect& screen_bounds);
...
protected:
    ...
    bool is_tracking_any_menus() const
    {
        return !root_menu_to_data_.empty();
    }
