...
public:
    ...
    explicit constexpr ElementIdentifier(const internal::ElementIdentifierImpl* provider)
        : handle_(provider)
    {
    }
...
private:
    ...
    friend COMPONENT_EXPORT(UI_BASE) void PrintTo(ElementIdentifier element_identifier, std::ostream* os);
...
public:
    ...
    template <class T>
    explicit ElementContext(T value)
        : value_(static_cast<uintptr_t>(value))
    {
    }
    ...
    {
        return static_cast<intptr_t>(value_);
    }
...
COMPONENT_EXPORT(UI_BASE)
extern std::ostream& operator<<(std::ostream& os, ElementIdentifier element_identifier);

COMPONENT_EXPORT(UI_BASE)
extern std::ostream& operator<<(std::ostream& os, ElementContext element_context);

// Required for interoperability with PropertyHandler.
template <> class ClassPropertyCaster<ui::ElementIdentifier> {
public:
    static int64_t ToInt64(ui::ElementIdentifier x)
    {
...
#define DECLARE_ELEMENT_IDENTIFIER_VALUE(IdentifierName)                                                                                                       \
    ...
    inline constexpr ui::ElementIdentifier IdentifierName(&IdentifierName##Provider)
...
#define DECLARE_EXPORTED_ELEMENT_IDENTIFIER_VALUE(ExportName, IdentifierName)                                                                                  \
    ExportName extern const ui::internal::ElementIdentifierImpl IdentifierName##Provider;                                                                      \
...
#define DEFINE_EXPORTED_ELEMENT_IDENTIFIER_VALUE(IdentifierName)                                                                                               \
    const ui::internal::ElementIdentifierImpl IdentifierName##Provider { #IdentifierName };                                                                    \
...
#define DEFINE_CLASS_ELEMENT_IDENTIFIER_VALUE(ClassName, IdentifierName)                                                                                       \
    const ui::internal::ElementIdentifierImpl ClassName::IdentifierName##Provider { #ClassName "::" #IdentifierName };                                         \
...
#define LOCAL_ELEMENT_IDENTIFIER_NAME(File, Line, Name) File "::" #Line "::" #Name
...
#define DEFINE_MACRO_ELEMENT_IDENTIFIER_VALUE(File, Line, IdentifierName)                                                                                      \
    static constexpr ui::internal::ElementIdentifierImpl IdentifierName##Provider { LOCAL_ELEMENT_IDENTIFIER_NAME(File, Line, IdentifierName) };               \
...
#define DEFINE_LOCAL_ELEMENT_IDENTIFIER_VALUE(IdentifierName) DEFINE_MACRO_ELEMENT_IDENTIFIER_VALUE(__FILE__, __LINE__, IdentifierName)
