...
public:
    ...
    gfx::Vector2dF GetVelocityForFlingStart(const blink::WebGestureEvent& gesture_start);
...
private:
    ...
    blink::WebGestureDevice source_device_ = blink::WebGestureDevice::kUninitialized;
    int modifiers_ = 0;
