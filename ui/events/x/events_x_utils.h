...
EVENTS_X_EXPORT int GetEventFlagsFromXKeyEvent(const x11::KeyEvent& key, bool send_event);
...
EVENTS_X_EXPORT gfx::Vector2d GetMouseWheelOffsetFromXEvent(const x11::Event& xev);
...
EVENTS_X_EXPORT PointerDetails GetStylusPointerDetailsFromXEvent(const x11::Event& xev);
...
// Gets the pointer details from an x11::Event.
EVENTS_X_EXPORT PointerDetails GetTouchPointerDetailsFromXEvent(const x11::Event& xev);

// Returns whether this is a scroll event and optionally gets the amount to be
// scrolled. |x_offset|, |y_offset| and |finger_count| can be NULL.
EVENTS_X_EXPORT bool GetScrollOffsetsFromXEvent(
...
EVENTS_X_EXPORT bool GetFlingDataFromXEvent(const x11::Event& xev, float* vx, float* vy, float* vx_ordinal, float* vy_ordinal, bool* is_cancel);
