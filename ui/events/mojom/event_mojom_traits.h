...
template <> struct TypeConverter<ui::mojom::EventType, ui::EventType> {
    static ui::mojom::EventType Convert(ui::EventType type);
};

template <> struct TypeConverter<ui::EventType, ui::mojom::EventType> {
    static ui::EventType Convert(ui::mojom::EventType type);
};

template <> struct StructTraits<ui::mojom::EventDataView, EventUniquePtr> {
...
template <> struct EnumTraits<ui::mojom::EventMomentumPhase, ui::EventMomentumPhase> {
    ...
    static bool FromMojom(ui::mojom::EventMomentumPhase input, ui::EventMomentumPhase* out)
    {
        switch (input) {
...
template <> struct StructTraits<ui::mojom::PointerDetailsDataView, ui::PointerDetails> {
    static ui::EventPointerType pointer_type(const ui::PointerDetails& i)
    {
        return i.pointer_type;
    }
    static float radius_x(const ui::PointerDetails& i)
    {
        return i.radius_x;
    }
    static float radius_y(const ui::PointerDetails& i)
    {
        return i.radius_y;
    }
    static float force(const ui::PointerDetails& i)
    {
        return i.force;
    }
    static float tilt_x(const ui::PointerDetails& i)
    {
        return i.tilt_x;
    }
    static float tilt_y(const ui::PointerDetails& i)
    {
        return i.tilt_y;
    }
    ...
    static float twist(const ui::PointerDetails& i)
    {
        return i.twist;
    }
    static int32_t id(const ui::PointerDetails& i)
    {
        return i.id;
    }
    static int32_t offset_x(const ui::PointerDetails& i)
    {
        return i.offset.x();
    }
    static int32_t offset_y(const ui::PointerDetails& i)
    {
        return i.offset.y();
    }

    static bool Read(ui::mojom::PointerDetailsDataView data, ui::PointerDetails* out);
};

template <> struct EnumTraits<ui::mojom::ScrollEventPhase, ui::ScrollEventPhase> {
    ...
    static bool FromMojom(ui::mojom::ScrollEventPhase input, ui::ScrollEventPhase* out)
    {
        switch (input) {
...
template <> struct EnumTraits<ui::mojom::GestureDeviceType, ui::GestureDeviceType> {
    ...
    static bool FromMojom(ui::mojom::GestureDeviceType input, ui::GestureDeviceType* out)
    {
        switch (input) {
