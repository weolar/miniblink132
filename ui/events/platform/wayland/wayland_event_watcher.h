...
public:
    ...
    static std::unique_ptr<WaylandEventWatcher> CreateWaylandEventWatcher(wl_display* display, wl_event_queue* event_queue, bool use_threaded_polling = false);
...
protected:
    WaylandEventWatcher(wl_display* display, wl_event_queue* event_queue, bool use_threaded_polling);
