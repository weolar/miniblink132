...
public:
    ...
    // wasn't any).
    std::unique_ptr<ScopedEventDispatcher> OverrideDispatcher(PlatformEventDispatcher* dispatcher);
...
protected:
    typedef base::ObserverList<PlatformEventObserver>::Unchecked PlatformEventObserverList;
    ...
    PlatformEventObserverList& observers()
    {
        return observers_;
    }
...
private:
    ...
    // is well-defined.
    using PlatformEventDispatcherList = base::ObserverList<PlatformEventDispatcher>::Unchecked;
