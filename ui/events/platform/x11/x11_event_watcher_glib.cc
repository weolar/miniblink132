...
gboolean XSourceDispatch(GSource* source, GSourceFunc unused_func, gpointer data)
{
    auto* connection = static_cast<GLibX11Source*>(source)->connection.get();
    connection->Dispatch();
...
GSourceFuncs XSourceFuncs = { XSourcePrepare, XSourceCheck, XSourceDispatch, XSourceFinalize };
...
void X11EventWatcherGlib::StartWatching()
{
    ...
    GLibX11Source* glib_x_source = static_cast<GLibX11Source*>(g_source_new(&XSourceFuncs, sizeof(GLibX11Source)));
