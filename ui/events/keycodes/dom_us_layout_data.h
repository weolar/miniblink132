...
// DomCode::WAKE_UP                            0x010083 WakeUp
...
#endif
#if BUILDFLAG(IS_POSIX)
    { DomCode::MICROPHONE_MUTE_TOGGLE, VKEY_MICROPHONE_MUTE_TOGGLE }, // 0x0100A9 MicrophoneMuteToggle
    { DomCode::ACCESSIBILITY, VKEY_ACCESSIBILITY }, // 0x0100AA System Accessibility Binding
#endif
    ...
    { DomCode::BRIGHTNESS_DOWN, VKEY_BRIGHTNESS_DOWN }, // 0x0C0070 BrightnessDown
    { DomCode::KBD_ILLUM_UP, VKEY_KBD_BRIGHTNESS_UP }, // 0x0C0079 KbdIllumUp
    { DomCode::KBD_ILLUM_DOWN, VKEY_KBD_BRIGHTNESS_DOWN }, // 0x0C007a KbdIllumDown
    { DomCode::KEYBOARD_BACKLIGHT_TOGGLE, VKEY_KBD_BACKLIGHT_TOGGLE }, // 0x0C007C KeyboardBacklightToggle
#endif
    { DomCode::MEDIA_TRACK_NEXT, VKEY_MEDIA_NEXT_TRACK }, // 0x0C00B5 MediaTrackNext
    { DomCode::MEDIA_TRACK_PREVIOUS, VKEY_MEDIA_PREV_TRACK }, // 0x0C00B6 MediaTrackPrevious
    { DomCode::MEDIA_STOP, VKEY_MEDIA_STOP }, // 0x0C00B7 MediaStop
    // DomCode::EJECT                              0x0C00B8 Eject
    { DomCode::MEDIA_PLAY_PAUSE, VKEY_MEDIA_PLAY_PAUSE }, // 0x0C00CD MediaPlayPause
#if BUILDFLAG(IS_POSIX)
    { DomCode::DICTATE, VKEY_DICTATE }, // 0x0C00D8 Dictate
    { DomCode::EMOJI_PICKER, VKEY_EMOJI_PICKER }, // 0x0C00D9 Emoji
#endif
    { DomCode::MEDIA_SELECT, VKEY_MEDIA_LAUNCH_MEDIA_SELECT }, // 0x0C0183 MediaSelect
...
#if BUILDFLAG(IS_POSIX)
    { DomCode::LAUNCH_CONTROL_PANEL, VKEY_SETTINGS }, // 0x0C019F Launch Assistant
    ...
    { DomCode::BROWSER_FORWARD, VKEY_BROWSER_FORWARD }, // 0x0C0225 BrowserForward
    { DomCode::BROWSER_STOP, VKEY_BROWSER_STOP }, // 0x0C0226 BrowserStop
    { DomCode::BROWSER_REFRESH, VKEY_BROWSER_REFRESH }, // 0x0C0227 BrowserRefresh
    { DomCode::BROWSER_FAVORITES, VKEY_BROWSER_FAVORITES }, // 0x0C022A BrowserFavorites
    { DomCode::ZOOM_TOGGLE, VKEY_ZOOM }, // 0x0C0232 ZoomToggle
#if BUILDFLAG(IS_POSIX)
    { DomCode::ALL_APPLICATIONS, VKEY_ALL_APPLICATIONS }, // 0x0C02A2 All Applications
    { DomCode::PRIVACY_SCREEN_TOGGLE, VKEY_PRIVACY_SCREEN_TOGGLE }, // 0x0C02D0 PrivacyScreenToggle
#endif
};
...
const DomCodeToKeyboardCodeEntry kFallbackKeyboardCodeToDomCodeMap[] = {
    { DomCode::ALT_LEFT, VKEY_MENU }, { DomCode::ALT_RIGHT, VKEY_ALTGR },
#if BUILDFLAG(IS_POSIX)
    { DomCode::CONTEXT_MENU, VKEY_COMPOSE },
#endif
    { DomCode::CONTROL_LEFT, VKEY_CONTROL }, { DomCode::LANG1, VKEY_HANGUL }, { DomCode::LANG2, VKEY_HANJA }, { DomCode::LANG5, VKEY_DBE_DBCSCHAR },
    { DomCode::NUMPAD_CLEAR, VKEY_OEM_CLEAR }, { DomCode::NUMPAD_DECIMAL, VKEY_SEPARATOR }, { DomCode::PROPS, VKEY_CRSEL }, { DomCode::SHIFT_LEFT, VKEY_SHIFT },
