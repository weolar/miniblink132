...
DomKey DomKeyFromFuchsiaNonPrintableKey(const fuchsia_ui_input3::NonPrintableKey& key)
{
...
DomKey DomKeyFromFuchsiaKeyMeaning(const fuchsia_ui_input3::KeyMeaning& key_meaning)
{
    ...
    if (key_meaning.non_printable_key()) {
        return DomKeyFromFuchsiaNonPrintableKey(key_meaning.non_printable_key().value());
    }
