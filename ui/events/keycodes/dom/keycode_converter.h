...
public:
    ...
    // |DomCode::NONE|.
    static DomCode MapUSPositionalShortcutKeyToDomCode(KeyboardCode key_code, DomCode original_dom_code = ui::DomCode::NONE);
    ...
    static KeyboardCode MapPositionalDomCodeToUSShortcutKey(DomCode code, KeyboardCode original_key_code = VKEY_UNKNOWN);
#endif
