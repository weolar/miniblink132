...
protected:
    ...
    virtual ui::DomKey GetDomKeyFromDomCodeForLayout(ui::DomCode dom_code, uint32_t keyboard_layout_index) = 0;
...
private:
    ...
    void PopulateLayout(uint32_t keyboard_layout_index, ui::DomKeyboardLayout* keyboard_layout);
};
