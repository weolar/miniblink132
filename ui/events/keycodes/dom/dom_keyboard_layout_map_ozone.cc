...
public:
    ...
    DomKeyboardLayoutMapOzone& operator=(const DomKeyboardLayoutMapOzone&) = delete;
...
ui::DomKey DomKeyboardLayoutMapOzone::GetDomKeyFromDomCodeForLayout(ui::DomCode dom_code, uint32_t keyboard_layout_index)
{
    DCHECK_NE(dom_code, ui::DomCode::NONE);
    DCHECK_EQ(keyboard_layout_index, 0U);

    ui::KeyboardLayoutEngine* const keyboard_layout_engine = ui::KeyboardLayoutEngineManager::GetKeyboardLayoutEngine();
