...
DomKey GetKeyFromFullLookupTable(DomCode dom_code)
{
    ...
    static constexpr auto kFullLookupTable
        = base::MakeFixedFlatMap<DomCode, DomKey>({ { DomCode::DIGIT0, DomKey::FromCharacter('0') }, { DomCode::DIGIT1, DomKey::FromCharacter('1') },
            { DomCode::DIGIT2, DomKey::FromCharacter('2') }, { DomCode::DIGIT3, DomKey::FromCharacter('3') }, { DomCode::DIGIT4, DomKey::FromCharacter('4') },
            { DomCode::DIGIT5, DomKey::FromCharacter('5') }, { DomCode::DIGIT6, DomKey::FromCharacter('6') }, { DomCode::DIGIT7, DomKey::FromCharacter('7') },
            { DomCode::DIGIT8, DomKey::FromCharacter('8') }, { DomCode::DIGIT9, DomKey::FromCharacter('9') }, { DomCode::US_A, DomKey::FromCharacter('a') },
            { DomCode::US_B, DomKey::FromCharacter('b') }, { DomCode::US_C, DomKey::FromCharacter('c') }, { DomCode::US_D, DomKey::FromCharacter('d') },
            { DomCode::US_E, DomKey::FromCharacter('e') }, { DomCode::US_F, DomKey::FromCharacter('f') }, { DomCode::US_G, DomKey::FromCharacter('g') },
            { DomCode::US_H, DomKey::FromCharacter('h') }, { DomCode::US_I, DomKey::FromCharacter('i') }, { DomCode::US_J, DomKey::FromCharacter('j') },
            { DomCode::US_K, DomKey::FromCharacter('k') }, { DomCode::US_L, DomKey::FromCharacter('l') }, { DomCode::US_M, DomKey::FromCharacter('m') },
            { DomCode::US_N, DomKey::FromCharacter('n') }, { DomCode::US_O, DomKey::FromCharacter('o') }, { DomCode::US_P, DomKey::FromCharacter('p') },
            { DomCode::US_Q, DomKey::FromCharacter('q') }, { DomCode::US_R, DomKey::FromCharacter('r') }, { DomCode::US_S, DomKey::FromCharacter('s') },
            { DomCode::US_T, DomKey::FromCharacter('t') }, { DomCode::US_U, DomKey::FromCharacter('u') }, { DomCode::US_V, DomKey::FromCharacter('v') },
            { DomCode::US_W, DomKey::FromCharacter('w') }, { DomCode::US_X, DomKey::FromCharacter('x') }, { DomCode::US_Y, DomKey::FromCharacter('y') },
            { DomCode::US_Z, DomKey::FromCharacter('z') }, { DomCode::BACKQUOTE, DomKey::FromCharacter('`') }, { DomCode::MINUS, DomKey::FromCharacter('-') },
            { DomCode::EQUAL, DomKey::FromCharacter('=') }, { DomCode::INTL_YEN, DomKey::DeadKeyFromCombiningCharacter(0x00A5) },
            { DomCode::BRACKET_LEFT, DomKey::FromCharacter('{') }, { DomCode::BRACKET_RIGHT, DomKey::FromCharacter('}') },
            { DomCode::BACKSLASH, DomKey::FromCharacter('\\') }, { DomCode::SEMICOLON, DomKey::FromCharacter(';') },
            { DomCode::QUOTE, DomKey::FromCharacter('\'') }, { DomCode::INTL_BACKSLASH, DomKey::FromCharacter('/') },
            { DomCode::COMMA, DomKey::FromCharacter(',') }, { DomCode::PERIOD, DomKey::FromCharacter('.') }, { DomCode::SLASH, DomKey::FromCharacter('/') },
...
public:
    ...
    DomKey GetDomKeyFromDomCodeForLayout(DomCode dom_code, uint32_t keyboard_layout_id) override;
...
DomKey TestDomKeyboardLayoutMap::GetDomKeyFromDomCodeForLayout(DomCode dom_code, uint32_t keyboard_layout_id)
{
...
DomKey TestDomKeyboardLayoutMap::GetDomKeyForLayoutWithAllValidKeys(DomCode dom_code)
{
    return GetKeyFromFullLookupTable(dom_code);
}

DomKey TestDomKeyboardLayoutMap::GetDomKeyForLayoutWithAllValidAlphaKeys(DomCode dom_code)
{
...
DomKey TestDomKeyboardLayoutMap::GetDomKeyForLayoutWithSomeValidKeys(DomCode dom_code)
{
    if (dom_code == DomCode::US_A || dom_code == DomCode::US_Z || dom_code == DomCode::BACKQUOTE)
        return DomKey::NONE;
    return GetKeyFromFullLookupTable(dom_code);
}
...
{
    TestDomKeyboardLayoutMap test_keyboard_layout_map;
    test_keyboard_layout_map.AddKeyboardLayout(kKeyboardLayoutWithAllValidAlphaKeys);
...
TEST(DomKeyboardLayoutMapTest, MapGenerationWithTwoValidLayouts)
{
    ...
    test_keyboard_layout_map_1.AddKeyboardLayout(kKeyboardLayoutWithAllValidAlphaKeys);
    ...
    test_keyboard_layout_map_2.AddKeyboardLayout(kKeyboardLayoutWithAllValidAlphaKeys);
