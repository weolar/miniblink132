...
KEYCODES_X_EXPORT int XKeysymForWindowsKeyCode(KeyboardCode keycode, bool shift);
...
KEYCODES_X_EXPORT unsigned int XKeyCodeForWindowsKeyCode(KeyboardCode key_code, int flags, x11::Connection* connection);

// Converts an X keycode into ui::KeyboardCode.
KEYCODES_X_EXPORT KeyboardCode DefaultKeyboardCodeFromHardwareKeycode(unsigned int hardware_code);
