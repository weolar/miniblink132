...
TEST(MotionEventGenericTest, Basic)
{
    ...
    MotionEventGeneric event(MotionEvent::Action::DOWN, event_time, PointerProperties());
    ...
    MotionEventGeneric historical_event(MotionEvent::Action::MOVE, event_time - base::Milliseconds(5), historical_pointer0);
    ...
    EXPECT_EQ(event_time - base::Milliseconds(5), event.GetHistoricalEventTime(0));
...
{
    MotionEventGeneric event(MotionEvent::Action::DOWN, base::TimeTicks::Now(), PointerProperties(8.3f, 4.7f, 2.f));
    event.set_button_state(MotionEvent::BUTTON_PRIMARY);
...
TEST(MotionEventGenericTest, CloneWithHistory)
{
    ...
    std::unique_ptr<MotionEvent> historical_event(new MotionEventGeneric(MotionEvent::Action::MOVE, historical_event_time, historical_pointer));
...
{
    MotionEventGeneric event(MotionEvent::Action::UP, base::TimeTicks::Now(), PointerProperties(8.7f, 4.3f, 1.f));
...
TEST(MotionEventGenericTest, ToString)
{
    ...
    pointer0.x += 50;
    pointer1.x -= 50;
    std::unique_ptr<MotionEventGeneric> historical_event0(new MotionEventGeneric(MotionEvent::Action::MOVE, historical_event_time0, pointer0));
    historical_event0->PushPointer(pointer1);

    pointer0.x += 100;
    pointer1.x -= 100;
    std::unique_ptr<MotionEventGeneric> historical_event1(new MotionEventGeneric(MotionEvent::Action::MOVE, historical_event_time1, pointer0));
