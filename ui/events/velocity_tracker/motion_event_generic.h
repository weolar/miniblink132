...
struct COMPONENT_EXPORT(VELOCITY_TRACKER) PointerProperties {
    ...
    void SetAxesAndOrientation(float radius_x, float radius_y, float rotation_angle_degree);
...
class COMPONENT_EXPORT(VELOCITY_TRACKER) MotionEventGeneric : public MotionEvent {
public:
    MotionEventGeneric(Action action, base::TimeTicks event_time, const PointerProperties& pointer);
    ...
    PointerProperties& pointer(size_t index)
    {
    ...
    void set_event_time(base::TimeTicks event_time)
    {
    ...
    void set_action_index(int action_index)
    {
        action_index_ = action_index;
    }
    void set_button_state(int button_state)
    {
    ...
    static std::unique_ptr<MotionEventGeneric> CloneEvent(const MotionEvent& event);
    static std::unique_ptr<MotionEventGeneric> CancelEvent(const MotionEvent& event);
