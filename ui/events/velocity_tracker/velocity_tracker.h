...
public:
    ...
    inline int32_t GetActivePointerId() const
    {
        return active_pointer_id_;
    }
...
private:
    ...
    // id_bits.
    void AddMovement(const base::TimeTicks& event_time, BitSet32 id_bits, const Position* positions);
