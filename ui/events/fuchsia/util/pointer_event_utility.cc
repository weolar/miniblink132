...
fup::ViewParameters CreateViewParameters(gfx::RectF view, gfx::RectF viewport, std::array<float, 9> transform)
{
    return { {
        .view = fup::Rectangle { {
            .min = { view.x(), view.y() },
...
TouchEventBuilder& TouchEventBuilder::SetTransform(std::array<float, 9> transform)
{
    transform_ = transform;
    return *this;
}

TouchEventBuilder& TouchEventBuilder::SetTouchInteractionStatus(fup::TouchInteractionStatus touch_interaction_status)
{
...
MouseEventBuilder& MouseEventBuilder::SetTransform(std::array<float, 9> transform)
{
    transform_ = transform;
    return *this;
}
...
MouseEventBuilder& MouseEventBuilder::SetPressedButtons(std::vector<uint8_t> pressed_buttons)
{
...
MouseEventBuilder& MouseEventBuilder::SetScrollInPhysicalPixel(Scroll scroll_in_physical_pixel)
{
    scroll_in_physical_pixel_ = scroll_in_physical_pixel;
    return *this;
}

MouseEventBuilder& MouseEventBuilder::SetIsPrecisionScroll(bool is_precision_scroll)
{
...
fup::MousePointerSample MouseEventBuilder::MouseEventBuilder::BuildSample() const
{
