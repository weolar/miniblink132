...
const fuchsia_ui_pointer::TouchInteractionId kIxnOne = { { .device_id = 1u, .pointer_id = 1u, .interaction_id = 2u } };
...
public:
    ...
    TouchEventBuilder& SetTouchInteractionStatus(fuchsia_ui_pointer::TouchInteractionStatus touch_interaction_status);
...
private:
    ...
    std::optional<fuchsia_ui_pointer::TouchInteractionStatus> touch_interaction_status_;
