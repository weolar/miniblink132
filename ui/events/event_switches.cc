...
const char kCompensateForUnstablePinchZoom[] = "compensate-for-unstable-pinch-zoom";
...
constexpr char kEnableMicrophoneMuteSwitchDeviceSwitch[] = "enable-microphone-mute-switch-device";
