...
template <typename T> class EventTargetIteratorPtrImpl : public EventTargetIterator {
public:
    explicit EventTargetIteratorPtrImpl(const std::vector<raw_ptr<T, VectorExperimental>>& children)
...
private:
    typename std::vector<raw_ptr<T, VectorExperimental>>::const_reverse_iterator begin_;
    typename std::vector<raw_ptr<T, VectorExperimental>>::const_reverse_iterator end_;
};

template <typename T> class EventTargetIteratorUniquePtrImpl : public EventTargetIterator {
public:
