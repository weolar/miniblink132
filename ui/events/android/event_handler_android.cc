...
bool EventHandlerAndroid::OnGenericMotionEvent(const MotionEventAndroid& event)
{
    return false;
}
...
void EventHandlerAndroid::OnPhysicalBackingSizeChanged(std::optional<base::TimeDelta> deadline_override)
{
}
...
void EventHandlerAndroid::NotifyVirtualKeyboardOverlayRect(const gfx::Rect& keyboard_rect)
{
}
} // namespace ui
