...
public:
    ...
    MotionEventAndroidJava(JNIEnv* env, jobject event, jfloat pix_to_dip, jfloat ticks_x, jfloat ticks_y, jfloat tick_multiplier,
        ...
        jint android_gesture_classification, jint android_button_state, jint meta_state, jint source, jfloat raw_offset_x_pixels, jfloat raw_offset_y_pixels,
        jboolean for_touch_handle, const Pointer* const pointer0, const Pointer* const pointer1);
    ...
    MotionEventAndroidJava(JNIEnv* env, jobject event, jfloat pix_to_dip, jfloat ticks_x, jfloat ticks_y, jfloat tick_multiplier,
        ...
        jint android_action_button, jint android_gesture_classification, jint android_button_state, jint meta_state, jint source, jfloat raw_offset_x_pixels,
    ...
    float GetHistoricalX(size_t pointer_index, size_t historical_index) const override;
    float GetHistoricalY(size_t pointer_index, size_t historical_index) const override;
    ToolType GetToolType(size_t pointer_index) const override;
    // End ui::MotionEvent overrides

    // Start MotionEventAndroid overrides
    std::unique_ptr<MotionEventAndroid> CreateFor(const gfx::PointF& point) const override;
...
private:
    ...
    MotionEventAndroidJava(const MotionEventAndroidJava& e, const gfx::PointF& point);
};
