...
public:
    ...
    GestureEventDetails(EventType type, float delta_x, float delta_y, ui::ScrollGranularity units = ui::ScrollGranularity::kScrollByPrecisePixel);
    ...
    GestureDeviceType device_type() const
    {
        return device_type_;
    }
    ...
    void set_is_source_touch_event_set_blocking(bool is_source_touch_event_set_blocking)
    {
    ...
    void set_bounding_box(const gfx::RectF& box)
    {
        bounding_box_ = box;
    }
    ...
    int tap_count() const
    {
        DCHECK(type_ == EventType::kGestureTap || type_ == EventType::kGestureTapUnconfirmed || type_ == EventType::kGestureDoubleTap);
    ...
    {
        return type_ == other.type_ && !memcmp(&data_, &other.data_, sizeof(Details)) && device_type_ == other.device_type_
            && touch_points_ == other.touch_points_ && bounding_box_ == other.bounding_box_;
    }
