...
public:
    ...
    KeyboardDeviceIdEventRewriter& rewriter()
    {
        return *rewriter_;
    }
    KeyboardCapability& capability()
    {
        return *capability_;
    }
    ...
    void SetUp() override
    {
        ...
        rewriter_ = std::make_unique<KeyboardDeviceIdEventRewriter>(capability_.get());
    }
...
TEST_F(KeyboardDeviceIdEventRewriterTest, KeyEventRewriting)
{
    ...
    keyboard_info.device_type = KeyboardCapability::DeviceType::kDeviceVirtualCoreKeyboard;
...
TEST_F(KeyboardDeviceIdEventRewriterTest, MotionEventRewriting)
{
    ...
    {
        auto touch_event
            = std::make_unique<TouchEvent>(EventType::kTouchPressed, gfx::PointF(0.f, 0.f), gfx::PointF(0.f, 0.f), base::TimeTicks(), PointerDetails());
