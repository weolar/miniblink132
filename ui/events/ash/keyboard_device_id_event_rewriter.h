...
public:
    explicit KeyboardDeviceIdEventRewriter(KeyboardCapability* keyboard_capability);
    KeyboardDeviceIdEventRewriter(const KeyboardDeviceIdEventRewriter&) = delete;
    KeyboardDeviceIdEventRewriter operator=(const KeyboardDeviceIdEventRewriter&) = delete;
    ...
    static int GetKeyboardDeviceId(int keyboard_device_id, int last_keyboard_device_id, KeyboardCapability* keyboard_capability);
