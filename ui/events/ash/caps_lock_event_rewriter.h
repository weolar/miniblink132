...
public:
    ...
    CapsLockEventRewriter(KeyboardLayoutEngine* keyboard_layout_engine, KeyboardCapability* keyboard_capability, ash::input_method::ImeKeyboard* ime_keyboard);
...
private:
    std::unique_ptr<KeyEvent> BuildRewrittenEvent(const KeyEvent& event, const RemappedKey& remapped_key);
