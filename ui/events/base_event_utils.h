...
EVENTS_BASE_EXPORT void SetEventTickClockForTesting(const base::TickClock* tick_clock);
...
// WARNING: This should only be used when interfacing with platform code that
// does not use base::Time* types.
EVENTS_BASE_EXPORT base::TimeTicks EventTimeStampFromSeconds(double time_stamp_seconds);
...
EVENTS_BASE_EXPORT bool IsValidTimebase(base::TimeTicks now, base::TimeTicks timestamp);
