...
public:
    ...
    public:
        ...
        std::optional<LibInputEventConverter::LibInputDevice> AddDevice(int id, const base::FilePath& path) const;
        bool Dispatch() const;
        int Fd();
    ...
    private:
        ...
        static void LogHandler(libinput* libinput, enum libinput_log_priority priority, const char* format, va_list args);

        static constexpr libinput_interface interface_ = { OpenRestricted, CloseRestricted };
    ...
    LibInputEventConverter(LibInputEventConverter::LibInputContext&& ctx, const base::FilePath& path, int id, const EventDeviceInfo& devinfo,
        CursorDelegateEvdev* cursor, DeviceEventDispatcherEvdev* dispatcher);
    LibInputEventConverter(const LibInputEventConverter& other) = delete;
    LibInputEventConverter& operator=(const LibInputEventConverter& other) = delete;
