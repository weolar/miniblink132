...
private:
    ...
    bool IsSuspectedKeyboardImposter(EventConverterEvdev* converter, bool shared_phys);
    bool IsSuspectedMouseImposter(EventConverterEvdev* converter, bool shared_phys);
