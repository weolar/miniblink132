...
constexpr struct {
    ...
    { HapticTouchpadEffect::kSnap, 0x2003,
        { { HapticTouchpadEffectStrength::kLow, 20 }, { HapticTouchpadEffectStrength::kMedium, 50 }, { HapticTouchpadEffectStrength::kHigh, 80 } } },
    { HapticTouchpadEffect::kSnapReverse, 0x2004,
        { { HapticTouchpadEffectStrength::kLow, 20 }, { HapticTouchpadEffectStrength::kMedium, 50 }, { HapticTouchpadEffectStrength::kHigh, 80 } } },
    { HapticTouchpadEffect::kKnock, 0x2005,
        { { HapticTouchpadEffectStrength::kLow, 20 }, { HapticTouchpadEffectStrength::kMedium, 50 }, { HapticTouchpadEffectStrength::kHigh, 80 } } },
    { HapticTouchpadEffect::kTick, 0x2006,
        { { HapticTouchpadEffectStrength::kLow, 20 }, { HapticTouchpadEffectStrength::kMedium, 50 }, { HapticTouchpadEffectStrength::kHigh, 70 } } },
    { HapticTouchpadEffect::kToggleOn, 0x2007,
        { { HapticTouchpadEffectStrength::kLow, 15 }, { HapticTouchpadEffectStrength::kMedium, 30 }, { HapticTouchpadEffectStrength::kHigh, 50 } } },
    { HapticTouchpadEffect::kToggleOff, 0x2008,
        { { HapticTouchpadEffectStrength::kLow, 20 }, { HapticTouchpadEffectStrength::kMedium, 50 }, { HapticTouchpadEffectStrength::kHigh, 80 } } },
    { HapticTouchpadEffect::kPress, 0x1006,
        { { HapticTouchpadEffectStrength::kLow, 75 }, { HapticTouchpadEffectStrength::kMedium, 90 }, { HapticTouchpadEffectStrength::kHigh, 90 } } },
    { HapticTouchpadEffect::kRelease, 0x1007,
        { { HapticTouchpadEffectStrength::kLow, 55 }, { HapticTouchpadEffectStrength::kMedium, 65 }, { HapticTouchpadEffectStrength::kHigh, 65 } } },
    { HapticTouchpadEffect::kDeepPress, 0x2001,
        { { HapticTouchpadEffectStrength::kLow, 35 }, { HapticTouchpadEffectStrength::kMedium, 60 }, { HapticTouchpadEffectStrength::kHigh, 80 } } },
    { HapticTouchpadEffect::kDeepRelease, 0x2002,
        { { HapticTouchpadEffectStrength::kLow, 20 }, { HapticTouchpadEffectStrength::kMedium, 40 }, { HapticTouchpadEffectStrength::kHigh, 70 } } },
};

} // namespace

// static
std::unique_ptr<HapticTouchpadHandler> HapticTouchpadHandler::Create(int fd, const EventDeviceInfo& devinfo)
{
...
void HapticTouchpadHandler::SetEffectForNextButtonRelease(HapticTouchpadEffect effect, HapticTouchpadEffectStrength strength)
{
    if (!button_pressed_)
        return;
...
void HapticTouchpadHandler::SetClickStrength(HapticTouchpadEffectStrength strength)
{
...
void HapticTouchpadHandler::PlayEffect(HapticTouchpadEffect effect, HapticTouchpadEffectStrength strength)
{
...
void HapticTouchpadHandler::PlayFfEffect(int effect_id)
{
    ...
    ssize_t nbytes = HANDLE_EINTR(write(fd_, static_cast<const void*>(&event), sizeof(event)));
    if (nbytes != sizeof(event)) {
        PLOG(ERROR) << "Error playing the force feedback effect.";
    }
}

int HapticTouchpadHandler::UploadFfEffect(uint16_t hid_usage, uint8_t intensity)
{
