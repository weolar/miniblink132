...
struct COMPONENT_EXPORT(EVDEV) InputDeviceSettingsEvdev {
    ...
    const PointingStickSettingsEvdev& GetPointingStickSettings(int device_id) const;
...
private:
    ...
    mutable base::flat_map<int, PointingStickSettingsEvdev> pointing_stick_settings_;
};
