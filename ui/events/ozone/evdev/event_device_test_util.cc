...
#define EVDEV_BITS_TO_GROUPS(x) (((x) + kTestDataWordSize - 1) / kTestDataWordSize)
...
bool ParseBitfield(const std::string& bitfield, size_t max_bits, std::vector<unsigned long>* out)
{
    std::vector<std::string> groups = base::SplitString(bitfield, " ", base::TRIM_WHITESPACE, base::SPLIT_WANT_ALL);
...
const DeviceAbsoluteAxis kHJCGamepadAbsAxes[] = {
    ...
    { ABS_Z, { 0, 0, 255, 0, 15, 0 } },
    { ABS_RZ, { 0, 0, 255, 0, 15, 0 } },
...
const DeviceAbsoluteAxis kEveStylusAbsAxes[] = {
    { ABS_X, { 0, 0, 25920, 0, 0, 100 } },
    { ABS_Y, { 0, 0, 17280, 0, 0, 100 } },
...
const DeviceAbsoluteAxis kNocturneStylusAbsAxes[] = {
    { ABS_X, { 0, 0, 26010, 0, 0, 100 } },
    { ABS_Y, { 0, 0, 17340, 0, 0, 100 } },
    { ABS_PRESSURE, { 0, 0, 2047, 0, 0, 0 } },
    { ABS_TILT_X, { 0, -90, 90, 0, 0, 57 } },
    { ABS_TILT_Y, { 0, -90, 90, 0, 0, 57 } },
    { ABS_MISC, { 0, 0, 65535, 0, 0, 0 } },
...
bool CapabilitiesToDeviceInfo(const DeviceCapabilities& capabilities, EventDeviceInfo* devinfo)
{
