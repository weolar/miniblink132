...
public:
    TestGamepadEventConverterEvdev(base::ScopedFD fd, base::FilePath path, int id, const EventDeviceInfo& info, DeviceEventDispatcherEvdev* dispatcher)
        : GamepadEventConverterEvdev(std::move(fd), path, id, info, dispatcher)
    {
    }

    int UploadFfEffect(const base::ScopedFD& fd, struct ff_effect* effect) override
    {
        uploaded_ff_effects_.push_back(*effect);
        return kEffectId;
    }

    ssize_t WriteEvent(const base::ScopedFD& fd, const struct input_event& event) override
    {
...
public:
    ...
    GamepadEventConverterEvdevTest(const GamepadEventConverterEvdevTest&) = delete;
    GamepadEventConverterEvdevTest& operator=(const GamepadEventConverterEvdevTest&) = delete;
    ...
    void SetUp() override
    {
        ...
        event_factory_ = ui::CreateEventFactoryEvdevForTest(nullptr, device_manager_.get(), keyboard_layout_engine_.get(),
            base::BindRepeating(&GamepadEventConverterEvdevTest::DispatchEventForTest, base::Unretained(this)));
        dispatcher_ = ui::CreateDeviceEventDispatcherEvdevForTest(event_factory_.get());
    }

    std::unique_ptr<ui::TestGamepadEventConverterEvdev> CreateDevice(const ui::DeviceCapabilities& caps)
    {
        int evdev_io[2];
        if (pipe(evdev_io))
        ...
        return std::make_unique<ui::TestGamepadEventConverterEvdev>(std::move(events_in), base::FilePath(kTestDevicePath), 1, devinfo, dispatcher_.get());
    }
...
TEST_F(GamepadEventConverterEvdevTest, XboxGamepadEvents)
{
    ...
    std::unique_ptr<ui::TestGamepadEventConverterEvdev> dev = CreateDevice(kXboxGamepad);

    struct input_event mock_kernel_queue[]
        = { { { 1493076826, 766851 }, EV_ABS, 0, 19105 }, { { 1493076826, 766851 }, EV_SYN, SYN_REPORT }, { { 1493076826, 774849 }, EV_ABS, 0, 17931 },
              { { 1493076826, 774849 }, EV_SYN, SYN_REPORT }, { { 1493076826, 782849 }, EV_ABS, 0, 17398 }, { { 1493076826, 782849 }, EV_SYN, SYN_REPORT },
              { { 1493076829, 670856 }, EV_MSC, 4, 90007 }, { { 1493076829, 670856 }, EV_KEY, 310, 1 }, { { 1493076829, 670856 }, EV_SYN, SYN_REPORT },
              { { 1493076829, 870828 }, EV_MSC, 4, 90007 }, { { 1493076829, 870828 }, EV_KEY, 310, 0 }, { { 1493076829, 870828 }, EV_SYN, SYN_REPORT },
              { { 1493076830, 974859 }, EV_MSC, 4, 90005 }, { { 1493076830, 974859 }, EV_KEY, 308, 1 }, { { 1493076830, 974859 }, EV_SYN, SYN_REPORT },
              { { 1493076831, 158857 }, EV_MSC, 4, 90005 }, { { 1493076831, 158857 }, EV_KEY, 308, 0 }, { { 1493076831, 158857 }, EV_SYN, SYN_REPORT },
              { { 1493076832, 62859 }, EV_MSC, 4, 90002 }, { { 1493076832, 62859 }, EV_KEY, 305, 1 }, { { 1493076832, 62859 }, EV_SYN, SYN_REPORT },
              { { 1493076832, 206859 }, EV_MSC, 4, 90002 }, { { 1493076832, 206859 }, EV_KEY, 305, 0 }, { { 1493076832, 206859 }, EV_SYN, SYN_REPORT },
              { { 1493076832, 406860 }, EV_MSC, 4, 90003 }, { { 1493076832, 406860 }, EV_KEY, 306, 1 }, { { 1493076832, 406860 }, EV_SYN, SYN_REPORT },
              { { 1493076832, 526871 }, EV_MSC, 4, 90003 }, { { 1493076832, 526871 }, EV_KEY, 306, 0 }, { { 1493076832, 526871 }, EV_SYN, SYN_REPORT },
              { { 1493076832, 750860 }, EV_MSC, 4, 90004 }, { { 1493076832, 750860 }, EV_KEY, 307, 1 }, { { 1493076832, 750860 }, EV_SYN, SYN_REPORT } };
    ...
    struct ExpectedEvent expected_events[] = {
        { GamepadEventType::AXIS, 0, 19105 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::AXIS, 0, 17931 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::AXIS, 0, 17398 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 310, 1 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 310, 0 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 308, 1 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 308, 0 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 305, 1 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 305, 0 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 306, 1 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 306, 0 },
        { GamepadEventType::FRAME, 0, 0 },
        { GamepadEventType::BUTTON, 307, 1 },
        { GamepadEventType::FRAME, 0, 0 },
    };
...
TEST_F(GamepadEventConverterEvdevTest, XboxGamepadVibrationEvents)
{
    ...
    struct ExpectedVibrationEvent expected_events[] = { { static_cast<uint16_t>(dev->kEffectId), 1 }, { static_cast<uint16_t>(dev->kEffectId), 0 } };
    ...
    EXPECT_EQ(expected_effect.strong_magnitude, received_effect.u.rumble.strong_magnitude);
    EXPECT_EQ(expected_effect.weak_magnitude, received_effect.u.rumble.weak_magnitude);
