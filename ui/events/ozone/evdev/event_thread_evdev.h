...
typedef base::OnceCallback<void(std::unique_ptr<InputDeviceFactoryEvdevProxy>)> EventThreadStartCallback;
...
public:
    ...
    void Start(std::unique_ptr<DeviceEventDispatcherEvdev> dispatcher, CursorDelegateEvdev* cursor, EventThreadStartCallback callback,
