...
public:
    ...
    int32_t GetAbsMtSlotValueWithDefault(unsigned int code, unsigned int slot, int32_t default_value) const;
    ...
    const std::string& phys() const
    {
        return phys_;
    }
    uint16_t bustype() const
    {
        return input_id_.bustype;
    }
    uint16_t vendor_id() const
    {
        return input_id_.vendor;
    }
    uint16_t product_id() const
    {
        return input_id_.product;
    }
    uint16_t version() const
    {
        return input_id_.version;
    }
    ...
    InputDeviceType device_type() const
    {
        return device_type_;
    }
