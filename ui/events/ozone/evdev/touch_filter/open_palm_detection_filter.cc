...
OpenPalmDetectionFilter::OpenPalmDetectionFilter(SharedPalmDetectionFilterState* shared_palm_state)
...
void OpenPalmDetectionFilter::Filter(const std::vector<InProgressTouchEvdev>& touches, base::TimeTicks time, std::bitset<kNumTouchEvdevSlots>* slots_to_hold,
