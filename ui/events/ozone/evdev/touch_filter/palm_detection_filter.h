...
public:
    ...
    explicit PalmDetectionFilter(SharedPalmDetectionFilterState* shared_palm_state);
    ...
    virtual void Filter(const std::vector<InProgressTouchEvdev>& touches, base::TimeTicks time, std::bitset<kNumTouchEvdevSlots>* slots_to_hold,
