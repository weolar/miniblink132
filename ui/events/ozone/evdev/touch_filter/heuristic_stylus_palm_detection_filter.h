...
class COMPONENT_EXPORT(EVDEV) HeuristicStylusPalmDetectionFilter : public PalmDetectionFilter {
public:
    HeuristicStylusPalmDetectionFilter(SharedPalmDetectionFilterState* shared_palm_state, int hold_stroke_count, base::TimeDelta hold, base::TimeDelta cancel);

    HeuristicStylusPalmDetectionFilter(const HeuristicStylusPalmDetectionFilter&) = delete;
    HeuristicStylusPalmDetectionFilter& operator=(const HeuristicStylusPalmDetectionFilter&) = delete;
    ...
    static bool CompatibleWithHeuristicStylusPalmDetectionFilter(const EventDeviceInfo& device_info);
