...
class COMPONENT_EXPORT(EVDEV) OneDeviceTrainNeuralStylusPalmDetectionFilterModel : public NeuralStylusPalmDetectionFilterModel {
public:
    explicit OneDeviceTrainNeuralStylusPalmDetectionFilterModel(const std::string& model_version, const std::vector<float>& radius_poly);

    OneDeviceTrainNeuralStylusPalmDetectionFilterModel(const OneDeviceTrainNeuralStylusPalmDetectionFilterModel&) = delete;
    OneDeviceTrainNeuralStylusPalmDetectionFilterModel& operator=(const OneDeviceTrainNeuralStylusPalmDetectionFilterModel&) = delete;
