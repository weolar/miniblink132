...
public:
   ...
   */
    ...
    virtual void Start(ModelId model_id, std::string_view hidraw_path, std::optional<CropHeatmap> crop_heatmap) = 0;
    ...
    virtual void AddTouchRecord(base::Time timestamp, const std::vector<int>& tracking_ids) = 0;
