...
class COMPONENT_EXPORT(EVDEV) NumberpadMetricsDelegate final : public ash::feature_usage::FeatureUsageMetrics::Delegate {
public:
    ...
    void SetState(bool now_eligible)
    {
        SetState(now_eligible, now_eligible);
    }
...
public:
    ...
    static constexpr char kFeatureDynamicActivations[] = "NumberpadDynamicActivations";
    static constexpr char kFeatureDynamicCancellations[] = "NumberpadDynamicCancellations";
    static constexpr char kFeatureDynamicEnterKeystrokes[] = "NumberpadDynamicEnterKeystrokes";
    static constexpr char kFeatureDynamicNonEnterKeystrokes[] = "NumberpadDynamicNonEnterKeystrokes";
    static constexpr char kFeatureInternalEnterKeystrokes[] = "NumberpadInternalEnterKeystrokes";
    static constexpr char kFeatureInternalNonEnterKeystrokes[] = "NumberpadInternalNonEnterKeystrokes";
    static constexpr char kFeatureExternalEnterKeystrokes[] = "NumberpadExternalEnterKeystrokes";
    static constexpr char kFeatureExternalNonEnterKeystrokes[] = "NumberpadExternalNonEnterKeystrokes";
...
private:
    ...
    NumberpadMetricsDelegate dynamic_activations_metrics_delegate_ { kFeatureDynamicActivations };
    NumberpadMetricsDelegate dynamic_cancellations_metrics_delegate_ { kFeatureDynamicCancellations };
    NumberpadMetricsDelegate dynamic_enter_keystrokes_metrics_delegate_ { kFeatureDynamicEnterKeystrokes };
    NumberpadMetricsDelegate dynamic_non_enter_keystrokes_metrics_delegate_ { kFeatureDynamicNonEnterKeystrokes };

    NumberpadMetricsDelegate internal_enter_keystrokes_metrics_delegate_ { kFeatureInternalEnterKeystrokes };
    NumberpadMetricsDelegate internal_non_enter_keystrokes_metrics_delegate_ { kFeatureInternalNonEnterKeystrokes };

    NumberpadMetricsDelegate external_enter_keystrokes_metrics_delegate_ { kFeatureExternalEnterKeystrokes };
    NumberpadMetricsDelegate external_non_enter_keystrokes_metrics_delegate_ { kFeatureExternalNonEnterKeystrokes };
};
