...
HeatmapPalmDetector::TouchRecord::TouchRecord(base::Time timestamp, const std::vector<int>& tracking_ids)
{
    this->timestamp = timestamp;
    this->tracking_ids = tracking_ids;
}

HeatmapPalmDetector::TouchRecord::TouchRecord(const HeatmapPalmDetector::TouchRecord& t) = default;

HeatmapPalmDetector::TouchRecord::~TouchRecord() = default;

void HeatmapPalmDetector::SetInstance(std::unique_ptr<HeatmapPalmDetector> detector)
{
