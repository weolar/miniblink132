...
class COMPONENT_EXPORT(EVDEV) MicrophoneMuteSwitchEventConverterEvdev : public EventConverterEvdev {
public:
    ...
    MicrophoneMuteSwitchEventConverterEvdev(const MicrophoneMuteSwitchEventConverterEvdev&) = delete;
    MicrophoneMuteSwitchEventConverterEvdev& operator=(const MicrophoneMuteSwitchEventConverterEvdev&) = delete;
