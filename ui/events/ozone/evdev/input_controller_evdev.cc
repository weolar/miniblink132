...
TouchpadSettingsEvdev& GetTouchpadSettings(InputDeviceSettingsEvdev& settings, std::optional<int> device_id)
{
...
MouseSettingsEvdev& GetMouseSettings(InputDeviceSettingsEvdev& settings, std::optional<int> device_id)
{
    if (!device_id.has_value()) {
...
PointingStickSettingsEvdev& GetPointingStickSettings(InputDeviceSettingsEvdev& settings, std::optional<int> device_id)
{
    if (!device_id.has_value()) {
...
class InputControllerEvdev::ScopedDisableInputDevicesImpl : public ScopedDisableInputDevices {
public:
    explicit ScopedDisableInputDevicesImpl(base::WeakPtr<InputControllerEvdev> parent)
        : parent_(parent)
    {
...
InputControllerEvdev::InputControllerEvdev(KeyboardEvdev* keyboard, MouseButtonMapEvdev* mouse_button_map, MouseButtonMapEvdev* pointing_stick_button_map)
    : keyboard_(keyboard)
...
void InputControllerEvdev::SetInputDeviceFactory(InputDeviceFactoryEvdevProxy* input_device_factory)
{
...
std::unique_ptr<ScopedDisableInputDevices> InputControllerEvdev::DisableInputDevices()
{
    return std::make_unique<ScopedDisableInputDevicesImpl>(weak_ptr_factory_.GetWeakPtr());
}
...
void InputControllerEvdev::SetAutoRepeatRate(const base::TimeDelta& delay, const base::TimeDelta& interval)
{
    keyboard_->SetAutoRepeatRate(delay, interval);
}

void InputControllerEvdev::GetAutoRepeatRate(base::TimeDelta* delay, base::TimeDelta* interval)
{
    keyboard_->GetAutoRepeatRate(delay, interval);
}

void InputControllerEvdev::SetKeyboardKeyBitsMapping(base::flat_map<int, std::vector<uint64_t>> key_bits_mapping)
{
...
std::vector<uint64_t> InputControllerEvdev::GetKeyboardKeyBits(int id)
{
    ...
    return key_bits_mapping_iter == keyboard_key_bits_mapping_.end() ? std::vector<uint64_t>() : key_bits_mapping_iter->second;
}

void InputControllerEvdev::SetCurrentLayoutByName(const std::string& layout_name, base::OnceCallback<void(bool)> callback)
{
...
void InputControllerEvdev::SetInternalKeyboardFilter(bool enable_filter, std::vector<DomCode> allowed_keys)
{
...
void InputControllerEvdev::SetTouchpadSensitivity(std::optional<int> device_id, int value)
{
    GetTouchpadSettings(input_device_settings_, device_id).sensitivity = value;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetTouchpadAcceleration(std::optional<int> device_id, bool enabled)
{
    GetTouchpadSettings(input_device_settings_, device_id).acceleration_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetTouchpadScrollAcceleration(std::optional<int> device_id, bool enabled)
{
    GetTouchpadSettings(input_device_settings_, device_id).scroll_acceleration_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetTouchpadScrollSensitivity(std::optional<int> device_id, int value)
{
    GetTouchpadSettings(input_device_settings_, device_id).scroll_sensitivity = value;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetTouchpadHapticFeedback(std::optional<int> device_id, bool enabled)
{
    GetTouchpadSettings(input_device_settings_, device_id).haptic_feedback_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetTouchpadHapticClickSensitivity(std::optional<int> device_id, int value)
{
    GetTouchpadSettings(input_device_settings_, device_id).haptic_click_sensitivity = value;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetTapToClick(std::optional<int> device_id, bool enabled)
{
    GetTouchpadSettings(input_device_settings_, device_id).tap_to_click_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetTapDragging(std::optional<int> device_id, bool enabled)
{
    GetTouchpadSettings(input_device_settings_, device_id).tap_dragging_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetNaturalScroll(std::optional<int> device_id, bool enabled)
{
    GetTouchpadSettings(input_device_settings_, device_id).natural_scroll_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetMouseSensitivity(std::optional<int> device_id, int value)
{
    GetMouseSettings(input_device_settings_, device_id).sensitivity = value;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetMouseScrollSensitivity(std::optional<int> device_id, int value)
{
    GetMouseSettings(input_device_settings_, device_id).scroll_sensitivity = value;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetMouseScrollAcceleration(std::optional<int> device_id, bool enabled)
{
    GetMouseSettings(input_device_settings_, device_id).scroll_acceleration_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetPointingStickSensitivity(std::optional<int> device_id, int value)
{
    GetPointingStickSettings(input_device_settings_, device_id).sensitivity = value;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetMouseReverseScroll(std::optional<int> device_id, bool enabled)
{
    GetMouseSettings(input_device_settings_, device_id).reverse_scroll_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetPointingStickAcceleration(std::optional<int> device_id, bool enabled)
{
    GetPointingStickSettings(input_device_settings_, device_id).acceleration_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetMouseAcceleration(std::optional<int> device_id, bool enabled)
{
    GetMouseSettings(input_device_settings_, device_id).acceleration_enabled = enabled;
    ScheduleUpdateDeviceSettings();
}

void InputControllerEvdev::SetPrimaryButtonRight(std::optional<int> device_id, bool right)
{
    mouse_button_map_->SetPrimaryButtonRight(device_id, right);
}

void InputControllerEvdev::SetPointingStickPrimaryButtonRight(std::optional<int> device_id, bool right)
{
    pointing_stick_button_map_->SetPrimaryButtonRight(device_id, right);
}

void InputControllerEvdev::SetGamepadKeyBitsMapping(base::flat_map<int, std::vector<uint64_t>> key_bits_mapping)
{
...
std::vector<uint64_t> InputControllerEvdev::GetGamepadKeyBits(int id)
{
    ...
    return gamepad_key_bits_iter == gamepad_key_bits_mapping_.end() ? std::vector<uint64_t>() : gamepad_key_bits_iter->second;
}
...
void InputControllerEvdev::GetStylusSwitchState(GetStylusSwitchStateReply reply)
{
...
void InputControllerEvdev::GetTouchDeviceStatus(GetTouchDeviceStatusReply reply)
{
    if (input_device_factory_)
...
void InputControllerEvdev::GetTouchEventLog(const base::FilePath& out_dir, GetTouchEventLogReply reply)
{
    if (input_device_factory_)
...
void InputControllerEvdev::DescribeForLog(InputController::DescribeForLogReply reply) const
{
    if (input_device_factory_) {
...
void InputControllerEvdev::GetGesturePropertiesService(mojo::PendingReceiver<ozone::mojom::GesturePropertiesService> receiver)
{
    if (input_device_factory_)
...
void InputControllerEvdev::ScheduleUpdateDeviceSettings()
{
    ...
    base::SingleThreadTaskRunner::GetCurrentDefault()->PostTask(
        FROM_HERE, base::BindOnce(&InputControllerEvdev::UpdateDeviceSettings, weak_ptr_factory_.GetWeakPtr()));
...
void InputControllerEvdev::PlayVibrationEffect(int id, uint8_t amplitude, uint16_t duration_millis)
{
    if (!input_device_factory_)
        return;
...
void InputControllerEvdev::PlayHapticTouchpadEffect(ui::HapticTouchpadEffect effect, ui::HapticTouchpadEffectStrength strength)
{
    if (!input_device_factory_)
        return;
...
void InputControllerEvdev::SetHapticTouchpadEffectForNextButtonRelease(ui::HapticTouchpadEffect effect, ui::HapticTouchpadEffectStrength strength)
{
    if (!input_device_factory_)
        return;
    input_device_factory_->SetHapticTouchpadEffectForNextButtonRelease(effect, strength);
}
...
void InputControllerEvdev::BlockModifiersOnDevices(std::vector<int> device_ids)
{
