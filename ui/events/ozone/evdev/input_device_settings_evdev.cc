...
{
    touch_event_logging_enabled = base::FeatureList::IsEnabled(ui::kEnableInputEventLogging);
}
InputDeviceSettingsEvdev::InputDeviceSettingsEvdev(const InputDeviceSettingsEvdev& input_device_settings) = default;
...
const TouchpadSettingsEvdev& InputDeviceSettingsEvdev::GetTouchpadSettings() const
{
    return touchpad_settings_[kSharedSettingsDeviceId];
}
...
const PointingStickSettingsEvdev& InputDeviceSettingsEvdev::GetPointingStickSettings() const
{
    return pointing_stick_settings_[kSharedSettingsDeviceId];
}

TouchpadSettingsEvdev& InputDeviceSettingsEvdev::GetTouchpadSettings(int device_id)
{
...
PointingStickSettingsEvdev& InputDeviceSettingsEvdev::GetPointingStickSettings(int device_id)
{
    if (!enable_per_device_settings) {
...
const TouchpadSettingsEvdev& InputDeviceSettingsEvdev::GetTouchpadSettings(int device_id) const
{
    if (!enable_per_device_settings) {
        return GetTouchpadSettings();
    }
...
const MouseSettingsEvdev& InputDeviceSettingsEvdev::GetMouseSettings(int device_id) const
{
    if (!enable_per_device_settings) {
        return GetMouseSettings();
    }
...
const PointingStickSettingsEvdev& InputDeviceSettingsEvdev::GetPointingStickSettings(int device_id) const
{
    if (!enable_per_device_settings) {
        return GetPointingStickSettings();
    }
...
TouchpadSettingsEvdev::TouchpadSettingsEvdev(const TouchpadSettingsEvdev& touchpad_settings) = default;
TouchpadSettingsEvdev::~TouchpadSettingsEvdev() = default;
