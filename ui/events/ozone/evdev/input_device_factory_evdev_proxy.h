...
public:
    InputDeviceFactoryEvdevProxy(scoped_refptr<base::SingleThreadTaskRunner> task_runner, base::WeakPtr<InputDeviceFactoryEvdev> input_device_factory);

    InputDeviceFactoryEvdevProxy(const InputDeviceFactoryEvdevProxy&) = delete;
    InputDeviceFactoryEvdevProxy& operator=(const InputDeviceFactoryEvdevProxy&) = delete;
