...
GamepadProviderOzone* GamepadProviderOzone::GetInstance()
{
    ...
    return base::Singleton<GamepadProviderOzone, base::LeakySingletonTraits<GamepadProviderOzone>>::get();
}

void GamepadProviderOzone::DispatchGamepadDevicesUpdated(std::vector<GamepadDevice> gamepad_devices)
{
