...
EventResult DispatchEventFromNativeUiEvent(const PlatformEvent& event, base::OnceCallback<void(ui::Event*)> callback)
{
...
void SetKeyboardImeFlagProperty(KeyEvent::Properties* properties, uint8_t flags)
{
