...
public:
    ...
    public:
        ...
        virtual void DispatchKey(unsigned int key, unsigned int scan_code, bool down, bool repeat, base::TimeTicks timestamp, int device_id, int flags) = 0;
    };
    ...
    void UpdateKeyRepeat(unsigned int key, unsigned int scan_code, bool down, bool suppress_auto_repeat, int device_id, base::TimeTicks base_timestamp);
    void StopKeyRepeat();
...
private:
    ...
    void StartKeyRepeat(unsigned int key, unsigned int scan_code, int device_id, base::TimeTicks base_timestamp);
