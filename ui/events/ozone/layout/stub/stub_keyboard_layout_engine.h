...
class COMPONENT_EXPORT(EVENTS_OZONE_LAYOUT) StubKeyboardLayoutEngine : public KeyboardLayoutEngine {
public:
    ...
    void SetCustomLookupTableForTesting(const std::vector<CustomLookupEntry>& table);
