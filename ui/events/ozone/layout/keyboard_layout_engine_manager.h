...
public:
    ...
    KeyboardLayoutEngineManager& operator=(const KeyboardLayoutEngineManager&) = delete;

    virtual ~KeyboardLayoutEngineManager();

    static void SetKeyboardLayoutEngine(KeyboardLayoutEngine* keyboard_layout_engine);
