...
XkbModifierConverter::XkbModifierConverter(XkbModifierConverter&& other) = default;

XkbModifierConverter& XkbModifierConverter::operator=(XkbModifierConverter&& other) = default;

XkbModifierConverter::~XkbModifierConverter() = default;

// static
XkbModifierConverter XkbModifierConverter::CreateFromKeymap(xkb_keymap* keymap)
{
...
xkb_mod_mask_t XkbModifierConverter::MaskFromNames(const std::vector<std::string_view>& names) const
{
