...
typedef base::OnceCallback<void(const std::string&, std::unique_ptr<char, base::FreeDeleter>)> LoadKeymapCallback;

KeyboardCode AlphanumericKeyboardCode(xkb_keysym_t xkb_keysym, char16_t character)
{
    // Plain ASCII letters and digits map directly to VKEY values.
    if ((character >= '0') && (character <= '9')) {
        int zero = ((xkb_keysym >= XKB_KEY_KP_0) && (xkb_keysym <= XKB_KEY_KP_9)) ? VKEY_NUMPAD0 : VKEY_0;
...
const PrintableSubEntry kU0021[] = { { DomCode::DIGIT1, false, false, kAny, kAny, VKEY_1 }, { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 },
    { DomCode::SLASH, false, false, kAny, kAny, VKEY_OEM_8 } };

// U+0022 quote
const PrintableSubEntry kU0022[] = { { DomCode::DIGIT2, false, false, kAny, kAny, VKEY_2 }, { DomCode::DIGIT3, false, false, kAny, kAny, VKEY_3 } };

// U+0023 number sign
const PrintableSubEntry kU0023[]
    = { { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_OEM_7 }, { DomCode::BACKSLASH, true, false, 0x0027, kAny, VKEY_OEM_2 }, // apostrophe
          { DomCode::BACKSLASH, true, false, 0x007E, kAny, VKEY_OEM_7 } }; // ~, NoSymbol

// U+0024 dollar sign
const PrintableSubEntry kU0024[]
    = { { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_1 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_8 } };

// U+0027 apostrophe
const PrintableSubEntry kU0027[] = { { DomCode::DIGIT4, false, false, kAny, kAny, VKEY_4 }, { DomCode::US_Q, false, false, kAny, kAny, VKEY_OEM_7 },
    { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_1 }, { DomCode::SLASH, false, false, kAny, kAny, VKEY_OEM_7 },
    ...
    { DomCode::BACKSLASH, true, true, 0x002A, 0x00BD, VKEY_OEM_5 }, // *, one half
...
const PrintableSubEntry kU0028[] = { { DomCode::DIGIT5, false, false, kAny, kAny, VKEY_5 }, { DomCode::DIGIT9, false, false, kAny, kAny, VKEY_9 },
    { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 } };

// U+0029 right parenthesis
const PrintableSubEntry kU0029[] = { { DomCode::DIGIT0, false, false, kAny, kAny, VKEY_0 }, { DomCode::MINUS, false, false, kAny, kAny, VKEY_OEM_4 },
    { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 } };

// U+002A *
const PrintableSubEntry kU002A[]
    = { { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_1 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 } };

// U+002B plus sign
const PrintableSubEntry kU002B[] = { { DomCode::DIGIT1, false, false, kAny, kAny, VKEY_1 }, { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_PLUS },
    { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_PLUS }, { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_PLUS },
    { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_PLUS }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_2 },
    { DomCode::MINUS, true, false, 0x003F, kAny, VKEY_OEM_PLUS } }; // ?

// U+002C comma
const PrintableSubEntry kU002C[] = { { DomCode::DIGIT3, false, false, kAny, kAny, VKEY_3 }, { DomCode::DIGIT5, false, false, kAny, kAny, VKEY_5 },
    { DomCode::DIGIT6, false, false, kAny, kAny, VKEY_6 }, { DomCode::DIGIT9, false, false, kAny, kAny, VKEY_9 },
    { DomCode::US_W, false, false, kAny, kAny, VKEY_OEM_COMMA }, { DomCode::US_V, false, false, kAny, kAny, VKEY_OEM_COMMA },
    { DomCode::US_M, false, false, kAny, kAny, VKEY_OEM_COMMA }, { DomCode::COMMA, false, false, kAny, kAny, VKEY_OEM_COMMA } };

// U+002D hyphen-minus
const PrintableSubEntry kU002D[] = { { DomCode::DIGIT2, false, false, kAny, kAny, VKEY_2 }, { DomCode::DIGIT6, false, false, kAny, kAny, VKEY_6 },
    { DomCode::MINUS, false, false, kAny, kAny, VKEY_OEM_MINUS }, { DomCode::US_A, false, false, kAny, kAny, VKEY_OEM_MINUS },
    { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_MINUS }, { DomCode::SLASH, true, false, 0x003D, kAny, VKEY_OEM_MINUS }, // =
...
// U+002E full stop
const PrintableSubEntry kU002E[] = { { DomCode::DIGIT7, false, false, kAny, kAny, VKEY_7 }, { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 },
    { DomCode::US_E, false, false, kAny, kAny, VKEY_OEM_PERIOD }, { DomCode::US_R, false, false, kAny, kAny, VKEY_OEM_PERIOD },
    { DomCode::US_O, false, false, kAny, kAny, VKEY_OEM_PERIOD }, { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 },
    { DomCode::PERIOD, false, false, kAny, kAny, VKEY_OEM_PERIOD }, { DomCode::SLASH, false, false, kAny, kAny, VKEY_OEM_2 } };

// U+002F /
const PrintableSubEntry kU002F[] = { { DomCode::MINUS, false, false, kAny, kAny, VKEY_OEM_4 }, { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_2 },
    { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_OEM_7 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 },
    { DomCode::SLASH, false, false, kAny, kAny, VKEY_OEM_2 }, { DomCode::CONTROL_RIGHT, false, false, kAny, kAny, VKEY_RCONTROL },
...
// U+003A colon
const PrintableSubEntry kU003A[] = { { DomCode::DIGIT1, false, false, kAny, kAny, VKEY_1 }, { DomCode::DIGIT5, false, false, kAny, kAny, VKEY_5 },
    { DomCode::DIGIT6, false, false, kAny, kAny, VKEY_6 }, { DomCode::PERIOD, false, false, kAny, kAny, VKEY_OEM_2 } };

// U+003B semicolon
const PrintableSubEntry kU003B[] = { { DomCode::DIGIT4, false, false, kAny, kAny, VKEY_4 }, { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 },
    { DomCode::US_Q, false, false, kAny, kAny, VKEY_OEM_1 }, { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_1 },
    { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 }, { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_1 },
    { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_OEM_3 }, { DomCode::US_Z, false, false, kAny, kAny, VKEY_OEM_1 },
    { DomCode::COMMA, false, false, kAny, kAny, VKEY_OEM_PERIOD }, { DomCode::SLASH, false, false, kAny, kAny, VKEY_OEM_2 } };
// U+003D =
const PrintableSubEntry kU003D[] = { { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 }, { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_PLUS },
    { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_PLUS }, { DomCode::SLASH, true, false, 0x0025, kAny, VKEY_OEM_8 }, // %
...
// U+003F ?
const PrintableSubEntry kU003F[] = { { DomCode::DIGIT2, false, false, kAny, kAny, VKEY_2 }, { DomCode::DIGIT7, false, false, kAny, kAny, VKEY_7 },
    { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 }, { DomCode::MINUS, false, false, kAny, kAny, VKEY_OEM_PLUS } };

// U+0040 @
const PrintableSubEntry kU0040[]
    = { { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 }, { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+005B left square bracket
const PrintableSubEntry kU005B[] = { { DomCode::DIGIT1, false, false, kAny, kAny, VKEY_OEM_4 }, { DomCode::MINUS, false, false, kAny, kAny, VKEY_OEM_4 },
    { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_4 }, { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 },
    { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+005C backslash
const PrintableSubEntry kU005C[]
    = { { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_4 }, { DomCode::BACKSLASH, true, false, 0x002F, kAny, VKEY_OEM_7 }, // /
          { DomCode::BACKSLASH, true, false, 0x007C, kAny, VKEY_OEM_5 }, // |
          { DomCode::BACKQUOTE, true, true, 0x007C, 0x0031, VKEY_OEM_5 }, // |, 1
          { DomCode::BACKQUOTE, true, true, 0x007C, 0x0145, VKEY_OEM_3 } }; // |, N cedilla

// U+005D right square bracket
const PrintableSubEntry kU005D[] = { { DomCode::DIGIT2, false, false, kAny, kAny, VKEY_OEM_6 }, { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_6 },
    { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 }, { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_OEM_3 },
    { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 } };

// U+005F _
const PrintableSubEntry kU005F[] = { { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 }, { DomCode::MINUS, false, false, kAny, kAny, VKEY_OEM_MINUS } };

// U+0060 grave accent
const PrintableSubEntry kU0060[] = { { DomCode::BACKQUOTE, true, false, kNone, kAny, VKEY_OEM_3 }, // NoSymbol
    { DomCode::BACKQUOTE, true, false, 0x00AC, kAny, VKEY_OEM_8 }, // not
    { DomCode::BACKQUOTE, true, false, 0x007E, kAny, VKEY_OEM_3 } }; // ~

// U+00A7 section
const PrintableSubEntry kU00A7[] = { { DomCode::DIGIT4, false, false, kAny, kAny, VKEY_4 }, { DomCode::DIGIT6, false, false, kAny, kAny, VKEY_6 },
    { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 }, { DomCode::BACKQUOTE, true, false, 0x00B0, kAny, VKEY_OEM_2 }, // degree
    { DomCode::BACKQUOTE, true, false, 0x00BD, kAny, VKEY_OEM_5 } }; // one half

// U+00AB left-pointing double angle quote
const PrintableSubEntry kU00AB[] = { { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 }, { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_6 } };

// U+00B0 degree
const PrintableSubEntry kU00B0[] = { { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_2 }, { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+00BA masculine ordinal indicator
const PrintableSubEntry kU00BA[] = { { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 }, { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_OEM_5 } };

// U+00E0 a grave
const PrintableSubEntry kU00E0[] = { { DomCode::DIGIT0, false, false, kAny, kAny, VKEY_0 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 },
    { DomCode::QUOTE, true, false, 0x00B0, kAny, VKEY_OEM_7 }, // degree
    { DomCode::QUOTE, true, false, 0x00E4, kAny, VKEY_OEM_5 } }; // a diaeresis

// U+00E1 a acute
const PrintableSubEntry kU00E1[] = { { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 }, { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+00E2 a circumflex
const PrintableSubEntry kU00E2[] = { { DomCode::DIGIT2, false, false, kAny, kAny, VKEY_2 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 } };

// U+00E4 a diaeresis
const PrintableSubEntry kU00E4[]
    = { { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 }, { DomCode::QUOTE, true, false, 0x00E0, kAny, VKEY_OEM_5 }, // a grave
          { DomCode::QUOTE, true, false, 0x00C4, kAny, VKEY_OEM_7 } }; // A dia.

// U+00E6 ae
const PrintableSubEntry kU00E6[] = { { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_3 }, { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+00E7 c cedilla
const PrintableSubEntry kU00E7[] = { { DomCode::DIGIT9, false, false, kAny, kAny, VKEY_9 }, { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_4 },
    { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 }, { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 },
    { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_2 }, { DomCode::COMMA, false, false, kAny, kAny, VKEY_OEM_COMMA },
    { DomCode::SEMICOLON, true, true, 0x00C7, 0x00DE, VKEY_OEM_3 }, // C ced., Thorn
    { DomCode::SEMICOLON, true, false, 0x00C7, kAny, VKEY_OEM_1 } }; // C ced., NoSy

// U+00E8 e grave
const PrintableSubEntry kU00E8[] = { { DomCode::DIGIT7, false, false, kAny, kAny, VKEY_7 }, { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_1 },
    { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_3 } };

// U+00E9 e acute
const PrintableSubEntry kU00E9[] = { { DomCode::DIGIT2, false, false, kAny, kAny, VKEY_2 }, { DomCode::DIGIT0, false, false, kAny, kAny, VKEY_0 },
    { DomCode::SLASH, false, false, kAny, kAny, VKEY_OEM_2 }, { DomCode::SEMICOLON, true, false, 0x00C9, kAny, VKEY_OEM_1 }, // E acute
    { DomCode::SEMICOLON, true, false, 0x00F6, kAny, VKEY_OEM_7 } }; // o diaeresis

// U+00ED i acute
const PrintableSubEntry kU00ED[] = { { DomCode::DIGIT9, false, false, kAny, kAny, VKEY_9 }, { DomCode::BACKQUOTE, false, false, kAny, kAny, VKEY_0 } };

// U+00F0 eth
const PrintableSubEntry kU00F0[]
    = { { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_6 }, { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_1 } };

// U+00F3 o acute
const PrintableSubEntry kU00F3[]
    = { { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_PLUS }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 } };

// U+00F4 o circumflex
const PrintableSubEntry kU00F4[] = { { DomCode::DIGIT4, false, false, kAny, kAny, VKEY_4 }, { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_1 } };

// U+00F6 o diaeresis
const PrintableSubEntry kU00F6[] = { { DomCode::DIGIT0, false, false, kAny, kAny, VKEY_OEM_3 }, { DomCode::MINUS, false, false, kAny, kAny, VKEY_OEM_PLUS },
    { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_4 }, { DomCode::SEMICOLON, true, false, 0x00E9, kAny, VKEY_OEM_7 }, // e acute
    { DomCode::SEMICOLON, true, true, 0x00D6, 0x0162, VKEY_OEM_3 }, // O dia., T ced.
    { DomCode::SEMICOLON, true, false, 0x00D6, kAny, VKEY_OEM_3 } }; // O diaresis

// U+00F8 o stroke
const PrintableSubEntry kU00F8[] = { { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_3 }, { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+00F9 u grave
const PrintableSubEntry kU00F9[] = { { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_3 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_2 } };
...
const PrintableSubEntry kU00FC[]
    = { { DomCode::US_W, false, false, kAny, kAny, VKEY_W }, { DomCode::BRACKET_LEFT, true, false, 0x00E8, kAny, VKEY_OEM_1 }, // e grave
          { DomCode::MINUS, true, false, 0x00DC, kAny, VKEY_OEM_2 }, // U diaresis
          { DomCode::BRACKET_LEFT, true, true, 0x00DC, 0x0141, VKEY_OEM_3 }, // U dia., L-
          { DomCode::BRACKET_LEFT, true, false, 0x00DC, kAny, VKEY_OEM_1 } }; // U diaresis

// U+0103 a breve
const PrintableSubEntry kU0103[] = { { DomCode::DIGIT1, false, false, kAny, kAny, VKEY_1 }, { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_4 } };

// U+0105 a ogonek
const PrintableSubEntry kU0105[] = { { DomCode::DIGIT1, false, false, kAny, kAny, VKEY_1 }, { DomCode::US_Q, false, false, kAny, kAny, VKEY_Q },
    { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+010D c caron
const PrintableSubEntry kU010D[] = { { DomCode::DIGIT2, false, false, kAny, kAny, VKEY_2 }, { DomCode::DIGIT4, false, false, kAny, kAny, VKEY_4 },
    { DomCode::US_P, false, false, kAny, kAny, VKEY_X }, { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_1 },
    { DomCode::COMMA, false, false, kAny, kAny, VKEY_OEM_COMMA } };

// U+0111 d stroke
const PrintableSubEntry kU0111[] = { { DomCode::DIGIT0, false, false, kAny, kAny, VKEY_0 }, { DomCode::BRACKET_RIGHT, false, false, kAny, kAny, VKEY_OEM_6 } };

// U+0117 e dot above
const PrintableSubEntry kU0117[] = { { DomCode::DIGIT4, false, false, kAny, kAny, VKEY_4 }, { DomCode::QUOTE, false, false, kAny, kAny, VKEY_OEM_7 } };

// U+0119 e ogonek
const PrintableSubEntry kU0119[]
    = { { DomCode::DIGIT3, false, false, kAny, kAny, VKEY_3 }, { DomCode::SLASH, true, true, 0x0118, 0x006E, VKEY_OEM_2 }, // E ogonek, n
          { DomCode::SLASH, true, false, 0x0118, kAny, VKEY_OEM_MINUS } }; // E ogonek

// U+012F i ogonek
const PrintableSubEntry kU012F[]
    = { { DomCode::DIGIT5, false, false, kAny, kAny, VKEY_5 }, { DomCode::BRACKET_LEFT, true, false, 0x012E, kAny, VKEY_OEM_4 } }; // Iogonek

// U+0142 l stroke
const PrintableSubEntry kU0142[]
    = { { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_1 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_2 } };

// U+015F s cedilla
const PrintableSubEntry kU015F[]
    = { { DomCode::SEMICOLON, false, false, kAny, kAny, VKEY_OEM_1 }, { DomCode::PERIOD, false, false, kAny, kAny, VKEY_OEM_PERIOD } };

// U+0161 s caron
const PrintableSubEntry kU0161[] = { { DomCode::DIGIT3, false, false, kAny, kAny, VKEY_3 }, { DomCode::DIGIT6, false, false, kAny, kAny, VKEY_6 },
    { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_4 }, { DomCode::US_A, false, false, kAny, kAny, VKEY_OEM_1 },
    { DomCode::US_F, false, false, kAny, kAny, VKEY_F }, { DomCode::PERIOD, false, false, kAny, kAny, VKEY_OEM_PERIOD } };

// U+016B u macron
const PrintableSubEntry kU016B[] = { { DomCode::DIGIT8, false, false, kAny, kAny, VKEY_8 }, { DomCode::US_Q, false, false, kAny, kAny, VKEY_Q },
    { DomCode::US_X, false, false, kAny, kAny, VKEY_X } };

// U+0173 u ogonek
const PrintableSubEntry kU0173[]
    = { { DomCode::DIGIT7, false, false, kAny, kAny, VKEY_7 }, { DomCode::SEMICOLON, true, true, 0x0172, 0x0162, VKEY_OEM_1 }, // U ogo., T ced.
          { DomCode::SEMICOLON, true, false, 0x0172, kAny, VKEY_OEM_3 } }; // U ogonek

// U+017C z dot above
const PrintableSubEntry kU017C[]
    = { { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_OEM_4 }, { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 } };

// U+017E z caron
const PrintableSubEntry kU017E[] = { { DomCode::DIGIT6, false, false, kAny, kAny, VKEY_6 }, { DomCode::EQUAL, false, false, kAny, kAny, VKEY_OEM_PLUS },
    { DomCode::US_W, false, false, kAny, kAny, VKEY_W }, { DomCode::BRACKET_LEFT, false, false, kAny, kAny, VKEY_Y },
    { DomCode::BACKSLASH, false, false, kAny, kAny, VKEY_OEM_5 } };
...
void LoadKeymap(const std::string& layout_name, scoped_refptr<base::SingleThreadTaskRunner> reply_runner, LoadKeymapCallback reply_callback)
{
    std::string layout_id;
    std::string layout_variant;
    XkbKeyboardLayoutEngine::ParseLayoutName(layout_name, &layout_id, &layout_variant);
    xkb_rule_names names = { .rules = NULL, .model = "pc101", .layout = layout_id.c_str(), .variant = layout_variant.c_str(), .options = "" };
    ...
    keymap.reset(xkb_keymap_new_from_names(context.get(), &names, XKB_KEYMAP_COMPILE_NO_FLAGS));
    if (keymap) {
        std::unique_ptr<char, base::FreeDeleter> keymap_str(xkb_keymap_get_as_string(keymap.get(), XKB_KEYMAP_FORMAT_TEXT_V1));
        reply_runner->PostTask(FROM_HERE, base::BindOnce(std::move(reply_callback), layout_name, std::move(keymap_str)));
    } else {
...
XkbKeyboardLayoutEngine::XkbKeyboardLayoutEngine(const XkbKeyCodeConverter& converter)
...
void XkbKeyboardLayoutEngine::SetCurrentLayoutByName(const std::string& layout_name, base::OnceCallback<void(bool)> callback)
{
#if BUILDFLAG(IS_CHROMEOS)
    ...
    LoadKeymapCallback reply_callback = base::BindOnce(&XkbKeyboardLayoutEngine::OnKeymapLoaded, weak_ptr_factory_.GetWeakPtr(), std::move(callback));
    base::ThreadPool::PostTask(FROM_HERE, { base::MayBlock(), base::TaskShutdownBehavior::CONTINUE_ON_SHUTDOWN },
        base::BindOnce(&LoadKeymap, layout_name, base::SingleThreadTaskRunner::GetCurrentDefault(), std::move(reply_callback)));
#else
    NOTIMPLEMENTED();
...
void XkbKeyboardLayoutEngine::OnKeymapLoaded(
    base::OnceCallback<void(bool)> callback, const std::string& layout_name, std::unique_ptr<char, base::FreeDeleter> keymap_str)
{
    if (keymap_str) {
        xkb_keymap* keymap = xkb_keymap_new_from_string(xkb_context_.get(), keymap_str.get(), XKB_KEYMAP_FORMAT_TEXT_V1, XKB_KEYMAP_COMPILE_NO_FLAGS);
...
bool XkbKeyboardLayoutEngine::Lookup(DomCode dom_code, int flags, DomKey* dom_key, KeyboardCode* key_code) const
{
    ...
    if (xkb_keycode == key_code_converter_->InvalidXkbKeyCode()) {
        LOG(ERROR) << "No XKB keycode for DomCode 0x" << std::hex << static_cast<int>(dom_code) << " '" << KeycodeConverter::DomCodeToCodeString(dom_code)
                   << "'";
        return false;
    }
    ...
    if ((flags & kNonShiftlikeModifiers) && IsControlCharacter(character)) {
        ...
        if (XkbLookup(xkb_keycode, normal_xkb_flags, &normal_keysym, &normal_character) && !IsControlCharacter(normal_character)) {
    ...
    *key_code = AlphanumericKeyboardCode(xkb_keysym, character);
    if (*key_code == VKEY_UNKNOWN) {
        *key_code = DifficultKeyboardCode(dom_code, flags, xkb_keycode, xkb_flags, xkb_keysym, character);
        if (*key_code == VKEY_UNKNOWN)
            *key_code = DomCodeToUsLayoutNonLocatedKeyboardCode(dom_code);
    }
    return true;
...
void XkbKeyboardLayoutEngine::SetInitCallbackForTest(base::OnceClosure closure)
{
    if (xkb_state_) {
...
bool XkbKeyboardLayoutEngine::SetCurrentLayoutFromBuffer(const char* keymap_string, size_t size)
{
    xkb_keymap* keymap = xkb_keymap_new_from_buffer(xkb_context_.get(), keymap_string, size, XKB_KEYMAP_FORMAT_TEXT_V1, XKB_KEYMAP_COMPILE_NO_FLAGS);
    if (!keymap)
        return false;
    ...
    for (xkb_keycode_t keycode = min_key; keycode <= max_key; ++keycode) {
        ...
        for (xkb_layout_index_t layout = 0; layout < num_layouts; ++layout) {
            ...
            for (xkb_level_index_t level = 0; level < num_levels; ++level) {
                ...
                int num_syms = xkb_keymap_key_get_syms_by_level(keymap, keycode, layout, level, &keysyms);
                for (int i = 0; i < num_syms; ++i)
                    keysym_map.emplace_back(XkbKeysymMapEntry { keysyms[i], keycode, layout });
            }
        }
    }

    // Then sort and unique here. On tie break, smaller keycode comes first.
    std::sort(keysym_map.begin(), keysym_map.end(), [](const XkbKeysymMapEntry& entry1, const XkbKeysymMapEntry& entry2) {
        return std::tie(entry1.xkb_keysym, entry1.xkb_keycode, entry1.xkb_layout) < std::tie(entry2.xkb_keysym, entry2.xkb_keycode, entry2.xkb_layout);
    });
    keysym_map.erase(std::unique(keysym_map.begin(), keysym_map.end(),
                         [](const XkbKeysymMapEntry& entry1, const XkbKeysymMapEntry& entry2) {
                             return std::tie(entry1.xkb_keysym, entry1.xkb_keycode, entry1.xkb_layout)
                                 == std::tie(entry2.xkb_keysym, entry2.xkb_keycode, entry2.xkb_layout);
                         }),
        keysym_map.end());
...
xkb_mod_mask_t XkbKeyboardLayoutEngine::EventFlagsToXkbFlags(int ui_flags) const
{
#if BUILDFLAG(IS_CHROMEOS)
...
int XkbKeyboardLayoutEngine::UpdateModifiers(uint32_t depressed, uint32_t latched, uint32_t locked, uint32_t group)
{
    auto* state = xkb_state_.get();
    xkb_state_update_mask(state, depressed, latched, locked, 0, 0, group);
    auto component = static_cast<xkb_state_component>(XKB_STATE_MODS_DEPRESSED | XKB_STATE_MODS_LATCHED | XKB_STATE_MODS_LOCKED);
    xkb_mod_index_t num_mods = xkb_keymap_num_mods(xkb_state_get_keymap(xkb_state_.get()));
...
DomCode XkbKeyboardLayoutEngine::GetDomCodeByKeysym(uint32_t keysym, const std::optional<std::vector<std::string_view>>& modifiers) const
{
    // Look up all candidates.
    auto range = std::equal_range(xkb_keysym_map_.begin(), xkb_keysym_map_.end(), XkbKeysymMapEntry { keysym },
        [](const XkbKeysymMapEntry& entry1, const XkbKeysymMapEntry& entry2) { return entry1.xkb_keysym < entry2.xkb_keysym; });
    if (range.first != range.second) {
        ...
        xkb_mod_mask_t xkb_modifiers = xkb_modifier_converter_.MaskFromNames(*modifiers);
        // Note: value is already in the lexicographical order, so smaller keycode
        // comes first.
        for (std::unique_ptr<xkb_state, XkbStateDeleter> xkb_state(xkb_state_new(xkb_state_get_keymap(xkb_state_.get()))); range.first != range.second;
             ++range.first) {
            ...
            if (xkb_layout != layout_index_)
                continue;
            xkb_state_update_mask(xkb_state.get(), xkb_modifiers, 0, 0, 0, 0, xkb_layout);
            const xkb_keysym_t* out_keysyms;
            int num_syms = xkb_state_key_get_syms(xkb_state.get(), xkb_keycode, &out_keysyms);
            for (int i = 0; i < num_syms; ++i) {
    ...
    VLOG(1) << "No Keycode found for the keysym: " << keysym
            << ", modifiers: " << (modifiers.has_value() ? base::JoinString(modifiers.value(), ",") : "(no modifiers)");
    return DomCode::NONE;
}

bool XkbKeyboardLayoutEngine::XkbLookup(xkb_keycode_t xkb_keycode, xkb_mod_mask_t xkb_flags, xkb_keysym_t* xkb_keysym, uint32_t* character) const
{
    if (!xkb_state_) {
...
KeyboardCode XkbKeyboardLayoutEngine::DifficultKeyboardCode(
    DomCode dom_code, int ui_flags, xkb_keycode_t xkb_keycode, xkb_mod_mask_t xkb_flags, xkb_keysym_t xkb_keysym, char16_t character) const
{
    ...
    const PrintableMultiEntry* multi
        = std::lower_bound(kMultiMap, multi_end, plain_character, [](const PrintableMultiEntry& e, char16_t c) { return e.plain_character < c; });
        ...
        for (size_t i = 0; i < multi->subtable_size; ++i) {
            ...
            if (multi->subtable[i].test_shift) {
                if (shift_character == kNonCharacter) {
                    shift_character = XkbSubCharacter(xkb_keycode, xkb_flags, character, shift_mod_mask_);
                }
            ...
            if (multi->subtable[i].test_altgr) {
                if (altgr_character == kNonCharacter) {
                    altgr_character = XkbSubCharacter(xkb_keycode, xkb_flags, character, altgr_mod_mask_);
                }
    ...
    const PrintableSimpleEntry* simple
        = std::lower_bound(kSimpleMap, simple_end, plain_character, [](const PrintableSimpleEntry& e, char16_t c) { return e.plain_character < c; });
...
char16_t XkbKeyboardLayoutEngine::XkbSubCharacter(xkb_keycode_t xkb_keycode, xkb_mod_mask_t base_flags, char16_t base_character, xkb_mod_mask_t flags) const
{
    if (flags == base_flags)
...
void XkbKeyboardLayoutEngine::ParseLayoutName(const std::string& layout_name, std::string* layout_id, std::string* layout_variant)
{
    ...
    *layout_variant = "";
    if (parentheses_index != std::string::npos) {
        ...
        *layout_variant = layout_name.substr(parentheses_index + 1, close_index - parentheses_index - 1);
