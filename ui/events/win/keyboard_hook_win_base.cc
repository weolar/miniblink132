...
KeyboardHookWinBase::KeyboardHookWinBase(std::optional<base::flat_set<DomCode>> dom_codes, KeyEventCallback callback, bool enable_hook_registration)
...
// static
LRESULT CALLBACK KeyboardHookWinBase::ProcessKeyEvent(KeyboardHookWinBase* instance, int code, WPARAM w_param, LPARAM l_param)
{
