...
constexpr EventFlags EF_MOUSE_BUTTON = EF_LEFT_MOUSE_BUTTON | EF_MIDDLE_MOUSE_BUTTON | EF_RIGHT_MOUSE_BUTTON | EF_BACK_MOUSE_BUTTON | EF_FORWARD_MOUSE_BUTTON;
...
enum EventResult {
    ...
    ER_FORCE_PROCESS_GESTURE = 1 << 3, // The event should be processed by gesture recognizer even if
