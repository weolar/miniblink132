...
EVENTS_DEVICES_EXPORT std::ostream& operator<<(std::ostream& os, const InputDeviceType value);
...
struct EVENTS_DEVICES_EXPORT InputDevice {
    ...
    InputDevice(int id, InputDeviceType type, const std::string& name, const std::string& phys, const base::FilePath& sys_path, uint16_t vendor,
