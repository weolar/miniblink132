...
{
    ui::TouchscreenDevice device(ui::InputDevice(123, ui::InputDeviceType::INPUT_DEVICE_USB, "Name", "Phys",
                                     base::FilePath(FILE_PATH_LITERAL("/sys/some/path/event8")), 0x0012, 0xBE00, 0x18AF),
