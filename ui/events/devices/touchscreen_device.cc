...
TouchscreenDevice::TouchscreenDevice(
    int id, InputDeviceType type, const std::string& name, const gfx::Size& size, int touch_points, bool has_stylus, bool has_stylus_garage_switch)
...
TouchscreenDevice::TouchscreenDevice(const InputDevice& input_device, const gfx::Size& size, int touch_points, bool has_stylus, bool has_stylus_garage_switch)
