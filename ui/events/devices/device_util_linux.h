...
EVENTS_DEVICES_EXPORT base::FilePath GetInputPathInSys(const base::FilePath& path);

// Finds device type (internal or external) based on device path.
EVENTS_DEVICES_EXPORT InputDeviceType GetInputDeviceTypeFromPath(const base::FilePath& path);
