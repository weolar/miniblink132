...
public:
    ...
    // time this is called.
    void SetTouchDeviceList(const std::vector<std::pair<int, EventPointerType>>& devices);
    ...
    EventPointerType GetTouchDevicePointerType(x11::Input::DeviceId deviceid) const;
