...
TEST(EventTargetTest, HandlerOrdering)
{
    ...
    target.AddPreTargetHandler(&a11y_handler, EventTarget::Priority::kAccessibility);
    list = test_api.GetPreTargetHandlers();
...
TEST(EventTargetTest, HandlerOrderingComplex)
{
    ...
    target.AddPreTargetHandler(&default_handler_1, EventTarget::Priority::kDefault);
    target.AddPreTargetHandler(&system_handler_2, EventTarget::Priority::kSystem);
    target.AddPreTargetHandler(&a11y_handler_2, EventTarget::Priority::kAccessibility);
    target.AddPreTargetHandler(&system_handler_1, EventTarget::Priority::kSystem);
    target.AddPreTargetHandler(&default_handler_2, EventTarget::Priority::kDefault);
    target.AddPreTargetHandler(&a11y_handler_1, EventTarget::Priority::kAccessibility);
    list = test_api.GetPreTargetHandlers();
...
TEST(EventTargetTest, HandlerOrderingAcrossEventTargets)
{
    ...
    std::unique_ptr<test::TestEventTarget> child = std::make_unique<test::TestEventTarget>();
    ...
    parent.AddPreTargetHandler(&default_handler_1, EventTarget::Priority::kDefault);
    parent.AddPreTargetHandler(&system_handler_2, EventTarget::Priority::kSystem);
    parent.AddPreTargetHandler(&a11y_handler_2, EventTarget::Priority::kAccessibility);

    child->AddPreTargetHandler(&default_handler_3, EventTarget::Priority::kDefault);
    child->AddPreTargetHandler(&a11y_handler_3, EventTarget::Priority::kAccessibility);
    ...
    parent.AddPreTargetHandler(&default_handler_2, EventTarget::Priority::kDefault);
    parent.AddPreTargetHandler(&a11y_handler_1, EventTarget::Priority::kAccessibility);
