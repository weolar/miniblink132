...
std::unique_ptr<TestEventTarget> TestEventTarget::RemoveChild(TestEventTarget* c)
{
...
void TestEventTarget::SetEventTargeter(std::unique_ptr<EventTargeter> targeter)
{
...
{
    return std::make_unique<EventTargetIteratorUniquePtrImpl<TestEventTarget>>(children_);
}
