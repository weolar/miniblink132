...
class TestEventTarget : public EventTarget, public EventHandler {
public:
    TestEventTarget();
    ...
    TestEventTarget* child_at(int index)
    {
...
private:
    void set_parent(TestEventTarget* parent)
    {
        parent_ = parent;
    }
