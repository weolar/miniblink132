...
public:
    ScopedEventWaiterTest()
    {
        ...
        root_target->SetEventTargeter(std::make_unique<TestEventTargeter>(root_target.get(), /*should_bubble=*/false));
    ...
    void DispatchEventAsync(ui::Event* event)
    {
        base::SequencedTaskRunner::GetCurrentDefault()->PostTask(
            FROM_HERE, base::BindOnce(&ScopedEventWaiterTest::DispatchEvent, base::Unretained(this), event));
    }

    TestEventTarget* root_target()
    {
        return root_target_;
    }
