...
public:
    ...
    void SetSnapScrollMode(const MotionEvent& event, bool is_scale_gesture_detection_in_progress, float slop_distance);
    ...
    // behavior is reset.
    void UpdateSnapScrollMode(float distance_x, float distance_y, float slop_distance);
