...
public:
    ...
    bool double_tap_enabled() const
    {
        return double_tap_enabled_;
    }
    void set_double_tap_enabled(bool enabled)
    {
    ...
    bool stylus_scale_enabled() const
    {
        return stylus_scale_enabled_;
    }
    ...
    base::TimeDelta short_press_time() const
    {
        return short_press_time_;
    }
    void set_short_press_time(base::TimeDelta val)
    {
        short_press_time_ = val;
    }
    int long_press_time_in_ms() const
    {
        return long_press_time_in_ms_;
    }
    void set_long_press_time_in_ms(int val)
    {
    ...
    int max_tap_count() const
    {
        return max_tap_count_;
    }
    void set_max_tap_count(int count)
    {
        max_tap_count_ = count;
    }
    float max_fling_velocity() const
    {
        return max_fling_velocity_;
    }
    void set_max_fling_velocity(float val)
    {
        max_fling_velocity_ = val;
    }
    ...
    float min_fling_velocity() const
    {
        return min_fling_velocity_;
    }
    void set_min_fling_velocity(float val)
    {
        min_fling_velocity_ = val;
    }
    ...
    float min_swipe_velocity() const
    {
        return min_swipe_velocity_;
    }
    void set_min_swipe_velocity(float val)
    {
        min_swipe_velocity_ = val;
    }
    ...
    int show_press_delay_in_ms() const
    {
    ...
    float span_slop() const
    {
        return span_slop_;
    }
    bool swipe_enabled() const
    {
        return swipe_enabled_;
    }
    void set_swipe_enabled(bool val)
    {
        swipe_enabled_ = val;
    }
    bool two_finger_tap_enabled() const
    {
        return two_finger_tap_enabled_;
    }
    void set_two_finger_tap_enabled(bool val)
    {
        two_finger_tap_enabled_ = val;
    }
...
private:
    ...
    VelocityTracker::Strategy velocity_tracker_strategy_ = VelocityTracker::Strategy::STRATEGY_DEFAULT;
};
