...
class FilteredGestureProviderTest : public GestureProviderClient, public testing::Test {
public:
...
TEST_F(FilteredGestureProviderTest, ExtraCancel)
{
    ...
    test::MockMotionEvent event(MotionEvent::Action::CANCEL, base::TimeTicks(), 0, 0);
    auto result = provider.OnTouchEvent(event);
