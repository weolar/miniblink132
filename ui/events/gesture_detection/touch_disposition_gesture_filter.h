...
public:
    explicit TouchDispositionGestureFilter(TouchDispositionGestureFilterClient* client);

    TouchDispositionGestureFilter(const TouchDispositionGestureFilter&) = delete;
    TouchDispositionGestureFilter& operator=(const TouchDispositionGestureFilter&) = delete;
...
private:
    ...
    void SendGesture(const GestureEventData& gesture, const GestureEventDataPacket& packet);
    ...
    void SendAckedEvents(const std::optional<EventLatencyMetadata>& event_latency_metadata);
