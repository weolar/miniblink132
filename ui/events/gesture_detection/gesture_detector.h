...
public:
    struct GESTURE_DETECTION_EXPORT Config {
        ...
        VelocityTracker::Strategy velocity_tracker_strategy = VelocityTracker::Strategy::STRATEGY_DEFAULT;
    ...
    GestureDetector(const Config& config, GestureListener* listener, DoubleTapListener* optional_double_tap_listener);
    ...
    bool has_doubletap_listener() const
    {
        return !!double_tap_listener_;
    }

    bool is_double_tapping() const
    {
        return is_double_tapping_;
    }
    ...
    void set_showpress_enabled(bool enabled)
    {
        showpress_enabled_ = enabled;
    }
    ...
    const MotionEvent* GetSourcePointerDownEvent(const MotionEvent& current_down_event, const MotionEvent* secondary_pointer_down_event, const int pointer_id);
...
private:
    ...
    void Cancel();
    void CancelTaps();
    bool IsRepeatedTap(const MotionEvent& first_down, const MotionEvent& first_up, const MotionEvent& second_down, bool should_process_double_tap) const;
