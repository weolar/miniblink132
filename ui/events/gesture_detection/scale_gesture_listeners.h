...
public:
    ...
    virtual bool OnScale(const ScaleGestureDetector& detector, const MotionEvent& e) = 0;
    virtual bool OnScaleBegin(const ScaleGestureDetector& detector, const MotionEvent& e) = 0;
    virtual void OnScaleEnd(const ScaleGestureDetector& detector, const MotionEvent& e) = 0;
};
...
class GESTURE_DETECTION_EXPORT SimpleScaleGestureListener : public ScaleGestureListener {
public:
