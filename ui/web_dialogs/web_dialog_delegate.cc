...
void WebDialogDelegate::GetWebUIMessageHandlers(std::vector<content::WebUIMessageHandler*>* handlers)
{
...
void WebDialogDelegate::AddWebUIMessageHandler(std::unique_ptr<content::WebUIMessageHandler> handler)
{
...
void WebDialogDelegate::RegisterOnDialogClosedCallback(OnDialogClosedCallback callback)
{
    closed_callback_ = std::move(callback);
}

void WebDialogDelegate::OnDialogCloseFromWebUI(const std::string& json_retval)
{
    OnDialogClosed(json_retval);
}

void WebDialogDelegate::OnCloseContents(content::WebContents* source, bool* out_close_dialog)
{
    *out_close_dialog = can_close_;
}

bool WebDialogDelegate::HandleContextMenu(content::RenderFrameHost& render_frame_host, const content::ContextMenuParams& params)
{
...
bool WebDialogDelegate::HandleOpenURLFromTab(content::WebContents* source, const content::OpenURLParams& params,
...
void WebDialogDelegate::RegisterAccelerator(Accelerator accelerator, AcceleratorHandler handler)
{
