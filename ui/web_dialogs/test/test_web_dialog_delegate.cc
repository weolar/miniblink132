...
void TestWebDialogDelegate::SetDeleteOnClosedAndObserve(bool* destroy_observer)
{
...
void TestWebDialogDelegate::OnCloseContents(WebContents* source, bool* out_close_dialog)
{
