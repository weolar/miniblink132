...
public:
    ...
    static void SetDelegate(content::WebContents* web_contents, WebDialogDelegate* delegate);
...
// this.
class WEB_DIALOGS_EXPORT WebDialogUI : public WebDialogUIBase, public content::WebUIController {
public:
...
class WEB_DIALOGS_EXPORT MojoWebDialogUI : public WebDialogUI, public ui::EnableMojoWebUI {
public:
    // When created, the delegate should already be set as user data on the
    // WebContents.
