...
BASE_FEATURE(kRoundedDisplay, "RoundedDisplay", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kUseHDRTransferFunction, "UseHDRTransferFunction",
...
BASE_FEATURE(kEnableExternalDisplayHDR10Mode, "EnableExternalDisplayHDR10Mode", base::FEATURE_DISABLED_BY_DEFAULT);

// Feature to control if the CTM is dynamically set to the primary transform
// from plane color space to output color space.
BASE_FEATURE(kCtmColorManagement, "CtmColorManagement", base::FEATURE_ENABLED_BY_DEFAULT);
#endif
...
BASE_FEATURE(kListAllDisplayModes, "ListAllDisplayModes", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kEnableEdidBasedDisplayIds, "EnableEdidBasedDisplayIds", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kOledScaleFactorEnabled, "OledScaleFactorEnabled", base::FEATURE_DISABLED_BY_DEFAULT);
...
// details.
BASE_FEATURE(kEnableHardwareMirrorMode, "EnableHardwareMirrorMode", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kRequireHdcpKeyProvisioning, "RequireHdcpKeyProvisioning", base::FEATURE_DISABLED_BY_DEFAULT);
bool IsHdcpKeyProvisioningRequired()
{
    return base::FeatureList::IsEnabled(kRequireHdcpKeyProvisioning);
}

BASE_FEATURE(kPanelSelfRefresh2, "PanelSelfRefresh2", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kTiledDisplaySupport, "TiledDisplaySupport", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kExcludeDisplayInMirrorMode, "ExcludeDisplayInMirrorMode", base::FEATURE_DISABLED_BY_DEFAULT);
