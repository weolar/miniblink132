...
public:
    ...
    TouchDeviceManagerTestApi& operator=(const TouchDeviceManagerTestApi&) = delete;

    ~TouchDeviceManagerTestApi();

    // Associate the given display |display_info| with the touch device |device|.
    void Associate(ManagedDisplayInfo* display_info, const ui::TouchscreenDevice& device);
