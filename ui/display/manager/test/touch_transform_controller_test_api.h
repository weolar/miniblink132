...
public:
    explicit TouchTransformControllerTestApi(TouchTransformController* controller);

    TouchTransformControllerTestApi(const TouchTransformControllerTestApi&) = delete;
    TouchTransformControllerTestApi& operator=(const TouchTransformControllerTestApi&) = delete;
