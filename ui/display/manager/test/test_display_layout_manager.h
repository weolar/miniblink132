...
public:
    TestDisplayLayoutManager(const std::vector<raw_ptr<DisplaySnapshot, VectorExperimental>>& displays, MultipleDisplayState display_state);
    ...
    void set_displays(const std::vector<raw_ptr<DisplaySnapshot, VectorExperimental>>& displays)
    {
        displays_ = displays;
    }
    ...
    std::vector<raw_ptr<DisplaySnapshot, VectorExperimental>> GetDisplayStates() const override;
