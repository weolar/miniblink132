...
{
    auto result = ReadJsonString("[{\"connector-type\": 14, \"rounded-corners\": {\"bottom-left\": 15, "
...
{
    auto result = ReadJsonString("[{\"connector-type\": 5, \"rounded-corners\": {\"bottom-left\": 15, "
                                 "\"bottom-right\": -15, \"top-left\": 16, \"top-right\": 16}}]");
...
{
    auto result = ReadJsonString("[{\"connector-type\": 5, \"round-corners\": {\"bottom-left\": 15, "
                                 "\"bottom-right\": -15, \"top-left\": 16, \"top-right\": 16}}]");
