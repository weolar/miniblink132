...
public:
    TouchTransformController(DisplayManager* display_manager, std::unique_ptr<TouchTransformSetter> setter);
...
private:
    ...
    // |update_data|.
    void UpdateTouchRadius(const ManagedDisplayInfo& display, UpdateData* update_data) const;
