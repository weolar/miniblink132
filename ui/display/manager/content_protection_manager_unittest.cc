...
public:
    explicit TestObserver(ContentProtectionManager* manager)
        : manager_(manager)
    {
    ...
    const SecurityChanges& security_changes() const
    {
        return security_changes_;
    }

    void Reset()
    {
        security_changes_.clear();
    }
...
public:
    ...
    ContentProtectionManagerTest& operator=(const ContentProtectionManagerTest&) = delete;
    ...
    void SetUp() override
    {
        ...
        DisplayConnectionType conn_types[]
            = { DISPLAY_CONNECTION_TYPE_INTERNAL, DISPLAY_CONNECTION_TYPE_HDMI, DISPLAY_CONNECTION_TYPE_VGA, DISPLAY_CONNECTION_TYPE_HDMI };
        for (size_t i = 0; i < std::size(kDisplayIds); ++i) {
            displays_[i] = FakeDisplaySnapshot::Builder().SetId(kDisplayIds[i]).SetType(conn_types[i]).SetCurrentMode(kDisplayMode.Clone()).Build();
        }
    ...
    void QueryContentProtectionCallback(bool success, uint32_t connection_mask, uint32_t protection_mask)
    {
...
protected:
    ...
    ContentProtectionManager manager_ { &layout_manager_, base::BindRepeating([] { return false; }) };
...
TEST_F(ContentProtectionManagerTest, Basic)
{
    ...
    manager_.QueryContentProtection(
        id, displays_[0]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.QueryContentProtection(
        id, displays_[1]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.ApplyContentProtection(id, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_HDCP,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));

    EXPECT_EQ(1, apply_content_protection_call_count_);
    EXPECT_TRUE(apply_content_protection_success_);
    EXPECT_EQ(GetSetHDCPStateAction(kDisplayIds[1], HDCP_STATE_DESIRED, CONTENT_PROTECTION_METHOD_HDCP), log_.GetActionsAndClear());
    ...
    manager_.QueryContentProtection(
        id, kInvalidDisplayId, base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));

    manager_.ApplyContentProtection(id, kInvalidDisplayId, CONTENT_PROTECTION_METHOD_HDCP,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    EXPECT_EQ(GetSetHDCPStateAction(kDisplayIds[1], HDCP_STATE_UNDESIRED, CONTENT_PROTECTION_METHOD_NONE), log_.GetActionsAndClear());
...
TEST_F(ContentProtectionManagerTest, BasicAsync)
{
    ...
    manager_.ApplyContentProtection(id, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_NONE,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, TwoClients)
{
    ...
    manager_.ApplyContentProtection(client1, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_HDCP,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.QueryContentProtection(
        client1, displays_[1]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.QueryContentProtection(
        client2, displays_[1]->display_id(), base::BindOnce(&ContentProtectionManagerTest::QueryContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.ApplyContentProtection(client2, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_NONE,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    manager_.ApplyContentProtection(client1, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_NONE,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, TwoClientsEnable)
{
    ...
    manager_.ApplyContentProtection(client2, displays_[1]->display_id(), CONTENT_PROTECTION_METHOD_HDCP,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, RequestRetention)
{
    ...
    manager_.ApplyContentProtection(id, displays_[0]->display_id(), CONTENT_PROTECTION_METHOD_NONE,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    EXPECT_EQ(GetSetHDCPStateAction(kDisplayIds[1], HDCP_STATE_DESIRED, CONTENT_PROTECTION_METHOD_HDCP).c_str(), log_.GetActionsAndClear());
    EXPECT_EQ(HDCP_STATE_ENABLED, native_display_delegate_.hdcp_state());
}
...
TEST_F(ContentProtectionManagerTest, ClientRegistration)
{
    ...
    EXPECT_EQ(JoinActions(GetSetHDCPStateAction(kDisplayIds[1], HDCP_STATE_DESIRED, CONTENT_PROTECTION_METHOD_HDCP).c_str(),
                  GetSetHDCPStateAction(kDisplayIds[1], HDCP_STATE_UNDESIRED, CONTENT_PROTECTION_METHOD_NONE).c_str(), nullptr),
...
TEST_F(ContentProtectionManagerTest, DisplaySecurityObserver)
{
    ...
    EXPECT_EQ(SecurityChanges({ { kDisplayIds[0], true }, { kDisplayIds[1], false } }), observer.security_changes());
    observer.Reset();
    ...
    manager_.ApplyContentProtection(id, kDisplayIds[1], CONTENT_PROTECTION_METHOD_HDCP,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    EXPECT_EQ(SecurityChanges({ { kDisplayIds[0], true }, { kDisplayIds[1], true } }), observer.security_changes());
    observer.Reset();
    ...
    manager_.ApplyContentProtection(id, kDisplayIds[1], CONTENT_PROTECTION_METHOD_NONE,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    ...
    EXPECT_EQ(SecurityChanges({ { kDisplayIds[0], false }, { kDisplayIds[1], false } }), observer.security_changes());
    observer.Reset();
...
TEST_F(ContentProtectionManagerTest, NoSecurityPollingIfInternalDisplayOnly)
{
    ...
    EXPECT_EQ(SecurityChanges({ { kDisplayIds[0], true } }), observer.security_changes());
    observer.Reset();
    ...
    manager_.ApplyContentProtection(id, kDisplayIds[0], CONTENT_PROTECTION_METHOD_HDCP,
        base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
...
TEST_F(ContentProtectionManagerTest, AnalogDisplaySecurity)
{
    ...
    EXPECT_EQ(SecurityChanges({ { kDisplayIds[0], true }, { kDisplayIds[1], false }, { kDisplayIds[2], false } }), observer.security_changes());
    observer.Reset();
    ...
    for (int64_t display_id : kDisplayIds) {
        manager_.ApplyContentProtection(id, display_id, CONTENT_PROTECTION_METHOD_HDCP,
            base::BindOnce(&ContentProtectionManagerTest::ApplyContentProtectionCallback, base::Unretained(this)));
    }
    ...
    EXPECT_EQ(SecurityChanges({ { kDisplayIds[0], true }, { kDisplayIds[1], true }, { kDisplayIds[2], false } }), observer.security_changes());
    observer.Reset();
    ...
    EXPECT_EQ(SecurityChanges({ { kDisplayIds[0], false }, { kDisplayIds[1], false }, { kDisplayIds[2], false } }), observer.security_changes());
    observer.Reset();
