...
class DISPLAY_MANAGER_EXPORT DisplayManagerObserver : public base::CheckedObserver {
public:
    ...
    struct DISPLAY_EXPORT DisplayConfigurationChange {
        DisplayConfigurationChange(Displays added_displays, Displays removed_displays, std::vector<DisplayMetricsChange> display_metrics_changes);
    ...
    virtual void OnDidProcessDisplayChanges(const DisplayConfigurationChange& configuration_change)
    {
    }
