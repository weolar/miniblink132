...
using DisplaySizeToZoomFactorMap = std::map</*size_as_string=*/std::string, /*zoom_factor=*/float>;
...
public:
    ...
    ManagedDisplayMode(const gfx::Size& size, float refresh_rate, bool is_interlaced, bool native);

    ManagedDisplayMode(const gfx::Size& size, float refresh_rate, bool is_interlaced, bool native, float device_scale_factor);
...
inline bool operator!=(const ManagedDisplayMode& lhs, const ManagedDisplayMode& rhs)
{
    return !(lhs == rhs);
}
...
public:
    ...
    static ManagedDisplayInfo CreateFromSpecWithID(const std::string& spec, int64_t id);
    ...
    void set_display_id(int64_t id)
    {
        id_ = id;
    }
    ...
    {
        return port_display_id_;
    }
    void set_port_display_id(int64_t id)
    {
        port_display_id_ = id;
    }
    ...
    {
        return edid_display_id_;
    }
    void set_edid_display_id(int64_t id)
    {
        edid_display_id_ = id;
    }
    ...
    void set_connector_index(uint16_t index)
    {
    ...
    void set_sys_path(const base::FilePath& sys_path)
    {
        sys_path_ = sys_path;
    }
    const base::FilePath& sys_path() const
    {
        return sys_path_;
    }
    ...
    void set_has_overscan(bool has_overscan)
    {
        has_overscan_ = has_overscan;
    }
    bool has_overscan() const
    {
        return has_overscan_;
    }
    ...
    Display::TouchSupport touch_support() const
    {
    ...
    DisplayConnectionType connection_type() const
    {
        return connection_type_;
    }

    void set_physical_size(const gfx::Size& size)
    {
        physical_size_ = size;
    }
    const gfx::Size& physical_size() const
    {
    ...
    void set_is_interlaced(bool is_interlaced)
    {
        is_interlaced_ = is_interlaced;
    }

    // Gets/Sets the device DPI of the display.
    float device_dpi() const
    {
        return device_dpi_;
    }
    void set_device_dpi(float dpi)
    {
        device_dpi_ = dpi;
    }

    PanelOrientation panel_orientation() const
    {
    ...
    // account.
    const gfx::Size& size_in_pixel() const
    {
        return size_in_pixel_;
    }
    ...
    bool clear_overscan_insets() const
    {
        return clear_overscan_insets_;
    }
    void set_clear_overscan_insets(bool clear)
    {
        clear_overscan_insets_ = clear;
    }
    ...
    bool from_native_platform() const
    {
        return from_native_platform_;
    }

    const ManagedDisplayModeList& display_modes() const
    {
    ...
    void set_display_color_spaces(const gfx::DisplayColorSpaces& display_color_spaces)
    {
    ...
    const gfx::Size& maximum_cursor_size() const
    {
        return maximum_cursor_size_;
    }
    ...
    const std::string& manufacturer_id() const
    {
        return manufacturer_id_;
    }
    void set_manufacturer_id(const std::string& id)
    {
        manufacturer_id_ = id;
    }
    ...
    void set_year_of_manufacture(int32_t year)
    {
        year_of_manufacture_ = year;
    }
    ...
    void set_variable_refresh_rate_state(VariableRefreshRateState variable_refresh_rate_state)
    {
        variable_refresh_rate_state_ = variable_refresh_rate_state;
    }

    const std::optional<float>& vsync_rate_min() const
    {
    ...
    void SetDRMFormatsAndModifiers(const DrmFormatsAndModifiers& drm_formats_and_modifiers)
    {
...
private:
    ...
    Display::Rotation GetRotationWithPanelOrientation(Display::Rotation rotation) const;
...
ManagedDisplayInfo DISPLAY_MANAGER_EXPORT CreateDisplayInfo(int64_t id, const gfx::Rect& bounds = gfx::Rect());
