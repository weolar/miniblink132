...
ui::TouchscreenDevice CreateTouchscreenDevice(int id, ui::InputDeviceType type, const gfx::Size& size)
{
...
TouchDeviceManager::TouchAssociationInfo CreateTouchAssociationInfo(int days_old)
{
...
public:
    ...
    void SetUp() override
    {
        ...
        display_manager_ = std::make_unique<DisplayManager>(std::make_unique<ScreenBase>());
        ...
        // with matching size.
        {
            ...
            const ManagedDisplayMode mode(gfx::Size(1920, 1080), 60.0, false /* interlaced */, true /* native */, 1.0 /* device_scale_factor */);
...

        {
            ...
            const ManagedDisplayMode mode(gfx::Size(800, 600), 60.0, false /* interlaced */, true /* native */, 1.0 /* device_scale_factor */);
            ManagedDisplayInfo::ManagedDisplayModeList modes(1, mode);
            display.SetManagedDisplayModes(modes);
            displays_.push_back(display);
        }
...

        {
            ...
            const ManagedDisplayMode mode(gfx::Size(1024, 768), 60.0, false /* interlaced */,
    ...
    bool AreAssociated(const ManagedDisplayInfo& info, const ui::TouchscreenDevice& device) const
    {
        test::TouchDeviceManagerTestApi tdm_api(touch_device_manager_);
...
TEST_F(TouchAssociationTest, NoTouchscreens)
{
    ...
    test::ScopedSetInternalDisplayId set_internal(display_manager(), displays_[0].id());
...
TEST_F(TouchAssociationTest, ManyTouchscreens)
{
    std::vector<ui::TouchscreenDevice> devices;
    for (int i = 0; i < 5; ++i) {
        devices.push_back(CreateTouchscreenDevice(i, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(256, 256)));
    }
...
{
    std::vector<ui::TouchscreenDevice> devices;
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(800, 600)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1024, 768)));
...
{
    std::vector<ui::TouchscreenDevice> devices;
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(801, 600)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1023, 768)));
...
{
    std::vector<ui::TouchscreenDevice> devices;
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1022, 768)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(802, 600)));

    DisplayInfoList displays;
    displays.push_back(displays_[0]);
    displays.push_back(displays_[1]);

    test::ScopedSetInternalDisplayId set_internal(display_manager(), displays[0].id());
    touch_device_manager()->AssociateTouchscreens(&displays, devices);
...
{
    std::vector<ui::TouchscreenDevice> devices;
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1920, 1080)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, gfx::Size(9999, 888)));
...
{
    std::vector<ui::TouchscreenDevice> devices;
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, gfx::Size(1920, 1080)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, gfx::Size(1920, 1080)));
...
TEST_F(TouchAssociationTest, MultipleInternalAndExternal)
{
    ...
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, gfx::Size(1920, 1080)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, gfx::Size(1920, 1080)));
    devices.push_back(CreateTouchscreenDevice(3, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1024, 768)));
...
{
    std::vector<ui::TouchscreenDevice> devices;
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(123, 456)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(234, 567)));
    devices.push_back(CreateTouchscreenDevice(3, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(345, 678)));
...
TEST_F(TouchAssociationTest, MatchRemainingDevicesWithNoInternalDisplayPresent)
{
    std::vector<ui::TouchscreenDevice> devices;
    devices.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(123, 456)));
    devices.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(234, 567)));
...
public:
    ...
    TouchAssociationFromPrefTest& operator=(const TouchAssociationFromPrefTest&) = delete;
    ...
    void SetUp() override
    {
        ...
        devices_.push_back(CreateTouchscreenDevice(1, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1920, 1080)));
        devices_.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1024, 768)));
        devices_.push_back(CreateTouchscreenDevice(3, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(640, 480)));
        devices_.push_back(CreateTouchscreenDevice(4, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, gfx::Size(800, 600)));

        // Create priority list for Device Id = 1
        //   - Display Index 0
        //   - Display Index 1
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[0])] = TouchDeviceManager::AssociationInfoMap();
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[0])][displays_[0].id()] = CreateTouchAssociationInfo(1);
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[0])][displays_[1].id()] = CreateTouchAssociationInfo(2);

        // Create priority list for Device Id = 2
        //   - Display Index 3
        //   - Display Index 1
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[1])] = TouchDeviceManager::AssociationInfoMap();
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[1])][displays_[3].id()] = CreateTouchAssociationInfo(1);
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[1])][displays_[1].id()] = CreateTouchAssociationInfo(2);

        // Create priority list for Device Id = 3
        //   - Display Index 2
        //   - Display Index 3
        //   - Display Index 0
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[2])] = TouchDeviceManager::AssociationInfoMap();
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[2])][displays_[2].id()] = CreateTouchAssociationInfo(1);
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[2])][displays_[3].id()] = CreateTouchAssociationInfo(2);
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[2])][displays_[0].id()] = CreateTouchAssociationInfo(3);

        touch_device_manager_->RegisterTouchAssociations(touch_associations, TouchDeviceManager::PortAssociationMap());
    }
...
{
    test::ScopedSetInternalDisplayId set_internal(display_manager(), displays_[1].id());
...
TEST_F(TouchAssociationFromPrefTest, UpdateMappingBeforeAssociation)
{
    ...
    touch_device_manager()->AddTouchCalibrationData(devices_[2], displays_[3].id(), TouchCalibrationData());
...
TEST_F(TouchAssociationFromPrefTest, AssociatingDeviceToNewDisplay)
{
    ...
    // Reassociate display with id 4 to touch device with id 3. This will
    // bring the display to the top of the priority list.
    touch_device_manager()->AddTouchCalibrationData(devices_[0], displays_[2].id(), TouchCalibrationData());
...
TEST_F(TouchAssociationFromPrefTest, AssociateDeviceWithNoCalibrationData)
{
    ...
    auto calibration_data = touch_device_manager()->GetCalibrationData(devices_[0]);
...
// not wiped out.
TEST_F(TouchAssociationFromPrefTest, AssociateDeviceWithPreviousCalibrationData)
{
    test::ScopedSetInternalDisplayId set_internal(display_manager(), displays_[1].id());
    touch_device_manager()->AddTouchCalibrationData(devices_[0], displays_[2].id(), TouchCalibrationData(/*point_pairs=*/ {}, /*bounds=*/gfx::Size(100, 200)));
    {
        auto test_calibration_data = touch_device_manager()->GetCalibrationData(devices_[0]);
...
TEST_F(TouchAssociationFromPrefTest, AssociatingDeviceToNewDisplayAfterAssociation)
{
    test::ScopedSetInternalDisplayId set_internal(display_manager(), displays_[1].id());
...
public:
    ...
    TouchAssociationWithDuplicateDeviceTest(const TouchAssociationWithDuplicateDeviceTest&) = delete;
    TouchAssociationWithDuplicateDeviceTest& operator=(const TouchAssociationWithDuplicateDeviceTest&) = delete;
    ...
    void SetUp() override
    {
        ...
        const std::vector<std::string> ports = { "port 0", "port 1", "port 2", "port 3", "port 4" };
        ...
        devices_.push_back(CreateTouchscreenDevice(2, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1920, 1080)));
        ...
        devices_.push_back(CreateTouchscreenDevice(3, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(1920, 1080)));
        devices_.back().name = device_name_1;
        ...
        devices_.push_back(CreateTouchscreenDevice(5, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(4096, 4096)));
        ...
        devices_.push_back(CreateTouchscreenDevice(6, ui::InputDeviceType::INPUT_DEVICE_USB, gfx::Size(4096, 4096)));
        devices_.back().name = device_name_2;
        ...
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[0])] = TouchDeviceManager::AssociationInfoMap();
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[0])][displays_[0].id()] = CreateTouchAssociationInfo(1);
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[0])][displays_[2].id()] = CreateTouchAssociationInfo(2);
        ...
        //   - Display Index 3
        //   - Display Index 2
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[4])] = TouchDeviceManager::AssociationInfoMap();
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[4])][displays_[3].id()] = CreateTouchAssociationInfo(1);
        touch_associations[TouchDeviceIdentifier::FromDevice(devices_[4])][displays_[2].id()] = CreateTouchAssociationInfo(2);
        ...
        port_associations[TouchDeviceIdentifier::FromDevice(devices_[0])] = displays_[2].id();
        port_associations[TouchDeviceIdentifier::FromDevice(devices_[1])] = displays_[3].id();
        port_associations[TouchDeviceIdentifier::FromDevice(devices_[2])] = displays_[2].id();
        port_associations[TouchDeviceIdentifier::FromDevice(devices_[4])] = displays_[0].id();

        touch_device_manager_->RegisterTouchAssociations(touch_associations, port_associations);
    }
