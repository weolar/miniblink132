...
public:
    ...
    gfx::NativeWindow GetLocalProcessWindowAtPoint(const gfx::Point& screen_point, const std::set<gfx::NativeWindow>& ignore) override;
    ...
    void SetPanelRotationForTesting(int64_t display_id, Display::Rotation rotation) override;
