...
class VirtualDisplayUtilMac : public VirtualDisplayUtil, public display::DisplayObserver {
public:
...
private:
    ...
    int64_t AddDisplay(int64_t serial_number, const DisplayParams& display_params);
