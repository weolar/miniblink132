...
public:
    static void DisplayToScreenInfo(display::ScreenInfo* screen_info, const display::Display& display);

    static void GetNativeViewScreenInfo(display::ScreenInfo* screen_info, gfx::NativeView native_view);
    ...
    static display::mojom::ScreenOrientation GetOrientationTypeForMobile(const display::Display& display);

    // Compute the orientation type of the display assuming it is a desktop.
    static display::mojom::ScreenOrientation GetOrientationTypeForDesktop(const display::Display& display);
