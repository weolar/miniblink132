...
public:
    ...
    // changed_metrics.
    virtual void OnDisplayMetricsChanged(const Display& display, uint32_t changed_metrics)
    {
    }
...
class DISPLAY_EXPORT ScopedDisplayObserver : public ScopedOptionalDisplayObserver {
public:
