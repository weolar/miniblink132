...
gfx::NativeWindow ScreenBase::GetLocalProcessWindowAtPoint(const gfx::Point& screen_point, const std::set<gfx::NativeWindow>& ignore)
{
    NOTIMPLEMENTED_LOG_ONCE();
    return gfx::NativeWindow();
}
...
void ScreenBase::SetPanelRotationForTesting(int64_t display_id, Display::Rotation rotation)
{
...
void ScreenBase::ProcessDisplayChanged(const Display& changed_display, bool is_primary)
{
