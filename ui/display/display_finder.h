...
DISPLAY_EXPORT const Display* FindDisplayNearestPoint(const std::vector<Display>& displays, const gfx::Point& point);
...
DISPLAY_EXPORT const Display* FindDisplayWithBiggestIntersection(const std::vector<Display>& displays, const gfx::Rect& rect);
...
// |point_in_screen|.
DISPLAY_EXPORT std::vector<Display>::const_iterator FindDisplayContainingPoint(const std::vector<Display>& displays, const gfx::Point& point_in_screen);
