...
base::Value BuildGpuInfoEntry(std::string_view description, std::string_view value);
base::Value::Dict BuildGpuInfoEntry(std::string_view description, base::Value value);
