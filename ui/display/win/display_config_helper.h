...
DISPLAY_EXPORT std::optional<DISPLAYCONFIG_PATH_INFO> GetDisplayConfigPathInfo(HMONITOR monitor);
...
DISPLAY_EXPORT UINT16 GetDisplayManufacturerId(const std::optional<DISPLAYCONFIG_PATH_INFO>& path);
...
DISPLAY_EXPORT UINT16 GetDisplayProductCode(const std::optional<DISPLAYCONFIG_PATH_INFO>& path);
