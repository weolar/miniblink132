...
DISPLAY_EXPORT bool DisplayInfosTouch(const internal::DisplayInfo& a, const internal::DisplayInfo& b);
...
// |        |        |
// +--------+--------+
DISPLAY_EXPORT DisplayPlacement CalculateDisplayPlacement(const internal::DisplayInfo& parent, const internal::DisplayInfo& current);
...
DISPLAY_EXPORT int64_t SquaredDistanceBetweenRects(const gfx::Rect& ref, const gfx::Rect& rect);
