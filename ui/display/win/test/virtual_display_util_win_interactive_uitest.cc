...
public:
    VirtualDisplayUtilWinInteractiveUitest(const VirtualDisplayUtilWinInteractiveUitest&) = delete;
    VirtualDisplayUtilWinInteractiveUitest& operator=(const VirtualDisplayUtilWinInteractiveUitest&) = delete;
...
TEST_F(VirtualDisplayUtilWinInteractiveUitest, DISABLED_AddRemove)
{
    ...
    display_id[0] = virtual_display_util_win_.AddDisplay(display::test::VirtualDisplayUtilWin::k1920x1080);
    ...
    display_id[1] = virtual_display_util_win_.AddDisplay(display::test::VirtualDisplayUtilWin::k1024x768);
    ...
    display_id[2] = virtual_display_util_win_.AddDisplay(display::test::VirtualDisplayUtilWin::k1920x1080);
