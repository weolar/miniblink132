...
public:
    ...
    DisplayLayoutBuilder& AddDisplayPlacement(int64_t display_id, int64_t parent_id, DisplayPlacement::Position position, int offset);
    ...
    DisplayLayoutBuilder& SetSecondaryPlacement(int64_t secondary_id, DisplayPlacement::Position position, int offset);
