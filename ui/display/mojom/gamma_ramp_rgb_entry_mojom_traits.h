...
template <> struct StructTraits<display::mojom::GammaRampRGBEntryDataView, display::GammaRampRGBEntry> {
    ...
    static bool Read(display::mojom::GammaRampRGBEntryDataView data, display::GammaRampRGBEntry* out);
};
