...
display::mojom::DisplayConnectionType EnumTraits<display::mojom::DisplayConnectionType, display::DisplayConnectionType>::ToMojom(
    display::DisplayConnectionType type)
{
    ...
    case display::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_INTERNAL:
        return display::mojom::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_INTERNAL;
    ...
    case display::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_HDMI:
        return display::mojom::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_HDMI;
    ...
    case display::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_NETWORK:
        return display::mojom::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_NETWORK;
    }
    NOTREACHED();
}

bool EnumTraits<display::mojom::DisplayConnectionType, display::DisplayConnectionType>::FromMojom(
    display::mojom::DisplayConnectionType type, display::DisplayConnectionType* out)
{
    switch (type) {
    ...
    case display::mojom::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_UNKNOWN:
        *out = display::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_UNKNOWN;
        return true;
    case display::mojom::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_INTERNAL:
    ...
    case display::mojom::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_DVI:
        *out = display::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_DVI;
        return true;
    case display::mojom::DisplayConnectionType::DISPLAY_CONNECTION_TYPE_DISPLAYPORT:
...
// static
display::mojom::HDCPState EnumTraits<display::mojom::HDCPState, display::HDCPState>::ToMojom(display::HDCPState type)
{
    switch (type) {
...
// static
bool EnumTraits<display::mojom::HDCPState, display::HDCPState>::FromMojom(display::mojom::HDCPState type, display::HDCPState* out)
{
    switch (type) {
...
// static
display::mojom::ContentProtectionMethod EnumTraits<display::mojom::ContentProtectionMethod, display::ContentProtectionMethod>::ToMojom(
    display::ContentProtectionMethod type)
{
    switch (type) {
    case display::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_NONE:
        return display::mojom::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_NONE;
    case display::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_0:
        return display::mojom::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_0;
    case display::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_1:
        return display::mojom::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_1;
    }
    NOTREACHED();
}

// static
bool EnumTraits<display::mojom::ContentProtectionMethod, display::ContentProtectionMethod>::FromMojom(
    display::mojom::ContentProtectionMethod type, display::ContentProtectionMethod* out)
{
    switch (type) {
    case display::mojom::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_NONE:
        *out = display::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_NONE;
        return true;
    case display::mojom::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_0:
        *out = display::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_0;
        return true;
    case display::mojom::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_1:
        *out = display::ContentProtectionMethod::CONTENT_PROTECTION_METHOD_HDCP_TYPE_1;
        return true;
    }
    return false;
}
...
// static
display::mojom::PanelOrientation EnumTraits<display::mojom::PanelOrientation, display::PanelOrientation>::ToMojom(display::PanelOrientation rotation)
{
    switch (rotation) {
...
// static
bool EnumTraits<display::mojom::PanelOrientation, display::PanelOrientation>::FromMojom(
    display::mojom::PanelOrientation rotation, display::PanelOrientation* out)
{
    switch (rotation) {
...
// static
display::mojom::PrivacyScreenState EnumTraits<display::mojom::PrivacyScreenState, display::PrivacyScreenState>::ToMojom(display::PrivacyScreenState state)
{
    switch (state) {
...
// static
bool EnumTraits<display::mojom::PrivacyScreenState, display::PrivacyScreenState>::FromMojom(
    display::mojom::PrivacyScreenState state, display::PrivacyScreenState* out)
{
    switch (state) {
...
// static
display::mojom::VariableRefreshRateState EnumTraits<display::mojom::VariableRefreshRateState, display::VariableRefreshRateState>::ToMojom(
    display::VariableRefreshRateState state)
{
    switch (state) {
...
// static
bool EnumTraits<display::mojom::VariableRefreshRateState, display::VariableRefreshRateState>::FromMojom(
    display::mojom::VariableRefreshRateState state, display::VariableRefreshRateState* out)
{
    switch (state) {
...
// static
bool StructTraits<display::mojom::ModesetFlagsDataView, display::ModesetFlags>::Read(
    display::mojom::ModesetFlagsDataView data, display::ModesetFlags* out_flags)
{
