...
template <> struct COMPONENT_EXPORT(DISPLAY_SHARED_MOJOM_TRAITS) StructTraits<display::mojom::ScreenInfoDataView, display::ScreenInfo> {
    static float device_scale_factor(const display::ScreenInfo& r)
    {
        return r.device_scale_factor;
    }

    static const gfx::DisplayColorSpaces& display_color_spaces(const display::ScreenInfo& r)
    {
        return r.display_color_spaces;
    }

    static int depth(const display::ScreenInfo& r)
    {
        return r.depth;
    }
    ...
    static const gfx::Rect& rect(const display::ScreenInfo& r)
    {
        return r.rect;
    }
    ...
    static display::mojom::ScreenOrientation orientation_type(const display::ScreenInfo& r)
    {
    ...
    static bool is_primary(const display::ScreenInfo& r)
    {
        return r.is_primary;
    }
    ...
    static bool Read(display::mojom::ScreenInfoDataView r, display::ScreenInfo* out);
};
