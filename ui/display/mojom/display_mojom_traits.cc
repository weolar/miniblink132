...
display::mojom::Rotation EnumTraits<display::mojom::Rotation, display::Display::Rotation>::ToMojom(display::Display::Rotation rotation)
{
    switch (rotation) {
...
bool EnumTraits<display::mojom::Rotation, display::Display::Rotation>::FromMojom(display::mojom::Rotation rotation, display::Display::Rotation* out)
{
    switch (rotation) {
...
display::mojom::TouchSupport EnumTraits<display::mojom::TouchSupport, display::Display::TouchSupport>::ToMojom(display::Display::TouchSupport touch_support)
{
...
bool EnumTraits<display::mojom::TouchSupport, display::Display::TouchSupport>::FromMojom(
    display::mojom::TouchSupport touch_support, display::Display::TouchSupport* out)
{
    switch (touch_support) {
...
display::mojom::AccelerometerSupport EnumTraits<display::mojom::AccelerometerSupport, display::Display::AccelerometerSupport>::ToMojom(
...
bool EnumTraits<display::mojom::AccelerometerSupport, display::Display::AccelerometerSupport>::FromMojom(
    display::mojom::AccelerometerSupport accelerometer_support, display::Display::AccelerometerSupport* out)
{
    switch (accelerometer_support) {
...
bool StructTraits<display::mojom::DisplayDataView, display::Display>::Read(display::mojom::DisplayDataView data, display::Display* out)
{
    out->set_id(data.id());
