...
display::mojom::Position EnumTraits<display::mojom::Position, display::DisplayPlacement::Position>::ToMojom(display::DisplayPlacement::Position rotation)
{
    switch (rotation) {
...
bool EnumTraits<display::mojom::Position, display::DisplayPlacement::Position>::FromMojom(
    display::mojom::Position rotation, display::DisplayPlacement::Position* out)
{
    switch (rotation) {
...
display::mojom::OffsetReference EnumTraits<display::mojom::OffsetReference, display::DisplayPlacement::OffsetReference>::ToMojom(
    display::DisplayPlacement::OffsetReference rotation)
{
    switch (rotation) {
...
bool EnumTraits<display::mojom::OffsetReference, display::DisplayPlacement::OffsetReference>::FromMojom(
    display::mojom::OffsetReference rotation, display::DisplayPlacement::OffsetReference* out)
{
    switch (rotation) {
...
bool StructTraits<display::mojom::DisplayPlacementDataView, display::DisplayPlacement>::Read(
    display::mojom::DisplayPlacementDataView data, display::DisplayPlacement* out)
{
...
bool StructTraits<display::mojom::DisplayLayoutDataView, std::unique_ptr<display::DisplayLayout>>::Read(
    display::mojom::DisplayLayoutDataView data, std::unique_ptr<display::DisplayLayout>* out)
{
