...
public:
    ...
    void OnDisplayMetricsChanged(const Display& display, uint32_t metrics) override
    {
        display_changed_++;
...
TEST(DisplayChangeNotifierTest, AddObserver_Smoke)
{
    ...
    change_notifier.NotifyDisplaysChanged(std::vector<Display>(), std::vector<Display>(1, Display()));
...
TEST(DisplayChangeNotifierTest, NotifyDisplaysChanged_Changed_Bounds)
{
...

    {
        ...
        uint32_t metrics_change = DisplayObserver::DISPLAY_METRIC_BOUNDS | DisplayObserver::DISPLAY_METRIC_WORK_AREA;
...

    {
        ...
        change_notifier.NotifyDisplaysChanged(old_displays, new_displays);
        EXPECT_EQ(1, observer.display_changed());
        EXPECT_EQ(static_cast<uint32_t>(DisplayObserver::DISPLAY_METRIC_BOUNDS), observer.latest_metrics_change());
...
TEST(DisplayChangeNotifierTest, NotifyDisplaysChanged_Changed_Rotation)
{
    ...
    change_notifier.NotifyDisplaysChanged(old_displays, new_displays);
    EXPECT_EQ(1, observer.display_changed());
    EXPECT_EQ(static_cast<uint32_t>(DisplayObserver::DISPLAY_METRIC_ROTATION), observer.latest_metrics_change());
}
...
TEST(DisplayChangeNotifierTest, NotifyDisplaysChanged_Changed_WorkArea)
{
    ...
    change_notifier.NotifyDisplaysChanged(old_displays, new_displays);
    EXPECT_EQ(1, observer.display_changed());
    EXPECT_EQ(static_cast<uint32_t>(DisplayObserver::DISPLAY_METRIC_WORK_AREA), observer.latest_metrics_change());
}
...
TEST(DisplayChangeNotifierTest, NotifyDisplaysChanged_Changed_DSF)
{
    ...
    change_notifier.NotifyDisplaysChanged(old_displays, new_displays);
    EXPECT_EQ(1, observer.display_changed());
    EXPECT_EQ(static_cast<uint32_t>(DisplayObserver::DISPLAY_METRIC_DEVICE_SCALE_FACTOR), observer.latest_metrics_change());
}
...
TEST(DisplayChangeNotifierTest, NotifyDisplaysChanged_Changed_Multi_Metrics)
{
    ...
    change_notifier.NotifyDisplaysChanged(old_displays, new_displays);
    EXPECT_EQ(1, observer.display_changed());
    uint32_t metrics = DisplayObserver::DISPLAY_METRIC_BOUNDS | DisplayObserver::DISPLAY_METRIC_ROTATION | DisplayObserver::DISPLAY_METRIC_WORK_AREA
