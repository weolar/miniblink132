...
DisplayLayoutBuilder& DisplayLayoutBuilder::SetDefaultUnified(bool default_unified)
{
...
DisplayLayoutBuilder& DisplayLayoutBuilder::AddDisplayPlacement(int64_t display_id, int64_t parent_display_id, DisplayPlacement::Position position, int offset)
{
...
DisplayLayoutBuilder& DisplayLayoutBuilder::AddDisplayPlacement(const DisplayPlacement& placement)
{
    layout_->placement_list.push_back(placement);
    return *this;
}

DisplayLayoutBuilder& DisplayLayoutBuilder::SetSecondaryPlacement(int64_t secondary_id, DisplayPlacement::Position position, int offset)
{
    layout_->placement_list.clear();
...
std::unique_ptr<DisplayLayout> DisplayLayoutBuilder::Build()
{
    std::sort(layout_->placement_list.begin(), layout_->placement_list.end(),
        [](const DisplayPlacement& a, const DisplayPlacement& b) { return CompareDisplayIds(a.display_id, b.display_id); });
