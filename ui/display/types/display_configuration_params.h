...
struct DISPLAY_TYPES_EXPORT DisplayConfigurationParams {
    ...
    DisplayConfigurationParams(int64_t id, const gfx::Point& origin, const display::DisplayMode* pmode, bool enable_vrr = false);

    DisplayConfigurationParams& operator=(const DisplayConfigurationParams& other);
