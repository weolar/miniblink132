...
public:
    DisplayMode(const gfx::Size& size, bool interlaced, float refresh_rate, const std::optional<float>& vsync_rate_min);
...
private:
    friend struct mojo::StructTraits<display::mojom::DisplayModeDataView, std::unique_ptr<DisplayMode>>;
