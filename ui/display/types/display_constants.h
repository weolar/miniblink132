...
constexpr uint32_t kContentProtectionMethodHdcpAll = CONTENT_PROTECTION_METHOD_HDCP_TYPE_0 | CONTENT_PROTECTION_METHOD_HDCP_TYPE_1;
...
enum PanelOrientation { kNormal = 0, kBottomUp = 1, kLeftUp = 2, kRightUp = 3, kLast = kRightUp };
...
using ModesetFlags = base::EnumSet<ModesetFlag, ModesetFlag::kMinValue, ModesetFlag::kMaxValue>;
...
using ZoomListBucketDsf = std::pair<float, std::array<float, kNumOfZoomFactors>>;
...
constexpr std::array<ZoomListBucketDsf, 9> kZoomListBucketsForDsf { {
    ...
    { kDsf_1_777, { 1.f / kDsf_1_777, 0.65f, 0.75f, 0.8f, 0.9f, 1.f, 1.1f, 1.2f, 1.3f } },
    { kDsf_1_8, { 1.f / kDsf_1_8, 0.65f, 0.75f, 0.8f, 0.9f, 1.f, 1.1f, 1.2f, 1.3f } },
    { 2.f, { 1.f / 2.f, 0.6f, 0.7f, 0.8f, 0.9f, 1.f, 1.1f, 1.25f, 1.5f } },
    { kDsf_2_252, { 1.f / kDsf_2_252, 0.6f, 0.7f, 0.8f, 0.9f, 1.f, 1.15f, 1.3f, 1.5f } },
    { 2.4f, { 1.f / 2.4f, 0.5f, 0.6f, 0.8f, 0.9f, 1.f, 1.2f, 1.35f, 1.5f } },
    { kDsf_2_666, { 1.f / kDsf_2_666, 0.5f, 0.6f, 0.8f, 0.9f, 1.f, 1.2f, 1.35f, 1.5f } },
} };
...
constexpr struct Data {
    ...
    { 9.7f, kQXGA_P, 2.0f, { 768, 1024 }, false, kExact }, { 10.f, kWXGA_800, 1.25f, { 1024, 640 }, false, kExact },
    { 10.1f, kWXGA_800, 1.f, kWXGA_800, false, kExact }, { 10.1f, kFHD, 1.6, { 1200, 675 }, true, kExact },
    { 10.1f, kWUXGA, kDsf_1_777, { 1080, 675 }, false, kExact }, { 10.5f, kWUXGA, 1.6f, { 1200, 750 }, true, kExact },
    { 11.6f, kWXGA_768, 1.f, kWXGA_768, false, kExact }, { 11.6f, kSHD, 1.f, kSHD, false, kExact }, { 11.6f, kFHD, 1.6f, { 1200, 675 }, false, kExact },
    { 12.f, kFHD, 1.6f, { 1200, 675 }, false, kExact }, { 12.1f, kWXGA_800, 1.f, kWXGA_800, true, kExact },
    { 12.2f, kWUXGA, 1.6f, { 1200, 750 }, false, kExact }, { 12.2f, kFHD, 1.6f, { 1200, 675 }, false, kExact },
    { 12.3f, kQHD, 2.f, { 1280, 720 }, false, kExact }, { 13.0f, kFHD, 1.25f, { 1536, 864 }, true, kExact },
    { 13.1f, k4K_UHD, kDsf_2_666, { 1440, 810 }, false, kExact }, { 13.3f, kWXGA_768, 1.f, kWXGA_768, true, kExact },
    { 13.3f, kFHD, 1.25f, { 1536, 864 }, true, kExact }, { 13.3f, k4K_UHD, kDsf_2_666, { 1440, 810 }, false, kExact },
    { 13.5f, kFHD, 1.25f, { 1536, 864 }, false, kExact }, { 14.f, kWXGA_768, 1.f, kWXGA_768, true, kExact },
    { 14.f, kFHD, 1.25f, { 1536, 864 }, false, kExact }, { 14.f, kWUXGA, 1.25f, { 1536, 960 }, false, kExact },
    { 14.f, k4K_UHD, kDsf_2_666, { 1440, 810 }, false, kExact }, { 15.6f, kWXGA_768, 1.f, kWXGA_768, true, kExact },
    { 15.6f, kWUXGA, 1.f, kWUXGA, false, kExact }, { 15.6f, kFHD, 1.f, kFHD, false, kExact }, { 15.6f, k4K_UHD, 2.4f, { 1600, 900 }, false, kEpsilon },
    { 17.f, kHD_PLUS, 1.f, kHD_PLUS, true, kExact }, { 17.f, kFHD, 1.0f, { 1920, 1080 }, false, kExact }, { 17.3f, kFHD, 1.0f, { 1920, 1080 }, false, kExact },
    { 18.51f, kWXGA_768, 1.0f, kWXGA_768, true, kExact },

    // Non standard panels
    { 11.0f, kLux, kDsf_1_8, { 1200, 800 }, false, kExact }, { 12.f, { 1366, 912 }, 1.f, { 1366, 912 }, false, kExact },
    { 12.3f, kEveDisplay, 2.0f, { 1200, 800 }, false, kExact }, { 12.85f, kLink, 2.0f, { 1280, 850 }, false, kExact },
    { 12.3f, kNocturne, kDsf_2_252, { 1332, 888 }, false, kEpsilon }, { 13.3f, kQHD_PLUS, 2.f, { 1600, 900 }, false, kExact },
    { 13.3f, kAkaliQHD, 1.6f, { 1410, 940 }, false, kExact }, { 13.6f, kAkaliQHD, 1.6f, { 1410, 940 }, false, kExact },

    // Chromebase
    { 19.5, kHD_PLUS, 1.f, kHD_PLUS, true, kExact }, { 21.5f, kFHD, 1.f, kFHD, true, kExact }, { 23.8f, kFHD, 1.f, kFHD, true, kExact },
...
DISPLAY_TYPES_EXPORT std::string DisplayConnectionTypeString(DisplayConnectionType type);
