...
public:
    VirtualDisplayUtilLinuxInteractiveUitest(const VirtualDisplayUtilLinuxInteractiveUitest&) = delete;
    VirtualDisplayUtilLinuxInteractiveUitest& operator=(const VirtualDisplayUtilLinuxInteractiveUitest&) = delete;
...
protected:
    ...
    void SetUp() override
    {
        ...
        virtual_display_util_ = std::make_unique<display::test::VirtualDisplayUtilLinux>(screen());
        testing::Test::SetUp();
    }
...
TEST_F(VirtualDisplayUtilLinuxInteractiveUitest, AddRemove)
{
    ...
    display_id[0] = virtual_display_util_->AddDisplay(display::test::VirtualDisplayUtilLinux::k1920x1080);
    ...
    display_id[1] = virtual_display_util_->AddDisplay(display::test::VirtualDisplayUtilLinux::k1024x768);
    ...
    display_id[2] = virtual_display_util_->AddDisplay(display::test::VirtualDisplayUtilLinux::k1920x1080);
