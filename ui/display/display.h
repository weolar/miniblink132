...
public:
    ...
    void set_panel_rotation(Rotation rotation)
    {
        panel_rotation_ = rotation;
    }
    ...
    const gfx::Size& work_area_size() const
    {
    ...
    void SetScaleAndBounds(float device_scale_factor, const gfx::Rect& bounds_in_pixel);
    ...
    void set_size_in_pixels(const gfx::Size& size)
    {
...
private:
    ...
    class DisplayColorSpacesRef : public base::RefCountedThreadSafe<DisplayColorSpacesRef> {
    public:
    ...
    void SetDisplayColorSpacesRef(scoped_refptr<const DisplayColorSpacesRef> color_spaces);

    // Returns the default value of the DisplayColorSpaces.
    static scoped_refptr<const DisplayColorSpacesRef> GetDefaultDisplayColorSpacesRef();
