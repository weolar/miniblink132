...
//
///////////////////////////////////////////////////////////////////////////////
class COMPONENT_EXPORT(GFX) InterpolatedRotation : public InterpolatedTransform {
public:
    InterpolatedRotation(float start_degrees, float end_degrees);
    InterpolatedRotation(float start_degrees, float end_degrees, float start_time, float end_time);
...
//
///////////////////////////////////////////////////////////////////////////////
class COMPONENT_EXPORT(GFX) InterpolatedAxisAngleRotation : public InterpolatedTransform {
public:
    InterpolatedAxisAngleRotation(const gfx::Vector3dF& axis, float start_degrees, float end_degrees);
    InterpolatedAxisAngleRotation(const gfx::Vector3dF& axis, float start_degrees, float end_degrees, float start_time, float end_time);

    InterpolatedAxisAngleRotation(const InterpolatedAxisAngleRotation&) = delete;
    InterpolatedAxisAngleRotation& operator=(const InterpolatedAxisAngleRotation&) = delete;
...
public:
    ...
    InterpolatedScale(float start_scale, float end_scale, float start_time, float end_time);
    InterpolatedScale(const gfx::Point3F& start_scale, const gfx::Point3F& end_scale);
    InterpolatedScale(const gfx::Point3F& start_scale, const gfx::Point3F& end_scale, float start_time, float end_time);
...
class COMPONENT_EXPORT(GFX) InterpolatedTranslation : public InterpolatedTransform {
public:
    InterpolatedTranslation(const gfx::PointF& start_pos, const gfx::PointF& end_pos);
    InterpolatedTranslation(const gfx::PointF& start_pos, const gfx::PointF& end_pos, float start_time, float end_time);
    InterpolatedTranslation(const gfx::Point3F& start_pos, const gfx::Point3F& end_pos);
    InterpolatedTranslation(const gfx::Point3F& start_pos, const gfx::Point3F& end_pos, float start_time, float end_time);
...
//
///////////////////////////////////////////////////////////////////////////////
class COMPONENT_EXPORT(GFX) InterpolatedConstantTransform : public InterpolatedTransform {
public:
    ...
    InterpolatedConstantTransform& operator=(const InterpolatedConstantTransform&) = delete;
...
//
///////////////////////////////////////////////////////////////////////////////
class COMPONENT_EXPORT(GFX) InterpolatedTransformAboutPivot : public InterpolatedTransform {
public:
    // Takes ownership of the passed transform.
    InterpolatedTransformAboutPivot(const gfx::Point& pivot, std::unique_ptr<InterpolatedTransform> transform);

    // Takes ownership of the passed transform.
    InterpolatedTransformAboutPivot(const gfx::Point& pivot, std::unique_ptr<InterpolatedTransform> transform, float start_time, float end_time);

    InterpolatedTransformAboutPivot(const InterpolatedTransformAboutPivot&) = delete;
    InterpolatedTransformAboutPivot& operator=(const InterpolatedTransformAboutPivot&) = delete;
...
private:
    void Init(const gfx::Point& pivot, std::unique_ptr<InterpolatedTransform> transform);

    std::unique_ptr<InterpolatedTransform> transform_;
};

class COMPONENT_EXPORT(GFX) InterpolatedMatrixTransform : public InterpolatedTransform {
public:
    InterpolatedMatrixTransform(const gfx::Transform& start_transform, const gfx::Transform& end_transform);

    InterpolatedMatrixTransform(const gfx::Transform& start_transform, const gfx::Transform& end_transform, float start_time, float end_time);
...
private:
    void Init(const gfx::Transform& start_transform, const gfx::Transform& end_transform);
