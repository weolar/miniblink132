...
public:
    ...
    static SkBitmap CreateBlendedBitmap(const SkBitmap& first, const SkBitmap& second, double alpha);
    ...
    static SkBitmap CreateMaskedBitmap(const SkBitmap& first, const SkBitmap& alpha);
    ...
    static SkBitmap CreateButtonBackground(SkColor color, const SkBitmap& image, const SkBitmap& mask);
    ...
    static SkBitmap CreateHSLShiftedBitmap(const SkBitmap& bitmap, const color_utils::HSL& hsl_shift);
    ...
    static SkBitmap CreateTiledBitmap(const SkBitmap& bitmap, int src_x, int src_y, int dst_w, int dst_h);
    ...
    static SkBitmap DownsampleByTwoUntilSize(const SkBitmap& bitmap, int min_w, int min_h);
    ...
    static SkBitmap CreateDropShadow(const SkBitmap& bitmap, const gfx::ShadowValues& shadows);
