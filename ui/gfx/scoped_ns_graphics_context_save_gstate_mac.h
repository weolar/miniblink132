...
public:
    ...
    ScopedNSGraphicsContextSaveGState(const ScopedNSGraphicsContextSaveGState&) = delete;
    ScopedNSGraphicsContextSaveGState& operator=(const ScopedNSGraphicsContextSaveGState&) = delete;
