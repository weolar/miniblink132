...
// static
SkPixelGeometry FontRenderParams::SubpixelRenderingToSkiaPixelGeometry(FontRenderParams::SubpixelRendering subpixel_rendering)
{
...
FontRenderParamsQuery::FontRenderParamsQuery(const FontRenderParamsQuery& other) = default;
