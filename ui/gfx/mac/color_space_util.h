...
COLOR_SPACE_EXPORT bool ColorSpaceToCVImageBufferKeys(
    const gfx::ColorSpace& color_space, bool prefer_srgb_trfn, CFStringRef* out_primaries, CFStringRef* out_transfer, CFStringRef* out_matrix);

// Converts individual kCVImageBuffer keys to a gfx::ColorSpace.
COLOR_SPACE_EXPORT gfx::ColorSpace ColorSpaceFromCVImageBufferKeys(CFTypeRef primaries, CFTypeRef transfer, CFTypeRef gamma, CFTypeRef matrix);
