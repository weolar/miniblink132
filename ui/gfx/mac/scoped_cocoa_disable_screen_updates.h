...
public:
    ...
    ScopedCocoaDisableScreenUpdates(const ScopedCocoaDisableScreenUpdates&) = delete;
    ScopedCocoaDisableScreenUpdates& operator=(const ScopedCocoaDisableScreenUpdates&) = delete;
