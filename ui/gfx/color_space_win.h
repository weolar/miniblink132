...
public:
    ...
    static DXGI_COLOR_SPACE_TYPE GetDXGIColorSpace(const ColorSpace& color_space, bool force_yuv = false);
    ...
    static D3D11_VIDEO_PROCESSOR_COLOR_SPACE GetD3D11ColorSpace(const ColorSpace& color_space);
};
