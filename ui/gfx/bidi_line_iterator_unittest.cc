...
class BiDiLineIteratorTest : public testing::TestWithParam<base::i18n::TextDirection> {
public:
...
TEST_P(BiDiLineIteratorTest, RTLPunctuationNoCustomBehavior)
{
    ...
    iterator()->Open(u"א!ב\"ג#ד$ה%ו&ז'ח(ט)י*ך+כ,ל-ם.מ/"
...
INSTANTIATE_TEST_SUITE_P(All, BiDiLineIteratorTest, ::testing::Values(base::i18n::TextDirection::LEFT_TO_RIGHT, base::i18n::TextDirection::RIGHT_TO_LEFT));
