...
TEST(TweenTest, ColorValueBetween)
{
    ...
    EXPECT_SKCOLOR_EQ(0xFF00FF00, Tween::ColorValueBetween(-10.0, 0xFF00FF00, 0xFF00FF00));
    EXPECT_SKCOLOR_EQ(0xFF00FF00, Tween::ColorValueBetween(-10.0, 0xFF00FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0xFF00FF00, Tween::ColorValueBetween(0.0, 0xFF00FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0xFF01FE01, Tween::ColorValueBetween(1.0 / 255, 0xFF00FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0xFF808080, Tween::ColorValueBetween(0.5, 0xFF00FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0xFFFE01FE, Tween::ColorValueBetween(254.0 / 255.0, 0xFF00FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0xFFFF00FF, Tween::ColorValueBetween(1.0, 0xFF00FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0xFFFF00FF, Tween::ColorValueBetween(10.0, 0xFF00FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0xFF0C253E, Tween::ColorValueBetween(3.0 / 16.0, 0xFF001020, 0xFF4080C0));
    EXPECT_SKCOLOR_EQ(0x80FF00FF, Tween::ColorValueBetween(0.5, 0x0000FF00, 0xFFFF00FF));
    EXPECT_SKCOLOR_EQ(0x60AA55AA, Tween::ColorValueBetween(0.5, 0x4000FF00, 0x80FF00FF));
    EXPECT_SKCOLOR_EQ(0x60FFAAFF, Tween::ColorValueBetween(0.5, 0x40FF00FF, 0x80FFFFFF));
    EXPECT_SKCOLOR_EQ(0x103060A0, Tween::ColorValueBetween(0.5, 0x10204080, 0x104080C0));
}
...
TEST(TweenTest, SizeValueBetween)
{
    ...
    EXPECT_EQ(gfx::Size(24, 36), Tween::SizeValueBetween(kBetween, kSize1, kSize2));
...
TEST(TweenTest, SizeFValueBetween)
{
    ...
    EXPECT_SIZEF_EQ(gfx::SizeF(9.0f, 21.0f), Tween::SizeFValueBetween(kBefore, s1, s2));
    EXPECT_SIZEF_EQ(s1, Tween::SizeFValueBetween(kFrom, s1, s2));
    EXPECT_SIZEF_EQ(gfx::SizeF(24.0f, 36.0f), Tween::SizeFValueBetween(kBetween, s1, s2));
    EXPECT_SIZEF_EQ(s2, Tween::SizeFValueBetween(kTo, s1, s2));
    EXPECT_SIZEF_EQ(gfx::SizeF(39.0f, 51.0f), Tween::SizeFValueBetween(kAfter, s1, s2));
}
