...
public:
    ...
    enum class RichAnimationRenderMode { PLATFORM, FORCE_ENABLED, FORCE_DISABLED };
    ...
    gfx::Rect CurrentValueBetween(const gfx::Rect& start_bounds, const gfx::Rect& target_bounds) const;
