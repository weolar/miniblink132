...
TEST_F(SlideAnimationTest, AnimationWithPartialProgressAndDefaultDampeningFactor)
{
    slide_animation()->SetTweenType(Tween::LINEAR);
    slide_animation()->SetSlideDuration(base::Milliseconds(100));
    slide_animation()->Show();
...
TEST_F(SlideAnimationTest, AnimationWithPartialProgressAndNonDefaultDampeningFactor)
{
    slide_animation()->SetTweenType(Tween::LINEAR);
