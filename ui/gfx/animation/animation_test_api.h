...
public:
    using RenderModeResetter = std::unique_ptr<base::AutoReset<Animation::RichAnimationRenderMode>>;
    ...
    [[nodiscard]] static RenderModeResetter SetRichAnimationRenderMode(Animation::RichAnimationRenderMode mode);
...
public:
    ...
    AnimationContainerTestApi& operator=(const AnimationContainerTestApi&) = delete;
