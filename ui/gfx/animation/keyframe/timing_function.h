...
class GFX_KEYFRAME_ANIMATION_EXPORT CubicBezierTimingFunction : public TimingFunction {
public:
    ...
    EaseType ease_type() const
    {
        return ease_type_;
    }
    const gfx::CubicBezier& bezier() const
    {
        return bezier_;
    }
...
class GFX_KEYFRAME_ANIMATION_EXPORT StepsTimingFunction : public TimingFunction {
public:
    ...
    StepPosition step_position() const
    {
...
class GFX_KEYFRAME_ANIMATION_EXPORT LinearTimingFunction : public TimingFunction {
public:
    ...
    const LinearEasingPoint& Point(size_t i) const
    {
        return points_[i];
    }
    const std::vector<LinearEasingPoint>& Points() const
    {
        return points_;
    }
