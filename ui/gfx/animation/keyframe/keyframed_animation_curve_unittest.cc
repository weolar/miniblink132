...
void ExpectTranslateX(SkScalar translate_x, const gfx::TransformOperations& operations)
{
...
TEST(KeyframedAnimationCurveTest, OneColorKeyFrame)
{
    ...
    std::unique_ptr<KeyframedColorAnimationCurve> curve(KeyframedColorAnimationCurve::Create());
...
TEST(KeyframedAnimationCurveTest, TwoColorKeyFrame)
{
    ...
    std::unique_ptr<KeyframedColorAnimationCurve> curve(KeyframedColorAnimationCurve::Create());
    curve->AddKeyframe(ColorKeyframe::Create(base::TimeDelta(), color_a, nullptr));
    curve->AddKeyframe(ColorKeyframe::Create(base::Seconds(1.0), color_b, nullptr));
...
TEST(KeyframedAnimationCurveTest, ThreeColorKeyFrame)
{
    ...
    curve->AddKeyframe(ColorKeyframe::Create(base::TimeDelta(), color_a, nullptr));
    curve->AddKeyframe(ColorKeyframe::Create(base::Seconds(1.0), color_b, nullptr));
    curve->AddKeyframe(ColorKeyframe::Create(base::Seconds(2.0), color_c, nullptr));
...
TEST(KeyframedAnimationCurveTest, RepeatedColorKeyFrame)
{
    ...
    std::unique_ptr<KeyframedColorAnimationCurve> curve(KeyframedColorAnimationCurve::Create());
    curve->AddKeyframe(ColorKeyframe::Create(base::TimeDelta(), color_a, nullptr));
    curve->AddKeyframe(ColorKeyframe::Create(base::Seconds(1.0), color_a, nullptr));
    curve->AddKeyframe(ColorKeyframe::Create(base::Seconds(1.0), color_b, nullptr));
    curve->AddKeyframe(ColorKeyframe::Create(base::Seconds(2.0), color_b, nullptr));
...
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
...
{
    std::unique_ptr<KeyframedTransformAnimationCurve> curve(KeyframedTransformAnimationCurve::Create());
    gfx::TransformOperations operations;
    operations.AppendTranslate(2.f, 0.f, 0.f);
    curve->AddKeyframe(TransformKeyframe::Create(base::TimeDelta(), operations, nullptr));
...
TEST(KeyframedAnimationCurveTest, TwoTransformKeyframe)
{
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::TimeDelta(), operations1, nullptr));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.0), operations2, nullptr));
    ExpectTranslateX(2.f, SAMPLE(curve, base::Seconds(-1.f)));
    ExpectTranslateX(2.f, SAMPLE(curve, base::Seconds(0.f)));
...
TEST(KeyframedAnimationCurveTest, ThreeTransformKeyframe)
{
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::TimeDelta(), operations1, nullptr));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.0), operations2, nullptr));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(2.0), operations3, nullptr));
    ExpectTranslateX(2.f, SAMPLE(curve, base::Seconds(-1.f)));
    ExpectTranslateX(2.f, SAMPLE(curve, base::Seconds(0.f)));
    ExpectTranslateX(3.f, SAMPLE(curve, base::Seconds(0.5f)));
    ExpectTranslateX(4.f, SAMPLE(curve, base::Seconds(1.f)));
...
TEST(KeyframedAnimationCurveTest, RepeatedTransformKeyTimes)
{
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::TimeDelta(), operations1, nullptr));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.0), operations2, nullptr));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.0), operations3, nullptr));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(2.0), operations4, nullptr));
...
TEST(KeyframedAnimationCurveTest, DiscreteCubicBezierTransformAnimation)
{
    ...
    curve->AddKeyframe(TransformKeyframe::Create(base::TimeDelta(), operations1, CubicBezierTimingFunction::Create(0.75f, 0.25f, 0.9f, 0.4f)));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(1.0), operations2, CubicBezierTimingFunction::Create(0.75f, 0.25f, 0.9f, 0.4f)));
    curve->AddKeyframe(TransformKeyframe::Create(base::Seconds(2.0), operations3, CubicBezierTimingFunction::Create(0.75f, 0.25f, 0.9f, 0.4f)));
...
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, LinearTimingFunction::Create()));
...
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, CubicBezierTimingFunction::Create(0.25f, 0.f, 0.75f, 1.f)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.0), 1.f, nullptr));
...
TEST(KeyframedAnimationCurveTest, KeyframeStepsTimingFunctionStepAtStart)
{
    ...
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, StepsTimingFunction::Create(num_steps, StepsTimingFunction::StepPosition::START)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.0), num_steps, nullptr));
...
TEST(KeyframedAnimationCurveTest, CurveStepsTimingFunctionStepAtStart)
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    const int num_steps = 36;
    curve->SetTimingFunction(StepsTimingFunction::Create(num_steps, StepsTimingFunction::StepPosition::START));
...
TEST(KeyframedAnimationCurveTest, StepsTimingFunctionStepAtEnd)
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    const int num_steps = 36;
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, StepsTimingFunction::Create(num_steps, StepsTimingFunction::StepPosition::END)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.0), num_steps, nullptr));
...
TEST(KeyframedAnimationCurveTest, StepsTimingFunctionMaxSteps)
{
    ...
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, StepsTimingFunction::Create(num_steps, StepsTimingFunction::StepPosition::JUMP_BOTH)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.0), 1.f, nullptr));
...
TEST(KeyframedAnimationCurveTest, MaximumScale)
{
    ...
    curve->AddKeyframe(
        TransformKeyframe::Create(base::Seconds(1.f), operations1, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    curve->AddKeyframe(
        TransformKeyframe::Create(base::Seconds(2.f), operations2, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    curve->AddKeyframe(
        TransformKeyframe::Create(base::Seconds(3.f), operations3, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    std::unique_ptr<KeyframedTransformAnimationCurve> curve2(KeyframedTransformAnimationCurve::Create());

    gfx::TransformOperations operations5;
    operations5.AppendScale(0.4f, 0.2f, 0.6f);
    curve2->AddKeyframe(
        TransformKeyframe::Create(base::TimeDelta(), operations5, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    gfx::TransformOperations operations6;
    operations6.AppendScale(0.5f, 0.3f, -0.8f);
    curve2->AddKeyframe(
        TransformKeyframe::Create(base::Seconds(1.f), operations6, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
...
TEST(KeyframeAnimationCurveTest, NonCalculatableMaximumScale)
{
    ...
    curve->AddKeyframe(
        TransformKeyframe::Create(base::Seconds(1.f), operations4, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    curve->AddKeyframe(
        TransformKeyframe::Create(base::Seconds(1.f), operations4, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
    ...
    curve->AddKeyframe(
        TransformKeyframe::Create(base::TimeDelta(), operations, CubicBezierTimingFunction::CreatePreset(CubicBezierTimingFunction::EaseType::EASE)));
...
TEST(KeyframedAnimationCurveTest, CurveTiming)
{
    ...
    curve->SetTimingFunction(CubicBezierTimingFunction::Create(0.75f, 0.f, 0.25f, 1.f));
...
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, CubicBezierTimingFunction::Create(0.35f, 0.f, 0.65f, 1.f)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.f), 1.f, nullptr));
    // Curve timing function producing outputs outside of range [0,1].
    curve->SetTimingFunction(CubicBezierTimingFunction::Create(0.5f, -0.5f, 0.5f, 1.5f));
    EXPECT_FLOAT_EQ(0.f, SAMPLE(curve, base::Seconds(-1.f)));
    EXPECT_FLOAT_EQ(0.f, SAMPLE(curve, base::Seconds(0.f)));
    EXPECT_FLOAT_EQ(0.f, SAMPLE(curve, base::Seconds(0.25f))); // Clamped. c(.25) < 0
    ...
    EXPECT_FLOAT_EQ(1.f, SAMPLE(curve, base::Seconds(0.75f))); // Clamped. c(.75) > 1
    EXPECT_FLOAT_EQ(1.f, SAMPLE(curve, base::Seconds(1.f)));
    EXPECT_FLOAT_EQ(1.f, SAMPLE(curve, base::Seconds(2.f)));
}
...
TEST(KeyframedAnimationCurveTest, CurveTimingInputsOutsideZeroOneRange)
{
    ...
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, CubicBezierTimingFunction::Create(0.5f, 0.25f, 0.5f, 0.75f)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.f), 1.f, nullptr));
    // Curve timing function producing timing outputs outside of range [0,1].
    curve->SetTimingFunction(CubicBezierTimingFunction::Create(0.5f, -0.5f, 0.5f, 1.5f));
...
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, StepsTimingFunction::Create(4, StepsTimingFunction::StepPosition::START)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.0), 2.f, nullptr));
    // Curve timing function producing timing outputs outside of range [0,1].
    curve->SetTimingFunction(CubicBezierTimingFunction::Create(0.5f, -0.5f, 0.5f, 1.5f));
...
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, StepsTimingFunction::Create(4, StepsTimingFunction::StepPosition::END)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.0), 2.f, nullptr));
    // Curve timing function producing timing outputs outside of range [0,1].
    curve->SetTimingFunction(CubicBezierTimingFunction::Create(0.5f, -0.5f, 0.5f, 1.5f));
...
{
    std::unique_ptr<KeyframedFloatAnimationCurve> curve(KeyframedFloatAnimationCurve::Create());
    curve->AddKeyframe(FloatKeyframe::Create(base::TimeDelta(), 0.f, StepsTimingFunction::Create(1, StepsTimingFunction::StepPosition::JUMP_BOTH)));
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(1.0), 2.f, nullptr));
...
TEST(KeyframedAnimationCurveTest, CurveTimingMultipleKeyframes)
{
    ...
    curve->SetTimingFunction(CubicBezierTimingFunction::Create(0.5f, 0.f, 0.5f, 1.f));
    EXPECT_FLOAT_EQ(0.f, SAMPLE(curve, base::Seconds(-1.f)));
    EXPECT_FLOAT_EQ(0.f, SAMPLE(curve, base::Seconds(0.f)));
...
TEST(KeyframedAnimationCurveTest, OneSizeKeyFrame)
{
    ...
    std::unique_ptr<KeyframedSizeAnimationCurve> curve(KeyframedSizeAnimationCurve::Create());
...
TEST(KeyframedAnimationCurveTest, ThreeSizeKeyFrame)
{
    ...
    gfx::SizeF size_midpoint1 = gfx::Tween::SizeFValueBetween(0.5, size_a, size_b);
    gfx::SizeF size_midpoint2 = gfx::Tween::SizeFValueBetween(0.5, size_b, size_c);
    std::unique_ptr<KeyframedSizeAnimationCurve> curve(KeyframedSizeAnimationCurve::Create());
    curve->AddKeyframe(SizeKeyframe::Create(base::TimeDelta(), size_a, nullptr));
    curve->AddKeyframe(SizeKeyframe::Create(base::Seconds(1.0), size_b, nullptr));
...
TEST(KeyframedAnimationCurveTest, OneRectKeyFrame)
{
    ...
    std::unique_ptr<KeyframedRectAnimationCurve> curve(KeyframedRectAnimationCurve::Create());
...
TEST(KeyFrameAnimationCurveTest, TickIntervalForStepsTimingFunction)
{
    ...
    curve->AddKeyframe(FloatKeyframe::Create(base::Seconds(kDuration), 4.0, nullptr));
    curve->SetTimingFunction(StepsTimingFunction::Create(kNumSteps, StepsTimingFunction::StepPosition::START));
...
TEST(KeyFrameAnimationCurveTest, TickIntervalForCubicBezierTimingFunction)
{
    ...
    std::unique_ptr<KeyframedColorAnimationCurve> curve(KeyframedColorAnimationCurve::Create());
    curve->AddKeyframe(ColorKeyframe::Create(base::TimeDelta(), color_a, nullptr));
    curve->AddKeyframe(ColorKeyframe::Create(base::Seconds(kDuration), color_b, nullptr));
    curve->SetTimingFunction(CubicBezierTimingFunction::Create(0.75f, 0.25f, 0.9f, 0.4f));
...
TEST(KeyFrameAnimationCurveTest, TickIntervalForLinearTimingFunction)
{
    ...
    int kNumStepsBC = 100;
    std::unique_ptr<KeyframedSizeAnimationCurve> curve(KeyframedSizeAnimationCurve::Create());
    curve->AddKeyframe(SizeKeyframe::Create(base::TimeDelta(), size_a, StepsTimingFunction::Create(kNumStepsAB, StepsTimingFunction::StepPosition::START)));
    curve->AddKeyframe(
        SizeKeyframe::Create(base::Seconds(kDurationAB), size_b, StepsTimingFunction::Create(kNumStepsBC, StepsTimingFunction::StepPosition::START)));
    curve->AddKeyframe(SizeKeyframe::Create(base::Seconds(kDurationAB + kDurationBC), size_c, nullptr));

    // Without explicitly setting a timing function, the default is linear.
    EXPECT_FLOAT_EQ(kDurationBC / kNumStepsBC, curve->TickInterval().InSecondsF());
    curve->SetTimingFunction(LinearTimingFunction::Create());
    EXPECT_FLOAT_EQ(kDurationBC / kNumStepsBC, curve->TickInterval().InSecondsF());

    // Add a 4th keyframe.
    // Now the 3rd keyframe's "easing" into the 4th isn't STEPS.
    curve->AddKeyframe(SizeKeyframe::Create(base::Seconds(kDurationAB + kDurationBC + kDurationCD), size_d, nullptr));
    EXPECT_FLOAT_EQ(0, curve->TickInterval().InSecondsF());
}
