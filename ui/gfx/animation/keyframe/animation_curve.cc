...
#define DEFINE_ANIMATION_CURVE(Name, CurveType)                                                                                                                \
    void Name##AnimationCurve::Tick(base::TimeDelta t, int property_id, KeyframeModel* keyframe_model, gfx::TimingFunction::LimitDirection limit_direction)    \
        const                                                                                                                                                  \
    {                                                                                                                                                          \
        if (target_) {                                                                                                                                         \
            target_->On##Name##Animated(GetTransformedValue(t, limit_direction), property_id, keyframe_model);                                                 \
        }                                                                                                                                                      \
    }                                                                                                                                                          \
    ...
    const Name##AnimationCurve* Name##AnimationCurve::To##Name##AnimationCurve(const AnimationCurve* c)                                                        \
    {                                                                                                                                                          \
        DCHECK_EQ(AnimationCurve::CurveType, c->Type());                                                                                                       \
        return static_cast<const Name##AnimationCurve*>(c);                                                                                                    \
    }                                                                                                                                                          \
    Name##AnimationCurve* Name##AnimationCurve::To##Name##AnimationCurve(AnimationCurve* c)                                                                    \
    {                                                                                                                                                          \
        DCHECK_EQ(AnimationCurve::CurveType, c->Type());                                                                                                       \
