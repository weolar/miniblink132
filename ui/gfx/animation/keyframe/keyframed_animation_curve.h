...
protected:
    Keyframe(base::TimeDelta time, std::unique_ptr<TimingFunction> timing_function);
    virtual ~Keyframe();
...
public:
    static std::unique_ptr<ColorKeyframe> Create(base::TimeDelta time, SkColor value, std::unique_ptr<TimingFunction> timing_function);
...
private:
    ColorKeyframe(base::TimeDelta time, SkColor value, std::unique_ptr<TimingFunction> timing_function);
...
public:
    static std::unique_ptr<FloatKeyframe> Create(base::TimeDelta time, float value, std::unique_ptr<TimingFunction> timing_function);
...
private:
    FloatKeyframe(base::TimeDelta time, float value, std::unique_ptr<TimingFunction> timing_function);
...
private:
    TransformKeyframe(base::TimeDelta time, const gfx::TransformOperations& value, std::unique_ptr<TimingFunction> timing_function);
...
public:
    static std::unique_ptr<SizeKeyframe> Create(base::TimeDelta time, const gfx::SizeF& bounds, std::unique_ptr<TimingFunction> timing_function);
...
private:
    SizeKeyframe(base::TimeDelta time, const gfx::SizeF& value, std::unique_ptr<TimingFunction> timing_function);
...
public:
    static std::unique_ptr<RectKeyframe> Create(base::TimeDelta time, const gfx::Rect& value, std::unique_ptr<TimingFunction> timing_function);
...
private:
    RectKeyframe(base::TimeDelta time, const gfx::Rect& value, std::unique_ptr<TimingFunction> timing_function);

    gfx::Rect value_;
};

class GFX_KEYFRAME_ANIMATION_EXPORT KeyframedColorAnimationCurve : public ColorAnimationCurve {
public:
    ...
    KeyframedColorAnimationCurve& operator=(const KeyframedColorAnimationCurve&) = delete;
    ...
    SkColor GetTransformedValue(base::TimeDelta t, gfx::TimingFunction::LimitDirection limit_direction) const override;

    std::unique_ptr<AnimationCurve> Retarget(base::TimeDelta t, SkColor new_target);
    ...
    const Keyframes& keyframes_for_testing() const
    {
        return keyframes_;
    }
...
class GFX_KEYFRAME_ANIMATION_EXPORT KeyframedFloatAnimationCurve : public FloatAnimationCurve {
public:
    // It is required that the keyframes be sorted by time.
    ...
    KeyframedFloatAnimationCurve& operator=(const KeyframedFloatAnimationCurve&) = delete;
    ...
    float GetTransformedValue(base::TimeDelta t, gfx::TimingFunction::LimitDirection limit_direction) const override;
...
class GFX_KEYFRAME_ANIMATION_EXPORT KeyframedTransformAnimationCurve : public TransformAnimationCurve {
public:
    // It is required that the keyframes be sorted by time.
    static std::unique_ptr<KeyframedTransformAnimationCurve> Create();

    KeyframedTransformAnimationCurve(const KeyframedTransformAnimationCurve&) = delete;
    ~KeyframedTransformAnimationCurve() override;

    KeyframedTransformAnimationCurve& operator=(const KeyframedTransformAnimationCurve&) = delete;
    ...
    gfx::TransformOperations GetTransformedValue(base::TimeDelta t, gfx::TimingFunction::LimitDirection limit_direction) const override;
    bool PreservesAxisAlignment() const override;
    bool MaximumScale(float* max_scale) const override;

    std::unique_ptr<AnimationCurve> Retarget(base::TimeDelta t, const gfx::TransformOperations& new_target);
...
class GFX_KEYFRAME_ANIMATION_EXPORT KeyframedSizeAnimationCurve : public SizeAnimationCurve {
public:
    // It is required that the keyframes be sorted by time.
    ...
    KeyframedSizeAnimationCurve& operator=(const KeyframedSizeAnimationCurve&) = delete;
    ...
    gfx::SizeF GetTransformedValue(base::TimeDelta t, gfx::TimingFunction::LimitDirection limit_direction) const override;

    std::unique_ptr<AnimationCurve> Retarget(base::TimeDelta t, const gfx::SizeF& new_target);
...
class GFX_KEYFRAME_ANIMATION_EXPORT KeyframedRectAnimationCurve : public RectAnimationCurve {
public:
    // It is required that the keyframes be sorted by time.
    ...
    KeyframedRectAnimationCurve& operator=(const KeyframedRectAnimationCurve&) = delete;
    ...
    gfx::Rect GetTransformedValue(base::TimeDelta t, gfx::TimingFunction::LimitDirection limit_direction) const override;

    std::unique_ptr<AnimationCurve> Retarget(base::TimeDelta t, const gfx::Rect& new_target);
...
template <typename T> struct AnimationTraits { };

#define DEFINE_ANIMATION_TRAITS(value_type, name)                                                                                                              \
    template <> struct AnimationTraits<value_type> {                                                                                                           \
        ...
        static const KeyframedCurveType* ToKeyframedCurve(const AnimationCurve* curve)                                                                         \
        {                                                                                                                                                      \
        ...
        static void OnValueAnimated(name##AnimationCurve::Target* target, const ValueType& target_value, int target_property)                                  \
        {                                                                                                                                                      \
