...
public:
    ...
    virtual void Tick(base::TimeDelta t, int property_id, KeyframeModel* keyframe_model, gfx::TimingFunction::LimitDirection limit_direction) const = 0;
...
public:                                                                                                                                                        \
    static const Name##AnimationCurve* To##Name##AnimationCurve(const AnimationCurve* c);                                                                      \
    static Name##AnimationCurve* To##Name##AnimationCurve(AnimationCurve* c);                                                                                  \
    class Target {                                                                                                                                             \
    public:                                                                                                                                                    \
        virtual ~Target() = default;                                                                                                                           \
        virtual void On##Name##Animated(const T& value, int target_property_id, gfx::KeyframeModel* keyframe_model) = 0;                                       \
    };                                                                                                                                                         \
    ~Name##AnimationCurve() override = default;                                                                                                                \
    virtual T GetValue(base::TimeDelta t) const = 0;                                                                                                           \
    virtual T GetTransformedValue(base::TimeDelta t, gfx::TimingFunction::LimitDirection limit_direction) const = 0;                                           \
...
class GFX_KEYFRAME_ANIMATION_EXPORT ColorAnimationCurve : public AnimationCurve {
    DECLARE_ANIMATION_CURVE_BODY(SkColor, Color)
};

class GFX_KEYFRAME_ANIMATION_EXPORT FloatAnimationCurve : public AnimationCurve {
...
class GFX_KEYFRAME_ANIMATION_EXPORT TransformAnimationCurve : public AnimationCurve {
