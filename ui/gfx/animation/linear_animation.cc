...
LinearAnimation::LinearAnimation(base::TimeDelta duration, int frame_rate, AnimationDelegate* delegate)
...
void LinearAnimation::SetDuration(base::TimeDelta duration)
{
    static const double duration_scale_factor = []() {
        ...
        return (base::StringToDouble(command_line->GetSwitchValueASCII(switches::kAnimationDurationScale), &animation_duration_scale)
