...
public:
    ...
    FakeAnimationContainerObserver(const FakeAnimationContainerObserver&) = delete;
    FakeAnimationContainerObserver& operator=(const FakeAnimationContainerObserver&) = delete;

    int progressed_count() const
    {
        return progressed_count_;
    }
    bool empty() const
    {
        return empty_;
