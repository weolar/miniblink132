...
// static
Animation::RichAnimationRenderMode Animation::rich_animation_rendering_mode_ = RichAnimationRenderMode::PLATFORM;
...
gfx::Rect Animation::CurrentValueBetween(const gfx::Rect& start_bounds, const gfx::Rect& target_bounds) const
{
    return Tween::RectValueBetween(GetCurrentValue(), start_bounds, target_bounds);
}
...
bool Animation::ShouldRenderRichAnimation()
{
    ...
    return rich_animation_rendering_mode_ == RichAnimationRenderMode::FORCE_ENABLED;
}
