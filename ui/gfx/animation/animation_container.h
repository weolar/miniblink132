...
class ANIMATION_EXPORT AnimationContainer : public base::RefCounted<AnimationContainer> {
public:
    AnimationContainer();
    ...
    AnimationRunner* animation_runner_for_testing()
    {
        return runner_.get();
    }
...
private:
    ...
    typedef base::flat_set<raw_ptr<AnimationContainerElement, CtnExperimental>> Elements;
    ...
    std::unique_ptr<AnimationRunner> runner_ = AnimationRunner::CreateDefaultAnimationRunner();
