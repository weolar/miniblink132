...
// |default_foreground|.
COMPONENT_EXPORT(GFX_COLOR_UTILS)
BlendResult BlendForMinContrast(SkColor default_foreground, SkColor background, std::optional<SkColor> high_contrast_foreground = std::nullopt,
...
COMPONENT_EXPORT(GFX_COLOR_UTILS)
SkColor PickGoogleColor(SkColor color, SkColor background_color, float min_contrast, float max_contrast = kMaximumPossibleContrast);
...
SkColor PickGoogleColorTwoBackgrounds(
    SkColor color, SkColor background_color_a, SkColor background_color_b, float min_contrast, float max_contrast_with_nearer = kMaximumPossibleContrast);
