...
enum VisualCursorDirection { CURSOR_LEFT, CURSOR_RIGHT, CURSOR_UP, CURSOR_DOWN };
enum LogicalCursorDirection { CURSOR_BACKWARD, CURSOR_FORWARD };
...
public:
    ...
    // position.
    SelectionModel(const std::vector<Range>& selections, LogicalCursorDirection affinity);
    ...
    LogicalCursorDirection caret_affinity() const
    {
    ...
    void set_selection_start(uint32_t pos)
    {
        selection_.set_start(pos);
    }
