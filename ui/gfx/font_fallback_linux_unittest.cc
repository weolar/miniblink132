...
TEST_F(FontFallbackLinuxTest, GetFallbackFont)
{
    ...
    EXPECT_TRUE(GetFallbackFont(base_font, kDefaultApplicationLocale, u"⻩", &fallback_font_cjk));
...
TEST_F(FontFallbackLinuxTest, GetFallbackFontCache)
{
    ...
    Font base_font;
    Font fallback_font;
    EXPECT_TRUE(GetFallbackFont(base_font, kDefaultApplicationLocale, u"⻩", &fallback_font));
    ...
    EXPECT_TRUE(GetFallbackFont(base_font, kFrenchApplicationLocale, u"⻩", &fallback_font));
