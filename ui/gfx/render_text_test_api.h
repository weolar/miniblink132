...
public:
    ...
    static const cc::PaintFlags& GetRendererPaint(internal::SkiaTextRenderer* renderer)
    {
    ...
    void DrawVisualText(internal::SkiaTextRenderer* renderer, const std::vector<Range> selection)
    {
    ...
    {
        render_text_->reset_cached_cursor_x();
    }
