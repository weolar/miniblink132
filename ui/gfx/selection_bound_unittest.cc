...
TEST(SelectionBoundTest, RectBetweenSelectionBounds)
{
    ...
    gfx::Rect expected_rect(b1.edge_start_rounded().x(), b1.edge_start_rounded().y(), b2.edge_start_rounded().x() - b1.edge_start_rounded().x(),
    ...
    gfx::RectF expected_visible_rect(b1.visible_edge_start().x(), b1.visible_edge_start().y(), b2.visible_edge_start().x() - b1.visible_edge_start().x(),
    ...
    b2.SetVisibleEdge(gfx::PointF(100.f, 20.f), gfx::PointF(100.f, 25.f));
    expected_visible_rect = gfx::RectF(b1.visible_edge_start().x(), b1.visible_edge_start().y(), b2.visible_edge_start().x() - b1.visible_edge_start().x(),
        b2.visible_edge_end().y() - b2.visible_edge_start().y());
    EXPECT_EQ(expected_visible_rect, RectFBetweenVisibleSelectionBounds(b1, b2));
    EXPECT_EQ(expected_visible_rect, RectFBetweenVisibleSelectionBounds(b2, b1));
    ...
    expected_rect = gfx::Rect(b1.edge_start_rounded().x(), b2.edge_start_rounded().y(), b2.edge_start_rounded().x() - b1.edge_start_rounded().x(),
        b2.edge_end_rounded().y() - b2.edge_start_rounded().y());
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b1, b2));
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b2, b1));
    ...
    expected_rect = gfx::Rect(b1.edge_start_rounded().x(), b1.edge_start_rounded().y(), b2.edge_start_rounded().x() - b1.edge_start_rounded().x(),
    ...
    expected_rect = gfx::Rect(b1.edge_start_rounded().x(), b1.edge_start_rounded().y(), 0, b2.edge_end_rounded().y() - b1.edge_start_rounded().y());
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b1, b2));
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b2, b1));
    ...
    expected_rect = gfx::Rect(b1.edge_start_rounded().x(), b1.edge_start_rounded().y(), b2.edge_end_rounded().x() - b1.edge_start_rounded().x(),
        b2.edge_end_rounded().y() - b1.edge_start_rounded().y());
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b1, b2));
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b2, b1));
    ...
    expected_rect = gfx::Rect(b1.edge_end_rounded().x(), b1.edge_start_rounded().y(), b2.edge_end_rounded().x() - b1.edge_end_rounded().x(),
        b2.edge_end_rounded().y() - b2.edge_start_rounded().y());
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b1, b2));
    EXPECT_EQ(expected_rect, RectBetweenSelectionBounds(b2, b1));
}
