...
template <> struct StructTraits<gfx::mojom::SwapTimingsDataView, gfx::SwapTimings> {
    ...
    static bool Read(gfx::mojom::SwapTimingsDataView data, gfx::SwapTimings* out)
    {
        return data.ReadSwapStart(&out->swap_start) && data.ReadSwapEnd(&out->swap_end);
    }
};
