...
// static
bool StructTraits<gfx::mojom::LinearGradientDataView, gfx::LinearGradient>::Read(gfx::mojom::LinearGradientDataView data, gfx::LinearGradient* out)
{
    std::array<gfx::LinearGradient::Step, gfx::LinearGradient::kMaxStepSize> steps_data;
