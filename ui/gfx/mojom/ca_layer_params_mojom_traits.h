...
template <> struct StructTraits<gfx::mojom::CALayerParamsDataView, gfx::CALayerParams> {
    ...
    static gfx::mojom::CALayerContentPtr content(const gfx::CALayerParams& ca_layer_params);

    static bool Read(gfx::mojom::CALayerParamsDataView data, gfx::CALayerParams* out);
};
