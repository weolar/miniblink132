...
namespace mojo {
template <> struct StructTraits<gfx::mojom::MaskFilterInfoDataView, gfx::MaskFilterInfo> {
    static const gfx::RRectF& rounded_corner_bounds(const gfx::MaskFilterInfo& info)
    {
        return info.rounded_corner_bounds();
    }

    static const std::optional<gfx::LinearGradient>& gradient_mask(const gfx::MaskFilterInfo& info)
    {
        return info.gradient_mask();
    }

    static bool Read(gfx::mojom::MaskFilterInfoDataView data, gfx::MaskFilterInfo* out);
};
