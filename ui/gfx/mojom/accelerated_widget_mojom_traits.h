...
template <> struct StructTraits<gfx::mojom::AcceleratedWidgetDataView, gfx::AcceleratedWidget> {
    ...
    static bool Read(gfx::mojom::AcceleratedWidgetDataView data, gfx::AcceleratedWidget* out)
    {
#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_IOS)
