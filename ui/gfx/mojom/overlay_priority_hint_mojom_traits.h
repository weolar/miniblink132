...
template <> struct EnumTraits<gfx::mojom::OverlayPriorityHint, gfx::OverlayPriorityHint> {
    static gfx::mojom::OverlayPriorityHint ToMojom(gfx::OverlayPriorityHint hint)
    {
        switch (hint) {
    ...
    static bool FromMojom(gfx::mojom::OverlayPriorityHint input, gfx::OverlayPriorityHint* out)
    {
        switch (input) {
