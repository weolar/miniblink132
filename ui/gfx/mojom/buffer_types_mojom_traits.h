...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) EnumTraits<gfx::mojom::BufferFormat, gfx::BufferFormat> {
    ...
    static bool FromMojom(gfx::mojom::BufferFormat input, gfx::BufferFormat* out)
    {
        switch (input) {
...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) EnumTraits<gfx::mojom::BufferUsage, gfx::BufferUsage> {
...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::BufferUsageAndFormatDataView, gfx::BufferUsageAndFormat> {
    ...
    static bool Read(gfx::mojom::BufferUsageAndFormatDataView data, gfx::BufferUsageAndFormat* out);
};

template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::GpuMemoryBufferIdDataView, gfx::GpuMemoryBufferId> {
    static int32_t id(const gfx::GpuMemoryBufferId& buffer_id)
    {
        return buffer_id.id;
    }
    static bool Read(gfx::mojom::GpuMemoryBufferIdDataView data, gfx::GpuMemoryBufferId* out)
    {
        out->id = data.id();
        return true;
    }
...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::GpuMemoryBufferHandleDataView, gfx::GpuMemoryBufferHandle> {
    ...
    static mojo::StructPtr<gfx::mojom::GpuMemoryBufferPlatformHandle> platform_handle(gfx::GpuMemoryBufferHandle& handle);

    static bool Read(gfx::mojom::GpuMemoryBufferHandleDataView data, gfx::GpuMemoryBufferHandle* handle);
};

template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) EnumTraits<gfx::mojom::BufferPlane, gfx::BufferPlane> {
