...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::HDRStaticMetadataDataView, gfx::HDRStaticMetadata> {
    static float max(const gfx::HDRStaticMetadata& input)
    {
        return input.max;
    }
    ...
    static float min(const gfx::HDRStaticMetadata& input)
    {
        return input.min;
    }
    ...
    static bool Read(gfx::mojom::HDRStaticMetadataDataView data, gfx::HDRStaticMetadata* output);
};
