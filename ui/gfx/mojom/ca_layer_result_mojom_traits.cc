...
// static
gfx::mojom::CALayerResult EnumTraits<gfx::mojom::CALayerResult, gfx::CALayerResult>::ToMojom(gfx::CALayerResult ca_layer_error_code)
{
    ...
    case gfx::kCALayerFailedRenderPassSortingContextId: // = 22,
        return gfx::mojom::CALayerResult::kCALayerFailedRenderPassSortingContextId;
    case gfx::kCALayerFailedTooManyRenderPassDrawQuads: // = 23,
        return gfx::mojom::CALayerResult::kCALayerFailedTooManyRenderPassDrawQuads;
    case gfx::kCALayerFailedQuadRoundedCornerNotUniform: // = 26,
        return gfx::mojom::CALayerResult::kCALayerFailedQuadRoundedCornerNotUniform;
...
// static
bool EnumTraits<gfx::mojom::CALayerResult, gfx::CALayerResult>::FromMojom(gfx::mojom::CALayerResult input, gfx::CALayerResult* out)
{
    switch (input) {
    ...
    case gfx::mojom::CALayerResult::kCALayerFailedDifferentClipSettings: // =
        ...
        *out = gfx::kCALayerFailedDifferentClipSettings;
        return true;
    case gfx::mojom::CALayerResult::kCALayerFailedRenderPassBackdropFilters: // = 19
    ...
    case gfx::mojom::CALayerResult::kCALayerFailedRenderPassPassMask: // = 20
        *out = gfx::kCALayerFailedRenderPassPassMask;
        return true;
    case gfx::mojom::CALayerResult::kCALayerFailedRenderPassFilterOperation: // = 21
        *out = gfx::kCALayerFailedRenderPassFilterOperation;
        return true;
    case gfx::mojom::CALayerResult::kCALayerFailedRenderPassSortingContextId: // = 22
        *out = gfx::kCALayerFailedRenderPassSortingContextId;
        return true;
    case gfx::mojom::CALayerResult::kCALayerFailedTooManyRenderPassDrawQuads: // = 23
        *out = gfx::kCALayerFailedTooManyRenderPassDrawQuads;
        return true;
    case gfx::mojom::CALayerResult::kCALayerFailedQuadRoundedCornerNotUniform: // = 26
