...
// static
gfx::mojom::ContentColorUsage EnumTraits<gfx::mojom::ContentColorUsage, gfx::ContentColorUsage>::ToMojom(gfx::ContentColorUsage input)
{
    switch (input) {
...
// static
bool EnumTraits<gfx::mojom::ContentColorUsage, gfx::ContentColorUsage>::FromMojom(gfx::mojom::ContentColorUsage input, gfx::ContentColorUsage* output)
{
    switch (input) {
...
// static
base::span<const gfx::ColorSpace> StructTraits<gfx::mojom::DisplayColorSpacesDataView, gfx::DisplayColorSpaces>::color_spaces(
...
// static
base::span<const gfx::BufferFormat> StructTraits<gfx::mojom::DisplayColorSpacesDataView, gfx::DisplayColorSpaces>::buffer_formats(
    const gfx::DisplayColorSpaces& input)
{
...
// static
bool StructTraits<gfx::mojom::DisplayColorSpacesDataView, gfx::DisplayColorSpaces>::Read(
    gfx::mojom::DisplayColorSpacesDataView input, gfx::DisplayColorSpaces* out)
{
