...
template <> struct StructTraits<gfx::mojom::DelegatedInkPointDataView, gfx::DelegatedInkPoint> {
    ...
    static bool Read(gfx::mojom::DelegatedInkPointDataView data, gfx::DelegatedInkPoint* out);
};
