...
template <> struct EnumTraits<gfx::mojom::ColorSpacePrimaryID, gfx::ColorSpace::PrimaryID> {
    static gfx::mojom::ColorSpacePrimaryID ToMojom(gfx::ColorSpace::PrimaryID input)
    {
        switch (input) {
    ...
    static bool FromMojom(gfx::mojom::ColorSpacePrimaryID input, gfx::ColorSpace::PrimaryID* out)
    {
        switch (input) {
...
template <> struct EnumTraits<gfx::mojom::ColorSpaceTransferID, gfx::ColorSpace::TransferID> {
    static gfx::mojom::ColorSpaceTransferID ToMojom(gfx::ColorSpace::TransferID input)
    {
        switch (input) {
    ...
    static bool FromMojom(gfx::mojom::ColorSpaceTransferID input, gfx::ColorSpace::TransferID* out)
    {
        switch (input) {
...
template <> struct EnumTraits<gfx::mojom::ColorSpaceMatrixID, gfx::ColorSpace::MatrixID> {
    static gfx::mojom::ColorSpaceMatrixID ToMojom(gfx::ColorSpace::MatrixID input)
    {
        switch (input) {
    ...
    static bool FromMojom(gfx::mojom::ColorSpaceMatrixID input, gfx::ColorSpace::MatrixID* out)
    {
        switch (input) {
...
template <> struct EnumTraits<gfx::mojom::ColorSpaceRangeID, gfx::ColorSpace::RangeID> {
    ...
    static bool FromMojom(gfx::mojom::ColorSpaceRangeID input, gfx::ColorSpace::RangeID* out)
    {
        switch (input) {
...
template <> struct COMPONENT_EXPORT(GFX_SHARED_MOJOM_TRAITS) StructTraits<gfx::mojom::ColorSpaceDataView, gfx::ColorSpace> {
