...
gfx::mojom::SelectionBoundType GfxSelectionBoundTypeToMojo(gfx::SelectionBound::Type type)
{
    switch (type) {
...
gfx::SelectionBound::Type MojoSelectionBoundTypeToGfx(gfx::mojom::SelectionBoundType type)
{
    switch (type) {
...
template <> struct StructTraits<gfx::mojom::SelectionBoundDataView, gfx::SelectionBound> {
    ...
    static bool Read(gfx::mojom::SelectionBoundDataView data, gfx::SelectionBound* out)
    {
        gfx::PointF edge_start;
        gfx::PointF edge_end;
        gfx::PointF visible_edge_start;
        gfx::PointF visible_edge_end;
        if (!data.ReadEdgeStart(&edge_start) || !data.ReadEdgeEnd(&edge_end) || !data.ReadVisibleEdgeStart(&visible_edge_start)
