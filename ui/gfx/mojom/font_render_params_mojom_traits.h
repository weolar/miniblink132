...
template <> struct EnumTraits<gfx::mojom::SubpixelRendering, gfx::FontRenderParams::SubpixelRendering> {
    static gfx::mojom::SubpixelRendering ToMojom(gfx::FontRenderParams::SubpixelRendering input)
    {
        switch (input) {
    ...
    static bool FromMojom(gfx::mojom::SubpixelRendering input, gfx::FontRenderParams::SubpixelRendering* out)
    {
        switch (input) {
...
template <> struct EnumTraits<gfx::mojom::Hinting, gfx::FontRenderParams::Hinting> {
    ...
    static bool FromMojom(gfx::mojom::Hinting input, gfx::FontRenderParams::Hinting* out)
    {
        switch (input) {
