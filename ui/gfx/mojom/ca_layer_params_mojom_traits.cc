...
gfx::mojom::CALayerContentPtr StructTraits<gfx::mojom::CALayerParamsDataView, gfx::CALayerParams>::content(const gfx::CALayerParams& ca_layer_params)
{
    ...
    if (ca_layer_params.io_surface_mach_port) {
        ...
        return gfx::mojom::CALayerContent::NewIoSurfaceMachPort(
            mojo::PlatformHandle(base::apple::RetainMachSendRight(ca_layer_params.io_surface_mach_port.get())));
    }
#endif
    return gfx::mojom::CALayerContent::NewCaContextId(ca_layer_params.ca_context_id);
}

bool StructTraits<gfx::mojom::CALayerParamsDataView, gfx::CALayerParams>::Read(gfx::mojom::CALayerParamsDataView data, gfx::CALayerParams* out)
{
...
#if BUILDFLAG(IS_APPLE)
        mojo::PlatformHandle platform_handle = content_data.TakeIoSurfaceMachPort();
