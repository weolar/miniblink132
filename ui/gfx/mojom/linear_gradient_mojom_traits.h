...
template <> struct StructTraits<gfx::mojom::StepDataView, gfx::LinearGradient::Step> {
    ...
    static bool Read(gfx::mojom::StepDataView data, gfx::LinearGradient::Step* out)
    {
...
template <> struct StructTraits<gfx::mojom::LinearGradientDataView, gfx::LinearGradient> {
    ...
    static const gfx::LinearGradient::StepArray& steps(const gfx::LinearGradient& input)
    {
        return input.steps();
    }

    static bool Read(gfx::mojom::LinearGradientDataView data, gfx::LinearGradient* out);
};
