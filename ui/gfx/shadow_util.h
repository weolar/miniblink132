...
struct COMPONENT_EXPORT(GFX) ShadowDetails {
    ShadowDetails(const gfx::ShadowValues& values, const gfx::ImageSkia& nine_patch_image);
    ...
    static const ShadowDetails& Get(int elevation, int radius, ShadowStyle style = ShadowStyle::kMaterialDesign);
    ...
    static const ShadowDetails& Get(int elevation, int radius, SkColor key_color, SkColor ambient_color, ShadowStyle style);
