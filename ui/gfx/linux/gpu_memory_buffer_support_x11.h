...
public:
    ...
    std::unique_ptr<GbmBuffer> CreateBuffer(gfx::BufferFormat format, const gfx::Size& size, gfx::BufferUsage usage);

    bool CanCreateNativePixmapForFormat(gfx::BufferFormat format);
    std::unique_ptr<GbmBuffer> CreateBufferFromHandle(const gfx::Size& size, gfx::BufferFormat format, gfx::NativePixmapHandle handle);
