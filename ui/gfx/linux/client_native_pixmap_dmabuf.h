...
public:
    static COMPONENT_EXPORT(GFX) bool IsConfigurationSupported(gfx::BufferFormat format, gfx::BufferUsage usage);
    ...
    static std::unique_ptr<gfx::ClientNativePixmap> ImportFromDmabuf(gfx::NativePixmapHandle handle, const gfx::Size& size, gfx::BufferFormat format);
...
private:
    ...
    ClientNativePixmapDmaBuf(gfx::NativePixmapHandle handle, const gfx::Size& size, std::array<PlaneInfo, kMaxPlanes> plane_info);
