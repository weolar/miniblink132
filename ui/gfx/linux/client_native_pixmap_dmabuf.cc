...
void* MapPlane(const NativePixmapPlane& plane)
{
    ...
    const size_t size_to_map = base::CheckAdd(plane.size, plane.offset).ValueOrDie<size_t>();
    void* data = mmap(nullptr, size_to_map, (PROT_READ | PROT_WRITE), MAP_SHARED, plane.fd.get(), 0);
    if (data == MAP_FAILED) {
        ...
        LOG(ERROR) << "Failed to mmap dmabuf: " << logging::SystemErrorCodeToString(mmap_error);
        return nullptr;
    }
    return data;
}
...
{
    static bool result = base::CommandLine::ForCurrentProcess()->HasSwitch(switches::kEnableNativeGpuMemoryBuffers);
    return result;
}
...
// static
bool ClientNativePixmapDmaBuf::IsConfigurationSupported(gfx::BufferFormat format, gfx::BufferUsage usage)
{
    switch (usage) {
    case gfx::BufferUsage::GPU_READ:
        return format == gfx::BufferFormat::BGR_565 || format == gfx::BufferFormat::RGBA_8888 || format == gfx::BufferFormat::RGBX_8888
            || format == gfx::BufferFormat::BGRA_8888 || format == gfx::BufferFormat::BGRX_8888 || format == gfx::BufferFormat::YVU_420;
    case gfx::BufferUsage::SCANOUT:
        return format == gfx::BufferFormat::BGRX_8888 || format == gfx::BufferFormat::RGBX_8888 || format == gfx::BufferFormat::RGBA_8888
            || format == gfx::BufferFormat::BGRA_8888 || format == gfx::BufferFormat::RGBA_1010102 || format == gfx::BufferFormat::BGRA_1010102;
    ...
    case gfx::BufferUsage::SCANOUT_CPU_READ_WRITE:
        ...
        return
            ...
            format == gfx::BufferFormat::R_8 || format == gfx::BufferFormat::RG_88 || format == gfx::BufferFormat::YUV_420_BIPLANAR
            || format == gfx::BufferFormat::RGBA_1010102 || format == gfx::BufferFormat::BGRA_1010102 ||
#endif

            format == gfx::BufferFormat::BGRX_8888 || format == gfx::BufferFormat::BGRA_8888 || format == gfx::BufferFormat::RGBX_8888
    ...
    case gfx::BufferUsage::VEA_READ_CAMERA_AND_CPU_READ_WRITE:
        return format == gfx::BufferFormat::YVU_420 || format == gfx::BufferFormat::YUV_420_BIPLANAR;
    }
    NOTREACHED();
}

// static
std::unique_ptr<gfx::ClientNativePixmap> ClientNativePixmapDmaBuf::ImportFromDmabuf(
    gfx::NativePixmapHandle handle, const gfx::Size& size, gfx::BufferFormat format)
{
    ...
    return base::WrapUnique(new ClientNativePixmapDmaBuf(std::move(handle), size, std::move(plane_info)));
}

ClientNativePixmapDmaBuf::ClientNativePixmapDmaBuf(gfx::NativePixmapHandle handle, const gfx::Size& size, std::array<PlaneInfo, kMaxPlanes> plane_info)
...
void* ClientNativePixmapDmaBuf::GetMemoryAddress(size_t plane) const
{
    ...
    CHECK(mapped_);
    return static_cast<uint8_t*>(plane_info_[plane].data) + plane_info_[plane].offset;
}
