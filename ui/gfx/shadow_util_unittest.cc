...
TEST(ShadowUtilTest, ShadowDetailsKey)
{
    ...
    ShadowValues new_blur_values = { ShadowValue(values_1[0].offset(), /*blur=*/20, values_1[0].color()), values_1[1] };
    ...
    ShadowValues new_color_values = { ShadowValue(values_2[0].offset(), values_2[0].blur(), SK_ColorBLUE), values_2[1] };
