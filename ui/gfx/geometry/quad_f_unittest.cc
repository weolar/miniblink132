...
TEST(QuadFTest, AddingVectors)
{
    ...
    QuadF added = q1 + v;
    q1 += v;
    QuadF expected1(PointF(4.5f, -1.5f), PointF(5.5f, -1.5f), PointF(5.5f, -0.5f), PointF(4.5f, -0.5f));
    ...
    q2 -= v;
    QuadF expected2(PointF(-2.5f, 3.5f), PointF(-1.5f, 3.5f), PointF(-1.5f, 4.5f), PointF(-2.5f, 4.5f));
...
TEST(QuadFTest, IsRectilinear)
{
    ...
    } tests[] = { { PointF(1, 1.00001f), PointF(2, 1.00001f), PointF(2, 2.00001f), PointF(1, 2.00001f) },
        { PointF(1.00001f, 1), PointF(2.00001f, 1), PointF(2.00001f, 2), PointF(1.00001f, 2) },
        { PointF(1.00001f, 1.00001f), PointF(2.00001f, 1.00001f), PointF(2.00001f, 2.00001f), PointF(1.00001f, 2.00001f) },
        { PointF(1, 0.99999f), PointF(2, 0.99999f), PointF(2, 1.99999f), PointF(1, 1.99999f) },
        { PointF(0.99999f, 1), PointF(1.99999f, 1), PointF(1.99999f, 2), PointF(0.99999f, 2) },
        { PointF(0.99999f, 0.99999f), PointF(1.99999f, 0.99999f), PointF(1.99999f, 1.99999f), PointF(0.99999f, 1.99999f) } };
...
TEST(QuadFTest, IsRectilinearForMappedQuad)
{
    ...
    gfx::QuadF original(gfx::RectF(0.01010101f, 0.01010101f, 100.01010101f, 100.01010101f));
...
TEST(QuadFTest, BoundingBox)
{
    ...
    float right = 2.1f;
    float bottom = 6.2f;
    EXPECT_EQ(RectF(left, top, right - left, bottom - top), QuadF(a, b, c, d).BoundingBox());
}
...
TEST(QuadFTest, RectIntersectionIsInclusive)
{
    ...
    QuadF quad2(PointF(100, 100), PointF(80, 120), PointF(50, 80), PointF(60, 40));
...
TEST(FloatQuadTest, QuadIntersection)
{
    ...
    QuadF cw_quad(PointF(100, 100), PointF(80, 120), PointF(50, 80), PointF(60, 40));
    ...
    // Co-linear edges.
    EXPECT_TRUE(cw_quad.IntersectsQuad(QuadF(PointF(20, 40), PointF(110, 160), PointF(70, 160), PointF(10, 40))));

    // Fully outside.
    // L = { 80, 120 } + t * { -30, -40 }
    EXPECT_FALSE(cw_quad.IntersectsQuad(QuadF(PointF(10, 40), PointF(100, 160), PointF(70, 160), PointF(0, 40))));
    // L = { 100, 100 } + t * { -20, 20 }
    EXPECT_FALSE(cw_quad.IntersectsQuad(QuadF(PointF(120, 90), PointF(80, 130), PointF(90, 130), PointF(130, 90))));
    // L = { 50, 80 } + t * { 10, -40 }
    EXPECT_FALSE(cw_quad.IntersectsQuad(QuadF(PointF(35, 100), PointF(55, 20), PointF(45, 20), PointF(25, 100))));
    // L = { 60, 40 } + t * { 40, 60 }
    EXPECT_FALSE(cw_quad.IntersectsQuad(QuadF(PointF(50, 10), PointF(130, 130), PointF(150, 130), PointF(80, 10))));
    ...
    // (Centroid = { 72.5, 85 }, Min = { 50, 40 }, Max = { 100, 120 })
    QuadF ccw_quad(PointF(100, 100), PointF(60, 40), PointF(50, 80), PointF(80, 120));
    ...
    // Co-linear edges.
    EXPECT_TRUE(ccw_quad.IntersectsQuad(QuadF(PointF(20, 40), PointF(110, 160), PointF(70, 160), PointF(10, 40))));

    // Fully outside.
    // L = { 80, 120 } + t * { -30, -40 }
    EXPECT_FALSE(ccw_quad.IntersectsQuad(QuadF(PointF(10, 40), PointF(100, 160), PointF(70, 160), PointF(0, 40))));
    // L = { 100, 100 } + t * { -20, 20 }
    EXPECT_FALSE(ccw_quad.IntersectsQuad(QuadF(PointF(120, 90), PointF(80, 130), PointF(90, 130), PointF(130, 90))));
    // L = { 50, 80 } + t * { 10, -40 }
    EXPECT_FALSE(ccw_quad.IntersectsQuad(QuadF(PointF(35, 100), PointF(55, 20), PointF(45, 20), PointF(25, 100))));
    // L = { 60, 40 } + t * { 40, 60 }
    EXPECT_FALSE(ccw_quad.IntersectsQuad(QuadF(PointF(50, 10), PointF(130, 130), PointF(150, 130), PointF(80, 10))));
    // BBox = { { 50, 40 }, { 100, 120 } }; w = 50, h = 80
...
TEST(QuadFTest, CenterPoint)
{
    ...
    EXPECT_EQ(PointF(25.75f, 40.75f), QuadF(RectF(10.5f, 20.5f, 30.5f, 40.5f)).CenterPoint());
    EXPECT_EQ(PointF(10, 10), QuadF(PointF(10, 0), PointF(20, 10), PointF(10, 20), PointF(0, 10)).CenterPoint());
}
