...
struct GEOMETRY_SKIA_EXPORT TransformOperation {
    ...
    bool ApproximatelyEqual(const TransformOperation& other, SkScalar tolerance) const;

    static bool BlendTransformOperations(const TransformOperation* from, const TransformOperation* to, SkScalar progress, TransformOperation* result);
