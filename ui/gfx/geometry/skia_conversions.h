...
GEOMETRY_SKIA_EXPORT SkMatrix AxisTransform2dToSkMatrix(const AxisTransform2d& transform);
...
GEOMETRY_SKIA_EXPORT void TransformToFlattenedSkMatrix(const gfx::Transform& transform, SkMatrix* flattened);
GEOMETRY_SKIA_EXPORT SkMatrix TransformToFlattenedSkMatrix(const Transform& transform);
