...
public:
    ...
    // clang-format on
    constexpr Matrix44(double r0c0, double r1c0, double r2c0, double r3c0, double r0c1, double r1c1, double r2c1, double r3c1, double r0c2, double r1c2,
        double r2c2, double r3c2, double r0c3, double r1c3, double r2c3, double r3c3)
        // matrix_ is indexed by [col][row] (i.e. col-major).
        : matrix_ { { r0c0, r1c0, r2c0, r3c0 }, { r0c1, r1c1, r2c1, r3c1 }, { r0c2, r1c2, r2c2, r3c2 }, { r0c3, r1c3, r2c3, r3c3 } }
    {
    }
    // clang-format on
    ...
    {
        return AllTrue(Col(0) == other.Col(0)) && AllTrue(Col(1) == other.Col(1)) && AllTrue(Col(2) == other.Col(2)) && AllTrue(Col(3) == other.Col(3));
    }
    bool operator!=(const Matrix44& other) const
    {
        return !(other == *this);
    ...
    {
        return AllTrue(Col(0) == Double4 { 1, 0, 0, 0 }) && AllTrue(Col(1) == Double4 { 0, 1, 0, 0 }) && AllTrue(Col(2) == Double4 { 0, 0, 1, 0 })
            && matrix_[3][3] == 1;
    }
    ...
    {
        return AllTrue(Double4 { matrix_[0][1], matrix_[0][2], matrix_[0][3], matrix_[1][0] } == Double4 { 0, 0, 0, 0 })
            && AllTrue(Double4 { matrix_[1][2], matrix_[1][3], matrix_[2][0], matrix_[2][1] } == Double4 { 0, 0, 0, 0 }) && matrix_[2][3] == 0
            && matrix_[3][3] == 1;
    }
    ...
    bool IsFlat() const
    {
        return AllTrue(Col(2) == Double4 { 0, 0, 1, 0 }) && AllTrue(Double4 { matrix_[0][2], matrix_[1][2], 0, matrix_[3][2] } == Double4 { 0, 0, 0, 0 });
    }

    bool HasPerspective() const
    {
        return !AllTrue(Double4 { matrix_[0][3], matrix_[1][3], matrix_[2][3], matrix_[3][3] } == Double4 { 0, 0, 0, 1 });
    }

    bool Is2dTransform() const
    {
        return IsFlat() && !HasPerspective();
    }
    ...
    // this = this * m.
    void PreConcat(const Matrix44& m)
    {
        SetConcat(*this, m);
    }
    // this = m * this.
    void PostConcat(const Matrix44& m)
    {
        SetConcat(m, *this);
    }
    // this = a * b.
