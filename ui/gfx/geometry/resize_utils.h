...
enum class ResizeEdge { kBottom, kBottomLeft, kBottomRight, kLeft, kRight, kTop, kTopLeft, kTopRight };
...
void GEOMETRY_EXPORT SizeRectToAspectRatio(
    ResizeEdge resize_edge, float aspect_ratio, const Size& min_window_size, std::optional<Size> max_window_size, Rect* rect);
...
void GEOMETRY_EXPORT SizeRectToAspectRatioWithExcludedMargin(
    ResizeEdge resize_edge, float aspect_ratio, const Size& min_window_size, std::optional<Size> max_window_size, const Size& excluded_margin, Rect& rect);
