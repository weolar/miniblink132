...
TEST(BoxTest, Constructors)
{
    ...
    EXPECT_EQ(BoxF(0.f, 0.f, 0.f, -3.f, -5.f, -7.f).ToString(), BoxF().ToString());

    EXPECT_EQ(BoxF(0.f, 0.f, 0.f, 3.f, 5.f, 7.f).ToString(), BoxF(3.f, 5.f, 7.f).ToString());
    EXPECT_EQ(BoxF(0.f, 0.f, 0.f, 0.f, 0.f, 0.f).ToString(), BoxF(-3.f, -5.f, -7.f).ToString());

    EXPECT_EQ(BoxF(2.f, 4.f, 6.f, 3.f, 5.f, 7.f).ToString(), BoxF(Point3F(2.f, 4.f, 6.f), 3.f, 5.f, 7.f).ToString());
    EXPECT_EQ(BoxF(2.f, 4.f, 6.f, 0.f, 0.f, 0.f).ToString(), BoxF(Point3F(2.f, 4.f, 6.f), -3.f, -5.f, -7.f).ToString());
}
...
TEST(BoxTest, Union)
{
    ...
    EXPECT_EQ(BoxF(0.f, 0.f, 0.f, 9.f, 8.f, 5.f).ToString(), UnionBoxes(box1, box3).ToString());
    EXPECT_EQ(BoxF(0.f, 0.f, 0.f, 9.f, 8.f, 5.f).ToString(), UnionBoxes(box3, box1).ToString());

    // box_2 and box_3 intersect, but neither contains the other
    EXPECT_EQ(BoxF(0.f, 0.f, 0.f, 9.f, 8.f, 8.f).ToString(), UnionBoxes(box2, box3).ToString());
    EXPECT_EQ(BoxF(0.f, 0.f, 0.f, 9.f, 8.f, 8.f).ToString(), UnionBoxes(box3, box2).ToString());
}
...
TEST(BoxTest, Scale)
{
    ...
    EXPECT_EQ(BoxF(4.f, 12.f, 24.f, 10.f, 24.f, 42.f).ToString(), ScaleBox(box1, 2.f, 4.f, 6.f).ToString());
    ...
    EXPECT_EQ(BoxF(4.f, 12.f, 24.f, 10.f, 24.f, 42.f).ToString(), box2.ToString());
}
...
TEST(BoxTest, Offset)
{
    ...
    EXPECT_EQ(BoxF(3.f, 1.f, 0.f, 5.f, 6.f, 7.f).ToString(), (box1 + Vector3dF(1.f, -2.f, -4.f)).ToString());
