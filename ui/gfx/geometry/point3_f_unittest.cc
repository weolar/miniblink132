...
TEST(Point3FTest, VectorArithmetic)
{
    ...
    static const struct {
        ...
        gfx::Point3F actual;
    } tests[] = { { gfx::Point3F(4.7f, 1.9f, 12.5f), a + v1 }, { gfx::Point3F(-1.5f, 8.3f, -6.1f), a - v1 }, { a, a - v1 + v1 }, { a, a + v1 - v1 },
        { a, a + gfx::Vector3dF() }, { gfx::Point3F(12.8f, 0.7f, 9.2f), a + v1 - v2 }, { gfx::Point3F(-9.6f, 9.5f, -2.8f), a - v1 + v2 } };
...
TEST(Point3FTest, Scale)
{
    ...
    EXPECT_EQ(Point3F().ToString(), ScalePoint(Point3F(), 2.f, 2.f, 2.f).ToString());

    EXPECT_EQ(Point3F(2.f, -2.f, 4.f).ToString(), ScalePoint(Point3F(1.f, -1.f, 2.f), 2.f).ToString());
    EXPECT_EQ(Point3F(2.f, -3.f, 8.f).ToString(), ScalePoint(Point3F(1.f, -1.f, 2.f), 2.f, 3.f, 4.f).ToString());
...
{
    EXPECT_EQ(Vector3dF(1.25f, 2.5f, -3.75f), Point3F(1.25f, 2.5f, -3.75f).OffsetFromOrigin());
}
