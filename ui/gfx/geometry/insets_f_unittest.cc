...
{
    InsetsF insets = InsetsF().set_left(2.5f).set_right(4.1f).set_top(1.f).set_bottom(3.3f);
    insets += InsetsF().set_left(6.7f).set_right(8.5f).set_top(5.8f).set_bottom(7.6f);
    ...
    insets -= InsetsF().set_left(0).set_right(2.2f).set_top(-1.f).set_bottom(1.1f);
    ...
    insets
        = InsetsF().set_left(10.1f).set_right(10.001f).set_top(10).set_bottom(10.01f) + InsetsF().set_left(5.f).set_right(-20.2f).set_top(5.5f).set_bottom(0);
...
{
    InsetsF insets1 = InsetsF().set_left(2.2f).set_right(4.4f).set_top(1.1f).set_bottom(3.3f);
    InsetsF insets2;
...
{
    InsetsF insets = InsetsF().set_left(2.2).set_right(4.4).set_top(1.1).set_bottom(3.3);
...
TEST(InsetsFTest, Scale)
{
    ...
    EXPECT_EQ(InsetsF().set_left(12.5f).set_right(2.5f).set_top(24.5f).set_bottom(10.5f), testf);
    testf = ScaleInsets(in, 2.5f);
    EXPECT_EQ(InsetsF().set_left(12.5f).set_right(2.5f).set_top(17.5f).set_bottom(7.5f), testf);

    in.Scale(2.5f, 3.5f);
    EXPECT_EQ(InsetsF().set_left(12.5f).set_right(2.5f).set_top(24.5f).set_bottom(10.5f), in);
    in.Scale(-2.5f);
    EXPECT_EQ(InsetsF().set_left(-31.25f).set_right(-6.25f).set_top(-61.25f).set_bottom(-26.25f), in);
}
...
{
    InsetsF insets;
    insets.SetToMax(InsetsF().set_left(2.5f).set_right(4.5f).set_top(-1.25f).set_bottom(-2.5f));
    ...
    EXPECT_EQ(InsetsF().set_left(2.5f).set_right(4.5f).set_top(1.25f).set_bottom(3.75f), insets);
    insets.SetToMax(InsetsF().set_left(30).set_right(50).set_top(20).set_bottom(40));
    EXPECT_EQ(InsetsF().set_left(30).set_right(50).set_top(20).set_bottom(40), insets);

    InsetsF insets1 = InsetsF().set_left(-2).set_right(-4).set_top(-1).set_bottom(-3);
...
{
    InsetsF insets = InsetsF().set_left(2.5f).set_right(4.5f).set_top(-1.25f).set_bottom(-2.5f);
    EXPECT_EQ(OutsetsF().set_left(-2.5f).set_right(-4.5f).set_top(1.25f).set_bottom(2.5f), insets.ToOutsets());
