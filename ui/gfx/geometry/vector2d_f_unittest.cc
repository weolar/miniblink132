...
{
    float double_values[][4] = { { 4.5f, 1.2f, 3.3f, 5.6f }, { 4.5f, -1.2f, 3.3f, 5.6f }, { 4.5f, 1.2f, 3.3f, -5.6f }, { 4.5f, 1.2f, -3.3f, -5.6f },
        { -4.5f, 1.2f, 3.3f, 5.6f }, { -4.5f, 1.2f, 0, 5.6f }, { -4.5f, 1.2f, 3.3f, 0 }, { 4.5f, 0, 3.3f, 5.6f }, { 0, 1.2f, 3.3f, 5.6f } };
    ...
    for (auto& values : double_values) {
        ...
        Vector2dF v2 = ScaleVector2d(gfx::Vector2dF(values[0], values[1]), values[2], values[3]);
        EXPECT_EQ(values[0] * values[2], v2.x());
        EXPECT_EQ(values[1] * values[3], v2.y());
    }

    float single_values[][3] = { { 4.5f, 1.2f, 3.3f }, { 4.5f, -1.2f, 3.3f }, { 4.5f, 1.2f, 3.3f }, { 4.5f, 1.2f, -3.3f }, { -4.5f, 1.2f, 3.3f },
        { -4.5f, 1.2f, 0 }, { -4.5f, 1.2f, 3.3f }, { 4.5f, 0, 3.3f }, { 0, 1.2f, 3.3f } };
    ...
    for (auto& values : single_values) {
        ...
        Vector2dF v2 = ScaleVector2d(gfx::Vector2dF(values[0], values[1]), values[2]);
        EXPECT_EQ(values[0] * values[2], v2.x());
...
TEST(Vector2dFTest, SlopeAngleRadians)
{
    ...
    EXPECT_NEAR(-kPi * 3 / 4, Vector2dF(-50, -50).SlopeAngleRadians(), kTolerance);
    EXPECT_NEAR(-kPi / 4, Vector2dF(1, -1).SlopeAngleRadians(), kTolerance);
}
