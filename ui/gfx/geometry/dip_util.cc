...
PointF ConvertPointToDips(const Point& point_in_pixels, float device_scale_factor)
{
    return ScalePoint(PointF(point_in_pixels), 1.f / device_scale_factor);
}

PointF ConvertPointToDips(const PointF& point_in_pixels, float device_scale_factor)
{
    return ScalePoint(point_in_pixels, 1.f / device_scale_factor);
}

PointF ConvertPointToPixels(const Point& point_in_dips, float device_scale_factor)
{
    return ScalePoint(PointF(point_in_dips), device_scale_factor);
}

PointF ConvertPointToPixels(const PointF& point_in_dips, float device_scale_factor)
{
...
SizeF ConvertSizeToDips(const SizeF& size_in_pixels, float device_scale_factor)
{
...
SizeF ConvertSizeToPixels(const SizeF& size_in_dips, float device_scale_factor)
{
...
RectF ConvertRectToDips(const RectF& rect_in_pixels, float device_scale_factor)
{
...
RectF ConvertRectToPixels(const RectF& rect_in_dips, float device_scale_factor)
{
    return ScaleRect(rect_in_dips, device_scale_factor);
}

InsetsF ConvertInsetsToDips(const gfx::Insets& insets_in_pixels, float device_scale_factor)
{
    return ScaleInsets(InsetsF(insets_in_pixels), 1.f / device_scale_factor);
}

InsetsF ConvertInsetsToDips(const gfx::InsetsF& insets_in_pixels, float device_scale_factor)
{
    return ScaleInsets(insets_in_pixels, 1.f / device_scale_factor);
}

InsetsF ConvertInsetsToPixels(const gfx::Insets& insets_in_dips, float device_scale_factor)
{
    return ScaleInsets(InsetsF(insets_in_dips), device_scale_factor);
}

InsetsF ConvertInsetsToPixels(const gfx::InsetsF& insets_in_dips, float device_scale_factor)
{
