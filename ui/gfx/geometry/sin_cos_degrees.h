    ...
    if (degrees > -90000000.0 && degrees < 90000000.0) {
        ...
        if (octant == n45degrees) {
            constexpr SinCos kSinCosN45[]
                = { { 0, 1 }, { std::numbers::sqrt2 / 2, std::numbers::sqrt2 / 2 }, { 1, 0 }, { std::numbers::sqrt2 / 2, -std::numbers::sqrt2 / 2 }, { 0, -1 },
                      { -std::numbers::sqrt2 / 2, -std::numbers::sqrt2 / 2 }, { -1, 0 }, { -std::numbers::sqrt2 / 2, std::numbers::sqrt2 / 2 } };
