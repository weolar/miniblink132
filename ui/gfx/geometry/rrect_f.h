...
public:
    ...
    RRectF(const gfx::RectF& rect, float radius)
        : RRectF(rect, radius, radius)
    {
    }
    ...
    RRectF(float x, float y, float width, float height, float upper_left_x, float upper_left_y, float upper_right_x, float upper_right_y, float lower_right_x,
        float lower_right_y, float lower_left_x, float lower_left_y);
    RRectF(const gfx::RectF& rect, float upper_left_x, float upper_left_y, float upper_right_x, float upper_right_y, float lower_right_x, float lower_right_y,
        float lower_left_x, float lower_left_y)
        : RRectF(rect.x(), rect.y(), rect.width(), rect.height(), upper_left_x, upper_left_y, upper_right_x, upper_right_y, lower_right_x, lower_right_y,
            lower_left_x, lower_left_y)
    {
    }
    RRectF(const gfx::RectF& rect, const gfx::RoundedCornersF& corners)
        : RRectF(rect.x(), rect.y(), rect.width(), rect.height(), corners.upper_left(), corners.upper_left(), corners.upper_right(), corners.upper_right(),
            corners.lower_right(), corners.lower_right(), corners.lower_left(), corners.lower_left())
    {
    }
    ...
    {
        return gfx::SkRectToRectF(skrrect_.rect());
    }
    ...
    {
        return skrrect_ == other.skrrect_;
    }
    ...
    void Inset(float val)
    {
        skrrect_.inset(val, val);
    }
    void Inset(float dx, float dy)
    {
        skrrect_.inset(dx, dy);
    }
    ...
    static RRectF ToEnclosingRRectFIgnoringError(const RRectF& rrect, float error = 0.001f);
