...
GEOMETRY_EXPORT Rect ToEnclosingRectIgnoringError(const RectF& rect, float error = 0.001f);
...
// integer rect with or without floating point error, this function also accepts
// non-integer rect.
GEOMETRY_EXPORT Rect ToEnclosedRectIgnoringError(const RectF& rect, float error);
...
GEOMETRY_EXPORT bool IsNearestRectWithinDistance(const gfx::RectF& rect, float distance);
