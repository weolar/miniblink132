...
TEST(InsetsTest, Offset)
{
    ...
    EXPECT_EQ(gfx::Insets().set_left_right(11, -5).set_top_bottom(11, -7), insets_with_offset);
...
TEST(InsetsTest, IntegerOverflowSet)
{
    ...
    Insets set_all_test = Insets().set_left_right(int_max, 20).set_top_bottom(10, int_max);
    EXPECT_EQ(Insets().set_left_right(int_max, 0).set_top_bottom(10, int_max - 10), set_all_test);
}
...
TEST(InsetsTest, IntegerOverflowOffset)
{
    ...
    EXPECT_EQ(gfx::Insets().set_left_right(int_max, 4 - int_max).set_top_bottom(int_max, 3 - int_max), insets);
}
...
TEST(InsetsTest, IntegerUnderflowOffset)
{
    ...
    EXPECT_EQ(gfx::Insets().set_left_right(int_min, -10 - int_min).set_top_bottom(int_min, -10 - int_min), insets);
}
...
{
    Insets insets = Insets().set_left_right(2, 4).set_top_bottom(-1, -3);
    EXPECT_EQ(Outsets().set_left_right(-2, -4).set_top_bottom(1, 3), insets.ToOutsets());
