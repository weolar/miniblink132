...
TEST(RectFTest, BoundingRect)
{
    ...
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 0, 0), BoundingRect(PointF(4.2f, 6.8f), PointF(4.2f, 6.8f)));
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 4.3f, 0), BoundingRect(PointF(4.2f, 6.8f), PointF(8.5f, 6.8f)));
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 0, 2.5f), BoundingRect(PointF(4.2f, 6.8f), PointF(4.2f, 9.3f)));
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 4.3f, 2.5f), BoundingRect(PointF(4.2f, 6.8f), PointF(8.5f, 9.3f)));
    // If point A dominates B, then B should be the origin.
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 0, 0), BoundingRect(PointF(4.2f, 6.8f), PointF(4.2f, 6.8f)));
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 4.3f, 0), BoundingRect(PointF(8.5f, 6.8f), PointF(4.2f, 6.8f)));
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 0, 2.5f), BoundingRect(PointF(4.2f, 9.3f), PointF(4.2f, 6.8f)));
    EXPECT_RECTF_EQ(RectF(4.2f, 6.8f, 4.3f, 2.5f), BoundingRect(PointF(8.5f, 9.3f), PointF(4.2f, 6.8f)));
    // If neither point dominates, then the origin is a combination of the two.
    EXPECT_RECTF_EQ(RectF(4.2f, 4.2f, 2.6f, 2.6f), BoundingRect(PointF(4.2f, 6.8f), PointF(6.8f, 4.2f)));
    EXPECT_RECTF_EQ(RectF(-6.8f, -6.8f, 2.6f, 2.6f), BoundingRect(PointF(-4.2f, -6.8f), PointF(-6.8f, -4.2f)));
    EXPECT_RECTF_EQ(RectF(-4.2f, -4.2f, 11.0f, 11.0f), BoundingRect(PointF(-4.2f, 6.8f), PointF(6.8f, -4.2f)));
    ...
    RectF boundingRect1(BoundingRect(PointF(20.0f, -1000000000.0f), PointF(20.0f, 10.0f)));
    ...
    RectF boundingRect2(BoundingRect(PointF(20.0f, 20.0f), PointF(20.0f, 1000000000.0f)));
    ...
    RectF boundingRect3(BoundingRect(PointF(-1000000000.0f, 20.0f), PointF(20.0f, 20.0f)));
    ...
    RectF boundingRect4(BoundingRect(PointF(20.0f, 20.0f), PointF(1000000000.0f, 20.0f)));
...
TEST(RectFTest, Union)
{
    ...
    EXPECT_RECTF_EQ(RectF(1.1f, 2.2f, 3.3f, 4.4f), UnionRects(RectF(1.1f, 2.2f, 3.3f, 4.4f), RectF(1.1f, 2.2f, 3.3f, 4.4f)));
    EXPECT_RECTF_EQ(RectF(0, 0, 8.8f, 11.0f), UnionRects(RectF(0, 0, 3.3f, 4.4f), RectF(3.3f, 4.4f, 5.5f, 6.6f)));
    EXPECT_RECTF_EQ(RectF(0, 0, 8.8f, 11.0f), UnionRects(RectF(3.3f, 4.4f, 5.5f, 6.6f), RectF(0, 0, 3.3f, 4.4f)));
    EXPECT_RECTF_EQ(RectF(0, 1.1f, 3.3f, 8.8f), UnionRects(RectF(0, 1.1f, 3.3f, 4.4f), RectF(0, 5.5f, 3.3f, 4.4f)));
    EXPECT_RECTF_EQ(RectF(0, 1.1f, 11.0f, 12.1f), UnionRects(RectF(0, 1.1f, 3.3f, 4.4f), RectF(4.4f, 5.5f, 6.6f, 7.7f)));
    EXPECT_RECTF_EQ(RectF(0, 1.1f, 11.0f, 12.1f), UnionRects(RectF(4.4f, 5.5f, 6.6f, 7.7f), RectF(0, 1.1f, 3.3f, 4.4f)));
    EXPECT_RECTF_EQ(RectF(2.2f, 3.3f, 4.4f, 5.5f), UnionRects(RectF(8.8f, 9.9f, 0, 2.2f), RectF(2.2f, 3.3f, 4.4f, 5.5f)));
    EXPECT_RECTF_EQ(RectF(2.2f, 3.3f, 4.4f, 5.5f), UnionRects(RectF(2.2f, 3.3f, 4.4f, 5.5f), RectF(8.8f, 9.9f, 2.2f, 0)));
}

TEST(RectFTest, UnionEvenIfEmpty)
{
    EXPECT_RECTF_EQ(RectF(), UnionRectsEvenIfEmpty(RectF(), RectF()));
    EXPECT_RECTF_EQ(RectF(0, 0, 3.3f, 4.4f), UnionRectsEvenIfEmpty(RectF(), RectF(3.3f, 4.4f, 0, 0)));
    EXPECT_RECTF_EQ(RectF(0, 0, 8.8f, 11.0f), UnionRectsEvenIfEmpty(RectF(0, 0, 3.3f, 4.4f), RectF(3.3f, 4.4f, 5.5f, 6.6f)));
    EXPECT_RECTF_EQ(RectF(0, 0, 8.8f, 11.0f), UnionRectsEvenIfEmpty(RectF(3.3f, 4.4f, 5.5f, 6.6f), RectF(0, 0, 3.3f, 4.4f)));
    EXPECT_RECTF_EQ(RectF(2.2f, 3.3f, 6.6f, 8.8f), UnionRectsEvenIfEmpty(RectF(8.8f, 9.9f, 0, 2.2f), RectF(2.2f, 3.3f, 4.4f, 5.5f)));
    EXPECT_RECTF_EQ(RectF(2.2f, 3.3f, 8.8f, 6.6f), UnionRectsEvenIfEmpty(RectF(2.2f, 3.3f, 4.4f, 5.5f), RectF(8.8f, 9.9f, 2.2f, 0)));
}
...
TEST(RectFTest, ScaleRect)
{
    ...
    EXPECT_RECTF_EQ(RectF(kMaxFloat, kMaxFloat, kMaxFloat, kMaxFloat), ScaleRect(input, kMaxFloat));
    EXPECT_RECTF_EQ(RectF(input.x() * static_cast<float>(kMaxInt), input.y() * static_cast<float>(kMaxInt), input.width() * static_cast<float>(kMaxInt),
...
TEST(RectFTest, IsExpressibleAsRect)
{
    ...
    constexpr float kMinIntF = static_cast<float>(std::numeric_limits<int>::min());
    constexpr float kMaxIntF = static_cast<float>(std::numeric_limits<int>::max());
    constexpr float kInfinity = std::numeric_limits<float>::infinity();

    EXPECT_TRUE(RectF(kMinIntF + 200, kMinIntF + 200, kMaxIntF - 200, kMaxIntF - 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(kMinIntF - 200, kMinIntF + 200, kMaxIntF + 200, kMaxIntF + 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(kMinIntF + 200, kMinIntF - 200, kMaxIntF + 200, kMaxIntF + 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(kMinIntF + 200, kMinIntF + 200, kMaxIntF + 200, kMaxIntF - 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(kMinIntF + 200, kMinIntF + 200, kMaxIntF - 200, kMaxIntF + 200).IsExpressibleAsRect());

    EXPECT_TRUE(RectF(0, 0, kMaxIntF - 200, kMaxIntF - 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(200, 0, kMaxIntF + 200, kMaxIntF - 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(0, 200, kMaxIntF - 200, kMaxIntF + 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(0, 0, kMaxIntF + 200, kMaxIntF - 200).IsExpressibleAsRect());
    EXPECT_FALSE(RectF(0, 0, kMaxIntF - 200, kMaxIntF + 200).IsExpressibleAsRect());
...
TEST(RectFTest, ManhattanInternalDistance)
{
    ...
    EXPECT_FLOAT_EQ(0.0f, f.ManhattanInternalDistance(RectF(-1.0f, 0.0f, 2.0f, 1.0f)));
    EXPECT_FLOAT_EQ(kEpsilon, f.ManhattanInternalDistance(RectF(400.0f, 0.0f, 1.0f, 400.0f)));
    EXPECT_FLOAT_EQ(2.0f * kEpsilon, f.ManhattanInternalDistance(RectF(-100.0f, -100.0f, 100.0f, 100.0f)));
    EXPECT_FLOAT_EQ(1.0f + kEpsilon, f.ManhattanInternalDistance(RectF(-101.0f, 100.0f, 100.0f, 100.0f)));
    EXPECT_FLOAT_EQ(2.0f + 2.0f * kEpsilon, f.ManhattanInternalDistance(RectF(-101.0f, -101.0f, 100.0f, 100.0f)));
    EXPECT_FLOAT_EQ(433.0f + 2.0f * kEpsilon, f.ManhattanInternalDistance(RectF(630.0f, 603.0f, 100.0f, 100.0f)));

    EXPECT_FLOAT_EQ(0.0f, f.ManhattanInternalDistance(RectF(-1.0f, 0.0f, 1.1f, 1.0f)));
    EXPECT_FLOAT_EQ(0.1f + kEpsilon, f.ManhattanInternalDistance(RectF(-1.5f, 0.0f, 1.4f, 1.0f)));
    EXPECT_FLOAT_EQ(kEpsilon, f.ManhattanInternalDistance(RectF(-1.5f, 0.0f, 1.5f, 1.0f)));
}
...
TEST(RectFTest, MaximumCoveredRect)
{
    ...
    EXPECT_EQ(RectF(10, 20, 30, 60), MaximumCoveredRect(RectF(10, 20, 30, 40), RectF(10, 30, 30, 50)));
    // X aligned and adjacent: unite.
    EXPECT_EQ(RectF(10, 20, 30, 90), MaximumCoveredRect(RectF(10, 20, 30, 40), RectF(10, 60, 30, 50)));
    // X aligned and separate: choose the bigger one.
    EXPECT_EQ(RectF(10, 61, 30, 50), MaximumCoveredRect(RectF(10, 20, 30, 40), RectF(10, 61, 30, 50)));
    // Y aligned and intersect: unite.
    EXPECT_EQ(RectF(10, 20, 60, 40), MaximumCoveredRect(RectF(10, 20, 30, 40), RectF(30, 20, 40, 40)));
    // Y aligned and adjacent: unite.
    EXPECT_EQ(RectF(10, 20, 70, 40), MaximumCoveredRect(RectF(10, 20, 30, 40), RectF(40, 20, 40, 40)));
    // Y aligned and separate: choose the bigger one.
    EXPECT_EQ(RectF(41, 20, 40, 40), MaximumCoveredRect(RectF(10, 20, 30, 40), RectF(41, 20, 40, 40)));
    // Get the biggest expanded intersection.
    EXPECT_EQ(RectF(0, 0, 9, 19), MaximumCoveredRect(RectF(0, 0, 10, 10), RectF(0, 9, 9, 10)));
    EXPECT_EQ(RectF(0, 0, 19, 9), MaximumCoveredRect(RectF(0, 0, 10, 10), RectF(9, 0, 10, 9)));
    // Otherwise choose the bigger one.
    EXPECT_EQ(RectF(20, 30, 40, 50), MaximumCoveredRect(RectF(10, 20, 30, 40), RectF(20, 30, 40, 50)));
    EXPECT_EQ(RectF(10, 20, 40, 50), MaximumCoveredRect(RectF(10, 20, 40, 50), RectF(20, 30, 30, 40)));
    EXPECT_EQ(RectF(10, 20, 40, 50), MaximumCoveredRect(RectF(10, 20, 40, 50), RectF(20, 30, 40, 50)));
}
...
TEST(RectFTest, MapRect)
{
    ...
    EXPECT_RECTF_EQ(RectF(), MapRect(RectF(1, 2, 3, 4), RectF(), RectF(5, 6, 7, 8)));
    EXPECT_RECTF_EQ(RectF(1, 2, 3, 4), MapRect(RectF(1, 2, 3, 4), RectF(5, 6, 7, 8), RectF(5, 6, 7, 8)));
    EXPECT_RECTF_EQ(RectF(5, 6, 7, 8), MapRect(RectF(1, 2, 3, 4), RectF(1, 2, 3, 4), RectF(5, 6, 7, 8)));
    EXPECT_RECTF_EQ(RectF(200, 300, 300, 400), MapRect(RectF(1, 2, 3, 4), RectF(0, 1, 6, 8), RectF(100, 200, 600, 800)));
    EXPECT_RECTF_EQ(RectF(1, 2, 3, 4), MapRect(RectF(200, 300, 300, 400), RectF(100, 200, 600, 800), RectF(0, 1, 6, 8)));
}
