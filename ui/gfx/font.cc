...
Font::Font(const std::string& font_name, int font_size)
    : platform_font_(PlatformFont::CreateFromNameAndSize(font_name, font_size))
{
}
...
{
    static const Font::Weight weights[] = { Font::Weight::INVALID, Font::Weight::THIN, Font::Weight::EXTRA_LIGHT, Font::Weight::LIGHT, Font::Weight::NORMAL,
        Font::Weight::MEDIUM, Font::Weight::SEMIBOLD, Font::Weight::BOLD, Font::Weight::EXTRA_BOLD, Font::Weight::BLACK };

    const Font::Weight* next_bigger_weight = std::lower_bound(std::begin(weights), std::end(weights), weight,
        [](const Font::Weight& a, const int& b) { return static_cast<std::underlying_type<Font::Weight>::type>(a) < b; });
