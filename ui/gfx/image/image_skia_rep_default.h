...
public:
    ...
    ImageSkiaRep(cc::PaintRecord paint_record, const gfx::Size& size, float scale);
    ...
    {
        return pixel_size_.width();
    }
    int pixel_height() const
    {
        return pixel_size_.height();
    }
    ...
    bool is_null() const
    {
        return type_ == ImageRepType::kImageTypeBitmap ? bitmap_.isNull() : !paint_record_;
    }
    ...
    const cc::PaintImage& paint_image() const
    {
        return paint_image_;
    }
    bool has_paint_image() const
    {
        return !!paint_image_;
    }
