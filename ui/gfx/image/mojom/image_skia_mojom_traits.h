...
template <> struct StructTraits<gfx::mojom::ImageSkiaRepDataView, gfx::ImageSkiaRep> {
    static SkBitmap bitmap(const gfx::ImageSkiaRep& input);
    static float scale(const gfx::ImageSkiaRep& input);

    static bool Read(gfx::mojom::ImageSkiaRepDataView data, gfx::ImageSkiaRep* out);
};

template <> struct StructTraits<gfx::mojom::ImageSkiaDataView, gfx::ImageSkia> {
    ...
    static void SetToNull(gfx::ImageSkia* out)
    {
        *out = gfx::ImageSkia();
    }
