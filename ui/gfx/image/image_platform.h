...
#if BUILDFLAG(IS_IOS)
scoped_refptr<base::RefCountedMemory> Get1xPNGBytesFromUIImage(UIImage* uiimage);
...
#elif BUILDFLAG(IS_MAC)
scoped_refptr<base::RefCountedMemory> Get1xPNGBytesFromNSImage(NSImage* nsimage);
...
inline NSImage* NSImageFromPNG(const std::vector<ImagePNGRep>& image_png_reps, CGColorSpaceRef color_space)
{
...
scoped_refptr<base::RefCountedMemory> Get1xPNGBytesFromImageSkia(const ImageSkia* image_skia);
