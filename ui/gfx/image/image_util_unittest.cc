...
TEST(ImageUtilTest, JPEGEncodeAndDecode)
{
    ...
    std::optional<std::vector<uint8_t>> encoded = gfx::JPEG1xEncodedDataFromImage(original, /*quality=*/80);
...
TEST(ImageUtilTest, ResizedImageForSearchByImage)
{
    ...
    // resize the image.
    gfx::Image original_image = gfx::test::CreateImage(gfx::kSearchByImageMaxImageWidth * 2, gfx::kSearchByImageMaxImageHeight * 2);
