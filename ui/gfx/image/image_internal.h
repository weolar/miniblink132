...
public:
    ...
    const ImageRep* GetRepresentation(Image::RepresentationType rep_type, bool must_exist) const;
...
private:
    ...
    mutable std::map<Image::RepresentationType, std::unique_ptr<internal::ImageRep>> representations_;
};
