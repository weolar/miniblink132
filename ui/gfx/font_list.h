...
public:
    ...
    FontList(const std::vector<std::string>& font_names, int font_style, int font_size, Font::Weight font_weight);
    ...
    // weight.
    FontList Derive(int size_delta, int font_style, Font::Weight weight) const;
