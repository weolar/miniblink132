...
const char kDisableFontSubpixelPositioning[] = "disable-font-subpixel-positioning";
...
namespace features {
BASE_FEATURE(kOddHeightMultiPlanarBuffers, "OddHeightMultiPlanarBuffers",
...
BASE_FEATURE(kOddWidthMultiPlanarBuffers, "OddWidthMultiPlanarBuffers",
#if BUILDFLAG(IS_APPLE)
    base::FEATURE_ENABLED_BY_DEFAULT
#else
    base::FEATURE_DISABLED_BY_DEFAULT
...
BASE_FEATURE(kUseSmartRefForGPUFenceHandle, "UseSmartRefForGPUFenceHandle", base::FEATURE_ENABLED_BY_DEFAULT);
} // namespace features
