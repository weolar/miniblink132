...
const unsigned char k1x1White[] = {  };

const unsigned char k1x3BlueWhite[] = {  };

const unsigned char k1x3BlueRed[] = {  };
...
scoped_refptr<base::RefCountedMemory> CreateTestPNG(const std::vector<SkColor>& colors)
{
    SkBitmap bitmap;
...
TEST_F(ColorAnalysisTest, CalculatePNGKMeanAllWhite)
{
    ...
    SkColor color = CalculateKMeanColorOfPNG(k1x1White, kDefaultLowerBound, kDefaultUpperBound, &test_sampler);
...
TEST_F(ColorAnalysisTest, CalculatePNGKMeanIgnoreWhiteLightness)
{
    ...
    SkColor color = CalculateKMeanColorOfPNG(k1x3BlueWhite, kDefaultLowerBound, kDefaultUpperBound, &test_sampler);
...
TEST_F(ColorAnalysisTest, CalculatePNGKMeanPickMostCommon)
{
    ...
    SkColor color = CalculateKMeanColorOfPNG(k1x3BlueRed, kDefaultLowerBound, kDefaultUpperBound, &test_sampler);
...
TEST_F(ColorAnalysisTest, FindClosestColor)
{
    ...
    UNSAFE_BUFFERS(base::span<uint8_t> bitmap_span(static_cast<uint8_t*>(bitmap.getPixels()), bitmap.computeByteSize()));
    color = FindClosestColor(bitmap_span, bitmap.width(), bitmap.height(), SK_ColorRED);
    ...
    *pixel = SK_ColorBLACK;
    color = FindClosestColor(bitmap_span, bitmap.width(), bitmap.height(), SK_ColorDKGRAY);
...
TEST_F(ColorAnalysisTest, ComputeProminentColors)
{
    ...
    SaturationRange saturations[] = { SaturationRange::VIBRANT, SaturationRange::MUTED };
    ...
    std::vector<Swatch> expectations(color_profiles.size(), Swatch(SK_ColorTRANSPARENT, 0));
    std::vector<Swatch> computations = CalculateProminentColorsOfBitmap(bitmap, color_profiles, nullptr /* region */, ColorSwatchFilter());
    ...
    computations = CalculateProminentColorsOfBitmap(bitmap, color_profiles, nullptr /* region */, ColorSwatchFilter());
    EXPECT_EQ(expectations, computations);
...
TEST_F(ColorAnalysisTest, ComputeColorSwatches)
{
    ...
    const Swatch kGreenSwatch = Swatch(SK_ColorGREEN, (80u * 80u) - kYellowSwatch.population);
    const Swatch kMagentaSwatch = Swatch(SK_ColorMAGENTA, (100u * 100u) - kGreenSwatch.population - kYellowSwatch.population);

    {
        std::vector<Swatch> colors = CalculateColorSwatches(bitmap, 10, gfx::Rect(100, 100), std::nullopt);
    ...
    {
        std::vector<Swatch> colors = CalculateColorSwatches(bitmap, 10, gfx::Rect(10, 10, 80, 80), std::nullopt);
...
TEST_F(ColorAnalysisTest, ComputeColorSwatches_MaxConsideredPixels)
{
    ...
    {
        std::vector<Swatch> colors = CalculateColorSwatches(bitmap, 10, gfx::Rect(200, 200), std::nullopt);

        size_t total_population = 0;
        for (auto& color : colors) {
            total_population += color.population;
        }
        EXPECT_EQ(static_cast<size_t>(kMaxConsideredPixelsForSwatches), total_population);
    }

    {
        ...
        EXPECT_NEAR(0.6, static_cast<float>(colors[0].population) / kMaxConsideredPixelsForSwatches, 0.001);
        EXPECT_EQ(SK_ColorMAGENTA, colors[1].color);
        EXPECT_NEAR(0.36, static_cast<float>(colors[1].population) / kMaxConsideredPixelsForSwatches, 0.001);
        EXPECT_EQ(SK_ColorYELLOW, colors[2].color);
        EXPECT_NEAR(0.04, static_cast<float>(colors[2].population) / kMaxConsideredPixelsForSwatches, 0.001);
    }

    {
        std::vector<Swatch> colors = CalculateColorSwatches(bitmap, 10, gfx::Rect(20, 20, 140, 140), std::nullopt);
        ...
        EXPECT_EQ(2u, colors.size());
        EXPECT_EQ(SK_ColorGREEN, colors[0].color);
        EXPECT_NEAR(0.918, static_cast<float>(colors[0].population) / kMaxConsideredPixelsForSwatches, 0.001);
        EXPECT_EQ(SK_ColorYELLOW, colors[1].color);
        EXPECT_NEAR(0.082, static_cast<float>(colors[1].population) / kMaxConsideredPixelsForSwatches, 0.001);
    }
}
...
TEST_F(ColorAnalysisTest, ComputeColorSwatches_Filter)
{
    ...
    const Swatch kBlackSwatch = Swatch(SK_ColorBLACK, (80u * 80u) - kWhiteSwatch.population);
    const Swatch kMagentaSwatch = Swatch(SK_ColorMAGENTA, (100u * 100u) - kBlackSwatch.population - kWhiteSwatch.population);

    {
        std::vector<Swatch> colors
            = CalculateColorSwatches(bitmap, 10, gfx::Rect(100, 100), base::BindRepeating([](const SkColor& candidate) { return candidate != SK_ColorBLACK; }));
        EXPECT_EQ(2u, colors.size());
