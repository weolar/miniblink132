...
FutureImpl::FutureImpl(Connection* connection, SequenceType sequence, bool generates_reply, const char* request_name_for_tracing)
...
void FutureImpl::TakeResponse(RawReply* raw_reply, std::unique_ptr<Error>* error)
{
    DCHECK_CALLED_ON_VALID_SEQUENCE(connection_->sequence_checker_);
