...
public:
    X11CrtcResizer(x11::RandR::GetScreenResourcesCurrentReply* resources, x11::Connection* connection);
    ...
    void UpdateActiveCrtcs(x11::RandR::Crtc crtc, x11::RandR::Mode mode, const gfx::Size& new_size);
    ...
    // overlaps.
    void UpdateActiveCrtc(x11::RandR::Crtc crtc, x11::RandR::Mode mode, const gfx::Rect& new_rect);
    ...
    void AddActiveCrtc(x11::RandR::Crtc crtc, x11::RandR::Mode mode, const std::vector<x11::RandR::Output>& outputs, const gfx::Rect& new_rect);
...
private:
    ...
    struct CrtcInfo {
        CrtcInfo();
        CrtcInfo(x11::RandR::Crtc crtc, int16_t x, int16_t y, uint16_t width, uint16_t height, x11::RandR::Mode mode, x11::RandR::Rotation rotation,
    ...
    void AddCrtcFromReply(x11::RandR::Crtc crtc, const x11::RandR::GetCrtcInfoReply& reply);
    ...
    void RelayoutCrtcs(x11::RandR::Crtc crtc_to_resize, const gfx::Size& new_size);
    ...
    void PackHorizontally(const gfx::Size& new_size, x11::RandR::Crtc resized_crtc);
    ...
    void MoveWindow(x11::Window window, const x11::GetWindowAttributesReply& attributes, gfx::Point top_left);
    ...
    x11::Window FindAppWindow(x11::Window window, const x11::GetWindowAttributesReply& attributes);
