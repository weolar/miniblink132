...
Event::Event(scoped_refptr<UnsizedRefCountedMemory> event_bytes, Connection* connection)
{
    auto* xcb_event = reinterpret_cast<xcb_generic_event_t*>(event_bytes->bytes());
