...
public:
    ...
    struct SystemCounter {
        ...
        {
            return counter == other.counter && resolution == other.resolution && name == other.name;
        }
    ...
    struct Trigger {
        ...
        {
            return counter == other.counter && wait_type == other.wait_type && wait_value == other.wait_value && test_type == other.test_type;
        }
    ...
    struct WaitCondition {
        ...
        {
            return trigger == other.trigger && event_threshold == other.event_threshold;
        }
    ...
    Future<InitializeReply> Initialize(const uint8_t& desired_major_version = {}, const uint8_t& desired_minor_version = {});
    ...
    Future<ListSystemCountersReply> ListSystemCounters(const ListSystemCountersRequest& request);
    ...
    Future<void> CreateCounter(const Counter& id = {}, const Int64& initial_value = { {}, {} });
    ...
    Future<void> ChangeCounter(const Counter& counter = {}, const Int64& amount = { {}, {} });
    ...
    Future<void> SetCounter(const Counter& counter = {}, const Int64& value = { {}, {} });
    ...
    Future<void> CreateAlarm(const Alarm& id = {}, const std::optional<Counter>& counter = std::nullopt,
        const std::optional<Valuetype>& valueType = std::nullopt, const std::optional<Int64>& value = std::nullopt,
        const std::optional<Testtype>& testType = std::nullopt, const std::optional<Int64>& delta = std::nullopt,
    ...
    Future<void> ChangeAlarm(const Alarm& id = {}, const std::optional<Counter>& counter = std::nullopt,
        const std::optional<Valuetype>& valueType = std::nullopt, const std::optional<Int64>& value = std::nullopt,
        const std::optional<Testtype>& testType = std::nullopt, const std::optional<Int64>& delta = std::nullopt,
        const std::optional<uint32_t>& events = std::nullopt);
    ...
    Future<void> SetPriority(const uint32_t& id = {}, const int32_t& priority = {});
    ...
    Future<void> CreateFence(const Drawable& drawable = {}, const Fence& fence = {}, const uint8_t& initially_triggered = {});
...
inline constexpr x11::Sync::Alarmstate operator|(x11::Sync::Alarmstate l, x11::Sync::Alarmstate r)
{
    using T = std::underlying_type_t<x11::Sync::Alarmstate>;
    return static_cast<x11::Sync::Alarmstate>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Sync::Testtype operator|(x11::Sync::Testtype l, x11::Sync::Testtype r)
{
    using T = std::underlying_type_t<x11::Sync::Testtype>;
    return static_cast<x11::Sync::Testtype>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Sync::Valuetype operator|(x11::Sync::Valuetype l, x11::Sync::Valuetype r)
{
    using T = std::underlying_type_t<x11::Sync::Valuetype>;
    return static_cast<x11::Sync::Valuetype>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Sync::ChangeAlarmAttribute operator|(x11::Sync::ChangeAlarmAttribute l, x11::Sync::ChangeAlarmAttribute r)
{
    using T = std::underlying_type_t<x11::Sync::ChangeAlarmAttribute>;
    return static_cast<x11::Sync::ChangeAlarmAttribute>(static_cast<T>(l) | static_cast<T>(r));
}
