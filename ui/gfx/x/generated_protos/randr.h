...
public:
    ...
    struct ScreenSize {
        ...
        {
            return width == other.width && height == other.height && mwidth == other.mwidth && mheight == other.mheight;
        }
    ...
    struct ModeInfo {
        ...
        {
            return id == other.id && width == other.width && height == other.height && dot_clock == other.dot_clock && hsync_start == other.hsync_start
                && hsync_end == other.hsync_end && htotal == other.htotal && hskew == other.hskew && vsync_start == other.vsync_start
                && vsync_end == other.vsync_end && vtotal == other.vtotal && name_len == other.name_len && mode_flags == other.mode_flags;
        }
    ...
    struct MonitorInfo {
        ...
        {
            return name == other.name && primary == other.primary && automatic == other.automatic && x == other.x && y == other.y && width == other.width
                && height == other.height && width_in_millimeters == other.width_in_millimeters && height_in_millimeters == other.height_in_millimeters
    ...
    Future<SetScreenConfigReply> SetScreenConfig(const SetScreenConfigRequest& request);

    Future<SetScreenConfigReply> SetScreenConfig(const Window& window = {}, const Time& timestamp = {}, const Time& config_timestamp = {},
        const uint16_t& sizeID = {}, const Rotation& rotation = {}, const uint16_t& rate = {});
    ...
    Future<void> SelectInput(const Window& window = {}, const NotifyMask& enable = {});
    ...
    Future<GetScreenSizeRangeReply> GetScreenSizeRange(const GetScreenSizeRangeRequest& request);
    ...
    Future<void> SetScreenSize(
        const Window& window = {}, const uint16_t& width = {}, const uint16_t& height = {}, const uint32_t& mm_width = {}, const uint32_t& mm_height = {});
    ...
    Future<GetScreenResourcesReply> GetScreenResources(const GetScreenResourcesRequest& request);
    ...
    Future<GetOutputInfoReply> GetOutputInfo(const Output& output = {}, const Time& config_timestamp = {});
    ...
    Future<ListOutputPropertiesReply> ListOutputProperties(const ListOutputPropertiesRequest& request);

    Future<ListOutputPropertiesReply> ListOutputProperties(const Output& output = {});
    ...
    Future<QueryOutputPropertyReply> QueryOutputProperty(const QueryOutputPropertyRequest& request);

    Future<QueryOutputPropertyReply> QueryOutputProperty(const Output& output = {}, const Atom& property = {});
    ...
    Future<void> ConfigureOutputProperty(const ConfigureOutputPropertyRequest& request);
    ...
    Future<void> ChangeOutputProperty(const Output& output = {}, const Atom& property = {}, const Atom& type = {}, const uint8_t& format = {},
        const PropMode& mode = {}, const uint32_t& num_units = {}, const scoped_refptr<base::RefCountedMemory>& data = {});
    ...
    Future<void> DeleteOutputProperty(const Output& output = {}, const Atom& property = {});
    ...
    Future<GetOutputPropertyReply> GetOutputProperty(const GetOutputPropertyRequest& request);

    Future<GetOutputPropertyReply> GetOutputProperty(const Output& output = {}, const Atom& property = {}, const Atom& type = {},
    ...
    Future<CreateModeReply> CreateMode(
        const Window& window = {}, const ModeInfo& mode_info = { {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {} }, const std::string& name = {});
    ...
    Future<void> DeleteOutputMode(const Output& output = {}, const Mode& mode = {});
    ...
    Future<GetCrtcInfoReply> GetCrtcInfo(const Crtc& crtc = {}, const Time& config_timestamp = {});
    ...
    Future<SetCrtcConfigReply> SetCrtcConfig(const Crtc& crtc = {}, const Time& timestamp = {}, const Time& config_timestamp = {}, const int16_t& x = {},
    ...
    Future<GetCrtcGammaSizeReply> GetCrtcGammaSize(const GetCrtcGammaSizeRequest& request);
    ...
    Future<void> SetCrtcGamma(
        const Crtc& crtc = {}, const std::vector<uint16_t>& red = {}, const std::vector<uint16_t>& green = {}, const std::vector<uint16_t>& blue = {});
    ...
    using GetScreenResourcesCurrentResponse = Response<GetScreenResourcesCurrentReply>;

    Future<GetScreenResourcesCurrentReply> GetScreenResourcesCurrent(const GetScreenResourcesCurrentRequest& request);

    Future<GetScreenResourcesCurrentReply> GetScreenResourcesCurrent(const Window& window = {});
    ...
    Future<void> SetCrtcTransform(const Crtc& crtc = {}, const Render::Transform& transform = { {}, {}, {}, {}, {}, {}, {}, {}, {} },
        const std::string& filter_name = {}, const std::vector<Render::Fixed>& filter_params = {});
    ...
    Future<GetCrtcTransformReply> GetCrtcTransform(const GetCrtcTransformRequest& request);
    ...
    Future<SetPanningReply> SetPanning(const Crtc& crtc = {}, const Time& timestamp = {}, const uint16_t& left = {}, const uint16_t& top = {},
        const uint16_t& width = {}, const uint16_t& height = {}, const uint16_t& track_left = {}, const uint16_t& track_top = {},
        const uint16_t& track_width = {}, const uint16_t& track_height = {}, const int16_t& border_left = {}, const int16_t& border_top = {},
        const int16_t& border_right = {}, const int16_t& border_bottom = {});
    ...
    Future<void> SetOutputPrimary(const Window& window = {}, const Output& output = {});
    ...
    Future<GetOutputPrimaryReply> GetOutputPrimary(const GetOutputPrimaryRequest& request);
    ...
    Future<GetProviderInfoReply> GetProviderInfo(const GetProviderInfoRequest& request);

    Future<GetProviderInfoReply> GetProviderInfo(const Provider& provider = {}, const Time& config_timestamp = {});
    ...
    Future<void> SetProviderOffloadSink(const SetProviderOffloadSinkRequest& request);

    Future<void> SetProviderOffloadSink(const Provider& provider = {}, const Provider& sink_provider = {}, const Time& config_timestamp = {});
    ...
    Future<void> SetProviderOutputSource(const SetProviderOutputSourceRequest& request);

    Future<void> SetProviderOutputSource(const Provider& provider = {}, const Provider& source_provider = {}, const Time& config_timestamp = {});
    ...
    Future<ListProviderPropertiesReply> ListProviderProperties(const ListProviderPropertiesRequest& request);

    Future<ListProviderPropertiesReply> ListProviderProperties(const Provider& provider = {});
    ...
    Future<QueryProviderPropertyReply> QueryProviderProperty(const QueryProviderPropertyRequest& request);

    Future<QueryProviderPropertyReply> QueryProviderProperty(const Provider& provider = {}, const Atom& property = {});
    ...
    Future<void> ConfigureProviderProperty(const ConfigureProviderPropertyRequest& request);

    Future<void> ConfigureProviderProperty(const Provider& provider = {}, const Atom& property = {}, const uint8_t& pending = {}, const uint8_t& range = {},
    ...
    Future<void> ChangeProviderProperty(const ChangeProviderPropertyRequest& request);

    Future<void> ChangeProviderProperty(const Provider& provider = {}, const Atom& property = {}, const Atom& type = {}, const uint8_t& format = {},
        const uint8_t& mode = {}, const uint32_t& num_items = {}, const scoped_refptr<base::RefCountedMemory>& data = {});
    ...
    Future<void> DeleteProviderProperty(const DeleteProviderPropertyRequest& request);

    Future<void> DeleteProviderProperty(const Provider& provider = {}, const Atom& property = {});
    ...
    Future<GetProviderPropertyReply> GetProviderProperty(const GetProviderPropertyRequest& request);

    Future<GetProviderPropertyReply> GetProviderProperty(const Provider& provider = {}, const Atom& property = {}, const Atom& type = {},
        const uint32_t& long_offset = {}, const uint32_t& long_length = {}, const uint8_t& c_delete = {}, const uint8_t& pending = {});
    ...
    Future<GetMonitorsReply> GetMonitors(const Window& window = {}, const uint8_t& get_active = {});
    ...
    Future<void> SetMonitor(const Window& window = {}, const MonitorInfo& monitorinfo = { {}, {}, {}, {}, {}, {}, {}, {}, {}, {} });
    ...
    Future<CreateLeaseReply> CreateLease(
        const Window& window = {}, const Lease& lid = {}, const std::vector<Crtc>& crtcs = {}, const std::vector<Output>& outputs = {});
...
inline constexpr x11::RandR::Rotation operator|(x11::RandR::Rotation l, x11::RandR::Rotation r)
{
    using T = std::underlying_type_t<x11::RandR::Rotation>;
    return static_cast<x11::RandR::Rotation>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::RandR::SetConfig operator|(x11::RandR::SetConfig l, x11::RandR::SetConfig r)
{
    using T = std::underlying_type_t<x11::RandR::SetConfig>;
    return static_cast<x11::RandR::SetConfig>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::RandR::NotifyMask operator|(x11::RandR::NotifyMask l, x11::RandR::NotifyMask r)
{
    using T = std::underlying_type_t<x11::RandR::NotifyMask>;
    return static_cast<x11::RandR::NotifyMask>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::RandR::ModeFlag operator|(x11::RandR::ModeFlag l, x11::RandR::ModeFlag r)
{
    using T = std::underlying_type_t<x11::RandR::ModeFlag>;
    return static_cast<x11::RandR::ModeFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::RandR::RandRConnection operator|(x11::RandR::RandRConnection l, x11::RandR::RandRConnection r)
{
    using T = std::underlying_type_t<x11::RandR::RandRConnection>;
    return static_cast<x11::RandR::RandRConnection>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::RandR::Transform operator|(x11::RandR::Transform l, x11::RandR::Transform r)
{
    using T = std::underlying_type_t<x11::RandR::Transform>;
    return static_cast<x11::RandR::Transform>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::RandR::ProviderCapability operator|(x11::RandR::ProviderCapability l, x11::RandR::ProviderCapability r)
{
    using T = std::underlying_type_t<x11::RandR::ProviderCapability>;
    return static_cast<x11::RandR::ProviderCapability>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::RandR::Notify operator|(x11::RandR::Notify l, x11::RandR::Notify r)
{
