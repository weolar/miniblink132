...
public:
    ...
    struct DirectFormat {
        ...
        {
            return red_shift == other.red_shift && red_mask == other.red_mask && green_shift == other.green_shift && green_mask == other.green_mask
                && blue_shift == other.blue_shift && blue_mask == other.blue_mask && alpha_shift == other.alpha_shift && alpha_mask == other.alpha_mask;
        }
    ...
    struct PictFormInfo {
        ...
        {
            return id == other.id && type == other.type && depth == other.depth && direct == other.direct && colormap == other.colormap;
        }
    ...
    struct IndexValue {
        ...
        {
            return pixel == other.pixel && red == other.red && green == other.green && blue == other.blue && alpha == other.alpha;
        }
    ...
    struct GlyphInfo {
        ...
        {
            return width == other.width && height == other.height && x == other.x && y == other.y && x_off == other.x_off && y_off == other.y_off;
        }
    ...
    struct Transform {
        ...
        {
            return matrix11 == other.matrix11 && matrix12 == other.matrix12 && matrix13 == other.matrix13 && matrix21 == other.matrix21
                && matrix22 == other.matrix22 && matrix23 == other.matrix23 && matrix31 == other.matrix31 && matrix32 == other.matrix32
    ...
    Future<QueryVersionReply> QueryVersion(const uint32_t& client_major_version = {}, const uint32_t& client_minor_version = {});
    ...
    Future<QueryPictFormatsReply> QueryPictFormats(const QueryPictFormatsRequest& request);
    ...
    Future<QueryPictIndexValuesReply> QueryPictIndexValues(const QueryPictIndexValuesRequest& request);

    Future<QueryPictIndexValuesReply> QueryPictIndexValues(const PictFormat& format = {});
    ...
    Future<void> CreatePicture(const Picture& pid = {}, const Drawable& drawable = {}, const PictFormat& format = {},
        const std::optional<Repeat>& repeat = std::nullopt, const std::optional<Picture>& alphamap = std::nullopt,
        const std::optional<int32_t>& alphaxorigin = std::nullopt, const std::optional<int32_t>& alphayorigin = std::nullopt,
        const std::optional<int32_t>& clipxorigin = std::nullopt, const std::optional<int32_t>& clipyorigin = std::nullopt,
        const std::optional<Pixmap>& clipmask = std::nullopt, const std::optional<uint32_t>& graphicsexposure = std::nullopt,
        const std::optional<SubwindowMode>& subwindowmode = std::nullopt, const std::optional<PolyEdge>& polyedge = std::nullopt,
        const std::optional<PolyMode>& polymode = std::nullopt, const std::optional<Atom>& dither = std::nullopt,
    ...
    Future<void> ChangePicture(const Picture& picture = {}, const std::optional<Repeat>& repeat = std::nullopt,
        const std::optional<Picture>& alphamap = std::nullopt, const std::optional<int32_t>& alphaxorigin = std::nullopt,
        const std::optional<int32_t>& alphayorigin = std::nullopt, const std::optional<int32_t>& clipxorigin = std::nullopt,
        const std::optional<int32_t>& clipyorigin = std::nullopt, const std::optional<Pixmap>& clipmask = std::nullopt,
        const std::optional<uint32_t>& graphicsexposure = std::nullopt, const std::optional<SubwindowMode>& subwindowmode = std::nullopt,
        const std::optional<PolyEdge>& polyedge = std::nullopt, const std::optional<PolyMode>& polymode = std::nullopt,
        const std::optional<Atom>& dither = std::nullopt, const std::optional<uint32_t>& componentalpha = std::nullopt);
    ...
    Future<void> SetPictureClipRectangles(const SetPictureClipRectanglesRequest& request);
    ...
    Future<void> Composite(const PictOp& op = {}, const Picture& src = {}, const Picture& mask = {}, const Picture& dst = {}, const int16_t& src_x = {},
        const int16_t& src_y = {}, const int16_t& mask_x = {}, const int16_t& mask_y = {}, const int16_t& dst_x = {}, const int16_t& dst_y = {},
    ...
    Future<void> Trapezoids(const PictOp& op = {}, const Picture& src = {}, const Picture& dst = {}, const PictFormat& mask_format = {},
        const int16_t& src_x = {}, const int16_t& src_y = {}, const std::vector<Trapezoid>& traps = {});
    ...
    Future<void> Triangles(const PictOp& op = {}, const Picture& src = {}, const Picture& dst = {}, const PictFormat& mask_format = {},
        const int16_t& src_x = {}, const int16_t& src_y = {}, const std::vector<Triangle>& triangles = {});
    ...
    Future<void> TriStrip(const PictOp& op = {}, const Picture& src = {}, const Picture& dst = {}, const PictFormat& mask_format = {},
        const int16_t& src_x = {}, const int16_t& src_y = {}, const std::vector<PointFix>& points = {});
    ...
    Future<void> TriFan(const PictOp& op = {}, const Picture& src = {}, const Picture& dst = {}, const PictFormat& mask_format = {}, const int16_t& src_x = {},
    ...
    Future<void> CreateGlyphSet(const GlyphSet& gsid = {}, const PictFormat& format = {});
    ...
    Future<void> ReferenceGlyphSet(const GlyphSet& gsid = {}, const GlyphSet& existing = {});
    ...
    Future<void> AddGlyphs(const GlyphSet& glyphset = {}, const std::vector<uint32_t>& glyphids = {}, const std::vector<GlyphInfo>& glyphs = {},
    ...
    Future<void> FreeGlyphs(const GlyphSet& glyphset = {}, const std::vector<Glyph>& glyphs = {});
    ...
    Future<void> CompositeGlyphs8(const PictOp& op = {}, const Picture& src = {}, const Picture& dst = {}, const PictFormat& mask_format = {},
        const GlyphSet& glyphset = {}, const int16_t& src_x = {}, const int16_t& src_y = {}, const std::vector<uint8_t>& glyphcmds = {});
    ...
    Future<void> CompositeGlyphs16(const PictOp& op = {}, const Picture& src = {}, const Picture& dst = {}, const PictFormat& mask_format = {},
        const GlyphSet& glyphset = {}, const int16_t& src_x = {}, const int16_t& src_y = {}, const std::vector<uint8_t>& glyphcmds = {});
    ...
    Future<void> CompositeGlyphs32(const PictOp& op = {}, const Picture& src = {}, const Picture& dst = {}, const PictFormat& mask_format = {},
        const GlyphSet& glyphset = {}, const int16_t& src_x = {}, const int16_t& src_y = {}, const std::vector<uint8_t>& glyphcmds = {});
    ...
    Future<void> FillRectangles(
        const PictOp& op = {}, const Picture& dst = {}, const Color& color = { {}, {}, {}, {} }, const std::vector<Rectangle>& rects = {});
    ...
    Future<void> CreateCursor(const Cursor& cid = {}, const Picture& source = {}, const uint16_t& x = {}, const uint16_t& y = {});
    ...
    Future<void> SetPictureTransform(const Picture& picture = {}, const Transform& transform = { {}, {}, {}, {}, {}, {}, {}, {}, {} });
    ...
    Future<void> SetPictureFilter(const Picture& picture = {}, const std::string& filter = {}, const std::vector<Fixed>& values = {});
    ...
    Future<void> CreateAnimCursor(const Cursor& cid = {}, const std::vector<AnimationCursorElement>& cursors = {});
    ...
    Future<void> AddTraps(const Picture& picture = {}, const int16_t& x_off = {}, const int16_t& y_off = {}, const std::vector<Trap>& traps = {});
    ...
    Future<void> CreateSolidFill(const Picture& picture = {}, const Color& color = { {}, {}, {}, {} });
    ...
    Future<void> CreateLinearGradient(const Picture& picture = {}, const PointFix& p1 = { {}, {} }, const PointFix& p2 = { {}, {} },
        const std::vector<Fixed>& stops = {}, const std::vector<Color>& colors = {});
    ...
    Future<void> CreateRadialGradient(const Picture& picture = {}, const PointFix& inner = { {}, {} }, const PointFix& outer = { {}, {} },
        const Fixed& inner_radius = {}, const Fixed& outer_radius = {}, const std::vector<Fixed>& stops = {}, const std::vector<Color>& colors = {});
    ...
    Future<void> CreateConicalGradient(const CreateConicalGradientRequest& request);

    Future<void> CreateConicalGradient(const Picture& picture = {}, const PointFix& center = { {}, {} }, const Fixed& angle = {},
        const std::vector<Fixed>& stops = {}, const std::vector<Color>& colors = {});
...
inline constexpr x11::Render::PictType operator|(x11::Render::PictType l, x11::Render::PictType r)
{
    using T = std::underlying_type_t<x11::Render::PictType>;
    return static_cast<x11::Render::PictType>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Render::Picture operator|(x11::Render::Picture l, x11::Render::Picture r)
{
    using T = std::underlying_type_t<x11::Render::Picture>;
    return static_cast<x11::Render::Picture>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Render::PictOp operator|(x11::Render::PictOp l, x11::Render::PictOp r)
{
    using T = std::underlying_type_t<x11::Render::PictOp>;
    return static_cast<x11::Render::PictOp>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Render::PolyEdge operator|(x11::Render::PolyEdge l, x11::Render::PolyEdge r)
{
    using T = std::underlying_type_t<x11::Render::PolyEdge>;
    return static_cast<x11::Render::PolyEdge>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Render::PolyMode operator|(x11::Render::PolyMode l, x11::Render::PolyMode r)
{
    using T = std::underlying_type_t<x11::Render::PolyMode>;
    return static_cast<x11::Render::PolyMode>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Render::CreatePictureAttribute operator|(x11::Render::CreatePictureAttribute l, x11::Render::CreatePictureAttribute r)
{
    using T = std::underlying_type_t<x11::Render::CreatePictureAttribute>;
    return static_cast<x11::Render::CreatePictureAttribute>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Render::SubPixel operator|(x11::Render::SubPixel l, x11::Render::SubPixel r)
{
    using T = std::underlying_type_t<x11::Render::SubPixel>;
    return static_cast<x11::Render::SubPixel>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Render::Repeat operator|(x11::Render::Repeat l, x11::Render::Repeat r)
{
    using T = std::underlying_type_t<x11::Render::Repeat>;
    return static_cast<x11::Render::Repeat>(static_cast<T>(l) | static_cast<T>(r));
}
