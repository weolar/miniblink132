...
public:
    ...
    struct IndicatorMap {
        ...
        {
            return flags == other.flags && whichGroups == other.whichGroups && groups == other.groups && whichMods == other.whichMods && mods == other.mods
                && realMods == other.realMods && vmods == other.vmods && ctrls == other.ctrls;
        }
    ...
    struct ModDef {
        ...
        {
            return mask == other.mask && realMods == other.realMods && vmods == other.vmods;
        }
    ...
    struct KTMapEntry {
        ...
        {
            return active == other.active && mods_mask == other.mods_mask && level == other.level && mods_mods == other.mods_mods
    ...
    struct KeyType {
        ...
        {
            return mods_mask == other.mods_mask && mods_mods == other.mods_mods && mods_vmods == other.mods_vmods && numLevels == other.numLevels
                && hasPreserve == other.hasPreserve && map == other.map && preserve == other.preserve;
        }
    ...
    struct KeySymMap {
        ...
        {
            return kt_index == other.kt_index && groupInfo == other.groupInfo && width == other.width && syms == other.syms;
        }
    ...
    struct KTSetMapEntry {
        ...
        {
            return level == other.level && realMods == other.realMods && virtualMods == other.virtualMods;
        }
    ...
    struct SetKeyType {
        ...
        {
            return mask == other.mask && realMods == other.realMods && virtualMods == other.virtualMods && numLevels == other.numLevels
                && preserve == other.preserve && entries == other.entries && preserve_entries == other.preserve_entries;
        }
    ...
    struct Shape {
        ...
        {
            return name == other.name && primaryNdx == other.primaryNdx && approxNdx == other.approxNdx && outlines == other.outlines;
        }
    ...
    struct Key {
        ...
        {
            return name == other.name && gap == other.gap && shapeNdx == other.shapeNdx && colorNdx == other.colorNdx;
        }
    ...
    struct Row {
        ...
        {
            return top == other.top && left == other.left && vertical == other.vertical && keys == other.keys;
        }
    ...
    struct DeviceLedInfo {
        ...
        {
            return ledClass == other.ledClass && ledID == other.ledID && namesPresent == other.namesPresent && mapsPresent == other.mapsPresent
                && physIndicators == other.physIndicators && state == other.state && names == other.names && maps == other.maps;
        }
    ...
    struct SASetMods {
        ...
        {
            return type == other.type && flags == other.flags && mask == other.mask && realMods == other.realMods && vmodsHigh == other.vmodsHigh
    ...
    struct SAMovePtr {
        ...
        {
            return type == other.type && flags == other.flags && xHigh == other.xHigh && xLow == other.xLow && yHigh == other.yHigh && yLow == other.yLow;
        }
    ...
    struct SAPtrBtn {
        ...
        {
            return type == other.type && flags == other.flags && count == other.count && button == other.button;
        }
    ...
    struct SALockPtrBtn {
        ...
        {
            return type == other.type && flags == other.flags && button == other.button;
        }
    ...
    struct SASetPtrDflt {
        ...
        {
            return type == other.type && flags == other.flags && affect == other.affect && value == other.value;
        }
    ...
    struct SAIsoLock {
        ...
        {
            return type == other.type && flags == other.flags && mask == other.mask && realMods == other.realMods && group == other.group
                && affect == other.affect && vmodsHigh == other.vmodsHigh && vmodsLow == other.vmodsLow;
        }
    ...
    struct SASwitchScreen {
        ...
        {
            return type == other.type && flags == other.flags && newScreen == other.newScreen;
        }
    ...
    struct SASetControls {
        ...
        {
            return type == other.type && boolCtrlsHigh == other.boolCtrlsHigh && boolCtrlsLow == other.boolCtrlsLow;
        }
    ...
    struct SAActionMessage {
        ...
        {
            return type == other.type && flags == other.flags && message == other.message;
        }
    ...
    struct SARedirectKey {
        ...
        {
            return type == other.type && newkey == other.newkey && mask == other.mask && realModifiers == other.realModifiers
                && vmodsMaskHigh == other.vmodsMaskHigh && vmodsMaskLow == other.vmodsMaskLow && vmodsHigh == other.vmodsHigh && vmodsLow == other.vmodsLow;
        }
    ...
    struct SADeviceBtn {
        ...
        {
            return type == other.type && flags == other.flags && count == other.count && button == other.button && device == other.device;
        }
    ...
    struct SALockDeviceBtn {
        ...
        {
            return type == other.type && flags == other.flags && button == other.button && device == other.device;
        }
    ...
    struct SADeviceValuator {
        ...
        {
            return type == other.type && device == other.device && val1what == other.val1what && val1index == other.val1index && val1value == other.val1value
                && val2what == other.val2what && val2index == other.val2index && val2value == other.val2value;
        }
    ...
    struct SymInterpret {
        ...
        {
            return sym == other.sym && mods == other.mods && match == other.match && virtualMod == other.virtualMod && flags == other.flags
                && action == other.action;
        }
    ...
    Future<UseExtensionReply> UseExtension(const uint16_t& wantedMajor = {}, const uint16_t& wantedMinor = {});
    ...
    Future<void> SelectEvents(const DeviceSpec& deviceSpec = {}, const EventType& affectWhich = {}, const EventType& clear = {},
        const EventType& selectAll = {}, const MapPart& affectMap = {}, const MapPart& map = {},
        const std::optional<NKNDetail>& affectNewKeyboard = std::nullopt, const std::optional<NKNDetail>& newKeyboardDetails = std::nullopt,
        const std::optional<StatePart>& affectState = std::nullopt, const std::optional<StatePart>& stateDetails = std::nullopt,
        const std::optional<Control>& affectCtrls = std::nullopt, const std::optional<Control>& ctrlDetails = std::nullopt,
        const std::optional<uint32_t>& affectIndicatorState = std::nullopt, const std::optional<uint32_t>& indicatorStateDetails = std::nullopt,
        const std::optional<uint32_t>& affectIndicatorMap = std::nullopt, const std::optional<uint32_t>& indicatorMapDetails = std::nullopt,
        const std::optional<NameDetail>& affectNames = std::nullopt, const std::optional<NameDetail>& namesDetails = std::nullopt,
        const std::optional<CMDetail>& affectCompat = std::nullopt, const std::optional<CMDetail>& compatDetails = std::nullopt,
        const std::optional<uint8_t>& affectBell = std::nullopt, const std::optional<uint8_t>& bellDetails = std::nullopt,
        const std::optional<uint8_t>& affectMsgDetails = std::nullopt, const std::optional<uint8_t>& msgDetails = std::nullopt,
        const std::optional<AXNDetail>& affectAccessX = std::nullopt, const std::optional<AXNDetail>& accessXDetails = std::nullopt,
        const std::optional<XIFeature>& affectExtDev = std::nullopt, const std::optional<XIFeature>& extdevDetails = std::nullopt);
    ...
    Future<void> Bell(const DeviceSpec& deviceSpec = {}, const BellClassSpec& bellClass = {}, const IDSpec& bellID = {}, const int8_t& percent = {},
        const uint8_t& forceSound = {}, const uint8_t& eventOnly = {}, const int16_t& pitch = {}, const int16_t& duration = {}, const Atom& name = {},
        const Window& window = {});
    ...
    Future<void> LatchLockState(const DeviceSpec& deviceSpec = {}, const ModMask& affectModLocks = {}, const ModMask& modLocks = {},
        const uint8_t& lockGroup = {}, const Group& groupLock = {}, const ModMask& affectModLatches = {}, const uint8_t& latchGroup = {},
    ...
    Future<void> SetControls(const DeviceSpec& deviceSpec = {}, const ModMask& affectInternalRealMods = {}, const ModMask& internalRealMods = {},
        const ModMask& affectIgnoreLockRealMods = {}, const ModMask& ignoreLockRealMods = {}, const VMod& affectInternalVirtualMods = {},
        const VMod& internalVirtualMods = {}, const VMod& affectIgnoreLockVirtualMods = {}, const VMod& ignoreLockVirtualMods = {},
        const uint8_t& mouseKeysDfltBtn = {}, const uint8_t& groupsWrap = {}, const AXOption& accessXOptions = {}, const BoolCtrl& affectEnabledControls = {},
        const BoolCtrl& enabledControls = {}, const Control& changeControls = {}, const uint16_t& repeatDelay = {}, const uint16_t& repeatInterval = {},
        const uint16_t& slowKeysDelay = {}, const uint16_t& debounceDelay = {}, const uint16_t& mouseKeysDelay = {}, const uint16_t& mouseKeysInterval = {},
        const uint16_t& mouseKeysTimeToMax = {}, const uint16_t& mouseKeysMaxSpeed = {}, const int16_t& mouseKeysCurve = {},
        const uint16_t& accessXTimeout = {}, const BoolCtrl& accessXTimeoutMask = {}, const BoolCtrl& accessXTimeoutValues = {},
        const AXOption& accessXTimeoutOptionsMask = {}, const AXOption& accessXTimeoutOptionsValues = {}, const std::array<uint8_t, 32>& perKeyRepeat = {});
    ...
    Future<GetMapReply> GetMap(const DeviceSpec& deviceSpec = {}, const MapPart& full = {}, const MapPart& partial = {}, const uint8_t& firstType = {},
        const uint8_t& nTypes = {}, const KeyCode& firstKeySym = {}, const uint8_t& nKeySyms = {}, const KeyCode& firstKeyAction = {},
        const uint8_t& nKeyActions = {}, const KeyCode& firstKeyBehavior = {}, const uint8_t& nKeyBehaviors = {}, const VMod& virtualMods = {},
        const KeyCode& firstKeyExplicit = {}, const uint8_t& nKeyExplicit = {}, const KeyCode& firstModMapKey = {}, const uint8_t& nModMapKeys = {},
        const KeyCode& firstVModMapKey = {}, const uint8_t& nVModMapKeys = {});
    ...
    Future<void> SetMap(const DeviceSpec& deviceSpec = {}, const SetMapFlags& flags = {}, const KeyCode& minKeyCode = {}, const KeyCode& maxKeyCode = {},
        const uint8_t& firstType = {}, const uint8_t& nTypes = {}, const KeyCode& firstKeySym = {}, const uint8_t& nKeySyms = {},
        const uint16_t& totalSyms = {}, const KeyCode& firstKeyAction = {}, const uint8_t& nKeyActions = {}, const uint16_t& totalActions = {},
        const KeyCode& firstKeyBehavior = {}, const uint8_t& nKeyBehaviors = {}, const uint8_t& totalKeyBehaviors = {}, const KeyCode& firstKeyExplicit = {},
        const uint8_t& nKeyExplicit = {}, const uint8_t& totalKeyExplicit = {}, const KeyCode& firstModMapKey = {}, const uint8_t& nModMapKeys = {},
        const uint8_t& totalModMapKeys = {}, const KeyCode& firstVModMapKey = {}, const uint8_t& nVModMapKeys = {}, const uint8_t& totalVModMapKeys = {},
        const VMod& virtualMods = {}, const std::optional<std::vector<SetKeyType>>& types = std::nullopt,
        const std::optional<std::vector<KeySymMap>>& syms = std::nullopt, const std::optional<std::vector<uint8_t>>& actionsCount = std::nullopt,
        const std::optional<std::vector<Action>>& actions = std::nullopt, const std::optional<std::vector<SetBehavior>>& behaviors = std::nullopt,
        const std::optional<std::vector<uint8_t>>& vmods = std::nullopt, const std::optional<std::vector<SetExplicit>>& c_explicit = std::nullopt,
        const std::optional<std::vector<KeyModMap>>& modmap = std::nullopt, const std::optional<std::vector<KeyVModMap>>& vmodmap = std::nullopt);
    ...
    Future<GetCompatMapReply> GetCompatMap(
    ...
    Future<void> SetCompatMap(const DeviceSpec& deviceSpec = {}, const uint8_t& recomputeActions = {}, const uint8_t& truncateSI = {},
        const SetOfGroup& groups = {}, const uint16_t& firstSI = {}, const std::vector<SymInterpret>& si = {}, const std::vector<ModDef>& groupMaps = {});
    ...
    Future<GetIndicatorStateReply> GetIndicatorState(const GetIndicatorStateRequest& request);

    Future<GetIndicatorStateReply> GetIndicatorState(const DeviceSpec& deviceSpec = {});
    ...
    Future<GetIndicatorMapReply> GetIndicatorMap(const GetIndicatorMapRequest& request);

    Future<GetIndicatorMapReply> GetIndicatorMap(const DeviceSpec& deviceSpec = {}, const uint32_t& which = {});
    ...
    Future<void> SetIndicatorMap(const DeviceSpec& deviceSpec = {}, const uint32_t& which = {}, const std::vector<IndicatorMap>& maps = {});
    ...
    Future<GetNamedIndicatorReply> GetNamedIndicator(const GetNamedIndicatorRequest& request);

    Future<GetNamedIndicatorReply> GetNamedIndicator(
        const DeviceSpec& deviceSpec = {}, const LedClass& ledClass = {}, const IDSpec& ledID = {}, const Atom& indicator = {});
    ...
    Future<void> SetNamedIndicator(const DeviceSpec& deviceSpec = {}, const LedClass& ledClass = {}, const IDSpec& ledID = {}, const Atom& indicator = {},
        const uint8_t& setState = {}, const uint8_t& on = {}, const uint8_t& setMap = {}, const uint8_t& createMap = {}, const IMFlag& map_flags = {},
        const IMGroupsWhich& map_whichGroups = {}, const SetOfGroups& map_groups = {}, const IMModsWhich& map_whichMods = {}, const ModMask& map_realMods = {},
        const VMod& map_vmods = {}, const BoolCtrl& map_ctrls = {});
    ...
    Future<GetNamesReply> GetNames(const DeviceSpec& deviceSpec = {}, const NameDetail& which = {});
    ...
    Future<void> SetNames(const DeviceSpec& deviceSpec = {}, const VMod& virtualMods = {}, const uint8_t& firstType = {}, const uint8_t& nTypes = {},
        const uint8_t& firstKTLevelt = {}, const uint8_t& nKTLevels = {}, const uint32_t& indicators = {}, const SetOfGroup& groupNames = {},
        const uint8_t& nRadioGroups = {}, const KeyCode& firstKey = {}, const uint8_t& nKeys = {}, const uint8_t& nKeyAliases = {},
        const uint16_t& totalKTLevelNames = {}, const std::optional<Atom>& keycodesName = std::nullopt, const std::optional<Atom>& geometryName = std::nullopt,
        const std::optional<Atom>& symbolsName = std::nullopt, const std::optional<Atom>& physSymbolsName = std::nullopt,
        const std::optional<Atom>& typesName = std::nullopt, const std::optional<Atom>& compatName = std::nullopt,
        const std::optional<std::vector<Atom>>& typeNames = std::nullopt, const std::optional<std::vector<uint8_t>>& nLevelsPerType = std::nullopt,
        const std::optional<std::vector<Atom>>& ktLevelNames = std::nullopt, const std::optional<std::vector<Atom>>& indicatorNames = std::nullopt,
        const std::optional<std::vector<Atom>>& virtualModNames = std::nullopt, const std::optional<std::vector<Atom>>& groups = std::nullopt,
        const std::optional<std::vector<KeyName>>& keyNames = std::nullopt, const std::optional<std::vector<KeyAlias>>& keyAliases = std::nullopt,
    ...
    Future<PerClientFlagsReply> PerClientFlags(const PerClientFlagsRequest& request);

    Future<PerClientFlagsReply> PerClientFlags(const DeviceSpec& deviceSpec = {}, const PerClientFlag& change = {}, const PerClientFlag& value = {},
    ...
    Future<ListComponentsReply> ListComponents(const ListComponentsRequest& request);

    Future<ListComponentsReply> ListComponents(const DeviceSpec& deviceSpec = {}, const uint16_t& maxNames = {});
    ...
    Future<GetKbdByNameReply> GetKbdByName(const DeviceSpec& deviceSpec = {}, const GBNDetail& need = {}, const GBNDetail& want = {}, const uint8_t& load = {});
    ...
    Future<GetDeviceInfoReply> GetDeviceInfo(const DeviceSpec& deviceSpec = {}, const XIFeature& wanted = {}, const uint8_t& allButtons = {},
        const uint8_t& firstButton = {}, const uint8_t& nButtons = {}, const LedClass& ledClass = {}, const IDSpec& ledID = {});
    ...
    Future<void> SetDeviceInfo(const DeviceSpec& deviceSpec = {}, const uint8_t& firstBtn = {}, const XIFeature& change = {},
        const std::vector<Action>& btnActions = {}, const std::vector<DeviceLedInfo>& leds = {});
    ...
    Future<SetDebuggingFlagsReply> SetDebuggingFlags(const SetDebuggingFlagsRequest& request);

    Future<SetDebuggingFlagsReply> SetDebuggingFlags(const uint32_t& affectFlags = {}, const uint32_t& flags = {}, const uint32_t& affectCtrls = {},
        const uint32_t& ctrls = {}, const std::vector<String8>& message = {});
...
inline constexpr x11::Xkb::Const operator|(x11::Xkb::Const l, x11::Xkb::Const r)
{
...
inline constexpr x11::Xkb::EventType operator|(x11::Xkb::EventType l, x11::Xkb::EventType r)
{
    using T = std::underlying_type_t<x11::Xkb::EventType>;
    return static_cast<x11::Xkb::EventType>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::NKNDetail operator|(x11::Xkb::NKNDetail l, x11::Xkb::NKNDetail r)
{
    using T = std::underlying_type_t<x11::Xkb::NKNDetail>;
    return static_cast<x11::Xkb::NKNDetail>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::AXNDetail operator|(x11::Xkb::AXNDetail l, x11::Xkb::AXNDetail r)
{
    using T = std::underlying_type_t<x11::Xkb::AXNDetail>;
    return static_cast<x11::Xkb::AXNDetail>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::MapPart operator|(x11::Xkb::MapPart l, x11::Xkb::MapPart r)
{
...
inline constexpr x11::Xkb::SetMapFlags operator|(x11::Xkb::SetMapFlags l, x11::Xkb::SetMapFlags r)
{
    using T = std::underlying_type_t<x11::Xkb::SetMapFlags>;
    return static_cast<x11::Xkb::SetMapFlags>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::StatePart operator|(x11::Xkb::StatePart l, x11::Xkb::StatePart r)
{
    using T = std::underlying_type_t<x11::Xkb::StatePart>;
    return static_cast<x11::Xkb::StatePart>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::BoolCtrl operator|(x11::Xkb::BoolCtrl l, x11::Xkb::BoolCtrl r)
{
...
inline constexpr x11::Xkb::Control operator|(x11::Xkb::Control l, x11::Xkb::Control r)
{
...
inline constexpr x11::Xkb::AXOption operator|(x11::Xkb::AXOption l, x11::Xkb::AXOption r)
{
...
inline constexpr x11::Xkb::LedClassResult operator|(x11::Xkb::LedClassResult l, x11::Xkb::LedClassResult r)
{
    using T = std::underlying_type_t<x11::Xkb::LedClassResult>;
    return static_cast<x11::Xkb::LedClassResult>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::LedClass operator|(x11::Xkb::LedClass l, x11::Xkb::LedClass r)
{
...
inline constexpr x11::Xkb::BellClassResult operator|(x11::Xkb::BellClassResult l, x11::Xkb::BellClassResult r)
{
    using T = std::underlying_type_t<x11::Xkb::BellClassResult>;
    return static_cast<x11::Xkb::BellClassResult>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::BellClass operator|(x11::Xkb::BellClass l, x11::Xkb::BellClass r)
{
    using T = std::underlying_type_t<x11::Xkb::BellClass>;
    return static_cast<x11::Xkb::BellClass>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::Group operator|(x11::Xkb::Group l, x11::Xkb::Group r)
{
...
inline constexpr x11::Xkb::Groups operator|(x11::Xkb::Groups l, x11::Xkb::Groups r)
{
...
inline constexpr x11::Xkb::SetOfGroup operator|(x11::Xkb::SetOfGroup l, x11::Xkb::SetOfGroup r)
{
    using T = std::underlying_type_t<x11::Xkb::SetOfGroup>;
    return static_cast<x11::Xkb::SetOfGroup>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::SetOfGroups operator|(x11::Xkb::SetOfGroups l, x11::Xkb::SetOfGroups r)
{
    using T = std::underlying_type_t<x11::Xkb::SetOfGroups>;
    return static_cast<x11::Xkb::SetOfGroups>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::GroupsWrap operator|(x11::Xkb::GroupsWrap l, x11::Xkb::GroupsWrap r)
{
    using T = std::underlying_type_t<x11::Xkb::GroupsWrap>;
    return static_cast<x11::Xkb::GroupsWrap>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::VModsHigh operator|(x11::Xkb::VModsHigh l, x11::Xkb::VModsHigh r)
{
    using T = std::underlying_type_t<x11::Xkb::VModsHigh>;
    return static_cast<x11::Xkb::VModsHigh>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::VModsLow operator|(x11::Xkb::VModsLow l, x11::Xkb::VModsLow r)
{
...
inline constexpr x11::Xkb::Explicit operator|(x11::Xkb::Explicit l, x11::Xkb::Explicit r)
{
...
inline constexpr x11::Xkb::SymInterpretMatch operator|(x11::Xkb::SymInterpretMatch l, x11::Xkb::SymInterpretMatch r)
{
    using T = std::underlying_type_t<x11::Xkb::SymInterpretMatch>;
    return static_cast<x11::Xkb::SymInterpretMatch>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::SymInterpMatch operator|(x11::Xkb::SymInterpMatch l, x11::Xkb::SymInterpMatch r)
{
    using T = std::underlying_type_t<x11::Xkb::SymInterpMatch>;
    return static_cast<x11::Xkb::SymInterpMatch>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::IMFlag operator|(x11::Xkb::IMFlag l, x11::Xkb::IMFlag r)
{
...
inline constexpr x11::Xkb::IMModsWhich operator|(x11::Xkb::IMModsWhich l, x11::Xkb::IMModsWhich r)
{
    using T = std::underlying_type_t<x11::Xkb::IMModsWhich>;
    return static_cast<x11::Xkb::IMModsWhich>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::IMGroupsWhich operator|(x11::Xkb::IMGroupsWhich l, x11::Xkb::IMGroupsWhich r)
{
    using T = std::underlying_type_t<x11::Xkb::IMGroupsWhich>;
    return static_cast<x11::Xkb::IMGroupsWhich>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::CMDetail operator|(x11::Xkb::CMDetail l, x11::Xkb::CMDetail r)
{
...
inline constexpr x11::Xkb::NameDetail operator|(x11::Xkb::NameDetail l, x11::Xkb::NameDetail r)
{
    using T = std::underlying_type_t<x11::Xkb::NameDetail>;
    return static_cast<x11::Xkb::NameDetail>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::GBNDetail operator|(x11::Xkb::GBNDetail l, x11::Xkb::GBNDetail r)
{
    using T = std::underlying_type_t<x11::Xkb::GBNDetail>;
    return static_cast<x11::Xkb::GBNDetail>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::XIFeature operator|(x11::Xkb::XIFeature l, x11::Xkb::XIFeature r)
{
    using T = std::underlying_type_t<x11::Xkb::XIFeature>;
    return static_cast<x11::Xkb::XIFeature>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::PerClientFlag operator|(x11::Xkb::PerClientFlag l, x11::Xkb::PerClientFlag r)
{
    using T = std::underlying_type_t<x11::Xkb::PerClientFlag>;
    return static_cast<x11::Xkb::PerClientFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::BehaviorType operator|(x11::Xkb::BehaviorType l, x11::Xkb::BehaviorType r)
{
    using T = std::underlying_type_t<x11::Xkb::BehaviorType>;
    return static_cast<x11::Xkb::BehaviorType>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::DoodadType operator|(x11::Xkb::DoodadType l, x11::Xkb::DoodadType r)
{
    using T = std::underlying_type_t<x11::Xkb::DoodadType>;
    return static_cast<x11::Xkb::DoodadType>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::Error operator|(x11::Xkb::Error l, x11::Xkb::Error r)
{
...
inline constexpr x11::Xkb::SAType operator|(x11::Xkb::SAType l, x11::Xkb::SAType r)
{
...
inline constexpr x11::Xkb::SAMovePtrFlag operator|(x11::Xkb::SAMovePtrFlag l, x11::Xkb::SAMovePtrFlag r)
{
    using T = std::underlying_type_t<x11::Xkb::SAMovePtrFlag>;
    return static_cast<x11::Xkb::SAMovePtrFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::SASetPtrDfltFlag operator|(x11::Xkb::SASetPtrDfltFlag l, x11::Xkb::SASetPtrDfltFlag r)
{
    using T = std::underlying_type_t<x11::Xkb::SASetPtrDfltFlag>;
    return static_cast<x11::Xkb::SASetPtrDfltFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::SAIsoLockFlag operator|(x11::Xkb::SAIsoLockFlag l, x11::Xkb::SAIsoLockFlag r)
{
    using T = std::underlying_type_t<x11::Xkb::SAIsoLockFlag>;
    return static_cast<x11::Xkb::SAIsoLockFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::SAIsoLockNoAffect operator|(x11::Xkb::SAIsoLockNoAffect l, x11::Xkb::SAIsoLockNoAffect r)
{
    using T = std::underlying_type_t<x11::Xkb::SAIsoLockNoAffect>;
    return static_cast<x11::Xkb::SAIsoLockNoAffect>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::SwitchScreenFlag operator|(x11::Xkb::SwitchScreenFlag l, x11::Xkb::SwitchScreenFlag r)
{
    using T = std::underlying_type_t<x11::Xkb::SwitchScreenFlag>;
    return static_cast<x11::Xkb::SwitchScreenFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::BoolCtrlsHigh operator|(x11::Xkb::BoolCtrlsHigh l, x11::Xkb::BoolCtrlsHigh r)
{
    using T = std::underlying_type_t<x11::Xkb::BoolCtrlsHigh>;
    return static_cast<x11::Xkb::BoolCtrlsHigh>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::BoolCtrlsLow operator|(x11::Xkb::BoolCtrlsLow l, x11::Xkb::BoolCtrlsLow r)
{
    using T = std::underlying_type_t<x11::Xkb::BoolCtrlsLow>;
    return static_cast<x11::Xkb::BoolCtrlsLow>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::ActionMessageFlag operator|(x11::Xkb::ActionMessageFlag l, x11::Xkb::ActionMessageFlag r)
{
    using T = std::underlying_type_t<x11::Xkb::ActionMessageFlag>;
    return static_cast<x11::Xkb::ActionMessageFlag>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::LockDeviceFlags operator|(x11::Xkb::LockDeviceFlags l, x11::Xkb::LockDeviceFlags r)
{
    using T = std::underlying_type_t<x11::Xkb::LockDeviceFlags>;
    return static_cast<x11::Xkb::LockDeviceFlags>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::Xkb::SAValWhat operator|(x11::Xkb::SAValWhat l, x11::Xkb::SAValWhat r)
{
    using T = std::underlying_type_t<x11::Xkb::SAValWhat>;
    return static_cast<x11::Xkb::SAValWhat>(static_cast<T>(l) | static_cast<T>(r));
}
