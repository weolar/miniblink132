...
public:
    ...
    Future<void> ChangeSaveSet(const SaveSetMode& mode = {}, const SaveSetTarget& target = {}, const SaveSetMapping& map = {}, const Window& window = {});
    ...
    Future<void> SelectSelectionInput(const Window& window = {}, const Atom& selection = {}, const SelectionEventMask& event_mask = {});
    ...
    Future<void> SelectCursorInput(const Window& window = {}, const CursorNotifyMask& event_mask = {});
    ...
    Future<GetCursorImageReply> GetCursorImage(const GetCursorImageRequest& request);
    ...
    Future<void> CreateRegion(const Region& region = {}, const std::vector<Rectangle>& rectangles = {});
    ...
    Future<void> CreateRegionFromBitmap(const CreateRegionFromBitmapRequest& request);

    Future<void> CreateRegionFromBitmap(const Region& region = {}, const Pixmap& bitmap = {});
    ...
    Future<void> CreateRegionFromWindow(const CreateRegionFromWindowRequest& request);

    Future<void> CreateRegionFromWindow(const Region& region = {}, const Window& window = {}, const Shape::Sk& kind = {});
    ...
    Future<void> CreateRegionFromGC(const Region& region = {}, const GraphicsContext& gc = {});
    ...
    Future<void> CreateRegionFromPicture(const CreateRegionFromPictureRequest& request);

    Future<void> CreateRegionFromPicture(const Region& region = {}, const Render::Picture& picture = {});
    ...
    Future<void> SetRegion(const Region& region = {}, const std::vector<Rectangle>& rectangles = {});
    ...
    Future<void> CopyRegion(const Region& source = {}, const Region& destination = {});
    ...
    Future<void> UnionRegion(const Region& source1 = {}, const Region& source2 = {}, const Region& destination = {});
    ...
    Future<void> IntersectRegion(const Region& source1 = {}, const Region& source2 = {}, const Region& destination = {});
    ...
    Future<void> SubtractRegion(const Region& source1 = {}, const Region& source2 = {}, const Region& destination = {});
    ...
    Future<void> InvertRegion(const Region& source = {}, const Rectangle& bounds = { {}, {}, {}, {} }, const Region& destination = {});
    ...
    Future<void> TranslateRegion(const Region& region = {}, const int16_t& dx = {}, const int16_t& dy = {});
    ...
    Future<void> RegionExtents(const Region& source = {}, const Region& destination = {});
    ...
    Future<void> SetGCClipRegion(const GraphicsContext& gc = {}, const Region& region = {}, const int16_t& x_origin = {}, const int16_t& y_origin = {});
    ...
    Future<void> SetPictureClipRegion(
        const Render::Picture& picture = {}, const Region& region = {}, const int16_t& x_origin = {}, const int16_t& y_origin = {});
    ...
    Future<void> SetCursorName(const Cursor& cursor = {}, const std::string& name = {});
    ...
    Future<GetCursorImageAndNameReply> GetCursorImageAndName(const GetCursorImageAndNameRequest& request);
    ...
    Future<void> ChangeCursor(const Cursor& source = {}, const Cursor& destination = {});
    ...
    Future<void> ChangeCursorByName(const Cursor& src = {}, const std::string& name = {});
    ...
    Future<void> ExpandRegion(const Region& source = {}, const Region& destination = {}, const uint16_t& left = {}, const uint16_t& right = {},
        const uint16_t& top = {}, const uint16_t& bottom = {});
    ...
    Future<void> CreatePointerBarrier(const Barrier& barrier = {}, const Window& window = {}, const uint16_t& x1 = {}, const uint16_t& y1 = {},
        const uint16_t& x2 = {}, const uint16_t& y2 = {}, const BarrierDirections& directions = {}, const std::vector<uint16_t>& devices = {});
    ...
    Future<void> SetClientDisconnectMode(const SetClientDisconnectModeRequest& request);

    Future<void> SetClientDisconnectMode(const ClientDisconnectFlags& disconnect_mode = {});
    ...
    using GetClientDisconnectModeResponse = Response<GetClientDisconnectModeReply>;

    Future<GetClientDisconnectModeReply> GetClientDisconnectMode(const GetClientDisconnectModeRequest& request);
...
inline constexpr x11::XFixes::SaveSetMode operator|(x11::XFixes::SaveSetMode l, x11::XFixes::SaveSetMode r)
{
    using T = std::underlying_type_t<x11::XFixes::SaveSetMode>;
    return static_cast<x11::XFixes::SaveSetMode>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::SaveSetTarget operator|(x11::XFixes::SaveSetTarget l, x11::XFixes::SaveSetTarget r)
{
    using T = std::underlying_type_t<x11::XFixes::SaveSetTarget>;
    return static_cast<x11::XFixes::SaveSetTarget>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::SaveSetMapping operator|(x11::XFixes::SaveSetMapping l, x11::XFixes::SaveSetMapping r)
{
    using T = std::underlying_type_t<x11::XFixes::SaveSetMapping>;
    return static_cast<x11::XFixes::SaveSetMapping>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::SelectionEvent operator|(x11::XFixes::SelectionEvent l, x11::XFixes::SelectionEvent r)
{
    using T = std::underlying_type_t<x11::XFixes::SelectionEvent>;
    return static_cast<x11::XFixes::SelectionEvent>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::SelectionEventMask operator|(x11::XFixes::SelectionEventMask l, x11::XFixes::SelectionEventMask r)
{
    using T = std::underlying_type_t<x11::XFixes::SelectionEventMask>;
    return static_cast<x11::XFixes::SelectionEventMask>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::CursorNotify operator|(x11::XFixes::CursorNotify l, x11::XFixes::CursorNotify r)
{
    using T = std::underlying_type_t<x11::XFixes::CursorNotify>;
    return static_cast<x11::XFixes::CursorNotify>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::CursorNotifyMask operator|(x11::XFixes::CursorNotifyMask l, x11::XFixes::CursorNotifyMask r)
{
    using T = std::underlying_type_t<x11::XFixes::CursorNotifyMask>;
    return static_cast<x11::XFixes::CursorNotifyMask>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::Region operator|(x11::XFixes::Region l, x11::XFixes::Region r)
{
    using T = std::underlying_type_t<x11::XFixes::Region>;
    return static_cast<x11::XFixes::Region>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::BarrierDirections operator|(x11::XFixes::BarrierDirections l, x11::XFixes::BarrierDirections r)
{
    using T = std::underlying_type_t<x11::XFixes::BarrierDirections>;
    return static_cast<x11::XFixes::BarrierDirections>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::XFixes::ClientDisconnectFlags operator|(x11::XFixes::ClientDisconnectFlags l, x11::XFixes::ClientDisconnectFlags r)
{
    using T = std::underlying_type_t<x11::XFixes::ClientDisconnectFlags>;
    return static_cast<x11::XFixes::ClientDisconnectFlags>(static_cast<T>(l) | static_cast<T>(r));
}
