...
struct Drawable {
    ...
    Drawable(Pixmap value)
        : value { static_cast<uint32_t>(value) }
    {
    }
    operator Pixmap() const
    {
        return static_cast<Pixmap>(value);
    }
...
struct Fontable {
    ...
    operator Font() const
    {
        return static_cast<Font>(value);
    }

    Fontable(GraphicsContext value)
        : value { static_cast<uint32_t>(value) }
    {
    }
...
struct Arc {
    ...
    {
        return x == other.x && y == other.y && width == other.width && height == other.height && angle1 == other.angle1 && angle2 == other.angle2;
    }
...
struct Format {
    ...
    {
        return depth == other.depth && bits_per_pixel == other.bits_per_pixel && scanline_pad == other.scanline_pad;
    }
...
struct VisualType {
    ...
    {
        return visual_id == other.visual_id && c_class == other.c_class && bits_per_rgb_value == other.bits_per_rgb_value
            && colormap_entries == other.colormap_entries && red_mask == other.red_mask && green_mask == other.green_mask && blue_mask == other.blue_mask;
    }
...
struct Screen {
    ...
    {
        return root == other.root && default_colormap == other.default_colormap && white_pixel == other.white_pixel && black_pixel == other.black_pixel
            && current_input_masks == other.current_input_masks && width_in_pixels == other.width_in_pixels && height_in_pixels == other.height_in_pixels
            && width_in_millimeters == other.width_in_millimeters && height_in_millimeters == other.height_in_millimeters
            && min_installed_maps == other.min_installed_maps && max_installed_maps == other.max_installed_maps && root_visual == other.root_visual
            && backing_stores == other.backing_stores && save_unders == other.save_unders && root_depth == other.root_depth
...
struct SetupRequest {
    ...
    {
        return byte_order == other.byte_order && protocol_major_version == other.protocol_major_version
            && protocol_minor_version == other.protocol_minor_version && authorization_protocol_name == other.authorization_protocol_name
...
struct SetupFailed {
    ...
    {
        return status == other.status && protocol_major_version == other.protocol_major_version && protocol_minor_version == other.protocol_minor_version
...
struct SetupAuthenticate {
    ...
    {
        return status == other.status && length == other.length && reason == other.reason;
    }
...
struct Setup {
    ...
    {
        return status == other.status && protocol_major_version == other.protocol_major_version && protocol_minor_version == other.protocol_minor_version
            && length == other.length && release_number == other.release_number && resource_id_base == other.resource_id_base
            && resource_id_mask == other.resource_id_mask && motion_buffer_size == other.motion_buffer_size
            && maximum_request_length == other.maximum_request_length && image_byte_order == other.image_byte_order
            && bitmap_format_bit_order == other.bitmap_format_bit_order && bitmap_format_scanline_unit == other.bitmap_format_scanline_unit
            && bitmap_format_scanline_pad == other.bitmap_format_scanline_pad && min_keycode == other.min_keycode && max_keycode == other.max_keycode
            && vendor == other.vendor && pixmap_formats == other.pixmap_formats && roots == other.roots;
    }
...
struct CharInfo {
    ...
    {
        return left_side_bearing == other.left_side_bearing && right_side_bearing == other.right_side_bearing && character_width == other.character_width
            && ascent == other.ascent && descent == other.descent && attributes == other.attributes;
    }
...
struct ColorItem {
    ...
    {
        return pixel == other.pixel && red == other.red && green == other.green && blue == other.blue && flags == other.flags;
    }
...
public:
    ...
    Future<void> CreateWindow(const uint8_t& depth = {}, const Window& wid = {}, const Window& parent = {}, const int16_t& x = {}, const int16_t& y = {},
        const uint16_t& width = {}, const uint16_t& height = {}, const uint16_t& border_width = {}, const WindowClass& c_class = {},
        const VisualId& visual = {}, const std::optional<Pixmap>& background_pixmap = std::nullopt,
        const std::optional<uint32_t>& background_pixel = std::nullopt, const std::optional<Pixmap>& border_pixmap = std::nullopt,
        const std::optional<uint32_t>& border_pixel = std::nullopt, const std::optional<Gravity>& bit_gravity = std::nullopt,
        const std::optional<Gravity>& win_gravity = std::nullopt, const std::optional<BackingStore>& backing_store = std::nullopt,
        const std::optional<uint32_t>& backing_planes = std::nullopt, const std::optional<uint32_t>& backing_pixel = std::nullopt,
        const std::optional<Bool32>& override_redirect = std::nullopt, const std::optional<Bool32>& save_under = std::nullopt,
        const std::optional<EventMask>& event_mask = std::nullopt, const std::optional<EventMask>& do_not_propogate_mask = std::nullopt,
        const std::optional<ColorMap>& colormap = std::nullopt, const std::optional<Cursor>& cursor = std::nullopt);

    Future<void> ChangeWindowAttributes(const ChangeWindowAttributesRequest& request);

    Future<void> ChangeWindowAttributes(const Window& window = {}, const std::optional<Pixmap>& background_pixmap = std::nullopt,
        const std::optional<uint32_t>& background_pixel = std::nullopt, const std::optional<Pixmap>& border_pixmap = std::nullopt,
        const std::optional<uint32_t>& border_pixel = std::nullopt, const std::optional<Gravity>& bit_gravity = std::nullopt,
        const std::optional<Gravity>& win_gravity = std::nullopt, const std::optional<BackingStore>& backing_store = std::nullopt,
        const std::optional<uint32_t>& backing_planes = std::nullopt, const std::optional<uint32_t>& backing_pixel = std::nullopt,
    ...
    Future<GetWindowAttributesReply> GetWindowAttributes(const GetWindowAttributesRequest& request);

    Future<GetWindowAttributesReply> GetWindowAttributes(const Window& window = {});
    ...
    Future<void> ChangeSaveSet(const SetMode& mode = {}, const Window& window = {});

    Future<void> ReparentWindow(const ReparentWindowRequest& request);

    Future<void> ReparentWindow(const Window& window = {}, const Window& parent = {}, const int16_t& x = {}, const int16_t& y = {});
    ...
    Future<void> ConfigureWindow(const Window& window = {}, const std::optional<int32_t>& x = std::nullopt, const std::optional<int32_t>& y = std::nullopt,
        const std::optional<uint32_t>& width = std::nullopt, const std::optional<uint32_t>& height = std::nullopt,
        const std::optional<uint32_t>& border_width = std::nullopt, const std::optional<Window>& sibling = std::nullopt,
        const std::optional<StackMode>& stack_mode = std::nullopt);

    Future<void> CirculateWindow(const CirculateWindowRequest& request);

    Future<void> CirculateWindow(const Circulate& direction = {}, const Window& window = {});
    ...
    Future<InternAtomReply> InternAtom(const uint8_t& only_if_exists = {}, const std::string& name = {});
    ...
    Future<void> ChangeProperty(const PropMode& mode = {}, const Window& window = {}, const Atom& property = {}, const Atom& type = {},
        const uint8_t& format = {}, const uint32_t& data_len = {}, const scoped_refptr<base::RefCountedMemory>& data = {});

    Future<void> DeleteProperty(const DeletePropertyRequest& request);

    Future<void> DeleteProperty(const Window& window = {}, const Atom& property = {});

    Future<GetPropertyReply> GetProperty(const GetPropertyRequest& request);

    Future<GetPropertyReply> GetProperty(const uint8_t& c_delete = {}, const Window& window = {}, const Atom& property = {}, const Atom& type = {},
        const uint32_t& long_offset = {}, const uint32_t& long_length = {});

    Future<ListPropertiesReply> ListProperties(const ListPropertiesRequest& request);
    ...
    Future<void> SetSelectionOwner(const Window& owner = {}, const Atom& selection = {}, const Time& time = {});

    Future<GetSelectionOwnerReply> GetSelectionOwner(const GetSelectionOwnerRequest& request);
    ...
    Future<void> ConvertSelection(
        const Window& requestor = {}, const Atom& selection = {}, const Atom& target = {}, const Atom& property = {}, const Time& time = {});

    Future<void> SendEvent(const SendEventRequest& request);

    Future<void> SendEvent(
        const uint8_t& propagate = {}, const Window& destination = {}, const EventMask& event_mask = {}, const std::array<char, 32>& event = {});

    Future<GrabPointerReply> GrabPointer(const GrabPointerRequest& request);

    Future<GrabPointerReply> GrabPointer(const uint8_t& owner_events = {}, const Window& grab_window = {}, const EventMask& event_mask = {},
        const GrabMode& pointer_mode = {}, const GrabMode& keyboard_mode = {}, const Window& confine_to = {}, const Cursor& cursor = {}, const Time& time = {});
    ...
    Future<void> GrabButton(const uint8_t& owner_events = {}, const Window& grab_window = {}, const EventMask& event_mask = {},
        const GrabMode& pointer_mode = {}, const GrabMode& keyboard_mode = {}, const Window& confine_to = {}, const Cursor& cursor = {},
        const ButtonIndex& button = {}, const ModMask& modifiers = {});

    Future<void> UngrabButton(const UngrabButtonRequest& request);

    Future<void> UngrabButton(const ButtonIndex& button = {}, const Window& grab_window = {}, const ModMask& modifiers = {});

    Future<void> ChangeActivePointerGrab(const ChangeActivePointerGrabRequest& request);

    Future<void> ChangeActivePointerGrab(const Cursor& cursor = {}, const Time& time = {}, const EventMask& event_mask = {});

    Future<GrabKeyboardReply> GrabKeyboard(const GrabKeyboardRequest& request);

    Future<GrabKeyboardReply> GrabKeyboard(const uint8_t& owner_events = {}, const Window& grab_window = {}, const Time& time = {},
        const GrabMode& pointer_mode = {}, const GrabMode& keyboard_mode = {});
    ...
    Future<void> GrabKey(const uint8_t& owner_events = {}, const Window& grab_window = {}, const ModMask& modifiers = {}, const KeyCode& key = {},
        const GrabMode& pointer_mode = {}, const GrabMode& keyboard_mode = {});

    Future<void> UngrabKey(const UngrabKeyRequest& request);

    Future<void> UngrabKey(const KeyCode& key = {}, const Window& grab_window = {}, const ModMask& modifiers = {});
    ...
    Future<GetMotionEventsReply> GetMotionEvents(const GetMotionEventsRequest& request);

    Future<GetMotionEventsReply> GetMotionEvents(const Window& window = {}, const Time& start = {}, const Time& stop = {});

    Future<TranslateCoordinatesReply> TranslateCoordinates(const TranslateCoordinatesRequest& request);

    Future<TranslateCoordinatesReply> TranslateCoordinates(
        const Window& src_window = {}, const Window& dst_window = {}, const int16_t& src_x = {}, const int16_t& src_y = {});

    Future<void> WarpPointer(const WarpPointerRequest& request);

    Future<void> WarpPointer(const Window& src_window = {}, const Window& dst_window = {}, const int16_t& src_x = {}, const int16_t& src_y = {},
        const uint16_t& src_width = {}, const uint16_t& src_height = {}, const int16_t& dst_x = {}, const int16_t& dst_y = {});

    Future<void> SetInputFocus(const SetInputFocusRequest& request);

    Future<void> SetInputFocus(const InputFocus& revert_to = {}, const Window& focus = {}, const Time& time = {});
    ...
    Future<QueryTextExtentsReply> QueryTextExtents(const QueryTextExtentsRequest& request);

    Future<QueryTextExtentsReply> QueryTextExtents(const Fontable& font = {}, const std::vector<Char16>& string = {});

    Future<ListFontsReply> ListFonts(const ListFontsRequest& request);

    Future<ListFontsReply> ListFonts(const uint16_t& max_names = {}, const std::string& pattern = {});

    Future<ListFontsWithInfoReply> ListFontsWithInfo(const ListFontsWithInfoRequest& request);

    Future<ListFontsWithInfoReply> ListFontsWithInfo(const uint16_t& max_names = {}, const std::string& pattern = {});
    ...
    Future<void> CreatePixmap(
        const uint8_t& depth = {}, const Pixmap& pid = {}, const Drawable& drawable = {}, const uint16_t& width = {}, const uint16_t& height = {});
    ...
    Future<void> CreateGC(const GraphicsContext& cid = {}, const Drawable& drawable = {}, const std::optional<Gx>& function = std::nullopt,
        const std::optional<uint32_t>& plane_mask = std::nullopt, const std::optional<uint32_t>& foreground = std::nullopt,
        const std::optional<uint32_t>& background = std::nullopt, const std::optional<uint32_t>& line_width = std::nullopt,
        const std::optional<LineStyle>& line_style = std::nullopt, const std::optional<CapStyle>& cap_style = std::nullopt,
        const std::optional<JoinStyle>& join_style = std::nullopt, const std::optional<FillStyle>& fill_style = std::nullopt,
        const std::optional<FillRule>& fill_rule = std::nullopt, const std::optional<Pixmap>& tile = std::nullopt,
        const std::optional<Pixmap>& stipple = std::nullopt, const std::optional<int32_t>& tile_stipple_x_origin = std::nullopt,
        const std::optional<int32_t>& tile_stipple_y_origin = std::nullopt, const std::optional<Font>& font = std::nullopt,
        const std::optional<SubwindowMode>& subwindow_mode = std::nullopt, const std::optional<Bool32>& graphics_exposures = std::nullopt,
        const std::optional<int32_t>& clip_x_origin = std::nullopt, const std::optional<int32_t>& clip_y_origin = std::nullopt,
        const std::optional<Pixmap>& clip_mask = std::nullopt, const std::optional<uint32_t>& dash_offset = std::nullopt,
        const std::optional<uint32_t>& dashes = std::nullopt, const std::optional<ArcMode>& arc_mode = std::nullopt);

    Future<void> ChangeGC(const ChangeGCRequest& request);

    Future<void> ChangeGC(const GraphicsContext& gc = {}, const std::optional<Gx>& function = std::nullopt,
        const std::optional<uint32_t>& plane_mask = std::nullopt, const std::optional<uint32_t>& foreground = std::nullopt,
        const std::optional<uint32_t>& background = std::nullopt, const std::optional<uint32_t>& line_width = std::nullopt,
        const std::optional<LineStyle>& line_style = std::nullopt, const std::optional<CapStyle>& cap_style = std::nullopt,
        const std::optional<JoinStyle>& join_style = std::nullopt, const std::optional<FillStyle>& fill_style = std::nullopt,
    ...
    Future<void> CopyGC(const GraphicsContext& src_gc = {}, const GraphicsContext& dst_gc = {}, const GraphicsContextAttribute& value_mask = {});

    Future<void> SetDashes(const SetDashesRequest& request);

    Future<void> SetDashes(const GraphicsContext& gc = {}, const uint16_t& dash_offset = {}, const std::vector<uint8_t>& dashes = {});

    Future<void> SetClipRectangles(const SetClipRectanglesRequest& request);

    Future<void> SetClipRectangles(const ClipOrdering& ordering = {}, const GraphicsContext& gc = {}, const int16_t& clip_x_origin = {},
        const int16_t& clip_y_origin = {}, const std::vector<Rectangle>& rectangles = {});
    ...
    Future<void> ClearArea(const uint8_t& exposures = {}, const Window& window = {}, const int16_t& x = {}, const int16_t& y = {}, const uint16_t& width = {},
        const uint16_t& height = {});

    Future<void> CopyArea(const CopyAreaRequest& request);

    Future<void> CopyArea(const Drawable& src_drawable = {}, const Drawable& dst_drawable = {}, const GraphicsContext& gc = {}, const int16_t& src_x = {},
        const int16_t& src_y = {}, const int16_t& dst_x = {}, const int16_t& dst_y = {}, const uint16_t& width = {}, const uint16_t& height = {});

    Future<void> CopyPlane(const CopyPlaneRequest& request);

    Future<void> CopyPlane(const Drawable& src_drawable = {}, const Drawable& dst_drawable = {}, const GraphicsContext& gc = {}, const int16_t& src_x = {},
        const int16_t& src_y = {}, const int16_t& dst_x = {}, const int16_t& dst_y = {}, const uint16_t& width = {}, const uint16_t& height = {},
    ...
    Future<void> PolyPoint(
        const CoordMode& coordinate_mode = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Point>& points = {});
    ...
    Future<void> PolySegment(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Segment>& segments = {});

    Future<void> PolyRectangle(const PolyRectangleRequest& request);

    Future<void> PolyRectangle(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Rectangle>& rectangles = {});

    Future<void> PolyArc(const PolyArcRequest& request);

    Future<void> PolyArc(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Arc>& arcs = {});

    Future<void> FillPoly(const FillPolyRequest& request);

    Future<void> FillPoly(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const PolyShape& shape = {}, const CoordMode& coordinate_mode = {},
        const std::vector<Point>& points = {});

    Future<void> PolyFillRectangle(const PolyFillRectangleRequest& request);

    Future<void> PolyFillRectangle(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Rectangle>& rectangles = {});

    Future<void> PolyFillArc(const PolyFillArcRequest& request);

    Future<void> PolyFillArc(const Drawable& drawable = {}, const GraphicsContext& gc = {}, const std::vector<Arc>& arcs = {});

    Future<void> PutImage(const PutImageRequest& request);

    Future<void> PutImage(const ImageFormat& format = {}, const Drawable& drawable = {}, const GraphicsContext& gc = {}, const uint16_t& width = {},
        const uint16_t& height = {}, const int16_t& dst_x = {}, const int16_t& dst_y = {}, const uint8_t& left_pad = {}, const uint8_t& depth = {},
        const scoped_refptr<base::RefCountedMemory>& data = {});

    Future<GetImageReply> GetImage(const GetImageRequest& request);

    Future<GetImageReply> GetImage(const ImageFormat& format = {}, const Drawable& drawable = {}, const int16_t& x = {}, const int16_t& y = {},
        const uint16_t& width = {}, const uint16_t& height = {}, const uint32_t& plane_mask = {});

    Future<void> PolyText8(const PolyText8Request& request);

    Future<void> PolyText8(
        const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& x = {}, const int16_t& y = {}, const std::vector<uint8_t>& items = {});
    ...
    Future<void> ImageText8(
        const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& x = {}, const int16_t& y = {}, const std::string& string = {});

    Future<void> ImageText16(const ImageText16Request& request);

    Future<void> ImageText16(
        const Drawable& drawable = {}, const GraphicsContext& gc = {}, const int16_t& x = {}, const int16_t& y = {}, const std::vector<Char16>& string = {});

    Future<void> CreateColormap(const CreateColormapRequest& request);

    Future<void> CreateColormap(const ColormapAlloc& alloc = {}, const ColorMap& mid = {}, const Window& window = {}, const VisualId& visual = {});
    ...
    Future<void> CopyColormapAndFree(const ColorMap& mid = {}, const ColorMap& src_cmap = {});
    ...
    Future<ListInstalledColormapsReply> ListInstalledColormaps(const ListInstalledColormapsRequest& request);

    Future<ListInstalledColormapsReply> ListInstalledColormaps(const Window& window = {});

    Future<AllocColorReply> AllocColor(const AllocColorRequest& request);

    Future<AllocColorReply> AllocColor(const ColorMap& cmap = {}, const uint16_t& red = {}, const uint16_t& green = {}, const uint16_t& blue = {});

    Future<AllocNamedColorReply> AllocNamedColor(const AllocNamedColorRequest& request);

    Future<AllocNamedColorReply> AllocNamedColor(const ColorMap& cmap = {}, const std::string& name = {});

    Future<AllocColorCellsReply> AllocColorCells(const AllocColorCellsRequest& request);

    Future<AllocColorCellsReply> AllocColorCells(
        const uint8_t& contiguous = {}, const ColorMap& cmap = {}, const uint16_t& colors = {}, const uint16_t& planes = {});

    Future<AllocColorPlanesReply> AllocColorPlanes(const AllocColorPlanesRequest& request);

    Future<AllocColorPlanesReply> AllocColorPlanes(const uint8_t& contiguous = {}, const ColorMap& cmap = {}, const uint16_t& colors = {},
        const uint16_t& reds = {}, const uint16_t& greens = {}, const uint16_t& blues = {});

    Future<void> FreeColors(const FreeColorsRequest& request);

    Future<void> FreeColors(const ColorMap& cmap = {}, const uint32_t& plane_mask = {}, const std::vector<uint32_t>& pixels = {});

    Future<void> StoreColors(const StoreColorsRequest& request);

    Future<void> StoreColors(const ColorMap& cmap = {}, const std::vector<ColorItem>& items = {});

    Future<void> StoreNamedColor(const StoreNamedColorRequest& request);

    Future<void> StoreNamedColor(const ColorFlag& flags = {}, const ColorMap& cmap = {}, const uint32_t& pixel = {}, const std::string& name = {});

    Future<QueryColorsReply> QueryColors(const QueryColorsRequest& request);

    Future<QueryColorsReply> QueryColors(const ColorMap& cmap = {}, const std::vector<uint32_t>& pixels = {});

    Future<LookupColorReply> LookupColor(const LookupColorRequest& request);

    Future<LookupColorReply> LookupColor(const ColorMap& cmap = {}, const std::string& name = {});

    Future<void> CreateCursor(const CreateCursorRequest& request);

    Future<void> CreateCursor(const Cursor& cid = {}, const Pixmap& source = {}, const Pixmap& mask = {}, const uint16_t& fore_red = {},
        const uint16_t& fore_green = {}, const uint16_t& fore_blue = {}, const uint16_t& back_red = {}, const uint16_t& back_green = {},
        const uint16_t& back_blue = {}, const uint16_t& x = {}, const uint16_t& y = {});

    Future<void> CreateGlyphCursor(const CreateGlyphCursorRequest& request);

    Future<void> CreateGlyphCursor(const Cursor& cid = {}, const Font& source_font = {}, const Font& mask_font = {}, const uint16_t& source_char = {},
        const uint16_t& mask_char = {}, const uint16_t& fore_red = {}, const uint16_t& fore_green = {}, const uint16_t& fore_blue = {},
    ...
    Future<void> RecolorCursor(const Cursor& cursor = {}, const uint16_t& fore_red = {}, const uint16_t& fore_green = {}, const uint16_t& fore_blue = {},
        const uint16_t& back_red = {}, const uint16_t& back_green = {}, const uint16_t& back_blue = {});

    Future<QueryBestSizeReply> QueryBestSize(const QueryBestSizeRequest& request);

    Future<QueryBestSizeReply> QueryBestSize(
        const QueryShapeOf& c_class = {}, const Drawable& drawable = {}, const uint16_t& width = {}, const uint16_t& height = {});

    Future<QueryExtensionReply> QueryExtension(const QueryExtensionRequest& request);

    Future<QueryExtensionReply> QueryExtension(const std::string& name = {});

    Future<ListExtensionsReply> ListExtensions(const ListExtensionsRequest& request);

    Future<ListExtensionsReply> ListExtensions();

    Future<void> ChangeKeyboardMapping(const ChangeKeyboardMappingRequest& request);
    ...
    Future<GetKeyboardMappingReply> GetKeyboardMapping(const GetKeyboardMappingRequest& request);

    Future<GetKeyboardMappingReply> GetKeyboardMapping(const KeyCode& first_keycode = {}, const uint8_t& count = {});

    Future<void> ChangeKeyboardControl(const ChangeKeyboardControlRequest& request);

    Future<void> ChangeKeyboardControl(const std::optional<int32_t>& key_click_percent = std::nullopt,
        const std::optional<int32_t>& bell_percent = std::nullopt, const std::optional<int32_t>& bell_pitch = std::nullopt,
        const std::optional<int32_t>& bell_duration = std::nullopt, const std::optional<uint32_t>& led = std::nullopt,
        const std::optional<LedMode>& led_mode = std::nullopt, const std::optional<KeyCode32>& key = std::nullopt,
        const std::optional<AutoRepeatMode>& auto_repeat_mode = std::nullopt);

    Future<GetKeyboardControlReply> GetKeyboardControl(const GetKeyboardControlRequest& request);
    ...
    Future<void> ChangePointerControl(const int16_t& acceleration_numerator = {}, const int16_t& acceleration_denominator = {}, const int16_t& threshold = {},
        const uint8_t& do_acceleration = {}, const uint8_t& do_threshold = {});

    Future<GetPointerControlReply> GetPointerControl(const GetPointerControlRequest& request);
    ...
    Future<void> SetScreenSaver(
        const int16_t& timeout = {}, const int16_t& interval = {}, const Blanking& prefer_blanking = {}, const Exposures& allow_exposures = {});

    Future<GetScreenSaverReply> GetScreenSaver(const GetScreenSaverRequest& request);

    Future<GetScreenSaverReply> GetScreenSaver();

    Future<void> ChangeHosts(const ChangeHostsRequest& request);

    Future<void> ChangeHosts(const HostMode& mode = {}, const Family& family = {}, const std::vector<uint8_t>& address = {});
    ...
    Future<void> RotateProperties(const Window& window = {}, const int16_t& delta = {}, const std::vector<Atom>& atoms = {});
    ...
    Future<SetPointerMappingReply> SetPointerMapping(const SetPointerMappingRequest& request);

    Future<SetPointerMappingReply> SetPointerMapping(const std::vector<uint8_t>& map = {});

    Future<GetPointerMappingReply> GetPointerMapping(const GetPointerMappingRequest& request);

    Future<GetPointerMappingReply> GetPointerMapping();

    Future<SetModifierMappingReply> SetModifierMapping(const SetModifierMappingRequest& request);

    Future<SetModifierMappingReply> SetModifierMapping(const uint8_t& keycodes_per_modifier = {}, const std::vector<KeyCode>& keycodes = {});

    Future<GetModifierMappingReply> GetModifierMapping(const GetModifierMappingRequest& request);
...
inline constexpr x11::VisualClass operator|(x11::VisualClass l, x11::VisualClass r)
{
...
inline constexpr x11::BackingStore operator|(x11::BackingStore l, x11::BackingStore r)
{
...
inline constexpr x11::ImageOrder operator|(x11::ImageOrder l, x11::ImageOrder r)
{
...
inline constexpr x11::KeyButMask operator|(x11::KeyButMask l, x11::KeyButMask r)
{
...
inline constexpr x11::ButtonMask operator|(x11::ButtonMask l, x11::ButtonMask r)
{
...
inline constexpr x11::NotifyDetail operator|(x11::NotifyDetail l, x11::NotifyDetail r)
{
...
inline constexpr x11::NotifyMode operator|(x11::NotifyMode l, x11::NotifyMode r)
{
...
inline constexpr x11::Visibility operator|(x11::Visibility l, x11::Visibility r)
{
...
inline constexpr x11::ColormapState operator|(x11::ColormapState l, x11::ColormapState r)
{
...
inline constexpr x11::WindowClass operator|(x11::WindowClass l, x11::WindowClass r)
{
...
inline constexpr x11::CreateWindowAttribute operator|(x11::CreateWindowAttribute l, x11::CreateWindowAttribute r)
{
    using T = std::underlying_type_t<x11::CreateWindowAttribute>;
    return static_cast<x11::CreateWindowAttribute>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::BackPixmap operator|(x11::BackPixmap l, x11::BackPixmap r)
{
...
inline constexpr x11::ConfigWindow operator|(x11::ConfigWindow l, x11::ConfigWindow r)
{
...
inline constexpr x11::GetPropertyType operator|(x11::GetPropertyType l, x11::GetPropertyType r)
{
    using T = std::underlying_type_t<x11::GetPropertyType>;
    return static_cast<x11::GetPropertyType>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::SendEventDest operator|(x11::SendEventDest l, x11::SendEventDest r)
{
...
inline constexpr x11::GrabStatus operator|(x11::GrabStatus l, x11::GrabStatus r)
{
...
inline constexpr x11::ButtonIndex operator|(x11::ButtonIndex l, x11::ButtonIndex r)
{
...
inline constexpr x11::InputFocus operator|(x11::InputFocus l, x11::InputFocus r)
{
...
inline constexpr x11::GraphicsContextAttribute operator|(x11::GraphicsContextAttribute l, x11::GraphicsContextAttribute r)
{
    using T = std::underlying_type_t<x11::GraphicsContextAttribute>;
    return static_cast<x11::GraphicsContextAttribute>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::SubwindowMode operator|(x11::SubwindowMode l, x11::SubwindowMode r)
{
...
inline constexpr x11::ClipOrdering operator|(x11::ClipOrdering l, x11::ClipOrdering r)
{
...
inline constexpr x11::ImageFormat operator|(x11::ImageFormat l, x11::ImageFormat r)
{
...
inline constexpr x11::ColormapAlloc operator|(x11::ColormapAlloc l, x11::ColormapAlloc r)
{
...
inline constexpr x11::QueryShapeOf operator|(x11::QueryShapeOf l, x11::QueryShapeOf r)
{
...
inline constexpr x11::AutoRepeatMode operator|(x11::AutoRepeatMode l, x11::AutoRepeatMode r)
{
    using T = std::underlying_type_t<x11::AutoRepeatMode>;
    return static_cast<x11::AutoRepeatMode>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::AccessControl operator|(x11::AccessControl l, x11::AccessControl r)
{
...
inline constexpr x11::ScreenSaverMode operator|(x11::ScreenSaverMode l, x11::ScreenSaverMode r)
{
    using T = std::underlying_type_t<x11::ScreenSaverMode>;
    return static_cast<x11::ScreenSaverMode>(static_cast<T>(l) | static_cast<T>(r));
}
...
inline constexpr x11::MappingStatus operator|(x11::MappingStatus l, x11::MappingStatus r)
{
