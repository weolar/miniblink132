...
template <> void ReadError<Sync::CounterError>(Sync::CounterError* error_, ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
template <> void ReadError<Sync::AlarmError>(Sync::AlarmError* error_, ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
template <> COMPONENT_EXPORT(X11) void ReadEvent<Sync::CounterNotifyEvent>(Sync::CounterNotifyEvent* event_, ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
template <> COMPONENT_EXPORT(X11) void ReadEvent<Sync::AlarmNotifyEvent>(Sync::AlarmNotifyEvent* event_, ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<Sync::InitializeReply> Sync::Initialize(const Sync::InitializeRequest& request)
{
    ...
    return connection_->SendRequest<Sync::InitializeReply>(&buf, "Sync::Initialize", false);
}

Future<Sync::InitializeReply> Sync::Initialize(const uint8_t& desired_major_version, const uint8_t& desired_minor_version)
{
    return Sync::Initialize(Sync::InitializeRequest { desired_major_version, desired_minor_version });
}

template <> COMPONENT_EXPORT(X11) std::unique_ptr<Sync::InitializeReply> detail::ReadReply<Sync::InitializeReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<Sync::ListSystemCountersReply> Sync::ListSystemCounters(const Sync::ListSystemCountersRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Sync::ListSystemCountersReply>(&buf, "Sync::ListSystemCounters", false);
}
...
template <> COMPONENT_EXPORT(X11) std::unique_ptr<Sync::ListSystemCountersReply> detail::ReadReply<Sync::ListSystemCountersReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> Sync::CreateCounter(const Counter& id, const Int64& initial_value)
{
...
Future<Sync::QueryCounterReply> Sync::QueryCounter(const Sync::QueryCounterRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Sync::QueryCounterReply>(&buf, "Sync::QueryCounter", false);
}
...
template <> COMPONENT_EXPORT(X11) std::unique_ptr<Sync::QueryCounterReply> detail::ReadReply<Sync::QueryCounterReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> Sync::CreateAlarm(const Sync::CreateAlarmRequest& request)
{
    ...
    // value_mask
    SwitchVar(ChangeAlarmAttribute::Counter, value_list.counter.has_value(), true, &value_mask);
    SwitchVar(ChangeAlarmAttribute::ValueType, value_list.valueType.has_value(), true, &value_mask);
    SwitchVar(ChangeAlarmAttribute::Value, value_list.value.has_value(), true, &value_mask);
    SwitchVar(ChangeAlarmAttribute::TestType, value_list.testType.has_value(), true, &value_mask);
    SwitchVar(ChangeAlarmAttribute::Delta, value_list.delta.has_value(), true, &value_mask);
    SwitchVar(ChangeAlarmAttribute::Events, value_list.events.has_value(), true, &value_mask);
    uint32_t tmp3;
...
Future<void> Sync::CreateAlarm(const Alarm& id, const std::optional<Counter>& counter, const std::optional<Valuetype>& valueType,
    const std::optional<Int64>& value, const std::optional<Testtype>& testType, const std::optional<Int64>& delta, const std::optional<uint32_t>& events)
{
    return Sync::CreateAlarm(Sync::CreateAlarmRequest { id, counter, valueType, value, testType, delta, events });
}
...
Future<void> Sync::ChangeAlarm(const Alarm& id, const std::optional<Counter>& counter, const std::optional<Valuetype>& valueType,
    const std::optional<Int64>& value, const std::optional<Testtype>& testType, const std::optional<Int64>& delta, const std::optional<uint32_t>& events)
{
    return Sync::ChangeAlarm(Sync::ChangeAlarmRequest { id, counter, valueType, value, testType, delta, events });
}
...
Future<Sync::QueryAlarmReply> Sync::QueryAlarm(const Sync::QueryAlarmRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Sync::QueryAlarmReply>(&buf, "Sync::QueryAlarm", false);
}
...
template <> COMPONENT_EXPORT(X11) std::unique_ptr<Sync::QueryAlarmReply> detail::ReadReply<Sync::QueryAlarmReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<Sync::GetPriorityReply> Sync::GetPriority(const Sync::GetPriorityRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Sync::GetPriorityReply>(&buf, "Sync::GetPriority", false);
}
...
template <> COMPONENT_EXPORT(X11) std::unique_ptr<Sync::GetPriorityReply> detail::ReadReply<Sync::GetPriorityReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
...
Future<void> Sync::CreateFence(const Drawable& drawable, const Fence& fence, const uint8_t& initially_triggered)
{
    return Sync::CreateFence(Sync::CreateFenceRequest { drawable, fence, initially_triggered });
}
...
Future<Sync::QueryFenceReply> Sync::QueryFence(const Sync::QueryFenceRequest& request)
{
    if (!connection_->Ready() || !present())
        return {};
    ...
    return connection_->SendRequest<Sync::QueryFenceReply>(&buf, "Sync::QueryFence", false);
}
...
template <> COMPONENT_EXPORT(X11) std::unique_ptr<Sync::QueryFenceReply> detail::ReadReply<Sync::QueryFenceReply>(ReadBuffer* buffer)
{
    auto& buf = *buffer;
