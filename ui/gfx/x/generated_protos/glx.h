...
public:
    ...
    struct Drawable {
        ...
        Drawable(x11::Window value)
            : value { static_cast<uint32_t>(value) }
        {
        }
        operator x11::Window() const
        {
            return static_cast<x11::Window>(value);
        }

        Drawable(PBuffer value)
            : value { static_cast<uint32_t>(value) }
        {
        }
        operator PBuffer() const
        {
            return static_cast<PBuffer>(value);
        }
    ...
    Future<void> Render(const ContextTag& context_tag = {}, const std::vector<uint8_t>& data = {});
    ...
    Future<void> RenderLarge(
        const ContextTag& context_tag = {}, const uint16_t& request_num = {}, const uint16_t& request_total = {}, const std::vector<uint8_t>& data = {});
    ...
    Future<void> CreateContext(
        const Context& context = {}, const VisualId& visual = {}, const uint32_t& screen = {}, const Context& share_list = {}, const uint8_t& is_direct = {});
    ...
    Future<MakeCurrentReply> MakeCurrent(const Drawable& drawable = {}, const Context& context = {}, const ContextTag& old_context_tag = {});
    ...
    Future<QueryVersionReply> QueryVersion(const uint32_t& major_version = {}, const uint32_t& minor_version = {});
    ...
    Future<void> CopyContext(const Context& src = {}, const Context& dest = {}, const uint32_t& mask = {}, const ContextTag& src_context_tag = {});
    ...
    Future<void> SwapBuffers(const ContextTag& context_tag = {}, const Drawable& drawable = {});
    ...
    Future<void> UseXFont(
        const ContextTag& context_tag = {}, const Font& font = {}, const uint32_t& first = {}, const uint32_t& count = {}, const uint32_t& list_base = {});
    ...
    Future<void> CreateGLXPixmap(const uint32_t& screen = {}, const VisualId& visual = {}, const x11::Pixmap& pixmap = {}, const Pixmap& glx_pixmap = {});
    ...
    Future<GetVisualConfigsReply> GetVisualConfigs(const GetVisualConfigsRequest& request);
    ...
    Future<void> VendorPrivate(const uint32_t& vendor_code = {}, const ContextTag& context_tag = {}, const std::vector<uint8_t>& data = {});
    ...
    Future<VendorPrivateWithReplyReply> VendorPrivateWithReply(const VendorPrivateWithReplyRequest& request);
    ...
    Future<QueryExtensionsStringReply> QueryExtensionsString(const QueryExtensionsStringRequest& request);

    Future<QueryExtensionsStringReply> QueryExtensionsString(const uint32_t& screen = {});
    ...
    Future<QueryServerStringReply> QueryServerString(const QueryServerStringRequest& request);

    Future<QueryServerStringReply> QueryServerString(const uint32_t& screen = {}, const uint32_t& name = {});
    ...
    Future<void> ClientInfo(const uint32_t& major_version = {}, const uint32_t& minor_version = {}, const std::string& string = {});
    ...
    Future<void> CreatePixmap(const uint32_t& screen = {}, const FbConfig& fbconfig = {}, const x11::Pixmap& pixmap = {}, const Pixmap& glx_pixmap = {},
    ...
    Future<void> CreateNewContext(const Context& context = {}, const FbConfig& fbconfig = {}, const uint32_t& screen = {}, const uint32_t& render_type = {},
        const Context& share_list = {}, const uint8_t& is_direct = {});
    ...
    Future<MakeContextCurrentReply> MakeContextCurrent(const MakeContextCurrentRequest& request);
    ...
    Future<void> CreatePbuffer(const uint32_t& screen = {}, const FbConfig& fbconfig = {}, const PBuffer& pbuffer = {}, const uint32_t& num_attribs = {},
    ...
    Future<GetDrawableAttributesReply> GetDrawableAttributes(const GetDrawableAttributesRequest& request);

    Future<GetDrawableAttributesReply> GetDrawableAttributes(const Drawable& drawable = {});
    ...
    Future<void> ChangeDrawableAttributes(const ChangeDrawableAttributesRequest& request);

    Future<void> ChangeDrawableAttributes(const Drawable& drawable = {}, const uint32_t& num_attribs = {}, const std::vector<uint32_t>& attribs = {});
    ...
    Future<void> CreateWindow(const uint32_t& screen = {}, const FbConfig& fbconfig = {}, const x11::Window& window = {}, const Window& glx_window = {},
        const uint32_t& num_attribs = {}, const std::vector<uint32_t>& attribs = {});
    ...
    Future<void> SetClientInfoARB(const uint32_t& major_version = {}, const uint32_t& minor_version = {}, const uint32_t& num_versions = {},
    ...
    Future<void> CreateContextAttribsARB(const CreateContextAttribsARBRequest& request);

    Future<void> CreateContextAttribsARB(const Context& context = {}, const FbConfig& fbconfig = {}, const uint32_t& screen = {},
        const Context& share_list = {}, const uint8_t& is_direct = {}, const uint32_t& num_attribs = {}, const std::vector<uint32_t>& attribs = {});
    ...
    Future<void> SetClientInfo2ARB(const uint32_t& major_version = {}, const uint32_t& minor_version = {}, const uint32_t& num_versions = {},
        const std::vector<uint32_t>& gl_versions = {}, const std::string& gl_extension_string = {}, const std::string& glx_extension_string = {});
    ...
    Future<void> NewList(const ContextTag& context_tag = {}, const uint32_t& list = {}, const uint32_t& mode = {});
    ...
    Future<void> DeleteLists(const ContextTag& context_tag = {}, const uint32_t& list = {}, const int32_t& range = {});
    ...
    Future<GenListsReply> GenLists(const ContextTag& context_tag = {}, const int32_t& range = {});
    ...
    Future<void> FeedbackBuffer(const ContextTag& context_tag = {}, const int32_t& size = {}, const int32_t& type = {});
    ...
    Future<void> SelectBuffer(const ContextTag& context_tag = {}, const int32_t& size = {});
    ...
    Future<RenderModeReply> RenderMode(const ContextTag& context_tag = {}, const uint32_t& mode = {});
    ...
    Future<void> PixelStoref(const ContextTag& context_tag = {}, const uint32_t& pname = {}, const float& datum = {});
    ...
    Future<void> PixelStorei(const ContextTag& context_tag = {}, const uint32_t& pname = {}, const int32_t& datum = {});
    ...
    Future<ReadPixelsReply> ReadPixels(const ContextTag& context_tag = {}, const int32_t& x = {}, const int32_t& y = {}, const int32_t& width = {},
        const int32_t& height = {}, const uint32_t& format = {}, const uint32_t& type = {}, const uint8_t& swap_bytes = {}, const uint8_t& lsb_first = {});
    ...
    Future<GetBooleanvReply> GetBooleanv(const ContextTag& context_tag = {}, const int32_t& pname = {});
    ...
    Future<GetClipPlaneReply> GetClipPlane(const ContextTag& context_tag = {}, const int32_t& plane = {});
    ...
    Future<GetDoublevReply> GetDoublev(const ContextTag& context_tag = {}, const uint32_t& pname = {});
    ...
    Future<GetFloatvReply> GetFloatv(const ContextTag& context_tag = {}, const uint32_t& pname = {});
    ...
    Future<GetIntegervReply> GetIntegerv(const ContextTag& context_tag = {}, const uint32_t& pname = {});
    ...
    Future<GetLightfvReply> GetLightfv(const ContextTag& context_tag = {}, const uint32_t& light = {}, const uint32_t& pname = {});
    ...
    Future<GetLightivReply> GetLightiv(const ContextTag& context_tag = {}, const uint32_t& light = {}, const uint32_t& pname = {});
    ...
    Future<GetMapdvReply> GetMapdv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& query = {});
    ...
    Future<GetMapfvReply> GetMapfv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& query = {});
    ...
    Future<GetMapivReply> GetMapiv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& query = {});
    ...
    Future<GetMaterialfvReply> GetMaterialfv(const ContextTag& context_tag = {}, const uint32_t& face = {}, const uint32_t& pname = {});
    ...
    Future<GetMaterialivReply> GetMaterialiv(const ContextTag& context_tag = {}, const uint32_t& face = {}, const uint32_t& pname = {});
    ...
    Future<GetPixelMapfvReply> GetPixelMapfv(const ContextTag& context_tag = {}, const uint32_t& map = {});
    ...
    Future<GetPixelMapuivReply> GetPixelMapuiv(const GetPixelMapuivRequest& request);

    Future<GetPixelMapuivReply> GetPixelMapuiv(const ContextTag& context_tag = {}, const uint32_t& map = {});
    ...
    Future<GetPixelMapusvReply> GetPixelMapusv(const GetPixelMapusvRequest& request);

    Future<GetPixelMapusvReply> GetPixelMapusv(const ContextTag& context_tag = {}, const uint32_t& map = {});
    ...
    Future<GetPolygonStippleReply> GetPolygonStipple(const GetPolygonStippleRequest& request);

    Future<GetPolygonStippleReply> GetPolygonStipple(const ContextTag& context_tag = {}, const uint8_t& lsb_first = {});
    ...
    Future<GetStringReply> GetString(const ContextTag& context_tag = {}, const uint32_t& name = {});
    ...
    Future<GetTexEnvfvReply> GetTexEnvfv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetTexEnvivReply> GetTexEnviv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetTexGendvReply> GetTexGendv(const ContextTag& context_tag = {}, const uint32_t& coord = {}, const uint32_t& pname = {});
    ...
    Future<GetTexGenfvReply> GetTexGenfv(const ContextTag& context_tag = {}, const uint32_t& coord = {}, const uint32_t& pname = {});
    ...
    Future<GetTexGenivReply> GetTexGeniv(const ContextTag& context_tag = {}, const uint32_t& coord = {}, const uint32_t& pname = {});
    ...
    Future<GetTexImageReply> GetTexImage(const ContextTag& context_tag = {}, const uint32_t& target = {}, const int32_t& level = {},
        const uint32_t& format = {}, const uint32_t& type = {}, const uint8_t& swap_bytes = {});
    ...
    Future<GetTexParameterfvReply> GetTexParameterfv(const GetTexParameterfvRequest& request);

    Future<GetTexParameterfvReply> GetTexParameterfv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetTexParameterivReply> GetTexParameteriv(const GetTexParameterivRequest& request);

    Future<GetTexParameterivReply> GetTexParameteriv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetTexLevelParameterfvReply> GetTexLevelParameterfv(const GetTexLevelParameterfvRequest& request);
    ...
    Future<GetTexLevelParameterivReply> GetTexLevelParameteriv(const GetTexLevelParameterivRequest& request);
    ...
    Future<IsEnabledReply> IsEnabled(const ContextTag& context_tag = {}, const uint32_t& capability = {});
    ...
    Future<IsListReply> IsList(const ContextTag& context_tag = {}, const uint32_t& list = {});
    ...
    Future<AreTexturesResidentReply> AreTexturesResident(const AreTexturesResidentRequest& request);

    Future<AreTexturesResidentReply> AreTexturesResident(const ContextTag& context_tag = {}, const std::vector<uint32_t>& textures = {});
    ...
    Future<void> DeleteTextures(const ContextTag& context_tag = {}, const std::vector<uint32_t>& textures = {});
    ...
    Future<GenTexturesReply> GenTextures(const ContextTag& context_tag = {}, const int32_t& n = {});
    ...
    Future<IsTextureReply> IsTexture(const ContextTag& context_tag = {}, const uint32_t& texture = {});
    ...
    Future<GetColorTableReply> GetColorTable(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& format = {},
        const uint32_t& type = {}, const uint8_t& swap_bytes = {});
    ...
    using GetColorTableParameterfvResponse = Response<GetColorTableParameterfvReply>;

    Future<GetColorTableParameterfvReply> GetColorTableParameterfv(const GetColorTableParameterfvRequest& request);

    Future<GetColorTableParameterfvReply> GetColorTableParameterfv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    using GetColorTableParameterivResponse = Response<GetColorTableParameterivReply>;

    Future<GetColorTableParameterivReply> GetColorTableParameteriv(const GetColorTableParameterivRequest& request);

    Future<GetColorTableParameterivReply> GetColorTableParameteriv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetConvolutionFilterReply> GetConvolutionFilter(const GetConvolutionFilterRequest& request);

    Future<GetConvolutionFilterReply> GetConvolutionFilter(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& format = {},
        const uint32_t& type = {}, const uint8_t& swap_bytes = {});
    ...
    using GetConvolutionParameterfvResponse = Response<GetConvolutionParameterfvReply>;

    Future<GetConvolutionParameterfvReply> GetConvolutionParameterfv(const GetConvolutionParameterfvRequest& request);

    Future<GetConvolutionParameterfvReply> GetConvolutionParameterfv(
        const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    using GetConvolutionParameterivResponse = Response<GetConvolutionParameterivReply>;

    Future<GetConvolutionParameterivReply> GetConvolutionParameteriv(const GetConvolutionParameterivRequest& request);
    ...
    Future<GetSeparableFilterReply> GetSeparableFilter(const GetSeparableFilterRequest& request);

    Future<GetSeparableFilterReply> GetSeparableFilter(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& format = {},
        const uint32_t& type = {}, const uint8_t& swap_bytes = {});
    ...
    Future<GetHistogramReply> GetHistogram(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& format = {},
        const uint32_t& type = {}, const uint8_t& swap_bytes = {}, const uint8_t& reset = {});
    ...
    using GetHistogramParameterfvResponse = Response<GetHistogramParameterfvReply>;

    Future<GetHistogramParameterfvReply> GetHistogramParameterfv(const GetHistogramParameterfvRequest& request);

    Future<GetHistogramParameterfvReply> GetHistogramParameterfv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    using GetHistogramParameterivResponse = Response<GetHistogramParameterivReply>;

    Future<GetHistogramParameterivReply> GetHistogramParameteriv(const GetHistogramParameterivRequest& request);

    Future<GetHistogramParameterivReply> GetHistogramParameteriv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetMinmaxReply> GetMinmax(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& format = {}, const uint32_t& type = {},
        const uint8_t& swap_bytes = {}, const uint8_t& reset = {});
    ...
    Future<GetMinmaxParameterfvReply> GetMinmaxParameterfv(const GetMinmaxParameterfvRequest& request);

    Future<GetMinmaxParameterfvReply> GetMinmaxParameterfv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetMinmaxParameterivReply> GetMinmaxParameteriv(const GetMinmaxParameterivRequest& request);

    Future<GetMinmaxParameterivReply> GetMinmaxParameteriv(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    using GetCompressedTexImageARBResponse = Response<GetCompressedTexImageARBReply>;

    Future<GetCompressedTexImageARBReply> GetCompressedTexImageARB(const GetCompressedTexImageARBRequest& request);

    Future<GetCompressedTexImageARBReply> GetCompressedTexImageARB(const ContextTag& context_tag = {}, const uint32_t& target = {}, const int32_t& level = {});
    ...
    Future<void> DeleteQueriesARB(const ContextTag& context_tag = {}, const std::vector<uint32_t>& ids = {});
    ...
    Future<GenQueriesARBReply> GenQueriesARB(const ContextTag& context_tag = {}, const int32_t& n = {});
    ...
    Future<IsQueryARBReply> IsQueryARB(const ContextTag& context_tag = {}, const uint32_t& id = {});
    ...
    Future<GetQueryivARBReply> GetQueryivARB(const ContextTag& context_tag = {}, const uint32_t& target = {}, const uint32_t& pname = {});
    ...
    Future<GetQueryObjectivARBReply> GetQueryObjectivARB(const GetQueryObjectivARBRequest& request);

    Future<GetQueryObjectivARBReply> GetQueryObjectivARB(const ContextTag& context_tag = {}, const uint32_t& id = {}, const uint32_t& pname = {});
    ...
    Future<GetQueryObjectuivARBReply> GetQueryObjectuivARB(const GetQueryObjectuivARBRequest& request);

    Future<GetQueryObjectuivARBReply> GetQueryObjectuivARB(const ContextTag& context_tag = {}, const uint32_t& id = {}, const uint32_t& pname = {});
...
inline constexpr x11::Glx::Pbcet operator|(x11::Glx::Pbcet l, x11::Glx::Pbcet r)
{
...
inline constexpr x11::Glx::Pbcdt operator|(x11::Glx::Pbcdt l, x11::Glx::Pbcdt r)
{
...
inline constexpr x11::Glx::GraphicsContextAttribute operator|(x11::Glx::GraphicsContextAttribute l, x11::Glx::GraphicsContextAttribute r)
{
    using T = std::underlying_type_t<x11::Glx::GraphicsContextAttribute>;
    return static_cast<x11::Glx::GraphicsContextAttribute>(static_cast<T>(l) | static_cast<T>(r));
}
