...
public:
    ...
    Future<OpenReply> Open(const Drawable& drawable = {}, const uint32_t& provider = {});
    ...
    Future<void> PixmapFromBuffer(const Pixmap& pixmap = {}, const Drawable& drawable = {}, const uint32_t& size = {}, const uint16_t& width = {},
        const uint16_t& height = {}, const uint16_t& stride = {}, const uint8_t& depth = {}, const uint8_t& bpp = {}, const RefCountedFD& pixmap_fd = {});
    ...
    Future<BufferFromPixmapReply> BufferFromPixmap(const BufferFromPixmapRequest& request);
    ...
    Future<void> FenceFromFD(
        const Drawable& drawable = {}, const uint32_t& fence = {}, const uint8_t& initially_triggered = {}, const RefCountedFD& fence_fd = {});
    ...
    Future<FDFromFenceReply> FDFromFence(const Drawable& drawable = {}, const uint32_t& fence = {});
    ...
    Future<GetSupportedModifiersReply> GetSupportedModifiers(const GetSupportedModifiersRequest& request);

    Future<GetSupportedModifiersReply> GetSupportedModifiers(const uint32_t& window = {}, const uint8_t& depth = {}, const uint8_t& bpp = {});
    ...
    Future<void> PixmapFromBuffers(const Pixmap& pixmap = {}, const Window& window = {}, const uint16_t& width = {}, const uint16_t& height = {},
        const uint32_t& stride0 = {}, const uint32_t& offset0 = {}, const uint32_t& stride1 = {}, const uint32_t& offset1 = {}, const uint32_t& stride2 = {},
        const uint32_t& offset2 = {}, const uint32_t& stride3 = {}, const uint32_t& offset3 = {}, const uint8_t& depth = {}, const uint8_t& bpp = {},
        const uint64_t& modifier = {}, const std::vector<RefCountedFD>& buffers = {});
    ...
    Future<BuffersFromPixmapReply> BuffersFromPixmap(const BuffersFromPixmapRequest& request);
    ...
    Future<void> SetDRMDeviceInUse(const Window& window = {}, const uint32_t& drmMajor = {}, const uint32_t& drmMinor = {});
    ...
    Future<void> ImportSyncobj(const Syncobj& syncobj = {}, const Drawable& drawable = {}, const RefCountedFD& syncobj_fd = {});
