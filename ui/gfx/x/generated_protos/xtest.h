...
public:
    ...
    Future<GetVersionReply> GetVersion(const uint8_t& major_version = {}, const uint16_t& minor_version = {});
    ...
    Future<CompareCursorReply> CompareCursor(const Window& window = {}, const x11::Cursor& cursor = {});
    ...
    Future<void> FakeInput(const uint8_t& type = {}, const uint8_t& detail = {}, const uint32_t& time = {}, const Window& root = {}, const int16_t& rootX = {},
        const int16_t& rootY = {}, const uint8_t& deviceid = {});
...
inline constexpr x11::Test::Cursor operator|(x11::Test::Cursor l, x11::Test::Cursor r)
{
