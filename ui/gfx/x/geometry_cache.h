...
public:
    using BoundsChangedCallback = base::RepeatingCallback<void(const std::optional<gfx::Rect>&, const gfx::Rect&)>;

    GeometryCache(Connection* connection, Window window, BoundsChangedCallback bounds_changed_callback);
...
private:
    ...
    void OnParentGeometryChanged(const std::optional<gfx::Rect>& old_parent_bounds, const gfx::Rect& new_parent_bounds);
