...
ColorSpace::RangeID all_ranges[] = { ColorSpace::RangeID::FULL, ColorSpace::RangeID::LIMITED, ColorSpace::RangeID::DERIVED };
...
TEST(SimpleColorSpace, BT709toSRGB)
{
    ...
    std::unique_ptr<ColorTransform> t(ColorTransform::NewColorTransform(bt709, sRGB));
...
{
    ColorSpace ycocg(ColorSpace::PrimaryID::BT709, ColorSpace::TransferID::SRGB, ColorSpace::MatrixID::YCOCG, ColorSpace::RangeID::LIMITED);
    ColorSpace sRGB = ColorSpace::CreateSRGB();
    std::unique_ptr<ColorTransform> t(ColorTransform::NewColorTransform(ycocg, sRGB));
    ...
    tmp = ColorTransform::TriStim(235.0f / 255.0f, 128.0f / 255.0f, 128.0f / 255.0f);
    t->Transform(&tmp, 1);
    EXPECT_NEAR(tmp.x(), 1.0f, kMathEpsilon);
    EXPECT_NEAR(tmp.y(), 1.0f, kMathEpsilon);
    EXPECT_NEAR(tmp.z(), 1.0f, kMathEpsilon);
    ...
    tmp = ColorTransform::TriStim(70.75f / 255.0f, 73.25f / 255.0f, 18.5f / 255.0f);
    t->Transform(&tmp, 1);
    EXPECT_NEAR(tmp.x(), 0.0f, kMathEpsilon);
    EXPECT_NEAR(tmp.y(), 0.0f, kMathEpsilon);
    EXPECT_NEAR(tmp.z(), 1.0f, kMathEpsilon);
...
TEST(SimpleColorSpace, TransferFnCancel)
{
    ...
    std::unique_ptr<ColorTransform> bt709_to_srgb(ColorTransform::NewColorTransform(bt709, srgb));
    ...
    std::unique_ptr<ColorTransform> bt709_to_gamma28(ColorTransform::NewColorTransform(bt709, gamma28));
    ...
    std::unique_ptr<ColorTransform> bt709_to_gamma24(ColorTransform::NewColorTransform(bt709, gamma24));
    ...
    std::unique_ptr<ColorTransform> rec601_yuv_to_rgb(ColorTransform::NewColorTransform(rec601, rec601.GetAsFullRangeRGB()));
...
TEST(SimpleColorSpace, SRGBFromICCAndNotICC)
{
    ...
    std::unique_ptr<ColorTransform> toxyzd50_fromicc(ColorTransform::NewColorTransform(srgb_fromicc, xyzd50));
    ...
    std::unique_ptr<ColorTransform> toxyzd50_default(ColorTransform::NewColorTransform(srgb_default, xyzd50));
    ...
    std::unique_ptr<ColorTransform> fromxyzd50_fromicc(ColorTransform::NewColorTransform(xyzd50, srgb_fromicc));
    fromxyzd50_fromicc->Transform(&value_fromicc, 1);

    std::unique_ptr<ColorTransform> fromxyzd50_default(ColorTransform::NewColorTransform(xyzd50, srgb_default));
...
TEST(SimpleColorSpace, ICCProfileOnlyXYZ)
{
    ...
    ColorTransform::TriStim expected_transformed_value(0.34090986847877502f, 0.42633286118507385f, 0.3408740758895874f);

    // Two steps should be needed, transfer fn and matrix.
    std::unique_ptr<ColorTransform> icc_to_xyzd50(ColorTransform::NewColorTransform(icc_space, xyzd50));
    EXPECT_EQ(icc_to_xyzd50->NumberOfStepsForTesting(), 2u);
    icc_to_xyzd50->Transform(&transformed_value, 1);
    EXPECT_NEAR(transformed_value.x(), expected_transformed_value.x(), kPixelEpsilon);
    EXPECT_NEAR(transformed_value.y(), expected_transformed_value.y(), kPixelEpsilon);
    EXPECT_NEAR(transformed_value.z(), expected_transformed_value.z(), kPixelEpsilon);

    // Two steps should be needed, matrix and transfer fn.
    std::unique_ptr<ColorTransform> xyzd50_to_icc(ColorTransform::NewColorTransform(xyzd50, icc_space));
...
TEST(SimpleColorSpace, ICCProfileOnlyColorSpin)
{
    ...
    ColorTransform::TriStim transformed_value = input_value;
    ColorTransform::TriStim expected_transformed_value(0.49694931507110596f, 0.74937951564788818f, 0.31359460949897766f);

    // Three steps will be needed.
    std::unique_ptr<ColorTransform> icc_to_colorspin(ColorTransform::NewColorTransform(icc_space, colorspin));
    ...
    std::unique_ptr<ColorTransform> colorspin_to_icc(ColorTransform::NewColorTransform(colorspin, icc_space));
...
TEST(SimpleColorSpace, GetColorSpace)
{
    ...
    std::unique_ptr<ColorTransform> t(ColorTransform::NewColorTransform(sRGB, sRGB2));
...
TEST(SimpleColorSpace, Scale)
{
    ...
    std::unique_ptr<ColorTransform> t(ColorTransform::NewColorTransform(srgb, srgb_scaled));
...
TEST(SimpleColorSpace, ToUndefined)
{
    ...
    std::unique_ptr<ColorTransform> video_to_null(ColorTransform::NewColorTransform(video, null));
    ...
    std::unique_ptr<ColorTransform> video_to_null_no_opt(ColorTransform::NewColorTransform(video, null, options));
    ...
    std::unique_ptr<ColorTransform> luttrcicc_to_null(ColorTransform::NewColorTransform(luttrcicc, null));
    EXPECT_EQ(luttrcicc_to_null->NumberOfStepsForTesting(), 0u);
    std::unique_ptr<ColorTransform> luttrcicc_to_nonnull(ColorTransform::NewColorTransform(luttrcicc, nonnull));
    ...
    std::unique_ptr<ColorTransform> adobeicc_to_null(ColorTransform::NewColorTransform(adobeicc, null));
    EXPECT_EQ(adobeicc_to_null->NumberOfStepsForTesting(), 0u);
    std::unique_ptr<ColorTransform> adobeicc_to_nonnull(ColorTransform::NewColorTransform(adobeicc, nonnull));
    EXPECT_GT(adobeicc_to_nonnull->NumberOfStepsForTesting(), 0u);

    // And with something analytic.
    ColorSpace xyzd50 = gfx::ColorSpace::CreateXYZD50();
    std::unique_ptr<ColorTransform> xyzd50_to_null(ColorTransform::NewColorTransform(xyzd50, null));
    EXPECT_EQ(xyzd50_to_null->NumberOfStepsForTesting(), 0u);
    std::unique_ptr<ColorTransform> xyzd50_to_nonnull(ColorTransform::NewColorTransform(xyzd50, nonnull));
...
TEST(SimpleColorSpace, DefaultToSRGB)
{
    ...
    ColorSpace unknown;
    std::unique_ptr<ColorTransform> t1(ColorTransform::NewColorTransform(unknown, ColorSpace::CreateSRGB()));
    EXPECT_EQ(t1->NumberOfStepsForTesting(), 0u);
    std::unique_ptr<ColorTransform> t2(ColorTransform::NewColorTransform(unknown, ColorSpace::CreateXYZD50()));
...
{
    std::vector<ColorSpace> common_color_spaces = { ColorSpace::CreateSRGB(), ColorSpace::CreateDisplayP3D65(), ColorSpace::CreateExtendedSRGB(),
        ColorSpace::CreateSRGBLinear(), ColorSpace::CreateJpeg(), ColorSpace::CreateREC601(), ColorSpace::CreateREC709() };
...
{
    gfx::ColorSpace space_with_transfer(ColorSpace::PrimaryID::BT709, GetParam(), ColorSpace::MatrixID::RGB, ColorSpace::RangeID::FULL);
    gfx::ColorSpace space_linear(ColorSpace::PrimaryID::BT709, ColorSpace::TransferID::LINEAR, ColorSpace::MatrixID::RGB, ColorSpace::RangeID::FULL);

    std::unique_ptr<ColorTransform> to_linear(ColorTransform::NewColorTransform(space_with_transfer, space_linear));

    std::unique_ptr<ColorTransform> from_linear(ColorTransform::NewColorTransform(space_linear, space_with_transfer));
...
INSTANTIATE_TEST_SUITE_P(ColorSpace, TransferTest, testing::ValuesIn(simple_transfers));

class ExtendedTransferTest : public testing::TestWithParam<ColorSpace::TransferID> { };
...
typedef std::tuple<ColorSpace::PrimaryID, ColorSpace::TransferID, ColorSpace::MatrixID, ColorSpace::RangeID, bool> ColorSpaceTestData;

class ColorSpaceTestBase : public testing::TestWithParam<ColorSpaceTestData> {
public:
    ColorSpaceTestBase()
        : color_space_(std::get<0>(GetParam()), std::get<1>(GetParam()), std::get<2>(GetParam()), std::get<3>(GetParam()))
    {
...
{
    std::unique_ptr<ColorTransform> t(ColorTransform::NewColorTransform(color_space_, color_space_, options_));
...
{
    std::unique_ptr<ColorTransform> t1(ColorTransform::NewColorTransform(color_space_, ColorSpace::CreateXYZD50(), options_));
    std::unique_ptr<ColorTransform> t2(ColorTransform::NewColorTransform(ColorSpace::CreateXYZD50(), color_space_, options_));
    ColorTransform::TriStim tristim(0.4f, 0.5f, 0.6f);
...
INSTANTIATE_TEST_SUITE_P(A, ColorSpaceTestBase,
    testing::Combine(testing::ValuesIn(all_primaries), testing::ValuesIn(simple_transfers), testing::Values(ColorSpace::MatrixID::BT709),
        testing::Values(ColorSpace::RangeID::LIMITED), testing::ValuesIn(optimizations)));

INSTANTIATE_TEST_SUITE_P(B, ColorSpaceTestBase,
    testing::Combine(testing::Values(ColorSpace::PrimaryID::BT709), testing::ValuesIn(simple_transfers), testing::ValuesIn(all_matrices),
        testing::ValuesIn(all_ranges), testing::ValuesIn(optimizations)));

INSTANTIATE_TEST_SUITE_P(C, ColorSpaceTestBase,
    testing::Combine(testing::ValuesIn(all_primaries), testing::Values(ColorSpace::TransferID::BT709), testing::ValuesIn(all_matrices),
        testing::ValuesIn(all_ranges), testing::ValuesIn(optimizations)));
...
TEST(ColorSpaceTest, ExtendedSRGBScale)
{
    ...
    float scale = 3.14;
    skcms_TransferFunction scaled_trfn = skia::ScaleTransferFunction(*skcms_sRGB_TransferFunction(), scale);
    ColorSpace space_scaled(
        ColorSpace::PrimaryID::BT709, ColorSpace::TransferID::CUSTOM_HDR, ColorSpace::MatrixID::RGB, ColorSpace::RangeID::FULL, nullptr, &scaled_trfn);
    ColorSpace space_target(ColorSpace::PrimaryID::BT709, ColorSpace::TransferID::LINEAR, ColorSpace::MatrixID::RGB, ColorSpace::RangeID::FULL);

    std::unique_ptr<ColorTransform> xform_scaled(ColorTransform::NewColorTransform(space_scaled, space_target));
    std::unique_ptr<ColorTransform> xform_unscaled(ColorTransform::NewColorTransform(space_unscaled, space_target));
...
{
    ColorSpace dst(ColorSpace::PrimaryID::BT2020, ColorSpace::TransferID::SCRGB_LINEAR_80_NITS);
    ...
    // PQ's 80 nits maps to 80 nits.
    {
        ...
        std::unique_ptr<ColorTransform> xform(ColorTransform::NewColorTransform(src_pq, dst, options));
    ...
    // SDR white is scaled by 80 nits.
    {
        ...
        std::unique_ptr<ColorTransform> xform(ColorTransform::NewColorTransform(src_srgb, dst, options));
    ...
    // PQ's maximum maps to the maximum value when tonemapped.
    {
        ...
        runtime_options.src_hdr_metadata = HDRMetadata(HdrMetadataCta861_3(10000.f, 100.f));
    ...
    // path is to be deleted.
    {
        ...
        ColorSpace src_hlg(ColorSpace::PrimaryID::BT2020, ColorSpace::TransferID::HLG);

        ColorTransform::Options options;
        ColorTransform::RuntimeOptions runtime_options;
        runtime_options.dst_sdr_max_luminance_nits = kSdrWhite;

        std::unique_ptr<ColorTransform> xform(ColorTransform::NewColorTransform(src_hlg, dst, options));

        ColorTransform::TriStim val(1.f, 1.f, 1.f);
        xform->Transform(&val, 1, runtime_options);
        EXPECT_NEAR(val.x(), 12.f * ColorSpace::kDefaultSDRWhiteLevel / 80.f, kMathEpsilon);
    }
...
TEST(ColorSpaceTest, HLGTonemapSdrRelative)
{
    ...
    // We will max out at the reference maximum if it is below the headroom.
    {
        ...
        ColorTransform::TriStim val(1.f, 1.f, 1.f);
        xform->Transform(&val, 1, runtime_options);
        EXPECT_NEAR(val.x(), 1000.f / ColorSpace::kDefaultSDRWhiteLevel, kMathLargeEpsilon);
    }
}
...
TEST(ColorSpaceTest, PQTonemapSdrRelative)
{
    ...
    // If we do not reach the headroom, then no tonemapping is applied.
    {
        ...
        ColorTransform::TriStim val(1.f, 1.f, 1.f);
        xform->Transform(&val, 1, runtime_options);
        EXPECT_NEAR(val.x(), 10000.f / ColorSpace::kDefaultSDRWhiteLevel, kMathLargeEpsilon);
    }
    ...
    // is applied.
    {
        ...
        runtime_options.dst_sdr_max_luminance_nits = kSdrWhite;
        runtime_options.dst_max_luminance_relative = kDstMaxLumRel;
        runtime_options.src_hdr_metadata = HDRMetadata(HdrMetadataCta861_3(1000.f, 100.f));
...
TEST(ColorSpaceTest, PQSDRWhiteLevel)
{
    ...
    for (size_t i = 0; i < 3; ++i) {
        ...
        // function.
        ColorSpace target(ColorSpace::PrimaryID::BT2020, ColorSpace::TransferID::LINEAR_HDR, ColorSpace::MatrixID::RGB, ColorSpace::RangeID::FULL);
        std::unique_ptr<ColorTransform> xform(ColorTransform::NewColorTransform(hdr10, target, options));

        // Do the transform to the values in |pq_encoded_nits|.
        ColorTransform::TriStim val(pq_encoded_nits[0], pq_encoded_nits[1], pq_encoded_nits[2]);
        xform->Transform(&val, 1, runtime_options);
        ...
        std::unique_ptr<ColorTransform> xform_inv(ColorTransform::NewColorTransform(target, hdr10, options));
...
TEST(ColorSpaceTest, HLGSDRWhiteLevel)
{
    ...
    for (size_t i = 0; i < 3; ++i) {
        ...
        // function.
        ColorSpace target(ColorSpace::PrimaryID::BT2020, ColorSpace::TransferID::LINEAR_HDR, ColorSpace::MatrixID::RGB, ColorSpace::RangeID::FULL);
        std::unique_ptr<ColorTransform> xform(ColorTransform::NewColorTransform(hlg, target, options));

        // Do the transform to the values in |hlg_encoded_nits|.
        ColorTransform::TriStim val(hlg_encoded_nits[0], hlg_encoded_nits[1], hlg_encoded_nits[2]);
        xform->Transform(&val, 1, runtime_options);
        ...
        // Test the inverse transform.
        std::unique_ptr<ColorTransform> xform_inv(ColorTransform::NewColorTransform(target, hlg, options));
        xform_inv->Transform(&val, 1, runtime_options);
...
TEST(ColorSpaceTest, PiecewiseHDR)
{
    ...
    for (float sdr_joint : test_sdr_joints) {
        for (float hdr_level : test_hdr_levels) {
            ColorSpace hdr = ColorSpace::CreatePiecewiseHDR(ColorSpace::PrimaryID::BT709, sdr_joint, hdr_level);
            ColorSpace linear(ColorSpace::PrimaryID::BT709, ColorSpace::TransferID::LINEAR_HDR);
            std::unique_ptr<ColorTransform> xform_to(ColorTransform::NewColorTransform(hdr, linear));
            std::unique_ptr<ColorTransform> xform_from(ColorTransform::NewColorTransform(linear, hdr));
            ...
            for (size_t i = 0; i < kTestPointCount; ++i) {
                ...
                EXPECT_NEAR(val.x(), test_y[i], kMathEpsilon) << " test_x[i] is " << test_x[i];

                val.set_x(test_y[i]);
                xform_from->Transform(&val, 1);
                EXPECT_NEAR(val.x(), test_x[i], kMathEpsilon) << " test_y[i] is " << test_y[i];
            }
        }
    }
}
