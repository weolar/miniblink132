...
template <> struct GFX_SKIA_IPC_EXPORT ParamTraits<SkImageInfo> {
...
template <> struct GFX_SKIA_IPC_EXPORT ParamTraits<SkBitmap> {
...
template <> struct GFX_SKIA_IPC_EXPORT ParamTraits<gfx::Transform> {
