...
template <> struct GFX_IPC_EXPORT ParamTraits<gfx::Range> {
...
#if BUILDFLAG(IS_APPLE)
template <> struct GFX_IPC_EXPORT ParamTraits<gfx::ScopedRefCountedIOSurfaceMachPort> {
...
template <> struct GFX_IPC_EXPORT ParamTraits<gfx::ScopedIOSurface> {
...
template <> struct GFX_IPC_EXPORT ParamTraits<gfx::SelectionBound> {
