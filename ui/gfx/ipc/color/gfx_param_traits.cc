...
void ParamTraits<gfx::ColorSpace>::Write(base::Pickle* m, const gfx::ColorSpace& p)
{
...
bool ParamTraits<gfx::ColorSpace>::Read(const base::Pickle* m, base::PickleIterator* iter, gfx::ColorSpace* r)
{
...
void ParamTraits<gfx::ColorSpace>::Log(const gfx::ColorSpace& p, std::string* l)
{
    l->append("<gfx::ColorSpace>");
}

void ParamTraits<gfx::DisplayColorSpaces>::Write(base::Pickle* m, const gfx::DisplayColorSpaces& p)
{
...
bool ParamTraits<gfx::DisplayColorSpaces>::Read(const base::Pickle* m, base::PickleIterator* iter, gfx::DisplayColorSpaces* r)
{
...
void ParamTraits<gfx::DisplayColorSpaces>::Log(const gfx::DisplayColorSpaces& p, std::string* l)
{
