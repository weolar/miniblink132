...
public:
    ...
    static std::optional<std::vector<uint8_t>> EncodeBGRASkBitmap(const SkBitmap& input, bool discard_transparency);
    ...
    static std::optional<std::vector<uint8_t>> FastEncodeBGRASkBitmap(const SkBitmap& input, bool discard_transparency);
    ...
    static std::optional<DecodeOutput> Decode(base::span<const uint8_t> input, ColorFormat format);
