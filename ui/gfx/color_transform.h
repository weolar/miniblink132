...
public:
    ...
    virtual void Transform(TriStim* colors, size_t num, const RuntimeOptions& options) const = 0;
    ...
    virtual sk_sp<SkData> GetSkShaderUniforms(const RuntimeOptions& options) const = 0;
    ...
    static std::unique_ptr<ColorTransform> NewColorTransform(const ColorSpace& src, const ColorSpace& dst);

    static std::unique_ptr<ColorTransform> NewColorTransform(const ColorSpace& src, const ColorSpace& dst, const Options& options);
