...
public:                                                                                                                                                        \
    ...
    BOOL ProcessWindowMessage(HWND hwnd, UINT msg, WPARAM w_param, LPARAM l_param, LRESULT& l_result, DWORD msg_map_id = 0) override                           \
    {                                                                                                                                                          \
        auto ref(theClass::msg_handler_weak_factory_.GetWeakPtr());                                                                                            \
        BOOL old_msg_handled = msg_handled_;                                                                                                                   \
        BOOL ret = _ProcessWindowMessage(hwnd, msg, w_param, l_param, l_result, msg_map_id);                                                                   \
        if (ref.get())                                                                                                                                         \
...
#define CR_MSG_WM_SIZE(func)                                                                                                                                   \
    if (uMsg == WM_SIZE) {                                                                                                                                     \
        SetMsgHandled(TRUE);                                                                                                                                   \
        func((UINT)wParam, gfx::Size(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                                                                       \
        lResult = 0;                                                                                                                                           \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
#define CR_MSG_WM_NCHITTEST(func)                                                                                                                              \
    if (uMsg == WM_NCHITTEST) {                                                                                                                                \
        SetMsgHandled(TRUE);                                                                                                                                   \
        lResult = (LRESULT)func(gfx::Point(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                                                                 \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
#define CR_MSG_WM_NCMOUSEMOVE(func)                                                                                                                            \
    if (uMsg == WM_NCMOUSEMOVE) {                                                                                                                              \
        SetMsgHandled(TRUE);                                                                                                                                   \
        func((UINT)wParam, gfx::Point(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                                                                      \
        lResult = 0;                                                                                                                                           \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
#define CR_MSG_WM_MOUSEWHEEL(func)                                                                                                                             \
    if (uMsg == WM_MOUSEWHEEL) {                                                                                                                               \
        SetMsgHandled(TRUE);                                                                                                                                   \
        lResult = (LRESULT)func((UINT)LOWORD(wParam), (short)HIWORD(wParam), gfx::Point(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                    \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
#define CR_MSG_WM_CONTEXTMENU(func)                                                                                                                            \
    if (uMsg == WM_CONTEXTMENU) {                                                                                                                              \
        SetMsgHandled(TRUE);                                                                                                                                   \
        func((HWND)wParam, gfx::Point(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                                                                      \
        lResult = 0;                                                                                                                                           \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
#define CR_MSG_WM_MOUSEHOVER(func)                                                                                                                             \
    if (uMsg == WM_MOUSEHOVER) {                                                                                                                               \
        SetMsgHandled(TRUE);                                                                                                                                   \
        func(wParam, gfx::Point(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                                                                            \
        lResult = 0;                                                                                                                                           \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
#define CR_MSG_WM_NCXBUTTONDOWN(func)                                                                                                                          \
    if (uMsg == WM_NCXBUTTONDOWN) {                                                                                                                            \
        SetMsgHandled(TRUE);                                                                                                                                   \
        func(GET_XBUTTON_WPARAM(wParam), GET_NCHITTEST_WPARAM(wParam), gfx::Point(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                          \
        lResult = 0;                                                                                                                                           \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
#define CR_MSG_WM_XBUTTONDOWN(func)                                                                                                                            \
    if (uMsg == WM_XBUTTONDOWN) {                                                                                                                              \
        SetMsgHandled(TRUE);                                                                                                                                   \
        func(GET_XBUTTON_WPARAM(wParam), GET_KEYSTATE_WPARAM(wParam), gfx::Point(CR_GET_X_LPARAM(lParam), CR_GET_Y_LPARAM(lParam)));                           \
        lResult = 0;                                                                                                                                           \
        if (!ref.get() || msg_handled_)                                                                                                                        \
            return TRUE;                                                                                                                                       \
    }
...
// wndCtl)
#define CR_REFLECTED_COMMAND_RANGE_CODE_HANDLER_EX(idFirst, idLast, code, func)                                                                                \
