...
class COMPONENT_EXPORT(GFX) D3DSharedFence : public base::RefCountedThreadSafe<D3DSharedFence> {
public:
    ...
    static scoped_refptr<D3DSharedFence> CreateForD3D11(Microsoft::WRL::ComPtr<ID3D11Device> d3d11_signal_device);
    ...
    static scoped_refptr<D3DSharedFence> CreateFromScopedHandle(base::win::ScopedHandle fence_handle, const DXGIHandleToken& fence_token);
    ...
    static scoped_refptr<D3DSharedFence> CreateFromUnownedHandle(HANDLE shared_handle);
...
private:
    ...
    explicit D3DSharedFence(base::win::ScopedHandle shared_handle, const DXGIHandleToken& dxgi_token);
    ...
    base::LRUCache<Microsoft::WRL::ComPtr<ID3D11Device>, Microsoft::WRL::ComPtr<ID3D11Fence>> d3d11_wait_fence_map_;
};
