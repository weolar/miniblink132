...
[[nodiscard]] COMPONENT_EXPORT(GFX) bool RowSizeForBufferFormatChecked(size_t width, BufferFormat format, size_t plane, size_t* size_in_bytes);

// Returns the height in pixels of the given zero-indexed |plane| of |format|.
[[nodiscard]] COMPONENT_EXPORT(GFX) bool PlaneHeightForBufferFormatChecked(size_t width, BufferFormat format, size_t plane, size_t* height_in_pixels);
...
[[nodiscard]] COMPONENT_EXPORT(GFX) bool PlaneSizeForBufferFormatChecked(const Size& size, BufferFormat format, size_t plane, size_t* size_in_bytes);
...
[[nodiscard]] COMPONENT_EXPORT(GFX) bool BufferSizeForBufferFormatChecked(const Size& size, BufferFormat format, size_t* size_in_bytes);
