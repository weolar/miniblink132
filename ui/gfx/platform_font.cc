...
// static
int PlatformFont::GetFontSizeDeltaIgnoringUserOrLocaleSettings(int desired_font_size)
{
    ...
    if (base_font.GetFontSize() != desired_font_size) {
        ...
        base_font = gfx::FontList().DeriveWithSizeDelta(size_delta + user_or_locale_delta);
    }
    ...
    return base_font.GetFontSize() - gfx::PlatformFont::kDefaultBaseFontSize + user_or_locale_delta;
}
