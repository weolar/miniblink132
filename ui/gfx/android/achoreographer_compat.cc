...
AChoreographerCompat33::AChoreographerCompat33()
{
    ...
    LOAD_FUNCTION(main_dl_handle, AChoreographerFrameCallbackData_getFrameTimeNanos);
    LOAD_FUNCTION(main_dl_handle, AChoreographerFrameCallbackData_getFrameTimelinesLength);
    LOAD_FUNCTION(main_dl_handle, AChoreographerFrameCallbackData_getPreferredFrameTimelineIndex);
    LOAD_FUNCTION(main_dl_handle, AChoreographerFrameCallbackData_getFrameTimelineVsyncId);
    LOAD_FUNCTION(main_dl_handle, AChoreographerFrameCallbackData_getFrameTimelineExpectedPresentationTimeNanos);
    LOAD_FUNCTION(main_dl_handle, AChoreographerFrameCallbackData_getFrameTimelineDeadlineNanos);
}
