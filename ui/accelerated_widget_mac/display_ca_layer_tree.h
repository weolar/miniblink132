...
class ACCELERATED_WIDGET_MAC_EXPORT DisplayCALayerTree : public CALayerFrameSink {
public:
...
private:
    ...
    void GotIOSurfaceFrame(base::apple::ScopedCFTypeRef<IOSurfaceRef> io_surface, const gfx::Size& dip_size, float scale_factor);
