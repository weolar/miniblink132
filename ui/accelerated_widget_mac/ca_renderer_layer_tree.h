...
ACCELERATED_WIDGET_MAC_EXPORT BASE_DECLARE_FEATURE(kFullscreenLowPowerBackdropMac);
...
public:
    CARendererLayerTree(bool allow_av_sample_buffer_display_layer, bool allow_solid_color_layers);
    ...
    void CommitScheduledCALayers(CALayer* superlayer, std::unique_ptr<CARendererLayerTree> old_tree, const gfx::Size& pixel_size, float scale_factor);
...
private:
    ...
    using CALayerMap = std::unordered_map<IOSurfaceRef, base::WeakPtr<ContentLayer>>;
    ...
    class ClipAndSortingLayer {
    public:
        ClipAndSortingLayer(RootLayer* root_layer, bool is_clipped, gfx::Rect clip_rect, gfx::RRectF rounded_corner_bounds, unsigned sorting_context_id,
    ...
    class TransformLayer {
    public:
        TransformLayer(ClipAndSortingLayer* parent_layer, const gfx::Transform& transform);
    ...
    class ContentLayer {
    public:
        ContentLayer(TransformLayer* parent_layer, base::apple::ScopedCFTypeRef<IOSurfaceRef> io_surface,
            base::apple::ScopedCFTypeRef<CVPixelBufferRef> cv_pixel_buffer, const gfx::RectF& contents_rect, const gfx::Rect& rect, SkColor4f background_color,
            const gfx::ColorSpace& color_space, unsigned edge_aa_mask, float opacity, bool nearest_neighbor_filter, const gfx::HDRMetadata& hdr_metadata,
            gfx::ProtectedVideoType protected_video_type, bool is_render_pass_draw_quad);
        ...
        void UpdateMapAndMatchOldLayers(CALayerMap& old_ca_layer_map, int& layer_order, int& last_old_layer_order);
        ...
        gfx::ProtectedVideoType protected_video_type_ = gfx::ProtectedVideoType::kClear;
