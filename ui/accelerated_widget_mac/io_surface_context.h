...
class IOSurfaceContext : public base::RefCounted<IOSurfaceContext>, public ui::GpuSwitchingObserver {
public:
    enum Type {
    ...
    ACCELERATED_WIDGET_MAC_EXPORT static scoped_refptr<IOSurfaceContext> Get(Type type);
    ...
    CGLContextObj cgl_context() const
    {
        return cgl_context_.get();
    }
...
private:
    ...
    IOSurfaceContext(Type type, base::apple::ScopedTypeRef<CGLContextObj> clg_context_strong);
