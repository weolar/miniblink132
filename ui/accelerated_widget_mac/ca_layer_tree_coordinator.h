...
namespace ui {
using BufferPresentedCallback = base::RepeatingCallback<void(gl::Presenter::PresentationCallback callback, const gfx::PresentationFeedback& feedback)>;

struct PresentedFrame {
    PresentedFrame(gl::Presenter::SwapCompletionCallback completion_cb, gl::Presenter::PresentationCallback presentation_cb, uint64_t fence,
        gfx::CALayerResult error_code, base::TimeTicks ready_timestamp, std::unique_ptr<CARendererLayerTree> layer_tree);
    ~PresentedFrame();
...
public:
    CALayerTreeCoordinator(
        bool allow_av_sample_buffer_display_layer, bool new_presentation_feedback_timestamps, BufferPresentedCallback buffer_preseneted_callback);
    ...
    void Present(gl::Presenter::SwapCompletionCallback completion_callback, gl::Presenter::PresentationCallback presentation_callback);
    ...
    void CommitPresentedFrameToCA(base::TimeDelta frame_interval, base::TimeTicks display_time);
