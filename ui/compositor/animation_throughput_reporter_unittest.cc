...
TEST_F(AnimationThroughputReporterTest, ExplicitAnimation)
{
    ...
    animator->ScheduleAnimation(new LayerAnimationSequence(LayerAnimationElement::CreateOpacityElement(1.0f, base::Milliseconds(48))));
...
TEST_F(AnimationThroughputReporterTest, ReportForAnimateToNewTarget)
{
    ...
    {
        AnimationThroughputReporter reporter(animator, checker2.repeating_callback());
        ScopedLayerAnimationSettings settings(animator);
...
TEST_F(AnimationThroughputReporterTest, NoReportForNoRunAnimations)
{
    ...
    ThroughputReportChecker checker(this, /*fail_if_reported=*/true);
    {
        ...
        sequences.push_back(new LayerAnimationSequence(LayerAnimationElement::CreateOpacityElement(1.0f, base::TimeDelta())));
