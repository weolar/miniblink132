...
public:
    ...
    // is destroyed.
    std::unique_ptr<CompositorLock> GetCompositorLock(CompositorLockClient* client, base::TimeDelta timeout, base::OnceClosure release_callback);
    ...
    bool IsLocked() const
    {
        return !active_locks_.empty();
    }

    void TimeoutLocksForTesting()
    {
        TimeoutLocks();
    }
...
private:
    ...
    base::WeakPtrFactory<CompositorLockManager> lock_timeout_weak_ptr_factory_ { this };
};
...
public:
    ...
    explicit CompositorLock(CompositorLockClient* client, base::WeakPtr<CompositorLockManager> manager, base::OnceClosure release_callback);
