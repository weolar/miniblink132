...
public:
    ...
    // |invalidation|.
    PaintContext(cc::DisplayItemList* list, float device_scale_factor, const gfx::Rect& invalidation, bool is_pixel_canvas);
    ...
    // invalid.
    bool CanCheckInvalid() const
    {
        return !invalidation_.IsEmpty();
    }
    ...
    void* RootVisited() const
    {
        return root_visited_;
    }
    const gfx::Vector2d& PaintOffset() const
    {
        return offset_;
    }
#endif
