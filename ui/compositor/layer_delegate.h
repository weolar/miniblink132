...
public:
    ...
    // bounds animation.
    virtual void OnLayerBoundsChanged(const gfx::Rect& old_bounds, PropertyChangeReason reason);
    ...
    virtual void OnLayerTransformed(const gfx::Transform& old_transform, PropertyChangeReason reason);
    ...
    // clip rect animation.
    virtual void OnLayerClipRectChanged(const gfx::Rect& old_rect, PropertyChangeReason reason);
