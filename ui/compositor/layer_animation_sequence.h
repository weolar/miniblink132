...
public:
    ...
    explicit LayerAnimationSequence(std::unique_ptr<LayerAnimationElement> element);
    ...
    bool waiting_for_group_start()
    {
        return waiting_for_group_start_;
    }
    ...
    // property in |other|.
    bool HasConflictingProperty(LayerAnimationElement::AnimatableProperties other) const;
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(LayerAnimatorTest, ObserverReleasedBeforeAnimationSequenceEnds);
