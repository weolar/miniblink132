...
PaintRecorder::PaintRecorder(const PaintContext& context, const gfx::Size& recording_size, float recording_scale_x, float recording_scale_y, PaintCache* cache)
    : context_(context)
...
PaintRecorder::PaintRecorder(const PaintContext& context, const gfx::Size& recording_size)
    : PaintRecorder(context, gfx::ScaleToRoundedSize(recording_size, context.is_pixel_canvas() ? context.device_scale_factor_ : 1.f),
        context.device_scale_factor_, context.device_scale_factor_, nullptr)
{
}
