...
public:
    ...
    void set_should_delete_observer_on_animations_ended(bool should_delete_observer_on_animations_ended)
    {
        should_delete_observer_on_animations_ended_ = should_delete_observer_on_animations_ended;
    }

    bool animations_started() const
    {
        return animations_started_;
    }

    bool animations_ended() const
    {
        return animations_ended_;
    }
...
testing::AssertionResult TestCallbacks::StartedEpochIsBeforeEndedEpoch()
{
    if (animations_started_epoch_ < animations_ended_epoch_) {
        ...
        return testing::AssertionFailure() << "The started epoch=" << animations_started_epoch_ << " is NOT before the ended epoch=" << animations_ended_epoch_;
    }
}
...
public:
    ...
    TestCallbacksThatExplicitlyDeletesObserver(const TestCallbacksThatExplicitlyDeletesObserver&) = delete;
    TestCallbacksThatExplicitlyDeletesObserver& operator=(const TestCallbacksThatExplicitlyDeletesObserver&) = delete;

    void set_observer_to_delete_in_animation_ended(std::unique_ptr<CallbackLayerAnimationObserver> observer)
    {
        observer_to_delete_in_animation_ended_ = std::move(observer);
    }

    void set_observer_to_delete_in_animation_started(std::unique_ptr<CallbackLayerAnimationObserver> observer)
    {
    ...
    // TestCallbacks:
    void AnimationsStarted(const CallbackLayerAnimationObserver& observer) override;
...
private:
    ...
    std::unique_ptr<CallbackLayerAnimationObserver> observer_to_delete_in_animation_started_;

    // The observer to delete, if non-NULL, in AnimationsEnded().
    std::unique_ptr<CallbackLayerAnimationObserver> observer_to_delete_in_animation_ended_;
};

TestCallbacksThatExplicitlyDeletesObserver::TestCallbacksThatExplicitlyDeletesObserver()
{
}

void TestCallbacksThatExplicitlyDeletesObserver::AnimationsStarted(const CallbackLayerAnimationObserver& observer)
{
    observer_to_delete_in_animation_started_.reset();
    TestCallbacks::AnimationsStarted(observer);
}

bool TestCallbacksThatExplicitlyDeletesObserver::AnimationsEnded(const CallbackLayerAnimationObserver& observer)
{
...
// destroyed.
class TestCallbackLayerAnimationObserver : public CallbackLayerAnimationObserver {
public:
    TestCallbackLayerAnimationObserver(AnimationStartedCallback animation_started_callback, AnimationEndedCallback animation_ended_callback, bool* destroyed);

    TestCallbackLayerAnimationObserver(AnimationStartedCallback animation_started_callback, bool should_delete_observer, bool* destroyed);

    TestCallbackLayerAnimationObserver(AnimationEndedCallback animation_ended_callback, bool* destroyed);

    TestCallbackLayerAnimationObserver(const TestCallbackLayerAnimationObserver&) = delete;
    TestCallbackLayerAnimationObserver& operator=(const TestCallbackLayerAnimationObserver&) = delete;
...
TestCallbackLayerAnimationObserver::TestCallbackLayerAnimationObserver(
    AnimationStartedCallback animation_started_callback, AnimationEndedCallback animation_ended_callback, bool* destroyed)
    : CallbackLayerAnimationObserver(animation_started_callback, animation_ended_callback)
...
TestCallbackLayerAnimationObserver::TestCallbackLayerAnimationObserver(
    AnimationStartedCallback animation_started_callback, bool should_delete_observer, bool* destroyed)
    : CallbackLayerAnimationObserver(animation_started_callback, should_delete_observer)
    , destroyed_(destroyed)
{
    if (destroyed_)
        (*destroyed_) = false;
...
TestCallbackLayerAnimationObserver::TestCallbackLayerAnimationObserver(AnimationEndedCallback animation_ended_callback, bool* destroyed)
...
public:
    ...
    CallbackLayerAnimationObserverTest(const CallbackLayerAnimationObserverTest&) = delete;
    CallbackLayerAnimationObserverTest& operator=(const CallbackLayerAnimationObserverTest&) = delete;
...
CallbackLayerAnimationObserverTest::CallbackLayerAnimationObserverTest()
    ...
    , observer_(new CallbackLayerAnimationObserver(base::BindRepeating(&TestCallbacks::AnimationsStarted, base::Unretained(callbacks_.get())),
          base::BindRepeating(&TestCallbacks::AnimationsEnded, base::Unretained(callbacks_.get()))))
...
LayerAnimationSequence* CallbackLayerAnimationObserverTest::CreateLayerAnimationSequence()
{
    sequences_.emplace_back(new LayerAnimationSequence);
    return sequences_.back().get();
}

class CallbackLayerAnimationObserverTestOverwrite : public CallbackLayerAnimationObserverTest {
public:
    CallbackLayerAnimationObserverTestOverwrite();

    CallbackLayerAnimationObserverTestOverwrite(const CallbackLayerAnimationObserverTestOverwrite&) = delete;
    CallbackLayerAnimationObserverTestOverwrite& operator=(const CallbackLayerAnimationObserverTestOverwrite&) = delete;
...
CallbackLayerAnimationObserverTestOverwrite::CallbackLayerAnimationObserverTestOverwrite()
{
    observer_ = CreateAnimationObserver();
    observer_test_api_ = std::make_unique<LayerAnimationObserverTestApi>(observer_.get());
}

void CallbackLayerAnimationObserverTestOverwrite::AnimationStarted(const CallbackLayerAnimationObserver& observer)
{
...
std::unique_ptr<CallbackLayerAnimationObserver> CallbackLayerAnimationObserverTestOverwrite::CreateAnimationObserver()
{
    return std::make_unique<CallbackLayerAnimationObserver>(
        base::BindRepeating(&CallbackLayerAnimationObserverTestOverwrite::AnimationStarted, base::Unretained(this)),
        base::BindRepeating([](const CallbackLayerAnimationObserver& observer) { return false; }));
}
...
TEST(CallbackLayerAnimationObserverDestructionTest, VerifyFalseAutoDelete)
{
    ...
    TestCallbackLayerAnimationObserver* observer
        = new TestCallbackLayerAnimationObserver(base::BindRepeating(&TestCallbacks::AnimationsStarted, base::Unretained(&callbacks)), false, &is_destroyed);
    observer->SetActive();
...
TEST(CallbackLayerAnimationObserverDestructionTest, VerifyTrueAutoDelete)
{
    ...
    TestCallbackLayerAnimationObserver* observer
        = new TestCallbackLayerAnimationObserver(base::BindRepeating(&TestCallbacks::AnimationsStarted, base::Unretained(&callbacks)), true, &is_destroyed);
    observer->SetActive();

    EXPECT_TRUE(is_destroyed);
}

TEST(CallbackLayerAnimationObserverDestructionTest, AnimationEndedReturnsFalse)
{
    TestCallbacks callbacks;
    callbacks.set_should_delete_observer_on_animations_ended(false);
    ...
    TestCallbackLayerAnimationObserver* observer
        = new TestCallbackLayerAnimationObserver(base::BindRepeating(&TestCallbacks::AnimationsStarted, base::Unretained(&callbacks)),
            base::BindRepeating(&TestCallbacks::AnimationsEnded, base::Unretained(&callbacks)), &is_destroyed);
    observer->SetActive();
...
TEST_F(CallbackLayerAnimationObserverTestOverwrite, VerifyOverwriteOnAnimationStart)
{
...
TEST_F(CallbackLayerAnimationObserverTest, ExplicitlyDeleteObserverInAnimationStartedCallbackWithNoSequencesAttached)
{
    ...
    std::unique_ptr<TestCallbackLayerAnimationObserver> observer
        = std::make_unique<TestCallbackLayerAnimationObserver>(base::BindRepeating(&TestCallbacks::AnimationsStarted, base::Unretained(&callbacks)),
            base::BindRepeating(&TestCallbacks::AnimationsEnded, base::Unretained(&callbacks)), &is_destroyed);
...
// heap-use-after-free errors.
TEST_F(CallbackLayerAnimationObserverTest, ExplicitlyDeleteObserverInAnimationStartedCallbackSequencesDetached)
{
    TestCallbacksThatExplicitlyDeletesObserver callbacks;
    callbacks.set_should_delete_observer_on_animations_ended(true);
    ...
    callbacks.set_observer_to_delete_in_animation_started(std::move(observer));
    CallbackLayerAnimationObserver* observer_ptr = callbacks.observer_to_delete_in_animation_started();
...
TEST_F(CallbackLayerAnimationObserverTest, ExplicitlyDeleteObserverInAnimationStartedCallbackWithSomeSequencesAttached)
{
    LayerAnimationSequence* sequence_1 = CreateLayerAnimationSequence();
    LayerAnimationSequence* sequence_2 = CreateLayerAnimationSequence();
...
// heap-use-after-free errors.
TEST_F(CallbackLayerAnimationObserverTest, IgnoreTrueReturnValueForAnimationEndedCallbackIfExplicitlyDeleted)
{
    TestCallbacksThatExplicitlyDeletesObserver callbacks;
    callbacks.set_should_delete_observer_on_animations_ended(true);
...
TEST_F(CallbackLayerAnimationObserverTest, SetActiveWhenAllSequencesAreAttachedAndOnlySomeWereStarted)
{
    LayerAnimationSequence* sequence_1 = CreateLayerAnimationSequence();
    LayerAnimationSequence* sequence_2 = CreateLayerAnimationSequence();
...
TEST_F(CallbackLayerAnimationObserverTest, SetActiveWhenAllSequencesAreAttachedAndOnlySomeWereCompleted)
{
    LayerAnimationSequence* sequence_1 = CreateLayerAnimationSequence();
    LayerAnimationSequence* sequence_2 = CreateLayerAnimationSequence();
...
TEST_F(CallbackLayerAnimationObserverTest, SetActiveAfterAllSequencesWereStartedButNoneWereCompleted)
{
    LayerAnimationSequence* sequence_1 = CreateLayerAnimationSequence();
    LayerAnimationSequence* sequence_2 = CreateLayerAnimationSequence();
...
TEST_F(CallbackLayerAnimationObserverTest, SetActiveWhenAllSequencesAreStartedAndOnlySomeWereCompleted)
{
    LayerAnimationSequence* sequence_1 = CreateLayerAnimationSequence();
    LayerAnimationSequence* sequence_2 = CreateLayerAnimationSequence();
...
TEST_F(CallbackLayerAnimationObserverTest, SetActiveWhenAllSequencesWereCompleted)
{
    LayerAnimationSequence* sequence_1 = CreateLayerAnimationSequence();
    LayerAnimationSequence* sequence_2 = CreateLayerAnimationSequence();
...
TEST_F(CallbackLayerAnimationObserverTest, SetActiveAgainAfterAllSequencesWereCompleted)
{
    LayerAnimationSequence* sequence_1 = CreateLayerAnimationSequence();
    LayerAnimationSequence* sequence_2 = CreateLayerAnimationSequence();
