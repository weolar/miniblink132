...
public:
    FloatAnimationCurveAdapter(gfx::Tween::Type tween_type, float initial_value, float target_value, base::TimeDelta duration);
    ...
    float GetTransformedValue(base::TimeDelta t, gfx::TimingFunction::LimitDirection) const override;
