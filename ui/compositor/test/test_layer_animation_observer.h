...
public:
    ...
    int last_ended_sequence_epoch() const
    {
        return last_ended_sequence_epoch_;
    }
...
private:
    ...
    raw_ptr<const LayerAnimationSequence, AcrossTasksDanglingUntriaged> last_attached_sequence_;
    int last_attached_sequence_epoch_;

    raw_ptr<const LayerAnimationSequence, AcrossTasksDanglingUntriaged> last_scheduled_sequence_;
    int last_scheduled_sequence_epoch_;

    raw_ptr<const LayerAnimationSequence, AcrossTasksDanglingUntriaged> last_started_sequence_;
    int last_started_sequence_epoch_;

    raw_ptr<const LayerAnimationSequence, AcrossTasksDanglingUntriaged> last_aborted_sequence_;
    int last_aborted_sequence_epoch_;

    raw_ptr<const LayerAnimationSequence, AcrossTasksDanglingUntriaged> last_ended_sequence_;
    ...
    raw_ptr<const LayerAnimationSequence, AcrossTasksDanglingUntriaged> last_detached_sequence_;
