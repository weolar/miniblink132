...
public:
    explicit MultiLayerAnimatorTestController(MultiLayerAnimatorTestControllerDelegate* delegate);

    MultiLayerAnimatorTestController(const MultiLayerAnimatorTestController&) = delete;
    MultiLayerAnimatorTestController& operator=(const MultiLayerAnimatorTestController&) = delete;
