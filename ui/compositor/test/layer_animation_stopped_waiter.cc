...
void LayerAnimationStoppedWaiter::OnLayerAnimationAborted(LayerAnimationSequence* sequence)
{
...
void LayerAnimationStoppedWaiter::OnLayerAnimationEnded(LayerAnimationSequence* sequence)
{
    if (!layer_animator_->is_animating()) {
        layer_animator_observer_.Reset();
        wait_loop_->Quit();
