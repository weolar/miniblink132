...
TestContextFactories::TestContextFactories(bool enable_pixel_output, bool output_to_window)
{
    ...
    implicit_factory_ = std::make_unique<InProcessContextFactory>(host_frame_sink_manager_.get(), frame_sink_manager_.get(), output_to_window);
