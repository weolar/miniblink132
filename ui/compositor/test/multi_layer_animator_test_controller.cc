...
MultiLayerAnimatorTestController::MultiLayerAnimatorTestController(MultiLayerAnimatorTestControllerDelegate* delegate)
    : delegate_(delegate)
{
}
...
void MultiLayerAnimatorTestController::SetDisableAnimationTimers(bool disable_timers)
{
...
std::vector<LayerAnimator*> MultiLayerAnimatorTestController::GetLayerAnimators()
{
    return static_cast<const MultiLayerAnimatorTestController*>(this)->GetLayerAnimators();
}

std::vector<LayerAnimator*> MultiLayerAnimatorTestController::GetLayerAnimators() const
{
    return delegate_->GetLayerAnimators();
}

void MultiLayerAnimatorTestController::StepAnimations(const base::TimeDelta& duration)
{
