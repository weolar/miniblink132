...
public:
    ...
    AnimationThroughputReporterTestBase(const AnimationThroughputReporterTestBase&) = delete;
    AnimationThroughputReporterTestBase& operator=(const AnimationThroughputReporterTestBase&) = delete;
