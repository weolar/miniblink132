...
public:
    MultiLayerAnimatorTestControllerDelegate(const MultiLayerAnimatorTestControllerDelegate&) = delete;
    MultiLayerAnimatorTestControllerDelegate& operator=(const MultiLayerAnimatorTestControllerDelegate&) = delete;
