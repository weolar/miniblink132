...
public:
    ...
    InProcessContextFactory(viz::HostFrameSinkManager* host_frame_sink_manager, viz::FrameSinkManagerImpl* frame_sink_manager, bool output_to_window = false);
    ...
    std::optional<base::TimeDelta> GetMaxVSyncInterval(Compositor* compositor) const;
...
private:
    ...
    using PerCompositorDataMap = std::unordered_map<Compositor*, std::unique_ptr<PerCompositorData>>;
