...
class TestLayerThreadedAnimationDelegate : public LayerThreadedAnimationDelegate {
public:
...
public:
    ...
    void SetTransformFromAnimation(const gfx::Transform& transform, PropertyChangeReason reason) override;
...
private:
    ...
    PropertyChangeReason last_property_change_reason_ = PropertyChangeReason::NOT_FROM_ANIMATION;
