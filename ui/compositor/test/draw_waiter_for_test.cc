...
void DrawWaiterForTest::WaitImpl(Compositor* compositor)
{
    ...
    wait_run_loop_ = std::make_unique<base::RunLoop>(base::RunLoop::Type::kNestableTasksAllowed);
    wait_run_loop_->Run();
...
void DrawWaiterForTest::OnCompositingStarted(Compositor* compositor, base::TimeTicks start_time)
{
