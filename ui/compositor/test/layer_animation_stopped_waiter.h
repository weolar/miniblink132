...
public:
    ...
    LayerAnimationStoppedWaiter& operator=(const LayerAnimationStoppedWaiter&) = delete;
...
private:
    ...
    raw_ptr<LayerAnimator, AcrossTasksDanglingUntriaged> layer_animator_ = nullptr;
    base::ScopedObservation<LayerAnimator, LayerAnimationObserver> layer_animator_observer_ { this };
