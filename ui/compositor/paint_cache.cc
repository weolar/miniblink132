...
bool PaintCache::UseCache(const PaintContext& context, const gfx::Size& size_in_context)
{
...
void PaintCache::SetPaintRecord(cc::PaintRecord record, float device_scale_factor)
{
