...
void LayerAnimatorCollection::StopAnimator(scoped_refptr<LayerAnimator> animator)
{
...
void LayerAnimatorCollection::OnCompositingShuttingDown(Compositor* compositor)
{
