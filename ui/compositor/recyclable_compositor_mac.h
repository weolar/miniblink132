...
class COMPOSITOR_EXPORT RecyclableCompositorMac : public ui::CompositorObserver {
public:
    ...
    const gfx::Size pixel_size() const
    {
        return size_pixels_;
    }
    ...
    void UpdateSurface(const gfx::Size& size_pixels, float scale_factor, const gfx::DisplayColorSpaces& display_color_spaces, int64_t display_id);
