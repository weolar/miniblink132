...
public:
    virtual void SetBoundsFromAnimation(const gfx::Rect& bounds, PropertyChangeReason reason) = 0;
    virtual void SetTransformFromAnimation(const gfx::Transform& transform, PropertyChangeReason reason) = 0;
    virtual void SetOpacityFromAnimation(float opacity, PropertyChangeReason reason) = 0;
    virtual void SetVisibilityFromAnimation(bool visibility, PropertyChangeReason reason) = 0;
    virtual void SetBrightnessFromAnimation(float brightnes, PropertyChangeReason reasons) = 0;
    virtual void SetGrayscaleFromAnimation(float grayscale, PropertyChangeReason reason) = 0;
    virtual void SetColorFromAnimation(SkColor color, PropertyChangeReason reason) = 0;
    virtual void SetClipRectFromAnimation(const gfx::Rect& clip_rect, PropertyChangeReason reason) = 0;
    virtual void SetRoundedCornersFromAnimation(const gfx::RoundedCornersF& rounded_corners, PropertyChangeReason reason) = 0;
    virtual void SetGradientMaskFromAnimation(const gfx::LinearGradient& gradient_mask, PropertyChangeReason reason) = 0;
