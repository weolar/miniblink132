...
public:
    ...
    virtual void SetOrientation(TouchHandleOrientation orientation, bool mirror_vertical, bool mirror_horizontal) = 0;
...
class UI_TOUCH_SELECTION_EXPORT TouchHandleClient : public TouchSelectionDraggableClient {
public:
...
public:
    ...
    TouchHandle(TouchHandleClient* client, TouchHandleOrientation orientation, const gfx::RectF& viewport_rect);
    ...
    const gfx::PointF& focus_bottom() const
    {
        return focus_bottom_;
    }
    TouchHandleOrientation orientation() const
    {
        return orientation_;
    }
    float alpha() const
