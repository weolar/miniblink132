...
inline constexpr char kTouchSelectionDragTypeHistogramName[] = "InputMethod.TouchSelection.DragType";

inline constexpr char kTouchSelectionMenuActionHistogramName[] = "InputMethod.TouchSelection.MenuAction";

inline constexpr char kTouchCursorSessionTouchDownCountHistogramName[] = "InputMethod.TouchSelection.CursorSession.TouchDownCount";

inline constexpr char kTouchSelectionSessionTouchDownCountHistogramName[] = "InputMethod.TouchSelection.SelectionSession.TouchDownCount";
...
UI_TOUCH_SELECTION_EXPORT void RecordTouchSelectionDrag(TouchSelectionDragType drag_type);

UI_TOUCH_SELECTION_EXPORT void RecordTouchSelectionMenuCommandAction(int command_id);
...
public:
    ...
    TouchSelectionSessionMetricsRecorder(const TouchSelectionSessionMetricsRecorder&) = delete;
    TouchSelectionSessionMetricsRecorder& operator=(const TouchSelectionSessionMetricsRecorder&) = delete;
