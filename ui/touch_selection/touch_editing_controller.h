...
// using touch.
class COMPONENT_EXPORT(UI_BASE) TouchEditable : public ui::SimpleMenuModel::Delegate {
public:
    ...
    virtual void SelectBetweenCoordinates(const gfx::Point& base, const gfx::Point& extent) = 0;
    ...
    virtual void GetSelectionEndPoints(gfx::SelectionBound* anchor, gfx::SelectionBound* focus) = 0;
