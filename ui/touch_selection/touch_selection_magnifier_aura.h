...
// selection session.
class UI_TOUCH_SELECTION_EXPORT TouchSelectionMagnifierAura : public NativeThemeObserver {
public:
    TouchSelectionMagnifierAura();

    TouchSelectionMagnifierAura(const TouchSelectionMagnifierAura&) = delete;
    TouchSelectionMagnifierAura& operator=(const TouchSelectionMagnifierAura&) = delete;
    ...
    void ShowFocusBound(Layer* parent, const gfx::Point& focus_start, const gfx::Point& focus_end);
...
private:
    ...
    base::ScopedObservation<NativeTheme, NativeThemeObserver> theme_observation_ { this };
};
