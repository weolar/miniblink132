...
TEST(TouchSelectionSessionMetricsTest, RecordsSuccessfulCursorSession)
{
    ...
    histogram_tester.ExpectUniqueSample(kTouchCursorSessionTouchDownCountHistogramName, 1, 1);
}
...
TEST(TouchSelectionSessionMetricsTest, RecordsSuccessfulSelectionSession)
{
    ...
    histogram_tester.ExpectUniqueSample(kTouchSelectionSessionTouchDownCountHistogramName, 1, 1);
}
...
TEST(TouchSelectionSessionMetricsTest, DoesNotRecordDismissedSession)
{
    ...
    histogram_tester.ExpectTotalCount(kTouchSelectionSessionTouchDownCountHistogramName, 0);
}
...
TEST(TouchSelectionSessionMetricsTest, MultipleSessions)
{
    ...
    histogram_tester.ExpectTotalCount(kTouchSelectionSessionTouchDownCountHistogramName, 2);
    // First session.
    histogram_tester.ExpectBucketCount(kTouchSelectionSessionTouchDownCountHistogramName, 1, 1);
    // Third session.
    histogram_tester.ExpectBucketCount(kTouchSelectionSessionTouchDownCountHistogramName, 2, 1);
}
...
TEST(TouchSelectionSessionMetricsTest, MultipleActivationEvents)
{
    ...
    histogram_tester.ExpectUniqueSample(kTouchSelectionSessionTouchDownCountHistogramName, 3, 1);
}
...
TEST(TouchSelectionSessionMetricsTest, RecordsAfterCharacterKeyEvent)
{
    ...
    const KeyEvent key_event(EventType::kKeyPressed, VKEY_A, DomCode::US_A, EF_NONE, DomKey::FromCharacter('a'), EventTimeForNow());
