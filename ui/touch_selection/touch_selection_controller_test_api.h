...
public:
    ...
    TouchSelectionControllerTestApi(const TouchSelectionControllerTestApi&) = delete;
    TouchSelectionControllerTestApi& operator=(const TouchSelectionControllerTestApi&) = delete;
    ...
    bool temporarily_hidden() const
    {
        return controller_->temporarily_hidden_;
    }
