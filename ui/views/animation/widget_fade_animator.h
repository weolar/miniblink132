...
class VIEWS_EXPORT WidgetFadeAnimator : public AnimationDelegateViews, public WidgetObserver {
public:
    ...
    // kNone).
    using FadeCompleteCallbackSignature = void(WidgetFadeAnimator*, FadeType animation_type);
    using FadeCompleteCallback = base::RepeatingCallback<FadeCompleteCallbackSignature>;
    ...
    base::TimeDelta fade_in_duration() const
    {
        return fade_in_duration_;
    }
    ...
    base::TimeDelta fade_out_duration() const
    {
        return fade_out_duration_;
    }
    ...
    void set_close_on_hide(bool close_on_hide)
    {
        close_on_hide_ = close_on_hide;
    }
    bool close_on_hide() const
    {
        return close_on_hide_;
    }
    ...
    {
        return animation_type_ == FadeType::kFadeIn;
    }

    bool IsFadingOut() const
    {
        return animation_type_ == FadeType::kFadeOut;
    }
    ...
    base::CallbackListSubscription AddFadeCompleteCallback(FadeCompleteCallback callback);
...
private:
    ...
    base::RepeatingCallbackList<FadeCompleteCallbackSignature> fade_complete_callbacks_;
};
