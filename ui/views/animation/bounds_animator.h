...
public:
    ...
    void AnimateViewTo(View* view, const gfx::Rect& target, std::unique_ptr<gfx::AnimationDelegate> delegate = nullptr);
    ...
    void SetAnimationDelegate(View* view, std::unique_ptr<gfx::AnimationDelegate> delegate);
    ...
    void set_tween_type(gfx::Tween::Type type)
    {
        tween_type_ = type;
    }
...
private:
    ...
    using AnimationToViewMap = std::map<const gfx::Animation*, raw_ptr<View, CtnExperimental>>;
    ...
    void AnimationEndedOrCanceled(const gfx::Animation* animation, AnimationEndType type);

    // AnimationDelegateViews overrides.
    void AnimationProgressed(const gfx::Animation* animation) override;
    void AnimationEnded(const gfx::Animation* animation) override;
    void AnimationCanceled(const gfx::Animation* animation) override;
    void AnimationContainerProgressed(gfx::AnimationContainer* container) override;
    void AnimationContainerEmpty(gfx::AnimationContainer* container) override;
    void OnChildViewRemoved(views::View* observed_view, views::View* child) override;
