...
CompositorAnimationRunner::CompositorAnimationRunner(Widget* widget, const base::Location& location)
...
void CompositorAnimationRunner::OnCompositingShuttingDown(ui::Compositor* compositor)
{
    StopInternal();
}
