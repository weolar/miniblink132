...
public:
    ...
    static InkDropHost* Install(View* host, std::unique_ptr<InkDropHost> ink_drop);
    ...
    static std::unique_ptr<InkDrop> CreateInkDropForSquareRipple(
        InkDropHost* host, bool highlight_on_hover = true, bool highlight_on_focus = false, bool show_highlight_on_ripple = false);

    // Configure `host` to use CreateInkDropForSquareRipple().
    static void UseInkDropForSquareRipple(
        InkDropHost* host, bool highlight_on_hover = true, bool highlight_on_focus = false, bool show_highlight_on_ripple = false);
    ...
    static std::unique_ptr<InkDrop> CreateInkDropForFloodFillRipple(
        InkDropHost* host, bool highlight_on_hover = true, bool highlight_on_focus = false, bool show_highlight_on_ripple = true);
    ...
    static std::unique_ptr<InkDrop> CreateInkDropWithoutAutoHighlight(InkDropHost* host, bool highlight_on_hover = true, bool highlight_on_focus = false);

    // Configure `host` to use CreateInkDropWithoutAutoHighlight().
    static void UseInkDropWithoutAutoHighlight(InkDropHost* host, bool highlight_on_hover = true, bool highlight_on_focus = false);
