...
class VIEWS_EXPORT InkDropImpl : public InkDrop, public InkDropRippleObserver, public InkDropHighlightObserver {
public:
    ...
    // not focused.
    InkDropImpl(InkDropHost* ink_drop_host, const gfx::Size& host_size, AutoHighlightMode auto_highlight_mode);
...
private:
    ...
    public:
        ...
        virtual void AnimationEnded(InkDropState ink_drop_state, InkDropAnimationEndedReason reason) = 0;
    ...
    class HighlightStateFactory {
    public:
        HighlightStateFactory(AutoHighlightMode highlight_mode, InkDropImpl* ink_drop);
        ...
        std::unique_ptr<HighlightState> CreateHiddenState(base::TimeDelta animation_duration);

        std::unique_ptr<HighlightState> CreateVisibleState(base::TimeDelta animation_duration);
    ...
    void AnimationStarted(InkDropHighlight::AnimationType animation_type) override;
    void AnimationEnded(InkDropHighlight::AnimationType animation_type, InkDropAnimationEndedReason reason) override;
