...
public:
    void SetUp() override
    {
        ...
        widget_ = CreateTestWidget(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::Type::TYPE_WINDOW);
...
TEST_F(WidgetFadeAnimatorTest, FadeInCallback)
{
    ...
    auto subscription = delegate_->AddFadeCompleteCallback(base::BindLambdaForTesting([&](WidgetFadeAnimator*, WidgetFadeAnimator::FadeType animation_type) {
        ++called_count;
