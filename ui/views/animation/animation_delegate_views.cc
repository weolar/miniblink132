...
AnimationDelegateViews::AnimationDelegateViews(View* view, const base::Location& location)
    : view_(view)
    , location_(location)
{
    if (view)
...
void AnimationDelegateViews::AnimationContainerWasSet(gfx::AnimationContainer* container)
{
...
void AnimationDelegateViews::AnimationContainerShuttingDown(gfx::AnimationContainer* container)
{
    container_ = nullptr;
    ClearAnimationRunner();
}

base::TimeDelta AnimationDelegateViews::GetAnimationDurationForReporting() const
{
    return base::TimeDelta();
}

void AnimationDelegateViews::UpdateAnimationRunner(const base::Location& location)
{
    ...
    auto compositor_animation_runner = std::make_unique<CompositorAnimationRunner>(view_->GetWidget(), location);
