...
public:
    ...
    public:
        ...
        void OnLayerAnimationWillRepeat(ui::LayerAnimationSequence* sequence) override;
        void OnLayerAnimationAborted(ui::LayerAnimationSequence* sequence) override;
        void OnLayerAnimationScheduled(ui::LayerAnimationSequence* sequence) override;

        bool GetAttachedToSequence() const
        {
            return attached_to_sequence_;
        }
    ...
    // Must use before creating a sequence block.
    AnimationBuilder& OnEnded(base::OnceClosure callback, base::Location location = FROM_HERE);
    ...
    // Must use before creating a sequence block.
    AnimationBuilder& OnAborted(base::OnceClosure callback, base::Location location = FROM_HERE);
    ...
    void AddLayerAnimationElement(base::PassKey<AnimationSequenceBlock>, AnimationKey key, base::TimeDelta start, base::TimeDelta original_duration,
    ...
    static void SetObserverDeletedCallbackForTesting(base::RepeatingClosure deleted_closure);
...
private:
    ...
    std::multimap<ui::Layer*, std::unique_ptr<ui::LayerAnimationSequence>> layer_animation_sequences_;
