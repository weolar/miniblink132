...
public:
    ...
    virtual void AnimationStarted(InkDropHighlight::AnimationType animation_type) = 0;
    ...
    // frame.
    virtual void AnimationEnded(InkDropHighlight::AnimationType animation_type, InkDropAnimationEndedReason reason) = 0;
