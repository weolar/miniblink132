...
class VIEWS_EXPORT BubbleSlideAnimator : public AnimationDelegateViews, public WidgetObserver {
public:
    ...
    using SlideCompleteCallback = base::RepeatingCallback<SlideCompleteCallbackSignature>;
    ...
    using SlideProgressedCallbackSignature = void(BubbleSlideAnimator*, double animation_value);
    using SlideProgressedCallback = base::RepeatingCallback<SlideProgressedCallbackSignature>;
    ...
    base::CallbackListSubscription AddSlideProgressedCallback(SlideProgressedCallback callback);

    // Adds a listener for slide complete events.
    base::CallbackListSubscription AddSlideCompleteCallback(SlideCompleteCallback callback);
...
private:
    ...
    base::RepeatingCallbackList<SlideProgressedCallbackSignature> slide_progressed_callbacks_;
    base::RepeatingCallbackList<SlideCompleteCallbackSignature> slide_complete_callbacks_;
};
