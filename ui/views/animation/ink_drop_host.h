...
public:
    ...
    void SetCreateInkDropCallback(base::RepeatingCallback<std::unique_ptr<InkDrop>()> callback);
    ...
    void SetCreateRippleCallback(base::RepeatingCallback<std::unique_ptr<InkDropRipple>()> callback);
    ...
    void SetCreateHighlightCallback(base::RepeatingCallback<std::unique_ptr<InkDropHighlight>()> callback);

    // Callback replacement of CreateInkDropMask().
    // TODO(pbos): Investigate removing this. It currently is only used by
    // PieMenuView.
    void SetCreateMaskCallback(base::RepeatingCallback<std::unique_ptr<InkDropMask>()> callback);
    ...
    base::CallbackListSubscription AddHighlightedChangedCallback(base::RepeatingClosure callback);
    ...
    std::unique_ptr<InkDropRipple> CreateSquareRipple(const gfx::Point& center_point, const gfx::Size& size = kDefaultSquareInkDropSize) const;
...
private:
    ...
    absl::variant<SkColor, ui::ColorId, base::RepeatingCallback<SkColor()>> ink_drop_base_color_ = gfx::kPlaceholderColor;
    ...
    base::RepeatingCallback<std::unique_ptr<InkDropHighlight>()> create_ink_drop_highlight_callback_;

    base::RepeatingCallback<std::unique_ptr<InkDropMask>()> create_ink_drop_mask_callback_;
