...
class InkDropImplTestApi : public ui::test::MultiLayerAnimatorTestController, public ui::test::MultiLayerAnimatorTestControllerDelegate {
public:
    ...
    public:
        ...
        explicit AccessFactoryOnExitHighlightState(InkDropImpl::HighlightStateFactory* state_factory);

        AccessFactoryOnExitHighlightState(const AccessFactoryOnExitHighlightState&) = delete;
        AccessFactoryOnExitHighlightState& operator=(const AccessFactoryOnExitHighlightState&) = delete;
    ...
    public:
        ...
        explicit SetStateOnExitHighlightState(InkDropImpl::HighlightStateFactory* state_factory);

        SetStateOnExitHighlightState(const SetStateOnExitHighlightState&) = delete;
        SetStateOnExitHighlightState& operator=(const SetStateOnExitHighlightState&) = delete;
    ...
    void SetHighlightState(std::unique_ptr<InkDropImpl::HighlightState> highlight_state);
