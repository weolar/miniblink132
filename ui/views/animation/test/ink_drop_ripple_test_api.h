...
class InkDropRippleTestApi : public ui::test::MultiLayerAnimatorTestController, public ui::test::MultiLayerAnimatorTestControllerDelegate {
public:
...
protected:
    ...
    InkDropRipple* ink_drop_ripple() const
    {
        return ink_drop_ripple_;
    }
