...
void InkDropHostTestApi::SetInkDrop(std::unique_ptr<InkDrop> ink_drop, bool handles_gesture_events)
{
    ink_drop_host_->SetMode(handles_gesture_events ? views::InkDropHost::InkDropMode::ON : views::InkDropHost::InkDropMode::ON_NO_GESTURE_HANDLER);
...
void InkDropHostTestApi::AnimateToState(InkDropState state, const ui::LocatedEvent* event)
{
