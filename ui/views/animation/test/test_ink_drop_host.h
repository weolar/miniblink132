...
public:
    explicit TestInkDropHost(InkDropImpl::AutoHighlightMode auto_highlight_mode = InkDropImpl::AutoHighlightMode::NONE);
    ...
    int num_ink_drop_layers_added() const
    {
        return num_ink_drop_layers_added_;
    }
