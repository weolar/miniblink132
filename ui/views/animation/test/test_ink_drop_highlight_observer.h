...
// last invocation.
class TestInkDropHighlightObserver : public InkDropHighlightObserver, public TestInkDropAnimationObserverHelper<InkDropHighlight::AnimationType> {
public:
...
private:
    ...
    using ObserverHelper = TestInkDropAnimationObserverHelper<InkDropHighlight::AnimationType>;
