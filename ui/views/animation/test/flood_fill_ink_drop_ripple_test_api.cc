...
FloodFillInkDropRippleTestApi::FloodFillInkDropRippleTestApi(FloodFillInkDropRipple* ink_drop_ripple)
...
gfx::Point3F FloodFillInkDropRippleTestApi::MapPoint(float radius, const gfx::Point3F& point)
{
...
{
    return ToRoundedPoint(PointAtOffsetFromOrigin(ink_drop_ripple()->circle_layer_delegate_.GetCenteringOffset()));
}

float FloodFillInkDropRippleTestApi::MaxDistanceToCorners(const gfx::Point& point) const
{
...
std::vector<ui::LayerAnimator*> FloodFillInkDropRippleTestApi::GetLayerAnimators()
{
