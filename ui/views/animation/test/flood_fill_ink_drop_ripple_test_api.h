...
public:
    explicit FloodFillInkDropRippleTestApi(FloodFillInkDropRipple* ink_drop_ripple);

    FloodFillInkDropRippleTestApi(const FloodFillInkDropRippleTestApi&) = delete;
    FloodFillInkDropRippleTestApi& operator=(const FloodFillInkDropRippleTestApi&) = delete;
...
private:
    ...
    {
        return static_cast<const FloodFillInkDropRippleTestApi*>(this)->ink_drop_ripple();
    }

    FloodFillInkDropRipple* ink_drop_ripple() const
    {
        return static_cast<FloodFillInkDropRipple*>(InkDropRippleTestApi::ink_drop_ripple());
    }
};
