...
public:
    ...
    SlideOutController(ui::EventTarget* target, SlideOutControllerDelegate* delegate);
    ...
    float gesture_amount() const
    {
        return gesture_amount_;
    }
...
private:
    ...
    void SetTransformWithAnimationIfNecessary(const gfx::Transform& transform, base::TimeDelta animation_duration);
