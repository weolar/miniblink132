...
gfx::Transform GetTransformSubpixelCorrection(const gfx::Transform& transform, float device_scale_factor)
{
...
{
    return view->GetWidget() && view->GetNativeTheme()->GetDefaultSystemColorScheme() == ui::NativeTheme::ColorScheme::kPlatformHighContrast
        && base::FeatureList::IsEnabled(features::kEnablePlatformHighContrastInkDrop);
}
