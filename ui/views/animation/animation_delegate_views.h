...
class VIEWS_EXPORT AnimationDelegateViews : public gfx::AnimationDelegate, public ViewObserver, public gfx::AnimationContainerObserver {
public:
    explicit AnimationDelegateViews(View* view, const base::Location& location = FROM_HERE);
    ...
    void AnimationContainerShuttingDown(gfx::AnimationContainer* container) override;
    ...
    const base::Location& location_for_test() const
    {
        return location_;
    }
