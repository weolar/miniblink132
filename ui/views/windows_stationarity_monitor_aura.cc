...
WindowsStationarityMonitorAura::WindowsStationarityMonitorAura()
{
    ...
    for (aura::WindowTreeHost* window_tree_host : aura::Env::GetInstance()->window_tree_hosts()) {
...
void WindowsStationarityMonitorAura::OnHostInitialized(aura::WindowTreeHost* host)
{
    ...
    // ignored.
    if (!native_widget || !Widget::RequiresNonClientView(native_widget->widget_type())) {
        return;
    }
#endif
