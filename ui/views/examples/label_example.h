...
class VIEWS_EXAMPLES_EXPORT LabelExample : public ExampleBase, public TextfieldController, public ViewObserver {
public:
    LabelExample();
...
private:
    ...
    Combobox* AddCombobox(View* parent, std::u16string name, base::span<const char* const> items, void (LabelExample::*function)());
