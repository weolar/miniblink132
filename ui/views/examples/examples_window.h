...
VIEWS_EXAMPLES_EXPORT void ShowExamplesWindow(
    base::OnceClosure on_close, ExampleVector examples = CreateExamples(), gfx::NativeWindow window_context = gfx::NativeWindow());
...
template <typename... Args> void PrintStatus(const char* format, Args... args)
{
