...
void ExamplesViewsDelegateChromeOS::OnBeforeWidgetInit(Widget::InitParams* params, internal::NativeWidgetDelegate* delegate)
{
...
void ExamplesViewsDelegateChromeOS::OnHostCloseRequested(aura::WindowTreeHost* host)
{
