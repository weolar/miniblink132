...
private:
    void ActionSelected();
    void AssignAction(actions::ActionItem* action, actions::ActionInvocationContext context);
    void ActionInvoked(actions::ActionItem* action, actions::ActionInvocationContext context);
    void CreateControl(actions::ActionItem* action, actions::ActionInvocationContext context);
