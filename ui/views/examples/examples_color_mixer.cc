...
void AddExamplesColorMixers(ui::ColorProvider* color_provider, const ui::ColorProviderKey& key)
{
    ...
    mixer[Ids::kColorBubbleExampleBackground4] = { SkColorSetRGB(0xC1, 0xB1, 0xE1) };
    ...
    mixer[Ids::kColorButtonBackgroundFab] = { dark_mode ? ui::kColorRefSecondary30 : ui::kColorRefPrimary90 };
}
