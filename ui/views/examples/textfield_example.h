...
class VIEWS_EXAMPLES_EXPORT TextfieldExample : public ExampleBase, public TextfieldController {
public:
    TextfieldExample();
...
private:
    ...
    bool HandleMouseEvent(Textfield* sender, const ui::MouseEvent& mouse_event) override;
