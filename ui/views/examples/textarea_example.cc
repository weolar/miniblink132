...
{
    constexpr char16_t kLongText[] = u"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do "
    ...
    textarea->GetViewAccessibility().SetName(l10n_util::GetStringUTF16(IDS_TEXTAREA_NAME));
