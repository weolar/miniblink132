    ...
    Builder<View>(container)
        ...
        .AddChild(Builder<FlexLayoutView>()
                      ...
                      .AddChildren(Builder<Checkbox>()
                                       .SetText(u"Checkbox")
                                       .SetCallback(base::BindRepeating([](int* count) { PrintStatus("Pressed! count: %d", ++(*count)); }, &count_)),
                          Builder<Checkbox>().SetText(u"Disabled Unchecked").SetState(Button::STATE_DISABLED),
