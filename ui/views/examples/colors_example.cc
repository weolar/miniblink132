...
void InsertColorRow(View* parent, std::u16string_view label_string, ui::ColorId color_id)
{
    auto* label_view = parent->AddChildView(std::make_unique<Label>(std::u16string(label_string)));
    ...
    std::string color_string = base::StringPrintf("#%02x%02x%02x Alpha: %d", red, green, blue, alpha);
...
void CreateAllColorsView(ScrollView* scroll_view)
{
    ...
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorRadioButtonForegroundUnchecked));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorButtonBackgroundProminent));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorButtonBackgroundProminentFocused));
    ...
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorMenuItemForegroundSecondary));
    ...
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorMenuItemBackgroundHighlighted));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorMenuItemForegroundHighlighted));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorMenuItemBackgroundAlertedInitial));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorMenuItemBackgroundAlertedTarget));
    ...
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTextfieldForegroundPlaceholder));
    ...
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTextfieldSelectionForeground));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTextfieldSelectionBackground));
    ...
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTreeNodeForegroundSelectedFocused));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTreeNodeForegroundSelectedUnfocused));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTreeNodeBackgroundSelectedFocused));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTreeNodeBackgroundSelectedUnfocused));
    ...
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTableForegroundSelectedFocused));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTableForegroundSelectedUnfocused));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTableBackgroundSelectedFocused));
    InsertColorRow(container, COLOR_LABEL_ARGS(kColorTableBackgroundSelectedUnfocused));
