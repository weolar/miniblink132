...
TypographyExample::TypographyExample()
    : ExampleBase(l10n_util::GetStringUTF8(IDS_TYPOGRAPHY_SELECT_LABEL).c_str())
{
}
...
void TypographyExample::CreateExampleView(View* container)
{
    ...
    std::u16string headline_text = l10n_util::GetStringUTF16(IDS_TYPOGRAPHY_HEADLINE_PLACEHOLDER_TEXT);
    std::u16string body_text = l10n_util::GetStringUTF16(IDS_TYPOGRAPHY_BODY_PLACEHOLDER_TEXT);

    auto headlines = Builder<TableLayoutView>()
                         ...
                         .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 600, 0)
                         .AddRows(6, TableLayout::kFixedSize, 0)
                         .AddChildren(Builder<Label>().SetText(u"HeadLine1"),
                             Builder<Label>()
    ...
    auto bodies = Builder<TableLayoutView>()
                      .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
                      .AddPaddingColumn(TableLayout::kFixedSize, 4)
                      .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 220, 0)
                      .AddPaddingColumn(TableLayout::kFixedSize, 4)
                      .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 220, 0)
                      .AddPaddingColumn(TableLayout::kFixedSize, 4)
                      .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 220, 0)
                      .AddRows(9, TableLayout::kFixedSize, 0)
                      .AddChildren(Builder<View>(), Builder<Label>().SetText(u"Regular"), Builder<Label>().SetText(u"Medium"),
                          Builder<Label>().SetText(u"Bold"), Builder<Label>().SetText(u"Body1"),
                          Builder<Label>()
                              .SetText(body_text)
                              .SetMultiLine(true)
                              .SetHorizontalAlignment(gfx::HorizontalAlignment::ALIGN_LEFT)
