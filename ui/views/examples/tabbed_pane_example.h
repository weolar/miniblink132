...
class VIEWS_EXAMPLES_EXPORT TabbedPaneExample : public ExampleBase, public TabbedPaneListener {
public:
    TabbedPaneExample();
...
private:
    ...
    void CreateTabbedPane(View* container, TabbedPane::Orientation orientation, TabbedPane::TabStripStyle style);
