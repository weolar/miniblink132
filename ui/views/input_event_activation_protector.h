...
class VIEWS_EXPORT InputEventActivationProtector : WindowsStationarityMonitor::Observer {
public:
    ...
    InputEventActivationProtector& operator=(const InputEventActivationProtector&) = delete;
