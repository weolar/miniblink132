...
const ui::Layer* NextLayer(const ui::Layer* layer)
{
    ...
    if (!parent)
        return nullptr;
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>> children = parent->children();
...
// trees are in sync.
bool ViewAndLayerTreeAreConsistent(const views::View* view, const ui::Layer* layer)
{
    ...
    while (v && l) {
        ...
        if (v->IsDrawn() != l->IsVisible()) {
            for (const views::View* vv = v; vv; vv = vv->parent())
                LOG(ERROR) << "V: " << vv << " " << vv->GetVisible() << " " << vv->IsDrawn() << " " << vv->layer();
...
public:
    ...
    explicit A11yTestView(std::optional<ax::mojom::Role> role = std::nullopt, std::optional<std::u16string> name = std::nullopt,
        std::optional<std::u16string> description = std::nullopt, std::optional<std::u16string> role_description = std::nullopt,
        std::optional<ax::mojom::NameFrom> name_from = std::nullopt, std::optional<ax::mojom::DescriptionFrom> description_from = std::nullopt)
    {
        if (role) {
    ...
    void AdjustAccessibleName(std::u16string& new_name, ax::mojom::NameFrom& name_from) override
    {
...
public:
    int layout_count() const
    {
        return layout_count_;
    }
...
TEST_F(ViewTest, ReadyToSendAccessibilityEvents)
{
    ...
    // send events.
    root->GetViewAccessibility().SetName(u"Root", ax::mojom::NameFrom::kAttribute);
    ...
    added_view_2->GetViewAccessibility().SetName(u"Child", ax::mojom::NameFrom::kAttribute);
    EXPECT_EQ(ax_counter.GetCount(ax::mojom::Event::kTextChanged, added_view_2), 0);

    // Events should be sent if the view is connected to a RootView.
    auto* added_view_1 = root->AddChildView(std::move(view1));
    added_view_1->GetViewAccessibility().SetName(u"Descendant_1", ax::mojom::NameFrom::kAttribute);
    EXPECT_EQ(ax_counter.GetCount(ax::mojom::Event::kTextChanged, added_view_1), 1);
    added_view_2->GetViewAccessibility().SetName(u"Descendant_2", ax::mojom::NameFrom::kAttribute);
    EXPECT_EQ(ax_counter.GetCount(ax::mojom::Event::kTextChanged, added_view_2), 1);
}

TEST_F(ViewTest, SetAccessibilityPropertiesRoleNameDescription)
{
    views::test::AXEventCounter ax_counter(views::AXEventManager::Get());
    auto v = std::make_unique<A11yTestView>(ax::mojom::Role::kButton, u"Name", u"Description");
    ...
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"Name");
    EXPECT_EQ(static_cast<ax::mojom::NameFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)), ax::mojom::NameFrom::kAttribute);
    EXPECT_EQ(v->GetViewAccessibility().GetCachedDescription(), u"Description");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kDescription), u"Description");
    EXPECT_EQ(
        static_cast<ax::mojom::DescriptionFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom)), ax::mojom::DescriptionFrom::kAriaDescription);
...
TEST_F(ViewTest, SetAccessibilityPropertiesRoleNameDescriptionDetailed)
{
    views::test::AXEventCounter ax_counter(views::AXEventManager::Get());
    auto v = std::make_unique<A11yTestView>(ax::mojom::Role::kButton, u"Name", u"Description",
        /*role_description*/ u"", ax::mojom::NameFrom::kContents, ax::mojom::DescriptionFrom::kTitle);
    ui::AXNodeData data = ui::AXNodeData();
    v->GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(v->GetViewAccessibility().GetCachedRole(), ax::mojom::Role::kButton);
    EXPECT_EQ(data.role, ax::mojom::Role::kButton);
    EXPECT_EQ(v->GetViewAccessibility().GetCachedName(), u"Name");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"Name");
    EXPECT_EQ(static_cast<ax::mojom::NameFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)), ax::mojom::NameFrom::kContents);
    EXPECT_EQ(v->GetViewAccessibility().GetCachedDescription(), u"Description");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kDescription), u"Description");
    EXPECT_EQ(static_cast<ax::mojom::DescriptionFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom)), ax::mojom::DescriptionFrom::kTitle);
...
{
    views::test::AXEventCounter ax_counter(views::AXEventManager::Get());
    auto v = std::make_unique<A11yTestView>(ax::mojom::Role::kButton, u"Name", u"Description", u"Super Button");
    ui::AXNodeData data = ui::AXNodeData();
    v->GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(v->GetViewAccessibility().GetCachedRole(), ax::mojom::Role::kButton);
    EXPECT_EQ(data.role, ax::mojom::Role::kButton);
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kRoleDescription), u"Super Button");
    EXPECT_EQ(v->GetViewAccessibility().GetCachedName(), u"Name");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"Name");
    EXPECT_EQ(v->GetViewAccessibility().GetCachedDescription(), u"Description");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kDescription), u"Description");
...
TEST_F(ViewTest, SetAccessibilityPropertiesNameExplicitlyEmpty)
{
    A11yTestView v(ax::mojom::Role::kNone,
        /*name*/ u"",
        /*description*/ u"",
        /*role_description*/ u"", ax::mojom::NameFrom::kAttributeExplicitlyEmpty);
    ui::AXNodeData data = ui::AXNodeData();
    v.GetViewAccessibility().GetAccessibleNodeData(&data);
    ...
    EXPECT_EQ(static_cast<ax::mojom::NameFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)), ax::mojom::NameFrom::kAttributeExplicitlyEmpty);
}
...
TEST_F(ViewTest, SetAccessibleRole)
{
    ...
    ui::AXNodeData data = ui::AXNodeData();
    v.GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(v.GetViewAccessibility().GetCachedRole(), ax::mojom::Role::kUnknown);
...
TEST_F(ViewTest, AdjustAccessibleNameStringWithRoleAlreadySet)
{
    ...
    added_view->GetViewAccessibility().SetName(u"Name");
    added_view->GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(added_view->GetViewAccessibility().GetCachedName(), u"Prefix: Name");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"Prefix: Name");
    EXPECT_EQ(added_view->last_a11y_event_, ax::mojom::Event::kTextChanged);
}
...
TEST_F(ViewTest, SetAccessibleNameToLabelWithRoleAlreadySet)
{
    ...
    EXPECT_EQ(added_view->GetViewAccessibility().GetCachedName(), u"");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"");
    EXPECT_EQ(static_cast<ax::mojom::NameFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)), ax::mojom::NameFrom::kNone);
    EXPECT_FALSE(data.HasIntListAttribute(ax::mojom::IntListAttribute::kLabelledbyIds));
    ...
    added_view->GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(added_view->GetViewAccessibility().GetCachedName(), u"Label's Name");
    EXPECT_TRUE(data.HasIntListAttribute(ax::mojom::IntListAttribute::kLabelledbyIds));
    EXPECT_EQ(static_cast<ax::mojom::NameFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)), ax::mojom::NameFrom::kRelatedElement);
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"Label's Name");
    EXPECT_EQ(added_view->last_a11y_event_, ax::mojom::Event::kTextChanged);
}
...
TEST_F(ViewTest, AdjustAccessibleNameFrom)
{
    ...
    EXPECT_EQ(added_view->GetViewAccessibility().GetCachedName(), u"Name");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"Name");
    EXPECT_EQ(static_cast<ax::mojom::NameFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)), ax::mojom::NameFrom::kPlaceholder);
    EXPECT_EQ(added_view->last_a11y_event_, ax::mojom::Event::kTextChanged);
}
...
TEST_F(ViewTest, AdjustAccessibleNameFromLabelWithRoleAlreadySet)
{
    ...
    added_view->GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(added_view->GetViewAccessibility().GetCachedName(), u"Prefix: Label's Name");
    EXPECT_TRUE(data.HasIntListAttribute(ax::mojom::IntListAttribute::kLabelledbyIds));
    EXPECT_EQ(static_cast<ax::mojom::NameFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kNameFrom)), ax::mojom::NameFrom::kRelatedElement);
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), u"Prefix: Label's Name");
    EXPECT_EQ(added_view->last_a11y_event_, ax::mojom::Event::kTextChanged);
}
...
TEST_F(ViewTest, SetAccessibleDescriptionToString)
{
    ...
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kDescription), u"");
...
TEST_F(ViewTest, SetAccessibleDescriptionToLabel)
{
    ...
    EXPECT_EQ(v.GetViewAccessibility().GetCachedDescription(), u"");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kDescription), u"");
    EXPECT_EQ(static_cast<ax::mojom::DescriptionFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom)), ax::mojom::DescriptionFrom::kNone);
    EXPECT_FALSE(data.HasIntListAttribute(ax::mojom::IntListAttribute::kDescribedbyIds));

    data = ui::AXNodeData();
    v.GetViewAccessibility().SetDescription(label);
    v.GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(v.GetViewAccessibility().GetCachedDescription(), u"Label's Name");
    EXPECT_TRUE(data.HasIntListAttribute(ax::mojom::IntListAttribute::kDescribedbyIds));
    EXPECT_EQ(
        static_cast<ax::mojom::DescriptionFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom)), ax::mojom::DescriptionFrom::kRelatedElement);
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kDescription), u"Label's Name");
}
...
TEST_F(ViewTest, SetAccessibleDescriptionExplicitlyEmpty)
{
    ...
    data = ui::AXNodeData();
    v.GetViewAccessibility().SetDescription(u"", ax::mojom::DescriptionFrom::kAttributeExplicitlyEmpty);
    v.GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(v.GetViewAccessibility().GetCachedDescription(), u"");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kDescription), u"");
    EXPECT_EQ(static_cast<ax::mojom::DescriptionFrom>(data.GetIntAttribute(ax::mojom::IntAttribute::kDescriptionFrom)),
...
TEST_F(ViewTest, MouseEvent)
{
    ...
    ui::MouseEvent pressed(ui::EventType::kMousePressed, p1, p1, ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON);
    ...
    v2->Reset();
    gfx::Point p2(50, 40);
    ui::MouseEvent dragged(ui::EventType::kMouseDragged, p2, p2, ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, 0);
    ...
    v1->Reset();
    v2->Reset();
    ui::MouseEvent released(ui::EventType::kMouseReleased, gfx::Point(), gfx::Point(), ui::EventTimeForNow(), 0, 0);
...
TEST_F(ViewTest, DeleteOnPressed)
{
    ...
    ui::MouseEvent pressed(ui::EventType::kMousePressed, point, point, ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON);
    root->OnMousePressed(pressed);
...
{
    ScopedTestPaintWidget widget(CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_POPUP));
    ...
    root_view->Paint(PaintInfo::CreateRootPaintInfo(ui::PaintContext(list.get(), 1.f, first_paint, false), first_paint.size()));
...
TEST_F(ViewTest, PaintWithMovedViewUsesCache)
{
    ...
    auto list = base::MakeRefCounted<cc::DisplayItemList>();
    root_view->PaintFromPaintRoot(ui::PaintContext(list.get(), device_scale_factor, pixel_rect, false));
    ...
    int item_index = 3;
    EXPECT_EQ(expected_visual_rect_in_layer_space, list->VisualRectForTesting(item_index++));
    EXPECT_EQ(expected_visual_rect_in_layer_space, list->VisualRectForTesting(item_index++));
    EXPECT_EQ(expected_visual_rect_in_layer_space, list->VisualRectForTesting(item_index));
    ...
    list = base::MakeRefCounted<cc::DisplayItemList>();
    root_view->PaintFromPaintRoot(ui::PaintContext(list.get(), device_scale_factor, v1->bounds(), false));
    EXPECT_TRUE(v1->did_paint_);
    v1->Reset();
    ...
    root_view->PaintFromPaintRoot(
        ui::PaintContext(ui::PaintContext(list.get(), device_scale_factor, pixel_rect, false), ui::PaintContext::CLONE_WITHOUT_INVALIDATION));
    EXPECT_TRUE(v1->did_paint_);
    v1->Reset();
    item_index = 3;
...
TEST_F(ViewTest, PaintWithUnknownInvalidation)
{
    ...
    gfx::Rect first_paint(1, 1);
    auto list = base::MakeRefCounted<cc::DisplayItemList>();
    root_view->PaintFromPaintRoot(ui::PaintContext(list.get(), 1.f, first_paint, false));
    v1->Reset();
    v2->Reset();
    ...
    root_view->PaintFromPaintRoot(ui::PaintContext(list.get(), 1.f, paint_area, false));
    EXPECT_FALSE(v1->did_paint_);
    EXPECT_FALSE(v2->did_paint_);

    // With unknown invalidation, v1 and v2 are painted.
    root_view->PaintFromPaintRoot(ui::PaintContext(ui::PaintContext(list.get(), 1.f, paint_area, false), ui::PaintContext::CLONE_WITHOUT_INVALIDATION));
    EXPECT_TRUE(v1->did_paint_);
    EXPECT_TRUE(v2->did_paint_);
}
...
TEST_F(ViewTest, PaintContainsChildren)
{
    ...
    gfx::Rect first_paint(1, 1);
    auto list = base::MakeRefCounted<cc::DisplayItemList>();
    root_view->Paint(PaintInfo::CreateRootPaintInfo(ui::PaintContext(list.get(), 1.f, first_paint, false), root_view->size()));
    v1->Reset();
    v2->Reset();
    ...
    EXPECT_FALSE(v1->did_paint_);
    EXPECT_FALSE(v2->did_paint_);
    root_view->Paint(PaintInfo::CreateRootPaintInfo(ui::PaintContext(list.get(), 1.f, paint_area, false), root_view->size()));
    EXPECT_TRUE(v1->did_paint_);
    EXPECT_TRUE(v2->did_paint_);
}
...
TEST_F(ViewTest, PaintInPromotedToLayer)
{
...

    {
        ...
        gfx::Rect first_paint(1, 1);
        auto list = base::MakeRefCounted<cc::DisplayItemList>();
        v1->Paint(PaintInfo::CreateRootPaintInfo(ui::PaintContext(list.get(), 1.f, first_paint, false), v1->size()));
        v1->Reset();
        v2->Reset();
    }
...

    {
        ...
        v1->Paint(PaintInfo::CreateRootPaintInfo(ui::PaintContext(list.get(), 1.f, paint_area, false), v1->size()));
        EXPECT_TRUE(v1->did_paint_);
        EXPECT_FALSE(v2->did_paint_);
    }
...
public:
    ...
    gfx::Rect canvas_bounds() const
    {
        return canvas_bounds_;
    }
...
TEST_F(ViewTest, NotifyEnterExitOnChild)
{
    ...
    gfx::Point p1(6, 6);
    ui::MouseEvent move1(ui::EventType::kMouseMoved, p1, p1, ui::EventTimeForNow(), 0, 0);
    ...
    // Now, move into v121.
    gfx::Point p2(65, 21);
    ui::MouseEvent move2(ui::EventType::kMouseMoved, p2, p2, ui::EventTimeForNow(), 0, 0);
    ...
    // Now, move into v11.
    gfx::Point p3(1, 1);
    ui::MouseEvent move3(ui::EventType::kMouseMoved, p3, p3, ui::EventTimeForNow(), 0, 0);
    ...
    // Move to v21.
    gfx::Point p4(121, 15);
    ui::MouseEvent move4(ui::EventType::kMouseMoved, p4, p4, ui::EventTimeForNow(), 0, 0);
    ...
    // Move to v1.
    gfx::Point p5(21, 0);
    ui::MouseEvent move5(ui::EventType::kMouseMoved, p5, p5, ui::EventTimeForNow(), 0, 0);
    ...
    // Now, move into v11.
    gfx::Point p6(15, 15);
    ui::MouseEvent mouse6(ui::EventType::kMouseMoved, p6, p6, ui::EventTimeForNow(), 0, 0);
    ...
    gfx::Point p7(21, 0);
    ui::MouseEvent mouse7(ui::EventType::kMouseMoved, p7, p7, ui::EventTimeForNow(), 0, 0);
...
{
    const std::u16string kText = u"Reality is that which, when you stop believing it, doesn't go away.";
...
TEST_F(ViewTest, TextfieldCutCopyPaste)
{
    ...
    clipboard->ReadText(ui::ClipboardBuffer::kCopyPaste, /* data_dst = */ nullptr, &result);
...
public:
    ...
    ViewPaintOptimizationTest& operator=(const ViewPaintOptimizationTest&) = delete;

    ~ViewPaintOptimizationTest() override = default;

    void SetUp() override
    {
        scoped_feature_list_.InitAndEnableFeature(views::features::kEnableViewPaintOptimization);
        ViewTest::SetUp();
    }
...
TEST_F(ViewPaintOptimizationTest, PaintDirtyViewsOnly)
{
    ...
    root_view->Paint(PaintInfo::CreateRootPaintInfo(ui::PaintContext(list.get(), 1.f, paint_area, false), empty_rect.size()));
...
public:
    TestViewWidget(Widget::InitParams create_params, ui::Accelerator* initial_accelerator, bool show_after_init = true)
    {
        auto view = std::make_unique<TestView>();
        view->Reset();
...
TEST_F(ViewTest, HandleAccelerator)
{
    ...
    TestViewWidget test_widget(CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_POPUP), &return_accelerator);
    ...
    Widget::InitParams child_params = CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_CONTROL);
    child_params.parent = widget->GetNativeView();
    child_widget->Init(std::move(child_params));
    TestView* child_view = child_widget->SetContentsView(std::make_unique<TestView>());
    child_view->Reset();
...
TEST_F(ViewTest, ActivateAcceleratorOnMac)
{
    ...
    TestViewWidget test_widget(CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_POPUP), &command_accelerator);
    TestView* view = test_widget.view();

    ui::test::EventGenerator event_generator(test_widget.widget()->GetNativeWindow());
    // Emulate normal event dispatch through -[NSWindow sendEvent:].
    event_generator.set_target(ui::test::EventGenerator::Target::WINDOW);

    event_generator.PressKey(command_accelerator.key_code(), command_accelerator.modifiers());
    event_generator.ReleaseKey(command_accelerator.key_code(), command_accelerator.modifiers());
    ...
    ui::Accelerator key_up_accelerator(ui::VKEY_TAB, ui::EF_CONTROL_DOWN | ui::EF_SHIFT_DOWN);
    view->AddAccelerator(key_up_accelerator);
    event_generator.PressKey(key_up_accelerator.key_code(), key_up_accelerator.modifiers());
    event_generator.ReleaseKey(key_up_accelerator.key_code(), key_up_accelerator.modifiers());
    ...
    ui::Accelerator key_down_accelerator(ui::VKEY_L, ui::EF_CONTROL_DOWN | ui::EF_ALT_DOWN | ui::EF_SHIFT_DOWN);
    view->AddAccelerator(key_down_accelerator);
    event_generator.PressKey(key_down_accelerator.key_code(), key_down_accelerator.modifiers());
    event_generator.ReleaseKey(key_down_accelerator.key_code(), key_down_accelerator.modifiers());
...
{
    ui::Accelerator return_accelerator(ui::VKEY_RETURN, ui::EF_NONE);
    TestViewWidget test_widget(CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_POPUP), &return_accelerator, false);
    TestView* view = test_widget.view();
    Widget* widget = test_widget.widget();
    FocusManager* focus_manager = test_widget.widget()->GetFocusManager();
...
public:
    ...
    ToplevelWidgetObserverView& operator=(const ToplevelWidgetObserverView&) = delete;
...
TEST_F(ViewTest, NativeViewHierarchyChanged)
{
    ...
    Widget::InitParams toplevel1_params = CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_POPUP);
    toplevel1->Init(std::move(toplevel1_params));

    auto toplevel2 = std::make_unique<Widget>();
    Widget::InitParams toplevel2_params = CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_POPUP);
    toplevel2->Init(std::move(toplevel2_params));

    auto child = std::make_unique<Widget>();
    Widget::InitParams child_params(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_CONTROL);
    ...
    ToplevelWidgetObserverView* observer_view = child->SetContentsView(std::move(owning_observer_view));
    EXPECT_EQ(toplevel1.get(), observer_view->toplevel());

    Widget::ReparentNativeView(child->GetNativeView(), toplevel2->GetNativeView());
    EXPECT_EQ(toplevel2.get(), observer_view->toplevel());
    EXPECT_EQ(toplevel2.get(), child->parent());

    owning_observer_view = observer_view->parent()->RemoveChildViewT(observer_view);
...
public:
    ...
    gfx::Rect scheduled_paint_rect() const
    {
        return scheduled_paint_rect_;
    }
...
TEST_F(ViewTest, TransformEvent)
{
    ...
    ui::MouseEvent p2(ui::EventType::kMousePressed, point2, point2, ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON);
    ...
    ui::MouseEvent p3(ui::EventType::kMousePressed, point, point, ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON);
    ...
    ui::MouseEvent p4(ui::EventType::kMousePressed, point3, point3, ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON);
...
TEST_F(ViewTest, WidgetObserverViewWidgetClosedViewReparented)
{
    ...
    View* contents_view = widget->GetRootView()->AddChildView(std::make_unique<View>());
    ...
    params = CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_WINDOW);
...
public:
    ...
    bool received_notification() const
    {
...
TEST_F(ViewTest, OnVisibleBoundsChanged)
{
    ...
    VisibleBoundsView* child = contents->AddChildView(std::make_unique<VisibleBoundsView>());
...
TEST_F(ViewTest, ConversionsWithTransform)
{
    ...
    // Conversions from child->top and top->child.
    {
        ...
        EXPECT_TRUE(kActualF.ApproximatelyEqual(gfx::RectF(kExpected), kDefaultAllowedConversionError, kDefaultAllowedConversionError));

        View::ConvertRectToTarget(child, &top_view, &kSrcF);
        EXPECT_TRUE(kSrcF.ApproximatelyEqual(gfx::RectF(kExpected), kDefaultAllowedConversionError, kDefaultAllowedConversionError));
    ...
    // Conversions from child_child->top and top->child_child.
    {
        ...
        gfx::RectF kActualF = View::ConvertRectToTarget(child_child, &top_view, kSrcF);
        EXPECT_TRUE(kActualF.ApproximatelyEqual(gfx::RectF(kExpected), kDefaultAllowedConversionError, kDefaultAllowedConversionError));
...
TEST_F(ViewTest, ConvertRectWithTransform)
{
    ...
    EXPECT_EQ(gfx::Rect(22, 60, 21, 8).ToString(), v2->ConvertRectToWidget(rect).ToString());
}
...
void ObserverView::ViewHierarchyChanged(const ViewHierarchyChangedDetails& details)
{
...
public:
    ...
    int added_to_widget_count()
    {
        return added_to_widget_count_;
    }
    int removed_from_widget_count()
    {
        return removed_from_widget_count_;
    }
...
TEST_F(ViewTest, AddedToRemovedFromWidget)
{
    ...
    params = CreateParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_POPUP);
    ...
    v1_ptr = second_root->AddChildView(v1_ptr->parent()->RemoveChildViewT(v1_ptr));
...
TEST_F(ViewTest, UseMirroredLayoutDisableMirroring)
{
    ...
    parent.SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal));
...
public:
    ...
    const gfx::Rect& last_bounds() const
    {
        return last_bounds_;
    }
...
public:
    explicit TestingLayerViewObserver(View* view)
        : view_(view)
    {
    ...
    ~TestingLayerViewObserver() override
    {
...
public:
    ...
    {
        scoped_feature_list_.InitAndDisableFeature(::features::kEnablePixelCanvasRecording);
    }

protected:
    // Accessors to View internals.
    void SchedulePaintOnParent(View* view)
    {
        view->SchedulePaintOnParent();
    }
...
TEST_F(ViewLayerTest, ToggleVisibilityWithLayer)
{
    ...
    EXPECT_FALSE(LayerIsAncestor(widget()->GetCompositor()->root_layer(), v1->layer()));

    // Once the view is attached to a widget, its layer should be attached to the
    // root layer and visible.
    content_view->AddChildView(v1);
    EXPECT_TRUE(LayerIsAncestor(widget()->GetCompositor()->root_layer(), v1->layer()));
...
TEST_F(ViewLayerTest, OrphanLayerAfterViewRemove)
{
    ...
    v1->AddChildView(v2);
    v2->SetPaintToLayer();
    EXPECT_TRUE(LayerIsAncestor(widget()->GetCompositor()->root_layer(), v2->layer()));
    EXPECT_TRUE(v2->layer()->IsVisible());

    content_view->RemoveChildView(v1);

    EXPECT_FALSE(LayerIsAncestor(widget()->GetCompositor()->root_layer(), v2->layer()));
...
{
    PaintTrackingView* content_view = widget()->SetContentsView(std::make_unique<PaintTrackingView>());
    content_view->SetPaintToLayer();
    GetRootLayer()->GetCompositor()->ScheduleDraw();
    ui::DrawWaiterForTest::WaitForCompositingEnded(GetRootLayer()->GetCompositor());
...
TEST_F(ViewLayerTest, ScheduledRectsInParentAfterSchedulingPaint)
{
    ...
    ASSERT_EQ(1U, parent_view.scheduled_paint_rects_.size());
    EXPECT_EQ(gfx::Rect(5, 6, 10, 20), parent_view.scheduled_paint_rects_.front());
}
...
TEST_F(ViewLayerTest, RecreateLayerZOrder)
{
    ...
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>>& child_layers_pre = v->layer()->children();
    ...
    // for |v1| and |v2|.
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>>& child_layers_post = v->layer()->children();
...
TEST_F(ViewLayerTest, RecreateLayerZOrderWidgetParent)
{
    ...
    // Test the initial z-order.
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>>& child_layers_pre = root_layer->children();
    ASSERT_EQ(2u, child_layers_pre.size());
    EXPECT_EQ(v1->layer(), child_layers_pre[0]);
    EXPECT_EQ(v2->layer(), child_layers_pre[1]);
    ...
    // Test the new layer order. We expect: |v1| |v1_old_layer| |v2|.
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>>& child_layers_post = root_layer->children();
    ASSERT_EQ(3u, child_layers_post.size());
    EXPECT_EQ(v1->layer(), child_layers_post[0]);
    EXPECT_EQ(v1_old_layer.get(), child_layers_post[1]);
    EXPECT_EQ(v2->layer(), child_layers_post[2]);
...
std::string ToString(const gfx::Vector2dF& vector)
{
    ...
    return base::StringPrintf("%0.2f %0.2f", std::round(vector.x() * 100) / 100.f, std::round(vector.y() * 100) / 100.f);
}
...
TEST_F(ViewLayerTest, SnapLayerToPixel)
{
    ...
    GetRootLayer()->GetCompositor()->SetScaleAndSize(1.25f, size, allocator.GetCurrentLocalSurfaceId());
    ...
    GetRootLayer()->GetCompositor()->SetScaleAndSize(1.5f, size, allocator.GetCurrentLocalSurfaceId());
    ...
    GetRootLayer()->GetCompositor()->SetScaleAndSize(2.0f, size, allocator.GetCurrentLocalSurfaceId());
    EXPECT_EQ("0.00 0.00", ToString(v11->layer()->GetSubpixelOffset()));

    // DSF reset followed by DSF change should update the offset.
    GetRootLayer()->GetCompositor()->SetScaleAndSize(1.0f, size, allocator.GetCurrentLocalSurfaceId());
    EXPECT_EQ("0.00 0.00", ToString(v11->layer()->GetSubpixelOffset()));
    GetRootLayer()->GetCompositor()->SetScaleAndSize(1.5f, size, allocator.GetCurrentLocalSurfaceId());
    EXPECT_EQ("0.33 0.33", ToString(v11->layer()->GetSubpixelOffset()));
}
...
TEST_F(ViewLayerTest, LayerBeneathAtFractionalScale)
{
    ...
    allocator.GenerateId();
    const gfx::Size& size = GetRootLayer()->GetCompositor()->size();
    GetRootLayer()->GetCompositor()->SetScaleAndSize(device_scale, size, allocator.GetCurrentLocalSurfaceId());
...
public:
    ...
    {
        scoped_feature_list_.InitAndEnableFeature(::features::kEnablePixelCanvasRecording);
    }

    // Test if the recording rects are same with and without layer.
    void PaintRecordingSizeTest(PaintLayerView* v3, const gfx::Size& expected_size)
    {
        v3->DestroyLayer();
        ui::Compositor* compositor = widget()->GetCompositor();
        auto list = base::MakeRefCounted<cc::DisplayItemList>();
        ui::PaintContext context(list.get(), compositor->device_scale_factor(), gfx::Rect(compositor->size()), true);
...
TEST_F(ViewLayerPixelCanvasTest, SnapLayerToPixel)
{
    ...
    const gfx::Size& size = GetRootLayer()->GetCompositor()->size();
    GetRootLayer()->GetCompositor()->SetScaleAndSize(1.6f, size, allocator.GetCurrentLocalSurfaceId());
    ...
    GetRootLayer()->GetCompositor()->SetScaleAndSize(1.33f, size, allocator.GetCurrentLocalSurfaceId());
...
TEST_F(ViewTest, OnThemeChanged)
{
    ...
    TestView* test_view_child = test_view->AddChildView(std::make_unique<TestView>());
    ...
    TestView* test_view_ptr = widget->GetRootView()->AddChildView(std::move(test_view));
    ...
    // notification.
    TestView* test_view_child_2 = test_view_ptr->AddChildView(std::make_unique<TestView>());
...
TEST_F(ViewTest, ScopedTargetHandlerReceivesEvents)
{
    ...
    v->Reset();
    {
        ...
        EXPECT_EQ(&scoped_target_handler, v->SetTargetHandler(&scoped_target_handler));

        EXPECT_EQ(v->last_mouse_event_type_, ui::EventType::kUnknown);
        gfx::Point p(10, 120);
        ui::MouseEvent pressed(ui::EventType::kMousePressed, p, p, ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON);
        root->OnMousePressed(pressed);
...
public:
    explicit WidgetWithCustomTheme(ui::TestNativeTheme* theme)
        : theme_(theme)
    {
    }
...
public:
    ViewThatAddsViewInOnThemeChanged()
    {
        SetPaintToLayer();
    }

    ViewThatAddsViewInOnThemeChanged(const ViewThatAddsViewInOnThemeChanged&) = delete;
    ViewThatAddsViewInOnThemeChanged& operator=(const ViewThatAddsViewInOnThemeChanged&) = delete;
...
TEST_F(ViewTest, CrashOnAddFromFromOnThemeChanged)
{
    ...
    ViewThatAddsViewInOnThemeChanged* v = widget->GetRootView()->AddChildView(std::make_unique<ViewThatAddsViewInOnThemeChanged>());
...
TEST_F(ViewTest, DestroyLayerInClose)
{
    ...
    auto* view = widget->GetContentsView()->AddChildView(
        std::make_unique<NoLayerWhenHiddenView>(base::BindOnce([](bool* removed_from_widget) { *removed_from_widget = true; }, &removed_from_widget)));
    widget->Show();
...
public:
    ...
    View::Views GetChildrenInZOrder() override
    {
        ...
        std::stable_partition(children_in_z_order.begin(), children_in_z_order.end(), [](const View* child) { return child->GetID() != VIEW_ID_RAISED; });
...
TEST_F(ViewTest, ChildViewZOrderChanged)
{
    ...
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>>& layers = view->layer()->children();
...
TEST_F(ViewTest, AttachChildViewWithComplicatedLayers)
{
    ...
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>>& layers = parent_view->layer()->children();
    ...
    // should not change.
    OrderableView* parent_view_ptr = grand_parent_view->AddChildView(std::move(parent_view));
    const std::vector<raw_ptr<ui::Layer, VectorExperimental>>& layers_after_attached = parent_view_ptr->layer()->children();
...
TEST_F(ViewTest, TestEnabledPropertyMetadata)
{
    ...
    ui::metadata::MemberMetaDataBase* enabled_property = view_metadata->FindMemberData("Enabled");
...
TEST_F(ViewTest, TestMarginsPropertyMetadata)
{
    ...
    ui::metadata::ClassMetaData* view_metadata = View::MetaData();
    ASSERT_TRUE(view_metadata);
    ui::metadata::MemberMetaDataBase* insets_property = view_metadata->FindMemberData("kMarginsKey");
...
TEST_F(ViewTest, TestVisibleChangedCallback)
{
    ...
    auto subscription
        = test_view->AddVisibleChangedCallback(base::BindRepeating([](bool* visibility_changed) { *visibility_changed = true; }, &visibility_changed));
...
TEST_F(ViewTest, TooltipShowsForDisabledView)
{
    ...
    View enabled_parent;
    View* const disabled_child = enabled_parent.AddChildView(std::make_unique<View>());
    ...
    EXPECT_EQ(disabled_child, enabled_parent.GetTooltipHandlerForPoint(gfx::Point(50, 50)));
}
...
public:
    ...
    void OnViewBoundsChanged(View* view) override
    {
    ...
    void SetVerifyOnViewHierarchyWillBeDeletedCallback(base::OnceClosure verify_on_view_hierarchy_will_be_deleted_callback)
    {
        verify_on_view_hierarchy_will_be_deleted_callback_ = std::move(verify_on_view_hierarchy_will_be_deleted_callback);
    }

    int child_view_added_times()
    {
        return child_view_added_times_;
    }
    int child_view_removed_times()
    {
        return child_view_removed_times_;
    }
    const View* child_view_added() const
    {
        return child_view_added_;
    }
    ...
    const View* child_view_removed() const
    {
        return child_view_removed_;
    }
    ...
    const View* view_bounds_changed() const
    {
        return view_bounds_changed_;
    }
    const View* view_reordered() const
    {
        return view_reordered_;
    }
...
TEST_F(ViewObserverTest, ViewHierarchyWillBeDeleted)
{
    TestViewObserver observer({});
    {
        ...
        TestView* child_view = main_view->AddChildView(std::make_unique<TestView>());
        observer.AddObservation(main_view);
        child_view->SetDestructionCallback(
            base::BindOnce([](TestViewObserver& observer) { EXPECT_TRUE(observer.has_on_view_hierarchy_will_be_deleted_called()); }, std::ref(observer)));
...
public:
    // ViewObserver:
    MOCK_METHOD(void, OnViewPropertyChanged, (View * observed_view, const void* key, int64_t old_value), (override));
};

ACTION_TEMPLATE(ExpectThatViewProperty, HAS_1_TEMPLATE_PARAMS(typename, T), AND_1_VALUE_PARAMS(Matcher))
{
...
TEST_F(ViewObserverTest, ViewPropertyChanged)
{
    ...
    // should be a `nullptr`.
    EXPECT_CALL(view_observer, OnViewPropertyChanged(Eq(view.get()), Eq(kMarginsKey), /*old_value*/ _))
    ...
    EXPECT_CALL(view_observer, OnViewPropertyChanged(Eq(view.get()), Eq(kMarginsKey), /*old_value=*/_))
        .WillOnce(WithArg<2>(ExpectThatViewProperty<gfx::Insets>(Pointee(Eq(kPreviousValue)))));
...
public:
    ...
    int layer_change_count() const
    {
        return layer_change_count_;
    }
...
public:
    explicit LayerResizingView(ui::Layer* layer)
        : layer_(layer)
    {
    }
...
TEST(ViewTestUnfixtured, ViewLayerSizeStayInSync)
{
    ...
    std::unique_ptr<View> view_owned = std::make_unique<LayerResizingView>(region_layer.get());
...
TEST_F(BaseActionViewInterfaceTest, TestActionChanged)
{
    ...
    std::unique_ptr<actions::ActionItem> action_item = actions::ActionItem::Builder().SetActionId(0).SetEnabled(false).Build();
    action_view->GetActionViewInterface()->ActionItemChangedImpl(action_item.get());
