...
public:
    ...
    template <typename T> T* PrepareTextfields(int count, std::unique_ptr<T> textfield_owned, gfx::Rect bounds)
    {
...
protected:
    void PrepareTextfieldsInternal(int count, Textfield* textfield, View* view, gfx::Rect bounds);

    void SendKeyPress(ui::KeyboardCode key_code, int flags);
    void SendKeyEvent(ui::KeyboardCode key_code, bool alt, bool shift, bool control_or_command, bool caps_lock);
    void SendKeyEvent(ui::KeyboardCode key_code, bool shift, bool control_or_command);
    ...
    void VerifyTextfieldContextMenuContents(bool textfield_has_selection, bool can_undo, ui::MenuModel* menu);
