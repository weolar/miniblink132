...
public:
...
#if BUILDFLAG(IS_MAC)
    static constexpr gfx::SelectionBehavior kLineSelectionBehavior = gfx::SELECTION_EXTEND;
    static constexpr gfx::SelectionBehavior kWordSelectionBehavior = gfx::SELECTION_CARET;
    static constexpr gfx::SelectionBehavior kMoveParagraphSelectionBehavior = gfx::SELECTION_CARET;
    static constexpr gfx::SelectionBehavior kPageSelectionBehavior = gfx::SELECTION_EXTEND;
#else
    static constexpr gfx::SelectionBehavior kLineSelectionBehavior = gfx::SELECTION_RETAIN;
    static constexpr gfx::SelectionBehavior kWordSelectionBehavior = gfx::SELECTION_RETAIN;
    static constexpr gfx::SelectionBehavior kMoveParagraphSelectionBehavior = gfx::SELECTION_RETAIN;
    static constexpr gfx::SelectionBehavior kPageSelectionBehavior = gfx::SELECTION_RETAIN;
#endif
    ...
    void SetTextWithoutCaretBoundsChangeNotification(const std::u16string& text, size_t cursor_position);
    ...
    bool force_text_directionality() const
    {
        return force_text_directionality_;
    }
    ...
    bool drop_cursor_visible() const
    {
        return drop_cursor_visible_;
    }
    ...
    views::View::DropCallback GetDropCallback(const ui::DropTargetEvent& event) override;
    ...
    bool GetWordLookupDataAtPoint(const gfx::Point& point, gfx::DecoratedText* decorated_word, gfx::Rect* rect) override;
    bool GetWordLookupDataFromSelection(gfx::DecoratedText* decorated_text, gfx::Rect* rect) override;
...
#if BUILDFLAG(IS_WIN)
    std::optional<gfx::Rect> GetProximateCharacterBounds(const gfx::Range& range) const override;
    std::optional<size_t> GetProximateCharacterIndexFromPoint(const gfx::Point& point, ui::IndexFromPointFlags flags) const override;
#endif // BUILDFLAG(IS_WIN)
    bool GetCompositionCharacterBounds(size_t index, gfx::Rect* rect) const override;
    ...
    bool ChangeTextDirectionAndLayoutAlignment(base::i18n::TextDirection direction) override;
    ...
    void SetShouldDoLearning(bool value)
    {
    ...
    bool AddGrammarFragments(const std::vector<ui::GrammarFragment>& fragments) override;
#endif
...
#if BUILDFLAG(IS_WIN)
    void SetActiveCompositionForAccessibility(const gfx::Range& range, const std::u16string& active_composition_text, bool is_composition_committed) override;
#endif

    // ViewObserver overrides:
    void OnViewFocused(views::View* observed_view) override;

    [[nodiscard]] base::CallbackListSubscription AddTextChangedCallback(views::PropertyChangedCallback callback);

protected:
    TextfieldModel* textfield_model()
    {
        return model_.get();
    }
    ...
    virtual Textfield::EditCommandResult DoExecuteTextEditCommand(ui::TextEditCommand command);
...
private:
    ...
    void UpdateAfterChange(TextChangeType text_change_type, bool cursor_changed, std::optional<bool> notify_caret_bounds_changed = std::nullopt);
    ...
    void RevealPasswordChar(std::optional<size_t> index, base::TimeDelta duration);
    ...
    ui::TextEditCommand scheduled_text_edit_command_ = ui::TextEditCommand::INVALID_COMMAND;
    ...
    SelectionDraggingState selection_dragging_state_ = SelectionDraggingState::kNone;
    ...
    ui::TextInputClient::FocusReason focus_reason_ = ui::TextInputClient::FOCUS_REASON_NONE;
    ...
    base::CallbackListSubscription enabled_changed_subscription_
        = AddEnabledChangedCallback(base::BindRepeating(&Textfield::OnEnabledChanged, base::Unretained(this)));
