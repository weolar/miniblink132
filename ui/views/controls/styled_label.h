...
public:
    ...
    gfx::FontList GetFontList(const RangeStyleInfo& style_info = RangeStyleInfo()) const;
...
private:
    ...
    std::unique_ptr<Label> CreateLabel(
        const std::u16string& text, const RangeStyleInfo& style_info, const gfx::Range& range, LinkFragment** previous_link_component) const;
    ...
    gfx::HorizontalAlignment horizontal_alignment_ = base::i18n::IsRTL() ? gfx::ALIGN_RIGHT : gfx::ALIGN_LEFT;
};
