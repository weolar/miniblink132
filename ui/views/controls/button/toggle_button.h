...
private:
    ...
    absl::variant<ui::ColorId, SkColor> track_on_color_ = ui::kColorToggleButtonTrackOn;
    absl::variant<ui::ColorId, SkColor> track_off_color_ = ui::kColorToggleButtonTrackOff;
