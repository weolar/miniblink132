...
class VIEWS_EXPORT LabelButton : public Button, public NativeThemeDelegate, public LayoutDelegate {
...
public:
    ...
    explicit LabelButton(PressedCallback callback = PressedCallback(), const std::u16string& text = std::u16string(),
        int button_context = style::CONTEXT_BUTTON, std::unique_ptr<LabelButtonImageContainer> image_container = std::make_unique<SingleImageContainer>());
    ...
    // the button.
    virtual void SetImageModel(ButtonState state, const std::optional<ui::ImageModel>& image_model);
    ...
    void AddLayerToRegion(ui::Layer* new_layer, views::LayerRegion region) override;
    ...
    ui::NativeTheme::State GetThemeState(ui::NativeTheme::ExtraParams* params) const override;
    const gfx::Animation* GetThemeAnimation() const override;
    ui::NativeTheme::State GetBackgroundThemeState(ui::NativeTheme::ExtraParams* params) const override;
    ui::NativeTheme::State GetForegroundThemeState(ui::NativeTheme::ExtraParams* params) const override;
...
private:
    ...
    std::array<std::optional<ui::ImageModel>, STATE_COUNT> button_state_image_models_;
    std::array<absl::variant<SkColor, ui::ColorId>, STATE_COUNT> button_state_colors_;
    ...
    int image_label_spacing_ = LayoutProvider::Get()->GetDistanceMetric(DISTANCE_RELATED_LABEL_HORIZONTAL);
    ...
    base::CallbackListSubscription flip_canvas_on_paint_subscription_
        = AddFlipCanvasOnPaintForRTLUIChangedCallback(base::BindRepeating(&LabelButton::FlipCanvasOnPaintForRTLUIChanged, base::Unretained(this)));
};

class VIEWS_EXPORT LabelButtonActionViewInterface : public ButtonActionViewInterface {
public:
