...
public:
    ...
    LabelButtonImageContainer& operator=(const LabelButtonImageContainer&) = delete;
...
class VIEWS_EXPORT SingleImageContainer final : public LabelButtonImageContainer {
public:
