...
public:
    ...
    class VIEWS_EXPORT DefaultButtonControllerDelegate : public ButtonControllerDelegate {
    public:
        explicit DefaultButtonControllerDelegate(Button* button);

        DefaultButtonControllerDelegate(const DefaultButtonControllerDelegate&) = delete;
        DefaultButtonControllerDelegate& operator=(const DefaultButtonControllerDelegate&) = delete;
    ...
    private:
        absl::variant<base::OnceClosure, base::RepeatingClosure, Callback> callback_;
    };
    ...
    static constexpr ButtonState kButtonStates[STATE_COUNT]
        = { ButtonState::STATE_NORMAL, ButtonState::STATE_HOVERED, ButtonState::STATE_PRESSED, ButtonState::STATE_DISABLED };
    ...
    base::CallbackListSubscription AddStateChangedCallback(PropertyChangedCallback callback);
    base::CallbackListSubscription AddAnchorCountChangedCallback(base::RepeatingCallback<void(size_t)> callback);
    ...
    View* ink_drop_view() const
    {
        return ink_drop_view_;
    }
...
protected:
    ...
    const PressedCallback& GetCallback() const
    {
        return callback_;
    }
...
private:
    ...
    base::CallbackListSubscription enabled_changed_subscription_ { AddEnabledChangedCallback(
        base::BindRepeating(&Button::OnEnabledChanged, base::Unretained(this))) };

    size_t anchor_count_ = 0;

    ax::mojom::DefaultActionVerb default_action_verb_ = ax::mojom::DefaultActionVerb::kPress;
...
public:
    ...
    void LinkActionInvocationToView(base::RepeatingClosure invoke_action_callback) override;
