...
TEST_F(ImageButtonTest, Basics)
{
    ...
    button.SetImageModel(Button::STATE_PRESSED, ui::ImageModel::FromImageSkia(pushed_image));
...
TEST_F(ImageButtonTest, SetAndGetImage)
{
    ...
    button.SetImageModel(Button::STATE_NORMAL, ui::ImageModel::FromImageSkia(image1));
    button.SetImageModel(Button::STATE_HOVERED, ui::ImageModel::FromImageSkia(image2));
    EXPECT_TRUE(button.GetImage(Button::STATE_NORMAL).BackedBySameObjectAs(image1));
    EXPECT_TRUE(button.GetImage(Button::STATE_HOVERED).BackedBySameObjectAs(image2));
    EXPECT_TRUE(button.GetImage(Button::STATE_PRESSED).isNull());
    EXPECT_TRUE(button.GetImage(Button::STATE_DISABLED).isNull());
...
TEST_F(ImageButtonTest, PreferredSizeInvalidation)
{
    ...
    button.SetImageModel(Button::STATE_NORMAL, ui::ImageModel::FromImageSkia(first_image));
    ...
    button.SetImageModel(Button::STATE_HOVERED, ui::ImageModel::FromImageSkia(second_image));
    EXPECT_EQ(0, parent.pref_size_changed_calls());

    // Changing normal state image size leads to a change in preferred size.
    button.SetImageModel(Button::STATE_NORMAL, ui::ImageModel::FromImageSkia(second_image));
