...
VIEWS_EXPORT std::unique_ptr<ImageButton> CreateVectorImageButtonWithNativeTheme(Button::PressedCallback callback, const gfx::VectorIcon& icon,
    std::optional<int> dip_size = std::nullopt, ui::ColorId icon_color_id = ui::kColorIcon, ui::ColorId icon_disabled_color_id = ui::kColorIconDisabled);
...
VIEWS_EXPORT std::unique_ptr<ImageButton> CreateVectorImageButton(Button::PressedCallback callback);
...
VIEWS_EXPORT std::unique_ptr<ToggleImageButton> CreateVectorToggleImageButton(Button::PressedCallback callback);
...
VIEWS_EXPORT void SetImageFromVectorIconWithColor(ImageButton* button, const gfx::VectorIcon& icon, SkColor icon_color, SkColor icon_disabled_color);

// As above, but creates the images at the given size.
VIEWS_EXPORT void SetImageFromVectorIconWithColor(
    ImageButton* button, const gfx::VectorIcon& icon, int dip_size, SkColor icon_color, SkColor icon_disabled_color);
...
VIEWS_EXPORT void SetToggledImageFromVectorIconWithColor(
    ToggleImageButton* button, const gfx::VectorIcon& icon, int dip_size, SkColor icon_color, SkColor disabled_color);

// Sets images on |button| for STATE_NORMAL and STATE_DISABLED with the default
// size from the given vector icon and colors,
VIEWS_EXPORT void SetImageFromVectorIconWithColorId(ImageButton* button, const gfx::VectorIcon& icon, ui::ColorId icon_color_id,
    ui::ColorId icon_disabled_color_id, std::optional<int> icon_size = std::nullopt);
...
VIEWS_EXPORT void SetToggledImageFromVectorIconWithColorId(ToggleImageButton* button, const gfx::VectorIcon& icon, ui::ColorId icon_color_id,
    ui::ColorId icon_disabled_color_id, std::optional<int> icon_size = std::nullopt);
