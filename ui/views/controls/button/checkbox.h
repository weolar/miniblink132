...
public:
    explicit Checkbox(const std::u16string& label = std::u16string(), PressedCallback callback = PressedCallback(), int button_context = style::CONTEXT_BUTTON);
    ...
    [[nodiscard]] base::CallbackListSubscription AddCheckedChangedCallback(PropertyChangedCallback callback);
...
class VIEWS_EXPORT CheckboxActionViewInterface : public LabelButtonActionViewInterface {
public:
