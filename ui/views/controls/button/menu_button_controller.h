...
public:
    ...
    public:
        ...
        PressedLock(MenuButtonController* menu_button_controller, bool is_sibling_menu_show, const ui::LocatedEvent* event);
    ...
    MenuButtonController(Button* button, Button::PressedCallback callback, std::unique_ptr<ButtonControllerDelegate> delegate);
    ...
    std::unique_ptr<PressedLock> TakeLock(bool is_sibling_menu_show, const ui::LocatedEvent* event);
...
private:
    ...
    void IncrementPressedLocked(bool snap_ink_drop_to_activated, const ui::LocatedEvent* event);
