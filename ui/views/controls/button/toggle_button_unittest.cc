...
TEST_F(ToggleButtonTest, AccessibleCheckedStateChange)
{
    ...
    ui::AXNodeData data;
    EXPECT_EQ(ax_counter.GetCount(ax::mojom::Event::kCheckedStateChanged, button()), 0);
    button()->SetIsOn(true);
    button()->GetViewAccessibility().GetAccessibleNodeData(&data);
    EXPECT_EQ(ax_counter.GetCount(ax::mojom::Event::kCheckedStateChanged, button()), 1);
    ...
    EXPECT_EQ(ax_counter.GetCount(ax::mojom::Event::kCheckedStateChanged, button()), 2);
}
