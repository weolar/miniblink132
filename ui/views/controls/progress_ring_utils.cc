...
void DrawRing(gfx::Canvas* canvas, const SkRect& bounds, SkColor background_color, SkColor foreground_color, float stroke_width, SkScalar start_angle,
    const std::vector<ArcSpec>& arcs)
{
    ...
    for (const ArcSpec& arc : arcs) {
        SkPath& path = arc.color == ArcSpec::Color::kBackground ? background_path : foreground_path;
...
void DrawProgressRing(
    gfx::Canvas* canvas, const SkRect& bounds, SkColor background_color, SkColor progress_color, float stroke_width, SkScalar start_angle, SkScalar sweep_angle)
{
    ...
    DrawRing(canvas, bounds, background_color, progress_color, stroke_width, start_angle, arcs);
}

void DrawSpinningRing(gfx::Canvas* canvas, const SkRect& bounds, SkColor background_color, SkColor progress_color, float stroke_width, SkScalar start_angle)
{
    std::vector<ArcSpec> arcs;
