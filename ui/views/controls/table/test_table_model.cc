...
{
    return base::ASCIIToUTF16(base::NumberToString(row) + "x" + base::NumberToString(column_id));
}
...
ui::ImageModel TestTableModel::GetIcon(size_t row)
{
    ...
    return ui::ImageModel::FromImageSkia(gfx::ImageSkia::CreateFrom1xBitmap(bitmap));
}
