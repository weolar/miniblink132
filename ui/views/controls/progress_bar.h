...
public:
    ...
    void SetPreferredCornerRadii(std::optional<gfx::RoundedCornersF> preferred_corner_radii);
...
private:
    ...
    std::optional<gfx::RoundedCornersF> preferred_corner_radii_ = gfx::RoundedCornersF(3);
