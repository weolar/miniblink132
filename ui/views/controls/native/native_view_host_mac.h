...
class NativeViewHostMac : public NativeViewHostWrapper, public ui::ViewsHostableView::Host {
public:
    ...
    void ShowWidget(int x, int y, int w, int h, int native_w, int native_h) override;
