...
public:
    ...
    int host_destroyed_count()
    {
        return host_destroyed_count_;
    }
    void ResetHostDestroyedCount()
    {
    ...
    std::unique_ptr<Widget> CreateChildForHost(gfx::NativeView native_parent_view, View* parent_view, View* contents_view, NativeViewHost* host);
...
protected:
    int on_mouse_pressed_called_count()
    {
        return on_mouse_pressed_called_count_;
    }
