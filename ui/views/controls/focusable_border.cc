...
void FocusableBorder::Paint(const View& view, gfx::Canvas* canvas)
{
    ...
    path.addRoundRect(gfx::RectFToSkRect(rect), corner_radius_px, corner_radius_px);
...
SkColor FocusableBorder::GetCurrentColor(const View& view) const
{
    ...
    return view.GetEnabled() ? color : color_utils::BlendTowardMaxContrast(color, gfx::kDisabledControlAlpha);
}
