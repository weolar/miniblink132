...
ComboboxMenuModel::ComboboxMenuModel(views::Combobox* owner, ui::ComboboxModel* model)
    : owner_(owner)
    , model_(model)
{
}
...
ui::MenuSeparatorType ComboboxMenuModel::GetSeparatorTypeAt(size_t index) const
{
...
bool ComboboxMenuModel::GetAcceleratorAt(size_t index, ui::Accelerator* accelerator) const
{
    return false;
}
...
ui::ButtonMenuItemModel* ComboboxMenuModel::GetButtonMenuItemAt(size_t index) const
{
    return nullptr;
}
...
std::optional<ui::ColorId> ComboboxMenuModel::GetForegroundColorId(size_t index)
{
    return model_->GetDropdownForegroundColorIdAt(index);
}

std::optional<ui::ColorId> ComboboxMenuModel::GetSubmenuBackgroundColorId(size_t index)
{
    return model_->GetDropdownBackgroundColorIdAt(index);
}

std::optional<ui::ColorId> ComboboxMenuModel::GetSelectedBackgroundColorId(size_t index)
{
