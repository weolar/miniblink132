...
class VIEWS_EXPORT Combobox : public View, public PrefixDelegate, public ui::ComboboxModelObserver {
...
public:
    ...
    [[nodiscard]] base::CallbackListSubscription AddSelectedIndexChangedCallback(views::PropertyChangedCallback callback);
    ...
    ui::ComboboxModel* GetModel() const
    {
        return model_;
    }
    ...
    bool GetSizeToLargestLabel() const
    {
        return size_to_largest_label_;
    }
    ...
    base::CallbackListSubscription AddMenuWillShowCallback(MenuWillShowCallback callback);
