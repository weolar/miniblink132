...
class WebContentsSetBackgroundColor : public content::WebContentsObserver, public content::WebContentsUserData<WebContentsSetBackgroundColor> {
public:
    WEBVIEW_EXPORT static void CreateForWebContentsWithColor(content::WebContents* web_contents, SkColor color);

    WebContentsSetBackgroundColor(const WebContentsSetBackgroundColor&) = delete;
    WebContentsSetBackgroundColor& operator=(const WebContentsSetBackgroundColor&) = delete;
...
private:
    ...
    WebContentsSetBackgroundColor(content::WebContents* web_contents, SkColor color);
