...
VIEWS_EXPORT SkPath GetHighlightPath(const View* view, float halo_thickness = FocusRing::kDefaultHaloThickness);
...
VIEWS_EXPORT extern const ui::ClassProperty<bool>* const kDrawFocusRingBackgroundOutline;
