...
//
/////////////////////////////////////////////////////////////////////////////
class VIEWS_EXPORT AnimatedImageView : public ImageViewBase, public ui::CompositorAnimationObserver {
...
public:
    ...
    // one is used.
    void Play(std::optional<lottie::Animation::PlaybackConfig> playback_config = std::nullopt);

    // Stops any animation and resets it to the start frame.
    void Stop();

    // May return null if SetAnimatedImage() has not been called.
    lottie::Animation* animated_image()
    {
