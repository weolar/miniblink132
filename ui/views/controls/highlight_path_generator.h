...
public:
    ...
    static void Install(View* host, std::unique_ptr<HighlightPathGenerator> generator);
...
public:
    ...
    EmptyHighlightPathGenerator& operator=(const EmptyHighlightPathGenerator&) = delete;
...
public:
    ...
    RectHighlightPathGenerator& operator=(const RectHighlightPathGenerator&) = delete;
...
class VIEWS_EXPORT CircleHighlightPathGenerator : public HighlightPathGenerator {
public:
    ...
    CircleHighlightPathGenerator& operator=(const CircleHighlightPathGenerator&) = delete;
...
void VIEWS_EXPORT InstallCircleHighlightPathGenerator(View* view, const gfx::Insets& insets);
...
public:
    ...
    PillHighlightPathGenerator& operator=(const PillHighlightPathGenerator&) = delete;
...
class VIEWS_EXPORT FixedSizeCircleHighlightPathGenerator : public HighlightPathGenerator {
public:
    explicit FixedSizeCircleHighlightPathGenerator(int radius);

    FixedSizeCircleHighlightPathGenerator(const FixedSizeCircleHighlightPathGenerator&) = delete;
    FixedSizeCircleHighlightPathGenerator& operator=(const FixedSizeCircleHighlightPathGenerator&) = delete;
...
void VIEWS_EXPORT InstallFixedSizeCircleHighlightPathGenerator(View* view, int radius);

// Sets a rounded rectangle highlight path with optional insets.
class VIEWS_EXPORT RoundRectHighlightPathGenerator : public HighlightPathGenerator {
public:
    RoundRectHighlightPathGenerator(const gfx::Insets& insets, int corner_radius);
    RoundRectHighlightPathGenerator(const gfx::Insets& insets, const gfx::RoundedCornersF& rounded_corners);

    RoundRectHighlightPathGenerator(const RoundRectHighlightPathGenerator&) = delete;
    RoundRectHighlightPathGenerator& operator=(const RoundRectHighlightPathGenerator&) = delete;
...
void VIEWS_EXPORT InstallRoundRectHighlightPathGenerator(View* view, const gfx::Insets& insets, int corner_radius);
