...
public:
    ScrollBarButtonTest()
        : button_(std::make_unique<ScrollBarButton>(base::BindRepeating(&MockButtonCallback::ButtonPressed, base::Unretained(&callback_)),
            ScrollBarButton::Type::kLeft, task_environment_.GetMockTickClock()))
    {
...
protected:
    testing::StrictMock<MockButtonCallback>& callback()
    {
        return callback_;
    }
    Button* button()
...
TEST_F(ScrollBarButtonTest, CallbackFiresOnMouseDown)
{
    ...
    button()->OnMousePressed(
        ui::MouseEvent(ui::EventType::kMousePressed, gfx::Point(), gfx::Point(), ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON));
}
...
TEST_F(ScrollBarButtonTest, CallbackStopsFiringAfterMouseReleased)
{
    ...
    button()->OnMouseReleased(
        ui::MouseEvent(ui::EventType::kMouseReleased, gfx::Point(), gfx::Point(), ui::EventTimeForNow(), ui::EF_LEFT_MOUSE_BUTTON, ui::EF_LEFT_MOUSE_BUTTON));
