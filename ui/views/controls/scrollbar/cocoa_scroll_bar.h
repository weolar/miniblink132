...
class VIEWS_EXPORT CocoaScrollBar : public ScrollBar, public ViewsScrollbarBridgeDelegate, public ui::ImplicitAnimationObserver, public gfx::AnimationDelegate {
...
public:
    ...
    // ScrollBar:
    void Update(int viewport_size, int content_size, int contents_scroll_offset) override;
    ...
    NSScrollerStyle GetScrollerStyle() const
    {
        return scroller_style_;
    }
