...
public:
    ...
    virtual int GetScrollIncrement(ScrollBar* source, bool is_page, bool is_positive) = 0;
};
...
//
/////////////////////////////////////////////////////////////////////////////
class VIEWS_EXPORT ScrollBar : public View, public ScrollDelegate, public ContextMenuController, public ui::SimpleMenuModel::Delegate {
...
public:
    ...
    ScrollBarController* controller() const
    {
        return controller_;
    }
    ...
    // current position.
    virtual void Update(int viewport_size, int content_size, int contents_scroll_offset);
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(ScrollBarViewsTest, DragThumbScrollsContentWhenSnapBackDisabled);
    ...
    static base::RetainingOneShotTimer* GetHideTimerForTesting(ScrollBar* scroll_bar);
    ...
    int CalculateContentsOffset(float thumb_position, bool scroll_to_middle) const;
    ...
    ScrollAmount DetermineScrollAmountByKeyCode(const ui::KeyboardCode& keycode) const;
