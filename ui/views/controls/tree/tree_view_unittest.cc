...
{
    std::string result = view.GetData().GetStringAttribute(ax::mojom::StringAttribute::kName);
    if (!view.GetChildCount() || view.GetData().HasState(ax::mojom::State::kCollapsed)) {
...
public:
    TreeViewTest()
        : model_(std::make_unique<TestNode>())
    {
...
protected:
    using AccessibilityEventsVector = std::vector<std::pair<const ui::AXPlatformNodeDelegate*, const ax::mojom::Event>>;
    ...
    const AXVirtualView* GetAccessibilityViewByName(const std::string& name) const;
...
void TreeViewTest::SetUp()
{
    ...
    ViewAccessibility::AccessibilityEventsCallback accessibility_events_callback = base::BindRepeating(
        [](std::vector<std::pair<const ui::AXPlatformNodeDelegate*, const ax::mojom::Event>>* accessibility_events, const ui::AXPlatformNodeDelegate* delegate,
    ...
    tree()->GetViewAccessibility().set_accessibility_events_callback(std::move(accessibility_events_callback));
}
...
TestNode* TreeViewTest::Add(TestNode* parent, size_t index, const std::string& title)
{
...
std::string TreeViewTest::GetSelectedNodeTitle()
{
    ...
    return model_node ? base::UTF16ToASCII(model_node->GetTitle()) : std::string();
}
...
std::string TreeViewTest::GetSelectedAccessibilityViewName() const
{
    ...
    while (ax_view) {
        if (ax_view->GetData().GetBoolAttribute(ax::mojom::BoolAttribute::kSelected)) {
            return ax_view->GetData().GetStringAttribute(ax::mojom::StringAttribute::kName);
        }
        ...
        while (parent_view) {
            size_t sibling_index_in_parent = parent_view->GetIndexOf(ax_view).value() + 1;
...
{
    const AXVirtualView* ax_view = tree()->GetViewAccessibility().FocusedVirtualChild();
    return ax_view ? ax_view->GetData().GetStringAttribute(ax::mojom::StringAttribute::kName) : std::string();
}
...
#else
    return static_cast<ViewAXPlatformNodeDelegate*>(&(tree()->GetViewAccessibility()));
#endif
}
...
const AXVirtualView* TreeViewTest::GetAccessibilityViewByName(const std::string& name) const
{
    const AXVirtualView* ax_view = GetRootAccessibilityView();

    while (ax_view) {
        if (ax_view->GetData().HasStringAttribute(ax::mojom::StringAttribute::kName)) {
            const std::string& ax_view_name = ax_view->GetData().GetStringAttribute(ax::mojom::StringAttribute::kName);
...
{
    tree()->IncrementSelection(next ? TreeView::IncrementType::kNext : TreeView::IncrementType::kPrevious);
}
...
TestNode* TreeViewTest::GetNodeByTitleImpl(TestNode* node, const std::u16string& title)
{
...
std::string TreeViewTest::InternalNodeAsString(TreeView::InternalNode* node)
{
    ...
    if (node->is_expanded() && !node->children().empty()) {
        result += std::accumulate(node->children().cbegin() + 1, node->children().cend(), " [" + InternalNodeAsString(node->children().front().get()),
                      [this](const std::string& str, const auto& child) { return str + " " + InternalNodeAsString(child.get()); })
            + "]";
    }
    return result;
}
...
TEST_F(TreeViewTest, TreeViewPaintCoverage)
{
    ...
    ui::CanvasPainter canvas_painter(&bitmap, size, 1.f, SK_ColorTRANSPARENT, false);
    widget_->GetRootView()->Paint(PaintInfo::CreateRootPaintInfo(canvas_painter.context(), size));
}
...
TEST_F(TreeViewTest, SetModel)
{
    ...
    EXPECT_EQ(
        (AccessibilityEventsVector { std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
            std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
            std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
            std::make_pair(GetRootAccessibilityView(), ax::mojom::Event::kFocus), std::make_pair(GetRootAccessibilityView(), ax::mojom::Event::kSelection) }),
...
TEST_F(TreeViewTest, SetSelectedNode)
{
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetAccessibilityViewByName("c"), ax::mojom::Event::kFocus),
                  std::make_pair(GetAccessibilityViewByName("c"), ax::mojom::Event::kSelection) }),
        accessibility_events());
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
                  std::make_pair(GetAccessibilityViewByName("b"), ax::mojom::Event::kExpandedChanged),
                  std::make_pair(GetAccessibilityViewByName("b"), ax::mojom::Event::kRowExpanded),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kRowCountChanged),
                  std::make_pair(GetAccessibilityViewByName("b1"), ax::mojom::Event::kFocus),
                  std::make_pair(GetAccessibilityViewByName("b1"), ax::mojom::Event::kSelection) }),
        accessibility_events());
}
...
TEST_F(TreeViewTest, HideRoot)
{
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetAccessibilityViewByName("a"), ax::mojom::Event::kFocus),
                  std::make_pair(GetAccessibilityViewByName("a"), ax::mojom::Event::kSelection),
                  std::make_pair(GetRootAccessibilityView(), ax::mojom::Event::kStateChanged) }),
        accessibility_events());
}
...
TEST_F(TreeViewTest, Expand)
{
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
                  std::make_pair(GetAccessibilityViewByName("b1"), ax::mojom::Event::kExpandedChanged),
                  std::make_pair(GetAccessibilityViewByName("b1"), ax::mojom::Event::kRowExpanded),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kRowCountChanged) }),
        accessibility_events());
}
...
TEST_F(TreeViewTest, Collapse)
{
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetAccessibilityViewByName("b"), ax::mojom::Event::kFocus),
                  std::make_pair(GetAccessibilityViewByName("b"), ax::mojom::Event::kSelection),
                  std::make_pair(GetAccessibilityViewByName("b"), ax::mojom::Event::kExpandedChanged),
                  std::make_pair(GetAccessibilityViewByName("b"), ax::mojom::Event::kRowCollapsed),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kRowCountChanged) }),
        accessibility_events());
}
...
TEST_F(TreeViewTest, TreeNodesRemoved)
{
    ...
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kHierarchicalLevel), 1);
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kSetSize), root_set_size);
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kPosInSet), root_pos_in_set);
    EXPECT_TRUE(data.HasState(ax::mojom::State::kInvisible));

    data = GetAccessibilityViewByName("a")->GetData();
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kSetSize), root_children_set_size);
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kPosInSet), a_pos_in_set);
    ...
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kHierarchicalLevel), 2);

    data = GetAccessibilityViewByName("b")->GetData();
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kSetSize), root_children_set_size);
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kPosInSet), b_pos_in_set);
    EXPECT_TRUE(data.HasState(ax::mojom::State::kFocusable));
    EXPECT_TRUE(data.HasAction(ax::mojom::Action::kFocus));
    EXPECT_TRUE(data.HasAction(ax::mojom::Action::kScrollToMakeVisible));
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kHierarchicalLevel), 2);
    ...
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kSetSize), root_children_set_size);
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kPosInSet), c_pos_in_set);
    EXPECT_TRUE(data.HasState(ax::mojom::State::kFocusable));
    EXPECT_TRUE(data.HasAction(ax::mojom::Action::kFocus));
    EXPECT_TRUE(data.HasAction(ax::mojom::Action::kScrollToMakeVisible));
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kHierarchicalLevel), 2);
    ...
    EXPECT_TRUE(data.HasAction(ax::mojom::Action::kFocus));
    EXPECT_TRUE(data.HasAction(ax::mojom::Action::kScrollToMakeVisible));
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kHierarchicalLevel), 3);
    ...
    EXPECT_EQ("root", GetSelectedAccessibilityViewName());
    EXPECT_EQ(4u, GetRowCount());
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged) }), accessibility_events());
    ...
    EXPECT_EQ("root", GetSelectedAccessibilityViewName());
    EXPECT_EQ(3u, GetRowCount());
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kFocus),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kRowCountChanged) }),
        accessibility_events());
    data = GetAccessibilityViewByName("root")->GetData();
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kFocus),
                  ...
                  std::make_pair(GetAccessibilityViewByName("c1"), ax::mojom::Event::kSelection),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kRowCountChanged) }),
        accessibility_events());
...
public:
    ...
    int selection_change_count() const
    {
        return call_count_;
    }
...
TEST_F(TreeViewTest, TreeNodeChanged)
{
    ...
    EXPECT_EQ("root", GetSelectedAccessibilityViewName());
    EXPECT_EQ(4u, GetRowCount());
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetAccessibilityViewByName("b.new"), ax::mojom::Event::kLocationChanged) }), accessibility_events());
}
...
TEST_F(TreeViewTest, SelectOnKeyStroke)
{
    ...
    selector()->InsertText(u"b", ui::TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText);
    EXPECT_EQ("b", GetSelectedNodeTitle());
    EXPECT_EQ("b", GetSelectedAccessibilityViewName());
    selector()->InsertText(u"1", ui::TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText);
    EXPECT_EQ("b1", GetSelectedNodeTitle());
    EXPECT_EQ("b1", GetSelectedAccessibilityViewName());

    // Invoke OnViewBlur() to reset time.
    selector()->OnViewBlur();
    selector()->InsertText(u"z", ui::TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText);
    EXPECT_EQ("b1", GetSelectedNodeTitle());
    EXPECT_EQ("b1", GetSelectedAccessibilityViewName());

    selector()->OnViewBlur();
    selector()->InsertText(u"a", ui::TextInputClient::InsertTextCursorBehavior::kMoveCursorAfterText);
    EXPECT_EQ("a", GetSelectedNodeTitle());
    EXPECT_EQ("a", GetSelectedAccessibilityViewName());
}
...
TEST_F(TreeViewTest, CommitOnFocusLost)
{
    ...
    EXPECT_EQ("a changed", GetRootAccessibilityView()->children()[0]->GetData().GetStringAttribute(ax::mojom::StringAttribute::kName));
}
...
TEST_F(TreeViewTest, OnFocusAccessibilityEvents)
{
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kChildrenChanged),
                  std::make_pair(GetRootAccessibilityView(), ax::mojom::Event::kSelection) }),
        accessibility_events());
    ...
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetRootAccessibilityView(), ax::mojom::Event::kFocus) }), accessibility_events());
    ...
    EXPECT_EQ("a", GetSelectedNodeTitle());
    EXPECT_EQ("a", GetSelectedAccessibilityViewName());
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetAccessibilityViewByName("a"), ax::mojom::Event::kSelection) }), accessibility_events());
    ...
    for (const std::string& name : test_cases) {
        ...
        EXPECT_EQ(name, GetSelectedNodeTitle());
        EXPECT_EQ(name, GetSelectedAccessibilityViewName());
        EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetAccessibilityViewByName(name), ax::mojom::Event::kSelection),
                      std::make_pair(GetAccessibilityViewByName(name), ax::mojom::Event::kFocus) }),
            accessibility_events());
    }
    ...
    EXPECT_EQ("b", GetSelectedNodeTitle());
    EXPECT_EQ("b", GetSelectedAccessibilityViewName());
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetAccessibilityViewByName("b"), ax::mojom::Event::kSelection) }), accessibility_events());
    ...
    EXPECT_EQ(std::string(), GetSelectedNodeTitle());
    EXPECT_EQ(std::string(), GetSelectedAccessibilityViewName());
    EXPECT_EQ((AccessibilityEventsVector { std::make_pair(GetRootAccessibilityView(), ax::mojom::Event::kSelection),
                  std::make_pair(GetTreeAccessibilityView(), ax::mojom::Event::kSelection),
                  std::make_pair(GetRootAccessibilityView(), ax::mojom::Event::kStateChanged),
