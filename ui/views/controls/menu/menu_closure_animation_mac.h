...
class VIEWS_EXPORT MenuClosureAnimationMac final : public gfx::AnimationDelegate {
public:
    ...
    MenuClosureAnimationMac(MenuItemView* item, SubmenuView* menu, base::OnceClosure callback);
