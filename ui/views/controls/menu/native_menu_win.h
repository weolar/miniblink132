...
private:
    ...
    void SetMenuItemState(size_t menu_index, bool enabled, bool checked, bool is_default);

    // Sets the label of the item at the specified index.
    void SetMenuItemLabel(size_t menu_index, size_t model_index, const std::u16string& label);
    ...
    void UpdateMenuItemInfoForString(MENUITEMINFO* mii, size_t model_index, const std::u16string& label);
