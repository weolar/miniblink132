...
public:
    ...
    virtual std::u16string GetTooltipText(int id, const gfx::Point& screen_loc) const;
    ...
    virtual bool ShowContextMenu(MenuItemView* source, int id, const gfx::Point& p, ui::mojom::MenuSourceType source_type);
    ...
    virtual bool ShouldExecuteCommandWithoutClosingMenu(int id, const ui::Event& e);
    ...
    virtual bool GetDropFormats(MenuItemView* menu, int* formats, std::set<ui::ClipboardFormatType>* format_types);
    ...
    virtual ui::mojom::DragOperation GetDropOperation(MenuItemView* item, const ui::DropTargetEvent& event, DropPosition* position);
    ...
    virtual views::View::DropCallback GetDropCallback(MenuItemView* menu, DropPosition position, const ui::DropTargetEvent& event);
    ...
    virtual MenuItemView* GetSiblingMenu(
