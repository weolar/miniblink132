...
class VIEWS_EXPORT SubmenuView : public View, public PrefixDelegate, public ScrollDelegate {
...
public:
    ...
    int icon_area_width() const
    {
        return icon_area_width_;
    }
    int min_icon_height() const
    {
        return min_icon_height_;
    }
    int label_start() const
    {
        return label_start_;
    }
    int trailing_padding() const
    {
    ...
    int max_minor_text_width() const
    {
        return max_minor_text_width_;
    }
    ...
    bool resize_open_menu() const
    {
        return resize_open_menu_;
    }
...
private:
    ...
    void SchedulePaintForDropIndicator(MenuItemView* item, MenuDelegate::DropPosition position);

    // Calculates the location of th edrop indicator.
    gfx::Rect CalculateDropIndicatorBounds(MenuItemView* item, MenuDelegate::DropPosition position);
    ...
    std::unique_ptr<ScrollAnimator> scroll_animator_ { std::make_unique<ScrollAnimator>(this) };
