...
public:
    ...
    View* scroll_down_button() const
    {
        return scroll_down_button_;
    }
    View* scroll_up_button() const
    {
        return scroll_up_button_;
    }
    ...
    gfx::Insets outside_border_insets() const
    {
        return outside_border_insets_;
    }
