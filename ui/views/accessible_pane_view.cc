...
public:
    ...
    AccessiblePaneViewFocusSearch& operator=(const AccessiblePaneViewFocusSearch&) = delete;

protected:
    View* GetParent(View* v) override
    {
        return accessible_pane_view_->ContainsForFocusSearch(root(), v) ? accessible_pane_view_->GetParentForFocusSearch(v) : nullptr;
    }
...
bool AccessiblePaneView::SetPaneFocus(views::View* initial_focus)
{
    ...
    if (!initial_focus || !ContainsForFocusSearch(this, initial_focus) || !initial_focus->GetVisible() || !initial_focus->GetEnabled()) {
...
views::View* AccessiblePaneView::GetFirstFocusableChild()
{
    ...
    return focus_search_->FindNextFocusableView(nullptr, FocusSearch::SearchDirection::kForwards, FocusSearch::TraversalDirection::kDown,
        FocusSearch::StartingViewPolicy::kSkipStartingView, FocusSearch::AnchoredDialogPolicy::kCanGoIntoAnchoredDialog, &dummy_focus_traversable,
...
views::View* AccessiblePaneView::GetLastFocusableChild()
{
    FocusTraversable* dummy_focus_traversable;
    views::View* dummy_focus_traversable_view;
    return focus_search_->FindNextFocusableView(this, FocusSearch::SearchDirection::kBackwards, FocusSearch::TraversalDirection::kDown,
        FocusSearch::StartingViewPolicy::kSkipStartingView, FocusSearch::AnchoredDialogPolicy::kCanGoIntoAnchoredDialog, &dummy_focus_traversable,
        &dummy_focus_traversable_view);
}
...
bool AccessiblePaneView::AcceleratorPressed(const ui::Accelerator& accelerator)
{
    ...
    case ui::VKEY_ESCAPE: {
        ...
        if (last_focused_view) {
            focus_manager_->SetFocusedViewWithReason(last_focused_view, FocusChangeReason::kFocusRestore);
    ...
    case ui::VKEY_RIGHT:
        ...
        return true;
    case ui::VKEY_HOME:
        focus_manager_->SetFocusedViewWithReason(GetFirstFocusableChild(), FocusChangeReason::kFocusTraversal);
        return true;
    case ui::VKEY_END:
        focus_manager_->SetFocusedViewWithReason(GetLastFocusableChild(), FocusChangeReason::kFocusTraversal);
        return true;
    default:
        return false;
    }
...
void AccessiblePaneView::OnWillChangeFocus(views::View* focused_before, views::View* focused_now)
{
    //  Act when focus has changed.
}

void AccessiblePaneView::OnDidChangeFocus(views::View* focused_before, views::View* focused_now)
{
    if (!focused_now)
        return;
    ...
    if (!ContainsForFocusSearch(this, focused_now) || reason == views::FocusManager::FocusChangeReason::kDirectFocusChange) {
