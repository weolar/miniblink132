...
public:
    ...
    // --------------------
    //
    explicit BoxLayout(Orientation orientation = Orientation::kHorizontal, const gfx::Insets& inside_border_insets = gfx::Insets(),
        int between_child_spacing = 0, bool collapse_margins_spacing = false);
    ~BoxLayout() override;
    ...
    MainAxisAlignment main_axis_alignment() const
    {
    ...
    int between_child_spacing() const
    {
...
private:
    ...
    gfx::Size GetPreferredSizeForView(const View* view, const NormalizedSizeBounds& size_bounds) const;
    ...
    void CalculatePreferredSize(const SizeBounds& size_bounds, BoxLayoutData& data) const;
    ...
    // rules.
    void UpdateFlexLayout(const NormalizedSizeBounds& bounds, BoxLayoutData& data) const;
    ...
    // exceeds the bounds.
    void CalculateChildBounds(const SizeBounds& size_bounds, BoxLayoutData& data) const;
