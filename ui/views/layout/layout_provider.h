...
public:
    ...
    static int GetControlHeightForFont(int context, int style, const gfx::FontList& font);
    ...
    gfx::Insets GetDialogInsetsForContentType(DialogContentType leading, DialogContentType trailing) const;
    ...
    virtual int GetCornerRadiusMetric(Emphasis emphasis, const gfx::Size& size = gfx::Size()) const;
    ...
    // context tokens.
    int GetCornerRadiusMetric(ShapeContextTokens token, const gfx::Size& size = gfx::Size()) const;
