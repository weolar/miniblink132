...
void BoxLayoutView::SetMainAxisAlignment(BoxLayout::MainAxisAlignment main_axis_alignment)
{
...
void BoxLayoutView::SetCrossAxisAlignment(BoxLayout::CrossAxisAlignment cross_axis_alignment)
{
...
void BoxLayoutView::SetFlexForView(const View* view, int flex, bool use_min_size)
{
