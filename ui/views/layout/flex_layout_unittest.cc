...
public:
    ...
    void SetMaximumSize(gfx::Size maximum_size)
    {
        maximum_size_ = maximum_size;
    }

    Size GetMaximumSize() const override
    {
    ...
    {
        gfx::Size preferred_size = preferred_size_ ? preferred_size_.value() : View::CalculatePreferredSize(available_size);
        switch (size_mode_) {
        ...
        case SizeMode::kFixedArea: {
            ...
            return gfx::Size(width, (preferred_size.width() * preferred_size.height()) / width);
        }
        }
    }
    ...
    int GetSetVisibleCount() const
    {
        return set_visible_count_;
    }

    void ResetCounts()
    {
        set_visible_count_ = 0;
    }
...
Size CustomFlexImpl(bool snap_to_zero, const View* view, const SizeBounds& maximum_size)
{
...
public:
    ...
    MockView* AddChild(const Size& preferred_size, const optional<Size>& minimum_size = optional<Size>(), bool visible = true)
    {
        return AddChild(host_.get(), preferred_size, minimum_size, visible);
    }

    static MockView* AddChild(View* parent, const Size& preferred_size, const optional<Size>& minimum_size = optional<Size>(), bool visible = true)
    {
    ...
    std::vector<Rect> GetChildBounds() const
    {
        ...
        base::ranges::transform(host_->children(), std::back_inserter(result), [](const View* v) { return v->GetVisible() ? v->bounds() : gfx::Rect(); });
        return result;
    }
...
const FlexSpecification FlexLayoutTest::kPreferredAdjustHeight
    = FlexSpecification(MinimumFlexSizeRule::kPreferred, MaximumFlexSizeRule::kPreferred, true).WithWeight(0);
const FlexSpecification FlexLayoutTest::kDropOut
    = FlexSpecification(MinimumFlexSizeRule::kPreferredSnapToZero, MaximumFlexSizeRule::kPreferred).WithWeight(0).WithOrder(2);
const FlexSpecification FlexLayoutTest::kDropOutHighPriority = FlexLayoutTest::kDropOut.WithOrder(1);
const FlexSpecification FlexLayoutTest::kFlex1ScaleToZero = FlexSpecification(MinimumFlexSizeRule::kScaleToZero, MaximumFlexSizeRule::kPreferred).WithOrder(2);
const FlexSpecification FlexLayoutTest::kFlex1ScaleToMinimum
    = FlexSpecification(MinimumFlexSizeRule::kScaleToMinimum, MaximumFlexSizeRule::kPreferred).WithOrder(2);
const FlexSpecification FlexLayoutTest::kFlex2ScaleToMinimum = FlexLayoutTest::kFlex1ScaleToMinimum.WithWeight(2);
const FlexSpecification FlexLayoutTest::kFlex1ScaleToMinimumHighPriority = FlexLayoutTest::kFlex1ScaleToMinimum.WithOrder(1);
const FlexSpecification FlexLayoutTest::kUnbounded = FlexSpecification(MinimumFlexSizeRule::kPreferred, MaximumFlexSizeRule::kUnbounded).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedSnapToMinimum
    = FlexSpecification(MinimumFlexSizeRule::kPreferredSnapToMinimum, MaximumFlexSizeRule::kUnbounded).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedSnapToZero
    = FlexSpecification(MinimumFlexSizeRule::kPreferredSnapToZero, MaximumFlexSizeRule::kUnbounded).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedScaleToMinimumSnapToZero
    = FlexSpecification(MinimumFlexSizeRule::kScaleToMinimumSnapToZero, MaximumFlexSizeRule::kUnbounded).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedScaleToZero
    = FlexSpecification(MinimumFlexSizeRule::kScaleToZero, MaximumFlexSizeRule::kUnbounded).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedScaleToZeroAdjustHeight
    = FlexSpecification(MinimumFlexSizeRule::kScaleToZero, MaximumFlexSizeRule::kUnbounded, true).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedScaleToMinimumHighPriority(MinimumFlexSizeRule::kScaleToMinimum, MaximumFlexSizeRule::kUnbounded);
const FlexSpecification FlexLayoutTest::kUnboundedScaleToMinimum = kUnboundedScaleToMinimumHighPriority.WithOrder(2);

const FlexSpecification FlexLayoutTest::kUnboundedSnapToMinimumHorizontal
    = FlexSpecification(LayoutOrientation::kHorizontal, MinimumFlexSizeRule::kPreferredSnapToMinimum, MaximumFlexSizeRule::kUnbounded).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedScaleToMinimumSnapToZeroHorizontal
    = FlexSpecification(LayoutOrientation::kHorizontal, MinimumFlexSizeRule::kScaleToMinimumSnapToZero, MaximumFlexSizeRule::kUnbounded).WithOrder(2);
const FlexSpecification FlexLayoutTest::kUnboundedScaleToZeroHorizontal
    = FlexSpecification(LayoutOrientation::kHorizontal, MinimumFlexSizeRule::kScaleToZero, MaximumFlexSizeRule::kUnbounded).WithOrder(2);

const FlexSpecification FlexLayoutTest::kScaleToMaximum = FlexSpecification(MinimumFlexSizeRule::kPreferred, MaximumFlexSizeRule::kScaleToMaximum).WithOrder(2);

const FlexSpecification FlexLayoutTest::kCustomFlex = FlexSpecification(base::BindRepeating(&CustomFlexImpl, false)).WithOrder(2);
const FlexSpecification FlexLayoutTest::kCustomFlexSnapToZero = FlexSpecification(base::BindRepeating(&CustomFlexImpl, true)).WithOrder(2);
...
TEST_F(FlexLayoutTest, GetMinimumSize_Empty_InternalMargin_DefaultMarginHasNoEffect)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(false);
    layout_->SetInteriorMargin(kLayoutInsets);
...
TEST_F(FlexLayoutTest, Layout_VisibilitySetBeforeInstall)
{
    ...
    View* child1 = AddChild(host.get(), Size(10, 10), std::optional<Size>(), false);
    View* child2 = AddChild(host.get(), Size(10, 10), std::optional<Size>(), true);
...
TEST_F(FlexLayoutTest, Layout_VisibilitySetBeforeAdd)
{
    ...
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(6, 5, 12, 10), Rect(18, 5, 13, 11), Rect(31, 5, 17, 13) };
    EXPECT_TRUE(child2->GetVisible());
...
TEST_F(FlexLayoutTest, Layout_ViewVisibilitySetNotContingentOnActualVisibility)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(kLayoutInsets);
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_Horizontal_CrossCenter)
{
    ...
    AddChild(kChild3Size);
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(6, 6, 12, 10), Rect(18, 6, 13, 11), Rect(31, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(57, 25), host_->GetPreferredSize({}));
}
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_Horizontal_CrossEnd)
{
    ...
    AddChild(kChild3Size);
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(6, 8, 12, 10), Rect(18, 7, 13, 11), Rect(31, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(57, 25), host_->GetPreferredSize({}));
}
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_Horizontal_CrossStretch)
{
    ...
    AddChild(kChild3Size);
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(6, 5, 12, 13), Rect(18, 5, 13, 13), Rect(31, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(57, 25), host_->GetPreferredSize({}));
}
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_Vertical_CrossStart)
{
    ...
    AddChild(kChild3Size);
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(6, 5, 12, 10), Rect(6, 15, 13, 11), Rect(6, 26, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_Vertical_CrossCenter)
{
    ...
    AddChild(kChild3Size);
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(8, 5, 12, 10), Rect(8, 15, 13, 11), Rect(6, 26, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(32, 46), host_->GetPreferredSize({}));
}
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_Vertical_CrossEnd)
{
    ...
    AddChild(kChild3Size);
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(11, 5, 12, 10), Rect(10, 15, 13, 11), Rect(6, 26, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(32, 46), host_->GetPreferredSize({}));
}
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_Vertical_CrossStretch)
{
    ...
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(6, 5, 17, 10), Rect(6, 15, 17, 11), Rect(6, 26, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(32, 46), host_->GetPreferredSize({}));
}

TEST_F(FlexLayoutTest, LayoutMultipleViews_MarginAndSpacing_NoCollapse_Horizontal)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(false);
    layout_->SetInteriorMargin(kLayoutInsets);
    ...
    test::RunScheduledLayout(host_.get());
    expected = std::vector<Rect> { Rect(27, 25, 12, 10), Rect(62, 5, 13, 11), Rect(75, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    ...
    test::RunScheduledLayout(host_.get());
    expected = std::vector<Rect> { Rect(27, 25, 12, 10), Rect(63, 6, 13, 11), Rect(80, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    ...
    host_->InvalidateLayout();
    test::RunScheduledLayout(host_.get());
    expected = std::vector<Rect> { Rect(27, 25, 12, 10), Rect(63, 6, 13, 11), Rect(79, 7, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(107, 64), host_->GetPreferredSize({}));
}

TEST_F(FlexLayoutTest, LayoutMultipleViews_MarginAndSpacing_NoCollapse_Vertical)
{
    layout_->SetOrientation(LayoutOrientation::kVertical);
    layout_->SetCollapseMargins(false);
    layout_->SetInteriorMargin(kLayoutInsets);
    ...
    host_->InvalidateLayout();
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(27, 25, 12, 10), Rect(7, 58, 13, 11), Rect(8, 72, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
    EXPECT_EQ(Size(71, 94), host_->GetPreferredSize({}));
}

TEST_F(FlexLayoutTest, LayoutMultipleViews_MarginAndSpacing_Collapse_Horizontal)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(kLayoutInsets);
    ...
    host_->InvalidateLayout();
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(21, 20, 12, 10), Rect(56, 5, 13, 11), Rect(71, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, LayoutMultipleViews_MarginAndSpacing_Collapse_Vertical)
{
    ...
    host_->InvalidateLayout();
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(21, 20, 12, 10), Rect(6, 52, 13, 11), Rect(6, 65, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, HeightForWidth_Vertical_CrossStretch_WidthChangesHeight)
{
    layout_->SetOrientation(LayoutOrientation::kVertical);
    layout_->SetMainAxisAlignment(LayoutAlignment::kStart);
    layout_->SetCrossAxisAlignment(LayoutAlignment::kStretch);
...
TEST_F(FlexLayoutTest, Layout_HostInsets_Horizontal_Center)
{
    ...
    View* child = AddChild(kChild1Size);
    host_->SetSize({ 100, 100 });
    const int expected_x = kLayoutInsets.left() + (host_->size().width() - kChild1Size.width() - kLayoutInsets.width()) / 2;
...
TEST_F(FlexLayoutTest, Layout_HostInsets_Vertical_Center)
{
    ...
    View* child = AddChild(kChild1Size);
    host_->SetSize({ 100, 100 });
    const int expected_y = kLayoutInsets.top() + (host_->size().height() - kChild1Size.height() - kLayoutInsets.height()) / 2;
...
TEST_F(FlexLayoutTest, Layout_HostInsets_Horizontal_End)
{
    ...
    View* child = AddChild(kChild1Size);
    host_->SetSize({ 100, 100 });
    const int expected_x = kLayoutInsets.left() + (host_->size().width() - kChild1Size.width() - kLayoutInsets.width());
    EXPECT_EQ(Rect(expected_x, 5, 12, 10), child->bounds());
}
...
TEST_F(FlexLayoutTest, Layout_HostInsets_Vertical_End)
{
    ...
    View* child = AddChild(kChild1Size);
    host_->SetSize({ 100, 100 });
    const int expected_y = kLayoutInsets.top() + (host_->size().height() - kChild1Size.height() - kLayoutInsets.height());
    EXPECT_EQ(Rect(6, expected_y, 12, 10), child->bounds());
}
...
TEST_F(FlexLayoutTest, SetIncludeHostInsetsInLayout_CollapseIntoInsets)
{
    ...
    const std::vector<Rect> expected = { Rect(19, 7, 10, 10), Rect(15, 32, 10, 10), Rect(19, 57, 10, 10) };
    EXPECT_EQ(expected, GetChildBounds());
}
...
TEST_F(FlexLayoutTest, SetIgnoreDefaultMainAxisMargins_IgnoresDefaultMargins)
{
    ...
    host_->SetSize(preferred_size);
    const std::vector<Rect> expected = { Rect(10, 5, 10, 10), Rect(10, 23, 10, 10), Rect(10, 41, 10, 10) };
    EXPECT_EQ(expected, GetChildBounds());
}

TEST_F(FlexLayoutTest, SetIgnoreDefaultMainAxisMargins_IncludesExplicitMargins)
{
    layout_->SetOrientation(LayoutOrientation::kVertical);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(kLayoutInsets);
    ...
    host_->SetSize(preferred_size);
    const std::vector<Rect> expected = { Rect(11, 11, 10, 10), Rect(6, 32, 10, 10), Rect(12, 54, 10, 10) };
    EXPECT_EQ(expected, GetChildBounds());
}
...
TEST_F(FlexLayoutTest, Layout_AlignCenter)
{
    ...
    host_->SetSize(Size(105, 50));
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(25, 20, 12, 10), Rect(60, 5, 13, 11), Rect(75, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
}
...
TEST_F(FlexLayoutTest, Layout_AlignEnd)
{
    ...
    host_->SetSize(Size(105, 50));
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(29, 20, 12, 10), Rect(64, 5, 13, 11), Rect(79, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
}
...
TEST_F(FlexLayoutTest, Layout_AddDroppedMargins)
{
    ...
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(5, 5, 10, 10), Rect(16, 6, 10, 10), Rect(27, 5, 10, 10) };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, Layout_VerticalAlign_WiderThanTall)
{
    ...
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(21, 27, 12, 10), Rect(6, 59, 13, 11), Rect(6, 72, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
}
...
TEST_F(FlexLayoutTest, Layout_IgnoreMinimumSize_DropViews)
{
    ...
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected = { Rect(11, 10, 12, 10), Rect(36, 5, 13, 11), Rect(51, 5, 17, 13) };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, Layout_Flex_OneViewScales_CausesSubsequentControlToDropOut)
{
    layout_->SetOrientation(LayoutOrientation::kVertical);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(Insets(5));
...
TEST_F(FlexLayoutTest, Layout_Flex_OneViewScales_CausesSubsequentFlexControlToDropOut)
{
    layout_->SetOrientation(LayoutOrientation::kVertical);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(Insets(5));
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_UnequalWeight_FirstHigher_FlexSmaller)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(Insets(5));
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_UnequalWeight_SecondHigher_FlexSmaller)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(Insets(5));
...
// size*.
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_UnequalWeight_OneDropsOut_OtherExceedsPreferred)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(Insets(5));
    ...
    child1->SetProperty(views::kFlexBehaviorKey, kUnboundedScaleToMinimumSnapToZero);
    child2->SetProperty(views::kFlexBehaviorKey, kUnboundedScaleToMinimumSnapToZero.WithWeight(4));
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_FirstViewFillsAvailableSpace)
{
    ...
    child2->SetProperty(views::kFlexBehaviorKey, FlexSpecification(MinimumFlexSizeRule::kPreferred, MaximumFlexSizeRule::kPreferred));
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_Priority)
{
    ...
    View* child2 = AddChild(Size(20, 10), Size(5, 5));
    child1->SetProperty(views::kFlexBehaviorKey, kFlex1ScaleToMinimum);
    child2->SetProperty(views::kFlexBehaviorKey, kFlex1ScaleToMinimumHighPriority);
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_Priority_LowerPriorityDropsOut)
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    layout_->SetCollapseMargins(true);
    layout_->SetInteriorMargin(Insets(5));
...
TEST_F(FlexLayoutTest, Layout_FlexRule_UnboundedScaleToMinimumSnapToZero)
{
    ...
    layout_->SetDefault(views::kMarginsKey, gfx::Insets(5));
    View* child = AddChild(Size(20, 10), Size(5, 5));
    child->SetProperty(views::kFlexBehaviorKey, kUnboundedScaleToMinimumSnapToZero);
...
TEST_F(FlexLayoutTest, Layout_FlexRule_UnboundedSnapToMinimum1D)
{
    ...
    layout_->SetDefault(views::kMarginsKey, gfx::Insets(5));
    View* child = AddChild(Size(20, 10), Size(5, 5));
    child->SetProperty(views::kFlexBehaviorKey, kUnboundedSnapToMinimumHorizontal);
...
TEST_F(FlexLayoutTest, Layout_FlexRule_UnboundedScaleToMinimumSnapToZero1D)
{
    ...
    layout_->SetDefault(views::kMarginsKey, gfx::Insets(5));
    View* child = AddChild(Size(20, 10), Size(5, 5));
    child->SetProperty(views::kFlexBehaviorKey, kUnboundedScaleToMinimumSnapToZeroHorizontal);
...
TEST_F(FlexLayoutTest, Layout_FlexRule_ScaleToMaximum)
{
    ...
    test::RunScheduledLayout(host_.get());
    std::vector<Rect> expected_bounds = { { 0, 0, 10, 10 }, { 10, 0, 10, 10 }, { 20, 0, 10, 10 } };
    EXPECT_EQ(expected_bounds, GetChildBounds());
...
TEST_F(FlexLayoutTest, Layout_FlexRule_TwoPassScaling_PreferredSizeTakesPrecedence)
{
    ...
    child1->SetProperty(views::kFlexBehaviorKey, kUnboundedScaleToMinimumHighPriority);
...
TEST_F(FlexLayoutTest, Layout_FlexRule_TwoPassScaling_StopAtPreferredSize)
{
    ...
    constexpr Size kEnoughSpace(kSmallSize.width() + kLargeSize.width(), kLargeSize.height());
...
TEST_F(FlexLayoutTest, Layout_FlexRule_TwoPassScaling_GrowPastPreferredSize)
{
    ...
    constexpr Size kExtraSpace(kSmallSize.width() + kLargeSize.width() + kExtra, kLargeSize.height() + kExtra);
    host_->SetSize(kExtraSpace);
    EXPECT_EQ(Size(kLargeSize.width() + kExtra, kLargeSize.height() + kExtra), child1->size());
    EXPECT_EQ(kSmallSize, child2->size());
}
...
TEST_F(FlexLayoutTest, Layout_FlexRule_GrowPastPreferredSize_TwoViews_SamePriority)
{
    constexpr Size kLargeSize(10, 10);
    constexpr Size kSmallSize(5, 5);
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    ...
    child2->SetProperty(views::kFlexBehaviorKey, kUnboundedScaleToMinimumHighPriority);

    constexpr int kExtra = 8;
    constexpr Size kExtraSpace(2 * kLargeSize.width() + kExtra, kLargeSize.height());
    host_->SetSize(kExtraSpace);
    EXPECT_EQ(Size(kLargeSize.width() + kExtra / 2, kLargeSize.height()), child1->size());
    EXPECT_EQ(Size(kLargeSize.width() + kExtra / 2, kLargeSize.height()), child2->size());
}
...
TEST_F(FlexLayoutTest, Layout_FlexRule_GrowPastPreferredSize_TwoViews_DifferentPriority)
{
    constexpr Size kLargeSize(10, 10);
    constexpr Size kSmallSize(5, 5);
    layout_->SetOrientation(LayoutOrientation::kHorizontal);
    ...
    constexpr Size kExtraSpace(2 * kLargeSize.width() + kExtra, kLargeSize.height());
    host_->SetSize(kExtraSpace);
    EXPECT_EQ(Size(kLargeSize.width() + kExtra, kLargeSize.height()), child1->size());
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_FlexAlignment_Start)
{
    ...
    View* child1 = AddChild(Size(10, 10));
    AddChild(Size(10, 10));
    child1->SetProperty(views::kFlexBehaviorKey, kUnbounded.WithAlignment(LayoutAlignment::kStart));
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_FlexAlignment_End)
{
    ...
    View* child1 = AddChild(Size(10, 10));
    AddChild(Size(10, 10));
    child1->SetProperty(views::kFlexBehaviorKey, kUnbounded.WithAlignment(LayoutAlignment::kEnd));
...
TEST_F(FlexLayoutTest, Layout_Flex_TwoChildViews_FlexAlignment_Center)
{
    ...
    View* child1 = AddChild(Size(10, 10));
    AddChild(Size(10, 10));
    child1->SetProperty(views::kFlexBehaviorKey, kUnbounded.WithAlignment(LayoutAlignment::kCenter));
...
TEST_F(FlexLayoutTest, Layout_Vertical_ZeroWidthNonZeroHeight)
{
    ...
    const std::vector<gfx::Rect> expected = { { 5, 5, 10, 10 }, { 10, 20, 0, 10 }, { 5, 35, 10, 10 } };
    EXPECT_EQ(expected, GetChildBounds());
}
...
TEST_F(FlexLayoutTest, GetAvailableSize_NoFlex_ExtraSize)
{
    ...
    EXPECT_EQ(SizeBounds(child1->GetPreferredSize({}).width() + excess, 15), host_->GetAvailableSize(child1));
    EXPECT_EQ(SizeBounds(child2->GetPreferredSize({}).width() + excess, 15), host_->GetAvailableSize(child2));
}
...
TEST_F(FlexLayoutTest, GetAvailableSize_NoFlex_Vertical)
{
    ...
    EXPECT_EQ(SizeBounds(25, child1->GetPreferredSize({}).height() + excess), host_->GetAvailableSize(child1));
    EXPECT_EQ(SizeBounds(25, child2->GetPreferredSize({}).height() + excess), host_->GetAvailableSize(child2));
}
...
TEST_F(FlexLayoutTest, GetAvailableSize_Flex_DifferentWeights)
{
    ...
    host_->SetSize({ 80, 25 });
    const int excess = host_->width() - host_->GetPreferredSize({}).width();
    const int child3_excess = child3->GetPreferredSize({}).width() - child3->GetMinimumSize().width();
    const int child4_excess = child4->GetPreferredSize({}).width() - child4->GetMinimumSize().width();
    ...
    EXPECT_EQ(SizeBounds(child1->GetPreferredSize({}).width() + excess + child3_excess + child4_excess, 15), host_->GetAvailableSize(child1));
    EXPECT_EQ(SizeBounds(child2->GetPreferredSize({}).width() + excess + child3_excess + child4_excess, 15), host_->GetAvailableSize(child2));
    // The third view has a higher priority, so it can take the excess plus the
    // excess from the fourth view.
    EXPECT_EQ(SizeBounds(child3->GetPreferredSize({}).width() + excess + child4_excess, 15), host_->GetAvailableSize(child3));
    // This view has the lowest priority so it can only take the excess space in
    // the layout.
    EXPECT_EQ(SizeBounds(child4->GetPreferredSize({}).width() + excess, 15), host_->GetAvailableSize(child4));

    // Same as above, but there is no overall excess.
    host_->SizeToPreferredSize();
    EXPECT_EQ(SizeBounds(child1->GetPreferredSize({}).width() + child3_excess + child4_excess, 12), host_->GetAvailableSize(child1));
    EXPECT_EQ(SizeBounds(child2->GetPreferredSize({}).width() + child3_excess + child4_excess, 12), host_->GetAvailableSize(child2));
    EXPECT_EQ(SizeBounds(child3->GetPreferredSize({}).width() + child4_excess, 12), host_->GetAvailableSize(child3));
    EXPECT_EQ(SizeBounds(child4->GetPreferredSize({}).width(), 12), host_->GetAvailableSize(child4));

    // At minimum size there is no excess; all views get their minimum size.
    host_->SetSize(host_->GetMinimumSize());
    EXPECT_EQ(SizeBounds(child1->GetPreferredSize({}).width(), 10), host_->GetAvailableSize(child1));
    EXPECT_EQ(SizeBounds(child2->GetPreferredSize({}).width(), 10), host_->GetAvailableSize(child2));
    EXPECT_EQ(SizeBounds(child3->GetMinimumSize().width(), 10), host_->GetAvailableSize(child3));
    EXPECT_EQ(SizeBounds(child4->GetMinimumSize().width(), 10), host_->GetAvailableSize(child4));
}
...
TEST_F(FlexLayoutTest, FlexRuleContradictsPreferredSize)
{
    const FlexSpecification custom_spec(
        base::BindRepeating([](const View* view, const SizeBounds& maximum_size) { return gfx::Size((maximum_size.width() >= 100) ? 100 : 0, 100); }));
...
TEST_F(FlexLayoutTest, PreferredSizeZeroPreventsFlex_Horizontal)
{
    ...
    host_->SetSize({ 30, 15 });
    std::vector<gfx::Rect> expected = { { 0, 0, 10, 10 }, { 10, 0, 10, 15 }, { 20, 0, 10, 15 } };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, PreferredSizeZeroPreventsFlex_Vertical)
{
    ...
    host_->SetSize({ 15, 30 });
    std::vector<gfx::Rect> expected = { { 0, 0, 10, 10 }, { 0, 10, 15, 10 }, { 0, 20, 15, 10 } };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, LabelPreferredHeightChangesWithWidth)
{
    ...
    label->SetProperty(kFlexBehaviorKey,
        FlexSpecification(LayoutOrientation::kHorizontal, MinimumFlexSizeRule::kScaleToZero, MaximumFlexSizeRule::kPreferred,
...
TEST_F(FlexLayoutTest, VerticalInHorizontalInVertical_HeightForWidth)
{
    ...
    auto* const vertical = horizontal->AddChildView(std::make_unique<views::View>());
    ...
    layout_->SetOrientation(LayoutOrientation::kVertical);
    horizontal->SetProperty(kFlexBehaviorKey,
        FlexSpecification(horizontal->SetLayoutManager(std::make_unique<FlexLayout>())
                              ->SetOrientation(LayoutOrientation::kHorizontal)
                              .SetCrossAxisAlignment(LayoutAlignment::kStart)
                              .GetDefaultFlexRule()));
    vertical->SetProperty(kFlexBehaviorKey,
        FlexSpecification(vertical->SetLayoutManager(std::make_unique<FlexLayout>())->SetOrientation(LayoutOrientation::kVertical).GetDefaultFlexRule()));

    const views::FlexSpecification view_flex(views::LayoutOrientation::kVertical, views::MinimumFlexSizeRule::kPreferred,
        views::MaximumFlexSizeRule::kPreferred,
        /* adjust_height_for_width = */ true, views::MinimumFlexSizeRule::kScaleToZero);
...
Size StepwiseFlexRule(int step, const View* view, const SizeBounds& maximum_size)
{
    DCHECK_GT(step, 0);
...
TEST_F(FlexLayoutTest, Advanced_ViewDoesNotTakeFullExcess_Reallocation)
{
    ...
    v1->SetProperty(kFlexBehaviorKey, FlexSpecification(MinimumFlexSizeRule::kPreferred, MaximumFlexSizeRule::kUnbounded));
    v2->SetProperty(kFlexBehaviorKey, FlexSpecification(base::BindRepeating(&StepwiseFlexRule, 5)));
...
{
    const FlexSpecification spec_scale = FlexSpecification(MinimumFlexSizeRule::kScaleToZero, MaximumFlexSizeRule::kUnbounded);
...
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal).SetDefault(kMarginsKey, gfx::Insets(5));
    View* const v1 = AddChild(gfx::Size(10, 10));
...
{
    layout_->SetOrientation(LayoutOrientation::kVertical).SetDefault(kMarginsKey, gfx::Insets(5));
    View* const v1 = AddChild(gfx::Size(10, 10));
    v1->SetProperty(kCrossAxisAlignmentKey, LayoutAlignment::kStart);
    View* const v2 = AddChild(gfx::Size(10, 10));
    v2->SetProperty(kCrossAxisAlignmentKey, LayoutAlignment::kCenter);
...
{
    layout_->SetOrientation(LayoutOrientation::kHorizontal).SetCrossAxisAlignment(views::LayoutAlignment::kStart).SetIgnoreDefaultMainAxisMargins(true);

    // We want to specialize the maximum size and have different sizes within the
    // constraints of the scene
    const FlexSpecification custom_spec(base::BindRepeating([](const View* view, const SizeBounds& maximum_size) {
        ...
        // a simple simulation.
        return gfx::Size(maximum_size.width() >= 300 ? 300 : maximum_size.width().min_of(250), 24);
    }));
    ...
    v2->SetProperty(kFlexBehaviorKey, kUnbounded.WithAlignment(views::LayoutAlignment::kEnd));
...
TEST_F(FlexLayoutTest, PreferredSizeMutationTest2)
{
    ...
    v1->SetProperty(kFlexBehaviorKey, custom_spec.WithOrder(2));
    View* const v2 = AddChild(gfx::Size(24, 24));
    v2->SetProperty(kFlexBehaviorKey, kUnbounded.WithAlignment(views::LayoutAlignment::kCenter));
    ...
    host_->SizeToPreferredSize();
    std::vector<Rect> expected = { { 0, 0, 300, 24 }, { 300, 0, 24, 24 }, { 324, 0, 300, 24 } };
    EXPECT_EQ(expected, GetChildBounds());
...
TEST_F(FlexLayoutTest, ZeroPreferedSizeView)
{
    ...
    v2->SetProperty(kFlexBehaviorKey, views::FlexSpecification(views::MinimumFlexSizeRule::kScaleToMinimum, views::MaximumFlexSizeRule::kScaleToMaximum));
...
protected:
    ...
    static constexpr std::array<gfx::Size, kNumChildren> kChildSizes = { { { 10, 10 }, { 10, 10 }, { 10, 30 } } };
    static constexpr std::array<gfx::Insets, kNumChildren> kChildMargins
        = { { gfx::Insets::TLBR(6, 0, 2, 0), gfx::Insets::TLBR(10, 0, 5, 0), gfx::Insets::TLBR(6, 0, 2, 0) } };
...
TEST_F(FlexLayoutCrossAxisFitTest, Layout_CrossStretch)
{
    ...
    for (size_t i = 0; i < kNumChildren; ++i) {
        ...
        const int expected_height = std::max(0, kHostSize.height() - kChildMargins[i].height());
...
TEST_F(FlexLayoutCrossAxisFitTest, Layout_CrossCenter)
{
    ...
    int remain = kHostSize.height() - (kChildSizes[0].height() + kChildMargins[0].height());
    ...
    expected = base::ClampRound(kChildMargins[1].top() * static_cast<float>(remain) / kChildMargins[1].height());
...
TEST_F(FlexLayoutCrossAxisFitTest, Layout_CrossEnd)
{
    ...
    for (size_t i = 0; i < kNumChildren; ++i) {
        EXPECT_EQ(kHostSize.height() - kChildMargins[i].bottom(), child_views_[i]->bounds().bottom());
        EXPECT_EQ(kChildSizes[i].height(), child_views_[i]->size().height());
    }
}
...
public:
    ...
    View* AddGrandchild(size_t child_index, const gfx::Size& preferred, const std::optional<gfx::Size>& minimum = std::nullopt)
    {
        return AddChild(children_[child_index - 1], preferred, minimum);
    }

    View* child(size_t child_index) const
    {
        return children_[child_index - 1];
    }
...
TEST_F(NestedFlexLayoutTest, UsingDefaultFlexRule)
{
    ...
    child(1)->SetProperty(kFlexBehaviorKey, FlexSpecification(layout(1)->GetDefaultFlexRule()).WithOrder(2));
    child(2)->SetProperty(kFlexBehaviorKey, FlexSpecification(layout(2)->GetDefaultFlexRule()));
...
static const DirectionalFlexRuleTestParamRules kNoCrossFlex
    = { "Main unbounded scale to minimum snap to zero, cross no flex.", MinimumFlexSizeRule::kScaleToMinimumSnapToZero, MaximumFlexSizeRule::kUnbounded };

// Drop out on main axis, flex on cross axis.
static const DirectionalFlexRuleTestParamRules kMainDropOutCrossFlex = { "Main preferred snap to zero, cross unbounded scale to zero.",
    MinimumFlexSizeRule::kPreferredSnapToZero, MaximumFlexSizeRule::kPreferred, false, MinimumFlexSizeRule::kScaleToZero };

// Preferred height-for-width on main axis, scale to minimum snap to zero on
// cross axis. (Note: Vertical only!)
static const DirectionalFlexRuleTestParamRules kFlexUseHeightForWidth = { "Cross scale to minimum snap to zero, main use height for width.",
    MinimumFlexSizeRule::kPreferred, MaximumFlexSizeRule::kPreferred, true, MinimumFlexSizeRule::kScaleToMinimumSnapToZero };

const DirectionalFlexRuleTestParam DirectionalFlexRuleTestParamList[] = {
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(20, 10), { { 0, 0, 10, 10 }, { 10, 0, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(30, 10), { { 0, 0, 10, 10 }, { 10, 0, 20, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(16, 10), { { 0, 0, 10, 10 }, { 10, 0, 6, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(14, 10), { { 0, 0, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(20, 20), { { 0, 5, 10, 10 }, { 10, 5, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(30, 20), { { 0, 5, 10, 10 }, { 10, 5, 20, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(16, 20), { { 0, 5, 10, 10 }, { 10, 5, 6, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(14, 20), { { 0, 5, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(20, 6), { { 0, -2, 10, 10 }, { 10, -2, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(30, 6), { { 0, -2, 10, 10 }, { 10, -2, 20, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(16, 6), { { 0, -2, 10, 10 }, { 10, -2, 6, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(14, 6), { { 0, -2, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(20, 4), { { 0, -3, 10, 10 }, { 10, -3, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(30, 4), { { 0, -3, 10, 10 }, { 10, -3, 20, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(16, 4), { { 0, -3, 10, 10 }, { 10, -3, 6, 10 } } },
    { LayoutOrientation::kHorizontal, kNoCrossFlex, gfx::Size(14, 4), { { 0, -3, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(20, 10), { { 0, 0, 10, 10 }, { 10, 0, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(30, 10), { { 0, 0, 10, 10 }, { 10, 0, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(16, 10), { { 0, 0, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(14, 10), { { 0, 0, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(20, 20), { { 0, 5, 10, 10 }, { 10, 5, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(30, 20), { { 0, 5, 10, 10 }, { 10, 5, 10, 10 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(16, 20), { { 0, 5, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(14, 20), { { 0, 5, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(20, 6), { { 0, -2, 10, 10 }, { 10, 0, 10, 6 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(30, 6), { { 0, -2, 10, 10 }, { 10, 0, 10, 6 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(16, 6), { { 0, -2, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(14, 6), { { 0, -2, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(20, 4), { { 0, -3, 10, 10 }, { 10, 0, 10, 4 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(30, 4), { { 0, -3, 10, 10 }, { 10, 0, 10, 4 } } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(16, 4), { { 0, -3, 10, 10 }, {} } },
    { LayoutOrientation::kHorizontal, kMainDropOutCrossFlex, gfx::Size(14, 4), { { 0, -3, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(10, 20), { { 0, 0, 10, 10 }, { 0, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(10, 30), { { 0, 0, 10, 10 }, { 0, 10, 10, 20 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(10, 16), { { 0, 0, 10, 10 }, { 0, 10, 10, 6 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(10, 14), { { 0, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(20, 20), { { 5, 0, 10, 10 }, { 5, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(20, 30), { { 5, 0, 10, 10 }, { 5, 10, 10, 20 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(20, 16), { { 5, 0, 10, 10 }, { 5, 10, 10, 6 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(20, 14), { { 5, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(6, 20), { { -2, 0, 10, 10 }, { -2, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(6, 30), { { -2, 0, 10, 10 }, { -2, 10, 10, 20 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(6, 16), { { -2, 0, 10, 10 }, { -2, 10, 10, 6 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(6, 14), { { -2, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(4, 20), { { -3, 0, 10, 10 }, { -3, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(4, 30), { { -3, 0, 10, 10 }, { -3, 10, 10, 20 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(4, 16), { { -3, 0, 10, 10 }, { -3, 10, 10, 6 } } },
    { LayoutOrientation::kVertical, kNoCrossFlex, gfx::Size(4, 14), { { -3, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(10, 20), { { 0, 0, 10, 10 }, { 0, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(10, 30), { { 0, 0, 10, 10 }, { 0, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(10, 16), { { 0, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(10, 14), { { 0, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(20, 20), { { 5, 0, 10, 10 }, { 5, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(20, 30), { { 5, 0, 10, 10 }, { 5, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(20, 16), { { 5, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(20, 14), { { 5, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(6, 20), { { -2, 0, 10, 10 }, { 0, 10, 6, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(6, 30), { { -2, 0, 10, 10 }, { 0, 10, 6, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(6, 16), { { -2, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(6, 14), { { -2, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(4, 20), { { -3, 0, 10, 10 }, { 0, 10, 4, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(4, 30), { { -3, 0, 10, 10 }, { 0, 10, 4, 10 } } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(4, 16), { { -3, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kMainDropOutCrossFlex, gfx::Size(4, 14), { { -3, 0, 10, 10 }, {} } },
    { LayoutOrientation::kVertical, kFlexUseHeightForWidth, gfx::Size(10, 20), { { 0, 0, 10, 10 }, { 0, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kFlexUseHeightForWidth, gfx::Size(20, 20), { { 5, 0, 10, 10 }, { 5, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kFlexUseHeightForWidth, gfx::Size(10, 30), { { 0, 0, 10, 10 }, { 0, 10, 10, 10 } } },
    { LayoutOrientation::kVertical, kFlexUseHeightForWidth, gfx::Size(8, 30), { { -1, 0, 10, 10 }, { 0, 10, 8, 12 } } },
    { LayoutOrientation::kVertical, kFlexUseHeightForWidth, gfx::Size(6, 20), { { -2, 0, 10, 10 }, { 0, 10, 6, 16 } } },
    { LayoutOrientation::kVertical, kFlexUseHeightForWidth, gfx::Size(4, 20), { { -3, 0, 10, 10 }, { 2, 10, 0, 20 } } },
};

} // anonymous namespace

class FlexLayoutDirectionalRuleTest : public FlexLayoutTest, public testing::WithParamInterface<DirectionalFlexRuleTestParam> { };
...
TEST_P(FlexLayoutDirectionalRuleTest, TestRules)
{
    ...
    child2->SetProperty(kFlexBehaviorKey,
        FlexSpecification(
            param.orientation, param.rules.min_main_rule, param.rules.max_main_rule, param.rules.use_height_for_width, param.rules.min_cross_rule));
    if (param.rules.use_height_for_width)
        child2->set_size_mode(MockView::SizeMode::kFixedArea);

    host_->SetSize(param.size);
    EXPECT_EQ(param.expected, GetChildBounds()) << " Params: " << param.ToString();
}

INSTANTIATE_TEST_SUITE_P(, FlexLayoutDirectionalRuleTest, testing::ValuesIn(DirectionalFlexRuleTestParamList));
