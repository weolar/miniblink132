...
public:
    ...
    // method.
    virtual gfx::Size GetPreferredSize(const View* host, const SizeBounds& available_size) const = 0;
    ...
    // external code.
    virtual void ViewVisibilitySet(View* host, View* view, bool old_visibility, bool new_visibility);
...
protected:
    ...
    virtual std::vector<raw_ptr<View, VectorExperimental>> GetChildViewsInPaintOrder(const View* host) const;
