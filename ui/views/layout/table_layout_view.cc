...
TableLayoutView& TableLayoutView::AddColumn(
    LayoutAlignment h_align, LayoutAlignment v_align, float horizontal_resize, TableLayout::ColumnSize size_type, int fixed_width, int min_width)
{
    table_layout_->AddColumn(h_align, v_align, horizontal_resize, size_type, fixed_width, min_width);
    return *this;
}

TableLayoutView& TableLayoutView::AddPaddingColumn(float horizontal_resize, int width)
{
    table_layout_->AddPaddingColumn(horizontal_resize, width);
    return *this;
}

TableLayoutView& TableLayoutView::AddRows(size_t n, float vertical_resize, int height)
{
    table_layout_->AddRows(n, vertical_resize, height);
    return *this;
}

TableLayoutView& TableLayoutView::AddPaddingRow(float vertical_resize, int height)
{
