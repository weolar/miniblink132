...
private:
    raw_ptr<TableLayout> table_layout_ = SetLayoutManager(std::make_unique<TableLayout>());
};

BEGIN_VIEW_BUILDER(VIEWS_EXPORT, TableLayoutView, View)
VIEW_BUILDER_METHOD(AddColumn, views::LayoutAlignment, views::LayoutAlignment, float, views::TableLayout::ColumnSize, int, int)
