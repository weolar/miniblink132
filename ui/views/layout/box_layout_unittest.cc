...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets(10), 20));
    EXPECT_EQ(gfx::Size(20, 20), layout->GetPreferredSize(host_.get()));
}

TEST_F(BoxLayoutTest, AlignmentHorizontal)
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal));
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kVertical));
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets::VH(20, 10)));
    View* v1 = new StaticSizedView(gfx::Size(10, 20));
    host_->AddChildView(v1);
    View* v2 = new StaticSizedView(gfx::Size(10, 10));
    host_->AddChildView(v2);
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets(7), 8));
    View* v1 = new StaticSizedView(gfx::Size(10, 20));
    host_->AddChildView(v1);
...
{
    host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets(10), 10));
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets(10), 10));
    View* v1 = new StaticSizedView(gfx::Size(20, 20));
    v1->SetVisible(false);
    host_->AddChildView(v1);
    View* v2 = new StaticSizedView(gfx::Size(10, 10));
...
TEST_F(BoxLayoutTest, UseHeightForWidth)
{
    ...
    layout->set_cross_axis_alignment(views::BoxLayout::CrossAxisAlignment::kStretch);
    View* v1 = new StaticSizedView(gfx::Size(20, 10));
    host_->AddChildView(v1);
...
TEST_F(BoxLayoutTest, EmptyPreferredSize)
{
    for (size_t i = 0; i < 2; i++) {
        BoxLayout::Orientation orientation = i == 0 ? BoxLayout::Orientation::kHorizontal : BoxLayout::Orientation::kVertical;
        host_->RemoveAllChildViews();
        host_->SetLayoutManager(std::make_unique<BoxLayout>(orientation, gfx::Insets(), 5));
...
{
    host_->RemoveAllChildViews();
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets(), 5));
    View* v1 = new StaticSizedView(gfx::Size());
    host_->AddChildView(v1);
    View* v2 = new StaticSizedView(gfx::Size(10, 10));
    host_->AddChildView(v2);
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kVertical, gfx::Insets(10), 10));
...
TEST_F(BoxLayoutTest, CrossAxisAlignmentVerticalChildHugePreferredWidth)
{
    ...
    host_->SetBounds(0, 0, 60, 100);
    const int available_height = host_->height() - layout->inside_border_insets().height();
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<views::BoxLayout>(BoxLayout::Orientation::kVertical));

    View* v1 = host_->AddChildView(std::make_unique<StaticSizedView>(gfx::Size(20, 20)));
    View* v2 = host_->AddChildView(std::make_unique<StaticSizedView>(gfx::Size(20, 20)));
    ...
    // default flex.
    v1->SetProperty(kBoxLayoutFlexKey, BoxLayoutFlexSpecification().WithWeight(2));
    HandleHostLayoutManagerChanges();
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets(), 0, true));
    View* v1 = new StaticSizedView(gfx::Size(20, 10));
    v1->SetProperty(kMarginsKey, gfx::Insets(5));
    host_->AddChildView(v1);
    View* v2 = new StaticSizedView(gfx::Size(20, 10));
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kVertical, gfx::Insets(), 0, true));
    View* v1 = new StaticSizedView(gfx::Size(20, 10));
    v1->SetProperty(kMarginsKey, gfx::Insets(5));
    host_->AddChildView(v1);
    View* v2 = new StaticSizedView(gfx::Size(20, 10));
...
{
    auto layout_owner = std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal);
    layout_owner->set_cross_axis_alignment(BoxLayout::CrossAxisAlignment::kCenter);
...
{
    auto layout_owner = std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets(), 0, true);
    layout_owner->set_cross_axis_alignment(BoxLayout::CrossAxisAlignment::kCenter);
    BoxLayout* layout = host_->SetLayoutManager(std::move(layout_owner));
    View* v1 = new StaticSizedView(gfx::Size(20, 10));
    v1->SetProperty(kMarginsKey, gfx::Insets::TLBR(5, 5, 4, 4));
...
{
    auto layout_owner = std::make_unique<BoxLayout>(BoxLayout::Orientation::kVertical);
    layout_owner->set_cross_axis_alignment(BoxLayout::CrossAxisAlignment::kCenter);
    BoxLayout* layout = host_->SetLayoutManager(std::move(layout_owner));
    View* v1 = new StaticSizedView(gfx::Size(20, 10));
...
{
    auto layout_owner = std::make_unique<BoxLayout>(BoxLayout::Orientation::kVertical, gfx::Insets(), 0, true);
    layout_owner->set_cross_axis_alignment(BoxLayout::CrossAxisAlignment::kCenter);
    BoxLayout* layout = host_->SetLayoutManager(std::move(layout_owner));
    View* v1 = new StaticSizedView(gfx::Size(20, 10));
    v1->SetProperty(kMarginsKey, gfx::Insets::TLBR(4, 5, 5, 3));
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kVertical, gfx::Insets(), -10));
    View* v1 = new StaticSizedView(gfx::Size(20, 20));
    host_->AddChildView(v1);
...
{
    BoxLayout* layout = host_->SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal, gfx::Insets()));
...
TEST_F(BoxLayoutTest, HeightIsAdjustedForInsufficientWidth)
{
    ...
    EXPECT_GT(layout->GetPreferredSize(host_.get(), SizeBounds(text_size.width(), {})).height(), text_size.height());
}
