...
FlexLayoutView::FlexLayoutView()
    ...
    , ignore_default_main_axis_margins_(layout_->ignore_default_main_axis_margins())
...
void FlexLayoutView::SetCrossAxisAlignment(LayoutAlignment cross_axis_alignment)
{
...
void FlexLayoutView::SetIncludeHostInsetsInLayout(bool include_host_insets_in_layout)
{
...
void FlexLayoutView::SetFlexAllocationOrder(FlexAllocationOrder flex_allocation_order)
{
...
DEFINE_ENUM_CONVERTERS(
    views::LayoutOrientation, { views::LayoutOrientation::kHorizontal, u"kHorizontal" }, { views::LayoutOrientation::kVertical, u"kVertical" })

DEFINE_ENUM_CONVERTERS(views::LayoutAlignment, { views::LayoutAlignment::kStart, u"kStart" }, { views::LayoutAlignment::kCenter, u"kCenter" },
    { views::LayoutAlignment::kEnd, u"kEnd" }, { views::LayoutAlignment::kStretch, u"kStretch" })

DEFINE_ENUM_CONVERTERS(views::FlexAllocationOrder, { views::FlexAllocationOrder::kNormal, u"kNormal" }, { views::FlexAllocationOrder::kReverse, u"kReverse" })
