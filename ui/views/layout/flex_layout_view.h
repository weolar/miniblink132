...
public:
    ...
    template <class T, class U> void SetDefault(const ui::ClassProperty<T>* key, U&& value)
    {
    ...
    template <class T, class U> void SetDefault(const ui::ClassProperty<T>* key, const U& value)
    {
        layout_->SetDefault(key, value);
        InvalidateLayout();
    }
