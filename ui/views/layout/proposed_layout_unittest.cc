...
TEST(ProposedLayoutTest, ProposedLayoutBetween_SimpleInterpolation)
{
    View view1;
    View view2;
    const ProposedLayout kLayout1 { { 10, 20 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, true, { 1, 12, 7, 8 } } } };
    const ProposedLayout kLayout2 { { 20, 10 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, true, { 11, 2, 3, 2 } } } };

    const ProposedLayout kExpected { { 15, 15 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, true, { 6, 7, 5, 5 } } } };
...
TEST(ProposedLayoutTest, ProposedLayoutBetween_OutOfOrder)
{
    View view1;
    View view2;
    const ProposedLayout kLayout1 { { 10, 20 }, { { &view2, true, { 1, 12, 7, 8 } }, { &view1, true, { 3, 4, 5, 6 } } } };
    const ProposedLayout kLayout2 { { 20, 10 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, true, { 11, 2, 3, 2 } } } };
...
TEST(ProposedLayoutTest, ProposedLayoutBetween_ViewBecomesInvisible)
{
    ...
    View view2;
    const ProposedLayout kLayout1 { { 10, 20 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, true, { 1, 12, 7, 8 } } } };
    const ProposedLayout kLayout2 { { 20, 10 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, false } } };

    const ProposedLayout kExpected { { 15, 15 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, false } } };
    EXPECT_EQ(kExpected, ProposedLayoutBetween(0.5, kLayout1, kLayout2));
}
...
TEST(ProposedLayoutTest, ProposedLayoutBetween_ViewBecomesVisible)
{
    View view1;
    View view2;
    const ProposedLayout kLayout1 { { 10, 20 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, false, { 1, 12, 7, 8 } } } };
    const ProposedLayout kLayout2 { { 20, 10 }, { { &view1, true, { 3, 4, 5, 6 } }, { &view2, true, { 11, 2, 3, 2 } } } };
...
{
    View view1;
    const ProposedLayout kLayout1 { { 10, 20 }, { { &view1, true, { 3, 4, 5, 6 }, { 4, 8 } } } };
    const ProposedLayout kLayout2 { { 20, 10 }, { { &view1, true, { 3, 4, 5, 6 }, { 10, 2 } } } };
