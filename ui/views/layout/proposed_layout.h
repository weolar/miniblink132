...
struct VIEWS_EXPORT ProposedLayout {
    ...
    ProposedLayout(const gfx::Size& size, const std::initializer_list<ChildLayout>& children);
...
VIEWS_EXPORT ProposedLayout ProposedLayoutBetween(double value, const ProposedLayout& start, const ProposedLayout& target);
