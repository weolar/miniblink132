...
public:
    explicit MinSizeView(const gfx::Size& min_size)
        : min_size_(min_size)
    {
    }
...
std::unique_ptr<MinSizeView> CreateViewWithMinAndPref(const gfx::Size& min, const gfx::Size& pref)
{
...
public:
    ...
    {
        layout_->AddColumn(alignment, alignment, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0).AddRows(1, 1.0f);
...
{
    layout()
        .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
...
TEST_F(TableLayoutTest, LinkedSizes)
{
    // Fill widths.
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
...
TEST_F(TableLayoutTest, ColSpan1)
{
    layout()
        .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
...
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 10, 0)
        .AddRows(1, TableLayout::kFixedSize);
    auto* v1 = host()->AddChildView(CreateSizedView(gfx::Size(10, 10)));
...
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStart, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStart, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(1, TableLayout::kFixedSize);
    auto* v1 = host()->AddChildView(CreateSizedView(gfx::Size(50, 20)));
    auto* v2 = host()->AddChildView(CreateSizedView(gfx::Size(10, 10)));
...
TEST_F(TableLayoutTest, HorizontalResizeTest2)
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStart, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kEnd, LayoutAlignment::kStart, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(1, TableLayout::kFixedSize);
    auto* v1 = host()->AddChildView(CreateSizedView(gfx::Size(50, 20)));
    auto* v2 = host()->AddChildView(CreateSizedView(gfx::Size(10, 10)));
...
TEST_F(TableLayoutTest, HorizontalResizeTest3)
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStart, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStart, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kEnd, LayoutAlignment::kStart, TableLayout::kFixedSize, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(1, TableLayout::kFixedSize);
    auto* v1 = host()->AddChildView(CreateSizedView(gfx::Size(10, 10)));
    auto* v2 = host()->AddChildView(CreateSizedView(gfx::Size(10, 10)));
...
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(1, 1.0f)
        .AddRows(1, TableLayout::kFixedSize);
    auto* v1 = host()->AddChildView(CreateSizedView(gfx::Size(50, 20)));
    auto* v2 = host()->AddChildView(CreateSizedView(gfx::Size(10, 10)));
...
TEST_F(TableLayoutTest, FixedSize)
{
    ...
    for (size_t i = 0; i < kColumnCount; ++i) {
        layout().AddColumn(
            LayoutAlignment::kCenter, LayoutAlignment::kCenter, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, kTitleWidth, kTitleWidth);
    }
    ...
    for (size_t row = 0; row < kRowCount; ++row) {
        for (size_t column = 0; column < kColumnCount; ++column, ++i) {
            ExpectViewBoundsEquals(2 + kTitleWidth * column + (kTitleWidth - kPrefWidth) / 2, 2 + kPrefHeight * row, kPrefWidth, kPrefHeight, *i);
        }
    }

    EXPECT_EQ(gfx::Size(kColumnCount * kTitleWidth + 4, kRowCount * kPrefHeight + 4), GetPreferredSize());
}

TEST_F(TableLayoutTest, RowSpanWithPaddingRow)
{
    layout()
        .AddColumn(LayoutAlignment::kCenter, LayoutAlignment::kCenter, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 10, 10)
        .AddRows(1, TableLayout::kFixedSize)
...
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kCenter, 2.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kCenter, 4.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(2, TableLayout::kFixedSize);
...
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kCenter, 1.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kCenter, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 10, 0)
        .AddRows(2, TableLayout::kFixedSize);
    View* span_view = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(20, 40), gfx::Size(80, 40)));
    span_view->SetProperty(kTableColAndRowSpanKey, gfx::Size(2, 1));
...
TEST_F(TableLayoutTest, ColumnSpanResizing3)
{
    layout()
        ...
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kCenter, TableLayout::kFixedSize, TableLayout::ColumnSize::kFixed, 10, 0)
        .AddRows(2, TableLayout::kFixedSize);
    View* span_view = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(0, 40), gfx::Size(80, 40)));
    span_view->SetProperty(kTableColAndRowSpanKey, gfx::Size(2, 1));

    auto* view1 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(0, 40), gfx::Size(1, 40)));
    auto* view2 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(0, 40), gfx::Size(1, 40)));
...
TEST_F(TableLayoutTest, ColumnMinForcesPreferredWidth)
{
    ...
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 5.0f, TableLayout::ColumnSize::kUsePreferred, 0, 100)
        .AddRows(1, TableLayout::kFixedSize);
    host()->AddChildView(CreateSizedView(gfx::Size(20, 10)));
...
TEST_F(TableLayoutTest, HonorsColumnMin)
{
    ...
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 5.0f, TableLayout::ColumnSize::kUsePreferred, 0, 100)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 5.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(1, TableLayout::kFixedSize);
    View* view1 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(10, 10), gfx::Size(125, 10)));
    View* view2 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(10, 10), gfx::Size(50, 10)));
...
TEST_F(TableLayoutTest, TwoViewsOneSizeSmallerThanMinimum)
{
    ...
    layout()
        ...
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 5.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(1, TableLayout::kFixedSize);
    View* view1 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(20, 10), gfx::Size(100, 10)));
    View* view2 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(100, 10), gfx::Size(100, 10)));
...
TEST_F(TableLayoutTest, TwoViewsBothSmallerThanMinimumDifferentResizeWeights)
{
    ...
    // resizable.
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 8.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 2.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddRows(1, TableLayout::kFixedSize);
    View* view1 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(91, 10), gfx::Size(100, 10)));
    View* view2 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(10, 10), gfx::Size(100, 10)));
...
TEST_F(TableLayoutTest, TwoViewsOneColumnUsePrefOtherFixed)
{
    layout()
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 8.0f, TableLayout::ColumnSize::kUsePreferred, 0, 0)
        .AddColumn(LayoutAlignment::kStretch, LayoutAlignment::kStretch, 2.0f, TableLayout::ColumnSize::kFixed, 100, 0)
        .AddRows(1, TableLayout::kFixedSize);
    View* view1 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(10, 10), gfx::Size(100, 10)));
    View* view2 = host()->AddChildView(CreateViewWithMinAndPref(gfx::Size(10, 10), gfx::Size(100, 10)));
