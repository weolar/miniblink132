...
public:
    ...
    using PropCallback = base::RepeatingCallback<void(const std::string&, const std::string&)>;
...
void PrintViewHierarchy(std::ostream* out, ViewDebugWrapper* view, bool verbose = false, int depth = -1, size_t column_limit = 240);
