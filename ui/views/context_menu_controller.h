...
public:
    ...
    void ShowContextMenuForView(View* source, const gfx::Point& point, ui::mojom::MenuSourceType source_type);
...
private:
    ...
    virtual void ShowContextMenuForViewImpl(View* source, const gfx::Point& point, ui::mojom::MenuSourceType source_type) = 0;
