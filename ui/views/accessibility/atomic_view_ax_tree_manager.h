...
public:
    static std::unique_ptr<AtomicViewAXTreeManager> Create(ViewAXPlatformNodeDelegate* delegate, ui::AXNodeData node_data);
    friend std::unique_ptr<AtomicViewAXTreeManager> Create(ViewAXPlatformNodeDelegate* delegate, ui::AXNodeData node_data);
    ...
    ui::AXPlatformNode* GetPlatformNodeFromTree(ui::AXNodeID node_id) const override;
...
private:
    explicit AtomicViewAXTreeManager(ViewAXPlatformNodeDelegate* delegate, ui::AXNodeData node_data);
