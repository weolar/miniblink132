...
class VIEWS_EXPORT AXRootObjWrapper : public views::AXAuraObjWrapper, display::DisplayObserver {
public:
    AXRootObjWrapper(views::AXAuraObjCache::Delegate* delegate, views::AXAuraObjCache* cache);
    ...
    void GetChildren(std::vector<raw_ptr<views::AXAuraObjWrapper, VectorExperimental>>* out_children) override;
