...
void AXEventManager::NotifyViewEvent(views::View* view, ax::mojom::Event event_type)
{
    observers_.Notify(&AXEventObserver::OnViewEvent, view, event_type);
}

void AXEventManager::NotifyVirtualViewEvent(views::AXVirtualView* virtual_view, ax::mojom::Event event_type)
{
    observers_.Notify(&AXEventObserver::OnVirtualViewEvent, virtual_view, event_type);
}
