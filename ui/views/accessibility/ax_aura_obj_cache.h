...
public:
    ...
    public:
        ...
        virtual void OnEvent(AXAuraObjWrapper* aura_obj, ax::mojom::Event event_type) = 0;
    };
    ...
    void GetTopLevelWindows(std::vector<raw_ptr<AXAuraObjWrapper, VectorExperimental>>* children);
...
private:
    ...
    AXAuraObjWrapper* CreateInternal(AuraView* aura_view, std::map<AuraView*, ui::AXNodeID>* aura_view_to_id_map);

    template <typename AuraView> ui::AXNodeID GetIDInternal(AuraView* aura_view, const std::map<AuraView*, ui::AXNodeID>& aura_view_to_id_map) const;

    template <typename AuraView> void RemoveInternal(AuraView* aura_view, std::map<AuraView*, ui::AXNodeID>* aura_view_to_id_map);
