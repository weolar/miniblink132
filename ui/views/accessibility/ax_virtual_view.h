...
public:
    ...
    const AXVirtualViews& children() const
    {
        return children_;
    }
    ...
    const ViewAccessibility* parent_view() const
    {
        return parent_view_;
    }
    ViewAccessibility* parent_view()
    {
        return parent_view_;
    }
    ...
    AXVirtualView* virtual_parent_view()
    {
        return virtual_parent_view_;
    }
    ...
    void SetPopulateDataCallback(base::RepeatingCallback<void(ui::AXNodeData*)> callback);
    ...
    gfx::Rect GetBoundsRect(const ui::AXCoordinateSystem coordinate_system, const ui::AXClippingBehavior clipping_behavior,
