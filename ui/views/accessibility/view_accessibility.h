...
using IntAttributeCallbackList = base::RepeatingCallbackList<void(ax::mojom::IntAttribute, std::optional<int>)>;
using StringAttributeCallbackList = base::RepeatingCallbackList<void(ax::mojom::StringAttribute, const std::optional<std::string>&)>;
using BoolAttributeCallbackList = base::RepeatingCallbackList<void(ax::mojom::BoolAttribute, std::optional<bool>)>;
using StateCallbackList = base::RepeatingCallbackList<void(ax::mojom::State, bool)>;
using IntListAttributeCallbackList = base::RepeatingCallbackList<void(ax::mojom::IntListAttribute, const std::optional<std::vector<int32_t>>&)>;
...
public:
    using AccessibilityEventsCallback = base::RepeatingCallback<void(const ui::AXPlatformNodeDelegate*, const ax::mojom::Event)>;
    ...
    void SetDescription(const std::string& description, const ax::mojom::DescriptionFrom description_from = ax::mojom::DescriptionFrom::kAriaDescription);
    void SetDescription(const std::u16string& description, const ax::mojom::DescriptionFrom description_from = ax::mojom::DescriptionFrom::kAriaDescription);
    ...
    void SetDefaultActionVerb(const ax::mojom::DefaultActionVerb default_action_verb);
    ...
    AXVirtualView* FocusedVirtualChild() const
    {
        return focused_virtual_child_;
    }
    ...
    void AddVirtualChildViewAt(std::unique_ptr<AXVirtualView> virtual_view, size_t index);

    // Removes |virtual_view| from this View. The virtual view's parent will
    // change to nullptr. Hands ownership back to the caller.
    std::unique_ptr<AXVirtualView> RemoveVirtualChildView(AXVirtualView* virtual_view);

    // Removes all the virtual children from this View.
    // The virtual views are deleted.
    void RemoveAllVirtualChildViews();

    const AXVirtualViews& virtual_children() const
    {
        return virtual_children_;
    }
    ...
    bool propagate_focus_to_ancestor()
    {
        return propagate_focus_to_ancestor_;
    }

    // If true, ensures an AtomicViewAXTreeManager is created for this view.
    void set_needs_ax_tree_manager(bool value)
    {
        needs_ax_tree_manager_ = value;
    }

    bool needs_ax_tree_manager()
    {
        return needs_ax_tree_manager_;
    }
    ...
    // };
    base::CallbackListSubscription AddRoleChangedCallback(RoleCallbackList::CallbackType callback);
    base::CallbackListSubscription AddIntAttributeChangedCallback(ax::mojom::IntAttribute attribute, IntAttributeCallbackList::CallbackType callback);
    base::CallbackListSubscription AddStringAttributeChangedCallback(ax::mojom::StringAttribute attribute, StringAttributeCallbackList::CallbackType callback);
    base::CallbackListSubscription AddBoolAttributeChangedCallback(ax::mojom::BoolAttribute attribute, BoolAttributeCallbackList::CallbackType callback);
    base::CallbackListSubscription AddStateChangedCallback(ax::mojom::State state, StateCallbackList::CallbackType callback);
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(ViewTest, WidgetObserverViewWidgetClosedViewReparented);
    ...
    void OnIntAttributeChanged(ax::mojom::IntAttribute attribute, std::optional<int> value);
    void OnStringAttributeChanged(ax::mojom::StringAttribute attribute, const std::optional<std::string>& value);
    void OnBoolAttributeChanged(ax::mojom::BoolAttribute attribute, std::optional<bool> value);
    void OnStateChanged(ax::mojom::State state, bool is_enabled);
    void OnIntListAttributeChanged(ax::mojom::IntListAttribute attribute, const std::optional<std::vector<int>>& value);
    ...
    std::unique_ptr<ui::AXAttributeChangedCallbacks> attribute_changed_callbacks_ = nullptr;
...
public:
    explicit IgnoreMissingWidgetForTestingScopedSetter(ViewAccessibility& view_accessibility)
...
class ScopedAccessibilityEventBlocker {
public:
    explicit ScopedAccessibilityEventBlocker(ViewAccessibility& view_accessibility)
        : view_accessibility_(&view_accessibility)
    {
