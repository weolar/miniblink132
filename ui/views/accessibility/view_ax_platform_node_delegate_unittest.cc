...
public:
    explicit TestAXEventObserver(AXAuraObjCache* cache)
        : cache_(cache)
    {
...
public:
    ...
    ViewAXPlatformNodeDelegateTest(const ViewAXPlatformNodeDelegateTest&) = delete;
    ViewAXPlatformNodeDelegateTest& operator=(const ViewAXPlatformNodeDelegateTest&) = delete;
    ...
    void SetUp() override
    {
        ...
        button_ = widget_->GetRootView()->AddChildView(std::make_unique<TestButton>());
    ...
    {
        return static_cast<ViewAXPlatformNodeDelegate*>(&button_->GetViewAccessibility());
    }
    ...
    {
        return static_cast<ViewAXPlatformNodeDelegate*>(&view->GetViewAccessibility());
    }

    bool SetFocused(ViewAXPlatformNodeDelegate* ax_delegate, bool focused)
    {
        ui::AXActionData data;
        data.action = focused ? ax::mojom::Action::kFocus : ax::mojom::Action::kBlur;
    ...
    {
        View* parent_view = widget_->GetRootView()->AddChildView(std::make_unique<View>());
...
class ViewAXPlatformNodeDelegateTableTest : public ViewAXPlatformNodeDelegateTest {
public:
    void SetUp() override
    {
        ...
        auto table = std::make_unique<TableView>(model_.get(), columns, TableType::kIconAndText, true);
        table_ = table.get();
        widget_->GetRootView()->AddChildView(TableView::CreateScrollViewWithTable(std::move(table)));
    }
...
class ViewAXPlatformNodeDelegateMenuTest : public ViewAXPlatformNodeDelegateTest {
public:
    void SetUp() override
    {
        ViewAXPlatformNodeDelegateTest::SetUp();
        ...
        menu_->AppendMenuItemImpl(0, u"normal", ui::ImageModel(), MenuItemView::Type::kNormal);
        menu_->AppendMenuItemImpl(1, u"submenu", ui::ImageModel(), MenuItemView::Type::kSubMenu);
        menu_->AppendMenuItemImpl(2, u"actionable", ui::ImageModel(), MenuItemView::Type::kActionableSubMenu);
        menu_->AppendMenuItemImpl(3, u"checkbox", ui::ImageModel(), MenuItemView::Type::kCheckbox);
        menu_->AppendMenuItemImpl(4, u"radio", ui::ImageModel(), MenuItemView::Type::kRadio);
        menu_->AppendMenuItemImpl(5, u"separator", ui::ImageModel(), MenuItemView::Type::kSeparator);
        menu_->AppendMenuItemImpl(6, u"highlighted", ui::ImageModel(), MenuItemView::Type::kHighlighted);
        menu_->AppendMenuItemImpl(7, u"title", ui::ImageModel(), MenuItemView::Type::kTitle);
    ...
    void RunMenu()
    {
        runner_.get()->RunMenuAt(owner_.get(), nullptr, gfx::Rect(), MenuAnchorPosition::kTopLeft, ui::mojom::MenuSourceType::kNone);
    }
...
{
    gfx::Rect bounds = gfx::ToEnclosingRect(button_accessibility()->GetData().relative_bounds.bounds);
...
TEST_F(ViewAXPlatformNodeDelegateTest, LabelIsChildOfButton)
{
    ...
    EXPECT_EQ(label_->GetNativeViewAccessible(), button_accessibility()->ChildAtIndex(0));
    EXPECT_EQ(button_->GetNativeViewAccessible(), label_accessibility()->GetParent());
    EXPECT_EQ(ax::mojom::Role::kStaticText, label_accessibility()->GetRole());
}
...
TEST_F(ViewAXPlatformNodeDelegateTest, IsInvisibleOrIgnored)
{
    ...
    View* container = widget_->GetRootView()->AddChildView(std::make_unique<View>());
    View* test_button = container->AddChildView(std::make_unique<TestButton>());

    ViewAXPlatformNodeDelegate* container_accessibility = static_cast<ViewAXPlatformNodeDelegate*>(&container->GetViewAccessibility());
    ViewAXPlatformNodeDelegate* test_button_accessibility = static_cast<ViewAXPlatformNodeDelegate*>(&test_button->GetViewAccessibility());
...
TEST_F(ViewAXPlatformNodeDelegateTest, SetFocus)
{
    ...
    EXPECT_EQ(button_->GetNativeViewAccessible(), button_accessibility()->GetFocus());
...
TEST_F(ViewAXPlatformNodeDelegateTest, SetNameAndDescription)
{
    ...
    EXPECT_EQ(button_accessibility()->GetDescriptionFrom(), ax::mojom::DescriptionFrom::kNone);

    button_accessibility()->SetName("", ax::mojom::NameFrom::kAttributeExplicitlyEmpty);
    EXPECT_EQ(button_accessibility()->GetName(), "");
    EXPECT_EQ(button_accessibility()->GetNameFrom(), ax::mojom::NameFrom::kAttributeExplicitlyEmpty);

    button_accessibility()->SetDescription("", ax::mojom::DescriptionFrom::kAttributeExplicitlyEmpty);
    EXPECT_EQ(button_accessibility()->GetDescription(), "");
    EXPECT_EQ(button_accessibility()->GetDescriptionFrom(), ax::mojom::DescriptionFrom::kAttributeExplicitlyEmpty);
    ...
    EXPECT_EQ(button_accessibility()->GetDescriptionFrom(), ax::mojom::DescriptionFrom::kAriaDescription);
    ...
    label_accessibility()->SetName("Label's Name", ax::mojom::NameFrom::kContents);
    EXPECT_EQ(label_accessibility()->GetName(), "Label's Name");
    EXPECT_EQ(label_accessibility()->GetNameFrom(), ax::mojom::NameFrom::kContents);

    label_accessibility()->SetDescription("Label's description", ax::mojom::DescriptionFrom::kTitle);
    EXPECT_EQ(label_accessibility()->GetDescription(), "Label's description");
    EXPECT_EQ(label_accessibility()->GetDescriptionFrom(), ax::mojom::DescriptionFrom::kTitle);
    ...
    EXPECT_EQ(button_accessibility()->GetNameFrom(), ax::mojom::NameFrom::kRelatedElement);

    // Setting the labelledby View to itself should trigger a DCHECK.
    EXPECT_DCHECK_DEATH_WITH(button_accessibility()->SetName(*button_), "Check failed: view_ != &naming_view");
}
...
TEST_F(ViewAXPlatformNodeDelegateTest, SetIsSelected)
{
    ...
    EXPECT_FALSE(node_data_0.HasBoolAttribute(ax::mojom::BoolAttribute::kSelected));

    ui::AXNodeData node_data_1;
    view_ids[1]->GetViewAccessibility().GetAccessibleNodeData(&node_data_1);
    EXPECT_TRUE(node_data_1.HasBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    EXPECT_TRUE(node_data_1.GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));

    ui::AXNodeData node_data_2;
    view_ids[2]->GetViewAccessibility().GetAccessibleNodeData(&node_data_2);
    EXPECT_TRUE(node_data_2.HasBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    EXPECT_FALSE(node_data_2.GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
}
...
TEST_F(ViewAXPlatformNodeDelegateTest, TreeNavigation)
{
    ...
    EXPECT_EQ(view_accessibility(widget_->GetRootView())->GetNativeObject(), parent_view->GetParent());
    ...
    EXPECT_EQ(textfield_accessibility()->GetNativeObject(), parent_view->GetPreviousSibling());
    ...
    EXPECT_EQ(child_view_1->GetNativeObject(), child_view_2->GetPreviousSibling());
    ...
    EXPECT_EQ(child_view_2->GetNativeObject(), child_view_3->GetPreviousSibling());
    ...
    EXPECT_EQ(child_view_3->GetNativeObject(), child_view_4->GetPreviousSibling());
}
...
TEST_F(ViewAXPlatformNodeDelegateTest, TreeNavigationWithLeafViews)
{
    ...
    // 4 = ++++ChildView4
    View::Views extra_views = SetUpExtraViews();
    ViewAXPlatformNodeDelegate* contents_view = view_accessibility(widget_->GetRootView());
    ViewAXPlatformNodeDelegate* parent_view = view_accessibility(extra_views[0]);
    ViewAXPlatformNodeDelegate* child_view_1 = view_accessibility(extra_views[1]);
    ViewAXPlatformNodeDelegate* child_view_2 = view_accessibility(extra_views[2]);
    ViewAXPlatformNodeDelegate* child_view_3 = view_accessibility(extra_views[3]);
...
TEST_F(ViewAXPlatformNodeDelegateTest, TreeNavigationWithIgnoredViews)
{
    ...
    EXPECT_EQ(button_accessibility()->GetNativeObject(), contents_view->ChildAtIndex(0));
    ...
    EXPECT_EQ(textfield_accessibility()->GetNativeObject(), child_view_1->GetPreviousSibling());
    ...
    EXPECT_EQ(child_view_4->GetNativeObject(), child_view_3->GetNextSibling());
    EXPECT_EQ(child_view_1->GetNativeObject(), child_view_3->GetPreviousSibling());
...
TEST_F(ViewAXPlatformNodeDelegateTest, FocusOnMenuClose)
{
    ...
    ui::AXPlatformNodeBase::SetOnNotifyEventCallbackForTesting(ax::mojom::Event::kFocusAfterMenuClose, run_loop.QuitClosure());
...
TEST_F(ViewAXPlatformNodeDelegateTest, GetUnignoredSelection)
{
    ...
    textfield_->SetSelectedRange(gfx::Range(expected_anchor_offset, expected_focus_offset));

    ui::AXNodeID expected_id = textfield_accessibility()->GetData().id;
    const ui::AXSelection selection_1 = textfield_accessibility()->GetUnignoredSelection();
    ...
    const ui::AXSelection selection_2 = textfield_accessibility()->GetUnignoredSelection();
...
TEST_F(ViewAXPlatformNodeDelegateMenuTest, MenuTest)
{
    ...
    EXPECT_FALSE(normal_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    ...
    EXPECT_FALSE(submenu_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    ...
    ViewAXPlatformNodeDelegate* actionable_submenu_item = view_accessibility(items[2]);
    ...
    EXPECT_FALSE(actionable_submenu_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    ...
    EXPECT_EQ(actionable_submenu_item->GetData().GetHasPopup(), ax::mojom::HasPopup::kMenu);
    ...
    EXPECT_TRUE(checkbox_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    ...
    EXPECT_EQ(checkbox_item->GetData().GetHasPopup(), ax::mojom::HasPopup::kFalse);
    ...
    EXPECT_FALSE(radio_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    ...
    EXPECT_FALSE(separator_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    ...
    EXPECT_EQ(separator_item->GetData().GetHasPopup(), ax::mojom::HasPopup::kFalse);
    EXPECT_FALSE(separator_item->HasIntAttribute(ax::mojom::IntAttribute::kPosInSet));
    EXPECT_FALSE(separator_item->HasIntAttribute(ax::mojom::IntAttribute::kSetSize));
    ...
    EXPECT_FALSE(highlighted_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
    ...
    EXPECT_EQ(highlighted_item->GetData().GetHasPopup(), ax::mojom::HasPopup::kFalse);
    ...
    EXPECT_FALSE(title_item->GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
