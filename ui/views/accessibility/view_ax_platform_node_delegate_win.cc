...
gfx::NativeViewAccessible ViewAXPlatformNodeDelegateWin::GetParent() const
{
    ...
    IAccessible* parent;
    if (SUCCEEDED(::AccessibleObjectFromWindow(hwnd, OBJID_WINDOW, IID_IAccessible, reinterpret_cast<void**>(&parent)))) {
        return parent;
    }
...
gfx::AcceleratedWidget ViewAXPlatformNodeDelegateWin::GetTargetForNativeAccessibilityEvent()
{
    ...
    const ui::AXCoordinateSystem coordinate_system, const ui::AXClippingBehavior clipping_behavior, ui::AXOffscreenResult* offscreen_result) const
{
    ...
    case ui::AXCoordinateSystem::kScreenPhysicalPixels:
        return display::win::ScreenWin::DIPToScreenRect(HWNDForView(view()), view()->GetBoundsInScreen());
...
gfx::Rect ViewAXPlatformNodeDelegateWin::GetInnerTextRangeBoundsRect(const int start_offset, const int end_offset,
    const ui::AXCoordinateSystem coordinate_system, const ui::AXClippingBehavior clipping_behavior, ui::AXOffscreenResult* offscreen_result) const
{
    switch (coordinate_system) {
    case ui::AXCoordinateSystem::kScreenPhysicalPixels:
        return display::win::ScreenWin::DIPToScreenRect(HWNDForView(view()),
            ViewAXPlatformNodeDelegate::GetInnerTextRangeBoundsRect(
                start_offset, end_offset, ui::AXCoordinateSystem::kScreenDIPs, clipping_behavior, offscreen_result));
    case ui::AXCoordinateSystem::kScreenDIPs:
        return ViewAXPlatformNodeDelegate::GetInnerTextRangeBoundsRect(start_offset, end_offset, coordinate_system, clipping_behavior, offscreen_result);
    case ui::AXCoordinateSystem::kRootFrame:
    case ui::AXCoordinateSystem::kFrame:
        NOTIMPLEMENTED();
        return gfx::Rect();
...
gfx::Point ViewAXPlatformNodeDelegateWin::ScreenToDIPPoint(const gfx::Point& screen_point) const
{
    ...
    return ToRoundedPoint(display::win::ScreenWin::ScreenToDIPPoint(gfx::PointF(screen_point)));
}
...
void ViewAXPlatformNodeDelegateWin::EnsureAtomicViewAXTreeManager()
{
    ...
    atomic_view_ax_tree_manager_ = views::AtomicViewAXTreeManager::Create(this, data());
}
