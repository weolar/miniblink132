...
class VIEWS_EXPORT AXTreeSourceViews : public ui::AXTreeSource<AXAuraObjWrapper*, ui::AXTreeData*, ui::AXNodeData> {
public:
    AXTreeSourceViews(ui::AXNodeID root_id, const ui::AXTreeID& tree_id, AXAuraObjCache* cache);
    ...
    void SerializeNode(AXAuraObjWrapper* node, ui::AXNodeData* out_data) const override;
