...
public:
    ...
    void OnNameChanged(ax::mojom::StringAttribute attribute, const std::optional<std::string>& name)
    {
    ...
    void OnClassNameChanged(ax::mojom::StringAttribute attribute, const std::optional<std::string>& class_name)
    {
        ScopedAccessibilityEventBlocker blocker(GetViewAccessibility());
    ...
    void OnSelectedChanged(ax::mojom::BoolAttribute attribute, std::optional<bool> selected)
    {
    ...
    void OnPosInSetChanged(ax::mojom::IntAttribute attribute, std::optional<int> pos_in_set)
    {
    ...
    void OnCharacterOffsetsChanged(ax::mojom::IntListAttribute attribute, const std::optional<std::vector<int32_t>>& offsets)
    {
        ScopedAccessibilityEventBlocker blocker(GetViewAccessibility());
...
TEST_F(ViewAccessibilityTest, ViewUsesChildViewRole)
{
    base::CallbackListSubscription role_changed_subscription_
        = child_view()->GetViewAccessibility().AddRoleChangedCallback(base::BindRepeating(&TestView::OnRoleChanged, base::Unretained(view())));
...
TEST_F(ViewAccessibilityTest, ViewUsesChildViewName)
{
    view()->GetViewAccessibility().SetRole(ax::mojom::Role::kTextField);
    child_view()->GetViewAccessibility().SetRole(ax::mojom::Role::kButton);
    base::CallbackListSubscription name_changed_subscription_ = child_view()->GetViewAccessibility().AddStringAttributeChangedCallback(
        ax::mojom::StringAttribute::kName, base::BindRepeating(&TestView::OnNameChanged, base::Unretained(view())));
    base::CallbackListSubscription class_name_changed_subscription_ = child_view()->GetViewAccessibility().AddStringAttributeChangedCallback(
        ax::mojom::StringAttribute::kClassName, base::BindRepeating(&TestView::OnClassNameChanged, base::Unretained(view())));
    ...
    EXPECT_EQ(data_2.GetStringAttribute(ax::mojom::StringAttribute::kName), "My button");
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), data_2.GetString16Attribute(ax::mojom::StringAttribute::kName));
    ...
    child_view()->GetViewAccessibility().GetAccessibleNodeData(&data_2);
    EXPECT_EQ(data_2.GetStringAttribute(ax::mojom::StringAttribute::kName), "My button");
    EXPECT_EQ(data_2.GetStringAttribute(ax::mojom::StringAttribute::kClassName), "My class");
    EXPECT_EQ(data.GetStringAttribute(ax::mojom::StringAttribute::kClassName), data_2.GetStringAttribute(ax::mojom::StringAttribute::kClassName));
    EXPECT_EQ(data.GetString16Attribute(ax::mojom::StringAttribute::kName), data_2.GetString16Attribute(ax::mojom::StringAttribute::kName));
...
{
    base::CallbackListSubscription selected_changed_subscription_ = child_view()->GetViewAccessibility().AddBoolAttributeChangedCallback(
        ax::mojom::BoolAttribute::kSelected, base::BindRepeating(&TestView::OnSelectedChanged, base::Unretained(view())));
    child_view()->GetViewAccessibility().SetIsSelected(true);
    ui::AXNodeData data;
    ui::AXNodeData data_2;
    view()->GetViewAccessibility().GetAccessibleNodeData(&data);
    child_view()->GetViewAccessibility().GetAccessibleNodeData(&data_2);
    EXPECT_EQ(data.GetBoolAttribute(ax::mojom::BoolAttribute::kSelected), data_2.GetBoolAttribute(ax::mojom::BoolAttribute::kSelected));
}

TEST_F(ViewAccessibilityTest, ViewUsesChildViewEditable)
{
    base::CallbackListSubscription editable_changed_subscription_ = child_view()->GetViewAccessibility().AddStateChangedCallback(
        ax::mojom::State::kEditable, base::BindRepeating(&TestView::OnEditableChanged, base::Unretained(view())));
    child_view()->GetViewAccessibility().SetIsEditable(true);
    ui::AXNodeData data;
    ui::AXNodeData data_2;
    view()->GetViewAccessibility().GetAccessibleNodeData(&data);
    child_view()->GetViewAccessibility().GetAccessibleNodeData(&data_2);
    EXPECT_EQ(data.HasState(ax::mojom::State::kEditable), data_2.HasState(ax::mojom::State::kEditable));
}

TEST_F(ViewAccessibilityTest, ViewUsesChildViewPosInSet)
{
    base::CallbackListSubscription pos_in_set_changed_subscription_ = child_view()->GetViewAccessibility().AddIntAttributeChangedCallback(
        ax::mojom::IntAttribute::kPosInSet, base::BindRepeating(&TestView::OnPosInSetChanged, base::Unretained(view())));
    child_view()->GetViewAccessibility().SetPosInSet(1);
    ui::AXNodeData data;
    ui::AXNodeData data_2;
    view()->GetViewAccessibility().GetAccessibleNodeData(&data);
    child_view()->GetViewAccessibility().GetAccessibleNodeData(&data_2);
    EXPECT_EQ(data.GetIntAttribute(ax::mojom::IntAttribute::kPosInSet), data_2.GetIntAttribute(ax::mojom::IntAttribute::kPosInSet));
}

TEST_F(ViewAccessibilityTest, ViewUsesChildViewCharacterOffsets)
{
    base::CallbackListSubscription character_offsets_changed_subscription_ = child_view()->GetViewAccessibility().AddIntListAttributeChangedCallback(
        ax::mojom::IntListAttribute::kCharacterOffsets, base::BindRepeating(&TestView::OnCharacterOffsetsChanged, base::Unretained(view())));
    ...
    child_view()->GetViewAccessibility().GetAccessibleNodeData(&data_2);
    EXPECT_EQ(
        data.GetIntListAttribute(ax::mojom::IntListAttribute::kCharacterOffsets), data_2.GetIntListAttribute(ax::mojom::IntListAttribute::kCharacterOffsets));
}
...
TEST_F(ViewAccessibilityTest, LazyLoadingNoOverlap)
{
    ...
    lazy_loading_view->lazy_loading_data_.AddStringAttribute(ax::mojom::StringAttribute::kName, "My button");
    ...
    EXPECT_EQ(data.GetStringAttribute(ax::mojom::StringAttribute::kName), "My button");
}
...
TEST_F(ViewAccessibilityTest, LazyLoadingOverlapString)
{
    ...
    lazy_loading_view->lazy_loading_data_.AddStringAttribute(ax::mojom::StringAttribute::kName, "Lazy Name");
    lazy_loading_view->GetViewAccessibility().SetName("My button");
    EXPECT_DCHECK_DEATH(lazy_loading_view->GetViewAccessibility().CompleteCacheInitialization());
}
...
TEST_F(ViewAccessibilityTest, LazyLoadingOverlapBool)
{
    ...
    lazy_loading_view->lazy_loading_data_.AddBoolAttribute(ax::mojom::BoolAttribute::kSelected, true);
...
TEST_F(ViewAccessibilityTest, LazyLoadingOverlapInt)
{
    ...
    lazy_loading_view->lazy_loading_data_.AddIntAttribute(ax::mojom::IntAttribute::kPosInSet, 1);
...
TEST_F(ViewAccessibilityTest, LazyLoadingOverlapFloat)
{
    ...
    lazy_loading_view->lazy_loading_data_.AddFloatAttribute(ax::mojom::FloatAttribute::kChildTreeScale, 1.0f);
    lazy_loading_view->GetViewAccessibility().SetChildTreeID(ui::AXTreeID::CreateNewAXTreeID());
...
TEST_F(ViewAccessibilityTest, LazyLoadingOverlapIntList)
{
    ...
    lazy_loading_view->lazy_loading_data_.AddIntListAttribute(ax::mojom::IntListAttribute::kCharacterOffsets, list_1);
...
TEST_F(ViewAccessibilityTest, CantSetActionsInLazyLoading)
{
    ...
    lazy_loading_view->lazy_loading_data_.AddAction(ax::mojom::Action::kDoDefault);
    EXPECT_DCHECK_DEATH(lazy_loading_view->GetViewAccessibility().CompleteCacheInitialization());
}
...
TEST_F(ViewAccessibilityTest, CantSetRelativeBoundsInLazyLoading)
{
    ...
    lazy_loading_view->lazy_loading_data_.relative_bounds.bounds = relative_bounds;
    EXPECT_DCHECK_DEATH(lazy_loading_view->GetViewAccessibility().CompleteCacheInitialization());
}
