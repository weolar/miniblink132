...
public:
    ...
    FakeAXAuraObjCacheDelegate& operator=(const FakeAXAuraObjCacheDelegate&) = delete;
    ~FakeAXAuraObjCacheDelegate() override = default;

    void OnChildWindowRemoved(AXAuraObjWrapper* parent) override
    {
    }
    void OnEvent(AXAuraObjWrapper* aura_obj, ax::mojom::Event event_type) override
    {
...
public:
    ...
    AccessibilityAlertWindowTest& operator=(const AccessibilityAlertWindowTest&) = delete;
