...
TEST_F(AccessibilityPaintChecksTest, VerifyAccessibilityCheckerFailAndPass)
{
    ...
    Widget widget;
    Widget::InitParams params = Widget::InitParams(Widget::InitParams::CLIENT_OWNS_WIDGET, Widget::InitParams::TYPE_WINDOW);
    ...
    // Add the button.
    auto* button = widget.GetContentsView()->AddChildView(std::make_unique<ImageButton>());
    ...
    auto* generic_view = widget.GetContentsView()->AddChildView(std::make_unique<View>());
