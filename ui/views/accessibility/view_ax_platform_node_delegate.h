...
// APIs.
class VIEWS_EXPORT ViewAXPlatformNodeDelegate : public ViewAccessibility, public ui::AXPlatformNodeDelegate {
public:
    ViewAXPlatformNodeDelegate(const ViewAXPlatformNodeDelegate&) = delete;
    ViewAXPlatformNodeDelegate& operator=(const ViewAXPlatformNodeDelegate&) = delete;
    ...
    ui::AXNodePosition::AXPositionInstance CreatePositionAt(int offset, ax::mojom::TextAffinity affinity = ax::mojom::TextAffinity::kDownstream) const override;
    ui::AXNodePosition::AXPositionInstance CreateTextPositionAt(int offset, ax::mojom::TextAffinity affinity) const override;
    ...
    gfx::Rect GetBoundsRect(
        const ui::AXCoordinateSystem coordinate_system, const ui::AXClippingBehavior clipping_behavior, ui::AXOffscreenResult* offscreen_result) const override;
    gfx::Rect GetInnerTextRangeBoundsRect(const int start_offset, const int end_offset, const ui::AXCoordinateSystem coordinate_system,
        const ui::AXClippingBehavior clipping_behavior, ui::AXOffscreenResult* offscreen_result) const override;
    ...
    ui::AXPlatformNode* GetFromTreeIDAndNodeID(const ui::AXTreeID& ax_tree_id, int32_t id) override;
    ...
    gfx::RectF RelativeToContainerBounds(const gfx::RectF& bounds, ui::AXOffscreenResult* offscreen_result) const;

    AtomicViewAXTreeManager* GetAtomicViewAXTreeManagerForTesting() const override;
...
private:
    ...
    struct ChildWidgetsResult final {
        ChildWidgetsResult();
        ChildWidgetsResult(std::vector<raw_ptr<Widget, VectorExperimental>> child_widgets, bool is_tab_modal_showing);
    ...
    void GetViewsInGroupForSet(std::vector<raw_ptr<View, VectorExperimental>>* views_in_group) const;
