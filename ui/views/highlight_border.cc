...
void HighlightBorder::PaintBorderToCanvas(
    gfx::Canvas* canvas, SkColor highlight_color, SkColor border_color, const gfx::Rect& bounds, const gfx::RoundedCornersF& corner_radii, Type type)
{
    cc::PaintFlags flags;
    ...
    const SkScalar radii[8]
        = { corner_radii.upper_left() * dsf, corner_radii.upper_left() * dsf, corner_radii.upper_right() * dsf, corner_radii.upper_right() * dsf,
              corner_radii.lower_right() * dsf, corner_radii.lower_right() * dsf, corner_radii.lower_left() * dsf, corner_radii.lower_left() * dsf };
...
// static
void HighlightBorder::PaintBorderToCanvas(
    gfx::Canvas* canvas, const views::View& view, const gfx::Rect& bounds, const gfx::RoundedCornersF& corner_radii, Type type)
{
    PaintBorderToCanvas(canvas, GetHighlightColor(view, type), GetBorderColor(view, type), bounds, corner_radii, type);
}

// static
SkColor HighlightBorder::GetHighlightColor(const views::View& view, HighlightBorder::Type type)
{
...
// static
SkColor HighlightBorder::GetBorderColor(const views::View& view, HighlightBorder::Type type)
{
...
HighlightBorder::HighlightBorder(int corner_radius, Type type, InsetsType insets_type)
    : HighlightBorder(gfx::RoundedCornersF(corner_radius), type, insets_type)
{
}

HighlightBorder::HighlightBorder(const gfx::RoundedCornersF& rounded_corners, Type type, InsetsType insets_type)
...
{
    PaintBorderToCanvas(canvas, view, view.GetLocalBounds(), rounded_corners_, type_);
}
...
{
    return gfx::Size(kHighlightBorderThickness * 4, kHighlightBorderThickness * 4);
}
