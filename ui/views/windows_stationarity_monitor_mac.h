...
class WindowsStationarityMonitorMac : public WindowsStationarityMonitor, WidgetObserver {
public:
    WindowsStationarityMonitorMac();

    WindowsStationarityMonitorMac(const WindowsStationarityMonitorMac&) = delete;
    WindowsStationarityMonitorMac& operator=(const WindowsStationarityMonitorMac&) = delete;
