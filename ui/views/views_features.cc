...
BASE_FEATURE(kEnablePlatformHighContrastInkDrop, "EnablePlatformHighContrastInkDrop", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kEnableTouchDragCursorSync, "EnableTouchDragCursorSync", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kEnableViewPaintOptimization, "EnableViewPaintOptimization", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kKeyboardAccessibleTooltipInViews, "KeyboardAccessibleTooltipInViews", base::FEATURE_ENABLED_BY_DEFAULT);

// Used to enable additional a11y attributes when announcing text.
BASE_FEATURE(kAnnounceTextAdditionalAttributes, "AnnounceTextAdditionalAttributes", base::FEATURE_ENABLED_BY_DEFAULT);
