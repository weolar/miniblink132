...
// touch interface.
class VIEWS_EXPORT TouchSelectionControllerImpl : public TouchSelectionController,
...
public:
    ...
    TouchSelectionControllerImpl& operator=(const TouchSelectionControllerImpl&) = delete;
...
private:
    ...
    void SetHandleBound(EditingHandleView* handle, const gfx::SelectionBound& bound, const gfx::SelectionBound& bound_in_screen);
