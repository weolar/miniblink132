...
class VIEWS_EXPORT TouchSelectionMenuRunnerViews : public ui::TouchSelectionMenuRunner {
public:
    ...
    public:
        ...
        Widget* GetWidget();
        void ShowMenu(TouchSelectionMenuViews* menu, const gfx::Rect& anchor_rect, const gfx::Size& handle_image_size);
    ...
    TouchSelectionMenuRunnerViews& operator=(const TouchSelectionMenuRunnerViews&) = delete;
...
protected:
    ...
    bool IsMenuAvailable(const ui::TouchSelectionMenuClient* client) const override;
    void CloseMenu() override;
    void OpenMenu(
        base::WeakPtr<ui::TouchSelectionMenuClient> client, const gfx::Rect& anchor_rect, const gfx::Size& handle_image_size, aura::Window* context) override;
