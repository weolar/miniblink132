...
public:
    ...
    TouchSelectionMenuViews(TouchSelectionMenuRunnerViews* owner, base::WeakPtr<ui::TouchSelectionMenuClient> client, aura::Window* context);
    ...
    void ShowMenu(const gfx::Rect& anchor_rect, const gfx::Size& handle_image_size);
...
protected:
    ...
    LabelButton* CreateButton(const std::u16string& title, Button::PressedCallback callback);
