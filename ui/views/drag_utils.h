...
VIEWS_EXPORT void RunShellDrag(
    gfx::NativeView view, std::unique_ptr<ui::OSExchangeData> data, const gfx::Point& location, int operation, ui::mojom::DragEventSource source);
...
VIEWS_EXPORT void CancelShellDrag(gfx::NativeView view, bool allow_widget_mismatch = false);
