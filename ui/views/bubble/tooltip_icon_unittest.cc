...
TEST_F(TooltipIconTest, AccessibleRoleAndName)
{
    ...
    std::unique_ptr<views::TooltipIcon> tooltip = std::make_unique<views::TooltipIcon>(tooltip_text, 12);

    IgnoreMissingWidgetForTestingScopedSetter a11y_ignore_missing_widget_(tooltip->GetViewAccessibility());
