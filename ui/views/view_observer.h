...
public:
    ...
    virtual void OnViewVisibilityChanged(View* observed_view, View* starting_view)
    {
    }
    ...
    virtual void OnViewHierarchyChanged(View* observed_view, const ViewHierarchyChangedDetails& details)
    {
    }
    ...
    virtual void OnViewPropertyChanged(View* observed_view, const void* key, int64_t old_value)
    {
    }
