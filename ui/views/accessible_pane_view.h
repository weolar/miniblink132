...
// to this pane.
class VIEWS_EXPORT AccessiblePaneView : public View, public FocusChangeListener, public FocusTraversable {
...
public:
    ...
    bool pane_has_focus() const
    {
        return pane_has_focus_;
    }
    ...
    // For testing only.
    const ui::Accelerator& home_key() const
    {
        return home_key_;
    }
    const ui::Accelerator& end_key() const
    {
        return end_key_;
    }
    const ui::Accelerator& escape_key() const
    {
        return escape_key_;
    }
    const ui::Accelerator& left_key() const
    {
        return left_key_;
    }
    const ui::Accelerator& right_key() const
    {
        return right_key_;
    }
...
protected:
    ...
    FocusManager* focus_manager() const
    {
