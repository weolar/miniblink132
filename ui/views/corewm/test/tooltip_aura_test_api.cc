...
gfx::Rect TooltipAuraTestApi::GetTooltipBounds(const gfx::Size& tooltip_size, const gfx::Point& anchor_point, const TooltipTrigger trigger)
{
    ui::OwnedWindowAnchor anchor;
    return tooltip_aura_->GetTooltipBounds(tooltip_size, anchor_point, trigger, &anchor);
}
