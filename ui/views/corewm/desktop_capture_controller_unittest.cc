...
public:
    ...
    bool received_gesture_event() const
    {
        return received_gesture_event_;
    }
...
std::unique_ptr<views::Widget> CreateWidget()
{
    ...
    views::Widget::InitParams params(views::Widget::InitParams::CLIENT_OWNS_WIDGET, views::Widget::InitParams::TYPE_WINDOW_FRAMELESS);
...
TEST_F(DesktopCaptureControllerTest, CaptureWindowInputEventTest)
{
    ...
    std::unique_ptr<wm::ScopedCaptureClient> scoped_capture_client(new wm::ScopedCaptureClient(params.context->GetRootWindow()));
    aura::client::CaptureClient* capture_client = wm::CaptureController::Get();
    params.bounds = gfx::Rect(50, 50, 650, 650);
    params.native_widget = test::CreatePlatformNativeWidgetImpl(widget1.get(), test::kStubCapture, nullptr);
    desktop_position_client1 = std::make_unique<DesktopScreenPositionClient>(params.context->GetRootWindow());
    widget1->Init(std::move(params));
    internal::RootView* root1 = static_cast<internal::RootView*>(widget1->GetRootView());
    aura::client::SetScreenPositionClient(widget1->GetNativeView()->GetRootWindow(), desktop_position_client1.get());
    ...
    params.bounds = gfx::Rect(50, 50, 650, 650);
    params.native_widget = test::CreatePlatformNativeWidgetImpl(widget2.get(), test::kStubCapture, nullptr);
    desktop_position_client2 = std::make_unique<DesktopScreenPositionClient>(params.context->GetRootWindow());
    widget2->Init(std::move(params));
    internal::RootView* root2 = static_cast<internal::RootView*>(widget2->GetRootView());
    aura::client::SetScreenPositionClient(widget2->GetNativeView()->GetRootWindow(), desktop_position_client2.get());
    ...
    ui::GestureEvent g1(80, 80, 0, base::TimeTicks(), ui::GestureEventDetails(ui::EventType::kGestureLongPress));
