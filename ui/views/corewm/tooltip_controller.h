...
// tooltip state.
class VIEWS_EXPORT TooltipController : public wm::TooltipClient,
                                       public ui::EventHandler,
                                       public aura::client::CursorClientObserver,
                                       public aura::WindowObserver,
                                       public wm::ActivationChangeObserver {
public:
    TooltipController(std::unique_ptr<Tooltip> tooltip, wm::ActivationClient* activation_client);
    ...
    void UpdateTooltipFromKeyboard(const gfx::Rect& bounds, aura::Window* target) override;
    bool IsTooltipSetFromKeyboard(aura::Window* target) override;
    void SetHideTooltipTimeout(aura::Window* target, base::TimeDelta timeout) override;
    ...
    void UpdateTooltipFromKeyboardWithAnchorPoint(const gfx::Point& anchor_point, aura::Window* target);
...
private:
    ...
    // keyboard.
    void ResetWindowAtMousePressedIfNeeded(aura::Window* target, bool force_reset);
