...
public:
    ...
    using TooltipViewFactory = base::RepeatingCallback<std::unique_ptr<TooltipViewAura>(void)>;
...
private:
    ...
    gfx::Rect GetTooltipBounds(const gfx::Size& tooltip_size, const gfx::Point& anchor_point, const TooltipTrigger trigger, ui::OwnedWindowAnchor* anchor);
    ...
    void CreateTooltipWidget(const gfx::Rect& bounds, const ui::OwnedWindowAnchor& anchor);
