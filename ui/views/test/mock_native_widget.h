...
public:
    ...
    MOCK_METHOD(std::unique_ptr<NonClientFrameView>, CreateNonClientFrameView, (), (override));
    ...
    MOCK_METHOD(void, SetNativeWindowProperty, (const char* name, void* value), (override));
    MOCK_METHOD(void*, GetNativeWindowProperty, (const char* name), (const override));
    ...
    MOCK_METHOD(void, GetWindowPlacement, (gfx::Rect * bounds, ui::mojom::WindowShowState* show_state), (const override));
    MOCK_METHOD(bool, SetWindowTitle, (const std::u16string& title), (override));
    MOCK_METHOD(void, SetWindowIcons, (const gfx::ImageSkia& window_icon, const gfx::ImageSkia& app_icon), (override));
    MOCK_METHOD(void, InitModalType, (ui::mojom::ModalType modal_type), (override));
    ...
    MOCK_METHOD(void, SetBoundsConstrained, (const gfx::Rect& bounds), (override));
    ...
    MOCK_METHOD(void, SetShape, (std::unique_ptr<Widget::ShapeRects> shape), (override));
    MOCK_METHOD(void, Close, (), (override));
    MOCK_METHOD(void, CloseNow, (), (override));
    MOCK_METHOD(void, Show, (ui::mojom::WindowShowState show_state, const gfx::Rect& restore_bounds), (override));
    ...
    MOCK_METHOD(void, SetVisibleOnAllWorkspaces, (bool always_visible), (override));
    ...
    MOCK_METHOD(void, SetFullscreen, (bool fullscreen, int64_t target_display_id), (override));
    MOCK_METHOD(bool, IsFullscreen, (), (const override));
    MOCK_METHOD(void, SetCanAppearInExistingFullscreenSpaces, (bool can_appear_in_existing_fullscreen_spaces), (override));
    MOCK_METHOD(void, SetOpacity, (float opacity), (override));
    MOCK_METHOD(void, SetAspectRatio, (const gfx::SizeF& aspect_ratio, const gfx::Size& excluded_margin), (override));
    MOCK_METHOD(void, FlashFrame, (bool flash), (override));
    MOCK_METHOD(void, RunShellDrag, (std::unique_ptr<ui::OSExchangeData> data, const gfx::Point& location, int operation, ui::mojom::DragEventSource source),
        (override));
    ...
    MOCK_METHOD(Widget::MoveLoopResult, RunMoveLoop,
    ...
    MOCK_METHOD(void, SetVisibilityChangedAnimationsEnabled, (bool value), (override));
    MOCK_METHOD(void, SetVisibilityAnimationDuration, (const base::TimeDelta& duration), (override));
    MOCK_METHOD(void, SetVisibilityAnimationTransition, (Widget::VisibilityTransition transition), (override));
