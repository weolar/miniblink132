...
public:
    ...
    void SetFontDetails(int context, int style, const ui::ResourceBundle::FontDetails& details);
    ...
    // TypographyProvider:
    ui::ResourceBundle::FontDetails GetFontDetailsImpl(int context, int style) const override;
