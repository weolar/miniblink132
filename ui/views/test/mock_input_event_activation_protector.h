...
public:
    ...
    MockInputEventActivationProtector(const MockInputEventActivationProtector&) = delete;
    MockInputEventActivationProtector& operator=(const MockInputEventActivationProtector&) = delete;

    MOCK_METHOD(bool, IsPossiblyUnintendedInteraction, (const ui::Event& event), (override));
};
