...
void FocusManagerTest::TearDown()
{
    ...
    if (widget_focus_change_listener_) {
        WidgetFocusManager::GetInstance()->RemoveFocusChangeListener(widget_focus_change_listener_);
    }
    GetWidget()->Close();
...
void FocusManagerTest::RemoveFocusChangeListener(FocusChangeListener* listener)
{
...
void FocusManagerTest::AddWidgetFocusChangeListener(WidgetFocusChangeListener* listener)
{
...
void FocusManagerTest::RemoveWidgetFocusChangeListener(WidgetFocusChangeListener* listener)
{
...
void FocusManagerTest::SetAccessiblePanes(const std::vector<raw_ptr<View, VectorExperimental>>& panes)
{
...
void TestFocusChangeListener::OnWillChangeFocus(View* focused_before, View* focused_now)
{
    focus_changes_.emplace_back(focused_before, focused_now);
}
void TestFocusChangeListener::OnDidChangeFocus(View* focused_before, View* focused_now)
{
}
...
void TestWidgetFocusChangeListener::OnNativeFocusChanged(gfx::NativeView focused_now)
{
