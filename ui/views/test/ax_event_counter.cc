...
void AXEventCounter::OnViewEvent(views::View* view, ax::mojom::Event event_type)
{
...
int AXEventCounter::GetCount(ax::mojom::Event event_type, ax::mojom::Role role) const
{
    return event_counts_for_role_[std::make_pair(event_type, role)];
}

int AXEventCounter::GetCount(ax::mojom::Event event_type, views::View* view) const
{
