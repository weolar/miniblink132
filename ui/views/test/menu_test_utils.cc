...
bool TestMenuDelegate::ShowContextMenu(MenuItemView* source, int id, const gfx::Point& p, ui::mojom::MenuSourceType source_type)
{
...
views::View::DropCallback TestMenuDelegate::GetDropCallback(MenuItemView* menu, DropPosition position, const ui::DropTargetEvent& event)
{
...
void TestMenuDelegate::WriteDragData(MenuItemView* sender, OSExchangeData* data)
{
}
...
bool TestMenuDelegate::ShouldExecuteCommandWithoutClosingMenu(int id, const ui::Event& e)
{
