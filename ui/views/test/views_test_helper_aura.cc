...
{
    aura_test_helper_ = g_helper_factory ? (*g_helper_factory)() : std::make_unique<aura::test::AuraTestHelper>();
}
...
std::unique_ptr<TestViewsDelegate> ViewsTestHelperAura::GetFallbackTestViewsDelegate()
{
    // The factory delegate takes priority over the parent default.
    return g_delegate_factory ? (*g_delegate_factory)() : ViewsTestHelper::GetFallbackTestViewsDelegate();
}
...
// static
void ViewsTestHelperAura::SetAuraTestHelperFactory(AuraTestHelperFactory factory)
{
...
// static
void ViewsTestHelperAura::SetFallbackTestViewsDelegateFactory(TestViewsDelegateFactory factory)
{
