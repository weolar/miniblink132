...
bool IsWidgetInShowState(Widget* widget, ui::mojom::WindowShowState show_state)
{
    switch (show_state) {
...
public:
    ...
    {
        CHECK(show_state == ui::mojom::WindowShowState::kMinimized || show_state == ui::mojom::WindowShowState::kMaximized)
...
void WaitForWidgetShowState(Widget* widget, ui::mojom::WindowShowState show_state)
{
