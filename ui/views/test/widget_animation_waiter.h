...
class WidgetAnimationWaiter : public ui::LayerAnimationObserver, public views::WidgetObserver {
public:
...
private:
    ...
    base::ScopedObservation<ui::LayerAnimator, ui::LayerAnimationObserver> layer_animation_observation_ { this };
