...
public:
    ...
    DesktopWindowTreeHostWinTestApi(const DesktopWindowTreeHostWinTestApi&) = delete;
    DesktopWindowTreeHostWinTestApi& operator=(const DesktopWindowTreeHostWinTestApi&) = delete;
    ...
    LRESULT SimulatePenEventForTesting(UINT message, UINT32 pointer_id, POINTER_PEN_INFO pointer_pen_info);
