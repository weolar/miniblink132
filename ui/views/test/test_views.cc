...
gfx::Size StaticSizedView::CalculatePreferredSize(const SizeBounds& /*available_size*/) const
{
...
gfx::Size ProportionallySizedView::CalculatePreferredSize(const SizeBounds& available_size) const
{
...
{
    SetLayoutManager(std::make_unique<BoxLayout>(BoxLayout::Orientation::kHorizontal));
}
