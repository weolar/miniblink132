...
NativeWidget* CreatePlatformNativeWidgetImpl(Widget* widget, uint32_t behavior, bool* destroyed);
...
// destructor of the NativeWidget.
NativeWidget* CreatePlatformNativeWidgetImpl(Widget* widget, uint32_t behavior, base::OnceClosure destroyed_callback);
...
// NativeWidget.
NativeWidget* CreatePlatformDesktopNativeWidgetImpl(Widget* widget, uint32_t behavior, base::OnceClosure destroyed_callback);
