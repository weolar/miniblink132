...
class ViewFocusObserverByView final : public ViewFocusObserverBase, public ui::test::StateObserver<View*> {
public:
...
// has no identifier.
class ViewFocusObserverByIdentifier final : public ViewFocusObserverBase, public ui::test::StateObserver<ui::ElementIdentifier> {
public:
...
DECLARE_STATE_IDENTIFIER_VALUE(ViewFocusObserverByIdentifier, kCurrentFocusedViewId);
