...
public:
    TrackedElementViews(View* view, ui::ElementIdentifier identifier, ui::ElementContext context);
...
public:
    ...
    using ContextOverrideCallback = base::RepeatingCallback<ui::ElementContext(Widget* primary_widget)>;
    ...
    // assigned.
    TrackedElementViews* GetElementForView(View* view, bool assign_temporary_id = false);
    ...
    template <class T> T* GetUniqueViewAs(ui::ElementIdentifier id, ui::ElementContext context);
    ...
    View* GetFirstMatchingView(ui::ElementIdentifier id, ui::ElementContext context);
    ...
    template <class T> T* GetFirstMatchingViewAs(ui::ElementIdentifier id, ui::ElementContext context);
    ...
    ViewList GetAllMatchingViews(ui::ElementIdentifier id, ui::ElementContext context);
...
template <class T> T* ElementTrackerViews::GetUniqueViewAs(ui::ElementIdentifier id, ui::ElementContext context)
{
...
template <class T> T* ElementTrackerViews::GetFirstMatchingViewAs(ui::ElementIdentifier id, ui::ElementContext context)
{
