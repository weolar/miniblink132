...
public:
    ...
    static std::unique_ptr<ui::InteractionSequence::Step> WithInitialView(View* view,
        ui::InteractionSequence::StepStartCallback start_callback = ui::InteractionSequence::StepStartCallback(),
        ui::InteractionSequence::StepEndCallback end_callback = ui::InteractionSequence::StepEndCallback());
    ...
    static void NameView(ui::InteractionSequence* sequence, View* view, std::string_view name);
};
