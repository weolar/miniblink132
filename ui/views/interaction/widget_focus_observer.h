...
public:
    ...
    using WidgetFocusChangedCallback = base::RepeatingCallback<void(gfx::NativeView)>;
    base::CallbackListSubscription AddWidgetFocusChangedCallback(WidgetFocusChangedCallback callback);
...
public:
    ...
    using SupplierList = ui::FrameworkSpecificRegistrationList<WidgetFocusSupplier>;

    SupplierList& supplier_list()
    {
        return supplier_list_;
    }
