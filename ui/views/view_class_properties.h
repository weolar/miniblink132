...
//
// Used by FlexLayout.
VIEWS_EXPORT extern const ui::ClassProperty<gfx::Insets*>* const kInternalPaddingKey;
...
VIEWS_EXPORT extern const ui::ClassProperty<DialogDelegate*>* const kAnchoredDialogKey;
...
VIEWS_EXPORT extern const ui::ClassProperty<Widget*>* const kWidgetForAnchoringKey;

// A property to store how a view should flex when placed in a layout.
// Only supported by BoxLayout.
VIEWS_EXPORT extern const ui::ClassProperty<BoxLayoutFlexSpecification*>* const kBoxLayoutFlexKey;
...
VIEWS_EXPORT extern const ui::ClassProperty<HighlightPathGenerator*>* const kHighlightPathGeneratorKey;

// A property to store how a view should flex when placed in a layout.
// Currently only supported by FlexLayout.
VIEWS_EXPORT extern const ui::ClassProperty<FlexSpecification*>* const kFlexBehaviorKey;

VIEWS_EXPORT extern const ui::ClassProperty<LayoutAlignment*>* const kCrossAxisAlignmentKey;
...
// 3, not 2.
VIEWS_EXPORT extern const ui::ClassProperty<gfx::Size*>* const kTableColAndRowSpanKey;
VIEWS_EXPORT extern const ui::ClassProperty<LayoutAlignment*>* const kTableHorizAlignKey;
VIEWS_EXPORT extern const ui::ClassProperty<LayoutAlignment*>* const kTableVertAlignKey;
...
VIEWS_EXPORT extern const ui::ClassProperty<bool>* const kViewIgnoredByLayoutKey;

// Tag for the view associated with ui::ElementTracker.
VIEWS_EXPORT extern const ui::ClassProperty<ui::ElementIdentifier>* const kElementIdentifierKey;
...
DECLARE_EXPORTED_UI_CLASS_PROPERTY_TYPE(VIEWS_EXPORT, views::HighlightPathGenerator*)
