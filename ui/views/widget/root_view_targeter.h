...
public:
    RootViewTargeter(ViewTargeterDelegate* delegate, internal::RootView* root_view);
...
private:
    // ViewTargeter:
    View* FindTargetForGestureEvent(View* root, const ui::GestureEvent& gesture) override;
    ui::EventTarget* FindNextBestTargetForGestureEvent(ui::EventTarget* previous_target, const ui::GestureEvent& gesture) override;
