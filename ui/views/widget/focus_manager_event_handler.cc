...
FocusManagerEventHandler::FocusManagerEventHandler(Widget* widget, aura::Window* window)
...
{
    if (widget_ && widget_->GetFocusManager() && widget_->GetFocusManager()->GetFocusedView() && !widget_->GetFocusManager()->OnKeyEvent(*event)) {
