...
public:
    WindowEventFilterLinux(DesktopWindowTreeHostPlatform* desktop_window_tree_host, ui::WmMoveResizeHandler* handler);
...
private:
    ...
    void MaybeDispatchHostWindowDragMovement(int hittest, ui::LocatedEvent* event);
