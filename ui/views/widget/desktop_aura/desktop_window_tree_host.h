...
public:
    ...
    static DesktopWindowTreeHost* Create(internal::NativeWidgetDelegate* native_widget_delegate, DesktopNativeWidgetAura* desktop_native_widget_aura);
    ...
    // DesktopWindowTreeHost.
    virtual std::unique_ptr<aura::client::DragDropClient> CreateDragDropClient() = 0;

    // Creates the ScreenPositionClient to use for the WindowTreeHost. Default
    // implementation creates DesktopScreenPositionClient.
    virtual std::unique_ptr<aura::client::ScreenPositionClient> CreateScreenPositionClient();
