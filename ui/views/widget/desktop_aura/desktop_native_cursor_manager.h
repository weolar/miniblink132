...
public:
    ...
    DesktopNativeCursorManager& operator=(const DesktopNativeCursorManager&) = delete;
    ...
    virtual void InitCursorSizeObserver(wm::NativeCursorManagerDelegate* delegate);
