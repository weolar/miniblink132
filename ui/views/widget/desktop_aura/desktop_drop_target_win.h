...
class DesktopDropTargetWin : public ui::DropTargetWin, public aura::WindowObserver {
public:
...
private:
    ...
    DWORD OnDragEnter(IDataObject* data_object, DWORD key_state, POINT position, DWORD effect) override;
    DWORD OnDragOver(IDataObject* data_object, DWORD key_state, POINT position, DWORD effect) override;
    void OnDragLeave(IDataObject* data_object) override;
    DWORD OnDrop(IDataObject* data_object, DWORD key_state, POINT position, DWORD effect) override;
    ...
    void Translate(IDataObject* data_object, DWORD key_state, POINT cursor_position, DWORD effect, std::unique_ptr<ui::OSExchangeData>* data,
        std::unique_ptr<ui::DropTargetEvent>* event, aura::client::DragDropDelegate** delegate);
    ...
    // for them.
    base::ScopedObservation<aura::Window, aura::WindowObserver> target_window_observation_ { this };
};
