...
class VIEWS_EXPORT DesktopScreenPositionClient : public wm::DefaultScreenPositionClient {
public:
    ...
    DesktopScreenPositionClient& operator=(const DesktopScreenPositionClient&) = delete;
