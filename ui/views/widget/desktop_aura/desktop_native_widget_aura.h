...
// Chrome OS with mash.
class VIEWS_EXPORT DesktopNativeWidgetAura : public internal::NativeWidgetPrivate,
...
public:
    ...
    Widget::InitParams::Type widget_type() const
    {
        return widget_type_;
    }
...
private:
    ...
    void PerformDrop(views::DropHelper::DropCallback drop_cb, std::unique_ptr<ui::OSExchangeData> data, ui::mojom::DragOperation& output_drag_op,
