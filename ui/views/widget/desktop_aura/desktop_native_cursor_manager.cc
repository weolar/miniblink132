...
void DesktopNativeCursorManager::SetDisplay(const display::Display& display, wm::NativeCursorManagerDelegate* delegate)
{
...
void DesktopNativeCursorManager::SetCursor(gfx::NativeCursor cursor, wm::NativeCursorManagerDelegate* delegate)
{
...
void DesktopNativeCursorManager::SetVisibility(bool visible, wm::NativeCursorManagerDelegate* delegate)
{
    TRACE_EVENT1("ui,input", "DesktopNativeCursorManager::SetVisibility", "visible", visible);
...
void DesktopNativeCursorManager::SetCursorSize(ui::CursorSize cursor_size, wm::NativeCursorManagerDelegate* delegate)
{
    NOTIMPLEMENTED();
}

void DesktopNativeCursorManager::SetMouseEventsEnabled(bool enabled, wm::NativeCursorManagerDelegate* delegate)
{
...
void DesktopNativeCursorManager::InitCursorSizeObserver(wm::NativeCursorManagerDelegate* delegate)
{
    NOTREACHED();
}
