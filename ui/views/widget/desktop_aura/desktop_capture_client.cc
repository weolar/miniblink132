...
bool CompareWeakPtrs(const base::WeakPtr<DesktopCaptureClient>& lhs, const base::WeakPtr<DesktopCaptureClient>& rhs)
{
    ...
    if (!capture_window_) {
        ...
        for (auto client : clients) {
            if (client && client.get() != this) {
                aura::client::CaptureDelegate* client_delegate = client->root_->GetHost()->dispatcher();
...
void DesktopCaptureClient::AddObserver(aura::client::CaptureClientObserver* observer)
{
    observers_.AddObserver(observer);
}

void DesktopCaptureClient::RemoveObserver(aura::client::CaptureClientObserver* observer)
{
