...
class VIEWS_EXPORT DesktopWindowTreeHostPlatform : public aura::WindowTreeHostPlatform, public DesktopWindowTreeHost, public ui::WorkspaceExtensionDelegate {
public:
    DesktopWindowTreeHostPlatform(internal::NativeWidgetDelegate* native_widget_delegate, DesktopNativeWidgetAura* desktop_native_widget_aura);

    DesktopWindowTreeHostPlatform(const DesktopWindowTreeHostPlatform&) = delete;
    DesktopWindowTreeHostPlatform& operator=(const DesktopWindowTreeHostPlatform&) = delete;
    ...
    static DesktopWindowTreeHostPlatform* GetHostForWidget(gfx::AcceleratedWidget widget);
    ...
    void Show(ui::mojom::WindowShowState show_state, const gfx::Rect& restore_bounds) override;
    ...
    void GetWindowPlacement(gfx::Rect* bounds, ui::mojom::WindowShowState* show_state) const override;
    ...
    Widget::MoveLoopResult RunMoveLoop(
        const gfx::Vector2d& drag_offset, Widget::MoveLoopSource source, Widget::MoveLoopEscapeBehavior escape_behavior) override;
    ...
    // CompositorObserver:
    void OnCompositorVisibilityChanging(ui::Compositor* compositor, bool visible) override;
    void OnCompositorVisibilityChanged(ui::Compositor* compositor, bool visible) override;

    // PlatformWindowDelegate:
    gfx::Insets CalculateInsetsInDIP(ui::PlatformWindowState window_state) const override;
    ...
    bool OnRotateFocus(ui::PlatformWindowDelegate::RotateDirection direction, bool reset) override;
    ...
    std::optional<ui::OwnedWindowAnchor> GetOwnedWindowAnchorAndRectInDIP() override;
    ...
    gfx::PointF ConvertScreenPointToLocalDIP(const gfx::Point& screen_in_pixels) const override;
    gfx::Insets ConvertInsetsToPixels(const gfx::Insets& insets_dip) const override;
...
protected:
    FRIEND_TEST_ALL_PREFIXES(DesktopWindowTreeHostPlatformImplTest, MouseNCEvents);
    FRIEND_TEST_ALL_PREFIXES(DesktopWindowTreeHostPlatformImplHighDPITest, MouseNCEvents);
...
private:
    FRIEND_TEST_ALL_PREFIXES(DesktopWindowTreeHostPlatformTest, UpdateWindowShapeFromWindowMask);
    FRIEND_TEST_ALL_PREFIXES(DesktopWindowTreeHostPlatformTest, MakesParentChildRelationship);
    ...
    virtual void AddAdditionalInitProperties(const Widget::InitParams& params, ui::PlatformWindowInitProperties* properties);
    ...
    static bool RotateFocusForWidget(Widget& widget, ui::PlatformWindowDelegate::RotateDirection direction, bool reset);
    ...
    std::set<raw_ptr<DesktopWindowTreeHostPlatform, SetExperimental>> window_children_;
    ...
    base::WeakPtrFactory<DesktopWindowTreeHostPlatform> close_widget_factory_ { this };
};
