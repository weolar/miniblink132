...
class UniqueWidgetPtrTest : public ViewsTestBase, public ::testing::WithParamInterface<Widget::InitParams::Ownership>, public ViewObserver {
public:
...
protected:
    std::unique_ptr<Widget> AllocateTestWidget() override
    {
        ...
        widget->Init(CreateParams(GetParam(), Widget::InitParams::TYPE_WINDOW_FRAMELESS));
...
INSTANTIATE_TEST_SUITE_P(AllOwnershipTypes, UniqueWidgetPtrTest,
    testing::Values(Widget::InitParams::NATIVE_WIDGET_OWNS_WIDGET, Widget::InitParams::WIDGET_OWNS_NATIVE_WIDGET, Widget::InitParams::CLIENT_OWNS_WIDGET));
