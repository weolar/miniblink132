...
RootViewTargeter::RootViewTargeter(ViewTargeterDelegate* delegate, internal::RootView* root_view)
...
View* RootViewTargeter::FindTargetForGestureEvent(View* root, const ui::GestureEvent& gesture)
{
...
ui::EventTarget* RootViewTargeter::FindNextBestTargetForGestureEvent(ui::EventTarget* previous_target, const ui::GestureEvent& gesture)
{
    ...
    if (root_view_->gesture_handler_set_before_processing_ && gesture.type() != ui::EventType::kGestureScrollBegin) {
        return nullptr;
    }
