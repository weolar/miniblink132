...
class VIEWS_EXPORT NativeWidgetMac : public internal::NativeWidgetPrivate, public FocusChangeListener, public ui::ImeKeyEventDispatcher, public WidgetObserver {
public:
    ...
    virtual void GetWindowFrameTitlebarHeight(bool* override_titlebar_height, float* titlebar_height);
    ...
    virtual void ValidateUserInterfaceItem(int32_t command, remote_cocoa::mojom::ValidateUserInterfaceItemResult* result)
    {
    }
    ...
    virtual bool WillExecuteCommand(int32_t command, WindowOpenDisposition window_open_disposition, bool is_before_first_responder);
    ...
    virtual bool ExecuteCommand(int32_t command, WindowOpenDisposition window_open_disposition, bool is_before_first_responder);

    ui::Compositor* GetCompositor()
    {
        return const_cast<ui::Compositor*>(const_cast<const NativeWidgetMac*>(this)->GetCompositor());
    }
    ...
    void SetCanAppearInExistingFullscreenSpaces(bool can_appear_in_existing_fullscreen_spaces) override;
    void SetOpacity(float opacity) override;
    void SetAspectRatio(const gfx::SizeF& aspect_ratio, const gfx::Size& excluded_margin) override;
    void FlashFrame(bool flash_frame) override;
    void RunShellDrag(std::unique_ptr<ui::OSExchangeData> data, const gfx::Point& location, int operation, ui::mojom::DragEventSource source) override;
    ...
    void SetVisibilityAnimationTransition(Widget::VisibilityTransition transition) override;
    ...
    static base::CallbackListSubscription RegisterInitNativeWidgetCallback(const base::RepeatingCallback<void(NativeWidgetMac*)>& callback);
...
protected:
    ...
    virtual void PopulateCreateWindowParams(const Widget::InitParams& widget_params, remote_cocoa::mojom::CreateWindowParams* params);

    // Creates the NSWindow that will be passed to the NativeWidgetNSWindowBridge.
    // Called by InitNativeWidget.
    virtual NativeWidgetMacNSWindow* CreateNSWindow(const remote_cocoa::mojom::CreateWindowParams* params);
...
private:
    ...
    Widget::InitParams::Ownership ownership_ = Widget::InitParams::NATIVE_WIDGET_OWNS_WIDGET;
