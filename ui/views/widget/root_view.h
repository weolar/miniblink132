...
//
class VIEWS_EXPORT RootView : public View, public ViewTargeterDelegate, public FocusTraversable, public ui::EventProcessor {
...
protected:
    ...
    View::LayerOffsetData CalculateOffsetToAncestorWithLayer(ui::Layer** layer_parent) override;
...
private:
    ...
    [[nodiscard]] ui::EventDispatchDetails NotifyEnterExitOfDescendant(const ui::MouseEvent& event, ui::EventType type, View* view, View* sibling);
    ...
    raw_ptr<FocusTraversable, AcrossTasksDanglingUntriaged> focus_traversable_parent_ = nullptr;
    ...
    raw_ptr<View, AcrossTasksDanglingUntriaged> focus_traversable_parent_view_ = nullptr;
    ...
    // live region update.
    raw_ptr<AnnounceTextView, AcrossTasksDanglingUntriaged> announce_view_ = nullptr;
};
