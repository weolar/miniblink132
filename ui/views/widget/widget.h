...
public:
    ...
    static Widget* CreateWindowWithParent(WidgetDelegate* delegate, gfx::NativeView parent, const gfx::Rect& bounds = gfx::Rect());
    static Widget* CreateWindowWithParent(std::unique_ptr<WidgetDelegate> delegate, gfx::NativeView parent, const gfx::Rect& bounds = gfx::Rect());
    ...
    // for details.
    // The std::unique_ptr variant requires that delegate->owned_by_widget().
    static Widget* CreateWindowWithContext(WidgetDelegate* delegate, gfx::NativeWindow context, const gfx::Rect& bounds = gfx::Rect());
    static Widget* CreateWindowWithContext(std::unique_ptr<WidgetDelegate> delegate, gfx::NativeWindow context, const gfx::Rect& bounds = gfx::Rect());
    ...
    // an out param.
    static void GetAllChildWidgets(gfx::NativeView native_view, Widgets* children);
    ...
    // of the change.
    static void ReparentNativeView(gfx::NativeView native_view, gfx::NativeView new_parent);
    ...
    WidgetDelegate* widget_delegate() const
    {
    ...
    template <typename T> T* SetContentsView(std::unique_ptr<T> view)
    {
        DCHECK(!view->owned_by_client()) << "This should only be called if the client is passing over the "
                                            "ownership of |view|.";
    ...
    MoveLoopResult RunMoveLoop(const gfx::Vector2d& drag_offset, MoveLoopSource source, MoveLoopEscapeBehavior escape_behavior);
    ...
    void SetBlockCloseForTesting(bool block_close)
    {
        block_close_ = block_close;
    }
    ...
    ClosedReason closed_reason() const
    {
    ...
    void SetCanAppearInExistingFullscreenSpaces(bool can_appear_in_existing_fullscreen_spaces);
    ...
    bool is_secondary_widget() const
    {
        return is_secondary_widget_;
    }
    ...
    virtual ui::ColorProviderKey::ThemeInitializerSupplier* GetCustomTheme() const;

    ui::NativeTheme* GetNativeTheme()
    {
        return const_cast<ui::NativeTheme*>(static_cast<const Widget*>(this)->GetNativeTheme());
    }
    ...
    void RunShellDrag(View* view, std::unique_ptr<ui::OSExchangeData> data, const gfx::Point& location, int operation, ui::mojom::DragEventSource source);
    ...
    // factor changed.
    void DeviceScaleFactorChanged(float old_device_scale_factor, float new_device_scale_factor);
    ...
    void set_frame_type(FrameType frame_type)
    {
    ...
    {
        return const_cast<NonClientView*>(const_cast<const Widget*>(this)->non_client_view());
    }
    ...
    {
        return const_cast<ClientView*>(const_cast<const Widget*>(this)->client_view());
    }
    ...
    {
        return const_cast<ui::Compositor*>(const_cast<const Widget*>(this)->GetCompositor());
    }
    ...
    bool is_autosized() const
    {
        return is_autosized_;
    }

    // True when window movement via mouse interaction with the frame is disabled.
    bool movement_disabled() const
    {
        return movement_disabled_;
    }
    void set_movement_disabled(bool disabled)
    {
        movement_disabled_ = disabled;
    }
    ...
    // changes.
    base::CallbackListSubscription RegisterPaintAsActiveChangedCallback(PaintAsActiveCallbackList::CallbackType callback);
    ...
    bool ShouldDescendIntoChildForEventHandling(ui::Layer* root_layer, gfx::NativeView child, ui::Layer* child_layer, const gfx::Point& location) override;
    ...
    void SetColorModeOverride(std::optional<ui::ColorProviderKey::ColorMode> color_mode);

    // ui::ColorProviderSource:
    const ui::ColorProvider* GetColorProvider() const override;
    ui::RendererColorMap GetRendererColorMap(ui::ColorProviderKey::ColorMode color_mode, ui::ColorProviderKey::ForcedColors forced_colors) const override;
    ...
    InitParams::Ownership ownership() const
    {
        return ownership_;
    }

    bool native_widget_active() const
    {
        return native_widget_active_;
    }
...
private:
    ...
    static void SetDisableActivationChangeHandling(DisableActivationChangeHandlingType new_type)
    {
        g_disable_activation_change_handling_ = new_type;
    }
    static DisableActivationChangeHandlingType GetDisableActivationChangeHandling()
    {
    ...
    bool GetSavedWindowPlacement(gfx::Rect* bounds, ui::mojom::WindowShowState* show_state);
    ...
    static DisableActivationChangeHandlingType g_disable_activation_change_handling_;
    ...
    ui::mojom::WindowShowState saved_show_state_ = ui::mojom::WindowShowState::kDefault;
    ...
    base::ScopedObservation<ui::NativeTheme, ui::NativeThemeObserver> native_theme_observation_ { this };

    base::ScopedObservation<ui::AXPlatform, ui::AXModeObserver> ax_mode_observation_ { this };
