...
public:
    ...
    {
        return base::BindOnce(&TestDropTargetView::PerformDrop, base::Unretained(this));
    }
...
TEST_F(DropHelperTest, DropCoordinates)
{
    ...
    views::View* container = widget.SetContentsView(std::make_unique<views::View>());
    TestDropTargetView* drop_target = container->AddChildView(std::make_unique<TestDropTargetView>());
    ...
    // Start drop.
    DropHelper::DropCallback callback = drop_helper->GetDropCallback(*data, target, drag_operation);
