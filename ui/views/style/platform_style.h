...
public:
    ...
    static std::unique_ptr<ScrollBar> CreateScrollBar(ScrollBar::Orientation orientation);
    ...
    static gfx::Range RangeToDeleteBackwards(const std::u16string& text, size_t cursor_position);
};
