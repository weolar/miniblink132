...
class VIEWS_EXPORT NonClientFrameView : public View, public ViewTargeterDelegate {
...
public:
    ...
    virtual gfx::Rect GetWindowBoundsForClientBounds(const gfx::Rect& client_bounds) const;
