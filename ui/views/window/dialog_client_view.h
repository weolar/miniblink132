...
class VIEWS_EXPORT DialogClientView : public ClientView, public DialogObserver, public LayoutDelegate {
...
public:
    ...
    MdTextButton* ok_button() const
    {
        return ok_button_;
    }
    MdTextButton* cancel_button() const
    {
        return cancel_button_;
    }
    View* extra_view() const
    {
        return extra_view_;
    }
    ...
    void set_minimum_size(const gfx::Size& size)
    {
        minimum_size_ = size;
    }
    ...
    void SetInputProtectorForTesting(std::unique_ptr<views::InputEventActivationProtector> input_protector)
    {
...
private:
    ...
    void UpdateDialogButton(raw_ptr<MdTextButton>* member, ui::mojom::DialogButton type);
