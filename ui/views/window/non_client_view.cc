...
int NonClientFrameView::GetHTComponentForFrame(
    const gfx::Point& point, const gfx::Insets& resize_border, int top_resize_corner_height, int resize_corner_width, bool can_resize)
{
...
gfx::Rect NonClientFrameView::GetWindowBoundsForClientBounds(const gfx::Rect& client_bounds) const
{
    return client_bounds;
}

bool NonClientFrameView::GetClientMask(const gfx::Size& size, SkPath* mask) const
{
    return false;
}
...
{
    gfx::Point point(GetMirroredXInView(GetBoundsForClientView().x()), GetSystemMenuY());
...
View::Views NonClientFrameView::GetChildrenInZOrder()
{
    ...
    views::ClientView* client_view = GetWidget() ? GetWidget()->client_view() : nullptr;
...
void NonClientView::SetFrameView(std::unique_ptr<NonClientFrameView> frame_view)
{
...
gfx::Rect NonClientView::GetWindowBoundsForClientBounds(const gfx::Rect client_bounds) const
{
...
gfx::Size NonClientView::CalculatePreferredSize(const SizeBounds& available_size) const
{
    ...
    gfx::Rect client_bounds(gfx::Point(), client_view_->GetPreferredSize(available_size));
...
void NonClientView::ViewHierarchyChanged(const ViewHierarchyChangedDetails& details)
{
...
View* NonClientView::TargetForRect(View* root, const gfx::Rect& rect)
{
    ...
    if (frame_view_->parent() == this) {
        ...
        gfx::Rect rect_in_child_coords = gfx::ToEnclosingRect(rect_in_child_coords_f);
