...
public:
    struct Params {
        ...
        // this dialog.
        int buttons = static_cast<int>(ui::mojom::DialogButton::kOk) | static_cast<int>(ui::mojom::DialogButton::kCancel);
        ...
        std::array<std::u16string, static_cast<size_t>(ui::mojom::DialogButton::kCancel) + 1> button_labels;

        // Styles of each button on this dialog. If empty a style will be derived.
        std::array<std::optional<ui::ButtonStyle>, static_cast<size_t>(ui::mojom::DialogButton::kCancel) + 1> button_styles;
        ...
        int enabled_buttons = static_cast<int>(ui::mojom::DialogButton::kOk) | static_cast<int>(ui::mojom::DialogButton::kCancel);
    };
    ...
    // your use case.
    static Widget* CreateDialogWidget(std::unique_ptr<WidgetDelegate> delegate, gfx::NativeWindow context, gfx::NativeView parent);
    static Widget* CreateDialogWidget(WidgetDelegate* delegate, gfx::NativeWindow context, gfx::NativeView parent);
    ...
    static Widget::InitParams GetDialogWidgetInitParams(WidgetDelegate* delegate, gfx::NativeWindow context, gfx::NativeView parent, const gfx::Rect& bounds);
    ...
    virtual bool ShouldIgnoreButtonPressedEventHandling(View* button, const ui::Event& event) const;
    ...
    static std::unique_ptr<NonClientFrameView> CreateDialogFrameView(Widget* widget);

    const gfx::Insets& margins() const
    {
        return margins_;
    }
    ...
    template <typename T = View> T* SetExtraView(std::unique_ptr<T> extra_view)
    {
    ...
    template <typename T> T* SetFootnoteView(std::unique_ptr<T> footnote_view)
    {
    ...
    void set_use_round_corners(bool round)
    {
        params_.round_corners = round;
    }
    ...
    {
        params_.draggable = draggable;
    }
    bool draggable() const
    {
        return params_.draggable;
    }
    void set_use_custom_frame(bool use)
    {
        params_.custom_frame = use;
    }
    bool use_custom_frame() const
    {
        return params_.custom_frame;
    }
    ...
    void SetButtonLabel(ui::mojom::DialogButton dialog_button, std::u16string label);
    void SetButtonStyle(ui::mojom::DialogButton button, std::optional<ui::ButtonStyle> style);
...
private:
    ...
    bool RunCloseCallback(absl::variant<base::OnceClosure, base::RepeatingCallback<bool()>>& callback);
    ...
    base::ObserverList<DialogObserver>::UncheckedAndDanglingUntriaged observer_list_;

    // Callbacks for the dialog's actions:
    absl::variant<base::OnceClosure, base::RepeatingCallback<bool()>> accept_callback_;
    absl::variant<base::OnceClosure, base::RepeatingCallback<bool()>> cancel_callback_;
    ...
    Widget::InitParams::Ownership ownership_of_new_widget_ = Widget::InitParams::NATIVE_WIDGET_OWNS_WIDGET;
};
