...
gfx::Size ClientView::CalculatePreferredSize(const SizeBounds& available_size) const
{
...
void ClientView::ViewHierarchyChanged(const ViewHierarchyChangedDetails& details)
{
