...
public:
    ...
    virtual bool GetClientAreaInsets(gfx::Insets* insets, HMONITOR monitor) const = 0;
    ...
    // user.
    virtual void GetMinMaxSize(gfx::Size* min_size, gfx::Size* max_size) const = 0;
    ...
    // performed.
    virtual bool HandleIMEMessage(UINT message, WPARAM w_param, LPARAM l_param, LRESULT* result) = 0;

    // Called when the system input language changes.
    virtual void HandleInputLanguageChange(DWORD character_set, HKL input_language_id) = 0;
    ...
    virtual bool PreHandleMSG(UINT message, WPARAM w_param, LPARAM l_param, LRESULT* result) = 0;
