...
Microsoft::WRL::ComPtr<ABI::Windows::Devices::Input::IPenDeviceStatics> FakeIPenDeviceStatics::FakeIPenDeviceStaticsComPtr()
{
    FakeIPenDeviceStatics* instance = GetInstance();
    return static_cast<Microsoft::WRL::ComPtr<ABI::Windows::Devices::Input::IPenDeviceStatics>>(instance);
}

HRESULT FakeIPenDeviceStatics::GetFromPointerId(UINT32 pointer_id, IPenDevice** result)
{
...
void FakeIPenDeviceStatics::SimulatePenEventGenerated(UINT32 pointer_id, Microsoft::WRL::ComPtr<IPenDevice> pen_device)
{
