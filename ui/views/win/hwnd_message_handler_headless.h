...
public:
    ...
    HWNDMessageHandlerHeadless& operator=(const HWNDMessageHandlerHeadless&) = delete;
    ...
    void Show(ui::mojom::WindowShowState show_state, const gfx::Rect& pixel_restore_bounds) override;
    void Hide() override;
...
protected:
    ...
    HWNDMessageHandlerHeadless(HWNDMessageHandlerDelegate* delegate, const std::string& debugging_id);

    void SetBoundsInternal(const gfx::Rect& bounds_in_pixels, bool force_size_changed) override;
