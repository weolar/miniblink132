...
VIEWS_EXPORT gfx::Rect GetWindowBoundsForClientBounds(View* view, const gfx::Rect& client_bounds);
...
// coordinates).
VIEWS_EXPORT void ShowSystemMenuAtScreenPixelLocation(HWND window, const gfx::Point& point);
