...
// not.
class VIEWS_EXPORT ViewShadow : public ViewObserver, public ui::LayerOwner::Observer {
public:
...
private:
    ...
    base::ScopedObservation<ui::Shadow, ui::LayerOwner::Observer> shadow_observation_ { this };
};
