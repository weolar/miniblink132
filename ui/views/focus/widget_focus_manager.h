...
private:
    ...
    base::ObserverList<WidgetFocusChangeListener>::Unchecked focus_change_listeners_;
...
public:
    ...
    AutoNativeNotificationDisabler(const AutoNativeNotificationDisabler&) = delete;
    AutoNativeNotificationDisabler& operator=(const AutoNativeNotificationDisabler&) = delete;
...
template <> struct ScopedObservationTraits<views::WidgetFocusManager, views::WidgetFocusChangeListener> {
public:
    static void AddObserver(views::WidgetFocusManager* source, views::WidgetFocusChangeListener* observer)
    {
        source->AddFocusChangeListener(observer);
    }
    static void RemoveObserver(views::WidgetFocusManager* source, views::WidgetFocusChangeListener* observer)
    {
