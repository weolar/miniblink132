...
void WidgetFocusManager::AddFocusChangeListener(WidgetFocusChangeListener* listener)
{
    focus_change_listeners_.AddObserver(listener);
}

void WidgetFocusManager::RemoveFocusChangeListener(WidgetFocusChangeListener* listener)
{
...
{
    if (enabled_) {
        focus_change_listeners_.Notify(&WidgetFocusChangeListener::OnNativeFocusChanged, focused_now);
    }
}
