...
public:
    ...
    bool shortcut_handling_suspended()
    {
    ...
    void RegisterAccelerator(const ui::Accelerator& accelerator, ui::AcceleratorManager::HandlerPriority priority, ui::AcceleratorTarget* target);

    // Unregister the specified keyboard accelerator for the specified target.
    void UnregisterAccelerator(const ui::Accelerator& accelerator, ui::AcceleratorTarget* target);
    ...
    // starts at |widget_|.
    View* GetNextFocusableView(View* starting_view, Widget* starting_widget, bool reverse, bool dont_loop);

    bool keyboard_accessible() const
    {
...
private:
    ...
    View* FindFocusableView(FocusTraversable* focus_traversable, View* starting_view, bool reverse);
    ...
    // the bubble didn't.
    bool RedirectAcceleratorToBubbleAnchorWidget(const ui::Accelerator& accelerator);
    ...
    FocusChangeReason focus_change_reason_ = FocusChangeReason::kDirectFocusChange;

    // The list of registered FocusChange listeners.
    base::ObserverList<FocusChangeListener, true>::Unchecked focus_change_listeners_;
