...
public:
    DragDropClientMac(remote_cocoa::NativeWidgetNSWindowBridge* bridge, View* root_view);
    ...
    void StartDragAndDrop(std::unique_ptr<ui::OSExchangeData> data, int operation, ui::mojom::DragEventSource source);

    DropHelper* drop_helper()
    {
        return &drop_helper_;
    }
...
private:
    ...
    raw_ptr<remote_cocoa::NativeWidgetNSWindowBridge, DanglingUntriaged> bridge_; // Weak. Owns |this|.
