...
public:
    ...
    void BindReceiver(mojo::PendingAssociatedReceiver<remote_cocoa::mojom::TextInputHost> receiver);
...
private:
    ...
    bool GetAttributedSubstringForRange(const gfx::Range& requested_range, std::u16string* out_text, gfx::Range* out_actual_range) override;
    bool GetFirstRectForRange(const gfx::Range& requested_range, gfx::Rect* out_rect, gfx::Range* out_actual_range) override;
    bool IsTextEditCommandEnabled(ui::TextEditCommand command, bool* out_enabled) override;
    ...
    mojo::AssociatedReceiver<remote_cocoa::mojom::TextInputHost> mojo_receiver_ { this };
};
