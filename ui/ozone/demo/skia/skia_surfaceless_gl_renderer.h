...
public:
    SurfacelessSkiaGlRenderer(gfx::AcceleratedWidget widget, std::unique_ptr<PlatformWindowSurface> window_surface,
    ...
    SurfacelessSkiaGlRenderer& operator=(const SurfacelessSkiaGlRenderer&) = delete;
