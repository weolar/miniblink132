...
public:
    WaylandClipboard(WaylandConnection* connection, WaylandDataDeviceManager* device_manager);
    ...
    void SetClipboardDataChangedCallback(ClipboardDataChangedCallback data_changed_callback) override;
