...
public:
    ...
    virtual int SyncobjTransfer(uint32_t dst_handle, uint64_t dst_point, uint32_t src_handle, uint64_t src_point, uint32_t flags);
    ...
    virtual int SyncobjEventfd(uint32_t handle, uint64_t point, int ev_fd, uint32_t flags);
