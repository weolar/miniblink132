...
TEST(WaylandSerialTrackerTest, Queries)
{
    ...
    serial = serial_tracker.GetSerial({ SerialType::kMouseEnter, SerialType::kMousePress });
    ASSERT_TRUE(serial);
    EXPECT_EQ(2u, serial->value);
    EXPECT_EQ(SerialType::kMousePress, serial->type);

    serial = serial_tracker.GetSerial({ SerialType::kMousePress, SerialType::kMouseEnter });
    ASSERT_TRUE(serial);
    EXPECT_EQ(2u, serial->value);
    EXPECT_EQ(SerialType::kMousePress, serial->type);

    serial = serial_tracker.GetSerial({ SerialType::kMousePress, SerialType::kMouseEnter, SerialType::kTouchPress });
    ASSERT_TRUE(serial);
    EXPECT_EQ(3u, serial->value);
    EXPECT_EQ(SerialType::kTouchPress, serial->type);

    serial = serial_tracker.GetSerial({ SerialType::kMousePress, SerialType::kMouseEnter, SerialType::kKeyPress });
    ASSERT_TRUE(serial);
    ...
    EXPECT_FALSE(serial_tracker.GetSerial({ SerialType::kMouseEnter, SerialType::kTouchPress }));

    serial = serial_tracker.GetSerial({ SerialType::kTouchPress, SerialType::kMousePress });
    ASSERT_TRUE(serial);
    EXPECT_EQ(2u, serial->value);
    EXPECT_EQ(SerialType::kMousePress, serial->type);

    serial = serial_tracker.GetSerial({ SerialType::kTouchPress, SerialType::kMousePress, SerialType::kKeyPress });
    ASSERT_TRUE(serial);
    EXPECT_EQ(4u, serial->value);
    EXPECT_EQ(SerialType::kKeyPress, serial->type);
}
