...
class WaylandExchangeDataProvider final : public OSExchangeDataProviderNonBacked {
public:
    WaylandExchangeDataProvider();
    WaylandExchangeDataProvider(const WaylandExchangeDataProvider&) = delete;
    WaylandExchangeDataProvider& operator=(const WaylandExchangeDataProvider&) = delete;
