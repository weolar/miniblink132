...
class WaylandDataDeviceManager : public wl::GlobalObjectRegistrar<WaylandDataDeviceManager> {
public:
    ...
    WaylandDataDeviceManager(wl_data_device_manager* device_manager, WaylandConnection* connection);
    ...
    std::unique_ptr<WaylandDataSource> CreateSource(WaylandDataSource::Delegate* delegate);
