...
public:
    explicit WaylandBufferManagerConnector(WaylandBufferManagerHost* buffer_manager_host);

    WaylandBufferManagerConnector(const WaylandBufferManagerConnector&) = delete;
    WaylandBufferManagerConnector& operator=(const WaylandBufferManagerConnector&) = delete;
...
private:
    ...
    const raw_ptr<WaylandBufferManagerHost, LeakedDanglingUntriaged> buffer_manager_host_;
