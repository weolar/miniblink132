...
class WaylandZcrCursorShapes : public wl::GlobalObjectRegistrar<WaylandZcrCursorShapes> {
public:
    ...
    WaylandZcrCursorShapes(zcr_cursor_shapes_v1* zcr_cursor_shapes, WaylandConnection* connection);
