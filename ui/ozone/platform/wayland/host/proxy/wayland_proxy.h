...
public:
    ...
    public:
        ...
        virtual void OnWindowConfigured(gfx::AcceleratedWidget widget, bool is_configured) = 0;
    ...
    virtual wl_surface* GetWlSurfaceForAcceleratedWidget(gfx::AcceleratedWidget widget) = 0;
    // Returns WaylandWindow backed by |widget|.
    virtual ui::WaylandWindow* GetWaylandWindowForAcceleratedWidget(gfx::AcceleratedWidget widget) = 0;
    ...
    virtual ui::PlatformWindowType GetWindowType(gfx::AcceleratedWidget widget) = 0;
