...
public:
    ...
    explicit SurfaceAugmenter(surface_augmenter* surface_augmenter, WaylandConnection* connection);
    ...
    wl::Object<augmented_sub_surface> CreateAugmentedSubSurface(wl_subsurface* subsurface);

    wl::Object<wl_buffer> CreateSolidColorBuffer(const SkColor4f& color, const gfx::Size& size);
