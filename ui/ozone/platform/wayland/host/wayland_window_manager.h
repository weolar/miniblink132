...
public:
    ...
    void AddSubsurface(gfx::AcceleratedWidget widget, WaylandSubsurface* subsurface);
    void RemoveSubsurface(gfx::AcceleratedWidget widget, WaylandSubsurface* subsurface);
...
private:
    ...
    base::flat_map<gfx::AcceleratedWidget, raw_ptr<WaylandWindow, CtnExperimental>> window_map_;
