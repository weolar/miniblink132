...
public:
    ...
    WaylandBufferBackingSinglePixel(const WaylandBufferBackingSinglePixel&) = delete;
    WaylandBufferBackingSinglePixel& operator=(const WaylandBufferBackingSinglePixel&) = delete;
    WaylandBufferBackingSinglePixel(const WaylandConnection* connection, SkColor4f color, uint32_t buffer_id);
