...
public:
    ...
    struct Metrics {
        ...
        Metrics();
        Metrics(Id output_id, int64_t display_id, gfx::Point origin, gfx::Size logical_size, gfx::Size physical_size, gfx::Insets insets,
    ...
    XDGOutput* xdg_output_for_testing()
    {
...
private:
    ...
    static void OnGeometry(void* data, wl_output* output, int32_t x, int32_t y, int32_t physical_width, int32_t physical_height, int32_t subpixel,
