...
public:
    ...
    WaylandBufferBackingSolidColor(const WaylandBufferBackingSolidColor&) = delete;
    WaylandBufferBackingSolidColor& operator=(const WaylandBufferBackingSolidColor&) = delete;
    WaylandBufferBackingSolidColor(const WaylandConnection* connection, SkColor4f color, const gfx::Size& size, uint32_t buffer_id);
