...
TEST_F(XdgToplevelIconTest, Basic)
{
    ...
    PostToServerAndWait([&](wl::TestWaylandServerThread* server) {
        ...
        ASSERT_TRUE(manager);
        wl::XdgToplevelIconResources expected_resources = { wl::XdgToplevelIconResource(gfx::Size(128, 128), 1) };
...
TEST_F(XdgToplevelIconTest, AppIconTakesPrecedence)
{
    ...
    gfx::ImageSkia window_icon = gfx::ImageSkia::CreateFrom1xBitmap(window_bitmap);
