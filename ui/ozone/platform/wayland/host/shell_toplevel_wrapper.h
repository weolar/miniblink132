...
public:
    ...
    virtual void SurfaceResize(WaylandConnection* connection, uint32_t hittest) = 0;
    ...
    virtual void RequestWindowBounds(const gfx::Rect& bounds, int64_t display_id = display::kInvalidDisplayId) = 0;
    ...
    virtual void CommitSnap(WaylandWindowSnapDirection snap_direction, float snap_ratio) = 0;
    ...
    // feedback.
    virtual void ShowSnapPreview(WaylandWindowSnapDirection snap_direction, bool allow_haptic_feedback) = 0;
