...
public:
    ZwpPrimarySelectionDevice(WaylandConnection* connection, zwp_primary_selection_device_v1* data_device);
...
private:
    ...
    static void OnDataOffer(void* data, zwp_primary_selection_device_v1* selection_device, zwp_primary_selection_offer_v1* offer);
    static void OnSelection(void* data, zwp_primary_selection_device_v1* selection_device, zwp_primary_selection_offer_v1* offer);
