...
class ZwpIdleInhibitManager : public wl::GlobalObjectRegistrar<ZwpIdleInhibitManager> {
public:
    ...
    explicit ZwpIdleInhibitManager(zwp_idle_inhibit_manager_v1* manager, WaylandConnection* connection);
