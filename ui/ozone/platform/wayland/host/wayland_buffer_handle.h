...
public:
    ...
    void set_buffer_released_callback(base::OnceCallback<void(wl_buffer*)> callback, WaylandSurface* requestor)
    {
...
private:
    ...
    base::flat_map<WaylandSurface*, base::OnceCallback<void(wl_buffer*)>> released_callbacks_;
