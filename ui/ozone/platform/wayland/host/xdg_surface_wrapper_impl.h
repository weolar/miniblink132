...
public:
    XDGSurfaceWrapperImpl(WaylandWindow* wayland_window, WaylandConnection* connection);
...
private:
    ...
    static void OnConfigure(void* data, struct xdg_surface* xdg_surface, uint32_t serial);
