...
int DrmSyncobjIoctlWrapper::SyncobjTransfer(uint32_t dst_handle, uint64_t dst_point, uint32_t src_handle, uint64_t src_point, uint32_t flags)
{
    return drmSyncobjTransfer(fd_.get(), dst_handle, dst_point, src_handle, src_point, flags);
}
...
int DrmSyncobjIoctlWrapper::SyncobjImportSyncFile(uint32_t handle, int sync_file_fd)
{
    return drmSyncobjImportSyncFile(fd_.get(), handle, sync_file_fd);
}

int DrmSyncobjIoctlWrapper::SyncobjExportSyncFile(uint32_t handle, int* sync_file_fd)
{
    return drmSyncobjExportSyncFile(fd_.get(), handle, sync_file_fd);
}

int DrmSyncobjIoctlWrapper::SyncobjEventfd(uint32_t handle, uint64_t point, int ev_fd, uint32_t flags)
{
