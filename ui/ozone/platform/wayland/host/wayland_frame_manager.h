...
public:
    ...
    WaylandFrame(uint32_t frame_id, const gfx::FrameData& data, WaylandSurface* root_surface, wl::WaylandOverlayConfig root_config,
    ...
    WaylandFrame(WaylandSurface* root_surface, wl::WaylandOverlayConfig root_config,
        base::circular_deque<std::pair<WaylandSubsurface*, wl::WaylandOverlayConfig>> subsurfaces_to_overlays = {});
...
private:
    ...
    base::flat_map<WaylandSurface*, raw_ptr<WaylandBufferHandle, CtnExperimental>> submitted_buffers;
...
private:
    ...
    std::optional<bool> ApplySurfaceConfigure(WaylandFrame* frame, WaylandSurface* surface, wl::WaylandOverlayConfig& config, bool needs_opaque_region);
    ...
    void OnExplicitBufferRelease(WaylandSurface* surface, wl_buffer* wl_buffer, base::ScopedFD fence);
    ...
    static void OnSyncOutput(void* data, struct wp_presentation_feedback* presentation_feedback, wl_output* output);
    static void OnPresented(void* data, struct wp_presentation_feedback* presentation_feedback, uint32_t tv_sec_hi, uint32_t tv_sec_lo, uint32_t tv_nsec,
        uint32_t refresh, uint32_t seq_hi, uint32_t seq_lo, uint32_t flags);
    static void OnDiscarded(void* data, struct wp_presentation_feedback* presentation_feedback);

    void HandlePresentationFeedback(struct wp_presentation_feedback* presentation_feedback, const gfx::PresentationFeedback& feedback, bool discarded = false);
