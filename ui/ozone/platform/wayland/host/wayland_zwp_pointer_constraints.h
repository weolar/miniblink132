...
class WaylandZwpPointerConstraints : public wl::GlobalObjectRegistrar<WaylandZwpPointerConstraints> {
public:
    ...
    WaylandZwpPointerConstraints(zwp_pointer_constraints_v1* pointer_constraints, WaylandConnection* connection);

    WaylandZwpPointerConstraints(const WaylandZwpPointerConstraints&) = delete;
    WaylandZwpPointerConstraints& operator=(const WaylandZwpPointerConstraints&) = delete;
...
private:
    ...
    static void OnLocked(void* data, struct zwp_locked_pointer_v1* locked_pointer);
    static void OnUnlocked(void* data, struct zwp_locked_pointer_v1* locked_pointer);
