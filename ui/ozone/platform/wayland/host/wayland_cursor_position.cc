...
void WaylandCursorPosition::OnCursorPositionChanged(const gfx::Point& cursor_position)
{
...
{
    out << "WaylandCursorPositoin: cursor_surface_point:" << cursor_surface_point_.ToString();
}
