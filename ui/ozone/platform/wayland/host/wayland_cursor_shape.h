...
class WaylandCursorShape : public wl::GlobalObjectRegistrar<WaylandCursorShape> {
public:
    ...
    WaylandCursorShape(wp_cursor_shape_manager_v1* cursor_shape, WaylandConnection* connection);
