...
std::string WaylandMenuUtils::ToDBusKeySym(KeyboardCode code) const
{
    ...
    KeyboardLayoutEngine* keyboard_layout_engine = KeyboardLayoutEngineManager::GetKeyboardLayoutEngine();
    ...
    if (!keyboard_layout_engine->Lookup(dom_code, EF_NONE, &dom_key, &key_code_ignored) || !dom_key.IsCharacter()) {
