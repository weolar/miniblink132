...
public:
    GtkPrimarySelectionDevice(WaylandConnection* connection, gtk_primary_selection_device* data_device);

    GtkPrimarySelectionDevice(const GtkPrimarySelectionDevice&) = delete;
    GtkPrimarySelectionDevice& operator=(const GtkPrimarySelectionDevice&) = delete;
...
private:
    ...
    static void OnDataOffer(void* data, gtk_primary_selection_device* selection_device, gtk_primary_selection_offer* offer);
    static void OnSelection(void* data, gtk_primary_selection_device* selection_device, gtk_primary_selection_offer* offer);
