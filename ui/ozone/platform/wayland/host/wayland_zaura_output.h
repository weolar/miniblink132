...
private:
    ...
    static void OnScale(void* data, zaura_output* output, uint32_t flags, uint32_t scale);
    static void OnConnection(void* data, zaura_output* output, uint32_t connection);
    static void OnDeviceScaleFactor(void* data, zaura_output* output, uint32_t scale);
    static void OnInsets(void* data, zaura_output* output, int32_t top, int32_t left, int32_t bottom, int32_t right);
    static void OnLogicalTransform(void* data, zaura_output* output, int32_t transform);
    static void OnDisplayId(void* data, zaura_output* output, uint32_t display_id_hi, uint32_t display_id_lo);
