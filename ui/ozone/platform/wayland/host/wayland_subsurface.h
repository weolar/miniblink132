...
public:
    ...
    {
        return wayland_surface_.surface();
    }
    ...
    bool ConfigureAndShowSurface(const gfx::RectF& bounds_px, const gfx::RectF& parent_bounds_px, const std::optional<gfx::Rect>& clip_rect_px,
        const absl::variant<gfx::OverlayTransform, gfx::Transform>& transform, float buffer_scale, WaylandSubsurface* reference_below,
...
private:
    ...
    absl::variant<gfx::OverlayTransform, gfx::Transform> transform_ = gfx::OVERLAY_TRANSFORM_NONE;
