...
enum class SerialType { kMouseEnter, kMousePress, kTouchPress, kKeyPress, kMaxValue = kKeyPress };
...
private:
    ...
    base::fixed_flat_map<SerialType, std::optional<Serial>, static_cast<size_t>(SerialType::kMaxValue) + 1> serials_;
};
