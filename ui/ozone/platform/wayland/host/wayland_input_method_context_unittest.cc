...
{
    base::i18n::BreakIterator iter(text, base::i18n::BreakIterator::BREAK_CHARACTER);
    if (!iter.Init())
        return std::nullopt;
    size_t result = 0;
    while (iter.Advance())
...
public:
    ...
    MOCK_METHOD(void, SetCompositionText, (const ui::CompositionText&), (override));
    MOCK_METHOD(size_t, ConfirmCompositionText, (bool), (override));
    MOCK_METHOD(void, ClearCompositionText, (), (override));
    MOCK_METHOD(void, InsertText, (const std::u16string&, ui::TextInputClient::InsertTextCursorBehavior cursor_behavior), (override));
    MOCK_METHOD(void, InsertChar, (const ui::KeyEvent&), (override));
    MOCK_METHOD(ui::TextInputMode, GetTextInputMode, (), (const, override));
    MOCK_METHOD(base::i18n::TextDirection, GetTextDirection, (), (const, override));
    ...
    MOCK_METHOD(bool, GetCompositionCharacterBounds, (size_t, gfx::Rect*), (const, override));
    MOCK_METHOD(bool, HasCompositionText, (), (const, override));
    MOCK_METHOD(ui::TextInputClient::FocusReason, GetFocusReason, (), (const, override));
    MOCK_METHOD(bool, GetTextRange, (gfx::Range*), (const, override));
    MOCK_METHOD(bool, GetCompositionTextRange, (gfx::Range*), (const, override));
    MOCK_METHOD(bool, GetEditableSelectionRange, (gfx::Range*), (const, override));
    MOCK_METHOD(bool, SetEditableSelectionRange, (const gfx::Range&), (override));
    MOCK_METHOD(bool, GetTextFromRange, (const gfx::Range&, std::u16string*), (const, override));
    MOCK_METHOD(void, OnInputMethodChanged, (), (override));
    MOCK_METHOD(bool, ChangeTextDirectionAndLayoutAlignment, (base::i18n::TextDirection), (override));
    ...
    MOCK_METHOD(bool, IsTextEditCommandEnabled, (TextEditCommand), (const, override));
    MOCK_METHOD(void, SetTextEditCommandForNextKeyEvent, (TextEditCommand), (override));
    MOCK_METHOD(ukm::SourceId, GetClientSourceForMetrics, (), (const, override));
    MOCK_METHOD(bool, ShouldDoLearning, (), (override));
    MOCK_METHOD(bool, SetCompositionFromExistingText, (const gfx::Range&, const std::vector<ui::ImeTextSpan>&), (override));
    ...
    MOCK_METHOD(
        void, GetActiveTextInputControlLayoutBounds, (std::optional<gfx::Rect> * control_bounds, std::optional<gfx::Rect>* selection_bounds), (override));
#endif
...
public:
    ...
    MOCK_METHOD(void, Activate, (WaylandWindow * window, ui::TextInputClient::FocusReason reason), (override));
    ...
    MOCK_METHOD(void, SetSurroundingText, (const std::string& text, const gfx::Range& preedit_range, const gfx::Range& selection_range), (override));
    MOCK_METHOD(bool, HasAdvancedSurroundingTextSupport, (), (const override));
    MOCK_METHOD(void, SetSurroundingTextOffsetUtf16, (uint32_t offset_utf16), (override));
    MOCK_METHOD(
        void, SetContentType, (ui::TextInputType type, ui::TextInputMode mode, uint32_t flags, bool should_do_learning, bool can_compose_inline), (override));

    MOCK_METHOD(void, SetGrammarFragmentAtCursor, (const ui::GrammarFragment& fragment), (override));
    MOCK_METHOD(void, SetAutocorrectInfo, (const gfx::Range& autocorrect_range, const gfx::Rect& autocorrect_bounds), (override));
};

class TestInputMethodContextDelegate : public LinuxInputMethodContextDelegate {
public:
    TestInputMethodContextDelegate() = default;
    TestInputMethodContextDelegate(const TestInputMethodContextDelegate&) = delete;
    TestInputMethodContextDelegate& operator=(const TestInputMethodContextDelegate&) = delete;
    ...
    void OnSetPreeditRegion(const gfx::Range& range, const std::vector<ImeTextSpan>& spans) override
    {
        was_on_set_preedit_region_called_ = true;
    }

    void OnSetVirtualKeyboardOccludedBounds(const gfx::Rect& screen_bounds) override
    {
        virtual_keyboard_bounds_ = screen_bounds;
    }

    bool was_on_commit_called() const
    {
        return was_on_commit_called_;
    }
    ...
    const std::optional<std::pair<size_t, size_t>>& last_on_delete_surrounding_text_args() const
    {
...
private:
    ...
    std::optional<std::pair<size_t, size_t>> last_on_delete_surrounding_text_args_;
...
public:
    ...
    uint32_t OnKeyboardKeyEvent(EventType type, DomCode dom_code, bool repeat, std::optional<uint32_t> serial, base::TimeTicks timestamp, int device_id,
        WaylandKeyboard::KeyEventKind kind) override
    {
        last_event_timestamp_ = timestamp;
        return 0;
    }
    void OnSynthesizedKeyPressEvent(DomCode dom_code, base::TimeTicks timestamp) override
    {
    }

    base::TimeTicks last_event_timestamp() const
    {
...
public:
    void SetUp() override
    {
        ...
        PostToServerAndWait([](wl::TestWaylandServerThread* server) {
            ...
            // attached.
            wl_seat_send_capabilities(server->seat()->resource(), WL_SEAT_CAPABILITY_KEYBOARD);
        });
...
protected:
    void SetUpInternal()
    {
        input_method_context_delegate_ = std::make_unique<TestInputMethodContextDelegate>();
        keyboard_delegate_ = std::make_unique<TestKeyboardDelegate>();
        input_method_context_ = std::make_unique<WaylandInputMethodContext>(connection_.get(), keyboard_delegate_.get(), input_method_context_delegate_.get());
        input_method_context_->Init(true, nullptr,
    ...
    std::unique_ptr<TestInputMethodContextDelegate> input_method_context_delegate_;
...
using WaylandInputMethodContextOldServerTest = WaylandInputMethodContextTestBase;

INSTANTIATE_TEST_SUITE_P(TextInputExtensionLatestVersion, WaylandInputMethodContextTest,
    ::testing::Values(
        wl::ServerConfig {
            .text_input_extension_version = wl::TestZcrTextInputExtensionV1::Version::kV8,
        },
        wl::ServerConfig {}));

INSTANTIATE_TEST_SUITE_P(TextInputExtensionV7, WaylandInputMethodContextOldServerTest,
    ::testing::Values(wl::ServerConfig { .text_input_extension_version = wl::TestZcrTextInputExtensionV1::Version::kV7 }));
...
TEST_P(WaylandInputMethodContextOldServerTest, SetInputType)
{
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_extension_v1()->extended_text_input(),
            DeprecatedSetInputType(ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_TYPE_URL, ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_MODE_DEFAULT,
                ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_FLAGS_AUTOCOMPLETE_ON, ZCR_EXTENDED_TEXT_INPUT_V1_LEARNING_MODE_ENABLED))
            .Times(1);
    });
    ...
    input_method_context_->UpdateFocus(
        /*has_client=*/true, TEXT_INPUT_TYPE_NONE, attributes, TextInputClient::FOCUS_REASON_OTHER);

    connection_->Flush();

    PostToServerAndWait(
        [](wl::TestWaylandServerThread* server) { Mock::VerifyAndClearExpectations(server->text_input_extension_v1()->extended_text_input()); });
}
...
TEST_P(WaylandInputMethodContextTest, ActivateDeactivate)
{
    ...
    PostToServerAndWait([id = surface_id_](wl::TestWaylandServerThread* server) {
        ...
        EXPECT_CALL(*zwp_text_input, Activate(server->GetObject<wl::MockSurface>(id)->resource())).Times(0);
        EXPECT_CALL(*zwp_text_input, ShowInputPanel()).Times(0);
    });

    LinuxInputMethodContext::TextInputClientAttributes attributes;
    attributes.input_type = TEXT_INPUT_TYPE_TEXT;
    input_method_context_->UpdateFocus(true, ui::TEXT_INPUT_TYPE_NONE, attributes, ui::TextInputClient::FOCUS_REASON_OTHER);
    connection_->Flush();
    ...
    PostToServerAndWait([id = surface_id_](wl::TestWaylandServerThread* server) {
        ...
        EXPECT_CALL(*zwp_text_input, Activate(server->GetObject<wl::MockSurface>(id)->resource()));
    ...
    input_method_context_->UpdateFocus(true, ui::TEXT_INPUT_TYPE_TEXT, attributes, ui::TextInputClient::FOCUS_REASON_NONE);
    connection_->Flush();
...
{
    PostToServerAndWait([](wl::TestWaylandServerThread* server) { EXPECT_CALL(*server->text_input_manager_v1()->text_input(), Reset()); });
...
TEST_P(WaylandInputMethodContextTest, SetCursorLocation)
{
    ...
    PostToServerAndWait([cursor_location, window_bounds](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_manager_v1()->text_input(),
            SetCursorRect(cursor_location.x() - window_bounds.x(), cursor_location.y() - window_bounds.y(), cursor_location.width(), cursor_location.height()));
    });
...
TEST_P(WaylandInputMethodContextTest, SetSurroundingTextForShortText)
{
    ...
    PostToServerAndWait([kExpectedSentText, kExpectedSentRange](wl::TestWaylandServerThread* server) {
        ...
        EXPECT_CALL(*server->text_input_manager_v1()->text_input(), SetSurroundingText(kExpectedSentText, kExpectedSentRange)).Times(1);
    });

    input_method_context_->SetSurroundingText(text, gfx::Range(0, 50), gfx::Range::InvalidRange(), range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, range);
    connection_->Flush();

    PostToServerAndWait([kExpectedSentRange](wl::TestWaylandServerThread* server) {
        ...
        zwp_text_input_v1_send_delete_surrounding_text(text_input->resource(), kExpectedSentRange.start(), kExpectedSentRange.length());
    });

    EXPECT_EQ(input_method_context_delegate_->last_on_delete_surrounding_text_args(), (std::pair<size_t, size_t>(0, 0)));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, std::u16string(40, u'あ'));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(20));
}
...
TEST_P(WaylandInputMethodContextTest, SetSurroundingTextForLongText)
{
    ...
    PostToServerAndWait([expected_sent_text, expected_sent_range](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_manager_v1()->text_input(), SetSurroundingText(expected_sent_text, expected_sent_range)).Times(1);
    });

    input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), gfx::Range::InvalidRange(), range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, range);
    connection_->Flush();

    PostToServerAndWait([expected_sent_range](wl::TestWaylandServerThread* server) {
        auto* text_input = server->text_input_manager_v1()->text_input();
        Mock::VerifyAndClearExpectations(text_input);

        // Test OnDeleteSurroundingText with this input.
        zwp_text_input_v1_send_delete_surrounding_text(text_input->resource(), expected_sent_range.start(), expected_sent_range.length());
    });

    EXPECT_EQ(input_method_context_delegate_->last_on_delete_surrounding_text_args(), (std::pair<size_t, size_t>(0, 0)));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, std::u16string(4600, u'あ'));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(2800));
}
...
TEST_P(WaylandInputMethodContextTest, SetSurroundingTextForLongTextInLeftEdge)
{
    ...
    EXPECT_EQ(input_method_context_delegate_->last_on_delete_surrounding_text_args(), (std::pair<size_t, size_t>(0, 0)));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, std::u16string(4500, u'あ'));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(0));
}

TEST_P(WaylandInputMethodContextTest, SetSurroundingTextForLongTextInRightEdge)
{
    const std::u16string text(5000, u'あ');
    ...
    EXPECT_EQ(input_method_context_delegate_->last_on_delete_surrounding_text_args(), (std::pair<size_t, size_t>(0, 0)));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, std::u16string(4500, u'あ'));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(4500));
}
...
TEST_P(WaylandInputMethodContextTest, DISABLED_SetSurroundingTextForLongRange)
{
    ...
    if (GetApiVersion() == wl::TestZcrTextInputExtensionV1::Version::kV8) {
        ...
        PostToServerAndWait(
            [](wl::TestWaylandServerThread* server) { EXPECT_CALL(*server->text_input_manager_v1()->text_input(), SetSurroundingText(_, _)).Times(0); });

        input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), gfx::Range::InvalidRange(), range);
        // Predicted state in SurroundingTextTracker is reset when the range is
        // longer than wayland message size maximum.
        EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"");
        EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(0));
        connection_->Flush();

        PostToServerAndWait([](wl::TestWaylandServerThread* server) { Mock::VerifyAndClearExpectations(server->text_input_manager_v1()->text_input()); });
    } else {
        // In the new protocol, we can send large selection range.
        const std::string kExpectedSentText = base::UTF16ToUTF8(std::u16string(3332, u'あ'));
...
TEST_P(WaylandInputMethodContextTest, DeleteSurroundingTextWithExtendedRange)
{
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        ...
        zwp_text_input_v1_send_delete_surrounding_text(text_input->resource(), 57, 36);
    });

    EXPECT_EQ(input_method_context_delegate_->last_on_delete_surrounding_text_args(), (std::pair<size_t, size_t>(1, 1)));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, std::u16string(38, u'あ'));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(19));
}
...
TEST_P(WaylandInputMethodContextTest, DeleteSurroundingTextInIncorrectOrder)
{
    ...
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 3), gfx::Range::InvalidRange(), range);
    connection_->Flush();
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        ...
        zwp_text_input_v1_send_delete_surrounding_text(text_input->resource(), 4, 1);
    });
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"aあ");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(2));
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        ...
        zwp_text_input_v1_send_delete_surrounding_text(text_input->resource(), 1, 3);
    });

    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"a");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(1));
    ...
    input_method_context_->SetSurroundingText(u"aあ", gfx::Range(0, 2), gfx::Range::InvalidRange(), gfx::Range(2));
    connection_->Flush();
    ...
    input_method_context_->SetSurroundingText(u"a", gfx::Range(0, 1), gfx::Range::InvalidRange(), gfx::Range(1));
    connection_->Flush();
...
TEST_P(WaylandInputMethodContextTest, DeleteSurroundingTextAndCommitInIncorrectOrder)
{
    ...
    // "String".
    input_method_context_->SetSurroundingText(u"CommitString", gfx::Range(0, 12), gfx::Range::InvalidRange(), gfx::Range(6));
    connection_->Flush();

    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"CommitString");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(6));
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        ...
        zwp_text_input_v1_send_delete_surrounding_text(text_input->resource(), 0, 6);
    });

    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"String");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(0));
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        ...
        zwp_text_input_v1_send_commit_string(server->text_input_manager_v1()->text_input()->resource(), server->GetNextSerial(), "Updated");
    });

    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"UpdatedString");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(7));

    // 4. Set surrounding text for step 2. Ideally this should be sent before step
    // 3.
    input_method_context_->SetSurroundingText(u"String", gfx::Range(0, 6), gfx::Range::InvalidRange(), gfx::Range(0));
    connection_->Flush();
    ...
    input_method_context_->SetSurroundingText(u"UpdatedString", gfx::Range(0, 13), gfx::Range::InvalidRange(), gfx::Range(7));
    connection_->Flush();
...
TEST_P(WaylandInputMethodContextTest, SetInputType)
{
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_extension_v1()->extended_text_input(),
            SetInputType(ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_TYPE_URL, ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_MODE_DEFAULT,
                ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_FLAGS_AUTOCOMPLETE_ON, ZCR_EXTENDED_TEXT_INPUT_V1_LEARNING_MODE_ENABLED,
...
TEST_P(WaylandInputMethodContextTest, SetInputTypeWithoutLearning)
{
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_extension_v1()->extended_text_input(),
            SetInputType(ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_TYPE_URL, ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_MODE_DEFAULT,
                ZCR_EXTENDED_TEXT_INPUT_V1_INPUT_FLAGS_AUTOCOMPLETE_ON, ZCR_EXTENDED_TEXT_INPUT_V1_LEARNING_MODE_DISABLED,
                ZCR_EXTENDED_TEXT_INPUT_V1_INLINE_COMPOSITION_SUPPORT_SUPPORTED))
            .Times(1);
    });
    LinuxInputMethodContext::TextInputClientAttributes attributes;
...
TEST_P(WaylandInputMethodContextTest, SetInputTypeWithoutInlineCompositionSupport)
{
    connection_->window_manager()->SetKeyboardFocusedWindow(window_.get());
    connection_->Flush();
...
TEST_P(WaylandInputMethodContextTest, OnPreeditChanged)
{
    ...
    input_method_context_->OnPreeditString(kPreeditString,
        { { 0, static_cast<uint32_t>(kPreeditString.size()), { { ImeTextSpan::Type::kComposition, ImeTextSpan::Thickness::kThin } } } }, kSelection);
    ...
    EXPECT_EQ(input_method_context_delegate_->last_preedit()->ime_text_spans,
        ImeTextSpans { ImeTextSpan(ImeTextSpan::Type::kComposition, 0, kPreeditString.size(), ImeTextSpan::Thickness::kThin) });
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"PreeditString");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, gfx::Range(0, kPreeditString.size()));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, kSelection);
}

TEST_P(WaylandInputMethodContextTest, OnCommit)
{
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        zwp_text_input_v1_send_commit_string(server->text_input_manager_v1()->text_input()->resource(), server->GetNextSerial(), "CommitString");
    });
    ...
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(12));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, gfx::Range(0));
}

// Regression test for crbug.com/40263583
TEST_P(WaylandInputMethodContextTest, OnCommitAfterEmptyPreeditStringWithoutCursor)
{
    input_method_context_->OnPreeditString("", {}, gfx::Range::InvalidRange());
    EXPECT_TRUE(input_method_context_delegate_->was_on_preedit_changed_called());
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, gfx::Range(0, 0));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(0));
...
{
    input_method_context_->OnPreeditString("PreeditString", {}, gfx::Range::InvalidRange());
    EXPECT_TRUE(input_method_context_delegate_->was_on_preedit_changed_called());
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"PreeditString");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, gfx::Range(0, 13));
    // Cursor should be at the end of preedit when cursor position is not
    // specified.
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(13));
    input_method_context_->OnCommitString("CommitString");
    EXPECT_TRUE(input_method_context_delegate_->was_on_commit_called());
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"CommitString");
    // On commit string, selection is placed next to the last character unless the
...
TEST_P(WaylandInputMethodContextTest, OnConfirmCompositionText)
{
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_manager_v1()->text_input(), SetSurroundingText("ab😀cあdef", gfx::Range(7, 10)));
    });
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 9), gfx::Range::InvalidRange(), range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, range);
    connection_->Flush();
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        ...
        zwp_text_input_v1_send_cursor_position(text_input->resource(), sent_range.start(), sent_range.end());
        zwp_text_input_v1_send_commit_string(text_input->resource(), 0, "ab😀cあdef");
    });

    EXPECT_THAT(input_method_context_delegate_->last_on_confirm_composition_arg(), Optional(true));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
...
TEST_P(WaylandInputMethodContextTest, OnConfirmCompositionTextExtendedKeepSelectionNoComposition)
{
    input_method_context_->SetSurroundingText(u"abcd", gfx::Range(0, 4), gfx::Range::InvalidRange(), gfx::Range(0, 4));
    connection_->Flush();

    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        zcr_extended_text_input_v1_send_confirm_preedit(server->text_input_extension_v1()->extended_text_input()->resource(),
            /*selection_behavior=*/
    ...
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(0, 4));
}

TEST_P(WaylandInputMethodContextTest, OnConfirmCompositionTextExtendedKeepSelectionComposition)
{
    input_method_context_->SetSurroundingText(u"abcd", gfx::Range(0, 4), gfx::Range::InvalidRange(), gfx::Range(2));
    ...
    EXPECT_THAT(input_method_context_delegate_->last_on_confirm_composition_arg(), Optional(true));
    // Selection range should not be changed.
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(3));
}

TEST_P(WaylandInputMethodContextTest, OnConfirmCompositionTextExtendedDontKeepSelectionNoComposition)
{
    input_method_context_->SetSurroundingText(u"abcd", gfx::Range(0, 4), gfx::Range::InvalidRange(), gfx::Range(0, 4));
    connection_->Flush();
    ...
    EXPECT_THAT(input_method_context_delegate_->last_on_confirm_composition_arg(), Optional(false));
    // Selection range should not be changed.
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(0, 4));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, gfx::Range(0));
}

TEST_P(WaylandInputMethodContextTest, OnConfirmCompositionTextExtendedDontKeepSelectionComposition)
{
    input_method_context_->SetSurroundingText(u"abcd", gfx::Range(0, 4), gfx::Range::InvalidRange(), gfx::Range(2));
    input_method_context_->OnPreeditString("xyz", {}, gfx::Range(1));
    connection_->Flush();
    ...
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(5));
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, gfx::Range(0));
}
...
TEST_P(WaylandInputMethodContextTest, OnConfirmCompositionTextForLongRange)
{
    ...
    // SetSurroundingText should be called in UTF-8.
    PostToServerAndWait([expected_sent_text, expected_sent_range](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_manager_v1()->text_input(), SetSurroundingText(expected_sent_text, expected_sent_range));
    });
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), gfx::Range::InvalidRange(), range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, range);
    ...
    PostToServerAndWait([expected_sent_text, expected_sent_range](wl::TestWaylandServerThread* server) {
        ...
        gfx::Range range = gfx::Range(expected_sent_range.end(), expected_sent_range.start());

        zwp_text_input_v1_send_cursor_position(text_input->resource(), range.start(), range.end());
        zwp_text_input_v1_send_commit_string(text_input->resource(), 0, expected_sent_text.c_str());
    });
...
TEST_P(WaylandInputMethodContextTest, OnSetPreeditRegion_Success)
{
    ...
    // SetSurroundingText should be called in UTF-8.
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_manager_v1()->text_input(), SetSurroundingText("abcあdef", gfx::Range(3, 6)));
    });

    input_method_context_->SetSurroundingText(text, gfx::Range(0, 7), gfx::Range::InvalidRange(), range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, range);
    connection_->Flush();

    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        Mock::VerifyAndClearExpectations(server->text_input_manager_v1()->text_input());

        // Specify "cあd" as a new preedit region.
        zcr_extended_text_input_v1_send_set_preedit_region(server->text_input_extension_v1()->extended_text_input()->resource(), -4, 5);
    });

    EXPECT_TRUE(input_method_context_delegate_->was_on_set_preedit_region_called());
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, gfx::Range(2, 5));
}
...
TEST_P(WaylandInputMethodContextTest, OnSetPreeditRegion_NoSurroundingText)
{
    ...
    PostToServerAndWait([](wl::TestWaylandServerThread* server) {
        zcr_extended_text_input_v1_send_set_preedit_region(server->text_input_extension_v1()->extended_text_input()->resource(), -1, 3);
    });
    EXPECT_FALSE(input_method_context_delegate_->was_on_set_preedit_region_called());
}

// The range is represented in UTF-16 code points, so it is independent from
// grapheme clusters.
TEST_P(WaylandInputMethodContextTest, OnSetPreeditRegion_GraphemeClusterIndependeceSimple)
{
    ...
    PostToServerAndWait([u8_range, u8_text](wl::TestWaylandServerThread* server) {
        EXPECT_CALL(*server->text_input_manager_v1()->text_input(), SetSurroundingText(u8_text, u8_range));
    });

    input_method_context_->SetSurroundingText(u16_text, gfx::Range(0, 1), gfx::Range::InvalidRange(), u16_range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u16_text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, u16_range);
    connection_->Flush();
    ...
    PostToServerAndWait([u8_range](wl::TestWaylandServerThread* server) {
        ...
        zcr_extended_text_input_v1_send_set_preedit_region(
            server->text_input_extension_v1()->extended_text_input()->resource(), -static_cast<int32_t>(u8_range.length()), u8_range.length());
    });

    EXPECT_TRUE(input_method_context_delegate_->was_on_set_preedit_region_called());
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().composition, u16_range);
}

TEST_P(WaylandInputMethodContextTest, OnSetPreeditRegion_GraphemeClusterIndependeceCombined)
{
    ...
    input_method_context_->SetSurroundingText(u16_text, gfx::Range(0, 2), gfx::Range::InvalidRange(), u16_range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u16_text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, u16_range);
    connection_->Flush();
...
TEST_P(WaylandInputMethodContextTest, OnSetVirtualKeyboardOccludedBoundsUpdatesPastTextInputClients)
{
    ...
    input_method_context_->UpdateFocus(true, client1->GetTextInputType(), attributes, ui::TextInputClient::FOCUS_REASON_OTHER);
    input_method_context_->WillUpdateFocus(client2.get(), nullptr);
    attributes.input_type = TEXT_INPUT_TYPE_NONE;
    input_method_context_->UpdateFocus(false, client2->GetTextInputType(), attributes, ui::TextInputClient::FOCUS_REASON_NONE);
...
TEST_P(WaylandInputMethodContextTest, OnSetVirtualKeyboardOccludedBoundsWithDeletedPastTextInputClient)
{
    ...
    LinuxInputMethodContext::TextInputClientAttributes attributes;
    attributes.input_type = TEXT_INPUT_TYPE_NONE;
    input_method_context_->UpdateFocus(false, client->GetTextInputType(), attributes, ui::TextInputClient::FOCUS_REASON_NONE);
...
{
    PostToServerAndWait([](wl::TestWaylandServerThread* server) { EXPECT_CALL(*server->text_input_manager_v1()->text_input(), ShowInputPanel()).Times(1); });
...
{
    PostToServerAndWait([](wl::TestWaylandServerThread* server) { EXPECT_CALL(*server->text_input_manager_v1()->text_input(), HideInputPanel()); });
...
TEST_P(WaylandInputMethodContextTest, UpdateVirtualKeyboardState)
{
    ...
    PostToServerAndWait(
        [](wl::TestWaylandServerThread* server) { zwp_text_input_v1_send_input_panel_state(server->text_input_manager_v1()->text_input()->resource(), 1); });

    EXPECT_TRUE(input_method_context_->IsKeyboardVisible());

    PostToServerAndWait(
        [](wl::TestWaylandServerThread* server) { zwp_text_input_v1_send_input_panel_state(server->text_input_manager_v1()->text_input()->resource(), 0); });
...
TEST_P(WaylandInputMethodContextTest, OnKeySym)
{
    ...
    input_method_context_->OnKeysym(XKB_KEY_Shift_L, wl_keyboard_key_state::WL_KEYBOARD_KEY_STATE_PRESSED, 0, test_timestamp);

    ASSERT_EQ(wl::EventMillisecondsToTimeTicks(test_timestamp), keyboard_delegate_->last_event_timestamp());
#endif
}

namespace {

std::unique_ptr<KeyEvent> CreateKeyEventForCharacterComposer(KeyboardCode keyboard_code, DomCode dom_code, DomKey dom_key)
{
    auto event = std::make_unique<KeyEvent>(EventType::kKeyPressed, keyboard_code, dom_code, EF_NONE, dom_key, EventTimeForNow());
...
TEST_P(WaylandInputMethodContextTest, CharacterComposerPreeditStringDeadKey)
{
    ...
    auto event = CreateKeyEventForCharacterComposer(VKEY_UNKNOWN, DomCode::NONE, DomKey::DeadKeyFromCombiningCharacter(kCombiningAcute));
    ...
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, preedit_string);

    event = CreateKeyEventForCharacterComposer(VKEY_A, DomCode::US_A, DomKey::FromCharacter('a'));
    EXPECT_TRUE(input_method_context_->DispatchKeyEvent(*event));
    EXPECT_TRUE(input_method_context_delegate_->was_on_preedit_changed_called());
    EXPECT_TRUE(input_method_context_delegate_->was_on_commit_called());
...
TEST_P(WaylandInputMethodContextTest, CharacterComposerPreeditStringComposeKey)
{
    auto event = CreateKeyEventForCharacterComposer(VKEY_COMPOSE, DomCode::ALT_RIGHT, DomKey::COMPOSE);
    EXPECT_TRUE(input_method_context_->DispatchKeyEvent(*event));
    EXPECT_TRUE(input_method_context_delegate_->was_on_preedit_changed_called());

#if BUILDFLAG(IS_LINUX)
    std::u16string preedit_string(1, ui::CharacterComposer::kPreeditStringComposeKeySymbol);
#else
    std::u16string preedit_string = u"";
#endif // BUILDFLAG(IS_LINUX)
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, preedit_string);

    event = CreateKeyEventForCharacterComposer(VKEY_OEM_7, DomCode::QUOTE, DomKey::FromCharacter('\''));
    EXPECT_TRUE(input_method_context_->DispatchKeyEvent(*event));
    EXPECT_TRUE(input_method_context_delegate_->was_on_preedit_changed_called());
...
class WaylandInputMethodContextNoKeyboardTest : public WaylandInputMethodContextTest {
public:
    void SetUp() override
    {
...
INSTANTIATE_TEST_SUITE_P(TextInputExtensionLatestVersion, WaylandInputMethodContextNoKeyboardTest, ::testing::Values(wl::ServerConfig {}));
...
TEST_P(WaylandInputMethodContextNoKeyboardTest, ActivateDeactivate)
{
    ...
    attributes.input_type = TEXT_INPUT_TYPE_NONE;
    input_method_context_->UpdateFocus(false, ui::TEXT_INPUT_TYPE_TEXT, attributes, ui::TextInputClient::FOCUS_REASON_NONE);
    connection_->Flush();
...
TEST_P(WaylandInputMethodContextNoKeyboardTest, UpdateFocusBetweenTextFields)
{
    ...
    attributes.input_type = TEXT_INPUT_TYPE_TEXT;
    input_method_context_->UpdateFocus(false, ui::TEXT_INPUT_TYPE_TEXT, attributes, ui::TextInputClient::FOCUS_REASON_OTHER);
    connection_->Flush();
...
TEST_F(WaylandInputMethodContextWithMockWrapperTest, SetSurroundingShortTextWithCompositionRange)
{
    const std::u16string text(50, u'あ');
    constexpr gfx::Range range(20, 30);
    ...
    EXPECT_CALL(*mock_wrapper_, SetSurroundingText(kExpectedSentText, kExpectedSentRange, kExpectedSentRange));
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 50), range, range);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, range);
    connection_->Flush();
}

TEST_F(WaylandInputMethodContextWithMockWrapperTest, SetSurroundingLongTextWithCompositionRange)
{
    const std::u16string text(5000, u'あ');
    constexpr gfx::Range kRange(2800, 3200);

    const std::string kExpectedSentText(base::UTF16ToUTF8(std::u16string(1332, u'あ')));
    constexpr gfx::Range kExpectedSentRange(1398, 2598);

    EXPECT_CALL(*mock_wrapper_, SetSurroundingText(kExpectedSentText, kExpectedSentRange, kExpectedSentRange));
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), kRange, kRange);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, kRange);
}

TEST_F(WaylandInputMethodContextWithMockWrapperTest, SetSurroundingLongTextWithCompositionRangeOutsideSurroundingTextRange)
{
    const std::u16string text(5000, u'あ');
    ...
    EXPECT_CALL(*mock_wrapper_, SetSurroundingText(kExpectedSentText, gfx::Range::InvalidRange(), kExpectedSentSelectionRange));
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), kCompositionRange, kSelectionRange);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, kSelectionRange);

    // composition range after surrounding text range.
    constexpr gfx::Range kCompositionRange2(4500, 4600);

    EXPECT_CALL(*mock_wrapper_, SetSurroundingText(kExpectedSentText, gfx::Range::InvalidRange(), kExpectedSentSelectionRange));
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), kCompositionRange2, kSelectionRange);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, kSelectionRange);
}

TEST_F(WaylandInputMethodContextWithMockWrapperTest, SetSurroundingWithCompositionRangeOutideText)
{
    const std::u16string text(5000, u'あ');
    constexpr gfx::Range kSelectionRange(2800, 3200);

    EXPECT_CALL(*mock_wrapper_, SetSurroundingText(_, _, _)).Times(0);
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), gfx::Range(6000, 7000), kSelectionRange);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, kSelectionRange);
}

TEST_F(WaylandInputMethodContextWithMockWrapperTest, SetSurroundingWithCompositionRangeInvalid)
{
    const std::u16string text(5000, u'あ');
    constexpr gfx::Range kSelectionRange(2800, 3200);
    ...
    input_method_context_->SetSurroundingText(text, gfx::Range(0, 5000), gfx::Range::InvalidRange(), kSelectionRange);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, kSelectionRange);
}
...
TEST_F(WaylandInputMethodContextWithMockWrapperTest, OnPreeditChanged)
{
    ...
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(10, 20));

    // cursor end before begin
    input_method_context_->OnPreeditString(text_utf8, {}, { 60, 30 });
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(20, 10));
}

TEST_F(WaylandInputMethodContextWithMockWrapperTest, OnPreeditChangedInvalidCursorEnd)
{
    const std::u16string text(50, u'あ');
    const std::string text_utf8 = base::UTF16ToUTF8(text);
    ...
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().surrounding_text, u"");
    EXPECT_EQ(input_method_context_->predicted_state_for_testing().selection, gfx::Range(0, 0));
...
TEST_F(WaylandInputMethodContextWithMockWrapperTest, OnPreeditChangedGnomeWorkaround)
{
    const std::u16string text(50, u'あ');
    const std::string text_utf8 = base::UTF16ToUTF8(text);
    ...
    input_method_context = std::make_unique<WaylandInputMethodContext>(connection_.get(), keyboard_delegate_.get(), input_method_context_delegate_.get());
    auto mock_wrapper = std::make_unique<MockZWPTextInputWrapper>();
    input_method_context->Init(true, std::move(mock_wrapper), base::nix::DESKTOP_ENVIRONMENT_KDE3);

    input_method_context->OnPreeditString(text_utf8, {}, { 60, 30 });
    EXPECT_EQ(input_method_context->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context->predicted_state_for_testing().selection, gfx::Range(20, 10));

    // workaround should be used when desktop is gnome.
    input_method_context = std::make_unique<WaylandInputMethodContext>(connection_.get(), keyboard_delegate_.get(), input_method_context_delegate_.get());
    mock_wrapper = std::make_unique<MockZWPTextInputWrapper>();
    input_method_context->Init(true, std::move(mock_wrapper), base::nix::DESKTOP_ENVIRONMENT_GNOME);
    input_method_context->OnPreeditString(text_utf8, {}, { 60, 30 });
    EXPECT_EQ(input_method_context->predicted_state_for_testing().surrounding_text, text);
    EXPECT_EQ(input_method_context->predicted_state_for_testing().selection, gfx::Range(20, 20));
}
