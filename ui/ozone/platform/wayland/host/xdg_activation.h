...
public:
    ...
    XdgActivation(wl::Object<xdg_activation_v1> xdg_activation_v1, WaylandConnection* connection);
...
private:
    ...
    void OnTokenRequestCompleted(base::nix::XdgActivationTokenCallback callback, std::string token);
    ...
    scoped_refptr<base::SequencedTaskRunner> task_runner_ = base::SequencedTaskRunner::GetCurrentDefault();
