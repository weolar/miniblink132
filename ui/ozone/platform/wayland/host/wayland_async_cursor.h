...
public:
    ...
    static scoped_refptr<WaylandAsyncCursor> FromPlatformCursor(scoped_refptr<PlatformCursor> platform_cursor);
    ...
    scoped_refptr<BitmapCursor> bitmap_cursor() const
    {
        return bitmap_cursor_;
    }
