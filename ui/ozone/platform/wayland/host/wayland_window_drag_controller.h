...
public:
    ...
    WaylandWindowDragController(WaylandConnection* connection, WaylandDataDeviceManager* device_manager, WaylandPointer::Delegate* pointer_delegate,
        WaylandTouch::Delegate* touch_delegate, WaylandKeyboard::Delegate* keyboard_delegate);
    WaylandWindowDragController(const WaylandWindowDragController&) = delete;
    WaylandWindowDragController& operator=(const WaylandWindowDragController&) = delete;
    ...
    bool StartDragSession(WaylandToplevelWindow* origin, mojom::DragEventSource event_source);
    ...
    std::optional<mojom::DragEventSource> drag_source()
    {
        return drag_source_;
    }
...
private:
    ...
    std::optional<wl::Serial> GetSerial(mojom::DragEventSource drag_source, WaylandToplevelWindow* origin);
