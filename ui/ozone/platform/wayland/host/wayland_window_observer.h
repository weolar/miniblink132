...
public:
    ...
    virtual void OnSubsurfaceAdded(WaylandWindow* window, WaylandSubsurface* subsurface);

    // Called when |window| removes |subsurface|.
    virtual void OnSubsurfaceRemoved(WaylandWindow* window, WaylandSubsurface* subsurface);
