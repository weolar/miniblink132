...
class XdgForeignWrapper : public wl::GlobalObjectRegistrar<XdgForeignWrapper>, public WaylandWindowObserver {
public:
    ...
    XdgForeignWrapper(WaylandConnection* connection, wl::Object<zxdg_exporter_v1> exporter_v1);
    XdgForeignWrapper(WaylandConnection* connection, wl::Object<zxdg_exporter_v2> exporter_v2);
