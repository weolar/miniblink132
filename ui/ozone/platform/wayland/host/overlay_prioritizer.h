...
class OverlayPrioritizer : public wl::GlobalObjectRegistrar<OverlayPrioritizer> {
public:
    ...
    explicit OverlayPrioritizer(overlay_prioritizer* prioritizer, WaylandConnection* connection);
    OverlayPrioritizer(const OverlayPrioritizer&) = delete;
    OverlayPrioritizer& operator=(const OverlayPrioritizer&) = delete;
    ~OverlayPrioritizer();

    wl::Object<overlay_prioritized_surface> CreateOverlayPrioritizedSurface(wl_surface* surface);
