...
class WaylandZcrTouchpadHaptics : public wl::GlobalObjectRegistrar<WaylandZcrTouchpadHaptics> {
public:
    ...
    WaylandZcrTouchpadHaptics(zcr_touchpad_haptics_v1* zcr_touchpad_haptics, WaylandConnection* connection);
    WaylandZcrTouchpadHaptics(const WaylandZcrTouchpadHaptics&) = delete;
    WaylandZcrTouchpadHaptics& operator=(const WaylandZcrTouchpadHaptics&) = delete;
...
private:
    ...
    static void OnActivated(void* data, zcr_touchpad_haptics_v1* touchpad_haptics);
    static void OnDeactivated(void* data, zcr_touchpad_haptics_v1* touchpad_haptics);
