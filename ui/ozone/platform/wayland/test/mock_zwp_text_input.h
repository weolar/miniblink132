...
public:
    ...
    MOCK_METHOD(void, SetCursorRect, (int32_t x, int32_t y, int32_t width, int32_t height));
    MOCK_METHOD(void, SetSurroundingText, (std::string text, gfx::Range selection_range));
    MOCK_METHOD(void, SetContentType, (uint32_t content_hint, uint32_t content_purpose));
