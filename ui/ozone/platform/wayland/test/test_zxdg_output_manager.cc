...
void GetXdgOutput(wl_client* client, wl_resource* resource, uint32_t id, wl_resource* output_resource)
{
    wl_resource* zxdg_output_resource = CreateResourceWithImpl<TestZXdgOutput>(client, &zxdg_output_v1_interface, kZXdgOutputVersion, &kTestZXdgOutputImpl, id);
...
TestZXdgOutputManager::TestZXdgOutputManager()
    : GlobalObject(&zxdg_output_manager_v1_interface, &kTestZXdgOutputManagerImpl, kZXdgOutputManagerVersion)
{
}
