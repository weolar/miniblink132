...
extern const struct zcr_color_management_surface_v1_interface kTestZcrColorManagementSurfaceV1Impl;
...
public:
    ...
    TestZcrColorManagementSurfaceV1(const TestZcrColorManagementSurfaceV1&) = delete;
    TestZcrColorManagementSurfaceV1& operator=(const TestZcrColorManagementSurfaceV1&) = delete;
