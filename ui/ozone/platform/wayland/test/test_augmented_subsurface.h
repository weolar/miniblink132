...
extern const struct augmented_sub_surface_interface kTestAugmentedSubSurfaceImpl;
...
public:
    ...
    TestAugmentedSubSurface& operator=(const TestAugmentedSubSurface& rhs) = delete;

    wl_resource* sub_surface() const
    {
        return sub_surface_;
    }
