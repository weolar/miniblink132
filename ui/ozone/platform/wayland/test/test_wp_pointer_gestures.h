...
public:
    ...
    TestPinchGesture* pinch() const
    {
        return pinch_;
    }

    TestHoldGesture* hold() const
    {
        return hold_;
    }

    static void GetSwipeGesture(struct wl_client* client, struct wl_resource* resource, uint32_t id, struct wl_resource* pointer);

    static void GetPinchGesture(struct wl_client* client, struct wl_resource* pointer_gestures_resource, uint32_t id, struct wl_resource* pointer);

    static void GetHoldGesture(struct wl_client* client, struct wl_resource* pointer_gestures_resource, uint32_t id, struct wl_resource* pointer);
