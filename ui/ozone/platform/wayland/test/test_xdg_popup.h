...
public:
    ...
    uint32_t grab_serial() const
    {
        return grab_serial_;
    }
    void set_grab_serial(uint32_t serial)
    {
        grab_serial_ = serial;
    }

    gfx::Rect anchor_rect() const
    {
        return position_.anchor_rect;
    }
    gfx::Size size() const
    {
    ...
    {
        return position_.anchor;
    }
    uint32_t gravity() const
    {
        return position_.gravity;
    }
