...
void TestOutput::SetLogicalTransform(wl_output_transform aura_logical_transform)
{
...
void TestOutput::Flush()
{
    ...
    wl_output_send_geometry(resource(), metrics_.wl_origin.x(), metrics_.wl_origin.y(), 0 /* physical_width */, 0 /* physical_height */, 0 /* subpixel */,
        kUnknownMake, kUnknownModel, metrics_.wl_panel_transform);
    wl_output_send_mode(resource(), WL_OUTPUT_MODE_CURRENT, metrics_.wl_physical_size.width(), metrics_.wl_physical_size.height(), 0);
