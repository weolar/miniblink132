...
extern const struct zcr_color_management_output_v1_interface kTestZcrColorManagementOutputV1Impl;
...
public:
    ...
    TestZcrColorManagementOutputV1(const TestZcrColorManagementOutputV1&) = delete;
    TestZcrColorManagementOutputV1& operator=(const TestZcrColorManagementOutputV1&) = delete;
    ...
    TestZcrColorSpaceV1* GetZcrColorSpace() const
    {
        return zcr_color_space_;
    }
