...
int MockDrmSyncobjIoctlWrapper::SyncobjCreate(uint32_t flags, uint32_t* handle)
{
...
int MockDrmSyncobjIoctlWrapper::SyncobjHandleToFD(uint32_t handle, int* obj_fd)
{
