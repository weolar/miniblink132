...
extern const struct zwp_text_input_manager_v1_interface kTestZwpTextInputManagerV1Impl;
extern const struct zwp_text_input_manager_v3_interface kTestZwpTextInputManagerV3Impl;
...
public:
    ...
    TestZwpTextInputManagerV1& operator=(const TestZwpTextInputManagerV1&) = delete;
    ...
    MockZwpTextInputV1* text_input() const
    {
        return text_input_;
    }
...
public:
    ...
    TestZwpTextInputManagerV3& operator=(const TestZwpTextInputManagerV3&) = delete;
    ...
    MockZwpTextInputV3* text_input() const
    {
        return text_input_;
    }
