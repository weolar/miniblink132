...
void TextInputV1Activate(wl_client* client, wl_resource* resource, wl_resource* seat, wl_resource* surface)
{
    GetUserDataAs<MockZwpTextInputV1>(resource)->Activate(surface);
}

void TextInputV1Deactivate(wl_client* client, wl_resource* resource, wl_resource* seat)
{
...
void TextInputV1SetSurroundingText(wl_client* client, wl_resource* resource, const char* text, uint32_t cursor, uint32_t anchor)
{
    GetUserDataAs<MockZwpTextInputV1>(resource)->SetSurroundingText(text, gfx::Range(cursor, anchor));
}

void TextInputV1SetContentType(wl_client* client, wl_resource* resource, uint32_t content_hint, uint32_t content_purpose)
{
    GetUserDataAs<MockZwpTextInputV1>(resource)->SetContentType(content_hint, content_purpose);
}

void TextInputV1SetCursorRectangle(wl_client* client, wl_resource* resource, int32_t x, int32_t y, int32_t width, int32_t height)
{
    GetUserDataAs<MockZwpTextInputV1>(resource)->SetCursorRect(x, y, width, height);
}
...
void TextInputV3Disable(struct wl_client* client, struct wl_resource* resource)
{
    GetUserDataAs<MockZwpTextInputV3>(resource)->Disable();
}

void TextInputV3SetSurroundingText(struct wl_client* client, struct wl_resource* resource, const char* text, int32_t cursor, int32_t anchor)
{
    GetUserDataAs<MockZwpTextInputV3>(resource)->SetSurroundingText(text, gfx::Range(anchor, cursor));
}

void TextInputV3SetTextChangeCause(struct wl_client* client, struct wl_resource* resource, uint32_t cause)
{
    GetUserDataAs<MockZwpTextInputV3>(resource)->SetTextChangeCause(cause);
}

void TextInputV3SetContentType(struct wl_client* client, struct wl_resource* resource, uint32_t hint, uint32_t purpose)
{
    GetUserDataAs<MockZwpTextInputV3>(resource)->SetContentType(hint, purpose);
}

void TextInputV3SetCursorRectangle(struct wl_client* client, struct wl_resource* resource, int32_t x, int32_t y, int32_t width, int32_t height)
{
    GetUserDataAs<MockZwpTextInputV3>(resource)->SetCursorRect(x, y, width, height);
}
