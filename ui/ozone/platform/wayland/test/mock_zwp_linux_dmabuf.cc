...
{
    wl_resource* params_resource = CreateResourceWithImpl<TestZwpLinuxBufferParamsV1>(
        client, &zwp_linux_buffer_params_v1_interface, wl_resource_get_version(resource), &kTestZwpLinuxBufferParamsV1Impl, id);

    auto* zwp_linux_dmabuf = GetUserDataAs<MockZwpLinuxDmabufV1>(resource);
    auto* buffer_params = GetUserDataAs<TestZwpLinuxBufferParamsV1>(params_resource);
...
MockZwpLinuxDmabufV1::MockZwpLinuxDmabufV1()
    : GlobalObject(&zwp_linux_dmabuf_v1_interface, &kMockZwpLinuxDmabufV1Impl, kLinuxDmabufVersion)
{
}
...
void MockZwpLinuxDmabufV1::StoreBufferParams(TestZwpLinuxBufferParamsV1* params)
{
    buffer_params_.push_back(params);
}

void MockZwpLinuxDmabufV1::OnBufferParamsDestroyed(TestZwpLinuxBufferParamsV1* params)
{
