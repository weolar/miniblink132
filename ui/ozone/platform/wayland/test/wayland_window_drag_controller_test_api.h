...
public:
    ...
    WaylandWindowDragControllerTestApi(const WaylandWindowDragControllerTestApi&) = delete;
    WaylandWindowDragControllerTestApi& operator=(const WaylandWindowDragControllerTestApi&) = delete;
    ...
    WaylandWindow* drag_target_window()
    {
        return impl_->drag_target_window_;
    }
    WaylandWindow* dragged_window()
    {
        return impl_->dragged_window_;
    }
    WaylandWindow* origin_window()
    {
        return impl_->origin_window_;
    }
    WaylandWindow* pointer_grab_owner()
    {
        return impl_->pointer_grab_owner_;
    }
    const gfx::Vector2d& drag_offset() const
    {
        return impl_->drag_offset_;
    }
    bool has_received_enter() const
    {
        return impl_->has_received_enter_;
    }

    WaylandTouch::Delegate* touch_delegate()
    {
        return impl_->touch_delegate_;
    }
