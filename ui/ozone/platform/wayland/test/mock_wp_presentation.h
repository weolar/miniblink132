...
public:
    ...
    MOCK_METHOD2(Destroy, void(struct wl_client* client, struct wl_resource* resource));
    MOCK_METHOD4(Feedback, void(struct wl_client* client, struct wl_resource* resource, struct wl_resource* surface, uint32_t callback));
    ...
    // value.
    void SendPresentationFeedbackToClient(bool last, std::optional<PresentationFeedbackParams> params);
