...
extern const struct xdg_toplevel_icon_manager_v1_interface kMockXdgToplevelIconManagerImpl;
...
public:
    ...
    MockXdgToplevelIconManagerV1& operator=(const MockXdgToplevelIconManagerV1&) = delete;

    ~MockXdgToplevelIconManagerV1() override;

    void set_icon(MockXdgToplevelIconV1* icon)
    {
        icon_ = icon;
    }
    MockXdgToplevelIconV1* icon()
    {
        return icon_;
    }

    XdgToplevelIconResources& resources()
    {
        return resources_;
    }
...
public:
    MockXdgToplevelIconV1(wl_resource* resource, MockXdgToplevelIconManagerV1* global);
