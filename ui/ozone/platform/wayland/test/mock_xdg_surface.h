...
public:
    ...
    MockXdgTopLevel* xdg_toplevel() const
    {
        return xdg_toplevel_.get();
    }

    void set_xdg_popup(TestXdgPopup* xdg_popup)
    {
        xdg_popup_ = xdg_popup;
    }
    TestXdgPopup* xdg_popup() const
    {
        return xdg_popup_;
    }
...
public:
    ...
    TestZAuraToplevel* zaura_toplevel()
    {
        return zaura_toplevel_;
    }
