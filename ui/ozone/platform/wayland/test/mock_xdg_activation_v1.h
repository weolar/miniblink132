...
extern const struct xdg_activation_token_v1_interface kMockXdgActivationTokenV1Impl;
...
public:
    ...
    MockXdgActivationTokenV1* get_token()
    {
        return token_;
    }
    void set_token(MockXdgActivationTokenV1* token)
    {
        token_ = token;
    }

    MOCK_METHOD4(Activate, void(struct wl_client* client, struct wl_resource* resource, const char* token, struct wl_resource* surface));
    MOCK_METHOD3(TokenSetSurface, void(struct wl_client* client, struct wl_resource* resource, struct wl_resource* surface));

    MOCK_METHOD2(TokenCommit, void(struct wl_client* client, struct wl_resource* resource));
...
public:
    explicit MockXdgActivationTokenV1(wl_resource* resource, MockXdgActivationV1* global);
