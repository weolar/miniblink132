...
public:
    ...
    MOCK_METHOD(void, SetAcquirePoint, (int timeline_fd, uint64_t acquire_point), ());
    MOCK_METHOD(void, SetReleasePoint, (int timeline_fd, uint64_t acquire_point), ());
};

class TestLinuxDrmSyncobjTimeline : public ServerObject {
public:
    TestLinuxDrmSyncobjTimeline(wl_resource* resource, TestWpLinuxDrmSyncobjManagerV1* manager, int fd);
...
public:
    ...
    TestWpLinuxDrmSyncobjManagerV1(const TestWpLinuxDrmSyncobjManagerV1&) = delete;
    TestWpLinuxDrmSyncobjManagerV1& operator=(const TestWpLinuxDrmSyncobjManagerV1&) = delete;
