...
extern const struct zcr_text_input_extension_v1_interface kTestZcrTextInputExtensionV1Impl;
...
public:
    ...
    TestZcrTextInputExtensionV1& operator=(const TestZcrTextInputExtensionV1&) = delete;
