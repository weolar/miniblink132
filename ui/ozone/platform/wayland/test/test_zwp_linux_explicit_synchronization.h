...
public:
    TestLinuxSurfaceSynchronization(wl_resource* resource, wl_resource* surface_resource);
    ~TestLinuxSurfaceSynchronization() override;

    wl_resource* surface_resource() const
    {
...
public:
    ...
    TestZwpLinuxExplicitSynchronizationV1(const TestZwpLinuxExplicitSynchronizationV1& rhs) = delete;
    TestZwpLinuxExplicitSynchronizationV1& operator=(const TestZwpLinuxExplicitSynchronizationV1& rhs) = delete;
};
