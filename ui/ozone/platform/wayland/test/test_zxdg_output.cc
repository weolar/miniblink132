...
{
    zxdg_output_v1_send_logical_size(resource(), metrics.xdg_logical_size.width(), metrics.xdg_logical_size.height());
    zxdg_output_v1_send_logical_position(resource(), metrics.xdg_logical_origin.x(), metrics.xdg_logical_origin.y());
}
