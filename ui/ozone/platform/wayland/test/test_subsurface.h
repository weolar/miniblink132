...
public:
    explicit TestSubSurface(wl_resource* resource, wl_resource* surface, wl_resource* parent_resource);
    ...
    wl_resource* parent_resource() const
    {
...
private:
    ...
    raw_ptr<TestAugmentedSubSurface, DanglingUntriaged> augmented_subsurface_ = nullptr;
};
