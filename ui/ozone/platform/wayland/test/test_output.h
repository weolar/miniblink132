...
public:
    ...
    public:
        ...
        virtual void OnTestOutputFlush(TestOutput* test_output, const TestOutputMetrics& metrics) = 0;
    ...
    void set_aura_shell_enabled()
    {
        aura_shell_enabled_ = true;
    }
    bool aura_shell_enabled()
    {
        return aura_shell_enabled_;
    }
