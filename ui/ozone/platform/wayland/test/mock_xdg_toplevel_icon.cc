...
void CreateIcon(struct wl_client* client, struct wl_resource* resource, uint32_t id)
{
    auto* global = GetUserDataAs<MockXdgToplevelIconManagerV1>(resource);
    wl_resource* icon = CreateResourceWithImpl<MockXdgToplevelIconV1>(client, &xdg_toplevel_icon_v1_interface, 1, &kMockXdgToplevelIconImpl, id, global);
    global->set_icon(GetUserDataAs<MockXdgToplevelIconV1>(icon));
}

void SetIcon(struct wl_client* client, struct wl_resource* resource, struct wl_resource* toplevel, struct wl_resource* icon)
{
...
const struct xdg_toplevel_icon_manager_v1_interface kMockXdgToplevelIconManagerImpl = {
...
MockXdgToplevelIconManagerV1::MockXdgToplevelIconManagerV1()
    : GlobalObject(&xdg_toplevel_icon_manager_v1_interface, &kMockXdgToplevelIconManagerImpl, 1)
{
}
...
void SetName(struct wl_client* client, struct wl_resource* resource, const char* icon_name)
{
}

void AddBuffer(struct wl_client* client, struct wl_resource* resource, struct wl_resource* buffer, int32_t scale)
{
...
MockXdgToplevelIconV1::MockXdgToplevelIconV1(wl_resource* resource, MockXdgToplevelIconManagerV1* global)
