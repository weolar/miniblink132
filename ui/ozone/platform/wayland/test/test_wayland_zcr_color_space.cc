...
const struct zcr_color_space_v1_interface kTestZcrColorSpaceV1Impl = { &GetInformation, &DestroyResource };
...
void TestZcrColorSpaceV1::SetZcrColorManager(MockZcrColorManagerV1* zcr_color_manager)
{
