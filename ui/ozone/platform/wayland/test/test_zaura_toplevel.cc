...
void SetOrientationLock(struct wl_client* client, struct wl_resource* resource, uint32_t orientation_lock)
{
    NOTIMPLEMENTED_LOG_ONCE();
}

void SurfaceSubmissionInPixelCoordinates(struct wl_client* client, struct wl_resource* resource)
{
...
void SetSupportsScreenCoordinates(struct wl_client* client, struct wl_resource* resource)
{
    NOTIMPLEMENTED_LOG_ONCE();
}
...
void SetDecoration(struct wl_client* client, struct wl_resource* resource, uint32_t type)
{
    NOTREACHED();
}
...
void SetZOrder(struct wl_client* client, struct wl_resource* resource, uint32_t z_order)
{
    NOTIMPLEMENTED_LOG_ONCE();
}
...
void SetFullscreenMode(struct wl_client* client, struct wl_resource* resource, uint32_t mode)
{
    NOTIMPLEMENTED_LOG_ONCE();
}

void SetScaleFactor(wl_client* client, wl_resource* resource, uint32_t scale_factor_as_uint)
{
    NOTIMPLEMENTED_LOG_ONCE();
}

void SetSnapPrimary(wl_client* client, wl_resource* resource, uint32_t snap_ratio_as_uint)
{
    NOTIMPLEMENTED_LOG_ONCE();
}

void SetSnapSecondary(wl_client* client, wl_resource* resource, uint32_t snap_ratio_as_uint)
{
    NOTIMPLEMENTED_LOG_ONCE();
}

void IntentToSnap(wl_client* client, wl_resource* resource, uint32_t snap_direction)
{
    NOTIMPLEMENTED_LOG_ONCE();
}
...
void SetPersistable(wl_client* client, wl_resource* resource, uint32_t persistable)
{
    NOTIMPLEMENTED_LOG_ONCE();
}

void SetShape(wl_client* client, wl_resource* resource, wl_resource* region_resource)
{
    GetUserDataAs<TestZAuraToplevel>(resource)->set_shape(
        region_resource ? std::optional<TestRegion>(*GetUserDataAs<TestRegion>(region_resource)) : std::nullopt);
}
...
void AckRotateFocus(wl_client* client, wl_resource* resource, uint32_t serial, uint32_t handled)
{
    auto* toplevel = GetUserDataAs<TestZAuraToplevel>(resource);
...
void SetFloatToLocation(struct wl_client* client, struct wl_resource* resource, uint32_t float_start_location)
{
    auto* toplevel = GetUserDataAs<TestZAuraToplevel>(resource);
    if (toplevel->set_unset_float_callback()) {
        toplevel->set_unset_float_callback().Run(/*floated=*/true, float_start_location);
    } else {
        NOTIMPLEMENTED_LOG_ONCE();
    }
}
