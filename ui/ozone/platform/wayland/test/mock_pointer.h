...
public:
    ...
    MOCK_METHOD3(SetCursor, void(wl_resource* surface_resource, int32_t hotspot_x, int32_t hotspot_y));

    void set_pointer_stylus(TestZcrPointerStylus* pointer_stylus)
    {
        pointer_stylus_ = pointer_stylus;
    }
    TestZcrPointerStylus* pointer_stylus() const
    {
        return pointer_stylus_;
    }
