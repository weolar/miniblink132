...
WaylandOverlayCandidates::WaylandOverlayCandidates(WaylandOverlayManager* manager, gfx::AcceleratedWidget widget)
...
void WaylandOverlayCandidates::CheckOverlaySupport(std::vector<OverlaySurfaceCandidate>* candidates)
{
