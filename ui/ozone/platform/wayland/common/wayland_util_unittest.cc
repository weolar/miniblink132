...
TEST_F(WaylandUtilTest, TestCreateRectsFromSkPath)
{
    ...
    std::vector<gfx::Rect> expectedFor2Rects = { gfx::Rect(1, 0, 99, 1), gfx::Rect(0, 1, 100, 99) };
    ...
    std::vector<gfx::Rect> expectedFor5Rects
        = { gfx::Rect(3, 0, 94, 1), gfx::Rect(1, 1, 98, 2), gfx::Rect(0, 3, 100, 94), gfx::Rect(1, 97, 98, 2), gfx::Rect(3, 99, 94, 1) };
