...
struct WaylandPresentationInfo {
    ...
    WaylandPresentationInfo(uint32_t in_frame_id, const gfx::PresentationFeedback& in_feedback)
    ...
    WaylandPresentationInfo& operator=(const WaylandPresentationInfo& other) = default;
