...
// static
wl::mojom::TransformUnionDataView::Tag UnionTraits<wl::mojom::TransformUnionDataView, absl::variant<gfx::OverlayTransform, gfx::Transform>>::GetTag(
...
// static
bool UnionTraits<wl::mojom::TransformUnionDataView, absl::variant<gfx::OverlayTransform, gfx::Transform>>::Read(
    wl::mojom::TransformUnionDataView data, absl::variant<gfx::OverlayTransform, gfx::Transform>* out)
{
    switch (data.tag()) {
...
// static
bool StructTraits<wl::mojom::WaylandOverlayConfigDataView, wl::WaylandOverlayConfig>::Read(
    wl::mojom::WaylandOverlayConfigDataView data, wl::WaylandOverlayConfig* out)
{
