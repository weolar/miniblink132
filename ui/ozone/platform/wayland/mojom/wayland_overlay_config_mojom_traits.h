...
template <> struct UnionTraits<wl::mojom::TransformUnionDataView, absl::variant<gfx::OverlayTransform, gfx::Transform>> {
    static wl::mojom::TransformUnionDataView::Tag GetTag(const absl::variant<gfx::OverlayTransform, gfx::Transform>& transform);

    static gfx::OverlayTransform overlay_transform(const absl::variant<gfx::OverlayTransform, gfx::Transform>& transform)
    {
        return absl::get<gfx::OverlayTransform>(transform);
    }

    static gfx::Transform matrix_transform(const absl::variant<gfx::OverlayTransform, gfx::Transform>& transform)
    {
        return absl::get<gfx::Transform>(transform);
    }

    static bool Read(wl::mojom::TransformUnionDataView data, absl::variant<gfx::OverlayTransform, gfx::Transform>* out);
};

template <> struct StructTraits<wl::mojom::WaylandOverlayConfigDataView, wl::WaylandOverlayConfig> {
    static int z_order(const wl::WaylandOverlayConfig& input)
    {
        return input.z_order;
    }

    static const std::optional<gfx::ColorSpace>& color_space(const wl::WaylandOverlayConfig& input)
    {
        return input.color_space;
    }

    static const absl::variant<gfx::OverlayTransform, gfx::Transform>& transform(const wl::WaylandOverlayConfig& input)
    {
    ...
    static gfx::GpuFenceHandle access_fence_handle(const wl::WaylandOverlayConfig& input)
    {
        return input.access_fence_handle.Clone();
    }

    static const gfx::OverlayPriorityHint& priority_hint(const wl::WaylandOverlayConfig& input)
    {
        return input.priority_hint;
    }

    static const std::optional<gfx::RRectF>& rounded_clip_bounds(const wl::WaylandOverlayConfig& input)
    {
        return input.rounded_clip_bounds;
    }

    static const std::optional<SkColor4f>& background_color(const wl::WaylandOverlayConfig& input)
    {
        return input.background_color;
    }

    static const std::optional<gfx::Rect>& clip_rect(const wl::WaylandOverlayConfig& input)
    {
        return input.clip_rect;
    }

    static bool Read(wl::mojom::WaylandOverlayConfigDataView data, wl::WaylandOverlayConfig* out);
};
