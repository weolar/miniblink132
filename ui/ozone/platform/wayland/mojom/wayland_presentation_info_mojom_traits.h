...
template <> struct StructTraits<wl::mojom::WaylandPresentationInfoDataView, wl::WaylandPresentationInfo> {
    static uint32_t frame_id(const wl::WaylandPresentationInfo& input)
    {
        return input.frame_id;
    }

    static const gfx::PresentationFeedback& feedback(const wl::WaylandPresentationInfo& input)
    {
        return input.feedback;
    }

    static bool Read(wl::mojom::WaylandPresentationInfoDataView data, wl::WaylandPresentationInfo* out);
};
