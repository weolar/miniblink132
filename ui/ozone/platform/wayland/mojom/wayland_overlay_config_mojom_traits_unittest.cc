...
class WaylandOverlayConfigStructTraitsTest : public testing::Test, public mojom::ConfigTraitsTestService {
public:
    WaylandOverlayConfigStructTraitsTest() = default;

    WaylandOverlayConfigStructTraitsTest(const WaylandOverlayConfigStructTraitsTest&) = delete;
    WaylandOverlayConfigStructTraitsTest& operator=(const WaylandOverlayConfigStructTraitsTest&) = delete;
...
private:
    ...
    void EchoTransform(const absl::variant<gfx::OverlayTransform, gfx::Transform>& t, EchoTransformCallback callback) override
    {
