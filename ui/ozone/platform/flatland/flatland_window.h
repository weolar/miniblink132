...
class COMPONENT_EXPORT(OZONE) FlatlandWindow : public PlatformWindow, public InputEventSink {
public:
    ...
    FlatlandWindow(FlatlandWindowManager* window_manager, PlatformWindowDelegate* platform_window_delegate, PlatformWindowInitProperties properties);
    ...
    bool virtual_keyboard_enabled() const
    {
...
private:
    ...
    base::FidlErrorEventLogger<fuchsia_ui_input3::Keyboard> fidl_error_event_logger_;
