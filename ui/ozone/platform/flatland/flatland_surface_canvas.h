...
public:
    FlatlandSurfaceCanvas(fuchsia::sysmem2::Allocator_Sync* sysmem_allocator, fuchsia::ui::composition::Allocator* flatland_allocator);
...
private:
    ...
    struct Frame {
        ...
        void InitializeBuffer(fuchsia::sysmem2::VmoBuffer vmo, gfx::Size size, size_t stride);
    ...
    void OnFramePresented(base::TimeTicks actual_presentation_time, base::TimeDelta future_presentation_interval);
