...
using MovableDisplaySnapshots = std::vector<std::unique_ptr<display::DisplaySnapshot>>;

using EventPropertyMap = base::flat_map<std::string, std::string>;

using MapEdidIdToDisplaySnapshot = base::flat_map<int64_t, display::DisplaySnapshot*>;
