...
void DrmObjectPropertiesDeleter::operator()(drmModeObjectProperties* properties) const
{
...
void DrmPropertyBlobDeleter::operator()(drmModePropertyBlobRes* property) const
{
