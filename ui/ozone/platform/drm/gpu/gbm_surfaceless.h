...
public:
    GbmSurfaceless(GbmSurfaceFactory* surface_factory, gl::GLDisplayEGL* display, std::unique_ptr<DrmWindowProxy> window, gfx::AcceleratedWidget widget);
...
private:
    ...
    void OnSubmission(bool should_handle_non_simple_overlay_failure, gfx::SwapResult result, gfx::GpuFenceHandle release_fence);
