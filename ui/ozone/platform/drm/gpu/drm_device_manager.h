...
public:
    explicit DrmDeviceManager(std::unique_ptr<DrmDeviceGenerator> drm_device_generator);
    ...
    void UpdateDrmDevice(gfx::AcceleratedWidget widget, const scoped_refptr<DrmDevice>& device);
