...
public:
    DrmOverlayCandidates(DrmOverlayManager* manager, gfx::AcceleratedWidget widget);
    ...
    void CheckOverlaySupport(std::vector<OverlaySurfaceCandidate>* candidates) override;
    void ObserveHardwareCapabilities(HardwareCapabilitiesCallback receive_callback) override;
    ...
    void SetSupportedBufferFormats(base::flat_set<gfx::BufferFormat> supported_buffer_formats) override;
    void NotifyOverlayPromotion(std::vector<gfx::OverlayType> promoted_overlay_types) override;
