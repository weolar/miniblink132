...
public:
    ...
    HardwareDisplayPlaneAtomic& operator=(const HardwareDisplayPlaneAtomic&) = delete;
    ...
    virtual bool AssignPlaneProps(DrmDevice* drm, uint32_t crtc_id, uint32_t framebuffer, const gfx::Rect& crtc_rect, const gfx::Rect& src_rect,
