...
MockDrmModifiersFilter::MockDrmModifiersFilter(const std::vector<uint64_t>& supported_modifiers)
...
std::vector<uint64_t> MockDrmModifiersFilter::Filter(gfx::BufferFormat format, const std::vector<uint64_t>& modifiers)
{
