...
void DrmWindowHostManager::AddWindow(gfx::AcceleratedWidget widget, DrmWindowHost* window)
{
    std::pair<WidgetToWindowMap::iterator, bool> result = window_map_.insert(std::pair<gfx::AcceleratedWidget, DrmWindowHost*>(widget, window));
