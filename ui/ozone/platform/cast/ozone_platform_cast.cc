...
public:
    ...
    SurfaceFactoryOzone* GetSurfaceFactoryOzone() override
    {
        if (!surface_factory_) {
            ...
            bool allow_dummy_software_rendering = base::CommandLine::ForCurrentProcess()->HasSwitch("allow-dummy-software-rendering");
    ...
    {
        return format == gfx::BufferFormat::BGRA_8888 && usage == gfx::BufferUsage::SCANOUT;
    }
    ...
    bool InitializeUI(const InitParams& params) override
    {
        ...
        enable_dummy_software_rendering = base::CommandLine::ForCurrentProcess()->HasSwitch("disable-gpu");
#endif // BUILDFLAG(IS_CAST_AUDIO_ONLY)

        keyboard_layout_engine_ = std::make_unique<StubKeyboardLayoutEngine>();
        KeyboardLayoutEngineManager::SetKeyboardLayoutEngine(keyboard_layout_engine_.get());

        event_factory_ozone_ = std::make_unique<EventFactoryEvdev>(nullptr, device_manager_.get(), KeyboardLayoutEngineManager::GetKeyboardLayoutEngine());
    ...
    void InitializeGPU(const InitParams& params) override
    {
        ...
        surface_factory_ = std::make_unique<SurfaceFactoryCast>(std::move(egl_platform_));
    }
...
OzonePlatform* CreateOzonePlatformCast()
{
    ...
    std::unique_ptr<chromecast::CastEglPlatform> platform(chromecast::CastEglPlatformShlib::Create(argv));
