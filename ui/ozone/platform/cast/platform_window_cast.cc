...
PlatformWindowCast::PlatformWindowCast(PlatformWindowDelegate* delegate, const gfx::Rect& bounds)
...
{
    DispatchEventFromNativeUiEvent(native_event, base::BindOnce(&PlatformWindowDelegate::DispatchEvent, base::Unretained(delegate())));
