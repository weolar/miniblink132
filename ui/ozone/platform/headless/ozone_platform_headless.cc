...
public:
    ...
    HeadlessPlatformEventSource& operator=(const HeadlessPlatformEventSource&) = delete;
...
public:
    ...
    {
        return std::make_unique<HeadlessWindow>(delegate, window_manager_.get(), properties.bounds);
    }
