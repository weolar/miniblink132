...
public:
    static std::unique_ptr<VulkanSurfaceHeadless> Create(VkInstance vk_instance, gfx::AcceleratedWidget widget);
    VulkanSurfaceHeadless(VkInstance vk_instance, VkSurfaceKHR vk_surface, gfx::AcceleratedWidget widget);
