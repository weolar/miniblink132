...
public:
    explicit X11UserInputMonitor(const scoped_refptr<base::SingleThreadTaskRunner>& io_task_runner);
    ...
    void StartMonitor(PlatformUserInputMonitor::WriteKeyPressCallback callback) override;
    void StartMonitorWithMapping(PlatformUserInputMonitor::WriteKeyPressCallback callback, base::WritableSharedMemoryMapping mapping) override;
