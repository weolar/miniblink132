...
class OSExchangeDataProviderX11 : public XOSExchangeDataProvider, public x11::EventObserver {
public:
    ...
    OSExchangeDataProviderX11(x11::Window x_window, x11::Window source_window, const SelectionFormatMap& selection);
    ...
    OSExchangeDataProviderX11& operator=(const OSExchangeDataProviderX11&) = delete;
