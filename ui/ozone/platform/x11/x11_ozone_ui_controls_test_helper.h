...
public:
    ...
    X11OzoneUIControlsTestHelper& operator=(const X11OzoneUIControlsTestHelper&) = delete;
    ...
    void SendKeyEvents(gfx::AcceleratedWidget widget, ui::KeyboardCode key, int key_event_types, int accelerated_state, base::OnceClosure closure) override;
