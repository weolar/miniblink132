...
public:
    ...
    bool IsAcceleratedWidgetUnderCursor(gfx::AcceleratedWidget widget) const override;
...
private:
    ...
    class X11ScreenSaverSuspender : public PlatformScreen::PlatformScreenSaverSuspender {
    public:
