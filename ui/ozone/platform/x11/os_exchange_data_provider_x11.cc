...
OSExchangeDataProviderX11::OSExchangeDataProviderX11(x11::Window x_window, x11::Window source_window, const SelectionFormatMap& selection)
...
std::unique_ptr<OSExchangeDataProvider> OSExchangeDataProviderX11::Clone() const
{
    std::unique_ptr<OSExchangeDataProviderX11> ret(new OSExchangeDataProviderX11());
...
void OSExchangeDataProviderX11::SetSource(std::unique_ptr<DataTransferEndpoint> data_source)
{
}
