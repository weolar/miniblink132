...
public:
    ...
    int change_notified() const
    {
        return change_notified_;
    }
    void Reset()
    {
        change_notified_ = false;
...
TEST_F(DeviceDataManagerX11Test, NotifyOnDisable)
{
    ...
    keyboards.emplace_back(1, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, "Keyboard");
    keyboards.emplace_back(2, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, "Keyboard");
...
TEST_F(DeviceDataManagerX11Test, UnblockOnDeviceUnplugged)
{
    ...
    all_keyboards.emplace_back(1, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, "Keyboard");
    all_keyboards.emplace_back(2, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, "Keyboard");
    ...
    subset_keyboards.emplace_back(1, ui::InputDeviceType::INPUT_DEVICE_INTERNAL, "Keyboard");
