...
public:
    ...
    {
        scoped_refptr<base::RefCountedMemory> mem(base::MakeRefCounted<base::RefCountedString>(list_contents));
...
TEST_F(OSExchangeDataProviderX11Test, MozillaURL)
{
    ...
    {
        std::optional<OSExchangeDataProvider::UrlInfo> url_info = provider.GetURLAndTitle(FilenameToURLPolicy::DO_NOT_CONVERT_FILENAMES);
