...
void InitButtonEvent(x11::Event* event, bool is_press, const gfx::Point& location, int button, x11::KeyButMask state)
{
    *event = x11::Event(false,
        x11::ButtonEvent {
...
void InitKeyEvent(x11::Event* event, bool is_press, int keycode, x11::KeyButMask state)
{
...
{
    return gfx::ToFlooredPoint(gfx::PointF(ui::EventLocationFromXEvent(xev))).ToString();
}
...
TEST_F(EventsXTest, ButtonEvents)
{
    ...
    EXPECT_EQ(ui::EF_LEFT_MOUSE_BUTTON, ui::GetChangedMouseButtonFlagsFromXEvent(event));
    EXPECT_EQ(location, ui::EventLocationFromXEvent(event));

    InitButtonEvent(&event, true, location, 2, x11::KeyButMask::Button1 | x11::KeyButMask::Shift);
    EXPECT_EQ(ui::EventType::kMousePressed, ui::EventTypeFromXEvent(event));
    EXPECT_EQ(ui::EF_LEFT_MOUSE_BUTTON | ui::EF_MIDDLE_MOUSE_BUTTON | ui::EF_SHIFT_DOWN, ui::EventFlagsFromXEvent(event));
    EXPECT_EQ(ui::EF_MIDDLE_MOUSE_BUTTON, ui::GetChangedMouseButtonFlagsFromXEvent(event));
    EXPECT_EQ(location, ui::EventLocationFromXEvent(event));
    ...
    EXPECT_EQ(ui::EF_RIGHT_MOUSE_BUTTON, ui::GetChangedMouseButtonFlagsFromXEvent(event));
    EXPECT_EQ(location, ui::EventLocationFromXEvent(event));
...
TEST_F(EventsXTest, ClickCount)
{
    ...
    base::TimeDelta time_stamp = base::TimeTicks::Now().since_origin() - base::Milliseconds(10);
    for (int i = 1; i <= 3; ++i) {
        InitButtonEvent(&event, true, location, 1, {});
        {
...
TEST_F(EventsXTest, TouchEventBasic)
{
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchBegin, 5, gfx::Point(10, 10), valuators);
    EXPECT_EQ(ui::EventType::kTouchPressed, ui::EventTypeFromXEvent(*scoped_xevent));
    EXPECT_EQ("10,10", FlooredEventLocationString(*scoped_xevent));
    EXPECT_EQ(GetTouchIdFromXEvent(*scoped_xevent), 0);
    PointerDetails pointer_details = GetTouchPointerDetailsFromXEvent(*scoped_xevent);
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchUpdate, 5, gfx::Point(20, 20), valuators);
    EXPECT_EQ(ui::EventType::kTouchMoved, ui::EventTypeFromXEvent(*scoped_xevent));
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchBegin, 6, gfx::Point(200, 200), valuators);
    EXPECT_EQ(ui::EventType::kTouchPressed, ui::EventTypeFromXEvent(*scoped_xevent));
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchEnd, 5, gfx::Point(30, 30), valuators);
    EXPECT_EQ(ui::EventType::kTouchReleased, ui::EventTypeFromXEvent(*scoped_xevent));
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchEnd, 6, gfx::Point(200, 200), valuators);
    EXPECT_EQ(ui::EventType::kTouchReleased, ui::EventTypeFromXEvent(*scoped_xevent));
    EXPECT_EQ("200,200", FlooredEventLocationString(*scoped_xevent));
    EXPECT_EQ(GetTouchIdFromXEvent(*scoped_xevent), 1);
    pointer_details = GetTouchPointerDetailsFromXEvent(*scoped_xevent);
...
TEST_F(EventsXTest, TouchEventNotRemovingFromNativeMapping)
{
    ...
    xpress0.InitTouchEvent(kDeviceId, x11::Input::DeviceEvent::TouchBegin, kTrackingId, gfx::Point(10, 10), valuators);
    ...
    xpress1.InitTouchEvent(kDeviceId, x11::Input::DeviceEvent::TouchBegin, kTrackingId, gfx::Point(20, 20), valuators);
    ...
    xrelease1.InitTouchEvent(kDeviceId, x11::Input::DeviceEvent::TouchEnd, kTrackingId, gfx::Point(10, 10), valuators);
    {
...
TEST_F(EventsXTest, CopiedTouchEventNotRemovingFromXEventMapping)
{
    ...
    xrelease0.InitTouchEvent(0, x11::Input::DeviceEvent::TouchEnd, 0, gfx::Point(10, 10), valuators);
...
{
    DeviceDataManagerX11* device_data_manager = static_cast<DeviceDataManagerX11*>(DeviceDataManager::GetInstance());
    ...
    std::unique_ptr<std::set<KeyboardCode>> excepted_keys(new std::set<KeyboardCode>);
    ...
    // EventType::kUnknown.
    xev.InitGenericKeyEvent(master_device_id, blocked_device_id, ui::EventType::kKeyPressed, ui::VKEY_A, 0);
    ...
    xev.InitGenericKeyEvent(master_device_id, blocked_device_id, ui::EventType::kKeyPressed, ui::VKEY_B, 0);
    EXPECT_EQ(ui::EventType::kKeyPressed, ui::EventTypeFromXEvent(*xev));

    // Both A and B are allowed on an unblocked keyboard device.
    xev.InitGenericKeyEvent(master_device_id, other_device_id, ui::EventType::kKeyPressed, ui::VKEY_A, 0);
    EXPECT_EQ(ui::EventType::kKeyPressed, ui::EventTypeFromXEvent(*xev));
    xev.InitGenericKeyEvent(master_device_id, other_device_id, ui::EventType::kKeyPressed, ui::VKEY_B, 0);
    EXPECT_EQ(ui::EventType::kKeyPressed, ui::EventTypeFromXEvent(*xev));
...
TEST_F(EventsXTest, DisableMouse)
{
    ...
    ScopedXI2Event xev;
    xev.InitGenericButtonEvent(blocked_device_id, EventType::kMousePressed, gfx::Point(), EF_LEFT_MOUSE_BUTTON);
    EXPECT_EQ(ui::EventType::kUnknown, ui::EventTypeFromXEvent(*xev));

    xev.InitGenericButtonEvent(other_device_id, EventType::kMousePressed, gfx::Point(), EF_LEFT_MOUSE_BUTTON);
...
TEST_F(EventsXTest, TimestampRolloverAndAdjustWhenDecreasing)
{
    ...
    EXPECT_EQ(TimeTicksFromMillis(0x100000000 + 3), ui::EventTimeFromXEvent(event));
}
...
TEST_F(EventsXTest, AutoRepeat)
{
    ...
    native_event_a_pressed.InitKeyEvent(EventType::kKeyPressed, VKEY_A, kNativeCodeA);
    ScopedXI2Event native_event_a_pressed_1500;
    native_event_a_pressed_1500.InitKeyEvent(EventType::kKeyPressed, VKEY_A, kNativeCodeA);
    ScopedXI2Event native_event_a_pressed_3000;
    native_event_a_pressed_3000.InitKeyEvent(EventType::kKeyPressed, VKEY_A, kNativeCodeA);

    ScopedXI2Event native_event_a_released;
    native_event_a_released.InitKeyEvent(EventType::kKeyReleased, VKEY_A, kNativeCodeA);
    ScopedXI2Event native_event_b_pressed;
    native_event_b_pressed.InitKeyEvent(EventType::kKeyPressed, VKEY_B, kNativeCodeB);
    ScopedXI2Event native_event_a_pressed_nonstandard_state;
    native_event_a_pressed_nonstandard_state.InitKeyEvent(EventType::kKeyPressed, VKEY_A, kNativeCodeA);
    ...
    int64_t ticks_base = (base::TimeTicks::Now() - base::TimeTicks()).InMilliseconds() - 5000;
...

    {
        ...
        auto key_a4_pressed_nonstandard_state = BuildKeyEventFromXEvent(*native_event_a_pressed_nonstandard_state);
...

    {
        ...
        auto key_a1_with_same_event = BuildKeyEventFromXEvent(*native_event_a_pressed);
...
TEST_F(EventsXTest, EventLatencyOSTouchHistograms)
{
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchBegin, 5, gfx::Point(10, 10), {});
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchUpdate, 5, gfx::Point(20, 20), {});
    ...
    scoped_xevent.InitTouchEvent(0, x11::Input::DeviceEvent::TouchEnd, 5, gfx::Point(30, 30), {});
