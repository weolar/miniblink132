...
class MockGesturePropertiesService : public ui::ozone::mojom::GesturePropertiesService {
public:
    ...
    MOCK_METHOD3(GetProperty, void(int32_t, const std::string&, GetPropertyCallback));
    MOCK_METHOD4(SetProperty, void(int32_t, const std::string&, ui::ozone::mojom::GesturePropValuePtr, SetPropertyCallback));
};
