...
scoped_refptr<PlatformCursor> BitmapCursorFactory::GetDefaultCursor(mojom::CursorType type)
{
...
scoped_refptr<PlatformCursor> BitmapCursorFactory::CreateImageCursor(mojom::CursorType type, const SkBitmap& bitmap, const gfx::Point& hotspot, float scale)
{
    ...
    mojom::CursorType type, const std::vector<SkBitmap>& bitmaps, const gfx::Point& hotspot, float scale, base::TimeDelta frame_delay)
{
    ...
    return base::MakeRefCounted<BitmapCursor>(type, bitmaps, hotspot, frame_delay, scale);
}
