...
BASE_FEATURE(kWaylandOverlayDelegation, "WaylandOverlayDelegation", base::FEATURE_DISABLED_BY_DEFAULT);

// Controls whether support for the fractional_scale_v1 protocol should be
// enabled.
BASE_FEATURE(kWaylandFractionalScaleV1, "WaylandFractionalScaleV1", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kWaylandXdgToplevelDrag, "WaylandXdgToplevelDrag", base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kPrettyPrintDrmModesetConfigLogs, "PrettyPrintDrmModesetConfigLogs", base::FEATURE_DISABLED_BY_DEFAULT);

// If enabled, Chromium will try to use the smallest valid size for the cursor
// plane that fits the cursor bitmap.
BASE_FEATURE(kUseDynamicCursorSize, "UseDynamicCursorSize", base::FEATURE_ENABLED_BY_DEFAULT);
...
// with the protocol.
BASE_FEATURE(kDispatchPointerEventsOnFrameEvent, "DispatchPointerEventsOnFrameEvent", base::FEATURE_DISABLED_BY_DEFAULT);
...
// immediately.
BASE_FEATURE(kDispatchTouchEventsOnFrameEvent, "DispatchTouchEventsOnFrameEvent", base::FEATURE_DISABLED_BY_DEFAULT);
