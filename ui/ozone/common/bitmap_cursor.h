...
public:
    static scoped_refptr<BitmapCursor> FromPlatformCursor(scoped_refptr<PlatformCursor> platform_cursor);
    ...
    BitmapCursor(mojom::CursorType type, const SkBitmap& bitmap, const gfx::Point& hotspot, float cursor_image_scale_factor);
    ...
    BitmapCursor(mojom::CursorType type, void* platform_data, float cursor_image_scale_factor);

    BitmapCursor(const BitmapCursor&) = delete;
    BitmapCursor& operator=(const BitmapCursor&) = delete;

    mojom::CursorType type() const
    {
        return type_;
    }
    ...
    float cursor_image_scale_factor() const
    {
        return cursor_image_scale_factor_;
    }
