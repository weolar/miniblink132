...
public:
    ...
    // WeakPtr.
    virtual void ObserveHardwareCapabilities(ui::HardwareCapabilitiesCallback receive_callback);
    ...
    // possible.
    virtual void SetSupportedBufferFormats(base::flat_set<gfx::BufferFormat> supported_buffer_formats)
    {
    }

    // Notifies what overlay candidates were actually promoted as overlays.
    // Can be empty.
    virtual void NotifyOverlayPromotion(std::vector<gfx::OverlayType> promoted_overlay_types)
    {
    }
