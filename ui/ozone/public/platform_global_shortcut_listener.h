...
public:
    ...
    virtual void OnKeyPressed(KeyboardCode key_code, bool is_alt_down, bool is_ctrl_down, bool is_shift_down) = 0;
...
public:
    explicit PlatformGlobalShortcutListener(PlatformGlobalShortcutListenerDelegate* delegate);
    ...
    virtual bool RegisterAccelerator(KeyboardCode key_code, bool is_alt_down, bool is_ctrl_down, bool is_shift_down) = 0;
    virtual void UnregisterAccelerator(KeyboardCode key_code, bool is_alt_down, bool is_ctrl_down, bool is_shift_down) = 0;
