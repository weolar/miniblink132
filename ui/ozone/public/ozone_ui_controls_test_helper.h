...
public:
    ...
    virtual void SendKeyEvents(gfx::AcceleratedWidget widget, ui::KeyboardCode key, int key_event_types, int accelerator_state, base::OnceClosure closure) = 0;

    // Sends mouse motion notify event and executes |closure| when done.
    virtual void SendMouseMotionNotifyEvent(
    ...
    virtual void SendMouseEvent(gfx::AcceleratedWidget widget, ui_controls::MouseButton type, int button_state, int accelerator_state,
