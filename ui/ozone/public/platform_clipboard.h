...
public:
    ...
    virtual void OfferClipboardData(ClipboardBuffer buffer, const DataMap& data_map, OfferDataClosure callback) = 0;
    ...
    virtual void RequestClipboardData(ClipboardBuffer buffer, const std::string& mime_type, RequestDataClosure callback) = 0;
    ...
    using GetMimeTypesClosure = base::OnceCallback<void(const std::vector<std::string>&)>;
    virtual void GetAvailableMimeTypes(ClipboardBuffer buffer, GetMimeTypesClosure callback) = 0;
    ...
    using ClipboardDataChangedCallback = base::RepeatingCallback<void(ClipboardBuffer buffer)>;
