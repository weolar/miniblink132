...
public:
    ...
    using GpuHostTerminateCallback = base::OnceCallback<void(const std::string& message)>;
    ...
    virtual void OnGpuServiceLaunched(int host_id, GpuHostBindInterfaceCallback binder, GpuHostTerminateCallback terminate_callback) = 0;
};
