...
public:
    ...
    MOCK_CONST_METHOD1(CalculateInsetsInDIP, gfx::Insets(PlatformWindowState window_state));
    ...
    MOCK_METHOD2(OnWindowStateChanged, void(PlatformWindowState old_state, PlatformWindowState new_state));
#if BUILDFLAG(IS_LINUX)
    MOCK_METHOD1(OnWindowTiledStateChanged, void(WindowTiledEdges new_tiled_edges));
#endif
    ...
    MOCK_METHOD0(GetOwnedWindowAnchorAndRectInDIP, std::optional<OwnedWindowAnchor>());
    MOCK_METHOD0(OnMouseEnter, void());
    MOCK_METHOD1(OnOcclusionStateChanged, void(PlatformWindowOcclusionState occlusion_state));
    ...
    MOCK_METHOD2(OnRotateFocus, bool(PlatformWindowDelegate::RotateDirection, bool));
    MOCK_CONST_METHOD0(CanMaximize, bool());
    MOCK_CONST_METHOD0(CanFullscreen, bool());
};

bool operator==(const PlatformWindowDelegate::BoundsChange& a, const PlatformWindowDelegate::BoundsChange& b);
