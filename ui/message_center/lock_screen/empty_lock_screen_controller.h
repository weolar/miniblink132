...
public:
    ...
    EmptyLockScreenController& operator=(const EmptyLockScreenController&) = delete;

    ~EmptyLockScreenController() override = default;

    void DismissLockScreenThenExecute(base::OnceClosure pending_callback, base::OnceClosure cancal_callback, int message_id) override;
