...
public:
    ...
    // always.
    virtual bool ShouldShowNotification(const Notification& notification) const;
    ...
    virtual bool ShouldShowNotificationAsPopup(const Notification& notification) const = 0;
...
typedef std::vector<raw_ptr<NotificationBlocker, VectorExperimental>> NotificationBlockers;
