...
const RelativeTimeFormat& GetRelativeTimeFormat(base::TimeDelta delta)
{
    ...
    static constexpr RelativeTimeFormat kTimeFormats[] = {
        { base::TimeDelta(), IDS_MESSAGE_NOTIFICATION_NOW_STRING_SHORTEST, IDS_MESSAGE_NOTIFICATION_NOW_STRING_SHORTEST },
        { base::Minutes(1), IDS_MESSAGE_NOTIFICATION_DURATION_MINUTES_SHORTEST, IDS_MESSAGE_NOTIFICATION_DURATION_MINUTES_SHORTEST_FUTURE },
        { base::Hours(1), IDS_MESSAGE_NOTIFICATION_DURATION_HOURS_SHORTEST, IDS_MESSAGE_NOTIFICATION_DURATION_HOURS_SHORTEST_FUTURE },
        { base::Days(1), IDS_MESSAGE_NOTIFICATION_DURATION_DAYS_SHORTEST, IDS_MESSAGE_NOTIFICATION_DURATION_DAYS_SHORTEST_FUTURE },
        { base::Days(364), IDS_MESSAGE_NOTIFICATION_DURATION_YEARS_SHORTEST, IDS_MESSAGE_NOTIFICATION_DURATION_YEARS_SHORTEST_FUTURE },
    };
...
void GetRelativeTimeStringAndNextUpdateTime(base::TimeDelta delta, std::u16string* relative_time, base::TimeDelta* next_update)
{
    ...
    base::TimeDelta delay = past ? format.range * (count + 1) : base::Milliseconds(1) - format.range * count;
