...
public:
    ...
    NotificationControlButtonFactory(const NotificationControlButtonFactory&) = delete;
    NotificationControlButtonFactory& operator=(const NotificationControlButtonFactory&) = delete;
    ...
    virtual std::unique_ptr<views::ImageButton> CreateButton(views::Button::PressedCallback callback);
};
