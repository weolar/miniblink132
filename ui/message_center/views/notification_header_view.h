...
public:
    ...
    void ConfigureLabelsStyle(const gfx::FontList& font_list, const gfx::Insets& text_view_padding, bool auto_color_readability);
    ...
    views::ImageView* expand_button()
    {
        return expand_button_;
    }

    std::optional<SkColor> color_for_testing() const
    {
        return color_;
    }
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(NotificationHeaderViewTest, GroupChildNotificationVisibility);
...
DEFINE_VIEW_BUILDER(MESSAGE_CENTER_EXPORT, message_center::NotificationHeaderView)
