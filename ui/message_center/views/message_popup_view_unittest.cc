...
public:
    MockMessagePopupView(MockMessagePopupCollection* popup_collection, MessageView* message_view)
...
{
    Notification notification(NOTIFICATION_TYPE_SIMPLE, "id", u"title", u"message", ui::ImageModel(),
        /*display_source=*/std::u16string(), GURL(), NotifierId(), RichNotificationData(), /*delegate=*/nullptr);
    ...
    EXPECT_FALSE(popup_data.GetString16Attribute(ax::mojom::StringAttribute::kName).empty());
    EXPECT_FALSE(message_data.GetString16Attribute(ax::mojom::StringAttribute::kName).empty());
    EXPECT_EQ(popup_data.GetString16Attribute(ax::mojom::StringAttribute::kName), message_data.GetString16Attribute(ax::mojom::StringAttribute::kName));
    EXPECT_EQ(popup_data.GetString16Attribute(ax::mojom::StringAttribute::kRoleDescription),
        message_data.GetString16Attribute(ax::mojom::StringAttribute::kRoleDescription));

    Notification new_notification(NOTIFICATION_TYPE_SIMPLE, "id", u"new title", u"new message", ui::ImageModel(), /*display_source=*/std::u16string(), GURL(),
