...
// rounded corners.
class MESSAGE_CENTER_EXPORT NotificationBackgroundPainter : public views::Painter {
public:
    NotificationBackgroundPainter(float top_radius, float bottom_radius, SkColor color);

    NotificationBackgroundPainter(const NotificationBackgroundPainter&) = delete;
    NotificationBackgroundPainter& operator=(const NotificationBackgroundPainter&) = delete;
