...
class MESSAGE_CENTER_EXPORT MessageView : public views::View, public views::SlideOutControllerDelegate, public views::FocusChangeListener {
...
public:
    ...
    virtual void AnimateSingleToGroup(const std::string& notification_id, std::string parent_id)
    {
    }
    ...
    // exists.
    virtual views::View* FindGroupNotificationView(const std::string& notification_id);
    ...
    virtual void PopulateGroupNotifications(const std::vector<const Notification*>& notifications)
    {
    }
    ...
    virtual base::TimeDelta GetBoundsAnimationDuration(const Notification& notification) const;
#endif
    ...
    MessageView* parent_message_view()
    {
        return parent_message_view_;
    }

    void set_scroller(views::ScrollView* scroller)
    {
        scroller_ = scroller;
    }
    ...
    bool inline_settings_enabled() const
    {
        return inline_settings_enabled_;
    }
    ...
    bool snooze_settings_enabled() const
    {
        return snooze_settings_enabled_;
    }
...
protected:
    ...
    void UpdateControlButtonsVisibilityWithNotification(const Notification& notification);
    ...
    int bottom_radius() const
    {
        return bottom_radius_;
    }
    int top_radius() const
    {
        return top_radius_;
    }
