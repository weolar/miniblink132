...
class MESSAGE_CENTER_EXPORT DesktopMessagePopupCollection : public MessagePopupCollection, public display::DisplayObserver {
public:
    DesktopMessagePopupCollection();

    DesktopMessagePopupCollection(const DesktopMessagePopupCollection&) = delete;
    DesktopMessagePopupCollection& operator=(const DesktopMessagePopupCollection&) = delete;
