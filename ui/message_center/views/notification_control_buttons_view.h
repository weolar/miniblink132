...
class MESSAGE_CENTER_EXPORT NotificationControlButtonsView : public views::View {
...
public:
    ...
    NotificationControlButtonsView(const NotificationControlButtonsView&) = delete;
    NotificationControlButtonsView& operator=(const NotificationControlButtonsView&) = delete;
    ~NotificationControlButtonsView() override;

    // Default control button icons.
    inline static const gfx::VectorIcon& kDefaultCloseIcon = kNotificationCloseButtonIcon;
    inline static const gfx::VectorIcon& kDefaultSettingsIcon = kNotificationSettingsButtonIcon;
    inline static const gfx::VectorIcon& kDefaultSnoozeIcon = kNotificationSnoozeButtonIcon;
    ...
    void SetNotificationControlButtonFactory(std::unique_ptr<NotificationControlButtonFactory> notification_control_button_factory);
...
private:
    ...
    std::unique_ptr<NotificationControlButtonFactory> notification_control_button_factory_;
};

BEGIN_VIEW_BUILDER(MESSAGE_CENTER_EXPORT, NotificationControlButtonsView, views::View)
VIEW_BUILDER_PROPERTY(MessageView*, MessageView)
VIEW_BUILDER_PROPERTY(const gfx::VectorIcon&, CloseButtonIcon, const gfx::VectorIcon&)
VIEW_BUILDER_PROPERTY(const gfx::VectorIcon&, SettingsButtonIcon, const gfx::VectorIcon&)
VIEW_BUILDER_PROPERTY(const gfx::VectorIcon&, SnoozeButtonIcon, const gfx::VectorIcon&)
...
VIEW_BUILDER_PROPERTY(std::unique_ptr<NotificationControlButtonFactory>, NotificationControlButtonFactory)
END_VIEW_BUILDER

} // namespace message_center

DEFINE_VIEW_BUILDER(MESSAGE_CENTER_EXPORT, message_center::NotificationControlButtonsView)
