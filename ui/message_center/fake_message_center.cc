...
void FakeMessageCenter::RemoveNotificationBlocker(NotificationBlocker* blocker)
{
}
...
Notification* FakeMessageCenter::FindParentNotification(Notification* notification)
{
    // stub
    return nullptr;
}

Notification* FakeMessageCenter::FindPopupNotificationById(const std::string& id)
{
    // stub
    return nullptr;
}

Notification* FakeMessageCenter::FindVisibleNotificationById(const std::string& id)
{
...
NotificationList::Notifications FakeMessageCenter::FindNotificationsByAppId(const std::string& app_id)
{
...
const NotificationList::Notifications& FakeMessageCenter::GetVisibleNotifications()
{
    return visible_notifications_;
}

NotificationList::Notifications FakeMessageCenter::GetVisibleNotificationsWithoutBlocker(const NotificationBlocker* blocker) const
{
    return visible_notifications_;
}

NotificationList::PopupNotifications FakeMessageCenter::GetPopupNotifications()
{
    return NotificationList::PopupNotifications();
}

NotificationList::PopupNotifications FakeMessageCenter::GetPopupNotificationsWithoutBlocker(const NotificationBlocker& blocker) const
{
    return NotificationList::PopupNotifications();
}

void FakeMessageCenter::AddNotification(std::unique_ptr<Notification> notification)
{
...
void FakeMessageCenter::UpdateNotification(const std::string& old_id, std::unique_ptr<Notification> new_notification)
{
...
void FakeMessageCenter::RemoveNotification(const std::string& id, bool by_user)
{
...
void FakeMessageCenter::RemoveNotificationsForNotifierId(const NotifierId& notifier_id)
{
}
...
void FakeMessageCenter::SetNotificationIcon(const std::string& notification_id, const ui::ImageModel& image)
{
}

void FakeMessageCenter::SetNotificationImage(const std::string& notification_id, const gfx::Image& image)
{
}
...
void FakeMessageCenter::ClickOnNotificationButton(const std::string& id, int button_index)
{
}

void FakeMessageCenter::ClickOnNotificationButtonWithReply(const std::string& id, int button_index, const std::u16string& reply)
{
}
...
void FakeMessageCenter::MarkSinglePopupAsShown(const std::string& id, bool mark_notification_as_read)
{
}
...
void FakeMessageCenter::DisplayedNotification(const std::string& id, const DisplaySource source)
{
}

void FakeMessageCenter::SetQuietMode(bool in_quiet_mode, QuietModeSourceType type)
{
}

QuietModeSourceType FakeMessageCenter::GetLastQuietModeChangeSourceType() const
{
...
void FakeMessageCenter::EnterQuietModeWithExpire(const base::TimeDelta& expires_in)
{
}
...
ExpandState FakeMessageCenter::GetNotificationExpandState(const std::string& id)
{
    return ExpandState::DEFAULT;
}

void FakeMessageCenter::SetNotificationExpandState(const std::string& id, const ExpandState state)
{
}
...
void FakeMessageCenter::SetSystemNotificationAppName(const std::u16string& product_os_name)
{
}

void FakeMessageCenter::OnMessageViewHovered(const std::string& notification_id)
{
}
