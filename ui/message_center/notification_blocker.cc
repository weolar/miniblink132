...
{
    CHECK(!is_initialized_) << "Do not initialize a NotificationBlocker more than once.";
...
void NotificationBlocker::RemoveObserver(NotificationBlocker::Observer* observer)
{
    observers_.RemoveObserver(observer);
}

bool NotificationBlocker::ShouldShowNotification(const Notification& notification) const
{
    return true;
}
