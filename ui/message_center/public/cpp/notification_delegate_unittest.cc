...
{
    auto delegate
        = base::MakeRefCounted<HandleNotificationClickDelegate>(base::BindRepeating(&NotificationDelegateTest::BodyClickCallback, base::Unretained(this)));
...
{
    auto delegate = base::MakeRefCounted<HandleNotificationClickDelegate>(base::RepeatingClosure());
...
{
    auto delegate
        = base::MakeRefCounted<HandleNotificationClickDelegate>(base::BindRepeating(&NotificationDelegateTest::ButtonClickCallback, base::Unretained(this)));
