...
public:
    ...
    // button.
    virtual void Click(const std::optional<int>& button_index, const std::optional<std::u16string>& reply)
    {
    }
...
class MESSAGE_CENTER_PUBLIC_EXPORT NotificationDelegate : public NotificationObserver, public base::RefCountedThreadSafe<NotificationDelegate> {
public:
...
class MESSAGE_CENTER_PUBLIC_EXPORT ThunkNotificationDelegate : public NotificationDelegate {
public:
    ...
    ThunkNotificationDelegate& operator=(const ThunkNotificationDelegate&) = delete;
...
class MESSAGE_CENTER_PUBLIC_EXPORT HandleNotificationClickDelegate : public NotificationDelegate {
public:
    ...
    // notification.
    explicit HandleNotificationClickDelegate(const base::RepeatingClosure& closure);

    HandleNotificationClickDelegate(const HandleNotificationClickDelegate&) = delete;
    HandleNotificationClickDelegate& operator=(const HandleNotificationClickDelegate&) = delete;
