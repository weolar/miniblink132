...
public:
    ...
    static void ScaleCopyOutputResult(GrabSnapshotImageCallback callback, const gfx::Size& target_size, std::unique_ptr<viz::CopyOutputResult> result);

    static void RunCallbackWithCopyOutputResult(GrabSnapshotImageCallback callback, std::unique_ptr<viz::CopyOutputResult> result);
};
