...
public:
    ...
    virtual void OnDragEnter(const gfx::PointF& point, int operations, int modifiers) = 0;
    ...
    virtual int OnDragMotion(const gfx::PointF& point, int operations, int modifiers) = 0;
...
COMPONENT_EXPORT(WM)
void SetWmDropHandler(PlatformWindow* platform_window, WmDropHandler* drop_handler);
COMPONENT_EXPORT(WM)
