...
DEFINE_UI_CLASS_PROPERTY_KEY(PinnedModeExtension*, kPinnedModeExtensionKey, nullptr)

PinnedModeExtension::~PinnedModeExtension() = default;

void PinnedModeExtension::SetPinnedModeExtension(PlatformWindow* window, PinnedModeExtension* extension)
{
