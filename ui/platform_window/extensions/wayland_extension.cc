...
DEFINE_UI_CLASS_PROPERTY_KEY(WaylandToplevelExtension*, kWaylandToplevelExtensionKey, nullptr)

WaylandExtension::~WaylandExtension() = default;

void WaylandExtension::SetWaylandExtension(PlatformWindow* window, WaylandExtension* extension)
{
...
void WaylandToplevelExtension::SetWaylandToplevelExtension(PlatformWindow* window, WaylandToplevelExtension* extension)
{
