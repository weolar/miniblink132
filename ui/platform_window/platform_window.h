...
class COMPONENT_EXPORT(PLATFORM_WINDOW) PlatformWindow : public PropertyHandler {
public:
    PlatformWindow();
    ...
    virtual void SetShape(std::unique_ptr<ShapeRects> native_shape, const gfx::Transform& transform);
    ...
    // side.
    virtual void ShowTooltip(const std::u16string& text, const gfx::Point& position, const PlatformWindowTooltipTrigger trigger,
