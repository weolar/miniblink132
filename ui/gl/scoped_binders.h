...
public:
    ScopedVertexAttribArray(unsigned int index, int size, unsigned int type, char normalized, int stride, const void* pointer);
...
public:
    ScopedVertexAttribPointer(unsigned index, int size, unsigned type, char normalized, int stride, const void* pointer);

    ScopedVertexAttribPointer(const ScopedVertexAttribPointer&) = delete;
    ScopedVertexAttribPointer& operator=(const ScopedVertexAttribPointer&) = delete;
