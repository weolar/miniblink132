...
// static
gl::mojom::GLImplementation EnumTraits<gl::mojom::GLImplementation, gl::GLImplementation>::ToMojom(gl::GLImplementation impl)
{
    switch (impl) {
...
// static
bool EnumTraits<gl::mojom::GLImplementation, gl::GLImplementation>::FromMojom(gl::mojom::GLImplementation input, gl::GLImplementation* out)
{
    switch (input) {
...
// static
gl::mojom::ANGLEImplementation EnumTraits<gl::mojom::ANGLEImplementation, gl::ANGLEImplementation>::ToMojom(gl::ANGLEImplementation impl)
{
    switch (impl) {
...
// static
bool EnumTraits<gl::mojom::ANGLEImplementation, gl::ANGLEImplementation>::FromMojom(gl::mojom::ANGLEImplementation input, gl::ANGLEImplementation* out)
{
    switch (input) {
...
// static
bool StructTraits<gl::mojom::GLImplementationPartsDataView, gl::GLImplementationParts>::Read(
    gl::mojom::GLImplementationPartsDataView data, gl::GLImplementationParts* out)
{
