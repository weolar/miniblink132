...
typedef void(GL_BINDING_CALL* glAcquireTexturesANGLEProc)(GLuint numTextures, const GLuint* textures, const GLenum* layouts);
typedef void(GL_BINDING_CALL* glActiveShaderProgramProc)(GLuint pipeline, GLuint program);
...
typedef void(GL_BINDING_CALL* glBeginPixelLocalStorageANGLEProc)(GLsizei n, const GLenum* loadops);
typedef void(GL_BINDING_CALL* glBeginQueryProc)(GLenum target, GLuint id);
typedef void(GL_BINDING_CALL* glBeginTransformFeedbackProc)(GLenum primitiveMode);
...
typedef void(GL_BINDING_CALL* glBindBufferBaseProc)(GLenum target, GLuint index, GLuint buffer);
typedef void(GL_BINDING_CALL* glBindBufferRangeProc)(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size);
...
typedef void(GL_BINDING_CALL* glBindImageTextureEXTProc)(
...
typedef void(GL_BINDING_CALL* glBindTransformFeedbackProc)(GLenum target, GLuint id);
typedef void(GL_BINDING_CALL* glBindUniformLocationCHROMIUMProc)(GLuint program, GLint location, const char* name);
typedef void(GL_BINDING_CALL* glBindVertexArrayOESProc)(GLuint array);
typedef void(GL_BINDING_CALL* glBindVertexBufferProc)(GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride);
...
typedef void(GL_BINDING_CALL* glBlendEquationSeparateiOESProc)(GLuint buf, GLenum modeRGB, GLenum modeAlpha);
typedef void(GL_BINDING_CALL* glBlendFuncProc)(GLenum sfactor, GLenum dfactor);
typedef void(GL_BINDING_CALL* glBlendFunciOESProc)(GLuint buf, GLenum sfactor, GLenum dfactor);
typedef void(GL_BINDING_CALL* glBlendFuncSeparateProc)(GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
typedef void(GL_BINDING_CALL* glBlendFuncSeparateiOESProc)(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
typedef void(GL_BINDING_CALL* glBlitFramebufferProc)(
...
typedef void(GL_BINDING_CALL* glBlobCacheCallbacksANGLEProc)(GLSETBLOBPROCANGLE set, GLGETBLOBPROCANGLE get, const void* userData);
...
typedef void(GL_BINDING_CALL* glClearBufferfiProc)(GLenum buffer, GLint drawbuffer, const GLfloat depth, GLint stencil);
typedef void(GL_BINDING_CALL* glClearBufferfvProc)(GLenum buffer, GLint drawbuffer, const GLfloat* value);
typedef void(GL_BINDING_CALL* glClearBufferivProc)(GLenum buffer, GLint drawbuffer, const GLint* value);
typedef void(GL_BINDING_CALL* glClearBufferuivProc)(GLenum buffer, GLint drawbuffer, const GLuint* value);
...
typedef void(GL_BINDING_CALL* glClearTexImageProc)(GLuint texture, GLint level, GLenum format, GLenum type, const GLvoid* data);
typedef void(GL_BINDING_CALL* glClearTexSubImageProc)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint width, GLint height,
    GLint depth, GLenum format, GLenum type, const GLvoid* data);
typedef GLenum(GL_BINDING_CALL* glClientWaitSyncProc)(GLsync sync, GLbitfield flags, GLuint64 timeout);
typedef void(GL_BINDING_CALL* glClipControlEXTProc)(GLenum origin, GLenum depth);
typedef void(GL_BINDING_CALL* glColorMaskProc)(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
typedef void(GL_BINDING_CALL* glColorMaskiOESProc)(GLuint buf, GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
typedef void(GL_BINDING_CALL* glCompileShaderProc)(GLuint shader);
typedef void(GL_BINDING_CALL* glCompressedTexImage2DProc)(
...
typedef void(GL_BINDING_CALL* glCompressedTexImage3DProc)(
...
typedef void(GL_BINDING_CALL* glCompressedTexImage3DRobustANGLEProc)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height,
    GLsizei depth, GLint border, GLsizei imageSize, GLsizei dataSize, const void* data);
typedef void(GL_BINDING_CALL* glCompressedTexSubImage2DProc)(
...
typedef void(GL_BINDING_CALL* glCompressedTexSubImage2DRobustANGLEProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height,
    GLenum format, GLsizei imageSize, GLsizei dataSize, const void* data);
typedef void(GL_BINDING_CALL* glCompressedTexSubImage3DProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width,
    GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void* data);
typedef void(GL_BINDING_CALL* glCompressedTexSubImage3DRobustANGLEProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width,
    GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, GLsizei dataSize, const void* data);
typedef void(GL_BINDING_CALL* glCopyBufferSubDataProc)(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size);
typedef void(GL_BINDING_CALL* glCopySubTextureCHROMIUMProc)(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel,
...
typedef void(GL_BINDING_CALL* glCreateMemoryObjectsEXTProc)(GLsizei n, GLuint* memoryObjects);
typedef GLuint(GL_BINDING_CALL* glCreateProgramProc)(void);
typedef GLuint(GL_BINDING_CALL* glCreateShaderProc)(GLenum type);
typedef GLuint(GL_BINDING_CALL* glCreateShaderProgramvProc)(GLenum type, GLsizei count, const char* const* strings);
typedef void(GL_BINDING_CALL* glCullFaceProc)(GLenum mode);
typedef void(GL_BINDING_CALL* glDebugMessageCallbackProc)(GLDEBUGPROC callback, const void* userParam);
typedef void(GL_BINDING_CALL* glDebugMessageControlProc)(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled);
typedef void(GL_BINDING_CALL* glDebugMessageInsertProc)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const char* buf);
...
typedef void(GL_BINDING_CALL* glDeleteMemoryObjectsEXTProc)(GLsizei n, const GLuint* memoryObjects);
typedef void(GL_BINDING_CALL* glDeleteProgramProc)(GLuint program);
typedef void(GL_BINDING_CALL* glDeleteProgramPipelinesProc)(GLsizei n, const GLuint* pipelines);
...
typedef void(GL_BINDING_CALL* glDeleteSamplersProc)(GLsizei n, const GLuint* samplers);
typedef void(GL_BINDING_CALL* glDeleteSemaphoresEXTProc)(GLsizei n, const GLuint* semaphores);
...
typedef void(GL_BINDING_CALL* glDeleteTransformFeedbacksProc)(GLsizei n, const GLuint* ids);
...
typedef void(GL_BINDING_CALL* glDispatchComputeProc)(GLuint numGroupsX, GLuint numGroupsY, GLuint numGroupsZ);
...
typedef void(GL_BINDING_CALL* glDrawArraysIndirectProc)(GLenum mode, const void* indirect);
typedef void(GL_BINDING_CALL* glDrawArraysInstancedANGLEProc)(GLenum mode, GLint first, GLsizei count, GLsizei primcount);
typedef void(GL_BINDING_CALL* glDrawArraysInstancedBaseInstanceANGLEProc)(GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance);
...
typedef void(GL_BINDING_CALL* glDrawElementsIndirectProc)(GLenum mode, GLenum type, const void* indirect);
...
typedef void(GL_BINDING_CALL* glDrawElementsInstancedBaseVertexBaseInstanceANGLEProc)(
    GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei primcount, GLint baseVertex, GLuint baseInstance);
typedef void(GL_BINDING_CALL* glDrawRangeElementsProc)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void* indices);
...
typedef void(GL_BINDING_CALL* glEndPixelLocalStorageANGLEProc)(GLsizei n, const GLenum* storeops);
...
typedef void(GL_BINDING_CALL* glFramebufferMemorylessPixelLocalStorageANGLEProc)(GLint plane, GLenum internalformat);
typedef void(GL_BINDING_CALL* glFramebufferParameteriProc)(GLenum target, GLenum pname, GLint param);
typedef void(GL_BINDING_CALL* glFramebufferPixelLocalClearValuefvANGLEProc)(GLint plane, const GLfloat* value);
typedef void(GL_BINDING_CALL* glFramebufferPixelLocalClearValueivANGLEProc)(GLint plane, const GLint* value);
typedef void(GL_BINDING_CALL* glFramebufferPixelLocalClearValueuivANGLEProc)(GLint plane, const GLuint* value);
typedef void(GL_BINDING_CALL* glFramebufferPixelLocalStorageInterruptANGLEProc)();
...
typedef void(GL_BINDING_CALL* glFramebufferTextureLayerProc)(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer);
typedef void(GL_BINDING_CALL* glFramebufferTextureMultiviewOVRProc)(
    GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews);
typedef void(GL_BINDING_CALL* glFramebufferTexturePixelLocalStorageANGLEProc)(GLint plane, GLuint backingtexture, GLint level, GLint layer);
...
typedef GLuint(GL_BINDING_CALL* glGenProgramPipelinesProc)(GLsizei n, GLuint* pipelines);
...
typedef void(GL_BINDING_CALL* glGenSemaphoresEXTProc)(GLsizei n, GLuint* semaphores);
typedef void(GL_BINDING_CALL* glGenTexturesProc)(GLsizei n, GLuint* textures);
typedef void(GL_BINDING_CALL* glGenTransformFeedbacksProc)(GLsizei n, GLuint* ids);
...
typedef void(GL_BINDING_CALL* glGetActiveUniformBlockivProc)(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetActiveUniformsivProc)(GLuint program, GLsizei uniformCount, const GLuint* uniformIndices, GLenum pname, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetBooleani_vProc)(GLenum target, GLuint index, GLboolean* data);
typedef void(GL_BINDING_CALL* glGetBooleani_vRobustANGLEProc)(GLenum target, GLuint index, GLsizei bufSize, GLsizei* length, GLboolean* data);
typedef void(GL_BINDING_CALL* glGetBooleanvProc)(GLenum pname, GLboolean* params);
typedef void(GL_BINDING_CALL* glGetBooleanvRobustANGLEProc)(GLenum pname, GLsizei bufSize, GLsizei* length, GLboolean* data);
typedef void(GL_BINDING_CALL* glGetBufferParameteri64vRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint64* params);
typedef void(GL_BINDING_CALL* glGetBufferParameterivProc)(GLenum target, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetBufferParameterivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetBufferPointervRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, void** params);
typedef GLuint(GL_BINDING_CALL* glGetDebugMessageLogProc)(
...
typedef void(GL_BINDING_CALL* glGetFloatvRobustANGLEProc)(GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* data);
typedef GLint(GL_BINDING_CALL* glGetFragDataIndexProc)(GLuint program, const char* name);
typedef GLint(GL_BINDING_CALL* glGetFragDataLocationProc)(GLuint program, const char* name);
...
typedef void(GL_BINDING_CALL* glGetFramebufferAttachmentParameterivRobustANGLEProc)(
    GLenum target, GLenum attachment, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetFramebufferParameterivProc)(GLenum target, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetFramebufferParameterivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetFramebufferPixelLocalStorageParameterfvANGLEProc)(GLint plane, GLenum pname, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetFramebufferPixelLocalStorageParameterfvRobustANGLEProc)(
    GLint plane, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetFramebufferPixelLocalStorageParameterivANGLEProc)(GLint plane, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetFramebufferPixelLocalStorageParameterivRobustANGLEProc)(
...
typedef void(GL_BINDING_CALL* glGetInteger64i_vProc)(GLenum target, GLuint index, GLint64* data);
typedef void(GL_BINDING_CALL* glGetInteger64i_vRobustANGLEProc)(GLenum target, GLuint index, GLsizei bufSize, GLsizei* length, GLint64* data);
typedef void(GL_BINDING_CALL* glGetInteger64vProc)(GLenum pname, GLint64* params);
typedef void(GL_BINDING_CALL* glGetInteger64vRobustANGLEProc)(GLenum pname, GLsizei bufSize, GLsizei* length, GLint64* data);
typedef void(GL_BINDING_CALL* glGetIntegeri_vProc)(GLenum target, GLuint index, GLint* data);
typedef void(GL_BINDING_CALL* glGetIntegeri_vRobustANGLEProc)(GLenum target, GLuint index, GLsizei bufSize, GLsizei* length, GLint* data);
typedef void(GL_BINDING_CALL* glGetIntegervProc)(GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetIntegervRobustANGLEProc)(GLenum pname, GLsizei bufSize, GLsizei* length, GLint* data);
typedef void(GL_BINDING_CALL* glGetInternalformativProc)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetMultisamplefvProc)(GLenum pname, GLuint index, GLfloat* val);
typedef void(GL_BINDING_CALL* glGetMultisamplefvRobustANGLEProc)(GLenum pname, GLuint index, GLsizei bufSize, GLsizei* length, GLfloat* val);
typedef void(GL_BINDING_CALL* glGetnUniformfvRobustANGLEProc)(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetnUniformivRobustANGLEProc)(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetnUniformuivRobustANGLEProc)(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLuint* params);
typedef void(GL_BINDING_CALL* glGetObjectLabelProc)(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei* length, char* label);
typedef void(GL_BINDING_CALL* glGetObjectPtrLabelProc)(void* ptr, GLsizei bufSize, GLsizei* length, char* label);
typedef void(GL_BINDING_CALL* glGetPointervProc)(GLenum pname, void** params);
typedef void(GL_BINDING_CALL* glGetPointervRobustANGLERobustANGLEProc)(GLenum pname, GLsizei bufSize, GLsizei* length, void** params);
...
typedef void(GL_BINDING_CALL* glGetProgramInterfaceivProc)(GLuint program, GLenum programInterface, GLenum pname, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetProgramivRobustANGLEProc)(GLuint program, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetProgramPipelineInfoLogProc)(GLuint pipeline, GLsizei bufSize, GLsizei* length, GLchar* infoLog);
typedef void(GL_BINDING_CALL* glGetProgramPipelineivProc)(GLuint pipeline, GLenum pname, GLint* params);
typedef GLuint(GL_BINDING_CALL* glGetProgramResourceIndexProc)(GLuint program, GLenum programInterface, const GLchar* name);
...
typedef GLint(GL_BINDING_CALL* glGetProgramResourceLocationProc)(GLuint program, GLenum programInterface, const char* name);
...
typedef void(GL_BINDING_CALL* glGetQueryivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetQueryObjecti64vProc)(GLuint id, GLenum pname, GLint64* params);
typedef void(GL_BINDING_CALL* glGetQueryObjecti64vRobustANGLEProc)(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLint64* params);
typedef void(GL_BINDING_CALL* glGetQueryObjectivProc)(GLuint id, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetQueryObjectivRobustANGLEProc)(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetQueryObjectui64vProc)(GLuint id, GLenum pname, GLuint64* params);
typedef void(GL_BINDING_CALL* glGetQueryObjectui64vRobustANGLEProc)(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint64* params);
typedef void(GL_BINDING_CALL* glGetQueryObjectuivProc)(GLuint id, GLenum pname, GLuint* params);
typedef void(GL_BINDING_CALL* glGetQueryObjectuivRobustANGLEProc)(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params);
typedef void(GL_BINDING_CALL* glGetRenderbufferParameterivEXTProc)(GLenum target, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetRenderbufferParameterivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetSamplerParameterfvProc)(GLuint sampler, GLenum pname, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetSamplerParameterfvRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetSamplerParameterIivRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetSamplerParameterIuivRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params);
typedef void(GL_BINDING_CALL* glGetSamplerParameterivProc)(GLuint sampler, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetSamplerParameterivRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
...
typedef void(GL_BINDING_CALL* glGetShaderivRobustANGLEProc)(GLuint shader, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
...
typedef const GLubyte*(GL_BINDING_CALL* glGetStringiProc)(GLenum name, GLuint index);
...
typedef void(GL_BINDING_CALL* glGetTexParameterfvRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetTexParameterIivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetTexParameterIuivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params);
typedef void(GL_BINDING_CALL* glGetTexParameterivProc)(GLenum target, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetTexParameterivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
...
typedef GLuint(GL_BINDING_CALL* glGetUniformBlockIndexProc)(GLuint program, const char* uniformBlockName);
typedef void(GL_BINDING_CALL* glGetUniformfvProc)(GLuint program, GLint location, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetUniformfvRobustANGLEProc)(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetUniformIndicesProc)(GLuint program, GLsizei uniformCount, const char* const* uniformNames, GLuint* uniformIndices);
typedef void(GL_BINDING_CALL* glGetUniformivProc)(GLuint program, GLint location, GLint* params);
typedef void(GL_BINDING_CALL* glGetUniformivRobustANGLEProc)(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLint* params);
typedef GLint(GL_BINDING_CALL* glGetUniformLocationProc)(GLuint program, const char* name);
typedef void(GL_BINDING_CALL* glGetUniformuivProc)(GLuint program, GLint location, GLuint* params);
typedef void(GL_BINDING_CALL* glGetUniformuivRobustANGLEProc)(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLuint* params);
typedef void(GL_BINDING_CALL* glGetVertexAttribfvProc)(GLuint index, GLenum pname, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetVertexAttribfvRobustANGLEProc)(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params);
typedef void(GL_BINDING_CALL* glGetVertexAttribIivRobustANGLEProc)(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetVertexAttribIuivRobustANGLEProc)(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params);
typedef void(GL_BINDING_CALL* glGetVertexAttribivProc)(GLuint index, GLenum pname, GLint* params);
typedef void(GL_BINDING_CALL* glGetVertexAttribivRobustANGLEProc)(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params);
typedef void(GL_BINDING_CALL* glGetVertexAttribPointervProc)(GLuint index, GLenum pname, void** pointer);
typedef void(GL_BINDING_CALL* glGetVertexAttribPointervRobustANGLEProc)(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, void** pointer);
typedef void(GL_BINDING_CALL* glHintProc)(GLenum target, GLenum mode);
typedef void(GL_BINDING_CALL* glImportMemoryFdEXTProc)(GLuint memory, GLuint64 size, GLenum handleType, GLint fd);
typedef void(GL_BINDING_CALL* glImportMemoryWin32HandleEXTProc)(GLuint memory, GLuint64 size, GLenum handleType, void* handle);
typedef void(GL_BINDING_CALL* glImportMemoryZirconHandleANGLEProc)(GLuint memory, GLuint64 size, GLenum handleType, GLuint handle);
typedef void(GL_BINDING_CALL* glImportSemaphoreFdEXTProc)(GLuint semaphore, GLenum handleType, GLint fd);
typedef void(GL_BINDING_CALL* glImportSemaphoreWin32HandleEXTProc)(GLuint semaphore, GLenum handleType, void* handle);
typedef void(GL_BINDING_CALL* glImportSemaphoreZirconHandleANGLEProc)(GLuint semaphore, GLenum handleType, GLuint handle);
typedef void(GL_BINDING_CALL* glInsertEventMarkerEXTProc)(GLsizei length, const char* marker);
typedef void(GL_BINDING_CALL* glInvalidateFramebufferProc)(GLenum target, GLsizei numAttachments, const GLenum* attachments);
...
typedef GLboolean(GL_BINDING_CALL* glIsEnablediOESProc)(GLenum target, GLuint index);
...
typedef void*(GL_BINDING_CALL* glMapBufferRangeProc)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
...
typedef void(GL_BINDING_CALL* glMemoryObjectParameterivEXTProc)(GLuint memoryObject, GLenum pname, const GLint* param);
typedef void(GL_BINDING_CALL* glMinSampleShadingProc)(GLfloat value);
typedef void(GL_BINDING_CALL* glMultiDrawArraysANGLEProc)(GLenum mode, const GLint* firsts, const GLsizei* counts, GLsizei drawcount);
...
typedef void(GL_BINDING_CALL* glMultiDrawElementsANGLEProc)(GLenum mode, const GLsizei* counts, GLenum type, const GLvoid* const* indices, GLsizei drawcount);
...
typedef void(GL_BINDING_CALL* glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLEProc)(GLenum mode, const GLsizei* counts, GLenum type,
...
typedef void(GL_BINDING_CALL* glObjectLabelProc)(GLenum identifier, GLuint name, GLsizei length, const char* label);
typedef void(GL_BINDING_CALL* glObjectPtrLabelProc)(void* ptr, GLsizei length, const char* label);
...
typedef void(GL_BINDING_CALL* glPolygonOffsetClampEXTProc)(GLfloat factor, GLfloat units, GLfloat clamp);
...
typedef void(GL_BINDING_CALL* glProgramUniform1fProc)(GLuint program, GLint location, GLfloat v0);
typedef void(GL_BINDING_CALL* glProgramUniform1fvProc)(GLuint program, GLint location, GLsizei count, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniform1iProc)(GLuint program, GLint location, GLint v0);
typedef void(GL_BINDING_CALL* glProgramUniform1ivProc)(GLuint program, GLint location, GLsizei count, const GLint* value);
typedef void(GL_BINDING_CALL* glProgramUniform1uiProc)(GLuint program, GLint location, GLuint v0);
typedef void(GL_BINDING_CALL* glProgramUniform1uivProc)(GLuint program, GLint location, GLsizei count, const GLuint* value);
typedef void(GL_BINDING_CALL* glProgramUniform2fProc)(GLuint program, GLint location, GLfloat v0, GLfloat v1);
typedef void(GL_BINDING_CALL* glProgramUniform2fvProc)(GLuint program, GLint location, GLsizei count, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniform2iProc)(GLuint program, GLint location, GLint v0, GLint v1);
typedef void(GL_BINDING_CALL* glProgramUniform2ivProc)(GLuint program, GLint location, GLsizei count, const GLint* value);
typedef void(GL_BINDING_CALL* glProgramUniform2uiProc)(GLuint program, GLint location, GLuint v0, GLuint v1);
typedef void(GL_BINDING_CALL* glProgramUniform2uivProc)(GLuint program, GLint location, GLsizei count, const GLuint* value);
typedef void(GL_BINDING_CALL* glProgramUniform3fProc)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2);
typedef void(GL_BINDING_CALL* glProgramUniform3fvProc)(GLuint program, GLint location, GLsizei count, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniform3iProc)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2);
typedef void(GL_BINDING_CALL* glProgramUniform3ivProc)(GLuint program, GLint location, GLsizei count, const GLint* value);
typedef void(GL_BINDING_CALL* glProgramUniform3uiProc)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2);
typedef void(GL_BINDING_CALL* glProgramUniform3uivProc)(GLuint program, GLint location, GLsizei count, const GLuint* value);
typedef void(GL_BINDING_CALL* glProgramUniform4fProc)(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3);
typedef void(GL_BINDING_CALL* glProgramUniform4fvProc)(GLuint program, GLint location, GLsizei count, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniform4iProc)(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3);
typedef void(GL_BINDING_CALL* glProgramUniform4ivProc)(GLuint program, GLint location, GLsizei count, const GLint* value);
typedef void(GL_BINDING_CALL* glProgramUniform4uiProc)(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
typedef void(GL_BINDING_CALL* glProgramUniform4uivProc)(GLuint program, GLint location, GLsizei count, const GLuint* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix2fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix2x3fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix2x4fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix3fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix3x2fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix3x4fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix4fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix4x2fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProgramUniformMatrix4x3fvProc)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glProvokingVertexANGLEProc)(GLenum provokeMode);
typedef void(GL_BINDING_CALL* glPushDebugGroupProc)(GLenum source, GLuint id, GLsizei length, const char* message);
...
typedef void(GL_BINDING_CALL* glReadnPixelsRobustANGLEProc)(
...
typedef void(GL_BINDING_CALL* glReadPixelsRobustANGLEProc)(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize,
    GLsizei* length, GLsizei* columns, GLsizei* rows, void* pixels);
typedef void(GL_BINDING_CALL* glReleaseShaderCompilerProc)(void);
typedef void(GL_BINDING_CALL* glReleaseTexturesANGLEProc)(GLuint numTextures, const GLuint* textures, GLenum* layouts);
...
typedef void(GL_BINDING_CALL* glSampleMaskiProc)(GLuint maskNumber, GLbitfield mask);
typedef void(GL_BINDING_CALL* glSamplerParameterfProc)(GLuint sampler, GLenum pname, GLfloat param);
typedef void(GL_BINDING_CALL* glSamplerParameterfvProc)(GLuint sampler, GLenum pname, const GLfloat* params);
typedef void(GL_BINDING_CALL* glSamplerParameterfvRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, const GLfloat* param);
typedef void(GL_BINDING_CALL* glSamplerParameteriProc)(GLuint sampler, GLenum pname, GLint param);
typedef void(GL_BINDING_CALL* glSamplerParameterIivRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, const GLint* param);
typedef void(GL_BINDING_CALL* glSamplerParameterIuivRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, const GLuint* param);
typedef void(GL_BINDING_CALL* glSamplerParameterivProc)(GLuint sampler, GLenum pname, const GLint* params);
typedef void(GL_BINDING_CALL* glSamplerParameterivRobustANGLEProc)(GLuint sampler, GLenum pname, GLsizei bufSize, const GLint* param);
...
typedef void(GL_BINDING_CALL* glStartTilingQCOMProc)(GLuint x, GLuint y, GLuint width, GLuint height, GLbitfield preserveMask);
...
typedef void(GL_BINDING_CALL* glTexBufferProc)(GLenum target, GLenum internalformat, GLuint buffer);
typedef void(GL_BINDING_CALL* glTexBufferRangeProc)(GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
typedef void(GL_BINDING_CALL* glTexImage2DProc)(
...
typedef void(GL_BINDING_CALL* glTexImage2DRobustANGLEProc)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border,
    GLenum format, GLenum type, GLsizei bufSize, const void* pixels);
typedef void(GL_BINDING_CALL* glTexImage3DProc)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border,
    GLenum format, GLenum type, const void* pixels);
typedef void(GL_BINDING_CALL* glTexImage3DRobustANGLEProc)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth,
...
typedef void(GL_BINDING_CALL* glTexParameterfvRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, const GLfloat* params);
typedef void(GL_BINDING_CALL* glTexParameteriProc)(GLenum target, GLenum pname, GLint param);
typedef void(GL_BINDING_CALL* glTexParameterIivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, const GLint* params);
typedef void(GL_BINDING_CALL* glTexParameterIuivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, const GLuint* params);
typedef void(GL_BINDING_CALL* glTexParameterivProc)(GLenum target, GLenum pname, const GLint* params);
typedef void(GL_BINDING_CALL* glTexParameterivRobustANGLEProc)(GLenum target, GLenum pname, GLsizei bufSize, const GLint* params);
...
typedef void(GL_BINDING_CALL* glTexStorage3DProc)(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth);
typedef void(GL_BINDING_CALL* glTexStorageMem2DEXTProc)(
    GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset);
typedef void(GL_BINDING_CALL* glTexStorageMemFlags2DANGLEProc)(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height,
...
typedef void(GL_BINDING_CALL* glTexSubImage3DProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
    GLsizei depth, GLenum format, GLenum type, const void* pixels);
typedef void(GL_BINDING_CALL* glTexSubImage3DRobustANGLEProc)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width,
    GLsizei height, GLsizei depth, GLenum format, GLenum type, GLsizei bufSize, const void* pixels);
typedef void(GL_BINDING_CALL* glTransformFeedbackVaryingsProc)(GLuint program, GLsizei count, const char* const* varyings, GLenum bufferMode);
...
typedef void(GL_BINDING_CALL* glUniform1uivProc)(GLint location, GLsizei count, const GLuint* v);
...
typedef void(GL_BINDING_CALL* glUniform2uiProc)(GLint location, GLuint v0, GLuint v1);
typedef void(GL_BINDING_CALL* glUniform2uivProc)(GLint location, GLsizei count, const GLuint* v);
...
typedef void(GL_BINDING_CALL* glUniform3uiProc)(GLint location, GLuint v0, GLuint v1, GLuint v2);
typedef void(GL_BINDING_CALL* glUniform3uivProc)(GLint location, GLsizei count, const GLuint* v);
...
typedef void(GL_BINDING_CALL* glUniform4uiProc)(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
typedef void(GL_BINDING_CALL* glUniform4uivProc)(GLint location, GLsizei count, const GLuint* v);
typedef void(GL_BINDING_CALL* glUniformBlockBindingProc)(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding);
typedef void(GL_BINDING_CALL* glUniformMatrix2fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix2x3fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix2x4fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix3fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix3x2fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix3x4fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix4fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix4x2fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(GL_BINDING_CALL* glUniformMatrix4x3fvProc)(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
...
typedef void(GL_BINDING_CALL* glUseProgramStagesProc)(GLuint pipeline, GLbitfield stages, GLuint program);
...
typedef void(GL_BINDING_CALL* glVertexAttribBindingProc)(GLuint attribindex, GLuint bindingindex);
typedef void(GL_BINDING_CALL* glVertexAttribDivisorANGLEProc)(GLuint index, GLuint divisor);
typedef void(GL_BINDING_CALL* glVertexAttribFormatProc)(GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
typedef void(GL_BINDING_CALL* glVertexAttribI4iProc)(GLuint indx, GLint x, GLint y, GLint z, GLint w);
typedef void(GL_BINDING_CALL* glVertexAttribI4ivProc)(GLuint indx, const GLint* values);
typedef void(GL_BINDING_CALL* glVertexAttribI4uiProc)(GLuint indx, GLuint x, GLuint y, GLuint z, GLuint w);
typedef void(GL_BINDING_CALL* glVertexAttribI4uivProc)(GLuint indx, const GLuint* values);
typedef void(GL_BINDING_CALL* glVertexAttribIFormatProc)(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset);
typedef void(GL_BINDING_CALL* glVertexAttribIPointerProc)(GLuint indx, GLint size, GLenum type, GLsizei stride, const void* ptr);
...
typedef void(GL_BINDING_CALL* glVertexBindingDivisorProc)(GLuint bindingindex, GLuint divisor);
typedef void(GL_BINDING_CALL* glViewportProc)(GLint x, GLint y, GLsizei width, GLsizei height);
typedef void(GL_BINDING_CALL* glWaitSemaphoreEXTProc)(
...
typedef void(GL_BINDING_CALL* glWaitSyncProc)(GLsync sync, GLbitfield flags, GLuint64 timeout);
typedef void(GL_BINDING_CALL* glWindowRectanglesEXTProc)(GLenum mode, GLsizei n, const GLint* box);
...
struct ProcsGL {
    ...
    glCompressedTexSubImage2DRobustANGLEProc glCompressedTexSubImage2DRobustANGLEFn;
    glCompressedTexSubImage3DProc glCompressedTexSubImage3DFn;
    glCompressedTexSubImage3DRobustANGLEProc glCompressedTexSubImage3DRobustANGLEFn;
    ...
    glDrawArraysInstancedBaseInstanceANGLEProc glDrawArraysInstancedBaseInstanceANGLEFn;
    ...
    glDrawElementsInstancedBaseVertexBaseInstanceANGLEProc glDrawElementsInstancedBaseVertexBaseInstanceANGLEFn;
    ...
    glFramebufferMemorylessPixelLocalStorageANGLEProc glFramebufferMemorylessPixelLocalStorageANGLEFn;
    glFramebufferParameteriProc glFramebufferParameteriFn;
    glFramebufferPixelLocalClearValuefvANGLEProc glFramebufferPixelLocalClearValuefvANGLEFn;
    glFramebufferPixelLocalClearValueivANGLEProc glFramebufferPixelLocalClearValueivANGLEFn;
    glFramebufferPixelLocalClearValueuivANGLEProc glFramebufferPixelLocalClearValueuivANGLEFn;
    glFramebufferPixelLocalStorageInterruptANGLEProc glFramebufferPixelLocalStorageInterruptANGLEFn;
    glFramebufferPixelLocalStorageRestoreANGLEProc glFramebufferPixelLocalStorageRestoreANGLEFn;
    ...
    glFramebufferTexturePixelLocalStorageANGLEProc glFramebufferTexturePixelLocalStorageANGLEFn;
    ...
    glGetActiveUniformBlockivRobustANGLEProc glGetActiveUniformBlockivRobustANGLEFn;
    ...
    glGetFramebufferAttachmentParameterivRobustANGLEProc glGetFramebufferAttachmentParameterivRobustANGLEFn;
    glGetFramebufferParameterivProc glGetFramebufferParameterivFn;
    glGetFramebufferParameterivRobustANGLEProc glGetFramebufferParameterivRobustANGLEFn;
    glGetFramebufferPixelLocalStorageParameterfvANGLEProc glGetFramebufferPixelLocalStorageParameterfvANGLEFn;
    glGetFramebufferPixelLocalStorageParameterfvRobustANGLEProc glGetFramebufferPixelLocalStorageParameterfvRobustANGLEFn;
    glGetFramebufferPixelLocalStorageParameterivANGLEProc glGetFramebufferPixelLocalStorageParameterivANGLEFn;
    glGetFramebufferPixelLocalStorageParameterivRobustANGLEProc glGetFramebufferPixelLocalStorageParameterivRobustANGLEFn;
    ...
    glGetRenderbufferParameterivRobustANGLEProc glGetRenderbufferParameterivRobustANGLEFn;
    ...
    glGetSamplerParameterIuivRobustANGLEProc glGetSamplerParameterIuivRobustANGLEFn;
    ...
    glGetVertexAttribPointervRobustANGLEProc glGetVertexAttribPointervRobustANGLEFn;
    glHintProc glHintFn;
    ...
    glMultiDrawArraysInstancedBaseInstanceANGLEProc glMultiDrawArraysInstancedBaseInstanceANGLEFn;
    ...
    glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLEProc glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLEFn;
    ...
    glRenderbufferStorageMultisampleAdvancedAMDProc glRenderbufferStorageMultisampleAdvancedAMDFn;
...
public:
    ...
    virtual void glAcquireTexturesANGLEFn(GLuint numTextures, const GLuint* textures, const GLenum* layouts) = 0;
    ...
    virtual void glBeginPixelLocalStorageANGLEFn(GLsizei n, const GLenum* loadops) = 0;
    ...
    virtual void glBindBufferBaseFn(GLenum target, GLuint index, GLuint buffer) = 0;
    virtual void glBindBufferRangeFn(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size) = 0;
    ...
    virtual void glBindImageTextureEXTFn(GLuint index, GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum access, GLint format) = 0;
    ...
    virtual void glBindUniformLocationCHROMIUMFn(GLuint program, GLint location, const char* name) = 0;
    virtual void glBindVertexArrayOESFn(GLuint array) = 0;
    virtual void glBindVertexBufferFn(GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride) = 0;
    ...
    virtual void glBlendEquationSeparateiOESFn(GLuint buf, GLenum modeRGB, GLenum modeAlpha) = 0;
    virtual void glBlendFuncFn(GLenum sfactor, GLenum dfactor) = 0;
    virtual void glBlendFunciOESFn(GLuint buf, GLenum sfactor, GLenum dfactor) = 0;
    virtual void glBlendFuncSeparateFn(GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha) = 0;
    virtual void glBlendFuncSeparateiOESFn(GLuint buf, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha) = 0;
    virtual void glBlitFramebufferFn(
        GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter)
        = 0;
    virtual void glBlobCacheCallbacksANGLEFn(GLSETBLOBPROCANGLE set, GLGETBLOBPROCANGLE get, const void* userData) = 0;
    ...
    virtual void glClearBufferfiFn(GLenum buffer, GLint drawbuffer, const GLfloat depth, GLint stencil) = 0;
    virtual void glClearBufferfvFn(GLenum buffer, GLint drawbuffer, const GLfloat* value) = 0;
    virtual void glClearBufferivFn(GLenum buffer, GLint drawbuffer, const GLint* value) = 0;
    virtual void glClearBufferuivFn(GLenum buffer, GLint drawbuffer, const GLuint* value) = 0;
    ...
    virtual void glClearTexImageFn(GLuint texture, GLint level, GLenum format, GLenum type, const GLvoid* data) = 0;
    virtual void glClearTexSubImageFn(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint width, GLint height, GLint depth,
    ...
    virtual void glColorMaskiOESFn(GLuint buf, GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) = 0;
    virtual void glCompileShaderFn(GLuint shader) = 0;
    virtual void glCompressedTexImage2DFn(
        GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void* data)
        = 0;
    virtual void glCompressedTexImage2DRobustANGLEFn(
        GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, GLsizei dataSize, const void* data)
        = 0;
    virtual void glCompressedTexImage3DFn(
        GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void* data)
        = 0;
    virtual void glCompressedTexImage3DRobustANGLEFn(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth,
        GLint border, GLsizei imageSize, GLsizei dataSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage2DFn(
        GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage2DRobustANGLEFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format,
        GLsizei imageSize, GLsizei dataSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage3DFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
        GLsizei depth, GLenum format, GLsizei imageSize, const void* data)
        = 0;
    virtual void glCompressedTexSubImage3DRobustANGLEFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
        GLsizei depth, GLenum format, GLsizei imageSize, GLsizei dataSize, const void* data)
        = 0;
    virtual void glCopyBufferSubDataFn(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size) = 0;
    virtual void glCopySubTextureCHROMIUMFn(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint xoffset, GLint yoffset,
    ...
    virtual void glCopyTexSubImage3DFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)
        = 0;
    virtual void glCopyTextureCHROMIUMFn(GLuint sourceId, GLint sourceLevel, GLenum destTarget, GLuint destId, GLint destLevel, GLint internalFormat,
    ...
    virtual GLuint glCreateShaderProgramvFn(GLenum type, GLsizei count, const char* const* strings) = 0;
    virtual void glCullFaceFn(GLenum mode) = 0;
    virtual void glDebugMessageCallbackFn(GLDEBUGPROC callback, const void* userParam) = 0;
    virtual void glDebugMessageControlFn(GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint* ids, GLboolean enabled) = 0;
    virtual void glDebugMessageInsertFn(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const char* buf) = 0;
    ...
    virtual void glDeleteMemoryObjectsEXTFn(GLsizei n, const GLuint* memoryObjects) = 0;
    virtual void glDeleteProgramFn(GLuint program) = 0;
    virtual void glDeleteProgramPipelinesFn(GLsizei n, const GLuint* pipelines) = 0;
    ...
    virtual void glDispatchComputeFn(GLuint numGroupsX, GLuint numGroupsY, GLuint numGroupsZ) = 0;
    ...
    virtual void glDrawArraysInstancedBaseInstanceANGLEFn(GLenum mode, GLint first, GLsizei count, GLsizei primcount, GLuint baseinstance) = 0;
    ...
    virtual void glDrawElementsIndirectFn(GLenum mode, GLenum type, const void* indirect) = 0;
    ...
    virtual void glDrawElementsInstancedBaseVertexBaseInstanceANGLEFn(
        GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei primcount, GLint baseVertex, GLuint baseInstance)
        = 0;
    virtual void glDrawRangeElementsFn(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void* indices) = 0;
    ...
    virtual void glEndPixelLocalStorageANGLEFn(GLsizei n, const GLenum* storeops) = 0;
    ...
    virtual void glFramebufferMemorylessPixelLocalStorageANGLEFn(GLint plane, GLenum internalformat) = 0;
    virtual void glFramebufferParameteriFn(GLenum target, GLenum pname, GLint param) = 0;
    virtual void glFramebufferPixelLocalClearValuefvANGLEFn(GLint plane, const GLfloat* value) = 0;
    virtual void glFramebufferPixelLocalClearValueivANGLEFn(GLint plane, const GLint* value) = 0;
    virtual void glFramebufferPixelLocalClearValueuivANGLEFn(GLint plane, const GLuint* value) = 0;
    ...
    virtual void glFramebufferTextureLayerFn(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer) = 0;
    virtual void glFramebufferTextureMultiviewOVRFn(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews) = 0;
    virtual void glFramebufferTexturePixelLocalStorageANGLEFn(GLint plane, GLuint backingtexture, GLint level, GLint layer) = 0;
    ...
    virtual void glGetActiveUniformBlockivFn(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint* params) = 0;
    virtual void glGetActiveUniformBlockivRobustANGLEFn(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params)
        = 0;
    virtual void glGetActiveUniformBlockNameFn(GLuint program, GLuint uniformBlockIndex, GLsizei bufSize, GLsizei* length, char* uniformBlockName) = 0;
    virtual void glGetActiveUniformsivFn(GLuint program, GLsizei uniformCount, const GLuint* uniformIndices, GLenum pname, GLint* params) = 0;
    ...
    virtual void glGetBooleani_vFn(GLenum target, GLuint index, GLboolean* data) = 0;
    virtual void glGetBooleani_vRobustANGLEFn(GLenum target, GLuint index, GLsizei bufSize, GLsizei* length, GLboolean* data) = 0;
    virtual void glGetBooleanvFn(GLenum pname, GLboolean* params) = 0;
    virtual void glGetBooleanvRobustANGLEFn(GLenum pname, GLsizei bufSize, GLsizei* length, GLboolean* data) = 0;
    virtual void glGetBufferParameteri64vRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint64* params) = 0;
    virtual void glGetBufferParameterivFn(GLenum target, GLenum pname, GLint* params) = 0;
    virtual void glGetBufferParameterivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetBufferPointervRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, void** params) = 0;
    virtual GLuint glGetDebugMessageLogFn(
        GLuint count, GLsizei bufSize, GLenum* sources, GLenum* types, GLuint* ids, GLenum* severities, GLsizei* lengths, char* messageLog)
        = 0;
    ...
    virtual void glGetFloatvRobustANGLEFn(GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* data) = 0;
    ...
    virtual void glGetFramebufferAttachmentParameterivRobustANGLEFn(
        GLenum target, GLenum attachment, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params)
        = 0;
    virtual void glGetFramebufferParameterivFn(GLenum target, GLenum pname, GLint* params) = 0;
    virtual void glGetFramebufferParameterivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetFramebufferPixelLocalStorageParameterfvANGLEFn(GLint plane, GLenum pname, GLfloat* params) = 0;
    virtual void glGetFramebufferPixelLocalStorageParameterfvRobustANGLEFn(GLint plane, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params) = 0;
    virtual void glGetFramebufferPixelLocalStorageParameterivANGLEFn(GLint plane, GLenum pname, GLint* params) = 0;
    virtual void glGetFramebufferPixelLocalStorageParameterivRobustANGLEFn(GLint plane, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual GLenum glGetGraphicsResetStatusARBFn(void) = 0;
    virtual void glGetInteger64i_vFn(GLenum target, GLuint index, GLint64* data) = 0;
    virtual void glGetInteger64i_vRobustANGLEFn(GLenum target, GLuint index, GLsizei bufSize, GLsizei* length, GLint64* data) = 0;
    virtual void glGetInteger64vFn(GLenum pname, GLint64* params) = 0;
    virtual void glGetInteger64vRobustANGLEFn(GLenum pname, GLsizei bufSize, GLsizei* length, GLint64* data) = 0;
    virtual void glGetIntegeri_vFn(GLenum target, GLuint index, GLint* data) = 0;
    virtual void glGetIntegeri_vRobustANGLEFn(GLenum target, GLuint index, GLsizei bufSize, GLsizei* length, GLint* data) = 0;
    virtual void glGetIntegervFn(GLenum pname, GLint* params) = 0;
    virtual void glGetIntegervRobustANGLEFn(GLenum pname, GLsizei bufSize, GLsizei* length, GLint* data) = 0;
    virtual void glGetInternalformativFn(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint* params) = 0;
    virtual void glGetInternalformativRobustANGLEFn(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetInternalformatSampleivNVFn(GLenum target, GLenum internalformat, GLsizei samples, GLenum pname, GLsizei bufSize, GLint* params) = 0;
    virtual void glGetMultisamplefvFn(GLenum pname, GLuint index, GLfloat* val) = 0;
    virtual void glGetMultisamplefvRobustANGLEFn(GLenum pname, GLuint index, GLsizei bufSize, GLsizei* length, GLfloat* val) = 0;
    virtual void glGetnUniformfvRobustANGLEFn(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLfloat* params) = 0;
    virtual void glGetnUniformivRobustANGLEFn(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetnUniformuivRobustANGLEFn(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLuint* params) = 0;
    virtual void glGetObjectLabelFn(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei* length, char* label) = 0;
    virtual void glGetObjectPtrLabelFn(void* ptr, GLsizei bufSize, GLsizei* length, char* label) = 0;
    virtual void glGetPointervFn(GLenum pname, void** params) = 0;
    virtual void glGetPointervRobustANGLERobustANGLEFn(GLenum pname, GLsizei bufSize, GLsizei* length, void** params) = 0;
    ...
    virtual void glGetProgramInterfaceivFn(GLuint program, GLenum programInterface, GLenum pname, GLint* params) = 0;
    virtual void glGetProgramInterfaceivRobustANGLEFn(GLuint program, GLenum programInterface, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params)
        = 0;
    virtual void glGetProgramivFn(GLuint program, GLenum pname, GLint* params) = 0;
    virtual void glGetProgramivRobustANGLEFn(GLuint program, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetProgramPipelineInfoLogFn(GLuint pipeline, GLsizei bufSize, GLsizei* length, GLchar* infoLog) = 0;
    virtual void glGetProgramPipelineivFn(GLuint pipeline, GLenum pname, GLint* params) = 0;
    virtual GLuint glGetProgramResourceIndexFn(GLuint program, GLenum programInterface, const GLchar* name) = 0;
    virtual void glGetProgramResourceivFn(
        GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum* props, GLsizei bufSize, GLsizei* length, GLint* params)
        = 0;
    virtual GLint glGetProgramResourceLocationFn(GLuint program, GLenum programInterface, const char* name) = 0;
    virtual void glGetProgramResourceNameFn(GLuint program, GLenum programInterface, GLuint index, GLsizei bufSize, GLsizei* length, GLchar* name) = 0;
    virtual void glGetQueryivFn(GLenum target, GLenum pname, GLint* params) = 0;
    virtual void glGetQueryivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetQueryObjecti64vFn(GLuint id, GLenum pname, GLint64* params) = 0;
    virtual void glGetQueryObjecti64vRobustANGLEFn(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLint64* params) = 0;
    virtual void glGetQueryObjectivFn(GLuint id, GLenum pname, GLint* params) = 0;
    virtual void glGetQueryObjectivRobustANGLEFn(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetQueryObjectui64vFn(GLuint id, GLenum pname, GLuint64* params) = 0;
    virtual void glGetQueryObjectui64vRobustANGLEFn(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint64* params) = 0;
    virtual void glGetQueryObjectuivFn(GLuint id, GLenum pname, GLuint* params) = 0;
    virtual void glGetQueryObjectuivRobustANGLEFn(GLuint id, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params) = 0;
    virtual void glGetRenderbufferParameterivEXTFn(GLenum target, GLenum pname, GLint* params) = 0;
    virtual void glGetRenderbufferParameterivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetSamplerParameterfvFn(GLuint sampler, GLenum pname, GLfloat* params) = 0;
    virtual void glGetSamplerParameterfvRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params) = 0;
    virtual void glGetSamplerParameterIivRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetSamplerParameterIuivRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params) = 0;
    virtual void glGetSamplerParameterivFn(GLuint sampler, GLenum pname, GLint* params) = 0;
    virtual void glGetSamplerParameterivRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    ...
    virtual void glGetShaderivRobustANGLEFn(GLuint shader, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    ...
    virtual void glGetTexLevelParameterfvRobustANGLEFn(GLenum target, GLint level, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params) = 0;
    virtual void glGetTexLevelParameterivFn(GLenum target, GLint level, GLenum pname, GLint* params) = 0;
    virtual void glGetTexLevelParameterivRobustANGLEFn(GLenum target, GLint level, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetTexParameterfvFn(GLenum target, GLenum pname, GLfloat* params) = 0;
    virtual void glGetTexParameterfvRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params) = 0;
    virtual void glGetTexParameterIivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetTexParameterIuivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params) = 0;
    virtual void glGetTexParameterivFn(GLenum target, GLenum pname, GLint* params) = 0;
    virtual void glGetTexParameterivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetTransformFeedbackVaryingFn(GLuint program, GLuint index, GLsizei bufSize, GLsizei* length, GLsizei* size, GLenum* type, char* name) = 0;
    virtual void glGetTranslatedShaderSourceANGLEFn(GLuint shader, GLsizei bufsize, GLsizei* length, char* source) = 0;
    virtual GLuint glGetUniformBlockIndexFn(GLuint program, const char* uniformBlockName) = 0;
    virtual void glGetUniformfvFn(GLuint program, GLint location, GLfloat* params) = 0;
    virtual void glGetUniformfvRobustANGLEFn(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLfloat* params) = 0;
    virtual void glGetUniformIndicesFn(GLuint program, GLsizei uniformCount, const char* const* uniformNames, GLuint* uniformIndices) = 0;
    virtual void glGetUniformivFn(GLuint program, GLint location, GLint* params) = 0;
    virtual void glGetUniformivRobustANGLEFn(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual GLint glGetUniformLocationFn(GLuint program, const char* name) = 0;
    virtual void glGetUniformuivFn(GLuint program, GLint location, GLuint* params) = 0;
    virtual void glGetUniformuivRobustANGLEFn(GLuint program, GLint location, GLsizei bufSize, GLsizei* length, GLuint* params) = 0;
    virtual void glGetVertexAttribfvFn(GLuint index, GLenum pname, GLfloat* params) = 0;
    virtual void glGetVertexAttribfvRobustANGLEFn(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLfloat* params) = 0;
    virtual void glGetVertexAttribIivRobustANGLEFn(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetVertexAttribIuivRobustANGLEFn(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLuint* params) = 0;
    virtual void glGetVertexAttribivFn(GLuint index, GLenum pname, GLint* params) = 0;
    virtual void glGetVertexAttribivRobustANGLEFn(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, GLint* params) = 0;
    virtual void glGetVertexAttribPointervFn(GLuint index, GLenum pname, void** pointer) = 0;
    virtual void glGetVertexAttribPointervRobustANGLEFn(GLuint index, GLenum pname, GLsizei bufSize, GLsizei* length, void** pointer) = 0;
    virtual void glHintFn(GLenum target, GLenum mode) = 0;
    virtual void glImportMemoryFdEXTFn(GLuint memory, GLuint64 size, GLenum handleType, GLint fd) = 0;
    virtual void glImportMemoryWin32HandleEXTFn(GLuint memory, GLuint64 size, GLenum handleType, void* handle) = 0;
    virtual void glImportMemoryZirconHandleANGLEFn(GLuint memory, GLuint64 size, GLenum handleType, GLuint handle) = 0;
    virtual void glImportSemaphoreFdEXTFn(GLuint semaphore, GLenum handleType, GLint fd) = 0;
    virtual void glImportSemaphoreWin32HandleEXTFn(GLuint semaphore, GLenum handleType, void* handle) = 0;
    virtual void glImportSemaphoreZirconHandleANGLEFn(GLuint semaphore, GLenum handleType, GLuint handle) = 0;
    virtual void glInsertEventMarkerEXTFn(GLsizei length, const char* marker) = 0;
    virtual void glInvalidateFramebufferFn(GLenum target, GLsizei numAttachments, const GLenum* attachments) = 0;
    virtual void glInvalidateSubFramebufferFn(GLenum target, GLsizei numAttachments, const GLenum* attachments, GLint x, GLint y, GLint width, GLint height)
        = 0;
    ...
    virtual void* glMapBufferRangeFn(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access) = 0;
    ...
    virtual void glMemoryObjectParameterivEXTFn(GLuint memoryObject, GLenum pname, const GLint* param) = 0;
    virtual void glMinSampleShadingFn(GLfloat value) = 0;
    virtual void glMultiDrawArraysANGLEFn(GLenum mode, const GLint* firsts, const GLsizei* counts, GLsizei drawcount) = 0;
    virtual void glMultiDrawArraysInstancedANGLEFn(GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instanceCounts, GLsizei drawcount)
        = 0;
    virtual void glMultiDrawArraysInstancedBaseInstanceANGLEFn(
        GLenum mode, const GLint* firsts, const GLsizei* counts, const GLsizei* instanceCounts, const GLuint* baseInstances, GLsizei drawcount)
        = 0;
    virtual void glMultiDrawElementsANGLEFn(GLenum mode, const GLsizei* counts, GLenum type, const GLvoid* const* indices, GLsizei drawcount) = 0;
    virtual void glMultiDrawElementsInstancedANGLEFn(
        GLenum mode, const GLsizei* counts, GLenum type, const GLvoid* const* indices, const GLsizei* instanceCounts, GLsizei drawcount)
        = 0;
    virtual void glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLEFn(GLenum mode, const GLsizei* counts, GLenum type, const GLvoid* const* indices,
        const GLsizei* instanceCounts, const GLint* baseVertices, const GLuint* baseInstances, GLsizei drawcount)
        = 0;
    virtual void glObjectLabelFn(GLenum identifier, GLuint name, GLsizei length, const char* label) = 0;
    virtual void glObjectPtrLabelFn(void* ptr, GLsizei length, const char* label) = 0;
    ...
    virtual void glPolygonOffsetClampEXTFn(GLfloat factor, GLfloat units, GLfloat clamp) = 0;
    ...
    virtual void glProgramUniform1fFn(GLuint program, GLint location, GLfloat v0) = 0;
    virtual void glProgramUniform1fvFn(GLuint program, GLint location, GLsizei count, const GLfloat* value) = 0;
    virtual void glProgramUniform1iFn(GLuint program, GLint location, GLint v0) = 0;
    virtual void glProgramUniform1ivFn(GLuint program, GLint location, GLsizei count, const GLint* value) = 0;
    virtual void glProgramUniform1uiFn(GLuint program, GLint location, GLuint v0) = 0;
    virtual void glProgramUniform1uivFn(GLuint program, GLint location, GLsizei count, const GLuint* value) = 0;
    virtual void glProgramUniform2fFn(GLuint program, GLint location, GLfloat v0, GLfloat v1) = 0;
    virtual void glProgramUniform2fvFn(GLuint program, GLint location, GLsizei count, const GLfloat* value) = 0;
    virtual void glProgramUniform2iFn(GLuint program, GLint location, GLint v0, GLint v1) = 0;
    virtual void glProgramUniform2ivFn(GLuint program, GLint location, GLsizei count, const GLint* value) = 0;
    virtual void glProgramUniform2uiFn(GLuint program, GLint location, GLuint v0, GLuint v1) = 0;
    virtual void glProgramUniform2uivFn(GLuint program, GLint location, GLsizei count, const GLuint* value) = 0;
    virtual void glProgramUniform3fFn(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2) = 0;
    virtual void glProgramUniform3fvFn(GLuint program, GLint location, GLsizei count, const GLfloat* value) = 0;
    virtual void glProgramUniform3iFn(GLuint program, GLint location, GLint v0, GLint v1, GLint v2) = 0;
    virtual void glProgramUniform3ivFn(GLuint program, GLint location, GLsizei count, const GLint* value) = 0;
    virtual void glProgramUniform3uiFn(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2) = 0;
    virtual void glProgramUniform3uivFn(GLuint program, GLint location, GLsizei count, const GLuint* value) = 0;
    virtual void glProgramUniform4fFn(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3) = 0;
    virtual void glProgramUniform4fvFn(GLuint program, GLint location, GLsizei count, const GLfloat* value) = 0;
    virtual void glProgramUniform4iFn(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3) = 0;
    virtual void glProgramUniform4ivFn(GLuint program, GLint location, GLsizei count, const GLint* value) = 0;
    virtual void glProgramUniform4uiFn(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3) = 0;
    virtual void glProgramUniform4uivFn(GLuint program, GLint location, GLsizei count, const GLuint* value) = 0;
    virtual void glProgramUniformMatrix2fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix2x3fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix2x4fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix3fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix3x2fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix3x4fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix4fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix4x2fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProgramUniformMatrix4x3fvFn(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glProvokingVertexANGLEFn(GLenum provokeMode) = 0;
    virtual void glPushDebugGroupFn(GLenum source, GLuint id, GLsizei length, const char* message) = 0;
    ...
    virtual void glReadnPixelsRobustANGLEFn(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLsizei* length,
        GLsizei* columns, GLsizei* rows, void* data)
        = 0;
    virtual void glReadPixelsFn(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void* pixels) = 0;
    virtual void glReadPixelsRobustANGLEFn(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLsizei bufSize, GLsizei* length,
        GLsizei* columns, GLsizei* rows, void* pixels)
        = 0;
    virtual void glReleaseShaderCompilerFn(void) = 0;
    virtual void glReleaseTexturesANGLEFn(GLuint numTextures, const GLuint* textures, GLenum* layouts) = 0;
    ...
    virtual void glSamplerParameterfFn(GLuint sampler, GLenum pname, GLfloat param) = 0;
    virtual void glSamplerParameterfvFn(GLuint sampler, GLenum pname, const GLfloat* params) = 0;
    virtual void glSamplerParameterfvRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, const GLfloat* param) = 0;
    virtual void glSamplerParameteriFn(GLuint sampler, GLenum pname, GLint param) = 0;
    virtual void glSamplerParameterIivRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, const GLint* param) = 0;
    virtual void glSamplerParameterIuivRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, const GLuint* param) = 0;
    virtual void glSamplerParameterivFn(GLuint sampler, GLenum pname, const GLint* params) = 0;
    virtual void glSamplerParameterivRobustANGLEFn(GLuint sampler, GLenum pname, GLsizei bufSize, const GLint* param) = 0;
    ...
    virtual void glSignalSemaphoreEXTFn(
        GLuint semaphore, GLuint numBufferBarriers, const GLuint* buffers, GLuint numTextureBarriers, const GLuint* textures, const GLenum* dstLayouts)
        = 0;
    virtual void glStartTilingQCOMFn(GLuint x, GLuint y, GLuint width, GLuint height, GLbitfield preserveMask) = 0;
    ...
    virtual void glTexBufferFn(GLenum target, GLenum internalformat, GLuint buffer) = 0;
    virtual void glTexBufferRangeFn(GLenum target, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size) = 0;
    virtual void glTexImage2DFn(
        GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void* pixels)
        = 0;
    virtual void glTexImage2DExternalANGLEFn(
        GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type)
        = 0;
    virtual void glTexImage2DRobustANGLEFn(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format,
        GLenum type, GLsizei bufSize, const void* pixels)
        = 0;
    virtual void glTexImage3DFn(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format,
        GLenum type, const void* pixels)
        = 0;
    virtual void glTexImage3DRobustANGLEFn(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border,
        GLenum format, GLenum type, GLsizei bufSize, const void* pixels)
        = 0;
    ...
    virtual void glTexParameterfvRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, const GLfloat* params) = 0;
    virtual void glTexParameteriFn(GLenum target, GLenum pname, GLint param) = 0;
    virtual void glTexParameterIivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, const GLint* params) = 0;
    virtual void glTexParameterIuivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, const GLuint* params) = 0;
    virtual void glTexParameterivFn(GLenum target, GLenum pname, const GLint* params) = 0;
    virtual void glTexParameterivRobustANGLEFn(GLenum target, GLenum pname, GLsizei bufSize, const GLint* params) = 0;
    virtual void glTexStorage2DEXTFn(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height) = 0;
    virtual void glTexStorage2DMultisampleFn(
        GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations)
        = 0;
    virtual void glTexStorage3DFn(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth) = 0;
    virtual void glTexStorageMem2DEXTFn(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory, GLuint64 offset)
        = 0;
    virtual void glTexStorageMemFlags2DANGLEFn(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLsizei height, GLuint memory,
    ...
    virtual void glTexSubImage2DFn(
        GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* pixels)
        = 0;
    virtual void glTexSubImage2DRobustANGLEFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format,
        GLenum type, GLsizei bufSize, const void* pixels)
        = 0;
    virtual void glTexSubImage3DFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth,
        GLenum format, GLenum type, const void* pixels)
        = 0;
    virtual void glTexSubImage3DRobustANGLEFn(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height,
        GLsizei depth, GLenum format, GLenum type, GLsizei bufSize, const void* pixels)
        = 0;
    virtual void glTransformFeedbackVaryingsFn(GLuint program, GLsizei count, const char* const* varyings, GLenum bufferMode) = 0;
    ...
    virtual void glUniform1uivFn(GLint location, GLsizei count, const GLuint* v) = 0;
    ...
    virtual void glUniform2uivFn(GLint location, GLsizei count, const GLuint* v) = 0;
    ...
    virtual void glUniform3uiFn(GLint location, GLuint v0, GLuint v1, GLuint v2) = 0;
    virtual void glUniform3uivFn(GLint location, GLsizei count, const GLuint* v) = 0;
    ...
    virtual void glUniform4uiFn(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3) = 0;
    virtual void glUniform4uivFn(GLint location, GLsizei count, const GLuint* v) = 0;
    virtual void glUniformBlockBindingFn(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding) = 0;
    virtual void glUniformMatrix2fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix2x3fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix2x4fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix3fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix3x2fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix3x4fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix4fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix4x2fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual void glUniformMatrix4x3fvFn(GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) = 0;
    virtual GLboolean glUnmapBufferFn(GLenum target) = 0;
    virtual void glUseProgramFn(GLuint program) = 0;
    virtual void glUseProgramStagesFn(GLuint pipeline, GLbitfield stages, GLuint program) = 0;
    ...
    virtual void glVertexAttribBindingFn(GLuint attribindex, GLuint bindingindex) = 0;
    virtual void glVertexAttribDivisorANGLEFn(GLuint index, GLuint divisor) = 0;
    virtual void glVertexAttribFormatFn(GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset) = 0;
    virtual void glVertexAttribI4iFn(GLuint indx, GLint x, GLint y, GLint z, GLint w) = 0;
    virtual void glVertexAttribI4ivFn(GLuint indx, const GLint* values) = 0;
    virtual void glVertexAttribI4uiFn(GLuint indx, GLuint x, GLuint y, GLuint z, GLuint w) = 0;
    virtual void glVertexAttribI4uivFn(GLuint indx, const GLuint* values) = 0;
    virtual void glVertexAttribIFormatFn(GLuint attribindex, GLint size, GLenum type, GLuint relativeoffset) = 0;
    virtual void glVertexAttribIPointerFn(GLuint indx, GLint size, GLenum type, GLsizei stride, const void* ptr) = 0;
    ...
    virtual void glVertexBindingDivisorFn(GLuint bindingindex, GLuint divisor) = 0;
    virtual void glViewportFn(GLint x, GLint y, GLsizei width, GLsizei height) = 0;
    virtual void glWaitSemaphoreEXTFn(
        GLuint semaphore, GLuint numBufferBarriers, const GLuint* buffers, GLuint numTextureBarriers, const GLuint* textures, const GLenum* srcLayouts)
        = 0;
    virtual void glWaitSyncFn(GLsync sync, GLbitfield flags, GLuint64 timeout) = 0;
    virtual void glWindowRectanglesEXTFn(GLenum mode, GLsizei n, const GLint* box) = 0;
};

} // namespace gl

#define glAcquireTexturesANGLE ::gl::g_current_gl_context->glAcquireTexturesANGLEFn
#define glActiveShaderProgram ::gl::g_current_gl_context->glActiveShaderProgramFn
...
#define glBeginPixelLocalStorageANGLE ::gl::g_current_gl_context->glBeginPixelLocalStorageANGLEFn
#define glBeginQuery ::gl::g_current_gl_context->glBeginQueryFn
#define glBeginTransformFeedback ::gl::g_current_gl_context->glBeginTransformFeedbackFn
...
#define glBindFragDataLocation ::gl::g_current_gl_context->glBindFragDataLocationFn
#define glBindFragDataLocationIndexed ::gl::g_current_gl_context->glBindFragDataLocationIndexedFn
#define glBindFramebufferEXT ::gl::g_current_gl_context->glBindFramebufferEXTFn
#define glBindImageTextureEXT ::gl::g_current_gl_context->glBindImageTextureEXTFn
#define glBindProgramPipeline ::gl::g_current_gl_context->glBindProgramPipelineFn
#define glBindRenderbufferEXT ::gl::g_current_gl_context->glBindRenderbufferEXTFn
#define glBindSampler ::gl::g_current_gl_context->glBindSamplerFn
#define glBindTexture ::gl::g_current_gl_context->glBindTextureFn
#define glBindTransformFeedback ::gl::g_current_gl_context->glBindTransformFeedbackFn
#define glBindUniformLocationCHROMIUM ::gl::g_current_gl_context->glBindUniformLocationCHROMIUMFn
...
#define glBlendEquationSeparate ::gl::g_current_gl_context->glBlendEquationSeparateFn
#define glBlendEquationSeparateiOES ::gl::g_current_gl_context->glBlendEquationSeparateiOESFn
...
#define glBlendFuncSeparateiOES ::gl::g_current_gl_context->glBlendFuncSeparateiOESFn
#define glBlitFramebuffer ::gl::g_current_gl_context->glBlitFramebufferFn
#define glBlobCacheCallbacksANGLE ::gl::g_current_gl_context->glBlobCacheCallbacksANGLEFn
...
#define glCheckFramebufferStatusEXT ::gl::g_current_gl_context->glCheckFramebufferStatusEXTFn
...
#define glCompressedTexImage2D ::gl::g_current_gl_context->glCompressedTexImage2DFn
#define glCompressedTexImage2DRobustANGLE ::gl::g_current_gl_context->glCompressedTexImage2DRobustANGLEFn
#define glCompressedTexImage3D ::gl::g_current_gl_context->glCompressedTexImage3DFn
#define glCompressedTexImage3DRobustANGLE ::gl::g_current_gl_context->glCompressedTexImage3DRobustANGLEFn
#define glCompressedTexSubImage2D ::gl::g_current_gl_context->glCompressedTexSubImage2DFn
#define glCompressedTexSubImage2DRobustANGLE ::gl::g_current_gl_context->glCompressedTexSubImage2DRobustANGLEFn
#define glCompressedTexSubImage3D ::gl::g_current_gl_context->glCompressedTexSubImage3DFn
#define glCompressedTexSubImage3DRobustANGLE ::gl::g_current_gl_context->glCompressedTexSubImage3DRobustANGLEFn
#define glCopyBufferSubData ::gl::g_current_gl_context->glCopyBufferSubDataFn
#define glCopySubTextureCHROMIUM ::gl::g_current_gl_context->glCopySubTextureCHROMIUMFn
...
#define glCopyTextureCHROMIUM ::gl::g_current_gl_context->glCopyTextureCHROMIUMFn
#define glCreateMemoryObjectsEXT ::gl::g_current_gl_context->glCreateMemoryObjectsEXTFn
...
#define glCreateShaderProgramv ::gl::g_current_gl_context->glCreateShaderProgramvFn
#define glCullFace ::gl::g_current_gl_context->glCullFaceFn
#define glDebugMessageCallback ::gl::g_current_gl_context->glDebugMessageCallbackFn
#define glDebugMessageControl ::gl::g_current_gl_context->glDebugMessageControlFn
...
#define glDeleteFramebuffersEXT ::gl::g_current_gl_context->glDeleteFramebuffersEXTFn
#define glDeleteMemoryObjectsEXT ::gl::g_current_gl_context->glDeleteMemoryObjectsEXTFn
#define glDeleteProgram ::gl::g_current_gl_context->glDeleteProgramFn
#define glDeleteProgramPipelines ::gl::g_current_gl_context->glDeleteProgramPipelinesFn
#define glDeleteQueries ::gl::g_current_gl_context->glDeleteQueriesFn
#define glDeleteRenderbuffersEXT ::gl::g_current_gl_context->glDeleteRenderbuffersEXTFn
#define glDeleteSamplers ::gl::g_current_gl_context->glDeleteSamplersFn
#define glDeleteSemaphoresEXT ::gl::g_current_gl_context->glDeleteSemaphoresEXTFn
...
#define glDeleteTransformFeedbacks ::gl::g_current_gl_context->glDeleteTransformFeedbacksFn
#define glDeleteVertexArraysOES ::gl::g_current_gl_context->glDeleteVertexArraysOESFn
...
#define glDisableExtensionANGLE ::gl::g_current_gl_context->glDisableExtensionANGLEFn
#define glDisableiOES ::gl::g_current_gl_context->glDisableiOESFn
#define glDisableVertexAttribArray ::gl::g_current_gl_context->glDisableVertexAttribArrayFn
#define glDiscardFramebufferEXT ::gl::g_current_gl_context->glDiscardFramebufferEXTFn
#define glDispatchCompute ::gl::g_current_gl_context->glDispatchComputeFn
#define glDispatchComputeIndirect ::gl::g_current_gl_context->glDispatchComputeIndirectFn
...
#define glDrawArraysInstancedANGLE ::gl::g_current_gl_context->glDrawArraysInstancedANGLEFn
#define glDrawArraysInstancedBaseInstanceANGLE ::gl::g_current_gl_context->glDrawArraysInstancedBaseInstanceANGLEFn
...
#define glDrawElementsIndirect ::gl::g_current_gl_context->glDrawElementsIndirectFn
#define glDrawElementsInstancedANGLE ::gl::g_current_gl_context->glDrawElementsInstancedANGLEFn
#define glDrawElementsInstancedBaseVertexBaseInstanceANGLE ::gl::g_current_gl_context->glDrawElementsInstancedBaseVertexBaseInstanceANGLEFn
#define glDrawRangeElements ::gl::g_current_gl_context->glDrawRangeElementsFn
#define glEGLImageTargetRenderbufferStorageOES ::gl::g_current_gl_context->glEGLImageTargetRenderbufferStorageOESFn
#define glEGLImageTargetTexture2DOES ::gl::g_current_gl_context->glEGLImageTargetTexture2DOESFn
#define glEnable ::gl::g_current_gl_context->glEnableFn
#define glEnableiOES ::gl::g_current_gl_context->glEnableiOESFn
#define glEnableVertexAttribArray ::gl::g_current_gl_context->glEnableVertexAttribArrayFn
#define glEndPixelLocalStorageANGLE ::gl::g_current_gl_context->glEndPixelLocalStorageANGLEFn
#define glEndQuery ::gl::g_current_gl_context->glEndQueryFn
#define glEndTilingQCOM ::gl::g_current_gl_context->glEndTilingQCOMFn
#define glEndTransformFeedback ::gl::g_current_gl_context->glEndTransformFeedbackFn
...
#define glFlushMappedBufferRange ::gl::g_current_gl_context->glFlushMappedBufferRangeFn
#define glFramebufferMemorylessPixelLocalStorageANGLE ::gl::g_current_gl_context->glFramebufferMemorylessPixelLocalStorageANGLEFn
#define glFramebufferParameteri ::gl::g_current_gl_context->glFramebufferParameteriFn
#define glFramebufferPixelLocalClearValuefvANGLE ::gl::g_current_gl_context->glFramebufferPixelLocalClearValuefvANGLEFn
#define glFramebufferPixelLocalClearValueivANGLE ::gl::g_current_gl_context->glFramebufferPixelLocalClearValueivANGLEFn
#define glFramebufferPixelLocalClearValueuivANGLE ::gl::g_current_gl_context->glFramebufferPixelLocalClearValueuivANGLEFn
#define glFramebufferPixelLocalStorageInterruptANGLE ::gl::g_current_gl_context->glFramebufferPixelLocalStorageInterruptANGLEFn
#define glFramebufferPixelLocalStorageRestoreANGLE ::gl::g_current_gl_context->glFramebufferPixelLocalStorageRestoreANGLEFn
#define glFramebufferRenderbufferEXT ::gl::g_current_gl_context->glFramebufferRenderbufferEXTFn
#define glFramebufferTexture2DEXT ::gl::g_current_gl_context->glFramebufferTexture2DEXTFn
#define glFramebufferTexture2DMultisampleEXT ::gl::g_current_gl_context->glFramebufferTexture2DMultisampleEXTFn
#define glFramebufferTextureLayer ::gl::g_current_gl_context->glFramebufferTextureLayerFn
#define glFramebufferTextureMultiviewOVR ::gl::g_current_gl_context->glFramebufferTextureMultiviewOVRFn
#define glFramebufferTexturePixelLocalStorageANGLE ::gl::g_current_gl_context->glFramebufferTexturePixelLocalStorageANGLEFn
...
#define glGenProgramPipelines ::gl::g_current_gl_context->glGenProgramPipelinesFn
#define glGenQueries ::gl::g_current_gl_context->glGenQueriesFn
#define glGenRenderbuffersEXT ::gl::g_current_gl_context->glGenRenderbuffersEXTFn
...
#define glGenTransformFeedbacks ::gl::g_current_gl_context->glGenTransformFeedbacksFn
...
#define glGetActiveUniformBlockiv ::gl::g_current_gl_context->glGetActiveUniformBlockivFn
#define glGetActiveUniformBlockivRobustANGLE ::gl::g_current_gl_context->glGetActiveUniformBlockivRobustANGLEFn
#define glGetActiveUniformBlockName ::gl::g_current_gl_context->glGetActiveUniformBlockNameFn
#define glGetActiveUniformsiv ::gl::g_current_gl_context->glGetActiveUniformsivFn
...
#define glGetBooleani_vRobustANGLE ::gl::g_current_gl_context->glGetBooleani_vRobustANGLEFn
#define glGetBooleanv ::gl::g_current_gl_context->glGetBooleanvFn
#define glGetBooleanvRobustANGLE ::gl::g_current_gl_context->glGetBooleanvRobustANGLEFn
#define glGetBufferParameteri64vRobustANGLE ::gl::g_current_gl_context->glGetBufferParameteri64vRobustANGLEFn
#define glGetBufferParameteriv ::gl::g_current_gl_context->glGetBufferParameterivFn
#define glGetBufferParameterivRobustANGLE ::gl::g_current_gl_context->glGetBufferParameterivRobustANGLEFn
#define glGetBufferPointervRobustANGLE ::gl::g_current_gl_context->glGetBufferPointervRobustANGLEFn
...
#define glGetFloatvRobustANGLE ::gl::g_current_gl_context->glGetFloatvRobustANGLEFn
#define glGetFragDataIndex ::gl::g_current_gl_context->glGetFragDataIndexFn
#define glGetFragDataLocation ::gl::g_current_gl_context->glGetFragDataLocationFn
#define glGetFramebufferAttachmentParameterivEXT ::gl::g_current_gl_context->glGetFramebufferAttachmentParameterivEXTFn
#define glGetFramebufferAttachmentParameterivRobustANGLE ::gl::g_current_gl_context->glGetFramebufferAttachmentParameterivRobustANGLEFn
#define glGetFramebufferParameteriv ::gl::g_current_gl_context->glGetFramebufferParameterivFn
#define glGetFramebufferParameterivRobustANGLE ::gl::g_current_gl_context->glGetFramebufferParameterivRobustANGLEFn
#define glGetFramebufferPixelLocalStorageParameterfvANGLE ::gl::g_current_gl_context->glGetFramebufferPixelLocalStorageParameterfvANGLEFn
#define glGetFramebufferPixelLocalStorageParameterfvRobustANGLE ::gl::g_current_gl_context->glGetFramebufferPixelLocalStorageParameterfvRobustANGLEFn
#define glGetFramebufferPixelLocalStorageParameterivANGLE ::gl::g_current_gl_context->glGetFramebufferPixelLocalStorageParameterivANGLEFn
#define glGetFramebufferPixelLocalStorageParameterivRobustANGLE ::gl::g_current_gl_context->glGetFramebufferPixelLocalStorageParameterivRobustANGLEFn
#define glGetGraphicsResetStatusARB ::gl::g_current_gl_context->glGetGraphicsResetStatusARBFn
#define glGetInteger64i_v ::gl::g_current_gl_context->glGetInteger64i_vFn
#define glGetInteger64i_vRobustANGLE ::gl::g_current_gl_context->glGetInteger64i_vRobustANGLEFn
#define glGetInteger64v ::gl::g_current_gl_context->glGetInteger64vFn
#define glGetInteger64vRobustANGLE ::gl::g_current_gl_context->glGetInteger64vRobustANGLEFn
#define glGetIntegeri_v ::gl::g_current_gl_context->glGetIntegeri_vFn
#define glGetIntegeri_vRobustANGLE ::gl::g_current_gl_context->glGetIntegeri_vRobustANGLEFn
#define glGetIntegerv ::gl::g_current_gl_context->glGetIntegervFn
#define glGetIntegervRobustANGLE ::gl::g_current_gl_context->glGetIntegervRobustANGLEFn
#define glGetInternalformativ ::gl::g_current_gl_context->glGetInternalformativFn
#define glGetInternalformativRobustANGLE ::gl::g_current_gl_context->glGetInternalformativRobustANGLEFn
#define glGetInternalformatSampleivNV ::gl::g_current_gl_context->glGetInternalformatSampleivNVFn
#define glGetMultisamplefv ::gl::g_current_gl_context->glGetMultisamplefvFn
#define glGetMultisamplefvRobustANGLE ::gl::g_current_gl_context->glGetMultisamplefvRobustANGLEFn
#define glGetnUniformfvRobustANGLE ::gl::g_current_gl_context->glGetnUniformfvRobustANGLEFn
#define glGetnUniformivRobustANGLE ::gl::g_current_gl_context->glGetnUniformivRobustANGLEFn
#define glGetnUniformuivRobustANGLE ::gl::g_current_gl_context->glGetnUniformuivRobustANGLEFn
...
#define glGetPointervRobustANGLERobustANGLE ::gl::g_current_gl_context->glGetPointervRobustANGLERobustANGLEFn
...
#define glGetProgramInterfaceiv ::gl::g_current_gl_context->glGetProgramInterfaceivFn
#define glGetProgramInterfaceivRobustANGLE ::gl::g_current_gl_context->glGetProgramInterfaceivRobustANGLEFn
#define glGetProgramiv ::gl::g_current_gl_context->glGetProgramivFn
#define glGetProgramivRobustANGLE ::gl::g_current_gl_context->glGetProgramivRobustANGLEFn
#define glGetProgramPipelineInfoLog ::gl::g_current_gl_context->glGetProgramPipelineInfoLogFn
#define glGetProgramPipelineiv ::gl::g_current_gl_context->glGetProgramPipelineivFn
#define glGetProgramResourceIndex ::gl::g_current_gl_context->glGetProgramResourceIndexFn
#define glGetProgramResourceiv ::gl::g_current_gl_context->glGetProgramResourceivFn
#define glGetProgramResourceLocation ::gl::g_current_gl_context->glGetProgramResourceLocationFn
#define glGetProgramResourceName ::gl::g_current_gl_context->glGetProgramResourceNameFn
#define glGetQueryiv ::gl::g_current_gl_context->glGetQueryivFn
#define glGetQueryivRobustANGLE ::gl::g_current_gl_context->glGetQueryivRobustANGLEFn
#define glGetQueryObjecti64v ::gl::g_current_gl_context->glGetQueryObjecti64vFn
#define glGetQueryObjecti64vRobustANGLE ::gl::g_current_gl_context->glGetQueryObjecti64vRobustANGLEFn
#define glGetQueryObjectiv ::gl::g_current_gl_context->glGetQueryObjectivFn
#define glGetQueryObjectivRobustANGLE ::gl::g_current_gl_context->glGetQueryObjectivRobustANGLEFn
#define glGetQueryObjectui64v ::gl::g_current_gl_context->glGetQueryObjectui64vFn
#define glGetQueryObjectui64vRobustANGLE ::gl::g_current_gl_context->glGetQueryObjectui64vRobustANGLEFn
#define glGetQueryObjectuiv ::gl::g_current_gl_context->glGetQueryObjectuivFn
#define glGetQueryObjectuivRobustANGLE ::gl::g_current_gl_context->glGetQueryObjectuivRobustANGLEFn
#define glGetRenderbufferParameterivEXT ::gl::g_current_gl_context->glGetRenderbufferParameterivEXTFn
#define glGetRenderbufferParameterivRobustANGLE ::gl::g_current_gl_context->glGetRenderbufferParameterivRobustANGLEFn
#define glGetSamplerParameterfv ::gl::g_current_gl_context->glGetSamplerParameterfvFn
#define glGetSamplerParameterfvRobustANGLE ::gl::g_current_gl_context->glGetSamplerParameterfvRobustANGLEFn
#define glGetSamplerParameterIivRobustANGLE ::gl::g_current_gl_context->glGetSamplerParameterIivRobustANGLEFn
#define glGetSamplerParameterIuivRobustANGLE ::gl::g_current_gl_context->glGetSamplerParameterIuivRobustANGLEFn
#define glGetSamplerParameteriv ::gl::g_current_gl_context->glGetSamplerParameterivFn
#define glGetSamplerParameterivRobustANGLE ::gl::g_current_gl_context->glGetSamplerParameterivRobustANGLEFn
...
#define glGetShaderivRobustANGLE ::gl::g_current_gl_context->glGetShaderivRobustANGLEFn
#define glGetShaderPrecisionFormat ::gl::g_current_gl_context->glGetShaderPrecisionFormatFn
...
#define glGetTexLevelParameterfv ::gl::g_current_gl_context->glGetTexLevelParameterfvFn
#define glGetTexLevelParameterfvRobustANGLE ::gl::g_current_gl_context->glGetTexLevelParameterfvRobustANGLEFn
#define glGetTexLevelParameteriv ::gl::g_current_gl_context->glGetTexLevelParameterivFn
#define glGetTexLevelParameterivRobustANGLE ::gl::g_current_gl_context->glGetTexLevelParameterivRobustANGLEFn
#define glGetTexParameterfv ::gl::g_current_gl_context->glGetTexParameterfvFn
#define glGetTexParameterfvRobustANGLE ::gl::g_current_gl_context->glGetTexParameterfvRobustANGLEFn
#define glGetTexParameterIivRobustANGLE ::gl::g_current_gl_context->glGetTexParameterIivRobustANGLEFn
#define glGetTexParameterIuivRobustANGLE ::gl::g_current_gl_context->glGetTexParameterIuivRobustANGLEFn
#define glGetTexParameteriv ::gl::g_current_gl_context->glGetTexParameterivFn
#define glGetTexParameterivRobustANGLE ::gl::g_current_gl_context->glGetTexParameterivRobustANGLEFn
#define glGetTransformFeedbackVarying ::gl::g_current_gl_context->glGetTransformFeedbackVaryingFn
#define glGetTranslatedShaderSourceANGLE ::gl::g_current_gl_context->glGetTranslatedShaderSourceANGLEFn
#define glGetUniformBlockIndex ::gl::g_current_gl_context->glGetUniformBlockIndexFn
#define glGetUniformfv ::gl::g_current_gl_context->glGetUniformfvFn
#define glGetUniformfvRobustANGLE ::gl::g_current_gl_context->glGetUniformfvRobustANGLEFn
...
#define glGetUniformivRobustANGLE ::gl::g_current_gl_context->glGetUniformivRobustANGLEFn
...
#define glGetUniformuivRobustANGLE ::gl::g_current_gl_context->glGetUniformuivRobustANGLEFn
#define glGetVertexAttribfv ::gl::g_current_gl_context->glGetVertexAttribfvFn
#define glGetVertexAttribfvRobustANGLE ::gl::g_current_gl_context->glGetVertexAttribfvRobustANGLEFn
#define glGetVertexAttribIivRobustANGLE ::gl::g_current_gl_context->glGetVertexAttribIivRobustANGLEFn
#define glGetVertexAttribIuivRobustANGLE ::gl::g_current_gl_context->glGetVertexAttribIuivRobustANGLEFn
#define glGetVertexAttribiv ::gl::g_current_gl_context->glGetVertexAttribivFn
#define glGetVertexAttribivRobustANGLE ::gl::g_current_gl_context->glGetVertexAttribivRobustANGLEFn
#define glGetVertexAttribPointerv ::gl::g_current_gl_context->glGetVertexAttribPointervFn
#define glGetVertexAttribPointervRobustANGLE ::gl::g_current_gl_context->glGetVertexAttribPointervRobustANGLEFn
#define glHint ::gl::g_current_gl_context->glHintFn
#define glImportMemoryFdEXT ::gl::g_current_gl_context->glImportMemoryFdEXTFn
#define glImportMemoryWin32HandleEXT ::gl::g_current_gl_context->glImportMemoryWin32HandleEXTFn
#define glImportMemoryZirconHandleANGLE ::gl::g_current_gl_context->glImportMemoryZirconHandleANGLEFn
#define glImportSemaphoreFdEXT ::gl::g_current_gl_context->glImportSemaphoreFdEXTFn
#define glImportSemaphoreWin32HandleEXT ::gl::g_current_gl_context->glImportSemaphoreWin32HandleEXTFn
#define glImportSemaphoreZirconHandleANGLE ::gl::g_current_gl_context->glImportSemaphoreZirconHandleANGLEFn
#define glInsertEventMarkerEXT ::gl::g_current_gl_context->glInsertEventMarkerEXTFn
#define glInvalidateFramebuffer ::gl::g_current_gl_context->glInvalidateFramebufferFn
#define glInvalidateSubFramebuffer ::gl::g_current_gl_context->glInvalidateSubFramebufferFn
#define glInvalidateTextureANGLE ::gl::g_current_gl_context->glInvalidateTextureANGLEFn
...
#define glIsTransformFeedback ::gl::g_current_gl_context->glIsTransformFeedbackFn
...
#define glMaxShaderCompilerThreadsKHR ::gl::g_current_gl_context->glMaxShaderCompilerThreadsKHRFn
...
#define glMemoryObjectParameterivEXT ::gl::g_current_gl_context->glMemoryObjectParameterivEXTFn
#define glMinSampleShading ::gl::g_current_gl_context->glMinSampleShadingFn
#define glMultiDrawArraysANGLE ::gl::g_current_gl_context->glMultiDrawArraysANGLEFn
#define glMultiDrawArraysInstancedANGLE ::gl::g_current_gl_context->glMultiDrawArraysInstancedANGLEFn
#define glMultiDrawArraysInstancedBaseInstanceANGLE ::gl::g_current_gl_context->glMultiDrawArraysInstancedBaseInstanceANGLEFn
#define glMultiDrawElementsANGLE ::gl::g_current_gl_context->glMultiDrawElementsANGLEFn
#define glMultiDrawElementsInstancedANGLE ::gl::g_current_gl_context->glMultiDrawElementsInstancedANGLEFn
#define glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLE ::gl::g_current_gl_context->glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLEFn
...
#define glPauseTransformFeedback ::gl::g_current_gl_context->glPauseTransformFeedbackFn
#define glPixelLocalStorageBarrierANGLE ::gl::g_current_gl_context->glPixelLocalStorageBarrierANGLEFn
...
#define glPolygonOffsetClampEXT ::gl::g_current_gl_context->glPolygonOffsetClampEXTFn
...
#define glPrimitiveRestartIndex ::gl::g_current_gl_context->glPrimitiveRestartIndexFn
...
#define glProgramUniformMatrix2fv ::gl::g_current_gl_context->glProgramUniformMatrix2fvFn
#define glProgramUniformMatrix2x3fv ::gl::g_current_gl_context->glProgramUniformMatrix2x3fvFn
#define glProgramUniformMatrix2x4fv ::gl::g_current_gl_context->glProgramUniformMatrix2x4fvFn
#define glProgramUniformMatrix3fv ::gl::g_current_gl_context->glProgramUniformMatrix3fvFn
#define glProgramUniformMatrix3x2fv ::gl::g_current_gl_context->glProgramUniformMatrix3x2fvFn
#define glProgramUniformMatrix3x4fv ::gl::g_current_gl_context->glProgramUniformMatrix3x4fvFn
#define glProgramUniformMatrix4fv ::gl::g_current_gl_context->glProgramUniformMatrix4fvFn
#define glProgramUniformMatrix4x2fv ::gl::g_current_gl_context->glProgramUniformMatrix4x2fvFn
#define glProgramUniformMatrix4x3fv ::gl::g_current_gl_context->glProgramUniformMatrix4x3fvFn
#define glProvokingVertexANGLE ::gl::g_current_gl_context->glProvokingVertexANGLEFn
...
#define glReadnPixelsRobustANGLE ::gl::g_current_gl_context->glReadnPixelsRobustANGLEFn
#define glReadPixels ::gl::g_current_gl_context->glReadPixelsFn
#define glReadPixelsRobustANGLE ::gl::g_current_gl_context->glReadPixelsRobustANGLEFn
#define glReleaseShaderCompiler ::gl::g_current_gl_context->glReleaseShaderCompilerFn
#define glReleaseTexturesANGLE ::gl::g_current_gl_context->glReleaseTexturesANGLEFn
#define glRenderbufferStorageEXT ::gl::g_current_gl_context->glRenderbufferStorageEXTFn
#define glRenderbufferStorageMultisample ::gl::g_current_gl_context->glRenderbufferStorageMultisampleFn
#define glRenderbufferStorageMultisampleAdvancedAMD ::gl::g_current_gl_context->glRenderbufferStorageMultisampleAdvancedAMDFn
#define glRenderbufferStorageMultisampleEXT ::gl::g_current_gl_context->glRenderbufferStorageMultisampleEXTFn
#define glRequestExtensionANGLE ::gl::g_current_gl_context->glRequestExtensionANGLEFn
#define glResumeTransformFeedback ::gl::g_current_gl_context->glResumeTransformFeedbackFn
...
#define glSamplerParameterfvRobustANGLE ::gl::g_current_gl_context->glSamplerParameterfvRobustANGLEFn
#define glSamplerParameteri ::gl::g_current_gl_context->glSamplerParameteriFn
#define glSamplerParameterIivRobustANGLE ::gl::g_current_gl_context->glSamplerParameterIivRobustANGLEFn
#define glSamplerParameterIuivRobustANGLE ::gl::g_current_gl_context->glSamplerParameterIuivRobustANGLEFn
#define glSamplerParameteriv ::gl::g_current_gl_context->glSamplerParameterivFn
#define glSamplerParameterivRobustANGLE ::gl::g_current_gl_context->glSamplerParameterivRobustANGLEFn
...
#define glStencilFuncSeparate ::gl::g_current_gl_context->glStencilFuncSeparateFn
#define glStencilMask ::gl::g_current_gl_context->glStencilMaskFn
#define glStencilMaskSeparate ::gl::g_current_gl_context->glStencilMaskSeparateFn
...
#define glTexImage2DExternalANGLE ::gl::g_current_gl_context->glTexImage2DExternalANGLEFn
#define glTexImage2DRobustANGLE ::gl::g_current_gl_context->glTexImage2DRobustANGLEFn
#define glTexImage3D ::gl::g_current_gl_context->glTexImage3DFn
#define glTexImage3DRobustANGLE ::gl::g_current_gl_context->glTexImage3DRobustANGLEFn
...
#define glTexParameterfvRobustANGLE ::gl::g_current_gl_context->glTexParameterfvRobustANGLEFn
#define glTexParameteri ::gl::g_current_gl_context->glTexParameteriFn
#define glTexParameterIivRobustANGLE ::gl::g_current_gl_context->glTexParameterIivRobustANGLEFn
#define glTexParameterIuivRobustANGLE ::gl::g_current_gl_context->glTexParameterIuivRobustANGLEFn
#define glTexParameteriv ::gl::g_current_gl_context->glTexParameterivFn
#define glTexParameterivRobustANGLE ::gl::g_current_gl_context->glTexParameterivRobustANGLEFn
#define glTexStorage2DEXT ::gl::g_current_gl_context->glTexStorage2DEXTFn
#define glTexStorage2DMultisample ::gl::g_current_gl_context->glTexStorage2DMultisampleFn
...
#define glTexStorageMemFlags2DANGLE ::gl::g_current_gl_context->glTexStorageMemFlags2DANGLEFn
#define glTexSubImage2D ::gl::g_current_gl_context->glTexSubImage2DFn
#define glTexSubImage2DRobustANGLE ::gl::g_current_gl_context->glTexSubImage2DRobustANGLEFn
#define glTexSubImage3D ::gl::g_current_gl_context->glTexSubImage3DFn
#define glTexSubImage3DRobustANGLE ::gl::g_current_gl_context->glTexSubImage3DRobustANGLEFn
#define glTransformFeedbackVaryings ::gl::g_current_gl_context->glTransformFeedbackVaryingsFn
...
#define glUniformBlockBinding ::gl::g_current_gl_context->glUniformBlockBindingFn
...
#define glValidateProgramPipeline ::gl::g_current_gl_context->glValidateProgramPipelineFn
...
#define glVertexAttribBinding ::gl::g_current_gl_context->glVertexAttribBindingFn
#define glVertexAttribDivisorANGLE ::gl::g_current_gl_context->glVertexAttribDivisorANGLEFn
...
#define glVertexAttribIFormat ::gl::g_current_gl_context->glVertexAttribIFormatFn
#define glVertexAttribIPointer ::gl::g_current_gl_context->glVertexAttribIPointerFn
#define glVertexAttribPointer ::gl::g_current_gl_context->glVertexAttribPointerFn
#define glVertexBindingDivisor ::gl::g_current_gl_context->glVertexBindingDivisorFn
...
#define glWindowRectanglesEXT ::gl::g_current_gl_context->glWindowRectanglesEXTFn
