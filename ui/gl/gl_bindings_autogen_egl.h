...
typedef void(GL_BINDING_CALL* eglAcquireExternalContextANGLEProc)(EGLDisplay dpy, EGLSurface readAndDraw);
...
typedef EGLint(GL_BINDING_CALL* eglClientWaitSyncProc)(EGLDisplay dpy, EGLSync sync, EGLint flags, EGLTime timeout);
...
typedef void*(GL_BINDING_CALL* eglCopyMetalSharedEventANGLEProc)(EGLDisplay dpy, EGLSync sync);
...
typedef EGLImage(GL_BINDING_CALL* eglCreateImageProc)(EGLDisplay dpy, EGLContext ctx, EGLenum target, EGLClientBuffer buffer, const EGLAttrib* attrib_list);
...
typedef EGLSurface(GL_BINDING_CALL* eglCreatePlatformPixmapSurfaceProc)(EGLDisplay dpy, EGLConfig config, void* native_pixmap, const EGLAttrib* attrib_list);
typedef EGLSurface(GL_BINDING_CALL* eglCreatePlatformWindowSurfaceProc)(EGLDisplay dpy, EGLConfig config, void* native_window, const EGLAttrib* attrib_list);
typedef EGLStreamKHR(GL_BINDING_CALL* eglCreateStreamKHRProc)(EGLDisplay dpy, const EGLint* attrib_list);
typedef EGLBoolean(GL_BINDING_CALL* eglCreateStreamProducerD3DTextureANGLEProc)(EGLDisplay dpy, EGLStreamKHR stream, EGLAttrib* attrib_list);
typedef EGLSync(GL_BINDING_CALL* eglCreateSyncProc)(EGLDisplay dpy, EGLenum type, const EGLAttrib* attrib_list);
...
typedef EGLint(GL_BINDING_CALL* eglDebugMessageControlKHRProc)(EGLDEBUGPROCKHR callback, const EGLAttrib* attrib_list);
typedef EGLBoolean(GL_BINDING_CALL* eglDestroyContextProc)(EGLDisplay dpy, EGLContext ctx);
typedef EGLBoolean(GL_BINDING_CALL* eglDestroyImageProc)(EGLDisplay dpy, EGLImage image);
typedef EGLBoolean(GL_BINDING_CALL* eglDestroyImageKHRProc)(EGLDisplay dpy, EGLImageKHR image);
typedef EGLBoolean(GL_BINDING_CALL* eglDestroyStreamKHRProc)(EGLDisplay dpy, EGLStreamKHR stream);
typedef EGLBoolean(GL_BINDING_CALL* eglDestroySurfaceProc)(EGLDisplay dpy, EGLSurface surface);
typedef EGLBoolean(GL_BINDING_CALL* eglDestroySyncProc)(EGLDisplay dpy, EGLSync sync);
typedef EGLBoolean(GL_BINDING_CALL* eglDestroySyncKHRProc)(EGLDisplay dpy, EGLSyncKHR sync);
typedef EGLint(GL_BINDING_CALL* eglDupNativeFenceFDANDROIDProc)(EGLDisplay dpy, EGLSyncKHR sync);
typedef EGLBoolean(GL_BINDING_CALL* eglExportDMABUFImageMESAProc)(EGLDisplay dpy, EGLImageKHR image, int* fds, EGLint* strides, EGLint* offsets);
...
typedef EGLBoolean(GL_BINDING_CALL* eglExportVkImageANGLEProc)(EGLDisplay dpy, EGLImageKHR image, void* vk_image, void* vk_image_create_info);
...
typedef EGLBoolean(GL_BINDING_CALL* eglGetCompositorTimingSupportedANDROIDProc)(EGLDisplay dpy, EGLSurface surface, EGLint timestamp);
...
typedef EGLBoolean(GL_BINDING_CALL* eglGetFrameTimestampSupportedANDROIDProc)(EGLDisplay dpy, EGLSurface surface, EGLint timestamp);
typedef EGLBoolean(GL_BINDING_CALL* eglGetMscRateANGLEProc)(EGLDisplay dpy, EGLSurface surface, EGLint* numerator, EGLint* denominator);
typedef EGLClientBuffer(GL_BINDING_CALL* eglGetNativeClientBufferANDROIDProc)(const struct AHardwareBuffer* ahardwarebuffer);
typedef EGLBoolean(GL_BINDING_CALL* eglGetNextFrameIdANDROIDProc)(EGLDisplay dpy, EGLSurface surface, EGLuint64KHR* frameId);
typedef EGLDisplay(GL_BINDING_CALL* eglGetPlatformDisplayProc)(EGLenum platform, void* native_display, const EGLAttrib* attrib_list);
typedef __eglMustCastToProperFunctionPointerType(GL_BINDING_CALL* eglGetProcAddressProc)(const char* procname);
typedef EGLBoolean(GL_BINDING_CALL* eglGetSyncAttribProc)(EGLDisplay dpy, EGLSync sync, EGLint attribute, EGLAttrib* value);
typedef EGLBoolean(GL_BINDING_CALL* eglGetSyncAttribKHRProc)(EGLDisplay dpy, EGLSyncKHR sync, EGLint attribute, EGLint* value);
...
typedef EGLBoolean(GL_BINDING_CALL* eglImageFlushExternalEXTProc)(EGLDisplay dpy, EGLImageKHR image, const EGLAttrib* attrib_list);
typedef EGLBoolean(GL_BINDING_CALL* eglInitializeProc)(EGLDisplay dpy, EGLint* major, EGLint* minor);
typedef EGLint(GL_BINDING_CALL* eglLabelObjectKHRProc)(EGLDisplay display, EGLenum objectType, EGLObjectKHR object, EGLLabelKHR label);
...
typedef EGLBoolean(GL_BINDING_CALL* eglQueryDebugKHRProc)(EGLint attribute, EGLAttrib* value);
typedef EGLBoolean(GL_BINDING_CALL* eglQueryDeviceAttribEXTProc)(EGLDeviceEXT device, EGLint attribute, EGLAttrib* value);
typedef EGLBoolean(GL_BINDING_CALL* eglQueryDevicesEXTProc)(EGLint max_devices, EGLDeviceEXT* devices, EGLint* num_devices);
typedef const char*(GL_BINDING_CALL* eglQueryDeviceStringEXTProc)(EGLDeviceEXT device, EGLint name);
typedef EGLBoolean(GL_BINDING_CALL* eglQueryDisplayAttribANGLEProc)(EGLDisplay dpy, EGLint attribute, EGLAttrib* value);
typedef EGLBoolean(GL_BINDING_CALL* eglQueryDisplayAttribEXTProc)(EGLDisplay dpy, EGLint attribute, EGLAttrib* value);
typedef EGLBoolean(GL_BINDING_CALL* eglQueryDmaBufFormatsEXTProc)(EGLDisplay dpy, EGLint max_formats, EGLint* formats, EGLint* num_formats);
...
typedef EGLBoolean(GL_BINDING_CALL* eglQueryStreamKHRProc)(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLint* value);
typedef EGLBoolean(GL_BINDING_CALL* eglQueryStreamu64KHRProc)(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLuint64KHR* value);
typedef const char*(GL_BINDING_CALL* eglQueryStringProc)(EGLDisplay dpy, EGLint name);
typedef const char*(GL_BINDING_CALL* eglQueryStringiANGLEProc)(EGLDisplay dpy, EGLint name, EGLint index);
...
typedef void(GL_BINDING_CALL* eglReacquireHighPowerGPUANGLEProc)(EGLDisplay dpy, EGLContext ctx);
typedef void(GL_BINDING_CALL* eglReleaseExternalContextANGLEProc)(EGLDisplay dpy);
typedef void(GL_BINDING_CALL* eglReleaseHighPowerGPUANGLEProc)(EGLDisplay dpy, EGLContext ctx);
...
typedef void(GL_BINDING_CALL* eglSetBlobCacheFuncsANDROIDProc)(EGLDisplay dpy, EGLSetBlobFuncANDROID set, EGLGetBlobFuncANDROID get);
typedef void(GL_BINDING_CALL* eglSetValidationEnabledANGLEProc)(EGLBoolean validationState);
typedef EGLBoolean(GL_BINDING_CALL* eglStreamAttribKHRProc)(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLint value);
typedef EGLBoolean(GL_BINDING_CALL* eglStreamConsumerAcquireKHRProc)(EGLDisplay dpy, EGLStreamKHR stream);
typedef EGLBoolean(GL_BINDING_CALL* eglStreamConsumerGLTextureExternalAttribsNVProc)(EGLDisplay dpy, EGLStreamKHR stream, EGLAttrib* attrib_list);
typedef EGLBoolean(GL_BINDING_CALL* eglStreamConsumerGLTextureExternalKHRProc)(EGLDisplay dpy, EGLStreamKHR stream);
typedef EGLBoolean(GL_BINDING_CALL* eglStreamConsumerReleaseKHRProc)(EGLDisplay dpy, EGLStreamKHR stream);
typedef EGLBoolean(GL_BINDING_CALL* eglStreamPostD3DTextureANGLEProc)(EGLDisplay dpy, EGLStreamKHR stream, void* texture, const EGLAttrib* attrib_list);
...
typedef EGLBoolean(GL_BINDING_CALL* eglSwapBuffersWithDamageKHRProc)(EGLDisplay dpy, EGLSurface surface, EGLint* rects, EGLint n_rects);
...
typedef EGLint(GL_BINDING_CALL* eglWaitSyncProc)(EGLDisplay dpy, EGLSync sync, EGLint flags);
typedef EGLint(GL_BINDING_CALL* eglWaitSyncKHRProc)(EGLDisplay dpy, EGLSyncKHR sync, EGLint flags);
typedef void(GL_BINDING_CALL* eglWaitUntilWorkScheduledANGLEProc)(EGLDisplay dpy);
...
struct ProcsEGL {
    ...
    eglCreateStreamProducerD3DTextureANGLEProc eglCreateStreamProducerD3DTextureANGLEFn;
    ...
    eglGetCompositorTimingSupportedANDROIDProc eglGetCompositorTimingSupportedANDROIDFn;
    ...
    eglGetFrameTimestampSupportedANDROIDProc eglGetFrameTimestampSupportedANDROIDFn;
    ...
    eglStreamConsumerGLTextureExternalAttribsNVProc eglStreamConsumerGLTextureExternalAttribsNVFn;
    eglStreamConsumerGLTextureExternalKHRProc eglStreamConsumerGLTextureExternalKHRFn;
...
public:
    ...
    virtual void eglAcquireExternalContextANGLEFn(EGLDisplay dpy, EGLSurface readAndDraw) = 0;
    ...
    virtual EGLint eglClientWaitSyncFn(EGLDisplay dpy, EGLSync sync, EGLint flags, EGLTime timeout) = 0;
    ...
    virtual void* eglCopyMetalSharedEventANGLEFn(EGLDisplay dpy, EGLSync sync) = 0;
    ...
    virtual EGLImage eglCreateImageFn(EGLDisplay dpy, EGLContext ctx, EGLenum target, EGLClientBuffer buffer, const EGLAttrib* attrib_list) = 0;
    ...
    virtual EGLSurface eglCreatePlatformPixmapSurfaceFn(EGLDisplay dpy, EGLConfig config, void* native_pixmap, const EGLAttrib* attrib_list) = 0;
    virtual EGLSurface eglCreatePlatformWindowSurfaceFn(EGLDisplay dpy, EGLConfig config, void* native_window, const EGLAttrib* attrib_list) = 0;
    virtual EGLStreamKHR eglCreateStreamKHRFn(EGLDisplay dpy, const EGLint* attrib_list) = 0;
    virtual EGLBoolean eglCreateStreamProducerD3DTextureANGLEFn(EGLDisplay dpy, EGLStreamKHR stream, EGLAttrib* attrib_list) = 0;
    virtual EGLSync eglCreateSyncFn(EGLDisplay dpy, EGLenum type, const EGLAttrib* attrib_list) = 0;
    ...
    virtual EGLint eglDebugMessageControlKHRFn(EGLDEBUGPROCKHR callback, const EGLAttrib* attrib_list) = 0;
    ...
    virtual EGLBoolean eglDestroyStreamKHRFn(EGLDisplay dpy, EGLStreamKHR stream) = 0;
    ...
    virtual EGLint eglDupNativeFenceFDANDROIDFn(EGLDisplay dpy, EGLSyncKHR sync) = 0;
    virtual EGLBoolean eglExportDMABUFImageMESAFn(EGLDisplay dpy, EGLImageKHR image, int* fds, EGLint* strides, EGLint* offsets) = 0;
    virtual EGLBoolean eglExportDMABUFImageQueryMESAFn(EGLDisplay dpy, EGLImageKHR image, int* fourcc, int* num_planes, EGLuint64KHR* modifiers) = 0;
    virtual EGLBoolean eglExportVkImageANGLEFn(EGLDisplay dpy, EGLImageKHR image, void* vk_image, void* vk_image_create_info) = 0;
    virtual EGLBoolean eglGetCompositorTimingANDROIDFn(EGLDisplay dpy, EGLSurface surface, EGLint numTimestamps, EGLint* names, EGLnsecsANDROID* values) = 0;
    virtual EGLBoolean eglGetCompositorTimingSupportedANDROIDFn(EGLDisplay dpy, EGLSurface surface, EGLint timestamp) = 0;
    ...
    virtual EGLBoolean eglGetFrameTimestampsANDROIDFn(
        EGLDisplay dpy, EGLSurface surface, EGLuint64KHR frameId, EGLint numTimestamps, EGLint* timestamps, EGLnsecsANDROID* values)
        = 0;
    virtual EGLBoolean eglGetFrameTimestampSupportedANDROIDFn(EGLDisplay dpy, EGLSurface surface, EGLint timestamp) = 0;
    virtual EGLBoolean eglGetMscRateANGLEFn(EGLDisplay dpy, EGLSurface surface, EGLint* numerator, EGLint* denominator) = 0;
    virtual EGLClientBuffer eglGetNativeClientBufferANDROIDFn(const struct AHardwareBuffer* ahardwarebuffer) = 0;
    virtual EGLBoolean eglGetNextFrameIdANDROIDFn(EGLDisplay dpy, EGLSurface surface, EGLuint64KHR* frameId) = 0;
    virtual EGLDisplay eglGetPlatformDisplayFn(EGLenum platform, void* native_display, const EGLAttrib* attrib_list) = 0;
    virtual __eglMustCastToProperFunctionPointerType eglGetProcAddressFn(const char* procname) = 0;
    virtual EGLBoolean eglGetSyncAttribFn(EGLDisplay dpy, EGLSync sync, EGLint attribute, EGLAttrib* value) = 0;
    virtual EGLBoolean eglGetSyncAttribKHRFn(EGLDisplay dpy, EGLSyncKHR sync, EGLint attribute, EGLint* value) = 0;
    virtual EGLBoolean eglGetSyncValuesCHROMIUMFn(EGLDisplay dpy, EGLSurface surface, EGLuint64CHROMIUM* ust, EGLuint64CHROMIUM* msc, EGLuint64CHROMIUM* sbc)
        = 0;
    virtual void eglHandleGPUSwitchANGLEFn(EGLDisplay dpy) = 0;
    virtual EGLBoolean eglImageFlushExternalEXTFn(EGLDisplay dpy, EGLImageKHR image, const EGLAttrib* attrib_list) = 0;
    virtual EGLBoolean eglInitializeFn(EGLDisplay dpy, EGLint* major, EGLint* minor) = 0;
    virtual EGLint eglLabelObjectKHRFn(EGLDisplay display, EGLenum objectType, EGLObjectKHR object, EGLLabelKHR label) = 0;
    ...
    virtual EGLBoolean eglQueryDeviceAttribEXTFn(EGLDeviceEXT device, EGLint attribute, EGLAttrib* value) = 0;
    virtual EGLBoolean eglQueryDevicesEXTFn(EGLint max_devices, EGLDeviceEXT* devices, EGLint* num_devices) = 0;
    virtual const char* eglQueryDeviceStringEXTFn(EGLDeviceEXT device, EGLint name) = 0;
    virtual EGLBoolean eglQueryDisplayAttribANGLEFn(EGLDisplay dpy, EGLint attribute, EGLAttrib* value) = 0;
    virtual EGLBoolean eglQueryDisplayAttribEXTFn(EGLDisplay dpy, EGLint attribute, EGLAttrib* value) = 0;
    virtual EGLBoolean eglQueryDmaBufFormatsEXTFn(EGLDisplay dpy, EGLint max_formats, EGLint* formats, EGLint* num_formats) = 0;
    virtual EGLBoolean eglQueryDmaBufModifiersEXTFn(
        EGLDisplay dpy, EGLint format, EGLint max_modifiers, EGLuint64KHR* modifiers, EGLBoolean* external_only, EGLint* num_modifiers)
        = 0;
    virtual EGLBoolean eglQueryStreamKHRFn(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLint* value) = 0;
    virtual EGLBoolean eglQueryStreamu64KHRFn(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLuint64KHR* value) = 0;
    virtual const char* eglQueryStringFn(EGLDisplay dpy, EGLint name) = 0;
    virtual const char* eglQueryStringiANGLEFn(EGLDisplay dpy, EGLint name, EGLint index) = 0;
    ...
    virtual void eglReacquireHighPowerGPUANGLEFn(EGLDisplay dpy, EGLContext ctx) = 0;
    virtual void eglReleaseExternalContextANGLEFn(EGLDisplay dpy) = 0;
    virtual void eglReleaseHighPowerGPUANGLEFn(EGLDisplay dpy, EGLContext ctx) = 0;
    ...
    virtual void eglSetBlobCacheFuncsANDROIDFn(EGLDisplay dpy, EGLSetBlobFuncANDROID set, EGLGetBlobFuncANDROID get) = 0;
    virtual void eglSetValidationEnabledANGLEFn(EGLBoolean validationState) = 0;
    virtual EGLBoolean eglStreamAttribKHRFn(EGLDisplay dpy, EGLStreamKHR stream, EGLenum attribute, EGLint value) = 0;
    virtual EGLBoolean eglStreamConsumerAcquireKHRFn(EGLDisplay dpy, EGLStreamKHR stream) = 0;
    virtual EGLBoolean eglStreamConsumerGLTextureExternalAttribsNVFn(EGLDisplay dpy, EGLStreamKHR stream, EGLAttrib* attrib_list) = 0;
    virtual EGLBoolean eglStreamConsumerGLTextureExternalKHRFn(EGLDisplay dpy, EGLStreamKHR stream) = 0;
    virtual EGLBoolean eglStreamConsumerReleaseKHRFn(EGLDisplay dpy, EGLStreamKHR stream) = 0;
    virtual EGLBoolean eglStreamPostD3DTextureANGLEFn(EGLDisplay dpy, EGLStreamKHR stream, void* texture, const EGLAttrib* attrib_list) = 0;
    ...
    virtual EGLBoolean eglSwapBuffersWithDamageKHRFn(EGLDisplay dpy, EGLSurface surface, EGLint* rects, EGLint n_rects) = 0;
    ...
    virtual EGLint eglWaitSyncKHRFn(EGLDisplay dpy, EGLSyncKHR sync, EGLint flags) = 0;
    virtual void eglWaitUntilWorkScheduledANGLEFn(EGLDisplay dpy) = 0;
};

} // namespace gl

#define eglAcquireExternalContextANGLE ::gl::g_current_egl_context->eglAcquireExternalContextANGLEFn
...
#define eglCopyMetalSharedEventANGLE ::gl::g_current_egl_context->eglCopyMetalSharedEventANGLEFn
...
#define eglCreatePbufferFromClientBuffer ::gl::g_current_egl_context->eglCreatePbufferFromClientBufferFn
#define eglCreatePbufferSurface ::gl::g_current_egl_context->eglCreatePbufferSurfaceFn
#define eglCreatePixmapSurface ::gl::g_current_egl_context->eglCreatePixmapSurfaceFn
#define eglCreatePlatformPixmapSurface ::gl::g_current_egl_context->eglCreatePlatformPixmapSurfaceFn
#define eglCreatePlatformWindowSurface ::gl::g_current_egl_context->eglCreatePlatformWindowSurfaceFn
#define eglCreateStreamKHR ::gl::g_current_egl_context->eglCreateStreamKHRFn
#define eglCreateStreamProducerD3DTextureANGLE ::gl::g_current_egl_context->eglCreateStreamProducerD3DTextureANGLEFn
...
#define eglCreateWindowSurface ::gl::g_current_egl_context->eglCreateWindowSurfaceFn
#define eglDebugMessageControlKHR ::gl::g_current_egl_context->eglDebugMessageControlKHRFn
...
#define eglDupNativeFenceFDANDROID ::gl::g_current_egl_context->eglDupNativeFenceFDANDROIDFn
#define eglExportDMABUFImageMESA ::gl::g_current_egl_context->eglExportDMABUFImageMESAFn
#define eglExportDMABUFImageQueryMESA ::gl::g_current_egl_context->eglExportDMABUFImageQueryMESAFn
#define eglExportVkImageANGLE ::gl::g_current_egl_context->eglExportVkImageANGLEFn
#define eglGetCompositorTimingANDROID ::gl::g_current_egl_context->eglGetCompositorTimingANDROIDFn
#define eglGetCompositorTimingSupportedANDROID ::gl::g_current_egl_context->eglGetCompositorTimingSupportedANDROIDFn
...
#define eglGetFrameTimestampsANDROID ::gl::g_current_egl_context->eglGetFrameTimestampsANDROIDFn
#define eglGetFrameTimestampSupportedANDROID ::gl::g_current_egl_context->eglGetFrameTimestampSupportedANDROIDFn
#define eglGetMscRateANGLE ::gl::g_current_egl_context->eglGetMscRateANGLEFn
#define eglGetNativeClientBufferANDROID ::gl::g_current_egl_context->eglGetNativeClientBufferANDROIDFn
#define eglGetNextFrameIdANDROID ::gl::g_current_egl_context->eglGetNextFrameIdANDROIDFn
...
#define eglGetSyncValuesCHROMIUM ::gl::g_current_egl_context->eglGetSyncValuesCHROMIUMFn
#define eglHandleGPUSwitchANGLE ::gl::g_current_egl_context->eglHandleGPUSwitchANGLEFn
#define eglImageFlushExternalEXT ::gl::g_current_egl_context->eglImageFlushExternalEXTFn
...
#define eglQueryDeviceAttribEXT ::gl::g_current_egl_context->eglQueryDeviceAttribEXTFn
#define eglQueryDevicesEXT ::gl::g_current_egl_context->eglQueryDevicesEXTFn
#define eglQueryDeviceStringEXT ::gl::g_current_egl_context->eglQueryDeviceStringEXTFn
#define eglQueryDisplayAttribANGLE ::gl::g_current_egl_context->eglQueryDisplayAttribANGLEFn
#define eglQueryDisplayAttribEXT ::gl::g_current_egl_context->eglQueryDisplayAttribEXTFn
#define eglQueryDmaBufFormatsEXT ::gl::g_current_egl_context->eglQueryDmaBufFormatsEXTFn
#define eglQueryDmaBufModifiersEXT ::gl::g_current_egl_context->eglQueryDmaBufModifiersEXTFn
...
#define eglQuerySurfacePointerANGLE ::gl::g_current_egl_context->eglQuerySurfacePointerANGLEFn
#define eglReacquireHighPowerGPUANGLE ::gl::g_current_egl_context->eglReacquireHighPowerGPUANGLEFn
#define eglReleaseExternalContextANGLE ::gl::g_current_egl_context->eglReleaseExternalContextANGLEFn
#define eglReleaseHighPowerGPUANGLE ::gl::g_current_egl_context->eglReleaseHighPowerGPUANGLEFn
...
#define eglSetBlobCacheFuncsANDROID ::gl::g_current_egl_context->eglSetBlobCacheFuncsANDROIDFn
#define eglSetValidationEnabledANGLE ::gl::g_current_egl_context->eglSetValidationEnabledANGLEFn
#define eglStreamAttribKHR ::gl::g_current_egl_context->eglStreamAttribKHRFn
#define eglStreamConsumerAcquireKHR ::gl::g_current_egl_context->eglStreamConsumerAcquireKHRFn
#define eglStreamConsumerGLTextureExternalAttribsNV ::gl::g_current_egl_context->eglStreamConsumerGLTextureExternalAttribsNVFn
#define eglStreamConsumerGLTextureExternalKHR ::gl::g_current_egl_context->eglStreamConsumerGLTextureExternalKHRFn
#define eglStreamConsumerReleaseKHR ::gl::g_current_egl_context->eglStreamConsumerReleaseKHRFn
#define eglStreamPostD3DTextureANGLE ::gl::g_current_egl_context->eglStreamPostD3DTextureANGLEFn
...
#define eglSwapBuffersWithDamageKHR ::gl::g_current_egl_context->eglSwapBuffersWithDamageKHRFn
...
#define eglWaitUntilWorkScheduledANGLE ::gl::g_current_egl_context->eglWaitUntilWorkScheduledANGLEFn
