...
private:
    ...
    explicit GPUTimer(scoped_refptr<GPUTimingClient> gpu_timing_client, bool use_elapsed_timer);
...
class GL_EXPORT GPUTimingClient : public base::RefCounted<GPUTimingClient> {
public:
