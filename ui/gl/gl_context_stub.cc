...
bool GLContextStub::InitializeImpl(GLSurface* compatible_surface, const GLContextAttribs& attribs)
{
    return true;
}
...
{
    return HasExtension("GL_ARB_robustness") || HasExtension("GL_KHR_robustness") || HasExtension("GL_EXT_robustness");
}
