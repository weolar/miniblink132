...
void GpuSwitchingManager::NotifyGpuSwitched(gl::GpuPreference active_gpu_heuristic)
{
    observer_list_.Notify(&GpuSwitchingObserver::OnGpuSwitched, active_gpu_heuristic);
}
