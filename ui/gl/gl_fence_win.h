...
public:
    ...
    static std::unique_ptr<GLFenceWin> CreateFromGpuFence(const gfx::GpuFence& gpu_fence);
    static std::unique_ptr<GLFenceWin> CreateFromGpuFence(ID3D11Device*, const gfx::GpuFence& gpu_fence);
    static bool IsSupported();

    GLFenceWin(Microsoft::WRL::ComPtr<ID3D11Fence> d3d11_fence, gfx::GpuFenceHandle gpu_fence_handle);
    ~GLFenceWin() override;
