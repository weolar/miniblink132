...
// the root surface.
class GL_EXPORT DCompPresenter : public Presenter, public VSyncThreadWin::VSyncObserver {
public:
    struct Settings {
    ...
    void SetDelegatedInkTrailStartPoint(std::unique_ptr<gfx::DelegatedInkMetadata> metadata) override;
    ...
    DCLayerTree* GetLayerTreeForTesting()
    {
...
private:
    ...
    void HandleVSyncOnMainThread(base::TimeTicks vsync_time, base::TimeDelta interval);
