...
public:
    ...
    // longer current.
    virtual gfx::SwapResult SwapBuffers(PresentationCallback callback, gfx::FrameData data) = 0;
    ...
    virtual void SwapBuffersAsync(SwapCompletionCallback completion_callback, PresentationCallback presentation_callback, gfx::FrameData data);
    ...
    virtual gfx::SwapResult PostSubBuffer(int x, int y, int width, int height, PresentationCallback callback, gfx::FrameData data);
    ...
    virtual void PostSubBufferAsync(
        int x, int y, int width, int height, SwapCompletionCallback completion_callback, PresentationCallback presentation_callback, gfx::FrameData data);
...
GL_EXPORT scoped_refptr<GLSurface> InitializeGLSurface(scoped_refptr<GLSurface> surface);
