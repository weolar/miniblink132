...
void DisplayExtensionsEGL::UpdateConditionalExtensionSettings(EGLDisplay display)
{
    ...
    b_EGL_KHR_fence_sync = extensions.find("EGL_KHR_fence_sync ") != std::string::npos;
    b_EGL_KHR_wait_sync = extensions.find("EGL_KHR_wait_sync ") != std::string::npos;
}
