...
GLSurfaceOverlay::GLSurfaceOverlay(
    scoped_refptr<gfx::NativePixmap> pixmap, std::unique_ptr<gfx::GpuFence> gpu_fence, const gfx::OverlayPlaneData& overlay_plane_data)
...
bool GLSurfaceOverlay::ScheduleOverlayPlane(gfx::AcceleratedWidget widget)
{
    ...
    DCHECK(pixmap_);
    return pixmap_->ScheduleOverlayPlane(widget, overlay_plane_data_, std::move(acquire_fences), {});
}
