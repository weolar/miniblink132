...
public:
    GLSurfaceOverlay(scoped_refptr<gfx::NativePixmap> pixmap, std::unique_ptr<gfx::GpuFence> gpu_fence, const gfx::OverlayPlaneData& overlay_plane_data);
    ...
    gfx::GpuFence* gpu_fence() const
    {
        return gpu_fence_.get();
    }
    int z_order() const
    {
        return overlay_plane_data_.z_order;
    }
