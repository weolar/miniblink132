...
TEST(GLVersionInfoTest, ParseGLVersionStringTest)
{
    ...
    static constexpr std::array<GLVersionTestData, 8> kTestData = { { { "OpenGL ES 3.0", 3, 0, false, true, "", "" },
        { "OpenGL ES 3.2 v1.r12p0-04rel0.44f2946824bb8739781564bffe2110c9", 3, 2, false, true, "ARM", "12.0.04rel0" },
        { "OpenGL ES 3.0 V@84.0 AU@05.00.00.046.002 (CL@)", 3, 0, false, true, "", "84.0" },
        { "OpenGL ES 2.0 build 1.12@2701748", 2, 0, true, false, "", "1.12" }, { "OpenGL ES 3.1 V6.2.4.138003", 3, 1, false, true, "", "6.2.4.138003" },
        { "OpenGL ES 3.0 Mesa 12.0.3 (git-8b8f097)", 3, 0, false, true, "Mesa", "12.0.3" },
    ...
    for (const auto& test_case : kTestData) {
        GLVersionInfo version_info(test_case.gl_version.data(), nullptr, extensions);
        ...
        EXPECT_STREQ(test_case.expected_driver_vendor.data(), version_info.driver_vendor.c_str());
        EXPECT_STREQ(test_case.expected_driver_version.data(), version_info.driver_version.c_str());
    }
}
...
TEST(GLVersionInfoTest, DriverVendorForANGLE)
{
    ...
    static constexpr std::array<GLVersionTestData, 12> kTestData = { { { "OpenGL ES 2.0.0 (ANGLE 2.1.4875 git hash: 32e78475b1c0)",
        ...
        { "OpenGL ES 2.0.0 (ANGLE 2.1.4875 git hash: 32e78475b1c0)", "ANGLE (Apple, Apple A12Z, OpenGL 4.1 Metal - 70.12.7)", 2, 0, true, false, false, "Apple",
            "70.12.7" },
        { "OpenGL ES 2.0.0 (ANGLE 2.1.4875 git hash: 32e78475b1c0)",
    ...
    gfx::ExtensionSet extensions;
    for (const auto& test_case : kTestData) {
        GLVersionInfo version_info(test_case.gl_version.data(), test_case.gl_renderer.data(), extensions);
