...
public:
    ...
    base::UnguessableToken RegisterDCOMPSurfaceHandle(base::win::ScopedHandle surface);
    ...
    // render process.
    base::win::ScopedHandle TakeDCOMPSurfaceHandle(const base::UnguessableToken& token);
...
private:
    ...
    base::flat_map<base::UnguessableToken, base::win::ScopedHandle> surface_handle_map_;
};
