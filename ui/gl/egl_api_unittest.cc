...
public:
    ...
    void InitializeAPI(const char* disabled_extensions)
    {
        ...
        display_ = GLDisplayManagerEGL::GetInstance()->GetDisplay(GpuPreference::kDefault);
    ...
    void SetFakeExtensionString(const char* fake_string, const char* fake_client_string)
    {
        fake_extension_string_ = fake_string;
        fake_client_extension_string_ = fake_client_string;
    }

    static EGLBoolean GL_BINDING_CALL FakeInitialize(EGLDisplay display, EGLint* major, EGLint* minor)
    {
        return EGL_TRUE;
    }
    ...
    static const char* GL_BINDING_CALL FakeQueryString(EGLDisplay dpy, EGLint name)
    {
    ...
    static EGLDisplay GL_BINDING_CALL FakeGetDisplay(EGLNativeDisplayType native_display)
    {
        return reinterpret_cast<EGLDisplay>(0x1);
    }
    ...
    static __eglMustCastToProperFunctionPointerType GL_BINDING_CALL FakeGetProcAddress(const char* procname)
    {
        return nullptr;
    }
    ...
    {
        return std::make_pair(api_->eglQueryStringFn(EGL_NO_DISPLAY, EGL_EXTENSIONS), api_->eglQueryStringFn(api_->eglGetCurrentDisplayFn(), EGL_EXTENSIONS));
    }
...
{
    static const char* kFakeExtensions = "EGL_EXT_1 EGL_KHR_fence_sync EGL_EXT_3 EGL_KHR_wait_sync";
    static const char* kFakeClientExtensions = "EGL_CLIENT_EXT_1 EGL_CLIENT_EXT_2";
    static const char* kFakeDisabledExtensions = "EGL_KHR_fence_sync,EGL_KHR_wait_sync";
    static const char* kFilteredExtensions = "EGL_EXT_1 EGL_EXT_3";
    static const char* kFilteredClientExtensions = "EGL_CLIENT_EXT_1 EGL_CLIENT_EXT_2";
