...
public:
    ...
    ScopedJavaSurfaceControl(const base::android::JavaRef<jobject>& j_surface_control, bool release_on_destroy);
    ~ScopedJavaSurfaceControl();
    ...
    base::android::ScopedJavaGlobalRef<jobject> TakeJavaSurfaceControl(bool& release_on_destroy);
