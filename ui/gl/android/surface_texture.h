...
class GL_EXPORT SurfaceTexture : public base::RefCountedThreadSafe<SurfaceTexture> {
public:
...
protected:
    explicit SurfaceTexture(const base::android::ScopedJavaLocalRef<jobject>& j_surface_texture);
