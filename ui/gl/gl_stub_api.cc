...
void GLStubApi::glGetQueryObjecti64vFn(GLuint id, GLenum pname, GLint64* params)
{
    switch (pname) {
...
void GLStubApi::glGetQueryObjectui64vFn(GLuint id, GLenum pname, GLuint64* params)
{
    switch (pname) {
    case GL_QUERY_RESULT_AVAILABLE:
        *params = GL_TRUE;
