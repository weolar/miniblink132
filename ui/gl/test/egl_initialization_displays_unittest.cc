...
{
    std::unique_ptr<base::CommandLine> command_line(new base::CommandLine(base::CommandLine::NO_PROGRAM));
    ...
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // available
    command_line->AppendSwitchASCII(switches::kUseANGLE, gl::kANGLEImplementationD3D11Name);
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // not available
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(false, true, true, true, true, true, true, command_line.get(), &displays);
    EXPECT_FALSE(base::Contains(displays, gl::ANGLE_D3D11));
}
...
TEST(EGLInitializationDisplaysTest, DefaultRenderers)
{
    ...
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &default_no_flag_displays);
    ...
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &default_with_flag_displays);
...
TEST(EGLInitializationDisplaysTest, NonDefaultRenderers)
{
    ...
    // OpenGL
    command_line->AppendSwitchASCII(switches::kUseANGLE, gl::kANGLEImplementationOpenGLName);
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // OpenGLES
    command_line->AppendSwitchASCII(switches::kUseANGLE, gl::kANGLEImplementationOpenGLESName);
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // Vulkan
    command_line->AppendSwitchASCII(switches::kUseANGLE, gl::kANGLEImplementationVulkanName);
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // OpenGL EGL
    command_line->AppendSwitchASCII(switches::kUseANGLE, gl::kANGLEImplementationOpenGLEGLName);
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // OpenGLES EGL
    command_line->AppendSwitchASCII(switches::kUseANGLE, gl::kANGLEImplementationOpenGLESEGLName);
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
    ...
    // Metal
    command_line->AppendSwitchASCII(switches::kUseANGLE, gl::kANGLEImplementationMetalName);
    displays.clear();
    gl::init::GetEGLInitDisplaysForTesting(true, true, true, true, true, true, true, command_line.get(), &displays);
...
TEST(EGLInitializationDisplaysTest, NoExtensions)
{
    ...
    std::vector<gl::DisplayType> displays;
    gl::init::GetEGLInitDisplaysForTesting(false, false, false, false, false, false, false, command_line.get(), &displays);
