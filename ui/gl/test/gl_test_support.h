...
public:
    ...
    static GLDisplay* InitializeGL(std::optional<GLImplementationParts> prefered_impl);
    ...
    static void SetBufferDataToColor(int width, int height, int stride, int plane, gfx::BufferFormat format, base::span<const uint8_t, 4> color, uint8_t* data);
};
