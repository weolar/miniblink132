...
GLenum GLStubApiBase::glClientWaitSyncFn(GLsync sync, GLbitfield flags, GLuint64 timeout)
{
    return 0;
}
...
GLuint GLStubApiBase::glCreateShaderProgramvFn(GLenum type, GLsizei count, const char* const* strings)
{
    return 0;
}
...
GLuint GLStubApiBase::glGetDebugMessageLogFn(
...
GLuint GLStubApiBase::glGetProgramResourceIndexFn(GLuint program, GLenum programInterface, const GLchar* name)
{
    return 0;
}

GLint GLStubApiBase::glGetProgramResourceLocationFn(GLuint program, GLenum programInterface, const char* name)
{
    return 0;
}
...
void* GLStubApiBase::glMapBufferRangeFn(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access)
{
    return 0;
}
