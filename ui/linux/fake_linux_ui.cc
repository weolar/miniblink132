...
std::unique_ptr<ui::LinuxInputMethodContext> FakeLinuxUi::CreateInputMethodContext(ui::LinuxInputMethodContextDelegate* delegate) const
{
    return nullptr;
}
...
ui::SelectFileDialog* FakeLinuxUi::CreateSelectFileDialog(void* listener, std::unique_ptr<ui::SelectFilePolicy> policy) const
{
    return nullptr;
}
...
bool FakeLinuxUi::GetColor(int id, SkColor* color, bool use_custom_frame) const
{
    return false;
}
...
gfx::Image FakeLinuxUi::GetIconForContentType(const std::string& content_type, int size, float scale) const
{
    return gfx::Image();
}

LinuxUi::WindowFrameAction FakeLinuxUi::GetWindowFrameAction(WindowFrameActionSource source)
{
...
void FakeLinuxUi::AddWindowButtonOrderObserver(ui::WindowButtonOrderObserver* observer)
{
}

void FakeLinuxUi::RemoveWindowButtonOrderObserver(ui::WindowButtonOrderObserver* observer)
{
}
...
ui::WindowFrameProvider* FakeLinuxUi::GetWindowFrameProvider(bool solid_frame, bool tiled)
{
    return nullptr;
}
...
bool FakeLinuxUi::GetTextEditCommandsForEvent(const ui::Event& event, int text_falgs, std::vector<ui::TextEditCommandAuraLinux>* commands)
{
    return false;
}

#if BUILDFLAG(ENABLE_PRINTING)
printing::PrintDialogLinuxInterface* FakeLinuxUi::CreatePrintDialog(printing::PrintingContextLinux* context)
{
    return nullptr;
}

gfx::Size FakeLinuxUi::GetPdfPaperSize(printing::PrintingContextLinux* context)
{
    return gfx::Size();
}
#endif
