...
void LinuxUi::AddDeviceScaleFactorObserver(DeviceScaleFactorObserver* observer)
{
    device_scale_factor_observer_list_.AddObserver(observer);
}

void LinuxUi::RemoveDeviceScaleFactorObserver(DeviceScaleFactorObserver* observer)
{
...
// static
LinuxUi::CmdLineArgs LinuxUi::CopyCmdLine(const base::CommandLine& command_line)
{
