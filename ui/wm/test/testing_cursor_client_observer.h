...
public:
    ...
    TestingCursorClientObserver& operator=(const TestingCursorClientObserver&) = delete;
    ...
    bool did_visibility_change() const
    {
        return did_visibility_change_;
    }
    ui::CursorSize cursor_size() const
    {
        return cursor_size_;
    }
    bool did_cursor_size_change() const
    {
        return did_cursor_size_change_;
    }
