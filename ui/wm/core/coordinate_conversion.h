...
// coordinates.
COMPONENT_EXPORT(UI_WM)
void ConvertPointFromScreen(const aura::Window* window, gfx::Point* point_in_screen);

COMPONENT_EXPORT(UI_WM)
void ConvertPointFromScreen(const aura::Window* window, gfx::PointF* point_in_screen);
...
// coordinates.
COMPONENT_EXPORT(UI_WM)
void ConvertRectFromScreen(const aura::Window* window, gfx::Rect* rect_in_screen);

COMPONENT_EXPORT(UI_WM)
void TranslateRectFromScreen(const aura::Window* window, gfx::RectF* rect_in_screen);
