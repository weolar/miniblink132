...
class COMPONENT_EXPORT(UI_WM) CaptureController : public aura::client::CaptureClient {
public:
    CaptureController();
...
private:
    ...
    std::map<aura::Window*, raw_ptr<aura::client::CaptureDelegate, CtnExperimental>> delegates_;
...
class COMPONENT_EXPORT(UI_WM) ScopedCaptureClient : public aura::WindowObserver {
public:
