...
class COMPONENT_EXPORT(UI_WM) ShadowController : public ActivationChangeObserver {
public:
    ...
    static ui::Shadow::ElevationToColorsMap GenerateShadowColorsMap(const ui::ColorProvider* color_provider);

    ShadowController(ActivationClient* activation_client, std::unique_ptr<ShadowControllerDelegate> delegate, aura::Env* env = nullptr);
    ...
    void OnWindowActivated(ActivationChangeObserver::ActivationReason reason, aura::Window* gained_active, aura::Window* lost_active) override;
