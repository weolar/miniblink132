...
// enabled.
#if DCHECK_IS_ON()
#define EXPECT_DCHECK(statement, regex) EXPECT_DEATH_IF_SUPPORTED(statement, regex)
#else
...
class FocusNotificationObserver : public ActivationChangeObserver, public aura::client::FocusChangeObserver {
public:
    ...
    FocusNotificationObserver& operator=(const FocusNotificationObserver&) = delete;
...
private:
    ...
    void OnWindowActivated(ActivationReason reason, aura::Window* gained_active, aura::Window* lost_active) override
    {
        last_activation_reason_ = reason;
        ++activation_changed_count_;
    }
    void OnAttemptToReactivateWindow(aura::Window* request_active, aura::Window* actual_active) override
    {
        ++reactivation_count_;
    ...
    void OnWindowFocused(aura::Window* gained_focus, aura::Window* lost_focus) override
    {
...
// window.
class RecordingActivationAndFocusChangeObserver : public ActivationChangeObserver, public aura::client::FocusChangeObserver {
public:
    RecordingActivationAndFocusChangeObserver(aura::Window* root, WindowDeleter* deleter)
        : root_(root)
        , deleter_(deleter)
    ...
    RecordingActivationAndFocusChangeObserver(const RecordingActivationAndFocusChangeObserver&) = delete;
    ...
    // Overridden from ActivationChangeObserver:
    void OnWindowActivating(ActivationReason reason, aura::Window* gaining_active, aura::Window* losing_active) override
    {
...
public:
    ...
    HideOnLoseActivationChangeObserver(const HideOnLoseActivationChangeObserver&) = delete;
    HideOnLoseActivationChangeObserver& operator=(const HideOnLoseActivationChangeObserver&) = delete;
    ...
    aura::Window* window_to_hide()
    {
        return window_to_hide_;
    }
...
class DeleteOnActivationChangeObserver : public ActivationChangeObserver, public WindowDeleter {
public:
    ...
    // gaining activation.
    DeleteOnActivationChangeObserver(aura::Window* window, bool delete_on_activating, bool delete_window_losing_active)
    ...
    DeleteOnActivationChangeObserver(const DeleteOnActivationChangeObserver&) = delete;
    DeleteOnActivationChangeObserver& operator=(const DeleteOnActivationChangeObserver&) = delete;
    ...
    void OnWindowActivating(ActivationReason reason, aura::Window* gaining_active, aura::Window* losing_active) override
    {
        ...
        auto* window_to_delete = delete_window_losing_active_ ? losing_active : gaining_active;
    ...
    void OnWindowActivated(ActivationReason reason, aura::Window* gained_active, aura::Window* lost_active) override
    {
        ...
        auto* window_to_delete = delete_window_losing_active_ ? lost_active : gained_active;
        if (window_ && window_to_delete == window_) {
            delete window_to_delete;
            did_delete_ = true;
        }
...
class DeleteOnLoseFocusChangeObserver : public aura::client::FocusChangeObserver, public WindowDeleter {
public:
    ...
    DeleteOnLoseFocusChangeObserver(const DeleteOnLoseFocusChangeObserver&) = delete;
    DeleteOnLoseFocusChangeObserver& operator=(const DeleteOnLoseFocusChangeObserver&) = delete;
...
public:
    ...
    ScopedFocusNotificationObserver(const ScopedFocusNotificationObserver&) = delete;
    ScopedFocusNotificationObserver& operator=(const ScopedFocusNotificationObserver&) = delete;
...
public:
    ...
    ScopedTargetFocusNotificationObserver(const ScopedTargetFocusNotificationObserver&) = delete;
    ScopedTargetFocusNotificationObserver& operator=(const ScopedTargetFocusNotificationObserver&) = delete;
...
public:
    explicit FocusShiftingActivationObserver(aura::Window* activated_window)
        ...
        , shift_focus_to_(nullptr)
    {
    }

    FocusShiftingActivationObserver(const FocusShiftingActivationObserver&) = delete;
    FocusShiftingActivationObserver& operator=(const FocusShiftingActivationObserver&) = delete;
...
public:
    ActivateWhileActivatingObserver(aura::Window* to_observe, aura::Window* to_activate, aura::Window* to_focus)
    ...
    ActivateWhileActivatingObserver(const ActivateWhileActivatingObserver&) = delete;
    ActivateWhileActivatingObserver& operator=(const ActivateWhileActivatingObserver&) = delete;
...
private:
    ...
    {
        aura::client::GetFocusClient(to_observe_->GetRootWindow())->FocusWindow(window);
    }
...
public:
    ...
    bool CanFocusWindow(const aura::Window* window, const ui::Event* event) const override
    {
        return CanFocusOrActivate(window) ? BaseFocusRules::CanFocusWindow(window, event) : false;
    }
    aura::Window* GetActivatableWindow(aura::Window* window) const override
    {
        return BaseFocusRules::GetActivatableWindow(CanFocusOrActivate(window) ? window : focus_restriction_.get());
    }
    aura::Window* GetFocusableWindow(aura::Window* window) const override
    {
        return BaseFocusRules::GetFocusableWindow(CanFocusOrActivate(window) ? window : focus_restriction_.get());
    }
...
protected:
    ...
    void SetUp() override
    {
        ...
        aura::Window* w1 = aura::test::CreateTestWindowWithDelegate(
            aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 1, gfx::Rect(0, 0, 50, 50), root_window());
        aura::test::CreateTestWindowWithDelegate(aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 11, gfx::Rect(5, 5, 10, 10), w1);
        aura::test::CreateTestWindowWithDelegate(aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 12, gfx::Rect(15, 15, 10, 10), w1);
        aura::Window* w2 = aura::test::CreateTestWindowWithDelegate(
            aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 2, gfx::Rect(75, 75, 50, 50), root_window());
        aura::Window* w21
            = aura::test::CreateTestWindowWithDelegate(aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 21, gfx::Rect(5, 5, 10, 10), w2);
        aura::test::CreateTestWindowWithDelegate(aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 211, gfx::Rect(1, 1, 5, 5), w21);
        aura::test::CreateTestWindowWithDelegate(aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 3, gfx::Rect(125, 125, 50, 50), root_window());
    }
    ...
    TestFocusRules* test_focus_rules()
    {
        return test_focus_rules_;
    }
...
public:
    ...
    FocusControllerDirectTestBase& operator=(const FocusControllerDirectTestBase&) = delete;
...
protected:
    ...
    virtual ActivationChangeObserver::ActivationReason GetExpectedActivationReason() const = 0;
    ...
    void ActivationEvents() override
    {
        ...
        ActivateWindowById(2);
        root_observer.ExpectCounts(1, 1);
        EXPECT_EQ(GetExpectedActivationReason(), root_observer.last_activation_reason());
        observer1.ExpectCounts(1, 1);
        observer2.ExpectCounts(1, 1);
    }
    void ReactivationEvents() override
    {
        ...
        EXPECT_EQ(root_window()->GetChildById(2), root_observer.reactivation_requested_window());
    ...
    void ShiftFocusOnActivation() override
    {
        ...
        std::unique_ptr<FocusShiftingActivationObserver> observer(new FocusShiftingActivationObserver(target));
    ...
    {
        std::unique_ptr<aura::client::DefaultCaptureClient> capture_client(new aura::client::DefaultCaptureClient(root_window()));
    ...
    void DontPassDeletedWindow() override
    {
...

        {
            ...
            DeleteOnActivationChangeObserver observer1(to_delete,
                /*delete_on_activating=*/true,
                /*delete_window_losing_active=*/true);
            RecordingActivationAndFocusChangeObserver observer2(root_window(), &observer1);
...

        {
            ...
            DeleteOnActivationChangeObserver observer1(to_delete, /*delete_on_activating=*/false,
                /*delete_window_losing_active=*/true);
            RecordingActivationAndFocusChangeObserver observer2(root_window(), &observer1);
...

        {
            aura::test::CreateTestWindowWithDelegate(
                aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 4, gfx::Rect(125, 125, 50, 50), root_window());
        ...
        {
            aura::test::CreateTestWindowWithDelegate(
                aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 5, gfx::Rect(125, 125, 50, 50), root_window());
            aura::test::CreateTestWindowWithDelegate(
                aura::test::TestWindowDelegate::CreateSelfDestroyingDelegate(), 6, gfx::Rect(125, 125, 50, 50), root_window());
            ...
            DeleteOnActivationChangeObserver observer1(to_delete1, /*delete_on_activating=*/false,
            ...
            DeleteOnActivationChangeObserver observer3(to_delete2, /*delete_on_activating=*/true,
                /*delete_window_losing_active=*/false);
            RecordingActivationAndFocusChangeObserver observer4(root_window(), &observer3);
    ...
    void StackWindowAtTopOnActivation() override
    {
        ...
        std::unique_ptr<aura::Window> window1 = std::make_unique<aura::Window>(nullptr);
        ...
        std::unique_ptr<aura::Window> window2 = std::make_unique<aura::Window>(nullptr);
...
private:
    ...
    bool IsInputEvent() override
    {
        return false;
    }
    // Overridden from FocusControllerDirectTestBase:
    ActivationChangeObserver::ActivationReason GetExpectedActivationReason() const override
    {
...
public:
    ...
    FocusControllerMouseEventTest& operator=(const FocusControllerMouseEventTest&) = delete;
    ...
    void IgnoreHandledEvent()
    {
        ...
        root_window()->AddPreTargetHandler(&handler, ui::EventTarget::Priority::kSystem);
...
class FocusControllerMouseEnterEventTest : public FocusControllerMouseEventTest {
public:
...
public:
    ...
    FocusControllerGestureEventTest(const FocusControllerGestureEventTest&) = delete;
    FocusControllerGestureEventTest& operator=(const FocusControllerGestureEventTest&) = delete;
...
public:
    FocusControllerImplicitTestBase(const FocusControllerImplicitTestBase&) = delete;
    FocusControllerImplicitTestBase& operator=(const FocusControllerImplicitTestBase&) = delete;
...
protected:
    ...
    // Returns the expected ActivationReason caused by calling the
    // ActivatedWindowDirect(...) or DeactivateWindowDirect(...) methods.
    ActivationChangeObserver::ActivationReason GetExpectedActivationReason() const
    {
        return ActivationChangeObserver::ActivationReason::WINDOW_DISPOSITION_CHANGED;
    }
...
public:
    ...
    FocusControllerParentHideTest& operator=(const FocusControllerParentHideTest&) = delete;
    ...
    void TransientChildWindowActivationTest()
    {
        ...
        EXPECT_EQ(ui::mojom::ModalType::kNone, w1->GetProperty(aura::client::kModalKey));
        EXPECT_EQ(ui::mojom::ModalType::kWindow, w11->GetProperty(aura::client::kModalKey));
...
public:
    ...
    FocusControllerDestructionTest(const FocusControllerDestructionTest&) = delete;
    FocusControllerDestructionTest& operator=(const FocusControllerDestructionTest&) = delete;
...
class FocusControllerParentDestructionTest : public FocusControllerDestructionTest {
public:
    ...
    FocusControllerParentDestructionTest(const FocusControllerParentDestructionTest&) = delete;
    FocusControllerParentDestructionTest& operator=(const FocusControllerParentDestructionTest&) = delete;
};
...
public:
    ...
    FocusControllerRemovalTest& operator=(const FocusControllerRemovalTest&) = delete;
...
public:
    ...
    FocusControllerParentRemovalTest(const FocusControllerParentRemovalTest&) = delete;
    FocusControllerParentRemovalTest& operator=(const FocusControllerParentRemovalTest&) = delete;
};
...
FOCUS_CONTROLLER_TEST(FocusControllerApiTest, ChangeFocusWhenNothingFocusedAndCaptured)
...
FOCUS_CONTROLLER_TEST(FocusControllerApiTest, HideFocusedWindowDuringActivationLoss)
...
FOCUS_CONTROLLER_TEST(FocusControllerParentHideTest, TransientChildWindowActivationTest)
...
FOCUS_CONTROLLER_TEST(FocusControllerMouseEnterEventTest, MouseEnteredWithActiveParent)
