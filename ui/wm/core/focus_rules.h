...
public:
    ...
    virtual bool CanFocusWindow(const aura::Window* window, const ui::Event* event) const = 0;
    ...
    virtual aura::Window* GetNextActivatableWindow(aura::Window* ignore) const = 0;
};
