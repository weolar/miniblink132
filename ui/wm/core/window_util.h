...
void SetWindowFullscreen(aura::Window* window, bool fullscreen, int64_t target_display_id = display::kInvalidDisplayId);
...
using MapLayerFunc = base::RepeatingCallback<std::unique_ptr<ui::Layer>(ui::LayerOwner*)>;
