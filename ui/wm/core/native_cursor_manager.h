...
public:
    ...
    virtual void SetDisplay(const display::Display& display, NativeCursorManagerDelegate* delegate) = 0;
    ...
    // actually used.
    virtual void SetCursor(gfx::NativeCursor cursor, NativeCursorManagerDelegate* delegate) = 0;
    ...
    // the visibility is.
    virtual void SetVisibility(bool visible, NativeCursorManagerDelegate* delegate) = 0;

    // A request to set the cursor set.
    virtual void SetCursorSize(ui::CursorSize cursor_size, NativeCursorManagerDelegate* delegate) = 0;
    ...
    virtual void SetMouseEventsEnabled(bool enabled, NativeCursorManagerDelegate* delegate) = 0;
};
