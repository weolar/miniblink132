...
class COMPONENT_EXPORT(UI_WM) TransientWindowManager : public aura::WindowObserver {
public:
    ...
    const Windows& transient_children() const
    {
        return transient_children_;
    }
    ...
    const aura::Window* transient_parent() const
    {
        return transient_parent_;
    }
