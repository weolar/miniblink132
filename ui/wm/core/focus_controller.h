...
public:
    ...
    const aura::Window* GetToplevelWindow(const aura::Window* window) const override;
...
private:
    ...
    // changes.
    void FocusAndActivateWindow(ActivationChangeObserver::ActivationReason reason, aura::Window* window, bool no_stacking);
    ...
    bool SetActiveWindow(ActivationChangeObserver::ActivationReason reason, aura::Window* requested_window, aura::Window* activatable_window, bool no_stacking);
    ...
    void WindowLostFocusFromDispositionChange(aura::Window* window, aura::Window* next);
    ...
    void WindowFocusedFromInputEvent(aura::Window* window, const ui::Event* event);
