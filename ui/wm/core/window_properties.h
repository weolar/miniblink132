...
COMPONENT_EXPORT(UI_WM)
extern const ui::ClassProperty<base::TimeDelta>* const kWindowVisibilityAnimationDurationKey;

COMPONENT_EXPORT(UI_WM)
extern const ui::ClassProperty<WindowVisibilityAnimationTransition>* const kWindowVisibilityAnimationTransitionKey;
...
COMPONENT_EXPORT(UI_WM)
extern const ui::ClassProperty<float>* const kWindowVisibilityAnimationVerticalPositionKey;
...
DECLARE_EXPORTED_UI_CLASS_PROPERTY_TYPE(COMPONENT_EXPORT(UI_WM), wm::WindowVisibilityAnimationTransition)
