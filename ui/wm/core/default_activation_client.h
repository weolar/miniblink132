...
class COMPONENT_EXPORT(UI_WM) DefaultActivationClient : public ActivationClient, public aura::WindowObserver {
public:
...
private:
    ...
    void ActivateWindowImpl(ActivationChangeObserver::ActivationReason reason, aura::Window* window);
