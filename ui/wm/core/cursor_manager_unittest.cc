...
TEST(CursorManagerCreateDestroyTest, VisibilityTest)
{
    ...
    {
        wm::CursorManager cursor_manager1(base::WrapUnique(new TestingCursorManager));
    ...
    {
        wm::CursorManager cursor_manager2(base::WrapUnique(new TestingCursorManager));
    ...
    {
        wm::CursorManager cursor_manager3(base::WrapUnique(new TestingCursorManager));
