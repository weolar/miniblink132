...
public:
    ...
    virtual void OnTransientChildAdded(aura::Window* window, aura::Window* transient)
    {
    }

    // Called when a transient child is removed from |window|.
    virtual void OnTransientChildRemoved(aura::Window* window, aura::Window* transient)
    {
    }
