...
DEFINE_UI_CLASS_PROPERTY_KEY(ActivationClient*, kRootWindowActivationClientKey, NULL)
...
{
    return root_window ? root_window->GetProperty(kRootWindowActivationClientKey) : nullptr;
}
