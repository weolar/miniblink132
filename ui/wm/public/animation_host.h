...
public:
    ...
    virtual void SetHostTransitionOffsets(const gfx::Vector2d& top_left_delta, const gfx::Vector2d& bottom_right_delta) = 0;
...
WM_PUBLIC_EXPORT void SetAnimationHost(aura::Window* window, AnimationHost* animation_host);
