...
public:
    ...
    MOCK_METHOD(void, OnAttemptToReactivateWindow, (aura::Window * gained_active, aura::Window* lost_active), (override));
    MOCK_METHOD(
    ...
    MOCK_METHOD(
        void, OnWindowActivating, (wm::ActivationChangeObserver::ActivationReason reason, aura::Window* gained_active, aura::Window* lost_active), (override));
};
