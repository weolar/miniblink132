...
DEFINE_UI_CLASS_PROPERTY_KEY(ActivationChangeObserver*, kActivationChangeObserverKey, nullptr)
...
void SetActivationChangeObserver(aura::Window* window, ActivationChangeObserver* observer)
{
