...
public:
    ...
    {
        return const_cast<aura::Window*>(const_cast<const ActivationClient*>(this)->GetActiveWindow());
    }
    ...
    virtual const aura::Window* GetToplevelWindow(const aura::Window* window) const = 0;
...
WM_PUBLIC_EXPORT void SetActivationClient(aura::Window* root_window, ActivationClient* client);
WM_PUBLIC_EXPORT ActivationClient* GetActivationClient(aura::Window* root_window);
WM_PUBLIC_EXPORT const ActivationClient* GetActivationClient(const aura::Window* root_window);
...
WM_PUBLIC_EXPORT void SetHideOnDeactivate(aura::Window* window, bool hide_on_deactivate);
