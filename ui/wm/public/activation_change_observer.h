...
public:
    ...
    virtual void OnWindowActivating(ActivationReason reason, aura::Window* gaining_active, aura::Window* losing_active)
    {
    }
    ...
    // window. |reason| specifies the cause of the activation change.
    virtual void OnWindowActivated(ActivationReason reason, aura::Window* gained_active, aura::Window* lost_active) = 0;
    ...
    virtual void OnAttemptToReactivateWindow(aura::Window* request_active, aura::Window* actual_active)
    {
    }
...
WM_PUBLIC_EXPORT void SetActivationChangeObserver(aura::Window* window, ActivationChangeObserver* observer);
WM_PUBLIC_EXPORT ActivationChangeObserver* GetActivationChangeObserver(aura::Window* window);
