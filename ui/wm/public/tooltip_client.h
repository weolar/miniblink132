...
public:
    ...
    // contained.
    virtual void UpdateTooltipFromKeyboard(const gfx::Rect& bounds, aura::Window* target) = 0;
    ...
    virtual void SetHideTooltipTimeout(aura::Window* target, base::TimeDelta timeout) = 0;
...
WM_PUBLIC_EXPORT void SetTooltipClient(aura::Window* root_window, TooltipClient* client);
...
WM_PUBLIC_EXPORT void SetTooltipText(aura::Window* window, std::u16string* tooltip_text);
...
WM_PUBLIC_EXPORT extern const aura::WindowProperty<TooltipClient*>* const kRootWindowTooltipClientKey;
WM_PUBLIC_EXPORT extern const aura::WindowProperty<void*>* const kTooltipIdKey;
WM_PUBLIC_EXPORT extern const aura::WindowProperty<std::u16string*>* const kTooltipTextKey;
