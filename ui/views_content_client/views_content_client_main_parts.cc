...
ViewsContentClientMainParts::ViewsContentClientMainParts(ViewsContentClient* views_content_client)
...
void ViewsContentClientMainParts::WillRunMainMessageLoop(std::unique_ptr<base::RunLoop>& run_loop)
{
