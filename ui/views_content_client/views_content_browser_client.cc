...
ViewsContentBrowserClient::ViewsContentBrowserClient(ViewsContentClient* views_content_client)
...
std::unique_ptr<content::BrowserMainParts> ViewsContentBrowserClient::CreateBrowserMainParts(bool /* is_integration_test */)
{
