...
public:
    ...
    static std::unique_ptr<ViewsContentClientMainParts> Create(ViewsContentClient* views_content_client);

    static void PreBrowserMain();

    ViewsContentClientMainParts(const ViewsContentClientMainParts&) = delete;
    ViewsContentClientMainParts& operator=(const ViewsContentClientMainParts&) = delete;
...
protected:
    explicit ViewsContentClientMainParts(ViewsContentClient* views_content_client);
