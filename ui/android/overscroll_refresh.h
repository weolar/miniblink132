...
enum OverscrollAction { NONE = 0, PULL_TO_REFRESH = 1, HISTORY_NAVIGATION = 2, PULL_FROM_BOTTOM_EDGE = 3 };
...
public:
    ...
    virtual void OnOverscrolled(const cc::OverscrollBehavior& overscroll_behavior);
    ...
    void OnFrameUpdated(const gfx::SizeF& viewport_size, const gfx::PointF& content_scroll_offset, const gfx::SizeF& content_size, bool root_overflow_y_hidden);
