...
public:
    ...
    void SetUIResource(std::unique_ptr<cc::ScopedUIResource> ui_resource, const gfx::Size& size_in_px);
    size_t EstimateMemoryUsage() const;

    cc::ScopedUIResource* ui_resource() const
    {
        return ui_resource_.get();
    }
    gfx::Size size() const
    {
        return size_;
