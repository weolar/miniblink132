...
public:
    enum State { STATE_IDLE = 0, STATE_PULL, STATE_ABSORB, STATE_RECEDE, STATE_PULL_DECAY };
    ...
    void Pull(base::TimeTicks current_time, float delta_distance, float displacement);
