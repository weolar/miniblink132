...
public:
    ...
    explicit ModalDialogManagerBridge(const jni_zero::JavaParamRef<jobject>& manager);
    ...
    void ShowDialog(base::android::ScopedJavaGlobalRef<jobject> j_modal_dialog_wrapper, ModalDialogType dialog_type);
    void DismissDialog(base::android::ScopedJavaGlobalRef<jobject> j_modal_dialog_wrapper);
