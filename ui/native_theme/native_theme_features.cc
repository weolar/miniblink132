...
#if BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_FUCHSIA) || BUILDFLAG(IS_IOS)
constexpr base::FeatureState kOverlayScrollbarFeatureState = base::FEATURE_ENABLED_BY_DEFAULT;
#else
constexpr base::FeatureState kOverlayScrollbarFeatureState = base::FEATURE_DISABLED_BY_DEFAULT;
#endif
...
BASE_FEATURE(kOverlayScrollbar, "OverlayScrollbar", kOverlayScrollbarFeatureState);
// Enables the os settings of overlay scrollbars for ChromeOS.
#if BUILDFLAG(IS_CHROMEOS)
BASE_FEATURE(kOverlayScrollbarsOSSetting, "OverlayScrollbarsOSSetting", base::FEATURE_DISABLED_BY_DEFAULT);
...
BASE_FEATURE(kFluentScrollbar, "FluentScrollbar", base::FEATURE_DISABLED_BY_DEFAULT);
...
// once it is complete.
BASE_FEATURE(kFluentOverlayScrollbar, "FluentOverlayScrollbar", base::FEATURE_DISABLED_BY_DEFAULT);
...
// Fluent scrollbars are only used for some OSes due to UI design guidelines.
#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_LINUX)
    return base::FeatureList::IsEnabled(features::kFluentScrollbar) || IsFluentOverlayScrollbarEnabled();
#else
    return false;
#endif
}
...
{
    return base::FeatureList::IsEnabled(features::kOverlayScrollbar) || IsFluentOverlayScrollbarEnabled();
}
