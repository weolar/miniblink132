...
{
    observers_.Notify(&ColorProviderSourceObserver::OnColorProviderSourceDestroying);
}
...
void ColorProviderSource::RemoveObserver(ColorProviderSourceObserver* observer)
{
...
ui::ColorProviderKey::ForcedColors ColorProviderSource::GetForcedColors() const
{
