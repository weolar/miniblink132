...
void AddMaterialUiColorMixer(ColorProvider* provider, const ColorProviderKey& key)
{
    const bool dark_mode = key.color_mode == ColorProviderKey::ColorMode::kDark;
    DVLOG(2) << "Adding MaterialUiColorMixer to ColorProvider for " << (dark_mode ? "Dark" : "Light") << " window.";
    ...
    mixer[kColorAppMenuProfileRowChipHovered] = { ui::GetResultingPaintColor(kColorAppMenuRowBackgroundHovered, kColorAppMenuProfileRowChipBackground) };
    ...
    mixer[kColorAppMenuUpgradeRowSubstringForeground] = { kColorSysOnTonalContainer };
    ...
    mixer[kColorButtonBackgroundPressed] = GetResultingPaintColor({ kColorSysStatePressed }, { kColorButtonBackground });
    mixer[kColorButtonBackgroundProminent] = { kColorSysPrimary };
    mixer[kColorButtonBackgroundProminentDisabled] = { GetResultingPaintColor({ kColorSysStateDisabledContainer }, { kColorButtonBackground }) };
    mixer[kColorButtonBackgroundProminentFocused] = { GetResultingPaintColor({ kColorSysStateFocus }, { kColorButtonBackgroundProminent }) };
    mixer[kColorButtonBorder] = { kColorSysTonalOutline };
    mixer[kColorButtonBorderDisabled] = { kColorSysStateDisabledContainer };
    mixer[kColorButtonFeatureAttentionHighlight] = SetAlpha({ kColorSysPrimary }, kAttentionHighlightAlpha);
    ...
    mixer[kColorComboboxBackgroundDisabled] = { GetResultingPaintColor({ kColorSysStateDisabledContainer }, { kColorComboboxBackground }) };
    ...
    mixer[kColorFrameCaptionButtonUnfocused] = { dark_mode ? kColorRefSecondary100 : kColorRefSecondary0 };
    ...
    mixer[kColorHistoryClustersSidePanelDialogDivider] = { kColorSysNeutralOutline };
    mixer[kColorHistoryClustersSidePanelDialogPrimaryForeground] = { kColorSysOnSurface };
    mixer[kColorHistoryClustersSidePanelDialogSecondaryForeground] = { kColorSysOnSurfaceSubtle };
    mixer[kColorHistoryClustersSidePanelCardSecondaryForeground] = { kColorSysOnSurfaceSubtle };
    ...
    mixer[kColorLinkForegroundPressedOnBubbleFooter] = { kColorLinkForegroundPressedDefault };
    ...
    mixer[kColorMenuButtonBackgroundSelected] = { GetResultingPaintColor({ kColorSysStateHoverOnSubtle }, { kColorMenuButtonBackground }) };
    ...
    mixer[kColorMenuSelectionBackground] = { GetResultingPaintColor({ kColorSysStateHoverOnSubtle }, { kColorMenuBackground }) };
    ...
    mixer[kColorRadioButtonForegroundDisabled] = { kColorSysStateDisabledContainer };
    ...
    mixer[kColorTableBackgroundSelectedUnfocused] = { kColorTableBackgroundSelectedFocused };
    mixer[kColorTableForeground] = { kColorPrimaryForeground };
    mixer[kColorTableForegroundSelectedFocused] = { kColorTableForeground };
    mixer[kColorTableForegroundSelectedUnfocused] = { kColorTableForegroundSelectedFocused };
    ...
    mixer[kColorTextfieldBackgroundDisabled] = { GetResultingPaintColor({ kColorSysStateDisabledContainer }, { kColorTextfieldBackground }) };
    ...
    mixer[kColorTextfieldForegroundPlaceholderInvalid] = { BlendForMinContrast(kColorSysError, kColorTextfieldBackground) };
    ...
    mixer[kColorTextfieldOutlineInvalid] = { kColorTextfieldForegroundPlaceholderInvalid };
    ...
    mixer[kColorThemeColorPickerCustomColorIconBackground] = { kColorSysOnSurfaceSubtle };
    ...
    mixer[kColorToolbarSearchFieldBackgroundHover] = { kColorSysStateHoverDimBlendProtection };
    mixer[kColorToolbarSearchFieldBackgroundPressed] = { kColorSysStateRippleNeutralOnSubtle };
    mixer[kColorToolbarSearchFieldForeground] = { kColorSysOnSurface };
    mixer[kColorToolbarSearchFieldForegroundPlaceholder] = { kColorSysOnSurfaceSubtle };
