...
void AddNativeCoreColorMixer(ColorProvider* provider, const ColorProviderKey& key)
{
    ...
    // these.
    mixer[kColorNative3dDkShadow] = { color_utils::GetSysSkColor(COLOR_3DDKSHADOW) };
    mixer[kColorNative3dLight] = { color_utils::GetSysSkColor(COLOR_3DLIGHT) };
    mixer[kColorNativeActiveBorder] = { color_utils::GetSysSkColor(COLOR_ACTIVEBORDER) };
    mixer[kColorNativeActiveCaption] = { color_utils::GetSysSkColor(COLOR_ACTIVECAPTION) };
    mixer[kColorNativeAppWorkspace] = { color_utils::GetSysSkColor(COLOR_APPWORKSPACE) };
    mixer[kColorNativeBackground] = { color_utils::GetSysSkColor(COLOR_BACKGROUND) };
    mixer[kColorNativeBtnFace] = { color_utils::GetSysSkColor(COLOR_BTNFACE) };
    mixer[kColorNativeBtnHighlight] = { color_utils::GetSysSkColor(COLOR_BTNHIGHLIGHT) };
    ...
    mixer[kColorNativeCaptionText] = { color_utils::GetSysSkColor(COLOR_CAPTIONTEXT) };
    mixer[kColorNativeGradientActiveCaption] = { color_utils::GetSysSkColor(COLOR_GRADIENTACTIVECAPTION) };
    mixer[kColorNativeGradientInactiveCaption] = { color_utils::GetSysSkColor(COLOR_GRADIENTINACTIVECAPTION) };
    ...
    mixer[kColorNativeHighlightText] = { color_utils::GetSysSkColor(COLOR_HIGHLIGHTTEXT) };
    mixer[kColorNativeHotlight] = { color_utils::GetSysSkColor(COLOR_HOTLIGHT) };
    mixer[kColorNativeInactiveBorder] = { color_utils::GetSysSkColor(COLOR_INACTIVEBORDER) };
    mixer[kColorNativeInactiveCaption] = { color_utils::GetSysSkColor(COLOR_INACTIVECAPTION) };
    mixer[kColorNativeInactiveCaptionText] = { color_utils::GetSysSkColor(COLOR_INACTIVECAPTIONTEXT) };
    ...
    mixer[kColorNativeMenuHilight] = { color_utils::GetSysSkColor(COLOR_MENUHILIGHT) };
    ...
    mixer[kColorNativeWindowFrame] = { color_utils::GetSysSkColor(COLOR_WINDOWFRAME) };
    mixer[kColorNativeWindowText] = { color_utils::GetSysSkColor(COLOR_WINDOWTEXT) };
    ...
    if (accent_color.has_value() && accent_color_observer->use_dwm_frame_color()) {
...
void AddNativeUiColorMixer(ColorProvider* provider, const ColorProviderKey& key)
{
    ...
    mixer[kColorSliderTrack] = AlphaBlend(kColorNativeHighlight, kColorNativeWindow, gfx::kGoogleGreyAlpha400);
    ...
    mixer[kColorTreeNodeForegroundSelectedUnfocused] = { kColorNativeHighlightText };
    mixer[kColorButtonForegroundProminent] = { kColorNativeHighlightText };
}
