...
struct /*COMPONENT_EXPORT(COLOR_PROVIDER_KEY)*/ ColorProviderKey {
    ...
    public:
        ...
        virtual void AddColorMixers(ColorProvider* provider, const ColorProviderKey& key) const = 0;
    ...
    class COMPONENT_EXPORT(COLOR_PROVIDER_KEY) ThemeInitializerSupplier : public InitializerSupplier,
    ...
    raw_ptr<InitializerSupplier, AcrossTasksDanglingUntriaged> app_controller = nullptr; // unowned
    ...
    bool operator<(const ColorProviderKey& other) const
    {
        ...
        return std::tie(color_mode, contrast_mode, forced_colors, system_theme, frame_type, frame_style, user_color_source, user_color, scheme_variant,
                   custom_theme, lhs_app_controller)
            < std::tie(other.color_mode, other.contrast_mode, other.forced_colors, other.system_theme, other.frame_type, other.frame_style,
                other.user_color_source, other.user_color, other.scheme_variant, other.custom_theme, rhs_app_controller);
    }
};
