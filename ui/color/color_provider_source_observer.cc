...
ColorProviderSourceObserver::ColorProviderSourceObserver(ColorProviderSource* source)
    : source_(source)
{
    if (source) {
...
const ui::ColorProviderSource* ColorProviderSourceObserver::GetColorProviderSourceForTesting() const
{
...
{
    if ((source && color_provider_source_observation_.IsObservingSource(source)) || (!source && source_ == nullptr)) {
        return;
    }
...
const ui::ColorProviderSource* ColorProviderSourceObserver::GetColorProviderSource() const
{
    return source_;
}
