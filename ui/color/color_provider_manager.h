...
public:
    using ColorProviderInitializerList = base::RepeatingCallbackList<void(ColorProvider*, const ColorProviderKey&)>;
    ...
    void AppendColorProviderInitializer(ColorProviderInitializerList::CallbackType Initializer);
...
private:
    ...
    base::flat_map<ColorProviderKey, std::unique_ptr<ColorProvider>> color_providers_;
