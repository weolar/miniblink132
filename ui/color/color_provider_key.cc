...
ColorProviderKey::ThemeInitializerSupplier::ThemeInitializerSupplier(ThemeType theme_type)
...
ColorProviderKey& ColorProviderKey::operator=(const ColorProviderKey&) = default;
