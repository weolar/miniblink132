...
class COMPONENT_EXPORT(COLOR) ColorProviderSourceObserver : public base::CheckedObserver {
public:
...
private:
    ...
    base::ScopedObservation<ColorProviderSource, ColorProviderSourceObserver> color_provider_source_observation_ { this };
};
