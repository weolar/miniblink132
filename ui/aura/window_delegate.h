...
public:
    ...
    virtual void OnBoundsChanged(const gfx::Rect& old_bounds, const gfx::Rect& new_bounds) = 0;
    ...
    virtual bool ShouldDescendIntoChildForEventHandling(Window* child, const gfx::Point& location) = 0;
    ...
    virtual void OnDeviceScaleFactorChanged(float old_device_scale_factor, float new_device_scale_factor) = 0;
    ...
    virtual void OnWindowOcclusionChanged(Window::OcclusionState old_occlusion_state, Window::OcclusionState new_occlusion_state)
    {
    }
