...
ScopedWindowCaptureRequest::ScopedWindowCaptureRequest(ScopedWindowCaptureRequest&& other)
...
ScopedWindowCaptureRequest& ScopedWindowCaptureRequest::operator=(ScopedWindowCaptureRequest&& rhs)
{
...
void ScopedWindowCaptureRequest::AttachToCurrentWindow(bool increment_requests)
{
    DCHECK(window_);
...
Window* ScopedWindowCaptureRequest::DetachFromCurrentWindow(bool decrement_requests)
{
