...
DEFINE_UI_CLASS_PROPERTY_KEY(FocusChangeObserver*, kFocusChangeObserverKey, nullptr)
...
void SetFocusChangeObserver(Window* window, FocusChangeObserver* focus_change_observer)
{
