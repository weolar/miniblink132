...
public:
    ...
    virtual void OnTransientChildWindowAdded(Window* parent, Window* transient_child) = 0;
    ...
    virtual void OnTransientChildWindowRemoved(Window* parent, Window* transient_child) = 0;
