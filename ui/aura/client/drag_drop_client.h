...
public:
    ...
    virtual ui::mojom::DragOperation StartDragAndDrop(std::unique_ptr<ui::OSExchangeData> data, aura::Window* root_window, aura::Window* source_window,
...
AURA_EXPORT void SetDragDropClient(Window* root_window, DragDropClient* client);
