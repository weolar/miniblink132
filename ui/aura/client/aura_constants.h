...
AURA_EXPORT extern const WindowProperty<bool>* const kAccessibilityTouchExplorationPassThrough;
...
AURA_EXPORT extern const WindowProperty<struct ui::OwnedWindowAnchor*>* const kOwnedWindowAnchor;
...
AURA_EXPORT extern const aura::WindowProperty<gfx::NativeViewAccessible>* const kParentNativeViewAccessibleKey;
...
AURA_EXPORT extern const WindowProperty<ui::mojom::WindowShowState>* const kShowStateKey;
...
AURA_EXPORT extern const WindowProperty<int64_t>* const kFullscreenTargetDisplayIdKey;

// A property key to store ui::mojom::WindowShowState for a window to restore
// back to from the current window show state.
AURA_EXPORT extern const WindowProperty<ui::mojom::WindowShowState>* const kRestoreShowStateKey;
