...
public:
    ...
    void ConvertPointFromScreen(const Window* window, gfx::PointF* point) override
    {
    }
    void ConvertHostPointToScreen(Window* root_window, gfx::Point* point) override
    {
    }
    void SetBounds(Window* window, const gfx::Rect& bounds, const display::Display& display) override
    {
    }
