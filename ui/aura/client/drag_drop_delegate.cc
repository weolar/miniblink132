...
DEFINE_EXPORTED_UI_CLASS_PROPERTY_TYPE(AURA_EXPORT, aura::client::DragDropDelegate*)
...
DragUpdateInfo& DragUpdateInfo::operator=(const DragUpdateInfo& update_info) = default;
