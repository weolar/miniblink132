...
public:
    ...
    NativeWindowOcclusionTracker& operator=(const NativeWindowOcclusionTracker&) = delete;
    ~NativeWindowOcclusionTracker() = delete;
    ...
    static bool IsNativeWindowOcclusionTrackingAlwaysEnabled(WindowTreeHost* host);
