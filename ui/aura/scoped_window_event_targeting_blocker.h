...
public:
    ...
    ScopedWindowEventTargetingBlocker(const ScopedWindowEventTargetingBlocker&) = delete;
    ScopedWindowEventTargetingBlocker& operator=(const ScopedWindowEventTargetingBlocker&) = delete;
