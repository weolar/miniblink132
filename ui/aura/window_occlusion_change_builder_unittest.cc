...
public:
    ...
    OcclusionTrackWindowDelegate& operator=(const OcclusionTrackWindowDelegate&) = delete;
    ...
    bool occlusion_change_count() const
    {
        return occlusion_change_count_;
    }
    Window::OcclusionState last_occlusion_state() const
    {
        return last_occlusion_state_;
    }
    const SkRegion& last_occluded_region() const
    {
        return last_occluded_region_;
    }
...
private:
    ...
    Window::OcclusionState last_occlusion_state_ = Window::OcclusionState::UNKNOWN;
...
public:
    ...
    WindowOcclusionChangeBuilderTest(const WindowOcclusionChangeBuilderTest&) = delete;
    WindowOcclusionChangeBuilderTest& operator=(const WindowOcclusionChangeBuilderTest&) = delete;

    ~WindowOcclusionChangeBuilderTest() override = default;

    std::unique_ptr<Window> CreateTestWindow(OcclusionTrackWindowDelegate* delegate)
    {
...
TEST_F(WindowOcclusionChangeBuilderTest, SingleWindow)
{
    ...
    for (const auto state : { Window::OcclusionState::VISIBLE, Window::OcclusionState::OCCLUDED, Window::OcclusionState::HIDDEN }) {
