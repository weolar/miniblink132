...
class AURA_EXPORT WindowTreeHostPlatform : public WindowTreeHost, public ui::PlatformWindowDelegate {
public:
    explicit WindowTreeHostPlatform(ui::PlatformWindowInitProperties properties, std::unique_ptr<Window> = nullptr);
    ...
    std::unique_ptr<ui::PlatformWindow> CreatePlatformWindow(ui::PlatformWindowInitProperties properties);

    class PlatformWindowFactoryDelegateForTesting {
    public:
        virtual ~PlatformWindowFactoryDelegateForTesting() = default;
        virtual std::unique_ptr<ui::PlatformWindow> Create(WindowTreeHostPlatform*) = 0;
    };
    static void SetPlatformWindowFactoryDelegateForTesting(PlatformWindowFactoryDelegateForTesting* delegate);
...
protected:
    ...
    int64_t OnStateUpdate(const PlatformWindowDelegate::State& old, const PlatformWindowDelegate::State& latest) override;
