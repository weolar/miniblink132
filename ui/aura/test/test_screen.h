...
public:
    ...
    void SetColorSpace(const gfx::ColorSpace& color_space, float sdr_white_level = gfx::ColorSpace::kDefaultSDRWhiteLevel);
    void SetDisplayRotation(display::Display::Rotation rotation);
    void SetUIScale(float ui_scale);
    void SetWorkAreaInsets(const gfx::Insets& insets);
    void SetPreferredScaleFactorForWindow(gfx::NativeWindow window, float scale_factor);

protected:
    static gfx::NativeWindow GetWindowForPoint(Window* window, const gfx::Point& local_point);
