...
void TestCursorClient::AddObserver(aura::client::CursorClientObserver* observer)
{
    observers_.AddObserver(observer);
}

void TestCursorClient::RemoveObserver(aura::client::CursorClientObserver* observer)
{
    observers_.RemoveObserver(observer);
}

bool TestCursorClient::ShouldHideCursorOnKeyEvent(const ui::KeyEvent& event) const
{
    return should_hide_cursor_on_key_event_;
}

bool TestCursorClient::ShouldHideCursorOnTouchEvent(const ui::TouchEvent& event) const
{
    return true;
}
