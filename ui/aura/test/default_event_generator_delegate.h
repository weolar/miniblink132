...
public:
    ...
    DefaultEventGeneratorDelegate& operator=(const DefaultEventGeneratorDelegate&) = delete;
    ...
    client::ScreenPositionClient* GetScreenPositionClient(const Window* window) const override;
