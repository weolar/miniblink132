...
WindowOcclusionTrackerTestApi::WindowOcclusionTrackerTestApi(WindowOcclusionTracker* tracker)
    : tracker_(tracker)
{
}
...
// static
std::unique_ptr<WindowOcclusionTracker> WindowOcclusionTrackerTestApi::Create()
{
