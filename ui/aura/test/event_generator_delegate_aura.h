...
public:
    ...
    EventGeneratorDelegateAura& operator=(const EventGeneratorDelegateAura&) = delete;
    ...
    virtual client::ScreenPositionClient* GetScreenPositionClient(const Window* window) const;
    ...
    void ConvertPointFromTarget(const ui::EventTarget* target, gfx::Point* point) const override;
    void ConvertPointToTarget(const ui::EventTarget* target, gfx::Point* point) const override;
    void ConvertPointFromWindow(gfx::NativeWindow window, gfx::Point* point) const override;
    void ConvertPointFromHost(const ui::EventTarget* hosted_target, gfx::Point* point) const override;
