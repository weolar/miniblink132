...
void AuraTestBase::SetUp()
{
    ...
    gesture_config->set_velocity_tracker_strategy(ui::VelocityTracker::Strategy::LSQ2_RESTRICTED);
...
Window* AuraTestBase::CreateNormalWindow(int id, Window* parent, WindowDelegate* delegate)
{
    return CreateTestWindowWithDelegateAndType(delegate ? delegate : test::TestWindowDelegate::CreateSelfDestroyingDelegate(), client::WINDOW_TYPE_UNKNOWN, id,
        gfx::Rect(0, 0, 100, 100), parent,
...
{
    client::ParentWindowWithContext(window, root_window(), gfx::Rect(), display::kInvalidDisplayId);
}
