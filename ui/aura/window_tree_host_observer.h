...
public:
    ...
    virtual void OnOcclusionStateChanged(WindowTreeHost* host, Window::OcclusionState new_state, const SkRegion& occluded_region)
    {
    }
    ...
    virtual void OnCompositingFrameSinksToThrottleUpdated(const aura::WindowTreeHost* host, const base::flat_set<viz::FrameSinkId>& ids)
    {
    }

    virtual void OnSetPreferredRefreshRate(WindowTreeHost* host, float preferred_refresh_rate)
    {
    }
