...
public:
    ...
    void set_icon_on_item(int command_id)
    {
        item_with_icon_ = command_id;
    }
    ...
    {
        return item_with_icon_ == command_id ? ImageModel::FromImage(gfx::test::CreateImage(16, 16)) : ImageModel();
    }
...
TEST(SimpleMenuModelTest, SetElementIdentifierAt)
{
    ...
    EXPECT_EQ(ui::ElementIdentifier(), simple_menu_model.GetElementIdentifierAt(0));
...
TEST(SimpleMenuModelTest, HasIconsViaAddItem)
{
    ...
    simple_menu_model.AddItemWithIcon(
        /*command_id*/ 11, u"menu item", ui::ImageModel::FromImage(gfx::test::CreateImage(16, 16)));
    EXPECT_FALSE(simple_menu_model.GetIconAt(1).IsEmpty());
}
...
TEST(SimpleMenuModelTest, HasIconsViaVectorIcon)
{
    ...
    simple_menu_model.AddItemWithIcon(
        /*command_id*/ 11, u"menu item", ui::ImageModel::FromVectorIcon(circle_icon, ui::kColorMenuIcon, 16));
    EXPECT_FALSE(simple_menu_model.GetIconAt(1).IsEmpty());
}
