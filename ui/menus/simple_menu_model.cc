...
bool SimpleMenuModel::Delegate::IsElementIdAlerted(ui::ElementIdentifier element_id) const
{
    return false;
}

bool SimpleMenuModel::Delegate::IsItemForCommandIdDynamic(int command_id) const
{
    return false;
}

std::u16string SimpleMenuModel::Delegate::GetLabelForCommandId(int command_id) const
{
    return std::u16string();
}

ImageModel SimpleMenuModel::Delegate::GetIconForCommandId(int command_id) const
{
    return ImageModel();
}
...
bool SimpleMenuModel::Delegate::GetAcceleratorForCommandId(int command_id, ui::Accelerator* accelerator) const
{
    return false;
}
...
void SimpleMenuModel::AddItemWithIcon(int command_id, const std::u16string& label, const ImageModel& icon)
{
...
void SimpleMenuModel::AddItemWithStringIdAndIcon(int command_id, int string_id, const ImageModel& icon)
{
    AddItemWithIcon(command_id, l10n_util::GetStringUTF16(string_id), icon);
}

void SimpleMenuModel::AddCheckItem(int command_id, const std::u16string& label)
{
...
void SimpleMenuModel::AddRadioItem(int command_id, const std::u16string& label, int group_id)
{
...
void SimpleMenuModel::AddRadioItemWithStringId(int command_id, int string_id, int group_id)
{
    AddRadioItem(command_id, l10n_util::GetStringUTF16(string_id), group_id);
}

void SimpleMenuModel::AddHighlightedItemWithIcon(int command_id, const std::u16string& label, const ImageModel& icon)
{
...
void SimpleMenuModel::AddSubMenu(int command_id, const std::u16string& label, MenuModel* model)
{
...
void SimpleMenuModel::AddSubMenuWithStringId(int command_id, int string_id, MenuModel* model)
{
    AddSubMenu(command_id, l10n_util::GetStringUTF16(string_id), model);
}

void SimpleMenuModel::AddSubMenuWithIcon(int command_id, const std::u16string& label, MenuModel* model, const ImageModel& icon)
{
    Item item(command_id, TYPE_SUBMENU, label);
    item.submenu = model;
    item.icon = icon;
...
void SimpleMenuModel::AddSubMenuWithStringIdAndIcon(int command_id, int string_id, MenuModel* model, const ImageModel& icon)
{
...
void SimpleMenuModel::AddActionableSubMenu(int command_id, const std::u16string& label, MenuModel* model)
{
...
void SimpleMenuModel::AddActionableSubmenuWithStringIdAndIcon(int command_id, int string_id, MenuModel* model, const ImageModel& icon)
{
    Item item(command_id, TYPE_ACTIONABLE_SUBMENU, l10n_util::GetStringUTF16(string_id));
    item.submenu = model;
    item.icon = icon;
    AppendItem(std::move(item));
}

void SimpleMenuModel::InsertItemAt(size_t index, int command_id, const std::u16string& label)
{
    InsertItemAtIndex(Item(command_id, TYPE_COMMAND, label), index);
}

void SimpleMenuModel::InsertItemWithStringIdAt(size_t index, int command_id, int string_id)
{
    InsertItemAt(index, command_id, l10n_util::GetStringUTF16(string_id));
}

void SimpleMenuModel::InsertCheckItemAt(size_t index, int command_id, const std::u16string& label)
{
    InsertItemAtIndex(Item(command_id, TYPE_CHECK, label), index);
}

void SimpleMenuModel::InsertCheckItemWithStringIdAt(size_t index, int command_id, int string_id)
{
    InsertCheckItemAt(index, command_id, l10n_util::GetStringUTF16(string_id));
}

void SimpleMenuModel::InsertRadioItemAt(size_t index, int command_id, const std::u16string& label, int group_id)
{
    Item item(command_id, TYPE_RADIO, label);
    item.group_id = group_id;
...
void SimpleMenuModel::InsertRadioItemWithStringIdAt(size_t index, int command_id, int string_id, int group_id)
{
    InsertRadioItemAt(index, command_id, l10n_util::GetStringUTF16(string_id), group_id);
}
...
void SimpleMenuModel::InsertSeparatorAt(size_t index, MenuSeparatorType separator_type)
{
#if !defined(USE_AURA)
    if (separator_type != NORMAL_SEPARATOR) {
        NOTIMPLEMENTED();
...
void SimpleMenuModel::InsertSubMenuAt(size_t index, int command_id, const std::u16string& label, MenuModel* model)
{
    Item item(command_id, TYPE_SUBMENU, label);
    item.submenu = model;
    InsertItemAtIndex(std::move(item), index);
...
void SimpleMenuModel::InsertSubMenuWithStringIdAt(size_t index, int command_id, int string_id, MenuModel* model)
{
    InsertSubMenuAt(index, command_id, l10n_util::GetStringUTF16(string_id), model);
}

void SimpleMenuModel::RemoveItemAt(size_t index)
{
    items_.erase(items_.begin() + static_cast<ptrdiff_t>(ValidateItemIndex(index)));
    MenuItemsChanged();
}
...
void SimpleMenuModel::SetAcceleratorAt(size_t index, const ui::Accelerator& accelerator)
{
    items_[ValidateItemIndex(index)].accelerator = accelerator;
    MenuItemsChanged();
}

void SimpleMenuModel::SetMinorText(size_t index, const std::u16string& minor_text)
{
    items_[ValidateItemIndex(index)].minor_text = minor_text;
}

void SimpleMenuModel::SetMinorIcon(size_t index, const ui::ImageModel& minor_icon)
{
...
void SimpleMenuModel::SetIsNewFeatureAt(size_t index, IsNewFeatureAtValue is_new_feature)
{
    items_[ValidateItemIndex(index)].is_new_feature = is_new_feature;
}

void SimpleMenuModel::SetMayHaveMnemonicsAt(size_t index, bool may_have_mnemonics)
{
    items_[ValidateItemIndex(index)].may_have_mnemonics = may_have_mnemonics;
}

void SimpleMenuModel::SetAccessibleNameAt(size_t index, std::u16string accessible_name)
{
    items_[ValidateItemIndex(index)].accessible_name = std::move(accessible_name);
}

void SimpleMenuModel::SetElementIdentifierAt(size_t index, ElementIdentifier unique_id)
{
    items_[ValidateItemIndex(index)].unique_id = unique_id;
}

void SimpleMenuModel::SetExecuteCallbackAt(size_t index, base::RepeatingCallback<void(int)> callback)
{
...
std::optional<size_t> SimpleMenuModel::GetIndexOfCommandId(int command_id) const
{
...
void SimpleMenuModel::SetForceShowAcceleratorForItemAt(size_t index, bool force_show_accelerator_for_item)
{
    items_[ValidateItemIndex(index)].force_show_accelerator_for_item = force_show_accelerator_for_item;
}
...
{
    return delegate_ && delegate_->IsItemForCommandIdDynamic(GetCommandIdAt(index));
}

bool SimpleMenuModel::GetAcceleratorAt(size_t index, ui::Accelerator* accelerator) const
{
    bool has_accelerator = false;
    if (delegate_) {
        has_accelerator = delegate_->GetAcceleratorForCommandId(GetCommandIdAt(index), accelerator);
    }
    if (!has_accelerator) {
...
bool SimpleMenuModel::IsItemCheckedAt(size_t index) const
{
    ...
    return (item_type == TYPE_CHECK || item_type == TYPE_RADIO) && delegate_->IsCommandIdChecked(GetCommandIdAt(index));
}
...
bool SimpleMenuModel::IsEnabledAt(size_t index) const
{
    ...
    if (!delegate_ || command_id == kSeparatorId || command_id == kTitleId || GetButtonMenuItemAt(index)) {
        return items_[ValidateItemIndex(index)].enabled;
    }

    return delegate_->IsCommandIdEnabled(command_id) && items_[ValidateItemIndex(index)].enabled;
}
...
bool SimpleMenuModel::IsVisibleAt(size_t index) const
{
    ...
    return delegate_->IsCommandIdVisible(command_id) && items_[ValidateItemIndex(index)].visible;
}
...
void SimpleMenuModel::ActivatedAt(size_t index, int event_flags)
{
    ...
    const base::RepeatingCallback<void(int)> on_execute_callback = items_[ValidateItemIndex(index)].on_execute_callback;
...
void SimpleMenuModel::MenuWillClose()
{
    ...
    base::SingleThreadTaskRunner::GetCurrentDefault()->PostTask(FROM_HERE, base::BindOnce(&SimpleMenuModel::OnMenuClosed, method_factory_.GetWeakPtr()));
}
