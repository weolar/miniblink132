...
- (void)controllerWillAddItem:(NSMenuItem*)menuItem fromModel:(ui::MenuModel*)model atIndex:(size_t)index;
...
COMPONENT_EXPORT(UI_MENUS)
@interface MenuControllerCocoa : NSObject <NSMenuDelegate, NSUserInterfaceValidations>
...
- (instancetype)initWithModel:(ui::MenuModel*)model delegate:(id<MenuControllerCocoaDelegate>)delegate useWithPopUpButtonCell:(BOOL)useWithCell;
