...
// context menu.
class COMPONENT_EXPORT(UI_MENUS) TextServicesContextMenu : public SimpleMenuModel::Delegate {
public:
    enum MenuCommands {
    ...
    public:
        ...
        virtual bool IsTextDirectionEnabled(base::i18n::TextDirection direction) const = 0;

        // Returns true if |direction| should be checked in the BiDi submenu.
        virtual bool IsTextDirectionChecked(base::i18n::TextDirection direction) const = 0;
