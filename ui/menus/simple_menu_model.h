...
public:
    ...
    IsNewFeatureAtValue(base::PassKey<user_education::NewBadgeController>, bool value)
...
private:
    explicit IsNewFeatureAtValue(bool value)
        : value_(value)
    {
    }
...
public:
    ...
    void AddItemWithIcon(int command_id, const std::u16string& label, const ui::ImageModel& icon);
    void AddItemWithStringIdAndIcon(int command_id, int string_id, const ui::ImageModel& icon);
    ...
    void AddHighlightedItemWithIcon(int command_id, const std::u16string& label, const ui::ImageModel& icon);
    ...
    void AddSubMenu(int command_id, const std::u16string& label, MenuModel* model);
    void AddSubMenuWithStringId(int command_id, int string_id, MenuModel* model);
    void AddSubMenuWithIcon(int command_id, const std::u16string& label, MenuModel* model, const ImageModel& icon);
    void AddSubMenuWithStringIdAndIcon(int command_id, int string_id, MenuModel* model, const ui::ImageModel& icon);
    void AddActionableSubMenu(int command_id, const std::u16string& label, MenuModel* model);
    void AddActionableSubmenuWithStringIdAndIcon(int command_id, int string_id, MenuModel* model, const ui::ImageModel& icon);
    ...
    void InsertCheckItemAt(size_t index, int command_id, const std::u16string& label);
    void InsertCheckItemWithStringIdAt(size_t index, int command_id, int string_id);
    void InsertRadioItemAt(size_t index, int command_id, const std::u16string& label, int group_id);
    void InsertRadioItemWithStringIdAt(size_t index, int command_id, int string_id, int group_id);
    ...
    void InsertSubMenuAt(size_t index, int command_id, const std::u16string& label, MenuModel* model);
    void InsertSubMenuWithStringIdAt(size_t index, int command_id, int string_id, MenuModel* model);
    ...
    void SetExecuteCallbackAt(size_t index, base::RepeatingCallback<void(int)> callback);
    ...
    // with the Mac team.
    void SetForceShowAcceleratorForItemAt(size_t index, bool force_show_accelerator_for_item);
