...
public:
    ...
    virtual GdkModifierType GetGdkKeyEventState(const ui::KeyEvent& key_event) = 0;
    ...
    virtual bool SetGtkWidgetTransientFor(GtkWidget* widget, gfx::AcceleratedWidget parent) = 0;
    ...
    virtual std::unique_ptr<ui::LinuxInputMethodContext> CreateInputMethodContext(ui::LinuxInputMethodContextDelegate* delegate) const = 0;
