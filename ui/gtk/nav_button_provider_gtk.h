...
public:
    ...
    gfx::ImageSkia GetImage(ui::NavButtonProvider::FrameButtonDisplayType type, ButtonState state) const override;
    gfx::Insets GetNavButtonMargin(ui::NavButtonProvider::FrameButtonDisplayType type) const override;
    gfx::Insets GetTopAreaSpacing() const override;
    int GetInterNavButtonSpacing() const override;

private:
    std::map<ui::NavButtonProvider::FrameButtonDisplayType, base::flat_map<ui::NavButtonProvider::ButtonState, gfx::ImageSkia>> button_images_;
    std::map<ui::NavButtonProvider::FrameButtonDisplayType, gfx::Insets> button_margins_;
