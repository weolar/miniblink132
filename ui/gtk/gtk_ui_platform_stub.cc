...
GdkModifierType GtkUiPlatformStub::GetGdkKeyEventState(const ui::KeyEvent& key_event)
{
...
bool GtkUiPlatformStub::SetGtkWidgetTransientFor(GtkWidget* widget, gfx::AcceleratedWidget parent)
{
    return false;
}
...
std::unique_ptr<ui::LinuxInputMethodContext> GtkUiPlatformStub::CreateInputMethodContext(ui::LinuxInputMethodContextDelegate* delegate) const
{
    return nullptr;
}
