...
struct SHELL_DIALOGS_EXPORT SelectedFileInfo {
    ...
    // `in_file_path` value.
    SelectedFileInfo(const base::FilePath& in_file_path, const base::FilePath& in_local_path);
...
SHELL_DIALOGS_EXPORT std::vector<SelectedFileInfo> FilePathListToSelectedFileInfoList(const std::vector<base::FilePath>& paths);
...
// `file_path`.
SHELL_DIALOGS_EXPORT std::vector<base::FilePath> SelectedFileInfoListToFilePathList(const std::vector<SelectedFileInfo>& files);
