...
public:
    ...
    public:
        ...
        ui::SelectFileDialog* Create(ui::SelectFileDialog::Listener* listener, std::unique_ptr<ui::SelectFilePolicy> policy) override;
    ...
    FakeSelectFileDialog(const base::RepeatingClosure& opened, Listener* listener, std::unique_ptr<SelectFilePolicy> policy);
    ...
    const FileTypeInfo& file_types() const
    {
        return file_types_;
    }
    ...
    [[nodiscard]] bool CallFileSelected(const base::FilePath& file_path, std::string_view filter_text);
