...
protected:
    explicit SelectFileDialogLinux(Listener* listener, std::unique_ptr<ui::SelectFilePolicy> policy);
    ...
    size_t file_type_index() const
    {
        return file_type_index_;
    }
    ...
    static const base::FilePath* last_saved_path()
    {
    ...
    static const base::FilePath* last_opened_path()
    {
        return last_opened_path_;
    }
