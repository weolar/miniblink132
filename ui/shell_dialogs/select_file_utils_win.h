...
template <typename T> std::basic_string<T> RemoveEnvVarFromFileName(const std::basic_string<T>& file_name, const std::basic_string<T>& env_delimit)
{
    base::StringTokenizerT<std::basic_string<T>, typename std::basic_string<T>::const_iterator> t(file_name, env_delimit);
