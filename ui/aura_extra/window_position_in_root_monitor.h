...
// to a valid root.
class AURA_EXTRA_EXPORT WindowPositionInRootMonitor : public aura::WindowObserver {
public:
    WindowPositionInRootMonitor(aura::Window* window, base::RepeatingClosure callback);

    WindowPositionInRootMonitor(const WindowPositionInRootMonitor&) = delete;
    WindowPositionInRootMonitor& operator=(const WindowPositionInRootMonitor&) = delete;
