...
// renderer.
class ColorChangeHandler : public content::WebContentsObserver, public color_change_listener::mojom::PageHandler {
public:
    ColorChangeHandler(content::WebContents* web_contents, mojo::PendingReceiver<color_change_listener::mojom::PageHandler> pending_page_handler);
    ...
    void SetPage(mojo::PendingRemote<color_change_listener::mojom::Page> pending_page) override;
