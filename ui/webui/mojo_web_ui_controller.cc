...
EnableMojoWebUI::EnableMojoWebUI(content::WebUI* contents, bool enable_chrome_send)
{
    content::BindingsPolicySet bindings({ content::BindingsPolicyValue::kMojoWebUi });
...
MojoWebUIController::MojoWebUIController(content::WebUI* contents, bool enable_chrome_send)
