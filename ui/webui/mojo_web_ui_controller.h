...
class MojoWebUIController : public content::WebUIController, public EnableMojoWebUI {
public:
    // By default MojoWebUIControllers do not have normal WebUI bindings. Pass
    // |enable_chrome_send| as true if these are needed.
    explicit MojoWebUIController(content::WebUI* contents, bool enable_chrome_send = false);
