...
protected:
    ...
    virtual void CreateAndShowWindowForWebContents(std::unique_ptr<content::WebContents> web_contents, const std::u16string& title) = 0;
...
private:
    ...
    content::WebContents* CreateAndShowWindow(GURL url, const std::u16string& title);
