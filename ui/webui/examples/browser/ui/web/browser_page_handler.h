...
class BrowserPageHandler : public content::DocumentService<webui_examples::mojom::PageHandler> {
public:
    ...
    static void CreateForRenderFrameHost(content::RenderFrameHost& render_frame_host, mojo::PendingReceiver<webui_examples::mojom::PageHandler> receiver);

    // webui_examples::mojom::PageHandler
    void CreateGuestView(base::Value::Dict create_params, CreateGuestViewCallback callback) override;
...
private:
    BrowserPageHandler(content::RenderFrameHost& render_frame_host, mojo::PendingReceiver<webui_examples::mojom::PageHandler> receiver);
};
