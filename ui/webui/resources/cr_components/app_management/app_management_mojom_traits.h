...
template <> struct EnumTraits<AppType, apps::AppType> {
    static AppType ToMojom(apps::AppType input);
    static bool FromMojom(AppType input, apps::AppType* output);
};

template <> struct StructTraits<PermissionDataView, apps::PermissionPtr> {
    static apps::PermissionType permission_type(const apps::PermissionPtr& r)
    {
        return r->permission_type;
    }

    static const apps::Permission::PermissionValue& value(const apps::PermissionPtr& r)
    {
        return r->value;
    }

    static bool is_managed(const apps::PermissionPtr& r)
    {
        return r->is_managed;
    }
...
template <> struct EnumTraits<PermissionType, apps::PermissionType> {
...
template <> struct EnumTraits<TriState, apps::TriState> {
    static TriState ToMojom(apps::TriState input);
    static bool FromMojom(TriState input, apps::TriState* output);
};

template <> struct UnionTraits<PermissionValueDataView, apps::Permission::PermissionValue> {
    static PermissionValueDataView::Tag GetTag(const apps::Permission::PermissionValue& r);
    ...
    static apps::TriState tristate_value(const apps::Permission::PermissionValue& r)
    {
...
template <> struct StructTraits<RunOnOsLoginDataView, apps::RunOnOsLoginPtr> {
