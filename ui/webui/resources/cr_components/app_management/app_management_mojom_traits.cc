...
bool EnumTraits<AppType, apps::AppType>::FromMojom(AppType input, apps::AppType* output)
{
    switch (input) {
...
bool StructTraits<PermissionDataView, apps::PermissionPtr>::Read(PermissionDataView data, apps::PermissionPtr* out)
{
    ...
    *out = std::make_unique<apps::Permission>(permission_type, std::move(value), data.is_managed(), details);
    return true;
}

PermissionType EnumTraits<PermissionType, apps::PermissionType>::ToMojom(apps::PermissionType input)
{
    switch (input) {
...
bool EnumTraits<PermissionType, apps::PermissionType>::FromMojom(PermissionType input, apps::PermissionType* output)
{
    switch (input) {
...
bool EnumTraits<TriState, apps::TriState>::FromMojom(TriState input, apps::TriState* output)
{
    switch (input) {
...
PermissionValueDataView::Tag UnionTraits<PermissionValueDataView, apps::Permission::PermissionValue>::GetTag(const apps::Permission::PermissionValue& r)
{
...
bool UnionTraits<PermissionValueDataView, apps::Permission::PermissionValue>::Read(PermissionValueDataView data, apps::Permission::PermissionValue* out)
{
    switch (data.tag()) {
...
InstallReason EnumTraits<InstallReason, apps::InstallReason>::ToMojom(apps::InstallReason input)
{
    switch (input) {
...
bool EnumTraits<InstallReason, apps::InstallReason>::FromMojom(InstallReason input, apps::InstallReason* output)
{
    switch (input) {
...
InstallSource EnumTraits<InstallSource, apps::InstallSource>::ToMojom(apps::InstallSource input)
{
    switch (input) {
...
bool EnumTraits<InstallSource, apps::InstallSource>::FromMojom(InstallSource input, apps::InstallSource* output)
{
    switch (input) {
...
WindowMode EnumTraits<WindowMode, apps::WindowMode>::ToMojom(apps::WindowMode input)
{
    switch (input) {
...
bool EnumTraits<WindowMode, apps::WindowMode>::FromMojom(WindowMode input, apps::WindowMode* output)
{
    switch (input) {
...
RunOnOsLoginMode EnumTraits<RunOnOsLoginMode, apps::RunOnOsLoginMode>::ToMojom(apps::RunOnOsLoginMode input)
{
    switch (input) {
...
bool EnumTraits<RunOnOsLoginMode, apps::RunOnOsLoginMode>::FromMojom(RunOnOsLoginMode input, apps::RunOnOsLoginMode* output)
{
    switch (input) {
...
bool StructTraits<RunOnOsLoginDataView, apps::RunOnOsLoginPtr>::Read(RunOnOsLoginDataView data, apps::RunOnOsLoginPtr* out)
{
