...
static_assert(static_cast<int>(ui::mojom::LatencyComponentType::kMaxValue) == static_cast<int>(ui::LATENCY_COMPONENT_TYPE_LAST), "Enum size mismatch");

template <> struct COMPONENT_EXPORT(LATENCY_SHARED_MOJOM_TRAITS) ArrayTraits<ui::LatencyInfo::LatencyMap> {
...
template <> struct COMPONENT_EXPORT(LATENCY_SHARED_MOJOM_TRAITS) StructTraits<ui::mojom::LatencyInfoDataView, ui::LatencyInfo> {
    static const ui::LatencyInfo::LatencyMap& latency_components(const ui::LatencyInfo& info);
...
template <> struct COMPONENT_EXPORT(LATENCY_SHARED_MOJOM_TRAITS) EnumTraits<ui::mojom::LatencyComponentType, ui::LatencyComponentType> {
    static ui::mojom::LatencyComponentType ToMojom(ui::LatencyComponentType type);
    static bool FromMojom(ui::mojom::LatencyComponentType input, ui::LatencyComponentType* output);
};
