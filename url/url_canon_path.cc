...
const unsigned char kPathCharLookup[0x100] = {
    ...
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE,
    ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE, ESCAPE
};
// clang-format on
...
template <typename CHAR> DotDisposition ClassifyAfterDot(const CHAR* spec, size_t after_dot, size_t end, size_t* consumed_len)
{
    if (after_dot == end) {
...
bool DoPartialPathInternal(const CHAR* spec, const Component& path, size_t path_begin_in_output, CanonMode canon_mode, CanonOutput* output)
{
    if (path.is_empty())
        return true;
        ...
        if (sizeof(CHAR) > 1 && uch >= 0x80) {
            ...
            if (flags & SPECIAL) {
                ...
                if ((dotlen = IsDot(spec, i, end)) > 0) {
                    ...
                    if (canon_mode == CanonMode::kSpecialURL || canon_mode == CanonMode::kFileURL) {
...
// true if successful.
template <typename CHAR, typename UCHAR> bool DoPartialPath(const CHAR* spec, const Component& path, CanonOutput* output, Component* out_path)
{
    out_path->begin = output->length();
    bool success = DoPartialPathInternal<CHAR, UCHAR>(spec, path, out_path->begin,
...
template <typename CHAR, typename UCHAR> bool DoPath(const CHAR* spec, const Component& path, CanonMode canon_mode, CanonOutput* output, Component* out_path)
{
    // URL Standard:
    ...
    if (path.is_nonempty()) {
        ...
        success = DoPartialPathInternal<CHAR, UCHAR>(spec, path, out_path->begin, canon_mode, output);
    } else if (canon_mode == CanonMode::kSpecialURL || canon_mode == CanonMode::kFileURL) {
...
{
    return DoPath<char, unsigned char>(spec, path, CanonMode::kSpecialURL, output, out_path);
}

bool CanonicalizePath(const char16_t* spec, const Component& path, CanonOutput* output, Component* out_path)
{
    return DoPath<char16_t, char16_t>(spec, path, CanonMode::kSpecialURL, output, out_path);
}
...
bool CanonicalizePartialPathInternal(const char* spec, const Component& path, size_t path_begin_in_output, CanonMode canon_mode, CanonOutput* output)
{
    return DoPartialPathInternal<char, unsigned char>(spec, path, path_begin_in_output, canon_mode, output);
}

bool CanonicalizePartialPathInternal(const char16_t* spec, const Component& path, size_t path_begin_in_output, CanonMode canon_mode, CanonOutput* output)
{
    return DoPartialPathInternal<char16_t, char16_t>(spec, path, path_begin_in_output, canon_mode, output);
}
