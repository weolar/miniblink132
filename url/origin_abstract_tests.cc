...
// static
Origin UrlOriginTestTraits::CreateWithReferenceOrigin(std::string_view url, const Origin& reference_origin)
{
...
// static
SchemeHostPort UrlOriginTestTraits::GetTupleOrPrecursorTupleIfOpaque(const Origin& origin)
{
