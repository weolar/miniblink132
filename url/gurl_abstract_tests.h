...
template <typename TUrlTraits> class AbstractUrlTest : public testing::Test {
protected:
...
TYPED_TEST_P(AbstractUrlTest, IsAboutBlankTest)
{
    ...
    const std::string kAboutBlankUrls[] = { "about:blank", "about:blank?foo", "about:blank/#foo", "about:blank?foo#foo" };
    ...
    const std::string kNotAboutBlankUrls[]
        = { "", "about", "about:", "about:blanky", "about:blan", "about:about:blank:", "data:blank", "http:blank", "about://blank", "about:blank/foo",
              "about://:8000/blank", "about://foo:foo@/blank", "foo@about:blank", "foo:bar@about:blank", "about:blank:8000", "about:blANk" };
...
TYPED_TEST_P(AbstractUrlTest, IsAboutSrcdocTest)
{
    ...
    const std::string kAboutSrcdocUrls[] = { "about:srcdoc", "about:srcdoc/", "about:srcdoc?foo", "about:srcdoc/#foo", "about:srcdoc?foo#foo" };
    ...
    const std::string kNotAboutSrcdocUrls[] = { "", "about", "about:", "about:srcdocx", "about:srcdo", "about:about:srcdoc:", "data:srcdoc", "http:srcdoc",
        "about:srcdo", "about://srcdoc", "about://srcdoc\\", "about:srcdoc/foo", "about://:8000/srcdoc", "about://foo:foo@/srcdoc", "foo@about:srcdoc",
        "foo:bar@about:srcdoc", "about:srcdoc:8000", "about:srCDOc" };
...
REGISTER_TYPED_TEST_SUITE_P(AbstractUrlTest, IsAboutBlankTest, IsAboutSrcdocTest);
