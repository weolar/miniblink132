...
template <typename CharT> class StringViewReplacements : public Replacements<CharT> {
private:
...
public:
    void SetSchemeStr(const CharT* str)
    {
        SetImpl(&ParentT::SetScheme, str);
    }
    void SetSchemeStr(StringViewT str)
    {
        SetImpl(&ParentT::SetScheme, str);
    }
    void SetSchemeStr(const StringT&&) = delete;

    void SetUsernameStr(const CharT* str)
    {
        SetImpl(&ParentT::SetUsername, str);
    }
    ...
    void SetPasswordStr(const CharT* str)
    {
        SetImpl(&ParentT::SetPassword, str);
    }
    ...
    void SetHostStr(const CharT* str)
    {
        SetImpl(&ParentT::SetHost, str);
    }
    void SetHostStr(StringViewT str)
    {
        SetImpl(&ParentT::SetHost, str);
    }
    ...
    void SetPortStr(const CharT* str)
    {
        SetImpl(&ParentT::SetPort, str);
    }
    void SetPortStr(StringViewT str)
    {
        SetImpl(&ParentT::SetPort, str);
    }
    ...
    void SetPathStr(const CharT* str)
    {
        SetImpl(&ParentT::SetPath, str);
    }
    void SetPathStr(StringViewT str)
    {
        SetImpl(&ParentT::SetPath, str);
    }
    ...
    void SetQueryStr(const CharT* str)
    {
        SetImpl(&ParentT::SetQuery, str);
    }
    void SetQueryStr(StringViewT str)
    {
        SetImpl(&ParentT::SetQuery, str);
    }
    ...
    void SetRefStr(const CharT* str)
    {
        SetImpl(&ParentT::SetRef, str);
    }
    void SetRefStr(StringViewT str)
    {
        SetImpl(&ParentT::SetRef, str);
    }
