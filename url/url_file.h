...
template <typename CHAR> inline int DoesContainWindowsDriveSpecUntil(const CHAR* spec, int start_offset, int max_offset, int spec_len)
{
...
template <typename CHAR> inline bool DoesBeginWindowsDriveSpec(const CHAR* spec, int start_offset, int spec_len)
{
...
template <typename CHAR> inline bool DoesBeginUNCPath(const CHAR* text, int start_offset, int len, bool strict_slashes)
{
