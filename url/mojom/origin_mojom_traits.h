...
template <> struct COMPONENT_EXPORT(URL_MOJOM_TRAITS) StructTraits<url::mojom::OriginDataView, url::Origin> {
    ...
    static mojo::OptionalAsPointer<const base::UnguessableToken> nonce_if_opaque(const url::Origin& r)
    {
