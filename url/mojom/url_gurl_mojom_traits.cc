...
// static
std::string_view StructTraits<url::mojom::UrlDataView, GURL>::url(const GURL& r)
{
...
// static
bool StructTraits<url::mojom::UrlDataView, GURL>::Read(url::mojom::UrlDataView data, GURL* out)
{
