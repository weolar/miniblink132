...
void appendURLEscapedChar(const void* context, UConverterFromUnicodeArgs* from_args, const UChar* code_units, int32_t length, UChar32 code_point,
...
void ICUCharsetConverter::ConvertFromUTF16(const char16_t* input, int input_len, CanonOutput* output)
{
    ...
    do {
        ...
        int required_capacity = ucnv_fromUChars(converter_, dest, dest_capacity, input, input_len, &err);
