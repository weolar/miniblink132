...
public:
    ...
    static std::optional<SharedDictionaryIsolationKey> MaybeCreate(const IsolationInfo& isolation_info);
    ...
    SharedDictionaryIsolationKey(const url::Origin& frame_origin, const SchemefulSite& top_frame_site);
    ...
    SharedDictionaryIsolationKey& operator=(const SharedDictionaryIsolationKey& other);
    ...
    {
        return std::tie(frame_origin_, top_frame_site_) == std::tie(other.frame_origin_, other.top_frame_site_);
    }
    bool operator!=(const SharedDictionaryIsolationKey& other) const
    {
        return !(*this == other);
