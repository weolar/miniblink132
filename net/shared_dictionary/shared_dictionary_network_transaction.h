...
public:
    SharedDictionaryNetworkTransaction(std::unique_ptr<HttpTransaction> network_transaction, bool enable_shared_zstd);

    SharedDictionaryNetworkTransaction(const SharedDictionaryNetworkTransaction&) = delete;
    SharedDictionaryNetworkTransaction& operator=(const SharedDictionaryNetworkTransaction&) = delete;
...
private:
    ...
    public:
        PendingReadTask(IOBuffer* buf, int buf_len, CompletionOnceCallback callback);
    ...
    SharedDictionaryEncodingType ParseSharedDictionaryEncodingType(const HttpResponseHeaders& headers);

    void OnStartCompleted(CompletionOnceCallback callback, int result);

    void ModifyRequestHeaders(const GURL& request_url, HttpRequestHeaders* request_headers);
    ...
    SharedDictionaryEncodingType shared_dictionary_encoding_type_ = SharedDictionaryEncodingType::kNotUsed;
    ...
    base::RepeatingCallback<scoped_refptr<SharedDictionary>()> shared_dictionary_getter_;
