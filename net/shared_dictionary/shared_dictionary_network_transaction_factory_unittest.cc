...
public:
    ...
    DummyHttpTransactionFactory& operator=(const DummyHttpTransactionFactory&) = delete;
    ...
    bool create_transaction_called() const
    {
        return create_transaction_called_;
    }
    bool get_cache_called() const
    {
        return get_cache_called_;
    }
    bool get_session_called() const
    {
        return get_session_called_;
    }
...
TEST(SharedDictionaryNetworkTransactionFactoryTest, CreateTransaction)
{
    ...
    SharedDictionaryNetworkTransactionFactory factory = SharedDictionaryNetworkTransactionFactory(std::move(dummy_factory),
...
TEST(SharedDictionaryNetworkTransactionFactoryTest, CreateTransactionFailure)
{
    ...
    std::unique_ptr<HttpTransaction> transaction;
    EXPECT_EQ(ERR_FAILED, factory.CreateTransaction(DEFAULT_PRIORITY, &transaction));
