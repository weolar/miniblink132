...
public:
    StaticHttpUserAgentSettings(const std::string& accept_language, const std::string& user_agent);

    StaticHttpUserAgentSettings(const StaticHttpUserAgentSettings&) = delete;
    StaticHttpUserAgentSettings& operator=(const StaticHttpUserAgentSettings&) = delete;
