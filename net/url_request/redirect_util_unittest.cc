...
TEST(RedirectUtilTest, UpdateHttpRequest)
{
    ...
    const TestCase kTests[] = {
        {
            "POST" /* original_method */, "POST" /* new_method */, "https://www.example.com/redirected.php" /* new_url */,
            { { "Header1", "Value1" }, { "Header2", "Value2" } } /* modified_headers */, false /* expected_should_clear_upload */,
            "https://origin.example.com" /* expected_origin_header */
        },
        {
            "POST" /* original_method */, "GET" /* new_method */, "https://www.example.com/redirected.php" /* new_url */,
            { { "Header1", "Value1" }, { "Header2", "Value2" } } /* modified_headers */, true /* expected_should_clear_upload */,
            std::nullopt /* expected_origin_header */
        },
        {
            "POST" /* original_method */, "POST" /* new_method */, "https://other.example.com/redirected.php" /* new_url */,
            { { "Header1", "Value1" }, { "Header2", "Value2" } } /* modified_headers */, false /* expected_should_clear_upload */,
            "null" /* expected_origin_header */
        },
        {
            "POST" /* original_method */, "GET" /* new_method */, "https://other.example.com/redirected.php" /* new_url */,
            { { "Header1", "Value1" }, { "Header2", "Value2" } } /* modified_headers */, true /* expected_should_clear_upload */,
            std::nullopt /* expected_origin_header */
        },
        {
            "PUT" /* original_method */, "GET" /* new_method */, "https://www.example.com/redirected.php" /* new_url */,
            { { "Header1", "Value1" }, { "Header2", "Value2" } } /* modified_headers */, true /* expected_should_clear_upload */,
            std::nullopt /* expected_origin_header */
        },
        {
            "FOOT" /* original_method */, "GET" /* new_method */, "https://www.example.com/redirected.php" /* new_url */,
            { { "Header1", "Value1" }, { "Header2", "Value2" } } /* modified_headers */, true /* expected_should_clear_upload */,
            std::nullopt /* expected_origin_header */
        },
    };
    ...
    for (const auto& test : kTests) {
        SCOPED_TRACE(::testing::Message() << "original_method: " << test.original_method << " new_method: " << test.new_method << " new_url: " << test.new_url);
        ...
        std::optional<std::string> expected_modified_header1 = modified_headers.GetHeader("Header1");
        std::optional<std::string> expected_modified_header2 = modified_headers.GetHeader("Header2");

        HttpRequestHeaders request_headers;
        request_headers.SetHeader(HttpRequestHeaders::kOrigin, "https://origin.example.com");
        request_headers.SetHeader(HttpRequestHeaders::kContentLength, kContentLengthValue);
        request_headers.SetHeader(HttpRequestHeaders::kContentType, kContentTypeValue);
        ...
        RedirectUtil::UpdateHttpRequest(
            original_url, test.original_method, redirect_info, std::nullopt /* removed_headers */, modified_headers, &request_headers, &should_clear_upload);
        ...
        EXPECT_EQ(request_headers.GetHeader(HttpRequestHeaders::kContentLength), expected_content_length);
        EXPECT_EQ(request_headers.GetHeader(HttpRequestHeaders::kContentType), expected_content_type);
        EXPECT_EQ(request_headers.GetHeader(kContentEncoding), expected_content_encoding);
        EXPECT_EQ(request_headers.GetHeader(kContentLanguage), expected_content_language);
        EXPECT_EQ(request_headers.GetHeader(kContentLocation), expected_content_location);

        EXPECT_EQ(kCustomHeaderValue, request_headers.GetHeader(kCustomHeader));

        EXPECT_EQ(request_headers.GetHeader(HttpRequestHeaders::kOrigin), test.expected_origin_header);
...
TEST(RedirectUtilTest, RemovedHeaders)
{
    ...
    for (const auto& test : kTests) {
        ...
        RedirectUtil::UpdateHttpRequest(GURL(), // original_url
            ...
            RedirectInfo(), removed_headers, modified_headers, &initial_headers, &should_clear_upload);
