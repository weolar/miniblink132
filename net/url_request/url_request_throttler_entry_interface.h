...
class NET_EXPORT URLRequestThrottlerEntryInterface : public base::RefCountedThreadSafe<URLRequestThrottlerEntryInterface> {
public:
    URLRequestThrottlerEntryInterface() = default;

    URLRequestThrottlerEntryInterface(const URLRequestThrottlerEntryInterface&) = delete;
    URLRequestThrottlerEntryInterface& operator=(const URLRequestThrottlerEntryInterface&) = delete;
    ...
    virtual int64_t ReserveSendingTimeForNextRequest(const base::TimeTicks& earliest_time) = 0;
