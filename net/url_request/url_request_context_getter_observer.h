...
public:
    ...
    URLRequestContextGetterObserver(const URLRequestContextGetterObserver&) = delete;
    URLRequestContextGetterObserver& operator=(const URLRequestContextGetterObserver&) = delete;
