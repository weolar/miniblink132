...
class NET_EXPORT_PRIVATE URLRequestThrottlerManager : public NetworkChangeNotifier::IPAddressObserver, public NetworkChangeNotifier::ConnectionTypeObserver {
public:
    URLRequestThrottlerManager();

    URLRequestThrottlerManager(const URLRequestThrottlerManager&) = delete;
    URLRequestThrottlerManager& operator=(const URLRequestThrottlerManager&) = delete;
    ...
    // informations.
    scoped_refptr<URLRequestThrottlerEntryInterface> RegisterRequestUrl(const GURL& url);
    ...
    void OverrideEntryForTests(const GURL& url, scoped_refptr<URLRequestThrottlerEntry> entry);
...
private:
    ...
    typedef std::map<std::string, scoped_refptr<URLRequestThrottlerEntry>> UrlEntryMap;
