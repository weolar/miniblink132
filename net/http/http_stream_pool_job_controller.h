...
class HttpStreamPool::JobController : public HttpStreamPool::Job::Delegate, public HttpStreamRequest::Helper {
public:
...
private:
    ...
    // the request.
    void CallRequestComplete(std::unique_ptr<HttpStream> stream, NextProto negotiated_protocol);
