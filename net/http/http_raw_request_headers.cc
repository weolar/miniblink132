...
HttpRawRequestHeaders& HttpRawRequestHeaders::operator=(HttpRawRequestHeaders&&) = default;
HttpRawRequestHeaders::~HttpRawRequestHeaders() = default;
...
bool HttpRawRequestHeaders::FindHeaderForTest(std::string_view key, std::string* value) const
{
