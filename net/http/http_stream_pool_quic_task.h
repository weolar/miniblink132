...
public:
    ...
    std::optional<int> start_result() const
    {
...
private:
    ...
    std::optional<QuicEndpoint> GetQuicEndpointFromServiceEndpoint(const ServiceEndpoint& service_endpoint, bool svcb_optional);
    std::optional<IPEndPoint> GetPreferredIPEndPoint(const std::vector<IPEndPoint>& ip_endpoints);
