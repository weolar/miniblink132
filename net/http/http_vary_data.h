...
public:
    ...
    //
    bool Init(const HttpRequestInfo& request_info, const HttpResponseHeaders& response_headers);
    ...
    bool MatchesRequest(const HttpRequestInfo& request_info, const HttpResponseHeaders& cached_response_headers) const;

private:
    // Append to the MD5 context for the given request header.
    static void AddField(const HttpRequestInfo& request_info, std::string_view request_header, base::MD5Context* context);
