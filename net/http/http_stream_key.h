...
public:
    HttpStreamKey();
    HttpStreamKey(url::SchemeHostPort destination, PrivacyMode privacy_mode, SocketTag socket_tag, NetworkAnonymizationKey network_anonymization_key,
    ...
    QuicSessionAliasKey CalculateQuicSessionAliasKey(std::optional<url::SchemeHostPort> optional_alias_name = std::nullopt) const;
