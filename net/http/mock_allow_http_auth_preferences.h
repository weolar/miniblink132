...
public:
    ...
    MockAllowHttpAuthPreferences& operator=(const MockAllowHttpAuthPreferences&) = delete;
    ...
    HttpAuth::DelegationType GetDelegationType(const url::SchemeHostPort& auth_scheme_host_port) const override;
};
