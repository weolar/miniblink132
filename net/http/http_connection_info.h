...
NET_EXPORT std::string_view HttpConnectionInfoToString(HttpConnectionInfo connection_info);

NET_EXPORT std::string_view HttpConnectionInfoCoarseToString(HttpConnectionInfoCoarse http_connection_info_coarse);

// Returns a more coarse-grained description of the protocol used to fetch the
// response.
NET_EXPORT HttpConnectionInfoCoarse HttpConnectionInfoToCoarse(HttpConnectionInfo info);
