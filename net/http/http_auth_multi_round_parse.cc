...
bool SchemeIsValid(HttpAuth::Scheme scheme, HttpAuthChallengeTokenizer* challenge)
{
...
HttpAuth::AuthorizationResult ParseFirstRoundChallenge(HttpAuth::Scheme scheme, HttpAuthChallengeTokenizer* challenge)
{
...
HttpAuth::AuthorizationResult ParseLaterRoundChallenge(
    HttpAuth::Scheme scheme, HttpAuthChallengeTokenizer* challenge, std::string* encoded_token, std::string* decoded_token)
{
    if (!SchemeIsValid(scheme, challenge))
        return HttpAuth::AUTHORIZATION_RESULT_INVALID;
