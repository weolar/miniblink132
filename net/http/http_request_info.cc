...
HttpRequestInfo& HttpRequestInfo::operator=(const HttpRequestInfo& other) = default;
...
{
    return network_anonymization_key == NetworkAnonymizationKey::CreateFromNetworkIsolationKey(network_isolation_key);
}
