...
public:
    ...
    static HttpNoVarySearchData CreateFromNoVaryParams(const std::vector<std::string>& no_vary_params, bool vary_on_key_order);
    static HttpNoVarySearchData CreateFromVaryParams(const std::vector<std::string>& vary_params, bool vary_on_key_order);
    ...
    static base::expected<HttpNoVarySearchData, HttpNoVarySearchData::ParseErrorEnum> ParseFromHeaders(const HttpResponseHeaders& response_headers);
...
private:
    ...
    static base::expected<HttpNoVarySearchData, HttpNoVarySearchData::ParseErrorEnum> ParseNoVarySearchDictionary(const structured_headers::Dictionary& dict);
