...
class NET_EXPORT TransportSecurityPersister : public TransportSecurityState::Delegate, public base::ImportantFileWriter::DataSerializer {
public:
    ...
    TransportSecurityPersister& operator=(const TransportSecurityPersister&) = delete;
    ...
    void WriteNow(TransportSecurityState* state, base::OnceClosure callback) override;
...
private:
    ...
    static void Deserialize(const std::string& serialized, TransportSecurityState* state, bool& contains_legacy_expect_ct_data);
