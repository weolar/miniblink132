...
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_USED, base::StrCat({ kHttps, kPattern1, kRoboto }));
...
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_NOT_IN_CACHE, base::StrCat({ kHttp, kPattern2, kOpenSans }));
    histograms.ExpectTotalCount(kRobotoHistogramName, 0);
    histograms.ExpectUniqueSample(kOpenSansHistogramName, 2 /* ENTRY_NOT_IN_CACHE */, 1);
    histograms.ExpectTotalCount(kOthersHistogramName, 0);
}
...
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_CANT_CONDITIONALIZE, base::StrCat({ kHttps, kPattern3 }));
    histograms.ExpectTotalCount(kRobotoHistogramName, 0);
    histograms.ExpectTotalCount(kOpenSansHistogramName, 0);
    histograms.ExpectUniqueSample(kOthersHistogramName, 6 /* ENTRY_CANT_CONDITIONALIZE */, 1);
}

TEST(WebfontsHistogramTest, ArbitraryFont_RecordOthers)
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_OTHER, base::StrCat({ kHttps, kPattern2, "abc" }));
    histograms.ExpectTotalCount(kRobotoHistogramName, 0);
    histograms.ExpectTotalCount(kOpenSansHistogramName, 0);
...
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_USED, base::StrCat({ kHttps, kPattern1, kRoboto, "abc" }));
    histograms.ExpectUniqueSample(kRobotoHistogramName, 3 /* ENTRY_USED */, 1);
    histograms.ExpectTotalCount(kOpenSansHistogramName, 0);
    histograms.ExpectTotalCount(kOthersHistogramName, 0);
}
...
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_USED, base::StrCat({ "abc", kHttps, kPattern1, kRoboto }));
    histograms.ExpectTotalCount(kRobotoHistogramName, 0);
    histograms.ExpectTotalCount(kOpenSansHistogramName, 0);
    histograms.ExpectTotalCount(kOthersHistogramName, 0);
}
...
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_OTHER, base::StrCat({ "ftp://", kPattern1, kRoboto }));
    histograms.ExpectTotalCount(kRobotoHistogramName, 0);
    histograms.ExpectTotalCount(kOpenSansHistogramName, 0);
    histograms.ExpectTotalCount(kOthersHistogramName, 0);
}
...
{
    base::HistogramTester histograms;
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_USED, base::StrCat({ kHttps, "fonts.gstatic.com//s/", kRoboto }));
    histograms.ExpectTotalCount(kRobotoHistogramName, 0);
    histograms.ExpectTotalCount(kOpenSansHistogramName, 0);
    histograms.ExpectTotalCount(kOthersHistogramName, 0);
}
...
TEST(WebfontsHistogramTest, TwoRobotoSameBucket_TwoOpenSansDifferentBucket)
{
    ...
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_USED, base::StrCat({ kHttps, kPattern2, kRoboto }));
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_USED, base::StrCat({ kHttp, kPattern3, kRoboto }));
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_USED, base::StrCat({ kHttps, kPattern2, kOpenSans }));
    MaybeRecordCacheStatus(HttpResponseInfo::ENTRY_OTHER, base::StrCat({ kHttp, kPattern3, kOpenSans }));
