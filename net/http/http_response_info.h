...
public:
    ...
    void Persist(base::Pickle* pickle, bool skip_transient_headers, bool response_truncated) const;
    ...
    // semantics.
    AlternateProtocolUsage alternate_protocol_usage = AlternateProtocolUsage::ALTERNATE_PROTOCOL_USAGE_UNSPECIFIED_REASON;
