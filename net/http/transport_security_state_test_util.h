...
public:
    ...
    ScopedTransportSecurityStateSource(const ScopedTransportSecurityStateSource&) = delete;
    ScopedTransportSecurityStateSource& operator=(const ScopedTransportSecurityStateSource&) = delete;
