...
public:
    ...
    void set_start_result(int start_result)
    {
        start_result_ = start_result;
    }

    FakeServiceEndpointRequest& set_endpoints(std::vector<ServiceEndpoint> endpoints)
    {
    ...
    FakeServiceEndpointRequest& set_resolve_error_info(ResolveErrorInfo resolve_error_info)
    {
...
public:
    ...
    FakeServiceEndpointResolver& operator=(const FakeServiceEndpointResolver&) = delete;
...
public:
    ...
    ServiceEndpointBuilder& set_ech_config_list(std::vector<uint8_t> ech_config_list);
...
public:
    ...
    void set_was_ever_used(bool was_ever_used)
    {
        was_ever_used_ = was_ever_used;
    }

    void set_peer_addr(IPEndPoint peer_addr)
    {
        peer_addr_ = peer_addr;
    }

    void set_ssl_info(SSLInfo ssl_info)
    {
