...
public:
    ...
    static HttpByteRange Bounded(int64_t first_byte_position, int64_t last_byte_position);
    ...
    void set_first_byte_position(int64_t value)
    {
        first_byte_position_ = value;
    }

    int64_t last_byte_position() const
    {
        return last_byte_position_;
    }
    void set_last_byte_position(int64_t value)
    {
        last_byte_position_ = value;
    }
    ...
    void set_suffix_length(int64_t value)
    {
        suffix_length_ = value;
    }
