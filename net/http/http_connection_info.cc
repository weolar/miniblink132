...
std::string_view HttpConnectionInfoToString(HttpConnectionInfo connection_info)
{
...
std::string_view HttpConnectionInfoCoarseToString(HttpConnectionInfoCoarse connection_info_coarse)
{
