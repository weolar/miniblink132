...
// HttpNetworkSession.
class NET_EXPORT BidirectionalStream : public BidirectionalStreamImpl::Delegate, public HttpStreamRequest::Delegate {
public:
    ...
    public:
        ...
        virtual void OnTrailersReceived(const quiche::HttpHeaderBlock& trailers) = 0;
    ...
    BidirectionalStream(std::unique_ptr<BidirectionalStreamRequestInfo> request_info, HttpNetworkSession* session, bool send_request_headers_automatically,
        Delegate* delegate, std::unique_ptr<base::OneShotTimer> timer);
