...
public:
    ...
    virtual bool IsValid(const url::SchemeHostPort& scheme_host_port, HttpAuth::Target target) const = 0;
};
...
public:
    ...
    bool IsValid(const url::SchemeHostPort& scheme_host_port, HttpAuth::Target target) const override;
