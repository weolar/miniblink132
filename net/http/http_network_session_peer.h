...
public:
    ...
    void SetClientSocketPoolManager(std::unique_ptr<ClientSocketPoolManager> socket_pool_manager);

    void SetHttpStreamFactory(std::unique_ptr<HttpStreamFactory> http_stream_factory);
