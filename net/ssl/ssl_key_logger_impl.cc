...
// SequencedTaskRunner.
class SSLKeyLoggerImpl::Core : public base::RefCountedThreadSafe<SSLKeyLoggerImpl::Core> {
public:
    Core()
    {
        ...
        task_runner_ = base::ThreadPool::CreateSequencedTaskRunner({ base::MayBlock(), base::TaskShutdownBehavior::CONTINUE_ON_SHUTDOWN });
    }
    ...
    {
        task_runner_->PostTask(FROM_HERE, base::BindOnce(&Core::OpenFileImpl, this, path));
    }
