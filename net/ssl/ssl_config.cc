...
SSLConfig::CertAndStatus::CertAndStatus(scoped_refptr<X509Certificate> cert_arg, CertStatus status)
...
bool SSLConfig::IsAllowedBadCert(X509Certificate* cert, CertStatus* cert_status) const
{
