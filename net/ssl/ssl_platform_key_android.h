...
// object.
NET_EXPORT scoped_refptr<SSLPrivateKey> WrapJavaPrivateKey(const X509Certificate* cert, const base::android::JavaRef<jobject>& key);
...
NET_EXPORT std::vector<std::string> SignatureAlgorithmsToJavaKeyTypes(base::span<const uint16_t> algorithms);
