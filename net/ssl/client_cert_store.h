...
public:
    ...
    using ClientCertListCallback = base::OnceCallback<void(ClientCertIdentityList)>;
    ...
    virtual void GetClientCerts(scoped_refptr<const SSLCertRequestInfo> cert_request_info, ClientCertListCallback callback) = 0;
