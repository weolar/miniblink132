...
class OpenSSLPrivateKeyTest : public testing::TestWithParam<TestKey>, public WithTaskEnvironment { };
...
TEST_P(OpenSSLPrivateKeyTest, KeyMatches)
{
    ...
    scoped_refptr<SSLPrivateKey> private_key = WrapOpenSSLPrivateKey(std::move(openssl_key));
    ASSERT_TRUE(private_key);
    net::TestSSLPrivateKeyMatches(private_key.get(), pkcs8);
}

INSTANTIATE_TEST_SUITE_P(All, OpenSSLPrivateKeyTest, testing::ValuesIn(kTestKeys), TestKeyToString);
