...
public:
    ...
    virtual bool CanShareConnectionWithClientCerts(std::string_view hostname) const = 0;
...
protected:
    ...
    void ProcessConfigUpdate(const SSLContextConfig& orig_config, const SSLContextConfig& new_config, bool force_notification);
