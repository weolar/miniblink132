...
TEST(SSLConnectionStatusTest, SetVersion)
{
    ...
    EXPECT_EQ(SSL_CONNECTION_VERSION_TLS1_2, SSLConnectionStatusToVersion(connection_status));
    EXPECT_EQ(expected_cipher_suite, SSLConnectionStatusToCipherSuite(connection_status));
}
