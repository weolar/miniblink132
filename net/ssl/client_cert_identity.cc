...
void IdentityOwningPrivateKeyCallback(std::unique_ptr<ClientCertIdentity> identity, base::OnceCallback<void(scoped_refptr<SSLPrivateKey>)> private_key_callback,
...
void ClientCertIdentity::SelfOwningAcquirePrivateKey(
    std::unique_ptr<ClientCertIdentity> self, base::OnceCallback<void(scoped_refptr<SSLPrivateKey>)> private_key_callback)
{
...
void ClientCertIdentity::SetIntermediates(std::vector<bssl::UniquePtr<CRYPTO_BUFFER>> intermediates)
{
...
bool ClientCertIdentitySorter::operator()(const std::unique_ptr<ClientCertIdentity>& a_identity, const std::unique_ptr<ClientCertIdentity>& b_identity) const
{
