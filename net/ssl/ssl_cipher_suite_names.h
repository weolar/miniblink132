...
NET_EXPORT void SSLCipherSuiteToStrings(
    const char** key_exchange_str, const char** cipher_str, const char** mac_str, bool* is_aead, bool* is_tls13, uint16_t cipher_suite);
...
// list.
NET_EXPORT bool ParseSSLCipherString(const std::string& cipher_string, uint16_t* cipher_suite);
...
NET_EXPORT int ObsoleteSSLStatus(int connection_status, uint16_t signature_algorithm);
