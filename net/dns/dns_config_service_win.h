...
std::vector<std::string> NET_EXPORT_PRIVATE ParseSearchList(std::wstring_view value);
...
base::expected<DnsConfig, ReadWinSystemDnsSettingsError> NET_EXPORT_PRIVATE ConvertSettingsToDnsConfig(
