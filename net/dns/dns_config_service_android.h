...
class NET_EXPORT_PRIVATE DnsConfigServiceAndroid : public DnsConfigService, public NetworkChangeNotifier::NetworkChangeObserver {
public:
    ...
    void set_dns_server_getter_for_testing(android::DnsServerGetter dns_server_getter)
    {
