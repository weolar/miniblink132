...
public:
    HostResolverNat64Task(std::string_view hostname, NetworkAnonymizationKey network_anonymization_key, NetLogWithSource net_log,
...
private:
    ...
    HostCache::Entry results_ = HostCache::Entry(ERR_FAILED, HostCache::Entry::SOURCE_UNKNOWN);
