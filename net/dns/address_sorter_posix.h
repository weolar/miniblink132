...
class NET_EXPORT_PRIVATE AddressSorterPosix : public AddressSorter, public NetworkChangeNotifier::IPAddressObserver {
public:
...
private:
    ...
    mutable std::set<std::unique_ptr<SortContext>, base::UniquePtrComparator> sort_contexts_;
