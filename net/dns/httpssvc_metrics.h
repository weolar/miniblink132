...
public:
    ...
    void SaveForAddressQuery(base::TimeDelta resolve_time, enum HttpssvcDnsRcode rcode);
    ...
    void SaveForHttps(enum HttpssvcDnsRcode rcode, const std::vector<bool>& condensed_records, base::TimeDelta https_resolve_time);
