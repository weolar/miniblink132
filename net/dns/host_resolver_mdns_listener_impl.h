...
class HostResolverMdnsListenerImpl : public HostResolver::MdnsListener, public net::MDnsListener::Delegate {
public:
    using Delegate = HostResolver::MdnsListener::Delegate;

    HostResolverMdnsListenerImpl(const HostPortPair& query_host, DnsQueryType query_type);
    ...
    void OnRecordUpdate(net::MDnsListener::UpdateType update, const RecordParsed* record) override;
