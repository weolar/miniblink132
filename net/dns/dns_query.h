...
public:
    ...
    DnsQuery(uint16_t id, base::span<const uint8_t> qname, uint16_t qtype, const OptRecordRdata* opt_rdata = nullptr,
...
private:
    ...
    bool ReadHeader(base::SpanReader<const uint8_t>* reader, dns_protocol::Header* out);
