...
public:
    ...
    static std::unique_ptr<SrvRecordRdata> Create(std::string_view data, const DnsRecordParser& parser);
...
public:
    ...
    static std::unique_ptr<ARecordRdata> Create(std::string_view data, const DnsRecordParser& parser);
    bool IsEqual(const RecordRdata* other) const override;
    uint16_t Type() const override;
...
public:
    ...
    static std::unique_ptr<AAAARecordRdata> Create(std::string_view data, const DnsRecordParser& parser);
    bool IsEqual(const RecordRdata* other) const override;
    uint16_t Type() const override;
...
public:
    ...
    static std::unique_ptr<CnameRecordRdata> Create(std::string_view data, const DnsRecordParser& parser);
    bool IsEqual(const RecordRdata* other) const override;
    uint16_t Type() const override;
...
public:
    ...
    static std::unique_ptr<PtrRecordRdata> Create(std::string_view data, const DnsRecordParser& parser);
    bool IsEqual(const RecordRdata* other) const override;
    uint16_t Type() const override;

    std::string ptrdomain() const
    {
        return ptrdomain_;
    }
...
public:
    ...
    static std::unique_ptr<TxtRecordRdata> Create(std::string_view data, const DnsRecordParser& parser);
    bool IsEqual(const RecordRdata* other) const override;
    uint16_t Type() const override;
...
public:
    ...
    static std::unique_ptr<NsecRecordRdata> Create(std::string_view data, const DnsRecordParser& parser);
    bool IsEqual(const RecordRdata* other) const override;
    uint16_t Type() const override;
