...
public:
    using CallbackType = base::OnceCallback<void(bool success, std::vector<IPEndPoint> sorted)>;
    ...
    virtual void Sort(const std::vector<IPEndPoint>& endpoints, CallbackType callback) const = 0;
