...
using DnsQueryTypeSet = base::EnumSet<DnsQueryType, DnsQueryType::UNSPECIFIED, DnsQueryType::MAX>;

inline constexpr auto kDnsQueryTypes = base::MakeFixedFlatMap<DnsQueryType, std::string_view>(
    { { DnsQueryType::UNSPECIFIED, "UNSPECIFIED" }, { DnsQueryType::A, "A" }, { DnsQueryType::AAAA, "AAAA" }, { DnsQueryType::TXT, "TXT" },
        { DnsQueryType::PTR, "PTR" }, { DnsQueryType::SRV, "SRV" }, { DnsQueryType::HTTPS, "HTTPS" } });
