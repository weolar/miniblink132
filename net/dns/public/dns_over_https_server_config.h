...
public:
    ...
    static std::optional<DnsOverHttpsServerConfig> FromString(std::string doh_template, Endpoints endpoints = {});

    static std::optional<DnsOverHttpsServerConfig> FromValue(base::Value::Dict value);
...
private:
    DnsOverHttpsServerConfig(std::string server_template, bool use_post, Endpoints endpoints);
