...
TEST(WinDnsSystemSettings, GetAllNameServersEmpty)
{
    ...
    std::optional<std::vector<IPEndPoint>> nameservers = settings.GetAllNameservers();
...
{
    AdapterInfo infos[3] = { { .if_type = IF_TYPE_USB,
                                 .oper_status = IfOperStatusUp,
                                 .dns_suffix = L"example.com",
        ...
        { .if_type = IF_TYPE_USB,
            .oper_status = IfOperStatusUp,
            .dns_suffix = L"foo.bar",
            .dns_server_addresses = { "2001:ffff::1111", "aaaa:bbbb:cccc:dddd:eeee:ffff:0:1" },
            .ports = { 33, 44 } },
        { 0 } };
    ...
    EXPECT_EQ(nameservers.value()[3].ToString(), "[aaaa:bbbb:cccc:dddd:eeee:ffff:0:1]:44");
}
} // namespace
