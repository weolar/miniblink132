...
bool IsAddressType(DnsQueryType dns_query_type)
{
    ...
    return dns_query_type == DnsQueryType::UNSPECIFIED || dns_query_type == DnsQueryType::A || dns_query_type == DnsQueryType::AAAA;
}
...
bool HasAddressType(DnsQueryTypeSet dns_query_types)
{
    ...
    return dns_query_types.Has(DnsQueryType::A) || dns_query_types.Has(DnsQueryType::AAAA);
}
