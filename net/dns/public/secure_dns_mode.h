...
inline constexpr auto kSecureDnsModes = base::MakeFixedFlatMap<SecureDnsMode, std::string_view>(
    { { SecureDnsMode::kOff, "Off" }, { SecureDnsMode::kAutomatic, "Automatic" }, { SecureDnsMode::kSecure, "Secure" } });
