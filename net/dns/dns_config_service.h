...
protected:
    ...
    public:
        ...
        HostsReader(base::FilePath::StringPieceType hosts_file_path, DnsConfigService& service);
    ...
    protected:
        ...
        bool OnWorkFinished(std::unique_ptr<SerialWorker::WorkItem> work_item) final;
    ...
    explicit DnsConfigService(base::FilePath::StringPieceType hosts_file_path, std::optional<base::TimeDelta> config_change_delay = base::Milliseconds(50));
