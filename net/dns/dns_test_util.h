...
static const char kT0DnsName[] = { 0x03, 'w', 'w', 'w', 0x06, 'g', 'o', 'o', 'g', 'l', 'e', 0x03, 'c', 'o', 'm', 0x00 };
...
static const uint8_t kT0ResponseDatagram[] = {
    ...
    
};
static const char* const kT0IpAddresses[] = { "74.125.226.179", "74.125.226.180", "74.125.226.176", "74.125.226.177", "74.125.226.178" };
...
static const char kT1DnsName[]
    = { 0x0a, 'c', 'o', 'd', 'e', 'r', 'e', 'v', 'i', 'e', 'w', 0x08, 'c', 'h', 'r', 'o', 'm', 'i', 'u', 'm', 0x03, 'o', 'r', 'g', 0x00 };
...
static const uint8_t kT1ResponseDatagram[] = {
    ...
    0x00, 0x01, 0x81, 0x80, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x63, 0x6f, 0x64, 0x65, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x08, 0x63, 0x68,
    0x72, 0x6f, 0x6d, 0x69, 0x75, 0x6d, 0x03, 0x6f, 0x72, 0x67, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00, 0x05, 0x00, 0x01, 0x00, 0x01, 0x41, 0x75, 0x00,
    0x12, 0x03, 0x67, 0x68, 0x73, 0x01, 0x6c, 0x06, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x03, 0x63, 0x6f, 0x6d, 0x00, 0xc0, 0x35, 0x00, 0x01, 0x00, 0x01, 0x00,
    0x00, 0x01, 0x0b, 0x00, 0x04, 0x40, 0xe9, 0xa9, 0x79
};
...
static const char kT2DnsName[] = { 0x03, 'w', 'w', 'w', 0x03, 'c', 'c', 's', 0x03, 'n', 'e', 'u', 0x03, 'e', 'd', 'u', 0x00 };
...
static const uint8_t kT2ResponseDatagram[] = {
    ...
    0x00, 0x02, 0x81, 0x80, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x03, 0x77, 0x77, 0x77, 0x03, 0x63, 0x63, 0x73, 0x03, 0x6e, 0x65, 0x75, 0x03, 0x65,
    0x64, 0x75, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00, 0x05, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2c, 0x00, 0x09, 0x06, 0x76, 0x75, 0x6c, 0x63, 0x61, 0x6e,
    0xc0, 0x10, 0xc0, 0x2d, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2c, 0x00, 0x04, 0x81, 0x0a, 0x74, 0x51
};
...
static const char kT3DnsName[] = { 0x03, 'w', 'w', 'w', 0x06, 'g', 'o', 'o', 'g', 'l', 'e', 0x02, 'a', 'z', 0x00 };
...
static const uint8_t kT3ResponseDatagram[] = {
    ...
    
};
static const char* const kT3IpAddresses[] = { "74.125.226.178", "74.125.226.179", "74.125.226.180", "74.125.226.176", "74.125.226.177" };
...
static const char kT4DnsName[] = { 0x03, 'w', 'w', 'w', 0x07, 'g', 's', 't', 'a', 't', 'i', 'c', 0x03, 'c', 'o', 'm', 0x00 };
...
static const uint8_t kT4ResponseDatagram[] = {
    ...
    0x00, 0x00, 0x81, 0x80, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x03, 0x77, 0x77, 0x77, 0x07, 0x67, 0x73, 0x74, 0x61, 0x74, 0x69, 0x63, 0x03, 0x63,
    0x6f, 0x6d, 0x00, 0x00, 0x01, 0x00, 0x01, 0xc0, 0x0c, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x01, 0x2b, 0x00, 0x04, 0xac, 0xd9, 0x06, 0xc3
};
...
DnsResourceRecord BuildTestDnsRecord(std::string name, uint16_t type, std::string rdata, base::TimeDelta ttl = base::Days(1));

DnsResourceRecord BuildTestCnameRecord(std::string name, std::string_view canonical_name, base::TimeDelta ttl = base::Days(1));

DnsResourceRecord BuildTestAddressRecord(std::string name, const IPAddress& ip, base::TimeDelta ttl = base::Days(1));

DnsResourceRecord BuildTestTextRecord(std::string name, std::vector<std::string> text_strings, base::TimeDelta ttl = base::Days(1));

DnsResourceRecord BuildTestHttpsAliasRecord(std::string name, std::string_view alias_name, base::TimeDelta ttl = base::Days(1));
...
DnsResourceRecord BuildTestHttpsServiceRecord(
    std::string name, uint16_t priority, std::string_view service_name, const std::map<uint16_t, std::string>& params, base::TimeDelta ttl = base::Days(1));

DnsResponse BuildTestDnsResponse(std::string name, uint16_t type, const std::vector<DnsResourceRecord>& answers,
    const std::vector<DnsResourceRecord>& authority = {}, const std::vector<DnsResourceRecord>& additional = {}, uint8_t rcode = dns_protocol::kRcodeNOERROR);
...
struct MockDnsClientRule {
    ...
    struct Result {
        explicit Result(ResultType type, std::optional<DnsResponse> response = std::nullopt, std::optional<int> net_error = std::nullopt);
    ...
    MockDnsClientRule(const std::string& prefix, uint16_t qtype, bool secure, Result result, bool delay, URLRequestContext* context = nullptr);
...
public:
    ...
    std::unique_ptr<DnsTransaction> CreateTransaction(std::string hostname, uint16_t qtype, const NetLogWithSource&, bool secure, SecureDnsMode secure_dns_mode,
        ResolveContext* resolve_context, bool fast_timeout) override;
    ...
    bool doh_probes_running()
    {
        return !running_doh_probe_runners_.empty();
    }
    void CompleteDohProbeRuners()
    {
        running_doh_probe_runners_.clear();
    }
...
private:
    ...
    std::set<raw_ptr<MockDohProbeRunner, SetExperimental>> running_doh_probe_runners_;
...
public:
    ...
    bool FallbackFromSecureTransactionPreferred(ResolveContext* resolve_context) const override;
    ...
    void SetTransactionFactoryForTesting(std::unique_ptr<DnsTransactionFactory> factory) override;
    void SetAddressSorterForTesting(std::unique_ptr<AddressSorter> address_sorter) override;
    std::optional<std::vector<IPEndPoint>> GetPresetAddrs(const url::SchemeHostPort& endpoint) const override;
    ...
    MockDnsTransactionFactory* factory()
    {
        return factory_.get();
    }
...
public:
    struct ResolveKey {
        ResolveKey(const std::string& hostname, AddressFamily address_family, HostResolverFlags flags)
            : hostname(hostname)
        ...
        {
            return std::tie(address_family, hostname, flags) < std::tie(other.address_family, other.hostname, other.flags);
        }
        std::string hostname;
    ...
    void AddRule(const std::string& hostname, AddressFamily family, const AddressList& result, HostResolverFlags flags = 0);

    void AddRule(
        const std::string& hostname, AddressFamily family, const std::string& ip_list, HostResolverFlags flags = 0, const std::string& canonical_name = "");

    void AddRuleForAllFamilies(const std::string& hostname, const std::string& ip_list, HostResolverFlags flags = 0, const std::string& canonical_name = "");

    int Resolve(
        const std::string& hostname, AddressFamily address_family, HostResolverFlags host_resolver_flags, AddressList* addrlist, int* os_error) override;
