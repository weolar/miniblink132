...
TestDnsConfigService::TestDnsConfigService()
    : DnsConfigService(base::FilePath::StringPieceType() /* hosts_file_path */, std::nullopt /* config_change_delay */)
{
}
...
HostsReadingTestDnsConfigService::HostsReadingTestDnsConfigService(HostsParserFactory hosts_parser_factory)
    : hosts_reader_(std::make_unique<HostsReader>(*this, std::move(hosts_parser_factory)))
{
}
...
HostsReadingTestDnsConfigService::HostsReader::HostsReader(TestDnsConfigService& service, HostsParserFactory hosts_parser_factory)
    : DnsConfigService::HostsReader(
        /*hosts_file_path=*/base::FilePath::StringPieceType(), service)
...
std::unique_ptr<SerialWorker::WorkItem> HostsReadingTestDnsConfigService::HostsReader::CreateWorkItem()
{
...
void HostsReadingTestDnsConfigService::Watcher::TriggerHostsChangeNotification(bool success)
{
