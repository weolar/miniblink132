...
public:
    ...
    SystemDnsConfigChangeNotifier(scoped_refptr<base::SequencedTaskRunner> task_runner, std::unique_ptr<DnsConfigService> dns_config_service);

    SystemDnsConfigChangeNotifier(const SystemDnsConfigChangeNotifier&) = delete;
    SystemDnsConfigChangeNotifier& operator=(const SystemDnsConfigChangeNotifier&) = delete;
