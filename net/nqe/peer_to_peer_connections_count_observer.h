...
public:
    PeerToPeerConnectionsCountObserver(const PeerToPeerConnectionsCountObserver&) = delete;
    PeerToPeerConnectionsCountObserver& operator=(const PeerToPeerConnectionsCountObserver&) = delete;
