...
public:
    ...
    public:
        NetworkQualitiesCacheObserver(const NetworkQualitiesCacheObserver&) = delete;
        NetworkQualitiesCacheObserver& operator=(const NetworkQualitiesCacheObserver&) = delete;
        ...
        virtual void OnChangeInCachedNetworkQuality(
            const nqe::internal::NetworkID& network_id, const nqe::internal::CachedNetworkQuality& cached_network_quality)
            = 0;
    ...
    // |network_id|.
    void Add(const nqe::internal::NetworkID& network_id, const nqe::internal::CachedNetworkQuality& cached_network_quality);
    ...
    // the estimate read.
    bool GetById(const nqe::internal::NetworkID& network_id, nqe::internal::CachedNetworkQuality* cached_network_quality) const;
    ...
    void AddNetworkQualitiesCacheObserver(NetworkQualitiesCacheObserver* observer);
    void RemoveNetworkQualitiesCacheObserver(NetworkQualitiesCacheObserver* observer);
...
private:
    ...
    void NotifyCacheObserverIfPresent(MayBeDangling<NetworkQualitiesCacheObserver> observer) const;
    ...
    // map is tiny.
    typedef std::map<nqe::internal::NetworkID, nqe::internal::CachedNetworkQuality> CachedNetworkQualities;
    ...
    base::ObserverList<NetworkQualitiesCacheObserver>::Unchecked network_qualities_cache_observer_list_;
