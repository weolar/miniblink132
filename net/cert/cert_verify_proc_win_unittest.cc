...
TEST(CertVerifyProcWinTest, ReadsAuthRootVersionSuccessfulValidation)
{
    ...
    scoped_refptr<CertVerifyProc> verify_proc = base::MakeRefCounted<CertVerifyProcWin>();
    ...
    const CertVerifyProcWin::ResultDebugData* win_debug_data = CertVerifyProcWin::ResultDebugData::Get(&verify_result);
