...
NET_EXPORT_PRIVATE bool ExtractSubjectFromDERCert(std::string_view cert, std::string_view* subject_out);
...
NET_EXPORT bool ExtractSPKIFromDERCert(std::string_view cert, std::string_view* spki_out);
...
NET_EXPORT_PRIVATE bool ExtractSubjectPublicKeyFromSPKI(std::string_view spki, std::string_view* spk_out);
...
// OCTET STRING).
NET_EXPORT bool ExtractExtensionFromDERCert(
