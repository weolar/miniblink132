...
void CertVerifyResult::Reset()
{
    ...
    scts.clear();
    policy_compliance = ct::CTPolicyCompliance::CT_POLICY_COMPLIANCE_DETAILS_NOT_AVAILABLE;
}
...
base::Value::Dict CertVerifyResult::NetLogParams(int net_error) const
{
    ...
    certificate_dict.Set("certificates", net::NetLogX509CertificateList(verified_cert.get()));
    ...
    dict.Set("ct_compliance_status", CTPolicyComplianceToString(policy_compliance));
