...
public:
    ...
    using UserSlotTrustSetting = absl::variant<UseTrustFromAllUserSlots, crypto::ScopedPK11Slot>;
...
private:
    ...
    bssl::CertificateTrust GetTrustIgnoringSystemTrust(CERTCertificate* nss_cert) const;
