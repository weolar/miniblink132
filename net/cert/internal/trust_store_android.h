...
class NET_EXPORT TrustStoreAndroid : public PlatformTrustStore, public CertDatabase::Observer {
public:
    TrustStoreAndroid();
...
private:
    ...
    bool is_observing_certdb_changes_ GUARDED_BY_CONTEXT(certdb_observer_sequence_checker_) = false;
