...
// other years.
inline constexpr base::TimeDelta kMaxRevocationIntermediateUpdateAge = base::Days(366);
...
NET_EXPORT_PRIVATE void CheckValidatedChainRevocation(const bssl::ParsedCertificateList& certs, const RevocationPolicy& policy, base::TimeTicks deadline,
...
NET_EXPORT_PRIVATE CRLSet::Result CheckChainRevocationUsingCRLSet(
    const CRLSet* crl_set, const bssl::ParsedCertificateList& certs, bssl::CertPathErrors* errors);
