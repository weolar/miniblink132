...
public:
    ...
    public:
        ...
        const std::string& ocsp_response() const
        {
    ...
    // it in this case.
    virtual int Verify(const RequestParams& params, CertVerifyResult* verify_result, CompletionOnceCallback callback, std::unique_ptr<Request>* out_req,
    ...
    static std::unique_ptr<CertVerifierWithUpdatableProc> CreateDefaultWithoutCaching(scoped_refptr<CertNetFetcher> cert_net_fetcher);

    // Wraps the result of |CreateDefaultWithoutCaching| in a CachingCertVerifier
    // and a CoalescingCertVerifier.
    static std::unique_ptr<CertVerifier> CreateDefault(scoped_refptr<CertNetFetcher> cert_net_fetcher);
};
...
// object.
NET_EXPORT bool operator==(const CertVerifier::Config& lhs, const CertVerifier::Config& rhs);
NET_EXPORT bool operator!=(const CertVerifier::Config& lhs, const CertVerifier::Config& rhs);
...
public:
    ...
    virtual void UpdateVerifyProcData(scoped_refptr<CertNetFetcher> cert_net_fetcher, const net::CertVerifyProc::ImplParams& impl_params,
