...
class NET_EXPORT CoalescingCertVerifier : public CertVerifier, public CertVerifier::Observer {
public:
    ...
    int Verify(const RequestParams& params, CertVerifyResult* verify_result, CompletionOnceCallback callback, std::unique_ptr<CertVerifier::Request>* out_req,
    ...
    uint64_t requests_for_testing() const
    {
        return requests_;
    }
    uint64_t inflight_joins_for_testing() const
    {
