...
public:
    ...
    //       signer
    Result CheckSerial(std::string_view serial_number, std::string_view issuer_spki_hash) const;
    ...
    Result CheckSubject(std::string_view asn1_subject, std::string_view spki_hash) const;
    ...
    static scoped_refptr<CRLSet> ForTesting(bool is_expired, const SHA256HashValue* issuer_spki, std::string_view serial_number,
        std::string_view utf8_common_name, const std::vector<std::string>& acceptable_spki_hashes_for_cn);
