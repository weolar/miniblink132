...
struct NET_EXPORT SignedTreeHead {
    ...
    SignedTreeHead();
    SignedTreeHead(Version version, const base::Time& timestamp, uint64_t tree_size, const char sha256_root_hash[kSthRootHashLength],
...
NET_EXPORT bool operator==(const SignedTreeHead& lhs, const SignedTreeHead& rhs);
NET_EXPORT bool operator!=(const SignedTreeHead& lhs, const SignedTreeHead& rhs);
