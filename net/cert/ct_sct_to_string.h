...
NET_EXPORT const std::string HashAlgorithmToString(DigitallySigned::HashAlgorithm hashAlgorithm);

// Returns a textual representation of |origin|.
NET_EXPORT const std::string OriginToString(SignedCertificateTimestamp::Origin origin);

// Returns a textual representation of |signatureAlgorithm|.
NET_EXPORT const std::string SignatureAlgorithmToString(DigitallySigned::SignatureAlgorithm signatureAlgorithm);
