...
public:
    void SetUp() override
    {
        ...
        ASSERT_TRUE(ReadCertChainFromFile("net/data/verify_certificate_chain_unittest/key-rollover/oldchain.pem", &chain));
        ...
        ASSERT_TRUE(ReadCertChainFromFile("net/data/verify_certificate_chain_unittest/"
...
TEST_F(TrustStoreCollectionTest, OneStore)
{
    ...
    // newroot_ is trusted.
    CertificateTrust trust = collection.GetTrust(newroot_.get(), /*debug_data=*/nullptr);
