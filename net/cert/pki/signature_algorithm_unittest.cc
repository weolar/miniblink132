...
TEST(SignatureAlgorithmTest, ParseDerRsaPssUnsupportedAlgorithmOid)
{
    ...
    const uint8_t kData[] = {
        0x30,
        0x03, // SEQUENCE (3 bytes)
        0x06,
        0x01, // OBJECT IDENTIFIER (1 bytes)
        0x42,
    };
    // clang-format on
    EXPECT_FALSE(ParseSignatureAlgorithm(der::Input(kData), nullptr));
...
TEST(SignatureAlgorithmTest, ParseDerSha1WithRSAEncryptionNullParams)
{
    ...
    const uint8_t kData[] = {
        ...
        0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x01, 0x05, 0x05, 0x00, // NULL (0 bytes)
    };
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kRsaPkcs1Sha1);
}
...
//       NULL
//       INTEGER  0
TEST(SignatureAlgorithmTest, ParseDerSha1WithRSAEncryptionNullParamsThenInteger)
{
    // clang-format off
  const uint8_t kData[] = {
...
TEST(SignatureAlgorithmTest, ParseDerSha256WithRSAEncryptionNullParams)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kRsaPkcs1Sha256);
}
...
TEST(SignatureAlgorithmTest, ParseDerSha384WithRSAEncryptionNullParams)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kRsaPkcs1Sha384);
}
...
TEST(SignatureAlgorithmTest, ParseDerSha512WithRSAEncryptionNullParams)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kRsaPkcs1Sha512);
}
...
TEST(SignatureAlgorithmTest, ParseDerEcdsaWithSHA1NoParams)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kEcdsaSha1);
}
...
TEST(SignatureAlgorithmTest, ParseDerEcdsaWithSHA256NoParams)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kEcdsaSha256);
}
...
TEST(SignatureAlgorithmTest, ParseDerEcdsaWithSHA384NoParams)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kEcdsaSha384);
}
...
TEST(SignatureAlgorithmTest, ParseDerEcdsaWithSHA512NoParams)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kEcdsaSha512);
}
...
TEST(SignatureAlgorithmTest, ParseDerRsaPss)
{
  ...
  const uint8_t kData[] = {
    ...
    // clang-format on
    EXPECT_EQ(ParseSignatureAlgorithm(der::Input(kData), nullptr), SignatureAlgorithm::kRsaPssSha256);
}
...
TEST(SignatureAlgorithmTest, ParseDerRsaPssSpecifiedDefaultTrailerField)
{
    ...
    // }
    const uint8_t kData[]
        = { 0x30, 0x46, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x39, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
              0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
              0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x20, 0xa3, 0x03, 0x02, 0x01, 0x01 };
    EXPECT_FALSE(ParseSignatureAlgorithm(der::Input(kData), nullptr));
}
...
TEST(SignatureAlgorithmTest, ParseRsaPss)
{
    ...
    struct {
        ...
        //   }
        // }
        { { 0x30, 0x41, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x34, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
              0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
              0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x20 },
        ...
        // }
        { { 0x30, 0x41, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x34, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
              0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
              0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x30 },
        ...
        // }
        { { 0x30, 0x41, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x34, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
              0x01, 0x65, 0x03, 0x04, 0x02, 0x03, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
              0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x03, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x40 },
            SignatureAlgorithm::kRsaPssSha512 },

        // The same inputs as above, but the NULLs in the digest algorithms are
        // omitted.
        { { 0x30, 0x3d, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x30, 0xa0, 0x0d, 0x30, 0x0b, 0x06, 0x09, 0x60, 0x86, 0x48,
              0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0xa1, 0x1a, 0x30, 0x18, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30, 0x0b, 0x06,
              0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0xa2, 0x03, 0x02, 0x01, 0x20 },
            SignatureAlgorithm::kRsaPssSha256 },
        { { 0x30, 0x3d, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x30, 0xa0, 0x0d, 0x30, 0x0b, 0x06, 0x09, 0x60, 0x86, 0x48,
              0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0xa1, 0x1a, 0x30, 0x18, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30, 0x0b, 0x06,
              0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0xa2, 0x03, 0x02, 0x01, 0x30 },
            SignatureAlgorithm::kRsaPssSha384 },
        { { 0x30, 0x3d, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x30, 0xa0, 0x0d, 0x30, 0x0b, 0x06, 0x09, 0x60, 0x86, 0x48,
              0x01, 0x65, 0x03, 0x04, 0x02, 0x03, 0xa1, 0x1a, 0x30, 0x18, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30, 0x0b, 0x06,
              0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x03, 0xa2, 0x03, 0x02, 0x01, 0x40 },
            SignatureAlgorithm::kRsaPssSha512 }
    };
    for (const auto& t : kValidTests) {
        EXPECT_EQ(ParseSignatureAlgorithm(der::Input(t.data.data(), t.data.size()), nullptr), t.expected);
    }
    ...
    struct {
        ...
        //   }
        // }
        { { 0x30, 0x3c, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x2f, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
            0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
            0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0x05, 0x00 } },
        // SEQUENCE {
        //   # rsassa-pss
        //   OBJECT_IDENTIFIER { 1.2.840.113549.1.1.10 }
        //   SEQUENCE {
        ...
        //   }
        // }
        { { 0x30, 0x3f, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x32, 0xa0, 0x0e, 0x30, 0x0c, 0x06, 0x08, 0x2a, 0x86, 0x48,
            0x86, 0xf7, 0x0d, 0x02, 0x05, 0x05, 0x00, 0xa1, 0x1b, 0x30, 0x19, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30, 0x0c,
            0x06, 0x08, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x02, 0x05, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x10 } },
        // SEQUENCE {
        //   # rsassa-pss
        //   OBJECT_IDENTIFIER { 1.2.840.113549.1.1.10 }
        ...
        //   }
        // }
        { { 0x30, 0x12, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x05, 0xa2, 0x03, 0x02, 0x01, 0x15 } },
        // SEQUENCE {
        //   # rsassa-pss
        //   OBJECT_IDENTIFIER { 1.2.840.113549.1.1.10 }
        //   SEQUENCE {
        ...
        { { 0x30, 0x41, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x34, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
            0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
            0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x01, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x21 } },
        // SEQUENCE {
        //   # rsassa-pss
        //   OBJECT_IDENTIFIER { 1.2.840.113549.1.1.10 }
        //   SEQUENCE {
        ...
        { { 0x30, 0x41, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x34, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
            0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
            0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x02, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x31 } },
        ...
        { { 0x30, 0x41, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x0a, 0x30, 0x34, 0xa0, 0x0f, 0x30, 0x0d, 0x06, 0x09, 0x60, 0x86, 0x48,
            0x01, 0x65, 0x03, 0x04, 0x02, 0x03, 0x05, 0x00, 0xa1, 0x1c, 0x30, 0x1a, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x01, 0x08, 0x30,
            0x0d, 0x06, 0x09, 0x60, 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x03, 0x05, 0x00, 0xa2, 0x03, 0x02, 0x01, 0x41 } },
    };
    for (const auto& t : kInvalidTests) {
        EXPECT_FALSE(ParseSignatureAlgorithm(der::Input(t.data.data(), t.data.size()), nullptr));
    }
}
