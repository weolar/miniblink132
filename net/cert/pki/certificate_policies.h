...
inline constexpr uint8_t kCpsPointerId[] = { 0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x02, 0x01 };

// id-qt-unotice  OBJECT IDENTIFIER ::=  { id-qt 2 }
//
// In dotted decimal form: 1.3.6.1.5.5.7.2.2
inline constexpr uint8_t kUserNoticeId[] = { 0x2b, 0x06, 0x01, 0x05, 0x05, 0x07, 0x02, 0x02 };
...
// it references data).
NET_EXPORT bool ParseCertificatePoliciesExtension(const der::Input& extension_value, std::vector<PolicyInformation>* policies, CertErrors* errors);
...
[[nodiscard]] NET_EXPORT bool ParsePolicyConstraints(const der::Input& policy_constraints_tlv, ParsedPolicyConstraints* out);

// Parses an InhibitAnyPolicy as defined by RFC 5280. Returns true on success,
// and sets |num_certs|.
[[nodiscard]] NET_EXPORT bool ParseInhibitAnyPolicy(const der::Input& inhibit_any_policy_tlv, uint8_t* num_certs);
...
[[nodiscard]] NET_EXPORT bool ParsePolicyMappings(const der::Input& policy_mappings_tlv, std::vector<ParsedPolicyMapping>* mappings);
