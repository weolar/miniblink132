...
public:
    ...
    // was rejected.
    virtual bool IsSignatureAlgorithmAcceptable(SignatureAlgorithm signature_algorithm, CertErrors* errors) = 0;
    ...
    virtual bool IsPublicKeyAcceptable(EVP_PKEY* public_key, CertErrors* errors) = 0;
...
// validation.
NET_EXPORT void VerifyCertificateChain(const ParsedCertificateList& certs, const CertificateTrust& last_cert_trust, VerifyCertificateChainDelegate* delegate,
