...
public:
    ...
    void AddCertificateWithUnspecifiedTrust(scoped_refptr<ParsedCertificate> cert);
...
private:
    ...
    void AddCertificate(scoped_refptr<ParsedCertificate> cert, const CertificateTrust& trust);
