...
[[nodiscard]] NET_EXPORT bool ParseAlgorithmIdentifier(const der::Input& input, der::Input* algorithm, der::Input* parameters);
...
NET_EXPORT absl::optional<SignatureAlgorithm> ParseSignatureAlgorithm(const der::Input& algorithm_identifier, CertErrors* errors);
