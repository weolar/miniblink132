...
void TrustStoreCollection::SyncGetIssuersOf(const ParsedCertificate* cert, ParsedCertificateList* issuers)
{
...
CertificateTrust TrustStoreCollection::GetTrust(const ParsedCertificate* cert, base::SupportsUserData* debug_data) const
{
