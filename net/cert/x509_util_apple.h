...
NET_EXPORT base::apple::ScopedCFTypeRef<SecCertificateRef> CreateSecCertificateFromBytes(base::span<const uint8_t> data);

// Returns a SecCertificate representing |cert|, or NULL on failure.
NET_EXPORT base::apple::ScopedCFTypeRef<SecCertificateRef> CreateSecCertificateFromX509Certificate(const X509Certificate* cert);
...
NET_EXPORT base::apple::ScopedCFTypeRef<CFMutableArrayRef> CreateSecCertificateArrayForX509Certificate(X509Certificate* cert);
...
NET_EXPORT base::apple::ScopedCFTypeRef<CFMutableArrayRef> CreateSecCertificateArrayForX509Certificate(
...
// |sec_chain|.
NET_EXPORT scoped_refptr<X509Certificate> CreateX509CertificateFromSecCertificate(
...
NET_EXPORT scoped_refptr<X509Certificate> CreateX509CertificateFromSecCertificate(base::apple::ScopedCFTypeRef<SecCertificateRef> sec_cert,
