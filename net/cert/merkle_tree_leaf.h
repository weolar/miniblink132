...
NET_EXPORT bool GetMerkleTreeLeaf(const X509Certificate* cert, const SignedCertificateTimestamp* sct, MerkleTreeLeaf* merkle_tree_leaf);
...
// occurred.
NET_EXPORT bool HashMerkleTreeLeaf(const MerkleTreeLeaf& tree_leaf, std::string* out);
