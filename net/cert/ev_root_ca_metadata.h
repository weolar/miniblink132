...
#if BUILDFLAG(USE_NSS_CERTS) || BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_FUCHSIA)
...
namespace base {
template <typename T> struct LazyInstanceTraitsBase;
} // namespace base
...
public:
    ...
    bool HasEVPolicyOID(const SHA256HashValue& fingerprint, bssl::der::Input policy_oid) const;
