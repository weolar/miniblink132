...
public:
    Notifier()
    {
        GetNetworkNotificationThreadMac()->PostTask(FROM_HERE, base::BindOnce(&Notifier::Init, base::Unretained(this)));
    }
...
// static
OSStatus Notifier::KeychainCallback(SecKeychainEvent keychain_event, SecKeychainCallbackInfo* info, void* context)
{
