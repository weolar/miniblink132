...
public:
    void SetUp() override
    {
        ...
        test_precert_ = CreateCertificateChainFromFile(GetTestCertsDirectory(), "ct-test-embedded-cert.pem", X509Certificate::FORMAT_AUTO);
...
{
    MerkleTreeLeaf leaf;
    ASSERT_TRUE(GetMerkleTreeLeaf(test_precert_.get(), precert_sct_.get(), &leaf));
...
TEST_F(MerkleTreeLeafTest, HashForX509Cert)
{
    ...
    EXPECT_THAT(hash,
        HexEq("452da788b3b8d15872ff0bb0777354b2a7f1c1887b5633201e76"
              "2ba5a4b143fc"));
}
...
TEST_F(MerkleTreeLeafTest, HashForPrecert)
{
    ...
    ASSERT_TRUE(HashMerkleTreeLeaf(leaf, &hash));
    EXPECT_THAT(hash,
        HexEq("257ae85f08810445511e35e33f7aee99ee19407971e35e95822b"
              "bf42a74be223"));
}
