...
class MockPersistentNelStore : public NetworkErrorLoggingService::PersistentNelStore {
public:
    // Represents a command that has been passed to the MockPersistentNelStore.
    struct Command {
        enum class Type { LOAD_NEL_POLICIES, ADD_NEL_POLICY, UPDATE_NEL_POLICY, DELETE_NEL_POLICY, FLUSH };
    ...
    void SetPrestoredPolicies(std::vector<NetworkErrorLoggingService::NelPolicy> policies);
