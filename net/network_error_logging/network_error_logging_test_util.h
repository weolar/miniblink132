...
public:
    ...
    TestNetworkErrorLoggingService(const TestNetworkErrorLoggingService&) = delete;
    TestNetworkErrorLoggingService& operator=(const TestNetworkErrorLoggingService&) = delete;
    ...
    const std::vector<RequestDetails>& errors()
    {
        return errors_;
    }
