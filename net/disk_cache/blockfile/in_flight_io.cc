...
BackgroundIO::BackgroundIO(InFlightIO* controller)
    : io_completed_(base::WaitableEvent::ResetPolicy::MANUAL, base::WaitableEvent::InitialState::NOT_SIGNALED)
...
void InFlightIO::OnIOComplete(BackgroundIO* operation)
{
    ...
    callback_task_runner_->PostTask(FROM_HERE, base::BindOnce(&BackgroundIO::OnIOSignalled, operation));
