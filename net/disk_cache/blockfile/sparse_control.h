...
public:
    ...
    enum SparseOperation { kNoOperation, kReadOperation, kWriteOperation, kGetRangeOperation };
    ...
    int StartIO(SparseOperation op, int64_t offset, net::IOBuffer* buf, int buf_len, CompletionOnceCallback callback);
