...
NET_EXPORT_PRIVATE SimpleCacheConsistencyResult UpgradeSimpleCacheOnDisk(BackendFileOperations* file_operations, const base::FilePath& path);
...
// were deleted.
NET_EXPORT_PRIVATE bool DeleteIndexFilesIfCacheIsEmpty(const base::FilePath& path);
...
// Exposed for testing.
NET_EXPORT_PRIVATE bool UpgradeIndexV5V6(BackendFileOperations* file_operations, const base::FilePath& cache_directory);
