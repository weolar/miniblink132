...
class SimplePostDoomWaiterTable : public base::RefCounted<SimplePostDoomWaiterTable> {
...
public:
    ...
    SimplePostDoomWaiterTable& operator=(const SimplePostDoomWaiterTable&) = delete;
...
private:
    ...
    std::unordered_map<uint64_t, std::vector<SimplePostDoomWaiter>> entries_pending_doom_;
};
