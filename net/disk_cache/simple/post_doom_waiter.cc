...
SimplePostDoomWaiter::SimplePostDoomWaiter(SimplePostDoomWaiter&& other) = default;
SimplePostDoomWaiter& SimplePostDoomWaiter::operator=(SimplePostDoomWaiter&& other) = default;
SimplePostDoomWaiter::~SimplePostDoomWaiter() = default;
...
void SimplePostDoomWaiterTable::OnDoomStart(uint64_t entry_hash)
{
    ...
    entries_pending_doom_.insert(std::make_pair(entry_hash, std::vector<SimplePostDoomWaiter>()));
}
...
std::vector<SimplePostDoomWaiter>* SimplePostDoomWaiterTable::Find(uint64_t entry_hash)
{
