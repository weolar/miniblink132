...
#define SIMPLE_CACHE_THUNK(uma_prefix, uma_type, args) uma_prefix##_HISTOGRAM_##uma_type args
...
#define SIMPLE_CACHE_HISTO(uma_prefix, uma_type, uma_name, cache_type, ...)                                                                                    \
    do {                                                                                                                                                       \
        switch (cache_type) {                                                                                                                                  \
        case net::DISK_CACHE:                                                                                                                                  \
            SIMPLE_CACHE_THUNK(uma_prefix, uma_type, ("SimpleCache.Http." uma_name, ##__VA_ARGS__));                                                           \
            break;                                                                                                                                             \
        case net::APP_CACHE:                                                                                                                                   \
            SIMPLE_CACHE_THUNK(uma_prefix, uma_type, ("SimpleCache.App." uma_name, ##__VA_ARGS__));                                                            \
            break;                                                                                                                                             \
        case net::GENERATED_BYTE_CODE_CACHE:                                                                                                                   \
            SIMPLE_CACHE_THUNK(uma_prefix, uma_type, ("SimpleCache.Code." uma_name, ##__VA_ARGS__));                                                           \
            break;                                                                                                                                             \
...
#define SIMPLE_CACHE_UMA(uma_type, uma_name, cache_type, ...) SIMPLE_CACHE_HISTO(UMA, uma_type, uma_name, cache_type, ##__VA_ARGS__)

#define DEPRECATED_SIMPLE_CACHE_UMA_MEDIUM_TIMES(uma_name, cache_type, ...)                                                                                    \
    SIMPLE_CACHE_HISTO(DEPRECATED_UMA, MEDIUM_TIMES, uma_name, cache_type, ##__VA_ARGS__)

#define SIMPLE_CACHE_LOCAL(uma_type, uma_name, cache_type, ...) SIMPLE_CACHE_HISTO(LOCAL, uma_type, uma_name, cache_type, ##__VA_ARGS__)
