...
public:
    ...
    static SimpleEntryOperation OpenOperation(SimpleEntryImpl* entry, EntryResultState result_state, EntryResultCallback);
    static SimpleEntryOperation CreateOperation(SimpleEntryImpl* entry, EntryResultState result_state, EntryResultCallback);
    static SimpleEntryOperation OpenOrCreateOperation(
        SimpleEntryImpl* entry, OpenEntryIndexEnum index_state, EntryResultState result_state, EntryResultCallback);
    static SimpleEntryOperation CloseOperation(SimpleEntryImpl* entry);
    static SimpleEntryOperation ReadOperation(SimpleEntryImpl* entry, int index, int offset, int length, net::IOBuffer* buf, CompletionOnceCallback callback);
    ...
    static SimpleEntryOperation WriteSparseOperation(
        SimpleEntryImpl* entry, int64_t sparse_offset, int length, net::IOBuffer* buf, CompletionOnceCallback callback);
    static SimpleEntryOperation GetAvailableRangeOperation(SimpleEntryImpl* entry, int64_t sparse_offset, int length, RangeResultCallback callback);
    static SimpleEntryOperation DoomOperation(SimpleEntryImpl* entry, CompletionOnceCallback callback);

    EntryOperationType type() const
    {
        return static_cast<EntryOperationType>(type_);
    }
    CompletionOnceCallback ReleaseCallback()
    {
    ...
    EntryResultState entry_result_state()
    {
        return entry_result_state_;
    }

    OpenEntryIndexEnum index_state() const
    {
        return index_state_;
    }
    int index() const
    ...
    int64_t sparse_offset() const
    {
        return sparse_offset_;
    }
    int length() const
    {
        return length_;
...
private:
    SimpleEntryOperation(SimpleEntryImpl* entry, net::IOBuffer* buf, CompletionOnceCallback callback, int offset, int64_t sparse_offset, int length,
        EntryOperationType type, OpenEntryIndexEnum index_state, int index, bool truncate, bool optimistic);
