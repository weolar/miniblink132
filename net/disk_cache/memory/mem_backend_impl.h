...
public:
    ...
    static std::unique_ptr<MemBackendImpl> CreateBackend(int64_t max_bytes, net::NetLog* net_log);
...
private:
    ...
    using EntryMap = std::unordered_map<std::string, raw_ptr<MemEntryImpl, CtnExperimental>>;
