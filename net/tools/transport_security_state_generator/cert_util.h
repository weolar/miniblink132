...
bool CalculateSPKIHashFromCertificate(X509* certificate, net::transport_security_state::SPKIHash* out_hash);
...
// failure.
bool CalculateSPKIHashFromKey(std::string_view pem_key, net::transport_security_state::SPKIHash* out_hash);
