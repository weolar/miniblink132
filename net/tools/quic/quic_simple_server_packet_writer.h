...
public:
    QuicSimpleServerPacketWriter(UDPServerSocket* socket, quic::QuicDispatcher* dispatcher);

    QuicSimpleServerPacketWriter(const QuicSimpleServerPacketWriter&) = delete;
    QuicSimpleServerPacketWriter& operator=(const QuicSimpleServerPacketWriter&) = delete;
