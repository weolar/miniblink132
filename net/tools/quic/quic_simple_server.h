...
public:
    QuicSimpleServer(std::unique_ptr<quic::ProofSource> proof_source, const quic::QuicConfig& config,
    ...
    bool CreateUDPSocketAndListen(const quic::QuicSocketAddress& address) override;
    ...
    IPEndPoint server_address() const
    {
