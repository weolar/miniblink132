...
#define TRAFFIC_ANNOTATION_FOR_TESTS net::DefineNetworkTrafficAnnotation("test", "Traffic annotation for unit, browser and other tests")
#define PARTIAL_TRAFFIC_ANNOTATION_FOR_TESTS                                                                                                                   \
    net::DefinePartialNetworkTrafficAnnotation("test_partial", "test", "Partial traffic annotation for unit, browser and other tests")
