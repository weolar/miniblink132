...
struct NET_EXPORT CookieDeletionInfo {
    ...
    bool Matches(const CanonicalCookie& cookie, const CookieAccessParams& params) const;
    ...
    // all partitions.
    CookiePartitionKeyCollection cookie_partition_key_collection = CookiePartitionKeyCollection::ContainsAll();
