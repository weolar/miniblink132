...
void GetCookieListCallback::Run(const CookieAccessResultList& cookies, const CookieAccessResultList& excluded_cookies)
{
...
GetAllCookiesWithAccessSemanticsCallback::GetAllCookiesWithAccessSemanticsCallback() = default;
GetAllCookiesWithAccessSemanticsCallback::GetAllCookiesWithAccessSemanticsCallback(base::Thread* run_in_thread)
    : CookieCallback(run_in_thread)
{
}
...
void GetAllCookiesWithAccessSemanticsCallback::Run(const CookieList& cookies, const std::vector<CookieAccessSemantics>& access_semantics_list)
{
    cookies_ = cookies;
