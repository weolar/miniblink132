...
class NET_EXPORT NetworkConnection : public NetworkChangeNotifier::IPAddressObserver, public NetworkChangeNotifier::ConnectionTypeObserver {
public:
    NetworkConnection();
...
private:
    ...
    NetworkChangeNotifier::ConnectionType connection_type_ = NetworkChangeNotifier::CONNECTION_UNKNOWN;
