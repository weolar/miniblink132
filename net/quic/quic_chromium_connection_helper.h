...
class NET_EXPORT_PRIVATE QuicChromiumConnectionHelper : public quic::QuicConnectionHelperInterface {
public:
    QuicChromiumConnectionHelper(const quic::QuicClock* clock, quic::QuicRandom* random_generator);

    QuicChromiumConnectionHelper(const QuicChromiumConnectionHelper&) = delete;
    QuicChromiumConnectionHelper& operator=(const QuicChromiumConnectionHelper&) = delete;
