...
bool MockEncrypter::EncryptPacket(
    uint64_t /*packet_number*/, std::string_view associated_data, std::string_view plaintext, char* output, size_t* output_length, size_t max_output_length)
{
...
std::string MockEncrypter::GenerateHeaderProtectionMask(std::string_view sample)
{
