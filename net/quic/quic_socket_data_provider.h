...
public:
    ...
    public:
        ...
        const std::set<std::string>& after() const
        {
            return after_;
        }
        int rv() const
    ...
    protected:
        ...
        Expectation(std::string name, Type type, int rv, std::unique_ptr<quic::QuicEncryptedPacket> packet);
    ...
    Expectation& AddRead(std::string name, std::unique_ptr<quic::QuicReceivedPacket> packet);
    Expectation& AddRead(std::string name, std::unique_ptr<quic::QuicEncryptedPacket> packet);
    ...
    Expectation& AddWrite(std::string name, std::unique_ptr<quic::QuicEncryptedPacket> packet, int rv = OK);
