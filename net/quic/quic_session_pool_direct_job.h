...
public:
    DirectJob(QuicSessionPool* pool, quic::ParsedQuicVersion quic_version, HostResolver* host_resolver, QuicSessionAliasKey key,
    ...
    void UpdatePriority(RequestPriority old_priority, RequestPriority new_priority) override;
...
private:
    ...
    base::WeakPtr<DirectJob> GetWeakPtr()
    {
