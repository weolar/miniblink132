...
class MockCryptoClientStream : public quic::QuicCryptoClientStream, public quic::QuicCryptoHandshaker {
public:
    ...
    MockCryptoClientStream(const quic::QuicServerId& server_id, quic::QuicSpdyClientSessionBase* session,
        std::unique_ptr<quic::ProofVerifyContext> verify_context, const quic::QuicConfig& config, quic::QuicCryptoClientConfig* crypto_config,
        HandshakeMode handshake_mode, const net::ProofVerifyDetailsChromium* proof_verify_details_, bool use_mock_crypter);
    ...
    std::unique_ptr<quic::QuicDecrypter> AdvanceKeysAndCreateCurrentOneRttDecrypter() override;
    ...
    void SetServerApplicationStateForResumption(std::unique_ptr<quic::ApplicationState> application_state) override
    {
    }
...
private:
    ...
    quiche::QuicheReferenceCountedPointer<quic::QuicCryptoNegotiatedParameters> crypto_negotiated_params_;
