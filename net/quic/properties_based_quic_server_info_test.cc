...
protected:
    PropertiesBasedQuicServerInfoTest()
        ...
        , server_info_(server_id_, PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), &http_server_properties_)
    {
    }
...
TEST_F(PropertiesBasedQuicServerInfoTest, Update)
{
    ...
    PropertiesBasedQuicServerInfo server_info1(server_id_, PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), &http_server_properties_);
    ...
    // Read the persisted data and verify we have read the data correctly.
    PropertiesBasedQuicServerInfo server_info2(server_id_, PRIVACY_MODE_DISABLED, NetworkAnonymizationKey(), &http_server_properties_);
