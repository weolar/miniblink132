...
{
#define QUICHE_FLAG(type, flag, internal_value, external_value, doc) saved_##flag##_ = FLAGS_##flag;
...
QuicFlagSaverImpl::~QuicFlagSaverImpl()
{
#define QUICHE_FLAG(type, flag, internal_value, external_value, doc) FLAGS_##flag = saved_##flag##_;
#include "net/third_party/quiche/src/quiche/common/quiche_feature_flags_list.h"
#undef QUICHE_FLAG
...
#define QUICHE_FLAG(type, flag, internal_value, external_value, doc)                                                                                           \
    CHECK_EQ(external_value, FLAGS_##flag) << "Flag set to an unexpected value.  A prior test is likely "                                                      \
...
#define QUICHE_PROTOCOL_FLAG_CHECK(type, flag, value)                                                                                                          \
    CHECK_EQ((type)value, FLAGS_##flag) << "Flag set to an unexpected value.  A prior test is likely "                                                         \
                                        << "setting a flag without using a QuicFlagSaver. Use QuicTest to "                                                    \
                                           "avoid this issue.";
#define DEFINE_QUICHE_PROTOCOL_FLAG_SINGLE_VALUE(type, flag, value, doc) QUICHE_PROTOCOL_FLAG_CHECK(type, flag, value);

#define DEFINE_QUICHE_PROTOCOL_FLAG_TWO_VALUES(type, flag, internal_value, external_value, doc) QUICHE_PROTOCOL_FLAG_CHECK(type, flag, external_value);
#define GET_6TH_ARG(arg1, arg2, arg3, arg4, arg5, arg6, ...) arg6
#define QUICHE_PROTOCOL_FLAG_MACRO_CHOOSER(...) GET_6TH_ARG(__VA_ARGS__, DEFINE_QUICHE_PROTOCOL_FLAG_TWO_VALUES, DEFINE_QUICHE_PROTOCOL_FLAG_SINGLE_VALUE)
#define QUICHE_PROTOCOL_FLAG(...) QUICHE_PROTOCOL_FLAG_MACRO_CHOOSER(__VA_ARGS__)(__VA_ARGS__)
#include "net/third_party/quiche/src/quiche/common/quiche_protocol_flags_list.h"
#undef QUICHE_PROTOCOL_FLAG
