...
QuicChromiumConnectionHelper::QuicChromiumConnectionHelper(const quic::QuicClock* clock, quic::QuicRandom* random_generator)
    : clock_(clock)
...
quiche::QuicheBufferAllocator* QuicChromiumConnectionHelper::GetStreamSendBufferAllocator()
{
