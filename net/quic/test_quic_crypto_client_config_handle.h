...
public:
    explicit TestQuicCryptoClientConfigHandle(quic::QuicCryptoClientConfig* crypto_config);

    TestQuicCryptoClientConfigHandle& operator=(const TestQuicCryptoClientConfigHandle&) = delete;
