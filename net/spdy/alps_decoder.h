...
private:
    ...
    public:
        ...
        bool forbidden_frame_received() const
        {
            return forbidden_frame_received_;
        }
        bool settings_ack_received() const
        {
            return settings_ack_received_;
        }
        int settings_frame_count() const
        {
            return settings_frame_count_;
        }
    ...
    public:
        ...
        Error error_bypass() const
        {
            return error_bypass_;
        }
