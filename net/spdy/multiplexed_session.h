...
public:
    ...
    // origins.
    virtual std::string_view GetAcceptChViaAlps(const url::SchemeHostPort& scheme_host_port) const = 0;
};
...
public:
    ...
    // is based around network authorities, as opposed to general RFC 6454
    // origins.
    virtual std::string_view GetAcceptChViaAlps(const url::SchemeHostPort& scheme_host_port) const;
