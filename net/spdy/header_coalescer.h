...
class NET_EXPORT_PRIVATE HeaderCoalescer : public spdy::SpdyHeadersHandlerInterface {
public:
    HeaderCoalescer(uint32_t max_header_list_size, const NetLogWithSource& net_log);
