...
public:
    ...
    SpdySessionKey(const HostPortPair& host_port_pair, PrivacyMode privacy_mode, const ProxyChain& proxy_chain, SessionUsage session_usage,
    ...
    CompareForAliasingResult CompareForAliasing(const SpdySessionKey& other) const;
