...
public:
    ...
    public:
        ...
        // |key|.
        virtual bool ValidatePushedStream(spdy::SpdyStreamId stream_id, const GURL& url, const HttpRequestInfo& request_info, const SpdySessionKey& key) const
            = 0;
    ...
    [[nodiscard]] bool RegisterUnclaimedPushedStream(const GURL& url, spdy::SpdyStreamId stream_id, Delegate* delegate);
    ...
    [[nodiscard]] bool UnregisterUnclaimedPushedStream(const GURL& url, spdy::SpdyStreamId stream_id, Delegate* delegate);
    ...
    spdy::SpdyStreamId FindStream(const GURL& url, const Delegate* delegate) const;
...
private:
    ...
    struct NET_EXPORT CompareByUrl {
        bool operator()(const UnclaimedPushedStream& a, const UnclaimedPushedStream& b) const;
    };
