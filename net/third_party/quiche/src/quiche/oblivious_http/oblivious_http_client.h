...
public:
    static absl::StatusOr<ObliviousHttpClient> Create(absl::string_view hpke_public_key, const ObliviousHttpHeaderKeyConfig& ohttp_key_config);
    ...
    absl::StatusOr<ObliviousHttpRequest> CreateObliviousHttpRequest(std::string plaintext_data) const;
...
private:
    explicit ObliviousHttpClient(std::string client_public_key, const ObliviousHttpHeaderKeyConfig& ohttp_key_config);
