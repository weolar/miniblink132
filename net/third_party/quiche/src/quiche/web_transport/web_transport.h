...
struct QUICHE_EXPORT StreamPriority {
    ...
    {
        return send_group_id == other.send_group_id && send_order == other.send_order;
    }
};
...
class QUICHE_EXPORT StreamVisitor : public quiche::ReadStreamVisitor, public quiche::WriteStreamVisitor {
public:
...
class QUICHE_EXPORT Stream : public quiche::ReadStream, public quiche::WriteStream, public quiche::TerminableStream {
public:
    virtual ~Stream()
    {
    }
...
public:
    ...
    virtual void OnSessionClosed(SessionErrorCode error_code, const std::string& error_message) = 0;
...
public:
    ...
    // and |error_message|.
    virtual void CloseSession(SessionErrorCode error_code, absl::string_view error_message) = 0;
