...
TEST(WebTransportSchedulerTest, Register)
{
    ...
    EXPECT_THAT(scheduler.Register(4, StreamPriority { 0, 0 }), StatusIs(absl::StatusCode::kAlreadyExists));
    EXPECT_THAT(scheduler.Register(4, StreamPriority { 1, 0 }), StatusIs(absl::StatusCode::kAlreadyExists));
}
...
TEST(WebTransportSchedulerTest, UpdatePriority)
{
    ...
    EXPECT_THAT(scheduler.UpdateSendGroup(1000, 1), StatusIs(absl::StatusCode::kNotFound));
    EXPECT_THAT(scheduler.UpdateSendOrder(1000, 1), StatusIs(absl::StatusCode::kNotFound));
