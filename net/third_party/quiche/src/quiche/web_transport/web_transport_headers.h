...
inline constexpr absl::string_view kSubprotocolRequestHeader = "WT-Available-Protocols";
inline constexpr absl::string_view kSubprotocolResponseHeader = "WT-Protocol";

QUICHE_EXPORT absl::StatusOr<std::vector<std::string>> ParseSubprotocolRequestHeader(absl::string_view value);
QUICHE_EXPORT absl::StatusOr<std::string> SerializeSubprotocolRequestHeader(absl::Span<const std::string> subprotocols);
QUICHE_EXPORT absl::StatusOr<std::string> ParseSubprotocolResponseHeader(absl::string_view value);
QUICHE_EXPORT absl::StatusOr<std::string> SerializeSubprotocolResponseHeader(absl::string_view subprotocol);
...
struct QUICHE_EXPORT WebTransportInitHeader {
    ...
    {
        return initial_unidi_limit == other.initial_unidi_limit && initial_incoming_bidi_limit == other.initial_incoming_bidi_limit
            && initial_outgoing_bidi_limit == other.initial_outgoing_bidi_limit;
    }
};

QUICHE_EXPORT absl::StatusOr<WebTransportInitHeader> ParseInitHeader(absl::string_view header);
QUICHE_EXPORT absl::StatusOr<std::string> SerializeInitHeader(const WebTransportInitHeader& header);
