...
public:
    ...
    MOCK_METHOD(absl::Status, Writev, (absl::Span<const absl::string_view> data, const quiche::StreamWriteOptions& options), (override));
    ...
    MOCK_METHOD(void, SetVisitor, (std::unique_ptr<StreamVisitor> visitor), (override));
};

class QUICHE_NO_EXPORT MockSessionVisitor : public SessionVisitor {
public:
    MOCK_METHOD(void, OnSessionReady, (), (override));
    MOCK_METHOD(void, OnSessionClosed, (SessionErrorCode error_code, const std::string& error_message), (override));
    ...
    MOCK_METHOD(void, OnDatagramReceived, (absl::string_view datagram), (override));
...
public:
    MOCK_METHOD(void, CloseSession, (SessionErrorCode error_code, absl::string_view error_message), (override));
    ...
    MOCK_METHOD(DatagramStatus, SendOrQueueDatagram, (absl::string_view datagram), (override));
    ...
    MOCK_METHOD(void, SetOnDraining, (quiche::SingleUseCallback<void()>), (override));
};
