...
template <typename T, typename ListID = void> class QUICHE_EXPORT_PRIVATE SpdyIntrusiveLink {
protected:
...
template <typename T, typename ListID = void> class QUICHE_EXPORT_PRIVATE SpdyIntrusiveList {
...
private:
    ...
    template <typename QualifiedT, typename QualifiedLinkT> class QUICHE_EXPORT_PRIVATE iterator_impl {
    public:
