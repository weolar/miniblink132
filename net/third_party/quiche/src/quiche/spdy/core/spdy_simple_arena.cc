...
SpdySimpleArena::SpdySimpleArena(size_t block_size)
...
SpdySimpleArena::Block::Block(size_t s)
    : data(new char[s])
    , size(s)
    , used(0)
{
...
SpdySimpleArena::Block& SpdySimpleArena::Block::operator=(SpdySimpleArena::Block&& other)
{
    size = other.size;
    used = other.used;
    data = std::move(other.data);
