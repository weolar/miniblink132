...
public:
    ...
    static std::string EncodeHeaderBlock(HpackEncoder* encoder, const Http2HeaderBlock& header_set)
    {
        return encoder->EncodeHeaderBlock(header_set);
    }

    static bool EncodeIncremental(HpackEncoder* encoder, const Http2HeaderBlock& header_set, std::string* output)
    {
