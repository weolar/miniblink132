...
TEST(HpackLookupEntryTest, EntryNamesDiffer)
{
    ...
    EXPECT_NE(absl::Hash<HpackLookupEntry>()(entry1), absl::Hash<HpackLookupEntry>()(entry2));
}
...
TEST(HpackLookupEntryTest, EntriesEqual)
{
    ...
    EXPECT_EQ(absl::Hash<HpackLookupEntry>()(entry1), absl::Hash<HpackLookupEntry>()(entry2));
}
