...
QUICHE_EXPORT_PRIVATE const std::vector<HpackHuffmanSymbol>& HpackHuffmanCodeVector();

// RFC 7541, Appendix A: Static Table Definition.
QUICHE_EXPORT_PRIVATE const std::vector<HpackStaticEntry>& HpackStaticTableVector();
