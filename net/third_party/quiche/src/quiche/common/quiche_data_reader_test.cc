...
TEST(QuicheDataReaderTest, ReadUInt32)
{
    ...
    QuicheDataReader reader(reinterpret_cast<const char*>(kData), ABSL_ARRAYSIZE(kData) * sizeof(uint32_t));
    EXPECT_FALSE(reader.IsDoneReading());
...
TEST(QuicheDataReaderTest, ReadStringPiece16)
{
    ...
    const char kData[] = {
        ...
        0x54, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2c, 0x20, 0x31, 0x2c, 0x20, 0x32, 0x2c, 0x20, 0x33, // "Testing, 1, 2, 3"
    };
