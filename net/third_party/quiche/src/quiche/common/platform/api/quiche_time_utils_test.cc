...
TEST(QuicheTimeUtilsTest, Basic)
{
    ...
    EXPECT_EQ(1152966896, QuicheUtcDateTimeToUnixSeconds(2006, 7, 15, 12, 34, 56));
...
{
    EXPECT_EQ(QuicheUtcDateTimeToUnixSeconds(2015, 6, 30, 23, 59, 60), QuicheUtcDateTimeToUnixSeconds(2015, 7, 1, 0, 0, 0));
    EXPECT_EQ(QuicheUtcDateTimeToUnixSeconds(2015, 6, 30, 25, 59, 60), std::nullopt);
}
