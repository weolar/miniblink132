...
#define DEFINE_QUICHE_COMMAND_LINE_FLAG(type, name, default_value, help) DEFINE_QUICHE_COMMAND_LINE_FLAG_IMPL(type, name, default_value, help)
...
inline std::vector<std::string> QuicheParseCommandLineFlags(const char* usage, int argc, const char* const* argv)
{
