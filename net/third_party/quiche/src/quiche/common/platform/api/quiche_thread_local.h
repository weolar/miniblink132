...
// Chromium.
#define DEFINE_QUICHE_THREAD_LOCAL_POINTER(name, type) DEFINE_QUICHE_THREAD_LOCAL_POINTER_IMPL(name, type)

// Get the value of |name| for the current thread.
#define GET_QUICHE_THREAD_LOCAL_POINTER(name) GET_QUICHE_THREAD_LOCAL_POINTER_IMPL(name)

// Set the |value| of |name| for the current thread.
#define SET_QUICHE_THREAD_LOCAL_POINTER(name, value) SET_QUICHE_THREAD_LOCAL_POINTER_IMPL(name, value)
