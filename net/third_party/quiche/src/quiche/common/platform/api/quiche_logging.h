...
#define QUICHE_DVLOG_IF(verbose_level, condition) QUICHE_DVLOG_IF_IMPL(verbose_level, condition)
#define QUICHE_DLOG(severity) QUICHE_DLOG_IMPL(severity)
#define QUICHE_DLOG_IF(severity, condition) QUICHE_DLOG_IF_IMPL(severity, condition)
...
#define QUICHE_LOG_EVERY_N_SEC(severity, seconds) QUICHE_LOG_EVERY_N_SEC_IMPL(severity, seconds)
#define QUICHE_LOG_IF(severity, condition) QUICHE_LOG_IF_IMPL(severity, condition)
