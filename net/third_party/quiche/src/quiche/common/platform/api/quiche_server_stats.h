...
#define QUICHE_SERVER_HISTOGRAM_ENUM(name, sample, enum_size, docstring) QUICHE_SERVER_HISTOGRAM_ENUM_IMPL(name, sample, enum_size, docstring)
...
#define QUICHE_SERVER_HISTOGRAM_BOOL(name, sample, docstring) QUICHE_SERVER_HISTOGRAM_BOOL_IMPL(name, sample, docstring)
...
#define QUICHE_SERVER_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring)                                                                         \
    QUICHE_SERVER_HISTOGRAM_TIMES_IMPL(name, sample, min, max, bucket_count, docstring)
...
#define QUICHE_SERVER_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring)                                                                        \
    QUICHE_SERVER_HISTOGRAM_COUNTS_IMPL(name, sample, min, max, bucket_count, docstring)
