...
inline void QuicheSaveTestOutput(absl::string_view filename, absl::string_view data)
{
...
inline bool QuicheLoadTestOutput(absl::string_view filename, std::string* data)
{
...
inline void QuicheRecordTrace(absl::string_view identifier, absl::string_view data)
{
