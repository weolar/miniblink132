...
#define DEFINE_QUICHE_THREAD_LOCAL_POINTER_IMPL(name, type)                                                                                                    \
    struct QuicheThreadLocalPointer_##name {                                                                                                                   \
        ...
        static void Set(type* ptr)                                                                                                                             \
        {                                                                                                                                                      \
            *Instance() = ptr;                                                                                                                                 \
        }                                                                                                                                                      \
    }

#define GET_QUICHE_THREAD_LOCAL_POINTER_IMPL(name) QuicheThreadLocalPointer_##name::Get()

#define SET_QUICHE_THREAD_LOCAL_POINTER_IMPL(name, value) QuicheThreadLocalPointer_##name::Set(value)
