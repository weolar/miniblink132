...
QUICHE_EXPORT bool ExpandURITemplateImpl(const std::string& uri_template, const absl::flat_hash_map<std::string, std::string>& parameters, std::string* target,
...
QUICHE_EXPORT std::optional<std::string> AsciiUrlDecodeImpl(absl::string_view input);
