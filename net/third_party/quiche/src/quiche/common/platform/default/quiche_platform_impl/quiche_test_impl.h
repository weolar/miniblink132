...
#define EXPECT_QUICHE_DEATH_IMPL(condition, message) EXPECT_DEATH(condition, message)
...
private:
#define QUICHE_FLAG(type, flag, internal_value, external_value, doc) type saved_##flag##_;
