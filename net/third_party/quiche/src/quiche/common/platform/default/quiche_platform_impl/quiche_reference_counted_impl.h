...
template <class T> class QUICHE_NO_EXPORT QuicheReferenceCountedPointerImpl {
public:
    ...
    explicit QuicheReferenceCountedPointerImpl(T* p)
        : object_(p)
    {
        if (p != nullptr) {
    ...
    template <typename U> QuicheReferenceCountedPointerImpl(QuicheReferenceCountedPointerImpl<U>&& other)
    { // NOLINT
    ...
    template <typename U> QuicheReferenceCountedPointerImpl<T>& operator=(const QuicheReferenceCountedPointerImpl<U>& other)
    {
        AssignObject(other.object_);
        AddReference();
        return *this;
    ...
    template <typename U> QuicheReferenceCountedPointerImpl<T>& operator=(QuicheReferenceCountedPointerImpl<U>&& other)
    {
        AssignObject(other.get());
        AddReference();
        other = nullptr;
    ...
    friend bool operator==(const QuicheReferenceCountedPointerImpl& a, const QuicheReferenceCountedPointerImpl& b)
    {
        return a.get() == b.get();
    }
    friend bool operator!=(const QuicheReferenceCountedPointerImpl& a, const QuicheReferenceCountedPointerImpl& b)
    ...
    friend bool operator==(const QuicheReferenceCountedPointerImpl& a, std::nullptr_t)
    {
        return a.get() == nullptr;
    }
    friend bool operator==(std::nullptr_t, const QuicheReferenceCountedPointerImpl& b)
    {
