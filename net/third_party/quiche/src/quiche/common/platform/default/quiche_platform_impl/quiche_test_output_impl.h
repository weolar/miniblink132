...
inline void QuicheSaveTestOutputImpl(absl::string_view /*filename*/, absl::string_view /*data*/)
{
}

inline bool QuicheLoadTestOutputImpl(absl::string_view /*filename*/, std::string* /*data*/)
{
    return false;
}

inline void QuicheRecordTraceImpl(absl::string_view /*identifier*/, absl::string_view /*data*/)
{
}
