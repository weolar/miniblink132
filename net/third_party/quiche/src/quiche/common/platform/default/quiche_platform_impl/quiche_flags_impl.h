...
#define QUICHE_FLAG(type, flag, internal_value, external_value, doc) QUICHE_EXPORT extern type FLAGS_##flag;
#include "quiche/common/quiche_feature_flags_list.h"
#undef QUICHE_FLAG

// Protocol flags.
#define QUICHE_PROTOCOL_FLAG(type, flag, ...) QUICHE_EXPORT extern type FLAGS_##flag;
...
#define GetQuicheReloadableFlagImpl(flag) GetQuicheFlag(QUICHE_RELOADABLE_FLAG(flag))
#define SetQuicheReloadableFlagImpl(flag, value) SetQuicheFlag(QUICHE_RELOADABLE_FLAG(flag), value)
#define GetQuicheRestartFlagImpl(flag) GetQuicheFlag(QUICHE_RESTART_FLAG(flag))
#define SetQuicheRestartFlagImpl(flag, value) SetQuicheFlag(QUICHE_RESTART_FLAG(flag), value)
