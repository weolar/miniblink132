...
#define QUICHE_LOG_IF_IMPL(severity, condition) QUICHE_LOG_IF_IMPL_##severity(condition)
...
#define QUICHE_PLOG_IF_IMPL(severity, condition) QUICHE_PLOG_IF_IMPL_##severity(condition)
...
#define QUICHE_DLOG_IF_IMPL(severity, condition) QUICHE_DLOG_IF_IMPL_##severity(condition)
...
#define QUICHE_LOG_FIRST_N_IMPL(severity, n) QUICHE_LOG_FIRST_N_IMPL_##severity(n)
...
#define QUICHE_LOG_EVERY_N_SEC_IMPL(severity, seconds) QUICHE_LOG_EVERY_N_SEC_IMPL_##severity(seconds)
#define QUICHE_LOG_EVERY_N_SEC_IMPL_FATAL(seconds) ABSL_LOG_EVERY_N_SEC(FATAL, seconds)
#define QUICHE_LOG_EVERY_N_SEC_IMPL_ERROR(seconds) ABSL_LOG_EVERY_N_SEC(ERROR, seconds)
#define QUICHE_LOG_EVERY_N_SEC_IMPL_WARNING(seconds) ABSL_LOG_EVERY_N_SEC(WARNING, seconds)
#define QUICHE_LOG_EVERY_N_SEC_IMPL_INFO(seconds) ABSL_LOG_EVERY_N_SEC(INFO, seconds)
...
#define QUICHE_LOG_EVERY_N_SEC_IMPL_DFATAL(seconds) ABSL_LOG_EVERY_N_SEC(ERROR, seconds)
#else
...
#define QUICHE_LOG_EVERY_N_SEC_IMPL_DFATAL(seconds) ABSL_LOG_EVERY_N_SEC(FATAL, seconds)
#endif // NDEBUG

// Implement VLOG and DVLOG in terms of LOG and DLOG.
#define QUICHE_VLOG_PREDICATE(verbose_level) (verbose_level <= absl::GetFlag(FLAGS_v))

#define QUICHE_VLOG_IMPL(verbose_level) QUICHE_LOG_IF_IMPL(INFO, QUICHE_VLOG_PREDICATE(verbose_level))
#define QUICHE_VLOG_IF_IMPL(verbose_level, condition) QUICHE_LOG_IF_IMPL(INFO, (QUICHE_VLOG_PREDICATE(verbose_level) && condition))
#define QUICHE_DVLOG_IMPL(verbose_level) QUICHE_DLOG_IF_IMPL(INFO, QUICHE_VLOG_PREDICATE(verbose_level))
#define QUICHE_DVLOG_IF_IMPL(verbose_level, condition) QUICHE_DLOG_IF_IMPL(INFO, (QUICHE_VLOG_PREDICATE(verbose_level) && condition))
