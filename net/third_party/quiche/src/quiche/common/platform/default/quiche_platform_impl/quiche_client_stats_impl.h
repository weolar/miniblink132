...
#define QUICHE_CLIENT_HISTOGRAM_TIMES_IMPL(name, sample, min, max, num_buckets, docstring)                                                                     \
    do {                                                                                                                                                       \
        (void)sample; /* Workaround for -Wunused-variable. */                                                                                                  \
    } while (0)

#define QUICHE_CLIENT_HISTOGRAM_COUNTS_IMPL(name, sample, min, max, num_buckets, docstring)                                                                    \
    do {                                                                                                                                                       \
