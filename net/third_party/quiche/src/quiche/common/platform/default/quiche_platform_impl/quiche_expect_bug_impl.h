...
#define EXPECT_QUICHE_BUG_IMPL(statement, regex) EXPECT_QUICHE_DEBUG_DEATH(statement, regex)
#define EXPECT_QUICHE_PEER_BUG_IMPL(statement, regex) EXPECT_QUICHE_DEBUG_DEATH(statement, regex)
