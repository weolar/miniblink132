...
template <typename T, typename ListID> class QuicheIntrusiveList;

template <typename T, typename ListID = void> class QUICHE_EXPORT QuicheIntrusiveLink {
protected:
...
template <typename T, typename ListID = void> class QUICHE_EXPORT QuicheIntrusiveList {
...
public:
    ...
    iterator begin()
    {
        return iterator(sentinel_link_.next_);
    }
    const_iterator begin() const
    {
        return const_iterator(sentinel_link_.next_);
    }
    iterator end()
    {
        return iterator(&sentinel_link_);
    }
    const_iterator end() const
    {
        return const_iterator(&sentinel_link_);
    }
...
private:
    ...
    template <typename QualifiedT, typename QualifiedLinkT> class QUICHE_EXPORT iterator_impl {
    public:
        ...
        iterator_impl(QualifiedLinkT* link)
            : link_(link)
        {
        }
        ...
        iterator_impl(const iterator_impl<U, V>& x)
            : link_(x.link_)
        {
        }
        template <typename U, typename V> bool operator==(const iterator_impl<U, V>& x) const
        {
