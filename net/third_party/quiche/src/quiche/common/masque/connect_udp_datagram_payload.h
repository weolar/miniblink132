...
public:
    ...
    static std::unique_ptr<ConnectUdpDatagramPayload> Parse(absl::string_view datagram_payload);

    ConnectUdpDatagramPayload() = default;

    ConnectUdpDatagramPayload(const ConnectUdpDatagramPayload&) = delete;
    ConnectUdpDatagramPayload& operator=(const ConnectUdpDatagramPayload&) = delete;
...
class QUICHE_EXPORT ConnectUdpDatagramUdpPacketPayload final : public ConnectUdpDatagramPayload {
public:
    ...
    absl::string_view udp_packet() const
    {
        return udp_packet_;
    }
...
class QUICHE_EXPORT ConnectUdpDatagramUnknownPayload final : public ConnectUdpDatagramPayload {
public:
    ...
    ConnectUdpDatagramUnknownPayload(ContextId context_id, absl::string_view udp_proxying_payload);
