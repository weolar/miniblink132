...
public:
    ...
    static std::unique_ptr<ConnectIpDatagramPayload> Parse(absl::string_view datagram_payload);
...
class QUICHE_EXPORT ConnectIpDatagramIpPacketPayload final : public ConnectIpDatagramPayload {
public:
    ...
    absl::string_view ip_packet() const
    {
        return ip_packet_;
    }
...
class QUICHE_EXPORT ConnectIpDatagramUnknownPayload final : public ConnectIpDatagramPayload {
public:
    ...
    ConnectIpDatagramUnknownPayload(ContextId context_id, absl::string_view ip_proxying_payload);
