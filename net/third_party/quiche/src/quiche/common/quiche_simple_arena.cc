...
QuicheSimpleArena& QuicheSimpleArena::operator=(QuicheSimpleArena&& other) = default;
...
char* QuicheSimpleArena::Realloc(char* original, size_t oldsize, size_t newsize)
{
...
QuicheSimpleArena::Block& QuicheSimpleArena::Block::operator=(QuicheSimpleArena::Block&& other)
{
    size = other.size;
    used = other.used;
    data = std::move(other.data);
