...
INSTANTIATE_TEST_SUITE_P(QuicheDataWriterTests, QuicheDataWriterTest, ::testing::ValuesIn(GetTestParams()), ::testing::PrintToStringParamName());
...
TEST_P(QuicheDataWriterTest, Write16BitUnsignedIntegers)
{
    ...
    char buffer16[2];
    {
        ...
        test::CompareCharArraysWithHexError("uint16_t", buffer16, 2, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian16 : little_endian16, 2);
...
TEST_P(QuicheDataWriterTest, Write24BitUnsignedIntegers)
{
    ...
    test::CompareCharArraysWithHexError("uint24", buffer24, 3, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian24 : little_endian24, 3);
...
TEST_P(QuicheDataWriterTest, Write32BitUnsignedIntegers)
{
    ...
    char buffer32[4];
    {
        ...
        test::CompareCharArraysWithHexError("uint32_t", buffer32, 4, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian32 : little_endian32, 4);
...
TEST_P(QuicheDataWriterTest, Write40BitUnsignedIntegers)
{
    ...
    test::CompareCharArraysWithHexError("uint40", buffer40, 5, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian40 : little_endian40, 5);
...
TEST_P(QuicheDataWriterTest, Write48BitUnsignedIntegers)
{
    ...
    test::CompareCharArraysWithHexError("uint48", buffer48, 6, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian48 : little_endian48, 6);
...
TEST_P(QuicheDataWriterTest, Write56BitUnsignedIntegers)
{
    ...
    test::CompareCharArraysWithHexError("uint56", buffer56, 7, GetParam().endianness == quiche::NETWORK_BYTE_ORDER ? big_endian56 : little_endian56, 7);
...
bool EncodeDecodeValue(uint64_t value_in, char* buffer, size_t size_of_buffer)
{
    ...
    QuicheDataReader reader(buffer, expected_length, quiche::Endianness::NETWORK_BYTE_ORDER);
    uint64_t value_out;
...
TEST_P(QuicheDataWriterTest, VarInt8Layout)
{
    ...
    QuicheDataWriter writer(sizeof(buffer), static_cast<char*>(buffer), quiche::Endianness::NETWORK_BYTE_ORDER);
...
TEST_P(QuicheDataWriterTest, VarIntGoodTargetedValues)
{
    ...
    for (uint64_t test_val : passing_values) {
        EXPECT_TRUE(EncodeDecodeValue(test_val, static_cast<char*>(buffer), sizeof(buffer))) << " encode/decode of " << test_val << " failed";
    }
}
//
...
TEST_P(QuicheDataWriterTest, VarIntBadTargetedValues)
{
    ...
    for (uint64_t test_val : failing_values) {
        EXPECT_FALSE(EncodeDecodeValue(test_val, static_cast<char*>(buffer), sizeof(buffer))) << " encode/decode of " << test_val << " succeeded, but was an "
                                                                                              << "invalid value";
    }
}
...
TEST_P(QuicheDataWriterTest, WriteVarInt62WithForcedLength)
{
    ...
    writer.WriteVarInt62WithForcedLength(1073741823, VARIABLE_LENGTH_INTEGER_LENGTH_4);
    writer.WriteVarInt62WithForcedLength(1073741823, VARIABLE_LENGTH_INTEGER_LENGTH_8);

    writer.WriteVarInt62WithForcedLength(1073741824, VARIABLE_LENGTH_INTEGER_LENGTH_8);
...
{
    char buffer[3] = {};
    QuicheDataWriter writer(ABSL_ARRAYSIZE(buffer), buffer, GetParam().endianness);
...
TEST_P(QuicheDataWriterTest, PayloadReads)
{
    ...
    test::CompareCharArraysWithHexError("first read", first_read_buffer, sizeof(first_read_buffer), expected_first_read, sizeof(expected_first_read));
    ...
    test::CompareCharArraysWithHexError("full_payload", full_payload.data(), full_payload.length(), buffer, sizeof(buffer));
    absl::string_view previously_read_payload2 = reader.PreviouslyReadPayload();
    test::CompareCharArraysWithHexError(
        "previously_read_payload2", previously_read_payload2.data(), previously_read_payload2.length(), first_read_buffer, sizeof(first_read_buffer));
    ...
    test::CompareCharArraysWithHexError("full_payload2", full_payload2.data(), full_payload2.length(), buffer, sizeof(buffer));
    absl::string_view previously_read_payload3 = reader.PreviouslyReadPayload();
    test::CompareCharArraysWithHexError("previously_read_payload3", previously_read_payload3.data(), previously_read_payload3.length(), buffer, sizeof(buffer));
}
