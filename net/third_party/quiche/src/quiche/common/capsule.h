...
enum class CapsuleType : uint64_t {
    ...
    LEGACY_DATAGRAM_WITHOUT_CONTEXT = 0xff37a5, // draft-ietf-masque-h3-datagram-05 to -08.
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const CapsuleType& capsule_type);
...
struct QUICHE_EXPORT LegacyDatagramCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return CapsuleType::LEGACY_DATAGRAM;
    }
...
struct QUICHE_EXPORT DrainWebTransportSessionCapsule {
    ...
    bool operator==(const DrainWebTransportSessionCapsule&) const
    {
        return true;
    }
};
...
struct QUICHE_EXPORT AddressAssignCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return CapsuleType::ADDRESS_ASSIGN;
    }
};
struct QUICHE_EXPORT AddressRequestCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return CapsuleType::ADDRESS_REQUEST;
    }
};
struct QUICHE_EXPORT RouteAdvertisementCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return CapsuleType::ROUTE_ADVERTISEMENT;
    }
};
struct QUICHE_EXPORT UnknownCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return static_cast<CapsuleType>(type);
    }
...
struct QUICHE_EXPORT WebTransportResetStreamCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return CapsuleType::WT_RESET_STREAM;
    }
};
struct QUICHE_EXPORT WebTransportStopSendingCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return CapsuleType::WT_STOP_SENDING;
    }
};
struct QUICHE_EXPORT WebTransportMaxStreamDataCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return CapsuleType::WT_MAX_STREAM_DATA;
    }
};
struct QUICHE_EXPORT WebTransportMaxStreamsCapsule {
    ...
    CapsuleType capsule_type() const
    {
        return stream_type == webtransport::StreamType::kBidirectional ? CapsuleType::WT_MAX_STREAMS_BIDI : CapsuleType::WT_MAX_STREAMS_UNIDI;
    }
};
...
public:
    static Capsule Datagram(absl::string_view http_datagram_payload = absl::string_view());
    static Capsule LegacyDatagram(absl::string_view http_datagram_payload = absl::string_view());
    static Capsule LegacyDatagramWithoutContext(absl::string_view http_datagram_payload = absl::string_view());
    static Capsule CloseWebTransportSession(webtransport::SessionErrorCode error_code = 0, absl::string_view error_message = "");
    static Capsule AddressRequest();
    static Capsule AddressAssign();
    static Capsule RouteAdvertisement();
    static Capsule Unknown(uint64_t capsule_type, absl::string_view unknown_capsule_data = absl::string_view());

    template <typename CapsuleStruct>
    explicit Capsule(CapsuleStruct capsule)
    ...
    std::string ToString() const;
    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const Capsule& capsule);

    CapsuleType capsule_type() const
    {
        return absl::visit([](const auto& capsule) { return capsule.capsule_type(); }, capsule_);
    }
    ...
    LegacyDatagramWithoutContextCapsule& legacy_datagram_without_context_capsule()
    {
        return absl::get<LegacyDatagramWithoutContextCapsule>(capsule_);
    }
    const LegacyDatagramWithoutContextCapsule& legacy_datagram_without_context_capsule() const
    {
        return absl::get<LegacyDatagramWithoutContextCapsule>(capsule_);
    }
    ...
    const CloseWebTransportSessionCapsule& close_web_transport_session_capsule() const
    {
        return absl::get<CloseWebTransportSessionCapsule>(capsule_);
    }
    ...
    const WebTransportMaxStreamDataCapsule& web_transport_max_stream_data() const
    {
        return absl::get<WebTransportMaxStreamDataCapsule>(capsule_);
    }
...
private:
    absl::variant<DatagramCapsule, LegacyDatagramCapsule, LegacyDatagramWithoutContextCapsule, CloseWebTransportSessionCapsule, DrainWebTransportSessionCapsule,
        AddressRequestCapsule, AddressAssignCapsule, RouteAdvertisementCapsule, WebTransportStreamDataCapsule, WebTransportResetStreamCapsule,
        WebTransportStopSendingCapsule, WebTransportMaxStreamsCapsule, WebTransportMaxStreamDataCapsule, UnknownCapsule>
        capsule_;
};
...
QUICHE_EXPORT quiche::QuicheBuffer SerializeCapsule(const Capsule& capsule, quiche::QuicheBufferAllocator* allocator);

// Serializes the header for a datagram of size |datagram_size|.
QUICHE_EXPORT QuicheBuffer SerializeDatagramCapsuleHeader(uint64_t datagram_size, QuicheBufferAllocator* allocator);
