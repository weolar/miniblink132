...
int ToPlatformAddressFamily(IpAddressFamily family)
{
    ...
    case IpAddressFamily::IP_UNSPEC:
        return AF_UNSPEC;
    default:
        QUICHE_BUG(quic_bug_10126_1) << "Invalid IpAddressFamily " << static_cast<int32_t>(family);
        return AF_UNSPEC;
    }
}
...
IpAddressFamily FromPlatformAddressFamily(int family)
{
    ...
    default:
        QUICHE_BUG(quic_FromPlatformAddressFamily_unrecognized_family) << "Invalid platform address family int " << family;
        return IpAddressFamily::IP_UNSPEC;
    }
}
