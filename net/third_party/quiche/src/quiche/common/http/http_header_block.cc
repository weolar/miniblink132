...
HttpHeaderBlock::HeaderValue::HeaderValue(HttpHeaderStorage* storage, absl::string_view key, absl::string_view initial_value)
    : storage_(storage)
...
HttpHeaderBlock::HeaderValue& HttpHeaderBlock::HeaderValue::operator=(HeaderValue&& other)
{
    storage_ = other.storage_;
    fragments_ = std::move(other.fragments_);
    pair_ = std::move(other.pair_);
...
const std::pair<absl::string_view, absl::string_view>& HttpHeaderBlock::HeaderValue::as_pair() const
{
...
HttpHeaderBlock::ValueProxy::ValueProxy(
    HttpHeaderBlock* block, HttpHeaderBlock::MapType::iterator lookup_result, const absl::string_view key, size_t* spdy_header_block_value_size)
    : block_(block)
...
HttpHeaderBlock::ValueProxy& HttpHeaderBlock::ValueProxy::operator=(HttpHeaderBlock::ValueProxy&& other)
{
    block_ = other.block_;
    lookup_result_ = other.lookup_result_;
    key_ = other.key_;
...
HttpHeaderBlock::ValueProxy& HttpHeaderBlock::ValueProxy::operator=(absl::string_view value)
{
...
HttpHeaderBlock::InsertResult HttpHeaderBlock::insert(const HttpHeaderBlock::value_type& value)
{
...
HttpHeaderBlock::ValueProxy HttpHeaderBlock::operator[](const absl::string_view key)
{
...
void HttpHeaderBlock::AppendValueOrAddHeader(const absl::string_view key, const absl::string_view value)
{
...
void HttpHeaderBlock::AppendHeader(const absl::string_view key, const absl::string_view value)
{
