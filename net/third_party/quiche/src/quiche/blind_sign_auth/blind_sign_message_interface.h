...
using BlindSignMessageCallback = quiche::SingleUseCallback<void(absl::StatusOr<BlindSignMessageResponse>)>;
...
public:
    ...
    virtual void DoRequest(BlindSignMessageRequestType request_type, std::optional<absl::string_view> authorization_header, const std::string& body,
