...
template <class S> class Http2StructureDecoderTest : public RandomDecoderTest {
protected:
    typedef S Structure;
    ...
    AssertionResult DecodeLeadingStructure(const S* expected, absl::string_view data)
    {
        ...
        Validator validator;
        if (expected != nullptr) {
            validator = [expected, this](const DecodeBuffer& /*db*/, DecodeStatus /*status*/) -> AssertionResult {
        ...
        HTTP2_VERIFY_SUCCESS(DecodeAndValidateSeveralWays(&original, kMayReturnZeroOnFirst, validator));
    ...
    template <size_t N> AssertionResult DecodeLeadingStructure(const char (&data)[N])
    {
        return DecodeLeadingStructure(nullptr, absl::string_view(data, N));
    }

    template <size_t N> AssertionResult DecodeLeadingStructure(const unsigned char (&data)[N])
    {
...
class Http2FrameHeaderDecoderTest : public Http2StructureDecoderTest<Http2FrameHeader> { };
...
class Http2PriorityFieldsDecoderTest : public Http2StructureDecoderTest<Http2PriorityFields> { };
...
class Http2RstStreamFieldsDecoderTest : public Http2StructureDecoderTest<Http2RstStreamFields> { };
...
class Http2SettingFieldsDecoderTest : public Http2StructureDecoderTest<Http2SettingFields> { };
...
class Http2PushPromiseFieldsDecoderTest : public Http2StructureDecoderTest<Http2PushPromiseFields> { };
...
class Http2PingFieldsDecoderTest : public Http2StructureDecoderTest<Http2PingFields> { };
...
class Http2GoAwayFieldsDecoderTest : public Http2StructureDecoderTest<Http2GoAwayFields> { };
...
class Http2WindowUpdateFieldsDecoderTest : public Http2StructureDecoderTest<Http2WindowUpdateFields> { };
...
class Http2AltSvcFieldsDecoderTest : public Http2StructureDecoderTest<Http2AltSvcFields> { };
