...
#ifndef NDEBUG
void DecodeBuffer::set_subset_of_base(DecodeBuffer* base, const DecodeBufferSubset* subset)
{
    QUICHE_DCHECK_EQ(this, subset);
    base->set_subset(subset);
}
void DecodeBuffer::clear_subset_of_base(DecodeBuffer* base, const DecodeBufferSubset* subset)
{
    QUICHE_DCHECK_EQ(this, subset);
...
void DecodeBufferSubset::DebugTearDown()
{
    ...
    QUICHE_DCHECK_EQ(start_base_offset_, base_buffer_->Offset()) << "The base buffer was modified";
