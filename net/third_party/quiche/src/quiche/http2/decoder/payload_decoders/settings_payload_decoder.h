...
private:
    ...
    DecodeStatus StartDecodingSettings(FrameDecoderState* state, DecodeBuffer* db);
    ...
    DecodeStatus HandleNotDone(FrameDecoderState* state, DecodeBuffer* db, DecodeStatus status);
