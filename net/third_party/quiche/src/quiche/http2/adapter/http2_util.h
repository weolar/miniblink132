...
QUICHE_EXPORT absl::string_view ConnectionErrorToString(Http2VisitorInterface::ConnectionError error);

QUICHE_EXPORT absl::string_view InvalidFrameErrorToString(Http2VisitorInterface::InvalidFrameError error);
...
QUICHE_EXPORT bool DeltaAtLeastHalfLimit(int64_t limit, int64_t /*size*/, int64_t delta);
