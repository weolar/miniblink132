...
public:
    ...
    static bool IsValidHeaderValue(absl::string_view value, ObsTextOption ops_text_option);
...
private:
    ...
    static bool ValidateRequestHeaders(const PseudoHeaderTagSet& pseudo_headers, const PseudoHeaderStateSet& pseudo_header_state, bool allow_extended_connect);
    ...
    static bool ValidateResponseTrailers(const PseudoHeaderTagSet& pseudo_headers);
