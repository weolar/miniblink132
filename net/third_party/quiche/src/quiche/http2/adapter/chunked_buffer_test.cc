...
constexpr absl::string_view kLoremIpsum = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod "
...
TEST(ChunkedBufferTest, LargeAppendAfterEmptied)
{
    ...
    buffer.RemovePrefix(9);
    auto more_data = MakeDataAndSize(absl::StrCat("different data", std::string(2048, 'x')));
...
TEST(ChunkedBufferTest, RemovePartialPrefix)
{
    ...
    const std::initializer_list<absl::string_view> parts = { kLoremIpsum.substr(26), " Anday igpay atinlay!" };
