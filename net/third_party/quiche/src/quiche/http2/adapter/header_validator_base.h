...
public:
    ...
    virtual HeaderStatus ValidateSingleHeader(absl::string_view key, absl::string_view value) = 0;
    ...
    {
        max_field_size_ = field_size;
    }
    void SetObsTextOption(ObsTextOption option)
    {
        obs_text_option_ = option;
    }
    ...
    void SetValidatePath()
    {
        validate_path_ = true;
    }
    void SetAllowFragmentInPath()
    {
        allow_fragment_in_path_ = true;
    }
