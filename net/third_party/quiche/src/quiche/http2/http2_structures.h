...
struct QUICHE_EXPORT Http2FrameHeader {
    ...
    Http2FrameHeader(uint32_t payload_length, Http2FrameType type, uint8_t flags, uint32_t stream_id)
        : payload_length(payload_length)
        , stream_id(stream_id)
        , type(type)
        , flags(flags)
    {
        QUICHE_DCHECK_LT(payload_length, static_cast<uint32_t>(1 << 24)) << "Payload Length is only a 24 bit field\n" << ToString();
    }
    ...
    // otherwise false.
    bool HasAnyFlags(uint8_t flag_mask) const
    {
        return 0 != (flags & flag_mask);
    }

    // Is the END_STREAM flag set?
    bool IsEndStream() const
    {
        QUICHE_DCHECK(type == Http2FrameType::DATA || type == Http2FrameType::HEADERS) << ToString();
    ...
    bool IsAck() const
    {
        QUICHE_DCHECK(type == Http2FrameType::SETTINGS || type == Http2FrameType::PING) << ToString();
    ...
    {
        QUICHE_DCHECK(type == Http2FrameType::HEADERS || type == Http2FrameType::PUSH_PROMISE || type == Http2FrameType::CONTINUATION) << ToString();
    ...
    bool IsPadded() const
    {
        QUICHE_DCHECK(type == Http2FrameType::DATA || type == Http2FrameType::HEADERS || type == Http2FrameType::PUSH_PROMISE) << ToString();
...
QUICHE_EXPORT bool operator==(const Http2FrameHeader& a, const Http2FrameHeader& b);
QUICHE_EXPORT inline bool operator!=(const Http2FrameHeader& a, const Http2FrameHeader& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2FrameHeader& v);
...
struct QUICHE_EXPORT Http2PriorityFields {
    ...
    Http2PriorityFields(uint32_t stream_dependency, uint32_t weight, bool is_exclusive)
        ...
        , is_exclusive(is_exclusive)
    {
        ...
        QUICHE_DCHECK_EQ(stream_dependency, stream_dependency & StreamIdMask()) << "Stream Dependency is only a 31-bit field.\n" << ToString();
...
QUICHE_EXPORT bool operator==(const Http2PriorityFields& a, const Http2PriorityFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2PriorityFields& a, const Http2PriorityFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2PriorityFields& v);
...
QUICHE_EXPORT bool operator==(const Http2RstStreamFields& a, const Http2RstStreamFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2RstStreamFields& a, const Http2RstStreamFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2RstStreamFields& v);
...
QUICHE_EXPORT bool operator==(const Http2SettingFields& a, const Http2SettingFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2SettingFields& a, const Http2SettingFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2SettingFields& v);
...
QUICHE_EXPORT bool operator==(const Http2PushPromiseFields& a, const Http2PushPromiseFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2PushPromiseFields& a, const Http2PushPromiseFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2PushPromiseFields& v);
...
QUICHE_EXPORT bool operator==(const Http2PingFields& a, const Http2PingFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2PingFields& a, const Http2PingFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2PingFields& v);
...
QUICHE_EXPORT bool operator==(const Http2GoAwayFields& a, const Http2GoAwayFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2GoAwayFields& a, const Http2GoAwayFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2GoAwayFields& v);
...
QUICHE_EXPORT bool operator==(const Http2WindowUpdateFields& a, const Http2WindowUpdateFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2WindowUpdateFields& a, const Http2WindowUpdateFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2WindowUpdateFields& v);
...
QUICHE_EXPORT bool operator==(const Http2AltSvcFields& a, const Http2AltSvcFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2AltSvcFields& a, const Http2AltSvcFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2AltSvcFields& v);
...
QUICHE_EXPORT bool operator==(const Http2PriorityUpdateFields& a, const Http2PriorityUpdateFields& b);
QUICHE_EXPORT inline bool operator!=(const Http2PriorityUpdateFields& a, const Http2PriorityUpdateFields& b)
{
    return !(a == b);
}
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const Http2PriorityUpdateFields& v);
