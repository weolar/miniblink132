...
struct QUICHE_NO_EXPORT HpackStringCollector : public HpackStringDecoderListener {
    enum CollectorState {
        kGenesis,
        kStarted,
        kEnded,
    ...
    ::testing::AssertionResult Collected(absl::string_view str, bool is_huffman_encoded) const;
...
QUICHE_NO_EXPORT std::ostream& operator<<(std::ostream& out, const HpackStringCollector& v);
