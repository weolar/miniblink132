...
void HpackBlockBuilder::AppendHighBitsAndVarint(uint8_t high_bits, uint8_t prefix_length, uint64_t varint)
{
...
void HpackBlockBuilder::AppendEntryTypeAndVarint(HpackEntryType entry_type, uint64_t varint)
{
    uint8_t high_bits;
...
void HpackBlockBuilder::AppendString(bool is_huffman_encoded, absl::string_view str)
{
