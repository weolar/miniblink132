...
#define HTTP2_VERIFY_EQ(value1, value2) HTTP2_VERIFY_CORE((value1) == (value2), #value1 "==" #value2)
#define HTTP2_VERIFY_NE(value1, value2) HTTP2_VERIFY_CORE((value1) != (value2), #value1 "!=" #value2)
#define HTTP2_VERIFY_LE(value1, value2) HTTP2_VERIFY_CORE((value1) <= (value2), #value1 "<=" #value2)
#define HTTP2_VERIFY_LT(value1, value2) HTTP2_VERIFY_CORE((value1) < (value2), #value1 "<" #value2)
#define HTTP2_VERIFY_GT(value1, value2) HTTP2_VERIFY_CORE((value1) > (value2), #value1 ">" #value2)
