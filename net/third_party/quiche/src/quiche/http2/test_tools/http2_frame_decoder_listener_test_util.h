...
// expected calls.
class QUICHE_NO_EXPORT FailingHttp2FrameDecoderListener : public Http2FrameDecoderListener {
public:
...
private:
    void EnsureNotAbstract()
    {
        FailingHttp2FrameDecoderListener instance;
    }
};

// QUICHE_VLOG's all the calls it receives, and forwards those calls to an
// optional listener.
class QUICHE_NO_EXPORT LoggingHttp2FrameDecoderListener : public Http2FrameDecoderListener {
public:
...
private:
    void EnsureNotAbstract()
    {
        LoggingHttp2FrameDecoderListener instance;
    }
