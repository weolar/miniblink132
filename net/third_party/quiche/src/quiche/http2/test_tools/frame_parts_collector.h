...
class QUICHE_NO_EXPORT FramePartsCollector : public FailingHttp2FrameDecoderListener {
public:
    FramePartsCollector();
    ...
    const FrameParts* current_frame() const
    {
