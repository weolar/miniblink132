...
std::ostream& operator<<(std::ostream& out, HpackStringCollector::CollectorState v)
{
    switch (v) {
...
::testing::AssertionResult HpackStringCollector::Collected(absl::string_view str, bool is_huffman_encoded) const
{
...
{
    return a.s == b.s && a.len == b.len && a.huffman_encoded == b.huffman_encoded && a.state == b.state;
}
