...
class QUICHE_NO_EXPORT FramePartsCollectorListener : public FramePartsCollector {
public:
    ...
    void OnPriorityFrame(const Http2FrameHeader& header, const Http2PriorityFields& priority_fields) override;
    ...
    void OnWindowUpdate(const Http2FrameHeader& header, uint32_t window_size_increment) override;
