...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, const HpackEntryDecoder& v);
QUICHE_EXPORT std::ostream& operator<<(std::ostream& out, HpackEntryDecoder::EntryDecoderState state);
