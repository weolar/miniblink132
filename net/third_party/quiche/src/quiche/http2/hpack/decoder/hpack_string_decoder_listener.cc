...
void HpackStringDecoderVLoggingListener::OnStringStart(bool huffman_encoded, size_t len)
{
...
void HpackStringDecoderVLoggingListener::OnStringData(const char* data, size_t len)
{
