...
void HpackDecoderNoOpListener::OnHeader(absl::string_view /*name*/, absl::string_view /*value*/)
{
}
void HpackDecoderNoOpListener::OnHeaderListEnd()
{
}
void HpackDecoderNoOpListener::OnHeaderErrorDetected(absl::string_view /*error_message*/)
{
}
...
{
    static HpackDecoderNoOpListener* static_instance = new HpackDecoderNoOpListener();
