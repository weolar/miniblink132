...
public:
    ...
    virtual void OnStartLiteralHeader(HpackEntryType entry_type, size_t maybe_name_index) = 0;
...
class QUICHE_EXPORT HpackEntryDecoderVLoggingListener : public HpackEntryDecoderListener {
public:
    HpackEntryDecoderVLoggingListener()
        : wrapped_(nullptr)
    {
    }
    ...
    void OnStartLiteralHeader(HpackEntryType entry_type, size_t maybe_name_index) override;
...
class QUICHE_EXPORT HpackEntryDecoderNoOpListener : public HpackEntryDecoderListener {
public:
