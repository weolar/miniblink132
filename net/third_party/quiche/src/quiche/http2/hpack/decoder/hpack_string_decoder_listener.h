...
class QUICHE_EXPORT HpackStringDecoderVLoggingListener : public HpackStringDecoderListener {
public:
    HpackStringDecoderVLoggingListener()
        : wrapped_(nullptr)
    {
    }
    explicit HpackStringDecoderVLoggingListener(HpackStringDecoderListener* wrapped)
        : wrapped_(wrapped)
    {
    }
