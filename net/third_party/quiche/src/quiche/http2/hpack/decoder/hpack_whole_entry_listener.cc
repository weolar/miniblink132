...
void HpackWholeEntryNoOpListener::OnNameIndexAndLiteralValue(HpackEntryType /*entry_type*/, size_t /*name_index*/, HpackDecoderStringBuffer* /*value_buffer*/)
{
}
void HpackWholeEntryNoOpListener::OnLiteralNameAndValue(
    HpackEntryType /*entry_type*/, HpackDecoderStringBuffer* /*name_buffer*/, HpackDecoderStringBuffer* /*value_buffer*/)
{
}
...
{
    static HpackWholeEntryNoOpListener* static_instance = new HpackWholeEntryNoOpListener();
