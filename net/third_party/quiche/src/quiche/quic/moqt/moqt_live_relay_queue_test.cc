...
class TestMoqtLiveRelayQueue : public MoqtLiveRelayQueue, public MoqtObjectListener {
public:
    TestMoqtLiveRelayQueue()
        : MoqtLiveRelayQueue(FullTrackName { "test", "track" }, MoqtForwardingPreference::kSubgroup)
    {
    ...
    MOCK_METHOD(void, CloseStreamForSubgroup, (uint64_t group_id, uint64_t subgroup_id), ());
...
TEST(MoqtLiveRelayQueue, SingleGroup)
{
    ...
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 3 }, MoqtObjectStatus::kEndOfGroup));
}
...
TEST(MoqtLiveRelayQueue, FiveGroups)
{
    ...
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 0 }, "a"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 1 }, "b"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 2 }, MoqtObjectStatus::kEndOfGroup));
    EXPECT_TRUE(queue.AddObject(FullSequence { 1, 0 }, "c"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 1, 1 }, "d"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 1, 2 }, MoqtObjectStatus::kEndOfGroup));
    EXPECT_TRUE(queue.AddObject(FullSequence { 2, 0 }, "e"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 2, 1 }, "f"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 2, 2 }, MoqtObjectStatus::kEndOfGroup));
    EXPECT_TRUE(queue.AddObject(FullSequence { 3, 0 }, "g"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 3, 1 }, "h"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 3, 2 }, MoqtObjectStatus::kEndOfGroup));
...
TEST(MoqtLiveRelayQueue, EndOfTrack)
{
    ...
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 0 }, "a"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 2 }, "c"));
    EXPECT_FALSE(queue.AddObject(FullSequence { 0, 1 }, MoqtObjectStatus::kEndOfTrack));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 3 }, MoqtObjectStatus::kEndOfTrack));
}
...
TEST(MoqtLiveRelayQueue, EndOfGroup)
{
    ...
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 0 }, "a"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 2 }, "c"));
    EXPECT_FALSE(queue.AddObject(FullSequence { 0, 1 }, MoqtObjectStatus::kEndOfGroup));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 3 }, MoqtObjectStatus::kEndOfGroup));
...
TEST(MoqtLiveRelayQueue, GroupDoesNotExist)
{
    ...
    EXPECT_FALSE(queue.AddObject(FullSequence { 0, 1 }, MoqtObjectStatus::kGroupDoesNotExist));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 0 }, MoqtObjectStatus::kGroupDoesNotExist));
}
...
TEST(MoqtLiveRelayQueue, DifferentSubgroups)
{
    ...
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 0, 4 }, MoqtObjectStatus::kEndOfSubgroup));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 1, 5 }, "e"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 2, 7 }, "f"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 1, 6 }, MoqtObjectStatus::kEndOfSubgroup));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 2, 8 }, MoqtObjectStatus::kEndOfSubgroup));
    queue.CallSubscribeForPast(SubscribeWindow(0, 0));
}
...
TEST(MoqtLiveRelayQueue, EndOfSubgroup)
{
    ...
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 0, 0 }, "a"));
    EXPECT_TRUE(queue.AddObject(FullSequence { 0, 0, 1 }, MoqtObjectStatus::kEndOfSubgroup));
