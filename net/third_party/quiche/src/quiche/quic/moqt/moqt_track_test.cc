...
{
    EXPECT_TRUE(track_.CheckForwardingPreference(MoqtForwardingPreference::kSubgroup));
    EXPECT_TRUE(track_.CheckForwardingPreference(MoqtForwardingPreference::kSubgroup));
    EXPECT_FALSE(track_.CheckForwardingPreference(MoqtForwardingPreference::kDatagram));
}
