...
public:
    explicit MoqtOutgoingQueue(FullTrackName track, MoqtForwardingPreference forwarding_preference)
    ...
    std::unique_ptr<MoqtFetchTask> Fetch(FullSequence start, uint64_t end_group, std::optional<uint64_t> end_object, MoqtDeliveryOrder order) override;
...
private:
    ...
    public:
        ...
        absl::Status GetStatus() override
        {
            return status_;
        }
