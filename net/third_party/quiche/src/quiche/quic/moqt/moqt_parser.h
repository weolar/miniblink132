...
public:
    ...
    virtual void OnTrackStatusRequestMessage(const MoqtTrackStatusRequest& message) = 0;
    ...
    virtual void OnSubscribeAnnouncesMessage(const MoqtSubscribeAnnounces& message) = 0;
    virtual void OnSubscribeAnnouncesOkMessage(const MoqtSubscribeAnnouncesOk& message) = 0;
    virtual void OnSubscribeAnnouncesErrorMessage(const MoqtSubscribeAnnouncesError& message) = 0;
    virtual void OnUnsubscribeAnnouncesMessage(const MoqtUnsubscribeAnnounces& message) = 0;
...
public:
    ...
    virtual void OnObjectMessage(const MoqtObject& message, absl::string_view payload, bool end_of_message) = 0;
...
private:
    ...
    bool ReadParameter(quic::QuicDataReader& reader, uint64_t& type, absl::string_view& value);
    ...
    bool ReadSubscribeParameters(quic::QuicDataReader& reader, MoqtSubscribeParameters& params);
    ...
    bool ReadTrackNamespace(quic::QuicDataReader& reader, FullTrackName& full_track_name);
