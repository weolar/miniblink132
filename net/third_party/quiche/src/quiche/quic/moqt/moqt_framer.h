...
public:
    ...
    quiche::QuicheBuffer SerializeObjectHeader(const MoqtObject& message, MoqtDataStreamType message_type, bool is_first_in_stream);
    quiche::QuicheBuffer SerializeObjectDatagram(const MoqtObject& message, absl::string_view payload);
    ...
    quiche::QuicheBuffer SerializeSubscribeError(const MoqtSubscribeError& message);
    ...
    quiche::QuicheBuffer SerializeSubscribeUpdate(const MoqtSubscribeUpdate& message);
    ...
    quiche::QuicheBuffer SerializeAnnounceCancel(const MoqtAnnounceCancel& message);
    quiche::QuicheBuffer SerializeTrackStatusRequest(const MoqtTrackStatusRequest& message);
    ...
    quiche::QuicheBuffer SerializeSubscribeAnnounces(const MoqtSubscribeAnnounces& message);
    quiche::QuicheBuffer SerializeSubscribeAnnouncesOk(const MoqtSubscribeAnnouncesOk& message);
    quiche::QuicheBuffer SerializeSubscribeAnnouncesError(const MoqtSubscribeAnnouncesError& message);
    quiche::QuicheBuffer SerializeUnsubscribeAnnounces(const MoqtUnsubscribeAnnounces& message);
    quiche::QuicheBuffer SerializeMaxSubscribeId(const MoqtMaxSubscribeId& message);
...
private:
    ...
    static bool ValidateObjectMetadata(const MoqtObject& object, MoqtDataStreamType message_type);
