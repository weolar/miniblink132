...
absl::StatusOr<SocketFd> CreateSocket(IpAddressFamily address_family, SocketProtocol protocol, bool blocking = false);
...
absl::Status SetIpHeaderIncluded(SocketFd fd, IpAddressFamily address_family, bool ip_header_included);
...
absl::StatusOr<absl::Span<char>> Receive(SocketFd fd, absl::Span<char> buffer, bool peek = false);
