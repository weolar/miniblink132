...
public:
    ...
    protected:
        ...
        virtual void SetWriteSecret(EncryptionLevel level, const SSL_CIPHER* cipher, absl::Span<const uint8_t> write_secret) = 0;
        ...
        virtual bool SetReadSecret(EncryptionLevel level, const SSL_CIPHER* cipher, absl::Span<const uint8_t> read_secret) = 0;
        ...
        virtual void WriteMessage(EncryptionLevel level, absl::string_view data) = 0;
        ...
        virtual void MessageCallback(bool is_write, int version, int content_type, absl::string_view data) = 0;
    ...
    static enum ssl_encryption_level_t BoringEncryptionLevel(EncryptionLevel level);
...
private:
    ...
    static int SetReadSecretCallback(SSL* ssl, enum ssl_encryption_level_t level, const SSL_CIPHER* cipher, const uint8_t* secret, size_t secret_len);
    static int SetWriteSecretCallback(SSL* ssl, enum ssl_encryption_level_t level, const SSL_CIPHER* cipher, const uint8_t* secret, size_t secret_len);
