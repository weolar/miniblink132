...
std::string AesBaseDecrypter::GenerateHeaderProtectionMask(QuicDataReader* sample_reader)
{
...
QuicPacketCount AesBaseDecrypter::GetIntegrityLimit() const
{
    ...
    static_assert(kMaxIncomingPacketSize <= 2048, "This key limit requires limits on decryption payload sizes");
