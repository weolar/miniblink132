...
struct QUICHE_EXPORT TransportParameters {
    ...
    public:
        ...
        friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const IntegerParameter& param);
    ...
    private:
        ...
        IntegerParameter(TransportParameterId param_id, uint64_t default_value, uint64_t min_value, uint64_t max_value);
    ...
    struct QUICHE_EXPORT PreferredAddress {
        ...
        friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const TransportParameters& params);
    };
    ...
    struct QUICHE_EXPORT LegacyVersionInformation {
        ...
        LegacyVersionInformation& operator=(const LegacyVersionInformation& other) = default;
        LegacyVersionInformation& operator=(LegacyVersionInformation&& other) = default;
        ...
        // Allows easily logging.
        std::string ToString() const;
        friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const LegacyVersionInformation& legacy_version_information);
    };
    ...
    struct QUICHE_EXPORT VersionInformation {
        ...
        // Allows easily logging.
        std::string ToString() const;
        friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const VersionInformation& version_information);
    };
...
QUICHE_EXPORT bool SerializeTransportParameters(const TransportParameters& in, std::vector<uint8_t>* out);
...
// On failure, this method will write a human-readable error message to
// |error_details|.
QUICHE_EXPORT bool ParseTransportParameters(
...
QUICHE_EXPORT bool SerializeTransportParametersForTicket(
    const TransportParameters& in, const std::vector<uint8_t>& application_data, std::vector<uint8_t>* out);
