...
public:
    ...
    virtual void Run(bool ok, const std::string& error_details, std::unique_ptr<ProofVerifyDetails>* details) = 0;
};
...
public:
    ...
    // case of RSA.
    virtual QuicAsyncStatus VerifyProof(const std::string& hostname, uint16_t port, const std::string& server_config, QuicTransportVersion transport_version,
    ...
    virtual QuicAsyncStatus VerifyCertChain(const std::string& hostname, uint16_t port, const std::vector<std::string>& certs, const std::string& ocsp_response,
