...
public:
    ...
    TlsClientConnection(SSL_CTX* ssl_ctx, Delegate* delegate, QuicSSLConfig ssl_config);
    ...
    void SetCertChain(const std::vector<CRYPTO_BUFFER*>& cert_chain, EVP_PKEY* privkey);
