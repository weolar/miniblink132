...
QuicData* EncryptWithNonce(Aes128Gcm12Encrypter* encrypter, absl::string_view nonce, absl::string_view associated_data, absl::string_view plaintext)
{
...
TEST_F(Aes128Gcm12EncrypterTest, Encrypt)
{
    for (size_t i = 0; i < ABSL_ARRAYSIZE(test_group_array); i++) {
        ...
        for (size_t j = 0; test_vectors[j].key != nullptr; j++) {
            ...
            // the first 12.
            ASSERT_LE(static_cast<size_t>(Aes128Gcm12Encrypter::kAuthTagSize), tag.length());
