...
public:
    ...
    static std::unique_ptr<Curve25519KeyExchange> New(absl::string_view private_key);
    ...
    bool CalculateSharedKeySync(absl::string_view peer_public_value, std::string* shared_key) const override;
    absl::string_view public_value() const override;
    QuicTag type() const override
    {
        return kC255;
    }
