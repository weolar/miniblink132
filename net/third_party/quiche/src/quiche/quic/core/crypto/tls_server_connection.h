...
public:
    ...
    protected:
        ...
        virtual ssl_select_cert_result_t EarlySelectCertCallback(const SSL_CLIENT_HELLO* client_hello) = 0;
        ...
        virtual int SelectAlpn(const uint8_t** out, uint8_t* out_len, const uint8_t* in, unsigned in_len) = 0;
        ...
        // |*out_len|.
        virtual ssl_private_key_result_t PrivateKeySign(uint8_t* out, size_t* out_len, size_t max_out, uint16_t sig_alg, absl::string_view in) = 0;
        ...
        virtual ssl_private_key_result_t PrivateKeyComplete(uint8_t* out, size_t* out_len, size_t max_out) = 0;
        ...
        virtual int SessionTicketSeal(uint8_t* out, size_t* out_len, size_t max_out_len, absl::string_view in) = 0;
        ...
        virtual enum ssl_ticket_aead_result_t SessionTicketOpen(uint8_t* out, size_t* out_len, size_t max_out_len, absl::string_view in) = 0;
    ...
    TlsServerConnection(SSL_CTX* ssl_ctx, Delegate* delegate, QuicSSLConfig ssl_config);
    ...
    absl::Status ConfigureSSL(ProofSourceHandleCallback::ConfigureSSLFunc configure_ssl);
...
private:
    ...
    static int SelectAlpnCallback(SSL* ssl, const uint8_t** out, uint8_t* out_len, const uint8_t* in, unsigned in_len, void* arg);
    ...
    static ssl_private_key_result_t PrivateKeySign(SSL* ssl, uint8_t* out, size_t* out_len, size_t max_out, uint16_t sig_alg, const uint8_t* in, size_t in_len);
    static ssl_private_key_result_t PrivateKeyComplete(SSL* ssl, uint8_t* out, size_t* out_len, size_t max_out);
    ...
    static int SessionTicketSeal(SSL* ssl, uint8_t* out, size_t* out_len, size_t max_out_len, const uint8_t* in, size_t in_len);
    static enum ssl_ticket_aead_result_t SessionTicketOpen(SSL* ssl, uint8_t* out, size_t* out_len, size_t max_out_len, const uint8_t* in, size_t in_len);
