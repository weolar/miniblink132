...
public:
    ...
    static std::unique_ptr<QuicEncrypter> Create(const ParsedQuicVersion& version, QuicTag algorithm);
    ...
    static std::unique_ptr<QuicEncrypter> CreateFromCipherSuite(uint32_t cipher_suite);
    ...
    // be empty.
    virtual std::string GenerateHeaderProtectionMask(absl::string_view sample) = 0;
