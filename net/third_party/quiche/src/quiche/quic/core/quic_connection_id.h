...
public:
    ...
    template <typename H> friend H AbslHashValue(H h, const QuicConnectionId& c)
    {
    ...
    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicConnectionId& v);
