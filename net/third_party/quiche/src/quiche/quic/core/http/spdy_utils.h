...
public:
    ...
    // missing.
    static bool ExtractContentLengthFromHeaders(int64_t* content_length, quiche::HttpHeaderBlock* headers);

    // Copies a list of headers to a Http2HeaderBlock.
    static bool CopyAndValidateHeaders(const QuicHeaderList& header_list, int64_t* content_length, quiche::HttpHeaderBlock* headers);
    ...
    static bool PopulateHeaderBlockFromUrl(const std::string url, quiche::HttpHeaderBlock* headers);
