...
QUICHE_EXPORT std::string H3SettingsToString(Http3AndQpackSettingsIdentifiers identifier);
...
ABSL_CONST_INIT QUICHE_EXPORT extern const absl::string_view kUserAgentHeaderName;
