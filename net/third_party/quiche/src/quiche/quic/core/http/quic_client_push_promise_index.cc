...
QuicClientPromisedInfo* QuicClientPushPromiseIndex::GetPromised(const std::string& url)
{
...
QuicAsyncStatus QuicClientPushPromiseIndex::Try(const spdy::Http2HeaderBlock& request, QuicClientPushPromiseIndex::Delegate* delegate, TryHandle** handle)
{
