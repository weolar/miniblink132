...
public:
    WebTransportStreamAdapter(QuicSession* session, QuicStream* stream, QuicStreamSequencer* sequencer, std::optional<QuicStreamId> session_id);
    ...
    QuicStreamId GetStreamId() const override
    {
        return stream_->id();
    }
    ...
    WebTransportStreamVisitor* visitor() override
    {
        return visitor_.get();
    }
