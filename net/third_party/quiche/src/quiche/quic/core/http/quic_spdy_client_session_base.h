...
class QUICHE_EXPORT QuicSpdyClientSessionBase : public QuicSpdySession, public QuicCryptoClientStream::ProofHandler {
public:
    ...
    QuicSpdyClientSessionBase& operator=(const QuicSpdyClientSessionBase&) = delete;
