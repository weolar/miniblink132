...
public:
    ...
    QuicServerSessionBase(const QuicConfig& config, const ParsedQuicVersionVector& supported_versions, QuicConnection* connection,
...
protected:
    ...
    std::optional<CachedNetworkParameters> GenerateCachedNetworkParameters() const override;
...
private:
    ...
    int32_t BandwidthToCachedParameterBytesPerSecond(const QuicBandwidth& bandwidth) const;
};
