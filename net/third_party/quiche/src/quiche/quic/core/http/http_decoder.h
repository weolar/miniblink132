...
public:
    ...
    public:
        ...
        virtual bool OnDataFrameStart(QuicByteCount header_length, QuicByteCount payload_length) = 0;
        ...
        virtual bool OnHeadersFrameStart(QuicByteCount header_length, QuicByteCount payload_length) = 0;
        ...
        // process to cease.
        virtual void OnWebTransportStreamFrameType(QuicByteCount header_length, WebTransportSessionId session_id) = 0;

        // Called when a METADATA frame has been received.
        // |header_length| and |payload_length| are the length of the frame header
        // and payload, respectively.
        virtual bool OnMetadataFrameStart(QuicByteCount header_length, QuicByteCount payload_length) = 0;
        ...
        // |header_length| and |payload_length| are the length of the frame header
        // and payload, respectively.
        virtual bool OnUnknownFrameStart(uint64_t frame_type, QuicByteCount header_length, QuicByteCount payload_length) = 0;
    ...
    static bool DecodeSettings(const char* data, QuicByteCount len, SettingsFrame* frame);
    ...
    {
        return state_ == STATE_READING_FRAME_TYPE;
    }

    // Indicates that WEBTRANSPORT_STREAM should be parsed.
    void EnableWebTransportStreamParsing()
    {
        allow_web_transport_stream_ = true;
    }
...
private:
    ...
    bool ParsePriorityUpdateFrame(QuicDataReader& reader, PriorityUpdateFrame& frame);
