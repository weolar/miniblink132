...
public:
    ...
    MOCK_METHOD(void, OnCapsuleParseFailure, (const std::string& error_message), (override));
};
...
public:
    ...
    {
        quiche::QuicheBuffer serialized_capsule = SerializeCapsule(capsule, quiche::SimpleBufferAllocator::Get());
...
{
    std::string capsule_fragment = absl::HexStringToBytes("80ff37a0" // LEGACY_DATAGRAM capsule type
                                                          "08" // capsule length
...
{
    std::string capsule_fragment = absl::HexStringToBytes("80ff37a5" // DATAGRAM_WITHOUT_CONTEXT capsule type
                                                          "08" // capsule length
                                                          "a1a2a3a4a5a6a7a8" // HTTP Datagram payload
    );
    std::string datagram_payload = absl::HexStringToBytes("a1a2a3a4a5a6a7a8");
...
{
    std::string capsule_fragment = absl::HexStringToBytes("6843" // CLOSE_WEBTRANSPORT_STREAM capsule type
                                                          "09" // capsule length
...
{
    std::string capsule_fragment = absl::HexStringToBytes("9ECA6A00" // ADDRESS_ASSIGN capsule type
...
{
    std::string capsule_fragment = absl::HexStringToBytes("9ECA6A01" // ADDRESS_REQUEST capsule type
                                                          "1A" // capsule length = 26
...
{
    std::string capsule_fragment = absl::HexStringToBytes("9ECA6A02" // ROUTE_ADVERTISEMENT capsule type
...
{
    std::string capsule_fragment = absl::HexStringToBytes("33" // unknown capsule type of 0x33
                                                          "08" // capsule length
...
TEST_F(CapsuleTest, TwoCapsules)
{
    ...
    Capsule expected_capsule1 = Capsule::DatagramWithoutContext(datagram_payload1);
    Capsule expected_capsule2 = Capsule::DatagramWithoutContext(datagram_payload2);
    {
        InSequence s;
...
{
    std::string capsule_fragment1 = absl::HexStringToBytes("80ff37a5" // first capsule DATAGRAM_WITHOUT_CONTEXT capsule type
                                                           "08" // frist capsule length
                                                           "a1a2a3a4" // first half of HTTP Datagram payload of first capsule
    );
    std::string capsule_fragment2 = absl::HexStringToBytes("a5a6a7a8" // second half of HTTP Datagram payload 1
                                                           "80ff37a5" // second capsule DATAGRAM_WITHOUT_CONTEXT capsule type
    );
    std::string capsule_fragment3 = absl::HexStringToBytes("08" // second capsule length
