...
public:
    ...
    static quiche::QuicheBuffer SerializeDataFrameHeader(QuicByteCount payload_length, quiche::QuicheBufferAllocator* allocator);
    ...
    static std::string SerializePriorityUpdateFrame(const PriorityUpdateFrame& priority_update);
    ...
    static std::string SerializeWebTransportStreamFrameHeader(WebTransportSessionId session_id);
