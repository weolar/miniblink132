...
QuicMaxStreamsFrame::QuicMaxStreamsFrame(QuicControlFrameId control_frame_id, QuicStreamCount stream_count, bool unidirectional)
    : QuicInlinedFrame(MAX_STREAMS_FRAME)
...
{
    os << "{ control_frame_id: " << frame.control_frame_id << ", stream_count: " << frame.stream_count
