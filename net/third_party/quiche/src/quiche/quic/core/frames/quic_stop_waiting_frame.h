...
struct QUICHE_EXPORT QuicStopWaitingFrame : public QuicInlinedFrame<QuicStopWaitingFrame> {
    QuicStopWaitingFrame();

    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicStopWaitingFrame& s);
