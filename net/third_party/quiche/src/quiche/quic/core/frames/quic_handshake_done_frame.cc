...
QuicHandshakeDoneFrame::QuicHandshakeDoneFrame(QuicControlFrameId control_frame_id)
    : QuicInlinedFrame(HANDSHAKE_DONE_FRAME)
    , control_frame_id(control_frame_id)
{
}

std::ostream& operator<<(std::ostream& os, const QuicHandshakeDoneFrame& handshake_done_frame)
{
