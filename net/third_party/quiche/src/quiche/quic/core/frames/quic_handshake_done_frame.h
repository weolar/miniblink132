...
struct QUICHE_EXPORT QuicHandshakeDoneFrame : public QuicInlinedFrame<QuicHandshakeDoneFrame> {
    QuicHandshakeDoneFrame();
    explicit QuicHandshakeDoneFrame(QuicControlFrameId control_frame_id);

    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicHandshakeDoneFrame& handshake_done_frame);
