...
struct QUICHE_EXPORT QuicGoAwayFrame {
    ...
    QuicGoAwayFrame(QuicControlFrameId control_frame_id, QuicErrorCode error_code, QuicStreamId last_good_stream_id, const std::string& reason);

    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicGoAwayFrame& g);
