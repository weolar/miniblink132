...
struct QUICHE_EXPORT QuicPaddingFrame : public QuicInlinedFrame<QuicPaddingFrame> {
    QuicPaddingFrame()
        : QuicInlinedFrame(PADDING_FRAME)
    {
    }
    ...
    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicPaddingFrame& padding_frame);
