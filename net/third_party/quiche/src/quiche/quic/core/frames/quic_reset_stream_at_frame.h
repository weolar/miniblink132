...
struct QUICHE_EXPORT QuicResetStreamAtFrame {
    ...
    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicResetStreamAtFrame& frame);
    ...
    {
        return QuicRstStreamFrame(control_frame_id, stream_id, static_cast<QuicRstStreamErrorCode>(error), final_offset);
    }
};
