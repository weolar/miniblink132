...
struct QUICHE_EXPORT QuicNewConnectionIdFrame {
    ...
    QuicNewConnectionIdFrame(QuicControlFrameId control_frame_id, QuicConnectionId connection_id, QuicConnectionIdSequenceNumber sequence_number,
        StatelessResetToken stateless_reset_token, uint64_t retire_prior_to);

    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicNewConnectionIdFrame& frame);
