...
struct QUICHE_EXPORT QuicRetireConnectionIdFrame {
    ...
    QuicRetireConnectionIdFrame(QuicControlFrameId control_frame_id, QuicConnectionIdSequenceNumber sequence_number);

    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicRetireConnectionIdFrame& frame);
