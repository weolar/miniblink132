...
struct QUICHE_EXPORT QuicMessageFrame {
    ...
    QuicMessageFrame(QuicMessageId message_id, absl::Span<quiche::QuicheMemSlice> span);
    ...
    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicMessageFrame& s);
