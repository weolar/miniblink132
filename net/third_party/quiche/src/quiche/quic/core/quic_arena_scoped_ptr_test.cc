...
INSTANTIATE_TEST_SUITE_P(QuicArenaScopedPtrParamTest, QuicArenaScopedPtrParamTest, testing::Values(TestParam::kFromHeap, TestParam::kFromArena),
...
TEST_P(QuicArenaScopedPtrParamTest, FromArena)
{
    ...
    EXPECT_FALSE(QuicArenaScopedPtr<TestObject>(new TestObject(0)).is_from_arena());
}
