...
public:
    ...
    virtual int Sendmmsg(int sockfd, mmsghdr* msgvec, unsigned int vlen, int flags);
};
...
public:
    explicit ScopedGlobalSyscallWrapperOverride(QuicSyscallWrapper* wrapper_in_scope);
