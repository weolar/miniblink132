...
static_assert(sizeof(StatelessResetToken) == kStatelessResetTokenLength, "bad size");

std::ostream& operator<<(std::ostream& os, const QuicConsumedData& s)
{
    os << "bytes_consumed: " << s.bytes_consumed << " fin_consumed: " << s.fin_consumed;
    return os;
}
...
std::string ConnectionCloseSourceToString(ConnectionCloseSource connection_close_source)
{
...
std::ostream& operator<<(std::ostream& os, const ConnectionCloseSource& connection_close_source)
{
    os << ConnectionCloseSourceToString(connection_close_source);
    return os;
}

std::string ConnectionCloseBehaviorToString(ConnectionCloseBehavior connection_close_behavior)
{
...
std::ostream& operator<<(std::ostream& os, const ConnectionCloseBehavior& connection_close_behavior)
{
...
{
    os << "{ packet_number: " << acked_packet.packet_number << ", bytes_acked: " << acked_packet.bytes_acked
       << ", receive_timestamp: " << acked_packet.receive_timestamp.ToDebuggingValue() << "} ";
    return os;
}

std::ostream& operator<<(std::ostream& os, const LostPacket& lost_packet)
{
    os << "{ packet_number: " << lost_packet.packet_number << ", bytes_lost: " << lost_packet.bytes_lost << "} ";
    return os;
}
...
std::string HistogramEnumString(WriteStatus enum_value)
{
    ...
    QUIC_DLOG(ERROR) << "Invalid WriteStatus value: " << static_cast<int16_t>(enum_value);
    return "<invalid>";
}
...
{
    return a.sni == b.sni && a.uaid == b.uaid && a.supported_groups == b.supported_groups && a.cert_compression_algos == b.cert_compression_algos
        && a.alpns == b.alpns && a.retry_token == b.retry_token && a.resumption_attempted == b.resumption_attempted
        && a.early_data_attempted == b.early_data_attempted;
}

std::ostream& operator<<(std::ostream& os, const ParsedClientHello& parsed_chlo)
{
    os << "{ sni:" << parsed_chlo.sni << ", uaid:" << parsed_chlo.uaid << ", alpns:" << quiche::PrintElements(parsed_chlo.alpns)
       << ", supported_groups:" << quiche::PrintElements(parsed_chlo.supported_groups)
       << ", cert_compression_algos:" << quiche::PrintElements(parsed_chlo.cert_compression_algos)
       << ", resumption_attempted:" << parsed_chlo.resumption_attempted << ", early_data_attempted:" << parsed_chlo.early_data_attempted
...
{
    return lhs.early_data_enabled == rhs.early_data_enabled && lhs.disable_ticket_support == rhs.disable_ticket_support
        && lhs.signing_algorithm_prefs == rhs.signing_algorithm_prefs && lhs.client_cert_mode == rhs.client_cert_mode
        && lhs.ech_config_list == rhs.ech_config_list && lhs.ech_grease_enabled == rhs.ech_grease_enabled;
}
