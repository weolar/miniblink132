...
constexpr QuicTime::Delta kPragueRttVirtMin = QuicTime::Delta::FromMilliseconds(25);
...
public:
    PragueSender(const QuicClock* clock, const RttStats* rtt_stats, QuicPacketCount initial_tcp_congestion_window, QuicPacketCount max_congestion_window,
