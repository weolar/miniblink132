...
public:
    ...
    struct QUICHE_EXPORT StandardDeviationCalculator {
        ...
        void OnNewRttSample(QuicTime::Delta rtt_sample, QuicTime::Delta smoothed_rtt);
    ...
    bool UpdateRtt(QuicTime::Delta send_delta, QuicTime::Delta ack_delay, QuicTime now);
