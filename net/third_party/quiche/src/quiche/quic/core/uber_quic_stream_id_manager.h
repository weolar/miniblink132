...
public:
    UberQuicStreamIdManager(Perspective perspective, ParsedQuicVersion version, QuicStreamIdManager::DelegateInterface* delegate,
    ...
    bool MaybeAllowNewOutgoingBidirectionalStreams(QuicStreamCount max_open_streams);
    ...
    void SetMaxOpenIncomingUnidirectionalStreams(QuicStreamCount max_open_streams);
    ...
    bool MaybeIncreaseLargestPeerStreamId(QuicStreamId id, std::string* error_details);
