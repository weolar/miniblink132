...
class QUICHE_EXPORT QpackDecoderStreamReceiver : public QpackInstructionDecoder::Delegate, public QpackStreamReceiver {
public:
    ...
    QpackDecoderStreamReceiver& operator=(const QpackDecoderStreamReceiver&) = delete;
