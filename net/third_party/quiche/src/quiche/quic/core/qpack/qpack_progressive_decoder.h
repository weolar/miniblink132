...
class QUICHE_EXPORT QpackProgressiveDecoder : public QpackInstructionDecoder::Delegate, public QpackDecoderHeaderTable::Observer {
public:
    ...
    public:
        ...
        virtual void OnHeaderDecoded(absl::string_view name, absl::string_view value) = 0;
        ...
        virtual void OnDecodingErrorDetected(QuicErrorCode error_code, absl::string_view error_message) = 0;
    };
    ...
    public:
        ...
        virtual void OnDecodingCompleted(QuicStreamId stream_id, uint64_t required_insert_count) = 0;
    };

    QpackProgressiveDecoder() = delete;
    QpackProgressiveDecoder(QuicStreamId stream_id, BlockedStreamLimitEnforcer* enforcer, DecodingCompletedVisitor* visitor,
    ...
    void OnInstructionDecodingError(QpackInstructionDecoder::ErrorCode error_code, absl::string_view error_message) override;
...
private:
    ...
    // valid.
    bool OnHeaderDecoded(bool value_from_static_table, absl::string_view name, absl::string_view value);
