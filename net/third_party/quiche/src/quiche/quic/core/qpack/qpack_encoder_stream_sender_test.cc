...
INSTANTIATE_TEST_SUITE_P(DisableHuffmanEncoding, QpackEncoderStreamSenderTest, testing::Values(false, true));
...
TEST_P(QpackEncoderStreamSenderTest, InsertWithNameReference)
{
    ...
    ASSERT_TRUE(absl::HexStringToBytes("aa7f005a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a"
...
TEST_P(QpackEncoderStreamSenderTest, InsertWithoutNameReference)
{
    ...
    if (DisableHuffmanEncoding()) {
        ...
        ASSERT_TRUE(absl::HexStringToBytes("43666f6f03666f6f", &expected_encoded_data));
    } else {
    ...
    // 'Z' would be Huffman encoded to 8 bits, so no Huffman encoding is used.
    ASSERT_TRUE(absl::HexStringToBytes("5f005a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a7f"
        ...
        &expected_encoded_data));
    EXPECT_CALL(delegate_, WriteStreamData(Eq(expected_encoded_data)));
    stream_.SendInsertWithoutNameReference(std::string(31, 'Z'), std::string(127, 'Z'));
    EXPECT_EQ(expected_encoded_data.size(), stream_.BufferedByteCount());
    stream_.Flush();
}
...
TEST_P(QpackEncoderStreamSenderTest, Coalesce)
{
    ...
    std::string expected_encoded_data;
    if (DisableHuffmanEncoding()) {
        ASSERT_TRUE(absl::HexStringToBytes("c500" // Insert entry with static name reference.
