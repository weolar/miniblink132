...
public:
    ...
    quiche::HttpHeaderBlock EncodeThenDecode(const quiche::HttpHeaderBlock& header_list)
    {
        NoopDecoderStreamErrorDelegate decoder_stream_error_delegate;
        NoopQpackStreamSenderDelegate encoder_stream_sender_delegate;
        QpackEncoder encoder(&decoder_stream_error_delegate, HuffmanEncoding::kEnabled, CookieCrumbling::kEnabled);
        encoder.set_qpack_stream_sender_delegate(&encoder_stream_sender_delegate);
        std::string encoded_header_block = encoder.EncodeHeaderList(/* stream_id = */ 1, header_list, nullptr);
        ...
        QpackDecode(
            ...
            /* maximum_blocked_streams = */ 0, &encoder_stream_error_delegate, &decoder_stream_sender_delegate, &handler,
...
INSTANTIATE_TEST_SUITE_P(All, QpackRoundTripTest, Values(FragmentMode::kSingleChunk, FragmentMode::kOctetByOctet));
