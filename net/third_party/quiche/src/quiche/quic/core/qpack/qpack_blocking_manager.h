...
private:
    ...
    using HeaderBlocks = absl::flat_hash_map<QuicStreamId, std::list<HeaderBlock>>;
    ...
    const bool optimize_qpack_blocking_manager_ = GetQuicReloadableFlag(quic_optimize_qpack_blocking_manager);
};
