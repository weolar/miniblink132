...
using QpackEncoderDynamicTable = quiche::QuicheCircularDeque<std::unique_ptr<QpackEntry>>;
...
template <typename DynamicEntryTable> class QUICHE_EXPORT QpackHeaderTableBase {
public:
    ...
    uint64_t dynamic_table_size() const
    {
        return dynamic_table_size_;
    }
    uint64_t dynamic_table_capacity() const
    {
...
protected:
    ...
    const DynamicEntryTable& dynamic_entries() const
    {
...
template <typename DynamicEntryTable>
bool QpackHeaderTableBase<DynamicEntryTable>::EntryFitsDynamicTableCapacity(absl::string_view name, absl::string_view value) const
{
...
QUICHE_EXPORT inline std::unique_ptr<QpackEntry> NewEntry(std::string name, std::string value, QpackEncoderDynamicTable& /*t*/)
{
    return std::make_unique<QpackEntry>(std::move(name), std::move(value));
}

QUICHE_EXPORT inline QpackEntry NewEntry(std::string name, std::string value, QpackDecoderDynamicTable& /*t*/)
{
...
template <typename DynamicEntryTable> uint64_t QpackHeaderTableBase<DynamicEntryTable>::InsertEntry(absl::string_view name, absl::string_view value)
{
    ...
    auto new_entry = internal::NewEntry(std::string(name), std::string(value), dynamic_entries_);
...
template <typename DynamicEntryTable> bool QpackHeaderTableBase<DynamicEntryTable>::SetDynamicTableCapacity(uint64_t capacity)
{
...
template <typename DynamicEntryTable> bool QpackHeaderTableBase<DynamicEntryTable>::SetMaximumDynamicTableCapacity(uint64_t maximum_dynamic_table_capacity)
{
...
template <typename DynamicEntryTable> void QpackHeaderTableBase<DynamicEntryTable>::RemoveEntryFromEnd()
{
...
template <typename DynamicEntryTable> void QpackHeaderTableBase<DynamicEntryTable>::EvictDownToCapacity(uint64_t capacity)
{
...
class QUICHE_EXPORT QpackEncoderHeaderTable : public QpackHeaderTableBase<QpackEncoderDynamicTable> {
public:
    ...
    uint64_t InsertEntry(absl::string_view name, absl::string_view value) override;
    ...
    MatchResult FindHeaderField(absl::string_view name, absl::string_view value) const;
...
class QUICHE_EXPORT QpackDecoderHeaderTable : public QpackHeaderTableBase<QpackDecoderDynamicTable> {
public:
