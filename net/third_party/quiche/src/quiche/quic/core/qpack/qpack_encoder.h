...
public:
    ...
    public:
        ...
        virtual void OnDecoderStreamError(QuicErrorCode error_code, absl::string_view error_message) = 0;
    };

    QpackEncoder(DecoderStreamErrorDelegate* decoder_stream_error_delegate, HuffmanEncoding huffman_encoding, CookieCrumbling cookie_crumbling);
    ...
    std::string EncodeHeaderList(QuicStreamId stream_id, const quiche::HttpHeaderBlock& header_list, QuicByteCount* encoder_stream_sent_byte_count);
    ...
    void OnErrorDetected(QuicErrorCode error_code, absl::string_view error_message) override;
    ...
    {
        return maximum_blocked_streams_;
    }
...
private:
    ...
    static Representation EncodeIndexedHeaderField(bool is_static, uint64_t index, QpackBlockingManagerShim::IndexSet* referred_indices);
    ...
    static Representation EncodeLiteralHeaderField(absl::string_view name, absl::string_view value);
    ...
    Representations FirstPassEncode(QuicStreamId stream_id, const quiche::HttpHeaderBlock& header_list, QpackBlockingManagerShim::IndexSet* referred_indices,
    ...
    std::string SecondPassEncode(Representations representations, uint64_t required_insert_count) const;
...
class QUICHE_EXPORT NoopDecoderStreamErrorDelegate : public QpackEncoder::DecoderStreamErrorDelegate {
public:
