...
public:
    ...
    void Encode(const QpackInstructionWithValues& instruction_with_values, std::string* output);
...
private:
    ...
    void DoWriteString(absl::string_view name, absl::string_view value, std::string* output);
