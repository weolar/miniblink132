...
bool QpackDecoderStreamReceiver::OnInstructionDecoded(const QpackInstruction* instruction)
{
...
void QpackDecoderStreamReceiver::OnInstructionDecodingError(QpackInstructionDecoder::ErrorCode error_code, absl::string_view error_message)
{
    ...
    QuicErrorCode quic_error_code
        = (error_code == QpackInstructionDecoder::ErrorCode::INTEGER_TOO_LARGE) ? QUIC_QPACK_DECODER_STREAM_INTEGER_TOO_LARGE : QUIC_INTERNAL_ERROR;
