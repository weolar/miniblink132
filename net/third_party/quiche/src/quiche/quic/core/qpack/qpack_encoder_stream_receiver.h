...
class QUICHE_EXPORT QpackEncoderStreamReceiver : public QpackInstructionDecoder::Delegate, public QpackStreamReceiver {
public:
    ...
    public:
        ...
        virtual void OnInsertWithNameReference(bool is_static, uint64_t name_index, absl::string_view value) = 0;
        // 5.2.2. Insert Without Name Reference
        virtual void OnInsertWithoutNameReference(absl::string_view name, absl::string_view value) = 0;
        // 5.2.3. Duplicate
        ...
        // Decoding error
        virtual void OnErrorDetected(QuicErrorCode error_code, absl::string_view error_message) = 0;
    };
    ...
    QpackEncoderStreamReceiver& operator=(const QpackEncoderStreamReceiver&) = delete;
