...
std::ostream& operator<<(std::ostream& os, const QuicConnectionStats& s)
{
    ...
    os << " packets_spuriously_retransmitted: " << s.packets_spuriously_retransmitted;
    ...
    os << " undecryptable_packets_received_before_handshake_complete: " << s.undecryptable_packets_received_before_handshake_complete;
    ...
    os << " connection_creation_time: " << s.connection_creation_time.ToDebuggingValue();
    ...
    os << " retry_packet_processed: " << (s.retry_packet_processed ? "yes" : "no");
    ...
    os << " num_failed_authentication_packets_received: " << s.num_failed_authentication_packets_received;
    os << " num_tls_server_zero_rtt_packets_received_after_discarding_decrypter: " << s.num_tls_server_zero_rtt_packets_received_after_discarding_decrypter;
    os << " address_validated_via_decrypting_packet: " << s.address_validated_via_decrypting_packet;
    os << " address_validated_via_token: " << s.address_validated_via_token;
    os << " server_preferred_address_validated: " << s.server_preferred_address_validated;
    os << " failed_to_validate_server_preferred_address: " << s.failed_to_validate_server_preferred_address;
    os << " num_duplicated_packets_sent_to_server_preferred_address: " << s.num_duplicated_packets_sent_to_server_preferred_address;
    os << " }";
