...
public:
    ...
    bool MaybeCoalescePacket(const SerializedPacket& packet, const QuicSocketAddress& self_address, const QuicSocketAddress& peer_address,
    ...
    // enough).
    bool CopyEncryptedBuffers(char* buffer, size_t buffer_len, size_t* length_copied) const;
    ...
    QuicPacketLength length() const
    {
        return length_;
    }

    QuicPacketLength max_packet_length() const
    {
