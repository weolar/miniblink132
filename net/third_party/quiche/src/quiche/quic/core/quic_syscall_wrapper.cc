...
int QuicSyscallWrapper::Sendmmsg(int sockfd, mmsghdr* msgvec, unsigned int vlen, int flags)
{
...
ScopedGlobalSyscallWrapperOverride::ScopedGlobalSyscallWrapperOverride(QuicSyscallWrapper* wrapper_in_scope)
