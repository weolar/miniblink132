...
public:
    QuicSendmmsgBatchWriter(std::unique_ptr<QuicBatchWriterBuffer> batch_buffer, int fd);
...
protected:
    ...
    FlushImplResult InternalFlushImpl(size_t cmsg_space, const CmsgBuilder& cmsg_builder);
};
