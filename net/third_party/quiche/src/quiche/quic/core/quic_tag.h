...
QUICHE_EXPORT bool ContainsQuicTag(const QuicTagVector& tag_vector, QuicTag tag);
...
QUICHE_EXPORT bool FindMutualQuicTag(const QuicTagVector& our_tags, const QuicTagVector& their_tags, QuicTag* out_result, size_t* out_index);
