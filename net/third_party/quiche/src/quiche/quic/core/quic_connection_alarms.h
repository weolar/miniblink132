...
public:
    ...
    public:
        ...
        bool IsSet() const
        {
            return multiplexer_->IsSet(slot_);
        }
        QuicTime deadline() const
        {
            return multiplexer_->GetDeadline(slot_);
        }
        ...
        {
            multiplexer_->Set(slot_, new_deadline);
        }
    ...
    static constexpr size_t kNumberOfSlots = static_cast<size_t>(QuicAlarmSlot::kSlotCount);

    QuicAlarmMultiplexer(absl::Nonnull<QuicConnectionAlarmsDelegate*> connection, QuicConnectionArena& arena, QuicAlarmFactory& alarm_factory);
    ...
    void Update(QuicAlarmSlot slot, QuicTime new_deadline, QuicTimeDelta granularity);
    ...
    QuicConnectionAlarmsDelegate* delegate()
    {
        return connection_;
    }
...
public:
    ...
    class AlarmProxy {
    public:
        explicit AlarmProxy(absl::Nonnull<QuicAlarm*> alarm)
            : alarm_(alarm)
        {
        }
    ...
    class ConstAlarmProxy {
    public:
        explicit ConstAlarmProxy(const QuicAlarm* alarm)
            : alarm_(alarm)
        {
        }
    ...
    QuicConnectionAlarmHolder(QuicConnectionAlarmsDelegate* delegate, QuicAlarmFactory& alarm_factory, QuicConnectionArena& arena);

    AlarmProxy ack_alarm()
    {
        return AlarmProxy(ack_alarm_.get());
    }
    ...
    {
        return AlarmProxy(send_alarm_.get());
    }
    ...
    {
        return AlarmProxy(ping_alarm_.get());
    }
...
public:
    ...
    public:
        ...
        bool IsPermanentlyCancelled() const
        {
            return absl::visit([](auto& alarm) { return alarm.IsPermanentlyCancelled(); }, alarm_);
        }

    private:
        friend class ::quic::test::QuicConnectionAlarmsPeer;

        absl::variant<QuicConnectionAlarmHolder::ConstAlarmProxy, QuicAlarmMultiplexer::ConstAlarmProxy> alarm_;
    };
    ...
    public:
        ...
        void Update(QuicTime new_deadline, QuicTime::Delta granularity)
        {
            absl::visit([&](auto& alarm) { alarm.Update(new_deadline, granularity); }, alarm_);
        }
        void Cancel()
        {
    ...
    private:
        ...
        absl::variant<QuicConnectionAlarmHolder::AlarmProxy, QuicAlarmMultiplexer::AlarmProxy> alarm_;
    };

    QuicConnectionAlarms(QuicConnectionAlarmsDelegate* delegate, QuicAlarmFactory& alarm_factory, QuicConnectionArena& arena);

    AlarmProxy ack_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kAck));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->ack_alarm()));
    }
    ConstAlarmProxy ack_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kAck));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->ack_alarm()));
    }

    AlarmProxy retransmission_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kRetransmission));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->retransmission_alarm()));
    }
    ConstAlarmProxy retransmission_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kRetransmission));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->retransmission_alarm()));
    }

    AlarmProxy send_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kSend));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->send_alarm()));
    }
    ConstAlarmProxy send_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kSend));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->send_alarm()));
    }

    AlarmProxy mtu_discovery_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kMtuDiscovery));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->mtu_discovery_alarm()));
    }
    ConstAlarmProxy mtu_discovery_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kMtuDiscovery));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->mtu_discovery_alarm()));
    }

    AlarmProxy process_undecryptable_packets_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kProcessUndecryptablePackets));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->process_undecryptable_packets_alarm()));
    }
    ConstAlarmProxy process_undecryptable_packets_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kProcessUndecryptablePackets));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->process_undecryptable_packets_alarm()));
    }

    AlarmProxy discard_previous_one_rtt_keys_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kDiscardPreviousOneRttKeys));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->discard_previous_one_rtt_keys_alarm()));
    }
    ConstAlarmProxy discard_previous_one_rtt_keys_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kDiscardPreviousOneRttKeys));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->discard_previous_one_rtt_keys_alarm()));
    }

    AlarmProxy discard_zero_rtt_decryption_keys_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kDiscardZeroRttDecryptionKeys));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->discard_zero_rtt_decryption_keys_alarm()));
    }
    ConstAlarmProxy discard_zero_rtt_decryption_keys_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kDiscardZeroRttDecryptionKeys));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->discard_zero_rtt_decryption_keys_alarm()));
    }

    AlarmProxy multi_port_probing_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kMultiPortProbing));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->multi_port_probing_alarm()));
    }
    ConstAlarmProxy multi_port_probing_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kMultiPortProbing));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->multi_port_probing_alarm()));
    }

    AlarmProxy idle_network_detector_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kIdleNetworkDetector));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->idle_network_detector_alarm()));
    }
    ConstAlarmProxy idle_network_detector_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kIdleNetworkDetector));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->idle_network_detector_alarm()));
    }

    AlarmProxy network_blackhole_detector_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kNetworkBlackholeDetector));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->network_blackhole_detector_alarm()));
    }
    ConstAlarmProxy network_blackhole_detector_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kNetworkBlackholeDetector));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->network_blackhole_detector_alarm()));
    }

    AlarmProxy ping_alarm()
    {
        if (use_multiplexer_) {
            return AlarmProxy(QuicAlarmMultiplexer::AlarmProxy(&*multiplexer_, QuicAlarmSlot::kPing));
        }
        return AlarmProxy(QuicConnectionAlarmHolder::AlarmProxy(holder_->ping_alarm()));
    }
    ConstAlarmProxy ping_alarm() const
    {
        if (use_multiplexer_) {
            return ConstAlarmProxy(QuicAlarmMultiplexer::ConstAlarmProxy(&*multiplexer_, QuicAlarmSlot::kPing));
        }
        return ConstAlarmProxy(QuicConnectionAlarmHolder::ConstAlarmProxy(holder_->ping_alarm()));
    }
