...
struct QUICHE_EXPORT QuicConsumedData {
    ...
    QUICHE_EXPORT friend std::ostream& operator<<(std::ostream& os, const QuicConsumedData& s);
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const WriteStatus& status);
...
{
    return status == WRITE_STATUS_BLOCKED || status == WRITE_STATUS_BLOCKED_DATA_BUFFERED;
}
...
struct QUICHE_EXPORT WriteResult {
    ...
    constexpr WriteResult()
        : WriteResult(WRITE_STATUS_ERROR, 0)
    {
    }
    ...
    QUICHE_EXPORT friend std::ostream& operator<<(std::ostream& os, const WriteResult& s);
...
QUICHE_EXPORT std::string TransmissionTypeToString(TransmissionType transmission_type);

QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, TransmissionType transmission_type);
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const Perspective& perspective);

// Describes whether a ConnectionClose was originated by the peer.
enum class ConnectionCloseSource { FROM_PEER, FROM_SELF };

QUICHE_EXPORT std::string ConnectionCloseSourceToString(ConnectionCloseSource connection_close_source);
...
enum class ConnectionCloseBehavior { SILENT_CLOSE, SILENT_CLOSE_WITH_CONNECTION_CLOSE_PACKET_SERIALIZED, SEND_CONNECTION_CLOSE_PACKET };

QUICHE_EXPORT std::string ConnectionCloseBehaviorToString(ConnectionCloseBehavior connection_close_behavior);
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const ConnectionCloseBehavior& connection_close_behavior);
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicFrameType& t);
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicIetfFrameType& c);
...
#define IS_IETF_STREAM_FRAME(_stype_) (((_stype_)&IETF_STREAM_FRAME_TYPE_MASK) == IETF_STREAM)
...
QUICHE_EXPORT std::string CongestionControlTypeToString(CongestionControlType cc_type);
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, AddressChangeType type);
...
struct QUICHE_EXPORT AckedPacket {
    constexpr AckedPacket(QuicPacketNumber packet_number, QuicPacketLength bytes_acked, QuicTime receive_timestamp)
    ...
    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const AckedPacket& acked_packet);
...
struct QUICHE_EXPORT LostPacket {
    ...
    friend QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const LostPacket& lost_packet);
...
struct QUICHE_EXPORT MessageResult {
    ...
    QUICHE_EXPORT friend std::ostream& operator<<(std::ostream& os, const MessageResult& mr);
...
QUICHE_EXPORT std::string PacketNumberSpaceToString(PacketNumberSpace packet_number_space);
...
QUICHE_EXPORT std::string SerializedPacketFateToString(SerializedPacketFate fate);

QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const SerializedPacketFate fate);

// There are three different forms of CONNECTION_CLOSE.
enum QuicConnectionCloseType { GOOGLE_QUIC_CONNECTION_CLOSE = 0, IETF_QUIC_TRANSPORT_CONNECTION_CLOSE = 1, IETF_QUIC_APPLICATION_CONNECTION_CLOSE = 2 };

QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const QuicConnectionCloseType type);

QUICHE_EXPORT std::string QuicConnectionCloseTypeString(QuicConnectionCloseType type);
...
struct QUICHE_EXPORT QuicPacketBuffer {
    ...
    QuicPacketBuffer(char* buffer, std::function<void(const char*)> release_buffer)
        : buffer(buffer)
        , release_buffer(std::move(release_buffer))
    {
    }
...
struct QUICHE_EXPORT QuicOwnedPacketBuffer : public QuicPacketBuffer {
    ...
    QuicOwnedPacketBuffer(char* buffer, std::function<void(const char*)> release_buffer)
...
QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const KeyUpdateReason reason);
...
QUICHE_EXPORT bool operator==(const QuicSSLConfig& lhs, const QuicSSLConfig& rhs);
...
QUICHE_EXPORT bool operator==(const ParsedClientHello& a, const ParsedClientHello& b);

QUICHE_EXPORT std::ostream& operator<<(std::ostream& os, const ParsedClientHello& parsed_chlo);
...
struct QUICHE_EXPORT QuicEcnCounts {
    ...
    std::string ToString() const
    {
        return absl::StrFormat("ECT(0): %s, ECT(1): %s, CE: %s", std::to_string(ect0), std::to_string(ect1), std::to_string(ce));
    }

    bool operator==(const QuicEcnCounts& other) const
    {
        return (this->ect0 == other.ect0 && this->ect1 == other.ect1 && this->ce == other.ce);
    }
