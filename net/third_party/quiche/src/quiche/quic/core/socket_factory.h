...
public:
    ...
    virtual std::unique_ptr<ConnectingClientSocket> CreateTcpClientSocket(const quic::QuicSocketAddress& peer_address, QuicByteCount receive_buffer_size,
        QuicByteCount send_buffer_size, ConnectingClientSocket::AsyncVisitor* async_visitor)
        = 0;
    ...
    virtual std::unique_ptr<ConnectingClientSocket> CreateConnectingUdpClientSocket(const quic::QuicSocketAddress& peer_address,
