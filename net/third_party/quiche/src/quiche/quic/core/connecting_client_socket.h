...
public:
    ...
    public:
        ...
        // data.
        virtual void ReceiveComplete(absl::StatusOr<quiche::QuicheMemSlice> data) = 0;
    ...
    virtual absl::StatusOr<quiche::QuicheMemSlice> ReceiveBlocking(QuicByteCount max_size) = 0;
