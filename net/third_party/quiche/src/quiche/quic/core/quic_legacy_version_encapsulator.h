...
class QUIC_EXPORT_PRIVATE QuicLegacyVersionEncapsulator : public QuicPacketCreator::DelegateInterface {
public:
    ...
    static QuicPacketLength Encapsulate(absl::string_view sni, absl::string_view inner_packet, const QuicConnectionId& server_connection_id,
...
private:
    ...
    QuicLegacyVersionEncapsulator& operator=(const QuicLegacyVersionEncapsulator&) = delete;
    QuicLegacyVersionEncapsulator& operator=(QuicLegacyVersionEncapsulator&&) = delete;
