...
inline webtransport::DatagramStatus MessageStatusToWebTransportStatus(MessageStatus status)
{
    switch (status) {
    case MESSAGE_STATUS_SUCCESS:
        return webtransport::DatagramStatus(webtransport::DatagramStatusCode::kSuccess, "");
    case MESSAGE_STATUS_BLOCKED:
        return webtransport::DatagramStatus(webtransport::DatagramStatusCode::kBlocked, "QUIC connection write-blocked");
    case MESSAGE_STATUS_TOO_LARGE:
        return webtransport::DatagramStatus(webtransport::DatagramStatusCode::kTooBig, "Datagram payload exceeded maximum allowed size");
    ...
    case MESSAGE_STATUS_SETTINGS_NOT_RECEIVED:
        return webtransport::DatagramStatus(webtransport::DatagramStatusCode::kInternalError, absl::StrCat("Internal error: ", MessageStatusToString(status)));
    default:
        return webtransport::DatagramStatus(webtransport::DatagramStatusCode::kInternalError, absl::StrCat("Unknown status: ", MessageStatusToString(status)));
    }
}
