...
class QUICHE_EXPORT QuicAckListenerInterface : public quiche::QuicheReferenceCounted {
public:
    ...
    virtual void OnPacketAcked(int acked_bytes, QuicTime::Delta ack_delay_time) = 0;
