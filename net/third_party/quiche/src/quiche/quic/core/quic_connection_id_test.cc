...
TEST_F(QuicConnectionIdTest, Data)
{
    ...
    QuicConnectionId connection_id1 = QuicConnectionId(connection_id_data, sizeof(connection_id_data));
    QuicConnectionId connection_id2 = QuicConnectionId(connection_id_data, sizeof(connection_id_data));
    ...
    EXPECT_EQ(0, memcmp(connection_id1.data(), connection_id2.data(), sizeof(connection_id_data)));
    EXPECT_EQ(0, memcmp(connection_id1.data(), connection_id_data, sizeof(connection_id_data)));
...
TEST_F(QuicConnectionIdTest, SpanData)
{
    ...
    QuicConnectionId empty_connection_id = QuicConnectionId(absl::Span<uint8_t>());
...
TEST_F(QuicConnectionIdTest, DoubleConvert)
{
    ...
    QuicConnectionId connection_id64_3 = test::TestConnectionId(UINT64_C(0xfedcba9876543210));
    EXPECT_EQ(connection_id64_1, test::TestConnectionId(test::TestConnectionIdToUInt64(connection_id64_1)));
    EXPECT_EQ(connection_id64_2, test::TestConnectionId(test::TestConnectionIdToUInt64(connection_id64_2)));
    EXPECT_EQ(connection_id64_3, test::TestConnectionId(test::TestConnectionIdToUInt64(connection_id64_3)));
...
TEST_F(QuicConnectionIdTest, ChangeLength)
{
    ...
    char connection_id136_2_bytes[17] = { 0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, 0 };
    QuicConnectionId connection_id136_2b(connection_id136_2_bytes, sizeof(connection_id136_2_bytes));
    ...
    memcpy(connection_id.mutable_data(), connection_id64_2.data(), connection_id64_2.length());
