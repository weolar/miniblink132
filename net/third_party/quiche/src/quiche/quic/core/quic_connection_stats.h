...
struct QUICHE_EXPORT QuicConnectionStats {
    QUICHE_EXPORT friend std::ostream& operator<<(std::ostream& os, const QuicConnectionStats& s);
    ...
    QuicPacketCount num_tls_server_zero_rtt_packets_received_after_discarding_decrypter = 0;
