...
public:
    QuicFlowController(QuicSession* session, QuicStreamId id, bool is_connection_flow_controller, QuicStreamOffset send_window_offset,
    ...
    QuicByteCount receive_window_size() const
    {
    ...
    QuicByteCount bytes_consumed() const
    {
        return bytes_consumed_;
    }

    QuicByteCount bytes_sent() const
    {
        return bytes_sent_;
    }
    ...
    bool auto_tune_receive_window()
    {
        return auto_tune_receive_window_;
    }
...
private:
    ...
    void UpdateReceiveWindowOffsetAndSendWindowUpdate(QuicStreamOffset available_window);
