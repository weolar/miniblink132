...
public:
    ...
    static std::optional<QuicServerId> ParseFromHostPortString(absl::string_view host_port_string);
    ...
    template <typename H> friend H AbslHashValue(H h, const QuicServerId& server_id)
    {
