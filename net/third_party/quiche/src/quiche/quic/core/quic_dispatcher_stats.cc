...
std::ostream& operator<<(std::ostream& os, const QuicDispatcherStats& s)
{
    ...
    os << ", packets_processed_with_unknown_cid: " << s.packets_processed_with_unknown_cid;
    os << ", packets_processed_with_replaced_cid_in_store: " << s.packets_processed_with_replaced_cid_in_store;
