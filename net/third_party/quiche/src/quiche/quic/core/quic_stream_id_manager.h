...
public:
    ...
    public:
        ...
        virtual void SendMaxStreams(QuicStreamCount stream_count, bool unidirectional) = 0;
    };

    QuicStreamIdManager(DelegateInterface* delegate, bool unidirectional, Perspective perspective, ParsedQuicVersion version,
    ...
    {
        return absl::StrCat(" { unidirectional_: ", unidirectional_, ", perspective: ", perspective_, ", outgoing_max_streams_: ", outgoing_max_streams_,
            ", next_outgoing_stream_id_: ", next_outgoing_stream_id_, ", outgoing_stream_count_: ", outgoing_stream_count_,
            ", incoming_actual_max_streams_: ", incoming_actual_max_streams_, ", incoming_advertised_max_streams_: ", incoming_advertised_max_streams_,
            ", incoming_stream_count_: ", incoming_stream_count_, ", available_streams_.size(): ", available_streams_.size(),
    ...
    bool OnStreamsBlockedFrame(const QuicStreamsBlockedFrame& frame, std::string* error_details);
    ...
    bool MaybeIncreaseLargestPeerStreamId(const QuicStreamId stream_id, std::string* error_details);
    ...
    QuicStreamCount outgoing_max_streams() const
    {
        return outgoing_max_streams_;
    }
