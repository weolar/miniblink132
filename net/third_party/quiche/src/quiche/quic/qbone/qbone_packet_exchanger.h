...
private:
    ...
    virtual std::unique_ptr<QuicData> ReadPacket(bool* blocked, std::string* error) = 0;
    ...
    // the error message.
    virtual bool WritePacket(const char* packet, size_t size, bool* blocked, std::string* error) = 0;
