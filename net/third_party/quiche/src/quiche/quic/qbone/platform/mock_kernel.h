...
public:
    ...
    MOCK_METHOD(int, bind, (int fd, const struct sockaddr*, socklen_t addr_len), (override));
    ...
    MOCK_METHOD(ssize_t, recvfrom, (int sockfd, void*, size_t len, int flags, struct sockaddr*, socklen_t*), (override));
    MOCK_METHOD(int, recvmmsg, (int sockfd, struct mmsghdr* msgvec, unsigned int vlen, int flags, struct timespec* timeout), (override));
    MOCK_METHOD(ssize_t, sendmsg, (int sockfd, const struct msghdr*, int flags), (override));
    MOCK_METHOD(ssize_t, sendto, (int sockfd, const void*, size_t len, int flags, const struct sockaddr*, socklen_t addrlen), (override));
