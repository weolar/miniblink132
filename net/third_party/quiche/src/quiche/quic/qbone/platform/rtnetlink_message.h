...
public:
    ...
    virtual void AppendAttribute(uint16_t type, const void* data, uint16_t data_length);
...
public:
    static RuleMessage New(RtnetlinkMessage::Operation request_operation, uint16_t flags, uint32_t seq, uint32_t pid, const struct rtmsg* rule_message_header);
