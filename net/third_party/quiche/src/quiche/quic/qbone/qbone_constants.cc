...
{
    return QuicUtils::GetFirstBidirectionalStreamId(version, Perspective::IS_CLIENT);
}
...
{
    static auto* range = new quic::IpRange(*quic::QboneConstants::TerminatorLocalAddress(), 128);
    return range;
}
