...
public:
    ...
    MOCK_METHOD(void, OnPacketForwarded, (QbonePacketProcessor::Direction, uint8_t), (override));
    MOCK_METHOD(void, OnPacketDroppedSilently, (QbonePacketProcessor::Direction, uint8_t), (override));
    MOCK_METHOD(void, OnPacketDroppedWithIcmp, (QbonePacketProcessor::Direction, uint8_t), (override));
    MOCK_METHOD(void, OnPacketDroppedWithTcpReset, (QbonePacketProcessor::Direction, uint8_t), (override));
    MOCK_METHOD(void, RecordThroughput, (size_t, QbonePacketProcessor::Direction, uint8_t), (override));
};
