...
public:
    MOCK_METHOD(std::optional<quic::QuicConnectionId>, GenerateNextConnectionId, (const quic::QuicConnectionId& original), (override));

    MOCK_METHOD(std::optional<quic::QuicConnectionId>, MaybeReplaceConnectionId,
        (const quic::QuicConnectionId& original, const quic::ParsedQuicVersion& version), (override));
