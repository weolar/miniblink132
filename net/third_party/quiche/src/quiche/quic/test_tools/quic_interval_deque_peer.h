...
public:
    template <class T, class C> static int32_t GetCachedIndex(QuicIntervalDeque<T, C>* interval_deque)
    {
    ...
    template <class T, class C> static T* GetItem(QuicIntervalDeque<T, C>* interval_deque, const std::size_t index)
    {
