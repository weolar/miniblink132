...
public:
    static void SetMaxPacketLength(QuicCoalescedPacket& coalesced_packet, QuicPacketLength length);

    static std::string* GetMutableEncryptedBuffer(QuicCoalescedPacket& coalesced_packet, EncryptionLevel encryption_level);
};
