...
// static
void QuicStreamPeer::SetStreamBytesWritten(QuicStreamOffset stream_bytes_written, QuicStream* stream)
{
    ...
    QuicStreamSendBufferPeer::SetStreamOffset(&stream->send_buffer_, stream_bytes_written);
}

// static
void QuicStreamPeer::SetSendWindowOffset(QuicStream* stream, QuicStreamOffset offset)
{
    QuicFlowControllerPeer::SetSendWindowOffset(&*stream->flow_controller_, offset);
}
...
// static
void QuicStreamPeer::SetReceiveWindowOffset(QuicStream* stream, QuicStreamOffset offset)
{
    QuicFlowControllerPeer::SetReceiveWindowOffset(&*stream->flow_controller_, offset);
}

// static
void QuicStreamPeer::SetMaxReceiveWindow(QuicStream* stream, QuicStreamOffset size)
{
...
{
    return QuicFlowControllerPeer::ReceiveWindowOffset(&*stream->flow_controller_);
}
...
// static
bool QuicStreamPeer::StreamContributesToConnectionFlowControl(QuicStream* stream)
{
