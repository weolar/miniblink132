...
public:
    ...
    static void SetStreamBytesWritten(QuicStreamOffset stream_bytes_written, QuicStream* stream);
    static void SetSendWindowOffset(QuicStream* stream, QuicStreamOffset offset);
    static void SetReceiveWindowOffset(QuicStream* stream, QuicStreamOffset offset);
