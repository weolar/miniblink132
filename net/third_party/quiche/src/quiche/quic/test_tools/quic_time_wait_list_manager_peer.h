...
public:
    static bool ShouldSendResponse(QuicTimeWaitListManager* manager, int received_packet_count);
    ...
    static void set_clock(QuicTimeWaitListManager* manager, const QuicClock* clock);
