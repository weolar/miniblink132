...
public:
    ...
    bool DecodeAndVerifyOfflineData(absl::string_view input_filename, absl::string_view expected_headers_filename);
...
private:
    ...
    bool ReadNextExpectedHeaderList(absl::string_view* expected_headers_data, quiche::HttpHeaderBlock* expected_header_list);
    ...
    bool CompareHeaderBlocks(quiche::HttpHeaderBlock decoded_header_list, quiche::HttpHeaderBlock expected_header_list);
