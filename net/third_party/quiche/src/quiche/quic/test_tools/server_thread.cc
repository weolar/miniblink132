...
ServerThread::ServerThread(std::unique_ptr<QuicServer> server, const QuicSocketAddress& address)
...
void ServerThread::ScheduleAndWaitForCompletion(quiche::SingleUseCallback<void()> action)
{
...
bool ServerThread::WaitUntil(quiche::UnretainedCallback<bool()> termination_predicate, QuicTime::Delta timeout)
{
