...
public:
    ...
    MOCK_METHOD(ssize_t, Sendmsg, (int sockfd, const msghdr*, int flags), (override));

    MOCK_METHOD(int, Sendmmsg, (int sockfd, mmsghdr*, unsigned int vlen, int flags), (override));
};
