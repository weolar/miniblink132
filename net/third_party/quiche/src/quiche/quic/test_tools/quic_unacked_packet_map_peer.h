...
public:
    static const QuicStreamFrame& GetAggregatedStreamFrame(const QuicUnackedPacketMap& unacked_packets);

    static void SetPerspective(QuicUnackedPacketMap* unacked_packets, Perspective perspective);
