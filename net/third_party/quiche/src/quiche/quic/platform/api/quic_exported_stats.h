...
#define QUIC_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring)                                                                                  \
    do {                                                                                                                                                       \
        QUIC_CLIENT_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring);                                                                          \
        QUIC_SERVER_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring);                                                                          \
    } while (0)
...
#define QUIC_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring)                                                                                 \
    do {                                                                                                                                                       \
        QUIC_CLIENT_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring);                                                                         \
        QUIC_SERVER_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring);                                                                         \
    } while (0)
