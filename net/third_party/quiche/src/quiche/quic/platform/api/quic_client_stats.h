...
#define QUIC_CLIENT_HISTOGRAM_ENUM(name, sample, enum_size, docstring) QUICHE_CLIENT_HISTOGRAM_ENUM(name, sample, enum_size, docstring)
...
#define QUIC_CLIENT_HISTOGRAM_BOOL(name, sample, docstring) QUICHE_CLIENT_HISTOGRAM_BOOL(name, sample, docstring)
...
#define QUIC_CLIENT_HISTOGRAM_TIMES(name, sample, min, max, bucket_count, docstring)                                                                           \
...
#define QUIC_CLIENT_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring)                                                                          \
    QUICHE_CLIENT_HISTOGRAM_COUNTS(name, sample, min, max, bucket_count, docstring)
