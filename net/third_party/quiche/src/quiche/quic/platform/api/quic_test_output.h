...
inline void QuicSaveTestOutput(absl::string_view filename, absl::string_view data)
{
...
inline void QuicRecordTrace(absl::string_view identifier, absl::string_view data)
{
