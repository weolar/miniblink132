...
public:
    ...
    QuicDefaultClient(QuicSocketAddress server_address, const QuicServerId& server_id, const ParsedQuicVersionVector& supported_versions,
    ...
    {
        return default_network_helper()->GetLatestFD();
    }
