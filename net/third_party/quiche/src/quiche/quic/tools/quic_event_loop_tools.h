...
inline constexpr QuicTimeDelta kDefaultTimeoutForTools = QuicTimeDelta::FromSeconds(3);
inline constexpr QuicTimeDelta kDefaultEventLoopTimeoutForTools = QuicTimeDelta::FromMilliseconds(50);
...
ABSL_MUST_USE_RESULT inline bool ProcessEventsUntil(
    QuicEventLoop* event_loop, quiche::UnretainedCallback<bool()> callback, QuicTimeDelta timeout = kDefaultTimeoutForTools)
{
