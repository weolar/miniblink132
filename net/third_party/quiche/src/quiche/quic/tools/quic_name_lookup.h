...
quic::QuicSocketAddress LookupAddress(int address_family_for_lookup, std::string host, std::string port);

quic::QuicSocketAddress LookupAddress(int address_family_for_lookup, const QuicServerId& server_id);
