...
TEST_F(QuicUrlTest, Basic)
{
    ...
    url = QuicUrl(url_str);
    EXPECT_TRUE(url.IsValid());
    EXPECT_EQ("https://www.example.com:12345/path/to/resource?a=1&campaign=2", url.ToString());
...
{
    std::string url_str = "ftp://www.example.com:12345/path/to/resource?a=1&campaign=2";
