...
std::string QuicheGetCommonSourcePathImpl()
{
    ...
    return net_path.AppendASCII("third_party/quiche/src/quiche/common").MaybeAsASCII();
}
...
std::string QuicheGetTestMemoryCachePathImpl()
{
    ...
    path = path.AppendASCII("net").AppendASCII("data").AppendASCII("quic_http_response_cache_data");
