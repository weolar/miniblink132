...
#define QUICHE_CLIENT_HISTOGRAM_ENUM_IMPL(name, sample, enum_size, docstring) UMA_HISTOGRAM_ENUMERATION(QUICHE_HISTOGRAM_NAME(name), sample, enum_size)

#define QUICHE_CLIENT_HISTOGRAM_BOOL_IMPL(name, sample, docstring) UMA_HISTOGRAM_BOOLEAN(QUICHE_HISTOGRAM_NAME(name), sample)

#define QUICHE_CLIENT_HISTOGRAM_TIMES_IMPL(name, sample, min, max, bucket_count, docstring)                                                                    \
    UMA_HISTOGRAM_CUSTOM_TIMES(QUICHE_HISTOGRAM_NAME(name), base::Microseconds(sample.ToMicroseconds()), base::Microseconds(min.ToMicroseconds()),             \
...
#define QUICHE_CLIENT_HISTOGRAM_COUNTS_IMPL(name, sample, min, max, bucket_count, docstring)                                                                   \
    UMA_HISTOGRAM_CUSTOM_COUNTS(QUICHE_HISTOGRAM_NAME(name), sample, min, max, bucket_count)

inline void QuicheClientSparseHistogramImpl(const std::string& name, int sample)
{
