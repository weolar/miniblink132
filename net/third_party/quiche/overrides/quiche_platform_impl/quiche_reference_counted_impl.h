...
class QUIC_EXPORT_PRIVATE QuicheReferenceCountedImpl : public base::RefCountedThreadSafe<QuicheReferenceCountedImpl> {
public:
...
template <class T> class QuicheReferenceCountedPointerImpl {
public:
    ...
    {
        return static_cast<bool>(refptr_);
    }
    ...
    const scoped_refptr<T>& refptr() const
    {
        return refptr_;
    }
