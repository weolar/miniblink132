...
void AddressMapCacheLinux::SetCachedInfo(AddressMap address_map, std::unordered_set<int> online_links)
{
    base::AutoLock autolock(lock_);
...
void AddressMapCacheLinux::ApplyDiffs(const AddressMapDiff& addr_diff, const OnlineLinksDiff& links_diff)
{
    base::AutoLock autolock(lock_);
