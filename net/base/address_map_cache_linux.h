...
public:
    ...
    void SetCachedInfo(AddressMap address_map, std::unordered_set<int> online_links);
    ...
    // data.
    void ApplyDiffs(const AddressMapDiff& addr_diff, const OnlineLinksDiff& links_diff);
