...
public:
    ...
    NetworkChangeNotifierPosix& operator=(const NetworkChangeNotifierPosix&) = delete;
...
private:
    ...
    // global one.
    NetworkChangeNotifierPosix(NetworkChangeNotifier::ConnectionType initial_connection_type,
    ...
    // signals.
    static NetworkChangeNotifier::NetworkChangeCalculatorParams NetworkChangeCalculatorParamsPosix();
