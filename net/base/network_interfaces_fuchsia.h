...
public:
    ...
    static std::optional<InterfaceProperties> VerifyAndCreate(fuchsia::net::interfaces::Properties properties);
    ...
    {
        return !properties_.addresses().empty();
    }
