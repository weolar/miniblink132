...
struct NET_EXPORT TransportInfo {
    TransportInfo();
    TransportInfo(
        TransportType type_arg, IPEndPoint endpoint_arg, std::string accept_ch_frame_arg, bool cert_is_issued_by_known_root, NextProto negotiated_protocol);
...
NET_EXPORT std::ostream& operator<<(std::ostream& out, const TransportInfo& info);
