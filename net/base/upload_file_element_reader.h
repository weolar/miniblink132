...
public:
    ...
    // instead.
    UploadFileElementReader(base::TaskRunner* task_runner, base::File file, const base::FilePath& path, uint64_t range_offset, uint64_t range_length,
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(HttpNetworkTransactionTest, UploadFileSmallerThanLength);
