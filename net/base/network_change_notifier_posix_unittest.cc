...
public:
        ...
        : task_environment_(base::test::TaskEnvironment::TimeSource::MOCK_TIME)
    {
        ...
        notifier_ = base::WrapUnique(
            new NetworkChangeNotifierPosix(NetworkChangeNotifier::CONNECTION_UNKNOWN, NetworkChangeNotifier::SUBTYPE_UNKNOWN, dns_config_notifier_.get()));
        auto dns_config_service = std::make_unique<TestDnsConfigService>();
        dns_config_service_ = dns_config_service.get();
        dns_config_notifier_->SetDnsConfigServiceForTesting(std::move(dns_config_service));
    }
    ...
    NetworkChangeNotifierPosix* notifier()
    {
