...
void ExpectConnectTimingHasNoTimes(const LoadTimingInfo::ConnectTiming& connect_timing);
...
void ExpectConnectTimingHasTimes(const LoadTimingInfo::ConnectTiming& connect_timing, int connect_timing_flags);

// Tests that all non-connection establishment times in |load_timing_info| are
// null.  Its |connect_timing| field is ignored.
void ExpectLoadTimingHasOnlyConnectionTimes(const LoadTimingInfo& load_timing_info);
