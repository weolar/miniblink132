...
class NET_EXPORT_PRIVATE NetworkChangeNotifierLinux : public NetworkChangeNotifier {
public:
    ...
    explicit NetworkChangeNotifierLinux(const std::unordered_set<std::string>& ignored_interfaces);
    ...
    NetworkChangeNotifierLinux& operator=(const NetworkChangeNotifierLinux&) = delete;
