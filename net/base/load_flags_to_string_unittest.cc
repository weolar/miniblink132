...
{
    EXPECT_EQ(LoadFlagsToString(LOAD_DO_NOT_SAVE_COOKIES | LOAD_PREFETCH), "LOAD_DO_NOT_SAVE_COOKIES | LOAD_PREFETCH");
}

TEST(LoadFlagsToStringTest, ThreeFlags)
{
    EXPECT_EQ(LoadFlagsToString(LOAD_BYPASS_CACHE | LOAD_CAN_USE_SHARED_DICTIONARY | LOAD_SHOULD_BYPASS_HSTS),
