...
TEST(NetworkIsolationKeyTest, NonEmptySameSiteKey)
{
    ...
    EXPECT_EQ(site1.Serialize() + " " + site1.Serialize(), key.ToCacheKeyString());
    EXPECT_EQ(site1.GetDebugString() + " " + site1.GetDebugString(), key.ToDebugString());
...
TEST(NetworkIsolationKeyTest, NonEmptyCrossSiteKey)
{
    ...
    EXPECT_TRUE(key.IsFullyPopulated());
    EXPECT_EQ(site1.Serialize() + " " + site2.Serialize(), key.ToCacheKeyString());
    EXPECT_EQ(site1.GetDebugString() + " " + site2.GetDebugString(), key.ToDebugString());
    EXPECT_FALSE(key.IsTransient());
}
...
TEST(NetworkIsolationKeyTest, KeyWithNonce)
{
    ...
    EXPECT_EQ(std::nullopt, key.ToCacheKeyString());
    EXPECT_TRUE(key.IsTransient());
    EXPECT_EQ(site1.GetDebugString() + " " + site2.GetDebugString() + " (with nonce " + nonce.ToString() + ")", key.ToDebugString());
...
TEST(NetworkIsolationKeyTest, OpaqueOriginKey)
{
    ...
    EXPECT_EQ(std::nullopt, key.ToCacheKeyString());
    EXPECT_TRUE(key.IsTransient());
    EXPECT_EQ(site_data.GetDebugString() + " " + site_data.GetDebugString(), key.ToDebugString());
    ...
    EXPECT_EQ(other_site.GetDebugString() + " " + other_site.GetDebugString(), other_key.ToDebugString());
}
...
TEST(NetworkIsolationKeyTest, OpaqueOriginTopLevelSiteKey)
{
    ...
    EXPECT_EQ(std::nullopt, key.ToCacheKeyString());
    EXPECT_TRUE(key.IsTransient());
    EXPECT_EQ(site_data.GetDebugString() + " " + site1.GetDebugString(), key.ToDebugString());
    ...
    EXPECT_NE(key, other_key);
    EXPECT_NE(key.ToDebugString(), other_key.ToDebugString());
    EXPECT_EQ(other_site.GetDebugString() + " " + site1.GetDebugString(), other_key.ToDebugString());
}
...
TEST(NetworkIsolationKeyTest, OpaqueOriginIframeKey)
{
    ...
    EXPECT_EQ(std::nullopt, key.ToCacheKeyString());
    EXPECT_TRUE(key.IsTransient());
    EXPECT_EQ(site1.GetDebugString() + " " + site_data.GetDebugString(), key.ToDebugString());
    ...
    EXPECT_NE(key, other_key);
    EXPECT_NE(key.ToDebugString(), other_key.ToDebugString());
    EXPECT_EQ(site1.GetDebugString() + " " + other_site.GetDebugString(), other_key.ToDebugString());
}
...
TEST(NetworkIsolationKeyTest, Operators)
{
    ...
    const NetworkIsolationKey kKeys[] = {
        ...
        NetworkIsolationKey(SchemefulSite(GURL(kDataUrl)), SchemefulSite(GURL(kDataUrl))),
        NetworkIsolationKey(SchemefulSite(GURL("file:///foo")), SchemefulSite(GURL("file:///foo"))),
        NetworkIsolationKey(SchemefulSite(GURL("http://a.test/")), SchemefulSite(GURL("http://a.test/"))),
        NetworkIsolationKey(SchemefulSite(GURL("http://b.test/")), SchemefulSite(GURL("http://b.test/"))),
        NetworkIsolationKey(SchemefulSite(GURL("https://a.test/")), SchemefulSite(GURL("https://a.test/"))),
        NetworkIsolationKey(SchemefulSite(GURL("https://a.test/")), SchemefulSite(GURL("https://a.test/")), nonce1),
        NetworkIsolationKey(SchemefulSite(GURL("https://a.test/")), SchemefulSite(GURL("https://a.test/")), nonce2),
    };
...
TEST(NetworkIsolationKeyTest, CreateWithNewFrameSite)
{
    ...
    NetworkIsolationKey key_with_nonce_c = key_with_nonce.CreateWithNewFrameSite(site_c);
...
{
    NetworkIsolationKey transient_key = NetworkIsolationKey::CreateTransientForTesting();
