...
TEST(NetErrorsTest, IsCertificateError)
{
    ...
    EXPECT_FALSE(IsCertificateError(ERR_SSL_CLIENT_AUTH_PRIVATE_KEY_ACCESS_DENIED));
...
TEST(NetErrorsTest, IsClientCertificateError)
{
    ...
    EXPECT_TRUE(IsClientCertificateError(ERR_SSL_CLIENT_AUTH_PRIVATE_KEY_ACCESS_DENIED));
    EXPECT_TRUE(IsClientCertificateError(ERR_SSL_CLIENT_AUTH_CERT_NO_PRIVATE_KEY));
