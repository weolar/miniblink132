...
TestCompletionCallbackBaseInternal::TestCompletionCallbackBaseInternal() = default;
...
ReleaseBufferCompletionCallback::ReleaseBufferCompletionCallback(IOBuffer* buffer)
    : buffer_(buffer)
{
}
