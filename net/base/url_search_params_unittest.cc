...
{
    const UrlSearchParams search_params(GURL("https://a.test/index.html?a=1&b=2&c=3"));
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("a", "1"), Pair("b", "2"), Pair("c", "3")));
}

TEST(UrlSearchParamsTest, ParseSearchParamUnescapeValue)
{
    const UrlSearchParams search_params(GURL(R"(https://a.test/index.html?a=a%20b%20c)"));
...
TEST(UrlSearchParamsTest, DeleteOneSearchParams)
{
    ...
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("a", "1"), Pair("c", "3")));
}
...
{
    UrlSearchParams search_params(GURL("https://a.test/index.html?c=3&b=2&a=1&c=2&a=5"));
    search_params.Sort();
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("a", "1"), Pair("a", "5"), Pair("b", "2"), Pair("c", "3"), Pair("c", "2")));
}

TEST(UrlSearchParamsTest, SortSearchParamsPercentEncoded)
{
    UrlSearchParams search_params(GURL("https://a.test/index.html?c=3&b=2&a=1&%63=2&a=5"));
    search_params.Sort();
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("a", "1"), Pair("a", "5"), Pair("b", "2"), Pair("c", "3"), Pair("c", "2")));
}
...
{
    const UrlSearchParams search_params(GURL(R"(https://a.test/index.html?c+1=3&b+%202=2&a=1&%63%201=2&a=5)"));
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("c 1", "3"), Pair("b  2", "2"), Pair("a", "1"), Pair("c 1", "2"), Pair("a", "5")));
}

TEST(UrlSearchParamsTest, ParseSearchParamsDoubleCodePoint)
{
    const UrlSearchParams search_params(GURL(R"(https://a.test/index.html?%C3%A9=foo)"));
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("é", "foo")));
}

TEST(UrlSearchParamsTest, SortSearchParamsDoubleCodePoint)
{
    UrlSearchParams search_params(GURL(R"(https://a.test/index.html?%C3%A9=f&a=2&c=4&é=b)"));
    search_params.Sort();
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("a", "2"), Pair("c", "4"), Pair("é", "f"), Pair("é", "b")));
}

TEST(UrlSearchParamsTest, ParseSearchParamsTripleCodePoint)
{
    const UrlSearchParams search_params(GURL(R"(https://a.test/index.html?%E3%81%81=foo)"));
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("ぁ", "foo")));
}

TEST(UrlSearchParamsTest, ParseSearchParamsQuadrupleCodePoint)
{
    const UrlSearchParams search_params(GURL(R"(https://a.test/index.html?%F0%90%A8%80=foo)"));
...
{
    const UrlSearchParams search_params(GURL(R"(https://a.test/index.html?%C3=foo)"));
...
{
    const UrlSearchParams search_params(GURL("https://a.test/index.html?a&b&c&d&=5&=1"));
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("a", ""), Pair("b", ""), Pair("c", ""), Pair("d", ""), Pair("", "5"), Pair("", "1")));
}

TEST(UrlSearchParamsTest, ParseSearchParamsInvalidEscapeTest)
{
    const UrlSearchParams search_params(GURL(R"(https://a.test/index.html?a=%3&%3=b)"));
    EXPECT_THAT(search_params.params(), ElementsAre(Pair("a", "%3"), Pair("%3", "b")));
}
