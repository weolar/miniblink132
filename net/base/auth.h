...
public:
    AuthCredentials();
    AuthCredentials(const std::u16string& username, const std::u16string& password);
    ~AuthCredentials();
...
enum AuthState { AUTH_STATE_DONT_NEED_AUTH, AUTH_STATE_NEED_AUTH, AUTH_STATE_HAVE_AUTH, AUTH_STATE_CANCELED };
