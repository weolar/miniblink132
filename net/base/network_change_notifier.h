...
public:
    ...
    enum ConnectionCost { CONNECTION_COST_UNKNOWN = 0, CONNECTION_COST_UNMETERED, CONNECTION_COST_METERED, CONNECTION_COST_LAST };
    ...
    private:
        ...
        scoped_refptr<base::ObserverListThreadSafe<IPAddressObserver>> observer_list_;
    };
    ...
    private:
        friend NetworkChangeNotifier;
        scoped_refptr<base::ObserverListThreadSafe<ConnectionTypeObserver>> observer_list_;
    };
    ...
    private:
        friend NetworkChangeNotifier;
        scoped_refptr<base::ObserverListThreadSafe<NetworkChangeObserver>> observer_list_;
    };
    ...
    public:
        ...
        // |max_bandwidth_mbps|.
        virtual void OnMaxBandwidthChanged(double max_bandwidth_mbps, ConnectionType type) = 0;
    ...
    private:
        friend NetworkChangeNotifier;
        scoped_refptr<base::ObserverListThreadSafe<MaxBandwidthObserver>> observer_list_;
    };
    ...
    private:
        friend NetworkChangeNotifier;
        scoped_refptr<base::ObserverListThreadSafe<ConnectionCostObserver>> observer_list_;
    };
    ...
    public:
        ...
        DefaultNetworkActiveObserver& operator=(const DefaultNetworkActiveObserver&) = delete;
    ...
    private:
        friend NetworkChangeNotifier;
        scoped_refptr<base::ObserverListThreadSafe<DefaultNetworkActiveObserver>> observer_list_;
    };
    ...
    static constexpr ConnectionType kDefaultInitialConnectionType = CONNECTION_UNKNOWN;
    static constexpr ConnectionSubtype kDefaultInitialConnectionSubtype = SUBTYPE_UNKNOWN;
#else
    static constexpr ConnectionType kDefaultInitialConnectionType = CONNECTION_NONE;
    static constexpr ConnectionSubtype kDefaultInitialConnectionSubtype = SUBTYPE_NONE;
#endif
    ...
    static std::unique_ptr<NetworkChangeNotifier> CreateIfNeeded(
        ConnectionType initial_type = kDefaultInitialConnectionType, ConnectionSubtype initial_subtype = kDefaultInitialConnectionSubtype);
    ...
    // type.
    static void GetMaxBandwidthAndConnectionType(double* max_bandwidth_mbps, ConnectionType* connection_type);
    ...
    static double GetMaxBandwidthMbpsForConnectionSubtype(ConnectionSubtype subtype);
    ...
    static ConnectionType GetNetworkConnectionType(handles::NetworkHandle network);
    ...
    static ConnectionType ConnectionTypeFromInterfaceList(const NetworkInterfaceList& interfaces);
    ...
    static void AddDefaultNetworkActiveObserver(DefaultNetworkActiveObserver* observer);
    ...
    static void RemoveDefaultNetworkActiveObserver(DefaultNetworkActiveObserver* observer);
    ...
    static void NotifyObserversOfConnectionTypeChangeForTests(ConnectionType type);
    static void NotifyObserversOfDNSChangeForTests();
    static void NotifyObserversOfNetworkChangeForTests(ConnectionType type);
    static void NotifyObserversOfMaxBandwidthChangeForTests(double max_bandwidth_mbps, ConnectionType type);
    static void NotifyObserversOfConnectionCostChangeForTests(ConnectionCost cost);
    ...
    static bool IsTestNotificationsOnly()
    {
        return test_notifications_only_;
    }
...
protected:
    ...
    enum class NetworkChangeType { kConnected, kDisconnected, kSoonToDisconnect, kMadeDefault };
    ...
    explicit NetworkChangeNotifier(const NetworkChangeCalculatorParams& params = NetworkChangeCalculatorParams(),
...
#if BUILDFLAG(IS_FUCHSIA)
    virtual const internal::NetworkInterfaceCache* GetNetworkInterfaceCacheInternal() const;
#endif
    ...
    virtual void GetCurrentMaxBandwidthAndConnectionType(double* max_bandwidth_mbps, ConnectionType* connection_type) const;
    ...
    virtual ConnectionType GetCurrentNetworkConnectionType(handles::NetworkHandle network) const;
    ...
    static void NotifyObserversOfMaxBandwidthChange(double max_bandwidth_mbps, ConnectionType type);
    static void NotifyObserversOfSpecificNetworkChange(NetworkChangeType type, handles::NetworkHandle network);
...
private:
    ...
    void NotifyObserversOfMaxBandwidthChangeImpl(double max_bandwidth_mbps, ConnectionType type);
    void NotifyObserversOfSpecificNetworkChangeImpl(NetworkChangeType type, handles::NetworkHandle network);
