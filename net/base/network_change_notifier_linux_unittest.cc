...
public:
    ...
    NetworkChangeNotifierLinuxTest(const NetworkChangeNotifierLinuxTest&) = delete;
    NetworkChangeNotifierLinuxTest& operator=(const NetworkChangeNotifierLinuxTest&) = delete;
    ...
    void CreateNotifier()
    {
        ...
        notifier_ = std::make_unique<NetworkChangeNotifierLinux>(std::unordered_set<std::string>());
    }
...
TEST_F(NetworkChangeNotifierLinuxTest, AddressTrackerLinuxSetDiffCallback)
{
    ...
    internal::AddressTrackerLinux* address_tracker_linux = address_map_owner->GetAddressTrackerLinux();
