...
class NET_EXPORT LoggingNetworkChangeObserver : public NetworkChangeNotifier::IPAddressObserver,
...
public:
    ...
    LoggingNetworkChangeObserver& operator=(const LoggingNetworkChangeObserver&) = delete;
