...
public:
    ...
    MockFileStream(base::File file, const scoped_refptr<base::TaskRunner>& task_runner);
    ...
    int Write(IOBuffer* buf, int buf_len, CompletionOnceCallback callback) override;
