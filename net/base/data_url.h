...
inline constexpr std::string_view kRemoveWhitespaceForDataURLs = "remove-keep-whitespace-for-data-urls";
...
public:
    ...
    // true is returned.
    [[nodiscard]] static bool Parse(const GURL& url, std::string* mime_type, std::string* charset, std::string* data);
