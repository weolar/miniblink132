...
public:
    ...
    DirectoryLister(const base::FilePath& dir, ListingType type, DirectoryListerDelegate* delegate);
...
private:
    ...
    private:
        ...
        void DoneOnOriginSequence(std::unique_ptr<DirectoryList> directory_list, int error) const;
