...
public:
    ...
    void VerifyOnTunnelHeadersReceived(const ProxyChain& proxy_chain, size_t chain_index, const std::string& response_header_name,
        const std::string& response_header_value, size_t call_index = 0) const;
...
private:
    ...
    std::vector<scoped_refptr<HttpResponseHeaders>> on_tunnel_headers_received_headers_;
};
