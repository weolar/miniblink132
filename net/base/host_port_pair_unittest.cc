...
{
    const char* kBadStrings[] = { "foo.com", "foo.com:", "foo.com:2:3", "bar.com:two", "www.google.com:-1", "www.google.com:+1", "127.0.0.1:65536",
        "[2001:db8::42]:65536", "[2001:db8::42", "2001:db8::42", "2001:db8::42:100", "[2001:db8::42]" };
...
{
    HostPortPair parsed = HostPortPair::FromSchemeHostPort(url::SchemeHostPort("ws", "bar.test", 111));
...
{
    HostPortPair parsed = HostPortPair::FromSchemeHostPort(url::SchemeHostPort("wss", "[::1022]", 112));
