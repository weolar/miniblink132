...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    static_assert(kMaxSniffLength >= net::kMaxBytesToSniff, "kMaxSniffLength is too small.");
    ...
    net::ForceSniffFileUrlsForHtml force_sniff_file_urls_for_html
        = data_provider.ConsumeBool() ? net::ForceSniffFileUrlsForHtml::kDisabled : net::ForceSniffFileUrlsForHtml::kEnabled;
