...
// active.
NET_EXPORT void SetExplicitlyAllowedPorts(base::span<const uint16_t> allowed_ports);
...
public:
    ...
    ScopedAllowablePortForTesting& operator=(const ScopedAllowablePortForTesting&) = delete;
