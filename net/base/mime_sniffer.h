...
NET_EXPORT bool ShouldSniffMimeType(const GURL& url, std::string_view mime_type);
...
NET_EXPORT bool SniffMimeTypeFromLocalData(std::string_view content, std::string* result);
