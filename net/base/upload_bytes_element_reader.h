...
class NET_EXPORT UploadOwnedBytesElementReader : public UploadBytesElementReader {
public:
    ...
    UploadOwnedBytesElementReader& operator=(const UploadOwnedBytesElementReader&) = delete;
    ~UploadOwnedBytesElementReader() override;

    // Creates UploadOwnedBytesElementReader with a string.
    static std::unique_ptr<UploadOwnedBytesElementReader> CreateWithString(const std::string& string);
