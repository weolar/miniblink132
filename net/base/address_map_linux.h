...
public:
    ...
    using AddressMapDiff = base::flat_map<IPAddress, std::optional<struct ifaddrmsg>>;
    ...
    using DiffCallback = base::RepeatingCallback<void(const AddressMapDiff& addr_diff, const OnlineLinksDiff&)>;
