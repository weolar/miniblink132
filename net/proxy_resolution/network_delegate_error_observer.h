...
class NET_EXPORT_PRIVATE NetworkDelegateErrorObserver : public ProxyResolverErrorObserver {
public:
    NetworkDelegateErrorObserver(NetworkDelegate* network_delegate, base::SingleThreadTaskRunner* origin_runner);

    NetworkDelegateErrorObserver(const NetworkDelegateErrorObserver&) = delete;
    NetworkDelegateErrorObserver& operator=(const NetworkDelegateErrorObserver&) = delete;
