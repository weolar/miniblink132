...
class NET_EXPORT PacFileFetcherImpl : public PacFileFetcher, public URLRequest::Delegate {
public:
    ...
    //   * ftp://
    //   * data:
    static std::unique_ptr<PacFileFetcherImpl> Create(URLRequestContext* url_request_context);
    ...
    void OnSSLCertificateError(URLRequest* request, int net_error, const SSLInfo& ssl_info, bool is_hsts_ok) override;
