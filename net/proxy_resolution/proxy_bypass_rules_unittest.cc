...
void ExpectRulesMatch(const ProxyBypassRules& rules, const char* hosts[], size_t num_hosts, bool bypasses, const std::set<std::string>& inverted_hosts)
{
...
void ExpectBypassLocalhost(const ProxyBypassRules& rules, bool bypasses, const std::set<std::string>& inverted_hosts = std::set<std::string>())
{
    const char* kHosts[]
        = { "localhost",
              "localhost.",
...
void ExpectBypassMisc(const ProxyBypassRules& rules, bool bypasses, const std::set<std::string>& inverted_hosts = std::set<std::string>())
{
    const char* kHosts[]
        = { "192.168.0.1",
              "170.254.0.0",
...
{
    ProxyBypassRules rules;
    rules.ParseFromString("foo1.com, .foo2.com, 192.168.1.1, "
