...
public:
    ...
    PollingProxyConfigService& operator=(const PollingProxyConfigService&) = delete;
...
protected:
    ...
    // worker threads.
    using GetConfigFunction = base::RepeatingCallback<void(const NetworkTrafficAnnotationTag, ProxyConfigWithAnnotation*)>;
    ...
    // on a worker thread.
    PollingProxyConfigService(base::TimeDelta poll_interval, GetConfigFunction get_config_func, const NetworkTrafficAnnotationTag& traffic_annotation);
