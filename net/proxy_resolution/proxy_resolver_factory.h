...
public:
    ...
    virtual int CreateProxyResolver(const scoped_refptr<PacFileData>& pac_script, std::unique_ptr<ProxyResolver>* resolver, CompletionOnceCallback callback,
    ...
    bool expects_pac_bytes() const
    {
        return expects_pac_bytes_;
    }
