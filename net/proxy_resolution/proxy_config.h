...
public:
    ...
    struct NET_EXPORT ProxyRules {
        ...
        //                                  URLs.
        void ParseFromString(const std::string& proxy_rules, bool allow_bracketed_proxy_chains = false, bool is_quic_allowed = false);
        ...
        const ProxyList* MapUrlSchemeToProxyList(const std::string& url_scheme) const;
    ...
    void set_from_system(bool from_system)
    {
        from_system_ = from_system;
    }
