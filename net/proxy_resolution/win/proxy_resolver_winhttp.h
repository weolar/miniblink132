...
// proxy settings.
class NET_EXPORT_PRIVATE ProxyResolverFactoryWinHttp : public ProxyResolverFactory {
public:
    ProxyResolverFactoryWinHttp();

    ProxyResolverFactoryWinHttp(const ProxyResolverFactoryWinHttp&) = delete;
    ProxyResolverFactoryWinHttp& operator=(const ProxyResolverFactoryWinHttp&) = delete;
