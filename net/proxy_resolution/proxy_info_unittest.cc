...
TEST(ProxyInfoTest, IsForIpProtection)
{
    ...
    ProxyChain regular_proxy_chain = ProxyChain::FromSchemeHostAndPort(ProxyServer::SCHEME_HTTP, "foo", 80);
    ...
    ProxyChain ip_protection_proxy_chain = ProxyChain::ForIpProtection({
        ProxyServer::FromSchemeHostAndPort(ProxyServer::SCHEME_HTTPS, "proxy1", std::nullopt),
        ProxyServer::FromSchemeHostAndPort(ProxyServer::SCHEME_HTTPS, "proxy2", std::nullopt),
    });
