...
public:
    ...
    public:
        ...
        // pass CONFIG_PENDING.
        virtual void OnProxyConfigChanged(const ProxyConfigWithAnnotation& config, ConfigAvailability availability) = 0;
    };
    ...
    static std::unique_ptr<ProxyConfigService> CreateSystemProxyConfigService(scoped_refptr<base::SequencedTaskRunner> main_task_runner);
};
