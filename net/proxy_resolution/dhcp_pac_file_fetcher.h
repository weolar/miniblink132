...
class NET_EXPORT_PRIVATE DoNothingDhcpPacFileFetcher : public DhcpPacFileFetcher {
public:
    DoNothingDhcpPacFileFetcher();

    DoNothingDhcpPacFileFetcher(const DoNothingDhcpPacFileFetcher&) = delete;
    DoNothingDhcpPacFileFetcher& operator=(const DoNothingDhcpPacFileFetcher&) = delete;
