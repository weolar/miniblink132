...
public:
    ...
    RegistrationRequestParam& operator=(RegistrationRequestParam&& other) noexcept;

    ~RegistrationRequestParam();

    static RegistrationRequestParam Create(RegistrationFetcherParam&& fetcher_param);
    ...
    std::optional<std::string> TakeChallenge()
    {
    ...
    static RegistrationRequestParam CreateForTesting(const GURL& registration_endpoint, std::string session_identifier, std::optional<std::string> challenge);

private:
    RegistrationRequestParam(const GURL& registration_endpoint, std::optional<std::string> session_identifier, std::optional<std::string> challenge,
