...
public:
    ...
    SessionStoreImpl(base::FilePath db_storage_path, unexportable_keys::UnexportableKeyService& key_service);
    ...
    void DeleteSession(const SchemefulSite& site, const Session::Id& session_id) override;
...
private:
    FRIEND_TEST_ALL_PREFIXES(SessionStoreImplTest, PruneLoadedEntryWithInvalidSite);
    FRIEND_TEST_ALL_PREFIXES(SessionStoreImplTest, PruneLoadedEntryWithInvalidSession);
    FRIEND_TEST_ALL_PREFIXES(SessionStoreImplTest, PruneLoadedEntryWithSessionMissingWrappedKey);
    ...
    static SessionsMap CreateSessionsFromLoadedData(const std::map<std::string, proto::SiteSessions>& loaded_data, std::vector<std::string>& keys_to_delete);
    ...
    std::unique_ptr<sqlite_proto::KeyValueTable<proto::SiteSessions>> session_table_;
    ...
    std::unique_ptr<sqlite_proto::KeyValueData<proto::SiteSessions>> session_data_;
