...
public:
    struct NET_EXPORT RegistrationCompleteParams {
        ...
        RegistrationCompleteParams& operator=(RegistrationCompleteParams&& other) noexcept;
    ...
    using RegistrationCompleteCallback = base::OnceCallback<void(std::optional<RegistrationCompleteParams>)>;
    ...
    static void StartCreateTokenAndFetch(RegistrationFetcherParam registration_params, unexportable_keys::UnexportableKeyService& key_service,
    ...
    static void StartFetchWithExistingKey(RegistrationRequestParam request_params, unexportable_keys::UnexportableKeyService& key_service,
        const URLRequestContext* context, const IsolationInfo& isolation_info, RegistrationCompleteCallback callback,
        unexportable_keys::ServiceErrorOr<unexportable_keys::UnexportableKeyId> key_id);
    ...
    // callback result
    static void CreateTokenAsyncForTesting(unexportable_keys::UnexportableKeyService& unexportable_key_service, std::string challenge,
