...
public:
    ...
    bool AddUrlRuleIfValid(InclusionResult rule_type, const std::string& host_pattern, const std::string& path_prefix);
    ...
    bool may_include_site_for_testing() const
    {
        return may_include_site_;
    }
    ...
    static std::unique_ptr<SessionInclusionRules> CreateFromProto(const proto::SessionInclusionRules& proto);
