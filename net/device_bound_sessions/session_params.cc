...
SessionParams::SessionParams(std::string id, std::string refresh, Scope incoming_scope, std::vector<Credential> creds)
...
SessionParams::Scope& SessionParams::Scope::operator=(SessionParams::Scope&& other) = default;
