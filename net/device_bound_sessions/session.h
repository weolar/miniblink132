...
public:
    ...
    using KeyIdOrError = unexportable_keys::ServiceErrorOr<unexportable_keys::UnexportableKeyId>;
    ...
    static std::unique_ptr<Session> CreateIfValid(const SessionParams& params, GURL url);
    ...
    const KeyIdOrError& unexportable_key_id() const
    {
    ...
    const base::Time& expiry_date() const
    {
        return expiry_date_;
    }
    ...
    {
        return should_defer_when_expired_;
    }
    ...
    void set_expiry_date(base::Time expiry_date)
    {
...
private:
    ...
    Session(Id id, GURL refresh, SessionInclusionRules inclusion_rules, std::vector<CookieCraving> cookie_cravings, bool should_defer_when_expired,
    ...
    KeyIdOrError key_id_or_error_ = base::unexpected(unexportable_keys::ServiceError::kKeyNotReady);
