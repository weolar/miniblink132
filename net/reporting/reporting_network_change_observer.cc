...
class ReportingNetworkChangeObserverImpl : public ReportingNetworkChangeObserver, public NetworkChangeNotifier::NetworkChangeObserver {
public:
    ...
    ReportingNetworkChangeObserverImpl(const ReportingNetworkChangeObserverImpl&) = delete;
    ReportingNetworkChangeObserverImpl& operator=(const ReportingNetworkChangeObserverImpl&) = delete;
...
// static
std::unique_ptr<ReportingNetworkChangeObserver> ReportingNetworkChangeObserver::Create(ReportingContext* context)
{
