...
class MockPersistentReportingStore : public ReportingCache::PersistentReportingStore {
public:
    struct Command {
        enum class Type {
        ...
        Command(Type type, const ReportingEndpointGroupKey& group_key, const GURL& endpoint_url);
    ...
    MockPersistentReportingStore& operator=(const MockPersistentReportingStore&) = delete;
    ...
    void SetPrestoredClients(std::vector<ReportingEndpoint> endpoints, std::vector<CachedReportingEndpointGroup> groups);
    ...
    int StoredEndpointsCount() const
    {
        return endpoint_count_;
    }
    int StoredEndpointGroupsCount() const
    {
        return endpoint_group_count_;
    }
