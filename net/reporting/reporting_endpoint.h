...
struct NET_EXPORT ReportingEndpointGroupKey {
    ...
    ReportingEndpointGroupKey(const NetworkAnonymizationKey& network_anonymization_key, const std::optional<url::Origin>& origin, const std::string& group_name,
        ReportingTargetType target_type);

    // Constructs a ReportingEndpointGroupKey with the given parameters.
    ReportingEndpointGroupKey(const NetworkAnonymizationKey& network_anonymization_key, std::optional<base::UnguessableToken> reporting_source,
        const std::optional<url::Origin>& origin, const std::string& group_name, ReportingTargetType target_type);

    // Constructs a ReportingEndpointGroupKey with the given `reporting_source`
    // and all other members from `other`.
    ReportingEndpointGroupKey(const ReportingEndpointGroupKey& other, const std::optional<base::UnguessableToken>& reporting_source);
    ...
    bool IsDocumentEndpoint() const
    {
        return reporting_source.has_value();
    }
    ...
    friend bool operator==(const ReportingEndpointGroupKey& lhs, const ReportingEndpointGroupKey& rhs) = default;
};

NET_EXPORT bool operator!=(const ReportingEndpointGroupKey& lhs, const ReportingEndpointGroupKey& rhs);
NET_EXPORT bool operator<(const ReportingEndpointGroupKey& lhs, const ReportingEndpointGroupKey& rhs);
NET_EXPORT bool operator>(const ReportingEndpointGroupKey& lhs, const ReportingEndpointGroupKey& rhs);
...
struct NET_EXPORT ReportingEndpoint {
    struct NET_EXPORT EndpointInfo {
        ...
        friend bool operator==(const EndpointInfo& lhs, const EndpointInfo& rhs) = default;
    };
    ...
    struct Statistics {
        ...
        friend bool operator==(const Statistics& lhs, const Statistics& rhs) = default;
    };

    // Constructs an invalid ReportingEndpoint.
    ReportingEndpoint();

    ReportingEndpoint(const ReportingEndpointGroupKey& group, const EndpointInfo& info);
    ...
    friend bool operator==(const ReportingEndpoint& lhs, const ReportingEndpoint& rhs) = default;
...
struct NET_EXPORT CachedReportingEndpointGroup {
    ...
    CachedReportingEndpointGroup(const ReportingEndpointGroup& endpoint_group, base::Time now);
