...
void CheckExtension(const WebSocketDeflateParameters& params, const std::string& name, const std::string& value)
{
...
TEST(WebSocketDeflateParametersTest, Empty)
{
    ...
    EXPECT_EQ(WebSocketDeflater::TAKE_OVER_CONTEXT, r.server_context_take_over_mode());
    EXPECT_EQ(WebSocketDeflater::TAKE_OVER_CONTEXT, r.client_context_take_over_mode());
...
class WebSocketDeflateParametersInitializeTest : public ::testing::TestWithParam<InitializeTestParameter> { };
...
class WebSocketDeflateParametersCompatibilityTest : public ::testing::TestWithParam<CompatibilityTestParameter> { };
...
{
    return { false, "Received duplicate permessage-deflate extension parameter " + name };
}
...
std::vector<InitializeTestParameter> InitializeTestParameters()
{
    ...
    const InitializeTestParameter::Expectation kUnknownParameter = { false, "Received an unexpected permessage-deflate extension parameter" };
    ...
    const InitializeTestParameter parameters[] = {
        ...
        { "; server_no_context_takeover; server_no_context_takeover", Duplicate("server_no_context_takeover") },
        { "; client_no_context_takeover", kInitialized },
        { "; client_no_context_takeover=0", Invalid("client_no_context_takeover") },
        { "; client_no_context_takeover; client_no_context_takeover", Duplicate("client_no_context_takeover") },
        { "; server_max_window_bits=8", kInitialized },
        { "; server_max_window_bits=15", kInitialized },
        { "; server_max_window_bits=15; server_max_window_bits=15", Duplicate("server_max_window_bits") },
        ...
        { "; client_max_window_bits=15; client_max_window_bits=15", Duplicate("client_max_window_bits") },
    ...
    return std::vector<InitializeTestParameter>(parameters, parameters + std::size(parameters));
}
...
INSTANTIATE_TEST_SUITE_P(WebSocketDeflateParametersInitializeTest, WebSocketDeflateParametersInitializeTest, ::testing::ValuesIn(InitializeTestParameters()));

INSTANTIATE_TEST_SUITE_P(
    WebSocketDeflateParametersCompatibilityTest, WebSocketDeflateParametersCompatibilityTest, ::testing::ValuesIn(kCompatibilityTestParameters));
