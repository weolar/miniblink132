...
public:
    ...
    bool Decode(base::span<uint8_t> data_span, std::vector<std::unique_ptr<WebSocketFrameChunk>>* frame_chunks);
    ...
    WebSocketError websocket_error() const
    {
        return websocket_error_;
    }
...
private:
    ...
    std::unique_ptr<WebSocketFrameChunk> DecodeFramePayload(bool first_chunk, base::span<uint8_t>* data);
