...
private:
    ...
    void OnMessageStart(const std::vector<std::unique_ptr<WebSocketFrame>>& frames, size_t index);
    int AppendCompressedFrame(const WebSocketFrameHeader& header, std::vector<std::unique_ptr<WebSocketFrame>>* frames_to_write);
    int AppendPossiblyCompressedMessage(std::vector<std::unique_ptr<WebSocketFrame>>* frames, std::vector<std::unique_ptr<WebSocketFrame>>* frames_to_write);
    ...
    int InflateAndReadIfNecessary(std::vector<std::unique_ptr<WebSocketFrame>>* frames);
    ...
    WebSocketFrameHeader::OpCode current_reading_opcode_ = WebSocketFrameHeader::kOpCodeText;
    WebSocketFrameHeader::OpCode current_writing_opcode_ = WebSocketFrameHeader::kOpCodeText;
