...
class NET_EXPORT_PRIVATE WebSocketHttp2HandshakeStream : public WebSocketHandshakeStreamBase, public WebSocketSpdyStreamAdapter::Delegate {
public:
    ...
    WebSocketHttp2HandshakeStream& operator=(const WebSocketHttp2HandshakeStream&) = delete;
