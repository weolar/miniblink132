...
public:
    ...
    WebSocketMockClientSocketFactoryMaker(const WebSocketMockClientSocketFactoryMaker&) = delete;
    WebSocketMockClientSocketFactoryMaker& operator=(const WebSocketMockClientSocketFactoryMaker&) = delete;
    ...
    void SetExpectations(const std::string& expect_written, const std::string& return_to_read);
    ...
    void AddSSLSocketDataProvider(std::unique_ptr<SSLSocketDataProvider> ssl_socket_data);
...
public:
    ...
    WebSocketTestURLRequestContextHost(const WebSocketTestURLRequestContextHost&) = delete;
    WebSocketTestURLRequestContextHost& operator=(const WebSocketTestURLRequestContextHost&) = delete;
    ...
    const TestNetworkDelegate& network_delegate() const
    {
        ...
        return *static_cast<TestNetworkDelegate*>(url_request_context_->network_delegate());
    }
...
class TestWebSocketHandshakeStreamCreateHelper : public WebSocketHandshakeStreamCreateHelper {
public:
    ...
    TestWebSocketHandshakeStreamCreateHelper()
        : WebSocketHandshakeStreamCreateHelper(&connect_delegate_,
            /* requested_subprotocols = */ {}, &request_)
    {
    }

    TestWebSocketHandshakeStreamCreateHelper(const TestWebSocketHandshakeStreamCreateHelper&) = delete;
    TestWebSocketHandshakeStreamCreateHelper& operator=(const TestWebSocketHandshakeStreamCreateHelper&) = delete;
