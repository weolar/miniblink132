...
class NET_EXPORT_PRIVATE WebSocketHttp3HandshakeStream final : public WebSocketHandshakeStreamBase, public WebSocketQuicStreamAdapter::Delegate {
public:
    ...
    WebSocketHttp3HandshakeStream& operator=(const WebSocketHttp3HandshakeStream&) = delete;
...
private:
    void ReceiveAdapterAndStartRequest(std::unique_ptr<WebSocketQuicStreamAdapter> adapter);
    ...
    void OnFailure(const std::string& message, int net_error, std::optional<int> response_code);
