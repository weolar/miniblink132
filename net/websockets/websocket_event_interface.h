...
public:
    ...
    virtual void OnDataFrame(bool fin, WebSocketMessageType type, base::span<const char> payload) = 0;
    ...
    //
    // This function deletes the Channel.
    virtual void OnFailChannel(const std::string& message, int net_error, std::optional<int> response_code) = 0;
    ...
    virtual int OnAuthRequired(const AuthChallengeInfo& auth_info, scoped_refptr<HttpResponseHeaders> response_headers, const IPEndPoint& socket_address,
