...
inline NetLogCaptureModeSet NetLogCaptureModeToBit(NetLogCaptureMode capture_mode)
{
    return 1 << static_cast<uint32_t>(capture_mode);
}

inline bool NetLogCaptureModeSetContains(NetLogCaptureMode capture_mode, NetLogCaptureModeSet set)
{
    return (set & NetLogCaptureModeToBit(capture_mode)) != 0;
}

inline bool NetLogCaptureModeSetAdd(NetLogCaptureMode value, NetLogCaptureModeSet* set)
{
...
// bytes from sockets.
NET_EXPORT bool NetLogCaptureIncludesSocketBytes(NetLogCaptureMode capture_mode);
