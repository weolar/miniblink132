...
NET_EXPORT base::Value::Dict NetLogParamsWithInt(std::string_view name, int value);
NET_EXPORT base::Value::Dict NetLogParamsWithInt64(std::string_view name, int64_t value);
NET_EXPORT base::Value::Dict NetLogParamsWithBool(std::string_view name, bool value);
NET_EXPORT base::Value::Dict NetLogParamsWithString(std::string_view name, std::string_view value);
