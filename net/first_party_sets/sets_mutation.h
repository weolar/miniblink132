...
public:
    ...
    explicit SetsMutation(std::vector<base::flat_map<SchemefulSite, FirstPartySetEntry>> replacement_sets,
        std::vector<base::flat_map<SchemefulSite, FirstPartySetEntry>> addition_sets);
    ...
    const std::vector<base::flat_map<SchemefulSite, FirstPartySetEntry>>& replacements() const
    {
        return replacements_;
    }

    const std::vector<base::flat_map<SchemefulSite, FirstPartySetEntry>>& additions() const
    {
        return additions_;
    }
...
NET_EXPORT std::ostream& operator<<(std::ostream& os, const SetsMutation& mutation);
