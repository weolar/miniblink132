...
{
    EXPECT_THAT(AdditionOverlapsUnionFind(4).SetsMapping(), AdditionOverlapsUnionFind::SetsMap({ { 0, {} }, { 1, {} }, { 2, {} }, { 3, {} } }));
}
...
TEST(AdditionOverlapsUnionFindUnittest, Union_ChoosesLesserSetIndex)
{
    ...
    EXPECT_THAT(union_find.SetsMapping(), AdditionOverlapsUnionFind::SetsMap({ { 0, {} }, { 1, { 2 } } }));

    union_find.Union(0, 1);
    EXPECT_THAT(union_find.SetsMapping(),
        AdditionOverlapsUnionFind::SetsMap({
            { 0, { 1, 2 } },
        }));
}
...
TEST(AdditionOverlapsUnionFindUnittest, Union_NoOp_SharedRepresentative)
{
    ...
    EXPECT_THAT(union_find.SetsMapping(), AdditionOverlapsUnionFind::SetsMap({ { 0, { 2 } }, { 1, {} }, { 3, {} } }));
