...
public:
    ...
    FirstPartySetEntryOverride& operator=(const FirstPartySetEntryOverride& other);
...
private:
    ...
    friend struct mojo::StructTraits<network::mojom::FirstPartySetEntryOverrideDataView, FirstPartySetEntryOverride>;

    std::optional<FirstPartySetEntry> entry_;
};

NET_EXPORT std::ostream& operator<<(std::ostream& os, const FirstPartySetEntryOverride& override);
