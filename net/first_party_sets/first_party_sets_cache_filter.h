...
public:
    ...
    explicit FirstPartySetsCacheFilter(base::flat_map<net::SchemefulSite, int64_t> filter, int64_t browser_run_id);
...
private:
    ...
    friend struct mojo::StructTraits<network::mojom::FirstPartySetsCacheFilterDataView, FirstPartySetsCacheFilter>;
