...
public:
    ...
    // request body.
    RemoteTestServerSpawnerRequest(scoped_refptr<base::SingleThreadTaskRunner> io_task_runner, const GURL& url, const std::string& post_data);

    RemoteTestServerSpawnerRequest(const RemoteTestServerSpawnerRequest&) = delete;
    RemoteTestServerSpawnerRequest& operator=(const RemoteTestServerSpawnerRequest&) = delete;
