...
public:
    ...
    void AddAddressRecord(std::string_view name, const IPAddress& address, base::TimeDelta ttl = base::Days(1));
...
private:
    ...
    std::multimap<std::pair<std::string, uint16_t>, DnsResourceRecord> records_ GUARDED_BY(lock_);
