...
public:
    ...
    static void AddResponse(const std::string& path, quiche::HttpHeaderBlock response_headers, const std::string& response_body);

    // Add a response to `path` with Early Hints.
    static void AddResponseWithEarlyHints(const std::string& path, const quiche::HttpHeaderBlock& response_headers, const std::string& response_body,
