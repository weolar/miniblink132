...
public:
    EmbeddedTestServerAndroid(JNIEnv* env, const base::android::JavaRef<jobject>& obj, jboolean jhttps);

    EmbeddedTestServerAndroid(const EmbeddedTestServerAndroid&) = delete;
    EmbeddedTestServerAndroid& operator=(const EmbeddedTestServerAndroid&) = delete;
    ...
    base::android::ScopedJavaLocalRef<jstring> GetRootCertPemPath(JNIEnv* jenv) const;

    jboolean ShutdownAndWaitUntilComplete(JNIEnv* env);

    base::android::ScopedJavaLocalRef<jstring> GetURL(JNIEnv* jenv, const base::android::JavaParamRef<jstring>& jrelative_url) const;

    base::android::ScopedJavaLocalRef<jstring> GetURLWithHostName(
        JNIEnv* jenv, const base::android::JavaParamRef<jstring>& jhostname, const base::android::JavaParamRef<jstring>& jrelative_url) const;

    void AddDefaultHandlers(JNIEnv* jenv, const base::android::JavaParamRef<jstring>& jdirectory_path);

    void SetSSLConfig(JNIEnv* jenv, jint jserver_certificate);

    void RegisterRequestHandler(JNIEnv* jenv, jlong handler);

    void ServeFilesFromDirectory(JNIEnv* env, const base::android::JavaParamRef<jstring>& jdirectory_path);
