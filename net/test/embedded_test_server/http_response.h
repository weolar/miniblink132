...
public:
    ...
    virtual void SendResponseHeaders(HttpStatusCode status, const std::string& status_reason, const base::StringPairs& headers) = 0;
    ...
    virtual void SendContents(const std::string& contents, base::OnceClosure callback = base::DoNothing()) = 0;
    ...
    virtual void SendHeadersContentAndFinish(
...
public:
    ...
    void set_code(HttpStatusCode code)
    {
        code_ = code;
    }
