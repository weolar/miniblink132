...
namespace {
const base::FilePath::CharType kPythonPathEnv[] = FILE_PATH_LITERAL("PYTHONPATH");
const base::FilePath::CharType kVPythonClearPathEnv[] = FILE_PATH_LITERAL("VPYTHON_CLEAR_PYTHONPATH");
} // namespace

void SetPythonPathInEnvironment(const std::vector<base::FilePath>& python_path, base::EnvironmentMap* map)
{
