...
public:
    ...
    int Read(IOBuffer* read_buffer, int read_buffer_size, CompletionOnceCallback callback) override;
...
private:
    ...
    virtual base::expected<size_t, Error> FilterData(
        IOBuffer* output_buffer, size_t output_buffer_size, IOBuffer* input_buffer, size_t input_buffer_size, size_t* consumed_bytes, bool upstream_eof_reached)
        = 0;
