...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    net::SOCKSClientSocket socket(std::move(fuzzed_socket), net::HostPortPair("foo", 80), net::NetworkAnonymizationKey(), net::DEFAULT_PRIORITY,
        &mock_host_resolver, net::SecureDnsPolicy::kAllow, TRAFFIC_ANNOTATION_FOR_TESTS);
