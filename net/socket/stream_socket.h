...
public:
    ...
    // each one.
    virtual void SetBeforeConnectCallback(const BeforeConnectCallback& before_connect_callback);
    ...
    virtual void GetSSLCertRequestInfo(SSLCertRequestInfo* cert_request_info) const;
