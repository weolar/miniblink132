...
public:
    ...
    SocketPerformanceWatcherFactory(const SocketPerformanceWatcherFactory&) = delete;
    SocketPerformanceWatcherFactory& operator=(const SocketPerformanceWatcherFactory&) = delete;
    ...
    virtual std::unique_ptr<SocketPerformanceWatcher> CreateSocketPerformanceWatcher(const Protocol protocol, const IPAddress& ip_address) = 0;
