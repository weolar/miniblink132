...
public:
    ...
    static void RecordSSLConnectResult(SSLClientSocket* ssl_socket, int result, bool is_ech_capable, bool ech_enabled,
...
protected:
    void set_signed_cert_timestamps_received(bool signed_cert_timestamps_received)
    {
...
private:
    ...
    FRIEND_TEST_ALL_PREFIXES(SSLClientSocketVersionTest, ConnectSignedCertTimestampsTLSExtension);
...
class NET_EXPORT SSLClientContext : public SSLConfigService::Observer, public CertVerifier::Observer, public CertDatabase::Observer {
public:
    ...
    public:
        ...
        // configuration.
        virtual void OnSSLConfigForServersChanged(const base::flat_set<HostPortPair>& servers) = 0;
    };
    ...
    SSLClientContext(SSLConfigService* ssl_config_service, CertVerifier* cert_verifier, TransportSecurityState* transport_security_state,
    ...
    bool GetClientCertificate(const HostPortPair& server, scoped_refptr<X509Certificate>* client_cert, scoped_refptr<SSLPrivateKey>* private_key);
    ...
    // observers.
    void SetClientCertificate(const HostPortPair& server, scoped_refptr<X509Certificate> client_cert, scoped_refptr<SSLPrivateKey> private_key);
    ...
    // Note this method will synchronously call OnSSLConfigForServersChanged() on
    // observers.
    void ClearClientCertificateIfNeeded(const net::HostPortPair& host, const scoped_refptr<net::X509Certificate>& certificate);
    ...
    // Note this method will synchronously call OnSSLConfigForServersChanged() on
    // observers.
    void ClearMatchingClientCertificate(const scoped_refptr<net::X509Certificate>& certificate);

    base::flat_set<HostPortPair> GetClientCertificateCachedServersForTesting() const
    {
...
private:
    ...
    void NotifySSLConfigForServersChanged(const base::flat_set<HostPortPair>& servers);
