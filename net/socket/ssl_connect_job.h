...
class NET_EXPORT_PRIVATE SSLSocketParams : public base::RefCounted<SSLSocketParams> {
public:
    ...
    SSLSocketParams(ConnectJobParams params, const HostPortPair& host_and_port, const SSLConfig& ssl_config, NetworkAnonymizationKey network_anonymization_key);
    ...
    const scoped_refptr<HttpProxySocketParams>& GetHttpProxyConnectionParams() const
    {
...
class NET_EXPORT_PRIVATE SSLConnectJob : public ConnectJob, public ConnectJob::Delegate {
public:
    ...
    public:
        ...
        virtual std::unique_ptr<SSLConnectJob> Create(RequestPriority priority, const SocketTag& socket_tag,
    ...
    SSLConnectJob(RequestPriority priority, const SocketTag& socket_tag, const CommonConnectJobParams* common_connect_job_params,
