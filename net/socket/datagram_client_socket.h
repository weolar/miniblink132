...
class NET_EXPORT_PRIVATE DatagramClientSocket : public DatagramSocket, public Socket {
public:
    ...
    // TODO(liza): Remove this method once consumers have been updated.
    virtual int ConnectUsingNetwork(handles::NetworkHandle network, const IPEndPoint& address) = 0;
    ...
    virtual int ConnectAsync(const IPEndPoint& address, CompletionOnceCallback callback) = 0;
    ...
    // updated.
    virtual int ConnectUsingNetworkAsync(handles::NetworkHandle network, const IPEndPoint& address, CompletionOnceCallback callback) = 0;
    ...
    // been updated.
    virtual int ConnectUsingDefaultNetworkAsync(const IPEndPoint& address, CompletionOnceCallback callback) = 0;
