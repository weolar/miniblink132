...
public:
    ...
    {
        return absl::holds_alternative<scoped_refptr<HttpProxySocketParams>>(params_);
    }
    ...
    {
        return absl::holds_alternative<scoped_refptr<TransportSocketParams>>(params_);
    }
...
private:
    absl::variant<scoped_refptr<HttpProxySocketParams>, scoped_refptr<SOCKSSocketParams>, scoped_refptr<TransportSocketParams>, scoped_refptr<SSLSocketParams>>
        params_;
};
