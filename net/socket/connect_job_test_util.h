...
public:
    ...
    explicit TestConnectJobDelegate(SocketExpected socket_expected = SocketExpected::ON_SUCCESS_ONLY);
    ...
    int num_auth_challenges() const
    {
        return num_auth_challenges_;
    }
    ...
    void StartJobExpectingResult(ConnectJob* connect_job, net::Error expected_result, bool expect_sync_result);
