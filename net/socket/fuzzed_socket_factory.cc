...
std::unique_ptr<DatagramClientSocket> FuzzedSocketFactory::CreateDatagramClientSocket(
...
std::unique_ptr<TransportClientSocket> FuzzedSocketFactory::CreateTransportClientSocket(const AddressList& addresses,
