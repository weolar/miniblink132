...
enum NextProto : uint8_t { kProtoUnknown = 0, kProtoHTTP11 = 1, kProtoHTTP2 = 2, kProtoQUIC = 3, kProtoLast = kProtoQUIC };

// List of protocols to use for ALPN, used for configuring HttpNetworkSessions.
typedef std::vector<NextProto> NextProtoVector;

using NextProtoSet = base::EnumSet<NextProto, NextProto::kProtoUnknown, NextProto::kProtoLast>;
