...
class NET_EXPORT_PRIVATE SOCKSSocketParams : public base::RefCounted<SOCKSSocketParams> {
public:
    SOCKSSocketParams(ConnectJobParams nested_params, bool socks_v5, const HostPortPair& host_port_pair,
    ...
    const HostPortPair& destination() const
    {
        return destination_;
    }
    bool is_socks_v5() const
    {
        return socks_v5_;
    }
...
class NET_EXPORT_PRIVATE SOCKSConnectJob : public ConnectJob, public ConnectJob::Delegate {
public:
    ...
    public:
        ...
        virtual std::unique_ptr<SOCKSConnectJob> Create(RequestPriority priority, const SocketTag& socket_tag,
    ...
    SOCKSConnectJob(RequestPriority priority, const SocketTag& socket_tag, const CommonConnectJobParams* common_connect_job_params,
