...
public:
    ...
    int Init(const ClientSocketPool::GroupId& group_id, scoped_refptr<ClientSocketPool::SocketParams> socket_params,
    ...
    void set_idle_time(base::TimeDelta idle_time)
    {
    ...
    void set_is_ssl_error(bool is_ssl_error)
    {
        is_ssl_error_ = is_ssl_error;
    }
    void set_ssl_cert_request_info(scoped_refptr<SSLCertRequestInfo> ssl_cert_request_info)
    {
    ...
    int64_t group_generation() const
    {
        return group_generation_;
    }
    bool is_reused() const
    {
        return reuse_type() == SocketReuseType::kReusedIdle;
    }
    base::TimeDelta idle_time() const
    {
        return idle_time_;
    }
