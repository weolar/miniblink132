...
void TestConnectJobDelegate::OnConnectJobComplete(int result, ConnectJob* job)
{
    ...
    EXPECT_EQ(socket_.get() != nullptr, result == OK || socket_expected_ == SocketExpected::ALWAYS);
...
void TestConnectJobDelegate::WaitForAuthChallenge(int num_auth_challenges_to_wait_for)
{
...
void TestConnectJobDelegate::StartJobExpectingResult(ConnectJob* connect_job, net::Error expected_result, bool expect_sync_result)
{
