...
class NET_EXPORT_PRIVATE NetworkChangeNotifierAndroid : public NetworkChangeNotifier, public NetworkChangeNotifierDelegateAndroid::Observer {
public:
    NetworkChangeNotifierAndroid(const NetworkChangeNotifierAndroid&) = delete;
    NetworkChangeNotifierAndroid& operator=(const NetworkChangeNotifierAndroid&) = delete;
    ...
    ConnectionType GetCurrentNetworkConnectionType(handles::NetworkHandle network) const override;
    NetworkChangeNotifier::ConnectionSubtype GetCurrentConnectionSubtype() const override;
    ...
    void OnMaxBandwidthChanged(double max_bandwidth_mbps, ConnectionType type) override;
...
private:
    ...
    explicit NetworkChangeNotifierAndroid(NetworkChangeNotifierDelegateAndroid* delegate);
    ...
    std::unique_ptr<BlockingThreadObjects, base::OnTaskRunnerDeleter> blocking_thread_objects_;
