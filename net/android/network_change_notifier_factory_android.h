...
public:
    ...
    NetworkChangeNotifierFactoryAndroid(const NetworkChangeNotifierFactoryAndroid&) = delete;
    NetworkChangeNotifierFactoryAndroid& operator=(const NetworkChangeNotifierFactoryAndroid&) = delete;
    ...
    std::unique_ptr<NetworkChangeNotifier> CreateInstanceWithInitialTypes(
        NetworkChangeNotifier::ConnectionType /*initial_type*/, NetworkChangeNotifier::ConnectionSubtype /*initial_subtype*/) override;
