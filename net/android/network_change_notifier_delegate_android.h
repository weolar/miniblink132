...
public:
    ...
    public:
        ...
        virtual void OnMaxBandwidthChanged(double max_bandwidth_mbps, ConnectionType connection_type) = 0;
    ...
    NetworkChangeNotifierDelegateAndroid(const NetworkChangeNotifierDelegateAndroid&) = delete;
    NetworkChangeNotifierDelegateAndroid& operator=(const NetworkChangeNotifierDelegateAndroid&) = delete;
    ~NetworkChangeNotifierDelegateAndroid();
    ...
    void NotifyConnectionTypeChanged(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jint new_connection_type, jlong default_netid);
    ...
    // by this class and forwards the notification to the observers that
    // subscribed through RegisterObserver().
    void NotifyConnectionCostChanged(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jint new_connection_cost);
    ...
    // RegisterObserver().
    void NotifyConnectionSubtypeChanged(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jint subtype);
    ...
    void NotifyOfNetworkConnect(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jlong net_id, jint connection_type);
    void NotifyOfNetworkSoonToDisconnect(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jlong net_id);
    void NotifyOfNetworkDisconnect(JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, jlong net_id);
    void NotifyPurgeActiveNetworkList(
        JNIEnv* env, const base::android::JavaParamRef<jobject>& obj, const base::android::JavaParamRef<jlongArray>& active_networks);
    ...
    void GetCurrentMaxBandwidthAndConnectionType(double* max_bandwidth_mbps, ConnectionType* connection_type) const;
...
private:
    ...
    static void JavaLongArrayToNetworkMap(JNIEnv* env, const base::android::JavaRef<jlongArray>& long_array, NetworkMap* network_map);
    ...
    void SetOnline();
    void SetOffline();
    void FakeNetworkConnected(handles::NetworkHandle network, ConnectionType type);
    ...
    const base::android::ScopedJavaGlobalRef<jobject> java_network_change_notifier_;
