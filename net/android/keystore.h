...
bool SignWithPrivateKey(
    const base::android::JavaRef<jobject>& private_key, std::string_view algorithm, base::span<const uint8_t> input, std::vector<uint8_t>* signature);
...
bool EncryptWithPrivateKey(
    const base::android::JavaRef<jobject>& private_key, std::string_view algorithm, base::span<const uint8_t> input, std::vector<uint8_t>* ciphertext);
